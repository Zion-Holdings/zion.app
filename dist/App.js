...
const App = () => {
    return (_jsx("div", { className: "App", children: _jsx(Suspense, { fallback: _jsx("div", { className: "p-4 text-center", children: "Loading..." }), children: _jsx(Routes, { children: baseRoutes.map(({ path, element }) => (_jsx(Route, { path: path, element: element }, path))) }) }) }));
};
export default App;
