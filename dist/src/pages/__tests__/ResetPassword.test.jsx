...
const TestWrapper = ({ children, initialRoute = '/reset-password/test-token' }) => (<MemoryRouter initialEntries={[initialRoute]}>
    <Routes>
...
describe('ResetPasswordPage', () => {
    ...
    it('displays error if token is missing (simulated by different route)', () => {
        ...
        render(<MemoryRouter initialEntries={['/reset-password/']}>
        <Routes>
