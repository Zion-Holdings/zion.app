...
export default function Button({ children, variant = 'primary', size = 'md', href, external = false, onClick, disabled = false, className = '', type = 'button', }) {
    ...
    if (href) {
        if (external) {
            return (_jsx("a", { href: href, className: classes, style: style, target: "_blank", rel: "noopener noreferrer", children: content }));
        }
        return (_jsx(Link, { href: href, className: classes, style: style, target: target, rel: target === '_blank' ? 'noopener noreferrer' : rel, children: content }));
    }
