...
function fixParsingErrors(filePath) {
  try {
    ...
    const $1 = /return\s*\(\s*<ModernLayout>\s*return\s*\(\s*<ModernLayout>\s*return\s*\(\s*<ModernLayout>\s*return\s*\(\s*/g;
    ...
    const $1 = /useEffect\s*\(\s*\(\)\s*=>\s*\{\s*return\s*\(\s*<ModernLayout>/g;
    ...
    const $1 = /<Home\s*\/>|<Search\s*\/>|<User\s*\/>/g;
