  ...
  return ("
    <div className="relative" z-10 container-responsive py-8>
      <Head> 
        ...
        <meta name=description content=Comprehensive user profiles with skills, experience, portfolio, and social connections > </meta" name=description content="Comprehensive user profiles with skills, experience, portfolio, and social" connections" ><meta name="keywords content=user profiles, skills, experience, portfolio, marketplace profiles, Zion > </meta" name="keywords" content="user profiles, skills, experience, portfolio, marketplace profiles," Zion" ><link rel="icon href= favicon.ico  > </link" rel="icon" href= favicon.ico"  ><meta name="viewport" content=width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no /></Head>
