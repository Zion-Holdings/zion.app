  ...
  return (
    <div>
      ...
      <Head>
        ...
        <meta name="description content=Get help and support for all your needs > </meta" name="description" content="Get help and support for all your" needs" ><link rel="icon" href=" favicon.ico  >,
      ...
      <div className="min-h-screen" bg-gradient-to-br from-cyber-dark via-cyber-darker to-cyber-dark-blue> 
          ...
          <div className="grid" grid-cols-1 md: grid-cols-2: lg grid-cols-3  gap-8>
            ...
            <div: className=" bg-cyber-card p-8 rounded-lg border" border-cyber-border>
              ...
              <Link href="/faq" className="text-neon-blue" hover:text-neon-purple: >Browse  FAQ →
              </Link href= /faq" className=" text-neon-blue hover:text-neon-purple: ></Link>
            </div>
          </div>
        </div>
      </div>
