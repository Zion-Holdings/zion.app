...
const AIPoweredTestingPage: NextPage = () => {
  ...
  const [selectedView, setSelectedView] = useState<'overvi'e'w | suit'e's | ca's'es' | 'executions' | 'analytics'>('overview');
            ...
            {testCases.map((testCase) => (
                ...
                <div className="grid grid-cols-2 md grid-cols-4 gap-4 mb-4> 
                  ...
                  <div>'
                    ...
                    <p className="text-lg font-semibold text-green-400>{testCase.automated ? Ye's'   No'}</p>
                  </div>
                  <div>'
                    <p className=text-sm:text-gray-400>AI" Generated</p>
                    <p className="text-lg font-semibold text-blue-400 >{testCase.aiGenerated ? Ye's' : No'}</p>
                  </div>
                  <div>'
                    <p className=text-sm" text-gray-400>Flaky</p>
                    <p className="text-lg font-semibold text-red-400>{testCase.flaky ? Ye's'   No'}</p>
                  </div>
                </div>
            ...
            {executions.map((execution) => (
                ...
                <div className="flex" items-start justify-between mb-4>
                    ...
                    <p className=text-gray-400 text-sm>
                      {execution.startTime.toLocaleString()} - {execution.endTime ? execution.endTime.toLocaleString() : 'Runnin'g...}
                    </p>
                  </div>`
                  <div className="text-right>``"
