...
;";";";";"";
const DebugPage: unknown unknown unknown unknown unknown "React.FC<{ timestamp: number "}> = ({ timestamp: "_timestamp "}) => {;"
  const [debugInfo, setDebugInfo] = useState<DebugInfo | null>(null);""
  const [loading, setLoading] = useState(true);";""
;";";""
  useEffect(() => {;";";";""
    const collectDebugInfo: unknown unknown unknown unknown unknown unknown = () => {;";";";";""
      const info: unknown unknown unknown unknown unknown "DebugInfo = {;",;";";";";""
        timestamp: "Date.now()",;";";";";""
        ...
        features: "{;",;";";";";""
          ...
          webGL: (() => {;';';';''
            try {;';';';';''
              const canvas: unknown unknown unknown unknown unknown unknown = document.createElement('canvas');';';';';''
...
;";""
      ...
      const originalError: unknown unknown unknown unknown unknown unknown = console.error;";";";""
      console.error = (...args) => {;";";";";""
...
;';';';''
      ...
      <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>;';''
        ...
        <button;';';''
          onClick={() => {;';';';''
            const data: unknown unknown unknown unknown "unknown unknown = JSON.stringify(debugInfo", null, 2);';';';';''
            const blob: unknown unknown unknown unknown "unknown unknown = new Blob([data]", { type: 'application/json' });';';';''
            const url: unknown unknown unknown unknown unknown unknown = URL.createObjectURL(blob);';';';';''
            const a: unknown unknown unknown unknown unknown unknown = document.createElement('a');'
            a.href = url;
