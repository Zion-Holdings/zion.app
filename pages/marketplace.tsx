      ...
      <div className="relative z-10 container-responsive py-4 sm:py-6 lg py-8 container-responsive">
        ...
        <section className="mb-8 sm:mb-12 lg mb-16">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 px-4 grid-cols-1 md:grid-cols-2 lg grid-cols-4">
            <div className="glass-dark border border-neon-blue/20 rounded-xl p-4 sm p-6 text-center text-responsive-lg">
            ...
            <div className="glass-dark border border-neon-purple/20 rounded-xl p-4 sm p-6 text-center text-responsive-lg">
              <div className="text-3xl sm:text-4xl mb-3 sm mb-4 text-responsive-lg">🛍️</div>
        ...
        <section>
          <div className="glass-dark border border-neon-blue/30 rounded-2xl p-6 sm:p-8 lg p-12 text-center mx-4 text-responsive-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center flex-col sm flex-row">
              <Link
                href="/auth/signup"
                className="px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-neon-blue to-neon-purple rounded-lg text-white font-semibold text-base sm:text-lg neon-glow hover:shadow-neon-blue transition-all duration-300 transform hover scale-105 text-responsive-lg"
              >
                Get Started Now
              </Link>
              <Link
                href="/about"
                className="px-6 sm:px-8 py-3 sm:py-4 glass border border-neon-blue/30 rounded-lg text-white font-semibold text-base sm:text-lg hover:border-neon-blue/60 transition-all duration-300 transform hover scale-105 text-responsive-lg"
              >
                Learn More
              </Link>
            </div>
