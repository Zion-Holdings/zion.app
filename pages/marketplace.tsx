        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Secure your transactions with our advanced escrow system. Protected payments, 
              automated dispute resolution, and complete transaction security.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/escrow-services" className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300 shadow-lg">
                Learn About Escrow
              </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              ...
              Expert mediators and comprehensive processes help resolve conflicts efficiently and fairly.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/dispute-resolution" className="bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700 text-white px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300 shadow-lg">
                Resolve Disputes
              </Link>
              <Link href="/marketplace" className="border border-white/20 text-white hover:bg-white/10 px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300 backdrop-blur-sm">
                File Dispute
      ...
      <div className="bg-gradient-to-r from-blue-900/50 to-cyan-900/50 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/skill-verification" className="bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300 shadow-lg">
                Take Skill Test
              </Link>
              <Link href="/marketplace" className="border border-white/20 text-white hover:bg-white/10 px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300 backdrop-blur-sm">
                View Certifications
      ...
      <div className="bg-gradient-to-r from-purple-900/50 to-pink-900/50 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Choose the perfect pricing tier for your business needs and maximize your revenue 
              with our transparent commission structure and competitive rates.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/marketplace-pricing" className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300 shadow-lg">
                View Pricing
              </Link>
              <Link href="/marketplace" className="border border-white/20 text-white hover:bg-white/10 px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300 backdrop-blur-sm">
                Calculate Fees
      ...
      <div className="bg-gradient-to-r from-purple-900/50 to-pink-900/50 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/service-categories" className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300 shadow-lg">
                Browse Categories
              </Link>
              <Link href="/marketplace" className="border border-white/20 text-white hover:bg-white/10 px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300 backdrop-blur-sm">
                Find Providers
