...
const $1: NextPage = () => {
  const $1 = [
    {
      title: A'I' Services,
      description: Professiona'l' AI development and consulting services,
      icon: 🤖',
      price: 'From $50/hr','
      rating: 4.8,
      link: /services,
...
{
      title: 'A'I Talent,
      description: 'Exper't AI professionals and developers,
      icon: '👥',
      price: From' $75/hr',
      rating: 4.9,
      link: /talents',
