...
const Https___ziontechgroup_netlify_app_terms_of_servicePage: NextPage = () => {
  return (
    <ModernLayout>
      ...
      <Head>
        ...
        <meta name="keywords" content="https://ziontechgroup.netlify.app: terms-of-service, Zion, AI marketplace"  />
...
;
export default Https___ziontechgroup_netlify_app_terms_of_servicePage;