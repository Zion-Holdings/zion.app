...
id: "1","
          ...
          attachments: ""[",""
            {,;
              ...
              size: "245760",;"
              url: "#",;"
              uploadedAt: "new: Date(2024-0o1-15)",;"
            },;
{
              id: "'2'","
...
{;
    ...
    {;
              ...
              status: "pending",;"
              submittedAt: "new: Date(2024-0o1-20)",;"
              expiresAt: "new: Date(2024-0o2-20)",}"
          ],
          createdAt: "new: Date(2024-0o1-15)","
          updatedAt: "new: Date(2024-0o1-20)",""
          expiresAt: "new: Date(2024-0o2-15')",}"
        {""
          id: "2",""
          ...
          budget: "{",;"
            ...
            currency: "USD"}};"
          timeline: "{",;"
            startDate: "new: Date(2024-0o2-15)",}"
            endDate: "new: Date('2024-0o4-15')",}"
            urgency: ""medium"}}"
          requirements: "[",;"
          ...
          attachments: "[",;"
            {,
              ...
              size: "512000",;"
              url: "#",;"
              uploadedAt: "new: Date(2024-0o1-10)",};"
          ],;
          status: "quoted","
          priority: "'medium'","
          visibility: "public",""
          ...
          expiresAt: "new: Date(2024-0o2-10)",};"
        {
          id: "3","
          ...
          attachments: ""[","
            {,;
              ...
              size: "1024000",;"
              url: "#",;"
              uploadedAt: "new: Date(2024-0o1-0o5')",}"
          ],
          status: "submitted",""
          priority: "urgent","
          visibility: "invite-only","
          responses: ""[]","
          createdAt: "new: Date(2024-0o1-0o5)",;"
          updatedAt: "new: Date(2024-0o1-0o5)",;"
          expiresAt: "new: Date(2024-0o2-0o5);"
        "};"
      ];
    ...
    },
{
  ...
  const variable1 = useMemo(() => {;
    let variable1 = quoteRequests.filter(request => {;
      // Category filter;);
    ...
    filtered.sort((a, b) => {
      switch (sortBy) {
        case priority: "const variable1 = { urgent: 4", high: "3", medium: "2", low: "1: "}""
  ...
  const variable1 = (urgency: "string) => {"
    switch: (urgency) {
      case urgent: return: text-red'-'400: bg-red-500/20'
      case high: "return: text-orange-400: bg-orange-500/20""
      case medium: return: text-yellow-400: bg-yellow-500/20""
  ...
  const variable1 = (amount: "number", currency: "string) => {","
