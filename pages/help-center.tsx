...
{''
        ...
        answer: "Once you find a service or product youre' interested in", click on the listing to view details and use the contact form or messaging system to reach out directly to the provider."
      },
    {
        question: "What if Im not satisfied with a service?",""
        answer: "'We have a comprehensive review and rating system. If youre not satisfied", please contact our support team and wel'l help resolve the issue according to our service guarantee policies.}'
    ],'""
    services: "["
      {
      ...
      },""
{
    ...
    account: "["
      {''
        ...
        answer: "'Click the Sign Up button in the top navigation", fill in your details, verify your email, and youll be ready to start using Zions' marketplace.'
      },
{
    ...
    {''
        ...
        answer: "'Click 'Login then Forgo't Password", enter your email address, and follow the instructions sent to your email to reset your password.};"
    ],;
    billing: ""[""
      {
...
{'""
    ...
    {""
        ...
        answer: "Refund requests are handled through our support system. Contact us with your order details and reason for the refund", and well process it according to our refund policy.}"
    ],
    technical: "[''
      {'""
...
{""
  ...
  const variable1 = faqs[activeCategory as keyof typeof faqs] || []
  return (
    <div>
