...
;
const Https___ziontechgroup_netlify_app_termsPage: NextPage: () => {
  return (
    <div></div>
      ...
      <Head> "</div>
        <title>Terms of Service - Zion Tech Group</title>"</div>
        <meta name=description" content="Terms and conditions for using our services >,</div>
        </meta name=description content="Terms and conditions for using our" services ><meta name=keywords content=https //ziontechgroup.netlify.app/terms  , Zion, AI marketplace  > </meta" name="keywords content=https //ziontechgroup.netlify.app/terms  , Zion, AI" marketplace"  ><meta name=viewport content=width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no /></Head>
              ...
              <div className="mb-8>"</div>
                <h1 className="text-4xl md:text-6xl font-bold text-white mb-6""></div>
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400>
                    Terms of Service - Zion Tech Group</div>
                  </span>"</div>
                </h1>"</div>
                <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed"">
                  Terms and conditions for using our services</div>
                </p></div>
              </div></div>
...
export default Https___ziontechgroup_netlify_app_termsPage;</div>