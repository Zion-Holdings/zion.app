    ...
    },;
{
  ...
  const variable1 = (status: "string) => {;"
    switch (status) {;
      ...
      case disput'ed: return text-red-400'
    ...
    <div></div>""
      ...
      <div className="max-w-7xl" mx-auto px-4 sm:px-6 lg px-8 py-32> </div>"
        ...
        <div className="grid"  grid-cols-1 md:grid-cols-4 gap-6 mb-12></div>''
            ...
            <div className="text-3xl" font-bold text-white mb-2>variable2.5M+</div></div>"
...
{ id: "transaction's", label: ""Transactions "},""
    { id: "disputes", label  Disput'es },;'
{ id  accoun't, label  Accou'nt};'
          ].map((tab) => (
