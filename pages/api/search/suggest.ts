...
;
  try {;
    const suggestions: unknown unknown unknown unknown unknown SearchSuggestion[] = [];
;
    // Search services;"
...
;
    ...
    const sortedSuggestions: unknown unknown unknown unknown unknown unknown = suggestions;
      .sort((a, b) => {;
        // Prioritize exact matches;
        const aExact: unknown unknown unknown unknown unknown unknown = a.text.toLowerCase() === query;
