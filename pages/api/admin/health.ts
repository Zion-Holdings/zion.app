  ...
  try {;";";";";"
    if (req['method'] !== 'GET') {;';';';'
      return res.status(405).json({;';';';';'
        health: "{"} catch (error) {} catch (error) {} catch (error) {} catch (error) {} catch (error) {}as HealthData,;";";";";"
        success: "false",;";";";";"
...
;
    ...
    const healthData: unknown unknown unknown unknown unknown unknown = errorReportingDashboard.getHealthData();';'
;';';'
