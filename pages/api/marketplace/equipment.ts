...
;';';';''
  try {;';';';';''
    logInfo('Marketplace equipment API called with query:', { data:  { data: req['query'] } catch (error) {} catch (error) {} catch (error) {} catch (error) {} catch (error) {}});';';''
    ;';';';''
    // Add CORS headers;';';';';''
...
;';';';''
    ...
    const search: unknown unknown unknown unknown unknown unknown = ((req['query'] as { search?: string }).search as string);';';';';''
    const category: unknown unknown unknown unknown unknown unknown = ((req['query'] as { category?: string }).category as string);'
;
...
;
    // Apply search filter;
    if (search) {;
      const searchTerm: unknown unknown unknown unknown unknown unknown = search.toLowerCase();
      equipment = equipment.filter(e => ;
...
;''
    ...
    const paginatedEquipment: unknown unknown unknown unknown "unknown unknown = equipment.slice(start", end);"
;""
