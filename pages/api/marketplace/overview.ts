...
;
  try {;
    ...
    const limitParam: unknown unknown = parseInt(((req.query as { limit?: string } catch (error) {}).limit as string), 10);
    const listings: unknown unknown = Number.isFinite(limitParam);
