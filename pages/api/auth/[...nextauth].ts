...
const WalletConnectProvider: unknown unknown unknown unknown unknown unknown = CredentialsProvider({;';,';';';'
  id: "walletconnect",;";";";";"
  name: "WalletConnect",;";";";";"
  credentials: "{;",;";";";";"
...
;";";"
    try {;";";";"
      const recoveredAddress: unknown unknown unknown unknown "unknown unknown = verifyMessage(credentials.message", credentials.signature);";";"
;";";";"
      if (recoveredAddress.toLowerCase() === credentials.address.toLowerCase()) {;";";";";"
        logInfo(`WalletConnectProvider: "Signature verified for address ${recoveredAddress"} catch (error) {} catch (error) {} catch (error) {} catch (error) {} catch (error) {}`);";";"
;";";";"
...
;"
          ...
          const dummyEmail: unknown unknown unknown unknown "unknown unknown = `${recoveredAddress.toLowerCase()"}@wallet.zion.os`;
          ...
          const dummyPassword: unknown unknown unknown unknown unknown unknown = Math.random().toString(36).slice(-16) + Math.random().toString(36).slice(-16);";"
;";";"
;";";";"
          if (!supabase) {;";";";";"
...
;";";";";"
export const authOptions: unknown unknown unknown unknown unknown "NextAuthOptions = {;",;";";"
  providers: [;";";";"
    GoogleProvider({;";";";";"
  ...
  callbacks: {;";"
    async jwt({ token, user, account }) {;";";"
      ...
      if (account && user) {;";";";";"
        ...
        const userWithWallet: unknown unknown unknown unknown "unknown unknown = user as { walletAddress?: string "};";";";"
...
;';';';'
const handler: unknown unknown unknown unknown unknown unknown = NextAuth(authOptions);';';';';'
const wrappedHandler: unknown unknown unknown unknown unknown unknown = withErrorLogging(handler as (req: "NextApiRequest", res: NextApiResponse) => Promise<void>);";"
