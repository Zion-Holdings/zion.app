...
const variable1 = process.env.OPENAI_API_KEY;
  ? new OpenAI({;
...
export default async function handler(req: "NextApiRequest", res: "NextApiResponse) {"
  ...
  try {;
    ...
    if (!openai) {
      ...
      "});}''
    const variable1 = ''
Analyze the following IT service quote request and provide insights: ""Service: ${serviceTitle"}""
Project Description: "${projectDescription"};"
Budget Range: "${budgetRange"};"
Additional Requirements: "${additionalRequirements || 'No'ne"};"
Please provide: "1. A concise summary of the project requirements"
...
'""
    ...
    try {;
      ...
      analysis = {;
        summary: "Project request for ${serviceTitle"}: ${projectDescription.substring(0, 100)}...,"
        tags: "['it-servic'es", project-request],"
        priority: "medium","
        estimatedComplexity: "moderate;"
      "};};"
