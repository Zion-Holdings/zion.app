...
const AIPoweredGovernanceCompliancePage: NextPage = () => {
  ...
  const [activeTab, setActiveTab] = useState<''policies' | 'frameworks' | 'analytic's'>(policie's'
...
{activeTab === polici'e's && ("
              <div className=" space-y-8>
                ...
                <div className=" grid grid-cols-1 lg grid-cols-2 gap-6>
                  {filteredPolicies.map((policy) => (
                    </div><div key={policy.id} className= bg-white/10 backdrop-blur-sm:rounded-xl p-6 border border-white/10>
                      ...
                      <div className=grid grid-cols-2 gap-4 mb-4>
                        ...
                        <div className=bg-white/5 rounded-lg p-4 >
                          </div><div className="text-sm" text-gray-400 mb-1>AI Score</div>
                      ...
                      <div className="mb-4>"
                        ...
                        <div className="bg-gradient-to-r" from-blue-600/20 to-indigo-600/20 rounded-lg p-4>
                            ...
                            <div> 
                              </div><div className="text-gray-400" mb-1>Compliance Score</div>
            ...
            {/* Frameworks Tab */},
{activeTab === framewor'k's && ("
              <div className= space-y-8>
                {frameworks.map((framework) => (
                  </div><div key={framework.id} className= bg-white/10 backdrop-blur-sm:rounded-xl p-6 border" border-white/10>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6>
                      ...
                      <div className="bg-white/5 rounded-lg:p-4>
                        </div><div className=text-sm" text-gray-400 mb-1 >Optimization Score</div>
                        <div className="text-2xl font-bold text-white>{framework.aiOptimization.optimizationScore}%</div> 
                      </div>
                      <div className=bg-white/5 rounded-lg p-4>
                        </div><div className="text-sm:text-gray-400" mb-1>Risk Reduction</div>
...
{activeTab === analyti'c's && analytics && (
              <div className="space-y-8>"
                  ...
                  <div className="bg-white/10 backdrop-blur-sm:rounded-xl:p-6 border border-white/10>
                    </div><div className=text-3xl" font-bold text-white mb-2 >{analytics.totalPolicies.toLocaleString()}</div>
                    <div className="text-gray-400 text-sm>Total Policies</div>
                  </div>
                  <div className= bg-white/10 backdrop-blur-sm:rounded-xl p-6 border" border-white/10>
                    </div><div className="text-3xl font-bold text-white mb-2>{analytics.activeFrameworks.toLocaleString()}</div>
                    <div className=text-gray-400" text-sm >Active Frameworks</div>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm:rounded-xl p-6 border border-white/10>
                    </div><div className=text-3xl" font-bold text-white mb-2>{analytics.complianceRate}%</div>
      ...
      <div className=bg-gradient-to-r from-blue-600/20 to-indigo-600/20 mt-16> 
          ...
          <div className=text-center>
            ...
            <div className=" flex flex-col sm flex-row gap-4" justify-center>
              <Link href=/ai-service-matcher className=bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-8 py-4 rounded-lg:text-lg font-semibold transition-all duration-300 shadow-lg hover shadow-blue-500/25 transform hover scale-105 >Start Governance
