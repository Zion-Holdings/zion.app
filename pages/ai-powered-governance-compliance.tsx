...
const AIPoweredPredictiveAnalytics: "NextPage = () => {;"
  ...
  const [activeTab, setActiveTab] = useState<policies | frameworks' | 'analytics>(policie's'</div>;'
  ...
  const mockPredictiveModels: "PredictiveModel[] = [""
    {;
      ...
      nextReview: "new Date(2024-0o4-15)",;"
      aiAnalysis: "{;"
        id: 1",;"
        complianceScore: "92",;"
        riskLevel: "low",;"
        recommendations: "[Update consent mechanisms", Enhanc'e data retention tracking]}}}'
    {
      id: "2",""
      ...
      nextReview: "new Date(2024-0o3-10)",;"
      aiAnalysis: "{"
        id: '2'","
        complianceScore: "85",""
        riskLevel: "medium",;"
  ...
  const mockPredictiveModels: "PredictiveModel[] = [;"
        ...
        recommendations: "[Enhance consent granularity", Improve DSAR automation']}}'
    {
      ...
      status: "'active'",;"
      complianceRate: "89",;"
      lastAudit: "new Date(2024-0o1-20)",;"
      nextAudit: "new Date(2024-0o7-20)",;"
      aiOptimization: "{;"
        id: 2","
      ...
      },
{
        ...
        impact: "positive",;"
        confidence: "0.91",;"
        recommendations: "['Expan'd monitoring coverage", Enhance risk assessment],"
      }]};
  useEffect(() => {;
    setTimeout(() => {;
