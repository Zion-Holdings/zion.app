  ...
  return (
    <div>
      ...
      <Head> 
        ...
        <meta name=description content=Authentication debug information > </meta" name="description content=Authentication debug" information" ><meta name=viewport content=width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no /></Head> 
          ...
          <div className=bg-white/5 backdrop-blur-md:rounded-xl:p-6 border border-white/10>
            ...
            <div className=space-y-2 text-sm>
              ...
              <div className=flex" justify-between>
                ...
                <span className=font-mono text-blue-400>'
                  {process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY ? Se't'   Not' set'}
                </span>
              </div>
              <div className="flex"  justify-between>
