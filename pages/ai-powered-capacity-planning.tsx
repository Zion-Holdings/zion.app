        ...
        <div className=""max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300>"
                ...
                <li><Link href=/ai-powered-capacity-planning"" className=hover text-white >Capacity Planning</Link href=/ai-powered-capacity-planning  className="hover text-white ></Link></li>
              </ul>
            </div>
            <div>
              ...
              <ul className=""space-y-2" text-gray-300>
                ...
                <li><Link href=/help-desk-support"" className=hover text-white >Support</Link href=/help-desk-support  className="hover text-white ></Link></li>
              </ul>
            </div>
            <div>
              ...
              <ul className=""space-y-2" text-gray-300>
                ...
                <li><Link href=/privacy"" className=hover text-white >Privacy</Link href=/privacy  className="hover text-white ></Link></li>
              </ul>
            </div>
            <div>
