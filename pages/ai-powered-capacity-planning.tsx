  ...
  return (
    <div className="relative z-10 container-responsive py-8">
      ...
      <Head>
        ...
        <meta name="description" content="Comprehensive capacity planning with AI-powered demand forecasting, resource optimization, and planning analytics." />
        <meta name="keywords" content="capacity planning, demand forecasting, resource optimization, AI analytics, Zion" />
                  ...
                  <div className="bg-white/10 backdrop-blur-md rounded-lg p-6 border border-white/20">
                    ...
                    <div className="space-y-3">
                      {demandForecasts.slice(0, 5).map((forecast) => (
                        <div key={forecast.id} className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
                          <div>
                            <p className="text-white font-medium">{forecast.resource}</p>
                            <p className="text-gray-300 text-sm">{forecast.period}</p>
                          </div>
                          <span className={`px-2 py-1 rounded-full text-xs font-medium ${getTrendColor(forecast.trend)}`}>
                            {forecast.trend}
                          </span>
                        </div>
                      ))}
                      ...
                      <tbody className="divide-y divide-white/10">
                        {demandForecasts.map((forecast) => (
                          <tr key={forecast.id} className="hover:bg-white/5">
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div>
                                <div className="text-sm font-medium text-white">{forecast.resource}</div>
                              </div>
                            </td>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getTrendColor(forecast.trend)}`}>
                                {forecast.trend}
                              </span>
                            </td>
                          ...
                          <tr key={recommendation.id} className="hover:bg-white/5">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                                ...
                                recommendation.status === 'approved' ? 'bg-blue-100 text-blue-800' :
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                ...
                <li><Link href="/ai-powered-capacity-planning" className="hover:text-white">Capacity Planning</Link></li>
              </ul>
            </div>
            <div>
