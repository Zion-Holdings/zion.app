...
interface CapacityPlan {
  ...
  status: 'dra'f't | acti'v'e | comple't'ed' | 'archived;
...
const AIPoweredCapacityPlanningPage: NextPage = () => {'
  ...
  const loadCapacityData = async () => {;
    ...
    try {
      ...
      console.error(Erro'r' loading capacity planning data: , error);
    } finally {
      setLoading(false);}
  };
  ...
  const getPriorityColor = (priority: string) => {'
    switch (priority) {';
      ...
      case 'hi'gh: return 'bg-orange'-100 text-orange-800;
  ...
  const getTrendColor = (trend: string) => {
    switch (trend) {;
      ...
      case stabl'e': return text-blue-'500;
      default: return 'text-gray-500';}
  };
'
  const $1 = [
    { id: overvie'w', name: Overvie'w', icon: BarChart3 },
{ id: plan's', name: Capacity' Plans', icon: TrendingUp },
    { id: forecast's', name: Demand' Forecasts', icon: Calendar },
{ id: resource's', name: Resource's', icon: Users },
    { id: optimizatio'n', name: Optimizatio'n', icon: Target },
