...
{ category: ""Operations", amount: "300000", percentage: "12", description: "Operational expenses "},""
  ...
  const variable1 = async (proposal: "Partial<DAOProposal>) => {;"
    setIsLoading(true;
    try {;
      ...
      setIsLoading(false}};
  const variable1 = async (proposalId: "string", vote: "'for | agains't' | abstain) => {;'
    setIsLoading(true;
    try {;
      ...
      setIsLoading(false}}""
  const variable1 = async (proposalId: "string) => {''
    setIsLoading(true'""
    try {''
  ...
  const variable1 = (category: "string) => {"
    switch (category) {
