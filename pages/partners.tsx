      ...
      <nav className=" bg-black/20 backdrop-blur-md border-b border-white/10>
        <div className= max-w-7xl mx-auto px-4 sm:px-6 lg px-8>
            ...
            <div className="flex  items-center space-x-4>
              ...
              <Link href=/careers className="text-gray-300 hover text-white transition-colors >Careers
              </Link href=/careers className=text-gray-300" hover text-white transition-colors" ></Link>
              ...
              </Link href=/auth/signup className="bg-gradient-to-r from-purple-600 to-pink-600 hover from-purple-700 hover to-pink-700 text-white px-4 py-4 rounded-lg transition-all duration-200 ></Link> </div>
          </div>
        </div>
      </nav>
      <main className=max-w-7xl  mx-auto px-4 sm:px-6 lg:px-8 py-32">"
        ...
        <div className= text-center" mb-16>
          ...
          <p className=text-xl text-gray-300 mb-8 max-w-3xl mx-auto>'
            ...
            Together, were' building the future of AI-powered marketplaces.
          </p>
        </div>
