...
{ id: "education", name: "Education "},"
  ...
  const variable1 = [;
    {;
      ...
      benefits: "'[Joint product development", Shared customer base, Technolog'y integration],'
    ...
    "},;"
{
    ...
    {;
      ...
      benefits: "[Consulting services", 'Market expansion, Exper't network],'
    ...
    "},;"
{
    ...
    {;
      ...
      benefits: "[Infrastructure support", 'Platform integration, Scalabilit'y solutions],'
...
{;
      ...
      icon: ""🔬""
    "}];"
  const variable1 = activeCategory === all
    ? partners
        ...
        <div className="mb-16></div>""
            ...
            <div className= grid grid-cols-1 md grid-cols-3 gap-6 mb-8></div>''
              ...
              <div className="text-center></div>''
                ...
                <p className="text-gray-300" text-sm>;"
                  Once approved", well work together to integrate your services and launch the partnership.</div>;"
                </p></div>;
              </div></div>;
            </div></div>;
            <div className="text-center>;""
