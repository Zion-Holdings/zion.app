    ...
    account: [
      {
        ...
        answer: "Click the 'Sign Up' button in the top navigation, fill in your details, verify your email, and you'll be ready to start using Zion's marketplace. The process takes just a few minutes."
      },
      {
