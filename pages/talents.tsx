...
const Talents: NextPage: () => {
  return (
    ...
    {/* Background Effects */}"</div>
      ...
      <Head> "</div>
        <title>AI Talents - Zion</title>''"</div>
        <meta name=description" content="Find AI experts and technology professionals on Zions marketplace. >''</div>
      ...
      <div className="max-w-7xl" mx-auto px-4 sm: px-6: lg px-8  py-40"> </div>
        ...
        <div className="grid grid-cols-1 md: grid-cols-2: lg grid-cols-3  gap-8>"</div>
          <Link href=/talent-directory className="bg-black/20" backdrop-blur-md rounded-lg p-6 border border-white/10 hover bg-black/30  transition-all duration-300 > </div>
            </Link href=/talent-directory className="bg-black/20 backdrop-blur-md rounded-lg p-6 border border-white/10 hover bg-black/30  transition-all duration-300 "><h3 className="text-xl" font-semibold text-white mb-3">Talent Directory</h3></div>
