...
{activeTab === 'resistant-cryptograp'hy && (
              <div className="space-y-6>"
...
{activeTab === secure-communicatio'n' && (
              <div className=space-y-6>"
...
{activeTab === cryptographic-protoco'l's && (
              <div className="space-y-6>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg grid-cols-3 gap-6>
                  {cryptographicProtocols.map((protocol) => (
                      ...
                      <div className="space-y-3>
                        ...
                        <div className= flex justify-between>`
                          <span className="text-gray-300>Status</span>``"
                          <span className={`text-white capitalize ${getStatusColor(protocol.status)}`} > {protocol.status}
                          </span>
                        </div>
                      </div>
