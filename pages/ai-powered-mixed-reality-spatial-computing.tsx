...
const AIPoweredMixedRealitySpatialComputingPage: NextPage = () => {
  ...
  const [selectedView, setSelectedView] = useState<'overvi'e'w | experienc'e's | spat'i'al' | 'digital-tw'i'n | technolo'g'y | insig'h'ts'>('overview
      ...
      },
{
  ...
  const filteredMixedRealityExperiences = useMemo(() => {
    return mixedRealityExperiences.filter(experience => {
      const typeMatch = selectedType === a'l'l || experience.type === selectedType
      return typeMatch}
