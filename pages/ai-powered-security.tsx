              ...
              <div key={event.id} className="bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className={`px-2 py-1 rounded text-xs font-medium ${getSeverityColor(event.aiAnalysis.threatLevel)}`}>
                  ...
                  <div>
                    ...
                    <span className={`px-3 py-1 rounded-full text-xs font-medium ${getActionColor(event.action)} bg-opacity-20`}>
