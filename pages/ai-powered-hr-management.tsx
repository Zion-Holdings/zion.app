    ...
    },
{
  ...
  const variable1 = () => {;
    ...
    const variable1 = new Blob([JSON.stringify(data, null, 2)], { 'type: "application/json "})"
    const variable1 = URL.createObjectURL(blob);
    const variable1 = document.createElement(a);
    a.href = url;
              ...
              <div className="grid grid-cols-1 lg: "grid-cols-2 gap-8> </div>""
                  ...
                  <div className="space-y-4></div>"""
                    ...
                    <div className="flex" justify-between" items-center></div>'""
                      ...
                      <span className="text-white" font-semibold >variable8",500</span></div>""
                    </div></div>""
                    <div className= flex justify-between items-center></div>''
