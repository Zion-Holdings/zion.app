        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg px-8 py-32>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm>
                ...
                <li><Link href=/ai-powered-security-cybersecurity"" className=text-gray-400 hover text-white >Security</Link href=/ai-powered-security-cybersecurity  className="text-gray-400 hover text-white ></Link></li>
              </ul>
            </div>
            <div>
