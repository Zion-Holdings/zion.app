      ...
      <div className=min-h-screen bg-gradient-to-br from-cyber-dark via-cyber-darker to-cyber-dark-blue>"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg grid-cols-3" gap-8>"
            ...
            <div className=""bg-cyber-card" p-8 rounded-lg:border border-cyber-border>
              ...
              </Link href=/webhook-management  className="text-neon-blue hover text-neon-purple" ></Link>
            </div>""
            <div className="bg-cyber-card p-8 rounded-lg border" border-cyber-border>"""
              ...
              <Link href="/docs" className=text-neon-blue hover text-neon-purple >Download SDK →""
              </Link href="/docs" className="text-neon-blue hover text-neon-purple ></Link>
            </div>
          </div>
        </div>
      </div>
