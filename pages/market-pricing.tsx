        ...
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-black/30 rounded-2xl border border-cyan-500/30 p-6">
              ...
              <ul className="list-disc list-inside text-slate-300 space-y-1">
                				                <li>OpenAI Safety: <a className="text-cyan-400 underline" href={`https://platform.openai.com/docs/guides/safety`} target="_blank" rel="noopener noreferrer">platform.openai.com/docs/guides/safety</a></li>
            ...
            <div className="bg-black/30 rounded-2xl border border-amber-500/30 p-6">
              ...
              <div className="text-sm text-slate-400 mt-3">Typical SMB budgets: $100–$2,000/month based on traffic and protections.</div>
                ...
                <ul className="list-disc list-inside text-slate-300 space-y-1">
                  ...
                  <li>Transcend: <a className="text-cyan-400 underline" href={`https://www.transcend.io`} target="_blank" rel="noopener noreferrer">transcend.io</a></li>
                </ul>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-black/30 rounded-2xl border border-indigo-500/30 p-6">
              ...
              <ul className="list-disc list-inside text-slate-300 space-y-1">
                ...
                <li>Grafana SLO: <a className="text-cyan-400 underline" href={`https://grafana.com/docs/grafana-cloud/monitor-infrastructure/`} target="_blank" rel="noopener noreferrer">grafana.com/docs/.../monitor-infrastructure</a></li>
