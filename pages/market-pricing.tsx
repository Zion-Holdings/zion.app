          ...
          <div className="space-y-6">
            <div className="bg-black/30 rounded-2xl border border-cyan-500/30 p-6">
              ...
              <ul className="list-disc list-inside text-slate-300 space-y-1">
                ...
                <li>Weights & Biases pricing: <a className="text-cyan-400 underline" href={`https://wandb.ai/site/pricing`} target="_blank" rel="noopener noreferrer">wandb.ai/site/pricing</a></li>
                <li>Replicate pricing: <a className="text-cyan-400 underline" href={`https://replicate.com/pricing`} target="_blank" rel="noopener noreferrer">replicate.com/pricing</a></li>
              </ul>
            ...
            <div className="bg-black/30 rounded-2xl border border-amber-500/30 p-6">
              ...
              <ul className="list-disc list-inside text-slate-300 space-y-1">
                ...
                <li>Netlify pricing: <a className="text-cyan-400 underline" href={`https://www.netlify.com/pricing/`} target="_blank" rel="noopener noreferrer">netlify.com/pricing</a></li>
              </ul>
            ...
            <div className="bg-black/30 rounded-2xl border border-pink-500/30 p-6">
              <h2 className="text-2xl font-semibold mb-2">Observability & Ops</h2>
              <ul className="list-disc list-inside text-slate-300 space-y-1">
              ...
              <div className="text-sm text-slate-400 mt-3">Typical SMB budgets: $100–$2,500/month depending on data volume and retention.</div>
            </div>
          </div>
        </div>
      </div>
