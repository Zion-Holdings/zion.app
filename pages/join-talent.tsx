        ...
        <div className=""max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm >
                ...
                <li><Link href=/equipment"" className=text-high-contrast-tertiary hover text-white transition-colors >Equipment</Link href=/equipment  className="text-high-contrast-tertiary hover text-white transition-colors ></Link></li>
              </ul>
            </div>
            <div>
              ...
              <ul className=""space-y-2" text-sm>
                ...
                <li><Link href=/blog"" className=text-high-contrast-tertiary hover text-white transition-colors >Blog</Link href=/blog  className="text-high-contrast-tertiary hover text-white transition-colors ></Link></li>
              </ul>
            </div>
            <div>
