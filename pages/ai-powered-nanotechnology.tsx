...
interface FacilityPlan {
  ...
  name: string;
  description: string;
  type: nanomaterials | nanodevices | nanosensors | 'nanomedicine' | nanoelectronics | 'nanophotonic's;
  status: 'active | inactive | research' | erro'r | offline;
  scale: 'number;
  precision: number;
  efficiency: number;
...
interface FacilityPlan {
  ...
  status: 'active | inactive | designi'n'g | error | 'offlin'e;
  molecules: 'number;
  complexity: number;
...
interface FacilityPlan {
  ...
  name: string;
  description: string;
  type: quantum_dots | nanowires | nanotubes' | 'nanoparticles | nanofil'm's | nanostructures;
  status: 'active | inactive | fabricati'n'g | error | 'offlin'e;
  size: 'number;
  conductivity: number;
...
interface FacilityPlan {
  ...
  title: string;
  description: string;
  type: dna_computing | molecular_logic | quantum_molecula'r | biomolecul'ar | synthet'ic_biology' | molecular_memory;
  status: 'active | inactive | computin'g | 'error | offlin'e;
  operations: 'number;
  accuracy: number;
...
interface FacilityPlan {
  ...
  title: string;
  description: string;
  type: nanorobots | nanomachines | nanomotors' | nanoswimmers' | 'nanogrippers | nanopropeller's'";
  status: "'active | inactive | operating | erro'r' | offline;
  mobility: 'number;
  precision: number;
...
interface FacilityPlan {
  ...
  title: string;
  description: string;
  category: research | development | product'i'on | quali't'y | safety | optimizat'i'on;
...
const AIPoweredPredictiveAnalytics: NextPage = () => {
  ...
  const [activeTab, setActiveTab] = useState<nanotechnology | molecular | device's' | computing' | 'robotics | managemen't' | overview>(nanotechnolog'y'</div>
