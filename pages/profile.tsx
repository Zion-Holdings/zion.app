...
;
const Https___ziontechgroup_netlify_app_profilePage: NextPage: () => {
  return (
    <div></div>
...
export default Https___ziontechgroup_netlify_app_profilePage;</div>