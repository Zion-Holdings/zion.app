  ...
  return (
    <UltraAdvancedFuturisticBackground>
      <Head>
        ...
        <link rel="canonical" href="https://ziontechgroup.com/webhook-relay-replay" />
      </Head>
      <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 bg-clip-text text-transparent flex items-center justify-center gap-3"><RefreshCcw className="w-10 h-10" />{service.name}</h1>
