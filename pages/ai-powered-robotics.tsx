              ...
              <div key={robot.id} className="bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="text-right">
                    ...
                    <div className="mt-2">
                      <span className={`px-2 py-1 rounded text-xs font-medium ${robot.aiEnabled ? 'text-green-400 bg-green-500/20' : 'text-red-400 bg-red-500/20'}`}>
                  ...
                  <div className="space-y-1">
                    {robot.sensors.map((sensor, index) => (
                      <div key={index} className="flex items-center justify-between text-xs">
                        ...
                        <span className={`px-2 py-1 rounded text-xs ${sensor.status === 'active' ? 'text-green-400 bg-green-500/20' : sensor.status === 'error' ? 'text-red-400 bg-red-500/20' : 'text-gray-400 bg-gray-500/20'}`}>
                          {sensor.status}
                        </span>
                      </div>
                    ))}
              ...
              <div key={task.id} className="bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="text-right">
                    ...
                    <div className="mt-2">
                      <span className={`px-2 py-1 rounded text-xs font-medium ${task.aiAssisted ? 'text-green-400 bg-green-500/20' : 'text-red-400 bg-red-500/20'}`}>
