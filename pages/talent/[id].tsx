  ...
  return (
    <div>
      <Head>"
        ...
        <meta name = description content={`${talent.full_name} - ${talent.title}. ${talent.summary}`} > </meta name=description"" content={`${talent.full_name} - ${talent.title}. ${talent.summary}`} ><meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no /></Head>"
"""
...
""
                ...
                <div>
                  ...
                  {reviews.length > 0 ? ("""
                    <div className="space-y-4">"
                      {reviews.map((review) => (""
                        </div><div key={review.id} className="border border-gray-200 rounded-lg" p-4>""
            ...
            <div className=lg  col-span-1>"
              </div><div className="bg-white rounded-xl:shadow-lg p-6 sticky" top-8>"""'
