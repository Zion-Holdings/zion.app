...
const handleApiResponse: unknown unknown unknown unknown unknown unknown = async (res: Response) => {;";";";"
  if (!res.ok) {;";";";";"
...
;
const TalentPage: unknown unknown unknown unknown unknown React.FC = () => {;
...
;
  const { data, error, isLoading } = useSWR<TalentProfile | null>(;
    ...
    async (url: string) => {;
      const result: unknown unknown unknown unknown unknown TalentProfileResponse = await fetch(url).then(handleApiResponse);
