...
const Https___ziontechgroup_netlify_app_helpPage: NextPage = () => {
  return (
    <div>
      ...
      <Head>
        ...
        <meta name="keywords" content="https //ziontechgroup.netlify.app/help/, Zion, AI marketplace" />
...
export default Https___ziontechgroup_netlify_app_helpPage)