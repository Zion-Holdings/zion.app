...
;
const Https___ziontechgroup_netlify_app_contactPage: NextPage = () => {
  return (
    <div></div>
      ...
      <Head> </div>
        <title>Contact Us - Zion Tech Group</title></div>
        <meta name="description" content="Get in touch with our team > </meta name=description" content="Get in touch with our team ><meta name="keywords content=https //ziontechgroup.netlify.app/contact, Zion, AI marketplace > </meta" name=keywords content="https //ziontechgroup.netlify.app/contact, Zion, AI" marketplace ><meta name=viewport" content=width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no /></Head>
              ...
              <div className="mb-8""></div>
                <h1 className=" text-4xl md text-6xlfont-bold text-white mb-6>"</div>
                  <span className="text-transparent" bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">
                    Contact Us - Zion Tech Group</div>
                  </span></div>
                </h1></div>
...
;}
export default Https___ziontechgroup_netlify_app_contactPage)"'"</div>