                ...
                {financialServices.slice(0, 3).map((service) => (
                  <div key={service.id} className="p-4 bg-white/5 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className={`px-2 py-1 rounded text-xs font-medium ${getStatusBgColor(service.status)} text-white`}>
                        {service.status}
                      </span>
                    </div>
                ...
                {bankingOperations.slice(0, 2).map((operation) => (
                  <div key={operation.id} className="p-4 bg-white/5 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className={`px-2 py-1 rounded text-xs font-medium ${getStatusBgColor(operation.status)} text-white`}>
                        {operation.status}
                      </span>
                    </div>
              ...
              {filteredFinancialServices.map((service) => (
                <div key={service.id} className="bg-black/20 rounded-lg p-6 border border-white/10">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className={`px-3 py-1 rounded-full text-sm ${getStatusBgColor(service.status)} text-white`}>
                      {service.status}
                    </span>
                  </div>
              ...
              {bankingOperations.map((operation) => (
                <div key={operation.id} className="bg-black/20 rounded-lg p-6 border border-white/10">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className={`px-3 py-1 rounded-full text-sm ${getStatusBgColor(operation.status)} text-white`}>
                      {operation.status}
                    </span>
                  </div>
              ...
              {riskManagement.map((risk) => (
                <div key={risk.id} className="bg-black/20 rounded-lg p-6 border border-white/10">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className={`px-3 py-1 rounded-full text-sm ${getStatusBgColor(risk.status)} text-white`}>
                      {risk.status}
                    </span>
                  </div>
