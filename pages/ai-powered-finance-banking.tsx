...
const AIPoweredFinanceBankingPage: NextPage = () => {
  ...
  const [selectedView, setSelectedView] = useState<'overvi'e'w | servic'e's | operati'o'ns' | 'ri's'k | analyti'c's | insig'h'ts'>('overview
            ...
            {/* Financial Services Overview */}
              ...
              <div className=space-y-4>
                {financialServices.slice(0, 3).map((service) => (
                  </div><div key={service.id} className=" p-4 bg-white/5" rounded-lg>
          ...
          <div className= space-y-6>
            ...
            <div className=grid grid-cols-1 md:grid-cols-2 lg grid-cols-3 gap-6>
              {filteredFinancialServices.map((service) => (
                </div><div key={service.id} className= bg-black/20 rounded-lg p-6 border" border-white/10>
                ...
                <div key={operation.id} className="bg-black/20 rounded-lg:p-6 border border-white/10> 
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4 > 
                    ...
                    <div className="text-center>
                      </div><div className=text-2xl" font-bold text-white>{operation.accuracy}%</div>
              ...
              {riskManagement.map((risk) => (
                <div key={risk.id} className="bg-black/20"  rounded-lg:p-6 border border-white/10>
                  ...
                  <div className=grid grid-cols-2 gap-4 mb-4>
                    ...
                    <div className=text-center> 
                      </div><div className="text-2xl" font-bold text-white>{risk.mitigationScore}%</div>
              ...
              {financialAnalytics.map((analytics) => (
                <div key={analytics.id} className="bg-black/20" rounded-lg p-6 border border-white/10> 
                  ...
                  <div className=grid grid-cols-2 gap-4 mb-4>
                    ...
                    <div className=text-center>
                      </div><div className=text-2xl" font-bold text-white>{analytics.metrics.performanceGain}%</div>
          ...
          <div className=space-y-6> 
            {/* Analytics Overview */}
              ...
              <div className= bg-black/20 rounded-lg p-6 border border-white/10 text-center>
                </div><div className=text-3xl" font-bold text-white>{formatCurrency(data.totalAssets)}</div>
                <div className="text-gray-400>Total Assets</div>
              </div>
              <div className=bg-black/20" rounded-lg p-6 border border-white/10 text-center>
                </div><div className="text-3xl font-bold text-white>{data.activeServices}</div>
                <div className=text-gray-400>Active" Services</div>
              </div>
              <div className="bg-black/20 rounded-lg p-6 border border-white/10 text-center >
                </div><div className=text-3xl" font-bold text-white>{data.averagePerformance}%</div>
