  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <main className="container mx-auto px-6 py-12 prose prose-invert">
        ...
        <div className="mt-4" dangerouslySetInnerHTML={{ __html: "<p>Signal source: <a className=\"text-cyan-300 underline\" href=\"https://ziontechgroup.com/main/front\" target=\"_blank\" rel=\"noopener\">https://ziontechgroup.com/main/front</a></p><h2>Purpose</h2><p>Operational steps to execute reliably with measurable outcomes.</p><h2>Checklist</h2><ol><li>Define objectives, KPIs, and guardrails.</li><li>Inventory data, models, tools, and constraints.</li><li>Design evaluation and feedback loops upfront.</li><li>Implement smallest viable slice with telemetry.</li><li>Iterate, measure, and harden for production.</li></ol><h2>Notes</h2><p className=\"text-white/75\">ZionHomeCommandFeaturesMapSuitesCapabilitiesUse CasesPillarsBenefitsTemplatesDemosHighlightsCasesReportsDocsAutomationsMenuFront systems hub — tailored view of our autonomous capabilitiesFuturistic Front ExperienceFeature Map•Capabilities•Benefits•IntegrationsExplore the features, capabilities, and </p>" }} />
