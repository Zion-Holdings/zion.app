      ...
      <main className="container mx-auto px-6 py-12 max-w-6xl">
        ...
        <section className="mb-12">
          <div className="bg-slate-900/50 border border-white/10 rounded-lg p-8">
            <h2 className="text-3xl font-bold text-white mb-6 text-center">Our Methodology</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="bg-cyan-500/20 border border-cyan-500/30 rounded-lg p-4 mb-4">
                ...
                <p className="text-white/70 text-sm">
                  Deep dive into business challenges, technical constraints, and success metrics
                </p>
              </div>
              
              <div className="text-center">
                <div className="bg-fuchsia-500/20 border border-fuchsia-500/30 rounded-lg p-4 mb-4">
                  <div className="text-2xl font-bold text-fuchsia-400">2</div>
                </div>
                <h3 className="text-xl font-semibold text-white mb-2">Solution Design</h3>
                <p className="text-white/70 text-sm">
                  Custom AI-powered solution architecture with autonomous capabilities
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-white mb-2">Implementation & Results</h3>
                <p className="text-white/70 text-sm">
        ...
        {/* Success Metrics */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-white mb-6 text-center">Success Metrics We Deliver</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-slate-900/50 border border-white/10 rounded-lg p-6 text-center">
              <div className="text-4xl font-bold text-green-400 mb-2">40-80%</div>
              <div className="text-white/70 text-sm">Performance Improvement</div>
            </div>
            <div className="bg-slate-900/50 border border-white/10 rounded-lg p-6 text-center">
            ...
            <div className="bg-slate-900/50 border border-white/10 rounded-lg p-6 text-center">
              <div className="text-4xl font-bold text-cyan-400 mb-2">3-6</div>
              <div className="text-white/70 text-sm">Months to ROI</div>
            </div>
          </div>
        </section>
