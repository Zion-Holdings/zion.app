  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <Head>
        ...
        <meta property="og:title" content="Capability Map — Generative AI Systems" />
        <meta property="og:description" content="Innovative, useful guidance to reduce latency and cost." />
        <meta name="twitter:card" content="summary_large_image" />
      </Head>
      <main className="container mx-auto px-6 py-12 prose prose-invert">
        <h1 className="text-3xl font-extrabold">Capability Map — Generative AI Systems</h1>
        <p className="text-white/70">Innovative, useful guidance to reduce latency and cost.</p>
        <ul className="mt-6 list-disc pl-6 space-y-2">
          <li>Scope and objectives: Capability Map for Generative AI Systems.</li>
