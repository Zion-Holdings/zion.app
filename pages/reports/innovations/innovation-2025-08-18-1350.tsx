...
export default function InnovationPage() {
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <Head>
        <title>Case Study Template — Retrieval-Augmented Generation</title>
        <meta name="description" content="Autonomously generated innovations content." />
        <meta property="og:title" content="Case Study Template — Retrieval-Augmented Generation" />
        <meta property="og:description" content="Innovative, useful guidance to reduce latency and cost." />
        <meta name="twitter:card" content="summary_large_image" />
      </Head>
      <main className="container mx-auto px-6 py-12 prose prose-invert">
        <h1 className="text-3xl font-extrabold">Case Study Template — Retrieval-Augmented Generation</h1>
        <p className="text-white/70">Innovative, useful guidance to reduce latency and cost.</p>
        <ul className="mt-6 list-disc pl-6 space-y-2">
          <li>Scope and objectives: Case Study Template for Retrieval-Augmented Generation.</li>
