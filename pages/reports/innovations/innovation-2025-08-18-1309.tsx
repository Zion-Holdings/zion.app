...
export default function InnovationPage() {
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <Head>
        <title>Case Study Template — Generative AI Systems</title>
        <meta name="description" content="Autonomously generated innovations content." />
        <meta property="og:title" content="Case Study Template — Generative AI Systems" />
        <meta property="og:description" content="Innovative, useful guidance to improve retrieval quality." />
        <meta name="twitter:card" content="summary_large_image" />
      </Head>
      <main className="container mx-auto px-6 py-12 prose prose-invert">
        <h1 className="text-3xl font-extrabold">Case Study Template — Generative AI Systems</h1>
        <p className="text-white/70">Innovative, useful guidance to improve retrieval quality.</p>
        <ul className="mt-6 list-disc pl-6 space-y-2">
          <li>Scope and objectives: Case Study Template for Generative AI Systems.</li>
