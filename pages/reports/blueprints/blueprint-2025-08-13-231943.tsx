  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <main className="container mx-auto px-6 py-12 prose prose-invert">
        ...
        <div className="mt-4"><p>Signal source: <a className="text-cyan-300 underline" href="https://ziontechgroup.com" target="_blank" rel="noopener">https://ziontechgroup.com</a></p><h2>Components</h2><ul><li>Ingestion & normalization</li><li>Knowledge index</li><li>Generation & evaluation</li><li>Publishing</li><li>Observability</li></ul><h2>Flows</h2><ol><li>Collect</li><li>Synthesize</li><li>Review</li><li>Publish</li><li>Measure</li></ol></div>
