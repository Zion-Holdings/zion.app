...
export default function UpdatePage() {
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <Head>
        <title>Autonomous Checklist — AI Service Design (2025-08-14 06:50 UTC)</title>
        ...
        <meta property="og:title" content="Autonomous Checklist — AI Service Design (2025-08-14 06:50 UTC)" />
      ...
      <main className="container mx-auto px-6 py-12 prose prose-invert">
        <h1 className="text-3xl font-extrabold">Autonomous Checklist — AI Service Design (2025-08-14 06:50 UTC)</h1>
