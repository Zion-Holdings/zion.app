...
const Https___ziontechgroup_netlify_app_privacyPage: NextPage = () => {
  return (
    <div></div>
      ...
      <Head> </div>
        <title>Privacy Policy - Zion Tech Group</title></div>
              ...
              <div className="mb-8""></div>
                <h1 className=" text-4xl md text-6xlfont-bold text-white mb-6>"</div>
                  <span className="text-transparent" bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">
                    Privacy Policy - Zion Tech Group</div>
                  </span></div>
                </h1></div>
                <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed >
                  Our commitment to protecting your privacy</div>
                </p>"</div>
              </div>"</div>
...
;}
export default Https___ziontechgroup_netlify_app_privacyPage)"'"</div>