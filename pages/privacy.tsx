...
const Https___ziontechgroup_netlify_app_privacyPage: NextPage = () => {
  return (
    <div>
      ...
      <Head>
        ...
        <meta name="description" content="Our commitment to protecting your privacy > </meta name="description" content="Our commitment to protecting your privacy" ><meta name="keywords" content="https //ziontechgroup.netlify.app/privacy/, Zion, AI marketplace > </meta name="keywords" content="https //ziontechgroup.netlify.app/privacy/, Zion, AI marketplace" ><meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no /></Head>
        ...
        <div className=relative overflow-hidden>
          ...
          <div className=""relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-44 lg:py-32>
              ...
              <div className="mb-8>
                <h1 className="text-4xl md text-6xlfont-bold text-white mb-6>"
                  <span className=""text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400>
                    Privacy Policy - Zion Tech Group
                  </span>
                </h1>
              ...
              <div className="mt-12 flex flex-col sm flex-row gap-4 justify-center>
                ...
                </Link href=/auth/signup  className="border border-purple-500 text-purple-400 hover bg-purple-500 hover text-white px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300 ></Link>
              </div>
            </div>
          </div>
        </div>
...
export default Https___ziontechgroup_netlify_app_privacyPage)