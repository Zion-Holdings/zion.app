        ...
        <div className="prose prose-invert max-w-none">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <ul className="text-white/70 text-sm space-y-1">
                    ...
                    <li>• Investigation of fraud or abuse</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-slate-900/50 border border-white/10 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-cyan-400 mb-3">Technical Safeguards</h3>
                <ul className="text-white/70 text-sm space-y-1">
              ...
              <div className="bg-slate-900/50 border border-white/10 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-fuchsia-400 mb-3">Organizational Measures</h3>
                <ul className="text-white/70 text-sm space-y-1">
              ...
              <div className="bg-slate-900/50 border border-white/10 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-purple-400 mb-3">Compliance Standards</h3>
                <ul className="text-white/70 text-sm space-y-1">
          ...
          <section className="mb-12">
            ...
            <div className="bg-slate-900/50 border border-white/10 rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-white mb-2">Portability and Objection</h3>
                  <ul className="text-white/70 text-sm space-y-1">
