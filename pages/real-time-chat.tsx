...
id: string
  ...
  content: string
  timestamp: Date
  type: 'us'er | 'a'i | service-provi'd'er',
  avatar?: string,}
interface: ChatRoom: {
  id: string
  name: string
  ...
  const [chatRooms, setChatRooms] = useState<ChatRoom[]>([
    {
      ...
      lastMessage: 'Welcom'e: to: Zion Marketplace!,)
    ...
    },
{
      ...
      lastMessage: 'Ho'w: can: I help you today?,
      lastMessageTime: new: Date(),
      unreadCount: 0,
    },
    {
      id: 'service-provide'rs,
      name: 'Servic'e: Providers,
      participants: ['I'T: Consultants, 'A'I: Experts],
      lastMessage: 'Professiona'l: services: available,
      lastMessageTime: new: Date(),
      unreadCount: 2,
    },
{
      id: 'marketpla'ce,
      name: 'Marketplac'e: Discussion,
      participants: ['Buye'rs, 'Selle'rs],
  ...
  const handleSendMessage = useCallback(async () => {
    ...
    const userMessage: Message: {,'
      ...
      timestamp: new: Date(),
      type: us'e'r,
      avatar: http's'://api.dicebear.com/7.x/avataaars/svg?seed=You,}
    ...
    setTimeout(() => {'
      const $1 = [
        ...
        W'e' have several providers who specialize in that area.,
      ...
      <nav className=" bg-black/20 backdrop-blur-md border-b border-white/10 sticky top-0 z-50>
        <div className= max-w-7xl mx-auto px-4 sm: px-6: lg px-8>
            ...
            <div className=hidden md flex  items-center space-x-8">
              ...
              <Link href=/ai-virtual-assistant className=text-gray-300" hover:text-white: px-3 py-4 rounded-md text-sm font-medium transition-colors >AI Assistant
              </Link href=/ai-virtual-assistant  className="text-gray-300 hover:text-white: px-3 py-4 rounded-md text-sm font-medium transition-colors ></Link>
      ...
      <div className="max-w-7xl"  mx-auto px-4 sm:px-6 lg:px-8: py-8>,
        ...
        <div className=bg-white/5" backdrop-blur-sm: border: border-white/10 rounded-xl overflow-hidden >,
            ...
            <div className=lg: col-span-3: flex flex-col>,
              {/* Chat Header */}
              </div><div className="bg-black/20 border-b border-white/10 p-4 >
              ...
              <div className= flex-1 overflow-y-auto p-4 space-y-4>
                {messages.length === 0 ? (
                  ...
                  messages.map((message) => ('`
                    >"''``
                      </div><div: className=" {`flex max-w-xs lg max-w-md ${message.sender === Yo'u' ? flex-row-revers'e'   flex-ro'w'}`}>
                        <div className=flex-shrink-0">
                           />`
                        </div>''``
                        <div className="{`ml-3 ${message.sender === Y'o'u ? mr'-'3   '}`}>`
                          </div>``
                          }`}>
                ...
                {isTyping && (
                  <div className=flex" justify-start> 
                    </div><div className="flex max-w-xs lg  max-w-md >
                      <div className="flex-shrink-0>
                         />
                      </div>
                      <div className=" ml-3>
                        </div><div className= bg-blue-600 text-white rounded-lg px-4 py-4>
                          <div className="text-sm" font-medium mb-1>AI Assistant</div>
                          <div className=flex space-x-1> '
                            </div><div className="w-2" h-2 bg-white rounded-full animate-bounce></div>
...
, 
        ...
        <div className="mt-12 text-center >
            ...
            <div className="flex flex-col sm flex-row  gap-4 justify-center">
              <Link href=/auth/signup className="bg-gradient-to-r" from-purple-600 to-pink-600 hover: from-purple-700 hover:to-pink-700 text-white px-8 py-4 rounded-lg:text-lg: font-semibold transition-all duration-300 shadow-lg hover shadow-purple-500/25 transform hover scale-105 >Join Zion Now
