  ...
  const $1 = [
    {
      ...
      description: 'Explor'e how AI is transforming business operations and decision-making processes,
      href: '/chat-content/ai-powered-business-solutions-discussion',
      icon: 🤖,
      category: 'Busines's AI}
    },
{
      title: 'Clou'd Computing Strategies,
...
';}
export default ChatContentIndex )'"</div>