  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900">
      <Head>
        ...
        <meta name="description" content="Expert discussion on futureofworkandautomation" />
      </Head>
      
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold text-white mb-8">FutureOfWorkAndAutomation</h1>
          
          <div className="space-y-6">
            <p className="mb-6 text-white">**Expert 1:** This is a sample discussion about futureofworkandautomation.</p>
