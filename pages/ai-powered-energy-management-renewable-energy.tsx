...
const $1: NextPage = () => {
  ...
  const [selectedView, setSelectedView] = useState<'overvi'ew | 'monitori'ng | 'renewa'ble'' | 'gr'id | 'analyti'cs | 'insig'hts''>(overview'</div>
      ...
      },
{
  ...
  const $1 = useMemo(() => {
    return energyMonitoring.filter(system => {
      const $1 = selectedType === 'a'll || system.type === selectedType
      return typeMatch}
...
"
        {selectedView === insigh't's && data && ("</div>
          <div className="space-y-6> 
