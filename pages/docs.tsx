  ...
  return (
    <div>
      ...
      <Head>
        ...
        <meta name="description" content="Documentation for Zion's marketplace platform > </meta name="description" content="Documentation for Zion's marketplace platform" ><meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no /></Head>
