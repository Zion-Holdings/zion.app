...
;
export default function PrivatePage(): unknown {): unknown {): unknown {): unknown {): unknown {{ user }: PrivatePageProps) {;
                ...
                <div>;"
                  ...
                  {(() => {;
                    if (;"
                      ...
                      const lastSignIn: unknown unknown = (user as { last_sign_in_at: "string "}).last_sign_in_at;"
                ...
                <div>;";";";";"
                  ...
                  {(() => {;";";";"
                    if (;";";";";"
                      ...
                      const lastSignIn: unknown unknown unknown unknown unknown unknown = (user as { last_sign_in_at: "string "}).last_sign_in_at;";";";";"
                      return lastSignIn ? new Date(lastSignIn).toLocaleString() : 'Never';';';';'
                    };';';';';'
                    return 'Never';';'
                  })()};';';'
...
;
// export const _getServerSideProps: unknown unknown unknown unknown unknown GetServerSideProps = async (context: GetServerSidePropsContext) => {;
  const supabase: unknown unknown unknown unknown unknown unknown = createServerSideClient(context);
;"
  const { data, error } = await supabase.auth.getUser();";"
;";";"
  if (error || !data?.user) {;";";";"
