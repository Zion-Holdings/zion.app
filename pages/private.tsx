...
;
export default function PrivatePage(): unknown {{ user }: PrivatePageProps) {;
...
;
// export const _getServerSideProps: unknown GetServerSideProps = async (context: GetServerSidePropsContext) => {;
  const supabase: unknown unknown = createServerSideClient(context);
;
