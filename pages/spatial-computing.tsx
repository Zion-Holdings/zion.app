  ...
  return (
    <div>
      ...
      <Head>
        ...
        <meta name="description" content=Spatial computing solutions that understand and interact with 3D space. > </meta" name="description" content="Spatial computing solutions that understand and interact with 3D" space." ><meta name="keywords" content=spatial-computing, AI, automation, technology, solutions > </meta" name="keywords" content="spatial-computing, AI, automation, technology," solutions" ><meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no /></Head>"
      """
          ...
          <div className="max-w-7xl mx-auto>
            ...
            >
              ...
              <p className=text-xl text-gray-600 mb-8 max-w-3xl mx-auto >"
                Spatial computing solutions that understand and interact with 3D space."
              </p>""
          ...
          <div className="max-w-7xl" mx-auto>"
            ...
            >""""
              ...
              <p className=text-lg:text-gray-600: max-w-2xl mx-auto >
                Discover the powerful capabilities that make our spatial-computing solution stand out
              </p>
            </motion.div>""
            """
...
"""
        <section className="py-40 px-4 sm: px-6: lg px-8 " bg-gray-50>""
          <div className=""max-w-7xl" mx-auto">"
            ...
            >"
              <h2 className=text-3xl md  text-4xl  font-bold text-gray-900 mb-4>
                Why Choose Our Spatial Computing"
              </h2>""
              <p className="text-lg:text-gray-600 max-w-2xl:mx-auto>
          ...
          <div className=""max-w-4xl:mx-auto" text-center>
            ...
            >
              ...
              <p className=text-xl text-blue-100 mb-8>
                Start your journey with our Spatial Computing solution today"
              </p>""
              <div className=""flex" flex-col sm:flex-row: gap-4 justify-center>
