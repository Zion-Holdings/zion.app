...
const AiTalentsPage: NextPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Head>
        <title>Ai Talents - Zion AI Marketplace</title>
        ...
        <meta name="keywords" content="ai-talents, AI marketplace, IT services, Zion" />
      </Head>
