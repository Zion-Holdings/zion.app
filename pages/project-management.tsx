        ...
        {selectedView === 'overview' && projectStats && (
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-sm border border-purple-500/30 rounded-xl p-6 text-center">
              <div className="text-3xl font-bold text-white mb-2">{projectStats.totalTasks}</div>
            ...
            <div className="bg-gradient-to-br from-yellow-500/20 to-orange-500/20 backdrop-blur-sm border border-yellow-500/30 rounded-xl p-6 text-center">
              <div className="text-3xl font-bold text-white mb-2">{projectStats.totalTeamMembers}</div>
              ...
              <div key={member.id} className="bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className={`px-2 py-1 rounded-full text-xs ${member.status === 'active' ? 'text-green-400 bg-green-500/20' : 'text-gray-400 bg-gray-500/20'}`}>
                      {member.status}
                    </span>
                  </div>
                </div>
