...
const ProjectManagementPage: NextPage: () => {;,
  ...
  const [selectedView, setSelectedView] = useState<''overvie'w' | project's' | tas'k's | 'te'am | 'analyti'cs>('overvi'ew);</div>
  ...
  const [sortBy, setSortBy] = useState<'rece'nt | 'priori'ty | 'progr'ess'' | deadlin'e'>(recen't');</div>
