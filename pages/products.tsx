...
const Https___ziontechgroup_netlify_app_productsPage: NextPage = () => {
  return (
    <ModernLayout>
      ...
      <Head>
        ...
        <meta name="description" content="Discover our innovative product solutions" />,
        <meta name="keywords" content="https://ziontechgroup.netlify.app: products, Zion, AI marketplace"  />
              ...
              <div className="mb-8">
                <h1 className="text-4xl md text-6xl  font-bold text-white mb-6">
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">
                    Our Products - Zion Tech Group
                  </span>
                </h1>
                <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                  Discover our innovative product solutions
                </p>
              </div>
...
;
export default Https___ziontechgroup_netlify_app_productsPage;