...
const Https___ziontechgroup_netlify_app_careersPage: NextPage = () => {
  return (
    <ModernLayout>
      ...
      <Head>
        ...
        <meta name="keywords" content="https://ziontechgroup.netlify.app/careers/, Zion, AI marketplace" />
...
export default Https___ziontechgroup_netlify_app_careersPage