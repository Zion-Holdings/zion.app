      ...
      <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black">
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-lg text-gray-300 max-w-3xl mx-auto">
                A collaborative, innovative environment where great ideas become reality
              </p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {culture.map((item, index) => (
                ...
                >
                  <div className={`w-12 h-12 bg-gradient-to-br ${item.color} rounded-lg mx-auto mb-4 flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
        ...
        <section className="py-20 bg-gray-900/50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              {openPositions.filter(position => position.featured).map((position, index) => (
                ...
                >
                  <div className="p-8">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-4 p-4 bg-gray-700/30 rounded-lg">
            ...
            <div className="mt-12">
              <h3 className="text-2xl font-bold text-white mb-8 text-center">More Opportunities</h3>
                  ...
                  >
                    <div className="p-6">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-gray-400">{position.salary}</span>
