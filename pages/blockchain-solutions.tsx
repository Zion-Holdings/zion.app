  ...
  return (
    <div>
      ...
      <Head>
        ...
        <meta name="description content=Enterprise-grade blockchain solutions that provide transparency, security, and efficiency. > </meta" name="description" content="Enterprise-grade blockchain solutions that provide transparency, security, and" efficiency." ><meta name="keywords content=blockchain-solutions, AI, automation, technology, solutions > </meta" name="keywords" content="blockchain-solutions, AI, automation, technology," solutions" ><meta name="viewport" content=width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no /></Head> 
          ...
          <div className=" max-w-7xl mx-auto>
            ...
            >
              ...
              <p className="text-xl text-high-contrast-secondary mb-8 max-w-3xl mx-auto > 
                Enterprise-grade blockchain solutions that provide transparency, security, and efficiency.
              </p>
          ...
          <div className=" max-w-7xl" mx-auto>
            ...
            >
              ...
              <p className="text-lg:text-high-contrast-secondary" max-w-2xl mx-auto >
                Discover the powerful capabilities that make our blockchain-solutions solution stand out
              </p>
            </motion.div>
          ...
          <div className="max-w-4xl:mx-auto"  text-center>
            ...
            >
              ...
              <p className="text-xl" text-blue-100 mb-8>
                Start your journey with our Blockchain Solutions solution today
              </p>
              <div className="flex  flex-col sm:flex-row gap-4 justify-center>
