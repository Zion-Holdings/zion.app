			...
			<div className="max-w-6xl mx-auto space-y-10">
				...
				<section id="q2-2035-additions" className="space-y-6">
					...
					<ul className="list-disc list-inside text-slate-300 space-y-2">
						...
						<li><strong className="text-white">AI Contract Reviewer</strong> — $69/mo. Learn: <a className="text-cyan-400 underline" href="/services/ai-contract-reviewer">/services/ai-contract-reviewer</a>. References: https://platform.openai.com/pricing, https://anthropic.com/pricing</li>
				...
				<section id="service-expansions-2036" className="space-y-6">
					...
					<ul className="list-disc list-inside text-slate-300 space-y-2">
						...
						<li><strong className="text-white">AI Contract Reviewer</strong> — $69/mo. <a className="text-cyan-400 underline" href="/services/ai-contract-reviewer">Learn more</a>. References: {ext('https://platform.openai.com/pricing')}, {ext('https://www.anthropic.com/pricing')}</li>
