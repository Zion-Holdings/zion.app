        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-400 mb-8 max-w-3xl mx-auto">
              All 28+ services include comprehensive documentation, dedicated support, enterprise-grade reliability, 99.9% uptime guarantee, and 14-day free trials. 
      ...
      <section className="py-24 bg-gradient-to-br from-black via-gray-900 to-black relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { icon: '🧠', title: 'AI & Machine Learning', description: 'Advanced neural networks and deep learning algorithms', color: 'from-purple-500 to-pink-600' },
              { icon: '📊', title: 'Big Data Analytics', description: 'Real-time processing and predictive insights', color: 'from-blue-500 to-cyan-600' },
              { icon: '🔒', title: 'Blockchain Security', description: 'Decentralized and immutable data protection', color: 'from-green-500 to-emerald-600' },
              { icon: '🌐', title: 'Edge Computing', description: 'Distributed computing for ultra-low latency', color: 'from-orange-500 to-red-600' }
            ].map((tech, index) => (
              <motion.div
                key={tech.title}
                initial={{ opacity: 0, y: 30 }}
