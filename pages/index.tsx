        ...
        <section className="mx-auto max-w-7xl px-6 pb-20">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { title: 'Ops Dashboard', desc: 'Consolidated A11y, SEO, Metadata and Trends reports.', href: '/reports/ops' },
              { title: 'Automation Health', desc: 'Aggregated automation logs for quick diagnostics.', href: '/reports/automation-health' },
            ].map((tool) => (
