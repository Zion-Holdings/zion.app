        ...
        <div className="text-center text-white">
          ...
          <div className="flex justify-center gap-6 mb-12">
            ...
            <Link href="/automation">
              <a className="bg-transparent border-2 border-white/30 text-white hover:bg-white/10 px-8 py-3 rounded-xl font-semibold transition-colors">Automations</a>
            </Link>
            <Link href="/contact">
          ...
          <section className="mt-20 text-left">
            ...
            <p className="text-white/80 mb-6 max-w-3xl mx-auto">These automations run on a schedule in the cloud, require no human interaction, and continuously improve the site.</p>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white/10 rounded-xl p-5 border border-white/10">
                <h3 className="text-xl font-semibold mb-2">Sitemap Generator</h3>
                <p className="text-white/80 mb-3">Keeps <code>public/sitemap.xml</code> in sync with all site routes.</p>
                <a href="/sitemap.xml" className="underline">View sitemap</a>
              </div>
              <div className="bg-white/10 rounded-xl p-5 border border-white/10">
                <h3 className="text-xl font-semibold mb-2">SEO Auditor</h3>
                <p className="text-white/80 mb-3">Audits pages for title/description quality and flags issues.</p>
                <a href="/reports/seo/" className="underline">View SEO report</a>
              </div>
              <div className="bg-white/10 rounded-xl p-5 border border-white/10">
                <h3 className="text-xl font-semibold mb-2">AI Trends Radar</h3>
                <p className="text-white/80 mb-3">Fetches trending AI stories and publishes concise reports.</p>
                <a href="/reports/ai-trends/" className="underline">Latest report</a>
              </div>
            </div>
          </section>
        </div>
