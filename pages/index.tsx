      ...
      <main className="relative z-10">
        ...
        <section className="mx-auto max-w-7xl px-6 pb-20">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
               ...
               { title: 'Repo Insights Digest (2m)', desc: 'Generates repo stats and insights, updates JSON/MD, and commits.', href: '/.netlify/functions/repo-insights-digest' },
               { title: 'Architecture Graph (3m)', desc: 'Builds a lightweight dependency graph of the app and saves it.', href: '/.netlify/functions/architecture-graph' },
               { title: 'UX Issues Scanner (5m)', desc: 'Flags large assets and basic UX risks, with actionable reports.', href: '/.netlify/functions/ux-issues-scanner' },
             ].map((tool) => (
