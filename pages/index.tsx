          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { title: 'Broken Image Scanner (6h)', desc: 'Finds broken images, optimizes assets, and syncs fixes.', href: '/.netlify/functions/broken-image-scanner' },
               ...
               { title: 'Auto Redirect Mapper', desc: 'Scans link reports and writes safe redirects automatically.', href: '/.netlify/functions/auto-redirect-mapper' },
               { title: 'Asset Size Guardian', desc: 'Scans public assets, writes reports, and commits insights.', href: '/.netlify/functions/asset-size-guardian' },
             ].map((tool) => (
