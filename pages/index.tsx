      ...
      <main className="relative z-10">
        ...
        <section className="mx-auto max-w-7xl px-6 pb-20">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
               ...
               { title: 'Intelligent Orchestrator (1m)', desc: 'Runs prioritized homepage/front tasks and ensures rapid git syncs.', href: '/.netlify/functions/intelligent-orchestrator' },
               { title: 'Anomaly Watchdog (10m)', desc: 'Audits security, code smell, dead code, and repo radar; commits fixes.', href: '/.netlify/functions/anomaly-watchdog' },
               { title: 'Pulse Sync (1m)', desc: 'Ultra-fast content refresh and push to main every minute.', href: '/.netlify/functions/pulse-sync' },
