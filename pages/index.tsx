        ...
        <section className="mx-auto max-w-7xl px-6 pb-20">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { title: 'Docs TOC Builder', desc: 'Generates a table of contents for all docs and publishes JSON/MD artifacts.', href: '/.netlify/functions/docs-toc-builder' },
              { title: 'README Badges Runner', desc: 'Injects useful shields badges into README.md and keeps them fresh.', href: '/.netlify/functions/readme-badges-runner' },
              { title: 'Release Cadence Runner', desc: 'Analyzes commit history to recommend a release cadence.', href: '/.netlify/functions/release-cadence-runner' },
              { title: 'Contributing Refresher', desc: 'Ensures CONTRIBUTING.md exists and stays updated.', href: '/.netlify/functions/contributing-refresher' },
            ].map((tool) => (
