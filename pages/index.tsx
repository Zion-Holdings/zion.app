        ...
        <section className="mx-auto max-w-7xl px-6 pb-20">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { title: 'Dependency Auto‑Upgrade', desc: 'Continuously upgrades safe dependencies and commits changes.', href: '/.netlify/functions/deps-auto-upgrade-runner' },
              { title: 'Branch Cleanup', desc: 'Removes merged and stale ephemeral branches automatically.', href: '/.netlify/functions/branch-cleanup-runner' },
              { title: 'UI Beautifier', desc: 'Applies visual polish and UX improvements autonomously.', href: '/.netlify/functions/ui-beautifier-runner' },
              { title: 'Revenue Ideas Runner', desc: 'Generates and applies growth experiments on a safe cadence.', href: '/.netlify/functions/revenue-ideas-runner' },
            ].map((tool) => (
