        ...
        <section className="mx-auto max-w-7xl px-6 pb-20">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { title: 'Autonomous Ad Factory', desc: 'Invents and applies homepage promos automatically.', href: '/.netlify/functions/autonomous-ad-factory' },
              { title: 'Knowledge & Radar Orchestrator', desc: 'Builds the repo knowledge graph and trend radar.', href: '/.netlify/functions/knowledge-radar-orchestrator' },
              { title: 'Innovation Researcher', desc: 'Curates AI-assisted content and newsroom updates.', href: '/.netlify/functions/innovation-researcher' },
              { title: 'Continuous Cloud Refiner (5m)', desc: 'Refines links, images, sitemap, and homepage sections.', href: '/.netlify/functions/continuous-cloud-refiner' },
            ].map((tool) => (
