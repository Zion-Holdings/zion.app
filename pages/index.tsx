        ...
        <section className="mx-auto max-w-7xl px-6 pb-20">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { title: 'AI Innovation Orchestrator', desc: 'Researches trends, innovates features, updates newsroom and changelog.', href: '/.netlify/functions/ai-innovation-orchestrator' },
              { title: 'Meta Orchestrator', desc: 'Runs autonomous meta factory and syncs changes.', href: '/.netlify/functions/meta-orchestrator' },
              { title: 'UI Evolution Runner', desc: 'Continuously enhances UI and beautifies the front.', href: '/.netlify/functions/ui-evolution-runner' },
              { title: 'Venture Orchestrator', desc: 'Continuously evolves venture services and marketing assets.', href: '/.netlify/functions/venture-orchestrator' },
            ].map((tool) => (
