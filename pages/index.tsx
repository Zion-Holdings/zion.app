        ...
        <section className="mx-auto max-w-7xl px-6 pb-20">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { title: 'Autonomous Cloud Meta Orchestrator (1m)', desc: 'Triggers high‑impact cloud jobs and stamps commits for rapid sync.', href: '/.netlify/functions/autonomous-cloud-meta-orchestrator' },
              ...
              { title: 'Trigger All & Commit (1m)', desc: 'Invokes all cloud functions concurrently and triggers a build or commit stamp.', href: '/.netlify/functions/trigger-all-and-commit' },
