      ...
      <main className="relative z-10">
        ...
        <section className="mx-auto max-w-7xl px-6 pb-14">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <a href="/.netlify/functions/merge-conflict-auto-resolver" className="group relative overflow-hidden rounded-2xl border border-emerald-400/30 bg-gradient-to-br from-emerald-400/10 to-white/5 p-6 backdrop-blur-xl hover:border-emerald-400/60 tilt-on-hover">
              <div className="pointer-events-none absolute -inset-px -z-10 bg-gradient-to-r from-emerald-400/0 via-emerald-400/10 to-emerald-400/0 opacity-0 blur-2xl transition-opacity group-hover:opacity-100" />
              <h3 className="text-lg font-semibold">Merge Conflict Auto‑Resolver</h3>
              <p className="mt-1 text-sm text-white/75">Automatically resolves conflict markers preferring HEAD, then syncs to main.</p>
