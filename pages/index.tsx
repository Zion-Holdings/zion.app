        ...
        <section className="mx-auto max-w-7xl px-6 pb-20">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { title: 'Smart Redirects Manager', desc: 'Auto‑generates _redirects from 404 insights and commits safely.', href: '/.netlify/functions/smart-redirects-manager' },
              { title: 'QA Knowledge Runner', desc: 'Builds a Q&A knowledge base from README and docs.', href: '/.netlify/functions/qa-knowledge-runner' },
              { title: 'SEO Schema Runner', desc: 'Publishes JSON‑LD schema for better discovery.', href: '/.netlify/functions/seo-schema-runner' },
        ...
        <section className="mx-auto max-w-7xl px-6 pb-20">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { title: 'Auto Scheduler (15m)', desc: 'Smart time-based runner that chooses and executes the best tasks.', href: '/.netlify/functions/auto-scheduler' },
              { title: 'Broken Image Scanner (6h)', desc: 'Finds broken images, optimizes assets, and syncs fixes.', href: '/.netlify/functions/broken-image-scanner' },
              { title: 'AI Trends Radar', desc: 'Updates AI trends report and insights automatically.', href: '/.netlify/functions/ai-trends-radar' },
              { title: 'SEO Audit Runner', desc: 'Runs SEO audits and publishes reports.', href: '/.netlify/functions/seo-audit-runner' },
              { title: 'Monetization Orchestrator', desc: 'Applies autonomous revenue ideas safely.', href: '/.netlify/functions/monetization-orchestrator' },
              { title: 'UI Evolution Beautify', desc: 'Refreshes UI polish via autonomous evolution.', href: '/.netlify/functions/ui-evolution-beautify' },
              { title: 'Design Evolution', desc: 'Cycles design improvements automatically.', href: '/.netlify/functions/design-evolution' },
              { title: 'Autonomous Git Sync', desc: 'Keeps the repo in a healthy, synchronized state.', href: '/.netlify/functions/autonomous-git-sync' },
              { title: 'Autonomous Invention Lab', desc: 'Discovers and proposes new automations.', href: '/.netlify/functions/autonomous-invention-lab' },
              { title: 'Knowledge Radar', desc: 'Updates repo radar metrics and knowledge views.', href: '/.netlify/functions/knowledge-radar' },
              { title: 'Innovation Sprint', desc: 'High-frequency front innovation and directory refresh.', href: '/.netlify/functions/innovation-sprint' },
            ].map((tool) => (
              <a key={tool.title} href={tool.href} className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-xl hover:border-cyan-400/30 tilt-on-hover">
                <div className="pointer-events-none absolute -inset-px -z-10 bg-gradient-to-r from-fuchsia-500/0 via-cyan-400/10 to-fuchsia-500/0 opacity-0 blur-2xl transition-opacity group-hover:opacity-100" />
                <h3 className="text-lg font-semibold">{tool.title}</h3>
...
/* AUTO-GENERATED: HOME_VISIONARY_START */}
        ...
        <section id="home-visionary" className="mx-auto max-w-7xl px-6 pb-20">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <a key="Roadmap Synthesizer" href="/.netlify/functions/roadmap-synthesizer" className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-xl hover:border-cyan-400/30 tilt-on-hover">
                <div className="pointer-events-none absolute -inset-px -z-10 bg-gradient-to-r from-fuchsia-500/0 via-cyan-400/10 to-fuchsia-500/0 opacity-0 blur-2xl transition-opacity group-hover:opacity-100" />
                <div className="text-base font-semibold">Roadmap Synthesizer</div>
                <div className="mt-1 text-sm text-white/75">Combines TODOs, ideas, and graphs into a live roadmap; commits every 30m.</div>
                <div className="mt-3 inline-flex items-center gap-1 text-xs text-cyan-300/90">Open <span aria-hidden>↗</span></div>
              </a>

              <a key="Schema.org Enhancer" href="/.netlify/functions/schema-org-enhancer" className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-xl hover:border-cyan-400/30 tilt-on-hover">
                <div className="pointer-events-none absolute -inset-px -z-10 bg-gradient-to-r from-fuchsia-500/0 via-cyan-400/10 to-fuchsia-500/0 opacity-0 blur-2xl transition-opacity group-hover:opacity-100" />
                <div className="text-base font-semibold">Schema.org Enhancer</div>
                <div className="mt-1 text-sm text-white/75">Audits structured data across pages and publishes a live coverage report.</div>
                <div className="mt-3 inline-flex items-center gap-1 text-xs text-cyan-300/90">Open <span aria-hidden>↗</span></div>
              </a>

              <a key="Component Prop Coverage" href="/.netlify/functions/component-prop-coverage-runner" className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-xl hover:border-cyan-400/30 tilt-on-hover">
                <div className="pointer-events-none absolute -inset-px -z-10 bg-gradient-to-r from-fuchsia-500/0 via-cyan-400/10 to-fuchsia-500/0 opacity-0 blur-2xl transition-opacity group-hover:opacity-100" />
                <div className="text-base font-semibold">Component Prop Coverage</div>
                <div className="mt-1 text-sm text-white/75">Measures typing coverage of component props and suggests targets.</div>
                <div className="mt-3 inline-flex items-center gap-1 text-xs text-cyan-300/90">Open <span aria-hidden>↗</span></div>
              </a>
          </div>
