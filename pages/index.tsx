        ...
        <section className="mx-auto max-w-7xl px-6 pb-20">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { title: 'Smart Redirect Manager', desc: 'Fixes internal 404s by auto-adding smart redirects.', href: '/.netlify/functions/redirect-manager' },
              ...
              // New innovations
              { title: 'OG Meta Auditor', desc: 'Audits pages for OG/Twitter meta coverage; publishes report.', href: '/.netlify/functions/og-meta-auditor' },
              { title: 'Unused Media Report', desc: 'Finds unreferenced assets in public/ and reports savings.', href: '/.netlify/functions/unused-media-report' },
              { title: 'Orphan Page Finder', desc: 'Detects unlinked pages to improve crawlability.', href: '/.netlify/functions/orphan-page-finder' },
            ].map((tool) => (
