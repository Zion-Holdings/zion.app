        ...
        <section className="mx-auto max-w-7xl px-6 pt-10 pb-16 md:pt-16 md:pb-24">
          <div className="text-center">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              ...
              <a href="/.netlify/functions/marketing-scheduler" target="_blank" rel="noopener" className="rounded-xl border border-white/20 bg-white/5 px-6 py-3 font-semibold backdrop-blur-md hover:bg-white/10">Live Marketing Scheduler</a>
            </div>
