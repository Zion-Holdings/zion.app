      ...
      <main className="relative z-10">
        ...
        <section className="mx-auto max-w-7xl px-6 pb-20">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
               ...
               { title: 'AI Trends Radar', desc: 'Aggregates trending AI topics and publishes a report every 30m.', href: '/.netlify/functions/ai-trends-radar-runner' },
               { title: 'A11y Audit Runner', desc: 'Checks core pages for accessibility issues and commits a report.', href: '/.netlify/functions/a11y-audit-runner' },
            ].map((tool) => (
