        ...
        <section className="mx-auto max-w-7xl px-6 pb-20">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { title: 'AI Trends Radar', desc: 'Aggregates AI trends from HN and Reddit into public reports.', href: '/.netlify/functions/ai-trends-radar-runner' },
              { title: 'Dependency Insights', desc: 'Analyzes npm dependencies and publishes insights.', href: '/.netlify/functions/deps-insights-runner' },
            ].map((tool) => (
