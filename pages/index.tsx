        ...
        <section className="mx-auto max-w-7xl px-6 pb-20">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { title: 'SEO Audit Runner', desc: 'Analyzes SEO and writes reports every 30 minutes.', href: '/.netlify/functions/seo-audit-runner' },
              { title: 'AI Trends Radar', desc: 'Fetches and summarizes AI trends periodically.', href: '/.netlify/functions/ai-trends-radar-runner' },
              { title: 'UI Beautifier', desc: 'Automatically improves UI polish and consistency.', href: '/.netlify/functions/ui-beautifier-runner' },
