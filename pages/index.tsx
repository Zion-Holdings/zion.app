 ...
 /* AUTO-GENERATED: HOME_UPDATER_END */}
        ...
        <section id="home-visionary" className="mx-auto max-w-7xl px-6 pb-20">
          ...
          <p className="mx-auto mt-2 max-w-3xl text-center text-sm text-white/70">Futuristic templates, animated backgrounds, and deep links — continuously curated by cloud functions.</p>
               ...
               <a key="A11y Auditor" href="/.netlify/functions/a11y-audit-runner" className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-xl hover:border-emerald-400/30 tilt-on-hover">
                 ...
                 <div className="text-base font-semibold">A11y Auditor</div>
                 <div className="mt-1 text-sm text-white/75">Detects missing alts and unlabeled controls; updates reports.</div>
                 <div className="mt-3 inline-flex items-center gap-1 text-xs text-emerald-300/90">Open <span aria-hidden>↗</span></div>
               </a>

               <a key="Internal Link Guardian" href="/.netlify/functions/internal-link-guardian" className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-xl hover:border-yellow-400/30 tilt-on-hover">
                 <div className="pointer-events-none absolute -inset-px -z-10 bg-gradient-to-r from-yellow-500/0 via-yellow-400/10 to-yellow-500/0 opacity-0 blur-2xl transition-opacity group-hover:opacity-100" />
                 <div className="text-base font-semibold">Internal Link Guardian</div>
                 <div className="mt-1 text-sm text-white/75">Validates internal links resolve to real routes or assets.</div>
                 <div className="mt-3 inline-flex items-center gap-1 text-xs text-yellow-300/90">Open <span aria-hidden>↗</span></div>
               </a>

               <a key="Performance Asset Watcher" href="/.netlify/functions/perf-asset-watcher" className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-xl hover:border-pink-400/30 tilt-on-hover">
                 <div className="pointer-events-none absolute -inset-px -z-10 bg-gradient-to-r from-pink-500/0 via-pink-400/10 to-pink-500/0 opacity-0 blur-2xl transition-opacity group-hover:opacity-100" />
                 <div className="text-base font-semibold">Performance Asset Watcher</div>
                 <div className="mt-1 text-sm text-white/75">Flags oversized public assets and suggests optimizations.</div>
                 <div className="mt-3 inline-flex items-center gap-1 text-xs text-pink-300/90">Open <span aria-hidden>↗</span></div>
               </a>
          </div>
