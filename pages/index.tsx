      ...
      <main className="relative z-10">
        <section className="mx-auto max-w-7xl px-6 pt-10 pb-16 md:pt-16 md:pb-24">
          <div className="text-center">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              ...
              <Link href="/automation"><a className="rounded-xl border border-white/20 bg-white/5 px-6 py-3 font-semibold backdrop-blur-md hover:bg-white/10">Cloud Automations (Netlify)</a></Link>
            </div>
        ...
        <section className="mx-auto max-w-7xl px-6 pb-20">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { title: 'Frontpage Enhancer', desc: 'Auto‑advertises features and refreshes homepage content frequently.', href: '/.netlify/functions/frontpage-enhancer' },
              { title: 'Feature Catalog', desc: 'Runs homepage/front advertisers and promo updaters on a fast cadence.', href: '/.netlify/functions/feature-catalog' },
              { title: 'Link & Health Scheduler', desc: 'Runs link checks, health scans, and sitemap updates regularly.', href: '/.netlify/functions/link-and-health-scheduler' },
            ].map((tool) => (
