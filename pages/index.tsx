      ...
      <main className="relative z-10">
        ...
        <section className="mx-auto max-w-7xl px-6 pb-20">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
               ...
               { title: 'LLM Content Curator', desc: 'Curates content and promos with LLM; commits changes to main.', href: '/.netlify/functions/llm-content-curator-runner' },
               { title: 'Link Sentinel Aggregator', desc: 'Aggregates link integrity data and proposes fixes; auto-syncs.', href: '/.netlify/functions/link-sentinel-aggregator-runner' },
               { title: 'Site Promo Orchestrator', desc: 'Analyzes, generates and applies homepage/site promos automatically.', href: '/.netlify/functions/site-promo-orchestrator' },
               { title: 'Auto-Discovery Orchestrator', desc: 'Discovers new automation ideas and runs the guardian; syncs.', href: '/.netlify/functions/auto-discovery-orchestrator' },
            ].map((tool) => (
