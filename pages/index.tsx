      ...
      <main className="relative z-10">
        ...
        <section className="mx-auto max-w-7xl px-6 pb-20">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
               ...
               { title: 'Roadmap Generator', desc: 'Builds a live roadmap from GitHub issues and local signals.', href: '/.netlify/functions/roadmap-generator-runner' },
               { title: 'Redirects Audit', desc: 'Audits Netlify redirects and publishes a readable report.', href: '/.netlify/functions/redirects-audit-runner' },
             ].map((tool) => (
