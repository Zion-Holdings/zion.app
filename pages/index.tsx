      ...
      <main className="relative z-10">
        ...
        <section className="mx-auto max-w-7xl px-6 pb-20">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
               ...
               { title: 'Performance Audit Runner', desc: 'Pulls PageSpeed scores for key pages and publishes a live report hourly.', href: '/.netlify/functions/performance-audit-runner' },
               { title: 'Unused Deps Scanner', desc: 'Finds unused deps/devDeps and writes a dependencies audit report.', href: '/.netlify/functions/unused-deps-runner' },
               { title: 'Sitemap Pinger', desc: 'Pings search engines when sitemap updates for faster indexing.', href: '/.netlify/functions/sitemap-pinger' },
             ].map((tool) => (
