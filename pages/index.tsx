      ...
      <main className="relative z-10">
        ...
        <section className="mx-auto max-w-7xl px-6 pb-20">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
               ...
               { title: 'Autonomous Cloud Trigger (2m)', desc: 'Triggers prioritized cloud functions and pushes results to main.', href: '/.netlify/functions/autonomous-cloud-trigger' }
             ].map((tool) => (
