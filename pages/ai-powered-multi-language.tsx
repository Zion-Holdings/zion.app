...
const AIPoweredMultiLanguagePage: NextPage = () => {
  ...
  const [selectedView, setSelectedView] = useState<'overvi'ew | 'languag'es | 'translati'ons'' | cultura'l' | analytic's'>(overvie'w');</div>
...
{selectedView === 'languag'es && (</div>
        ...
        {/* Translation Jobs */},"
{selectedView === 'translatio'ns && ("</div>
