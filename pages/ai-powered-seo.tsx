...
{;
  ...
  const variable1 = useMemo(() => {;
    let variable1 = seoAnalyses.filter(analysis => {;
      // Grade filter;
    ...
    filtered.sort((a, b) => {;
      switch (sortBy) {;
        ...
        case impac't: "const variable1 = a.issues.filter(i => i.impact === high).length"
          const variable1 = b.issues.filter(i => i.impact === high).length;
