          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8"">
            ...
            <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 p-8 rounded-lg:border border-white/10>"
              ...
              <div className="flex gap-4>
                <input
                  type=number"
                  placeholder=Enter your bid className=""flex-1 px-4 py-3 bg-white/10 border border-white/20 rounded-lg:text-white placeholder-gray-400 focus outline-none focus border-purple-500
                  min={currentBid + 100}
                />
