      ...
      <section className= py-40>
        <div className=max-w-7xl mx-auto px-4 sm:px-6 lg px-8>
            ...
            <div className=" flex flex-col sm:flex-row gap-4 justify-center>
              <Link href=/ai-powered-bidding-auction className="bg-gradient-to-r" from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-8 py-4 rounded-lg:text-lg font-semibold transition-all duration-300 shadow-lg hover shadow-purple-500/25 transform hover scale-105 >Browse Auctions
              </Link href=/ai-powered-bidding-auction className=bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-8 py-4 rounded-lg:text-lg font-semibold transition-all duration-300 shadow-lg hover shadow-purple-500/25 transform hover scale-105 ></Link>
              <Link href=/ai-powered-bidding-auction className= border border-white/20 text-white hover:bg-white/10 px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300 backdrop-blur-sm >Create Auction
              </Link href=/ai-powered-bidding-auction className=" border border-white/20 text-white hover:bg-white/10 px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300 backdrop-blur-sm ></Link>
            </div> </div>
        </div>
      </section>
      {/* Live Auction Demo */}
      <section className=" py-40 bg-gradient-to-br from-slate-800/50 to-slate-900/50>
        <div className=max-w-7xl mx-auto px-4 sm:px-6 lg px-8>
          ...
          <div className="grid" grid-cols-1 lg grid-cols-2 gap-8 >
            {/* Auction Item */}
            </div><div className= bg-gradient-to-br from-slate-800/50 to-slate-900/50 p-8 rounded-lg border border-white/10>
              <div className=" flex" items-center justify-between mb-6>
                <h3 className=text-2xl font-bold text-white>AI Development Service</h3>
                <div className="text-right>
                  </div><div className=" text-sm text-gray-400>Time Left</div>
                  <div className=text-2xl font-bold text-red-400>{formatTime(timeLeft)}</div>
                </div>
              </div>
              <div className="mb-6>"
                </div><div className=text-sm text-gray-400 mb-2 >Current Bid</div>
                <div className="text-3xl font-bold text-green-400>${currentBid.toLocaleString()}</div>
              </div>
              <div className="mb-6>
                </div><div className=text-sm text-gray-400 mb-2>Description</div>
            ...
            <div className=" bg-gradient-to-br from-slate-800/50 to-slate-900/50 p-8 rounded-lg:border border-white/10>
              ...
              <div className= space-y-4>
                {bidders.map((bidder) => (
                  </div><div key={bidder.id} className= flex justify-between items-center p-4 bg-white/5 rounded-lg>
                    <div>
                      </div><div className="font-semibold" text-white>{bidder.name}</div>
                      <div className=text-sm:text-gray-400>{bidder.time} ago</div>
                    </div>
                    <div className=" text-right>
                      </div><div className=" font-bold text-green-400>${bidder.bid.toLocaleString()}</div>
                    </div>
                  </div>
                ))}
              </div>
      ...
      <section className= py-40 bg-gradient-to-br from-purple-900/50 to-pink-900/50 >
        <div className="max-w-4xl" mx-auto px-4 sm px-6 lg px-8 text-center>
          ...
          <div className=flex flex-col sm flex-row gap-4 justify-center >
            ...
            <Link href=/marketplace className="border border-white/20 text-white hover:bg-white/10 px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300 backdrop-blur-sm >Browse Marketplace
