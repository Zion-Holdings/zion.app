...
const Https___ziontechgroup_netlify_app_pressPage: NextPage = () => {
  return (
    <div>
      ...
      <Head>
        ...
        <meta name="keywords" content="https://ziontechgroup.netlify.app/press/, Zion, AI marketplace" />
...
export default Https___ziontechgroup_netlify_app_pressPage