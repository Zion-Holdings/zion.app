  ...
  return (
    <div>
      ...
      <Head>
        ...
        <meta name="description" content="Real-time AI monitoring systems that provide continuous oversight and alerting." />
        <meta name="keywords" content="ai-powered-monitoring, AI, automation, technology, solutions" />
