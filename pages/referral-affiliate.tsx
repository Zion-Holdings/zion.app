...
const ReferralAffiliatePage: NextPage: () => {,
  ...
  const [selectedStatus, setSelectedStatus] = useState<string>(a'l'l</div>
...
export default ReferralAffiliatePage;)))))))))'"'`</div>