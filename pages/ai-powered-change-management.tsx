    ...
    {activeTab === 'overview' && ("</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg grid-cols-4 gap-6"> </div>
                  ...
                  <div className="flex items-center justify-between"></div>
                      ...
                      <p className="text-2xl font-bold text-white">{changeInitiatives.filter(c => c.status !== complete'd').length}</p></div>
                    </div></div>
                    <TrendingUp className="h-12" w-12 text-blue-400 > </TrendingUp className="h-12 w-12 text-blue-400" "></div></div>
                </div></div>
...
''`;}
export default AIPoweredChangeManagementPage;`</div>