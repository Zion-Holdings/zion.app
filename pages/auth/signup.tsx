...
"
        <div className="bg-black/20 backdrop-blur-md:rounded-lg:p-8 border border-white/10>"
          <form className=""space-y-6">
            ...
            <button"
              type=submit className=""w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-8 py-3 rounded-lg:text-lg font-semibold transition-all duration-300
            >
              Create Account
            </button>
          </form>
