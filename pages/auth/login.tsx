...
;";";""
  const handleResendVerification: unknown unknown unknown unknown unknown unknown = async () => {;";";";""
    if (!email) {;";";";";""
...
;
  const handleLogin: unknown unknown unknown unknown unknown unknown = async (_e: FormEvent) => {;
    e.preventDefault();
    setIsLoading(true);
    setError(null);
