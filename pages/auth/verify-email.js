...
const VerifyEmailPage = () => {
    ...
    return (_jsxs("div", { style: { display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', padding: '20px' }, children: [_jsx("h1", { children: "Email Verification" }), isLoading && _jsx("p", { children: message || 'Processing...' }), !isLoading && error && _jsxs("p", { style: { color: 'red' }, children: ["Error: ", error] }), !isLoading && !error && message && _jsx("p", { style: { color: 'green' }, children: message }), !isLoading && (_jsx("button", { onClick: () => router.push('/auth/login'), children: "Go to Login" }))] }));
};
