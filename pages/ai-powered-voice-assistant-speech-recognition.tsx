...
const AIPoweredVoiceAssistantSpeechRecognitionPage: NextPage = () => {
  ...
  const [selectedView, setSelectedView] = useState<''overview' | 'commands' | 'transcriptio'n' | ''speech' | 'assistants' | 'analytic's'>(overvie'w'
      ...
      <div className= max-w-7xl mx-auto px-4 sm:px-6 lg px-8 py-8>
        {/* Hero Section */}
          ...
          <div className= flex justify-center space-x-4>
            ...
            >
              {isListening ? Sto'p' Listening : Star't' Voice Assistant}
            </button>
            `
