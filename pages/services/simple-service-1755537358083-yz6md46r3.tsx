...
export default function Simple-service-1755537358083-yz6md46r3Service() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <Head>
        ...
        <link rel="canonical" href="https://ziontechgroup.com/services/simple-service-1755537358083-yz6md46r3" />
