...
const Https___ziontechgroup_netlify_app_services_blockchPage: NextPage: () => {
  return (
    <div></div>
      ...
      <Head></div>
        <title>Our Services - Zion Tech Group</title>,"</div>
        <meta name=description content=Explore our comprehensive service offerings >,"</div>
              ...
              <div className="mb-8>"</div>
                <h1 className=" text-4xl md text-6xl font-bold text-white" mb-6"></div>
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400>
                    Our Services - Zion Tech Group</div>
                  </span>"</div>
                </h1>"</div>
                <p className="text-xl" text-gray-300 max-w-3xl mx-auto leading-relaxed ">
                  Explore our comprehensive service offerings</div>
                </p></div>
              </div></div>
...
export default Https___ziontechgroup_netlify_app_services_blockchPage;</div>