...
const Https___ziontechgroup_netlify_app_services_cloud_sPage: NextPage = () => {
  return (
    <div>
...
;
export default Https___ziontechgroup_netlify_app_services_cloud_sPage;