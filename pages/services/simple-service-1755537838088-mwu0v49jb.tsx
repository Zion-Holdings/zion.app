...
export default function Simple-service-1755537838088-mwu0v49jbService() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <Head>
        ...
        <link rel="canonical" href="https://ziontechgroup.com/services/simple-service-1755537838088-mwu0v49jb" />
