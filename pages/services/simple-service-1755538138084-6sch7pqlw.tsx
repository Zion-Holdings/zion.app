...
export default function Simple-service-1755538138084-6sch7pqlwService() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <Head>
        ...
        <link rel="canonical" href="https://ziontechgroup.com/services/simple-service-1755538138084-6sch7pqlw" />
      </Head>
