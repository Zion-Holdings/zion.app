...
export default function Simple-service-1755537658090-uso2zuk5rService() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <Head>
        ...
        <link rel="canonical" href="https://ziontechgroup.com/services/simple-service-1755537658090-uso2zuk5r" />
