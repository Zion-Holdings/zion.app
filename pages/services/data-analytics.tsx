...
const Data_anPagePage: NextPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900></div>
      <Head>"</div>
        <title>Data Analytics - Zion Tech Group</title>"</div>
        <meta name=description" content="Explore our comprehensive data analytics service offerings /></div>
...
export default Data_anPagePage;</div>