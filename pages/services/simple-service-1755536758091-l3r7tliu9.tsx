...
export default function Simple-service-1755536758091-l3r7tliu9Service() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <Head>
        ...
        <link rel="canonical" href="https://ziontechgroup.com/services/simple-service-1755536758091-l3r7tliu9" />
      </Head>
