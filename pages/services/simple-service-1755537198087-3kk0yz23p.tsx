...
export default function Simple-service-1755537198087-3kk0yz23pService() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <Head>
        ...
        <link rel="canonical" href="https://ziontechgroup.com/services/simple-service-1755537198087-3kk0yz23p" />
      </Head>
