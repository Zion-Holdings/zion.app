...
export default function Simple-service-1755536858088-fz53cro35Service() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <Head>
        ...
        <link rel="canonical" href="https://ziontechgroup.com/services/simple-service-1755536858088-fz53cro35" />
      </Head>
