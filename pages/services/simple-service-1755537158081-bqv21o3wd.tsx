...
export default function Simple-service-1755537158081-bqv21o3wdService() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <Head>
        ...
        <link rel="canonical" href="https://ziontechgroup.com/services/simple-service-1755537158081-bqv21o3wd" />
