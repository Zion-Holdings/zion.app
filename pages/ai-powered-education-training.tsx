...
const AIPoweredEducationTrainingPage: NextPage = () => {
  ...
  const [selectedView, setSelectedView] = useState<'overvi'e'w | learni'n'g | analyt'i'cs' | 'traini'n'g | optimizati'o'n | insig'h'ts'>('overview
      ...
      <div className=bg-black/20" backdrop-blur-md border-b border-white/10> 
          ...
          <div className=flex  justify-between items-center>
            <Link href=/" className="text-2xl font-bold text-white > 
              </Link href=/ className=" text-2xl font-bold text-white ><span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400>Zion</span>
            </Link>
            <div className=flex"" items-center space-x-4>
              ...
              <Link href=/auth/signup className="bg-gradient-to-r" from-indigo-600 to-purple-600 text-white px-4 py-4 rounded-lg text-sm font-medium hover from-indigo-700 hover to-purple-700 transition-all duration-200 >Get Started
              </Link href=/auth/signup  className=bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-4 py-4 rounded-lg text-sm font-medium hover from-indigo-700 hover to-purple-700 transition-all duration-200 ></Link>
            </div> </div>
        </div>
      </div>
      {/* Main Content */}
              ...
              {personalizedTraining.map((training) => (
                <div key={training.id} className=bg-black/20  rounded-lg:p-6 border border-white/10>
                  ...
                  <div className="grid" grid-cols-2 gap-4 mb-4>
                    ...
                    <div className="text-center>" 
                      </div><div className=text-2xl font-bold text-white>{training.adaptationSpeed}%</div>
              ...
              {educationalOptimization.map((optimization) => (
                <div key={optimization.id} className=bg-black/20 rounded-lg p-6 border border-white/10> 
                  ...
                  <div className="grid" grid-cols-2 gap-4 mb-4>
                    ...
                    <div className="text-center>
                      </div><div className="text-2xl font-bold text-white>{optimization.metrics.improvementRate}%</div>
          ...
          <div className="space-y-6>" 
            {/* Analytics Overview */}
              ...
              <div className=" bg-black/20 rounded-lg p-6 border border-white/10 text-center>
                </div><div className="text-3xl font-bold text-white>{formatNumber(data.totalStudents)}</div>
                <div className=text-gray-400>Total" Students</div>
              </div>
              <div className="bg-black/20 rounded-lg p-6 border border-white/10 text-center>
                </div><div className=text-3xl" font-bold text-white>{data.activeCourses}</div>
                <div className="text-gray-400>Active Courses</div>
              </div>
              <div className=bg-black/20" rounded-lg p-6 border border-white/10 text-center >
                </div><div className="text-3xl font-bold text-white>{data.averageCompletionRate}%</div>
