...
const TheRiseOfEdgeComputingInIotApplicationsChatPage: NextPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Head>
        <title>The Rise of Edge Computing in IoT Applications - Expert Discussion - Zion Tech Blog</title>
        <meta name="description" content="Expert conversation about the rise of edge computing in iot applications with insights and analysis." />
      </Head>
...
export default TheRiseOfEdgeComputingInIotApplicationsChatPage