  ...
  return (
    <div>
      ...
      <Head>
        ...
        </meta name=description content=Learn about 5g networks and iot integration and its impact on modern business technology. ><meta name=viewport  content=width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no /></Head> 
