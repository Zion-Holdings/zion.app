...
;";";";";"";
const BlogPostPage: unknown unknown unknown unknown unknown "React.FC<BlogPostPageProps> = ({ initialPost "}) => {;"
...
;
  ...
  const body: unknown unknown unknown unknown "unknown unknown = (post as BlogPost & { body?: string "}).body || post.content;"
  return (;
    <>;""
      <AdvancedSEO;";""
        title={post.title};";";""
...
;
export const _getStaticProps: unknown unknown unknown unknown unknown GetStaticProps<BlogPostPageProps> = async ({;
  params,;
}: {;
  params?: { slug?: string };
}) => {;''
