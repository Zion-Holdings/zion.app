          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-16 pt-8 border-t border-white/20">
              ...
              <div className="flex gap-4">
                <a 
                  href={`https://twitter.com/intent/tweet?text=${encodeURIComponent('AI Automation Trends 2025 - Autonomous Systems & Edge Computing')}&url=${encodeURIComponent('https://bolt.new.zion.app/blog/ai-automation-trends-2025')}`}
                  target="_blank"
                ...
                <a 
                  href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent('https://bolt.new.zion.app/blog/ai-automation-trends-2025')}`}
                  target="_blank"
                  rel="noopener noreferrer"
