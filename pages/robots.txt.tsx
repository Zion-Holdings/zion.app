...
const Https___ziontechgroup_netlify_app_robots_txtPage: NextPage = () => {
  return (
    <div className="relative z-10 container-responsive py-8">
      ...
      <Head>
        ...
        <meta name="keywords" content="https://ziontechgroup.netlify.app/robots.txt, Zion, AI marketplace" />
      </Head>
...
export default Https___ziontechgroup_netlify_app_robots_txtPage