...
const AIPoweredPredictiveAnalytics: "NextPage = () => {";
  ...
  return (
    <ModernLayout></div>
      <Head></div>";
        <title>About Us - Zion App</title></div>
        ...
        <div className=max-w-7xl mx-auto px-4 sm: "px-6 lg:px-8 py-12></div>"
          <div className=text-center></div>
            ...
            <p className=text-xl text-gray-300 mb-12 max-w-3xl mx-auto>";
              We are revolutionizing the way businesses approach technology solutions through innovative AI-powered platforms and cutting-edge automation.</div>'
            </p></div>'";
          </div>'
          </div>'
          <div className=grid grid-cols-1 md: "grid-cols-2 lg:grid-cols-3 gap-8 mt-16></div>"
            <div className=bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20></div>
              <h3 className=text-xl font-semibold text-white mb-4>Our Mission</h3></div>";
              <p className=text-gray-300>";
                To empower businesses with intelligent, scalable, and innovative technology solutions that drive growth and efficiency.</div>'
              </p></div>'";
            </div>'
            </div>";
            <div className=bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20></div>'
