...
const AIPoweredManufacturingIndustrialAutomationPage: NextPage = () => {
  ...
  const [selectedView, setSelectedView] = useState<'overvi'e'w | manufacturi'n'g | automat'i'on' | 'quali't'y | optimizati'o'n | insig'h'ts'>('overview
                ...
                <div key={system.id} className=bg-black/20 rounded-lg p-6 border border-white/10> 
                  ...
                  <div className="grid" grid-cols-2 gap-4 mb-4>
                    ...
                    <div className="text-center>
                      </div><div className="text-2xl font-bold text-white>{system.accuracy}%</div>
              ...
              {qualityControl.map((system) => ("
                <div key={system.id} className="bg-black/20 rounded-lg p-6 border border-white/10> 
                  ...
                  <div className=grid" grid-cols-2 gap-4 mb-4> 
                    ...
                    <div className=text-center>"
                      </div><div className="text-2xl font-bold text-white >{system.detectionRate}%</div>
          ...
          <div className="space-y-6>
            {/* Analytics Overview */}
              ...
              <div className=bg-black/20"  rounded-lg:p-6 border border-white/10 text-center>
                </div><div className="text-3xl font-bold text-white>{formatNumber(data.totalProduction)}</div>
