        ...
        >
          ...
          <div className="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {[ 
              ...
              { label: 'Performance Budget Runner', desc: 'Checks size budgets; writes reports and flags regressions.', href: '/.netlify/functions/performance-budget-runner' },
              { label: 'Structured Data Generator', desc: 'Publishes JSON-LD for SEO (Organization, WebSite, WebPage).', href: '/.netlify/functions/structured-data-generator' },
              { label: 'Internal Anchors Checker', desc: 'Detects broken #anchor links and missing ids.', href: '/.netlify/functions/internal-anchors-checker' }
            ].map((f) => (
