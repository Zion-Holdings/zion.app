...
export default function MainFrontIndex() {
  ...
  <div className="mt-3 inline-flex items-center gap-1 text-xs text-cyan-300/90">Open <span aria-hidden>↗</span></div></a>
        ...
        >
          ...
          <p className="mx-auto mt-2 max-w-3xl text-center text-sm text-white/70">Autonomous cloud agents that scan, advise, and keep the experience evergreen — no humans, no servers.</p>
          <div className="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
            <a href="/.netlify/functions/ux-drift-detector" className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-xl hover:border-cyan-400/30 tilt-on-hover holo">
              <div className="pointer-events-none absolute -inset-px -z-10 bg-gradient-to-r from-fuchsia-500/0 via-cyan-400/10 to-fuchsia-500/0 opacity-0 blur-2xl transition-opacity group-hover:opacity-100" />
              <div className="flex items-center gap-2"><Search className="h-5 w-5 text-cyan-300" /><h3 className="text-lg font-semibold">UX Drift Detector</h3></div>
              <p className="mt-1 text-sm text-white/75">Detects content/UX drift across pages, docs, and automations.</p>
              <div className="mt-3 inline-flex items-center gap-1 text-xs text-cyan-300/90">Run <span aria-hidden>↗</span></div>
            </a>
            <a href="/.netlify/functions/unused-asset-cleaner" className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-xl hover:border-cyan-400/30 tilt-on-hover holo">
              <div className="pointer-events-none absolute -inset-px -z-10 bg-gradient-to-r from-fuchsia-500/0 via-cyan-400/10 to-fuchsia-500/0 opacity-0 blur-2xl transition-opacity group-hover:opacity-100" />
              <div className="flex items-center gap-2"><Link2 className="h-5 w-5 text-cyan-300" /><h3 className="text-lg font-semibold">Unused Asset Cleaner</h3></div>
              <p className="mt-1 text-sm text-white/75">Finds unreferenced media under public/ and writes a report.</p>
              <div className="mt-3 inline-flex items-center gap-1 text-xs text-cyan-300/90">Run <span aria-hidden>↗</span></div>
            </a>
            <a href="/.netlify/functions/type-tightener" className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-xl hover:border-cyan-400/30 tilt-on-hover holo">
              <div className="pointer-events-none absolute -inset-px -z-10 bg-gradient-to-r from-fuchsia-500/0 via-cyan-400/10 to-fuchsia-500/0 opacity-0 blur-2xl transition-opacity group-hover:opacity-100" />
              <div className="flex items-center gap-2"><BarChart3 className="h-5 w-5 text-cyan-300" /><h3 className="text-lg font-semibold">Type Tightener</h3></div>
              <p className="mt-1 text-sm text-white/75">Runs TypeScript checks and summarizes issues for action.</p>
              <div className="mt-3 inline-flex items-center gap-1 text-xs text-cyan-300/90">Run <span aria-hidden>↗</span></div>
            </a>
          </div>
        </motion.section>
