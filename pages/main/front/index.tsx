...
{/* Footer */}
        ...
        <section id="auto-ads" className="mx-auto max-w-7xl px-6 pb-16">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            ...
            <Link href="/.netlify/functions/content-staleness-auditor"><a className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-xl tilt-on-hover holo neon-ring"><div className="text-base font-semibold">Content Staleness Auditor</div><div className="mt-1 text-sm text-white/75">Flags outdated pages/docs and publishes a report</div></a></Link>
            <Link href="/.netlify/functions/image-lazyload-auditor"><a className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-xl tilt-on-hover holo neon-ring"><div className="text-base font-semibold">Image Lazyload Auditor</div><div className="mt-1 text-sm text-white/75">Finds img tags without loading attribute</div></a></Link>
            <Link href="/.netlify/functions/internal-link-orphan-audit"><a className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-xl tilt-on-hover holo neon-ring"><div className="text-base font-semibold">Internal Link Orphans</div><div className="mt-1 text-sm text-white/75">Detects internal links that do not resolve</div></a></Link>
            <Link href="/.netlify/functions/css-bloat-report"><a className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-xl tilt-on-hover holo neon-ring"><div className="text-base font-semibold">CSS Bloat Report</div><div className="mt-1 text-sm text-white/75">Sizes CSS bundles and highlights heavy files</div></a></Link>
