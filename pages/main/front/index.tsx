        ...
        >
          ...
          <div className="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {[ 
              ...
              { label: 'Structured Data Auditor', desc: 'Checks JSON‑LD coverage; writes a public report.', href: '/.netlify/functions/structured-data-auditor' },
              { label: 'Robots Auditor', desc: 'Validates robots.txt and sitemap linkage.', href: '/.netlify/functions/robots-auditor' },
              { label: 'Canonical Auditor', desc: 'Scans canonical tags for correctness.', href: '/.netlify/functions/canonical-auditor' }
            ].map((f) => (
...
<section id="auto-promoted" className="mx-auto max-w-7xl px-6 pb-14">
  ...
  <div className="mt-1 text-sm text-white/75">Ecosystem intelligence</div>
  <div className="mt-3 inline-flex items-center gap-1 text-xs text-cyan-300/90">Open <span aria-hidden>→</span></div></a></Link>
              <Link href="/reports/github-trending"><a className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-xl hover:border-cyan-400/30 tilt-on-hover holo">
  <div className="text-base font-semibold">GitHub Trending</div>
  <div className="mt-1 text-sm text-white/75">Daily hottest repos</div>
  <div className="mt-3 inline-flex items-center gap-1 text-xs text-cyan-300/90">Open <span aria-hidden>→</span></div></a></Link>
              <Link href="/reports/ai-papers"><a className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-xl hover:border-cyan-400/30 tilt-on-hover holo">
  <div className="text-base font-semibold">AI Papers Watch</div>
  <div className="mt-1 text-sm text-white/75">Recent arXiv cs.AI</div>
  <div className="mt-3 inline-flex items-center gap-1 text-xs text-cyan-300/90">Open <span aria-hidden>→</span></div></a></Link>
              <Link href="/.netlify/functions/topic-map-runner"><a className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-xl hover:border-cyan-400/30 tilt-on-hover holo">
  <div className="text-base font-semibold">Site Topic Map</div>
  <div className="mt-1 text-sm text-white/75">Knowledge graph of site topics</div>
  <div className="mt-3 inline-flex items-center gap-1 text-xs text-cyan-300/90">Open <span aria-hidden>→</span></div></a></Link>
  </div>
</section>
