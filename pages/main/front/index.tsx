        ...
        >
          ...
          <div className="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {[ 
              ...
              { label: 'Edge Cache Warmer', desc: 'Proactively warms critical pages globally.', href: '/.netlify/functions/edge-cache-warmer' },
              { label: 'OG Meta Auditor', desc: 'Finds pages missing OG tags', href: '/.netlify/functions/og-meta-auditor' },
              { label: 'Repo Fitness Score', desc: 'Calculates recent commit cadence and repo fitness.', href: '/.netlify/functions/repo-fitness-score' },
            ].map((f) => (
