        ...
        >
          ...
          <div className="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {[ 
              ...
              { label: 'Roadmap Curator', desc: 'Generates a living roadmap from repo signals; commits reports.', href: '/.netlify/functions/roadmap-curator' },
              { label: 'Patterns Miner', desc: 'Discovers code patterns and refactor opportunities.', href: '/.netlify/functions/patterns-miner' }
            ].map((f) => (
