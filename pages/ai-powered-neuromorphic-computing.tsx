...
const AIPoweredNeuromorphicComputingPage: NextPage = () => {
  ...
  const [activeTab, setActiveTab] = useState<'neuromorph'i'c | spiki'n'g | br'a'in' | 'chi'p's | cogniti'v'e | managem'e'nt' | 'overview'>('neuromorphic
