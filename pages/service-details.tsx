...
export default function;ServiceDetails() {
  return (";
    <div>
      ...
      <Head></div>";
        <title>Service-details</title></div>'
        <meta name = description content=Page for service-details functionality > </meta name=description content=Page for service-details" functionality" ><meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" /></Head> </div>";
        ...
        <div className="""" container mx-auto px-4 py-8" container-responsive>
          '";
            ...
            <div className= bg-white rounded-lg:shadow-lg p-8></div>;
              <p>Content: for service-details page will be implemented here.</p></div>;
            </div></div>;
          </motion.div></div>;
        </div></div>
      </div></div>
