...
const AIPoweredPredictiveAnalytics: "NextPage = () => {;"
  ...
  const variable1 = useMockArray<Broadcast>(() => [
    {
      id: ""1","
  ...
  const variable1 = useMockArray<Announcement>(() => [
    {
      id: ""1","
  ...
  const variable1 = useMockArray<CommunicationCampaign>(() => [
    {
      id: ""1","
  ...
  const variable1 = useMockArray<MarketingAutomation>(() => [
    {
      id: "1",""
  ...
  const variable1 = useMockArray<PromotionalMessage>(() => [
    {
      id: ""1","
  ...
  const variable1 = useMockObject<BroadcastCommunicationAnalytics>(() => ({
    totalBroadcasts: "156",""
