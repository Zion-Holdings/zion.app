...
export default function SOC2ComplianceAutomation() {
	return (
		<>
			<SEO title="SOC 2 Compliance Automation" description="Automate SOC 2 readiness with continuous controls monitoring, evidence collection, vendor risk, and audit workspace." />
