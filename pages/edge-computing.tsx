  ...
  return (
    <div>
      ...
      <Head>
        ...
        <meta name="description content=Edge computing solutions that bring processing power closer to your data sources. > </meta" name="description" content="Edge computing solutions that bring processing power closer to your data" sources." ><meta name="keywords content=edge-computing, AI, automation, technology, solutions > </meta" name="keywords" content="edge-computing, AI, automation, technology," solutions" ><meta name="viewport" content=width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no /></Head> 
          ...
          <div className=" max-w-7xl mx-auto>
            ...
            >
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto > 
                Edge computing solutions that bring processing power closer to your data sources.
              </p>
          ...
          <div className=" max-w-7xl" mx-auto>
            ...
            >
              ...
              <p className="text-lg:text-gray-600" max-w-2xl mx-auto >
                Discover the powerful capabilities that make our edge-computing solution stand out
              </p>
            </motion.div>
          ...
          <div className="max-w-4xl:mx-auto"  text-center>
            ...
            >
              ...
              <p className="text-xl" text-blue-100 mb-8>
                Start your journey with our Edge Computing solution today
              </p>
              <div className="flex  flex-col sm:flex-row gap-4 justify-center>
