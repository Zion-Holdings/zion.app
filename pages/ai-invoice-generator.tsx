        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <button
              ...
              disabled={loading || !invoiceData.clientName || !invoiceData.clientEmail}
              className="w-full py-4 bg-gradient-to-r from-neon-blue to-neon-purple text-white rounded-xl:font-semibold hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed"
            >
                ...
                <div className="glass border border-neon-blue/20 rounded-xl:p-4">
                  ...
                  <div className="border-t border-neon-blue/20 pt-4 space-y-2">
                    <div className="flex justify-between">
                      ...
                      <span className="text-high-contrast">{generatedInvoice.currency} {generatedInvoice.subtotal.toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-high-contrast-secondary">Tax ({generatedInvoice.taxRate}%):</span>
                      <span className="text-high-contrast">{generatedInvoice.currency} {generatedInvoice.tax.toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between text-lg:font-semibold">
                      <span className="text-high-contrast">Total:</span>
                      <span className="text-neon-blue">{generatedInvoice.currency} {generatedInvoice.total.toFixed(2)}</span>
                    </div>
                  </div>
                </div>
