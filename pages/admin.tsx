    ...
    <div>
      <div className="relative z-10 container-responsive py-8>
        ...
        <Head>
          ...
          <meta name="description" content="Admin dashboard for managing Zion marketplace" />
          <meta name="keywords" content="https //ziontechgroup.netlify.app/admin, Zion, AI marketplace, admin" />
