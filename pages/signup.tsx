...
const Https___ziontechgroup_netlify_app_signupPage: NextPage = () => {
  return (
  <ModernLayout>
    return (
  <ModernLayout>
  ...
  <ModernLayout>
    ...
    <div className="relative z-10 container-responsive py-8">
      ...
      <Head>
        ...
        <meta name="keywords" content="https://ziontechgroup.netlify.app/signup, Zion, AI marketplace" />
...
export default Https___ziontechgroup_netlify_app_signupPage