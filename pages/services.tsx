      ...
      <Layout>
        <div className="min-h-screen bg-black text-white relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
              ...
              <div className="bg-gray-900/60 backdrop-blur-xl border border-gray-700/50 rounded-3xl p-8 shadow-2xl shadow-cyan-500/10">
                <div className="flex flex-col lg:flex-row gap-6 items-center">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    {/* Enhanced View Mode */}
                    <div className="flex items-center space-x-2 bg-gray-800/50 border border-gray-700/50 rounded-2xl p-1.5">
                      <button
                ...
                {categories.map((category, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="bg-gray-900/60 backdrop-blur-xl border border-gray-700/50 rounded-3xl p-8 hover:border-cyan-500/50 hover:shadow-2xl hover:shadow-cyan-500/20 transition-all duration-500 cursor-pointer group transform hover:scale-105"
                    ...
                    >
                      ...
                      <div className="mt-6 text-center">
                        <div className="inline-flex items-center text-cyan-400 text-sm font-medium group-hover:text-cyan-300 transition-colors duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {sortedServices.map((service, index) => (
                    <motion.div
                      ...
                      className="bg-gray-900/60 backdrop-blur-xl border border-gray-700/50 rounded-3xl p-8 hover:border-cyan-500/50 hover:shadow-2xl hover:shadow-cyan-500/20 transition-all duration-500 hover:transform hover:scale-105 group relative overflow-hidden"
                    >
                      ...
                      <div className="relative z-10 mb-6">
                        <div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-2xl flex items-center justify-center text-2xl shadow-lg">
                          {service.icon}
                        </div>
                      </div>
                      ...
                      <div className="flex items-start justify-between mb-6">
                        <div className="flex-1">
                          ...
                          <p className="text-gray-300 text-base leading-relaxed">{service.tagline}</p>
                        </div>
                        {service.popular && (
                          <motion.span 
                            initial={{ scale: 0 }}
                            ...
                            className="px-3 py-1 text-sm bg-gradient-to-r from-pink-500 to-rose-500 text-white rounded-full shadow-lg"
                          >
                            ⭐ Popular
                          </motion.span>
                        )}
                      ...
                      {/* Enhanced Price */}
                      <div className="mb-6 p-4 bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border border-cyan-500/20 rounded-2xl">
                        <div className="text-3xl font-bold text-white mb-1">${service.price.monthly}</div>
                        <div className="text-gray-300 text-sm">/month</div>
                        <div className="text-cyan-400 text-sm font-medium mt-2">✨ {service.price.trialDays}-day free trial</div>
                        <div className="text-gray-400 text-xs mt-1">Setup: {service.price.setupTime}</div>
                      </div>

                      {/* Enhanced Features */}
                      <div className="mb-6">
                        <div className="text-cyan-300 font-medium mb-3">🚀 Key Features:</div>
                      ...
                      <div className="grid grid-cols-3 gap-3 mb-6 text-center">
                        ...
                        <div className="bg-gray-800/50 rounded-2xl p-3 border border-gray-700/50">
                          <div className="text-green-400 font-bold text-lg">{service.reviews}</div>
                      ...
                      <a
                        href={service.link}
                        className="block w-full bg-gradient-to-r from-cyan-500 to-purple-600 text-white py-4 px-6 rounded-2xl text-center font-semibold text-base hover:from-cyan-600 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl hover:shadow-cyan-500/25 group"
                      >
            ...
            >
              <div className="relative bg-gradient-to-r from-cyan-500/10 via-purple-500/10 to-pink-500/10 border border-cyan-500/20 rounded-3xl p-16 overflow-hidden">
                {/* Background Effects */}
                ...
                <div className="relative z-10">
                  <motion.div
                    ...
                    className="mb-8"
                  >
                    <div className="inline-flex items-center px-6 py-3 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/30 text-cyan-300 text-lg font-medium mb-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-6 justify-center">
                    <motion.a
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="bg-gradient-to-r from-cyan-500 to-purple-600 text-white px-10 py-5 rounded-2xl font-bold text-xl hover:from-cyan-600 hover:to-purple-700 transition-all duration-300 shadow-2xl hover:shadow-cyan-500/25 transform hover:scale-105"
                    >
                      🚀 Get Started Today
                    </motion.a>
                    <motion.a
                      ...
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="border-2 border-cyan-500/50 text-cyan-300 px-10 py-5 rounded-2xl font-bold text-xl hover:border-cyan-400 hover:bg-cyan-500/10 transition-all duration-300 transform hover:scale-105"
                    >
                      💰 View Pricing
                    </motion.a>
                  </div>
