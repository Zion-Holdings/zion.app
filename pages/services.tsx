...
export default function ServicesPage() {
  const services = [
    ...
    },
    {
      ...
      description: 'Predictive sales intelligence with pipeline optimization and revenue prediction.',
      features: [
    ...
    },
    {
      ...
      description: 'Intelligent product suggestions with behavioral analysis and conversion optimization.',
      features: [
