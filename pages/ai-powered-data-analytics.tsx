        ...
        <div className=max-w-7xl mx-auto px-4 sm:px-6 lg px-8>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-300>"
                ...
                <li><Link href=/talents"" className=hover text-white transition-colors >Talents</Link href=/talents  className="hover text-white transition-colors ></Link></li>
              </ul>
            </div>
            <div>
              ...
              <ul className=""space-y-2" text-sm:text-gray-300>
                ...
                <li><Link href=/docs"" className=hover text-white transition-colors >Documentation</Link href=/docs  className="hover text-white transition-colors ></Link></li>
              </ul>
            </div>
            <div>
