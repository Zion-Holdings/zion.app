...
;";";";"
const ProductDetailPage: unknown unknown unknown unknown "unknown unknown = ({ product "}: ProductPageProps) => {;
  if (!product) {;
    return (;
      <div>;
        <Head>;"
...
;";";"
export const _getServerSideProps: unknown unknown unknown unknown unknown GetServerSideProps<;";";";"
  ProductPageProps;";";";";"
