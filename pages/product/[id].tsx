...
;
const ProductDetailPage: unknown unknown = ({ product }: ProductPageProps) => {;
  if (!product) {;
    return (;
      <div>;
        <Head>;
...
;
export const _getServerSideProps: unknown GetServerSideProps<;
  ProductPageProps;"
> = async (context: "{ params?: { id?: string "} }) => {;
  const id: unknown unknown = context.params?.id;
;"
  if (typeof id !== 'string') {;'
