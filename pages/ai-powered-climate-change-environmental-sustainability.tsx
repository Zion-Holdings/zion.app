...
const AIPoweredClimateChangeEnvironmentalSustainabilityPage: NextPage = () => {
  ...
  const [selectedView, setSelectedView] = useState<'overvi'e'w | clima't'e | sustainabil'i'ty' | 'carb'o'n | impac't's | analyt'i'cs'>('overview
