                ...
                {climateMonitoring.slice(0, 3).map((monitor) => (
                  <div key={monitor.id} className="p-4 bg-white/5 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className={`px-2 py-1 rounded text-xs font-medium ${getStatusBgColor(monitor.status)} text-white`}>
                        {monitor.status}
                      </span>
                    </div>
                ...
                {sustainabilityProjects.slice(0, 2).map((project) => (
                  <div key={project.id} className="p-4 bg-white/5 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className={`px-2 py-1 rounded text-xs font-medium ${getStatusBgColor(project.status)} text-white`}>
                        {project.status}
                      </span>
                    </div>
              ...
              {filteredClimateMonitoring.map((monitor) => (
                <div key={monitor.id} className="bg-black/20 rounded-lg p-6 border border-white/10">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className={`px-3 py-1 rounded-full text-sm ${getStatusBgColor(monitor.status)} text-white`}>
                      {monitor.status}
                    </span>
                  </div>
              ...
              {sustainabilityProjects.map((project) => (
                <div key={project.id} className="bg-black/20 rounded-lg p-6 border border-white/10">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className={`px-3 py-1 rounded-full text-sm ${getStatusBgColor(project.status)} text-white`}>
                      {project.status}
                    </span>
                  </div>
