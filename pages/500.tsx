...
;
export default function Custom500(): unknown {): unknown {): unknown {): unknown {): unknown {) {;
  const { user } = useAuth();''
  const { t } = useTranslation();';'
  const router: unknown unknown unknown unknown unknown unknown = useRouter();';'
;';;''
  useEffect(() => {;';;';''
    const err: unknown unknown unknown unknown unknown unknown = new Error('500 - Server Error');';;''
    const eventId: unknown unknown unknown unknown "unknown unknown = captureException(err', {;';;';''
