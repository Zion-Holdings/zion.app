...
export default function Custom500() {
	return (
		<div className="min-h-[60vh] flex flex-col items-center justify-center text-center p-8">
			        <SEO data={{
          pageTitle: "Server Error – Zion Tech Group",
          pageDescription: "Something went wrong on our end. Please try again or return home.",
          pageKeywords: ["500", "server error", "Zion Tech Group"]
        }} />
