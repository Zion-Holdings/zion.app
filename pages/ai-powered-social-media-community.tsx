        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link href="/auth/signup" className="bg-gradient-to-r from-teal-600 to-cyan-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:from-teal-700 hover:to-cyan-700 transition-all duration-200">
                Get Started
              </Link>
            </div>
          </div>
                ...
                {communityManagement.slice(0, 2).map((management) => (
                  <div key={management.id} className="p-4 bg-white/5 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className={`px-2 py-1 rounded text-xs font-medium ${getStatusBgColor(management.status)} text-white`}>
                        {management.status}
                      </span>
                    </div>
              ...
              {communityManagement.map((management) => (
                <div key={management.id} className="bg-black/20 rounded-lg p-6 border border-white/10">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className={`px-3 py-1 rounded-full text-sm ${getStatusBgColor(management.status)} text-white`}>
                      {management.status}
                    </span>
                  </div>
              ...
              {contentModeration.map((moderation) => (
                <div key={moderation.id} className="bg-black/20 rounded-lg p-6 border border-white/10">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className={`px-3 py-1 rounded-full text-sm ${getStatusBgColor(moderation.status)} text-white`}>
                      {moderation.status}
                    </span>
                  </div>
