  ...
  return (
    <div>
      ...
      <Head>
        ...
        <meta name="description content=Mixed reality experiences that blend physical and digital worlds. > </meta" name="description" content="Mixed reality experiences that blend physical and digital" worlds." ><meta name="keywords content=mixed-reality, AI, automation, technology, solutions > </meta" name="keywords" content="mixed-reality, AI, automation, technology," solutions" ><meta name="viewport" content=width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no /></Head> 
          ...
          <div className=" max-w-7xl mx-auto>
            ...
            >
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto > 
                Mixed reality experiences that blend physical and digital worlds.
              </p>
          ...
          <div className=" max-w-7xl" mx-auto>
            ...
            >
              ...
              <p className="text-lg:text-gray-600" max-w-2xl mx-auto >
                Discover the powerful capabilities that make our mixed-reality solution stand out
              </p>
            </motion.div>
          ...
          <div className="max-w-4xl:mx-auto"  text-center>
            ...
            >
              ...
              <p className="text-xl" text-blue-100 mb-8>
                Start your journey with our Mixed Reality solution today
              </p>
              <div className="flex  flex-col sm:flex-row gap-4 justify-center>
