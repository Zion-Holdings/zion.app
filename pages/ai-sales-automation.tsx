      ...
      <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-green-400 via-emerald-400 to-teal-400 bg-clip-text text-transparent flex items-center justify-center gap-3"><ChartBar className="w-10 h-10" />{service.name}</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12">
            ...
            <div className="bg-black/30 rounded-2xl border border-emerald-500/30 p-6 h-fit">
              ...
              <Button href="/contact" variant="primary" size="lg" className="w-full">Accelerate Pipeline<ArrowRight className="w-5 h-5 ml-2" /></Button>
              <div className="mt-6 space-y-3 text-sm text-slate-300">
                <div className="flex items-center space-x-2"><Phone className="w-4 h-4 text-emerald-400" /><span>{service.contactInfo.mobile}</span></div>
