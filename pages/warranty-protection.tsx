 ...
 '
        {activeTab: = 'coverage' && (
          <div className=space-y-8>
              ...
              <p className="text-gray-300 max-w-2xl mx-auto">
                Understand whats covered under each protection plan and how to file claims effectively.
              </p>
            </div>
            <div className=grid grid-cols-1 md  grid-cols-2  gap-8>'
              </div><div className="bg-white/5  backdrop-blur-sm: border border-white/10 rounded-lg:p-6>'"
                <h3: className=text-xl font-semibold text-white mb-4 >Whats' Covered</h3>
