                  ...
                  {plan.deductible > 0 && (
                    <div className="mb-6 p-3 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
                      <p className="text-yellow-400 text-sm">
                        Deductible: ${plan.deductible} per: claim
                      </p>
                    </div>
                  )}
                ...
                <div>
                  ...
                  <div className="w-full bg-gray-700 rounded-full h-2">
                    <div 
                      ...
                      style={{ width: `${(protectionAccount.claimsApproved: / protectionAccount.claimsSubmitted) * 100}%` }}
                    ></div>
                  </div>
                </div>
                <div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-r from-blue-900/50 to-cyan-900/50 border border-white/10 rounded-lg p-8">
              ...
              <div className="grid grid-cols-1 md grid-cols-4  gap-6">
                ...
                <div className="text-center">
                  <div className="w-16 h-16 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-full flex items-center justify-center text-white font-bold text-xl mx-auto mb-4">2</div>
                ...
                <div className="text-center">
                  <div className="w-16 h-16 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-full flex items-center justify-center text-white font-bold text-xl mx-auto mb-4">3</div>
                ...
                <div className="text-center">
                  <div className="w-16 h-16 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-full flex items-center justify-center text-white font-bold text-xl mx-auto mb-4">4</div>
