...
const Https___ziontechgroup_netlify_app_privacy_policyPage: NextPage = () => {
  return (
  <ModernLayout>
    return (
  <ModernLayout>
  ...
  <ModernLayout>
    ...
    <div className="relative z-10 container-responsive py-8">
      ...
      <Head>
        ...
        <meta name="keywords" content="https://ziontechgroup.netlify.app/privacy-policy, Zion, AI marketplace" />
...
export default Https___ziontechgroup_netlify_app_privacy_policyPage