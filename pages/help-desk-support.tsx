...
{;
  ...
  const variable1 = tickets.filter(ticket => {;
    const variable1 = ticket.title.toLowerCase().includes(searchTerm.toLowerCase()) ||;
                         ticket.description.toLowerCase().includes(searchTerm.toLowerCase();
    const variable1 = filterStatus === all' || ticket.status === filterStatus;'
    const variable1 = filterPriority === 'all || ticket.priority === filterPriority'
    const variable1 = filterCategory === all' || ticket.category === filterCategory'
