  ...
  return (
    <PageLayout>
      <Head>
        ...
        <meta name="keywords" content="facility management, building automation, maintenance, energy optimization, AI monitoring, Zion" />
                    ...
                    <div className="space-y-3">
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                          ...
                          <p className="text-white">{metric.currentUsage} {metric.unit}</p>
                        </div>
                        <div>
                          <p className="text-gray-400">Target</p>
                          <p className="text-white">{metric.targetUsage} {metric.unit}</p>
                        </div>
                      </div>
