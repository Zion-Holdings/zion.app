...
const Https___ziontechgroup_netlify_app_dashboardPage: NextPage = () => {
  return (
    <div>
...
export default Https___ziontechgroup_netlify_app_dashboardPage)