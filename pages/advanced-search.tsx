    ...
    <ModernLayout>
      <div className="relative" z-10 container-responsive py-8>
        ...
        <Head>
          ...
          <meta name="description content=Advanced search and filter system for finding services, talents, equipment, and products on Zion marketplace > </meta" name="description" content="Advanced search and filter system for finding services, talents, equipment, and products on Zion" marketplace" ><meta name="keywords content=advanced search, marketplace search, filter, Zion > </meta" name="keywords" content="advanced search, marketplace search, filter," Zion" ><link rel="icon href=/favicon.ico > </link" rel="icon" href="/favicon.ico" ><meta name="viewport content=width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no > </meta" name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0," user-scalable=no" ></Head>
                  ...
                  <div className="flex  space-x-2>'
                    ...
                    >"
                      <svg className=" w-5 h-5 text-white fill=currentColor viewBox=0 0 20" 20">
                        <path d=M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z > </path" d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0" 01-2-2v-2z" ></svg>
                    </button>'
                    '''`
                    ...
                    >
                      <svg className=" w-5 h-5 text-white fill=currentColor " viewBox="0 0 20" 20">
                        <path fillRule="evenodd" d="M3 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0" 01-1-1z clipRule=evenodd > </path" fillRule="evenodd" d="M3 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0" 01-1-1z" clipRule="evenodd" ></svg>
                    </button>
                  </div>
                </div>
              </div>
...
{result.type === 'service' || result.type === 'talent' ? '/hr' : ''}
                      ...
                      <div className=" flex flex-wrap gap-2 mb-4 >
                        {result.tags.slice(0, 3).map((tag) => (
                          <span key={tag} className="text-xs" bg-purple-500/20 text-purple-300 px-4 py-3 rounded> {tag}
                          </span>
                        ))}
                      </div>
          ...
          <div className="mt-12" text-center>
              ...
              <div className=" flex flex-col sm flex-row gap-4" justify-center>
                <Link href=/ai-service-matcher className="bg-gradient-to-r" from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-8 py-4 rounded-lg:text-lg font-semibold transition-all duration-300 shadow-lg hover shadow-purple-500/25 transform hover scale-105 >AI Recommendations
                ...
                <Link href=/real-time-chat className="border" border-white/20 text-white hover:bg-white/10 px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300 backdrop-blur-sm >Chat with Expert
