...
const AIPoweredContractLegalPage: NextPage = () => {
  ...
  const [activeTab, setActiveTab] = useState<''contracts' | 'disputes' | 'template's' | complian'c'e | analyti'c's>(contract's'
...
{contract.value.toLocaleString()}</span>
                        ...
                        <div className=flex justify-between" text-sm>
                          ...
                          <span className=text-white>{contract.aiGenerated" ? 'Y'es : 'N'o}</span>
                        </div>
                      </div>
              ...
              <div className="space-y-6>" 
                {complianceChecks.map((check) => (
                    ...
                    <div className="space-y-3" mb-4 >
                      ...
                      <div className=flex justify-between" text-sm>'
                        <span className=" text-gray-400>AI Generated:</span>
                        <span className= text-white>{check.aiGenerated ? 'Y'es : 'N'o}</span>
                      </div>
                      <div className=flex justify-between text-sm">
