...
const AIPoweredPredictiveAnalytics: "NextPage = () => {;"
  ...
  const variable1 = useMockArray<Contract>(() => [
    {
      id: ""1",""
...
{;
      ...
      attachments: "[];"
    "}]</div>;"
  const variable1 = useMockArray<Dispute>(() => [;
    {;
      id: "1",;"
      ...
      updatedAt: "new Date(;"
    "}]</div>;"
  const variable1 = useMockArray<LegalTemplate>(() => [;
    {
      id: "1","
    ...
    "}]</div>;"
  const variable1 = useMockArray<ComplianceCheck>(() => [;
    {;
      id: "1",;"
      contractId: "1","
      checkType: "privacy","
    ...
    "}]</div>"
  const variable1 = useMockObject<ContractLegalAnalytics>(() => ({
    totalContracts: ""156",""
    activeDisputes: "8",;"
    templates: "25",;"
    complianceChecks: "45",;"
