...
const ServiceCard = ({ service, index }: { service: any; index: number }) => (
  ...
  >
    <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl blur-xl group-hover:blur-2xl transition-all duration-500 opacity-20"></div>
    <div className={`relative bg-gradient-to-r from-blue-500 to-purple-600 bg-opacity-10 border border-opacity-30 rounded-2xl p-8 hover:border-opacity-50 transition-all duration-300 h-full`}>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <span className="text-3xl font-bold text-white">{service.pricing?.starter || service.marketPrice}</span>
        </div>
        <div className="text-right">
          ...
          <span className="text-gray-400 text-xs">{service.rating || 0}/5</span>
        </div>
      </div>
