...
const ServiceCard = ({ service, index }: { service: any; index: number }) => (
  ...
  >
    ...
    <div className={`relative bg-gradient-to-r ${service.color || 'from-cyan-500 to-blue-600'} bg-opacity-10 border border-opacity-30 rounded-2xl p-8 hover:border-opacity-50 transition-all duration-300 h-full`}>
      ...
      <div className="space-y-3 mb-6 text-xs text-gray-400">
        ...
        <div className="flex justify-between">
          <span>Customers:</span>
          <span>{service.customers?.toLocaleString() || '0'}</span>
        </div>
      </div>
