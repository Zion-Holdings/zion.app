  ...
  return (
    <div>
      ...
      <Head>
        ...
        <meta name="description content=Seamless AI integration solutions that connect all your systems and data sources. > </meta" name="description" content="Seamless AI integration solutions that connect all your systems and data" sources." ><meta name="keywords content=ai-powered-integration, AI, automation, technology, solutions > </meta" name="keywords" content="ai-powered-integration, AI, automation, technology," solutions" ><meta name="viewport" content=width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no /></Head> 
      <div className=" relative z-10 container-responsive py-8>
          ...
          <div className=" max-w-7xl mx-auto>
            ...
            >
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto > 
                Seamless AI integration solutions that connect all your systems and data sources.
              </p>
          ...
          <div className=" max-w-7xl" mx-auto>
            ...
            >
              ...
              <p className="text-lg:text-gray-600" max-w-2xl mx-auto >
                Discover the powerful capabilities that make our ai-powered-integration solution stand out
              </p>
            </motion.div>
        ...
        <section className=" py-40 px-4 sm:px-6 lg px-8" bg-gray-50>
          <div className="max-w-7xl  mx-auto">
            ...
            >"
              <h2 className="text-3xl" md text-4xl font-bold text-gray-900 mb-4>
                Why Choose Our Ai Powered Integration 
              </h2>
              <p className="text-lg:text-gray-600" max-w-2xl:mx-auto>
          ...
          <div className="max-w-4xl:mx-auto"  text-center>
            ...
            >
              ...
              <p className="text-xl" text-blue-100 mb-8>
                Start your journey with our Ai Powered Integration solution today
              </p>
              <div className="flex  flex-col sm:flex-row gap-4 justify-center>
