		...
		<UltraFuturisticBackground>
			...
			<div className="container mx-auto px-4 py-24 space-y-6 text-white">
				...
				<ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
					<li className="p-6 rounded-2xl bg-black/50 border border-gray-700/60 hover:border-cyan-500/50"><a href="https://x.com/ziontechgroup" target="_blank" rel="noopener noreferrer nofollow">Twitter/X</a></li>
					<li className="p-6 rounded-2xl bg-black/50 border border-gray-700/60 hover:border-cyan-500/50"><a href="https://www.linkedin.com/company/zion-tech-group" target="_blank" rel="noopener noreferrer nofollow">LinkedIn</a></li>
