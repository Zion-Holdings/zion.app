...
const $1: NextPage = () => {
  ...
  const [selectedView, setSelectedView] = useState<'overvi'e'w | planni'n'g | infrastruct'u're' | 'analyti'c's | developme'n't | insig'h'ts'>('overview</div>
      ...
      },
{
  ...
  const $1 = useMemo(() => {'
    return urbanPlanning.filter(planning => {
      const $1 = selectedType === al'l' || planning.type === selectedType
      return typeMatch}
