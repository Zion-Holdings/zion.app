        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link href="/auth/signup" className="bg-gradient-to-r from-indigo-600 to-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:from-indigo-700 hover:to-blue-700 transition-all duration-200">
                Get Started
              </Link>
            </div>
          </div>
                ...
                {urbanPlanning.slice(0, 3).map((planning) => (
                  <div key={planning.id} className="p-4 bg-white/5 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className={`px-2 py-1 rounded text-xs font-medium ${getStatusBgColor(planning.status)} text-white`}>
                        {planning.status}
                      </span>
                    </div>
                ...
                {infrastructureManagement.slice(0, 2).map((infrastructure) => (
                  <div key={infrastructure.id} className="p-4 bg-white/5 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className={`px-2 py-1 rounded text-xs font-medium ${getStatusBgColor(infrastructure.status)} text-white`}>
              ...
              {filteredUrbanPlanning.map((planning) => (
                <div key={planning.id} className="bg-black/20 rounded-lg p-6 border border-white/10">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className={`px-3 py-1 rounded-full text-sm ${getStatusBgColor(planning.status)} text-white`}>
                      {planning.status}
                    </span>
                  </div>
              ...
              {infrastructureManagement.map((infrastructure) => (
                <div key={infrastructure.id} className="bg-black/20 rounded-lg p-6 border border-white/10">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className={`px-3 py-1 rounded-full text-sm ${getStatusBgColor(infrastructure.status)} text-white`}>
                      {infrastructure.status}
                    </span>
                  </div>
              ...
              {urbanDevelopment.map((development) => (
                <div key={development.id} className="bg-black/20 rounded-lg p-6 border border-white/10">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className={`px-3 py-1 rounded-full text-sm ${getStatusBgColor(development.status)} text-white`}>
                      {development.status}
                    </span>
                  </div>
