...
const AIPoweredEntertainmentGamingPage: NextPage = () => {
  ...
  const [selectedView, setSelectedView] = useState<'overvi'e'w | gami'n'g | analyt'i'cs' | 'conte'n't | optimizati'o'n | insig'h'ts'>('overview</div>
