...
"
          ...
          <div className="mb-6""></div>
            <div className="flex space-x-2>
              {[a'l'l, performan'c'e, tre'n'd, predicti'o'n, optimizati'o'n].map((type) => (</div>
                <button
                  key={type}
                ...
                >
                  {type === a'l'l ? A'l'l : type.charAt(0).toUpperCase() + type.slice(1)}</div>
                </button>
              ))}</div>
            </div></div>
          </div>
...
;}
export default AIPoweredAnalysisPage;</div>