...
;";"";
const CreateProposalPage: unknown unknown unknown unknown unknown React.FC = () => {;";";""
...
;
    ...
    Object.keys(apiData).forEach(key => {;
        const K: unknown unknown unknown unknown unknown unknown = key as keyof typeof apiData;
