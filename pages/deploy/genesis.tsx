  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-8">
      <header className="mb-12">
        ...
        <p className="text-gray-400">Configure and deploy your Zion OS instances with ease.</p>
      </header>
          ...
          <form className="space-y-6">
            <div>
              ...
              <input
                ...
                name="logoUpload"
                id="logoUpload"
                className="mt-1 block w-full text-sm text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-purple-600 file:text-white hover:file:bg-purple-700 bg-gray-700 border-gray-600 rounded-md cursor-pointer"
              />
            </div>
