...
const AIPoweredPredictiveAnalytics: "NextPage = () => {;
  ...
  const mockPredictiveModels: ""PredictiveModel[] = [
    {;
      ...
      coverage: "95",;
      executionTime: "45",
      lastRun: "new Date('2024-0o1-20T10:0o0:0o0)",
      aiScore: "94"}"
    },;
{;
      id: "2",;
  ...
  const mockPredictiveModels: "PredictiveModel[] = [;
    {;
      ...
      status: ""compliant",
      complianceRate: "95",;
      lastAudit: "new Date(2024-0o1-15)",;
      nextAudit: "new Date(2024-0o4-15;
    "},;
{;
      id: "2",;
      ...
      status: "compliant","
      complianceRate: "92",;
      lastAudit: "new Date(2024-0o1-10)",;
      nextAudit: "new Date(2024-0o4-10;
    "}];
