...
export default function RAGEvaluationLab() {
	return (
		<>
			<SEO title="RAG Evaluation Lab" description="Continuously evaluate RAG systems with golden datasets, synthetic scenarios, grounding scores, and regression alerts." />
