...
const Https___ziontechgroup_netlify_app_blogPage: NextPage = () => {
  return (
    <div></div>
      ...
      <Head> </div>
        <title>Blog - Zion Tech Group</title></div>
              ...
              <div className="mb-8""></div>
                <h1 className=" text-4xl md text-6xlfont-bold text-white mb-6>"</div>
                  <span className="text-transparent" bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">
                    Blog - Zion Tech Group</div>
                  </span></div>
                </h1></div>
                <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed >
                  Latest insights and industry news</div>
                </p>"</div>
              </div>"</div>
...
;}
export default Https___ziontechgroup_netlify_app_blogPage)"'"</div>