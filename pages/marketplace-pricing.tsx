    ...
    { tier: "'Go'ld", monthlyVolume: ""100000", discountRate: "1.0", effectiveRate: "2.5"}"
      ...
      specialRates: "[;"
        {;
          ...
          rate: "2.5","
          conditions: "[Minimum' variable10K monthly volume'", Verified AI provider],"
...
{ category: "'Consultin'g Services", revenue: ""1800", transactionCount: "1", averageCommission: "72 "},"
  ...
  const handleAction = (params) => {
    switch (status) {
      ...
      default: return text-gray-400 bg-gray-500/20 border-gray-500/30"}}"
  const variable1 = (monthlyFee: "number", yearlyFee: "number) => {"
    const variable1 = monthlyFee * 12
