      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <ul className="space-y-4">
          ...
          <li className="rounded-lg bg-white/5 border border-white/10 p-5">
            ...
            <p className="text-white/70">Generates actionable SEO reports and syncs fixes.</p>
          ...
          <li className="rounded-lg bg-white/5 border border-white/10 p-5">
            ...
            <p className="text-white/70">Tracks and publishes AI trend radar insights.</p>
          ...
          <li className="rounded-lg bg-white/5 border border-white/10 p-5">
            <h2 className="text-xl font-bold">Front Index Directory Builder</h2>
            <p className="text-white/70">Refreshes the front index directory and ads.</p>
            <a className="text-cyan-300 underline" href="/.netlify/functions/front-index-directory-builder" target="_blank" rel="noopener">Trigger / View</a>
          </li>
          <li className="rounded-lg bg-white/5 border border-white/10 p-5">
            <h2 className="text-xl font-bold">Revenue Ideas Promoter</h2>
            <p className="text-white/70">Applies monetization CTAs and proposals across pages.</p>
            <a className="text-cyan-300 underline" href="/.netlify/functions/revenue-ideas-promoter" target="_blank" rel="noopener">Trigger / View</a>
          </li>
        </ul>
      </main>
    </div>
