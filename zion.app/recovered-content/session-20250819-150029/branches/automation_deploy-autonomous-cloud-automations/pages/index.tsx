      ...
      <main className="relative z-10">
        ...
        <section className="mx-auto max-w-7xl px-6 pb-20">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
               ...
               { title: 'Autonomous Innovation Generator', desc: 'Invents and applies fresh front + homepage updates on a tight loop.', href: '/.netlify/functions/autonomous-innovation-generator' },
