...
export default function Home() {
 ...
 <section className="mx-auto max-w-7xl px-6 pb-16">
   ...
   <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            ...
            <Link href="/reports/automation-insights"><a className="bg-white/5 hover:bg-white/10 rounded-lg p-4 transition-colors border border-white/10"><span className="text-white/90">Automation Insights — health & coverage</span></a></Link>
