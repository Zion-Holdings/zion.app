      ...
      <main className="relative z-10">
        ...
        <section className="mx-auto max-w-7xl px-6 pb-20">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
               ...
               { title: 'Autonomous Invention Orchestrator', desc: 'Discovers and generates new automations; syncs changes to main.', href: '/.netlify/functions/autonomous-invention-orchestrator' },
               { title: 'Dependency Whisperer', desc: 'Safely upgrades dependencies and commits results automatically.', href: '/.netlify/functions/dependency-upgrade-runner' },
               { title: 'Discovery Lab', desc: 'Explores the repo to invent and advertise new front experiences.', href: '/.netlify/functions/auto-discovery-lab' },
               { title: 'LLM Content Curator', desc: 'Curates content and homepage/front promos using AI.', href: '/.netlify/functions/llm-curation-runner' },
             ].map((tool) => (
