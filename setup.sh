...
# Some restricted environments have limited support for the built-in '['
# alias. Use a strictly POSIX compatible check and avoid '; then' on the
# same line to maximise portability.
if [ -n "${npm_config_http_proxy:-}" ]
then
