...
export const metadata = {
  ...
  description:
    'AI Medical Assistant brings AI-powered intelligence to healthcare workflows, enabling faster diagnostics, better patient outcomes, and streamlined administ',
  alternates: { canonical: '/ai-medical-assistant' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Medical Assistant brings AI-powered intelligence to healthcare workflows, enabling faster diagnostics, better patient outcomes, and streamlined administrative processes while maintaining strict compliance.',
        iconEmoji: '🏥',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy AI Medical Assistant to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use AI Medical Assistant to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage AI Medical Assistant analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with AI Medical Assistant',
      }}
    />
  );
}
