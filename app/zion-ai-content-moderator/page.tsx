...
export const metadata = {
  title: 'Zion AI Content Moderator | Zion Tech Group',
  description:
    'Zion AI Content Moderator empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automatio',
  alternates: { canonical: '/zion-ai-content-moderator' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion AI Content Moderator empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion AI Content Moderator',
      }}
    />
  );
}
