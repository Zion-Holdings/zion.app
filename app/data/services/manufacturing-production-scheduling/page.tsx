  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">AI Production Scheduling Optimizer</h1>
        <p className="text-lg text-gray-300 mb-8">AI-powered production scheduling that optimizes for delivery, cost, and resource utilization. Handle complex constraints, changeovers, and multi-site scheduling.</p>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>Real-time schedule adjustment</li>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Improve on-time delivery by 25%</li>
            <li>Reduce changeover time by 30%</li>
            <li>Optimize resource utilization</li>
            <li>Handle complex scheduling constraints</li>
          </ul>
        </div>
