...
export const metadata = {
  title: "IT Service Mesh Platform - Zion Tech Group",
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/it-service-mesh-platform`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">IT Service Mesh Platform</h1>
        <p className="text-lg text-gray-300 mb-8">Enterprise service mesh for microservices communication, security, and observability. mTLS encryption, traffic management, circuit breaking, and distributed tracing across Kubernetes clusters.</p>
        
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          <h2 className="text-2xl font-semibold mb-4">Key Features</h2>
          <ul className="list-disc list-inside space-y-2">
            <li>Automatic mTLS encryption</li>
            <li>Traffic routing and canary deployments</li>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>Full observability across services</li>
            <li>Simplify multi-cluster management</li>
          </ul>
        </div>
