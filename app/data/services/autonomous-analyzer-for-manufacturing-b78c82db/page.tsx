...
export const metadata = {
  ...
  description: "Unlock unprecedented growth with Autonomous Analyzer for Manufacturing. This autonomous system provides healthcare data analytics with zero manual intervention needed.",
  alternates: {
