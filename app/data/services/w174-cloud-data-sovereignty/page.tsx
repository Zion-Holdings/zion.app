  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Ensure data stays in the right jurisdiction. Data residency controls, sovereignty auditing, and localization for GDPR, LGPD, Chinese Cybersecurity Law, and Russian FZ-152.</p>
