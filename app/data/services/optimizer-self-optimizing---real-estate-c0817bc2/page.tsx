...
export const metadata = {
  ...
  description: "Unlock unprecedented growth with Optimizer Self-Optimizing - Real-Estate. This autonomous system provides network optimization with zero manual intervention needed.",
  alternates: {
