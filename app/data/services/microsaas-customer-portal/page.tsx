  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">ClientPortal - Customer Portal</h1>
        <p className="text-lg text-gray-300 mb-8">White-label customer portal with ticket management, knowledge base, billing overview, and self-service options. Reduces support load while improving customer satisfaction.</p>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce support tickets 40%</li>
