...
export const metadata = {
  title: "Self-Learning Supply Chain Rust (Iot) - Zion Tech Group",
  description: "Self-Learning Supply Chain Rust (Iot) is an AI-powered iot solution that transforms how businesses operate through intelligent automation and real-time analytics.\n\n## Key Features\n\n- **AI/ML Integrati",
  alternates: {
    canonical: `https://ziontechgroup.com/services/service-20260806034405838500`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Self-Learning Supply Chain Rust (Iot)</h1>
        <p className="text-lg text-gray-300 mb-8">Self-Learning Supply Chain Rust (Iot) is an AI-powered iot solution that transforms how businesses operate through intelligent automation and real-time analytics.
...
Blockchain, GCP, Edge Computing, PyTorch, PostgreSQL, MongoDB
