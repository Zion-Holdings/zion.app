...
export const metadata = {
  ...
  description: "AI Personal Financial Coach — enterprise-grade solution with AI-powered automation, real-time analytics, and seamless integration. Built for scale with security-first architecture.",
  alternates: {
