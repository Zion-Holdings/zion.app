...
export const metadata = {
  title: "Edge Analytics Dashboard AWS (Api) - Zion Tech Group",
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Edge Analytics Dashboard AWS (Api)</h1>
        <p className="text-lg text-gray-300 mb-8">Edge Analytics Dashboard AWS (Api) is an AI-powered api solution that transforms how businesses operate through intelligent automation and real-time analytics.
