...
export const metadata = {
  ...
  description: "Unlock unprecedented growth with AI Manufacturing - Transportation Edition #1. This autonomous system provides data processing with zero manual intervention needed.",
  alternates: {
