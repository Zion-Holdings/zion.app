  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Revolutionize retail through intelligent automation. Our Autonomous Security for Retail leverages advanced machine learning to deliver document processing at scale.</p>
