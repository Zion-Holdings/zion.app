...
export const metadata = {
  ...
  description: "Drive innovation in fintech with Enterprise Process Mining Platform - FINTECH. This AI-powered platform transforms network optimization into a competitive advantage.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/enterprise-process-mining-platform-fintech-862ac091`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Drive innovation in fintech with Enterprise Process Mining Platform - FINTECH. This AI-powered platform transforms network optimization into a competitive advantage.</p>
