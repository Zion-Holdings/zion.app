  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Smart Grid Energy Management</h1>
        <p className="text-lg text-gray-300 mb-8">AI-powered smart grid management platform. Real-time energy monitoring, demand forecasting, renewable integration, and outage prediction.</p>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce energy waste 30%</li>
            <li>Optimize renewable usage</li>
