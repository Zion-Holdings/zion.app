  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Adaptive Optimization for Construction</h1>
        <p className="text-lg text-gray-300 mb-8">Revolutionize construction through intelligent automation. Our Adaptive Optimization for Construction leverages advanced machine learning to deliver sales process optimization at scale.</p>
