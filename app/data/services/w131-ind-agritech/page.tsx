  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">AgriTech AI Platform</h1>
        <p className="text-lg text-gray-300 mb-8">Precision agriculture with AI: crop monitoring, yield prediction, pest detection, and irrigation optimization. Satellite and drone imagery analysis.</p>
