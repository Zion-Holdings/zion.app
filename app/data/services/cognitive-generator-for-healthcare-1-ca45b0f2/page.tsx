...
export const metadata = {
  title: "Cognitive Generator for Healthcare #1 - Zion Tech Group",
  description: "Drive innovation in healthcare with Cognitive Generator for Healthcare #1. This AI-powered platform transforms data processing into a competitive advantage.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/cognitive-generator-for-healthcare-1-ca45b0f2`
  }
};
