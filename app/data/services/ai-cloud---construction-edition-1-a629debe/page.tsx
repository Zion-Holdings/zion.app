...
export const metadata = {
  ...
  description: "Revolutionize construction through intelligent automation. Our AI Cloud - Construction Edition #1 leverages advanced machine learning to deliver decision support at scale.",
  alternates: {
