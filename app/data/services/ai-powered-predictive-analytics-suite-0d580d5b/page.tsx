...
export const metadata = {
  ...
  description: "AI-driven analytics platform that predicts market trends, customer behavior, and operational outcomes with 95% accuracy. Uses machine learning models trained on historical data to forecast future perf",
  alternates: {
