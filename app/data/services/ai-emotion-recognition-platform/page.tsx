...
export const metadata = {
  ...
  description: "Real-time emotion and sentiment analysis from facial expressions, voice tone, and text. Used for customer experience optimization, market research, and mental health screening. GDPR-compliant with on-",
  alternates: {
