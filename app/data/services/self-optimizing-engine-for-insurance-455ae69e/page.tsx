...
export const metadata = {
  ...
  description: "Transform your insurance operations with our Self-Optimizing Engine for Insurance. This AI-driven solution automates risk assessment with unprecedented accuracy and efficiency.",
  alternates: {
