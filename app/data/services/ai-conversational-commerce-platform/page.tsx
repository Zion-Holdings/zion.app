...
export const metadata = {
  ...
  description: "AI-powered shopping assistant that engages customers via chat, voice, and messaging apps. Product recommendations, order management, and personalized offers through natural conversation. Integrates wi",
  alternates: {
