  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Next-generation real-estate solution: Smart Intelligence Platform - Real-Estate. Combines customer journey mapping with adaptive intelligence for optimal results.</p>
