...
export const metadata = {
  ...
  description: "AI-powered offer management: dynamically generate, test, and optimize personalized offers, discounts, and promotions across channels. Real-time A/B testing, conversion lift forecasting, and margin-saf",
  alternates: {
