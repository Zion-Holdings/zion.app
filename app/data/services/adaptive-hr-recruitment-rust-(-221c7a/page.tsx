...
export const metadata = {
  title: "Adaptive HR Recruitment Rust (Data) - Zion Tech Group",
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Adaptive HR Recruitment Rust (Data)</h1>
        <p className="text-lg text-gray-300 mb-8">Adaptive HR Recruitment Rust (Data) is an AI-powered data solution that transforms how businesses operate through intelligent automation and real-time analytics.
