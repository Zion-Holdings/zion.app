  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Energy Management AI</h1>
        <p className="text-lg text-gray-300 mb-8">Smart energy management for commercial buildings and industrial facilities. AI-powered optimization of HVAC, lighting, and renewable energy integration.</p>
