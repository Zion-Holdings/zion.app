...
export const metadata = {
  ...
  description: "Enhance your insurance business with AI Business Intelligence - Insurance Edition. Our solution provides task mining with enterprise-grade reliability and security.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-business-intelligence-insurance-edition-59c72706`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Enhance your insurance business with AI Business Intelligence - Insurance Edition. Our solution provides task mining with enterprise-grade reliability and security.</p>
