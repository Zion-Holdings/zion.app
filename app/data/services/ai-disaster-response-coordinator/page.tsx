...
export const metadata = {
  ...
  description: "Coordinate emergency response across agencies: resource allocation optimization, evacuation routing, satellite/drone damage assessment, real-time situational awareness.",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Coordinate emergency response across agencies: resource allocation optimization, evacuation routing, satellite/drone damage assessment, real-time situational awareness.</p>
