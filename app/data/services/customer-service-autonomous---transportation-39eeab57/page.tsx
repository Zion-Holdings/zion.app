...
export const metadata = {
  ...
  description: "Next-generation transportation solution: Customer Service Autonomous - Transportation. Combines process automation with adaptive intelligence for optimal results.",
  alternates: {
