  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Neural business intelligence-agriculture</h1>
        <p className="text-lg text-gray-300 mb-8">Drive innovation in agriculture with Neural business intelligence-agriculture. This AI-powered platform transforms sentiment analysis into a competitive advantage.</p>
