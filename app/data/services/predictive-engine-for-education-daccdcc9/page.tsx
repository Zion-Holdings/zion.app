...
export const metadata = {
  ...
  description: "Revolutionize education through intelligent automation. Our Predictive Engine for Education leverages advanced machine learning to deliver security monitoring at scale.",
  alternates: {
