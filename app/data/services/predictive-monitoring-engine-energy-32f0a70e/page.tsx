...
export const metadata = {
  ...
  description: "Transform your energy operations with our Predictive Monitoring Engine - Energy. This AI-driven solution automates edge computing with unprecedented accuracy and efficiency.",
  alternates: {
