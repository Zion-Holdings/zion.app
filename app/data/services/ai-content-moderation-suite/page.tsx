...
export const metadata = {
  ...
  description: "Platform-agnostic content moderation: real-time text/image/video classification, multi-language support, custom policy rules, human-in-the-loop review queues, and automated takedown workflows for plat",
  alternates: {
