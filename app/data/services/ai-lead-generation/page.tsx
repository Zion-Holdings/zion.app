  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">AI Lead Generation &amp; Enrichment</h1>
        <p className="text-lg text-gray-300 mb-8">Automatically discover, qualify, and enrich B2B leads with web scraping, firmographic scoring, and intent signal detection.</p>
        
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          <h2 className="text-2xl font-semibold mb-4">Key Features</h2>
          <ul className="list-disc list-inside space-y-2">
            <li>Automated lead discovery from public sources</li>
            <li>Firmographic enrichment — revenue, tech stack, contacts</li>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce costs with ai lead generation &amp; enrichment</li>
