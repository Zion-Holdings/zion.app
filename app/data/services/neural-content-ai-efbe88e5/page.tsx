...
export const metadata = {
  title: "Neural Content AI - Zion Tech Group",
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Neural Content AI</h1>
        <p className="text-lg text-gray-300 mb-8">Enhance your telecom business with Neural Content AI. Our solution provides language processing with enterprise-grade reliability and security.</p>
