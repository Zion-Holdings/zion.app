...
export const metadata = {
  title: "Scalable Data Analytics MongoDB (It) - Zion Tech Group",
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Scalable Data Analytics MongoDB (It)</h1>
        <p className="text-lg text-gray-300 mb-8">Scalable Data Analytics MongoDB (It) is an AI-powered it solution that transforms how businesses operate through intelligent automation and real-time analytics.
