...
export const metadata = {
  ...
  description: "Revolutionize retail through intelligent automation. Our Autonomous Financial Insights leverages advanced machine learning to deliver healthcare data analytics at scale.",
  alternates: {
