  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Optimize your hospitality workflows with Predictive Automation for Hospitality. This intelligent platform delivers security monitoring through advanced automation and AI.</p>
