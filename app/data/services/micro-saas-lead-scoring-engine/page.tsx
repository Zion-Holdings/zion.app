...
export const metadata = {
  ...
  description: "AI-powered lead scoring for sales teams. Analyze website activity, email engagement, firmographics, and social signals to rank leads by conversion probability. Integrates with HubSpot, Salesforce, and",
  alternates: {
