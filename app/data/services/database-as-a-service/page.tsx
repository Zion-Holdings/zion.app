  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Managed Database as a Service (DBaaS)</h1>
        <p className="text-lg text-gray-300 mb-8">Fully managed databases with automated backups, scaling, and monitoring. Supports PostgreSQL, MySQL, MongoDB, and Redis. Includes query optimization, security patching, and 24/7 support.</p>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>99.99% uptime</li>
            <li>70% reduction in DB admin time</li>
