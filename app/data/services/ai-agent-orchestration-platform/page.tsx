  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">AI Agent Orchestration Platform</h1>
        <p className="text-lg text-gray-300 mb-8">Build, deploy, and manage autonomous AI agents. Multi-agent workflows, tool integration, memory management, and human-in-the-loop controls.</p>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>Integration with LangChain, CrewAI</li>
          </ul>
        </div>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Build agentic apps 10x faster</li>
            <li>Coordinate complex workflows</li>
            <li>Safe autonomous operation</li>
