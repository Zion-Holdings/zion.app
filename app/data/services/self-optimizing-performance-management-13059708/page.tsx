...
export const metadata = {
  ...
  description: "Unlock unprecedented growth with Self-Optimizing Performance Management. This autonomous system provides workflow management with zero manual intervention needed.",
  alternates: {
