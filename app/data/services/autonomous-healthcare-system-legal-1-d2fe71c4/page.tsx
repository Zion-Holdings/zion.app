...
export const metadata = {
  ...
  description: "Drive innovation in legal with Autonomous Healthcare System - Legal #1. This AI-powered platform transforms project portfolio into a competitive advantage.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/autonomous-healthcare-system-legal-1-d2fe71c4`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Drive innovation in legal with Autonomous Healthcare System - Legal #1. This AI-powered platform transforms project portfolio into a competitive advantage.</p>
