  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Next-generation LMS with AI-powered content recommendations, automated grading, learning analytics, and adaptive learning paths. For K-12, higher education, and corporate training.</p>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>Discussion forum with AI moderation</li>
          </ul>
        </div>
