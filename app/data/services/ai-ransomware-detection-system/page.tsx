...
export const metadata = {
  ...
  description: "Real-time ransomware detection across endpoints and network. AI identifies encryption behavior, auto-isolates infected systems, triggers incident response playbooks. Stops ransomware in under 30 secon",
  alternates: {
