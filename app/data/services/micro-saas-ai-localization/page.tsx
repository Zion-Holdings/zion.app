  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">AI-powered translation and localization for websites, apps, docs, and marketing. Go beyond translation with cultural adaptation, SEO optimization, and quality scoring.</p>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>Glossary and style guide enforcement</li>
          </ul>
        </div>
