...
export const metadata = {
  title: "Intelligent Marketing Automation Terraform (Marketing) - Zion Tech Group",
  description: "Intelligent Marketing Automation Terraform (Marketing) is an AI-powered marketing solution that transforms how businesses operate through intelligent automation and real-time analytics.\n\n## Key Featur",
  alternates: {
    canonical: `https://ziontechgroup.com/services/service-20260806034405838596`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Intelligent Marketing Automation Terraform (Marketing)</h1>
        <p className="text-lg text-gray-300 mb-8">Intelligent Marketing Automation Terraform (Marketing) is an AI-powered marketing solution that transforms how businesses operate through intelligent automation and real-time analytics.
