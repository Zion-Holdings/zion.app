...
export const metadata = {
  ...
  description: "Accelerate legal document review with AI-powered contract analysis, clause extraction, risk identification, and compliance checking. Reduces review time by 80% while improving accuracy. Supports NDAs,",
  alternates: {
