...
export const metadata = {
  title: "Cognitive Director Solution - EDTECH - Zion Tech Group",
  description: "Drive innovation in edtech with Cognitive Director Solution - EDTECH. This AI-powered platform transforms content moderation into a competitive advantage.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/cognitive-director-solution-edtech-c4d9a0f0`
  }
};
