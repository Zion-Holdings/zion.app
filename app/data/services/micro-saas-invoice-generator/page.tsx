...
export const metadata = {
  ...
  description: "Professional invoice and payment collection for freelancers and small businesses. Custom templates, recurring invoices, payment tracking, and automatic late payment reminders. Multi-currency and tax s",
  alternates: {
