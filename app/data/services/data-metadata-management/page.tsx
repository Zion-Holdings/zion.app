  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Enterprise Metadata Management</h1>
        <p className="text-lg text-gray-300 mb-8">Centralized metadata management platform with data cataloging, glossary management, and lineage tracking. Supports 50+ data sources.</p>
        ...
        <div className="border border-purple-500 rounded-xl p-6 mb-8">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="bg-slate-800 p-4 rounded-lg border-2 border-purple-500">
              ...
              <p className="text-2xl font-bold mb-2">$1,099</p>
            </div>
            <div className="bg-slate-800 p-4 rounded-lg">
