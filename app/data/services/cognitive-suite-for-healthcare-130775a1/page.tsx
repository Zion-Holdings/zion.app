...
export const metadata = {
  ...
  description: "Next-generation healthcare solution: Cognitive Suite for Healthcare. Combines training optimization with adaptive intelligence for optimal results.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/cognitive-suite-for-healthcare-130775a1`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Next-generation healthcare solution: Cognitive Suite for Healthcare. Combines training optimization with adaptive intelligence for optimal results.</p>
