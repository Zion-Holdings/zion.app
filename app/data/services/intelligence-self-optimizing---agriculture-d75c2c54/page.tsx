...
export const metadata = {
  ...
  description: "Next-generation agriculture solution: Intelligence Self-Optimizing - Agriculture. Combines healthcare data analytics with adaptive intelligence for optimal results.",
  alternates: {
