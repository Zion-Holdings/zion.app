...
export const metadata = {
  ...
  description: "Optimize your transportation workflows with Intelligent Data for Transportation. This intelligent platform delivers lead scoring through advanced automation and AI.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/intelligent-data-for-transportation-adc0a79b`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Optimize your transportation workflows with Intelligent Data for Transportation. This intelligent platform delivers lead scoring through advanced automation and AI.</p>
