  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Cloud-based virtual laboratory platform for science, technology, engineering, and math education. Simulate physics, chemistry, biology, and engineering experiments.</p>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>Assessment and grading integration</li>
          </ul>
        </div>
