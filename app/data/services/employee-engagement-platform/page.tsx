  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Measure and improve employee engagement with pulse surveys, eNPS tracking, recognition programs, and action planning. AI-powered sentiment analysis identifies trends and recommends interventions.</p>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>25% improvement in retention</li>
