  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Cognitive Risk for Sports #1</h1>
        <p className="text-lg text-gray-300 mb-8">Transform your sports operations with our Cognitive Risk for Sports #1. This AI-driven solution automates customer insights with unprecedented accuracy and efficiency.</p>
