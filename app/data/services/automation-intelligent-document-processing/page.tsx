...
export const metadata = {
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/automation-intelligent-document-processing`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Intelligent Document Processing (IDP)</h1>
        <p className="text-lg text-gray-300 mb-8">AI-powered document processing for invoices, contracts, forms, and receipts. OCR, NLP extraction, validation, and integration with ERP and accounting systems.</p>
        
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          <h2 className="text-2xl font-semibold mb-4">Key Features</h2>
          <ul className="list-disc list-inside space-y-2">
            <li>OCR with 99%+ accuracy</li>
            <li>AI field extraction</li>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce document processing time by 85%</li>
            <li>Eliminate manual data entry</li>
            <li>Improve accuracy and compliance</li>
