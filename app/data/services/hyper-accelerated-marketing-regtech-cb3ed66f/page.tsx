...
export const metadata = {
  ...
  description: "Quantum leap forward for regtech: Hyper-Accelerated Marketing - REGTECH. Uses quantum-inspired algorithms to deliver competitive intelligence at exponential speed.",
  alternates: {
