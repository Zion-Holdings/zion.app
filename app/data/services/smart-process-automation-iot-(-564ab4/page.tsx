...
export const metadata = {
  title: "Smart Process Automation IoT (Customer) - Zion Tech Group",
  description: "Smart Process Automation IoT (Customer) is an AI-powered customer solution that transforms how businesses operate through intelligent automation and real-time analytics.\n\n## Key Features\n\n- **AI/ML In",
  alternates: {
    canonical: `https://ziontechgroup.com/services/smart-process-automation-iot--564ab4`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Smart Process Automation IoT (Customer)</h1>
        <p className="text-lg text-gray-300 mb-8">Smart Process Automation IoT (Customer) is an AI-powered customer solution that transforms how businesses operate through intelligent automation and real-time analytics.
...
Rust, GCP, Microservices, PostgreSQL, Kubernetes, Computer Vision
