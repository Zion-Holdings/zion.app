...
export const INITIAL_AGENT_LOGS: AgentLogEntry[] = [
  ...
  { id: 'log-043', timestamp: '2026-06-14 22:30', bot: '@OWL', action: 'Deep crawl — full site verification', result: '18/18 core pages OK (200), 0 broken links. All nav pages + dashboard + agent-monitoring verified.', category: 'monitoring', duration: '12m' },
...
export const INITIAL_AGENT_STATUS: AgentStatus[] = [
  ...
  { name: 'OWL', telegram: '@OWL', role: 'Wave Integration & Monitoring', emoji: '🦉', status: 'active', currentTask: 'Monitoring dashboard v2 + homepage banner', tasksCompleted: 430, lastAction: 'Created AgentDashboard homepage component + enhanced dashboard', lastActionTime: '2026-06-17 12:00', uptime: '99.5%', specialty: 'Full-stack, Coordination, QA', todayActions: 5, weekActions: 42 },
];
