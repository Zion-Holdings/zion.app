...
eexport const metadata = { title: 'IT Services — Zion Tech Group', description: 'Managed IT services from Zion Tech Group: cloud, cybersecurity, platform engineering, support, and infrastructure modernization.' };
