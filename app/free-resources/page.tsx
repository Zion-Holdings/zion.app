...
e  alternates: { canonical: 'https://ziontechgroup.com/free-resources' },
xport const metadata = { title: 'Free Resources', description: 'Free AI tools, guides, templates, and resources from Zion Tech Group.' };
