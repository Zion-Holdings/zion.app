...
export const metadata = {
  ...
  description:
    'Analytics Tools transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more c',
  alternates: { canonical: '/analytics-tools' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Analytics Tools transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more confident decisions backed by production-grade analytics.',
        iconEmoji: '📊',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Analytics Tools',
      }}
    />
  );
}
