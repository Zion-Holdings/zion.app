...
export const metadata = {
  ...
  description:
    'Help elevates customer interactions with AI-driven support, intelligent routing, and personalized engagement across every touchpoint. Increase satisfaction',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Help elevates customer interactions with AI-driven support, intelligent routing, and personalized engagement across every touchpoint. Increase satisfaction while reducing response times.',
        iconEmoji: '💬',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy Help to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use Help to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage Help analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with Help',
      }}
    />
  );
}
