...
export const metadata = {
  title: 'Zion AI Data Cleaner | Zion Tech Group',
  description:
    'Zion AI Data Cleaner transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, m',
  alternates: { canonical: '/zion-ai-data-cleaner' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion AI Data Cleaner transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more confident decisions backed by production-grade analytics.',
        iconEmoji: '📊',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion AI Data Cleaner',
      }}
    />
  );
}
