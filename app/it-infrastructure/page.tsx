...
export const metadata = {
  ...
  description:
    'IT Infrastructure delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faste',
  alternates: { canonical: '/it-infrastructure' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'IT Infrastructure delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster with battle-tested deployment patterns and cost optimization.',
        iconEmoji: '☁️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with IT Infrastructure',
      }}
    />
  );
}
