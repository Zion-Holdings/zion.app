...
export const metadata: Metadata = {
  ...
  description: 'AI-powered ai help desk for enterprise automation and business intelligence. Deployed by Zion Tech Group.',
  alternates: { canonical: '/zion-ai-help-desk/' },
};

export default function Page() {
  return (
    <PageTemplate
      title="Zion AI Help Desk"
      description="AI-powered ai help desk for enterprise automation and business intelligence. Deployed by Zion Tech Group."
      actions={[
