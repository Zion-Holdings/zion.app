...
export const metadata = {
  ...
  description:
    'AI Mobile App Builder accelerates software delivery with intelligent tooling, automated code analysis, and streamlined development workflows. Ship higher-q',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Mobile App Builder accelerates software delivery with intelligent tooling, automated code analysis, and streamlined development workflows. Ship higher-quality code faster while reducing technical debt.',
        iconEmoji: '⚙️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Mobile App Builder',
      }}
    />
  );
}
