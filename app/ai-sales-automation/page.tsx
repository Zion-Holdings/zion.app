...
export const metadata = {
  ...
  description:
    'AI Sales Automation empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Tur',
  alternates: { canonical: '/ai-sales-automation' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Sales Automation empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Sales Automation',
      }}
    />
  );
}
