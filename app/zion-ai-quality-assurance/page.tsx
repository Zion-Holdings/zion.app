...
export const metadata: Metadata = {
  ...
  description: 'AI-powered QA platform for automated testing, bug detection, and quality scoring across the software development lifecycle.',
  alternates: { canonical: '/zion-ai-quality-assuranc/' },
};
