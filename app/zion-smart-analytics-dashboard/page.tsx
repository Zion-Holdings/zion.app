...
export const metadata = {
  ...
  description:
    'Zion Smart Analytics Dashboard transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion Smart Analytics Dashboard transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more confident decisions backed by production-grade analytics.',
        iconEmoji: '📊',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion Smart Analytics Dashboard',
      }}
    />
  );
}
