...
export const metadata = {
  title: 'Robotics Integration | Zion Tech Group',
  description:
    'Robotics Integration eliminates manual bottlenecks with intelligent process automation, event-driven orchestration, and cross-system integration. Reclaim o',
  alternates: { canonical: '/robotics-integration' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Robotics Integration eliminates manual bottlenecks with intelligent process automation, event-driven orchestration, and cross-system integration. Reclaim operational capacity and reduce human error.',
        iconEmoji: '🔄',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Robotics Integration',
      }}
    />
  );
}
