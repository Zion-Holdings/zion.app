...
export const metadata = {
  ...
  description:
    'Zion Social Scheduler empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. T',
  alternates: { canonical: '/zion-social-scheduler' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion Social Scheduler empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion Social Scheduler',
      }}
    />
  );
}
