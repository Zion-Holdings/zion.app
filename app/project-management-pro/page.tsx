...
export const metadata = {
  title: 'Project Management Pro | Zion Tech Group',
  description:
    'Project Management Pro streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team ',
  alternates: { canonical: '/project-management-pro' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Project Management Pro streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focus on strategic work.',
        iconEmoji: '📋',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Project Management Pro',
      }}
    />
  );
}
