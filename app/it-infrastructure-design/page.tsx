...
export const metadata = {
  title: 'IT Infrastructure Design | Zion Tech Group',
  description:
    'IT Infrastructure Design delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to productio',
  alternates: { canonical: '/it-infrastructure-design' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'IT Infrastructure Design delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster with battle-tested deployment patterns and cost optimization.',
        iconEmoji: '☁️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with IT Infrastructure Design',
      }}
    />
  );
}
