    ...
    <main className="min-h-screen">
      <section className="relative overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 pt-20 pb-16">
        <div className="container-page relative">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 max-w-3xl">ITSM Copilot Free Trial</h1>
          <p className="text-lg text-slate-400 max-w-2xl mb-8">Start an ITSM copilot free trial to evaluate AI-assisted ticketing, knowledge retrieval, change support, and service desk automation.</p>
      ...
      <section className="py-20 bg-gradient-to-b from-slate-900 to-slate-950 border-t border-slate-800/60">
        <div className="container-page">
          ...
          <p className="text-slate-400 max-w-2xl mb-6">Evaluate AI copilot capabilities in a real ITSM workflow with guided setup and operator support.</p>
          <ul className="grid md:grid-cols-2 gap-4 text-slate-300 list-disc pl-6">
            <li>Copilot-assisted ticket triage</li>
            <li>Knowledge base search and summarization</li>
            <li>Change and incident support workflows</li>
            <li>Service desk automation evaluation</li>
          </ul>
          <div className="mt-10">
