export const metadata = {
  ...
  alternates: { canonical: '/enterprise-ai-automation-operations' }
};
    ...
    <main className="min-h-screen">
      <section className="relative overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 pt-20 pb-16">
        <div className="container-page relative">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 max-w-3xl">Enterprise AI Automation for Operations</h1>
          <p className="text-lg text-slate-400 max-w-2xl mb-8">Enterprise AI automation for operations, process orchestration, workflow optimization, and reliability engineering built for IT teams.</p>
      ...
      <section className="py-20 bg-gradient-to-b from-slate-900 to-slate-950 border-t border-slate-800/60">
        <div className="container-page">
          ...
          <p className="text-slate-400 max-w-2xl mb-6">We design automation that reduces manual work, improves reliability, and shortens incident response without adding headcount.</p>
          <ul className="grid md:grid-cols-2 gap-4 text-slate-300 list-disc pl-6">
            <li>Operations automation and orchestration</li>
            <li>Workflow optimization and monitoring</li>
            <li>Autonomous remediation and reliability</li>
