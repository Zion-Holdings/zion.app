eexport const metadata = {
  ...
  description: 'Free IT automation tools and scripts for enterprises and operators from Zion Tech Group. Automate deployments, monitoring, and workflows.',
  alternates: { canonical: 'https://ziontechgroup.com/it-automation-free-tools-scripts' }
};
    ...
    <main className="min-h-screen">
      <section className="relative overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 pt-20 pb-16">
        <div className="container-page relative">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-orange-400/20 bg-orange-400/5 mb-6">
            <span className="text-orange-400 text-xs font-semibold uppercase tracking-wider">Free Tools</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 max-w-3xl">IT Automation Free Tools and Scripts</h1>
          <p className="text-lg text-slate-400 max-w-2xl mb-8">Free IT automation tools and scripts for enterprises and operators from Zion Tech Group. Automate deployments, monitoring, and workflows.</p>
      ...
      <section className="py-20 bg-gradient-to-b from-slate-900 to-slate-950 border-t border-slate-800/60">
        <div className="container-page">
          ...
          <p className="text-slate-400 max-w-2xl mb-6">Free automation resources to evaluate workflows, integrations, and deployment patterns with operator-ready guidance.</p>
          <ul className="grid md:grid-cols-2 gap-4 text-slate-300 list-disc pl-6">
            <li>Deployment automation starters</li>
            <li>Monitoring and alerting scripts</li>
            <li>Workflow integration templates</li>
            <li>Hands-on automation workshops</li>
          </ul>
          <div className="mt-10">
