    ...
    <main className="min-h-screen">
      <section className="relative overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 pt-20 pb-16">
        <div className="container-page relative">
          ...
          <p className="text-lg text-slate-400 max-w-2xl mb-8">How enterprise IT teams use AI copilots, automation, and IT service assistants to reduce ticket resolution time and improve reliability.</p>
