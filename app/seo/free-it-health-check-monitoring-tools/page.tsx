export const metadata = {
  ...
  description: 'Free IT health check and monitoring tools, baseline assessments, observability integrations, and readiness checks for IT and AI environments.',
  alternates: { canonical: '/free-it-health-check-monitoring-tools' }
};
    ...
    <main className="min-h-screen">
      <section className="relative overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 pt-20 pb-16">
        <div className="container-page relative">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 max-w-3xl">Free IT Health Check and Monitoring Tools</h1>
          <p className="text-lg text-slate-400 max-w-2xl mb-8">Free IT health check and monitoring tools, baseline assessments, observability integrations, and readiness checks for IT and AI environments.</p>
      ...
      <section className="py-20 bg-gradient-to-b from-slate-900 to-slate-950 border-t border-slate-800/60">
        <div className="container-page">
          ...
          <p className="text-slate-400 max-w-2xl mb-6">Free IT health checks with monitoring baseline evaluations, alerting setup, and readiness summaries.</p>
          <ul className="grid md:grid-cols-2 gap-4 text-slate-300 list-disc pl-6">
            <li>Free health-check scripts and checklists</li>
            <li>Monitoring and observability integrations</li>
            <li>Alerting and runbook templates</li>
            <li>Baseline assessments and reporting</li>
          </ul>
          <div className="mt-10">
