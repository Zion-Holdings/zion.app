export const metadata = {
  ...
  description: 'AI email tuning, triage, reply-intelligence, and automation free tools for support and revenue teams.',
  alternates: { canonical: '/ai-email-tuning-free-tools' }
};
    ...
    <main className="min-h-screen">
      <section className="relative overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 pt-20 pb-16">
        <div className="container-page relative">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 max-w-3xl">AI Email Tuning Free Tools</h1>
          <p className="text-lg text-slate-400 max-w-2xl mb-8">AI email tuning, triage, reply-intelligence, and automation free tools for support and revenue teams.</p>
