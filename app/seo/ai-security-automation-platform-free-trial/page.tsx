export const metadata = {
  ...
  alternates: { canonical: '/ai-security-automation-platform-free-trial' }
};
    ...
    <main className="min-h-screen">
      <section className="relative overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 pt-20 pb-16">
        <div className="container-page relative">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 max-w-3xl">IT Security Automation Platform Free Trial</h1>
          <p className="text-lg text-slate-400 max-w-2xl mb-8">Start an IT security automation platform free trial with guided trial scope, SOC use cases, and evaluation support from Zion Tech Group.</p>
      ...
      <section className="py-20 bg-gradient-to-b from-slate-900 to-slate-950 border-t border-slate-800/60">
        <div className="container-page">
          ...
          <p className="text-slate-400 max-w-2xl mb-6">A practical trial path from alerts to automated response with measurable outcomes and security team onboarding.</p>
          <ul className="grid md:grid-cols-2 gap-4 text-slate-300 list-disc pl-6">
            <li>Security automation evaluation sandbox</li>
            <li>Alert triage and response playbooks</li>
            <li>Tooling assessment with vendor guidance</li>
            <li>Free trial support from experienced operators</li>
          </ul>
          <div className="mt-10">
