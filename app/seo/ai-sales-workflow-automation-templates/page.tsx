export const metadata = {
  ...
  description: 'AI sales workflow automation templates, lead-routing setups, outreach sequencing, prospecting playbooks, and revenue-ready workflows for IT services.',
  alternates: { canonical: '/ai-sales-workflow-automation-templates' }
};
    ...
    <main className="min-h-screen">
      <section className="relative overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 pt-20 pb-16">
        <div className="container-page relative">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-orange-400/20 bg-orange-400/5 mb-6">
            <span className="text-orange-400 text-xs font-semibold uppercase tracking-wider">Sales</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 max-w-3xl">AI Sales Workflow Automation Templates</h1>
          <p className="text-lg text-slate-400 max-w-2xl mb-8">AI sales workflow automation templates, lead-routing setups, outreach sequencing, prospecting playbooks, and revenue-ready workflows for IT services.</p>
      ...
      <section className="py-20 bg-gradient-to-b from-slate-900 to-slate-950 border-t border-slate-800/60">
        <div className="container-page">
          ...
          <p className="text-slate-400 max-w-2xl mb-6">Workflow templates that speed up qualification, follow-up, and handoffs without rebuilding integrations.</p>
          <ul className="grid md:grid-cols-2 gap-4 text-slate-300 list-disc pl-6">
            ...
            <li>CRM automation and reporting templates</li>
            <li>RevOps and sales enablement playbooks</li>
          </ul>
          <div className="mt-10">
