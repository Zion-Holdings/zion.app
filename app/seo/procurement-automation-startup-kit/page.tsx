export const metadata = {
  ...
  alternates: { canonical: '/procurement-automation-startup-kit' }
};
    ...
    <main className="min-h-screen">
      <section className="relative overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 pt-20 pb-16">
        <div className="container-page relative">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-orange-400/20 bg-orange-400/5 mb-6">
            <span className="text-orange-400 text-xs font-semibold uppercase tracking-wider">Startup Kit</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 max-w-3xl">Procurement Automation Startup Kit</h1>
          <p className="text-lg text-slate-400 max-w-2xl mb-8">Procurement automation startup kit with vendor intake workflows, request templates, approval chains, and free starter scripts from Zion Tech Group.</p>
      ...
      <section className="py-20 bg-gradient-to-b from-slate-900 to-slate-950 border-t border-slate-800/60">
        <div className="container-page">
          ...
          <p className="text-slate-400 max-w-2xl mb-6">A practical startup kit to automate intake, comparison, approvals, and supplier management.</p>
          <ul className="grid md:grid-cols-2 gap-4 text-slate-300 list-disc pl-6">
            <li>Vendor intake and request templates</li>
            <li>Approval workflow builders and paths</li>
            <li>AI-assisted comparison and scoring</li>
            <li>Compliance-ready procurement scripts</li>
          </ul>
          <div className="mt-10">
