...
export const metadata = {
  ...
  description:
    'AI Voice Processing eliminates manual bottlenecks with intelligent process automation, event-driven orchestration, and cross-system integration. Reclaim op',
  alternates: { canonical: '/ai-voice-processing' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Voice Processing eliminates manual bottlenecks with intelligent process automation, event-driven orchestration, and cross-system integration. Reclaim operational capacity and reduce human error.',
        iconEmoji: '🔄',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Voice Processing',
      }}
    />
  );
}
