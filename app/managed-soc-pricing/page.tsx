export const metadata = {
  ...
  description: "Zion Tech Group delivers managed soc pricing with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/managed-soc-pricing/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>managed soc pricing</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers managed soc pricing with measurable outcomes.
      </p>
