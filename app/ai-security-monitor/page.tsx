...
export const metadata = {
  ...
  description:
    'AI Security Monitor provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audi',
  alternates: { canonical: '/ai-security-monitor' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Security Monitor provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit readiness with AI-driven threat detection and policy enforcement.',
        iconEmoji: '🛡️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Security Monitor',
      }}
    />
  );
}
