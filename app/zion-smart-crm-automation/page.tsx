...
export const metadata = {
  title: 'Zion Smart CRM Automation | Zion Tech Group',
  description:
    'Zion Smart CRM Automation empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automatio',
  alternates: { canonical: '/zion-smart-crm-automation' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion Smart CRM Automation empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion Smart CRM Automation',
      }}
    />
  );
}
