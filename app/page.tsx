        ...
        <div className="relative container-page pt-32 pb-24">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-900/30 border border-purple-500/30 text-purple-300 text-sm mb-6">
              <span className="text-green-400">●</span> <span className="font-bold gradient-text tabular-nums">{serviceCount.toLocaleString()}</span> Services — Live Now
            </div>
          ...
          <p className="text-xl text-slate-300 mb-10 max-w-3xl mx-auto leading-relaxed">
            <span className="font-bold gradient-text tabular-nums">{serviceCount.toLocaleString()}</span> real-world AI, IT, cloud, security, data, automation, micro-SaaS, DevOps, blockchain, and IoT services — from machine learning to cybersecurity, CRM to 5G networks.
