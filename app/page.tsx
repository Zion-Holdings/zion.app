      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative container-page pt-32 pb-24">
          ...
          <p className="text-xl text-slate-300 mb-10 max-w-3xl mx-auto leading-relaxed">
            <ServiceCounter /> production-ready AI, IT, cloud, security, automation, data, and micro-SaaS services — from machine learning to cybersecurity, CRM to blockchain. Most engagements ship in days, not weeks.
          </p>
