...
export const metadata: Metadata = {
  ...
  description: 'AI-powered lead scoring platform that predicts conversion probability and prioritizes sales opportunities.',
  alternates: { canonical: '/zion-ai-lead-scorin/' },
};
