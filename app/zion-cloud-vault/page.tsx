...
export const metadata: Metadata = {
  ...
  description: 'Secure cloud storage and infrastructure management platform for enterprise data. Protect, encrypt, and manage your cloud resources with AI-driven security.',
