...
export const metadata = {
  ...
  description:
    'Cloud Native Development delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to productio',
  alternates: { canonical: '/cloud-native-development' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Cloud Native Development delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster with battle-tested deployment patterns and cost optimization.',
        iconEmoji: '☁️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Cloud Native Development',
      }}
    />
  );
}
