...
export const metadata = {
  ...
  description:
    'AI SEO Optimizer empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn d',
  alternates: { canonical: '/ai-seo-optimizer' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI SEO Optimizer empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI SEO Optimizer',
      }}
    />
  );
}
