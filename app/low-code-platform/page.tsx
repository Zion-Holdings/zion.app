...
export const metadata = {
  ...
  alternates: { canonical: '/low-code-platform' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Low Code Platform accelerates software delivery with intelligent tooling, automated code analysis, and streamlined development workflows. Ship higher-quality code faster while reducing technical debt.',
        iconEmoji: '⚙️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Low Code Platform',
      }}
    />
  );
}
