...
export const metadata = {
  ...
  description:
    'Cloud Migration delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster ',
  alternates: { canonical: '/it-services/cloud-migration' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Cloud Migration delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster with battle-tested deployment patterns and cost optimization.',
        iconEmoji: '☁️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Cloud Migration',
      }}
    />
  );
}
