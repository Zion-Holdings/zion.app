...
export default function HashGeneratorPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Is the Hash Generator free to use?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How do I use the Hash Generator?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Simply open the Hash Generator page, enter your inputs, and click run to get instant results."
      }
    },
    {
      "@type": "Question",
