...
=======
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 max-w-5xl mx-auto">
        ...
        <a href="/tools/cloud-cost-calculator/" className="rounded-2xl border border-slate-800 bg-slate-900/60 p-6 hover:border-purple-500/40">
          ...
          <p className="text-slate-400 text-sm">Estimate your cloud cost savings with our interactive calculator. See how much you coul...</p>
        </a>
        ...
        <a href="/tools/hermes-prompt-builder/" className="rounded-2xl border border-slate-800 bg-slate-900/60 p-6 hover:border-purple-500/40">
          <h3 className="text-white font-semibold mb-2">Hermes Prompt Builder</h3>
          <p className="text-slate-400 text-sm">Generate and validate JSON schemas for Hermes Agent function calling. Build prompts and...</p>
        </a>
        ...
        <a href="/tools/json-schema-validator/" className="rounded-2xl border border-slate-800 bg-slate-900/60 p-6 hover:border-purple-500/40">
          ...
          <p className="text-slate-400 text-sm">Validate JSON data against a JSON Schema draft 7/2019-09/2020-12.</p>
        </a>
...
>>>>>>> 5c0e10c01a4 (feat(tools): add new security/json/jwt/mcp/agent builder tools and sync sitemap)
      </div>
    </StandardPage>
  );
}
