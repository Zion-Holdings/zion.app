...
export default function ImageToBase64Page() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Is the Image To Base64 free to use?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How do I use the Image To Base64?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Simply open the Image To Base64 page, enter your inputs, and click run to get instant results."
      }
    },
    {
      "@type": "Question",
