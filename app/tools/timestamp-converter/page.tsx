...
export default function TimestampConverterPage() {
    ...
    <div className="max-w-5xl mx-auto space-y-6">
        <section className="rounded-2xl border border-slate-800 bg-slate-900/60 p-6">
          ...
          <p className="text-slate-300">
            Use Timestamp Converter when you need reliable encoding, validation, or conversion in developer workflows, automation scripts, and QA checks. It reduces manual errors and keeps formatting consistent across environments.
          </p>
        </section>
        <section className="rounded-2xl border border-slate-800 bg-slate-900/60 p-6">
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Is the Timestamp Converter free to use?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How do I use the Timestamp Converter?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Simply open the Timestamp Converter page, enter your inputs, and click run to get instant results."
      }
    },
    {
      "@type": "Question",
