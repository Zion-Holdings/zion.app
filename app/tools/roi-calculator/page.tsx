  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <PageWrapper centered>
        <Link href="/tools/" className="text-purple-400 text-sm hover:underline mb-8 inline-block">← All Tools</Link>
      ...
      <Section>
        <h2 className="text-2xl font-bold text-white mb-4">Why Use This Calculator?</h2>
      ...
      <Section variant="accent">
        <div className="text-center rounded-2xl border border-purple-500/20 bg-gradient-to-br from-purple-900/15 to-slate-900/40 p-10">
          <h2 className="text-2xl font-bold text-white mb-3">Ready for a Custom ROI Analysis?</h2>
