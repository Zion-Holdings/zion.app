...
export default function CronParserPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Is the Cron Parser free to use?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How do I use the Cron Parser?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Simply open the Cron Parser page, enter your inputs, and click run to get instant results."
      }
    },
    {
      "@type": "Question",
