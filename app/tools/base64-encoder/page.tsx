...
export default function Base64EncoderPage() {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Is the Base64 Encoder free to use?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How do I use the Base64 Encoder?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Simply open the Base64 Encoder page, enter your inputs, and click run to get instant results."
      }
    },
    {
      "@type": "Question",
