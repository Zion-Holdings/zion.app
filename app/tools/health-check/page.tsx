...
<>
  ...
  "url": "https://ziontechgroup.com/tools/health-check/",
  "@id": "https://ziontechgroup.com/tools/health-check/",
  "featureList": [
    "Free to use",
  ...
  "description": "Interactive tool: Health Check.",
  "url": "https://ziontechgroup.com/tools/health-check/",
  "featureList": [
    "Free online tool",
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Is the Health Check free to use?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How do I use the Health Check?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Simply open the Health Check page, enter your inputs, and click run to get instant results."
      }
    },
    {
      "@type": "Question",
