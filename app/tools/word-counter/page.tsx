...
<>
  ...
  "name": "Word Counter — Zion Tech Group",
  "description": "Count words, characters, sentences, and paragraphs. Useful for content, UX microcopy, and SEO checks.",
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Is the Word Counter free to use?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Simply open the Word Counter page, enter your inputs, and click run to get instant results."
      }
    },
    {
      "@type": "Question",
