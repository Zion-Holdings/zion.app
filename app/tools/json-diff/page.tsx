...
<>
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Is the Json Diff free to use?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "How do I use the Json Diff?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Simply open the Json Diff page, enter your inputs, and click run to get instant results."
      }
    },
    {
      "@type": "Question",
