...
export const metadata = {
  title: 'Zion AI Social Scheduler Pro | Zion Tech Group',
  description:
    'Zion AI Social Scheduler Pro empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automa',
  alternates: { canonical: '/zion-ai-social-scheduler-pro' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion AI Social Scheduler Pro empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion AI Social Scheduler Pro',
      }}
    />
  );
}
