...
export const metadata = {
  title: 'Robotic Process Automation | Zion Tech Group',
  description:
    'Robotic Process Automation eliminates manual bottlenecks with intelligent process automation, event-driven orchestration, and cross-system integration. Rec',
  alternates: { canonical: '/robotic-process-automation' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Robotic Process Automation eliminates manual bottlenecks with intelligent process automation, event-driven orchestration, and cross-system integration. Reclaim operational capacity and reduce human error.',
        iconEmoji: '🔄',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Robotic Process Automation',
      }}
    />
  );
}
