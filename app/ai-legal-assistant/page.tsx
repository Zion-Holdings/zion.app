...
export const metadata = {
  ...
  description:
    'AI Legal Assistant streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to f',
  alternates: { canonical: '/ai-legal-assistant' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Legal Assistant streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focus on strategic work.',
        iconEmoji: '📋',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Legal Assistant',
      }}
    />
  );
}
