...
export const metadata = {
  ...
  description:
    'Zion AI Predictive Analytics transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make f',
  alternates: { canonical: '/zion-ai-predictive-analytics' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion AI Predictive Analytics transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more confident decisions backed by production-grade analytics.',
        iconEmoji: '📊',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion AI Predictive Analytics',
      }}
    />
  );
}
