...
export const metadata: Metadata = {
  ...
  description: 'Free guides for AI and automation',
}
    ...
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page max-w-4xl">
        ...
        <div className="glass-card p-8">
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-4 capitalize">guides</h1>
          <p className="text-slate-300 mb-6">Free downloadable guides to help your organization succeed with AI and automation.</p>
