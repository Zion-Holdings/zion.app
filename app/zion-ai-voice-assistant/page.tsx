...
export const metadata: Metadata = {
  ...
  description: 'Enterprise AI voice assistant for customer service, meeting transcription, and voice-enabled workflow automation.',
  alternates: { canonical: '/zion-ai-voice-assistan/' },
};
