...
export const metadata = {
  ...
  description:
    'Blockchain Development provides secure, transparent, and decentralized solutions for modern businesses. Build trust through immutable records, smart contra',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Blockchain Development provides secure, transparent, and decentralized solutions for modern businesses. Build trust through immutable records, smart contract automation, and distributed ledger technology.',
        iconEmoji: '⛓️',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy Blockchain Development to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use Blockchain Development to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage Blockchain Development analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with Blockchain Development',
      }}
    />
  );
}
