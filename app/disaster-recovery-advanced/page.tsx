...
export const metadata = {
  ...
  description:
    'Disaster Recovery Advanced delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to product',
  alternates: { canonical: '/disaster-recovery-advanced' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Disaster Recovery Advanced delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster with battle-tested deployment patterns and cost optimization.',
        iconEmoji: '☁️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Disaster Recovery Advanced',
      }}
    />
  );
}
