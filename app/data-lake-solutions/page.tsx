...
export const metadata = {
  ...
  description:
    'Data Lake Solutions transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, mo',
  alternates: { canonical: '/data-lake-solutions' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Data Lake Solutions transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more confident decisions backed by production-grade analytics.',
        iconEmoji: '📊',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Data Lake Solutions',
      }}
    />
  );
}
