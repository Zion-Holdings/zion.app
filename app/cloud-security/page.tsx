...
export const metadata = {
  title: 'Cloud Security | Zion Tech Group',
  description:
    'Cloud Security provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit rea',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Cloud Security provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit readiness with AI-driven threat detection and policy enforcement.',
        iconEmoji: '🛡️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Cloud Security',
      }}
    />
  );
}
