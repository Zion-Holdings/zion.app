...
export const metadata = {
  title: 'Hospitality Case Study: 24/7 availability | Zion Tech Group',
  description: 'Learn how we helped Hospitality Solutions Inc achieve 24/7 availability through Process optimization.',
  openGraph: {
    title: 'Hospitality Case Study | Zion Tech Group',
    description: '24/7 availability',
    url: 'https://ziontechgroup.com/case-studies/hospitality-slow-decision-making',
  },
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50">
      <section className="py-20 max-w-5xl mx-auto px-4">
        ...
        <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 mt-4">
          How Hospitality Solutions Inc Achieved 24/7 availability
        </h1>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Hospitality Solutions Inc was facing significant challenges with slow decision-making,
