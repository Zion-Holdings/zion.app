...
export const metadata = {
  ...
  description: 'Learn how we helped Manufacturing Solutions Inc achieve 90% faster processing through Anomaly detection.',
  openGraph: {
    title: 'Manufacturing Case Study | Zion Tech Group',
    description: '90% faster processing',
    url: 'https://ziontechgroup.com/case-studies/manufacturing-legacy-system-constraints',
  },
