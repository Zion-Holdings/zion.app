...
export default function CaseStudiesPage() {
  const studies = [
    ...
    { industry: 'Technology', title: 'DevOps Automation for SaaS Startup', challenge: 'Manual deployments causing 6-hour release cycles with frequent rollbacks.', solution: 'AI-powered CI/CD pipeline with automated testing and rollback prevention.', results: ['15-minute deployments', '99.9% success rate', '3x faster feature delivery'], services: ['DevOps Automation', 'CI/CD Pipeline', 'Automated Testing'] },
    { industry: 'Insurance', title: 'Claims Processing Automation', challenge: 'Average 48-hour claims processing with 15% manual errors.', solution: 'AI document processing with automated claims classification and fraud detection.', results: ['85% faster processing', '99.5% accuracy', '30% cost reduction'], services: ['Claims AI', 'Document OCR', 'Fraud Detection'] },
    { industry: 'Media & Entertainment', title: 'Content Generation for Streaming Platform', challenge: 'Need 1000+ unique thumbnails and descriptions weekly for content library.', solution: 'AI image generation and content creation platform with brand consistency.', results: ['1000+ assets/week', '60% cost savings', 'Brand-consistent output'], services: ['AI Image Generation', 'Content Engine', 'Brand Training'] },
    { industry: 'Energy', title: 'Grid Optimization for Utility Company', challenge: 'Peak demand causing grid instability and high operational costs.', solution: 'AI-powered load forecasting and renewable energy optimization with demand response.', results: ['28% peak load reduction', '15% renewable integration', '$2.3M annual savings'], services: ['Grid AI', 'Load Forecasting', 'Demand Response'] },
  ];
