...
export default function CaseStudiesPage() {
  const studies = [
    ...
    { industry: 'Manufacturing', title: 'AI Vision Quality Inspection', challenge: 'Inconsistent defect detection across production shifts.', solution: 'Deployed real-time computer vision inspection with automatic quarantine.', results: ['30% fewer defects', '42% fewer false positives', '25% higher throughput'], services: ['AI Vision Inspection', 'Quality Automation', 'Manufacturing AI'] },
    { industry: 'Technology & SaaS', title: 'Onboarding Fraud Prevention', challenge: 'Rising fraudulent account creation during rapid growth.', solution: 'AI identity verification, device trust scoring, and behavior analytics on signup.', results: ['48% less fraud', '<1.2% false positives', '9% better completion'], services: ['Fraud Detection AI', 'Identity Verification', 'Behavior Analytics'] },
    { industry: 'Healthcare', title: 'Patient Flow and AI Triage', challenge: 'Front-desk bottleneck and long patient wait times.', solution: 'AI intake triage, documentation assistance, and smart scheduling.', results: ['40% faster flow', '18% less doc time', '27% same-day access'], services: ['AI Triage', 'Healthcare Automation', 'Patient Scheduling'] },
  ];
