...
export const metadata = {
  ...
  openGraph: {
    ...
    url: 'https://ziontechgroup.com/case-studies/technology-poor-customer-experience',
  },
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Technology Solutions Inc was facing significant challenges with poor customer experience,
