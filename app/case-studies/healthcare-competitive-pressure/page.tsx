...
export const metadata = {
  title: 'Healthcare Case Study: 95% customer satisfaction | Zion Tech Group',
  description: 'Learn how we helped Healthcare Solutions Inc achieve 95% customer satisfaction through Computer vision.',
  openGraph: {
    title: 'Healthcare Case Study | Zion Tech Group',
    description: '95% customer satisfaction',
    url: 'https://ziontechgroup.com/case-studies/healthcare-competitive-pressure',
  },
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50">
      <section className="py-20 max-w-5xl mx-auto px-4">
        ...
        <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 mt-4">
          How Healthcare Solutions Inc Achieved 95% customer satisfaction
        </h1>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Healthcare Solutions Inc was facing significant challenges with competitive pressure,
      ...
      <section className="py-16 max-w-5xl mx-auto px-4">
        ...
        <p className="text-gray-700 leading-relaxed mb-6">
          Zion Tech Group partnered with Healthcare Solutions Inc to implement computer vision
