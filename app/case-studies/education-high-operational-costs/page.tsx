...
export const metadata = {
  title: 'Education Case Study: 300% increase in efficiency | Zion Tech Group',
  description: 'Learn how we helped Education Solutions Inc achieve 300% increase in efficiency through Machine learning models.',
  openGraph: {
    title: 'Education Case Study | Zion Tech Group',
    description: '300% increase in efficiency',
    url: 'https://ziontechgroup.com/case-studies/education-high-operational-costs',
  },
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Education Solutions Inc was facing significant challenges with high operational costs,
