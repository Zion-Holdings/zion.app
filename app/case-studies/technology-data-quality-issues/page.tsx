...
export const metadata = {
  title: 'Technology Case Study: 24/7 availability | Zion Tech Group',
  description: 'Learn how we helped Technology Solutions Inc achieve 24/7 availability through Automated decision-making.',
  openGraph: {
    title: 'Technology Case Study | Zion Tech Group',
    description: '24/7 availability',
    url: 'https://ziontechgroup.com/case-studies/technology-data-quality-issues',
  },
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Technology Solutions Inc was facing significant challenges with data quality issues,
