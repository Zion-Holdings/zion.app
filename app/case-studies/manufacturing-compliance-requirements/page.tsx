...
export const metadata = {
  title: 'Manufacturing Case Study: 90% faster processing | Zion Tech Group',
  description: 'Learn how we helped Manufacturing Solutions Inc achieve 90% faster processing through AI-powered automation.',
  openGraph: {
    title: 'Manufacturing Case Study | Zion Tech Group',
    description: '90% faster processing',
    url: 'https://ziontechgroup.com/case-studies/manufacturing-compliance-requirements',
  },
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Manufacturing Solutions Inc was facing significant challenges with compliance requirements,
