...
export const metadata = {
  title: 'Healthcare Case Study: 100% compliance achievement | Zion Tech Group',
  description: 'Learn how we helped Healthcare Solutions Inc achieve 100% compliance achievement through AI-powered automation.',
  openGraph: {
    title: 'Healthcare Case Study | Zion Tech Group',
    description: '100% compliance achievement',
    url: 'https://ziontechgroup.com/case-studies/healthcare-slow-decision-making',
  },
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50">
      <section className="py-20 max-w-5xl mx-auto px-4">
        ...
        <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 mt-4">
          How Healthcare Solutions Inc Achieved 100% compliance achievement
        </h1>
        <p className="text-xl text-gray-600 leading-relaxed">
          A case study on transforming healthcare operations through
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Healthcare Solutions Inc was facing significant challenges with slow decision-making,
      ...
      <section className="py-16 max-w-5xl mx-auto px-4">
        ...
        <p className="text-gray-700 leading-relaxed mb-6">
          Zion Tech Group partnered with Healthcare Solutions Inc to implement ai-powered automation
