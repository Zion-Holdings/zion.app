...
export const metadata = {
  ...
  description: 'Learn how we helped Hospitality Solutions Inc achieve 150% increase in capacity through Natural language processing.',
  openGraph: {
    title: 'Hospitality Case Study | Zion Tech Group',
    description: '150% increase in capacity',
    url: 'https://ziontechgroup.com/case-studies/hospitality-high-operational-costs',
  },
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Hospitality Solutions Inc was facing significant challenges with high operational costs,
