...
export const metadata = {
  title: 'Real Estate Case Study: 99% accuracy improvement | Zion Tech Group',
  description: 'Learn how we helped Real Estate Solutions Inc achieve 99% accuracy improvement through Automated decision-making.',
  openGraph: {
    title: 'Real Estate Case Study | Zion Tech Group',
    description: '99% accuracy improvement',
    url: 'https://ziontechgroup.com/case-studies/real-estate-manual-data-processing',
  },
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Real Estate Solutions Inc was facing significant challenges with manual data processing,
