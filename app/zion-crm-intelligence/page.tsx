...
export const metadata = {
  ...
  description:
    'Zion CRM Intelligence empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. T',
  alternates: { canonical: '/zion-crm-intelligence' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion CRM Intelligence empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion CRM Intelligence',
      }}
    />
  );
}
