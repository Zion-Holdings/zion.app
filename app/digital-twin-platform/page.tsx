  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Digital Twin Platform explores the frontier of computing with advanced AI, simulation, and next-generation platforms. Position your team at the cutting edge while maintaining practical delivery standards.',
        iconEmoji: '🚀',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy Digital Twin Platform to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use Digital Twin Platform to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage Digital Twin Platform analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with Digital Twin Platform',
      }}
    />
  );
}
