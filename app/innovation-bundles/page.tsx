...
eexport const metadata = { title: 'Innovation Bundles', description: 'Curated bundles of AI and IT services at discounted prices. Combine solutions for maximum impact.' };
