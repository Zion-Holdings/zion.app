...
export const metadata = {
  title: 'Zion Lead Magnet | Zion Tech Group',
  description:
    'Zion Lead Magnet empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn d',
  alternates: { canonical: '/zion-lead-magnet' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion Lead Magnet empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion Lead Magnet',
      }}
    />
  );
}
