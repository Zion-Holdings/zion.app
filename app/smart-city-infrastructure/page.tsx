...
export const metadata = {
  ...
  description:
    'Smart City Infrastructure delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to producti',
  alternates: { canonical: '/smart-city-infrastructure' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Smart City Infrastructure delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster with battle-tested deployment patterns and cost optimization.',
        iconEmoji: '☁️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Smart City Infrastructure',
      }}
    />
  );
}
