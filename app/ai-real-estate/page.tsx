...
export const metadata = {
  ...
  description:
    'AI Real Estate delivers purpose-built AI solutions tailored to specific industry requirements. Accelerate digital transformation with domain-specific workf',
  alternates: { canonical: '/ai-real-estate' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Real Estate delivers purpose-built AI solutions tailored to specific industry requirements. Accelerate digital transformation with domain-specific workflows, compliance controls, and operational intelligence.',
        iconEmoji: '🏢',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy AI Real Estate to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use AI Real Estate to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage AI Real Estate analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with AI Real Estate',
      }}
    />
  );
}
