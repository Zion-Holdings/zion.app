...
export const metadata: Metadata = {
  title: 'Serverless Application Performance Monitor',
  description: 'Comprehensive monitoring for serverless applications.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/serverless-application-performance-monitor-a9f3799e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Serverless Application Performance Monitor
          </h1>
