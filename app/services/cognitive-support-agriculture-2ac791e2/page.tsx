...
export const metadata: Metadata = {
  title: 'Cognitive support-agriculture',
  description: 'Optimize your agriculture workflows with Cognitive support-agriculture. This intelligent platform delivers healthcare data analytics through advanced automation',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-support-agriculture-2ac791e2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive support-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your agriculture workflows with Cognitive support-agriculture. This intelligent platform delivers healthcare data analytics through advanced automation and AI.
          </p>
