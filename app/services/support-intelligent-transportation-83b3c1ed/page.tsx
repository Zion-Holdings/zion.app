...
export const metadata: Metadata = {
  title: 'Support Intelligent - Transportation',
  description: 'Transform your transportation operations with our Support Intelligent - Transportation. This AI-driven solution automates financial planning with unprecedented ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/support-intelligent-transportation-83b3c1ed',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your transportation operations with our Support Intelligent - Transportation. This AI-driven solution automates financial planning with unprecedented accuracy and efficiency.
          </p>
