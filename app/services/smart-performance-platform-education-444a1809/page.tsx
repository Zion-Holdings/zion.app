...
export const metadata: Metadata = {
  title: 'Smart Performance Platform - Education',
  description: 'Drive innovation in education with Smart Performance Platform - Education. This AI-powered platform transforms personalization engine into a competitive advanta',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Performance Platform - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in education with Smart Performance Platform - Education. This AI-powered platform transforms personalization engine into a competitive advantage.
          </p>
