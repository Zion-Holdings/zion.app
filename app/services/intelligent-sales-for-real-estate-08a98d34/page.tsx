...
export const metadata: Metadata = {
  title: 'Intelligent Sales for Real-Estate',
  description: 'Optimize your real-estate workflows with Intelligent Sales for Real-Estate. This intelligent platform delivers compliance reporting through advanced automation ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-sales-for-real-estate-08a98d34',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Sales for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your real-estate workflows with Intelligent Sales for Real-Estate. This intelligent platform delivers compliance reporting through advanced automation and AI.
          </p>
