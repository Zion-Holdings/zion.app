...
export const metadata: Metadata = {
  title: 'AI-Powered Finance for Telecom',
  description: 'The future of telecom is here with AI-Powered Finance for Telecom. Powered by cutting-edge AI, this platform delivers customer journey mapping like never before',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-finance-for-telecom-6835bcc3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Finance for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of telecom is here with AI-Powered Finance for Telecom. Powered by cutting-edge AI, this platform delivers customer journey mapping like never before.
          </p>
