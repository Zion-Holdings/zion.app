...
export const metadata: Metadata = {
  title: 'AI/IT SMB Suite - FINTECH',
  description: 'Next-generation fintech solution: AI/IT SMB Suite - FINTECH. Combines sustainability tracking with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-smb-suite-fintech-8a2daa61',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT SMB Suite - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation fintech solution: AI/IT SMB Suite - FINTECH. Combines sustainability tracking with adaptive intelligence for optimal results.
          </p>
