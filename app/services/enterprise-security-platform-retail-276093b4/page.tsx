...
export const metadata: Metadata = {
  title: 'Enterprise Security Platform - Retail',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Security Platform - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in retail with Enterprise Security Platform - Retail. This AI-powered platform transforms sustainability tracking into a competitive advantage.
          </p>
