...
export const metadata: Metadata = {
  title: 'Intelligent Cloud for Telecom',
  description: 'Transform your telecom operations with our Intelligent Cloud for Telecom. This AI-driven solution automates resource allocation with unprecedented accuracy and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-cloud-for-telecom-b1ac4a65',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Cloud for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your telecom operations with our Intelligent Cloud for Telecom. This AI-driven solution automates resource allocation with unprecedented accuracy and efficiency.
          </p>
