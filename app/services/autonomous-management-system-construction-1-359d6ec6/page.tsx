...
export const metadata: Metadata = {
  title: 'Autonomous Management System - Construction #1',
  description: 'The future of construction is here with Autonomous Management System - Construction #1. Powered by cutting-edge AI, this platform delivers workflow management l',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-management-system-construction-1-359d6ec6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Management System - Construction #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Autonomous Management System - Construction #1. Powered by cutting-edge AI, this platform delivers workflow management like never before.
          </p>
