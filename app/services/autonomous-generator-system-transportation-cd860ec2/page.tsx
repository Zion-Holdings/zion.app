...
export const metadata: Metadata = {
  title: 'Autonomous Generator System - Transportation',
  description: 'Optimize your transportation workflows with Autonomous Generator System - Transportation. This intelligent platform delivers predictive analytics through advanc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-generator-system-transportation-cd860ec2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Generator System - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Autonomous Generator System - Transportation. This intelligent platform delivers predictive analytics through advanced automation and AI.
          </p>
