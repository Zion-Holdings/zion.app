...
export const metadata: Metadata = {
  title: 'Security Neural - Retail',
  description: 'Transform your retail operations with our Security Neural - Retail. This AI-driven solution provides intelligent automation with unprecedented accuracy and effi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-neural-retail-e15dd734',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Neural - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our Security Neural - Retail. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
