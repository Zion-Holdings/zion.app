...
export const metadata: Metadata = {
  title: 'AI Intelligence - Construction Edition #2',
  description: 'Transform your construction operations with our AI Intelligence - Construction Edition #2. This AI-driven solution automates expense reporting with unprecedente',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Intelligence - Construction Edition #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our AI Intelligence - Construction Edition #2. This AI-driven solution automates expense reporting with unprecedented accuracy and efficiency.
          </p>
