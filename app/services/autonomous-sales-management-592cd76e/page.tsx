...
export const metadata: Metadata = {
  title: 'Autonomous Sales Management',
  description: 'Revolutionize finance through intelligent automation. Our Autonomous Sales Management leverages advanced machine learning to deliver image recognition at scale.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our Autonomous Sales Management leverages advanced machine learning to deliver image recognition at scale.
          </p>
