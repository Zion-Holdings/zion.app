...
export const metadata: Metadata = {
  title: 'Intelligent Data Science for Hospitality',
  description: 'Optimize your hospitality workflows with Intelligent Data Science for Hospitality. This intelligent platform delivers revenue forecasting through advanced autom',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-data-science-for-hospitality-1bb794ea',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Data Science for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Intelligent Data Science for Hospitality. This intelligent platform delivers revenue forecasting through advanced automation and AI.
          </p>
