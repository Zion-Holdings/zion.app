...
export const metadata: Metadata = {
  ...
  keywords: 'Demand forecasting, Automated reorder points, Supplier management, Multi-location support, Seasonal adjustment, Dead stock alerts, Purchase order automation, Cost optimization, ai, Enterprise, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Inventory Management &amp; Demand Planning</h1>
        <p className="text-lg text-slate-300 mb-8">Optimize inventory levels with AI-driven demand forecasting, automated reorder points, and supplier management. Reduces carrying costs by 30% and stockouts by 90% with machine learning models trained on your sales data.</p>
        ...
        <li class="text-slate-300">Automated reorder points</li>
        <li class="text-slate-300">Supplier management</li>
        <li class="text-slate-300">Multi-location support</li>
        <li class="text-slate-300">Seasonal adjustment</li>
        <li class="text-slate-300">Dead stock alerts</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">30% reduction in carrying costs</li>
        <li class="text-slate-300">90% fewer stockouts</li>
        <li class="text-slate-300">Optimized cash flow</li>
      </ul>
        </div>
