...
export const metadata: Metadata = {
  title: 'Decision Intelligent - Automotive',
  description: 'Drive innovation in automotive with Decision Intelligent - Automotive. This AI-powered platform transforms quality control into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/decision-intelligent-automotive-6fc0c846',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Decision Intelligent - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in automotive with Decision Intelligent - Automotive. This AI-powered platform transforms quality control into a competitive advantage.
          </p>
