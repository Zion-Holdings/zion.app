...
export const metadata: Metadata = {
  title: "Accounting AI Code Generation & Optimization - AI-Powered Accounting Solution",
  ...
  alternates: {
    canonical: "https://ziontechgroup.com/services/accounting-ai-code-generation--optimization-09304ecb",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Accounting AI Code Generation & Optimization - AI-Powered Accounting Solution
        </h1>
