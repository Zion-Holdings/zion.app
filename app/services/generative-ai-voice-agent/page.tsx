...
export const metadata: Metadata = {
  ...
  keywords: 'Natural TTS + STT, Multi-lingual support, Real-time CRM sync, Sentiment analysis, Call analytics dashboard, ai, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Generative AI Voice Agent</h1>
        <p className="text-lg text-slate-300 mb-8">24/7 AI voice agents for inbound support, outbound lead qualification, and appointment booking with natural voice and real-time CRM sync.</p>
        ...
        <li class="text-slate-300">Natural TTS + STT</li>
        <li class="text-slate-300">Multi-lingual support</li>
        <li class="text-slate-300">Real-time CRM sync</li>
        <li class="text-slate-300">Sentiment analysis</li>
        <li class="text-slate-300">Call analytics dashboard</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with generative ai voice agent</li>
