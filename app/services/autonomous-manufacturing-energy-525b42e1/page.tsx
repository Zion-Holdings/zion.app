...
export const metadata: Metadata = {
  title: 'Autonomous manufacturing-energy',
  description: 'Revolutionize energy through intelligent automation. Our Autonomous manufacturing-energy leverages advanced machine learning to deliver predictive analytics at ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous manufacturing-energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Autonomous manufacturing-energy leverages advanced machine learning to deliver predictive analytics at scale.
          </p>
