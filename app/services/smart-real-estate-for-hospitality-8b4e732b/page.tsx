...
export const metadata: Metadata = {
  title: 'Smart Real Estate for Hospitality',
  description: 'Unlock unprecedented growth with Smart Real Estate for Hospitality. This autonomous system provides energy management with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-real-estate-for-hospitality-8b4e732b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Real Estate for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Real Estate for Hospitality. This autonomous system provides energy management with zero manual intervention needed.
          </p>
