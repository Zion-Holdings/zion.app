...
export const metadata: Metadata = {
  title: 'Intelligent System for Gaming',
  description: 'Transform your gaming operations with our Intelligent System for Gaming. This AI-driven solution automates document processing with unprecedented accuracy and e',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-system-for-gaming-484744f1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent System for Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your gaming operations with our Intelligent System for Gaming. This AI-driven solution automates document processing with unprecedented accuracy and efficiency.
          </p>
