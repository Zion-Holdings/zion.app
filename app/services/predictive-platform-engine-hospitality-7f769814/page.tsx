...
export const metadata: Metadata = {
  title: 'Predictive Platform Engine - Hospitality',
  description: 'The future of hospitality is here with Predictive Platform Engine - Hospitality. Powered by cutting-edge AI, this platform delivers insurance automation like ne',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-platform-engine-hospitality-7f769814',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Platform Engine - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Predictive Platform Engine - Hospitality. Powered by cutting-edge AI, this platform delivers insurance automation like never before.
          </p>
