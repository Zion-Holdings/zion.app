...
export const metadata: Metadata = {
  title: 'AI Financial - Sports Edition',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Financial - Sports Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your sports business with AI Financial - Sports Edition. Our solution provides recruitment automation with enterprise-grade reliability and security.
          </p>
