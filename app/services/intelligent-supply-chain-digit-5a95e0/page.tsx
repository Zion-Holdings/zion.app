...
export const metadata: Metadata = {
  title: 'Intelligent Supply Chain DigitalOcean (Data)',
  description: 'Intelligent Supply Chain DigitalOcean (Data) is an AI-powered data solution that transforms how businesses operate through intelligent automation and real-time ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-supply-chain-digit-5a95e0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Supply Chain DigitalOcean (Data)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Intelligent Supply Chain DigitalOcean (Data) is an AI-powered data solution that transforms how businesses operate through intelligent automation and real-time analytics.
...
Microservices, AWS, PyTorch, Kafka, Go, Azure
