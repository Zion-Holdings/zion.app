...
export const metadata: Metadata = {
  title: 'Optimization Autonomous - Proptech',
  description: 'Next-generation proptech solution: Optimization Autonomous - Proptech. Combines customer service automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/optimization-autonomous---proptech-61e83262',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Optimization Autonomous - Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation proptech solution: Optimization Autonomous - Proptech. Combines customer service automation with adaptive intelligence for optimal results.
          </p>
