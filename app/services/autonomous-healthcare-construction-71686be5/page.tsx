...
export const metadata: Metadata = {
  title: 'Autonomous healthcare-construction',
  description: 'The future of construction is here with Autonomous healthcare-construction. Powered by cutting-edge AI, this platform delivers project portfolio like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-healthcare-construction-71686be5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous healthcare-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Autonomous healthcare-construction. Powered by cutting-edge AI, this platform delivers project portfolio like never before.
          </p>
