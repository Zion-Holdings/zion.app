...
export const metadata = {
  title: "Enterprise Optimized Marketing Analytics Suite - Zion Tech Group",
  description: "Enterprise analytics suite that delivers optimized marketing insights with unified dashboards and reporting.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/enterprise-optimized-marketing-analytics-suite-7733ba7c`
  }
};
