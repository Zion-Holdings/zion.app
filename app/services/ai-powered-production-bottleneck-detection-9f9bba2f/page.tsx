...
export const metadata: Metadata = {
  title: 'AI-Powered Production Bottleneck Detection',
  description: 'Detects and resolves production bottlenecks with AI analysis.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-production-bottleneck-detection-9f9bba2f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Production Bottleneck Detection
          </h1>
