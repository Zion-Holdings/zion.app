...
export const metadata: Metadata = {
  title: 'Adaptive Business Intelligence for Hospitality',
  description: 'The future of hospitality is here with Adaptive Business Intelligence for Hospitality. Powered by cutting-edge AI, this platform delivers transformative results',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-business-intelligence-for-hospitality-688f8eba',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Business Intelligence for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Adaptive Business Intelligence for Hospitality. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
