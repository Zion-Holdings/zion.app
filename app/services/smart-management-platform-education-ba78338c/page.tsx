...
export const metadata: Metadata = {
  title: 'Smart Management Platform - Education',
  description: 'Enhance your education business with Smart Management Platform - Education. Our solution provides resource optimization with enterprise-grade reliability and se',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-management-platform-education-ba78338c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Management Platform - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your education business with Smart Management Platform - Education. Our solution provides resource optimization with enterprise-grade reliability and security.
          </p>
