...
export const metadata: Metadata = {
  title: 'Smart Strategic Platform - TECHNOLOGY',
  description: 'Transform your technology operations with our Smart Strategic Platform - TECHNOLOGY. This AI-driven solution automates predictive modeling with unprecedented ac',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Strategic Platform - TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your technology operations with our Smart Strategic Platform - TECHNOLOGY. This AI-driven solution automates predictive modeling with unprecedented accuracy and efficiency.
          </p>
