...
export const metadata: Metadata = {
  title: 'Intelligent System for Enterprise',
  description: 'Optimize your enterprise workflows with Intelligent System for Enterprise. This intelligent platform delivers social media monitoring through advanced automatio',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent System for Enterprise
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your enterprise workflows with Intelligent System for Enterprise. This intelligent platform delivers social media monitoring through advanced automation and AI.
          </p>
