...
export const metadata: Metadata = {
  title: 'Next-Gen Customer Service - Saas',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Customer Service - Saas
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your saaS with Next-Gen Customer Service - Saas. Our autonomous solution handles recruitment automation end-to-end without human intervention.
          </p>
