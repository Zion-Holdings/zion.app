...
export const metadata: Metadata = {
  title: 'Smart Compliance Analytics',
  description: 'Transform your quantum operations with our Smart Compliance Analytics. This AI-driven solution automates process automation with unprecedented accuracy and effi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Compliance Analytics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your quantum operations with our Smart Compliance Analytics. This AI-driven solution automates process automation with unprecedented accuracy and efficiency.
          </p>
