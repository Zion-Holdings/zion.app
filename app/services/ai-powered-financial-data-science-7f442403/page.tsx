...
export const metadata: Metadata = {
  title: 'AI-Powered Financial Data Science',
  description: 'The future of finance is here with AI-Powered Financial Data Science. Powered by cutting-edge AI, this platform delivers loyalty optimization like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-financial-data-science-7f442403',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Financial Data Science
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of finance is here with AI-Powered Financial Data Science. Powered by cutting-edge AI, this platform delivers loyalty optimization like never before.
          </p>
