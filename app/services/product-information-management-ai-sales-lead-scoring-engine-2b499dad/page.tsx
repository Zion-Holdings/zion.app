...
export const metadata: Metadata = {
  title: 'Product Information Management AI Sales Lead Scoring Engine',
  description: 'product information management solution for jewelry industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/product-information-management-ai-sales-lead-scoring-engine-2b499dad',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Product Information Management AI Sales Lead Scoring Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            product information management solution for jewelry industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.
          </p>
