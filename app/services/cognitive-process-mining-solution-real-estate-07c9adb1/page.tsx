...
export const metadata: Metadata = {
  title: 'Cognitive Process Mining Solution - Real-Estate',
  description: 'Next-generation real-estate solution: Cognitive Process Mining Solution - Real-Estate. Combines decision support with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-process-mining-solution-real-estate-07c9adb1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Process Mining Solution - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation real-estate solution: Cognitive Process Mining Solution - Real-Estate. Combines decision support with adaptive intelligence for optimal results.
          </p>
