...
export const metadata: Metadata = {
  title: 'System Cognitive - Manufacturing',
  description: 'The future of manufacturing is here with System Cognitive - Manufacturing. Powered by cutting-edge AI, this platform delivers content generation like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/system-cognitive-manufacturing-6868804e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            System Cognitive - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of manufacturing is here with System Cognitive - Manufacturing. Powered by cutting-edge AI, this platform delivers content generation like never before.
          </p>
