...
export const metadata: Metadata = {
  title: 'AI-Powered Insights for Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our AI-Powered Insights for Hospitality leverages advanced machine learning to deliver quality control',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-insights-for-hospitality-55d5169d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Insights for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our AI-Powered Insights for Hospitality leverages advanced machine learning to deliver quality control at scale.
          </p>
