...
export const metadata: Metadata = {
  title: 'Automated Data for Agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Automated Data for Agriculture leverages advanced machine learning to deliver security monitoring ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-data-for-agriculture-73e2e02f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Data for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Automated Data for Agriculture leverages advanced machine learning to deliver security monitoring at scale.
          </p>
