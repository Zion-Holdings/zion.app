...
export const metadata: Metadata = {
  title: 'Smart Revenue Platform - Legal',
  description: 'The future of legal is here with Smart Revenue Platform - Legal. Powered by cutting-edge AI, this platform delivers user provisioning like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-revenue-platform-legal-270ba93f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Revenue Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Smart Revenue Platform - Legal. Powered by cutting-edge AI, this platform delivers user provisioning like never before.
          </p>
