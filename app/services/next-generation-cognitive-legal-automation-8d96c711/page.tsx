...
export const metadata = {
  title: "Next-Generation Cognitive Legal Automation - Zion Tech Group",
  description: "Next-generation automation suite that streamlines cognitive legal workflows with intelligent orchestration.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/next-generation-cognitive-legal-automation-8d96c711`
  }
};
