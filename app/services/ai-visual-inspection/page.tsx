...
export const metadata: Metadata = {
  ...
  keywords: 'Defect detection (scratches, dents, misalignments), Real-time inspection at line speed, Anomaly detection on novel defect types, Self-learning model improvement, Integration with PLCs & MES systems, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Visual Inspection &amp; Quality Control</h1>
        <p className="text-lg text-slate-300 mb-8">Computer vision-powered quality control for manufacturing: detect defects, classify product flaws, and ensure consistent quality on the production line.</p>
        ...
        <li class="text-slate-300">Defect detection (scratches, dents, misalignments)</li>
        <li class="text-slate-300">Real-time inspection at line speed</li>
        <li class="text-slate-300">Anomaly detection on novel defect types</li>
        <li class="text-slate-300">Self-learning model improvement</li>
        <li class="text-slate-300">Integration with PLCs &amp; MES systems</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai visual inspection &amp; quality control</li>
