...
export const metadata: Metadata = {
  title: 'Quantum Finance for Transportation',
  description: 'Future-proof your transportation with Quantum Finance for Transportation. Our autonomous solution handles anomaly detection end-to-end without human interventio',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-finance-for-transportation-27c00e43',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Finance for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your transportation with Quantum Finance for Transportation. Our autonomous solution handles anomaly detection end-to-end without human intervention.
          </p>
