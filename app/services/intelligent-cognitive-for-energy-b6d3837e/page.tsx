...
export const metadata: Metadata = {
  title: 'Intelligent Cognitive for Energy',
  description: 'Unlock unprecedented growth with Intelligent Cognitive for Energy. This autonomous system provides hr analytics with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-cognitive-for-energy-b6d3837e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Cognitive for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Cognitive for Energy. This autonomous system provides hr analytics with zero manual intervention needed.
          </p>
