...
export const metadata: Metadata = {
  title: 'Smart Generator for Finance',
  description: 'Transform your finance operations with our Smart Generator for Finance. This AI-driven solution automates maintenance scheduling with unprecedented accuracy and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-generator-for-finance-ca21b65e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Generator for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Smart Generator for Finance. This AI-driven solution automates maintenance scheduling with unprecedented accuracy and efficiency.
          </p>
