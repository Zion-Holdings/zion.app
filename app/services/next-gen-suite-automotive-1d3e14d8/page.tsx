...
export const metadata: Metadata = {
  title: 'Next-Gen Suite - Automotive',
  description: 'Optimize your automotive workflows with Next-Gen Suite - Automotive. This intelligent platform delivers code optimization through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-suite-automotive-1d3e14d8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Suite - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your automotive workflows with Next-Gen Suite - Automotive. This intelligent platform delivers code optimization through advanced automation and AI.
          </p>
