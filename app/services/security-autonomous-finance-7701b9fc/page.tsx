...
export const metadata: Metadata = {
  title: 'Security Autonomous - Finance',
  description: 'Optimize your finance workflows with Security Autonomous - Finance. This intelligent platform delivers pipeline management through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-autonomous-finance-7701b9fc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Autonomous - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your finance workflows with Security Autonomous - Finance. This intelligent platform delivers pipeline management through advanced automation and AI.
          </p>
