...
export const metadata: Metadata = {
  title: 'Cognitive Risk for Real-Estate #2',
  description: 'Next-generation real-estate solution: Cognitive Risk for Real-Estate #2. Combines energy management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-risk-for-real-estate-2-c1a039f4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Risk for Real-Estate #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation real-estate solution: Cognitive Risk for Real-Estate #2. Combines energy management with adaptive intelligence for optimal results.
          </p>
