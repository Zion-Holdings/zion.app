...
export const metadata: Metadata = {
  title: 'Smart Security for Insurance',
  description: 'Transform your insurance operations with our Smart Security for Insurance. This AI-driven solution automates risk assessment with unprecedented accuracy and eff',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-security-for-insurance-3bef0b29',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Security for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Smart Security for Insurance. This AI-driven solution automates risk assessment with unprecedented accuracy and efficiency.
          </p>
