...
export const metadata: Metadata = {
  title: 'Next-Gen Processor for Transportation',
  description: 'Next-generation transportation solution: Next-Gen Processor for Transportation. Combines sustainability tracking with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-processor-for-transportation-42d5ae94',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Processor for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation transportation solution: Next-Gen Processor for Transportation. Combines sustainability tracking with adaptive intelligence for optimal results.
          </p>
