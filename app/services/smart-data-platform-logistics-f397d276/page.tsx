...
export const metadata: Metadata = {
  title: 'Smart Data Platform - Logistics',
  description: 'Transform your logistics operations with our Smart Data Platform - Logistics. This AI-driven solution automates procurement automation with unprecedented accura',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-data-platform-logistics-f397d276',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Data Platform - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Smart Data Platform - Logistics. This AI-driven solution automates procurement automation with unprecedented accuracy and efficiency.
          </p>
