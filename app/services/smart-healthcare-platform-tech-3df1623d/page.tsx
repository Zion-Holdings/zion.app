...
export const metadata: Metadata = {
  title: 'Smart Healthcare Platform - Tech',
  description: 'Next-generation technology solution: Smart Healthcare Platform - Tech. Combines supply chain with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-healthcare-platform-tech-3df1623d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Healthcare Platform - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation technology solution: Smart Healthcare Platform - Tech. Combines supply chain with adaptive intelligence for optimal results.
          </p>
