...
export const metadata: Metadata = {
  title: 'AI Business Intelligence - Insurance Edition',
  description: 'The future of insurance is here with AI Business Intelligence - Insurance Edition. Powered by cutting-edge AI, this platform delivers decision support like neve',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Business Intelligence - Insurance Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with AI Business Intelligence - Insurance Edition. Powered by cutting-edge AI, this platform delivers decision support like never before.
          </p>
