...
export const metadata: Metadata = {
  title: 'Next-Gen Decision for CLEANTECH',
  description: 'Drive innovation in cleantech with Next-Gen Decision for CLEANTECH. This AI-powered platform transforms personalization engine into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-decision-for-cleantech-1b2d5db9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Decision for CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in cleantech with Next-Gen Decision for CLEANTECH. This AI-powered platform transforms personalization engine into a competitive advantage.
          </p>
