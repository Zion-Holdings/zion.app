...
export const metadata: Metadata = {
  title: 'Security Next-Gen - FINTECH',
  description: 'Quantum leap forward for fintech: Security Next-Gen - FINTECH. Uses quantum-inspired algorithms to deliver data pipeline orchestration at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-next-gen-fintech-cfcd3e78',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Next-Gen - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for fintech: Security Next-Gen - FINTECH. Uses quantum-inspired algorithms to deliver data pipeline orchestration at exponential speed.
          </p>
