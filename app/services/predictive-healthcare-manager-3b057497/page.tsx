...
export const metadata: Metadata = {
  title: 'Predictive Healthcare Manager',
  description: 'Next-generation insurance solution: Predictive Healthcare Manager. Combines process automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-healthcare-manager-3b057497',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Healthcare Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Predictive Healthcare Manager. Combines process automation with adaptive intelligence for optimal results.
          </p>
