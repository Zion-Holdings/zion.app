...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time CDC for all major databases, Sub-second latency, Minimal source system impact, Schema evolution handling, Integration with Kafka, Snowflake, Databricks, Exactly-once delivery, Monitoring and alerting, Cloud and on-premises deployment, data, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Change Data Capture (CDC) Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Real-time change data capture for databases. Stream data changes to data lakes, warehouses, and applications with low latency and minimal source impact.</p>
        ...
        <li class="text-slate-300">Real-time CDC for all major databases</li>
        <li class="text-slate-300">Sub-second latency</li>
        <li class="text-slate-300">Minimal source system impact</li>
        <li class="text-slate-300">Schema evolution handling</li>
        <li class="text-slate-300">Integration with Kafka, Snowflake, Databricks</li>
        <li class="text-slate-300">Exactly-once delivery</li>
        <li class="text-slate-300">Monitoring and alerting</li>
        <li class="text-slate-300">Cloud and on-premises deployment</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Real-time data synchronization</li>
        <li class="text-slate-300">Minimal impact on source systems</li>
        <li class="text-slate-300">Enable event-driven architectures</li>
        <li class="text-slate-300">Keep all systems in sync</li>
      </ul>
        </div>
