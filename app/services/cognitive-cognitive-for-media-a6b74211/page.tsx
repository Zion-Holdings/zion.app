...
export const metadata: Metadata = {
  title: 'Cognitive Cognitive for Media',
  description: 'Drive innovation in media with Cognitive Cognitive for Media. This AI-powered platform transforms customer insights into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-cognitive-for-media-a6b74211',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Cognitive for Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in media with Cognitive Cognitive for Media. This AI-powered platform transforms customer insights into a competitive advantage.
          </p>
