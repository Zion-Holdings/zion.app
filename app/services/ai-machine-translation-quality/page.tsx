      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Neural MT post-editing quality scoring (COMET/HYENA), terminology enforcement, auto-edit suggestion, and translation memory browser.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ COMET/HYENA quality scoring per segment</li>
            <li className="text-purple-300">✓ Terminology enforcement dictionary</li>
            <li className="text-purple-300">✓ Auto-edit suggestion (Neural MT post-editing)</li>
            <li className="text-purple-300">✓ Translation memory browser per language pair</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with machine translation quality engine</li>
