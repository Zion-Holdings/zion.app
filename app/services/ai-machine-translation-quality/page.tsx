...
export const metadata: Metadata = {
  ...
  keywords: 'COMET/HYENA quality scoring per segment, Terminology enforcement dictionary, Auto-edit suggestion (Neural MT post-editing), Translation memory browser per language pair, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Machine Translation Quality Engine</h1>
        <p className="text-lg text-slate-300 mb-8">Neural MT post-editing quality scoring (COMET/HYENA), terminology enforcement, auto-edit suggestion, and translation memory browser.</p>
        ...
        <li class="text-slate-300">COMET/HYENA quality scoring per segment</li>
        <li class="text-slate-300">Terminology enforcement dictionary</li>
        <li class="text-slate-300">Auto-edit suggestion (Neural MT post-editing)</li>
        <li class="text-slate-300">Translation memory browser per language pair</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with machine translation quality engine</li>
