...
export const metadata: Metadata = {
  title: 'Cognitive System for Energy',
  description: 'Revolutionize energy through intelligent automation. Our Cognitive System for Energy leverages advanced machine learning to deliver supply chain at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-system-for-energy-4b2c09e6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive System for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Cognitive System for Energy leverages advanced machine learning to deliver supply chain at scale.
          </p>
