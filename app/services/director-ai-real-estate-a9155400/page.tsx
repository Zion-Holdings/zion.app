...
export const metadata: Metadata = {
  title: 'Director AI - Real-Estate',
  description: 'Revolutionize real-estate through intelligent automation. Our Director AI - Real-Estate leverages advanced machine learning to deliver customer retention at sca',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/director-ai-real-estate-a9155400',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Director AI - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our Director AI - Real-Estate leverages advanced machine learning to deliver customer retention at scale.
          </p>
