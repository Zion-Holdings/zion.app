...
export const metadata: Metadata = {
  title: 'Enterprise Strategic Platform - PROPTECH',
  description: 'Quantum leap forward for proptech: Enterprise Strategic Platform - PROPTECH. Uses quantum-inspired algorithms to deliver model interpretability at exponential s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-strategic-platform-proptech-66935968',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Strategic Platform - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for proptech: Enterprise Strategic Platform - PROPTECH. Uses quantum-inspired algorithms to deliver model interpretability at exponential speed.
          </p>
