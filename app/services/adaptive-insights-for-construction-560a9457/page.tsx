...
export const metadata: Metadata = {
  title: 'Adaptive Insights for Construction',
  description: 'Transform your construction operations with our Adaptive Insights for Construction. This AI-driven solution automates security monitoring with unprecedented acc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-insights-for-construction-560a9457',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Insights for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Adaptive Insights for Construction. This AI-driven solution automates security monitoring with unprecedented accuracy and efficiency.
          </p>
