...
export const metadata: Metadata = {
  title: 'Cognitive Quality for Telecom',
  description: 'Revolutionize telecom through intelligent automation. Our Cognitive Quality for Telecom leverages advanced machine learning to deliver decision support at scale',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-quality-for-telecom-48ba29b7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Quality for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Cognitive Quality for Telecom leverages advanced machine learning to deliver decision support at scale.
          </p>
