  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Data Engineering &amp; Pipeline Development</h1>
        <p className="text-lg text-slate-300 mb-8">Build scalable data pipelines and engineering solutions. From batch ETL to real-time streaming, with data quality, governance, and observability built in.</p>
        ...
        <li class="text-slate-300">Batch and real-time ETL/ELT pipeline development</li>
        <li class="text-slate-300">Data quality framework and monitoring</li>
        <li class="text-slate-300">Data catalog and lineage implementation</li>
        <li class="text-slate-300">Streaming data with Kafka, Spark, Flink</li>
        <li class="text-slate-300">Data mesh and domain-oriented architecture</li>
        <li class="text-slate-300">Integration with Snowflake, Databricks, BigQuery</li>
        <li class="text-slate-300">Data pipeline observability and alerting</li>
        <li class="text-slate-300">Cost optimization for data infrastructure</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Process data 10x faster with modern pipelines</li>
        <li class="text-slate-300">Ensure data quality with automated monitoring</li>
        <li class="text-slate-300">Reduce data infrastructure costs by 35%</li>
        <li class="text-slate-300">Enable self-service data for all teams</li>
      </ul>
        </div>
