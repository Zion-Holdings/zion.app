...
export const metadata: Metadata = {
  title: 'Member Experience Autonomous Customer Service AI',
  description: 'member experience solution for emergency services industry. Fully automated customer support system that handles 80% of inquiries without human intervention.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/member-experience-autonomous-customer-service-ai-a32cdac0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Member Experience Autonomous Customer Service AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            member experience solution for emergency services industry. Fully automated customer support system that handles 80% of inquiries without human intervention.
          </p>
