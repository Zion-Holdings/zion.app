    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Deploy with confidence, $500M+ in protected TVL</li>
            <li>Catch re-entrancy + overflow before mainnet</li>
            <li>30-day post-audit fix window included</li>
            <li>Support: Ethereum, BSC, Polygon, Arbitrum</li>
          </ul>
        </div>
