...
export const metadata: Metadata = {
  ...
  keywords: 'Cloud-native architecture, GDPR compliance, Open-source friendly, Performance dashboards, Edge computing support, Alerting system, management, logistics, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Autonomous Platform for Logistics</h1>
        <p className="text-lg text-slate-300 mb-8">Revolutionize logistics through intelligent automation. Our Autonomous Platform for Logistics leverages advanced machine learning to deliver energy management at scale.</p>
