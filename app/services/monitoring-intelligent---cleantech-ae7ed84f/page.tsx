...
export const metadata: Metadata = {
  title: 'Monitoring Intelligent - Cleantech',
  description: 'Revolutionize cleantech through intelligent automation. Our Monitoring Intelligent - Cleantech leverages advanced machine learning to deliver logistics route op',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/monitoring-intelligent---cleantech-ae7ed84f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Monitoring Intelligent - Cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cleantech through intelligent automation. Our Monitoring Intelligent - Cleantech leverages advanced machine learning to deliver logistics route optimization at scale.
          </p>
