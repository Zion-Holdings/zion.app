...
export const metadata: Metadata = {
  title: 'Autonomous Customer Service System - PROPTECH',
  description: 'Revolutionize proptech through intelligent automation. Our Autonomous Customer Service System - PROPTECH leverages advanced machine learning to deliver complian',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-customer-service-system-proptech-83f6ccef',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Customer Service System - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our Autonomous Customer Service System - PROPTECH leverages advanced machine learning to deliver compliance automation at scale.
          </p>
