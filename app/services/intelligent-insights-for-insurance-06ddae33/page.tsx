...
export const metadata: Metadata = {
  title: 'Intelligent Insights for Insurance',
  description: 'Hyper-accelerated insurance solution: Intelligent Insights for Insurance. Combines receipt processing with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-insights-for-insurance-06ddae33',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Insights for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated insurance solution: Intelligent Insights for Insurance. Combines receipt processing with next-gen AI for maximum velocity.
          </p>
