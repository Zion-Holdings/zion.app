...
export const metadata: Metadata = {
  title: 'Autonomous security-construction',
  description: 'Revolutionize construction through intelligent automation. Our Autonomous security-construction leverages advanced machine learning to deliver vendor management',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-security-construction-bf697877',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous security-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Autonomous security-construction leverages advanced machine learning to deliver vendor management at scale.
          </p>
