...
export const metadata: Metadata = {
  title: 'Automated finance-logistics',
  description: 'Next-generation logistics solution: Automated finance-logistics. Combines financial risk management with adaptive intelligence for optimal results.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated finance-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Automated finance-logistics. Combines financial risk management with adaptive intelligence for optimal results.
          </p>
