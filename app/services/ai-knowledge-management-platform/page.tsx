...
export const metadata: Metadata = {
  ...
  keywords: 'AI-powered search across all sources, Auto-tagging and classification, Expert identification, Knowledge gap analysis, Integration with Confluence, SharePoint, Slack, Knowledge verification workflows, Analytics and usage insights, Mobile access, ai, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Knowledge Management Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Enterprise knowledge management with AI-powered search, auto-tagging, and expert identification. Capture, organize, and surface institutional knowledge.</p>
        ...
        <li class="text-slate-300">AI-powered search across all sources</li>
        <li class="text-slate-300">Auto-tagging and classification</li>
        <li class="text-slate-300">Expert identification</li>
        <li class="text-slate-300">Knowledge gap analysis</li>
        <li class="text-slate-300">Integration with Confluence, SharePoint, Slack</li>
        <li class="text-slate-300">Knowledge verification workflows</li>
        <li class="text-slate-300">Analytics and usage insights</li>
        <li class="text-slate-300">Mobile access</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Find knowledge 10x faster</li>
        <li class="text-slate-300">Identify subject matter experts</li>
        <li class="text-slate-300">Prevent knowledge loss</li>
        <li class="text-slate-300">Improve decision-making</li>
      </ul>
        </div>
