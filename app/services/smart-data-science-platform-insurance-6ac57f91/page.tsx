...
export const metadata: Metadata = {
  title: 'Smart Data Science Platform - Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Smart Data Science Platform - Insurance leverages advanced machine learning to deliver audit trail m',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-data-science-platform-insurance-6ac57f91',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Data Science Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Smart Data Science Platform - Insurance leverages advanced machine learning to deliver audit trail management at scale.
          </p>
