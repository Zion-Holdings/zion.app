...
export const metadata: Metadata = {
  title: 'Autonomous Support System - Logistics',
  description: 'Transform your logistics operations with our Autonomous Support System - Logistics. This AI-driven solution automates logistics route optimization with unpreced',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-support-system-logistics-642b94f7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Support System - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Autonomous Support System - Logistics. This AI-driven solution automates logistics route optimization with unprecedented accuracy and efficiency.
          </p>
