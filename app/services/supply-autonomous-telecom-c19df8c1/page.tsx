...
export const metadata: Metadata = {
  title: 'Supply Autonomous - Telecom',
  description: 'Revolutionize telecom through intelligent automation. Our Supply Autonomous - Telecom leverages advanced machine learning to deliver edge computing at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/supply-autonomous-telecom-c19df8c1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Supply Autonomous - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Supply Autonomous - Telecom leverages advanced machine learning to deliver edge computing at scale.
          </p>
