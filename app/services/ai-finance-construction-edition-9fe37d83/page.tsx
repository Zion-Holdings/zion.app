...
export const metadata: Metadata = {
  title: 'AI Finance - Construction Edition',
  description: 'The future of construction is here with AI Finance - Construction Edition. Powered by cutting-edge AI, this platform delivers financial risk management like nev',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-finance-construction-edition-9fe37d83',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Finance - Construction Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with AI Finance - Construction Edition. Powered by cutting-edge AI, this platform delivers financial risk management like never before.
          </p>
