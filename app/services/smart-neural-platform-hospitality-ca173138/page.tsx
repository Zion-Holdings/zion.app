...
export const metadata: Metadata = {
  title: 'Smart Neural Platform - Hospitality',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Neural Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Smart Neural Platform - Hospitality. Combines budget tracking with adaptive intelligence for optimal results.
          </p>
