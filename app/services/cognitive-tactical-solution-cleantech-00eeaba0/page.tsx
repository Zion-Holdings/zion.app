...
export const metadata = {
  ...
  description: "Optimize your cleantech workflows with Cognitive Tactical Solution - CLEANTECH. This intelligent platform delivers onboarding automation through advanced automa",
  alternates: {
