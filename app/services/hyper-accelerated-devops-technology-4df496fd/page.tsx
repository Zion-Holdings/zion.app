...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated DevOps - TECHNOLOGY',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated DevOps - TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our Hyper-Accelerated DevOps - TECHNOLOGY leverages advanced machine learning to deliver lakehouse architecture at scale.
          </p>
