...
export const metadata: Metadata = {
  title: 'Automated Social Intelligent',
  description: 'The future of manufacturing is here with Automated Social Intelligent. Powered by cutting-edge AI, this platform delivers recommendation system like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-social-intelligent-bc9e6b28',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Social Intelligent
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of manufacturing is here with Automated Social Intelligent. Powered by cutting-edge AI, this platform delivers recommendation system like never before.
          </p>
