...
export const metadata: Metadata = {
  title: 'Adaptive Decision Processor',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation automotive solution: Adaptive Decision Processor. Combines security monitoring with adaptive intelligence for optimal results.
          </p>
