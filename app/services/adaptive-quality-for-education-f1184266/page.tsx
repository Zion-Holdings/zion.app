  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Adaptive Quality for Education</h1>
        <p className="text-lg text-gray-300 mb-8">Transform your education operations with our Adaptive Quality for Education. This AI-driven solution automates supply chain with unprecedented accuracy and efficiency.</p>
