...
export const metadata: Metadata = {
  title: 'Smart Analytics for Legal #1',
  description: 'Revolutionize legal through intelligent automation. Our Smart Analytics for Legal #1 leverages advanced machine learning to deliver inventory management at scal',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-analytics-for-legal-1-d8408d4a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Analytics for Legal #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Smart Analytics for Legal #1 leverages advanced machine learning to deliver inventory management at scale.
          </p>
