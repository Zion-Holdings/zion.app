...
export const metadata: Metadata = {
  ...
  keywords: 'Plugin architecture, Custom integrations, Multi-language support, SOC 2 certified, analytics, construction, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Intelligence - Construction Edition</h1>
        <p className="text-lg text-slate-300 mb-8">Next-generation construction solution: AI Intelligence - Construction Edition. Combines fraud prevention with adaptive intelligence for optimal results.</p>
