...
export const metadata = {
  ...
  description: "Transform your logistics operations with our AI Advisor - Logistics Edition #2. This AI-driven solution automates user provisioning with unprecedented accuracy ",
  alternates: {
