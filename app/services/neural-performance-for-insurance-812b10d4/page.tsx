...
export const metadata: Metadata = {
  ...
  description: 'The future of insurance is here with Neural Performance for Insurance. Powered by cutting-edge AI, this platform delivers sales process optimization like never ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-performance-for-insurance-812b10d4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Neural Performance for Insurance. Powered by cutting-edge AI, this platform delivers sales process optimization like never before.
          </p>
