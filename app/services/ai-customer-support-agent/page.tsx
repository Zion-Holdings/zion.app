      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Fully automated 24/7 customer support using RAG + LLMs: answer FAQs, troubleshoot issues, process returns, and escalate complex tickets with context handoff.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Integrations: Zendesk, Intercom, Salesforce</li>
            <li className="text-purple-300">✓ Document retrieval from knowledge base (RAG)</li>
            <li className="text-purple-300">✓ Sentiment-aware responses & escalation</li>
            <li className="text-purple-300">✓ Analytics: resolution rate, CSAT impact</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai customer support agent</li>
