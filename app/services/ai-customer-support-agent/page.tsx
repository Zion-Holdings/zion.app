...
export const metadata: Metadata = {
  ...
  keywords: 'Multilingual support (50+ languages), Integrations: Zendesk, Intercom, Salesforce, Document retrieval from knowledge base (RAG), Sentiment-aware responses & escalation, Analytics: resolution rate, CSAT impact, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Customer Support Agent</h1>
        <p className="text-lg text-slate-300 mb-8">Fully automated 24/7 customer support using RAG + LLMs: answer FAQs, troubleshoot issues, process returns, and escalate complex tickets with context handoff.</p>
        ...
        <li class="text-slate-300">Integrations: Zendesk, Intercom, Salesforce</li>
        <li class="text-slate-300">Document retrieval from knowledge base (RAG)</li>
        <li class="text-slate-300">Sentiment-aware responses &amp; escalation</li>
        <li class="text-slate-300">Analytics: resolution rate, CSAT impact</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai customer support agent</li>
