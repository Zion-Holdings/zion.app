...
export const metadata: Metadata = {
  title: 'Intelligent Insights for Logistics',
  description: 'Next-generation logistics solution: Intelligent Insights for Logistics. Combines audit trail management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-insights-for-logistics-8fe1a344',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Insights for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Intelligent Insights for Logistics. Combines audit trail management with adaptive intelligence for optimal results.
          </p>
