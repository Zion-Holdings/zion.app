...
export const metadata: Metadata = {
  title: 'Generator Next-Gen - TECHNOLOGY',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Generator Next-Gen - TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our Generator Next-Gen - TECHNOLOGY leverages advanced machine learning to deliver churn prediction at scale.
          </p>
