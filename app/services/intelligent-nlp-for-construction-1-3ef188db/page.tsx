...
export const metadata: Metadata = {
  title: 'Intelligent NLP for Construction #1',
  description: 'Enhance your construction business with Intelligent NLP for Construction #1. Our solution provides employee engagement with enterprise-grade reliability and sec',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-nlp-for-construction-1-3ef188db',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent NLP for Construction #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Intelligent NLP for Construction #1. Our solution provides employee engagement with enterprise-grade reliability and security.
          </p>
