...
export const metadata: Metadata = {
  ...
  description: 'Next-generation healthcare solution: Intelligent Analytics for Healthcare. Combines loyalty optimization with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-analytics-for-healthcare-0a417949',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Intelligent Analytics for Healthcare. Combines loyalty optimization with adaptive intelligence for optimal results.
          </p>
