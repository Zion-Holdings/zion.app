...
export const metadata: Metadata = {
  title: 'Smart Manager for Tech',
  description: 'Drive innovation in technology with Smart Manager for Tech. This AI-powered platform transforms audit trail management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-manager-for-tech-4d9646dd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manager for Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in technology with Smart Manager for Tech. This AI-powered platform transforms audit trail management into a competitive advantage.
          </p>
