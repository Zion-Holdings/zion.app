...
export const metadata: Metadata = {
  title: 'Enterprise Scenario Pipeline',
  description: 'Drive innovation in healthcare with Enterprise Scenario Pipeline. This AI-powered platform transforms budget optimization into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-scenario-pipeline-9306b09f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Scenario Pipeline
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with Enterprise Scenario Pipeline. This AI-powered platform transforms budget optimization into a competitive advantage.
          </p>
