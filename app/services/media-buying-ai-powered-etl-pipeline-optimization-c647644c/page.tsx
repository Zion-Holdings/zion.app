...
export const metadata: Metadata = {
  title: 'Media Buying AI-Powered ETL Pipeline Optimization',
  description: 'AI-powered media buying solution for data engineering. Automated ETL pipeline optimization and error recovery.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/media-buying-ai-powered-etl-pipeline-optimization-c647644c',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Media Buying AI-Powered ETL Pipeline Optimization
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered media buying solution for data engineering. Automated ETL pipeline optimization and error recovery.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your media buying operations?</p>
