      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Proactive threat detection using advanced AI behavioral analysis, anomaly detection, and automated incident response orchestration for enterprises under constant attack.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ 24/7 AI-powered threat hunting across network endpoints</li>
            <li className="text-purple-300">✓ Behavioral anomaly detection & zero-day identification</li>
            <li className="text-purple-300">✓ Automated incident response playbooks</li>
            <li className="text-purple-300">✓ Threat intelligence correlation & enrichment</li>
            <li className="text-purple-300">✓ Forensic analysis & root-cause reconstruction</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai cyber threat hunting & incident response</li>
