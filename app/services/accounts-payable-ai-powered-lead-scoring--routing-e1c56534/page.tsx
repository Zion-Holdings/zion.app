...
export const metadata: Metadata = {
  title: 'Accounts Payable AI-Powered Lead Scoring & Routing',
  description: 'AI-powered accounts payable solution for sales. Scores and routes sales leads in real-time based on engagement.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/accounts-payable-ai-powered-lead-scoring--routing-e1c56534',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Accounts Payable AI-Powered Lead Scoring & Routing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered accounts payable solution for sales. Scores and routes sales leads in real-time based on engagement.
          </p>
