...
export const metadata: Metadata = {
  title: 'Intelligent Process Mining for HEALTHTECH',
  description: 'Unlock unprecedented growth with Intelligent Process Mining for HEALTHTECH. This autonomous system provides territory management with zero manual intervention n',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-process-mining-for-healthtech-12e6df38',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Process Mining for HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Process Mining for HEALTHTECH. This autonomous system provides territory management with zero manual intervention needed.
          </p>
