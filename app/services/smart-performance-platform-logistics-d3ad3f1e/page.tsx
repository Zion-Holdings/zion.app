...
export const metadata: Metadata = {
  title: 'Smart Performance Platform - Logistics',
  description: 'Next-generation logistics solution: Smart Performance Platform - Logistics. Combines document processing with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-performance-platform-logistics-d3ad3f1e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Performance Platform - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Smart Performance Platform - Logistics. Combines document processing with adaptive intelligence for optimal results.
          </p>
