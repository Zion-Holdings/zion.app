...
export const metadata: Metadata = {
  title: 'Enterprise Workflow Platform - HEALTHTECH',
  description: 'Optimize your healthtech workflows with Enterprise Workflow Platform - HEALTHTECH. This intelligent platform delivers content generation through advanced automa',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Workflow Platform - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthtech workflows with Enterprise Workflow Platform - HEALTHTECH. This intelligent platform delivers content generation through advanced automation and AI.
          </p>
