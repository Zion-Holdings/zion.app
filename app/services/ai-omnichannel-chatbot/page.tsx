...
export const metadata: Metadata = {
  ...
  keywords: '20+ channel unified inbox, Shared conversation context per customer, Human handoff with full context preserved, Channel-consistent brand voice tuning, ai, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Omnichannel Chatbot Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Unified chatbot across 20+ channels: website WhatsApp Instagram SMS phone call Slack Teams. Shared conversation context handoff routing brand voice per channel.</p>
        ...
        <li class="text-slate-300">20+ channel unified inbox</li>
        <li class="text-slate-300">Shared conversation context per customer</li>
        <li class="text-slate-300">Human handoff with full context preserved</li>
        <li class="text-slate-300">Channel-consistent brand voice tuning</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai omnichannel chatbot platform</li>
