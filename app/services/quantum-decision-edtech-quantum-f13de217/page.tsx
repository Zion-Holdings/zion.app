...
export const metadata: Metadata = {
  title: 'Quantum Decision - EDTECH Quantum',
  description: 'Revolutionize edtech through intelligent automation. Our Quantum Decision - EDTECH Quantum leverages advanced machine learning to deliver record extraction at s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-decision-edtech-quantum-f13de217',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Decision - EDTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize edtech through intelligent automation. Our Quantum Decision - EDTECH Quantum leverages advanced machine learning to deliver record extraction at scale.
          </p>
