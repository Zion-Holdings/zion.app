...
export const metadata: Metadata = {
  title: 'Smart Support Platform - Hospitality',
  description: 'Quantum leap forward for hospitality: Smart Support Platform - Hospitality. Uses quantum-inspired algorithms to deliver compensation management at exponential s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-support-platform-hospitality-e9bc2722',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Support Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for hospitality: Smart Support Platform - Hospitality. Uses quantum-inspired algorithms to deliver compensation management at exponential speed.
          </p>
