...
export const metadata: Metadata = {
  title: 'Intelligent cognitive-finance',
  description: 'The future of finance is here with Intelligent cognitive-finance. Powered by cutting-edge AI, this platform delivers vendor management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-cognitive-finance-8cb0adab',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent cognitive-finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of finance is here with Intelligent cognitive-finance. Powered by cutting-edge AI, this platform delivers vendor management like never before.
          </p>
