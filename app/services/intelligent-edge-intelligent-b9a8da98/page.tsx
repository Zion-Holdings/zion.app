...
export const metadata: Metadata = {
  title: 'Intelligent Edge Intelligent',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Edge Intelligent
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your real-estate workflows with Intelligent Edge Intelligent. This intelligent platform delivers quality assurance through advanced automation and AI.
          </p>
