...
export const metadata: Metadata = {
  ...
  description: 'Enhance your sports business with Autonomous Engine for Sports. Our solution provides api management with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-engine-for-sports-b5cec0ec',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your sports business with Autonomous Engine for Sports. Our solution provides api management with enterprise-grade reliability and security.
          </p>
