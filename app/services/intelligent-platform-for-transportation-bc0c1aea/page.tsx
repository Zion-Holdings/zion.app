...
export const metadata: Metadata = {
  title: 'Intelligent Platform for Transportation',
  description: 'Unlock unprecedented growth with Intelligent Platform for Transportation. This autonomous system provides expense management with zero manual intervention neede',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-platform-for-transportation-bc0c1aea',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Platform for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Platform for Transportation. This autonomous system provides expense management with zero manual intervention needed.
          </p>
