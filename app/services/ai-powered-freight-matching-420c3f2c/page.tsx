...
export const metadata: Metadata = {
  title: "Service - AI-Powered Logistics Solution",
  description: "Matches shippers with carriers in real-time based on price, capacity, and delivery requirements.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-freight-matching-420c3f2c",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Service - AI-Powered Logistics Solution
        </h1>
