...
export const metadata: Metadata = {
  title: 'Automated Security Quality',
  description: 'Revolutionize construction through intelligent automation. Our Automated Security Quality leverages advanced machine learning to deliver sentiment analysis at s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Automated Security Quality leverages advanced machine learning to deliver sentiment analysis at scale.
          </p>
