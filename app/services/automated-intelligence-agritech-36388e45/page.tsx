...
export const metadata: Metadata = {
  title: 'Automated intelligence-agritech',
  description: 'Transform your agritech operations with our Automated intelligence-agritech. This AI-driven solution automates code optimization with unprecedented accuracy and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-intelligence-agritech-36388e45',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated intelligence-agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agritech operations with our Automated intelligence-agritech. This AI-driven solution automates code optimization with unprecedented accuracy and efficiency.
          </p>
