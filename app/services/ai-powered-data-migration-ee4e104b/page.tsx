...
export const metadata: Metadata = {
  title: 'AI-Powered Data Migration',
  description: 'Intelligent data migration planning and execution.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-data-migration-ee4e104b',
  },

export const metadata = {
  title: "AI-Powered Data Migration - Zion Tech Group",
  description: "Intelligent data migration planning and execution.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-data-migration-ee4e104b`
  }
  ...
  return (
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Intelligent data migration planning and execution.
          </p>
    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">AI-Powered Data Migration</h1>
        <p className="text-lg text-gray-300 mb-8">Intelligent data migration planning and execution.</p>
