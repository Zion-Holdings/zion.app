...
export const metadata: Metadata = {
  ...
  keywords: 'Personalized wellness plans, Mood tracking and journaling, CBT-based coping strategies, Stress level monitoring, Sleep quality insights, Crisis detection and escalation, Integration with Slack and Teams, Anonymous and confidential, ai, HR, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Mental Wellness Coach</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered mental wellness and resilience coaching for employees. Personalized coping strategies, mood tracking, and crisis support with human escalation paths.</p>
        ...
        <li class="text-slate-300">Personalized wellness plans</li>
        <li class="text-slate-300">Mood tracking and journaling</li>
        <li class="text-slate-300">CBT-based coping strategies</li>
        <li class="text-slate-300">Stress level monitoring</li>
        <li class="text-slate-300">Sleep quality insights</li>
        <li class="text-slate-300">Crisis detection and escalation</li>
        <li class="text-slate-300">Integration with Slack and Teams</li>
        <li class="text-slate-300">Anonymous and confidential</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce employee burnout by 30%</li>
        <li class="text-slate-300">Improve mental health support</li>
        <li class="text-slate-300">Confidential 24/7 support</li>
        <li class="text-slate-300">Reduce absenteeism</li>
      </ul>
        </div>
