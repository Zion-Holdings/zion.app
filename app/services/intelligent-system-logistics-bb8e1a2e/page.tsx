...
export const metadata: Metadata = {
  title: 'Intelligent system-logistics',
  description: 'Transform logistics with Intelligent system-logistics - the intelligent automation platform that learns, adapts, and delivers 10x results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-system-logistics-bb8e1a2e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent system-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform logistics with Intelligent system-logistics - the intelligent automation platform that learns, adapts, and delivers 10x results.
          </p>
