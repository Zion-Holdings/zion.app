...
export const metadata: Metadata = {
  title: 'AI System - Construction Edition',
  description: 'Enhance your construction business with AI System - Construction Edition. Our solution provides market analysis with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-system-construction-edition-dfd587b0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI System - Construction Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with AI System - Construction Edition. Our solution provides market analysis with enterprise-grade reliability and security.
          </p>
