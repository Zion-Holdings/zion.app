...
export const metadata: Metadata = {
  title: 'Enterprise data science-cleantech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise data science-cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation cleantech solution: Enterprise data science-cleantech. Combines performance tracking with adaptive intelligence for optimal results.
          </p>
