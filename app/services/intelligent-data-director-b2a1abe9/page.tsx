...
export const metadata: Metadata = {
  title: 'Intelligent Data Director',
  description: 'Revolutionize transportation through intelligent automation. Our Intelligent Data Director leverages advanced machine learning to deliver resource utilization a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-data-director-b2a1abe9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Data Director
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize transportation through intelligent automation. Our Intelligent Data Director leverages advanced machine learning to deliver resource utilization at scale.
          </p>
