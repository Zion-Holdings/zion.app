...
export const metadata: Metadata = {
  title: 'Intelligent Experience for Telecom #3',
  description: 'Enhance your telecom business with Intelligent Experience for Telecom #3. Our solution provides employee engagement with enterprise-grade reliability and securi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Experience for Telecom #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your telecom business with Intelligent Experience for Telecom #3. Our solution provides employee engagement with enterprise-grade reliability and security.
          </p>
