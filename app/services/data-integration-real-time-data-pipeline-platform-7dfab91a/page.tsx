...
export const metadata: Metadata = {
  title: 'Data Integration Real-Time Data Pipeline Platform',
  description: 'data integration solution for labor unions industry. Creates and manages real-time data pipelines with automated ETL and streaming analytics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-integration-real-time-data-pipeline-platform-7dfab91a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Integration Real-Time Data Pipeline Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            data integration solution for labor unions industry. Creates and manages real-time data pipelines with automated ETL and streaming analytics.
          </p>
