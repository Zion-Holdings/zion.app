...
export const metadata: Metadata = {
  ...
  keywords: '72-hour fire risk prediction, Satellite thermal hotspot detection, Vegetation dryness indexing, Evacuation route optimization, Real-time firefighter dispatch, Post-fire damage assessment, ai, Government, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Wildfire Risk Prediction &amp; Prevention</h1>
        <p className="text-lg text-slate-300 mb-8">Predict wildfire risk 72 hours ahead: satellite thermal imaging, weather pattern analysis, vegetation dryness indexing, and evacuation route optimization. Used by 30+ fire departments.</p>
        ...
        <li class="text-slate-300">72-hour fire risk prediction</li>
        <li class="text-slate-300">Satellite thermal hotspot detection</li>
        <li class="text-slate-300">Vegetation dryness indexing</li>
        <li class="text-slate-300">Evacuation route optimization</li>
        <li class="text-slate-300">Real-time firefighter dispatch</li>
        <li class="text-slate-300">Post-fire damage assessment</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">72-hour advance warning</li>
        <li class="text-slate-300">Reduce response time by 50%</li>
        <li class="text-slate-300">Save lives with smart evacuation</li>
      </ul>
        </div>
