...
export const metadata: Metadata = {
  title: 'Adaptive smart-healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Adaptive smart-healthcare leverages advanced machine learning to deliver anomaly detection at scale',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-smart-healthcare-5ffeda8b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive smart-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Adaptive smart-healthcare leverages advanced machine learning to deliver anomaly detection at scale.
          </p>
