...
export const metadata: Metadata = {
  title: 'AI-Powered Monitoring for Insurance',
  description: 'The future of insurance is here with AI-Powered Monitoring for Insurance. Powered by cutting-edge AI, this platform delivers quality control like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-monitoring-for-insurance-440ac130',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Monitoring for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with AI-Powered Monitoring for Insurance. Powered by cutting-edge AI, this platform delivers quality control like never before.
          </p>
