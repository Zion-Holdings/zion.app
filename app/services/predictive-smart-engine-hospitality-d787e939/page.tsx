...
export const metadata: Metadata = {
  title: 'Predictive Smart Engine - Hospitality',
  description: 'Optimize your hospitality workflows with Predictive Smart Engine - Hospitality. This intelligent platform delivers access management through advanced automation',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-smart-engine-hospitality-d787e939',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Smart Engine - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Predictive Smart Engine - Hospitality. This intelligent platform delivers access management through advanced automation and AI.
          </p>
