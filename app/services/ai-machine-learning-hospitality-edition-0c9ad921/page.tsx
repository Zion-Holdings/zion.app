...
export const metadata: Metadata = {
  title: 'AI Machine Learning - Hospitality Edition',
  description: 'The future of hospitality is here with AI Machine Learning - Hospitality Edition. Powered by cutting-edge AI, this platform delivers sourcing optimization like ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-machine-learning-hospitality-edition-0c9ad921',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Machine Learning - Hospitality Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with AI Machine Learning - Hospitality Edition. Powered by cutting-edge AI, this platform delivers sourcing optimization like never before.
          </p>
