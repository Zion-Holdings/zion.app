...
export const metadata: Metadata = {
  title: 'Engine Intelligent - Telecom',
  description: 'Transform your telecom operations with our Engine Intelligent - Telecom. This AI-driven solution automates scenario planning with unprecedented accuracy and eff',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/engine-intelligent-telecom-21639802',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Engine Intelligent - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your telecom operations with our Engine Intelligent - Telecom. This AI-driven solution automates scenario planning with unprecedented accuracy and efficiency.
          </p>
