...
export const metadata: Metadata = {
  title: 'Speech Analytics Intelligent Document Processing AI',
  description: 'speech analytics solution for warehousing industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatica',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/speech-analytics-intelligent-document-processing-ai-f93c07b0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Speech Analytics Intelligent Document Processing AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            speech analytics solution for warehousing industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.
          </p>
