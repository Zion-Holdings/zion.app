...
export const metadata: Metadata = {
  title: 'UiPath AI-Powered Inventory Optimization',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            UiPath AI-Powered Inventory Optimization
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered uipath solution for retail. Optimizes inventory levels using demand forecasting and machine learning.
          </p>
