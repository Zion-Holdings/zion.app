...
export const metadata: Metadata = {
  title: 'Adaptive insights-retail',
  description: 'Revolutionize retail through intelligent automation. Our Adaptive insights-retail leverages advanced machine learning to deliver enterprise-grade insights at sc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-insights-retail-f285ec98',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive insights-retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize retail through intelligent automation. Our Adaptive insights-retail leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
