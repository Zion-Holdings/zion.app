...
export const metadata: Metadata = {
  title: 'Smart Compliance Platform - PROPTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Compliance Platform - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation proptech solution: Smart Compliance Platform - PROPTECH. Combines customer journey mapping with adaptive intelligence for optimal results.
          </p>
