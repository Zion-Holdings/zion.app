...
export const metadata: Metadata = {
  ...
  keywords: 'PPE detection (hard hat, vest, gloves), Hazard zone monitoring, Incident prediction, Integration with security cameras, Real-time alerts to safety officers, Compliance reporting, Worker proximity alerts, Integration with Procore, Autodesk Build, construction-tech, Construction, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Construction Safety Monitoring</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered construction site safety. PPE detection, hazard identification, incident prediction, and compliance reporting with computer vision.</p>
        ...
        <li class="text-slate-300">PPE detection (hard hat, vest, gloves)</li>
        <li class="text-slate-300">Hazard zone monitoring</li>
        <li class="text-slate-300">Incident prediction</li>
        <li class="text-slate-300">Integration with security cameras</li>
        <li class="text-slate-300">Real-time alerts to safety officers</li>
        <li class="text-slate-300">Compliance reporting</li>
        <li class="text-slate-300">Worker proximity alerts</li>
        <li class="text-slate-300">Integration with Procore, Autodesk Build</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce safety incidents 50%</li>
        <li class="text-slate-300">Automated compliance</li>
        <li class="text-slate-300">Real-time hazard alerts</li>
        <li class="text-slate-300">Protect workers proactively</li>
      </ul>
        </div>
