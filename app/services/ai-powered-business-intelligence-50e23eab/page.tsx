...
export const metadata: Metadata = {
  title: "AI-Powered Business Intelligence - AI-Powered BI Solution",
  description: "Automated BI report generation and insight discovery.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-business-intelligence-50e23eab",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Business Intelligence - AI-Powered BI Solution
        </h1>
