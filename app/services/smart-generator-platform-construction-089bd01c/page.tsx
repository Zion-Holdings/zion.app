...
export const metadata: Metadata = {
  title: 'Smart Generator Platform - Construction',
  description: 'Drive innovation in construction with Smart Generator Platform - Construction. This AI-powered platform transforms healthcare data analytics into a competitive ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-generator-platform-construction-089bd01c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Generator Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Smart Generator Platform - Construction. This AI-powered platform transforms healthcare data analytics into a competitive advantage.
          </p>
