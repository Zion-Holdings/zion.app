...
export const metadata: Metadata = {
  title: 'Open Data Zero-Trust Identity & Access Manager',
  description: 'AI-powered open data solution for enterprise security. Implements zero-trust security architecture with continuous authentication and adaptive access controls.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/open-data-zero-trust-identity--access-manager-e10b5f41',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Open Data Zero-Trust Identity & Access Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered open data solution for enterprise security. Implements zero-trust security architecture with continuous authentication and adaptive access controls.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your open data operations?</p>
