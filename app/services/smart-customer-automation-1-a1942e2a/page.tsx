...
export const metadata: Metadata = {
  title: 'Smart Customer Automation #1',
  description: 'Enhance your hospitality business with Smart Customer Automation #1. Our solution provides maintenance scheduling with enterprise-grade reliability and security',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-customer-automation-1-a1942e2a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Customer Automation #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Smart Customer Automation #1. Our solution provides maintenance scheduling with enterprise-grade reliability and security.
          </p>
