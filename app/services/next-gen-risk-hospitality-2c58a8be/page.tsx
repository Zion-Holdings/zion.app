...
export const metadata: Metadata = {
  title: 'Next-Gen Risk - Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Next-Gen Risk - Hospitality leverages advanced machine learning to deliver upsell identification a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Risk - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Next-Gen Risk - Hospitality leverages advanced machine learning to deliver upsell identification at scale.
          </p>
