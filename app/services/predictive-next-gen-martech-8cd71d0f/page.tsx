...
export const metadata: Metadata = {
  title: 'Predictive Next-Gen - MARTECH',
  description: 'Enhance your martech business with Predictive Next-Gen - MARTECH. Our solution provides logistics route optimization with enterprise-grade reliability and secur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-next-gen-martech-8cd71d0f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Next-Gen - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your martech business with Predictive Next-Gen - MARTECH. Our solution provides logistics route optimization with enterprise-grade reliability and security.
          </p>
