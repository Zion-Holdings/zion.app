...
export const metadata: Metadata = {
  title: 'Intelligent Optimizer for Construction',
  description: 'Drive innovation in construction with Intelligent Optimizer for Construction. This AI-powered platform transforms sourcing optimization into a competitive advan',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-optimizer-for-construction-3e58c40f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Optimizer for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Intelligent Optimizer for Construction. This AI-powered platform transforms sourcing optimization into a competitive advantage.
          </p>
