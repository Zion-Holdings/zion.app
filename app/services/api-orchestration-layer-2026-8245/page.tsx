...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "API Orchestration Layer | Zion Tech Group", description: "End-to-end api orchestration layer services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/api-orchestration-layer-2026-8245/"}} />
