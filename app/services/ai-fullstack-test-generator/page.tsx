...
export const metadata: Metadata = {
  ...
  keywords: 'Source + schema + OpenAPI ingestion, Unit + integration + E2E auto-gen, 90%+ line coverage without manual writing, CI/CD pipeline + flaky test auto-retry, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Full-Stack Test Generator</h1>
        <p className="text-lg text-slate-300 mb-8">Reads source code + OpenAPI + DB schema produces unit + integration + E2E tests: React/Vue component API endpoint DB constraint auth flow 90%+ coverage.</p>
        ...
        <li class="text-slate-300">Source + schema + OpenAPI ingestion</li>
        <li class="text-slate-300">Unit + integration + E2E auto-gen</li>
        <li class="text-slate-300">90%+ line coverage without manual writing</li>
        <li class="text-slate-300">CI/CD pipeline + flaky test auto-retry</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai full-stack test generator</li>
