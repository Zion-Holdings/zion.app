      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Reads source code + OpenAPI + DB schema produces unit + integration + E2E tests: React/Vue component API endpoint DB constraint auth flow 90%+ coverage.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Source + schema + OpenAPI ingestion</li>
            <li className="text-purple-300">✓ Unit + integration + E2E auto-gen</li>
            <li className="text-purple-300">✓ 90%+ line coverage without manual writing</li>
            <li className="text-purple-300">✓ CI/CD pipeline + flaky test auto-retry</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai full-stack test generator</li>
