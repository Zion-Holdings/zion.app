...
export const metadata: Metadata = {
  title: 'Cognitive Supply Solution - Media',
  description: 'Next-generation media solution: Cognitive Supply Solution - Media. Combines process automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-supply-solution-media-21b93f10',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Supply Solution - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation media solution: Cognitive Supply Solution - Media. Combines process automation with adaptive intelligence for optimal results.
          </p>
