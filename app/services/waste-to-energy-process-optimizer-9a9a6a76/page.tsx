...
export const metadata: Metadata = {
  title: 'Waste-to-Energy Process Optimizer',
  description: 'Optimizes waste-to-energy plants with predictive maintenance and yield optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/waste-to-energy-process-optimizer-9a9a6a76',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Waste-to-Energy Process Optimizer
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimizes waste-to-energy plants with predictive maintenance and yield optimization.
          </p>
