...
export const metadata = {
  ...
  description: "AI-powered site search with natural language understanding, typo tolerance, faceted filters, and merchandising rules. Replaces Algolia/Elastic with smarter sear",
  alternates: {
