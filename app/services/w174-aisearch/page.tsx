...
export const metadata: Metadata = {
  ...
  keywords: 'Natural language query understanding, Typo tolerance and synonym expansion, Faceted filtering and sorting, Merchandising and boosting rules, Click and conversion analytics, Recommendations from search behavior, JavaScript SDK and API, micro-saas, E-Commerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AISearch — Site Search Intelligence</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered site search with natural language understanding, typo tolerance, faceted filters, and merchandising rules. Replaces Algolia/Elastic with smarter search.</p>
        ...
        <li class="text-slate-300">Typo tolerance and synonym expansion</li>
        <li class="text-slate-300">Faceted filtering and sorting</li>
        <li class="text-slate-300">Merchandising and boosting rules</li>
        <li class="text-slate-300">Click and conversion analytics</li>
        <li class="text-slate-300">Recommendations from search behavior</li>
        <li class="text-slate-300">JavaScript SDK and API</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Users find what they want 3x faster</li>
        <li class="text-slate-300">NL queries reduce zero-result searches</li>
        <li class="text-slate-300">Merchandising rules drive revenue</li>
        <li class="text-slate-300">Search analytics reveal intent patterns</li>
      </ul>
        </div>
