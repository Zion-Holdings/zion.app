...
export const metadata: Metadata = {
  title: 'Intelligent Performance for Telecom',
  description: 'Next-generation telecom solution: Intelligent Performance for Telecom. Combines scalability planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-performance-for-telecom-a8565e8e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Performance for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation telecom solution: Intelligent Performance for Telecom. Combines scalability planning with adaptive intelligence for optimal results.
          </p>
