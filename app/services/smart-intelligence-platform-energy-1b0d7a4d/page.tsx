...
export const metadata: Metadata = {
  title: 'Smart Intelligence Platform - Energy',
  description: 'Optimize your energy workflows with Smart Intelligence Platform - Energy. This intelligent platform delivers feedback collection through advanced automation and',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Intelligence Platform - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your energy workflows with Smart Intelligence Platform - Energy. This intelligent platform delivers feedback collection through advanced automation and AI.
          </p>
