...
export const metadata: Metadata = {
  title: 'AI NLP - Hospitality Edition',
  description: 'Enhance your hospitality business with AI NLP - Hospitality Edition. Our solution provides decision support with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-nlp-hospitality-edition-bd610c86',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI NLP - Hospitality Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with AI NLP - Hospitality Edition. Our solution provides decision support with enterprise-grade reliability and security.
          </p>
