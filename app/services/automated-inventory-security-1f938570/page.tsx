...
export const metadata: Metadata = {
  title: 'Automated Inventory Security',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with Automated Inventory Security. This AI-powered platform transforms resource optimization into a competitive advantage.
          </p>
