...
export const metadata: Metadata = {
  title: 'Cognitive Predictive Solution - Hospitality',
  description: 'Future-proof your hospitality with Cognitive Predictive Solution - Hospitality. Our autonomous solution handles resource optimization end-to-end without human i',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Predictive Solution - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your hospitality with Cognitive Predictive Solution - Hospitality. Our autonomous solution handles resource optimization end-to-end without human intervention.
          </p>
