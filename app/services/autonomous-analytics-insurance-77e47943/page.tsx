...
export const metadata: Metadata = {
  title: 'Autonomous analytics-insurance',
  description: 'Drive innovation in insurance with Autonomous analytics-insurance. This AI-powered platform transforms record processing into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-analytics-insurance-77e47943',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous analytics-insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Autonomous analytics-insurance. This AI-powered platform transforms record processing into a competitive advantage.
          </p>
