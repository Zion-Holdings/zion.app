...
export const metadata: Metadata = {
  title: 'Predictive Suite for Agriculture',
  description: 'The future of agriculture is here with Predictive Suite for Agriculture. Powered by cutting-edge AI, this platform delivers fraud prevention like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-suite-for-agriculture-4c938b89',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Suite for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Predictive Suite for Agriculture. Powered by cutting-edge AI, this platform delivers fraud prevention like never before.
          </p>
