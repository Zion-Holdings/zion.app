...
export const metadata: Metadata = {
  title: 'Data Autonomous - Media',
  description: 'The future of media is here with Data Autonomous - Media. Powered by cutting-edge AI, this platform delivers compliance monitoring like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-autonomous---media-08dacf5d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Autonomous - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of media is here with Data Autonomous - Media. Powered by cutting-edge AI, this platform delivers compliance monitoring like never before.
          </p>
