...
export const metadata: Metadata = {
  title: 'Smart Finance Platform - Hospitality',
  description: 'Enhance your hospitality business with Smart Finance Platform - Hospitality. Our solution provides project management with enterprise-grade reliability and secu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-finance-platform-hospitality-9e086450',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Finance Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Smart Finance Platform - Hospitality. Our solution provides project management with enterprise-grade reliability and security.
          </p>
