...
export const metadata: Metadata = {
  ...
  keywords: 'Automated cross-region replication, RTO/RPO testing dashboard, VM & DB & container backup, One-click failover drills, Air-gapped backup storage, cloud, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Automated backup, cross-region replication, and RTO/RPO-tested failover orchestration for VMs, databases, and containers across clouds.</p>
        ...
        <li class="text-slate-300">Automated cross-region replication</li>
        <li class="text-slate-300">RTO/RPO testing dashboard</li>
        <li class="text-slate-300">VM &amp; DB &amp; container backup</li>
        <li class="text-slate-300">One-click failover drills</li>
        <li class="text-slate-300">Air-gapped backup storage</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with disaster recovery platform</li>
