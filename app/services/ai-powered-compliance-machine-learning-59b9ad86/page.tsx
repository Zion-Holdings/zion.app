...
export const metadata: Metadata = {
  title: 'AI-Powered Compliance Machine Learning',
  description: 'Transform your telecom operations with our AI-Powered Compliance Machine Learning. This AI-driven solution automates process discovery with unprecedented accura',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Compliance Machine Learning
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your telecom operations with our AI-Powered Compliance Machine Learning. This AI-driven solution automates process discovery with unprecedented accuracy and efficiency.
          </p>
