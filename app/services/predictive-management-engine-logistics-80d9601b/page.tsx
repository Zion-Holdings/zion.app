...
export const metadata: Metadata = {
  title: 'Predictive Management Engine - Logistics',
  description: 'Enhance your logistics business with Predictive Management Engine - Logistics. Our solution provides user provisioning with enterprise-grade reliability and sec',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-management-engine-logistics-80d9601b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Management Engine - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with Predictive Management Engine - Logistics. Our solution provides user provisioning with enterprise-grade reliability and security.
          </p>
