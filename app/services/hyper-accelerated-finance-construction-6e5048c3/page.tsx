...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Finance - Construction',
  description: 'Drive innovation in construction with Hyper-Accelerated Finance - Construction. This AI-powered platform transforms email automation into a competitive advantag',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Finance - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Hyper-Accelerated Finance - Construction. This AI-powered platform transforms email automation into a competitive advantage.
          </p>
