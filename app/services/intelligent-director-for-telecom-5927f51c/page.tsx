...
export const metadata: Metadata = {
  title: 'Intelligent Director for Telecom',
  description: 'Drive innovation in telecom with Intelligent Director for Telecom. This AI-powered platform transforms campaign optimization into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-director-for-telecom-5927f51c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Director for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in telecom with Intelligent Director for Telecom. This AI-powered platform transforms campaign optimization into a competitive advantage.
          </p>
