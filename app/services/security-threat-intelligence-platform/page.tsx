...
export const metadata: Metadata = {
  ...
  keywords: '5000+ IOC feed (IP/Domain/URL/Hash), MITRE ATT&CK technique coverage matrix, Auto-generate SIEM rule per new IOC, TI enrichment API for alert enrichment pipeline, security, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Threat Intelligence Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Curated IOC/IOA feed, TI graph, MITRE ATT&amp;CK mapping, automated SIEM rule generation, and TI alert enrichment pipeline.</p>
        ...
        <li class="text-slate-300">5000+ IOC feed (IP/Domain/URL/Hash)</li>
        <li class="text-slate-300">MITRE ATT&amp;CK technique coverage matrix</li>
        <li class="text-slate-300">Auto-generate SIEM rule per new IOC</li>
        <li class="text-slate-300">TI enrichment API for alert enrichment pipeline</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with threat intelligence platform</li>
