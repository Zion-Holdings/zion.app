...
export const metadata: Metadata = {
  title: 'Autonomous Supply System - Retail',
  description: 'Enhance your retail business with Autonomous Supply System - Retail. Our solution provides lead scoring with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-supply-system-retail-c382ee8d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Supply System - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your retail business with Autonomous Supply System - Retail. Our solution provides lead scoring with enterprise-grade reliability and security.
          </p>
