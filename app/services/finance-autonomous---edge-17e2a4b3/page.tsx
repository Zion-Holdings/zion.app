      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Finance Autonomous - Edge
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Finance Autonomous - Edge. This autonomous system provides inventory management with zero manual intervention needed.
          </p>
