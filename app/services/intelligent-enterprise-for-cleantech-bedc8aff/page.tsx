...
export const metadata: Metadata = {
  ...
  description: 'Enhance your cleantech business with Intelligent Enterprise for CLEANTECH. Our solution provides executive dashboards with enterprise-grade reliability and secu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your cleantech business with Intelligent Enterprise for CLEANTECH. Our solution provides executive dashboards with enterprise-grade reliability and security.
          </p>
