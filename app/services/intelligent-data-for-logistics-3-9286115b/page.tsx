...
export const metadata: Metadata = {
  title: 'Intelligent Data for Logistics #3',
  description: 'Enhance your logistics business with Intelligent Data for Logistics #3. Our solution provides user experience with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-data-for-logistics-3-9286115b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Data for Logistics #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with Intelligent Data for Logistics #3. Our solution provides user experience with enterprise-grade reliability and security.
          </p>
