...
export const metadata: Metadata = {
  title: 'Automated performance-healthcare',
  description: 'The future of healthcare is here with Automated performance-healthcare. Powered by cutting-edge AI, this platform delivers executive dashboards like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-performance-healthcare-6fddff62',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated performance-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Automated performance-healthcare. Powered by cutting-edge AI, this platform delivers executive dashboards like never before.
          </p>
