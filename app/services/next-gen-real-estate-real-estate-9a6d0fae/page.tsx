...
export const metadata: Metadata = {
  title: 'Next-Gen real estate-real-estate',
  description: 'Next-generation real-estate solution: Next-Gen real estate-real-estate. Combines lead scoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-real-estate-real-estate-9a6d0fae',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen real estate-real-estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation real-estate solution: Next-Gen real estate-real-estate. Combines lead scoring with adaptive intelligence for optimal results.
          </p>
