...
export const metadata: Metadata = {
  title: 'Smart Generator for Hospitality',
  description: 'Transform your hospitality operations with our Smart Generator for Hospitality. This AI-driven solution automates data processing with unprecedented accuracy an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-generator-for-hospitality-4b79907a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Generator for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Smart Generator for Hospitality. This AI-driven solution automates data processing with unprecedented accuracy and efficiency.
          </p>
