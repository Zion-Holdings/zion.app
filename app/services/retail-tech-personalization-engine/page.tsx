...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time product recommendations, Dynamic pricing optimization, Customer segmentation, Omnichannel orchestration, A/B testing framework, Integration with Shopify, WooCommerce, Inventory-aware recommendations, Analytics dashboard, retail-tech, Retail, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Hyper-personalized shopping experiences. Product recommendations, dynamic pricing, customer segmentation, and omnichannel orchestration.</p>
        ...
        <li class="text-slate-300">Omnichannel orchestration</li>
        <li class="text-slate-300">A/B testing framework</li>
        <li class="text-slate-300">Integration with Shopify, WooCommerce</li>
        <li class="text-slate-300">Inventory-aware recommendations</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Increase conversion 35%</li>
        <li class="text-slate-300">Boost average order value</li>
        <li class="text-slate-300">Personalize at scale</li>
        <li class="text-slate-300">Unify online and offline</li>
      </ul>
        </div>
