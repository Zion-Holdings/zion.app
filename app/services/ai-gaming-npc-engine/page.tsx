...
export const metadata: Metadata = {
  ...
  keywords: 'AI personality & dialogue generation, Emotion state machines, Procedural quest generation, Multi-language voice synthesis, Unity & Unreal SDKs, Behavior tree editor, ai, Gaming & Entertainment, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI NPC &amp; Game Character Engine</h1>
        <p className="text-lg text-slate-300 mb-8">Procedural NPC generation for games: AI-driven dialogue, personality modeling, emotion state machines, and dynamic quest generation. Unity + Unreal integration.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">ai</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">Gaming &amp; Entertainment</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">AI personality &amp; dialogue generation</li>
        <li class="text-slate-300">Emotion state machines</li>
        <li class="text-slate-300">Procedural quest generation</li>
        <li class="text-slate-300">Multi-language voice synthesis</li>
        <li class="text-slate-300">Unity &amp; Unreal SDKs</li>
        <li class="text-slate-300">Behavior tree editor</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Create infinite unique NPCs</li>
        <li class="text-slate-300">Players feel real connections</li>
        <li class="text-slate-300">Cut character dev time by 80%</li>
      </ul>
        </div>
