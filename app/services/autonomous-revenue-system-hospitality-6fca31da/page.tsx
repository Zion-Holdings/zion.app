...
export const metadata: Metadata = {
  ...
  description: 'Enhance your hospitality business with Autonomous Revenue System - Hospitality. Our solution provides regulatory tracking with enterprise-grade reliability and ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Autonomous Revenue System - Hospitality. Our solution provides regulatory tracking with enterprise-grade reliability and security.
          </p>
