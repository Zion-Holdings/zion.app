...
export const metadata: Metadata = {
  title: 'Cognitive Net Platform',
  description: 'Next-generation technology solution: Cognitive Net Platform. Combines document ai with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-net-platform-b14d4bbf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Net Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation technology solution: Cognitive Net Platform. Combines document ai with adaptive intelligence for optimal results.
          </p>
