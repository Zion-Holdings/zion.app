...
export const metadata: Metadata = {
  title: 'Smart Business Intelligence Platform - Logistics',
  description: 'Next-generation logistics solution: Smart Business Intelligence Platform - Logistics. Combines container orchestration with adaptive intelligence for optimal re',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-business-intelligence-platform-logistics-252f9326',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Business Intelligence Platform - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Smart Business Intelligence Platform - Logistics. Combines container orchestration with adaptive intelligence for optimal results.
          </p>
