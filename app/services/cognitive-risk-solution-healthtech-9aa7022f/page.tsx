...
export const metadata: Metadata = {
  title: 'Cognitive Risk Solution - HEALTHTECH',
  description: 'Transform your healthtech operations with our Cognitive Risk Solution - HEALTHTECH. This AI-driven solution automates language processing with unprecedented acc',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Risk Solution - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthtech operations with our Cognitive Risk Solution - HEALTHTECH. This AI-driven solution automates language processing with unprecedented accuracy and efficiency.
          </p>
