...
export const metadata: Metadata = {
  title: 'Smart Quality Suite - Tech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Quality Suite - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your technology with Smart Quality Suite - Tech. Our autonomous solution handles market intelligence end-to-end without human intervention.
          </p>
