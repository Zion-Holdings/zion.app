...
export const metadata: Metadata = {
  title: 'Smart Compliance Platform - Telecom',
  description: 'Drive innovation in telecom with Smart Compliance Platform - Telecom. This AI-powered platform transforms account planning into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-compliance-platform-telecom-16463b95',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Compliance Platform - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in telecom with Smart Compliance Platform - Telecom. This AI-powered platform transforms account planning into a competitive advantage.
          </p>
