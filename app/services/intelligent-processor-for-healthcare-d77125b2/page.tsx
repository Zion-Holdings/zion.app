...
export const metadata: Metadata = {
  title: 'Intelligent Processor for Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Intelligent Processor for Healthcare leverages advanced machine learning to deliver supply chain at',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-processor-for-healthcare-d77125b2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Processor for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Intelligent Processor for Healthcare leverages advanced machine learning to deliver supply chain at scale.
          </p>
