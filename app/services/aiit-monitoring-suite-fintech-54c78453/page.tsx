...
export const metadata: Metadata = {
  title: 'AI/IT Monitoring Suite - FINTECH',
  description: 'The future of fintech is here with AI/IT Monitoring Suite - FINTECH. Powered by cutting-edge AI, this platform delivers document processing like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-monitoring-suite-fintech-54c78453',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Monitoring Suite - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of fintech is here with AI/IT Monitoring Suite - FINTECH. Powered by cutting-edge AI, this platform delivers document processing like never before.
          </p>
