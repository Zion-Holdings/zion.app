...
export const metadata: Metadata = {
  title: 'AI Intelligence - Proptech Edition',
  description: 'Revolutionize proptech through intelligent automation. Our AI Intelligence - Proptech Edition leverages advanced machine learning to deliver predictive analytic',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-intelligence---proptech-edition-56e54c23',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Intelligence - Proptech Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our AI Intelligence - Proptech Edition leverages advanced machine learning to deliver predictive analytics at scale.
          </p>
