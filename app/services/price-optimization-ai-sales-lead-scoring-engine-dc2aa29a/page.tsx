...
export const metadata: Metadata = {
  title: 'Price Optimization AI Sales Lead Scoring Engine',
  description: 'price optimization solution for smart city industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/price-optimization-ai-sales-lead-scoring-engine-dc2aa29a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Price Optimization AI Sales Lead Scoring Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            price optimization solution for smart city industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.
          </p>
