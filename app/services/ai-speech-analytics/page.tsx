...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time transcription, Sentiment analysis, Topic and keyword detection, Compliance monitoring, Agent coaching insights, Integration with Twilio, Genesys, Custom vocabulary, Call summarization, ai, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Speech Analytics Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Analyze customer calls with AI. Sentiment analysis, topic detection, compliance monitoring, and agent coaching insights.</p>
        ...
        <li class="text-slate-300">Topic and keyword detection</li>
        <li class="text-slate-300">Compliance monitoring</li>
        <li class="text-slate-300">Agent coaching insights</li>
        <li class="text-slate-300">Integration with Twilio, Genesys</li>
        <li class="text-slate-300">Custom vocabulary</li>
        <li class="text-slate-300">Call summarization</li>
      </ul>
        </div>
        ...
        <li class="text-slate-300">Coach agents effectively</li>
        <li class="text-slate-300">Automate call review</li>
      </ul>
        </div>
