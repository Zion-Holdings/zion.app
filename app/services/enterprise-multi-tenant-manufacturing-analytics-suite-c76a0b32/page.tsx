...
export const metadata = {
  title: "Enterprise Multi-Tenant Manufacturing Analytics Suite - Zion Tech Group",
  description: "Enterprise analytics suite that delivers multi-tenant manufacturing insights with unified dashboards and reporting.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/enterprise-multi-tenant-manufacturing-analytics-suite-c76a0b32`
  }
};
