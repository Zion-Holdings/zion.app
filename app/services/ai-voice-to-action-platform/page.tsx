...
export const metadata: Metadata = {
  ...
  keywords: 'ASR (Whisper/Deepgram) multi-language, Intent extraction + slot-filling via LLM, Connector library (calendar/CRM/ticketing), Privacy-first: on-prem ASR + LLM option, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Voice-to-Action Platform</h1>
        <p className="text-lg text-slate-300 mb-8">ASR (speech-to-text) + LLM intent extraction + action execution: schedule meetings, create tickets, run queries — all via natural voice.</p>
        ...
        <li class="text-slate-300">ASR (Whisper/Deepgram) multi-language</li>
        <li class="text-slate-300">Intent extraction + slot-filling via LLM</li>
        <li class="text-slate-300">Connector library (calendar/CRM/ticketing)</li>
        <li class="text-slate-300">Privacy-first: on-prem ASR + LLM option</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with voice-to-action platform</li>
