...
export const metadata: Metadata = {
  title: 'Adaptive platform-tech #2',
  description: 'Transform your technology operations with our Adaptive platform-tech #2. This AI-driven solution automates supply chain with unprecedented accuracy and efficien',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive platform-tech #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your technology operations with our Adaptive platform-tech #2. This AI-driven solution automates supply chain with unprecedented accuracy and efficiency.
          </p>
