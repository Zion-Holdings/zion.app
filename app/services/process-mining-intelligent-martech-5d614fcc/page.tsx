...
export const metadata: Metadata = {
  title: 'Process Mining Intelligent - MARTECH',
  description: 'Next-generation martech solution: Process Mining Intelligent - MARTECH. Combines sustainability tracking with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/process-mining-intelligent-martech-5d614fcc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Process Mining Intelligent - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation martech solution: Process Mining Intelligent - MARTECH. Combines sustainability tracking with adaptive intelligence for optimal results.
          </p>
