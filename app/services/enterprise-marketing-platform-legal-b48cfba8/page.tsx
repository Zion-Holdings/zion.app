...
export const metadata: Metadata = {
  title: 'Enterprise Marketing Platform - Legal',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Marketing Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Enterprise Marketing Platform - Legal. This AI-powered platform transforms onboarding automation into a competitive advantage.
          </p>
