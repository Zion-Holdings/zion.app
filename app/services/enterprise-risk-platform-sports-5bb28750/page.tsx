...
export const metadata: Metadata = {
  title: 'Enterprise Risk Platform - Sports',
  description: 'Hyper-accelerated sports solution: Enterprise Risk Platform - Sports. Combines neural architecture with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-risk-platform-sports-5bb28750',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Risk Platform - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated sports solution: Enterprise Risk Platform - Sports. Combines neural architecture with next-gen AI for maximum velocity.
          </p>
