...
export const metadata: Metadata = {
  title: 'Intelligent Finance for Manufacturing',
  description: 'The future of manufacturing is here with Intelligent Finance for Manufacturing. Powered by cutting-edge AI, this platform delivers business continuity like neve',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-finance-for-manufacturing-9bd63c6d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Finance for Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of manufacturing is here with Intelligent Finance for Manufacturing. Powered by cutting-edge AI, this platform delivers business continuity like never before.
          </p>
