...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-channel product sync for Amazon, Shopify, eBay, Etsy — bidirectional per SKU, Inventory sync across channels — stock depletion reflected across every marketplace in 60 seconds, Dropship workflow — auto-route orders to supplier per stock-level threshold, Auto-review generator sends per-buyer review request post-delivery with personalised template, Return and refund auto-process — auto-compute refund amount and inventory return per policy, Carrier shipping auto-label — auto-chooses cheapest carrier per weight and destination, automation, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Integrated Commerce Automation</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end e-commerce automation: product sync per multi-marketplace including Amazon, Shopify, eBay, and Etsy; inventory sync; order and workflow routing; auto-generated review request post-delivery; shipping and delivery auto-tracking; refund and return auto-processing.</p>
        ...
        <li class="text-slate-300">Multi-channel product sync for Amazon, Shopify, eBay, Etsy — bidirectional per SKU</li>
        <li class="text-slate-300">Inventory sync across channels — stock depletion reflected across every marketplace in 60 seconds</li>
        <li class="text-slate-300">Dropship workflow — auto-route orders to supplier per stock-level threshold</li>
        <li class="text-slate-300">Auto-review generator sends per-buyer review request post-delivery with personalised template</li>
        <li class="text-slate-300">Return and refund auto-process — auto-compute refund amount and inventory return per policy</li>
        <li class="text-slate-300">Carrier shipping auto-label — auto-chooses cheapest carrier per weight and destination</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with integrated commerce automation</li>
