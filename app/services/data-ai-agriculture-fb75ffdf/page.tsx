...
export const metadata: Metadata = {
  title: 'Data AI - Agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Data AI - Agriculture leverages advanced machine learning to deliver decision support at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-ai-agriculture-fb75ffdf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Data AI - Agriculture leverages advanced machine learning to deliver decision support at scale.
          </p>
