...
export const metadata: Metadata = {
  ...
  keywords: 'Per-query and per-table cost tracing, AI rightsizing recommendations, Materialised view recommendations, Tag-based cost governance, Chargeback and showback exports, data, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Data Cost Governance &amp; FinOps</h1>
        <p className="text-lg text-slate-300 mb-8">Track per-table, per-query cloud data spend. AI recommends materialised views, query optimisation, and warehouse right-sizing to lower your bill by 20-40%.</p>
        ...
        <li class="text-slate-300">Per-query and per-table cost tracing</li>
        <li class="text-slate-300">AI rightsizing recommendations</li>
        <li class="text-slate-300">Materialised view recommendations</li>
        <li class="text-slate-300">Tag-based cost governance</li>
        <li class="text-slate-300">Chargeback and showback exports</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with data cost governance &amp; finops</li>
