...
export const metadata: Metadata = {
  title: 'Knowledge AI - Retail',
  description: 'Quantum leap forward for retail: Knowledge AI - Retail. Uses quantum-inspired algorithms to deliver social media automation at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/knowledge-ai-retail-a470825a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for retail: Knowledge AI - Retail. Uses quantum-inspired algorithms to deliver social media automation at exponential speed.
          </p>
