...
export const metadata: Metadata = {
  title: 'Smart Manager Platform - Logistics #2',
  description: 'Transform your logistics operations with our Smart Manager Platform - Logistics #2. This AI-driven solution automates budget tracking with unprecedented accurac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-manager-platform-logistics-2-f390084b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manager Platform - Logistics #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Smart Manager Platform - Logistics #2. This AI-driven solution automates budget tracking with unprecedented accuracy and efficiency.
          </p>
