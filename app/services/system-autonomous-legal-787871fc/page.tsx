...
export const metadata: Metadata = {
  title: 'System Autonomous - Legal',
  description: 'Transform your legal operations with our System Autonomous - Legal. This AI-driven solution automates audit trail management with unprecedented accuracy and eff',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/system-autonomous-legal-787871fc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            System Autonomous - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our System Autonomous - Legal. This AI-driven solution automates audit trail management with unprecedented accuracy and efficiency.
          </p>
