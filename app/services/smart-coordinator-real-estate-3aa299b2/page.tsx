...
export const metadata: Metadata = {
  title: 'Smart coordinator-real-estate',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation real-estate solution: Smart coordinator-real-estate. Combines risk assessment with adaptive intelligence for optimal results.
          </p>
