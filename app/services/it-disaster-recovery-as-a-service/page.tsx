...
export const metadata: Metadata = {
  ...
  keywords: 'Continuous data replication with sub-minute RPO, Automated failover and failback orchestration, DR runbook automation with one-click execution, Regular DR testing without production impact, Multi-region and multi-cloud DR topologies, Compliance documentation (SOC 2, HIPAA, ISO 27001), Real-time DR health monitoring and alerting, Dedicated DR environment with warm standby, it, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Disaster Recovery as a Service (DRaaS)</h1>
        <p className="text-lg text-slate-300 mb-8">Enterprise disaster recovery solution with automated failover, continuous data replication, and sub-minute RTO/RPO. Includes runbook automation, regular DR testing, and compliance documentation.</p>
        ...
        <li class="text-slate-300">Continuous data replication with sub-minute RPO</li>
        <li class="text-slate-300">Automated failover and failback orchestration</li>
        <li class="text-slate-300">DR runbook automation with one-click execution</li>
        <li class="text-slate-300">Regular DR testing without production impact</li>
        <li class="text-slate-300">Multi-region and multi-cloud DR topologies</li>
        <li class="text-slate-300">Compliance documentation (SOC 2, HIPAA, ISO 27001)</li>
        <li class="text-slate-300">Real-time DR health monitoring and alerting</li>
        <li class="text-slate-300">Dedicated DR environment with warm standby</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Achieve sub-minute RTO for critical applications</li>
        <li class="text-slate-300">Eliminate manual DR testing with automated runs</li>
        <li class="text-slate-300">Meet compliance requirements with documented DR</li>
        <li class="text-slate-300">Reduce DR costs by 60% vs. traditional hot sites</li>
      </ul>
        </div>
