...
export const metadata = {
  ...
  description: 'End-to-end ai support quality assurance: score tickets, detect escalations, and coach agents services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/ai-support-quality-assurance-score-tickets-detect-escalations-and-coach-agents-28/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">AI Support Quality Assurance: Score Tickets, Detect Escalations, and Coach Agents</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end ai support quality assurance: score tickets, detect escalations, and coach agents services: assessment, deployment, and managed operations.
        </p>
