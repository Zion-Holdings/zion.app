...
export const metadata: Metadata = {
  title: 'Automated Computer Vision for Legal',
  description: 'Enhance your legal business with Automated Computer Vision for Legal. Our solution provides root cause analysis with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-computer-vision-for-legal-02c303e0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Computer Vision for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Automated Computer Vision for Legal. Our solution provides root cause analysis with enterprise-grade reliability and security.
          </p>
