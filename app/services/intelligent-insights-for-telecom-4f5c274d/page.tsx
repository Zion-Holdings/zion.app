...
export const metadata: Metadata = {
  title: 'Intelligent Insights for Telecom',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Insights for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Insights for Telecom. This autonomous system provides process discovery with zero manual intervention needed.
          </p>
