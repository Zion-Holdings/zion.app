...
export const metadata: Metadata = {
  title: 'DevOps AI - Construction',
  description: 'Optimize your construction workflows with DevOps AI - Construction. This intelligent platform delivers network optimization through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/devops-ai-construction-7c7cfa3c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            DevOps AI - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with DevOps AI - Construction. This intelligent platform delivers network optimization through advanced automation and AI.
          </p>
