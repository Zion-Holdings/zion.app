...
export const metadata: Metadata = {
  ...
  description: 'compliance management solution for biotechnology industry. Monitors market trends, competitor activities, and industry news to provide actionable insights.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/compliance-management-ai-powered-market-intelligence-7a3d6b6a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            compliance management solution for biotechnology industry. Monitors market trends, competitor activities, and industry news to provide actionable insights.
          </p>
