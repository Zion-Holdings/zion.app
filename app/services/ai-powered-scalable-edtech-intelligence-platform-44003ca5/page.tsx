...
export const metadata = {
  title: "AI-Powered Scalable Edtech Intelligence Platform - Zion Tech Group",
  description: "AI-driven intelligence platform that delivers scalable insights and automated decision-making for edtech operations.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-scalable-edtech-intelligence-platform-44003ca5`
  }
};
