...
export const metadata: Metadata = {
  ...
  description: 'The future of energy is here with Smart Resource Predictor. Powered by cutting-edge AI, this platform delivers transformative results like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-resource-predictor-f8f2be5c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Resource Predictor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Smart Resource Predictor. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
