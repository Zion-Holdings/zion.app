...
export const metadata: Metadata = {
  title: 'Intelligent Operational for EDTECH',
  description: 'Transform your edtech operations with our Intelligent Operational for EDTECH. This AI-driven solution automates automation opportunity with unprecedented accura',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Operational for EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your edtech operations with our Intelligent Operational for EDTECH. This AI-driven solution automates automation opportunity with unprecedented accuracy and efficiency.
          </p>
