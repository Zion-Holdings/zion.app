...
export const metadata: Metadata = {
  title: 'Predictive Disaster Experience',
  description: 'Next-generation insurance solution: Predictive Disaster Experience. Combines business process with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-disaster-experience-73d56766',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Disaster Experience
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Predictive Disaster Experience. Combines business process with adaptive intelligence for optimal results.
          </p>
