...
export const metadata: Metadata = {
  title: 'Experience AI - Automotive',
  description: 'Next-generation automotive solution: Experience AI - Automotive. Combines reputation management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/experience-ai-automotive-90577721',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Experience AI - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation automotive solution: Experience AI - Automotive. Combines reputation management with adaptive intelligence for optimal results.
          </p>
