...
export const metadata: Metadata = {
  title: 'Cognitive Business Orchestrator',
  description: 'Optimize your gaming workflows with Cognitive Business Orchestrator. This intelligent platform delivers customer onboarding through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-business-orchestrator-adfa2553',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Business Orchestrator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your gaming workflows with Cognitive Business Orchestrator. This intelligent platform delivers customer onboarding through advanced automation and AI.
          </p>
