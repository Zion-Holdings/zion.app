...
export const metadata: Metadata = {
  title: "AI-Powered Metaverse Experience Engine - AI-Powered Gaming Solution",
  description: "Creates immersive metaverse experiences with AI-generated content and virtual avatars.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-metaverse-experience-engine-bd960923",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Metaverse Experience Engine - AI-Powered Gaming Solution
        </h1>
