...
export const metadata: Metadata = {
  ...
  keywords: 'Inbound spam and phishing filtering, BEC and impersonation detection, Attachment sandboxing (ATP), Outbound DLP and encryption, Email archival and eDiscovery, DMARC reporting and enforcement, Microsoft 365 and Google Workspace native integration, security, Cybersecurity, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Email Security &amp; Protection Suite</h1>
        <p className="text-lg text-slate-300 mb-8">Complete email security: inbound/outbound filtering, ATP sandboxing, DLP, encryption, and archival. Protect against phishing, BEC, and data exfiltration.</p>
        ...
        <li class="text-slate-300">Inbound spam and phishing filtering</li>
        <li class="text-slate-300">BEC and impersonation detection</li>
        <li class="text-slate-300">Attachment sandboxing (ATP)</li>
        <li class="text-slate-300">Outbound DLP and encryption</li>
        <li class="text-slate-300">Email archival and eDiscovery</li>
        <li class="text-slate-300">DMARC reporting and enforcement</li>
        <li class="text-slate-300">Microsoft 365 and Google Workspace native integration</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Block 99.9% of phishing and spam</li>
        <li class="text-slate-300">BEC detection prevents wire fraud</li>
        <li class="text-slate-300">DLP prevents sensitive data leaks</li>
        <li class="text-slate-300">Archival meets compliance requirements</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$4/user/mo</p>
