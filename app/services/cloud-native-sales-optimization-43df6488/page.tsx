...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'Cloud-Native Sales Optimization', 'description': 'AI-driven cloud optimization platform that automatically manages resource allocation, cost optimization, and performance tuning for cloud-native applications.', 'serviceType': 'cloud', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'hello@ziontechgroup.com', 'telephone': '+1 (302) 464-0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'technology'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'Cloud-Native Sales Optimization Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '218', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '548', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': '1648', 'priceCurrency': 'USD'}]}} />
