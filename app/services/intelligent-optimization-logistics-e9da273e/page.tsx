...
export const metadata: Metadata = {
  title: 'Intelligent optimization-logistics',
  description: 'Next-generation logistics solution: Intelligent optimization-logistics. Combines decision support with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-optimization-logistics-e9da273e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent optimization-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Intelligent optimization-logistics. Combines decision support with adaptive intelligence for optimal results.
          </p>
