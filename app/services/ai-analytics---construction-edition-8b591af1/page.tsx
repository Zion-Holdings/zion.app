...
export const metadata: Metadata = {
  ...
  keywords: 'Performance dashboards, Multi-language support, Edge computing support, HIPAA ready, GDPR compliance, engine, construction, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Analytics - Construction Edition</h1>
        <p className="text-lg text-slate-300 mb-8">Revolutionize construction through intelligent automation. Our AI Analytics - Construction Edition leverages advanced machine learning to deliver document processing at scale.</p>
