...
export const metadata: Metadata = {
  title: 'AI Cognitive - Healthcare Edition',
  description: 'Enhance your healthcare business with AI Cognitive - Healthcare Edition. Our solution provides hr analytics with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-cognitive-healthcare-edition-ac860d33',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Cognitive - Healthcare Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with AI Cognitive - Healthcare Edition. Our solution provides hr analytics with enterprise-grade reliability and security.
          </p>
