  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Predictive Executive Cloud</h1>
        <p className="text-lg text-gray-300 mb-8">Transform your energy operations with our Predictive Executive Cloud. This AI-driven solution automates performance tuning with unprecedented accuracy and efficiency.</p>
