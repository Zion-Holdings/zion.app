...
export const metadata: Metadata = {
  title: 'Autonomous Performance System - Healthcare',
  description: 'The future of healthcare is here with Autonomous Performance System - Healthcare. Powered by cutting-edge AI, this platform delivers market analysis like never ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Performance System - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Autonomous Performance System - Healthcare. Powered by cutting-edge AI, this platform delivers market analysis like never before.
          </p>
