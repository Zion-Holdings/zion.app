...
export const metadata: Metadata = {
  title: 'Intelligent API Gateway TensorFlow (Telecom)',
  description: 'Intelligent API Gateway TensorFlow (Telecom) is an AI-powered telecom solution that transforms how businesses operate through intelligent automation and real-ti',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent API Gateway TensorFlow (Telecom)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Intelligent API Gateway TensorFlow (Telecom) is an AI-powered telecom solution that transforms how businesses operate through intelligent automation and real-time analytics.
