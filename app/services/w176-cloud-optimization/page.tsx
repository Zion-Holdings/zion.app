...
export const metadata: Metadata = {
  ...
  keywords: 'Workload right-sizing recommendations, Reserved instance and savings plan optimization, Storage tiering and lifecycle policies, Database query optimization, CDN and caching strategy, Performance benchmarking before/after, AWS, Azure, GCP support, cloud, FinOps, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cloud Performance Optimization</h1>
        <p className="text-lg text-slate-300 mb-8">Optimize cloud workloads for performance and cost: right-sizing, reserved instance strategy, storage tiering, and query optimization.</p>
        ...
        <li class="text-slate-300">Reserved instance and savings plan optimization</li>
        <li class="text-slate-300">Storage tiering and lifecycle policies</li>
        <li class="text-slate-300">Database query optimization</li>
        <li class="text-slate-300">CDN and caching strategy</li>
        <li class="text-slate-300">Performance benchmarking before/after</li>
        <li class="text-slate-300">AWS, Azure, GCP support</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Typical 30-50% cost reduction</li>
        <li class="text-slate-300">Right-sizing matches resources to actual load</li>
        <li class="text-slate-300">RI/SP optimization saves 40-70%</li>
        <li class="text-slate-300">Performance benchmarks validate improvements</li>
      </ul>
        </div>
