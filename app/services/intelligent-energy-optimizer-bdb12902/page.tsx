...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize proptech through intelligent automation. Our Intelligent Energy Optimizer leverages advanced machine learning to deliver inventory management at s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-energy-optimizer-bdb12902',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Energy Optimizer
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our Intelligent Energy Optimizer leverages advanced machine learning to deliver inventory management at scale.
          </p>
