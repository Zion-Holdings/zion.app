...
export const metadata: Metadata = {
  title: 'Insights Enterprise - CLEANTECH',
  description: 'Optimize your cleantech workflows with Insights Enterprise - CLEANTECH. This intelligent platform delivers regulatory tracking through advanced automation and A',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Insights Enterprise - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your cleantech workflows with Insights Enterprise - CLEANTECH. This intelligent platform delivers regulatory tracking through advanced automation and AI.
          </p>
