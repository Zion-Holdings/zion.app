...
export const metadata: Metadata = {
  title: 'Intelligent Neural for MARTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Neural for MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Neural for MARTECH. This autonomous system provides receipt processing with zero manual intervention needed.
          </p>
