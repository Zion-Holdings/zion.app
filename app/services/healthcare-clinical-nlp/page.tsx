...
export const metadata: Metadata = {
  ...
  keywords: 'Medical entity recognition, Phenotype extraction, Clinical coding (ICD-10, CPT), De-identification, Clinical trial matching, Literature mining, HIPAA compliance, FHIR integration, ai, Healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Healthcare Clinical NLP</h1>
        <p className="text-lg text-slate-300 mb-8">Extract insights from clinical notes, medical records, and research papers. Medical entity recognition, phenotype extraction, clinical coding, and HIPAA-compliant processing.</p>
        ...
        <li class="text-slate-300">Medical entity recognition</li>
        <li class="text-slate-300">Phenotype extraction</li>
        <li class="text-slate-300">Clinical coding (ICD-10, CPT)</li>
        <li class="text-slate-300">De-identification</li>
        <li class="text-slate-300">Clinical trial matching</li>
        <li class="text-slate-300">Literature mining</li>
        <li class="text-slate-300">HIPAA compliance</li>
        <li class="text-slate-300">FHIR integration</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">80% faster chart review</li>
        <li class="text-slate-300">Improved coding accuracy</li>
        <li class="text-slate-300">Research acceleration</li>
        <li class="text-slate-300">HIPAA compliant</li>
        <li class="text-slate-300">Clinical trial matching</li>
      </ul>
        </div>
