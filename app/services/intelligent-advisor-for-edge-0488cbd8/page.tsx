...
export const metadata: Metadata = {
  title: 'Intelligent Advisor for Edge',
  description: 'Next-generation edge solution: Intelligent Advisor for Edge. Combines healthcare data analytics with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-advisor-for-edge-0488cbd8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Advisor for Edge
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation edge solution: Intelligent Advisor for Edge. Combines healthcare data analytics with adaptive intelligence for optimal results.
          </p>
