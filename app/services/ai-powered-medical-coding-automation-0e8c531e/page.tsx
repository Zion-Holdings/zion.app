...
export const metadata: Metadata = {
  title: 'AI-Powered Medical Coding Automation',
  description: 'Automates medical coding with accuracy and compliance checking.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-medical-coding-automation-0e8c531e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automates medical coding with accuracy and compliance checking.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Medical coding</li>
          <li className="text-gray-300">Accuracy checking</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">80% faster coding</li>
