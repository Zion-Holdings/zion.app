...
export const metadata: Metadata = {
  title: 'Cognitive Healthcare Solution - Legal',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Healthcare Solution - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Cognitive Healthcare Solution - Legal. Our solution provides data governance with enterprise-grade reliability and security.
          </p>
