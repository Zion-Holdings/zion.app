...
export const metadata: Metadata = {
  title: 'AI-Powered Health Insurance Claims',
  description: 'Automates health insurance claims processing and fraud detection.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-health-insurance-claims2026-07-28t0321551840800000119-9034318d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automates health insurance claims processing and fraud detection.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">70% faster claims</li>
