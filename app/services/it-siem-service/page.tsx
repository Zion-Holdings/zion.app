...
export const metadata: Metadata = {
  ...
  keywords: 'Log collection, AI threat detection, Compliance reporting, Incident triage, Dashboard creation, Alert management, Forensic analysis, Managed response, it, Security, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Managed SIEM &amp; Log Analytics</h1>
        <p className="text-lg text-slate-300 mb-8">24/7 security monitoring with AI threat detection, log correlation, and compliance reporting.</p>
        ...
        <li class="text-slate-300">Log collection</li>
        <li class="text-slate-300">AI threat detection</li>
        <li class="text-slate-300">Compliance reporting</li>
        <li class="text-slate-300">Incident triage</li>
        <li class="text-slate-300">Dashboard creation</li>
        <li class="text-slate-300">Alert management</li>
        <li class="text-slate-300">Forensic analysis</li>
        <li class="text-slate-300">Managed response</li>
      </ul>
        </div>
        ...
        <li class="text-slate-300">AI detection</li>
        <li class="text-slate-300">Compliance ready</li>
        <li class="text-slate-300">Expert analysts</li>
      </ul>
        </div>
