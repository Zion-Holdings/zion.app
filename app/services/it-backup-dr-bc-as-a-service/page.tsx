...
export const metadata: Metadata = {
  ...
  keywords: '3-2-1-1-airgap backup policy enforced automatically, WORM snapshots every 30 seconds, point-in-time restore to 90 days, Automatic failover testing every 30 minutes with pass/fail report, 4-hour RTO and 15-minute RPO SLA with financial credit clause, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Backup / DR/BCaaS</h1>
        <p className="text-lg text-slate-300 mb-8">Managed backup and disaster recovery: 3-2-1-1-airgap policy, every-30s WORM snapshots, point-in-time restore to 90 days, failover tests every 30 min, 4-hour RTO, 15-min RPO SLA.</p>
        ...
        <li class="text-slate-300">3-2-1-1-airgap backup policy enforced automatically</li>
        <li class="text-slate-300">WORM snapshots every 30 seconds, point-in-time restore to 90 days</li>
        <li class="text-slate-300">Automatic failover testing every 30 minutes with pass/fail report</li>
        <li class="text-slate-300">4-hour RTO and 15-minute RPO SLA with financial credit clause</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with backup / dr/bcaas</li>
