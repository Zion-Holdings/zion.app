...
export const metadata: Metadata = {
  title: 'Synthetic Check Data Generator',
  description: 'Generates realistic synthetic check datasets for payments and healthcare claims.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/synthetic-check-data-generator-c482b62b',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Synthetic Check Data Generator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Generates realistic synthetic check datasets for payments and healthcare claims.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$10999</p>
          <ul className="space-y-2 mb-4">
