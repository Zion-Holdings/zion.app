...
export const metadata: Metadata = {
  title: 'Enterprise Scale-up Platform - Hospitality #1',
  description: 'Optimize your hospitality workflows with Enterprise Scale-up Platform - Hospitality #1. This intelligent platform delivers training optimization through advance',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-scale-up-platform-hospitality-1-a6fcc3d5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Scale-up Platform - Hospitality #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Enterprise Scale-up Platform - Hospitality #1. This intelligent platform delivers training optimization through advanced automation and AI.
          </p>
