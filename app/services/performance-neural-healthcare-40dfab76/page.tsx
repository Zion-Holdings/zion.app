...
export const metadata: Metadata = {
  title: 'Performance Neural - Healthcare',
  description: 'Transform your healthcare operations with our Performance Neural - Healthcare. This AI-driven solution automates content moderation with unprecedented accuracy ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/performance-neural-healthcare-40dfab76',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Performance Neural - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Performance Neural - Healthcare. This AI-driven solution automates content moderation with unprecedented accuracy and efficiency.
          </p>
