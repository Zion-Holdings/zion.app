...
export const metadata: Metadata = {
  ...
  keywords: 'Print fleet assessment and optimization, Managed print fleet (supplies, maintenance), Secure print release and authentication, Print policy enforcement and rules, Cost allocation by department/project, Sustainability tracking and reporting, Integration with Active Directory, Mobile and cloud printing support, it, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Print Management &amp; Managed Print Services</h1>
        <p className="text-lg text-slate-300 mb-8">Managed print services that reduce printing costs by 40%. Fleet management, secure printing, and sustainability tracking for organizations of all sizes.</p>
        ...
        <li class="text-slate-300">Print fleet assessment and optimization</li>
        <li class="text-slate-300">Managed print fleet (supplies, maintenance)</li>
        <li class="text-slate-300">Secure print release and authentication</li>
        <li class="text-slate-300">Print policy enforcement and rules</li>
        <li class="text-slate-300">Cost allocation by department/project</li>
        <li class="text-slate-300">Sustainability tracking and reporting</li>
        <li class="text-slate-300">Integration with Active Directory</li>
        <li class="text-slate-300">Mobile and cloud printing support</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce print costs by 40%</li>
        <li class="text-slate-300">Eliminate wasted prints with secure release</li>
        <li class="text-slate-300">Track and reduce environmental impact</li>
        <li class="text-slate-300">Free IT staff from printer management</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$500/mo</p>
              <p class="text-sm text-slate-400">Getting started plan</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              <h3 class="font-semibold text-white mb-2">Pro</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">$1,200/mo</p>
