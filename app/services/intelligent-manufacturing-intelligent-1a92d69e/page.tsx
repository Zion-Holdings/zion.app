...
export const metadata: Metadata = {
  title: 'Intelligent Manufacturing Intelligent',
  description: 'Optimize your automotive workflows with Intelligent Manufacturing Intelligent. This intelligent platform delivers compliance monitoring through advanced automat',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your automotive workflows with Intelligent Manufacturing Intelligent. This intelligent platform delivers compliance monitoring through advanced automation and AI.
          </p>
