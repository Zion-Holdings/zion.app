...
export const metadata = {
  ...
  description: "The future of Logistics is here with Generator Autonomous - Logistics. Powered by cutting-edge AI, this platform delivers maintenance scheduling like never befo",
  alternates: {
