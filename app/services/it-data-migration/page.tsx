...
export const metadata: Metadata = {
  ...
  keywords: 'Source system assessment and mapping, ETL pipeline development and testing, Zero-downtime migration execution, Automated data validation and reconciliation, Rollback planning and testing, Integration with Oracle, SQL Server, MongoDB, PostgreSQL, Performance optimization post-migration, Documentation and knowledge transfer, it, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Data Migration &amp; Database Consolidation</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end data migration services — from legacy databases to modern platforms. Zero-downtime migration with automated validation and rollback.</p>
        ...
        <li class="text-slate-300">Source system assessment and mapping</li>
        <li class="text-slate-300">ETL pipeline development and testing</li>
        <li class="text-slate-300">Zero-downtime migration execution</li>
        <li class="text-slate-300">Automated data validation and reconciliation</li>
        <li class="text-slate-300">Rollback planning and testing</li>
        <li class="text-slate-300">Integration with Oracle, SQL Server, MongoDB, PostgreSQL</li>
        <li class="text-slate-300">Performance optimization post-migration</li>
        <li class="text-slate-300">Documentation and knowledge transfer</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Migrate with zero downtime</li>
        <li class="text-slate-300">Ensure 100% data accuracy with automated validation</li>
        <li class="text-slate-300">Reduce database costs by 40%</li>
        <li class="text-slate-300">Modernize without business disruption</li>
      </ul>
        </div>
