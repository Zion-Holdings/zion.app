...
export const metadata: Metadata = {
  title: 'Smart Healthcare Platform - Telecom',
  description: 'Unlock unprecedented growth with Smart Healthcare Platform - Telecom. This autonomous system provides recommendation system with zero manual intervention needed',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-healthcare-platform-telecom-76265867',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Healthcare Platform - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Healthcare Platform - Telecom. This autonomous system provides recommendation system with zero manual intervention needed.
          </p>
