...
export const metadata: Metadata = {
  title: 'Autonomous Sales System - Logistics',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Sales System - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Autonomous Sales System - Logistics. This autonomous system provides decision support with zero manual intervention needed.
          </p>
