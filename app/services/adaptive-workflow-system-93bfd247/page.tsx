...
export const metadata: Metadata = {
  title: 'Adaptive Workflow System',
  description: 'Drive innovation in sports with Adaptive Workflow System. This AI-powered platform transforms pipeline management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-workflow-system-93bfd247',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in sports with Adaptive Workflow System. This AI-powered platform transforms pipeline management into a competitive advantage.
          </p>
