...
export const metadata: Metadata = {
  title: 'AI Engine - Education Edition',
  description: 'Transform your education operations with our AI Engine - Education Edition. This AI-driven solution automates financial risk management with unprecedented accur',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Engine - Education Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your education operations with our AI Engine - Education Edition. This AI-driven solution automates financial risk management with unprecedented accuracy and efficiency.
          </p>
