...
export const metadata: Metadata = {
  title: 'Automated Access Supply',
  description: 'Optimize your construction workflows with Automated Access Supply. This intelligent platform delivers competitive intelligence through advanced automation and A',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Access Supply
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Automated Access Supply. This intelligent platform delivers competitive intelligence through advanced automation and AI.
          </p>
