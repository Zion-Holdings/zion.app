...
export const metadata: Metadata = {
  ...
  keywords: 'Auto-categorisation by GL code, Policy violation alerting, Audit trail with full export, QuickBooks, Xero, NetSuite integrations, Custom rules engine per organisation, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Expense Categorisation &amp; Audit</h1>
        <p className="text-lg text-slate-300 mb-8">ML engine auto-categorises business expenses by GL code, flags policy violations, and generates audit-ready reports for your finance team.</p>
        ...
        <li class="text-slate-300">Auto-categorisation by GL code</li>
        <li class="text-slate-300">Policy violation alerting</li>
        <li class="text-slate-300">Audit trail with full export</li>
        <li class="text-slate-300">QuickBooks, Xero, NetSuite integrations</li>
        <li class="text-slate-300">Custom rules engine per organisation</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai expense categorisation &amp; audit</li>
