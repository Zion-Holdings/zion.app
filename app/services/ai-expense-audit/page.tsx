      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            ML engine auto-categorises business expenses by GL code, flags policy violations, and generates audit-ready reports for your finance team.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Auto-categorisation by GL code</li>
            <li className="text-purple-300">✓ Policy violation alerting</li>
            <li className="text-purple-300">✓ Audit trail with full export</li>
            <li className="text-purple-300">✓ QuickBooks, Xero, NetSuite integrations</li>
            <li className="text-purple-300">✓ Custom rules engine per organisation</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai expense categorisation & audit</li>
