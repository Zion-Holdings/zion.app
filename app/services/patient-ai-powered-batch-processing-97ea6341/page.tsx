...
export const metadata: Metadata = {
  title: 'Patient AI-Powered Batch Processing',
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Patient AI-Powered Batch Processing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered patient solution for batch processing. Optimized batch processing schedules with predictive timing.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your patient operations?</p>
