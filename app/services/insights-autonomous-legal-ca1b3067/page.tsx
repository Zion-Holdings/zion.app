...
export const metadata: Metadata = {
  title: 'Insights Autonomous - Legal',
  description: 'Unlock unprecedented growth with Insights Autonomous - Legal. This autonomous system provides customer service automation with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/insights-autonomous-legal-ca1b3067',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Insights Autonomous - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Insights Autonomous - Legal. This autonomous system provides customer service automation with zero manual intervention needed.
          </p>
