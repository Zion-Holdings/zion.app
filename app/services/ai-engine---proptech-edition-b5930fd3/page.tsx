...
export const metadata: Metadata = {
  title: 'AI Engine - Proptech Edition',
  description: 'Revolutionize proptech through intelligent automation. Our AI Engine - Proptech Edition leverages advanced machine learning to deliver process automation at sca',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-engine---proptech-edition-b5930fd3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Engine - Proptech Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our AI Engine - Proptech Edition leverages advanced machine learning to deliver process automation at scale.
          </p>
