...
export const metadata: Metadata = {
  title: 'AI Support - Real-Estate Edition',
  description: 'Optimize your real-estate workflows with AI Support - Real-Estate Edition. This intelligent platform delivers competitive intelligence through advanced automati',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your real-estate workflows with AI Support - Real-Estate Edition. This intelligent platform delivers competitive intelligence through advanced automation and AI.
          </p>
