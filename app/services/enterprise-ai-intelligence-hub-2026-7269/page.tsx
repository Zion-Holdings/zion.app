...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={@context: "https://schema.org", @type: "Service", name: "Enterprise AI Intelligence Hub | Zion Tech Group", description: "End-to-end enterprise ai intelligence hub services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/enterprise-ai-intelligence-hub-2026-7269/"} />
