...
export const metadata: Metadata = {
  title: 'Predictive Intelligence Engine - Finance',
  description: 'Revolutionize finance through intelligent automation. Our Predictive Intelligence Engine - Finance leverages advanced machine learning to deliver sourcing optim',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Intelligence Engine - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our Predictive Intelligence Engine - Finance leverages advanced machine learning to deliver sourcing optimization at scale.
          </p>
