      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Call transcript analysis: talk-listen ratio, sentiment, intent signals, competitor mentions, pricing cues, action item extraction, CRM autofill, team leaderboard coaching.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Per-call sentiment + intent heatmap</li>
            <li className="text-purple-300">✓ Talk-listen ratio scoring</li>
            <li className="text-purple-300">✓ CRM auto-logging + deal stage update</li>
            <li className="text-purple-300">✓ Competitor mention + pricing cue detection</li>
            <li className="text-purple-300">✓ Personalized rep coaching tip per call</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with conversation intelligence & call coach</li>
