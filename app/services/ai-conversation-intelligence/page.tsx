...
export const metadata: Metadata = {
  ...
  keywords: 'Per-call sentiment + intent heatmap, Talk-listen ratio scoring, CRM auto-logging + deal stage update, Competitor mention + pricing cue detection, Personalized rep coaching tip per call, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Conversation Intelligence &amp; Call Coach</h1>
        <p className="text-lg text-slate-300 mb-8">Call transcript analysis: talk-listen ratio, sentiment, intent signals, competitor mentions, pricing cues, action item extraction, CRM autofill, team leaderboard coaching.</p>
        ...
        <li class="text-slate-300">Per-call sentiment + intent heatmap</li>
        <li class="text-slate-300">Talk-listen ratio scoring</li>
        <li class="text-slate-300">CRM auto-logging + deal stage update</li>
        <li class="text-slate-300">Competitor mention + pricing cue detection</li>
        <li class="text-slate-300">Personalized rep coaching tip per call</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with conversation intelligence &amp; call coach</li>
