...
export const metadata: Metadata = {
  title: 'Smart Predictive - FINTECH',
  description: 'Transform your fintech operations with our Smart Predictive - FINTECH. This AI-driven solution automates capacity management with unprecedented accuracy and eff',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Predictive - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your fintech operations with our Smart Predictive - FINTECH. This AI-driven solution automates capacity management with unprecedented accuracy and efficiency.
          </p>
