...
export const metadata: Metadata = {
  title: 'AI-Powered advisor-healthcare',
  description: 'Drive innovation in healthcare with AI-Powered advisor-healthcare. This AI-powered platform transforms expense management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-advisor-healthcare-bff83325',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered advisor-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with AI-Powered advisor-healthcare. This AI-powered platform transforms expense management into a competitive advantage.
          </p>
