...
export const metadata: Metadata = {
  title: 'Automated Healthcare Diagnostics Kubernetes (Hr)',
  description: 'Automated Healthcare Diagnostics Kubernetes (Hr) is an AI-powered hr solution that transforms how businesses operate through intelligent automation and real-tim',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-healthcare-diagnosti-81719f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Healthcare Diagnostics Kubernetes (Hr)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Automated Healthcare Diagnostics Kubernetes (Hr) is an AI-powered hr solution that transforms how businesses operate through intelligent automation and real-time analytics.
...
Express, Microservices, Serverless, Docker, Redis, Fastify
