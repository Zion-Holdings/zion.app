...
export const metadata: Metadata = {
  ...
  description: 'Drive innovation in manufacturing with Self-Optimizing Optimization for Manufacturing. This AI-powered platform transforms cost reduction into a competitive adv',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in manufacturing with Self-Optimizing Optimization for Manufacturing. This AI-powered platform transforms cost reduction into a competitive advantage.
          </p>
