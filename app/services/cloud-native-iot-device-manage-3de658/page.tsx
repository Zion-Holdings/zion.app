...
export const metadata: Metadata = {
  title: 'Cloud-Native IoT Device Management Blockchain (It)',
  description: 'Cloud-Native IoT Device Management Blockchain (It) is an AI-powered it solution that transforms how businesses operate through intelligent automation and real-t',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cloud-native-iot-device-manage-3de658',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cloud-Native IoT Device Management Blockchain (It)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Cloud-Native IoT Device Management Blockchain (It) is an AI-powered it solution that transforms how businesses operate through intelligent automation and real-time analytics.
