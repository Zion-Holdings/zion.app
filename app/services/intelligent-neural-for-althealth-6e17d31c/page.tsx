...
export const metadata: Metadata = {
  title: 'Intelligent Neural for ALTHEALTH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Neural for ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for althealth: Intelligent Neural for ALTHEALTH. Uses quantum-inspired algorithms to deliver career development at exponential speed.
          </p>
