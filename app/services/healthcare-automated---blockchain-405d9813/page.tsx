...
export const metadata: Metadata = {
  title: 'Healthcare Automated - Blockchain',
  description: 'The future of blockchain is here with Healthcare Automated - Blockchain. Powered by cutting-edge AI, this platform delivers healthcare data analytics like never',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/healthcare-automated---blockchain-405d9813',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Healthcare Automated - Blockchain
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of blockchain is here with Healthcare Automated - Blockchain. Powered by cutting-edge AI, this platform delivers healthcare data analytics like never before.
          </p>
