...
export const metadata: Metadata = {
  title: 'Smart Supply Platform - Education',
  description: 'Revolutionize education through intelligent automation. Our Smart Supply Platform - Education leverages advanced machine learning to deliver quota optimization ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-supply-platform-education-d362f2b6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Supply Platform - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize education through intelligent automation. Our Smart Supply Platform - Education leverages advanced machine learning to deliver quota optimization at scale.
          </p>
