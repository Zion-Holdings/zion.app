...
export const metadata: Metadata = {
  title: 'Benefits Management Intelligent Document Processing AI',
  description: 'benefits management solution for professional associations industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing doc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/benefits-management-intelligent-document-processing-ai-926cad51',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Benefits Management Intelligent Document Processing AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            benefits management solution for professional associations industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.
          </p>
