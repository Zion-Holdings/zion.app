...
export const metadata: Metadata = {
  title: 'AI/IT Management Suite - Education',
  description: 'Quantum leap forward for education: AI/IT Management Suite - Education. Uses quantum-inspired algorithms to deliver energy management at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-management-suite-education-2f75bc3a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Management Suite - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for education: AI/IT Management Suite - Education. Uses quantum-inspired algorithms to deliver energy management at exponential speed.
          </p>
