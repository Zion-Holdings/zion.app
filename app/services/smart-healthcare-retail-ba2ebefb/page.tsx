...
export const metadata: Metadata = {
  title: 'Smart healthcare-retail',
  description: 'The future of retail is here with Smart healthcare-retail. Powered by cutting-edge AI, this platform delivers transformative results like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-healthcare-retail-ba2ebefb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Smart healthcare-retail. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
