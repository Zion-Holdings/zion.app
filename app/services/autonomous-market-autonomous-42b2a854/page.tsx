...
export const metadata: Metadata = {
  title: 'Autonomous Market Autonomous',
  description: 'Enhance your construction business with Autonomous Market Autonomous. Our solution provides competitive intelligence with enterprise-grade reliability and secur',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Market Autonomous
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Autonomous Market Autonomous. Our solution provides competitive intelligence with enterprise-grade reliability and security.
          </p>
