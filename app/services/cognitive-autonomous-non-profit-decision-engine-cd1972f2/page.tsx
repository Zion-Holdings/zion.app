...
export const metadata = {
  title: "Cognitive Autonomous Non-Profit Decision Engine - Zion Tech Group",
  description: "Cognitive decision engine that processes autonomous signals to drive non-profit strategy with deep learning.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/cognitive-autonomous-non-profit-decision-engine-cd1972f2`
  }
};
