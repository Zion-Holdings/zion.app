...
export const metadata: Metadata = {
  title: 'AI-Powered Orchestrator',
  description: 'Transform your agriculture operations with our AI-Powered Orchestrator. This cloud solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-orchestrator-627a9f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our AI-Powered Orchestrator. This cloud solution delivers unprecedented automation and intelligence.
          </p>
