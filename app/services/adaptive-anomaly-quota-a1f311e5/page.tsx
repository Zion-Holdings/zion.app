      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Anomaly Quota
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your technology with Adaptive Anomaly Quota. Our autonomous solution handles master data management end-to-end without human intervention.
          </p>
