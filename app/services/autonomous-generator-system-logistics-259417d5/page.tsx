...
export const metadata: Metadata = {
  title: 'Autonomous Generator System - Logistics',
  description: 'Optimize your logistics workflows with Autonomous Generator System - Logistics. This intelligent platform delivers ml model training through advanced automation',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-generator-system-logistics-259417d5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Generator System - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your logistics workflows with Autonomous Generator System - Logistics. This intelligent platform delivers ml model training through advanced automation and AI.
          </p>
