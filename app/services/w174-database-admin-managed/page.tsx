...
export const metadata: Metadata = {
  ...
  keywords: '24/7 database monitoring and alerting, Performance tuning and query optimization, High availability and replication setup, Backup verification and DR testing, Database migration and upgrades, Capacity planning and forecasting, Support for Postgres, MySQL, SQL Server, Oracle, MongoDB, it, Data Operations, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Managed Database Administration</h1>
        <p className="text-lg text-slate-300 mb-8">Expert DBA services for PostgreSQL, MySQL, SQL Server, Oracle, and MongoDB. Performance tuning, HA/DR setup, migrations, and 24/7 monitoring.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">it</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">Data Operations</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">24/7 database monitoring and alerting</li>
        <li class="text-slate-300">Performance tuning and query optimization</li>
        <li class="text-slate-300">High availability and replication setup</li>
        <li class="text-slate-300">Backup verification and DR testing</li>
        <li class="text-slate-300">Database migration and upgrades</li>
        <li class="text-slate-300">Capacity planning and forecasting</li>
        <li class="text-slate-300">Support for Postgres, MySQL, SQL Server, Oracle, MongoDB</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Expert DBA support without hiring</li>
        <li class="text-slate-300">24/7 monitoring catches issues before outage</li>
        <li class="text-slate-300">Performance tuning reduces cloud costs</li>
        <li class="text-slate-300">HA/DR setup protects business continuity</li>
      </ul>
        </div>
