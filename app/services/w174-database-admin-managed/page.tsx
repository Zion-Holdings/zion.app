...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{'@context': 'https://schema.org', '@type': 'Service', 'name': 'Managed Database Administration', 'description': 'Expert DBA services for PostgreSQL, MySQL, SQL Server, Oracle, and MongoDB. Performance tuning, HA/DR setup, migrations, and 24/7 monitoring.', 'serviceType': 'it', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'Data Operations'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'Managed Database Administration Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$499/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$1,499/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': '$4,999/mo', 'priceCurrency': 'USD'}]}} }/>
    <JsonLd data={{'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': '24/7 database monitoring and alerting', 'acceptedAnswer': {'@type': 'Answer', 'text': '24/7 database monitoring and alerting'}}, {'@type': 'Question', 'name': 'Performance tuning and query optimization', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Performance tuning and query optimization'}}, {'@type': 'Question', 'name': 'High availability and replication setup', 'acceptedAnswer': {'@type': 'Answer', 'text': 'High availability and replication setup'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Expert DBA support without hiring; 24/7 monitoring catches issues before outage; Performance tuning reduces cloud costs'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} }/>
