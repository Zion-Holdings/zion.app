...
export const metadata: Metadata = {
  ...
  keywords: 'Citizen portal, Case management, Form automation, Document processing, Compliance tracking, Section 508 access, Multi-agency, Analytics, ai, Government, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Government Digital Services Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Modern digital services for government with case management and Section 508 accessibility.</p>
        ...
        <li class="text-slate-300">Citizen portal</li>
        <li class="text-slate-300">Case management</li>
        <li class="text-slate-300">Form automation</li>
        <li class="text-slate-300">Document processing</li>
        <li class="text-slate-300">Compliance tracking</li>
        <li class="text-slate-300">Section 508 access</li>
        <li class="text-slate-300">Multi-agency</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">50% faster processing</li>
        <li class="text-slate-300">Citizen satisfaction</li>
