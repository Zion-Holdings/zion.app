...
export const metadata: Metadata = {
  title: 'Manager Intelligent - Iot',
  description: 'Transform your iot operations with our Manager Intelligent - Iot. This AI-driven solution automates energy management with unprecedented accuracy and efficiency',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/manager-intelligent---iot-022385b7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manager Intelligent - Iot
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your iot operations with our Manager Intelligent - Iot. This AI-driven solution automates energy management with unprecedented accuracy and efficiency.
          </p>
