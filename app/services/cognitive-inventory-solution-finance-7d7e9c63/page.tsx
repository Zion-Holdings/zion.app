...
export const metadata: Metadata = {
  title: 'Cognitive Inventory Solution - Finance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Inventory Solution - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation finance solution: Cognitive Inventory Solution - Finance. Combines root cause analysis with adaptive intelligence for optimal results.
          </p>
