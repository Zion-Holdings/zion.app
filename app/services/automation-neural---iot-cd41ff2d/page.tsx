...
export const metadata: Metadata = {
  title: 'Automation Neural - Iot',
  description: 'Transform your iot operations with our Automation Neural - Iot. This AI-driven solution automates logistics route optimization with unprecedented accuracy and e',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automation Neural - Iot
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your iot operations with our Automation Neural - Iot. This AI-driven solution automates logistics route optimization with unprecedented accuracy and efficiency.
          </p>
