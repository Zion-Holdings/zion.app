...
export const metadata: Metadata = {
  title: 'Automated Regulatory Optimizer',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Regulatory Optimizer
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with Automated Regulatory Optimizer. Our solution provides succession planning with enterprise-grade reliability and security.
          </p>
