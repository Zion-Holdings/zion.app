...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-sensor fusion (camera, LiDAR, radar), Real-time object detection and tracking, Path planning and trajectory optimization, Behavior prediction for other road users, Simulation environment for testing, Edge deployment on NVIDIA, Qualcomm platforms, Safety validation and verification, HD map integration and localization, ai, automotive, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Autonomous Vehicle Perception &amp; Planning</h1>
        <p className="text-lg text-slate-300 mb-8">AI perception and planning stack for autonomous vehicles. Object detection, path planning, and decision-making for self-driving cars, trucks, and drones.</p>
        ...
        <li class="text-slate-300">Multi-sensor fusion (camera, LiDAR, radar)</li>
        <li class="text-slate-300">Real-time object detection and tracking</li>
        <li class="text-slate-300">Path planning and trajectory optimization</li>
        <li class="text-slate-300">Behavior prediction for other road users</li>
        <li class="text-slate-300">Simulation environment for testing</li>
        <li class="text-slate-300">Edge deployment on NVIDIA, Qualcomm platforms</li>
        <li class="text-slate-300">Safety validation and verification</li>
        <li class="text-slate-300">HD map integration and localization</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Detect objects with 99.9% accuracy</li>
        <li class="text-slate-300">Plan safe paths in complex environments</li>
        <li class="text-slate-300">Test millions of scenarios in simulation</li>
        <li class="text-slate-300">Deploy to edge with real-time performance</li>
      </ul>
        </div>
