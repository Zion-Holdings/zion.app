...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'AI Autonomous Vehicle Perception & Planning', 'description': 'AI perception and planning stack for autonomous vehicles. Object detection, path planning, and decision-making for self-driving cars, trucks, and drones.', 'serviceType': 'ai', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'automotive'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'AI Autonomous Vehicle Perception & Planning Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$4,999/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$12,000/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': 'Custom', 'priceCurrency': 'USD'}]}} />
    <JsonLd data={'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'Multi-sensor fusion (camera, LiDAR, radar)', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Multi-sensor fusion (camera, LiDAR, radar)'}}, {'@type': 'Question', 'name': 'Real-time object detection and tracking', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Real-time object detection and tracking'}}, {'@type': 'Question', 'name': 'Path planning and trajectory optimization', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Path planning and trajectory optimization'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Detect objects with 99.9% accuracy; Plan safe paths in complex environments; Test millions of scenarios in simulation'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} />
