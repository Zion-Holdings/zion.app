...
export const metadata: Metadata = {
  ...
  keywords: 'Text search, Image search, Video search, Audio search, Cross-modal retrieval, Semantic understanding, ai-services, ai-and-ml, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Search across text, images, video, and audio with a single query. Powers next-generation enterprise search and discovery.</p>
        ...
        <li class="text-slate-300">Text search</li>
        <li class="text-slate-300">Image search</li>
        <li class="text-slate-300">Video search</li>
        <li class="text-slate-300">Audio search</li>
        <li class="text-slate-300">Cross-modal retrieval</li>
        <li class="text-slate-300">Semantic understanding</li>
      </ul>
        </div>
        ...
        <li class="text-slate-300">Unify siloed content</li>
        <li class="text-slate-300">Better knowledge discovery</li>
        <li class="text-slate-300">Improved productivity</li>
      </ul>
        </div>
