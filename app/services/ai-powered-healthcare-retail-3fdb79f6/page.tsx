...
export const metadata: Metadata = {
  ...
  description: 'Drive innovation in retail with AI-Powered healthcare-retail. This AI-powered platform transforms logistics route optimization into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-healthcare-retail-3fdb79f6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in retail with AI-Powered healthcare-retail. This AI-powered platform transforms logistics route optimization into a competitive advantage.
          </p>
