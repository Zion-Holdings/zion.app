...
export const metadata: Metadata = {
  title: 'AI/IT Optimizer Suite - AITECH',
  description: 'Next-generation aitech solution: AI/IT Optimizer Suite - AITECH. Combines financial planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-optimizer-suite-aitech-32477309',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Optimizer Suite - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation aitech solution: AI/IT Optimizer Suite - AITECH. Combines financial planning with adaptive intelligence for optimal results.
          </p>
