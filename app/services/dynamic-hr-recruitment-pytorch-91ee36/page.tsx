...
export const metadata: Metadata = {
  title: 'Dynamic HR Recruitment PyTorch (Education)',
  description: 'Dynamic HR Recruitment PyTorch (Education) is an AI-powered education solution that transforms how businesses operate through intelligent automation and real-ti',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Dynamic HR Recruitment PyTorch (Education)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Dynamic HR Recruitment PyTorch (Education) is an AI-powered education solution that transforms how businesses operate through intelligent automation and real-time analytics.
