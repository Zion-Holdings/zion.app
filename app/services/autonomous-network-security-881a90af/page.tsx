...
export const metadata: Metadata = {
  title: 'Autonomous Network Security',
  description: 'Transform your finance operations with our Autonomous Network Security. This AI-driven solution automates customer service automation with unprecedented accurac',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Autonomous Network Security. This AI-driven solution automates customer service automation with unprecedented accuracy and efficiency.
          </p>
