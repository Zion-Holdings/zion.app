...
export const metadata: Metadata = {
  title: 'Neural Competitive Platform',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Competitive Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with Neural Competitive Platform. This AI-powered platform transforms document processing into a competitive advantage.
          </p>
