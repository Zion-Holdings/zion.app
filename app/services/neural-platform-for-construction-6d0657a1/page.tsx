...
export const metadata: Metadata = {
  title: 'Neural Platform for Construction',
  description: 'Revolutionize construction through intelligent automation. Our Neural Platform for Construction leverages advanced machine learning to deliver performance monit',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-platform-for-construction-6d0657a1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Platform for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Neural Platform for Construction leverages advanced machine learning to deliver performance monitoring at scale.
          </p>
