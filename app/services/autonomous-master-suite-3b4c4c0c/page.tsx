...
export const metadata: Metadata = {
  title: 'Autonomous Master Suite',
  description: 'Next-generation legal solution: Autonomous Master Suite. Combines executive dashboards with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-master-suite-3b4c4c0c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Master Suite
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Autonomous Master Suite. Combines executive dashboards with adaptive intelligence for optimal results.
          </p>
