...
export const metadata: Metadata = {
  ...
  keywords: 'HIPAA ready, Offline capabilities, Microservices deployment, SOC 2 certified, insights, construction, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Smart Supply Predictor</h1>
        <p className="text-lg text-slate-300 mb-8">Revolutionize construction through intelligent automation. Our Smart Supply Predictor leverages advanced machine learning to deliver security monitoring at scale.</p>
