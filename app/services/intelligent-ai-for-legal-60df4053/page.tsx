...
export const metadata: Metadata = {
  title: 'Intelligent AI for Legal',
  description: 'Drive innovation in legal with Intelligent AI for Legal. This AI-powered platform transforms container orchestration into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-ai-for-legal-60df4053',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent AI for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Intelligent AI for Legal. This AI-powered platform transforms container orchestration into a competitive advantage.
          </p>
