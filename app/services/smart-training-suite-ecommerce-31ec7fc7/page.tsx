...
export const metadata: Metadata = {
  title: 'Smart Training Suite - Ecommerce',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Training Suite - Ecommerce
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your ecommerce with Smart Training Suite - Ecommerce. Our autonomous solution handles inventory management end-to-end without human intervention.
          </p>
