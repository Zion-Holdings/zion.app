...
export const metadata: Metadata = {
  ...
  description: 'anomaly detection solution for defense industry. Generates financial forecasts, budget plans, and performance analyses using machine learning models.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/anomaly-detection-ai-financial-planning--analysis-3398242b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            anomaly detection solution for defense industry. Generates financial forecasts, budget plans, and performance analyses using machine learning models.
          </p>
