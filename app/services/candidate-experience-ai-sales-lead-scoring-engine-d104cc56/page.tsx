...
export const metadata: Metadata = {
  title: 'Candidate Experience AI Sales Lead Scoring Engine',
  description: 'candidate experience solution for border services industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/candidate-experience-ai-sales-lead-scoring-engine-d104cc56',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Candidate Experience AI Sales Lead Scoring Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            candidate experience solution for border services industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.
          </p>
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-purple-900/30 text-purple-300 text-sm">
            <span className="mr-2">💡</span>
            <span>Border Services</span>
          </div>
        </div>
