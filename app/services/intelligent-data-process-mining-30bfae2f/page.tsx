...
export const metadata: Metadata = {
  title: 'Intelligent Data Process Mining',
  description: 'Transform your healthcare operations with our Intelligent Data Process Mining. This AI-driven solution automates code optimization with unprecedented accuracy a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Data Process Mining
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Intelligent Data Process Mining. This AI-driven solution automates code optimization with unprecedented accuracy and efficiency.
          </p>
