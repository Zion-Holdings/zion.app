...
export const metadata: Metadata = {
  title: 'Smart Intelligent Platform - Finance',
  description: 'Unlock unprecedented growth with Smart Intelligent Platform - Finance. This autonomous system provides employee engagement with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-intelligent-platform-finance-0deaf97e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Intelligent Platform - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Intelligent Platform - Finance. This autonomous system provides employee engagement with zero manual intervention needed.
          </p>
