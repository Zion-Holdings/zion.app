...
export const metadata: Metadata = {
  title: 'Intelligence Adaptive - Healthcare',
  description: 'Optimize your healthcare workflows with Intelligence Adaptive - Healthcare. This intelligent platform delivers financial risk management through advanced automa',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligence Adaptive - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Intelligence Adaptive - Healthcare. This intelligent platform delivers financial risk management through advanced automation and AI.
          </p>
