...
export const metadata: Metadata = {
  ...
  description: 'Creates intelligent chatbots for customer service and lead generation.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-chatbot-builder-b3675d51',
  },

export const metadata = {
  title: "AI-Powered Chatbot Builder - Zion Tech Group",
  description: "Creates intelligent chatbots for customer service and lead generation.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-chatbot-builder-b3675d51`
  }
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Creates intelligent chatbots for customer service and lead generation.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your customer service operations?</p>
    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">AI-Powered Chatbot Builder</h1>
        <p className="text-lg text-gray-300 mb-8">Creates intelligent chatbots for customer service and lead generation.</p>
