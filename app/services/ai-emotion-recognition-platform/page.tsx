...
export const metadata: Metadata = {
  ...
  keywords: 'Facial emotion detection (7 basic emotions), Voice tone and prosody analysis, Text sentiment and emotion detection, Real-time streaming API, On-device processing for privacy, Emotion timeline visualization, Demographic-aware analysis, Integration with video conferencing tools, ai, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Emotion Recognition Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Real-time emotion and sentiment analysis from facial expressions, voice tone, and text. Used for customer experience optimization, market research, and mental health screening. GDPR-compliant with on-device processing option.</p>
        ...
        <li class="text-slate-300">Facial emotion detection (7 basic emotions)</li>
        <li class="text-slate-300">Voice tone and prosody analysis</li>
        <li class="text-slate-300">Text sentiment and emotion detection</li>
        <li class="text-slate-300">Real-time streaming API</li>
        <li class="text-slate-300">On-device processing for privacy</li>
        <li class="text-slate-300">Emotion timeline visualization</li>
        <li class="text-slate-300">Demographic-aware analysis</li>
        <li class="text-slate-300">Integration with video conferencing tools</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Understand customer emotions in real-time</li>
        <li class="text-slate-300">Improve product experience with emotional data</li>
        <li class="text-slate-300">Mental health screening support</li>
        <li class="text-slate-300">Privacy-first architecture</li>
      </ul>
        </div>
