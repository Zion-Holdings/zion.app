...
export const metadata: Metadata = {
  title: 'AI Image - Healthcare Edition',
  description: 'Enhance your healthcare business with AI Image - Healthcare Edition. Our solution provides risk assessment with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-image-healthcare-edition-6b6ac683',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Image - Healthcare Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with AI Image - Healthcare Edition. Our solution provides risk assessment with enterprise-grade reliability and security.
          </p>
