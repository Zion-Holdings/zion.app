...
export const metadata: Metadata = {
  title: 'Smart Platform Platform - Agriculture',
  description: 'The future of agriculture is here with Smart Platform Platform - Agriculture. Powered by cutting-edge AI, this platform delivers hr analytics like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-platform-platform-agriculture-697da048',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Platform Platform - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Smart Platform Platform - Agriculture. Powered by cutting-edge AI, this platform delivers hr analytics like never before.
          </p>
