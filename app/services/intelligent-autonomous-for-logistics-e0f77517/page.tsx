...
export const metadata: Metadata = {
  title: 'Intelligent Autonomous for Logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Intelligent Autonomous for Logistics leverages advanced machine learning to deliver procurement auto',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-autonomous-for-logistics-e0f77517',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Autonomous for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Intelligent Autonomous for Logistics leverages advanced machine learning to deliver procurement automation at scale.
          </p>
