...
export const metadata: Metadata = {
  title: 'Cognitive Management Solution - Construction',
  description: 'Optimize your construction workflows with Cognitive Management Solution - Construction. This intelligent platform delivers churn prediction through advanced aut',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-management-solution-construction-40de6749',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Management Solution - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Cognitive Management Solution - Construction. This intelligent platform delivers churn prediction through advanced automation and AI.
          </p>
