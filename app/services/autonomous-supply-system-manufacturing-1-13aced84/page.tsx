...
export const metadata: Metadata = {
  title: 'Autonomous Supply System - Manufacturing #1',
  description: 'Enhance your manufacturing business with Autonomous Supply System - Manufacturing #1. Our solution provides skills management with enterprise-grade reliability ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-supply-system-manufacturing-1-13aced84',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Supply System - Manufacturing #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your manufacturing business with Autonomous Supply System - Manufacturing #1. Our solution provides skills management with enterprise-grade reliability and security.
          </p>
