...
export const metadata: Metadata = {
  title: 'Cognitive Security Solution - Hospitality #2',
  description: 'Unlock unprecedented growth with Cognitive Security Solution - Hospitality #2. This autonomous system provides document processing with zero manual intervention',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-security-solution-hospitality-2-a58bad11',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Security Solution - Hospitality #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Cognitive Security Solution - Hospitality #2. This autonomous system provides document processing with zero manual intervention needed.
          </p>
