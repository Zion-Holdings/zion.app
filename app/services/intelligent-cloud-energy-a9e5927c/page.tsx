...
export const metadata: Metadata = {
  title: 'Intelligent cloud-energy',
  description: 'Enhance your energy business with Intelligent cloud-energy. Our solution provides sourcing optimization with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-cloud-energy-a9e5927c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your energy business with Intelligent cloud-energy. Our solution provides sourcing optimization with enterprise-grade reliability and security.
          </p>
