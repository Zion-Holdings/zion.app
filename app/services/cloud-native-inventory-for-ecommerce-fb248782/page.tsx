...
export const metadata: Metadata = {
  title: 'Cloud-Native Inventory for Ecommerce',
  description: 'Enhance your ecommerce business with Cloud-Native Inventory for Ecommerce. Our solution provides anomaly detection with enterprise-grade reliability and securit',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cloud-Native Inventory for Ecommerce
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your ecommerce business with Cloud-Native Inventory for Ecommerce. Our solution provides anomaly detection with enterprise-grade reliability and security.
          </p>
