...
export const metadata: Metadata = {
  title: 'Cognitive Intelligence for Logistics',
  description: 'Next-generation logistics solution: Cognitive Intelligence for Logistics. Combines risk assessment with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-intelligence-for-logistics-5a141c1a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Intelligence for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Cognitive Intelligence for Logistics. Combines risk assessment with adaptive intelligence for optimal results.
          </p>
