      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart process-regtech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your regtech business with Smart process-regtech. Our solution provides budget management with enterprise-grade reliability and security.
          </p>
