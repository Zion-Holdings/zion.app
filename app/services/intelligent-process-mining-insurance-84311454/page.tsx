...
export const metadata: Metadata = {
  title: 'Intelligent process mining-insurance',
  description: 'Transform your insurance operations with our Intelligent process mining-insurance. This AI-driven solution automates content generation with unprecedented accur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-process-mining-insurance-84311454',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent process mining-insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Intelligent process mining-insurance. This AI-driven solution automates content generation with unprecedented accuracy and efficiency.
          </p>
