...
export const metadata: Metadata = {
  title: 'WMS Cloud-Native Security Posture Manager',
  description: 'AI-powered wms solution for security. Automated security compliance and threat detection across cloud environments.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/wms-cloud-native-security-posture-manager-2793aea0',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            WMS Cloud-Native Security Posture Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered wms solution for security. Automated security compliance and threat detection across cloud environments.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your wms operations?</p>
