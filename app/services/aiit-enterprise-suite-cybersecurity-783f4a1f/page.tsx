...
export const metadata: Metadata = {
  title: 'AI/IT Enterprise Suite - Cybersecurity',
  description: 'Transform your cybersecurity operations with our AI/IT Enterprise Suite - Cybersecurity. This AI-driven solution automates risk assessment with unprecedented ac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-enterprise-suite-cybersecurity-783f4a1f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Enterprise Suite - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your cybersecurity operations with our AI/IT Enterprise Suite - Cybersecurity. This AI-driven solution automates risk assessment with unprecedented accuracy and efficiency.
          </p>
