...
export const metadata: Metadata = {
  title: 'Predictive Smart Engine - Insurance',
  description: 'The future of insurance is here with Predictive Smart Engine - Insurance. Powered by cutting-edge AI, this platform delivers feature engineering like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-smart-engine-insurance-586fbe7b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Smart Engine - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Predictive Smart Engine - Insurance. Powered by cutting-edge AI, this platform delivers feature engineering like never before.
          </p>
