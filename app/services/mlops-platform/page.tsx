...
export const metadata: Metadata = {
  ...
  keywords: 'Experiment tracking, Model registry & version, ML pipeline CI/CD, Feature store, Model drift monitoring, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">MLOps Platform</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end ML lifecycle platform: experiment tracking, model registry, CI/CD for ML, feature store, and monitoring dashboards.</p>
        ...
        <li class="text-slate-300">Experiment tracking</li>
        <li class="text-slate-300">Model registry &amp; version</li>
        <li class="text-slate-300">ML pipeline CI/CD</li>
        <li class="text-slate-300">Feature store</li>
        <li class="text-slate-300">Model drift monitoring</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with mlops platform</li>
