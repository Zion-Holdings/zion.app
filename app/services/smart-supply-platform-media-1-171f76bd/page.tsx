...
export const metadata: Metadata = {
  title: 'Smart Supply Platform - Media #1',
  description: 'Next-generation media solution: Smart Supply Platform - Media #1. Combines api management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-supply-platform-media-1-171f76bd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Supply Platform - Media #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation media solution: Smart Supply Platform - Media #1. Combines api management with adaptive intelligence for optimal results.
          </p>
