...
export const metadata: Metadata = {
  title: 'AI/IT Finance Suite - CLEANTECH',
  description: 'Transform your cleantech operations with our AI/IT Finance Suite - CLEANTECH. This AI-driven solution automates user provisioning with unprecedented accuracy an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Finance Suite - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your cleantech operations with our AI/IT Finance Suite - CLEANTECH. This AI-driven solution automates user provisioning with unprecedented accuracy and efficiency.
          </p>
