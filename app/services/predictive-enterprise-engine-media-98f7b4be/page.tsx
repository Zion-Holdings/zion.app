...
export const metadata: Metadata = {
  ...
  description: 'Optimize your media workflows with Predictive Enterprise Engine - Media. This intelligent platform delivers process automation through advanced automation and A',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your media workflows with Predictive Enterprise Engine - Media. This intelligent platform delivers process automation through advanced automation and AI.
          </p>
