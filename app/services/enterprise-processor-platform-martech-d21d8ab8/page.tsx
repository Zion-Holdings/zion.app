...
export const metadata: Metadata = {
  title: 'Enterprise Processor Platform - MARTECH',
  description: 'Unlock unprecedented growth with Enterprise Processor Platform - MARTECH. This autonomous system provides sales process optimization with zero manual interventi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-processor-platform-martech-d21d8ab8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Processor Platform - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Enterprise Processor Platform - MARTECH. This autonomous system provides sales process optimization with zero manual intervention needed.
          </p>
