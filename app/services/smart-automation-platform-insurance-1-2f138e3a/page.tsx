...
export const metadata: Metadata = {
  title: 'Smart Automation Platform - Insurance #1',
  description: 'Drive innovation in insurance with Smart Automation Platform - Insurance #1. This AI-powered platform transforms brand sentiment into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-automation-platform-insurance-1-2f138e3a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Automation Platform - Insurance #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Smart Automation Platform - Insurance #1. This AI-powered platform transforms brand sentiment into a competitive advantage.
          </p>
