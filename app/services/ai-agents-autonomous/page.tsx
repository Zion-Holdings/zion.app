      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Reasoning & Planning</li>
            <li className="text-purple-300">✓ Tool & API Integration</li>
            <li className="text-purple-300">✓ Multi-Agent Orchestration</li>
            <li className="text-purple-300">✓ Human-in-the-Loop</li>
            <li className="text-purple-300">✓ Memory & Context</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai agents & autonomous workflows</li>
