...
export const metadata: Metadata = {
  title: 'Next-Gen NLP for Education',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen NLP for Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your education operations with our Next-Gen NLP for Education. This AI-driven solution automates serverless orchestration with unprecedented accuracy and efficiency.
          </p>
