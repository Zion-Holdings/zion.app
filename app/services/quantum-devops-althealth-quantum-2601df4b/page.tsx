...
export const metadata: Metadata = {
  title: 'Quantum DevOps - ALTHEALTH Quantum',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum DevOps - ALTHEALTH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in althealth with Quantum DevOps - ALTHEALTH Quantum. This AI-powered platform transforms net promoter score into a competitive advantage.
          </p>
