...
export const metadata: Metadata = {
  title: 'Intelligent Neural for Legal',
  description: 'Revolutionize legal through intelligent automation. Our Intelligent Neural for Legal leverages advanced machine learning to deliver testing automation at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-neural-for-legal-230a2ba8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Neural for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Intelligent Neural for Legal leverages advanced machine learning to deliver testing automation at scale.
          </p>
