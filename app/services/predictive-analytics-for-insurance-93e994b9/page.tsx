...
export const metadata: Metadata = {
  title: 'Predictive Analytics for Insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Predictive Analytics for Insurance leverages advanced machine learning to deliver user experience at scale.
          </p>
