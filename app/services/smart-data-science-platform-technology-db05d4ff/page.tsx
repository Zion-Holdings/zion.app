...
export const metadata: Metadata = {
  title: 'Smart Data Science Platform - TECHNOLOGY',
  description: 'Drive innovation in technology with Smart Data Science Platform - TECHNOLOGY. This AI-powered platform transforms invoice automation into a competitive advantag',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-data-science-platform-technology-db05d4ff',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Data Science Platform - TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in technology with Smart Data Science Platform - TECHNOLOGY. This AI-powered platform transforms invoice automation into a competitive advantage.
          </p>
