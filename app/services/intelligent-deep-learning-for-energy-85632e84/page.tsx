...
export const metadata: Metadata = {
  title: 'Intelligent Deep Learning for Energy',
  description: 'Revolutionize energy through intelligent automation. Our Intelligent Deep Learning for Energy leverages advanced machine learning to deliver workflow management',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-deep-learning-for-energy-85632e84',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Deep Learning for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Intelligent Deep Learning for Energy leverages advanced machine learning to deliver workflow management at scale.
          </p>
