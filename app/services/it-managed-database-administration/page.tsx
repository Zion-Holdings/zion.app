...
export const metadata: Metadata = {
  ...
  keywords: '24/7 database monitoring and alerting, Automated backup and point-in-time recovery, Query performance analysis and optimization, Index tuning and schema optimization, Replication and high-availability, Security patching and upgrades, Capacity planning, Multi-cloud support, it, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Database Administration as a Service (DBAaaS)</h1>
        <p className="text-lg text-slate-300 mb-8">Fully managed database administration for PostgreSQL, MySQL, MongoDB, Redis, and cloud-native databases.</p>
        ...
        <li class="text-slate-300">Automated backup and point-in-time recovery</li>
        <li class="text-slate-300">Query performance analysis and optimization</li>
        <li class="text-slate-300">Index tuning and schema optimization</li>
        <li class="text-slate-300">Replication and high-availability</li>
        <li class="text-slate-300">Security patching and upgrades</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Eliminate database downtime</li>
        <li class="text-slate-300">Reduce database costs</li>
        <li class="text-slate-300">Free team from routine DBA tasks</li>
        <li class="text-slate-300">Ensure data security and compliance</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$399/mo per instance</p>
              <p class="text-sm text-slate-400">Getting started plan</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              <h3 class="font-semibold text-white mb-2">Pro</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">$999/mo per instance</p>
