...
export const metadata: Metadata = {
  ...
  keywords: 'Automated evidence, Gap analysis, Policy templates, Auditor portal, Continuous monitoring, Remediation tracking, Reporting, Training, it, Compliance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Audit Readiness as a Service</h1>
        <p className="text-lg text-slate-300 mb-8">Continuous audit readiness with automated evidence collection.</p>
        ...
        <li class="text-slate-300">Automated evidence</li>
        <li class="text-slate-300">Gap analysis</li>
        <li class="text-slate-300">Policy templates</li>
        <li class="text-slate-300">Auditor portal</li>
        <li class="text-slate-300">Continuous monitoring</li>
        <li class="text-slate-300">Remediation tracking</li>
        <li class="text-slate-300">Reporting</li>
        <li class="text-slate-300">Training</li>
      </ul>
        </div>
        ...
        <li class="text-slate-300">80% less prep time</li>
        <li class="text-slate-300">Fewer findings</li>
        <li class="text-slate-300">Faster audits</li>
      </ul>
        </div>
