...
export const metadata: Metadata = {
  title: 'Cognitive customer-manufacturing',
  description: 'The future of manufacturing is here with Cognitive customer-manufacturing. Powered by cutting-edge AI, this platform delivers fleet management like never before',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-customer-manufacturing-1de3dd41',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive customer-manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of manufacturing is here with Cognitive customer-manufacturing. Powered by cutting-edge AI, this platform delivers fleet management like never before.
          </p>
