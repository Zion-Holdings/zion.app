...
export const metadata: Metadata = {
  title: 'Cognitive Serverless Analytics',
  description: 'Optimize your legal workflows with Cognitive Serverless Analytics. This intelligent platform delivers code optimization through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-serverless-analytics-b36bc68d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Serverless Analytics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with Cognitive Serverless Analytics. This intelligent platform delivers code optimization through advanced automation and AI.
          </p>
