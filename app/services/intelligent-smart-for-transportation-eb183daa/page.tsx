...
export const metadata: Metadata = {
  title: 'Intelligent Smart for Transportation',
  description: 'Revolutionize transportation through intelligent automation. Our Intelligent Smart for Transportation leverages advanced machine learning to deliver disaster re',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-smart-for-transportation-eb183daa',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Smart for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize transportation through intelligent automation. Our Intelligent Smart for Transportation leverages advanced machine learning to deliver disaster recovery at scale.
          </p>
