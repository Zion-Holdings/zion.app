...
export const metadata: Metadata = {
  title: 'Edge AI AI-Powered Lead Scoring & Routing',
  description: 'AI-powered edge ai solution for sales. Scores and routes sales leads in real-time based on engagement.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/edge-ai-ai-powered-lead-scoring--routing-830b2329',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Edge AI AI-Powered Lead Scoring & Routing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered edge ai solution for sales. Scores and routes sales leads in real-time based on engagement.
          </p>
