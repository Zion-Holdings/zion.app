...
export const metadata: Metadata = {
  ...
  keywords: 'Unified observability stack (Prometheus, Grafana, Jaeger), Custom SLO/SLI definition and dashboard creation, Incident management with automated runbooks, Chaos engineering and resilience testing, SRE consulting and reliability maturity assessment, cloud, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Observability Platform &amp; SRE Consulting</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end observability implementation with distributed tracing, log aggregation, metrics collection, and Site Reliability Engineering best practices.</p>
        ...
        <li class="text-slate-300">Unified observability stack (Prometheus, Grafana, Jaeger)</li>
        <li class="text-slate-300">Custom SLO/SLI definition and dashboard creation</li>
        <li class="text-slate-300">Incident management with automated runbooks</li>
        <li class="text-slate-300">Chaos engineering and resilience testing</li>
        <li class="text-slate-300">SRE consulting and reliability maturity assessment</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with observability platform &amp; sre consulting</li>
