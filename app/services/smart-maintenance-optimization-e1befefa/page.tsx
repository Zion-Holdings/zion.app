...
export const metadata: Metadata = {
  title: 'Smart Maintenance Optimization',
  description: 'Revolutionize telecom through intelligent automation. Our Smart Maintenance Optimization leverages advanced machine learning to deliver sales forecasting at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Smart Maintenance Optimization leverages advanced machine learning to deliver sales forecasting at scale.
          </p>
