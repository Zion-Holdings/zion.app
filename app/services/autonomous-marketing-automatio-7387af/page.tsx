...
export const metadata: Metadata = {
  title: 'Autonomous Marketing Automation Microservices (It)',
  description: 'Autonomous Marketing Automation Microservices (It) is an AI-powered it solution that transforms how businesses operate through intelligent automation and real-t',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-marketing-automatio-7387af',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Marketing Automation Microservices (It)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Autonomous Marketing Automation Microservices (It) is an AI-powered it solution that transforms how businesses operate through intelligent automation and real-time analytics.
...
Spark, Kafka, Ansible, Kubernetes, Blockchain, AWS
