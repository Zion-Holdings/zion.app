...
export const metadata: Metadata = {
  ...
  keywords: 'Brand voice learning and style matching, Tone adjustment (formal, casual, persuasive), Grammar, clarity, and conciseness correction, Template library for common documents, In-line suggestions with accept/reject, Plagiarism detection, Browser extension and API, micro-saas, Productivity, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Writely — AI Writing Assistant</h1>
        <p className="text-lg text-slate-300 mb-8">AI writing assistant for business: emails, reports, proposals, and documentation. Style matching, tone adjustment, and grammar correction. Not generic — learns your brand voice.</p>
        ...
        <li class="text-slate-300">Brand voice learning and style matching</li>
        <li class="text-slate-300">Tone adjustment (formal, casual, persuasive)</li>
        <li class="text-slate-300">Grammar, clarity, and conciseness correction</li>
        <li class="text-slate-300">Template library for common documents</li>
        <li class="text-slate-300">In-line suggestions with accept/reject</li>
        <li class="text-slate-300">Plagiarism detection</li>
        <li class="text-slate-300">Browser extension and API</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">On-brand writing every time</li>
        <li class="text-slate-300">Tone adjustment for different audiences</li>
        <li class="text-slate-300">Grammar checks without losing your voice</li>
        <li class="text-slate-300">Templates accelerate common writing tasks</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$12/mo</p>
              <p class="text-sm text-slate-400">Getting started plan</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              <h3 class="font-semibold text-white mb-2">Pro</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">$35/mo</p>
