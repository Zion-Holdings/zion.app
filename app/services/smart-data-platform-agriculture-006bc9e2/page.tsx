...
export const metadata: Metadata = {
  title: 'Smart Data Platform - Agriculture',
  description: 'Next-generation agriculture solution: Smart Data Platform - Agriculture. Combines margin analysis with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-data-platform-agriculture-006bc9e2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Data Platform - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agriculture solution: Smart Data Platform - Agriculture. Combines margin analysis with adaptive intelligence for optimal results.
          </p>
