...
export const metadata: Metadata = {
  title: 'Predictive Decision Insights',
  description: 'Transform your insurance operations with our Predictive Decision Insights. This AI-driven solution automates market intelligence with unprecedented accuracy and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-decision-insights-8e06813c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Decision Insights
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Predictive Decision Insights. This AI-driven solution automates market intelligence with unprecedented accuracy and efficiency.
          </p>
