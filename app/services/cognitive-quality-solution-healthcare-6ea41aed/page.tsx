...
export const metadata: Metadata = {
  title: 'Cognitive Quality Solution - Healthcare',
  description: 'The future of healthcare is here with Cognitive Quality Solution - Healthcare. Powered by cutting-edge AI, this platform delivers access management like never b',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-quality-solution-healthcare-6ea41aed',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Quality Solution - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Cognitive Quality Solution - Healthcare. Powered by cutting-edge AI, this platform delivers access management like never before.
          </p>
