...
export const metadata: Metadata = {
  title: 'AI-Powered machine learning-technology',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in technology with AI-Powered machine learning-technology. This AI-powered platform transforms email automation into a competitive advantage.
          </p>
