...
export const metadata: Metadata = {
  ...
  description: 'Quantum leap forward for edtech: AI/IT Business Intelligence Suite - EDTECH. Uses quantum-inspired algorithms to deliver predictive analytics at exponential spe',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for edtech: AI/IT Business Intelligence Suite - EDTECH. Uses quantum-inspired algorithms to deliver predictive analytics at exponential speed.
          </p>
