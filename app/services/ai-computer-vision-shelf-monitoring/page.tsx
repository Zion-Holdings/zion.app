      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Retail shelf stock-out detection, facings count, planogram compliance, and out-of-stock alert to store manager via Slack/POS.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ YOLOv8/RT-DETR shelf item detection</li>
            <li className="text-purple-300">✓ Stock-out detection per SKU per camera</li>
            <li className="text-purple-300">✓ Facings count + planogram compliance score</li>
            <li className="text-purple-300">✓ Slack/POS out-of-stock alert auto-create ticket</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with computer vision shelf monitoring</li>
