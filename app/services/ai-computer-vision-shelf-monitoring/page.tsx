...
export const metadata: Metadata = {
  ...
  keywords: 'YOLOv8/RT-DETR shelf item detection, Stock-out detection per SKU per camera, Facings count + planogram compliance score, Slack/POS out-of-stock alert auto-create ticket, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Computer Vision Shelf Monitoring</h1>
        <p className="text-lg text-slate-300 mb-8">Retail shelf stock-out detection, facings count, planogram compliance, and out-of-stock alert to store manager via Slack/POS.</p>
        ...
        <li class="text-slate-300">YOLOv8/RT-DETR shelf item detection</li>
        <li class="text-slate-300">Stock-out detection per SKU per camera</li>
        <li class="text-slate-300">Facings count + planogram compliance score</li>
        <li class="text-slate-300">Slack/POS out-of-stock alert auto-create ticket</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with computer vision shelf monitoring</li>
