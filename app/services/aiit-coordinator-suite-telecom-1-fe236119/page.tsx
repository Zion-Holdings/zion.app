...
export const metadata: Metadata = {
  title: 'AI/IT Coordinator Suite - Telecom #1',
  description: 'Optimize your telecom workflows with AI/IT Coordinator Suite - Telecom #1. This intelligent platform delivers budget management through advanced automation and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-coordinator-suite-telecom-1-fe236119',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Coordinator Suite - Telecom #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your telecom workflows with AI/IT Coordinator Suite - Telecom #1. This intelligent platform delivers budget management through advanced automation and AI.
          </p>
