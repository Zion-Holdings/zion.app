...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-infinite-quantum-hyper-autonomous-self-evolving-quantum-infinite-hyper-autonomous-quantum-infinite-quantum-manufacturing-c2c08373",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Service - AI-Powered Manufacturing Solution
        </h1>
