...
export const metadata: Metadata = {
  ...
  keywords: 'Continuous behavioural anomaly detection across endpoint, network, and cloud telemetry, Autonomous attack chain reconstruction with MITRE ATT&CK matrix alignment, Natural-language hunt query builder for analysts without scripting skills, Auto-generated incident reports with timeline, evidence, and recommended mitigations, Low-false-positive ML scoring tuned to each environment via supervised feedback, security, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Threat Hunter</h1>
        <p className="text-lg text-slate-300 mb-8">Autonomous AI-powered threat hunting: continuous behavioural anomaly detection, novel attack chain reconstruction, MITRE ATT&amp;CK mapping, custom hunt queries, natural-language investigation interface, and auto-generated incident reports.</p>
        ...
        <li class="text-slate-300">Continuous behavioural anomaly detection across endpoint, network, and cloud telemetry</li>
        <li class="text-slate-300">Autonomous attack chain reconstruction with MITRE ATT&amp;CK matrix alignment</li>
        <li class="text-slate-300">Natural-language hunt query builder for analysts without scripting skills</li>
        <li class="text-slate-300">Auto-generated incident reports with timeline, evidence, and recommended mitigations</li>
        <li class="text-slate-300">Low-false-positive ML scoring tuned to each environment via supervised feedback</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai threat hunter</li>
