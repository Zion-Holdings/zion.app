...
export const metadata: Metadata = {
  title: 'Smart Account Cognitive',
  description: 'The future of education is here with Smart Account Cognitive. Powered by cutting-edge AI, this platform delivers transformative results like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-account-cognitive-dec06b2f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Account Cognitive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of education is here with Smart Account Cognitive. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
