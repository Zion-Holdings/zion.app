...
export const metadata: Metadata = {
  title: 'Cognitive Smart Solution - Legal #3',
  description: 'The future of legal is here with Cognitive Smart Solution - Legal #3. Powered by cutting-edge AI, this platform delivers predictive modeling like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-smart-solution-legal-3-355bbb97',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Smart Solution - Legal #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Cognitive Smart Solution - Legal #3. Powered by cutting-edge AI, this platform delivers predictive modeling like never before.
          </p>
