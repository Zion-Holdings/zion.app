...
export const metadata: Metadata = {
  title: 'Smart Experience Platform - Hospitality',
  description: 'Drive innovation in hospitality with Smart Experience Platform - Hospitality. This AI-powered platform transforms data processing into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-experience-platform-hospitality-3f3e989b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Experience Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Smart Experience Platform - Hospitality. This AI-powered platform transforms data processing into a competitive advantage.
          </p>
