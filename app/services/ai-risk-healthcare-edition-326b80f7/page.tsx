...
export const metadata: Metadata = {
  title: 'AI Risk - Healthcare Edition',
  description: 'Transform your healthcare operations with our AI Risk - Healthcare Edition. This AI-driven solution automates language processing with unprecedented accuracy an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-risk-healthcare-edition-326b80f7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Risk - Healthcare Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our AI Risk - Healthcare Edition. This AI-driven solution automates language processing with unprecedented accuracy and efficiency.
          </p>
