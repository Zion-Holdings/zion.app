...
export const metadata: Metadata = {
  title: 'Autonomous Sales for Media',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Sales for Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of media is here with Autonomous Sales for Media. Powered by cutting-edge AI, this platform delivers sales forecasting like never before.
          </p>
