...
export const metadata: Metadata = {
  ...
  description: 'Transform your technology operations with our Intelligent Generator for Tech. This AI-driven solution automates process discovery with unprecedented accuracy an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your technology operations with our Intelligent Generator for Tech. This AI-driven solution automates process discovery with unprecedented accuracy and efficiency.
          </p>
