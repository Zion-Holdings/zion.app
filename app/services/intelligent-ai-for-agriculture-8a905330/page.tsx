...
export const metadata: Metadata = {
  title: 'Intelligent AI for Agriculture',
  description: 'Optimize your agriculture workflows with Intelligent AI for Agriculture. This intelligent platform delivers personalization engine through advanced automation a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-ai-for-agriculture-8a905330',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent AI for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your agriculture workflows with Intelligent AI for Agriculture. This intelligent platform delivers personalization engine through advanced automation and AI.
          </p>
