...
export const metadata: Metadata = {
  title: 'Intelligent Customer for FINTECH',
  description: 'Optimize your fintech workflows with Intelligent Customer for FINTECH. This intelligent platform delivers data pipeline orchestration through advanced automatio',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Customer for FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your fintech workflows with Intelligent Customer for FINTECH. This intelligent platform delivers data pipeline orchestration through advanced automation and AI.
          </p>
