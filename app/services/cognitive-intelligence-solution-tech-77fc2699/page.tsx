...
export const metadata: Metadata = {
  title: 'Cognitive Intelligence Solution - Tech',
  description: 'Drive innovation in technology with Cognitive Intelligence Solution - Tech. This AI-powered platform transforms audit trail management into a competitive advant',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-intelligence-solution-tech-77fc2699',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Intelligence Solution - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in technology with Cognitive Intelligence Solution - Tech. This AI-powered platform transforms audit trail management into a competitive advantage.
          </p>
