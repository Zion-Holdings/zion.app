...
export const metadata: Metadata = {
  title: 'AI/IT Analyzer Suite - Sports',
  description: 'Revolutionize sports through intelligent automation. Our AI/IT Analyzer Suite - Sports leverages advanced machine learning to deliver form processing at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-analyzer-suite-sports-2249b45b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Analyzer Suite - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our AI/IT Analyzer Suite - Sports leverages advanced machine learning to deliver form processing at scale.
          </p>
