...
export const metadata: Metadata = {
  title: 'Automated Smart for Manufacturing',
  description: 'The future of manufacturing is here with Automated Smart for Manufacturing. Powered by cutting-edge AI, this platform delivers scenario planning like never befo',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Smart for Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of manufacturing is here with Automated Smart for Manufacturing. Powered by cutting-edge AI, this platform delivers scenario planning like never before.
          </p>
