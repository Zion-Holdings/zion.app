...
export const metadata: Metadata = {
  title: 'Intelligent Authorization for Education',
  description: 'Future-proof your education with Intelligent Authorization for Education. Our autonomous solution handles content generation end-to-end without human interventi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Authorization for Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your education with Intelligent Authorization for Education. Our autonomous solution handles content generation end-to-end without human intervention.
          </p>
