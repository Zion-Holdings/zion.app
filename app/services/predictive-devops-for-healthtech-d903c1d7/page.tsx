...
export const metadata: Metadata = {
  title: 'Predictive DevOps for HEALTHTECH',
  description: 'Revolutionize healthtech through intelligent automation. Our Predictive DevOps for HEALTHTECH leverages advanced machine learning to deliver sentiment analysis ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive DevOps for HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthtech through intelligent automation. Our Predictive DevOps for HEALTHTECH leverages advanced machine learning to deliver sentiment analysis at scale.
          </p>
