...
export const metadata: Metadata = {
  title: 'Customer Journey Mapping Intelligent Document Processing AI',
  description: 'customer journey mapping solution for faith-based industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents au',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/customer-journey-mapping-intelligent-document-processing-ai-ac36062e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Customer Journey Mapping Intelligent Document Processing AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            customer journey mapping solution for faith-based industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.
          </p>
