...
export const metadata: Metadata = {
  ...
  keywords: 'Lead scoring + nurture per segment, Multi-channel orchestration: email/SMS/push/ads, Campaign A/B test + auto-optimize per winner, Attribution + analytics per campaign, CRM sync + customer journey canvas, automation, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Marketing Automation Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Full marketing automation: lead scoring, nurture campaigns, A/B test + auto-optimize, multi-channel (email/SMS/push/social/ads), CRM sync, customer journey per segment.</p>
        ...
        <li class="text-slate-300">Lead scoring + nurture per segment</li>
        <li class="text-slate-300">Multi-channel orchestration: email/SMS/push/ads</li>
        <li class="text-slate-300">Campaign A/B test + auto-optimize per winner</li>
        <li class="text-slate-300">Attribution + analytics per campaign</li>
        <li class="text-slate-300">CRM sync + customer journey canvas</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with marketing automation platform</li>
