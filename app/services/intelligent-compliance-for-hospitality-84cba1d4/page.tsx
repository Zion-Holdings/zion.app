...
export const metadata: Metadata = {
  title: 'Intelligent Compliance for Hospitality',
  description: 'The future of hospitality is here with Intelligent Compliance for Hospitality. Powered by cutting-edge AI, this platform delivers document processing like never',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-compliance-for-hospitality-84cba1d4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Compliance for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Intelligent Compliance for Hospitality. Powered by cutting-edge AI, this platform delivers document processing like never before.
          </p>
