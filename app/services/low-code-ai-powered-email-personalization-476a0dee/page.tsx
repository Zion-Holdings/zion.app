...
export const metadata: Metadata = {
  title: 'Low-code AI-Powered Email Personalization',
  description: 'AI-powered low-code solution for email marketing. Creates hyper-personalized email campaigns by analyzing recipient data.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/low-code-ai-powered-email-personalization-476a0dee',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Low-code AI-Powered Email Personalization
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered low-code solution for email marketing. Creates hyper-personalized email campaigns by analyzing recipient data.
          </p>
