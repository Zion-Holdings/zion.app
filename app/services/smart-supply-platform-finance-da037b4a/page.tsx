...
export const metadata: Metadata = {
  title: 'Smart Supply Platform - Finance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Supply Platform - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation finance solution: Smart Supply Platform - Finance. Combines performance tuning with adaptive intelligence for optimal results.
          </p>
