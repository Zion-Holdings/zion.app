...
export const metadata: Metadata = {
  title: 'AI Risk - Gaming Edition',
  description: 'The future of gaming is here with AI Risk - Gaming Edition. Powered by cutting-edge AI, this platform delivers data governance like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-risk-gaming-edition-b26d49e3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Risk - Gaming Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of gaming is here with AI Risk - Gaming Edition. Powered by cutting-edge AI, this platform delivers data governance like never before.
          </p>
