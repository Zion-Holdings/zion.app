...
export const metadata: Metadata = {
  title: 'AI Finance - Media Edition',
  description: 'Transform your media operations with our AI Finance - Media Edition. This AI-driven solution automates language processing with unprecedented accuracy and effic',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Finance - Media Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your media operations with our AI Finance - Media Edition. This AI-driven solution automates language processing with unprecedented accuracy and efficiency.
          </p>
