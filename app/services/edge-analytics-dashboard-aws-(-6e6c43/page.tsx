...
export const metadata: Metadata = {
  title: 'Edge Analytics Dashboard AWS (Api)',
  description: 'Edge Analytics Dashboard AWS (Api) is an AI-powered api solution that transforms how businesses operate through intelligent automation and real-time analytics.
',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/edge-analytics-dashboard-aws-(-6e6c43',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Edge Analytics Dashboard AWS (Api)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Edge Analytics Dashboard AWS (Api) is an AI-powered api solution that transforms how businesses operate through intelligent automation and real-time analytics.
...
Azure, Computer Vision, MongoDB, Vue.js, GCP, IoT
