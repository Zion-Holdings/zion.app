...
export const metadata: Metadata = {
  title: 'Autonomous Security for Agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Autonomous Security for Agriculture leverages advanced machine learning to deliver risk assessment',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-security-for-agriculture-792ca58e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Security for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Autonomous Security for Agriculture leverages advanced machine learning to deliver risk assessment at scale.
          </p>
