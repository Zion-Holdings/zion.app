...
export const metadata: Metadata = {
  title: 'AI/IT Strategic Suite - CLEANTECH',
  description: 'Optimize your cleantech workflows with AI/IT Strategic Suite - CLEANTECH. This intelligent platform delivers hr analytics through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-strategic-suite-cleantech-ca5997de',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Strategic Suite - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your cleantech workflows with AI/IT Strategic Suite - CLEANTECH. This intelligent platform delivers hr analytics through advanced automation and AI.
          </p>
