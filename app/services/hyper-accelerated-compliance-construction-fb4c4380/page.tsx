...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Compliance - Construction',
  description: 'Transform your construction operations with our Hyper-Accelerated Compliance - Construction. This AI-driven solution automates invoice processing with unprecede',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Compliance - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Hyper-Accelerated Compliance - Construction. This AI-driven solution automates invoice processing with unprecedented accuracy and efficiency.
          </p>
