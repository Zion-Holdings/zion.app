...
export const metadata: Metadata = {
  title: 'Smart Optimization Platform - Legal',
  description: 'Next-generation legal solution: Smart Optimization Platform - Legal. Combines resource utilization with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-optimization-platform-legal-31b5c1d6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Optimization Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Smart Optimization Platform - Legal. Combines resource utilization with adaptive intelligence for optimal results.
          </p>
