...
export const metadata: Metadata = {
  title: 'Route Optimization AI-Powered SEO Content Engine',
  description: 'route optimization solution for nuclear energy industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing cop',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/route-optimization-ai-powered-seo-content-engine-fa99c790',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Route Optimization AI-Powered SEO Content Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            route optimization solution for nuclear energy industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing copy.
          </p>
