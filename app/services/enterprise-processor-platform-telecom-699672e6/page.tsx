...
export const metadata: Metadata = {
  title: 'Enterprise Processor Platform - Telecom',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Processor Platform - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your telecom operations with our Enterprise Processor Platform - Telecom. This AI-driven solution automates claims processing with unprecedented accuracy and efficiency.
          </p>
