...
export const metadata: Metadata = {
  title: 'Cloud Intelligent - Education',
  description: 'Transform your education operations with our Cloud Intelligent - Education. This AI-driven solution automates market intelligence with unprecedented accuracy an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cloud-intelligent-education-fe94d694',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cloud Intelligent - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your education operations with our Cloud Intelligent - Education. This AI-driven solution automates market intelligence with unprecedented accuracy and efficiency.
          </p>
