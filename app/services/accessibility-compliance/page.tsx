      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Automated WCAG 2.2 auditing, AI-powered remediation suggestions, screen reader simulation, and continuous accessibility compliance monitoring.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ WCAG 2.2 AA/AAA automated auditing</li>
            <li className="text-purple-300">✓ Screen reader simulation & navigation testing</li>
            <li className="text-purple-300">✓ Auto-generated remediation code snippets</li>
            <li className="text-purple-300">✓ Color contrast & typography analysis</li>
            <li className="text-purple-300">✓ Continuous CI/CD accessibility gates</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with accessibility & wcag compliance</li>
