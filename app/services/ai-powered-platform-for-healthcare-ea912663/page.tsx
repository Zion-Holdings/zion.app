...
export const metadata: Metadata = {
  title: 'AI-Powered Platform for Healthcare',
  description: 'Transform your healthcare operations with our AI-Powered Platform for Healthcare. This AI-driven solution automates threat detection with unprecedented accuracy',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-platform-for-healthcare-ea912663',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Platform for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our AI-Powered Platform for Healthcare. This AI-driven solution automates threat detection with unprecedented accuracy and efficiency.
          </p>
