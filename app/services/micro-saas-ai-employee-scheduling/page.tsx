...
export const metadata: Metadata = {
  ...
  keywords: 'AI demand forecasting for staffing needs, Auto-scheduling with employee preference matching, Labor law compliance checking (breaks, overtime, minors), Shift swapping and open shift marketplace, Time and attendance tracking, Integration with payroll systems, Mobile app for employees, Analytics on labor costs and overtime, ai, hr-tech, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Employee Scheduling &amp; Workforce Planning</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered employee scheduling that optimizes shifts based on demand forecasts, employee preferences, skills, and labor law compliance.</p>
        ...
        <li class="text-slate-300">AI demand forecasting for staffing needs</li>
        <li class="text-slate-300">Auto-scheduling with employee preference matching</li>
        <li class="text-slate-300">Labor law compliance checking (breaks, overtime, minors)</li>
        <li class="text-slate-300">Shift swapping and open shift marketplace</li>
        <li class="text-slate-300">Time and attendance tracking</li>
        <li class="text-slate-300">Integration with payroll systems</li>
        <li class="text-slate-300">Mobile app for employees</li>
        <li class="text-slate-300">Analytics on labor costs and overtime</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce labor costs by 15%</li>
        <li class="text-slate-300">Eliminate scheduling conflicts automatically</li>
        <li class="text-slate-300">Ensure 100% labor law compliance</li>
        <li class="text-slate-300">Improve employee satisfaction with preference matching</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$8/employee/mo</p>
              <p class="text-sm text-slate-400">Getting started plan</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              <h3 class="font-semibold text-white mb-2">Pro</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">$15/employee/mo</p>
