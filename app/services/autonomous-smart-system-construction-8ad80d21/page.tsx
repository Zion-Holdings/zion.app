...
export const metadata: Metadata = {
  title: 'Autonomous Smart System - Construction',
  description: 'Enhance your construction business with Autonomous Smart System - Construction. Our solution provides risk assessment with enterprise-grade reliability and secu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-smart-system-construction-8ad80d21',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Smart System - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Autonomous Smart System - Construction. Our solution provides risk assessment with enterprise-grade reliability and security.
          </p>
