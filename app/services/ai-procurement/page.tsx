...
export const metadata: Metadata = {
  ...
  keywords: 'Auto-sourcing + supplier matching, Price comparison + contract negotiation, Delivery tracking + SLA monitoring, Supplier risk scoring + scorecard, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Procurement Intelligence</h1>
        <p className="text-lg text-slate-300 mb-8">Auto-sources suppliers compares prices negotiates contracts tracks delivery and manages supplier risk: e-procurement spend analysis contract mgmt supplier scorecards.</p>
        ...
        <li class="text-slate-300">Auto-sourcing + supplier matching</li>
        <li class="text-slate-300">Price comparison + contract negotiation</li>
        <li class="text-slate-300">Delivery tracking + SLA monitoring</li>
        <li class="text-slate-300">Supplier risk scoring + scorecard</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai procurement intelligence</li>
