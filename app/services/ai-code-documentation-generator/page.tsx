...
export const metadata: Metadata = {
  ...
  keywords: 'Auto-generate API documentation, Inline comment generation, Architecture diagram extraction, README and changelog generation, Multi-language support (30+), Swagger/OpenAPI spec generation, Integration with GitHub, GitLab, Bitbucket, Custom documentation templates, ai, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Code Documentation Generator</h1>
        <p className="text-lg text-slate-300 mb-8">Automatically generate comprehensive documentation from source code. Produces API docs, inline comments, README files, architecture diagrams, and changelogs. Supports 30+ programming languages.</p>
        ...
        <li class="text-slate-300">Auto-generate API documentation</li>
        <li class="text-slate-300">Inline comment generation</li>
        <li class="text-slate-300">Architecture diagram extraction</li>
        <li class="text-slate-300">README and changelog generation</li>
        <li class="text-slate-300">Multi-language support (30+)</li>
        <li class="text-slate-300">Swagger/OpenAPI spec generation</li>
        <li class="text-slate-300">Integration with GitHub, GitLab, Bitbucket</li>
        <li class="text-slate-300">Custom documentation templates</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Always up-to-date documentation</li>
        <li class="text-slate-300">Reduce documentation time by 90%</li>
        <li class="text-slate-300">Improve code onboarding</li>
        <li class="text-slate-300">Consistent documentation style</li>
      </ul>
        </div>
