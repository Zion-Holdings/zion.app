...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={@context: "https://schema.org", @type: "Service", name: "MicroSaaS Expense Tracker | Zion Tech Group", description: "End-to-end microsaas expense tracker services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/micro-saas-ai-expense-tracker-2026-8162/"} />
