...
export const metadata: Metadata = {
  title: 'Records Management AI-Powered SEO Content Engine',
  description: 'records management solution for cultural heritage industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/records-management-ai-powered-seo-content-engine-b08ec3b1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Records Management AI-Powered SEO Content Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            records management solution for cultural heritage industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing copy.
          </p>
