...
export const metadata: Metadata = {
  title: 'Intelligent Manager for Telecom',
  description: 'Revolutionize telecom through intelligent automation. Our Intelligent Manager for Telecom leverages advanced machine learning to deliver vendor management at sc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-manager-for-telecom-53166ecc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Manager for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Intelligent Manager for Telecom leverages advanced machine learning to deliver vendor management at scale.
          </p>
