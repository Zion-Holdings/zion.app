...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize manufacturing through intelligent automation. Our Autonomous Sales System - Manufacturing leverages advanced machine learning to deliver sentiment',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize manufacturing through intelligent automation. Our Autonomous Sales System - Manufacturing leverages advanced machine learning to deliver sentiment analysis at scale.
          </p>
