...
export const metadata = {
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-analytics-platform-for-telecommunications-b82f3b37`
  }
};
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>Process 22% faster with automation</li>
        ...
        <div className="border border-purple-500 rounded-xl p-6 mb-8">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="bg-slate-800 p-4 rounded-lg border-2 border-purple-500">
              ...
              <p className="text-2xl font-bold mb-2">$373/month</p>
            </div>
            <div className="bg-slate-800 p-4 rounded-lg">
              <h3 className="font-semibold mb-2">Enterprise</h3>
              <p className="text-2xl font-bold mb-2">$937/month</p>
            </div>
          </div>
        </div>
