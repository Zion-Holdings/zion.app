...
export const metadata: Metadata = {
  title: 'Next-Gen Pipeline - Real-Estate',
  description: 'Transform your real-estate operations with our Next-Gen Pipeline - Real-Estate. This AI-driven solution automates decision support with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-pipeline-real-estate-3aa6d946',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Pipeline - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Next-Gen Pipeline - Real-Estate. This AI-driven solution automates decision support with unprecedented accuracy and efficiency.
          </p>
