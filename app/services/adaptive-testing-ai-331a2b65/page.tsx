...
export const metadata: Metadata = {
  title: 'Adaptive Testing AI',
  description: 'Revolutionize real-estate through intelligent automation. Our Adaptive Testing AI leverages advanced machine learning to deliver enterprise-grade insights at sc',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our Adaptive Testing AI leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
