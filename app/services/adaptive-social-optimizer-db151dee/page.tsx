...
export const metadata: Metadata = {
  title: 'Adaptive Social Optimizer',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Social Optimizer
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Adaptive Social Optimizer. This intelligent platform delivers recruitment automation through advanced automation and AI.
          </p>
