...
export const metadata: Metadata = {
  title: 'AI/IT Executive Suite - Cybersecurity',
  description: 'Hyper-accelerated cybersecurity solution: AI/IT Executive Suite - Cybersecurity. Combines model interpretability with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-executive-suite-cybersecurity-7e4dc906',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Executive Suite - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated cybersecurity solution: AI/IT Executive Suite - Cybersecurity. Combines model interpretability with next-gen AI for maximum velocity.
          </p>
