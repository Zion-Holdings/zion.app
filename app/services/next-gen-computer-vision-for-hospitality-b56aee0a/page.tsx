...
export const metadata: Metadata = {
  title: 'Next-Gen Computer Vision for Hospitality',
  description: 'Unlock unprecedented growth with Next-Gen Computer Vision for Hospitality. This autonomous system provides api composition with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-computer-vision-for-hospitality-b56aee0a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Computer Vision for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Next-Gen Computer Vision for Hospitality. This autonomous system provides api composition with zero manual intervention needed.
          </p>
