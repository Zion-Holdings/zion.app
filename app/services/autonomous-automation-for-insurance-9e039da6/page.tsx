...
export const metadata: Metadata = {
  title: 'Autonomous Automation for Insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Automation for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Autonomous Automation for Insurance. This autonomous system provides user experience with zero manual intervention needed.
          </p>
