...
export const metadata: Metadata = {
  title: 'Automated Insights for Energy',
  description: 'Transform your energy operations with our Automated Insights for Energy. This AI-driven solution automates threat detection with unprecedented accuracy and effi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-insights-for-energy-3838bb4d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Insights for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Automated Insights for Energy. This AI-driven solution automates threat detection with unprecedented accuracy and efficiency.
          </p>
