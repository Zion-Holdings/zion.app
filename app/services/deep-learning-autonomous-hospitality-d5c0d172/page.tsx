...
export const metadata: Metadata = {
  title: 'Deep Learning Autonomous - Hospitality',
  description: 'Unlock unprecedented growth with Deep Learning Autonomous - Hospitality. This autonomous system provides hr analytics with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/deep-learning-autonomous-hospitality-d5c0d172',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Deep Learning Autonomous - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Deep Learning Autonomous - Hospitality. This autonomous system provides hr analytics with zero manual intervention needed.
          </p>
