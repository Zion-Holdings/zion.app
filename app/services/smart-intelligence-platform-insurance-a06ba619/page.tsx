...
export const metadata: Metadata = {
  title: 'Smart Intelligence Platform - Insurance',
  description: 'Drive innovation in insurance with Smart Intelligence Platform - Insurance. This AI-powered platform transforms scenario planning into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-intelligence-platform-insurance-a06ba619',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Intelligence Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Smart Intelligence Platform - Insurance. This AI-powered platform transforms scenario planning into a competitive advantage.
          </p>
