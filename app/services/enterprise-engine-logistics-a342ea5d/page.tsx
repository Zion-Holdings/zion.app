...
export const metadata: Metadata = {
  title: 'Enterprise engine-logistics',
  description: 'Transform your logistics operations with our Enterprise engine-logistics. This AI-driven solution automates microservices mesh with unprecedented accuracy and e',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise engine-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Enterprise engine-logistics. This AI-driven solution automates microservices mesh with unprecedented accuracy and efficiency.
          </p>
