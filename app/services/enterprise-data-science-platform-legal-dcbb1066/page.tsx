...
export const metadata: Metadata = {
  title: 'Enterprise Data Science Platform - Legal',
  description: 'Hyper-accelerated legal solution: Enterprise Data Science Platform - Legal. Combines recruitment automation with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-data-science-platform-legal-dcbb1066',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Data Science Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated legal solution: Enterprise Data Science Platform - Legal. Combines recruitment automation with next-gen AI for maximum velocity.
          </p>
