...
export const metadata: Metadata = {
  title: 'Cognitive Intelligence for Legal',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Intelligence for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Cognitive Intelligence for Legal leverages advanced machine learning to deliver performance monitoring at scale.
          </p>
