...
export const metadata: Metadata = {
  title: 'Predictive Energy Suite',
  description: 'Revolutionize finance through intelligent automation. Our Predictive Energy Suite leverages advanced machine learning to deliver image recognition at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-energy-suite-b443f54b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Energy Suite
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our Predictive Energy Suite leverages advanced machine learning to deliver image recognition at scale.
          </p>
