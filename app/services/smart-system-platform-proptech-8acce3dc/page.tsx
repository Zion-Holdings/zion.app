...
export const metadata: Metadata = {
  title: 'Smart System Platform - PROPTECH',
  description: 'Transform your proptech operations with our Smart System Platform - PROPTECH. This AI-driven solution automates personalization engine with unprecedented accura',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart System Platform - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your proptech operations with our Smart System Platform - PROPTECH. This AI-driven solution automates personalization engine with unprecedented accuracy and efficiency.
          </p>
