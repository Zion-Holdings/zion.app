...
export const metadata: Metadata = {
  title: 'Employee Engagement Real-Time Data Pipeline Platform',
  description: 'employee engagement solution for space technology industry. Creates and manages real-time data pipelines with automated ETL and streaming analytics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/employee-engagement-real-time-data-pipeline-platform-dc6c1c2e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Employee Engagement Real-Time Data Pipeline Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            employee engagement solution for space technology industry. Creates and manages real-time data pipelines with automated ETL and streaming analytics.
          </p>
