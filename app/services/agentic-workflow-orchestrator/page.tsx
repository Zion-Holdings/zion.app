...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-agent workflow DAG editor (visual + code), Agent handoff + state persistence, Conditional branching + retry policy per step, Human-review gate per critical node, Audit trail per agent + cost tracking, automation, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Agentic Workflow Orchestrator</h1>
        <p className="text-lg text-slate-300 mb-8">Orchestrate multi-agent AI workflows: DAG of agents with routing, handoff, conditional branches, state persistence, retry logic, human-review gates. LangGraph/Semantic Kernel backend.</p>
        ...
        <li class="text-slate-300">Multi-agent workflow DAG editor (visual + code)</li>
        <li class="text-slate-300">Agent handoff + state persistence</li>
        <li class="text-slate-300">Conditional branching + retry policy per step</li>
        <li class="text-slate-300">Human-review gate per critical node</li>
        <li class="text-slate-300">Audit trail per agent + cost tracking</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with agentic workflow orchestrator</li>
