      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Orchestrate multi-agent AI workflows: DAG of agents with routing, handoff, conditional branches, state persistence, retry logic, human-review gates. LangGraph/Semantic Kernel backend.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Multi-agent workflow DAG editor (visual + code)</li>
            <li className="text-purple-300">✓ Agent handoff + state persistence</li>
            <li className="text-purple-300">✓ Conditional branching + retry policy per step</li>
            <li className="text-purple-300">✓ Human-review gate per critical node</li>
            <li className="text-purple-300">✓ Audit trail per agent + cost tracking</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with agentic workflow orchestrator</li>
