...
export const metadata: Metadata = {
  title: 'Intelligent Performance Real Estate',
  description: 'Drive innovation in sports with Intelligent Performance Real Estate. This AI-powered platform transforms capacity management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-performance-real-estate-6291ee57',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Performance Real Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in sports with Intelligent Performance Real Estate. This AI-powered platform transforms capacity management into a competitive advantage.
          </p>
