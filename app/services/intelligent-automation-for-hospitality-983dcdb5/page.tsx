...
export const metadata: Metadata = {
  title: 'Intelligent Automation for Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Intelligent Automation for Hospitality leverages advanced machine learning to deliver pipeline man',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-automation-for-hospitality-983dcdb5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Automation for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Intelligent Automation for Hospitality leverages advanced machine learning to deliver pipeline management at scale.
          </p>
