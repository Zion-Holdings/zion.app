...
export const metadata = {
  ...
  description: "Our AI-driven yield prediction engine for agriculture combines predictive analytics with autonomous automation to deliver measurable ROI and competitive advanta",
  alternates: {
    canonical: `https://ziontechgroup.com/services/yield-prediction-smart-automation-platform-912f670a`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Yield Prediction Smart Automation Platform</h1>
        <p className="text-lg text-gray-300 mb-8">Our AI-driven yield prediction engine for agriculture combines predictive analytics with autonomous automation to deliver measurable ROI and competitive advantage.</p>
        
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          <h2 className="text-2xl font-semibold mb-4">Key Features</h2>
          <ul className="list-disc list-inside space-y-2">
            <li>Yield Prediction process automation and optimization</li>
