      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Insights AI - Legal. Powered by cutting-edge AI, this platform delivers fraud prevention like never before.
          </p>
