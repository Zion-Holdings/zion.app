...
export const metadata: Metadata = {
  ...
  keywords: 'PostgreSQL/BigQuery/Snowflake CDC ingestion, Flink SQL window aggregations (sub-second), Role-based Superset/Metabase dashboard, Latency SLA alert per dashboard, data, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Real-Time Operational Analytics</h1>
        <p className="text-lg text-slate-300 mb-8">Sub-second analytics on operational DB change streams: CDC Kafka Flink aggregations → Superset/Metabase dashboards.</p>
        ...
        <li class="text-slate-300">PostgreSQL/BigQuery/Snowflake CDC ingestion</li>
        <li class="text-slate-300">Flink SQL window aggregations (sub-second)</li>
        <li class="text-slate-300">Role-based Superset/Metabase dashboard</li>
        <li class="text-slate-300">Latency SLA alert per dashboard</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with real-time operational analytics</li>
