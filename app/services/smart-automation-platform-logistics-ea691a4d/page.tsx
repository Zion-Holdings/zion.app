...
export const metadata: Metadata = {
  title: 'Smart Automation Platform - Logistics',
  description: 'Unlock unprecedented growth with Smart Automation Platform - Logistics. This autonomous system provides language processing with zero manual intervention needed',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-automation-platform-logistics-ea691a4d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Automation Platform - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Automation Platform - Logistics. This autonomous system provides language processing with zero manual intervention needed.
          </p>
