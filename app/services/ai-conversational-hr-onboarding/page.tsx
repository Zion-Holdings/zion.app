...
export const metadata: Metadata = {
  ...
  keywords: 'New-hire document collection & I-9, Benefits enrollment guided flow, IT provisioning (Okta, Slack, GitHub access), Policy Q&A (handbook, PTO, leave), People analytics dashboard for HR, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Conversational HR &amp; Employee Onboarding</h1>
        <p className="text-lg text-slate-300 mb-8">HR chatbot that handles new-employee paperwork, benefits enrollment, IT provisioning, I-9 verification, PTO requests, and policy questions — reducing HR admin workload by 90% and improving new-hire experience.</p>
        ...
        <li class="text-slate-300">New-hire document collection &amp; I-9</li>
        <li class="text-slate-300">Benefits enrollment guided flow</li>
        <li class="text-slate-300">IT provisioning (Okta, Slack, GitHub access)</li>
        <li class="text-slate-300">Policy Q&amp;A (handbook, PTO, leave)</li>
        <li class="text-slate-300">People analytics dashboard for HR</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai conversational hr &amp; employee onboarding</li>
