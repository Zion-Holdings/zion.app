...
export const metadata: Metadata = {
  title: 'Predictive Cognitive Engine - Education',
  description: 'Revolutionize education through intelligent automation. Our Predictive Cognitive Engine - Education leverages advanced machine learning to deliver procurement a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Cognitive Engine - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize education through intelligent automation. Our Predictive Cognitive Engine - Education leverages advanced machine learning to deliver procurement automation at scale.
          </p>
