...
export const metadata: Metadata = {
  title: 'AI Analyzer - Iot Edition',
  description: 'Transform your iot operations with our AI Analyzer - Iot Edition. This AI-driven solution automates process automation with unprecedented accuracy and efficienc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-analyzer---iot-edition-56e784d6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Analyzer - Iot Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your iot operations with our AI Analyzer - Iot Edition. This AI-driven solution automates process automation with unprecedented accuracy and efficiency.
          </p>
