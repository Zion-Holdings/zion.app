...
export const metadata: Metadata = {
  title: 'Cognitive Data Science Solution - Energy',
  description: 'The future of energy is here with Cognitive Data Science Solution - Energy. Powered by cutting-edge AI, this platform delivers project portfolio like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-data-science-solution-energy-651cf9a8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Data Science Solution - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Cognitive Data Science Solution - Energy. Powered by cutting-edge AI, this platform delivers project portfolio like never before.
          </p>
