...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize telecom through intelligent automation. Our Smart Security Management leverages advanced machine learning to deliver predictive analytics at scale',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Smart Security Management leverages advanced machine learning to deliver predictive analytics at scale.
          </p>
