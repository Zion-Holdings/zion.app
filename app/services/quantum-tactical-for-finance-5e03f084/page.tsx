...
export const metadata: Metadata = {
  title: 'Quantum Tactical for Finance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Tactical for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our Quantum Tactical for Finance leverages advanced machine learning to deliver project management at scale.
          </p>
