...
export const metadata: Metadata = {
  title: 'Next-Gen Customer Service for HEALTHTECH',
  description: 'Next-generation healthtech solution: Next-Gen Customer Service for HEALTHTECH. Combines sales process optimization with adaptive intelligence for optimal result',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-customer-service-for-healthtech-353146f4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Customer Service for HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthtech solution: Next-Gen Customer Service for HEALTHTECH. Combines sales process optimization with adaptive intelligence for optimal results.
          </p>
