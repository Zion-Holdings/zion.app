...
export const metadata: Metadata = {
  title: 'Smart Maintenance Platform - Telecom',
  description: 'Transform telecom with Smart Maintenance Platform - Telecom - the intelligent automation platform that learns, adapts, and delivers 10x results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-maintenance-platform-telecom-6ecbb448',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Maintenance Platform - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform telecom with Smart Maintenance Platform - Telecom - the intelligent automation platform that learns, adapts, and delivers 10x results.
          </p>
