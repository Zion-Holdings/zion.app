...
export const metadata: Metadata = {
  title: 'Intelligent Healthcare for Manufacturing',
  description: 'Drive innovation in manufacturing with Intelligent Healthcare for Manufacturing. This AI-powered platform transforms api management into a competitive advantage',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-healthcare-for-manufacturing-96574d33',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Healthcare for Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in manufacturing with Intelligent Healthcare for Manufacturing. This AI-powered platform transforms api management into a competitive advantage.
          </p>
