...
export const metadata: Metadata = {
  title: 'AI Marketing - Cleantech Edition',
  description: 'The future of cleantech is here with AI Marketing - Cleantech Edition. Powered by cutting-edge AI, this platform delivers user experience like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-marketing---cleantech-edition-8b7b0f5e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Marketing - Cleantech Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of cleantech is here with AI Marketing - Cleantech Edition. Powered by cutting-edge AI, this platform delivers user experience like never before.
          </p>
