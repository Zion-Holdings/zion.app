...
export const metadata: Metadata = {
  title: 'Intelligent Cognitive for Construction',
  description: 'Enhance your construction business with Intelligent Cognitive for Construction. Our solution provides sales process optimization with enterprise-grade reliabili',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-cognitive-for-construction-ec4875d6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Cognitive for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Intelligent Cognitive for Construction. Our solution provides sales process optimization with enterprise-grade reliability and security.
          </p>
