...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-cloud misconfiguration detection, Continuous compliance assessment (CIS, SOC2, PCI), Infrastructure drift detection, Auto-remediation for common misconfigs, Risk scoring and prioritization, Network path and exposure analysis, Integration with Terraform, CloudFormation, Pulumi, security, Cloud Security, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cloud Security Posture Management</h1>
        <p className="text-lg text-slate-300 mb-8">CSPM for AWS, Azure, GCP: misconfiguration detection, compliance checks, drift detection, auto-remediation.</p>
        ...
        <li class="text-slate-300">Multi-cloud misconfiguration detection</li>
        <li class="text-slate-300">Continuous compliance assessment (CIS</li>
        <li class="text-slate-300">SOC2</li>
        <li class="text-slate-300">PCI)</li>
        <li class="text-slate-300">Infrastructure drift detection</li>
        <li class="text-slate-300">Auto-remediation for common misconfigs</li>
        <li class="text-slate-300">Risk scoring and prioritization</li>
        <li class="text-slate-300">Network path and exposure analysis</li>
        <li class="text-slate-300">Integration with Terraform</li>
        <li class="text-slate-300">CloudFormation</li>
        <li class="text-slate-300">Pulumi</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Detect cloud misconfigs before breach</li>
        <li class="text-slate-300">Automated compliance checks 24/7</li>
        <li class="text-slate-300">Auto-remediate common misconfigurations</li>
        <li class="text-slate-300">Visualize cloud attack surface</li>
      </ul>
        </div>
