...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{'@context': 'https://schema.org', '@type': 'Service', 'name': 'Cloud Security Posture Management', 'description': 'CSPM for AWS, Azure, GCP: misconfiguration detection, compliance checks, drift detection, auto-remediation.', 'serviceType': 'security', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'Cloud Security'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'Cloud Security Posture Management Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$399/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$1,199/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': '$3,999/mo', 'priceCurrency': 'USD'}]}} }/>
    <JsonLd data={{'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'Multi-cloud misconfiguration detection', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Multi-cloud misconfiguration detection'}}, {'@type': 'Question', 'name': 'Continuous compliance assessment (CIS', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Continuous compliance assessment (CIS'}}, {'@type': 'Question', 'name': 'SOC2', 'acceptedAnswer': {'@type': 'Answer', 'text': 'SOC2'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Detect cloud misconfigs before breach; Automated compliance checks 24/7; Auto-remediate common misconfigurations'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} }/>
