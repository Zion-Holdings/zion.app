...
export const metadata: Metadata = {
  title: 'AI Vendor - Healthcare Edition',
  description: 'Revolutionize healthcare through intelligent automation. Our AI Vendor - Healthcare Edition leverages advanced machine learning to deliver social media monitori',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Vendor - Healthcare Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our AI Vendor - Healthcare Edition leverages advanced machine learning to deliver social media monitoring at scale.
          </p>
