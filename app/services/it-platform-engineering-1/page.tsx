    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce time-to-first-deploy from weeks to hours</li>
            <li>Empower developers to self-serve without ops bottlenecks</li>
            <li>Standardize best practices across all teams</li>
            <li>Improve developer satisfaction and retention</li>
          </ul>
        </div>
