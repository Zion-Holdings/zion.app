...
export const metadata: Metadata = {
  ...
  description: 'lead management solution for conservation industry. Fully automated customer support system that handles 80% of inquiries without human intervention.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/lead-management-autonomous-customer-service-ai-f2bea08b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            lead management solution for conservation industry. Fully automated customer support system that handles 80% of inquiries without human intervention.
          </p>
