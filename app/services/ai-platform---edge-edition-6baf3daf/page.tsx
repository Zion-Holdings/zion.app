...
export const metadata: Metadata = {
  title: 'AI Platform - Edge Edition',
  description: 'Next-generation edge solution: AI Platform - Edge Edition. Combines customer insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-platform---edge-edition-6baf3daf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Platform - Edge Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation edge solution: AI Platform - Edge Edition. Combines customer insights with adaptive intelligence for optimal results.
          </p>
