...
export const metadata: Metadata = {
  title: 'Enterprise Monitoring Platform - Logistics',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Monitoring Platform - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated logistics solution: Enterprise Monitoring Platform - Logistics. Combines api composition with next-gen AI for maximum velocity.
          </p>
