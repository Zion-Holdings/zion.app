...
export const metadata: Metadata = {
  title: 'Smart Compliance for Legal',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Compliance for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Smart Compliance for Legal. Our solution provides forecast accuracy with enterprise-grade reliability and security.
          </p>
