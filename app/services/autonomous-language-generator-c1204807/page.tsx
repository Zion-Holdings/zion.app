...
export const metadata: Metadata = {
  title: 'Autonomous Language Generator',
  description: 'Revolutionize construction through intelligent automation. Our Autonomous Language Generator leverages advanced machine learning to deliver enterprise-grade ins',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Autonomous Language Generator leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
