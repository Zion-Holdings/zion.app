...
export const metadata: Metadata = {
  title: 'Adaptive Engine for Transportation',
  description: 'Optimize your transportation workflows with Adaptive Engine for Transportation. This intelligent platform delivers learning management through advanced automati',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-engine-for-transportation-c0844c70',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Engine for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Adaptive Engine for Transportation. This intelligent platform delivers learning management through advanced automation and AI.
          </p>
