...
export const metadata: Metadata = {
  ...
  keywords: 'Template library, Data merging, Conditional logic, E-signature, Version control, Approval workflows, Multi-format export, Analytics, ai, Legal, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Document Generation Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Auto-generate contracts, proposals, reports, and emails from templates and data. Conditional logic, data merging, e-signature, and lifecycle management.</p>
        ...
        <li class="text-slate-300">Data merging</li>
        ...
        <li class="text-slate-300">Multi-format export</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">90% faster document creation</li>
        <li class="text-slate-300">Error-free generation</li>
        <li class="text-slate-300">Template management</li>
        <li class="text-slate-300">Legal compliance</li>
      </ul>
        </div>
