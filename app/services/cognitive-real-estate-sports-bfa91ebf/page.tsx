...
export const metadata: Metadata = {
  title: 'Cognitive real estate-sports',
  description: 'Revolutionize sports through intelligent automation. Our Cognitive real estate-sports leverages advanced machine learning to deliver market intelligence at scal',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive real estate-sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Cognitive real estate-sports leverages advanced machine learning to deliver market intelligence at scale.
          </p>
