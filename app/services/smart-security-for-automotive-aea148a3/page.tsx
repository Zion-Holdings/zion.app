...
export const metadata: Metadata = {
  title: 'Smart Security for Automotive',
  description: 'Revolutionize automotive through intelligent automation. Our Smart Security for Automotive leverages advanced machine learning to deliver market intelligence at',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Security for Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize automotive through intelligent automation. Our Smart Security for Automotive leverages advanced machine learning to deliver market intelligence at scale.
          </p>
