...
export const metadata: Metadata = {
  title: 'Intelligent Platform for Insurance #3',
  description: 'Enhance your insurance business with Intelligent Platform for Insurance #3. Our solution provides user experience with enterprise-grade reliability and security',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-platform-for-insurance-3-4ab8b940',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Platform for Insurance #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Intelligent Platform for Insurance #3. Our solution provides user experience with enterprise-grade reliability and security.
          </p>
