...
export const metadata: Metadata = {
  title: 'Smart Smart Platform - Finance',
  description: 'The future of finance is here with Smart Smart Platform - Finance. Powered by cutting-edge AI, this platform delivers network optimization like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-smart-platform-finance-d00bceb7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Smart Platform - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of finance is here with Smart Smart Platform - Finance. Powered by cutting-edge AI, this platform delivers network optimization like never before.
          </p>
