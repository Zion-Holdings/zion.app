...
export const metadata: Metadata = {
  title: 'AI Compliance - Construction Edition #2',
  description: 'Optimize your construction workflows with AI Compliance - Construction Edition #2. This intelligent platform delivers talent acquisition through advanced automa',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-compliance-construction-edition-2-706bf805',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Compliance - Construction Edition #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with AI Compliance - Construction Edition #2. This intelligent platform delivers talent acquisition through advanced automation and AI.
          </p>
