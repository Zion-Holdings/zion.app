...
export const metadata: Metadata = {
  title: 'Smart computer vision-manufacturing',
  description: 'Revolutionize manufacturing through intelligent automation. Our Smart computer vision-manufacturing leverages advanced machine learning to deliver language proc',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart computer vision-manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize manufacturing through intelligent automation. Our Smart computer vision-manufacturing leverages advanced machine learning to deliver language processing at scale.
          </p>
