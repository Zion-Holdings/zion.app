...
export const metadata: Metadata = {
  title: 'Autonomous Intelligence for Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Autonomous Intelligence for Healthcare leverages advanced machine learning to deliver threat detect',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-intelligence-for-healthcare-bde11b6b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Intelligence for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Autonomous Intelligence for Healthcare leverages advanced machine learning to deliver threat detection at scale.
          </p>
