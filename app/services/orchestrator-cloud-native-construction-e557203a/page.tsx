...
export const metadata: Metadata = {
  title: 'Orchestrator Cloud-Native - Construction',
  description: 'Transform your construction operations with our Orchestrator Cloud-Native - Construction. This AI-driven solution automates business intelligence with unprecede',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Orchestrator Cloud-Native - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Orchestrator Cloud-Native - Construction. This AI-driven solution automates business intelligence with unprecedented accuracy and efficiency.
          </p>
