...
export const metadata: Metadata = {
  title: 'Intelligent Employee for EDTECH',
  description: 'Revolutionize edtech through intelligent automation. Our Intelligent Employee for EDTECH leverages advanced machine learning to deliver inventory optimization a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Employee for EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize edtech through intelligent automation. Our Intelligent Employee for EDTECH leverages advanced machine learning to deliver inventory optimization at scale.
          </p>
