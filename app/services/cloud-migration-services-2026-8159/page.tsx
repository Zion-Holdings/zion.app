...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={@context: "https://schema.org", @type: "Service", name: "Cloud Migration Services | Zion Tech Group", description: "End-to-end cloud migration services services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/cloud-migration-services-2026-8159/"} />
