...
export const metadata: Metadata = {
  title: 'Enterprise Process Platform - ALTHEALTH',
  description: 'Optimize your althealth workflows with Enterprise Process Platform - ALTHEALTH. This intelligent platform delivers quality assurance through advanced automation',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-process-platform-althealth-a0879ac3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Process Platform - ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your althealth workflows with Enterprise Process Platform - ALTHEALTH. This intelligent platform delivers quality assurance through advanced automation and AI.
          </p>
