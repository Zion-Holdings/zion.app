...
export const metadata: Metadata = {
  title: 'Smart Performance Platform - Insurance',
  description: 'Quantum leap forward for insurance: Smart Performance Platform - Insurance. Uses quantum-inspired algorithms to deliver compliance reporting at exponential spee',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-performance-platform-insurance-7d91d671',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Performance Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for insurance: Smart Performance Platform - Insurance. Uses quantum-inspired algorithms to deliver compliance reporting at exponential speed.
          </p>
