...
export const metadata: Metadata = {
  title: 'Smart Process Mining Platform - Insurance #1',
  description: 'Optimize your insurance workflows with Smart Process Mining Platform - Insurance #1. This intelligent platform delivers workflow management through advanced aut',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-process-mining-platform-insurance-1-7fd262e9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Process Mining Platform - Insurance #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Smart Process Mining Platform - Insurance #1. This intelligent platform delivers workflow management through advanced automation and AI.
          </p>
