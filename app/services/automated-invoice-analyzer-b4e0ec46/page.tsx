...
export const metadata: Metadata = {
  title: 'Automated Invoice Analyzer',
  description: 'Next-generation retail solution: Automated Invoice Analyzer. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-invoice-analyzer-b4e0ec46',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Invoice Analyzer
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation retail solution: Automated Invoice Analyzer. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
