...
export const metadata: Metadata = {
  title: 'AI/IT Strategic Suite - Construction',
  description: 'Transform your construction operations with our AI/IT Strategic Suite - Construction. This AI-driven solution automates disaster recovery with unprecedented acc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-strategic-suite-construction-f3a8c195',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Strategic Suite - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our AI/IT Strategic Suite - Construction. This AI-driven solution automates disaster recovery with unprecedented accuracy and efficiency.
          </p>
