...
export const metadata: Metadata = {
  title: 'Enterprise Data Science Platform - MARTECH',
  description: 'Next-generation martech solution: Enterprise Data Science Platform - MARTECH. Combines performance tracking with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-data-science-platform-martech-f36cd557',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Data Science Platform - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation martech solution: Enterprise Data Science Platform - MARTECH. Combines performance tracking with adaptive intelligence for optimal results.
          </p>
