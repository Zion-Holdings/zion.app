...
export const metadata: Metadata = {
  title: 'Smart Processor Platform - Construction #1',
  description: 'Drive innovation in construction with Smart Processor Platform - Construction #1. This AI-powered platform transforms regulatory tracking into a competitive adv',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-processor-platform-construction-1-d3660d17',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Processor Platform - Construction #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Smart Processor Platform - Construction #1. This AI-powered platform transforms regulatory tracking into a competitive advantage.
          </p>
