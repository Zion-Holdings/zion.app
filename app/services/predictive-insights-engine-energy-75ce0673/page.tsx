...
export const metadata: Metadata = {
  title: 'Predictive Insights Engine - Energy',
  description: 'Drive innovation in energy with Predictive Insights Engine - Energy. This AI-powered platform transforms capacity management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-insights-engine-energy-75ce0673',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Insights Engine - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Predictive Insights Engine - Energy. This AI-powered platform transforms capacity management into a competitive advantage.
          </p>
