...
export const metadata: Metadata = {
  title: 'User Experience AI Sales Lead Scoring Engine',
  description: 'user experience solution for cleaning services industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/user-experience-ai-sales-lead-scoring-engine-35290e1d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            User Experience AI Sales Lead Scoring Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            user experience solution for cleaning services industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.
          </p>
