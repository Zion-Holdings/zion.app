...
export const metadata: Metadata = {
  title: 'AI Engine - Hospitality Edition',
  description: 'Revolutionize hospitality through intelligent automation. Our AI Engine - Hospitality Edition leverages advanced machine learning to deliver employee engagement',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Engine - Hospitality Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our AI Engine - Hospitality Edition leverages advanced machine learning to deliver employee engagement at scale.
          </p>
