...
export const metadata: Metadata = {
  title: 'Automated manager-construction',
  description: 'Transform your construction operations with our Automated manager-construction. This AI-driven solution automates maintenance scheduling with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-manager-construction-68e1527f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated manager-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Automated manager-construction. This AI-driven solution automates maintenance scheduling with unprecedented accuracy and efficiency.
          </p>
