...
export const metadata: Metadata = {
  title: 'Next-Gen Enterprise for Logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Next-Gen Enterprise for Logistics leverages advanced machine learning to deliver generative ai at sc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-enterprise-for-logistics-f2ad4d84',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Enterprise for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Next-Gen Enterprise for Logistics leverages advanced machine learning to deliver generative ai at scale.
          </p>
