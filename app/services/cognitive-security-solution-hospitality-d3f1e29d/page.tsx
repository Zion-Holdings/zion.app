...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize hospitality through intelligent automation. Our Cognitive Security Solution - Hospitality leverages advanced machine learning to deliver expense m',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Cognitive Security Solution - Hospitality leverages advanced machine learning to deliver expense management at scale.
          </p>
