...
export const metadata: Metadata = {
  title: 'Smart Tactical Platform - EDTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Tactical Platform - EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your edtech operations with our Smart Tactical Platform - EDTECH. This AI-driven solution automates performance tracking with unprecedented accuracy and efficiency.
          </p>
