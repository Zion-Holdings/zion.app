...
export const metadata: Metadata = {
  title: 'Supply Intelligent - Construction',
  description: 'Revolutionize construction through intelligent automation. Our Supply Intelligent - Construction leverages advanced machine learning to deliver decision support',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Supply Intelligent - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Supply Intelligent - Construction leverages advanced machine learning to deliver decision support at scale.
          </p>
