...
export const metadata: Metadata = {
  title: 'Autonomous Processor for Sports',
  description: 'Revolutionize sports through intelligent automation. Our Autonomous Processor for Sports leverages advanced machine learning to deliver image recognition at sca',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-processor-for-sports-fdf0a058',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Processor for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Autonomous Processor for Sports leverages advanced machine learning to deliver image recognition at scale.
          </p>
