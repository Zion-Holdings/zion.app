...
export const metadata: Metadata = {
  title: 'Cognitive real estate-logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Cognitive real estate-logistics leverages advanced machine learning to deliver enterprise-grade insi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-real-estate-logistics-990df9a2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive real estate-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Cognitive real estate-logistics leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
