...
export const metadata: Metadata = {
  title: `Mainframe Modernization | Zion Tech Group`,
  ...
  keywords: 'COBOL → Java/Python transpiler, Automated data migration, Parallel run validation, Mainframe emulator for testing, Gradual cutover strategy, it, General, Zion Tech Group',
  alternates: {
    canonical: `https://ziontechgroup.com/services/mainframe-modernization/`,
  },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Mainframe Modernization</h1>
        <p className="text-lg text-slate-300 mb-8">Migrate legacy COBOL, PL/I, and JCL workloads to cloud-native microservices with automated refactoring, data migration, and parallel-run validation.</p>
        ...
        <li class="text-slate-300">COBOL → Java/Python transpiler</li>
        <li class="text-slate-300">Automated data migration</li>
        <li class="text-slate-300">Parallel run validation</li>
        <li class="text-slate-300">Mainframe emulator for testing</li>
        <li class="text-slate-300">Gradual cutover strategy</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with mainframe modernization</li>
