...
export const metadata: Metadata = {
  title: 'Intelligent supply-telecom',
  description: 'The future of telecom is here with Intelligent supply-telecom. Powered by cutting-edge AI, this platform delivers transformative results like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-supply-telecom-d91f33eb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent supply-telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of telecom is here with Intelligent supply-telecom. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
