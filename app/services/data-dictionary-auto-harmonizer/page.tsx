  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Data Dictionary Auto Harmonizer</h1>
        <p className="text-lg text-gray-300 mb-8">Reconciles field definitions, synonyms, and classifications across systems with owner review and approval workflows.</p>
