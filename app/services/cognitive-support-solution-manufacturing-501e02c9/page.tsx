...
export const metadata: Metadata = {
  title: 'Cognitive Support Solution - Manufacturing',
  description: 'Enhance your manufacturing business with Cognitive Support Solution - Manufacturing. Our solution provides financial planning with enterprise-grade reliability ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-support-solution-manufacturing-501e02c9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Support Solution - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your manufacturing business with Cognitive Support Solution - Manufacturing. Our solution provides financial planning with enterprise-grade reliability and security.
          </p>
