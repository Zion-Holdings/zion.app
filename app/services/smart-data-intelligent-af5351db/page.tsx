...
export const metadata: Metadata = {
  title: 'Smart Data Intelligent',
  description: 'Enhance your hospitality business with Smart Data Intelligent. Our solution provides customer retention with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-data-intelligent-af5351db',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Data Intelligent
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Smart Data Intelligent. Our solution provides customer retention with enterprise-grade reliability and security.
          </p>
