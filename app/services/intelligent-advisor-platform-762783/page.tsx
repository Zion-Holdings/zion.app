...
export const metadata: Metadata = {
  title: 'Intelligent Advisor Platform',
  description: 'Transform your gaming operations with our Intelligent Advisor Platform. This security solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-advisor-platform-762783',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your gaming operations with our Intelligent Advisor Platform. This security solution delivers unprecedented automation and intelligence.
          </p>
