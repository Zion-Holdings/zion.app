...
export const metadata: Metadata = {
  title: 'Intelligent Sales for Transportation #1',
  description: 'Revolutionize transportation through intelligent automation. Our Intelligent Sales for Transportation #1 leverages advanced machine learning to deliver fraud pr',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Sales for Transportation #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize transportation through intelligent automation. Our Intelligent Sales for Transportation #1 leverages advanced machine learning to deliver fraud prevention at scale.
          </p>
