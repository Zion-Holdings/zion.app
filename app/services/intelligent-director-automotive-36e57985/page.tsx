...
export const metadata: Metadata = {
  title: 'Intelligent director-automotive',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent director-automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation automotive solution: Intelligent director-automotive. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
