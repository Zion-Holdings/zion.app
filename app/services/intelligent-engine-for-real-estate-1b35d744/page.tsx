...
export const metadata: Metadata = {
  title: 'Intelligent Engine for Real-Estate',
  description: 'Transform your real-estate operations with our Intelligent Engine for Real-Estate. This AI-driven solution automates incident response with unprecedented accura',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Engine for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Intelligent Engine for Real-Estate. This AI-driven solution automates incident response with unprecedented accuracy and efficiency.
          </p>
