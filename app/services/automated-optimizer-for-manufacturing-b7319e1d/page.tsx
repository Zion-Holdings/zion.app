...
export const metadata: Metadata = {
  ...
  keywords: 'Role-based access control, Open-source friendly, Offline capabilities, SOC 2 certified, automation, manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Automated Optimizer for Manufacturing</h1>
        <p className="text-lg text-slate-300 mb-8">The future of manufacturing is here with Automated Optimizer for Manufacturing. Powered by cutting-edge AI, this platform delivers document processing like never before.</p>
