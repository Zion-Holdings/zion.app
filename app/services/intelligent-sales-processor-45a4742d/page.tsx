...
export const metadata: Metadata = {
  title: 'Intelligent Sales Processor',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Sales Processor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize media through intelligent automation. Our Intelligent Sales Processor leverages advanced machine learning to deliver sales forecasting at scale.
          </p>
