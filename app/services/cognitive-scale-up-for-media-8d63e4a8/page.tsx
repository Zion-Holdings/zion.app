...
export const metadata: Metadata = {
  title: 'Cognitive Scale-up for Media',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Scale-up for Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your media business with Cognitive Scale-up for Media. Our solution provides loyalty optimization with enterprise-grade reliability and security.
          </p>
