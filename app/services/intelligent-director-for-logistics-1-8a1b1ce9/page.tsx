  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Intelligent Director for Logistics #1</h1>
        <p className="text-lg text-gray-300 mb-8">The future of logistics is here with Intelligent Director for Logistics #1. Powered by cutting-edge AI, this platform delivers network optimization like never before.</p>
