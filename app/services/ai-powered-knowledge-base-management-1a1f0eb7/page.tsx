...
export const metadata: Metadata = {
  title: 'AI-Powered Knowledge Base Management',
  description: 'Auto-generates and maintains knowledge base articles from support interactions.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-knowledge-base-management-1a1f0eb7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Auto-generates and maintains knowledge base articles from support interactions.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">KB generation</li>
          <li className="text-gray-300">Article optimization</li>
          <li className="text-gray-300">Self-service enhancement</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">40% self-service rate</li>
