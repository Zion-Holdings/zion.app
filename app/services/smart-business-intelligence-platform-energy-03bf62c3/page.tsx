...
export const metadata: Metadata = {
  title: 'Smart Business Intelligence Platform - Energy',
  description: 'Enhance your energy business with Smart Business Intelligence Platform - Energy. Our solution provides influencer identification with enterprise-grade reliabili',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Business Intelligence Platform - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your energy business with Smart Business Intelligence Platform - Energy. Our solution provides influencer identification with enterprise-grade reliability and security.
          </p>
