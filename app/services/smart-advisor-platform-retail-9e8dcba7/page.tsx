...
export const metadata: Metadata = {
  title: 'Smart Advisor Platform - Retail',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Advisor Platform - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in retail with Smart Advisor Platform - Retail. This AI-powered platform transforms testing automation into a competitive advantage.
          </p>
