...
export const metadata: Metadata = {
  ...
  keywords: 'Kubernetes-based edge orchestration, Serverless edge functions, Automatic data synchronization, Edge-to-cloud tiered storage, Zero-touch device provisioning, Real-time monitoring and alerting, OTA update management, Multi-cloud edge deployment, it, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Edge Computing Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Deploy and manage applications at the edge with low-latency processing. Container orchestration, serverless functions, and data synchronization across edge locations. Ideal for IoT, retail, and real-time applications.</p>
        ...
        <li class="text-slate-300">Kubernetes-based edge orchestration</li>
        <li class="text-slate-300">Serverless edge functions</li>
        <li class="text-slate-300">Automatic data synchronization</li>
        <li class="text-slate-300">Edge-to-cloud tiered storage</li>
        <li class="text-slate-300">Zero-touch device provisioning</li>
        <li class="text-slate-300">Real-time monitoring and alerting</li>
        <li class="text-slate-300">OTA update management</li>
        <li class="text-slate-300">Multi-cloud edge deployment</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Sub-10ms latency for critical apps</li>
        <li class="text-slate-300">Reduced bandwidth costs</li>
        <li class="text-slate-300">Improved reliability with offline capability</li>
        <li class="text-slate-300">Consistent deployment across edge locations</li>
      </ul>
        </div>
