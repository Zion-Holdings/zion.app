...
export const metadata = {
  ...
  description: "Deploy and manage applications at the edge with low-latency processing. Container orchestration, serverless functions, and data synchronization across edge loca",
  alternates: {
