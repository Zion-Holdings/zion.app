...
export const metadata: Metadata = {
  ...
  keywords: 'Real-user monitoring (RUM), Synthetic transaction monitoring, API performance monitoring, End-user experience scoring, Root cause analysis with AI, Integration with Datadog, New Relic, Dynatrace, Custom dashboards and alerts, Mobile app performance monitoring, it, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Digital Experience Monitoring (DEM)</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered digital experience monitoring for web applications, APIs, and digital services with real-user monitoring and synthetic testing.</p>
        ...
        <li class="text-slate-300">Synthetic transaction monitoring</li>
        <li class="text-slate-300">API performance monitoring</li>
        <li class="text-slate-300">End-user experience scoring</li>
        <li class="text-slate-300">Root cause analysis with AI</li>
        <li class="text-slate-300">Integration with Datadog, New Relic, Dynatrace</li>
        <li class="text-slate-300">Custom dashboards and alerts</li>
        <li class="text-slate-300">Mobile app performance monitoring</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Detect issues before users complain</li>
        <li class="text-slate-300">Optimize digital experience</li>
