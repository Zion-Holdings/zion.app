...
export const metadata: Metadata = {
  ...
  keywords: 'Template library with merge fields, Data merge from CRM, spreadsheet, API, Approval workflows and routing, E-signature integration, Document generation (PDF, Word, Excel), Version control and audit trail, Integration with DocuSign, PandaDoc, Google Docs, automation, Document Management, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Document Automation Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Automate document creation: templates, data merge, approval workflows, e-signature. Generate docs in seconds.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">automation</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">Document Management</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Template library with merge fields</li>
        <li class="text-slate-300">Data merge from CRM</li>
        <li class="text-slate-300">spreadsheet</li>
        <li class="text-slate-300">API</li>
        <li class="text-slate-300">Approval workflows and routing</li>
        <li class="text-slate-300">E-signature integration</li>
        <li class="text-slate-300">Document generation (PDF</li>
        <li class="text-slate-300">Word</li>
        <li class="text-slate-300">Excel)</li>
        <li class="text-slate-300">Version control and audit trail</li>
        <li class="text-slate-300">Integration with DocuSign</li>
        <li class="text-slate-300">PandaDoc</li>
        <li class="text-slate-300">Google Docs</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Generate documents in seconds</li>
        <li class="text-slate-300">Approval workflows ensure review</li>
        <li class="text-slate-300">E-signature eliminates printing</li>
