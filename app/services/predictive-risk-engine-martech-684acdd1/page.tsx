...
export const metadata: Metadata = {
  title: 'Predictive Risk Engine - MARTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Risk Engine - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation martech solution: Predictive Risk Engine - MARTECH. Combines employee engagement with adaptive intelligence for optimal results.
          </p>
