...
export const metadata: Metadata = {
  title: 'Guest Experience AI Supply Chain Optimization',
  description: 'guest experience solution for travel industry. Optimizes supply chain operations using predictive analytics, demand forecasting, and route optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/guest-experience-ai-supply-chain-optimization-787aeff1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Guest Experience AI Supply Chain Optimization
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            guest experience solution for travel industry. Optimizes supply chain operations using predictive analytics, demand forecasting, and route optimization.
          </p>
