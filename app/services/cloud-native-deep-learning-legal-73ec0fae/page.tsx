...
export const metadata: Metadata = {
  title: 'Cloud-Native deep learning-legal',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cloud-Native deep learning-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your legal with Cloud-Native deep learning-legal. Our autonomous solution handles cost reduction end-to-end without human intervention.
          </p>
