...
export const metadata: Metadata = {
  title: 'Quantum Workflow - Transportation Quantum',
  description: 'Optimize your transportation workflows with Quantum Workflow - Transportation Quantum. This intelligent platform delivers case management through advanced autom',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-workflow-transportation-quantum-7d976ddd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Workflow - Transportation Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Quantum Workflow - Transportation Quantum. This intelligent platform delivers case management through advanced automation and AI.
          </p>
