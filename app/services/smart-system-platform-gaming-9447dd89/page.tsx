...
export const metadata: Metadata = {
  title: 'Smart System Platform - Gaming',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart System Platform - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your gaming business with Smart System Platform - Gaming. Our solution provides business continuity with enterprise-grade reliability and security.
          </p>
