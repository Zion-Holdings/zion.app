...
export const metadata: Metadata = {
  title: 'Smart Process Mining Platform - Construction',
  description: 'The future of construction is here with Smart Process Mining Platform - Construction. Powered by cutting-edge AI, this platform delivers access management like ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-process-mining-platform-construction-6ba919f3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Process Mining Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Smart Process Mining Platform - Construction. Powered by cutting-edge AI, this platform delivers access management like never before.
          </p>
