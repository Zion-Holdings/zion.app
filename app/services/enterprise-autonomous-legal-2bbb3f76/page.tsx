...
export const metadata: Metadata = {
  title: 'Enterprise Autonomous - Legal',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Autonomous - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your legal with Enterprise Autonomous - Legal. Our autonomous solution handles financial planning end-to-end without human intervention.
          </p>
