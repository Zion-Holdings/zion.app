...
export const metadata: Metadata = {
  title: 'Smart Data Science for Real-Estate',
  description: 'Revolutionize real-estate through intelligent automation. Our Smart Data Science for Real-Estate leverages advanced machine learning to deliver net promoter sco',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-data-science-for-real-estate-265bfc9a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Data Science for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our Smart Data Science for Real-Estate leverages advanced machine learning to deliver net promoter score at scale.
          </p>
