...
export const metadata: Metadata = {
  title: 'AI-Powered performance-education',
  description: 'Revolutionize education through intelligent automation. Our AI-Powered performance-education leverages advanced machine learning to deliver customer retention a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered performance-education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize education through intelligent automation. Our AI-Powered performance-education leverages advanced machine learning to deliver customer retention at scale.
          </p>
