...
export const metadata: Metadata = {
  ...
  description: 'referral management solution for travel industry. Identifies at-risk customers before they churn using behavioral patterns and engagement metrics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/referral-management-ai-customer-churn-prediction-ec9901d6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            referral management solution for travel industry. Identifies at-risk customers before they churn using behavioral patterns and engagement metrics.
          </p>
