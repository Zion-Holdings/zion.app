...
export const metadata: Metadata = {
  title: 'Intelligent Optimization for Media',
  description: 'Enhance your media business with Intelligent Optimization for Media. Our solution provides social media automation with enterprise-grade reliability and securit',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Optimization for Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your media business with Intelligent Optimization for Media. Our solution provides social media automation with enterprise-grade reliability and security.
          </p>
