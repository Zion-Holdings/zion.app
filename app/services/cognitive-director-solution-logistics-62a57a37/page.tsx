...
export const metadata: Metadata = {
  title: 'Cognitive Director Solution - Logistics',
  description: 'Optimize your logistics workflows with Cognitive Director Solution - Logistics. This intelligent platform delivers resource utilization through advanced automat',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-director-solution-logistics-62a57a37',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Director Solution - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your logistics workflows with Cognitive Director Solution - Logistics. This intelligent platform delivers resource utilization through advanced automation and AI.
          </p>
