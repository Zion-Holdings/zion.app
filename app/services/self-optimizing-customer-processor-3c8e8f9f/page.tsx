...
export const metadata: Metadata = {
  title: 'Self-Optimizing Customer Processor',
  description: 'Transform your proptech operations with our Self-Optimizing Customer Processor. This AI-driven solution automates energy management with unprecedented accuracy ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Customer Processor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your proptech operations with our Self-Optimizing Customer Processor. This AI-driven solution automates energy management with unprecedented accuracy and efficiency.
          </p>
