...
export const metadata: Metadata = {
  title: 'Risk Adaptive - Construction',
  description: 'Enhance your construction business with Risk Adaptive - Construction. Our solution provides resource utilization with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/risk-adaptive-construction-e5c461f0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Risk Adaptive - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Risk Adaptive - Construction. Our solution provides resource utilization with enterprise-grade reliability and security.
          </p>
