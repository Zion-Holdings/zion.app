...
export const metadata: Metadata = {
  title: 'Autonomous Healthcare for Hospitality',
  description: 'Transform your hospitality operations with our Autonomous Healthcare for Hospitality. This AI-driven solution automates threat detection with unprecedented accu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Healthcare for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Autonomous Healthcare for Hospitality. This AI-driven solution automates threat detection with unprecedented accuracy and efficiency.
          </p>
