...
export const metadata: Metadata = {
  title: 'Cognitive Root Performance',
  description: 'Enhance your hospitality business with Cognitive Root Performance. Our solution provides contract analysis with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-root-performance-8e50130a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Root Performance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Cognitive Root Performance. Our solution provides contract analysis with enterprise-grade reliability and security.
          </p>
