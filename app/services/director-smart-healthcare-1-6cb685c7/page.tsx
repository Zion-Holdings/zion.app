...
export const metadata: Metadata = {
  title: 'Director Smart - Healthcare #1',
  description: 'Revolutionize healthcare through intelligent automation. Our Director Smart - Healthcare #1 leverages advanced machine learning to deliver data quality at scale',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/director-smart-healthcare-1-6cb685c7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Director Smart - Healthcare #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Director Smart - Healthcare #1 leverages advanced machine learning to deliver data quality at scale.
          </p>
