...
export const metadata: Metadata = {
  title: 'Enterprise Cognitive - Automotive',
  description: 'Drive innovation in automotive with Enterprise Cognitive - Automotive. This AI-powered platform transforms disaster recovery into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-cognitive-automotive-a19a7d12',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Cognitive - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in automotive with Enterprise Cognitive - Automotive. This AI-powered platform transforms disaster recovery into a competitive advantage.
          </p>
