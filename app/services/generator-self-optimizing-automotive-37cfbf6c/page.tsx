...
export const metadata: Metadata = {
  title: 'Generator Self-Optimizing - Automotive',
  description: 'Next-generation automotive solution: Generator Self-Optimizing - Automotive. Combines compliance reporting with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/generator-self-optimizing-automotive-37cfbf6c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Generator Self-Optimizing - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation automotive solution: Generator Self-Optimizing - Automotive. Combines compliance reporting with adaptive intelligence for optimal results.
          </p>
