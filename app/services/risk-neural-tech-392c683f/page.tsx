...
export const metadata: Metadata = {
  title: 'Risk Neural - Tech',
  description: 'Revolutionize technology through intelligent automation. Our Risk Neural - Tech leverages advanced machine learning to deliver security monitoring at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/risk-neural-tech-392c683f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our Risk Neural - Tech leverages advanced machine learning to deliver security monitoring at scale.
          </p>
