...
export const metadata: Metadata = {
  title: 'Intelligent Marketing Automation Hadoop (Hr)',
  description: 'Intelligent Marketing Automation Hadoop (Hr) is an AI-powered hr solution that transforms how businesses operate through intelligent automation and real-time an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-marketing-automati-46c867',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Marketing Automation Hadoop (Hr)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Intelligent Marketing Automation Hadoop (Hr) is an AI-powered hr solution that transforms how businesses operate through intelligent automation and real-time analytics.
...
IoT, Redis, TensorFlow, Airflow, AWS, Edge Computing
