...
export const metadata: Metadata = {
  title: 'Intelligent Data Science for Logistics',
  description: 'Transform your logistics operations with our Intelligent Data Science for Logistics. This AI-driven solution automates data processing with unprecedented accura',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-data-science-for-logistics-30d3cd04',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Data Science for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Intelligent Data Science for Logistics. This AI-driven solution automates data processing with unprecedented accuracy and efficiency.
          </p>
