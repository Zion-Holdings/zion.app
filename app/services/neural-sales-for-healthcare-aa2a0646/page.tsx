...
export const metadata: Metadata = {
  title: 'Neural Sales for Healthcare',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Sales for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Neural Sales for Healthcare. This intelligent platform delivers loyalty optimization through advanced automation and AI.
          </p>
