...
export const metadata: Metadata = {
  title: 'Autonomous Manufacturing System - Retail',
  description: 'Optimize your retail workflows with Autonomous Manufacturing System - Retail. This intelligent platform delivers process discovery through advanced automation a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-manufacturing-system-retail-4828a822',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Manufacturing System - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your retail workflows with Autonomous Manufacturing System - Retail. This intelligent platform delivers process discovery through advanced automation and AI.
          </p>
