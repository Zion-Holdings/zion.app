      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            AI-powered legacy code analysis, automated migration planning, and assisted code transformation from COBOL, mainframe, and legacy frameworks to modern cloud-native stacks.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Legacy code analysis and dependency mapping</li>
            <li className="text-purple-300">✓ Automated migration plan generation</li>
            <li className="text-purple-300">✓ AI-assisted code transformation and refactoring</li>
            <li className="text-purple-300">✓ Test case generation for migrated systems</li>
            <li className="text-purple-300">✓ Risk assessment and rollback planning</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai code migration & legacy modernization</li>
