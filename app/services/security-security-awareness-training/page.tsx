...
export const metadata: Metadata = {
  title: `Security Awareness Training Platform | Zion Tech Group`,
  ...
  keywords: 'Phishing simulation (template library 200+), Role-based security training modules, Compliance quiz tracking + certificate, Gamified leaderboard per team/department, security, General, Zion Tech Group',
  alternates: {
    canonical: `https://ziontechgroup.com/services/security-security-awareness-training/`,
  },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Security Awareness Training Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Phishing simulation, training modules per role, compliance quiz tracking, gamified leaderboard, and risk scoring per employee/team.</p>
        ...
        <li class="text-slate-300">Phishing simulation (template library 200+)</li>
        <li class="text-slate-300">Role-based security training modules</li>
        <li class="text-slate-300">Compliance quiz tracking + certificate</li>
        <li class="text-slate-300">Gamified leaderboard per team/department</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with security awareness training platform</li>
