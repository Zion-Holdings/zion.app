...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize retail through intelligent automation. Our Smart Healthcare Analytics leverages advanced machine learning to deliver customer insights at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-healthcare-analytics-b90cbe08',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize retail through intelligent automation. Our Smart Healthcare Analytics leverages advanced machine learning to deliver customer insights at scale.
          </p>
