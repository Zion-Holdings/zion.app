...
export const metadata: Metadata = {
  title: 'Intelligent Supply for Construction',
  description: 'The future of construction is here with Intelligent Supply for Construction. Powered by cutting-edge AI, this platform delivers succession planning like never b',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-supply-for-construction-96f55be7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Supply for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Intelligent Supply for Construction. Powered by cutting-edge AI, this platform delivers succession planning like never before.
          </p>
