...
export const metadata = {
  title: "Serverless Integrated Travel Deployment - Zion Tech Group",
  description: "Serverless deployment platform that auto-scales integrated travel workloads without infrastructure management.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/serverless-integrated-travel-deployment-833d4e75`
  }
};
