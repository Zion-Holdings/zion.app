...
export const metadata: Metadata = {
  title: 'Next-Gen Management for Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Next-Gen Management for Healthcare leverages advanced machine learning to deliver energy management',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Management for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Next-Gen Management for Healthcare leverages advanced machine learning to deliver energy management at scale.
          </p>
