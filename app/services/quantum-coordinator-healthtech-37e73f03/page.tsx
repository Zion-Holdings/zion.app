...
export const metadata: Metadata = {
  title: 'Quantum coordinator-healthtech',
  description: 'Transform your healthtech operations with our Quantum coordinator-healthtech. This AI-driven solution automates workflow automation with unprecedented accuracy ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum coordinator-healthtech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthtech operations with our Quantum coordinator-healthtech. This AI-driven solution automates workflow automation with unprecedented accuracy and efficiency.
          </p>
