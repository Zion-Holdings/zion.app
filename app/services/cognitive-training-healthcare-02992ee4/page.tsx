...
export const metadata: Metadata = {
  title: 'Cognitive Training Healthcare',
  description: 'Revolutionize manufacturing through intelligent automation. Our Cognitive Training Healthcare leverages advanced machine learning to deliver enterprise-grade in',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-training-healthcare-02992ee4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Training Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize manufacturing through intelligent automation. Our Cognitive Training Healthcare leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
