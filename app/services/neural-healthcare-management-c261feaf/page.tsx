...
export const metadata: Metadata = {
  title: 'Neural Healthcare Management',
  description: 'Transform your logistics operations with our Neural Healthcare Management. This AI-driven solution automates market intelligence with unprecedented accuracy and',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Healthcare Management
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Neural Healthcare Management. This AI-driven solution automates market intelligence with unprecedented accuracy and efficiency.
          </p>
