...
export const metadata: Metadata = {
  title: 'AI Suite - Construction Edition',
  description: 'Optimize your construction workflows with AI Suite - Construction Edition. This intelligent platform delivers forecast accuracy through advanced automation and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-suite-construction-edition-7633c7cc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Suite - Construction Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with AI Suite - Construction Edition. This intelligent platform delivers forecast accuracy through advanced automation and AI.
          </p>
