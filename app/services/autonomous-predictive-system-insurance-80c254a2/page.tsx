...
export const metadata: Metadata = {
  title: 'Autonomous Predictive System - Insurance',
  description: 'Enhance your insurance business with Autonomous Predictive System - Insurance. Our solution provides api management with enterprise-grade reliability and securi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-predictive-system-insurance-80c254a2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Predictive System - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Autonomous Predictive System - Insurance. Our solution provides api management with enterprise-grade reliability and security.
          </p>
