...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'AI QA & Testing Agent', 'description': 'Autonomous QA agent that tests your application: generates test plans, executes tests, reports bugs with reproduction steps, and verifies fixes.', 'serviceType': 'automation', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'Quality Assurance'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'AI QA & Testing Agent Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$199/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$599/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': '$1,999/mo', 'priceCurrency': 'USD'}]}} />
    <JsonLd data={'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'AI test plan generation from requirements', 'acceptedAnswer': {'@type': 'Answer', 'text': 'AI test plan generation from requirements'}}, {'@type': 'Question', 'name': 'Automated test execution (functional, regression)', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Automated test execution (functional, regression)'}}, {'@type': 'Question', 'name': 'Bug reports with reproduction steps and logs', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Bug reports with reproduction steps and logs'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Autonomous testing without writing test code; Bug reports with steps that developers can reproduce; Regression testing after every deploy'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} />
