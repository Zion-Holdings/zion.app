...
export const metadata: Metadata = {
  title: 'Manager Intelligent - Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Manager Intelligent - Healthcare leverages advanced machine learning to deliver net promoter score ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/manager-intelligent-healthcare-d102a3d4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manager Intelligent - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Manager Intelligent - Healthcare leverages advanced machine learning to deliver net promoter score at scale.
          </p>
