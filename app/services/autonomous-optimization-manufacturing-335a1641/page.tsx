...
export const metadata: Metadata = {
  title: 'Autonomous optimization-manufacturing',
  description: 'Revolutionize manufacturing through intelligent automation. Our Autonomous optimization-manufacturing leverages advanced machine learning to deliver decision su',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize manufacturing through intelligent automation. Our Autonomous optimization-manufacturing leverages advanced machine learning to deliver decision support at scale.
          </p>
