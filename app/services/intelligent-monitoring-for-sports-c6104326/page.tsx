...
export const metadata: Metadata = {
  title: 'Intelligent Monitoring for Sports',
  description: 'Revolutionize sports through intelligent automation. Our Intelligent Monitoring for Sports leverages advanced machine learning to deliver market analysis at sca',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-monitoring-for-sports-c6104326',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Monitoring for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Intelligent Monitoring for Sports leverages advanced machine learning to deliver market analysis at scale.
          </p>
