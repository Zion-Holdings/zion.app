...
export const metadata: Metadata = {
  title: 'Intelligent System for Transportation #1',
  description: 'Enhance your transportation business with Intelligent System for Transportation #1. Our solution provides expense management with enterprise-grade reliability a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-system-for-transportation-1-dbab755c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent System for Transportation #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with Intelligent System for Transportation #1. Our solution provides expense management with enterprise-grade reliability and security.
          </p>
