...
export const metadata: Metadata = {
  title: 'AI/IT intelligence-legal',
  description: 'Next-generation legal solution: AI/IT intelligence-legal. Combines lakehouse architecture with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-intelligence-legal-2bee0112',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT intelligence-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: AI/IT intelligence-legal. Combines lakehouse architecture with adaptive intelligence for optimal results.
          </p>
