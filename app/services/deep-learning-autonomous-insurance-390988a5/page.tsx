...
export const metadata: Metadata = {
  title: 'Deep Learning Autonomous - Insurance',
  description: 'Optimize your insurance workflows with Deep Learning Autonomous - Insurance. This intelligent platform delivers sourcing optimization through advanced automatio',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Deep Learning Autonomous - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Deep Learning Autonomous - Insurance. This intelligent platform delivers sourcing optimization through advanced automation and AI.
          </p>
