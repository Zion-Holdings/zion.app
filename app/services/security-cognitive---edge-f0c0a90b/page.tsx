...
export const metadata: Metadata = {
  title: 'Security Cognitive - Edge',
  description: 'The future of edge is here with Security Cognitive - Edge. Powered by cutting-edge AI, this platform delivers quality control like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-cognitive---edge-f0c0a90b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Cognitive - Edge
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of edge is here with Security Cognitive - Edge. Powered by cutting-edge AI, this platform delivers quality control like never before.
          </p>
