...
export const metadata: Metadata = {
  title: "AI-Powered Customer Journey Mapping - AI-Powered Marketing Solution",
  description: "Visualizes and optimizes customer journeys using behavioral analytics.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-customer-journey-mapping-92683aa3",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Customer Journey Mapping - AI-Powered Marketing Solution
        </h1>
