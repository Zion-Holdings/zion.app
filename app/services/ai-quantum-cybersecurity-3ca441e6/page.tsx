...
export const metadata: Metadata = {
  title: 'AI Quantum - Cybersecurity',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cybersecurity through intelligent automation. Our AI Quantum - Cybersecurity leverages advanced machine learning to deliver sales forecasting at scale.
          </p>
