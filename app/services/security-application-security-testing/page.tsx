...
export const metadata: Metadata = {
  ...
  keywords: 'Static application security testing (SAST), Dynamic application security testing (DAST), Software composition analysis (SCA), API security testing, Interactive application security testing (IAST), Integration with CI/CD pipelines, Vulnerability prioritization, Remediation guidance, security, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Application Security Testing Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Comprehensive application security testing with SAST, DAST, SCA, and API security testing. Unified platform for DevSecOps teams.</p>
        ...
        <li class="text-slate-300">Static application security testing (SAST)</li>
        <li class="text-slate-300">Dynamic application security testing (DAST)</li>
        <li class="text-slate-300">Software composition analysis (SCA)</li>
        <li class="text-slate-300">API security testing</li>
        <li class="text-slate-300">Interactive application security testing (IAST)</li>
        <li class="text-slate-300">Integration with CI/CD pipelines</li>
        <li class="text-slate-300">Vulnerability prioritization</li>
        <li class="text-slate-300">Remediation guidance</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Find vulnerabilities early</li>
        <li class="text-slate-300">Unified security testing platform</li>
        <li class="text-slate-300">Developer-friendly remediation</li>
        <li class="text-slate-300">Automate security in CI/CD</li>
      </ul>
        </div>
