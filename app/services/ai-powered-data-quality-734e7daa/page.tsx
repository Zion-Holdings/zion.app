...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize construction through intelligent automation. Our AI-Powered Data Quality leverages advanced machine learning to deliver churn prediction at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-data-quality-734e7daa',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our AI-Powered Data Quality leverages advanced machine learning to deliver churn prediction at scale.
          </p>
