...
export const metadata: Metadata = {
  title: 'Automated Procurement NLP',
  description: 'Transform your telecom operations with our Automated Procurement NLP. This AI-driven solution provides intelligent automation with unprecedented accuracy and ef',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Procurement NLP
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your telecom operations with our Automated Procurement NLP. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
