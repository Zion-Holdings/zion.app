...
export const metadata: Metadata = {
  ...
  keywords: 'SD-WAN, Zero-trust security, 24/7 NOC, Predictable OPEX, Auto-scaling, QoS management, Encryption, Analytics, it, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Network as a Service</h1>
        <p className="text-lg text-slate-300 mb-8">Fully managed enterprise network with SD-WAN and zero-trust security.</p>
        ...
        <li class="text-slate-300">SD-WAN</li>
        <li class="text-slate-300">Zero-trust security</li>
        <li class="text-slate-300">24/7 NOC</li>
        <li class="text-slate-300">Predictable OPEX</li>
        <li class="text-slate-300">Auto-scaling</li>
        <li class="text-slate-300">QoS management</li>
        <li class="text-slate-300">Encryption</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">40% cost reduction</li>
        <li class="text-slate-300">Enterprise security</li>
        <li class="text-slate-300">Predictable costs</li>
        <li class="text-slate-300">Zero-touch provisioning</li>
      </ul>
        </div>
