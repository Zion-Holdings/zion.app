...
export const metadata: Metadata = {
  title: 'Automated Threat Cloud',
  description: 'Drive innovation in retail with Automated Threat Cloud. This AI-powered platform transforms risk assessment into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-threat-cloud-a622fefd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Threat Cloud
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in retail with Automated Threat Cloud. This AI-powered platform transforms risk assessment into a competitive advantage.
          </p>
