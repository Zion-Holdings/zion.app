...
export const metadata: Metadata = {
  title: 'Cloud AI - Edge',
  description: 'Revolutionize edge through intelligent automation. Our Cloud AI - Edge leverages advanced machine learning to deliver language processing at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cloud-ai---edge-f84d7f11',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize edge through intelligent automation. Our Cloud AI - Edge leverages advanced machine learning to deliver language processing at scale.
          </p>
