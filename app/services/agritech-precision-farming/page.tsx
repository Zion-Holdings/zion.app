      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Satellite imagery</li>
            <li className="text-purple-300">✓ Soil analysis</li>
            <li className="text-purple-300">✓ Crop health</li>
            <li className="text-purple-300">✓ Yield prediction</li>
            <li className="text-purple-300">✓ Irrigation scheduling</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ 20% higher yields</li>
            <li className="text-purple-300">✓ 30% less water</li>
            <li className="text-purple-300">✓ Pest early warning</li>
