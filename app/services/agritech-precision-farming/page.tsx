...
export const metadata: Metadata = {
  ...
  keywords: 'Satellite imagery, Soil analysis, Crop health, Yield prediction, Irrigation scheduling, Pest detection, Weather integration, Farm analytics, ai, Agriculture, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Precision Agriculture Platform</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered precision farming with satellite imagery, soil analysis, crop health monitoring, yield prediction, and automated irrigation scheduling.</p>
        ...
        <li class="text-slate-300">Satellite imagery</li>
        <li class="text-slate-300">Soil analysis</li>
        <li class="text-slate-300">Crop health</li>
        <li class="text-slate-300">Yield prediction</li>
        <li class="text-slate-300">Irrigation scheduling</li>
        <li class="text-slate-300">Pest detection</li>
        <li class="text-slate-300">Weather integration</li>
        <li class="text-slate-300">Farm analytics</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">20% higher yields</li>
        <li class="text-slate-300">30% less water</li>
        <li class="text-slate-300">Pest early warning</li>
