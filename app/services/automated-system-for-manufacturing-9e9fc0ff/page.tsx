...
export const metadata: Metadata = {
  title: 'Automated System for Manufacturing',
  description: 'Transform your manufacturing operations with our Automated System for Manufacturing. This AI-driven solution automates security monitoring with unprecedented ac',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your manufacturing operations with our Automated System for Manufacturing. This AI-driven solution automates security monitoring with unprecedented accuracy and efficiency.
          </p>
