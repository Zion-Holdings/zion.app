...
export const metadata: Metadata = {
  title: 'AI-Powered Cloud for Hospitality',
  description: 'The future of hospitality is here with AI-Powered Cloud for Hospitality. Powered by cutting-edge AI, this platform delivers business intelligence like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-cloud-for-hospitality-0592e065',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Cloud for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with AI-Powered Cloud for Hospitality. Powered by cutting-edge AI, this platform delivers business intelligence like never before.
          </p>
