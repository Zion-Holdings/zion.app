...
export const metadata: Metadata = {
  title: 'Cognitive Machine Learning Solution - Construction',
  description: 'Enhance your construction business with Cognitive Machine Learning Solution - Construction. Our solution provides financial planning with enterprise-grade relia',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-machine-learning-solution-construction-797fa8ab',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Machine Learning Solution - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Cognitive Machine Learning Solution - Construction. Our solution provides financial planning with enterprise-grade reliability and security.
          </p>
