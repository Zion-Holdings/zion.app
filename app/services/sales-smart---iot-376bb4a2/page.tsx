...
export const metadata: Metadata = {
  title: 'Sales Smart - Iot',
  description: 'Next-generation iot solution: Sales Smart - Iot. Combines content generation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/sales-smart---iot-376bb4a2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation iot solution: Sales Smart - Iot. Combines content generation with adaptive intelligence for optimal results.
          </p>
