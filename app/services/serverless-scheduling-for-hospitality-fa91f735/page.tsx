...
export const metadata: Metadata = {
  title: 'Serverless Scheduling for Hospitality',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Serverless Scheduling for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your hospitality with Serverless Scheduling for Hospitality. Our autonomous solution handles data processing end-to-end without human intervention.
          </p>
