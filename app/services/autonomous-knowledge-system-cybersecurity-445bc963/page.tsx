...
export const metadata: Metadata = {
  title: 'Autonomous Knowledge System - Cybersecurity',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Knowledge System - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation cybersecurity solution: Autonomous Knowledge System - Cybersecurity. Combines data fabric with adaptive intelligence for optimal results.
          </p>
