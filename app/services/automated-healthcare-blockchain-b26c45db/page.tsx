...
export const metadata: Metadata = {
  title: 'Automated healthcare-blockchain',
  description: 'Transform your blockchain operations with our Automated healthcare-blockchain. This AI-driven solution automates code optimization with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-healthcare-blockchain-b26c45db',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated healthcare-blockchain
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your blockchain operations with our Automated healthcare-blockchain. This AI-driven solution automates code optimization with unprecedented accuracy and efficiency.
          </p>
