...
export const metadata: Metadata = {
  title: 'Smart Healthcare Platform - Insurance #1',
  description: 'Enhance your insurance business with Smart Healthcare Platform - Insurance #1. Our solution provides capacity management with enterprise-grade reliability and s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-healthcare-platform-insurance-1-64dc4a02',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Healthcare Platform - Insurance #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Smart Healthcare Platform - Insurance #1. Our solution provides capacity management with enterprise-grade reliability and security.
          </p>
