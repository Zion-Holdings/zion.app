...
export const metadata: Metadata = {
  title: 'Predictive Marketing for Agritech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Marketing for Agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Predictive Marketing for Agritech. This autonomous system provides quality control with zero manual intervention needed.
          </p>
