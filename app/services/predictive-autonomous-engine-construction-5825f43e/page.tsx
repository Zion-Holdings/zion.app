...
export const metadata: Metadata = {
  ...
  description: 'Drive innovation in construction with Predictive Autonomous Engine - Construction. This AI-powered platform transforms net promoter score into a competitive adv',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-autonomous-engine-construction-5825f43e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Predictive Autonomous Engine - Construction. This AI-powered platform transforms net promoter score into a competitive advantage.
          </p>
