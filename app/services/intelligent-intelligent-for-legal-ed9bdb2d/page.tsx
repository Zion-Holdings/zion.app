...
export const metadata: Metadata = {
  title: 'Intelligent Intelligent for Legal',
  description: 'Revolutionize legal through intelligent automation. Our Intelligent Intelligent for Legal leverages advanced machine learning to deliver net promoter score at s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-intelligent-for-legal-ed9bdb2d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Intelligent for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Intelligent Intelligent for Legal leverages advanced machine learning to deliver net promoter score at scale.
          </p>
