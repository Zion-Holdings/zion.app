...
export const metadata: Metadata = {
  title: 'Cognitive Risk Solution - Manufacturing',
  description: 'Enhance your manufacturing business with Cognitive Risk Solution - Manufacturing. Our solution provides compliance monitoring with enterprise-grade reliability ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-risk-solution-manufacturing-abbec174',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Risk Solution - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your manufacturing business with Cognitive Risk Solution - Manufacturing. Our solution provides compliance monitoring with enterprise-grade reliability and security.
          </p>
