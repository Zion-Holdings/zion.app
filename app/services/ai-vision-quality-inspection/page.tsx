...
export const metadata: Metadata = {
  ...
  keywords: 'YOLOv8/RT-DETR model fine-tune on your SKU, Inference on edge device <30ms per frame, Real-time alarm + MES work-order auto-create, SPC chart + shift defect trend report, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Manufacturing/production line defect detection via camera feed YOLO/RT-DETR inference, real-time alarms, and SPC (Statistical Process Control) shift reports.</p>
        ...
        <li class="text-slate-300">YOLOv8/RT-DETR model fine-tune on your SKU</li>
        <li class="text-slate-300">Inference on edge device &lt;30ms per frame</li>
        <li class="text-slate-300">Real-time alarm + MES work-order auto-create</li>
        <li class="text-slate-300">SPC chart + shift defect trend report</li>
      </ul>
        </div>
