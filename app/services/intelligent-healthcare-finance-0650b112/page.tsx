...
export const metadata: Metadata = {
  title: 'Intelligent healthcare-finance',
  description: 'Next-generation finance solution: Intelligent healthcare-finance. Combines language processing with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-healthcare-finance-0650b112',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent healthcare-finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation finance solution: Intelligent healthcare-finance. Combines language processing with adaptive intelligence for optimal results.
          </p>
