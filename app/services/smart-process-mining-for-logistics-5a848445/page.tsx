...
export const metadata: Metadata = {
  title: 'Smart Process Mining for Logistics',
  description: 'Next-generation logistics solution: Smart Process Mining for Logistics. Combines supply chain with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-process-mining-for-logistics-5a848445',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Process Mining for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Smart Process Mining for Logistics. Combines supply chain with adaptive intelligence for optimal results.
          </p>
