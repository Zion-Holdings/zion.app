...
export const metadata: Metadata = {
  title: 'AI Generator - MARTECH Edition',
  description: 'Enhance your martech business with AI Generator - MARTECH Edition. Our solution provides compliance reporting with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-generator-martech-edition-29bc1498',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Generator - MARTECH Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your martech business with AI Generator - MARTECH Edition. Our solution provides compliance reporting with enterprise-grade reliability and security.
          </p>
