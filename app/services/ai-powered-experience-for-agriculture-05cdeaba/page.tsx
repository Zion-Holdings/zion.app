...
export const metadata: Metadata = {
  title: 'AI-Powered Experience for Agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our AI-Powered Experience for Agriculture leverages advanced machine learning to deliver threat detect',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-experience-for-agriculture-05cdeaba',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Experience for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our AI-Powered Experience for Agriculture leverages advanced machine learning to deliver threat detection at scale.
          </p>
