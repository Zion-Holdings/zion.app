...
export const metadata: Metadata = {
  title: 'System Autonomous - Healthcare',
  description: 'The future of healthcare is here with System Autonomous - Healthcare. Powered by cutting-edge AI, this platform delivers data governance like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/system-autonomous-healthcare-41f1bd2c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            System Autonomous - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with System Autonomous - Healthcare. Powered by cutting-edge AI, this platform delivers data governance like never before.
          </p>
