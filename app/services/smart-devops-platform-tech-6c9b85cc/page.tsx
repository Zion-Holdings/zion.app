...
export const metadata: Metadata = {
  title: 'Smart DevOps Platform - Tech',
  description: 'Next-generation technology solution: Smart DevOps Platform - Tech. Combines audit trail management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-devops-platform-tech-6c9b85cc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart DevOps Platform - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation technology solution: Smart DevOps Platform - Tech. Combines audit trail management with adaptive intelligence for optimal results.
          </p>
