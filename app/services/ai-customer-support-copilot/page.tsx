...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time response suggestions based on knowledge base, Automatic ticket summarization and categorization, Smart routing to best-qualified agent, Sentiment-aware tone adjustment, Multi-language support (50+ languages), Integration with Zendesk, Intercom, Freshdesk, ai, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Customer Support Copilot</h1>
        <p className="text-lg text-slate-300 mb-8">AI copilot for support agents that suggests responses, auto-summarizes tickets, and routes inquiries to the right team. Reduces average handle time by 40% while improving CSAT.</p>
        ...
        <li class="text-slate-300">Real-time response suggestions based on knowledge base</li>
        <li class="text-slate-300">Automatic ticket summarization and categorization</li>
        <li class="text-slate-300">Smart routing to best-qualified agent</li>
        <li class="text-slate-300">Sentiment-aware tone adjustment</li>
        <li class="text-slate-300">Multi-language support (50+ languages)</li>
        <li class="text-slate-300">Integration with Zendesk, Intercom, Freshdesk</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce handle time by 40%</li>
        <li class="text-slate-300">Improve first-contact resolution by 25%</li>
        <li class="text-slate-300">Consistent quality across all agents</li>
        <li class="text-slate-300">Scale support without adding headcount</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$49/agent/mo</p>
              <p class="text-sm text-slate-400">Getting started plan</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              <h3 class="font-semibold text-white mb-2">Pro</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">$99/agent/mo</p>
