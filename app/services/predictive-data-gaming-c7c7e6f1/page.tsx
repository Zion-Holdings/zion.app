...
export const metadata: Metadata = {
  title: 'Predictive data-gaming',
  description: 'Enhance your gaming business with Predictive data-gaming. Our solution provides customer onboarding with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-data-gaming-c7c7e6f1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive data-gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your gaming business with Predictive data-gaming. Our solution provides customer onboarding with enterprise-grade reliability and security.
          </p>
