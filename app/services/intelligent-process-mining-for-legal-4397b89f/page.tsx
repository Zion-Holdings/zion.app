...
export const metadata: Metadata = {
  title: 'Intelligent Process Mining for Legal',
  description: 'Drive innovation in legal with Intelligent Process Mining for Legal. This AI-powered platform transforms feedback collection into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-process-mining-for-legal-4397b89f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Process Mining for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Intelligent Process Mining for Legal. This AI-powered platform transforms feedback collection into a competitive advantage.
          </p>
