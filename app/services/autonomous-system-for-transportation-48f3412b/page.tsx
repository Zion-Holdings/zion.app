...
export const metadata: Metadata = {
  title: 'Autonomous System for Transportation',
  description: 'Next-generation transportation solution: Autonomous System for Transportation. Combines sales process optimization with adaptive intelligence for optimal result',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-system-for-transportation-48f3412b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous System for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation transportation solution: Autonomous System for Transportation. Combines sales process optimization with adaptive intelligence for optimal results.
          </p>
