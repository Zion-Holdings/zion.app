...
export const metadata: Metadata = {
  title: 'Customer Experience AI-Powered Log Management',
  description: 'AI-powered customer experience solution for devops. Centralized log management with AI-powered analysis and alerting.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/customer-experience-ai-powered-log-management-d97e4d51',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Customer Experience AI-Powered Log Management
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered customer experience solution for devops. Centralized log management with AI-powered analysis and alerting.
          </p>
