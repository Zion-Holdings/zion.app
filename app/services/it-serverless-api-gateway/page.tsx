...
export const metadata: Metadata = {
  ...
  keywords: 'JWT/OAuth validation, Request/response transformation, Response caching (Redis), Rate limiting & quotas, WebSocket support, it, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Serverless API Gateway</h1>
        <p className="text-lg text-slate-300 mb-8">Fully managed API gateway with rate limiting, auth, caching, and transformation. Pay-per-request pricing, auto-scaling to millions of RPS.</p>
        ...
        <li class="text-slate-300">JWT/OAuth validation</li>
        <li class="text-slate-300">Request/response transformation</li>
        <li class="text-slate-300">Response caching (Redis)</li>
        <li class="text-slate-300">Rate limiting &amp; quotas</li>
        <li class="text-slate-300">WebSocket support</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with serverless api gateway</li>
