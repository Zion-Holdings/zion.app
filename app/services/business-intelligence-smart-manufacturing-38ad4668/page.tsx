...
export const metadata: Metadata = {
  title: 'Business Intelligence Smart - Manufacturing',
  description: 'Revolutionize manufacturing through intelligent automation. Our Business Intelligence Smart - Manufacturing leverages advanced machine learning to deliver enter',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Business Intelligence Smart - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize manufacturing through intelligent automation. Our Business Intelligence Smart - Manufacturing leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
