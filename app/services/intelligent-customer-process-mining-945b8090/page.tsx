...
export const metadata: Metadata = {
  title: 'Intelligent Customer Process Mining',
  description: 'The future of legal is here with Intelligent Customer Process Mining. Powered by cutting-edge AI, this platform delivers serverless deployment like never before',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-customer-process-mining-945b8090',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Customer Process Mining
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Intelligent Customer Process Mining. Powered by cutting-edge AI, this platform delivers serverless deployment like never before.
          </p>
