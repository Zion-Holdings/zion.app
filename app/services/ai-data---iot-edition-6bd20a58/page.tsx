...
export const metadata: Metadata = {
  title: 'AI Data - Iot Edition',
  description: 'Revolutionize iot through intelligent automation. Our AI Data - Iot Edition leverages advanced machine learning to deliver performance monitoring at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-data---iot-edition-6bd20a58',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize iot through intelligent automation. Our AI Data - Iot Edition leverages advanced machine learning to deliver performance monitoring at scale.
          </p>
