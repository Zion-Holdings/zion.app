...
export const metadata: Metadata = {
  title: 'Cognitive Customer Service for Retail',
  description: 'The future of retail is here with Cognitive Customer Service for Retail. Powered by cutting-edge AI, this platform delivers resource optimization like never bef',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Customer Service for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Cognitive Customer Service for Retail. Powered by cutting-edge AI, this platform delivers resource optimization like never before.
          </p>
