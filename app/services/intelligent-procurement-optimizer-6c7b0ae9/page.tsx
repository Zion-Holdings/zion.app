...
export const metadata: Metadata = {
  title: 'Intelligent Procurement Optimizer',
  description: 'Next-generation education solution: Intelligent Procurement Optimizer. Combines customer journey mapping with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-procurement-optimizer-6c7b0ae9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Procurement Optimizer
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation education solution: Intelligent Procurement Optimizer. Combines customer journey mapping with adaptive intelligence for optimal results.
          </p>
