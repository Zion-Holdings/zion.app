...
export const metadata: Metadata = {
  title: 'Automated Engine for Real-Estate',
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-engine-for-real-estate-e11d4ea1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Engine for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of real-estate is here with Automated Engine for Real-Estate. Powered by cutting-edge AI, this platform delivers risk assessment like never before.
          </p>
