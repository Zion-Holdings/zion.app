...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://ziontechgroup.com/services/accounts-receivable-ai-powered-database-optimization-968fa3f2",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Accounts Receivable AI-Powered Database Optimization - AI-Powered Accounts Receivable Solution
        </h1>
