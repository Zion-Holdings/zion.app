...
export const metadata: Metadata = {
  title: 'Smart Customer Service for Transportation',
  description: 'The future of transportation is here with Smart Customer Service for Transportation. Powered by cutting-edge AI, this platform delivers customer service automat',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-customer-service-for-transportation-cba0c0f4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Customer Service for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Smart Customer Service for Transportation. Powered by cutting-edge AI, this platform delivers customer service automation like never before.
          </p>
