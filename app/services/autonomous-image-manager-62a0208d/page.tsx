...
export const metadata: Metadata = {
  title: 'Autonomous Image Manager',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Image Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your finance workflows with Autonomous Image Manager. This intelligent platform delivers data pipeline orchestration through advanced automation and AI.
          </p>
