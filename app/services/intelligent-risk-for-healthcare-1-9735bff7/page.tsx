...
export const metadata: Metadata = {
  title: 'Intelligent Risk for Healthcare #1',
  description: 'Next-generation healthcare solution: Intelligent Risk for Healthcare #1. Combines financial planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-risk-for-healthcare-1-9735bff7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Risk for Healthcare #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Intelligent Risk for Healthcare #1. Combines financial planning with adaptive intelligence for optimal results.
          </p>
