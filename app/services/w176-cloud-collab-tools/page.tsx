...
export const metadata: Metadata = {
  ...
  keywords: 'M365 or Google Workspace design and deployment, Email and file migration, Security and DLP configuration, Teams/Meet collaboration setup, Adoption tracking and training, License optimization, Ongoing support and optimization, cloud, Productivity, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cloud Collaboration &amp; Productivity</h1>
        <p className="text-lg text-slate-300 mb-8">Managed cloud productivity suite: M365 or Google Workspace deployment, migration, security configuration, and adoption optimization.</p>
        ...
        <li class="text-slate-300">M365 or Google Workspace design and deployment</li>
        <li class="text-slate-300">Email and file migration</li>
        <li class="text-slate-300">Security and DLP configuration</li>
        <li class="text-slate-300">Teams/Meet collaboration setup</li>
        <li class="text-slate-300">Adoption tracking and training</li>
        <li class="text-slate-300">License optimization</li>
        <li class="text-slate-300">Ongoing support and optimization</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Expert deployment avoids common pitfalls</li>
        <li class="text-slate-300">Migration with zero data loss</li>
        <li class="text-slate-300">Security configured to best practices</li>
        <li class="text-slate-300">Adoption tracking ensures ROI</li>
      </ul>
        </div>
