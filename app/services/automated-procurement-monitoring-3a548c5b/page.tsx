...
export const metadata: Metadata = {
  title: 'Automated Procurement Monitoring',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Automated Procurement Monitoring. Our solution provides testing automation with enterprise-grade reliability and security.
          </p>
