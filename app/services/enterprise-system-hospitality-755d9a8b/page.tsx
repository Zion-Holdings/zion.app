...
export const metadata: Metadata = {
  ...
  description: 'Transform your hospitality operations with our Enterprise System - Hospitality. This AI-driven solution automates budget optimization with unprecedented accurac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-system-hospitality-755d9a8b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Enterprise System - Hospitality. This AI-driven solution automates budget optimization with unprecedented accuracy and efficiency.
          </p>
