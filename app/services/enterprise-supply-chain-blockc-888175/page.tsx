...
export const metadata: Metadata = {
  title: 'Enterprise Supply Chain Blockchain (Cloud)',
  description: 'Enterprise Supply Chain Blockchain (Cloud) is an AI-powered cloud solution that transforms how businesses operate through intelligent automation and real-time a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-supply-chain-blockc-888175',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Supply Chain Blockchain (Cloud)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enterprise Supply Chain Blockchain (Cloud) is an AI-powered cloud solution that transforms how businesses operate through intelligent automation and real-time analytics.
...
Computer Vision, Ansible, Edge Computing, Express, Node.js, Go
