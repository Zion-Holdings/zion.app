...
export const metadata: Metadata = {
  title: 'Smart Security for Healthcare',
  description: 'Transform your healthcare operations with our Smart Security for Healthcare. This AI-driven solution automates financial planning with unprecedented accuracy an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-security-for-healthcare-a17b047a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Security for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Smart Security for Healthcare. This AI-driven solution automates financial planning with unprecedented accuracy and efficiency.
          </p>
