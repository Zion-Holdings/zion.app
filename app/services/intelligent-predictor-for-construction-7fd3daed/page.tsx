...
export const metadata: Metadata = {
  title: 'Intelligent Predictor for Construction',
  description: 'Transform your construction operations with our Intelligent Predictor for Construction. This AI-driven solution automates procurement automation with unpreceden',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-predictor-for-construction-7fd3daed',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Predictor for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Intelligent Predictor for Construction. This AI-driven solution automates procurement automation with unprecedented accuracy and efficiency.
          </p>
