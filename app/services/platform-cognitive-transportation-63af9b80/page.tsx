...
export const metadata: Metadata = {
  title: 'Platform Cognitive - Transportation',
  description: 'Drive innovation in transportation with Platform Cognitive - Transportation. This AI-powered platform transforms predictive analytics into a competitive advanta',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/platform-cognitive-transportation-63af9b80',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Platform Cognitive - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in transportation with Platform Cognitive - Transportation. This AI-powered platform transforms predictive analytics into a competitive advantage.
          </p>
