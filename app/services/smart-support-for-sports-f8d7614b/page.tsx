...
export const metadata: Metadata = {
  title: 'Smart Support for Sports',
  description: 'Revolutionize sports through intelligent automation. Our Smart Support for Sports leverages advanced machine learning to deliver fraud prevention at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-support-for-sports-f8d7614b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Support for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Smart Support for Sports leverages advanced machine learning to deliver fraud prevention at scale.
          </p>
