...
export const metadata: Metadata = {
  title: 'AI Automated - Energy',
  description: 'Transform your energy operations with our AI Automated - Energy. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficie',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our AI Automated - Energy. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
