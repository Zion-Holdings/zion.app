...
export const metadata: Metadata = {
  title: 'Platform Intelligent - Real-Estate',
  description: 'Transform your real-estate operations with our Platform Intelligent - Real-Estate. This AI-driven solution automates master data management with unprecedented a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/platform-intelligent-real-estate-b641d135',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Platform Intelligent - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Platform Intelligent - Real-Estate. This AI-driven solution automates master data management with unprecedented accuracy and efficiency.
          </p>
