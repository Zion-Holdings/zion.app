...
export const metadata: Metadata = {
  title: 'AI/IT SMB Suite - Legal',
  description: 'Optimize your legal workflows with AI/IT SMB Suite - Legal. This intelligent platform delivers process discovery through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-smb-suite-legal-33c9b4ac',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT SMB Suite - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with AI/IT SMB Suite - Legal. This intelligent platform delivers process discovery through advanced automation and AI.
          </p>
