...
export const metadata: Metadata = {
  ...
  keywords: 'Role-based access control, Multi-region deployment, Offline capabilities, Audit trails, GDPR compliance, Comprehensive monitoring, coordinator, energy, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Intelligent Platform for Energy</h1>
        <p className="text-lg text-slate-300 mb-8">Unlock unprecedented growth with Intelligent Platform for Energy. This autonomous system provides energy management with zero manual intervention needed.</p>
