  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Hybrid Multi-Cloud Orchestrator</h1>
        <p className="text-lg text-slate-300 mb-8">Single-pane hybrid-multi-cloud management: deploy, monitor, and govern workloads across AWS, Azure, GCP, and on-prem from a unified control plane with standardised cost, security, and compliance dashboards.</p>
        ...
        <li class="text-slate-300">Unified control plane deploys to any cloud or on-prem with a single API</li>
        <li class="text-slate-300">Standardised cost dashboard: per-workload spend across all clouds, anomaly alerts</li>
        <li class="text-slate-300">Unified security posture: CSPM findings pitched against unified CIS/PCI benchmark</li>
        <li class="text-slate-300">Federated identity: SSO/SAML/OIDC across all clouds</li>
        <li class="text-slate-300">Policy engine OPA — policy-as-code to guard all infrastructure agnostic of provider</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with hybrid multi-cloud orchestrator</li>
