...
export const metadata: Metadata = {
  title: 'AI-Powered AR/VR Content Creator',
  description: 'Generates AR/VR content from 2D images and videos with AI-powered enhancement.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-arvr-content-creator-30c68acb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered AR/VR Content Creator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Generates AR/VR content from 2D images and videos with AI-powered enhancement.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">3D enhancement</li>
          <li className="text-gray-300">Interactive experiences</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">10x faster creation</li>
