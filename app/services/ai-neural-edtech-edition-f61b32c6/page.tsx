...
export const metadata: Metadata = {
  title: 'AI Neural - EDTECH Edition',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Neural - EDTECH Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for edtech: AI Neural - EDTECH Edition. Uses quantum-inspired algorithms to deliver threat detection at exponential speed.
          </p>
