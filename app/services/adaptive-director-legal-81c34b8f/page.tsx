...
export const metadata: Metadata = {
  title: 'Adaptive director-legal',
  description: 'Drive innovation in legal with Adaptive director-legal. This AI-powered platform transforms budget optimization into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-director-legal-81c34b8f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive director-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Adaptive director-legal. This AI-powered platform transforms budget optimization into a competitive advantage.
          </p>
