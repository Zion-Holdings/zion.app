...
export const metadata: Metadata = {
  title: 'Enterprise Predictive Platform - Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Enterprise Predictive Platform - Insurance leverages advanced machine learning to deliver warehouse ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-predictive-platform-insurance-67eb3510',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Predictive Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Enterprise Predictive Platform - Insurance leverages advanced machine learning to deliver warehouse automation at scale.
          </p>
