...
export const metadata: Metadata = {
  title: 'Operational Cognitive - PROPTECH',
  description: 'Transform your proptech operations with our Operational Cognitive - PROPTECH. This AI-driven solution automates performance tuning with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/operational-cognitive-proptech-93d82dce',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Operational Cognitive - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your proptech operations with our Operational Cognitive - PROPTECH. This AI-driven solution automates performance tuning with unprecedented accuracy and efficiency.
          </p>
