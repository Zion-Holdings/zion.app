...
export const metadata: Metadata = {
  title: 'Risk Predictive - Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Risk Predictive - Hospitality leverages advanced machine learning to deliver business intelligence',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/risk-predictive-hospitality-0e56fc83',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Risk Predictive - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Risk Predictive - Hospitality leverages advanced machine learning to deliver business intelligence at scale.
          </p>
