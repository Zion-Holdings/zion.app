...
export const metadata: Metadata = {
  title: 'Smart Intelligence Platform - Enterprise',
  description: 'Future-proof your enterprise with Smart Intelligence Platform - Enterprise. Our autonomous solution handles market analysis end-to-end without human interventio',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-intelligence-platform-enterprise-0573d489',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Intelligence Platform - Enterprise
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your enterprise with Smart Intelligence Platform - Enterprise. Our autonomous solution handles market analysis end-to-end without human intervention.
          </p>
