...
export const metadata: Metadata = {
  ...
  keywords: 'Global anycast network, DDoS protection, Intelligent routing, Automatic failover, Health checks, DNSSEC, Traffic analytics, 100% uptime SLA, it, Enterprise, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Managed DNS &amp; Traffic Management</h1>
        <p className="text-lg text-slate-300 mb-8">Enterprise-grade DNS management with global anycast network, DDoS protection, and intelligent traffic routing. 100% uptime SLA with automatic failover and health checks.</p>
        ...
        <li class="text-slate-300">Global anycast network</li>
        <li class="text-slate-300">DDoS protection</li>
        <li class="text-slate-300">Intelligent routing</li>
        <li class="text-slate-300">Automatic failover</li>
        <li class="text-slate-300">Health checks</li>
        <li class="text-slate-300">DNSSEC</li>
        <li class="text-slate-300">Traffic analytics</li>
        <li class="text-slate-300">100% uptime SLA</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">100% DNS uptime</li>
        <li class="text-slate-300">50% faster resolution</li>
        <li class="text-slate-300">DDoS protection included</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">200</p>
