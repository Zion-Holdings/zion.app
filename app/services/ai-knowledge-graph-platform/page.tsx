      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Entity resolution</li>
            <li className="text-purple-300">✓ Relationship discovery</li>
            <li className="text-purple-300">✓ Semantic search</li>
            <li className="text-purple-300">✓ Graph analytics</li>
            <li className="text-purple-300">✓ Ontology management</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Connected data insights</li>
            <li className="text-purple-300">✓ Entity disambiguation</li>
            <li className="text-purple-300">✓ Relationship discovery</li>
            <li className="text-purple-300">✓ Semantic search</li>
            <li className="text-purple-300">✓ Graph analytics</li>
            </ul>
