...
export const metadata: Metadata = {
  ...
  keywords: 'Entity resolution, Relationship discovery, Semantic search, Graph analytics, Ontology management, Data integration, Visualization, API access, ai, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Knowledge Graph &amp; Entity Resolution Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Build and query enterprise knowledge graphs. Entity resolution, relationship discovery, semantic search, and graph analytics for connected data intelligence.</p>
        ...
        <li class="text-slate-300">Entity resolution</li>
        <li class="text-slate-300">Relationship discovery</li>
        <li class="text-slate-300">Semantic search</li>
        <li class="text-slate-300">Graph analytics</li>
        <li class="text-slate-300">Ontology management</li>
        <li class="text-slate-300">Data integration</li>
        <li class="text-slate-300">Visualization</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Connected data insights</li>
        <li class="text-slate-300">Entity disambiguation</li>
        <li class="text-slate-300">Relationship discovery</li>
        <li class="text-slate-300">Semantic search</li>
        <li class="text-slate-300">Graph analytics</li>
      </ul>
