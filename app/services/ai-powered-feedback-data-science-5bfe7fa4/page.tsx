...
export const metadata: Metadata = {
  title: 'AI-Powered Feedback Data Science',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Feedback Data Science
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with AI-Powered Feedback Data Science. This AI-powered platform transforms inventory management into a competitive advantage.
          </p>
