...
export const metadata = {
  ...
  alternates: { canonical: '/services/cloud-cost-optimization-checklist-2026-6902/' },

  openGraph: {
    title: 'Cloud Cost Optimization | Zion Tech Group',
    description: 'End-to-end cloud cost optimization services: assessment, deployment, and managed operations.',
    url: 'https://ziontechgroup.com/services/cloud-cost-optimization-checklist-2026-6902/',
...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "Cloud Cost Optimization | Zion Tech Group", description: "End-to-end cloud cost optimization services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/cloud-cost-optimization-checklist-2026-6902/"}} />
