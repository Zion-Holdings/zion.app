...
export const metadata: Metadata = {
  title: 'DevOps Predictive - Hospitality',
  description: 'Transform your hospitality operations with our DevOps Predictive - Hospitality. This AI-driven solution automates recruitment automation with unprecedented accu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            DevOps Predictive - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our DevOps Predictive - Hospitality. This AI-driven solution automates recruitment automation with unprecedented accuracy and efficiency.
          </p>
