...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-lang static analysis 20+ languages, custom rulesets, CVE/GHSA dependency scanning with severity-graded alerts, Code-smell auditor + complexity hot-spot mapper, Quality-gate CI/CD blocks merge on quality score threshold, IDE plugin: VS Code + JetBrains — inline issue highlight + auto-fix, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Code Quality &amp; Governance Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Automated code-quality scanning: static analysis, lint coverage gates, dependency vulnerability CVE detection, code smell auditor, branch-protection + quality-gate CI/CD enforcement, and actionable fix suggestions.</p>
        ...
        <li class="text-slate-300">Multi-lang static analysis 20+ languages, custom rulesets</li>
        <li class="text-slate-300">CVE/GHSA dependency scanning with severity-graded alerts</li>
        <li class="text-slate-300">Code-smell auditor + complexity hot-spot mapper</li>
        <li class="text-slate-300">Quality-gate CI/CD blocks merge on quality score threshold</li>
        <li class="text-slate-300">IDE plugin: VS Code + JetBrains — inline issue highlight + auto-fix</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with code quality &amp; governance platform</li>
