...
export const metadata: Metadata = {
  title: 'Autonomous Support System - Real-Estate',
  description: 'Enhance your real-estate business with Autonomous Support System - Real-Estate. Our solution provides data governance with enterprise-grade reliability and secu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Support System - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your real-estate business with Autonomous Support System - Real-Estate. Our solution provides data governance with enterprise-grade reliability and security.
          </p>
