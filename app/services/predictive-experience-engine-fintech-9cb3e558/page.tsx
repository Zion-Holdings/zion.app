...
export const metadata: Metadata = {
  title: 'Predictive Experience Engine - FINTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Experience Engine - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your fintech business with Predictive Experience Engine - FINTECH. Our solution provides user experience with enterprise-grade reliability and security.
          </p>
