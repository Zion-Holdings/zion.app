...
export const metadata: Metadata = {
  title: 'Smart generator-transportation',
  description: 'Optimize your transportation workflows with Smart generator-transportation. This intelligent platform delivers scalability planning through advanced automation ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-generator-transportation-b3132431',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart generator-transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Smart generator-transportation. This intelligent platform delivers scalability planning through advanced automation and AI.
          </p>
