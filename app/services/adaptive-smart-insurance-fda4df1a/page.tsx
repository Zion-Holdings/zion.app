...
export const metadata: Metadata = {
  title: 'Adaptive smart-insurance',
  description: 'Optimize your insurance workflows with Adaptive smart-insurance. This intelligent platform delivers threat detection through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-smart-insurance-fda4df1a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive smart-insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Adaptive smart-insurance. This intelligent platform delivers threat detection through advanced automation and AI.
          </p>
