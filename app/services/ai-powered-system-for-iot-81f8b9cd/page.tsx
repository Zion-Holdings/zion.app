...
export const metadata: Metadata = {
  title: 'AI-Powered System for Iot',
  description: 'Next-generation iot solution: AI-Powered System for Iot. Combines financial planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-system-for-iot-81f8b9cd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered System for Iot
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation iot solution: AI-Powered System for Iot. Combines financial planning with adaptive intelligence for optimal results.
          </p>
