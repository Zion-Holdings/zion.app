...
export const metadata: Metadata = {
  title: "AI SEO Content Engine | Zion Tech Group",
  ...
  openGraph: {
    title: "AI SEO Content Engine | Zion Tech Group",
    description: "Generate search-optimized articles, product pages, and blog posts at scale. AI handles keyword research, outline creation, writing, and on-page SEO while matching your brand voice.",
    url: "https://ziontechgroup.com/services/ai-seo-content-engine/",
    type: 'website',
  },
  alternates: { canonical: "/services/ai-seo-content-engine/" },
};

export default function AiSeoContentEnginePage() {
  return (
    <StandardPage
      title="AI SEO Content Engine"
      subtitle="Generate search-optimized articles, product pages, and blog posts at scale. AI handles keyword research, outline creation, writing, and on-page SEO while matching your brand voice."
      breadcrumbItems={[
        { label: "Home", href: "/" },
        { label: "Services", href: "/services/" },
        { label: "AI SEO Content Engine" }
      ]}
      actions={[
    ...
    >
        ...
        <div className="rounded-2xl border border-white/10 bg-slate-900/40 p-5"><h2 className="text-white font-semibold mb-2">AI SEO Content Engine</h2><p className="text-slate-400 text-sm">Archived section recovered from the live site snapshot.</p></div>
      ...
      <p className="text-slate-400 leading-relaxed mb-4 max-w-5xl mx-auto">Estimated timeline for AI SEO Content Engine — adapt to your team size and complexity.</p>
      ...
      <p className="text-slate-500 text-sm max-w-5xl mx-auto">Restored from a Wayback Machine snapshot (20260614135052) of ziontechgroup.com.</p>
    </StandardPage>
  );
}
