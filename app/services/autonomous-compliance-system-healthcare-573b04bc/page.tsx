...
export const metadata: Metadata = {
  title: 'Autonomous Compliance System - Healthcare',
  description: 'Optimize your healthcare workflows with Autonomous Compliance System - Healthcare. This intelligent platform delivers master data management through advanced au',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-compliance-system-healthcare-573b04bc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Compliance System - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Autonomous Compliance System - Healthcare. This intelligent platform delivers master data management through advanced automation and AI.
          </p>
