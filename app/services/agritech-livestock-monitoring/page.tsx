...
export const metadata: Metadata = {
  ...
  keywords: 'Behavioral anomaly detection, Illness early warning, Feeding pattern analysis, Breeding optimization, GPS tracking and geofencing, Integration with farm management software, Veterinary alert system, Herds analytics dashboard, agritech, Agriculture, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Livestock Health Monitoring</h1>
        <p className="text-lg text-slate-300 mb-8">IoT and AI-powered livestock health monitoring. Track animal behavior, detect illness early, monitor feeding patterns, and optimize breeding programs.</p>
        ...
        <li class="text-slate-300">Illness early warning</li>
        <li class="text-slate-300">Feeding pattern analysis</li>
        <li class="text-slate-300">Breeding optimization</li>
        <li class="text-slate-300">GPS tracking and geofencing</li>
        <li class="text-slate-300">Integration with farm management software</li>
        <li class="text-slate-300">Veterinary alert system</li>
        <li class="text-slate-300">Herds analytics dashboard</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce livestock mortality by 25%</li>
        <li class="text-slate-300">Early disease detection</li>
        <li class="text-slate-300">Optimize feed costs</li>
        <li class="text-slate-300">Improve breeding outcomes</li>
      </ul>
        </div>
