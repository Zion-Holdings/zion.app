...
export const metadata: Metadata = {
  title: 'Platform Adaptive - Transportation',
  description: 'Transform your transportation operations with our Platform Adaptive - Transportation. This AI-driven solution provides intelligent automation with unprecedented',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/platform-adaptive-transportation-060f83a3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Platform Adaptive - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your transportation operations with our Platform Adaptive - Transportation. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
