...
export const metadata: Metadata = {
  title: 'Predictive Finance Engine - Retail',
  description: 'The future of retail is here with Predictive Finance Engine - Retail. Powered by cutting-edge AI, this platform delivers lead scoring like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-finance-engine-retail-e7f1706f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Finance Engine - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Predictive Finance Engine - Retail. Powered by cutting-edge AI, this platform delivers lead scoring like never before.
          </p>
