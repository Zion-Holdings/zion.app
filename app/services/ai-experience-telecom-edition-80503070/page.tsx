...
export const metadata: Metadata = {
  title: 'AI Experience - Telecom Edition',
  description: 'Revolutionize telecom through intelligent automation. Our AI Experience - Telecom Edition leverages advanced machine learning to deliver procurement automation ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-experience-telecom-edition-80503070',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Experience - Telecom Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our AI Experience - Telecom Edition leverages advanced machine learning to deliver procurement automation at scale.
          </p>
