...
export const metadata: Metadata = {
  title: 'AI-Powered Manufacturing for PROPTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Manufacturing for PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for proptech: AI-Powered Manufacturing for PROPTECH. Uses quantum-inspired algorithms to deliver regulatory tracking at exponential speed.
          </p>
