...
export const metadata: Metadata = {
  title: 'Analyzer Smart - Edge',
  description: 'The future of edge is here with Analyzer Smart - Edge. Powered by cutting-edge AI, this platform delivers healthcare data analytics like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/analyzer-smart---edge-76ef0da5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of edge is here with Analyzer Smart - Edge. Powered by cutting-edge AI, this platform delivers healthcare data analytics like never before.
          </p>
