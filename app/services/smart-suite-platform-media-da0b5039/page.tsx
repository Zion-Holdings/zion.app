...
export const metadata: Metadata = {
  title: 'Smart Suite Platform - Media',
  description: 'Enhance your media business with Smart Suite Platform - Media. Our solution provides process automation with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-suite-platform-media-da0b5039',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Suite Platform - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your media business with Smart Suite Platform - Media. Our solution provides process automation with enterprise-grade reliability and security.
          </p>
