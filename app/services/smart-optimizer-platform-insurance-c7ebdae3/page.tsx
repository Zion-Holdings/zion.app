...
export const metadata: Metadata = {
  title: 'Smart Optimizer Platform - Insurance',
  description: 'Drive innovation in insurance with Smart Optimizer Platform - Insurance. This AI-powered platform transforms competitive intelligence into a competitive advanta',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Optimizer Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Smart Optimizer Platform - Insurance. This AI-powered platform transforms competitive intelligence into a competitive advantage.
          </p>
