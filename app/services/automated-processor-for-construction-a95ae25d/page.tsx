...
export const metadata: Metadata = {
  ...
  keywords: 'Performance dashboards, Comprehensive monitoring, Offline capabilities, Machine learning integration, Audit trails, Microservices deployment, insights, construction, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Automated Processor for Construction</h1>
        <p className="text-lg text-slate-300 mb-8">Revolutionize construction through intelligent automation. Our Automated Processor for Construction leverages advanced machine learning to deliver energy management at scale.</p>
