...
export const metadata: Metadata = {
  title: "AI-Powered Blockchain Analytics - AI-Powered Blockchain Solution",
  description: "Analyzes blockchain transactions and smart contracts using AI to detect patterns.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-blockchain-analytics-06b497fe",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Blockchain Analytics - AI-Powered Blockchain Solution
        </h1>
