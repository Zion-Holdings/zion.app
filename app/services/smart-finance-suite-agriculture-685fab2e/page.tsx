...
export const metadata: Metadata = {
  title: 'Smart Finance Suite - Agriculture',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Finance Suite - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your agriculture workflows with Smart Finance Suite - Agriculture. This intelligent platform delivers data quality through advanced automation and AI.
          </p>
