...
export const metadata: Metadata = {
  title: 'AI/IT Knowledge Suite - PROPTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Knowledge Suite - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for proptech: AI/IT Knowledge Suite - PROPTECH. Uses quantum-inspired algorithms to deliver api composition at exponential speed.
          </p>
