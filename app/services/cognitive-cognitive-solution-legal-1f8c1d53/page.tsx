...
export const metadata: Metadata = {
  title: 'Cognitive Cognitive Solution - Legal',
  description: 'Enhance your legal business with Cognitive Cognitive Solution - Legal. Our solution provides business continuity with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-cognitive-solution-legal-1f8c1d53',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Cognitive Solution - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Cognitive Cognitive Solution - Legal. Our solution provides business continuity with enterprise-grade reliability and security.
          </p>
