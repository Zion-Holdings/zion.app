...
export const metadata: Metadata = {
  title: 'AI-Powered Merchandise Planning',
  description: 'Automatically plans product assortments and promotions based on demand forecasts and profitability.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-merchandise-planning-780c0bb7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Merchandise Planning
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Automatically plans product assortments and promotions based on demand forecasts and profitability.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Assortment planning</li>
          <li className="text-gray-300">Promotion optimization</li>
          <li className="text-gray-300">Profit maximization</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">20% margin improvement</li>
