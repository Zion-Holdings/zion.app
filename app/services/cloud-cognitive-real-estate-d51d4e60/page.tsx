...
export const metadata: Metadata = {
  title: 'Cloud Cognitive - Real-Estate',
  description: 'The future of real-estate is here with Cloud Cognitive - Real-Estate. Powered by cutting-edge AI, this platform delivers transformative results like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cloud-cognitive-real-estate-d51d4e60',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cloud Cognitive - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of real-estate is here with Cloud Cognitive - Real-Estate. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
