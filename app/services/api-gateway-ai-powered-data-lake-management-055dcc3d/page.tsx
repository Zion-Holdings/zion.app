...
export const metadata: Metadata = {
  title: 'API Gateway AI-Powered Data Lake Management',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            API Gateway AI-Powered Data Lake Management
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered api gateway solution for data engineering. Automated data lake organization and metadata management.
          </p>
