...
export const metadata: Metadata = {
  title: 'DevOps Smart - Blockchain',
  description: 'Transform your blockchain operations with our DevOps Smart - Blockchain. This AI-driven solution automates workflow management with unprecedented accuracy and e',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/devops-smart---blockchain-6e006204',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            DevOps Smart - Blockchain
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your blockchain operations with our DevOps Smart - Blockchain. This AI-driven solution automates workflow management with unprecedented accuracy and efficiency.
          </p>
