...
export const metadata: Metadata = {
  ...
  description: 'Drive innovation in healthcare with Autonomous Predictor System - Healthcare. This AI-powered platform transforms language processing into a competitive advanta',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with Autonomous Predictor System - Healthcare. This AI-powered platform transforms language processing into a competitive advantage.
          </p>
