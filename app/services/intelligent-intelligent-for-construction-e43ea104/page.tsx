...
export const metadata: Metadata = {
  title: 'Intelligent Intelligent for Construction',
  description: 'Enhance your construction business with Intelligent Intelligent for Construction. Our solution provides financial planning with enterprise-grade reliability and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-intelligent-for-construction-e43ea104',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Intelligent for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Intelligent Intelligent for Construction. Our solution provides financial planning with enterprise-grade reliability and security.
          </p>
