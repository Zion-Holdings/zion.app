...
export const metadata: Metadata = {
  title: 'Cognitive Monitoring for Agritech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Monitoring for Agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agritech solution: Cognitive Monitoring for Agritech. Combines financial risk management with adaptive intelligence for optimal results.
          </p>
