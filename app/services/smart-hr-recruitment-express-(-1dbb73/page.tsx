...
export const metadata: Metadata = {
  title: 'Smart HR Recruitment Express (Marketing)',
  description: 'Smart HR Recruitment Express (Marketing) is an AI-powered marketing solution that transforms how businesses operate through intelligent automation and real-time',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart HR Recruitment Express (Marketing)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Smart HR Recruitment Express (Marketing) is an AI-powered marketing solution that transforms how businesses operate through intelligent automation and real-time analytics.
