...
export const metadata: Metadata = {
  title: 'Healthcare AI - Automotive',
  description: 'Revolutionize automotive through intelligent automation. Our Healthcare AI - Automotive leverages advanced machine learning to deliver energy management at scal',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/healthcare-ai-automotive-0a2a0bcb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Healthcare AI - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize automotive through intelligent automation. Our Healthcare AI - Automotive leverages advanced machine learning to deliver energy management at scale.
          </p>
