...
export const metadata: Metadata = {
  title: 'Management Intelligent - Hospitality',
  description: 'Next-generation hospitality solution: Management Intelligent - Hospitality. Combines release management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/management-intelligent-hospitality-3721a0d0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Management Intelligent - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Management Intelligent - Hospitality. Combines release management with adaptive intelligence for optimal results.
          </p>
