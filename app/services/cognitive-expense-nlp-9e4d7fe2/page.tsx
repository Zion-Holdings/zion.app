...
export const metadata: Metadata = {
  title: 'Cognitive Expense NLP',
  description: 'Revolutionize energy through intelligent automation. Our Cognitive Expense NLP leverages advanced machine learning to deliver enterprise-grade insights at scale',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-expense-nlp-9e4d7fe2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Expense NLP
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Cognitive Expense NLP leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
