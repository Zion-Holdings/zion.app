...
export const metadata: Metadata = {
  title: 'Intelligent automation-gaming',
  description: 'Revolutionize gaming through intelligent automation. Our Intelligent automation-gaming leverages advanced machine learning to deliver performance monitoring at ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-automation-gaming-6950a5d6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent automation-gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize gaming through intelligent automation. Our Intelligent automation-gaming leverages advanced machine learning to deliver performance monitoring at scale.
          </p>
