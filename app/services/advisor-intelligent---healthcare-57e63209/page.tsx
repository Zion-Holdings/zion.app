...
export const metadata: Metadata = {
  title: 'Advisor Intelligent - Healthcare',
  description: 'Transform your healthcare operations with our Advisor Intelligent - Healthcare. This AI-driven solution automates energy management with unprecedented accuracy ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Advisor Intelligent - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Advisor Intelligent - Healthcare. This AI-driven solution automates energy management with unprecedented accuracy and efficiency.
          </p>
