...
export const metadata: Metadata = {
  ...
  keywords: 'Self-service booking agent for commercial property showings, Automated CRM opportunity creation and lead scoring per inquiry source, Multi-channel tour reminders: SMS, email, WhatsApp, push notification, Post-tour nurturing sequence: re-engagement at 48 h, 1w, 2w, 4w with incremental incentives, Leasing-commission attribution: tie closed deals back to originating touchpoints, automation, E-Commerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Commercial Leasing &amp; Property Tour Scheduler</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end commercial-property tour scheduling and lead qualification: booking agent handoff, CRM opportunity creation, automated reminders, post-tour follow-up nurturing, and leasing-commission attribution dashboard.</p>
        ...
        <li class="text-slate-300">Self-service booking agent for commercial property showings</li>
        <li class="text-slate-300">Automated CRM opportunity creation and lead scoring per inquiry source</li>
        <li class="text-slate-300">Multi-channel tour reminders: SMS, email, WhatsApp, push notification</li>
        <li class="text-slate-300">Post-tour nurturing sequence: re-engagement at 48 h, 1w, 2w, 4w with incremental incentives</li>
        <li class="text-slate-300">Leasing-commission attribution: tie closed deals back to originating touchpoints</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with commercial leasing &amp; property tour scheduler</li>
