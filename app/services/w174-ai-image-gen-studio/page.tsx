...
export const metadata: Metadata = {
  ...
  keywords: 'Fine-tuned models for brand consistency, Style presets and reference image control, Batch generation with variation management, Upscaling and outpainting, Background removal and replacement, API with prompt templates and parameter presets, Integration with Figma, Canva, Adobe, ai, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Image Generation Studio</h1>
        <p className="text-lg text-slate-300 mb-8">Production image generation with fine-tuned models, brand consistency, style presets, and batch processing. Generate marketing assets, product images, and social content at scale.</p>
        ...
        <li class="text-slate-300">Fine-tuned models for brand consistency</li>
        <li class="text-slate-300">Style presets and reference image control</li>
        <li class="text-slate-300">Batch generation with variation management</li>
        <li class="text-slate-300">Upscaling and outpainting</li>
        <li class="text-slate-300">Background removal and replacement</li>
        <li class="text-slate-300">API with prompt templates and parameter presets</li>
        <li class="text-slate-300">Integration with Figma, Canva, Adobe</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">On-brand imagery every time with fine-tuning</li>
        <li class="text-slate-300">Generate 1000s of marketing images in minutes</li>
        <li class="text-slate-300">No more stock photo licensing costs</li>
        <li class="text-slate-300">Consistent brand style across all outputs</li>
      </ul>
        </div>
