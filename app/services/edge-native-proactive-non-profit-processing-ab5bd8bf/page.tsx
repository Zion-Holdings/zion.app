...
export const metadata = {
  title: "Edge-Native Proactive Non-Profit Processing - Zion Tech Group",
  description: "Edge-native processing layer that delivers proactive non-profit insights with sub-millisecond latency.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/edge-native-proactive-non-profit-processing-ab5bd8bf`
  }
};
