...
export const metadata: Metadata = {
  title: 'Automation Quantum - PROPTECH',
  description: 'Drive innovation in proptech with Automation Quantum - PROPTECH. This AI-powered platform transforms influencer identification into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automation-quantum-proptech-6d462918',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automation Quantum - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in proptech with Automation Quantum - PROPTECH. This AI-powered platform transforms influencer identification into a competitive advantage.
          </p>
