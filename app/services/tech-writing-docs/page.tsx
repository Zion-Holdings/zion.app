...
export const metadata: Metadata = {
  ...
  keywords: 'OpenAPI auto-generated per route with examples, SDK docs with runnable JS/Python/Go code, Architecture decision records from PR discussion, Changelog auto-generated from git tags + commits, Interactive API explorer (Swagger UI) embedded, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Technical Writing &amp; Developer Documentation</h1>
        <p className="text-lg text-slate-300 mb-8">Developer-first docs: OpenAPI reference, SDK guides with runnable code snippets, architecture decision records, changelog from git, embedded Swagger UI.</p>
        ...
        <li class="text-slate-300">OpenAPI auto-generated per route with examples</li>
        <li class="text-slate-300">SDK docs with runnable JS/Python/Go code</li>
        <li class="text-slate-300">Architecture decision records from PR discussion</li>
        <li class="text-slate-300">Changelog auto-generated from git tags + commits</li>
        <li class="text-slate-300">Interactive API explorer (Swagger UI) embedded</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with technical writing &amp; developer documentation</li>
