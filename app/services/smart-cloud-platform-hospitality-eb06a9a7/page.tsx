...
export const metadata: Metadata = {
  title: 'Smart Cloud Platform - Hospitality',
  description: 'Enhance your hospitality business with Smart Cloud Platform - Hospitality. Our solution provides api management with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-cloud-platform-hospitality-eb06a9a7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Cloud Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Smart Cloud Platform - Hospitality. Our solution provides api management with enterprise-grade reliability and security.
          </p>
