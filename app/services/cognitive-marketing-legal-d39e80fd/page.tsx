...
export const metadata: Metadata = {
  title: 'Cognitive marketing-legal',
  description: 'Revolutionize legal through intelligent automation. Our Cognitive marketing-legal leverages advanced machine learning to deliver revenue forecasting at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-marketing-legal-d39e80fd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive marketing-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Cognitive marketing-legal leverages advanced machine learning to deliver revenue forecasting at scale.
          </p>
