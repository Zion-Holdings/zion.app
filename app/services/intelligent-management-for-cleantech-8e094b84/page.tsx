...
export const metadata: Metadata = {
  title: 'Intelligent Management for CLEANTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Management for CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of cleantech is here with Intelligent Management for CLEANTECH. Powered by cutting-edge AI, this platform delivers predictive modeling like never before.
          </p>
