...
export const metadata: Metadata = {
  title: 'Smart Process Platform - REGTECH',
  description: 'Transform your regtech operations with our Smart Process Platform - REGTECH. This AI-driven solution automates sales forecasting with unprecedented accuracy and',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Process Platform - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your regtech operations with our Smart Process Platform - REGTECH. This AI-driven solution automates sales forecasting with unprecedented accuracy and efficiency.
          </p>
