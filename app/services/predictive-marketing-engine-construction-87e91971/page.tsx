...
export const metadata: Metadata = {
  title: 'Predictive Marketing Engine - Construction',
  description: 'Transform your construction operations with our Predictive Marketing Engine - Construction. This AI-driven solution automates risk assessment with unprecedented',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-marketing-engine-construction-87e91971',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Marketing Engine - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Predictive Marketing Engine - Construction. This AI-driven solution automates risk assessment with unprecedented accuracy and efficiency.
          </p>
