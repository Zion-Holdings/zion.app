...
export const metadata: Metadata = {
  ...
  keywords: 'Route optimization, Real-time traffic, Driver hours tracking, Vehicle capacity, Customer preferences, Proof of delivery, Fleet tracking, Analytics, ai, Logistics, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Logistics Route Optimizer</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered route optimization for delivery fleets. Real-time traffic, driver hours, vehicle capacity, and customer preferences for optimal routing.</p>
        ...
        <li class="text-slate-300">Real-time traffic</li>
        <li class="text-slate-300">Driver hours tracking</li>
        <li class="text-slate-300">Vehicle capacity</li>
        <li class="text-slate-300">Customer preferences</li>
        <li class="text-slate-300">Proof of delivery</li>
        <li class="text-slate-300">Fleet tracking</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">25% fuel savings</li>
        <li class="text-slate-300">40% more deliveries</li>
        <li class="text-slate-300">Customer satisfaction</li>
        <li class="text-slate-300">Driver efficiency</li>
      </ul>
        </div>
