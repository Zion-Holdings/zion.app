...
export const metadata: Metadata = {
  title: 'Cognitive Customer Solution - Telecom',
  description: 'Next-generation telecom solution: Cognitive Customer Solution - Telecom. Combines leave management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-customer-solution-telecom-cb1bf695',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Customer Solution - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation telecom solution: Cognitive Customer Solution - Telecom. Combines leave management with adaptive intelligence for optimal results.
          </p>
