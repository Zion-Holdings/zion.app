...
export const metadata: Metadata = {
  title: 'AI/IT Monitoring for Media',
  description: 'Optimize your media workflows with AI/IT Monitoring for Media. This intelligent platform delivers threat detection through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-monitoring-for-media-068d8394',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Monitoring for Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your media workflows with AI/IT Monitoring for Media. This intelligent platform delivers threat detection through advanced automation and AI.
          </p>
