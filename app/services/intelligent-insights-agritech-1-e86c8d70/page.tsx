...
export const metadata: Metadata = {
  title: 'Intelligent insights-agritech #1',
  description: 'The future of agritech is here with Intelligent insights-agritech #1. Powered by cutting-edge AI, this platform delivers threat detection like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-insights-agritech-1-e86c8d70',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent insights-agritech #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agritech is here with Intelligent insights-agritech #1. Powered by cutting-edge AI, this platform delivers threat detection like never before.
          </p>
