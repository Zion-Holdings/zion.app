...
export const metadata: Metadata = {
  title: 'Cognitive Network Automation',
  description: 'The future of logistics is here with Cognitive Network Automation. Powered by cutting-edge AI, this platform delivers fraud prevention like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-network-automation-964cfe77',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Cognitive Network Automation. Powered by cutting-edge AI, this platform delivers fraud prevention like never before.
          </p>
