...
export const metadata: Metadata = {
  title: 'Low-code AI-Powered Data Quality Rules',
  description: 'AI-powered low-code solution for data quality. Machine learning-based data quality rules that adapt over time.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/low-code-ai-powered-data-quality-rules-ccf59761',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Low-code AI-Powered Data Quality Rules
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered low-code solution for data quality. Machine learning-based data quality rules that adapt over time.
          </p>
