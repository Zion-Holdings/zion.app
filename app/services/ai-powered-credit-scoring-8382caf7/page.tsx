...
export const metadata: Metadata = {
  ...
  description: 'Real-time credit scoring using alternative data and machine learning.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-credit-scoring-8382caf7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Real-time credit scoring using alternative data and machine learning.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Credit scoring</li>
          <li className="text-gray-300">Alternative data</li>
