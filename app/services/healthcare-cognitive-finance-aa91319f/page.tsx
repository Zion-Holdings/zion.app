...
export const metadata: Metadata = {
  title: 'Healthcare Cognitive - Finance',
  description: 'Revolutionize finance through intelligent automation. Our Healthcare Cognitive - Finance leverages advanced machine learning to deliver audit trail management a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/healthcare-cognitive-finance-aa91319f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Healthcare Cognitive - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our Healthcare Cognitive - Finance leverages advanced machine learning to deliver audit trail management at scale.
          </p>
