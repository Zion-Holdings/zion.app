...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "ETL Pipeline Optimization | Zion Tech Group", description: "End-to-end etl pipeline optimization services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/etl-pipeline-optimization-2026-7167/}} />
