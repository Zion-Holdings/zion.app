...
export const metadata: Metadata = {
  ...
  keywords: 'Molecular simulation, Target identification, Toxicity prediction, Clinical optimization, Literature mining, Compound screening, Regulatory, Analytics, ai, Pharmaceutical, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Pharma Drug Discovery AI</h1>
        <p className="text-lg text-slate-300 mb-8">Accelerate drug discovery with molecular simulation and toxicity prediction.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">ai</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">Pharmaceutical</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Molecular simulation</li>
        <li class="text-slate-300">Target identification</li>
        <li class="text-slate-300">Toxicity prediction</li>
        <li class="text-slate-300">Clinical optimization</li>
        <li class="text-slate-300">Literature mining</li>
        <li class="text-slate-300">Compound screening</li>
        <li class="text-slate-300">Regulatory</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">50% faster discovery</li>
        <li class="text-slate-300">Cost reduction</li>
        <li class="text-slate-300">Higher success rates</li>
        <li class="text-slate-300">Regulatory ready</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$25,000</p>
