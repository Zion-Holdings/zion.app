...
export const metadata: Metadata = {
  title: "AI-Powered API Management - AI-Powered API Management Solution",
  description: "Intelligent API gateway with rate limiting, authentication, and analytics.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-api-management-b9621616",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered API Management - AI-Powered API Management Solution
        </h1>
