...
export const metadata: Metadata = {
  ...
  keywords: 'AI-optimized scheduling and dispatch, Mobile app for technicians (iOS, Android), Work order management and tracking, Parts and inventory management, Customer portal and self-service, Integration with CRM and billing, GPS tracking and route optimization, Analytics on technician performance, it, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Field Service Management &amp; Mobile Workforce</h1>
        <p className="text-lg text-slate-300 mb-8">Field service management platform for mobile workforce. Scheduling, dispatch, work orders, and mobile app for technicians. Increase first-time fix rates by 35%.</p>
        ...
        <li class="text-slate-300">AI-optimized scheduling and dispatch</li>
        <li class="text-slate-300">Mobile app for technicians (iOS, Android)</li>
        <li class="text-slate-300">Work order management and tracking</li>
        <li class="text-slate-300">Parts and inventory management</li>
        <li class="text-slate-300">Customer portal and self-service</li>
        <li class="text-slate-300">Integration with CRM and billing</li>
        <li class="text-slate-300">GPS tracking and route optimization</li>
        <li class="text-slate-300">Analytics on technician performance</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Increase first-time fix rate by 35%</li>
        <li class="text-slate-300">Reduce travel time with AI routing</li>
        <li class="text-slate-300">Improve customer satisfaction with real-time updates</li>
        <li class="text-slate-300">Scale field operations without adding dispatchers</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$50/tech/mo</p>
              <p class="text-sm text-slate-400">Getting started plan</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              <h3 class="font-semibold text-white mb-2">Pro</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">$85/tech/mo</p>
