...
export const metadata: Metadata = {
  title: 'Smart finance-blockchain',
  description: 'Transform your blockchain operations with our Smart finance-blockchain. This AI-driven solution automates customer service automation with unprecedented accurac',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart finance-blockchain
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your blockchain operations with our Smart finance-blockchain. This AI-driven solution automates customer service automation with unprecedented accuracy and efficiency.
          </p>
