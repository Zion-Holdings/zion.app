...
export const metadata: Metadata = {
  ...
  description: 'The future of proptech is here with AI Data - PROPTECH Edition. Powered by cutting-edge AI, this platform delivers recruitment automation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-data-proptech-edition-6cbbf166',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with AI Data - PROPTECH Edition. Powered by cutting-edge AI, this platform delivers recruitment automation like never before.
          </p>
