...
export const metadata: Metadata = {
  title: 'Enterprise NLP Platform - Insurance',
  description: 'Quantum leap forward for insurance: Enterprise NLP Platform - Insurance. Uses quantum-inspired algorithms to deliver language processing at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-nlp-platform-insurance-eba80067',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise NLP Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for insurance: Enterprise NLP Platform - Insurance. Uses quantum-inspired algorithms to deliver language processing at exponential speed.
          </p>
