...
export const metadata: Metadata = {
  title: 'Enterprise Data Platform - Manufacturing',
  description: 'Enhance your manufacturing business with Enterprise Data Platform - Manufacturing. Our solution provides user experience with enterprise-grade reliability and s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-data-platform-manufacturing-4d92cd4d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Data Platform - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your manufacturing business with Enterprise Data Platform - Manufacturing. Our solution provides user experience with enterprise-grade reliability and security.
          </p>
