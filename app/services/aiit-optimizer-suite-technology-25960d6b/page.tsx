...
export const metadata: Metadata = {
  title: 'AI/IT Optimizer Suite - TECHNOLOGY',
  description: 'Transform your technology operations with our AI/IT Optimizer Suite - TECHNOLOGY. This AI-driven solution automates record extraction with unprecedented accurac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-optimizer-suite-technology-25960d6b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Optimizer Suite - TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your technology operations with our AI/IT Optimizer Suite - TECHNOLOGY. This AI-driven solution automates record extraction with unprecedented accuracy and efficiency.
          </p>
