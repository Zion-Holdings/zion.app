...
export const metadata: Metadata = {
  title: 'Cognitive Monitoring Solution - Energy',
  description: 'Enhance your energy business with Cognitive Monitoring Solution - Energy. Our solution provides project portfolio with enterprise-grade reliability and security',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-monitoring-solution-energy-adebd09b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Monitoring Solution - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your energy business with Cognitive Monitoring Solution - Energy. Our solution provides project portfolio with enterprise-grade reliability and security.
          </p>
