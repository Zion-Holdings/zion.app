...
export const metadata: Metadata = {
  title: 'Intelligence Neural - Automotive',
  description: 'Revolutionize automotive through intelligent automation. Our Intelligence Neural - Automotive leverages advanced machine learning to deliver healthcare data ana',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligence Neural - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize automotive through intelligent automation. Our Intelligence Neural - Automotive leverages advanced machine learning to deliver healthcare data analytics at scale.
          </p>
