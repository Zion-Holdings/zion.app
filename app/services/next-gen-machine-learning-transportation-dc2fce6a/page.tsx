...
export const metadata: Metadata = {
  title: 'Next-Gen machine learning-transportation',
  description: 'Revolutionize transportation through intelligent automation. Our Next-Gen machine learning-transportation leverages advanced machine learning to deliver roi tra',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen machine learning-transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize transportation through intelligent automation. Our Next-Gen machine learning-transportation leverages advanced machine learning to deliver roi tracking at scale.
          </p>
