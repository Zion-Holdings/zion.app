...
export const metadata: Metadata = {
  title: 'Optimizer Autonomous - Hospitality',
  description: 'Transform your hospitality operations with our Optimizer Autonomous - Hospitality. This AI-driven solution automates fraud prevention with unprecedented accurac',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Optimizer Autonomous - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Optimizer Autonomous - Hospitality. This AI-driven solution automates fraud prevention with unprecedented accuracy and efficiency.
          </p>
