...
export const metadata: Metadata = {
  title: 'Smart Engine Platform - Hospitality',
  description: 'Drive innovation in hospitality with Smart Engine Platform - Hospitality. This AI-powered platform transforms maintenance scheduling into a competitive advantag',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-engine-platform-hospitality-374a65fb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Engine Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Smart Engine Platform - Hospitality. This AI-powered platform transforms maintenance scheduling into a competitive advantage.
          </p>
