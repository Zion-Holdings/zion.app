...
export const metadata: Metadata = {
  ...
  description: 'Automated email campaigns with dynamic content and A/B testing.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-email-marketing-automation-5973bbf4',
  },

export const metadata = {
  title: "AI-Powered Email Marketing Automation - Zion Tech Group",
  description: "Automated email campaigns with dynamic content and A/B testing.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-email-marketing-automation-5973bbf4`
  }
  ...
  return (
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automated email campaigns with dynamic content and A/B testing.
          </p>
    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">AI-Powered Email Marketing Automation</h1>
        <p className="text-lg text-gray-300 mb-8">Automated email campaigns with dynamic content and A/B testing.</p>
