...
export const metadata: Metadata = {
  ...
  keywords: 'VoIP phone system deployment, SIP trunking for cost savings, Auto-attendant and call routing, Voicemail-to-email and transcription, Call recording and analytics, Integration with CRM and helpdesk, Mobile and desktop softphones, 911 and compliance configuration, it, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT VoIP &amp; Business Telephony Solutions</h1>
        <p className="text-lg text-slate-300 mb-8">Modern business telephony with VoIP, SIP trunking, and unified communications. Crystal-clear voice, video, and messaging for distributed teams.</p>
        ...
        <li class="text-slate-300">VoIP phone system deployment</li>
        <li class="text-slate-300">SIP trunking for cost savings</li>
        <li class="text-slate-300">Auto-attendant and call routing</li>
        <li class="text-slate-300">Voicemail-to-email and transcription</li>
        <li class="text-slate-300">Call recording and analytics</li>
        <li class="text-slate-300">Integration with CRM and helpdesk</li>
        <li class="text-slate-300">Mobile and desktop softphones</li>
        <li class="text-slate-300">911 and compliance configuration</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce phone costs by 60% with VoIP</li>
        <li class="text-slate-300">Enable work-from-anywhere with softphones</li>
        <li class="text-slate-300">Improve customer experience with smart routing</li>
        <li class="text-slate-300">Scale phone system without adding hardware</li>
      </ul>
        </div>
