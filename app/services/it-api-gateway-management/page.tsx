...
export const metadata: Metadata = {
  ...
  keywords: 'Centralised rate limiting, throttling, protocol transforms, OAuth2, mTLS, API-key auth with role-based scopes, Developer self-service portal + SDK generation, Built-in developer portal: docs, try-it console, usage analytics, Dead-letter queue + retry logic with configurable backoff, it, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Enterprise API gateway: rate limiting, API key management, OAuth2 + mTLS, usage analytics, developer portal, request/response transforms, and dead-letter queue handling across cloud and on-prem APIs.</p>
        ...
        <li class="text-slate-300">Centralised rate limiting, throttling, protocol transforms</li>
        <li class="text-slate-300">OAuth2, mTLS, API-key auth with role-based scopes</li>
        <li class="text-slate-300">Developer self-service portal + SDK generation</li>
        <li class="text-slate-300">Built-in developer portal: docs, try-it console, usage analytics</li>
        <li class="text-slate-300">Dead-letter queue + retry logic with configurable backoff</li>
      </ul>
        </div>
