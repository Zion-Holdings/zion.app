...
export const metadata: Metadata = {
  title: 'Autonomous Process System - EDTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Process System - EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize edtech through intelligent automation. Our Autonomous Process System - EDTECH leverages advanced machine learning to deliver process mining at scale.
          </p>
