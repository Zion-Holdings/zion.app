...
export const metadata: Metadata = {
  title: 'Intelligent Fraud Insights',
  description: 'Transform your quantum operations with our Intelligent Fraud Insights. This AI-driven solution automates process automation with unprecedented accuracy and effi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Fraud Insights
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your quantum operations with our Intelligent Fraud Insights. This AI-driven solution automates process automation with unprecedented accuracy and efficiency.
          </p>
