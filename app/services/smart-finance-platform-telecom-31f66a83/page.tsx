...
export const metadata: Metadata = {
  title: 'Smart Finance Platform - Telecom',
  description: 'Drive innovation in telecom with Smart Finance Platform - Telecom. This AI-powered platform transforms scenario planning into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-finance-platform-telecom-31f66a83',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Finance Platform - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in telecom with Smart Finance Platform - Telecom. This AI-powered platform transforms scenario planning into a competitive advantage.
          </p>
