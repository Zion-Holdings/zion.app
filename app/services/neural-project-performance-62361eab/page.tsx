...
export const metadata: Metadata = {
  title: 'Neural Project Performance',
  description: 'Revolutionize finance through intelligent automation. Our Neural Project Performance leverages advanced machine learning to deliver maintenance scheduling at sc',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Project Performance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our Neural Project Performance leverages advanced machine learning to deliver maintenance scheduling at scale.
          </p>
