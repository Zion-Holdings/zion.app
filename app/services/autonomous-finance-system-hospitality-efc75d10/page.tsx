...
export const metadata: Metadata = {
  title: 'Autonomous Finance System - Hospitality',
  description: 'Drive innovation in hospitality with Autonomous Finance System - Hospitality. This AI-powered platform transforms business continuity into a competitive advanta',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-finance-system-hospitality-efc75d10',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Finance System - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Autonomous Finance System - Hospitality. This AI-powered platform transforms business continuity into a competitive advantage.
          </p>
