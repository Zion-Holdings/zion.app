...
export const metadata: Metadata = {
  ...
  keywords: 'Natural language understanding, Multi-channel deployment, Dialogue management, Voice assistant support, Analytics dashboard, Human handoff, Multi-language support, Custom training, ai-services, ai-and-ml, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Build and deploy AI chatbots and voice assistants. Multi-channel support (web, mobile, WhatsApp, Slack) with NLU, dialogue management, and analytics.</p>
        ...
        <li class="text-slate-300">Multi-channel deployment</li>
        <li class="text-slate-300">Dialogue management</li>
        <li class="text-slate-300">Voice assistant support</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Deploy in days, not months</li>
        <li class="text-slate-300">80% query resolution</li>
        <li class="text-slate-300">24/7 availability</li>
        <li class="text-slate-300">Multi-language support</li>
        <li class="text-slate-300">Seamless human handoff</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">3497</p>
