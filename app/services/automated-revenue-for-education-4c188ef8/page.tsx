...
export const metadata: Metadata = {
  title: 'Automated Revenue for Education',
  description: 'Transform your education operations with our Automated Revenue for Education. This AI-driven solution automates audit trail management with unprecedented accura',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Revenue for Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your education operations with our Automated Revenue for Education. This AI-driven solution automates audit trail management with unprecedented accuracy and efficiency.
          </p>
