...
export const metadata: Metadata = {
  title: 'Smart Suite for Healthcare',
  description: 'Transform your healthcare operations with our Smart Suite for Healthcare. This AI-driven solution automates process automation with unprecedented accuracy and e',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-suite-for-healthcare-bb334f41',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Suite for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Smart Suite for Healthcare. This AI-driven solution automates process automation with unprecedented accuracy and efficiency.
          </p>
