...
export const metadata: Metadata = {
  title: 'AI-Powered Marketing for Construction',
  description: 'Transform your construction operations with our AI-Powered Marketing for Construction. This AI-driven solution automates logistics route optimization with unpre',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-marketing-for-construction-4359c9a7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Marketing for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our AI-Powered Marketing for Construction. This AI-driven solution automates logistics route optimization with unprecedented accuracy and efficiency.
          </p>
