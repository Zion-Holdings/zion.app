...
export const metadata: Metadata = {
  title: 'Intelligent Workflow for Media',
  description: 'The future of media is here with Intelligent Workflow for Media. Powered by cutting-edge AI, this platform delivers background checks like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-workflow-for-media-802ced69',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Workflow for Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of media is here with Intelligent Workflow for Media. Powered by cutting-edge AI, this platform delivers background checks like never before.
          </p>
