...
export const metadata: Metadata = {
  title: 'AI Computer Vision - Hospitality Edition',
  description: 'Transform your hospitality operations with our AI Computer Vision - Hospitality Edition. This AI-driven solution provides intelligent automation with unpreceden',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-computer-vision-hospitality-edition-357fe74d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Computer Vision - Hospitality Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our AI Computer Vision - Hospitality Edition. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
