...
export const metadata: Metadata = {
  ...
  description: 'Optimizes inventory levels across all locations to minimize costs while maximizing availability.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-inventory-optimization-8c282d3c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimizes inventory levels across all locations to minimize costs while maximizing availability.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Replenishment</li>
          <li className="text-gray-300">Dead stock reduction</li>
          </ul>
        </section>
