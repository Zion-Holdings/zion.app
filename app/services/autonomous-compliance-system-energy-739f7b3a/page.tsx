...
export const metadata: Metadata = {
  title: 'Autonomous Compliance System - Energy',
  description: 'Drive innovation in energy with Autonomous Compliance System - Energy. This AI-powered platform transforms data processing into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-compliance-system-energy-739f7b3a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Compliance System - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Autonomous Compliance System - Energy. This AI-powered platform transforms data processing into a competitive advantage.
          </p>
