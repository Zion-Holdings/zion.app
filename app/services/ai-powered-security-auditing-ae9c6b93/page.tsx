...
export const metadata: Metadata = {
  ...
  description: 'Continuous security auditing with automated compliance reporting.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-security-auditing-ae9c6b93',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Continuous security auditing with automated compliance reporting.
          </p>
