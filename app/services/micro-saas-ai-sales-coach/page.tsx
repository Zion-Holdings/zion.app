...
export const metadata: Metadata = {
  ...
  keywords: 'AI call analysis with talk-to-listen ratio scoring, Deal health scoring with win probability, Next-best-action recommendations per opportunity, Automated follow-up email sequences, Sales playbook enforcement and coaching, Integration with Salesforce, HubSpot, Pipedrive, Revenue forecasting with pipeline analytics, Rep performance benchmarking and leaderboards, ai, sales, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Sales Coach &amp; Pipeline Optimizer</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered sales coaching that analyzes calls, emails, and pipeline data to recommend winning strategies. Real-time deal scoring, next-best-action suggestions, and automated follow-ups.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">ai</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">Sales Enablement</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">AI call analysis with talk-to-listen ratio scoring</li>
        <li class="text-slate-300">Deal health scoring with win probability</li>
        <li class="text-slate-300">Next-best-action recommendations per opportunity</li>
        <li class="text-slate-300">Automated follow-up email sequences</li>
        <li class="text-slate-300">Sales playbook enforcement and coaching</li>
        <li class="text-slate-300">Integration with Salesforce, HubSpot, Pipedrive</li>
        <li class="text-slate-300">Revenue forecasting with pipeline analytics</li>
        <li class="text-slate-300">Rep performance benchmarking and leaderboards</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Increase win rates by 25-35%</li>
        <li class="text-slate-300">Shorten sales cycles by 20%</li>
        <li class="text-slate-300">Coach reps with AI instead of manual review</li>
        <li class="text-slate-300">Forecast revenue with 90%+ accuracy</li>
      </ul>
        </div>
