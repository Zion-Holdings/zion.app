...
export const metadata: Metadata = {
  title: 'Intelligent contract-energy',
  description: 'Next-generation energy solution: Intelligent contract-energy. Combines sourcing optimization with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-contract-energy-71cda87f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent contract-energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Intelligent contract-energy. Combines sourcing optimization with adaptive intelligence for optimal results.
          </p>
