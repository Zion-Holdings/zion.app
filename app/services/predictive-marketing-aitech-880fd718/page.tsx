...
export const metadata: Metadata = {
  title: 'Predictive marketing-aitech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive marketing-aitech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of aitech is here with Predictive marketing-aitech. Powered by cutting-edge AI, this platform delivers edge computing like never before.
          </p>
