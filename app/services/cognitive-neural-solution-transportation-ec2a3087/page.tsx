...
export const metadata: Metadata = {
  title: 'Cognitive Neural Solution - Transportation',
  description: 'Enhance your transportation business with Cognitive Neural Solution - Transportation. Our solution provides api management with enterprise-grade reliability and',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Neural Solution - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with Cognitive Neural Solution - Transportation. Our solution provides api management with enterprise-grade reliability and security.
          </p>
