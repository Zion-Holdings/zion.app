...
export const metadata: Metadata = {
  title: 'Next-Gen Manufacturing - Retail',
  description: 'Drive innovation in retail with Next-Gen Manufacturing - Retail. This AI-powered platform transforms document processing into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-manufacturing-retail-fd929f1b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Manufacturing - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in retail with Next-Gen Manufacturing - Retail. This AI-powered platform transforms document processing into a competitive advantage.
          </p>
