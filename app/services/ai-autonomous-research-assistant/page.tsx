...
export const metadata: Metadata = {
  ...
  keywords: 'Autonomous multi-source research, Academic paper analysis (PubMed, arXiv), Patent landscape mapping, Competitive intelligence reports, Auto-citation and bibliography, Natural language query to structured report, Scheduled monitoring and alerts, Export to Word, PDF, LaTeX, ai, Research, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Autonomous Research Assistant</h1>
        <p className="text-lg text-slate-300 mb-8">AI agent that autonomously conducts deep research across academic papers, patents, news, and databases. Produces cited reports, literature reviews, and competitive intelligence briefs. Supports 50+ data sources including PubMed, arXiv, Google Patents, and SEC filings.</p>
        ...
        <li class="text-slate-300">Autonomous multi-source research</li>
        <li class="text-slate-300">Academic paper analysis (PubMed, arXiv)</li>
        <li class="text-slate-300">Patent landscape mapping</li>
        <li class="text-slate-300">Competitive intelligence reports</li>
        <li class="text-slate-300">Auto-citation and bibliography</li>
        <li class="text-slate-300">Natural language query to structured report</li>
        <li class="text-slate-300">Scheduled monitoring and alerts</li>
        <li class="text-slate-300">Export to Word, PDF, LaTeX</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">10x faster literature reviews</li>
        <li class="text-slate-300">Never miss relevant patents or papers</li>
        <li class="text-slate-300">Data-driven competitive insights</li>
        <li class="text-slate-300">Reduce research costs by 70%</li>
      </ul>
        </div>
