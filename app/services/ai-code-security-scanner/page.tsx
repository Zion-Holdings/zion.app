...
export const metadata: Metadata = {
  title: "AI Code Security & Vulnerability Scanner | Zion Tech Group",
  ...
  openGraph: {
    title: "AI Code Security & Vulnerability Scanner | Zion Tech Group",
    description: "Deep code analysis using AI to find security vulnerabilities, logic flaws, and compliance issues. Integrates with GitHub, GitLab, and CI/CD pipelines. Prioritizes findings by exploitability and business impact.",
    url: "https://ziontechgroup.com/services/ai-code-security-scanner/",
    type: 'website',
  },
  alternates: { canonical: "/services/ai-code-security-scanner/" },
};

export default function AiCodeSecurityScannerPage() {
  return (
    <StandardPage
      title="AI Code Security & Vulnerability Scanner"
      subtitle="Deep code analysis using AI to find security vulnerabilities, logic flaws, and compliance issues. Integrates with GitHub, GitLab, and CI/CD pipelines. Prioritizes findings by exploitability and business impact."
      breadcrumbItems={[
        { label: "Home", href: "/" },
        { label: "Services", href: "/services/" },
        { label: "AI Code Security & Vulnerability Scanner" }
      ]}
      actions={[
    ...
    >
        ...
        <div className="rounded-2xl border border-white/10 bg-slate-900/40 p-5"><h2 className="text-white font-semibold mb-2">AI Code Security &amp; Vulnerability Scanner</h2><p className="text-slate-400 text-sm">Archived section recovered from the live site snapshot.</p></div>
      ...
      <p className="text-slate-400 leading-relaxed mb-4 max-w-5xl mx-auto">Estimated timeline for AI Code Security &amp; Vulnerability Scanner — adapt to your team size and complexity.</p>
      ...
      <p className="text-slate-500 text-sm max-w-5xl mx-auto">Restored from a Wayback Machine snapshot (20260607112403) of ziontechgroup.com.</p>
    </StandardPage>
  );
}
