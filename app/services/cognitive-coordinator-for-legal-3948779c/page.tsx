...
export const metadata: Metadata = {
  title: 'Cognitive Coordinator for Legal',
  description: 'Next-generation legal solution: Cognitive Coordinator for Legal. Combines user experience with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-coordinator-for-legal-3948779c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Coordinator for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Cognitive Coordinator for Legal. Combines user experience with adaptive intelligence for optimal results.
          </p>
