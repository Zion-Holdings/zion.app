...
export const metadata: Metadata = {
  title: 'Manufacturing Intelligent - Logistics',
  description: 'The future of logistics is here with Manufacturing Intelligent - Logistics. Powered by cutting-edge AI, this platform delivers inventory management like never b',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/manufacturing-intelligent---logistics-32aa3ccf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manufacturing Intelligent - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Manufacturing Intelligent - Logistics. Powered by cutting-edge AI, this platform delivers inventory management like never before.
          </p>
