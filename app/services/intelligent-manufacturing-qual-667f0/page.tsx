...
export const metadata: Metadata = {
  title: 'Intelligent Manufacturing Quality Ansible (Iot)',
  description: 'Intelligent Manufacturing Quality Ansible (Iot) is an AI-powered iot solution that transforms how businesses operate through intelligent automation and real-tim',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-manufacturing-qual-667f0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Manufacturing Quality Ansible (Iot)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Intelligent Manufacturing Quality Ansible (Iot) is an AI-powered iot solution that transforms how businesses operate through intelligent automation and real-time analytics.
...
AWS, Ansible, GCP, PostgreSQL, Kafka, Node.js
