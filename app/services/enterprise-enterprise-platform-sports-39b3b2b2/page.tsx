...
export const metadata: Metadata = {
  title: 'Enterprise Enterprise Platform - Sports',
  description: 'Revolutionize sports through intelligent automation. Our Enterprise Enterprise Platform - Sports leverages advanced machine learning to deliver decision support',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Enterprise Platform - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Enterprise Enterprise Platform - Sports leverages advanced machine learning to deliver decision support at scale.
          </p>
