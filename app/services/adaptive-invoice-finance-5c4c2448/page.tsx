...
export const metadata: Metadata = {
  title: 'Adaptive Invoice Finance',
  description: 'Optimize your media workflows with Adaptive Invoice Finance. This intelligent platform delivers performance monitoring through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-invoice-finance-5c4c2448',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Invoice Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your media workflows with Adaptive Invoice Finance. This intelligent platform delivers performance monitoring through advanced automation and AI.
          </p>
