...
export const metadata: Metadata = {
  title: 'Intelligent Healthcare for Media',
  description: 'The future of media is here with Intelligent Healthcare for Media. Powered by cutting-edge AI, this platform delivers compliance monitoring like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-healthcare-for-media-c40248c1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Healthcare for Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of media is here with Intelligent Healthcare for Media. Powered by cutting-edge AI, this platform delivers compliance monitoring like never before.
          </p>
