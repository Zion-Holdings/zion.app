...
export const metadata: Metadata = {
  title: 'Autonomous Advisor System - Healthcare',
  description: 'Enhance your healthcare business with Autonomous Advisor System - Healthcare. Our solution provides anomaly detection with enterprise-grade reliability and secu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Advisor System - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with Autonomous Advisor System - Healthcare. Our solution provides anomaly detection with enterprise-grade reliability and security.
          </p>
