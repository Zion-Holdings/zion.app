...
export const metadata: Metadata = {
  title: 'Adaptive Cloud for Sports',
  description: 'The future of sports is here with Adaptive Cloud for Sports. Powered by cutting-edge AI, this platform delivers energy management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-cloud-for-sports-46bd7c2a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Cloud for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Adaptive Cloud for Sports. Powered by cutting-edge AI, this platform delivers energy management like never before.
          </p>
