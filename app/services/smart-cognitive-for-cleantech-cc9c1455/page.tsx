...
export const metadata: Metadata = {
  title: 'Smart Cognitive for CLEANTECH',
  description: 'Enhance your cleantech business with Smart Cognitive for CLEANTECH. Our solution provides talent acquisition with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-cognitive-for-cleantech-cc9c1455',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Cognitive for CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your cleantech business with Smart Cognitive for CLEANTECH. Our solution provides talent acquisition with enterprise-grade reliability and security.
          </p>
