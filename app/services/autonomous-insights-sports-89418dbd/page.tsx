...
export const metadata: Metadata = {
  title: 'Autonomous insights-sports',
  description: 'Revolutionize sports through intelligent automation. Our Autonomous insights-sports leverages advanced machine learning to deliver enterprise-grade insights at ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-insights-sports-89418dbd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous insights-sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Autonomous insights-sports leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
