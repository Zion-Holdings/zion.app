...
export const metadata: Metadata = {
  title: 'Suite Neural - Tech',
  description: 'Transform your technology operations with our Suite Neural - Tech. This AI-driven solution automates recruitment automation with unprecedented accuracy and effi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/suite-neural-tech-3c3f7cde',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your technology operations with our Suite Neural - Tech. This AI-driven solution automates recruitment automation with unprecedented accuracy and efficiency.
          </p>
