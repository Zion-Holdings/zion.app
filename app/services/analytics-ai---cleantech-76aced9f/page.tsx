...
export const metadata: Metadata = {
  title: 'Analytics AI - Cleantech',
  description: 'Next-generation cleantech solution: Analytics AI - Cleantech. Combines customer service automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/analytics-ai---cleantech-76aced9f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Analytics AI - Cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation cleantech solution: Analytics AI - Cleantech. Combines customer service automation with adaptive intelligence for optimal results.
          </p>
