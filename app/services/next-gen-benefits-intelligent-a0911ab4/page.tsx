...
export const metadata: Metadata = {
  title: 'Next-Gen Benefits Intelligent',
  description: 'Drive innovation in sports with Next-Gen Benefits Intelligent. This AI-powered platform transforms container orchestration into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-benefits-intelligent-a0911ab4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Benefits Intelligent
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in sports with Next-Gen Benefits Intelligent. This AI-powered platform transforms container orchestration into a competitive advantage.
          </p>
