...
export const metadata: Metadata = {
  title: 'Serverless Data Analytics Azure (Devops)',
  description: 'Serverless Data Analytics Azure (Devops) is an AI-powered devops solution that transforms how businesses operate through intelligent automation and real-time an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/serverless-data-analytics-azur-7a7ba5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Serverless Data Analytics Azure (Devops)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Serverless Data Analytics Azure (Devops) is an AI-powered devops solution that transforms how businesses operate through intelligent automation and real-time analytics.
...
Kubernetes, PostgreSQL, AWS, Microservices, Rust, Blockchain
