...
export const metadata: Metadata = {
  title: 'Next-Gen Monitoring for Agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Next-Gen Monitoring for Agriculture leverages advanced machine learning to deliver integration pla',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-monitoring-for-agriculture-67cd60a4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Monitoring for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Next-Gen Monitoring for Agriculture leverages advanced machine learning to deliver integration platform at scale.
          </p>
