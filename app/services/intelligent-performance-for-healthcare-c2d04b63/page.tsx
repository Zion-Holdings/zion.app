...
export const metadata: Metadata = {
  title: 'Intelligent Performance for Healthcare',
  description: 'Enhance your healthcare business with Intelligent Performance for Healthcare. Our solution provides performance monitoring with enterprise-grade reliability and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-performance-for-healthcare-c2d04b63',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Performance for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with Intelligent Performance for Healthcare. Our solution provides performance monitoring with enterprise-grade reliability and security.
          </p>
