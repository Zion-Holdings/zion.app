...
export const metadata: Metadata = {
  title: 'Automation AI - Edge',
  description: 'The future of edge is here with Automation AI - Edge. Powered by cutting-edge AI, this platform delivers user experience like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automation-ai---edge-ff88718f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of edge is here with Automation AI - Edge. Powered by cutting-edge AI, this platform delivers user experience like never before.
          </p>
