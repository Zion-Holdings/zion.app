...
export const metadata: Metadata = {
  title: 'AI Compliance - Construction Edition #1',
  description: 'Transform your construction operations with our AI Compliance - Construction Edition #1. This AI-driven solution automates loyalty optimization with unprecedent',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-compliance-construction-edition-1-977d97de',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Compliance - Construction Edition #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our AI Compliance - Construction Edition #1. This AI-driven solution automates loyalty optimization with unprecedented accuracy and efficiency.
          </p>
