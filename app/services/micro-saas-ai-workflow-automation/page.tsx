...
export const metadata: Metadata = {
  ...
  keywords: 'AI workflow suggestions from natural language, 500+ app integrations, Conditional logic and branching, Error handling and retry logic, Scheduling and webhook triggers, Analytics on automation performance, Team collaboration and sharing, Version history and rollback, ai, productivity, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI No-Code Workflow Automation Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Build complex automations without code. AI suggests workflows based on your processes, connects 500+ apps, and optimizes flows over time.</p>
        ...
        <li class="text-slate-300">AI workflow suggestions from natural language</li>
        <li class="text-slate-300">500+ app integrations</li>
        <li class="text-slate-300">Conditional logic and branching</li>
        <li class="text-slate-300">Error handling and retry logic</li>
        <li class="text-slate-300">Scheduling and webhook triggers</li>
        <li class="text-slate-300">Analytics on automation performance</li>
        <li class="text-slate-300">Team collaboration and sharing</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Automate 10x faster with AI suggestions</li>
        <li class="text-slate-300">Connect all your tools without code</li>
        <li class="text-slate-300">Optimize workflows based on performance data</li>
        <li class="text-slate-300">Scale automations across the organization</li>
      </ul>
        </div>
