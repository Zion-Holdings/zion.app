...
export const metadata = {
  ...
  description: 'End-to-end kubernetes platform engineering: build an internal developer platform on k8s services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/kubernetes-platform-engineering-build-internal-developer-platform-k8s-22/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">Kubernetes Platform Engineering: Build an Internal Developer Platform on K8s</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end kubernetes platform engineering: build an internal developer platform on k8s services: assessment, deployment, and managed operations.
        </p>
