...
export const metadata: Metadata = {
  title: 'AI-Powered Manufacturing for Hospitality',
  description: 'Next-generation hospitality solution: AI-Powered Manufacturing for Hospitality. Combines market intelligence with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-manufacturing-for-hospitality-2a383a24',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Manufacturing for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: AI-Powered Manufacturing for Hospitality. Combines market intelligence with adaptive intelligence for optimal results.
          </p>
