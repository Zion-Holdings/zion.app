...
export const metadata: Metadata = {
  title: 'Service Assurance AI-Powered Data Privacy',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Service Assurance AI-Powered Data Privacy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered service assurance solution for compliance. GDPR/CCPA compliance automation with automated data redaction.
          </p>
