...
export const metadata: Metadata = {
  title: 'Neural Logistics Analytics',
  description: 'Transform your finance operations with our Neural Logistics Analytics. This AI-driven solution automates risk assessment with unprecedented accuracy and efficie',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-logistics-analytics-895cd7f5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Logistics Analytics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Neural Logistics Analytics. This AI-driven solution automates risk assessment with unprecedented accuracy and efficiency.
          </p>
