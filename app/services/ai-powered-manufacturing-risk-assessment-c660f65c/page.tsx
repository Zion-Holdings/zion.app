...
export const metadata: Metadata = {
  ...
  description: 'AI-powered risk assessment for industrial operations with 80% defect reduction, Cost savings, and Predictive maintenance.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-manufacturing-risk-assessment-c660f65c',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            AI-powered risk assessment for industrial operations with 80% defect reduction, Cost savings, and Predictive maintenance.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$2256</p>
          <ul className="space-y-2 mb-4">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$10543</p>
          <ul className="space-y-2 mb-4">
