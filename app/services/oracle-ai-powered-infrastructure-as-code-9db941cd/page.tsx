...
export const metadata: Metadata = {
  title: 'Oracle AI-Powered Infrastructure as Code',
  description: 'AI-powered oracle solution for infrastructure. AI-generated infrastructure code with best practices and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/oracle-ai-powered-infrastructure-as-code-9db941cd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Oracle AI-Powered Infrastructure as Code
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered oracle solution for infrastructure. AI-generated infrastructure code with best practices and security.
          </p>
