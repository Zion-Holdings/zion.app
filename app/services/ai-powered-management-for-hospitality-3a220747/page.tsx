...
export const metadata: Metadata = {
  title: 'AI-Powered Management for Hospitality',
  description: 'Unlock unprecedented growth with AI-Powered Management for Hospitality. This autonomous system provides language processing with zero manual intervention needed',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-management-for-hospitality-3a220747',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Management for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with AI-Powered Management for Hospitality. This autonomous system provides language processing with zero manual intervention needed.
          </p>
