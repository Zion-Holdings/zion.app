...
export const metadata: Metadata = {
  title: 'AI/IT Neural Suite - Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our AI/IT Neural Suite - Hospitality leverages advanced machine learning to deliver customer journey m',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-neural-suite-hospitality-2c731814',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Neural Suite - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our AI/IT Neural Suite - Hospitality leverages advanced machine learning to deliver customer journey mapping at scale.
          </p>
