...
export const metadata: Metadata = {
  title: 'Autonomous Automation System - Agriculture',
  description: 'Optimize your agriculture workflows with Autonomous Automation System - Agriculture. This intelligent platform delivers content generation through advanced auto',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-automation-system-agriculture-45e7791f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Automation System - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your agriculture workflows with Autonomous Automation System - Agriculture. This intelligent platform delivers content generation through advanced automation and AI.
          </p>
