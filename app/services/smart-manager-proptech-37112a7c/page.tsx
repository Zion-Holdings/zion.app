...
export const metadata: Metadata = {
  title: 'Smart manager-proptech',
  description: 'Transform your proptech operations with our Smart manager-proptech. This AI-driven solution automates document processing with unprecedented accuracy and effici',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-manager-proptech-37112a7c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart manager-proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your proptech operations with our Smart manager-proptech. This AI-driven solution automates document processing with unprecedented accuracy and efficiency.
          </p>
