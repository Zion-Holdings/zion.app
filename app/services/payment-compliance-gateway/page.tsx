...
export const metadata: Metadata = {
  ...
  keywords: 'PCI-DSS L1 certified, Tokenization & vaulting, 3D Secure 2 support, Adaptive fraud scoring, Multi-currency settlement, security, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Payment Compliance Gateway</h1>
        <p className="text-lg text-slate-300 mb-8">PCI-DSS Level 1 certified payment gateway adapter with tokenization, 3D Secure 2, fraud scoring, and settlement reconciliation.</p>
        ...
        <li class="text-slate-300">PCI-DSS L1 certified</li>
        <li class="text-slate-300">Tokenization &amp; vaulting</li>
        <li class="text-slate-300">3D Secure 2 support</li>
        <li class="text-slate-300">Adaptive fraud scoring</li>
        <li class="text-slate-300">Multi-currency settlement</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with payment compliance gateway</li>
