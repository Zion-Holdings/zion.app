...
export const metadata: Metadata = {
  ...
  keywords: 'Custom integrations, Offline capabilities, Cloud-native architecture, GDPR compliance, SOC 2 certified, API-first design, generator, construction, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Self-Optimizing Intelligence for Construction</h1>
        <p className="text-lg text-slate-300 mb-8">Unlock unprecedented growth with Self-Optimizing Intelligence for Construction. This autonomous system provides data processing with zero manual intervention needed.</p>
