...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time dashboards & custom metrics, Proactive alerting (PagerDuty, OpsGenie), Centralized log aggregation (ELK/Loki), Distributed tracing (Jaeger, OpenTelemetry), Uptime monitoring from 20+ global locations, automation, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Monitoring &amp; Observability</h1>
        <p className="text-lg text-slate-300 mb-8">Full-stack monitoring with real-time dashboards, alerting, log aggregation, and distributed tracing for your entire infrastructure.</p>
        ...
        <li class="text-slate-300">Real-time dashboards &amp; custom metrics</li>
        <li class="text-slate-300">Proactive alerting (PagerDuty, OpsGenie)</li>
        <li class="text-slate-300">Centralized log aggregation (ELK/Loki)</li>
        <li class="text-slate-300">Distributed tracing (Jaeger, OpenTelemetry)</li>
        <li class="text-slate-300">Uptime monitoring from 20+ global locations</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with monitoring &amp; observability</li>
