...
export const metadata: Metadata = {
  title: 'AI-Powered AI-Powered Threat Detection System',
  description: 'ai-powered solution for insurtech industry. Real-time threat detection using behavioral analysis, anomaly detection, and machine learning.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-ai-powered-threat-detection-system-441a021b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered AI-Powered Threat Detection System
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            ai-powered solution for insurtech industry. Real-time threat detection using behavioral analysis, anomaly detection, and machine learning.
          </p>
