...
export const metadata: Metadata = {
  title: 'Intelligent engine-hospitality',
  description: 'Next-generation hospitality solution: Intelligent engine-hospitality. Combines performance tuning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-engine-hospitality-807624fc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent engine-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Intelligent engine-hospitality. Combines performance tuning with adaptive intelligence for optimal results.
          </p>
