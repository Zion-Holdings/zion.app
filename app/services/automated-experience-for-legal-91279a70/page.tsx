...
export const metadata: Metadata = {
  title: 'Automated Experience for Legal',
  description: 'Revolutionize legal through intelligent automation. Our Automated Experience for Legal leverages advanced machine learning to deliver resource optimization at s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-experience-for-legal-91279a70',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Experience for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Automated Experience for Legal leverages advanced machine learning to deliver resource optimization at scale.
          </p>
