...
export const metadata = {
  ...
  alternates: { canonical: '/services/cyber-threat-intelligence-2026-7573/' },

  openGraph: {
    title: 'Cyber Threat Intelligence | Zion Tech Group',
    description: 'End-to-end cyber threat intelligence services: assessment, deployment, and managed operations.',
    url: 'https://ziontechgroup.com/services/cyber-threat-intelligence-2026-7573/',
...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "Cyber Threat Intelligence | Zion Tech Group", description: "End-to-end cyber threat intelligence services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/cyber-threat-intelligence-2026-7573/}} />
