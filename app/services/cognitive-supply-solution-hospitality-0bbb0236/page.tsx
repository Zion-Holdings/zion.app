...
export const metadata: Metadata = {
  title: 'Cognitive Supply Solution - Hospitality',
  description: 'Next-generation hospitality solution: Cognitive Supply Solution - Hospitality. Combines expense management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-supply-solution-hospitality-0bbb0236',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Supply Solution - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Cognitive Supply Solution - Hospitality. Combines expense management with adaptive intelligence for optimal results.
          </p>
