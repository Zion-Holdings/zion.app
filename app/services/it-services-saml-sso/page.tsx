...
export const metadata: Metadata = {
  ...
  keywords: 'SAML 2.0 and OIDC support, Multi-factor authentication, Directory sync (LDAP, AD, SCIM), Conditional access policies, User provisioning and deprovisioning, Integration with Okta, Azure AD, Google Workspace, Session management, Compliance reporting (SOC2, HIPAA), it-services, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">SAML/SSO Identity Provider</h1>
        <p className="text-lg text-slate-300 mb-8">Enterprise Single Sign-On and identity management. SAML, OIDC, MFA, and directory integration for seamless access control.</p>
        ...
        <li class="text-slate-300">SAML 2.0 and OIDC support</li>
        <li class="text-slate-300">Multi-factor authentication</li>
        <li class="text-slate-300">Directory sync (LDAP, AD, SCIM)</li>
        ...
        <li class="text-slate-300">Session management</li>
        <li class="text-slate-300">Compliance reporting (SOC2, HIPAA)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">One login for all apps</li>
        <li class="text-slate-300">Reduce password tickets 80%</li>
        <li class="text-slate-300">Enforce MFA everywhere</li>
