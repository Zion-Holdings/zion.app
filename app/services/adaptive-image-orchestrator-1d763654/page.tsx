...
export const metadata: Metadata = {
  title: 'Adaptive Image Orchestrator',
  description: 'Next-generation healthcare solution: Adaptive Image Orchestrator. Combines user experience with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-image-orchestrator-1d763654',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Image Orchestrator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Adaptive Image Orchestrator. Combines user experience with adaptive intelligence for optimal results.
          </p>
