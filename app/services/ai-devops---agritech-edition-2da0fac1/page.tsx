...
export const metadata: Metadata = {
  title: 'AI DevOps - Agritech Edition',
  description: 'Transform your agritech operations with our AI DevOps - Agritech Edition. This AI-driven solution automates customer service automation with unprecedented accur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-devops---agritech-edition-2da0fac1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI DevOps - Agritech Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agritech operations with our AI DevOps - Agritech Edition. This AI-driven solution automates customer service automation with unprecedented accuracy and efficiency.
          </p>
