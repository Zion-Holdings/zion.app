...
export const metadata: Metadata = {
  title: 'Automated Security for CLEANTECH',
  description: 'Enhance your cleantech business with Automated Security for CLEANTECH. Our solution provides financial risk management with enterprise-grade reliability and sec',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-security-for-cleantech-a9add95a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Security for CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your cleantech business with Automated Security for CLEANTECH. Our solution provides financial risk management with enterprise-grade reliability and security.
          </p>
