...
export const metadata: Metadata = {
  title: 'Smart advisor-retail',
  description: 'The future of retail is here with Smart advisor-retail. Powered by cutting-edge AI, this platform delivers transformative results like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-advisor-retail-3a87c047',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart advisor-retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Smart advisor-retail. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
