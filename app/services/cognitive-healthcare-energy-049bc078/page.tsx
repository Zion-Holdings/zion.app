...
export const metadata: Metadata = {
  title: 'Cognitive healthcare-energy',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive healthcare-energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Cognitive healthcare-energy leverages advanced machine learning to deliver supply chain at scale.
          </p>
