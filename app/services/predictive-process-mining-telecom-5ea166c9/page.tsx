...
export const metadata: Metadata = {
  title: 'Predictive process mining-telecom',
  description: 'Transform your telecom operations with our Predictive process mining-telecom. This AI-driven solution provides intelligent automation with unprecedented accurac',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive process mining-telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your telecom operations with our Predictive process mining-telecom. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
