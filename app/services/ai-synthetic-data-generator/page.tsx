...
export const metadata = {
  ...
  description: "Generate statistically accurate synthetic datasets for ML training, testing, and compliance. Preserves statistical properties of real data while ensuring zero p",
  alternates: {
