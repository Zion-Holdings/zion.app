...
export const metadata: Metadata = {
  ...
  keywords: 'Statistical fidelity preservation, Privacy guarantee (differential privacy), Tabular, time-series, text, image generation, Data quality scoring, Schema-aware generation, Bias detection and mitigation, GDPR/HIPAA compliant by design, API and SDK access, ai, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Synthetic Data Generator Pro</h1>
        <p className="text-lg text-slate-300 mb-8">Generate statistically accurate synthetic datasets for ML training, testing, and compliance. Preserves statistical properties of real data while ensuring zero privacy risk. Supports tabular, time-series, text, and image data.</p>
        ...
        <li class="text-slate-300">Statistical fidelity preservation</li>
        <li class="text-slate-300">Privacy guarantee (differential privacy)</li>
        <li class="text-slate-300">Tabular, time-series, text, image generation</li>
        <li class="text-slate-300">Data quality scoring</li>
        <li class="text-slate-300">Schema-aware generation</li>
        <li class="text-slate-300">Bias detection and mitigation</li>
        <li class="text-slate-300">GDPR/HIPAA compliant by design</li>
        <li class="text-slate-300">API and SDK access</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Eliminate privacy compliance risks</li>
        <li class="text-slate-300">Unlimited training data generation</li>
        <li class="text-slate-300">Balance underrepresented classes</li>
        <li class="text-slate-300">Accelerate ML development cycles</li>
      </ul>
        </div>
