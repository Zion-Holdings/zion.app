...
export const metadata: Metadata = {
  title: 'Next-Gen Computer Vision for CLEANTECH',
  description: 'Revolutionize cleantech through intelligent automation. Our Next-Gen Computer Vision for CLEANTECH leverages advanced machine learning to deliver performance re',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-computer-vision-for-cleantech-2fe34637',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Computer Vision for CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cleantech through intelligent automation. Our Next-Gen Computer Vision for CLEANTECH leverages advanced machine learning to deliver performance reviews at scale.
          </p>
