...
export const metadata: Metadata = {
  ...
  keywords: 'Custom CIDR and VPC design, Private subnet with no internet, VPC peering & transit gateway, Centralized network routing, DDoS with clean traffic, cloud, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Virtual Private Cloud</h1>
        <p className="text-lg text-slate-300 mb-8">Dedicated VPC with custom CIDR, isolated network topology, private subnet routing, VPC peering, and cross-VPC transit across any cloud provider.</p>
        ...
        <li class="text-slate-300">Custom CIDR and VPC design</li>
        <li class="text-slate-300">Private subnet with no internet</li>
        <li class="text-slate-300">VPC peering &amp; transit gateway</li>
        <li class="text-slate-300">Centralized network routing</li>
        <li class="text-slate-300">DDoS with clean traffic</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with virtual private cloud</li>
