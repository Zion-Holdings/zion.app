...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Monitoring - PROPTECH',
  description: 'The future of proptech is here with Hyper-Accelerated Monitoring - PROPTECH. Powered by cutting-edge AI, this platform delivers logistics route optimization lik',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Monitoring - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with Hyper-Accelerated Monitoring - PROPTECH. Powered by cutting-edge AI, this platform delivers logistics route optimization like never before.
          </p>
