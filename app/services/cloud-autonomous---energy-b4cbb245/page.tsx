...
export const metadata: Metadata = {
  title: 'Cloud Autonomous - Energy',
  description: 'Unlock unprecedented growth with Cloud Autonomous - Energy. This autonomous system provides supply chain with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cloud-autonomous---energy-b4cbb245',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cloud Autonomous - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Cloud Autonomous - Energy. This autonomous system provides supply chain with zero manual intervention needed.
          </p>
