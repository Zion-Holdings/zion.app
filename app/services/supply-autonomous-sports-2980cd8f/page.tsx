...
export const metadata: Metadata = {
  title: 'Supply Autonomous - Sports',
  description: 'The future of sports is here with Supply Autonomous - Sports. Powered by cutting-edge AI, this platform delivers process discovery like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/supply-autonomous-sports-2980cd8f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Supply Autonomous - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Supply Autonomous - Sports. Powered by cutting-edge AI, this platform delivers process discovery like never before.
          </p>
