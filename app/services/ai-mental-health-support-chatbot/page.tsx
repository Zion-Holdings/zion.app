...
export const metadata: Metadata = {
  ...
  keywords: '24/7 empathetic AI conversation, Crisis detection and escalation, CBT and DBT-based therapeutic techniques, Mood tracking and journaling, Integration with therapist workflows, Multilingual support, Anonymous usage option, Outcome measurement and reporting, ai, healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Mental Health Support &amp; Wellness Chatbot</h1>
        <p className="text-lg text-slate-300 mb-8">HIPAA-compliant AI chatbot providing 24/7 mental health support, crisis detection, and therapeutic conversation.</p>
        ...
        <li class="text-slate-300">24/7 empathetic AI conversation</li>
        <li class="text-slate-300">Crisis detection and escalation</li>
        <li class="text-slate-300">CBT and DBT-based therapeutic techniques</li>
        <li class="text-slate-300">Mood tracking and journaling</li>
        <li class="text-slate-300">Integration with therapist workflows</li>
        <li class="text-slate-300">Multilingual support</li>
        <li class="text-slate-300">Anonymous usage option</li>
        <li class="text-slate-300">Outcome measurement and reporting</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Provide 24/7 mental health support</li>
        <li class="text-slate-300">Reduce therapist workload</li>
        <li class="text-slate-300">Early crisis detection</li>
        <li class="text-slate-300">Improve employee wellness</li>
      </ul>
        </div>
