...
export const metadata: Metadata = {
  title: 'Automated Analytics for Telecom',
  description: 'The future of telecom is here with Automated Analytics for Telecom. Powered by cutting-edge AI, this platform delivers energy management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-analytics-for-telecom-556baa13',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Analytics for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of telecom is here with Automated Analytics for Telecom. Powered by cutting-edge AI, this platform delivers energy management like never before.
          </p>
