...
export const metadata: Metadata = {
  title: 'Neural Risk for Construction',
  description: 'Transform your construction operations with our Neural Risk for Construction. This AI-driven solution automates predictive analytics with unprecedented accuracy',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-risk-for-construction-c5c08027',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Risk for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Neural Risk for Construction. This AI-driven solution automates predictive analytics with unprecedented accuracy and efficiency.
          </p>
