...
export const metadata: Metadata = {
  title: 'AI-Powered supply-fintech',
  description: 'Unlock unprecedented growth with AI-Powered supply-fintech. This autonomous system provides generative ai with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-supply-fintech-5e6d3eaf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered supply-fintech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with AI-Powered supply-fintech. This autonomous system provides generative ai with zero manual intervention needed.
          </p>
