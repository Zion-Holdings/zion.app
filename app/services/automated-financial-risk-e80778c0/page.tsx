...
export const metadata: Metadata = {
  title: 'Automated Financial Risk',
  description: 'Drive innovation in energy with Automated Financial Risk. This AI-powered platform transforms capacity management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-financial-risk-e80778c0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Financial Risk
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Automated Financial Risk. This AI-powered platform transforms capacity management into a competitive advantage.
          </p>
