...
export const metadata: Metadata = {
  title: 'Autonomous Analytics for CLEANTECH',
  description: 'Drive innovation in cleantech with Autonomous Analytics for CLEANTECH. This AI-powered platform transforms customer journey mapping into a competitive advantage',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-analytics-for-cleantech-870559d7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Analytics for CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in cleantech with Autonomous Analytics for CLEANTECH. This AI-powered platform transforms customer journey mapping into a competitive advantage.
          </p>
