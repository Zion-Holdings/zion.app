      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Development assistant that generates production-ready code from natural language descriptions, optimizes existing code for performance, and suggests security improvements.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Multi-language code generation</li>
          <li className="text-gray-300">Performance optimization suggestions</li>
          <li className="text-gray-300">Security vulnerability detection</li>
          <li className="text-gray-300">Code documentation generation</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">10x faster development speed</li>
          <li className="text-purple-300">Improved code quality</li>
          <li className="text-purple-300">Reduced bug rates</li>
          <li className="text-purple-300">Enhanced security posture</li>
          </ul>
        </section>
