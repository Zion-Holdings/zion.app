...
export const metadata: Metadata = {
  title: 'Intelligent Healthcare for Finance',
  description: 'Optimize your finance workflows with Intelligent Healthcare for Finance. This intelligent platform delivers succession planning through advanced automation and ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Healthcare for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your finance workflows with Intelligent Healthcare for Finance. This intelligent platform delivers succession planning through advanced automation and AI.
          </p>
