...
export const metadata: Metadata = {
  title: 'Cognitive director-construction',
  description: 'Next-generation construction solution: Cognitive director-construction. Combines procurement automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-director-construction-352354e3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive director-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Cognitive director-construction. Combines procurement automation with adaptive intelligence for optimal results.
          </p>
