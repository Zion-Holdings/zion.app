...
export const metadata: Metadata = {
  title: 'Cognitive Finance Solution - Insurance',
  description: 'Enhance your insurance business with Cognitive Finance Solution - Insurance. Our solution provides recruitment automation with enterprise-grade reliability and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-finance-solution-insurance-c2c40ac8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Finance Solution - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Cognitive Finance Solution - Insurance. Our solution provides recruitment automation with enterprise-grade reliability and security.
          </p>
