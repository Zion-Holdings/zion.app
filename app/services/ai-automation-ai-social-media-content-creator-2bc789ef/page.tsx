...
export const metadata: Metadata = {
  title: "AI Automation AI Social Media Content Creator - AI-Powered AI Automation Solution",
  description: "AI-powered ai automation solution for social media. Generates, schedules, and optimizes social media content across all platforms.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-automation-ai-social-media-content-creator-2bc789ef",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI Automation AI Social Media Content Creator - AI-Powered AI Automation Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          AI-powered ai automation solution for social media. Generates, schedules, and optimizes social media content across all platforms.
        </p>
