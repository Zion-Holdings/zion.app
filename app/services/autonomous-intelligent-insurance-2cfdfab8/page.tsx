...
export const metadata: Metadata = {
  title: 'Autonomous Intelligent - Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Autonomous Intelligent - Insurance leverages advanced machine learning to deliver pricing optimizati',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-intelligent-insurance-2cfdfab8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Intelligent - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Autonomous Intelligent - Insurance leverages advanced machine learning to deliver pricing optimization at scale.
          </p>
