...
export const metadata: Metadata = {
  title: 'Smart Cloud Platform - Transportation',
  description: 'Transform your transportation operations with our Smart Cloud Platform - Transportation. This AI-driven solution automates capacity management with unprecedente',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-cloud-platform-transportation-7d85286d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Cloud Platform - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your transportation operations with our Smart Cloud Platform - Transportation. This AI-driven solution automates capacity management with unprecedented accuracy and efficiency.
          </p>
