...
export const metadata: Metadata = {
  title: 'AI-Powered AI for Transportation',
  description: 'Drive innovation in transportation with AI-Powered AI for Transportation. This AI-powered platform transforms ml model training into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-ai-for-transportation-91fe08de',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered AI for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in transportation with AI-Powered AI for Transportation. This AI-powered platform transforms ml model training into a competitive advantage.
          </p>
