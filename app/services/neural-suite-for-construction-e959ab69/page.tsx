...
export const metadata: Metadata = {
  title: 'Neural Suite for Construction',
  description: 'The future of construction is here with Neural Suite for Construction. Powered by cutting-edge AI, this platform delivers campaign optimization like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-suite-for-construction-e959ab69',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Suite for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Neural Suite for Construction. Powered by cutting-edge AI, this platform delivers campaign optimization like never before.
          </p>
