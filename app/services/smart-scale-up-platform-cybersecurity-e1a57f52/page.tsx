...
export const metadata: Metadata = {
  title: 'Smart Scale-up Platform - Cybersecurity',
  description: 'Quantum leap forward for cybersecurity: Smart Scale-up Platform - Cybersecurity. Uses quantum-inspired algorithms to deliver maintenance prediction at exponenti',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Scale-up Platform - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for cybersecurity: Smart Scale-up Platform - Cybersecurity. Uses quantum-inspired algorithms to deliver maintenance prediction at exponential speed.
          </p>
