...
export const metadata: Metadata = {
  title: 'Director AI - Healthcare',
  description: 'Next-generation healthcare solution: Director AI - Healthcare. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/director-ai-healthcare-7659b19a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Director AI - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Director AI - Healthcare. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
