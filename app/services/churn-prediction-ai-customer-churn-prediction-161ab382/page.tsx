...
export const metadata: Metadata = {
  ...
  description: 'churn prediction solution for bridges & tunnels industry. Identifies at-risk customers before they churn using behavioral patterns and engagement metrics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/churn-prediction-ai-customer-churn-prediction-161ab382',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            churn prediction solution for bridges & tunnels industry. Identifies at-risk customers before they churn using behavioral patterns and engagement metrics.
          </p>
