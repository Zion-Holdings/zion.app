...
export const metadata: Metadata = {
  title: 'Intelligent Quality System',
  description: 'Transform your automotive operations with our Intelligent Quality System. This AI-driven solution automates quality control with unprecedented accuracy and effi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your automotive operations with our Intelligent Quality System. This AI-driven solution automates quality control with unprecedented accuracy and efficiency.
          </p>
