...
export const metadata: Metadata = {
  ...
  description: 'The future of transportation is here with Intelligent Smart for Transportation. Powered by cutting-edge AI, this platform delivers payroll processing like never',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Intelligent Smart for Transportation. Powered by cutting-edge AI, this platform delivers payroll processing like never before.
          </p>
