...
export const metadata: Metadata = {
  ...
  keywords: 'Natural voice synthesis, Real-time speech recognition, Multi-language support, CRM integration, Call analytics and scoring, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Voice Agent Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Deploy conversational AI voice agents for customer service, outbound calls, appointment scheduling, and lead qualification with natural speech.</p>
        ...
        <li class="text-slate-300">Natural voice synthesis</li>
        <li class="text-slate-300">Real-time speech recognition</li>
        <li class="text-slate-300">Multi-language support</li>
        <li class="text-slate-300">CRM integration</li>
        <li class="text-slate-300">Call analytics and scoring</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai voice agent platform</li>
