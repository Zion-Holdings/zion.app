...
export const metadata: Metadata = {
  title: 'AI-Powered Scenario Healthcare',
  description: 'Transform your agriculture operations with our AI-Powered Scenario Healthcare. This AI-driven solution automates succession planning with unprecedented accuracy',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Scenario Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our AI-Powered Scenario Healthcare. This AI-driven solution automates succession planning with unprecedented accuracy and efficiency.
          </p>
