...
export const metadata: Metadata = {
  title: 'Predictive Optimizer Engine - Transportation',
  description: 'Enhance your transportation business with Predictive Optimizer Engine - Transportation. Our solution provides process discovery with enterprise-grade reliabilit',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Optimizer Engine - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with Predictive Optimizer Engine - Transportation. Our solution provides process discovery with enterprise-grade reliability and security.
          </p>
