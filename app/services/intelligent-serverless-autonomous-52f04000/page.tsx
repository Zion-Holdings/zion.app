...
export const metadata: Metadata = {
  title: 'Intelligent Serverless Autonomous',
  description: 'Revolutionize energy through intelligent automation. Our Intelligent Serverless Autonomous leverages advanced machine learning to deliver resource optimization ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Serverless Autonomous
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Intelligent Serverless Autonomous leverages advanced machine learning to deliver resource optimization at scale.
          </p>
