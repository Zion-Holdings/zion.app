...
export const metadata: Metadata = {
  title: 'Cognitive Insights Solution - Legal',
  description: 'Optimize your legal workflows with Cognitive Insights Solution - Legal. This intelligent platform delivers customer insights through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-insights-solution-legal-c28089cd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Insights Solution - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with Cognitive Insights Solution - Legal. This intelligent platform delivers customer insights through advanced automation and AI.
          </p>
