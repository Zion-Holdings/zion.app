...
export const metadata: Metadata = {
  ...
  keywords: 'ID document verification (190+ countries), Biometric face matching, Liveness detection, PEP & sanctions screening, Ongoing audit monitoring, Regulatory reporting, security, Financial Services, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Identity Verification &amp; KYC Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Automated KYC/AML for fintechs and banks: document verification, biometric matching, liveness detection, PEP/sanctions screening, ongoing monitoring.</p>
        ...
        <li class="text-slate-300">ID document verification (190+ countries)</li>
        <li class="text-slate-300">Biometric face matching</li>
        <li class="text-slate-300">Liveness detection</li>
        <li class="text-slate-300">PEP &amp; sanctions screening</li>
        <li class="text-slate-300">Ongoing audit monitoring</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Verify identity in 30 seconds</li>
        <li class="text-slate-300">Reduce fraud by 90%</li>
        <li class="text-slate-300">Full AML compliance</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">1/verification</p>
              <p class="text-sm text-slate-400">Getting started plan</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              <h3 class="font-semibold text-white mb-2">Pro</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">0.50/verification</p>
              <p class="text-sm text-slate-400">Most popular</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              <h3 class="font-semibold text-white mb-2">Enterprise</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">0.25/verification</p>
