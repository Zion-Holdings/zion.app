...
export const metadata: Metadata = {
  title: 'Product Catalog Management AI-Powered SEO Content Engine',
  description: 'product catalog management solution for textiles industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing c',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/product-catalog-management-ai-powered-seo-content-engine-8446314c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Product Catalog Management AI-Powered SEO Content Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            product catalog management solution for textiles industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing copy.
          </p>
