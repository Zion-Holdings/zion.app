...
export const metadata: Metadata = {
  title: 'Adaptive Procurement Experience',
  description: 'Transform your construction operations with our Adaptive Procurement Experience. This AI-driven solution provides intelligent automation with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-procurement-experience-fda94841',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Adaptive Procurement Experience. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
