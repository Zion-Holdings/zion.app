...
export const metadata: Metadata = {
  title: 'AI-Powered Data Security',
  description: 'Automated data access control and encryption management.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-data-security-4dc23485',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automated data access control and encryption management.
          </p>
