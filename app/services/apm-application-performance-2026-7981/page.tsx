...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "APM Application Performance | Zion Tech Group", description: "End-to-end apm application performance services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/apm-application-performance-2026-7981/}} />
