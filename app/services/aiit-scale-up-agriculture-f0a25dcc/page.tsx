...
export const metadata: Metadata = {
  title: 'AI/IT scale-up-agriculture',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT scale-up-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our AI/IT scale-up-agriculture leverages advanced machine learning to deliver content generation at scale.
          </p>
