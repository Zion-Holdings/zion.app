...
export const metadata: Metadata = {
  title: 'Image Autonomous - Logistics',
  description: 'The future of logistics is here with Image Autonomous - Logistics. Powered by cutting-edge AI, this platform delivers user experience like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/image-autonomous-logistics-36a78263',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Image Autonomous - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Image Autonomous - Logistics. Powered by cutting-edge AI, this platform delivers user experience like never before.
          </p>
