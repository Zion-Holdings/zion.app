...
export const metadata: Metadata = {
  ...
  description: 'Optimize your retail workflows with Risk Automated - Retail. This intelligent platform delivers api management through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/risk-automated-retail-73f3215f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your retail workflows with Risk Automated - Retail. This intelligent platform delivers api management through advanced automation and AI.
          </p>
