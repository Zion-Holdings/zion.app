...
export const metadata: Metadata = {
  title: 'Smart Compliance Healthcare',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Compliance Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Compliance Healthcare. This autonomous system provides performance monitoring with zero manual intervention needed.
          </p>
