...
export const metadata: Metadata = {
  title: 'Cognitive Sales for Transportation',
  description: 'The future of transportation is here with Cognitive Sales for Transportation. Powered by cutting-edge AI, this platform delivers process automation like never b',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-sales-for-transportation-62fe2990',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Sales for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Cognitive Sales for Transportation. Powered by cutting-edge AI, this platform delivers process automation like never before.
          </p>
