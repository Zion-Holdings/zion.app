...
export const metadata: Metadata = {
  ...
  description: 'disaster recovery solution for warehousing industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatic',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/disaster-recovery-intelligent-document-processing-ai-e6df467d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            disaster recovery solution for warehousing industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.
          </p>
