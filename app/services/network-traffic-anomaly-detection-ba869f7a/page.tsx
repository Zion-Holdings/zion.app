...
export const metadata = {
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/network-traffic-anomaly-detection-ba869f7a`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path={`/services/network-traffic-anomaly-detection-ba869f7a`} title="Network Traffic Anomaly Detection" />
