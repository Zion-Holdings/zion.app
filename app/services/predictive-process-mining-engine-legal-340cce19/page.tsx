...
export const metadata: Metadata = {
  title: 'Predictive Process Mining Engine - Legal',
  description: 'Enhance your legal business with Predictive Process Mining Engine - Legal. Our solution provides language processing with enterprise-grade reliability and secur',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Process Mining Engine - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Predictive Process Mining Engine - Legal. Our solution provides language processing with enterprise-grade reliability and security.
          </p>
