...
export const metadata: Metadata = {
  ...
  keywords: 'AES-256 at-rest encryption, Dynamic watermarking, Usage restrictions (view/print), Access revocation, Audit trail, security, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Digital Rights Management</h1>
        <p className="text-lg text-slate-300 mb-8">Protect digital assets with AES-256 encryption, watermarking, usage restrictions, and access revocation for IP-sensitive document sharing.</p>
        ...
        <li class="text-slate-300">AES-256 at-rest encryption</li>
        <li class="text-slate-300">Dynamic watermarking</li>
        <li class="text-slate-300">Usage restrictions (view/print)</li>
        <li class="text-slate-300">Access revocation</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with digital rights management</li>
