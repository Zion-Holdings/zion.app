...
export const metadata: Metadata = {
  title: 'Autonomous Enterprise System - AITECH',
  description: 'Next-generation aitech solution: Autonomous Enterprise System - AITECH. Combines budget tracking with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-enterprise-system-aitech-32a6173e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Enterprise System - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation aitech solution: Autonomous Enterprise System - AITECH. Combines budget tracking with adaptive intelligence for optimal results.
          </p>
