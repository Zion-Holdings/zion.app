...
export const metadata: Metadata = {
  title: 'Cognitive Image Compliance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Image Compliance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your telecom business with Cognitive Image Compliance. Our solution provides pipeline management with enterprise-grade reliability and security.
          </p>
