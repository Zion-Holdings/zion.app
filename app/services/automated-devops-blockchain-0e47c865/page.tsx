...
export const metadata: Metadata = {
  title: 'Automated devops-blockchain',
  description: 'Transform your blockchain operations with our Automated devops-blockchain. This AI-driven solution automates financial planning with unprecedented accuracy and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-devops-blockchain-0e47c865',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated devops-blockchain
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your blockchain operations with our Automated devops-blockchain. This AI-driven solution automates financial planning with unprecedented accuracy and efficiency.
          </p>
