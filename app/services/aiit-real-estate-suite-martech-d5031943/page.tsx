...
export const metadata: Metadata = {
  title: 'AI/IT Real Estate Suite - MARTECH',
  description: 'Next-generation martech solution: AI/IT Real Estate Suite - MARTECH. Combines api management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-real-estate-suite-martech-d5031943',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Real Estate Suite - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation martech solution: AI/IT Real Estate Suite - MARTECH. Combines api management with adaptive intelligence for optimal results.
          </p>
