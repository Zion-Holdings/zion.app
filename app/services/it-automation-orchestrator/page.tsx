...
export const metadata: Metadata = {
  ...
  keywords: 'Infrastructure automation with Terraform and Ansible, Workflow orchestration across IT systems, Self-healing infrastructure with event-driven automation, Compliance enforcement and drift detection, Centralized automation catalog and governance, automation, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Automation &amp; Orchestration Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Enterprise IT automation platform with workflow orchestration, infrastructure provisioning, configuration management, and self-healing system capabilities.</p>
        ...
        <li class="text-slate-300">Infrastructure automation with Terraform and Ansible</li>
        <li class="text-slate-300">Workflow orchestration across IT systems</li>
        <li class="text-slate-300">Self-healing infrastructure with event-driven automation</li>
        <li class="text-slate-300">Compliance enforcement and drift detection</li>
        <li class="text-slate-300">Centralized automation catalog and governance</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with it automation &amp; orchestration platform</li>
