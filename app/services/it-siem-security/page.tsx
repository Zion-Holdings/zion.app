  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT SIEM &amp; Security Information Event Management</h1>
        <p className="text-lg text-slate-300 mb-8">SIEM deployment, management, and tuning. Collect, correlate, and analyze security events from across your infrastructure. 24/7 monitoring with threat detection.</p>
        ...
        <li class="text-slate-300">SIEM platform selection and deployment</li>
        <li class="text-slate-300">Log collection from all infrastructure sources</li>
        <li class="text-slate-300">Custom correlation rules and dashboards</li>
        <li class="text-slate-300">Threat detection and alert tuning</li>
        <li class="text-slate-300">Integration with firewalls, EDR, cloud platforms</li>
        <li class="text-slate-300">Compliance reporting (SOC 2, HIPAA, PCI)</li>
        <li class="text-slate-300">Incident investigation and forensics</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Detect threats across all infrastructure</li>
        <li class="text-slate-300">Reduce false positives by 70% with tuning</li>
        <li class="text-slate-300">Meet compliance log management requirements</li>
        <li class="text-slate-300">24/7 expert monitoring and response</li>
      </ul>
        </div>
