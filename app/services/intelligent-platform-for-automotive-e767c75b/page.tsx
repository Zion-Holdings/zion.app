...
export const metadata: Metadata = {
  title: 'Intelligent Platform for Automotive',
  description: 'Unlock unprecedented growth with Intelligent Platform for Automotive. This autonomous system provides api management with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-platform-for-automotive-e767c75b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Platform for Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Platform for Automotive. This autonomous system provides api management with zero manual intervention needed.
          </p>
