...
export const metadata: Metadata = {
  title: 'Autonomous Manufacturing for Insurance',
  description: 'Next-generation insurance solution: Autonomous Manufacturing for Insurance. Combines process automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-manufacturing-for-insurance-9dc75c85',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Manufacturing for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Autonomous Manufacturing for Insurance. Combines process automation with adaptive intelligence for optimal results.
          </p>
