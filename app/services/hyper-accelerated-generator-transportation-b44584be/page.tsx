...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Generator - Transportation',
  description: 'The future of transportation is here with Hyper-Accelerated Generator - Transportation. Powered by cutting-edge AI, this platform delivers decision support like',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/hyper-accelerated-generator-transportation-b44584be',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Generator - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Hyper-Accelerated Generator - Transportation. Powered by cutting-edge AI, this platform delivers decision support like never before.
          </p>
