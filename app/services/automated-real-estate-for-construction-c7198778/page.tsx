...
export const metadata: Metadata = {
  title: 'Automated Real Estate for Construction',
  description: 'The future of construction is here with Automated Real Estate for Construction. Powered by cutting-edge AI, this platform delivers decision support like never b',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-real-estate-for-construction-c7198778',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Real Estate for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Automated Real Estate for Construction. Powered by cutting-edge AI, this platform delivers decision support like never before.
          </p>
