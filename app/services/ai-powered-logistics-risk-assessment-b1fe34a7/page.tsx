...
export const metadata: Metadata = {
  title: 'AI-Powered Logistics Risk Assessment',
  description: 'AI-powered risk assessment for supply chain with Customer satisfaction, 30% cost reduction, and Route optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-logistics-risk-assessment-b1fe34a7',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Logistics Risk Assessment
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered risk assessment for supply chain with Customer satisfaction, 30% cost reduction, and Route optimization.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$1404</p>
          <ul className="space-y-2 mb-4">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$9843</p>
          <ul className="space-y-2 mb-4">
