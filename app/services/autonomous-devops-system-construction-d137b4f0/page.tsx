...
export const metadata: Metadata = {
  title: 'Autonomous DevOps System - Construction',
  description: 'Transform your construction operations with our Autonomous DevOps System - Construction. This AI-driven solution automates business continuity with unprecedente',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-devops-system-construction-d137b4f0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous DevOps System - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Autonomous DevOps System - Construction. This AI-driven solution automates business continuity with unprecedented accuracy and efficiency.
          </p>
