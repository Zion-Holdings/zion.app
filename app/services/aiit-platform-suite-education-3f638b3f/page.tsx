...
export const metadata: Metadata = {
  title: 'AI/IT Platform Suite - Education',
  description: 'Optimize your education workflows with AI/IT Platform Suite - Education. This intelligent platform delivers lakehouse architecture through advanced automation a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Platform Suite - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your education workflows with AI/IT Platform Suite - Education. This intelligent platform delivers lakehouse architecture through advanced automation and AI.
          </p>
