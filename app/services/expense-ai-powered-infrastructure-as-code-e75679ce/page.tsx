...
export const metadata: Metadata = {
  title: 'Expense AI-Powered Infrastructure as Code',
  description: 'AI-powered expense solution for infrastructure. AI-generated infrastructure code with best practices and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/expense-ai-powered-infrastructure-as-code-e75679ce',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Expense AI-Powered Infrastructure as Code
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered expense solution for infrastructure. AI-generated infrastructure code with best practices and security.
          </p>
