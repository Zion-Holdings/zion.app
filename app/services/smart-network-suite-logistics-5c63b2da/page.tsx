...
export const metadata: Metadata = {
  title: 'Smart Network Suite - Logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Smart Network Suite - Logistics leverages advanced machine learning to deliver security monitoring a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-network-suite-logistics-5c63b2da',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Network Suite - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Smart Network Suite - Logistics leverages advanced machine learning to deliver security monitoring at scale.
          </p>
