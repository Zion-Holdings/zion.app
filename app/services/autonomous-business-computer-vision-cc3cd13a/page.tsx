...
export const metadata: Metadata = {
  title: 'Autonomous Business Computer Vision',
  description: 'Transform your media operations with our Autonomous Business Computer Vision. This AI-driven solution automates regulatory tracking with unprecedented accuracy ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Business Computer Vision
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your media operations with our Autonomous Business Computer Vision. This AI-driven solution automates regulatory tracking with unprecedented accuracy and efficiency.
          </p>
