...
export const metadata: Metadata = {
  title: 'Cognitive System Solution - Tech',
  description: 'Enhance your technology business with Cognitive System Solution - Tech. Our solution provides customer insights with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-system-solution-tech-68452919',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive System Solution - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your technology business with Cognitive System Solution - Tech. Our solution provides customer insights with enterprise-grade reliability and security.
          </p>
