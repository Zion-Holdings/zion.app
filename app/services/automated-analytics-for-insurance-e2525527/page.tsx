...
export const metadata: Metadata = {
  title: 'Automated Analytics for Insurance',
  description: 'Next-generation insurance solution: Automated Analytics for Insurance. Combines inventory management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-analytics-for-insurance-e2525527',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Analytics for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Automated Analytics for Insurance. Combines inventory management with adaptive intelligence for optimal results.
          </p>
