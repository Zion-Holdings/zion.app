...
export const metadata: Metadata = {
  title: 'Deep Learning Intelligent - Construction',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Deep Learning Intelligent - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Deep Learning Intelligent - Construction leverages advanced machine learning to deliver customer retention at scale.
          </p>
