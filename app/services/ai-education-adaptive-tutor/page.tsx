...
export const metadata: Metadata = {
  ...
  keywords: 'Mastery-level adaptive engine, Scaffold strugglers + accelerate performers, Curriculum-standard problem tagging, Parent+teacher mastery heat-map, ai, Education, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Adaptive Tutoring System</h1>
        <p className="text-lg text-slate-300 mb-8">Personalized K-12 adaptive: adjusts difficulty by mastery scaffolds strugglers accelerates high performers curriculum-standard tagged problems.</p>
        ...
        <li class="text-slate-300">Mastery-level adaptive engine</li>
        <li class="text-slate-300">Scaffold strugglers + accelerate performers</li>
        <li class="text-slate-300">Curriculum-standard problem tagging</li>
        <li class="text-slate-300">Parent+teacher mastery heat-map</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai adaptive tutoring system</li>
