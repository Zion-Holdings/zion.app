...
export const metadata: Metadata = {
  title: 'Predictive Platform for Insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Platform for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Predictive Platform for Insurance. Combines performance reviews with adaptive intelligence for optimal results.
          </p>
