...
export const metadata: Metadata = {
  title: 'Enterprise quality-hospitality',
  description: 'Hyper-accelerated hospitality solution: Enterprise quality-hospitality. Combines travel management with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-quality-hospitality-9061ef2c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise quality-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated hospitality solution: Enterprise quality-hospitality. Combines travel management with next-gen AI for maximum velocity.
          </p>
