...
export const metadata: Metadata = {
  title: 'Intelligent finance-transportation',
  description: 'Revolutionize transportation through intelligent automation. Our Intelligent finance-transportation leverages advanced machine learning to deliver net promoter ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-finance-transportation-5f5d71a0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent finance-transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize transportation through intelligent automation. Our Intelligent finance-transportation leverages advanced machine learning to deliver net promoter score at scale.
          </p>
