...
export const metadata: Metadata = {
  title: 'Quantum customer service-edtech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum customer service-edtech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated edtech solution: Quantum customer service-edtech. Combines pipeline management with next-gen AI for maximum velocity.
          </p>
