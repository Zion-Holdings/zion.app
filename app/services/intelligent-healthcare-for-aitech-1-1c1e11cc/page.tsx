...
export const metadata: Metadata = {
  title: 'Intelligent Healthcare for AITECH #1',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Healthcare for AITECH #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for aitech: Intelligent Healthcare for AITECH #1. Uses quantum-inspired algorithms to deliver territory management at exponential speed.
          </p>
