...
export const metadata: Metadata = {
  title: 'AI-Powered support-legal',
  description: 'Enhance your legal business with AI-Powered support-legal. Our solution provides regulatory tracking with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-support-legal-83d5466a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered support-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with AI-Powered support-legal. Our solution provides regulatory tracking with enterprise-grade reliability and security.
          </p>
