...
export const metadata: Metadata = {
  title: 'Smart Management Platform - Logistics #3',
  description: 'Next-generation logistics solution: Smart Management Platform - Logistics #3. Combines manufacturing quality control with adaptive intelligence for optimal resu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-management-platform-logistics-3-e240e1a5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Management Platform - Logistics #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Smart Management Platform - Logistics #3. Combines manufacturing quality control with adaptive intelligence for optimal results.
          </p>
