...
export const metadata: Metadata = {
  title: 'Cognitive Finance Solution - Energy',
  description: 'Revolutionize energy through intelligent automation. Our Cognitive Finance Solution - Energy leverages advanced machine learning to deliver master data manageme',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-finance-solution-energy-c556d7e0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Finance Solution - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Cognitive Finance Solution - Energy leverages advanced machine learning to deliver master data management at scale.
          </p>
