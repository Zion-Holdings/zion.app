...
export const metadata: Metadata = {
  title: 'Cloud AI - Legal #1',
  description: 'Transform your legal operations with our Cloud AI - Legal #1. This AI-driven solution automates account planning with unprecedented accuracy and efficiency.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cloud-ai-legal-1-0f018862',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Cloud AI - Legal #1. This AI-driven solution automates account planning with unprecedented accuracy and efficiency.
          </p>
