...
export const metadata: Metadata = {
  title: 'Smart DevOps Platform - Media',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart DevOps Platform - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your media workflows with Smart DevOps Platform - Media. This intelligent platform delivers lead scoring through advanced automation and AI.
          </p>
