...
export const metadata: Metadata = {
  title: 'Enterprise Business Intelligence Platform - Sports',
  description: 'Transform your sports operations with our Enterprise Business Intelligence Platform - Sports. This AI-driven solution automates quality prediction with unpreced',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-business-intelligence-platform-sports-8e7f391c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Business Intelligence Platform - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our Enterprise Business Intelligence Platform - Sports. This AI-driven solution automates quality prediction with unprecedented accuracy and efficiency.
          </p>
