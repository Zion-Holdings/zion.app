...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={@context: "https://schema.org", @type: "Service", name: "Automation Orchestration | Zion Tech Group", description: "End-to-end automation orchestration services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/automation-orchestration-enterprise-2026-7251/"} />
