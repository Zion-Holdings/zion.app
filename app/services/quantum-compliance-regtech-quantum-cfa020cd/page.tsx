...
export const metadata: Metadata = {
  title: 'Quantum Compliance - REGTECH Quantum',
  description: 'The future of regtech is here with Quantum Compliance - REGTECH Quantum. Powered by cutting-edge AI, this platform delivers event-driven architecture like never',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-compliance-regtech-quantum-cfa020cd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Compliance - REGTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of regtech is here with Quantum Compliance - REGTECH Quantum. Powered by cutting-edge AI, this platform delivers event-driven architecture like never before.
          </p>
