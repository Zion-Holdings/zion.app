...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-language support, Offline capabilities, HIPAA ready, Alerting system, insights, hospitality, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Predictive Suite for Hospitality</h1>
        <p className="text-lg text-slate-300 mb-8">Transform your hospitality operations with our Predictive Suite for Hospitality. This AI-driven solution automates inventory management with unprecedented accuracy and efficiency.</p>
