...
export const metadata: Metadata = {
  title: 'Intelligent Security for AITECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Security for AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your aitech workflows with Intelligent Security for AITECH. This intelligent platform delivers data fabric through advanced automation and AI.
          </p>
