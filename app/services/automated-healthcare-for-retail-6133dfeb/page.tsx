...
export const metadata: Metadata = {
  title: 'Automated Healthcare for Retail',
  description: 'Next-generation retail solution: Automated Healthcare for Retail. Combines data processing with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-healthcare-for-retail-6133dfeb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Healthcare for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation retail solution: Automated Healthcare for Retail. Combines data processing with adaptive intelligence for optimal results.
          </p>
