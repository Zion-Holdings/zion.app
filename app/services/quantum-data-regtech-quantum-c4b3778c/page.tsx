...
export const metadata: Metadata = {
  title: 'Quantum Data - REGTECH Quantum',
  description: 'Enhance your regtech business with Quantum Data - REGTECH Quantum. Our solution provides event-driven architecture with enterprise-grade reliability and securit',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Data - REGTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your regtech business with Quantum Data - REGTECH Quantum. Our solution provides event-driven architecture with enterprise-grade reliability and security.
          </p>
