...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time sensor fusion, Predictive simulation engine, What-if scenario modeling, Automated optimization recommendations, 3D visualization, PLC/SCADA integration, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Digital Twin Factory Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Build and deploy digital twins for manufacturing: real-time sensor fusion, predictive simulation, what-if scenario modeling, and automated optimization recommendations.</p>
        ...
        <li class="text-slate-300">Real-time sensor fusion</li>
        <li class="text-slate-300">Predictive simulation engine</li>
        <li class="text-slate-300">What-if scenario modeling</li>
        <li class="text-slate-300">Automated optimization recommendations</li>
        <li class="text-slate-300">3D visualization</li>
        <li class="text-slate-300">PLC/SCADA integration</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce downtime by 45%</li>
        <li class="text-slate-300">Optimize yield by 15%</li>
        <li class="text-slate-300">Test changes virtually first</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">4499</p>
              <p class="text-sm text-slate-400">Most popular</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              <h3 class="font-semibold text-white mb-2">Enterprise</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">14999</p>
