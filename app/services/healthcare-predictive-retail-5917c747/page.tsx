...
export const metadata: Metadata = {
  title: 'Healthcare Predictive - Retail',
  description: 'Drive innovation in retail with Healthcare Predictive - Retail. This AI-powered platform transforms root cause analysis into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/healthcare-predictive-retail-5917c747',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Healthcare Predictive - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in retail with Healthcare Predictive - Retail. This AI-powered platform transforms root cause analysis into a competitive advantage.
          </p>
