...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={@context: "https://schema.org", @type: "Service", name: "Database Migration Service | Zion Tech Group", description: "End-to-end database migration service services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/database-migration-service-2026-7368/"} />
