...
export const metadata: Metadata = {
  ...
  keywords: 'ATS optimization scoring, Job description analysis, Industry-specific templates, Cover letter generation, Skills gap analysis, LinkedIn profile optimization, Multi-format export (PDF, Word, LaTeX), Version history, micro-saas, HR Tech, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Resume &amp; Cover Letter Builder</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered resume and cover letter builder with ATS optimization, industry-specific templates, and real-time scoring. Analyzes job descriptions to tailor applications automatically.</p>
        ...
        <li class="text-slate-300">ATS optimization scoring</li>
        <li class="text-slate-300">Job description analysis</li>
        <li class="text-slate-300">Industry-specific templates</li>
        <li class="text-slate-300">Cover letter generation</li>
        <li class="text-slate-300">Skills gap analysis</li>
        <li class="text-slate-300">LinkedIn profile optimization</li>
        <li class="text-slate-300">Multi-format export (PDF, Word, LaTeX)</li>
        <li class="text-slate-300">Version history</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">3x more interview callbacks</li>
        <li class="text-slate-300">ATS pass-through rate 95%+</li>
        <li class="text-slate-300">Personalized for each application</li>
        <li class="text-slate-300">50+ industry templates</li>
      </ul>
        </div>
