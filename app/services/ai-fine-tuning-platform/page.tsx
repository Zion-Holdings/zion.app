...
export const metadata: Metadata = {
  ...
  keywords: 'Managed fine-tuning pipelines, LoRA and QLoRA support, RLHF and DPO alignment, Model evaluation and A/B testing, Integration with HuggingFace, OpenAI, Dataset management and versioning, Cost optimization (spot instances), Model registry and deployment, ai, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Model Fine-Tuning Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Fine-tune LLMs and foundation models on your data. Managed training, RLHF, LoRA/QLoRA support, and model evaluation with A/B testing.</p>
        ...
        <li class="text-slate-300">Managed fine-tuning pipelines</li>
        <li class="text-slate-300">LoRA and QLoRA support</li>
        <li class="text-slate-300">RLHF and DPO alignment</li>
        <li class="text-slate-300">Model evaluation and A/B testing</li>
        <li class="text-slate-300">Integration with HuggingFace, OpenAI</li>
        <li class="text-slate-300">Dataset management and versioning</li>
        <li class="text-slate-300">Cost optimization (spot instances)</li>
        <li class="text-slate-300">Model registry and deployment</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Custom models for your domain</li>
        <li class="text-slate-300">10x cheaper than training from scratch</li>
        <li class="text-slate-300">Maintain data privacy</li>
        <li class="text-slate-300">Iterate quickly on model improvements</li>
      </ul>
        </div>
