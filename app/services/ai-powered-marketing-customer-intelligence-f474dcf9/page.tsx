...
export const metadata: Metadata = {
  title: "AI-Powered Marketing Customer Intelligence - AI-Powered Marketing Solution",
  description: "AI-powered marketing solution leveraging advanced machine learning for optimal performance and ROI.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-marketing-customer-intelligence-f474dcf9",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Marketing Customer Intelligence - AI-Powered Marketing Solution
        </h1>
