...
export const metadata: Metadata = {
  title: 'AI/IT Business Intelligence',
  description: 'Drive innovation in healthcare with AI/IT Business Intelligence. This AI-powered platform transforms security monitoring into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-business-intelligence-1766d5ce',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Business Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with AI/IT Business Intelligence. This AI-powered platform transforms security monitoring into a competitive advantage.
          </p>
