...
export const metadata = {
  ...
  alternates: { canonical: '/services/ai-msp-security-compliance-2026-6704/' },

  openGraph: {
    title: 'AI MSP Security Compliance | Zion Tech Group',
    description: 'End-to-end ai msp security compliance services: assessment, deployment, and managed operations.',
    url: 'https://ziontechgroup.com/services/ai-msp-security-compliance-2026-6704/',
...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "AI MSP Security Compliance | Zion Tech Group", description: "End-to-end ai msp security compliance services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/ai-msp-security-compliance-2026-6704/"}} />
