...
export const metadata: Metadata = {
  title: 'Smart Supply Platform - Hospitality',
  description: 'The future of hospitality is here with Smart Supply Platform - Hospitality. Powered by cutting-edge AI, this platform delivers social media monitoring like neve',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Supply Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Smart Supply Platform - Hospitality. Powered by cutting-edge AI, this platform delivers social media monitoring like never before.
          </p>
