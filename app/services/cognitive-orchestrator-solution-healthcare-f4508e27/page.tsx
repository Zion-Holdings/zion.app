...
export const metadata: Metadata = {
  ...
  description: 'Future-proof your healthcare with Cognitive Orchestrator Solution - Healthcare. Our autonomous solution handles personalization engine end-to-end without human ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-orchestrator-solution-healthcare-f4508e27',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your healthcare with Cognitive Orchestrator Solution - Healthcare. Our autonomous solution handles personalization engine end-to-end without human intervention.
          </p>
