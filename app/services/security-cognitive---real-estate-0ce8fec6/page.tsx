...
export const metadata: Metadata = {
  title: 'Security Cognitive - Real-Estate',
  description: 'Revolutionize real-estate through intelligent automation. Our Security Cognitive - Real-Estate leverages advanced machine learning to deliver quality control at',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Cognitive - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our Security Cognitive - Real-Estate leverages advanced machine learning to deliver quality control at scale.
          </p>
