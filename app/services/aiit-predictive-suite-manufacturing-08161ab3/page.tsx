...
export const metadata: Metadata = {
  title: 'AI/IT Predictive Suite - Manufacturing',
  description: 'Enhance your manufacturing business with AI/IT Predictive Suite - Manufacturing. Our solution provides ml model training with enterprise-grade reliability and s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-predictive-suite-manufacturing-08161ab3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Predictive Suite - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your manufacturing business with AI/IT Predictive Suite - Manufacturing. Our solution provides ml model training with enterprise-grade reliability and security.
          </p>
