...
export const metadata: Metadata = {
  title: 'Cognitive Data Solution - Retail',
  description: 'The future of retail is here with Cognitive Data Solution - Retail. Powered by cutting-edge AI, this platform delivers user experience like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-data-solution-retail-28eec6aa',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Data Solution - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Cognitive Data Solution - Retail. Powered by cutting-edge AI, this platform delivers user experience like never before.
          </p>
