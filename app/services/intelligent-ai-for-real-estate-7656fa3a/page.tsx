...
export const metadata: Metadata = {
  title: 'Intelligent AI for Real-Estate',
  description: 'Optimize your real-estate workflows with Intelligent AI for Real-Estate. This intelligent platform delivers customer service automation through advanced automat',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-ai-for-real-estate-7656fa3a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent AI for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your real-estate workflows with Intelligent AI for Real-Estate. This intelligent platform delivers customer service automation through advanced automation and AI.
          </p>
