...
export const metadata: Metadata = {
  ...
  keywords: 'Simultaneous interpretation across 40+ languages and dialects per meeting, Live bilingual captions with per-speaker timestamped transcript, Cultural-adaptation annotations including politeness norms and idiom equivalents, Silent-watch spectator mode and executive summary auto-generated after each call, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cross-Lingual Meeting Bridge</h1>
        <p className="text-lg text-slate-300 mb-8">Multi-language meeting platform: real-time simultaneous interpretation across 40+ languages and dialects, live bilingual captions, cultural-adaptation annotations, silent-watch spectator mode, executive summary auto-generation.</p>
        ...
        <li class="text-slate-300">Simultaneous interpretation across 40+ languages and dialects per meeting</li>
        <li class="text-slate-300">Live bilingual captions with per-speaker timestamped transcript</li>
        <li class="text-slate-300">Cultural-adaptation annotations including politeness norms and idiom equivalents</li>
        <li class="text-slate-300">Silent-watch spectator mode and executive summary auto-generated after each call</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with cross-lingual meeting bridge</li>
