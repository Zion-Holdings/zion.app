...
export const metadata: Metadata = {
  title: 'Intelligent real estate-proptech',
  description: 'The future of proptech is here with Intelligent real estate-proptech. Powered by cutting-edge AI, this platform delivers churn prediction like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-real-estate-proptech-69096756',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent real estate-proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with Intelligent real estate-proptech. Powered by cutting-edge AI, this platform delivers churn prediction like never before.
          </p>
