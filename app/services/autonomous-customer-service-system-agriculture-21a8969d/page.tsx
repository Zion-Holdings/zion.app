...
export const metadata: Metadata = {
  title: 'Autonomous Customer Service System - Agriculture',
  description: 'Enhance your agriculture business with Autonomous Customer Service System - Agriculture. Our solution provides user experience with enterprise-grade reliability',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Customer Service System - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your agriculture business with Autonomous Customer Service System - Agriculture. Our solution provides user experience with enterprise-grade reliability and security.
          </p>
