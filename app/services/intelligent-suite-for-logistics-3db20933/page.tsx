...
export const metadata: Metadata = {
  title: 'Intelligent Suite for Logistics',
  description: 'Transform your logistics operations with our Intelligent Suite for Logistics. This AI-driven solution automates master data management with unprecedented accura',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-suite-for-logistics-3db20933',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Suite for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Intelligent Suite for Logistics. This AI-driven solution automates master data management with unprecedented accuracy and efficiency.
          </p>
