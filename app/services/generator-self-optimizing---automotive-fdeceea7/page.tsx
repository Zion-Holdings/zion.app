...
export const metadata = {
  ...
  description: "Revolutionize Automotive through intelligent automation. Our Generator Self-Optimizing - Automotive leverages advanced machine learning to deliver supply chain ",
  alternates: {
