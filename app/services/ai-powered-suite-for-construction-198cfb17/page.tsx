...
export const metadata: Metadata = {
  title: 'AI-Powered Suite for Construction',
  description: 'Next-generation construction solution: AI-Powered Suite for Construction. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-suite-for-construction-198cfb17',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Suite for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: AI-Powered Suite for Construction. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
