...
export const metadata: Metadata = {
  ...
  keywords: 'Text-to-3D scene generation, Image-to-3D scene interpretation, PBR material and lighting generation, Style control (realistic, stylized, low-poly), LOD generation for games, Export to GLTF, FBX, USDZ, OBJ, API for batch scene generation, ai, Media, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI 3D Scene Generator</h1>
        <p className="text-lg text-slate-300 mb-8">Generate 3D scenes and environments from text or images for games, AR/VR, and architecture. PBR materials, lighting, and export to major 3D formats.</p>
        ...
        <li class="text-slate-300">Text-to-3D scene generation</li>
        <li class="text-slate-300">Image-to-3D scene interpretation</li>
        <li class="text-slate-300">PBR material and lighting generation</li>
        <li class="text-slate-300">Style control (realistic, stylized, low-poly)</li>
        <li class="text-slate-300">LOD generation for games</li>
        <li class="text-slate-300">Export to GLTF, FBX, USDZ, OBJ</li>
        <li class="text-slate-300">API for batch scene generation</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Generate 3D environments in minutes</li>
        <li class="text-slate-300">Style control for different use cases</li>
        <li class="text-slate-300">LOD generation for game optimization</li>
        <li class="text-slate-300">Multi-format export for any engine</li>
      </ul>
        </div>
