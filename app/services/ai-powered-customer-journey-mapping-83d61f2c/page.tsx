...
export const metadata: Metadata = {
  ...
  description: 'Visualizes and optimizes customer journeys using behavioral analytics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-customer-journey-mapping-83d61f2c',
  },

export const metadata = {
  title: "AI-Powered Customer Journey Mapping - Zion Tech Group",
  description: "Visualizes and optimizes customer journeys using behavioral analytics.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-customer-journey-mapping-83d61f2c`
  }
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Visualizes and optimizes customer journeys using behavioral analytics.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your marketing operations?</p>
    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">AI-Powered Customer Journey Mapping</h1>
        <p className="text-lg text-gray-300 mb-8">Visualizes and optimizes customer journeys using behavioral analytics.</p>
        
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          <h2 className="text-2xl font-semibold mb-4">Key Features</h2>
          <ul className="list-disc list-inside space-y-2">
            <li>Journey visualization</li>
