...
export const metadata: Metadata = {
  title: 'Predictive Automation for Logistics',
  description: 'Enhance your logistics business with Predictive Automation for Logistics. Our solution provides net promoter score with enterprise-grade reliability and securit',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-automation-for-logistics-a8587351',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Automation for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with Predictive Automation for Logistics. Our solution provides net promoter score with enterprise-grade reliability and security.
          </p>
