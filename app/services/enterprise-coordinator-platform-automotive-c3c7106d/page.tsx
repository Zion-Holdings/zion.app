...
export const metadata: Metadata = {
  title: 'Enterprise Coordinator Platform - Automotive',
  description: 'Hyper-accelerated automotive solution: Enterprise Coordinator Platform - Automotive. Combines contract analysis with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-coordinator-platform-automotive-c3c7106d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Coordinator Platform - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated automotive solution: Enterprise Coordinator Platform - Automotive. Combines contract analysis with next-gen AI for maximum velocity.
          </p>
