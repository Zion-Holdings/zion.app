...
export const metadata: Metadata = {
  title: 'Smart Performance Platform - Healthcare',
  description: 'Enhance your healthcare business with Smart Performance Platform - Healthcare. Our solution provides threat detection with enterprise-grade reliability and secu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-performance-platform-healthcare-3daa8b20',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Performance Platform - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with Smart Performance Platform - Healthcare. Our solution provides threat detection with enterprise-grade reliability and security.
          </p>
