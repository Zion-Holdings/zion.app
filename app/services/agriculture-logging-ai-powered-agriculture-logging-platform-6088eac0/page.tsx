...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://ziontechgroup.com/services/agriculture-logging-ai-powered-agriculture-logging-platform-6088eac0",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Agriculture Logging Platform - AI-Powered Agriculture Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          AI-Powered Agriculture Logging Platform for Agriculture - Delivers Scalable solutions results with AI-driven automation. Boost efficiency, reduce costs, and acc
        </p>
