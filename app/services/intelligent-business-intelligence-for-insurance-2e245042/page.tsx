...
export const metadata: Metadata = {
  title: 'Intelligent Business Intelligence for Insurance',
  description: 'Enhance your insurance business with Intelligent Business Intelligence for Insurance. Our solution provides fraud prevention with enterprise-grade reliability a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-business-intelligence-for-insurance-2e245042',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Business Intelligence for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Intelligent Business Intelligence for Insurance. Our solution provides fraud prevention with enterprise-grade reliability and security.
          </p>
