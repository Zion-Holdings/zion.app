...
export const metadata: Metadata = {
  title: 'Appointment Scheduling Multi-Cloud Cost Management Platform',
  description: 'appointment scheduling solution for paper & pulp industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/appointment-scheduling-multi-cloud-cost-management-platform-8c74c5ca',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Appointment Scheduling Multi-Cloud Cost Management Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            appointment scheduling solution for paper & pulp industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.
          </p>
