...
export const metadata: Metadata = {
  title: 'AI-Powered platform-insurance',
  description: 'Revolutionize insurance through intelligent automation. Our AI-Powered platform-insurance leverages advanced machine learning to deliver budget optimization at ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-platform-insurance-4be2cc2f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered platform-insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our AI-Powered platform-insurance leverages advanced machine learning to deliver budget optimization at scale.
          </p>
