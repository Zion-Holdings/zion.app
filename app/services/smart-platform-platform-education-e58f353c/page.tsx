...
export const metadata: Metadata = {
  title: 'Smart Platform Platform - Education',
  description: 'Transform your education operations with our Smart Platform Platform - Education. This AI-driven solution automates resource utilization with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-platform-platform-education-e58f353c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Platform Platform - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your education operations with our Smart Platform Platform - Education. This AI-driven solution automates resource utilization with unprecedented accuracy and efficiency.
          </p>
