...
export const metadata: Metadata = {
  title: 'Smart Contract Suite - Agriculture',
  description: 'Transform agriculture with Smart Contract Suite - Agriculture - the intelligent automation platform that learns, adapts, and delivers 10x results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-contract-suite-agriculture-20fbf785',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Contract Suite - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform agriculture with Smart Contract Suite - Agriculture - the intelligent automation platform that learns, adapts, and delivers 10x results.
          </p>
