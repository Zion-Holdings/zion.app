...
export const metadata: Metadata = {
  title: 'AI-Powered Supply for Education',
  description: 'Transform your education operations with our AI-Powered Supply for Education. This AI-driven solution automates risk assessment with unprecedented accuracy and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-supply-for-education-4e63943d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Supply for Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your education operations with our AI-Powered Supply for Education. This AI-driven solution automates risk assessment with unprecedented accuracy and efficiency.
          </p>
