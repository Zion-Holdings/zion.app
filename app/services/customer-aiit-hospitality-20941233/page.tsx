...
export const metadata: Metadata = {
  title: 'Customer AI/IT - Hospitality',
  description: 'Optimize your hospitality workflows with Customer AI/IT - Hospitality. This intelligent platform delivers sustainability tracking through advanced automation an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/customer-aiit-hospitality-20941233',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Customer AI/IT - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Customer AI/IT - Hospitality. This intelligent platform delivers sustainability tracking through advanced automation and AI.
          </p>
