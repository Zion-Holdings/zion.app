...
export const metadata: Metadata = {
  ...
  keywords: 'Statistically faithful synthetic data generation, GDPR & HIPAA compliance by design, Multivariate distribution preservation, Relational integrity across linked tables, Differential privacy guarantees, Tabular, time-series, and image data support, Quality metrics & fidelity scoring, API-first with Python SDK & CLI, ai, Data Science, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Generate privacy-safe, statistically faithful synthetic datasets for ML model training and testing. Preserves multivariate distributions and relational integrity — fully GDPR- and HIPAA-compliant so you can innovate without exposing real PII.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">ai</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">Data Science</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Statistically faithful synthetic data generation</li>
        <li class="text-slate-300">GDPR &amp; HIPAA compliance by design</li>
        <li class="text-slate-300">Multivariate distribution preservation</li>
        <li class="text-slate-300">Relational integrity across linked tables</li>
        <li class="text-slate-300">Differential privacy guarantees</li>
        <li class="text-slate-300">Tabular, time-series, and image data support</li>
        <li class="text-slate-300">Quality metrics &amp; fidelity scoring</li>
        <li class="text-slate-300">API-first with Python SDK &amp; CLI</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Train ML models without real data risk</li>
        <li class="text-slate-300">Share datasets across teams and borders freely</li>
        <li class="text-slate-300">Accelerate development with unlimited test data</li>
        <li class="text-slate-300">Pass privacy audits with mathematical guarantees</li>
      </ul>
        </div>
