...
export const metadata: Metadata = {
  title: 'Autonomous Cost Cloud',
  description: 'Drive innovation in finance with Autonomous Cost Cloud. This AI-powered platform transforms employee engagement into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-cost-cloud-5c4c0e00',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Cost Cloud
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in finance with Autonomous Cost Cloud. This AI-powered platform transforms employee engagement into a competitive advantage.
          </p>
