...
export const metadata: Metadata = {
  ...
  description: 'Transform your legal operations with our Smart Generator Solution. This ai solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-generator-solution-2cd47',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Smart Generator Solution. This ai solution delivers unprecedented automation and intelligence.
          </p>
