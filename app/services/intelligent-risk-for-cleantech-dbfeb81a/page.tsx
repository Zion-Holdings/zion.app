...
export const metadata: Metadata = {
  title: 'Intelligent Risk for CLEANTECH',
  description: 'Enhance your cleantech business with Intelligent Risk for CLEANTECH. Our solution provides reporting automation with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-risk-for-cleantech-dbfeb81a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Risk for CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your cleantech business with Intelligent Risk for CLEANTECH. Our solution provides reporting automation with enterprise-grade reliability and security.
          </p>
