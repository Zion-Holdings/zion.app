...
export const metadata: Metadata = {
  title: 'Predictive Risk for Hospitality',
  description: 'Next-generation hospitality solution: Predictive Risk for Hospitality. Combines predictive analytics with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-risk-for-hospitality-fc4236b5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Risk for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Predictive Risk for Hospitality. Combines predictive analytics with adaptive intelligence for optimal results.
          </p>
