...
export const metadata: Metadata = {
  title: 'Smart Data for Media',
  description: 'The future of media is here with Smart Data for Media. Powered by cutting-edge AI, this platform delivers image recognition like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-data-for-media-1f721211',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Data for Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of media is here with Smart Data for Media. Powered by cutting-edge AI, this platform delivers image recognition like never before.
          </p>
