...
export const metadata: Metadata = {
  title: 'Intelligent Healthcare for Energy',
  description: 'The future of energy is here with Intelligent Healthcare for Energy. Powered by cutting-edge AI, this platform delivers pipeline management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-healthcare-for-energy-984f9621',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Healthcare for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Intelligent Healthcare for Energy. Powered by cutting-edge AI, this platform delivers pipeline management like never before.
          </p>
