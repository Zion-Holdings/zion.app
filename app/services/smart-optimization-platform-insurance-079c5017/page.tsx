...
export const metadata: Metadata = {
  title: 'Smart Optimization Platform - Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Smart Optimization Platform - Insurance leverages advanced machine learning to deliver workflow mana',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-optimization-platform-insurance-079c5017',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Optimization Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Smart Optimization Platform - Insurance leverages advanced machine learning to deliver workflow management at scale.
          </p>
