...
export const metadata: Metadata = {
  ...
  description: 'Personalized product and content recommendations for e-commerce and media.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-recommendation-engine-35b516cf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Personalized product and content recommendations for e-commerce and media.
          </p>
