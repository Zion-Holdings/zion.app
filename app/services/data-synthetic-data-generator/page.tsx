  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Synthetic Data Generator &amp; Privacy Shield</h1>
        <p className="text-lg text-slate-300 mb-8">Generative synthetic data platform for ML training, software testing, and GDPR/CCPA privacy compliance: maintains statistical distributions of real data while producing 100% synthetic records that pass all real-world QA and validation tests without human PII.</p>
        ...
        <li class="text-slate-300">Generative tabular model: preserves statistical distributions and edge-cases from real data</li>
        <li class="text-slate-300">PII-free guarantee: no real person IDs, SSNs, phone numbers, addresses, or credit card numbers in output</li>
        <li class="text-slate-300">Edge-case preservation: rare events, outliers, null patterns and multi-filed relationship preserved statistically</li>
        <li class="text-slate-300">Schema evolution: same generator continues generating data from updated schema as schema evolves</li>
        <li class="text-slate-300">SDV + CTGAN engine: zero-code, point-and-click configuration or full Python API</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with synthetic data generator &amp; privacy shield</li>
