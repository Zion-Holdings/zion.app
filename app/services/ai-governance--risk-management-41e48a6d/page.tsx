...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-governance--risk-management-41e48a6d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Model inventory and risk classification</li>
          <li className="text-gray-300">Bias review and fairness</li>
          <li className="text-gray-300">Governance approvals</li>
          <li className="text-gray-300">Regulatory evidence</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <li className="text-purple-300">Create audit-ready AI evidence</li>
          </ul>
        </section>
