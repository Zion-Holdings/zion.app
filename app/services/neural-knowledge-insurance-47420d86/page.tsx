...
export const metadata: Metadata = {
  title: 'Neural knowledge-insurance',
  description: 'Optimize your insurance workflows with Neural knowledge-insurance. This intelligent platform delivers record extraction through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-knowledge-insurance-47420d86',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural knowledge-insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Neural knowledge-insurance. This intelligent platform delivers record extraction through advanced automation and AI.
          </p>
