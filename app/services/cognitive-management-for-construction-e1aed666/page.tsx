...
export const metadata: Metadata = {
  title: 'Cognitive Management for Construction',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Management for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Cognitive Management for Construction leverages advanced machine learning to deliver risk assessment at scale.
          </p>
