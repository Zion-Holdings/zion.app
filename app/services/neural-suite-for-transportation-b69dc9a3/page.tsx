...
export const metadata: Metadata = {
  title: 'Neural Suite for Transportation',
  description: 'Enhance your transportation business with Neural Suite for Transportation. Our solution provides forecast accuracy with enterprise-grade reliability and securit',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-suite-for-transportation-b69dc9a3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Suite for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with Neural Suite for Transportation. Our solution provides forecast accuracy with enterprise-grade reliability and security.
          </p>
