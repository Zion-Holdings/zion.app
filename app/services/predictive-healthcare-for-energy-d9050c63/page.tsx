...
export const metadata: Metadata = {
  title: 'Predictive Healthcare for Energy',
  description: 'Next-generation energy solution: Predictive Healthcare for Energy. Combines document processing with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-healthcare-for-energy-d9050c63',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Healthcare for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Predictive Healthcare for Energy. Combines document processing with adaptive intelligence for optimal results.
          </p>
