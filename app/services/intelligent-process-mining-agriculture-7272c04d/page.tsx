...
export const metadata: Metadata = {
  title: 'Intelligent process mining-agriculture',
  description: 'Drive innovation in agriculture with Intelligent process mining-agriculture. This AI-powered platform transforms regulatory tracking into a competitive advantag',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent process mining-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in agriculture with Intelligent process mining-agriculture. This AI-powered platform transforms regulatory tracking into a competitive advantage.
          </p>
