...
export const metadata: Metadata = {
  title: 'Adaptive Real Estate for Construction #3',
  description: 'The future of construction is here with Adaptive Real Estate for Construction #3. Powered by cutting-edge AI, this platform delivers inventory management like n',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Real Estate for Construction #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Adaptive Real Estate for Construction #3. Powered by cutting-edge AI, this platform delivers inventory management like never before.
          </p>
