...
export const metadata: Metadata = {
  title: 'Cognitive Analyzer Solution - Construction',
  description: 'Drive innovation in construction with Cognitive Analyzer Solution - Construction. This AI-powered platform transforms influencer identification into a competiti',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-analyzer-solution-construction-7b86aee4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Analyzer Solution - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Cognitive Analyzer Solution - Construction. This AI-powered platform transforms influencer identification into a competitive advantage.
          </p>
