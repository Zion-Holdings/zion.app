...
export const metadata: Metadata = {
  title: 'Next-Gen Analyzer for Insurance',
  description: 'Quantum leap forward for insurance: Next-Gen Analyzer for Insurance. Uses quantum-inspired algorithms to deliver demand planning at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-analyzer-for-insurance-8821575a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Analyzer for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for insurance: Next-Gen Analyzer for Insurance. Uses quantum-inspired algorithms to deliver demand planning at exponential speed.
          </p>
