...
export const metadata: Metadata = {
  title: 'Campaign Management AI-Powered Security Auditing',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Campaign Management AI-Powered Security Auditing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered campaign management solution for security. Continuous security auditing with automated compliance reporting.
          </p>
