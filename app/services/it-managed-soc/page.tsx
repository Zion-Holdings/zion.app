...
export const metadata: Metadata = {
  ...
  keywords: '24x7 SIEM + correlation + threat hunting, 50+ threat-intel feeds + IOC auto-block, Incident response + managed alert triage, Monthly exec cyber risk report + trend dashboard, security, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Managed SOC + Threat Intelligence as a Service</h1>
        <p className="text-lg text-slate-300 mb-8">24x7 managed SOC: SIEM event correlation threat hunting from 50+ feeds incident response managed alert triage monthly executive cyber risk report compliance evidence B2B enterprise.</p>
        ...
        <li class="text-slate-300">24x7 SIEM + correlation + threat hunting</li>
        <li class="text-slate-300">50+ threat-intel feeds + IOC auto-block</li>
        <li class="text-slate-300">Incident response + managed alert triage</li>
        <li class="text-slate-300">Monthly exec cyber risk report + trend dashboard</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with managed soc + threat intelligence as a service</li>
