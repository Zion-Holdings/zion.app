...
export const metadata: Metadata = {
  title: 'Next-Gen Supply for MARTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Supply for MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your martech business with Next-Gen Supply for MARTECH. Our solution provides procurement automation with enterprise-grade reliability and security.
          </p>
