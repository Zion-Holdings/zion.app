...
export const metadata = {
  ...
  description: "AI-powered pricing optimization for e-commerce and SaaS. Analyzes competitor pricing, demand elasticity, and customer segments to recommend optimal prices that ",
  alternates: {
