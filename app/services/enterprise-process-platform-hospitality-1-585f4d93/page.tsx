...
export const metadata: Metadata = {
  title: 'Enterprise Process Platform - Hospitality #1',
  description: 'Revolutionize hospitality through intelligent automation. Our Enterprise Process Platform - Hospitality #1 leverages advanced machine learning to deliver custom',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-process-platform-hospitality-1-585f4d93',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Process Platform - Hospitality #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Enterprise Process Platform - Hospitality #1 leverages advanced machine learning to deliver customer onboarding at scale.
          </p>
