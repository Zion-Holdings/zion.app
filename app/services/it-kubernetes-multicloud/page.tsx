...
export const metadata: Metadata = {
  ...
  keywords: 'Cluster lifecycle automation, Cost allocation per namespace, Security policy as code (OPA/Gatekeeper), Cross-cloud service mesh, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Kubernetes Multi-Cloud Management</h1>
        <p className="text-lg text-slate-300 mb-8">Deploy and manage Kubernetes clusters across AWS, GCP, Azure, and on-prem with a single control plane. Includes GitOps and policy enforcement.</p>
        ...
        <li class="text-slate-300">Cluster lifecycle automation</li>
        <li class="text-slate-300">Cost allocation per namespace</li>
        <li class="text-slate-300">Security policy as code (OPA/Gatekeeper)</li>
        <li class="text-slate-300">Cross-cloud service mesh</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with kubernetes multi-cloud management</li>
