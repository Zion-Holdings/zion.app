...
export const metadata: Metadata = {
  title: 'Smart Knowledge Platform - CLEANTECH',
  description: 'Quantum leap forward for cleantech: Smart Knowledge Platform - CLEANTECH. Uses quantum-inspired algorithms to deliver sustainability tracking at exponential spe',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-knowledge-platform-cleantech-f031ae96',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Knowledge Platform - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for cleantech: Smart Knowledge Platform - CLEANTECH. Uses quantum-inspired algorithms to deliver sustainability tracking at exponential speed.
          </p>
