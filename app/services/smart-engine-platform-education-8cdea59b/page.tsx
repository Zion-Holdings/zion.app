...
export const metadata: Metadata = {
  title: 'Smart Engine Platform - Education',
  description: 'The future of education is here with Smart Engine Platform - Education. Powered by cutting-edge AI, this platform delivers customer onboarding like never before',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-engine-platform-education-8cdea59b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Engine Platform - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of education is here with Smart Engine Platform - Education. Powered by cutting-edge AI, this platform delivers customer onboarding like never before.
          </p>
