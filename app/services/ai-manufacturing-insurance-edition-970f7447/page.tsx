...
export const metadata: Metadata = {
  title: 'AI Manufacturing - Insurance Edition',
  description: 'The future of insurance is here with AI Manufacturing - Insurance Edition. Powered by cutting-edge AI, this platform delivers transformative results like never ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-manufacturing-insurance-edition-970f7447',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Manufacturing - Insurance Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with AI Manufacturing - Insurance Edition. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
