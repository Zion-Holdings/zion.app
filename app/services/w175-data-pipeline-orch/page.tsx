...
export const metadata: Metadata = {
  ...
  keywords: 'Managed Airflow, Dagster, or Prefect, Pipeline monitoring and SLA tracking, Error alerting and retry logic, Backfill and catchup management, Pipeline dependency visualization, Resource optimization and scaling, Integration with Snowflake, BigQuery, dbt, data, Data Engineering, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Data Pipeline Orchestration</h1>
        <p className="text-lg text-slate-300 mb-8">Managed data pipeline orchestration: Airflow, Dagster, or Prefect with monitoring, alerting, and backfill support. Schedule, monitor, and troubleshoot pipelines.</p>
        ...
        <li class="text-slate-300">Managed Airflow, Dagster, or Prefect</li>
        <li class="text-slate-300">Pipeline monitoring and SLA tracking</li>
        <li class="text-slate-300">Error alerting and retry logic</li>
        <li class="text-slate-300">Backfill and catchup management</li>
        <li class="text-slate-300">Pipeline dependency visualization</li>
        <li class="text-slate-300">Resource optimization and scaling</li>
        <li class="text-slate-300">Integration with Snowflake, BigQuery, dbt</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Managed orchestration without operational burden</li>
        <li class="text-slate-300">SLA tracking keeps pipelines on schedule</li>
        <li class="text-slate-300">Backfill handles data reprocessing</li>
        <li class="text-slate-300">Dependency visualization for impact analysis</li>
      </ul>
        </div>
