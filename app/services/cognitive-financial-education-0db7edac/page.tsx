...
export const metadata: Metadata = {
  title: 'Cognitive financial-education',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated education solution: Cognitive financial-education. Combines cost tracking with next-gen AI for maximum velocity.
          </p>
