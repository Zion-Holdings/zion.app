...
export const metadata: Metadata = {
  ...
  keywords: 'Carbon intensity forecasting per region, Job scheduling to low-carbon time windows, Resource right-sizing recommendations, Sustainability KPI dashboards, Compliance with ESG reporting standards, ai, Sustainability, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI for Sustainable Operations (Green AI)</h1>
        <p className="text-lg text-slate-300 mb-8">Optimize compute &amp; cloud resource usage to reduce carbon footprint: model carbon-aware scheduling, energy profiling, and sustainability reporting.</p>
        ...
        <li class="text-slate-300">Carbon intensity forecasting per region</li>
        <li class="text-slate-300">Job scheduling to low-carbon time windows</li>
        <li class="text-slate-300">Resource right-sizing recommendations</li>
        <li class="text-slate-300">Sustainability KPI dashboards</li>
        <li class="text-slate-300">Compliance with ESG reporting standards</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai for sustainable operations (green ai)</li>
