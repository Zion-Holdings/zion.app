...
export const metadata: Metadata = {
  ...
  keywords: 'Control mapping (PCI DSS 4.0), Automated evidence collection, Vulnerability scanning integration, Quarterly assessment workflow, Executive dashboards, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">PCI DSS Compliance Suite</h1>
        <p className="text-lg text-slate-300 mb-8">Automated PCI DSS v4.0 compliance monitoring, evidence collection, and reporting. Pre-built controls for 400+ requirements.</p>
        ...
        <li class="text-slate-300">Control mapping (PCI DSS 4.0)</li>
        <li class="text-slate-300">Automated evidence collection</li>
        <li class="text-slate-300">Vulnerability scanning integration</li>
        <li class="text-slate-300">Quarterly assessment workflow</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with pci dss compliance suite</li>
