...
export const metadata: Metadata = {
  title: 'Cognitive Risk for Agriculture',
  description: 'Drive innovation in agriculture with Cognitive Risk for Agriculture. This AI-powered platform transforms quota optimization into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-risk-for-agriculture-a8c5ebd7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Risk for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in agriculture with Cognitive Risk for Agriculture. This AI-powered platform transforms quota optimization into a competitive advantage.
          </p>
