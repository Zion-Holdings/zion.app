export const metadata = {
  title: "Smart Supply Platform - Tech",
  description: "Zion Tech Group delivers Smart Supply Platform - Tech with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/services/smart-supply-platform-tech-9de5b021/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>Smart Supply Platform - Tech</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers Smart Supply Platform - Tech with measurable outcomes.
      </p>
