...
export const metadata: Metadata = {
  title: 'Intelligent Optimization for Sports',
  description: 'Optimize your sports workflows with Intelligent Optimization for Sports. This intelligent platform delivers survey automation through advanced automation and AI',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-optimization-for-sports-2d9cfe1e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Optimization for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your sports workflows with Intelligent Optimization for Sports. This intelligent platform delivers survey automation through advanced automation and AI.
          </p>
