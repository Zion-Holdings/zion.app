...
export const metadata: Metadata = {
  title: 'Automated Cognitive for Energy',
  description: 'Next-generation energy solution: Automated Cognitive for Energy. Combines business continuity with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-cognitive-for-energy-2ee1f333',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Cognitive for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Automated Cognitive for Energy. Combines business continuity with adaptive intelligence for optimal results.
          </p>
