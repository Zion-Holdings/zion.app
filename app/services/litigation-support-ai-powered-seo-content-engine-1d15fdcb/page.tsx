...
export const metadata: Metadata = {
  title: 'Litigation Support AI-Powered SEO Content Engine',
  description: 'litigation support solution for water & wastewater industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/litigation-support-ai-powered-seo-content-engine-1d15fdcb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Litigation Support AI-Powered SEO Content Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            litigation support solution for water & wastewater industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing copy.
          </p>
