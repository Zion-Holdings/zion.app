...
export const metadata: Metadata = {
  title: 'Next-Gen Automation for Telecom',
  description: 'Unlock unprecedented growth with Next-Gen Automation for Telecom. This autonomous system provides ai ethics with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-automation-for-telecom-8b496fcd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Automation for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Next-Gen Automation for Telecom. This autonomous system provides ai ethics with zero manual intervention needed.
          </p>
