...
export const metadata: Metadata = {
  ...
  keywords: 'Predictive coding, Privilege detection, Document clustering, Concept search, Relevance ranking, Integration with legal hold systems, Production and redaction tools, Case analytics, ai, Legal, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Legal E-Discovery Platform</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered electronic discovery for legal teams. Document review, privilege detection, and case strategy analytics with predictive coding.</p>
        ...
        <li class="text-slate-300">Predictive coding</li>
        <li class="text-slate-300">Privilege detection</li>
        <li class="text-slate-300">Document clustering</li>
        <li class="text-slate-300">Concept search</li>
        <li class="text-slate-300">Relevance ranking</li>
        <li class="text-slate-300">Integration with legal hold systems</li>
        <li class="text-slate-300">Production and redaction tools</li>
        <li class="text-slate-300">Case analytics</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce document review time by 80%</li>
        <li class="text-slate-300">Lower e-discovery costs</li>
        <li class="text-slate-300">Improve review accuracy</li>
        <li class="text-slate-300">Scale legal team capacity</li>
      </ul>
        </div>
