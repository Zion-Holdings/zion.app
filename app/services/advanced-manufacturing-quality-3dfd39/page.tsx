...
export const metadata: Metadata = {
  title: 'Advanced Manufacturing Quality Terraform (Hr)',
  description: 'Advanced Manufacturing Quality Terraform (Hr) is an AI-powered hr solution that transforms how businesses operate through intelligent automation and real-time a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/advanced-manufacturing-quality-3dfd39',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Advanced Manufacturing Quality Terraform (Hr)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Advanced Manufacturing Quality Terraform (Hr) is an AI-powered hr solution that transforms how businesses operate through intelligent automation and real-time analytics.
...
Python, Serverless, Docker, GCP, Kafka, React
