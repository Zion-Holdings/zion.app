...
export const metadata: Metadata = {
  title: 'Adaptive security-healthcare',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive security-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Adaptive security-healthcare. Combines budget tracking with adaptive intelligence for optimal results.
          </p>
