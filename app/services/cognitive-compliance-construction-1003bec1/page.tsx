...
export const metadata: Metadata = {
  title: 'Cognitive compliance-construction',
  description: 'Transform your construction operations with our Cognitive compliance-construction. This AI-driven solution provides intelligent automation with unprecedented ac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-compliance-construction-1003bec1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive compliance-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Cognitive compliance-construction. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
