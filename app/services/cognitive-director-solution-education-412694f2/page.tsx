...
export const metadata: Metadata = {
  title: 'Cognitive Director Solution - Education',
  description: 'Drive innovation in education with Cognitive Director Solution - Education. This AI-powered platform transforms disaster recovery into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-director-solution-education-412694f2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Director Solution - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in education with Cognitive Director Solution - Education. This AI-powered platform transforms disaster recovery into a competitive advantage.
          </p>
