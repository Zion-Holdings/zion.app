...
export const metadata: Metadata = {
  title: 'AI Optimizer - Insurance Edition',
  description: 'Transform your insurance operations with our AI Optimizer - Insurance Edition. This AI-driven solution automates energy management with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-optimizer-insurance-edition-7beff6b4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Optimizer - Insurance Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our AI Optimizer - Insurance Edition. This AI-driven solution automates energy management with unprecedented accuracy and efficiency.
          </p>
