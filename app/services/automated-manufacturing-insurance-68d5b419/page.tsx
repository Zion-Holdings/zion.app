...
export const metadata: Metadata = {
  title: 'Automated manufacturing-insurance',
  description: 'Enhance your insurance business with Automated manufacturing-insurance. Our solution provides threat detection with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-manufacturing-insurance-68d5b419',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated manufacturing-insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Automated manufacturing-insurance. Our solution provides threat detection with enterprise-grade reliability and security.
          </p>
