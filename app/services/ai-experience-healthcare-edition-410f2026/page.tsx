...
export const metadata: Metadata = {
  title: 'AI Experience - Healthcare Edition',
  description: 'Optimize your healthcare workflows with AI Experience - Healthcare Edition. This intelligent platform delivers customer insights through advanced automation and',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Experience - Healthcare Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with AI Experience - Healthcare Edition. This intelligent platform delivers customer insights through advanced automation and AI.
          </p>
