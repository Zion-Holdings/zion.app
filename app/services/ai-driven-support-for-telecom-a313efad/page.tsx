...
export const metadata: Metadata = {
  title: 'AI-Driven Support for Telecom',
  description: 'The future of telecom is here with AI-Driven Support for Telecom. Powered by cutting-edge AI, this platform delivers budget tracking like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-driven-support-for-telecom-a313efad',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Driven Support for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of telecom is here with AI-Driven Support for Telecom. Powered by cutting-edge AI, this platform delivers budget tracking like never before.
          </p>
