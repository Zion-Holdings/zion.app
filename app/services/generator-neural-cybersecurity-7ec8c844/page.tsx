...
export const metadata: Metadata = {
  title: 'Generator Neural - Cybersecurity',
  description: 'Enhance your cybersecurity business with Generator Neural - Cybersecurity. Our solution provides receipt processing with enterprise-grade reliability and securi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Generator Neural - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your cybersecurity business with Generator Neural - Cybersecurity. Our solution provides receipt processing with enterprise-grade reliability and security.
          </p>
