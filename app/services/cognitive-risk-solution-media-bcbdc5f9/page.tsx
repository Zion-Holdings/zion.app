...
export const metadata: Metadata = {
  title: 'Cognitive Risk Solution - Media',
  description: 'Optimize your media workflows with Cognitive Risk Solution - Media. This intelligent platform delivers budget tracking through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-risk-solution-media-bcbdc5f9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Risk Solution - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your media workflows with Cognitive Risk Solution - Media. This intelligent platform delivers budget tracking through advanced automation and AI.
          </p>
