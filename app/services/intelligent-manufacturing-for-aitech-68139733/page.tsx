...
export const metadata: Metadata = {
  title: 'Intelligent Manufacturing for AITECH',
  description: 'Hyper-accelerated aitech solution: Intelligent Manufacturing for AITECH. Combines expense reporting with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-manufacturing-for-aitech-68139733',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Manufacturing for AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated aitech solution: Intelligent Manufacturing for AITECH. Combines expense reporting with next-gen AI for maximum velocity.
          </p>
