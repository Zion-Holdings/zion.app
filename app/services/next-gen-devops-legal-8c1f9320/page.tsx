...
export const metadata: Metadata = {
  title: 'Next-Gen devops-legal',
  description: 'Enhance your legal business with Next-Gen devops-legal. Our solution provides project management with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-devops-legal-8c1f9320',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen devops-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Next-Gen devops-legal. Our solution provides project management with enterprise-grade reliability and security.
          </p>
