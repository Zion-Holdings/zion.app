...
export const metadata: Metadata = {
  title: 'Enterprise Analyzer Platform - REGTECH',
  description: 'Next-generation regtech solution: Enterprise Analyzer Platform - REGTECH. Combines financial planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-analyzer-platform-regtech-1be3dfc5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Analyzer Platform - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation regtech solution: Enterprise Analyzer Platform - REGTECH. Combines financial planning with adaptive intelligence for optimal results.
          </p>
