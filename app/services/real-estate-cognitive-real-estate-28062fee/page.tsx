...
export const metadata: Metadata = {
  title: 'Real Estate Cognitive - Real-Estate',
  description: 'Enhance your real-estate business with Real Estate Cognitive - Real-Estate. Our solution provides scenario planning with enterprise-grade reliability and securi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/real-estate-cognitive-real-estate-28062fee',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Real Estate Cognitive - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your real-estate business with Real Estate Cognitive - Real-Estate. Our solution provides scenario planning with enterprise-grade reliability and security.
          </p>
