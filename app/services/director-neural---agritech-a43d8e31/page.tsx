...
export const metadata: Metadata = {
  title: 'Director Neural - Agritech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Director Neural - Agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agritech through intelligent automation. Our Director Neural - Agritech leverages advanced machine learning to deliver predictive analytics at scale.
          </p>
