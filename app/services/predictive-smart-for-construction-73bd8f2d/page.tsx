...
export const metadata: Metadata = {
  title: 'Predictive Smart for Construction',
  description: 'Next-generation construction solution: Predictive Smart for Construction. Combines account planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-smart-for-construction-73bd8f2d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Smart for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Predictive Smart for Construction. Combines account planning with adaptive intelligence for optimal results.
          </p>
