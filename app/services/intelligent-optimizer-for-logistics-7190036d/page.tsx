...
export const metadata: Metadata = {
  title: 'Intelligent Optimizer for Logistics',
  description: 'Next-generation logistics solution: Intelligent Optimizer for Logistics. Combines personalization engine with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-optimizer-for-logistics-7190036d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Optimizer for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Intelligent Optimizer for Logistics. Combines personalization engine with adaptive intelligence for optimal results.
          </p>
