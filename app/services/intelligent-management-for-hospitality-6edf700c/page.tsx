...
export const metadata: Metadata = {
  title: 'Intelligent Management for Hospitality',
  description: 'Unlock unprecedented growth with Intelligent Management for Hospitality. This autonomous system provides serverless orchestration with zero manual intervention ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-management-for-hospitality-6edf700c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Management for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Management for Hospitality. This autonomous system provides serverless orchestration with zero manual intervention needed.
          </p>
