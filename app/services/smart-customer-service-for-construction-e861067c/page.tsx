...
export const metadata: Metadata = {
  title: 'Smart Customer Service for Construction',
  description: 'Unlock unprecedented growth with Smart Customer Service for Construction. This autonomous system provides security monitoring with zero manual intervention need',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-customer-service-for-construction-e861067c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Customer Service for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Customer Service for Construction. This autonomous system provides security monitoring with zero manual intervention needed.
          </p>
