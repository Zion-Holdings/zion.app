...
export const metadata: Metadata = {
  title: 'Smart Intelligence Suite - Sports',
  description: 'Transform sports with Smart Intelligence Suite - Sports - the intelligent automation platform that learns, adapts, and delivers 10x results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-intelligence-suite-sports-ff181833',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Intelligence Suite - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform sports with Smart Intelligence Suite - Sports - the intelligent automation platform that learns, adapts, and delivers 10x results.
          </p>
