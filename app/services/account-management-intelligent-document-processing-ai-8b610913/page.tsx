...
export const metadata: Metadata = {
  title: "Account Management Intelligent Document Processing AI - AI-Powered Maritime Solution",
  description: "account management solution for maritime industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatical",
  alternates: {
    canonical: "https://ziontechgroup.com/services/account-management-intelligent-document-processing-ai-8b610913",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Account Management Intelligent Document Processing AI - AI-Powered Maritime Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          account management solution for maritime industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatical
        </p>
