...
export const metadata: Metadata = {
  title: 'Medical Imaging Real-Time Data Pipeline Platform',
  description: 'medical imaging solution for arts & culture industry. Creates and manages real-time data pipelines with automated ETL and streaming analytics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/medical-imaging-real-time-data-pipeline-platform-d1f4e5bd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Medical Imaging Real-Time Data Pipeline Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            medical imaging solution for arts & culture industry. Creates and manages real-time data pipelines with automated ETL and streaming analytics.
          </p>
