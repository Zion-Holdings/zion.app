...
export const metadata: Metadata = {
  title: 'Explainable AI Intelligent Workflow Automation Engine',
  description: 'AI-powered explainable ai solution for workflow. AI-powered workflow automation that learns from user behavior to optimize processes.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/explainable-ai-intelligent-workflow-automation-engine-227b3c1f',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Explainable AI Intelligent Workflow Automation Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered explainable ai solution for workflow. AI-powered workflow automation that learns from user behavior to optimize processes.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your explainable ai operations?</p>
