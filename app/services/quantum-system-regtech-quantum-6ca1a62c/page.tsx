...
export const metadata: Metadata = {
  title: 'Quantum System - REGTECH Quantum',
  description: 'Drive innovation in regtech with Quantum System - REGTECH Quantum. This AI-powered platform transforms goal setting into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-system-regtech-quantum-6ca1a62c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum System - REGTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in regtech with Quantum System - REGTECH Quantum. This AI-powered platform transforms goal setting into a competitive advantage.
          </p>
