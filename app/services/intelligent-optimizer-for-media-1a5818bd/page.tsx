...
export const metadata: Metadata = {
  title: 'Intelligent Optimizer for Media',
  description: 'Drive innovation in media with Intelligent Optimizer for Media. This AI-powered platform transforms user experience into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-optimizer-for-media-1a5818bd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Optimizer for Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in media with Intelligent Optimizer for Media. This AI-powered platform transforms user experience into a competitive advantage.
          </p>
