...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Document - AITECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Document - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of aitech is here with Hyper-Accelerated Document - AITECH. Powered by cutting-edge AI, this platform delivers compensation management like never before.
          </p>
