...
export const metadata: Metadata = {
  title: 'Support Smart - Agriculture',
  description: 'Transform your agriculture operations with our Support Smart - Agriculture. This AI-driven solution automates user provisioning with unprecedented accuracy and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/support-smart-agriculture-e1c27ad2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Support Smart - Agriculture. This AI-driven solution automates user provisioning with unprecedented accuracy and efficiency.
          </p>
