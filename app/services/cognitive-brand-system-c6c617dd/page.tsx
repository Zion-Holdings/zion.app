...
export const metadata: Metadata = {
  title: 'Cognitive Brand System',
  description: 'Optimize your healthcare workflows with Cognitive Brand System. This intelligent platform delivers data pipeline orchestration through advanced automation and A',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-brand-system-c6c617dd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Brand System
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Cognitive Brand System. This intelligent platform delivers data pipeline orchestration through advanced automation and AI.
          </p>
