...
export const metadata: Metadata = {
  title: 'Automation Anywhere Customer Data Platform AI',
  description: 'AI-powered automation anywhere solution for customer data. Unified customer data platform with AI-powered segmentation.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automation-anywhere-customer-data-platform-ai-0efa000a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automation Anywhere Customer Data Platform AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered automation anywhere solution for customer data. Unified customer data platform with AI-powered segmentation.
          </p>
