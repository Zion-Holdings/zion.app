...
export const metadata: Metadata = {
  title: 'Smart Data Science Platform - Healthcare',
  description: 'Optimize your healthcare workflows with Smart Data Science Platform - Healthcare. This intelligent platform delivers brand monitoring through advanced automatio',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-data-science-platform-healthcare-1262b41c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Data Science Platform - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Smart Data Science Platform - Healthcare. This intelligent platform delivers brand monitoring through advanced automation and AI.
          </p>
