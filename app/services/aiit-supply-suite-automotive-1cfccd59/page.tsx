...
export const metadata: Metadata = {
  title: 'AI/IT Supply Suite - Automotive',
  description: 'The future of automotive is here with AI/IT Supply Suite - Automotive. Powered by cutting-edge AI, this platform delivers inventory optimization like never befo',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Supply Suite - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of automotive is here with AI/IT Supply Suite - Automotive. Powered by cutting-edge AI, this platform delivers inventory optimization like never before.
          </p>
