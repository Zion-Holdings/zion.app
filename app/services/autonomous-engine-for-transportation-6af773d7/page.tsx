...
export const metadata: Metadata = {
  title: 'Autonomous Engine for Transportation',
  description: 'Transform your transportation operations with our Autonomous Engine for Transportation. This AI-driven solution automates customer insights with unprecedented a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-engine-for-transportation-6af773d7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Engine for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your transportation operations with our Autonomous Engine for Transportation. This AI-driven solution automates customer insights with unprecedented accuracy and efficiency.
          </p>
