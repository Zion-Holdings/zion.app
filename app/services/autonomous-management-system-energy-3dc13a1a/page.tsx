...
export const metadata: Metadata = {
  title: 'Autonomous Management System - Energy',
  description: 'The future of energy is here with Autonomous Management System - Energy. Powered by cutting-edge AI, this platform delivers financial risk management like never',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-management-system-energy-3dc13a1a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Management System - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Autonomous Management System - Energy. Powered by cutting-edge AI, this platform delivers financial risk management like never before.
          </p>
