...
export const metadata: Metadata = {
  title: 'Cognitive Monitoring for Energy #1',
  description: 'Next-generation energy solution: Cognitive Monitoring for Energy #1. Combines maintenance scheduling with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-monitoring-for-energy-1-be949536',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Monitoring for Energy #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Cognitive Monitoring for Energy #1. Combines maintenance scheduling with adaptive intelligence for optimal results.
          </p>
