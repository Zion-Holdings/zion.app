...
export const metadata: Metadata = {
  ...
  description: 'Drive innovation in logistics with AI Customer Service - Logistics Edition #1. This AI-powered platform transforms serverless deployment into a competitive adva',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with AI Customer Service - Logistics Edition #1. This AI-powered platform transforms serverless deployment into a competitive advantage.
          </p>
