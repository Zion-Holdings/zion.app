...
export const metadata: Metadata = {
  title: 'Smart Predictive for Logistics',
  description: 'Drive innovation in logistics with Smart Predictive for Logistics. This AI-powered platform transforms social media monitoring into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-predictive-for-logistics-14d64b4f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Predictive for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with Smart Predictive for Logistics. This AI-powered platform transforms social media monitoring into a competitive advantage.
          </p>
