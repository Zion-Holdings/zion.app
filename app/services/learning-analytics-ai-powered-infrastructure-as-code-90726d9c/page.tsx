...
export const metadata: Metadata = {
  title: 'Learning Analytics AI-Powered Infrastructure as Code',
  description: 'AI-powered learning analytics solution for infrastructure. AI-generated infrastructure code with best practices and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/learning-analytics-ai-powered-infrastructure-as-code-90726d9c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Learning Analytics AI-Powered Infrastructure as Code
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered learning analytics solution for infrastructure. AI-generated infrastructure code with best practices and security.
          </p>
