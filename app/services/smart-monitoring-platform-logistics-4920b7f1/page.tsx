...
export const metadata: Metadata = {
  title: 'Smart Monitoring Platform - Logistics',
  description: 'Unlock unprecedented growth with Smart Monitoring Platform - Logistics. This autonomous system provides data processing with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-monitoring-platform-logistics-4920b7f1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Monitoring Platform - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Monitoring Platform - Logistics. This autonomous system provides data processing with zero manual intervention needed.
          </p>
