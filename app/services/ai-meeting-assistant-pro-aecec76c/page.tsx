...
export const metadata: Metadata = {
  title: "AI Meeting Assistant Pro - AI-Powered Productivity Solution",
  description: "AI-powered meeting assistant that generates agendas, takes notes, and schedules follow-ups.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-meeting-assistant-pro-aecec76c",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI Meeting Assistant Pro - AI-Powered Productivity Solution
        </h1>
