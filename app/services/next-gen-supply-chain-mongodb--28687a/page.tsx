...
export const metadata: Metadata = {
  title: 'Next-Gen Supply Chain MongoDB (Energy)',
  description: 'Next-Gen Supply Chain MongoDB (Energy) is an AI-powered energy solution that transforms how businesses operate through intelligent automation and real-time anal',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Supply Chain MongoDB (Energy)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-Gen Supply Chain MongoDB (Energy) is an AI-powered energy solution that transforms how businesses operate through intelligent automation and real-time analytics.
