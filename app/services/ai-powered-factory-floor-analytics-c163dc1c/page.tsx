...
export const metadata: Metadata = {
  title: 'AI-Powered Factory Floor Analytics',
  description: 'Analytics for factory floor with real-time insights and recommendations.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-factory-floor-analytics-c163dc1c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Factory Floor Analytics
          </h1>
