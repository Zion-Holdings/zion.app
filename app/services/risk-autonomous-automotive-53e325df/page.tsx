...
export const metadata: Metadata = {
  title: 'Risk Autonomous - Automotive',
  description: 'Drive innovation in automotive with Risk Autonomous - Automotive. This AI-powered platform transforms predictive modeling into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/risk-autonomous-automotive-53e325df',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Risk Autonomous - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in automotive with Risk Autonomous - Automotive. This AI-powered platform transforms predictive modeling into a competitive advantage.
          </p>
