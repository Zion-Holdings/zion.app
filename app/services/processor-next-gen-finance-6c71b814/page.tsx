...
export const metadata: Metadata = {
  title: 'Processor Next-Gen - Finance',
  description: 'Next-generation finance solution: Processor Next-Gen - Finance. Combines executive dashboards with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/processor-next-gen-finance-6c71b814',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Processor Next-Gen - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation finance solution: Processor Next-Gen - Finance. Combines executive dashboards with adaptive intelligence for optimal results.
          </p>
