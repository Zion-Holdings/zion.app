...
export const metadata: Metadata = {
  title: 'Automated Financial Data',
  description: 'Transform your healthcare operations with our Automated Financial Data. This AI-driven solution automates succession planning with unprecedented accuracy and ef',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Automated Financial Data. This AI-driven solution automates succession planning with unprecedented accuracy and efficiency.
          </p>
