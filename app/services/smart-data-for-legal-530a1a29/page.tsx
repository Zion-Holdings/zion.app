...
export const metadata: Metadata = {
  title: 'Smart Data for Legal',
  description: 'Drive innovation in legal with Smart Data for Legal. This AI-powered platform transforms succession planning into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-data-for-legal-530a1a29',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Data for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Smart Data for Legal. This AI-powered platform transforms succession planning into a competitive advantage.
          </p>
