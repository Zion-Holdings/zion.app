...
export const metadata: Metadata = {
  ...
  keywords: 'SD-WAN with application-aware routing, Secure web gateway (SWG), Cloud access security broker (CASB), Zero trust network access (ZTNA), Firewall as a service (FWaaS), Global PoP network for performance, Integration with Zscaler, Palo Alto, Netskope, security, Cybersecurity, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Secure Access Service Edge (SASE)</h1>
        <p className="text-lg text-slate-300 mb-8">SASE platform: SD-WAN, SWG, CASB, ZTNA, FWaaS in one cloud service. Secure access from anywhere.</p>
        ...
        <li class="text-slate-300">SD-WAN with application-aware routing</li>
        <li class="text-slate-300">Secure web gateway (SWG)</li>
        <li class="text-slate-300">Cloud access security broker (CASB)</li>
        <li class="text-slate-300">Zero trust network access (ZTNA)</li>
        <li class="text-slate-300">Firewall as a service (FWaaS)</li>
        <li class="text-slate-300">Global PoP network for performance</li>
        <li class="text-slate-300">Integration with Zscaler</li>
        <li class="text-slate-300">Palo Alto</li>
        <li class="text-slate-300">Netskope</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">One platform for all secure access</li>
        <li class="text-slate-300">SD-WAN optimizes application performance</li>
        <li class="text-slate-300">ZTNA replaces legacy VPN</li>
        <li class="text-slate-300">Global PoP network for low latency</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$45/user/mo</p>
              <p class="text-sm text-slate-400">Most popular</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              <h3 class="font-semibold text-white mb-2">Enterprise</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">$75/user/mo</p>
