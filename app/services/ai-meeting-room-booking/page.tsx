...
export const metadata: Metadata = {
  ...
  keywords: 'Auto room selection by requirements, Conflict detection and resolution, Equipment matching, Automatic release of unused rooms, Calendar integration, Occupancy analytics, Waitlist management, Mobile check-in, ai, Corporate, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Smart Meeting Room Booking</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered meeting room optimization with automatic room selection based on attendee count, equipment needs, and calendar analysis.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">ai</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">Corporate</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Auto room selection by requirements</li>
        <li class="text-slate-300">Conflict detection and resolution</li>
        <li class="text-slate-300">Equipment matching</li>
        <li class="text-slate-300">Automatic release of unused rooms</li>
        <li class="text-slate-300">Calendar integration</li>
        <li class="text-slate-300">Occupancy analytics</li>
        <li class="text-slate-300">Waitlist management</li>
        <li class="text-slate-300">Mobile check-in</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Eliminate meeting room conflicts</li>
        <li class="text-slate-300">Increase room utilization by 35%</li>
        <li class="text-slate-300">Reduce phantom bookings</li>
        <li class="text-slate-300">Optimize space planning</li>
      </ul>
        </div>
