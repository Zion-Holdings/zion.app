...
export const metadata: Metadata = {
  title: 'Cognitive Data Solution - Media',
  description: 'Transform your media operations with our Cognitive Data Solution - Media. This AI-driven solution automates data pipeline orchestration with unprecedented accur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-data-solution-media-db8ccc8b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Data Solution - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your media operations with our Cognitive Data Solution - Media. This AI-driven solution automates data pipeline orchestration with unprecedented accuracy and efficiency.
          </p>
