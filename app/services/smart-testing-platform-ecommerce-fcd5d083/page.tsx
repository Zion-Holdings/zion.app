...
export const metadata: Metadata = {
  title: 'Smart Testing Platform - Ecommerce',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Testing Platform - Ecommerce
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Testing Platform - Ecommerce. This autonomous system provides business continuity with zero manual intervention needed.
          </p>
