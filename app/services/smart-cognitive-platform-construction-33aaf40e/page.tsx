...
export const metadata: Metadata = {
  title: 'Smart Cognitive Platform - Construction',
  description: 'Transform your construction operations with our Smart Cognitive Platform - Construction. This AI-driven solution automates testing automation with unprecedented',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-cognitive-platform-construction-33aaf40e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Cognitive Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Smart Cognitive Platform - Construction. This AI-driven solution automates testing automation with unprecedented accuracy and efficiency.
          </p>
