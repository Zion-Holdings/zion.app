...
export const metadata: Metadata = {
  title: 'Intelligent Computer Vision for Real-Estate',
  description: 'Unlock unprecedented growth with Intelligent Computer Vision for Real-Estate. This autonomous system provides feedback collection with zero manual intervention ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-computer-vision-for-real-estate-0870aa4e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Computer Vision for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Computer Vision for Real-Estate. This autonomous system provides feedback collection with zero manual intervention needed.
          </p>
