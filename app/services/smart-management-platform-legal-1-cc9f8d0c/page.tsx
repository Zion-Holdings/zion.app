...
export const metadata: Metadata = {
  title: 'Smart Management Platform - Legal #1',
  description: 'The future of legal is here with Smart Management Platform - Legal #1. Powered by cutting-edge AI, this platform delivers customer service automation like never',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-management-platform-legal-1-cc9f8d0c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Management Platform - Legal #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Smart Management Platform - Legal #1. Powered by cutting-edge AI, this platform delivers customer service automation like never before.
          </p>
