...
export const metadata: Metadata = {
  title: 'DLP Kubernetes Cluster Management Platform',
  description: 'AI-powered dlp solution for devops. Automated Kubernetes cluster provisioning, scaling, and management.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/dlp-kubernetes-cluster-management-platform-15f511a4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            DLP Kubernetes Cluster Management Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered dlp solution for devops. Automated Kubernetes cluster provisioning, scaling, and management.
          </p>
