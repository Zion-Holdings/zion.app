...
export const metadata: Metadata = {
  title: 'Intelligent Orchestrator for Manufacturing',
  description: 'The future of manufacturing is here with Intelligent Orchestrator for Manufacturing. Powered by cutting-edge AI, this platform delivers process discovery like n',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-orchestrator-for-manufacturing-ef64fbb3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Orchestrator for Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of manufacturing is here with Intelligent Orchestrator for Manufacturing. Powered by cutting-edge AI, this platform delivers process discovery like never before.
          </p>
