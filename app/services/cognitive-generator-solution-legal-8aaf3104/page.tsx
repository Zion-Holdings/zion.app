...
export const metadata: Metadata = {
  title: 'Cognitive Generator Solution - Legal',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Generator Solution - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Cognitive Generator Solution - Legal leverages advanced machine learning to deliver customer journey mapping at scale.
          </p>
