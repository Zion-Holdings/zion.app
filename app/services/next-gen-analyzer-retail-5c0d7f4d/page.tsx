...
export const metadata: Metadata = {
  title: 'Next-Gen analyzer-retail',
  description: 'The future of retail is here with Next-Gen analyzer-retail. Powered by cutting-edge AI, this platform delivers margin analysis like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-analyzer-retail-5c0d7f4d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen analyzer-retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Next-Gen analyzer-retail. Powered by cutting-edge AI, this platform delivers margin analysis like never before.
          </p>
