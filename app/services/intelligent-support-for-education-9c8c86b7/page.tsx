...
export const metadata: Metadata = {
  title: 'Intelligent Support for Education',
  description: 'Drive innovation in education with Intelligent Support for Education. This AI-powered platform transforms customer onboarding into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-support-for-education-9c8c86b7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Support for Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in education with Intelligent Support for Education. This AI-powered platform transforms customer onboarding into a competitive advantage.
          </p>
