...
export const metadata: Metadata = {
  title: 'Enterprise Asset Management AI-Powered Quality Assurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Asset Management AI-Powered Quality Assurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered enterprise asset management solution for development. Automated testing and quality control for software deployments.
          </p>
