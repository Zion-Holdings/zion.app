...
export const metadata: Metadata = {
  title: 'Smart Document Platform - Hospitality',
  description: 'Transform your hospitality operations with our Smart Document Platform - Hospitality. This AI-driven solution automates logistics optimization with unprecedente',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-document-platform-hospitality-81839984',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Document Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Smart Document Platform - Hospitality. This AI-driven solution automates logistics optimization with unprecedented accuracy and efficiency.
          </p>
