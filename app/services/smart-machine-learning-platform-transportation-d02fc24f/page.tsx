...
export const metadata: Metadata = {
  title: 'Smart Machine Learning Platform - Transportation',
  description: 'The future of transportation is here with Smart Machine Learning Platform - Transportation. Powered by cutting-edge AI, this platform delivers customer journey ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-machine-learning-platform-transportation-d02fc24f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Machine Learning Platform - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Smart Machine Learning Platform - Transportation. Powered by cutting-edge AI, this platform delivers customer journey mapping like never before.
          </p>
