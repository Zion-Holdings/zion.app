...
export const metadata: Metadata = {
  title: 'Next-Gen Scheduling - Sports',
  description: 'Transform your sports operations with our Next-Gen Scheduling - Sports. This AI-driven solution automates customer insights with unprecedented accuracy and effi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Scheduling - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our Next-Gen Scheduling - Sports. This AI-driven solution automates customer insights with unprecedented accuracy and efficiency.
          </p>
