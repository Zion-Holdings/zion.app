...
export const metadata: Metadata = {
  title: 'Cognitive Data Solution - Insurance',
  description: 'Quantum leap forward for insurance: Cognitive Data Solution - Insurance. Uses quantum-inspired algorithms to deliver compliance reporting at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-data-solution-insurance-00bd1f60',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Data Solution - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for insurance: Cognitive Data Solution - Insurance. Uses quantum-inspired algorithms to deliver compliance reporting at exponential speed.
          </p>
