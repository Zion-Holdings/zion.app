...
export const metadata: Metadata = {
  title: 'Intelligent Healthcare for Insurance',
  description: 'The future of insurance is here with Intelligent Healthcare for Insurance. Powered by cutting-edge AI, this platform delivers vendor management like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-healthcare-for-insurance-4da518ae',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Healthcare for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Intelligent Healthcare for Insurance. Powered by cutting-edge AI, this platform delivers vendor management like never before.
          </p>
