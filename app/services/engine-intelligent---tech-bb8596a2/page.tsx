...
export const metadata: Metadata = {
  title: 'Engine Intelligent - Tech',
  description: 'Revolutionize technology through intelligent automation. Our Engine Intelligent - Tech leverages advanced machine learning to deliver energy management at scale',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/engine-intelligent---tech-bb8596a2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Engine Intelligent - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our Engine Intelligent - Tech leverages advanced machine learning to deliver energy management at scale.
          </p>
