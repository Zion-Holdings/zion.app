...
export const metadata: Metadata = {
  title: 'Enterprise strategic-finance',
  description: 'Transform your finance operations with our Enterprise strategic-finance. This AI-driven solution automates hr analytics with unprecedented accuracy and efficien',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-strategic-finance-35d0041e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise strategic-finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Enterprise strategic-finance. This AI-driven solution automates hr analytics with unprecedented accuracy and efficiency.
          </p>
