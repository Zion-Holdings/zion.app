...
export const metadata: Metadata = {
  title: 'Accounts Receivable AI-Powered CRM Automation',
  description: 'AI-powered accounts receivable solution for sales. Automates customer relationship management with AI-driven insights and follow-ups.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/accounts-receivable-ai-powered-crm-automation-ffeaa211',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Accounts Receivable AI-Powered CRM Automation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered accounts receivable solution for sales. Automates customer relationship management with AI-driven insights and follow-ups.
          </p>
