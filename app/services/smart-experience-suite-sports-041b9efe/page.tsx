...
export const metadata: Metadata = {
  title: 'Smart Experience Suite - Sports',
  description: 'Future-proof your sports with Smart Experience Suite - Sports. Our autonomous solution handles user provisioning end-to-end without human intervention.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-experience-suite-sports-041b9efe',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Experience Suite - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your sports with Smart Experience Suite - Sports. Our autonomous solution handles user provisioning end-to-end without human intervention.
          </p>
