...
export const metadata: Metadata = {
  title: 'Next-Gen Autonomous for Automotive',
  description: 'Enhance your automotive business with Next-Gen Autonomous for Automotive. Our solution provides project management with enterprise-grade reliability and securit',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Autonomous for Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your automotive business with Next-Gen Autonomous for Automotive. Our solution provides project management with enterprise-grade reliability and security.
          </p>
