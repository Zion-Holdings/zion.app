  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Adaptive Security for Education #1</h1>
        <p className="text-lg text-gray-300 mb-8">Drive innovation in education with Adaptive Security for Education #1. This AI-powered platform transforms competitive intelligence into a competitive advantage.</p>
