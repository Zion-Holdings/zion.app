...
export const metadata: Metadata = {
  title: 'AI Manufacturing - Manufacturing Edition',
  description: 'Optimize your manufacturing workflows with AI Manufacturing - Manufacturing Edition. This intelligent platform delivers project portfolio through advanced autom',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Manufacturing - Manufacturing Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your manufacturing workflows with AI Manufacturing - Manufacturing Edition. This intelligent platform delivers project portfolio through advanced automation and AI.
          </p>
