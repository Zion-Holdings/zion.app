...
export const metadata: Metadata = {
  title: 'Neural Risk Neural',
  description: 'Revolutionize healthcare through intelligent automation. Our Neural Risk Neural leverages advanced machine learning to deliver logistics route optimization at s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Neural Risk Neural leverages advanced machine learning to deliver logistics route optimization at scale.
          </p>
