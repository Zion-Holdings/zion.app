...
export const metadata: Metadata = {
  ...
  keywords: 'DPIAs/LIAs auto-route per data type, Consent receipt ledger + preference store, DSAR ticketing + fulfilment SLA tracker, Automated data subject disclosure PDF, security, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Privacy Program Automation</h1>
        <p className="text-lg text-slate-300 mb-8">DPIA/LIA workflow, consent receipt ledger, DSAR ticketing + fulfilment SLA tracker, and automated GDPR/CCPA disclosure.</p>
        ...
        <li class="text-slate-300">DPIAs/LIAs auto-route per data type</li>
        <li class="text-slate-300">Consent receipt ledger + preference store</li>
        <li class="text-slate-300">DSAR ticketing + fulfilment SLA tracker</li>
        <li class="text-slate-300">Automated data subject disclosure PDF</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with privacy program automation</li>
