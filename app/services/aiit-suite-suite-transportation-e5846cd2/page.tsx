...
export const metadata: Metadata = {
  title: 'AI/IT Suite Suite - Transportation',
  description: 'Hyper-accelerated transportation solution: AI/IT Suite Suite - Transportation. Combines decision support with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-suite-suite-transportation-e5846cd2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Suite Suite - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated transportation solution: AI/IT Suite Suite - Transportation. Combines decision support with next-gen AI for maximum velocity.
          </p>
