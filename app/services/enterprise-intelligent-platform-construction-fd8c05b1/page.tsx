...
export const metadata: Metadata = {
  title: 'Enterprise Intelligent Platform - Construction',
  description: 'Drive innovation in construction with Enterprise Intelligent Platform - Construction. This AI-powered platform transforms invoice processing into a competitive ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-intelligent-platform-construction-fd8c05b1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Intelligent Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Enterprise Intelligent Platform - Construction. This AI-powered platform transforms invoice processing into a competitive advantage.
          </p>
