...
export const metadata: Metadata = {
  ...
  keywords: 'Text-to-video AI engine with scene generation, AI voiceover in 50+ languages with subtitles, Brand kit — colors, logos, auto-applied, Video editing timeline with AI-assisted cuts, Multi-platform export — YouTube, TikTok, Reels, Template marketplace — 500+ pre-built designs, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Video Generation &amp; Editing</h1>
        <p className="text-lg text-slate-300 mb-8">Create professional videos from text prompts with voiceover, B-roll, transitions, and brand styling — produce enterprise-grade content in minutes.</p>
        ...
        <li class="text-slate-300">Text-to-video AI engine with scene generation</li>
        <li class="text-slate-300">AI voiceover in 50+ languages with subtitles</li>
        <li class="text-slate-300">Brand kit — colors, logos, auto-applied</li>
        <li class="text-slate-300">Video editing timeline with AI-assisted cuts</li>
        <li class="text-slate-300">Multi-platform export — YouTube, TikTok, Reels</li>
        <li class="text-slate-300">Template marketplace — 500+ pre-built designs</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai video generation &amp; editing</li>
