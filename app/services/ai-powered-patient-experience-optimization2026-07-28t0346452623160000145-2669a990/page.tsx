...
export const metadata: Metadata = {
  title: 'AI-Powered Patient Experience Optimization',
  description: 'Optimizes patient experience with feedback analysis and service improvement.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-patient-experience-optimization2026-07-28t0346452623160000145-2669a990',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Patient Experience Optimization
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimizes patient experience with feedback analysis and service improvement.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Experience optimization</li>
          <li className="text-gray-300">Feedback analysis</li>
          <li className="text-gray-300">Service improvement</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">30% better experience</li>
