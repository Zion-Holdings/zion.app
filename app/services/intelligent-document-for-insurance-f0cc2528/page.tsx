...
export const metadata: Metadata = {
  title: 'Intelligent Document for Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Intelligent Document for Insurance leverages advanced machine learning to deliver rpa orchestration ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Document for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Intelligent Document for Insurance leverages advanced machine learning to deliver rpa orchestration at scale.
          </p>
