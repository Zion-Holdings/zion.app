...
export const metadata: Metadata = {
  title: 'Manufacturing Automated - Proptech',
  description: 'Revolutionize proptech through intelligent automation. Our Manufacturing Automated - Proptech leverages advanced machine learning to deliver risk assessment at ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manufacturing Automated - Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our Manufacturing Automated - Proptech leverages advanced machine learning to deliver risk assessment at scale.
          </p>
