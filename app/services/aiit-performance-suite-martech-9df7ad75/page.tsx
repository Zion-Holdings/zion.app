...
export const metadata: Metadata = {
  title: 'AI/IT Performance Suite - MARTECH',
  description: 'Enhance your martech business with AI/IT Performance Suite - MARTECH. Our solution provides root cause analysis with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-performance-suite-martech-9df7ad75',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Performance Suite - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your martech business with AI/IT Performance Suite - MARTECH. Our solution provides root cause analysis with enterprise-grade reliability and security.
          </p>
