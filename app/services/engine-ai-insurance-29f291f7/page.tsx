...
export const metadata: Metadata = {
  title: 'Engine AI - Insurance',
  description: 'Unlock unprecedented growth with Engine AI - Insurance. This autonomous system provides data processing with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/engine-ai-insurance-29f291f7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Engine AI - Insurance. This autonomous system provides data processing with zero manual intervention needed.
          </p>
