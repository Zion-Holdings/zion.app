...
export const metadata: Metadata = {
  title: 'Neural Healthcare for Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Neural Healthcare for Hospitality leverages advanced machine learning to deliver process automatio',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-healthcare-for-hospitality-3cd09feb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Healthcare for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Neural Healthcare for Hospitality leverages advanced machine learning to deliver process automation at scale.
          </p>
