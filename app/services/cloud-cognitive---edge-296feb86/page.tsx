...
export const metadata: Metadata = {
  title: 'Cloud Cognitive - Edge',
  description: 'Transform your edge operations with our Cloud Cognitive - Edge. This AI-driven solution automates language processing with unprecedented accuracy and efficiency',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cloud-cognitive---edge-296feb86',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cloud Cognitive - Edge
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your edge operations with our Cloud Cognitive - Edge. This AI-driven solution automates language processing with unprecedented accuracy and efficiency.
          </p>
