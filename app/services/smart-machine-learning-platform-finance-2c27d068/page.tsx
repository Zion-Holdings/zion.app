...
export const metadata: Metadata = {
  title: 'Smart Machine Learning Platform - Finance',
  description: 'Transform your finance operations with our Smart Machine Learning Platform - Finance. This AI-driven solution automates serverless deployment with unprecedented',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Machine Learning Platform - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Smart Machine Learning Platform - Finance. This AI-driven solution automates serverless deployment with unprecedented accuracy and efficiency.
          </p>
