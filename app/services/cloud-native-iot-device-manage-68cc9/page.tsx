...
export const metadata: Metadata = {
  title: 'Cloud-Native IoT Device Management Machine Learning (Legal)',
  description: 'Cloud-Native IoT Device Management Machine Learning (Legal) is an AI-powered legal solution that transforms how businesses operate through intelligent automatio',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cloud-Native IoT Device Management Machine Learning (Legal)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Cloud-Native IoT Device Management Machine Learning (Legal) is an AI-powered legal solution that transforms how businesses operate through intelligent automation and real-time analytics.
