...
export const metadata: Metadata = {
  title: 'Smart Lead Customer',
  description: 'Quantum leap forward for manufacturing: Smart Lead Customer. Uses quantum-inspired algorithms to deliver hr analytics at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-lead-customer-fbf3fd2c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for manufacturing: Smart Lead Customer. Uses quantum-inspired algorithms to deliver hr analytics at exponential speed.
          </p>
