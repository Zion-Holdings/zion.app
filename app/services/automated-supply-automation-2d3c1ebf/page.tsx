...
export const metadata: Metadata = {
  title: 'Automated Supply Automation',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Supply Automation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in transportation with Automated Supply Automation. This AI-powered platform transforms scalability planning into a competitive advantage.
          </p>
