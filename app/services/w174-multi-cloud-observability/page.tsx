...
export const metadata: Metadata = {
  ...
  keywords: 'Unified dashboard across AWS, Azure, GCP, OpenTelemetry-native collection, Cross-cloud trace correlation, Multi-cloud cost and performance comparison, Cloud-agnostic alerting, SLO tracking across providers, No vendor lock-in (OTel standard), cloud, Cloud Computing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Multi-Cloud Observability Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Unified observability across AWS, Azure, and GCP with OpenTelemetry. Single pane for metrics, traces, and logs regardless of cloud provider.</p>
        ...
        <li class="text-slate-300">Unified dashboard across AWS, Azure, GCP</li>
        <li class="text-slate-300">OpenTelemetry-native collection</li>
        <li class="text-slate-300">Cross-cloud trace correlation</li>
        <li class="text-slate-300">Multi-cloud cost and performance comparison</li>
        <li class="text-slate-300">Cloud-agnostic alerting</li>
        <li class="text-slate-300">SLO tracking across providers</li>
        <li class="text-slate-300">No vendor lock-in (OTel standard)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">One dashboard for all clouds</li>
        <li class="text-slate-300">Cross-cloud correlation for multi-cloud issues</li>
        <li class="text-slate-300">OTel standard prevents vendor lock-in</li>
        <li class="text-slate-300">Cost comparison drives optimization</li>
      </ul>
        </div>
