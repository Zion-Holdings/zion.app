...
export const metadata: Metadata = {
  title: 'Intelligent finance-retail',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent finance-retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your retail workflows with Intelligent finance-retail. This intelligent platform delivers automation opportunity through advanced automation and AI.
          </p>
