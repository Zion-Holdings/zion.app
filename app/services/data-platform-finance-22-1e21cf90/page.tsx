...
export const metadata: Metadata = {
  title: 'Data Platform for Finance - Batch 22',
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Platform for Finance - Batch 22
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Advanced data platform for Finance industry. Leverages machine learning for advanced analytics and automation. Provides real-time insights and predictive capabilities for strategic decision-making.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-500/20">
          ...
          <p className="text-3xl font-bold text-purple-400 mb-4">$409</p>
