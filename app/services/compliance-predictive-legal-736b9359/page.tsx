...
export const metadata: Metadata = {
  title: 'Compliance Predictive - Legal',
  description: 'The future of legal is here with Compliance Predictive - Legal. Powered by cutting-edge AI, this platform delivers transformative results like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/compliance-predictive-legal-736b9359',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Compliance Predictive - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Compliance Predictive - Legal. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
