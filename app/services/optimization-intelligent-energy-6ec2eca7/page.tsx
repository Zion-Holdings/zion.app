...
export const metadata: Metadata = {
  title: 'Optimization Intelligent - Energy',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Optimization Intelligent - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your energy business with Optimization Intelligent - Energy. Our solution provides maintenance scheduling with enterprise-grade reliability and security.
          </p>
