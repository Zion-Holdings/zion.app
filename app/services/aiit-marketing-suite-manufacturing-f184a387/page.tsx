...
export const metadata: Metadata = {
  title: 'AI/IT Marketing Suite - Manufacturing',
  description: 'Quantum leap forward for manufacturing: AI/IT Marketing Suite - Manufacturing. Uses quantum-inspired algorithms to deliver business process at exponential speed',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-marketing-suite-manufacturing-f184a387',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Marketing Suite - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for manufacturing: AI/IT Marketing Suite - Manufacturing. Uses quantum-inspired algorithms to deliver business process at exponential speed.
          </p>
