...
export const metadata: Metadata = {
  title: 'Cognitive Business Intelligence Solution - Telecom',
  description: 'Unlock unprecedented growth with Cognitive Business Intelligence Solution - Telecom. This autonomous system provides financial risk management with zero manual ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Business Intelligence Solution - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Cognitive Business Intelligence Solution - Telecom. This autonomous system provides financial risk management with zero manual intervention needed.
          </p>
