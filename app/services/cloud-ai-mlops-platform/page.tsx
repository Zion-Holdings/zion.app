...
export const metadata: Metadata = {
  ...
  keywords: 'Managed GPU K8s cluster (A100/H100), Model registry (MLflow) + experiment tracker, Distributed training (PyTorch DDP/DeepSpeed), vLLM/TGI serving auto-scale 0-to-N, cloud, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI/MLOps Cloud Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Managed Kubernetes GPU clusters, model registry (MLflow), distributed training orchestrator, LLM serving vLLM/TGI, and GPU auto-scaling.</p>
        ...
        <li class="text-slate-300">Managed GPU K8s cluster (A100/H100)</li>
        <li class="text-slate-300">Model registry (MLflow) + experiment tracker</li>
        <li class="text-slate-300">Distributed training (PyTorch DDP/DeepSpeed)</li>
        <li class="text-slate-300">vLLM/TGI serving auto-scale 0-to-N</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai/mlops cloud platform</li>
