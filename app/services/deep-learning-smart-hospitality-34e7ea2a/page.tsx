...
export const metadata: Metadata = {
  title: 'Deep Learning Smart - Hospitality',
  description: 'Next-generation hospitality solution: Deep Learning Smart - Hospitality. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/deep-learning-smart-hospitality-34e7ea2a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Deep Learning Smart - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Deep Learning Smart - Hospitality. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
