...
export const metadata: Metadata = {
  title: 'Quantum Management for Telecom',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Management for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your telecom business with Quantum Management for Telecom. Our solution provides goal setting with enterprise-grade reliability and security.
          </p>
