      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your retail business with Smart Support Platform - Retail. Our solution provides contract analysis with enterprise-grade reliability and security.
          </p>
