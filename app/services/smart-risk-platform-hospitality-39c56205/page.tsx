...
export const metadata: Metadata = {
  title: 'Smart Risk Platform - Hospitality',
  description: 'Unlock unprecedented growth with Smart Risk Platform - Hospitality. This autonomous system provides resource allocation with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-risk-platform-hospitality-39c56205',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Risk Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Risk Platform - Hospitality. This autonomous system provides resource allocation with zero manual intervention needed.
          </p>
