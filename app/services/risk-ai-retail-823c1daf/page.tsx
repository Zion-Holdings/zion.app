...
export const metadata: Metadata = {
  title: 'Risk AI - Retail',
  description: 'Transform your retail operations with our Risk AI - Retail. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/risk-ai-retail-823c1daf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our Risk AI - Retail. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
