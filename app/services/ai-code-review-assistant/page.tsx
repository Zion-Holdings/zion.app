...
export const metadata: Metadata = {
  ...
  keywords: 'Static analysis with deep learning, Security vulnerability detection, Performance optimization suggestions, Code style & best practice enforcement, GitHub/GitLab/Bitbucket PR integration, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Code Review Assistant</h1>
        <p className="text-lg text-slate-300 mb-8">Automated code review with AI: detect bugs, security flaws, performance anti-patterns, and suggest fixes with before/after diffs.</p>
        ...
        <li class="text-slate-300">Static analysis with deep learning</li>
        <li class="text-slate-300">Security vulnerability detection</li>
        <li class="text-slate-300">Performance optimization suggestions</li>
        <li class="text-slate-300">Code style &amp; best practice enforcement</li>
        <li class="text-slate-300">GitHub/GitLab/Bitbucket PR integration</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai code review assistant</li>
