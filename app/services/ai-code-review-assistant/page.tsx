      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Automated code review with AI: detect bugs, security flaws, performance anti-patterns, and suggest fixes with before/after diffs.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Static analysis with deep learning</li>
            <li className="text-purple-300">✓ Security vulnerability detection</li>
            <li className="text-purple-300">✓ Performance optimization suggestions</li>
            <li className="text-purple-300">✓ Code style & best practice enforcement</li>
            <li className="text-purple-300">✓ GitHub/GitLab/Bitbucket PR integration</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai code review assistant</li>
