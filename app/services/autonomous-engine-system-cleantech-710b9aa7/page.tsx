...
export const metadata: Metadata = {
  title: 'Autonomous Engine System - CLEANTECH',
  description: 'Next-generation cleantech solution: Autonomous Engine System - CLEANTECH. Combines quality assurance with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-engine-system-cleantech-710b9aa7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Engine System - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation cleantech solution: Autonomous Engine System - CLEANTECH. Combines quality assurance with adaptive intelligence for optimal results.
          </p>
