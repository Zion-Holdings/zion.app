...
export const metadata: Metadata = {
  title: 'Autonomous Generator System - EDTECH',
  description: 'Optimize your edtech workflows with Autonomous Generator System - EDTECH. This intelligent platform delivers budget tracking through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-generator-system-edtech-eab62a66',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Generator System - EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your edtech workflows with Autonomous Generator System - EDTECH. This intelligent platform delivers budget tracking through advanced automation and AI.
          </p>
