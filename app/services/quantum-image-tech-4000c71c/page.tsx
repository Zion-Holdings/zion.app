...
export const metadata: Metadata = {
  title: 'Quantum image-tech',
  description: 'Transform technology with Quantum image-tech - the intelligent automation platform that learns, adapts, and delivers 10x results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-image-tech-4000c71c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform technology with Quantum image-tech - the intelligent automation platform that learns, adapts, and delivers 10x results.
          </p>
