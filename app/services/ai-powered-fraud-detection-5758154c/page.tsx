...
export const metadata: Metadata = {
  title: "AI-Powered Fraud Detection - AI-Powered Finance Solution",
  description: "Real-time fraud detection for financial transactions and user behavior.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-fraud-detection-5758154c",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Fraud Detection - AI-Powered Finance Solution
        </h1>
