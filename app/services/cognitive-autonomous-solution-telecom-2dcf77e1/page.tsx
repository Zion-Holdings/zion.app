...
export const metadata: Metadata = {
  title: 'Cognitive Autonomous Solution - Telecom',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Autonomous Solution - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation telecom solution: Cognitive Autonomous Solution - Telecom. Combines capacity management with adaptive intelligence for optimal results.
          </p>
