...
export const metadata: Metadata = {
  title: 'Neural Performance Sales',
  description: 'The future of hospitality is here with Neural Performance Sales. Powered by cutting-edge AI, this platform delivers sales forecasting like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-performance-sales-f14cf8ed',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Performance Sales
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Neural Performance Sales. Powered by cutting-edge AI, this platform delivers sales forecasting like never before.
          </p>
