...
export const metadata: Metadata = {
  title: 'Smart Data Science Platform - Sports #1',
  description: 'Optimize your sports workflows with Smart Data Science Platform - Sports #1. This intelligent platform delivers vendor management through advanced automation an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-data-science-platform-sports-1-77aa051e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Data Science Platform - Sports #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your sports workflows with Smart Data Science Platform - Sports #1. This intelligent platform delivers vendor management through advanced automation and AI.
          </p>
