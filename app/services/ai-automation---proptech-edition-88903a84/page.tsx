...
export const metadata: Metadata = {
  title: 'AI Automation - Proptech Edition',
  description: 'Next-generation proptech solution: AI Automation - Proptech Edition. Combines predictive analytics with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-automation---proptech-edition-88903a84',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Automation - Proptech Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation proptech solution: AI Automation - Proptech Edition. Combines predictive analytics with adaptive intelligence for optimal results.
          </p>
