...
export const metadata: Metadata = {
  ...
  description: 'Enhance your hospitality business with Autonomous Optimization System - Hospitality. Our solution provides sales process optimization with enterprise-grade reli',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-optimization-system-hospitality-9f0dadf3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Autonomous Optimization System - Hospitality. Our solution provides sales process optimization with enterprise-grade reliability and security.
          </p>
