...
export const metadata: Metadata = {
  title: 'AI-Powered Data for Retail',
  description: 'The future of retail is here with AI-Powered Data for Retail. Powered by cutting-edge AI, this platform delivers quality control like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-data-for-retail-50145d66',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Data for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with AI-Powered Data for Retail. Powered by cutting-edge AI, this platform delivers quality control like never before.
          </p>
