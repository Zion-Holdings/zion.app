...
export const metadata: Metadata = {
  title: 'Self-Optimizing analyzer-hospitality',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Self-Optimizing analyzer-hospitality. Combines predictive analytics with adaptive intelligence for optimal results.
          </p>
