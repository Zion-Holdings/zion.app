...
export const metadata: Metadata = {
  ...
  keywords: 'Inquiry funnel: form → enriched CRM record → personalised nurture sequence per channel, Academic-risk detection via LMS grade-imported pattern scoring, Parent engagement portal with auto-summarised academic progress reports, Alumni lifecycle: graduation anniversary give, re-enrolment incentive, charitable giving prompts, FERPA-compliant data handling with role-based student record access, automation, Education, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Education Student Lifecycle Manager</h1>
        <p className="text-lg text-slate-300 mb-8">Full-cycle student lifecycle automation for higher ed and EdTech: inquiry-to-enrolment funnel, personalised nurture sequences, academic-risk detection, parents-and-alumni engagement, and LMS grade-imported at-risk alerts.</p>
        ...
        <li class="text-slate-300">Inquiry funnel: form → enriched CRM record → personalised nurture sequence per channel</li>
        <li class="text-slate-300">Academic-risk detection via LMS grade-imported pattern scoring</li>
        <li class="text-slate-300">Parent engagement portal with auto-summarised academic progress reports</li>
        <li class="text-slate-300">Alumni lifecycle: graduation anniversary give, re-enrolment incentive, charitable giving prompts</li>
        <li class="text-slate-300">FERPA-compliant data handling with role-based student record access</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with education student lifecycle manager</li>
