...
export const metadata: Metadata = {
  title: 'Intelligent automation-tech',
  description: 'Transform your technology operations with our Intelligent automation-tech. This AI-driven solution automates sales process optimization with unprecedented accur',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your technology operations with our Intelligent automation-tech. This AI-driven solution automates sales process optimization with unprecedented accuracy and efficiency.
          </p>
