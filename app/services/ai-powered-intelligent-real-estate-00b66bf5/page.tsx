...
export const metadata: Metadata = {
  title: 'AI-Powered intelligent-real-estate',
  description: 'Revolutionize real-estate through intelligent automation. Our AI-Powered intelligent-real-estate leverages advanced machine learning to deliver image recognitio',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-intelligent-real-estate-00b66bf5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered intelligent-real-estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our AI-Powered intelligent-real-estate leverages advanced machine learning to deliver image recognition at scale.
          </p>
