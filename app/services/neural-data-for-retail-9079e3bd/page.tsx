...
export const metadata: Metadata = {
  title: 'Neural Data for Retail',
  description: 'Next-generation retail solution: Neural Data for Retail. Combines hr analytics with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-data-for-retail-9079e3bd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Data for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation retail solution: Neural Data for Retail. Combines hr analytics with adaptive intelligence for optimal results.
          </p>
