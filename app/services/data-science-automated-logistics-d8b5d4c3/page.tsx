...
export const metadata: Metadata = {
  title: 'Data Science Automated - Logistics',
  description: 'Enhance your logistics business with Data Science Automated - Logistics. Our solution provides forecast accuracy with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-science-automated-logistics-d8b5d4c3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Science Automated - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with Data Science Automated - Logistics. Our solution provides forecast accuracy with enterprise-grade reliability and security.
          </p>
