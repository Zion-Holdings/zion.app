...
export const metadata: Metadata = {
  title: "AI-Powered Agriculture Customer Intelligence - AI-Powered Agriculture Solution",
  description: "AI-powered agriculture solution leveraging advanced machine learning for optimal performance and ROI.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-agriculture-customer-intelligence-3457b00f",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Agriculture Customer Intelligence - AI-Powered Agriculture Solution
        </h1>
