...
export const metadata: Metadata = {
  ...
  description: 'Next-generation retail solution: Automated Engine for Retail. Combines process automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-engine-for-retail-b949b2a7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation retail solution: Automated Engine for Retail. Combines process automation with adaptive intelligence for optimal results.
          </p>
