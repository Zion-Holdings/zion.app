...
export const metadata: Metadata = {
  title: 'Enterprise Quality Platform - Construction',
  description: 'Enhance your construction business with Enterprise Quality Platform - Construction. Our solution provides expense management with enterprise-grade reliability a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-quality-platform-construction-31c22173',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Quality Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Enterprise Quality Platform - Construction. Our solution provides expense management with enterprise-grade reliability and security.
          </p>
