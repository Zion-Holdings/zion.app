...
export const metadata: Metadata = {
  title: 'Strategic Adaptive - Real-Estate',
  description: 'Drive innovation in real-estate with Strategic Adaptive - Real-Estate. This AI-powered platform transforms event-driven architecture into a competitive advantag',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Strategic Adaptive - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in real-estate with Strategic Adaptive - Real-Estate. This AI-powered platform transforms event-driven architecture into a competitive advantage.
          </p>
