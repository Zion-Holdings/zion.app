...
export const metadata: Metadata = {
  title: 'Self-Optimizing Supply Management',
  description: 'Revolutionize manufacturing through intelligent automation. Our Self-Optimizing Supply Management leverages advanced machine learning to deliver process automat',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Supply Management
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize manufacturing through intelligent automation. Our Self-Optimizing Supply Management leverages advanced machine learning to deliver process automation at scale.
          </p>
