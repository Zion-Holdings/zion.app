...
export const metadata: Metadata = {
  ...
  description: 'Real-time fraud detection for financial transactions using behavioral analysis.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-fraud-detection-system2026-07-28t0402472906160000117-4bd25c47',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Real-time fraud detection for financial transactions using behavioral analysis.
          </p>
