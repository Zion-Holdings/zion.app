...
export const metadata: Metadata = {
  title: 'AI-Powered Suite for Iot #1',
  description: 'Next-generation iot solution: AI-Powered Suite for Iot #1. Combines workflow management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-suite-for-iot-1-1bebd3a0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Suite for Iot #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation iot solution: AI-Powered Suite for Iot #1. Combines workflow management with adaptive intelligence for optimal results.
          </p>
