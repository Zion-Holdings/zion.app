...
export const metadata: Metadata = {
  title: 'AI-Powered Experience for Telecom',
  description: 'The future of telecom is here with AI-Powered Experience for Telecom. Powered by cutting-edge AI, this platform delivers threat detection like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-experience-for-telecom-d1a0cdd6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Experience for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of telecom is here with AI-Powered Experience for Telecom. Powered by cutting-edge AI, this platform delivers threat detection like never before.
          </p>
