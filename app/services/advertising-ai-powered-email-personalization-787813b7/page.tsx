...
export const metadata: Metadata = {
  title: "Advertising AI-Powered Email Personalization - AI-Powered Advertising Solution",
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Advertising AI-Powered Email Personalization - AI-Powered Advertising Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          AI-powered advertising solution for email marketing. Creates hyper-personalized email campaigns by analyzing recipient data.
        </p>
