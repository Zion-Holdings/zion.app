...
export const metadata: Metadata = {
  title: 'AI Quality - Insurance Edition',
  description: 'Quantum leap forward for insurance: AI Quality - Insurance Edition. Uses quantum-inspired algorithms to deliver data governance at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-quality-insurance-edition-ff626502',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Quality - Insurance Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for insurance: AI Quality - Insurance Edition. Uses quantum-inspired algorithms to deliver data governance at exponential speed.
          </p>
