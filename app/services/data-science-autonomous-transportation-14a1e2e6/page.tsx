...
export const metadata: Metadata = {
  title: 'Data Science Autonomous - Transportation',
  description: 'Next-generation transportation solution: Data Science Autonomous - Transportation. Combines hr analytics with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-science-autonomous-transportation-14a1e2e6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Science Autonomous - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation transportation solution: Data Science Autonomous - Transportation. Combines hr analytics with adaptive intelligence for optimal results.
          </p>
