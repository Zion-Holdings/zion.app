...
export const metadata: Metadata = {
  title: 'Adaptive IoT Device Management Spark (Blockchain)',
  description: 'Adaptive IoT Device Management Spark (Blockchain) is an AI-powered blockchain solution that transforms how businesses operate through intelligent automation and',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive IoT Device Management Spark (Blockchain)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Adaptive IoT Device Management Spark (Blockchain) is an AI-powered blockchain solution that transforms how businesses operate through intelligent automation and real-time analytics.
