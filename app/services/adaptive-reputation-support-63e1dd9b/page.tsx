...
export const metadata: Metadata = {
  title: 'Adaptive Reputation Support',
  description: 'The future of insurance is here with Adaptive Reputation Support. Powered by cutting-edge AI, this platform delivers transformative results like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-reputation-support-63e1dd9b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Reputation Support
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Adaptive Reputation Support. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
