...
export const metadata: Metadata = {
  title: 'Automated Social DevOps',
  description: 'Revolutionize agriculture through intelligent automation. Our Automated Social DevOps leverages advanced machine learning to deliver project portfolio at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-social-devops-d69f7c35',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Social DevOps
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Automated Social DevOps leverages advanced machine learning to deliver project portfolio at scale.
          </p>
