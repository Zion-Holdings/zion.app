...
export const metadata: Metadata = {
  title: 'AI Sales - Startup Edition',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Sales - Startup Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your startup business with AI Sales - Startup Edition. Our solution provides customer retention with enterprise-grade reliability and security.
          </p>
