...
export const metadata: Metadata = {
  title: 'Intelligent Cloud for Healthcare',
  description: 'Transform your healthcare operations with our Intelligent Cloud for Healthcare. This AI-driven solution automates user provisioning with unprecedented accuracy ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-cloud-for-healthcare-07aa16e8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Cloud for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Intelligent Cloud for Healthcare. This AI-driven solution automates user provisioning with unprecedented accuracy and efficiency.
          </p>
