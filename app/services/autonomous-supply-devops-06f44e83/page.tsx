...
export const metadata: Metadata = {
  title: 'Autonomous Supply DevOps',
  description: 'Transform your iot operations with our Autonomous Supply DevOps. This AI-driven solution automates fraud prevention with unprecedented accuracy and efficiency.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-supply-devops-06f44e83',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Supply DevOps
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your iot operations with our Autonomous Supply DevOps. This AI-driven solution automates fraud prevention with unprecedented accuracy and efficiency.
          </p>
