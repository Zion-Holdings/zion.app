...
export const metadata: Metadata = {
  title: 'Smart Cloud Platform - Hospitality #3',
  description: 'The future of hospitality is here with Smart Cloud Platform - Hospitality #3. Powered by cutting-edge AI, this platform delivers fraud prevention like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-cloud-platform-hospitality-3-546dfc85',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Cloud Platform - Hospitality #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Smart Cloud Platform - Hospitality #3. Powered by cutting-edge AI, this platform delivers fraud prevention like never before.
          </p>
