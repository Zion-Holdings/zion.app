...
export const metadata: Metadata = {
  title: 'AI/IT Operational Suite - Telecom',
  description: 'Hyper-accelerated telecom solution: AI/IT Operational Suite - Telecom. Combines performance monitoring with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-operational-suite-telecom-c75f4abc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Operational Suite - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated telecom solution: AI/IT Operational Suite - Telecom. Combines performance monitoring with next-gen AI for maximum velocity.
          </p>
