...
export const metadata: Metadata = {
  title: 'AI-Driven Code for Hospitality',
  description: 'The future of hospitality is here with AI-Driven Code for Hospitality. Powered by cutting-edge AI, this platform delivers automation opportunity like never befo',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Driven Code for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with AI-Driven Code for Hospitality. Powered by cutting-edge AI, this platform delivers automation opportunity like never before.
          </p>
