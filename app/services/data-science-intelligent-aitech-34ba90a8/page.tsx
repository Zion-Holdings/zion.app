...
export const metadata: Metadata = {
  title: 'Data Science Intelligent - AITECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Science Intelligent - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated aitech solution: Data Science Intelligent - AITECH. Combines executive dashboards with next-gen AI for maximum velocity.
          </p>
