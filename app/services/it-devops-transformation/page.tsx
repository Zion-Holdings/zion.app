...
export const metadata: Metadata = {
  ...
  keywords: 'CI/CD pipeline design and implementation, Infrastructure as Code (Terraform, Pulumi), Container orchestration (Kubernetes, Docker), SRE practices and SLI/SLO definition, Monitoring and observability stack setup, Developer experience optimization, it, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT DevOps Transformation Service</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end DevOps transformation including CI/CD pipeline design, infrastructure as code, containerization, and SRE practices. Reduce deployment time from weeks to minutes.</p>
        ...
        <li class="text-slate-300">CI/CD pipeline design and implementation</li>
        <li class="text-slate-300">Infrastructure as Code (Terraform, Pulumi)</li>
        <li class="text-slate-300">Container orchestration (Kubernetes, Docker)</li>
        <li class="text-slate-300">SRE practices and SLI/SLO definition</li>
        <li class="text-slate-300">Monitoring and observability stack setup</li>
        <li class="text-slate-300">Developer experience optimization</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Deploy 100x faster with automated pipelines</li>
        <li class="text-slate-300">Reduce infrastructure costs by 40%</li>
        <li class="text-slate-300">Improve system reliability to 99.99%</li>
        <li class="text-slate-300">Free developers from operational burden</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$45,000 project</p>
