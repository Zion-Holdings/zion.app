...
export const metadata: Metadata = {
  ...
  keywords: 'Sub-second query on billions of rows, Streaming ingestion (Kafka, Kinesis, Pub/Sub), Pre-aggregation and materialized views, Real-time dashboard builder, SQL-compatible query interface, Multi-tenant with data isolation, ClickHouse, Apache Druid, Apache Pinot support, data, Analytics, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Real-Time Analytics Engine</h1>
        <p className="text-lg text-slate-300 mb-8">Sub-second analytics on streaming data with pre-aggregation, materialized views, and real-time dashboards. ClickHouse, Druid, or Pinot managed service.</p>
        ...
        <li class="text-slate-300">Sub-second query on billions of rows</li>
        <li class="text-slate-300">Streaming ingestion (Kafka, Kinesis, Pub/Sub)</li>
        <li class="text-slate-300">Pre-aggregation and materialized views</li>
        <li class="text-slate-300">Real-time dashboard builder</li>
        <li class="text-slate-300">SQL-compatible query interface</li>
        <li class="text-slate-300">Multi-tenant with data isolation</li>
        <li class="text-slate-300">ClickHouse, Apache Druid, Apache Pinot support</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Query billions of rows in under a second</li>
        <li class="text-slate-300">Real-time dashboards from streaming data</li>
        <li class="text-slate-300">SQL-compatible, no new query language</li>
        <li class="text-slate-300">Pre-aggregation reduces compute costs</li>
      </ul>
        </div>
