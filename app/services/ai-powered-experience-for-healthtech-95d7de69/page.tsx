...
export const metadata: Metadata = {
  title: 'AI-Powered Experience for HEALTHTECH',
  description: 'Transform your healthtech operations with our AI-Powered Experience for HEALTHTECH. This AI-driven solution automates background checks with unprecedented accur',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Experience for HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthtech operations with our AI-Powered Experience for HEALTHTECH. This AI-driven solution automates background checks with unprecedented accuracy and efficiency.
          </p>
