...
export const metadata: Metadata = {
  title: 'Self-Optimizing Suite for Cleantech',
  description: 'Transform your cleantech operations with our Self-Optimizing Suite for Cleantech. This AI-driven solution automates security monitoring with unprecedented accur',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Suite for Cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your cleantech operations with our Self-Optimizing Suite for Cleantech. This AI-driven solution automates security monitoring with unprecedented accuracy and efficiency.
          </p>
