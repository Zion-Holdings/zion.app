...
export const metadata: Metadata = {
  title: 'Platform Predictive - Proptech',
  description: 'Transform your proptech operations with our Platform Predictive - Proptech. This AI-driven solution automates security monitoring with unprecedented accuracy an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Platform Predictive - Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your proptech operations with our Platform Predictive - Proptech. This AI-driven solution automates security monitoring with unprecedented accuracy and efficiency.
          </p>
