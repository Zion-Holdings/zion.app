...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Marketing - Hospitality',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Marketing - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Hyper-Accelerated Marketing - Hospitality. This AI-powered platform transforms data fabric into a competitive advantage.
          </p>
