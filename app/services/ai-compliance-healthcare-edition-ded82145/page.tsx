...
export const metadata: Metadata = {
  title: 'AI Compliance - Healthcare Edition',
  description: 'Transform your healthcare operations with our AI Compliance - Healthcare Edition. This AI-driven solution automates data pipeline orchestration with unprecedent',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-compliance-healthcare-edition-ded82145',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Compliance - Healthcare Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our AI Compliance - Healthcare Edition. This AI-driven solution automates data pipeline orchestration with unprecedented accuracy and efficiency.
          </p>
