...
export const metadata: Metadata = {
  title: 'Intelligent predictor-education',
  description: 'The future of education is here with Intelligent predictor-education. Powered by cutting-edge AI, this platform delivers market intelligence like never before.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent predictor-education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of education is here with Intelligent predictor-education. Powered by cutting-edge AI, this platform delivers market intelligence like never before.
          </p>
