...
export const metadata: Metadata = {
  title: 'Autonomous Suite for Real-Estate #1',
  description: 'Next-generation real-estate solution: Autonomous Suite for Real-Estate #1. Combines supply chain with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-suite-for-real-estate-1-75692ac1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Suite for Real-Estate #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation real-estate solution: Autonomous Suite for Real-Estate #1. Combines supply chain with adaptive intelligence for optimal results.
          </p>
