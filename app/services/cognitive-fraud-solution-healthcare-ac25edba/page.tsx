...
export const metadata: Metadata = {
  title: 'Cognitive Fraud Solution - Healthcare',
  description: 'The future of healthcare is here with Cognitive Fraud Solution - Healthcare. Powered by cutting-edge AI, this platform delivers renewal prediction like never be',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-fraud-solution-healthcare-ac25edba',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Fraud Solution - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Cognitive Fraud Solution - Healthcare. Powered by cutting-edge AI, this platform delivers renewal prediction like never before.
          </p>
