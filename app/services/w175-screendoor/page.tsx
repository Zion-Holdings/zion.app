...
export const metadata: Metadata = {
  ...
  keywords: 'Feature toggle management, Progressive and canary rollouts, Segment targeting (user, geo, device, custom), A/B testing with statistical significance, Kill switch for instant rollback, Server-side SDK (sub-5ms evaluation), Integration with LaunchDarkly, Unleash, Statsig, micro-saas, Developer Tools, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">ScreenDoor — Feature Flag Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Feature flags and progressive rollouts: toggle features, A/B test, canary releases, and kill switches. Target by segment, gradual rollout, and instant rollback.</p>
        ...
        <li class="text-slate-300">Feature toggle management</li>
        <li class="text-slate-300">Progressive and canary rollouts</li>
        <li class="text-slate-300">Segment targeting (user, geo, device, custom)</li>
        <li class="text-slate-300">A/B testing with statistical significance</li>
        <li class="text-slate-300">Kill switch for instant rollback</li>
        <li class="text-slate-300">Server-side SDK (sub-5ms evaluation)</li>
        <li class="text-slate-300">Integration with LaunchDarkly, Unleash, Statsig</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Deploy with confidence using feature flags</li>
        <li class="text-slate-300">Canary releases limit blast radius</li>
        <li class="text-slate-300">Kill switch rolls back in milliseconds</li>
        <li class="text-slate-300">Sub-5ms evaluation, zero performance impact</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$15/mo</p>
