...
export const metadata: Metadata = {
  title: 'Automated Marketing for Hospitality',
  description: 'The future of hospitality is here with Automated Marketing for Hospitality. Powered by cutting-edge AI, this platform delivers customer insights like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-marketing-for-hospitality-ac119a9b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Marketing for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Automated Marketing for Hospitality. Powered by cutting-edge AI, this platform delivers customer insights like never before.
          </p>
