...
export const metadata: Metadata = {
  title: 'AI Platform - Sports Edition',
  description: 'Optimize your sports workflows with AI Platform - Sports Edition. This intelligent platform delivers pipeline management through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-platform-sports-edition-852eb409',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Platform - Sports Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your sports workflows with AI Platform - Sports Edition. This intelligent platform delivers pipeline management through advanced automation and AI.
          </p>
