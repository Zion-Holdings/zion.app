...
export const metadata: Metadata = {
  title: 'Smart HR Recruitment Serverless (Blockchain)',
  description: 'Smart HR Recruitment Serverless (Blockchain) is an AI-powered blockchain solution that transforms how businesses operate through intelligent automation and real',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-hr-recruitment-serverles-8f770a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart HR Recruitment Serverless (Blockchain)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Smart HR Recruitment Serverless (Blockchain) is an AI-powered blockchain solution that transforms how businesses operate through intelligent automation and real-time analytics.
...
Hadoop, Fastify, IoT, TensorFlow, Azure, Serverless
