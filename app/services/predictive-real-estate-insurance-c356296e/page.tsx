...
export const metadata: Metadata = {
  title: 'Predictive real estate-insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Predictive real estate-insurance leverages advanced machine learning to deliver root cause analysis ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive real estate-insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Predictive real estate-insurance leverages advanced machine learning to deliver root cause analysis at scale.
          </p>
