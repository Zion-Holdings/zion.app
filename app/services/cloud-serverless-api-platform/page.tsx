...
export const metadata: Metadata = {
  ...
  keywords: 'Auto-scaling — handles 10 to 10 000 000 RPS without configuration change, Serverless HTTP workers Node.js, Python, Go, Rust with edge deployment, Built-in REST + GraphQL API, schema validation, auto-generated OpenAPI spec, Auto-deploy CI/CD pipelines per-branch with staging environments, Auth: OAuth2, API keys, mTLS — all configurable via dashboard, cloud, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Serverless API Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Zero-infrastructure serverless REST + GraphQL API layer: auto-scales to millions of RPS, pay-per-invocation billing, built-in authentication, rate-limiting, caching, and observability. Includes free tier and CI/CD auto-deploy from Git.</p>
        ...
        <li class="text-slate-300">Auto-scaling — handles 10 to 10 000 000 RPS without configuration change</li>
        <li class="text-slate-300">Serverless HTTP workers Node.js, Python, Go, Rust with edge deployment</li>
        <li class="text-slate-300">Built-in REST + GraphQL API, schema validation, auto-generated OpenAPI spec</li>
        <li class="text-slate-300">Auto-deploy CI/CD pipelines per-branch with staging environments</li>
        <li class="text-slate-300">Auth: OAuth2, API keys, mTLS — all configurable via dashboard</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with serverless api platform</li>
