...
export const metadata: Metadata = {
  title: 'Enterprise Machine Learning - Construction',
  description: 'Next-generation construction solution: Enterprise Machine Learning - Construction. Combines sentiment analysis with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-machine-learning-construction-c0e9e261',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Machine Learning - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Enterprise Machine Learning - Construction. Combines sentiment analysis with adaptive intelligence for optimal results.
          </p>
