...
export const metadata: Metadata = {
  title: 'AI DevOps - Hospitality Edition',
  description: 'Revolutionize hospitality through intelligent automation. Our AI DevOps - Hospitality Edition leverages advanced machine learning to deliver business intelligen',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-devops-hospitality-edition-6421eed9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI DevOps - Hospitality Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our AI DevOps - Hospitality Edition leverages advanced machine learning to deliver business intelligence at scale.
          </p>
