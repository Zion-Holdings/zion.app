...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time simulation, Predictive maintenance, Quality optimization, Production planning, Energy optimization, What-if analysis, 3D visualization, IoT integration, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Create digital twins of manufacturing processes. Real-time simulation, predictive maintenance, quality optimization, and production planning with AI-driven insights.</p>
        ...
        <li class="text-slate-300">Quality optimization</li>
        <li class="text-slate-300">Production planning</li>
        ...
        <li class="text-slate-300">IoT integration</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">30% less unplanned downtime</li>
        <li class="text-slate-300">15% quality improvement</li>
        <li class="text-slate-300">Energy optimization</li>
        <li class="text-slate-300">Faster production planning</li>
        <li class="text-slate-300">Risk-free testing</li>
      </ul>
        </div>
