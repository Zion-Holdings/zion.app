...
export const metadata: Metadata = {
  title: 'Smart Generator Platform - Insurance',
  description: 'Optimize your insurance workflows with Smart Generator Platform - Insurance. This intelligent platform delivers resource utilization through advanced automation',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-generator-platform-insurance-d5c86d46',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Generator Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Smart Generator Platform - Insurance. This intelligent platform delivers resource utilization through advanced automation and AI.
          </p>
