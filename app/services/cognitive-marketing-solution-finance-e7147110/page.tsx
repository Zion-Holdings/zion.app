...
export const metadata: Metadata = {
  title: 'Cognitive Marketing Solution - Finance',
  description: 'Optimize your finance workflows with Cognitive Marketing Solution - Finance. This intelligent platform delivers brand sentiment through advanced automation and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-marketing-solution-finance-e7147110',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Marketing Solution - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your finance workflows with Cognitive Marketing Solution - Finance. This intelligent platform delivers brand sentiment through advanced automation and AI.
          </p>
