...
export const metadata: Metadata = {
  title: 'Autonomous Manufacturing System - Healthcare',
  description: 'Drive innovation in healthcare with Autonomous Manufacturing System - Healthcare. This AI-powered platform transforms workflow management into a competitive adv',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Manufacturing System - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with Autonomous Manufacturing System - Healthcare. This AI-powered platform transforms workflow management into a competitive advantage.
          </p>
