...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time curriculum adaptation per learner, Knowledge graph mastery modeling, Spaced repetition & retrieval practice scheduling, Adaptive assessment generation & scoring, Multi-modal content delivery (video, text, interactive), Progress analytics & early intervention alerts, LMS integration (Canvas, Moodle, Blackboard), Accessibility compliance (WCAG 2.1 AA), ai, EdTech, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">AI-driven personalized learning that adapts curricula, pacing, and assessment difficulty in real time. Knowledge graph models each learner&#x27;s mastery, while spaced repetition and retrieval practice lock in retention — improving outcomes by 25-40%.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">ai</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">EdTech</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Real-time curriculum adaptation per learner</li>
        <li class="text-slate-300">Knowledge graph mastery modeling</li>
        <li class="text-slate-300">Spaced repetition &amp; retrieval practice scheduling</li>
        <li class="text-slate-300">Adaptive assessment generation &amp; scoring</li>
        <li class="text-slate-300">Multi-modal content delivery (video, text, interactive)</li>
        <li class="text-slate-300">Progress analytics &amp; early intervention alerts</li>
        <li class="text-slate-300">LMS integration (Canvas, Moodle, Blackboard)</li>
        <li class="text-slate-300">Accessibility compliance (WCAG 2.1 AA)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">25-40% improvement in learning outcomes</li>
        <li class="text-slate-300">Every student gets a personal tutor at scale</li>
        <li class="text-slate-300">Early intervention before students fall behind</li>
        <li class="text-slate-300">Instructor dashboards for class-level insights</li>
      </ul>
        </div>
