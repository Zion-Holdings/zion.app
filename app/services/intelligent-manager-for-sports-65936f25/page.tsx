...
export const metadata: Metadata = {
  title: 'Intelligent Manager for Sports',
  description: 'Next-generation sports solution: Intelligent Manager for Sports. Combines performance monitoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-manager-for-sports-65936f25',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Manager for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation sports solution: Intelligent Manager for Sports. Combines performance monitoring with adaptive intelligence for optimal results.
          </p>
