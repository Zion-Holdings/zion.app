...
export const metadata: Metadata = {
  title: 'Smart Monitoring for Insurance',
  description: 'Transform your insurance operations with our Smart Monitoring for Insurance. This AI-driven solution automates code optimization with unprecedented accuracy and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-monitoring-for-insurance-16c7e97f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Monitoring for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Smart Monitoring for Insurance. This AI-driven solution automates code optimization with unprecedented accuracy and efficiency.
          </p>
