...
export const metadata: Metadata = {
  ...
  keywords: 'Automated clause extraction & classification, Risk scoring with explanations & citations, Template comparison & deviation analysis, Redline & markup suggestion generation, 50+ document type support (NDA, SaaS, M&A, etc.), Obligation extraction & deadline tracking, Multi-language contract analysis, Integration with CLM platforms (Ironclad, DocuSign), ai, Legal, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Powered Legal Document Analyzer</h1>
        <p className="text-lg text-slate-300 mb-8">Intelligent contract review at scale — extracts clauses, evaluates risk, compares against gold-standard templates, and generates redline suggestions. Handles 50+ document types from NDAs to M&amp;A agreements, cutting legal review costs by 70%.</p>
        ...
        <li class="text-slate-300">Automated clause extraction &amp; classification</li>
        <li class="text-slate-300">Risk scoring with explanations &amp; citations</li>
        <li class="text-slate-300">Template comparison &amp; deviation analysis</li>
        <li class="text-slate-300">Redline &amp; markup suggestion generation</li>
        <li class="text-slate-300">50+ document type support (NDA, SaaS, M&amp;A, etc.)</li>
        <li class="text-slate-300">Obligation extraction &amp; deadline tracking</li>
        <li class="text-slate-300">Multi-language contract analysis</li>
        <li class="text-slate-300">Integration with CLM platforms (Ironclad, DocuSign)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">70% reduction in legal review costs</li>
        <li class="text-slate-300">Never miss a risky clause again</li>
        <li class="text-slate-300">Standardize contracts across the organization</li>
        <li class="text-slate-300">Accelerate deal cycles from weeks to days</li>
      </ul>
        </div>
