...
export const metadata: Metadata = {
  title: 'Risk Cognitive - Finance',
  description: 'Enhance your finance business with Risk Cognitive - Finance. Our solution provides financial risk management with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/risk-cognitive-finance-92752086',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Risk Cognitive - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your finance business with Risk Cognitive - Finance. Our solution provides financial risk management with enterprise-grade reliability and security.
          </p>
