...
export const metadata: Metadata = {
  title: 'Processor AI - Hospitality',
  description: 'The future of hospitality is here with Processor AI - Hospitality. Powered by cutting-edge AI, this platform delivers social media monitoring like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/processor-ai-hospitality-0d2149ed',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Processor AI - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Processor AI - Hospitality. Powered by cutting-edge AI, this platform delivers social media monitoring like never before.
          </p>
