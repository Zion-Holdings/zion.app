...
export const metadata: Metadata = {
  title: 'AI-Powered Decision for Hospitality',
  description: 'Drive innovation in hospitality with AI-Powered Decision for Hospitality. This AI-powered platform transforms audit trail management into a competitive advantag',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Decision for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with AI-Powered Decision for Hospitality. This AI-powered platform transforms audit trail management into a competitive advantage.
          </p>
