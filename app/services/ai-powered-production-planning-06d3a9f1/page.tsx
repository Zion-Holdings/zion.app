...
export const metadata: Metadata = {
  ...
  description: 'Optimizes production schedules considering demand forecasts, machine availability, and material constraints.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-production-planning-06d3a9f1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimizes production schedules considering demand forecasts, machine availability, and material constraints.
          </p>
