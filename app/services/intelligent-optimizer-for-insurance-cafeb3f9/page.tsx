...
export const metadata: Metadata = {
  title: 'Intelligent Optimizer for Insurance',
  description: 'Drive innovation in insurance with Intelligent Optimizer for Insurance. This AI-powered platform transforms recruitment automation into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-optimizer-for-insurance-cafeb3f9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Optimizer for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Intelligent Optimizer for Insurance. This AI-powered platform transforms recruitment automation into a competitive advantage.
          </p>
