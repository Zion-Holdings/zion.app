...
export const metadata: Metadata = {
  title: 'Autonomous Experience System - Insurance',
  description: 'Enhance your insurance business with Autonomous Experience System - Insurance. Our solution provides stream processing with enterprise-grade reliability and sec',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-experience-system-insurance-411f794b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Experience System - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Autonomous Experience System - Insurance. Our solution provides stream processing with enterprise-grade reliability and security.
          </p>
