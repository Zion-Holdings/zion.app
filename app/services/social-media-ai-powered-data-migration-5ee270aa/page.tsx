...
export const metadata: Metadata = {
  title: 'Social Media AI-Powered Data Migration',
  description: 'AI-powered social media solution for data engineering. Intelligent data migration planning and execution.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/social-media-ai-powered-data-migration-5ee270aa',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Social Media AI-Powered Data Migration
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered social media solution for data engineering. Intelligent data migration planning and execution.
          </p>
