...
export const metadata = {
  title: "Predictive Industry-Specific Sustainability Risk Scoring - Zion Tech Group",
  description: "Predictive risk scoring engine that assesses industry-specific sustainability vulnerabilities with machine learning.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/predictive-industry-specific-sustainability-risk-scoring-7252d5c5`
  }
};
