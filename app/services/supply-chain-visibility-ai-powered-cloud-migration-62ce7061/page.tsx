...
export const metadata: Metadata = {
  title: 'Supply Chain Visibility AI-Powered Cloud Migration',
  description: 'AI-powered supply chain visibility solution for cloud migration. Intelligent cloud migration planning and execution.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/supply-chain-visibility-ai-powered-cloud-migration-62ce7061',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Supply Chain Visibility AI-Powered Cloud Migration
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered supply chain visibility solution for cloud migration. Intelligent cloud migration planning and execution.
          </p>
