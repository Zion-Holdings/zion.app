...
export const metadata: Metadata = {
  title: 'Manufacturing Intelligent - Tech',
  description: 'Revolutionize technology through intelligent automation. Our Manufacturing Intelligent - Tech leverages advanced machine learning to deliver enterprise-grade in',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/manufacturing-intelligent-tech-4123c0f1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our Manufacturing Intelligent - Tech leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
