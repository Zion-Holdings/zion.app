...
export const metadata: Metadata = {
  title: 'Smart Analytics Platform - Logistics #1',
  description: 'Transform your logistics operations with our Smart Analytics Platform - Logistics #1. This AI-driven solution automates customer retention with unprecedented ac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-analytics-platform-logistics-1-a48fe651',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Analytics Platform - Logistics #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Smart Analytics Platform - Logistics #1. This AI-driven solution automates customer retention with unprecedented accuracy and efficiency.
          </p>
