...
export const metadata: Metadata = {
  ...
  description: 'content management solution for water parks industry. Automatically detects, corrects, and prevents data quality issues using machine learning.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/content-management-ai-powered-data-quality-manager-a6b4d19c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            content management solution for water parks industry. Automatically detects, corrects, and prevents data quality issues using machine learning.
          </p>
