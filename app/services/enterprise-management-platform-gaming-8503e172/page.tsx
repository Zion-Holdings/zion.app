...
export const metadata: Metadata = {
  title: 'Enterprise Management Platform - Gaming',
  description: 'Revolutionize gaming through intelligent automation. Our Enterprise Management Platform - Gaming leverages advanced machine learning to deliver financial risk m',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-management-platform-gaming-8503e172',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Management Platform - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize gaming through intelligent automation. Our Enterprise Management Platform - Gaming leverages advanced machine learning to deliver financial risk management at scale.
          </p>
