...
export const metadata: Metadata = {
  title: 'Enterprise Experience Platform - REGTECH',
  description: 'Drive innovation in regtech with Enterprise Experience Platform - REGTECH. This AI-powered platform transforms decision support into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-experience-platform-regtech-56dee0c4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Experience Platform - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in regtech with Enterprise Experience Platform - REGTECH. This AI-powered platform transforms decision support into a competitive advantage.
          </p>
