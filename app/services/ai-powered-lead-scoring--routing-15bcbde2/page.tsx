...
export const metadata: Metadata = {
  title: 'AI-Powered Lead Scoring & Routing',
  description: 'Scores and routes sales leads in real-time based on engagement.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-lead-scoring--routing-15bcbde2',
  },

export const metadata = {
  title: "AI-Powered Lead Scoring & Routing - Zion Tech Group",
  description: "Scores and routes sales leads in real-time based on engagement.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-lead-scoring--routing-15bcbde2`
  }
  ...
  return (
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Scores and routes sales leads in real-time based on engagement.
          </p>
    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">AI-Powered Lead Scoring &amp; Routing</h1>
        <p className="text-lg text-gray-300 mb-8">Scores and routes sales leads in real-time based on engagement.</p>
