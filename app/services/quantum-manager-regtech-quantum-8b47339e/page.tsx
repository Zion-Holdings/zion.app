...
export const metadata: Metadata = {
  title: 'Quantum Manager - REGTECH Quantum',
  description: 'Transform your regtech operations with our Quantum Manager - REGTECH Quantum. This AI-driven solution automates employee engagement with unprecedented accuracy ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Manager - REGTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your regtech operations with our Quantum Manager - REGTECH Quantum. This AI-driven solution automates employee engagement with unprecedented accuracy and efficiency.
          </p>
