...
export const metadata: Metadata = {
  title: 'Cognitive Compliance Suite',
  description: 'Transform your gaming operations with our Cognitive Compliance Suite. This AI-driven solution automates content generation with unprecedented accuracy and effic',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-compliance-suite-84f549db',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Compliance Suite
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your gaming operations with our Cognitive Compliance Suite. This AI-driven solution automates content generation with unprecedented accuracy and efficiency.
          </p>
