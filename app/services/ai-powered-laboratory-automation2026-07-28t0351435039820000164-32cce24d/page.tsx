...
export const metadata: Metadata = {
  title: 'AI-Powered Laboratory Automation',
  description: 'Automates laboratory processes with sample tracking and analysis.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-laboratory-automation2026-07-28t0351435039820000164-32cce24d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automates laboratory processes with sample tracking and analysis.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Lab automation</li>
          <li className="text-gray-300">Sample tracking</li>
          <li className="text-gray-300">Analysis</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">60% faster testing</li>
