...
export const metadata = {
  ...
  description: 'End-to-end ai code review automation: security, style, and architecture gates services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/ai-code-review-automation-security-style-and-architecture-gates-6/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">AI Code Review Automation: Security, Style, and Architecture Gates</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end ai code review automation: security, style, and architecture gates services: assessment, deployment, and managed operations.
        </p>
