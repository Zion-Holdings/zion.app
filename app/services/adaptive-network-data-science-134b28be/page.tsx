...
export const metadata: Metadata = {
  title: 'Adaptive Network Data Science',
  description: 'The future of logistics is here with Adaptive Network Data Science. Powered by cutting-edge AI, this platform delivers performance reviews like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-network-data-science-134b28be',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Network Data Science
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Adaptive Network Data Science. Powered by cutting-edge AI, this platform delivers performance reviews like never before.
          </p>
