...
export const metadata: Metadata = {
  title: 'Intelligent DevOps for Agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Intelligent DevOps for Agriculture leverages advanced machine learning to deliver lead scoring at ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-devops-for-agriculture-a83bea8d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent DevOps for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Intelligent DevOps for Agriculture leverages advanced machine learning to deliver lead scoring at scale.
          </p>
