...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Decision - Hospitality',
  description: 'Drive innovation in hospitality with Hyper-Accelerated Decision - Hospitality. This AI-powered platform transforms business intelligence into a competitive adva',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/hyper-accelerated-decision-hospitality-5fcd571f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Decision - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Hyper-Accelerated Decision - Hospitality. This AI-powered platform transforms business intelligence into a competitive advantage.
          </p>
