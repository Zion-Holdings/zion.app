...
export const metadata: Metadata = {
  title: 'AI-Powered suite-tech',
  description: 'Transform your technology operations with our AI-Powered suite-tech. This AI-driven solution automates supply chain with unprecedented accuracy and efficiency.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-suite-tech-282d1c6e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered suite-tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your technology operations with our AI-Powered suite-tech. This AI-driven solution automates supply chain with unprecedented accuracy and efficiency.
          </p>
