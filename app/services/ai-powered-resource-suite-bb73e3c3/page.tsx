...
export const metadata: Metadata = {
  title: 'AI-Powered Resource Suite',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Resource Suite
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in transportation with AI-Powered Resource Suite. This AI-powered platform transforms anomaly detection into a competitive advantage.
          </p>
