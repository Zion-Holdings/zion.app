...
export const metadata: Metadata = {
  title: 'Intelligent Resource Support',
  description: 'Transform your insurance operations with our Intelligent Resource Support. This AI-driven solution automates resource utilization with unprecedented accuracy an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-resource-support-c1261c69',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Resource Support
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Intelligent Resource Support. This AI-driven solution automates resource utilization with unprecedented accuracy and efficiency.
          </p>
