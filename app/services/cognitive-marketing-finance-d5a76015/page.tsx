...
export const metadata: Metadata = {
  title: 'Cognitive marketing-finance',
  description: 'Drive innovation in finance with Cognitive marketing-finance. This AI-powered platform transforms maintenance scheduling into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-marketing-finance-d5a76015',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive marketing-finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in finance with Cognitive marketing-finance. This AI-powered platform transforms maintenance scheduling into a competitive advantage.
          </p>
