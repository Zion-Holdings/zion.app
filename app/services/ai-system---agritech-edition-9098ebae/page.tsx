...
export const metadata: Metadata = {
  title: 'AI System - Agritech Edition',
  description: 'The future of agritech is here with AI System - Agritech Edition. Powered by cutting-edge AI, this platform delivers inventory management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-system---agritech-edition-9098ebae',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI System - Agritech Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agritech is here with AI System - Agritech Edition. Powered by cutting-edge AI, this platform delivers inventory management like never before.
          </p>
