...
export const metadata: Metadata = {
  title: 'Enterprise Master Supply',
  description: 'Hyper-accelerated althealth solution: Enterprise Master Supply. Combines master data management with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-master-supply-8967d845',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Master Supply
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated althealth solution: Enterprise Master Supply. Combines master data management with next-gen AI for maximum velocity.
          </p>
