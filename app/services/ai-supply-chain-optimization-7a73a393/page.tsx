...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-supply-chain-optimization-7a73a393',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your supply chain operations?</p>
