...
export const metadata: Metadata = {
  title: 'Enterprise Supply Platform - Telecom',
  description: 'Next-generation telecom solution: Enterprise Supply Platform - Telecom. Combines fleet management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-supply-platform-telecom-ff842c37',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Supply Platform - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation telecom solution: Enterprise Supply Platform - Telecom. Combines fleet management with adaptive intelligence for optimal results.
          </p>
