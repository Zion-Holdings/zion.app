...
export const metadata: Metadata = {
  title: 'Intelligent Compliance for Retail #1',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Compliance for Retail #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Intelligent Compliance for Retail #1. Powered by cutting-edge AI, this platform delivers market intelligence like never before.
          </p>
