...
export const metadata: Metadata = {
  title: 'Automated Orchestrator for Legal',
  description: 'Transform your legal operations with our Automated Orchestrator for Legal. This AI-driven solution automates language processing with unprecedented accuracy and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-orchestrator-for-legal-427b7a65',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Orchestrator for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Automated Orchestrator for Legal. This AI-driven solution automates language processing with unprecedented accuracy and efficiency.
          </p>
