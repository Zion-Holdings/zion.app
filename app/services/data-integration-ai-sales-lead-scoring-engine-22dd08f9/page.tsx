...
export const metadata: Metadata = {
  title: 'Data Integration AI Sales Lead Scoring Engine',
  description: 'data integration solution for pharmaceuticals industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-integration-ai-sales-lead-scoring-engine-22dd08f9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Integration AI Sales Lead Scoring Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            data integration solution for pharmaceuticals industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.
          </p>
