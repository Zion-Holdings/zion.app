...
export const metadata: Metadata = {
  title: 'Supply Cognitive - Healthcare',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Supply Cognitive - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Supply Cognitive - Healthcare. Combines ml model training with adaptive intelligence for optimal results.
          </p>
