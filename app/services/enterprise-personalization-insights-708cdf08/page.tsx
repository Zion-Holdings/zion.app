...
export const metadata: Metadata = {
  title: 'Enterprise Personalization Insights',
  description: 'Drive innovation in media with Enterprise Personalization Insights. This AI-powered platform transforms performance reviews into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-personalization-insights-708cdf08',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Personalization Insights
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in media with Enterprise Personalization Insights. This AI-powered platform transforms performance reviews into a competitive advantage.
          </p>
