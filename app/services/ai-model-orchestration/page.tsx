      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Intelligent Model Routing</li>
            <li className="text-purple-300">✓ Fallback & Resilience</li>
            <li className="text-purple-300">✓ Cost & Latency Optimization</li>
            <li className="text-purple-300">✓ Unified API Layer</li>
            <li className="text-purple-300">✓ A/B Testing & Evaluation</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai model orchestration</li>
