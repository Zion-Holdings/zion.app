...
export const metadata: Metadata = {
  ...
  keywords: 'Application portfolio assessment, Technology roadmap development, Target architecture design, Integration architecture planning, TOGAF and ArchiMate frameworks, Cloud readiness assessment, Cost-benefit analysis, Executive presentation decks, it, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Enterprise Architecture as a Service</h1>
        <p className="text-lg text-slate-300 mb-8">Strategic enterprise architecture consulting and tooling. Technology roadmap, application portfolio rationalization, and target architecture design for digital transformation.</p>
        ...
        <li class="text-slate-300">Technology roadmap development</li>
        <li class="text-slate-300">Target architecture design</li>
        <li class="text-slate-300">Integration architecture planning</li>
        <li class="text-slate-300">TOGAF and ArchiMate frameworks</li>
        <li class="text-slate-300">Cloud readiness assessment</li>
        <li class="text-slate-300">Cost-benefit analysis</li>
        <li class="text-slate-300">Executive presentation decks</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Align IT with business strategy</li>
        <li class="text-slate-300">Reduce technical debt</li>
        <li class="text-slate-300">Optimize technology spend</li>
        <li class="text-slate-300">Accelerate digital transformation</li>
      </ul>
        </div>
