...
export const metadata: Metadata = {
  title: 'Next-Gen Orchestrator for Agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Next-Gen Orchestrator for Agriculture leverages advanced machine learning to deliver survey automa',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Orchestrator for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Next-Gen Orchestrator for Agriculture leverages advanced machine learning to deliver survey automation at scale.
          </p>
