...
export const metadata: Metadata = {
  title: 'Quantum Quality - ALTHEALTH Quantum',
  description: 'Transform your althealth operations with our Quantum Quality - ALTHEALTH Quantum. This AI-driven solution automates quantum computing with unprecedented accurac',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Quality - ALTHEALTH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your althealth operations with our Quantum Quality - ALTHEALTH Quantum. This AI-driven solution automates quantum computing with unprecedented accuracy and efficiency.
          </p>
