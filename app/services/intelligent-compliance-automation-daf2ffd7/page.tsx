...
export const metadata: Metadata = {
  ...
  keywords: 'Regulatory monitoring, Audit automation, Violation detection, Remediation guidance, compliance, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Intelligent Compliance Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Automated compliance platform that monitors, audits, and enforces regulatory requirements.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">compliance</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">technology</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Regulatory monitoring</li>
        <li class="text-slate-300">Audit automation</li>
        <li class="text-slate-300">Violation detection</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Full compliance coverage</li>
        <li class="text-slate-300">Reduced audit burden</li>
