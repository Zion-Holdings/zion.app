...
export const metadata: Metadata = {
  ...
  keywords: 'Golden record creation, Data matching and merging, Data quality scoring, Hierarchy management, Workflow-based stewardship, Integration with ERP, CRM, SCM, Data governance policies, Audit trail and lineage, data, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Master Data Management (MDM) Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Centralized master data management for customers, products, suppliers, and more. Data quality, matching, merging, and governance across all enterprise systems.</p>
        ...
        <li class="text-slate-300">Golden record creation</li>
        <li class="text-slate-300">Data matching and merging</li>
        <li class="text-slate-300">Data quality scoring</li>
        <li class="text-slate-300">Hierarchy management</li>
        <li class="text-slate-300">Workflow-based stewardship</li>
        <li class="text-slate-300">Integration with ERP, CRM, SCM</li>
        <li class="text-slate-300">Data governance policies</li>
        <li class="text-slate-300">Audit trail and lineage</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Single source of truth for master data</li>
        <li class="text-slate-300">Improve data quality by 80%</li>
        <li class="text-slate-300">Reduce data duplication</li>
        <li class="text-slate-300">Enable 360-degree customer view</li>
      </ul>
        </div>
