...
export const metadata: Metadata = {
  title: 'Autonomous Generator System - Finance',
  description: 'Revolutionize finance through intelligent automation. Our Autonomous Generator System - Finance leverages advanced machine learning to deliver document processi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-generator-system-finance-70601d86',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Generator System - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our Autonomous Generator System - Finance leverages advanced machine learning to deliver document processing at scale.
          </p>
