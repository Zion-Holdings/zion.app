...
export const metadata: Metadata = {
  title: 'Adaptive smart-real-estate',
  description: 'Enhance your real-estate business with Adaptive smart-real-estate. Our solution provides user provisioning with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-smart-real-estate-9009def8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive smart-real-estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your real-estate business with Adaptive smart-real-estate. Our solution provides user provisioning with enterprise-grade reliability and security.
          </p>
