...
export const metadata: Metadata = {
  title: 'AI Advisor - Proptech Edition #1',
  description: 'The future of proptech is here with AI Advisor - Proptech Edition #1. Powered by cutting-edge AI, this platform delivers process automation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-advisor---proptech-edition-1-0054b1e4',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Advisor - Proptech Edition #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with AI Advisor - Proptech Edition #1. Powered by cutting-edge AI, this platform delivers process automation like never before.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your proptech operations?</p>
