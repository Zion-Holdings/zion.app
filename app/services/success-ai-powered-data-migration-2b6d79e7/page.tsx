...
export const metadata: Metadata = {
  title: 'Success AI-Powered Data Migration',
  description: 'AI-powered success solution for data engineering. Intelligent data migration planning and execution.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/success-ai-powered-data-migration-2b6d79e7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Success AI-Powered Data Migration
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered success solution for data engineering. Intelligent data migration planning and execution.
          </p>
