...
export const metadata: Metadata = {
  title: "AI Energy Demand Forecasting Engine - AI-Powered Energy Solution",
  description: "AI-powered energy solution leveraging advanced machine learning for optimal performance and ROI.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-energy-demand-forecasting-engine-f055f16c",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI Energy Demand Forecasting Engine - AI-Powered Energy Solution
        </h1>
