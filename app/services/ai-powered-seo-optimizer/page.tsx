...
export const metadata: Metadata = {
  ...
  keywords: 'On-page SEO scoring (0-100), Competitor gap analysis, Automated meta title/description generation, Readability improvement suggestions, Schema.org structured data suggestions, ai, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Powered SEO Content Optimizer</h1>
        <p className="text-lg text-slate-300 mb-8">Real-time SEO analysis and content optimization: auto-suggest keywords, restructure sentences for readability, generate meta tags, and audit for E-E-A-T signals.</p>
        ...
        <li class="text-slate-300">On-page SEO scoring (0-100)</li>
        <li class="text-slate-300">Competitor gap analysis</li>
        <li class="text-slate-300">Automated meta title/description generation</li>
        <li class="text-slate-300">Readability improvement suggestions</li>
        <li class="text-slate-300">Schema.org structured data suggestions</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai-powered seo content optimizer</li>
