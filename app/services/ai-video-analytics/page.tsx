...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time object detection & tracking, People counting & heatmaps, License plate recognition (ANPR), Behavioral anomaly detection, Privacy-blur compliance mode, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Video Analytics</h1>
        <p className="text-lg text-slate-300 mb-8">Real-time video content analysis for security, retail insights, and operational intelligence using computer vision.</p>
        ...
        <li class="text-slate-300">Real-time object detection &amp; tracking</li>
        <li class="text-slate-300">People counting &amp; heatmaps</li>
        <li class="text-slate-300">License plate recognition (ANPR)</li>
        <li class="text-slate-300">Behavioral anomaly detection</li>
        <li class="text-slate-300">Privacy-blur compliance mode</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai video analytics</li>
