...
export const metadata: Metadata = {
  ...
  keywords: 'Adaptive curriculum generation, AI tutoring with Socratic method, Skill gap analysis, Spaced repetition scheduling, Multi-modal content (video, text, interactive), Progress analytics dashboard, LMS integration (SCORM, xAPI), Certification tracking, ai, Education, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Adaptive learning platform that creates personalized curricula based on individual learning styles, goals, and progress. AI tutors, skill assessments, and spaced repetition for corporate training and education.</p>
        ...
        <li class="text-slate-300">Adaptive curriculum generation</li>
        <li class="text-slate-300">AI tutoring with Socratic method</li>
        <li class="text-slate-300">Skill gap analysis</li>
        <li class="text-slate-300">Spaced repetition scheduling</li>
        <li class="text-slate-300">Multi-modal content (video, text, interactive)</li>
        <li class="text-slate-300">Progress analytics dashboard</li>
        <li class="text-slate-300">LMS integration (SCORM, xAPI)</li>
        <li class="text-slate-300">Certification tracking</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">3x faster skill acquisition</li>
        <li class="text-slate-300">Personalized at scale</li>
        <li class="text-slate-300">Reduce training costs</li>
        <li class="text-slate-300">Measurable skill improvement</li>
      </ul>
        </div>
