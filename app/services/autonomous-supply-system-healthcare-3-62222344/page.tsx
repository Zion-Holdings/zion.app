...
export const metadata: Metadata = {
  title: 'Autonomous Supply System - Healthcare #3',
  description: 'Transform your healthcare operations with our Autonomous Supply System - Healthcare #3. This AI-driven solution automates cost reduction with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-supply-system-healthcare-3-62222344',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Supply System - Healthcare #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Autonomous Supply System - Healthcare #3. This AI-driven solution automates cost reduction with unprecedented accuracy and efficiency.
          </p>
