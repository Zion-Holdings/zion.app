...
export const metadata: Metadata = {
  title: 'Intelligent Intelligence for AITECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Intelligence for AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your aitech business with Intelligent Intelligence for AITECH. Our solution provides roi tracking with enterprise-grade reliability and security.
          </p>
