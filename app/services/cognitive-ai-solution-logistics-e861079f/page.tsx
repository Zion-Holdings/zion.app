...
export const metadata: Metadata = {
  title: 'Cognitive AI Solution - Logistics',
  description: 'Enhance your logistics business with Cognitive AI Solution - Logistics. Our solution provides business continuity with enterprise-grade reliability and security',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-ai-solution-logistics-e861079f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive AI Solution - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with Cognitive AI Solution - Logistics. Our solution provides business continuity with enterprise-grade reliability and security.
          </p>
