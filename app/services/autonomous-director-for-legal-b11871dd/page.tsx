...
export const metadata: Metadata = {
  title: 'Autonomous Director for Legal',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Director for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Autonomous Director for Legal leverages advanced machine learning to deliver workflow management at scale.
          </p>
