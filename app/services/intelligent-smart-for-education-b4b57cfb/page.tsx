...
export const metadata: Metadata = {
  title: 'Intelligent Smart for Education',
  description: 'Transform your education operations with our Intelligent Smart for Education. This AI-driven solution automates data pipeline orchestration with unprecedented a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Smart for Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your education operations with our Intelligent Smart for Education. This AI-driven solution automates data pipeline orchestration with unprecedented accuracy and efficiency.
          </p>
