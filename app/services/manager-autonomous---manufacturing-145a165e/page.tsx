...
export const metadata = {
  ...
  description: "Transform your Manufacturing operations with our Manager Autonomous - Manufacturing. This AI-driven solution automates energy management with unprecedented accu",
  alternates: {
