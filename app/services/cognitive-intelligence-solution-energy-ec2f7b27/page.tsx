...
export const metadata: Metadata = {
  ...
  description: 'Drive innovation in energy with Cognitive Intelligence Solution - Energy. This AI-powered platform transforms performance monitoring into a competitive advantag',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-intelligence-solution-energy-ec2f7b27',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Cognitive Intelligence Solution - Energy. This AI-powered platform transforms performance monitoring into a competitive advantage.
          </p>
