...
export const metadata: Metadata = {
  title: 'Autonomous Generator System - CLEANTECH',
  description: 'Quantum leap forward for cleantech: Autonomous Generator System - CLEANTECH. Uses quantum-inspired algorithms to deliver model interpretability at exponential s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-generator-system-cleantech-f670f1f1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Generator System - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for cleantech: Autonomous Generator System - CLEANTECH. Uses quantum-inspired algorithms to deliver model interpretability at exponential speed.
          </p>
