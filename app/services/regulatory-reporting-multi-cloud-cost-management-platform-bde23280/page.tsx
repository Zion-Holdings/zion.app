...
export const metadata: Metadata = {
  title: 'Regulatory Reporting Multi-Cloud Cost Management Platform',
  description: 'regulatory reporting solution for cosmetics industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/regulatory-reporting-multi-cloud-cost-management-platform-bde23280',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Regulatory Reporting Multi-Cloud Cost Management Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            regulatory reporting solution for cosmetics industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.
          </p>
