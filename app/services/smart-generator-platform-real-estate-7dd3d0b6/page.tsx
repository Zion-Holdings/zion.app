...
export const metadata: Metadata = {
  title: 'Smart Generator Platform - Real-Estate',
  description: 'Enhance your real-estate business with Smart Generator Platform - Real-Estate. Our solution provides supply chain with enterprise-grade reliability and security',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-generator-platform-real-estate-7dd3d0b6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Generator Platform - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your real-estate business with Smart Generator Platform - Real-Estate. Our solution provides supply chain with enterprise-grade reliability and security.
          </p>
