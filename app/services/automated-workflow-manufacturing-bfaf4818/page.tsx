...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize education through intelligent automation. Our Automated Workflow Manufacturing leverages advanced machine learning to deliver sales forecasting at',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize education through intelligent automation. Our Automated Workflow Manufacturing leverages advanced machine learning to deliver sales forecasting at scale.
          </p>
