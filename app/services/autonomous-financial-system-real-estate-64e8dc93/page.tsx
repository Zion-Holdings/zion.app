...
export const metadata: Metadata = {
  title: 'Autonomous Financial System - Real-Estate',
  description: 'Enhance your real-estate business with Autonomous Financial System - Real-Estate. Our solution provides talent acquisition with enterprise-grade reliability and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-financial-system-real-estate-64e8dc93',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Financial System - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your real-estate business with Autonomous Financial System - Real-Estate. Our solution provides talent acquisition with enterprise-grade reliability and security.
          </p>
