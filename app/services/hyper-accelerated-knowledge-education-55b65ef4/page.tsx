...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Knowledge - Education',
  description: 'Revolutionize education through intelligent automation. Our Hyper-Accelerated Knowledge - Education leverages advanced machine learning to deliver leave managem',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Knowledge - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize education through intelligent automation. Our Hyper-Accelerated Knowledge - Education leverages advanced machine learning to deliver leave management at scale.
          </p>
