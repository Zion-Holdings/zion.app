...
export const metadata: Metadata = {
  title: 'Cognitive Support Solution - Sports',
  description: 'Transform your sports operations with our Cognitive Support Solution - Sports. This AI-driven solution automates automation opportunity with unprecedented accur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-support-solution-sports-6b63d798',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Support Solution - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our Cognitive Support Solution - Sports. This AI-driven solution automates automation opportunity with unprecedented accuracy and efficiency.
          </p>
