...
export const metadata: Metadata = {
  title: 'Intelligent User for Agriculture',
  description: 'Enhance your agriculture business with Intelligent User for Agriculture. Our solution provides compliance monitoring with enterprise-grade reliability and secur',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent User for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your agriculture business with Intelligent User for Agriculture. Our solution provides compliance monitoring with enterprise-grade reliability and security.
          </p>
