...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Financial - Education',
  description: 'Quantum leap forward for education: Hyper-Accelerated Financial - Education. Uses quantum-inspired algorithms to deliver executive dashboards at exponential spe',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Financial - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for education: Hyper-Accelerated Financial - Education. Uses quantum-inspired algorithms to deliver executive dashboards at exponential speed.
          </p>
