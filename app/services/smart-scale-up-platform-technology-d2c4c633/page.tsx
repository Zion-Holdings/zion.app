...
export const metadata: Metadata = {
  title: 'Smart Scale-up Platform - TECHNOLOGY',
  description: 'Transform your technology operations with our Smart Scale-up Platform - TECHNOLOGY. This AI-driven solution automates loyalty optimization with unprecedented ac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-scale-up-platform-technology-d2c4c633',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Scale-up Platform - TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your technology operations with our Smart Scale-up Platform - TECHNOLOGY. This AI-driven solution automates loyalty optimization with unprecedented accuracy and efficiency.
          </p>
