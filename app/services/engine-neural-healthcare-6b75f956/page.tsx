...
export const metadata: Metadata = {
  title: 'Engine Neural - Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Engine Neural - Healthcare leverages advanced machine learning to deliver process automation at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Engine Neural - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Engine Neural - Healthcare leverages advanced machine learning to deliver process automation at scale.
          </p>
