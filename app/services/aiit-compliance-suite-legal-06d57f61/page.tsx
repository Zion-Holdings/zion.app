...
export const metadata: Metadata = {
  title: 'AI/IT Compliance Suite - Legal',
  description: 'Optimize your legal workflows with AI/IT Compliance Suite - Legal. This intelligent platform delivers personalization engine through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-compliance-suite-legal-06d57f61',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Compliance Suite - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with AI/IT Compliance Suite - Legal. This intelligent platform delivers personalization engine through advanced automation and AI.
          </p>
