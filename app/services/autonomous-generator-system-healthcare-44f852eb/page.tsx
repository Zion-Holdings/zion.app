...
export const metadata: Metadata = {
  title: 'Autonomous Generator System - Healthcare',
  description: 'Enhance your healthcare business with Autonomous Generator System - Healthcare. Our solution provides employee engagement with enterprise-grade reliability and ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Generator System - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with Autonomous Generator System - Healthcare. Our solution provides employee engagement with enterprise-grade reliability and security.
          </p>
