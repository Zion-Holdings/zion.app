...
export const metadata: Metadata = {
  ...
  keywords: 'Prometheus + Thanos long-term store, Grafana OSS with 400+ dashboards, Loki logs + Tempo traces (shared tenant ID), Pre-built alert rules per service/database, PagerDuty/OpsGenie on-call routing, cloud, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Observability Stack as a Service</h1>
        <p className="text-lg text-slate-300 mb-8">Pre-integrated Prometheus+Grafana+Loki+Tempo stack with 400+ dashboards, alert rules pre-built, and PagerDuty/OpsGenie on-call.</p>
        ...
        <li class="text-slate-300">Prometheus + Thanos long-term store</li>
        <li class="text-slate-300">Grafana OSS with 400+ dashboards</li>
        <li class="text-slate-300">Loki logs + Tempo traces (shared tenant ID)</li>
        <li class="text-slate-300">Pre-built alert rules per service/database</li>
        <li class="text-slate-300">PagerDuty/OpsGenie on-call routing</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with observability stack as a service</li>
