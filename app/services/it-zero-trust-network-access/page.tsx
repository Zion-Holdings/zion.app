...
export const metadata = {
  ...
  description: "Implement zero trust security architecture with identity-aware micro-segmentation, continuous device trust verification, and least-privilege access controls. Re",
  alternates: {
