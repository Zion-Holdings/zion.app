...
export const metadata: Metadata = {
  title: 'Cognitive quality-construction',
  description: 'Revolutionize construction through intelligent automation. Our Cognitive quality-construction leverages advanced machine learning to deliver data quality at sca',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-quality-construction-d2236b74',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive quality-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Cognitive quality-construction leverages advanced machine learning to deliver data quality at scale.
          </p>
