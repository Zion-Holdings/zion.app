...
export const metadata: Metadata = {
  title: 'Smart Fraud Platform - Construction',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Fraud Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Smart Fraud Platform - Construction. This AI-powered platform transforms regulatory tracking into a competitive advantage.
          </p>
