...
export const metadata: Metadata = {
  title: 'Cognitive Data Predictive',
  description: 'Revolutionize construction through intelligent automation. Our Cognitive Data Predictive leverages advanced machine learning to deliver data processing at scale',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-data-predictive-5b5ec72a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Data Predictive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Cognitive Data Predictive leverages advanced machine learning to deliver data processing at scale.
          </p>
