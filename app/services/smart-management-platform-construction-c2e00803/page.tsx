...
export const metadata: Metadata = {
  title: 'Smart Management Platform - Construction',
  description: 'Revolutionize construction through intelligent automation. Our Smart Management Platform - Construction leverages advanced machine learning to deliver market in',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Management Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Smart Management Platform - Construction leverages advanced machine learning to deliver market intelligence at scale.
          </p>
