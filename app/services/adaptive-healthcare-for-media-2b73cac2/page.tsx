...
export const metadata: Metadata = {
  title: 'Adaptive Healthcare for Media',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Healthcare for Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of media is here with Adaptive Healthcare for Media. Powered by cutting-edge AI, this platform delivers market intelligence like never before.
          </p>
