...
export const metadata: Metadata = {
  title: 'Smart Advisor Platform - Energy #1',
  description: 'Enhance your energy business with Smart Advisor Platform - Energy #1. Our solution provides social media monitoring with enterprise-grade reliability and securi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Advisor Platform - Energy #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your energy business with Smart Advisor Platform - Energy #1. Our solution provides social media monitoring with enterprise-grade reliability and security.
          </p>
