...
export const metadata: Metadata = {
  title: 'Automated Healthcare Sales',
  description: 'Transform your telecom operations with our Automated Healthcare Sales. This AI-driven solution automates risk assessment with unprecedented accuracy and efficie',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Healthcare Sales
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your telecom operations with our Automated Healthcare Sales. This AI-driven solution automates risk assessment with unprecedented accuracy and efficiency.
          </p>
