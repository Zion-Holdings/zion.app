...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={@context: "https://schema.org", @type: "Service", name: "AI Ad Copy Generator | Zion Tech Group", description: "End-to-end ai ad copy generator services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/ai-ad-copy-generator-2026-8446/"} />
