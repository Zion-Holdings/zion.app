...
export const metadata: Metadata = {
  ...
  keywords: 'Dealer management system integration, Inventory and vehicle lifecycle tracking, Service appointment and workshop scheduling, Warranty claim processing automation, Connected vehicle data ingestion, Customer communication (service reminders), Integration with CDK, Reynolds, DMS platforms, automation, Automotive, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Automotive &amp; Mobility Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Automate automotive operations: dealer management, inventory, service scheduling, warranty claims, and connected vehicle data processing.</p>
        ...
        <li class="text-slate-300">Dealer management system integration</li>
        <li class="text-slate-300">Inventory and vehicle lifecycle tracking</li>
        <li class="text-slate-300">Service appointment and workshop scheduling</li>
        <li class="text-slate-300">Warranty claim processing automation</li>
        <li class="text-slate-300">Connected vehicle data ingestion</li>
        <li class="text-slate-300">Customer communication (service reminders)</li>
        <li class="text-slate-300">Integration with CDK, Reynolds, DMS platforms</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Inventory optimized across dealer network</li>
        <li class="text-slate-300">Service scheduling maximizes workshop utilization</li>
        <li class="text-slate-300">Warranty automation reduces claim cycle time</li>
        <li class="text-slate-300">Connected vehicle data drives insights</li>
      </ul>
        </div>
