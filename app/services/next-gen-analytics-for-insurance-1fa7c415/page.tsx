...
export const metadata: Metadata = {
  title: 'Next-Gen Analytics for Insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Analytics for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Next-Gen Analytics for Insurance. Our solution provides ml model training with enterprise-grade reliability and security.
          </p>
