...
export const metadata: Metadata = {
  title: 'Smart Experience Suite - Ecommerce',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Experience Suite - Ecommerce
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your ecommerce with Smart Experience Suite - Ecommerce. Our autonomous solution handles resource utilization end-to-end without human intervention.
          </p>
