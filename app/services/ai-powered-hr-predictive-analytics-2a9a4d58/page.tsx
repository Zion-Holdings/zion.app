...
export const metadata: Metadata = {
  title: "AI-Powered HR Predictive Analytics - AI-Powered HR Solution",
  description: "AI-powered hr solution leveraging advanced machine learning for optimal performance and ROI.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-hr-predictive-analytics-2a9a4d58",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered HR Predictive Analytics - AI-Powered HR Solution
        </h1>
