...
export const metadata: Metadata = {
  ...
  keywords: 'Scheduled report generation, Dynamic parameter and date range, Multi-format output (PDF, Excel, HTML, CSV), Delivery to email, Slack, Teams, portals, Exception-based reporting (only when thresholds breach), Self-service report builder, Integration with any SQL database and API, data, Business Intelligence, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Automated Reporting Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Automate report generation and distribution: scheduled reports, dynamic parameters, multi-format output, and delivery to email, Slack, and portals.</p>
        ...
        <li class="text-slate-300">Scheduled report generation</li>
        <li class="text-slate-300">Dynamic parameter and date range</li>
        <li class="text-slate-300">Multi-format output (PDF, Excel, HTML, CSV)</li>
        <li class="text-slate-300">Delivery to email, Slack, Teams, portals</li>
        <li class="text-slate-300">Exception-based reporting (only when thresholds breach)</li>
        <li class="text-slate-300">Self-service report builder</li>
        <li class="text-slate-300">Integration with any SQL database and API</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Eliminate manual report creation</li>
        <li class="text-slate-300">Exception reporting reduces noise</li>
        <li class="text-slate-300">Multi-format for different audiences</li>
        <li class="text-slate-300">Self-service reduces analyst requests</li>
      </ul>
        </div>
