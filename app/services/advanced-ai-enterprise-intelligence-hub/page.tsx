      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Unify generative AI, autonomous agents, multimodal intelligence, RAG, governance, observability, and enterprise copilots into a single advanced AI ...
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Unified Advanced AI Fabric</li>
            <li className="text-purple-300">✓ Enterprise-Grade Governance & Trust</li>
            <li className="text-purple-300">✓ Cross-Provider Model Orchestration</li>
            <li className="text-purple-300">✓ Production-Ready RAG & Knowledge Systems</li>
            <li className="text-purple-300">✓ Enterprise Copilots and Assistants</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with advanced ai & enterprise intelligence hub</li>
