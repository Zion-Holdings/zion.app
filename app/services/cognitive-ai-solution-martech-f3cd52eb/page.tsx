...
export const metadata: Metadata = {
  title: 'Cognitive AI Solution - MARTECH',
  description: 'Transform your martech operations with our Cognitive AI Solution - MARTECH. This AI-driven solution automates inventory optimization with unprecedented accuracy',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-ai-solution-martech-f3cd52eb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive AI Solution - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your martech operations with our Cognitive AI Solution - MARTECH. This AI-driven solution automates inventory optimization with unprecedented accuracy and efficiency.
          </p>
