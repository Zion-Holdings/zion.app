  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Legal Document Drafting &amp; Automation</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered legal document drafting that generates contracts, NDAs, and legal letters from templates and natural language descriptions. Reduce drafting time by 90%.</p>
        ...
        <li class="text-slate-300">AI document generation from templates</li>
        <li class="text-slate-300">Natural language to contract conversion</li>
        <li class="text-slate-300">Clause library with 1000+ pre-approved clauses</li>
        <li class="text-slate-300">Redline and comparison tools</li>
        <li class="text-slate-300">Integration with DocuSign and CLM systems</li>
        <li class="text-slate-300">Custom template builder</li>
        <li class="text-slate-300">Version control and approval workflows</li>
        <li class="text-slate-300">Compliance checking against jurisdiction requirements</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Draft legal documents 90% faster</li>
        <li class="text-slate-300">Reduce legal drafting costs by 70%</li>
        <li class="text-slate-300">Ensure consistency with approved clauses</li>
        <li class="text-slate-300">Scale legal operations without adding attorneys</li>
      </ul>
        </div>
