...
export const metadata: Metadata = {
  title: 'Enterprise Revenue Platform - Logistics',
  description: 'Transform your logistics operations with our Enterprise Revenue Platform - Logistics. This AI-driven solution automates process discovery with unprecedented acc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-revenue-platform-logistics-0304495c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Revenue Platform - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Enterprise Revenue Platform - Logistics. This AI-driven solution automates process discovery with unprecedented accuracy and efficiency.
          </p>
