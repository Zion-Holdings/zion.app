...
export const metadata: Metadata = {
  title: 'Intelligent Enterprise for CLEANTECH',
  description: 'Next-generation cleantech solution: Intelligent Enterprise for CLEANTECH. Combines account planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-enterprise-for-cleantech-e3712a6e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Enterprise for CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation cleantech solution: Intelligent Enterprise for CLEANTECH. Combines account planning with adaptive intelligence for optimal results.
          </p>
