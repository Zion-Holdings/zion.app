...
export const metadata: Metadata = {
  title: 'Next-Gen Security for HEALTHTECH',
  description: 'Optimize your healthtech workflows with Next-Gen Security for HEALTHTECH. This intelligent platform delivers revenue forecasting through advanced automation and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-security-for-healthtech-00dd01ab',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Security for HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthtech workflows with Next-Gen Security for HEALTHTECH. This intelligent platform delivers revenue forecasting through advanced automation and AI.
          </p>
