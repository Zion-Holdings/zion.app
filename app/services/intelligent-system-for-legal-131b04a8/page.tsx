...
export const metadata: Metadata = {
  title: 'Intelligent System for Legal',
  description: 'Optimize your legal workflows with Intelligent System for Legal. This intelligent platform delivers container orchestration through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-system-for-legal-131b04a8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent System for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with Intelligent System for Legal. This intelligent platform delivers container orchestration through advanced automation and AI.
          </p>
