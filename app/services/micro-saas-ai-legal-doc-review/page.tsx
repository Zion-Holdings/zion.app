...
export const metadata: Metadata = {
  ...
  keywords: 'Bulk document upload and AI classification, Key clause extraction and risk flagging, Redline comparison between document versions, M&A due diligence checklist automation, Regulatory compliance gap analysis, Privilege log generation for litigation, Integration with legal practice management tools, Audit trail and version history, ai, legal-tech, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Legal Document Review &amp; Due Diligence</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered legal document review for M&amp;A due diligence, contract analysis, and compliance review. Reduces review time by 90% while improving accuracy.</p>
        ...
        <li class="text-slate-300">Bulk document upload and AI classification</li>
        <li class="text-slate-300">Key clause extraction and risk flagging</li>
        <li class="text-slate-300">Redline comparison between document versions</li>
        <li class="text-slate-300">M&amp;A due diligence checklist automation</li>
        <li class="text-slate-300">Regulatory compliance gap analysis</li>
        <li class="text-slate-300">Privilege log generation for litigation</li>
        <li class="text-slate-300">Integration with legal practice management tools</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce document review time by 90%</li>
        <li class="text-slate-300">Catch risky clauses human reviewers miss</li>
        <li class="text-slate-300">Accelerate M&amp;A due diligence timelines</li>
        <li class="text-slate-300">Lower legal review costs by 60%</li>
      </ul>
        </div>
