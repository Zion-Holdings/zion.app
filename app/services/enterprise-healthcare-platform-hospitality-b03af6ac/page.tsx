...
export const metadata: Metadata = {
  title: 'Enterprise Healthcare Platform - Hospitality',
  description: 'Unlock unprecedented growth with Enterprise Healthcare Platform - Hospitality. This autonomous system provides lakehouse architecture with zero manual intervent',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-healthcare-platform-hospitality-b03af6ac',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Healthcare Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Enterprise Healthcare Platform - Hospitality. This autonomous system provides lakehouse architecture with zero manual intervention needed.
          </p>
