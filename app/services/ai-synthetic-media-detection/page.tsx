...
export const metadata: Metadata = {
  ...
  keywords: 'AI text detection (GPT, Claude, Gemini), Image provenance analysis, Video deepfake detection, Audio voice clone detection, API for real-time scanning, Browser extension for content verification, Batch scanning for enterprises, Confidence scoring with explanations, ai, Cybersecurity, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Synthetic Media Detection Suite</h1>
        <p className="text-lg text-slate-300 mb-8">Detect AI-generated text, images, video, and audio. Protect against deepfakes, AI-written content fraud, and synthetic identity attacks.</p>
        ...
        <li class="text-slate-300">AI text detection (GPT, Claude, Gemini)</li>
        <li class="text-slate-300">Image provenance analysis</li>
        <li class="text-slate-300">Video deepfake detection</li>
        <li class="text-slate-300">Audio voice clone detection</li>
        <li class="text-slate-300">API for real-time scanning</li>
        <li class="text-slate-300">Browser extension for content verification</li>
        <li class="text-slate-300">Batch scanning for enterprises</li>
        <li class="text-slate-300">Confidence scoring with explanations</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Protect against AI fraud</li>
        <li class="text-slate-300">Verify content authenticity</li>
        <li class="text-slate-300">Meet regulatory requirements</li>
        <li class="text-slate-300">Brand and reputation protection</li>
      </ul>
        </div>
