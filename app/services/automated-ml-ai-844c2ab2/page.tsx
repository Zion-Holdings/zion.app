...
export const metadata: Metadata = {
  title: 'Automated ML AI',
  description: 'Next-generation insurance solution: Automated ML AI. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-ml-ai-844c2ab2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Automated ML AI. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
