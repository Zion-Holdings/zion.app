...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "AI Email Intelligence | Zion Tech Group", description: "End-to-end ai email intelligence services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/ai-email-intelligence-2026-7666/"}} />
