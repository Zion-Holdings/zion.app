...
export const metadata: Metadata = {
  ...
  description: 'automated solution for proptech industry. Monitors market trends, competitor activities, and industry news to provide actionable insights.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-ai-powered-market-intelligence-e39af0ea',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            automated solution for proptech industry. Monitors market trends, competitor activities, and industry news to provide actionable insights.
          </p>
