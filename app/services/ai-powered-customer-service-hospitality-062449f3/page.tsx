...
export const metadata: Metadata = {
  title: 'AI-Powered customer service-hospitality',
  description: 'Next-generation hospitality solution: AI-Powered customer service-hospitality. Combines disaster recovery with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-customer-service-hospitality-062449f3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered customer service-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: AI-Powered customer service-hospitality. Combines disaster recovery with adaptive intelligence for optimal results.
          </p>
