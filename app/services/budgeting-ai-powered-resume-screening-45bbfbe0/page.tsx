...
export const metadata: Metadata = {
  title: 'Budgeting AI-Powered Resume Screening',
  description: 'AI-powered budgeting solution for hr. Automates candidate screening using NLP and skills matching.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/budgeting-ai-powered-resume-screening-45bbfbe0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Budgeting AI-Powered Resume Screening
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered budgeting solution for hr. Automates candidate screening using NLP and skills matching.
          </p>
