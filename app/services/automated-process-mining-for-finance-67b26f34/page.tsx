...
export const metadata: Metadata = {
  title: 'Automated Process Mining for Finance',
  description: 'The future of finance is here with Automated Process Mining for Finance. Powered by cutting-edge AI, this platform delivers transformative results like never be',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-process-mining-for-finance-67b26f34',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Process Mining for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of finance is here with Automated Process Mining for Finance. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
