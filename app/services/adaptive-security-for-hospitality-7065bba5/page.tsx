...
export const metadata: Metadata = {
  title: 'Adaptive Security for Hospitality',
  description: 'Transform your hospitality operations with our Adaptive Security for Hospitality. This AI-driven solution automates risk assessment with unprecedented accuracy ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-security-for-hospitality-7065bba5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Security for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Adaptive Security for Hospitality. This AI-driven solution automates risk assessment with unprecedented accuracy and efficiency.
          </p>
