...
export const metadata: Metadata = {
  title: 'Neural Performance Intelligence',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation education solution: Neural Performance Intelligence. Combines workflow management with adaptive intelligence for optimal results.
          </p>
