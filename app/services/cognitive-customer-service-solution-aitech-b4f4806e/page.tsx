...
export const metadata: Metadata = {
  title: 'Cognitive Customer Service Solution - AITECH',
  description: 'Optimize your aitech workflows with Cognitive Customer Service Solution - AITECH. This intelligent platform delivers code optimization through advanced automati',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Customer Service Solution - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your aitech workflows with Cognitive Customer Service Solution - AITECH. This intelligent platform delivers code optimization through advanced automation and AI.
          </p>
