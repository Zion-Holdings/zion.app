...
export const metadata: Metadata = {
  title: 'Next-Gen User - Real-Estate',
  description: 'Enhance your real-estate business with Next-Gen User - Real-Estate. Our solution provides influencer identification with enterprise-grade reliability and securi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen User - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your real-estate business with Next-Gen User - Real-Estate. Our solution provides influencer identification with enterprise-grade reliability and security.
          </p>
