...
export const metadata: Metadata = {
  title: 'Cloud-Native Root Business Intelligence',
  description: 'Transform your ecommerce operations with our Cloud-Native Root Business Intelligence. This AI-driven solution automates resource allocation with unprecedented a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cloud-Native Root Business Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your ecommerce operations with our Cloud-Native Root Business Intelligence. This AI-driven solution automates resource allocation with unprecedented accuracy and efficiency.
          </p>
