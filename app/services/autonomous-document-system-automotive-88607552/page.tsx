...
export const metadata: Metadata = {
  title: 'Autonomous Document System - Automotive',
  description: 'Enhance your automotive business with Autonomous Document System - Automotive. Our solution provides model interpretability with enterprise-grade reliability an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-document-system-automotive-88607552',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Document System - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your automotive business with Autonomous Document System - Automotive. Our solution provides model interpretability with enterprise-grade reliability and security.
          </p>
