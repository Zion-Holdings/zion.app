      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your finance business with Predictive Predictive - Finance. Our solution provides customer onboarding with enterprise-grade reliability and security.
          </p>
