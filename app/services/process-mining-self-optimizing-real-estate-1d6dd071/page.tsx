...
export const metadata: Metadata = {
  title: 'Process Mining Self-Optimizing - Real-Estate',
  description: 'Optimize your real-estate workflows with Process Mining Self-Optimizing - Real-Estate. This intelligent platform delivers quality control through advanced autom',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Process Mining Self-Optimizing - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your real-estate workflows with Process Mining Self-Optimizing - Real-Estate. This intelligent platform delivers quality control through advanced automation and AI.
          </p>
