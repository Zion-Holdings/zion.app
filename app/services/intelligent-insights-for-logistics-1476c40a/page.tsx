...
export const metadata: Metadata = {
  ...
  keywords: 'API-first design, Open-source friendly, Serverless functions, Cloud-native architecture, SOC 2 certified, optimizer, logistics, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Intelligent Insights for Logistics</h1>
        <p className="text-lg text-slate-300 mb-8">Next-generation logistics solution: Intelligent Insights for Logistics. Combines workflow management with adaptive intelligence for optimal results.</p>
