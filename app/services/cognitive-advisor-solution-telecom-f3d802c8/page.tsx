...
export const metadata: Metadata = {
  title: 'Cognitive Advisor Solution - Telecom',
  description: 'Transform your telecom operations with our Cognitive Advisor Solution - Telecom. This AI-driven solution automates quality assurance with unprecedented accuracy',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Advisor Solution - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your telecom operations with our Cognitive Advisor Solution - Telecom. This AI-driven solution automates quality assurance with unprecedented accuracy and efficiency.
          </p>
