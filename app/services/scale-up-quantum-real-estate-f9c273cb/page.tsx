...
export const metadata: Metadata = {
  title: 'Scale-up Quantum - Real-Estate',
  description: 'Transform your real-estate operations with our Scale-up Quantum - Real-Estate. This AI-driven solution automates learning management with unprecedented accuracy',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Scale-up Quantum - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Scale-up Quantum - Real-Estate. This AI-driven solution automates learning management with unprecedented accuracy and efficiency.
          </p>
