...
export const metadata: Metadata = {
  title: 'AI-Powered Patient Safety Management',
  description: 'Manages patient safety with incident detection and prevention.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-patient-safety-management2026-07-28t0356460584380000161-9c2b8d6b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Patient Safety Management
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Manages patient safety with incident detection and prevention.
          </p>
