...
export const metadata: Metadata = {
  ...
  description: 'Next-generation construction solution: Cognitive Process Mining Solution - Construction. Combines automation opportunity with adaptive intelligence for optimal ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Cognitive Process Mining Solution - Construction. Combines automation opportunity with adaptive intelligence for optimal results.
          </p>
