...
export const metadata: Metadata = {
  title: 'DevOps Predictive - Healthtech',
  description: 'Transform your healthtech operations with our DevOps Predictive - Healthtech. This AI-driven solution automates customer retention with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/devops-predictive-healthtech-7e415aa5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            DevOps Predictive - Healthtech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthtech operations with our DevOps Predictive - Healthtech. This AI-driven solution automates customer retention with unprecedented accuracy and efficiency.
          </p>
