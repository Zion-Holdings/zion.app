...
export const metadata: Metadata = {
  ...
  description: 'Generates and optimizes Terraform/CloudFormation templates from architecture diagrams.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-infrastructure-as-code-e9ad78d1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Generates and optimizes Terraform/CloudFormation templates from architecture diagrams.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Template optimization</li>
          <li className="text-gray-300">Drift detection</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">Infrastructure as code</li>
