...
export const metadata: Metadata = {
  title: 'Autonomous Quota System - Energy',
  description: 'Revolutionize energy through intelligent automation. Our Autonomous Quota System - Energy leverages advanced machine learning to deliver fraud prevention at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Quota System - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Autonomous Quota System - Energy leverages advanced machine learning to deliver fraud prevention at scale.
          </p>
