...
export const metadata: Metadata = {
  ...
  keywords: 'Auto-transcription, Action item extraction, Decision tracking, Speaker identification, Calendar integration, Searchable archive, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Micro-SAAS AI Meeting Minutes Generator</h1>
        <p className="text-lg text-slate-300 mb-8">Automatically generates structured meeting minutes from video/audio recordings. AI identifies action items, decisions, and key discussion points.</p>
        ...
        <li class="text-slate-300">Auto-transcription</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Never take manual minutes</li>
        <li class="text-slate-300">100% capture of decisions</li>
        <li class="text-slate-300">Accountability through action items</li>
