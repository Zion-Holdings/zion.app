...
export const metadata: Metadata = {
  title: 'Predictive Enterprise Engine - HEALTHTECH',
  description: 'Transform your healthtech operations with our Predictive Enterprise Engine - HEALTHTECH. This AI-driven solution automates automation opportunity with unprecede',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Enterprise Engine - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthtech operations with our Predictive Enterprise Engine - HEALTHTECH. This AI-driven solution automates automation opportunity with unprecedented accuracy and efficiency.
          </p>
