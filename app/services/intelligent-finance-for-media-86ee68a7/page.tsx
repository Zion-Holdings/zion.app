...
export const metadata: Metadata = {
  title: 'Intelligent Finance for Media',
  description: 'Drive innovation in media with Intelligent Finance for Media. This AI-powered platform transforms data processing into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-finance-for-media-86ee68a7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Finance for Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in media with Intelligent Finance for Media. This AI-powered platform transforms data processing into a competitive advantage.
          </p>
