...
export const metadata: Metadata = {
  title: 'Autonomous Supply for Real-Estate',
  description: 'The future of real-estate is here with Autonomous Supply for Real-Estate. Powered by cutting-edge AI, this platform delivers transformative results like never b',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-supply-for-real-estate-6706fd64',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Supply for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of real-estate is here with Autonomous Supply for Real-Estate. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
