...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-OS patch support, Automated scheduling, Pre-deployment testing, Compliance reports, One-click rollback, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Patch Management</h1>
        <p className="text-lg text-slate-300 mb-8">Automated OS, firmware, and application patching across Windows, Linux, and macOS fleets with compliance reporting and rollback.</p>
        ...
        <li class="text-slate-300">Multi-OS patch support</li>
        <li class="text-slate-300">Automated scheduling</li>
        <li class="text-slate-300">Pre-deployment testing</li>
        <li class="text-slate-300">Compliance reports</li>
        <li class="text-slate-300">One-click rollback</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with patch management</li>
