...
export const metadata: Metadata = {
  title: 'Automated Director for Legal',
  description: 'Optimize your legal workflows with Automated Director for Legal. This intelligent platform delivers access management through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-director-for-legal-ffa8a755',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Director for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with Automated Director for Legal. This intelligent platform delivers access management through advanced automation and AI.
          </p>
