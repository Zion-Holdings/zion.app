...
export const metadata: Metadata = {
  title: 'Smart quality-healthcare',
  description: 'Drive innovation in healthcare with Smart quality-healthcare. This AI-powered platform transforms claims processing into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-quality-healthcare-307c9d59',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart quality-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with Smart quality-healthcare. This AI-powered platform transforms claims processing into a competitive advantage.
          </p>
