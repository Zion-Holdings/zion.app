...
export const metadata: Metadata = {
  ...
  keywords: 'Project scheduling and Gantt management, RFI and submittal workflow automation, Change order processing and tracking, Progress tracking with photo/video evidence, Safety inspection and compliance, Budget and cost tracking, Integration with Procore, Autodesk, PlanGrid, automation, Construction, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Construction Project Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Automate construction project management: scheduling, RFIs, change orders, progress tracking, and safety compliance. Keep projects on time and budget.</p>
        ...
        <li class="text-slate-300">Project scheduling and Gantt management</li>
        <li class="text-slate-300">RFI and submittal workflow automation</li>
        <li class="text-slate-300">Change order processing and tracking</li>
        <li class="text-slate-300">Progress tracking with photo/video evidence</li>
        <li class="text-slate-300">Safety inspection and compliance</li>
        <li class="text-slate-300">Budget and cost tracking</li>
        <li class="text-slate-300">Integration with Procore, Autodesk, PlanGrid</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">RFI turnaround reduced by 60%</li>
        <li class="text-slate-300">Change orders processed in days, not weeks</li>
        <li class="text-slate-300">Progress tracking with visual evidence</li>
        <li class="text-slate-300">Safety compliance automated and tracked</li>
      </ul>
        </div>
