...
export const metadata: Metadata = {
  title: 'Infrastructure Management Intelligent Document Processing AI',
  description: 'infrastructure management solution for petrochemicals industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing document',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/infrastructure-management-intelligent-document-processing-ai-d86f736f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Infrastructure Management Intelligent Document Processing AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            infrastructure management solution for petrochemicals industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.
          </p>
