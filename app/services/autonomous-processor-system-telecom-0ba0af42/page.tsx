...
export const metadata: Metadata = {
  title: 'Autonomous Processor System - Telecom',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Processor System - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your telecom business with Autonomous Processor System - Telecom. Our solution provides supply chain with enterprise-grade reliability and security.
          </p>
