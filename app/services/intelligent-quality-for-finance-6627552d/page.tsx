...
export const metadata: Metadata = {
  title: 'Intelligent Quality for Finance',
  description: 'Unlock unprecedented growth with Intelligent Quality for Finance. This autonomous system provides capacity management with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-quality-for-finance-6627552d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Quality for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Quality for Finance. This autonomous system provides capacity management with zero manual intervention needed.
          </p>
