...
export const metadata: Metadata = {
  title: 'Automated employee-edtech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated employee-edtech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your edtech business with Automated employee-edtech. Our solution provides campaign optimization with enterprise-grade reliability and security.
          </p>
