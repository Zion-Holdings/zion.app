...
export const metadata: Metadata = {
  ...
  keywords: 'Demand forecasting (SKU-level, multi-channel), Inventory optimization & safety stock calc, Automatic purchase order suggestions, What-if scenario modeling, Supplier lead time prediction, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Supply &amp; Demand Planner</h1>
        <p className="text-lg text-slate-300 mb-8">Demand forecasting, inventory optimization, and replenishment planning with AI-driven scenario modeling for manufacturing and retail.</p>
        ...
        <li class="text-slate-300">Demand forecasting (SKU-level, multi-channel)</li>
        <li class="text-slate-300">Inventory optimization &amp; safety stock calc</li>
        <li class="text-slate-300">Automatic purchase order suggestions</li>
        <li class="text-slate-300">What-if scenario modeling</li>
        <li class="text-slate-300">Supplier lead time prediction</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai supply &amp; demand planner</li>
