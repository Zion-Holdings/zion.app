...
export const metadata: Metadata = {
  title: 'Quantum Support - HEALTHTECH Quantum',
  description: 'The future of healthtech is here with Quantum Support - HEALTHTECH Quantum. Powered by cutting-edge AI, this platform delivers quality control like never before',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-support-healthtech-quantum-32686e6d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Support - HEALTHTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthtech is here with Quantum Support - HEALTHTECH Quantum. Powered by cutting-edge AI, this platform delivers quality control like never before.
          </p>
