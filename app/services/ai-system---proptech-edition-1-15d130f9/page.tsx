...
export const metadata: Metadata = {
  title: 'AI System - Proptech Edition #1',
  description: 'The future of proptech is here with AI System - Proptech Edition #1. Powered by cutting-edge AI, this platform delivers customer insights like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-system---proptech-edition-1-15d130f9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI System - Proptech Edition #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with AI System - Proptech Edition #1. Powered by cutting-edge AI, this platform delivers customer insights like never before.
          </p>
