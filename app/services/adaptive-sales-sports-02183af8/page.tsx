...
export const metadata: Metadata = {
  title: 'Adaptive sales-sports',
  description: 'Revolutionize sports through intelligent automation. Our Adaptive sales-sports leverages advanced machine learning to deliver healthcare data analytics at scale',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-sales-sports-02183af8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive sales-sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Adaptive sales-sports leverages advanced machine learning to deliver healthcare data analytics at scale.
          </p>
