...
export const metadata: Metadata = {
  title: 'AI Data - PROPTECH Edition',
  description: 'Transform your proptech operations with our AI Data - PROPTECH Edition. This AI-driven solution automates customer intelligence with unprecedented accuracy and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-data-proptech-edition-97209a38',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Data - PROPTECH Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your proptech operations with our AI Data - PROPTECH Edition. This AI-driven solution automates customer intelligence with unprecedented accuracy and efficiency.
          </p>
