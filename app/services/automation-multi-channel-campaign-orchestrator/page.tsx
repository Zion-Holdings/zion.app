...
export const metadata: Metadata = {
  ...
  keywords: 'Sequence builder with channel-branch logic, A/B test per touch, and configurable delay steps, Unified send and reply inbox — all channels in one conversation thread without context switching, Re-engagement window auto-switches channel per non-engaged status per subscriber, Campaign analytics per channel with path dropout funnel visualisation and MQL revenue tracking, automation, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Multi-Channel Campaign Orchestrator</h1>
        <p className="text-lg text-slate-300 mb-8">Orchestrate campaigns across email, SMS, WhatsApp, Telegram, and LinkedIn with sequence branching, per-channel A/B testing, delay per touchpoint, re-engagement windows, engaged versus unengaged segment filter, and unified inbound conversation inbox.</p>
        ...
        <li class="text-slate-300">Sequence builder with channel-branch logic, A/B test per touch, and configurable delay steps</li>
        <li class="text-slate-300">Unified send and reply inbox — all channels in one conversation thread without context switching</li>
        <li class="text-slate-300">Re-engagement window auto-switches channel per non-engaged status per subscriber</li>
        <li class="text-slate-300">Campaign analytics per channel with path dropout funnel visualisation and MQL revenue tracking</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with multi-channel campaign orchestrator</li>
