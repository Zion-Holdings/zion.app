...
export const metadata: Metadata = {
  title: 'Cognitive Advisor Solution - REGTECH',
  description: 'Transform your regtech operations with our Cognitive Advisor Solution - REGTECH. This AI-driven solution automates contract analysis with unprecedented accuracy',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Advisor Solution - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your regtech operations with our Cognitive Advisor Solution - REGTECH. This AI-driven solution automates contract analysis with unprecedented accuracy and efficiency.
          </p>
