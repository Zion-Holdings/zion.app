...
export const metadata: Metadata = {
  title: 'AI/IT Financial Suite - Telecom',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Financial Suite - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in telecom with AI/IT Financial Suite - Telecom. This AI-powered platform transforms hyperautomation into a competitive advantage.
          </p>
