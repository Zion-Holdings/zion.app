...
export const metadata: Metadata = {
  title: 'Management Smart - Edge',
  description: 'Unlock unprecedented growth with Management Smart - Edge. This autonomous system provides decision support with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/management-smart---edge-51ad88b3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Management Smart - Edge. This autonomous system provides decision support with zero manual intervention needed.
          </p>
