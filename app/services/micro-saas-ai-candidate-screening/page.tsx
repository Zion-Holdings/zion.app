...
export const metadata: Metadata = {
  ...
  keywords: 'AI resume parsing and ranking, AI video interview analysis, Skills assessment and testing, Bias detection and mitigation, Integration with Greenhouse, Lever, Workday, Custom scoring rubrics, Candidate experience analytics, Diversity and inclusion reporting, ai, hr-tech, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Candidate Screening &amp; Interview Platform</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered candidate screening that analyzes resumes, conducts video interviews, and ranks candidates based on job requirements. Reduce screening time by 90%.</p>
        ...
        <li class="text-slate-300">AI resume parsing and ranking</li>
        <li class="text-slate-300">AI video interview analysis</li>
        <li class="text-slate-300">Skills assessment and testing</li>
        ...
        <li class="text-slate-300">Custom scoring rubrics</li>
        <li class="text-slate-300">Candidate experience analytics</li>
        <li class="text-slate-300">Diversity and inclusion reporting</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Screen candidates 90% faster</li>
        <li class="text-slate-300">Reduce unconscious bias in hiring</li>
        <li class="text-slate-300">Improve quality of hire with AI matching</li>
        <li class="text-slate-300">Deliver better candidate experience</li>
      </ul>
        </div>
