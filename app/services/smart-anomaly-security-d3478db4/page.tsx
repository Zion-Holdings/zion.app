...
export const metadata: Metadata = {
  title: 'Smart Anomaly Security',
  description: 'The future of hospitality is here with Smart Anomaly Security. Powered by cutting-edge AI, this platform delivers sourcing optimization like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-anomaly-security-d3478db4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Anomaly Security
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Smart Anomaly Security. Powered by cutting-edge AI, this platform delivers sourcing optimization like never before.
          </p>
