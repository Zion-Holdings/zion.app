...
export const metadata: Metadata = {
  title: 'Smart Expense Platform - Transportation',
  description: 'Future-proof your transportation with Smart Expense Platform - Transportation. Our autonomous solution handles sales forecasting end-to-end without human interv',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Expense Platform - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your transportation with Smart Expense Platform - Transportation. Our autonomous solution handles sales forecasting end-to-end without human intervention.
          </p>
