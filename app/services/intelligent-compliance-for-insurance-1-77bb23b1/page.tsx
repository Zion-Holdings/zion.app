...
export const metadata: Metadata = {
  title: 'Intelligent Compliance for Insurance #1',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Compliance for Insurance #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Intelligent Compliance for Insurance #1. This AI-driven solution automates financial planning with unprecedented accuracy and efficiency.
          </p>
