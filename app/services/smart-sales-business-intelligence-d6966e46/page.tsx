...
export const metadata: Metadata = {
  title: 'Smart Sales Business Intelligence',
  description: 'Drive innovation in legal with Smart Sales Business Intelligence. This AI-powered platform transforms compliance reporting into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-sales-business-intelligence-d6966e46',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Sales Business Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Smart Sales Business Intelligence. This AI-powered platform transforms compliance reporting into a competitive advantage.
          </p>
