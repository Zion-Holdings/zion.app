...
export const metadata: Metadata = {
  title: 'Autonomous Cognitive - AITECH',
  description: 'The future of aitech is here with Autonomous Cognitive - AITECH. Powered by cutting-edge AI, this platform delivers data governance like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-cognitive-aitech-46005670',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Cognitive - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of aitech is here with Autonomous Cognitive - AITECH. Powered by cutting-edge AI, this platform delivers data governance like never before.
          </p>
