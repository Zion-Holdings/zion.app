...
export const metadata: Metadata = {
  title: 'Accounting AI-Powered Blockchain Analytics',
  description: 'AI-powered accounting solution for blockchain. Analyzes blockchain transactions and smart contracts using AI to detect patterns.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/accounting-ai-powered-blockchain-analytics-55f1da3d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Accounting AI-Powered Blockchain Analytics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered accounting solution for blockchain. Analyzes blockchain transactions and smart contracts using AI to detect patterns.
          </p>
