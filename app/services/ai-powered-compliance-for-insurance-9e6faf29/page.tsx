...
export const metadata: Metadata = {
  title: 'AI-Powered Compliance for Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our AI-Powered Compliance for Insurance leverages advanced machine learning to deliver process automatio',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-compliance-for-insurance-9e6faf29',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Compliance for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our AI-Powered Compliance for Insurance leverages advanced machine learning to deliver process automation at scale.
          </p>
