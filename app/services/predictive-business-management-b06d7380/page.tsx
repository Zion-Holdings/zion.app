...
export const metadata: Metadata = {
  title: 'Predictive Business Management',
  description: 'The future of transportation is here with Predictive Business Management. Powered by cutting-edge AI, this platform delivers transformative results like never b',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-business-management-b06d7380',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Predictive Business Management. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
