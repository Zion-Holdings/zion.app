...
export const metadata: Metadata = {
  ...
  keywords: 'Technology roadmaps, Vendor evaluation, Budget planning, Digital transformation, IT governance, Risk management, Board presentations, M&A technology, it, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">CIO Advisory &amp; IT Strategy</h1>
        <p className="text-lg text-slate-300 mb-8">Strategic IT leadership advisory including technology roadmaps and digital transformation.</p>
        ...
        <li class="text-slate-300">Technology roadmaps</li>
        <li class="text-slate-300">Vendor evaluation</li>
        <li class="text-slate-300">Budget planning</li>
        <li class="text-slate-300">Digital transformation</li>
        <li class="text-slate-300">IT governance</li>
        <li class="text-slate-300">Risk management</li>
        <li class="text-slate-300">Board presentations</li>
        <li class="text-slate-300">M&amp;A technology</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Strategic leadership</li>
        <li class="text-slate-300">Cost optimization</li>
        <li class="text-slate-300">Risk reduction</li>
        <li class="text-slate-300">Board-ready insights</li>
      </ul>
        </div>
