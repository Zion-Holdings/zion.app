...
export const metadata: Metadata = {
  ...
  description: 'cross-channel analytics solution for insurtech industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents autom',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cross-channel-analytics-intelligent-document-processing-ai-26c1758d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            cross-channel analytics solution for insurtech industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.
          </p>
