...
export const metadata: Metadata = {
  title: 'Enterprise marketing-logistics',
  description: 'Drive innovation in logistics with Enterprise marketing-logistics. This AI-powered platform transforms lead scoring into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-marketing-logistics-952f9864',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with Enterprise marketing-logistics. This AI-powered platform transforms lead scoring into a competitive advantage.
          </p>
