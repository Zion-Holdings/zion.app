...
export const metadata: Metadata = {
  title: 'Cognitive Analytics for Sports',
  description: 'Next-generation sports solution: Cognitive Analytics for Sports. Combines resource optimization with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-analytics-for-sports-bb5180de',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Analytics for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation sports solution: Cognitive Analytics for Sports. Combines resource optimization with adaptive intelligence for optimal results.
          </p>
