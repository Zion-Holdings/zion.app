...
export const metadata: Metadata = {
  title: 'Intelligent Sales for Construction',
  description: 'Enhance your construction business with Intelligent Sales for Construction. Our solution provides fraud prevention with enterprise-grade reliability and securit',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-sales-for-construction-cff1b76d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Sales for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Intelligent Sales for Construction. Our solution provides fraud prevention with enterprise-grade reliability and security.
          </p>
