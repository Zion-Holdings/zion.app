...
export const metadata: Metadata = {
  title: 'Predictive Revenue Engine - HEALTHTECH',
  description: 'Enhance your healthtech business with Predictive Revenue Engine - HEALTHTECH. Our solution provides loyalty optimization with enterprise-grade reliability and s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Revenue Engine - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthtech business with Predictive Revenue Engine - HEALTHTECH. Our solution provides loyalty optimization with enterprise-grade reliability and security.
          </p>
