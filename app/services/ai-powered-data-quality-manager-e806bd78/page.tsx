...
export const metadata: Metadata = {
  title: "AI-Powered Data Quality Manager - AI-Powered Data Management Solution",
  description: "Automatically detects, corrects, and prevents data quality issues using machine learning.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-data-quality-manager-e806bd78",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Data Quality Manager - AI-Powered Data Management Solution
        </h1>
