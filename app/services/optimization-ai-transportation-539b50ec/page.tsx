...
export const metadata: Metadata = {
  title: 'Optimization AI - Transportation',
  description: 'Revolutionize transportation through intelligent automation. Our Optimization AI - Transportation leverages advanced machine learning to deliver market intellig',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/optimization-ai-transportation-539b50ec',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Optimization AI - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize transportation through intelligent automation. Our Optimization AI - Transportation leverages advanced machine learning to deliver market intelligence at scale.
          </p>
