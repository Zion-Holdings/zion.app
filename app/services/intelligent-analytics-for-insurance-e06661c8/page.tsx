...
export const metadata: Metadata = {
  title: 'Intelligent Analytics for Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Intelligent Analytics for Insurance leverages advanced machine learning to deliver sales forecasting',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-analytics-for-insurance-e06661c8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Analytics for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Intelligent Analytics for Insurance leverages advanced machine learning to deliver sales forecasting at scale.
          </p>
