...
export const metadata: Metadata = {
  title: 'Platform Intelligent - Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Platform Intelligent - Healthcare leverages advanced machine learning to deliver sourcing optimizat',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/platform-intelligent-healthcare-aac76941',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Platform Intelligent - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Platform Intelligent - Healthcare leverages advanced machine learning to deliver sourcing optimization at scale.
          </p>
