...
export const metadata: Metadata = {
  title: 'Smart Predictive Platform - Insurance',
  description: 'Enhance your insurance business with Smart Predictive Platform - Insurance. Our solution provides automation opportunity with enterprise-grade reliability and s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-predictive-platform-insurance-6ffb0df9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Predictive Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Smart Predictive Platform - Insurance. Our solution provides automation opportunity with enterprise-grade reliability and security.
          </p>
