...
export const metadata: Metadata = {
  title: 'Manufacturing Adaptive - Construction',
  description: 'Drive innovation in construction with Manufacturing Adaptive - Construction. This AI-powered platform transforms market analysis into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/manufacturing-adaptive-construction-b36ad7e5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manufacturing Adaptive - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Manufacturing Adaptive - Construction. This AI-powered platform transforms market analysis into a competitive advantage.
          </p>
