...
export const metadata: Metadata = {
  ...
  description: 'Enhance your real-estate business with Intelligent Monitoring for Real-Estate. Our solution provides churn prediction with enterprise-grade reliability and secu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your real-estate business with Intelligent Monitoring for Real-Estate. Our solution provides churn prediction with enterprise-grade reliability and security.
          </p>
