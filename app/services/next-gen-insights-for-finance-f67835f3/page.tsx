...
export const metadata: Metadata = {
  title: 'Next-Gen Insights for Finance',
  description: 'The future of finance is here with Next-Gen Insights for Finance. Powered by cutting-edge AI, this platform delivers esg reporting like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-insights-for-finance-f67835f3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Insights for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of finance is here with Next-Gen Insights for Finance. Powered by cutting-edge AI, this platform delivers esg reporting like never before.
          </p>
