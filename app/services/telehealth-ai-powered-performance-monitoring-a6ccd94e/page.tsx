...
export const metadata: Metadata = {
  title: 'Telehealth AI-Powered Performance Monitoring',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Telehealth AI-Powered Performance Monitoring
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered telehealth solution for devops. End-to-end performance monitoring with predictive insights.
          </p>
