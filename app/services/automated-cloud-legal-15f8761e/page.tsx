...
export const metadata: Metadata = {
  title: 'Automated cloud-legal',
  description: 'The future of legal is here with Automated cloud-legal. Powered by cutting-edge AI, this platform delivers customer service automation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-cloud-legal-15f8761e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated cloud-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Automated cloud-legal. Powered by cutting-edge AI, this platform delivers customer service automation like never before.
          </p>
