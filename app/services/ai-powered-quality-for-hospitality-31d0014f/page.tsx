...
export const metadata: Metadata = {
  ...
  description: 'Drive innovation in hospitality with AI-Powered Quality for Hospitality. This AI-powered platform transforms project portfolio into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-quality-for-hospitality-31d0014f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with AI-Powered Quality for Hospitality. This AI-powered platform transforms project portfolio into a competitive advantage.
          </p>
