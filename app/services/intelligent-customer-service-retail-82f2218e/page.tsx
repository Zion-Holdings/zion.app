...
export const metadata: Metadata = {
  title: 'Intelligent customer service-retail',
  description: 'Optimize your retail workflows with Intelligent customer service-retail. This intelligent platform delivers sourcing optimization through advanced automation an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-customer-service-retail-82f2218e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent customer service-retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your retail workflows with Intelligent customer service-retail. This intelligent platform delivers sourcing optimization through advanced automation and AI.
          </p>
