...
export const metadata: Metadata = {
  title: 'AI Analytics - Construction Edition #2',
  description: 'Revolutionize construction through intelligent automation. Our AI Analytics - Construction Edition #2 leverages advanced machine learning to deliver market anal',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Analytics - Construction Edition #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our AI Analytics - Construction Edition #2 leverages advanced machine learning to deliver market analysis at scale.
          </p>
