...
export const metadata: Metadata = {
  title: 'Generator Predictive - Construction',
  description: 'The future of construction is here with Generator Predictive - Construction. Powered by cutting-edge AI, this platform delivers transformative results like neve',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/generator-predictive-construction-1a800951',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Generator Predictive - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Generator Predictive - Construction. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
