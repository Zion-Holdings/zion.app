...
export const metadata: Metadata = {
  title: 'Autonomous Fleet Suite',
  description: 'Optimize your logistics workflows with Autonomous Fleet Suite. This intelligent platform delivers audit trail management through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-fleet-suite-83752f36',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Fleet Suite
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your logistics workflows with Autonomous Fleet Suite. This intelligent platform delivers audit trail management through advanced automation and AI.
          </p>
