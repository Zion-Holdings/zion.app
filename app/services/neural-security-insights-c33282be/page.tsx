...
export const metadata: Metadata = {
  title: 'Neural Security Insights',
  description: 'Revolutionize cleantech through intelligent automation. Our Neural Security Insights leverages advanced machine learning to deliver maintenance scheduling at sc',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cleantech through intelligent automation. Our Neural Security Insights leverages advanced machine learning to deliver maintenance scheduling at scale.
          </p>
