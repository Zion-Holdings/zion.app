...
export const metadata: Metadata = {
  title: 'Healthcare Automated - Healthcare',
  description: 'The future of healthcare is here with Healthcare Automated - Healthcare. Powered by cutting-edge AI, this platform delivers performance monitoring like never be',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/healthcare-automated---healthcare-3f02153d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Healthcare Automated - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Healthcare Automated - Healthcare. Powered by cutting-edge AI, this platform delivers performance monitoring like never before.
          </p>
