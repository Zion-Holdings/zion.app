...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize hospitality through intelligent automation. Our Automated Business Intelligence leverages advanced machine learning to deliver scalability plannin',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-business-intelligence-926a4db9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Automated Business Intelligence leverages advanced machine learning to deliver scalability planning at scale.
          </p>
