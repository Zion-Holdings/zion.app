...
export const metadata: Metadata = {
  title: 'Smart Automation for Proptech',
  description: 'Transform your proptech operations with our Smart Automation for Proptech. This AI-driven solution automates inventory management with unprecedented accuracy an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Automation for Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your proptech operations with our Smart Automation for Proptech. This AI-driven solution automates inventory management with unprecedented accuracy and efficiency.
          </p>
