...
export const metadata: Metadata = {
  title: 'Cognitive Management Solution - Logistics',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Management Solution - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with Cognitive Management Solution - Logistics. This AI-powered platform transforms ml model training into a competitive advantage.
          </p>
