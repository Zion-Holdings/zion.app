...
export const metadata: Metadata = {
  title: 'Engine Smart - Energy',
  description: 'The future of energy is here with Engine Smart - Energy. Powered by cutting-edge AI, this platform delivers customer service automation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/engine-smart---energy-e4d8320f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Engine Smart - Energy. Powered by cutting-edge AI, this platform delivers customer service automation like never before.
          </p>
