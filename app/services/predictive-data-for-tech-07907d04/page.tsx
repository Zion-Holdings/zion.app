...
export const metadata: Metadata = {
  title: 'Predictive Data for Tech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Data for Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your technology business with Predictive Data for Tech. Our solution provides brand monitoring with enterprise-grade reliability and security.
          </p>
