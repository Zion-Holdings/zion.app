...
export const metadata: Metadata = {
  title: 'Intelligent Cognitive for Hospitality',
  description: 'Enhance your hospitality business with Intelligent Cognitive for Hospitality. Our solution provides serverless orchestration with enterprise-grade reliability a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-cognitive-for-hospitality-a1bdde31',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Cognitive for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Intelligent Cognitive for Hospitality. Our solution provides serverless orchestration with enterprise-grade reliability and security.
          </p>
