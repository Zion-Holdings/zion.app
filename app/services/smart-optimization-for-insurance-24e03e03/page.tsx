...
export const metadata: Metadata = {
  title: 'Smart Optimization for Insurance',
  description: 'Transform your insurance operations with our Smart Optimization for Insurance. This AI-driven solution automates risk assessment with unprecedented accuracy and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-optimization-for-insurance-24e03e03',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Optimization for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Smart Optimization for Insurance. This AI-driven solution automates risk assessment with unprecedented accuracy and efficiency.
          </p>
