...
export const metadata: Metadata = {
  title: 'Cloud Predictive - Real-Estate',
  description: 'Optimize your real-estate workflows with Cloud Predictive - Real-Estate. This intelligent platform delivers customer onboarding through advanced automation and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cloud-predictive-real-estate-318f836c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cloud Predictive - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your real-estate workflows with Cloud Predictive - Real-Estate. This intelligent platform delivers customer onboarding through advanced automation and AI.
          </p>
