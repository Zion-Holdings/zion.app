...
export const metadata: Metadata = {
  title: 'AI/IT Deep Learning Suite - Energy',
  description: 'Enhance your energy business with AI/IT Deep Learning Suite - Energy. Our solution provides process discovery with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-deep-learning-suite-energy-37323b1d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Deep Learning Suite - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your energy business with AI/IT Deep Learning Suite - Energy. Our solution provides process discovery with enterprise-grade reliability and security.
          </p>
