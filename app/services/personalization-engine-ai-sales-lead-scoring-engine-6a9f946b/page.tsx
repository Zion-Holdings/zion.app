...
export const metadata: Metadata = {
  ...
  description: 'personalization engine solution for warehousing industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/personalization-engine-ai-sales-lead-scoring-engine-6a9f946b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            personalization engine solution for warehousing industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.
          </p>
