...
export const metadata: Metadata = {
  title: 'Cognitive system-automotive',
  description: 'Enhance your automotive business with Cognitive system-automotive. Our solution provides audit trail management with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-system-automotive-a3bb943b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive system-automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your automotive business with Cognitive system-automotive. Our solution provides audit trail management with enterprise-grade reliability and security.
          </p>
