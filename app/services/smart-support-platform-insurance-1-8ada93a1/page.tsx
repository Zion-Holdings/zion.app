...
export const metadata: Metadata = {
  title: 'Smart Support Platform - Insurance #1',
  description: 'Next-generation insurance solution: Smart Support Platform - Insurance #1. Combines user provisioning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-support-platform-insurance-1-8ada93a1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Support Platform - Insurance #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Smart Support Platform - Insurance #1. Combines user provisioning with adaptive intelligence for optimal results.
          </p>
