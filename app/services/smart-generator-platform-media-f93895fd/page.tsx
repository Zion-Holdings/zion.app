...
export const metadata: Metadata = {
  title: 'Smart Generator Platform - Media',
  description: 'Unlock unprecedented growth with Smart Generator Platform - Media. This autonomous system provides pipeline management with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-generator-platform-media-f93895fd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Generator Platform - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Generator Platform - Media. This autonomous system provides pipeline management with zero manual intervention needed.
          </p>
