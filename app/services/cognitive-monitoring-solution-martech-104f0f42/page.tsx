...
export const metadata: Metadata = {
  title: 'Cognitive Monitoring Solution - MARTECH',
  description: 'Optimize your martech workflows with Cognitive Monitoring Solution - MARTECH. This intelligent platform delivers expense management through advanced automation ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-monitoring-solution-martech-104f0f42',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Monitoring Solution - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your martech workflows with Cognitive Monitoring Solution - MARTECH. This intelligent platform delivers expense management through advanced automation and AI.
          </p>
