...
export const metadata: Metadata = {
  ...
  description: 'Enhance your gaming business with Predictive Management Engine - Gaming. Our solution provides audit trail management with enterprise-grade reliability and secu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your gaming business with Predictive Management Engine - Gaming. Our solution provides audit trail management with enterprise-grade reliability and security.
          </p>
