...
export const metadata: Metadata = {
  title: 'Insurtech AI-Powered Infrastructure as Code',
  description: 'AI-powered insurtech solution for infrastructure. AI-generated infrastructure code with best practices and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/insurtech-ai-powered-infrastructure-as-code-ef9d85d3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Insurtech AI-Powered Infrastructure as Code
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered insurtech solution for infrastructure. AI-generated infrastructure code with best practices and security.
          </p>
