...
export const metadata: Metadata = {
  ...
  description: 'Transform your hospitality operations with our Smart Predictor Platform - Hospitality. This AI-driven solution automates user experience with unprecedented accu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Smart Predictor Platform - Hospitality. This AI-driven solution automates user experience with unprecedented accuracy and efficiency.
          </p>
