...
export const metadata: Metadata = {
  title: 'Cognitive Security Solution - Enterprise',
  description: 'The future of enterprise is here with Cognitive Security Solution - Enterprise. Powered by cutting-edge AI, this platform delivers sentiment analysis like never',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-security-solution-enterprise-bb30e0b3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Security Solution - Enterprise
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of enterprise is here with Cognitive Security Solution - Enterprise. Powered by cutting-edge AI, this platform delivers sentiment analysis like never before.
          </p>
