...
export const metadata: Metadata = {
  title: 'AI-Powered Production Excellence',
  description: 'Platform for production excellence with AI and optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-production-excellence-b3ac0bea',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Production Excellence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Platform for production excellence with AI and optimization.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Production excellence</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">35% excellence improvement</li>
