...
export const metadata: Metadata = {
  title: 'Intelligent Data Science for Education',
  description: 'The future of education is here with Intelligent Data Science for Education. Powered by cutting-edge AI, this platform delivers transformative results like neve',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-data-science-for-education-d4ad16a8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Data Science for Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of education is here with Intelligent Data Science for Education. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
