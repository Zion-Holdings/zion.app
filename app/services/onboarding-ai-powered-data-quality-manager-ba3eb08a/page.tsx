...
export const metadata: Metadata = {
  title: 'Onboarding AI-Powered Data Quality Manager',
  description: 'onboarding solution for textiles industry. Automatically detects, corrects, and prevents data quality issues using machine learning.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/onboarding-ai-powered-data-quality-manager-ba3eb08a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Onboarding AI-Powered Data Quality Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            onboarding solution for textiles industry. Automatically detects, corrects, and prevents data quality issues using machine learning.
          </p>
