...
export const metadata: Metadata = {
  title: 'Predictive Smart Engine - Legal',
  description: 'Transform your legal operations with our Predictive Smart Engine - Legal. This AI-driven solution automates brand sentiment with unprecedented accuracy and effi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-smart-engine-legal-2dae8a2c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Smart Engine - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Predictive Smart Engine - Legal. This AI-driven solution automates brand sentiment with unprecedented accuracy and efficiency.
          </p>
