...
export const metadata: Metadata = {
  title: 'Autonomous platform-edge',
  description: 'Next-generation edge solution: Autonomous platform-edge. Combines energy management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-platform-edge-5f80ac09',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous platform-edge
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation edge solution: Autonomous platform-edge. Combines energy management with adaptive intelligence for optimal results.
          </p>
