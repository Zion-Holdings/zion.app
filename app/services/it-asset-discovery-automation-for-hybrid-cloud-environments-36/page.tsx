...
export const metadata = {
  ...
  description: 'End-to-end it asset discovery automation for hybrid cloud environments services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/it-asset-discovery-automation-for-hybrid-cloud-environments-36/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">IT Asset Discovery Automation for Hybrid Cloud Environments</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end it asset discovery automation for hybrid cloud environments services: assessment, deployment, and managed operations.
        </p>
