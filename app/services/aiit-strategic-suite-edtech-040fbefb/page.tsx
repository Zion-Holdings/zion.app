...
export const metadata: Metadata = {
  title: 'AI/IT Strategic Suite - EDTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Strategic Suite - EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your edtech workflows with AI/IT Strategic Suite - EDTECH. This intelligent platform delivers sales forecasting through advanced automation and AI.
          </p>
