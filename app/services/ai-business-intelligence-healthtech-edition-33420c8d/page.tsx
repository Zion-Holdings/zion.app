...
export const metadata: Metadata = {
  title: 'AI Business Intelligence - HEALTHTECH Edition',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Business Intelligence - HEALTHTECH Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthtech is here with AI Business Intelligence - HEALTHTECH Edition. Powered by cutting-edge AI, this platform delivers feature engineering like never before.
          </p>
