...
export const metadata: Metadata = {
  title: 'AI Tactical - MARTECH Edition',
  description: 'Next-generation martech solution: AI Tactical - MARTECH Edition. Combines microservices mesh with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-tactical-martech-edition-2e9a025f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Tactical - MARTECH Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation martech solution: AI Tactical - MARTECH Edition. Combines microservices mesh with adaptive intelligence for optimal results.
          </p>
