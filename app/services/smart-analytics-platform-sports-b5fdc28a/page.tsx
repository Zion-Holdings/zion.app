...
export const metadata: Metadata = {
  title: 'Smart Analytics Platform - Sports',
  description: 'The future of sports is here with Smart Analytics Platform - Sports. Powered by cutting-edge AI, this platform delivers master data management like never before',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-analytics-platform-sports-b5fdc28a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Analytics Platform - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Smart Analytics Platform - Sports. Powered by cutting-edge AI, this platform delivers master data management like never before.
          </p>
