...
export const metadata: Metadata = {
  title: 'Adaptive Optimizer for Construction',
  description: 'Next-generation construction solution: Adaptive Optimizer for Construction. Combines decision support with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-optimizer-for-construction-3cedb1b5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Optimizer for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Adaptive Optimizer for Construction. Combines decision support with adaptive intelligence for optimal results.
          </p>
