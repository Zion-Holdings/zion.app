...
export const metadata: Metadata = {
  title: 'Autonomous Document for Education',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Document for Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated education solution: Autonomous Document for Education. Combines maintenance scheduling with next-gen AI for maximum velocity.
          </p>
