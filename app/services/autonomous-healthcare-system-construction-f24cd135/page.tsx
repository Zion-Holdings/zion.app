...
export const metadata: Metadata = {
  title: 'Autonomous Healthcare System - Construction',
  description: 'Transform your construction operations with our Autonomous Healthcare System - Construction. This AI-driven solution automates quality control with unprecedente',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-healthcare-system-construction-f24cd135',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Healthcare System - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Autonomous Healthcare System - Construction. This AI-driven solution automates quality control with unprecedented accuracy and efficiency.
          </p>
