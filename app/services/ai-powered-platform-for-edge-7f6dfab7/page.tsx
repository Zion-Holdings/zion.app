...
export const metadata: Metadata = {
  title: 'AI-Powered Platform for Edge',
  description: 'Transform your edge operations with our AI-Powered Platform for Edge. This AI-driven solution automates network optimization with unprecedented accuracy and eff',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Platform for Edge
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your edge operations with our AI-Powered Platform for Edge. This AI-driven solution automates network optimization with unprecedented accuracy and efficiency.
          </p>
