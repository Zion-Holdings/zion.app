...
export const metadata: Metadata = {
  title: 'Autonomous Content System - Telecom',
  description: 'Drive innovation in telecom with Autonomous Content System - Telecom. This AI-powered platform transforms quality control into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-content-system-telecom-0a27223a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Content System - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in telecom with Autonomous Content System - Telecom. This AI-powered platform transforms quality control into a competitive advantage.
          </p>
