...
export const metadata: Metadata = {
  title: 'AI/IT Executive Suite - Retail',
  description: 'Transform your retail operations with our AI/IT Executive Suite - Retail. This AI-driven solution automates roi tracking with unprecedented accuracy and efficie',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-executive-suite-retail-e4e4e7a1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Executive Suite - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our AI/IT Executive Suite - Retail. This AI-driven solution automates roi tracking with unprecedented accuracy and efficiency.
          </p>
