...
export const metadata: Metadata = {
  title: 'Strategic Predictive - Finance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Strategic Predictive - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Strategic Predictive - Finance. This autonomous system provides ml model training with zero manual intervention needed.
          </p>
