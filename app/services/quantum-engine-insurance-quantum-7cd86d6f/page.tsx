...
export const metadata: Metadata = {
  title: 'Quantum Engine - Insurance Quantum',
  description: 'Revolutionize insurance through intelligent automation. Our Quantum Engine - Insurance Quantum leverages advanced machine learning to deliver model interpretabi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Engine - Insurance Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Quantum Engine - Insurance Quantum leverages advanced machine learning to deliver model interpretability at scale.
          </p>
