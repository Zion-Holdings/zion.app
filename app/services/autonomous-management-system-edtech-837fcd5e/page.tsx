...
export const metadata: Metadata = {
  title: 'Autonomous Management System - EDTECH',
  description: 'Unlock unprecedented growth with Autonomous Management System - EDTECH. This autonomous system provides financial risk management with zero manual intervention ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-management-system-edtech-837fcd5e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Management System - EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Autonomous Management System - EDTECH. This autonomous system provides financial risk management with zero manual intervention needed.
          </p>
