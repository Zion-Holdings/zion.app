...
export const metadata: Metadata = {
  ...
  keywords: 'Pipeline ingestion from CRM + custom objects, Revenue forecast probability-adjusted, Stalled-deal early-warning detection, Pipeline coverage score per rep, Revenue-at-risk breakdown per stage, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Revenue Clarity &amp; Forecasting</h1>
        <p className="text-lg text-slate-300 mb-8">Ingest pipeline, CRM custom objects, deal stages. ML forecasts: probability-adjusted revenue by rep, team, region. Detect stalled deals. Auto-generate pipeline coverage report.</p>
        ...
        <li class="text-slate-300">Pipeline ingestion from CRM + custom objects</li>
        <li class="text-slate-300">Revenue forecast probability-adjusted</li>
        <li class="text-slate-300">Stalled-deal early-warning detection</li>
        <li class="text-slate-300">Pipeline coverage score per rep</li>
        <li class="text-slate-300">Revenue-at-risk breakdown per stage</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai revenue clarity &amp; forecasting</li>
