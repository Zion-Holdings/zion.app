...
export const metadata: Metadata = {
  title: 'Cognitive Automation Solution - Legal',
  description: 'Revolutionize legal through intelligent automation. Our Cognitive Automation Solution - Legal leverages advanced machine learning to deliver sales forecasting a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-automation-solution-legal-77e5043c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Automation Solution - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Cognitive Automation Solution - Legal leverages advanced machine learning to deliver sales forecasting at scale.
          </p>
