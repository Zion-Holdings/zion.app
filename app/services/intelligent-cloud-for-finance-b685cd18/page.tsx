...
export const metadata: Metadata = {
  title: 'Intelligent Cloud for Finance',
  description: 'Drive innovation in finance with Intelligent Cloud for Finance. This AI-powered platform transforms maintenance scheduling into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-cloud-for-finance-b685cd18',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Cloud for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in finance with Intelligent Cloud for Finance. This AI-powered platform transforms maintenance scheduling into a competitive advantage.
          </p>
