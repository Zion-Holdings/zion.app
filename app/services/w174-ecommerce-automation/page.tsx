...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{'@context': 'https://schema.org', '@type': 'Service', 'name': 'E-Commerce Operations Automation', 'description': 'Automate e-commerce ops: order processing, inventory sync, pricing rules, fraud screening, and marketplace listings across Shopify, Amazon, Walmart.', 'serviceType': 'automation', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'E-Commerce'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'E-Commerce Operations Automation Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$99/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$299/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': '$999/mo', 'priceCurrency': 'USD'}]}} }/>
    <JsonLd data={{'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'Automated order processing and fulfilment', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Automated order processing and fulfilment'}}, {'@type': 'Question', 'name': 'Multi-channel inventory synchronization', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Multi-channel inventory synchronization'}}, {'@type': 'Question', 'name': 'Dynamic pricing rules and competitor matching', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Dynamic pricing rules and competitor matching'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Process orders 5x faster with automation; Inventory sync prevents overselling; Dynamic pricing maximizes margin'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} }/>
