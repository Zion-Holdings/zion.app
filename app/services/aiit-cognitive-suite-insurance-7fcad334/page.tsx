...
export const metadata: Metadata = {
  title: 'AI/IT Cognitive Suite - Insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Cognitive Suite - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with AI/IT Cognitive Suite - Insurance. Powered by cutting-edge AI, this platform delivers fleet management like never before.
          </p>
