...
export const metadata: Metadata = {
  title: 'Predictive management-sports',
  description: 'Next-generation sports solution: Predictive management-sports. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-management-sports-c19030ed',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive management-sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation sports solution: Predictive management-sports. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
