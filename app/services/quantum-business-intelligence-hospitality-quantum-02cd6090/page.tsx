...
export const metadata: Metadata = {
  title: 'Quantum Business Intelligence - Hospitality Quantum',
  description: 'Unlock unprecedented growth with Quantum Business Intelligence - Hospitality Quantum. This autonomous system provides insurance automation with zero manual inte',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-business-intelligence-hospitality-quantum-02cd6090',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Business Intelligence - Hospitality Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Quantum Business Intelligence - Hospitality Quantum. This autonomous system provides insurance automation with zero manual intervention needed.
          </p>
