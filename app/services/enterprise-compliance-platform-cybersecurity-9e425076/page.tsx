...
export const metadata: Metadata = {
  title: 'Enterprise Compliance Platform - Cybersecurity',
  description: 'Unlock unprecedented growth with Enterprise Compliance Platform - Cybersecurity. This autonomous system provides goal setting with zero manual intervention need',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-compliance-platform-cybersecurity-9e425076',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Compliance Platform - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Enterprise Compliance Platform - Cybersecurity. This autonomous system provides goal setting with zero manual intervention needed.
          </p>
