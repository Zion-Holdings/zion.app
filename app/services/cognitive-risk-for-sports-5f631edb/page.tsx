...
export const metadata: Metadata = {
  title: 'Cognitive Risk for Sports',
  description: 'Revolutionize sports through intelligent automation. Our Cognitive Risk for Sports leverages advanced machine learning to deliver customer insights at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-risk-for-sports-5f631edb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Risk for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Cognitive Risk for Sports leverages advanced machine learning to deliver customer insights at scale.
          </p>
