...
export const metadata: Metadata = {
  title: 'Smart Predictive Platform - Agriculture',
  description: 'Next-generation agriculture solution: Smart Predictive Platform - Agriculture. Combines performance reviews with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-predictive-platform-agriculture-e83f3acd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Predictive Platform - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agriculture solution: Smart Predictive Platform - Agriculture. Combines performance reviews with adaptive intelligence for optimal results.
          </p>
