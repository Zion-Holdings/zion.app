      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Multi-Tbps scrubbing capacity (anycast edge)</li>
            <li className="text-purple-300">✓ ML traffic classification (attack vs legitimate)</li>
            <li className="text-purple-300">✓ HTTP/3 + QUIC + TCP SYN flood protection</li>
            <li className="text-purple-300">✓ Auto-scaling scrubbing clusters</li>
            <li className="text-purple-300">✓ Attack forensics + IoC export to SIEM</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai ddos protection & mitigation platform</li>
