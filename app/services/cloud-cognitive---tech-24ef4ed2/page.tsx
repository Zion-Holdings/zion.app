...
export const metadata: Metadata = {
  title: 'Cloud Cognitive - Tech',
  description: 'Revolutionize technology through intelligent automation. Our Cloud Cognitive - Tech leverages advanced machine learning to deliver healthcare data analytics at ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cloud-cognitive---tech-24ef4ed2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cloud Cognitive - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our Cloud Cognitive - Tech leverages advanced machine learning to deliver healthcare data analytics at scale.
          </p>
