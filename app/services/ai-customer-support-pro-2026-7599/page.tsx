...
export const metadata = {
  ...
  alternates: { canonical: '/services/ai-customer-support-pro-2026-7599/' },

  openGraph: {
    title: 'AI Customer Support | Zion Tech Group',
    description: 'End-to-end ai customer support services: assessment, deployment, and managed operations.',
    url: 'https://ziontechgroup.com/services/ai-customer-support-pro-2026-7599/',
...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "AI Customer Support | Zion Tech Group", description: "End-to-end ai customer support services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/ai-customer-support-pro-2026-7599/}} />
