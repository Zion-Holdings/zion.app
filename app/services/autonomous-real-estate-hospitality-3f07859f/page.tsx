...
export const metadata: Metadata = {
  title: 'Autonomous real estate-hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Autonomous real estate-hospitality leverages advanced machine learning to deliver data quality at ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-real-estate-hospitality-3f07859f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous real estate-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Autonomous real estate-hospitality leverages advanced machine learning to deliver data quality at scale.
          </p>
