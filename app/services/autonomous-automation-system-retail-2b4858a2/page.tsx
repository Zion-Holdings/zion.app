...
export const metadata: Metadata = {
  title: 'Autonomous Automation System - Retail',
  description: 'Transform your retail operations with our Autonomous Automation System - Retail. This AI-driven solution automates resource allocation with unprecedented accura',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Automation System - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our Autonomous Automation System - Retail. This AI-driven solution automates resource allocation with unprecedented accuracy and efficiency.
          </p>
