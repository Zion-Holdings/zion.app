...
export const metadata: Metadata = {
  ...
  keywords: 'MITRE ATT&CK mapped adversary simulation, C2 + lateral movement + priv esc, Auto-remediation playbook per finding, Continuous testing on actual environment, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Red Team Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Automated adversary simulation: C2 beaconing lateral movement privilege escalation data exfiltration mapped to MITRE ATT&amp;CK auto-remediation playbooks continuous on-env testing.</p>
        ...
        <li class="text-slate-300">MITRE ATT&amp;CK mapped adversary simulation</li>
        <li class="text-slate-300">C2 + lateral movement + priv esc</li>
        <li class="text-slate-300">Auto-remediation playbook per finding</li>
        <li class="text-slate-300">Continuous testing on actual environment</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai red team automation</li>
