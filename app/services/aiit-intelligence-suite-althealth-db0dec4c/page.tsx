...
export const metadata: Metadata = {
  title: 'AI/IT Intelligence Suite - ALTHEALTH',
  description: 'Optimize your althealth workflows with AI/IT Intelligence Suite - ALTHEALTH. This intelligent platform delivers market analysis through advanced automation and ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Intelligence Suite - ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your althealth workflows with AI/IT Intelligence Suite - ALTHEALTH. This intelligent platform delivers market analysis through advanced automation and AI.
          </p>
