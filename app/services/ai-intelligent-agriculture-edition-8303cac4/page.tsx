...
export const metadata: Metadata = {
  ...
  description: 'Enhance your agriculture business with AI Intelligent - Agriculture Edition. Our solution provides healthcare data analytics with enterprise-grade reliability a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your agriculture business with AI Intelligent - Agriculture Edition. Our solution provides healthcare data analytics with enterprise-grade reliability and security.
          </p>
