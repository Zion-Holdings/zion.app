...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Optimizer - Construction',
  description: 'The future of construction is here with Hyper-Accelerated Optimizer - Construction. Powered by cutting-edge AI, this platform delivers reporting automation like',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/hyper-accelerated-optimizer-construction-c016384d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Optimizer - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Hyper-Accelerated Optimizer - Construction. Powered by cutting-edge AI, this platform delivers reporting automation like never before.
          </p>
