...
export const metadata: Metadata = {
  title: 'Smart Customer Service Platform - Construction',
  description: 'Transform your construction operations with our Smart Customer Service Platform - Construction. This AI-driven solution automates content generation with unprec',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-customer-service-platform-construction-c4872392',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Customer Service Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Smart Customer Service Platform - Construction. This AI-driven solution automates content generation with unprecedented accuracy and efficiency.
          </p>
