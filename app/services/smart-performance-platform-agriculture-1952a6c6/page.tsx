...
export const metadata: Metadata = {
  title: 'Smart Performance Platform - Agriculture',
  description: 'Unlock unprecedented growth with Smart Performance Platform - Agriculture. This autonomous system provides cost reduction with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-performance-platform-agriculture-1952a6c6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Performance Platform - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Performance Platform - Agriculture. This autonomous system provides cost reduction with zero manual intervention needed.
          </p>
