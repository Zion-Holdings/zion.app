...
export const metadata: Metadata = {
  title: 'Enterprise Suite Platform - ALTHEALTH',
  description: 'Drive innovation in althealth with Enterprise Suite Platform - ALTHEALTH. This AI-powered platform transforms forecast accuracy into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-suite-platform-althealth-ce5d2263',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Suite Platform - ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in althealth with Enterprise Suite Platform - ALTHEALTH. This AI-powered platform transforms forecast accuracy into a competitive advantage.
          </p>
