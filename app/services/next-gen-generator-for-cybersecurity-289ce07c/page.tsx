...
export const metadata: Metadata = {
  title: 'Next-Gen Generator for Cybersecurity',
  description: 'Optimize your cybersecurity workflows with Next-Gen Generator for Cybersecurity. This intelligent platform delivers pipeline management through advanced automat',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Generator for Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your cybersecurity workflows with Next-Gen Generator for Cybersecurity. This intelligent platform delivers pipeline management through advanced automation and AI.
          </p>
