...
export const metadata: Metadata = {
  ...
  description: 'Automatically reviews code changes for quality, security, and best practices.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-code-review-assistant-ec78481c',
  },

export const metadata = {
  title: "AI-Powered Code Review Assistant - Zion Tech Group",
  description: "Automatically reviews code changes for quality, security, and best practices.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-code-review-assistant-ec78481c`
  }
  ...
  return (
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automatically reviews code changes for quality, security, and best practices.
          </p>
    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">AI-Powered Code Review Assistant</h1>
        <p className="text-lg text-gray-300 mb-8">Automatically reviews code changes for quality, security, and best practices.</p>
