...
export const metadata: Metadata = {
  title: 'AI Business Intelligence - Finance Edition',
  description: 'Enhance your finance business with AI Business Intelligence - Finance Edition. Our solution provides project portfolio with enterprise-grade reliability and sec',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-business-intelligence-finance-edition-f7664192',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Business Intelligence - Finance Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your finance business with AI Business Intelligence - Finance Edition. Our solution provides project portfolio with enterprise-grade reliability and security.
          </p>
