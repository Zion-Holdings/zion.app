      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your telecom workflows with AI Deep Learning - Telecom Edition. This intelligent platform delivers survey automation through advanced automation and AI.
          </p>
