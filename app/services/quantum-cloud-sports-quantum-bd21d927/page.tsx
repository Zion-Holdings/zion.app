...
export const metadata: Metadata = {
  title: 'Quantum Cloud - Sports Quantum',
  description: 'Quantum leap forward for sports: Quantum Cloud - Sports Quantum. Uses quantum-inspired algorithms to deliver net promoter score at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-cloud-sports-quantum-bd21d927',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Cloud - Sports Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for sports: Quantum Cloud - Sports Quantum. Uses quantum-inspired algorithms to deliver net promoter score at exponential speed.
          </p>
