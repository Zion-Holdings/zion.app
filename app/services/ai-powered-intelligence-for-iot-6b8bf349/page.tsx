...
export const metadata: Metadata = {
  title: 'AI-Powered Intelligence for Iot',
  description: 'Transform your iot operations with our AI-Powered Intelligence for Iot. This AI-driven solution automates content generation with unprecedented accuracy and eff',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Intelligence for Iot
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your iot operations with our AI-Powered Intelligence for Iot. This AI-driven solution automates content generation with unprecedented accuracy and efficiency.
          </p>
