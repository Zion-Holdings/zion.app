...
export const metadata: Metadata = {
  ...
  keywords: 'AI-powered threat detection, Automated correlation rules, Cloud-native architecture, Integration with 300+ data sources, SOAR integration, Compliance reporting, Custom detection rules, Threat intelligence feeds, security, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cloud-Native SIEM Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Modern SIEM with AI-powered threat detection, automated correlation, and cloud-native architecture. Replace legacy SIEM with scalable, intelligent security analytics.</p>
        ...
        <li class="text-slate-300">Automated correlation rules</li>
        <li class="text-slate-300">Cloud-native architecture</li>
        <li class="text-slate-300">Integration with 300+ data sources</li>
        <li class="text-slate-300">SOAR integration</li>
        <li class="text-slate-300">Compliance reporting</li>
        <li class="text-slate-300">Custom detection rules</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Detect threats faster</li>
        <li class="text-slate-300">Reduce alert fatigue</li>
        <li class="text-slate-300">Cloud-native scalability</li>
        <li class="text-slate-300">Replace legacy SIEM</li>
      </ul>
        </div>
