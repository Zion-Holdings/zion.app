...
export const metadata: Metadata = {
  title: 'Deep Learning AI - Insurance',
  description: 'Next-generation insurance solution: Deep Learning AI - Insurance. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/deep-learning-ai-insurance-779aeec1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Deep Learning AI - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Deep Learning AI - Insurance. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
