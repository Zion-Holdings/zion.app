...
export const metadata: Metadata = {
  title: 'AI/IT Performance Suite - Agriculture',
  description: 'The future of agriculture is here with AI/IT Performance Suite - Agriculture. Powered by cutting-edge AI, this platform delivers resource optimization like neve',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-performance-suite-agriculture-99aca8c3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Performance Suite - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with AI/IT Performance Suite - Agriculture. Powered by cutting-edge AI, this platform delivers resource optimization like never before.
          </p>
