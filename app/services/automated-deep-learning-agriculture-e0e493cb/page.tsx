...
export const metadata: Metadata = {
  title: 'Automated deep learning-agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Automated deep learning-agriculture leverages advanced machine learning to deliver hr analytics at',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-deep-learning-agriculture-e0e493cb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated deep learning-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Automated deep learning-agriculture leverages advanced machine learning to deliver hr analytics at scale.
          </p>
