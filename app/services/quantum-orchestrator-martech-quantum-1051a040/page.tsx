...
export const metadata: Metadata = {
  title: 'Quantum Orchestrator - MARTECH Quantum',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Orchestrator - MARTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your martech business with Quantum Orchestrator - MARTECH Quantum. Our solution provides vendor management with enterprise-grade reliability and security.
          </p>
