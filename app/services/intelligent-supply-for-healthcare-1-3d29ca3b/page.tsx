...
export const metadata: Metadata = {
  title: 'Intelligent Supply for Healthcare #1',
  description: 'Transform your healthcare operations with our Intelligent Supply for Healthcare #1. This AI-driven solution automates cost reduction with unprecedented accuracy',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-supply-for-healthcare-1-3d29ca3b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Supply for Healthcare #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Intelligent Supply for Healthcare #1. This AI-driven solution automates cost reduction with unprecedented accuracy and efficiency.
          </p>
