...
export const metadata: Metadata = {
  ...
  description: 'Enhance your agriculture business with AI-Powered Risk Compliance. Our solution provides executive dashboards with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-risk-compliance-381570d0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your agriculture business with AI-Powered Risk Compliance. Our solution provides executive dashboards with enterprise-grade reliability and security.
          </p>
