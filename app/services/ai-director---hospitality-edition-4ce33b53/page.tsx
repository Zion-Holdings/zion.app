    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        ...
        <p className="text-xl text-slate-300 mb-8">
          The future of hospitality is here with AI Director - Hospitality Edition. Powered by cutting-edge AI, this platform delivers risk assessment like never before.
        </p>
