...
export const metadata: Metadata = {
  title: 'Automated Automation for Hospitality #1',
  description: 'Enhance your hospitality business with Automated Automation for Hospitality #1. Our solution provides vendor management with enterprise-grade reliability and se',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-automation-for-hospitality-1-8afc9cd0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Automation for Hospitality #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Automated Automation for Hospitality #1. Our solution provides vendor management with enterprise-grade reliability and security.
          </p>
