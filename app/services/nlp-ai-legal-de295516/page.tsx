...
export const metadata: Metadata = {
  title: 'NLP AI - Legal',
  description: 'Quantum leap forward for legal: NLP AI - Legal. Uses quantum-inspired algorithms to deliver revenue forecasting at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/nlp-ai-legal-de295516',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for legal: NLP AI - Legal. Uses quantum-inspired algorithms to deliver revenue forecasting at exponential speed.
          </p>
