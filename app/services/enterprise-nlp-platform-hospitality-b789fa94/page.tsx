...
export const metadata: Metadata = {
  title: 'Enterprise NLP Platform - Hospitality',
  description: 'Quantum leap forward for hospitality: Enterprise NLP Platform - Hospitality. Uses quantum-inspired algorithms to deliver feedback collection at exponential spee',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-nlp-platform-hospitality-b789fa94',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise NLP Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for hospitality: Enterprise NLP Platform - Hospitality. Uses quantum-inspired algorithms to deliver feedback collection at exponential speed.
          </p>
