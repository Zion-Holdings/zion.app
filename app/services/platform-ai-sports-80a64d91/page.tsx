...
export const metadata: Metadata = {
  title: 'Platform AI - Sports',
  description: 'Transform your sports operations with our Platform AI - Sports. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficien',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/platform-ai-sports-80a64d91',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our Platform AI - Sports. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
