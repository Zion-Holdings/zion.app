...
export const metadata: Metadata = {
  title: 'Smart Manager Suite - Agriculture',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manager Suite - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your agriculture with Smart Manager Suite - Agriculture. Our autonomous solution handles cost reduction end-to-end without human intervention.
          </p>
