...
export const metadata: Metadata = {
  title: 'AI Orchestrator - Cleantech Edition #1',
  description: 'Revolutionize cleantech through intelligent automation. Our AI Orchestrator - Cleantech Edition #1 leverages advanced machine learning to deliver financial plan',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-orchestrator---cleantech-edition-1-4d2666c7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Orchestrator - Cleantech Edition #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cleantech through intelligent automation. Our AI Orchestrator - Cleantech Edition #1 leverages advanced machine learning to deliver financial planning at scale.
          </p>
