...
export const metadata: Metadata = {
  title: 'Intelligent Risk for Healthcare #2',
  description: 'Enhance your healthcare business with Intelligent Risk for Healthcare #2. Our solution provides customer onboarding with enterprise-grade reliability and securi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-risk-for-healthcare-2-aa7e748d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Risk for Healthcare #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with Intelligent Risk for Healthcare #2. Our solution provides customer onboarding with enterprise-grade reliability and security.
          </p>
