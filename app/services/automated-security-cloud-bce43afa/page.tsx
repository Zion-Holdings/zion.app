...
export const metadata: Metadata = {
  title: 'Automated Security Cloud',
  description: 'Optimize your real-estate workflows with Automated Security Cloud. This intelligent platform delivers resource utilization through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-security-cloud-bce43afa',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your real-estate workflows with Automated Security Cloud. This intelligent platform delivers resource utilization through advanced automation and AI.
          </p>
