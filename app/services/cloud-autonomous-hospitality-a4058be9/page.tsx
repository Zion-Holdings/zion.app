...
export const metadata: Metadata = {
  title: 'Cloud Autonomous - Hospitality',
  description: 'Drive innovation in hospitality with Cloud Autonomous - Hospitality. This AI-powered platform transforms logistics route optimization into a competitive advanta',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cloud-autonomous-hospitality-a4058be9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cloud Autonomous - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Cloud Autonomous - Hospitality. This AI-powered platform transforms logistics route optimization into a competitive advantage.
          </p>
