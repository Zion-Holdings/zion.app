...
export const metadata: Metadata = {
  title: 'Suite Autonomous - Media',
  description: 'Drive innovation in media with Suite Autonomous - Media. This AI-powered platform transforms compliance reporting into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/suite-autonomous-media-53f7ba3a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Suite Autonomous - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in media with Suite Autonomous - Media. This AI-powered platform transforms compliance reporting into a competitive advantage.
          </p>
