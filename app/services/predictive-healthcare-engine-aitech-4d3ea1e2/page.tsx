...
export const metadata: Metadata = {
  title: 'Predictive Healthcare Engine - AITECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Healthcare Engine - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated aitech solution: Predictive Healthcare Engine - AITECH. Combines email automation with next-gen AI for maximum velocity.
          </p>
