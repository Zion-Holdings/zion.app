...
export const metadata: Metadata = {
  title: 'Intelligent Advisor for HEALTHTECH',
  description: 'Hyper-accelerated healthtech solution: Intelligent Advisor for HEALTHTECH. Combines esg reporting with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-advisor-for-healthtech-58206abc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Advisor for HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated healthtech solution: Intelligent Advisor for HEALTHTECH. Combines esg reporting with next-gen AI for maximum velocity.
          </p>
