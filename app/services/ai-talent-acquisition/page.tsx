...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-platform AI candidate sourcing, Bias-free resume scoring & ranking, Automated interview scheduling & coordination, Predictive hiring success modeling, Competitor talent mapping & intelligence, DEI analytics & reporting dashboard, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Talent Acquisition &amp; Hiring Intelligence</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end AI recruiting platform — candidate sourcing, resume screening, bias-free scoring, interview scheduling, and predictive hiring success modeling.</p>
        ...
        <li class="text-slate-300">Multi-platform AI candidate sourcing</li>
        <li class="text-slate-300">Bias-free resume scoring &amp; ranking</li>
        <li class="text-slate-300">Automated interview scheduling &amp; coordination</li>
        <li class="text-slate-300">Predictive hiring success modeling</li>
        <li class="text-slate-300">Competitor talent mapping &amp; intelligence</li>
        <li class="text-slate-300">DEI analytics &amp; reporting dashboard</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai talent acquisition &amp; hiring intelligence</li>
