      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Enterprise multimodal AI for text, video, images, and audio. Unified understanding across data types for document analysis, video insights, and int...
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Unified Multimodal Understanding</li>
            <li className="text-purple-300">✓ Video Intelligence</li>
            <li className="text-purple-300">✓ Image & Visual Analysis</li>
            <li className="text-purple-300">✓ Document-to-Insight Pipelines</li>
            <li className="text-purple-300">✓ Real-Time & Batch Processing</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai multimodal intelligence</li>
