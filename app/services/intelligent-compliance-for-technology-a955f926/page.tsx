...
export const metadata: Metadata = {
  title: 'Intelligent Compliance for Technology',
  description: 'The future of technology is here with Intelligent Compliance for Technology. Powered by cutting-edge AI, this platform delivers user experience like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-compliance-for-technology-a955f926',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Compliance for Technology
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of technology is here with Intelligent Compliance for Technology. Powered by cutting-edge AI, this platform delivers user experience like never before.
          </p>
