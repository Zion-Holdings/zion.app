      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Automated contract review against playbooks: flag risky clauses, missing obligations, fee anomalies, and unfavorable T&Cs. Generates redlines + executive summary per document type (MSA, SOW, NDA, EULA).
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Clause risk scoring vs your playbook</li>
            <li className="text-purple-300">✓ Missing obligation auto-detection</li>
            <li className="text-purple-300">✓ Fee/price anomaly flagging</li>
            <li className="text-purple-300">✓ Redline stub generation per clause</li>
            <li className="text-purple-300">✓ Executive summary + risk digest</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai legal document redlining & review</li>
