...
export const metadata: Metadata = {
  ...
  keywords: 'Clause risk scoring vs your playbook, Missing obligation auto-detection, Fee/price anomaly flagging, Redline stub generation per clause, Executive summary + risk digest, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Legal Document Redlining &amp; Review</h1>
        <p className="text-lg text-slate-300 mb-8">Automated contract review against playbooks: flag risky clauses, missing obligations, fee anomalies, and unfavorable T&amp;Cs. Generates redlines + executive summary per document type (MSA, SOW, NDA, EULA).</p>
        ...
        <li class="text-slate-300">Clause risk scoring vs your playbook</li>
        <li class="text-slate-300">Missing obligation auto-detection</li>
        <li class="text-slate-300">Fee/price anomaly flagging</li>
        <li class="text-slate-300">Redline stub generation per clause</li>
        <li class="text-slate-300">Executive summary + risk digest</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai legal document redlining &amp; review</li>
