...
export const metadata: Metadata = {
  title: 'Cognitive Intelligent for Energy',
  description: 'Revolutionize energy through intelligent automation. Our Cognitive Intelligent for Energy leverages advanced machine learning to deliver enterprise-grade insigh',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-intelligent-for-energy-264e3f30',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Intelligent for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Cognitive Intelligent for Energy leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
