...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Business Compliance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Business Compliance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in automotive with Hyper-Accelerated Business Compliance. This AI-powered platform transforms content moderation into a competitive advantage.
          </p>
