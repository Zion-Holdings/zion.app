      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Multi-tier bill-of-materials analyser. Optimises part sourcing, predicts shortages, recommends alternative components, and benchmarks against global market pricing for manufacturing.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Multi-tier BOM parsing</li>
            <li className="text-purple-300">✓ Supplier intelligence and scoring</li>
            <li className="text-purple-300">✓ Alternative component finder</li>
            <li className="text-purple-300">✓ Global price benchmarking</li>
            <li className="text-purple-300">✓ Lead-time and supply-risk prediction</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai bom & procurement optimiser</li>
