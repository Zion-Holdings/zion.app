...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-tier BOM parsing, Supplier intelligence and scoring, Alternative component finder, Global price benchmarking, Lead-time and supply-risk prediction, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI BOM &amp; Procurement Optimiser</h1>
        <p className="text-lg text-slate-300 mb-8">Multi-tier bill-of-materials analyser. Optimises part sourcing, predicts shortages, recommends alternative components, and benchmarks against global market pricing for manufacturing.</p>
        ...
        <li class="text-slate-300">Multi-tier BOM parsing</li>
        <li class="text-slate-300">Supplier intelligence and scoring</li>
        <li class="text-slate-300">Alternative component finder</li>
        <li class="text-slate-300">Global price benchmarking</li>
        <li class="text-slate-300">Lead-time and supply-risk prediction</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai bom &amp; procurement optimiser</li>
