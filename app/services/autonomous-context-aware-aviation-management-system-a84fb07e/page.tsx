...
export const metadata = {
  title: "Autonomous Context-Aware Aviation Management System - Zion Tech Group",
  description: "Autonomous management system that self-optimizes context-aware aviation processes with minimal human intervention.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/autonomous-context-aware-aviation-management-system-a84fb07e`
  }
};
