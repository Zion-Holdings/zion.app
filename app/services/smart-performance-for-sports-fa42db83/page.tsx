...
export const metadata: Metadata = {
  title: 'Smart Performance for Sports',
  description: 'Revolutionize sports through intelligent automation. Our Smart Performance for Sports leverages advanced machine learning to deliver container orchestration at ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Performance for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Smart Performance for Sports leverages advanced machine learning to deliver container orchestration at scale.
          </p>
