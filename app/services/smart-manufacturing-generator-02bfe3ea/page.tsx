...
export const metadata: Metadata = {
  title: 'Smart Manufacturing Generator',
  description: 'Revolutionize automotive through intelligent automation. Our Smart Manufacturing Generator leverages advanced machine learning to deliver inventory management a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manufacturing Generator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize automotive through intelligent automation. Our Smart Manufacturing Generator leverages advanced machine learning to deliver inventory management at scale.
          </p>
