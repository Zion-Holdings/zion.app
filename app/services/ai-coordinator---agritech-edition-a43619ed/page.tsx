...
export const metadata: Metadata = {
  title: 'AI Coordinator - Agritech Edition',
  description: 'Next-generation agritech solution: AI Coordinator - Agritech Edition. Combines supply chain with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-coordinator---agritech-edition-a43619ed',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Coordinator - Agritech Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agritech solution: AI Coordinator - Agritech Edition. Combines supply chain with adaptive intelligence for optimal results.
          </p>
