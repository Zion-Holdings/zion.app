...
export const metadata: Metadata = {
  title: 'Manufacturing Intelligent - Energy',
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/manufacturing-intelligent-energy-a7e47a8f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manufacturing Intelligent - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Manufacturing Intelligent - Energy. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
