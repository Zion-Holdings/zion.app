...
export const metadata: Metadata = {
  title: 'Player Retention Customer Data Platform AI',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Player Retention Customer Data Platform AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered player retention solution for customer data. Unified customer data platform with AI-powered segmentation.
          </p>
