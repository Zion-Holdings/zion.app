...
export const metadata: Metadata = {
  ...
  keywords: 'Automatic string extraction from code, Translation management with workflow, In-context visual editing, Machine translation + human review, 80+ language support, ICU MessageFormat and plural rules, GitHub/GitLab sync and CI/CD integration, micro-saas, Developer Tools, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Translatix — i18n Localization Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Developer-friendly app localization: string extraction, translation management, in-context editing, and automated deployment. 80+ languages with MT + human review.</p>
        ...
        <li class="text-slate-300">Automatic string extraction from code</li>
        <li class="text-slate-300">Translation management with workflow</li>
        <li class="text-slate-300">In-context visual editing</li>
        <li class="text-slate-300">Machine translation + human review</li>
        <li class="text-slate-300">80+ language support</li>
        <li class="text-slate-300">ICU MessageFormat and plural rules</li>
        <li class="text-slate-300">GitHub/GitLab sync and CI/CD integration</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Localize your app in days, not months</li>
        <li class="text-slate-300">In-context editing eliminates key confusion</li>
        <li class="text-slate-300">MT + human review balances speed and quality</li>
        <li class="text-slate-300">CI/CD keeps translations in sync with code</li>
      </ul>
        </div>
