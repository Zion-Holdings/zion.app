...
export const metadata: Metadata = {
  title: 'Intelligent Data Science for MARTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Data Science for MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize martech through intelligent automation. Our Intelligent Data Science for MARTECH leverages advanced machine learning to deliver recommendation system at scale.
          </p>
