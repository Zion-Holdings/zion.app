...
export const metadata: Metadata = {
  title: 'Smart Analyzer for Insurance',
  description: 'Transform your insurance operations with our Smart Analyzer for Insurance. This AI-driven solution automates decision support with unprecedented accuracy and ef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-analyzer-for-insurance-081ebe1b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Analyzer for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Smart Analyzer for Insurance. This AI-driven solution automates decision support with unprecedented accuracy and efficiency.
          </p>
