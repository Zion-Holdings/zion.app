...
export const metadata: Metadata = {
  title: 'Intelligent Recruitment for Hospitality',
  description: 'Future-proof your hospitality with Intelligent Recruitment for Hospitality. Our autonomous solution handles code optimization end-to-end without human intervent',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-recruitment-for-hospitality-e30ae939',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Recruitment for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your hospitality with Intelligent Recruitment for Hospitality. Our autonomous solution handles code optimization end-to-end without human intervention.
          </p>
