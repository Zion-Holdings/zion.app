...
export const metadata: Metadata = {
  title: 'Autonomous Automation for Media',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Automation for Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation media solution: Autonomous Automation for Media. Combines language processing with adaptive intelligence for optimal results.
          </p>
