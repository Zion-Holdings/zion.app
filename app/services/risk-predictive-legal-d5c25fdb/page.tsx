...
export const metadata: Metadata = {
  title: 'Risk Predictive - Legal',
  description: 'Unlock unprecedented growth with Risk Predictive - Legal. This autonomous system provides background checks with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/risk-predictive-legal-d5c25fdb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Risk Predictive - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Risk Predictive - Legal. This autonomous system provides background checks with zero manual intervention needed.
          </p>
