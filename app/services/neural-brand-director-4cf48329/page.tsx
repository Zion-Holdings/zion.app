...
export const metadata: Metadata = {
  title: 'Neural Brand Director',
  description: 'Revolutionize construction through intelligent automation. Our Neural Brand Director leverages advanced machine learning to deliver inventory management at scal',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Brand Director
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Neural Brand Director leverages advanced machine learning to deliver inventory management at scale.
          </p>
