...
export const metadata: Metadata = {
  title: 'Coordinator Autonomous - Tech',
  description: 'The future of technology is here with Coordinator Autonomous - Tech. Powered by cutting-edge AI, this platform delivers logistics route optimization like never ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/coordinator-autonomous---tech-29eaa942',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Coordinator Autonomous - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of technology is here with Coordinator Autonomous - Tech. Powered by cutting-edge AI, this platform delivers logistics route optimization like never before.
          </p>
