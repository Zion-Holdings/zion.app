...
export const metadata: Metadata = {
  title: 'Time Tracking AI-Powered Content Generation Platform',
  description: 'AI-powered time tracking solution for marketing. Generates high-quality, SEO-optimized content at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/time-tracking-ai-powered-content-generation-platform-e06ecea9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Time Tracking AI-Powered Content Generation Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered time tracking solution for marketing. Generates high-quality, SEO-optimized content at scale.
          </p>
