...
export const metadata: Metadata = {
  title: 'Cognitive Engine for Retail',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Engine for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your retail business with Cognitive Engine for Retail. Our solution provides financial planning with enterprise-grade reliability and security.
          </p>
