...
export const metadata: Metadata = {
  title: 'AI Management - Insurance Edition',
  description: 'The future of insurance is here with AI Management - Insurance Edition. Powered by cutting-edge AI, this platform delivers transformative results like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-management-insurance-edition-47f840cf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Management - Insurance Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with AI Management - Insurance Edition. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
