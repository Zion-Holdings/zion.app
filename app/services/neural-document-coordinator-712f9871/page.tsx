...
export const metadata: Metadata = {
  title: 'Neural Document Coordinator',
  description: 'Revolutionize healthcare through intelligent automation. Our Neural Document Coordinator leverages advanced machine learning to deliver language processing at s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Document Coordinator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Neural Document Coordinator leverages advanced machine learning to deliver language processing at scale.
          </p>
