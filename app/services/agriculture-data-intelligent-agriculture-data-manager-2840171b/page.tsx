...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://ziontechgroup.com/services/agriculture-data-intelligent-agriculture-data-manager-2840171b",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Intelligent Agriculture Data Manager - AI-Powered Agriculture Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          Intelligent Agriculture Data Manager for Agriculture - Delivers HIPAA compliant results with AI-driven automation. Boost efficiency, reduce costs, and accelerat
        </p>
