...
export const metadata: Metadata = {
  title: 'Intelligent Deep Learning for Legal',
  description: 'Drive innovation in legal with Intelligent Deep Learning for Legal. This AI-powered platform transforms hr analytics into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-deep-learning-for-legal-d93f91f8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Deep Learning for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Intelligent Deep Learning for Legal. This AI-powered platform transforms hr analytics into a competitive advantage.
          </p>
