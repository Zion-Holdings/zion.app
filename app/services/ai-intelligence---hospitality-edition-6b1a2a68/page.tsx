...
export const metadata: Metadata = {
  title: 'AI Intelligence - Hospitality Edition',
  description: 'Transform your hospitality operations with our AI Intelligence - Hospitality Edition. This AI-driven solution automates maintenance scheduling with unprecedente',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Intelligence - Hospitality Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our AI Intelligence - Hospitality Edition. This AI-driven solution automates maintenance scheduling with unprecedented accuracy and efficiency.
          </p>
