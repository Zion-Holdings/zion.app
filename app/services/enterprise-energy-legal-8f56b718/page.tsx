...
export const metadata: Metadata = {
  title: 'Enterprise Energy - Legal',
  description: 'The future of legal is here with Enterprise Energy - Legal. Powered by cutting-edge AI, this platform delivers influencer identification like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-energy-legal-8f56b718',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Energy - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Enterprise Energy - Legal. Powered by cutting-edge AI, this platform delivers influencer identification like never before.
          </p>
