...
export const metadata: Metadata = {
  title: 'Smart Advisor Solution',
  description: 'Transform your insurance operations with our Smart Advisor Solution. This security solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-advisor-solution-2cc94d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Advisor Solution
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Smart Advisor Solution. This security solution delivers unprecedented automation and intelligence.
          </p>
