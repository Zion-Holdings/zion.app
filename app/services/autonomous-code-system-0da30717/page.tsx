...
export const metadata: Metadata = {
  title: 'Autonomous Code System',
  description: 'Transform your logistics operations with our Autonomous Code System. This AI-driven solution automates healthcare data analytics with unprecedented accuracy and',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Code System
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Autonomous Code System. This AI-driven solution automates healthcare data analytics with unprecedented accuracy and efficiency.
          </p>
