...
export const metadata: Metadata = {
  title: 'Automated Autonomous for Energy',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Autonomous for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Automated Autonomous for Energy. Powered by cutting-edge AI, this platform delivers neural architecture like never before.
          </p>
