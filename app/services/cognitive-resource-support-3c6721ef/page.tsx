...
export const metadata: Metadata = {
  title: 'Cognitive Resource Support',
  description: 'Revolutionize gaming through intelligent automation. Our Cognitive Resource Support leverages advanced machine learning to deliver enterprise-grade insights at ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-resource-support-3c6721ef',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Resource Support
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize gaming through intelligent automation. Our Cognitive Resource Support leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
