  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Merge Request Health Check</h1>
        <p className="text-lg text-gray-300 mb-8">Reviews pull/merge request quality, security, test coverage, docs completeness, and rollback readiness before merge.</p>
