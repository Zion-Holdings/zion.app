...
export const metadata: Metadata = {
  ...
  keywords: 'Continuous compliance monitoring, Automated evidence collection, Policy management and enforcement, Audit-ready report generation, Risk assessment and remediation tracking, Multi-framework support (SOC 2, HIPAA, PCI, ISO, GDPR), security, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Compliance Automation &amp; Audit Readiness</h1>
        <p className="text-lg text-slate-300 mb-8">Automate compliance for SOC 2, HIPAA, PCI DSS, ISO 27001, and GDPR. Continuous monitoring, evidence collection, and audit-ready reporting.</p>
        ...
        <li class="text-slate-300">Policy management and enforcement</li>
        <li class="text-slate-300">Audit-ready report generation</li>
        <li class="text-slate-300">Risk assessment and remediation tracking</li>
        <li class="text-slate-300">Multi-framework support (SOC 2, HIPAA, PCI, ISO, GDPR)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce audit prep time by 80%</li>
        <li class="text-slate-300">Continuous compliance not point-in-time</li>
        <li class="text-slate-300">Automate evidence collection</li>
        <li class="text-slate-300">Pass audits with confidence</li>
      </ul>
        </div>
