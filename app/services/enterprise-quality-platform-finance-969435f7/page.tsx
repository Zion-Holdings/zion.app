...
export const metadata: Metadata = {
  title: 'Enterprise Quality Platform - Finance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Quality Platform - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our Enterprise Quality Platform - Finance leverages advanced machine learning to deliver performance monitoring at scale.
          </p>
