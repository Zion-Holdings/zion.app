...
export const metadata: Metadata = {
  title: 'Next-Gen Business Intelligence for TECHNOLOGY',
  description: 'Optimize your technology workflows with Next-Gen Business Intelligence for TECHNOLOGY. This intelligent platform delivers loyalty optimization through advanced ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Business Intelligence for TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your technology workflows with Next-Gen Business Intelligence for TECHNOLOGY. This intelligent platform delivers loyalty optimization through advanced automation and AI.
          </p>
