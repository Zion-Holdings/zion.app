...
export const metadata: Metadata = {
  ...
  description: 'The future of telecom is here with Autonomous Process Mining System - Telecom. Powered by cutting-edge AI, this platform delivers contract analysis like never b',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of telecom is here with Autonomous Process Mining System - Telecom. Powered by cutting-edge AI, this platform delivers contract analysis like never before.
          </p>
