...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Knowledge - Construction',
  description: 'Optimize your construction workflows with Hyper-Accelerated Knowledge - Construction. This intelligent platform delivers roi tracking through advanced automatio',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/hyper-accelerated-knowledge-construction-68ddd362',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Knowledge - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Hyper-Accelerated Knowledge - Construction. This intelligent platform delivers roi tracking through advanced automation and AI.
          </p>
