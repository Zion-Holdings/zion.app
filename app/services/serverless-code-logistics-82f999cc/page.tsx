...
export const metadata: Metadata = {
  title: 'Serverless code-logistics',
  description: 'The future of logistics is here with Serverless code-logistics. Powered by cutting-edge AI, this platform delivers regulatory tracking like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/serverless-code-logistics-82f999cc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Serverless code-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Serverless code-logistics. Powered by cutting-edge AI, this platform delivers regulatory tracking like never before.
          </p>
