...
export const metadata: Metadata = {
  title: 'Intelligent Insights for Legal',
  description: 'Optimize your legal workflows with Intelligent Insights for Legal. This intelligent platform delivers influencer identification through advanced automation and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-insights-for-legal-f9da8329',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Insights for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with Intelligent Insights for Legal. This intelligent platform delivers influencer identification through advanced automation and AI.
          </p>
