...
export const metadata: Metadata = {
  title: 'AI/IT Enterprise Suite - Transportation',
  description: 'Quantum leap forward for transportation: AI/IT Enterprise Suite - Transportation. Uses quantum-inspired algorithms to deliver demand planning at exponential spe',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Enterprise Suite - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for transportation: AI/IT Enterprise Suite - Transportation. Uses quantum-inspired algorithms to deliver demand planning at exponential speed.
          </p>
