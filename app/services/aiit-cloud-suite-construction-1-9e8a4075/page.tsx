...
export const metadata: Metadata = {
  title: 'AI/IT Cloud Suite - Construction #1',
  description: 'The future of construction is here with AI/IT Cloud Suite - Construction #1. Powered by cutting-edge AI, this platform delivers market analysis like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-cloud-suite-construction-1-9e8a4075',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Cloud Suite - Construction #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with AI/IT Cloud Suite - Construction #1. Powered by cutting-edge AI, this platform delivers market analysis like never before.
          </p>
