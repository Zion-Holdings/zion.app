...
export const metadata: Metadata = {
  title: 'Intelligent data-tech',
  description: 'Revolutionize technology through intelligent automation. Our Intelligent data-tech leverages advanced machine learning to deliver customer service automation at',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our Intelligent data-tech leverages advanced machine learning to deliver customer service automation at scale.
          </p>
