...
export const metadata: Metadata = {
  ...
  keywords: 'Metric anomaly scoring, Correlation across services, Predictive alerting (30 min lead), Integration with PagerDuty & Slack, ai, E-Commerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-AIOps Anomaly Detection</h1>
        <p className="text-lg text-slate-300 mb-8">Detects infrastructure anomalies (CPU, memory, error rates) before they cause outages using unsupervised learning and seasonal decomposition.</p>
        ...
        <li class="text-slate-300">Metric anomaly scoring</li>
        <li class="text-slate-300">Correlation across services</li>
        <li class="text-slate-300">Predictive alerting (30 min lead)</li>
        <li class="text-slate-300">Integration with PagerDuty &amp; Slack</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai-aiops anomaly detection</li>
