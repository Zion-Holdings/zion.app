...
export const metadata: Metadata = {
  title: 'Deep Learning Intelligent - CLEANTECH',
  description: 'Drive innovation in cleantech with Deep Learning Intelligent - CLEANTECH. This AI-powered platform transforms benefits administration into a competitive advanta',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Deep Learning Intelligent - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in cleantech with Deep Learning Intelligent - CLEANTECH. This AI-powered platform transforms benefits administration into a competitive advantage.
          </p>
