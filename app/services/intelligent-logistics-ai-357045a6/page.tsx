...
export const metadata: Metadata = {
  title: 'Intelligent Logistics AI',
  description: 'Transform your retail operations with our Intelligent Logistics AI. This AI-driven solution provides intelligent automation with unprecedented accuracy and effi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-logistics-ai-357045a6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Logistics AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our Intelligent Logistics AI. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
