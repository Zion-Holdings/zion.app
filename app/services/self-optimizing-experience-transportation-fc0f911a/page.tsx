...
export const metadata: Metadata = {
  title: 'Self-Optimizing experience-transportation',
  description: 'Drive innovation in transportation with Self-Optimizing experience-transportation. This AI-powered platform transforms customer journey mapping into a competiti',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing experience-transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in transportation with Self-Optimizing experience-transportation. This AI-powered platform transforms customer journey mapping into a competitive advantage.
          </p>
