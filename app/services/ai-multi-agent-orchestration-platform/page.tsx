    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        ...
        <p className="text-xl text-slate-300 mb-8">
          Deploy, manage, and monitor fleets of autonomous AI agents that collaborate on complex tasks. Features agent-to-agent communication, task decomposition, result 
        </p>
