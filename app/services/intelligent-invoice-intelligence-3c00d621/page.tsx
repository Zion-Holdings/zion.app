...
export const metadata: Metadata = {
  title: 'Intelligent Invoice Intelligence',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Invoice Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation media solution: Intelligent Invoice Intelligence. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
