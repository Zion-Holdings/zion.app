...
export const metadata: Metadata = {
  title: 'Self-Optimizing Threat Processor',
  description: 'Transform your hospitality operations with our Self-Optimizing Threat Processor. This AI-driven solution automates supply chain with unprecedented accuracy and ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Threat Processor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Self-Optimizing Threat Processor. This AI-driven solution automates supply chain with unprecedented accuracy and efficiency.
          </p>
