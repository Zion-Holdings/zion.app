...
export const metadata: Metadata = {
  title: 'Smart Decision Platform - Hospitality',
  description: 'The future of hospitality is here with Smart Decision Platform - Hospitality. Powered by cutting-edge AI, this platform delivers recruitment automation like nev',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-decision-platform-hospitality-665792d9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Decision Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Smart Decision Platform - Hospitality. Powered by cutting-edge AI, this platform delivers recruitment automation like never before.
          </p>
