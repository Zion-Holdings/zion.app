...
export const metadata: Metadata = {
  title: 'Experience Automated - Insurance',
  description: 'Next-generation insurance solution: Experience Automated - Insurance. Combines process automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/experience-automated-insurance-cb2ccaa3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Experience Automated - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Experience Automated - Insurance. Combines process automation with adaptive intelligence for optimal results.
          </p>
