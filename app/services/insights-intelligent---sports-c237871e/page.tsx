...
export const metadata: Metadata = {
  title: 'Insights Intelligent - Sports',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Insights Intelligent - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation sports solution: Insights Intelligent - Sports. Combines workflow management with adaptive intelligence for optimal results.
          </p>
