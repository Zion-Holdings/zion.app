...
export const metadata: Metadata = {
  title: 'Smart Risk for Manufacturing',
  description: 'Revolutionize manufacturing through intelligent automation. Our Smart Risk for Manufacturing leverages advanced machine learning to deliver image recognition at',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-risk-for-manufacturing-e4187292',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Risk for Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize manufacturing through intelligent automation. Our Smart Risk for Manufacturing leverages advanced machine learning to deliver image recognition at scale.
          </p>
