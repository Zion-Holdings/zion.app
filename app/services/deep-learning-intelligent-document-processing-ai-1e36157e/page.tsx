...
export const metadata: Metadata = {
  title: 'Deep Learning Intelligent Document Processing AI',
  description: 'deep learning solution for smart city industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/deep-learning-intelligent-document-processing-ai-1e36157e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Deep Learning Intelligent Document Processing AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            deep learning solution for smart city industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.
          </p>
