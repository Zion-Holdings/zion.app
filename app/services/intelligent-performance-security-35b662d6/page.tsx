...
export const metadata: Metadata = {
  title: 'Intelligent Performance Security',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize iot through intelligent automation. Our Intelligent Performance Security leverages advanced machine learning to deliver quality control at scale.
          </p>
