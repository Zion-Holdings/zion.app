...
export const metadata: Metadata = {
  ...
  description: 'The future of media is here with Predictive Financial Intelligence. Powered by cutting-edge AI, this platform delivers logistics route optimization like never b',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-financial-intelligence-c1f7a502',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of media is here with Predictive Financial Intelligence. Powered by cutting-edge AI, this platform delivers logistics route optimization like never before.
          </p>
