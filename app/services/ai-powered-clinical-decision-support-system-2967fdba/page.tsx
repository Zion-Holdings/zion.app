...
export const metadata: Metadata = {
  ...
  description: 'Real-time clinical decision support with evidence-based recommendations.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-clinical-decision-support-system-2967fdba',
  },
};
