...
export const metadata: Metadata = {
  title: 'Autonomous Computer Vision System - Retail',
  description: 'The future of retail is here with Autonomous Computer Vision System - Retail. Powered by cutting-edge AI, this platform delivers access management like never be',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Computer Vision System - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Autonomous Computer Vision System - Retail. Powered by cutting-edge AI, this platform delivers access management like never before.
          </p>
