...
export const metadata: Metadata = {
  title: 'Intelligent finance-education',
  description: 'Next-generation education solution: Intelligent finance-education. Combines risk assessment with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-finance-education-b7d3ed50',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation education solution: Intelligent finance-education. Combines risk assessment with adaptive intelligence for optimal results.
          </p>
