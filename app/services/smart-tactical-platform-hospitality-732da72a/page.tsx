...
export const metadata: Metadata = {
  title: 'Smart Tactical Platform - Hospitality',
  description: 'Unlock unprecedented growth with Smart Tactical Platform - Hospitality. This autonomous system provides brand monitoring with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-tactical-platform-hospitality-732da72a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Tactical Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Tactical Platform - Hospitality. This autonomous system provides brand monitoring with zero manual intervention needed.
          </p>
