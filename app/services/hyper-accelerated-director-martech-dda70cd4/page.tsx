...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Director - MARTECH',
  description: 'Enhance your martech business with Hyper-Accelerated Director - MARTECH. Our solution provides event-driven architecture with enterprise-grade reliability and s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Director - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your martech business with Hyper-Accelerated Director - MARTECH. Our solution provides event-driven architecture with enterprise-grade reliability and security.
          </p>
