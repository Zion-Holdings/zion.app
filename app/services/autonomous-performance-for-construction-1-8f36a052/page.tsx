...
export const metadata: Metadata = {
  title: 'Autonomous Performance for Construction #1',
  description: 'The future of construction is here with Autonomous Performance for Construction #1. Powered by cutting-edge AI, this platform delivers document processing like ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-performance-for-construction-1-8f36a052',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Performance for Construction #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Autonomous Performance for Construction #1. Powered by cutting-edge AI, this platform delivers document processing like never before.
          </p>
