...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "AI Conversational Analytics | Zion Tech Group",
    description: "Analyze customer conversations across chat, email, and voice. Extract sentiment, intent, and actionable insights to improve customer experience.",
    url: "https://ziontechgroup.com/services/ai-conversational-analytics/",
    type: 'website',
  },
  alternates: { canonical: "/services/ai-conversational-analytics/" },
};

export default function AiConversationalAnalyticsPage() {
  return (
    <StandardPage
      title="AI Conversational Analytics"
      subtitle="Analyze customer conversations across chat, email, and voice. Extract sentiment, intent, and actionable insights to improve customer experience."
      breadcrumbItems={[
        { label: "Home", href: "/" },
        { label: "Services", href: "/services/" },
        { label: "AI Conversational Analytics" }
      ]}
      actions={[
    ...
    >
        ...
        <div className="rounded-2xl border border-white/10 bg-slate-900/40 p-5"><h2 className="text-white font-semibold mb-2">AI Conversational Analytics</h2><p className="text-slate-400 text-sm">Archived section recovered from the live site snapshot.</p></div>
      ...
      <p className="text-slate-400 leading-relaxed mb-4 max-w-5xl mx-auto">Estimated timeline for AI Conversational Analytics — adapt to your team size and complexity.</p>
      ...
      <p className="text-slate-500 text-sm max-w-5xl mx-auto">Restored from a Wayback Machine snapshot (20260614131617) of ziontechgroup.com.</p>
    </StandardPage>
  );
}
