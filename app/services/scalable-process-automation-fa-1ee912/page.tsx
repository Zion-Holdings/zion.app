...
export const metadata: Metadata = {
  title: 'Scalable Process Automation Fastify (It)',
  description: 'Scalable Process Automation Fastify (It) is an AI-powered it solution that transforms how businesses operate through intelligent automation and real-time analyt',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/scalable-process-automation-fa-1ee912',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Scalable Process Automation Fastify (It)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Scalable Process Automation Fastify (It) is an AI-powered it solution that transforms how businesses operate through intelligent automation and real-time analytics.
