...
export const metadata: Metadata = {
  title: 'Learning Platforms AI-Powered Dashboard Creation',
  description: 'AI-powered learning platforms solution for bi. Auto-generates dashboards from data patterns and user behavior.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/learning-platforms-ai-powered-dashboard-creation-6d0192f9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Learning Platforms AI-Powered Dashboard Creation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered learning platforms solution for bi. Auto-generates dashboards from data patterns and user behavior.
          </p>
