...
export const metadata: Metadata = {
  ...
  keywords: 'Edge computing support, API-first design, Audit trails, Multi-region deployment, automation, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Smart Platform for Tech</h1>
        <p className="text-lg text-slate-300 mb-8">The future of technology is here with Smart Platform for Tech. Powered by cutting-edge AI, this platform delivers inventory management like never before.</p>
