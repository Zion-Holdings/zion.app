...
export const metadata: Metadata = {
  ...
  keywords: 'Contract drafting from templates, Negotiation and redlining, E-signature and execution, Obligation and milestone tracking, Renewal and expiry alerts, Integration with DocuSign, Ironclad, Contractbook, automation, Legal, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Contract Lifecycle Management</h1>
        <p className="text-lg text-slate-300 mb-8">Manage contracts: drafting, negotiation, execution, renewal, compliance. Reduce contract cycle time 50%.</p>
        ...
        <li class="text-slate-300">Contract drafting from templates</li>
        <li class="text-slate-300">Negotiation and redlining</li>
        <li class="text-slate-300">E-signature and execution</li>
        <li class="text-slate-300">Obligation and milestone tracking</li>
        <li class="text-slate-300">Renewal and expiry alerts</li>
        <li class="text-slate-300">Integration with DocuSign</li>
        <li class="text-slate-300">Ironclad</li>
        <li class="text-slate-300">Contractbook</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce contract cycle time by 50%</li>
        <li class="text-slate-300">Template drafting accelerates creation</li>
        <li class="text-slate-300">Obligation tracking prevents missed commitments</li>
        <li class="text-slate-300">Renewal alerts prevent auto-renewal surprises</li>
      </ul>
        </div>
