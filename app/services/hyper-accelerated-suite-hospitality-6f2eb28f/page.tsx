...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Suite - Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Hyper-Accelerated Suite - Hospitality leverages advanced machine learning to deliver survey automa',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/hyper-accelerated-suite-hospitality-6f2eb28f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Suite - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Hyper-Accelerated Suite - Hospitality leverages advanced machine learning to deliver survey automation at scale.
          </p>
