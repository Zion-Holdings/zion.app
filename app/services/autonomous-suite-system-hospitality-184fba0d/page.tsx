...
export const metadata: Metadata = {
  title: 'Autonomous Suite System - Hospitality',
  description: 'Unlock unprecedented growth with Autonomous Suite System - Hospitality. This autonomous system provides data governance with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-suite-system-hospitality-184fba0d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Suite System - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Autonomous Suite System - Hospitality. This autonomous system provides data governance with zero manual intervention needed.
          </p>
