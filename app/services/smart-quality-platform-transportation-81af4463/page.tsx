...
export const metadata: Metadata = {
  title: 'Smart Quality Platform - Transportation',
  description: 'Enhance your transportation business with Smart Quality Platform - Transportation. Our solution provides executive dashboards with enterprise-grade reliability ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-quality-platform-transportation-81af4463',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Quality Platform - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with Smart Quality Platform - Transportation. Our solution provides executive dashboards with enterprise-grade reliability and security.
          </p>
