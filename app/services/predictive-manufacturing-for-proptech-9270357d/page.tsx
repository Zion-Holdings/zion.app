...
export const metadata: Metadata = {
  title: 'Predictive Manufacturing for Proptech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Manufacturing for Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation proptech solution: Predictive Manufacturing for Proptech. Combines content generation with adaptive intelligence for optimal results.
          </p>
