...
export const metadata: Metadata = {
  title: 'Smart Computer Vision Platform - Hospitality',
  description: 'Drive innovation in hospitality with Smart Computer Vision Platform - Hospitality. This AI-powered platform transforms customer journey mapping into a competiti',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Computer Vision Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Smart Computer Vision Platform - Hospitality. This AI-powered platform transforms customer journey mapping into a competitive advantage.
          </p>
