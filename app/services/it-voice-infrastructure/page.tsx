...
export const metadata: Metadata = {
  ...
  keywords: 'SIP and VoIP infrastructure, Intelligent routing and IVR, Call quality monitoring, AI agent assistance, Omnichannel integration, cloud, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Voice Infrastructure &amp; Contact Center Solutions</h1>
        <p className="text-lg text-slate-300 mb-8">Modern contact center infrastructure - SIP trunking, IVR design, call routing, quality monitoring, and AI agent assistance.</p>
        ...
        <li class="text-slate-300">SIP and VoIP infrastructure</li>
        <li class="text-slate-300">Intelligent routing and IVR</li>
        <li class="text-slate-300">Call quality monitoring</li>
        <li class="text-slate-300">AI agent assistance</li>
        <li class="text-slate-300">Omnichannel integration</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with voice infrastructure &amp; contact center solutions</li>
