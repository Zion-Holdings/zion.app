...
export const metadata: Metadata = {
  title: 'AI Data - Construction Edition',
  description: 'Transform your construction operations with our AI Data - Construction Edition. This AI-driven solution automates feature engineering with unprecedented accurac',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Data - Construction Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our AI Data - Construction Edition. This AI-driven solution automates feature engineering with unprecedented accuracy and efficiency.
          </p>
