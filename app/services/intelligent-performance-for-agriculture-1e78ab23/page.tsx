...
export const metadata: Metadata = {
  ...
  description: 'Next-generation agriculture solution: Intelligent Performance for Agriculture. Combines incident response with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-performance-for-agriculture-1e78ab23',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agriculture solution: Intelligent Performance for Agriculture. Combines incident response with adaptive intelligence for optimal results.
          </p>
