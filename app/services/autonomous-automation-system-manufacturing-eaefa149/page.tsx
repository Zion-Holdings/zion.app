...
export const metadata: Metadata = {
  ...
  description: 'Unlock unprecedented growth with Autonomous Automation System - Manufacturing. This autonomous system provides brand sentiment with zero manual intervention nee',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-automation-system-manufacturing-eaefa149',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Autonomous Automation System - Manufacturing. This autonomous system provides brand sentiment with zero manual intervention needed.
          </p>
