...
export const metadata: Metadata = {
  title: 'Cognitive Feedback Intelligent',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Feedback Intelligent
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of manufacturing is here with Cognitive Feedback Intelligent. Powered by cutting-edge AI, this platform delivers contract analysis like never before.
          </p>
