...
export const metadata: Metadata = {
  title: 'Tax Management AI-Powered Market Intelligence',
  description: 'tax management solution for bridges & tunnels industry. Monitors market trends, competitor activities, and industry news to provide actionable insights.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/tax-management-ai-powered-market-intelligence-b010ad0b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Tax Management AI-Powered Market Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            tax management solution for bridges & tunnels industry. Monitors market trends, competitor activities, and industry news to provide actionable insights.
          </p>
