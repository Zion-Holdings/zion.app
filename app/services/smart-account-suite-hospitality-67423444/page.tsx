...
export const metadata: Metadata = {
  title: 'Smart Account Suite - Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Smart Account Suite - Hospitality leverages advanced machine learning to deliver image recognition',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-account-suite-hospitality-67423444',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Account Suite - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Smart Account Suite - Hospitality leverages advanced machine learning to deliver image recognition at scale.
          </p>
