...
export const metadata: Metadata = {
  title: 'Smart Analyzer Platform - Agriculture',
  description: 'Optimize your agriculture workflows with Smart Analyzer Platform - Agriculture. This intelligent platform delivers account planning through advanced automation ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-analyzer-platform-agriculture-f8786dc6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Analyzer Platform - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your agriculture workflows with Smart Analyzer Platform - Agriculture. This intelligent platform delivers account planning through advanced automation and AI.
          </p>
