...
export const metadata: Metadata = {
  title: 'Automated Security for Legal',
  description: 'Revolutionize legal through intelligent automation. Our Automated Security for Legal leverages advanced machine learning to deliver risk assessment at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-security-for-legal-9643af63',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Security for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Automated Security for Legal leverages advanced machine learning to deliver risk assessment at scale.
          </p>
