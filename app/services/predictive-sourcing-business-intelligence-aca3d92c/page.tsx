...
export const metadata: Metadata = {
  title: 'Predictive Sourcing Business Intelligence',
  description: 'Transform your healthcare operations with our Predictive Sourcing Business Intelligence. This AI-driven solution automates employee engagement with unprecedente',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-sourcing-business-intelligence-aca3d92c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Sourcing Business Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Predictive Sourcing Business Intelligence. This AI-driven solution automates employee engagement with unprecedented accuracy and efficiency.
          </p>
