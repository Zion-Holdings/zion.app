...
export const metadata: Metadata = {
  title: 'Automated optimization-insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated optimization-insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Automated optimization-insurance. This AI-driven solution automates project portfolio with unprecedented accuracy and efficiency.
          </p>
