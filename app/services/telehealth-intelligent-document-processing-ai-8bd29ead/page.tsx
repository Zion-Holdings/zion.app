...
export const metadata: Metadata = {
  title: 'Telehealth Intelligent Document Processing AI',
  description: 'telehealth solution for media industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/telehealth-intelligent-document-processing-ai-8bd29ead',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Telehealth Intelligent Document Processing AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            telehealth solution for media industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.
          </p>
