...
export const metadata: Metadata = {
  ...
  keywords: 'Public voting board, Duplicate detection and merging, Status tracking (planned, in-progress, done), Public roadmap publishing, Integration with Intercom, Slack, Zendesk, Admin moderation tools, Email notifications for voters, Embeddable widget, micro-saas, SaaS, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">FeatureVote — Feature Request Voting Board</h1>
        <p className="text-lg text-slate-300 mb-8">Public feature request board with voting, status tracking, and roadmap publishing. Help product teams prioritize based on real customer demand.</p>
        ...
        <li class="text-slate-300">Public voting board</li>
        <li class="text-slate-300">Duplicate detection and merging</li>
        <li class="text-slate-300">Status tracking (planned, in-progress, done)</li>
        <li class="text-slate-300">Public roadmap publishing</li>
        <li class="text-slate-300">Integration with Intercom, Slack, Zendesk</li>
        <li class="text-slate-300">Admin moderation tools</li>
        <li class="text-slate-300">Email notifications for voters</li>
        <li class="text-slate-300">Embeddable widget</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Build what customers actually want</li>
        <li class="text-slate-300">Reduce support ticket volume</li>
        <li class="text-slate-300">Transparent product roadmap</li>
