...
export const metadata: Metadata = {
  title: 'Analytics Enterprise - Legal',
  description: 'Drive innovation in legal with Analytics Enterprise - Legal. This AI-powered platform transforms influencer identification into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/analytics-enterprise-legal-df6db06c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Analytics Enterprise - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Analytics Enterprise - Legal. This AI-powered platform transforms influencer identification into a competitive advantage.
          </p>
