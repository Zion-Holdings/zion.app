...
export const metadata: Metadata = {
  title: 'Next-Gen Management for Real-Estate',
  description: 'Transform your real-estate operations with our Next-Gen Management for Real-Estate. This AI-driven solution automates scenario planning with unprecedented accur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-management-for-real-estate-8a964a89',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Management for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Next-Gen Management for Real-Estate. This AI-driven solution automates scenario planning with unprecedented accuracy and efficiency.
          </p>
