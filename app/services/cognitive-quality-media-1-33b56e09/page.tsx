...
export const metadata: Metadata = {
  title: 'Cognitive quality-media #1',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive quality-media #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize media through intelligent automation. Our Cognitive quality-media #1 leverages advanced machine learning to deliver content moderation at scale.
          </p>
