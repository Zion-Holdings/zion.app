...
export const metadata: Metadata = {
  title: 'Smart Energy Platform - Retail',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Energy Platform - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your retail with Smart Energy Platform - Retail. Our autonomous solution handles compliance monitoring end-to-end without human intervention.
          </p>
