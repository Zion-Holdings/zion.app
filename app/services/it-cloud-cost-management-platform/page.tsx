...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-cloud cost break-down (EC2/RDS/Lambda etc.), Rightsizing recommendation engine (>50% CPU idle), RI/SA coverage gap alert + expiry tracker, Chargeback/showback per team/project, it, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cloud Cost Management Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Multi-cloud cost visibility, rightsizing recommendations, RI/SA coverage gap, budget alert, chargeback/showback per team.</p>
        ...
        <li class="text-slate-300">Multi-cloud cost break-down (EC2/RDS/Lambda etc.)</li>
        <li class="text-slate-300">Rightsizing recommendation engine (&gt;50% CPU idle)</li>
        <li class="text-slate-300">RI/SA coverage gap alert + expiry tracker</li>
        <li class="text-slate-300">Chargeback/showback per team/project</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with cloud cost management platform</li>
