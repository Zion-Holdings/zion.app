...
export const metadata: Metadata = {
  title: 'Smart Real Estate Platform - Tech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Real Estate Platform - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation technology solution: Smart Real Estate Platform - Tech. Combines account planning with adaptive intelligence for optimal results.
          </p>
