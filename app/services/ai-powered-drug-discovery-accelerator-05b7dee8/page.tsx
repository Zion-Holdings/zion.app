...
export const metadata: Metadata = {
  ...
  description: 'Accelerates drug discovery by predicting molecular properties, binding affinity, and toxicity using deep learning.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-drug-discovery-accelerator-05b7dee8',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Accelerates drug discovery by predicting molecular properties, binding affinity, and toxicity using deep learning.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Molecular prediction</li>
          <li className="text-gray-300">Binding affinity</li>
          <li className="text-gray-300">Toxicity screening</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">5x faster discovery</li>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$199999</p>
          <ul className="space-y-2 mb-4">
