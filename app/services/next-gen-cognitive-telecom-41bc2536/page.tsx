...
export const metadata: Metadata = {
  title: 'Next-Gen Cognitive - Telecom',
  description: 'Drive innovation in telecom with Next-Gen Cognitive - Telecom. This AI-powered platform transforms procurement automation into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-cognitive-telecom-41bc2536',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Cognitive - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in telecom with Next-Gen Cognitive - Telecom. This AI-powered platform transforms procurement automation into a competitive advantage.
          </p>
