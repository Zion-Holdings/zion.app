...
export const metadata = {
  title: "Predictive Frictionless Financial Risk Scoring - Zion Tech Group",
  description: "Predictive risk scoring engine that assesses frictionless financial vulnerabilities with machine learning.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/predictive-frictionless-financial-risk-scoring-d8b10a35`
  }
};
