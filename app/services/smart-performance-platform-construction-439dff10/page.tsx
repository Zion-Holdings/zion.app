...
export const metadata: Metadata = {
  title: 'Smart Performance Platform - Construction',
  description: 'Revolutionize construction through intelligent automation. Our Smart Performance Platform - Construction leverages advanced machine learning to deliver quota op',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-performance-platform-construction-439dff10',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Performance Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Smart Performance Platform - Construction leverages advanced machine learning to deliver quota optimization at scale.
          </p>
