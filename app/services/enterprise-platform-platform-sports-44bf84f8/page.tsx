...
export const metadata: Metadata = {
  title: 'Enterprise Platform Platform - Sports',
  description: 'Next-generation sports solution: Enterprise Platform Platform - Sports. Combines succession planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-platform-platform-sports-44bf84f8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Platform Platform - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation sports solution: Enterprise Platform Platform - Sports. Combines succession planning with adaptive intelligence for optimal results.
          </p>
