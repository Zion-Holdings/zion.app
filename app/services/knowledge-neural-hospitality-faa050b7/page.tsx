...
export const metadata: Metadata = {
  title: 'Knowledge Neural - Hospitality',
  description: 'Transform your hospitality operations with our Knowledge Neural - Hospitality. This AI-driven solution automates pipeline management with unprecedented accuracy',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/knowledge-neural-hospitality-faa050b7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Knowledge Neural - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Knowledge Neural - Hospitality. This AI-driven solution automates pipeline management with unprecedented accuracy and efficiency.
          </p>
