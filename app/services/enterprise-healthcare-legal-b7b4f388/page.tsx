...
export const metadata: Metadata = {
  title: 'Enterprise Healthcare - Legal',
  description: 'Revolutionize legal through intelligent automation. Our Enterprise Healthcare - Legal leverages advanced machine learning to deliver performance monitoring at s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-healthcare-legal-b7b4f388',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Healthcare - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Enterprise Healthcare - Legal leverages advanced machine learning to deliver performance monitoring at scale.
          </p>
