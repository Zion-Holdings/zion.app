...
export const metadata: Metadata = {
  ...
  keywords: 'Layer-7 IDS/IPS with Suricata rules, Deep packet inspection + SSL/TLS decryption, Threat intelligence feed (10K+ IOC feed), Cloud firewall auto-sync (AWS/Azure/GCP), it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Next-Generation Firewall</h1>
        <p className="text-lg text-slate-300 mb-8">Layer-7 NGFW with IDS/IPS, deep packet inspection, SSL decryption, geo-IP block, zero-day threat feed, and cloud-firewall auto-sync.</p>
        ...
        <li class="text-slate-300">Layer-7 IDS/IPS with Suricata rules</li>
        <li class="text-slate-300">Deep packet inspection + SSL/TLS decryption</li>
        <li class="text-slate-300">Threat intelligence feed (10K+ IOC feed)</li>
        <li class="text-slate-300">Cloud firewall auto-sync (AWS/Azure/GCP)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with next-generation firewall</li>
