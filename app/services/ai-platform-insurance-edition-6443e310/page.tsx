...
export const metadata: Metadata = {
  title: 'AI Platform - Insurance Edition',
  description: 'Next-generation insurance solution: AI Platform - Insurance Edition. Combines brand monitoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-platform-insurance-edition-6443e310',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Platform - Insurance Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: AI Platform - Insurance Edition. Combines brand monitoring with adaptive intelligence for optimal results.
          </p>
