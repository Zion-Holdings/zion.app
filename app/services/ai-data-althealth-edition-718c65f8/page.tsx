...
export const metadata: Metadata = {
  title: 'AI Data - ALTHEALTH Edition',
  description: 'Transform your althealth operations with our AI Data - ALTHEALTH Edition. This AI-driven solution automates sentiment analysis with unprecedented accuracy and e',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Data - ALTHEALTH Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your althealth operations with our AI Data - ALTHEALTH Edition. This AI-driven solution automates sentiment analysis with unprecedented accuracy and efficiency.
          </p>
