...
export const metadata = {
  title: "Enterprise Hyper-Local E-Commerce Analytics Suite - Zion Tech Group",
  description: "Enterprise analytics suite that delivers hyper-local e-commerce insights with unified dashboards and reporting.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/enterprise-hyper-local-e-commerce-analytics-suite-a434dc6c`
  }
};
