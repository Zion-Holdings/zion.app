...
export const metadata: Metadata = {
  title: 'Optimization Autonomous - Sports',
  description: 'Revolutionize sports through intelligent automation. Our Optimization Autonomous - Sports leverages advanced machine learning to deliver security monitoring at ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/optimization-autonomous-sports-7cd15c94',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Optimization Autonomous - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Optimization Autonomous - Sports leverages advanced machine learning to deliver security monitoring at scale.
          </p>
