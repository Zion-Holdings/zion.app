...
export const metadata: Metadata = {
  title: 'Intelligent Cognitive for Tech',
  description: 'Next-generation technology solution: Intelligent Cognitive for Tech. Combines customer service automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-cognitive-for-tech-ea576a25',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Cognitive for Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation technology solution: Intelligent Cognitive for Tech. Combines customer service automation with adaptive intelligence for optimal results.
          </p>
