...
export const metadata: Metadata = {
  title: 'Intelligence Adaptive - Retail',
  description: 'Revolutionize retail through intelligent automation. Our Intelligence Adaptive - Retail leverages advanced machine learning to deliver supply chain at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligence-adaptive---retail-50e7e3d7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligence Adaptive - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize retail through intelligent automation. Our Intelligence Adaptive - Retail leverages advanced machine learning to deliver supply chain at scale.
          </p>
