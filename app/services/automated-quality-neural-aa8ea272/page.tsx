...
export const metadata: Metadata = {
  title: 'Automated Quality Neural',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Quality Neural
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Automated Quality Neural. This intelligent platform delivers cost reduction through advanced automation and AI.
          </p>
