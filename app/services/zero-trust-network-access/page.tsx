...
export const metadata: Metadata = {
  ...
  keywords: 'Identity-aware proxy (IAM to ZTNA gateway), Per-user + per-device + per-context access policy, Micro-segmentation per app/resource sensitivity, Session recording + threat analytics, Continuous trust evaluation re-auth on risk, cloud, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Zero-trust identity-aware proxy: every connection authenticated per user/device/context. Granular per-app policies, micro-segmentation, session recording.</p>
        ...
        <li class="text-slate-300">Identity-aware proxy (IAM to ZTNA gateway)</li>
        <li class="text-slate-300">Per-user + per-device + per-context access policy</li>
        <li class="text-slate-300">Micro-segmentation per app/resource sensitivity</li>
        <li class="text-slate-300">Session recording + threat analytics</li>
        <li class="text-slate-300">Continuous trust evaluation re-auth on risk</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with zero-trust network access (ztna)</li>
