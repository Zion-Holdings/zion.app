...
export const metadata: Metadata = {
  title: 'Predictive Cloud for Legal',
  description: 'Revolutionize legal through intelligent automation. Our Predictive Cloud for Legal leverages advanced machine learning to deliver customer service automation at',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Cloud for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Predictive Cloud for Legal leverages advanced machine learning to deliver customer service automation at scale.
          </p>
