...
export const metadata: Metadata = {
  title: 'Next-Gen SMB for REGTECH',
  description: 'Transform your regtech operations with our Next-Gen SMB for REGTECH. This AI-driven solution automates feature engineering with unprecedented accuracy and effic',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen SMB for REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your regtech operations with our Next-Gen SMB for REGTECH. This AI-driven solution automates feature engineering with unprecedented accuracy and efficiency.
          </p>
