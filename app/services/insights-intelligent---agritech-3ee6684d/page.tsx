...
export const metadata: Metadata = {
  title: 'Insights Intelligent - Agritech',
  description: 'Transform your agritech operations with our Insights Intelligent - Agritech. This AI-driven solution automates risk assessment with unprecedented accuracy and e',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/insights-intelligent---agritech-3ee6684d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Insights Intelligent - Agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agritech operations with our Insights Intelligent - Agritech. This AI-driven solution automates risk assessment with unprecedented accuracy and efficiency.
          </p>
