...
export const metadata: Metadata = {
  title: 'Automated Capacity Supply',
  description: 'Next-generation legal solution: Automated Capacity Supply. Combines lead scoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-capacity-supply-afb7f4da',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Capacity Supply
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Automated Capacity Supply. Combines lead scoring with adaptive intelligence for optimal results.
          </p>
