...
export const metadata: Metadata = {
  title: 'Intelligent Scheduler Platform',
  description: 'Transform your finance operations with our Intelligent Scheduler Platform. This security solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-scheduler-platform-6e760c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Scheduler Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Intelligent Scheduler Platform. This security solution delivers unprecedented automation and intelligence.
          </p>
