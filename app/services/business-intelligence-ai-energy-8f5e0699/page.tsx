...
export const metadata: Metadata = {
  title: 'Business Intelligence AI - Energy',
  description: 'Revolutionize energy through intelligent automation. Our Business Intelligence AI - Energy leverages advanced machine learning to deliver root cause analysis at',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Business Intelligence AI - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Business Intelligence AI - Energy leverages advanced machine learning to deliver root cause analysis at scale.
          </p>
