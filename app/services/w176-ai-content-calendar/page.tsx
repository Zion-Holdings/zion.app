...
export const metadata: Metadata = {
  ...
  keywords: 'Content strategy generation from goals, Auto-populated editorial calendar, Content brief generation with SEO keywords, Performance prediction scoring, Channel-specific formatting, Competitor content gap analysis, Integration with WordPress, Notion, Asana, Trello, ai, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Content Calendar Planner</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered content marketing: strategy generation, editorial calendar, content briefs, and performance prediction. Plan a quarter of content in an hour.</p>
        ...
        <li class="text-slate-300">Content strategy generation from goals</li>
        <li class="text-slate-300">Auto-populated editorial calendar</li>
        <li class="text-slate-300">Content brief generation with SEO keywords</li>
        <li class="text-slate-300">Performance prediction scoring</li>
        <li class="text-slate-300">Channel-specific formatting</li>
        <li class="text-slate-300">Competitor content gap analysis</li>
        <li class="text-slate-300">Integration with WordPress, Notion, Asana, Trello</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Plan quarterly content in one hour</li>
        <li class="text-slate-300">Performance prediction prioritizes topics</li>
        <li class="text-slate-300">SEO-optimized briefs rank faster</li>
        <li class="text-slate-300">Gap analysis finds underserved topics</li>
      </ul>
        </div>
