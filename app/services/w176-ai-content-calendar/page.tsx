...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{'@context': 'https://schema.org', '@type': 'Service', 'name': 'AI Content Calendar Planner', 'description': 'AI-powered content marketing: strategy generation, editorial calendar, content briefs, and performance prediction. Plan a quarter of content in an hour.', 'serviceType': 'ai', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'Marketing'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'AI Content Calendar Planner Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$49/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$149/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': '$499/mo', 'priceCurrency': 'USD'}]}} }/>
    <JsonLd data={{'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'Content strategy generation from goals', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Content strategy generation from goals'}}, {'@type': 'Question', 'name': 'Auto-populated editorial calendar', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Auto-populated editorial calendar'}}, {'@type': 'Question', 'name': 'Content brief generation with SEO keywords', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Content brief generation with SEO keywords'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Plan quarterly content in one hour; Performance prediction prioritizes topics; SEO-optimized briefs rank faster'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} }/>
