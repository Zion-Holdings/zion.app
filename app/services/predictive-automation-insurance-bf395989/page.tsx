...
export const metadata: Metadata = {
  title: 'Predictive automation-insurance',
  description: 'Enhance your insurance business with Predictive automation-insurance. Our solution provides logistics route optimization with enterprise-grade reliability and s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-automation-insurance-bf395989',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive automation-insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Predictive automation-insurance. Our solution provides logistics route optimization with enterprise-grade reliability and security.
          </p>
