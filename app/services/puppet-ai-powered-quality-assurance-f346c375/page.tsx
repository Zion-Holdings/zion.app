...
export const metadata: Metadata = {
  title: 'Puppet AI-Powered Quality Assurance',
  description: 'AI-powered puppet solution for development. Automated testing and quality control for software deployments.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/puppet-ai-powered-quality-assurance-f346c375',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Puppet AI-Powered Quality Assurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered puppet solution for development. Automated testing and quality control for software deployments.
          </p>
