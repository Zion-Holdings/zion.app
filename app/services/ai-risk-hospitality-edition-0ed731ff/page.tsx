...
export const metadata: Metadata = {
  title: 'AI Risk - Hospitality Edition',
  description: 'Next-generation hospitality solution: AI Risk - Hospitality Edition. Combines quota optimization with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-risk-hospitality-edition-0ed731ff',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Risk - Hospitality Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: AI Risk - Hospitality Edition. Combines quota optimization with adaptive intelligence for optimal results.
          </p>
