...
export const metadata: Metadata = {
  title: 'Serverless Neural for Insurance',
  description: 'Transform your insurance operations with our Serverless Neural for Insurance. This AI-driven solution automates project portfolio with unprecedented accuracy an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Serverless Neural for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Serverless Neural for Insurance. This AI-driven solution automates project portfolio with unprecedented accuracy and efficiency.
          </p>
