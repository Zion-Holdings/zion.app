...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'AI Sustainability & ESG Compliance Tracker', 'description': 'AI-powered sustainability tracking and ESG compliance platform. Automate data collection, calculate carbon footprint, and generate reports for GRI, CDP, TCFD, and SASB frameworks.', 'serviceType': 'ai', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'energy'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'AI Sustainability & ESG Compliance Tracker Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$999/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$2,999/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': 'Custom', 'priceCurrency': 'USD'}]}} />
    <JsonLd data={'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'Automated carbon footprint calculation', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Automated carbon footprint calculation'}}, {'@type': 'Question', 'name': 'Scope 1/2/3 emissions tracking', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Scope 1/2/3 emissions tracking'}}, {'@type': 'Question', 'name': 'ESG framework mapping (GRI', 'acceptedAnswer': {'@type': 'Answer', 'text': 'ESG framework mapping (GRI'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Reduce ESG reporting time by 80%; Identify carbon reduction opportunities; Meet investor and regulatory ESG requirements'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} />
