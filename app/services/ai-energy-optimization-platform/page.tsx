...
export const metadata: Metadata = {
  ...
  keywords: 'Demand forecasting by zone, HVAC optimization (20-40% savings), Renewable energy management, Carbon emissions tracking, Anomaly detection for equipment, Utility bill analysis, Integration with BMS and SCADA, ESG reporting automation, ai, Energy, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Energy Optimization Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Optimize energy consumption across buildings, factories, and data centers using AI. Predict demand, optimize HVAC, manage renewables, and reduce carbon emissions. Real-time monitoring with automated control.</p>
        ...
        <li class="text-slate-300">Demand forecasting by zone</li>
        <li class="text-slate-300">HVAC optimization (20-40% savings)</li>
        <li class="text-slate-300">Renewable energy management</li>
        <li class="text-slate-300">Carbon emissions tracking</li>
        <li class="text-slate-300">Anomaly detection for equipment</li>
        <li class="text-slate-300">Utility bill analysis</li>
        <li class="text-slate-300">Integration with BMS and SCADA</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce energy costs by 25-40%</li>
        <li class="text-slate-300">Meet carbon reduction targets</li>
        <li class="text-slate-300">Predict and prevent equipment failures</li>
        <li class="text-slate-300">Automated ESG compliance</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$3,499/mo</p>
