...
export const metadata: Metadata = {
  title: 'Automated compliance-agriculture',
  description: 'Hyper-accelerated agriculture solution: Automated compliance-agriculture. Combines claims processing with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-compliance-agriculture-10b39357',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated compliance-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated agriculture solution: Automated compliance-agriculture. Combines claims processing with next-gen AI for maximum velocity.
          </p>
