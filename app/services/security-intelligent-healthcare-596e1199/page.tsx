...
export const metadata: Metadata = {
  title: 'Security Intelligent - Healthcare',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Intelligent - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Security Intelligent - Healthcare. This intelligent platform delivers data governance through advanced automation and AI.
          </p>
