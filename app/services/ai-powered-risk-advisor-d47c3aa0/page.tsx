...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize construction through intelligent automation. Our AI-Powered Risk Advisor leverages advanced machine learning to deliver enterprise-grade insights ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-risk-advisor-d47c3aa0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our AI-Powered Risk Advisor leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
