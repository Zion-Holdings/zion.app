...
export const metadata: Metadata = {
  title: 'Scalable Supply Chain Vue.js (Healthcare)',
  description: 'Scalable Supply Chain Vue.js (Healthcare) is an AI-powered healthcare solution that transforms how businesses operate through intelligent automation and real-ti',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/scalable-supply-chain-vue.js-(-400d67',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Scalable Supply Chain Vue.js (Healthcare)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Scalable Supply Chain Vue.js (Healthcare) is an AI-powered healthcare solution that transforms how businesses operate through intelligent automation and real-time analytics.
