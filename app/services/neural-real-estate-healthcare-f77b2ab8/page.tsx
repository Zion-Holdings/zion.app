...
export const metadata: Metadata = {
  title: 'Neural real estate-healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Neural real estate-healthcare leverages advanced machine learning to deliver process automation at ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-real-estate-healthcare-f77b2ab8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural real estate-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Neural real estate-healthcare leverages advanced machine learning to deliver process automation at scale.
          </p>
