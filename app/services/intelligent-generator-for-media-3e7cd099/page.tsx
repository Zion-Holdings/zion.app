...
export const metadata: Metadata = {
  title: 'Intelligent Generator for Media',
  description: 'Transform your media operations with our Intelligent Generator for Media. This AI-driven solution automates content generation with unprecedented accuracy and e',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-generator-for-media-3e7cd099',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Generator for Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your media operations with our Intelligent Generator for Media. This AI-driven solution automates content generation with unprecedented accuracy and efficiency.
          </p>
