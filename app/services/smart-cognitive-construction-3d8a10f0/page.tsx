...
export const metadata: Metadata = {
  title: 'Smart Cognitive - Construction',
  description: 'Transform your construction operations with our Smart Cognitive - Construction. This AI-driven solution provides intelligent automation with unprecedented accur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-cognitive-construction-3d8a10f0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Cognitive - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Smart Cognitive - Construction. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
