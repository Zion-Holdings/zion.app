...
export const metadata: Metadata = {
  title: 'Intelligent automation-automotive',
  description: 'Drive innovation in automotive with Intelligent automation-automotive. This AI-powered platform transforms employee engagement into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-automation-automotive-16bf0a7a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent automation-automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in automotive with Intelligent automation-automotive. This AI-powered platform transforms employee engagement into a competitive advantage.
          </p>
