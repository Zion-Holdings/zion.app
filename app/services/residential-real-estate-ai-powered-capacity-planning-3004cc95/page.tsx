...
export const metadata: Metadata = {
  title: 'Residential Real Estate AI-Powered Capacity Planning',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Residential Real Estate AI-Powered Capacity Planning
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered residential real estate solution for capacity planning. Predictive capacity planning with demand forecasting and resource recommendations.
          </p>
