...
export const metadata: Metadata = {
  title: 'Management Cognitive - Proptech',
  description: 'Next-generation proptech solution: Management Cognitive - Proptech. Combines workflow management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/management-cognitive---proptech-ae8a2cea',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Management Cognitive - Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation proptech solution: Management Cognitive - Proptech. Combines workflow management with adaptive intelligence for optimal results.
          </p>
