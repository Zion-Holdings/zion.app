  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Unstructured Data Lake</h1>
        <p className="text-lg text-slate-300 mb-8">Unstructured data pipeline and lake: ingest PDF, Images, Audio, and Video at scale; auto-classify per document schema; OCR, ASR, object-detection hooks per file type; natural-language query with cited source passages.</p>
        ...
        <li class="text-slate-300">Ingest PDF, Images, Audio, and Video with automatic format and codec detection</li>
        <li class="text-slate-300">Auto-classify per schema: invoice, contract, report, or document using layout-aware LLM</li>
        <li class="text-slate-300">OCR and ASR and object-detection hooks applied per detected file type</li>
        <li class="text-slate-300">Natural-language query returns retrieved chunks with cited source passages</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with unstructured data lake</li>
