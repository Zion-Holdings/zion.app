...
export const metadata: Metadata = {
  title: 'Smart Quality Platform - REGTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Quality Platform - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your regtech business with Smart Quality Platform - REGTECH. Our solution provides workflow management with enterprise-grade reliability and security.
          </p>
