...
export const metadata: Metadata = {
  title: 'Smart smart-logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Smart smart-logistics leverages advanced machine learning to deliver customer retention at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-smart-logistics-097724aa',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Smart smart-logistics leverages advanced machine learning to deliver customer retention at scale.
          </p>
