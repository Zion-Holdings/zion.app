...
export const metadata: Metadata = {
  title: 'Smart Market Cloud',
  description: 'Transform your hospitality operations with our Smart Market Cloud. This AI-driven solution automates quota optimization with unprecedented accuracy and efficien',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-market-cloud-ceaaf099',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Smart Market Cloud. This AI-driven solution automates quota optimization with unprecedented accuracy and efficiency.
          </p>
