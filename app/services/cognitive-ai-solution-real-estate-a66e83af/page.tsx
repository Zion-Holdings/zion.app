...
export const metadata: Metadata = {
  title: 'Cognitive AI Solution - Real-Estate',
  description: 'Optimize your real-estate workflows with Cognitive AI Solution - Real-Estate. This intelligent platform delivers procurement automation through advanced automat',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive AI Solution - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your real-estate workflows with Cognitive AI Solution - Real-Estate. This intelligent platform delivers procurement automation through advanced automation and AI.
          </p>
