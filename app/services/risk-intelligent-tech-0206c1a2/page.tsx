...
export const metadata: Metadata = {
  title: 'Risk Intelligent - Tech',
  description: 'Transform your technology operations with our Risk Intelligent - Tech. This AI-driven solution automates resource utilization with unprecedented accuracy and ef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/risk-intelligent-tech-0206c1a2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Risk Intelligent - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your technology operations with our Risk Intelligent - Tech. This AI-driven solution automates resource utilization with unprecedented accuracy and efficiency.
          </p>
