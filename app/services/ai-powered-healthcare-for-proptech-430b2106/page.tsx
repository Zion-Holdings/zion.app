...
export const metadata: Metadata = {
  title: 'AI-Powered Healthcare for Proptech',
  description: 'Transform your proptech operations with our AI-Powered Healthcare for Proptech. This AI-driven solution automates healthcare data analytics with unprecedented a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Healthcare for Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your proptech operations with our AI-Powered Healthcare for Proptech. This AI-driven solution automates healthcare data analytics with unprecedented accuracy and efficiency.
          </p>
