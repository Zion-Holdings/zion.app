...
export const metadata: Metadata = {
  title: 'Neural Support for Legal',
  description: 'The future of legal is here with Neural Support for Legal. Powered by cutting-edge AI, this platform delivers financial planning like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-support-for-legal-f6eee5b9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Support for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Neural Support for Legal. Powered by cutting-edge AI, this platform delivers financial planning like never before.
          </p>
