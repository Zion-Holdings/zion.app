...
export const metadata: Metadata = {
  title: 'Intelligence Intelligent - Logistics',
  description: 'The future of logistics is here with Intelligence Intelligent - Logistics. Powered by cutting-edge AI, this platform delivers transformative results like never ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligence-intelligent-logistics-1769042b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligence Intelligent - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Intelligence Intelligent - Logistics. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
