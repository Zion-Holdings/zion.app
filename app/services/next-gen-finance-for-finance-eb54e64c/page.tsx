...
export const metadata: Metadata = {
  title: 'Next-Gen Finance for Finance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Finance for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for finance: Next-Gen Finance for Finance. Uses quantum-inspired algorithms to deliver performance monitoring at exponential speed.
          </p>
