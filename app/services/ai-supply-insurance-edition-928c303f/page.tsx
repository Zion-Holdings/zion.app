...
export const metadata: Metadata = {
  title: 'AI Supply - Insurance Edition',
  description: 'Revolutionize insurance through intelligent automation. Our AI Supply - Insurance Edition leverages advanced machine learning to deliver incident response at sc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-supply-insurance-edition-928c303f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Supply - Insurance Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our AI Supply - Insurance Edition leverages advanced machine learning to deliver incident response at scale.
          </p>
