...
export const metadata: Metadata = {
  title: 'AI/IT Predictor Suite - Transportation',
  description: 'Drive innovation in transportation with AI/IT Predictor Suite - Transportation. This AI-powered platform transforms warehouse automation into a competitive adva',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Predictor Suite - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in transportation with AI/IT Predictor Suite - Transportation. This AI-powered platform transforms warehouse automation into a competitive advantage.
          </p>
