...
export const metadata: Metadata = {
  title: 'AI/IT Analytics Suite - Logistics',
  description: 'Drive innovation in logistics with AI/IT Analytics Suite - Logistics. This AI-powered platform transforms customer onboarding into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-analytics-suite-logistics-8a72c6aa',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Analytics Suite - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with AI/IT Analytics Suite - Logistics. This AI-powered platform transforms customer onboarding into a competitive advantage.
          </p>
