...
export const metadata: Metadata = {
  title: 'Enterprise Analytics Platform - MARTECH',
  description: 'Drive innovation in martech with Enterprise Analytics Platform - MARTECH. This AI-powered platform transforms supply visibility into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-analytics-platform-martech-2e07933b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Analytics Platform - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in martech with Enterprise Analytics Platform - MARTECH. This AI-powered platform transforms supply visibility into a competitive advantage.
          </p>
