...
export const metadata: Metadata = {
  ...
  keywords: 'RAG over private document corpus, Source citation & confidence scores, Multi-department bots (HR, Eng, Sales, Support), Feedback loop to improve answers, Analytics: most-asked questions, gaps in docs, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Enterprise AI Question Answering (Internal Knowledge)</h1>
        <p className="text-lg text-slate-300 mb-8">Chatbot that answers employee questions from internal docs: HR policies, engineering runbooks, sales playbooks; cite sources, track unanswered queries.</p>
        ...
        <li class="text-slate-300">RAG over private document corpus</li>
        <li class="text-slate-300">Source citation &amp; confidence scores</li>
        <li class="text-slate-300">Multi-department bots (HR, Eng, Sales, Support)</li>
        <li class="text-slate-300">Feedback loop to improve answers</li>
        <li class="text-slate-300">Analytics: most-asked questions, gaps in docs</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with enterprise ai question answering (internal knowledge)</li>
