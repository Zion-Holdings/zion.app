...
export const metadata: Metadata = {
  title: 'NLP Smart - Retail',
  description: 'Next-generation retail solution: NLP Smart - Retail. Combines succession planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/nlp-smart-retail-d84774e7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation retail solution: NLP Smart - Retail. Combines succession planning with adaptive intelligence for optimal results.
          </p>
