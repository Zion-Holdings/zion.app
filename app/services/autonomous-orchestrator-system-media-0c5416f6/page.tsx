...
export const metadata: Metadata = {
  title: 'Autonomous Orchestrator System - Media',
  description: 'Drive innovation in media with Autonomous Orchestrator System - Media. This AI-powered platform transforms risk assessment into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-orchestrator-system-media-0c5416f6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Orchestrator System - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in media with Autonomous Orchestrator System - Media. This AI-powered platform transforms risk assessment into a competitive advantage.
          </p>
