...
export const metadata: Metadata = {
  ...
  keywords: 'BigQuery + partition-cluster auto-tuning, Dataflow batch + streaming pipelines, Pub/Sub to BigQuery streaming ingestion, Looker Studio + Looker dashboards, GCS Delta Lakehouse (Iceberg/Delta), cloud, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">GCP Data Analytics Platform</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end GCP analytics: BigQuery, Dataflow, Pub/Sub streaming, Looker dashboards. GCS Delta Lakehouse with partition pruning and auto-clustering.</p>
        ...
        <li class="text-slate-300">BigQuery + partition-cluster auto-tuning</li>
        <li class="text-slate-300">Dataflow batch + streaming pipelines</li>
        <li class="text-slate-300">Pub/Sub to BigQuery streaming ingestion</li>
        <li class="text-slate-300">Looker Studio + Looker dashboards</li>
        <li class="text-slate-300">GCS Delta Lakehouse (Iceberg/Delta)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with gcp data analytics platform</li>
