...
export const metadata: Metadata = {
  title: 'Cognitive Automation Solution - HEALTHTECH #1',
  description: 'Revolutionize healthtech through intelligent automation. Our Cognitive Automation Solution - HEALTHTECH #1 leverages advanced machine learning to deliver contra',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Automation Solution - HEALTHTECH #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthtech through intelligent automation. Our Cognitive Automation Solution - HEALTHTECH #1 leverages advanced machine learning to deliver contract analysis at scale.
          </p>
