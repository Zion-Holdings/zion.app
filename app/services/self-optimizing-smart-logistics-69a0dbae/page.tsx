...
export const metadata: Metadata = {
  title: 'Self-Optimizing smart-logistics',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing smart-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with Self-Optimizing smart-logistics. This AI-powered platform transforms recommendation system into a competitive advantage.
          </p>
