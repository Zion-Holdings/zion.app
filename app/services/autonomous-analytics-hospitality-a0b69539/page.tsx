...
export const metadata: Metadata = {
  title: 'Autonomous analytics-hospitality',
  description: 'Drive innovation in hospitality with Autonomous analytics-hospitality. This AI-powered platform transforms resource utilization into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-analytics-hospitality-a0b69539',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous analytics-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Autonomous analytics-hospitality. This AI-powered platform transforms resource utilization into a competitive advantage.
          </p>
