...
export const metadata: Metadata = {
  title: 'Quantum Coordinator - CLEANTECH Quantum',
  description: 'Optimize your cleantech workflows with Quantum Coordinator - CLEANTECH Quantum. This intelligent platform delivers integration platform through advanced automat',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Coordinator - CLEANTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your cleantech workflows with Quantum Coordinator - CLEANTECH Quantum. This intelligent platform delivers integration platform through advanced automation and AI.
          </p>
