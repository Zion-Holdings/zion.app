...
export const metadata: Metadata = {
  title: 'Autonomous Intelligence System - Energy',
  description: 'Transform your energy operations with our Autonomous Intelligence System - Energy. This AI-driven solution automates invoice processing with unprecedented accur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-intelligence-system-energy-a3a192da',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Intelligence System - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Autonomous Intelligence System - Energy. This AI-driven solution automates invoice processing with unprecedented accuracy and efficiency.
          </p>
