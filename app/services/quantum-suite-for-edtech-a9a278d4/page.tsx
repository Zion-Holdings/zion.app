...
export const metadata: Metadata = {
  title: 'Quantum Suite for EDTECH',
  description: 'The future of edtech is here with Quantum Suite for EDTECH. Powered by cutting-edge AI, this platform delivers invoice automation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-suite-for-edtech-a9a278d4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Suite for EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of edtech is here with Quantum Suite for EDTECH. Powered by cutting-edge AI, this platform delivers invoice automation like never before.
          </p>
