...
export const metadata: Metadata = {
  title: 'Intelligent Platform for Construction #2',
  description: 'Enhance your construction business with Intelligent Platform for Construction #2. Our solution provides churn prediction with enterprise-grade reliability and s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-platform-for-construction-2-ce5c8272',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Platform for Construction #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Intelligent Platform for Construction #2. Our solution provides churn prediction with enterprise-grade reliability and security.
          </p>
