...
export const metadata: Metadata = {
  title: 'Computer Vision Intelligent - Automotive',
  description: 'Drive innovation in automotive with Computer Vision Intelligent - Automotive. This AI-powered platform transforms sentiment analysis into a competitive advantag',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Computer Vision Intelligent - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in automotive with Computer Vision Intelligent - Automotive. This AI-powered platform transforms sentiment analysis into a competitive advantage.
          </p>
