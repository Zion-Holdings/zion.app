...
export const metadata: Metadata = {
  title: 'Smart performance-finance',
  description: 'The future of finance is here with Smart performance-finance. Powered by cutting-edge AI, this platform delivers transformative results like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-performance-finance-621fbd44',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart performance-finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of finance is here with Smart performance-finance. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
