...
export const metadata: Metadata = {
  title: 'Smart Optimization Platform - Legal #1',
  description: 'Enhance your legal business with Smart Optimization Platform - Legal #1. Our solution provides inventory management with enterprise-grade reliability and securi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-optimization-platform-legal-1-f1243f61',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Optimization Platform - Legal #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Smart Optimization Platform - Legal #1. Our solution provides inventory management with enterprise-grade reliability and security.
          </p>
