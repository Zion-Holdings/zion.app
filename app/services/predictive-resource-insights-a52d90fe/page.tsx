...
export const metadata: Metadata = {
  title: 'Predictive Resource Insights',
  description: 'Revolutionize education through intelligent automation. Our Predictive Resource Insights leverages advanced machine learning to deliver fraud prevention at scal',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize education through intelligent automation. Our Predictive Resource Insights leverages advanced machine learning to deliver fraud prevention at scale.
          </p>
