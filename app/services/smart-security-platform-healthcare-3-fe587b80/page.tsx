...
export const metadata: Metadata = {
  title: 'Smart Security Platform - Healthcare #3',
  description: 'Optimize your healthcare workflows with Smart Security Platform - Healthcare #3. This intelligent platform delivers contract analysis through advanced automatio',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-security-platform-healthcare-3-fe587b80',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Security Platform - Healthcare #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Smart Security Platform - Healthcare #3. This intelligent platform delivers contract analysis through advanced automation and AI.
          </p>
