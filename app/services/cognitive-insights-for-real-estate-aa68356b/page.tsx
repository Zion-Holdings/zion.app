...
export const metadata: Metadata = {
  title: 'Cognitive Insights for Real-Estate',
  description: 'The future of real-estate is here with Cognitive Insights for Real-Estate. Powered by cutting-edge AI, this platform delivers energy management like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-insights-for-real-estate-aa68356b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Insights for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of real-estate is here with Cognitive Insights for Real-Estate. Powered by cutting-edge AI, this platform delivers energy management like never before.
          </p>
