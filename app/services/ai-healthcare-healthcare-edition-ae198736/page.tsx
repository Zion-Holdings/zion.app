...
export const metadata: Metadata = {
  title: 'AI Healthcare - Healthcare Edition',
  description: 'The future of healthcare is here with AI Healthcare - Healthcare Edition. Powered by cutting-edge AI, this platform delivers transformative results like never b',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-healthcare-healthcare-edition-ae198736',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Healthcare - Healthcare Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with AI Healthcare - Healthcare Edition. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
