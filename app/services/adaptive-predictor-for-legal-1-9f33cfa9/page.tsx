  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Adaptive Predictor for Legal #1</h1>
        <p className="text-lg text-gray-300 mb-8">Transform your legal operations with our Adaptive Predictor for Legal #1. This AI-driven solution automates quality control with unprecedented accuracy and efficiency.</p>
