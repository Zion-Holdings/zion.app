...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Platform - Media',
  description: 'Revolutionize media through intelligent automation. Our Hyper-Accelerated Platform - Media leverages advanced machine learning to deliver insurance automation a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Platform - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize media through intelligent automation. Our Hyper-Accelerated Platform - Media leverages advanced machine learning to deliver insurance automation at scale.
          </p>
