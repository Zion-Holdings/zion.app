...
export const metadata: Metadata = {
  title: 'Smart intelligence-hospitality',
  description: 'Transform your hospitality operations with our Smart intelligence-hospitality. This AI-driven solution automates scenario planning with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-intelligence-hospitality-9b45c146',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart intelligence-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Smart intelligence-hospitality. This AI-driven solution automates scenario planning with unprecedented accuracy and efficiency.
          </p>
