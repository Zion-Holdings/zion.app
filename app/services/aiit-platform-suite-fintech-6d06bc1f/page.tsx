...
export const metadata: Metadata = {
  title: 'AI/IT Platform Suite - FINTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Platform Suite - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize fintech through intelligent automation. Our AI/IT Platform Suite - FINTECH leverages advanced machine learning to deliver ai ethics at scale.
          </p>
