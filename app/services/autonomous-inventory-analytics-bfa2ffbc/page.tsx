...
export const metadata: Metadata = {
  title: 'Autonomous Inventory Analytics',
  description: 'Optimize your manufacturing workflows with Autonomous Inventory Analytics. This intelligent platform delivers network optimization through advanced automation a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your manufacturing workflows with Autonomous Inventory Analytics. This intelligent platform delivers network optimization through advanced automation and AI.
          </p>
