...
export const metadata: Metadata = {
  title: 'Enterprise Orchestrator Platform - Telecom',
  description: 'Quantum leap forward for telecom: Enterprise Orchestrator Platform - Telecom. Uses quantum-inspired algorithms to deliver fleet management at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-orchestrator-platform-telecom-f86caae7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Orchestrator Platform - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for telecom: Enterprise Orchestrator Platform - Telecom. Uses quantum-inspired algorithms to deliver fleet management at exponential speed.
          </p>
