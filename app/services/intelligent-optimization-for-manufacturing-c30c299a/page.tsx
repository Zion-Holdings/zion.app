...
export const metadata: Metadata = {
  ...
  description: 'Transform your manufacturing operations with our Intelligent Optimization for Manufacturing. This AI-driven solution automates inventory management with unprece',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your manufacturing operations with our Intelligent Optimization for Manufacturing. This AI-driven solution automates inventory management with unprecedented accuracy and efficiency.
          </p>
