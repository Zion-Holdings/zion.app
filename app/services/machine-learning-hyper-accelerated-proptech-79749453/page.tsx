...
export const metadata: Metadata = {
  title: 'Machine Learning Hyper-Accelerated - PROPTECH',
  description: 'Enhance your proptech business with Machine Learning Hyper-Accelerated - PROPTECH. Our solution provides generative ai with enterprise-grade reliability and sec',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/machine-learning-hyper-accelerated-proptech-79749453',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Machine Learning Hyper-Accelerated - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your proptech business with Machine Learning Hyper-Accelerated - PROPTECH. Our solution provides generative ai with enterprise-grade reliability and security.
          </p>
