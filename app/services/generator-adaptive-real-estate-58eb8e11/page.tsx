...
export const metadata: Metadata = {
  title: 'Generator Adaptive - Real-Estate',
  description: 'Drive innovation in real-estate with Generator Adaptive - Real-Estate. This AI-powered platform transforms succession planning into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/generator-adaptive-real-estate-58eb8e11',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Generator Adaptive - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in real-estate with Generator Adaptive - Real-Estate. This AI-powered platform transforms succession planning into a competitive advantage.
          </p>
