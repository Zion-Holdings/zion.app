      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Mood journal with trends</li>
            <li className="text-purple-300">✓ Personalized coping strategies</li>
            <li className="text-purple-300">✓ Crisis keyword detection to human handoff</li>
            <li className="text-purple-300">✓ Weekly mental health reports</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai mental health companion</li>
