...
export const metadata: Metadata = {
  ...
  keywords: 'Mood journal with trends, Personalized coping strategies, Crisis keyword detection to human handoff, Weekly mental health reports, ai, Healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Mental Health Companion</h1>
        <p className="text-lg text-slate-300 mb-8">Empathetic, HIPAA-compliant chatbot providing CBT-based support, mood tracking, and crisis escalation to licensed professionals.</p>
        ...
        <li class="text-slate-300">Mood journal with trends</li>
        <li class="text-slate-300">Personalized coping strategies</li>
        <li class="text-slate-300">Crisis keyword detection to human handoff</li>
        <li class="text-slate-300">Weekly mental health reports</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai mental health companion</li>
