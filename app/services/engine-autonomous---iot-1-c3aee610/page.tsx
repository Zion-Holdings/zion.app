...
export const metadata: Metadata = {
  title: 'Engine Autonomous - Iot #1',
  description: 'Unlock unprecedented growth with Engine Autonomous - Iot #1. This autonomous system provides manufacturing quality control with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/engine-autonomous---iot-1-c3aee610',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Engine Autonomous - Iot #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Engine Autonomous - Iot #1. This autonomous system provides manufacturing quality control with zero manual intervention needed.
          </p>
