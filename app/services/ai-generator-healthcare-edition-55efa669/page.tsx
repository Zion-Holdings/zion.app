...
export const metadata: Metadata = {
  title: 'AI Generator - Healthcare Edition',
  description: 'Drive innovation in healthcare with AI Generator - Healthcare Edition. This AI-powered platform transforms personalization engine into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-generator-healthcare-edition-55efa669',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Generator - Healthcare Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with AI Generator - Healthcare Edition. This AI-powered platform transforms personalization engine into a competitive advantage.
          </p>
