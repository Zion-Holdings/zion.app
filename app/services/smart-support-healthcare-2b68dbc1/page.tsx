...
export const metadata: Metadata = {
  title: 'Smart support-healthcare',
  description: 'Optimize your healthcare workflows with Smart support-healthcare. This intelligent platform delivers scalability planning through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-support-healthcare-2b68dbc1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart support-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Smart support-healthcare. This intelligent platform delivers scalability planning through advanced automation and AI.
          </p>
