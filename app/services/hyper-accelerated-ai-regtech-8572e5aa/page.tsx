...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated AI - REGTECH',
  description: 'Transform your regtech operations with our Hyper-Accelerated AI - REGTECH. This AI-driven solution automates revenue forecasting with unprecedented accuracy and',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated AI - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your regtech operations with our Hyper-Accelerated AI - REGTECH. This AI-driven solution automates revenue forecasting with unprecedented accuracy and efficiency.
          </p>
