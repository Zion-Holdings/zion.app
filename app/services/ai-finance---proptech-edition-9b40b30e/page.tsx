...
export const metadata: Metadata = {
  title: 'AI Finance - Proptech Edition',
  description: 'The future of proptech is here with AI Finance - Proptech Edition. Powered by cutting-edge AI, this platform delivers image recognition like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-finance---proptech-edition-9b40b30e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Finance - Proptech Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with AI Finance - Proptech Edition. Powered by cutting-edge AI, this platform delivers image recognition like never before.
          </p>
