...
export const metadata: Metadata = {
  title: 'Intelligent Data Business Intelligence',
  description: 'Revolutionize technology through intelligent automation. Our Intelligent Data Business Intelligence leverages advanced machine learning to deliver lead scoring ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Data Business Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our Intelligent Data Business Intelligence leverages advanced machine learning to deliver lead scoring at scale.
          </p>
