...
export const metadata: Metadata = {
  ...
  keywords: 'Requisition and approval workflows, RFQ generation and vendor response management, Vendor scoring and selection, Purchase order generation and tracking, Invoice matching and payment scheduling, Contract and pricing compliance, Integration with SAP Ariba, Coupa, Jaggaer, automation, Procurement, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Procurement &amp; Sourcing Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Automate procurement: requisitions, RFQs, vendor selection, PO generation, and invoice processing. Reduce procurement cycle by 70%.</p>
        ...
        <li class="text-slate-300">Requisition and approval workflows</li>
        <li class="text-slate-300">RFQ generation and vendor response management</li>
        <li class="text-slate-300">Vendor scoring and selection</li>
        <li class="text-slate-300">Purchase order generation and tracking</li>
        <li class="text-slate-300">Invoice matching and payment scheduling</li>
        <li class="text-slate-300">Contract and pricing compliance</li>
        <li class="text-slate-300">Integration with SAP Ariba, Coupa, Jaggaer</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce procurement cycle by 70%</li>
        <li class="text-slate-300">Vendor scoring improves sourcing quality</li>
        <li class="text-slate-300">Invoice matching catches discrepancies</li>
        <li class="text-slate-300">Contract compliance prevents overspend</li>
      </ul>
        </div>
