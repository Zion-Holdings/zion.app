...
export const metadata: Metadata = {
  ...
  keywords: 'Automated data catalog, End-to-end lineage, PII auto-classification, Policy enforcement engine, GDPR / CCPA compliance, data, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Data Governance &amp; Catalog</h1>
        <p className="text-lg text-slate-300 mb-8">Unified data catalog, lineage tracking, and policy enforcement engine for regulated industries with automated compliance.</p>
        ...
        <li class="text-slate-300">End-to-end lineage</li>
        <li class="text-slate-300">PII auto-classification</li>
        <li class="text-slate-300">Policy enforcement engine</li>
        <li class="text-slate-300">GDPR / CCPA compliance</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with data governance &amp; catalog</li>
