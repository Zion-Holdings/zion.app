...
export const metadata: Metadata = {
  ...
  description: 'Enhance your automotive business with AI Risk - Automotive Edition. Our solution provides user provisioning with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-risk-automotive-edition-cf2bfa22',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your automotive business with AI Risk - Automotive Edition. Our solution provides user provisioning with enterprise-grade reliability and security.
          </p>
