...
export const metadata: Metadata = {
  title: 'Intelligent Automation for Healthcare #1',
  description: 'Revolutionize healthcare through intelligent automation. Our Intelligent Automation for Healthcare #1 leverages advanced machine learning to deliver business pr',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-automation-for-healthcare-1-b3a8c16c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Automation for Healthcare #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Intelligent Automation for Healthcare #1 leverages advanced machine learning to deliver business process at scale.
          </p>
