...
export const metadata: Metadata = {
  title: 'Smart Finance for Transportation',
  description: 'Revolutionize transportation through intelligent automation. Our Smart Finance for Transportation leverages advanced machine learning to deliver supply chain at',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-finance-for-transportation-b2b392b8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Finance for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize transportation through intelligent automation. Our Smart Finance for Transportation leverages advanced machine learning to deliver supply chain at scale.
          </p>
