...
export const metadata: Metadata = {
  ...
  description: 'Real-time clinical decision support that analyzes patient data and provides evidence-based treatment recommendations.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-clinical-decision-support-system-581d84c5',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Real-time clinical decision support that analyzes patient data and provides evidence-based treatment recommendations.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Diagnosis assistance</li>
          <li className="text-gray-300">Treatment recommendations</li>
          <li className="text-gray-300">Drug interaction checking</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">30% faster diagnosis</li>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-500/20">
          ...
          <p className="text-3xl font-bold text-purple-400 mb-4">$2999</p>
