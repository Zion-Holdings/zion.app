...
export const metadata: Metadata = {
  title: 'Enterprise Scale-up Platform - Legal',
  description: 'The future of legal is here with Enterprise Scale-up Platform - Legal. Powered by cutting-edge AI, this platform delivers automation opportunity like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-scale-up-platform-legal-95cc4034',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Scale-up Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Enterprise Scale-up Platform - Legal. Powered by cutting-edge AI, this platform delivers automation opportunity like never before.
          </p>
