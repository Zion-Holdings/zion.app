...
export const metadata: Metadata = {
  ...
  keywords: 'CI/CD pipelines per repo/branch, Artifact registry + SBOM auto-generated, Terraform Cloud/Enterprise workspace sync, Unified ops audit log per pipeline build, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">DevOps Platform &amp; Unified Toolchain</h1>
        <p className="text-lg text-slate-300 mb-8">One DevOps portal: CI/CD, artifact repo, Terraform Cloud, GitOps ops config, artifact SBOM, and full audit log per pipeline.</p>
        ...
        <li class="text-slate-300">CI/CD pipelines per repo/branch</li>
        <li class="text-slate-300">Artifact registry + SBOM auto-generated</li>
        <li class="text-slate-300">Terraform Cloud/Enterprise workspace sync</li>
        <li class="text-slate-300">Unified ops audit log per pipeline build</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with devops platform &amp; unified toolchain</li>
