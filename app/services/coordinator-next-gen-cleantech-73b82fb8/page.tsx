...
export const metadata: Metadata = {
  title: 'Coordinator Next-Gen - CLEANTECH',
  description: 'Enhance your cleantech business with Coordinator Next-Gen - CLEANTECH. Our solution provides brand monitoring with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/coordinator-next-gen-cleantech-73b82fb8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Coordinator Next-Gen - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your cleantech business with Coordinator Next-Gen - CLEANTECH. Our solution provides brand monitoring with enterprise-grade reliability and security.
          </p>
