...
export const metadata: Metadata = {
  title: 'Autonomous Monitoring System - Legal',
  description: 'Drive innovation in legal with Autonomous Monitoring System - Legal. This AI-powered platform transforms master data management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-monitoring-system-legal-2bc2068d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Monitoring System - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Autonomous Monitoring System - Legal. This AI-powered platform transforms master data management into a competitive advantage.
          </p>
