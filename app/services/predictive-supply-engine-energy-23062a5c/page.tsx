...
export const metadata: Metadata = {
  title: 'Predictive Supply Engine - Energy',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Supply Engine - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Predictive Supply Engine - Energy. This autonomous system provides capacity management with zero manual intervention needed.
          </p>
