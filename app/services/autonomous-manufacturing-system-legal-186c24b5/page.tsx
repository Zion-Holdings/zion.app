...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize legal through intelligent automation. Our Autonomous Manufacturing System - Legal leverages advanced machine learning to deliver access management',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-manufacturing-system-legal-186c24b5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Autonomous Manufacturing System - Legal leverages advanced machine learning to deliver access management at scale.
          </p>
