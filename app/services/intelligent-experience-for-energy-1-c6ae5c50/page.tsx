...
export const metadata: Metadata = {
  title: 'Intelligent Experience for Energy #1',
  description: 'Enhance your energy business with Intelligent Experience for Energy #1. Our solution provides hr analytics with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-experience-for-energy-1-c6ae5c50',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Experience for Energy #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your energy business with Intelligent Experience for Energy #1. Our solution provides hr analytics with enterprise-grade reliability and security.
          </p>
