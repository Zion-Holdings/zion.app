...
export const metadata: Metadata = {
  ...
  keywords: 'Performance dashboards, Data encryption, HIPAA ready, Cloud-native architecture, Audit trails, Alerting system, predictor, construction, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Autonomous Orchestrator for Construction</h1>
        <p className="text-lg text-slate-300 mb-8">Next-generation construction solution: Autonomous Orchestrator for Construction. Combines customer insights with adaptive intelligence for optimal results.</p>
