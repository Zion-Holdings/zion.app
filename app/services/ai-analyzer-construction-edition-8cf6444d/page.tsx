...
export const metadata: Metadata = {
  title: 'AI Analyzer - Construction Edition',
  description: 'Revolutionize construction through intelligent automation. Our AI Analyzer - Construction Edition leverages advanced machine learning to deliver data pipeline o',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-analyzer-construction-edition-8cf6444d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Analyzer - Construction Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our AI Analyzer - Construction Edition leverages advanced machine learning to deliver data pipeline orchestration at scale.
          </p>
