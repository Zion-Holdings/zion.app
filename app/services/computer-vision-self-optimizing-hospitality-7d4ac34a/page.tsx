...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize hospitality through intelligent automation. Our Computer Vision Self-Optimizing - Hospitality leverages advanced machine learning to deliver succe',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/computer-vision-self-optimizing-hospitality-7d4ac34a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Computer Vision Self-Optimizing - Hospitality leverages advanced machine learning to deliver succession planning at scale.
          </p>
