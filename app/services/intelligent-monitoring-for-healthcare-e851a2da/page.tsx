...
export const metadata: Metadata = {
  title: 'Intelligent Monitoring for Healthcare',
  description: 'The future of healthcare is here with Intelligent Monitoring for Healthcare. Powered by cutting-edge AI, this platform delivers threat detection like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-monitoring-for-healthcare-e851a2da',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Monitoring for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Intelligent Monitoring for Healthcare. Powered by cutting-edge AI, this platform delivers threat detection like never before.
          </p>
