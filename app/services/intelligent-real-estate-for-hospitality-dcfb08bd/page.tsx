...
export const metadata: Metadata = {
  title: 'Intelligent Real Estate for Hospitality',
  description: 'Unlock unprecedented growth with Intelligent Real Estate for Hospitality. This autonomous system provides revenue forecasting with zero manual intervention need',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Real Estate for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Real Estate for Hospitality. This autonomous system provides revenue forecasting with zero manual intervention needed.
          </p>
