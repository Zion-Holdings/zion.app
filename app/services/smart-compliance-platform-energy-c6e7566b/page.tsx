...
export const metadata: Metadata = {
  title: 'Smart Compliance Platform - Energy',
  description: 'Next-generation energy solution: Smart Compliance Platform - Energy. Combines document processing with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-compliance-platform-energy-c6e7566b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Compliance Platform - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Smart Compliance Platform - Energy. Combines document processing with adaptive intelligence for optimal results.
          </p>
