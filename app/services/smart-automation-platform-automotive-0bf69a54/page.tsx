...
export const metadata: Metadata = {
  ...
  description: 'The future of automotive is here with Smart Automation Platform - Automotive. Powered by cutting-edge AI, this platform delivers decision support like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-automation-platform-automotive-0bf69a54',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of automotive is here with Smart Automation Platform - Automotive. Powered by cutting-edge AI, this platform delivers decision support like never before.
          </p>
