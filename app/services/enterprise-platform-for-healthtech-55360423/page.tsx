...
export const metadata: Metadata = {
  title: 'Enterprise Platform for HEALTHTECH',
  description: 'Revolutionize healthtech through intelligent automation. Our Enterprise Platform for HEALTHTECH leverages advanced machine learning to deliver employee engageme',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-platform-for-healthtech-55360423',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Platform for HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthtech through intelligent automation. Our Enterprise Platform for HEALTHTECH leverages advanced machine learning to deliver employee engagement at scale.
          </p>
