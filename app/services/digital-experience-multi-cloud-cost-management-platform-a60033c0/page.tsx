...
export const metadata: Metadata = {
  title: 'Digital Experience Multi-Cloud Cost Management Platform',
  description: 'digital experience solution for marketplaces industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/digital-experience-multi-cloud-cost-management-platform-a60033c0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Digital Experience Multi-Cloud Cost Management Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            digital experience solution for marketplaces industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.
          </p>
