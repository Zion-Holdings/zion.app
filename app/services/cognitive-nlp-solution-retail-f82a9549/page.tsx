...
export const metadata: Metadata = {
  title: 'Cognitive NLP Solution - Retail',
  description: 'Transform your retail operations with our Cognitive NLP Solution - Retail. This AI-driven solution automates churn prediction with unprecedented accuracy and ef',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive NLP Solution - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our Cognitive NLP Solution - Retail. This AI-driven solution automates churn prediction with unprecedented accuracy and efficiency.
          </p>
