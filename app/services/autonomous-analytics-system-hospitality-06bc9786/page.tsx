...
export const metadata: Metadata = {
  title: 'Autonomous Analytics System - Hospitality',
  description: 'Next-generation hospitality solution: Autonomous Analytics System - Hospitality. Combines revenue forecasting with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-analytics-system-hospitality-06bc9786',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Analytics System - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Autonomous Analytics System - Hospitality. Combines revenue forecasting with adaptive intelligence for optimal results.
          </p>
