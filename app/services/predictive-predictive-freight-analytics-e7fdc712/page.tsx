...
export const metadata: Metadata = {
  ...
  keywords: 'Rate forecasting, Capacity planning, Carrier scorecards, Lane optimization, forecasting, logistics, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Predictive Predictive Freight Analytics</h1>
        <p className="text-lg text-slate-300 mb-8">Freight intelligence platform that provides predictive rate forecasting, capacity planning, and carrier performance analytics for logistics optimization.</p>
        ...
        <li class="text-slate-300">Rate forecasting</li>
        <li class="text-slate-300">Capacity planning</li>
        <li class="text-slate-300">Carrier scorecards</li>
        <li class="text-slate-300">Lane optimization</li>
      </ul>
        </div>
        ...
        <li class="text-slate-300">Better capacity</li>
        <li class="text-slate-300">Improved reliability</li>
        <li class="text-slate-300">Strategic sourcing</li>
      </ul>
        </div>
