...
export const metadata: Metadata = {
  title: 'Intelligent Supply for Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Intelligent Supply for Healthcare leverages advanced machine learning to deliver workflow managemen',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Supply for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Intelligent Supply for Healthcare leverages advanced machine learning to deliver workflow management at scale.
          </p>
