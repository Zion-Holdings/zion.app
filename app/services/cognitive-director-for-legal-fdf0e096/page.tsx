...
export const metadata: Metadata = {
  title: 'Cognitive Director for Legal',
  description: 'Revolutionize legal through intelligent automation. Our Cognitive Director for Legal leverages advanced machine learning to deliver document processing at scale',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-director-for-legal-fdf0e096',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Director for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Cognitive Director for Legal leverages advanced machine learning to deliver document processing at scale.
          </p>
