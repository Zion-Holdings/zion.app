...
export const metadata: Metadata = {
  title: 'Intelligent Sales for Construction #4',
  description: 'Next-generation construction solution: Intelligent Sales for Construction #4. Combines sustainability tracking with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-sales-for-construction-4-0990cfb4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Sales for Construction #4
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Intelligent Sales for Construction #4. Combines sustainability tracking with adaptive intelligence for optimal results.
          </p>
