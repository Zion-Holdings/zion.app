...
export const metadata: Metadata = {
  title: 'Intelligent Sales Customer Service',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize automotive through intelligent automation. Our Intelligent Sales Customer Service leverages advanced machine learning to deliver quality control at scale.
          </p>
