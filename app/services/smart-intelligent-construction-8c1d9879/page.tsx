...
export const metadata: Metadata = {
  title: 'Smart intelligent-construction',
  description: 'The future of construction is here with Smart intelligent-construction. Powered by cutting-edge AI, this platform delivers transformative results like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-intelligent-construction-8c1d9879',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart intelligent-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Smart intelligent-construction. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
