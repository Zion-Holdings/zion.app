...
export const metadata: Metadata = {
  title: 'AI/IT Intelligence Suite - Sports',
  description: 'Enhance your sports business with AI/IT Intelligence Suite - Sports. Our solution provides automation opportunity with enterprise-grade reliability and security',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-intelligence-suite-sports-53a7dfb9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Intelligence Suite - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your sports business with AI/IT Intelligence Suite - Sports. Our solution provides automation opportunity with enterprise-grade reliability and security.
          </p>
