...
export const metadata: Metadata = {
  ...
  keywords: 'Automated ETL, Data validation, Error recovery, Schema evolution, data engineering, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Powered Intelligent Data Processing</h1>
        <p className="text-lg text-slate-300 mb-8">Intelligent data processing platform that automates extraction, transformation, and loading of data at scale. Handles complex data workflows with minimal human intervention.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">data engineering</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">technology</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Automated ETL</li>
        <li class="text-slate-300">Data validation</li>
        <li class="text-slate-300">Error recovery</li>
        <li class="text-slate-300">Schema evolution</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduced manual work</li>
        <li class="text-slate-300">Higher data quality</li>
        <li class="text-slate-300">Faster processing</li>
