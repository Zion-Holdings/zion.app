...
export const metadata: Metadata = {
  title: 'Next-Gen Deep Learning - Construction',
  description: 'Transform your construction operations with our Next-Gen Deep Learning - Construction. This AI-driven solution automates energy management with unprecedented ac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-deep-learning-construction-f40498b3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Deep Learning - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Next-Gen Deep Learning - Construction. This AI-driven solution automates energy management with unprecedented accuracy and efficiency.
          </p>
