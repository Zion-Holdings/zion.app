...
export const metadata: Metadata = {
  title: 'AI/IT Marketing Suite - HEALTHTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Marketing Suite - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthtech workflows with AI/IT Marketing Suite - HEALTHTECH. This intelligent platform delivers esg reporting through advanced automation and AI.
          </p>
