...
export const metadata: Metadata = {
  title: 'Automated System for Real-Estate',
  description: 'Revolutionize real-estate through intelligent automation. Our Automated System for Real-Estate leverages advanced machine learning to deliver sales process opti',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-system-for-real-estate-332d0f62',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated System for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our Automated System for Real-Estate leverages advanced machine learning to deliver sales process optimization at scale.
          </p>
