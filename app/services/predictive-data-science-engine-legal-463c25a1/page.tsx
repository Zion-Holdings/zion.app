...
export const metadata: Metadata = {
  title: 'Predictive Data Science Engine - Legal',
  description: 'The future of legal is here with Predictive Data Science Engine - Legal. Powered by cutting-edge AI, this platform delivers recommendation system like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-data-science-engine-legal-463c25a1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Data Science Engine - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Predictive Data Science Engine - Legal. Powered by cutting-edge AI, this platform delivers recommendation system like never before.
          </p>
