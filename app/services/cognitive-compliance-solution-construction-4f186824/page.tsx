...
export const metadata: Metadata = {
  title: 'Cognitive Compliance Solution - Construction',
  description: 'Transform your construction operations with our Cognitive Compliance Solution - Construction. This AI-driven solution automates invoice processing with unpreced',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-compliance-solution-construction-4f186824',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Compliance Solution - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Cognitive Compliance Solution - Construction. This AI-driven solution automates invoice processing with unprecedented accuracy and efficiency.
          </p>
