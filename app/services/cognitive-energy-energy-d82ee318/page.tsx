...
export const metadata: Metadata = {
  title: 'Cognitive Energy Energy',
  description: 'Next-generation telecom solution: Cognitive Energy Energy. Combines churn risk with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-energy-energy-d82ee318',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Energy Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation telecom solution: Cognitive Energy Energy. Combines churn risk with adaptive intelligence for optimal results.
          </p>
