...
export const metadata: Metadata = {
  title: 'Cognitive Data Solution - Sports',
  description: 'Enhance your sports business with Cognitive Data Solution - Sports. Our solution provides healthcare data analytics with enterprise-grade reliability and securi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Data Solution - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your sports business with Cognitive Data Solution - Sports. Our solution provides healthcare data analytics with enterprise-grade reliability and security.
          </p>
