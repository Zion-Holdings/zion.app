...
export const metadata: Metadata = {
  title: 'Intelligent monitoring-logistics',
  description: 'Transform your logistics operations with our Intelligent monitoring-logistics. This AI-driven solution automates customer insights with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-monitoring-logistics-70202c64',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent monitoring-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Intelligent monitoring-logistics. This AI-driven solution automates customer insights with unprecedented accuracy and efficiency.
          </p>
