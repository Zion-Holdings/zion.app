...
export const metadata: Metadata = {
  title: 'Adaptive Content Automation',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in manufacturing with Adaptive Content Automation. This AI-powered platform transforms release management into a competitive advantage.
          </p>
