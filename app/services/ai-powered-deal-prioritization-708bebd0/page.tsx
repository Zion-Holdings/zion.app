...
export const metadata: Metadata = {
  title: 'AI-Powered Deal Prioritization',
  description: 'Ranks sales opportunities by probability of close and potential revenue.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-deal-prioritization-708bebd0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Ranks sales opportunities by probability of close and potential revenue.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Deal scoring</li>
          <li className="text-gray-300">Probability calculation</li>
          <li className="text-gray-300">Focus prioritization</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">30% more closes</li>
