...
export const metadata: Metadata = {
  title: 'AI Customer Service - REGTECH Edition',
  description: 'Quantum leap forward for regtech: AI Customer Service - REGTECH Edition. Uses quantum-inspired algorithms to deliver customer journey mapping at exponential spe',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Customer Service - REGTECH Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for regtech: AI Customer Service - REGTECH Edition. Uses quantum-inspired algorithms to deliver customer journey mapping at exponential speed.
          </p>
