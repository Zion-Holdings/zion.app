...
export const metadata: Metadata = {
  ...
  description: 'The future of technology is here with Autonomous Intelligence for Technology. Powered by cutting-edge AI, this platform delivers image recognition like never be',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of technology is here with Autonomous Intelligence for Technology. Powered by cutting-edge AI, this platform delivers image recognition like never before.
          </p>
