...
export const metadata: Metadata = {
  title: 'Analytics Intelligent - Legal',
  description: 'Enhance your legal business with Analytics Intelligent - Legal. Our solution provides manufacturing quality control with enterprise-grade reliability and securi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/analytics-intelligent-legal-cfa04f56',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Analytics Intelligent - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Analytics Intelligent - Legal. Our solution provides manufacturing quality control with enterprise-grade reliability and security.
          </p>
