...
export const metadata: Metadata = {
  title: 'Incident Response Multi-Cloud Cost Management Platform',
  description: 'incident response solution for energy industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/incident-response-multi-cloud-cost-management-platform-b283cc92',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Incident Response Multi-Cloud Cost Management Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            incident response solution for energy industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.
          </p>
