...
export const metadata: Metadata = {
  ...
  description: 'Self-updating data catalog with automated metadata extraction.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-data-catalog-1ce7038c',
  },

export const metadata = {
  title: "AI-Powered Data Catalog - Zion Tech Group",
  description: "Self-updating data catalog with automated metadata extraction.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-data-catalog-1ce7038c`
  }
  ...
  return (
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Self-updating data catalog with automated metadata extraction.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Metadata extraction</li>
          <li className="text-gray-300">Auto-cataloging</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">Complete catalog</li>
          <li className="text-purple-300">Better discoverability</li>
          </ul>
        </section>
    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">AI-Powered Data Catalog</h1>
        <p className="text-lg text-gray-300 mb-8">Self-updating data catalog with automated metadata extraction.</p>
        
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          <h2 className="text-2xl font-semibold mb-4">Key Features</h2>
          <ul className="list-disc list-inside space-y-2">
            <li>Metadata extraction</li>
            <li>Auto-cataloging</li>
          </ul>
        </div>
