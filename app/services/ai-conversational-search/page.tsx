...
export const metadata: Metadata = {
  ...
  keywords: 'Natural language search, Multi-source search, Answer synthesis, Source citations, Personalized results, Conversational follow-ups, Access control, Analytics, ai, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Conversational Enterprise Search</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered search that understands natural language questions. Searches across documents, databases, emails, and apps to find and synthesize answers.</p>
        ...
        <li class="text-slate-300">Natural language search</li>
        <li class="text-slate-300">Multi-source search</li>
        <li class="text-slate-300">Answer synthesis</li>
        <li class="text-slate-300">Source citations</li>
        <li class="text-slate-300">Personalized results</li>
        <li class="text-slate-300">Conversational follow-ups</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">100x faster information finding</li>
        <li class="text-slate-300">Find anything instantly</li>
        <li class="text-slate-300">Answer synthesis</li>
        <li class="text-slate-300">Full source citations</li>
      </ul>
        </div>
