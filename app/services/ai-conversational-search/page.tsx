      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Natural language search</li>
            <li className="text-purple-300">✓ Multi-source search</li>
            <li className="text-purple-300">✓ Answer synthesis</li>
            <li className="text-purple-300">✓ Source citations</li>
            <li className="text-purple-300">✓ Personalized results</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ 100x faster information finding</li>
            <li className="text-purple-300">✓ Find anything instantly</li>
            <li className="text-purple-300">✓ Answer synthesis</li>
            <li className="text-purple-300">✓ Full source citations</li>
            </ul>
          </div>
