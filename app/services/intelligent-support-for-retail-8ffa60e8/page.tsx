...
export const metadata: Metadata = {
  title: 'Intelligent Support for Retail',
  description: 'The future of retail is here with Intelligent Support for Retail. Powered by cutting-edge AI, this platform delivers data quality like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-support-for-retail-8ffa60e8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Support for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Intelligent Support for Retail. Powered by cutting-edge AI, this platform delivers data quality like never before.
          </p>
