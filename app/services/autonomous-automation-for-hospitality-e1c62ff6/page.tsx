...
export const metadata: Metadata = {
  title: 'Autonomous Automation for Hospitality',
  description: 'Drive innovation in hospitality with Autonomous Automation for Hospitality. This AI-powered platform transforms master data management into a competitive advant',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-automation-for-hospitality-e1c62ff6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Automation for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Autonomous Automation for Hospitality. This AI-powered platform transforms master data management into a competitive advantage.
          </p>
