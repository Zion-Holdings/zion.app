...
export const metadata: Metadata = {
  title: 'Smart Container Marketing',
  description: 'Transform your real-estate operations with our Smart Container Marketing. This AI-driven solution provides intelligent automation with unprecedented accuracy an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Container Marketing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Smart Container Marketing. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
