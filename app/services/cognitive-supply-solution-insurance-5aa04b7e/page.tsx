...
export const metadata: Metadata = {
  title: 'Cognitive Supply Solution - Insurance',
  description: 'Enhance your insurance business with Cognitive Supply Solution - Insurance. Our solution provides resource utilization with enterprise-grade reliability and sec',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-supply-solution-insurance-5aa04b7e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Supply Solution - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Cognitive Supply Solution - Insurance. Our solution provides resource utilization with enterprise-grade reliability and security.
          </p>
