...
export const metadata: Metadata = {
  title: "AI Market Intelligence Platform - AI-Powered Market Research Solution",
  description: "Monitors market trends, competitor activities, and industry news to provide actionable insights.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-market-intelligence-platform-d3dab41f",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI Market Intelligence Platform - AI-Powered Market Research Solution
        </h1>
