...
export const metadata: Metadata = {
  ...
  description: 'Optimize your retail workflows with Cognitive Insights Solution - Retail. This intelligent platform delivers business intelligence through advanced automation a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your retail workflows with Cognitive Insights Solution - Retail. This intelligent platform delivers business intelligence through advanced automation and AI.
          </p>
