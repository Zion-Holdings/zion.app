...
export const metadata: Metadata = {
  title: 'Intelligent Security Advisor',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of gaming is here with Intelligent Security Advisor. Powered by cutting-edge AI, this platform delivers compliance monitoring like never before.
          </p>
