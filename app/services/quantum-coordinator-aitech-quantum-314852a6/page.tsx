...
export const metadata: Metadata = {
  title: 'Quantum Coordinator - AITECH Quantum',
  description: 'Transform your aitech operations with our Quantum Coordinator - AITECH Quantum. This AI-driven solution automates market analysis with unprecedented accuracy an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Coordinator - AITECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your aitech operations with our Quantum Coordinator - AITECH Quantum. This AI-driven solution automates market analysis with unprecedented accuracy and efficiency.
          </p>
