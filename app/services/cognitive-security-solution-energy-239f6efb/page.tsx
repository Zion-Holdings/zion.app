...
export const metadata: Metadata = {
  title: 'Cognitive Security Solution - Energy',
  description: 'Optimize your energy workflows with Cognitive Security Solution - Energy. This intelligent platform delivers brand monitoring through advanced automation and AI',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-security-solution-energy-239f6efb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Security Solution - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your energy workflows with Cognitive Security Solution - Energy. This intelligent platform delivers brand monitoring through advanced automation and AI.
          </p>
