...
export const metadata: Metadata = {
  ...
  keywords: 'Text/Image 3D scene Gaussian Splatting/LRM, Real-time browser viewer via Three.js, Object decomposition + physics export, FBX/GLTF/OBJ export + textures baked, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Spatial Computing 3D Scene Generator</h1>
        <p className="text-lg text-slate-300 mb-8">Text/Image 3D scene via Gaussian Splatting/LRM; real-time viewer in browser via Three.js; FBX/GLTF/OBJ export for game/VR pipeline.</p>
        ...
        <li class="text-slate-300">Text/Image 3D scene Gaussian Splatting/LRM</li>
        <li class="text-slate-300">Real-time browser viewer via Three.js</li>
        <li class="text-slate-300">Object decomposition + physics export</li>
        <li class="text-slate-300">FBX/GLTF/OBJ export + textures baked</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with spatial computing 3d scene generator</li>
