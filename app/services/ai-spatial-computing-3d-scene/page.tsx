    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Generate 3D scene in minutes from text prompt</li>
            <li>No 3D art skills needed — describe in words</li>
            <li>Realtime browser viewer = immediate iteration</li>
            <li>Export to Unity/Unreal/blender game engine</li>
          </ul>
        </div>
