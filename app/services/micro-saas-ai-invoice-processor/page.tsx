...
export const metadata: Metadata = {
  ...
  keywords: 'OCR + AI data extraction, Multi-format PDF/scan support, ERP/accounting integration, Auto-validation against POs, Exception handling dashboard, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Micro-SAAS AI Invoice Processor</h1>
        <p className="text-lg text-slate-300 mb-8">Automated invoice data extraction and processing using AI. Reads PDF/scan invoices, extracts line items, validates against POs, and syncs with accounting systems.</p>
        ...
        <li class="text-slate-300">OCR + AI data extraction</li>
        <li class="text-slate-300">Multi-format PDF/scan support</li>
        <li class="text-slate-300">ERP/accounting integration</li>
        <li class="text-slate-300">Auto-validation against POs</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">95% reduction in manual data entry</li>
        <li class="text-slate-300">Process invoices in seconds</li>
        <li class="text-slate-300">Eliminate human errors</li>
