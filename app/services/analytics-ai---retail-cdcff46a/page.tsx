      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize retail through intelligent automation. Our Analytics AI - Retail leverages advanced machine learning to deliver process automation at scale.
          </p>
