...
export const metadata: Metadata = {
  title: 'Predictive Scale-up Engine - REGTECH #1',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Scale-up Engine - REGTECH #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your regtech operations with our Predictive Scale-up Engine - REGTECH #1. This AI-driven solution automates skills management with unprecedented accuracy and efficiency.
          </p>
