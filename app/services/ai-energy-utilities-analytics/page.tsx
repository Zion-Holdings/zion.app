...
export const metadata = {
  ...
  description: 'Services - Ai Energy Utilities Analytics page from Zion Tech Group.',
};

export default function Page() {
  return (
    <div className="container-page py-20">
      <h1 className="text-4xl font-bold mb-4 text-white">Services - Ai Energy Utilities Analytics</h1>
      <p className="mb-6 text-slate-300">Services - Ai Energy Utilities Analytics page from Zion Tech Group.</p>
            <div className="grid gap-6 sm:grid-cols-2">
        <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
          <h2 className="mb-2 text-xl font-bold text-white">Overview</h2>
          <p className="text-slate-300">This page provides information about Services - Ai Energy Utilities Analytics.</p>
        </div>
        <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
