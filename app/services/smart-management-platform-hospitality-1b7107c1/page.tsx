...
export const metadata: Metadata = {
  title: 'Smart Management Platform - Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Smart Management Platform - Hospitality leverages advanced machine learning to deliver market inte',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-management-platform-hospitality-1b7107c1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Management Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Smart Management Platform - Hospitality leverages advanced machine learning to deliver market intelligence at scale.
          </p>
