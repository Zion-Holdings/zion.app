...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time network traffic analysis, AI-powered anomaly detection, Automated root cause analysis, Application dependency mapping, Capacity planning predictions, Integration with Cisco, Juniper, Arista, Custom alerting and dashboards, Historical trend analysis, it, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Network Observability &amp; Performance Analytics</h1>
        <p className="text-lg text-slate-300 mb-8">AI-driven network observability platform with real-time traffic analysis, anomaly detection, and automated root cause analysis.</p>
        ...
        <li class="text-slate-300">Real-time network traffic analysis</li>
        <li class="text-slate-300">AI-powered anomaly detection</li>
        <li class="text-slate-300">Automated root cause analysis</li>
        <li class="text-slate-300">Application dependency mapping</li>
        <li class="text-slate-300">Capacity planning predictions</li>
        ...
        <li class="text-slate-300">Prevent network outages</li>
        <li class="text-slate-300">Optimize network performance</li>
        <li class="text-slate-300">Plan capacity proactively</li>
      </ul>
        </div>
