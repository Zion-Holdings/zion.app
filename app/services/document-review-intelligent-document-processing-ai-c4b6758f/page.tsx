...
export const metadata: Metadata = {
  title: 'Document Review Intelligent Document Processing AI',
  description: 'document review solution for regtech industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/document-review-intelligent-document-processing-ai-c4b6758f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Document Review Intelligent Document Processing AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            document review solution for regtech industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.
          </p>
