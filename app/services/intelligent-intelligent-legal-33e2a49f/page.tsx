...
export const metadata: Metadata = {
  title: 'Intelligent intelligent-legal',
  description: 'Enhance your legal business with Intelligent intelligent-legal. Our solution provides compliance reporting with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-intelligent-legal-33e2a49f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent intelligent-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Intelligent intelligent-legal. Our solution provides compliance reporting with enterprise-grade reliability and security.
          </p>
