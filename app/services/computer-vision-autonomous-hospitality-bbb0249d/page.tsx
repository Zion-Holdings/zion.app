...
export const metadata: Metadata = {
  title: 'Computer Vision Autonomous - Hospitality',
  description: 'The future of hospitality is here with Computer Vision Autonomous - Hospitality. Powered by cutting-edge AI, this platform delivers market intelligence like nev',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/computer-vision-autonomous-hospitality-bbb0249d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Computer Vision Autonomous - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Computer Vision Autonomous - Hospitality. Powered by cutting-edge AI, this platform delivers market intelligence like never before.
          </p>
