...
export const metadata: Metadata = {
  title: 'Intelligent AI-Powered Market Intelligence',
  description: 'intelligent solution for textiles industry. Monitors market trends, competitor activities, and industry news to provide actionable insights.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-ai-powered-market-intelligence-0ce0f933',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent AI-Powered Market Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            intelligent solution for textiles industry. Monitors market trends, competitor activities, and industry news to provide actionable insights.
          </p>
