...
export const metadata: Metadata = {
  ...
  description: 'Next-generation transportation solution: Cognitive Smart Solution - Transportation. Combines manufacturing quality control with adaptive intelligence for optima',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation transportation solution: Cognitive Smart Solution - Transportation. Combines manufacturing quality control with adaptive intelligence for optimal results.
          </p>
