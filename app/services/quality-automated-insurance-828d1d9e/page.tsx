...
export const metadata: Metadata = {
  title: 'Quality Automated - Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Quality Automated - Insurance leverages advanced machine learning to deliver loyalty optimization at',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quality-automated-insurance-828d1d9e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quality Automated - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Quality Automated - Insurance leverages advanced machine learning to deliver loyalty optimization at scale.
          </p>
