...
export const metadata: Metadata = {
  title: 'AI/IT Healthcare Suite - Real-Estate',
  description: 'Drive innovation in real-estate with AI/IT Healthcare Suite - Real-Estate. This AI-powered platform transforms regulatory tracking into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-healthcare-suite-real-estate-bd177bb8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Healthcare Suite - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in real-estate with AI/IT Healthcare Suite - Real-Estate. This AI-powered platform transforms regulatory tracking into a competitive advantage.
          </p>
