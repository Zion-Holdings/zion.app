...
export const metadata: Metadata = {
  ...
  description: 'Optimize your transportation workflows with Data Science Autonomous - Transportation. This intelligent platform delivers threat detection through advanced autom',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-science-autonomous-transportation-656a2efc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Data Science Autonomous - Transportation. This intelligent platform delivers threat detection through advanced automation and AI.
          </p>
