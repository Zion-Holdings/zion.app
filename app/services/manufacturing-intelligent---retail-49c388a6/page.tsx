...
export const metadata: Metadata = {
  title: 'Manufacturing Intelligent - Retail',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manufacturing Intelligent - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation retail solution: Manufacturing Intelligent - Retail. Combines fraud prevention with adaptive intelligence for optimal results.
          </p>
