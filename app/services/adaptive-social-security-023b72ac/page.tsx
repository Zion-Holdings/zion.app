...
export const metadata: Metadata = {
  title: 'Adaptive Social Security',
  description: 'Transform your automotive operations with our Adaptive Social Security. This AI-driven solution automates net promoter score with unprecedented accuracy and eff',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-social-security-023b72ac',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your automotive operations with our Adaptive Social Security. This AI-driven solution automates net promoter score with unprecedented accuracy and efficiency.
          </p>
