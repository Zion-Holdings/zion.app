...
export const metadata: Metadata = {
  title: 'AI-Powered Automation for Construction',
  description: 'Transform your construction operations with our AI-Powered Automation for Construction. This AI-driven solution automates performance monitoring with unpreceden',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-automation-for-construction-d94f160b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Automation for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our AI-Powered Automation for Construction. This AI-driven solution automates performance monitoring with unprecedented accuracy and efficiency.
          </p>
