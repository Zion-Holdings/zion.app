...
export const metadata: Metadata = {
  title: 'Autonomous Analytics System - Construction',
  description: 'Unlock unprecedented growth with Autonomous Analytics System - Construction. This autonomous system provides procurement automation with zero manual interventio',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-analytics-system-construction-8229c2cc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Analytics System - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Autonomous Analytics System - Construction. This autonomous system provides procurement automation with zero manual intervention needed.
          </p>
