...
export const metadata: Metadata = {
  title: 'Enterprise Director Platform - CLEANTECH',
  description: 'Revolutionize cleantech through intelligent automation. Our Enterprise Director Platform - CLEANTECH leverages advanced machine learning to deliver disaster rec',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-director-platform-cleantech-87166ceb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Director Platform - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cleantech through intelligent automation. Our Enterprise Director Platform - CLEANTECH leverages advanced machine learning to deliver disaster recovery at scale.
          </p>
