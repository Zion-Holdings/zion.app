      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous nlp-retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Autonomous nlp-retail. Powered by cutting-edge AI, this platform delivers logistics route optimization like never before.
          </p>
