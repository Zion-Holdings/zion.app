...
export const metadata: Metadata = {
  title: 'Autonomous Image Computer Vision',
  description: 'Optimize your transportation workflows with Autonomous Image Computer Vision. This intelligent platform delivers procurement automation through advanced automat',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Image Computer Vision
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Autonomous Image Computer Vision. This intelligent platform delivers procurement automation through advanced automation and AI.
          </p>
