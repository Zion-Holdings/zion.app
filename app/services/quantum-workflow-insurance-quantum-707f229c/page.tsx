...
export const metadata: Metadata = {
  title: 'Quantum Workflow - Insurance Quantum',
  description: 'Enhance your insurance business with Quantum Workflow - Insurance Quantum. Our solution provides customer service automation with enterprise-grade reliability a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-workflow-insurance-quantum-707f229c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Workflow - Insurance Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Quantum Workflow - Insurance Quantum. Our solution provides customer service automation with enterprise-grade reliability and security.
          </p>
