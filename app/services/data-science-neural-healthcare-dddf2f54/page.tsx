...
export const metadata: Metadata = {
  title: 'Data Science Neural - Healthcare',
  description: 'The future of healthcare is here with Data Science Neural - Healthcare. Powered by cutting-edge AI, this platform delivers transformative results like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-science-neural-healthcare-dddf2f54',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Science Neural - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Data Science Neural - Healthcare. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
