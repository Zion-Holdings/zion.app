...
export const metadata: Metadata = {
  title: 'Cognitive Adaptive - Transportation',
  description: 'Next-generation transportation solution: Cognitive Adaptive - Transportation. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-adaptive-transportation-39289a2f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Adaptive - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation transportation solution: Cognitive Adaptive - Transportation. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
