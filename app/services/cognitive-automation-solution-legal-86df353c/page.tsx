...
export const metadata: Metadata = {
  ...
  description: 'Next-generation legal solution: Cognitive Automation Solution - Legal. Combines compliance reporting with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-automation-solution-legal-86df353c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Cognitive Automation Solution - Legal. Combines compliance reporting with adaptive intelligence for optimal results.
          </p>
