...
export const metadata: Metadata = {
  title: 'Marketing Automated - PROPTECH',
  description: 'Revolutionize proptech through intelligent automation. Our Marketing Automated - PROPTECH leverages advanced machine learning to deliver performance tracking at',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Marketing Automated - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our Marketing Automated - PROPTECH leverages advanced machine learning to deliver performance tracking at scale.
          </p>
