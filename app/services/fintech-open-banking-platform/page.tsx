...
export const metadata: Metadata = {
  ...
  keywords: 'PSD2-compliant APIs, Consent management, Account aggregation, Payment initiation, Third-party provider management, Strong customer authentication, API analytics and reporting, Sandbox environment, fintech, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Open Banking API Platform</h1>
        <p className="text-lg text-slate-300 mb-8">PSD2-compliant open banking platform with API gateway, consent management, and third-party integration. Enable account aggregation, payment initiation, and data sharing.</p>
        ...
        <li class="text-slate-300">PSD2-compliant APIs</li>
        <li class="text-slate-300">Consent management</li>
        <li class="text-slate-300">Account aggregation</li>
        <li class="text-slate-300">Payment initiation</li>
        <li class="text-slate-300">Third-party provider management</li>
        <li class="text-slate-300">Strong customer authentication</li>
        <li class="text-slate-300">API analytics and reporting</li>
        <li class="text-slate-300">Sandbox environment</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Enable open banking partnerships</li>
        <li class="text-slate-300">PSD2 compliance</li>
        <li class="text-slate-300">New revenue streams from APIs</li>
        <li class="text-slate-300">Enhanced customer experience</li>
      </ul>
        </div>
