...
export const metadata: Metadata = {
  title: 'Smart Analytics for Real-Estate',
  description: 'The future of real-estate is here with Smart Analytics for Real-Estate. Powered by cutting-edge AI, this platform delivers market intelligence like never before',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-analytics-for-real-estate-948b3f7e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of real-estate is here with Smart Analytics for Real-Estate. Powered by cutting-edge AI, this platform delivers market intelligence like never before.
          </p>
