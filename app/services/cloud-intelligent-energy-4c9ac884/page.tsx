...
export const metadata: Metadata = {
  title: 'Cloud Intelligent - Energy',
  description: 'Drive innovation in energy with Cloud Intelligent - Energy. This AI-powered platform transforms loyalty optimization into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cloud-intelligent-energy-4c9ac884',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cloud Intelligent - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Cloud Intelligent - Energy. This AI-powered platform transforms loyalty optimization into a competitive advantage.
          </p>
