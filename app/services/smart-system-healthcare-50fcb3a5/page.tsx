    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        ...
        <p className="text-xl text-slate-300 mb-8">
          Transform your healthcare operations with our Smart system-healthcare. This AI-driven solution automates network optimization with unprecedented accuracy and ef
        </p>
