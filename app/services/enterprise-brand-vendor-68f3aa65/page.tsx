...
export const metadata: Metadata = {
  title: 'Enterprise Brand Vendor',
  description: 'Next-generation hospitality solution: Enterprise Brand Vendor. Combines process automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-brand-vendor-68f3aa65',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Brand Vendor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Enterprise Brand Vendor. Combines process automation with adaptive intelligence for optimal results.
          </p>
