...
export const metadata: Metadata = {
  title: 'AI/IT Cloud Suite - Construction',
  description: 'Unlock unprecedented growth with AI/IT Cloud Suite - Construction. This autonomous system provides warehouse automation with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-cloud-suite-construction-12f389b2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Cloud Suite - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with AI/IT Cloud Suite - Construction. This autonomous system provides warehouse automation with zero manual intervention needed.
          </p>
