...
export const metadata: Metadata = {
  title: 'Adaptive Market Insights',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of finance is here with Adaptive Market Insights. Powered by cutting-edge AI, this platform delivers workflow management like never before.
          </p>
