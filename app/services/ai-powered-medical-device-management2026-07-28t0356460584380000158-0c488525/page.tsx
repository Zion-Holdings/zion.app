...
export const metadata: Metadata = {
  title: 'AI-Powered Medical Device Management',
  description: 'Manages medical devices with maintenance scheduling and optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-medical-device-management2026-07-28t0356460584380000158-0c488525',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Medical Device Management
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Manages medical devices with maintenance scheduling and optimization.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Device management</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">30% better uptime</li>
