...
export const metadata: Metadata = {
  title: 'Predictive Supply Engine - TECHNOLOGY',
  description: 'Optimize your technology workflows with Predictive Supply Engine - TECHNOLOGY. This intelligent platform delivers quality control through advanced automation an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Supply Engine - TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your technology workflows with Predictive Supply Engine - TECHNOLOGY. This intelligent platform delivers quality control through advanced automation and AI.
          </p>
