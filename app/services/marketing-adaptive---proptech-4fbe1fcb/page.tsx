...
export const metadata: Metadata = {
  title: 'Marketing Adaptive - Proptech',
  description: 'Revolutionize proptech through intelligent automation. Our Marketing Adaptive - Proptech leverages advanced machine learning to deliver market intelligence at s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/marketing-adaptive---proptech-4fbe1fcb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Marketing Adaptive - Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our Marketing Adaptive - Proptech leverages advanced machine learning to deliver market intelligence at scale.
          </p>
