...
export const metadata: Metadata = {
  title: 'Cognitive Autonomous Solution - Construction',
  description: 'Drive innovation in construction with Cognitive Autonomous Solution - Construction. This AI-powered platform transforms recommendation system into a competitive',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-autonomous-solution-construction-a54a84c4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Autonomous Solution - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Cognitive Autonomous Solution - Construction. This AI-powered platform transforms recommendation system into a competitive advantage.
          </p>
