...
export const metadata: Metadata = {
  title: 'Cognitive Risk Solution - Real-Estate',
  description: 'Optimize your real-estate workflows with Cognitive Risk Solution - Real-Estate. This intelligent platform delivers user provisioning through advanced automation',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-risk-solution-real-estate-93554c60',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Risk Solution - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your real-estate workflows with Cognitive Risk Solution - Real-Estate. This intelligent platform delivers user provisioning through advanced automation and AI.
          </p>
