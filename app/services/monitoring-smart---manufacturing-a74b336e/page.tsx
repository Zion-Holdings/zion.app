...
export const metadata: Metadata = {
  title: 'Monitoring Smart - Manufacturing',
  description: 'The future of manufacturing is here with Monitoring Smart - Manufacturing. Powered by cutting-edge AI, this platform delivers risk assessment like never before.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of manufacturing is here with Monitoring Smart - Manufacturing. Powered by cutting-edge AI, this platform delivers risk assessment like never before.
          </p>
