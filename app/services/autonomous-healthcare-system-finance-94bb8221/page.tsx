      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in finance with Autonomous Healthcare System - Finance. This AI-powered platform transforms budget tracking into a competitive advantage.
          </p>
