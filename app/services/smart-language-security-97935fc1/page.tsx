...
export const metadata: Metadata = {
  title: 'Smart Language Security',
  description: 'Transform your cleantech operations with our Smart Language Security. This AI-driven solution automates healthcare data analytics with unprecedented accuracy an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-language-security-97935fc1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Language Security
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your cleantech operations with our Smart Language Security. This AI-driven solution automates healthcare data analytics with unprecedented accuracy and efficiency.
          </p>
