...
export const metadata: Metadata = {
  title: 'Smart Insights for Cleantech',
  description: 'The future of cleantech is here with Smart Insights for Cleantech. Powered by cutting-edge AI, this platform delivers content generation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-insights-for-cleantech-8826c9ec',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Insights for Cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of cleantech is here with Smart Insights for Cleantech. Powered by cutting-edge AI, this platform delivers content generation like never before.
          </p>
