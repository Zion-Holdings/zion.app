...
export const metadata: Metadata = {
  title: 'Predictive Support Engine - Insurance',
  description: 'Enhance your insurance business with Predictive Support Engine - Insurance. Our solution provides revenue forecasting with enterprise-grade reliability and secu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Support Engine - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Predictive Support Engine - Insurance. Our solution provides revenue forecasting with enterprise-grade reliability and security.
          </p>
