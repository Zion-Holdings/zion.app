...
export const metadata: Metadata = {
  title: 'Cognitive Customer Service Solution - MARTECH',
  description: 'Drive innovation in martech with Cognitive Customer Service Solution - MARTECH. This AI-powered platform transforms capacity planning into a competitive advanta',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Customer Service Solution - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in martech with Cognitive Customer Service Solution - MARTECH. This AI-powered platform transforms capacity planning into a competitive advantage.
          </p>
