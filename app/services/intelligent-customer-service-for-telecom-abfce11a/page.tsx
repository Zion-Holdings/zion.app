...
export const metadata: Metadata = {
  title: 'Intelligent Customer Service for Telecom',
  description: 'Optimize your telecom workflows with Intelligent Customer Service for Telecom. This intelligent platform delivers risk management through advanced automation an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-customer-service-for-telecom-abfce11a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Customer Service for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your telecom workflows with Intelligent Customer Service for Telecom. This intelligent platform delivers risk management through advanced automation and AI.
          </p>
