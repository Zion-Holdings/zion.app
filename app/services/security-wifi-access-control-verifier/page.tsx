  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Wi-Fi Access Control Verifier</h1>
        <p className="text-lg text-gray-300 mb-8">Validates wireless access policies, AP placement, segmentation, and guest isolation posture with periodic checks.</p>
