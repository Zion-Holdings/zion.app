...
export const metadata: Metadata = {
  title: 'Autonomous Real Estate System - Finance',
  description: 'Enhance your finance business with Autonomous Real Estate System - Finance. Our solution provides energy management with enterprise-grade reliability and securi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-real-estate-system-finance-6d3aadbf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Real Estate System - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your finance business with Autonomous Real Estate System - Finance. Our solution provides energy management with enterprise-grade reliability and security.
          </p>
