...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated SMB - Finance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated SMB - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your finance workflows with Hyper-Accelerated SMB - Finance. This intelligent platform delivers budget optimization through advanced automation and AI.
          </p>
