...
export const metadata: Metadata = {
  title: 'Autonomous Experience for Real-Estate',
  description: 'Revolutionize real-estate through intelligent automation. Our Autonomous Experience for Real-Estate leverages advanced machine learning to deliver supply chain ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-experience-for-real-estate-1d50e6d5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Experience for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our Autonomous Experience for Real-Estate leverages advanced machine learning to deliver supply chain at scale.
          </p>
