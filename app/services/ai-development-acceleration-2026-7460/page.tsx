...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "AI Development Acceleration | Zion Tech Group", description: "End-to-end ai development acceleration services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/ai-development-acceleration-2026-7460/}} />
