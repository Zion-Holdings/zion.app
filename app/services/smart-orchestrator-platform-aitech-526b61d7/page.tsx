...
export const metadata: Metadata = {
  title: 'Smart Orchestrator Platform - AITECH',
  description: 'Enhance your aitech business with Smart Orchestrator Platform - AITECH. Our solution provides automation opportunity with enterprise-grade reliability and secur',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Orchestrator Platform - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your aitech business with Smart Orchestrator Platform - AITECH. Our solution provides automation opportunity with enterprise-grade reliability and security.
          </p>
