...
export const metadata: Metadata = {
  title: 'Computer Vision Zero-Trust Identity & Access Manager',
  description: 'computer vision solution for cosmetics industry. Implements zero-trust security architecture with continuous authentication and adaptive access controls.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/computer-vision-zero-trust-identity--access-manager-924f11ee',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Computer Vision Zero-Trust Identity & Access Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            computer vision solution for cosmetics industry. Implements zero-trust security architecture with continuous authentication and adaptive access controls.
          </p>
