...
export const metadata: Metadata = {
  title: 'Autonomous risk-finance',
  description: 'Next-generation finance solution: Autonomous risk-finance. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-risk-finance-cdf94abc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous risk-finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation finance solution: Autonomous risk-finance. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
