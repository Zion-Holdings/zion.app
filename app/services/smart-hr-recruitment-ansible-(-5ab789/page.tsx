...
export const metadata: Metadata = {
  title: 'Smart HR Recruitment Ansible (Data)',
  description: 'Smart HR Recruitment Ansible (Data) is an AI-powered data solution that transforms how businesses operate through intelligent automation and real-time analytics',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-hr-recruitment-ansible-(-5ab789',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart HR Recruitment Ansible (Data)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Smart HR Recruitment Ansible (Data) is an AI-powered data solution that transforms how businesses operate through intelligent automation and real-time analytics.
...
Go, PostgreSQL, Ansible, Airflow, AWS, IoT
