...
export const metadata: Metadata = {
  title: 'Intelligent Healthcare for Sports #1',
  description: 'Revolutionize sports through intelligent automation. Our Intelligent Healthcare for Sports #1 leverages advanced machine learning to deliver financial planning ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-healthcare-for-sports-1-1deae5f4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Healthcare for Sports #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Intelligent Healthcare for Sports #1 leverages advanced machine learning to deliver financial planning at scale.
          </p>
