...
export const metadata: Metadata = {
  title: 'Autonomous Workflow System - FINTECH',
  description: 'Transform your fintech operations with our Autonomous Workflow System - FINTECH. This AI-driven solution automates succession planning with unprecedented accura',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-workflow-system-fintech-6ac27101',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Workflow System - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your fintech operations with our Autonomous Workflow System - FINTECH. This AI-driven solution automates succession planning with unprecedented accuracy and efficiency.
          </p>
