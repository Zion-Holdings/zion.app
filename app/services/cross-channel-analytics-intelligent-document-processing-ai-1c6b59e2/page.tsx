...
export const metadata: Metadata = {
  title: 'Cross-Channel Analytics Intelligent Document Processing AI',
  description: 'cross-channel analytics solution for insurance industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents autom',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cross-channel-analytics-intelligent-document-processing-ai-1c6b59e2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cross-Channel Analytics Intelligent Document Processing AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            cross-channel analytics solution for insurance industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.
          </p>
