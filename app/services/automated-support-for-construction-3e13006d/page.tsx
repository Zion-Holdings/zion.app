...
export const metadata: Metadata = {
  title: 'Automated Support for Construction',
  description: 'Revolutionize construction through intelligent automation. Our Automated Support for Construction leverages advanced machine learning to deliver security monito',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-support-for-construction-3e13006d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Support for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Automated Support for Construction leverages advanced machine learning to deliver security monitoring at scale.
          </p>
