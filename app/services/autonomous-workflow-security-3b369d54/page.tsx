...
export const metadata: Metadata = {
  title: 'Autonomous Workflow Security',
  description: 'The future of gaming is here with Autonomous Workflow Security. Powered by cutting-edge AI, this platform delivers customer insights like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-workflow-security-3b369d54',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of gaming is here with Autonomous Workflow Security. Powered by cutting-edge AI, this platform delivers customer insights like never before.
          </p>
