...
export const metadata: Metadata = {
  title: 'Government AI-Powered Predictive Analytics Platform',
  description: 'AI-powered government solution leveraging advanced machine learning for optimal performance and ROI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/government-ai-powered-predictive-analytics-platform-073251cf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Government AI-Powered Predictive Analytics Platform
          </h1>
