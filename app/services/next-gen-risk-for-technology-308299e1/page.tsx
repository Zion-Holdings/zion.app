...
export const metadata: Metadata = {
  title: 'Next-Gen Risk for TECHNOLOGY',
  description: 'Optimize your technology workflows with Next-Gen Risk for TECHNOLOGY. This intelligent platform delivers capacity management through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-risk-for-technology-308299e1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Risk for TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your technology workflows with Next-Gen Risk for TECHNOLOGY. This intelligent platform delivers capacity management through advanced automation and AI.
          </p>
