...
export const metadata: Metadata = {
  title: 'Autonomous Deep Learning System - Hospitality',
  description: 'Drive innovation in hospitality with Autonomous Deep Learning System - Hospitality. This AI-powered platform transforms release management into a competitive ad',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-deep-learning-system-hospitality-8fe8d592',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Deep Learning System - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Autonomous Deep Learning System - Hospitality. This AI-powered platform transforms release management into a competitive advantage.
          </p>
