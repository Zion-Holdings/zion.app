...
export const metadata: Metadata = {
  ...
  keywords: 'Behavioral analysis, Automated response, Threat intelligence, Incident management, security, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Powered Cloud-Native Threat Detection</h1>
        <p className="text-lg text-slate-300 mb-8">Advanced cybersecurity platform that identifies and mitigates cloud-native threats in real-time.</p>
        ...
        <li class="text-slate-300">Incident management</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Proactive protection</li>
        <li class="text-slate-300">Reduced breaches</li>
        <li class="text-slate-300">Faster response</li>
        <li class="text-slate-300">Compliance assurance</li>
      </ul>
        </div>
