...
export const metadata: Metadata = {
  title: 'AI-Powered Production Planning AI',
  description: 'AI-powered production planning with demand and capacity optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-production-planning-ai-617fb8f7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Production Planning AI
          </h1>
