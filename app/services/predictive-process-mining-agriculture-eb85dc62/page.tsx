...
export const metadata: Metadata = {
  title: 'Predictive process mining-agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Predictive process mining-agriculture leverages advanced machine learning to deliver enterprise-gr',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive process mining-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Predictive process mining-agriculture leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
