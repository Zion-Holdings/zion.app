...
export const metadata: Metadata = {
  ...
  keywords: 'Process mining and discovery, AI-powered bot development, Document understanding and extraction, Natural language processing for unstructured data, Integration with UiPath, Automation Anywhere, Blue Prism, Orchestration and monitoring dashboard, Continuous optimization with ML, Citizen developer enablement, ai, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Hyperautomation &amp; Intelligent Process Automation</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end hyperautomation combining RPA, AI, and process mining. Discover, automate, and optimize business processes with intelligent automation.</p>
        ...
        <li class="text-slate-300">Process mining and discovery</li>
        <li class="text-slate-300">AI-powered bot development</li>
        <li class="text-slate-300">Document understanding and extraction</li>
        <li class="text-slate-300">Natural language processing for unstructured data</li>
        <li class="text-slate-300">Integration with UiPath, Automation Anywhere, Blue Prism</li>
        <li class="text-slate-300">Orchestration and monitoring dashboard</li>
        <li class="text-slate-300">Continuous optimization with ML</li>
        <li class="text-slate-300">Citizen developer enablement</li>
      </ul>
        </div>
        ...
        <li class="text-slate-300">Reduce process costs by 60%</li>
        <li class="text-slate-300">Discover automation opportunities with AI</li>
        <li class="text-slate-300">Scale automation with citizen developers</li>
      </ul>
        </div>
