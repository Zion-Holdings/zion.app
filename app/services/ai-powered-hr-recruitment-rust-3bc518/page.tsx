...
export const metadata: Metadata = {
  title: 'AI-Powered HR Recruitment Rust (Automation)',
  description: 'AI-Powered HR Recruitment Rust (Automation) is an AI-powered automation solution that transforms how businesses operate through intelligent automation and real-',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-hr-recruitment-rust-3bc518',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered HR Recruitment Rust (Automation)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-Powered HR Recruitment Rust (Automation) is an AI-powered automation solution that transforms how businesses operate through intelligent automation and real-time analytics.
