...
export const metadata: Metadata = {
  title: 'Automated Insights for ALTHEALTH',
  description: 'The future of althealth is here with Automated Insights for ALTHEALTH. Powered by cutting-edge AI, this platform delivers scenario planning like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-insights-for-althealth-a6ca01c8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Insights for ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of althealth is here with Automated Insights for ALTHEALTH. Powered by cutting-edge AI, this platform delivers scenario planning like never before.
          </p>
