...
export const metadata: Metadata = {
  ...
  description: 'Transform your iot operations with our Smart intelligence-iot. This AI-driven solution automates manufacturing quality control with unprecedented accuracy and e',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-intelligence-iot-49c130b4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart intelligence-iot
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your iot operations with our Smart intelligence-iot. This AI-driven solution automates manufacturing quality control with unprecedented accuracy and efficiency.
          </p>
