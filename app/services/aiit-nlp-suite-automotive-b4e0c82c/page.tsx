...
export const metadata: Metadata = {
  title: 'AI/IT NLP Suite - Automotive',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT NLP Suite - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your automotive workflows with AI/IT NLP Suite - Automotive. This intelligent platform delivers microservices mesh through advanced automation and AI.
          </p>
