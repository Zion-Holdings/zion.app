...
export const metadata = {
  ...
  description: "Generate realistic synthetic data for AI/ML training while preserving privacy. Supports tabular, text, image, and time-series data with statistical fidelity gua",
  alternates: {
