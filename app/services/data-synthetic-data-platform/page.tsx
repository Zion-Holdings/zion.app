...
export const metadata: Metadata = {
  ...
  keywords: 'Tabular synthetic data generation, Text data synthesis, Image synthesis (GANs), Time-series generation, Statistical fidelity validation, Privacy guarantee (differential privacy), Bias detection and mitigation, API and SDK access, data, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Synthetic Data Platform for AI Training</h1>
        <p className="text-lg text-slate-300 mb-8">Generate realistic synthetic data for AI/ML training while preserving privacy. Supports tabular, text, image, and time-series data with statistical fidelity guarantees.</p>
        ...
        <li class="text-slate-300">Tabular synthetic data generation</li>
        <li class="text-slate-300">Text data synthesis</li>
        <li class="text-slate-300">Image synthesis (GANs)</li>
        <li class="text-slate-300">Time-series generation</li>
        <li class="text-slate-300">Statistical fidelity validation</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Unlimited training data without privacy risk</li>
        <li class="text-slate-300">Balance underrepresented classes</li>
        <li class="text-slate-300">Accelerate ML development</li>
        <li class="text-slate-300">GDPR/HIPAA compliant data</li>
      </ul>
        </div>
