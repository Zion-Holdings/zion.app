...
export const metadata: Metadata = {
  title: 'Cognitive system-construction',
  description: 'Drive innovation in construction with Cognitive system-construction. This AI-powered platform transforms territory management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-system-construction-80a47a78',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive system-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Cognitive system-construction. This AI-powered platform transforms territory management into a competitive advantage.
          </p>
