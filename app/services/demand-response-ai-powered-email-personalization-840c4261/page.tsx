...
export const metadata: Metadata = {
  title: 'Demand Response AI-Powered Email Personalization',
  description: 'AI-powered demand response solution for email marketing. Creates hyper-personalized email campaigns by analyzing recipient data.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/demand-response-ai-powered-email-personalization-840c4261',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Demand Response AI-Powered Email Personalization
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered demand response solution for email marketing. Creates hyper-personalized email campaigns by analyzing recipient data.
          </p>
