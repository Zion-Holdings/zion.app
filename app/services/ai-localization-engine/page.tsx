...
export const metadata: Metadata = {
  ...
  keywords: 'Cultural nuance detection, Image and icon adaptation, Brand voice preservation, Glossary and style guide support, Integration with CMS (Contentful, Strapi), In-context preview, Quality scoring per locale, Continuous learning from native reviewers, ai, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Content Localization Engine</h1>
        <p className="text-lg text-slate-300 mb-8">Go beyond translation — adapt content for local markets with AI. Cultural nuance detection, imagery adaptation, and brand voice consistency across 50+ languages.</p>
        ...
        <li class="text-slate-300">Cultural nuance detection</li>
        <li class="text-slate-300">Image and icon adaptation</li>
        <li class="text-slate-300">Brand voice preservation</li>
        <li class="text-slate-300">Glossary and style guide support</li>
        <li class="text-slate-300">Integration with CMS (Contentful, Strapi)</li>
        <li class="text-slate-300">In-context preview</li>
        <li class="text-slate-300">Quality scoring per locale</li>
        <li class="text-slate-300">Continuous learning from native reviewers</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Launch in new markets 3x faster</li>
        <li class="text-slate-300">Avoid cultural missteps</li>
        <li class="text-slate-300">Consistent brand voice globally</li>
        <li class="text-slate-300">Reduce localization costs by 50%</li>
      </ul>
        </div>
