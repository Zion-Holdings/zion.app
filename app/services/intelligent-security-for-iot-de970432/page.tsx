...
export const metadata: Metadata = {
  title: 'Intelligent Security for Iot',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize iot through intelligent automation. Our Intelligent Security for Iot leverages advanced machine learning to deliver energy management at scale.
          </p>
