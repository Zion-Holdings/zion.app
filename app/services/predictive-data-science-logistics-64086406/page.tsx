...
export const metadata: Metadata = {
  title: 'Predictive data science-logistics',
  description: 'The future of logistics is here with Predictive data science-logistics. Powered by cutting-edge AI, this platform delivers personalization engine like never bef',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive data science-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Predictive data science-logistics. Powered by cutting-edge AI, this platform delivers personalization engine like never before.
          </p>
