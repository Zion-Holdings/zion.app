...
export const metadata: Metadata = {
  title: 'Intelligent Capacity DevOps',
  description: 'Transform your automotive operations with our Intelligent Capacity DevOps. This AI-driven solution provides intelligent automation with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-capacity-devops-d52ea754',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Capacity DevOps
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your automotive operations with our Intelligent Capacity DevOps. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
