...
export const metadata: Metadata = {
  title: 'SQL Server AI-Powered Data Security',
  description: 'AI-powered sql server solution for security. Automated data access control and encryption management.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/sql-server-ai-powered-data-security-3c816ba9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            SQL Server AI-Powered Data Security
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered sql server solution for security. Automated data access control and encryption management.
          </p>
