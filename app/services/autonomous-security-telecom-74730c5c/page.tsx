...
export const metadata: Metadata = {
  title: 'Autonomous security-telecom',
  description: 'The future of telecom is here with Autonomous security-telecom. Powered by cutting-edge AI, this platform delivers incident response like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-security-telecom-74730c5c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous security-telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of telecom is here with Autonomous security-telecom. Powered by cutting-edge AI, this platform delivers incident response like never before.
          </p>
