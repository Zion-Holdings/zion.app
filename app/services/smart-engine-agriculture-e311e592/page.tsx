...
export const metadata: Metadata = {
  title: 'Smart engine-agriculture',
  description: 'Drive innovation in agriculture with Smart engine-agriculture. This AI-powered platform transforms fraud prevention into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-engine-agriculture-e311e592',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart engine-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in agriculture with Smart engine-agriculture. This AI-powered platform transforms fraud prevention into a competitive advantage.
          </p>
