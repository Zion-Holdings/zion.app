...
export const metadata: Metadata = {
  title: 'Adaptive Advisor Module',
  description: 'Transform your legal operations with our Adaptive Advisor Module. This cloud solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-advisor-module-3912db',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Advisor Module
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Adaptive Advisor Module. This cloud solution delivers unprecedented automation and intelligence.
          </p>
