...
export const metadata: Metadata = {
  title: 'Cognitive support-sports',
  description: 'Enhance your sports business with Cognitive support-sports. Our solution provides supply chain with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-support-sports-d004ee48',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive support-sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your sports business with Cognitive support-sports. Our solution provides supply chain with enterprise-grade reliability and security.
          </p>
