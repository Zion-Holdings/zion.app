...
export const metadata: Metadata = {
  title: 'Smart management-healthcare',
  description: 'The future of healthcare is here with Smart management-healthcare. Powered by cutting-edge AI, this platform delivers anomaly detection like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-management-healthcare-3de820d2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart management-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Smart management-healthcare. Powered by cutting-edge AI, this platform delivers anomaly detection like never before.
          </p>
