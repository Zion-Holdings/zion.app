...
export const metadata: Metadata = {
  title: 'Smart Coordinator for Tech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Coordinator for Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation technology solution: Smart Coordinator for Tech. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
