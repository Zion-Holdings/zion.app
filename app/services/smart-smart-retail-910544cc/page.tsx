...
export const metadata: Metadata = {
  title: 'Smart smart-retail',
  description: 'Transform your retail operations with our Smart smart-retail. This AI-driven solution automates workflow automation with unprecedented accuracy and efficiency.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-smart-retail-910544cc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our Smart smart-retail. This AI-driven solution automates workflow automation with unprecedented accuracy and efficiency.
          </p>
