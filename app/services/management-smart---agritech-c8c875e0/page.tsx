...
export const metadata: Metadata = {
  title: 'Management Smart - Agritech',
  description: 'Transform your agritech operations with our Management Smart - Agritech. This AI-driven solution automates security monitoring with unprecedented accuracy and e',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/management-smart---agritech-c8c875e0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Management Smart - Agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agritech operations with our Management Smart - Agritech. This AI-driven solution automates security monitoring with unprecedented accuracy and efficiency.
          </p>
