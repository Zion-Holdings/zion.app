...
export const metadata: Metadata = {
  title: 'Intelligent system-cleantech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent system-cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent system-cleantech. This autonomous system provides language processing with zero manual intervention needed.
          </p>
