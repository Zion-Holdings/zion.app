...
export const metadata: Metadata = {
  title: 'Smart Manufacturing for Energy',
  description: 'Revolutionize energy through intelligent automation. Our Smart Manufacturing for Energy leverages advanced machine learning to deliver inventory management at s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-manufacturing-for-energy-0088c79b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manufacturing for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Smart Manufacturing for Energy leverages advanced machine learning to deliver inventory management at scale.
          </p>
