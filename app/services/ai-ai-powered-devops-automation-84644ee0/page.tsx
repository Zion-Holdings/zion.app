...
export const metadata: Metadata = {
  title: 'AI AI-Powered DevOps Automation',
  description: 'AI-powered ai solution for devops. Automated CI/CD pipelines with intelligent testing and deployment.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-ai-powered-devops-automation-84644ee0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI AI-Powered DevOps Automation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered ai solution for devops. Automated CI/CD pipelines with intelligent testing and deployment.
          </p>
