...
export const metadata: Metadata = {
  title: 'Smart Deep Learning Platform - Agriculture',
  description: 'Next-generation agriculture solution: Smart Deep Learning Platform - Agriculture. Combines document processing with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-deep-learning-platform-agriculture-604bd689',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Deep Learning Platform - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agriculture solution: Smart Deep Learning Platform - Agriculture. Combines document processing with adaptive intelligence for optimal results.
          </p>
