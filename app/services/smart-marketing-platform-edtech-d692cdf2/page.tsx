...
export const metadata: Metadata = {
  title: 'Smart Marketing Platform - EDTECH',
  description: 'Transform your edtech operations with our Smart Marketing Platform - EDTECH. This AI-driven solution automates financial risk management with unprecedented accu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Marketing Platform - EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your edtech operations with our Smart Marketing Platform - EDTECH. This AI-driven solution automates financial risk management with unprecedented accuracy and efficiency.
          </p>
