...
export const metadata: Metadata = {
  title: 'Litigation Support AI-Powered Predictive Analytics Suite',
  description: 'litigation support solution for disaster preparedness industry. End-to-end predictive analytics platform that forecasts market trends, customer behavior, and op',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/litigation-support-ai-powered-predictive-analytics-suite-235dcd8a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Litigation Support AI-Powered Predictive Analytics Suite
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            litigation support solution for disaster preparedness industry. End-to-end predictive analytics platform that forecasts market trends, customer behavior, and operational metrics with 95% accuracy.
          </p>
