...
export const metadata: Metadata = {
  title: 'Smart cloud-retail',
  description: 'Transform your retail operations with our Smart cloud-retail. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-cloud-retail-9b3fb5e6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our Smart cloud-retail. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
