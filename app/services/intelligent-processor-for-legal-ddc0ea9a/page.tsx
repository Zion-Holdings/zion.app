...
export const metadata: Metadata = {
  title: 'Intelligent Processor for Legal',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Processor for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Intelligent Processor for Legal. This AI-powered platform transforms sales process optimization into a competitive advantage.
          </p>
