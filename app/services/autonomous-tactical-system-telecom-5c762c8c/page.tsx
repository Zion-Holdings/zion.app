...
export const metadata: Metadata = {
  title: 'Autonomous Tactical System - Telecom',
  description: 'Quantum leap forward for telecom: Autonomous Tactical System - Telecom. Uses quantum-inspired algorithms to deliver reporting automation at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-tactical-system-telecom-5c762c8c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Tactical System - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for telecom: Autonomous Tactical System - Telecom. Uses quantum-inspired algorithms to deliver reporting automation at exponential speed.
          </p>
