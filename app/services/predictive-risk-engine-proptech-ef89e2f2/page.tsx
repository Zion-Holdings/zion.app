...
export const metadata: Metadata = {
  title: 'Predictive Risk Engine - PROPTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Risk Engine - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your proptech workflows with Predictive Risk Engine - PROPTECH. This intelligent platform delivers business process through advanced automation and AI.
          </p>
