...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-observability--intelligence-02fae2c1",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI Observability & Intelligence - AI-Powered AI Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          AI-driven observability: anomaly detection across metrics/logs/traces, root-cause ranking, SLO burn-rate prediction, and incident summarization for engineering 
        </p>
