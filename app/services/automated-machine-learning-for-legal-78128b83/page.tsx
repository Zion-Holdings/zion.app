...
export const metadata: Metadata = {
  title: 'Automated Machine Learning for Legal',
  description: 'Enhance your legal business with Automated Machine Learning for Legal. Our solution provides financial risk management with enterprise-grade reliability and sec',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-machine-learning-for-legal-78128b83',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Machine Learning for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Automated Machine Learning for Legal. Our solution provides financial risk management with enterprise-grade reliability and security.
          </p>
