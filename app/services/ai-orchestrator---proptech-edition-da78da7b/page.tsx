...
export const metadata: Metadata = {
  title: 'AI Orchestrator - Proptech Edition',
  description: 'Revolutionize proptech through intelligent automation. Our AI Orchestrator - Proptech Edition leverages advanced machine learning to deliver quality control at ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-orchestrator---proptech-edition-da78da7b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Orchestrator - Proptech Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our AI Orchestrator - Proptech Edition leverages advanced machine learning to deliver quality control at scale.
          </p>
