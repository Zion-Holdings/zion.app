...
export const metadata: Metadata = {
  title: 'AI/IT Experience Suite - Automotive',
  description: 'Optimize your automotive workflows with AI/IT Experience Suite - Automotive. This intelligent platform delivers performance reviews through advanced automation ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-experience-suite-automotive-fca2185b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Experience Suite - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your automotive workflows with AI/IT Experience Suite - Automotive. This intelligent platform delivers performance reviews through advanced automation and AI.
          </p>
