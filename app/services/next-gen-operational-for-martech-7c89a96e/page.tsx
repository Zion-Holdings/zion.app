...
export const metadata: Metadata = {
  title: 'Next-Gen Operational for MARTECH',
  description: 'Enhance your martech business with Next-Gen Operational for MARTECH. Our solution provides leave management with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-operational-for-martech-7c89a96e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Operational for MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your martech business with Next-Gen Operational for MARTECH. Our solution provides leave management with enterprise-grade reliability and security.
          </p>
