...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Machine Learning - Cybersecurity',
  description: 'Enhance your cybersecurity business with Hyper-Accelerated Machine Learning - Cybersecurity. Our solution provides travel management with enterprise-grade relia',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Machine Learning - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your cybersecurity business with Hyper-Accelerated Machine Learning - Cybersecurity. Our solution provides travel management with enterprise-grade reliability and security.
          </p>
