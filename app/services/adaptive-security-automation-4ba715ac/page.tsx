...
export const metadata: Metadata = {
  title: 'Adaptive Security Automation',
  description: 'Next-generation agritech solution: Adaptive Security Automation. Combines document processing with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-security-automation-4ba715ac',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agritech solution: Adaptive Security Automation. Combines document processing with adaptive intelligence for optimal results.
          </p>
