...
export const metadata: Metadata = {
  title: 'Smart Customer Service Blockchain (It)',
  description: 'Smart Customer Service Blockchain (It) is an AI-powered it solution that transforms how businesses operate through intelligent automation and real-time analytic',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-customer-service-blockch-77686f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Customer Service Blockchain (It)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Smart Customer Service Blockchain (It) is an AI-powered it solution that transforms how businesses operate through intelligent automation and real-time analytics.
...
Go, Fastify, IoT, Serverless, Vue.js, Kafka
