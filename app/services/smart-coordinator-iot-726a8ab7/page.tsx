...
export const metadata: Metadata = {
  title: 'Smart coordinator-iot',
  description: 'Next-generation iot solution: Smart coordinator-iot. Combines content generation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-coordinator-iot-726a8ab7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart coordinator-iot
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation iot solution: Smart coordinator-iot. Combines content generation with adaptive intelligence for optimal results.
          </p>
