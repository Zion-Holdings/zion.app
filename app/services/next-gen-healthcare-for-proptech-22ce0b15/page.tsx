...
export const metadata: Metadata = {
  title: 'Next-Gen Healthcare for PROPTECH',
  description: 'Revolutionize proptech through intelligent automation. Our Next-Gen Healthcare for PROPTECH leverages advanced machine learning to deliver influencer identifica',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-healthcare-for-proptech-22ce0b15',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Healthcare for PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our Next-Gen Healthcare for PROPTECH leverages advanced machine learning to deliver influencer identification at scale.
          </p>
