...
export const metadata: Metadata = {
  title: 'Intelligent Financial for PROPTECH',
  description: 'Unlock unprecedented growth with Intelligent Financial for PROPTECH. This autonomous system provides quality control with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-financial-for-proptech-212bd7a4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Financial for PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Financial for PROPTECH. This autonomous system provides quality control with zero manual intervention needed.
          </p>
