...
export const metadata: Metadata = {
  ...
  description: 'Enhance your healthcare business with Cognitive Cognitive Solution - Healthcare. Our solution provides project portfolio with enterprise-grade reliability and s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-cognitive-solution-healthcare-5b4c0a52',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with Cognitive Cognitive Solution - Healthcare. Our solution provides project portfolio with enterprise-grade reliability and security.
          </p>
