...
export const metadata: Metadata = {
  title: 'Smart Cloud Migration GCP (Customer)',
  description: 'Smart Cloud Migration GCP (Customer) is an AI-powered customer solution that transforms how businesses operate through intelligent automation and real-time anal',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Cloud Migration GCP (Customer)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Smart Cloud Migration GCP (Customer) is an AI-powered customer solution that transforms how businesses operate through intelligent automation and real-time analytics.
