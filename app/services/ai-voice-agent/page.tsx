...
export const metadata: Metadata = {
  ...
  keywords: 'Natural language understanding (NLU), Real-time speech synthesis & recognition, Call routing & handoff to humans, CRM integration (auto-log calls), Compliance recording & transcription, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Voice Agent (Phone)</h1>
        <p className="text-lg text-slate-300 mb-8">Human-like conversational AI for phone calls: inbound customer service, outbound sales calls, appointment scheduling, and support ticket creation.</p>
        ...
        <li class="text-slate-300">Natural language understanding (NLU)</li>
        <li class="text-slate-300">Real-time speech synthesis &amp; recognition</li>
        <li class="text-slate-300">Call routing &amp; handoff to humans</li>
        <li class="text-slate-300">CRM integration (auto-log calls)</li>
        <li class="text-slate-300">Compliance recording &amp; transcription</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai voice agent (phone)</li>
