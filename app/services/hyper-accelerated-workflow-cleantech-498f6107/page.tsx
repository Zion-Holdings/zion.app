...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Workflow - CLEANTECH',
  description: 'Optimize your cleantech workflows with Hyper-Accelerated Workflow - CLEANTECH. This intelligent platform delivers customer insights through advanced automation ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Workflow - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your cleantech workflows with Hyper-Accelerated Workflow - CLEANTECH. This intelligent platform delivers customer insights through advanced automation and AI.
          </p>
