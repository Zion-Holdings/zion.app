...
export const metadata: Metadata = {
  title: 'Next-Gen Management for REGTECH',
  description: 'Revolutionize regtech through intelligent automation. Our Next-Gen Management for REGTECH leverages advanced machine learning to deliver training optimization a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-management-for-regtech-9c58d8bc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Management for REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize regtech through intelligent automation. Our Next-Gen Management for REGTECH leverages advanced machine learning to deliver training optimization at scale.
          </p>
