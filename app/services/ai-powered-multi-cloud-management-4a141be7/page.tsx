...
export const metadata: Metadata = {
  ...
  description: 'Unified multi-cloud management with policy enforcement and cost optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-multi-cloud-management-4a141be7',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Unified multi-cloud management with policy enforcement and cost optimization.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your multi-cloud operations?</p>
