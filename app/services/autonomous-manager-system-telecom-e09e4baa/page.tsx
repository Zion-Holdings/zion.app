...
export const metadata: Metadata = {
  title: 'Autonomous Manager System - Telecom',
  description: 'The future of telecom is here with Autonomous Manager System - Telecom. Powered by cutting-edge AI, this platform delivers supply chain like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-manager-system-telecom-e09e4baa',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Manager System - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of telecom is here with Autonomous Manager System - Telecom. Powered by cutting-edge AI, this platform delivers supply chain like never before.
          </p>
