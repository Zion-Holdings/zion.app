...
export const metadata: Metadata = {
  title: 'Smart Financial Platform - Legal',
  description: 'Transform your legal operations with our Smart Financial Platform - Legal. This AI-driven solution automates form processing with unprecedented accuracy and eff',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-financial-platform-legal-7d6aa314',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Financial Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Smart Financial Platform - Legal. This AI-driven solution automates form processing with unprecedented accuracy and efficiency.
          </p>
