...
export const metadata: Metadata = {
  ...
  description: 'Optimize your agriculture workflows with Autonomous AI System - Agriculture. This intelligent platform delivers sales process optimization through advanced auto',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-ai-system-agriculture-9bddd0d1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your agriculture workflows with Autonomous AI System - Agriculture. This intelligent platform delivers sales process optimization through advanced automation and AI.
          </p>
