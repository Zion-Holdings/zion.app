...
export const metadata: Metadata = {
  title: 'Optimization Cloud-Native - Construction',
  description: 'Optimize your construction workflows with Optimization Cloud-Native - Construction. This intelligent platform delivers executive dashboards through advanced aut',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Optimization Cloud-Native - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Optimization Cloud-Native - Construction. This intelligent platform delivers executive dashboards through advanced automation and AI.
          </p>
