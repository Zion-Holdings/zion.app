...
export const metadata: Metadata = {
  title: 'Predictive Intelligence Engine - Hospitality',
  description: 'Next-generation hospitality solution: Predictive Intelligence Engine - Hospitality. Combines business intelligence with adaptive intelligence for optimal result',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Intelligence Engine - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Predictive Intelligence Engine - Hospitality. Combines business intelligence with adaptive intelligence for optimal results.
          </p>
