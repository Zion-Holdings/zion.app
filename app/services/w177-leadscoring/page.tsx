...
export const metadata: Metadata = {
  ...
  keywords: 'Behavioral and firmographic scoring, Ideal customer profile identification, Score decay over time, CRM sync with score visibility, Score explanation and factor breakdown, A/B test scoring models, Integration with Salesforce, HubSpot, Pipedrive, micro-saas, Sales, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">LeadScore — Predictive Lead Scoring</h1>
        <p className="text-lg text-slate-300 mb-8">AI lead scoring: behavioral and firmographic data, predict conversion likelihood, prioritize sales effort.</p>
        ...
        <li class="text-slate-300">Behavioral and firmographic scoring</li>
        <li class="text-slate-300">Ideal customer profile identification</li>
        <li class="text-slate-300">Score decay over time</li>
        <li class="text-slate-300">CRM sync with score visibility</li>
        <li class="text-slate-300">Score explanation and factor breakdown</li>
        <li class="text-slate-300">A/B test scoring models</li>
        <li class="text-slate-300">Integration with Salesforce</li>
        <li class="text-slate-300">HubSpot</li>
        <li class="text-slate-300">Pipedrive</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Prioritize leads most likely to convert</li>
        <li class="text-slate-300">ICP identification improves targeting</li>
        <li class="text-slate-300">Score decay ensures freshness</li>
        <li class="text-slate-300">Explanation builds sales trust in scores</li>
      </ul>
        </div>
