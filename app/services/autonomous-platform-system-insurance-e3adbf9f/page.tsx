...
export const metadata: Metadata = {
  title: 'Autonomous Platform System - Insurance',
  description: 'The future of insurance is here with Autonomous Platform System - Insurance. Powered by cutting-edge AI, this platform delivers forecast accuracy like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-platform-system-insurance-e3adbf9f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Platform System - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Autonomous Platform System - Insurance. Powered by cutting-edge AI, this platform delivers forecast accuracy like never before.
          </p>
