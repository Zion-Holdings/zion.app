...
export const metadata: Metadata = {
  title: 'SQLite AI-Powered Edge AI Platform',
  description: 'AI-powered sqlite solution for iot. Deploys and manages AI models at the edge with automatic optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/sqlite-ai-powered-edge-ai-platform-12e5bd17',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            SQLite AI-Powered Edge AI Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered sqlite solution for iot. Deploys and manages AI models at the edge with automatic optimization.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your sqlite operations?</p>
