...
export const metadata: Metadata = {
  title: 'Smart Advisor Suite - Agriculture',
  description: 'Transform your agriculture operations with our Smart Advisor Suite - Agriculture. This AI-driven solution automates sourcing optimization with unprecedented acc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-advisor-suite-agriculture-5f350ec1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Advisor Suite - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Smart Advisor Suite - Agriculture. This AI-driven solution automates sourcing optimization with unprecedented accuracy and efficiency.
          </p>
