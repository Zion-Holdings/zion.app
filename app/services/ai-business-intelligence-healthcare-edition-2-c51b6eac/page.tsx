...
export const metadata: Metadata = {
  title: 'AI Business Intelligence - Healthcare Edition #2',
  description: 'Drive innovation in healthcare with AI Business Intelligence - Healthcare Edition #2. This AI-powered platform transforms sourcing optimization into a competiti',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-business-intelligence-healthcare-edition-2-c51b6eac',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Business Intelligence - Healthcare Edition #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with AI Business Intelligence - Healthcare Edition #2. This AI-powered platform transforms sourcing optimization into a competitive advantage.
          </p>
