export const metadata = {
  title: "Conversational AI for Media",
  description: "Zion Tech Group delivers Conversational AI for Media with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/services/conversational-ai-for-media-296f61d2/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>Conversational AI for Media</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers Conversational AI for Media with measurable outcomes.
      </p>
