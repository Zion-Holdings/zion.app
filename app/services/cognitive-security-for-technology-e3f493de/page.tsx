...
export const metadata: Metadata = {
  title: 'Cognitive Security for Technology',
  description: 'The future of technology is here with Cognitive Security for Technology. Powered by cutting-edge AI, this platform delivers document processing like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-security-for-technology-e3f493de',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Security for Technology
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of technology is here with Cognitive Security for Technology. Powered by cutting-edge AI, this platform delivers document processing like never before.
          </p>
