...
export const metadata: Metadata = {
  title: 'Next-Gen Session - Telecom',
  description: 'Optimize your telecom workflows with Next-Gen Session - Telecom. This intelligent platform delivers ml model training through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-session-telecom-fe82d1e9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Session - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your telecom workflows with Next-Gen Session - Telecom. This intelligent platform delivers ml model training through advanced automation and AI.
          </p>
