...
export const metadata: Metadata = {
  title: 'Cognitive Cognitive Solution - Construction',
  description: 'Enhance your construction business with Cognitive Cognitive Solution - Construction. Our solution provides territory management with enterprise-grade reliabilit',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-cognitive-solution-construction-e0d28b9f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Cognitive Solution - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Cognitive Cognitive Solution - Construction. Our solution provides territory management with enterprise-grade reliability and security.
          </p>
