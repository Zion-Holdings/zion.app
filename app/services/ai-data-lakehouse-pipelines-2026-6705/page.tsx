...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "AI Data Lakehouse Pipelines | Zion Tech Group", description: "End-to-end ai data lakehouse pipelines services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/ai-data-lakehouse-pipelines-2026-6705/}} />
