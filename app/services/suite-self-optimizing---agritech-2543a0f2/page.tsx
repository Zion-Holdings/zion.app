...
export const metadata: Metadata = {
  title: 'Suite Self-Optimizing - Agritech',
  description: 'Next-generation agritech solution: Suite Self-Optimizing - Agritech. Combines maintenance scheduling with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/suite-self-optimizing---agritech-2543a0f2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Suite Self-Optimizing - Agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agritech solution: Suite Self-Optimizing - Agritech. Combines maintenance scheduling with adaptive intelligence for optimal results.
          </p>
