...
export const metadata: Metadata = {
  title: 'Intelligent Suite for Hospitality #1',
  description: 'Transform your hospitality operations with our Intelligent Suite for Hospitality #1. This AI-driven solution automates survey automation with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-suite-for-hospitality-1-66072077',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Suite for Hospitality #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Intelligent Suite for Hospitality #1. This AI-driven solution automates survey automation with unprecedented accuracy and efficiency.
          </p>
