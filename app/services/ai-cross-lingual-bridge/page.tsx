...
export const metadata: Metadata = {
  ...
  keywords: 'Semantic translation engine (80+ language pairs, trains on in-domain corpus), Accent-normalised speech-to-text and TTS per locale, Auto language/region detection with confidence scoring, Webhook-ready multilingual chatbot builder, CSV/XLIFF glossary import + compliance glossary lock, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Cross-Lingual Bridge</h1>
        <p className="text-lg text-slate-300 mb-8">Enterprise-grade cross-language content and support platform: semantic translation, accent-normalised speech, multilingual chatbot/knowledge base build, automatic locale detection, and compliance-checked glossary management across 80+ language pairs.</p>
        ...
        <li class="text-slate-300">Semantic translation engine (80+ language pairs, trains on in-domain corpus)</li>
        <li class="text-slate-300">Accent-normalised speech-to-text and TTS per locale</li>
        <li class="text-slate-300">Auto language/region detection with confidence scoring</li>
        <li class="text-slate-300">Webhook-ready multilingual chatbot builder</li>
        <li class="text-slate-300">CSV/XLIFF glossary import + compliance glossary lock</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai cross-lingual bridge</li>
