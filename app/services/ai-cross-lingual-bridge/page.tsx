      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Semantic translation engine (80+ language pairs, trains on in-domain corpus)</li>
            <li className="text-purple-300">✓ Accent-normalised speech-to-text and TTS per locale</li>
            <li className="text-purple-300">✓ Auto language/region detection with confidence scoring</li>
            <li className="text-purple-300">✓ Webhook-ready multilingual chatbot builder</li>
            <li className="text-purple-300">✓ CSV/XLIFF glossary import + compliance glossary lock</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai cross-lingual bridge</li>
