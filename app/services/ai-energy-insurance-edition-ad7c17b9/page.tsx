...
export const metadata: Metadata = {
  title: 'AI Energy - Insurance Edition',
  description: 'Drive innovation in insurance with AI Energy - Insurance Edition. This AI-powered platform transforms access management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-energy-insurance-edition-ad7c17b9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Energy - Insurance Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with AI Energy - Insurance Edition. This AI-powered platform transforms access management into a competitive advantage.
          </p>
