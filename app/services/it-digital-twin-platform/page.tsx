...
export const metadata: Metadata = {
  ...
  keywords: '3D digital twin modeling and visualization, Real-time IoT sensor data ingestion and mapping, Predictive simulation and what-if scenario analysis, Integration with CAD, BIM, and ERP systems, Automated alerts and anomaly detection, automation, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Digital Twin &amp; IoT Platform Development</h1>
        <p className="text-lg text-slate-300 mb-8">Build real-time digital replicas of physical systems — factory floors, supply chains, and smart cities with predictive simulation and optimization capabilities.</p>
        ...
        <li class="text-slate-300">3D digital twin modeling and visualization</li>
        <li class="text-slate-300">Real-time IoT sensor data ingestion and mapping</li>
        <li class="text-slate-300">Predictive simulation and what-if scenario analysis</li>
        <li class="text-slate-300">Integration with CAD, BIM, and ERP systems</li>
        <li class="text-slate-300">Automated alerts and anomaly detection</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with digital twin &amp; iot platform development</li>
