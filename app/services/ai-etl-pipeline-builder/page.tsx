...
export const metadata: Metadata = {
  ...
  keywords: 'NL to ETL: dbt/Glue/Dataflow, Auto-generated transform tests + documentation, Schema mapping + type coercion per column, Schedule + alert (Airflow/Step/Cloud Scheduler), CLI + UI — iterate pipeline in minutes, data, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI ETL Pipeline Builder</h1>
        <p className="text-lg text-slate-300 mb-8">Natural language ETL builder: describe source, target, transformation — AI generates production-ready dbt/Glue/Dataflow pipeline. Auto-tests, docs, type-map.</p>
        ...
        <li class="text-slate-300">NL to ETL: dbt/Glue/Dataflow</li>
        <li class="text-slate-300">Auto-generated transform tests + documentation</li>
        <li class="text-slate-300">Schema mapping + type coercion per column</li>
        <li class="text-slate-300">Schedule + alert (Airflow/Step/Cloud Scheduler)</li>
        <li class="text-slate-300">CLI + UI — iterate pipeline in minutes</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai etl pipeline builder</li>
