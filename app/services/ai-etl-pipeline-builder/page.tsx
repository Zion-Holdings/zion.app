      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ NL to ETL: dbt/Glue/Dataflow</li>
            <li className="text-purple-300">✓ Auto-generated transform tests + documentation</li>
            <li className="text-purple-300">✓ Schema mapping + type coercion per column</li>
            <li className="text-purple-300">✓ Schedule + alert (Airflow/Step/Cloud Scheduler)</li>
            <li className="text-purple-300">✓ CLI + UI — iterate pipeline in minutes</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai etl pipeline builder</li>
