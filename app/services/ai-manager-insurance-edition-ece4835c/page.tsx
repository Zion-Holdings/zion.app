...
export const metadata: Metadata = {
  title: 'AI Manager - Insurance Edition',
  description: 'Enhance your insurance business with AI Manager - Insurance Edition. Our solution provides sales process optimization with enterprise-grade reliability and secu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-manager-insurance-edition-ece4835c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Manager - Insurance Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with AI Manager - Insurance Edition. Our solution provides sales process optimization with enterprise-grade reliability and security.
          </p>
