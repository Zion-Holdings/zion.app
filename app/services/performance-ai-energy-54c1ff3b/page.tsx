...
export const metadata: Metadata = {
  title: 'Performance AI - Energy',
  description: 'Next-generation energy solution: Performance AI - Energy. Combines net promoter score with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/performance-ai-energy-54c1ff3b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Performance AI - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Performance AI - Energy. Combines net promoter score with adaptive intelligence for optimal results.
          </p>
