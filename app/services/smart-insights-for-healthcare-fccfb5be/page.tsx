...
export const metadata: Metadata = {
  title: 'Smart Insights for Healthcare',
  description: 'Next-generation healthcare solution: Smart Insights for Healthcare. Combines compliance monitoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-insights-for-healthcare-fccfb5be',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Insights for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Smart Insights for Healthcare. Combines compliance monitoring with adaptive intelligence for optimal results.
          </p>
