...
export const metadata: Metadata = {
  ...
  keywords: 'IoT sensor processing, Failure prediction, Anomaly detection, Maintenance scheduling, Root cause analysis, Digital twin integration, ai-services, manufacturing-industrial, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">IoT sensor analysis with ML failure prediction. Reduces unplanned downtime by 73% and extends equipment life.</p>
        ...
        <li class="text-slate-300">IoT sensor processing</li>
        <li class="text-slate-300">Failure prediction</li>
        <li class="text-slate-300">Anomaly detection</li>
        <li class="text-slate-300">Maintenance scheduling</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">73% less downtime</li>
        <li class="text-slate-300">Extended equipment life</li>
        <li class="text-slate-300">Optimized maintenance costs</li>
        <li class="text-slate-300">Improved safety</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900/60 border border-slate-700/50 rounded-xl p-6 mb-8">
          ...
          <div class="grid md:grid-cols-2 gap-4">
              ...
              <div>
                <a href="/services/w129-digital-twin/" class="text-purple-300 hover:text-purple-200 font-medium">Manufacturing Digital Twin Platform</a>
                <p class="text-slate-400 text-sm mt-1">Process simulation, optimization, and what-if analysis. Reduces operational costs by 25% through predictive modeling....</p>
              </div>
