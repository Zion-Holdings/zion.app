...
export const metadata: Metadata = {
  ...
  keywords: 'Clause extraction, Risk assessment, Obligation tracking, Deviation analysis, Contract summarization, Redline comparison, Approval workflows, Compliance checking, ai, Legal, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Legal AI Contract Analysis</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered contract review, analysis, and management. Clause extraction, risk assessment, obligation tracking, and deviation analysis for legal teams.</p>
        ...
        <li class="text-slate-300">Deviation analysis</li>
        <li class="text-slate-300">Contract summarization</li>
        <li class="text-slate-300">Redline comparison</li>
        <li class="text-slate-300">Approval workflows</li>
        <li class="text-slate-300">Compliance checking</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">80% faster contract review</li>
        <li class="text-slate-300">Risk identification</li>
        <li class="text-slate-300">Obligation tracking</li>
        <li class="text-slate-300">Compliance monitoring</li>
        <li class="text-slate-300">Legal team efficiency</li>
      </ul>
        </div>
