...
export const metadata: Metadata = {
  title: 'Autonomous Customer Service System - FINTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Customer Service System - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation fintech solution: Autonomous Customer Service System - FINTECH. Combines payroll processing with adaptive intelligence for optimal results.
          </p>
