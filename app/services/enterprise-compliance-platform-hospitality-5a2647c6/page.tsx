...
export const metadata: Metadata = {
  title: 'Enterprise Compliance Platform - Hospitality',
  description: 'Hyper-accelerated hospitality solution: Enterprise Compliance Platform - Hospitality. Combines campaign optimization with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-compliance-platform-hospitality-5a2647c6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Compliance Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated hospitality solution: Enterprise Compliance Platform - Hospitality. Combines campaign optimization with next-gen AI for maximum velocity.
          </p>
