...
export const metadata = {
  ...
  description: "Summarize and analyze long documents: research papers, legal filings, financial reports, and technical docs. Multi-level summaries, key insight extraction, and ",
  alternates: {
