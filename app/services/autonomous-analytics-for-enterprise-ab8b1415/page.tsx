...
export const metadata: Metadata = {
  title: 'Autonomous Analytics for Enterprise',
  description: 'Future-proof your enterprise with Autonomous Analytics for Enterprise. Our autonomous solution handles social media monitoring end-to-end without human interven',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Analytics for Enterprise
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your enterprise with Autonomous Analytics for Enterprise. Our autonomous solution handles social media monitoring end-to-end without human intervention.
          </p>
