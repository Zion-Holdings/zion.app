...
export const metadata: Metadata = {
  ...
  keywords: 'Async standup collection (text, video, voice), AI-generated standup summaries, Blocker and dependency tracking, Timezone-aware scheduling, Historical search and analytics, Slack, Teams, and email integration, Team health and engagement metrics, micro-saas, Productivity, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">RemoteBoard — Async Standup Tool</h1>
        <p className="text-lg text-slate-300 mb-8">Async daily standups and team updates for remote teams. Text, video, or voice check-ins with AI summaries, blockers tracking, and Slack/Teams integration.</p>
        ...
        <li class="text-slate-300">Async standup collection (text, video, voice)</li>
        <li class="text-slate-300">AI-generated standup summaries</li>
        <li class="text-slate-300">Blocker and dependency tracking</li>
        <li class="text-slate-300">Timezone-aware scheduling</li>
        <li class="text-slate-300">Historical search and analytics</li>
        <li class="text-slate-300">Slack, Teams, and email integration</li>
        <li class="text-slate-300">Team health and engagement metrics</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">No more scheduling standups across timezones</li>
        <li class="text-slate-300">AI summaries save leadership reading time</li>
        <li class="text-slate-300">Blockers surface automatically</li>
        <li class="text-slate-300">Team health metrics reveal burnout early</li>
      </ul>
        </div>
