...
export const metadata: Metadata = {
  title: 'Automated real estate-logistics',
  description: 'The future of logistics is here with Automated real estate-logistics. Powered by cutting-edge AI, this platform delivers predictive analytics like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-real-estate-logistics-002db153',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated real estate-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Automated real estate-logistics. Powered by cutting-edge AI, this platform delivers predictive analytics like never before.
          </p>
