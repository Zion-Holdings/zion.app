...
export const metadata: Metadata = {
  title: 'Autonomous Decision System - REGTECH',
  description: 'Drive innovation in regtech with Autonomous Decision System - REGTECH. This AI-powered platform transforms neural architecture into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-decision-system-regtech-5c916ad2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Decision System - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in regtech with Autonomous Decision System - REGTECH. This AI-powered platform transforms neural architecture into a competitive advantage.
          </p>
