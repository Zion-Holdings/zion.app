...
export const metadata: Metadata = {
  title: 'Smart Risk Platform - Agriculture',
  description: 'Optimize your agriculture workflows with Smart Risk Platform - Agriculture. This intelligent platform delivers procurement automation through advanced automatio',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-risk-platform-agriculture-5b91e76a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Risk Platform - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your agriculture workflows with Smart Risk Platform - Agriculture. This intelligent platform delivers procurement automation through advanced automation and AI.
          </p>
