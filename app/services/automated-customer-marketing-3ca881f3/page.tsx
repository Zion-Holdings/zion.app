...
export const metadata: Metadata = {
  title: 'Automated Customer Marketing',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Automated Customer Marketing. This AI-powered platform transforms threat detection into a competitive advantage.
          </p>
