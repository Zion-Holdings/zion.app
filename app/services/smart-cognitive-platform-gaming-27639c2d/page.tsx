...
export const metadata: Metadata = {
  title: 'Smart Cognitive Platform - Gaming',
  description: 'Next-generation gaming solution: Smart Cognitive Platform - Gaming. Combines healthcare data analytics with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-cognitive-platform-gaming-27639c2d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Cognitive Platform - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation gaming solution: Smart Cognitive Platform - Gaming. Combines healthcare data analytics with adaptive intelligence for optimal results.
          </p>
