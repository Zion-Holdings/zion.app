...
export const metadata: Metadata = {
  title: 'System Neural - Proptech',
  description: 'Next-generation proptech solution: System Neural - Proptech. Combines customer insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/system-neural---proptech-8883f809',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            System Neural - Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation proptech solution: System Neural - Proptech. Combines customer insights with adaptive intelligence for optimal results.
          </p>
