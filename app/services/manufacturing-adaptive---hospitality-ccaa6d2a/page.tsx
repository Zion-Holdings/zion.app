...
export const metadata: Metadata = {
  title: 'Manufacturing Adaptive - Hospitality',
  description: 'Next-generation hospitality solution: Manufacturing Adaptive - Hospitality. Combines financial risk management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/manufacturing-adaptive---hospitality-ccaa6d2a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manufacturing Adaptive - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Manufacturing Adaptive - Hospitality. Combines financial risk management with adaptive intelligence for optimal results.
          </p>
