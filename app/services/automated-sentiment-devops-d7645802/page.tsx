...
export const metadata: Metadata = {
  title: 'Automated Sentiment DevOps',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Sentiment DevOps
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your telecom workflows with Automated Sentiment DevOps. This intelligent platform delivers compliance monitoring through advanced automation and AI.
          </p>
