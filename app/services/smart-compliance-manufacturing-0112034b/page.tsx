...
export const metadata: Metadata = {
  title: 'Smart Compliance Manufacturing',
  description: 'Revolutionize sports through intelligent automation. Our Smart Compliance Manufacturing leverages advanced machine learning to deliver financial planning at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Compliance Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Smart Compliance Manufacturing leverages advanced machine learning to deliver financial planning at scale.
          </p>
