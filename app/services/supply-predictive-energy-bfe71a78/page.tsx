...
export const metadata: Metadata = {
  title: 'Supply Predictive - Energy',
  description: 'Drive innovation in energy with Supply Predictive - Energy. This AI-powered platform transforms scenario planning into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/supply-predictive-energy-bfe71a78',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Supply Predictive - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Supply Predictive - Energy. This AI-powered platform transforms scenario planning into a competitive advantage.
          </p>
