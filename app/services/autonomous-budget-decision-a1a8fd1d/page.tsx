...
export const metadata: Metadata = {
  title: 'Autonomous Budget Decision',
  description: 'Enhance your healthcare business with Autonomous Budget Decision. Our solution provides case management with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-budget-decision-a1a8fd1d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Budget Decision
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with Autonomous Budget Decision. Our solution provides case management with enterprise-grade reliability and security.
          </p>
