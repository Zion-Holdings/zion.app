...
export const metadata: Metadata = {
  title: 'Smart Customer Sales',
  description: 'Next-generation logistics solution: Smart Customer Sales. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-customer-sales-8bcfc93c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Customer Sales
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Smart Customer Sales. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
