...
export const metadata: Metadata = {
  title: 'Cognitive Supply Solution - Logistics #1',
  description: 'Next-generation logistics solution: Cognitive Supply Solution - Logistics #1. Combines contract analysis with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-supply-solution-logistics-1-d00dbf6a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Supply Solution - Logistics #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Cognitive Supply Solution - Logistics #1. Combines contract analysis with adaptive intelligence for optimal results.
          </p>
