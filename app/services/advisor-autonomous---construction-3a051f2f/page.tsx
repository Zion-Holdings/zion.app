...
export const metadata: Metadata = {
  ...
  keywords: 'Edge computing support, SOC 2 certified, GDPR compliance, Custom integrations, Offline capabilities, analyzer, construction, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Advisor Autonomous - Construction</h1>
        <p className="text-lg text-slate-300 mb-8">Transform your construction operations with our Advisor Autonomous - Construction. This AI-driven solution automates workflow management with unprecedented accuracy and efficiency.</p>
