...
export const metadata: Metadata = {
  ...
  keywords: 'Comprehensive cloud spend audit & waste elimination, Reserved instance & savings plan optimization, Workload right-sizing recommendations, Multi-cloud support (AWS, Azure, GCP), Tagging governance & cost allocation, Automated anomaly detection on spend spikes, FinOps maturity assessment & roadmap, Executive reporting with unit economics, cloud, Cloud Infrastructure, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cloud Cost Optimization Consulting</h1>
        <p className="text-lg text-slate-300 mb-8">FinOps-led cloud spend management that delivers guaranteed savings. Right-sizes workloads, optimizes reserved instance and savings plan coverage, eliminates waste, and implements governance — typically reducing cloud spend by 25-40%.</p>
        ...
        <li class="text-slate-300">Comprehensive cloud spend audit &amp; waste elimination</li>
        <li class="text-slate-300">Reserved instance &amp; savings plan optimization</li>
        <li class="text-slate-300">Workload right-sizing recommendations</li>
        <li class="text-slate-300">Multi-cloud support (AWS, Azure, GCP)</li>
        <li class="text-slate-300">Tagging governance &amp; cost allocation</li>
        <li class="text-slate-300">Automated anomaly detection on spend spikes</li>
        <li class="text-slate-300">FinOps maturity assessment &amp; roadmap</li>
        <li class="text-slate-300">Executive reporting with unit economics</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">25-40% cloud spend reduction, guaranteed</li>
        <li class="text-slate-300">Unit economics visibility per product/team</li>
        <li class="text-slate-300">Prevent cost anomalies before they escalate</li>
        <li class="text-slate-300">FinOps cultural transformation, not just tools</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">8997</p>
              <p class="text-sm text-slate-400">Most popular</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              <h3 class="font-semibold text-white mb-2">Enterprise</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">18997</p>
