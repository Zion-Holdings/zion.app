      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Cognitive Security Solution - Energy. This AI-powered platform transforms resource optimization into a competitive advantage.
          </p>
