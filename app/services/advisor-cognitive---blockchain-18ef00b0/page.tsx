...
export const metadata: Metadata = {
  title: 'Advisor Cognitive - Blockchain',
  description: 'Next-generation blockchain solution: Advisor Cognitive - Blockchain. Combines supply chain with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/advisor-cognitive---blockchain-18ef00b0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Advisor Cognitive - Blockchain
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation blockchain solution: Advisor Cognitive - Blockchain. Combines supply chain with adaptive intelligence for optimal results.
          </p>
