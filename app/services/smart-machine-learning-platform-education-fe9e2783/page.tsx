...
export const metadata: Metadata = {
  title: 'Smart Machine Learning Platform - Education',
  description: 'The future of education is here with Smart Machine Learning Platform - Education. Powered by cutting-edge AI, this platform delivers master data management like',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-machine-learning-platform-education-fe9e2783',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Machine Learning Platform - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of education is here with Smart Machine Learning Platform - Education. Powered by cutting-edge AI, this platform delivers master data management like never before.
          </p>
