      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Deep analytics for email newsletters: which topics drive opens, optimal send times, subscriber churn prediction, and A/B headline wire-frame suggestions.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Open-rate and click prediction</li>
            <li className="text-purple-300">✓ Churn alerting by subscriber cohort</li>
            <li className="text-purple-300">✓ Topic performance clustering</li>
            <li className="text-purple-300">✓ A/B headline suggestion engine</li>
            <li className="text-purple-300">✓ Subscriber segmentation builder</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai newsletter engagement analyser</li>
