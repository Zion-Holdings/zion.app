...
export const metadata: Metadata = {
  ...
  keywords: 'Open-rate and click prediction, Churn alerting by subscriber cohort, Topic performance clustering, A/B headline suggestion engine, Subscriber segmentation builder, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Newsletter Engagement Analyser</h1>
        <p className="text-lg text-slate-300 mb-8">Deep analytics for email newsletters: which topics drive opens, optimal send times, subscriber churn prediction, and A/B headline wire-frame suggestions.</p>
        ...
        <li class="text-slate-300">Open-rate and click prediction</li>
        <li class="text-slate-300">Churn alerting by subscriber cohort</li>
        <li class="text-slate-300">Topic performance clustering</li>
        <li class="text-slate-300">A/B headline suggestion engine</li>
        <li class="text-slate-300">Subscriber segmentation builder</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai newsletter engagement analyser</li>
