...
export const metadata: Metadata = {
  title: 'Autonomous Cloud for Logistics',
  description: 'Transform your logistics operations with our Autonomous Cloud for Logistics. This AI-driven solution automates workflow management with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-cloud-for-logistics-0d9d3696',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Cloud for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Autonomous Cloud for Logistics. This AI-driven solution automates workflow management with unprecedented accuracy and efficiency.
          </p>
