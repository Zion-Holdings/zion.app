...
export const metadata: Metadata = {
  title: 'Enterprise Financial Platform - Real-Estate',
  description: 'Optimize your real-estate workflows with Enterprise Financial Platform - Real-Estate. This intelligent platform delivers compliance automation through advanced ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-financial-platform-real-estate-f02debc2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Financial Platform - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your real-estate workflows with Enterprise Financial Platform - Real-Estate. This intelligent platform delivers compliance automation through advanced automation and AI.
          </p>
