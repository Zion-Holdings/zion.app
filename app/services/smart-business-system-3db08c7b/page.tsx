...
export const metadata: Metadata = {
  ...
  description: 'Next-generation gaming solution: Smart Business System. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-business-system-3db08c7b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation gaming solution: Smart Business System. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
