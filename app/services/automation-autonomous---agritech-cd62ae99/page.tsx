...
export const metadata: Metadata = {
  title: 'Automation Autonomous - Agritech',
  description: 'Revolutionize agritech through intelligent automation. Our Automation Autonomous - Agritech leverages advanced machine learning to deliver code optimization at ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automation-autonomous---agritech-cd62ae99',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automation Autonomous - Agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agritech through intelligent automation. Our Automation Autonomous - Agritech leverages advanced machine learning to deliver code optimization at scale.
          </p>
