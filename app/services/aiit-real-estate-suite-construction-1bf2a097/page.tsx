...
export const metadata: Metadata = {
  title: 'AI/IT Real Estate Suite - Construction',
  description: 'Quantum leap forward for construction: AI/IT Real Estate Suite - Construction. Uses quantum-inspired algorithms to deliver maintenance scheduling at exponential',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Real Estate Suite - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for construction: AI/IT Real Estate Suite - Construction. Uses quantum-inspired algorithms to deliver maintenance scheduling at exponential speed.
          </p>
