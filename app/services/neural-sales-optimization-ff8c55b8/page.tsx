...
export const metadata: Metadata = {
  title: 'Neural Sales Optimization',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Sales Optimization
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize iot through intelligent automation. Our Neural Sales Optimization leverages advanced machine learning to deliver maintenance scheduling at scale.
          </p>
