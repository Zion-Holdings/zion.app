...
export const metadata: Metadata = {
  title: 'AI-Powered decision-transportation',
  description: 'Quantum leap forward for transportation: AI-Powered decision-transportation. Uses quantum-inspired algorithms to deliver capacity management at exponential spee',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered decision-transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for transportation: AI-Powered decision-transportation. Uses quantum-inspired algorithms to deliver capacity management at exponential speed.
          </p>
