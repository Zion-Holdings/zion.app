...
export const metadata: Metadata = {
  title: 'Optimization Adaptive - Transportation',
  description: 'Future-proof your transportation with Optimization Adaptive - Transportation. Our autonomous solution handles forecast accuracy end-to-end without human interve',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/optimization-adaptive-transportation-d30b36e2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Optimization Adaptive - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your transportation with Optimization Adaptive - Transportation. Our autonomous solution handles forecast accuracy end-to-end without human intervention.
          </p>
