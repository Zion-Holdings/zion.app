...
export const metadata: Metadata = {
  title: 'Cloud AI - Legal',
  description: 'Drive innovation in legal with Cloud AI - Legal. This AI-powered platform transforms document processing into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cloud-ai-legal-98852f96',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Cloud AI - Legal. This AI-powered platform transforms document processing into a competitive advantage.
          </p>
