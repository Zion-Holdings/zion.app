...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize finance through intelligent automation. Our Cognitive Marketing for Finance leverages advanced machine learning to deliver maintenance scheduling ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-marketing-for-finance-0dbd4100',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our Cognitive Marketing for Finance leverages advanced machine learning to deliver maintenance scheduling at scale.
          </p>
