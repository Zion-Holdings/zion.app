...
export const metadata: Metadata = {
  title: 'Intelligent real estate-cybersecurity',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent real estate-cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation cybersecurity solution: Intelligent real estate-cybersecurity. Combines territory management with adaptive intelligence for optimal results.
          </p>
