...
export const metadata: Metadata = {
  title: 'Autonomous Healthcare System - PROPTECH',
  description: 'The future of proptech is here with Autonomous Healthcare System - PROPTECH. Powered by cutting-edge AI, this platform delivers onboarding automation like never',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-healthcare-system-proptech-5c7b4600',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Healthcare System - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with Autonomous Healthcare System - PROPTECH. Powered by cutting-edge AI, this platform delivers onboarding automation like never before.
          </p>
