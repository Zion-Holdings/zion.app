...
export const metadata: Metadata = {
  ...
  keywords: 'Risk clause highlighting, Playbook clause matching, Redline suggestion engine, Multi-doc comparison, Workflow routing, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Generative AI Legal Document Review</h1>
        <p className="text-lg text-slate-300 mb-8">AI contract review that highlights risks, suggests clauses, compares against playbooks, and redlines in your firms style — cutting document review time 80%.</p>
        ...
        <li class="text-slate-300">Risk clause highlighting</li>
        <li class="text-slate-300">Playbook clause matching</li>
        <li class="text-slate-300">Redline suggestion engine</li>
        <li class="text-slate-300">Multi-doc comparison</li>
        <li class="text-slate-300">Workflow routing</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with generative ai legal document review</li>
