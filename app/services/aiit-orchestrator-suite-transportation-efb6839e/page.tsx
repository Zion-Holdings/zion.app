...
export const metadata: Metadata = {
  title: 'AI/IT Orchestrator Suite - Transportation',
  description: 'Enhance your transportation business with AI/IT Orchestrator Suite - Transportation. Our solution provides brand monitoring with enterprise-grade reliability an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-orchestrator-suite-transportation-efb6839e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Orchestrator Suite - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with AI/IT Orchestrator Suite - Transportation. Our solution provides brand monitoring with enterprise-grade reliability and security.
          </p>
