...
export const metadata: Metadata = {
  title: 'Finance Automated - Logistics',
  description: 'Next-generation logistics solution: Finance Automated - Logistics. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/finance-automated-logistics-9487072d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Finance Automated - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Finance Automated - Logistics. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
