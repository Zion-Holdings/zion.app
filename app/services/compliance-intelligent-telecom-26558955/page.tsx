...
export const metadata: Metadata = {
  title: 'Compliance Intelligent - Telecom',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Compliance Intelligent - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your telecom workflows with Compliance Intelligent - Telecom. This intelligent platform delivers capacity management through advanced automation and AI.
          </p>
