...
export const metadata: Metadata = {
  title: 'Intelligent cloud-automotive',
  description: 'Revolutionize automotive through intelligent automation. Our Intelligent cloud-automotive leverages advanced machine learning to deliver document processing at ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-cloud-automotive-6f123ade',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize automotive through intelligent automation. Our Intelligent cloud-automotive leverages advanced machine learning to deliver document processing at scale.
          </p>
