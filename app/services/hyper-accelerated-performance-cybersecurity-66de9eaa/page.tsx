...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Performance - Cybersecurity',
  description: 'Drive innovation in cybersecurity with Hyper-Accelerated Performance - Cybersecurity. This AI-powered platform transforms contract analysis into a competitive a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Performance - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in cybersecurity with Hyper-Accelerated Performance - Cybersecurity. This AI-powered platform transforms contract analysis into a competitive advantage.
          </p>
