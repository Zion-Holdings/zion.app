...
export const metadata: Metadata = {
  title: 'Next-Gen Director for MARTECH',
  description: 'Transform your martech operations with our Next-Gen Director for MARTECH. This AI-driven solution automates financial risk management with unprecedented accurac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-director-for-martech-a1404610',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Director for MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your martech operations with our Next-Gen Director for MARTECH. This AI-driven solution automates financial risk management with unprecedented accuracy and efficiency.
          </p>
