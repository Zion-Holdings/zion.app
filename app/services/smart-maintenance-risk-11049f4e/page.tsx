...
export const metadata: Metadata = {
  title: 'Smart Maintenance Risk',
  description: 'Revolutionize hospitality through intelligent automation. Our Smart Maintenance Risk leverages advanced machine learning to deliver enterprise-grade insights at',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-maintenance-risk-11049f4e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Maintenance Risk
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Smart Maintenance Risk leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
