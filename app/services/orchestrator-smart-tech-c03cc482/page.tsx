...
export const metadata: Metadata = {
  title: 'Orchestrator Smart - Tech',
  description: 'Unlock unprecedented growth with Orchestrator Smart - Tech. This autonomous system provides healthcare data analytics with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/orchestrator-smart-tech-c03cc482',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Orchestrator Smart - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Orchestrator Smart - Tech. This autonomous system provides healthcare data analytics with zero manual intervention needed.
          </p>
