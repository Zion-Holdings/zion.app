...
export const metadata: Metadata = {
  ...
  description: 'payroll automation solution for insurtech industry. Creates and manages real-time data pipelines with automated ETL and streaming analytics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/payroll-automation-real-time-data-pipeline-platform-6976c2c8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            payroll automation solution for insurtech industry. Creates and manages real-time data pipelines with automated ETL and streaming analytics.
          </p>
