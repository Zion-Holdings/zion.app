...
export const metadata: Metadata = {
  title: 'Smart Energy Security',
  description: 'Transform your automotive operations with our Smart Energy Security. This AI-driven solution provides intelligent automation with unprecedented accuracy and eff',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your automotive operations with our Smart Energy Security. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
