...
export const metadata: Metadata = {
  title: 'AI-Powered Orchestrator for Legal',
  description: 'Transform your legal operations with our AI-Powered Orchestrator for Legal. This AI-driven solution automates risk assessment with unprecedented accuracy and ef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-orchestrator-for-legal-131e703f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Orchestrator for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our AI-Powered Orchestrator for Legal. This AI-driven solution automates risk assessment with unprecedented accuracy and efficiency.
          </p>
