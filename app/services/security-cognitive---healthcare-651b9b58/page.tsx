...
export const metadata: Metadata = {
  title: 'Security Cognitive - Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Security Cognitive - Healthcare leverages advanced machine learning to deliver security monitoring ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-cognitive---healthcare-651b9b58',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Cognitive - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Security Cognitive - Healthcare leverages advanced machine learning to deliver security monitoring at scale.
          </p>
