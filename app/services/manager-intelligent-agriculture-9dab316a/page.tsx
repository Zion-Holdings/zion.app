...
export const metadata: Metadata = {
  title: 'Manager Intelligent - Agriculture',
  description: 'Transform your agriculture operations with our Manager Intelligent - Agriculture. This AI-driven solution automates predictive analytics with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/manager-intelligent-agriculture-9dab316a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manager Intelligent - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Manager Intelligent - Agriculture. This AI-driven solution automates predictive analytics with unprecedented accuracy and efficiency.
          </p>
