...
export const metadata: Metadata = {
  title: 'Enterprise Business Intelligence - Media',
  description: 'Next-generation media solution: Enterprise Business Intelligence - Media. Combines data processing with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-business-intelligence-media-345de3a6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Business Intelligence - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation media solution: Enterprise Business Intelligence - Media. Combines data processing with adaptive intelligence for optimal results.
          </p>
