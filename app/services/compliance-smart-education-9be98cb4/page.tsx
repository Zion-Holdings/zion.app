...
export const metadata: Metadata = {
  title: 'Compliance Smart - Education',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Compliance Smart - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Compliance Smart - Education. This autonomous system provides intelligent automation with zero manual intervention needed.
          </p>
