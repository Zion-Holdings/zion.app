...
export const metadata: Metadata = {
  title: 'Predictive Performance Engine - PROPTECH',
  description: 'Transform your proptech operations with our Predictive Performance Engine - PROPTECH. This AI-driven solution automates regulatory tracking with unprecedented a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Performance Engine - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your proptech operations with our Predictive Performance Engine - PROPTECH. This AI-driven solution automates regulatory tracking with unprecedented accuracy and efficiency.
          </p>
