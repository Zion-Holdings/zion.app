...
export const metadata: Metadata = {
  title: 'Smart Data Science Platform - Telecom',
  description: 'The future of telecom is here with Smart Data Science Platform - Telecom. Powered by cutting-edge AI, this platform delivers competitive intelligence like never',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Data Science Platform - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of telecom is here with Smart Data Science Platform - Telecom. Powered by cutting-edge AI, this platform delivers competitive intelligence like never before.
          </p>
