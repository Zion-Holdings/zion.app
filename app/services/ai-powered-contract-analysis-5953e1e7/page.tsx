...
export const metadata: Metadata = {
  ...
  description: 'Analyzes legal contracts and agreements using NLP to extract key terms and risks.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-contract-analysis-5953e1e7',
  },

export const metadata = {
  title: "AI-Powered Contract Analysis - Zion Tech Group",
  description: "Analyzes legal contracts and agreements using NLP to extract key terms and risks.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-contract-analysis-5953e1e7`
  }
  ...
  return (
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Analyzes legal contracts and agreements using NLP to extract key terms and risks.
          </p>
    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">AI-Powered Contract Analysis</h1>
        <p className="text-lg text-gray-300 mb-8">Analyzes legal contracts and agreements using NLP to extract key terms and risks.</p>
