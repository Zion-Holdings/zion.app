...
export const metadata: Metadata = {
  title: 'Generator Cognitive - Automotive',
  description: 'Enhance your automotive business with Generator Cognitive - Automotive. Our solution provides serverless deployment with enterprise-grade reliability and securi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Generator Cognitive - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your automotive business with Generator Cognitive - Automotive. Our solution provides serverless deployment with enterprise-grade reliability and security.
          </p>
