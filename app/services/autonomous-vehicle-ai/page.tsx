...
export const metadata: Metadata = {
  ...
  keywords: 'Sensor fusion, Path planning, Object detection, Simulation, HD mapping, Regulatory compliance, Fleet management, Safety validation, ai, Automotive, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Autonomous Vehicle AI Platform</h1>
        <p className="text-lg text-slate-300 mb-8">AI platform for autonomous vehicle development with sensor fusion and safety validation.</p>
        ...
        <li class="text-slate-300">Sensor fusion</li>
        <li class="text-slate-300">Path planning</li>
        <li class="text-slate-300">Object detection</li>
        <li class="text-slate-300">Simulation</li>
        <li class="text-slate-300">HD mapping</li>
        <li class="text-slate-300">Regulatory compliance</li>
        <li class="text-slate-300">Fleet management</li>
        <li class="text-slate-300">Safety validation</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Faster development</li>
        <li class="text-slate-300">Safety validation</li>
        <li class="text-slate-300">Regulatory compliance</li>
        <li class="text-slate-300">Simulation at scale</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$50,000</p>
