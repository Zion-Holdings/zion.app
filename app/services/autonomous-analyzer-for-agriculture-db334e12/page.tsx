...
export const metadata: Metadata = {
  title: 'Autonomous Analyzer for Agriculture',
  description: 'The future of agriculture is here with Autonomous Analyzer for Agriculture. Powered by cutting-edge AI, this platform delivers energy management like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-analyzer-for-agriculture-db334e12',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Analyzer for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Autonomous Analyzer for Agriculture. Powered by cutting-edge AI, this platform delivers energy management like never before.
          </p>
