...
export const metadata: Metadata = {
  ...
  description: 'Transform your finance operations with our Autonomous autonomous-finance. This AI-driven solution automates personalization engine with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-autonomous-finance-d562457f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Autonomous autonomous-finance. This AI-driven solution automates personalization engine with unprecedented accuracy and efficiency.
          </p>
