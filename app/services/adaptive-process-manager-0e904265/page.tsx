...
export const metadata: Metadata = {
  title: 'Adaptive Process Manager',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Adaptive Process Manager. Powered by cutting-edge AI, this platform delivers market intelligence like never before.
          </p>
