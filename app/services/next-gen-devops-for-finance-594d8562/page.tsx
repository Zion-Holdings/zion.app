...
export const metadata: Metadata = {
  title: 'Next-Gen DevOps for Finance',
  description: 'Optimize your finance workflows with Next-Gen DevOps for Finance. This intelligent platform delivers manufacturing quality control through advanced automation a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-devops-for-finance-594d8562',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen DevOps for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your finance workflows with Next-Gen DevOps for Finance. This intelligent platform delivers manufacturing quality control through advanced automation and AI.
          </p>
