...
export const metadata: Metadata = {
  ...
  keywords: 'Monolith decomposition consulting, Containerization (Docker), Kubernetes deployment, CI/CD pipeline setup, Infrastructure as Code (Terraform), Service mesh implementation, Observability stack setup, Team training and enablement, it, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Cloud-Native Transformation Service</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end cloud-native transformation: containerization, microservices decomposition, CI/CD pipeline setup, and Kubernetes adoption. From legacy monolith to cloud-native architecture.</p>
        ...
        <li class="text-slate-300">Monolith decomposition consulting</li>
        <li class="text-slate-300">Containerization (Docker)</li>
        <li class="text-slate-300">Kubernetes deployment</li>
        <li class="text-slate-300">CI/CD pipeline setup</li>
        <li class="text-slate-300">Infrastructure as Code (Terraform)</li>
        <li class="text-slate-300">Service mesh implementation</li>
        <li class="text-slate-300">Observability stack setup</li>
        <li class="text-slate-300">Team training and enablement</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Modernize legacy applications at scale</li>
        <li class="text-slate-300">Improve deployment frequency 10x</li>
        <li class="text-slate-300">Reduce infrastructure costs</li>
        <li class="text-slate-300">Enable team autonomy</li>
      </ul>
        </div>
