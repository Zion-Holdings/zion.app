...
export const metadata: Metadata = {
  ...
  keywords: 'Demand forecasting, Auto-replenishment, Assortment optimization, Markdown optimization, analytics, retail, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Intelligent Sales Inventory Management</h1>
        <p className="text-lg text-slate-300 mb-8">AI-driven inventory optimization platform that provides intelligent demand forecasting, automated replenishment, and assortment planning for retail operations.</p>
        ...
        <li class="text-slate-300">Auto-replenishment</li>
        <li class="text-slate-300">Assortment optimization</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduced stockouts</li>
        <li class="text-slate-300">Lower inventory costs</li>
        <li class="text-slate-300">Optimized assortments</li>
        <li class="text-slate-300">Improved margins</li>
      </ul>
        </div>
