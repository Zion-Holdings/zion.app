...
export const metadata: Metadata = {
  title: 'Intelligent Network Processor',
  description: 'Drive innovation in technology with Intelligent Network Processor. This AI-powered platform transforms survey automation into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-network-processor-d62971a0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in technology with Intelligent Network Processor. This AI-powered platform transforms survey automation into a competitive advantage.
          </p>
