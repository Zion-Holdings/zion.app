...
export const metadata: Metadata = {
  ...
  keywords: 'Unified gateway supporting REST, GraphQL, and gRPC with multi-protocol schema registry, Auto-generated developer portal with OpenAPI specification docs and try-it console, Rate-limiting, circuit-breaker, mTLS, and JWT claims context injection per route, Per-tenant and per-method usage analytics with monetisation rules, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">API Management &amp; Gateway</h1>
        <p className="text-lg text-slate-300 mb-8">Full API lifecycle management: unified gateway with auth, rate-limit, circuit-breaker, developer portal with auto-generated OpenAPI docs, per-tenant analytics, and API monetisation. Supports REST, GraphQL, and gRPC.</p>
        ...
        <li class="text-slate-300">Unified gateway supporting REST, GraphQL, and gRPC with multi-protocol schema registry</li>
        <li class="text-slate-300">Auto-generated developer portal with OpenAPI specification docs and try-it console</li>
        <li class="text-slate-300">Rate-limiting, circuit-breaker, mTLS, and JWT claims context injection per route</li>
        <li class="text-slate-300">Per-tenant and per-method usage analytics with monetisation rules</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with api management &amp; gateway</li>
