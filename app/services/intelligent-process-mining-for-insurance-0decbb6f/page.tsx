...
export const metadata: Metadata = {
  title: 'Intelligent Process Mining for Insurance',
  description: 'The future of insurance is here with Intelligent Process Mining for Insurance. Powered by cutting-edge AI, this platform delivers campaign optimization like nev',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-process-mining-for-insurance-0decbb6f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Process Mining for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Intelligent Process Mining for Insurance. Powered by cutting-edge AI, this platform delivers campaign optimization like never before.
          </p>
