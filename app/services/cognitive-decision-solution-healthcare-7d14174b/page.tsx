...
export const metadata: Metadata = {
  title: 'Cognitive Decision Solution - Healthcare',
  description: 'The future of healthcare is here with Cognitive Decision Solution - Healthcare. Powered by cutting-edge AI, this platform delivers recommendation system like ne',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-decision-solution-healthcare-7d14174b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Decision Solution - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Cognitive Decision Solution - Healthcare. Powered by cutting-edge AI, this platform delivers recommendation system like never before.
          </p>
