...
export const metadata: Metadata = {
  title: 'Marketing Smart - Insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Marketing Smart - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Marketing Smart - Insurance. This AI-powered platform transforms risk assessment into a competitive advantage.
          </p>
