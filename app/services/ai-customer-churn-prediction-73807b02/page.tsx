...
export const metadata: Metadata = {
  title: "AI Customer Churn Prediction - AI-Powered Customer Success Solution",
  description: "Identifies at-risk customers before they churn using behavioral patterns and engagement metrics.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-customer-churn-prediction-73807b02",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI Customer Churn Prediction - AI-Powered Customer Success Solution
        </h1>
