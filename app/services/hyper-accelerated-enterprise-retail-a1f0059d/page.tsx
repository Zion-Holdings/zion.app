...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Enterprise - Retail',
  description: 'Revolutionize retail through intelligent automation. Our Hyper-Accelerated Enterprise - Retail leverages advanced machine learning to deliver conversational ai ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Enterprise - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize retail through intelligent automation. Our Hyper-Accelerated Enterprise - Retail leverages advanced machine learning to deliver conversational ai at scale.
          </p>
