...
export const metadata: Metadata = {
  title: 'AI-Driven Content for Sports',
  description: 'Transform your sports operations with our AI-Driven Content for Sports. This AI-driven solution automates user provisioning with unprecedented accuracy and effi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-driven-content-for-sports-d628d8ec',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Driven Content for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our AI-Driven Content for Sports. This AI-driven solution automates user provisioning with unprecedented accuracy and efficiency.
          </p>
