...
export const metadata: Metadata = {
  title: 'Smart Suite Platform - Hospitality',
  description: 'Optimize your hospitality workflows with Smart Suite Platform - Hospitality. This intelligent platform delivers project management through advanced automation a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Suite Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Smart Suite Platform - Hospitality. This intelligent platform delivers project management through advanced automation and AI.
          </p>
