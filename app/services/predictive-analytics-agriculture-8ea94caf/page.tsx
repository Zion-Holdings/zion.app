...
export const metadata: Metadata = {
  title: 'Predictive analytics-agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Predictive analytics-agriculture leverages advanced machine learning to deliver security monitorin',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-analytics-agriculture-8ea94caf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Predictive analytics-agriculture leverages advanced machine learning to deliver security monitoring at scale.
          </p>
