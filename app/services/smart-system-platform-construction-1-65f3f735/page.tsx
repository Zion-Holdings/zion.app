...
export const metadata: Metadata = {
  title: 'Smart System Platform - Construction #1',
  description: 'Revolutionize construction through intelligent automation. Our Smart System Platform - Construction #1 leverages advanced machine learning to deliver recommenda',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-system-platform-construction-1-65f3f735',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart System Platform - Construction #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Smart System Platform - Construction #1 leverages advanced machine learning to deliver recommendation system at scale.
          </p>
