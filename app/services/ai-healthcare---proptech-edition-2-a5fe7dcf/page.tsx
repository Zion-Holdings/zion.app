...
export const metadata: Metadata = {
  title: 'AI Healthcare - Proptech Edition #2',
  description: 'Transform your proptech operations with our AI Healthcare - Proptech Edition #2. This AI-driven solution automates financial planning with unprecedented accurac',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Healthcare - Proptech Edition #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your proptech operations with our AI Healthcare - Proptech Edition #2. This AI-driven solution automates financial planning with unprecedented accuracy and efficiency.
          </p>
