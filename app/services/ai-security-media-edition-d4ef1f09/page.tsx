...
export const metadata: Metadata = {
  title: 'AI Security - Media Edition',
  description: 'The future of media is here with AI Security - Media Edition. Powered by cutting-edge AI, this platform delivers performance tuning like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-security-media-edition-d4ef1f09',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Security - Media Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of media is here with AI Security - Media Edition. Powered by cutting-edge AI, this platform delivers performance tuning like never before.
          </p>
