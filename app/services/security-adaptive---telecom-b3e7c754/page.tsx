...
export const metadata: Metadata = {
  title: 'Security Adaptive - Telecom',
  description: 'Revolutionize telecom through intelligent automation. Our Security Adaptive - Telecom leverages advanced machine learning to deliver document processing at scal',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-adaptive---telecom-b3e7c754',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Adaptive - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Security Adaptive - Telecom leverages advanced machine learning to deliver document processing at scale.
          </p>
