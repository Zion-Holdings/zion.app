...
export const metadata: Metadata = {
  title: 'Next-Gen Maintenance Workflow',
  description: 'Transform enterprise with Next-Gen Maintenance Workflow - the intelligent automation platform that learns, adapts, and delivers 10x results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-maintenance-workflow-8143fbc1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Maintenance Workflow
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform enterprise with Next-Gen Maintenance Workflow - the intelligent automation platform that learns, adapts, and delivers 10x results.
          </p>
