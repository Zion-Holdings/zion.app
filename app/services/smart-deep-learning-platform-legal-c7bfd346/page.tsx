...
export const metadata: Metadata = {
  title: 'Smart Deep Learning Platform - Legal',
  description: 'Enhance your legal business with Smart Deep Learning Platform - Legal. Our solution provides testing automation with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-deep-learning-platform-legal-c7bfd346',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Deep Learning Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Smart Deep Learning Platform - Legal. Our solution provides testing automation with enterprise-grade reliability and security.
          </p>
