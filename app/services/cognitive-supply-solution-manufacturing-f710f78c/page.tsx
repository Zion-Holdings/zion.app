...
export const metadata: Metadata = {
  title: 'Cognitive Supply Solution - Manufacturing',
  description: 'Optimize your manufacturing workflows with Cognitive Supply Solution - Manufacturing. This intelligent platform delivers budget optimization through advanced au',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Supply Solution - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your manufacturing workflows with Cognitive Supply Solution - Manufacturing. This intelligent platform delivers budget optimization through advanced automation and AI.
          </p>
