...
export const metadata: Metadata = {
  title: 'Cognitive System for Energy #1',
  description: 'The future of energy is here with Cognitive System for Energy #1. Powered by cutting-edge AI, this platform delivers anomaly detection like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-system-for-energy-1-5f57c551',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive System for Energy #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Cognitive System for Energy #1. Powered by cutting-edge AI, this platform delivers anomaly detection like never before.
          </p>
