...
export const metadata: Metadata = {
  ...
  keywords: 'Continuous internet-facing asset discovery, Domain/IP/subdomain + API enumeration, Shadow-IT detection from DNS + cert transparency, Attack vector prioritization: exploit + impact, Instant alert on new/misconfigured asset, security, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Attack Surface Management (ASM)</h1>
        <p className="text-lg text-slate-300 mb-8">Continuous external attack surface discovery: internet-facing assets, domains, IPs, subdomains, APIs, TLS certs, shadow IT. Continuous monitoring. Attack vector prioritization.</p>
        ...
        <li class="text-slate-300">Continuous internet-facing asset discovery</li>
        <li class="text-slate-300">Domain/IP/subdomain + API enumeration</li>
        <li class="text-slate-300">Shadow-IT detection from DNS + cert transparency</li>
        <li class="text-slate-300">Attack vector prioritization: exploit + impact</li>
        <li class="text-slate-300">Instant alert on new/misconfigured asset</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with attack surface management (asm)</li>
