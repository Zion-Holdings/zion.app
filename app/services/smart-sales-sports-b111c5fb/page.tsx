...
export const metadata: Metadata = {
  title: 'Smart sales-sports',
  description: 'Revolutionize sports through intelligent automation. Our Smart sales-sports leverages advanced machine learning to deliver quality control at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-sales-sports-b111c5fb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Smart sales-sports leverages advanced machine learning to deliver quality control at scale.
          </p>
