...
export const metadata: Metadata = {
  title: 'Customer Service Intelligent - Education',
  description: 'Enhance your education business with Customer Service Intelligent - Education. Our solution provides testing automation with enterprise-grade reliability and se',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Customer Service Intelligent - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your education business with Customer Service Intelligent - Education. Our solution provides testing automation with enterprise-grade reliability and security.
          </p>
