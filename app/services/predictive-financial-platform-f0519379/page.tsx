...
export const metadata: Metadata = {
  title: 'Predictive Financial Platform',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Financial Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize quantum through intelligent automation. Our Predictive Financial Platform leverages advanced machine learning to deliver fraud prevention at scale.
          </p>
