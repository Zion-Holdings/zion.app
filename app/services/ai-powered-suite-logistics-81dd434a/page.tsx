...
export const metadata: Metadata = {
  title: 'AI-Powered suite-logistics',
  description: 'Enhance your logistics business with AI-Powered suite-logistics. Our solution provides predictive modeling with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-suite-logistics-81dd434a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered suite-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with AI-Powered suite-logistics. Our solution provides predictive modeling with enterprise-grade reliability and security.
          </p>
