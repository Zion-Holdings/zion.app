...
export const metadata: Metadata = {
  title: 'Intelligent Healthcare Autonomous',
  description: 'Revolutionize manufacturing through intelligent automation. Our Intelligent Healthcare Autonomous leverages advanced machine learning to deliver enterprise-grad',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Healthcare Autonomous
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize manufacturing through intelligent automation. Our Intelligent Healthcare Autonomous leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
