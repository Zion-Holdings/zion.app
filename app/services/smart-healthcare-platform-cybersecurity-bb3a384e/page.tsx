...
export const metadata: Metadata = {
  title: 'Smart Healthcare Platform - Cybersecurity',
  description: 'Next-generation cybersecurity solution: Smart Healthcare Platform - Cybersecurity. Combines disaster recovery with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-healthcare-platform-cybersecurity-bb3a384e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Healthcare Platform - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation cybersecurity solution: Smart Healthcare Platform - Cybersecurity. Combines disaster recovery with adaptive intelligence for optimal results.
          </p>
