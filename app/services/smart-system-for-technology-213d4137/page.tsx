...
export const metadata: Metadata = {
  title: 'Smart System for Technology',
  description: 'The future of technology is here with Smart System for Technology. Powered by cutting-edge AI, this platform delivers supply chain like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-system-for-technology-213d4137',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart System for Technology
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of technology is here with Smart System for Technology. Powered by cutting-edge AI, this platform delivers supply chain like never before.
          </p>
