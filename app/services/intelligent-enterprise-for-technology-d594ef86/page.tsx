...
export const metadata: Metadata = {
  title: 'Intelligent Enterprise for TECHNOLOGY',
  description: 'Revolutionize technology through intelligent automation. Our Intelligent Enterprise for TECHNOLOGY leverages advanced machine learning to deliver decision suppo',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Enterprise for TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our Intelligent Enterprise for TECHNOLOGY leverages advanced machine learning to deliver decision support at scale.
          </p>
