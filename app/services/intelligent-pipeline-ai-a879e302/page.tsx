...
export const metadata: Metadata = {
  title: 'Intelligent Pipeline AI',
  description: 'Next-generation real-estate solution: Intelligent Pipeline AI. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-pipeline-ai-a879e302',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Pipeline AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation real-estate solution: Intelligent Pipeline AI. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
