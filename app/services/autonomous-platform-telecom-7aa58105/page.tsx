...
export const metadata: Metadata = {
  title: 'Autonomous platform-telecom',
  description: 'Revolutionize telecom through intelligent automation. Our Autonomous platform-telecom leverages advanced machine learning to deliver competitive intelligence at',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-platform-telecom-7aa58105',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous platform-telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Autonomous platform-telecom leverages advanced machine learning to deliver competitive intelligence at scale.
          </p>
