...
export const metadata: Metadata = {
  title: 'Cognitive Manager Solution - Media',
  description: 'Optimize your media workflows with Cognitive Manager Solution - Media. This intelligent platform delivers root cause analysis through advanced automation and AI',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-manager-solution-media-ab8d2f0f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Manager Solution - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your media workflows with Cognitive Manager Solution - Media. This intelligent platform delivers root cause analysis through advanced automation and AI.
          </p>
