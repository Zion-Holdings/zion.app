...
export const metadata: Metadata = {
  title: 'Quantum Tactical - Construction Quantum',
  description: 'Revolutionize construction through intelligent automation. Our Quantum Tactical - Construction Quantum leverages advanced machine learning to deliver threat det',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-tactical-construction-quantum-3d402721',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Tactical - Construction Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Quantum Tactical - Construction Quantum leverages advanced machine learning to deliver threat detection at scale.
          </p>
