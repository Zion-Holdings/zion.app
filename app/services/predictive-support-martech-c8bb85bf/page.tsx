...
export const metadata: Metadata = {
  title: 'Predictive support-martech',
  description: 'Enhance your martech business with Predictive support-martech. Our solution provides customer onboarding with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-support-martech-c8bb85bf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive support-martech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your martech business with Predictive support-martech. Our solution provides customer onboarding with enterprise-grade reliability and security.
          </p>
