...
export const metadata: Metadata = {
  title: 'Smart Healthcare Platform - Finance',
  description: 'Enhance your finance business with Smart Healthcare Platform - Finance. Our solution provides financial planning with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-healthcare-platform-finance-0960c4c4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Healthcare Platform - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your finance business with Smart Healthcare Platform - Finance. Our solution provides financial planning with enterprise-grade reliability and security.
          </p>
