...
export const metadata: Metadata = {
  title: 'Smart Campaign Smart',
  description: 'Next-generation agriculture solution: Smart Campaign Smart. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-campaign-smart-0e891d9a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agriculture solution: Smart Campaign Smart. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
