...
export const metadata: Metadata = {
  ...
  description: 'Optimize your sports workflows with Smart Orchestrator Platform - Sports. This intelligent platform delivers disaster recovery through advanced automation and A',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your sports workflows with Smart Orchestrator Platform - Sports. This intelligent platform delivers disaster recovery through advanced automation and AI.
          </p>
