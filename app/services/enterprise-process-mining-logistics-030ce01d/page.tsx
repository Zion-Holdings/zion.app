...
export const metadata: Metadata = {
  title: 'Enterprise Process Mining - Logistics',
  description: 'Next-generation logistics solution: Enterprise Process Mining - Logistics. Combines business intelligence with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-process-mining-logistics-030ce01d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Process Mining - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Enterprise Process Mining - Logistics. Combines business intelligence with adaptive intelligence for optimal results.
          </p>
