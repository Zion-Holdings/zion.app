    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce cloud spend by 30-40% sustainably</li>
            <li>Eliminate cloud waste and orphaned resources</li>
            <li>Allocate costs accurately to teams and projects</li>
            <li>Build a culture of cloud cost awareness</li>
          </ul>
        </div>
