...
export const metadata: Metadata = {
  title: 'AI-Powered Loan Portfolio Management',
  description: 'Manages loan portfolios with risk assessment and performance optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-loan-portfolio-management2026-07-28t0356460584380000142-10b29e91',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Manages loan portfolios with risk assessment and performance optimization.
          </p>
