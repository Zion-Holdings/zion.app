...
export const metadata: Metadata = {
  ...
  keywords: 'Stripe/Braintree native integration, Per-customer churn risk scoring, Automated retention email campaigns, Win-back workflow builder, Revenue impact forecasting, Cohort analysis dashboard, Slack/Teams alerts for at-risk accounts, API for custom integrations, micro-saas, SaaS, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">ChurnShield — Churn Prediction Micro-SaaS</h1>
        <p className="text-lg text-slate-300 mb-8">Plug-and-play churn prediction for SaaS businesses. Connect your Stripe/Braintree account, and get AI-powered churn risk scores for every customer. Automated retention campaigns and win-back workflows.</p>
        ...
        <li class="text-slate-300">Stripe/Braintree native integration</li>
        <li class="text-slate-300">Per-customer churn risk scoring</li>
        <li class="text-slate-300">Automated retention email campaigns</li>
        <li class="text-slate-300">Win-back workflow builder</li>
        <li class="text-slate-300">Revenue impact forecasting</li>
        <li class="text-slate-300">Cohort analysis dashboard</li>
        <li class="text-slate-300">Slack/Teams alerts for at-risk accounts</li>
