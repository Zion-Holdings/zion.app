...
export const metadata: Metadata = {
  title: 'AI/IT Tactical Suite - Retail',
  description: 'Transform your retail operations with our AI/IT Tactical Suite - Retail. This AI-driven solution automates personalization engine with unprecedented accuracy an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Tactical Suite - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our AI/IT Tactical Suite - Retail. This AI-driven solution automates personalization engine with unprecedented accuracy and efficiency.
          </p>
