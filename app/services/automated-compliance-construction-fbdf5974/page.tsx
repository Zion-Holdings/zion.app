...
export const metadata: Metadata = {
  title: 'Automated compliance-construction',
  description: 'Enhance your construction business with Automated compliance-construction. Our solution provides energy management with enterprise-grade reliability and securit',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-compliance-construction-fbdf5974',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Automated compliance-construction. Our solution provides energy management with enterprise-grade reliability and security.
          </p>
