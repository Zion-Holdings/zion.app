...
export const metadata: Metadata = {
  title: 'Advisor Adaptive - Legal',
  description: 'Optimize your legal workflows with Advisor Adaptive - Legal. This intelligent platform delivers quality assurance through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/advisor-adaptive-legal-bcd35516',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Advisor Adaptive - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with Advisor Adaptive - Legal. This intelligent platform delivers quality assurance through advanced automation and AI.
          </p>
