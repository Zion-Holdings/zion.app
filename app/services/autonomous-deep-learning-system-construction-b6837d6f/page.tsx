...
export const metadata: Metadata = {
  title: 'Autonomous Deep Learning System - Construction',
  description: 'Transform your construction operations with our Autonomous Deep Learning System - Construction. This AI-driven solution automates inventory management with unpr',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Deep Learning System - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Autonomous Deep Learning System - Construction. This AI-driven solution automates inventory management with unprecedented accuracy and efficiency.
          </p>
