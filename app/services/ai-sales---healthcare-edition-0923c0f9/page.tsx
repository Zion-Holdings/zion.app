...
export const metadata: Metadata = {
  title: 'AI Sales - Healthcare Edition',
  description: 'Unlock unprecedented growth with AI Sales - Healthcare Edition. This autonomous system provides customer insights with zero manual intervention needed.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Sales - Healthcare Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with AI Sales - Healthcare Edition. This autonomous system provides customer insights with zero manual intervention needed.
          </p>
