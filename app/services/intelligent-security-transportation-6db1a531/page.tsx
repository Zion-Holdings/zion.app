...
export const metadata: Metadata = {
  title: 'Intelligent security-transportation',
  description: 'Drive innovation in transportation with Intelligent security-transportation. This AI-powered platform transforms quota optimization into a competitive advantage',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-security-transportation-6db1a531',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent security-transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in transportation with Intelligent security-transportation. This AI-powered platform transforms quota optimization into a competitive advantage.
          </p>
