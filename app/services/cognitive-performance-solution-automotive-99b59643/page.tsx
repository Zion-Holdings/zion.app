...
export const metadata: Metadata = {
  title: 'Cognitive Performance Solution - Automotive',
  description: 'Revolutionize automotive through intelligent automation. Our Cognitive Performance Solution - Automotive leverages advanced machine learning to deliver process ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Performance Solution - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize automotive through intelligent automation. Our Cognitive Performance Solution - Automotive leverages advanced machine learning to deliver process automation at scale.
          </p>
