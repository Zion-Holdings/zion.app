...
export const metadata: Metadata = {
  title: 'AI Marketing - Tech Edition',
  description: 'Revolutionize technology through intelligent automation. Our AI Marketing - Tech Edition leverages advanced machine learning to deliver performance reviews at s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Marketing - Tech Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our AI Marketing - Tech Edition leverages advanced machine learning to deliver performance reviews at scale.
          </p>
