export const metadata = {
  ...
  description: "Zion Tech Group delivers Cognitive Engine Solution - Logistics with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/services/cognitive-engine-solution-logistics-32df1cde/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>Cognitive Engine Solution - Logistics</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers Cognitive Engine Solution - Logistics with measurable outcomes.
      </p>
