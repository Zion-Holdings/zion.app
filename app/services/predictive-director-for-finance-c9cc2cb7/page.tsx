...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize finance through intelligent automation. Our Predictive Director for Finance leverages advanced machine learning to deliver content generation at s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our Predictive Director for Finance leverages advanced machine learning to deliver content generation at scale.
          </p>
