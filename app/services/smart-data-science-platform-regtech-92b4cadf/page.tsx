...
export const metadata: Metadata = {
  title: 'Smart Data Science Platform - REGTECH',
  description: 'The future of regtech is here with Smart Data Science Platform - REGTECH. Powered by cutting-edge AI, this platform delivers receipt processing like never befor',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Data Science Platform - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of regtech is here with Smart Data Science Platform - REGTECH. Powered by cutting-edge AI, this platform delivers receipt processing like never before.
          </p>
