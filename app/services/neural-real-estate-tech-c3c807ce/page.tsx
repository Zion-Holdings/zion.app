...
export const metadata: Metadata = {
  title: 'Neural real estate-tech',
  description: 'Unlock unprecedented growth with Neural real estate-tech. This autonomous system provides process automation with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-real-estate-tech-c3c807ce',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural real estate-tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Neural real estate-tech. This autonomous system provides process automation with zero manual intervention needed.
          </p>
