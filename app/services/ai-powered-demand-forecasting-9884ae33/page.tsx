...
export const metadata: Metadata = {
  title: "AI-Powered Demand Forecasting - AI-Powered Retail Solution",
  description: "Uses time-series analysis to predict product demand with high accuracy.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-demand-forecasting-9884ae33",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Demand Forecasting - AI-Powered Retail Solution
        </h1>
