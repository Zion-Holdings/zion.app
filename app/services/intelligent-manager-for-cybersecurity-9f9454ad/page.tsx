...
export const metadata: Metadata = {
  title: 'Intelligent Manager for Cybersecurity',
  description: 'Next-generation cybersecurity solution: Intelligent Manager for Cybersecurity. Combines compliance automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-manager-for-cybersecurity-9f9454ad',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Manager for Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation cybersecurity solution: Intelligent Manager for Cybersecurity. Combines compliance automation with adaptive intelligence for optimal results.
          </p>
