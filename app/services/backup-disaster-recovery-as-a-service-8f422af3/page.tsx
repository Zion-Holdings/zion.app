...
export const metadata = {
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/backup-disaster-recovery-as-a-service-8f422af3`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Backup Disaster Recovery as a Service</h1>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>Disaster recovery testing and runbooks</li>
          </ul>
        </div>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>Meet RTO/RPO with tested plans</li>
