...
export const metadata: Metadata = {
  title: 'Enterprise Retail Personalization IoT (Transportation)',
  description: 'Enterprise Retail Personalization IoT (Transportation) is an AI-powered transportation solution that transforms how businesses operate through intelligent autom',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Retail Personalization IoT (Transportation)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enterprise Retail Personalization IoT (Transportation) is an AI-powered transportation solution that transforms how businesses operate through intelligent automation and real-time analytics.
