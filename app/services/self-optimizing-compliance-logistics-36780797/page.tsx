...
export const metadata = {
  ...
  description: "Revolutionize Logistics through intelligent automation. Our Self-Optimizing compliance-logistics leverages advanced machine learning to deliver business intelli",
  alternates: {
