...
export const metadata: Metadata = {
  title: 'Smart monitoring-proptech',
  description: 'The future of proptech is here with Smart monitoring-proptech. Powered by cutting-edge AI, this platform delivers market intelligence like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-monitoring-proptech-011570ef',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart monitoring-proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with Smart monitoring-proptech. Powered by cutting-edge AI, this platform delivers market intelligence like never before.
          </p>
