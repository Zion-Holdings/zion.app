...
export const metadata: Metadata = {
  title: 'Healthtech Marketing Platform #24',
  description: 'AI-powered healthtech solution for marketing. Provides enterprise-grade automation and optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/marketing-healthtech-59a07c33',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Healthtech Marketing Platform #24
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered healthtech solution for marketing. Provides enterprise-grade automation and optimization.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">SEO enhancement</li>
          </ul>
        </section>
