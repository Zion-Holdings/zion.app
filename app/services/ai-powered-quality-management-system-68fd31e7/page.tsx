...
export const metadata: Metadata = {
  ...
  description: 'End-to-end quality management solution that automates inspection, defect tracking, CAPA management, and compliance reporting across manufacturing and service op',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-quality-management-system-68fd31e7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            End-to-end quality management solution that automates inspection, defect tracking, CAPA management, and compliance reporting across manufacturing and service operations.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Automated inspection</li>
          <li className="text-gray-300">Defect prediction</li>
          <li className="text-gray-300">CAPA automation</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">70% faster audits</li>
          <li className="text-purple-300">50% defect reduction</li>
          <li className="text-purple-300">Full compliance</li>
          </ul>
        </section>
