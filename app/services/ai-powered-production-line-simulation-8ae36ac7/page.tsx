...
export const metadata: Metadata = {
  title: 'AI-Powered Production Line Simulation',
  description: 'Simulates production lines with digital twins and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-production-line-simulation-8ae36ac7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Production Line Simulation
          </h1>
