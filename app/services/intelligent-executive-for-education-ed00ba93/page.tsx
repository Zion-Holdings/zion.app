...
export const metadata: Metadata = {
  title: 'Intelligent Executive for Education',
  description: 'Enhance your education business with Intelligent Executive for Education. Our solution provides user provisioning with enterprise-grade reliability and security',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-executive-for-education-ed00ba93',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Executive for Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your education business with Intelligent Executive for Education. Our solution provides user provisioning with enterprise-grade reliability and security.
          </p>
