...
export const metadata: Metadata = {
  title: "Accounting Autonomous Customer Service AI - AI-Powered Accounting Solution",
  ...
  alternates: {
    canonical: "https://ziontechgroup.com/services/accounting-autonomous-customer-service-ai-2684817a",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Accounting Autonomous Customer Service AI - AI-Powered Accounting Solution
        </h1>
