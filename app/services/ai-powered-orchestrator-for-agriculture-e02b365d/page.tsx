...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize agriculture through intelligent automation. Our AI-Powered Orchestrator for Agriculture leverages advanced machine learning to deliver image recog',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our AI-Powered Orchestrator for Agriculture leverages advanced machine learning to deliver image recognition at scale.
          </p>
