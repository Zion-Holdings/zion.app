...
export const metadata: Metadata = {
  title: 'DevOps Autonomous - Agritech',
  description: 'Next-generation agritech solution: DevOps Autonomous - Agritech. Combines healthcare data analytics with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/devops-autonomous---agritech-6e9fb062',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            DevOps Autonomous - Agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agritech solution: DevOps Autonomous - Agritech. Combines healthcare data analytics with adaptive intelligence for optimal results.
          </p>
