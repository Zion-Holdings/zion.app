...
export const metadata: Metadata = {
  title: 'Cognitive Performance Solution - EDTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Performance Solution - EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your edtech operations with our Cognitive Performance Solution - EDTECH. This AI-driven solution automates data processing with unprecedented accuracy and efficiency.
          </p>
