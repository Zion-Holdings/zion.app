...
export const metadata: Metadata = {
  title: 'Autonomous Computer Vision System - Sports',
  description: 'Drive innovation in sports with Autonomous Computer Vision System - Sports. This AI-powered platform transforms business continuity into a competitive advantage',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-computer-vision-system-sports-f8cc9796',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Computer Vision System - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in sports with Autonomous Computer Vision System - Sports. This AI-powered platform transforms business continuity into a competitive advantage.
          </p>
