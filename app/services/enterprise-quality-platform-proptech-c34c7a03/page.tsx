...
export const metadata: Metadata = {
  title: 'Enterprise Quality Platform - PROPTECH',
  description: 'Next-generation proptech solution: Enterprise Quality Platform - PROPTECH. Combines ai ethics with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-quality-platform-proptech-c34c7a03',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Quality Platform - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation proptech solution: Enterprise Quality Platform - PROPTECH. Combines ai ethics with adaptive intelligence for optimal results.
          </p>
