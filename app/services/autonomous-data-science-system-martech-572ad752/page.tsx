...
export const metadata: Metadata = {
  title: 'Autonomous Data Science System - MARTECH',
  description: 'Revolutionize martech through intelligent automation. Our Autonomous Data Science System - MARTECH leverages advanced machine learning to deliver hyperautomatio',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-data-science-system-martech-572ad752',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Data Science System - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize martech through intelligent automation. Our Autonomous Data Science System - MARTECH leverages advanced machine learning to deliver hyperautomation at scale.
          </p>
