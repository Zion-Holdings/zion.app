...
export const metadata: Metadata = {
  title: 'Automated Manufacturing for Hospitality',
  description: 'The future of hospitality is here with Automated Manufacturing for Hospitality. Powered by cutting-edge AI, this platform delivers document processing like neve',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-manufacturing-for-hospitality-2a6e0e93',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Manufacturing for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Automated Manufacturing for Hospitality. Powered by cutting-edge AI, this platform delivers document processing like never before.
          </p>
