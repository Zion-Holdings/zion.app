...
export const metadata: Metadata = {
  title: 'Intelligent Management for Agriculture',
  description: 'Enhance your agriculture business with Intelligent Management for Agriculture. Our solution provides process automation with enterprise-grade reliability and se',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-management-for-agriculture-320229a1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Management for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your agriculture business with Intelligent Management for Agriculture. Our solution provides process automation with enterprise-grade reliability and security.
          </p>
