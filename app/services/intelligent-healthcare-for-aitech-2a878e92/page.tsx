...
export const metadata: Metadata = {
  title: 'Intelligent Healthcare for AITECH',
  description: 'The future of aitech is here with Intelligent Healthcare for AITECH. Powered by cutting-edge AI, this platform delivers hr analytics like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-healthcare-for-aitech-2a878e92',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Healthcare for AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of aitech is here with Intelligent Healthcare for AITECH. Powered by cutting-edge AI, this platform delivers hr analytics like never before.
          </p>
