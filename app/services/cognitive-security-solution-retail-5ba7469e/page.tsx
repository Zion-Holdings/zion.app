...
export const metadata: Metadata = {
  title: 'Cognitive Security Solution - Retail',
  description: 'Transform your retail operations with our Cognitive Security Solution - Retail. This AI-driven solution automates feedback collection with unprecedented accurac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-security-solution-retail-5ba7469e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Security Solution - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our Cognitive Security Solution - Retail. This AI-driven solution automates feedback collection with unprecedented accuracy and efficiency.
          </p>
