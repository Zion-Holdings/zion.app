...
export const metadata: Metadata = {
  title: 'Intelligent Risk for MARTECH #1',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Risk for MARTECH #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation martech solution: Intelligent Risk for MARTECH #1. Combines competitive intelligence with adaptive intelligence for optimal results.
          </p>
