...
export const metadata: Metadata = {
  title: 'Enterprise Strategic Platform - HEALTHTECH',
  description: 'Transform your healthtech operations with our Enterprise Strategic Platform - HEALTHTECH. This AI-driven solution automates process discovery with unprecedented',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-strategic-platform-healthtech-231537f8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Strategic Platform - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthtech operations with our Enterprise Strategic Platform - HEALTHTECH. This AI-driven solution automates process discovery with unprecedented accuracy and efficiency.
          </p>
