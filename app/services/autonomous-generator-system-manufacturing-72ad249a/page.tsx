...
export const metadata: Metadata = {
  title: 'Autonomous Generator System - Manufacturing',
  description: 'Transform your manufacturing operations with our Autonomous Generator System - Manufacturing. This AI-driven solution automates security monitoring with unprece',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-generator-system-manufacturing-72ad249a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Generator System - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your manufacturing operations with our Autonomous Generator System - Manufacturing. This AI-driven solution automates security monitoring with unprecedented accuracy and efficiency.
          </p>
