...
export const metadata: Metadata = {
  title: 'Coordinator Adaptive - Iot',
  description: 'Next-generation iot solution: Coordinator Adaptive - Iot. Combines healthcare data analytics with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/coordinator-adaptive---iot-0142601d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Coordinator Adaptive - Iot
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation iot solution: Coordinator Adaptive - Iot. Combines healthcare data analytics with adaptive intelligence for optimal results.
          </p>
