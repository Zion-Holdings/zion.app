...
export const metadata: Metadata = {
  title: 'AI-Powered Healthcare Cybersecurity',
  description: 'Protects healthcare data with AI-powered security and compliance.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-healthcare-cybersecurity2026-07-28t0321551840800000167-cad4ab86',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Healthcare Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Protects healthcare data with AI-powered security and compliance.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Healthcare security</li>
          <li className="text-gray-300">Data protection</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">99.9% security</li>
