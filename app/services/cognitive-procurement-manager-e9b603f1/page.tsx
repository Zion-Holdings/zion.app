...
export const metadata: Metadata = {
  title: 'Cognitive Procurement Manager',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Procurement Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in technology with Cognitive Procurement Manager. This AI-powered platform transforms predictive modeling into a competitive advantage.
          </p>
