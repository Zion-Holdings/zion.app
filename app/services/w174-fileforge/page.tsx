...
export const metadata: Metadata = {
  ...
  keywords: '200+ format conversion pairs, PDF merge, split, watermark, OCR, Image resize, compress, convert, watermark, Video/audio transcode and thumbnail, Batch processing with webhook completion, CDN-backed file storage, REST API with SDKs (Python, Node, Go, Ruby), micro-saas, Developer Tools, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">FileForge — File Conversion &amp; Processing</h1>
        <p className="text-lg text-slate-300 mb-8">Universal file conversion API: PDF, Office, images, CAD, video, audio. Batch processing, OCR, compression, and watermarking. 200+ format pairs.</p>
        ...
        <li class="text-slate-300">200+ format conversion pairs</li>
        <li class="text-slate-300">PDF merge, split, watermark, OCR</li>
        <li class="text-slate-300">Image resize, compress, convert, watermark</li>
        <li class="text-slate-300">Video/audio transcode and thumbnail</li>
        <li class="text-slate-300">Batch processing with webhook completion</li>
        <li class="text-slate-300">CDN-backed file storage</li>
        <li class="text-slate-300">REST API with SDKs (Python, Node, Go, Ruby)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Convert any file format instantly</li>
        <li class="text-slate-300">Batch processing handles millions of files</li>
        <li class="text-slate-300">OCR extracts text from any document</li>
        <li class="text-slate-300">CDN-backed delivery is globally fast</li>
      </ul>
        </div>
