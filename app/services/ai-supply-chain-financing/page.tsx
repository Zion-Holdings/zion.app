...
export const metadata: Metadata = {
  ...
  keywords: 'Automated invoice verification, Buyer credit risk scoring, Dynamic discounting engine, Fraud detection (99.5% accuracy), Multi-bank integration, Real-time funding decisions, ai, Financial Services, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Supply Chain Financing &amp; Risk Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Automated supply chain finance: invoice verification, buyer risk scoring, dynamic discounting, and fraud detection. Processes $1B+ in receivables with 99.5% accuracy.</p>
        ...
        <li class="text-slate-300">Automated invoice verification</li>
        <li class="text-slate-300">Buyer credit risk scoring</li>
        <li class="text-slate-300">Dynamic discounting engine</li>
        <li class="text-slate-300">Fraud detection (99.5% accuracy)</li>
        <li class="text-slate-300">Multi-bank integration</li>
        <li class="text-slate-300">Real-time funding decisions</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Process $1B+ in receivables</li>
        <li class="text-slate-300">Reduce fraud by 95%</li>
        <li class="text-slate-300">Instant funding decisions</li>
      </ul>
        </div>
