...
export const metadata: Metadata = {
  title: 'Optimization Cognitive - Hospitality',
  description: 'Optimize your hospitality workflows with Optimization Cognitive - Hospitality. This intelligent platform delivers budget optimization through advanced automatio',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/optimization-cognitive-hospitality-89085aaf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Optimization Cognitive - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Optimization Cognitive - Hospitality. This intelligent platform delivers budget optimization through advanced automation and AI.
          </p>
