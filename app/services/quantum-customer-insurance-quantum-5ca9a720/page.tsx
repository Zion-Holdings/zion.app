...
export const metadata: Metadata = {
  title: 'Quantum Customer - Insurance Quantum',
  description: 'Drive innovation in insurance with Quantum Customer - Insurance Quantum. This AI-powered platform transforms workflow management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-customer-insurance-quantum-5ca9a720',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Customer - Insurance Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Quantum Customer - Insurance Quantum. This AI-powered platform transforms workflow management into a competitive advantage.
          </p>
