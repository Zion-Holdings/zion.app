...
export const metadata: Metadata = {
  title: 'Autonomous Machine Learning System - Legal',
  description: 'Optimize your legal workflows with Autonomous Machine Learning System - Legal. This intelligent platform delivers ml model training through advanced automation ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Machine Learning System - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with Autonomous Machine Learning System - Legal. This intelligent platform delivers ml model training through advanced automation and AI.
          </p>
