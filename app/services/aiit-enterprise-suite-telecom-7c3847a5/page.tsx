...
export const metadata: Metadata = {
  title: 'AI/IT Enterprise Suite - Telecom',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Enterprise Suite - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your telecom business with AI/IT Enterprise Suite - Telecom. Our solution provides access management with enterprise-grade reliability and security.
          </p>
