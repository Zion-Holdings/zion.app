...
export const metadata: Metadata = {
  title: 'Cognitive data-tech',
  description: 'Revolutionize technology through intelligent automation. Our Cognitive data-tech leverages advanced machine learning to deliver enterprise-grade insights at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our Cognitive data-tech leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
