...
export const metadata: Metadata = {
  title: 'AI/IT performance-regtech',
  description: 'Optimize your regtech workflows with AI/IT performance-regtech. This intelligent platform delivers roi tracking through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-performance-regtech-61515653',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT performance-regtech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your regtech workflows with AI/IT performance-regtech. This intelligent platform delivers roi tracking through advanced automation and AI.
          </p>
