...
export const metadata: Metadata = {
  title: 'Smart Experience Platform - Gaming',
  description: 'The future of gaming is here with Smart Experience Platform - Gaming. Powered by cutting-edge AI, this platform delivers access management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-experience-platform-gaming-c374d171',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Experience Platform - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of gaming is here with Smart Experience Platform - Gaming. Powered by cutting-edge AI, this platform delivers access management like never before.
          </p>
