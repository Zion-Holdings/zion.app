export const metadata = {
  title: "Smart Marketing Platform - Healthcare",
  description: "Zion Tech Group delivers Smart Marketing Platform - Healthcare with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/services/smart-marketing-platform-healthcare-394223e8/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>Smart Marketing Platform - Healthcare</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers Smart Marketing Platform - Healthcare with measurable outcomes.
      </p>
