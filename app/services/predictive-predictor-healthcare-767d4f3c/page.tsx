...
export const metadata: Metadata = {
  title: 'Predictive predictor-healthcare',
  description: 'The future of healthcare is here with Predictive predictor-healthcare. Powered by cutting-edge AI, this platform delivers financial risk management like never b',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive predictor-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Predictive predictor-healthcare. Powered by cutting-edge AI, this platform delivers financial risk management like never before.
          </p>
