...
export const metadata: Metadata = {
  title: 'Scalable HR Recruitment Rust (Logistics)',
  description: 'Scalable HR Recruitment Rust (Logistics) is an AI-powered logistics solution that transforms how businesses operate through intelligent automation and real-time',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/scalable-hr-recruitment-rust-(-35a337',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Scalable HR Recruitment Rust (Logistics)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Scalable HR Recruitment Rust (Logistics) is an AI-powered logistics solution that transforms how businesses operate through intelligent automation and real-time analytics.
...
TensorFlow, Fastify, Terraform, Azure, Computer Vision, Go
