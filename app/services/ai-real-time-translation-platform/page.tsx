...
export const metadata: Metadata = {
  ...
  keywords: '100+ language speech-to-text live captions, Real-time translation (bidi, 50+ language pairs), Video subtitle SRT/VTT generation, AI voice dubbing preserves tone/emotion, Zoom, Teams, YouTube, Twitch integrations, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Real-Time Translation &amp; Subtitle Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Real-time speech-to-text translation: live event captioning, multilingual Zoom/Teams captions, video subtitle generation in 100+ languages, and AI voice dubbing that preserves emotion and tone.</p>
        ...
        <li class="text-slate-300">100+ language speech-to-text live captions</li>
        <li class="text-slate-300">Real-time translation (bidi, 50+ language pairs)</li>
        <li class="text-slate-300">Video subtitle SRT/VTT generation</li>
        <li class="text-slate-300">AI voice dubbing preserves tone/emotion</li>
        <li class="text-slate-300">Zoom, Teams, YouTube, Twitch integrations</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai real-time translation &amp; subtitle platform</li>
