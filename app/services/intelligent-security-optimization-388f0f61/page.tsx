...
export const metadata: Metadata = {
  title: 'Intelligent Security Optimization',
  description: 'Transform your real-estate operations with our Intelligent Security Optimization. This AI-driven solution automates language processing with unprecedented accur',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Intelligent Security Optimization. This AI-driven solution automates language processing with unprecedented accuracy and efficiency.
          </p>
