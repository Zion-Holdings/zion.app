...
export const metadata: Metadata = {
  title: 'Smart Manager Platform - Tech',
  description: 'Revolutionize technology through intelligent automation. Our Smart Manager Platform - Tech leverages advanced machine learning to deliver feature engineering at',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manager Platform - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our Smart Manager Platform - Tech leverages advanced machine learning to deliver feature engineering at scale.
          </p>
