...
export const metadata: Metadata = {
  title: 'Deep Learning Intelligent - Tech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Deep Learning Intelligent - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your technology business with Deep Learning Intelligent - Tech. Our solution provides business continuity with enterprise-grade reliability and security.
          </p>
