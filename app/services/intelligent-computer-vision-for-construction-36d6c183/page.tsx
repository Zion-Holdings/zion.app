...
export const metadata: Metadata = {
  title: 'Intelligent Computer Vision for Construction',
  description: 'Transform your construction operations with our Intelligent Computer Vision for Construction. This AI-driven solution automates quality assurance with unprecede',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-computer-vision-for-construction-36d6c183',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Computer Vision for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Intelligent Computer Vision for Construction. This AI-driven solution automates quality assurance with unprecedented accuracy and efficiency.
          </p>
