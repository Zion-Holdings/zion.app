...
export const metadata: Metadata = {
  title: 'AI Analytics - Edge Edition',
  description: 'The future of edge is here with AI Analytics - Edge Edition. Powered by cutting-edge AI, this platform delivers process automation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-analytics---edge-edition-076f2c33',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Analytics - Edge Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of edge is here with AI Analytics - Edge Edition. Powered by cutting-edge AI, this platform delivers process automation like never before.
          </p>
