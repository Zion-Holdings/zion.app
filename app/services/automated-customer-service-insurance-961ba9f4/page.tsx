...
export const metadata: Metadata = {
  title: 'Automated customer service-insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated customer service-insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Automated customer service-insurance. This AI-powered platform transforms net promoter score into a competitive advantage.
          </p>
