...
export const metadata: Metadata = {
  title: 'Next-Gen generator-sports',
  description: 'The future of sports is here with Next-Gen generator-sports. Powered by cutting-edge AI, this platform delivers insurance automation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-generator-sports-ec0d47e1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen generator-sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Next-Gen generator-sports. Powered by cutting-edge AI, this platform delivers insurance automation like never before.
          </p>
