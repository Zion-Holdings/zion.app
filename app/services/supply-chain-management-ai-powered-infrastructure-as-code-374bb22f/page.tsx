...
export const metadata: Metadata = {
  title: 'Supply Chain Management AI-Powered Infrastructure as Code',
  description: 'AI-powered supply chain management solution for infrastructure. AI-generated infrastructure code with best practices and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/supply-chain-management-ai-powered-infrastructure-as-code-374bb22f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Supply Chain Management AI-Powered Infrastructure as Code
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered supply chain management solution for infrastructure. AI-generated infrastructure code with best practices and security.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">IaC generation</li>
          <li className="text-gray-300">Best practices</li>
          <li className="text-gray-300">Security checks</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">Secure infrastructure</li>
          <li className="text-purple-300">Best practices</li>
          </ul>
        </section>
