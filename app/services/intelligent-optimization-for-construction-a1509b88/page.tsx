...
export const metadata: Metadata = {
  title: 'Intelligent Optimization for Construction',
  description: 'Transform your construction operations with our Intelligent Optimization for Construction. This AI-driven solution automates financial planning with unprecedent',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-optimization-for-construction-a1509b88',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Optimization for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Intelligent Optimization for Construction. This AI-driven solution automates financial planning with unprecedented accuracy and efficiency.
          </p>
