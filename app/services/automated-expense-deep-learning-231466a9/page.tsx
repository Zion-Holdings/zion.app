...
export const metadata: Metadata = {
  title: 'Automated Expense Deep Learning',
  description: 'The future of retail is here with Automated Expense Deep Learning. Powered by cutting-edge AI, this platform delivers healthcare data analytics like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-expense-deep-learning-231466a9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Expense Deep Learning
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Automated Expense Deep Learning. Powered by cutting-edge AI, this platform delivers healthcare data analytics like never before.
          </p>
