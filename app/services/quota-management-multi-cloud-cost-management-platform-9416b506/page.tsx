...
export const metadata: Metadata = {
  ...
  description: 'quota management solution for petrochemicals industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quota-management-multi-cloud-cost-management-platform-9416b506',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quota Management Multi-Cloud Cost Management Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            quota management solution for petrochemicals industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.
          </p>
