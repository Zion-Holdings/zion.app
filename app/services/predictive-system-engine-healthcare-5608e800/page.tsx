...
export const metadata: Metadata = {
  title: 'Predictive System Engine - Healthcare',
  description: 'Optimize your healthcare workflows with Predictive System Engine - Healthcare. This intelligent platform delivers sourcing optimization through advanced automat',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-system-engine-healthcare-5608e800',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive System Engine - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Predictive System Engine - Healthcare. This intelligent platform delivers sourcing optimization through advanced automation and AI.
          </p>
