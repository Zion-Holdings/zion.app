...
export const metadata: Metadata = {
  title: 'Adaptive Customer Management',
  description: 'Transform your automotive operations with our Adaptive Customer Management. This AI-driven solution automates compliance monitoring with unprecedented accuracy ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your automotive operations with our Adaptive Customer Management. This AI-driven solution automates compliance monitoring with unprecedented accuracy and efficiency.
          </p>
