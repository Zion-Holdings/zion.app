...
export const metadata: Metadata = {
  title: 'Intelligent Experience for Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Intelligent Experience for Healthcare leverages advanced machine learning to deliver healthcare dat',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-experience-for-healthcare-5e69072d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Experience for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Intelligent Experience for Healthcare leverages advanced machine learning to deliver healthcare data analytics at scale.
          </p>
