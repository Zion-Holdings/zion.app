...
export const metadata: Metadata = {
  title: 'AI/IT Advisor Suite - Finance',
  description: 'Unlock unprecedented growth with AI/IT Advisor Suite - Finance. This autonomous system provides resource allocation with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-advisor-suite-finance-9ac21dcf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Advisor Suite - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with AI/IT Advisor Suite - Finance. This autonomous system provides resource allocation with zero manual intervention needed.
          </p>
