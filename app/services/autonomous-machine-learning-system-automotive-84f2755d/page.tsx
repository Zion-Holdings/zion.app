...
export const metadata: Metadata = {
  ...
  description: 'Drive innovation in automotive with Autonomous Machine Learning System - Automotive. This AI-powered platform transforms audit trail management into a competiti',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in automotive with Autonomous Machine Learning System - Automotive. This AI-powered platform transforms audit trail management into a competitive advantage.
          </p>
