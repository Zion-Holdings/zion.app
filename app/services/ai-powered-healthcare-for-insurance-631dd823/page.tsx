...
export const metadata: Metadata = {
  title: 'AI-Powered Healthcare for Insurance',
  description: 'Transform your insurance operations with our AI-Powered Healthcare for Insurance. This AI-driven solution provides intelligent automation with unprecedented acc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-healthcare-for-insurance-631dd823',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Healthcare for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our AI-Powered Healthcare for Insurance. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
