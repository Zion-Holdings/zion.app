...
export const metadata: Metadata = {
  title: 'Cognitive Cloud Solution - Insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Cloud Solution - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Cognitive Cloud Solution - Insurance. Combines expense management with adaptive intelligence for optimal results.
          </p>
