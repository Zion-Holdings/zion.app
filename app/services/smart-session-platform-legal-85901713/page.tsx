...
export const metadata: Metadata = {
  title: 'Smart Session Platform - Legal',
  description: 'Transform legal with Smart Session Platform - Legal - the intelligent automation platform that learns, adapts, and delivers 10x results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-session-platform-legal-85901713',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Session Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform legal with Smart Session Platform - Legal - the intelligent automation platform that learns, adapts, and delivers 10x results.
          </p>
