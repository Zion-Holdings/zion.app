...
export const metadata: Metadata = {
  title: 'Intelligent deep learning-hospitality',
  description: 'Enhance your hospitality business with Intelligent deep learning-hospitality. Our solution provides user provisioning with enterprise-grade reliability and secu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-deep-learning-hospitality-54a04bac',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent deep learning-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Intelligent deep learning-hospitality. Our solution provides user provisioning with enterprise-grade reliability and security.
          </p>
