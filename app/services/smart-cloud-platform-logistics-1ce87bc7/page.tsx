...
export const metadata: Metadata = {
  title: 'Smart Cloud Platform - Logistics',
  description: 'Enhance your logistics business with Smart Cloud Platform - Logistics. Our solution provides market intelligence with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-cloud-platform-logistics-1ce87bc7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Cloud Platform - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with Smart Cloud Platform - Logistics. Our solution provides market intelligence with enterprise-grade reliability and security.
          </p>
