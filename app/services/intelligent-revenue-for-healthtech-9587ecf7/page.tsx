...
export const metadata: Metadata = {
  title: 'Intelligent Revenue for HEALTHTECH',
  description: 'The future of healthtech is here with Intelligent Revenue for HEALTHTECH. Powered by cutting-edge AI, this platform delivers revenue forecasting like never befo',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Revenue for HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthtech is here with Intelligent Revenue for HEALTHTECH. Powered by cutting-edge AI, this platform delivers revenue forecasting like never before.
          </p>
