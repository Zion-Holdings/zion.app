...
export const metadata: Metadata = {
  ...
  keywords: 'AI demand forecasting (15min-7day horizons), Solar/wind generation prediction, Battery storage dispatch optimization, Real-time load balancing, Carbon emission tracking, Wholesale energy market bidding, ai, Energy & Utilities, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Energy Grid Optimization Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Grid-scale energy management: demand forecasting, renewable integration, battery dispatch optimization, real-time load balancing. Reduces energy waste by 22%.</p>
        ...
        <li class="text-slate-300">AI demand forecasting (15min-7day horizons)</li>
        <li class="text-slate-300">Solar/wind generation prediction</li>
        <li class="text-slate-300">Battery storage dispatch optimization</li>
        <li class="text-slate-300">Real-time load balancing</li>
        <li class="text-slate-300">Carbon emission tracking</li>
        <li class="text-slate-300">Wholesale energy market bidding</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce energy waste by 22%</li>
        <li class="text-slate-300">Save 15% on energy costs</li>
        <li class="text-slate-300">Improve grid reliability</li>
      </ul>
        </div>
