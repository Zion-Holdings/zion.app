...
export const metadata: Metadata = {
  title: 'Sales Smart - Education',
  description: 'Transform your education operations with our Sales Smart - Education. This AI-driven solution automates audit trail management with unprecedented accuracy and e',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Sales Smart - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your education operations with our Sales Smart - Education. This AI-driven solution automates audit trail management with unprecedented accuracy and efficiency.
          </p>
