...
export const metadata: Metadata = {
  title: 'Smart DevOps Platform - Energy',
  description: 'Enhance your energy business with Smart DevOps Platform - Energy. Our solution provides leave management with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-devops-platform-energy-d9503e57',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart DevOps Platform - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your energy business with Smart DevOps Platform - Energy. Our solution provides leave management with enterprise-grade reliability and security.
          </p>
