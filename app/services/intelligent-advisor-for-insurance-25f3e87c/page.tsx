...
export const metadata: Metadata = {
  title: 'Intelligent Advisor for Insurance',
  description: 'Optimize your insurance workflows with Intelligent Advisor for Insurance. This intelligent platform delivers supply chain through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-advisor-for-insurance-25f3e87c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Advisor for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Intelligent Advisor for Insurance. This intelligent platform delivers supply chain through advanced automation and AI.
          </p>
