...
export const metadata: Metadata = {
  title: 'Predictive Data Engine - Construction',
  description: 'Drive innovation in construction with Predictive Data Engine - Construction. This AI-powered platform transforms employee engagement into a competitive advantag',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-data-engine-construction-0a78fb65',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Data Engine - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Predictive Data Engine - Construction. This AI-powered platform transforms employee engagement into a competitive advantage.
          </p>
