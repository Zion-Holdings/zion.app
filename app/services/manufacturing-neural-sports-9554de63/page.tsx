...
export const metadata: Metadata = {
  title: 'Manufacturing Neural - Sports',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manufacturing Neural - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your sports workflows with Manufacturing Neural - Sports. This intelligent platform delivers time tracking through advanced automation and AI.
          </p>
