...
export const metadata: Metadata = {
  title: 'Document Review AI Sales Lead Scoring Engine',
  description: 'document review solution for electric vehicles industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/document-review-ai-sales-lead-scoring-engine-f1de524c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Document Review AI Sales Lead Scoring Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            document review solution for electric vehicles industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.
          </p>
