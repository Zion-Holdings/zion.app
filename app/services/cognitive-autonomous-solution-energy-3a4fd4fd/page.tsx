...
export const metadata: Metadata = {
  title: 'Cognitive Autonomous Solution - Energy',
  description: 'Optimize your energy workflows with Cognitive Autonomous Solution - Energy. This intelligent platform delivers edge computing through advanced automation and AI',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-autonomous-solution-energy-3a4fd4fd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Autonomous Solution - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your energy workflows with Cognitive Autonomous Solution - Energy. This intelligent platform delivers edge computing through advanced automation and AI.
          </p>
