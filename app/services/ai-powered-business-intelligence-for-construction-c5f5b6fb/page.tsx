...
export const metadata: Metadata = {
  title: 'AI-Powered Business Intelligence for Construction',
  description: 'Optimize your construction workflows with AI-Powered Business Intelligence for Construction. This intelligent platform delivers process automation through advan',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Business Intelligence for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with AI-Powered Business Intelligence for Construction. This intelligent platform delivers process automation through advanced automation and AI.
          </p>
