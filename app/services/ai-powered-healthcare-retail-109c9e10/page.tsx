...
export const metadata: Metadata = {
  title: 'AI-Powered healthcare-retail',
  description: 'Revolutionize retail through intelligent automation. Our AI-Powered healthcare-retail leverages advanced machine learning to deliver language processing at scal',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-healthcare-retail-109c9e10',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered healthcare-retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize retail through intelligent automation. Our AI-Powered healthcare-retail leverages advanced machine learning to deliver language processing at scale.
          </p>
