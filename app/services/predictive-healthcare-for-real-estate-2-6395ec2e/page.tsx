  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Predictive Healthcare for Real-Estate #2</h1>
        <p className="text-lg text-gray-300 mb-8">The future of real-estate is here with Predictive Healthcare for Real-Estate #2. Powered by cutting-edge AI, this platform delivers supply chain like never before.</p>
