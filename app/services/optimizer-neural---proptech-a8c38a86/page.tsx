...
export const metadata: Metadata = {
  title: 'Optimizer Neural - Proptech',
  description: 'Revolutionize proptech through intelligent automation. Our Optimizer Neural - Proptech leverages advanced machine learning to deliver document processing at sca',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/optimizer-neural---proptech-a8c38a86',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Optimizer Neural - Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our Optimizer Neural - Proptech leverages advanced machine learning to deliver document processing at scale.
          </p>
