...
export const metadata: Metadata = {
  title: 'Cognitive Document Platform',
  description: 'Revolutionize logistics through intelligent automation. Our Cognitive Document Platform leverages advanced machine learning to deliver enterprise-grade insights',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-document-platform-5fc93852',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Document Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Cognitive Document Platform leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
