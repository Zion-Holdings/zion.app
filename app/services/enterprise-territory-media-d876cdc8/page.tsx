...
export const metadata: Metadata = {
  title: 'Enterprise Territory - Media',
  description: 'Enhance your media business with Enterprise Territory - Media. Our solution provides supply chain with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-territory-media-d876cdc8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Territory - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your media business with Enterprise Territory - Media. Our solution provides supply chain with enterprise-grade reliability and security.
          </p>
