...
export const metadata: Metadata = {
  title: 'Smart insights-agriculture',
  description: 'Enhance your agriculture business with Smart insights-agriculture. Our solution provides social media monitoring with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-insights-agriculture-1b48bc9c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart insights-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your agriculture business with Smart insights-agriculture. Our solution provides social media monitoring with enterprise-grade reliability and security.
          </p>
