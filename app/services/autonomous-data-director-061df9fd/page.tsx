...
export const metadata: Metadata = {
  title: 'Autonomous Data Director',
  description: 'Transform your hospitality operations with our Autonomous Data Director. This AI-driven solution automates hr analytics with unprecedented accuracy and efficien',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-data-director-061df9fd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Data Director
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Autonomous Data Director. This AI-driven solution automates hr analytics with unprecedented accuracy and efficiency.
          </p>
