...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{'@context': 'https://schema.org', '@type': 'Service', 'name': 'Network Automation & Intent-Based Networking', 'description': 'Automate network configuration with intent-based networking. Define desired state, platform enforces it. Eliminate config drift and manual CLI errors.', 'serviceType': 'it', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'Networking'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'Network Automation & Intent-Based Networking Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$799/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$2,499/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': '$7,999/mo', 'priceCurrency': 'USD'}]}} }/>
    <JsonLd data={{'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'Intent-based network configuration', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Intent-based network configuration'}}, {'@type': 'Question', 'name': 'Automated compliance and drift remediation', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Automated compliance and drift remediation'}}, {'@type': 'Question', 'name': 'Zero-touch provisioning (ZTP)', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Zero-touch provisioning (ZTP)'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Eliminate manual CLI configuration errors; Intent-based: describe what, not how; Automated drift remediation keeps network compliant'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} }/>
