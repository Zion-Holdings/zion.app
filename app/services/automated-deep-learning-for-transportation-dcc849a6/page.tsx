...
export const metadata: Metadata = {
  title: 'Automated Deep Learning for Transportation',
  description: 'Drive innovation in transportation with Automated Deep Learning for Transportation. This AI-powered platform transforms sourcing optimization into a competitive',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-deep-learning-for-transportation-dcc849a6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Deep Learning for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in transportation with Automated Deep Learning for Transportation. This AI-powered platform transforms sourcing optimization into a competitive advantage.
          </p>
