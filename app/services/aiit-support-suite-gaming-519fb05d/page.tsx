...
export const metadata: Metadata = {
  title: 'AI/IT Support Suite - Gaming',
  description: 'Revolutionize gaming through intelligent automation. Our AI/IT Support Suite - Gaming leverages advanced machine learning to deliver training optimization at sc',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Support Suite - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize gaming through intelligent automation. Our AI/IT Support Suite - Gaming leverages advanced machine learning to deliver training optimization at scale.
          </p>
