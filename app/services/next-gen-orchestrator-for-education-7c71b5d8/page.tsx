...
export const metadata: Metadata = {
  title: 'Next-Gen Orchestrator for Education',
  description: 'Enhance your education business with Next-Gen Orchestrator for Education. Our solution provides customer journey mapping with enterprise-grade reliability and s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-orchestrator-for-education-7c71b5d8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Orchestrator for Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your education business with Next-Gen Orchestrator for Education. Our solution provides customer journey mapping with enterprise-grade reliability and security.
          </p>
