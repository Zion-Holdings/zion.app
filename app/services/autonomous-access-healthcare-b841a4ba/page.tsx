...
export const metadata: Metadata = {
  title: 'Autonomous Access Healthcare',
  description: 'Revolutionize construction through intelligent automation. Our Autonomous Access Healthcare leverages advanced machine learning to deliver user provisioning at ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-access-healthcare-b841a4ba',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Access Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Autonomous Access Healthcare leverages advanced machine learning to deliver user provisioning at scale.
          </p>
