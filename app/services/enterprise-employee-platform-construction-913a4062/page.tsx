...
export const metadata: Metadata = {
  title: 'Enterprise Employee Platform - Construction',
  description: 'Drive innovation in construction with Enterprise Employee Platform - Construction. This AI-powered platform transforms receipt processing into a competitive adv',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Employee Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Enterprise Employee Platform - Construction. This AI-powered platform transforms receipt processing into a competitive advantage.
          </p>
