...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time sign language recognition, Text/gesture to sign language avatar, Video call sign language interpretation, Website accessibility overlay, Support for 20+ sign languages, Custom vocabulary training, API for embedding in any application, Compliance with ADA and accessibility standards, ai, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Sign Language Translation &amp; Accessibility</h1>
        <p className="text-lg text-slate-300 mb-8">Real-time AI sign language translation for video calls, websites, and public spaces. Supports ASL, BSL, and 20+ sign languages. Make your content accessible to the Deaf community.</p>
        ...
        <li class="text-slate-300">Real-time sign language recognition</li>
        <li class="text-slate-300">Text/gesture to sign language avatar</li>
        <li class="text-slate-300">Video call sign language interpretation</li>
        <li class="text-slate-300">Website accessibility overlay</li>
        <li class="text-slate-300">Support for 20+ sign languages</li>
        <li class="text-slate-300">Custom vocabulary training</li>
        <li class="text-slate-300">API for embedding in any application</li>
        <li class="text-slate-300">Compliance with ADA and accessibility standards</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Make content accessible to 70M+ Deaf worldwide</li>
        <li class="text-slate-300">Real-time translation for video calls</li>
        <li class="text-slate-300">Comply with ADA accessibility requirements</li>
        <li class="text-slate-300">Support 20+ sign languages globally</li>
      </ul>
        </div>
