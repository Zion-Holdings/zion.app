...
export const metadata = {
  ...
  description: "Real-time AI sign language translation for video calls, websites, and public spaces. Supports ASL, BSL, and 20+ sign languages. Make your content accessible to ",
  alternates: {
