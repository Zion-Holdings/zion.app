...
export const metadata: Metadata = {
  title: 'Smart Risk for Hospitality',
  description: 'Next-generation hospitality solution: Smart Risk for Hospitality. Combines user experience with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-risk-for-hospitality-c202bf6c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Risk for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Smart Risk for Hospitality. Combines user experience with adaptive intelligence for optimal results.
          </p>
