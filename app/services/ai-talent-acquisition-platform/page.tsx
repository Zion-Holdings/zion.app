...
export const metadata: Metadata = {
  ...
  keywords: 'Resume parsing & scoring, Candidate-job fit matching, Automated interview scheduling, Bias detection, Offer management, ai, Sustainability, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Talent Acquisition Platform</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end recruiting: resume parsing, candidate matching, interview scheduling, bias detection. Integrates with Greenhouse, Lever.</p>
        ...
        <li class="text-slate-300">Candidate-job fit matching</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai talent acquisition platform</li>
