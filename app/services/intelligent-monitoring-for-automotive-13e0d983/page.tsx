export const metadata = {
  title: "Intelligent Monitoring for Automotive",
  description: "Zion Tech Group delivers Intelligent Monitoring for Automotive with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/services/intelligent-monitoring-for-automotive-13e0d983/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>Intelligent Monitoring for Automotive</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers Intelligent Monitoring for Automotive with measurable outcomes.
      </p>
