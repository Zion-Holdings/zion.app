...
export const metadata: Metadata = {
  title: 'Intelligent Supply for Logistics #1',
  description: 'Enhance your logistics business with Intelligent Supply for Logistics #1. Our solution provides compliance reporting with enterprise-grade reliability and secur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-supply-for-logistics-1-e021119d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Supply for Logistics #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with Intelligent Supply for Logistics #1. Our solution provides compliance reporting with enterprise-grade reliability and security.
          </p>
