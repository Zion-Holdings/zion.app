...
export const metadata: Metadata = {
  ...
  description: 'Analyzes blockchain transactions and smart contracts using AI to detect patterns.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-blockchain-analytics-dfa3b87e',
  },

export const metadata = {
  title: "AI-Powered Blockchain Analytics - Zion Tech Group",
  description: "Analyzes blockchain transactions and smart contracts using AI to detect patterns.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-blockchain-analytics-dfa3b87e`
  }
  ...
  return (
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Analyzes blockchain transactions and smart contracts using AI to detect patterns.
          </p>
    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">AI-Powered Blockchain Analytics</h1>
        <p className="text-lg text-gray-300 mb-8">Analyzes blockchain transactions and smart contracts using AI to detect patterns.</p>
