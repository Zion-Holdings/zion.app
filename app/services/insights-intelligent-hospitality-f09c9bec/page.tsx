...
export const metadata: Metadata = {
  title: 'Insights Intelligent - Hospitality',
  description: 'Optimize your hospitality workflows with Insights Intelligent - Hospitality. This intelligent platform delivers financial planning through advanced automation a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Insights Intelligent - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Insights Intelligent - Hospitality. This intelligent platform delivers financial planning through advanced automation and AI.
          </p>
