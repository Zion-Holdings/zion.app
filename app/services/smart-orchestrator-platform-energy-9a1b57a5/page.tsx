      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your energy business with Smart Orchestrator Platform - Energy. Our solution provides budget tracking with enterprise-grade reliability and security.
          </p>
