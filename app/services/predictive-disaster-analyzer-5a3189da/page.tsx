...
export const metadata: Metadata = {
  title: 'Predictive Disaster Analyzer',
  description: 'Drive innovation in sports with Predictive Disaster Analyzer. This AI-powered platform transforms resource allocation into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-disaster-analyzer-5a3189da',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Disaster Analyzer
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in sports with Predictive Disaster Analyzer. This AI-powered platform transforms resource allocation into a competitive advantage.
          </p>
