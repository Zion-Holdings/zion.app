...
export const metadata: Metadata = {
  title: 'Smart Data Science Platform - Logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Smart Data Science Platform - Logistics leverages advanced machine learning to deliver customer jour',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-data-science-platform-logistics-5d4fe7e3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Data Science Platform - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Smart Data Science Platform - Logistics leverages advanced machine learning to deliver customer journey mapping at scale.
          </p>
