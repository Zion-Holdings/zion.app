...
export const metadata: Metadata = {
  ...
  keywords: 'Feature engineering from usage & billing data, Gradient boosting & survival analysis models, Risk score per account (1-100), Automated retention offer triggers, Dashboard with cohort analysis, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Predictive Churn Risk Scoring</h1>
        <p className="text-lg text-slate-300 mb-8">Machine learning model to predict which customers will churn with 90%+ accuracy; trigger retention workflows before cancellation.</p>
        ...
        <li class="text-slate-300">Feature engineering from usage &amp; billing data</li>
        <li class="text-slate-300">Gradient boosting &amp; survival analysis models</li>
        <li class="text-slate-300">Risk score per account (1-100)</li>
        <li class="text-slate-300">Automated retention offer triggers</li>
        <li class="text-slate-300">Dashboard with cohort analysis</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with predictive churn risk scoring</li>
