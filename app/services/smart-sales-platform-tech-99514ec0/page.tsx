...
export const metadata: Metadata = {
  title: 'Smart Sales Platform - Tech',
  description: 'Transform your technology operations with our Smart Sales Platform - Tech. This AI-driven solution automates expense management with unprecedented accuracy and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-sales-platform-tech-99514ec0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Sales Platform - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your technology operations with our Smart Sales Platform - Tech. This AI-driven solution automates expense management with unprecedented accuracy and efficiency.
          </p>
