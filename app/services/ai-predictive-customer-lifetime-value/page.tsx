...
export const metadata = {
  ...
  description: "Predict customer lifetime value (CLV) using advanced ML models that analyze behavioral patterns, transaction history, engagement metrics, and external signals. ",
  alternates: {
