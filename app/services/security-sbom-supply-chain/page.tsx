  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">SBOM &amp; Supply Chain Security</h1>
        <p className="text-lg text-slate-300 mb-8">Supply chain security platform: SBOM &amp; VEX generation (every build/build event), CVE SLSA provenance score, dependency-graph diff for every PR, SLSA Level 3 attestation, reproducible-build verification.</p>
        ...
        <li class="text-slate-300">SBOM + VEX generated per build with CycloneDX + SPDX dual-format</li>
        <li class="text-slate-300">CVE + SLSA provenance score every build — compare across time and distributors</li>
        <li class="text-slate-300">Dependency-graph diff per PR — highlight transitive dependency changes before merge</li>
        <li class="text-slate-300">SSL SA L3 attestation with reproducible-build verification per environment</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with sbom &amp; supply chain security</li>
