...
export const metadata: Metadata = {
  title: 'Intelligent Engine for Agritech',
  description: 'Next-generation agritech solution: Intelligent Engine for Agritech. Combines financial planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-engine-for-agritech-8c9e7b2f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Engine for Agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agritech solution: Intelligent Engine for Agritech. Combines financial planning with adaptive intelligence for optimal results.
          </p>
