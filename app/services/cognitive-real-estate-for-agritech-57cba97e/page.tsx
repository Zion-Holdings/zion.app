...
export const metadata: Metadata = {
  title: 'Cognitive Real Estate for Agritech',
  description: 'The future of agritech is here with Cognitive Real Estate for Agritech. Powered by cutting-edge AI, this platform delivers risk assessment like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-real-estate-for-agritech-57cba97e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Real Estate for Agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agritech is here with Cognitive Real Estate for Agritech. Powered by cutting-edge AI, this platform delivers risk assessment like never before.
          </p>
