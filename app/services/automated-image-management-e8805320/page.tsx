...
export const metadata: Metadata = {
  title: 'Automated Image Management',
  description: 'The future of construction is here with Automated Image Management. Powered by cutting-edge AI, this platform delivers transformative results like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-image-management-e8805320',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Automated Image Management. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
