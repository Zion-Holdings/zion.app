...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-source feedback aggregation, AI theme and topic extraction, Sentiment trend tracking, NPS and CSAT analysis, Actionable insight generation, Integration with Zendesk, SurveyMonkey, Custom categorization models, Executive summary reports, ai, Customer Success, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Customer Feedback Analyzer</h1>
        <p className="text-lg text-slate-300 mb-8">Analyze customer feedback from surveys, reviews, support tickets, and social media. AI-powered theme extraction, sentiment tracking, and actionable insight generation.</p>
        ...
        <li class="text-slate-300">Multi-source feedback aggregation</li>
        <li class="text-slate-300">AI theme and topic extraction</li>
        <li class="text-slate-300">Sentiment trend tracking</li>
        <li class="text-slate-300">NPS and CSAT analysis</li>
        <li class="text-slate-300">Actionable insight generation</li>
        <li class="text-slate-300">Integration with Zendesk, SurveyMonkey</li>
        <li class="text-slate-300">Custom categorization models</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Understand customer pain points at scale</li>
        <li class="text-slate-300">Track satisfaction trends over time</li>
        <li class="text-slate-300">Prioritize product improvements</li>
        <li class="text-slate-300">Close the feedback loop faster</li>
      </ul>
        </div>
