...
export const metadata: Metadata = {
  ...
  keywords: '24/7 security monitoring (SIEM), Threat hunting & proactive investigation, Incident response (IR) on call, Compliance reporting (PCI-DSS, HIPAA, GDPR), Regular executive security briefings, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Security Operations Center as a Service (SOCaaS)</h1>
        <p className="text-lg text-slate-300 mb-8">24/7 managed security monitoring, threat hunting, incident response, and compliance reporting — no need to build your own SOC.</p>
        ...
        <li class="text-slate-300">24/7 security monitoring (SIEM)</li>
        <li class="text-slate-300">Threat hunting &amp; proactive investigation</li>
        <li class="text-slate-300">Incident response (IR) on call</li>
        <li class="text-slate-300">Compliance reporting (PCI-DSS, HIPAA, GDPR)</li>
        <li class="text-slate-300">Regular executive security briefings</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with security operations center as a service (socaas)</li>
