...
export const metadata: Metadata = {
  title: 'AI/IT Orchestrator Suite - ALTHEALTH',
  description: 'Drive innovation in althealth with AI/IT Orchestrator Suite - ALTHEALTH. This AI-powered platform transforms esg reporting into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-orchestrator-suite-althealth-80f3376e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Orchestrator Suite - ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in althealth with AI/IT Orchestrator Suite - ALTHEALTH. This AI-powered platform transforms esg reporting into a competitive advantage.
          </p>
