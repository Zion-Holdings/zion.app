...
export const metadata: Metadata = {
  title: 'Finance Cognitive - Retail',
  description: 'Next-generation retail solution: Finance Cognitive - Retail. Combines inventory management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/finance-cognitive---retail-5d25722b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Finance Cognitive - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation retail solution: Finance Cognitive - Retail. Combines inventory management with adaptive intelligence for optimal results.
          </p>
