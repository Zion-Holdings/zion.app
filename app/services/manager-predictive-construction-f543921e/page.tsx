...
export const metadata: Metadata = {
  title: 'Manager Predictive - Construction',
  description: 'The future of construction is here with Manager Predictive - Construction. Powered by cutting-edge AI, this platform delivers account planning like never before',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/manager-predictive-construction-f543921e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manager Predictive - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Manager Predictive - Construction. Powered by cutting-edge AI, this platform delivers account planning like never before.
          </p>
