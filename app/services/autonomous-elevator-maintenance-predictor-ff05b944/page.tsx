...
export const metadata: Metadata = {
  title: 'Autonomous Elevator Maintenance Predictor',
  description: 'Predictive maintenance for elevator fleets using vibration and door-cycle telemetry.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-elevator-maintenance-predictor-ff05b944',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Elevator Maintenance Predictor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Predictive maintenance for elevator fleets using vibration and door-cycle telemetry.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your facilities operations?</p>
