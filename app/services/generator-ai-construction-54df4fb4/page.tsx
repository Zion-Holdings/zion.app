...
export const metadata: Metadata = {
  title: 'Generator AI - Construction',
  description: 'Optimize your construction workflows with Generator AI - Construction. This intelligent platform delivers cost reduction through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/generator-ai-construction-54df4fb4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Generator AI - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Generator AI - Construction. This intelligent platform delivers cost reduction through advanced automation and AI.
          </p>
