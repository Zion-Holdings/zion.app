...
export const metadata: Metadata = {
  title: 'Smart Cognitive Platform - FINTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Cognitive Platform - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation fintech solution: Smart Cognitive Platform - FINTECH. Combines edge computing with adaptive intelligence for optimal results.
          </p>
