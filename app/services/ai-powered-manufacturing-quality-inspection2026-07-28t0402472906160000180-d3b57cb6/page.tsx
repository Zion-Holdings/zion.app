...
export const metadata: Metadata = {
  title: 'AI-Powered Manufacturing Quality Inspection',
  description: 'Computer vision system that detects defects with 99.9% accuracy.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-manufacturing-quality-inspection2026-07-28t0402472906160000180-d3b57cb6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Computer vision system that detects defects with 99.9% accuracy.
          </p>
