...
export const metadata: Metadata = {
  title: 'AI-Powered Manager for Hospitality #1',
  description: 'The future of hospitality is here with AI-Powered Manager for Hospitality #1. Powered by cutting-edge AI, this platform delivers logistics route optimization li',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-manager-for-hospitality-1-a87035d6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Manager for Hospitality #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with AI-Powered Manager for Hospitality #1. Powered by cutting-edge AI, this platform delivers logistics route optimization like never before.
          </p>
