...
export const metadata: Metadata = {
  title: 'Neural Security for Iot',
  description: 'Next-generation iot solution: Neural Security for Iot. Combines market intelligence with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-security-for-iot-8ffd112d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Security for Iot
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation iot solution: Neural Security for Iot. Combines market intelligence with adaptive intelligence for optimal results.
          </p>
