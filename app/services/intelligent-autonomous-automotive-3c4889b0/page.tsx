...
export const metadata: Metadata = {
  title: 'Intelligent autonomous-automotive',
  description: 'Drive innovation in automotive with Intelligent autonomous-automotive. This AI-powered platform transforms social media monitoring into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-autonomous-automotive-3c4889b0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent autonomous-automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in automotive with Intelligent autonomous-automotive. This AI-powered platform transforms social media monitoring into a competitive advantage.
          </p>
