...
export const metadata: Metadata = {
  ...
  description: 'End-to-end algorithmic trading platform that generates, backtests, and deploys trading strategies using machine learning.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-algorithmic-trading-intelligence2026-07-28t0356460584380000177-f0070e16',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            End-to-end algorithmic trading platform that generates, backtests, and deploys trading strategies using machine learning.
          </p>
