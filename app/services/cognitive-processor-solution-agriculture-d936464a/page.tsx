...
export const metadata: Metadata = {
  ...
  description: 'Drive innovation in agriculture with Cognitive Processor Solution - Agriculture. This AI-powered platform transforms market analysis into a competitive advantag',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in agriculture with Cognitive Processor Solution - Agriculture. This AI-powered platform transforms market analysis into a competitive advantage.
          </p>
