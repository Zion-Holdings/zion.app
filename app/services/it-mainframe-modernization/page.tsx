...
export const metadata: Metadata = {
  ...
  keywords: 'Automated COBOL to Java/TS conversion, Database migration (DB2 → PostgreSQL), Replatform to Azure/AWS mainframe alternatives, Cutover orchestration, Regression testing suite, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Mainframe Modernization Service</h1>
        <p className="text-lg text-slate-300 mb-8">Rehost, replatform, or refactor COBOL/PL1 applications to cloud. Automated code conversion, database migration, and cutover planning.</p>
        ...
        <li class="text-slate-300">Automated COBOL to Java/TS conversion</li>
        <li class="text-slate-300">Database migration (DB2 → PostgreSQL)</li>
        <li class="text-slate-300">Replatform to Azure/AWS mainframe alternatives</li>
        <li class="text-slate-300">Cutover orchestration</li>
        <li class="text-slate-300">Regression testing suite</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with mainframe modernization service</li>
