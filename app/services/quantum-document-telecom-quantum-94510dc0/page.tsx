...
export const metadata: Metadata = {
  title: 'Quantum Document - Telecom Quantum',
  description: 'The future of telecom is here with Quantum Document - Telecom Quantum. Powered by cutting-edge AI, this platform delivers anomaly detection like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-document-telecom-quantum-94510dc0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Document - Telecom Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of telecom is here with Quantum Document - Telecom Quantum. Powered by cutting-edge AI, this platform delivers anomaly detection like never before.
          </p>
