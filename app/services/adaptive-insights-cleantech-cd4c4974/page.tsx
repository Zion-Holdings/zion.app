...
export const metadata: Metadata = {
  title: 'Adaptive insights-cleantech',
  description: 'Transform your cleantech operations with our Adaptive insights-cleantech. This AI-driven solution automates inventory management with unprecedented accuracy and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-insights-cleantech-cd4c4974',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive insights-cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your cleantech operations with our Adaptive insights-cleantech. This AI-driven solution automates inventory management with unprecedented accuracy and efficiency.
          </p>
