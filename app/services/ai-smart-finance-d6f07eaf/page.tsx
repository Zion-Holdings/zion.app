...
export const metadata: Metadata = {
  title: 'AI Smart - Finance',
  description: 'The future of finance is here with AI Smart - Finance. Powered by cutting-edge AI, this platform delivers transformative results like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-smart-finance-d6f07eaf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of finance is here with AI Smart - Finance. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
