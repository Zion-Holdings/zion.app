...
export const metadata: Metadata = {
  title: 'Cloud Autonomous - Sports',
  description: 'Next-generation sports solution: Cloud Autonomous - Sports. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cloud-autonomous-sports-9f653c5f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cloud Autonomous - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation sports solution: Cloud Autonomous - Sports. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
