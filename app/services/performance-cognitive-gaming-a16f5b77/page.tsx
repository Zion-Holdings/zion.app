...
export const metadata: Metadata = {
  title: 'Performance Cognitive - Gaming',
  description: 'Enhance your gaming business with Performance Cognitive - Gaming. Our solution provides master data management with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/performance-cognitive-gaming-a16f5b77',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Performance Cognitive - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your gaming business with Performance Cognitive - Gaming. Our solution provides master data management with enterprise-grade reliability and security.
          </p>
