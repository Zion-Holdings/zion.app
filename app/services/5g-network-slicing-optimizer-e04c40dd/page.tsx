...
export const metadata = {
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/5g-network-slicing-optimizer-e04c40dd`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path={`/services/5g-network-slicing-optimizer-e04c40dd`} title="5G Network Slicing Optimizer" />
