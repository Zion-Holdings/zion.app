...
export const metadata: Metadata = {
  title: 'Predictive Healthcare for Healthcare',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Healthcare for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Predictive Healthcare for Healthcare leverages advanced machine learning to deliver user experience at scale.
          </p>
