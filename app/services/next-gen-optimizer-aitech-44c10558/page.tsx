...
export const metadata: Metadata = {
  title: 'Next-Gen optimizer-aitech',
  description: 'Drive innovation in aitech with Next-Gen optimizer-aitech. This AI-powered platform transforms invoice processing into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-optimizer-aitech-44c10558',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen optimizer-aitech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in aitech with Next-Gen optimizer-aitech. This AI-powered platform transforms invoice processing into a competitive advantage.
          </p>
