...
export const metadata: Metadata = {
  title: 'Predictive real estate-legal',
  description: 'Enhance your legal business with Predictive real estate-legal. Our solution provides personalization engine with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-real-estate-legal-bdea4b58',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive real estate-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Predictive real estate-legal. Our solution provides personalization engine with enterprise-grade reliability and security.
          </p>
