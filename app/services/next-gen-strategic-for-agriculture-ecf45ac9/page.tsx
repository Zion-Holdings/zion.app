...
export const metadata: Metadata = {
  ...
  description: 'Next-generation agriculture solution: Next-Gen Strategic for Agriculture. Combines forecast accuracy with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-strategic-for-agriculture-ecf45ac9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agriculture solution: Next-Gen Strategic for Agriculture. Combines forecast accuracy with adaptive intelligence for optimal results.
          </p>
