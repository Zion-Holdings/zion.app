...
export const metadata: Metadata = {
  title: 'Adaptive NLP for Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Adaptive NLP for Insurance leverages advanced machine learning to deliver influencer identification ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive NLP for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Adaptive NLP for Insurance leverages advanced machine learning to deliver influencer identification at scale.
          </p>
