...
export const metadata: Metadata = {
  title: 'Healthcare Automated - Transportation',
  description: 'Next-generation transportation solution: Healthcare Automated - Transportation. Combines compliance monitoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/healthcare-automated-transportation-b0c23475',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Healthcare Automated - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation transportation solution: Healthcare Automated - Transportation. Combines compliance monitoring with adaptive intelligence for optimal results.
          </p>
