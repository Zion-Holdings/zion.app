...
export const metadata: Metadata = {
  title: 'Onboarding AI-Powered SEO Content Engine',
  description: 'onboarding solution for public safety industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing copy.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/onboarding-ai-powered-seo-content-engine-7fd732ba',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Onboarding AI-Powered SEO Content Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            onboarding solution for public safety industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing copy.
          </p>
