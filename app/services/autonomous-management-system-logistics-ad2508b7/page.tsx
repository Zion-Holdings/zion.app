...
export const metadata: Metadata = {
  title: 'Autonomous Management System - Logistics',
  description: 'The future of logistics is here with Autonomous Management System - Logistics. Powered by cutting-edge AI, this platform delivers audit trail management like ne',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-management-system-logistics-ad2508b7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Management System - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Autonomous Management System - Logistics. Powered by cutting-edge AI, this platform delivers audit trail management like never before.
          </p>
