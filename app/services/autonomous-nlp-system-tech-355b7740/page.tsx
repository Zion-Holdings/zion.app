...
export const metadata: Metadata = {
  title: 'Autonomous NLP System - Tech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous NLP System - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Autonomous NLP System - Tech. This autonomous system provides customer insights with zero manual intervention needed.
          </p>
