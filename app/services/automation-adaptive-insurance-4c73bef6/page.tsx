...
export const metadata: Metadata = {
  title: 'Automation Adaptive - Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Automation Adaptive - Insurance leverages advanced machine learning to deliver enterprise-grade insi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automation-adaptive-insurance-4c73bef6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automation Adaptive - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Automation Adaptive - Insurance leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
