...
export const metadata: Metadata = {
  title: 'Smart Analytics Platform - Telecom',
  description: 'The future of telecom is here with Smart Analytics Platform - Telecom. Powered by cutting-edge AI, this platform delivers logistics route optimization like neve',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-analytics-platform-telecom-c1e5724e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Analytics Platform - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of telecom is here with Smart Analytics Platform - Telecom. Powered by cutting-edge AI, this platform delivers logistics route optimization like never before.
          </p>
