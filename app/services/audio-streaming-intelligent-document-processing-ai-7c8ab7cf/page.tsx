...
export const metadata = {
  ...
  description: "AI-powered audio streaming solution for operations. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatica",
  alternates: {
    canonical: `https://ziontechgroup.com/services/audio-streaming-intelligent-document-processing-ai-7c8ab7cf`
  }
};
