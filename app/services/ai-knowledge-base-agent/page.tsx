...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-source document ingestion (PDF, DOC, Confluence, Notion), Semantic search with natural language queries, Automated knowledge graph construction, Answer citation & source linking, Real-time sync with source systems, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Knowledge Base &amp; Knowledge Graph Agent</h1>
        <p className="text-lg text-slate-300 mb-8">Turn your documents, wikis, and internal data into an intelligent, queryable knowledge graph with conversational AI search and automated content synchronization.</p>
        ...
        <li class="text-slate-300">Multi-source document ingestion (PDF, DOC, Confluence, Notion)</li>
        <li class="text-slate-300">Semantic search with natural language queries</li>
        <li class="text-slate-300">Automated knowledge graph construction</li>
        <li class="text-slate-300">Answer citation &amp; source linking</li>
        <li class="text-slate-300">Real-time sync with source systems</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai knowledge base &amp; knowledge graph agent</li>
