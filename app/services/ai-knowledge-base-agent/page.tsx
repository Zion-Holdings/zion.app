      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Turn your documents, wikis, and internal data into an intelligent, queryable knowledge graph with conversational AI search and automated content synchronization.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Multi-source document ingestion (PDF, DOC, Confluence, Notion)</li>
            <li className="text-purple-300">✓ Semantic search with natural language queries</li>
            <li className="text-purple-300">✓ Automated knowledge graph construction</li>
            <li className="text-purple-300">✓ Answer citation & source linking</li>
            <li className="text-purple-300">✓ Real-time sync with source systems</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai knowledge base & knowledge graph agent</li>
