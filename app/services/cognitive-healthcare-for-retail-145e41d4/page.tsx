  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path={`/services/{service_id}`} title="Cognitive Healthcare for Retail" />
        <h1 className="text-4xl font-bold mb-6">Cognitive Healthcare for Retail</h1>
        <p className="text-lg text-gray-300 mb-8">Transform your Retail operations with our Cognitive Healthcare for Retail. This AI-driven solution automates manufacturing quality control with unprecedented ac</p>
