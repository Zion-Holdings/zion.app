...
export const metadata: Metadata = {
  title: 'Cognitive Finance for Tech',
  description: 'Drive innovation in technology with Cognitive Finance for Tech. This AI-powered platform transforms scalability planning into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-finance-for-tech-89e01562',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Finance for Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in technology with Cognitive Finance for Tech. This AI-powered platform transforms scalability planning into a competitive advantage.
          </p>
