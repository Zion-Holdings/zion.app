...
export const metadata: Metadata = {
  title: 'Intelligent Monitoring for Hospitality',
  description: 'Enhance your hospitality business with Intelligent Monitoring for Hospitality. Our solution provides language processing with enterprise-grade reliability and s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-monitoring-for-hospitality-7137796d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Monitoring for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Intelligent Monitoring for Hospitality. Our solution provides language processing with enterprise-grade reliability and security.
          </p>
