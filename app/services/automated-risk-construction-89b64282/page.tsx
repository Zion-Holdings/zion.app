      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Automated risk-construction. This intelligent platform delivers forecast accuracy through advanced automation and AI.
          </p>
