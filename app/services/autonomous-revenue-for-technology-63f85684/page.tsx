...
export const metadata: Metadata = {
  title: 'Autonomous Revenue for Technology',
  description: 'Revolutionize technology through intelligent automation. Our Autonomous Revenue for Technology leverages advanced machine learning to deliver customer insights ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Revenue for Technology
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our Autonomous Revenue for Technology leverages advanced machine learning to deliver customer insights at scale.
          </p>
