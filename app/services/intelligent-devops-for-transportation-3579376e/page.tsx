...
export const metadata: Metadata = {
  title: 'Intelligent DevOps for Transportation',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent DevOps for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated transportation solution: Intelligent DevOps for Transportation. Combines process automation with next-gen AI for maximum velocity.
          </p>
