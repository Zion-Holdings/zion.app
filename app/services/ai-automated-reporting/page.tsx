      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Turn raw data into formatted PDF/PPT reports with natural language summaries. Schedule distributions to stakeholders.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Natural language summaries</li>
            <li className="text-purple-300">✓ Custom templates (PDF, PPT)</li>
            <li className="text-purple-300">✓ Scheduled distribution</li>
            <li className="text-purple-300">✓ Drill-down charts</li>
            <li className="text-purple-300">✓ Email & Slack delivery</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with automated reporting engine</li>
