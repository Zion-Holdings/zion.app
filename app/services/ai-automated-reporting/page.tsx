...
export const metadata: Metadata = {
  ...
  keywords: 'Natural language summaries, Custom templates (PDF, PPT), Scheduled distribution, Drill-down charts, Email & Slack delivery, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Automated Reporting Engine</h1>
        <p className="text-lg text-slate-300 mb-8">Turn raw data into formatted PDF/PPT reports with natural language summaries. Schedule distributions to stakeholders.</p>
        ...
        <li class="text-slate-300">Natural language summaries</li>
        <li class="text-slate-300">Custom templates (PDF, PPT)</li>
        <li class="text-slate-300">Scheduled distribution</li>
        <li class="text-slate-300">Drill-down charts</li>
        <li class="text-slate-300">Email &amp; Slack delivery</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with automated reporting engine</li>
