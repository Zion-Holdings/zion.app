...
export const metadata: Metadata = {
  title: 'Smart Monitoring for Energy',
  description: 'Revolutionize energy through intelligent automation. Our Smart Monitoring for Energy leverages advanced machine learning to deliver content generation at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-monitoring-for-energy-c253cf6e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Monitoring for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Smart Monitoring for Energy leverages advanced machine learning to deliver content generation at scale.
          </p>
