...
export const metadata: Metadata = {
  title: 'AI/IT Experience Suite - Telecom',
  description: 'Hyper-accelerated telecom solution: AI/IT Experience Suite - Telecom. Combines access management with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-experience-suite-telecom-287a8357',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Experience Suite - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated telecom solution: AI/IT Experience Suite - Telecom. Combines access management with next-gen AI for maximum velocity.
          </p>
