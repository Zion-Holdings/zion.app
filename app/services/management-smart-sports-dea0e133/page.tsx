...
export const metadata: Metadata = {
  title: 'Management Smart - Sports',
  description: 'Next-generation sports solution: Management Smart - Sports. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/management-smart-sports-dea0e133',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Management Smart - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation sports solution: Management Smart - Sports. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
