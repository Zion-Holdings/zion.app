...
export const metadata: Metadata = {
  title: 'Smart Performance Platform - Sports',
  description: 'Revolutionize sports through intelligent automation. Our Smart Performance Platform - Sports leverages advanced machine learning to deliver data governance at s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-performance-platform-sports-74bede20',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Performance Platform - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Smart Performance Platform - Sports leverages advanced machine learning to deliver data governance at scale.
          </p>
