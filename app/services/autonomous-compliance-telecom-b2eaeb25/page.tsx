...
export const metadata: Metadata = {
  title: 'Autonomous compliance-telecom',
  description: 'Revolutionize telecom through intelligent automation. Our Autonomous compliance-telecom leverages advanced machine learning to deliver social media monitoring a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous compliance-telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Autonomous compliance-telecom leverages advanced machine learning to deliver social media monitoring at scale.
          </p>
