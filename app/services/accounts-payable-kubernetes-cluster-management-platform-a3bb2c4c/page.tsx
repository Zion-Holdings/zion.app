...
export const metadata: Metadata = {
  title: 'Accounts Payable Kubernetes Cluster Management Platform',
  description: 'AI-powered accounts payable solution for devops. Automated Kubernetes cluster provisioning, scaling, and management.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/accounts-payable-kubernetes-cluster-management-platform-a3bb2c4c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Accounts Payable Kubernetes Cluster Management Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered accounts payable solution for devops. Automated Kubernetes cluster provisioning, scaling, and management.
          </p>
