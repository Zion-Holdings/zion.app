...
export const metadata: Metadata = {
  title: 'Intelligent Quality for Healthcare #3',
  description: 'Next-generation healthcare solution: Intelligent Quality for Healthcare #3. Combines audit trail management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-quality-for-healthcare-3-34112ac1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Quality for Healthcare #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Intelligent Quality for Healthcare #3. Combines audit trail management with adaptive intelligence for optimal results.
          </p>
