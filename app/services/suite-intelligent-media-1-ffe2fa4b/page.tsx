...
export const metadata: Metadata = {
  title: 'Suite Intelligent - Media #1',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Suite Intelligent - Media #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your media business with Suite Intelligent - Media #1. Our solution provides audit trail management with enterprise-grade reliability and security.
          </p>
