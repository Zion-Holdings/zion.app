...
export const metadata: Metadata = {
  ...
  keywords: 'Unified SQL over heterogeneous sources, No data movement or replication, Source integration (SQL, NoSQL, REST, files), Caching and query optimization, Row-level security and governance, API and JDBC/ODBC access, Denodo, Redshift Spectrum, Dremio support, data, Data Engineering, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Data Virtualization Layer</h1>
        <p className="text-lg text-slate-300 mb-8">Virtual data layer that integrates across databases, APIs, and files without moving data. Query any source through a unified SQL interface.</p>
        ...
        <li class="text-slate-300">Unified SQL over heterogeneous sources</li>
        <li class="text-slate-300">No data movement or replication</li>
        <li class="text-slate-300">Source integration (SQL, NoSQL, REST, files)</li>
        <li class="text-slate-300">Caching and query optimization</li>
        <li class="text-slate-300">Row-level security and governance</li>
        <li class="text-slate-300">API and JDBC/ODBC access</li>
        <li class="text-slate-300">Denodo, Redshift Spectrum, Dremio support</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Query any data source without ETL</li>
        <li class="text-slate-300">Real-time integration, no batch delay</li>
        <li class="text-slate-300">Caching delivers query performance</li>
        <li class="text-slate-300">Governance applies to virtual views</li>
      </ul>
        </div>
