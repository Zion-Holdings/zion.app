...
export const metadata: Metadata = {
  title: 'Quantum Executive - REGTECH Quantum',
  description: 'Transform your regtech operations with our Quantum Executive - REGTECH Quantum. This AI-driven solution automates market intelligence with unprecedented accurac',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Executive - REGTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your regtech operations with our Quantum Executive - REGTECH Quantum. This AI-driven solution automates market intelligence with unprecedented accuracy and efficiency.
          </p>
