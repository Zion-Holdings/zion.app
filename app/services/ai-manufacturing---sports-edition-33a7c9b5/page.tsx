...
export const metadata: Metadata = {
  title: 'AI Manufacturing - Sports Edition',
  description: 'Revolutionize sports through intelligent automation. Our AI Manufacturing - Sports Edition leverages advanced machine learning to deliver risk assessment at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Manufacturing - Sports Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our AI Manufacturing - Sports Edition leverages advanced machine learning to deliver risk assessment at scale.
          </p>
