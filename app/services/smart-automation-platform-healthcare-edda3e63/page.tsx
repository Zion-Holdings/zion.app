...
export const metadata: Metadata = {
  title: 'Smart Automation Platform - Healthcare',
  description: 'Transform your healthcare operations with our Smart Automation Platform - Healthcare. This AI-driven solution automates data processing with unprecedented accur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-automation-platform-healthcare-edda3e63',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Automation Platform - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Smart Automation Platform - Healthcare. This AI-driven solution automates data processing with unprecedented accuracy and efficiency.
          </p>
