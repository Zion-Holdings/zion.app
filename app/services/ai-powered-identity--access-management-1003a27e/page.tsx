...
export const metadata: Metadata = {
  title: 'AI-Powered Identity & Access Management',
  description: 'Zero-trust IAM with continuous authentication and adaptive access controls.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-identity--access-management-1003a27e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Zero-trust IAM with continuous authentication and adaptive access controls.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Zero-trust auth</li>
          <li className="text-gray-300">Adaptive controls</li>
          <li className="text-gray-300">Continuous verification</li>
          </ul>
        </section>
