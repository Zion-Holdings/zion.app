...
export const metadata: Metadata = {
  ...
  keywords: 'OAuth2/JWT/SAML auth per route/group, OWASP Top-10 attack pattern detection, Schema drift alert + active API inventory, Bot detection + anomaly scoring per IP/UA, security, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">API Security Gateway</h1>
        <p className="text-lg text-slate-300 mb-8">OAuth2/JWT/SAML auth, OWASP Top-10 attack detection, schema drift alert, bot detection, per-endpoint threat score card.</p>
        ...
        <li class="text-slate-300">OAuth2/JWT/SAML auth per route/group</li>
        <li class="text-slate-300">OWASP Top-10 attack pattern detection</li>
        <li class="text-slate-300">Schema drift alert + active API inventory</li>
        <li class="text-slate-300">Bot detection + anomaly scoring per IP/UA</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with api security gateway</li>
