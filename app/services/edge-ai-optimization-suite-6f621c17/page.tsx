...
export const metadata: Metadata = {
  ...
  description: 'Optimizes AI inference on edge devices with model compression, caching, and offline fallback.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/edge-ai-optimization-suite-6f621c17',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Edge AI Optimization Suite
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimizes AI inference on edge devices with model compression, caching, and offline fallback.
          </p>
