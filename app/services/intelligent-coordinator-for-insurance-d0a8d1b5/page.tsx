...
export const metadata: Metadata = {
  title: 'Intelligent Coordinator for Insurance',
  description: 'Next-generation insurance solution: Intelligent Coordinator for Insurance. Combines procurement automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-coordinator-for-insurance-d0a8d1b5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Coordinator for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Intelligent Coordinator for Insurance. Combines procurement automation with adaptive intelligence for optimal results.
          </p>
