...
export const metadata: Metadata = {
  title: 'Smart Quota Suite - Enterprise',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Quota Suite - Enterprise
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation enterprise solution: Smart Quota Suite - Enterprise. Combines anomaly detection with adaptive intelligence for optimal results.
          </p>
