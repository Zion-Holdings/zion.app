...
export const metadata: Metadata = {
  ...
  keywords: 'Alternative data analysis, ML-based credit scoring, Bank transaction analysis, Behavioral scoring, Explainable AI decisions, Fair lending compliance, API for loan origination, Model monitoring and validation, fintech, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Credit Scoring Engine</h1>
        <p className="text-lg text-slate-300 mb-8">Alternative credit scoring using AI and non-traditional data sources. Analyze bank transactions, utility payments, social signals, and behavioral data for more inclusive lending decisions.</p>
        ...
        <li class="text-slate-300">Alternative data analysis</li>
        <li class="text-slate-300">ML-based credit scoring</li>
        <li class="text-slate-300">Bank transaction analysis</li>
        <li class="text-slate-300">Behavioral scoring</li>
        <li class="text-slate-300">Explainable AI decisions</li>
        <li class="text-slate-300">Fair lending compliance</li>
        <li class="text-slate-300">API for loan origination</li>
        <li class="text-slate-300">Model monitoring and validation</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Expand credit access to underbanked</li>
        <li class="text-slate-300">Reduce default rates by 25%</li>
        <li class="text-slate-300">Faster credit decisions</li>
