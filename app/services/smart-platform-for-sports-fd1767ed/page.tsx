...
export const metadata: Metadata = {
  title: 'Smart Platform for Sports',
  description: 'Transform your sports operations with our Smart Platform for Sports. This AI-driven solution automates image recognition with unprecedented accuracy and efficie',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-platform-for-sports-fd1767ed',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Platform for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our Smart Platform for Sports. This AI-driven solution automates image recognition with unprecedented accuracy and efficiency.
          </p>
