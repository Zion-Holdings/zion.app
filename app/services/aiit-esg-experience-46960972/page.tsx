...
export const metadata: Metadata = {
  title: 'AI/IT ESG Experience',
  description: 'Hyper-accelerated logistics solution: AI/IT ESG Experience. Combines inventory optimization with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-esg-experience-46960972',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT ESG Experience
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated logistics solution: AI/IT ESG Experience. Combines inventory optimization with next-gen AI for maximum velocity.
          </p>
