...
export const metadata: Metadata = {
  title: 'Cognitive Supply Tactical',
  description: 'Enhance your healthcare business with Cognitive Supply Tactical. Our solution provides budget optimization with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-supply-tactical-4fac47e6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Supply Tactical
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with Cognitive Supply Tactical. Our solution provides budget optimization with enterprise-grade reliability and security.
          </p>
