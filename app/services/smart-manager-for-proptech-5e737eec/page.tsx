...
export const metadata: Metadata = {
  title: 'Smart Manager for Proptech',
  description: 'Next-generation proptech solution: Smart Manager for Proptech. Combines language processing with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-manager-for-proptech-5e737eec',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manager for Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation proptech solution: Smart Manager for Proptech. Combines language processing with adaptive intelligence for optimal results.
          </p>
