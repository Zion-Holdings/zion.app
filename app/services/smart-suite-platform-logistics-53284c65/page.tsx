...
export const metadata: Metadata = {
  title: 'Smart Suite Platform - Logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Smart Suite Platform - Logistics leverages advanced machine learning to deliver regulatory tracking ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-suite-platform-logistics-53284c65',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Suite Platform - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Smart Suite Platform - Logistics leverages advanced machine learning to deliver regulatory tracking at scale.
          </p>
