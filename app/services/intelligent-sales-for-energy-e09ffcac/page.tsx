...
export const metadata: Metadata = {
  title: 'Intelligent Sales for Energy',
  description: 'Transform your energy operations with our Intelligent Sales for Energy. This AI-driven solution automates user experience with unprecedented accuracy and effici',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-sales-for-energy-e09ffcac',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Sales for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Intelligent Sales for Energy. This AI-driven solution automates user experience with unprecedented accuracy and efficiency.
          </p>
