...
export const metadata: Metadata = {
  ...
  description: 'Optimize your construction workflows with Autonomous Finance System - Construction. This intelligent platform delivers sourcing optimization through advanced au',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Autonomous Finance System - Construction. This intelligent platform delivers sourcing optimization through advanced automation and AI.
          </p>
