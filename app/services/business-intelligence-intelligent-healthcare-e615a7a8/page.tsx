...
export const metadata: Metadata = {
  title: 'Business Intelligence Intelligent - Healthcare',
  description: 'Transform your healthcare operations with our Business Intelligence Intelligent - Healthcare. This AI-driven solution automates financial risk management with u',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Business Intelligence Intelligent - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Business Intelligence Intelligent - Healthcare. This AI-driven solution automates financial risk management with unprecedented accuracy and efficiency.
          </p>
