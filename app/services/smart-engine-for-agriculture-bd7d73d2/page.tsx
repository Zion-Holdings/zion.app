...
export const metadata: Metadata = {
  title: 'Smart Engine for Agriculture',
  description: 'Transform your agriculture operations with our Smart Engine for Agriculture. This AI-driven solution automates invoice processing with unprecedented accuracy an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-engine-for-agriculture-bd7d73d2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Engine for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Smart Engine for Agriculture. This AI-driven solution automates invoice processing with unprecedented accuracy and efficiency.
          </p>
