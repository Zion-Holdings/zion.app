...
export const metadata: Metadata = {
  title: 'Intelligent platform-finance',
  description: 'Drive innovation in finance with Intelligent platform-finance. This AI-powered platform transforms customer retention into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-platform-finance-5cd98d12',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent platform-finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in finance with Intelligent platform-finance. This AI-powered platform transforms customer retention into a competitive advantage.
          </p>
