...
export const metadata: Metadata = {
  title: 'Security Autonomous - Gaming',
  description: 'Next-generation gaming solution: Security Autonomous - Gaming. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-autonomous-gaming-56a64ca9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Autonomous - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation gaming solution: Security Autonomous - Gaming. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
