      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Comprehensive AI governance framework with bias detection, model explainability, audit trails, and regulatory compliance for responsible AI deployment.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Automated bias detection across training data and model outputs</li>
            <li className="text-purple-300">✓ Model interpretability and explainability (SHAP/LIME integration)</li>
            <li className="text-purple-300">✓ AI ethics board policy generation and compliance tracking</li>
            <li className="text-purple-300">✓ Regulatory compliance automation (EU AI Act, NIST AI RMF)</li>
            <li className="text-purple-300">✓ Continuous monitoring and audit log generation</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai ethics, safety & governance framework</li>
