...
export const metadata: Metadata = {
  title: 'Smart customer-regtech',
  description: 'Hyper-accelerated regtech solution: Smart customer-regtech. Combines onboarding automation with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-customer-regtech-e39ad175',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart customer-regtech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated regtech solution: Smart customer-regtech. Combines onboarding automation with next-gen AI for maximum velocity.
          </p>
