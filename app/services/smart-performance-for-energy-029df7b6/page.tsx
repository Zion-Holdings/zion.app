...
export const metadata: Metadata = {
  title: 'Smart Performance for Energy',
  description: 'The future of energy is here with Smart Performance for Energy. Powered by cutting-edge AI, this platform delivers language processing like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-performance-for-energy-029df7b6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Performance for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Smart Performance for Energy. Powered by cutting-edge AI, this platform delivers language processing like never before.
          </p>
