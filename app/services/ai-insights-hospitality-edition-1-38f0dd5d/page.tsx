...
export const metadata: Metadata = {
  title: 'AI Insights - Hospitality Edition #1',
  description: 'Transform your hospitality operations with our AI Insights - Hospitality Edition #1. This AI-driven solution automates data quality with unprecedented accuracy ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-insights-hospitality-edition-1-38f0dd5d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Insights - Hospitality Edition #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our AI Insights - Hospitality Edition #1. This AI-driven solution automates data quality with unprecedented accuracy and efficiency.
          </p>
