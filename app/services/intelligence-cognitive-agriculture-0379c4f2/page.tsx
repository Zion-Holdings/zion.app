...
export const metadata: Metadata = {
  title: 'Intelligence Cognitive - Agriculture',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligence Cognitive - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agriculture solution: Intelligence Cognitive - Agriculture. Combines customer retention with adaptive intelligence for optimal results.
          </p>
