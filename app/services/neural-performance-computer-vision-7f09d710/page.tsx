...
export const metadata: Metadata = {
  title: 'Neural Performance Computer Vision',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Performance Computer Vision
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of media is here with Neural Performance Computer Vision. Powered by cutting-edge AI, this platform delivers brand monitoring like never before.
          </p>
