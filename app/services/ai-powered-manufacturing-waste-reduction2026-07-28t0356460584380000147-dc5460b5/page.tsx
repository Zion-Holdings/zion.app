...
export const metadata: Metadata = {
  title: 'AI-Powered Manufacturing Waste Reduction',
  description: 'Reduces manufacturing waste with optimization and recycling.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-manufacturing-waste-reduction2026-07-28t0356460584380000147-dc5460b5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Manufacturing Waste Reduction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Reduces manufacturing waste with optimization and recycling.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Waste reduction</li>
          <li className="text-gray-300">Optimization</li>
          <li className="text-gray-300">Recycling</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">35% waste reduction</li>
