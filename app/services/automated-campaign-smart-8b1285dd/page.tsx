...
export const metadata: Metadata = {
  title: 'Automated Campaign Smart',
  description: 'Revolutionize energy through intelligent automation. Our Automated Campaign Smart leverages advanced machine learning to deliver enterprise-grade insights at sc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-campaign-smart-8b1285dd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Campaign Smart
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Automated Campaign Smart leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
