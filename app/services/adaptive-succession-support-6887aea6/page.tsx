...
export const metadata: Metadata = {
  title: 'Adaptive Succession Support',
  description: 'Transform your legal operations with our Adaptive Succession Support. This AI-driven solution automates recruitment automation with unprecedented accuracy and e',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-succession-support-6887aea6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Succession Support
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Adaptive Succession Support. This AI-driven solution automates recruitment automation with unprecedented accuracy and efficiency.
          </p>
