...
export const metadata: Metadata = {
  title: 'System AI - Education',
  description: 'Enhance your education business with System AI - Education. Our solution provides budget optimization with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/system-ai-education-241b8f92',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your education business with System AI - Education. Our solution provides budget optimization with enterprise-grade reliability and security.
          </p>
