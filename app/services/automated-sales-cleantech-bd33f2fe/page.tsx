...
export const metadata: Metadata = {
  title: 'Automated sales-cleantech',
  description: 'Transform your cleantech operations with our Automated sales-cleantech. This AI-driven solution automates content generation with unprecedented accuracy and eff',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated sales-cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your cleantech operations with our Automated sales-cleantech. This AI-driven solution automates content generation with unprecedented accuracy and efficiency.
          </p>
