...
export const metadata: Metadata = {
  ...
  keywords: 'Pre-labeling with foundation models (CLIP, YOLO), Active learning to prioritize ambiguous samples, Collaborative annotation workspace, Quality metrics & consensus scoring, Export to all major ML data formats, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Automated Data Labeling for Computer Vision &amp; NLP</h1>
        <p className="text-lg text-slate-300 mb-8">Scale data labeling 100x with AI-assisted annotation: pre-label images, text, and audio; human-in-the-loop review; export to COCO, Pascal VOC, JSONL.</p>
        ...
        <li class="text-slate-300">Pre-labeling with foundation models (CLIP, YOLO)</li>
        <li class="text-slate-300">Active learning to prioritize ambiguous samples</li>
        <li class="text-slate-300">Collaborative annotation workspace</li>
        <li class="text-slate-300">Quality metrics &amp; consensus scoring</li>
        <li class="text-slate-300">Export to all major ML data formats</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with automated data labeling for computer vision &amp; nlp</li>
