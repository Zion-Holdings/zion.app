...
export const metadata: Metadata = {
  title: 'AI-Powered Patient Risk Stratification',
  description: 'Identifies high-risk patients for chronic conditions and triggers preventive interventions.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-patient-risk-stratification-fd6c11db',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Identifies high-risk patients for chronic conditions and triggers preventive interventions.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Intervention triggering</li>
          <li className="text-gray-300">Outcome prediction</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">40% readmission reduction</li>
