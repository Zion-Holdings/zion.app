...
export const metadata: Metadata = {
  title: 'Cognitive Document Solution - Construction #1',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Document Solution - Construction #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Cognitive Document Solution - Construction #1. Our solution provides brand sentiment with enterprise-grade reliability and security.
          </p>
