...
export const metadata: Metadata = {
  title: 'Predictive Network Compliance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Network Compliance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Predictive Network Compliance. This intelligent platform delivers document ai through advanced automation and AI.
          </p>
