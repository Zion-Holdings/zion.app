...
export const metadata: Metadata = {
  title: 'Coordinator AI - Logistics',
  description: 'Unlock unprecedented growth with Coordinator AI - Logistics. This autonomous system provides performance reviews with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/coordinator-ai-logistics-40ce3c6c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Coordinator AI - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Coordinator AI - Logistics. This autonomous system provides performance reviews with zero manual intervention needed.
          </p>
