...
export const metadata: Metadata = {
  title: 'Smart data-real-estate #1',
  description: 'The future of real-estate is here with Smart data-real-estate #1. Powered by cutting-edge AI, this platform delivers transformative results like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-data-real-estate-1-60c97023',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart data-real-estate #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of real-estate is here with Smart data-real-estate #1. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
