...
export const metadata: Metadata = {
  title: 'Next-Gen ai-transportation',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen ai-transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize transportation through intelligent automation. Our Next-Gen ai-transportation leverages advanced machine learning to deliver time tracking at scale.
          </p>
