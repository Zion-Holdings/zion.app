...
export const metadata: Metadata = {
  title: 'Intelligent Insights for Cleantech',
  description: 'Unlock unprecedented growth with Intelligent Insights for Cleantech. This autonomous system provides threat detection with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-insights-for-cleantech-824774ed',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Insights for Cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Insights for Cleantech. This autonomous system provides threat detection with zero manual intervention needed.
          </p>
