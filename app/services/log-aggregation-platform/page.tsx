...
export const metadata: Metadata = {
  ...
  keywords: 'Structured + unstructured logs, Full-text search with filters, Retention policy tiers, Log-based alerting, OpenTelemetry compatible, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Log Aggregation &amp; Search</h1>
        <p className="text-lg text-slate-300 mb-8">Centralized log collection, structured indexing, and full-text search across all servers, containers, and services with retention policies and alerting.</p>
        ...
        <li class="text-slate-300">Structured + unstructured logs</li>
        <li class="text-slate-300">Full-text search with filters</li>
        <li class="text-slate-300">Retention policy tiers</li>
        <li class="text-slate-300">Log-based alerting</li>
        <li class="text-slate-300">OpenTelemetry compatible</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with log aggregation &amp; search</li>
