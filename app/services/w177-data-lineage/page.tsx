...
export const metadata: Metadata = {
  ...
  keywords: 'End-to-end data lineage tracking, Impact analysis for schema changes, Column-level lineage, Compliance documentation, Data flow visualization, Integration with dbt, Airflow, Snowflake, Databricks, data, Data Governance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Data Lineage and Impact Analysis</h1>
        <p className="text-lg text-slate-300 mb-8">Track data lineage end-to-end: source to dashboard, impact analysis for changes, compliance documentation.</p>
        ...
        <li class="text-slate-300">End-to-end data lineage tracking</li>
        <li class="text-slate-300">Impact analysis for schema changes</li>
        <li class="text-slate-300">Column-level lineage</li>
        <li class="text-slate-300">Compliance documentation</li>
        <li class="text-slate-300">Data flow visualization</li>
        <li class="text-slate-300">Integration with dbt</li>
        <li class="text-slate-300">Airflow</li>
        <li class="text-slate-300">Snowflake</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Track data from source to every dashboard</li>
        <li class="text-slate-300">Impact analysis prevents breaking changes</li>
        <li class="text-slate-300">Column-level lineage for precision</li>
        <li class="text-slate-300">Compliance documentation for auditors</li>
      </ul>
        </div>
