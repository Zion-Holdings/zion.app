...
export const metadata: Metadata = {
  title: 'Smart Data Science Suite - Transportation',
  description: 'Optimize your transportation workflows with Smart Data Science Suite - Transportation. This intelligent platform delivers capacity management through advanced a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-data-science-suite-transportation-e4160f75',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Data Science Suite - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Smart Data Science Suite - Transportation. This intelligent platform delivers capacity management through advanced automation and AI.
          </p>
