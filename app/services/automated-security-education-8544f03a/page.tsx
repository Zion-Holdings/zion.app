...
export const metadata: Metadata = {
  title: 'Automated security-education',
  description: 'Transform your education operations with our Automated security-education. This AI-driven solution automates cost reduction with unprecedented accuracy and effi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your education operations with our Automated security-education. This AI-driven solution automates cost reduction with unprecedented accuracy and efficiency.
          </p>
