...
export const metadata: Metadata = {
  title: 'Enterprise Quality Platform - Hospitality #1',
  description: 'Drive innovation in hospitality with Enterprise Quality Platform - Hospitality #1. This AI-powered platform transforms cost tracking into a competitive advantag',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Quality Platform - Hospitality #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Enterprise Quality Platform - Hospitality #1. This AI-powered platform transforms cost tracking into a competitive advantage.
          </p>
