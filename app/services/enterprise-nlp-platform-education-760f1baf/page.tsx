...
export const metadata: Metadata = {
  title: 'Enterprise NLP Platform - Education',
  description: 'Quantum leap forward for education: Enterprise NLP Platform - Education. Uses quantum-inspired algorithms to deliver social media automation at exponential spee',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise NLP Platform - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for education: Enterprise NLP Platform - Education. Uses quantum-inspired algorithms to deliver social media automation at exponential speed.
          </p>
