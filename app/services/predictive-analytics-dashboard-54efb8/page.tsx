...
export const metadata: Metadata = {
  title: 'Predictive Analytics Dashboard Serverless (Energy)',
  description: 'Predictive Analytics Dashboard Serverless (Energy) is an AI-powered energy solution that transforms how businesses operate through intelligent automation and re',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Analytics Dashboard Serverless (Energy)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Predictive Analytics Dashboard Serverless (Energy) is an AI-powered energy solution that transforms how businesses operate through intelligent automation and real-time analytics.
