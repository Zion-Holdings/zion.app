...
export const metadata: Metadata = {
  ...
  keywords: 'AI document intake and extraction, Automated claims triage and routing, Fraud detection with anomaly modeling, Payout calculation and approval workflows, Integration with policy admin systems, Customer communication automation, Regulatory compliance reporting, Analytics on claims patterns and fraud, ai, insurance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Insurance Claims Processing Platform</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered insurance claims processing that automates document review, fraud detection, and payout calculation. Reduce claims processing time from days to hours.</p>
        ...
        <li class="text-slate-300">AI document intake and extraction</li>
        <li class="text-slate-300">Automated claims triage and routing</li>
        <li class="text-slate-300">Fraud detection with anomaly modeling</li>
        <li class="text-slate-300">Payout calculation and approval workflows</li>
        <li class="text-slate-300">Integration with policy admin systems</li>
        <li class="text-slate-300">Customer communication automation</li>
        <li class="text-slate-300">Regulatory compliance reporting</li>
        <li class="text-slate-300">Analytics on claims patterns and fraud</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Process claims in hours instead of days</li>
        <li class="text-slate-300">Detect fraud with 95% accuracy</li>
        <li class="text-slate-300">Reduce claims processing costs by 60%</li>
        <li class="text-slate-300">Improve customer satisfaction with faster payouts</li>
      </ul>
        </div>
