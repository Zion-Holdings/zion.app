...
export const metadata: Metadata = {
  title: 'Optimizer Intelligent - Healthcare',
  description: 'Next-generation healthcare solution: Optimizer Intelligent - Healthcare. Combines healthcare data analytics with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/optimizer-intelligent-healthcare-d3f97e4f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Optimizer Intelligent - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Optimizer Intelligent - Healthcare. Combines healthcare data analytics with adaptive intelligence for optimal results.
          </p>
