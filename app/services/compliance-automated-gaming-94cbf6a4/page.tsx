...
export const metadata: Metadata = {
  title: 'Compliance Automated - Gaming',
  description: 'Transform your gaming operations with our Compliance Automated - Gaming. This AI-driven solution provides intelligent automation with unprecedented accuracy and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/compliance-automated-gaming-94cbf6a4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Compliance Automated - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your gaming operations with our Compliance Automated - Gaming. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
