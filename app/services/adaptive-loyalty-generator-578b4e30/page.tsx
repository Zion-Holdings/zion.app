...
export const metadata: Metadata = {
  title: 'Adaptive Loyalty Generator',
  description: 'Next-generation energy solution: Adaptive Loyalty Generator. Combines compliance monitoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-loyalty-generator-578b4e30',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Loyalty Generator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Adaptive Loyalty Generator. Combines compliance monitoring with adaptive intelligence for optimal results.
          </p>
