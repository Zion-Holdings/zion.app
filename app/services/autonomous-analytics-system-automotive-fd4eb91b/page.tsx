...
export const metadata: Metadata = {
  title: 'Autonomous Analytics System - Automotive',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Analytics System - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in automotive with Autonomous Analytics System - Automotive. This AI-powered platform transforms incident response into a competitive advantage.
          </p>
