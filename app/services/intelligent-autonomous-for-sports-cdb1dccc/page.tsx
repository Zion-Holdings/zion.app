...
export const metadata: Metadata = {
  title: 'Intelligent Autonomous for Sports',
  description: 'Drive innovation in sports with Intelligent Autonomous for Sports. This AI-powered platform transforms customer onboarding into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-autonomous-for-sports-cdb1dccc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Autonomous for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in sports with Intelligent Autonomous for Sports. This AI-powered platform transforms customer onboarding into a competitive advantage.
          </p>
