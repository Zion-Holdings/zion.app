...
export const metadata = {
  ...
  description: 'End-to-end opentelemetry implementation guide: instrument any language and export anywhere services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/opentelemetry-implementation-guide-instrument-any-language-export-anywhere-10/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">OpenTelemetry Implementation Guide: Instrument Any Language and Export Anywhere</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end opentelemetry implementation guide: instrument any language and export anywhere services: assessment, deployment, and managed operations.
        </p>
