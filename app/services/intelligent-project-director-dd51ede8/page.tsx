...
export const metadata: Metadata = {
  title: 'Intelligent Project Director',
  description: 'Enhance your automotive business with Intelligent Project Director. Our solution provides testing automation with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-project-director-dd51ede8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Project Director
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your automotive business with Intelligent Project Director. Our solution provides testing automation with enterprise-grade reliability and security.
          </p>
