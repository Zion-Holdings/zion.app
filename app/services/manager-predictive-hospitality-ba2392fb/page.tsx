...
export const metadata: Metadata = {
  title: 'Manager Predictive - Hospitality',
  description: 'The future of hospitality is here with Manager Predictive - Hospitality. Powered by cutting-edge AI, this platform delivers transformative results like never be',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/manager-predictive-hospitality-ba2392fb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manager Predictive - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Manager Predictive - Hospitality. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
