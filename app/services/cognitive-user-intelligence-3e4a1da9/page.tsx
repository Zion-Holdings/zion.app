...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-language support, Custom integrations, API-first design, Multi-region deployment, manager, retail, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cognitive User Intelligence</h1>
        <p className="text-lg text-slate-300 mb-8">Revolutionize retail through intelligent automation. Our Cognitive User Intelligence leverages advanced machine learning to deliver threat detection at scale.</p>
