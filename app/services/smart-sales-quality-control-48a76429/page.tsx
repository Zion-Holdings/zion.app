...
export const metadata = {
  ...
  description: "Computer vision system that provides adaptive automated inspection, defect detection, and quality assurance for manufacturing production lines.",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Computer vision system that provides adaptive automated inspection, defect detection, and quality assurance for manufacturing production lines.</p>
