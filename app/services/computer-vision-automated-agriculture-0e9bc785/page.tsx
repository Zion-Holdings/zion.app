...
export const metadata: Metadata = {
  title: 'Computer Vision Automated - Agriculture',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Computer Vision Automated - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agriculture solution: Computer Vision Automated - Agriculture. Combines loyalty optimization with adaptive intelligence for optimal results.
          </p>
