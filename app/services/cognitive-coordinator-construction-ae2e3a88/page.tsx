...
export const metadata: Metadata = {
  title: 'Cognitive coordinator-construction',
  description: 'The future of construction is here with Cognitive coordinator-construction. Powered by cutting-edge AI, this platform delivers scalability planning like never b',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive coordinator-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Cognitive coordinator-construction. Powered by cutting-edge AI, this platform delivers scalability planning like never before.
          </p>
