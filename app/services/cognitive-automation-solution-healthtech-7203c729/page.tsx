...
export const metadata: Metadata = {
  title: 'Cognitive Automation Solution - HEALTHTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Automation Solution - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthtech through intelligent automation. Our Cognitive Automation Solution - HEALTHTECH leverages advanced machine learning to deliver rpa orchestration at scale.
          </p>
