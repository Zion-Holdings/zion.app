...
export const metadata: Metadata = {
  ...
  keywords: 'Auto-transcription + captions, Text-to-speech voiceover, Background removal, AI scene description, One-click aspect ratio resize, ai, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Generative AI Video Editor</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered video editor: auto-transcribe, auto-caption, text-to-speech voiceover, background removal, and one-click social media resizing.</p>
        ...
        <li class="text-slate-300">Auto-transcription + captions</li>
        <li class="text-slate-300">Text-to-speech voiceover</li>
        <li class="text-slate-300">Background removal</li>
        <li class="text-slate-300">AI scene description</li>
        <li class="text-slate-300">One-click aspect ratio resize</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with generative ai video editor</li>
