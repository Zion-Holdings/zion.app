...
export const metadata: Metadata = {
  title: 'AI Manufacturing - Agriculture Edition',
  description: 'Drive innovation in agriculture with AI Manufacturing - Agriculture Edition. This AI-powered platform transforms quality control into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-manufacturing-agriculture-edition-413d3422',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Manufacturing - Agriculture Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in agriculture with AI Manufacturing - Agriculture Edition. This AI-powered platform transforms quality control into a competitive advantage.
          </p>
