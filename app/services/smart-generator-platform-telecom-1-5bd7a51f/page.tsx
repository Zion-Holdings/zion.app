...
export const metadata: Metadata = {
  title: 'Smart Generator Platform - Telecom #1',
  description: 'Transform your telecom operations with our Smart Generator Platform - Telecom #1. This AI-driven solution automates scalability planning with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-generator-platform-telecom-1-5bd7a51f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Generator Platform - Telecom #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your telecom operations with our Smart Generator Platform - Telecom #1. This AI-driven solution automates scalability planning with unprecedented accuracy and efficiency.
          </p>
