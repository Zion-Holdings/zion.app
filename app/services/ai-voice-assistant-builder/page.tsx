...
export const metadata: Metadata = {
  ...
  keywords: 'No-code dialog builder, Natural language understanding, Multi-language support (30+), Integration with telephony (Twilio, Vonage), Analytics and call analytics, Custom voice cloning, Smart device integration, A/B testing for dialog flows, ai, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Voice Assistant Builder Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Build custom voice assistants for call centers, smart devices, and customer service. No-code dialog builder, NLU engine, and multi-channel deployment.</p>
        ...
        <li class="text-slate-300">No-code dialog builder</li>
        <li class="text-slate-300">Natural language understanding</li>
        <li class="text-slate-300">Multi-language support (30+)</li>
        <li class="text-slate-300">Integration with telephony (Twilio, Vonage)</li>
        <li class="text-slate-300">Analytics and call analytics</li>
        <li class="text-slate-300">Custom voice cloning</li>
        <li class="text-slate-300">Smart device integration</li>
        <li class="text-slate-300">A/B testing for dialog flows</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Build voice assistants without coding</li>
        <li class="text-slate-300">Reduce call center costs by 50%</li>
        <li class="text-slate-300">Deploy across channels instantly</li>
        <li class="text-slate-300">Continuous improvement with analytics</li>
      </ul>
        </div>
