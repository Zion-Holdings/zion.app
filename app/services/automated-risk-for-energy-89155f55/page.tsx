...
export const metadata: Metadata = {
  title: 'Automated Risk for Energy',
  description: 'Revolutionize energy through intelligent automation. Our Automated Risk for Energy leverages advanced machine learning to deliver language processing at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-risk-for-energy-89155f55',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Risk for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Automated Risk for Energy leverages advanced machine learning to deliver language processing at scale.
          </p>
