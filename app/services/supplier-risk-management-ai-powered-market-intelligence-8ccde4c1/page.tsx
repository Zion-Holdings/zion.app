...
export const metadata: Metadata = {
  title: 'Supplier Risk Management AI-Powered Market Intelligence',
  description: 'supplier risk management solution for transportation industry. Monitors market trends, competitor activities, and industry news to provide actionable insights.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/supplier-risk-management-ai-powered-market-intelligence-8ccde4c1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Supplier Risk Management AI-Powered Market Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            supplier risk management solution for transportation industry. Monitors market trends, competitor activities, and industry news to provide actionable insights.
          </p>
