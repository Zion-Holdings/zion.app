...
export const metadata: Metadata = {
  title: 'Smart Director for Sports',
  description: 'Transform your sports operations with our Smart Director for Sports. This AI-driven solution automates security monitoring with unprecedented accuracy and effic',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-director-for-sports-9e9e472f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Director for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our Smart Director for Sports. This AI-driven solution automates security monitoring with unprecedented accuracy and efficiency.
          </p>
