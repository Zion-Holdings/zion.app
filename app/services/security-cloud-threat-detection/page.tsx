...
export const metadata: Metadata = {
  title: `Cloud Threat Detection & Response | Zion Tech Group`,
  ...
  keywords: 'CloudTrail/Azure Activity/Stackdriver log stream, IAM anomaly patterns (impossible travel/priv-esc), GuardDuty/Defender/Sentinel alert normalisation, Auto-remediation via Terraform/IaC config push, security, E-Commerce, Zion Tech Group',
  alternates: {
    canonical: `https://ziontechgroup.com/services/security-cloud-threat-detection/`,
  },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cloud Threat Detection &amp; Response</h1>
        <p className="text-lg text-slate-300 mb-8">CloudTrail/CloudAudit log analytics, IAM anomaly detection (impossible travel, priv-esc pattern), GuardDuty integration, auto-remediation.</p>
        ...
        <li class="text-slate-300">CloudTrail/Azure Activity/Stackdriver log stream</li>
        <li class="text-slate-300">IAM anomaly patterns (impossible travel/priv-esc)</li>
        <li class="text-slate-300">GuardDuty/Defender/Sentinel alert normalisation</li>
        <li class="text-slate-300">Auto-remediation via Terraform/IaC config push</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with cloud threat detection &amp; response</li>
