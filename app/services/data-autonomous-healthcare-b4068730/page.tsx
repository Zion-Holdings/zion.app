...
export const metadata: Metadata = {
  title: 'Data Autonomous - Healthcare',
  description: 'Transform your healthcare operations with our Data Autonomous - Healthcare. This AI-driven solution provides intelligent automation with unprecedented accuracy ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-autonomous-healthcare-b4068730',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Autonomous - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Data Autonomous - Healthcare. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
