...
export const metadata: Metadata = {
  ...
  keywords: 'Genre-aware composition generation, AI stem separation & remixing, Auto-mastering (streaming-optimized), Video-to-music synchronization, Royalty-free commercial license, MIDI + DAW integration, ai, Media & Entertainment, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Music Composition &amp; Production Studio</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered music creation: generate original compositions in any style, remix stems, auto-master tracks, and sync to video. Royalty-free output with commercial licensing.</p>
        ...
        <li class="text-slate-300">Genre-aware composition generation</li>
        <li class="text-slate-300">AI stem separation &amp; remixing</li>
        <li class="text-slate-300">Auto-mastering (streaming-optimized)</li>
        <li class="text-slate-300">Video-to-music synchronization</li>
        <li class="text-slate-300">Royalty-free commercial license</li>
        <li class="text-slate-300">MIDI + DAW integration</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Create music in minutes</li>
        <li class="text-slate-300">100% royalty-free</li>
        <li class="text-slate-300">Any genre, any mood</li>
      </ul>
        </div>
