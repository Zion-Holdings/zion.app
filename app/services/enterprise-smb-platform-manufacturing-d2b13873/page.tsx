...
export const metadata: Metadata = {
  title: 'Enterprise SMB Platform - Manufacturing',
  description: 'Hyper-accelerated manufacturing solution: Enterprise SMB Platform - Manufacturing. Combines lead scoring with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-smb-platform-manufacturing-d2b13873',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise SMB Platform - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated manufacturing solution: Enterprise SMB Platform - Manufacturing. Combines lead scoring with next-gen AI for maximum velocity.
          </p>
