...
export const metadata: Metadata = {
  ...
  keywords: 'Hardware asset tracking, Software license management, Procurement workflows, Auto-discovery of network assets, Compliance and audit reports, Integration with ServiceNow, Jira, Lifecycle cost analysis, Disposal and recycling tracking, it-services, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Asset Management Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Comprehensive IT asset lifecycle management. Hardware and software tracking, license compliance, procurement workflows, and disposal management.</p>
        ...
        <li class="text-slate-300">Hardware asset tracking</li>
        <li class="text-slate-300">Software license management</li>
        <li class="text-slate-300">Procurement workflows</li>
        <li class="text-slate-300">Auto-discovery of network assets</li>
        <li class="text-slate-300">Compliance and audit reports</li>
        <li class="text-slate-300">Integration with ServiceNow, Jira</li>
        <li class="text-slate-300">Lifecycle cost analysis</li>
        <li class="text-slate-300">Disposal and recycling tracking</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Eliminate license violations</li>
        <li class="text-slate-300">Reduce IT spend by 20%</li>
        <li class="text-slate-300">Full asset visibility</li>
