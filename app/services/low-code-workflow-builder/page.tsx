...
export const metadata: Metadata = {
  ...
  keywords: 'Visual drag-and-drop builder, 1000+ integrations, Approval gates & branching, Error handling & retries, Built-in audit log, automation, SaaS, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Low-Code Workflow Builder</h1>
        <p className="text-lg text-slate-300 mb-8">Drag-and-drop workflow automation builder connecting SaaS apps, databases, and custom code with approval gates and error handling.</p>
        ...
        <li class="text-slate-300">Visual drag-and-drop builder</li>
        <li class="text-slate-300">1000+ integrations</li>
        <li class="text-slate-300">Approval gates &amp; branching</li>
        <li class="text-slate-300">Error handling &amp; retries</li>
        <li class="text-slate-300">Built-in audit log</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with low-code workflow builder</li>
