...
export const metadata: Metadata = {
  title: 'Smart Smart Platform - Legal #1',
  description: 'Optimize your legal workflows with Smart Smart Platform - Legal #1. This intelligent platform delivers fraud prevention through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-smart-platform-legal-1-9f44b479',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Smart Platform - Legal #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with Smart Smart Platform - Legal #1. This intelligent platform delivers fraud prevention through advanced automation and AI.
          </p>
