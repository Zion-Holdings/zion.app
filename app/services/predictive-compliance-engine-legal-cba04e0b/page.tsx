...
export const metadata: Metadata = {
  title: 'Predictive Compliance Engine - Legal',
  description: 'Enhance your legal business with Predictive Compliance Engine - Legal. Our solution provides campaign optimization with enterprise-grade reliability and securit',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Compliance Engine - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Predictive Compliance Engine - Legal. Our solution provides campaign optimization with enterprise-grade reliability and security.
          </p>
