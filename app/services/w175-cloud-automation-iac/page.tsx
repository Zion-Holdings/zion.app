...
export const metadata: Metadata = {
  ...
  keywords: 'Reusable Terraform and Pulumi modules, CI/CD pipelines for infrastructure, Drift detection and auto-remediation, Policy-as-code (OPA/Sentinel/Checkov), Cost estimation in PR (Infracost), Module registry and versioning, Multi-cloud support (AWS, Azure, GCP), cloud, DevOps, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cloud Automation &amp; IaC Factory</h1>
        <p className="text-lg text-slate-300 mb-8">Infrastructure automation factory: reusable Terraform modules, CI/CD pipelines, drift detection, and policy-as-code. Ship infrastructure like application code.</p>
        ...
        <li class="text-slate-300">Reusable Terraform and Pulumi modules</li>
        <li class="text-slate-300">CI/CD pipelines for infrastructure</li>
        <li class="text-slate-300">Drift detection and auto-remediation</li>
        <li class="text-slate-300">Policy-as-code (OPA/Sentinel/Checkov)</li>
        <li class="text-slate-300">Cost estimation in PR (Infracost)</li>
        <li class="text-slate-300">Module registry and versioning</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Ship infrastructure with the same rigor as code</li>
        <li class="text-slate-300">Drift detection prevents configuration rot</li>
        <li class="text-slate-300">Policy-as-code ensures compliance</li>
        <li class="text-slate-300">Cost estimation before infrastructure changes</li>
      </ul>
        </div>
