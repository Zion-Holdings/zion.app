...
export const metadata: Metadata = {
  title: 'Coordinator Intelligent - Cleantech',
  description: 'Revolutionize cleantech through intelligent automation. Our Coordinator Intelligent - Cleantech leverages advanced machine learning to deliver performance monit',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/coordinator-intelligent---cleantech-04c55e6c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Coordinator Intelligent - Cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cleantech through intelligent automation. Our Coordinator Intelligent - Cleantech leverages advanced machine learning to deliver performance monitoring at scale.
          </p>
