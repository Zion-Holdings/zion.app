...
export const metadata: Metadata = {
  title: 'Cognitive Suite Solution - Education',
  description: 'Next-generation education solution: Cognitive Suite Solution - Education. Combines security monitoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-suite-solution-education-16a55cf0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Suite Solution - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation education solution: Cognitive Suite Solution - Education. Combines security monitoring with adaptive intelligence for optimal results.
          </p>
