...
export const metadata: Metadata = {
  title: 'Predictive Disaster Insights',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in media with Predictive Disaster Insights. This AI-powered platform transforms fraud prevention into a competitive advantage.
          </p>
