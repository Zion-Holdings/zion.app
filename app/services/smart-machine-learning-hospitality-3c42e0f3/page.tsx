...
export const metadata: Metadata = {
  title: 'Smart machine learning-hospitality',
  description: 'Optimize your hospitality workflows with Smart machine learning-hospitality. This intelligent platform delivers business intelligence through advanced automatio',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart machine learning-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Smart machine learning-hospitality. This intelligent platform delivers business intelligence through advanced automation and AI.
          </p>
