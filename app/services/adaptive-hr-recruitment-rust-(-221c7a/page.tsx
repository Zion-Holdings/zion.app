...
export const metadata: Metadata = {
  title: 'Adaptive HR Recruitment Rust (Data)',
  description: 'Adaptive HR Recruitment Rust (Data) is an AI-powered data solution that transforms how businesses operate through intelligent automation and real-time analytics',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-hr-recruitment-rust-(-221c7a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive HR Recruitment Rust (Data)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Adaptive HR Recruitment Rust (Data) is an AI-powered data solution that transforms how businesses operate through intelligent automation and real-time analytics.
...
PostgreSQL, Terraform, DigitalOcean, Machine Learning, Go, Microservices
