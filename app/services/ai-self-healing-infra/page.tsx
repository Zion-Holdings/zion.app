...
export const metadata: Metadata = {
  ...
  keywords: 'Anomaly detection per host, Auto root-cause diagnosis, Auto-remediation playbooks, Change-freeze awareness, Full audit trail, automation, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Self-Healing Infrastructure</h1>
        <p className="text-lg text-slate-300 mb-8">Autonomous infrastructure remediation engine that detects anomalies, diagnoses root cause, and applies fixes — rollback guaranteed — without human intervention.</p>
        ...
        <li class="text-slate-300">Anomaly detection per host</li>
        <li class="text-slate-300">Auto root-cause diagnosis</li>
        <li class="text-slate-300">Auto-remediation playbooks</li>
        <li class="text-slate-300">Change-freeze awareness</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai self-healing infrastructure</li>
