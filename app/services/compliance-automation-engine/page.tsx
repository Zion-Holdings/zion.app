...
export const metadata: Metadata = {
  ...
  keywords: 'Intelligent automation and orchestration, Enterprise-grade integration, Real-time monitoring and alerts, Scalable multi-tenant architecture, security, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Compliance Automation Engine</h1>
        <p className="text-lg text-slate-300 mb-8">Rule-based compliance engine that embeds regulatory logic into your data pipelines and APIs. Automates access reviews, entitlement certifications, policy violation detection, and remediation tracking.</p>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with compliance automation engine</li>
