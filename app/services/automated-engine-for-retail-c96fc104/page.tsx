...
export const metadata: Metadata = {
  title: 'Automated Engine for Retail',
  description: 'Revolutionize retail through intelligent automation. Our Automated Engine for Retail leverages advanced machine learning to deliver process automation at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-engine-for-retail-c96fc104',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Engine for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize retail through intelligent automation. Our Automated Engine for Retail leverages advanced machine learning to deliver process automation at scale.
          </p>
