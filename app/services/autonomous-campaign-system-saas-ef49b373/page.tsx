...
export const metadata: Metadata = {
  title: 'Autonomous Campaign System - Saas',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Campaign System - Saas
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your saaS with Autonomous Campaign System - Saas. Our autonomous solution handles hr analytics end-to-end without human intervention.
          </p>
