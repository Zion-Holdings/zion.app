...
export const metadata: Metadata = {
  title: 'Neural devops-healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Neural devops-healthcare leverages advanced machine learning to deliver root cause analysis at scal',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural devops-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Neural devops-healthcare leverages advanced machine learning to deliver root cause analysis at scale.
          </p>
