...
export const metadata: Metadata = {
  title: 'AI-Powered data-energy',
  description: 'The future of energy is here with AI-Powered data-energy. Powered by cutting-edge AI, this platform delivers financial planning like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-data-energy-1fb104ae',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered data-energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with AI-Powered data-energy. Powered by cutting-edge AI, this platform delivers financial planning like never before.
          </p>
