...
export const metadata: Metadata = {
  ...
  keywords: 'Interactive product tours, Onboarding checklists, Progress tracking dashboard, Email drip campaigns, In-app messaging, Milestone celebrations, Integration with Intercom, Segment, Custom branding, micro-saas, SaaS, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Onboardly — Customer Onboarding Micro-SaaS</h1>
        <p className="text-lg text-slate-300 mb-8">Interactive customer onboarding platform with guided tours, checklists, and progress tracking. Reduce time-to-value and improve activation rates with automated onboarding flows.</p>
        ...
        <li class="text-slate-300">Interactive product tours</li>
        <li class="text-slate-300">Onboarding checklists</li>
        <li class="text-slate-300">Progress tracking dashboard</li>
        <li class="text-slate-300">Email drip campaigns</li>
        <li class="text-slate-300">In-app messaging</li>
        <li class="text-slate-300">Milestone celebrations</li>
        <li class="text-slate-300">Integration with Intercom, Segment</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Improve activation rates by 40%</li>
        <li class="text-slate-300">Reduce onboarding time</li>
        <li class="text-slate-300">Increase customer satisfaction</li>
        <li class="text-slate-300">Automate onboarding workflows</li>
      </ul>
        </div>
