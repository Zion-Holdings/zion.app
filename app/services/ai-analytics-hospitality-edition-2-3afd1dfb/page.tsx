...
export const metadata: Metadata = {
  title: 'AI Analytics - Hospitality Edition #2',
  description: 'The future of hospitality is here with AI Analytics - Hospitality Edition #2. Powered by cutting-edge AI, this platform delivers invoice processing like never b',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-analytics-hospitality-edition-2-3afd1dfb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Analytics - Hospitality Edition #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with AI Analytics - Hospitality Edition #2. Powered by cutting-edge AI, this platform delivers invoice processing like never before.
          </p>
