...
export const metadata: Metadata = {
  title: 'Enterprise Data Science Platform - AITECH',
  description: 'Unlock unprecedented growth with Enterprise Data Science Platform - AITECH. This autonomous system provides reporting automation with zero manual intervention n',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-data-science-platform-aitech-67026054',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Data Science Platform - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Enterprise Data Science Platform - AITECH. This autonomous system provides reporting automation with zero manual intervention needed.
          </p>
