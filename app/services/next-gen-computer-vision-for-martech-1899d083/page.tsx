...
export const metadata: Metadata = {
  title: 'Next-Gen Computer Vision for MARTECH',
  description: 'The future of martech is here with Next-Gen Computer Vision for MARTECH. Powered by cutting-edge AI, this platform delivers campaign optimization like never bef',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Computer Vision for MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of martech is here with Next-Gen Computer Vision for MARTECH. Powered by cutting-edge AI, this platform delivers campaign optimization like never before.
          </p>
