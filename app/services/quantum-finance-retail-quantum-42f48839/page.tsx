...
export const metadata: Metadata = {
  title: 'Quantum Finance - Retail Quantum',
  description: 'The future of retail is here with Quantum Finance - Retail Quantum. Powered by cutting-edge AI, this platform delivers supply chain like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-finance-retail-quantum-42f48839',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Finance - Retail Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Quantum Finance - Retail Quantum. Powered by cutting-edge AI, this platform delivers supply chain like never before.
          </p>
