...
export const metadata: Metadata = {
  title: 'Generator Intelligent - Media',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Generator Intelligent - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your media workflows with Generator Intelligent - Media. This intelligent platform delivers customer insights through advanced automation and AI.
          </p>
