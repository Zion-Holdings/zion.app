...
export const metadata: Metadata = {
  ...
  keywords: 'Carbon footprint assessment, Energy-efficient architecture design, Carbon-aware workload optimization, E-waste management programs, Green cloud migration strategy, Sustainability KPI dashboards, ESG reporting automation, Renewable energy sourcing guidance, it, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Sustainable IT Infrastructure Consulting</h1>
        <p className="text-lg text-slate-300 mb-8">Green IT consulting to reduce carbon footprint of technology operations. Energy-efficient infrastructure design, carbon-aware workload scheduling, e-waste management, and sustainability reporting aligned with ESG goals.</p>
        ...
        <li class="text-slate-300">Carbon footprint assessment</li>
        <li class="text-slate-300">Energy-efficient architecture design</li>
        <li class="text-slate-300">Carbon-aware workload optimization</li>
        <li class="text-slate-300">E-waste management programs</li>
        <li class="text-slate-300">Green cloud migration strategy</li>
        <li class="text-slate-300">Sustainability KPI dashboards</li>
        <li class="text-slate-300">ESG reporting automation</li>
        <li class="text-slate-300">Renewable energy sourcing guidance</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce IT carbon footprint by 40%</li>
        <li class="text-slate-300">Lower energy costs</li>
        <li class="text-slate-300">Meet ESG reporting requirements</li>
        <li class="text-slate-300">Enhance brand sustainability image</li>
      </ul>
        </div>
