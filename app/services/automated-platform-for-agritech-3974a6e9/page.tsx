...
export const metadata: Metadata = {
  title: 'Automated Platform for Agritech',
  description: 'Revolutionize agritech through intelligent automation. Our Automated Platform for Agritech leverages advanced machine learning to deliver quality control at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Platform for Agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agritech through intelligent automation. Our Automated Platform for Agritech leverages advanced machine learning to deliver quality control at scale.
          </p>
