...
export const metadata: Metadata = {
  title: 'Smart Process Mining Platform - Transportation',
  description: 'The future of transportation is here with Smart Process Mining Platform - Transportation. Powered by cutting-edge AI, this platform delivers scenario planning l',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-process-mining-platform-transportation-88c0c539',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Process Mining Platform - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Smart Process Mining Platform - Transportation. Powered by cutting-edge AI, this platform delivers scenario planning like never before.
          </p>
