...
export const metadata: Metadata = {
  title: 'Predictive System for Construction',
  description: 'Next-generation construction solution: Predictive System for Construction. Combines risk assessment with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-system-for-construction-468d5459',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive System for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Predictive System for Construction. Combines risk assessment with adaptive intelligence for optimal results.
          </p>
