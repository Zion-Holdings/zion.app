  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Desktop Lifecycle Refresh Runner</h1>
        <p className="text-lg text-gray-300 mb-8">Manages PC/Mac refresh cycles, OS migrations, and handoffs with inventory, imaging, and readiness tracking.</p>
