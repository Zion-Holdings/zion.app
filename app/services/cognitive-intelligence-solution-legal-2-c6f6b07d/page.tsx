...
export const metadata: Metadata = {
  title: 'Cognitive Intelligence Solution - Legal #2',
  description: 'Enhance your legal business with Cognitive Intelligence Solution - Legal #2. Our solution provides feature engineering with enterprise-grade reliability and sec',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Intelligence Solution - Legal #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Cognitive Intelligence Solution - Legal #2. Our solution provides feature engineering with enterprise-grade reliability and security.
          </p>
