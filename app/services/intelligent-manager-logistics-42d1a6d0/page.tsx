...
export const metadata: Metadata = {
  title: 'Intelligent manager-logistics',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent manager-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your logistics workflows with Intelligent manager-logistics. This intelligent platform delivers invoice processing through advanced automation and AI.
          </p>
