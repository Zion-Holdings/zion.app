...
export const metadata: Metadata = {
  title: 'Smart Cloud Platform - CLEANTECH',
  description: 'Hyper-accelerated cleantech solution: Smart Cloud Platform - CLEANTECH. Combines neural architecture with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-cloud-platform-cleantech-52b1e878',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Cloud Platform - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated cleantech solution: Smart Cloud Platform - CLEANTECH. Combines neural architecture with next-gen AI for maximum velocity.
          </p>
