...
export const metadata: Metadata = {
  title: 'Predictive Orchestrator Engine - Hospitality',
  description: 'Drive innovation in hospitality with Predictive Orchestrator Engine - Hospitality. This AI-powered platform transforms lead scoring into a competitive advantage',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-orchestrator-engine-hospitality-72970bbf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Orchestrator Engine - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Predictive Orchestrator Engine - Hospitality. This AI-powered platform transforms lead scoring into a competitive advantage.
          </p>
