...
export const metadata: Metadata = {
  title: 'Cognitive Workflow Processor',
  description: 'Optimize your agriculture workflows with Cognitive Workflow Processor. This intelligent platform delivers lead scoring through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-workflow-processor-0e140b25',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Workflow Processor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your agriculture workflows with Cognitive Workflow Processor. This intelligent platform delivers lead scoring through advanced automation and AI.
          </p>
