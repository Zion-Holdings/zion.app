...
export const metadata: Metadata = {
  ...
  description: 'Next-generation healthcare solution: Intelligent Automation for Healthcare. Combines testing automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-automation-for-healthcare-8314cb3f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Intelligent Automation for Healthcare. Combines testing automation with adaptive intelligence for optimal results.
          </p>
