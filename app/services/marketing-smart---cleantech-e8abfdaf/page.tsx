...
export const metadata: Metadata = {
  title: 'Marketing Smart - Cleantech',
  description: 'Revolutionize cleantech through intelligent automation. Our Marketing Smart - Cleantech leverages advanced machine learning to deliver data processing at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/marketing-smart---cleantech-e8abfdaf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Marketing Smart - Cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cleantech through intelligent automation. Our Marketing Smart - Cleantech leverages advanced machine learning to deliver data processing at scale.
          </p>
