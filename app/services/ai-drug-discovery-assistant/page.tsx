...
export const metadata: Metadata = {
  ...
  keywords: 'De novo molecular generation with GFlowNets, Target binding affinity predictor (AlphaFold + GNN), ADMET property forecasting, Patent landscape FTO analysis, Lead candidate ranking with explainability, ai, Healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Drug Discovery &amp; Molecular Design Assistant</h1>
        <p className="text-lg text-slate-300 mb-8">AI platform for early drug discovery: molecular generation, target binding affinity prediction, ADMET forecasting, patent landscape analysis, and pre-clinical trial candidate ranking powered by graph neural networks.</p>
        ...
        <li class="text-slate-300">De novo molecular generation with GFlowNets</li>
        <li class="text-slate-300">Target binding affinity predictor (AlphaFold + GNN)</li>
        <li class="text-slate-300">ADMET property forecasting</li>
        <li class="text-slate-300">Patent landscape FTO analysis</li>
        <li class="text-slate-300">Lead candidate ranking with explainability</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai drug discovery &amp; molecular design assistant</li>
