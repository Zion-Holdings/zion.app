...
export const metadata: Metadata = {
  title: 'Cognitive Support Solution - Hospitality #1',
  description: 'Enhance your hospitality business with Cognitive Support Solution - Hospitality #1. Our solution provides healthcare data analytics with enterprise-grade reliab',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Support Solution - Hospitality #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Cognitive Support Solution - Hospitality #1. Our solution provides healthcare data analytics with enterprise-grade reliability and security.
          </p>
