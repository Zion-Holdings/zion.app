...
export const metadata: Metadata = {
  ...
  keywords: 'Black-box and white-box penetration testing, Web application and API security testing, Social engineering and phishing simulations, Wireless and network infrastructure testing, Detailed remediation reports with retesting, security, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Penetration Testing &amp; Vulnerability Assessment</h1>
        <p className="text-lg text-slate-300 mb-8">Comprehensive security testing — network, web application, API, and social engineering assessments with detailed remediation reports and retesting.</p>
        ...
        <li class="text-slate-300">Black-box and white-box penetration testing</li>
        <li class="text-slate-300">Web application and API security testing</li>
        <li class="text-slate-300">Social engineering and phishing simulations</li>
        <li class="text-slate-300">Wireless and network infrastructure testing</li>
        <li class="text-slate-300">Detailed remediation reports with retesting</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with penetration testing &amp; vulnerability assessment</li>
