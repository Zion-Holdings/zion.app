...
export const metadata: Metadata = {
  title: 'Cognitive Director Solution - Hospitality',
  description: 'The future of hospitality is here with Cognitive Director Solution - Hospitality. Powered by cutting-edge AI, this platform delivers insurance automation like n',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-director-solution-hospitality-6307313a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Director Solution - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Cognitive Director Solution - Hospitality. Powered by cutting-edge AI, this platform delivers insurance automation like never before.
          </p>
