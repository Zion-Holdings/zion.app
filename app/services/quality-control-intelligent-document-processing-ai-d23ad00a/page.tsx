...
export const metadata: Metadata = {
  title: 'Quality Control Intelligent Document Processing AI',
  description: 'quality control solution for cooperatives industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatica',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quality-control-intelligent-document-processing-ai-d23ad00a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quality Control Intelligent Document Processing AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            quality control solution for cooperatives industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.
          </p>
