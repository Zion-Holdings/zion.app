...
export const metadata: Metadata = {
  title: 'Automated Regulatory Cloud',
  description: 'The future of transportation is here with Automated Regulatory Cloud. Powered by cutting-edge AI, this platform delivers influencer identification like never be',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-regulatory-cloud-8742f0b8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Regulatory Cloud
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Automated Regulatory Cloud. Powered by cutting-edge AI, this platform delivers influencer identification like never before.
          </p>
