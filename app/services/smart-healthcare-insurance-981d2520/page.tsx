...
export const metadata: Metadata = {
  title: 'Smart healthcare-insurance',
  description: 'Transform your insurance operations with our Smart healthcare-insurance. This AI-driven solution automates pipeline management with unprecedented accuracy and e',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Smart healthcare-insurance. This AI-driven solution automates pipeline management with unprecedented accuracy and efficiency.
          </p>
