...
export const metadata: Metadata = {
  ...
  keywords: 'Auto-PRD first-draft generator, User story with acceptance criteria boilerplate, Mermaid user-flow diagrams, Development effort estimation, Notion and Linear one-click sync, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI PRD &amp; User Story Generator</h1>
        <p className="text-lg text-slate-300 mb-8">Transform vague feature requests into comprehensive Product Requirements Documents with acceptance criteria, user flows, and ready-for-engineering technical specs.</p>
        ...
        <li class="text-slate-300">Auto-PRD first-draft generator</li>
        <li class="text-slate-300">User story with acceptance criteria boilerplate</li>
        <li class="text-slate-300">Mermaid user-flow diagrams</li>
        <li class="text-slate-300">Development effort estimation</li>
        <li class="text-slate-300">Notion and Linear one-click sync</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai prd &amp; user story generator</li>
