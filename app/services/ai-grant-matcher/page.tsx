      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            AI scans 50,000+ government, foundation, and corporate grant opportunities. Matches your organisation profile and auto-drafts tailored proposals in minutes.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ 50,000+ opportunity database</li>
            <li className="text-purple-300">✓ Auto-draft tailored proposals</li>
            <li className="text-purple-300">✓ Deadline and eligibility tracker</li>
            <li className="text-purple-300">✓ Submission pipeline dashboard</li>
            <li className="text-purple-300">✓ Grant success analytics</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai grant & funding opportunity matcher</li>
