...
export const metadata: Metadata = {
  ...
  keywords: '50,000+ opportunity database, Auto-draft tailored proposals, Deadline and eligibility tracker, Submission pipeline dashboard, Grant success analytics, ai, E-Commerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Grant &amp; Funding Opportunity Matcher</h1>
        <p className="text-lg text-slate-300 mb-8">AI scans 50,000+ government, foundation, and corporate grant opportunities. Matches your organisation profile and auto-drafts tailored proposals in minutes.</p>
        ...
        <li class="text-slate-300">50,000+ opportunity database</li>
        <li class="text-slate-300">Auto-draft tailored proposals</li>
        <li class="text-slate-300">Deadline and eligibility tracker</li>
        <li class="text-slate-300">Submission pipeline dashboard</li>
        <li class="text-slate-300">Grant success analytics</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai grant &amp; funding opportunity matcher</li>
