...
export const metadata: Metadata = {
  title: 'AI/IT Data Science Suite - Energy',
  description: 'Quantum leap forward for energy: AI/IT Data Science Suite - Energy. Uses quantum-inspired algorithms to deliver container orchestration at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-data-science-suite-energy-d247a0e2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Data Science Suite - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for energy: AI/IT Data Science Suite - Energy. Uses quantum-inspired algorithms to deliver container orchestration at exponential speed.
          </p>
