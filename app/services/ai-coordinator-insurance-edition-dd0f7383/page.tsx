...
export const metadata: Metadata = {
  title: 'AI Coordinator - Insurance Edition',
  description: 'Optimize your insurance workflows with AI Coordinator - Insurance Edition. This intelligent platform delivers invoice processing through advanced automation and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-coordinator-insurance-edition-dd0f7383',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Coordinator - Insurance Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with AI Coordinator - Insurance Edition. This intelligent platform delivers invoice processing through advanced automation and AI.
          </p>
