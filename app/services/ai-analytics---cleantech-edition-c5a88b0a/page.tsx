...
export const metadata: Metadata = {
  title: 'AI Analytics - Cleantech Edition',
  description: 'The future of cleantech is here with AI Analytics - Cleantech Edition. Powered by cutting-edge AI, this platform delivers customer insights like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-analytics---cleantech-edition-c5a88b0a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Analytics - Cleantech Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of cleantech is here with AI Analytics - Cleantech Edition. Powered by cutting-edge AI, this platform delivers customer insights like never before.
          </p>
