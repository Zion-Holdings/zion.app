  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Automated Experience for Manufacturing</h1>
        <p className="text-lg text-gray-300 mb-8">Unlock unprecedented growth with Automated Experience for Manufacturing. This autonomous system provides network optimization with zero manual intervention needed.</p>
