...
export const metadata: Metadata = {
  title: 'Smart Autonomous Platform - Agriculture',
  description: 'Transform your agriculture operations with our Smart Autonomous Platform - Agriculture. This AI-driven solution automates performance tuning with unprecedented ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-autonomous-platform-agriculture-457b3ce8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Autonomous Platform - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Smart Autonomous Platform - Agriculture. This AI-driven solution automates performance tuning with unprecedented accuracy and efficiency.
          </p>
