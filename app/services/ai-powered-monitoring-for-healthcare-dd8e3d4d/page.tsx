...
export const metadata: Metadata = {
  title: 'AI-Powered Monitoring for Healthcare',
  description: 'The future of healthcare is here with AI-Powered Monitoring for Healthcare. Powered by cutting-edge AI, this platform delivers procurement automation like never',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-monitoring-for-healthcare-dd8e3d4d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Monitoring for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with AI-Powered Monitoring for Healthcare. Powered by cutting-edge AI, this platform delivers procurement automation like never before.
          </p>
