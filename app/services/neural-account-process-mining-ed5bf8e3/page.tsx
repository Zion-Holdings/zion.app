...
export const metadata: Metadata = {
  title: 'Neural Account Process Mining',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Account Process Mining
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of media is here with Neural Account Process Mining. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
