...
export const metadata: Metadata = {
  title: 'Cognitive Intelligent Solution - REGTECH',
  description: 'Revolutionize regtech through intelligent automation. Our Cognitive Intelligent Solution - REGTECH leverages advanced machine learning to deliver loyalty optimi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-intelligent-solution-regtech-976132f1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Intelligent Solution - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize regtech through intelligent automation. Our Cognitive Intelligent Solution - REGTECH leverages advanced machine learning to deliver loyalty optimization at scale.
          </p>
