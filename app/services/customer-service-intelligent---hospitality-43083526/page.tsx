...
export const metadata: Metadata = {
  title: 'Customer Service Intelligent - Hospitality',
  description: 'The future of hospitality is here with Customer Service Intelligent - Hospitality. Powered by cutting-edge AI, this platform delivers energy management like nev',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Customer Service Intelligent - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Customer Service Intelligent - Hospitality. Powered by cutting-edge AI, this platform delivers energy management like never before.
          </p>
