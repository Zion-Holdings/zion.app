...
export const metadata: Metadata = {
  title: 'Automated intelligence-construction',
  description: 'Next-generation construction solution: Automated intelligence-construction. Combines roi tracking with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-intelligence-construction-377ee573',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated intelligence-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Automated intelligence-construction. Combines roi tracking with adaptive intelligence for optimal results.
          </p>
