...
export const metadata: Metadata = {
  title: 'Cognitive Platform for Energy',
  description: 'The future of energy is here with Cognitive Platform for Energy. Powered by cutting-edge AI, this platform delivers workflow management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-platform-for-energy-16093775',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Platform for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Cognitive Platform for Energy. Powered by cutting-edge AI, this platform delivers workflow management like never before.
          </p>
