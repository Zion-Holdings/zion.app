...
export const metadata: Metadata = {
  title: 'Smart System Platform - CLEANTECH',
  description: 'Enhance your cleantech business with Smart System Platform - CLEANTECH. Our solution provides revenue intelligence with enterprise-grade reliability and securit',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-system-platform-cleantech-e544d503',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart System Platform - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your cleantech business with Smart System Platform - CLEANTECH. Our solution provides revenue intelligence with enterprise-grade reliability and security.
          </p>
