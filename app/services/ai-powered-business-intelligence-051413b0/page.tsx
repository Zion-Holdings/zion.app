...
export const metadata: Metadata = {
  ...
  description: 'Automated BI report generation and insight discovery.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-business-intelligence-051413b0',
  },

export const metadata = {
  title: "AI-Powered Business Intelligence - Zion Tech Group",
  description: "Automated BI report generation and insight discovery.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-business-intelligence-051413b0`
  }
  ...
  return (
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automated BI report generation and insight discovery.
          </p>
    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">AI-Powered Business Intelligence</h1>
        <p className="text-lg text-gray-300 mb-8">Automated BI report generation and insight discovery.</p>
