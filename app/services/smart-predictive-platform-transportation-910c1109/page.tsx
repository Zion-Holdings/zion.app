...
export const metadata: Metadata = {
  title: 'Smart Predictive Platform - Transportation',
  description: 'Unlock unprecedented growth with Smart Predictive Platform - Transportation. This autonomous system provides revenue forecasting with zero manual intervention n',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Predictive Platform - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Predictive Platform - Transportation. This autonomous system provides revenue forecasting with zero manual intervention needed.
          </p>
