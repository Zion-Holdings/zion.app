...
export const metadata: Metadata = {
  title: 'AI Marketing - Insurance Edition',
  description: 'Revolutionize insurance through intelligent automation. Our AI Marketing - Insurance Edition leverages advanced machine learning to deliver access management at',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-marketing-insurance-edition-547ebd63',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Marketing - Insurance Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our AI Marketing - Insurance Edition leverages advanced machine learning to deliver access management at scale.
          </p>
