...
export const metadata: Metadata = {
  title: 'Intelligent Support for Hospitality',
  description: 'Transform your hospitality operations with our Intelligent Support for Hospitality. This AI-driven solution automates data pipeline orchestration with unprecede',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-support-for-hospitality-fa6071b6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Support for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Intelligent Support for Hospitality. This AI-driven solution automates data pipeline orchestration with unprecedented accuracy and efficiency.
          </p>
