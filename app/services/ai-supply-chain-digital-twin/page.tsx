...
export const metadata: Metadata = {
  ...
  keywords: 'Full supply chain modeling, Real-time simulation engine, Disruption prediction and alerting, Inventory optimization across nodes, What-if scenario analysis, Supplier risk scoring, Carbon footprint tracking, Integration with ERP and WMS, ai, Supply Chain, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Supply Chain Digital Twin</h1>
        <p className="text-lg text-slate-300 mb-8">Create a virtual replica of your entire supply chain for simulation, optimization, and risk management. Model scenarios, predict disruptions, and optimize inventory across the network in real-time.</p>
        ...
        <li class="text-slate-300">Full supply chain modeling</li>
        <li class="text-slate-300">Real-time simulation engine</li>
        <li class="text-slate-300">Disruption prediction and alerting</li>
        <li class="text-slate-300">Inventory optimization across nodes</li>
        <li class="text-slate-300">What-if scenario analysis</li>
        <li class="text-slate-300">Supplier risk scoring</li>
        <li class="text-slate-300">Carbon footprint tracking</li>
        <li class="text-slate-300">Integration with ERP and WMS</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce supply chain disruptions by 50%</li>
        <li class="text-slate-300">Optimize inventory costs</li>
        <li class="text-slate-300">Data-driven scenario planning</li>
