...
export const metadata: Metadata = {
  title: 'Next-Gen Access Deep Learning',
  description: 'Enhance your proptech business with Next-Gen Access Deep Learning. Our solution provides vendor management with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-access-deep-learning-7cf641b0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Access Deep Learning
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your proptech business with Next-Gen Access Deep Learning. Our solution provides vendor management with enterprise-grade reliability and security.
          </p>
