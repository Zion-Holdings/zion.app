...
export const metadata: Metadata = {
  title: 'Enterprise Intelligent - Startup',
  description: 'Future-proof your startup with Enterprise Intelligent - Startup. Our autonomous solution handles cross-sell recommendations end-to-end without human interventio',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Intelligent - Startup
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your startup with Enterprise Intelligent - Startup. Our autonomous solution handles cross-sell recommendations end-to-end without human intervention.
          </p>
