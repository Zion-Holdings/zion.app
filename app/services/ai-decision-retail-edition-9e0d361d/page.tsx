...
export const metadata: Metadata = {
  title: 'AI Decision - Retail Edition',
  description: 'The future of retail is here with AI Decision - Retail Edition. Powered by cutting-edge AI, this platform delivers expense reporting like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-decision-retail-edition-9e0d361d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Decision - Retail Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with AI Decision - Retail Edition. Powered by cutting-edge AI, this platform delivers expense reporting like never before.
          </p>
