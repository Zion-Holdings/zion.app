...
export const metadata: Metadata = {
  title: 'Director Intelligent - Hospitality',
  description: 'Next-generation hospitality solution: Director Intelligent - Hospitality. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/director-intelligent-hospitality-36763199',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Director Intelligent - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Director Intelligent - Hospitality. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
