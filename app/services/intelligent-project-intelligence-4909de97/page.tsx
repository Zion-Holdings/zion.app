...
export const metadata: Metadata = {
  title: 'Intelligent Project Intelligence',
  description: 'Next-generation transportation solution: Intelligent Project Intelligence. Combines financial risk management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-project-intelligence-4909de97',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Project Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation transportation solution: Intelligent Project Intelligence. Combines financial risk management with adaptive intelligence for optimal results.
          </p>
