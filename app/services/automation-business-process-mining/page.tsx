...
export const metadata: Metadata = {
  ...
  keywords: 'Process discovery from event logs, Conformance checking, Bottleneck identification, Root cause analysis, Process simulation, Real-time process monitoring, Integration with SAP, Salesforce, ServiceNow, Custom KPI dashboards, automation, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Business Process Mining Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Discover, monitor, and optimize business processes from event logs. Identify bottlenecks, deviations, and optimization opportunities with AI-powered process intelligence.</p>
        ...
        <li class="text-slate-300">Process discovery from event logs</li>
        <li class="text-slate-300">Conformance checking</li>
        <li class="text-slate-300">Bottleneck identification</li>
        <li class="text-slate-300">Root cause analysis</li>
        <li class="text-slate-300">Process simulation</li>
        <li class="text-slate-300">Real-time process monitoring</li>
        <li class="text-slate-300">Integration with SAP, Salesforce, ServiceNow</li>
        <li class="text-slate-300">Custom KPI dashboards</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Identify process inefficiencies</li>
        <li class="text-slate-300">Reduce process cycle time by 30%</li>
        <li class="text-slate-300">Ensure compliance with standard processes</li>
        <li class="text-slate-300">Data-driven process optimization</li>
      </ul>
        </div>
