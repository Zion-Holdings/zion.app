...
export const metadata = {
  ...
  description: "Discover, monitor, and optimize business processes from event logs. Identify bottlenecks, deviations, and optimization opportunities with AI-powered process int",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Business Process Mining Platform</h1>
