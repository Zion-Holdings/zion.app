...
export const metadata: Metadata = {
  title: 'Adaptive cloud-construction',
  description: 'Revolutionize construction through intelligent automation. Our Adaptive cloud-construction leverages advanced machine learning to deliver contract analysis at s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-cloud-construction-f6f8a9d5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive cloud-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Adaptive cloud-construction leverages advanced machine learning to deliver contract analysis at scale.
          </p>
