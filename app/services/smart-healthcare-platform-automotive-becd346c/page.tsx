...
export const metadata: Metadata = {
  title: 'Smart Healthcare Platform - Automotive',
  description: 'Revolutionize automotive through intelligent automation. Our Smart Healthcare Platform - Automotive leverages advanced machine learning to deliver security moni',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Healthcare Platform - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize automotive through intelligent automation. Our Smart Healthcare Platform - Automotive leverages advanced machine learning to deliver security monitoring at scale.
          </p>
