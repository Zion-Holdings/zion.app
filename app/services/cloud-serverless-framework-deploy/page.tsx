...
export const metadata: Metadata = {
  ...
  keywords: 'Serverless Framework YAML generator, Multi-stage variable layering per env, CI/CD GitHub Actions + automated deploy, DynamoDB/Lambda/API Gateway pre-built blueprints, cloud, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Serverless Framework Deployment</h1>
        <p className="text-lg text-slate-300 mb-8">Infrastructure-as-code for Serverless Framework: multi-stage (dev/staging/prod), CI/CD integration, DynamoDB/Lambda/API Gateway resources.</p>
        ...
        <li class="text-slate-300">Serverless Framework YAML generator</li>
        <li class="text-slate-300">Multi-stage variable layering per env</li>
        <li class="text-slate-300">CI/CD GitHub Actions + automated deploy</li>
        <li class="text-slate-300">DynamoDB/Lambda/API Gateway pre-built blueprints</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with serverless framework deployment</li>
