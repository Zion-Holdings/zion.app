...
export const metadata: Metadata = {
  ...
  description: 'Automated master data consolidation and deduplication.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-master-data-management-7d817d6f',
  },

export const metadata = {
  title: "AI-Powered Master Data Management - Zion Tech Group",
  description: "Automated master data consolidation and deduplication.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-master-data-management-7d817d6f`
  }
  ...
  return (
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automated master data consolidation and deduplication.
          </p>
    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">AI-Powered Master Data Management</h1>
        <p className="text-lg text-gray-300 mb-8">Automated master data consolidation and deduplication.</p>
