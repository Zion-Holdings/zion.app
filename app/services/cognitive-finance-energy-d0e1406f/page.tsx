...
export const metadata: Metadata = {
  title: 'Cognitive finance-energy',
  description: 'Optimize your energy workflows with Cognitive finance-energy. This intelligent platform delivers process discovery through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-finance-energy-d0e1406f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive finance-energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your energy workflows with Cognitive finance-energy. This intelligent platform delivers process discovery through advanced automation and AI.
          </p>
