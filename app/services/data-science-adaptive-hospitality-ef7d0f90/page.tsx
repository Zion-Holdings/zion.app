...
export const metadata: Metadata = {
  title: 'Data Science Adaptive - Hospitality',
  description: 'Optimize your hospitality workflows with Data Science Adaptive - Hospitality. This intelligent platform delivers healthcare data analytics through advanced auto',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Science Adaptive - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Data Science Adaptive - Hospitality. This intelligent platform delivers healthcare data analytics through advanced automation and AI.
          </p>
