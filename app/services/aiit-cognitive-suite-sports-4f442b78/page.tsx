...
export const metadata: Metadata = {
  title: 'AI/IT Cognitive Suite - Sports',
  description: 'Transform your sports operations with our AI/IT Cognitive Suite - Sports. This AI-driven solution automates performance tracking with unprecedented accuracy and',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Cognitive Suite - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our AI/IT Cognitive Suite - Sports. This AI-driven solution automates performance tracking with unprecedented accuracy and efficiency.
          </p>
