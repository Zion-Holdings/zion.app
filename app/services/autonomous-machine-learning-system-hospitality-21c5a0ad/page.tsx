...
export const metadata: Metadata = {
  title: 'Autonomous Machine Learning System - Hospitality',
  description: 'Unlock unprecedented growth with Autonomous Machine Learning System - Hospitality. This autonomous system provides edge computing with zero manual intervention ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-machine-learning-system-hospitality-21c5a0ad',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Machine Learning System - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Autonomous Machine Learning System - Hospitality. This autonomous system provides edge computing with zero manual intervention needed.
          </p>
