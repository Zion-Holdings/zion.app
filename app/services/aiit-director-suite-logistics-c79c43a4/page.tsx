...
export const metadata: Metadata = {
  title: 'AI/IT Director Suite - Logistics',
  description: 'Quantum leap forward for logistics: AI/IT Director Suite - Logistics. Uses quantum-inspired algorithms to deliver social media automation at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-director-suite-logistics-c79c43a4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Director Suite - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for logistics: AI/IT Director Suite - Logistics. Uses quantum-inspired algorithms to deliver social media automation at exponential speed.
          </p>
