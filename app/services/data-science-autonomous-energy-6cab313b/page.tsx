...
export const metadata: Metadata = {
  title: 'Data Science Autonomous - Energy',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Science Autonomous - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Data Science Autonomous - Energy. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
