...
export const metadata: Metadata = {
  title: 'Smart Customer Service Platform - Retail',
  description: 'Transform your retail operations with our Smart Customer Service Platform - Retail. This AI-driven solution automates threat detection with unprecedented accura',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-customer-service-platform-retail-299891d3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Customer Service Platform - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our Smart Customer Service Platform - Retail. This AI-driven solution automates threat detection with unprecedented accuracy and efficiency.
          </p>
