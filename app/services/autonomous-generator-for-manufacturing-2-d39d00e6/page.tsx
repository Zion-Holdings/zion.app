...
export const metadata: Metadata = {
  title: 'Autonomous Generator for Manufacturing #2',
  description: 'Next-generation manufacturing solution: Autonomous Generator for Manufacturing #2. Combines maintenance scheduling with adaptive intelligence for optimal result',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-generator-for-manufacturing-2-d39d00e6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Generator for Manufacturing #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation manufacturing solution: Autonomous Generator for Manufacturing #2. Combines maintenance scheduling with adaptive intelligence for optimal results.
          </p>
