...
export const metadata = {
  ...
  description: "Revolutionize Healthcare through intelligent automation. Our Intelligent Performance for Healthcare leverages advanced machine learning to deliver risk assessme",
  alternates: {
