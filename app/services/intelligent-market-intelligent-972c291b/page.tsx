...
export const metadata: Metadata = {
  title: 'Intelligent Market Intelligent',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Market Intelligent
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation manufacturing solution: Intelligent Market Intelligent. Combines procurement automation with adaptive intelligence for optimal results.
          </p>
