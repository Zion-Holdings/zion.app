...
export const metadata: Metadata = {
  ...
  keywords: 'Technology stack assessment & recommendations, Digital transformation roadmap, CTO-as-a-service (fractional), Vendor evaluation & selection, Technical due diligence for M&A, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Strategy &amp; Digital Transformation Consulting</h1>
        <p className="text-lg text-slate-300 mb-8">Strategic technology consulting — digital transformation roadmaps, tech stack evaluation, and CTO-as-a-service.</p>
        ...
        <li class="text-slate-300">Technology stack assessment &amp; recommendations</li>
        <li class="text-slate-300">Digital transformation roadmap</li>
        <li class="text-slate-300">CTO-as-a-service (fractional)</li>
        <li class="text-slate-300">Vendor evaluation &amp; selection</li>
        <li class="text-slate-300">Technical due diligence for M&amp;A</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with it strategy &amp; digital transformation consulting</li>
