...
export const metadata: Metadata = {
  title: 'Automated experience-construction',
  description: 'Optimize your construction workflows with Automated experience-construction. This intelligent platform delivers decision support through advanced automation and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-experience-construction-f434e72e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated experience-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Automated experience-construction. This intelligent platform delivers decision support through advanced automation and AI.
          </p>
