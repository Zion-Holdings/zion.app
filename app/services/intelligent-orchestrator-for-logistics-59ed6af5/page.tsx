...
export const metadata: Metadata = {
  title: 'Intelligent Orchestrator for Logistics',
  description: 'Unlock unprecedented growth with Intelligent Orchestrator for Logistics. This autonomous system provides business intelligence with zero manual intervention nee',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-orchestrator-for-logistics-59ed6af5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Orchestrator for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Orchestrator for Logistics. This autonomous system provides business intelligence with zero manual intervention needed.
          </p>
