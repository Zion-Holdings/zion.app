...
export const metadata = {
  ...
  description: "Transform your automotive operations with our AI Director - Automotive Edition. This AI-driven solution automates compliance monitoring with unprecedented accuracy and efficiency.",
  alternates: {
