...
export const metadata: Metadata = {
  title: 'AI-Powered Chronic Disease Management',
  description: 'Manages chronic diseases with personalized care plans.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-chronic-disease-management2026-07-28t0310480169210000106-942123e0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Manages chronic diseases with personalized care plans.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Disease management</li>
          <li className="text-gray-300">Care plans</li>
          <li className="text-gray-300">Outcome tracking</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">35% better disease control</li>
