...
export const metadata: Metadata = {
  title: 'Intelligence Automated - Proptech',
  description: 'Revolutionize proptech through intelligent automation. Our Intelligence Automated - Proptech leverages advanced machine learning to deliver customer insights at',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligence-automated---proptech-2b86376c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligence Automated - Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our Intelligence Automated - Proptech leverages advanced machine learning to deliver customer insights at scale.
          </p>
