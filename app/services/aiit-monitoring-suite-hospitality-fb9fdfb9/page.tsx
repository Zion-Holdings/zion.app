...
export const metadata: Metadata = {
  title: 'AI/IT Monitoring Suite - Hospitality',
  description: 'The future of hospitality is here with AI/IT Monitoring Suite - Hospitality. Powered by cutting-edge AI, this platform delivers logistics optimization like neve',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-monitoring-suite-hospitality-fb9fdfb9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Monitoring Suite - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with AI/IT Monitoring Suite - Hospitality. Powered by cutting-edge AI, this platform delivers logistics optimization like never before.
          </p>
