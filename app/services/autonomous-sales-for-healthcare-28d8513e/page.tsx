...
export const metadata: Metadata = {
  title: 'Autonomous Sales for Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Autonomous Sales for Healthcare leverages advanced machine learning to deliver market intelligence ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Sales for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Autonomous Sales for Healthcare leverages advanced machine learning to deliver market intelligence at scale.
          </p>
