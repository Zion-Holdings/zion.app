...
export const metadata: Metadata = {
  title: 'Autonomous Suite for Real-Estate',
  description: 'Transform your real-estate operations with our Autonomous Suite for Real-Estate. This AI-driven solution automates workflow management with unprecedented accura',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-suite-for-real-estate-012d11e4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Suite for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Autonomous Suite for Real-Estate. This AI-driven solution automates workflow management with unprecedented accuracy and efficiency.
          </p>
