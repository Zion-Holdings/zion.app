...
export const metadata: Metadata = {
  title: 'Management Autonomous - Media',
  description: 'Drive innovation in media with Management Autonomous - Media. This AI-powered platform transforms user provisioning into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/management-autonomous-media-74c9dd61',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Management Autonomous - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in media with Management Autonomous - Media. This AI-powered platform transforms user provisioning into a competitive advantage.
          </p>
