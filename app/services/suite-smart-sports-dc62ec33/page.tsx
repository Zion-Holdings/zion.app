      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Suite Smart - Sports. Powered by cutting-edge AI, this platform delivers market analysis like never before.
          </p>
