...
export const metadata: Metadata = {
  ...
  keywords: 'Deep code analysis across 50+ languages, OWASP Top 10 vulnerability scanning, Performance suggestions with benchmarks, Team coding standards enforcement, PR integration — GitHub, GitLab, Bitbucket, Custom rules engine for team-specific checks, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Code Reviewer Pro</h1>
        <p className="text-lg text-slate-300 mb-8">Automated code review that catches bugs, security issues, performance problems, and style violations before production.</p>
        ...
        <li class="text-slate-300">Deep code analysis across 50+ languages</li>
        <li class="text-slate-300">OWASP Top 10 vulnerability scanning</li>
        <li class="text-slate-300">Performance suggestions with benchmarks</li>
        <li class="text-slate-300">Team coding standards enforcement</li>
        <li class="text-slate-300">PR integration — GitHub, GitLab, Bitbucket</li>
        <li class="text-slate-300">Custom rules engine for team-specific checks</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai code reviewer pro</li>
