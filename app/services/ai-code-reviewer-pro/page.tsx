      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Automated code review that catches bugs, security issues, performance problems, and style violations before production.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Deep code analysis across 50+ languages</li>
            <li className="text-purple-300">✓ OWASP Top 10 vulnerability scanning</li>
            <li className="text-purple-300">✓ Performance suggestions with benchmarks</li>
            <li className="text-purple-300">✓ Team coding standards enforcement</li>
            <li className="text-purple-300">✓ PR integration — GitHub, GitLab, Bitbucket</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai code reviewer pro</li>
