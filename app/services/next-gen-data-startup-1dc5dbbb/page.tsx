...
export const metadata: Metadata = {
  title: 'Next-Gen Data - Startup',
  description: 'Revolutionize startup through intelligent automation. Our Next-Gen Data - Startup leverages advanced machine learning to deliver hr analytics at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-data-startup-1dc5dbbb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Data - Startup
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize startup through intelligent automation. Our Next-Gen Data - Startup leverages advanced machine learning to deliver hr analytics at scale.
          </p>
