...
export const metadata: Metadata = {
  ...
  keywords: 'HashiCorp Vault managed cluster (HA), Dynamic secrets (DB/cloud/SSH/K8s), Lease auto-rotation per secret-type, Full audit log + SOC 2 Type II evidence report, security, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Secrets Management &amp; Vault</h1>
        <p className="text-lg text-slate-300 mb-8">HashiCorp Vault with dynamic secrets, lease/rotation, cross-cluster replication, and full audit trail with SOC 2 Type II evidence pack.</p>
        ...
        <li class="text-slate-300">HashiCorp Vault managed cluster (HA)</li>
        <li class="text-slate-300">Dynamic secrets (DB/cloud/SSH/K8s)</li>
        <li class="text-slate-300">Lease auto-rotation per secret-type</li>
        <li class="text-slate-300">Full audit log + SOC 2 Type II evidence report</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with secrets management &amp; vault</li>
