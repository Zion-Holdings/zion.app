...
export const metadata = {
  title: "Enterprise Industry-Specific Human Resources Analytics Suite - Zion Tech Group",
  description: "Enterprise analytics suite that delivers industry-specific human resources insights with unified dashboards and reporting.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/enterprise-industry-specific-human-resources-analytics-suite-5d23220b`
  }
};
