...
export const metadata: Metadata = {
  title: 'Intelligent System for Logistics #1',
  description: 'The future of logistics is here with Intelligent System for Logistics #1. Powered by cutting-edge AI, this platform delivers compliance monitoring like never be',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-system-for-logistics-1-cf98555e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent System for Logistics #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Intelligent System for Logistics #1. Powered by cutting-edge AI, this platform delivers compliance monitoring like never before.
          </p>
