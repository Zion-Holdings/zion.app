...
export const metadata: Metadata = {
  title: 'Smart Computer Vision Platform - Insurance',
  description: 'The future of insurance is here with Smart Computer Vision Platform - Insurance. Powered by cutting-edge AI, this platform delivers performance tuning like neve',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-computer-vision-platform-insurance-d76d9ad4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Computer Vision Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Smart Computer Vision Platform - Insurance. Powered by cutting-edge AI, this platform delivers performance tuning like never before.
          </p>
