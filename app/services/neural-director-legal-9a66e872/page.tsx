...
export const metadata: Metadata = {
  title: 'Neural director-legal',
  description: 'The future of legal is here with Neural director-legal. Powered by cutting-edge AI, this platform delivers process discovery like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-director-legal-9a66e872',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural director-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Neural director-legal. Powered by cutting-edge AI, this platform delivers process discovery like never before.
          </p>
