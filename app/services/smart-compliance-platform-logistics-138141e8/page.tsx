...
export const metadata: Metadata = {
  title: 'Smart Compliance Platform - Logistics',
  description: 'Transform your logistics operations with our Smart Compliance Platform - Logistics. This AI-driven solution automates feedback collection with unprecedented acc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-compliance-platform-logistics-138141e8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Compliance Platform - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Smart Compliance Platform - Logistics. This AI-driven solution automates feedback collection with unprecedented accuracy and efficiency.
          </p>
