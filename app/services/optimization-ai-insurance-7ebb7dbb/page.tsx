...
export const metadata: Metadata = {
  title: 'Optimization AI - Insurance',
  description: 'Enhance your insurance business with Optimization AI - Insurance. Our solution provides user experience with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/optimization-ai-insurance-7ebb7dbb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Optimization AI - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Optimization AI - Insurance. Our solution provides user experience with enterprise-grade reliability and security.
          </p>
