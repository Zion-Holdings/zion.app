...
export const metadata: Metadata = {
  title: 'Next-Gen Healthcare for Insurance',
  description: 'The future of insurance is here with Next-Gen Healthcare for Insurance. Powered by cutting-edge AI, this platform delivers procurement automation like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-healthcare-for-insurance-4a3cfdd6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Healthcare for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Next-Gen Healthcare for Insurance. Powered by cutting-edge AI, this platform delivers procurement automation like never before.
          </p>
