...
export const metadata: Metadata = {
  title: 'Cognitive Performance for Energy #1',
  description: 'The future of energy is here with Cognitive Performance for Energy #1. Powered by cutting-edge AI, this platform delivers sales forecasting like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-performance-for-energy-1-9b49baa6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Performance for Energy #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Cognitive Performance for Energy #1. Powered by cutting-edge AI, this platform delivers sales forecasting like never before.
          </p>
