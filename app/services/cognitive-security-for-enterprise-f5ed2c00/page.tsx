...
export const metadata: Metadata = {
  title: 'Cognitive Security for Enterprise',
  description: 'Enhance your enterprise business with Cognitive Security for Enterprise. Our solution provides performance reviews with enterprise-grade reliability and securit',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Security for Enterprise
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your enterprise business with Cognitive Security for Enterprise. Our solution provides performance reviews with enterprise-grade reliability and security.
          </p>
