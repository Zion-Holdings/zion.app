...
export const metadata: Metadata = {
  title: 'Cognitive Sales Solution - AITECH',
  description: 'Transform your aitech operations with our Cognitive Sales Solution - AITECH. This AI-driven solution automates customer journey mapping with unprecedented accur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-sales-solution-aitech-1fb7062a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Sales Solution - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your aitech operations with our Cognitive Sales Solution - AITECH. This AI-driven solution automates customer journey mapping with unprecedented accuracy and efficiency.
          </p>
