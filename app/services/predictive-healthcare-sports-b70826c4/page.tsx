...
export const metadata: Metadata = {
  title: 'Predictive healthcare-sports',
  description: 'Transform your sports operations with our Predictive healthcare-sports. This AI-driven solution provides intelligent automation with unprecedented accuracy and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-healthcare-sports-b70826c4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive healthcare-sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our Predictive healthcare-sports. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
