...
export const metadata: Metadata = {
  title: 'Cognitive Director Solution - Automotive',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Director Solution - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize automotive through intelligent automation. Our Cognitive Director Solution - Automotive leverages advanced machine learning to deliver scenario planning at scale.
          </p>
