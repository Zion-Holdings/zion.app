...
export const metadata: Metadata = {
  title: 'Cognitive Optimizer Solution - Construction',
  description: 'Drive innovation in construction with Cognitive Optimizer Solution - Construction. This AI-powered platform transforms feature engineering into a competitive ad',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-optimizer-solution-construction-3657da2f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Optimizer Solution - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Cognitive Optimizer Solution - Construction. This AI-powered platform transforms feature engineering into a competitive advantage.
          </p>
