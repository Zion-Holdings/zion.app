...
export const metadata: Metadata = {
  title: 'Cognitive Analytics for Hospitality',
  description: 'The future of hospitality is here with Cognitive Analytics for Hospitality. Powered by cutting-edge AI, this platform delivers quality control like never before',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-analytics-for-hospitality-56bfa2a2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Analytics for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Cognitive Analytics for Hospitality. Powered by cutting-edge AI, this platform delivers quality control like never before.
          </p>
