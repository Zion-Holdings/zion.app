...
export const metadata: Metadata = {
  title: 'Automation Autonomous - Logistics',
  description: 'Transform logistics with Automation Autonomous - Logistics - the intelligent automation platform that learns, adapts, and delivers 10x results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automation-autonomous-logistics-b0bf12ba',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automation Autonomous - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform logistics with Automation Autonomous - Logistics - the intelligent automation platform that learns, adapts, and delivers 10x results.
          </p>
