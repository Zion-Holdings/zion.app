...
export const metadata: Metadata = {
  title: 'Healthcare Ai Platform #1',
  description: 'AI-powered healthcare solution for ai. Provides enterprise-grade automation and optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-healthcare-d36b3adb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Healthcare Ai Platform #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered healthcare solution for ai. Provides enterprise-grade automation and optimization.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Machine learning optimization</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">60% faster decisions</li>
          <li className="text-purple-300">40% cost reduction</li>
          <li className="text-purple-300">95% accuracy rate</li>
          </ul>
        </section>
