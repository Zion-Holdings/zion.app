...
export const metadata: Metadata = {
  title: 'Enterprise Engine Platform - Finance',
  description: 'Revolutionize finance through intelligent automation. Our Enterprise Engine Platform - Finance leverages advanced machine learning to deliver predictive analyti',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Engine Platform - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our Enterprise Engine Platform - Finance leverages advanced machine learning to deliver predictive analytics at scale.
          </p>
