...
export const metadata: Metadata = {
  title: 'Smart Optimization Platform - Sports',
  description: 'Next-generation sports solution: Smart Optimization Platform - Sports. Combines brand monitoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-optimization-platform-sports-3c1a6bde',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Optimization Platform - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation sports solution: Smart Optimization Platform - Sports. Combines brand monitoring with adaptive intelligence for optimal results.
          </p>
