...
export const metadata: Metadata = {
  title: 'AI-Powered FinTech Automated Decision Making',
  description: 'AI-powered automated decision making for financial services with Zero false negatives, Regulatory reporting, and Fraud prevention. SOX and PCI compliant.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-fintech-automated-decision-making-0393fb3c',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered FinTech Automated Decision Making
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered automated decision making for financial services with Zero false negatives, Regulatory reporting, and Fraud prevention. SOX and PCI compliant.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-purple-300">Regulatory reporting</li>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$1815</p>
          <ul className="space-y-2 mb-4">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$8002</p>
          <ul className="space-y-2 mb-4">
