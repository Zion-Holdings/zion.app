...
export const metadata: Metadata = {
  title: 'Next-Gen Quality for PROPTECH #1',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Quality for PROPTECH #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your proptech workflows with Next-Gen Quality for PROPTECH #1. This intelligent platform delivers talent acquisition through advanced automation and AI.
          </p>
