...
export const metadata: Metadata = {
  title: 'Portfolio AI-Powered Market Intelligence',
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/portfolio-ai-powered-market-intelligence-54d792a9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Portfolio AI-Powered Market Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered portfolio solution for market research. Monitors market trends, competitor activities, and industry news to provide actionable insights.
          </p>
