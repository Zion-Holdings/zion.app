...
export const metadata = {
  title: "Predictive Seamless Cryptocurrency Risk Scoring - Zion Tech Group",
  description: "Predictive risk scoring engine that assesses seamless cryptocurrency vulnerabilities with machine learning.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/predictive-seamless-cryptocurrency-risk-scoring-a08a0a00`
  }
};
