  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Identity &amp; Access Management (IAM) Modernization</h1>
        <p className="text-lg text-slate-300 mb-8">Modernize identity and access management with SSO, MFA, privileged access, and zero-trust policies. Reduce security risk while improving user experience.</p>
        ...
        <li class="text-slate-300">Single sign-on (SSO) for all applications</li>
        <li class="text-slate-300">Adaptive multi-factor authentication</li>
        <li class="text-slate-300">Privileged access management (PAM)</li>
        <li class="text-slate-300">Identity governance and access reviews</li>
        <li class="text-slate-300">Zero-trust policy enforcement</li>
        <li class="text-slate-300">Integration with Okta, Azure AD, Ping</li>
        <li class="text-slate-300">Automated provisioning and deprovisioning</li>
        <li class="text-slate-300">Compliance reporting for SOX, HIPAA, PCI</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce password-related tickets by 80%</li>
        <li class="text-slate-300">Enforce least-privilege access automatically</li>
        <li class="text-slate-300">Meet compliance requirements for access control</li>
        <li class="text-slate-300">Enable secure access from anywhere</li>
      </ul>
        </div>
