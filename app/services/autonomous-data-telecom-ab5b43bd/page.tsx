...
export const metadata: Metadata = {
  title: 'Autonomous data-telecom',
  description: 'Transform your telecom operations with our Autonomous data-telecom. This AI-driven solution automates supply chain with unprecedented accuracy and efficiency.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-data-telecom-ab5b43bd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous data-telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your telecom operations with our Autonomous data-telecom. This AI-driven solution automates supply chain with unprecedented accuracy and efficiency.
          </p>
