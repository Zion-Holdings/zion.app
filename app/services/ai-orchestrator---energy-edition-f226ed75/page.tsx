...
export const metadata: Metadata = {
  title: 'AI Orchestrator - Energy Edition',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with AI Orchestrator - Energy Edition. Powered by cutting-edge AI, this platform delivers sales forecasting like never before.
          </p>
