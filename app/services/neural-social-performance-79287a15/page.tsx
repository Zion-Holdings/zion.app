...
export const metadata: Metadata = {
  title: 'Neural Social Performance',
  description: 'The future of retail is here with Neural Social Performance. Powered by cutting-edge AI, this platform delivers transformative results like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-social-performance-79287a15',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Social Performance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Neural Social Performance. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
