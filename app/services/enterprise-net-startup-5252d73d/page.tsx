...
export const metadata: Metadata = {
  title: 'Enterprise Net Startup',
  description: 'The future of education is here with Enterprise Net Startup. Powered by cutting-edge AI, this platform delivers document ai like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-net-startup-5252d73d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Net Startup
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of education is here with Enterprise Net Startup. Powered by cutting-edge AI, this platform delivers document ai like never before.
          </p>
