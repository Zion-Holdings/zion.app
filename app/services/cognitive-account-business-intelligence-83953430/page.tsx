...
export const metadata: Metadata = {
  title: 'Cognitive Account Business Intelligence',
  description: 'Next-generation energy solution: Cognitive Account Business Intelligence. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-account-business-intelligence-83953430',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Account Business Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Cognitive Account Business Intelligence. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
