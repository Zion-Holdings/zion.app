...
export const metadata: Metadata = {
  title: 'AI Platform - Legal Edition',
  description: 'Transform your legal operations with our AI Platform - Legal Edition. This AI-driven solution automates personalization engine with unprecedented accuracy and e',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-platform-legal-edition-5a2824de',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Platform - Legal Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our AI Platform - Legal Edition. This AI-driven solution automates personalization engine with unprecedented accuracy and efficiency.
          </p>
