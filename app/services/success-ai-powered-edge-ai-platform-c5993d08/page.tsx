...
export const metadata: Metadata = {
  title: 'Success AI-Powered Edge AI Platform',
  description: 'AI-powered success solution for iot. Deploys and manages AI models at the edge with automatic optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/success-ai-powered-edge-ai-platform-c5993d08',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Success AI-Powered Edge AI Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered success solution for iot. Deploys and manages AI models at the edge with automatic optimization.
          </p>
