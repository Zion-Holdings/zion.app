...
export const metadata: Metadata = {
  title: 'Autonomous Master Orchestrator',
  description: 'Transform your healthcare operations with our Autonomous Master Orchestrator. This AI-driven solution automates audit trail management with unprecedented accura',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-master-orchestrator-3875b090',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Autonomous Master Orchestrator. This AI-driven solution automates audit trail management with unprecedented accuracy and efficiency.
          </p>
