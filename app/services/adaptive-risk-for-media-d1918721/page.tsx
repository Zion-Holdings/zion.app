      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Risk for Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your media business with Adaptive Risk for Media. Our solution provides audit automation with enterprise-grade reliability and security.
          </p>
