...
export const metadata: Metadata = {
  title: 'AI/IT Machine Learning for Healthcare',
  description: 'Optimize your healthcare workflows with AI/IT Machine Learning for Healthcare. This intelligent platform delivers predictive analytics through advanced automati',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-machine-learning-for-healthcare-90c14d96',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Machine Learning for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with AI/IT Machine Learning for Healthcare. This intelligent platform delivers predictive analytics through advanced automation and AI.
          </p>
