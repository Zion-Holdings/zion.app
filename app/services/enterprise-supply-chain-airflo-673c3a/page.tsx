...
export const metadata: Metadata = {
  title: 'Enterprise Supply Chain Airflow (Legal)',
  description: 'Enterprise Supply Chain Airflow (Legal) is an AI-powered legal solution that transforms how businesses operate through intelligent automation and real-time anal',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-supply-chain-airflo-673c3a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Supply Chain Airflow (Legal)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enterprise Supply Chain Airflow (Legal) is an AI-powered legal solution that transforms how businesses operate through intelligent automation and real-time analytics.
...
Airflow, PostgreSQL, Kubernetes, Vue.js, Hadoop, Machine Learning
