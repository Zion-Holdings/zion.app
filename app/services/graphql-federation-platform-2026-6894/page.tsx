...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "GraphQL Federation Platform | Zion Tech Group", description: "End-to-end graphql federation platform services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/graphql-federation-platform-2026-6894/"}} />
