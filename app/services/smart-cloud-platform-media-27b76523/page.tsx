...
export const metadata: Metadata = {
  title: 'Smart Cloud Platform - Media',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Cloud Platform - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of media is here with Smart Cloud Platform - Media. Powered by cutting-edge AI, this platform delivers compliance automation like never before.
          </p>
