...
export const metadata: Metadata = {
  title: 'Self-Optimizing process mining-construction',
  description: 'Next-generation construction solution: Self-Optimizing process mining-construction. Combines business continuity with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/self-optimizing-process-mining-construction-98be4378',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing process mining-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Self-Optimizing process mining-construction. Combines business continuity with adaptive intelligence for optimal results.
          </p>
