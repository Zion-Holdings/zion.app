...
export const metadata: Metadata = {
  title: 'Insurtech Analytics Platform #23',
  description: 'AI-powered insurtech solution for analytics. Provides enterprise-grade automation and optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/analytics-insurtech-6b899bb3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Insurtech Analytics Platform #23
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered insurtech solution for analytics. Provides enterprise-grade automation and optimization.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-purple-300">Predictive insights</li>
          <li className="text-purple-300">ROI optimization</li>
          </ul>
        </section>
