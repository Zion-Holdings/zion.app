...
export const metadata: Metadata = {
  title: 'Quantum Support - Retail Quantum',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Support - Retail Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your retail workflows with Quantum Support - Retail Quantum. This intelligent platform delivers feature engineering through advanced automation and AI.
          </p>
