...
export const metadata: Metadata = {
  title: 'Quantum Healthcare - Construction Quantum',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Healthcare - Construction Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated construction solution: Quantum Healthcare - Construction Quantum. Combines click automation with next-gen AI for maximum velocity.
          </p>
