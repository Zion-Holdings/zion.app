...
export const metadata: Metadata = {
  title: 'Smart Platform Platform - Construction',
  description: 'Unlock unprecedented growth with Smart Platform Platform - Construction. This autonomous system provides employee engagement with zero manual intervention neede',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-platform-platform-construction-0184529d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Platform Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Platform Platform - Construction. This autonomous system provides employee engagement with zero manual intervention needed.
          </p>
