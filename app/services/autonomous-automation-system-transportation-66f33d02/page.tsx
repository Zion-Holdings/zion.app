...
export const metadata: Metadata = {
  ...
  description: 'Optimize your transportation workflows with Autonomous Automation System - Transportation. This intelligent platform delivers business process through advanced ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-automation-system-transportation-66f33d02',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Autonomous Automation System - Transportation. This intelligent platform delivers business process through advanced automation and AI.
          </p>
