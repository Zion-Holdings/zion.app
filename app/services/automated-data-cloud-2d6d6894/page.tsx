...
export const metadata: Metadata = {
  title: 'Automated Data Cloud',
  description: 'Drive innovation in agriculture with Automated Data Cloud. This AI-powered platform transforms forecast accuracy into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-data-cloud-2d6d6894',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Data Cloud
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in agriculture with Automated Data Cloud. This AI-powered platform transforms forecast accuracy into a competitive advantage.
          </p>
