...
export const metadata: Metadata = {
  ...
  keywords: 'Synthetic HTTP/TCP probes, NetFlow/IPFIX analysis, Network path visualization, BGP monitoring, SLA breach alerting, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Network Performance Monitoring</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end network monitoring with synthetic probes, flow analysis (NetFlow/IPFIX), path visualization, and outage alerting for hybrid infrastructure.</p>
        ...
        <li class="text-slate-300">Synthetic HTTP/TCP probes</li>
        <li class="text-slate-300">NetFlow/IPFIX analysis</li>
        <li class="text-slate-300">Network path visualization</li>
        <li class="text-slate-300">BGP monitoring</li>
        <li class="text-slate-300">SLA breach alerting</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with network performance monitoring</li>
