...
export const metadata: Metadata = {
  title: 'Predictive Machine Learning Engine - Insurance',
  description: 'The future of insurance is here with Predictive Machine Learning Engine - Insurance. Powered by cutting-edge AI, this platform delivers feature engineering like',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Machine Learning Engine - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Predictive Machine Learning Engine - Insurance. Powered by cutting-edge AI, this platform delivers feature engineering like never before.
          </p>
