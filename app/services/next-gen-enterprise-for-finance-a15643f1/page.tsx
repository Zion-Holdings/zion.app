...
export const metadata: Metadata = {
  title: 'Next-Gen Enterprise for Finance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Enterprise for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your finance workflows with Next-Gen Enterprise for Finance. This intelligent platform delivers expense reporting through advanced automation and AI.
          </p>
