...
export const metadata: Metadata = {
  title: 'Cognitive suite-edtech',
  description: 'Optimize your edtech workflows with Cognitive suite-edtech. This intelligent platform delivers form processing through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-suite-edtech-b77ea8cd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive suite-edtech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your edtech workflows with Cognitive suite-edtech. This intelligent platform delivers form processing through advanced automation and AI.
          </p>
