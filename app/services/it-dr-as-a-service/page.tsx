...
export const metadata: Metadata = {
  ...
  keywords: 'Automated failover, Continuous replication, Regular DR testing, Multi-region support, RPO/RTO guarantees, Compliance reporting, Runbook automation, 24/7 NOC, it, Cloud, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Disaster Recovery as a Service</h1>
        <p className="text-lg text-slate-300 mb-8">Cloud-based disaster recovery with automated failover, continuous replication, and regular DR testing. RPO/RTO guarantees with multi-region support.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">it</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">Cloud</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Automated failover</li>
        <li class="text-slate-300">Continuous replication</li>
        <li class="text-slate-300">Regular DR testing</li>
        <li class="text-slate-300">Multi-region support</li>
        <li class="text-slate-300">RPO/RTO guarantees</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Minutes not hours recovery</li>
        <li class="text-slate-300">Zero data loss</li>
