...
export const metadata: Metadata = {
  title: 'Enterprise Process Autonomous',
  description: 'Transform your hospitality operations with our Enterprise Process Autonomous. This AI-driven solution automates predictive analytics with unprecedented accuracy',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Process Autonomous
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Enterprise Process Autonomous. This AI-driven solution automates predictive analytics with unprecedented accuracy and efficiency.
          </p>
