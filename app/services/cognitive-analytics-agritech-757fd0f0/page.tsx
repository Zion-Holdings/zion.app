...
export const metadata: Metadata = {
  title: 'Cognitive analytics-agritech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive analytics-agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agritech through intelligent automation. Our Cognitive analytics-agritech leverages advanced machine learning to deliver user experience at scale.
          </p>
