...
export const metadata: Metadata = {
  ...
  description: 'Monitors model performance and triggers retraining when drift is detected.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-model-monitoring-6bb2c8f6',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Auto-retraining</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">99% model accuracy</li>
