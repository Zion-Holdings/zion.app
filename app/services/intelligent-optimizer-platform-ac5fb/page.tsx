...
export const metadata: Metadata = {
  title: 'Intelligent Optimizer Platform',
  description: 'Transform your finance operations with our Intelligent Optimizer Platform. This cloud solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-optimizer-platform-ac5fb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Optimizer Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Intelligent Optimizer Platform. This cloud solution delivers unprecedented automation and intelligence.
          </p>
