...
export const metadata: Metadata = {
  title: 'Quantum Management - EDTECH Quantum',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Management - EDTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your edtech workflows with Quantum Management - EDTECH Quantum. This intelligent platform delivers compliance reporting through advanced automation and AI.
          </p>
