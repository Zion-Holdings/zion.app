...
export const metadata: Metadata = {
  title: 'Manufacturing Smart - Iot',
  description: 'Next-generation iot solution: Manufacturing Smart - Iot. Combines image recognition with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/manufacturing-smart---iot-e6c06376',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manufacturing Smart - Iot
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation iot solution: Manufacturing Smart - Iot. Combines image recognition with adaptive intelligence for optimal results.
          </p>
