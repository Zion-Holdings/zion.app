...
export const metadata: Metadata = {
  title: 'Smart Quality Suite - Real-Estate',
  description: 'The future of real-estate is here with Smart Quality Suite - Real-Estate. Powered by cutting-edge AI, this platform delivers customer onboarding like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-quality-suite-real-estate-f91deda8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Quality Suite - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of real-estate is here with Smart Quality Suite - Real-Estate. Powered by cutting-edge AI, this platform delivers customer onboarding like never before.
          </p>
