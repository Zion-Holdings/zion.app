...
export const metadata: Metadata = {
  title: 'Cognitive Analytics Solution - Insurance',
  description: 'Transform your insurance operations with our Cognitive Analytics Solution - Insurance. This AI-driven solution automates hr analytics with unprecedented accurac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-analytics-solution-insurance-810b0d67',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Analytics Solution - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Cognitive Analytics Solution - Insurance. This AI-driven solution automates hr analytics with unprecedented accuracy and efficiency.
          </p>
