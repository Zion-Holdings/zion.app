...
export const metadata: Metadata = {
  title: 'Cloud Automated - Healthcare',
  description: 'Transform your healthcare operations with our Cloud Automated - Healthcare. This AI-driven solution automates workflow management with unprecedented accuracy an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cloud-automated---healthcare-6a74970c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cloud Automated - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Cloud Automated - Healthcare. This AI-driven solution automates workflow management with unprecedented accuracy and efficiency.
          </p>
