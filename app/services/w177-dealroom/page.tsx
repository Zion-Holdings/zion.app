...
export const metadata: Metadata = {
  ...
  keywords: 'Secure document storage and sharing, Granular access controls and permissions, Dynamic watermarking and DRM, Activity tracking and audit logs, Q&A workflow for due diligence, Bulk upload and organization, Integration with DocuSign, Adobe Sign, micro-saas, Legal, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">DealRoom — Virtual Data Room</h1>
        <p className="text-lg text-slate-300 mb-8">Secure virtual data rooms for M&amp;A: document access control, watermarking, activity tracking.</p>
        ...
        <li class="text-slate-300">Secure document storage and sharing</li>
        <li class="text-slate-300">Granular access controls and permissions</li>
        <li class="text-slate-300">Dynamic watermarking and DRM</li>
        <li class="text-slate-300">Activity tracking and audit logs</li>
        <li class="text-slate-300">Q&amp;A workflow for due diligence</li>
        <li class="text-slate-300">Bulk upload and organization</li>
        <li class="text-slate-300">Integration with DocuSign</li>
        <li class="text-slate-300">Adobe Sign</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Secure data sharing for sensitive transactions</li>
        <li class="text-slate-300">Watermarking deters unauthorized sharing</li>
        <li class="text-slate-300">Activity tracking for compliance</li>
        <li class="text-slate-300">Q&amp;A workflow speeds due diligence</li>
      </ul>
        </div>
