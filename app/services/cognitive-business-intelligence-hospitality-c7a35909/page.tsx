...
export const metadata: Metadata = {
  title: 'Cognitive business intelligence-hospitality',
  description: 'Optimize your hospitality workflows with Cognitive business intelligence-hospitality. This intelligent platform delivers incident response through advanced auto',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-business-intelligence-hospitality-c7a35909',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive business intelligence-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Cognitive business intelligence-hospitality. This intelligent platform delivers incident response through advanced automation and AI.
          </p>
