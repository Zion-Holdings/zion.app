...
export const metadata: Metadata = {
  ...
  description: 'AI-powered recommendation system for energy and utilities with Grid optimization, Predictive maintenance, and Renewable integration.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-energy-recommendation-system-5a015c6b',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Energy Recommendation System
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered recommendation system for energy and utilities with Grid optimization, Predictive maintenance, and Renewable integration.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$416</p>
          <ul className="space-y-2 mb-4">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$1755</p>
          <ul className="space-y-2 mb-4">
