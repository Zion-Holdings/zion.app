...
export const metadata: Metadata = {
  title: 'Autonomous Director for Agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Autonomous Director for Agriculture leverages advanced machine learning to deliver network optimiz',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Director for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Autonomous Director for Agriculture leverages advanced machine learning to deliver network optimization at scale.
          </p>
