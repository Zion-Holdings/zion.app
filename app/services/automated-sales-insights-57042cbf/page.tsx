...
export const metadata: Metadata = {
  ...
  description: 'The future of hospitality is here with Automated Sales Insights. Powered by cutting-edge AI, this platform delivers incident response like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-sales-insights-57042cbf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Automated Sales Insights. Powered by cutting-edge AI, this platform delivers incident response like never before.
          </p>
