...
export const metadata: Metadata = {
  title: 'Enterprise supply-retail',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise supply-retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize retail through intelligent automation. Our Enterprise supply-retail leverages advanced machine learning to deliver skills management at scale.
          </p>
