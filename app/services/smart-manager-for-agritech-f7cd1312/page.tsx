...
export const metadata: Metadata = {
  title: 'Smart Manager for Agritech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manager for Agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agritech is here with Smart Manager for Agritech. Powered by cutting-edge AI, this platform delivers language processing like never before.
          </p>
