...
export const metadata: Metadata = {
  title: 'Autonomous Scheduling System - Agriculture',
  description: 'Optimize your agriculture workflows with Autonomous Scheduling System - Agriculture. This intelligent platform delivers performance reviews through advanced aut',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Scheduling System - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your agriculture workflows with Autonomous Scheduling System - Agriculture. This intelligent platform delivers performance reviews through advanced automation and AI.
          </p>
