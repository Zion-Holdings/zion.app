...
export const metadata: Metadata = {
  title: 'Smart Quality for Hospitality #3',
  description: 'Next-generation hospitality solution: Smart Quality for Hospitality #3. Combines data processing with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-quality-for-hospitality-3-8fa4cf1a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Quality for Hospitality #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Smart Quality for Hospitality #3. Combines data processing with adaptive intelligence for optimal results.
          </p>
