...
export const metadata: Metadata = {
  title: 'Cognitive Adaptive - Tech',
  description: 'Next-generation technology solution: Cognitive Adaptive - Tech. Combines financial planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-adaptive-tech-92c6cf71',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Adaptive - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation technology solution: Cognitive Adaptive - Tech. Combines financial planning with adaptive intelligence for optimal results.
          </p>
