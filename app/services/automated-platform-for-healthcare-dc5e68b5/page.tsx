...
export const metadata: Metadata = {
  title: 'Automated Platform for Healthcare',
  description: 'The future of healthcare is here with Automated Platform for Healthcare. Powered by cutting-edge AI, this platform delivers supply chain like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-platform-for-healthcare-dc5e68b5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Platform for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Automated Platform for Healthcare. Powered by cutting-edge AI, this platform delivers supply chain like never before.
          </p>
