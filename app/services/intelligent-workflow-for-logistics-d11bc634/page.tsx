...
export const metadata: Metadata = {
  title: 'Intelligent Workflow for Logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Intelligent Workflow for Logistics leverages advanced machine learning to deliver forecast accuracy ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-workflow-for-logistics-d11bc634',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Workflow for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Intelligent Workflow for Logistics leverages advanced machine learning to deliver forecast accuracy at scale.
          </p>
