...
export const metadata: Metadata = {
  ...
  keywords: 'Defect detection, Object recognition, Facial analysis, OCR & document processing, Video analytics, Custom model training, Edge deployment, API & SDK access, ai-services, ai-and-ml, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Computer Vision Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Production-ready computer vision for manufacturing, retail, and security. Pre-trained models for defect detection, object recognition, and facial analysis.</p>
        ...
        <li class="text-slate-300">Defect detection</li>
        <li class="text-slate-300">Object recognition</li>
        <li class="text-slate-300">Facial analysis</li>
        <li class="text-slate-300">OCR &amp; document processing</li>
        <li class="text-slate-300">Video analytics</li>
        <li class="text-slate-300">Custom model training</li>
        <li class="text-slate-300">Edge deployment</li>
        <li class="text-slate-300">API &amp; SDK access</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">99.2% detection accuracy</li>
        <li class="text-slate-300">Real-time processing</li>
        <li class="text-slate-300">Edge deployment ready</li>
        <li class="text-slate-300">Custom model support</li>
        <li class="text-slate-300">Reduce manual inspection by 90%</li>
      </ul>
        </div>
