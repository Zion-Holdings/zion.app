...
export const metadata: Metadata = {
  title: 'Adaptive Experience for Hospitality',
  description: 'The future of hospitality is here with Adaptive Experience for Hospitality. Powered by cutting-edge AI, this platform delivers sales process optimization like n',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-experience-for-hospitality-6b21a293',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Experience for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Adaptive Experience for Hospitality. Powered by cutting-edge AI, this platform delivers sales process optimization like never before.
          </p>
