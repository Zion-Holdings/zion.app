...
export const metadata: Metadata = {
  title: 'Next-Gen Conversational Engine',
  description: 'Enhance your proptech business with Next-Gen Conversational Engine. Our solution provides employee engagement with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-conversational-engine-e16cb076',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your proptech business with Next-Gen Conversational Engine. Our solution provides employee engagement with enterprise-grade reliability and security.
          </p>
