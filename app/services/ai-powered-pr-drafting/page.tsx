...
export const metadata: Metadata = {
  ...
  keywords: 'Intelligent diff summarization, JIRA/GitHub issue linking & status updates, Changelog entry drafting per semantic version, Reviewer recommendation based on ownership, Auto-update of API docs & README diffs, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Powered PR Drafting &amp; Description</h1>
        <p className="text-lg text-slate-300 mb-8">Automatically generate PR titles, descriptions, and changelog entries from commit history and diff analysis; link to JIRA tickets and update documentation.</p>
        ...
        <li class="text-slate-300">Intelligent diff summarization</li>
        <li class="text-slate-300">JIRA/GitHub issue linking &amp; status updates</li>
        <li class="text-slate-300">Changelog entry drafting per semantic version</li>
        <li class="text-slate-300">Reviewer recommendation based on ownership</li>
        <li class="text-slate-300">Auto-update of API docs &amp; README diffs</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai-powered pr drafting &amp; description</li>
