...
export const metadata: Metadata = {
  title: 'Enterprise System - Logistics',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise System - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your logistics workflows with Enterprise System - Logistics. This intelligent platform delivers brand sentiment through advanced automation and AI.
          </p>
