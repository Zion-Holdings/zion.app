...
export const metadata: Metadata = {
  ...
  keywords: 'Pipeline bottleneck analysis & profiling, Code refactoring & parallelization, Migration to cloud-native (Glue, Dataflow, Flink), Data quality checks & anomaly detection, Cost optimization (spot instances, auto-scaling), it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">ETL Pipeline Optimization &amp; Modernization</h1>
        <p className="text-lg text-slate-300 mb-8">Accelerate and stabilize data pipelines (batch &amp; streaming): refactor legacy ETL, migrate to Airflow/DBT, add observability, and reduce cost.</p>
        ...
        <li class="text-slate-300">Pipeline bottleneck analysis &amp; profiling</li>
        <li class="text-slate-300">Code refactoring &amp; parallelization</li>
        <li class="text-slate-300">Migration to cloud-native (Glue, Dataflow, Flink)</li>
        <li class="text-slate-300">Data quality checks &amp; anomaly detection</li>
        <li class="text-slate-300">Cost optimization (spot instances, auto-scaling)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with etl pipeline optimization &amp; modernization</li>
