...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-infinite-quantum-hyper-autonomous-self-evolving-quantum-infinite-hyper-autonomous-quantum-manufacturing-a9fd7c16",
  },
};
