...
export const metadata: Metadata = {
  title: 'AI DevOps - PROPTECH Edition #1',
  description: 'The future of proptech is here with AI DevOps - PROPTECH Edition #1. Powered by cutting-edge AI, this platform delivers customer retention like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-devops-proptech-edition-1-8f305202',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI DevOps - PROPTECH Edition #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with AI DevOps - PROPTECH Edition #1. Powered by cutting-edge AI, this platform delivers customer retention like never before.
          </p>
