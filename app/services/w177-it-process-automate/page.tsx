...
export const metadata: Metadata = {
  ...
  keywords: 'User provisioning and deprovisioning, Ticket auto-routing and categorization, Report generation and distribution, System monitoring and alerting, Password reset automation, Software license reconciliation, Integration with ServiceNow, Jira, ActiveDirectory, it, IT Operations, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Process Automation (RPA)</h1>
        <p className="text-lg text-slate-300 mb-8">Robotic process automation for IT: user provisioning, ticket routing, report generation, system monitoring.</p>
        ...
        <li class="text-slate-300">User provisioning and deprovisioning</li>
        <li class="text-slate-300">Ticket auto-routing and categorization</li>
        <li class="text-slate-300">Report generation and distribution</li>
        <li class="text-slate-300">System monitoring and alerting</li>
        <li class="text-slate-300">Password reset automation</li>
        <li class="text-slate-300">Software license reconciliation</li>
        <li class="text-slate-300">Integration with ServiceNow</li>
        <li class="text-slate-300">Jira</li>
        <li class="text-slate-300">ActiveDirectory</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Automate 80% of repetitive IT tasks</li>
        <li class="text-slate-300">User provisioning in minutes not hours</li>
        <li class="text-slate-300">Ticket routing reduces response time</li>
        <li class="text-slate-300">Report generation eliminates manual work</li>
      </ul>
        </div>
