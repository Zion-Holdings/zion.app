...
export const metadata: Metadata = {
  title: 'Smart Workflow Platform - FINTECH',
  description: 'Next-generation fintech solution: Smart Workflow Platform - FINTECH. Combines integration platform with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-workflow-platform-fintech-445e4081',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Workflow Platform - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation fintech solution: Smart Workflow Platform - FINTECH. Combines integration platform with adaptive intelligence for optimal results.
          </p>
