...
export const metadata: Metadata = {
  title: 'System Intelligent - Logistics',
  description: 'Revolutionize logistics through intelligent automation. Our System Intelligent - Logistics leverages advanced machine learning to deliver manufacturing quality ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/system-intelligent---logistics-9c8de605',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            System Intelligent - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our System Intelligent - Logistics leverages advanced machine learning to deliver manufacturing quality control at scale.
          </p>
