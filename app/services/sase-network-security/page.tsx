...
export const metadata: Metadata = {
  title: 'SASE Network Security | Zion Tech Group',
  description: 'Secure Access Service Edge with zero-trust networking, SD-WAN, and cloud-native threat prevention.',
  keywords: ["SASE", "zero trust", "SD-WAN", "cloud security", "network security"],
  openGraph: {
    title: 'SASE Network Security | Zion Tech Group',
    description: 'Secure Access Service Edge with zero-trust networking, SD-WAN, and cloud-native threat prevention.',
    url: 'https://ziontechgroup.com/services/sase-network-security/',
    type: 'website',
  },
  alternates: { canonical: '/services/sase-network-security/' },
};

export default function Page() {
  return (
    <StandardPage
      title="SASE Network Security"
      subtitle="Secure Access Service Edge with zero-trust networking, SD-WAN, and cloud-native threat prevention."
      breadcrumbItems={[
        { label: 'Home', href: '/' },
        { label: 'Services', href: '/services/' },
        { label: 'SASE Network Security' },
      ]}
      actions={[
    ...
    >
      <div class="grid gap-8 max-w-5xl mx-auto">
        <section class="grid md:grid-cols-2 gap-8 items-center">
          <div>
            <h2 class="text-2xl font-bold text-white mb-4">Why SASE Network Security?</h2>
            <p class="text-slate-300 leading-relaxed">
              Secure Access Service Edge with zero-trust networking, SD-WAN, and cloud-native threat prevention. Our proven methodology delivers measurable ROI
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Service", "name": "SASE Network Security", "description": "Secure Access Service Edge with zero-trust networking."}) }}
      />
    </StandardPage>
  );
}
