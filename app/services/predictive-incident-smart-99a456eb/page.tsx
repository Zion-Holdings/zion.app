...
export const metadata: Metadata = {
  title: 'Predictive Incident Smart',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Incident Smart
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cybersecurity through intelligent automation. Our Predictive Incident Smart leverages advanced machine learning to deliver document ai at scale.
          </p>
