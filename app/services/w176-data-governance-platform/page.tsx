...
export const metadata: Metadata = {
  ...
  keywords: 'Data policy definition and enforcement, Automated data classification (PII, PHI, sensitive), Stewardship workflows and accountability, Data lineage and impact analysis, Compliance tracking (GDPR, CCPA, HIPAA), Data catalog and business glossary, Integration with Collibra, Alation, Informatica, data, Data Governance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Data Governance Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Enterprise data governance: policy management, data classification, stewardship workflows, and compliance tracking. Govern your data assets properly.</p>
        ...
        <li class="text-slate-300">Data policy definition and enforcement</li>
        <li class="text-slate-300">Automated data classification (PII, PHI, sensitive)</li>
        <li class="text-slate-300">Stewardship workflows and accountability</li>
        <li class="text-slate-300">Data lineage and impact analysis</li>
        <li class="text-slate-300">Compliance tracking (GDPR, CCPA, HIPAA)</li>
        <li class="text-slate-300">Data catalog and business glossary</li>
        <li class="text-slate-300">Integration with Collibra, Alation, Informatica</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Classify sensitive data automatically</li>
        <li class="text-slate-300">Stewardship ensures data quality accountability</li>
        <li class="text-slate-300">Lineage tracks data from source to report</li>
        <li class="text-slate-300">Compliance tracking reduces audit risk</li>
      </ul>
        </div>
