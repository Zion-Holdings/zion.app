...
export const metadata: Metadata = {
  title: 'AI/IT smart-althealth',
  description: 'Enhance your althealth business with AI/IT smart-althealth. Our solution provides dashboard automation with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-smart-althealth-84327344',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT smart-althealth
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your althealth business with AI/IT smart-althealth. Our solution provides dashboard automation with enterprise-grade reliability and security.
          </p>
