...
export const metadata: Metadata = {
  title: 'AI/IT Predictor Suite - Construction',
  description: 'Optimize your construction workflows with AI/IT Predictor Suite - Construction. This intelligent platform delivers code optimization through advanced automation',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-predictor-suite-construction-4d5eae50',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Predictor Suite - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with AI/IT Predictor Suite - Construction. This intelligent platform delivers code optimization through advanced automation and AI.
          </p>
