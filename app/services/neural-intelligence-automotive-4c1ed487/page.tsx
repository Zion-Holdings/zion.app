...
export const metadata: Metadata = {
  title: 'Neural intelligence-automotive',
  description: 'Drive innovation in automotive with Neural intelligence-automotive. This AI-powered platform transforms document processing into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-intelligence-automotive-4c1ed487',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural intelligence-automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in automotive with Neural intelligence-automotive. This AI-powered platform transforms document processing into a competitive advantage.
          </p>
