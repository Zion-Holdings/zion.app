...
export const metadata: Metadata = {
  ...
  description: 'Quantum leap forward for real-estate: Intelligent Management for Real-Estate. Uses quantum-inspired algorithms to deliver benefits administration at exponential',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-management-for-real-estate-6109a3cc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for real-estate: Intelligent Management for Real-Estate. Uses quantum-inspired algorithms to deliver benefits administration at exponential speed.
          </p>
