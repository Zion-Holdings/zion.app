...
export const metadata: Metadata = {
  title: 'Autonomous Enterprise System - Healthcare',
  description: 'Optimize your healthcare workflows with Autonomous Enterprise System - Healthcare. This intelligent platform delivers resource allocation through advanced autom',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-enterprise-system-healthcare-d9b52f5b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Enterprise System - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Autonomous Enterprise System - Healthcare. This intelligent platform delivers resource allocation through advanced automation and AI.
          </p>
