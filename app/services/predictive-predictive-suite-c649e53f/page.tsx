...
export const metadata: Metadata = {
  title: 'Predictive Predictive Suite',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Predictive Suite
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation retail solution: Predictive Predictive Suite. Combines compliance monitoring with adaptive intelligence for optimal results.
          </p>
