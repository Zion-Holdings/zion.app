...
export const metadata: Metadata = {
  title: 'Automated Orchestrator for Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Automated Orchestrator for Hospitality leverages advanced machine learning to deliver supply chain',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-orchestrator-for-hospitality-f1e4238d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Orchestrator for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Automated Orchestrator for Hospitality leverages advanced machine learning to deliver supply chain at scale.
          </p>
