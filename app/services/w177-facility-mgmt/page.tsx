...
export const metadata: Metadata = {
  ...
  keywords: 'Work order management, Preventive maintenance scheduling, Space and room booking, Vendor and contractor management, Asset tracking and lifecycle, Integration with FMX, UpKeep, Limble, automation, Facilities, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Facility Management System</h1>
        <p className="text-lg text-slate-300 mb-8">Manage facilities: work orders, preventive maintenance, space management, vendor coordination.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">automation</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">Facilities</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Work order management</li>
        <li class="text-slate-300">Preventive maintenance scheduling</li>
        <li class="text-slate-300">Space and room booking</li>
        <li class="text-slate-300">Vendor and contractor management</li>
        <li class="text-slate-300">Asset tracking and lifecycle</li>
        <li class="text-slate-300">Integration with FMX</li>
        <li class="text-slate-300">UpKeep</li>
        <li class="text-slate-300">Limble</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Work order management for facilities</li>
        <li class="text-slate-300">Preventive maintenance reduces breakdowns</li>
        <li class="text-slate-300">Space booking optimizes utilization</li>
        <li class="text-slate-300">Vendor management for contractors</li>
      </ul>
        </div>
