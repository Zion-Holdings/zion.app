...
export const metadata: Metadata = {
  title: 'Autonomous Performance Intelligence',
  description: 'Enhance your hospitality business with Autonomous Performance Intelligence. Our solution provides customer onboarding with enterprise-grade reliability and secu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-performance-intelligence-78f20840',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Autonomous Performance Intelligence. Our solution provides customer onboarding with enterprise-grade reliability and security.
          </p>
