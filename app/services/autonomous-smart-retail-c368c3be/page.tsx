...
export const metadata: Metadata = {
  title: 'Autonomous Smart - Retail',
  description: 'The future of retail is here with Autonomous Smart - Retail. Powered by cutting-edge AI, this platform delivers transformative results like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-smart-retail-c368c3be',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Autonomous Smart - Retail. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
