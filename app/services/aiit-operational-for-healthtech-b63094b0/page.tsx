...
export const metadata: Metadata = {
  title: 'AI/IT Operational for HEALTHTECH',
  description: 'Drive innovation in healthtech with AI/IT Operational for HEALTHTECH. This AI-powered platform transforms security monitoring into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-operational-for-healthtech-b63094b0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Operational for HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthtech with AI/IT Operational for HEALTHTECH. This AI-powered platform transforms security monitoring into a competitive advantage.
          </p>
