...
export const metadata: Metadata = {
  title: 'Self-Optimizing security-tech',
  description: 'Drive innovation in technology with Self-Optimizing security-tech. This AI-powered platform transforms risk assessment into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/self-optimizing-security-tech-43df712b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing security-tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in technology with Self-Optimizing security-tech. This AI-powered platform transforms risk assessment into a competitive advantage.
          </p>
