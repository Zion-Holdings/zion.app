...
export const metadata = {
  ...
  description: "Unlock unprecedented growth with Predictive Authentication Engine - Tech. This autonomous system provides healthcare data analytics with zero manual interventio",
  alternates: {
