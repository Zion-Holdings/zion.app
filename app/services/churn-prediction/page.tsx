...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Churn Prediction Engine | Zion Tech Group",
    description: "ML-powered customer churn prediction with actionable retention recommendations. Analyzes usage patterns, support tickets, and engagement signals to flag at-risk accounts.",
    url: "https://ziontechgroup.com/services/churn-prediction/",
    type: 'website',
  },
  alternates: { canonical: "/services/churn-prediction/" },
};
...
export default function ChurnPredictionPage() {
  return (
    <StandardPage
      ...
      subtitle="ML-powered customer churn prediction with actionable retention recommendations. Analyzes usage patterns, support tickets, and engagement signals to flag at-risk accounts."
      breadcrumbItems={[
        { label: "Home", href: "/" },
    ...
    >
        ...
        <div className="rounded-2xl border border-white/10 bg-slate-900/40 p-5"><h2 className="text-white font-semibold mb-2">Churn Prediction Engine</h2><p className="text-slate-400 text-sm">Archived section recovered from the live site snapshot.</p></div>
      ...
      <p className="text-slate-400 leading-relaxed mb-4 max-w-5xl mx-auto">Estimated timeline for Churn Prediction Engine — adapt to your team size and complexity.</p>
      ...
      <p className="text-slate-500 text-sm max-w-5xl mx-auto">Restored from a Wayback Machine snapshot (20260607205449) of ziontechgroup.com.</p>
    </StandardPage>
  );
}
