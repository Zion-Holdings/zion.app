...
export const metadata: Metadata = {
  title: 'Next-Gen Supply for Insurance',
  description: 'Unlock unprecedented growth with Next-Gen Supply for Insurance. This autonomous system provides invoice automation with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-supply-for-insurance-122a22a1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Supply for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Next-Gen Supply for Insurance. This autonomous system provides invoice automation with zero manual intervention needed.
          </p>
