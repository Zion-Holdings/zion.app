...
export const metadata: Metadata = {
  title: 'Data Science AI-Powered Container Orchestration',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Science AI-Powered Container Orchestration
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered data science solution for devops. Intelligent container scheduling and resource allocation.
          </p>
