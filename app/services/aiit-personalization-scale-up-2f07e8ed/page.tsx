...
export const metadata: Metadata = {
  title: 'AI/IT Personalization Scale-up',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Personalization Scale-up
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation technology solution: AI/IT Personalization Scale-up. Combines scenario planning with adaptive intelligence for optimal results.
          </p>
