...
export const metadata: Metadata = {
  title: 'Automated insights-hospitality',
  description: 'Transform your hospitality operations with our Automated insights-hospitality. This AI-driven solution automates forecast accuracy with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-insights-hospitality-dfafd2ce',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated insights-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Automated insights-hospitality. This AI-driven solution automates forecast accuracy with unprecedented accuracy and efficiency.
          </p>
