...
export const metadata: Metadata = {
  ...
  description: 'Transform your real-estate operations with our Autonomous Supply System - Real-Estate. This AI-driven solution automates healthcare data analytics with unpreced',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-supply-system-real-estate-becf33cf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Autonomous Supply System - Real-Estate. This AI-driven solution automates healthcare data analytics with unprecedented accuracy and efficiency.
          </p>
