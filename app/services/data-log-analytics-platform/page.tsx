...
export const metadata: Metadata = {
  ...
  keywords: 'Grafana Loki index + LogQL query, Log parsing via grok/JSON/regex pipeline, Trace correlation via OpenTelemetry span ID, Hot/warm/cold tiered retention policy, data, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Log Analytics &amp; SIP Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Petabyte-scale log ingestion, structured parsing, Grafana/Loki/Tempo correlation, and retention tiered hot/warm/cold.</p>
        ...
        <li class="text-slate-300">Grafana Loki index + LogQL query</li>
        <li class="text-slate-300">Log parsing via grok/JSON/regex pipeline</li>
        <li class="text-slate-300">Trace correlation via OpenTelemetry span ID</li>
        <li class="text-slate-300">Hot/warm/cold tiered retention policy</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with log analytics &amp; sip platform</li>
