...
export const metadata: Metadata = {
  title: 'Performance Intelligent - Hospitality',
  description: 'Transform your hospitality operations with our Performance Intelligent - Hospitality. This AI-driven solution automates manufacturing quality control with unpre',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/performance-intelligent-hospitality-71f0cd89',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Performance Intelligent - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Performance Intelligent - Hospitality. This AI-driven solution automates manufacturing quality control with unprecedented accuracy and efficiency.
          </p>
