...
export const metadata: Metadata = {
  title: 'Autonomous Cloud System - Transportation',
  description: 'The future of transportation is here with Autonomous Cloud System - Transportation. Powered by cutting-edge AI, this platform delivers loyalty optimization like',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-cloud-system-transportation-ef17ccfd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Cloud System - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Autonomous Cloud System - Transportation. Powered by cutting-edge AI, this platform delivers loyalty optimization like never before.
          </p>
