...
export const metadata: Metadata = {
  title: 'Autonomous Supply System - Healthcare #2',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Supply System - Healthcare #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Autonomous Supply System - Healthcare #2. This intelligent platform delivers campaign optimization through advanced automation and AI.
          </p>
