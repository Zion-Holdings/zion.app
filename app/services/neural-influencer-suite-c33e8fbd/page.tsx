...
export const metadata: Metadata = {
  title: 'Neural Influencer Suite',
  description: 'Revolutionize legal through intelligent automation. Our Neural Influencer Suite leverages advanced machine learning to deliver enterprise-grade insights at scal',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Influencer Suite
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Neural Influencer Suite leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
