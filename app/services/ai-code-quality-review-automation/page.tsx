...
export const metadata: Metadata = {
  ...
  keywords: 'Automated PR review with inline comments, OWASP Top 10 vulnerability detection, Performance anti-pattern identification, Code complexity scoring, Auto-fix suggestions, Custom rule engine, GitHub, GitLab, Bitbucket integration, Team analytics, ai, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Code Review &amp; Quality Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Automated code review powered by large language models. Detects bugs, security vulnerabilities, performance issues, and style violations.</p>
        ...
        <li class="text-slate-300">Automated PR review with inline comments</li>
        <li class="text-slate-300">OWASP Top 10 vulnerability detection</li>
        <li class="text-slate-300">Performance anti-pattern identification</li>
        <li class="text-slate-300">Code complexity scoring</li>
        <li class="text-slate-300">Auto-fix suggestions</li>
        <li class="text-slate-300">Custom rule engine</li>
        <li class="text-slate-300">GitHub, GitLab, Bitbucket integration</li>
        <li class="text-slate-300">Team analytics</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Catch 80% of bugs before human review</li>
        <li class="text-slate-300">Reduce code review time by 60%</li>
        <li class="text-slate-300">Enforce coding standards</li>
        <li class="text-slate-300">Improve code quality and security</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$15/developer/mo</p>
              <p class="text-sm text-slate-400">Getting started plan</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              <h3 class="font-semibold text-white mb-2">Pro</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">$35/developer/mo</p>
