...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-channel campaign builder works across email, SMS, social, push, and ads, Audience segmentation engine — behavioural and demographic criteria enriched per user, Content calendaring view visualises live campaigns across every channel, Real-time ROI dashboard with cross-channel attribution across up to 10 touchpoints, automation, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Multi-Channel Campaign Manager</h1>
        <p className="text-lg text-slate-300 mb-8">Orchestrate campaigns across email, SMS, social, push, and ads from one campaign studio: audience-segmentation engine, content-Calendar view, A/B-n testing, real-time ROI dashboard, attribution across 10 channels.</p>
        ...
        <li class="text-slate-300">Multi-channel campaign builder works across email, SMS, social, push, and ads</li>
        <li class="text-slate-300">Audience segmentation engine — behavioural and demographic criteria enriched per user</li>
        <li class="text-slate-300">Content calendaring view visualises live campaigns across every channel</li>
        <li class="text-slate-300">Real-time ROI dashboard with cross-channel attribution across up to 10 touchpoints</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with multi-channel campaign manager</li>
