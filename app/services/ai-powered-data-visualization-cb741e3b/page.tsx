...
export const metadata = {
  title: 'AI-Powered Data Visualization - AI-Powered BI Solution',
      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Chart recommendations</li>
            <li className="text-purple-300">✓ Graph generation</li>
            </ul>
          </div>
