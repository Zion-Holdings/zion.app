...
export const metadata: Metadata = {
  title: 'Smart Finance Platform - Tech',
  description: 'The future of technology is here with Smart Finance Platform - Tech. Powered by cutting-edge AI, this platform delivers resource optimization like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-finance-platform-tech-11cf276a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Finance Platform - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of technology is here with Smart Finance Platform - Tech. Powered by cutting-edge AI, this platform delivers resource optimization like never before.
          </p>
