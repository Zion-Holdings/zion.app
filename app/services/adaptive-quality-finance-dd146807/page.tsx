...
export const metadata: Metadata = {
  title: 'Adaptive quality-finance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive quality-finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in finance with Adaptive quality-finance. This AI-powered platform transforms cost reduction into a competitive advantage.
          </p>
