...
export const metadata: Metadata = {
  title: 'Real Estate Adaptive - Education',
  description: 'Drive innovation in education with Real Estate Adaptive - Education. This AI-powered platform transforms manufacturing quality control into a competitive advant',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Real Estate Adaptive - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in education with Real Estate Adaptive - Education. This AI-powered platform transforms manufacturing quality control into a competitive advantage.
          </p>
