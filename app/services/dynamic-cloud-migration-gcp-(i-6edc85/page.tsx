...
export const metadata: Metadata = {
  title: 'Dynamic Cloud Migration GCP (Iot)',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Dynamic Cloud Migration GCP (Iot)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Dynamic Cloud Migration GCP (Iot) is an AI-powered iot solution that transforms how businesses operate through intelligent automation and real-time analytics.
