...
export const metadata: Metadata = {
  title: 'Intelligent Marketing for Hospitality',
  description: 'Transform your hospitality operations with our Intelligent Marketing for Hospitality. This AI-driven solution automates maintenance scheduling with unprecedente',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-marketing-for-hospitality-11f8991b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Marketing for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Intelligent Marketing for Hospitality. This AI-driven solution automates maintenance scheduling with unprecedented accuracy and efficiency.
          </p>
