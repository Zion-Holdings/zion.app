...
export const metadata: Metadata = {
  title: 'Engine AI - Logistics',
  description: 'Transform your logistics operations with our Engine AI - Logistics. This AI-driven solution automates customer onboarding with unprecedented accuracy and effici',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Engine AI - Logistics. This AI-driven solution automates customer onboarding with unprecedented accuracy and efficiency.
          </p>
