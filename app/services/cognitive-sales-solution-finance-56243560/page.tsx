...
export const metadata: Metadata = {
  title: 'Cognitive Sales Solution - Finance',
  description: 'The future of finance is here with Cognitive Sales Solution - Finance. Powered by cutting-edge AI, this platform delivers anomaly detection like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-sales-solution-finance-56243560',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Sales Solution - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of finance is here with Cognitive Sales Solution - Finance. Powered by cutting-edge AI, this platform delivers anomaly detection like never before.
          </p>
