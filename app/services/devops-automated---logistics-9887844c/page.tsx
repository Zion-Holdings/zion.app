...
export const metadata: Metadata = {
  title: 'DevOps Automated - Logistics',
  description: 'The future of logistics is here with DevOps Automated - Logistics. Powered by cutting-edge AI, this platform delivers manufacturing quality control like never b',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/devops-automated---logistics-9887844c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            DevOps Automated - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with DevOps Automated - Logistics. Powered by cutting-edge AI, this platform delivers manufacturing quality control like never before.
          </p>
