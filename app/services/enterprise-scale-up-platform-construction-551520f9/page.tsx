...
export const metadata: Metadata = {
  title: 'Enterprise Scale-up Platform - Construction',
  description: 'Transform your construction operations with our Enterprise Scale-up Platform - Construction. This AI-driven solution automates anomaly detection with unpreceden',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-scale-up-platform-construction-551520f9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Scale-up Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Enterprise Scale-up Platform - Construction. This AI-driven solution automates anomaly detection with unprecedented accuracy and efficiency.
          </p>
