...
export const metadata: Metadata = {
  ...
  keywords: 'Event-log ingestion from ERP, CRM, and BPM — 10+ standard connectors, Process discovery — actual vs. intended step map with frequency breakdown, Bottleneck identification — highlight choke points on process with deviation rate, Change-impact simulation — predict how a new step or rule change affects total cost and lead time, automation, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Process Mining Intelligence</h1>
        <p className="text-lg text-slate-300 mb-8">Event-log based process discovery: take event-logs from ERP, CRM, BPM systems, discover actual vs. intended process maps, identify bottleneck and deviation, quantify handoff wait time, change-impact simulation.</p>
        ...
        <li class="text-slate-300">Event-log ingestion from ERP, CRM, and BPM — 10+ standard connectors</li>
        <li class="text-slate-300">Process discovery — actual vs. intended step map with frequency breakdown</li>
        <li class="text-slate-300">Bottleneck identification — highlight choke points on process with deviation rate</li>
        <li class="text-slate-300">Change-impact simulation — predict how a new step or rule change affects total cost and lead time</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with process mining intelligence</li>
