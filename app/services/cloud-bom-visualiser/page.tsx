...
export const metadata: Metadata = {
  ...
  keywords: 'Full dependency graph visualisation, Change impact analysis, Real-time configuration drift alerts, Kubernetes resource aware, Export to SVG and PDF, cloud, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cloud BOM &amp; Dependency Visualiser</h1>
        <p className="text-lg text-slate-300 mb-8">Map every cloud dependency from DNS records and load balancers to container images and Lambda layers. Visual graph with change impact analysis.</p>
        ...
        <li class="text-slate-300">Full dependency graph visualisation</li>
        <li class="text-slate-300">Change impact analysis</li>
        <li class="text-slate-300">Real-time configuration drift alerts</li>
        <li class="text-slate-300">Kubernetes resource aware</li>
        <li class="text-slate-300">Export to SVG and PDF</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with cloud bom &amp; dependency visualiser</li>
