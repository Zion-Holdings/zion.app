...
export const metadata: Metadata = {
  title: 'Intelligence Adaptive - Proptech',
  description: 'Revolutionize proptech through intelligent automation. Our Intelligence Adaptive - Proptech leverages advanced machine learning to deliver resource optimization',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligence-adaptive---proptech-024f38a8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligence Adaptive - Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our Intelligence Adaptive - Proptech leverages advanced machine learning to deliver resource optimization at scale.
          </p>
