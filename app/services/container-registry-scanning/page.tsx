...
export const metadata: Metadata = {
  ...
  keywords: 'Vulnerability scanning, Policy enforcement, CI/CD integration, Image signing, Compliance checks, Access control, Audit logging, Multi-region replication, it, Enterprise, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Container Registry &amp; Security Scanning</h1>
        <p className="text-lg text-slate-300 mb-8">Secure container registry with vulnerability scanning, policy enforcement, and CI/CD integration. Supports Docker and OCI images with automated compliance checks.</p>
        ...
        <li class="text-slate-300">Vulnerability scanning</li>
        <li class="text-slate-300">Policy enforcement</li>
        <li class="text-slate-300">CI/CD integration</li>
        <li class="text-slate-300">Image signing</li>
        <li class="text-slate-300">Compliance checks</li>
        <li class="text-slate-300">Access control</li>
        <li class="text-slate-300">Audit logging</li>
        <li class="text-slate-300">Multi-region replication</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">95% vulnerability detection</li>
        <li class="text-slate-300">Automated compliance</li>
        <li class="text-slate-300">Secure supply chain</li>
      </ul>
        </div>
