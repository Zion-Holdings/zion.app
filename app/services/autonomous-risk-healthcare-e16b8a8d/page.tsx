...
export const metadata: Metadata = {
  title: 'Autonomous risk-healthcare',
  description: 'Drive innovation in healthcare with Autonomous risk-healthcare. This AI-powered platform transforms rpa orchestration into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-risk-healthcare-e16b8a8d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous risk-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with Autonomous risk-healthcare. This AI-powered platform transforms rpa orchestration into a competitive advantage.
          </p>
