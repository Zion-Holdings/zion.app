...
export const metadata: Metadata = {
  title: 'Predictive Risk Engine - Agriculture',
  description: 'The future of agriculture is here with Predictive Risk Engine - Agriculture. Powered by cutting-edge AI, this platform delivers campaign optimization like never',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-risk-engine-agriculture-696f4889',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Risk Engine - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Predictive Risk Engine - Agriculture. Powered by cutting-edge AI, this platform delivers campaign optimization like never before.
          </p>
