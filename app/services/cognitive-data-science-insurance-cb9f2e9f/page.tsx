...
export const metadata: Metadata = {
  title: 'Cognitive data science-insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive data science-insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Cognitive data science-insurance. Combines quality control with adaptive intelligence for optimal results.
          </p>
