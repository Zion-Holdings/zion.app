...
export const metadata: Metadata = {
  ...
  description: 'cloud migration solution for forestry industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing copy.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cloud-migration-ai-powered-seo-content-engine-5788c5c9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            cloud migration solution for forestry industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing copy.
          </p>
