      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize media through intelligent automation. Our Revenue AI - Media leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
