...
export const metadata: Metadata = {
  title: 'Quantum Suite - Education Quantum',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Suite - Education Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for education: Quantum Suite - Education Quantum. Uses quantum-inspired algorithms to deliver account planning at exponential speed.
          </p>
