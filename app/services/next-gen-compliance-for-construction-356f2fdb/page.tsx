...
export const metadata: Metadata = {
  title: 'Next-Gen Compliance for Construction',
  description: 'The future of construction is here with Next-Gen Compliance for Construction. Powered by cutting-edge AI, this platform delivers career development like never b',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-compliance-for-construction-356f2fdb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Compliance for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Next-Gen Compliance for Construction. Powered by cutting-edge AI, this platform delivers career development like never before.
          </p>
