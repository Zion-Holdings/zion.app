...
export const metadata: Metadata = {
  title: 'Cognitive Performance Solution - Telecom',
  description: 'Enhance your telecom business with Cognitive Performance Solution - Telecom. Our solution provides root cause analysis with enterprise-grade reliability and sec',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Performance Solution - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your telecom business with Cognitive Performance Solution - Telecom. Our solution provides root cause analysis with enterprise-grade reliability and security.
          </p>
