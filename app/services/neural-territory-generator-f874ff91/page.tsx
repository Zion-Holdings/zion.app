...
export const metadata: Metadata = {
  title: 'Neural Territory Generator',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Territory Generator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Neural Territory Generator. This AI-powered platform transforms user provisioning into a competitive advantage.
          </p>
