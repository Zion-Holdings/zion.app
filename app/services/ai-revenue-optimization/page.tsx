    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Increase revenue by 15-30% through optimized pricing</li>
            <li>Reduce price-setting time from weeks to minutes</li>
            <li>Real-time competitor price intelligence</li>
            <li>Data-driven pricing decisions across all channels</li>
          </ul>
        </div>
