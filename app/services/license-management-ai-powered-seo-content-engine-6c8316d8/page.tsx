...
export const metadata: Metadata = {
  title: 'License Management AI-Powered SEO Content Engine',
  description: 'license management solution for public health industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing copy',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/license-management-ai-powered-seo-content-engine-6c8316d8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            License Management AI-Powered SEO Content Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            license management solution for public health industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing copy.
          </p>
