...
export const metadata: Metadata = {
  title: 'Supply Autonomous - Retail',
  description: 'Enhance your retail business with Supply Autonomous - Retail. Our solution provides employee engagement with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/supply-autonomous-retail-1a4460e2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Supply Autonomous - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your retail business with Supply Autonomous - Retail. Our solution provides employee engagement with enterprise-grade reliability and security.
          </p>
