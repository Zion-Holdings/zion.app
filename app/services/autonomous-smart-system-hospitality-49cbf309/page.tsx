...
export const metadata: Metadata = {
  title: 'Autonomous Smart System - Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Autonomous Smart System - Hospitality leverages advanced machine learning to deliver brand monitor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-smart-system-hospitality-49cbf309',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Smart System - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Autonomous Smart System - Hospitality leverages advanced machine learning to deliver brand monitoring at scale.
          </p>
