...
export const metadata: Metadata = {
  title: 'Self-Optimizing Finance for Manufacturing',
  description: 'Drive innovation in manufacturing with Self-Optimizing Finance for Manufacturing. This AI-powered platform transforms content moderation into a competitive adva',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Finance for Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in manufacturing with Self-Optimizing Finance for Manufacturing. This AI-powered platform transforms content moderation into a competitive advantage.
          </p>
