...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize iot through intelligent automation. Our Smart system-iot leverages advanced machine learning to deliver user experience at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-system-iot-60c5dbff',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize iot through intelligent automation. Our Smart system-iot leverages advanced machine learning to deliver user experience at scale.
          </p>
