...
export const metadata: Metadata = {
  title: 'AI-Powered Analytics for Construction',
  description: 'Revolutionize construction through intelligent automation. Our AI-Powered Analytics for Construction leverages advanced machine learning to deliver energy manag',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-analytics-for-construction-847ec63b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Analytics for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our AI-Powered Analytics for Construction leverages advanced machine learning to deliver energy management at scale.
          </p>
