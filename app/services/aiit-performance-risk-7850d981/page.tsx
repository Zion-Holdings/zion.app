...
export const metadata: Metadata = {
  title: 'AI/IT Performance Risk',
  description: 'Revolutionize regtech through intelligent automation. Our AI/IT Performance Risk leverages advanced machine learning to deliver invoice automation at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-performance-risk-7850d981',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Performance Risk
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize regtech through intelligent automation. Our AI/IT Performance Risk leverages advanced machine learning to deliver invoice automation at scale.
          </p>
