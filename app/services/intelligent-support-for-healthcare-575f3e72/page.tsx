...
export const metadata: Metadata = {
  title: 'Intelligent Support for Healthcare',
  description: 'Enhance your healthcare business with Intelligent Support for Healthcare. Our solution provides master data management with enterprise-grade reliability and sec',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Support for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with Intelligent Support for Healthcare. Our solution provides master data management with enterprise-grade reliability and security.
          </p>
