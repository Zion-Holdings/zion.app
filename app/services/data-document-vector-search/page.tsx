...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-format ingest (PDF/DOCX/PPTX/EML), Parse + semantic chunk + sentence embed, Hybrid BM25+DPR retrieval + cross-encoder rerank, Per-tenant namespace ACL in vector DB, data, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Document Intelligence + Vector Search</h1>
        <p className="text-lg text-slate-300 mb-8">Chunk embed store in vector DB; hybrid BM25 + dense retrieval; semantic reranking; per-tenant document isolation.</p>
        ...
        <li class="text-slate-300">Multi-format ingest (PDF/DOCX/PPTX/EML)</li>
        <li class="text-slate-300">Parse + semantic chunk + sentence embed</li>
        <li class="text-slate-300">Hybrid BM25+DPR retrieval + cross-encoder rerank</li>
        <li class="text-slate-300">Per-tenant namespace ACL in vector DB</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with document intelligence + vector search</li>
