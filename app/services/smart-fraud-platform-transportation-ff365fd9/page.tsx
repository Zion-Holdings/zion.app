...
export const metadata: Metadata = {
  title: 'Smart Fraud Platform - Transportation',
  description: 'The future of transportation is here with Smart Fraud Platform - Transportation. Powered by cutting-edge AI, this platform delivers hr analytics like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-fraud-platform-transportation-ff365fd9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Fraud Platform - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Smart Fraud Platform - Transportation. Powered by cutting-edge AI, this platform delivers hr analytics like never before.
          </p>
