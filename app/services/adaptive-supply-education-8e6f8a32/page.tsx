...
export const metadata: Metadata = {
  title: 'Adaptive supply-education',
  description: 'Drive innovation in education with Adaptive supply-education. This AI-powered platform transforms cost reduction into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-supply-education-8e6f8a32',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive supply-education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in education with Adaptive supply-education. This AI-powered platform transforms cost reduction into a competitive advantage.
          </p>
