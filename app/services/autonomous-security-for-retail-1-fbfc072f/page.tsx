...
export const metadata: Metadata = {
  title: 'Autonomous Security for Retail #1',
  description: 'The future of retail is here with Autonomous Security for Retail #1. Powered by cutting-edge AI, this platform delivers transformative results like never before',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-security-for-retail-1-fbfc072f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Security for Retail #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Autonomous Security for Retail #1. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
