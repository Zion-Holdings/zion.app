...
export const metadata: Metadata = {
  ...
  keywords: 'Natural-language workflow authoring, 100+ pre-built app connectors, AI decision nodes (classify, extract, score), Human-in-the-loop approval node, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Workflow Automation Builder — Starter</h1>
        <p className="text-lg text-slate-300 mb-8">Entry-level AI workflow builder: natural language workflow design, 100+ connectors, AI decision nodes, scheduled triggers, and human-in-the-loop approval steps for small teams.</p>
        ...
        <li class="text-slate-300">Natural-language workflow authoring</li>
        <li class="text-slate-300">100+ pre-built app connectors</li>
        <li class="text-slate-300">AI decision nodes (classify, extract, score)</li>
        <li class="text-slate-300">Human-in-the-loop approval node</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai workflow automation builder — starter</li>
