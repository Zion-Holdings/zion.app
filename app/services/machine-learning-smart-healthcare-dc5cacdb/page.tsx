...
export const metadata: Metadata = {
  title: 'Machine Learning Smart - Healthcare',
  description: 'Next-generation healthcare solution: Machine Learning Smart - Healthcare. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/machine-learning-smart-healthcare-dc5cacdb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Machine Learning Smart - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Machine Learning Smart - Healthcare. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
