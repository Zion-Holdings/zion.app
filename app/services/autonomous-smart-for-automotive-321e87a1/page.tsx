...
export const metadata: Metadata = {
  title: 'Autonomous Smart for Automotive',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Smart for Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your automotive business with Autonomous Smart for Automotive. Our solution provides data quality with enterprise-grade reliability and security.
          </p>
