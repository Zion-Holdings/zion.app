...
export const metadata: Metadata = {
  title: 'Intelligent Quality for CLEANTECH',
  description: 'Transform your cleantech operations with our Intelligent Quality for CLEANTECH. This AI-driven solution automates reporting automation with unprecedented accura',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Quality for CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your cleantech operations with our Intelligent Quality for CLEANTECH. This AI-driven solution automates reporting automation with unprecedented accuracy and efficiency.
          </p>
