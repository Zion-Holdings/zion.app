...
export const metadata: Metadata = {
  title: 'Analyzer Adaptive - Logistics',
  description: 'Transform your logistics operations with our Analyzer Adaptive - Logistics. This AI-driven solution automates risk assessment with unprecedented accuracy and ef',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Analyzer Adaptive - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Analyzer Adaptive - Logistics. This AI-driven solution automates risk assessment with unprecedented accuracy and efficiency.
          </p>
