...
export const metadata: Metadata = {
  title: 'AI System - Construction Edition #1',
  description: 'Revolutionize construction through intelligent automation. Our AI System - Construction Edition #1 leverages advanced machine learning to deliver enterprise-gra',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-system-construction-edition-1-6ac812af',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI System - Construction Edition #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our AI System - Construction Edition #1 leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
