...
export const metadata: Metadata = {
  title: 'Automated optimization-proptech',
  description: 'Revolutionize proptech through intelligent automation. Our Automated optimization-proptech leverages advanced machine learning to deliver sales process optimiza',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated optimization-proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our Automated optimization-proptech leverages advanced machine learning to deliver sales process optimization at scale.
          </p>
