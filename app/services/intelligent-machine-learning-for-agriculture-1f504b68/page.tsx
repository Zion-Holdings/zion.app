...
export const metadata: Metadata = {
  title: 'Intelligent Machine Learning for Agriculture',
  description: 'Transform your agriculture operations with our Intelligent Machine Learning for Agriculture. This AI-driven solution automates succession planning with unpreced',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-machine-learning-for-agriculture-1f504b68',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Machine Learning for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Intelligent Machine Learning for Agriculture. This AI-driven solution automates succession planning with unprecedented accuracy and efficiency.
          </p>
