...
export const metadata: Metadata = {
  title: 'AI/IT Management Suite - Transportation',
  description: 'Drive innovation in transportation with AI/IT Management Suite - Transportation. This AI-powered platform transforms lead scoring into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-management-suite-transportation-3d1cbf18',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Management Suite - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in transportation with AI/IT Management Suite - Transportation. This AI-powered platform transforms lead scoring into a competitive advantage.
          </p>
