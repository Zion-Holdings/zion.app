...
export const metadata: Metadata = {
  title: 'AI/IT Deep Learning Suite - Telecom',
  description: 'Next-generation telecom solution: AI/IT Deep Learning Suite - Telecom. Combines rpa orchestration with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-deep-learning-suite-telecom-3937211f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Deep Learning Suite - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation telecom solution: AI/IT Deep Learning Suite - Telecom. Combines rpa orchestration with adaptive intelligence for optimal results.
          </p>
