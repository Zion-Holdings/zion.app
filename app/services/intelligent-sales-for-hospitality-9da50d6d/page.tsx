...
export const metadata: Metadata = {
  title: 'Intelligent Sales for Hospitality',
  description: 'Enhance your hospitality business with Intelligent Sales for Hospitality. Our solution provides customer insights with enterprise-grade reliability and security',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-sales-for-hospitality-9da50d6d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Sales for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Intelligent Sales for Hospitality. Our solution provides customer insights with enterprise-grade reliability and security.
          </p>
