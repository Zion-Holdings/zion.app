...
export const metadata: Metadata = {
  title: 'Quantum Supply - Retail Quantum',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Supply - Retail Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Quantum Supply - Retail Quantum. Powered by cutting-edge AI, this platform delivers risk assessment like never before.
          </p>
