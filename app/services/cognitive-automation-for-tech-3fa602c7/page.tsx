...
export const metadata: Metadata = {
  title: 'Cognitive Automation for Tech',
  description: 'Transform your technology operations with our Cognitive Automation for Tech. This AI-driven solution automates document processing with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-automation-for-tech-3fa602c7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Automation for Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your technology operations with our Cognitive Automation for Tech. This AI-driven solution automates document processing with unprecedented accuracy and efficiency.
          </p>
