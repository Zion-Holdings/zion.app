      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Score every inbound and outbound lead on fit, intent, and priority. Auto-enrich records with 50+ data providers including LinkedIn, Crunchbase, and Clearbit.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Fit and intent scoring model</li>
            <li className="text-purple-300">✓ 50+ data provider enrichment</li>
            <li className="text-purple-300">✓ CRM native sync Salesforce and HubSpot</li>
            <li className="text-purple-300">✓ Priority queue routing</li>
            <li className="text-purple-300">✓ Enrichment history audit trail</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai lead richness scorer & enricher</li>
