...
export const metadata: Metadata = {
  ...
  keywords: 'Fit and intent scoring model, 50+ data provider enrichment, CRM native sync Salesforce and HubSpot, Priority queue routing, Enrichment history audit trail, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Lead Richness Scorer &amp; Enricher</h1>
        <p className="text-lg text-slate-300 mb-8">Score every inbound and outbound lead on fit, intent, and priority. Auto-enrich records with 50+ data providers including LinkedIn, Crunchbase, and Clearbit.</p>
        ...
        <li class="text-slate-300">Fit and intent scoring model</li>
        <li class="text-slate-300">50+ data provider enrichment</li>
        <li class="text-slate-300">CRM native sync Salesforce and HubSpot</li>
        <li class="text-slate-300">Priority queue routing</li>
        <li class="text-slate-300">Enrichment history audit trail</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai lead richness scorer &amp; enricher</li>
