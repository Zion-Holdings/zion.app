...
export const metadata: Metadata = {
  title: 'AI Soil Health Analyst',
  description: 'Analyzes soil sensor data for precision agriculture and regenerative farming.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-soil-health-analyst-3ebb8b81',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Soil Health Analyst
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Analyzes soil sensor data for precision agriculture and regenerative farming.
          </p>
