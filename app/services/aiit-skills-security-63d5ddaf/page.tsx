...
export const metadata: Metadata = {
  title: 'AI/IT Skills Security',
  description: 'Quantum leap forward for telecom: AI/IT Skills Security. Uses quantum-inspired algorithms to deliver api composition at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-skills-security-63d5ddaf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Skills Security
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for telecom: AI/IT Skills Security. Uses quantum-inspired algorithms to deliver api composition at exponential speed.
          </p>
