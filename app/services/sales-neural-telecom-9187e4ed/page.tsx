...
export const metadata: Metadata = {
  title: 'Sales Neural - Telecom',
  description: 'Revolutionize telecom through intelligent automation. Our Sales Neural - Telecom leverages advanced machine learning to deliver enterprise-grade insights at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Sales Neural - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Sales Neural - Telecom leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
