...
export const metadata: Metadata = {
  title: 'Autonomous System for Agriculture',
  description: 'Transform your agriculture operations with our Autonomous System for Agriculture. This AI-driven solution automates predictive analytics with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-system-for-agriculture-c1bf551c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Autonomous System for Agriculture. This AI-driven solution automates predictive analytics with unprecedented accuracy and efficiency.
          </p>
