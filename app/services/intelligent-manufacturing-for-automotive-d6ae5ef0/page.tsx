...
export const metadata: Metadata = {
  title: 'Intelligent Manufacturing for Automotive',
  description: 'The future of automotive is here with Intelligent Manufacturing for Automotive. Powered by cutting-edge AI, this platform delivers quota optimization like never',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of automotive is here with Intelligent Manufacturing for Automotive. Powered by cutting-edge AI, this platform delivers quota optimization like never before.
          </p>
