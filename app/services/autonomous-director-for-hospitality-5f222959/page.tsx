...
export const metadata: Metadata = {
  title: 'Autonomous Director for Hospitality',
  description: 'The future of hospitality is here with Autonomous Director for Hospitality. Powered by cutting-edge AI, this platform delivers energy management like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-director-for-hospitality-5f222959',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Director for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Autonomous Director for Hospitality. Powered by cutting-edge AI, this platform delivers energy management like never before.
          </p>
