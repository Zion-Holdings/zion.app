...
export const metadata: Metadata = {
  title: 'Platform Predictive - Hospitality',
  description: 'Next-generation hospitality solution: Platform Predictive - Hospitality. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/platform-predictive-hospitality-dc400770',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Platform Predictive - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Platform Predictive - Hospitality. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
