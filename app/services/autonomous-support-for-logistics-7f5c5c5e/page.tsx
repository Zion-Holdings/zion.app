...
export const metadata: Metadata = {
  title: 'Autonomous Support for Logistics',
  description: 'Transform your logistics operations with our Autonomous Support for Logistics. This AI-driven solution automates customer service automation with unprecedented ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-support-for-logistics-7f5c5c5e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Support for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Autonomous Support for Logistics. This AI-driven solution automates customer service automation with unprecedented accuracy and efficiency.
          </p>
