...
export const metadata: Metadata = {
  title: 'Predictive Risk for Healthcare',
  description: 'The future of healthcare is here with Predictive Risk for Healthcare. Powered by cutting-edge AI, this platform delivers influencer identification like never be',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-risk-for-healthcare-0893ce4c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Risk for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Predictive Risk for Healthcare. Powered by cutting-edge AI, this platform delivers influencer identification like never before.
          </p>
