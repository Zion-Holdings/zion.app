...
export const metadata: Metadata = {
  title: 'Adaptive Management for Healthcare',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Adaptive Management for Healthcare. Powered by cutting-edge AI, this platform delivers customer insights like never before.
          </p>
