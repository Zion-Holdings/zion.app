...
export const metadata: Metadata = {
  title: 'Intelligent Quality for Manufacturing',
  description: 'Enhance your manufacturing business with Intelligent Quality for Manufacturing. Our solution provides content moderation with enterprise-grade reliability and s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-quality-for-manufacturing-e872c1c7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Quality for Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your manufacturing business with Intelligent Quality for Manufacturing. Our solution provides content moderation with enterprise-grade reliability and security.
          </p>
