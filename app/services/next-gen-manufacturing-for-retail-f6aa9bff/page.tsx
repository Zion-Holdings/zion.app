...
export const metadata: Metadata = {
  title: 'Next-Gen Manufacturing for Retail',
  description: 'The future of retail is here with Next-Gen Manufacturing for Retail. Powered by cutting-edge AI, this platform delivers territory management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-manufacturing-for-retail-f6aa9bff',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Manufacturing for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Next-Gen Manufacturing for Retail. Powered by cutting-edge AI, this platform delivers territory management like never before.
          </p>
