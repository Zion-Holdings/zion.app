...
export const metadata: Metadata = {
  title: 'Intelligent Generator Platform',
  description: 'Transform your retail operations with our Intelligent Generator Platform. This data solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-generator-platform-14559',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Generator Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our Intelligent Generator Platform. This data solution delivers unprecedented automation and intelligence.
          </p>
