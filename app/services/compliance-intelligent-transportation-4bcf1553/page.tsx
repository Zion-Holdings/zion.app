...
export const metadata = {
  ...
  description: "Revolutionize transportation through intelligent automation. Our Compliance Intelligent - Transportation leverages advanced machine learning to deliver maintena",
  alternates: {
