...
export const metadata: Metadata = {
  title: 'Healthcare Smart - Automotive',
  description: 'Next-generation automotive solution: Healthcare Smart - Automotive. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/healthcare-smart-automotive-b9376201',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Healthcare Smart - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation automotive solution: Healthcare Smart - Automotive. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
