...
export const metadata: Metadata = {
  title: 'Automated nlp-legal',
  description: 'Enhance your legal business with Automated nlp-legal. Our solution provides sales forecasting with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-nlp-legal-ed79996b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Automated nlp-legal. Our solution provides sales forecasting with enterprise-grade reliability and security.
          </p>
