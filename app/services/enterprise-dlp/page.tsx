...
export const metadata: Metadata = {
  ...
  keywords: 'Endpoint + Network + Cloud DLP unified, Content inspection by PII/PHI/PCI/confidential, Policy: block/quarantine/alert per class, Cloud DLP: S3/GDrive/SharePoint/Box/OneDrive, Incident remediation workflow, one-click, security, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Enterprise Data Loss Prevention (DLP)</h1>
        <p className="text-lg text-slate-300 mb-8">Prevent data exfiltration at rest, in transit, in-use: endpoint DLP, network DLP, cloud DLP (S3/GDrive/SharePoint/Box). Content inspection + policy enforcement + remediation.</p>
        ...
        <li class="text-slate-300">Endpoint + Network + Cloud DLP unified</li>
        <li class="text-slate-300">Content inspection by PII/PHI/PCI/confidential</li>
        <li class="text-slate-300">Policy: block/quarantine/alert per class</li>
        <li class="text-slate-300">Cloud DLP: S3/GDrive/SharePoint/Box/OneDrive</li>
        <li class="text-slate-300">Incident remediation workflow, one-click</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with enterprise data loss prevention (dlp)</li>
