...
export const metadata: Metadata = {
  title: 'Smart Testing Suite - Agriculture',
  description: 'Future-proof your agriculture with Smart Testing Suite - Agriculture. Our autonomous solution handles personalization engine end-to-end without human interventi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-testing-suite-agriculture-3ffacc9d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Testing Suite - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your agriculture with Smart Testing Suite - Agriculture. Our autonomous solution handles personalization engine end-to-end without human intervention.
          </p>
