...
export const metadata: Metadata = {
  title: 'Autonomous Finance for Insurance',
  description: 'Optimize your insurance workflows with Autonomous Finance for Insurance. This intelligent platform delivers resource optimization through advanced automation an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-finance-for-insurance-f108e9bb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Finance for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Autonomous Finance for Insurance. This intelligent platform delivers resource optimization through advanced automation and AI.
          </p>
