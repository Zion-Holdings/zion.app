...
export const metadata: Metadata = {
  title: 'Automated ESG Support',
  description: 'Quantum leap forward for martech: Automated ESG Support. Uses quantum-inspired algorithms to deliver master data management at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-esg-support-b27989b0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated ESG Support
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for martech: Automated ESG Support. Uses quantum-inspired algorithms to deliver master data management at exponential speed.
          </p>
