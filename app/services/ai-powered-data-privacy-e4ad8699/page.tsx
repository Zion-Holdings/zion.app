...
export const metadata: Metadata = {
  title: 'AI-Powered Data Privacy',
  description: 'GDPR/CCPA compliance automation with automated data redaction.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-data-privacy-e4ad8699',
  },

export const metadata = {
  title: "AI-Powered Data Privacy - Zion Tech Group",
  description: "GDPR/CCPA compliance automation with automated data redaction.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-data-privacy-e4ad8699`
  }
  ...
  return (
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            GDPR/CCPA compliance automation with automated data redaction.
          </p>
    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">AI-Powered Data Privacy</h1>
        <p className="text-lg text-gray-300 mb-8">GDPR/CCPA compliance automation with automated data redaction.</p>
