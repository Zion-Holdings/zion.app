...
export const metadata = {
  ...
  description: 'End-to-end bot detection services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/bot-detection-2026-7125/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">Bot Detection</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end bot detection services: assessment, deployment, and managed operations.
        </p>
