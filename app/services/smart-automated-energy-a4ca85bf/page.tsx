...
export const metadata: Metadata = {
  title: 'Smart Automated - Energy',
  description: 'Optimize your energy workflows with Smart Automated - Energy. This intelligent platform delivers edge computing through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-automated-energy-a4ca85bf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your energy workflows with Smart Automated - Energy. This intelligent platform delivers edge computing through advanced automation and AI.
          </p>
