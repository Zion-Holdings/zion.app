...
export const metadata: Metadata = {
  title: 'Smart DevOps Platform - Agriculture #1',
  description: 'Transform your agriculture operations with our Smart DevOps Platform - Agriculture #1. This AI-driven solution automates performance monitoring with unprecedent',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-devops-platform-agriculture-1-367ea4dc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart DevOps Platform - Agriculture #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Smart DevOps Platform - Agriculture #1. This AI-driven solution automates performance monitoring with unprecedented accuracy and efficiency.
          </p>
