...
export const metadata: Metadata = {
  title: 'Experience Autonomous - Telecom',
  description: 'Optimize your telecom workflows with Experience Autonomous - Telecom. This intelligent platform delivers survey automation through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/experience-autonomous-telecom-77b39292',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Experience Autonomous - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your telecom workflows with Experience Autonomous - Telecom. This intelligent platform delivers survey automation through advanced automation and AI.
          </p>
