...
export const metadata: Metadata = {
  title: 'Next-Gen Financial for Gaming',
  description: 'Unlock unprecedented growth with Next-Gen Financial for Gaming. This autonomous system provides warehouse automation with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-financial-for-gaming-06dcfdb4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Financial for Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Next-Gen Financial for Gaming. This autonomous system provides warehouse automation with zero manual intervention needed.
          </p>
