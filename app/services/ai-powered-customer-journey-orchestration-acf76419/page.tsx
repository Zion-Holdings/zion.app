...
export const metadata: Metadata = {
  ...
  description: 'End-to-end customer journey mapping and orchestration platform that uses AI to predict next-best-actions and automate touchpoint personalization across all chan',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-customer-journey-orchestration-acf76419',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            End-to-end customer journey mapping and orchestration platform that uses AI to predict next-best-actions and automate touchpoint personalization across all channels.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Journey mapping</li>
          <li className="text-gray-300">Real-time personalization</li>
          <li className="text-gray-300">Cross-channel orchestration</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">40% increase in conversion</li>
          <li className="text-purple-300">3x faster campaign deployment</li>
          <li className="text-purple-300">Unified customer view</li>
          </ul>
        </section>
