...
export const metadata = {
  ...
  description: 'End-to-end business intelligence services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/business-intelligence-2026-7126/' },
};
    ...
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        ...
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end business intelligence services: assessment, deployment, and managed operations.
        </p>
