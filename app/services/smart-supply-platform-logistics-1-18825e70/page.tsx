...
export const metadata: Metadata = {
  title: 'Smart Supply Platform - Logistics #1',
  description: 'The future of logistics is here with Smart Supply Platform - Logistics #1. Powered by cutting-edge AI, this platform delivers data quality like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-supply-platform-logistics-1-18825e70',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Supply Platform - Logistics #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Smart Supply Platform - Logistics #1. Powered by cutting-edge AI, this platform delivers data quality like never before.
          </p>
