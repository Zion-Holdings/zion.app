...
export const metadata: Metadata = {
  title: 'Autonomous Cloud System - Retail',
  description: 'The future of retail is here with Autonomous Cloud System - Retail. Powered by cutting-edge AI, this platform delivers customer onboarding like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-cloud-system-retail-3ea45c45',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Cloud System - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Autonomous Cloud System - Retail. Powered by cutting-edge AI, this platform delivers customer onboarding like never before.
          </p>
