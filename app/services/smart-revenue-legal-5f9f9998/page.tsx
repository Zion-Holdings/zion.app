      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Smart revenue-legal. This AI-driven solution automates forecast accuracy with unprecedented accuracy and efficiency.
          </p>
