...
export const metadata: Metadata = {
  ...
  description: 'The future of construction is here with AI Orchestrator - Construction Edition. Powered by cutting-edge AI, this platform delivers transformative results like n',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-orchestrator-construction-edition-5f7f7a0c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with AI Orchestrator - Construction Edition. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
