...
export const metadata: Metadata = {
  title: 'AI/IT marketing-construction',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT marketing-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with AI/IT marketing-construction. This AI-powered platform transforms case management into a competitive advantage.
          </p>
