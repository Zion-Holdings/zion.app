...
export const metadata: Metadata = {
  title: 'Intelligent data science-legal',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent data science-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Intelligent data science-legal. Combines ml model training with adaptive intelligence for optimal results.
          </p>
