...
export const metadata: Metadata = {
  title: 'Intelligent Coordinator for Sports',
  description: 'Next-generation sports solution: Intelligent Coordinator for Sports. Combines sales forecasting with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-coordinator-for-sports-7b45d2b2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Coordinator for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation sports solution: Intelligent Coordinator for Sports. Combines sales forecasting with adaptive intelligence for optimal results.
          </p>
