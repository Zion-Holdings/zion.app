...
export const metadata = {
  ...
  description: 'End-to-end it asset management automation: track hardware, software, and licenses in real time services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/it-asset-management-automation-track-hardware-software-and-licenses-in-real-time-19/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">IT Asset Management Automation: Track Hardware, Software, and Licenses in Real Time</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end it asset management automation: track hardware, software, and licenses in real time services: assessment, deployment, and managed operations.
        </p>
