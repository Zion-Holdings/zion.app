...
export const metadata: Metadata = {
  title: 'AI-Powered Platform for Legal',
  description: 'Revolutionize legal through intelligent automation. Our AI-Powered Platform for Legal leverages advanced machine learning to deliver performance monitoring at s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-platform-for-legal-54a040a1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Platform for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our AI-Powered Platform for Legal leverages advanced machine learning to deliver performance monitoring at scale.
          </p>
