...
export const metadata: Metadata = {
  title: 'AI/IT Insights Suite - Telecom',
  description: 'Quantum leap forward for telecom: AI/IT Insights Suite - Telecom. Uses quantum-inspired algorithms to deliver fleet management at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-insights-suite-telecom-7f4904af',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Insights Suite - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for telecom: AI/IT Insights Suite - Telecom. Uses quantum-inspired algorithms to deliver fleet management at exponential speed.
          </p>
