  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Driven Predictive Marketing Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Intelligent marketing platform that creates predictive campaigns across channels, optimizing content and targeting.</p>
