...
export const metadata: Metadata = {
  title: 'Cognitive Cost System',
  description: 'Transform your hospitality operations with our Cognitive Cost System. This AI-driven solution provides intelligent automation with unprecedented accuracy and ef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-cost-system-e2cae3b1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Cost System
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Cognitive Cost System. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
