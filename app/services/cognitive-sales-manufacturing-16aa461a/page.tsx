...
export const metadata: Metadata = {
  title: 'Cognitive Sales Manufacturing',
  description: 'Transform your hospitality operations with our Cognitive Sales Manufacturing. This AI-driven solution automates content generation with unprecedented accuracy a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Sales Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Cognitive Sales Manufacturing. This AI-driven solution automates content generation with unprecedented accuracy and efficiency.
          </p>
