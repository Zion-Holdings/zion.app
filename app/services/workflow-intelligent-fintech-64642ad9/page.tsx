...
export const metadata: Metadata = {
  title: 'Workflow Intelligent - FINTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Workflow Intelligent - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for fintech: Workflow Intelligent - FINTECH. Uses quantum-inspired algorithms to deliver roi tracking at exponential speed.
          </p>
