...
export const metadata: Metadata = {
  ...
  keywords: 'Intelligent automation and orchestration, Enterprise-grade integration, Real-time monitoring and alerts, Scalable multi-tenant architecture, it, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Event-Driven Architecture (EDA) Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Design and implement event-driven microservices: Apache Kafka or Pulsar event mesh, schema registry, CQRS plus event sourcing patterns, exactly-once delivery, and replay and replay-sanitise pipelines.</p>
        ...
        <li class="text-slate-300">Intelligent automation and orchestration</li>
        <li class="text-slate-300">Enterprise-grade integration</li>
        <li class="text-slate-300">Real-time monitoring and alerts</li>
        <li class="text-slate-300">Scalable multi-tenant architecture</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with event-driven architecture (eda) platform</li>
