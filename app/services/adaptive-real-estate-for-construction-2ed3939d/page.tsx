...
export const metadata: Metadata = {
  title: 'Adaptive Real Estate for Construction',
  description: 'Next-generation construction solution: Adaptive Real Estate for Construction. Combines inventory management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-real-estate-for-construction-2ed3939d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Real Estate for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Adaptive Real Estate for Construction. Combines inventory management with adaptive intelligence for optimal results.
          </p>
