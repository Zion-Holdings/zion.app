...
export const metadata: Metadata = {
  title: "Affiliate Management Zero-Trust Identity & Access Manager - AI-Powered Warehousing Solution",
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Affiliate Management Zero-Trust Identity & Access Manager - AI-Powered Warehousing Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          affiliate management solution for warehousing industry. Implements zero-trust security architecture with continuous authentication and adaptive access controls.
        </p>
