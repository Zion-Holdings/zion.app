...
export const metadata: Metadata = {
  title: 'Manufacturing Cognitive - Agriculture',
  description: 'Next-generation agriculture solution: Manufacturing Cognitive - Agriculture. Combines benefits administration with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/manufacturing-cognitive-agriculture-5bb05a16',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manufacturing Cognitive - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agriculture solution: Manufacturing Cognitive - Agriculture. Combines benefits administration with adaptive intelligence for optimal results.
          </p>
