...
export const metadata: Metadata = {
  title: 'Smart Monitoring for Construction',
  description: 'The future of construction is here with Smart Monitoring for Construction. Powered by cutting-edge AI, this platform delivers cost reduction like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-monitoring-for-construction-d4365b0e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Monitoring for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Smart Monitoring for Construction. Powered by cutting-edge AI, this platform delivers cost reduction like never before.
          </p>
