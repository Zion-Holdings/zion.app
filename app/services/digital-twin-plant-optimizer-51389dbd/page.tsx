...
export const metadata: Metadata = {
  title: 'Digital Twin Plant Optimizer',
  description: 'Plant-level digital twin with real-time process simulation and optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/digital-twin-plant-optimizer-51389dbd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Digital Twin Plant Optimizer
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Plant-level digital twin with real-time process simulation and optimization.
          </p>
