...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-channel aggregation (email, chat, social), Emotion classification (8 categories), Trend alerts for sentiment drops, Root-cause topic clustering, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Customer Sentiment Tracker</h1>
        <p className="text-lg text-slate-300 mb-8">Monitors support tickets, reviews, social mentions, and surveys to produce a real-time Net Promoter Score (NPS) and emotion heatmap.</p>
        ...
        <li class="text-slate-300">Multi-channel aggregation (email, chat, social)</li>
        <li class="text-slate-300">Emotion classification (8 categories)</li>
        <li class="text-slate-300">Trend alerts for sentiment drops</li>
        <li class="text-slate-300">Root-cause topic clustering</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai customer sentiment tracker</li>
