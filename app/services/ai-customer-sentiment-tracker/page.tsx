  ...
  <div className="min-h-screen bg-slate-950 text-white">
   ...
   <main className="min-h-screen bg-slate-950 py-20 px-4">
    <div className="container-page max-w-4xl mx-auto">
     ...
     <p className="text-slate-300 text-lg mb-8">Monitors support tickets, reviews, social mentions, and surveys to produce a real-time Net Promoter Score (NPS) and emotion heatmap.</p>
