...
export const metadata: Metadata = {
  ...
  keywords: 'Identity resolution, Unified customer profiles, Real-time segmentation, Activation across channels, Privacy compliance (GDPR/CCPA), Data enrichment, Lookalike audience modeling, Consent management, micro-saas, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Customer Data Platform (CDP)</h1>
        <p className="text-lg text-slate-300 mb-8">Unify customer data from all touchpoints into a single profile. Identity resolution, segmentation, activation, and privacy compliance — all in one platform.</p>
        ...
        <li class="text-slate-300">Identity resolution</li>
        <li class="text-slate-300">Unified customer profiles</li>
        <li class="text-slate-300">Real-time segmentation</li>
        <li class="text-slate-300">Activation across channels</li>
        <li class="text-slate-300">Privacy compliance (GDPR/CCPA)</li>
        <li class="text-slate-300">Data enrichment</li>
        <li class="text-slate-300">Lookalike audience modeling</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">360-degree customer view</li>
        <li class="text-slate-300">20% higher campaign ROI</li>
        <li class="text-slate-300">Privacy compliance built-in</li>
        <li class="text-slate-300">Real-time audience updates</li>
        <li class="text-slate-300">Reduced data silos</li>
      </ul>
        </div>
