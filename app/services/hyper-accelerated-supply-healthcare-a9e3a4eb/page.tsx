...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Supply - Healthcare',
  description: 'Optimize your healthcare workflows with Hyper-Accelerated Supply - Healthcare. This intelligent platform delivers project management through advanced automation',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Supply - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Hyper-Accelerated Supply - Healthcare. This intelligent platform delivers project management through advanced automation and AI.
          </p>
