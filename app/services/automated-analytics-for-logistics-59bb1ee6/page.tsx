...
export const metadata: Metadata = {
  title: 'Automated Analytics for Logistics',
  description: 'Transform your logistics operations with our Automated Analytics for Logistics. This AI-driven solution automates decision support with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-analytics-for-logistics-59bb1ee6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Analytics for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Automated Analytics for Logistics. This AI-driven solution automates decision support with unprecedented accuracy and efficiency.
          </p>
