...
export const metadata: Metadata = {
  ...
  description: 'Enhance your legal business with Autonomous Suite System - Legal. Our solution provides scenario planning with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-suite-system-legal-d23a9520',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Autonomous Suite System - Legal. Our solution provides scenario planning with enterprise-grade reliability and security.
          </p>
