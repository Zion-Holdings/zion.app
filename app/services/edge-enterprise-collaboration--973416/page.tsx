...
export const metadata: Metadata = {
  title: 'Edge Enterprise Collaboration Redis (Healthcare)',
  description: 'Edge Enterprise Collaboration Redis (Healthcare) is an AI-powered healthcare solution that transforms how businesses operate through intelligent automation and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/edge-enterprise-collaboration--973416',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Edge Enterprise Collaboration Redis (Healthcare)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Edge Enterprise Collaboration Redis (Healthcare) is an AI-powered healthcare solution that transforms how businesses operate through intelligent automation and real-time analytics.
