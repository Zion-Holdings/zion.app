...
export const metadata: Metadata = {
  title: 'Intelligent Computer Vision for Telecom',
  description: 'The future of telecom is here with Intelligent Computer Vision for Telecom. Powered by cutting-edge AI, this platform delivers ml model training like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-computer-vision-for-telecom-bf206c0a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Computer Vision for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of telecom is here with Intelligent Computer Vision for Telecom. Powered by cutting-edge AI, this platform delivers ml model training like never before.
          </p>
