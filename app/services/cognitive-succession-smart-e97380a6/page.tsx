...
export const metadata: Metadata = {
  title: 'Cognitive Succession Smart',
  description: 'Next-generation insurance solution: Cognitive Succession Smart. Combines pipeline management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-succession-smart-e97380a6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Succession Smart
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Cognitive Succession Smart. Combines pipeline management with adaptive intelligence for optimal results.
          </p>
