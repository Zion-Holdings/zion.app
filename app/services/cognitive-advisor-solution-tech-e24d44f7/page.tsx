...
export const metadata: Metadata = {
  title: 'Cognitive Advisor Solution - Tech',
  description: 'Revolutionize technology through intelligent automation. Our Cognitive Advisor Solution - Tech leverages advanced machine learning to deliver process discovery ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Advisor Solution - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our Cognitive Advisor Solution - Tech leverages advanced machine learning to deliver process discovery at scale.
          </p>
