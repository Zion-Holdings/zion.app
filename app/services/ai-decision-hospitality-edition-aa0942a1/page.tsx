...
export const metadata: Metadata = {
  title: 'AI Decision - Hospitality Edition',
  description: 'Optimize your hospitality workflows with AI Decision - Hospitality Edition. This intelligent platform delivers process discovery through advanced automation and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-decision-hospitality-edition-aa0942a1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Decision - Hospitality Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with AI Decision - Hospitality Edition. This intelligent platform delivers process discovery through advanced automation and AI.
          </p>
