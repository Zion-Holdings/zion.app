...
export const metadata: Metadata = {
  title: 'Intelligent machine learning-construction',
  description: 'Next-generation construction solution: Intelligent machine learning-construction. Combines process discovery with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-machine-learning-construction-443e7861',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent machine learning-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Intelligent machine learning-construction. Combines process discovery with adaptive intelligence for optimal results.
          </p>
