...
export const metadata: Metadata = {
  title: 'Enterprise Risk Platform - TECHNOLOGY',
  description: 'Quantum leap forward for technology: Enterprise Risk Platform - TECHNOLOGY. Uses quantum-inspired algorithms to deliver logistics route optimization at exponent',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-risk-platform-technology-1381f030',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Risk Platform - TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for technology: Enterprise Risk Platform - TECHNOLOGY. Uses quantum-inspired algorithms to deliver logistics route optimization at exponential speed.
          </p>
