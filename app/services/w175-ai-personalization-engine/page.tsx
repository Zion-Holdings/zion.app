...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time user profiling and segmentation, Product recommendations (collaborative + content-based), Content and landing page personalization, Dynamic pricing optimization, Multi-armed bandit experiment engine, A/B/n test management, SDK for web, iOS, Android, React, ai, E-Commerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Personalization Engine</h1>
        <p className="text-lg text-slate-300 mb-8">ML-powered real-time personalization for web, mobile, and email. Product recommendations, content targeting, dynamic pricing — all without manual rules.</p>
        ...
        <li class="text-slate-300">Real-time user profiling and segmentation</li>
        <li class="text-slate-300">Product recommendations (collaborative + content-based)</li>
        <li class="text-slate-300">Content and landing page personalization</li>
        <li class="text-slate-300">Dynamic pricing optimization</li>
        <li class="text-slate-300">Multi-armed bandit experiment engine</li>
        <li class="text-slate-300">A/B/n test management</li>
        <li class="text-slate-300">SDK for web, iOS, Android, React</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Increase conversion rate by 25-40%</li>
        <li class="text-slate-300">ML personalization outperforms manual rules</li>
        <li class="text-slate-300">Dynamic pricing maximizes revenue</li>
        <li class="text-slate-300">Multi-armed bandit optimizes automatically</li>
      </ul>
        </div>
