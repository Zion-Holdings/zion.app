...
export const metadata: Metadata = {
  title: 'Next-Gen Recruitment - Construction',
  description: 'The future of construction is here with Next-Gen Recruitment - Construction. Powered by cutting-edge AI, this platform delivers pipeline management like never b',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-recruitment-construction-bc8e80d6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Recruitment - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Next-Gen Recruitment - Construction. Powered by cutting-edge AI, this platform delivers pipeline management like never before.
          </p>
