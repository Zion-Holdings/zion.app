...
export const metadata: Metadata = {
  title: 'Manufacturing AI/IT - ALTHEALTH',
  description: 'Drive innovation in althealth with Manufacturing AI/IT - ALTHEALTH. This AI-powered platform transforms document processing into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/manufacturing-aiit-althealth-00a52ab7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manufacturing AI/IT - ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in althealth with Manufacturing AI/IT - ALTHEALTH. This AI-powered platform transforms document processing into a competitive advantage.
          </p>
