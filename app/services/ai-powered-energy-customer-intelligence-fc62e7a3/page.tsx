...
export const metadata: Metadata = {
  title: "AI-Powered Energy Customer Intelligence - AI-Powered Energy Solution",
  description: "AI-powered energy solution leveraging advanced machine learning for optimal performance and ROI.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-energy-customer-intelligence-fc62e7a3",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Energy Customer Intelligence - AI-Powered Energy Solution
        </h1>
