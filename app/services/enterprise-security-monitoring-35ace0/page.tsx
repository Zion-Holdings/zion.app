...
export const metadata: Metadata = {
  title: 'Enterprise Security Monitoring Airflow (Ai)',
  description: 'Enterprise Security Monitoring Airflow (Ai) is an AI-powered ai solution that transforms how businesses operate through intelligent automation and real-time ana',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Security Monitoring Airflow (Ai)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enterprise Security Monitoring Airflow (Ai) is an AI-powered ai solution that transforms how businesses operate through intelligent automation and real-time analytics.
