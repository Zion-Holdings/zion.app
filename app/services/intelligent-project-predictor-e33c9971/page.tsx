...
export const metadata: Metadata = {
  title: 'Intelligent Project Predictor',
  description: 'The future of education is here with Intelligent Project Predictor. Powered by cutting-edge AI, this platform delivers quota optimization like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-project-predictor-e33c9971',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Project Predictor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of education is here with Intelligent Project Predictor. Powered by cutting-edge AI, this platform delivers quota optimization like never before.
          </p>
