...
export const metadata = {
  ...
  description: "Enterprise-grade workflow orchestration: unlimited workflows, role-based access, SSO, custom AI model integration, multi-region deployment, and 24/7 dedicated s",
  alternates: {
