...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize hospitality through intelligent automation. Our Autonomous Intelligence for Hospitality #1 leverages advanced machine learning to deliver serverle',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-intelligence-for-hospitality-1-ac6d1686',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Autonomous Intelligence for Hospitality #1 leverages advanced machine learning to deliver serverless deployment at scale.
          </p>
