...
export const metadata: Metadata = {
  title: 'Care Management AI-Powered Infrastructure as Code',
  description: 'AI-powered care management solution for infrastructure. AI-generated infrastructure code with best practices and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/care-management-ai-powered-infrastructure-as-code-680ff085',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Care Management AI-Powered Infrastructure as Code
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered care management solution for infrastructure. AI-generated infrastructure code with best practices and security.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your care management operations?</p>
