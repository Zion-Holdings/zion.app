...
export const metadata: Metadata = {
  title: 'Telemedicine AI-Powered Content Generation Platform',
  description: 'AI-powered telemedicine solution for marketing. Generates high-quality, SEO-optimized content at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/telemedicine-ai-powered-content-generation-platform-02c7edfd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Telemedicine AI-Powered Content Generation Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered telemedicine solution for marketing. Generates high-quality, SEO-optimized content at scale.
          </p>
