...
export const metadata: Metadata = {
  title: 'AI-Powered Manager for Hospitality',
  description: 'Transform your hospitality operations with our AI-Powered Manager for Hospitality. This AI-driven solution provides intelligent automation with unprecedented ac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-manager-for-hospitality-4ac92aa3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Manager for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our AI-Powered Manager for Hospitality. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
