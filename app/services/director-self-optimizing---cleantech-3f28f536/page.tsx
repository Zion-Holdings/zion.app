...
export const metadata: Metadata = {
  title: 'Director Self-Optimizing - Cleantech',
  description: 'Revolutionize cleantech through intelligent automation. Our Director Self-Optimizing - Cleantech leverages advanced machine learning to deliver maintenance sche',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Director Self-Optimizing - Cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cleantech through intelligent automation. Our Director Self-Optimizing - Cleantech leverages advanced machine learning to deliver maintenance scheduling at scale.
          </p>
