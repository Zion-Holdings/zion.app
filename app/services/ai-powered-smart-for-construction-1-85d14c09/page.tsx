...
export const metadata: Metadata = {
  title: 'AI-Powered Smart for Construction #1',
  description: 'Drive innovation in construction with AI-Powered Smart for Construction #1. This AI-powered platform transforms project portfolio into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-smart-for-construction-1-85d14c09',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Smart for Construction #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with AI-Powered Smart for Construction #1. This AI-powered platform transforms project portfolio into a competitive advantage.
          </p>
