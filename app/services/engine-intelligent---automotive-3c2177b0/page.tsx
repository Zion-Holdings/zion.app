...
export const metadata: Metadata = {
  title: 'Engine Intelligent - Automotive',
  description: 'Transform your automotive operations with our Engine Intelligent - Automotive. This AI-driven solution automates customer insights with unprecedented accuracy a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Engine Intelligent - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your automotive operations with our Engine Intelligent - Automotive. This AI-driven solution automates customer insights with unprecedented accuracy and efficiency.
          </p>
