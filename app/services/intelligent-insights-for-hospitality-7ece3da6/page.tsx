...
export const metadata: Metadata = {
  title: 'Intelligent Insights for Hospitality',
  description: 'Enhance your hospitality business with Intelligent Insights for Hospitality. Our solution provides inventory management with enterprise-grade reliability and se',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-insights-for-hospitality-7ece3da6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Insights for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Intelligent Insights for Hospitality. Our solution provides inventory management with enterprise-grade reliability and security.
          </p>
