...
export const metadata: Metadata = {
  title: 'Cognitive Optimizer for Construction',
  description: 'Transform your construction operations with our Cognitive Optimizer for Construction. This AI-driven solution provides intelligent automation with unprecedented',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-optimizer-for-construction-fa16dd6b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Optimizer for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Cognitive Optimizer for Construction. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
