...
export const metadata: Metadata = {
  title: 'Quantum Quality - Cybersecurity Quantum',
  description: 'The future of cybersecurity is here with Quantum Quality - Cybersecurity Quantum. Powered by cutting-edge AI, this platform delivers onboarding automation like ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Quality - Cybersecurity Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of cybersecurity is here with Quantum Quality - Cybersecurity Quantum. Powered by cutting-edge AI, this platform delivers onboarding automation like never before.
          </p>
