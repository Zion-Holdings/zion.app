...
export const metadata: Metadata = {
  title: 'Cognitive Director Solution - EDTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Director Solution - EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in edtech with Cognitive Director Solution - EDTECH. This AI-powered platform transforms content moderation into a competitive advantage.
          </p>
