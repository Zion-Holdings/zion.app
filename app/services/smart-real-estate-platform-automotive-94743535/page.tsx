...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize automotive through intelligent automation. Our Smart Real Estate Platform - Automotive leverages advanced machine learning to deliver scalability ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize automotive through intelligent automation. Our Smart Real Estate Platform - Automotive leverages advanced machine learning to deliver scalability planning at scale.
          </p>
