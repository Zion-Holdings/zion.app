...
export const metadata: Metadata = {
  title: 'Automated Language Process Mining',
  description: 'The future of agriculture is here with Automated Language Process Mining. Powered by cutting-edge AI, this platform delivers succession planning like never befo',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Language Process Mining
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Automated Language Process Mining. Powered by cutting-edge AI, this platform delivers succession planning like never before.
          </p>
