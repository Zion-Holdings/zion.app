...
export const metadata: Metadata = {
  ...
  keywords: 'Continuous per-interval Top-K aggregation on grouped dimensions with configurable window size, Out-of-norm score per dimension — automatically explains what changed since last window, Sigma-deviation alerting on every time-series window per threshold per metric, Curated drill-down per spike — root-cause dimension linked from the alert context, data, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Real-Time Trending Analytics</h1>
        <p className="text-lg text-slate-300 mb-8">Real-time windowed aggregation engine: 1-minute tumbling and hopping windows per dimension, per-interval top-K ranking, out-of-norm alerting, sigma deviation triggering, and curated drill-down with root-cause dimension linking per window.</p>
        ...
        <li class="text-slate-300">Continuous per-interval Top-K aggregation on grouped dimensions with configurable window size</li>
        <li class="text-slate-300">Out-of-norm score per dimension — automatically explains what changed since last window</li>
        <li class="text-slate-300">Sigma-deviation alerting on every time-series window per threshold per metric</li>
        <li class="text-slate-300">Curated drill-down per spike — root-cause dimension linked from the alert context</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with real-time trending analytics</li>
