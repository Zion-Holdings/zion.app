...
export const metadata: Metadata = {
  title: 'Enterprise Startup Platform - Insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Startup Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Enterprise Startup Platform - Insurance. This AI-powered platform transforms decision support into a competitive advantage.
          </p>
