...
export const metadata: Metadata = {
  title: 'Smart intelligence-healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Smart intelligence-healthcare leverages advanced machine learning to deliver healthcare data analyt',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart intelligence-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Smart intelligence-healthcare leverages advanced machine learning to deliver healthcare data analytics at scale.
          </p>
