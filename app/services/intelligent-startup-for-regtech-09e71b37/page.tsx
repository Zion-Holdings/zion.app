...
export const metadata: Metadata = {
  title: 'Intelligent Startup for REGTECH',
  description: 'Drive innovation in regtech with Intelligent Startup for REGTECH. This AI-powered platform transforms demand planning into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-startup-for-regtech-09e71b37',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Startup for REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in regtech with Intelligent Startup for REGTECH. This AI-powered platform transforms demand planning into a competitive advantage.
          </p>
