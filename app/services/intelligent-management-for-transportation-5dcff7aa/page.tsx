...
export const metadata: Metadata = {
  title: 'Intelligent Management for Transportation',
  description: 'Transform your transportation operations with our Intelligent Management for Transportation. This AI-driven solution automates content moderation with unprecede',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-management-for-transportation-5dcff7aa',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Management for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your transportation operations with our Intelligent Management for Transportation. This AI-driven solution automates content moderation with unprecedented accuracy and efficiency.
          </p>
