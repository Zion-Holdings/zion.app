...
export const metadata: Metadata = {
  title: 'Next-Gen Director - Manufacturing',
  description: 'Enhance your manufacturing business with Next-Gen Director - Manufacturing. Our solution provides resource optimization with enterprise-grade reliability and se',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Director - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your manufacturing business with Next-Gen Director - Manufacturing. Our solution provides resource optimization with enterprise-grade reliability and security.
          </p>
