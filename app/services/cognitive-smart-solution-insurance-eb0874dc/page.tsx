...
export const metadata: Metadata = {
  title: 'Cognitive Smart Solution - Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Cognitive Smart Solution - Insurance leverages advanced machine learning to deliver security monitor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-smart-solution-insurance-eb0874dc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Smart Solution - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Cognitive Smart Solution - Insurance leverages advanced machine learning to deliver security monitoring at scale.
          </p>
