...
export const metadata: Metadata = {
  title: 'AI Security - Healthcare Edition',
  description: 'Optimize your healthcare workflows with AI Security - Healthcare Edition. This intelligent platform delivers roi tracking through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-security-healthcare-edition-fae99387',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Security - Healthcare Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with AI Security - Healthcare Edition. This intelligent platform delivers roi tracking through advanced automation and AI.
          </p>
