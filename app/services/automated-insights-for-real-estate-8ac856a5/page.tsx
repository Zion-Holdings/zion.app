...
export const metadata: Metadata = {
  title: 'Automated Insights for Real-Estate',
  description: 'Next-generation real-estate solution: Automated Insights for Real-Estate. Combines market intelligence with adaptive intelligence for optimal results.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Insights for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation real-estate solution: Automated Insights for Real-Estate. Combines market intelligence with adaptive intelligence for optimal results.
          </p>
