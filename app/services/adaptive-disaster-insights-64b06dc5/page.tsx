...
export const metadata: Metadata = {
  title: 'Adaptive Disaster Insights',
  description: 'Next-generation retail solution: Adaptive Disaster Insights. Combines social media monitoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-disaster-insights-64b06dc5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Disaster Insights
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation retail solution: Adaptive Disaster Insights. Combines social media monitoring with adaptive intelligence for optimal results.
          </p>
