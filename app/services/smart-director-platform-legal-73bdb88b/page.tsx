...
export const metadata: Metadata = {
  title: 'Smart Director Platform - Legal',
  description: 'Unlock unprecedented growth with Smart Director Platform - Legal. This autonomous system provides sourcing optimization with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-director-platform-legal-73bdb88b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Director Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Director Platform - Legal. This autonomous system provides sourcing optimization with zero manual intervention needed.
          </p>
