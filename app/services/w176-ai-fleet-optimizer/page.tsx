...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time dynamic route optimization, Fuel consumption prediction and tracking, Driver behavior scoring and coaching, Predictive maintenance scheduling, Load and capacity optimization, Geofencing and compliance tracking, Integration with Samsara, Geotab, Fleetio, ai, Logistics, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Fleet Route Optimizer</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered fleet management: real-time route optimization, fuel prediction, driver behavior analysis, and maintenance scheduling. Reduce fuel costs by 20%.</p>
        ...
        <li class="text-slate-300">Real-time dynamic route optimization</li>
        <li class="text-slate-300">Fuel consumption prediction and tracking</li>
        <li class="text-slate-300">Driver behavior scoring and coaching</li>
        <li class="text-slate-300">Predictive maintenance scheduling</li>
        <li class="text-slate-300">Load and capacity optimization</li>
        <li class="text-slate-300">Geofencing and compliance tracking</li>
        <li class="text-slate-300">Integration with Samsara, Geotab, Fleetio</li>
      </ul>
        </div>
        ...
        <li class="text-slate-300">Dynamic routing adapts to traffic in real-time</li>
        <li class="text-slate-300">Driver coaching reduces incidents</li>
        <li class="text-slate-300">Predictive maintenance prevents breakdowns</li>
      </ul>
        </div>
