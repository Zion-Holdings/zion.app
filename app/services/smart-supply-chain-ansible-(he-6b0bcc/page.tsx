...
export const metadata: Metadata = {
  title: 'Smart Supply Chain Ansible (Healthcare)',
  description: 'Smart Supply Chain Ansible (Healthcare) is an AI-powered healthcare solution that transforms how businesses operate through intelligent automation and real-time',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-supply-chain-ansible-(he-6b0bcc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Supply Chain Ansible (Healthcare)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Smart Supply Chain Ansible (Healthcare) is an AI-powered healthcare solution that transforms how businesses operate through intelligent automation and real-time analytics.
...
Hadoop, Kubernetes, GCP, Spark, Vue.js, PostgreSQL
