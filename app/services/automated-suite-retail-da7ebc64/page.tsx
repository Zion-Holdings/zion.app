...
export const metadata: Metadata = {
  title: 'Automated suite-retail',
  description: 'Enhance your retail business with Automated suite-retail. Our solution provides container orchestration with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-suite-retail-da7ebc64',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated suite-retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your retail business with Automated suite-retail. Our solution provides container orchestration with enterprise-grade reliability and security.
          </p>
