...
export const metadata = {
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/algorithmic-trading-risk-manager-17b55066`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path={`/services/algorithmic-trading-risk-manager-17b55066`} title="Algorithmic Trading Risk Manager" />
