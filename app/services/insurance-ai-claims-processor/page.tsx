...
export const metadata: Metadata = {
  ...
  keywords: 'Automated intake, Fraud detection, Damage assessment, Adjudication, Payment processing, Customer communication, Compliance, Analytics, ai, Insurance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Insurance AI Claims Processor</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end claims processing with AI — intake, fraud detection, damage assessment, adjudication, and payment. Reduces processing time from weeks to minutes.</p>
        ...
        <li class="text-slate-300">Automated intake</li>
        <li class="text-slate-300">Fraud detection</li>
        <li class="text-slate-300">Damage assessment</li>
        <li class="text-slate-300">Adjudication</li>
        <li class="text-slate-300">Payment processing</li>
        <li class="text-slate-300">Customer communication</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">80% faster processing</li>
        <li class="text-slate-300">Fraud detection 95%+</li>
