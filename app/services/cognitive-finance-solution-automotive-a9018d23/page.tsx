...
export const metadata: Metadata = {
  title: 'Cognitive Finance Solution - Automotive',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Finance Solution - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in automotive with Cognitive Finance Solution - Automotive. This AI-powered platform transforms data governance into a competitive advantage.
          </p>
