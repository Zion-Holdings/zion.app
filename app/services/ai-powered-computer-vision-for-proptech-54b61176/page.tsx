...
export const metadata: Metadata = {
  title: 'AI-Powered Computer Vision for PROPTECH',
  description: 'The future of proptech is here with AI-Powered Computer Vision for PROPTECH. Powered by cutting-edge AI, this platform delivers data processing like never befor',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Computer Vision for PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with AI-Powered Computer Vision for PROPTECH. Powered by cutting-edge AI, this platform delivers data processing like never before.
          </p>
