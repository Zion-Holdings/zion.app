...
export const metadata: Metadata = {
  title: 'Cognitive DevOps Solution - Hospitality',
  description: 'Optimize your hospitality workflows with Cognitive DevOps Solution - Hospitality. This intelligent platform delivers recruitment automation through advanced aut',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-devops-solution-hospitality-d06257f2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive DevOps Solution - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Cognitive DevOps Solution - Hospitality. This intelligent platform delivers recruitment automation through advanced automation and AI.
          </p>
