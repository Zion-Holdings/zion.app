...
export const metadata: Metadata = {
  title: 'Smart Analyzer Platform - Sports',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Analyzer Platform - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your sports business with Smart Analyzer Platform - Sports. Our solution provides capacity management with enterprise-grade reliability and security.
          </p>
