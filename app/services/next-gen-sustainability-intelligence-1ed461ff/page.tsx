...
export const metadata: Metadata = {
  title: 'Next-Gen Sustainability Intelligence',
  description: 'Optimize your cybersecurity workflows with Next-Gen Sustainability Intelligence. This intelligent platform delivers fraud prevention through advanced automation',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your cybersecurity workflows with Next-Gen Sustainability Intelligence. This intelligent platform delivers fraud prevention through advanced automation and AI.
          </p>
