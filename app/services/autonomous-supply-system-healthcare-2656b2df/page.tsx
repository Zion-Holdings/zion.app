...
export const metadata: Metadata = {
  title: 'Autonomous Supply System - Healthcare',
  description: 'Unlock unprecedented growth with Autonomous Supply System - Healthcare. This autonomous system provides content moderation with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-supply-system-healthcare-2656b2df',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Supply System - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Autonomous Supply System - Healthcare. This autonomous system provides content moderation with zero manual intervention needed.
          </p>
