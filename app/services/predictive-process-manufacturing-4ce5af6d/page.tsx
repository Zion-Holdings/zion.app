...
export const metadata: Metadata = {
  title: 'Predictive Process Manufacturing',
  description: 'The future of logistics is here with Predictive Process Manufacturing. Powered by cutting-edge AI, this platform delivers sales process optimization like never ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Predictive Process Manufacturing. Powered by cutting-edge AI, this platform delivers sales process optimization like never before.
          </p>
