...
export const metadata: Metadata = {
  ...
  keywords: 'Edge computing support, Multi-language support, Container orchestration, Performance dashboards, platform, insurance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Smart Automation for Insurance</h1>
        <p className="text-lg text-slate-300 mb-8">Next-generation insurance solution: Smart Automation for Insurance. Combines document processing with adaptive intelligence for optimal results.</p>
