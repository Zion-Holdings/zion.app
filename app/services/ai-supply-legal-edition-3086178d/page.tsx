...
export const metadata: Metadata = {
  title: 'AI Supply - Legal Edition',
  description: 'Next-generation legal solution: AI Supply - Legal Edition. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-supply-legal-edition-3086178d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Supply - Legal Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: AI Supply - Legal Edition. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
