...
export const metadata: Metadata = {
  title: 'Edge Retail Personalization GCP (Government)',
  description: 'Edge Retail Personalization GCP (Government) is an AI-powered government solution that transforms how businesses operate through intelligent automation and real',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/edge-retail-personalization-gc-4c23ee',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Edge Retail Personalization GCP (Government)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Edge Retail Personalization GCP (Government) is an AI-powered government solution that transforms how businesses operate through intelligent automation and real-time analytics.
