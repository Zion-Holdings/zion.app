...
export const metadata: Metadata = {
  title: 'Threat Next-Gen - Startup',
  description: 'Drive innovation in startup with Threat Next-Gen - Startup. This AI-powered platform transforms access management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/threat-next-gen-startup-e3ac49df',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Threat Next-Gen - Startup
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in startup with Threat Next-Gen - Startup. This AI-powered platform transforms access management into a competitive advantage.
          </p>
