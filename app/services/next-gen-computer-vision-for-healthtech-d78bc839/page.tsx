...
export const metadata: Metadata = {
  title: 'Next-Gen Computer Vision for HEALTHTECH',
  description: 'Enhance your healthtech business with Next-Gen Computer Vision for HEALTHTECH. Our solution provides stream processing with enterprise-grade reliability and sec',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-computer-vision-for-healthtech-d78bc839',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Computer Vision for HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthtech business with Next-Gen Computer Vision for HEALTHTECH. Our solution provides stream processing with enterprise-grade reliability and security.
          </p>
