...
export const metadata: Metadata = {
  title: 'Smart System Platform - Construction',
  description: 'Transform your construction operations with our Smart System Platform - Construction. This AI-driven solution automates predictive modeling with unprecedented a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-system-platform-construction-0a509c60',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart System Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Smart System Platform - Construction. This AI-driven solution automates predictive modeling with unprecedented accuracy and efficiency.
          </p>
