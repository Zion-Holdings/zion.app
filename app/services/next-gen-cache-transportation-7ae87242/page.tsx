...
export const metadata: Metadata = {
  title: 'Next-Gen Cache - Transportation',
  description: 'Optimize your transportation workflows with Next-Gen Cache - Transportation. This intelligent platform delivers net promoter score through advanced automation a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-cache-transportation-7ae87242',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Cache - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Next-Gen Cache - Transportation. This intelligent platform delivers net promoter score through advanced automation and AI.
          </p>
