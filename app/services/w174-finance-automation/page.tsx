...
export const metadata: Metadata = {
  ...
  keywords: 'Financial close automation and scheduling, Accounts payable and receivable automation, Bank and intercompany reconciliation, Expense management and policy enforcement, Financial reporting and consolidation, Audit trail and SOX compliance, Integration with NetSuite, Sage, QuickBooks, SAP, automation, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Finance &amp; Accounting Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Automate financial close, AP/AR, reconciliation, expense management, and financial reporting. Reduce close time by 50%.</p>
        ...
        <li class="text-slate-300">Financial close automation and scheduling</li>
        <li class="text-slate-300">Accounts payable and receivable automation</li>
        <li class="text-slate-300">Bank and intercompany reconciliation</li>
        <li class="text-slate-300">Expense management and policy enforcement</li>
        <li class="text-slate-300">Financial reporting and consolidation</li>
        <li class="text-slate-300">Audit trail and SOX compliance</li>
        <li class="text-slate-300">Integration with NetSuite, Sage, QuickBooks, SAP</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce month-end close time by 50%</li>
        <li class="text-slate-300">AP automation eliminates manual invoice processing</li>
        <li class="text-slate-300">Auto-reconciliation catches discrepancies</li>
        <li class="text-slate-300">SOX-compliant audit trails</li>
      </ul>
        </div>
