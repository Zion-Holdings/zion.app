...
export const metadata: Metadata = {
  title: 'Autonomous intelligence-edge',
  description: 'Transform your edge operations with our Autonomous intelligence-edge. This AI-driven solution automates security monitoring with unprecedented accuracy and effi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous intelligence-edge
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your edge operations with our Autonomous intelligence-edge. This AI-driven solution automates security monitoring with unprecedented accuracy and efficiency.
          </p>
