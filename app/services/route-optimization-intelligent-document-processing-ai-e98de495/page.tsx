...
export const metadata: Metadata = {
  title: 'Route Optimization Intelligent Document Processing AI',
  description: 'route optimization solution for insurtech industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatica',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/route-optimization-intelligent-document-processing-ai-e98de495',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Route Optimization Intelligent Document Processing AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            route optimization solution for insurtech industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.
          </p>
