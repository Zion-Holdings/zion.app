...
export const metadata: Metadata = {
  title: 'Automated Coordinator for Proptech',
  description: 'The future of proptech is here with Automated Coordinator for Proptech. Powered by cutting-edge AI, this platform delivers code optimization like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-coordinator-for-proptech-d54ecf55',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Coordinator for Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with Automated Coordinator for Proptech. Powered by cutting-edge AI, this platform delivers code optimization like never before.
          </p>
