...
export const metadata: Metadata = {
  title: 'Smart generator-hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Smart generator-hospitality leverages advanced machine learning to deliver document processing at ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart generator-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Smart generator-hospitality leverages advanced machine learning to deliver document processing at scale.
          </p>
