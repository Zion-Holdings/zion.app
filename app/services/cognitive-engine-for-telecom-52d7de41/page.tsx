...
export const metadata: Metadata = {
  title: 'Cognitive Engine for Telecom',
  description: 'Revolutionize telecom through intelligent automation. Our Cognitive Engine for Telecom leverages advanced machine learning to deliver customer insights at scale',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-engine-for-telecom-52d7de41',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Engine for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Cognitive Engine for Telecom leverages advanced machine learning to deliver customer insights at scale.
          </p>
