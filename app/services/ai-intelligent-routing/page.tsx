...
export const metadata: Metadata = {
  ...
  keywords: 'OCR + AI document understanding (99.5% accuracy), Intelligent document classification and tagging, Automated data extraction to structured formats, Smart routing to teams based on content, Integration with RPA for downstream automation, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Intelligent Document Processing &amp; Routing</h1>
        <p className="text-lg text-slate-300 mb-8">Automated document intake with AI extraction, classification, and intelligent routing to the right team or workflow — invoices, claims, applications, and contracts.</p>
        ...
        <li class="text-slate-300">OCR + AI document understanding (99.5% accuracy)</li>
        <li class="text-slate-300">Intelligent document classification and tagging</li>
        <li class="text-slate-300">Automated data extraction to structured formats</li>
        <li class="text-slate-300">Smart routing to teams based on content</li>
        <li class="text-slate-300">Integration with RPA for downstream automation</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai intelligent document processing &amp; routing</li>
