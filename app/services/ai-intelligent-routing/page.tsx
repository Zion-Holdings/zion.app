      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Automated document intake with AI extraction, classification, and intelligent routing to the right team or workflow — invoices, claims, applications, and contracts.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ OCR + AI document understanding (99.5% accuracy)</li>
            <li className="text-purple-300">✓ Intelligent document classification and tagging</li>
            <li className="text-purple-300">✓ Automated data extraction to structured formats</li>
            <li className="text-purple-300">✓ Smart routing to teams based on content</li>
            <li className="text-purple-300">✓ Integration with RPA for downstream automation</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai intelligent document processing & routing</li>
