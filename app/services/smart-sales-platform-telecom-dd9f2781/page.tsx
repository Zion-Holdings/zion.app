...
export const metadata: Metadata = {
  title: 'Smart Sales Platform - Telecom',
  description: 'Revolutionize telecom through intelligent automation. Our Smart Sales Platform - Telecom leverages advanced machine learning to deliver vendor management at sca',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-sales-platform-telecom-dd9f2781',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Sales Platform - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Smart Sales Platform - Telecom leverages advanced machine learning to deliver vendor management at scale.
          </p>
