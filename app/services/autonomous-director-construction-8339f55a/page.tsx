...
export const metadata: Metadata = {
  title: 'Autonomous director-construction',
  description: 'Revolutionize construction through intelligent automation. Our Autonomous director-construction leverages advanced machine learning to deliver enterprise-grade ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-director-construction-8339f55a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous director-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Autonomous director-construction leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
