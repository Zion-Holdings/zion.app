...
export const metadata: Metadata = {
  title: "Service - AI-Powered Digital Twin Solution",
  description: "Creates and manages digital twins of physical assets for simulation and optimization.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-digital-twin-platform-7cacaf72",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Service - AI-Powered Digital Twin Solution
        </h1>
