...
export const metadata: Metadata = {
  title: 'Adaptive Customer Analytics',
  description: 'The future of construction is here with Adaptive Customer Analytics. Powered by cutting-edge AI, this platform delivers hr analytics like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-customer-analytics-7195d3ab',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Customer Analytics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Adaptive Customer Analytics. Powered by cutting-edge AI, this platform delivers hr analytics like never before.
          </p>
