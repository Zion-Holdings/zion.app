...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-metaverse-experience-engine-f578d636',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Avatar creation</li>
          <li className="text-gray-300">World building</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">Instant experiences</li>
