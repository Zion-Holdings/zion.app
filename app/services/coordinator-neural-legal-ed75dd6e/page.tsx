...
export const metadata: Metadata = {
  title: 'Coordinator Neural - Legal',
  description: 'The future of legal is here with Coordinator Neural - Legal. Powered by cutting-edge AI, this platform delivers recruitment automation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/coordinator-neural-legal-ed75dd6e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Coordinator Neural - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Coordinator Neural - Legal. Powered by cutting-edge AI, this platform delivers recruitment automation like never before.
          </p>
