...
export const metadata: Metadata = {
  title: 'AI Document - Insurance Edition',
  description: 'Next-generation insurance solution: AI Document - Insurance Edition. Combines goal setting with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-document-insurance-edition-608d5b0e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Document - Insurance Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: AI Document - Insurance Edition. Combines goal setting with adaptive intelligence for optimal results.
          </p>
