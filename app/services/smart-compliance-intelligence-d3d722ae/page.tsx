...
export const metadata: Metadata = {
  ...
  description: 'Transform your agriculture operations with our Smart Compliance Intelligence. This AI-driven solution automates competitive intelligence with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-compliance-intelligence-d3d722ae',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Smart Compliance Intelligence. This AI-driven solution automates competitive intelligence with unprecedented accuracy and efficiency.
          </p>
