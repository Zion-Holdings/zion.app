...
export const metadata: Metadata = {
  ...
  keywords: 'Append-only event log per aggregate ID, Projection worker auto-subscribes to topics, Snapshot compaction for long-lived aggregates, Read-model API (GraphQL/REST) per projection, data, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Event Sourcing &amp; CQRS Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Append-only event log per aggregate, projection workers per read-model, snapshot compaction, and Kafka-compatible event bus.</p>
        ...
        <li class="text-slate-300">Append-only event log per aggregate ID</li>
        <li class="text-slate-300">Projection worker auto-subscribes to topics</li>
        <li class="text-slate-300">Snapshot compaction for long-lived aggregates</li>
        <li class="text-slate-300">Read-model API (GraphQL/REST) per projection</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with event sourcing &amp; cqrs platform</li>
