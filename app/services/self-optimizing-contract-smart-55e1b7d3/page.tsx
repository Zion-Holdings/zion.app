...
export const metadata: Metadata = {
  title: 'Self-Optimizing Contract Smart',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Contract Smart
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Self-Optimizing Contract Smart. This intelligent platform delivers edge computing through advanced automation and AI.
          </p>
