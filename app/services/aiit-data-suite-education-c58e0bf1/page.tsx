...
export const metadata: Metadata = {
  title: 'AI/IT Data Suite - Education',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Data Suite - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your education business with AI/IT Data Suite - Education. Our solution provides integration platform with enterprise-grade reliability and security.
          </p>
