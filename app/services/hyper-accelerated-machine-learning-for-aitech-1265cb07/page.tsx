...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Machine Learning for AITECH',
  description: 'Revolutionize aitech through intelligent automation. Our Hyper-Accelerated Machine Learning for AITECH leverages advanced machine learning to deliver forecast a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Machine Learning for AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize aitech through intelligent automation. Our Hyper-Accelerated Machine Learning for AITECH leverages advanced machine learning to deliver forecast accuracy at scale.
          </p>
