...
export const metadata: Metadata = {
  ...
  keywords: 'CAPA management and tracking, Audit planning and execution, Document control and approval, Training management, Supplier quality management, Integration with MasterControl, Veeva Vault QMS, automation, Quality Assurance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Quality Management System (QMS)</h1>
        <p className="text-lg text-slate-300 mb-8">Manage quality: CAPA, audits, document control, compliance. ISO 9001, ISO 13485, FDA 21 CFR Part 820 aligned.</p>
        ...
        <li class="text-slate-300">CAPA management and tracking</li>
        <li class="text-slate-300">Audit planning and execution</li>
        <li class="text-slate-300">Document control and approval</li>
        <li class="text-slate-300">Training management</li>
        <li class="text-slate-300">Supplier quality management</li>
        <li class="text-slate-300">Integration with MasterControl</li>
        <li class="text-slate-300">Veeva Vault QMS</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">CAPA tracking ensures corrective actions</li>
        <li class="text-slate-300">Audit management for compliance</li>
        <li class="text-slate-300">Document control for ISO standards</li>
        <li class="text-slate-300">Supplier quality for supply chain</li>
      </ul>
        </div>
