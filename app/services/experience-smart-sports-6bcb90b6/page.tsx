...
export const metadata: Metadata = {
  title: 'Experience Smart - Sports',
  description: 'Optimize your sports workflows with Experience Smart - Sports. This intelligent platform delivers healthcare data analytics through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/experience-smart-sports-6bcb90b6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Experience Smart - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your sports workflows with Experience Smart - Sports. This intelligent platform delivers healthcare data analytics through advanced automation and AI.
          </p>
