...
export const metadata: Metadata = {
  title: "AI-Powered Performance Testing - AI-Powered QA Solution",
  description: "Automated performance testing with predictive scaling recommendations.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-performance-testing-4a83c378",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Performance Testing - AI-Powered QA Solution
        </h1>
