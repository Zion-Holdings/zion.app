...
export const metadata: Metadata = {
  title: 'Intelligent Performance for Gaming',
  description: 'The future of gaming is here with Intelligent Performance for Gaming. Powered by cutting-edge AI, this platform delivers resource allocation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-performance-for-gaming-3ce3928c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Performance for Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of gaming is here with Intelligent Performance for Gaming. Powered by cutting-edge AI, this platform delivers resource allocation like never before.
          </p>
