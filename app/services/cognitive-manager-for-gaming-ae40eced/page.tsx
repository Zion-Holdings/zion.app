...
export const metadata: Metadata = {
  title: 'Cognitive Manager for Gaming',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Manager for Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your gaming operations with our Cognitive Manager for Gaming. This AI-driven solution automates risk assessment with unprecedented accuracy and efficiency.
          </p>
