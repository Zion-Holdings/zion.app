...
export const metadata: Metadata = {
  title: 'Smart Optimization for Energy',
  description: 'The future of energy is here with Smart Optimization for Energy. Powered by cutting-edge AI, this platform delivers energy management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-optimization-for-energy-a2503eab',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Optimization for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Smart Optimization for Energy. Powered by cutting-edge AI, this platform delivers energy management like never before.
          </p>
