...
export const metadata: Metadata = {
  title: 'Adaptive automation-hospitality',
  description: 'The future of hospitality is here with Adaptive automation-hospitality. Powered by cutting-edge AI, this platform delivers container orchestration like never be',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-automation-hospitality-6bf781e4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive automation-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Adaptive automation-hospitality. Powered by cutting-edge AI, this platform delivers container orchestration like never before.
          </p>
