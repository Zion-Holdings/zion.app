...
export const metadata = {
  ...
  description: "Enhance your remote-work business with Project-Powered Remote-Work Automation. Our solution provides document collaboration with enterprise-grade reliability an",
  alternates: {
