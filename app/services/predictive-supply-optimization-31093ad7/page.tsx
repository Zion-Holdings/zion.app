...
export const metadata: Metadata = {
  title: 'Predictive Supply Optimization',
  description: 'Transform your retail operations with our Predictive Supply Optimization. This AI-driven solution automates document processing with unprecedented accuracy and ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our Predictive Supply Optimization. This AI-driven solution automates document processing with unprecedented accuracy and efficiency.
          </p>
