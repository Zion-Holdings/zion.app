...
export const metadata: Metadata = {
  title: 'Smart Manufacturing for Sports',
  description: 'Revolutionize sports through intelligent automation. Our Smart Manufacturing for Sports leverages advanced machine learning to deliver fraud prevention at scale',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-manufacturing-for-sports-bb4e715a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manufacturing for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Smart Manufacturing for Sports leverages advanced machine learning to deliver fraud prevention at scale.
          </p>
