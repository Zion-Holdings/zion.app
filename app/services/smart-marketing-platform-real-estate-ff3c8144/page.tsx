...
export const metadata: Metadata = {
  title: 'Smart Marketing Platform - Real-Estate',
  description: 'Optimize your real-estate workflows with Smart Marketing Platform - Real-Estate. This intelligent platform delivers sourcing optimization through advanced autom',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-marketing-platform-real-estate-ff3c8144',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Marketing Platform - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your real-estate workflows with Smart Marketing Platform - Real-Estate. This intelligent platform delivers sourcing optimization through advanced automation and AI.
          </p>
