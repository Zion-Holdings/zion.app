...
export const metadata: Metadata = {
  title: 'AI Advisor - Construction Edition',
  description: 'Enhance your construction business with AI Advisor - Construction Edition. Our solution provides social media monitoring with enterprise-grade reliability and s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-advisor-construction-edition-ac601316',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Advisor - Construction Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with AI Advisor - Construction Edition. Our solution provides social media monitoring with enterprise-grade reliability and security.
          </p>
