...
export const metadata: Metadata = {
  title: 'Intelligent Loyalty Suite',
  description: 'Revolutionize automotive through intelligent automation. Our Intelligent Loyalty Suite leverages advanced machine learning to deliver compliance monitoring at s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-loyalty-suite-d317548f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Loyalty Suite
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize automotive through intelligent automation. Our Intelligent Loyalty Suite leverages advanced machine learning to deliver compliance monitoring at scale.
          </p>
