...
export const metadata: Metadata = {
  title: 'Neural Customer Optimization',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Customer Optimization
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Neural Customer Optimization leverages advanced machine learning to deliver sales forecasting at scale.
          </p>
