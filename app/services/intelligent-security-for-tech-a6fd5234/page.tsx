...
export const metadata: Metadata = {
  title: 'Intelligent Security for Tech',
  description: 'Next-generation technology solution: Intelligent Security for Tech. Combines feature engineering with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-security-for-tech-a6fd5234',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Security for Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation technology solution: Intelligent Security for Tech. Combines feature engineering with adaptive intelligence for optimal results.
          </p>
