...
export const metadata: Metadata = {
  title: 'Predictive Insights Engine - Logistics',
  description: 'Drive innovation in logistics with Predictive Insights Engine - Logistics. This AI-powered platform transforms expense management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-insights-engine-logistics-1a1d5f1a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Insights Engine - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with Predictive Insights Engine - Logistics. This AI-powered platform transforms expense management into a competitive advantage.
          </p>
