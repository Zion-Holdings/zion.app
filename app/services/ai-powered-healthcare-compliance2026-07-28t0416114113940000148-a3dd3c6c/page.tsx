...
export const metadata: Metadata = {
  title: 'AI-Powered Healthcare Compliance',
  description: 'Automates healthcare compliance with regulation tracking and reporting.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-healthcare-compliance2026-07-28t0416114113940000148-a3dd3c6c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automates healthcare compliance with regulation tracking and reporting.
          </p>
