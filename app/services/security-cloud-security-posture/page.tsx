...
export const metadata = {
  ...
  description: "Continuous cloud security posture assessment across AWS, Azure, and GCP. Misconfiguration detection, compliance benchmarking, and automated remediation. Real-ti",
  alternates: {
