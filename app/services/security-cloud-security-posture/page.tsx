...
export const metadata = {
  ...
  description: "Continuous cloud security monitoring: misconfiguration detection, compliance, auto-remediation.",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Continuous cloud security monitoring: misconfiguration detection, compliance, auto-remediation.</p>
        
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          <h2 className="text-2xl font-semibold mb-4">Key Features</h2>
          <ul className="list-disc list-inside space-y-2">
            <li>Multi-cloud misconfiguration detection</li>
            <li>Compliance monitoring CIS/NIST</li>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Eliminate cloud misconfigurations</li>
