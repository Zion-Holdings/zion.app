...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-cloud assessment (AWS, Azure, GCP), Misconfiguration auto-remediation, Compliance benchmarking (CIS, NIST, PCI), Real-time security score, Drift detection and alerting, Infrastructure-as-Code scanning, Identity and access analysis, Executive risk dashboards, security, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cloud Security Posture Management (CSPM)</h1>
        <p className="text-lg text-slate-300 mb-8">Continuous cloud security posture assessment across AWS, Azure, and GCP. Misconfiguration detection, compliance benchmarking, and automated remediation. Real-time security score and drift detection.</p>
        ...
        <li class="text-slate-300">Multi-cloud assessment (AWS, Azure, GCP)</li>
        <li class="text-slate-300">Misconfiguration auto-remediation</li>
        <li class="text-slate-300">Compliance benchmarking (CIS, NIST, PCI)</li>
        <li class="text-slate-300">Real-time security score</li>
        <li class="text-slate-300">Drift detection and alerting</li>
        <li class="text-slate-300">Infrastructure-as-Code scanning</li>
        <li class="text-slate-300">Identity and access analysis</li>
        <li class="text-slate-300">Executive risk dashboards</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Prevent cloud breaches from misconfigurations</li>
        <li class="text-slate-300">Continuous compliance monitoring</li>
        <li class="text-slate-300">Automated security remediation</li>
        <li class="text-slate-300">Unified multi-cloud visibility</li>
      </ul>
        </div>
