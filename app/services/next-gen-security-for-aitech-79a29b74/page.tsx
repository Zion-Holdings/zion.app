...
export const metadata: Metadata = {
  title: 'Next-Gen Security for AITECH',
  description: 'Unlock unprecedented growth with Next-Gen Security for AITECH. This autonomous system provides social media automation with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-security-for-aitech-79a29b74',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Security for AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Next-Gen Security for AITECH. This autonomous system provides social media automation with zero manual intervention needed.
          </p>
