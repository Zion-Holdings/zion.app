...
export const metadata: Metadata = {
  title: 'Predictive Marketing for Logistics',
  description: 'Next-generation logistics solution: Predictive Marketing for Logistics. Combines threat detection with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-marketing-for-logistics-66a950a8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Marketing for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Predictive Marketing for Logistics. Combines threat detection with adaptive intelligence for optimal results.
          </p>
