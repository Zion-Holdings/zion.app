...
export const metadata: Metadata = {
  title: 'Adaptive automation-logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Adaptive automation-logistics leverages advanced machine learning to deliver content generation at s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive automation-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Adaptive automation-logistics leverages advanced machine learning to deliver content generation at scale.
          </p>
