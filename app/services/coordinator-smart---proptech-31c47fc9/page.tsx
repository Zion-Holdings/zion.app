...
export const metadata: Metadata = {
  title: 'Coordinator Smart - Proptech',
  description: 'Revolutionize proptech through intelligent automation. Our Coordinator Smart - Proptech leverages advanced machine learning to deliver code optimization at scal',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/coordinator-smart---proptech-31c47fc9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Coordinator Smart - Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our Coordinator Smart - Proptech leverages advanced machine learning to deliver code optimization at scale.
          </p>
