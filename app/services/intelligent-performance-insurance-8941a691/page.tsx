...
export const metadata: Metadata = {
  title: 'Intelligent performance-insurance',
  description: 'Transform your insurance operations with our Intelligent performance-insurance. This AI-driven solution automates hr analytics with unprecedented accuracy and e',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent performance-insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Intelligent performance-insurance. This AI-driven solution automates hr analytics with unprecedented accuracy and efficiency.
          </p>
