...
export const metadata: Metadata = {
  title: 'Predictive Real Estate for Energy',
  description: 'The future of energy is here with Predictive Real Estate for Energy. Powered by cutting-edge AI, this platform delivers user experience like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-real-estate-for-energy-24e0b330',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Real Estate for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Predictive Real Estate for Energy. Powered by cutting-edge AI, this platform delivers user experience like never before.
          </p>
