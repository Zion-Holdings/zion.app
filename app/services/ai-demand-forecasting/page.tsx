...
export const metadata = {
  title: "AI Demand Forecasting - Zion Tech Group",
  description: "Accurate demand predictions using ML models that incorporate seasonality, trends, promotions, weather, and external factors.",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Accurate demand predictions using ML models that incorporate seasonality, trends, promotions, weather, and external factors.</p>
        
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          <h2 className="text-2xl font-semibold mb-4">Key Features</h2>
          <ul className="list-disc list-inside space-y-2">
            <li>Multi-model ensemble (ARIMA, Prophet, XGBoost)</li>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce stockouts 40%</li>
            <li>Lower inventory carrying costs</li>
            <li>Optimize procurement timing</li>
