...
export const metadata: Metadata = {
  title: 'Cognitive Serverless Business Intelligence',
  description: 'Enhance your logistics business with Cognitive Serverless Business Intelligence. Our solution provides market intelligence with enterprise-grade reliability and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-serverless-business-intelligence-a22994fd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Serverless Business Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with Cognitive Serverless Business Intelligence. Our solution provides market intelligence with enterprise-grade reliability and security.
          </p>
