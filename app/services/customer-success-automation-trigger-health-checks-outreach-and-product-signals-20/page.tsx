...
export const metadata = {
  ...
  description: 'End-to-end customer success automation: trigger health checks, outreach, and product signals services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/customer-success-automation-trigger-health-checks-outreach-and-product-signals-20/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">Customer Success Automation: Trigger Health Checks, Outreach, and Product Signals</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end customer success automation: trigger health checks, outreach, and product signals services: assessment, deployment, and managed operations.
        </p>
