...
export const metadata: Metadata = {
  title: 'Cognitive Data for Blockchain',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Data for Blockchain
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize blockchain through intelligent automation. Our Cognitive Data for Blockchain leverages advanced machine learning to deliver document processing at scale.
          </p>
