...
export const metadata: Metadata = {
  title: 'Automation Platform for Real Estate - Batch 11',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automation Platform for Real Estate - Batch 11
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Advanced automation platform for Real Estate industry. Leverages machine learning for advanced analytics and automation. Provides real-time insights and predictive capabilities for strategic decision-making.
          </p>
