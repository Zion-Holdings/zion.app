...
export const metadata: Metadata = {
  title: 'Director Neural - Hospitality',
  description: 'Drive innovation in hospitality with Director Neural - Hospitality. This AI-powered platform transforms quality control into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/director-neural-hospitality-5939f437',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Director Neural - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Director Neural - Hospitality. This AI-powered platform transforms quality control into a competitive advantage.
          </p>
