...
export const metadata: Metadata = {
  title: 'Smart Inventory Security',
  description: 'Next-generation technology solution: Smart Inventory Security. Combines quality control with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-inventory-security-dd8dbb87',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Inventory Security
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation technology solution: Smart Inventory Security. Combines quality control with adaptive intelligence for optimal results.
          </p>
