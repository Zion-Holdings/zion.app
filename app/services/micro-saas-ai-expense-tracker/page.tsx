...
export const metadata: Metadata = {
  ...
  keywords: 'AI receipt scanning, Auto-categorization, Policy enforcement, Approval workflows, Accounting integration, Real-time reporting, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Micro-SAAS AI Expense Tracker &amp; Approval</h1>
        <p className="text-lg text-slate-300 mb-8">Smart expense management with AI receipt scanning, automatic categorization, policy enforcement, and approval workflows.</p>
        ...
        <li class="text-slate-300">AI receipt scanning</li>
        ...
        <li class="text-slate-300">Accounting integration</li>
        <li class="text-slate-300">Real-time reporting</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">90% faster expense processing</li>
        <li class="text-slate-300">Policy compliance guaranteed</li>
        <li class="text-slate-300">Real-time spend visibility</li>
        <li class="text-slate-300">Audit-ready reports</li>
      </ul>
        </div>
