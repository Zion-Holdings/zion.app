...
export const metadata: Metadata = {
  title: 'Intelligent Manager for Legal',
  description: 'Revolutionize legal through intelligent automation. Our Intelligent Manager for Legal leverages advanced machine learning to deliver risk assessment at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-manager-for-legal-c8706d1e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Manager for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Intelligent Manager for Legal leverages advanced machine learning to deliver risk assessment at scale.
          </p>
