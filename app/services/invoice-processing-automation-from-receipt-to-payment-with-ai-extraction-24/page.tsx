...
export const metadata = {
  ...
  description: 'End-to-end invoice processing automation: from receipt to payment with ai extraction services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/invoice-processing-automation-from-receipt-to-payment-with-ai-extraction-24/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">Invoice Processing Automation: From Receipt to Payment with AI Extraction</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end invoice processing automation: from receipt to payment with ai extraction services: assessment, deployment, and managed operations.
        </p>
