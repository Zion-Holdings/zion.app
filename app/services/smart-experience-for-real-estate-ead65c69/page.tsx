...
export const metadata: Metadata = {
  title: 'Smart Experience for Real-Estate',
  description: 'Revolutionize real-estate through intelligent automation. Our Smart Experience for Real-Estate leverages advanced machine learning to deliver supply chain at sc',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Experience for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our Smart Experience for Real-Estate leverages advanced machine learning to deliver supply chain at scale.
          </p>
