...
export const metadata: Metadata = {
  title: "AI-Powered Market Intelligence - AI-Powered Market Research Solution",
  description: "Monitors market trends, competitor activities, and industry news to provide actionable insights.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-market-intelligence-f1f1f45d",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Market Intelligence - AI-Powered Market Research Solution
        </h1>
