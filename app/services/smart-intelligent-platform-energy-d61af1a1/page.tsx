...
export const metadata: Metadata = {
  title: 'Smart Intelligent Platform - Energy',
  description: 'Drive innovation in energy with Smart Intelligent Platform - Energy. This AI-powered platform transforms threat detection into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-intelligent-platform-energy-d61af1a1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Intelligent Platform - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Smart Intelligent Platform - Energy. This AI-powered platform transforms threat detection into a competitive advantage.
          </p>
