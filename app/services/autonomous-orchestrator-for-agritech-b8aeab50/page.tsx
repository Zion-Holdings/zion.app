...
export const metadata: Metadata = {
  title: 'Autonomous Orchestrator for Agritech',
  description: 'Revolutionize agritech through intelligent automation. Our Autonomous Orchestrator for Agritech leverages advanced machine learning to deliver compliance monito',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Orchestrator for Agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agritech through intelligent automation. Our Autonomous Orchestrator for Agritech leverages advanced machine learning to deliver compliance monitoring at scale.
          </p>
