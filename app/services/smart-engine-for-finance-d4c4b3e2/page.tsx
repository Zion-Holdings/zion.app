...
export const metadata: Metadata = {
  title: 'Smart Engine for Finance',
  description: 'Revolutionize finance through intelligent automation. Our Smart Engine for Finance leverages advanced machine learning to deliver sales process optimization at ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Engine for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our Smart Engine for Finance leverages advanced machine learning to deliver sales process optimization at scale.
          </p>
