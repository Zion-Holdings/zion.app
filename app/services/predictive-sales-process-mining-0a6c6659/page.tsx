...
export const metadata: Metadata = {
  title: 'Predictive Sales Process Mining',
  description: 'Drive innovation in insurance with Predictive Sales Process Mining. This AI-powered platform transforms training optimization into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-sales-process-mining-0a6c6659',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Sales Process Mining
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Predictive Sales Process Mining. This AI-powered platform transforms training optimization into a competitive advantage.
          </p>
