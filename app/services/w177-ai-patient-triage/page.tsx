...
export const metadata: Metadata = {
  ...
  keywords: 'Symptom assessment and intake, Urgency scoring (ESI-level), Care path recommendation, ER diversion to urgent care or telehealth, Pre-visit information collection, Multilingual patient interaction, Integration with Epic, Cerner, Athenahealth, ai, Healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Patient Triage Assistant</h1>
        <p className="text-lg text-slate-300 mb-8">AI patient triage: symptom assessment, urgency scoring, care path recommendation, ER diversion.</p>
        ...
        <li class="text-slate-300">Symptom assessment and intake</li>
        <li class="text-slate-300">Urgency scoring (ESI-level)</li>
        <li class="text-slate-300">Care path recommendation</li>
        <li class="text-slate-300">ER diversion to urgent care or telehealth</li>
        <li class="text-slate-300">Pre-visit information collection</li>
        <li class="text-slate-300">Multilingual patient interaction</li>
        <li class="text-slate-300">Integration with Epic</li>
        <li class="text-slate-300">Cerner</li>
        <li class="text-slate-300">Athenahealth</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce ER overcrowding with smart triage</li>
        <li class="text-slate-300">Urgency scoring improves patient safety</li>
        <li class="text-slate-300">Diversion to appropriate care saves costs</li>
        <li class="text-slate-300">Multilingual support improves access</li>
      </ul>
        </div>
