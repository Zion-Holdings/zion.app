...
export const metadata: Metadata = {
  title: 'Cognitive Intelligence Solution - Sports',
  description: 'Transform your sports operations with our Cognitive Intelligence Solution - Sports. This AI-driven solution automates cost reduction with unprecedented accuracy',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-intelligence-solution-sports-746f15f8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Intelligence Solution - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our Cognitive Intelligence Solution - Sports. This AI-driven solution automates cost reduction with unprecedented accuracy and efficiency.
          </p>
