...
export const metadata: Metadata = {
  title: 'AI Orchestrator - Legal Edition',
  description: 'Transform your legal operations with our AI Orchestrator - Legal Edition. This AI-driven solution automates access management with unprecedented accuracy and ef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-orchestrator-legal-edition-b8230524',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Orchestrator - Legal Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our AI Orchestrator - Legal Edition. This AI-driven solution automates access management with unprecedented accuracy and efficiency.
          </p>
