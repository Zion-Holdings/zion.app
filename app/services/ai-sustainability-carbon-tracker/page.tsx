...
export const metadata: Metadata = {
  ...
  keywords: 'Integration with AWS/GCP carbon APIs, Travel emission estimation from calendars, Supply chain scope 3 modeling, Regulatory reporting templates (ESG), ai, Sustainability, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Automatically calculates organizational carbon footprint from operational data (energy, travel, cloud usage) and suggests reduction strategies.</p>
        ...
        <li class="text-slate-300">Integration with AWS/GCP carbon APIs</li>
        <li class="text-slate-300">Travel emission estimation from calendars</li>
        <li class="text-slate-300">Supply chain scope 3 modeling</li>
        <li class="text-slate-300">Regulatory reporting templates (ESG)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai sustainability &amp; carbon tracker</li>
