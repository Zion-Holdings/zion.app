...
export const metadata: Metadata = {
  title: 'Autonomous Document System - Healthcare',
  description: 'Transform healthcare with Autonomous Document System - Healthcare - the intelligent automation platform that learns, adapts, and delivers 10x results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-document-system-healthcare-a430b0c9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Document System - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform healthcare with Autonomous Document System - Healthcare - the intelligent automation platform that learns, adapts, and delivers 10x results.
          </p>
