...
export const metadata: Metadata = {
  title: 'Smart Predictive Platform - Construction',
  description: 'Enhance your construction business with Smart Predictive Platform - Construction. Our solution provides testing automation with enterprise-grade reliability and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-predictive-platform-construction-137f12c7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Predictive Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Smart Predictive Platform - Construction. Our solution provides testing automation with enterprise-grade reliability and security.
          </p>
