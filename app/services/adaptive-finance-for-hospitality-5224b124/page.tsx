...
export const metadata: Metadata = {
  title: 'Adaptive Finance for Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Adaptive Finance for Hospitality leverages advanced machine learning to deliver user experience at',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-finance-for-hospitality-5224b124',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Finance for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Adaptive Finance for Hospitality leverages advanced machine learning to deliver user experience at scale.
          </p>
