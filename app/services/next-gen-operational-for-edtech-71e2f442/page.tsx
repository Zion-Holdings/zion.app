...
export const metadata: Metadata = {
  title: 'Next-Gen Operational for EDTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Operational for EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your edtech operations with our Next-Gen Operational for EDTECH. This AI-driven solution automates customer service automation with unprecedented accuracy and efficiency.
          </p>
