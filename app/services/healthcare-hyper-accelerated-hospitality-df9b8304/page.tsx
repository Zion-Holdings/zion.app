...
export const metadata: Metadata = {
  title: 'Healthcare Hyper-Accelerated - Hospitality',
  description: 'Unlock unprecedented growth with Healthcare Hyper-Accelerated - Hospitality. This autonomous system provides leave management with zero manual intervention need',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/healthcare-hyper-accelerated-hospitality-df9b8304',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Healthcare Hyper-Accelerated - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Healthcare Hyper-Accelerated - Hospitality. This autonomous system provides leave management with zero manual intervention needed.
          </p>
