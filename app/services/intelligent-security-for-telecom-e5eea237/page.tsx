...
export const metadata: Metadata = {
  title: 'Intelligent Security for Telecom',
  description: 'The future of telecom is here with Intelligent Security for Telecom. Powered by cutting-edge AI, this platform delivers user experience like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-security-for-telecom-e5eea237',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Security for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of telecom is here with Intelligent Security for Telecom. Powered by cutting-edge AI, this platform delivers user experience like never before.
          </p>
