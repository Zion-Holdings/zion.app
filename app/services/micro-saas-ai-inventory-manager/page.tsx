...
export const metadata: Metadata = {
  ...
  keywords: 'AI demand forecasting with seasonality, Automatic reorder point calculation, Multi-warehouse inventory optimization, Supplier lead time tracking and alerts, Dead stock identification and liquidation, Integration with Shopify, WooCommerce, QuickBooks, Barcode and QR code scanning mobile app, Real-time inventory dashboard and alerts, ai, supply-chain, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Inventory &amp; Supply Chain Manager</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered inventory management that predicts demand, optimizes stock levels, and automates reordering. Reduces carrying costs by 30% while preventing stockouts.</p>
        ...
        <li class="text-slate-300">AI demand forecasting with seasonality</li>
        <li class="text-slate-300">Automatic reorder point calculation</li>
        <li class="text-slate-300">Multi-warehouse inventory optimization</li>
        <li class="text-slate-300">Supplier lead time tracking and alerts</li>
        <li class="text-slate-300">Dead stock identification and liquidation</li>
        <li class="text-slate-300">Integration with Shopify, WooCommerce, QuickBooks</li>
        <li class="text-slate-300">Barcode and QR code scanning mobile app</li>
        <li class="text-slate-300">Real-time inventory dashboard and alerts</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce inventory costs by 30%</li>
        <li class="text-slate-300">Eliminate stockouts with AI predictions</li>
        <li class="text-slate-300">Automate reordering and save 10+ hours/week</li>
        <li class="text-slate-300">Optimize warehouse space utilization</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$549/mo</p>
