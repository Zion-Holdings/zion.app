...
export const metadata: Metadata = {
  title: 'Smart Coordinator Platform - Real-Estate',
  description: 'Optimize your real-estate workflows with Smart Coordinator Platform - Real-Estate. This intelligent platform delivers financial risk management through advanced',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Coordinator Platform - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your real-estate workflows with Smart Coordinator Platform - Real-Estate. This intelligent platform delivers financial risk management through advanced automation and AI.
          </p>
