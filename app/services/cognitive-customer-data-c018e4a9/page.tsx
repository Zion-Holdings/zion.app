...
export const metadata: Metadata = {
  title: 'Cognitive Customer Data',
  description: 'Unlock unprecedented growth with Cognitive Customer Data. This autonomous system provides supply chain with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-customer-data-c018e4a9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Cognitive Customer Data. This autonomous system provides supply chain with zero manual intervention needed.
          </p>
