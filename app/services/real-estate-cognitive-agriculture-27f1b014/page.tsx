...
export const metadata: Metadata = {
  title: 'Real Estate Cognitive - Agriculture',
  description: 'Enhance your agriculture business with Real Estate Cognitive - Agriculture. Our solution provides budget optimization with enterprise-grade reliability and secu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Real Estate Cognitive - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your agriculture business with Real Estate Cognitive - Agriculture. Our solution provides budget optimization with enterprise-grade reliability and security.
          </p>
