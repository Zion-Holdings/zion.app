  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Claims Processing Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Automate insurance and warranty claims: intake, verification, adjudication, payment, and fraud detection. Reduce claims cycle time by 60%.</p>
        ...
        <li class="text-slate-300">Automated claims intake (portal, email, API)</li>
        ...
        <li class="text-slate-300">Integration with Guidewire, Duck Creek, CoreLogic</li>
      </ul>
        </div>
