...
export const metadata: Metadata = {
  ...
  description: 'Detects financial crimes using behavioral analysis and pattern recognition.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-financial-crime-detection-8256cc90',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Detects financial crimes using behavioral analysis and pattern recognition.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Crime detection</li>
