...
export const metadata: Metadata = {
  title: 'Quantum marketing-finance',
  description: 'Transform your finance operations with our Quantum marketing-finance. This AI-driven solution automates expense reporting with unprecedented accuracy and effici',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum marketing-finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Quantum marketing-finance. This AI-driven solution automates expense reporting with unprecedented accuracy and efficiency.
          </p>
