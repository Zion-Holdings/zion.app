...
export const metadata: Metadata = {
  title: 'Deep Learning Manager',
  description: 'Transform your telecommunications operations with our Deep Learning Manager. This data solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/deep-learning-manager-f2de',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your telecommunications operations with our Deep Learning Manager. This data solution delivers unprecedented automation and intelligence.
          </p>
