...
export const metadata: Metadata = {
  ...
  description: 'The future of logistics is here with Autonomous Optimizer System - Logistics. Powered by cutting-edge AI, this platform delivers campaign optimization like neve',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Autonomous Optimizer System - Logistics. Powered by cutting-edge AI, this platform delivers campaign optimization like never before.
          </p>
