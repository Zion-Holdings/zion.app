...
export const metadata: Metadata = {
  ...
  keywords: 'Serverless functions, Role-based access control, Machine learning integration, Multi-language support, analyzer, hospitality, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Smart Workflow Manager</h1>
        <p className="text-lg text-slate-300 mb-8">Revolutionize hospitality through intelligent automation. Our Smart Workflow Manager leverages advanced machine learning to deliver image recognition at scale.</p>
