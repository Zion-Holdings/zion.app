...
export const metadata: Metadata = {
  title: 'Healthcare Autonomous - Healthcare',
  description: 'Unlock unprecedented growth with Healthcare Autonomous - Healthcare. This autonomous system provides sales forecasting with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/healthcare-autonomous---healthcare-fcf70903',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Healthcare Autonomous - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Healthcare Autonomous - Healthcare. This autonomous system provides sales forecasting with zero manual intervention needed.
          </p>
