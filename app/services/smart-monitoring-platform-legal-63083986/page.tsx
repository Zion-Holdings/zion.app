...
export const metadata: Metadata = {
  title: 'Smart Monitoring Platform - Legal',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Monitoring Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Smart Monitoring Platform - Legal. Powered by cutting-edge AI, this platform delivers hr analytics like never before.
          </p>
