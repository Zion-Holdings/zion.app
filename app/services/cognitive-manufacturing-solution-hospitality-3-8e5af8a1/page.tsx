...
export const metadata: Metadata = {
  title: 'Cognitive Manufacturing Solution - Hospitality #3',
  description: 'Drive innovation in hospitality with Cognitive Manufacturing Solution - Hospitality #3. This AI-powered platform transforms master data management into a compet',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Manufacturing Solution - Hospitality #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Cognitive Manufacturing Solution - Hospitality #3. This AI-powered platform transforms master data management into a competitive advantage.
          </p>
