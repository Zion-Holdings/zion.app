...
export const metadata: Metadata = {
  title: 'Adaptive Engine for Sports',
  description: 'The future of sports is here with Adaptive Engine for Sports. Powered by cutting-edge AI, this platform delivers maintenance scheduling like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-engine-for-sports-1da16ea4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Engine for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Adaptive Engine for Sports. Powered by cutting-edge AI, this platform delivers maintenance scheduling like never before.
          </p>
