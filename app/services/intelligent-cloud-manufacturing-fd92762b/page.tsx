...
export const metadata: Metadata = {
  title: 'Intelligent cloud-manufacturing',
  description: 'Revolutionize manufacturing through intelligent automation. Our Intelligent cloud-manufacturing leverages advanced machine learning to deliver logistics route o',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-cloud-manufacturing-fd92762b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent cloud-manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize manufacturing through intelligent automation. Our Intelligent cloud-manufacturing leverages advanced machine learning to deliver logistics route optimization at scale.
          </p>
