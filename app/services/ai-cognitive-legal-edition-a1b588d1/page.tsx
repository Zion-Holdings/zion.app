...
export const metadata: Metadata = {
  title: 'AI Cognitive - Legal Edition',
  description: 'Transform your legal operations with our AI Cognitive - Legal Edition. This AI-driven solution provides intelligent automation with unprecedented accuracy and e',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-cognitive-legal-edition-a1b588d1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Cognitive - Legal Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our AI Cognitive - Legal Edition. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
