  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Predictive Inventory &amp; Demand Sensing</h1>
        <p className="text-lg text-slate-300 mb-8">AI demand sensing that predicts what customers will buy before they order. Reduce stockouts by 80% and inventory costs by 25% with real-time demand signals.</p>
        ...
        <li class="text-slate-300">Real-time demand sensing from multiple signals</li>
        <li class="text-slate-300">AI forecasting with weather, events, social trends</li>
        <li class="text-slate-300">Automatic replenishment recommendations</li>
        <li class="text-slate-300">Multi-echelon inventory optimization</li>
        <li class="text-slate-300">Integration with ERP, WMS, and e-commerce platforms</li>
        <li class="text-slate-300">Promotion and seasonal planning</li>
        <li class="text-slate-300">Supplier collaboration portal</li>
        <li class="text-slate-300">Analytics on forecast accuracy and inventory health</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce stockouts by 80%</li>
        <li class="text-slate-300">Cut inventory costs by 25%</li>
        <li class="text-slate-300">Sense demand changes in real-time</li>
        <li class="text-slate-300">Automate replenishment decisions</li>
      </ul>
        </div>
