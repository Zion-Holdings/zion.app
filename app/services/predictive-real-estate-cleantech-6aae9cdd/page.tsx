...
export const metadata: Metadata = {
  title: 'Predictive real estate-cleantech',
  description: 'Revolutionize cleantech through intelligent automation. Our Predictive real estate-cleantech leverages advanced machine learning to deliver document processing ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-real-estate-cleantech-6aae9cdd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive real estate-cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cleantech through intelligent automation. Our Predictive real estate-cleantech leverages advanced machine learning to deliver document processing at scale.
          </p>
