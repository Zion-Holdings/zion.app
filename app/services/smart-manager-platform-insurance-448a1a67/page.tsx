...
export const metadata: Metadata = {
  title: 'Smart Manager Platform - Insurance',
  description: 'Optimize your insurance workflows with Smart Manager Platform - Insurance. This intelligent platform delivers ml model training through advanced automation and ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manager Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Smart Manager Platform - Insurance. This intelligent platform delivers ml model training through advanced automation and AI.
          </p>
