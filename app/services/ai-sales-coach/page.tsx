...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time talk-listen + objection detection, Recommended next-step per call stage, CRM scorecard + follow-up task auto-created, Team leaderboard + best-practice highlight, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Sales Coach &amp; Call Analysis</h1>
        <p className="text-lg text-slate-300 mb-8">Real-time analysis: talk-listen ratio objection handling competitor mention pricing signal detection recommended next-step per call stage with CRM auto-scorecard team leaderboard.</p>
        ...
        <li class="text-slate-300">Real-time talk-listen + objection detection</li>
        <li class="text-slate-300">Recommended next-step per call stage</li>
        <li class="text-slate-300">CRM scorecard + follow-up task auto-created</li>
        <li class="text-slate-300">Team leaderboard + best-practice highlight</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai sales coach &amp; call analysis</li>
