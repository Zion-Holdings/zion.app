...
export const metadata: Metadata = {
  title: 'Enterprise Performance Management AI-Powered Security Auditing',
  description: 'AI-powered enterprise performance management solution for security. Continuous security auditing with automated compliance reporting.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-performance-management-ai-powered-security-auditing-0261efc8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Performance Management AI-Powered Security Auditing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered enterprise performance management solution for security. Continuous security auditing with automated compliance reporting.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Security auditing</li>
        ...
        <section className="mb-12">
          ...
          <li className="text-purple-300">Automated reports</li>
          </ul>
        </section>
