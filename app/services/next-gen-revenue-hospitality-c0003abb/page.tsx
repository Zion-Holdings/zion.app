...
export const metadata: Metadata = {
  title: 'Next-Gen Revenue - Hospitality',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Revenue - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your hospitality with Next-Gen Revenue - Hospitality. Our autonomous solution handles process automation end-to-end without human intervention.
          </p>
