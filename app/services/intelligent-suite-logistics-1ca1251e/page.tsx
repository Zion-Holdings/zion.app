...
export const metadata: Metadata = {
  ...
  keywords: 'Audit trails, Plugin architecture, Role-based access control, Zero-downtime updates, Machine learning integration, management, logistics, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Intelligent suite-logistics</h1>
        <p className="text-lg text-slate-300 mb-8">The future of logistics is here with Intelligent suite-logistics. Powered by cutting-edge AI, this platform delivers security monitoring like never before.</p>
