...
export const metadata: Metadata = {
  title: 'AI Healthcare - Transportation Edition',
  description: 'The future of transportation is here with AI Healthcare - Transportation Edition. Powered by cutting-edge AI, this platform delivers brand sentiment like never ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Healthcare - Transportation Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with AI Healthcare - Transportation Edition. Powered by cutting-edge AI, this platform delivers brand sentiment like never before.
          </p>
