...
export const metadata: Metadata = {
  title: 'AI/IT Enterprise Suite - Hospitality',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Enterprise Suite - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: AI/IT Enterprise Suite - Hospitality. Combines account planning with adaptive intelligence for optimal results.
          </p>
