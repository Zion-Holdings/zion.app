...
export const metadata: Metadata = {
  title: 'Automated Manager for Healthcare',
  description: 'Next-generation healthcare solution: Automated Manager for Healthcare. Combines decision support with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-manager-for-healthcare-4bcee9d9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Manager for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Automated Manager for Healthcare. Combines decision support with adaptive intelligence for optimal results.
          </p>
