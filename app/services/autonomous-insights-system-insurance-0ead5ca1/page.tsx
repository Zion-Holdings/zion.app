...
export const metadata: Metadata = {
  title: 'Autonomous Insights System - Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Autonomous Insights System - Insurance leverages advanced machine learning to deliver disaster recov',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-insights-system-insurance-0ead5ca1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Insights System - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Autonomous Insights System - Insurance leverages advanced machine learning to deliver disaster recovery at scale.
          </p>
