...
export const metadata: Metadata = {
  title: 'Smart Analytics for Transportation',
  description: 'Revolutionize transportation through intelligent automation. Our Smart Analytics for Transportation leverages advanced machine learning to deliver enterprise-gr',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize transportation through intelligent automation. Our Smart Analytics for Transportation leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
