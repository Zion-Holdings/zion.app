...
export const metadata: Metadata = {
  title: 'Smart Customer Automation',
  description: 'Optimize your media workflows with Smart Customer Automation. This intelligent platform delivers testing automation through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-customer-automation-d08f3cd2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your media workflows with Smart Customer Automation. This intelligent platform delivers testing automation through advanced automation and AI.
          </p>
