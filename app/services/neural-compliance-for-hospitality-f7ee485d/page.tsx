...
export const metadata: Metadata = {
  title: 'Neural Compliance for Hospitality',
  description: 'Next-generation hospitality solution: Neural Compliance for Hospitality. Combines performance monitoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-compliance-for-hospitality-f7ee485d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Compliance for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Neural Compliance for Hospitality. Combines performance monitoring with adaptive intelligence for optimal results.
          </p>
