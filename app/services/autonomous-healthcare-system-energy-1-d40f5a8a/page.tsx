...
export const metadata: Metadata = {
  title: 'Autonomous Healthcare System - Energy #1',
  description: 'Transform your energy operations with our Autonomous Healthcare System - Energy #1. This AI-driven solution automates social media monitoring with unprecedented',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-healthcare-system-energy-1-d40f5a8a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Healthcare System - Energy #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Autonomous Healthcare System - Energy #1. This AI-driven solution automates social media monitoring with unprecedented accuracy and efficiency.
          </p>
