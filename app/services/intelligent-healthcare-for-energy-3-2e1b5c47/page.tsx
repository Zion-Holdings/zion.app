...
export const metadata: Metadata = {
  title: 'Intelligent Healthcare for Energy #3',
  description: 'Optimize your energy workflows with Intelligent Healthcare for Energy #3. This intelligent platform delivers performance reviews through advanced automation and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-healthcare-for-energy-3-2e1b5c47',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Healthcare for Energy #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your energy workflows with Intelligent Healthcare for Energy #3. This intelligent platform delivers performance reviews through advanced automation and AI.
          </p>
