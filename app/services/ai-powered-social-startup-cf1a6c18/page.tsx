...
export const metadata: Metadata = {
  title: 'AI-Powered Social Startup',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Social Startup
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your proptech business with AI-Powered Social Startup. Our solution provides sustainability tracking with enterprise-grade reliability and security.
          </p>
