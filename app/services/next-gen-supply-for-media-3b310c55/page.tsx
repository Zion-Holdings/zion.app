...
export const metadata: Metadata = {
  title: 'Next-Gen Supply for Media',
  description: 'The future of media is here with Next-Gen Supply for Media. Powered by cutting-edge AI, this platform delivers content moderation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-supply-for-media-3b310c55',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Supply for Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of media is here with Next-Gen Supply for Media. Powered by cutting-edge AI, this platform delivers content moderation like never before.
          </p>
