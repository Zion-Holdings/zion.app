...
export const metadata: Metadata = {
  title: 'AI Experience - Insurance Edition',
  description: 'Revolutionize insurance through intelligent automation. Our AI Experience - Insurance Edition leverages advanced machine learning to deliver roi tracking at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Experience - Insurance Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our AI Experience - Insurance Edition leverages advanced machine learning to deliver roi tracking at scale.
          </p>
