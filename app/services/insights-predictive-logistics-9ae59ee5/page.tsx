...
export const metadata: Metadata = {
  title: 'Insights Predictive - Logistics',
  description: 'The future of logistics is here with Insights Predictive - Logistics. Powered by cutting-edge AI, this platform delivers forecast accuracy like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/insights-predictive-logistics-9ae59ee5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Insights Predictive - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Insights Predictive - Logistics. Powered by cutting-edge AI, this platform delivers forecast accuracy like never before.
          </p>
