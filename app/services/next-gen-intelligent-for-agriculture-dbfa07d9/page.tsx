...
export const metadata: Metadata = {
  title: 'Next-Gen Intelligent for Agriculture',
  description: 'The future of agriculture is here with Next-Gen Intelligent for Agriculture. Powered by cutting-edge AI, this platform delivers account planning like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-intelligent-for-agriculture-dbfa07d9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Intelligent for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Next-Gen Intelligent for Agriculture. Powered by cutting-edge AI, this platform delivers account planning like never before.
          </p>
