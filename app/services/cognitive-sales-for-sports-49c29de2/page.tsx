...
export const metadata: Metadata = {
  title: 'Cognitive Sales for Sports',
  description: 'Next-generation sports solution: Cognitive Sales for Sports. Combines energy management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-sales-for-sports-49c29de2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Sales for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation sports solution: Cognitive Sales for Sports. Combines energy management with adaptive intelligence for optimal results.
          </p>
