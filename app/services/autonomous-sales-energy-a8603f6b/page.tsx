...
export const metadata: Metadata = {
  title: 'Autonomous sales-energy',
  description: 'Next-generation energy solution: Autonomous sales-energy. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-sales-energy-a8603f6b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous sales-energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Autonomous sales-energy. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
