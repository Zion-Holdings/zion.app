...
export const metadata: Metadata = {
  title: 'Intelligent Engine for Legal',
  description: 'Optimize your legal workflows with Intelligent Engine for Legal. This intelligent platform delivers inventory optimization through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-engine-for-legal-ea1b9fd7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Engine for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with Intelligent Engine for Legal. This intelligent platform delivers inventory optimization through advanced automation and AI.
          </p>
