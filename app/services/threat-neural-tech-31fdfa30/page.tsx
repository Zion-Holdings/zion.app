...
export const metadata: Metadata = {
  title: 'Threat Neural - Tech',
  description: 'Transform your technology operations with our Threat Neural - Tech. This AI-driven solution automates net promoter score with unprecedented accuracy and efficie',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your technology operations with our Threat Neural - Tech. This AI-driven solution automates net promoter score with unprecedented accuracy and efficiency.
          </p>
