...
export const metadata: Metadata = {
  title: 'Intelligent Machine Learning for Construction',
  description: 'Transform your construction operations with our Intelligent Machine Learning for Construction. This AI-driven solution automates sourcing optimization with unpr',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-machine-learning-for-construction-f8fa3e11',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Machine Learning for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Intelligent Machine Learning for Construction. This AI-driven solution automates sourcing optimization with unprecedented accuracy and efficiency.
          </p>
