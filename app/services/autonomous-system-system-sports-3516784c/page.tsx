...
export const metadata: Metadata = {
  title: 'Autonomous System System - Sports',
  description: 'Optimize your sports workflows with Autonomous System System - Sports. This intelligent platform delivers logistics optimization through advanced automation and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-system-system-sports-3516784c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous System System - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your sports workflows with Autonomous System System - Sports. This intelligent platform delivers logistics optimization through advanced automation and AI.
          </p>
