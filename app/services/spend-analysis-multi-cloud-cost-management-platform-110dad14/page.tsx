...
export const metadata: Metadata = {
  ...
  description: 'spend analysis solution for water & wastewater industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/spend-analysis-multi-cloud-cost-management-platform-110dad14',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Spend Analysis Multi-Cloud Cost Management Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            spend analysis solution for water & wastewater industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.
          </p>
