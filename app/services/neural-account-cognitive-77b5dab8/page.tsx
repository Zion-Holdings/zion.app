...
export const metadata: Metadata = {
  title: 'Neural Account Cognitive',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Account Cognitive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your energy business with Neural Account Cognitive. Our solution provides logistics route optimization with enterprise-grade reliability and security.
          </p>
