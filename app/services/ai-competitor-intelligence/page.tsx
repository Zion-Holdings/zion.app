...
export const metadata: Metadata = {
  ...
  keywords: 'Daily web crawls, Feature matrix auto-update, Sentiment tracking, Alert rules & thresholds, Export to PDF/PPT, ai, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Competitor Intelligence Engine</h1>
        <p className="text-lg text-slate-300 mb-8">Automated competitor tracking: pricing changes, feature releases, marketing campaigns from 10K+ sources. Weekly digest + real-time alerts.</p>
        ...
        <li class="text-slate-300">Daily web crawls</li>
        <li class="text-slate-300">Feature matrix auto-update</li>
        <li class="text-slate-300">Sentiment tracking</li>
        <li class="text-slate-300">Alert rules &amp; thresholds</li>
        <li class="text-slate-300">Export to PDF/PPT</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with competitor intelligence engine</li>
