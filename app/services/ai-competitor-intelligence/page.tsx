      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Automated competitor tracking: pricing changes, feature releases, marketing campaigns from 10K+ sources. Weekly digest + real-time alerts.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Daily web crawls</li>
            <li className="text-purple-300">✓ Feature matrix auto-update</li>
            <li className="text-purple-300">✓ Sentiment tracking</li>
            <li className="text-purple-300">✓ Alert rules & thresholds</li>
            <li className="text-purple-300">✓ Export to PDF/PPT</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with competitor intelligence engine</li>
