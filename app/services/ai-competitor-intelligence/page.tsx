  ...
  <div className="min-h-screen bg-slate-950 text-white">
   ...
   <main className="min-h-screen bg-slate-950 py-20 px-4">
    <div className="container-page max-w-4xl mx-auto">
     <h1 className="text-4xl font-bold text-white mb-4">Competitor Intelligence Engine</h1>
     <p className="text-slate-300 text-lg mb-8">Automated competitor tracking: pricing changes, feature releases, marketing campaigns from 10K+ sources. Weekly digest + real-time alerts.</p>
