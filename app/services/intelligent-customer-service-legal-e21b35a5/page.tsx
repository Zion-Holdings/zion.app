...
export const metadata: Metadata = {
  title: 'Intelligent customer service-legal',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent customer service-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your legal with Intelligent customer service-legal. Our autonomous solution handles recommendation system end-to-end without human intervention.
          </p>
