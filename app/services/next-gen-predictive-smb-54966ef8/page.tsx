...
export const metadata: Metadata = {
  title: 'Next-Gen Predictive SMB',
  description: 'Revolutionize construction through intelligent automation. Our Next-Gen Predictive SMB leverages advanced machine learning to deliver rpa orchestration at scale',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-predictive-smb-54966ef8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Predictive SMB
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Next-Gen Predictive SMB leverages advanced machine learning to deliver rpa orchestration at scale.
          </p>
