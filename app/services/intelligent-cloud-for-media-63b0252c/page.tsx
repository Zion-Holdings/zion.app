export const metadata = {
  title: "Intelligent Cloud for Media",
  description: "Zion Tech Group delivers Intelligent Cloud for Media with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/services/intelligent-cloud-for-media-63b0252c/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>Intelligent Cloud for Media</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers Intelligent Cloud for Media with measurable outcomes.
      </p>
