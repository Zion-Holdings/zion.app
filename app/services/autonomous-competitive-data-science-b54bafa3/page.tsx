...
export const metadata: Metadata = {
  title: 'Autonomous Competitive Data Science',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Competitive Data Science
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agriculture solution: Autonomous Competitive Data Science. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
