...
export const metadata: Metadata = {
  title: 'Cognitive Data Solution - PROPTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Data Solution - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for proptech: Cognitive Data Solution - PROPTECH. Uses quantum-inspired algorithms to deliver onboarding automation at exponential speed.
          </p>
