...
export const metadata: Metadata = {
  title: 'AI Data - Proptech Edition #1',
  description: 'Next-generation proptech solution: AI Data - Proptech Edition #1. Combines resource optimization with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-data---proptech-edition-1-ff29f2a8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Data - Proptech Edition #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation proptech solution: AI Data - Proptech Edition #1. Combines resource optimization with adaptive intelligence for optimal results.
          </p>
