...
export const metadata: Metadata = {
  title: 'Compliance Cognitive - Insurance',
  description: 'Next-generation insurance solution: Compliance Cognitive - Insurance. Combines container orchestration with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/compliance-cognitive-insurance-235e1649',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Compliance Cognitive - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Compliance Cognitive - Insurance. Combines container orchestration with adaptive intelligence for optimal results.
          </p>
