      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Industry 4.0 AI</li>
            <li className="text-purple-300">✓ IoT</li>
            <li className="text-purple-300">✓ Big data</li>
            <li className="text-purple-300">✓ ML</li>
            </ul>
          </div>
          ...
          <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl p-8 text-center mb-8">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <div className="bg-white/10 rounded-lg p-4">
                <div className="text-3xl font-bold mb-2">$49999</div>
                <div>Enterprise</div>
              </div>
            </div>
          </div>
