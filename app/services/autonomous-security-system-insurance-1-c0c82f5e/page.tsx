...
export const metadata: Metadata = {
  title: 'Autonomous Security System - Insurance #1',
  description: 'Drive innovation in insurance with Autonomous Security System - Insurance #1. This AI-powered platform transforms business continuity into a competitive advanta',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-security-system-insurance-1-c0c82f5e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Security System - Insurance #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Autonomous Security System - Insurance #1. This AI-powered platform transforms business continuity into a competitive advantage.
          </p>
