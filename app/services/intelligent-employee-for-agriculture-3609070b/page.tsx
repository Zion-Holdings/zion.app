...
export const metadata: Metadata = {
  title: 'Intelligent Employee for Agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Intelligent Employee for Agriculture leverages advanced machine learning to deliver manufacturing ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-employee-for-agriculture-3609070b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Employee for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Intelligent Employee for Agriculture leverages advanced machine learning to deliver manufacturing quality control at scale.
          </p>
