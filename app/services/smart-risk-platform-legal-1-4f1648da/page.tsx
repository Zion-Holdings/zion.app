...
export const metadata: Metadata = {
  title: 'Smart Risk Platform - Legal #1',
  description: 'The future of legal is here with Smart Risk Platform - Legal #1. Powered by cutting-edge AI, this platform delivers loyalty optimization like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-risk-platform-legal-1-4f1648da',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Risk Platform - Legal #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Smart Risk Platform - Legal #1. Powered by cutting-edge AI, this platform delivers loyalty optimization like never before.
          </p>
