...
export const metadata: Metadata = {
  title: 'Intelligent Data for Tech',
  description: 'The future of technology is here with Intelligent Data for Tech. Powered by cutting-edge AI, this platform delivers survey automation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-data-for-tech-399835a4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Data for Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of technology is here with Intelligent Data for Tech. Powered by cutting-edge AI, this platform delivers survey automation like never before.
          </p>
