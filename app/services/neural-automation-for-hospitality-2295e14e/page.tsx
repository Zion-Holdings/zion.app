...
export const metadata: Metadata = {
  title: 'Neural Automation for Hospitality',
  description: 'Optimize your hospitality workflows with Neural Automation for Hospitality. This intelligent platform delivers revenue forecasting through advanced automation a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-automation-for-hospitality-2295e14e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Automation for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Neural Automation for Hospitality. This intelligent platform delivers revenue forecasting through advanced automation and AI.
          </p>
