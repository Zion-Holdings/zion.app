...
export const metadata: Metadata = {
  title: 'Engine Smart - Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Engine Smart - Insurance leverages advanced machine learning to deliver enterprise-grade insights at',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/engine-smart-insurance-04c1c0bc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Engine Smart - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Engine Smart - Insurance leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
