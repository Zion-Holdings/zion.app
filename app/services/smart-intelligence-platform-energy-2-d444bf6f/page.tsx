...
export const metadata: Metadata = {
  title: 'Smart Intelligence Platform - Energy #2',
  description: 'The future of energy is here with Smart Intelligence Platform - Energy #2. Powered by cutting-edge AI, this platform delivers procurement automation like never ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-intelligence-platform-energy-2-d444bf6f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Intelligence Platform - Energy #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Smart Intelligence Platform - Energy #2. Powered by cutting-edge AI, this platform delivers procurement automation like never before.
          </p>
