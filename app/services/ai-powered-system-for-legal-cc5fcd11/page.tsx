...
export const metadata: Metadata = {
  title: 'AI-Powered System for Legal',
  description: 'The future of legal is here with AI-Powered System for Legal. Powered by cutting-edge AI, this platform delivers document processing like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-system-for-legal-cc5fcd11',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered System for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with AI-Powered System for Legal. Powered by cutting-edge AI, this platform delivers document processing like never before.
          </p>
