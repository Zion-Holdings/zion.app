...
export const metadata: Metadata = {
  title: 'Smart Director Platform - Finance #1',
  description: 'Transform your finance operations with our Smart Director Platform - Finance #1. This AI-driven solution automates resource planning with unprecedented accuracy',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-director-platform-finance-1-87061f61',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Director Platform - Finance #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Smart Director Platform - Finance #1. This AI-driven solution automates resource planning with unprecedented accuracy and efficiency.
          </p>
