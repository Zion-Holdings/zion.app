      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Train and deploy custom foundation models. Domain-specific pretraining, fine-tuning, and model adaptation for enterprise AI with full data sovereig...
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Domain-Specific Pretraining</li>
            <li className="text-purple-300">✓ Efficient Fine-Tuning & Adaptation</li>
            <li className="text-purple-300">✓ Alignment & Safety Training</li>
            <li className="text-purple-300">✓ Continuous Learning Pipelines</li>
            <li className="text-purple-300">✓ Model Compression & Export</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai foundation models & custom training</li>
