...
export const metadata: Metadata = {
  title: 'AI/IT Director Suite - EDTECH',
  description: 'Enhance your edtech business with AI/IT Director Suite - EDTECH. Our solution provides supply chain with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-director-suite-edtech-c879452e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Director Suite - EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your edtech business with AI/IT Director Suite - EDTECH. Our solution provides supply chain with enterprise-grade reliability and security.
          </p>
