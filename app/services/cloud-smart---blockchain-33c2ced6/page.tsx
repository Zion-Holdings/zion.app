...
export const metadata: Metadata = {
  title: 'Cloud Smart - Blockchain',
  description: 'Next-generation blockchain solution: Cloud Smart - Blockchain. Combines network optimization with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cloud-smart---blockchain-33c2ced6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cloud Smart - Blockchain
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation blockchain solution: Cloud Smart - Blockchain. Combines network optimization with adaptive intelligence for optimal results.
          </p>
