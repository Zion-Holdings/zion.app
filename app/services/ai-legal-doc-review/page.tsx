      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Accelerate legal document analysis with AI: extract clauses, flag risks, summarize contracts, and generate due diligence reports in minutes.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Contract clause extraction & classification</li>
            <li className="text-purple-300">✓ Risk flagging & compliance checking</li>
            <li className="text-purple-300">✓ Document summarization (NLP)</li>
            <li className="text-purple-300">✓ Due diligence report generation</li>
            <li className="text-purple-300">✓ Multi-language support (20+ languages)</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai legal document review</li>
