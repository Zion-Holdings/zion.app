...
export const metadata: Metadata = {
  ...
  keywords: 'Contract clause extraction & classification, Risk flagging & compliance checking, Document summarization (NLP), Due diligence report generation, Multi-language support (20+ languages), ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Legal Document Review</h1>
        <p className="text-lg text-slate-300 mb-8">Accelerate legal document analysis with AI: extract clauses, flag risks, summarize contracts, and generate due diligence reports in minutes.</p>
        ...
        <li class="text-slate-300">Contract clause extraction &amp; classification</li>
        <li class="text-slate-300">Risk flagging &amp; compliance checking</li>
        <li class="text-slate-300">Document summarization (NLP)</li>
        <li class="text-slate-300">Due diligence report generation</li>
        <li class="text-slate-300">Multi-language support (20+ languages)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai legal document review</li>
