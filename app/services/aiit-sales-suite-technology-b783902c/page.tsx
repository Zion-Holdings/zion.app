...
export const metadata: Metadata = {
  title: 'AI/IT Sales Suite - TECHNOLOGY',
  description: 'Hyper-accelerated technology solution: AI/IT Sales Suite - TECHNOLOGY. Combines predictive analytics with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-sales-suite-technology-b783902c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Sales Suite - TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated technology solution: AI/IT Sales Suite - TECHNOLOGY. Combines predictive analytics with next-gen AI for maximum velocity.
          </p>
