...
export const metadata: Metadata = {
  ...
  keywords: 'Document format preservation, Industry-specific terminology, 100+ language pairs, Legal and medical translation, Terminology management, Translation memory, API and plugin for CMS/WMS, Human review workflow, ai, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Document Translation Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Enterprise document translation with AI. Translate contracts, manuals, and marketing materials while preserving formatting, terminology, and legal accuracy.</p>
        ...
        <li class="text-slate-300">Document format preservation</li>
        <li class="text-slate-300">Industry-specific terminology</li>
        <li class="text-slate-300">100+ language pairs</li>
        <li class="text-slate-300">Legal and medical translation</li>
        <li class="text-slate-300">Terminology management</li>
        <li class="text-slate-300">Translation memory</li>
        <li class="text-slate-300">API and plugin for CMS/WMS</li>
        <li class="text-slate-300">Human review workflow</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Translate 10x faster than human</li>
        <li class="text-slate-300">Ensure terminology consistency</li>
        <li class="text-slate-300">Preserve document formatting</li>
        <li class="text-slate-300">Scale localization operations</li>
      </ul>
        </div>
