...
export const metadata: Metadata = {
  title: 'Scalable Process Automation Vue.js (Api)',
  description: 'Scalable Process Automation Vue.js (Api) is an AI-powered api solution that transforms how businesses operate through intelligent automation and real-time analy',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Scalable Process Automation Vue.js (Api)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Scalable Process Automation Vue.js (Api) is an AI-powered api solution that transforms how businesses operate through intelligent automation and real-time analytics.
