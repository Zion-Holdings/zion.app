...
export const metadata: Metadata = {
  ...
  description: 'Future-proof your hospitality with Autonomous Machine Learning System - Hospitality. Our autonomous solution handles sales process optimization end-to-end witho',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your hospitality with Autonomous Machine Learning System - Hospitality. Our autonomous solution handles sales process optimization end-to-end without human intervention.
          </p>
