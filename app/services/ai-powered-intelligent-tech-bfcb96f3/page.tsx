...
export const metadata: Metadata = {
  title: 'AI-Powered intelligent-tech',
  description: 'Drive innovation in technology with AI-Powered intelligent-tech. This AI-powered platform transforms testing automation into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-intelligent-tech-bfcb96f3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered intelligent-tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in technology with AI-Powered intelligent-tech. This AI-powered platform transforms testing automation into a competitive advantage.
          </p>
