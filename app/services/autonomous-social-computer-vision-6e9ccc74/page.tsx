...
export const metadata: Metadata = {
  title: 'Autonomous Social Computer Vision',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Social Computer Vision
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for edtech: Autonomous Social Computer Vision. Uses quantum-inspired algorithms to deliver investor relations at exponential speed.
          </p>
