...
export const metadata: Metadata = {
  ...
  keywords: 'Automated access reviews and certifications, Role mining and optimization, Segregation of duties (SoD) enforcement, Privileged access management (PAM), Access request and approval workflows, Identity analytics and risk scoring, Integration with SailPoint, CyberArk, Okta, security, Identity, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Enterprise identity governance: access reviews, role mining, segregation of duties, and privileged access management. Ensure least privilege at scale.</p>
        ...
        <li class="text-slate-300">Automated access reviews and certifications</li>
        <li class="text-slate-300">Role mining and optimization</li>
        <li class="text-slate-300">Segregation of duties (SoD) enforcement</li>
        <li class="text-slate-300">Privileged access management (PAM)</li>
        <li class="text-slate-300">Access request and approval workflows</li>
        <li class="text-slate-300">Identity analytics and risk scoring</li>
        <li class="text-slate-300">Integration with SailPoint, CyberArk, Okta</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Ensure least privilege across 1000s of identities</li>
        <li class="text-slate-300">Automated reviews replace manual access audits</li>
        <li class="text-slate-300">SoD enforcement prevents fraud</li>
        <li class="text-slate-300">PAM secures privileged accounts</li>
      </ul>
        </div>
