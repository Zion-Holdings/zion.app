...
export const metadata: Metadata = {
  title: 'Platform Smart - Logistics',
  description: 'Transform your logistics operations with our Platform Smart - Logistics. This AI-driven solution automates campaign optimization with unprecedented accuracy and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/platform-smart-logistics-d214550e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Platform Smart - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Platform Smart - Logistics. This AI-driven solution automates campaign optimization with unprecedented accuracy and efficiency.
          </p>
