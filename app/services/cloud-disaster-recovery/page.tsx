...
export const metadata: Metadata = {
  ...
  keywords: 'Continuous data replication, Automated failover and failback, Regular DR testing, RPO/RTO guarantees, Integration with AWS, Azure, GCP, Runbook automation, Compliance reporting, 24/7 monitoring, cloud, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cloud Disaster Recovery as a Service</h1>
        <p className="text-lg text-slate-300 mb-8">Automated cloud disaster recovery. Continuous replication, automated failover, and regular DR testing with RPO/RTO guarantees.</p>
        ...
        <li class="text-slate-300">Integration with AWS, Azure, GCP</li>
        ...
        <li class="text-slate-300">Reduce RTO to minutes</li>
