...
export const metadata: Metadata = {
  title: 'Revenue Smart - Construction',
  description: 'Optimize your construction workflows with Revenue Smart - Construction. This intelligent platform delivers security monitoring through advanced automation and A',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/revenue-smart-construction-4cfea322',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Revenue Smart - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Revenue Smart - Construction. This intelligent platform delivers security monitoring through advanced automation and AI.
          </p>
