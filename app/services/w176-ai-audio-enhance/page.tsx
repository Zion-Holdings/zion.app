...
export const metadata: Metadata = {
  ...
  keywords: 'AI noise and background removal, Speaker diarization and separation, Podcast auto-editing (um, ah, silence removal), Speech enhancement and loudness normalization, Music and jingle insertion, Batch processing for episodes, API and CLI for automation pipelines, ai, Media, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Audio Enhancement Studio</h1>
        <p className="text-lg text-slate-300 mb-8">AI audio processing: noise removal, speaker separation, podcast editing, and speech enhancement. Studio quality from any recording.</p>
        ...
        <li class="text-slate-300">AI noise and background removal</li>
        <li class="text-slate-300">Speaker diarization and separation</li>
        <li class="text-slate-300">Podcast auto-editing (um, ah, silence removal)</li>
        <li class="text-slate-300">Speech enhancement and loudness normalization</li>
        <li class="text-slate-300">Music and jingle insertion</li>
        <li class="text-slate-300">Batch processing for episodes</li>
        <li class="text-slate-300">API and CLI for automation pipelines</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Studio quality from any recording</li>
        <li class="text-slate-300">Auto-editing saves hours per podcast</li>
        <li class="text-slate-300">Speaker separation for multi-participant content</li>
        <li class="text-slate-300">Batch processing scales production</li>
      </ul>
        </div>
