...
export const metadata: Metadata = {
  title: 'AI-Powered Legal Predictive Analytics',
  description: 'AI-powered legal solution leveraging advanced machine learning for optimal performance and ROI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-legal-predictive-analytics-058a836b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Legal Predictive Analytics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered legal solution leveraging advanced machine learning for optimal performance and ROI.
          </p>
