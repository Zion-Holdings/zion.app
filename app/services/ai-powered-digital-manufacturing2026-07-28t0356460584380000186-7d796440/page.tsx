...
export const metadata: Metadata = {
  title: 'AI-Powered Digital Manufacturing',
  description: 'Digital manufacturing with AI and simulation.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-digital-manufacturing2026-07-28t0356460584380000186-7d796440',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Digital manufacturing with AI and simulation.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Digital manufacturing</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">45% digital efficiency</li>
