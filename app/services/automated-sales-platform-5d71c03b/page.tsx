...
export const metadata: Metadata = {
  title: 'Automated Sales Platform',
  description: 'Transform your edge operations with our Automated Sales Platform. This AI-driven solution automates logistics route optimization with unprecedented accuracy and',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your edge operations with our Automated Sales Platform. This AI-driven solution automates logistics route optimization with unprecedented accuracy and efficiency.
          </p>
