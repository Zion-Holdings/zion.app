...
export const metadata: Metadata = {
  title: 'Tactical Intelligent - PROPTECH',
  description: 'Next-generation proptech solution: Tactical Intelligent - PROPTECH. Combines record extraction with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/tactical-intelligent-proptech-89e50980',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Tactical Intelligent - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation proptech solution: Tactical Intelligent - PROPTECH. Combines record extraction with adaptive intelligence for optimal results.
          </p>
