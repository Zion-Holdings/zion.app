...
export const metadata: Metadata = {
  title: 'Autonomous Optimizer System - REGTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Optimizer System - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation regtech solution: Autonomous Optimizer System - REGTECH. Combines incident response with adaptive intelligence for optimal results.
          </p>
