...
export const metadata: Metadata = {
  title: 'Cognitive Analyzer Solution - FINTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Analyzer Solution - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in fintech with Cognitive Analyzer Solution - FINTECH. This AI-powered platform transforms form processing into a competitive advantage.
          </p>
