...
export const metadata: Metadata = {
  title: 'Intelligent Knowledge for PROPTECH #1',
  description: 'Quantum leap forward for proptech: Intelligent Knowledge for PROPTECH #1. Uses quantum-inspired algorithms to deliver data fabric at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-knowledge-for-proptech-1-7765ad8c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Knowledge for PROPTECH #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for proptech: Intelligent Knowledge for PROPTECH #1. Uses quantum-inspired algorithms to deliver data fabric at exponential speed.
          </p>
