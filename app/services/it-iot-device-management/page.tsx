...
export const metadata: Metadata = {
  ...
  keywords: 'Device inventory & health monitoring, Remote command & control, Firmware OTA scheduling, Geofencing & alerting, it, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Enterprise IoT Device Management</h1>
        <p className="text-lg text-slate-300 mb-8">Provision, monitor, and secure 10K+ IoT devices (sensors, cameras, gateways) from a single dashboard with OTA updates and zero-touch enrollment.</p>
        ...
        <li class="text-slate-300">Device inventory &amp; health monitoring</li>
        <li class="text-slate-300">Remote command &amp; control</li>
        <li class="text-slate-300">Firmware OTA scheduling</li>
        <li class="text-slate-300">Geofencing &amp; alerting</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with enterprise iot device management</li>
