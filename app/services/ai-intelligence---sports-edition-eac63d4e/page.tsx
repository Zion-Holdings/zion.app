...
export const metadata: Metadata = {
  title: 'AI Intelligence - Sports Edition',
  description: 'The future of sports is here with AI Intelligence - Sports Edition. Powered by cutting-edge AI, this platform delivers financial planning like never before.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Intelligence - Sports Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with AI Intelligence - Sports Edition. Powered by cutting-edge AI, this platform delivers financial planning like never before.
          </p>
