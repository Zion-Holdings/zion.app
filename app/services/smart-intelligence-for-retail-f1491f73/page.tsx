...
export const metadata: Metadata = {
  title: 'Smart Intelligence for Retail',
  description: 'The future of retail is here with Smart Intelligence for Retail. Powered by cutting-edge AI, this platform delivers code optimization like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-intelligence-for-retail-f1491f73',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Intelligence for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Smart Intelligence for Retail. Powered by cutting-edge AI, this platform delivers code optimization like never before.
          </p>
