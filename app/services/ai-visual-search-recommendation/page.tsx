...
export const metadata: Metadata = {
  ...
  keywords: 'Multimodal embedding (CLIP + custom fine-tune), Visual similarity search <200ms, Shop-the-look & bundled recommendation, Colour/shape/pattern attribute extraction, OpenSearch / Pinecone / Weaviate connectors, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Visual Search &amp; Image-Based Recommendation</h1>
        <p className="text-lg text-slate-300 mb-8">Visual product discovery engine: upload any image to find visually similar products across your catalogue. Power visual search bars, Shop the Look features, and visual similarity recommendations.</p>
        ...
        <li class="text-slate-300">Multimodal embedding (CLIP + custom fine-tune)</li>
        <li class="text-slate-300">Visual similarity search &lt;200ms</li>
        <li class="text-slate-300">Shop-the-look &amp; bundled recommendation</li>
        <li class="text-slate-300">Colour/shape/pattern attribute extraction</li>
        <li class="text-slate-300">OpenSearch / Pinecone / Weaviate connectors</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai visual search &amp; image-based recommendation</li>
