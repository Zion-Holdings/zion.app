...
export const metadata: Metadata = {
  title: 'Data Autonomous - Iot',
  description: 'Transform your iot operations with our Data Autonomous - Iot. This AI-driven solution automates security monitoring with unprecedented accuracy and efficiency.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-autonomous---iot-2016d234',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your iot operations with our Data Autonomous - Iot. This AI-driven solution automates security monitoring with unprecedented accuracy and efficiency.
          </p>
