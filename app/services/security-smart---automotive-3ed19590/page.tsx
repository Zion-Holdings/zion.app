...
export const metadata: Metadata = {
  title: 'Security Smart - Automotive',
  description: 'Unlock unprecedented growth with Security Smart - Automotive. This autonomous system provides risk assessment with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-smart---automotive-3ed19590',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Smart - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Security Smart - Automotive. This autonomous system provides risk assessment with zero manual intervention needed.
          </p>
