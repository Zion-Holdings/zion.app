...
export const metadata: Metadata = {
  title: 'Cognitive marketing-energy',
  description: 'Revolutionize energy through intelligent automation. Our Cognitive marketing-energy leverages advanced machine learning to deliver content generation at scale.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive marketing-energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Cognitive marketing-energy leverages advanced machine learning to deliver content generation at scale.
          </p>
