...
export const metadata: Metadata = {
  ...
  description: 'speech analytics solution for pharmaceuticals industry. End-to-end predictive analytics platform that forecasts market trends, customer behavior, and operationa',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/speech-analytics-ai-powered-predictive-analytics-suite-4e799a22',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            speech analytics solution for pharmaceuticals industry. End-to-end predictive analytics platform that forecasts market trends, customer behavior, and operational metrics with 95% accuracy.
          </p>
