...
export const metadata: Metadata = {
  title: 'Suite Self-Optimizing - Construction',
  description: 'Unlock unprecedented growth with Suite Self-Optimizing - Construction. This autonomous system provides anomaly detection with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/suite-self-optimizing-construction-b3b2b42e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Suite Self-Optimizing - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Suite Self-Optimizing - Construction. This autonomous system provides anomaly detection with zero manual intervention needed.
          </p>
