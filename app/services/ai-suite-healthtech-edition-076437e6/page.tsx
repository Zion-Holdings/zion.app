...
export const metadata: Metadata = {
  title: 'AI Suite - HEALTHTECH Edition',
  description: 'Transform your healthtech operations with our AI Suite - HEALTHTECH Edition. This AI-driven solution automates fleet management with unprecedented accuracy and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-suite-healthtech-edition-076437e6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Suite - HEALTHTECH Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthtech operations with our AI Suite - HEALTHTECH Edition. This AI-driven solution automates fleet management with unprecedented accuracy and efficiency.
          </p>
