...
export const metadata = {
  ...
  description: 'End-to-end ar vr enterprise services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/ar-vr-enterprise-2026-7118/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">AR VR Enterprise</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end ar vr enterprise services: assessment, deployment, and managed operations.
        </p>
