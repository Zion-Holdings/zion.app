...
export const metadata: Metadata = {
  title: 'Intelligent Inventory Coordinator',
  description: 'Next-generation blockchain solution: Intelligent Inventory Coordinator. Combines image recognition with adaptive intelligence for optimal results.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Inventory Coordinator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation blockchain solution: Intelligent Inventory Coordinator. Combines image recognition with adaptive intelligence for optimal results.
          </p>
