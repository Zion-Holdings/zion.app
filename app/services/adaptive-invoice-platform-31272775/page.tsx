...
export const metadata: Metadata = {
  title: 'Adaptive Invoice Platform',
  description: 'Next-generation agriculture solution: Adaptive Invoice Platform. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-invoice-platform-31272775',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Invoice Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agriculture solution: Adaptive Invoice Platform. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
