...
export const metadata: Metadata = {
  ...
  keywords: 'Yaw & pitch AI optimization, Wake effect modeling & mitigation, Predictive maintenance scheduling, Power curve anomaly detection, Grid integration optimization, Wind forecasting (hourly to weekly), ai, Energy & Utilities, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Wind Farm Performance Optimizer</h1>
        <p className="text-lg text-slate-300 mb-8">Maximize wind turbine output: yaw optimization, pitch control, wake effect modeling, and predictive maintenance. Increases energy output by 12% and reduces maintenance by 40%.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">ai</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">Energy &amp; Utilities</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Yaw &amp; pitch AI optimization</li>
        <li class="text-slate-300">Wake effect modeling &amp; mitigation</li>
        <li class="text-slate-300">Predictive maintenance scheduling</li>
        <li class="text-slate-300">Power curve anomaly detection</li>
        <li class="text-slate-300">Grid integration optimization</li>
        <li class="text-slate-300">Wind forecasting (hourly to weekly)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Increase output by 12%</li>
        <li class="text-slate-300">Reduce maintenance by 40%</li>
        <li class="text-slate-300">Maximize ROI per turbine</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">499/turbine</p>
              <p class="text-sm text-slate-400">Getting started plan</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              <h3 class="font-semibold text-white mb-2">Pro</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">999/turbine</p>
              <p class="text-sm text-slate-400">Most popular</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              <h3 class="font-semibold text-white mb-2">Enterprise</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">2499/turbine</p>
