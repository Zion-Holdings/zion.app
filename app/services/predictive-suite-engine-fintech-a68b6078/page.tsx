...
export const metadata: Metadata = {
  title: 'Predictive Suite Engine - FINTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Suite Engine - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your fintech workflows with Predictive Suite Engine - FINTECH. This intelligent platform delivers workflow automation through advanced automation and AI.
          </p>
