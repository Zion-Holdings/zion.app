...
export const metadata: Metadata = {
  ...
  keywords: 'Interactive dependency graph, Auto-updated API endpoint docs, Change-log highlighting, Developer onboarding checklist, ai, E-Commerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Codebase Documentation Generator</h1>
        <p className="text-lg text-slate-300 mb-8">Automatically generates architecture diagrams, API docs, and README files by analyzing your Git repository and code dependencies.</p>
        ...
        <li class="text-slate-300">Interactive dependency graph</li>
        <li class="text-slate-300">Auto-updated API endpoint docs</li>
        <li class="text-slate-300">Change-log highlighting</li>
        <li class="text-slate-300">Developer onboarding checklist</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai codebase documentation generator</li>
