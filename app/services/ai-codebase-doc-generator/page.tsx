      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Automatically generates architecture diagrams, API docs, and README files by analyzing your Git repository and code dependencies.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Interactive dependency graph</li>
            <li className="text-purple-300">✓ Auto-updated API endpoint docs</li>
            <li className="text-purple-300">✓ Change-log highlighting</li>
            <li className="text-purple-300">✓ Developer onboarding checklist</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai codebase documentation generator</li>
