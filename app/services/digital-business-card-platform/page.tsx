...
export const metadata: Metadata = {
  ...
  keywords: 'NFC-enabled cards, Analytics dashboard, CRM sync, Lead capture forms, Team management, Custom designs, LinkedIn integration, QR code sharing, micro-saas, Enterprise, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Digital Business Card &amp; Networking Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Replace paper cards with smart digital business cards. NFC-enabled, analytics-tracked, with CRM sync and lead capture. Includes team management, custom designs, and integration with LinkedIn and major CRMs.</p>
        ...
        <li class="text-slate-300">NFC-enabled cards</li>
        <li class="text-slate-300">Analytics dashboard</li>
        <li class="text-slate-300">CRM sync</li>
        <li class="text-slate-300">Lead capture forms</li>
        <li class="text-slate-300">Team management</li>
        <li class="text-slate-300">Custom designs</li>
        <li class="text-slate-300">LinkedIn integration</li>
        <li class="text-slate-300">QR code sharing</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">100% more leads from networking</li>
        <li class="text-slate-300">Zero paper waste</li>
        <li class="text-slate-300">Real-time contact analytics</li>
      </ul>
        </div>
