...
export const metadata: Metadata = {
  title: 'Supply Cognitive - Manufacturing',
  description: 'Next-generation manufacturing solution: Supply Cognitive - Manufacturing. Combines document ai with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/supply-cognitive-manufacturing-f741947f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Supply Cognitive - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation manufacturing solution: Supply Cognitive - Manufacturing. Combines document ai with adaptive intelligence for optimal results.
          </p>
