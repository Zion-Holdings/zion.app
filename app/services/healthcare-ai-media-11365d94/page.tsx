...
export const metadata: Metadata = {
  title: 'Healthcare AI - Media',
  description: 'Next-generation media solution: Healthcare AI - Media. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/healthcare-ai-media-11365d94',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation media solution: Healthcare AI - Media. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
