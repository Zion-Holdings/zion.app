    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI Language Immersion & Conversation Tutor
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          Personalized language learning: AI conversation partner with speech recognition, cultural context lessons, pronunciation scoring, and spaced repetition. 30+ lan
        </p>
