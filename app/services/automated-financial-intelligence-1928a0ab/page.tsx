...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize quantum through intelligent automation. Our Automated Financial Intelligence leverages advanced machine learning to deliver financial planning at ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize quantum through intelligent automation. Our Automated Financial Intelligence leverages advanced machine learning to deliver financial planning at scale.
          </p>
