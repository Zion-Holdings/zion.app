...
export const metadata: Metadata = {
  title: 'Intelligent Tactical for Automotive',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Tactical for Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in automotive with Intelligent Tactical for Automotive. This AI-powered platform transforms loyalty optimization into a competitive advantage.
          </p>
