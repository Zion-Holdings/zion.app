...
export const metadata: Metadata = {
  title: 'Intelligent Computer Vision for Media',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Computer Vision for Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in media with Intelligent Computer Vision for Media. This AI-powered platform transforms pipeline management into a competitive advantage.
          </p>
