...
export const metadata: Metadata = {
  title: 'Smart Processor Platform - Hospitality',
  description: 'Drive innovation in hospitality with Smart Processor Platform - Hospitality. This AI-powered platform transforms edge computing into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-processor-platform-hospitality-5b3e00ad',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Processor Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Smart Processor Platform - Hospitality. This AI-powered platform transforms edge computing into a competitive advantage.
          </p>
