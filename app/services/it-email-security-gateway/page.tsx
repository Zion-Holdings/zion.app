...
export const metadata: Metadata = {
  ...
  keywords: 'AI-powered phishing and BEC detection, Sandboxing for attachment analysis, DMARC/DKIM/SPF enforcement and monitoring, Email encryption and DLP policies, Impersonation protection for executives, Incident response automation for compromised accounts, security, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Email Security Gateway &amp; Anti-Phishing</h1>
        <p className="text-lg text-slate-300 mb-8">Advanced email security gateway that blocks phishing, BEC, malware, and spam with AI-powered threat detection. Protects against the #1 attack vector for businesses.</p>
        ...
        <li class="text-slate-300">Sandboxing for attachment analysis</li>
        <li class="text-slate-300">DMARC/DKIM/SPF enforcement and monitoring</li>
        <li class="text-slate-300">Email encryption and DLP policies</li>
        <li class="text-slate-300">Impersonation protection for executives</li>
        <li class="text-slate-300">Incident response automation for compromised accounts</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Block 99.9% of phishing attempts</li>
        <li class="text-slate-300">Prevent BEC fraud with AI analysis</li>
        <li class="text-slate-300">Meet email compliance requirements</li>
        <li class="text-slate-300">Reduce email security management by 80%</li>
      </ul>
        </div>
