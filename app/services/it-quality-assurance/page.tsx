...
export const metadata: Metadata = {
  ...
  keywords: 'Test strategy and planning, Test automation framework development, Selenium, Cypress, Playwright automation, Performance and load testing, Security testing and vulnerability scanning, CI/CD pipeline integration, Test reporting and analytics, Dedicated QA engineers and managers, it, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Quality Assurance &amp; Testing Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Comprehensive QA and testing automation. From manual testing to full test automation with CI/CD integration. Ensure quality at speed.</p>
        ...
        <li class="text-slate-300">Test strategy and planning</li>
        <li class="text-slate-300">Test automation framework development</li>
        <li class="text-slate-300">Selenium, Cypress, Playwright automation</li>
        <li class="text-slate-300">Performance and load testing</li>
        <li class="text-slate-300">Security testing and vulnerability scanning</li>
        <li class="text-slate-300">CI/CD pipeline integration</li>
        <li class="text-slate-300">Test reporting and analytics</li>
        <li class="text-slate-300">Dedicated QA engineers and managers</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce testing time by 70% with automation</li>
        <li class="text-slate-300">Catch 95% of bugs before production</li>
        <li class="text-slate-300">Enable continuous delivery with confidence</li>
        <li class="text-slate-300">Reduce QA costs while improving quality</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$7,000/mo</p>
