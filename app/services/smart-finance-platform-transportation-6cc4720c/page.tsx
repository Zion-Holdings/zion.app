...
export const metadata: Metadata = {
  title: 'Smart Finance Platform - Transportation',
  description: 'The future of transportation is here with Smart Finance Platform - Transportation. Powered by cutting-edge AI, this platform delivers access management like nev',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-finance-platform-transportation-6cc4720c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Finance Platform - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Smart Finance Platform - Transportation. Powered by cutting-edge AI, this platform delivers access management like never before.
          </p>
