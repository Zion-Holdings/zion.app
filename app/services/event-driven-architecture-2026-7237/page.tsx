...
export const metadata = {
  ...
  alternates: { canonical: '/services/event-driven-architecture-2026-7237/' },

  openGraph: {
    title: 'Event Driven Architecture | Zion Tech Group',
    description: 'End-to-end event driven architecture services: assessment, deployment, and managed operations.',
    url: 'https://ziontechgroup.com/services/event-driven-architecture-2026-7237/',
...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "Event Driven Architecture | Zion Tech Group", description: "End-to-end event driven architecture services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/event-driven-architecture-2026-7237/"}} />
