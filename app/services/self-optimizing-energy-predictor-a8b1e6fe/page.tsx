...
export const metadata: Metadata = {
  title: 'Self-Optimizing Energy Predictor',
  description: 'Revolutionize real-estate through intelligent automation. Our Self-Optimizing Energy Predictor leverages advanced machine learning to deliver performance review',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Energy Predictor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our Self-Optimizing Energy Predictor leverages advanced machine learning to deliver performance reviews at scale.
          </p>
