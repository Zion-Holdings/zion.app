...
export const metadata: Metadata = {
  title: 'Manufacturing AI - Telecom',
  description: 'The future of telecom is here with Manufacturing AI - Telecom. Powered by cutting-edge AI, this platform delivers transformative results like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/manufacturing-ai-telecom-35439f24',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manufacturing AI - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of telecom is here with Manufacturing AI - Telecom. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
