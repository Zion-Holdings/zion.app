...
export const metadata: Metadata = {
  ...
  keywords: 'Skill assessment & gap analysis, Personalized learning path generation, Auto-generated micro-lessons (5–10 min), Progress analytics & leaderboards, Integration with LMS (SCORM, xAPI), ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Personalized Learning Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Adaptive learning paths powered by AI: skill gap analysis, micro-lesson generation, progress tracking, and competency-based assessments.</p>
        ...
        <li class="text-slate-300">Skill assessment &amp; gap analysis</li>
        <li class="text-slate-300">Personalized learning path generation</li>
        <li class="text-slate-300">Auto-generated micro-lessons (5–10 min)</li>
        <li class="text-slate-300">Progress analytics &amp; leaderboards</li>
        <li class="text-slate-300">Integration with LMS (SCORM, xAPI)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai personalized learning platform</li>
