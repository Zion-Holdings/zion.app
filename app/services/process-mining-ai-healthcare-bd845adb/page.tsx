...
export const metadata: Metadata = {
  title: 'Process Mining AI - Healthcare',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Process Mining AI - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Process Mining AI - Healthcare. This autonomous system provides compliance monitoring with zero manual intervention needed.
          </p>
