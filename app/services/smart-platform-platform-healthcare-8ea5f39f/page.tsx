...
export const metadata: Metadata = {
  title: 'Smart Platform Platform - Healthcare',
  description: 'Enhance your healthcare business with Smart Platform Platform - Healthcare. Our solution provides workflow management with enterprise-grade reliability and secu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-platform-platform-healthcare-8ea5f39f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Platform Platform - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with Smart Platform Platform - Healthcare. Our solution provides workflow management with enterprise-grade reliability and security.
          </p>
