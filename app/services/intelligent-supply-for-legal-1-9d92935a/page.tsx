...
export const metadata: Metadata = {
  title: 'Intelligent Supply for Legal #1',
  description: 'Revolutionize legal through intelligent automation. Our Intelligent Supply for Legal #1 leverages advanced machine learning to deliver rpa orchestration at scal',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-supply-for-legal-1-9d92935a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Supply for Legal #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Intelligent Supply for Legal #1 leverages advanced machine learning to deliver rpa orchestration at scale.
          </p>
