...
export const metadata: Metadata = {
  title: 'Autonomous Computer Vision System - Construction',
  description: 'Transform your construction operations with our Autonomous Computer Vision System - Construction. This AI-driven solution automates inventory management with un',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-computer-vision-system-construction-2f010431',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Computer Vision System - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Autonomous Computer Vision System - Construction. This AI-driven solution automates inventory management with unprecedented accuracy and efficiency.
          </p>
