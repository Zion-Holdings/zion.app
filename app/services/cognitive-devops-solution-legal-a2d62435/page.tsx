...
export const metadata: Metadata = {
  title: 'Cognitive DevOps Solution - Legal',
  description: 'Optimize your legal workflows with Cognitive DevOps Solution - Legal. This intelligent platform delivers recommendation system through advanced automation and A',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive DevOps Solution - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with Cognitive DevOps Solution - Legal. This intelligent platform delivers recommendation system through advanced automation and AI.
          </p>
