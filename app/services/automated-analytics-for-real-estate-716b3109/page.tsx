...
export const metadata: Metadata = {
  title: 'Automated Analytics for Real-Estate',
  description: 'Drive innovation in real-estate with Automated Analytics for Real-Estate. This AI-powered platform transforms customer onboarding into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-analytics-for-real-estate-716b3109',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Analytics for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in real-estate with Automated Analytics for Real-Estate. This AI-powered platform transforms customer onboarding into a competitive advantage.
          </p>
