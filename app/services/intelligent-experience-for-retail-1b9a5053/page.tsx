...
export const metadata: Metadata = {
  title: 'Intelligent Experience for Retail',
  description: 'Revolutionize retail through intelligent automation. Our Intelligent Experience for Retail leverages advanced machine learning to deliver personalization engine',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-experience-for-retail-1b9a5053',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Experience for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize retail through intelligent automation. Our Intelligent Experience for Retail leverages advanced machine learning to deliver personalization engine at scale.
          </p>
