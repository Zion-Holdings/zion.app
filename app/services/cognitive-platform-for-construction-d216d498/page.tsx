...
export const metadata: Metadata = {
  title: 'Cognitive Platform for Construction',
  description: 'Transform your construction operations with our Cognitive Platform for Construction. This AI-driven solution automates customer insights with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-platform-for-construction-d216d498',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Platform for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Cognitive Platform for Construction. This AI-driven solution automates customer insights with unprecedented accuracy and efficiency.
          </p>
