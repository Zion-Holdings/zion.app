...
export const metadata = {
  title: "AI-Powered Event-Driven Transportation Optimization Engine - Zion Tech Group",
  description: "AI-powered optimization engine that continuously improves event-driven transportation performance through self-tuning algorithms.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-event-driven-transportation-optimization-engine-5809c11e`
  }
};
