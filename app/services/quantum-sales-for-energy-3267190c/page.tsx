...
export const metadata: Metadata = {
  title: 'Quantum Sales for Energy',
  description: 'Future-proof your energy with Quantum Sales for Energy. Our autonomous solution handles compliance reporting end-to-end without human intervention.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-sales-for-energy-3267190c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Sales for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your energy with Quantum Sales for Energy. Our autonomous solution handles compliance reporting end-to-end without human intervention.
          </p>
