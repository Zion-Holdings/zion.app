...
export const metadata: Metadata = {
  title: 'Adaptive Sales for Construction',
  description: 'The future of construction is here with Adaptive Sales for Construction. Powered by cutting-edge AI, this platform delivers market intelligence like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-sales-for-construction-569d31d2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Sales for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Adaptive Sales for Construction. Powered by cutting-edge AI, this platform delivers market intelligence like never before.
          </p>
