...
export const metadata: Metadata = {
  title: 'AI-Powered Maintenance Analytics',
  description: 'Next-generation agritech solution: AI-Powered Maintenance Analytics. Combines threat detection with adaptive intelligence for optimal results.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agritech solution: AI-Powered Maintenance Analytics. Combines threat detection with adaptive intelligence for optimal results.
          </p>
