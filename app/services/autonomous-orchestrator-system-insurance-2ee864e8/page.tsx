...
export const metadata: Metadata = {
  title: 'Autonomous Orchestrator System - Insurance',
  description: 'Drive innovation in insurance with Autonomous Orchestrator System - Insurance. This AI-powered platform transforms code optimization into a competitive advantag',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Orchestrator System - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Autonomous Orchestrator System - Insurance. This AI-powered platform transforms code optimization into a competitive advantage.
          </p>
