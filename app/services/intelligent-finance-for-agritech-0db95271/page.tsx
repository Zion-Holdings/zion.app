...
export const metadata: Metadata = {
  title: 'Intelligent Finance for Agritech',
  description: 'Next-generation agritech solution: Intelligent Finance for Agritech. Combines compliance monitoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-finance-for-agritech-0db95271',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Finance for Agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agritech solution: Intelligent Finance for Agritech. Combines compliance monitoring with adaptive intelligence for optimal results.
          </p>
