...
export const metadata = {
  ...
  description: "Revolutionize Logistics through intelligent automation. Our Automated marketing-logistics leverages advanced machine learning to deliver process automation at s",
  alternates: {
