...
export const metadata: Metadata = {
  title: 'SOAP AI Sales Lead Scoring Engine',
  description: 'AI-powered soap solution for sales. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/soap-ai-sales-lead-scoring-engine-1417b19a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            SOAP AI Sales Lead Scoring Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered soap solution for sales. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.
          </p>
