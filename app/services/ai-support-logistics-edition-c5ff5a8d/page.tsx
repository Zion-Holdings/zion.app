...
export const metadata: Metadata = {
  ...
  description: 'Transform your logistics operations with our AI Support - Logistics Edition. This AI-driven solution provides intelligent automation with unprecedented accuracy',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our AI Support - Logistics Edition. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
