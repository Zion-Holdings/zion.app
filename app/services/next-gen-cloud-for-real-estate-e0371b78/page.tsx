...
export const metadata: Metadata = {
  title: 'Next-Gen Cloud for Real-Estate',
  description: 'Optimize your real-estate workflows with Next-Gen Cloud for Real-Estate. This intelligent platform delivers logistics optimization through advanced automation a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Cloud for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your real-estate workflows with Next-Gen Cloud for Real-Estate. This intelligent platform delivers logistics optimization through advanced automation and AI.
          </p>
