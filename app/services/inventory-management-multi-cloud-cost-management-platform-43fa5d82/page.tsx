...
export const metadata: Metadata = {
  title: 'Inventory Management Multi-Cloud Cost Management Platform',
  description: 'inventory management solution for finance industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/inventory-management-multi-cloud-cost-management-platform-43fa5d82',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Inventory Management Multi-Cloud Cost Management Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            inventory management solution for finance industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.
          </p>
