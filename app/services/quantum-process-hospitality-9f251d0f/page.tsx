...
export const metadata: Metadata = {
  title: 'Quantum process-hospitality',
  description: 'The future of hospitality is here with Quantum process-hospitality. Powered by cutting-edge AI, this platform delivers background checks like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-process-hospitality-9f251d0f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum process-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Quantum process-hospitality. Powered by cutting-edge AI, this platform delivers background checks like never before.
          </p>
