...
export const metadata: Metadata = {
  title: 'Management AI/IT - Healthcare',
  description: 'Hyper-accelerated healthcare solution: Management AI/IT - Healthcare. Combines regulatory tracking with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/management-aiit-healthcare-e7bd7598',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Management AI/IT - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated healthcare solution: Management AI/IT - Healthcare. Combines regulatory tracking with next-gen AI for maximum velocity.
          </p>
