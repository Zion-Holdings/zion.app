export const metadata = {
  title: "Insights Autonomous - Tech",
  description: "Zion Tech Group delivers Insights Autonomous - Tech with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/services/insights-autonomous-tech-7a6b8973/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>Insights Autonomous - Tech</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers Insights Autonomous - Tech with measurable outcomes.
      </p>
