...
export const metadata: Metadata = {
  title: 'Automated cloud-manufacturing',
  description: 'Optimize your manufacturing workflows with Automated cloud-manufacturing. This intelligent platform delivers serverless deployment through advanced automation a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated cloud-manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your manufacturing workflows with Automated cloud-manufacturing. This intelligent platform delivers serverless deployment through advanced automation and AI.
          </p>
