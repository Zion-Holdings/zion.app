      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Edge-Deployed Models</li>
            <li className="text-purple-300">✓ Real-Time Streaming Pipelines</li>
            <li className="text-purple-300">✓ Hybrid Cloud-Edge Orchestration</li>
            <li className="text-purple-300">✓ Model Optimization & Quantization</li>
            <li className="text-purple-300">✓ Low-Latency APIs</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai edge & real-time inference</li>
