...
export const metadata: Metadata = {
  title: 'AI AI-Powered Security Auditing',
  description: 'AI-powered ai solution for security. Continuous security auditing with automated compliance reporting.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-ai-powered-security-auditing-92cafa47',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI AI-Powered Security Auditing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered ai solution for security. Continuous security auditing with automated compliance reporting.
          </p>
