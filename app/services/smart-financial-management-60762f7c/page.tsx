...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize energy through intelligent automation. Our Smart Financial Management leverages advanced machine learning to deliver maintenance scheduling at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Smart Financial Management leverages advanced machine learning to deliver maintenance scheduling at scale.
          </p>
