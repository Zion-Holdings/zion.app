...
export const metadata: Metadata = {
  ...
  keywords: 'Business impact analysis (BIA), RTO/RPO requirements mapping, DR architecture design, Runbook development and maintenance, Regular DR test execution (quarterly/annual), Test results reporting and gap remediation, Cloud, on-prem, and hybrid DR support, it, Business Continuity, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Disaster Recovery Consulting &amp; Testing</h1>
        <p className="text-lg text-slate-300 mb-8">DR strategy, design, and testing: BIA, RTO/RPO analysis, runbook development, and regular DR test execution. Prove your recovery capabilities.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">it</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">Business Continuity</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Business impact analysis (BIA)</li>
        <li class="text-slate-300">RTO/RPO requirements mapping</li>
        <li class="text-slate-300">DR architecture design</li>
        <li class="text-slate-300">Runbook development and maintenance</li>
        <li class="text-slate-300">Regular DR test execution (quarterly/annual)</li>
        <li class="text-slate-300">Test results reporting and gap remediation</li>
        <li class="text-slate-300">Cloud, on-prem, and hybrid DR support</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Know your recovery capabilities, not just plans</li>
        <li class="text-slate-300">Regular testing proves recovery works</li>
        <li class="text-slate-300">Runbooks ensure consistent execution</li>
        <li class="text-slate-300">BIA prioritizes what matters most</li>
      </ul>
        </div>
