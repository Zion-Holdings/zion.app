...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{'@context': 'https://schema.org', '@type': 'Service', 'name': 'Disaster Recovery Consulting & Testing', 'description': 'DR strategy, design, and testing: BIA, RTO/RPO analysis, runbook development, and regular DR test execution. Prove your recovery capabilities.', 'serviceType': 'it', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'Business Continuity'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'Disaster Recovery Consulting & Testing Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$4,999', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$14,999', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': 'Custom', 'priceCurrency': 'USD'}]}} }/>
    <JsonLd data={{'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'Business impact analysis (BIA)', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Business impact analysis (BIA)'}}, {'@type': 'Question', 'name': 'RTO/RPO requirements mapping', 'acceptedAnswer': {'@type': 'Answer', 'text': 'RTO/RPO requirements mapping'}}, {'@type': 'Question', 'name': 'DR architecture design', 'acceptedAnswer': {'@type': 'Answer', 'text': 'DR architecture design'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Know your recovery capabilities, not just plans; Regular testing proves recovery works; Runbooks ensure consistent execution'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} }/>
