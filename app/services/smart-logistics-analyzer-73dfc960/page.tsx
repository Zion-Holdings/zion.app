...
export const metadata: Metadata = {
  title: 'Smart Logistics Analyzer',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Logistics Analyzer
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of quantum is here with Smart Logistics Analyzer. Powered by cutting-edge AI, this platform delivers fraud prevention like never before.
          </p>
