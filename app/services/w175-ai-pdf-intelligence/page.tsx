...
export const metadata: Metadata = {
  ...
  keywords: 'Table and chart extraction from PDF, Form field and checkbox parsing, Cross-document Q&A (ask across 1000s of PDFs), Document comparison and redline generation, Handwriting recognition in scanned PDFs, Citation and reference extraction, API with async batch processing, ai, Document Management, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI PDF Intelligence Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Deep understanding of PDFs: table extraction, form field parsing, cross-document Q&amp;A, and comparison. Process legal briefs, financial reports, and research papers with 99% accuracy.</p>
        ...
        <li class="text-slate-300">Table and chart extraction from PDF</li>
        <li class="text-slate-300">Form field and checkbox parsing</li>
        <li class="text-slate-300">Cross-document Q&amp;A (ask across 1000s of PDFs)</li>
        <li class="text-slate-300">Document comparison and redline generation</li>
        <li class="text-slate-300">Handwriting recognition in scanned PDFs</li>
        <li class="text-slate-300">Citation and reference extraction</li>
        <li class="text-slate-300">API with async batch processing</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Extract structured data from any PDF format</li>
        <li class="text-slate-300">Ask questions across your entire document library</li>
        <li class="text-slate-300">Compare contract versions automatically</li>
        <li class="text-slate-300">Replace hours of manual PDF review</li>
      </ul>
        </div>
