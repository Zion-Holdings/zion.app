...
export const metadata = {
  ...
  description: "Deep understanding of PDFs: table extraction, form field parsing, cross-document Q&A, and comparison. Process legal briefs, financial reports, and research pape",
  alternates: {
