...
export const metadata: Metadata = {
  title: 'AI/IT Finance Suite - AITECH',
  description: 'Revolutionize aitech through intelligent automation. Our AI/IT Finance Suite - AITECH leverages advanced machine learning to deliver dashboard automation at sca',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-finance-suite-aitech-5b513864',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Finance Suite - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize aitech through intelligent automation. Our AI/IT Finance Suite - AITECH leverages advanced machine learning to deliver dashboard automation at scale.
          </p>
