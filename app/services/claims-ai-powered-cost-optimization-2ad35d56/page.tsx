...
export const metadata: Metadata = {
  title: 'Claims AI-Powered Cost Optimization',
  description: 'AI-powered claims solution for finops. Intelligent cloud cost optimization with recommendations and automated rightsizing.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/claims-ai-powered-cost-optimization-2ad35d56',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Claims AI-Powered Cost Optimization
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered claims solution for finops. Intelligent cloud cost optimization with recommendations and automated rightsizing.
          </p>
