...
export const metadata: Metadata = {
  title: 'Enterprise Scale-up Platform - Sports',
  description: 'Hyper-accelerated sports solution: Enterprise Scale-up Platform - Sports. Combines budget tracking with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-scale-up-platform-sports-26dbdef4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Scale-up Platform - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated sports solution: Enterprise Scale-up Platform - Sports. Combines budget tracking with next-gen AI for maximum velocity.
          </p>
