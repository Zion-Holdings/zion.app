...
export const metadata: Metadata = {
  title: 'Financial Planning AI-Powered Content Generation Platform',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Financial Planning AI-Powered Content Generation Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered financial planning solution for marketing. Generates high-quality, SEO-optimized content at scale.
          </p>
