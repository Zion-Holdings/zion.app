...
export const metadata: Metadata = {
  title: 'AI/IT Generator Suite - MARTECH',
  description: 'The future of martech is here with AI/IT Generator Suite - MARTECH. Powered by cutting-edge AI, this platform delivers process discovery like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-generator-suite-martech-275a00e3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Generator Suite - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of martech is here with AI/IT Generator Suite - MARTECH. Powered by cutting-edge AI, this platform delivers process discovery like never before.
          </p>
