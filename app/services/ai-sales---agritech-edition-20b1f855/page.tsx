...
export const metadata: Metadata = {
  title: 'AI Sales - Agritech Edition',
  description: 'Transform your agritech operations with our AI Sales - Agritech Edition. This AI-driven solution automates maintenance scheduling with unprecedented accuracy an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-sales---agritech-edition-20b1f855',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Sales - Agritech Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agritech operations with our AI Sales - Agritech Edition. This AI-driven solution automates maintenance scheduling with unprecedented accuracy and efficiency.
          </p>
