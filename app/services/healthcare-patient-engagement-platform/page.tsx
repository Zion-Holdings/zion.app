...
export const metadata = {
  ...
  description: "HIPAA-compliant patient engagement platform with appointment scheduling, reminders, telehealth, patient portal, and automated follow-ups. Improve patient satisf",
  alternates: {
