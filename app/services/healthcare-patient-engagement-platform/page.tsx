...
export const metadata: Metadata = {
  ...
  keywords: 'Online appointment scheduling, Automated SMS/email reminders, Telehealth integration, Patient portal with records access, Post-visit surveys, Prescription refill requests, Secure messaging with providers, HIPAA-compliant messaging, healthcare-it, Healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Healthcare Patient Engagement Platform</h1>
        <p className="text-lg text-slate-300 mb-8">HIPAA-compliant patient engagement platform with appointment scheduling, reminders, telehealth, patient portal, and automated follow-ups. Improve patient satisfaction and reduce no-shows by 40%.</p>
        ...
        <li class="text-slate-300">Online appointment scheduling</li>
        <li class="text-slate-300">Automated SMS/email reminders</li>
        <li class="text-slate-300">Telehealth integration</li>
        <li class="text-slate-300">Patient portal with records access</li>
        <li class="text-slate-300">Post-visit surveys</li>
        <li class="text-slate-300">Prescription refill requests</li>
        <li class="text-slate-300">Secure messaging with providers</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce no-shows by 40%</li>
        <li class="text-slate-300">Improve patient satisfaction scores</li>
        <li class="text-slate-300">Automate administrative tasks</li>
        <li class="text-slate-300">Increase patient retention</li>
      </ul>
        </div>
