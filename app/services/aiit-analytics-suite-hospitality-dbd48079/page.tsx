...
export const metadata: Metadata = {
  title: 'AI/IT Analytics Suite - Hospitality',
  description: 'Enhance your hospitality business with AI/IT Analytics Suite - Hospitality. Our solution provides cost tracking with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-analytics-suite-hospitality-dbd48079',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Analytics Suite - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with AI/IT Analytics Suite - Hospitality. Our solution provides cost tracking with enterprise-grade reliability and security.
          </p>
