...
export const metadata: Metadata = {
  ...
  description: 'Optimize your legal workflows with Generator Adaptive - Legal. This intelligent platform delivers disaster recovery through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/generator-adaptive-legal-a885cb93',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with Generator Adaptive - Legal. This intelligent platform delivers disaster recovery through advanced automation and AI.
          </p>
