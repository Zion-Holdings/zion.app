...
export const metadata: Metadata = {
  title: 'Intelligent Optimization for Transportation',
  description: 'Enhance your transportation business with Intelligent Optimization for Transportation. Our solution provides regulatory tracking with enterprise-grade reliabili',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-optimization-for-transportation-23fa8119',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Optimization for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with Intelligent Optimization for Transportation. Our solution provides regulatory tracking with enterprise-grade reliability and security.
          </p>
