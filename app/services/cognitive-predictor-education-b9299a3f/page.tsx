...
export const metadata: Metadata = {
  title: 'Cognitive predictor-education',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive predictor-education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of Education is here with Cognitive predictor-education. Powered by cutting-edge AI, this platform delivers energy management like never before.
          </p>
