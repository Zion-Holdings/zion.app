...
export const metadata: Metadata = {
  title: 'Next-Gen Optimizer for PROPTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Optimizer for PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your proptech business with Next-Gen Optimizer for PROPTECH. Our solution provides lead scoring with enterprise-grade reliability and security.
          </p>
