...
export const metadata: Metadata = {
  title: 'Machine Learning AI - Telecom',
  description: 'The future of telecom is here with Machine Learning AI - Telecom. Powered by cutting-edge AI, this platform delivers contract analysis like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/machine-learning-ai-telecom-ab72a69f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Machine Learning AI - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of telecom is here with Machine Learning AI - Telecom. Powered by cutting-edge AI, this platform delivers contract analysis like never before.
          </p>
