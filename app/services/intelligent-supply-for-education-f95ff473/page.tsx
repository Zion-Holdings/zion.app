...
export const metadata: Metadata = {
  ...
  description: 'Enhance your education business with Intelligent Supply for Education. Our solution provides hr analytics with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-supply-for-education-f95ff473',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your education business with Intelligent Supply for Education. Our solution provides hr analytics with enterprise-grade reliability and security.
          </p>
