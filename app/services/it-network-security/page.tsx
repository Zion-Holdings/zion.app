...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'IT Network Security & Firewall Management', 'description': 'Comprehensive network security with next-gen firewall management, intrusion detection/prevention, and network access control. 24/7 monitoring and management.', 'serviceType': 'security', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'technology'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'IT Network Security & Firewall Management Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$2,000/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$5,000/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': 'Custom', 'priceCurrency': 'USD'}]}} />
    <JsonLd data={'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'Next-gen firewall deployment and management', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Next-gen firewall deployment and management'}}, {'@type': 'Question', 'name': 'IDS/IPS configuration and tuning', 'acceptedAnswer': {'@type': 'Answer', 'text': 'IDS/IPS configuration and tuning'}}, {'@type': 'Question', 'name': 'Network access control (NAC)', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Network access control (NAC)'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Block advanced threats with AI-powered firewalls; Detect intrusions in real-time; Secure remote access for all employees'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} />
