...
export const metadata: Metadata = {
  title: 'Next-Gen Performance - Startup',
  description: 'Revolutionize startup through intelligent automation. Our Next-Gen Performance - Startup leverages advanced machine learning to deliver sales forecasting at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Performance - Startup
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize startup through intelligent automation. Our Next-Gen Performance - Startup leverages advanced machine learning to deliver sales forecasting at scale.
          </p>
