...
export const metadata: Metadata = {
  title: 'Process Mining Automated - Retail',
  description: 'Revolutionize retail through intelligent automation. Our Process Mining Automated - Retail leverages advanced machine learning to deliver budget tracking at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Process Mining Automated - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize retail through intelligent automation. Our Process Mining Automated - Retail leverages advanced machine learning to deliver budget tracking at scale.
          </p>
