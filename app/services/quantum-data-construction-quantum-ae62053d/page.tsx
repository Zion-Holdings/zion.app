...
export const metadata: Metadata = {
  title: 'Quantum Data - Construction Quantum',
  description: 'Revolutionize construction through intelligent automation. Our Quantum Data - Construction Quantum leverages advanced machine learning to deliver sales process ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Data - Construction Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Quantum Data - Construction Quantum leverages advanced machine learning to deliver sales process optimization at scale.
          </p>
