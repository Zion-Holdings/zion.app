...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize hospitality through intelligent automation. Our Cognitive Cloud Solution - Hospitality leverages advanced machine learning to deliver hr analytics',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-cloud-solution-hospitality-7ede4b80',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Cognitive Cloud Solution - Hospitality leverages advanced machine learning to deliver hr analytics at scale.
          </p>
