...
export const metadata: Metadata = {
  title: 'Automated Sentiment Smart',
  description: 'Transform your education operations with our Automated Sentiment Smart. This AI-driven solution provides intelligent automation with unprecedented accuracy and ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Sentiment Smart
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your education operations with our Automated Sentiment Smart. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
