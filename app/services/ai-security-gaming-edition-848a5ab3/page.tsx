...
export const metadata: Metadata = {
  title: 'AI Security - Gaming Edition',
  description: 'Drive innovation in gaming with AI Security - Gaming Edition. This AI-powered platform transforms maintenance scheduling into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-security-gaming-edition-848a5ab3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Security - Gaming Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in gaming with AI Security - Gaming Edition. This AI-powered platform transforms maintenance scheduling into a competitive advantage.
          </p>
