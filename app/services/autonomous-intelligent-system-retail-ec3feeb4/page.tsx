...
export const metadata: Metadata = {
  title: 'Autonomous Intelligent System - Retail',
  description: 'Unlock unprecedented growth with Autonomous Intelligent System - Retail. This autonomous system provides ml model training with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-intelligent-system-retail-ec3feeb4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Intelligent System - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Autonomous Intelligent System - Retail. This autonomous system provides ml model training with zero manual intervention needed.
          </p>
