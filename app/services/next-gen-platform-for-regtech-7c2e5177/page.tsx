...
export const metadata: Metadata = {
  title: 'Next-Gen Platform for REGTECH',
  description: 'The future of regtech is here with Next-Gen Platform for REGTECH. Powered by cutting-edge AI, this platform delivers manufacturing quality control like never be',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-platform-for-regtech-7c2e5177',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Platform for REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of regtech is here with Next-Gen Platform for REGTECH. Powered by cutting-edge AI, this platform delivers manufacturing quality control like never before.
          </p>
