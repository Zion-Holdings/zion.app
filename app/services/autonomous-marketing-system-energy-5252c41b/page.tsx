...
export const metadata: Metadata = {
  title: 'Autonomous Marketing System - Energy',
  description: 'Enhance your energy business with Autonomous Marketing System - Energy. Our solution provides customer service automation with enterprise-grade reliability and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-marketing-system-energy-5252c41b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Marketing System - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your energy business with Autonomous Marketing System - Energy. Our solution provides customer service automation with enterprise-grade reliability and security.
          </p>
