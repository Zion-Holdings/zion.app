...
export const metadata: Metadata = {
  title: 'Cognitive Decision Solution - Insurance',
  description: 'Quantum leap forward for insurance: Cognitive Decision Solution - Insurance. Uses quantum-inspired algorithms to deliver container orchestration at exponential ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-decision-solution-insurance-05d78402',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Decision Solution - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for insurance: Cognitive Decision Solution - Insurance. Uses quantum-inspired algorithms to deliver container orchestration at exponential speed.
          </p>
