...
export const metadata: Metadata = {
  title: 'AI Customer Churn Prediction - Healthcare Edition',
  description: 'Identifies at-risk customers before they churn using behavioral patterns and engagement metrics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/svc-ee44966cb2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Customer Churn Prediction - Healthcare Edition
          </h1>
