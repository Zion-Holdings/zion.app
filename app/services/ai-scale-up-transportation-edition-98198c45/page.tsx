...
export const metadata: Metadata = {
  title: 'AI Scale-up - Transportation Edition',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Scale-up - Transportation Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation transportation solution: AI Scale-up - Transportation Edition. Combines quantum computing with adaptive intelligence for optimal results.
          </p>
