...
export const metadata: Metadata = {
  title: "AI-Powered Content Generation Platform - AI-Powered Marketing Solution",
  description: "Generates high-quality, SEO-optimized content at scale.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-content-generation-platform-f88ebc01",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Content Generation Platform - AI-Powered Marketing Solution
        </h1>
