...
export const metadata: Metadata = {
  title: 'Neural Language Healthcare',
  description: 'Revolutionize telecom through intelligent automation. Our Neural Language Healthcare leverages advanced machine learning to deliver financial risk management at',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Language Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Neural Language Healthcare leverages advanced machine learning to deliver financial risk management at scale.
          </p>
