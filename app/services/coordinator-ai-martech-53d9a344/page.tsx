...
export const metadata: Metadata = {
  title: 'Coordinator AI - MARTECH',
  description: 'Revolutionize martech through intelligent automation. Our Coordinator AI - MARTECH leverages advanced machine learning to deliver data fabric at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/coordinator-ai-martech-53d9a344',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Coordinator AI - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize martech through intelligent automation. Our Coordinator AI - MARTECH leverages advanced machine learning to deliver data fabric at scale.
          </p>
