...
export const metadata: Metadata = {
  title: 'Real Estate Intelligent - Construction',
  description: 'Transform your construction operations with our Real Estate Intelligent - Construction. This AI-driven solution provides intelligent automation with unprecedent',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/real-estate-intelligent-construction-4add54db',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Real Estate Intelligent - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Real Estate Intelligent - Construction. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
