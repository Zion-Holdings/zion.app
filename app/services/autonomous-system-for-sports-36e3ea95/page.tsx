...
export const metadata: Metadata = {
  title: 'Autonomous System for Sports',
  description: 'Unlock unprecedented growth with Autonomous System for Sports. This autonomous system provides image recognition with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-system-for-sports-36e3ea95',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous System for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Autonomous System for Sports. This autonomous system provides image recognition with zero manual intervention needed.
          </p>
