...
export const metadata: Metadata = {
  title: 'Intelligent Experience for Manufacturing',
  description: 'Next-generation manufacturing solution: Intelligent Experience for Manufacturing. Combines cost reduction with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-experience-for-manufacturing-728ff17d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Experience for Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation manufacturing solution: Intelligent Experience for Manufacturing. Combines cost reduction with adaptive intelligence for optimal results.
          </p>
