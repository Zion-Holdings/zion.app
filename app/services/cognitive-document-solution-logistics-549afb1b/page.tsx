...
export const metadata: Metadata = {
  title: 'Cognitive Document Solution - Logistics',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Document Solution - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated logistics solution: Cognitive Document Solution - Logistics. Combines recruitment automation with next-gen AI for maximum velocity.
          </p>
