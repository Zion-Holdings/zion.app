...
export const metadata: Metadata = {
  title: 'Enterprise Document Platform - HEALTHTECH',
  description: 'Drive innovation in healthtech with Enterprise Document Platform - HEALTHTECH. This AI-powered platform transforms recommendation system into a competitive adva',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-document-platform-healthtech-d61c7002',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Document Platform - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthtech with Enterprise Document Platform - HEALTHTECH. This AI-powered platform transforms recommendation system into a competitive advantage.
          </p>
