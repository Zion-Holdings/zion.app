...
export const metadata: Metadata = {
  title: 'Automated intelligence-regtech',
  description: 'Enhance your regtech business with Automated intelligence-regtech. Our solution provides manufacturing quality control with enterprise-grade reliability and sec',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-intelligence-regtech-8da2b9f4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated intelligence-regtech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your regtech business with Automated intelligence-regtech. Our solution provides manufacturing quality control with enterprise-grade reliability and security.
          </p>
