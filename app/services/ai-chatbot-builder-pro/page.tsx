...
export const metadata: Metadata = {
  ...
  keywords: 'RAG-powered knowledge base from your docs, Multi-channel — website, WhatsApp, Slack, Teams, Visual drag-and-drop flow designer, Smart human handoff with context transfer, Analytics — resolution rates, satisfaction, trends, Continuous learning from unanswered questions, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Chatbot Builder Pro</h1>
        <p className="text-lg text-slate-300 mb-8">Build intelligent, multi-channel chatbots with RAG-powered knowledge bases, workflow automation, and seamless human handoff.</p>
        ...
        <li class="text-slate-300">RAG-powered knowledge base from your docs</li>
        <li class="text-slate-300">Multi-channel — website, WhatsApp, Slack, Teams</li>
        <li class="text-slate-300">Visual drag-and-drop flow designer</li>
        <li class="text-slate-300">Smart human handoff with context transfer</li>
        <li class="text-slate-300">Analytics — resolution rates, satisfaction, trends</li>
        <li class="text-slate-300">Continuous learning from unanswered questions</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai chatbot builder pro</li>
