      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Build intelligent, multi-channel chatbots with RAG-powered knowledge bases, workflow automation, and seamless human handoff.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ RAG-powered knowledge base from your docs</li>
            <li className="text-purple-300">✓ Multi-channel — website, WhatsApp, Slack, Teams</li>
            <li className="text-purple-300">✓ Visual drag-and-drop flow designer</li>
            <li className="text-purple-300">✓ Smart human handoff with context transfer</li>
            <li className="text-purple-300">✓ Analytics — resolution rates, satisfaction, trends</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai chatbot builder pro</li>
