...
export const metadata = {
  title: "Autonomous Enterprise-Grade Blockchain Management System - Zion Tech Group",
  description: "Autonomous management system that self-optimizes enterprise-grade blockchain processes with minimal human intervention.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/autonomous-enterprise-grade-blockchain-management-system-2fff23d5`
  }
};
