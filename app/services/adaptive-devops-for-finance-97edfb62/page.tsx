...
export const metadata: Metadata = {
  title: 'Adaptive DevOps for Finance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive DevOps for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our Adaptive DevOps for Finance leverages advanced machine learning to deliver image recognition at scale.
          </p>
