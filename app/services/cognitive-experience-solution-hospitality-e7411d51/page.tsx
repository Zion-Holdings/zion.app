  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Cognitive Experience Solution - Hospitality</h1>
        <p className="text-lg text-gray-300 mb-8">Enhance your hospitality business with Cognitive Experience Solution - Hospitality. Our solution provides performance monitoring with enterprise-grade reliability and security.</p>
