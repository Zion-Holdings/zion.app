...
export const metadata: Metadata = {
  ...
  description: 'Engages patients with personalized health recommendations and reminders.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-patient-engagement-platform2026-07-28t0359244256640000133-a96b48e2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Engages patients with personalized health recommendations and reminders.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Reminders</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">40% better engagement</li>
