...
export const metadata: Metadata = {
  title: 'Adaptive Scheduler Module',
  description: 'Transform your education operations with our Adaptive Scheduler Module. This security solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-scheduler-module-68f72',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your education operations with our Adaptive Scheduler Module. This security solution delivers unprecedented automation and intelligence.
          </p>
