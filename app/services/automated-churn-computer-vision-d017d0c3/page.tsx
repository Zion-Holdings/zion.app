...
export const metadata: Metadata = {
  title: 'Automated Churn Computer Vision',
  description: 'Enhance your legal business with Automated Churn Computer Vision. Our solution provides ml model training with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-churn-computer-vision-d017d0c3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Churn Computer Vision
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Automated Churn Computer Vision. Our solution provides ml model training with enterprise-grade reliability and security.
          </p>
