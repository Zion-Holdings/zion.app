...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time transaction monitoring, Suspicious activity detection (AI), Customer due diligence (CDD/EDD), Sanctions screening, SAR filing automation, Risk scoring models, Regulatory reporting, Audit trail and documentation, fintech, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Anti-Money Laundering (AML) Compliance Platform</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered AML compliance with transaction monitoring, suspicious activity detection, customer due diligence, and regulatory reporting. Meet FinCEN, FATF, and BSA requirements.</p>
        ...
        <li class="text-slate-300">Real-time transaction monitoring</li>
        <li class="text-slate-300">Suspicious activity detection (AI)</li>
        <li class="text-slate-300">Customer due diligence (CDD/EDD)</li>
        <li class="text-slate-300">Sanctions screening</li>
        <li class="text-slate-300">SAR filing automation</li>
        <li class="text-slate-300">Risk scoring models</li>
        <li class="text-slate-300">Regulatory reporting</li>
        <li class="text-slate-300">Audit trail and documentation</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce false positives by 60%</li>
        <li class="text-slate-300">Automate compliance reporting</li>
        <li class="text-slate-300">Meet regulatory requirements</li>
        <li class="text-slate-300">Reduce compliance costs</li>
      </ul>
        </div>
