...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'Micro-SaaS AI Warranty & Asset Tracker', 'description': 'Track warranties, service contracts, and asset maintenance schedules with AI-powered reminders and predictive maintenance alerts. Never miss a warranty claim again.', 'serviceType': 'micro-saas', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'operations'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'Micro-SaaS AI Warranty & Asset Tracker Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$39/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$99/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': 'Custom', 'priceCurrency': 'USD'}]}} />
    <JsonLd data={'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'Warranty registration and tracking', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Warranty registration and tracking'}}, {'@type': 'Question', 'name': 'AI predictive maintenance alerts', 'acceptedAnswer': {'@type': 'Answer', 'text': 'AI predictive maintenance alerts'}}, {'@type': 'Question', 'name': 'Service contract management', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Service contract management'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Recover 15% more warranty claims; Avoid unexpected equipment failures; Optimize maintenance schedules'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} />
