...
export const metadata = {
  ...
  description: "Track warranties, service contracts, and asset maintenance schedules with AI-powered reminders and predictive maintenance alerts. Never miss a warranty claim ag",
  alternates: {
