...
export const metadata: Metadata = {
  title: 'Intelligent Process Mining for Real-Estate',
  description: 'Drive innovation in real-estate with Intelligent Process Mining for Real-Estate. This AI-powered platform transforms testing automation into a competitive advan',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-process-mining-for-real-estate-6d36b38c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Process Mining for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in real-estate with Intelligent Process Mining for Real-Estate. This AI-powered platform transforms testing automation into a competitive advantage.
          </p>
