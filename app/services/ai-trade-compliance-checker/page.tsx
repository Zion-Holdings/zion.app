...
export const metadata = {
  ...
  description: "Screen every transaction for sanctions, export controls, and denied-party lists (OFAC, EU, UN). Real-time screening, false-positive reduction, and audit-ready r",
  alternates: {
