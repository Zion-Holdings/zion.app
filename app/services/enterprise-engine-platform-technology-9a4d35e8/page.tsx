...
export const metadata: Metadata = {
  title: 'Enterprise Engine Platform - TECHNOLOGY',
  description: 'Quantum leap forward for technology: Enterprise Engine Platform - TECHNOLOGY. Uses quantum-inspired algorithms to deliver business continuity at exponential spe',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-engine-platform-technology-9a4d35e8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Engine Platform - TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for technology: Enterprise Engine Platform - TECHNOLOGY. Uses quantum-inspired algorithms to deliver business continuity at exponential speed.
          </p>
