...
export const metadata: Metadata = {
  title: 'Autonomous Security for Proptech',
  description: 'The future of proptech is here with Autonomous Security for Proptech. Powered by cutting-edge AI, this platform delivers manufacturing quality control like neve',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Security for Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with Autonomous Security for Proptech. Powered by cutting-edge AI, this platform delivers manufacturing quality control like never before.
          </p>
