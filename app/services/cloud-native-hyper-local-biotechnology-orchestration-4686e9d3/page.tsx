...
export const metadata = {
  title: "Cloud-Native Hyper-Local Biotechnology Orchestration - Zion Tech Group",
  description: "Cloud-native orchestration platform that manages hyper-local biotechnology resources with auto-scaling and cost control.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/cloud-native-hyper-local-biotechnology-orchestration-4686e9d3`
  }
};
