...
export const metadata: Metadata = {
  ...
  description: 'Automates expense reporting, categorization, and reimbursement.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-expense-management2026-07-28t0351435039820000188-72e9ab64',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automates expense reporting, categorization, and reimbursement.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Expense categorization</li>
          <li className="text-gray-300">Policy enforcement</li>
          <li className="text-gray-300">Reimbursement automation</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">60% time savings</li>
