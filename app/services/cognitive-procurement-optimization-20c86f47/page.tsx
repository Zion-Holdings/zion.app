...
export const metadata: Metadata = {
  title: 'Cognitive Procurement Optimization',
  description: 'Unlock unprecedented growth with Cognitive Procurement Optimization. This autonomous system provides capacity management with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-procurement-optimization-20c86f47',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Procurement Optimization
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Cognitive Procurement Optimization. This autonomous system provides capacity management with zero manual intervention needed.
          </p>
