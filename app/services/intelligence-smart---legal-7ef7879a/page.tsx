...
export const metadata: Metadata = {
  ...
  keywords: 'Custom integrations, Performance dashboards, Data encryption, Serverless functions, orchestrator, legal, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Intelligence Smart - Legal</h1>
        <p className="text-lg text-slate-300 mb-8">Revolutionize legal through intelligent automation. Our Intelligence Smart - Legal leverages advanced machine learning to deliver risk assessment at scale.</p>
