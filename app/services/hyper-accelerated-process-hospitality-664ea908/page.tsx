...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Process - Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Hyper-Accelerated Process - Hospitality leverages advanced machine learning to deliver document ai',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/hyper-accelerated-process-hospitality-664ea908',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Process - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Hyper-Accelerated Process - Hospitality leverages advanced machine learning to deliver document ai at scale.
          </p>
