...
export const metadata: Metadata = {
  title: 'Advanced Process Automation Redis (Analytics)',
  description: 'Advanced Process Automation Redis (Analytics) is an AI-powered analytics solution that transforms how businesses operate through intelligent automation and real',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Advanced Process Automation Redis (Analytics)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Advanced Process Automation Redis (Analytics) is an AI-powered analytics solution that transforms how businesses operate through intelligent automation and real-time analytics.
