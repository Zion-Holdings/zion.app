...
export const metadata: Metadata = {
  title: 'Predictive Intelligence Engine - Construction',
  description: 'Optimize your construction workflows with Predictive Intelligence Engine - Construction. This intelligent platform delivers churn prediction through advanced au',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Intelligence Engine - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Predictive Intelligence Engine - Construction. This intelligent platform delivers churn prediction through advanced automation and AI.
          </p>
