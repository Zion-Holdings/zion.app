...
export const metadata: Metadata = {
  ...
  keywords: 'MLflow experiment tracking + model registry, Managed feature store (Feast) auto-provisioned, KServe/Seldon batch + real-time inference, Model CI/CD per training run + gate before prod, GPU scheduling per experiment, no queue, data, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Data Science Platform (Managed)</h1>
        <p className="text-lg text-slate-300 mb-8">Managed data science on Kubernetes: MLflow tracking, model registry, managed feature store, KServe/Seldon inference, model CI/CD, GPU scheduling. Batch + real-time inference.</p>
        ...
        <li class="text-slate-300">MLflow experiment tracking + model registry</li>
        <li class="text-slate-300">Managed feature store (Feast) auto-provisioned</li>
        <li class="text-slate-300">KServe/Seldon batch + real-time inference</li>
        <li class="text-slate-300">Model CI/CD per training run + gate before prod</li>
        <li class="text-slate-300">GPU scheduling per experiment, no queue</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with data science platform (managed)</li>
