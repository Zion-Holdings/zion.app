...
export const metadata: Metadata = {
  title: 'Enterprise Strategic Platform - Cybersecurity',
  description: 'Drive innovation in cybersecurity with Enterprise Strategic Platform - Cybersecurity. This AI-powered platform transforms energy management into a competitive a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-strategic-platform-cybersecurity-c6856a0e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Strategic Platform - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in cybersecurity with Enterprise Strategic Platform - Cybersecurity. This AI-powered platform transforms energy management into a competitive advantage.
          </p>
