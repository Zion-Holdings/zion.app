...
export const metadata: Metadata = {
  title: 'Customer Intelligent - ALTHEALTH',
  description: 'Transform your althealth operations with our Customer Intelligent - ALTHEALTH. This AI-driven solution automates receipt processing with unprecedented accuracy ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/customer-intelligent-althealth-28858d3f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Customer Intelligent - ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your althealth operations with our Customer Intelligent - ALTHEALTH. This AI-driven solution automates receipt processing with unprecedented accuracy and efficiency.
          </p>
