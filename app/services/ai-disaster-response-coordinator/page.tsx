...
export const metadata: Metadata = {
  ...
  description: "Coordinate emergency response across agencies: resource allocation optimization, evacuation routing, satellite/drone damage assessment, real-time situational aw",
  alternates: {
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        ...
        <p className="text-xl text-slate-300 mb-8">
          Coordinate emergency response across agencies: resource allocation optimization, evacuation routing, satellite/drone damage assessment, real-time situational aw
        </p>
