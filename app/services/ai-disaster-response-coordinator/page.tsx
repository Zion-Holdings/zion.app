...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-agency coordination dashboard, Resource allocation optimization, Satellite/drone damage assessment, Evacuation route planning, Real-time resource tracking, Post-disaster damage reporting, ai, Government, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Disaster Response &amp; Coordination Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Coordinate emergency response across agencies: resource allocation optimization, evacuation routing, damage assessment from satellite/drone, and real-time situational awareness.</p>
        ...
        <li class="text-slate-300">Multi-agency coordination dashboard</li>
        <li class="text-slate-300">Resource allocation optimization</li>
        <li class="text-slate-300">Satellite/drone damage assessment</li>
        <li class="text-slate-300">Evacuation route planning</li>
        <li class="text-slate-300">Real-time resource tracking</li>
        <li class="text-slate-300">Post-disaster damage reporting</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Coordinate 10x faster</li>
        <li class="text-slate-300">Optimize resource deployment</li>
        <li class="text-slate-300">Save more lives</li>
      </ul>
        </div>
