...
export const metadata: Metadata = {
  title: 'Cognitive Smart Solution - Transportation',
  description: 'Optimize your transportation workflows with Cognitive Smart Solution - Transportation. This intelligent platform delivers case management through advanced autom',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-smart-solution-transportation-300d3664',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Smart Solution - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Cognitive Smart Solution - Transportation. This intelligent platform delivers case management through advanced automation and AI.
          </p>
