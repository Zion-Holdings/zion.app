...
export const metadata: Metadata = {
  title: 'Intelligent Security for Healthcare',
  description: 'Drive innovation in healthcare with Intelligent Security for Healthcare. This AI-powered platform transforms ml model training into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-security-for-healthcare-8c76c8b4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Security for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with Intelligent Security for Healthcare. This AI-powered platform transforms ml model training into a competitive advantage.
          </p>
