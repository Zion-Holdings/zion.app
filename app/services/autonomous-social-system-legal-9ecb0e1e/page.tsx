...
export const metadata: Metadata = {
  title: 'Autonomous Social System - Legal',
  description: 'Drive innovation in legal with Autonomous Social System - Legal. This AI-powered platform transforms social media monitoring into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-social-system-legal-9ecb0e1e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Social System - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Autonomous Social System - Legal. This AI-powered platform transforms social media monitoring into a competitive advantage.
          </p>
