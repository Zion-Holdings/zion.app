...
export const metadata: Metadata = {
  title: 'Smart performance-hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Smart performance-hospitality leverages advanced machine learning to deliver budget management at ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-performance-hospitality-9129db55',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart performance-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Smart performance-hospitality leverages advanced machine learning to deliver budget management at scale.
          </p>
