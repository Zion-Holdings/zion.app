...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "API Gateway Management | Zion Tech Group", description: "End-to-end api gateway management services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/api-gateway-management-2026-6552/"}} />
