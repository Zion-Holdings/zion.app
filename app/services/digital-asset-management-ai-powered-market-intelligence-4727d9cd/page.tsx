...
export const metadata: Metadata = {
  title: 'Digital Asset Management AI-Powered Market Intelligence',
  description: 'digital asset management solution for disaster preparedness industry. Monitors market trends, competitor activities, and industry news to provide actionable ins',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/digital-asset-management-ai-powered-market-intelligence-4727d9cd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Digital Asset Management AI-Powered Market Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            digital asset management solution for disaster preparedness industry. Monitors market trends, competitor activities, and industry news to provide actionable insights.
          </p>
