...
export const metadata: Metadata = {
  title: 'Autonomous Healthcare Coordinator',
  description: 'Transform your retail operations with our Autonomous Healthcare Coordinator. This AI-driven solution automates threat detection with unprecedented accuracy and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-healthcare-coordinator-4f23b2d2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Healthcare Coordinator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our Autonomous Healthcare Coordinator. This AI-driven solution automates threat detection with unprecedented accuracy and efficiency.
          </p>
