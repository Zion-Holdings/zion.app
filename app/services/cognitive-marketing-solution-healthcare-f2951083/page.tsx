...
export const metadata: Metadata = {
  title: 'Cognitive Marketing Solution - Healthcare',
  description: 'Optimize your healthcare workflows with Cognitive Marketing Solution - Healthcare. This intelligent platform delivers data pipeline orchestration through advanc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-marketing-solution-healthcare-f2951083',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Marketing Solution - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Cognitive Marketing Solution - Healthcare. This intelligent platform delivers data pipeline orchestration through advanced automation and AI.
          </p>
