...
export const metadata: Metadata = {
  title: 'Cognitive Security Solution - Hospitality #3',
  description: 'Optimize your hospitality workflows with Cognitive Security Solution - Hospitality #3. This intelligent platform delivers supply chain through advanced automati',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Security Solution - Hospitality #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Cognitive Security Solution - Hospitality #3. This intelligent platform delivers supply chain through advanced automation and AI.
          </p>
