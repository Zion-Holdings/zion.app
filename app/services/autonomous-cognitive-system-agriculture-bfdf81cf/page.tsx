...
export const metadata: Metadata = {
  title: 'Autonomous Cognitive System - Agriculture',
  description: 'Drive innovation in agriculture with Autonomous Cognitive System - Agriculture. This AI-powered platform transforms recruitment automation into a competitive ad',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-cognitive-system-agriculture-bfdf81cf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Cognitive System - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in agriculture with Autonomous Cognitive System - Agriculture. This AI-powered platform transforms recruitment automation into a competitive advantage.
          </p>
