...
export const metadata: Metadata = {
  ...
  keywords: 'NIST CSF maturity assessment, CMMC and CIS Controls gap analysis, Current state evaluation (people, process, tech), Risk-prioritized roadmap, Build vs buy analysis with TCO, Quick wins identification, Executive and board-ready findings, security, Cybersecurity, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Security Operations Maturity Assessment</h1>
        <p className="text-lg text-slate-300 mb-8">Assess and roadmap your security operations maturity. Gap analysis against NIST CSF, CMMC, and CIS Controls. Build vs buy recommendations with 3-year TCO.</p>
        ...
        <li class="text-slate-300">NIST CSF maturity assessment</li>
        <li class="text-slate-300">CMMC and CIS Controls gap analysis</li>
        <li class="text-slate-300">Current state evaluation (people, process, tech)</li>
        <li class="text-slate-300">Risk-prioritized roadmap</li>
        <li class="text-slate-300">Build vs buy analysis with TCO</li>
        <li class="text-slate-300">Quick wins identification</li>
        <li class="text-slate-300">Executive and board-ready findings</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Know where you stand vs industry frameworks</li>
        <li class="text-slate-300">Prioritized roadmap maximizes risk reduction per dollar</li>
        <li class="text-slate-300">Build vs buy saves 30-50% vs wrong choices</li>
        <li class="text-slate-300">Quick wins deliver value immediately</li>
      </ul>
        </div>
