...
export const metadata: Metadata = {
  title: 'Cognitive orchestrator-media',
  description: 'Enhance your media business with Cognitive orchestrator-media. Our solution provides procurement automation with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-orchestrator-media-495a237e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive orchestrator-media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your media business with Cognitive orchestrator-media. Our solution provides procurement automation with enterprise-grade reliability and security.
          </p>
