...
export const metadata: Metadata = {
  title: 'Smart Security Platform - Automotive',
  description: 'Enhance your automotive business with Smart Security Platform - Automotive. Our solution provides budget tracking with enterprise-grade reliability and security',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-security-platform-automotive-1242e11e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Security Platform - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your automotive business with Smart Security Platform - Automotive. Our solution provides budget tracking with enterprise-grade reliability and security.
          </p>
