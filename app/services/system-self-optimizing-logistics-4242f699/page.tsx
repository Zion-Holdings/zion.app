...
export const metadata: Metadata = {
  title: 'System Self-Optimizing - Logistics',
  description: 'Revolutionize logistics through intelligent automation. Our System Self-Optimizing - Logistics leverages advanced machine learning to deliver enterprise-grade i',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/system-self-optimizing-logistics-4242f699',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            System Self-Optimizing - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our System Self-Optimizing - Logistics leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
