...
export const metadata: Metadata = {
  title: 'Autonomous Insights System - Sports',
  description: 'Transform your sports operations with our Autonomous Insights System - Sports. This AI-driven solution automates forecast accuracy with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-insights-system-sports-ac99c204',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Insights System - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our Autonomous Insights System - Sports. This AI-driven solution automates forecast accuracy with unprecedented accuracy and efficiency.
          </p>
