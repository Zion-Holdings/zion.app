...
export const metadata: Metadata = {
  ...
  description: 'Next-generation logistics solution: Smart Platform Platform - Logistics. Combines brand sentiment with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-platform-platform-logistics-d13a1bba',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Smart Platform Platform - Logistics. Combines brand sentiment with adaptive intelligence for optimal results.
          </p>
