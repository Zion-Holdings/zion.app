...
export const metadata: Metadata = {
  title: 'Accounts Receivable Cloud-Native Security Posture Manager',
  description: 'AI-powered accounts receivable solution for security. Automated security compliance and threat detection across cloud environments.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/accounts-receivable-cloud-native-security-posture-manager-700b12a1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Accounts Receivable Cloud-Native Security Posture Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered accounts receivable solution for security. Automated security compliance and threat detection across cloud environments.
          </p>
