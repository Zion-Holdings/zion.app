...
export const metadata: Metadata = {
  ...
  keywords: 'Policy management and distribution, Risk assessment automation, Control testing and evidence collection, Regulatory reporting (SOX, GDPR, HIPAA), Integration with ServiceNow, SAP, Audit workflow management, Risk heat maps, Board reporting dashboards, automation, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">GRC Automation Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Automate governance, risk, and compliance. Policy management, risk assessment, control testing, and regulatory reporting in a single platform.</p>
        ...
        <li class="text-slate-300">Policy management and distribution</li>
        <li class="text-slate-300">Risk assessment automation</li>
        <li class="text-slate-300">Control testing and evidence collection</li>
        <li class="text-slate-300">Regulatory reporting (SOX, GDPR, HIPAA)</li>
        <li class="text-slate-300">Integration with ServiceNow, SAP</li>
        <li class="text-slate-300">Audit workflow management</li>
        <li class="text-slate-300">Risk heat maps</li>
        <li class="text-slate-300">Board reporting dashboards</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce compliance costs by 50%</li>
        <li class="text-slate-300">Automate audit preparation</li>
        <li class="text-slate-300">Real-time risk visibility</li>
        <li class="text-slate-300">Meet regulatory deadlines</li>
      </ul>
        </div>
