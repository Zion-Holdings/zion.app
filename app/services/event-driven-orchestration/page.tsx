...
export const metadata: Metadata = {
  ...
  keywords: 'Visual DAG designer, Durable execution, Automatic retries & DLQ, Saga pattern support, Webhook triggers, automation, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Event-Driven Orchestration</h1>
        <p className="text-lg text-slate-300 mb-8">Serverless workflow engine with durable execution, retries, and visual DAG designer for complex multi-service business processes.</p>
        ...
        <li class="text-slate-300">Visual DAG designer</li>
        <li class="text-slate-300">Durable execution</li>
        <li class="text-slate-300">Automatic retries &amp; DLQ</li>
        <li class="text-slate-300">Saga pattern support</li>
        <li class="text-slate-300">Webhook triggers</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with event-driven orchestration</li>
