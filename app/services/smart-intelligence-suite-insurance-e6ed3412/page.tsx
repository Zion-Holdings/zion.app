...
export const metadata: Metadata = {
  title: 'Smart Intelligence Suite - Insurance',
  description: 'Optimize your insurance workflows with Smart Intelligence Suite - Insurance. This intelligent platform delivers user provisioning through advanced automation an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Intelligence Suite - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Smart Intelligence Suite - Insurance. This intelligent platform delivers user provisioning through advanced automation and AI.
          </p>
