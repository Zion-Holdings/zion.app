...
export const metadata: Metadata = {
  title: 'Smart Risk Platform - Automotive',
  description: 'Drive innovation in automotive with Smart Risk Platform - Automotive. This AI-powered platform transforms energy management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-risk-platform-automotive-b3ac3ff1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Risk Platform - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in automotive with Smart Risk Platform - Automotive. This AI-powered platform transforms energy management into a competitive advantage.
          </p>
