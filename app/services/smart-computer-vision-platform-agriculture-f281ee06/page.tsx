...
export const metadata: Metadata = {
  title: 'Smart Computer Vision Platform - Agriculture',
  description: 'Transform your agriculture operations with our Smart Computer Vision Platform - Agriculture. This AI-driven solution automates scenario planning with unpreceden',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-computer-vision-platform-agriculture-f281ee06',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Computer Vision Platform - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Smart Computer Vision Platform - Agriculture. This AI-driven solution automates scenario planning with unprecedented accuracy and efficiency.
          </p>
