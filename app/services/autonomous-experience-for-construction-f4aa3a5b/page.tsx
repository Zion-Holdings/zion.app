...
export const metadata: Metadata = {
  title: 'Autonomous Experience for Construction',
  description: 'Revolutionize construction through intelligent automation. Our Autonomous Experience for Construction leverages advanced machine learning to deliver customer in',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-experience-for-construction-f4aa3a5b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Experience for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Autonomous Experience for Construction leverages advanced machine learning to deliver customer insights at scale.
          </p>
