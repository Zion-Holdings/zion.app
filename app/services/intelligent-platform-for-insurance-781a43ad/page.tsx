export const metadata = {
  title: "Intelligent Platform for Insurance",
  description: "Zion Tech Group delivers Intelligent Platform for Insurance with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/services/intelligent-platform-for-insurance-781a43ad/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>Intelligent Platform for Insurance</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers Intelligent Platform for Insurance with measurable outcomes.
      </p>
