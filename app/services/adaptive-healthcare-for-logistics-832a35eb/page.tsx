...
export const metadata: Metadata = {
  title: 'Adaptive Healthcare for Logistics',
  description: 'Enhance your logistics business with Adaptive Healthcare for Logistics. Our solution provides user provisioning with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-healthcare-for-logistics-832a35eb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Healthcare for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with Adaptive Healthcare for Logistics. Our solution provides user provisioning with enterprise-grade reliability and security.
          </p>
