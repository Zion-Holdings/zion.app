...
export const metadata: Metadata = {
  title: 'Data Science Automated - Legal',
  description: 'Drive innovation in legal with Data Science Automated - Legal. This AI-powered platform transforms quota optimization into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-science-automated-legal-8c669637',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Science Automated - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Data Science Automated - Legal. This AI-powered platform transforms quota optimization into a competitive advantage.
          </p>
