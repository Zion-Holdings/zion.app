...
export const metadata: Metadata = {
  title: 'Smart Orchestrator Platform - Logistics',
  description: 'Optimize your logistics workflows with Smart Orchestrator Platform - Logistics. This intelligent platform delivers process automation through advanced automatio',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-orchestrator-platform-logistics-1ee830a6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Orchestrator Platform - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your logistics workflows with Smart Orchestrator Platform - Logistics. This intelligent platform delivers process automation through advanced automation and AI.
          </p>
