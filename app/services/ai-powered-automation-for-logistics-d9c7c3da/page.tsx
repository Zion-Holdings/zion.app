...
export const metadata: Metadata = {
  ...
  description: 'Drive innovation in logistics with AI-Powered Automation for Logistics. This AI-powered platform transforms access management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-automation-for-logistics-d9c7c3da',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Automation for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with AI-Powered Automation for Logistics. This AI-powered platform transforms access management into a competitive advantage.
          </p>
