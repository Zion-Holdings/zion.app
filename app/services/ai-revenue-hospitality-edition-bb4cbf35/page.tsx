...
export const metadata: Metadata = {
  title: 'AI Revenue - Hospitality Edition',
  description: 'Transform your hospitality operations with our AI Revenue - Hospitality Edition. This AI-driven solution automates user experience with unprecedented accuracy a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Revenue - Hospitality Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our AI Revenue - Hospitality Edition. This AI-driven solution automates user experience with unprecedented accuracy and efficiency.
          </p>
