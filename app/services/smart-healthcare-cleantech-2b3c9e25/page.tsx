...
export const metadata: Metadata = {
  title: 'Smart healthcare-cleantech',
  description: 'The future of cleantech is here with Smart healthcare-cleantech. Powered by cutting-edge AI, this platform delivers healthcare data analytics like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-healthcare-cleantech-2b3c9e25',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart healthcare-cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of cleantech is here with Smart healthcare-cleantech. Powered by cutting-edge AI, this platform delivers healthcare data analytics like never before.
          </p>
