...
export const metadata: Metadata = {
  title: 'Enterprise Manager Platform - ALTHEALTH',
  description: 'Drive innovation in althealth with Enterprise Manager Platform - ALTHEALTH. This AI-powered platform transforms customer onboarding into a competitive advantage',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-manager-platform-althealth-6c40aa58',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Manager Platform - ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in althealth with Enterprise Manager Platform - ALTHEALTH. This AI-powered platform transforms customer onboarding into a competitive advantage.
          </p>
