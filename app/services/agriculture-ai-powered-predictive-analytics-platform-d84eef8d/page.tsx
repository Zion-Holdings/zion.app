...
export const metadata: Metadata = {
  title: 'Agriculture AI-Powered Predictive Analytics Platform',
  description: 'AI-powered agriculture solution leveraging advanced machine learning for optimal performance and ROI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/agriculture-ai-powered-predictive-analytics-platform-d84eef8d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Agriculture AI-Powered Predictive Analytics Platform
          </h1>
