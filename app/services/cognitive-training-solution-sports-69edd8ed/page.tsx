...
export const metadata: Metadata = {
  title: 'Cognitive Training Solution - Sports',
  description: 'Drive innovation in sports with Cognitive Training Solution - Sports. This AI-powered platform transforms usage analytics into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-training-solution-sports-69edd8ed',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Training Solution - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in sports with Cognitive Training Solution - Sports. This AI-powered platform transforms usage analytics into a competitive advantage.
          </p>
