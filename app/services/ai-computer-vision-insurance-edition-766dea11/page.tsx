...
export const metadata = {
  ...
  description: "Quantum leap forward for insurance: AI Computer Vision - Insurance Edition. Uses quantum-inspired algorithms to deliver lakehouse architecture at exponential sp",
  alternates: {
