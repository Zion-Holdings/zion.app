...
export const metadata: Metadata = {
  title: 'Smart Threat Generator',
  description: 'The future of sports is here with Smart Threat Generator. Powered by cutting-edge AI, this platform delivers transformative results like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-threat-generator-0012f15c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Threat Generator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Smart Threat Generator. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
