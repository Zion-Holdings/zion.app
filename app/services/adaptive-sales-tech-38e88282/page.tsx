...
export const metadata: Metadata = {
  title: 'Adaptive sales-tech',
  description: 'Transform your technology operations with our Adaptive sales-tech. This AI-driven solution automates process automation with unprecedented accuracy and efficien',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your technology operations with our Adaptive sales-tech. This AI-driven solution automates process automation with unprecedented accuracy and efficiency.
          </p>
