      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Automated profiling + anomaly scoring per column</li>
            <li className="text-purple-300">✓ Schema drift detect + alert on threshold</li>
            <li className="text-purple-300">✓ GE/Soda/DBT quality gate integration</li>
            <li className="text-purple-300">✓ Auto-fix recommendation per anomaly type</li>
            <li className="text-purple-300">✓ Quality scorecard per data product + owner</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai data quality & enforcement engine</li>
