...
export const metadata: Metadata = {
  ...
  keywords: 'Automated profiling + anomaly scoring per column, Schema drift detect + alert on threshold, GE/Soda/DBT quality gate integration, Auto-fix recommendation per anomaly type, Quality scorecard per data product + owner, data, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Data Quality &amp; Enforcement Engine</h1>
        <p className="text-lg text-slate-300 mb-8">Continuous data quality at pipeline scale: automated profiling, statistical anomaly detection, schema drift + auto-fix. GE/Soda/DBT quality gates prevent bad data flowing to warehouse.</p>
        ...
        <li class="text-slate-300">Automated profiling + anomaly scoring per column</li>
        <li class="text-slate-300">Schema drift detect + alert on threshold</li>
        <li class="text-slate-300">GE/Soda/DBT quality gate integration</li>
        <li class="text-slate-300">Auto-fix recommendation per anomaly type</li>
        <li class="text-slate-300">Quality scorecard per data product + owner</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai data quality &amp; enforcement engine</li>
