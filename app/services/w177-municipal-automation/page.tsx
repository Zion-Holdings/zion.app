...
export const metadata: Metadata = {
  ...
  keywords: 'Permit and license processing automation, Citizen request and complaint management, Work order creation and tracking, Public records request processing, Fee calculation and payment, Integration with Accela, Tyler Technologies, Granicus, automation, Government, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Municipal and City Services Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Automate city operations: permit processing, citizen requests, work orders, and public records. Digital government.</p>
        ...
        <li class="text-slate-300">Citizen request and complaint management</li>
        <li class="text-slate-300">Work order creation and tracking</li>
        <li class="text-slate-300">Public records request processing</li>
        <li class="text-slate-300">Fee calculation and payment</li>
        <li class="text-slate-300">Integration with Accela</li>
        <li class="text-slate-300">Tyler Technologies</li>
        <li class="text-slate-300">Granicus</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Permit processing in days not weeks</li>
        <li class="text-slate-300">Citizen requests tracked and resolved</li>
        <li class="text-slate-300">Work orders automated from intake</li>
        <li class="text-slate-300">Public records compliance</li>
      </ul>
        </div>
