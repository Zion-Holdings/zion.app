...
export const metadata: Metadata = {
  title: 'Predictive Supply Engine - Insurance',
  description: 'Hyper-accelerated insurance solution: Predictive Supply Engine - Insurance. Combines sales forecasting with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-supply-engine-insurance-b6876de1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Supply Engine - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated insurance solution: Predictive Supply Engine - Insurance. Combines sales forecasting with next-gen AI for maximum velocity.
          </p>
