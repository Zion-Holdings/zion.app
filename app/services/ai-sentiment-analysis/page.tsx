  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Sentiment Analysis &amp; Brand Monitoring</h1>
        <p className="text-lg text-slate-300 mb-8">Real-time brand perception tracking across social media, reviews, news, and forums. Understand customer emotion at scale and act on insights before they become crises.</p>
        ...
        <li class="text-slate-300">Multi-platform social listening (X, Reddit, TikTok, news)</li>
        <li class="text-slate-300">Emotion-level sentiment scoring (joy, anger, fear, trust)</li>
        <li class="text-slate-300">Brand mention clustering &amp; trending topic detection</li>
        <li class="text-slate-300">Influencer identification &amp; partnership scoring</li>
        <li class="text-slate-300">Crisis early-warning system with alert triage</li>
        <li class="text-slate-300">Competitor sentiment benchmarking &amp; gap analysis</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai sentiment analysis &amp; brand monitoring</li>
