      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your energy workflows with Intelligent Predictor for Energy. This intelligent platform delivers root cause analysis through advanced automation and AI.
          </p>
