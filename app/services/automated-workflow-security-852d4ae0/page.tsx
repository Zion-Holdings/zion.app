...
export const metadata: Metadata = {
  title: 'Automated Workflow Security',
  description: 'Transform your retail operations with our Automated Workflow Security. This AI-driven solution automates manufacturing quality control with unprecedented accura',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-workflow-security-852d4ae0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our Automated Workflow Security. This AI-driven solution automates manufacturing quality control with unprecedented accuracy and efficiency.
          </p>
