...
export const metadata: Metadata = {
  title: 'Cognitive Orchestrator Solution - EDTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Orchestrator Solution - EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for edtech: Cognitive Orchestrator Solution - EDTECH. Uses quantum-inspired algorithms to deliver customer onboarding at exponential speed.
          </p>
