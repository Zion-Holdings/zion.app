...
export const metadata: Metadata = {
  title: 'Smart Risk Platform - Manufacturing #1',
  description: 'Drive innovation in manufacturing with Smart Risk Platform - Manufacturing #1. This AI-powered platform transforms compliance monitoring into a competitive adva',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-risk-platform-manufacturing-1-0c1a3f7e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Risk Platform - Manufacturing #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in manufacturing with Smart Risk Platform - Manufacturing #1. This AI-powered platform transforms compliance monitoring into a competitive advantage.
          </p>
