...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time GPS tracking, Customs status sync, Demand forecasting ML, Disruption alerting, Multi-carrier dashboard, automation, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Supply Chain Visibility</h1>
        <p className="text-lg text-slate-300 mb-8">Real-time end-to-end supply chain control tower with GPS tracking, customs status, inventory forecasting, and disruption alerting across all carriers.</p>
        ...
        <li class="text-slate-300">Real-time GPS tracking</li>
        <li class="text-slate-300">Customs status sync</li>
        <li class="text-slate-300">Demand forecasting ML</li>
        <li class="text-slate-300">Disruption alerting</li>
        <li class="text-slate-300">Multi-carrier dashboard</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with supply chain visibility</li>
