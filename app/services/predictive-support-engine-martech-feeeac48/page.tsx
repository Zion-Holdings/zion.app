...
export const metadata: Metadata = {
  title: 'Predictive Support Engine - MARTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Support Engine - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of martech is here with Predictive Support Engine - MARTECH. Powered by cutting-edge AI, this platform delivers anomaly detection like never before.
          </p>
