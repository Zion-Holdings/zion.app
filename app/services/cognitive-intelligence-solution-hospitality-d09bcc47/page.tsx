...
export const metadata: Metadata = {
  title: 'Cognitive Intelligence Solution - Hospitality',
  description: 'Enhance your hospitality business with Cognitive Intelligence Solution - Hospitality. Our solution provides hr analytics with enterprise-grade reliability and s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-intelligence-solution-hospitality-d09bcc47',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Intelligence Solution - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Cognitive Intelligence Solution - Hospitality. Our solution provides hr analytics with enterprise-grade reliability and security.
          </p>
