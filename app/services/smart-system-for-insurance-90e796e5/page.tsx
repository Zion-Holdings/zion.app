...
export const metadata: Metadata = {
  ...
  keywords: 'Auto-scaling capabilities, API-first design, Data encryption, Alerting system, analyzer, insurance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Smart System for Insurance</h1>
        <p className="text-lg text-slate-300 mb-8">Revolutionize insurance through intelligent automation. Our Smart System for Insurance leverages advanced machine learning to deliver document processing at scale.</p>
