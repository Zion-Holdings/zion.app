...
export const metadata: Metadata = {
  title: 'Intelligent Intelligence for Logistics',
  description: 'Transform your logistics operations with our Intelligent Intelligence for Logistics. This AI-driven solution automates compliance monitoring with unprecedented ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-intelligence-for-logistics-44c30776',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Intelligence for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Intelligent Intelligence for Logistics. This AI-driven solution automates compliance monitoring with unprecedented accuracy and efficiency.
          </p>
