...
export const metadata: Metadata = {
  title: 'Omnichannel Experience Real-Time Data Pipeline Platform',
  description: 'omnichannel experience solution for real estate investment industry. Creates and manages real-time data pipelines with automated ETL and streaming analytics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/omnichannel-experience-real-time-data-pipeline-platform-f0e2ee73',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Omnichannel Experience Real-Time Data Pipeline Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            omnichannel experience solution for real estate investment industry. Creates and manages real-time data pipelines with automated ETL and streaming analytics.
          </p>
