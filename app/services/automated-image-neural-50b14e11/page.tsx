...
export const metadata: Metadata = {
  title: 'Automated Image Neural',
  description: 'The future of construction is here with Automated Image Neural. Powered by cutting-edge AI, this platform delivers transformative results like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-image-neural-50b14e11',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Image Neural
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Automated Image Neural. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
