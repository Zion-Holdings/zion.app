...
export const metadata: Metadata = {
  title: 'Platform Predictive - Insurance',
  description: 'Next-generation insurance solution: Platform Predictive - Insurance. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/platform-predictive-insurance-5c5a98e1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Platform Predictive - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Platform Predictive - Insurance. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
