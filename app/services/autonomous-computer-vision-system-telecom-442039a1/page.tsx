...
export const metadata: Metadata = {
  title: 'Autonomous Computer Vision System - Telecom',
  description: 'Future-proof your telecom with Autonomous Computer Vision System - Telecom. Our autonomous solution handles customer journey mapping end-to-end without human in',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Computer Vision System - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your telecom with Autonomous Computer Vision System - Telecom. Our autonomous solution handles customer journey mapping end-to-end without human intervention.
          </p>
