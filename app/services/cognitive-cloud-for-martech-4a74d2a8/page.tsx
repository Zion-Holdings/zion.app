...
export const metadata: Metadata = {
  title: 'Cognitive Cloud for MARTECH',
  description: 'Transform your martech operations with our Cognitive Cloud for MARTECH. This AI-driven solution automates model interpretability with unprecedented accuracy and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-cloud-for-martech-4a74d2a8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Cloud for MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your martech operations with our Cognitive Cloud for MARTECH. This AI-driven solution automates model interpretability with unprecedented accuracy and efficiency.
          </p>
