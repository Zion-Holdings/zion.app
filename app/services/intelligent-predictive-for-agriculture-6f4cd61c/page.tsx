...
export const metadata: Metadata = {
  title: 'Intelligent Predictive for Agriculture',
  description: 'Optimize your agriculture workflows with Intelligent Predictive for Agriculture. This intelligent platform delivers hr analytics through advanced automation and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-predictive-for-agriculture-6f4cd61c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Predictive for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your agriculture workflows with Intelligent Predictive for Agriculture. This intelligent platform delivers hr analytics through advanced automation and AI.
          </p>
