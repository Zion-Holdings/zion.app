      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ De novo molecular design with generative AI</li>
            <li className="text-purple-300">✓ Protein-ligand binding affinity prediction</li>
            <li className="text-purple-300">✓ ADMET toxicity and pharmacokinetics modeling</li>
            <li className="text-purple-300">✓ Clinical trial cohort matching and optimization</li>
            <li className="text-purple-300">✓ Multi-target drug candidate screening</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai drug discovery & molecular design</li>
