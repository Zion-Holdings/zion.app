...
export const metadata: Metadata = {
  ...
  keywords: 'De novo molecular design with generative AI, Protein-ligand binding affinity prediction, ADMET toxicity and pharmacokinetics modeling, Clinical trial cohort matching and optimization, Multi-target drug candidate screening, ai, Healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Drug Discovery &amp; Molecular Design</h1>
        <p className="text-lg text-slate-300 mb-8">Accelerate pharmaceutical R&amp;D with AI-powered molecular simulation, target identification, toxicity prediction, and clinical trial optimization.</p>
        ...
        <li class="text-slate-300">De novo molecular design with generative AI</li>
        <li class="text-slate-300">Protein-ligand binding affinity prediction</li>
        <li class="text-slate-300">ADMET toxicity and pharmacokinetics modeling</li>
        <li class="text-slate-300">Clinical trial cohort matching and optimization</li>
        <li class="text-slate-300">Multi-target drug candidate screening</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai drug discovery &amp; molecular design</li>
