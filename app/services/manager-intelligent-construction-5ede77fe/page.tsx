...
export const metadata: Metadata = {
  title: 'Manager Intelligent - Construction',
  description: 'Revolutionize construction through intelligent automation. Our Manager Intelligent - Construction leverages advanced machine learning to deliver enterprise-grad',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/manager-intelligent-construction-5ede77fe',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manager Intelligent - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Manager Intelligent - Construction leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
