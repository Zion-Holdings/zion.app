...
export const metadata: Metadata = {
  title: 'Predictor Intelligent - Telecom',
  description: 'Revolutionize telecom through intelligent automation. Our Predictor Intelligent - Telecom leverages advanced machine learning to deliver loyalty optimization at',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictor Intelligent - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Predictor Intelligent - Telecom leverages advanced machine learning to deliver loyalty optimization at scale.
          </p>
