...
export const metadata: Metadata = {
  title: 'Smart intelligence-gaming',
  description: 'The future of gaming is here with Smart intelligence-gaming. Powered by cutting-edge AI, this platform delivers decision support like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-intelligence-gaming-5bdc7f1a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart intelligence-gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of gaming is here with Smart intelligence-gaming. Powered by cutting-edge AI, this platform delivers decision support like never before.
          </p>
