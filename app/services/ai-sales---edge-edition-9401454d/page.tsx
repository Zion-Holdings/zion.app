...
export const metadata: Metadata = {
  title: 'AI Sales - Edge Edition',
  description: 'Transform your edge operations with our AI Sales - Edge Edition. This AI-driven solution automates risk assessment with unprecedented accuracy and efficiency.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-sales---edge-edition-9401454d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Sales - Edge Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your edge operations with our AI Sales - Edge Edition. This AI-driven solution automates risk assessment with unprecedented accuracy and efficiency.
          </p>
