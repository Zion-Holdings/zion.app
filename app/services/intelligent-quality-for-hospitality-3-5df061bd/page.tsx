...
export const metadata: Metadata = {
  title: 'Intelligent Quality for Hospitality #3',
  description: 'Drive innovation in hospitality with Intelligent Quality for Hospitality #3. This AI-powered platform transforms code optimization into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-quality-for-hospitality-3-5df061bd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Quality for Hospitality #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Intelligent Quality for Hospitality #3. This AI-powered platform transforms code optimization into a competitive advantage.
          </p>
