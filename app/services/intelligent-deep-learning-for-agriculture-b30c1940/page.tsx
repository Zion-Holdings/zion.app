...
export const metadata: Metadata = {
  title: 'Intelligent Deep Learning for Agriculture',
  description: 'Enhance your agriculture business with Intelligent Deep Learning for Agriculture. Our solution provides release management with enterprise-grade reliability and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-deep-learning-for-agriculture-b30c1940',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Deep Learning for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your agriculture business with Intelligent Deep Learning for Agriculture. Our solution provides release management with enterprise-grade reliability and security.
          </p>
