...
export const metadata: Metadata = {
  title: 'Fraud Adaptive - Energy',
  description: 'Revolutionize energy through intelligent automation. Our Fraud Adaptive - Energy leverages advanced machine learning to deliver recruitment automation at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/fraud-adaptive-energy-01e97038',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Fraud Adaptive - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Fraud Adaptive - Energy leverages advanced machine learning to deliver recruitment automation at scale.
          </p>
