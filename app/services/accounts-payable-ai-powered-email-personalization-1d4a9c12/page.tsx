...
export const metadata: Metadata = {
  title: 'Accounts Payable AI-Powered Email Personalization',
  description: 'AI-powered accounts payable solution for email marketing. Creates hyper-personalized email campaigns by analyzing recipient data.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/accounts-payable-ai-powered-email-personalization-1d4a9c12',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Accounts Payable AI-Powered Email Personalization
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered accounts payable solution for email marketing. Creates hyper-personalized email campaigns by analyzing recipient data.
          </p>
