...
export const metadata: Metadata = {
  ...
  keywords: 'SOC 2 certified, Machine learning integration, Plugin architecture, API-first design, Edge computing support, suite, healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Powered Manager for Healthcare</h1>
        <p className="text-lg text-slate-300 mb-8">The future of healthcare is here with AI-Powered Manager for Healthcare. Powered by cutting-edge AI, this platform delivers supply chain like never before.</p>
