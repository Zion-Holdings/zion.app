...
export const metadata: Metadata = {
  title: 'Intelligent Revenue for Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Intelligent Revenue for Insurance leverages advanced machine learning to deliver performance tuning ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-revenue-for-insurance-4ba240e7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Revenue for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Intelligent Revenue for Insurance leverages advanced machine learning to deliver performance tuning at scale.
          </p>
