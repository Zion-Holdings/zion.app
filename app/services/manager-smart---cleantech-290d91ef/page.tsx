...
export const metadata: Metadata = {
  title: 'Manager Smart - Cleantech',
  description: 'Next-generation cleantech solution: Manager Smart - Cleantech. Combines customer insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/manager-smart---cleantech-290d91ef',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manager Smart - Cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation cleantech solution: Manager Smart - Cleantech. Combines customer insights with adaptive intelligence for optimal results.
          </p>
