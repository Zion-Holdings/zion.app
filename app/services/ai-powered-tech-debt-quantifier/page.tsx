...
export const metadata: Metadata = {
  ...
  keywords: 'Static code analysis + complexity heatmaps, Dependency vulnerability & EOL detection, Duplicate code detection with CloneDR, Architecture rule validation (dependency cycles), Remediation effort estimation (person-days), ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Powered Tech Debt Quantifier</h1>
        <p className="text-lg text-slate-300 mb-8">Automatically identify, classify, and quantify technical debt: code complexity, duplication, outdated deps, test gaps, and architectural violations with remediation cost estimates.</p>
        ...
        <li class="text-slate-300">Static code analysis + complexity heatmaps</li>
        <li class="text-slate-300">Dependency vulnerability &amp; EOL detection</li>
        <li class="text-slate-300">Duplicate code detection with CloneDR</li>
        <li class="text-slate-300">Architecture rule validation (dependency cycles)</li>
        <li class="text-slate-300">Remediation effort estimation (person-days)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai-powered tech debt quantifier</li>
