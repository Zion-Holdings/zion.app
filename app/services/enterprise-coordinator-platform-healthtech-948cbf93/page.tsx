...
export const metadata: Metadata = {
  title: 'Enterprise Coordinator Platform - HEALTHTECH',
  description: 'Unlock unprecedented growth with Enterprise Coordinator Platform - HEALTHTECH. This autonomous system provides training optimization with zero manual interventi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Coordinator Platform - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Enterprise Coordinator Platform - HEALTHTECH. This autonomous system provides training optimization with zero manual intervention needed.
          </p>
