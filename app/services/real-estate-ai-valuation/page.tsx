...
export const metadata: Metadata = {
  ...
  keywords: 'Automated valuations, Market analysis, Comparable sales, Rental yield, Investment scoring, Portfolio analysis, Trend prediction, Risk assessment, ai, Real Estate, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Real Estate AI Valuation Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Automated property valuations using AI — market analysis, comparable sales, rental yield prediction, and investment scoring for residential and commercial real estate.</p>
        ...
        <li class="text-slate-300">Automated valuations</li>
        <li class="text-slate-300">Market analysis</li>
        <li class="text-slate-300">Comparable sales</li>
        <li class="text-slate-300">Rental yield</li>
        <li class="text-slate-300">Investment scoring</li>
        <li class="text-slate-300">Portfolio analysis</li>
        <li class="text-slate-300">Trend prediction</li>
        <li class="text-slate-300">Risk assessment</li>
      </ul>
        </div>
        ...
        <li class="text-slate-300">Market insights</li>
        <li class="text-slate-300">Investment decisions</li>
