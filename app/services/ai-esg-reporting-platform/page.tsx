...
export const metadata: Metadata = {
  ...
  keywords: 'Automated GHG emissions tracking, Social impact measurement, ESG governance scoring, GRI/SASB/TCFD report generation, Supply chain ESG monitoring, Benchmarking against peers, data, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI ESG Reporting &amp; Sustainability Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Automated ESG data collection, scoring, and reporting: GHG emissions tracking, social impact measurement, governance scoring, and GRI/SASB/TCFD compliant reports.</p>
        ...
        <li class="text-slate-300">Automated GHG emissions tracking</li>
        <li class="text-slate-300">Social impact measurement</li>
        <li class="text-slate-300">ESG governance scoring</li>
        <li class="text-slate-300">GRI/SASB/TCFD report generation</li>
        <li class="text-slate-300">Supply chain ESG monitoring</li>
        <li class="text-slate-300">Benchmarking against peers</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Automate ESG reporting</li>
        <li class="text-slate-300">Reduce audit costs by 60%</li>
        <li class="text-slate-300">Benchmark against 10K+ companies</li>
      </ul>
        </div>
