...
export const metadata: Metadata = {
  title: 'Autonomous Sales System - Finance',
  description: 'Transform your finance operations with our Autonomous Sales System - Finance. This AI-driven solution automates quota optimization with unprecedented accuracy a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Sales System - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Autonomous Sales System - Finance. This AI-driven solution automates quota optimization with unprecedented accuracy and efficiency.
          </p>
