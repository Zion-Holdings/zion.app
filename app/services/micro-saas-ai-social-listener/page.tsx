...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'Micro-SaaS AI Social Media Listener & Engagement', 'description': 'AI-powered social listening platform that monitors brand mentions, competitor activity, and industry trends across 20+ platforms. Auto-responds to common queries and escalates issues.', 'serviceType': 'micro-saas', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'marketing'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'Micro-SaaS AI Social Media Listener & Engagement Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$79/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$199/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': 'Custom', 'priceCurrency': 'USD'}]}} />
    <JsonLd data={'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'Real-time brand mention monitoring across 20+ platforms', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Real-time brand mention monitoring across 20+ platforms'}}, {'@type': 'Question', 'name': 'AI sentiment analysis with emotion detection', 'acceptedAnswer': {'@type': 'Answer', 'text': 'AI sentiment analysis with emotion detection'}}, {'@type': 'Question', 'name': 'Auto-response for common queries and FAQs', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Auto-response for common queries and FAQs'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Respond to customers 10x faster; Catch PR crises before they escalate; Identify sales opportunities from social signals'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} />
