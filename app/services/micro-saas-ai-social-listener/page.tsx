...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time brand mention monitoring across 20+ platforms, AI sentiment analysis with emotion detection, Auto-response for common queries and FAQs, Competitor tracking and benchmarking, Influencer identification and engagement tracking, Crisis alert system for negative sentiment spikes, micro-saas, marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Micro-SaaS AI Social Media Listener &amp; Engagement</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered social listening platform that monitors brand mentions, competitor activity, and industry trends across 20+ platforms. Auto-responds to common queries and escalates issues.</p>
        ...
        <li class="text-slate-300">Real-time brand mention monitoring across 20+ platforms</li>
        <li class="text-slate-300">AI sentiment analysis with emotion detection</li>
        <li class="text-slate-300">Auto-response for common queries and FAQs</li>
        <li class="text-slate-300">Competitor tracking and benchmarking</li>
        <li class="text-slate-300">Influencer identification and engagement tracking</li>
        <li class="text-slate-300">Crisis alert system for negative sentiment spikes</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Respond to customers 10x faster</li>
        <li class="text-slate-300">Catch PR crises before they escalate</li>
        <li class="text-slate-300">Identify sales opportunities from social signals</li>
        <li class="text-slate-300">Benchmark against competitors automatically</li>
      </ul>
        </div>
