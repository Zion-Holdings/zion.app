...
export const metadata = {
  ...
  description: 'End-to-end erp automation: automate sap/oracle/dynamics workflows without custom code services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/erp-automation-automate-sap-oracle-dynamics-workflows-without-custom-code-49/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">ERP Automation: Automate SAP/Oracle/Dynamics Workflows Without Custom Code</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end erp automation: automate sap/oracle/dynamics workflows without custom code services: assessment, deployment, and managed operations.
        </p>
