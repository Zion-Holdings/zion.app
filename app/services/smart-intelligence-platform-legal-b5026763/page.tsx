...
export const metadata: Metadata = {
  title: 'Smart Intelligence Platform - Legal',
  description: 'Drive innovation in legal with Smart Intelligence Platform - Legal. This AI-powered platform transforms incident response into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-intelligence-platform-legal-b5026763',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Intelligence Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Smart Intelligence Platform - Legal. This AI-powered platform transforms incident response into a competitive advantage.
          </p>
