...
export const metadata: Metadata = {
  ...
  description: 'Analyzes financial statements with anomaly detection and insights.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-financial-statement-analysis2026-07-28t0347441707170000102-49f5d14f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Analyzes financial statements with anomaly detection and insights.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Statement analysis</li>
