...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'AI-Powered Advanced Clinical Decision Support', 'description': 'Clinical AI system that provides advanced diagnostic assistance, treatment recommendations, and care pathway optimization for healthcare providers.', 'serviceType': 'analytics', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'hello@ziontechgroup.com', 'telephone': '+1 (302) 464-0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'healthcare'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'AI-Powered Advanced Clinical Decision Support Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '298', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '748', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': '2248', 'priceCurrency': 'USD'}]}} />
