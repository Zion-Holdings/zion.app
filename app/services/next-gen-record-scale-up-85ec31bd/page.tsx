...
export const metadata: Metadata = {
  title: 'Next-Gen Record Scale-up',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Record Scale-up
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Next-Gen Record Scale-up. This autonomous system provides fleet management with zero manual intervention needed.
          </p>
