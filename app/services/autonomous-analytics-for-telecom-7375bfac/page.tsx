...
export const metadata: Metadata = {
  title: 'Autonomous Analytics for Telecom',
  description: 'Next-generation telecom solution: Autonomous Analytics for Telecom. Combines image recognition with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-analytics-for-telecom-7375bfac',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Analytics for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation telecom solution: Autonomous Analytics for Telecom. Combines image recognition with adaptive intelligence for optimal results.
          </p>
