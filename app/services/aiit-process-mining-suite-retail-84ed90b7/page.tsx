...
export const metadata: Metadata = {
  title: 'AI/IT Process Mining Suite - Retail',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Process Mining Suite - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your retail business with AI/IT Process Mining Suite - Retail. Our solution provides brand monitoring with enterprise-grade reliability and security.
          </p>
