...
export const metadata: Metadata = {
  ...
  description: 'Optimize your insurance workflows with Autonomous Director System - Insurance. This intelligent platform delivers contract analysis through advanced automation ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Autonomous Director System - Insurance. This intelligent platform delivers contract analysis through advanced automation and AI.
          </p>
