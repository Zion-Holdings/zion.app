...
export const metadata: Metadata = {
  title: 'Enterprise Retail Personalization Express (Logistics)',
  description: 'Enterprise Retail Personalization Express (Logistics) is an AI-powered logistics solution that transforms how businesses operate through intelligent automation ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-retail-personalizat-aa27',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Retail Personalization Express (Logistics)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enterprise Retail Personalization Express (Logistics) is an AI-powered logistics solution that transforms how businesses operate through intelligent automation and real-time analytics.
...
Fastify, PostgreSQL, Python, DigitalOcean, Kafka, Redis
