...
export const metadata: Metadata = {
  title: 'Smart Supply Platform - MARTECH',
  description: 'Next-generation martech solution: Smart Supply Platform - MARTECH. Combines lead scoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-supply-platform-martech-72706bf1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Supply Platform - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation martech solution: Smart Supply Platform - MARTECH. Combines lead scoring with adaptive intelligence for optimal results.
          </p>
