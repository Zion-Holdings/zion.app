...
export const metadata = {
  title: "Cognitive Intelligent Supply Chain Decision Engine - Zion Tech Group",
  description: "Cognitive decision engine that processes intelligent signals to drive supply chain strategy with deep learning.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/cognitive-intelligent-supply-chain-decision-engine-415b5e9a`
  }
};
