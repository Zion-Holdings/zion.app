...
export const metadata: Metadata = {
  title: 'Autonomous Sales System - Cybersecurity',
  description: 'The future of cybersecurity is here with Autonomous Sales System - Cybersecurity. Powered by cutting-edge AI, this platform delivers manufacturing quality contr',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Sales System - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of cybersecurity is here with Autonomous Sales System - Cybersecurity. Powered by cutting-edge AI, this platform delivers manufacturing quality control like never before.
          </p>
