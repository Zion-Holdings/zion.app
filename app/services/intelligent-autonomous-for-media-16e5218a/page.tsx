...
export const metadata: Metadata = {
  title: 'Intelligent Autonomous for Media',
  description: 'Drive innovation in media with Intelligent Autonomous for Media. This AI-powered platform transforms click automation into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-autonomous-for-media-16e5218a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Autonomous for Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in media with Intelligent Autonomous for Media. This AI-powered platform transforms click automation into a competitive advantage.
          </p>
