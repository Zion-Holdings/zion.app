...
export const metadata: Metadata = {
  ...
  description: 'Optimizes patient scheduling with wait time minimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-patient-scheduling2026-07-28t0356460584380000153-0fede129',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimizes patient scheduling with wait time minimization.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Wait time reduction</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">30% wait time reduction</li>
