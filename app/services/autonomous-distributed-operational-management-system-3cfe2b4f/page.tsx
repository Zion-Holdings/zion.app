...
export const metadata = {
  title: "Autonomous Distributed Operational Management System - Zion Tech Group",
  description: "Autonomous management system that self-optimizes distributed operational processes with minimal human intervention.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/autonomous-distributed-operational-management-system-3cfe2b4f`
  }
};
