...
export const metadata: Metadata = {
  ...
  description: 'Transform your retail operations with our AI-Powered Engine for Retail. This AI-driven solution automates threat detection with unprecedented accuracy and effic',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our AI-Powered Engine for Retail. This AI-driven solution automates threat detection with unprecedented accuracy and efficiency.
          </p>
