...
export const metadata: Metadata = {
  title: 'AI-Powered finance-education',
  description: 'Revolutionize education through intelligent automation. Our AI-Powered finance-education leverages advanced machine learning to deliver predictive analytics at ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize education through intelligent automation. Our AI-Powered finance-education leverages advanced machine learning to deliver predictive analytics at scale.
          </p>
