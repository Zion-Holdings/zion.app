...
export const metadata: Metadata = {
  title: 'AI/IT SMB Suite - FINTECH #1',
  description: 'Transform your fintech operations with our AI/IT SMB Suite - FINTECH #1. This AI-driven solution automates skills management with unprecedented accuracy and eff',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-smb-suite-fintech-1-d49623cf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT SMB Suite - FINTECH #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your fintech operations with our AI/IT SMB Suite - FINTECH #1. This AI-driven solution automates skills management with unprecedented accuracy and efficiency.
          </p>
