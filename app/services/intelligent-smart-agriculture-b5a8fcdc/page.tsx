...
export const metadata: Metadata = {
  title: 'Intelligent Smart - Agriculture',
  description: 'Transform your agriculture operations with our Intelligent Smart - Agriculture. This AI-driven solution automates resource utilization with unprecedented accura',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Intelligent Smart - Agriculture. This AI-driven solution automates resource utilization with unprecedented accuracy and efficiency.
          </p>
