...
export const metadata: Metadata = {
  title: 'Intelligence Autonomous - Logistics',
  description: 'Transform your logistics operations with our Intelligence Autonomous - Logistics. This AI-driven solution provides intelligent automation with unprecedented acc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligence-autonomous-logistics-565b634b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligence Autonomous - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Intelligence Autonomous - Logistics. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
