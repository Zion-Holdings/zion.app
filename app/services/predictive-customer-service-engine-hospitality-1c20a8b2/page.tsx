...
export const metadata: Metadata = {
  ...
  description: 'Drive innovation in hospitality with Predictive Customer Service Engine - Hospitality. This AI-powered platform transforms net promoter score into a competitive',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-customer-service-engine-hospitality-1c20a8b2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Predictive Customer Service Engine - Hospitality. This AI-powered platform transforms net promoter score into a competitive advantage.
          </p>
