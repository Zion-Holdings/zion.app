...
export const metadata: Metadata = {
  title: 'Intelligent Manufacturing Threat',
  description: 'Next-generation agriculture solution: Intelligent Manufacturing Threat. Combines feedback collection with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-manufacturing-threat-8a098cbc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Manufacturing Threat
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agriculture solution: Intelligent Manufacturing Threat. Combines feedback collection with adaptive intelligence for optimal results.
          </p>
