...
export const metadata: Metadata = {
  title: 'Enterprise Executive Platform - Healthcare',
  description: 'Drive innovation in healthcare with Enterprise Executive Platform - Healthcare. This AI-powered platform transforms brand monitoring into a competitive advantag',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-executive-platform-healthcare-1e815135',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Executive Platform - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with Enterprise Executive Platform - Healthcare. This AI-powered platform transforms brand monitoring into a competitive advantage.
          </p>
