...
export const metadata = {
  ...
  description: "Enterprise RPA platform for automating repetitive tasks. No-code bot builder, AI-powered screen understanding, and orchestration across desktop and web applicat",
  alternates: {
