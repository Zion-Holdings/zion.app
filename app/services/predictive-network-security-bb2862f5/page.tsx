...
export const metadata: Metadata = {
  title: 'Predictive Network Security',
  description: 'Transform your hospitality operations with our Predictive Network Security. This AI-driven solution automates process discovery with unprecedented accuracy and ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Predictive Network Security. This AI-driven solution automates process discovery with unprecedented accuracy and efficiency.
          </p>
