...
export const metadata: Metadata = {
  title: 'Intelligent ai-agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Intelligent ai-agriculture leverages advanced machine learning to deliver enterprise-grade insight',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-ai-agriculture-1f61a7f3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent ai-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Intelligent ai-agriculture leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
