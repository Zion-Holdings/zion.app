...
export const metadata: Metadata = {
  title: 'DevOps Automated - Blockchain',
  description: 'The future of blockchain is here with DevOps Automated - Blockchain. Powered by cutting-edge AI, this platform delivers financial risk management like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/devops-automated---blockchain-96e66684',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            DevOps Automated - Blockchain
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of blockchain is here with DevOps Automated - Blockchain. Powered by cutting-edge AI, this platform delivers financial risk management like never before.
          </p>
