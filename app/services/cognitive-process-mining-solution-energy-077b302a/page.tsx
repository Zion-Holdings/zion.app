...
export const metadata: Metadata = {
  title: 'Cognitive Process Mining Solution - Energy',
  description: 'The future of energy is here with Cognitive Process Mining Solution - Energy. Powered by cutting-edge AI, this platform delivers business continuity like never ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-process-mining-solution-energy-077b302a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Process Mining Solution - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Cognitive Process Mining Solution - Energy. Powered by cutting-edge AI, this platform delivers business continuity like never before.
          </p>
