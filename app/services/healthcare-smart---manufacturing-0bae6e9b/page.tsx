...
export const metadata: Metadata = {
  title: 'Healthcare Smart - Manufacturing',
  description: 'Revolutionize manufacturing through intelligent automation. Our Healthcare Smart - Manufacturing leverages advanced machine learning to deliver data processing ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/healthcare-smart---manufacturing-0bae6e9b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize manufacturing through intelligent automation. Our Healthcare Smart - Manufacturing leverages advanced machine learning to deliver data processing at scale.
          </p>
