...
export const metadata: Metadata = {
  title: 'Enterprise Performance Experience',
  description: 'Optimize your legal workflows with Enterprise Performance Experience. This intelligent platform delivers learning management through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-performance-experience-0a0fa172',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with Enterprise Performance Experience. This intelligent platform delivers learning management through advanced automation and AI.
          </p>
