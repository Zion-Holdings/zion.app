...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-orchestrator-solution-6ba225',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your transportation operations with our Smart Orchestrator Solution. This data solution delivers unprecedented automation and intelligence.
          </p>
