...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Customer for Cybersecurity',
  description: 'Revolutionize cybersecurity through intelligent automation. Our Hyper-Accelerated Customer for Cybersecurity leverages advanced machine learning to deliver reco',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Customer for Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cybersecurity through intelligent automation. Our Hyper-Accelerated Customer for Cybersecurity leverages advanced machine learning to deliver record extraction at scale.
          </p>
