...
export const metadata: Metadata = {
  title: 'Adaptive Business Intelligence for Legal',
  description: 'Enhance your legal business with Adaptive Business Intelligence for Legal. Our solution provides feature engineering with enterprise-grade reliability and secur',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Business Intelligence for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Adaptive Business Intelligence for Legal. Our solution provides feature engineering with enterprise-grade reliability and security.
          </p>
