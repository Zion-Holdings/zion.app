...
export const metadata: Metadata = {
  title: 'Intelligent Intelligent for Transportation',
  description: 'Next-generation transportation solution: Intelligent Intelligent for Transportation. Combines release management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-intelligent-for-transportation-3b4f124b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Intelligent for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation transportation solution: Intelligent Intelligent for Transportation. Combines release management with adaptive intelligence for optimal results.
          </p>
