...
export const metadata: Metadata = {
  title: 'Fleet Management AI-Powered Market Intelligence',
  description: 'fleet management solution for conservation industry. Monitors market trends, competitor activities, and industry news to provide actionable insights.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/fleet-management-ai-powered-market-intelligence-df47d1c7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Fleet Management AI-Powered Market Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            fleet management solution for conservation industry. Monitors market trends, competitor activities, and industry news to provide actionable insights.
          </p>
