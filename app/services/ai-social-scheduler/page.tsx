...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-platform publishing queue, AI caption and hashtag writer, Optimal timing engine per channel, Engagement analytics dashboard, A/B post variant testing, ai, E-Commerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Social Scheduler &amp; Content Composer</h1>
        <p className="text-lg text-slate-300 mb-8">Generate, schedule, and analyse social posts across LinkedIn, X/Twitter, Instagram, and TikTok. AI suggests optimal posting times per audience segment.</p>
        ...
        <li class="text-slate-300">Multi-platform publishing queue</li>
        <li class="text-slate-300">AI caption and hashtag writer</li>
        <li class="text-slate-300">Optimal timing engine per channel</li>
        <li class="text-slate-300">Engagement analytics dashboard</li>
        <li class="text-slate-300">A/B post variant testing</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai social scheduler &amp; content composer</li>
