...
export const metadata: Metadata = {
  title: 'Neural Render Farm Controller',
  description: 'Controls GPU render farms with task scheduling, failure recovery, and cost capping.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-render-farm-controller-dec03587',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Render Farm Controller
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Controls GPU render farms with task scheduling, failure recovery, and cost capping.
          </p>
