...
export const metadata: Metadata = {
  ...
  keywords: 'Biometric auth (Face ID/Touch ID), Magic link email login, Hardware key (YubiKey) support, Risk-based step-up auth, Session management, security, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Passwordless Authentication</h1>
        <p className="text-lg text-slate-300 mb-8">Eliminate password-based attacks with biometric, magic link, and hardware key authentication. Passwordless by default with fallback options.</p>
        ...
        <li class="text-slate-300">Biometric auth (Face ID/Touch ID)</li>
        <li class="text-slate-300">Magic link email login</li>
        <li class="text-slate-300">Hardware key (YubiKey) support</li>
        <li class="text-slate-300">Risk-based step-up auth</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with passwordless authentication</li>
