...
export const metadata: Metadata = {
  ...
  keywords: '99.2% accuracy speech-to-text in 60+ languages, Real-time voice translation for live meetings, Voice cloning for personalized brand audio content, Voice biometrics for secure identity verification, Conversational IVR with natural language understanding, Meeting transcription with speaker diarization & summaries, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Speech &amp; Voice Solutions</h1>
        <p className="text-lg text-slate-300 mb-8">Enterprise-grade speech technology including high-accuracy transcription, AI voice cloning, real-time translation, voice biometrics, and conversational AI for customer service.</p>
        ...
        <li class="text-slate-300">99.2% accuracy speech-to-text in 60+ languages</li>
        <li class="text-slate-300">Real-time voice translation for live meetings</li>
        <li class="text-slate-300">Voice cloning for personalized brand audio content</li>
        <li class="text-slate-300">Voice biometrics for secure identity verification</li>
        <li class="text-slate-300">Conversational IVR with natural language understanding</li>
        <li class="text-slate-300">Meeting transcription with speaker diarization &amp; summaries</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai speech &amp; voice solutions</li>
