...
export const metadata: Metadata = {
  title: 'Smart System Platform - Tech',
  description: 'Transform your technology operations with our Smart System Platform - Tech. This AI-driven solution automates disaster recovery with unprecedented accuracy and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-system-platform-tech-e50fe9d9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart System Platform - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your technology operations with our Smart System Platform - Tech. This AI-driven solution automates disaster recovery with unprecedented accuracy and efficiency.
          </p>
