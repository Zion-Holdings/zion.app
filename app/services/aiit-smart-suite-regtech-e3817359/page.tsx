...
export const metadata: Metadata = {
  title: 'AI/IT Smart Suite - REGTECH',
  description: 'Revolutionize regtech through intelligent automation. Our AI/IT Smart Suite - REGTECH leverages advanced machine learning to deliver business continuity at scal',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-smart-suite-regtech-e3817359',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Smart Suite - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize regtech through intelligent automation. Our AI/IT Smart Suite - REGTECH leverages advanced machine learning to deliver business continuity at scale.
          </p>
