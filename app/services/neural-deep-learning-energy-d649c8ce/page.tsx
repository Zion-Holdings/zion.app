...
export const metadata: Metadata = {
  title: 'Neural deep learning-energy',
  description: 'Revolutionize energy through intelligent automation. Our Neural deep learning-energy leverages advanced machine learning to deliver workflow automation at scale',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-deep-learning-energy-d649c8ce',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural deep learning-energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Neural deep learning-energy leverages advanced machine learning to deliver workflow automation at scale.
          </p>
