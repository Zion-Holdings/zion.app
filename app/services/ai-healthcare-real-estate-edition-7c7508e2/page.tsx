...
export const metadata: Metadata = {
  title: 'AI Healthcare - Real-Estate Edition',
  description: 'Optimize your real-estate workflows with AI Healthcare - Real-Estate Edition. This intelligent platform delivers image recognition through advanced automation a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-healthcare-real-estate-edition-7c7508e2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Healthcare - Real-Estate Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your real-estate workflows with AI Healthcare - Real-Estate Edition. This intelligent platform delivers image recognition through advanced automation and AI.
          </p>
