...
export const metadata: Metadata = {
  ...
  description: 'AI-powered mental health support with chat and mood tracking.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-mental-health-support2026-07-28t0416114113940000195-50797801',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            AI-powered mental health support with chat and mood tracking.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Mental health support</li>
          <li className="text-gray-300">Chat therapy</li>
          <li className="text-gray-300">Mood tracking</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">60% better outcomes</li>
