...
export const metadata: Metadata = {
  title: 'Predictive Business Intelligence Engine - Legal',
  description: 'Drive innovation in legal with Predictive Business Intelligence Engine - Legal. This AI-powered platform transforms testing automation into a competitive advant',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Business Intelligence Engine - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Predictive Business Intelligence Engine - Legal. This AI-powered platform transforms testing automation into a competitive advantage.
          </p>
