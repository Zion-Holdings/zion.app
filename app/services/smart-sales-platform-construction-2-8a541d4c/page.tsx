...
export const metadata: Metadata = {
  title: 'Smart Sales Platform - Construction #2',
  description: 'Optimize your construction workflows with Smart Sales Platform - Construction #2. This intelligent platform delivers disaster recovery through advanced automati',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Sales Platform - Construction #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Smart Sales Platform - Construction #2. This intelligent platform delivers disaster recovery through advanced automation and AI.
          </p>
