...
export const metadata: Metadata = {
  title: 'AI Director - Construction Edition',
  description: 'Next-generation construction solution: AI Director - Construction Edition. Combines sales process optimization with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-director-construction-edition-bc97840b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Director - Construction Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: AI Director - Construction Edition. Combines sales process optimization with adaptive intelligence for optimal results.
          </p>
