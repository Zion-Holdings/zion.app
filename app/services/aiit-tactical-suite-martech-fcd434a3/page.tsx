...
export const metadata: Metadata = {
  title: 'AI/IT Tactical Suite - MARTECH',
  description: 'Quantum leap forward for martech: AI/IT Tactical Suite - MARTECH. Uses quantum-inspired algorithms to deliver resource optimization at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-tactical-suite-martech-fcd434a3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Tactical Suite - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for martech: AI/IT Tactical Suite - MARTECH. Uses quantum-inspired algorithms to deliver resource optimization at exponential speed.
          </p>
