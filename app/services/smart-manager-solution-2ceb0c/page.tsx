...
export const metadata: Metadata = {
  ...
  description: 'Transform your gaming operations with our Smart Manager Solution. This automation solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-manager-solution-2ceb0c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your gaming operations with our Smart Manager Solution. This automation solution delivers unprecedented automation and intelligence.
          </p>
