...
export const metadata: Metadata = {
  title: 'Next-Gen Employee for TECHNOLOGY',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Employee for TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in technology with Next-Gen Employee for TECHNOLOGY. This AI-powered platform transforms data governance into a competitive advantage.
          </p>
