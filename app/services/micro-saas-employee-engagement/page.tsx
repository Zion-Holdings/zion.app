...
export const metadata: Metadata = {
  ...
  keywords: 'Pulse surveys, eNPS scoring, AI sentiment analysis, Action planning, Slack/Teams integration, Anonymous feedback, Benchmarking, Manager dashboards, micro-saas, HR Tech, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Real-time employee sentiment tracking, pulse surveys, eNPS scoring, action planning, and AI-driven insights. Integrates with Slack, Teams, and HRIS systems.</p>
        ...
        <li class="text-slate-300">eNPS scoring</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">25% lower turnover</li>
        <li class="text-slate-300">Real-time sentiment</li>
        <li class="text-slate-300">AI-powered insights</li>
        <li class="text-slate-300">Manager action plans</li>
      </ul>
        </div>
