...
export const metadata: Metadata = {
  title: 'Data Science Predictive - Telecom',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Science Predictive - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of telecom is here with Data Science Predictive - Telecom. Powered by cutting-edge AI, this platform delivers training optimization like never before.
          </p>
