...
export const metadata: Metadata = {
  title: 'AI-Powered Cloud for Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our AI-Powered Cloud for Insurance leverages advanced machine learning to deliver inventory management a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-cloud-for-insurance-6cf789c6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Cloud for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our AI-Powered Cloud for Insurance leverages advanced machine learning to deliver inventory management at scale.
          </p>
