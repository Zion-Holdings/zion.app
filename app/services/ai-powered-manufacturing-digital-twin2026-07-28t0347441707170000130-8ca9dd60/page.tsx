...
export const metadata: Metadata = {
  title: 'AI-Powered Manufacturing Digital Twin',
  description: 'Creates digital twins for simulation and optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-manufacturing-digital-twin2026-07-28t0347441707170000130-8ca9dd60',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Creates digital twins for simulation and optimization.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Digital twin</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">40% faster innovation</li>
