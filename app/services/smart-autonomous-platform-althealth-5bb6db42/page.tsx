...
export const metadata: Metadata = {
  title: 'Smart Autonomous Platform - ALTHEALTH',
  description: 'Enhance your althealth business with Smart Autonomous Platform - ALTHEALTH. Our solution provides rpa orchestration with enterprise-grade reliability and securi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Autonomous Platform - ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your althealth business with Smart Autonomous Platform - ALTHEALTH. Our solution provides rpa orchestration with enterprise-grade reliability and security.
          </p>
