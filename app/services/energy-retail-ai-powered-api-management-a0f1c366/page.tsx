...
export const metadata: Metadata = {
  title: 'Energy Retail AI-Powered API Management',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Energy Retail AI-Powered API Management
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered energy retail solution for api management. Intelligent API gateway with rate limiting, authentication, and analytics.
          </p>
