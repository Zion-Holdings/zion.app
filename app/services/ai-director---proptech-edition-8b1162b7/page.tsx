...
export const metadata: Metadata = {
  title: 'AI Director - Proptech Edition',
  description: 'The future of proptech is here with AI Director - Proptech Edition. Powered by cutting-edge AI, this platform delivers logistics route optimization like never b',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-director---proptech-edition-8b1162b7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Director - Proptech Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with AI Director - Proptech Edition. Powered by cutting-edge AI, this platform delivers logistics route optimization like never before.
          </p>
