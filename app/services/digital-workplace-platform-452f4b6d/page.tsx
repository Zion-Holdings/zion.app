...
export const metadata: Metadata = {
  ...
  description: 'Unified digital workplace solution that provides secure access to applications, data, and collaboration tools from any device with AI-powered personalization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/digital-workplace-platform-452f4b6d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Unified digital workplace solution that provides secure access to applications, data, and collaboration tools from any device with AI-powered personalization.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Secure access</li>
          <li className="text-gray-300">App delivery</li>
          <li className="text-gray-300">Collaboration tools</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">70% productivity gain</li>
          <li className="text-purple-300">Zero device limitations</li>
          <li className="text-purple-300">Secure anywhere work</li>
          </ul>
        </section>
