...
export const metadata: Metadata = {
  title: 'Smart Security Optimizer',
  description: 'Revolutionize proptech through intelligent automation. Our Smart Security Optimizer leverages advanced machine learning to deliver financial planning at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-security-optimizer-3ab77362',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our Smart Security Optimizer leverages advanced machine learning to deliver financial planning at scale.
          </p>
