...
export const metadata: Metadata = {
  ...
  keywords: 'Semantic vector search, Hybrid keyword + vector ranking, Entity and faceted search, Natural language query understanding, Search analytics and feedback loops, Multi-index and multi-tenant, API with embeddable search UI, data, Search, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Semantic Search &amp; Knowledge API</h1>
        <p className="text-lg text-slate-300 mb-8">Semantic search over your documents and data: vector search, hybrid ranking, entity search, and NL queries. Power internal search, customer support, and product discovery.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">data</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">Search</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Semantic vector search</li>
        <li class="text-slate-300">Hybrid keyword + vector ranking</li>
        <li class="text-slate-300">Entity and faceted search</li>
        <li class="text-slate-300">Natural language query understanding</li>
        <li class="text-slate-300">Search analytics and feedback loops</li>
        <li class="text-slate-300">Multi-index and multi-tenant</li>
        <li class="text-slate-300">API with embeddable search UI</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Users find answers with natural language</li>
        <li class="text-slate-300">Hybrid ranking outperforms keyword-only</li>
        <li class="text-slate-300">Search analytics reveal what users want</li>
        <li class="text-slate-300">Embeddable search UI for any application</li>
      </ul>
        </div>
