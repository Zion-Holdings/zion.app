...
export const metadata = {
  ...
  description: "Semantic search over your documents and data: vector search, hybrid ranking, entity search, and NL queries. Power internal search, customer support, and product",
  alternates: {
