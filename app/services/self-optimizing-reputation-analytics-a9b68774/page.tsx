...
export const metadata: Metadata = {
  title: 'Self-Optimizing Reputation Analytics',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Reputation Analytics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in media with Self-Optimizing Reputation Analytics. This AI-powered platform transforms healthcare data analytics into a competitive advantage.
          </p>
