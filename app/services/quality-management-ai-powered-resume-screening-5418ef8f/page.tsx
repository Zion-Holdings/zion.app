...
export const metadata: Metadata = {
  title: 'Quality Management AI-Powered Resume Screening',
  description: 'AI-powered quality management solution for hr. Automates candidate screening using NLP and skills matching.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quality-management-ai-powered-resume-screening-5418ef8f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quality Management AI-Powered Resume Screening
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered quality management solution for hr. Automates candidate screening using NLP and skills matching.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Skills extraction</li>
          <li className="text-gray-300">Matching algorithm</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">90% faster hiring</li>
          <li className="text-purple-300">Better candidates</li>
          </ul>
        </section>
