...
export const metadata: Metadata = {
  title: 'Autonomous API Analyzer',
  description: 'Transform your ecommerce operations with our Autonomous API Analyzer. This AI-driven solution automates campaign optimization with unprecedented accuracy and ef',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous API Analyzer
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your ecommerce operations with our Autonomous API Analyzer. This AI-driven solution automates campaign optimization with unprecedented accuracy and efficiency.
          </p>
