...
export const metadata: Metadata = {
  title: 'Smart Compliance Platform - Insurance #4',
  description: 'Next-generation insurance solution: Smart Compliance Platform - Insurance #4. Combines vendor management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-compliance-platform-insurance-4-4d5ce854',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Compliance Platform - Insurance #4
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Smart Compliance Platform - Insurance #4. Combines vendor management with adaptive intelligence for optimal results.
          </p>
