...
export const metadata = {
  ...
  description: 'End-to-end cloud security posture services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/cloud-security-posture-2026-7135/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">Cloud Security Posture</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end cloud security posture services: assessment, deployment, and managed operations.
        </p>
