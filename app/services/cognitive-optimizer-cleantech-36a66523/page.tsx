...
export const metadata: Metadata = {
  title: 'Cognitive optimizer-cleantech',
  description: 'Next-generation cleantech solution: Cognitive optimizer-cleantech. Combines resource optimization with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-optimizer-cleantech-36a66523',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive optimizer-cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation cleantech solution: Cognitive optimizer-cleantech. Combines resource optimization with adaptive intelligence for optimal results.
          </p>
