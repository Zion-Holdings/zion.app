...
export const metadata: Metadata = {
  title: 'Predictive Data Science Engine - Insurance',
  description: 'The future of insurance is here with Predictive Data Science Engine - Insurance. Powered by cutting-edge AI, this platform delivers employee engagement like nev',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-data-science-engine-insurance-283c6076',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Data Science Engine - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Predictive Data Science Engine - Insurance. Powered by cutting-edge AI, this platform delivers employee engagement like never before.
          </p>
