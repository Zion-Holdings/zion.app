...
export const metadata: Metadata = {
  title: 'Intelligent manager-healthcare',
  description: 'The future of healthcare is here with Intelligent manager-healthcare. Powered by cutting-edge AI, this platform delivers disaster recovery like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-manager-healthcare-33880134',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent manager-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Intelligent manager-healthcare. Powered by cutting-edge AI, this platform delivers disaster recovery like never before.
          </p>
