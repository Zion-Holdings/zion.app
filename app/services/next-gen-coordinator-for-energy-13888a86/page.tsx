...
export const metadata: Metadata = {
  title: 'Next-Gen Coordinator for Energy',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Coordinator for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your energy workflows with Next-Gen Coordinator for Energy. This intelligent platform delivers api composition through advanced automation and AI.
          </p>
