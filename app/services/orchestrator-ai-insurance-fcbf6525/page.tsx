...
export const metadata: Metadata = {
  title: 'Orchestrator AI - Insurance',
  description: 'Transform your insurance operations with our Orchestrator AI - Insurance. This AI-driven solution automates resource optimization with unprecedented accuracy an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/orchestrator-ai-insurance-fcbf6525',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Orchestrator AI - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Orchestrator AI - Insurance. This AI-driven solution automates resource optimization with unprecedented accuracy and efficiency.
          </p>
