      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in martech with Smart Customer Service Platform - MARTECH. This AI-powered platform transforms risk assessment into a competitive advantage.
          </p>
