...
export const metadata: Metadata = {
  title: "Affiliate Management AI-Powered Predictive Analytics Suite - AI-Powered Travel Solution",
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Affiliate Management AI-Powered Predictive Analytics Suite - AI-Powered Travel Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          affiliate management solution for travel industry. End-to-end predictive analytics platform that forecasts market trends, customer behavior, and operational met
        </p>
