...
export const metadata: Metadata = {
  title: 'Next-Gen Release Pipeline',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Release Pipeline
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your legal with Next-Gen Release Pipeline. Our autonomous solution handles manufacturing quality control end-to-end without human intervention.
          </p>
