...
export const metadata: Metadata = {
  title: 'Smart Invoice Orchestrator',
  description: 'Transform your manufacturing operations with our Smart Invoice Orchestrator. This AI-driven solution provides intelligent automation with unprecedented accuracy',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-invoice-orchestrator-91f20919',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Invoice Orchestrator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your manufacturing operations with our Smart Invoice Orchestrator. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
