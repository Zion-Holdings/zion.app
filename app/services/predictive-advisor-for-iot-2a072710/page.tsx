...
export const metadata: Metadata = {
  title: 'Predictive Advisor for Iot',
  description: 'Revolutionize iot through intelligent automation. Our Predictive Advisor for Iot leverages advanced machine learning to deliver financial risk management at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Advisor for Iot
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize iot through intelligent automation. Our Predictive Advisor for Iot leverages advanced machine learning to deliver financial risk management at scale.
          </p>
