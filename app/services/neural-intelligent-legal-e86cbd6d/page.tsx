...
export const metadata: Metadata = {
  title: 'Neural intelligent-legal',
  description: 'Transform your legal operations with our Neural intelligent-legal. This AI-driven solution automates social media monitoring with unprecedented accuracy and eff',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural intelligent-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Neural intelligent-legal. This AI-driven solution automates social media monitoring with unprecedented accuracy and efficiency.
          </p>
