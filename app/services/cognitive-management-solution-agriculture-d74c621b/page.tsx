...
export const metadata: Metadata = {
  title: 'Cognitive Management Solution - Agriculture',
  description: 'Drive innovation in agriculture with Cognitive Management Solution - Agriculture. This AI-powered platform transforms financial risk management into a competiti',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Management Solution - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in agriculture with Cognitive Management Solution - Agriculture. This AI-powered platform transforms financial risk management into a competitive advantage.
          </p>
