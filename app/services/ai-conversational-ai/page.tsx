...
export const metadata: Metadata = {
  ...
  keywords: 'No-code conversational AI builder, Natural language understanding (NLU), Voice agent with text-to-speech, Integration with CRM, knowledge base, ticketing, Multi-language support (50+ languages), Human handoff with full context, Analytics on conversation quality, Custom training with your data, ai, customer-service, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Conversational AI &amp; Voice Agent Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Build and deploy AI conversational agents for chat and voice. Handle customer service, sales, and internal support with natural language understanding.</p>
        ...
        <li class="text-slate-300">No-code conversational AI builder</li>
        <li class="text-slate-300">Natural language understanding (NLU)</li>
        <li class="text-slate-300">Voice agent with text-to-speech</li>
        <li class="text-slate-300">Integration with CRM, knowledge base, ticketing</li>
        <li class="text-slate-300">Multi-language support (50+ languages)</li>
        <li class="text-slate-300">Human handoff with full context</li>
        <li class="text-slate-300">Analytics on conversation quality</li>
        <li class="text-slate-300">Custom training with your data</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Handle 70% of inquiries without humans</li>
        <li class="text-slate-300">24/7 availability in 50+ languages</li>
        <li class="text-slate-300">Reduce support costs by 50%</li>
        <li class="text-slate-300">Improve CSAT with instant responses</li>
      </ul>
        </div>
