...
export const metadata: Metadata = {
  ...
  description: 'Optimize your manufacturing workflows with Intelligent risk-manufacturing. This intelligent platform delivers sentiment analysis through advanced automation and',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your manufacturing workflows with Intelligent risk-manufacturing. This intelligent platform delivers sentiment analysis through advanced automation and AI.
          </p>
