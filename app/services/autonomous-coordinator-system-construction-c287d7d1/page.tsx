...
export const metadata: Metadata = {
  title: 'Autonomous Coordinator System - Construction',
  description: 'Drive innovation in construction with Autonomous Coordinator System - Construction. This AI-powered platform transforms training optimization into a competitive',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Coordinator System - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Autonomous Coordinator System - Construction. This AI-powered platform transforms training optimization into a competitive advantage.
          </p>
