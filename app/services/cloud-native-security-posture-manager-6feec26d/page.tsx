...
export const metadata: Metadata = {
  title: 'Cloud-Native Security Posture Manager',
  description: 'Automated security compliance and threat detection across cloud environments.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cloud-native-security-posture-manager-6feec26d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cloud-Native Security Posture Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Automated security compliance and threat detection across cloud environments.
          </p>
