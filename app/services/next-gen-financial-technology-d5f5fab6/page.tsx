...
export const metadata: Metadata = {
  title: 'Next-Gen financial-technology',
  description: 'Enhance your technology business with Next-Gen financial-technology. Our solution provides security monitoring with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-financial-technology-d5f5fab6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your technology business with Next-Gen financial-technology. Our solution provides security monitoring with enterprise-grade reliability and security.
          </p>
