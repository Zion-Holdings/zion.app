...
export const metadata: Metadata = {
  title: 'Intelligent Manager Platform',
  description: 'Transform your legal operations with our Intelligent Manager Platform. This ai solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-manager-platform-49db08',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Manager Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Intelligent Manager Platform. This ai solution delivers unprecedented automation and intelligence.
          </p>
