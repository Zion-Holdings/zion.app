...
export const metadata: Metadata = {
  ...
  keywords: 'Drag-and-drop form builder, 100+ templates, Conditional logic, Payment collection (Stripe, PayPal), Analytics and conversion tracking, Custom branding, Zapier/Make integration, Multi-step forms with progress, micro-saas, Productivity, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">FormCraft — Form Builder Micro-SaaS</h1>
        <p className="text-lg text-slate-300 mb-8">Drag-and-drop form builder with 100+ templates, conditional logic, payment collection, and analytics. Create surveys, registrations, orders, and lead capture forms without code.</p>
        ...
        <li class="text-slate-300">Drag-and-drop form builder</li>
        <li class="text-slate-300">100+ templates</li>
        <li class="text-slate-300">Conditional logic</li>
        <li class="text-slate-300">Payment collection (Stripe, PayPal)</li>
        <li class="text-slate-300">Analytics and conversion tracking</li>
        <li class="text-slate-300">Custom branding</li>
        <li class="text-slate-300">Zapier/Make integration</li>
        <li class="text-slate-300">Multi-step forms with progress</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Build forms in minutes</li>
        <li class="text-slate-300">Increase form completion rates</li>
        <li class="text-slate-300">Collect payments seamlessly</li>
        <li class="text-slate-300">Integrate with existing tools</li>
      </ul>
        </div>
