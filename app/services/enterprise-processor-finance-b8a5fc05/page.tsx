...
export const metadata: Metadata = {
  title: 'Enterprise Processor - Finance',
  description: 'The future of finance is here with Enterprise Processor - Finance. Powered by cutting-edge AI, this platform delivers vendor management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-processor-finance-b8a5fc05',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Processor - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of finance is here with Enterprise Processor - Finance. Powered by cutting-edge AI, this platform delivers vendor management like never before.
          </p>
