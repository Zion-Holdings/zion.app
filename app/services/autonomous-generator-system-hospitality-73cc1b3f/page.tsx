...
export const metadata: Metadata = {
  title: 'Autonomous Generator System - Hospitality',
  description: 'The future of hospitality is here with Autonomous Generator System - Hospitality. Powered by cutting-edge AI, this platform delivers territory management like n',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-generator-system-hospitality-73cc1b3f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Generator System - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Autonomous Generator System - Hospitality. Powered by cutting-edge AI, this platform delivers territory management like never before.
          </p>
