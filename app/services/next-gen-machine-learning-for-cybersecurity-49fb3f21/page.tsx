...
export const metadata: Metadata = {
  title: 'Next-Gen Machine Learning for Cybersecurity',
  description: 'Next-generation cybersecurity solution: Next-Gen Machine Learning for Cybersecurity. Combines sustainability tracking with adaptive intelligence for optimal res',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Machine Learning for Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation cybersecurity solution: Next-Gen Machine Learning for Cybersecurity. Combines sustainability tracking with adaptive intelligence for optimal results.
          </p>
