...
export const metadata: Metadata = {
  ...
  keywords: 'Auto-discovery, CMDB, License optimization, Lifecycle management, Compliance tracking, Cost optimization, Integration (ServiceNow, JAMF), Reporting, it, IT Operations, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Asset Management &amp; Discovery</h1>
        <p className="text-lg text-slate-300 mb-8">Automated IT asset discovery, inventory, lifecycle management, and software license optimization. CMDB, compliance tracking, and cost optimization.</p>
        ...
        <li class="text-slate-300">Auto-discovery</li>
        <li class="text-slate-300">CMDB</li>
        ...
        <li class="text-slate-300">Integration (ServiceNow, JAMF)</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">30% license cost savings</li>
        <li class="text-slate-300">Full asset visibility</li>
        <li class="text-slate-300">Compliance automation</li>
        <li class="text-slate-300">Lifecycle optimization</li>
      </ul>
        </div>
