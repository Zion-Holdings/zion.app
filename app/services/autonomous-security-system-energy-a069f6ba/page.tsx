...
export const metadata: Metadata = {
  title: 'Autonomous Security System - Energy',
  description: 'Next-generation energy solution: Autonomous Security System - Energy. Combines recruitment automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-security-system-energy-a069f6ba',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Security System - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Autonomous Security System - Energy. Combines recruitment automation with adaptive intelligence for optimal results.
          </p>
