...
export const metadata: Metadata = {
  title: 'Cognitive Customer Solution - MARTECH',
  description: 'Enhance your martech business with Cognitive Customer Solution - MARTECH. Our solution provides stream processing with enterprise-grade reliability and security',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-customer-solution-martech-50a45fcc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Customer Solution - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your martech business with Cognitive Customer Solution - MARTECH. Our solution provides stream processing with enterprise-grade reliability and security.
          </p>
