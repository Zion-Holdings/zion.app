...
export const metadata: Metadata = {
  ...
  keywords: 'AI demand forecasting with 95% accuracy, Multi-echelon inventory optimization, Supplier risk scoring, Logistics route optimization, Warehouse automation planning, Scenario modeling and simulation, Integration with SAP, Oracle, Kinaxis, Real-time supply chain visibility, ai, logistics, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Supply Chain Optimization &amp; Demand Planning</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end supply chain optimization with demand forecasting, inventory optimization, and logistics route planning using advanced ML.</p>
        ...
        <li class="text-slate-300">AI demand forecasting with 95% accuracy</li>
        <li class="text-slate-300">Multi-echelon inventory optimization</li>
        <li class="text-slate-300">Supplier risk scoring</li>
        <li class="text-slate-300">Logistics route optimization</li>
        <li class="text-slate-300">Warehouse automation planning</li>
        <li class="text-slate-300">Scenario modeling and simulation</li>
        <li class="text-slate-300">Integration with SAP, Oracle, Kinaxis</li>
        <li class="text-slate-300">Real-time supply chain visibility</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce inventory costs by 25%</li>
        <li class="text-slate-300">Improve forecast accuracy by 40%</li>
        <li class="text-slate-300">Optimize logistics costs</li>
        <li class="text-slate-300">Mitigate supply chain risks</li>
      </ul>
        </div>
