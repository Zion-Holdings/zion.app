...
export const metadata: Metadata = {
  title: 'Intelligent Knowledge for HEALTHTECH',
  description: 'Optimize your healthtech workflows with Intelligent Knowledge for HEALTHTECH. This intelligent platform delivers invoice processing through advanced automation ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-knowledge-for-healthtech-d3462be5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Knowledge for HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthtech workflows with Intelligent Knowledge for HEALTHTECH. This intelligent platform delivers invoice processing through advanced automation and AI.
          </p>
