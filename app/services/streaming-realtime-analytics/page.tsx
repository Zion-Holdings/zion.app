...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-broker: Kafka/Redpanda + connectors, Flink/Spark Streaming windowed aggregation, Sub-second event to alert latency, Anomaly detection per metric stream (Z-score), Grafana/Looker real-time dashboard, data, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Real-Time Streaming Analytics</h1>
        <p className="text-lg text-slate-300 mb-8">Sub-second analytics on event streams: Kafka/Redpanda/PubSub to Flink/Spark — sessionization, windowed aggregates, anomaly detection. Sub-second refresh dashboard.</p>
        ...
        <li class="text-slate-300">Multi-broker: Kafka/Redpanda + connectors</li>
        <li class="text-slate-300">Flink/Spark Streaming windowed aggregation</li>
        <li class="text-slate-300">Sub-second event to alert latency</li>
        <li class="text-slate-300">Anomaly detection per metric stream (Z-score)</li>
        <li class="text-slate-300">Grafana/Looker real-time dashboard</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with real-time streaming analytics</li>
