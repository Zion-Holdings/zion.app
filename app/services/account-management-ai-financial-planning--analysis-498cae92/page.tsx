...
export const metadata: Metadata = {
  title: "Account Management AI Financial Planning & Analysis - AI-Powered Defense Solution",
  description: "account management solution for defense industry. Generates financial forecasts, budget plans, and performance analyses using machine learning models.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/account-management-ai-financial-planning--analysis-498cae92",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Account Management AI Financial Planning & Analysis - AI-Powered Defense Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          account management solution for defense industry. Generates financial forecasts, budget plans, and performance analyses using machine learning models.
        </p>
