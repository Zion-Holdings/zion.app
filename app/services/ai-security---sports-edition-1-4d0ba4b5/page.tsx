...
export const metadata: Metadata = {
  title: 'AI Security - Sports Edition #1',
  description: 'The future of sports is here with AI Security - Sports Edition #1. Powered by cutting-edge AI, this platform delivers healthcare data analytics like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-security---sports-edition-1-4d0ba4b5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Security - Sports Edition #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with AI Security - Sports Edition #1. Powered by cutting-edge AI, this platform delivers healthcare data analytics like never before.
          </p>
