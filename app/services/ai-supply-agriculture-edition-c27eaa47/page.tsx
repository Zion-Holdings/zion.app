...
export const metadata: Metadata = {
  title: 'AI Supply - Agriculture Edition',
  description: 'Next-generation agriculture solution: AI Supply - Agriculture Edition. Combines recruitment automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-supply-agriculture-edition-c27eaa47',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Supply - Agriculture Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agriculture solution: AI Supply - Agriculture Edition. Combines recruitment automation with adaptive intelligence for optimal results.
          </p>
