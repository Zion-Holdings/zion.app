...
export const metadata: Metadata = {
  ...
  keywords: 'Auto-generate citations from URLs, DOIs, ISBNs, 9 citation styles (APA, MLA, Chicago, etc.), Reference library management, Duplicate detection, Browser extension for one-click capture, Collaborative bibliography, Word/Google Docs plugin, Batch import (BibTeX, RIS), ai, Education, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Citation Generation Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Automatic citation generation and management for academic and professional writing. Supports APA, MLA, Chicago, Harvard, and Vancouver styles. Reference management with duplicate detection.</p>
        ...
        <li class="text-slate-300">Auto-generate citations from URLs, DOIs, ISBNs</li>
        <li class="text-slate-300">9 citation styles (APA, MLA, Chicago, etc.)</li>
        <li class="text-slate-300">Reference library management</li>
        <li class="text-slate-300">Duplicate detection</li>
        <li class="text-slate-300">Browser extension for one-click capture</li>
        <li class="text-slate-300">Collaborative bibliography</li>
        <li class="text-slate-300">Word/Google Docs plugin</li>
        <li class="text-slate-300">Batch import (BibTeX, RIS)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Save hours on citation formatting</li>
        <li class="text-slate-300">Never miss a citation requirement</li>
        <li class="text-slate-300">Consistent formatting guarantee</li>
        <li class="text-slate-300">Collaborative research support</li>
      </ul>
        </div>
