...
export const metadata: Metadata = {
  title: 'Customer Service AI - Agritech',
  description: 'Revolutionize agritech through intelligent automation. Our Customer Service AI - Agritech leverages advanced machine learning to deliver supply chain at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/customer-service-ai---agritech-5585a0ac',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Customer Service AI - Agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agritech through intelligent automation. Our Customer Service AI - Agritech leverages advanced machine learning to deliver supply chain at scale.
          </p>
