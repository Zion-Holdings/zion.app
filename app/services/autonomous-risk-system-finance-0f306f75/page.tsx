...
export const metadata: Metadata = {
  title: 'Autonomous Risk System - Finance',
  description: 'Drive innovation in finance with Autonomous Risk System - Finance. This AI-powered platform transforms decision support into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-risk-system-finance-0f306f75',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Risk System - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in finance with Autonomous Risk System - Finance. This AI-powered platform transforms decision support into a competitive advantage.
          </p>
