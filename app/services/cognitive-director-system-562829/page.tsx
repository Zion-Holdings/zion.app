...
export const metadata: Metadata = {
  title: 'Cognitive Director System',
  description: 'Transform your education operations with our Cognitive Director System. This security solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-director-system-562829',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Director System
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your education operations with our Cognitive Director System. This security solution delivers unprecedented automation and intelligence.
          </p>
