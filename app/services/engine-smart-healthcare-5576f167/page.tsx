...
export const metadata: Metadata = {
  title: 'Engine Smart - Healthcare',
  description: 'The future of healthcare is here with Engine Smart - Healthcare. Powered by cutting-edge AI, this platform delivers manufacturing quality control like never bef',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Engine Smart - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Engine Smart - Healthcare. Powered by cutting-edge AI, this platform delivers manufacturing quality control like never before.
          </p>
