...
export const metadata: Metadata = {
  title: 'Machine Learning Autonomous - Construction',
  description: 'Enhance your construction business with Machine Learning Autonomous - Construction. Our solution provides healthcare data analytics with enterprise-grade reliab',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Machine Learning Autonomous - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Machine Learning Autonomous - Construction. Our solution provides healthcare data analytics with enterprise-grade reliability and security.
          </p>
