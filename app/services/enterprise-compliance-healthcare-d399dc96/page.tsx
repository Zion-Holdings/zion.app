...
export const metadata: Metadata = {
  title: 'Enterprise Compliance - Healthcare',
  description: 'Transform healthcare with Enterprise Compliance - Healthcare - the intelligent automation platform that learns, adapts, and delivers 10x results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-compliance-healthcare-d399dc96',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform healthcare with Enterprise Compliance - Healthcare - the intelligent automation platform that learns, adapts, and delivers 10x results.
          </p>
