...
export const metadata: Metadata = {
  title: 'Cognitive Automation Solution - Sports',
  description: 'Transform your sports operations with our Cognitive Automation Solution - Sports. This AI-driven solution automates api management with unprecedented accuracy a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Automation Solution - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our Cognitive Automation Solution - Sports. This AI-driven solution automates api management with unprecedented accuracy and efficiency.
          </p>
