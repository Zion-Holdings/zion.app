...
export const metadata: Metadata = {
  ...
  keywords: '24/7/365 Tier-1/2 support (phone, chat, email), Remote desktop access & fix (TeamViewer, AnyDesk), Onboarding/offboarding automation, Incident ticketing & SLA management, Knowledge base & self-service portal, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Remote IT Support &amp; Helpdesk Outsourcing</h1>
        <p className="text-lg text-slate-300 mb-8">24/7 outsourced IT helpdesk and desktop support for distributed workforces: remote troubleshooting, incident management, and user onboarding.</p>
        ...
        <li class="text-slate-300">24/7/365 Tier-1/2 support (phone, chat, email)</li>
        <li class="text-slate-300">Remote desktop access &amp; fix (TeamViewer, AnyDesk)</li>
        <li class="text-slate-300">Onboarding/offboarding automation</li>
        <li class="text-slate-300">Incident ticketing &amp; SLA management</li>
        <li class="text-slate-300">Knowledge base &amp; self-service portal</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with remote it support &amp; helpdesk outsourcing</li>
