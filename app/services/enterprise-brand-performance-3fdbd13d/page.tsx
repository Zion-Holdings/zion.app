...
export const metadata: Metadata = {
  title: 'Enterprise Brand Performance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in real-estate with Enterprise Brand Performance. This AI-powered platform transforms sustainability tracking into a competitive advantage.
          </p>
