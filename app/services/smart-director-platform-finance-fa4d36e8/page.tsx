...
export const metadata: Metadata = {
  title: 'Smart Director Platform - Finance',
  description: 'Drive innovation in finance with Smart Director Platform - Finance. This AI-powered platform transforms decision support into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-director-platform-finance-fa4d36e8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Director Platform - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in finance with Smart Director Platform - Finance. This AI-powered platform transforms decision support into a competitive advantage.
          </p>
