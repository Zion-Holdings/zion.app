...
export const metadata: Metadata = {
  title: 'Enterprise Processor Platform - REGTECH',
  description: 'Optimize your regtech workflows with Enterprise Processor Platform - REGTECH. This intelligent platform delivers model interpretability through advanced automat',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-processor-platform-regtech-740e1469',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Processor Platform - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your regtech workflows with Enterprise Processor Platform - REGTECH. This intelligent platform delivers model interpretability through advanced automation and AI.
          </p>
