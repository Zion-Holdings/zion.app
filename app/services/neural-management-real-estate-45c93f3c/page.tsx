...
export const metadata: Metadata = {
  title: 'Neural management-real-estate',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural management-real-estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our Neural management-real-estate leverages advanced machine learning to deliver hr analytics at scale.
          </p>
