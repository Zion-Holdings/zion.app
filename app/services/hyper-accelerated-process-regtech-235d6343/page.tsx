...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Process - REGTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Process - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of regtech is here with Hyper-Accelerated Process - REGTECH. Powered by cutting-edge AI, this platform delivers microservices mesh like never before.
          </p>
