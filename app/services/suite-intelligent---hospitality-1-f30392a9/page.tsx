...
export const metadata: Metadata = {
  title: 'Suite Intelligent - Hospitality #1',
  description: 'Transform your hospitality operations with our Suite Intelligent - Hospitality #1. This AI-driven solution automates data processing with unprecedented accuracy',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Suite Intelligent - Hospitality #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Suite Intelligent - Hospitality #1. This AI-driven solution automates data processing with unprecedented accuracy and efficiency.
          </p>
