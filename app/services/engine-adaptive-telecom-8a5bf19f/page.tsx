...
export const metadata: Metadata = {
  title: 'Engine Adaptive - Telecom',
  description: 'Optimize your telecom workflows with Engine Adaptive - Telecom. This intelligent platform delivers automation opportunity through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/engine-adaptive-telecom-8a5bf19f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Engine Adaptive - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your telecom workflows with Engine Adaptive - Telecom. This intelligent platform delivers automation opportunity through advanced automation and AI.
          </p>
