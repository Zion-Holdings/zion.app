...
export const metadata: Metadata = {
  title: 'Policy Management AI-Powered Data Quality Manager',
  description: 'policy management solution for proptech industry. Automatically detects, corrects, and prevents data quality issues using machine learning.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/policy-management-ai-powered-data-quality-manager-6ddca204',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Policy Management AI-Powered Data Quality Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            policy management solution for proptech industry. Automatically detects, corrects, and prevents data quality issues using machine learning.
          </p>
