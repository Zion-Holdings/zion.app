...
export const metadata: Metadata = {
  title: 'Enterprise Marketing for Sports',
  description: 'Transform your sports operations with our Enterprise Marketing for Sports. This AI-driven solution automates root cause analysis with unprecedented accuracy and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-marketing-for-sports-249d75fc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Marketing for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our Enterprise Marketing for Sports. This AI-driven solution automates root cause analysis with unprecedented accuracy and efficiency.
          </p>
