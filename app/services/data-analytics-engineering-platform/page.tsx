...
export const metadata: Metadata = {
  ...
  keywords: 'dbt model orchestration + Freshness SLA, Column-level lineage graph UI, Semantic Layer (Looker/dbt-metricflow), In-browser SQL editor + scheduler, data, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Analytics Engineering Platform</h1>
        <p className="text-lg text-slate-300 mb-8">dbt core orchestration, lineage graph, semantic layer, freshness SLAs, and an in-browser model explorer for SQL analysts.</p>
        ...
        <li class="text-slate-300">dbt model orchestration + Freshness SLA</li>
        <li class="text-slate-300">Column-level lineage graph UI</li>
        <li class="text-slate-300">Semantic Layer (Looker/dbt-metricflow)</li>
        <li class="text-slate-300">In-browser SQL editor + scheduler</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with analytics engineering platform</li>
