...
export const metadata: Metadata = {
  title: 'Smart Insights Platform - Telecom',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Insights Platform - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of telecom is here with Smart Insights Platform - Telecom. Powered by cutting-edge AI, this platform delivers employee engagement like never before.
          </p>
