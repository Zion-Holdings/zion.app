...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time transcription with speaker diarisation, Action item and decision extraction, Multi-platform calendar sync, Shareable branded summary packs, Slack and email distribution, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Meeting Notes &amp; Summary Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Auto-record, transcribe, and summarise every meeting with action items, decisions, and speaker attribution. Integrates with Zoom, Teams, Google Meet, and Slack.</p>
        ...
        <li class="text-slate-300">Real-time transcription with speaker diarisation</li>
        <li class="text-slate-300">Action item and decision extraction</li>
        <li class="text-slate-300">Multi-platform calendar sync</li>
        <li class="text-slate-300">Shareable branded summary packs</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai meeting notes &amp; summary platform</li>
