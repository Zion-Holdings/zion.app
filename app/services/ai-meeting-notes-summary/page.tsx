      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Auto-record, transcribe, and summarise every meeting with action items, decisions, and speaker attribution. Integrates with Zoom, Teams, Google Meet, and Slack.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Real-time transcription with speaker diarisation</li>
            <li className="text-purple-300">✓ Action item and decision extraction</li>
            <li className="text-purple-300">✓ Multi-platform calendar sync</li>
            <li className="text-purple-300">✓ Shareable branded summary packs</li>
            <li className="text-purple-300">✓ Slack and email distribution</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai meeting notes & summary platform</li>
