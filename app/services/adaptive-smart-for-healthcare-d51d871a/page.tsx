...
export const metadata: Metadata = {
  title: 'Adaptive Smart for Healthcare',
  description: 'Transform your healthcare operations with our Adaptive Smart for Healthcare. This AI-driven solution automates influencer identification with unprecedented accu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Smart for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Adaptive Smart for Healthcare. This AI-driven solution automates influencer identification with unprecedented accuracy and efficiency.
          </p>
