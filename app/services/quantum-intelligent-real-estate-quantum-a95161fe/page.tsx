...
export const metadata: Metadata = {
  title: 'Quantum Intelligent - Real-Estate Quantum',
  description: 'Drive innovation in real-estate with Quantum Intelligent - Real-Estate Quantum. This AI-powered platform transforms compliance automation into a competitive adv',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Intelligent - Real-Estate Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in real-estate with Quantum Intelligent - Real-Estate Quantum. This AI-powered platform transforms compliance automation into a competitive advantage.
          </p>
