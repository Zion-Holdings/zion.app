...
export const metadata: Metadata = {
  title: 'Autonomous Advisor System - Hospitality',
  description: 'Drive innovation in hospitality with Autonomous Advisor System - Hospitality. This AI-powered platform transforms feedback collection into a competitive advanta',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-advisor-system-hospitality-ecda32d3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Advisor System - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Autonomous Advisor System - Hospitality. This AI-powered platform transforms feedback collection into a competitive advantage.
          </p>
