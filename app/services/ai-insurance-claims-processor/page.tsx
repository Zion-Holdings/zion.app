...
export const metadata: Metadata = {
  ...
  keywords: 'Photo-based damage assessment (auto, home, health), Fraud pattern detection (97% accuracy), Policy coverage auto-verification, Payout calculation with approval workflow, Regulatory compliance docs, Customer self-service portal, ai, Insurance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">End-to-end claims automation: damage assessment from photos, fraud detection, policy verification, payout calculation. Processes claims 80% faster.</p>
        ...
        <li class="text-slate-300">Photo-based damage assessment (auto, home, health)</li>
        <li class="text-slate-300">Fraud pattern detection (97% accuracy)</li>
        <li class="text-slate-300">Policy coverage auto-verification</li>
        <li class="text-slate-300">Payout calculation with approval workflow</li>
        <li class="text-slate-300">Regulatory compliance docs</li>
        <li class="text-slate-300">Customer self-service portal</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Process claims 80% faster</li>
        <li class="text-slate-300">Reduce fraud by 60%</li>
        <li class="text-slate-300">40% fewer processing errors</li>
      </ul>
        </div>
