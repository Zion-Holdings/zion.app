...
export const metadata: Metadata = {
  title: 'Intelligent Performance Director',
  description: 'Transform your telecom operations with our Intelligent Performance Director. This AI-driven solution automates survey automation with unprecedented accuracy and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-performance-director-f2a1ee45',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Performance Director
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your telecom operations with our Intelligent Performance Director. This AI-driven solution automates survey automation with unprecedented accuracy and efficiency.
          </p>
