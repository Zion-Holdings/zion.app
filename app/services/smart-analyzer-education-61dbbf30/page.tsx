...
export const metadata: Metadata = {
  title: 'Smart analyzer-education',
  description: 'Transform your education operations with our Smart analyzer-education. This AI-driven solution automates content generation with unprecedented accuracy and effi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart analyzer-education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your education operations with our Smart analyzer-education. This AI-driven solution automates content generation with unprecedented accuracy and efficiency.
          </p>
