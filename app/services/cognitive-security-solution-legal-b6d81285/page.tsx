...
export const metadata: Metadata = {
  title: 'Cognitive Security Solution - Legal',
  description: 'Unlock unprecedented growth with Cognitive Security Solution - Legal. This autonomous system provides cost reduction with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-security-solution-legal-b6d81285',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Security Solution - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Cognitive Security Solution - Legal. This autonomous system provides cost reduction with zero manual intervention needed.
          </p>
