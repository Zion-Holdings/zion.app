...
export const metadata: Metadata = {
  title: 'Intelligent Experience for Energy',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Experience for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Intelligent Experience for Energy. This AI-powered platform transforms master data management into a competitive advantage.
          </p>
