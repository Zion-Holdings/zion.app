...
export const metadata: Metadata = {
  title: 'Smart Compliance Platform - REGTECH',
  description: 'Revolutionize regtech through intelligent automation. Our Smart Compliance Platform - REGTECH leverages advanced machine learning to deliver access management a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Compliance Platform - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize regtech through intelligent automation. Our Smart Compliance Platform - REGTECH leverages advanced machine learning to deliver access management at scale.
          </p>
