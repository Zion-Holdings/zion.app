...
export const metadata: Metadata = {
  title: 'Autonomous Generator for Automotive #1',
  description: 'Next-generation automotive solution: Autonomous Generator for Automotive #1. Combines image recognition with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-generator-for-automotive-1-ec81927a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Generator for Automotive #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation automotive solution: Autonomous Generator for Automotive #1. Combines image recognition with adaptive intelligence for optimal results.
          </p>
