...
export const metadata: Metadata = {
  title: 'AI Generator - Construction Edition',
  description: 'The future of construction is here with AI Generator - Construction Edition. Powered by cutting-edge AI, this platform delivers predictive analytics like never ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-generator-construction-edition-81cd95e4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Generator - Construction Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with AI Generator - Construction Edition. Powered by cutting-edge AI, this platform delivers predictive analytics like never before.
          </p>
