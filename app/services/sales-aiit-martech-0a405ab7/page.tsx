      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize martech through intelligent automation. Our Sales AI/IT - MARTECH leverages advanced machine learning to deliver customer insights at scale.
          </p>
