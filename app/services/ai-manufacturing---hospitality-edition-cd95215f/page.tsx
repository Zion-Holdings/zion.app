...
export const metadata: Metadata = {
  title: 'AI Manufacturing - Hospitality Edition',
  description: 'Revolutionize hospitality through intelligent automation. Our AI Manufacturing - Hospitality Edition leverages advanced machine learning to deliver data process',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-manufacturing---hospitality-edition-cd95215f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Manufacturing - Hospitality Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our AI Manufacturing - Hospitality Edition leverages advanced machine learning to deliver data processing at scale.
          </p>
