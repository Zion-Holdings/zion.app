...
export const metadata: Metadata = {
  title: 'AI AI-Powered Contract Analysis',
  description: 'AI-powered ai solution for legal. Analyzes legal contracts and agreements using NLP to extract key terms and risks.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-ai-powered-contract-analysis-d6c131bd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI AI-Powered Contract Analysis
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered ai solution for legal. Analyzes legal contracts and agreements using NLP to extract key terms and risks.
          </p>
