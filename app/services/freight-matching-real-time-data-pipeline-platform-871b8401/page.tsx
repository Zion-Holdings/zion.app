...
export const metadata: Metadata = {
  title: 'Freight Matching Real-Time Data Pipeline Platform',
  description: 'AI-powered freight matching solution for data engineering. Creates and manages real-time data pipelines with automated ETL and streaming analytics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/freight-matching-real-time-data-pipeline-platform-871b8401',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Freight Matching Real-Time Data Pipeline Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered freight matching solution for data engineering. Creates and manages real-time data pipelines with automated ETL and streaming analytics.
          </p>
