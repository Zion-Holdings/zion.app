...
export const metadata: Metadata = {
  title: 'Healthcare AI-Powered Predictive Analytics Platform',
  description: 'AI-powered healthcare solution leveraging advanced machine learning for optimal performance and ROI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/healthcare-ai-powered-predictive-analytics-platform-d12fdf6a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Healthcare AI-Powered Predictive Analytics Platform
          </h1>
