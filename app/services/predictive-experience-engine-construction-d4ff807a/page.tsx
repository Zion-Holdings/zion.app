...
export const metadata: Metadata = {
  title: 'Predictive Experience Engine - Construction',
  description: 'Next-generation construction solution: Predictive Experience Engine - Construction. Combines ml model training with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-experience-engine-construction-d4ff807a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Experience Engine - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Predictive Experience Engine - Construction. Combines ml model training with adaptive intelligence for optimal results.
          </p>
