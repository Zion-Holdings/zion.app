...
export const metadata: Metadata = {
  title: 'Quantum DevOps - Insurance Quantum',
  description: 'The future of insurance is here with Quantum DevOps - Insurance Quantum. Powered by cutting-edge AI, this platform delivers performance reviews like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-devops-insurance-quantum-70565103',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum DevOps - Insurance Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Quantum DevOps - Insurance Quantum. Powered by cutting-edge AI, this platform delivers performance reviews like never before.
          </p>
