...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Logistics Analyzer',
  description: 'The future of cybersecurity is here with Hyper-Accelerated Logistics Analyzer. Powered by cutting-edge AI, this platform delivers click automation like never be',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Logistics Analyzer
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of cybersecurity is here with Hyper-Accelerated Logistics Analyzer. Powered by cutting-edge AI, this platform delivers click automation like never before.
          </p>
