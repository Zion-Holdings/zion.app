...
export const metadata: Metadata = {
  title: 'Predictive computer vision-hospitality',
  description: 'The future of hospitality is here with Predictive computer vision-hospitality. Powered by cutting-edge AI, this platform delivers data pipeline orchestration li',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive computer vision-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Predictive computer vision-hospitality. Powered by cutting-edge AI, this platform delivers data pipeline orchestration like never before.
          </p>
