...
export const metadata: Metadata = {
  title: 'Autonomous Advisor Engine',
  description: 'Transform your healthcare operations with our Autonomous Advisor Engine. This security solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-advisor-engine-58cc21',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Autonomous Advisor Engine. This security solution delivers unprecedented automation and intelligence.
          </p>
