...
export const metadata: Metadata = {
  ...
  description: 'Drive innovation in agriculture with Automated Generator for Agriculture. This AI-powered platform transforms forecast accuracy into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-generator-for-agriculture-2e76b21e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in agriculture with Automated Generator for Agriculture. This AI-powered platform transforms forecast accuracy into a competitive advantage.
          </p>
