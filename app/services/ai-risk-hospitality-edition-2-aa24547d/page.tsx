...
export const metadata: Metadata = {
  title: 'AI Risk - Hospitality Edition #2',
  description: 'The future of hospitality is here with AI Risk - Hospitality Edition #2. Powered by cutting-edge AI, this platform delivers sourcing optimization like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-risk-hospitality-edition-2-aa24547d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Risk - Hospitality Edition #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with AI Risk - Hospitality Edition #2. Powered by cutting-edge AI, this platform delivers sourcing optimization like never before.
          </p>
