...
export const metadata: Metadata = {
  title: 'Smart Management Platform - Healthcare',
  description: 'Enhance your healthcare business with Smart Management Platform - Healthcare. Our solution provides brand sentiment with enterprise-grade reliability and securi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-management-platform-healthcare-00771a24',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Management Platform - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with Smart Management Platform - Healthcare. Our solution provides brand sentiment with enterprise-grade reliability and security.
          </p>
