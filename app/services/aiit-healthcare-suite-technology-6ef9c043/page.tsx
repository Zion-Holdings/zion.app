...
export const metadata: Metadata = {
  title: 'AI/IT Healthcare Suite - TECHNOLOGY',
  description: 'The future of technology is here with AI/IT Healthcare Suite - TECHNOLOGY. Powered by cutting-edge AI, this platform delivers microservices mesh like never befo',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Healthcare Suite - TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of technology is here with AI/IT Healthcare Suite - TECHNOLOGY. Powered by cutting-edge AI, this platform delivers microservices mesh like never before.
          </p>
