...
export const metadata: Metadata = {
  title: 'Infrastructure Monitoring AI-Powered Log Management',
  description: 'AI-powered infrastructure monitoring solution for devops. Centralized log management with AI-powered analysis and alerting.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/infrastructure-monitoring-ai-powered-log-management-0c577b8f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Infrastructure Monitoring AI-Powered Log Management
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered infrastructure monitoring solution for devops. Centralized log management with AI-powered analysis and alerting.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">AI analysis</li>
          <li className="text-gray-300">Alerting</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">Better insights</li>
          <li className="text-purple-300">Proactive alerts</li>
          </ul>
        </section>
