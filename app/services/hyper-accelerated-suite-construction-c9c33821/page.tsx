...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Suite - Construction',
  description: 'Optimize your construction workflows with Hyper-Accelerated Suite - Construction. This intelligent platform delivers business intelligence through advanced auto',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Suite - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Hyper-Accelerated Suite - Construction. This intelligent platform delivers business intelligence through advanced automation and AI.
          </p>
