...
export const metadata: Metadata = {
  title: 'Intelligent Support for Media',
  description: 'Revolutionize media through intelligent automation. Our Intelligent Support for Media leverages advanced machine learning to deliver churn prediction at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-support-for-media-a67438cf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Support for Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize media through intelligent automation. Our Intelligent Support for Media leverages advanced machine learning to deliver churn prediction at scale.
          </p>
