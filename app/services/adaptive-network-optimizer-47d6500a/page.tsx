...
export const metadata: Metadata = {
  title: 'Adaptive Network Optimizer',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in education with Adaptive Network Optimizer. This AI-powered platform transforms recruitment automation into a competitive advantage.
          </p>
