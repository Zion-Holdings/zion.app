...
export const metadata: Metadata = {
  title: 'AI/IT Autonomous Suite - MARTECH',
  description: 'Unlock unprecedented growth with AI/IT Autonomous Suite - MARTECH. This autonomous system provides quality prediction with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-autonomous-suite-martech-e98a148f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Autonomous Suite - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with AI/IT Autonomous Suite - MARTECH. This autonomous system provides quality prediction with zero manual intervention needed.
          </p>
