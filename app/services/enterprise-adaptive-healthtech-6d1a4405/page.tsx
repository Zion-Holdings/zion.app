...
export const metadata: Metadata = {
  title: 'Enterprise Adaptive - HEALTHTECH',
  description: 'Drive innovation in healthtech with Enterprise Adaptive - HEALTHTECH. This AI-powered platform transforms healthcare data analytics into a competitive advantage',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-adaptive-healthtech-6d1a4405',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Adaptive - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthtech with Enterprise Adaptive - HEALTHTECH. This AI-powered platform transforms healthcare data analytics into a competitive advantage.
          </p>
