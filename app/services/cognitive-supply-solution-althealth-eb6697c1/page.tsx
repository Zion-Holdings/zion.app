...
export const metadata: Metadata = {
  title: 'Cognitive Supply Solution - ALTHEALTH',
  description: 'Optimize your althealth workflows with Cognitive Supply Solution - ALTHEALTH. This intelligent platform delivers customer service automation through advanced au',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Supply Solution - ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your althealth workflows with Cognitive Supply Solution - ALTHEALTH. This intelligent platform delivers customer service automation through advanced automation and AI.
          </p>
