...
export const metadata: Metadata = {
  title: 'Intelligent Insights for Automotive',
  description: 'Enhance your automotive business with Intelligent Insights for Automotive. Our solution provides disaster recovery with enterprise-grade reliability and securit',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-insights-for-automotive-474c43d7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Insights for Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your automotive business with Intelligent Insights for Automotive. Our solution provides disaster recovery with enterprise-grade reliability and security.
          </p>
