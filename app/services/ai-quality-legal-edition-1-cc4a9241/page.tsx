...
export const metadata: Metadata = {
  title: 'AI Quality - Legal Edition #1',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Quality - Legal Edition #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with AI Quality - Legal Edition #1. This AI-powered platform transforms data pipeline orchestration into a competitive advantage.
          </p>
