...
export const metadata: Metadata = {
  ...
  keywords: 'ML-powered demand forecasting at SKU level, Multi-echelon inventory optimization, Supplier risk intelligence and monitoring, Logistics route optimization with cost modeling, Carbon footprint tracking and reduction, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Supply Chain Optimization &amp; Demand Forecasting</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end supply chain intelligence with ML demand forecasting, inventory optimization, supplier risk scoring, and logistics route planning.</p>
        ...
        <li class="text-slate-300">ML-powered demand forecasting at SKU level</li>
        <li class="text-slate-300">Multi-echelon inventory optimization</li>
        <li class="text-slate-300">Supplier risk intelligence and monitoring</li>
        <li class="text-slate-300">Logistics route optimization with cost modeling</li>
        <li class="text-slate-300">Carbon footprint tracking and reduction</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai supply chain optimization &amp; demand forecasting</li>
