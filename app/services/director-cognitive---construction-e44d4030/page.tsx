...
export const metadata: Metadata = {
  ...
  keywords: 'Custom integrations, Machine learning integration, Offline capabilities, Edge computing support, GDPR compliance, predictor, construction, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Director Cognitive - Construction</h1>
        <p className="text-lg text-slate-300 mb-8">Revolutionize construction through intelligent automation. Our Director Cognitive - Construction leverages advanced machine learning to deliver process automation at scale.</p>
