...
export const metadata: Metadata = {
  title: 'Autonomous Real Estate System - Hospitality',
  description: 'The future of hospitality is here with Autonomous Real Estate System - Hospitality. Powered by cutting-edge AI, this platform delivers resource allocation like ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-real-estate-system-hospitality-44cfde1a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Real Estate System - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Autonomous Real Estate System - Hospitality. Powered by cutting-edge AI, this platform delivers resource allocation like never before.
          </p>
