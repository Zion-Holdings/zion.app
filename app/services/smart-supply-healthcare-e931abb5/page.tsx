...
export const metadata: Metadata = {
  title: 'Smart Supply Healthcare',
  description: 'The future of technology is here with Smart Supply Healthcare. Powered by cutting-edge AI, this platform delivers testing automation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-supply-healthcare-e931abb5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Supply Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of technology is here with Smart Supply Healthcare. Powered by cutting-edge AI, this platform delivers testing automation like never before.
          </p>
