...
export const metadata: Metadata = {
  title: 'Cognitive Cloud Solution - Energy #1',
  description: 'Drive innovation in energy with Cognitive Cloud Solution - Energy #1. This AI-powered platform transforms hr analytics into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-cloud-solution-energy-1-7a75366b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Cloud Solution - Energy #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Cognitive Cloud Solution - Energy #1. This AI-powered platform transforms hr analytics into a competitive advantage.
          </p>
