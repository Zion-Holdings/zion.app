...
export const metadata: Metadata = {
  title: 'Enterprise Cloud Platform - AITECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Cloud Platform - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation aitech solution: Enterprise Cloud Platform - AITECH. Combines survey automation with adaptive intelligence for optimal results.
          </p>
