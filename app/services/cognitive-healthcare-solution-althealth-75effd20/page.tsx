...
export const metadata: Metadata = {
  title: 'Cognitive Healthcare Solution - ALTHEALTH',
  description: 'Optimize your althealth workflows with Cognitive Healthcare Solution - ALTHEALTH. This intelligent platform delivers customer journey mapping through advanced a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-healthcare-solution-althealth-75effd20',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Healthcare Solution - ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your althealth workflows with Cognitive Healthcare Solution - ALTHEALTH. This intelligent platform delivers customer journey mapping through advanced automation and AI.
          </p>
