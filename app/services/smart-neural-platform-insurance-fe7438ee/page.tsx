...
export const metadata: Metadata = {
  title: 'Smart Neural Platform - Insurance',
  description: 'Transform your insurance operations with our Smart Neural Platform - Insurance. This AI-driven solution automates data pipeline orchestration with unprecedented',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Neural Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Smart Neural Platform - Insurance. This AI-driven solution automates data pipeline orchestration with unprecedented accuracy and efficiency.
          </p>
