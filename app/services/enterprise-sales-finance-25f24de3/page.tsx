...
export const metadata: Metadata = {
  title: 'Enterprise Sales - Finance',
  description: 'Optimize your finance workflows with Enterprise Sales - Finance. This intelligent platform delivers churn risk through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-sales-finance-25f24de3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Sales - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your finance workflows with Enterprise Sales - Finance. This intelligent platform delivers churn risk through advanced automation and AI.
          </p>
