...
export const metadata: Metadata = {
  title: 'Telecom Analytics AI-Powered Lead Scoring & Routing',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Telecom Analytics AI-Powered Lead Scoring & Routing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered telecom analytics solution for sales. Scores and routes sales leads in real-time based on engagement.
          </p>
