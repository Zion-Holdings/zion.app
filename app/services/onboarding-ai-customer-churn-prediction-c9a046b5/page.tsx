...
export const metadata: Metadata = {
  title: 'Onboarding AI Customer Churn Prediction',
  description: 'onboarding solution for water & wastewater industry. Identifies at-risk customers before they churn using behavioral patterns and engagement metrics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/onboarding-ai-customer-churn-prediction-c9a046b5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Onboarding AI Customer Churn Prediction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            onboarding solution for water & wastewater industry. Identifies at-risk customers before they churn using behavioral patterns and engagement metrics.
          </p>
