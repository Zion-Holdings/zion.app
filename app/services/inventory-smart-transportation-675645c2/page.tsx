...
export const metadata: Metadata = {
  title: 'Inventory Smart - Transportation',
  description: 'Optimize your transportation workflows with Inventory Smart - Transportation. This intelligent platform delivers supply chain through advanced automation and AI',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/inventory-smart-transportation-675645c2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Inventory Smart - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Inventory Smart - Transportation. This intelligent platform delivers supply chain through advanced automation and AI.
          </p>
