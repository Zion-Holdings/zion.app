...
export const metadata: Metadata = {
  title: 'Intelligent Manufacturing for Finance',
  description: 'Enhance your finance business with Intelligent Manufacturing for Finance. Our solution provides customer service automation with enterprise-grade reliability an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-manufacturing-for-finance-c7f9c9c3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Manufacturing for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your finance business with Intelligent Manufacturing for Finance. Our solution provides customer service automation with enterprise-grade reliability and security.
          </p>
