...
export const metadata: Metadata = {
  title: 'Cognitive security-retail',
  description: 'Revolutionize retail through intelligent automation. Our Cognitive security-retail leverages advanced machine learning to deliver manufacturing quality control ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-security-retail-2f685f46',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive security-retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize retail through intelligent automation. Our Cognitive security-retail leverages advanced machine learning to deliver manufacturing quality control at scale.
          </p>
