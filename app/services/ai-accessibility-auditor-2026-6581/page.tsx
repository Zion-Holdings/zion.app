...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "AI Accessibility Auditor | Zion Tech Group", description: "End-to-end ai accessibility auditor services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/ai-accessibility-auditor-2026-6581/"}} />
