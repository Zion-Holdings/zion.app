...
export const metadata: Metadata = {
  title: 'Smart Insights for Finance',
  description: 'Transform your finance operations with our Smart Insights for Finance. This AI-driven solution automates user experience with unprecedented accuracy and efficie',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-insights-for-finance-fe837a83',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Insights for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Smart Insights for Finance. This AI-driven solution automates user experience with unprecedented accuracy and efficiency.
          </p>
