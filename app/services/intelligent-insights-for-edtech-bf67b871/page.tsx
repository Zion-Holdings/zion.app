...
export const metadata: Metadata = {
  title: 'Intelligent Insights for EDTECH',
  description: 'Revolutionize edtech through intelligent automation. Our Intelligent Insights for EDTECH leverages advanced machine learning to deliver record extraction at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Insights for EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize edtech through intelligent automation. Our Intelligent Insights for EDTECH leverages advanced machine learning to deliver record extraction at scale.
          </p>
