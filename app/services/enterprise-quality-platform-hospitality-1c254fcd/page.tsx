...
export const metadata: Metadata = {
  title: 'Enterprise Quality Platform - Hospitality',
  description: 'Quantum leap forward for hospitality: Enterprise Quality Platform - Hospitality. Uses quantum-inspired algorithms to deliver inventory management at exponential',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Quality Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for hospitality: Enterprise Quality Platform - Hospitality. Uses quantum-inspired algorithms to deliver inventory management at exponential speed.
          </p>
