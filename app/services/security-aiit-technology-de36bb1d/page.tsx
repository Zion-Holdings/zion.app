...
export const metadata: Metadata = {
  title: 'Security AI/IT - TECHNOLOGY',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security AI/IT - TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for technology: Security AI/IT - TECHNOLOGY. Uses quantum-inspired algorithms to deliver performance reviews at exponential speed.
          </p>
