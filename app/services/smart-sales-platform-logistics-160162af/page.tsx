...
export const metadata: Metadata = {
  title: 'Smart Sales Platform - Logistics',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Sales Platform - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Smart Sales Platform - Logistics. Combines user experience with adaptive intelligence for optimal results.
          </p>
