...
export const metadata: Metadata = {
  title: 'Smart Serverless Platform',
  description: 'Drive innovation in hospitality with Smart Serverless Platform. This AI-powered platform transforms reporting automation into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-serverless-platform-4cf9ae5d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Serverless Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Smart Serverless Platform. This AI-powered platform transforms reporting automation into a competitive advantage.
          </p>
