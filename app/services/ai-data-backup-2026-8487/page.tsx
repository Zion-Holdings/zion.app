...
export const metadata = {
  ...
  alternates: { canonical: '/services/ai-data-backup-2026-8487/' },

  openGraph: {
    title: 'AI Data Backup | Zion Tech Group',
    description: 'End-to-end ai data backup services: assessment, deployment, and managed operations.',
    url: 'https://ziontechgroup.com/services/ai-data-backup-2026-8487/',
...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={@context: "https://schema.org", @type: "Service", name: "AI Data Backup | Zion Tech Group", description: "End-to-end ai data backup services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/ai-data-backup-2026-8487/"} />
