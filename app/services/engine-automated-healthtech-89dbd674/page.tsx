...
export const metadata: Metadata = {
  title: 'Engine Automated - HEALTHTECH',
  description: 'Drive innovation in healthtech with Engine Automated - HEALTHTECH. This AI-powered platform transforms automation opportunity into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/engine-automated-healthtech-89dbd674',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Engine Automated - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthtech with Engine Automated - HEALTHTECH. This AI-powered platform transforms automation opportunity into a competitive advantage.
          </p>
