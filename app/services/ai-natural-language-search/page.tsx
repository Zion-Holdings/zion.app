...
export const metadata: Metadata = {
  ...
  keywords: 'Semantic search (vector embeddings), Natural language question answering, Auto-summarization of results, Multi-language support, Document and database indexing, Relevance tuning, Search analytics, API and widget deployment, ai, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Natural Language Search Engine</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered search that understands natural language queries. Semantic search, auto-summarization, and question-answering over documents, databases, and knowledge bases.</p>
        ...
        <li class="text-slate-300">Semantic search (vector embeddings)</li>
        <li class="text-slate-300">Natural language question answering</li>
        <li class="text-slate-300">Auto-summarization of results</li>
        <li class="text-slate-300">Multi-language support</li>
        <li class="text-slate-300">Document and database indexing</li>
        <li class="text-slate-300">Relevance tuning</li>
        <li class="text-slate-300">Search analytics</li>
        <li class="text-slate-300">API and widget deployment</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Find information 10x faster</li>
        <li class="text-slate-300">Natural language instead of keywords</li>
        <li class="text-slate-300">Summarized answers not just links</li>
        <li class="text-slate-300">Improve knowledge discovery</li>
      </ul>
        </div>
