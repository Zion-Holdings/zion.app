    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        ...
        <p className="text-xl text-slate-300 mb-8">
          AI-powered search that understands natural language queries. Semantic search, auto-summarization, and question-answering over documents, databases, and knowledg
        </p>
