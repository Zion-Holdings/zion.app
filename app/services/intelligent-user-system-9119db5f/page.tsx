...
export const metadata: Metadata = {
  title: 'Intelligent User System',
  description: 'Transform your gaming operations with our Intelligent User System. This AI-driven solution automates fraud prevention with unprecedented accuracy and efficiency',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-user-system-9119db5f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your gaming operations with our Intelligent User System. This AI-driven solution automates fraud prevention with unprecedented accuracy and efficiency.
          </p>
