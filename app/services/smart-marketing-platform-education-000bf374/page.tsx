...
export const metadata: Metadata = {
  title: 'Smart Marketing Platform - Education',
  description: 'Drive innovation in education with Smart Marketing Platform - Education. This AI-powered platform transforms data processing into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-marketing-platform-education-000bf374',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Marketing Platform - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in education with Smart Marketing Platform - Education. This AI-powered platform transforms data processing into a competitive advantage.
          </p>
