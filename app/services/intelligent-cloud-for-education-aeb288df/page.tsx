...
export const metadata: Metadata = {
  title: 'Intelligent Cloud for Education',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Cloud for Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize education through intelligent automation. Our Intelligent Cloud for Education leverages advanced machine learning to deliver roi tracking at scale.
          </p>
