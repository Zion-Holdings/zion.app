...
export const metadata: Metadata = {
  title: 'AI/IT Executive for Telecom',
  description: 'The future of telecom is here with AI/IT Executive for Telecom. Powered by cutting-edge AI, this platform delivers automation opportunity like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-executive-for-telecom-51a043d7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Executive for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of telecom is here with AI/IT Executive for Telecom. Powered by cutting-edge AI, this platform delivers automation opportunity like never before.
          </p>
