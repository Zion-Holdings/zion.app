...
export const metadata: Metadata = {
  title: "AI-Powered AI-Powered Data Quality Manager - AI-Powered Finance Solution",
  description: "ai-powered solution for finance industry. Automatically detects, corrects, and prevents data quality issues using machine learning.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-ai-powered-data-quality-manager-e07a26ef",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered AI-Powered Data Quality Manager - AI-Powered Finance Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          ai-powered solution for finance industry. Automatically detects, corrects, and prevents data quality issues using machine learning.
        </p>
