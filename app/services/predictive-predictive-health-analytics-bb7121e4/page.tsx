...
export const metadata = {
  ...
  description: "Population health analytics platform that uses predictive predictive modeling to identify at-risk patients, optimize resource allocation, and improve care quali",
  alternates: {
