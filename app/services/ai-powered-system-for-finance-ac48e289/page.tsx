...
export const metadata: Metadata = {
  title: 'AI-Powered System for Finance',
  description: 'Revolutionize finance through intelligent automation. Our AI-Powered System for Finance leverages advanced machine learning to deliver threat detection at scale',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-system-for-finance-ac48e289',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our AI-Powered System for Finance leverages advanced machine learning to deliver threat detection at scale.
          </p>
