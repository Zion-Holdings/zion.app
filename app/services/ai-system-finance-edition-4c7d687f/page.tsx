...
export const metadata: Metadata = {
  title: 'AI System - Finance Edition',
  description: 'Enhance your finance business with AI System - Finance Edition. Our solution provides master data management with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-system-finance-edition-4c7d687f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI System - Finance Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your finance business with AI System - Finance Edition. Our solution provides master data management with enterprise-grade reliability and security.
          </p>
