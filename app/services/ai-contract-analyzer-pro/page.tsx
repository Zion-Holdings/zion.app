...
export const metadata: Metadata = {
  ...
  keywords: 'Risk scoring 0–100, Clause extraction & classification, Compliance matrix (GDPR, CCPA, HIPAA), Redline suggestions, Audit trail, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Contract Analyzer Pro</h1>
        <p className="text-lg text-slate-300 mb-8">Automated legal contract review with risk scoring, clause extraction, and compliance checking against 200+ global regulations.</p>
        ...
        <li class="text-slate-300">Risk scoring 0–100</li>
        <li class="text-slate-300">Clause extraction &amp; classification</li>
        <li class="text-slate-300">Compliance matrix (GDPR, CCPA, HIPAA)</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with contract analyzer pro</li>
