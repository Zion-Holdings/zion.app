      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Automated legal contract review with risk scoring, clause extraction, and compliance checking against 200+ global regulations.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Risk scoring 0–100</li>
            <li className="text-purple-300">✓ Clause extraction & classification</li>
            <li className="text-purple-300">✓ Compliance matrix (GDPR, CCPA, HIPAA)</li>
            <li className="text-purple-300">✓ Redline suggestions</li>
            <li className="text-purple-300">✓ Audit trail</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with contract analyzer pro</li>
