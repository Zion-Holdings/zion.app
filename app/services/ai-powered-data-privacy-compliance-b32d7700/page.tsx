...
export const metadata: Metadata = {
  title: "Service - AI-Powered Security Solution",
  description: "Automates GDPR/CCPA compliance with data mapping and consent management.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-data-privacy-compliance-b32d7700",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Service - AI-Powered Security Solution
        </h1>
