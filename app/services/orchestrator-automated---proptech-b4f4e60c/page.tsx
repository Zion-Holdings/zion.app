...
export const metadata: Metadata = {
  title: 'Orchestrator Automated - Proptech',
  description: 'Transform your proptech operations with our Orchestrator Automated - Proptech. This AI-driven solution automates threat detection with unprecedented accuracy an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/orchestrator-automated---proptech-b4f4e60c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Orchestrator Automated - Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your proptech operations with our Orchestrator Automated - Proptech. This AI-driven solution automates threat detection with unprecedented accuracy and efficiency.
          </p>
