...
export const metadata: Metadata = {
  ...
  keywords: 'Data pipeline version control, Automated data testing, Pipeline CI/CD, Data quality monitoring, Lineage tracking, Integration with dbt, Airflow, Spark, Environment management, Cost and performance analytics, data, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">DataOps Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Automate data pipeline development, testing, and deployment. Version control for data, automated testing, monitoring, and CI/CD for data engineering teams.</p>
        ...
        <li class="text-slate-300">Data pipeline version control</li>
        <li class="text-slate-300">Automated data testing</li>
        <li class="text-slate-300">Pipeline CI/CD</li>
        <li class="text-slate-300">Data quality monitoring</li>
        <li class="text-slate-300">Lineage tracking</li>
        <li class="text-slate-300">Integration with dbt, Airflow, Spark</li>
        <li class="text-slate-300">Environment management</li>
        <li class="text-slate-300">Cost and performance analytics</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Ship data products faster</li>
        <li class="text-slate-300">Catch data quality issues early</li>
        <li class="text-slate-300">Reproducible data pipelines</li>
        <li class="text-slate-300">Data team productivity boost</li>
      </ul>
        </div>
