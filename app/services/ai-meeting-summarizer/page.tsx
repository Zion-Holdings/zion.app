...
export const metadata: Metadata = {
  ...
  description: "AI-powered meeting assistant that transcribes, summarizes, and extracts action items from meetings in real-time. Integrates with Zoom, Teams, and Google Meet. Generates shareable summaries with speaker attribution and de",
  openGraph: {
    title: "AI Meeting Summarizer & Action Tracker | Zion Tech Group",
    description: "AI-powered meeting assistant that transcribes, summarizes, and extracts action items from meetings in real-time. Integrates with Zoom, Teams, and Google Meet. Generates shareable summaries with speaker attribution and de",
    url: "https://ziontechgroup.com/services/ai-meeting-summarizer/",
    type: 'website',
  },
  alternates: { canonical: "/services/ai-meeting-summarizer/" },
};
...
export default function AiMeetingSummarizerPage() {
  return (
    <StandardPage
      ...
      subtitle="AI-powered meeting assistant that transcribes, summarizes, and extracts action items from meetings in real-time. Integrates with Zoom, Teams, and Google Meet. Generates shareable summaries with speaker attribution and de"
      breadcrumbItems={[
        { label: "Home", href: "/" },
        { label: "Services", href: "/services/" },
        { label: "AI Meeting Summarizer & Action Tracker" }
      ]}
      actions={[
    ...
    >
        ...
        <div className="rounded-2xl border border-white/10 bg-slate-900/40 p-5"><h2 className="text-white font-semibold mb-2">AI Meeting Summarizer &amp; Action Tracker</h2><p className="text-slate-400 text-sm">Archived section recovered from the live site snapshot.</p></div>
      ...
      <p className="text-slate-400 leading-relaxed mb-4 max-w-5xl mx-auto">Estimated timeline for AI Meeting Summarizer &amp; Action Tracker — adapt to your team size and complexity.</p>
      ...
      <p className="text-slate-500 text-sm max-w-5xl mx-auto">Restored from a Wayback Machine snapshot (20260614094858) of ziontechgroup.com.</p>
    </StandardPage>
  );
}
