...
export const metadata: Metadata = {
  title: 'Data Predictive - Transportation',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Predictive - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in transportation with Data Predictive - Transportation. This AI-powered platform transforms territory management into a competitive advantage.
          </p>
