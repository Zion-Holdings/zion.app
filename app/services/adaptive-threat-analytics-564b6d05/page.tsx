...
export const metadata: Metadata = {
  title: 'Adaptive Threat Analytics',
  description: 'Next-generation media solution: Adaptive Threat Analytics. Combines scalability planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-threat-analytics-564b6d05',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation media solution: Adaptive Threat Analytics. Combines scalability planning with adaptive intelligence for optimal results.
          </p>
