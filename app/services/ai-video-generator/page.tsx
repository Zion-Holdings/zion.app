...
export const metadata: Metadata = {
  ...
  keywords: 'Text-to-video generation (diffusion + GANs), Auto storyboard & scene composition, AI voiceover with 50+ languages, Built-in captions & subtitles, Export for social (9:16, 1:1, 16:9), ai, E-Commerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Video Generator &amp; Editor</h1>
        <p className="text-lg text-slate-300 mb-8">Generate professional videos from text prompts or scripts: auto-scene composition, voiceover, subtitles, and multi-format export (MP4, GIF, Reels).</p>
        ...
        <li class="text-slate-300">Text-to-video generation (diffusion + GANs)</li>
        <li class="text-slate-300">Auto storyboard &amp; scene composition</li>
        <li class="text-slate-300">AI voiceover with 50+ languages</li>
        <li class="text-slate-300">Built-in captions &amp; subtitles</li>
        <li class="text-slate-300">Export for social (9:16, 1:1, 16:9)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai video generator &amp; editor</li>
