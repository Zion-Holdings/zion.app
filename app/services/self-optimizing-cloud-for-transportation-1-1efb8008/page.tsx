  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Next-generation transportation solution: Self-Optimizing Cloud for Transportation #1. Combines workflow management with adaptive intelligence for optimal results.</p>
