...
export const metadata: Metadata = {
  ...
  keywords: 'Unified dashboard for all cloud providers, Cross-cloud policy and governance, Cost visibility and optimization, Cross-cloud networking and connectivity, Workload placement recommendations, Compliance and security posture view, Integration with CloudHealth, ParkMyCloud, Kion, cloud, Cloud Computing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Multi-Cloud Management Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Manage AWS, Azure, and GCP from one platform: unified dashboards, policy enforcement, cost optimization, and cross-cloud networking.</p>
        ...
        <li class="text-slate-300">Unified dashboard for all cloud providers</li>
        <li class="text-slate-300">Cross-cloud policy and governance</li>
        <li class="text-slate-300">Cost visibility and optimization</li>
        <li class="text-slate-300">Cross-cloud networking and connectivity</li>
        <li class="text-slate-300">Workload placement recommendations</li>
        <li class="text-slate-300">Compliance and security posture view</li>
        <li class="text-slate-300">Integration with CloudHealth, ParkMyCloud, Kion</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">One platform for all your clouds</li>
        <li class="text-slate-300">Consistent governance across providers</li>
        <li class="text-slate-300">Workload placement optimizes cost and performance</li>
        <li class="text-slate-300">Unified security posture view</li>
      </ul>
        </div>
