...
export const metadata: Metadata = {
  title: 'Analyzer AI - Legal',
  description: 'Next-generation legal solution: Analyzer AI - Legal. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/analyzer-ai-legal-f8a60348',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Analyzer AI - Legal. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
