...
export const metadata: Metadata = {
  title: 'Cognitive Risk Solution - Healthcare',
  description: 'Transform your healthcare operations with our Cognitive Risk Solution - Healthcare. This AI-driven solution automates account planning with unprecedented accura',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-risk-solution-healthcare-e0216202',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Risk Solution - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Cognitive Risk Solution - Healthcare. This AI-driven solution automates account planning with unprecedented accuracy and efficiency.
          </p>
