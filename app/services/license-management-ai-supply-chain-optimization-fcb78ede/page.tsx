...
export const metadata: Metadata = {
  title: 'License Management AI Supply Chain Optimization',
  description: 'license management solution for aerospace industry. Optimizes supply chain operations using predictive analytics, demand forecasting, and route optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/license-management-ai-supply-chain-optimization-fcb78ede',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            License Management AI Supply Chain Optimization
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            license management solution for aerospace industry. Optimizes supply chain operations using predictive analytics, demand forecasting, and route optimization.
          </p>
