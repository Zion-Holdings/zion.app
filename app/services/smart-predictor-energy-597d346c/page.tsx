...
export const metadata: Metadata = {
  title: 'Smart predictor-energy',
  description: 'Revolutionize energy through intelligent automation. Our Smart predictor-energy leverages advanced machine learning to deliver logistics route optimization at s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart predictor-energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Smart predictor-energy leverages advanced machine learning to deliver logistics route optimization at scale.
          </p>
