...
export const metadata: Metadata = {
  title: 'Predictive Supply Engine - Automotive',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Supply Engine - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in automotive with Predictive Supply Engine - Automotive. This AI-powered platform transforms data processing into a competitive advantage.
          </p>
