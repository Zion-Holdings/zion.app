...
export const metadata: Metadata = {
  title: 'Smart marketing-hospitality',
  description: 'Next-generation hospitality solution: Smart marketing-hospitality. Combines supply chain with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-marketing-hospitality-33408f4a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart marketing-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Smart marketing-hospitality. Combines supply chain with adaptive intelligence for optimal results.
          </p>
