...
export const metadata: Metadata = {
  title: 'Automated Automation Autonomous',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with Automated Automation Autonomous. This AI-powered platform transforms procurement automation into a competitive advantage.
          </p>
