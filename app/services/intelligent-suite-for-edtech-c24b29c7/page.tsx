...
export const metadata: Metadata = {
  title: 'Intelligent Suite for EDTECH',
  description: 'Optimize your edtech workflows with Intelligent Suite for EDTECH. This intelligent platform delivers performance tuning through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-suite-for-edtech-c24b29c7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Suite for EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your edtech workflows with Intelligent Suite for EDTECH. This intelligent platform delivers performance tuning through advanced automation and AI.
          </p>
