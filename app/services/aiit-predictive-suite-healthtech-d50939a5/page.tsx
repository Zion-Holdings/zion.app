...
export const metadata: Metadata = {
  title: 'AI/IT Predictive Suite - HEALTHTECH',
  description: 'Optimize your healthtech workflows with AI/IT Predictive Suite - HEALTHTECH. This intelligent platform delivers hr analytics through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-predictive-suite-healthtech-d50939a5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Predictive Suite - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthtech workflows with AI/IT Predictive Suite - HEALTHTECH. This intelligent platform delivers hr analytics through advanced automation and AI.
          </p>
