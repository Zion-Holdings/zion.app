...
export const metadata: Metadata = {
  title: 'AI-Powered Pension Fund Management',
  description: 'Manages pension funds with liability matching and risk optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-pension-fund-management-fc807e77',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Pension Fund Management
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Manages pension funds with liability matching and risk optimization.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Liability matching</li>
          <li className="text-gray-300">Risk optimization</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">20% better returns</li>
