...
export const metadata: Metadata = {
  ...
  description: 'Optimize your real-estate workflows with Next-Gen Enterprise for Real-Estate. This intelligent platform delivers compensation management through advanced automa',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-enterprise-for-real-estate-9a1c8150',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your real-estate workflows with Next-Gen Enterprise for Real-Estate. This intelligent platform delivers compensation management through advanced automation and AI.
          </p>
