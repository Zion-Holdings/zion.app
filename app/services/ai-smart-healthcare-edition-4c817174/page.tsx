...
export const metadata: Metadata = {
  title: 'AI Smart - Healthcare Edition',
  description: 'Revolutionize healthcare through intelligent automation. Our AI Smart - Healthcare Edition leverages advanced machine learning to deliver succession planning at',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-smart-healthcare-edition-4c817174',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Smart - Healthcare Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our AI Smart - Healthcare Edition leverages advanced machine learning to deliver succession planning at scale.
          </p>
