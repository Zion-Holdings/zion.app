...
export const metadata: Metadata = {
  title: 'Smart Revenue Platform - Agriculture',
  description: 'Optimize your agriculture workflows with Smart Revenue Platform - Agriculture. This intelligent platform delivers performance reviews through advanced automatio',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-revenue-platform-agriculture-bbf66f2f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Revenue Platform - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your agriculture workflows with Smart Revenue Platform - Agriculture. This intelligent platform delivers performance reviews through advanced automation and AI.
          </p>
