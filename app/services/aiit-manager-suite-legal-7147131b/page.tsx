...
export const metadata: Metadata = {
  title: 'AI/IT Manager Suite - Legal',
  description: 'Optimize your legal workflows with AI/IT Manager Suite - Legal. This intelligent platform delivers inventory optimization through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-manager-suite-legal-7147131b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Manager Suite - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with AI/IT Manager Suite - Legal. This intelligent platform delivers inventory optimization through advanced automation and AI.
          </p>
