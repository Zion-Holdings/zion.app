...
export const metadata: Metadata = {
  title: 'Autonomous Project Machine Learning',
  description: 'Transform your finance operations with our Autonomous Project Machine Learning. This AI-driven solution automates document processing with unprecedented accurac',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Project Machine Learning
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Autonomous Project Machine Learning. This AI-driven solution automates document processing with unprecedented accuracy and efficiency.
          </p>
