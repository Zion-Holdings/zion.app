...
export const metadata: Metadata = {
  title: 'Intelligent Knowledge for PROPTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Knowledge for PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our Intelligent Knowledge for PROPTECH leverages advanced machine learning to deliver learning management at scale.
          </p>
