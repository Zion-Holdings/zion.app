...
export const metadata: Metadata = {
  ...
  keywords: '6-dimension readiness scorecard, Migration wave planner, TCO comparison analysis, Skill gap heat map, Executive dashboard and PDF report, cloud, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cloud Migration Readiness Score</h1>
        <p className="text-lg text-slate-300 mb-8">Assess on-prem and multi-cloud workloads across 6 readiness dimensions: performance, cost, security, operability, resiliency, and team skill.</p>
        ...
        <li class="text-slate-300">6-dimension readiness scorecard</li>
        <li class="text-slate-300">Migration wave planner</li>
        <li class="text-slate-300">TCO comparison analysis</li>
        <li class="text-slate-300">Skill gap heat map</li>
        <li class="text-slate-300">Executive dashboard and PDF report</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with cloud migration readiness score</li>
