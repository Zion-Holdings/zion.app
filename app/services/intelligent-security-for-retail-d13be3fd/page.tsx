...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize retail through intelligent automation. Our Intelligent Security for Retail leverages advanced machine learning to deliver data processing at scale',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-security-for-retail-d13be3fd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize retail through intelligent automation. Our Intelligent Security for Retail leverages advanced machine learning to deliver data processing at scale.
          </p>
