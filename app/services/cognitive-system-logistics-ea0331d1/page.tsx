...
export const metadata: Metadata = {
  title: 'Cognitive system-logistics',
  description: 'Transform your logistics operations with our Cognitive system-logistics. This AI-driven solution automates click automation with unprecedented accuracy and effi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-system-logistics-ea0331d1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive system-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Cognitive system-logistics. This AI-driven solution automates click automation with unprecedented accuracy and efficiency.
          </p>
