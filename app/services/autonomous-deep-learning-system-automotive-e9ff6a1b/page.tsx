...
export const metadata = {
  ...
  description: "Unlock unprecedented growth with Autonomous Deep Learning System - Automotive. This autonomous system provides warehouse automation with zero manual interventio",
  alternates: {
