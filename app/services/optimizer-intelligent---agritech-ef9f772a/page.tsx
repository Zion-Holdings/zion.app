...
export const metadata: Metadata = {
  title: 'Optimizer Intelligent - Agritech',
  description: 'Next-generation agritech solution: Optimizer Intelligent - Agritech. Combines compliance monitoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/optimizer-intelligent---agritech-ef9f772a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Optimizer Intelligent - Agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agritech solution: Optimizer Intelligent - Agritech. Combines compliance monitoring with adaptive intelligence for optimal results.
          </p>
