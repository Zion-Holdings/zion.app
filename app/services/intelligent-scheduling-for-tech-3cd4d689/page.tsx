...
export const metadata: Metadata = {
  title: 'Intelligent Scheduling for Tech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Scheduling for Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your technology workflows with Intelligent Scheduling for Tech. This intelligent platform delivers supply chain through advanced automation and AI.
          </p>
