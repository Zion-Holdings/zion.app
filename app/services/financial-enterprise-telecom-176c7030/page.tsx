...
export const metadata: Metadata = {
  title: 'Financial Enterprise - Telecom',
  description: 'Next-generation telecom solution: Financial Enterprise - Telecom. Combines expense reporting with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/financial-enterprise-telecom-176c7030',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Financial Enterprise - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation telecom solution: Financial Enterprise - Telecom. Combines expense reporting with adaptive intelligence for optimal results.
          </p>
