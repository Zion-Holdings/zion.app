...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time text moderation, Image and video analysis, Custom moderation rules, Human review queues, Compliance reporting, Multi-language support (50+), Appeal management, Audit logs, micro-saas, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Content Moderation Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Real-time content moderation for user-generated content. AI-powered text, image, and video moderation with custom rules, human review queues, and compliance reporting.</p>
        ...
        <li class="text-slate-300">Real-time text moderation</li>
        <li class="text-slate-300">Image and video analysis</li>
        <li class="text-slate-300">Custom moderation rules</li>
        <li class="text-slate-300">Human review queues</li>
        <li class="text-slate-300">Compliance reporting</li>
        <li class="text-slate-300">Multi-language support (50+)</li>
        <li class="text-slate-300">Appeal management</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">95% auto-moderation rate</li>
        <li class="text-slate-300">Sub-second processing</li>
        <li class="text-slate-300">Custom rules engine</li>
        <li class="text-slate-300">Global compliance</li>
        <li class="text-slate-300">Scalable to millions of posts</li>
      </ul>
        </div>
