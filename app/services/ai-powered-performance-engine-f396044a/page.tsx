...
export const metadata: Metadata = {
  title: 'AI-Powered Performance Engine',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with AI-Powered Performance Engine. Powered by cutting-edge AI, this platform delivers inventory management like never before.
          </p>
