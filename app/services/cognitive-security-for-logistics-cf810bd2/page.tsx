...
export const metadata: Metadata = {
  title: 'Cognitive Security for Logistics',
  description: 'The future of logistics is here with Cognitive Security for Logistics. Powered by cutting-edge AI, this platform delivers risk assessment like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-security-for-logistics-cf810bd2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Security for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Cognitive Security for Logistics. Powered by cutting-edge AI, this platform delivers risk assessment like never before.
          </p>
