...
export const metadata: Metadata = {
  title: 'Marketing AI - Edge',
  description: 'Next-generation edge solution: Marketing AI - Edge. Combines energy management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/marketing-ai---edge-ff622c61',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation edge solution: Marketing AI - Edge. Combines energy management with adaptive intelligence for optimal results.
          </p>
