...
export const metadata: Metadata = {
  ...
  keywords: 'Text-to-music generation, Style and mood control, Royalty-free licensing, Soundtrack generation for video, Sound effects library, Custom model training, Integration with DAWs and video editors, Commercial usage rights, ai, Media, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Music Generation Platform</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered music creation for content creators, advertisers, and game developers. Generate royalty-free music, soundtracks, and sound effects from text descriptions.</p>
        ...
        <li class="text-slate-300">Text-to-music generation</li>
        <li class="text-slate-300">Style and mood control</li>
        <li class="text-slate-300">Royalty-free licensing</li>
        <li class="text-slate-300">Soundtrack generation for video</li>
        <li class="text-slate-300">Sound effects library</li>
        <li class="text-slate-300">Custom model training</li>
        <li class="text-slate-300">Integration with DAWs and video editors</li>
        <li class="text-slate-300">Commercial usage rights</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Create music instantly</li>
        <li class="text-slate-300">No copyright concerns</li>
        <li class="text-slate-300">Customize to brand and mood</li>
        <li class="text-slate-300">Reduce music licensing costs</li>
      </ul>
        </div>
