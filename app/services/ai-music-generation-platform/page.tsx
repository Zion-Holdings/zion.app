    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        ...
        <p className="text-xl text-slate-300 mb-8">
          AI-powered music creation for content creators, advertisers, and game developers. Generate royalty-free music, soundtracks, and sound effects from text descript
        </p>
