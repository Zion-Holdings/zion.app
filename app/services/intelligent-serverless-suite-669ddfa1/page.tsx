...
export const metadata: Metadata = {
  title: 'Intelligent Serverless Suite',
  description: 'The future of real-estate is here with Intelligent Serverless Suite. Powered by cutting-edge AI, this platform delivers quality control like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-serverless-suite-669ddfa1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Serverless Suite
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of real-estate is here with Intelligent Serverless Suite. Powered by cutting-edge AI, this platform delivers quality control like never before.
          </p>
