...
export const metadata: Metadata = {
  title: 'Neural Social Experience',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Social Experience
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Neural Social Experience. This intelligent platform delivers incident response through advanced automation and AI.
          </p>
