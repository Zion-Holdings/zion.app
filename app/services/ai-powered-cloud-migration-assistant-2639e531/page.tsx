...
export const metadata: Metadata = {
  title: 'AI-Powered Cloud Migration Assistant',
  description: 'Assesses workloads and creates migration plans with risk mitigation strategies.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-cloud-migration-assistant-2639e531',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Assesses workloads and creates migration plans with risk mitigation strategies.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Workload assessment</li>
          <li className="text-gray-300">Migration planning</li>
          <li className="text-gray-300">Risk mitigation</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">Zero-downtime migration</li>
