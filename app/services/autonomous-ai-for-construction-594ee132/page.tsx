...
export const metadata: Metadata = {
  title: 'Autonomous AI for Construction',
  description: 'Quantum leap forward for construction: Autonomous AI for Construction. Uses quantum-inspired algorithms to deliver fleet management at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-ai-for-construction-594ee132',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous AI for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for construction: Autonomous AI for Construction. Uses quantum-inspired algorithms to deliver fleet management at exponential speed.
          </p>
