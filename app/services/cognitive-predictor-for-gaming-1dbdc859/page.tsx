...
export const metadata: Metadata = {
  title: 'Cognitive Predictor for Gaming',
  description: 'The future of gaming is here with Cognitive Predictor for Gaming. Powered by cutting-edge AI, this platform delivers user experience like never before.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Predictor for Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of gaming is here with Cognitive Predictor for Gaming. Powered by cutting-edge AI, this platform delivers user experience like never before.
          </p>
