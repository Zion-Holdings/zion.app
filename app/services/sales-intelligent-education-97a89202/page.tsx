...
export const metadata: Metadata = {
  title: 'Sales Intelligent - Education',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Sales Intelligent - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your education workflows with Sales Intelligent - Education. This intelligent platform delivers account planning through advanced automation and AI.
          </p>
