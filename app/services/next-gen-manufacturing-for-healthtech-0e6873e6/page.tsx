...
export const metadata: Metadata = {
  title: 'Next-Gen Manufacturing for HEALTHTECH',
  description: 'Quantum leap forward for healthtech: Next-Gen Manufacturing for HEALTHTECH. Uses quantum-inspired algorithms to deliver compensation management at exponential s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-manufacturing-for-healthtech-0e6873e6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Manufacturing for HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for healthtech: Next-Gen Manufacturing for HEALTHTECH. Uses quantum-inspired algorithms to deliver compensation management at exponential speed.
          </p>
