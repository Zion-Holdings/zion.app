...
export const metadata: Metadata = {
  title: 'Cognitive automation-telecom',
  description: 'Transform your telecom operations with our Cognitive automation-telecom. This AI-driven solution automates data processing with unprecedented accuracy and effic',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive automation-telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your telecom operations with our Cognitive automation-telecom. This AI-driven solution automates data processing with unprecedented accuracy and efficiency.
          </p>
