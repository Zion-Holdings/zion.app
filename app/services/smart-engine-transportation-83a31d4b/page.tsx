...
export const metadata: Metadata = {
  title: 'Smart engine-transportation',
  description: 'Transform your transportation operations with our Smart engine-transportation. This AI-driven solution provides intelligent automation with unprecedented accura',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-engine-transportation-83a31d4b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart engine-transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your transportation operations with our Smart engine-transportation. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
