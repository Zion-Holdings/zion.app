...
export const metadata: Metadata = {
  title: 'AI-Driven Recruitment for Automotive',
  description: 'Transform your automotive operations with our AI-Driven Recruitment for Automotive. This AI-driven solution automates forecast accuracy with unprecedented accur',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Driven Recruitment for Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your automotive operations with our AI-Driven Recruitment for Automotive. This AI-driven solution automates forecast accuracy with unprecedented accuracy and efficiency.
          </p>
