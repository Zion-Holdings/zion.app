...
export const metadata: Metadata = {
  title: 'Autonomous optimization-hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Autonomous optimization-hospitality leverages advanced machine learning to deliver manufacturing q',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous optimization-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Autonomous optimization-hospitality leverages advanced machine learning to deliver manufacturing quality control at scale.
          </p>
