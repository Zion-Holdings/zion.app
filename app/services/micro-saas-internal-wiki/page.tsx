...
export const metadata: Metadata = {
  ...
  keywords: 'AI-powered search and answers, Auto-documentation from code, Real-time collaboration, Version history and rollback, Integration with Slack, GitHub, Jira, Custom templates and workflows, Access control and permissions, Analytics on knowledge gaps, micro-saas, Productivity, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">WikiBase — Internal Knowledge Wiki</h1>
        <p className="text-lg text-slate-300 mb-8">Modern internal wiki with AI-powered search, auto-documentation, and team collaboration. Replace Confluence with a faster, smarter knowledge base.</p>
        ...
        <li class="text-slate-300">AI-powered search and answers</li>
        <li class="text-slate-300">Auto-documentation from code</li>
        <li class="text-slate-300">Real-time collaboration</li>
        <li class="text-slate-300">Version history and rollback</li>
        <li class="text-slate-300">Integration with Slack, GitHub, Jira</li>
        <li class="text-slate-300">Custom templates and workflows</li>
        <li class="text-slate-300">Access control and permissions</li>
        <li class="text-slate-300">Analytics on knowledge gaps</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Find answers 5x faster</li>
        <li class="text-slate-300">Reduce onboarding time</li>
        <li class="text-slate-300">Keep documentation alive</li>
        <li class="text-slate-300">Single source of truth</li>
      </ul>
        </div>
