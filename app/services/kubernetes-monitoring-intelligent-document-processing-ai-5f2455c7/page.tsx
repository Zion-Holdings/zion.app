...
export const metadata: Metadata = {
  title: 'Kubernetes Monitoring Intelligent Document Processing AI',
  description: 'AI-powered kubernetes monitoring solution for operations. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents auto',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/kubernetes-monitoring-intelligent-document-processing-ai-5f2455c7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Kubernetes Monitoring Intelligent Document Processing AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered kubernetes monitoring solution for operations. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.
          </p>
