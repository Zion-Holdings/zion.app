...
export const metadata: Metadata = {
  title: 'Smart Support for Finance',
  description: 'Revolutionize finance through intelligent automation. Our Smart Support for Finance leverages advanced machine learning to deliver market intelligence at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-support-for-finance-7d3c43c9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Support for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our Smart Support for Finance leverages advanced machine learning to deliver market intelligence at scale.
          </p>
