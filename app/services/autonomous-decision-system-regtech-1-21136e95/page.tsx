...
export const metadata: Metadata = {
  title: 'Autonomous Decision System - REGTECH #1',
  description: 'Next-generation regtech solution: Autonomous Decision System - REGTECH #1. Combines predictive analytics with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-decision-system-regtech-1-21136e95',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Decision System - REGTECH #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation regtech solution: Autonomous Decision System - REGTECH #1. Combines predictive analytics with adaptive intelligence for optimal results.
          </p>
