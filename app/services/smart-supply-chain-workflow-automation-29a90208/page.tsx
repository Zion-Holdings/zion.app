...
export const metadata: Metadata = {
  ...
  keywords: 'Process mapping, Task automation, Workflow optimization, Exception handling, automation, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Smart Supply Chain Workflow Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Intelligent workflow automation platform that streamlines supply chain processes and eliminates manual tasks.</p>
        ...
        <li class="text-slate-300">Process mapping</li>
        <li class="text-slate-300">Task automation</li>
        <li class="text-slate-300">Workflow optimization</li>
        <li class="text-slate-300">Exception handling</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Faster operations</li>
