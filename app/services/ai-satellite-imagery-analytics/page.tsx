...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "AI Satellite Imagery Analytics Platform | Zion Tech Group",
    description: "Process and analyze satellite and drone imagery with AI for agriculture, urban planning, disaster response, and environmental monitoring. Change detection, object classification, and predictive modeling.",
    url: "https://ziontechgroup.com/services/ai-satellite-imagery-analytics/",
    type: 'website',
  },
  alternates: { canonical: "/services/ai-satellite-imagery-analytics/" },
};

export default function AiSatelliteImageryAnalyticsPage() {
  return (
    <StandardPage
      title="AI Satellite Imagery Analytics Platform"
      subtitle="Process and analyze satellite and drone imagery with AI for agriculture, urban planning, disaster response, and environmental monitoring. Change detection, object classification, and predictive modeling."
      breadcrumbItems={[
        { label: "Home", href: "/" },
        { label: "Services", href: "/services/" },
        { label: "AI Satellite Imagery Analytics Platform" }
      ]}
      actions={[
    ...
    >
        ...
        <div className="rounded-2xl border border-white/10 bg-slate-900/40 p-5"><h2 className="text-white font-semibold mb-2">AI Satellite Imagery Analytics Platform</h2><p className="text-slate-400 text-sm">Archived section recovered from the live site snapshot.</p></div>
      ...
      <p className="text-slate-400 leading-relaxed mb-4 max-w-5xl mx-auto">Estimated timeline for AI Satellite Imagery Analytics Platform — adapt to your team size and complexity.</p>
      ...
      <p className="text-slate-500 text-sm max-w-5xl mx-auto">Restored from a Wayback Machine snapshot (20260614135929) of ziontechgroup.com.</p>
    </StandardPage>
  );
}
