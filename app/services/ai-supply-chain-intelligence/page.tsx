...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time multi-tier visibility, Predictive disruption alerts, Vendor risk assessment, Cost optimization engine, Scenario simulation and planning, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Supply Chain Intelligence</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end supply chain visibility with predictive disruption alerts, multi-tier vendor risk scoring, and AI-driven cost optimization.</p>
        ...
        <li class="text-slate-300">Real-time multi-tier visibility</li>
        <li class="text-slate-300">Predictive disruption alerts</li>
        <li class="text-slate-300">Vendor risk assessment</li>
        <li class="text-slate-300">Cost optimization engine</li>
        <li class="text-slate-300">Scenario simulation and planning</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai supply chain intelligence</li>
