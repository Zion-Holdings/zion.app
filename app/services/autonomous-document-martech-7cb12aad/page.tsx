...
export const metadata: Metadata = {
  title: 'Autonomous document-martech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous document-martech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for martech: Autonomous document-martech. Uses quantum-inspired algorithms to deliver claims processing at exponential speed.
          </p>
