...
export const metadata: Metadata = {
  title: 'AI/IT Skills Engine',
  description: 'Transform your agriculture operations with our AI/IT Skills Engine. This AI-driven solution automates record extraction with unprecedented accuracy and efficien',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our AI/IT Skills Engine. This AI-driven solution automates record extraction with unprecedented accuracy and efficiency.
          </p>
