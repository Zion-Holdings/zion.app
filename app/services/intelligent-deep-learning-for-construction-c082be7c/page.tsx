...
export const metadata: Metadata = {
  title: 'Intelligent Deep Learning for Construction',
  description: 'Drive innovation in construction with Intelligent Deep Learning for Construction. This AI-powered platform transforms manufacturing quality control into a compe',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-deep-learning-for-construction-c082be7c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Deep Learning for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Intelligent Deep Learning for Construction. This AI-powered platform transforms manufacturing quality control into a competitive advantage.
          </p>
