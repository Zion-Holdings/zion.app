...
export const metadata: Metadata = {
  title: 'AI Analytics - MARTECH Edition',
  description: 'Optimize your martech workflows with AI Analytics - MARTECH Edition. This intelligent platform delivers employee engagement through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-analytics-martech-edition-0bdfd34a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Analytics - MARTECH Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your martech workflows with AI Analytics - MARTECH Edition. This intelligent platform delivers employee engagement through advanced automation and AI.
          </p>
