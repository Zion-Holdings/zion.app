...
export const metadata: Metadata = {
  title: 'Cognitive Logistics Intelligent',
  description: 'Transform your agriculture operations with our Cognitive Logistics Intelligent. This AI-driven solution provides intelligent automation with unprecedented accur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-logistics-intelligent-dc333fef',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Logistics Intelligent
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Cognitive Logistics Intelligent. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
