...
export const metadata: Metadata = {
  title: 'Government Analytics AI-Powered Data Migration',
  description: 'AI-powered government analytics solution for data engineering. Intelligent data migration planning and execution.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/government-analytics-ai-powered-data-migration-5eb8bbdd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Government Analytics AI-Powered Data Migration
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered government analytics solution for data engineering. Intelligent data migration planning and execution.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">Smooth migrations</li>
