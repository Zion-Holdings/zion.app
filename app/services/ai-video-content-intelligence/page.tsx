...
export const metadata = {
  ...
  description: "Analyze video content at scale with scene detection, object recognition, transcription, sentiment analysis, and content moderation. Generate highlights, chapter",
  alternates: {
