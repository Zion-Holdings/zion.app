...
export const metadata: Metadata = {
  ...
  keywords: 'Automatic scene detection and chaptering, Object and face recognition, Multi-language transcription and translation, Content moderation and brand safety, Sentiment and emotion analysis, Highlight reel generation, Searchable video metadata, API and webhook integrations, ai, Media, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Video Content Intelligence Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Analyze video content at scale with scene detection, object recognition, transcription, sentiment analysis, and content moderation. Generate highlights, chapters, and searchable metadata for video libraries.</p>
        ...
        <li class="text-slate-300">Automatic scene detection and chaptering</li>
        <li class="text-slate-300">Object and face recognition</li>
        <li class="text-slate-300">Multi-language transcription and translation</li>
        <li class="text-slate-300">Content moderation and brand safety</li>
        <li class="text-slate-300">Sentiment and emotion analysis</li>
        <li class="text-slate-300">Highlight reel generation</li>
        <li class="text-slate-300">Searchable video metadata</li>
        <li class="text-slate-300">API and webhook integrations</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Make video libraries fully searchable</li>
        <li class="text-slate-300">Automate content moderation</li>
        <li class="text-slate-300">Increase content discoverability</li>
        <li class="text-slate-300">Reduce manual video editing time</li>
      </ul>
        </div>
