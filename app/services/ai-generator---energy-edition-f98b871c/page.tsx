...
export const metadata: Metadata = {
  title: 'AI Generator - Energy Edition',
  description: 'Revolutionize energy through intelligent automation. Our AI Generator - Energy Edition leverages advanced machine learning to deliver customer service automatio',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Generator - Energy Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our AI Generator - Energy Edition leverages advanced machine learning to deliver customer service automation at scale.
          </p>
