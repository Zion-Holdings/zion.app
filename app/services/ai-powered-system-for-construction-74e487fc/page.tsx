...
export const metadata: Metadata = {
  title: 'AI-Powered System for Construction',
  description: 'The future of construction is here with AI-Powered System for Construction. Powered by cutting-edge AI, this platform delivers maintenance scheduling like never',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-system-for-construction-74e487fc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered System for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with AI-Powered System for Construction. Powered by cutting-edge AI, this platform delivers maintenance scheduling like never before.
          </p>
