...
export const metadata: Metadata = {
  title: 'AI-Powered Factory Automation Robotics',
  description: 'AI-powered robotics for assembly, welding, and material handling.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-factory-automation-robotics-dbfc039a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Factory Automation Robotics
          </h1>
