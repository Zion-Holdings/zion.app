...
export const metadata: Metadata = {
  title: 'Smart Customer Service Platform - Energy #1',
  description: 'The future of energy is here with Smart Customer Service Platform - Energy #1. Powered by cutting-edge AI, this platform delivers fraud prevention like never be',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-customer-service-platform-energy-1-8e45cf89',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Customer Service Platform - Energy #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Smart Customer Service Platform - Energy #1. Powered by cutting-edge AI, this platform delivers fraud prevention like never before.
          </p>
