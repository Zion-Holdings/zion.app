      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Create bias-free, inclusive job descriptions tailored to your role. Auto-generate scoring rubrics and EEOC/ADA compliant interview questions.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Bias detection and inclusive language</li>
            <li className="text-purple-300">✓ Interview question generator with rubrics</li>
            <li className="text-purple-300">✓ Role and level templates</li>
            <li className="text-purple-300">✓ ATS-ready export</li>
            <li className="text-purple-300">✓ EEOC and ADA compliance check</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai job description & interview kit</li>
