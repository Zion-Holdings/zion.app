...
export const metadata: Metadata = {
  ...
  keywords: 'Bias detection and inclusive language, Interview question generator with rubrics, Role and level templates, ATS-ready export, EEOC and ADA compliance check, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Job Description &amp; Interview Kit</h1>
        <p className="text-lg text-slate-300 mb-8">Create bias-free, inclusive job descriptions tailored to your role. Auto-generate scoring rubrics and EEOC/ADA compliant interview questions.</p>
        ...
        <li class="text-slate-300">Bias detection and inclusive language</li>
        <li class="text-slate-300">Interview question generator with rubrics</li>
        <li class="text-slate-300">Role and level templates</li>
        <li class="text-slate-300">ATS-ready export</li>
        <li class="text-slate-300">EEOC and ADA compliance check</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai job description &amp; interview kit</li>
