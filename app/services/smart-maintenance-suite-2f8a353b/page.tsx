...
export const metadata: Metadata = {
  title: 'Smart Maintenance Suite',
  description: 'The future of agritech is here with Smart Maintenance Suite. Powered by cutting-edge AI, this platform delivers network optimization like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-maintenance-suite-2f8a353b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of agritech is here with Smart Maintenance Suite. Powered by cutting-edge AI, this platform delivers network optimization like never before.
          </p>
