...
export const metadata: Metadata = {
  title: 'Intelligence Autonomous - Edge',
  description: 'Transform your edge operations with our Intelligence Autonomous - Edge. This AI-driven solution automates user experience with unprecedented accuracy and effici',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligence Autonomous - Edge
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your edge operations with our Intelligence Autonomous - Edge. This AI-driven solution automates user experience with unprecedented accuracy and efficiency.
          </p>
