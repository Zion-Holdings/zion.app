...
export const metadata: Metadata = {
  title: 'Generator Automated - Hospitality',
  description: 'Next-generation hospitality solution: Generator Automated - Hospitality. Combines image recognition with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/generator-automated---hospitality-f0c078c3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Generator Automated - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Generator Automated - Hospitality. Combines image recognition with adaptive intelligence for optimal results.
          </p>
