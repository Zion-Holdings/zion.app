...
export const metadata: Metadata = {
  ...
  keywords: 'Drag-and-drop BPMN process designer, RPA bots for legacy app interactions, Approval routing + SLA tracking, Complete audit trail + compliance logs, automation, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Process Automation &amp; BPA Suite</h1>
        <p className="text-lg text-slate-300 mb-8">Business process automation platform: map, model, and automate end-to-end workflows. BPMN modelling, RPA bots, approval gates, audit trails, and real-time KPI dashboards.</p>
        ...
        <li class="text-slate-300">Drag-and-drop BPMN process designer</li>
        <li class="text-slate-300">RPA bots for legacy app interactions</li>
        <li class="text-slate-300">Approval routing + SLA tracking</li>
        <li class="text-slate-300">Complete audit trail + compliance logs</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with process automation &amp; bpa suite</li>
