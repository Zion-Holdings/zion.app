...
export const metadata: Metadata = {
  title: 'Intelligent Analytics for PROPTECH',
  description: 'Transform your proptech operations with our Intelligent Analytics for PROPTECH. This AI-driven solution automates background checks with unprecedented accuracy ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-analytics-for-proptech-b432a124',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Analytics for PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your proptech operations with our Intelligent Analytics for PROPTECH. This AI-driven solution automates background checks with unprecedented accuracy and efficiency.
          </p>
