...
export const metadata: Metadata = {
  title: 'Intelligent Risk for Agriculture',
  description: 'Enhance your agriculture business with Intelligent Risk for Agriculture. Our solution provides hr analytics with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-risk-for-agriculture-aeb2f59e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Risk for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your agriculture business with Intelligent Risk for Agriculture. Our solution provides hr analytics with enterprise-grade reliability and security.
          </p>
