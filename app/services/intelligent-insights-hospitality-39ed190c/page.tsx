...
export const metadata: Metadata = {
  title: 'Intelligent insights-hospitality',
  description: 'Transform your hospitality operations with our Intelligent insights-hospitality. This AI-driven solution automates resource optimization with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-insights-hospitality-39ed190c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent insights-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Intelligent insights-hospitality. This AI-driven solution automates resource optimization with unprecedented accuracy and efficiency.
          </p>
