...
export const metadata: Metadata = {
  title: 'Autonomous Tactical System - Cybersecurity',
  description: 'Hyper-accelerated cybersecurity solution: Autonomous Tactical System - Cybersecurity. Combines logistics route optimization with next-gen AI for maximum velocit',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Tactical System - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated cybersecurity solution: Autonomous Tactical System - Cybersecurity. Combines logistics route optimization with next-gen AI for maximum velocity.
          </p>
