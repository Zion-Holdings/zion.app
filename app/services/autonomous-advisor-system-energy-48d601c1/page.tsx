...
export const metadata: Metadata = {
  title: 'Autonomous Advisor System - Energy',
  description: 'Drive innovation in energy with Autonomous Advisor System - Energy. This AI-powered platform transforms influencer identification into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-advisor-system-energy-48d601c1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Advisor System - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Autonomous Advisor System - Energy. This AI-powered platform transforms influencer identification into a competitive advantage.
          </p>
