...
export const metadata: Metadata = {
  title: 'Returns Management Real-Time Data Pipeline Platform',
  description: 'returns management solution for proptech industry. Creates and manages real-time data pipelines with automated ETL and streaming analytics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/returns-management-real-time-data-pipeline-platform-f7893240',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Returns Management Real-Time Data Pipeline Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            returns management solution for proptech industry. Creates and manages real-time data pipelines with automated ETL and streaming analytics.
          </p>
