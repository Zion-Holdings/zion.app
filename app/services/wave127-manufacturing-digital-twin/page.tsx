...
export const metadata: Metadata = {
  ...
  keywords: 'High-fidelity process simulation & 3D visualization, What-if scenario engine with constraint solving, Real-time IoT data synchronization with twin, Throughput optimization & bottleneck analysis, Supply chain disruption simulation, Energy consumption modeling & optimization, AR/VR overlay for shop-floor visualization, Integration with SCADA, MES, and ERP systems, ai, Manufacturing Tech, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">High-fidelity digital replicas of production lines, facilities, and supply chains. Run what-if scenarios, optimize throughput, simulate disruptions, and validate changes before touching the physical plant — compressing commissioning time by 60%.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">ai</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">Manufacturing Tech</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">High-fidelity process simulation &amp; 3D visualization</li>
        <li class="text-slate-300">What-if scenario engine with constraint solving</li>
        <li class="text-slate-300">Real-time IoT data synchronization with twin</li>
        <li class="text-slate-300">Throughput optimization &amp; bottleneck analysis</li>
        <li class="text-slate-300">Supply chain disruption simulation</li>
        <li class="text-slate-300">Energy consumption modeling &amp; optimization</li>
        <li class="text-slate-300">AR/VR overlay for shop-floor visualization</li>
        <li class="text-slate-300">Integration with SCADA, MES, and ERP systems</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">60% faster plant commissioning and changeovers</li>
        <li class="text-slate-300">Optimize throughput without disrupting production</li>
        <li class="text-slate-300">Simulate before you build — avoid costly mistakes</li>
        <li class="text-slate-300">Reduce energy costs 10-20% with consumption modeling</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">39997</p>
