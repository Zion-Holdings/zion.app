...
export const metadata: Metadata = {
  title: 'Autonomous Skills Manager',
  description: 'Transform your martech operations with our Autonomous Skills Manager. This AI-driven solution automates process discovery with unprecedented accuracy and effici',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-skills-manager-6d6b9d75',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Skills Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your martech operations with our Autonomous Skills Manager. This AI-driven solution automates process discovery with unprecedented accuracy and efficiency.
          </p>
