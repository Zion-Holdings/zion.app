...
export const metadata: Metadata = {
  title: 'Cognitive Security Solution - Gaming',
  description: 'Enhance your gaming business with Cognitive Security Solution - Gaming. Our solution provides user provisioning with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-security-solution-gaming-7029fd22',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Security Solution - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your gaming business with Cognitive Security Solution - Gaming. Our solution provides user provisioning with enterprise-grade reliability and security.
          </p>
