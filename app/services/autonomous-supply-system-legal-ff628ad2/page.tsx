...
export const metadata: Metadata = {
  title: 'Autonomous Supply System - Legal',
  description: 'Next-generation legal solution: Autonomous Supply System - Legal. Combines succession planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-supply-system-legal-ff628ad2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Supply System - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Autonomous Supply System - Legal. Combines succession planning with adaptive intelligence for optimal results.
          </p>
