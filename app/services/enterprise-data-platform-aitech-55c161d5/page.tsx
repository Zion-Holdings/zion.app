...
export const metadata: Metadata = {
  title: 'Enterprise Data Platform - AITECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Data Platform - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated aitech solution: Enterprise Data Platform - AITECH. Combines lead scoring with next-gen AI for maximum velocity.
          </p>
