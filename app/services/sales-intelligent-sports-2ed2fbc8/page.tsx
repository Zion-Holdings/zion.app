...
export const metadata: Metadata = {
  title: 'Sales Intelligent - Sports',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Sales Intelligent - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in sports with Sales Intelligent - Sports. This AI-powered platform transforms loyalty optimization into a competitive advantage.
          </p>
