...
export const metadata: Metadata = {
  title: 'Automated Root Experience',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Root Experience
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Automated Root Experience. Combines reputation management with adaptive intelligence for optimal results.
          </p>
