...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "DevSecOps Pipeline | Zion Tech Group", description: "End-to-end devsecops pipeline services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/devsecops-pipeline-2026-6887/"}} />
