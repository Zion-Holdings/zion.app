...
export const metadata: Metadata = {
  title: 'Automated executive-legal',
  description: 'Next-generation legal solution: Automated executive-legal. Combines performance reviews with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-executive-legal-9c55676f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated executive-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Automated executive-legal. Combines performance reviews with adaptive intelligence for optimal results.
          </p>
