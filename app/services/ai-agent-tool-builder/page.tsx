      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Visual no-code tool builder for LLM agents: define function-calling tools, MCP server scaffolding, OpenAPI wrapper, and sandbox test harness.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Drag-drop tool schema builder</li>
            <li className="text-purple-300">✓ MCP server scaffold + OpenAPI wrapper</li>
            <li className="text-purple-300">✓ Sandbox execution harness per tool</li>
            <li className="text-purple-300">✓ Multi-model compatibility (OpenAI/Anthropic/Google)</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai agent tool builder</li>
