...
export const metadata: Metadata = {
  ...
  keywords: 'Drag-drop tool schema builder, MCP server scaffold + OpenAPI wrapper, Sandbox execution harness per tool, Multi-model compatibility (OpenAI/Anthropic/Google), ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Agent Tool Builder</h1>
        <p className="text-lg text-slate-300 mb-8">Visual no-code tool builder for LLM agents: define function-calling tools, MCP server scaffolding, OpenAPI wrapper, and sandbox test harness.</p>
        ...
        <li class="text-slate-300">Drag-drop tool schema builder</li>
        <li class="text-slate-300">MCP server scaffold + OpenAPI wrapper</li>
        <li class="text-slate-300">Sandbox execution harness per tool</li>
        <li class="text-slate-300">Multi-model compatibility (OpenAI/Anthropic/Google)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai agent tool builder</li>
