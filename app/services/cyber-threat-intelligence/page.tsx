...
export const metadata: Metadata = {
  ...
  keywords: 'Automated threat feed ingestion (50+ sources), AI-driven threat prioritization (impact scoring), IOC & TTP matching against your environment, Dark web monitoring for leaked credentials, Executive threat briefings & reporting, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Proactive threat intelligence gathering, analysis, and prioritization from dark web, exploit feeds, and threat actor TTPs to stay ahead of attacks.</p>
        ...
        <li class="text-slate-300">Automated threat feed ingestion (50+ sources)</li>
        <li class="text-slate-300">AI-driven threat prioritization (impact scoring)</li>
        <li class="text-slate-300">IOC &amp; TTP matching against your environment</li>
        <li class="text-slate-300">Dark web monitoring for leaked credentials</li>
        <li class="text-slate-300">Executive threat briefings &amp; reporting</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai cyber threat intelligence platform</li>
