...
export const metadata: Metadata = {
  title: 'Intelligent Executive for Hospitality',
  description: 'Unlock unprecedented growth with Intelligent Executive for Hospitality. This autonomous system provides form processing with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-executive-for-hospitality-b9e48d54',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Executive for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Executive for Hospitality. This autonomous system provides form processing with zero manual intervention needed.
          </p>
