...
export const metadata: Metadata = {
  title: 'Adaptive Supply for Healthcare',
  description: 'The future of healthcare is here with Adaptive Supply for Healthcare. Powered by cutting-edge AI, this platform delivers transformative results like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-supply-for-healthcare-80cbe961',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Supply for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Adaptive Supply for Healthcare. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
