...
export const metadata: Metadata = {
  title: 'Predictive optimization-agritech',
  description: 'The future of agritech is here with Predictive optimization-agritech. Powered by cutting-edge AI, this platform delivers performance monitoring like never befor',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive optimization-agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agritech is here with Predictive optimization-agritech. Powered by cutting-edge AI, this platform delivers performance monitoring like never before.
          </p>
