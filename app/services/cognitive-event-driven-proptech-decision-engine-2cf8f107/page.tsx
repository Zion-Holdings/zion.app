...
export const metadata = {
  title: "Cognitive Event-Driven Proptech Decision Engine - Zion Tech Group",
  description: "Cognitive decision engine that processes event-driven signals to drive proptech strategy with deep learning.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/cognitive-event-driven-proptech-decision-engine-2cf8f107`
  }
};
