...
export const metadata: Metadata = {
  ...
  keywords: 'Custom integrations, Auto-scaling capabilities, Container orchestration, Microservices deployment, Performance dashboards, Multi-language support, predictor, construction, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Predictive Suite for Construction</h1>
        <p className="text-lg text-slate-300 mb-8">Transform your construction operations with our Predictive Suite for Construction. This AI-driven solution automates energy management with unprecedented accuracy and efficiency.</p>
