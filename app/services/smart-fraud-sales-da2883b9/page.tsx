...
export const metadata: Metadata = {
  title: 'Smart Fraud Sales',
  description: 'Transform your retail operations with our Smart Fraud Sales. This AI-driven solution automates supply chain with unprecedented accuracy and efficiency.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-fraud-sales-da2883b9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our Smart Fraud Sales. This AI-driven solution automates supply chain with unprecedented accuracy and efficiency.
          </p>
