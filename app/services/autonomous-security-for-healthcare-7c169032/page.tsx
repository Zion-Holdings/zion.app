...
export const metadata: Metadata = {
  title: 'Autonomous Security for Healthcare',
  description: 'Transform your healthcare operations with our Autonomous Security for Healthcare. This AI-driven solution automates energy management with unprecedented accurac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-security-for-healthcare-7c169032',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Security for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Autonomous Security for Healthcare. This AI-driven solution automates energy management with unprecedented accuracy and efficiency.
          </p>
