...
export const metadata: Metadata = {
  title: "5G Intelligent Document Processing AI - AI-Powered 5G Solution",
  ...
  alternates: {
    canonical: "https://ziontechgroup.com/services/5g-intelligent-document-processing-ai-07307104",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          5G Intelligent Document Processing AI - AI-Powered 5G Solution
        </h1>
