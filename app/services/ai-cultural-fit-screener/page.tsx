...
export const metadata: Metadata = {
  ...
  keywords: 'Value-alignment scoring per candidate, Behavioral flag detection, Culture-card comparison vs new hire baseline, Auto short-list per candidate + hiring manager, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Cultural Fit Screener</h1>
        <p className="text-lg text-slate-300 mb-8">AI evaluates resume+behavioral vs your company values: culture-fit score, behavioral alignment scoring, red-flag indicators before interview, auto short-list explanation.</p>
        ...
        <li class="text-slate-300">Value-alignment scoring per candidate</li>
        <li class="text-slate-300">Behavioral flag detection</li>
        <li class="text-slate-300">Culture-card comparison vs new hire baseline</li>
        <li class="text-slate-300">Auto short-list per candidate + hiring manager</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai cultural fit screener</li>
