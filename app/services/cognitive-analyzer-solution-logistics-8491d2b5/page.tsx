...
export const metadata: Metadata = {
  title: 'Cognitive Analyzer Solution - Logistics',
  description: 'Next-generation logistics solution: Cognitive Analyzer Solution - Logistics. Combines personalization engine with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-analyzer-solution-logistics-8491d2b5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Analyzer Solution - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Cognitive Analyzer Solution - Logistics. Combines personalization engine with adaptive intelligence for optimal results.
          </p>
