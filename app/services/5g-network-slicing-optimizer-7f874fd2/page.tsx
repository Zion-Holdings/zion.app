...
export const metadata = {
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/5g-network-slicing-optimizer-7f874fd2`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path={`/services/5g-network-slicing-optimizer-7f874fd2`} title="5G Network Slicing Optimizer" />
