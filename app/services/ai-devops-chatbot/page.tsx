      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Natural language interface to your infrastructure: ask for logs, deployments, metrics, and incidents; get instant answers and auto-remediation suggestions.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Natural language queries over logs & metrics</li>
            <li className="text-purple-300">✓ Incident root cause summarization</li>
            <li className="text-purple-300">✓ Automated runbook execution (via chat)</li>
            <li className="text-purple-300">✓ Slack/MS Teams integration</li>
            <li className="text-purple-300">✓ Access control & audit logging</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai devops chatbot</li>
