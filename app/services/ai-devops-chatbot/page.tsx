...
export const metadata: Metadata = {
  ...
  keywords: 'Natural language queries over logs & metrics, Incident root cause summarization, Automated runbook execution (via chat), Slack/MS Teams integration, Access control & audit logging, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI DevOps Chatbot</h1>
        <p className="text-lg text-slate-300 mb-8">Natural language interface to your infrastructure: ask for logs, deployments, metrics, and incidents; get instant answers and auto-remediation suggestions.</p>
        ...
        <li class="text-slate-300">Natural language queries over logs &amp; metrics</li>
        <li class="text-slate-300">Incident root cause summarization</li>
        <li class="text-slate-300">Automated runbook execution (via chat)</li>
        <li class="text-slate-300">Slack/MS Teams integration</li>
        <li class="text-slate-300">Access control &amp; audit logging</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai devops chatbot</li>
