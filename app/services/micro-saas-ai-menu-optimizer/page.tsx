...
export const metadata: Metadata = {
  ...
  keywords: 'AI menu item profitability analysis, Star/Puzzle/Plowhorse/Pet classification, Dynamic pricing recommendations, Food cost tracking and alerting, Customer preference analysis from orders, Integration with POS systems (Square, Toast, Clover), Menu A/B testing and simulation, Seasonal menu optimization, ai, food-tech, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Menu Engineering &amp; Profit Optimizer</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered menu engineering for restaurants and food service. Analyzes sales data, food costs, and customer preferences to optimize menu pricing and layout for maximum profit.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">ai</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">food-tech</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">AI menu item profitability analysis</li>
        <li class="text-slate-300">Star/Puzzle/Plowhorse/Pet classification</li>
        <li class="text-slate-300">Dynamic pricing recommendations</li>
        <li class="text-slate-300">Food cost tracking and alerting</li>
        <li class="text-slate-300">Customer preference analysis from orders</li>
        <li class="text-slate-300">Integration with POS systems (Square, Toast, Clover)</li>
        <li class="text-slate-300">Menu A/B testing and simulation</li>
        <li class="text-slate-300">Seasonal menu optimization</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Increase profit margins by 15-25%</li>
        <li class="text-slate-300">Identify hidden star items and costly dogs</li>
        <li class="text-slate-300">Optimize menu layout for higher check sizes</li>
        <li class="text-slate-300">Reduce food waste with demand prediction</li>
      </ul>
        </div>
