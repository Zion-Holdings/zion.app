...
export const metadata: Metadata = {
  ...
  keywords: 'SOC 2 certified, Multi-language support, Auto-scaling capabilities, Alerting system, processor, construction, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Optimization Autonomous - Construction</h1>
        <p className="text-lg text-slate-300 mb-8">Revolutionize construction through intelligent automation. Our Optimization Autonomous - Construction leverages advanced machine learning to deliver risk assessment at scale.</p>
