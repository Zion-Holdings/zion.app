...
export const metadata: Metadata = {
  title: 'Orchestrator Intelligent - Telecom',
  description: 'Optimize your telecom workflows with Orchestrator Intelligent - Telecom. This intelligent platform delivers content moderation through advanced automation and A',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/orchestrator-intelligent-telecom-7b303fdd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Orchestrator Intelligent - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your telecom workflows with Orchestrator Intelligent - Telecom. This intelligent platform delivers content moderation through advanced automation and AI.
          </p>
