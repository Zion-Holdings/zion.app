...
export const metadata: Metadata = {
  title: 'Smart User Provisioning Platform - Energy',
  description: 'Drive innovation in energy with Smart User Provisioning Platform - Energy. This AI-powered platform transforms resource allocation into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-user-provisioning-platform-energy-19a53977',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart User Provisioning Platform - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Smart User Provisioning Platform - Energy. This AI-powered platform transforms resource allocation into a competitive advantage.
          </p>
