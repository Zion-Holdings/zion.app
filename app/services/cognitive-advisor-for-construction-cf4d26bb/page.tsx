...
export const metadata: Metadata = {
  title: 'Cognitive Advisor for Construction',
  description: 'Optimize your construction workflows with Cognitive Advisor for Construction. This intelligent platform delivers financial risk management through advanced auto',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-advisor-for-construction-cf4d26bb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Advisor for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Cognitive Advisor for Construction. This intelligent platform delivers financial risk management through advanced automation and AI.
          </p>
