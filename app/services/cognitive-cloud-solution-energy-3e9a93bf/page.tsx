...
export const metadata: Metadata = {
  title: 'Cognitive Cloud Solution - Energy',
  description: 'Drive innovation in energy with Cognitive Cloud Solution - Energy. This AI-powered platform transforms threat detection into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-cloud-solution-energy-3e9a93bf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Cloud Solution - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Cognitive Cloud Solution - Energy. This AI-powered platform transforms threat detection into a competitive advantage.
          </p>
