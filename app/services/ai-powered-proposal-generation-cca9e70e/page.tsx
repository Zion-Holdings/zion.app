...
export const metadata: Metadata = {
  ...
  description: 'Creates customized sales proposals with product recommendations and pricing in seconds.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-proposal-generation-cca9e70e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Creates customized sales proposals with product recommendations and pricing in seconds.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Proposal generation</li>
          <li className="text-gray-300">Product recommendations</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">Instant proposals</li>
