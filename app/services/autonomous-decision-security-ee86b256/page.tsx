...
export const metadata: Metadata = {
  title: 'Autonomous Decision Security',
  description: 'Enhance your transportation business with Autonomous Decision Security. Our solution provides invoice processing with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-decision-security-ee86b256',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with Autonomous Decision Security. Our solution provides invoice processing with enterprise-grade reliability and security.
          </p>
