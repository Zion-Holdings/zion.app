...
export const metadata: Metadata = {
  title: 'AI-Powered predictive-construction',
  description: 'Enhance your construction business with AI-Powered predictive-construction. Our solution provides procurement automation with enterprise-grade reliability and s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-predictive-construction-43a71150',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with AI-Powered predictive-construction. Our solution provides procurement automation with enterprise-grade reliability and security.
          </p>
