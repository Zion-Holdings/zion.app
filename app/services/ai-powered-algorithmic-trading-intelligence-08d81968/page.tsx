...
export const metadata: Metadata = {
  ...
  description: 'End-to-end algorithmic trading platform that generates, backtests, and deploys trading strategies using machine learning. Features include real-time market anal',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-algorithmic-trading-intelligence-08d81968',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            End-to-end algorithmic trading platform that generates, backtests, and deploys trading strategies using machine learning. Features include real-time market analysis, risk management, and automated execution.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Strategy generation</li>
          <li className="text-gray-300">Backtesting engine</li>
          <li className="text-gray-300">Risk management</li>
          <li className="text-gray-300">Live execution</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">35%+ alpha generation</li>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$4999</p>
          <ul className="space-y-2 mb-4">
