...
export const metadata: Metadata = {
  title: 'Customer Service Intelligent - Iot',
  description: 'The future of iot is here with Customer Service Intelligent - Iot. Powered by cutting-edge AI, this platform delivers user experience like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/customer-service-intelligent---iot-4f35cda8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Customer Service Intelligent - Iot
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of iot is here with Customer Service Intelligent - Iot. Powered by cutting-edge AI, this platform delivers user experience like never before.
          </p>
