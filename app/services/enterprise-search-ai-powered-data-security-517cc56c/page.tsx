...
export const metadata: Metadata = {
  title: 'Enterprise Search AI-Powered Data Security',
  description: 'AI-powered enterprise search solution for security. Automated data access control and encryption management.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-search-ai-powered-data-security-517cc56c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Search AI-Powered Data Security
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered enterprise search solution for security. Automated data access control and encryption management.
          </p>
