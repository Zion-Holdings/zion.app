...
export const metadata: Metadata = {
  title: 'AI-Powered finance-real-estate',
  description: 'Revolutionize real-estate through intelligent automation. Our AI-Powered finance-real-estate leverages advanced machine learning to deliver language processing ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered finance-real-estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our AI-Powered finance-real-estate leverages advanced machine learning to deliver language processing at scale.
          </p>
