...
export const metadata: Metadata = {
  ...
  keywords: 'LLM application architecture and design, RAG (Retrieval-Augmented Generation) implementation, Multi-agent system design and orchestration (LangChain, LangGraph, CrewAI), Vector database selection and optimization (Pinecone, Weaviate, Qdrant), Prompt engineering and fine-tuning workflows, AI safety, guardrails, and output validation, Scalable deployment with cost optimization, Evaluation frameworks and A/B testing for AI outputs, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Powered Application Development</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end development service for building production-ready AI applications — from LLM-powered chatbots and RAG systems to multi-agent workflows and AI-native products.</p>
        ...
        <li class="text-slate-300">LLM application architecture and design</li>
        <li class="text-slate-300">RAG (Retrieval-Augmented Generation) implementation</li>
        <li class="text-slate-300">Multi-agent system design and orchestration (LangChain, LangGraph, CrewAI)</li>
        <li class="text-slate-300">Vector database selection and optimization (Pinecone, Weaviate, Qdrant)</li>
        <li class="text-slate-300">Prompt engineering and fine-tuning workflows</li>
        <li class="text-slate-300">AI safety, guardrails, and output validation</li>
        <li class="text-slate-300">Scalable deployment with cost optimization</li>
        <li class="text-slate-300">Evaluation frameworks and A/B testing for AI outputs</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai-powered application development</li>
