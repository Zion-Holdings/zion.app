      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            End-to-end development service for building production-ready AI applications — from LLM-powered chatbots and RAG systems to multi-agent workflows and AI-native products.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ LLM application architecture and design</li>
            <li className="text-purple-300">✓ RAG (Retrieval-Augmented Generation) implementation</li>
            <li className="text-purple-300">✓ Multi-agent system design and orchestration (LangChain, LangGraph, CrewAI)</li>
            <li className="text-purple-300">✓ Vector database selection and optimization (Pinecone, Weaviate, Qdrant)</li>
            <li className="text-purple-300">✓ Prompt engineering and fine-tuning workflows</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai-powered application development</li>
