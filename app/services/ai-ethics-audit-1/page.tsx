  ...
  <div className="min-h-screen bg-slate-950 text-white">
   ...
   <main className="min-h-screen bg-slate-950 py-20 px-4">
    <div className="container-page max-w-4xl mx-auto">
     <h1 className="text-4xl font-bold text-white mb-4">AI Ethics Audit & Bias Assessment</h1>
     <p className="text-slate-300 text-lg mb-8">Independent AI ethics audits examining your AI systems for bias, fairness, transparency, and regulatory compliance. Includes algorithmic impact assessments, bias testing across protected classes, and governance framework design.</p>
