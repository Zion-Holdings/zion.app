      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Independent AI ethics audits examining your AI systems for bias, fairness, transparency, and regulatory compliance. Includes algorithmic impact assessments, bias testing across protected classes, and governance framework design.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Algorithmic bias detection across race, gender, age, and geography</li>
            <li className="text-purple-300">✓ Model interpretability and explainability analysis (XAI)</li>
            <li className="text-purple-300">✓ EU AI Act compliance assessment and readiness</li>
            <li className="text-purple-300">✓ AI impact assessment for high-risk applications</li>
            <li className="text-purple-300">✓ Fairness metrics evaluation (demographic parity, equalized odds)</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai ethics audit & bias assessment</li>
