...
export const metadata: Metadata = {
  ...
  keywords: 'Edge processing, Real-time analytics, Automated responses, Energy efficiency, iot, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Powered Proactive IoT Intelligence</h1>
        <p className="text-lg text-slate-300 mb-8">Edge AI platform that processes IoT sensor data in real-time with proactive insights.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">iot</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">technology</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Edge processing</li>
        <li class="text-slate-300">Real-time analytics</li>
        <li class="text-slate-300">Automated responses</li>
        <li class="text-slate-300">Energy efficiency</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduced latency</li>
        <li class="text-slate-300">Better insights</li>
        <li class="text-slate-300">Automated responses</li>
        <li class="text-slate-300">Energy efficiency</li>
      </ul>
        </div>
