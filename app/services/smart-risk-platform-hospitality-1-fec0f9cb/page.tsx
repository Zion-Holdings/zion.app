...
export const metadata: Metadata = {
  title: 'Smart Risk Platform - Hospitality #1',
  description: 'Unlock unprecedented growth with Smart Risk Platform - Hospitality #1. This autonomous system provides financial planning with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-risk-platform-hospitality-1-fec0f9cb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Risk Platform - Hospitality #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Risk Platform - Hospitality #1. This autonomous system provides financial planning with zero manual intervention needed.
          </p>
