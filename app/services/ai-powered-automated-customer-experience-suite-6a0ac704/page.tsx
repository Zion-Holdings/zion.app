...
export const metadata: Metadata = {
  ...
  keywords: 'Omnichannel support, Personalization engine, Sentiment analysis, Journey mapping, customer experience, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Powered Automated Customer Experience Suite</h1>
        <p className="text-lg text-slate-300 mb-8">Next-generation customer experience platform that delivers automated service delivery across all touchpoints.</p>
        ...
        <li class="text-slate-300">Omnichannel support</li>
        <li class="text-slate-300">Personalization engine</li>
        <li class="text-slate-300">Sentiment analysis</li>
        <li class="text-slate-300">Journey mapping</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Higher customer satisfaction</li>
        <li class="text-slate-300">Increased loyalty</li>
        <li class="text-slate-300">Reduced churn</li>
        <li class="text-slate-300">Improved CSAT scores</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">218</p>
              <p class="text-sm text-slate-400">Getting started plan</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              <h3 class="font-semibold text-white mb-2">Pro</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">548</p>
              <p class="text-sm text-slate-400">Most popular</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              <h3 class="font-semibold text-white mb-2">Enterprise</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">1648</p>
