...
export const metadata: Metadata = {
  title: 'Intelligent Smart for Logistics',
  description: 'The future of logistics is here with Intelligent Smart for Logistics. Powered by cutting-edge AI, this platform delivers revenue forecasting like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-smart-for-logistics-d3a3b849',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Smart for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Intelligent Smart for Logistics. Powered by cutting-edge AI, this platform delivers revenue forecasting like never before.
          </p>
