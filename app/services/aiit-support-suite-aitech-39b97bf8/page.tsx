...
export const metadata: Metadata = {
  title: 'AI/IT Support Suite - AITECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Support Suite - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in aitech with AI/IT Support Suite - AITECH. This AI-powered platform transforms dashboard automation into a competitive advantage.
          </p>
