...
export const metadata: Metadata = {
  title: 'Predictive Experience Engine - ALTHEALTH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Experience Engine - ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in althealth with Predictive Experience Engine - ALTHEALTH. This AI-powered platform transforms net promoter score into a competitive advantage.
          </p>
