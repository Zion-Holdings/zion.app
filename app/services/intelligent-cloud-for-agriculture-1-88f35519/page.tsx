...
export const metadata: Metadata = {
  title: 'Intelligent Cloud for Agriculture #1',
  description: 'Enhance your agriculture business with Intelligent Cloud for Agriculture #1. Our solution provides recruitment automation with enterprise-grade reliability and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-cloud-for-agriculture-1-88f35519',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Cloud for Agriculture #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your agriculture business with Intelligent Cloud for Agriculture #1. Our solution provides recruitment automation with enterprise-grade reliability and security.
          </p>
