...
export const metadata: Metadata = {
  ...
  keywords: 'Clause-level risk scoring, Missing provision detection, Compliance gap analysis, Industry benchmark comparison, Redline suggestions, Integration with CLM systems, Custom risk models, Executive risk summaries, ai, Legal, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Contract Risk Analyzer</h1>
        <p className="text-lg text-slate-300 mb-8">Analyze contract risk with AI. Identify unfavorable clauses, missing provisions, and compliance gaps. Compare against industry benchmarks and internal standards.</p>
        ...
        <li class="text-slate-300">Clause-level risk scoring</li>
        <li class="text-slate-300">Missing provision detection</li>
        <li class="text-slate-300">Compliance gap analysis</li>
        <li class="text-slate-300">Industry benchmark comparison</li>
        <li class="text-slate-300">Redline suggestions</li>
        <li class="text-slate-300">Integration with CLM systems</li>
        <li class="text-slate-300">Custom risk models</li>
        <li class="text-slate-300">Executive risk summaries</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce contract risk exposure</li>
        <li class="text-slate-300">Speed up contract review</li>
        <li class="text-slate-300">Ensure compliance</li>
        <li class="text-slate-300">Standardize risk assessment</li>
      </ul>
        </div>
