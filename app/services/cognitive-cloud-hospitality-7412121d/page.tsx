...
export const metadata: Metadata = {
  title: 'Cognitive cloud-hospitality',
  description: 'The future of hospitality is here with Cognitive cloud-hospitality. Powered by cutting-edge AI, this platform delivers feature engineering like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-cloud-hospitality-7412121d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive cloud-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Cognitive cloud-hospitality. Powered by cutting-edge AI, this platform delivers feature engineering like never before.
          </p>
