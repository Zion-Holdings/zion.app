...
export const metadata: Metadata = {
  title: 'Smart Optimization Platform - Telecom',
  description: 'Next-generation telecom solution: Smart Optimization Platform - Telecom. Combines project management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-optimization-platform-telecom-51f9fa14',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Optimization Platform - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation telecom solution: Smart Optimization Platform - Telecom. Combines project management with adaptive intelligence for optimal results.
          </p>
