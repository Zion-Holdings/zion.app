...
export const metadata: Metadata = {
  title: 'Automated Security Performance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Security Performance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in transportation with Automated Security Performance. This AI-powered platform transforms compliance monitoring into a competitive advantage.
          </p>
