...
export const metadata: Metadata = {
  title: 'Autonomous Experience System - Healthcare',
  description: 'Hyper-accelerated healthcare solution: Autonomous Experience System - Healthcare. Combines audit trail management with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-experience-system-healthcare-4db10e2b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Experience System - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated healthcare solution: Autonomous Experience System - Healthcare. Combines audit trail management with next-gen AI for maximum velocity.
          </p>
