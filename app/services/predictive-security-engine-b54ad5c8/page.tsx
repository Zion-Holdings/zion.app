...
export const metadata: Metadata = {
  title: 'Predictive Security Engine',
  description: 'Revolutionize edge through intelligent automation. Our Predictive Security Engine leverages advanced machine learning to deliver financial risk management at sc',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize edge through intelligent automation. Our Predictive Security Engine leverages advanced machine learning to deliver financial risk management at scale.
          </p>
