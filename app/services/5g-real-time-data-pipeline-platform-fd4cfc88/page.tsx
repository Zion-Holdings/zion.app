...
export const metadata: Metadata = {
  title: "5G Real-Time Data Pipeline Platform - AI-Powered 5G Solution",
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          5G Real-Time Data Pipeline Platform - AI-Powered 5G Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          AI-powered 5g solution for data engineering. Creates and manages real-time data pipelines with automated ETL and streaming analytics.
        </p>
