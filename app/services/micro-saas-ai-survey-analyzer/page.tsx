...
export const metadata = {
  ...
  description: "Advanced survey platform with AI-powered open-ended response analysis, sentiment tracking, and automated insight generation. Turns qualitative feedback into act",
  alternates: {
