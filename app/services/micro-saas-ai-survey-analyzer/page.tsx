...
export const metadata: Metadata = {
  ...
  keywords: 'AI open-ended response categorization, Sentiment analysis with emotion detection, Trend tracking across survey waves, Automated insight reports with recommendations, Multi-language support (40+ languages), Integration with Slack, Teams, email, micro-saas, analytics, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Micro-SaaS AI Survey &amp; Feedback Analyzer</h1>
        <p className="text-lg text-slate-300 mb-8">Advanced survey platform with AI-powered open-ended response analysis, sentiment tracking, and automated insight generation. Turns qualitative feedback into actionable data.</p>
        ...
        <li class="text-slate-300">AI open-ended response categorization</li>
        <li class="text-slate-300">Sentiment analysis with emotion detection</li>
        <li class="text-slate-300">Trend tracking across survey waves</li>
        <li class="text-slate-300">Automated insight reports with recommendations</li>
        <li class="text-slate-300">Multi-language support (40+ languages)</li>
        <li class="text-slate-300">Integration with Slack, Teams, email</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Analyze 10,000 open-ended responses in seconds</li>
        <li class="text-slate-300">Track sentiment trends over time</li>
        <li class="text-slate-300">Automatically generate executive summaries</li>
        <li class="text-slate-300">Close the loop with action item tracking</li>
      </ul>
        </div>
