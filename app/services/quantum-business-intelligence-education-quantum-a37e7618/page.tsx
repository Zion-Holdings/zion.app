...
export const metadata: Metadata = {
  title: 'Quantum Business Intelligence - Education Quantum',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Business Intelligence - Education Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated education solution: Quantum Business Intelligence - Education Quantum. Combines social media monitoring with next-gen AI for maximum velocity.
          </p>
