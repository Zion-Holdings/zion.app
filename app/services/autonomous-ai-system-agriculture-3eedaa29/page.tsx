...
export const metadata: Metadata = {
  title: 'Autonomous AI System - Agriculture',
  description: 'Transform your agriculture operations with our Autonomous AI System - Agriculture. This AI-driven solution automates recruitment automation with unprecedented a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-ai-system-agriculture-3eedaa29',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous AI System - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Autonomous AI System - Agriculture. This AI-driven solution automates recruitment automation with unprecedented accuracy and efficiency.
          </p>
