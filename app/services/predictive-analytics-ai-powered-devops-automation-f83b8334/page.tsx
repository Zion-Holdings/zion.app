...
export const metadata: Metadata = {
  title: 'Predictive Analytics AI-Powered DevOps Automation',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Analytics AI-Powered DevOps Automation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered predictive analytics solution for devops. Automated CI/CD pipelines with intelligent testing and deployment.
          </p>
