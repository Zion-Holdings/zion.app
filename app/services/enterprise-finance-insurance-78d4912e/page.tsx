...
export const metadata: Metadata = {
  title: 'Enterprise Finance - Insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Finance - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Enterprise Finance - Insurance. This AI-powered platform transforms contract analysis into a competitive advantage.
          </p>
