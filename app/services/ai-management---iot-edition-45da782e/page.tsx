...
export const metadata: Metadata = {
  title: 'AI Management - Iot Edition',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Management - Iot Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize iot through intelligent automation. Our AI Management - Iot Edition leverages advanced machine learning to deliver logistics route optimization at scale.
          </p>
