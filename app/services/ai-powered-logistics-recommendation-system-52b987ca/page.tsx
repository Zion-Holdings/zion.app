...
export const metadata: Metadata = {
  title: 'AI-Powered Logistics Recommendation System',
  description: 'AI-powered recommendation system for supply chain with Route optimization, Customer satisfaction, and 30% cost reduction.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-logistics-recommendation-system-52b987ca',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Logistics Recommendation System
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered recommendation system for supply chain with Route optimization, Customer satisfaction, and 30% cost reduction.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Tracking</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">Route optimization</li>
          <li className="text-purple-300">Customer satisfaction</li>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$3053</p>
          <ul className="space-y-2 mb-4">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$11880</p>
          <ul className="space-y-2 mb-4">
