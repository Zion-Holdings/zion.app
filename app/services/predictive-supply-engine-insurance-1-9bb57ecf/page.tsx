...
export const metadata: Metadata = {
  title: 'Predictive Supply Engine - Insurance #1',
  description: 'Transform your insurance operations with our Predictive Supply Engine - Insurance #1. This AI-driven solution automates document processing with unprecedented a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-supply-engine-insurance-1-9bb57ecf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Supply Engine - Insurance #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Predictive Supply Engine - Insurance #1. This AI-driven solution automates document processing with unprecedented accuracy and efficiency.
          </p>
