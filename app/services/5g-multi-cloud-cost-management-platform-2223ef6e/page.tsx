...
export const metadata: Metadata = {
  title: "5G Multi-Cloud Cost Management Platform - AI-Powered 5G Solution",
  description: "AI-powered 5g solution for cloud operations. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/5g-multi-cloud-cost-management-platform-2223ef6e",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          5G Multi-Cloud Cost Management Platform - AI-Powered 5G Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          AI-powered 5g solution for cloud operations. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.
        </p>
