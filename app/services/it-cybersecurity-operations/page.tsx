...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'IT Cybersecurity Operations & Incident Response', 'description': '24/7 cybersecurity operations with threat detection, incident response, and compliance monitoring. SOC-as-a-service for organizations of all sizes.', 'serviceType': 'security', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'technology'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'IT Cybersecurity Operations & Incident Response Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$5,000/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$12,000/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': 'Custom', 'priceCurrency': 'USD'}]}} />
    <JsonLd data={'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': '24/7 security monitoring by certified analysts', 'acceptedAnswer': {'@type': 'Answer', 'text': '24/7 security monitoring by certified analysts'}}, {'@type': 'Question', 'name': 'SIEM management and tuning', 'acceptedAnswer': {'@type': 'Answer', 'text': 'SIEM management and tuning'}}, {'@type': 'Question', 'name': 'Incident response with 15-minute SLA', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Incident response with 15-minute SLA'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Enterprise-grade SOC for 1/10th the cost; Detect and respond to threats in 15 minutes; Meet compliance monitoring requirements'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} />
