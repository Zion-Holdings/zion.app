...
export const metadata: Metadata = {
  ...
  keywords: '24/7 security monitoring by certified analysts, SIEM management and tuning, Incident response with 15-minute SLA, Threat intelligence integration, Vulnerability scanning and management, Compliance monitoring (SOC 2, HIPAA, PCI), Monthly security posture reports, Tabletop exercises and IR planning, security, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Cybersecurity Operations &amp; Incident Response</h1>
        <p className="text-lg text-slate-300 mb-8">24/7 cybersecurity operations with threat detection, incident response, and compliance monitoring. SOC-as-a-service for organizations of all sizes.</p>
        ...
        <li class="text-slate-300">24/7 security monitoring by certified analysts</li>
        <li class="text-slate-300">SIEM management and tuning</li>
        <li class="text-slate-300">Incident response with 15-minute SLA</li>
        <li class="text-slate-300">Threat intelligence integration</li>
        <li class="text-slate-300">Vulnerability scanning and management</li>
        <li class="text-slate-300">Compliance monitoring (SOC 2, HIPAA, PCI)</li>
        <li class="text-slate-300">Monthly security posture reports</li>
        <li class="text-slate-300">Tabletop exercises and IR planning</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Enterprise-grade SOC for 1/10th the cost</li>
        <li class="text-slate-300">Detect and respond to threats in 15 minutes</li>
        <li class="text-slate-300">Meet compliance monitoring requirements</li>
        <li class="text-slate-300">Access certified security analysts 24/7</li>
      </ul>
        </div>
