...
export const metadata: Metadata = {
  ...
  keywords: '400+ pre-built connectors, Visual pipeline builder, Schema drift auto-handling, Data quality assertions, Incremental extraction, data, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Batch ETL Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Visual ETL/ELT builder with 400+ connectors, scheduled or event-triggered pipelines, schema drift handling, and data quality checks.</p>
        ...
        <li class="text-slate-300">400+ pre-built connectors</li>
        <li class="text-slate-300">Visual pipeline builder</li>
        <li class="text-slate-300">Schema drift auto-handling</li>
        <li class="text-slate-300">Data quality assertions</li>
        <li class="text-slate-300">Incremental extraction</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with batch etl platform</li>
