...
export const metadata: Metadata = {
  title: 'Next-Gen Training - Retail',
  description: 'Enhance your retail business with Next-Gen Training - Retail. Our solution provides serverless deployment with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-training-retail-318fde66',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Training - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your retail business with Next-Gen Training - Retail. Our solution provides serverless deployment with enterprise-grade reliability and security.
          </p>
