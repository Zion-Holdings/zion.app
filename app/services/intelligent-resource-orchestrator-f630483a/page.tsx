...
export const metadata: Metadata = {
  title: 'Intelligent Resource Orchestrator',
  description: 'Transform your transportation operations with our Intelligent Resource Orchestrator. This AI-driven solution automates fraud prevention with unprecedented accur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-resource-orchestrator-f630483a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your transportation operations with our Intelligent Resource Orchestrator. This AI-driven solution automates fraud prevention with unprecedented accuracy and efficiency.
          </p>
