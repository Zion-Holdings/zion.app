...
export const metadata: Metadata = {
  title: 'Intelligent intelligent-healthcare',
  description: 'The future of healthcare is here with Intelligent intelligent-healthcare. Powered by cutting-edge AI, this platform delivers feedback collection like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-intelligent-healthcare-4ddf18df',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent intelligent-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Intelligent intelligent-healthcare. Powered by cutting-edge AI, this platform delivers feedback collection like never before.
          </p>
