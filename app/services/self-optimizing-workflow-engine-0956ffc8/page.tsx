...
export const metadata: Metadata = {
  title: 'Self-Optimizing Workflow Engine',
  description: 'The future of sports is here with Self-Optimizing Workflow Engine. Powered by cutting-edge AI, this platform delivers sales process optimization like never befo',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Self-Optimizing Workflow Engine. Powered by cutting-edge AI, this platform delivers sales process optimization like never before.
          </p>
