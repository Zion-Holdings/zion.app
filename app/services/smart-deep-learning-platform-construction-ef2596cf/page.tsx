...
export const metadata: Metadata = {
  title: 'Smart Deep Learning Platform - Construction',
  description: 'Optimize your construction workflows with Smart Deep Learning Platform - Construction. This intelligent platform delivers customer onboarding through advanced a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Deep Learning Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Smart Deep Learning Platform - Construction. This intelligent platform delivers customer onboarding through advanced automation and AI.
          </p>
