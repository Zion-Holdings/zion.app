...
export const metadata: Metadata = {
  title: 'Smart Cloud for Transportation #1',
  description: 'Optimize your transportation workflows with Smart Cloud for Transportation #1. This intelligent platform delivers serverless deployment through advanced automat',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-cloud-for-transportation-1-90be1f46',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Cloud for Transportation #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Smart Cloud for Transportation #1. This intelligent platform delivers serverless deployment through advanced automation and AI.
          </p>
