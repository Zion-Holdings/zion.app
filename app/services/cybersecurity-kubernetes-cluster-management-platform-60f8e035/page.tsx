...
export const metadata: Metadata = {
  title: 'Cybersecurity Kubernetes Cluster Management Platform',
  description: 'AI-powered cybersecurity solution for devops. Automated Kubernetes cluster provisioning, scaling, and management.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cybersecurity-kubernetes-cluster-management-platform-60f8e035',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cybersecurity Kubernetes Cluster Management Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered cybersecurity solution for devops. Automated Kubernetes cluster provisioning, scaling, and management.
          </p>
