      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Autonomous AI agents that plan, execute, and monitor multi-step business workflows — from data gathering to decision execution with human-in-the-loop oversight.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Multi-agent orchestration with role specialization</li>
            <li className="text-purple-300">✓ Natural language workflow design</li>
            <li className="text-purple-300">✓ Human-in-the-loop approval gates</li>
            <li className="text-purple-300">✓ Self-healing workflows with error recovery</li>
            <li className="text-purple-300">✓ Real-time monitoring dashboards</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai agentic workflow automation</li>
