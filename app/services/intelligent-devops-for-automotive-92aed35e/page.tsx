...
export const metadata: Metadata = {
  title: 'Intelligent DevOps for Automotive',
  description: 'Enhance your automotive business with Intelligent DevOps for Automotive. Our solution provides social media monitoring with enterprise-grade reliability and sec',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-devops-for-automotive-92aed35e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent DevOps for Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your automotive business with Intelligent DevOps for Automotive. Our solution provides social media monitoring with enterprise-grade reliability and security.
          </p>
