      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Entity resolution graph across accounts, IPs, devices, cards, and emails</li>
            <li className="text-purple-300">✓ Real-time ML scoring per transaction in under 15ms</li>
            <li className="text-purple-300">✓ SAR and CTR auto-draft — zero compliance team manual data entry</li>
            <li className="text-purple-300">✓ Global rule engine per jurisdiction, instant payment scheme, and card network</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with fintech fraud graph</li>
