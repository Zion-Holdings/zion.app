...
export const metadata: Metadata = {
  ...
  keywords: 'Entity resolution graph across accounts, IPs, devices, cards, and emails, Real-time ML scoring per transaction in under 15ms, SAR and CTR auto-draft — zero compliance team manual data entry, Global rule engine per jurisdiction, instant payment scheme, and card network, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Fintech Fraud Graph</h1>
        <p className="text-lg text-slate-300 mb-8">Real-time fraud detection as a knowledge graph: entity resolution across accounts, IP, device, and card fingerprints; ML scoring per transaction in under 15ms; SAR and CTR auto-draft; global rule engine.</p>
        ...
        <li class="text-slate-300">Entity resolution graph across accounts, IPs, devices, cards, and emails</li>
        <li class="text-slate-300">Real-time ML scoring per transaction in under 15ms</li>
        <li class="text-slate-300">SAR and CTR auto-draft — zero compliance team manual data entry</li>
        <li class="text-slate-300">Global rule engine per jurisdiction, instant payment scheme, and card network</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with fintech fraud graph</li>
