...
export const metadata: Metadata = {
  title: 'Credit Management AI-Powered Infrastructure as Code',
  description: 'AI-powered credit management solution for infrastructure. AI-generated infrastructure code with best practices and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/credit-management-ai-powered-infrastructure-as-code-28b08ef2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Credit Management AI-Powered Infrastructure as Code
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered credit management solution for infrastructure. AI-generated infrastructure code with best practices and security.
          </p>
