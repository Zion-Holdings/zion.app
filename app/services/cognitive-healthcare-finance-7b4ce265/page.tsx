...
export const metadata: Metadata = {
  title: 'Cognitive healthcare-finance',
  description: 'Revolutionize finance through intelligent automation. Our Cognitive healthcare-finance leverages advanced machine learning to deliver testing automation at scal',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-healthcare-finance-7b4ce265',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive healthcare-finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our Cognitive healthcare-finance leverages advanced machine learning to deliver testing automation at scale.
          </p>
