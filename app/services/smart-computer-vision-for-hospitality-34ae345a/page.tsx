...
export const metadata: Metadata = {
  title: 'Smart Computer Vision for Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Smart Computer Vision for Hospitality leverages advanced machine learning to deliver enterprise-gr',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-computer-vision-for-hospitality-34ae345a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Computer Vision for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Smart Computer Vision for Hospitality leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
