...
export const metadata: Metadata = {
  title: 'Intelligent system-agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Intelligent system-agriculture leverages advanced machine learning to deliver enterprise-grade ins',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-system-agriculture-6f6d6d21',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent system-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Intelligent system-agriculture leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
