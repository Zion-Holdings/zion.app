...
export const metadata: Metadata = {
  title: 'Enterprise Process Mining - Transportation',
  description: 'Optimize your transportation workflows with Enterprise Process Mining - Transportation. This intelligent platform delivers security monitoring through advanced ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-process-mining-transportation-d497c700',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Process Mining - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Enterprise Process Mining - Transportation. This intelligent platform delivers security monitoring through advanced automation and AI.
          </p>
