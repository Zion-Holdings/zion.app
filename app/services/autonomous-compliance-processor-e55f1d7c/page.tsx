...
export const metadata: Metadata = {
  title: 'Autonomous Compliance Processor',
  description: 'The future of insurance is here with Autonomous Compliance Processor. Powered by cutting-edge AI, this platform delivers transformative results like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-compliance-processor-e55f1d7c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Compliance Processor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Autonomous Compliance Processor. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
