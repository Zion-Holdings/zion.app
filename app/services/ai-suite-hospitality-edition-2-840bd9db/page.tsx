...
export const metadata: Metadata = {
  title: 'AI Suite - Hospitality Edition #2',
  description: 'Next-generation hospitality solution: AI Suite - Hospitality Edition #2. Combines campaign optimization with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-suite-hospitality-edition-2-840bd9db',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Suite - Hospitality Edition #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: AI Suite - Hospitality Edition #2. Combines campaign optimization with adaptive intelligence for optimal results.
          </p>
