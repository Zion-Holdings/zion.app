...
export const metadata: Metadata = {
  title: 'Neural process mining-manufacturing',
  description: 'Transform your manufacturing operations with our Neural process mining-manufacturing. This AI-driven solution automates customer onboarding with unprecedented a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural process mining-manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your manufacturing operations with our Neural process mining-manufacturing. This AI-driven solution automates customer onboarding with unprecedented accuracy and efficiency.
          </p>
