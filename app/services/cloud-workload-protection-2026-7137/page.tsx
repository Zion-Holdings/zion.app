...
export const metadata = {
  ...
  description: 'End-to-end cloud workload protection services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/cloud-workload-protection-2026-7137/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">Cloud Workload Protection</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end cloud workload protection services: assessment, deployment, and managed operations.
        </p>
