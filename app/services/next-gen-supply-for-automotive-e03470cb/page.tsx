...
export const metadata: Metadata = {
  title: 'Next-Gen Supply for Automotive',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Supply for Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize automotive through intelligent automation. Our Next-Gen Supply for Automotive leverages advanced machine learning to deliver travel management at scale.
          </p>
