...
export const metadata: Metadata = {
  title: 'Strategic AI - Energy',
  description: 'Hyper-accelerated energy solution: Strategic AI - Energy. Combines contract analysis with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/strategic-ai-energy-30fec63c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated energy solution: Strategic AI - Energy. Combines contract analysis with next-gen AI for maximum velocity.
          </p>
