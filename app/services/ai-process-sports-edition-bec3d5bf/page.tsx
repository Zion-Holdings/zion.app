...
export const metadata: Metadata = {
  title: 'AI Process - Sports Edition',
  description: 'Drive innovation in sports with AI Process - Sports Edition. This AI-powered platform transforms incident response into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-process-sports-edition-bec3d5bf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Process - Sports Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in sports with AI Process - Sports Edition. This AI-powered platform transforms incident response into a competitive advantage.
          </p>
