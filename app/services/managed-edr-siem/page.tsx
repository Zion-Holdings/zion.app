...
export const metadata: Metadata = {
  ...
  keywords: 'EDR deployment + 24/7 managed tuning, SIEM log aggregation + correlation rules, SOC Tier-1/2 triage with analyst SLA, Automated kill-chain containment, Monthly executive threat report + KPI dashboard, security, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Managed EDR + SIEM SOC Service</h1>
        <p className="text-lg text-slate-300 mb-8">24/7 managed detection: EDR (CrowdStrike/SentinelOne) + SIEM (Splunk/QRadar/Sentinel), managed SOC tier 1/2 triage, kill-chain containment, executive monthly threat report.</p>
        ...
        <li class="text-slate-300">EDR deployment + 24/7 managed tuning</li>
        <li class="text-slate-300">SIEM log aggregation + correlation rules</li>
        <li class="text-slate-300">SOC Tier-1/2 triage with analyst SLA</li>
        <li class="text-slate-300">Automated kill-chain containment</li>
        <li class="text-slate-300">Monthly executive threat report + KPI dashboard</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with managed edr + siem soc service</li>
