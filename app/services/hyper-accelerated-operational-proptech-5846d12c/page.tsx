...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Operational - PROPTECH',
  description: 'Transform your proptech operations with our Hyper-Accelerated Operational - PROPTECH. This AI-driven solution automates customer retention with unprecedented ac',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Operational - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your proptech operations with our Hyper-Accelerated Operational - PROPTECH. This AI-driven solution automates customer retention with unprecedented accuracy and efficiency.
          </p>
