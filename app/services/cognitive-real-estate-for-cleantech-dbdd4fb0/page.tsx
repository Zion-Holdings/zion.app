...
export const metadata: Metadata = {
  title: 'Cognitive Real Estate for Cleantech',
  description: 'Next-generation cleantech solution: Cognitive Real Estate for Cleantech. Combines logistics route optimization with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-real-estate-for-cleantech-dbdd4fb0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Real Estate for Cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation cleantech solution: Cognitive Real Estate for Cleantech. Combines logistics route optimization with adaptive intelligence for optimal results.
          </p>
