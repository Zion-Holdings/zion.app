...
export const metadata: Metadata = {
  title: 'Enterprise Enterprise Platform - Logistics',
  description: 'Transform your logistics operations with our Enterprise Enterprise Platform - Logistics. This AI-driven solution automates content generation with unprecedented',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-enterprise-platform-logistics-77ce2463',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Enterprise Platform - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Enterprise Enterprise Platform - Logistics. This AI-driven solution automates content generation with unprecedented accuracy and efficiency.
          </p>
