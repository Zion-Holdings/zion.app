...
export const metadata: Metadata = {
  title: 'Intelligent Finance for Construction #1',
  description: 'Revolutionize construction through intelligent automation. Our Intelligent Finance for Construction #1 leverages advanced machine learning to deliver resource o',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-finance-for-construction-1-5eb10c81',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Finance for Construction #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Intelligent Finance for Construction #1 leverages advanced machine learning to deliver resource optimization at scale.
          </p>
