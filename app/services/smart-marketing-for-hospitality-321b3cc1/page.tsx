...
export const metadata: Metadata = {
  title: 'Smart Marketing for Hospitality',
  description: 'The future of hospitality is here with Smart Marketing for Hospitality. Powered by cutting-edge AI, this platform delivers financial risk management like never ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-marketing-for-hospitality-321b3cc1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Marketing for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Smart Marketing for Hospitality. Powered by cutting-edge AI, this platform delivers financial risk management like never before.
          </p>
