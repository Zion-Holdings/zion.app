...
export const metadata: Metadata = {
  title: 'Security AI - Manufacturing',
  description: 'Revolutionize manufacturing through intelligent automation. Our Security AI - Manufacturing leverages advanced machine learning to deliver enterprise-grade insi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-ai-manufacturing-2fe00f43',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize manufacturing through intelligent automation. Our Security AI - Manufacturing leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
