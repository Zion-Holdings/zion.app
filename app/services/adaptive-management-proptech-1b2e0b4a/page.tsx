...
export const metadata: Metadata = {
  title: 'Adaptive management-proptech',
  description: 'The future of proptech is here with Adaptive management-proptech. Powered by cutting-edge AI, this platform delivers financial planning like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-management-proptech-1b2e0b4a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive management-proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with Adaptive management-proptech. Powered by cutting-edge AI, this platform delivers financial planning like never before.
          </p>
