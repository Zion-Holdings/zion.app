...
export const metadata: Metadata = {
  ...
  keywords: 'Remote browser isolation — all rendering occurs off-device in a cloud sandbox, Drive-by download protection — adware aphishing payloads isolated from endpoint, Credential-forwarding sandbox — test credentials safely no overposting to real accounts, Phishing engine sandbox analysis — 30-day credential-reuse window check in isolated browser, security, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Browser Isolation Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Remote browser isolation: inspect every uncertified or risky site in cloud sandbox, drive-by download protection, credential-forwarding safe mock environment, phishing-engine sandbox analysis, bandwidth savings 30+.</p>
        ...
        <li class="text-slate-300">Remote browser isolation — all rendering occurs off-device in a cloud sandbox</li>
        <li class="text-slate-300">Drive-by download protection — adware aphishing payloads isolated from endpoint</li>
        <li class="text-slate-300">Credential-forwarding sandbox — test credentials safely no overposting to real accounts</li>
        <li class="text-slate-300">Phishing engine sandbox analysis — 30-day credential-reuse window check in isolated browser</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with browser isolation platform</li>
