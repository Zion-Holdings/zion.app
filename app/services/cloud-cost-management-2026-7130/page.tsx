...
export const metadata = {
  title: 'Cloud Cost Management | Zion Tech Group',
  description: 'End-to-end cloud cost management services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/cloud-cost-management-2026-7130/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">Cloud Cost Management</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end cloud cost management services: assessment, deployment, and managed operations.
        </p>
