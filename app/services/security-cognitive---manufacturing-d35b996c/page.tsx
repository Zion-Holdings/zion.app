...
export const metadata: Metadata = {
  title: 'Security Cognitive - Manufacturing',
  description: 'Transform your manufacturing operations with our Security Cognitive - Manufacturing. This AI-driven solution automates customer insights with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-cognitive---manufacturing-d35b996c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Cognitive - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your manufacturing operations with our Security Cognitive - Manufacturing. This AI-driven solution automates customer insights with unprecedented accuracy and efficiency.
          </p>
