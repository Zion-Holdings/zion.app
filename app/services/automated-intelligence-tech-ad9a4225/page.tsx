...
export const metadata: Metadata = {
  title: 'Automated intelligence-tech',
  description: 'The future of technology is here with Automated intelligence-tech. Powered by cutting-edge AI, this platform delivers api management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-intelligence-tech-ad9a4225',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated intelligence-tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of technology is here with Automated intelligence-tech. Powered by cutting-edge AI, this platform delivers api management like never before.
          </p>
