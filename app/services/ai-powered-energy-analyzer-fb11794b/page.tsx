...
export const metadata: Metadata = {
  title: 'AI-Powered Energy Analyzer',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Energy Analyzer
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with AI-Powered Energy Analyzer. Our solution provides data governance with enterprise-grade reliability and security.
          </p>
