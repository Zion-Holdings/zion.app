...
export const metadata: Metadata = {
  title: 'Predictive intelligent-logistics',
  description: 'Next-generation logistics solution: Predictive intelligent-logistics. Combines pipeline management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-intelligent-logistics-6eb956ab',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive intelligent-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Predictive intelligent-logistics. Combines pipeline management with adaptive intelligence for optimal results.
          </p>
