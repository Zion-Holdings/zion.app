...
export const metadata: Metadata = {
  title: 'Autonomous Data Customer',
  description: 'Transform your real-estate operations with our Autonomous Data Customer. This AI-driven solution automates benefits administration with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-data-customer-4ccc2a6a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Data Customer
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Autonomous Data Customer. This AI-driven solution automates benefits administration with unprecedented accuracy and efficiency.
          </p>
