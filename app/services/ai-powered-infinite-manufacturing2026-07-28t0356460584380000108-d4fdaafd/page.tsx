...
export const metadata: Metadata = {
  title: 'AI-Powered Infinite Manufacturing',
  description: 'Infinite manufacturing with AI and unbounded growth.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-infinite-manufacturing2026-07-28t0356460584380000108-d4fdaafd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Infinite Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Infinite manufacturing with AI and unbounded growth.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Infinite manufacturing</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">300% infinite efficiency</li>
