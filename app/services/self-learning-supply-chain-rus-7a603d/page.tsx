...
export const metadata: Metadata = {
  title: 'Self-Learning Supply Chain Rust (Iot)',
  description: 'Self-Learning Supply Chain Rust (Iot) is an AI-powered iot solution that transforms how businesses operate through intelligent automation and real-time analytic',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/self-learning-supply-chain-rus-7a603d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Learning Supply Chain Rust (Iot)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Self-Learning Supply Chain Rust (Iot) is an AI-powered iot solution that transforms how businesses operate through intelligent automation and real-time analytics.
