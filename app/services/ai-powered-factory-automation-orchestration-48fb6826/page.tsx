...
export const metadata: Metadata = {
  title: 'AI-Powered Factory Automation Orchestration',
  description: 'Orchestrates factory automation with AI and workflow management.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-factory-automation-orchestration-48fb6826',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Factory Automation Orchestration
          </h1>
