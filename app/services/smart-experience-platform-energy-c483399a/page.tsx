...
export const metadata: Metadata = {
  title: 'Smart Experience Platform - Energy',
  description: 'Transform your energy operations with our Smart Experience Platform - Energy. This AI-driven solution automates feedback collection with unprecedented accuracy ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-experience-platform-energy-c483399a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Experience Platform - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Smart Experience Platform - Energy. This AI-driven solution automates feedback collection with unprecedented accuracy and efficiency.
          </p>
