...
export const metadata: Metadata = {
  ...
  keywords: 'Open-source friendly, Microservices deployment, SOC 2 certified, Mobile-responsive interface, Alerting system, analyzer, energy, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Insights Intelligent - Energy</h1>
        <p className="text-lg text-slate-300 mb-8">The future of energy is here with Insights Intelligent - Energy. Powered by cutting-edge AI, this platform delivers predictive analytics like never before.</p>
