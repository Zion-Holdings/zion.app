...
export const metadata: Metadata = {
  ...
  keywords: 'Performance dashboards, Alerting system, GDPR compliance, Rollback mechanisms, director, energy, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Generator Intelligent - Energy</h1>
        <p className="text-lg text-slate-300 mb-8">Revolutionize energy through intelligent automation. Our Generator Intelligent - Energy leverages advanced machine learning to deliver image recognition at scale.</p>
