...
export const metadata: Metadata = {
  title: 'AI Security - Cleantech Edition',
  description: 'Unlock unprecedented growth with AI Security - Cleantech Edition. This autonomous system provides healthcare data analytics with zero manual intervention needed',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-security---cleantech-edition-80ce4f36',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Security - Cleantech Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with AI Security - Cleantech Edition. This autonomous system provides healthcare data analytics with zero manual intervention needed.
          </p>
