...
export const metadata: Metadata = {
  ...
  keywords: 'Managed Kafka/Pulsar clusters, Schema registry, Stream processing (Kafka Streams, Flink), Real-time dashboards, Exactly-once delivery, Auto-scaling partitions, Dead letter queues, Integration with 100+ connectors, data, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Real-Time Data Streaming Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Managed Apache Kafka/Pulsar platform for real-time data streaming. Event sourcing, stream processing, and real-time analytics with sub-second latency.</p>
        ...
        <li class="text-slate-300">Managed Kafka/Pulsar clusters</li>
        <li class="text-slate-300">Schema registry</li>
        <li class="text-slate-300">Stream processing (Kafka Streams, Flink)</li>
        <li class="text-slate-300">Real-time dashboards</li>
        <li class="text-slate-300">Exactly-once delivery</li>
        <li class="text-slate-300">Auto-scaling partitions</li>
        <li class="text-slate-300">Dead letter queues</li>
        <li class="text-slate-300">Integration with 100+ connectors</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Real-time data processing at scale</li>
        <li class="text-slate-300">Reduce streaming infrastructure complexity</li>
        <li class="text-slate-300">Event-driven architecture enablement</li>
        <li class="text-slate-300">Sub-second latency analytics</li>
      </ul>
        </div>
