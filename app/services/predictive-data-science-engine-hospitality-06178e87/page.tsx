...
export const metadata: Metadata = {
  title: 'Predictive Data Science Engine - Hospitality',
  description: 'Drive innovation in hospitality with Predictive Data Science Engine - Hospitality. This AI-powered platform transforms incident response into a competitive adva',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Data Science Engine - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Predictive Data Science Engine - Hospitality. This AI-powered platform transforms incident response into a competitive advantage.
          </p>
