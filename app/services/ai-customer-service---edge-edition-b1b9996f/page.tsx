...
export const metadata: Metadata = {
  title: 'AI Customer Service - Edge Edition',
  description: 'Transform your edge operations with our AI Customer Service - Edge Edition. This AI-driven solution automates customer service automation with unprecedented acc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-customer-service---edge-edition-b1b9996f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Customer Service - Edge Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your edge operations with our AI Customer Service - Edge Edition. This AI-driven solution automates customer service automation with unprecedented accuracy and efficiency.
          </p>
