...
export const metadata: Metadata = {
  ...
  description: 'Enhance your automotive business with Predictive Autonomous Engine - Automotive. Our solution provides fraud prevention with enterprise-grade reliability and se',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your automotive business with Predictive Autonomous Engine - Automotive. Our solution provides fraud prevention with enterprise-grade reliability and security.
          </p>
