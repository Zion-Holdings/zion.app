...
export const metadata: Metadata = {
  title: 'Automation Neural - Cleantech',
  description: 'Transform your cleantech operations with our Automation Neural - Cleantech. This AI-driven solution automates user experience with unprecedented accuracy and ef',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automation Neural - Cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your cleantech operations with our Automation Neural - Cleantech. This AI-driven solution automates user experience with unprecedented accuracy and efficiency.
          </p>
