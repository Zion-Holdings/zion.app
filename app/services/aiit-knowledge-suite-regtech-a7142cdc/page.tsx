...
export const metadata: Metadata = {
  title: 'AI/IT Knowledge Suite - REGTECH',
  description: 'Hyper-accelerated regtech solution: AI/IT Knowledge Suite - REGTECH. Combines language processing with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-knowledge-suite-regtech-a7142cdc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Knowledge Suite - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated regtech solution: AI/IT Knowledge Suite - REGTECH. Combines language processing with next-gen AI for maximum velocity.
          </p>
