      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your logistics workflows with Smart ai-logistics. This intelligent platform delivers api management through advanced automation and AI.
          </p>
