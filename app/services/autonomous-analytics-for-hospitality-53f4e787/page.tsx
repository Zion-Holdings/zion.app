...
export const metadata: Metadata = {
  ...
  keywords: 'SOC 2 certified, Cloud-native architecture, Auto-scaling capabilities, Offline capabilities, Multi-region deployment, Rollback mechanisms, analyzer, hospitality, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Autonomous Analytics for Hospitality</h1>
        <p className="text-lg text-slate-300 mb-8">The future of hospitality is here with Autonomous Analytics for Hospitality. Powered by cutting-edge AI, this platform delivers inventory management like never before.</p>
