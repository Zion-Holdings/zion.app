...
export const metadata: Metadata = {
  title: 'Predictive Operational Engine - Cybersecurity',
  description: 'Drive innovation in cybersecurity with Predictive Operational Engine - Cybersecurity. This AI-powered platform transforms image recognition into a competitive a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Operational Engine - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in cybersecurity with Predictive Operational Engine - Cybersecurity. This AI-powered platform transforms image recognition into a competitive advantage.
          </p>
