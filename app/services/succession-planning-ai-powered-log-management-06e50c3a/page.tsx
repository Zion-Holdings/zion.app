...
export const metadata: Metadata = {
  title: 'Succession Planning AI-Powered Log Management',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Succession Planning AI-Powered Log Management
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered succession planning solution for devops. Centralized log management with AI-powered analysis and alerting.
          </p>
