...
export const metadata: Metadata = {
  title: 'Quantum Territory Security',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Territory Security
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Quantum Territory Security leverages advanced machine learning to deliver reporting automation at scale.
          </p>
