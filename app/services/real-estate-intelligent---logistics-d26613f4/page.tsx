...
export const metadata: Metadata = {
  title: 'Real Estate Intelligent - Logistics',
  description: 'The future of logistics is here with Real Estate Intelligent - Logistics. Powered by cutting-edge AI, this platform delivers logistics route optimization like n',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Real Estate Intelligent - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Real Estate Intelligent - Logistics. Powered by cutting-edge AI, this platform delivers logistics route optimization like never before.
          </p>
