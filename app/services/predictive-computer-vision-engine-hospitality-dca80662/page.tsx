...
export const metadata: Metadata = {
  title: 'Predictive Computer Vision Engine - Hospitality',
  description: 'Transform your hospitality operations with our Predictive Computer Vision Engine - Hospitality. This AI-driven solution automates maintenance scheduling with un',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Computer Vision Engine - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Predictive Computer Vision Engine - Hospitality. This AI-driven solution automates maintenance scheduling with unprecedented accuracy and efficiency.
          </p>
