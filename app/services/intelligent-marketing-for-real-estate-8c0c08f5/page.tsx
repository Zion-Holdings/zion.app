...
export const metadata: Metadata = {
  title: 'Intelligent Marketing for Real-Estate',
  description: 'The future of real-estate is here with Intelligent Marketing for Real-Estate. Powered by cutting-edge AI, this platform delivers financial planning like never b',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of real-estate is here with Intelligent Marketing for Real-Estate. Powered by cutting-edge AI, this platform delivers financial planning like never before.
          </p>
