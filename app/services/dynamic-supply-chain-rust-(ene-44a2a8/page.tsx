...
export const metadata: Metadata = {
  title: 'Dynamic Supply Chain Rust (Energy)',
  description: 'Dynamic Supply Chain Rust (Energy) is an AI-powered energy solution that transforms how businesses operate through intelligent automation and real-time analytic',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Dynamic Supply Chain Rust (Energy)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Dynamic Supply Chain Rust (Energy) is an AI-powered energy solution that transforms how businesses operate through intelligent automation and real-time analytics.
