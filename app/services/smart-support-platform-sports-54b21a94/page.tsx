...
export const metadata: Metadata = {
  title: 'Smart Support Platform - Sports',
  description: 'The future of sports is here with Smart Support Platform - Sports. Powered by cutting-edge AI, this platform delivers data pipeline orchestration like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-support-platform-sports-54b21a94',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Support Platform - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Smart Support Platform - Sports. Powered by cutting-edge AI, this platform delivers data pipeline orchestration like never before.
          </p>
