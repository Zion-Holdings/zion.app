...
export const metadata: Metadata = {
  title: 'AI-Powered Decision Management',
  description: 'Optimize your hospitality workflows with AI-Powered Decision Management. This intelligent platform delivers recruitment automation through advanced automation a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with AI-Powered Decision Management. This intelligent platform delivers recruitment automation through advanced automation and AI.
          </p>
