...
export const metadata: Metadata = {
  title: 'Intelligent Startup for Hospitality',
  description: 'The future of hospitality is here with Intelligent Startup for Hospitality. Powered by cutting-edge AI, this platform delivers performance tuning like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-startup-for-hospitality-0af2fac7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Startup for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Intelligent Startup for Hospitality. Powered by cutting-edge AI, this platform delivers performance tuning like never before.
          </p>
