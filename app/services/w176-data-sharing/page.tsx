...
export const metadata: Metadata = {
  ...
  keywords: 'Cross-organization data sharing, Clean room computing (no raw data exchange), Differential privacy controls, Row and column level access policies, Usage metering and audit logging, Compliance controls (GDPR, HIPAA), Snowflake Sharing, BigQuery Omni, Databricks Clean Rooms, data, Data Collaboration, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Secure Data Sharing Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Share data securely between organizations: clean rooms, differential privacy, access controls, and audit logging. Collaborate without exposing raw data.</p>
        ...
        <li class="text-slate-300">Cross-organization data sharing</li>
        <li class="text-slate-300">Clean room computing (no raw data exchange)</li>
        <li class="text-slate-300">Differential privacy controls</li>
        <li class="text-slate-300">Row and column level access policies</li>
        <li class="text-slate-300">Usage metering and audit logging</li>
        <li class="text-slate-300">Compliance controls (GDPR, HIPAA)</li>
        <li class="text-slate-300">Snowflake Sharing, BigQuery Omni, Databricks Clean Rooms</li>
      </ul>
        </div>
        ...
        <li class="text-slate-300">Clean rooms for competitive collaboration</li>
