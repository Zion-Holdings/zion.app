...
export const metadata: Metadata = {
  title: 'Automated business intelligence-hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Automated business intelligence-hospitality leverages advanced machine learning to deliver enterpr',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-business-intelligence-hospitality-c1a59cdb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated business intelligence-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Automated business intelligence-hospitality leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
