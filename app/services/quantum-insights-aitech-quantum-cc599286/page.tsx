...
export const metadata: Metadata = {
  title: 'Quantum Insights - AITECH Quantum',
  description: 'Optimize your aitech workflows with Quantum Insights - AITECH Quantum. This intelligent platform delivers threat detection through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-insights-aitech-quantum-cc599286',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Insights - AITECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your aitech workflows with Quantum Insights - AITECH Quantum. This intelligent platform delivers threat detection through advanced automation and AI.
          </p>
