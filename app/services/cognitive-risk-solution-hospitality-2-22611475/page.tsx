...
export const metadata: Metadata = {
  title: 'Cognitive Risk Solution - Hospitality #2',
  description: 'Optimize your hospitality workflows with Cognitive Risk Solution - Hospitality #2. This intelligent platform delivers account planning through advanced automati',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-risk-solution-hospitality-2-22611475',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Risk Solution - Hospitality #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Cognitive Risk Solution - Hospitality #2. This intelligent platform delivers account planning through advanced automation and AI.
          </p>
