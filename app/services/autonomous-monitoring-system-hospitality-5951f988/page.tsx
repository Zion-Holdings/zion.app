...
export const metadata: Metadata = {
  title: 'Autonomous Monitoring System - Hospitality',
  description: 'Next-generation hospitality solution: Autonomous Monitoring System - Hospitality. Combines compliance reporting with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-monitoring-system-hospitality-5951f988',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Monitoring System - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Autonomous Monitoring System - Hospitality. Combines compliance reporting with adaptive intelligence for optimal results.
          </p>
