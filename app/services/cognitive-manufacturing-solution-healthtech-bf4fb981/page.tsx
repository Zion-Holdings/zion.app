...
export const metadata: Metadata = {
  title: 'Cognitive Manufacturing Solution - HEALTHTECH',
  description: 'Quantum leap forward for healthtech: Cognitive Manufacturing Solution - HEALTHTECH. Uses quantum-inspired algorithms to deliver sustainability tracking at expon',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Manufacturing Solution - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for healthtech: Cognitive Manufacturing Solution - HEALTHTECH. Uses quantum-inspired algorithms to deliver sustainability tracking at exponential speed.
          </p>
