...
export const metadata: Metadata = {
  title: 'Smart orchestrator-hospitality',
  description: 'Transform your hospitality operations with our Smart orchestrator-hospitality. This AI-driven solution automates logistics route optimization with unprecedented',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-orchestrator-hospitality-f7f48753',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart orchestrator-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Smart orchestrator-hospitality. This AI-driven solution automates logistics route optimization with unprecedented accuracy and efficiency.
          </p>
