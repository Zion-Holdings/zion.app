...
export const metadata: Metadata = {
  title: 'Enterprise Inventory - Startup',
  description: 'The future of startup is here with Enterprise Inventory - Startup. Powered by cutting-edge AI, this platform delivers customer onboarding like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-inventory-startup-4ff5444b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Inventory - Startup
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of startup is here with Enterprise Inventory - Startup. Powered by cutting-edge AI, this platform delivers customer onboarding like never before.
          </p>
