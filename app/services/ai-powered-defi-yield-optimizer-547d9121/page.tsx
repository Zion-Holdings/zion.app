...
export const metadata: Metadata = {
  ...
  description: 'Optimizes DeFi portfolio yields using AI-driven strategy selection and risk management.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-defi-yield-optimizer-547d9121',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimizes DeFi portfolio yields using AI-driven strategy selection and risk management.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Strategy selection</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">25% yield increase</li>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your web3 operations?</p>
