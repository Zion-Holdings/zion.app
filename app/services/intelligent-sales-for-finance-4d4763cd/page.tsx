...
export const metadata: Metadata = {
  title: 'Intelligent Sales for Finance',
  description: 'Revolutionize finance through intelligent automation. Our Intelligent Sales for Finance leverages advanced machine learning to deliver resource utilization at s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-sales-for-finance-4d4763cd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Sales for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our Intelligent Sales for Finance leverages advanced machine learning to deliver resource utilization at scale.
          </p>
