...
export const metadata: Metadata = {
  title: 'Cognitive AI Solution - REGTECH',
  description: 'Enhance your regtech business with Cognitive AI Solution - REGTECH. Our solution provides net promoter score with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-ai-solution-regtech-5b028d5e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive AI Solution - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your regtech business with Cognitive AI Solution - REGTECH. Our solution provides net promoter score with enterprise-grade reliability and security.
          </p>
