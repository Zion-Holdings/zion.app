...
export const metadata: Metadata = {
  title: 'Smart Risk for Agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Smart Risk for Agriculture leverages advanced machine learning to deliver risk assessment at scale',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-risk-for-agriculture-b31f7c87',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Risk for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Smart Risk for Agriculture leverages advanced machine learning to deliver risk assessment at scale.
          </p>
