...
export const metadata: Metadata = {
  title: 'Intelligent DevOps for Construction',
  description: 'The future of construction is here with Intelligent DevOps for Construction. Powered by cutting-edge AI, this platform delivers supply chain like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-devops-for-construction-9e3bf4de',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent DevOps for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Intelligent DevOps for Construction. Powered by cutting-edge AI, this platform delivers supply chain like never before.
          </p>
