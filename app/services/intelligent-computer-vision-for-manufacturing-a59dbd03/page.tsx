...
export const metadata: Metadata = {
  title: 'Intelligent Computer Vision for Manufacturing',
  description: 'Next-generation manufacturing solution: Intelligent Computer Vision for Manufacturing. Combines recruitment automation with adaptive intelligence for optimal re',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Computer Vision for Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation manufacturing solution: Intelligent Computer Vision for Manufacturing. Combines recruitment automation with adaptive intelligence for optimal results.
          </p>
