...
export const metadata: Metadata = {
  title: 'Intelligent Analyzer for Tech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Analyzer for Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your technology business with Intelligent Analyzer for Tech. Our solution provides expense management with enterprise-grade reliability and security.
          </p>
