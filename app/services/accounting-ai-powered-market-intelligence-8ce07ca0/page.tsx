...
export const metadata: Metadata = {
  title: 'Accounting AI-Powered Market Intelligence',
  description: 'AI-powered accounting solution for market research. Monitors market trends, competitor activities, and industry news to provide actionable insights.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/accounting-ai-powered-market-intelligence-8ce07ca0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Accounting AI-Powered Market Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered accounting solution for market research. Monitors market trends, competitor activities, and industry news to provide actionable insights.
          </p>
