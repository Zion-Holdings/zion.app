...
export const metadata: Metadata = {
  title: 'Suite Neural - Healthcare',
  description: 'Transform your healthcare operations with our Suite Neural - Healthcare. This AI-driven solution automates compliance monitoring with unprecedented accuracy and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/suite-neural---healthcare-30f52b6f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Suite Neural - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Suite Neural - Healthcare. This AI-driven solution automates compliance monitoring with unprecedented accuracy and efficiency.
          </p>
