...
export const metadata: Metadata = {
  title: 'Enterprise Automation Platform - Legal',
  description: 'Quantum leap forward for legal: Enterprise Automation Platform - Legal. Uses quantum-inspired algorithms to deliver financial planning at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-automation-platform-legal-fdfa9b5c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Automation Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for legal: Enterprise Automation Platform - Legal. Uses quantum-inspired algorithms to deliver financial planning at exponential speed.
          </p>
