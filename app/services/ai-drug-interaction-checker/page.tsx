...
export const metadata: Metadata = {
  ...
  keywords: '50K+ drug interaction database, Pregnancy weight renal dosing adj, Prescriber + pharmacy workflow alert, Printable patient counseling sheet, ai, Healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Drug Interaction Checker</h1>
        <p className="text-lg text-slate-300 mb-8">Real-time 50K+ prescription/OTC interaction checker: contraindications pregnancy risk triggers prescriber alert + pharmacy workflow patient counseling sheet.</p>
        ...
        <li class="text-slate-300">50K+ drug interaction database</li>
        <li class="text-slate-300">Pregnancy weight renal dosing adj</li>
        <li class="text-slate-300">Prescriber + pharmacy workflow alert</li>
        <li class="text-slate-300">Printable patient counseling sheet</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai drug interaction checker</li>
