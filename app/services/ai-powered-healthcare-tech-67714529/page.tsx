...
export const metadata: Metadata = {
  title: 'AI-Powered healthcare-tech',
  description: 'Transform your technology operations with our AI-Powered healthcare-tech. This AI-driven solution automates customer insights with unprecedented accuracy and ef',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your technology operations with our AI-Powered healthcare-tech. This AI-driven solution automates customer insights with unprecedented accuracy and efficiency.
          </p>
