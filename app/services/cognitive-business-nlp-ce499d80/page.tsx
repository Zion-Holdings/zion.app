...
export const metadata: Metadata = {
  title: 'Cognitive Business NLP',
  description: 'Drive innovation in energy with Cognitive Business NLP. This AI-powered platform transforms training optimization into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-business-nlp-ce499d80',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Business NLP
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Cognitive Business NLP. This AI-powered platform transforms training optimization into a competitive advantage.
          </p>
