...
export const metadata: Metadata = {
  title: 'Scalable Data Analytics MongoDB (It)',
  description: 'Scalable Data Analytics MongoDB (It) is an AI-powered it solution that transforms how businesses operate through intelligent automation and real-time analytics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/scalable-data-analytics-mongod-5fdba6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Scalable Data Analytics MongoDB (It)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Scalable Data Analytics MongoDB (It) is an AI-powered it solution that transforms how businesses operate through intelligent automation and real-time analytics.
...
Fastify, Hadoop, Docker, GCP, Microservices, Python
