...
export const metadata: Metadata = {
  title: 'Intelligent Process for Cybersecurity',
  description: 'Drive innovation in cybersecurity with Intelligent Process for Cybersecurity. This AI-powered platform transforms feedback collection into a competitive advanta',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-process-for-cybersecurity-abd27041',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Process for Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in cybersecurity with Intelligent Process for Cybersecurity. This AI-powered platform transforms feedback collection into a competitive advantage.
          </p>
