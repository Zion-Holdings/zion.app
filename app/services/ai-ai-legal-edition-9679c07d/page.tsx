...
export const metadata: Metadata = {
  title: 'AI AI - Legal Edition',
  description: 'Revolutionize legal through intelligent automation. Our AI AI - Legal Edition leverages advanced machine learning to deliver data pipeline orchestration at scal',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-ai-legal-edition-9679c07d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our AI AI - Legal Edition leverages advanced machine learning to deliver data pipeline orchestration at scale.
          </p>
