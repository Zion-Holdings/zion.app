...
export const metadata: Metadata = {
  title: 'AI/IT Deep Learning Suite - FINTECH',
  description: 'Transform your fintech operations with our AI/IT Deep Learning Suite - FINTECH. This AI-driven solution automates hr analytics with unprecedented accuracy and e',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-deep-learning-suite-fintech-21336e4a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Deep Learning Suite - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your fintech operations with our AI/IT Deep Learning Suite - FINTECH. This AI-driven solution automates hr analytics with unprecedented accuracy and efficiency.
          </p>
