...
export const metadata: Metadata = {
  title: 'Enterprise Quality Platform - Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Enterprise Quality Platform - Healthcare leverages advanced machine learning to deliver document pr',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Quality Platform - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Enterprise Quality Platform - Healthcare leverages advanced machine learning to deliver document processing at scale.
          </p>
