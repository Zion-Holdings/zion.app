  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Financial Advisory Copilot</h1>
        <p className="text-lg text-slate-300 mb-8">AI copilot for financial advisors: portfolio analysis, risk assessment, compliance checking, and client communication drafting. SEC/FINRA compliant with audit trails.</p>
        ...
        <li class="text-slate-300">Portfolio analysis and rebalancing suggestions</li>
        <li class="text-slate-300">Risk assessment with scenario modeling</li>
        <li class="text-slate-300">Compliance checking (SEC, FINRA, suitability)</li>
        <li class="text-slate-300">Client report and communication drafting</li>
        <li class="text-slate-300">Market intelligence and news summarization</li>
        <li class="text-slate-300">Regulatory change monitoring and impact analysis</li>
        <li class="text-slate-300">Audit trail for all AI-generated recommendations</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Serve 3x more clients with AI assistance</li>
        <li class="text-slate-300">Compliance checks on every recommendation</li>
        <li class="text-slate-300">Real-time market intelligence in every meeting</li>
        <li class="text-slate-300">Full audit trail for regulatory examinations</li>
      </ul>
        </div>
