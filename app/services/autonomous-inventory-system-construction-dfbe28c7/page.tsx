...
export const metadata: Metadata = {
  title: 'Autonomous Inventory System - Construction',
  description: 'Enhance your construction business with Autonomous Inventory System - Construction. Our solution provides process automation with enterprise-grade reliability a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-inventory-system-construction-dfbe28c7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Inventory System - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Autonomous Inventory System - Construction. Our solution provides process automation with enterprise-grade reliability and security.
          </p>
