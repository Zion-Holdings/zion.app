...
export const metadata: Metadata = {
  title: 'AI/IT Workflow Suite - FINTECH',
  description: 'Optimize your fintech workflows with AI/IT Workflow Suite - FINTECH. This intelligent platform delivers campaign optimization through advanced automation and AI',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-workflow-suite-fintech-5a4f8995',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Workflow Suite - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your fintech workflows with AI/IT Workflow Suite - FINTECH. This intelligent platform delivers campaign optimization through advanced automation and AI.
          </p>
