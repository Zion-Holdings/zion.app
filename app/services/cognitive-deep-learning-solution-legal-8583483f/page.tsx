...
export const metadata: Metadata = {
  title: 'Cognitive Deep Learning Solution - Legal',
  description: 'Revolutionize legal through intelligent automation. Our Cognitive Deep Learning Solution - Legal leverages advanced machine learning to deliver net promoter sco',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-deep-learning-solution-legal-8583483f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Deep Learning Solution - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Cognitive Deep Learning Solution - Legal leverages advanced machine learning to deliver net promoter score at scale.
          </p>
