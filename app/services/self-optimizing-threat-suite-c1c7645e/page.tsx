...
export const metadata: Metadata = {
  title: 'Self-Optimizing Threat Suite',
  description: 'The future of iot is here with Self-Optimizing Threat Suite. Powered by cutting-edge AI, this platform delivers threat detection like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/self-optimizing-threat-suite-c1c7645e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Threat Suite
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of iot is here with Self-Optimizing Threat Suite. Powered by cutting-edge AI, this platform delivers threat detection like never before.
          </p>
