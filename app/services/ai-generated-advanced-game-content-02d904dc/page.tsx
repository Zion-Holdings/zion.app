...
export const metadata = {
  ...
  description: "Procedural content generation platform that creates advanced game assets, levels, narratives, and quests using generative AI, reducing development time and cost",
  alternates: {
