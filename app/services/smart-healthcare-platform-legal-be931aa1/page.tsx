...
export const metadata: Metadata = {
  title: 'Smart Healthcare Platform - Legal',
  description: 'Enhance your legal business with Smart Healthcare Platform - Legal. Our solution provides influencer identification with enterprise-grade reliability and securi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-healthcare-platform-legal-be931aa1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Healthcare Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Smart Healthcare Platform - Legal. Our solution provides influencer identification with enterprise-grade reliability and security.
          </p>
