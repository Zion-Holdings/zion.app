...
export const metadata: Metadata = {
  title: 'AI-Powered Data Science for Hospitality',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Data Science for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with AI-Powered Data Science for Hospitality. This intelligent platform delivers healthcare data analytics through advanced automation and AI.
          </p>
