...
export const metadata: Metadata = {
  ...
  keywords: 'Unified management, Patch management, Security policies, Remote support, Compliance, Inventory, Application control, Analytics, it, Security, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Unified Endpoint Management</h1>
        <p className="text-lg text-slate-300 mb-8">Manage all endpoints from one platform with patch management and security.</p>
        ...
        <li class="text-slate-300">Unified management</li>
        <li class="text-slate-300">Patch management</li>
        <li class="text-slate-300">Security policies</li>
        <li class="text-slate-300">Remote support</li>
        <li class="text-slate-300">Compliance</li>
        <li class="text-slate-300">Inventory</li>
        <li class="text-slate-300">Application control</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">80% faster patching</li>
        <li class="text-slate-300">Unified visibility</li>
        <li class="text-slate-300">Reduced risk</li>
        <li class="text-slate-300">Compliance</li>
      </ul>
        </div>
