...
export const metadata: Metadata = {
  title: 'Quantum Platform - Insurance Quantum',
  description: 'Drive innovation in insurance with Quantum Platform - Insurance Quantum. This AI-powered platform transforms training optimization into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-platform-insurance-quantum-273a866d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Platform - Insurance Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Quantum Platform - Insurance Quantum. This AI-powered platform transforms training optimization into a competitive advantage.
          </p>
