...
export const metadata: Metadata = {
  title: 'Intelligent Document Marketing',
  description: 'Drive innovation in energy with Intelligent Document Marketing. This AI-powered platform transforms training optimization into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-document-marketing-f0ba46c7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Document Marketing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Intelligent Document Marketing. This AI-powered platform transforms training optimization into a competitive advantage.
          </p>
