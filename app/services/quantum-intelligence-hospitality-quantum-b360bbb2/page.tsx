...
export const metadata: Metadata = {
  title: 'Quantum Intelligence - Hospitality Quantum',
  description: 'Next-generation hospitality solution: Quantum Intelligence - Hospitality Quantum. Combines onboarding automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-intelligence-hospitality-quantum-b360bbb2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Intelligence - Hospitality Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Quantum Intelligence - Hospitality Quantum. Combines onboarding automation with adaptive intelligence for optimal results.
          </p>
