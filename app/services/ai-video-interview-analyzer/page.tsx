...
export const metadata: Metadata = {
  ...
  keywords: 'Response quality analysis, Communication skills scoring, Sentiment and confidence detection, Structured interview templates, Bias detection and mitigation, Candidate comparison reports, Integration with ATS, Interview recording and playback, ai, HR, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Video Interview Analysis Platform</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered video interview analysis for hiring. Evaluate candidate responses, communication skills, and role fit with standardized assessment criteria.</p>
        ...
        <li class="text-slate-300">Response quality analysis</li>
        <li class="text-slate-300">Communication skills scoring</li>
        <li class="text-slate-300">Sentiment and confidence detection</li>
        <li class="text-slate-300">Structured interview templates</li>
        <li class="text-slate-300">Bias detection and mitigation</li>
        <li class="text-slate-300">Candidate comparison reports</li>
        <li class="text-slate-300">Integration with ATS</li>
        <li class="text-slate-300">Interview recording and playback</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce time-to-hire by 40%</li>
        <li class="text-slate-300">Standardize interview evaluation</li>
        <li class="text-slate-300">Reduce unconscious bias</li>
        <li class="text-slate-300">Scale hiring without adding recruiters</li>
      </ul>
        </div>
