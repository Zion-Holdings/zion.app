...
export const metadata: Metadata = {
  ...
  keywords: 'Document authenticity verification, Facial biometrics and liveness detection, Device fingerprinting and risk scoring, Behavioral pattern analysis, Synthetic identity detection, Real-time fraud scoring API, Integration with Jumio, Onfido, Socure, ai, Financial Services, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Identity Fraud Detection</h1>
        <p className="text-lg text-slate-300 mb-8">Detect identity fraud: document verification, biometrics, device fingerprinting, behavioral analysis. Reduce fraud 60%.</p>
        ...
        <li class="text-slate-300">Document authenticity verification</li>
        <li class="text-slate-300">Facial biometrics and liveness detection</li>
        <li class="text-slate-300">Device fingerprinting and risk scoring</li>
        <li class="text-slate-300">Behavioral pattern analysis</li>
        <li class="text-slate-300">Synthetic identity detection</li>
        <li class="text-slate-300">Real-time fraud scoring API</li>
        <li class="text-slate-300">Integration with Jumio</li>
        <li class="text-slate-300">Onfido</li>
        <li class="text-slate-300">Socure</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce fraud losses by 60%</li>
        <li class="text-slate-300">Document verification in seconds</li>
        <li class="text-slate-300">Synthetic identity detection</li>
        <li class="text-slate-300">Real-time API for instant decisions</li>
      </ul>
        </div>
