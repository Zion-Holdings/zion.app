...
export const metadata: Metadata = {
  title: 'Enterprise Processor Platform - Legal',
  description: 'Enhance your legal business with Enterprise Processor Platform - Legal. Our solution provides resource optimization with enterprise-grade reliability and securi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-processor-platform-legal-f7e81692',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Processor Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Enterprise Processor Platform - Legal. Our solution provides resource optimization with enterprise-grade reliability and security.
          </p>
