...
export const metadata: Metadata = {
  title: 'Neural Engine for Insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Engine for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Neural Engine for Insurance. This AI-driven solution automates network optimization with unprecedented accuracy and efficiency.
          </p>
