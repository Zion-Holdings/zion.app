...
export const metadata: Metadata = {
  ...
  keywords: 'Personalized care plans, Remote monitoring, Medication adherence, Virtual consultations, customer experience, healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Intelligent Media Patient Engagement</h1>
        <p className="text-lg text-slate-300 mb-8">AI-driven patient engagement platform that delivers intelligent personalized care journeys, remote monitoring, and adherence support through intelligent automation.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">customer experience</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">healthcare</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Personalized care plans</li>
        <li class="text-slate-300">Remote monitoring</li>
        <li class="text-slate-300">Medication adherence</li>
        <li class="text-slate-300">Virtual consultations</li>
      </ul>
        </div>
        ...
        <li class="text-slate-300">Higher satisfaction</li>
        <li class="text-slate-300">Reduced readmissions</li>
        <li class="text-slate-300">Lower costs</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">258</p>
              <p class="text-sm text-slate-400">Getting started plan</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              <h3 class="font-semibold text-white mb-2">Pro</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">648</p>
              <p class="text-sm text-slate-400">Most popular</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              <h3 class="font-semibold text-white mb-2">Enterprise</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">1948</p>
