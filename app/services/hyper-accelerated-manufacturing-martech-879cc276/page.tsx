...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Manufacturing - MARTECH',
  description: 'The future of martech is here with Hyper-Accelerated Manufacturing - MARTECH. Powered by cutting-edge AI, this platform delivers integration platform like never',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Manufacturing - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of martech is here with Hyper-Accelerated Manufacturing - MARTECH. Powered by cutting-edge AI, this platform delivers integration platform like never before.
          </p>
