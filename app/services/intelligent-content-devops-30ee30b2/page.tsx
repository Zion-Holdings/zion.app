...
export const metadata: Metadata = {
  title: 'Intelligent Content DevOps',
  description: 'Transform your energy operations with our Intelligent Content DevOps. This AI-driven solution provides intelligent automation with unprecedented accuracy and ef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-content-devops-30ee30b2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Content DevOps
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Intelligent Content DevOps. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
