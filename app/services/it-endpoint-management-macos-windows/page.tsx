...
export const metadata: Metadata = {
  ...
  keywords: 'Zero-touch (DEP/Autopilot) + self-enrol portal, OS update enforcement patch policy, Full-disk encryption + TLS 1.3 VPN settings, Remote wipe + lost-device-geofence, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Endpoint Management (macOS &amp; Windows)</h1>
        <p className="text-lg text-slate-300 mb-8">Unified MDM for macOS and Windows: Zero-touch enrolment, OS update enforcement, full-disk encryption, compliance, remote wipe.</p>
        ...
        <li class="text-slate-300">Zero-touch (DEP/Autopilot) + self-enrol portal</li>
        <li class="text-slate-300">OS update enforcement patch policy</li>
        <li class="text-slate-300">Full-disk encryption + TLS 1.3 VPN settings</li>
        <li class="text-slate-300">Remote wipe + lost-device-geofence</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with endpoint management (macos &amp; windows)</li>
