...
export const metadata: Metadata = {
  title: 'Predictive Data Engine - Hospitality',
  description: 'Enhance your hospitality business with Predictive Data Engine - Hospitality. Our solution provides financial planning with enterprise-grade reliability and secu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-data-engine-hospitality-9561b7d8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Data Engine - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Predictive Data Engine - Hospitality. Our solution provides financial planning with enterprise-grade reliability and security.
          </p>
