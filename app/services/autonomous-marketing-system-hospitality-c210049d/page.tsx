...
export const metadata: Metadata = {
  title: 'Autonomous Marketing System - Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Autonomous Marketing System - Hospitality leverages advanced machine learning to deliver supply ch',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-marketing-system-hospitality-c210049d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Marketing System - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Autonomous Marketing System - Hospitality leverages advanced machine learning to deliver supply chain at scale.
          </p>
