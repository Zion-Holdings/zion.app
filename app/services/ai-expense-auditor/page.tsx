...
export const metadata: Metadata = {
  ...
  keywords: 'Receipt OCR and validation, Policy violation detection, Duplicate expense detection, Suspicious pattern analysis, Per diem and mileage calculation, Integration with SAP Concur, Expensify, Audit trail and reporting, Real-time submission feedback, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Expense Audit &amp; Compliance</h1>
        <p className="text-lg text-slate-300 mb-8">Automated expense report auditing with AI. Detect policy violations, duplicate submissions, suspicious patterns, and non-compliant receipts.</p>
        ...
        <li class="text-slate-300">Receipt OCR and validation</li>
        <li class="text-slate-300">Policy violation detection</li>
        <li class="text-slate-300">Duplicate expense detection</li>
        <li class="text-slate-300">Suspicious pattern analysis</li>
        <li class="text-slate-300">Per diem and mileage calculation</li>
        <li class="text-slate-300">Integration with SAP Concur, Expensify</li>
        <li class="text-slate-300">Audit trail and reporting</li>
        <li class="text-slate-300">Real-time submission feedback</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce expense fraud by 60%</li>
        <li class="text-slate-300">Cut audit time by 90%</li>
        <li class="text-slate-300">Ensure policy compliance</li>
        <li class="text-slate-300">Reclaim overpayments</li>
      </ul>
        </div>
