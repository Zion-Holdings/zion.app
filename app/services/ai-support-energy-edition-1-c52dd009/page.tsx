...
export const metadata: Metadata = {
  title: 'AI Support - Energy Edition #1',
  description: 'Drive innovation in energy with AI Support - Energy Edition #1. This AI-powered platform transforms user provisioning into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-support-energy-edition-1-c52dd009',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Support - Energy Edition #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with AI Support - Energy Edition #1. This AI-powered platform transforms user provisioning into a competitive advantage.
          </p>
