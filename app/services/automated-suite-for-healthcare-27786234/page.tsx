...
export const metadata: Metadata = {
  title: 'Automated Suite for Healthcare',
  description: 'Next-generation healthcare solution: Automated Suite for Healthcare. Combines quality control with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-suite-for-healthcare-27786234',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Suite for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Automated Suite for Healthcare. Combines quality control with adaptive intelligence for optimal results.
          </p>
