...
export const metadata: Metadata = {
  title: 'Predictive Healthcare Engine - Hospitality',
  description: 'Transform your hospitality operations with our Predictive Healthcare Engine - Hospitality. This AI-driven solution automates social media monitoring with unprec',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Healthcare Engine - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Predictive Healthcare Engine - Hospitality. This AI-driven solution automates social media monitoring with unprecedented accuracy and efficiency.
          </p>
