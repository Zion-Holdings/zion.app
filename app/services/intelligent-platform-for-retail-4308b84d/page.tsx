...
export const metadata: Metadata = {
  title: 'Intelligent Platform for Retail',
  description: 'Next-generation retail solution: Intelligent Platform for Retail. Combines audit trail management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-platform-for-retail-4308b84d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Platform for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation retail solution: Intelligent Platform for Retail. Combines audit trail management with adaptive intelligence for optimal results.
          </p>
