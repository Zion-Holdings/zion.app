...
export const metadata: Metadata = {
  title: 'Automated Analytics for Agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Automated Analytics for Agriculture leverages advanced machine learning to deliver market intellig',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-analytics-for-agriculture-132d09ce',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Analytics for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Automated Analytics for Agriculture leverages advanced machine learning to deliver market intelligence at scale.
          </p>
