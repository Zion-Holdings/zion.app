...
export const metadata: Metadata = {
  title: 'Marketing Cognitive - Agriculture',
  description: 'Drive innovation in agriculture with Marketing Cognitive - Agriculture. This AI-powered platform transforms energy management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/marketing-cognitive-agriculture-03c9a847',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Marketing Cognitive - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in agriculture with Marketing Cognitive - Agriculture. This AI-powered platform transforms energy management into a competitive advantage.
          </p>
