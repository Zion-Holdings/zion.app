...
export const metadata: Metadata = {
  title: 'Next-Gen Platform for Healthcare',
  description: 'Quantum leap forward for healthcare: Next-Gen Platform for Healthcare. Uses quantum-inspired algorithms to deliver task mining at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-platform-for-healthcare-dad79ae5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Platform for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for healthcare: Next-Gen Platform for Healthcare. Uses quantum-inspired algorithms to deliver task mining at exponential speed.
          </p>
