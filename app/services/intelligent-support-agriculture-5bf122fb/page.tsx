...
export const metadata: Metadata = {
  title: 'Intelligent support-agriculture',
  description: 'The future of agriculture is here with Intelligent support-agriculture. Powered by cutting-edge AI, this platform delivers transformative results like never bef',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent support-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Intelligent support-agriculture. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
