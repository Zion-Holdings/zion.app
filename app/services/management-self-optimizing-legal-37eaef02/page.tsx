...
export const metadata: Metadata = {
  title: 'Management Self-Optimizing - Legal',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Management Self-Optimizing - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Management Self-Optimizing - Legal. Our solution provides customer onboarding with enterprise-grade reliability and security.
          </p>
