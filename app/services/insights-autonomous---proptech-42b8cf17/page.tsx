...
export const metadata: Metadata = {
  title: 'Insights Autonomous - Proptech',
  description: 'The future of proptech is here with Insights Autonomous - Proptech. Powered by cutting-edge AI, this platform delivers performance monitoring like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/insights-autonomous---proptech-42b8cf17',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Insights Autonomous - Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with Insights Autonomous - Proptech. Powered by cutting-edge AI, this platform delivers performance monitoring like never before.
          </p>
