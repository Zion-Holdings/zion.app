...
export const metadata: Metadata = {
  title: 'Insights Autonomous - Retail',
  description: 'Enhance your retail business with Insights Autonomous - Retail. Our solution provides workflow management with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/insights-autonomous-retail-3fc53a97',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Insights Autonomous - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your retail business with Insights Autonomous - Retail. Our solution provides workflow management with enterprise-grade reliability and security.
          </p>
