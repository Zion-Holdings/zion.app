...
export const metadata: Metadata = {
  title: 'Smart Insights Platform - Education',
  description: 'Enhance your education business with Smart Insights Platform - Education. Our solution provides customer onboarding with enterprise-grade reliability and securi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Insights Platform - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your education business with Smart Insights Platform - Education. Our solution provides customer onboarding with enterprise-grade reliability and security.
          </p>
