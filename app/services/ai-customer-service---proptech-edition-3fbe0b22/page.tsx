...
export const metadata: Metadata = {
  title: 'AI Customer Service - Proptech Edition',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Customer Service - Proptech Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your proptech operations with our AI Customer Service - Proptech Edition. This AI-driven solution automates data processing with unprecedented accuracy and efficiency.
          </p>
