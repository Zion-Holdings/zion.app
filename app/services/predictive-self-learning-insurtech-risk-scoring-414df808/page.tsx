...
export const metadata = {
  title: "Predictive Self-Learning Insurtech Risk Scoring - Zion Tech Group",
  description: "Predictive risk scoring engine that assesses self-learning insurtech vulnerabilities with machine learning.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/predictive-self-learning-insurtech-risk-scoring-414df808`
  }
};
