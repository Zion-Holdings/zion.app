...
export const metadata: Metadata = {
  ...
  keywords: 'Automated WCAG 2.2 scanning, Manual expert testing (screen reader, keyboard), VPAT/ACR generation, Remediation guidance with code examples, Ongoing compliance monitoring, User testing with assistive technology users, ADA and Section 508 consulting, it, Compliance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Web Accessibility Audit Service</h1>
        <p className="text-lg text-slate-300 mb-8">WCAG 2.2 AA/AAA compliance audit: automated and manual testing, VPAT generation, remediation guidance, and ongoing monitoring. Section 508 and ADA compliance.</p>
        ...
        <li class="text-slate-300">Automated WCAG 2.2 scanning</li>
        <li class="text-slate-300">Manual expert testing (screen reader, keyboard)</li>
        <li class="text-slate-300">VPAT/ACR generation</li>
        <li class="text-slate-300">Remediation guidance with code examples</li>
        <li class="text-slate-300">Ongoing compliance monitoring</li>
        <li class="text-slate-300">User testing with assistive technology users</li>
        <li class="text-slate-300">ADA and Section 508 consulting</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Avoid accessibility lawsuits</li>
        <li class="text-slate-300">VPAT generated for procurement</li>
        <li class="text-slate-300">Code examples accelerate remediation</li>
        <li class="text-slate-300">Ongoing monitoring prevents regression</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$2,499</p>
