...
export const metadata: Metadata = {
  title: 'Cognitive security-telecom',
  description: 'Optimize your telecom workflows with Cognitive security-telecom. This intelligent platform delivers data quality through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-security-telecom-1f9c9d47',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive security-telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your telecom workflows with Cognitive security-telecom. This intelligent platform delivers data quality through advanced automation and AI.
          </p>
