...
export const metadata: Metadata = {
  title: 'Adaptive marketing-hospitality',
  description: 'Next-generation hospitality solution: Adaptive marketing-hospitality. Combines serverless deployment with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-marketing-hospitality-b52276e6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive marketing-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Adaptive marketing-hospitality. Combines serverless deployment with adaptive intelligence for optimal results.
          </p>
