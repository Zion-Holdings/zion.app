...
export const metadata: Metadata = {
  title: 'Autonomous Support for Construction',
  description: 'The future of construction is here with Autonomous Support for Construction. Powered by cutting-edge AI, this platform delivers financial planning like never be',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-support-for-construction-7fffac03',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Support for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Autonomous Support for Construction. Powered by cutting-edge AI, this platform delivers financial planning like never before.
          </p>
