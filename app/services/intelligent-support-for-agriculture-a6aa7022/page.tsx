...
export const metadata: Metadata = {
  ...
  description: 'The future of agriculture is here with Intelligent Support for Agriculture. Powered by cutting-edge AI, this platform delivers quality control like never before',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-support-for-agriculture-a6aa7022',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Intelligent Support for Agriculture. Powered by cutting-edge AI, this platform delivers quality control like never before.
          </p>
