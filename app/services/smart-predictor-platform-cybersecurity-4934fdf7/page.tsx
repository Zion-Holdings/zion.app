...
export const metadata: Metadata = {
  title: 'Smart Predictor Platform - Cybersecurity',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Predictor Platform - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of cybersecurity is here with Smart Predictor Platform - Cybersecurity. Powered by cutting-edge AI, this platform delivers cost tracking like never before.
          </p>
