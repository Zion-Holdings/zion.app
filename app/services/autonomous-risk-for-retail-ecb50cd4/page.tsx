...
export const metadata: Metadata = {
  title: 'Autonomous Risk for Retail',
  description: 'Transform your retail operations with our Autonomous Risk for Retail. This AI-driven solution automates market intelligence with unprecedented accuracy and effi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-risk-for-retail-ecb50cd4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Risk for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our Autonomous Risk for Retail. This AI-driven solution automates market intelligence with unprecedented accuracy and efficiency.
          </p>
