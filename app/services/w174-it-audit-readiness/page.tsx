...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-framework gap analysis (SOC 2, ISO, HIPAA, PCI), Automated evidence collection, Control mapping across frameworks, Remediation tracking with deadlines, Auditor-ready documentation, Continuous compliance monitoring, Integration with Drata, Vanta, Secureframe, it, Compliance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Audit Readiness Service</h1>
        <p className="text-lg text-slate-300 mb-8">Prepare for SOC 2, ISO 27001, HIPAA, and PCI audits with automated evidence collection, gap analysis, and remediation tracking. Pass audits the first time.</p>
        ...
        <li class="text-slate-300">Multi-framework gap analysis (SOC 2, ISO, HIPAA, PCI)</li>
        <li class="text-slate-300">Automated evidence collection</li>
        <li class="text-slate-300">Control mapping across frameworks</li>
        <li class="text-slate-300">Remediation tracking with deadlines</li>
        <li class="text-slate-300">Auditor-ready documentation</li>
        <li class="text-slate-300">Continuous compliance monitoring</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Pass audits the first time, every time</li>
        <li class="text-slate-300">Automated evidence eliminates manual collection</li>
        <li class="text-slate-300">Control mapping reduces redundant work</li>
        <li class="text-slate-300">Continuous monitoring keeps you audit-ready</li>
      </ul>
        </div>
