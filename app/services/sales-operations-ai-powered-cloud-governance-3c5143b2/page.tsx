...
export const metadata: Metadata = {
  title: 'Sales Operations AI-Powered Cloud Governance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Sales Operations AI-Powered Cloud Governance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered sales operations solution for cloud governance. Automated cloud governance with policy enforcement and resource control.
          </p>
