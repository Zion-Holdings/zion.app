...
export const metadata: Metadata = {
  title: 'Aviation Devops Platform #45',
  description: 'AI-powered aviation solution for devops. Provides enterprise-grade automation and optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/devops-aviation-709c3243',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Aviation Devops Platform #45
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered aviation solution for devops. Provides enterprise-grade automation and optimization.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Monitoring & alerts</li>
          <li className="text-gray-300">Deployment optimization</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">90% faster deployments</li>
