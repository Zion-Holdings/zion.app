...
export const metadata: Metadata = {
  title: 'Adaptive Workflow Real Estate',
  description: 'Transform your cleantech operations with our Adaptive Workflow Real Estate. This AI-driven solution automates decision support with unprecedented accuracy and e',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Workflow Real Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your cleantech operations with our Adaptive Workflow Real Estate. This AI-driven solution automates decision support with unprecedented accuracy and efficiency.
          </p>
