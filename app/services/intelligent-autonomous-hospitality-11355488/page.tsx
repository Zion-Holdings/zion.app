...
export const metadata: Metadata = {
  title: 'Intelligent Autonomous - Hospitality',
  description: 'Optimize your hospitality workflows with Intelligent Autonomous - Hospitality. This intelligent platform delivers churn prediction through advanced automation a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-autonomous-hospitality-11355488',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Autonomous - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Intelligent Autonomous - Hospitality. This intelligent platform delivers churn prediction through advanced automation and AI.
          </p>
