...
export const metadata: Metadata = {
  title: 'Claims AI-Powered Recommendation Engine',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Claims AI-Powered Recommendation Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered claims solution for e-commerce. Personalized product and content recommendations for e-commerce and media.
          </p>
