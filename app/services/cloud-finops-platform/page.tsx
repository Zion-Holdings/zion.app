...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-cloud cost visibility, Showback and chargeback, RI and Savings Plans optimization, Waste detection and auto-remediation, Unit economics (cost per customer, per feature), Integration with AWS, GCP, Azure billing, Budget alerts and forecasting, Executive cost dashboards, cloud, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cloud FinOps Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Comprehensive FinOps platform for cloud cost management. Showback/chargeback, reserved instance optimization, waste detection, and unit economics tracking.</p>
        ...
        <li class="text-slate-300">Multi-cloud cost visibility</li>
        <li class="text-slate-300">Showback and chargeback</li>
        <li class="text-slate-300">RI and Savings Plans optimization</li>
        <li class="text-slate-300">Waste detection and auto-remediation</li>
        <li class="text-slate-300">Unit economics (cost per customer, per feature)</li>
        <li class="text-slate-300">Integration with AWS, GCP, Azure billing</li>
        <li class="text-slate-300">Budget alerts and forecasting</li>
        <li class="text-slate-300">Executive cost dashboards</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce cloud spend by 30%</li>
        <li class="text-slate-300">Eliminate waste automatically</li>
        <li class="text-slate-300">Business-aligned cost decisions</li>
        <li class="text-slate-300">Accurate forecasting</li>
      </ul>
        </div>
