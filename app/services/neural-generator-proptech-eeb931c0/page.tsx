...
export const metadata: Metadata = {
  title: 'Neural generator-proptech',
  description: 'Transform your proptech operations with our Neural generator-proptech. This AI-driven solution automates healthcare data analytics with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-generator-proptech-eeb931c0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural generator-proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your proptech operations with our Neural generator-proptech. This AI-driven solution automates healthcare data analytics with unprecedented accuracy and efficiency.
          </p>
