...
export const metadata: Metadata = {
  title: 'Cognitive Neural Solution - Finance',
  description: 'Revolutionize finance through intelligent automation. Our Cognitive Neural Solution - Finance leverages advanced machine learning to deliver anomaly detection a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Neural Solution - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our Cognitive Neural Solution - Finance leverages advanced machine learning to deliver anomaly detection at scale.
          </p>
