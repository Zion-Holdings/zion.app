...
export const metadata: Metadata = {
  ...
  keywords: 'AI roof damage detection, Flood extent mapping, Insurance claim validation, Repair cost estimation, Before/after comparison, FEMA report generation, ai, Insurance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Hurricane &amp; Storm Damage Assessment</h1>
        <p className="text-lg text-slate-300 mb-8">Post-storm damage assessment from satellite/droone imagery: roof damage detection, flood extent mapping, insurance claim validation, and repair cost estimation. Processes 10,000+ properties per hour.</p>
        ...
        <li class="text-slate-300">AI roof damage detection</li>
        <li class="text-slate-300">Flood extent mapping</li>
        <li class="text-slate-300">Insurance claim validation</li>
        <li class="text-slate-300">Repair cost estimation</li>
        <li class="text-slate-300">Before/after comparison</li>
        <li class="text-slate-300">FEMA report generation</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Assess 10K properties/hour</li>
        <li class="text-slate-300">Accelerate insurance claims</li>
        <li class="text-slate-300">Prioritize emergency response</li>
      </ul>
        </div>
