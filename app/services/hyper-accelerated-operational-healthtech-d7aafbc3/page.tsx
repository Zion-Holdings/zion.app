...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Operational - HEALTHTECH',
  description: 'Optimize your healthtech workflows with Hyper-Accelerated Operational - HEALTHTECH. This intelligent platform delivers project portfolio through advanced automa',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Operational - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthtech workflows with Hyper-Accelerated Operational - HEALTHTECH. This intelligent platform delivers project portfolio through advanced automation and AI.
          </p>
