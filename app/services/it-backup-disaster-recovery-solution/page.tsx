    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Ransomware ransom note becomes moot when backups cannot be tampered with</li>
            <li>30-minute RTO without expensive custom scripting or runbook hunting</li>
            <li>Board-level DR compliance report delivered automatically every quarter</li>
            <li>Lamport-timestamp per snapshot provides evidence-grade backup chain-of-custody</li>
          </ul>
        </div>
