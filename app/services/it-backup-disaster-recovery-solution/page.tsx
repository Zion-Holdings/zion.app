...
export const metadata: Metadata = {
  ...
  keywords: 'Immutable backup chain with Lamport-signed tamper-evident restore points, RPO of 5 minutes and RTO of 30 minutes SLA guaranteed in the contract, Air-gapped off-site storage with ransomware snapshot hold holding ransom, Automated DR drill scheduling — report sent to board before quarter-end, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Backup &amp; Disaster Recovery Solution</h1>
        <p className="text-lg text-slate-300 mb-8">Immutable backup engine with RPO as low as 5 minutes, RTO of 30 minutes, off-site air-gapped storage, Lamport-timestamp chain-of-custody for tamper evidence, ransomware-hold per snapshot, point-in-time restore, and automated DR drill scheduling.</p>
        ...
        <li class="text-slate-300">Immutable backup chain with Lamport-signed tamper-evident restore points</li>
        <li class="text-slate-300">RPO of 5 minutes and RTO of 30 minutes SLA guaranteed in the contract</li>
        <li class="text-slate-300">Air-gapped off-site storage with ransomware snapshot hold holding ransom</li>
        <li class="text-slate-300">Automated DR drill scheduling — report sent to board before quarter-end</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with backup &amp; disaster recovery solution</li>
