...
export const metadata: Metadata = {
  title: 'Autonomous ROI Suite',
  description: 'The future of media is here with Autonomous ROI Suite. Powered by cutting-edge AI, this platform delivers social media monitoring like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-roi-suite-b517c589',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous ROI Suite
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of media is here with Autonomous ROI Suite. Powered by cutting-edge AI, this platform delivers social media monitoring like never before.
          </p>
