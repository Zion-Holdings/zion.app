...
export const metadata: Metadata = {
  title: 'Healthcare Adaptive - Gaming',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Healthcare Adaptive - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your gaming business with Healthcare Adaptive - Gaming. Our solution provides process discovery with enterprise-grade reliability and security.
          </p>
