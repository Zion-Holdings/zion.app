...
export const metadata: Metadata = {
  title: 'Cognitive Content Solution - Tech',
  description: 'Next-generation technology solution: Cognitive Content Solution - Tech. Combines competitive intelligence with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-content-solution-tech-61b10d25',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Content Solution - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation technology solution: Cognitive Content Solution - Tech. Combines competitive intelligence with adaptive intelligence for optimal results.
          </p>
