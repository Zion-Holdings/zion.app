...
export const metadata: Metadata = {
  title: 'Quantum Process - Agriculture Quantum',
  description: 'The future of agriculture is here with Quantum Process - Agriculture Quantum. Powered by cutting-edge AI, this platform delivers user provisioning like never be',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Process - Agriculture Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Quantum Process - Agriculture Quantum. Powered by cutting-edge AI, this platform delivers user provisioning like never before.
          </p>
