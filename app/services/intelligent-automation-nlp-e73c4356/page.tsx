...
export const metadata: Metadata = {
  title: 'Intelligent Automation NLP',
  description: 'Next-generation legal solution: Intelligent Automation NLP. Combines financial planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-automation-nlp-e73c4356',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Intelligent Automation NLP. Combines financial planning with adaptive intelligence for optimal results.
          </p>
