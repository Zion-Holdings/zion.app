...
export const metadata: Metadata = {
  title: 'Autonomous manager-iot',
  description: 'The future of iot is here with Autonomous manager-iot. Powered by cutting-edge AI, this platform delivers financial planning like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-manager-iot-30d1fd80',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous manager-iot
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of iot is here with Autonomous manager-iot. Powered by cutting-edge AI, this platform delivers financial planning like never before.
          </p>
