...
export const metadata: Metadata = {
  title: 'Cognitive Customer SMB',
  description: 'Revolutionize finance through intelligent automation. Our Cognitive Customer SMB leverages advanced machine learning to deliver feature engineering at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-customer-smb-6891bb66',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Customer SMB
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our Cognitive Customer SMB leverages advanced machine learning to deliver feature engineering at scale.
          </p>
