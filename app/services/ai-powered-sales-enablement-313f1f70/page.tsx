...
export const metadata: Metadata = {
  ...
  description: 'Provides real-time sales coaching and next-best-action recommendations during calls.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-sales-enablement-313f1f70',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Provides real-time sales coaching and next-best-action recommendations during calls.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Sales coaching</li>
          <li className="text-gray-300">Next-best-action</li>
          <li className="text-gray-300">Conversation intelligence</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">20% quota increase</li>
