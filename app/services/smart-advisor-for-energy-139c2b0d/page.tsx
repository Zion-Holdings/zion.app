...
export const metadata: Metadata = {
  title: 'Smart Advisor for Energy',
  description: 'Next-generation energy solution: Smart Advisor for Energy. Combines financial planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-advisor-for-energy-139c2b0d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Advisor for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Smart Advisor for Energy. Combines financial planning with adaptive intelligence for optimal results.
          </p>
