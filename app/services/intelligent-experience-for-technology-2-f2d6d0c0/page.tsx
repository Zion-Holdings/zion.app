  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Intelligent Experience for Technology #2</h1>
        <p className="text-lg text-gray-300 mb-8">Revolutionize technology through intelligent automation. Our Intelligent Experience for Technology #2 leverages advanced machine learning to deliver quality control at scale.</p>
