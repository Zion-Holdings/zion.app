...
export const metadata: Metadata = {
  ...
  keywords: 'Auto-alt-text for images, Video transcript with speaker IDs, Readability scoring, WCAG 2.1 AA gap analysis, ai, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Accessibility Content Optimizer</h1>
        <p className="text-lg text-slate-300 mb-8">Suggests alt-text for images, transcript generation for videos, and semantic HTML improvements to boost accessibility and SEO simultaneously.</p>
        ...
        <li class="text-slate-300">Auto-alt-text for images</li>
        <li class="text-slate-300">Video transcript with speaker IDs</li>
        <li class="text-slate-300">Readability scoring</li>
        <li class="text-slate-300">WCAG 2.1 AA gap analysis</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai accessibility content optimizer</li>
