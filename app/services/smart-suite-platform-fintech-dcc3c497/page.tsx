...
export const metadata: Metadata = {
  title: 'Smart Suite Platform - FINTECH',
  description: 'Quantum leap forward for fintech: Smart Suite Platform - FINTECH. Uses quantum-inspired algorithms to deliver ml model training at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-suite-platform-fintech-dcc3c497',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Suite Platform - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for fintech: Smart Suite Platform - FINTECH. Uses quantum-inspired algorithms to deliver ml model training at exponential speed.
          </p>
