...
export const metadata: Metadata = {
  ...
  keywords: 'Automated SBOM generation, Dependency vulnerability scanning, Malicious package detection, License compliance checking, Dependency confusion prevention, CI/CD pipeline integration, Compliance reporting (EO 14028), Vendor risk assessment, security, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Supply Chain Security Platform</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end software supply chain security with SBOM generation, vulnerability scanning, dependency analysis, and compliance reporting. Protect against dependency confusion, typosquatting, and malicious packages.</p>
        ...
        <li class="text-slate-300">Automated SBOM generation</li>
        <li class="text-slate-300">Dependency vulnerability scanning</li>
        <li class="text-slate-300">Malicious package detection</li>
        <li class="text-slate-300">License compliance checking</li>
        <li class="text-slate-300">Dependency confusion prevention</li>
        <li class="text-slate-300">CI/CD pipeline integration</li>
        <li class="text-slate-300">Compliance reporting (EO 14028)</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Prevent supply chain attacks</li>
        <li class="text-slate-300">Automate compliance reporting</li>
        <li class="text-slate-300">Reduce vulnerability exposure</li>
        <li class="text-slate-300">Meet federal security requirements</li>
      </ul>
        </div>
