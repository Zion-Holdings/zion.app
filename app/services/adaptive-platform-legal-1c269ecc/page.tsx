...
export const metadata: Metadata = {
  title: 'Adaptive platform-legal',
  description: 'Revolutionize legal through intelligent automation. Our Adaptive platform-legal leverages advanced machine learning to deliver enterprise-grade insights at scal',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-platform-legal-1c269ecc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive platform-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Adaptive platform-legal leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
