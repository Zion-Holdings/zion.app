...
export const metadata: Metadata = {
  title: 'Adaptive Intelligence for Insurance',
  description: 'Transform your insurance operations with our Adaptive Intelligence for Insurance. This AI-driven solution automates document processing with unprecedented accur',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Intelligence for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Adaptive Intelligence for Insurance. This AI-driven solution automates document processing with unprecedented accuracy and efficiency.
          </p>
