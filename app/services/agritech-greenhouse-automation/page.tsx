...
export const metadata: Metadata = {
  ...
  keywords: 'Temperature and humidity optimization, Lighting schedule automation, CO2 level management, Yield prediction models, Energy cost optimization, Integration with Priva, Argus, Disease risk alerts, Harvest timing recommendations, agritech, Agriculture, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Greenhouse Climate Control</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered greenhouse automation. Climate optimization, lighting control, CO2 management, and yield prediction for controlled environment agriculture.</p>
        ...
        <li class="text-slate-300">Temperature and humidity optimization</li>
        <li class="text-slate-300">Lighting schedule automation</li>
        <li class="text-slate-300">CO2 level management</li>
        <li class="text-slate-300">Yield prediction models</li>
        <li class="text-slate-300">Energy cost optimization</li>
        <li class="text-slate-300">Integration with Priva, Argus</li>
        <li class="text-slate-300">Disease risk alerts</li>
        <li class="text-slate-300">Harvest timing recommendations</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Increase yield 25%</li>
        <li class="text-slate-300">Reduce energy costs 30%</li>
        <li class="text-slate-300">Optimize growing conditions 24/7</li>
        <li class="text-slate-300">Predict harvest dates accurately</li>
      </ul>
        </div>
