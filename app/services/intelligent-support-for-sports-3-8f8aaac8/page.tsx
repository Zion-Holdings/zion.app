...
export const metadata: Metadata = {
  title: 'Intelligent Support for Sports #3',
  description: 'The future of sports is here with Intelligent Support for Sports #3. Powered by cutting-edge AI, this platform delivers image recognition like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-support-for-sports-3-8f8aaac8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Support for Sports #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Intelligent Support for Sports #3. Powered by cutting-edge AI, this platform delivers image recognition like never before.
          </p>
