...
export const metadata: Metadata = {
  title: 'Intelligent Optimizer for Finance',
  description: 'The future of finance is here with Intelligent Optimizer for Finance. Powered by cutting-edge AI, this platform delivers security monitoring like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-optimizer-for-finance-df428d44',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Optimizer for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of finance is here with Intelligent Optimizer for Finance. Powered by cutting-edge AI, this platform delivers security monitoring like never before.
          </p>
