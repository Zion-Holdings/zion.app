...
export const metadata: Metadata = {
  title: 'Enterprise Quality Platform - Finance #1',
  description: 'Drive innovation in finance with Enterprise Quality Platform - Finance #1. This AI-powered platform transforms maintenance scheduling into a competitive advanta',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Quality Platform - Finance #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in finance with Enterprise Quality Platform - Finance #1. This AI-powered platform transforms maintenance scheduling into a competitive advantage.
          </p>
