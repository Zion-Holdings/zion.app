...
export const metadata: Metadata = {
  ...
  keywords: 'SLO definition/management, Incident response, Capacity planning, Chaos engineering, Error budget tracking, Reliability reviews, On-call management, Post-mortems, it, DevOps, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">SRE as a Service</h1>
        <p className="text-lg text-slate-300 mb-8">Dedicated Site Reliability Engineering team for your infrastructure. SLO management, incident response, capacity planning, chaos engineering, and reliability best practices.</p>
        ...
        <li class="text-slate-300">SLO definition/management</li>
        <li class="text-slate-300">Incident response</li>
        <li class="text-slate-300">Capacity planning</li>
        <li class="text-slate-300">Chaos engineering</li>
        <li class="text-slate-300">Error budget tracking</li>
        <li class="text-slate-300">Reliability reviews</li>
        <li class="text-slate-300">On-call management</li>
        <li class="text-slate-300">Post-mortems</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">99.99% reliability target</li>
        <li class="text-slate-300">MTTR reduced by 60%</li>
        <li class="text-slate-300">Error budget culture</li>
        <li class="text-slate-300">Proactive reliability</li>
      </ul>
        </div>
