...
export const metadata: Metadata = {
  title: 'Medical Imaging AI-Powered Threat Detection System',
  description: 'medical imaging solution for ports & harbors industry. Real-time threat detection using behavioral analysis, anomaly detection, and machine learning.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/medical-imaging-ai-powered-threat-detection-system-901ae54d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Medical Imaging AI-Powered Threat Detection System
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            medical imaging solution for ports & harbors industry. Real-time threat detection using behavioral analysis, anomaly detection, and machine learning.
          </p>
