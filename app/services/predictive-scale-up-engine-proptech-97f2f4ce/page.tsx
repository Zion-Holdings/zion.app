...
export const metadata: Metadata = {
  title: 'Predictive Scale-up Engine - PROPTECH',
  description: 'Enhance your proptech business with Predictive Scale-up Engine - PROPTECH. Our solution provides scalability planning with enterprise-grade reliability and secu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Scale-up Engine - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your proptech business with Predictive Scale-up Engine - PROPTECH. Our solution provides scalability planning with enterprise-grade reliability and security.
          </p>
