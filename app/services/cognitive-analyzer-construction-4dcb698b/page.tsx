...
export const metadata: Metadata = {
  title: 'Cognitive analyzer-construction',
  description: 'Optimize your construction workflows with Cognitive analyzer-construction. This intelligent platform delivers process automation through advanced automation and',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive analyzer-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Cognitive analyzer-construction. This intelligent platform delivers process automation through advanced automation and AI.
          </p>
