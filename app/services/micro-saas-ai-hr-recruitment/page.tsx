...
export const metadata: Metadata = {
  ...
  keywords: 'AI resume screening, Candidate ranking, Interview scheduling, Predictive hiring analytics, ATS integration, Diversity analytics, ai, HR, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Micro-SAAS AI HR Recruitment Platform</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered recruitment platform that screens resumes, ranks candidates, schedules interviews, and predicts hiring success.</p>
        ...
        <li class="text-slate-300">AI resume screening</li>
        <li class="text-slate-300">Candidate ranking</li>
        <li class="text-slate-300">Interview scheduling</li>
        <li class="text-slate-300">Predictive hiring analytics</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">70% faster time-to-hire</li>
        <li class="text-slate-300">Better quality hires</li>
        <li class="text-slate-300">Reduced bias</li>
        <li class="text-slate-300">Lower recruitment costs</li>
      </ul>
        </div>
