...
export const metadata: Metadata = {
  title: 'AI-Powered Customer Service for Real-Estate',
  description: 'Optimize your real-estate workflows with AI-Powered Customer Service for Real-Estate. This intelligent platform delivers vendor management through advanced auto',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-customer-service-for-real-estate-eaade7ed',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Customer Service for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your real-estate workflows with AI-Powered Customer Service for Real-Estate. This intelligent platform delivers vendor management through advanced automation and AI.
          </p>
