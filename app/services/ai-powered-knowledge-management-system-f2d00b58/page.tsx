...
export const metadata: Metadata = {
  ...
  description: 'Intelligent knowledge base that automatically organizes content, answers employee questions, and continuously improves through machine learning.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-knowledge-management-system-f2d00b58',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Intelligent knowledge base that automatically organizes content, answers employee questions, and continuously improves through machine learning.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Content suggestions</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">80% faster information retrieval</li>
          <li className="text-purple-300">Reduced knowledge silos</li>
          <li className="text-purple-300">Self-improving accuracy</li>
          </ul>
        </section>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your operations operations?</p>
