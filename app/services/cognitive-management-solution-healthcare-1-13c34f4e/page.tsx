...
export const metadata: Metadata = {
  title: 'Cognitive Management Solution - Healthcare #1',
  description: 'Revolutionize healthcare through intelligent automation. Our Cognitive Management Solution - Healthcare #1 leverages advanced machine learning to deliver conten',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Management Solution - Healthcare #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Cognitive Management Solution - Healthcare #1 leverages advanced machine learning to deliver content moderation at scale.
          </p>
