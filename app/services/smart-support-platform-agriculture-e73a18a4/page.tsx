...
export const metadata: Metadata = {
  title: 'Smart Support Platform - Agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Smart Support Platform - Agriculture leverages advanced machine learning to deliver decision suppo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-support-platform-agriculture-e73a18a4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Support Platform - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Smart Support Platform - Agriculture leverages advanced machine learning to deliver decision support at scale.
          </p>
