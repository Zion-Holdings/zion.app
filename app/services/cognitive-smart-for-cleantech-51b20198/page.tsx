...
export const metadata: Metadata = {
  title: 'Cognitive Smart for CLEANTECH',
  description: 'Revolutionize cleantech through intelligent automation. Our Cognitive Smart for CLEANTECH leverages advanced machine learning to deliver investor relations at s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Smart for CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cleantech through intelligent automation. Our Cognitive Smart for CLEANTECH leverages advanced machine learning to deliver investor relations at scale.
          </p>
