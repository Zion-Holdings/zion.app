...
export const metadata: Metadata = {
  title: 'Smart supply-hospitality',
  description: 'Optimize your hospitality workflows with Smart supply-hospitality. This intelligent platform delivers succession planning through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-supply-hospitality-c5fe5b05',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart supply-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Smart supply-hospitality. This intelligent platform delivers succession planning through advanced automation and AI.
          </p>
