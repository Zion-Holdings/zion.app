...
export const metadata: Metadata = {
  ...
  keywords: 'Drag-and-drop calculator builder, Real-time cost updates, Scenario comparison tables, Embeddable JavaScript widget, Currency conversion, Integration with Stripe billing, PDF export for proposals, Analytics on calculator usage, micro-saas, SaaS, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">CostLens — Usage-Based Cost Calculator</h1>
        <p className="text-lg text-slate-300 mb-8">Interactive pricing calculator widget for usage-based SaaS. Real-time cost estimation, scenario comparison, and embed in any site with one script tag.</p>
        ...
        <li class="text-slate-300">Drag-and-drop calculator builder</li>
        <li class="text-slate-300">Real-time cost updates</li>
        <li class="text-slate-300">Scenario comparison tables</li>
        <li class="text-slate-300">Embeddable JavaScript widget</li>
        <li class="text-slate-300">Currency conversion</li>
        <li class="text-slate-300">Integration with Stripe billing</li>
        <li class="text-slate-300">PDF export for proposals</li>
        <li class="text-slate-300">Analytics on calculator usage</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Increase pricing page conversions</li>
        <li class="text-slate-300">Reduce sales cycle length</li>
        <li class="text-slate-300">Self-service pricing transparency</li>
        <li class="text-slate-300">Better lead qualification</li>
      </ul>
        </div>
