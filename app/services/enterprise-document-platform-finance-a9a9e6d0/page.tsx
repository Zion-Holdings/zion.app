...
export const metadata: Metadata = {
  title: 'Enterprise Document Platform - Finance',
  description: 'Next-generation finance solution: Enterprise Document Platform - Finance. Combines container orchestration with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-document-platform-finance-a9a9e6d0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Document Platform - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation finance solution: Enterprise Document Platform - Finance. Combines container orchestration with adaptive intelligence for optimal results.
          </p>
