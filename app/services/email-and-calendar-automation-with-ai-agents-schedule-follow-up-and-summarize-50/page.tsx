...
export const metadata = {
  ...
  description: 'End-to-end email and calendar automation with ai agents: schedule, follow up, and summarize services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/email-and-calendar-automation-with-ai-agents-schedule-follow-up-and-summarize-50/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">Email and Calendar Automation with AI Agents: Schedule, Follow Up, and Summarize</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end email and calendar automation with ai agents: schedule, follow up, and summarize services: assessment, deployment, and managed operations.
        </p>
