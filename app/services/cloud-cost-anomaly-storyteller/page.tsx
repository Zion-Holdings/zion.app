  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Cloud Cost Anomaly Storyteller</h1>
        <p className="text-lg text-gray-300 mb-8">Turns cloud spend anomalies into readable narratives with owner-ready findings, evidence links, and action checklists.</p>
