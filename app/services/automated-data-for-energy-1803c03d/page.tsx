...
export const metadata: Metadata = {
  title: 'Automated Data for Energy',
  description: 'Next-generation energy solution: Automated Data for Energy. Combines predictive analytics with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-data-for-energy-1803c03d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Data for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Automated Data for Energy. Combines predictive analytics with adaptive intelligence for optimal results.
          </p>
