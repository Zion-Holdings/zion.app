...
export const metadata: Metadata = {
  title: 'Predictive healthcare-legal',
  description: 'Transform your legal operations with our Predictive healthcare-legal. This AI-driven solution automates customer journey mapping with unprecedented accuracy and',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive healthcare-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Predictive healthcare-legal. This AI-driven solution automates customer journey mapping with unprecedented accuracy and efficiency.
          </p>
