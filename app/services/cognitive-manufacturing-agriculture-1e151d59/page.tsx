...
export const metadata: Metadata = {
  title: 'Cognitive manufacturing-agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Cognitive manufacturing-agriculture leverages advanced machine learning to deliver data processing',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-manufacturing-agriculture-1e151d59',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive manufacturing-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Cognitive manufacturing-agriculture leverages advanced machine learning to deliver data processing at scale.
          </p>
