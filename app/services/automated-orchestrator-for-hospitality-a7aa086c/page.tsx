...
export const metadata: Metadata = {
  ...
  description: 'The future of hospitality is here with Automated Orchestrator for Hospitality. Powered by cutting-edge AI, this platform delivers fraud prevention like never be',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-orchestrator-for-hospitality-a7aa086c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Automated Orchestrator for Hospitality. Powered by cutting-edge AI, this platform delivers fraud prevention like never before.
          </p>
