...
export const metadata: Metadata = {
  title: 'Autonomous Data for Agriculture',
  description: 'Unlock unprecedented growth with Autonomous Data for Agriculture. This autonomous system provides fraud prevention with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-data-for-agriculture-82b4c3fe',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Data for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Autonomous Data for Agriculture. This autonomous system provides fraud prevention with zero manual intervention needed.
          </p>
