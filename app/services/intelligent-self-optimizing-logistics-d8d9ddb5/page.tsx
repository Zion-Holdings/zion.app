...
export const metadata: Metadata = {
  title: 'Intelligent Self-Optimizing - Logistics',
  description: 'The future of logistics is here with Intelligent Self-Optimizing - Logistics. Powered by cutting-edge AI, this platform delivers transformative results like nev',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-self-optimizing-logistics-d8d9ddb5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Self-Optimizing - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Intelligent Self-Optimizing - Logistics. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
