...
export const metadata: Metadata = {
  title: 'Adaptive Platform for Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Adaptive Platform for Hospitality leverages advanced machine learning to deliver sales process opt',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-platform-for-hospitality-dedddc22',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Platform for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Adaptive Platform for Hospitality leverages advanced machine learning to deliver sales process optimization at scale.
          </p>
