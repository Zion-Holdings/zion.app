...
export const metadata: Metadata = {
  title: 'Autonomous Predictive System - Automotive',
  description: 'The future of automotive is here with Autonomous Predictive System - Automotive. Powered by cutting-edge AI, this platform delivers lead scoring like never befo',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Predictive System - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of automotive is here with Autonomous Predictive System - Automotive. Powered by cutting-edge AI, this platform delivers lead scoring like never before.
          </p>
