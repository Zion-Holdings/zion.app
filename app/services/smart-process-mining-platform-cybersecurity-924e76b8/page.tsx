...
export const metadata: Metadata = {
  title: 'Smart Process Mining Platform - Cybersecurity',
  description: 'Revolutionize cybersecurity through intelligent automation. Our Smart Process Mining Platform - Cybersecurity leverages advanced machine learning to deliver ml ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-process-mining-platform-cybersecurity-924e76b8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Process Mining Platform - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cybersecurity through intelligent automation. Our Smart Process Mining Platform - Cybersecurity leverages advanced machine learning to deliver ml model training at scale.
          </p>
