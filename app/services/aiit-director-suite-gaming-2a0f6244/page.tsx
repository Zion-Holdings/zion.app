...
export const metadata: Metadata = {
  title: 'AI/IT Director Suite - Gaming',
  description: 'Hyper-accelerated gaming solution: AI/IT Director Suite - Gaming. Combines release management with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-director-suite-gaming-2a0f6244',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Director Suite - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated gaming solution: AI/IT Director Suite - Gaming. Combines release management with next-gen AI for maximum velocity.
          </p>
