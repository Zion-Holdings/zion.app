...
export const metadata: Metadata = {
  title: 'Quantum Scale-up - Finance Quantum',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Scale-up - Finance Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated finance solution: Quantum Scale-up - Finance Quantum. Combines process automation with next-gen AI for maximum velocity.
          </p>
