...
export const metadata: Metadata = {
  title: 'Cognitive marketing-sports',
  description: 'The future of sports is here with Cognitive marketing-sports. Powered by cutting-edge AI, this platform delivers predictive modeling like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-marketing-sports-d1ff3bf3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive marketing-sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Cognitive marketing-sports. Powered by cutting-edge AI, this platform delivers predictive modeling like never before.
          </p>
