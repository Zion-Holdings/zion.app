...
export const metadata: Metadata = {
  title: 'Self-Optimizing Support for Construction',
  description: 'Revolutionize construction through intelligent automation. Our Self-Optimizing Support for Construction leverages advanced machine learning to deliver complianc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/self-optimizing-support-for-construction-80348741',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Support for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Self-Optimizing Support for Construction leverages advanced machine learning to deliver compliance monitoring at scale.
          </p>
