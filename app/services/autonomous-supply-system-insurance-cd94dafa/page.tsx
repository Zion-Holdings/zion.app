...
export const metadata: Metadata = {
  title: 'Autonomous Supply System - Insurance',
  description: 'Optimize your insurance workflows with Autonomous Supply System - Insurance. This intelligent platform delivers process discovery through advanced automation an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-supply-system-insurance-cd94dafa',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Supply System - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Autonomous Supply System - Insurance. This intelligent platform delivers process discovery through advanced automation and AI.
          </p>
