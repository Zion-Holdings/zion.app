...
export const metadata: Metadata = {
  title: 'System Automated - Manufacturing',
  description: 'Future-proof your manufacturing with System Automated - Manufacturing. Our autonomous solution handles content moderation end-to-end without human intervention.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/system-automated-manufacturing-464c9688',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            System Automated - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your manufacturing with System Automated - Manufacturing. Our autonomous solution handles content moderation end-to-end without human intervention.
          </p>
