...
export const metadata: Metadata = {
  title: 'Smart Social Finance',
  description: 'Optimize your gaming workflows with Smart Social Finance. This intelligent platform delivers churn risk through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-social-finance-cea8ca34',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Social Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your gaming workflows with Smart Social Finance. This intelligent platform delivers churn risk through advanced automation and AI.
          </p>
