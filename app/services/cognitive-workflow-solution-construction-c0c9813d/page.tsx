...
export const metadata: Metadata = {
  title: 'Cognitive Workflow Solution - Construction',
  description: 'Unlock unprecedented growth with Cognitive Workflow Solution - Construction. This autonomous system provides recruitment automation with zero manual interventio',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-workflow-solution-construction-c0c9813d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Workflow Solution - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Cognitive Workflow Solution - Construction. This autonomous system provides recruitment automation with zero manual intervention needed.
          </p>
