...
export const metadata: Metadata = {
  title: 'Cognitive Cognitive Solution - Construction #2',
  description: 'Enhance your construction business with Cognitive Cognitive Solution - Construction #2. Our solution provides market analysis with enterprise-grade reliability ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-cognitive-solution-construction-2-d42bf59b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Cognitive Solution - Construction #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Cognitive Cognitive Solution - Construction #2. Our solution provides market analysis with enterprise-grade reliability and security.
          </p>
