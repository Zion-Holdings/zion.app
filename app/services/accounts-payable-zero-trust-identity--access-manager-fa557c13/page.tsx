...
export const metadata: Metadata = {
  title: "Accounts Payable Zero-Trust Identity & Access Manager - AI-Powered Accounts Payable Solution",
  description: "AI-powered accounts payable solution for enterprise security. Implements zero-trust security architecture with continuous authentication and adaptive access con",
  alternates: {
    canonical: "https://ziontechgroup.com/services/accounts-payable-zero-trust-identity--access-manager-fa557c13",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Accounts Payable Zero-Trust Identity & Access Manager - AI-Powered Accounts Payable Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          AI-powered accounts payable solution for enterprise security. Implements zero-trust security architecture with continuous authentication and adaptive access con
        </p>
