...
export const metadata: Metadata = {
  title: 'Adaptive Access Smart',
  description: 'Next-generation agriculture solution: Adaptive Access Smart. Combines executive dashboards with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-access-smart-d50c847b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Access Smart
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agriculture solution: Adaptive Access Smart. Combines executive dashboards with adaptive intelligence for optimal results.
          </p>
