...
export const metadata: Metadata = {
  title: 'Next-Gen finance-althealth',
  description: 'Enhance your althealth business with Next-Gen finance-althealth. Our solution provides data fabric with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-finance-althealth-d09a5154',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen finance-althealth
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your althealth business with Next-Gen finance-althealth. Our solution provides data fabric with enterprise-grade reliability and security.
          </p>
