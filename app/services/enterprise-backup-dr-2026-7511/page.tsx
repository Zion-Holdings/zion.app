...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "Enterprise Backup DR | Zion Tech Group", description: "End-to-end enterprise backup dr services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/enterprise-backup-dr-2026-7511/"}} />
