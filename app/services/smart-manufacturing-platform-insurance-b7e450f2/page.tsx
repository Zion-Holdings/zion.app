...
export const metadata: Metadata = {
  title: 'Smart Manufacturing Platform - Insurance',
  description: 'Unlock unprecedented growth with Smart Manufacturing Platform - Insurance. This autonomous system provides loyalty optimization with zero manual intervention ne',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-manufacturing-platform-insurance-b7e450f2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manufacturing Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Manufacturing Platform - Insurance. This autonomous system provides loyalty optimization with zero manual intervention needed.
          </p>
