...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Scale-up - Real-Estate',
  description: 'The future of real-estate is here with Hyper-Accelerated Scale-up - Real-Estate. Powered by cutting-edge AI, this platform delivers recruitment automation like ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Scale-up - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of real-estate is here with Hyper-Accelerated Scale-up - Real-Estate. Powered by cutting-edge AI, this platform delivers recruitment automation like never before.
          </p>
