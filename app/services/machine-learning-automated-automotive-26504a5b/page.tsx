...
export const metadata: Metadata = {
  title: 'Machine Learning Automated - Automotive',
  description: 'Drive innovation in automotive with Machine Learning Automated - Automotive. This AI-powered platform transforms security monitoring into a competitive advantag',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Machine Learning Automated - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in automotive with Machine Learning Automated - Automotive. This AI-powered platform transforms security monitoring into a competitive advantage.
          </p>
