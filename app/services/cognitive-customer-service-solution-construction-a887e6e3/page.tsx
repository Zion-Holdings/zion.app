...
export const metadata: Metadata = {
  title: 'Cognitive Customer Service Solution - Construction',
  description: 'Next-generation construction solution: Cognitive Customer Service Solution - Construction. Combines executive dashboards with adaptive intelligence for optimal ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-customer-service-solution-construction-a887e6e3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Customer Service Solution - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Cognitive Customer Service Solution - Construction. Combines executive dashboards with adaptive intelligence for optimal results.
          </p>
