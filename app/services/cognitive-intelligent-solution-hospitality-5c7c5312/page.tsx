...
export const metadata: Metadata = {
  title: 'Cognitive Intelligent Solution - Hospitality',
  description: 'The future of hospitality is here with Cognitive Intelligent Solution - Hospitality. Powered by cutting-edge AI, this platform delivers hr analytics like never ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-intelligent-solution-hospitality-5c7c5312',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Intelligent Solution - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Cognitive Intelligent Solution - Hospitality. Powered by cutting-edge AI, this platform delivers hr analytics like never before.
          </p>
