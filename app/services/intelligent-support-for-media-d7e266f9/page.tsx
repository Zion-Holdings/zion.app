...
export const metadata: Metadata = {
  ...
  description: 'Transform your media operations with our Intelligent Support for Media. This AI-driven solution automates compliance monitoring with unprecedented accuracy and ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your media operations with our Intelligent Support for Media. This AI-driven solution automates compliance monitoring with unprecedented accuracy and efficiency.
          </p>
