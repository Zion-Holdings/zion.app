...
export const metadata = {
  ...
  description: 'Automate complex business processes with AI-powered solutions. Discover how Zion Tech Group can help transform your business.',
  openGraph: {
    title: 'Intelligent Process Automation | Zion Tech Group',
    description: 'Automate complex business processes with AI-powered solutions',
    url: 'https://ziontechgroup.com/solutions/intelligent-process-automation',
  },
  twitter: { card: 'summary_large_image' },
};

const features = ["Process mining and analysis","Robotic process automation (RPA)","Intelligent document processing","Workflow optimization","Integration with existing systems"];
const benefits = ["Reduce operational costs by 50%+","Eliminate manual errors","Increase processing speed by 300%","Improve employee satisfaction","Scale operations efficiently"];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50">
      <section className="py-20 text-center max-w-7xl mx-auto px-4">
        ...
        <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">Intelligent Process Automation</h1>
        <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">Automate complex business processes with AI-powered solutions</p>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 text-center bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-12 text-white">
          ...
          <p className="text-xl mb-8 text-blue-100">
            Let&apos;s discuss how Intelligent Process Automation can help you achieve your goals.
          </p>
