  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Access Provisioning Auditor</h1>
        <p className="text-lg text-gray-300 mb-8">Audits provisioning workflows, approval behavior, access entropy, and dormant entitlement issues across systems.</p>
