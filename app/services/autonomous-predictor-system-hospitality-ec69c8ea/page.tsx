...
export const metadata: Metadata = {
  title: 'Autonomous Predictor System - Hospitality',
  description: 'Enhance your hospitality business with Autonomous Predictor System - Hospitality. Our solution provides social media monitoring with enterprise-grade reliabilit',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Predictor System - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Autonomous Predictor System - Hospitality. Our solution provides social media monitoring with enterprise-grade reliability and security.
          </p>
