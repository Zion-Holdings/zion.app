...
export const metadata: Metadata = {
  title: 'AI Process Mining - ALTHEALTH Edition',
  description: 'The future of althealth is here with AI Process Mining - ALTHEALTH Edition. Powered by cutting-edge AI, this platform delivers campaign optimization like never ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-process-mining-althealth-edition-68bd1b0b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Process Mining - ALTHEALTH Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of althealth is here with AI Process Mining - ALTHEALTH Edition. Powered by cutting-edge AI, this platform delivers campaign optimization like never before.
          </p>
