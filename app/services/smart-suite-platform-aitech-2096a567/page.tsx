...
export const metadata: Metadata = {
  title: 'Smart Suite Platform - AITECH',
  description: 'Revolutionize aitech through intelligent automation. Our Smart Suite Platform - AITECH leverages advanced machine learning to deliver quality control at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-suite-platform-aitech-2096a567',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Suite Platform - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize aitech through intelligent automation. Our Smart Suite Platform - AITECH leverages advanced machine learning to deliver quality control at scale.
          </p>
