...
export const metadata: Metadata = {
  title: 'AI/IT Predictor Suite - Cybersecurity',
  description: 'Enhance your cybersecurity business with AI/IT Predictor Suite - Cybersecurity. Our solution provides image recognition with enterprise-grade reliability and se',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Predictor Suite - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your cybersecurity business with AI/IT Predictor Suite - Cybersecurity. Our solution provides image recognition with enterprise-grade reliability and security.
          </p>
