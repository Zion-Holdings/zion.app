...
export const metadata: Metadata = {
  title: 'Autonomous Customer Management',
  description: 'Transform your retail operations with our Autonomous Customer Management. This AI-driven solution automates energy management with unprecedented accuracy and ef',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our Autonomous Customer Management. This AI-driven solution automates energy management with unprecedented accuracy and efficiency.
          </p>
