...
export const metadata: Metadata = {
  ...
  keywords: 'Managed cron scheduling (any interval), Retry logic with exponential backoff, Timeout and failure alerting, Execution history and logs, Job dependency chaining, Timezone-aware scheduling, API, CLI, and dashboard, micro-saas, Developer Tools, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">CronJob Manager — Scheduled Tasks</h1>
        <p className="text-lg text-slate-300 mb-8">Managed cron job execution: create, monitor, and debug scheduled tasks. Retry on failure, timeout alerts, and execution history. No more lost crons.</p>
        ...
        <li class="text-slate-300">Managed cron scheduling (any interval)</li>
        <li class="text-slate-300">Retry logic with exponential backoff</li>
        <li class="text-slate-300">Timeout and failure alerting</li>
        <li class="text-slate-300">Execution history and logs</li>
        <li class="text-slate-300">Job dependency chaining</li>
        <li class="text-slate-300">Timezone-aware scheduling</li>
        <li class="text-slate-300">API, CLI, and dashboard</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Never lose a cron job again</li>
        <li class="text-slate-300">Retry logic handles transient failures</li>
        <li class="text-slate-300">Alerting catches silent failures</li>
        <li class="text-slate-300">Execution history for debugging</li>
      </ul>
        </div>
