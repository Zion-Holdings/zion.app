...
export const metadata: Metadata = {
  title: 'Smart Container Data Science',
  description: 'Next-generation transportation solution: Smart Container Data Science. Combines risk assessment with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-container-data-science-f2dbcf72',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Container Data Science
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation transportation solution: Smart Container Data Science. Combines risk assessment with adaptive intelligence for optimal results.
          </p>
