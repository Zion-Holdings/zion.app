...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize technology through intelligent automation. Our Smart Supply Platform - Tech leverages advanced machine learning to deliver net promoter score at s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Supply Platform - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our Smart Supply Platform - Tech leverages advanced machine learning to deliver net promoter score at scale.
          </p>
