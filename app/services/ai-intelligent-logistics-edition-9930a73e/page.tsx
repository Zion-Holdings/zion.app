...
export const metadata: Metadata = {
  title: 'AI Intelligent - Logistics Edition',
  description: 'Enhance your logistics business with AI Intelligent - Logistics Edition. Our solution provides performance monitoring with enterprise-grade reliability and secu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Intelligent - Logistics Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with AI Intelligent - Logistics Edition. Our solution provides performance monitoring with enterprise-grade reliability and security.
          </p>
