...
export const metadata = {
  ...
  description: "Unify customer data from all sources into a single profile. Segmentation, activation, and privacy compliance.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/data-customer-data-platform`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Unify customer data from all sources into a single profile. Segmentation, activation, and privacy compliance.</p>
        
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          <h2 className="text-2xl font-semibold mb-4">Key Features</h2>
          <ul className="list-disc list-inside space-y-2">
            <li>Cross-channel identity resolution</li>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>Activate segments in real-time</li>
            <li>Privacy-compliant by design</li>
            <li>Increase LTV with personalization</li>
          </ul>
        </div>
