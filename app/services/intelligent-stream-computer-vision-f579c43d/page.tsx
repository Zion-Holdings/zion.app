...
export const metadata: Metadata = {
  title: 'Intelligent Stream Computer Vision',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Stream Computer Vision
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in althealth with Intelligent Stream Computer Vision. This AI-powered platform transforms user experience into a competitive advantage.
          </p>
