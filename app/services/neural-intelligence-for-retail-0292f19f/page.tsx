...
export const metadata: Metadata = {
  title: 'Neural Intelligence for Retail',
  description: 'Transform your retail operations with our Neural Intelligence for Retail. This AI-driven solution automates supply chain with unprecedented accuracy and efficie',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-intelligence-for-retail-0292f19f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Intelligence for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our Neural Intelligence for Retail. This AI-driven solution automates supply chain with unprecedented accuracy and efficiency.
          </p>
