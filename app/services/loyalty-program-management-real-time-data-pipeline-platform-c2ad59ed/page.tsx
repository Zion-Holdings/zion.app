...
export const metadata: Metadata = {
  ...
  description: 'loyalty program management solution for retail industry. Creates and manages real-time data pipelines with automated ETL and streaming analytics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/loyalty-program-management-real-time-data-pipeline-platform-c2ad59ed',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            loyalty program management solution for retail industry. Creates and manages real-time data pipelines with automated ETL and streaming analytics.
          </p>
