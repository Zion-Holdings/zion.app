...
export const metadata: Metadata = {
  title: 'Cognitive Recruitment Solution - Sports',
  description: 'Transform your sports operations with our Cognitive Recruitment Solution - Sports. This AI-driven solution automates resource allocation with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-recruitment-solution-sports-0f98033b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Recruitment Solution - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our Cognitive Recruitment Solution - Sports. This AI-driven solution automates resource allocation with unprecedented accuracy and efficiency.
          </p>
