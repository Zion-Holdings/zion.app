...
export const metadata: Metadata = {
  title: 'Autonomous Suite for Agritech',
  description: 'The future of agritech is here with Autonomous Suite for Agritech. Powered by cutting-edge AI, this platform delivers process automation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-suite-for-agritech-340357c6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Suite for Agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agritech is here with Autonomous Suite for Agritech. Powered by cutting-edge AI, this platform delivers process automation like never before.
          </p>
