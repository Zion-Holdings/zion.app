...
export const metadata: Metadata = {
  title: 'Smart Quality Platform - Retail',
  description: 'Optimize your retail workflows with Smart Quality Platform - Retail. This intelligent platform delivers content moderation through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-quality-platform-retail-223afcd6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Quality Platform - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your retail workflows with Smart Quality Platform - Retail. This intelligent platform delivers content moderation through advanced automation and AI.
          </p>
