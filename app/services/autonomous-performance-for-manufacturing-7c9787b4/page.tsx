...
export const metadata: Metadata = {
  ...
  description: 'Next-generation manufacturing solution: Autonomous Performance for Manufacturing. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-performance-for-manufacturing-7c9787b4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation manufacturing solution: Autonomous Performance for Manufacturing. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
