...
export const metadata: Metadata = {
  title: 'Quantum Operational - PROPTECH Quantum',
  description: 'Enhance your proptech business with Quantum Operational - PROPTECH Quantum. Our solution provides demand planning with enterprise-grade reliability and security',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-operational-proptech-quantum-3a5f69cd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Operational - PROPTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your proptech business with Quantum Operational - PROPTECH Quantum. Our solution provides demand planning with enterprise-grade reliability and security.
          </p>
