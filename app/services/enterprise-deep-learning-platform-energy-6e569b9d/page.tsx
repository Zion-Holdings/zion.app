...
export const metadata: Metadata = {
  title: 'Enterprise Deep Learning Platform - Energy',
  description: 'Revolutionize energy through intelligent automation. Our Enterprise Deep Learning Platform - Energy leverages advanced machine learning to deliver demand planni',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Deep Learning Platform - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Enterprise Deep Learning Platform - Energy leverages advanced machine learning to deliver demand planning at scale.
          </p>
