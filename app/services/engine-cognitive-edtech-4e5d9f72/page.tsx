...
export const metadata: Metadata = {
  title: 'Engine Cognitive - EDTECH',
  description: 'Revolutionize edtech through intelligent automation. Our Engine Cognitive - EDTECH leverages advanced machine learning to deliver influencer identification at s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/engine-cognitive-edtech-4e5d9f72',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Engine Cognitive - EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize edtech through intelligent automation. Our Engine Cognitive - EDTECH leverages advanced machine learning to deliver influencer identification at scale.
          </p>
