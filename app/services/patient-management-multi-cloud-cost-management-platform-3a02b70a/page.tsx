...
export const metadata: Metadata = {
  title: 'Patient Management Multi-Cloud Cost Management Platform',
  description: 'patient management solution for highways industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/patient-management-multi-cloud-cost-management-platform-3a02b70a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Patient Management Multi-Cloud Cost Management Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            patient management solution for highways industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.
          </p>
