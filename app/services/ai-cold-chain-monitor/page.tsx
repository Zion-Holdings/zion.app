...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time temperature/humidity monitoring, Excursion prediction (30-min advance), Automated corrective actions, FDA 21 CFR Part 11 compliance, GDP documentation auto-generation, Recall batch identification, ai, Healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Cold Chain Monitoring for Pharmaceuticals</h1>
        <p className="text-lg text-slate-300 mb-8">IoT + AI for pharma cold chain: real-time temperature monitoring, excursion prediction, compliance reporting (GDP/FDA), and automated corrective actions. Prevents $35B in annual spoilage.</p>
        ...
        <li class="text-slate-300">Real-time temperature/humidity monitoring</li>
        <li class="text-slate-300">Excursion prediction (30-min advance)</li>
        <li class="text-slate-300">Automated corrective actions</li>
        <li class="text-slate-300">FDA 21 CFR Part 11 compliance</li>
        <li class="text-slate-300">GDP documentation auto-generation</li>
        <li class="text-slate-300">Recall batch identification</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Prevent spoilage 30 min early</li>
        <li class="text-slate-300">Full FDA/GDP compliance</li>
        <li class="text-slate-300">Save millions in recalled products</li>
      </ul>
        </div>
