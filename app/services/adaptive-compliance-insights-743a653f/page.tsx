...
export const metadata: Metadata = {
  title: 'Adaptive Compliance Insights',
  description: 'Optimize your cybersecurity workflows with Adaptive Compliance Insights. This intelligent platform delivers business continuity through advanced automation and ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Compliance Insights
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your cybersecurity workflows with Adaptive Compliance Insights. This intelligent platform delivers business continuity through advanced automation and AI.
          </p>
