...
export const metadata: Metadata = {
  title: 'Cognitive insights-insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive insights-insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Cognitive insights-insurance. Our solution provides business continuity with enterprise-grade reliability and security.
          </p>
