...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-sensor fusion + edge analytics, RUL estimation per asset, Failure mode classification (bearing, motor, pump), CMMS work-order auto-creation, OEE dashboard with MTBF/MTTR tracking, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Predictive Maintenance — Industrial IoT</h1>
        <p className="text-lg text-slate-300 mb-8">Industrial IoT predictive maintenance: sensor fusion (vibration, temperature, current, ultrasound), ML failure prediction, remaining useful life (RUL) estimation, and automated work-order creation in your CMMS.</p>
        ...
        <li class="text-slate-300">Multi-sensor fusion + edge analytics</li>
        <li class="text-slate-300">RUL estimation per asset</li>
        <li class="text-slate-300">Failure mode classification (bearing, motor, pump)</li>
        <li class="text-slate-300">CMMS work-order auto-creation</li>
        <li class="text-slate-300">OEE dashboard with MTBF/MTTR tracking</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai predictive maintenance — industrial iot</li>
