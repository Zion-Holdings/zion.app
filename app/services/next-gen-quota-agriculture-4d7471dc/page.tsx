...
export const metadata: Metadata = {
  title: 'Next-Gen Quota - Agriculture',
  description: 'Enhance your agriculture business with Next-Gen Quota - Agriculture. Our solution provides threat detection with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-quota-agriculture-4d7471dc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Quota - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your agriculture business with Next-Gen Quota - Agriculture. Our solution provides threat detection with enterprise-grade reliability and security.
          </p>
