...
export const metadata: Metadata = {
  title: 'Scalable Gaming Performance Kafka (Hr)',
  description: 'Scalable Gaming Performance Kafka (Hr) is an AI-powered hr solution that transforms how businesses operate through intelligent automation and real-time analytic',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Scalable Gaming Performance Kafka (Hr)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Scalable Gaming Performance Kafka (Hr) is an AI-powered hr solution that transforms how businesses operate through intelligent automation and real-time analytics.
