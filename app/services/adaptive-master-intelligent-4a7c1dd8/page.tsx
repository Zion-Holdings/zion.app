...
export const metadata: Metadata = {
  title: 'Adaptive Master Intelligent',
  description: 'Optimize your manufacturing workflows with Adaptive Master Intelligent. This intelligent platform delivers edge computing through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-master-intelligent-4a7c1dd8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Master Intelligent
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your manufacturing workflows with Adaptive Master Intelligent. This intelligent platform delivers edge computing through advanced automation and AI.
          </p>
