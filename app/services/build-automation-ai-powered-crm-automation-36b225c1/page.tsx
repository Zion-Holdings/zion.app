...
export const metadata: Metadata = {
  title: 'Build Automation AI-Powered CRM Automation',
  description: 'AI-powered build automation solution for sales. Automates customer relationship management with AI-driven insights and follow-ups.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/build-automation-ai-powered-crm-automation-36b225c1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Build Automation AI-Powered CRM Automation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered build automation solution for sales. Automates customer relationship management with AI-driven insights and follow-ups.
          </p>
