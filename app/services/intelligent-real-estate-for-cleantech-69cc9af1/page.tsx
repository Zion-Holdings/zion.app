...
export const metadata: Metadata = {
  title: 'Intelligent Real Estate for CLEANTECH',
  description: 'Revolutionize cleantech through intelligent automation. Our Intelligent Real Estate for CLEANTECH leverages advanced machine learning to deliver employee engage',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-real-estate-for-cleantech-69cc9af1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Real Estate for CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cleantech through intelligent automation. Our Intelligent Real Estate for CLEANTECH leverages advanced machine learning to deliver employee engagement at scale.
          </p>
