...
export const metadata: Metadata = {
  ...
  description: 'Transform your hospitality operations with our Computer Vision Automated - Hospitality. This AI-driven solution automates sales process optimization with unprec',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Computer Vision Automated - Hospitality. This AI-driven solution automates sales process optimization with unprecedented accuracy and efficiency.
          </p>
