...
export const metadata: Metadata = {
  ...
  keywords: 'Automated data connection ERP/CRM/HRIS/ADP, Executive KPI cards + drill-through detail, Scenario modelling (what-if sliders), Scheduled PDF/email executive pack per week, it, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Business Intelligence Cockpit</h1>
        <p className="text-lg text-slate-300 mb-8">Executive BI dashboard connecting ERP/CRM/HRIS: revenue run-rate, headcount cost, CAC/LTV, NRR, runway, and scenario modelling.</p>
        ...
        <li class="text-slate-300">Automated data connection ERP/CRM/HRIS/ADP</li>
        <li class="text-slate-300">Executive KPI cards + drill-through detail</li>
        <li class="text-slate-300">Scenario modelling (what-if sliders)</li>
        <li class="text-slate-300">Scheduled PDF/email executive pack per week</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with business intelligence cockpit</li>
