...
export const metadata: Metadata = {
  title: 'Intelligent Intelligence for Retail',
  description: 'Enhance your retail business with Intelligent Intelligence for Retail. Our solution provides procurement automation with enterprise-grade reliability and securi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-intelligence-for-retail-d5cef3c2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Intelligence for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your retail business with Intelligent Intelligence for Retail. Our solution provides procurement automation with enterprise-grade reliability and security.
          </p>
