...
export const metadata: Metadata = {
  title: 'Adaptive automation-regtech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive automation-regtech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of regtech is here with Adaptive automation-regtech. Powered by cutting-edge AI, this platform delivers insurance automation like never before.
          </p>
