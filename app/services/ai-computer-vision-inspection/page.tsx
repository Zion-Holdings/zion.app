...
export const metadata: Metadata = {
  ...
  keywords: 'Defect detection and classification, Object counting and verification, Assembly verification, Integration with industrial cameras, Edge deployment on NVIDIA Jetson, Custom model training, Real-time alerting, Historical trend analysis, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Computer Vision for Visual Inspection</h1>
        <p className="text-lg text-slate-300 mb-8">Automated visual inspection for manufacturing, logistics, and quality control. Detect defects, classify objects, and verify assembly with 99%+ accuracy.</p>
        ...
        <li class="text-slate-300">Defect detection and classification</li>
        <li class="text-slate-300">Object counting and verification</li>
        <li class="text-slate-300">Assembly verification</li>
        <li class="text-slate-300">Integration with industrial cameras</li>
        <li class="text-slate-300">Edge deployment on NVIDIA Jetson</li>
        ...
        <li class="text-slate-300">Automate manual inspection</li>
        <li class="text-slate-300">Improve product quality</li>
        <li class="text-slate-300">Lower labor costs</li>
      </ul>
        </div>
