...
export const metadata: Metadata = {
  title: 'Autonomous Process Mining System - Agriculture',
  description: 'Drive innovation in agriculture with Autonomous Process Mining System - Agriculture. This AI-powered platform transforms predictive analytics into a competitive',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-process-mining-system-agriculture-35395696',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Process Mining System - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in agriculture with Autonomous Process Mining System - Agriculture. This AI-powered platform transforms predictive analytics into a competitive advantage.
          </p>
