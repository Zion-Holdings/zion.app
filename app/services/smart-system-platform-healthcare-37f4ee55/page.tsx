...
export const metadata: Metadata = {
  title: 'Smart System Platform - Healthcare',
  description: 'The future of healthcare is here with Smart System Platform - Healthcare. Powered by cutting-edge AI, this platform delivers disaster recovery like never before',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-system-platform-healthcare-37f4ee55',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart System Platform - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Smart System Platform - Healthcare. Powered by cutting-edge AI, this platform delivers disaster recovery like never before.
          </p>
