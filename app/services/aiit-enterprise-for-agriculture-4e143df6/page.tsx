...
export const metadata: Metadata = {
  title: 'AI/IT Enterprise for Agriculture',
  description: 'Hyper-accelerated agriculture solution: AI/IT Enterprise for Agriculture. Combines process automation with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-enterprise-for-agriculture-4e143df6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Enterprise for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated agriculture solution: AI/IT Enterprise for Agriculture. Combines process automation with next-gen AI for maximum velocity.
          </p>
