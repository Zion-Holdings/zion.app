...
export const metadata: Metadata = {
  title: 'Autonomous Intelligence System - Tech',
  description: 'Enhance your technology business with Autonomous Intelligence System - Tech. Our solution provides customer retention with enterprise-grade reliability and secu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Intelligence System - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your technology business with Autonomous Intelligence System - Tech. Our solution provides customer retention with enterprise-grade reliability and security.
          </p>
