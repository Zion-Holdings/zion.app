...
export const metadata: Metadata = {
  title: 'Smart System Platform - Agriculture',
  description: 'The future of agriculture is here with Smart System Platform - Agriculture. Powered by cutting-edge AI, this platform delivers root cause analysis like never be',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-system-platform-agriculture-55d59c2d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart System Platform - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Smart System Platform - Agriculture. Powered by cutting-edge AI, this platform delivers root cause analysis like never before.
          </p>
