...
export const metadata: Metadata = {
  ...
  description: 'Transform your insurance operations with our Predictive Computer Vision Engine - Insurance. This AI-driven solution automates sales forecasting with unprecedent',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Predictive Computer Vision Engine - Insurance. This AI-driven solution automates sales forecasting with unprecedented accuracy and efficiency.
          </p>
