...
export const metadata: Metadata = {
  title: 'Predictive Threat Advisor',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Threat Advisor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Predictive Threat Advisor leverages advanced machine learning to deliver threat detection at scale.
          </p>
