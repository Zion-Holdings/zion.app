...
export const metadata: Metadata = {
  title: 'Enterprise Risk Platform - Cybersecurity #1',
  description: 'Next-generation cybersecurity solution: Enterprise Risk Platform - Cybersecurity #1. Combines record processing with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-risk-platform-cybersecurity-1-a0e2501e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Risk Platform - Cybersecurity #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation cybersecurity solution: Enterprise Risk Platform - Cybersecurity #1. Combines record processing with adaptive intelligence for optimal results.
          </p>
