...
export const metadata: Metadata = {
  title: 'Intelligent Supply for Legal',
  description: 'Transform your legal operations with our Intelligent Supply for Legal. This AI-driven solution automates scenario planning with unprecedented accuracy and effic',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-supply-for-legal-89667f97',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Supply for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Intelligent Supply for Legal. This AI-driven solution automates scenario planning with unprecedented accuracy and efficiency.
          </p>
