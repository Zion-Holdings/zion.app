...
export const metadata: Metadata = {
  title: 'Management Intelligent - Transportation',
  description: 'Transform your transportation operations with our Management Intelligent - Transportation. This AI-driven solution provides intelligent automation with unpreced',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your transportation operations with our Management Intelligent - Transportation. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
