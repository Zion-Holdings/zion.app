...
export const metadata: Metadata = {
  title: 'Cognitive Compliance Solution - Hospitality',
  description: 'The future of hospitality is here with Cognitive Compliance Solution - Hospitality. Powered by cutting-edge AI, this platform delivers access management like ne',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-compliance-solution-hospitality-960a1c36',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Compliance Solution - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Cognitive Compliance Solution - Hospitality. Powered by cutting-edge AI, this platform delivers access management like never before.
          </p>
