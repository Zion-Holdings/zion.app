...
export const metadata: Metadata = {
  title: 'Cognitive Support for Tech',
  description: 'Next-generation technology solution: Cognitive Support for Tech. Combines feature engineering with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-support-for-tech-a9093940',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Support for Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation technology solution: Cognitive Support for Tech. Combines feature engineering with adaptive intelligence for optimal results.
          </p>
