...
export const metadata: Metadata = {
  ...
  description: 'Transform your hospitality operations with our Suite Intelligent - Hospitality. This AI-driven solution automates serverless deployment with unprecedented accur',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Suite Intelligent - Hospitality. This AI-driven solution automates serverless deployment with unprecedented accuracy and efficiency.
          </p>
