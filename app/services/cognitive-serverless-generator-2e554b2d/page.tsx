...
export const metadata: Metadata = {
  title: 'Cognitive Serverless Generator',
  description: 'Drive innovation in hospitality with Cognitive Serverless Generator. This AI-powered platform transforms predictive analytics into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-serverless-generator-2e554b2d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Serverless Generator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Cognitive Serverless Generator. This AI-powered platform transforms predictive analytics into a competitive advantage.
          </p>
