...
export const metadata: Metadata = {
  title: 'Enterprise Engine - Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Enterprise Engine - Healthcare leverages advanced machine learning to deliver customer onboarding a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Engine - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Enterprise Engine - Healthcare leverages advanced machine learning to deliver customer onboarding at scale.
          </p>
