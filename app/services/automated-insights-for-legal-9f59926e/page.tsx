...
export const metadata: Metadata = {
  title: 'Automated Insights for Legal',
  description: 'Unlock unprecedented growth with Automated Insights for Legal. This autonomous system provides image recognition with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-insights-for-legal-9f59926e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Insights for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Automated Insights for Legal. This autonomous system provides image recognition with zero manual intervention needed.
          </p>
