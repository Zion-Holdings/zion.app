...
export const metadata: Metadata = {
  title: 'Predictive Smart Engine - PROPTECH',
  description: 'Optimize your proptech workflows with Predictive Smart Engine - PROPTECH. This intelligent platform delivers benefits administration through advanced automation',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Smart Engine - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your proptech workflows with Predictive Smart Engine - PROPTECH. This intelligent platform delivers benefits administration through advanced automation and AI.
          </p>
