...
export const metadata: Metadata = {
  title: 'Smart Intelligent Platform - Construction #1',
  description: 'Transform your construction operations with our Smart Intelligent Platform - Construction #1. This AI-driven solution automates data governance with unprecedent',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-intelligent-platform-construction-1-9825dd52',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Intelligent Platform - Construction #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Smart Intelligent Platform - Construction #1. This AI-driven solution automates data governance with unprecedented accuracy and efficiency.
          </p>
