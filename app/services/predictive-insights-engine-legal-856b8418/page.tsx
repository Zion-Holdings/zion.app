...
export const metadata: Metadata = {
  title: 'Predictive Insights Engine - Legal',
  description: 'Optimize your legal workflows with Predictive Insights Engine - Legal. This intelligent platform delivers serverless deployment through advanced automation and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-insights-engine-legal-856b8418',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Insights Engine - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with Predictive Insights Engine - Legal. This intelligent platform delivers serverless deployment through advanced automation and AI.
          </p>
