...
export const metadata: Metadata = {
  title: 'Autonomous Energy for Automotive',
  description: 'The future of automotive is here with Autonomous Energy for Automotive. Powered by cutting-edge AI, this platform delivers healthcare data analytics like never ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-energy-for-automotive-ff220de2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Energy for Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of automotive is here with Autonomous Energy for Automotive. Powered by cutting-edge AI, this platform delivers healthcare data analytics like never before.
          </p>
