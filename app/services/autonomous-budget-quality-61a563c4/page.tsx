...
export const metadata: Metadata = {
  title: 'Autonomous Budget Quality',
  description: 'Transform your construction operations with our Autonomous Budget Quality. This AI-driven solution automates process automation with unprecedented accuracy and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-budget-quality-61a563c4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Budget Quality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Autonomous Budget Quality. This AI-driven solution automates process automation with unprecedented accuracy and efficiency.
          </p>
