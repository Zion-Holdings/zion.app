...
export const metadata: Metadata = {
  title: 'Cognitive Security for Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Cognitive Security for Hospitality leverages advanced machine learning to deliver maintenance sche',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-security-for-hospitality-7b1d8330',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Security for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Cognitive Security for Hospitality leverages advanced machine learning to deliver maintenance scheduling at scale.
          </p>
