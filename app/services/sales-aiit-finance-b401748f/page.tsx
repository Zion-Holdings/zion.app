...
export const metadata: Metadata = {
  title: 'Sales AI/IT - Finance',
  description: 'The future of finance is here with Sales AI/IT - Finance. Powered by cutting-edge AI, this platform delivers customer service automation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/sales-aiit-finance-b401748f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of finance is here with Sales AI/IT - Finance. Powered by cutting-edge AI, this platform delivers customer service automation like never before.
          </p>
