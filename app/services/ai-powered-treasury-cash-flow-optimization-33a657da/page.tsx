...
export const metadata: Metadata = {
  title: 'AI-Powered Treasury Cash Flow Optimization',
  description: 'Dynamic cash flow forecasting and optimization using machine learning. Predicts cash needs 90 days out with 95% accuracy.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-treasury-cash-flow-optimization-33a657da',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Treasury Cash Flow Optimization
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Dynamic cash flow forecasting and optimization using machine learning. Predicts cash needs 90 days out with 95% accuracy.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Cash flow forecasting</li>
          <li className="text-gray-300">Liquidity optimization</li>
