...
export const metadata: Metadata = {
  title: 'Director Next-Gen - Construction',
  description: 'Drive innovation in construction with Director Next-Gen - Construction. This AI-powered platform transforms customer journey mapping into a competitive advantag',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/director-next-gen-construction-76806064',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Director Next-Gen - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Director Next-Gen - Construction. This AI-powered platform transforms customer journey mapping into a competitive advantage.
          </p>
