...
export const metadata = {
  ...
  description: "Unlock unprecedented growth with Cognitive monitoring-agriculture. This autonomous system provides customer service automation with zero manual intervention nee",
  alternates: {
