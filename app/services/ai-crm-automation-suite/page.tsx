      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Full CRM automation platform: AI lead scoring, email sequences, pipeline tracking, deal insights, automated follow-ups, and smart forecasting across HubSpot, Salesforce, and Pipedrive.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ AI lead scoring + prioritization</li>
            <li className="text-purple-300">✓ Automated email sequences & drips</li>
            <li className="text-purple-300">✓ Pipeline tracking + stage automation</li>
            <li className="text-purple-300">✓ Conversation intelligence & call coach</li>
            <li className="text-purple-300">✓ Native HS / SF / Zoho integrations</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai crm automation suite</li>
