...
export const metadata: Metadata = {
  ...
  keywords: 'AI lead scoring + prioritization, Automated email sequences & drips, Pipeline tracking + stage automation, Conversation intelligence & call coach, Native HS / SF / Zoho integrations, ai, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI CRM Automation Suite</h1>
        <p className="text-lg text-slate-300 mb-8">Full CRM automation platform: AI lead scoring, email sequences, pipeline tracking, deal insights, automated follow-ups, and smart forecasting across HubSpot, Salesforce, and Pipedrive.</p>
        ...
        <li class="text-slate-300">AI lead scoring + prioritization</li>
        <li class="text-slate-300">Automated email sequences &amp; drips</li>
        <li class="text-slate-300">Pipeline tracking + stage automation</li>
        <li class="text-slate-300">Conversation intelligence &amp; call coach</li>
        <li class="text-slate-300">Native HS / SF / Zoho integrations</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai crm automation suite</li>
