...
export const metadata: Metadata = {
  title: 'Enterprise Performance Platform - ALTHEALTH',
  description: 'Next-generation althealth solution: Enterprise Performance Platform - ALTHEALTH. Combines roi tracking with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-performance-platform-althealth-c0dc1afb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Performance Platform - ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation althealth solution: Enterprise Performance Platform - ALTHEALTH. Combines roi tracking with adaptive intelligence for optimal results.
          </p>
