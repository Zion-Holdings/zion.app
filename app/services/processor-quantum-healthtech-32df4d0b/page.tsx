...
export const metadata: Metadata = {
  title: 'Processor Quantum - HEALTHTECH',
  description: 'Drive innovation in healthtech with Processor Quantum - HEALTHTECH. This AI-powered platform transforms talent acquisition into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/processor-quantum-healthtech-32df4d0b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Processor Quantum - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthtech with Processor Quantum - HEALTHTECH. This AI-powered platform transforms talent acquisition into a competitive advantage.
          </p>
