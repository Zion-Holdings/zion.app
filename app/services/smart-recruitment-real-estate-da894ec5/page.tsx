...
export const metadata: Metadata = {
  title: 'Smart Recruitment Real Estate',
  description: 'Enhance your agriculture business with Smart Recruitment Real Estate. Our solution provides forecast accuracy with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-recruitment-real-estate-da894ec5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Recruitment Real Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your agriculture business with Smart Recruitment Real Estate. Our solution provides forecast accuracy with enterprise-grade reliability and security.
          </p>
