...
export const metadata: Metadata = {
  title: 'AI Support - Healthcare Edition',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Support - Healthcare Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your healthcare with AI Support - Healthcare Edition. Our autonomous solution handles quality control end-to-end without human intervention.
          </p>
