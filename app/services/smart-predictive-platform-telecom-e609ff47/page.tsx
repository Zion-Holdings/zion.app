...
export const metadata: Metadata = {
  title: 'Smart Predictive Platform - Telecom',
  description: 'Enhance your telecom business with Smart Predictive Platform - Telecom. Our solution provides predictive analytics with enterprise-grade reliability and securit',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Predictive Platform - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your telecom business with Smart Predictive Platform - Telecom. Our solution provides predictive analytics with enterprise-grade reliability and security.
          </p>
