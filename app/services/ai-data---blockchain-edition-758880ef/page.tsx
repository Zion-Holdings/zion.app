...
export const metadata: Metadata = {
  title: 'AI Data - Blockchain Edition',
  description: 'The future of blockchain is here with AI Data - Blockchain Edition. Powered by cutting-edge AI, this platform delivers healthcare data analytics like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-data---blockchain-edition-758880ef',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Data - Blockchain Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of blockchain is here with AI Data - Blockchain Edition. Powered by cutting-edge AI, this platform delivers healthcare data analytics like never before.
          </p>
