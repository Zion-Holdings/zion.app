...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-tier supplier risk scoring, Geopolitical and natural disaster monitoring, Supplier financial health analysis, Alternative supplier recommendations, Demand forecasting with ML, Logistics route optimization, Real-time shipment tracking, Scenario modeling, ai, logistics, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Monitor and predict supply chain disruptions using AI. Analyze geopolitical events, weather patterns, supplier financial health, and logistics data.</p>
        ...
        <li class="text-slate-300">Multi-tier supplier risk scoring</li>
        <li class="text-slate-300">Geopolitical and natural disaster monitoring</li>
        <li class="text-slate-300">Supplier financial health analysis</li>
        <li class="text-slate-300">Alternative supplier recommendations</li>
        <li class="text-slate-300">Demand forecasting with ML</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Prevent supply chain disruptions</li>
        <li class="text-slate-300">Reduce procurement costs by 15-25%</li>
        <li class="text-slate-300">Diversify supplier base</li>
        <li class="text-slate-300">Improve on-time delivery</li>
      </ul>
        </div>
