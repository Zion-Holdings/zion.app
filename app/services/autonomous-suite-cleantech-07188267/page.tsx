...
export const metadata: Metadata = {
  title: 'Autonomous suite-cleantech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous suite-cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of cleantech is here with Autonomous suite-cleantech. Powered by cutting-edge AI, this platform delivers sales forecasting like never before.
          </p>
