...
export const metadata: Metadata = {
  title: 'Personalization Engine AI-Powered Market Intelligence',
  description: 'personalization engine solution for franchises industry. Monitors market trends, competitor activities, and industry news to provide actionable insights.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/personalization-engine-ai-powered-market-intelligence-e3f73e51',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Personalization Engine AI-Powered Market Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            personalization engine solution for franchises industry. Monitors market trends, competitor activities, and industry news to provide actionable insights.
          </p>
