...
export const metadata: Metadata = {
  ...
  description: 'Advanced healthcare analytics platform leveraging machine learning to AI diagnostics, patient data analytics, telemedicine automation. Provides real-time insigh',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-analytics-platform-for-healthcare-41e24e60',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Advanced healthcare analytics platform leveraging machine learning to AI diagnostics, patient data analytics, telemedicine automation. Provides real-time insights and predictive capabilities for strategic decision-making.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Enterprise-grade security</li>
          <li className="text-gray-300">24/7 monitoring</li>
          <li className="text-gray-300">API-first integration</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">38% reduction in operational costs</li>
          <li className="text-purple-300">Process 42% faster with automation</li>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$276</p>
          <ul className="space-y-2 mb-4">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$636</p>
          <ul className="space-y-2 mb-4">
