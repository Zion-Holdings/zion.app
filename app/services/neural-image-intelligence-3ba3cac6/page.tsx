...
export const metadata: Metadata = {
  title: 'Neural Image Intelligence',
  description: 'Transform your healthcare operations with our Neural Image Intelligence. This AI-driven solution automates fraud prevention with unprecedented accuracy and effi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-image-intelligence-3ba3cac6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Image Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Neural Image Intelligence. This AI-driven solution automates fraud prevention with unprecedented accuracy and efficiency.
          </p>
