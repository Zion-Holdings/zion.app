...
export const metadata: Metadata = {
  ...
  keywords: 'Graph database management (Neo4j, Neptune), Social network and influence analysis, Fraud ring and collusion detection, Recommendation and similarity graphs, Path optimization and shortest route, Graph visualization and exploration, API with Cypher and Gremlin query, data, Analytics, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Graph Analytics &amp; Network Intelligence</h1>
        <p className="text-lg text-slate-300 mb-8">Graph database and analytics: Neo4j/Neptune, social network analysis, fraud ring detection, recommendation graphs, and path optimization.</p>
        ...
        <li class="text-slate-300">Graph database management (Neo4j, Neptune)</li>
        <li class="text-slate-300">Social network and influence analysis</li>
        <li class="text-slate-300">Fraud ring and collusion detection</li>
        <li class="text-slate-300">Recommendation and similarity graphs</li>
        <li class="text-slate-300">Path optimization and shortest route</li>
        <li class="text-slate-300">Graph visualization and exploration</li>
        <li class="text-slate-300">API with Cypher and Gremlin query</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Detect fraud rings invisible to SQL</li>
        <li class="text-slate-300">Social network analysis for marketing</li>
        <li class="text-slate-300">Graph recommendations outperform collaborative filtering</li>
        <li class="text-slate-300">Path optimization for logistics and routing</li>
      </ul>
        </div>
