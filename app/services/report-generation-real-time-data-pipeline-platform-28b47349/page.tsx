...
export const metadata: Metadata = {
  title: 'Report Generation Real-Time Data Pipeline Platform',
  description: 'report generation solution for cultural heritage industry. Creates and manages real-time data pipelines with automated ETL and streaming analytics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/report-generation-real-time-data-pipeline-platform-28b47349',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Report Generation Real-Time Data Pipeline Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            report generation solution for cultural heritage industry. Creates and manages real-time data pipelines with automated ETL and streaming analytics.
          </p>
