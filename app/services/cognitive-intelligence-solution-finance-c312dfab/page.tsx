...
export const metadata: Metadata = {
  title: 'Cognitive Intelligence Solution - Finance',
  description: 'Enhance your finance business with Cognitive Intelligence Solution - Finance. Our solution provides budget optimization with enterprise-grade reliability and se',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-intelligence-solution-finance-c312dfab',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Intelligence Solution - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your finance business with Cognitive Intelligence Solution - Finance. Our solution provides budget optimization with enterprise-grade reliability and security.
          </p>
