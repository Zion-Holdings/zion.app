...
export const metadata: Metadata = {
  ...
  keywords: 'Millions of events/sec throughput, Sub-second query latency, SQL + Python analytics, Built-in anomaly detection, Kafka, Kinesis, Pub/Sub connectors, data, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Data Real-Time Streaming Analytics Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Process and analyze millions of events per second with sub-second latency. Supports Kafka, Kinesis, Pub/Sub with built-in windowing, joins, and anomaly detection.</p>
        ...
        <li class="text-slate-300">Millions of events/sec throughput</li>
        <li class="text-slate-300">Sub-second query latency</li>
        <li class="text-slate-300">SQL + Python analytics</li>
        <li class="text-slate-300">Built-in anomaly detection</li>
        <li class="text-slate-300">Kafka, Kinesis, Pub/Sub connectors</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Real-time business decisions</li>
        <li class="text-slate-300">Detect anomalies instantly</li>
        <li class="text-slate-300">Unify batch and streaming</li>
      </ul>
        </div>
