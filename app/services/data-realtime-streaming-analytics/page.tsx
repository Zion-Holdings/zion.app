    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Data Real-Time Streaming Analytics Platform
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          Process and analyze millions of events per second with sub-second latency. Supports Kafka, Kinesis, Pub/Sub with built-in windowing, joins, and anomaly detectio
        </p>
