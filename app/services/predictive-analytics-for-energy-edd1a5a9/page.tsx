...
export const metadata: Metadata = {
  ...
  description: 'The future of energy is here with Predictive Analytics for Energy. Powered by cutting-edge AI, this platform delivers process automation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-analytics-for-energy-edd1a5a9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Predictive Analytics for Energy. Powered by cutting-edge AI, this platform delivers process automation like never before.
          </p>
