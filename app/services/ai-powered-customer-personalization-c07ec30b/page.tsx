...
export const metadata: Metadata = {
  ...
  description: "Creates hyper-personalized shopping experiences using customer behavior, preferences, and demographics.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-customer-personalization-c07ec30b",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Service - AI-Powered Retail Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          Creates hyper-personalized shopping experiences using customer behavior, preferences, and demographics.
        </p>
