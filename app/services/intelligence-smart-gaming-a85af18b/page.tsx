...
export const metadata: Metadata = {
  title: 'Intelligence Smart - Gaming',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligence Smart - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your gaming business with Intelligence Smart - Gaming. Our solution provides quality control with enterprise-grade reliability and security.
          </p>
