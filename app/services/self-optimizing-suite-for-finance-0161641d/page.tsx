...
export const metadata = {
  ...
  description: "Revolutionize Finance through intelligent automation. Our Self-Optimizing Suite for Finance leverages advanced machine learning to deliver sentiment analysis at",
  alternates: {
