...
export const metadata: Metadata = {
  ...
  description: 'The future of logistics is here with Intelligent Processor for Logistics. Powered by cutting-edge AI, this platform delivers content moderation like never befor',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Intelligent Processor for Logistics. Powered by cutting-edge AI, this platform delivers content moderation like never before.
          </p>
