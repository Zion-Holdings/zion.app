...
export const metadata: Metadata = {
  ...
  keywords: 'IoT sensor data ingestion & real-time monitoring, ML-based remaining useful life (RUL) prediction, Anomaly detection for early fault signatures, Automated maintenance scheduling & work order generation, Fleet-wide asset health dashboards, Integration with CMMS, SAP, and ERP systems, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Predictive Maintenance &amp; Asset Monitoring</h1>
        <p className="text-lg text-slate-300 mb-8">IoT-enabled predictive maintenance that monitors equipment health in real time, predicts failures before they happen, and optimizes maintenance schedules to reduce downtime.</p>
        ...
        <li class="text-slate-300">IoT sensor data ingestion &amp; real-time monitoring</li>
        <li class="text-slate-300">ML-based remaining useful life (RUL) prediction</li>
        <li class="text-slate-300">Anomaly detection for early fault signatures</li>
        <li class="text-slate-300">Automated maintenance scheduling &amp; work order generation</li>
        <li class="text-slate-300">Fleet-wide asset health dashboards</li>
        <li class="text-slate-300">Integration with CMMS, SAP, and ERP systems</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai predictive maintenance &amp; asset monitoring</li>
