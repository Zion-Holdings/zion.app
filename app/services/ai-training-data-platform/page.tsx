...
export const metadata: Metadata = {
  ...
  keywords: 'Labeling workforce + tools, Active learning loop, Dataset versioning, Consensus / quality scoring, Synthetic data generation, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Training Data Platform</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end data labeling, annotation, versioning, and quality validation platform for computer vision, NLP, and LLM fine-tuning datasets at any scale.</p>
        ...
        <li class="text-slate-300">Labeling workforce + tools</li>
        <li class="text-slate-300">Active learning loop</li>
        <li class="text-slate-300">Dataset versioning</li>
        <li class="text-slate-300">Consensus / quality scoring</li>
        <li class="text-slate-300">Synthetic data generation</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai training data platform</li>
