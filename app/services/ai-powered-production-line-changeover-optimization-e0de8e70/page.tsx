...
export const metadata: Metadata = {
  title: 'AI-Powered Production Line Changeover Optimization',
  description: 'Optimizes changeover times with AI and scheduling.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-production-line-changeover-optimization-e0de8e70',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Production Line Changeover Optimization
          </h1>
