...
export const metadata: Metadata = {
  title: 'Intelligent Fraud for Tech',
  description: 'Unlock unprecedented growth with Intelligent Fraud for Tech. This autonomous system provides threat detection with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-fraud-for-tech-1eff7bc1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Fraud for Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Fraud for Tech. This autonomous system provides threat detection with zero manual intervention needed.
          </p>
