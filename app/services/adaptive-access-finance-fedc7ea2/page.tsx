...
export const metadata: Metadata = {
  title: 'Adaptive Access Finance',
  description: 'The future of energy is here with Adaptive Access Finance. Powered by cutting-edge AI, this platform delivers resource optimization like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-access-finance-fedc7ea2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Access Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Adaptive Access Finance. Powered by cutting-edge AI, this platform delivers resource optimization like never before.
          </p>
