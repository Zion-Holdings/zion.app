...
export const metadata: Metadata = {
  title: 'Automated process mining-education',
  description: 'The future of education is here with Automated process mining-education. Powered by cutting-edge AI, this platform delivers transformative results like never be',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated process mining-education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of education is here with Automated process mining-education. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
