...
export const metadata: Metadata = {
  title: 'AI Orchestrator - HEALTHTECH Edition',
  description: 'Revolutionize healthtech through intelligent automation. Our AI Orchestrator - HEALTHTECH Edition leverages advanced machine learning to deliver business contin',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-orchestrator-healthtech-edition-254d4aa0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Orchestrator - HEALTHTECH Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthtech through intelligent automation. Our AI Orchestrator - HEALTHTECH Edition leverages advanced machine learning to deliver business continuity at scale.
          </p>
