...
export const metadata: Metadata = {
  title: 'Real Estate Smart - Education',
  description: 'Revolutionize education through intelligent automation. Our Real Estate Smart - Education leverages advanced machine learning to deliver ml model training at sc',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Real Estate Smart - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize education through intelligent automation. Our Real Estate Smart - Education leverages advanced machine learning to deliver ml model training at scale.
          </p>
