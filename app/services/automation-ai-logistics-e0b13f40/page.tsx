...
export const metadata: Metadata = {
  title: 'Automation AI - Logistics',
  description: 'Enhance your logistics business with Automation AI - Logistics. Our solution provides forecast accuracy with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automation-ai-logistics-e0b13f40',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with Automation AI - Logistics. Our solution provides forecast accuracy with enterprise-grade reliability and security.
          </p>
