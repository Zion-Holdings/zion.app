...
export const metadata: Metadata = {
  ...
  description: 'Optimize your agriculture workflows with Intelligent Analyzer for Agriculture. This intelligent platform delivers sourcing optimization through advanced automat',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your agriculture workflows with Intelligent Analyzer for Agriculture. This intelligent platform delivers sourcing optimization through advanced automation and AI.
          </p>
