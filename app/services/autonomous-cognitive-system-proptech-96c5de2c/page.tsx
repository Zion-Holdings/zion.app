...
export const metadata: Metadata = {
  title: 'Autonomous Cognitive System - PROPTECH',
  description: 'Drive innovation in proptech with Autonomous Cognitive System - PROPTECH. This AI-powered platform transforms form processing into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-cognitive-system-proptech-96c5de2c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Cognitive System - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in proptech with Autonomous Cognitive System - PROPTECH. This AI-powered platform transforms form processing into a competitive advantage.
          </p>
