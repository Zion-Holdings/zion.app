...
export const metadata: Metadata = {
  title: 'Smart Support Platform - Legal',
  description: 'Transform your legal operations with our Smart Support Platform - Legal. This AI-driven solution automates process automation with unprecedented accuracy and ef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-support-platform-legal-b7b55412',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Support Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Smart Support Platform - Legal. This AI-driven solution automates process automation with unprecedented accuracy and efficiency.
          </p>
