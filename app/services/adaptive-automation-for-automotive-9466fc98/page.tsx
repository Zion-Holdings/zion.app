...
export const metadata: Metadata = {
  title: 'Adaptive Automation for Automotive',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Automation for Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation automotive solution: Adaptive Automation for Automotive. Combines logistics route optimization with adaptive intelligence for optimal results.
          </p>
