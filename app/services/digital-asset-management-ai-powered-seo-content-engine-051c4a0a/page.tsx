...
export const metadata: Metadata = {
  ...
  description: 'digital asset management solution for aerospace industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing co',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/digital-asset-management-ai-powered-seo-content-engine-051c4a0a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            digital asset management solution for aerospace industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing copy.
          </p>
