...
export const metadata: Metadata = {
  title: 'Autonomous Scheduler Engine',
  description: 'Transform your construction operations with our Autonomous Scheduler Engine. This automation solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-scheduler-engine-5b274',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Autonomous Scheduler Engine. This automation solution delivers unprecedented automation and intelligence.
          </p>
