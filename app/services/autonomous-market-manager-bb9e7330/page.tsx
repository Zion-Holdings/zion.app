...
export const metadata: Metadata = {
  title: 'Autonomous Market Manager',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of cleantech is here with Autonomous Market Manager. Powered by cutting-edge AI, this platform delivers supply chain like never before.
          </p>
