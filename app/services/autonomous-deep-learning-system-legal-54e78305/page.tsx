...
export const metadata: Metadata = {
  title: 'Autonomous Deep Learning System - Legal',
  description: 'The future of legal is here with Autonomous Deep Learning System - Legal. Powered by cutting-edge AI, this platform delivers lead scoring like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-deep-learning-system-legal-54e78305',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Deep Learning System - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Autonomous Deep Learning System - Legal. Powered by cutting-edge AI, this platform delivers lead scoring like never before.
          </p>
