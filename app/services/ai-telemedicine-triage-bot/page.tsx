...
export const metadata: Metadata = {
  ...
  keywords: 'Conversational symptom collection, Emergency triage (ESI scoring), Pre-visit summary generation, Specialist auto-referral, EHR integration (Epic, Cerner), Multi-language support (20+), ai, Healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Telemedicine Triage &amp; Pre-Visit Assistant</h1>
        <p className="text-lg text-slate-300 mb-8">Patient intake AI: symptom collection, urgency triage, pre-visit summary generation, and specialist routing. Integrates with Epic, Cerner, Allscripts. Reduces admin time by 60%.</p>
        ...
        <li class="text-slate-300">Conversational symptom collection</li>
        <li class="text-slate-300">Emergency triage (ESI scoring)</li>
        <li class="text-slate-300">Pre-visit summary generation</li>
        <li class="text-slate-300">Specialist auto-referral</li>
        <li class="text-slate-300">EHR integration (Epic, Cerner)</li>
        <li class="text-slate-300">Multi-language support (20+)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce admin time by 60%</li>
        <li class="text-slate-300">Ensure proper triage</li>
        <li class="text-slate-300">Seamless EHR documentation</li>
      </ul>
        </div>
