...
export const metadata: Metadata = {
  title: 'AI/IT Computer Vision Suite - Cybersecurity',
  description: 'Revolutionize cybersecurity through intelligent automation. Our AI/IT Computer Vision Suite - Cybersecurity leverages advanced machine learning to deliver senti',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-computer-vision-suite-cybersecurity-45039512',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Computer Vision Suite - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cybersecurity through intelligent automation. Our AI/IT Computer Vision Suite - Cybersecurity leverages advanced machine learning to deliver sentiment analysis at scale.
          </p>
