      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent AI - Media #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your media workflows with Intelligent AI - Media #1. This intelligent platform delivers account planning through advanced automation and AI.
          </p>
