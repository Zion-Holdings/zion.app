...
export const metadata: Metadata = {
  title: 'Intelligent support-energy',
  description: 'Revolutionize energy through intelligent automation. Our Intelligent support-energy leverages advanced machine learning to deliver enterprise-grade insights at ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-support-energy-18c96736',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent support-energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Intelligent support-energy leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
