...
export const metadata: Metadata = {
  title: 'AI-Powered Optimization for Construction',
  description: 'The future of construction is here with AI-Powered Optimization for Construction. Powered by cutting-edge AI, this platform delivers sales process optimization ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-optimization-for-construction-d7fbe742',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Optimization for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with AI-Powered Optimization for Construction. Powered by cutting-edge AI, this platform delivers sales process optimization like never before.
          </p>
