...
export const metadata: Metadata = {
  ...
  keywords: 'Intelligent clause extraction and classification, Risk scoring and compliance flagging, Contract comparison and gap analysis, Legal precedent research automation, Multi-language contract processing, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Legal Document Analysis &amp; Contract Review</h1>
        <p className="text-lg text-slate-300 mb-8">Automated legal document review, clause extraction, risk assessment, and contract comparison powered by advanced NLP trained on legal corpora.</p>
        ...
        <li class="text-slate-300">Intelligent clause extraction and classification</li>
        <li class="text-slate-300">Risk scoring and compliance flagging</li>
        <li class="text-slate-300">Contract comparison and gap analysis</li>
        <li class="text-slate-300">Legal precedent research automation</li>
        <li class="text-slate-300">Multi-language contract processing</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai legal document analysis &amp; contract review</li>
