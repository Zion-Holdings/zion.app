      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Automated legal document review, clause extraction, risk assessment, and contract comparison powered by advanced NLP trained on legal corpora.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Intelligent clause extraction and classification</li>
            <li className="text-purple-300">✓ Risk scoring and compliance flagging</li>
            <li className="text-purple-300">✓ Contract comparison and gap analysis</li>
            <li className="text-purple-300">✓ Legal precedent research automation</li>
            <li className="text-purple-300">✓ Multi-language contract processing</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai legal document analysis & contract review</li>
