...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Cognitive - Sports',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Cognitive - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for sports: Hyper-Accelerated Cognitive - Sports. Uses quantum-inspired algorithms to deliver hr analytics at exponential speed.
          </p>
