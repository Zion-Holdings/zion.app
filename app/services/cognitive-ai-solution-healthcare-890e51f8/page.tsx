...
export const metadata: Metadata = {
  title: 'Cognitive AI Solution - Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Cognitive AI Solution - Healthcare leverages advanced machine learning to deliver disaster recovery',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive AI Solution - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Cognitive AI Solution - Healthcare leverages advanced machine learning to deliver disaster recovery at scale.
          </p>
