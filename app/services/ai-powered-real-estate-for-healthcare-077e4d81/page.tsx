...
export const metadata: Metadata = {
  title: 'AI-Powered Real Estate for Healthcare',
  description: 'The future of healthcare is here with AI-Powered Real Estate for Healthcare. Powered by cutting-edge AI, this platform delivers maintenance scheduling like neve',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-real-estate-for-healthcare-077e4d81',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Real Estate for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with AI-Powered Real Estate for Healthcare. Powered by cutting-edge AI, this platform delivers maintenance scheduling like never before.
          </p>
