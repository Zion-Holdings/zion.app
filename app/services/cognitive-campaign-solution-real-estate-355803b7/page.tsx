...
export const metadata: Metadata = {
  title: 'Cognitive Campaign Solution - Real-Estate',
  description: 'Transform your real-estate operations with our Cognitive Campaign Solution - Real-Estate. This AI-driven solution automates data governance with unprecedented a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-campaign-solution-real-estate-355803b7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Campaign Solution - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Cognitive Campaign Solution - Real-Estate. This AI-driven solution automates data governance with unprecedented accuracy and efficiency.
          </p>
