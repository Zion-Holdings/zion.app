...
export const metadata: Metadata = {
  title: 'AI Sales - Construction Edition',
  description: 'Drive innovation in construction with AI Sales - Construction Edition. This AI-powered platform transforms disaster recovery into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-sales-construction-edition-a1fa5421',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Sales - Construction Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with AI Sales - Construction Edition. This AI-powered platform transforms disaster recovery into a competitive advantage.
          </p>
