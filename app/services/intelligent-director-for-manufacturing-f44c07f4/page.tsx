...
export const metadata: Metadata = {
  title: 'Intelligent Director for Manufacturing',
  description: 'The future of manufacturing is here with Intelligent Director for Manufacturing. Powered by cutting-edge AI, this platform delivers maintenance scheduling like ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-director-for-manufacturing-f44c07f4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Director for Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of manufacturing is here with Intelligent Director for Manufacturing. Powered by cutting-edge AI, this platform delivers maintenance scheduling like never before.
          </p>
