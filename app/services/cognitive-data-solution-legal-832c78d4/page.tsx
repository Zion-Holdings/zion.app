...
export const metadata: Metadata = {
  title: 'Cognitive Data Solution - Legal',
  description: 'Transform your legal operations with our Cognitive Data Solution - Legal. This AI-driven solution automates sentiment analysis with unprecedented accuracy and e',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-data-solution-legal-832c78d4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Data Solution - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Cognitive Data Solution - Legal. This AI-driven solution automates sentiment analysis with unprecedented accuracy and efficiency.
          </p>
