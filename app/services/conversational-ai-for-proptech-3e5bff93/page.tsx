...
export const metadata = {
  title: "Conversational AI for Proptech - Zion Tech Group",
  description: "Natural language processing system that handles proptech inquiries through intelligent chatbots.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/conversational-ai-for-proptech-3e5bff93`
  }
};
