...
export const metadata: Metadata = {
  title: 'Smart Process Healthcare',
  description: 'Next-generation construction solution: Smart Process Healthcare. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-process-healthcare-420c6c75',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Process Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Smart Process Healthcare. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
