...
export const metadata: Metadata = {
  title: 'Platform Cognitive - Finance',
  description: 'Optimize your finance workflows with Platform Cognitive - Finance. This intelligent platform delivers training optimization through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/platform-cognitive-finance-b1afde25',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Platform Cognitive - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your finance workflows with Platform Cognitive - Finance. This intelligent platform delivers training optimization through advanced automation and AI.
          </p>
