...
export const metadata: Metadata = {
  title: 'Automated Platform for Quantum',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Platform for Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation quantum solution: Automated Platform for Quantum. Combines healthcare data analytics with adaptive intelligence for optimal results.
          </p>
