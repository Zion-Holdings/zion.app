...
export const metadata: Metadata = {
  title: 'Automated process mining-logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Automated process mining-logistics leverages advanced machine learning to deliver enterprise-grade i',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-process-mining-logistics-603b92bf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated process mining-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Automated process mining-logistics leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
