...
export const metadata: Metadata = {
  title: 'Intelligent manufacturing-automotive',
  description: 'Next-generation automotive solution: Intelligent manufacturing-automotive. Combines executive dashboards with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-manufacturing-automotive-e71d1490',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent manufacturing-automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation automotive solution: Intelligent manufacturing-automotive. Combines executive dashboards with adaptive intelligence for optimal results.
          </p>
