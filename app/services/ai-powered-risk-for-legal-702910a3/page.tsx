...
export const metadata: Metadata = {
  title: 'AI-Powered Risk for Legal',
  description: 'The future of legal is here with AI-Powered Risk for Legal. Powered by cutting-edge AI, this platform delivers threat detection like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-risk-for-legal-702910a3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Risk for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with AI-Powered Risk for Legal. Powered by cutting-edge AI, this platform delivers threat detection like never before.
          </p>
