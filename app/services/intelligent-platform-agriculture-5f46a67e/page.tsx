...
export const metadata: Metadata = {
  title: 'Intelligent platform-agriculture',
  description: 'Unlock unprecedented growth with Intelligent platform-agriculture. This autonomous system provides master data management with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-platform-agriculture-5f46a67e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent platform-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent platform-agriculture. This autonomous system provides master data management with zero manual intervention needed.
          </p>
