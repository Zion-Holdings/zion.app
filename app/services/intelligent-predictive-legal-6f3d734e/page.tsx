...
export const metadata: Metadata = {
  title: 'Intelligent Predictive - Legal',
  description: 'Unlock unprecedented growth with Intelligent Predictive - Legal. This autonomous system provides invoice processing with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-predictive-legal-6f3d734e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Predictive - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Predictive - Legal. This autonomous system provides invoice processing with zero manual intervention needed.
          </p>
