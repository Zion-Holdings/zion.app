...
export const metadata: Metadata = {
  title: 'Adaptive Quality for Media',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation media solution: Adaptive Quality for Media. Combines risk assessment with adaptive intelligence for optimal results.
          </p>
