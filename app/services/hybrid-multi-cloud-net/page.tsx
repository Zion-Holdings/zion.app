...
export const metadata: Metadata = {
  ...
  keywords: 'Cross-cloud VPC peering + VPN mesh, Transit Gateway/Cloud Router centralized routing, Cloud firewall + centralized egress, Istio/Linkerd cross-cloud service mesh, Centralized observability per cross-cloud request, cloud, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Hybrid Multi-Cloud Networking</h1>
        <p className="text-lg text-slate-300 mb-8">Unified networking across private DC + public clouds: VPC peering, VPN/Direct Connect/Interconnect, centralized routing, cloud firewall, Istio/Linkerd cross-cloud mesh.</p>
        ...
        <li class="text-slate-300">Cross-cloud VPC peering + VPN mesh</li>
        <li class="text-slate-300">Transit Gateway/Cloud Router centralized routing</li>
        <li class="text-slate-300">Cloud firewall + centralized egress</li>
        <li class="text-slate-300">Istio/Linkerd cross-cloud service mesh</li>
        <li class="text-slate-300">Centralized observability per cross-cloud request</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with hybrid multi-cloud networking</li>
