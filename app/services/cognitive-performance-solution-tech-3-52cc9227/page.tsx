...
export const metadata: Metadata = {
  title: 'Cognitive Performance Solution - Tech #3',
  description: 'The future of technology is here with Cognitive Performance Solution - Tech #3. Powered by cutting-edge AI, this platform delivers procurement automation like n',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Performance Solution - Tech #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of technology is here with Cognitive Performance Solution - Tech #3. Powered by cutting-edge AI, this platform delivers procurement automation like never before.
          </p>
