      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Multi-modal moderation (text/image/video): NSFW, hate-speech, PII, copyright, brand-safety classifier; moderation queue + human-review.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Text/image/video multi-modal classifier</li>
            <li className="text-purple-300">✓ NSFW + hate-speech + PII + copyright tagging</li>
            <li className="text-purple-300">✓ Auto-approve with confidence score threshold</li>
            <li className="text-purple-300">✓ Moderation queue + human-review escalations</li>
            </ul>
          </div>
