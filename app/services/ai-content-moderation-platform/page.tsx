...
export const metadata: Metadata = {
  ...
  keywords: 'Text/image/video multi-modal classifier, NSFW + hate-speech + PII + copyright tagging, Auto-approve with confidence score threshold, Moderation queue + human-review escalations, ai, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Multi-modal moderation (text/image/video): NSFW, hate-speech, PII, copyright, brand-safety classifier; moderation queue + human-review.</p>
        ...
        <li class="text-slate-300">Text/image/video multi-modal classifier</li>
        <li class="text-slate-300">NSFW + hate-speech + PII + copyright tagging</li>
        <li class="text-slate-300">Auto-approve with confidence score threshold</li>
        <li class="text-slate-300">Moderation queue + human-review escalations</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai content moderation platform</li>
