...
export const metadata: Metadata = {
  title: 'AI AI-Powered Business Intelligence',
  description: 'AI-powered ai solution for bi. Automated BI report generation and insight discovery.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-ai-powered-business-intelligence-d2a18305',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            AI-powered ai solution for bi. Automated BI report generation and insight discovery.
          </p>
