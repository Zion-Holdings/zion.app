...
export const metadata: Metadata = {
  ...
  description: 'The future of energy is here with Smart Workflow Generator. Powered by cutting-edge AI, this platform delivers manufacturing quality control like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-workflow-generator-4be27a0e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Smart Workflow Generator. Powered by cutting-edge AI, this platform delivers manufacturing quality control like never before.
          </p>
