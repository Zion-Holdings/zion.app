...
export const metadata: Metadata = {
  title: 'Enterprise Finance Platform - Automotive',
  description: 'Optimize your automotive workflows with Enterprise Finance Platform - Automotive. This intelligent platform delivers incident response through advanced automati',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-finance-platform-automotive-80811816',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Finance Platform - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your automotive workflows with Enterprise Finance Platform - Automotive. This intelligent platform delivers incident response through advanced automation and AI.
          </p>
