...
export const metadata: Metadata = {
  ...
  keywords: 'Auto-generated from OpenAPI 3.x specs, Interactive try-it-out console, Code samples in 10+ languages, GraphQL schema documentation, Versioning and changelog, Custom branding and domain, Search and navigation, micro-saas, Developer Tools, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">APIDocs — Interactive API Documentation</h1>
        <p className="text-lg text-slate-300 mb-8">Beautiful, interactive API documentation with try-it-out consoles, code samples in 10+ languages, and auto-generated from OpenAPI/GraphQL schemas.</p>
        ...
        <li class="text-slate-300">Auto-generated from OpenAPI 3.x specs</li>
        <li class="text-slate-300">Interactive try-it-out console</li>
        <li class="text-slate-300">Code samples in 10+ languages</li>
        <li class="text-slate-300">GraphQL schema documentation</li>
        <li class="text-slate-300">Versioning and changelog</li>
        <li class="text-slate-300">Custom branding and domain</li>
        <li class="text-slate-300">Search and navigation</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Interactive docs reduce API support tickets by 50%</li>
        <li class="text-slate-300">Code samples in every language accelerate integration</li>
        <li class="text-slate-300">Auto-generated stays in sync with your API</li>
        <li class="text-slate-300">Custom branding for developer portals</li>
      </ul>
        </div>
