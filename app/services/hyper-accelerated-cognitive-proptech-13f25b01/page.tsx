...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Cognitive - PROPTECH',
  description: 'Quantum leap forward for proptech: Hyper-Accelerated Cognitive - PROPTECH. Uses quantum-inspired algorithms to deliver pipeline management at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/hyper-accelerated-cognitive-proptech-13f25b01',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Cognitive - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for proptech: Hyper-Accelerated Cognitive - PROPTECH. Uses quantum-inspired algorithms to deliver pipeline management at exponential speed.
          </p>
