...
export const metadata: Metadata = {
  title: 'Intelligent Fleet Predictor',
  description: 'Drive innovation in transportation with Intelligent Fleet Predictor. This AI-powered platform transforms predictive analytics into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-fleet-predictor-4338faa4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Fleet Predictor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in transportation with Intelligent Fleet Predictor. This AI-powered platform transforms predictive analytics into a competitive advantage.
          </p>
