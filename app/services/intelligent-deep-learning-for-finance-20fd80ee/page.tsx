...
export const metadata: Metadata = {
  title: 'Intelligent Deep Learning for Finance',
  description: 'Transform your finance operations with our Intelligent Deep Learning for Finance. This AI-driven solution automates testing automation with unprecedented accura',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Deep Learning for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Intelligent Deep Learning for Finance. This AI-driven solution automates testing automation with unprecedented accuracy and efficiency.
          </p>
