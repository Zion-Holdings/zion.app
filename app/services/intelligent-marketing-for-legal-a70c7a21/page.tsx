...
export const metadata: Metadata = {
  title: 'Intelligent Marketing for Legal',
  description: 'Transform your legal operations with our Intelligent Marketing for Legal. This AI-driven solution automates energy management with unprecedented accuracy and ef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-marketing-for-legal-a70c7a21',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Marketing for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Intelligent Marketing for Legal. This AI-driven solution automates energy management with unprecedented accuracy and efficiency.
          </p>
