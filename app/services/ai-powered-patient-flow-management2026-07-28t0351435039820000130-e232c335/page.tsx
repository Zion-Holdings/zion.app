...
export const metadata: Metadata = {
  ...
  description: 'Manages patient flow with prediction and resource allocation.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-patient-flow-management2026-07-28t0351435039820000130-e232c335',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Manages patient flow with prediction and resource allocation.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Patient flow</li>
          <li className="text-gray-300">Prediction</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">25% better flow</li>
