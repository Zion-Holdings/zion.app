...
export const metadata: Metadata = {
  title: 'Cognitive Business DevOps',
  description: 'Next-generation healthcare solution: Cognitive Business DevOps. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-business-devops-319905ec',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Business DevOps
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Cognitive Business DevOps. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
