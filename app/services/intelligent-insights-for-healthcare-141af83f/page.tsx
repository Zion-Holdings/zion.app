...
export const metadata: Metadata = {
  title: 'Intelligent Insights for Healthcare',
  description: 'Transform your healthcare operations with our Intelligent Insights for Healthcare. This AI-driven solution automates predictive modeling with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-insights-for-healthcare-141af83f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Insights for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Intelligent Insights for Healthcare. This AI-driven solution automates predictive modeling with unprecedented accuracy and efficiency.
          </p>
