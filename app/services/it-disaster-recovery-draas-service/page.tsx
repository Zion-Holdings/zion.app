...
export const metadata: Metadata = {
  ...
  keywords: 'Continuous data replication to secure cloud, Automated failover with sub-minute RTO, Non-disruptive DR testing, Ransomware detection and immutable backups, Multi-region failover orchestration, Compliance-ready recovery documentation, 24/7 monitoring and incident response, Customizable RPO per workload tier, it, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Cloud-based disaster recovery with automated failover, continuous replication, and guaranteed RTO/RPO.</p>
        ...
        <li class="text-slate-300">Continuous data replication to secure cloud</li>
        <li class="text-slate-300">Automated failover with sub-minute RTO</li>
        <li class="text-slate-300">Non-disruptive DR testing</li>
        <li class="text-slate-300">Ransomware detection and immutable backups</li>
        <li class="text-slate-300">Multi-region failover orchestration</li>
        <li class="text-slate-300">Compliance-ready recovery documentation</li>
        <li class="text-slate-300">24/7 monitoring and incident response</li>
        <li class="text-slate-300">Customizable RPO per workload tier</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Achieve 99.99% uptime</li>
        <li class="text-slate-300">Reduce DR costs by 60%</li>
        <li class="text-slate-300">Test recovery without impacting production</li>
        <li class="text-slate-300">Meet regulatory DR requirements</li>
      </ul>
        </div>
