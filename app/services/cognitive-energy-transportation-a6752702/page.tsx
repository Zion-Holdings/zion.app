...
export const metadata: Metadata = {
  title: 'Cognitive energy-transportation',
  description: 'Transform transportation with Cognitive energy-transportation - the intelligent automation platform that learns, adapts, and delivers 10x results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-energy-transportation-a6752702',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive energy-transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform transportation with Cognitive energy-transportation - the intelligent automation platform that learns, adapts, and delivers 10x results.
          </p>
