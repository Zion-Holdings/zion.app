...
export const metadata: Metadata = {
  title: 'Autonomous Risk for Telecom',
  description: 'Unlock unprecedented growth with Autonomous Risk for Telecom. This autonomous system provides financial planning with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-risk-for-telecom-61575b46',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Risk for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Autonomous Risk for Telecom. This autonomous system provides financial planning with zero manual intervention needed.
          </p>
