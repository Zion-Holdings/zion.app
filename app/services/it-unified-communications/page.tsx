...
export const metadata: Metadata = {
  ...
  keywords: 'Microsoft Teams / Zoom / Cisco deployment, VoIP and PBX migration, Video conferencing room design, Contact center integration, Unified messaging and presence, Integration with CRM and business apps, Network assessment and QoS configuration, Training and change management, it, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Unified Communications &amp; Collaboration</h1>
        <p className="text-lg text-slate-300 mb-8">Design and deploy unified communications with Teams, Zoom, or Cisco. Voice, video, messaging, and collaboration in one platform.</p>
        ...
        <li class="text-slate-300">Microsoft Teams / Zoom / Cisco deployment</li>
        <li class="text-slate-300">VoIP and PBX migration</li>
        <li class="text-slate-300">Video conferencing room design</li>
        <li class="text-slate-300">Contact center integration</li>
        <li class="text-slate-300">Unified messaging and presence</li>
        <li class="text-slate-300">Integration with CRM and business apps</li>
        <li class="text-slate-300">Network assessment and QoS configuration</li>
        <li class="text-slate-300">Training and change management</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce communication costs by 40%</li>
        <li class="text-slate-300">Improve collaboration across locations</li>
        <li class="text-slate-300">Consolidate vendors into one platform</li>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$22/user/mo</p>
