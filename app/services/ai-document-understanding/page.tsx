  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Document Understanding &amp; Data Extraction</h1>
        <p className="text-lg text-slate-300 mb-8">AI that reads and understands any document — invoices, contracts, forms, handwritten notes. Extract structured data with 99% accuracy and learn from corrections.</p>
        ...
        <li class="text-slate-300">Multi-format document ingestion (PDF, scan, photo)</li>
        <li class="text-slate-300">AI classification by document type</li>
        <li class="text-slate-300">Structured data extraction with confidence scores</li>
        <li class="text-slate-300">Human-in-the-loop validation</li>
        <li class="text-slate-300">Continuous learning from corrections</li>
        <li class="text-slate-300">Integration with ERP, CRM, and accounting</li>
        <li class="text-slate-300">Batch processing and real-time API</li>
        <li class="text-slate-300">Compliance-ready audit trail</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Process documents 20x faster than manual</li>
        <li class="text-slate-300">Achieve 99%+ extraction accuracy</li>
        <li class="text-slate-300">Reduce processing costs by 80%</li>
