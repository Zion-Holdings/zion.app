...
export const metadata: Metadata = {
  ...
  keywords: 'AI content personalization per learner, Knowledge gap identification, Adaptive assessments and quizzes, Learning path recommendations, Integration with LMS (Canvas, Moodle, Cornerstone), Skills tracking and certification, Engagement analytics and nudges, Content authoring with AI assistance, ai, edtech, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Adaptive Learning &amp; Training Platform</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered adaptive learning platform that personalizes training content for each learner. Used by companies for employee training and by educators for student success.</p>
        ...
        <li class="text-slate-300">AI content personalization per learner</li>
        <li class="text-slate-300">Knowledge gap identification</li>
        <li class="text-slate-300">Adaptive assessments and quizzes</li>
        <li class="text-slate-300">Learning path recommendations</li>
        <li class="text-slate-300">Integration with LMS (Canvas, Moodle, Cornerstone)</li>
        <li class="text-slate-300">Skills tracking and certification</li>
        <li class="text-slate-300">Engagement analytics and nudges</li>
        <li class="text-slate-300">Content authoring with AI assistance</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Improve learning outcomes by 40%</li>
        <li class="text-slate-300">Reduce training time with personalized paths</li>
        <li class="text-slate-300">Identify skill gaps automatically</li>
        <li class="text-slate-300">Scale training without adding instructors</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$35/user/mo</p>
