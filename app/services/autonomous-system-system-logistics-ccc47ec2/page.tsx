...
export const metadata: Metadata = {
  title: 'Autonomous System System - Logistics',
  description: 'Enhance your logistics business with Autonomous System System - Logistics. Our solution provides data pipeline orchestration with enterprise-grade reliability a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-system-system-logistics-ccc47ec2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous System System - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with Autonomous System System - Logistics. Our solution provides data pipeline orchestration with enterprise-grade reliability and security.
          </p>
