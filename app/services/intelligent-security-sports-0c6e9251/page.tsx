...
export const metadata: Metadata = {
  title: 'Intelligent security-sports',
  description: 'Next-generation sports solution: Intelligent security-sports. Combines sales forecasting with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-security-sports-0c6e9251',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent security-sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation sports solution: Intelligent security-sports. Combines sales forecasting with adaptive intelligence for optimal results.
          </p>
