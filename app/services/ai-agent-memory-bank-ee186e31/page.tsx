...
export const metadata = {
  title: "AI Agent Memory Bank - Zion Tech Group",
  description: "Persistent memory system for AI agents to remember context across sessions and conversations.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-agent-memory-bank-ee186e31`
  }
};
