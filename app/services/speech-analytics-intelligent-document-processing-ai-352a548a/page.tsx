...
export const metadata: Metadata = {
  ...
  description: 'speech analytics solution for education industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automaticall',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/speech-analytics-intelligent-document-processing-ai-352a548a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            speech analytics solution for education industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.
          </p>
