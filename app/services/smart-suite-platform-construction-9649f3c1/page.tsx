...
export const metadata: Metadata = {
  title: 'Smart Suite Platform - Construction',
  description: 'The future of construction is here with Smart Suite Platform - Construction. Powered by cutting-edge AI, this platform delivers risk assessment like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-suite-platform-construction-9649f3c1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Suite Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Smart Suite Platform - Construction. Powered by cutting-edge AI, this platform delivers risk assessment like never before.
          </p>
