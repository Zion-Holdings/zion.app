...
export const metadata: Metadata = {
  title: 'AI-Powered Scenario Director',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Scenario Director
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with AI-Powered Scenario Director. This intelligent platform delivers image recognition through advanced automation and AI.
          </p>
