    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Automate complex physical workflows with AI robotics</li>
            <li>Improve workplace safety with intelligent monitoring</li>
            <li>Scale robot fleet operations without proportional overhead</li>
            <li>Reduce cycle times by 40% with autonomous optimization</li>
          </ul>
        </div>
