...
export const metadata: Metadata = {
  ...
  keywords: 'Computer vision for robot navigation and obstacle avoidance, Autonomous task planning with reinforcement learning, Human-robot collaboration and safety monitoring, Multi-robot fleet management and coordination, Edge AI deployment for low-latency real-time control, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Robotics Integration &amp; Autonomous Systems</h1>
        <p className="text-lg text-slate-300 mb-8">AI integration for industrial and commercial robotics — computer vision navigation, autonomous task planning, human-robot collaboration, and fleet management.</p>
        ...
        <li class="text-slate-300">Computer vision for robot navigation and obstacle avoidance</li>
        <li class="text-slate-300">Autonomous task planning with reinforcement learning</li>
        <li class="text-slate-300">Human-robot collaboration and safety monitoring</li>
        <li class="text-slate-300">Multi-robot fleet management and coordination</li>
        <li class="text-slate-300">Edge AI deployment for low-latency real-time control</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai robotics integration &amp; autonomous systems</li>
