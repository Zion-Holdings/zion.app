...
export const metadata: Metadata = {
  title: 'Smart Cloud Platform - CLEANTECH #1',
  description: 'Next-generation cleantech solution: Smart Cloud Platform - CLEANTECH #1. Combines edge computing with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-cloud-platform-cleantech-1-741a64c6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Cloud Platform - CLEANTECH #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation cleantech solution: Smart Cloud Platform - CLEANTECH #1. Combines edge computing with adaptive intelligence for optimal results.
          </p>
