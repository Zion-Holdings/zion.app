...
export const metadata: Metadata = {
  title: 'Autonomous Management System - Finance',
  description: 'Enhance your finance business with Autonomous Management System - Finance. Our solution provides testing automation with enterprise-grade reliability and securi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Management System - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your finance business with Autonomous Management System - Finance. Our solution provides testing automation with enterprise-grade reliability and security.
          </p>
