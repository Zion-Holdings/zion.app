...
export const metadata: Metadata = {
  title: 'Smart Healthcare Platform - Real-Estate #1',
  description: 'Enhance your real-estate business with Smart Healthcare Platform - Real-Estate #1. Our solution provides user provisioning with enterprise-grade reliability and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-healthcare-platform-real-estate-1-c5616b1e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Healthcare Platform - Real-Estate #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your real-estate business with Smart Healthcare Platform - Real-Estate #1. Our solution provides user provisioning with enterprise-grade reliability and security.
          </p>
