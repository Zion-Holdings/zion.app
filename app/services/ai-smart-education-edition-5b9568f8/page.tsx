      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your education workflows with AI Smart - Education Edition. This intelligent platform delivers business continuity through advanced automation and AI.
          </p>
