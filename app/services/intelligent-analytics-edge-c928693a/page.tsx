...
export const metadata: Metadata = {
  title: 'Intelligent analytics-edge',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent analytics-edge
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize edge through intelligent automation. Our Intelligent analytics-edge leverages advanced machine learning to deliver performance monitoring at scale.
          </p>
