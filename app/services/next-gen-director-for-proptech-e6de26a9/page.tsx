...
export const metadata: Metadata = {
  title: 'Next-Gen Director for PROPTECH',
  description: 'Drive innovation in proptech with Next-Gen Director for PROPTECH. This AI-powered platform transforms performance tracking into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-director-for-proptech-e6de26a9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Director for PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in proptech with Next-Gen Director for PROPTECH. This AI-powered platform transforms performance tracking into a competitive advantage.
          </p>
