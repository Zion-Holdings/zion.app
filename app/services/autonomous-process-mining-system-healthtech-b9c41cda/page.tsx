...
export const metadata: Metadata = {
  title: 'Autonomous Process Mining System - HEALTHTECH',
  description: 'Transform your healthtech operations with our Autonomous Process Mining System - HEALTHTECH. This AI-driven solution automates risk management with unprecedente',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-process-mining-system-healthtech-b9c41cda',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Process Mining System - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthtech operations with our Autonomous Process Mining System - HEALTHTECH. This AI-driven solution automates risk management with unprecedented accuracy and efficiency.
          </p>
