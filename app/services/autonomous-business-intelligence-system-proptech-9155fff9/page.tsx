...
export const metadata: Metadata = {
  title: 'Autonomous Business Intelligence System - PROPTECH',
  description: 'Drive innovation in proptech with Autonomous Business Intelligence System - PROPTECH. This AI-powered platform transforms supply visibility into a competitive a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-business-intelligence-system-proptech-9155fff9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Business Intelligence System - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in proptech with Autonomous Business Intelligence System - PROPTECH. This AI-powered platform transforms supply visibility into a competitive advantage.
          </p>
