...
export const metadata: Metadata = {
  title: 'Neural Intelligence for Logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Neural Intelligence for Logistics leverages advanced machine learning to deliver network optimizatio',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-intelligence-for-logistics-80898bdb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Intelligence for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Neural Intelligence for Logistics leverages advanced machine learning to deliver network optimization at scale.
          </p>
