...
export const metadata: Metadata = {
  title: 'Smart Engine Platform - Telecom',
  description: 'Revolutionize telecom through intelligent automation. Our Smart Engine Platform - Telecom leverages advanced machine learning to deliver manufacturing quality c',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-engine-platform-telecom-619a9ba1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Engine Platform - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Smart Engine Platform - Telecom leverages advanced machine learning to deliver manufacturing quality control at scale.
          </p>
