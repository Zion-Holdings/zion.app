...
export const metadata: Metadata = {
  title: 'Smart Experience for Finance #1',
  description: 'The future of finance is here with Smart Experience for Finance #1. Powered by cutting-edge AI, this platform delivers energy management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-experience-for-finance-1-18157b9c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Experience for Finance #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of finance is here with Smart Experience for Finance #1. Powered by cutting-edge AI, this platform delivers energy management like never before.
          </p>
