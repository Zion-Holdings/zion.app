...
export const metadata = {
  ...
  description: 'End-to-end digital workplace strategy: secure, productive remote and hybrid work environments services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/digital-workplace-strategy-secure-productive-remote-and-hybrid-work-environments-45/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">Digital Workplace Strategy: Secure, Productive Remote and Hybrid Work Environments</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end digital workplace strategy: secure, productive remote and hybrid work environments services: assessment, deployment, and managed operations.
        </p>
