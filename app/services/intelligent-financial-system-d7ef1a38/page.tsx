...
export const metadata: Metadata = {
  title: 'Intelligent Financial System',
  description: 'The future of real-estate is here with Intelligent Financial System. Powered by cutting-edge AI, this platform delivers resource utilization like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-financial-system-d7ef1a38',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of real-estate is here with Intelligent Financial System. Powered by cutting-edge AI, this platform delivers resource utilization like never before.
          </p>
