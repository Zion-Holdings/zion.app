...
export const metadata: Metadata = {
  ...
  keywords: 'SAST, secret-scan, and dependency-audit running at every pull request, 25-plus language ecosystems including TypeScript, Python, Go, Rust, and Java, Automated 1st-pass PR reviewer with inline code comments before human review, Quality score covering maintainability index and cognitive complexity trend, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Code Quality &amp; Pre-Merge Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Pre-merge quality gate: SAST, secret-scan, dependency-audit, trunk-based branch review, automated PR reviewer with inline comments, per-PR quality score, and merge-blocking on regressions across 25+ languages.</p>
        ...
        <li class="text-slate-300">SAST, secret-scan, and dependency-audit running at every pull request</li>
        <li class="text-slate-300">25-plus language ecosystems including TypeScript, Python, Go, Rust, and Java</li>
        <li class="text-slate-300">Automated 1st-pass PR reviewer with inline code comments before human review</li>
        <li class="text-slate-300">Quality score covering maintainability index and cognitive complexity trend</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with code quality &amp; pre-merge automation</li>
