...
export const metadata: Metadata = {
  title: 'Smart Scale-up Platform - CLEANTECH',
  description: 'Enhance your cleantech business with Smart Scale-up Platform - CLEANTECH. Our solution provides master data management with enterprise-grade reliability and sec',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-scale-up-platform-cleantech-613d141a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Scale-up Platform - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your cleantech business with Smart Scale-up Platform - CLEANTECH. Our solution provides master data management with enterprise-grade reliability and security.
          </p>
