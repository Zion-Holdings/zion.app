...
export const metadata: Metadata = {
  title: 'Quantum Optimization - Legal Quantum',
  description: 'Revolutionize legal through intelligent automation. Our Quantum Optimization - Legal Quantum leverages advanced machine learning to deliver benefits administrat',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Optimization - Legal Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Quantum Optimization - Legal Quantum leverages advanced machine learning to deliver benefits administration at scale.
          </p>
