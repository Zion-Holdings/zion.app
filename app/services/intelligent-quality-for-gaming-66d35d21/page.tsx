...
export const metadata: Metadata = {
  title: 'Intelligent Quality for Gaming',
  description: 'Optimize your gaming workflows with Intelligent Quality for Gaming. This intelligent platform delivers compensation management through advanced automation and A',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-quality-for-gaming-66d35d21',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Quality for Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your gaming workflows with Intelligent Quality for Gaming. This intelligent platform delivers compensation management through advanced automation and AI.
          </p>
