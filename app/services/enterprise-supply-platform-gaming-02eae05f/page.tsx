...
export const metadata: Metadata = {
  title: 'Enterprise Supply Platform - Gaming',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Supply Platform - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated gaming solution: Enterprise Supply Platform - Gaming. Combines access management with next-gen AI for maximum velocity.
          </p>
