...
export const metadata: Metadata = {
  title: 'Cognitive Suite Solution - Agriculture',
  description: 'Drive innovation in agriculture with Cognitive Suite Solution - Agriculture. This AI-powered platform transforms testing automation into a competitive advantage',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-suite-solution-agriculture-b423548a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Suite Solution - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in agriculture with Cognitive Suite Solution - Agriculture. This AI-powered platform transforms testing automation into a competitive advantage.
          </p>
