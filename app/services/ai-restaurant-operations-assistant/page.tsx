...
export const metadata: Metadata = {
  title: "AI Restaurant Operations Assistant | Zion Tech Group",
  ...
  openGraph: {
    title: "AI Restaurant Operations Assistant | Zion Tech Group",
    description: "Optimize restaurant operations from inventory and scheduling to customer experience. AI predicts demand, reduces waste, and automates ordering and staffing.",
    url: "https://ziontechgroup.com/services/ai-restaurant-operations-assistant/",
    type: 'website',
  },
  alternates: { canonical: "/services/ai-restaurant-operations-assistant/" },
};

export default function AiRestaurantOperationsAssistantPage() {
  return (
    <StandardPage
      title="AI Restaurant Operations Assistant"
      subtitle="Optimize restaurant operations from inventory and scheduling to customer experience. AI predicts demand, reduces waste, and automates ordering and staffing."
      breadcrumbItems={[
        { label: "Home", href: "/" },
        { label: "Services", href: "/services/" },
        { label: "AI Restaurant Operations Assistant" }
      ]}
      actions={[
    ...
    >
        ...
        <div className="rounded-2xl border border-white/10 bg-slate-900/40 p-5"><h2 className="text-white font-semibold mb-2">AI Restaurant Operations Assistant</h2><p className="text-slate-400 text-sm">Archived section recovered from the live site snapshot.</p></div>
      ...
      <p className="text-slate-400 leading-relaxed mb-4 max-w-5xl mx-auto">Estimated timeline for AI Restaurant Operations Assistant — adapt to your team size and complexity.</p>
      ...
      <p className="text-slate-500 text-sm max-w-5xl mx-auto">Restored from a Wayback Machine snapshot (20260607113851) of ziontechgroup.com.</p>
    </StandardPage>
  );
}
