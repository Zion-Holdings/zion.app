...
export const metadata: Metadata = {
  ...
  description: 'Enhance your real-estate business with Cognitive Real Estate Solution - Real-Estate. Our solution provides container orchestration with enterprise-grade reliabi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your real-estate business with Cognitive Real Estate Solution - Real-Estate. Our solution provides container orchestration with enterprise-grade reliability and security.
          </p>
