...
export const metadata: Metadata = {
  title: 'Intelligent Autonomous for Construction',
  description: 'Optimize your construction workflows with Intelligent Autonomous for Construction. This intelligent platform delivers performance tuning through advanced automa',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-autonomous-for-construction-b550e302',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Autonomous for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Intelligent Autonomous for Construction. This intelligent platform delivers performance tuning through advanced automation and AI.
          </p>
