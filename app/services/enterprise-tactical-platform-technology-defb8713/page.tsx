...
export const metadata: Metadata = {
  title: 'Enterprise Tactical Platform - TECHNOLOGY',
  description: 'Drive innovation in technology with Enterprise Tactical Platform - TECHNOLOGY. This AI-powered platform transforms user experience into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-tactical-platform-technology-defb8713',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Tactical Platform - TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in technology with Enterprise Tactical Platform - TECHNOLOGY. This AI-powered platform transforms user experience into a competitive advantage.
          </p>
