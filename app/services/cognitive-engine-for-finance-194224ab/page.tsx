...
export const metadata: Metadata = {
  title: 'Cognitive Engine for Finance',
  description: 'Transform your finance operations with our Cognitive Engine for Finance. This AI-driven solution automates user experience with unprecedented accuracy and effic',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-engine-for-finance-194224ab',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Engine for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Cognitive Engine for Finance. This AI-driven solution automates user experience with unprecedented accuracy and efficiency.
          </p>
