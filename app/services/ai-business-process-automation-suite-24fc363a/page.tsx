...
export const metadata: Metadata = {
  title: "AI Business Process Automation Suite - AI-Powered Business Process Solution",
  description: "Discovers, automates, and optimizes business processes using AI-powered process mining.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-business-process-automation-suite-24fc363a",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI Business Process Automation Suite - AI-Powered Business Process Solution
        </h1>
