...
export const metadata = {
  ...
  description: "Integration Platform as a Service for connecting applications, data, and APIs. 500+ pre-built connectors, visual workflow builder, and real-time data synchroniz",
  alternates: {
