...
export const metadata: Metadata = {
  title: 'Analyzer AI/IT - Energy',
  description: 'Enhance your energy business with Analyzer AI/IT - Energy. Our solution provides anomaly detection with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/analyzer-aiit-energy-033a93b8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Analyzer AI/IT - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your energy business with Analyzer AI/IT - Energy. Our solution provides anomaly detection with enterprise-grade reliability and security.
          </p>
