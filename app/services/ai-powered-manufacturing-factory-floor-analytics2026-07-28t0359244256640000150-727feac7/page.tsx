...
export const metadata: Metadata = {
  title: 'AI-Powered Manufacturing Factory Floor Analytics',
  description: 'Analytics for factory floor with real-time insights and recommendations.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-manufacturing-factory-floor-analytics2026-07-28t0359244256640000150-727feac7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Manufacturing Factory Floor Analytics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Analytics for factory floor with real-time insights and recommendations.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Floor analytics</li>
          <li className="text-gray-300">Real-time insights</li>
          <li className="text-gray-300">Recommendations</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">80% faster insights</li>
