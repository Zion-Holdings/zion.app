...
export const metadata: Metadata = {
  title: 'Security Smart - Healthcare #1',
  description: 'Transform your healthcare operations with our Security Smart - Healthcare #1. This AI-driven solution automates market intelligence with unprecedented accuracy ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Smart - Healthcare #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Security Smart - Healthcare #1. This AI-driven solution automates market intelligence with unprecedented accuracy and efficiency.
          </p>
