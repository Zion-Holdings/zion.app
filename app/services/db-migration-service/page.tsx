...
export const metadata: Metadata = {
  ...
  keywords: 'Homogeneous + heterogeneous moves, Online replication with CDC, Schema compatibility analyzer, Rollback automation, Performance validation, it, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Homogeneous and heterogeneous database migrations — on-prem to cloud, between engines (Oracle→Postgres, MySQL→CockroachDB) with zero-downtime cutovers.</p>
        ...
        <li class="text-slate-300">Homogeneous + heterogeneous moves</li>
        <li class="text-slate-300">Online replication with CDC</li>
        <li class="text-slate-300">Schema compatibility analyzer</li>
        <li class="text-slate-300">Rollback automation</li>
        <li class="text-slate-300">Performance validation</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with database migration service</li>
