...
export const metadata: Metadata = {
  title: 'Enterprise Compliance Platform - Legal',
  description: 'Transform your legal operations with our Enterprise Compliance Platform - Legal. This AI-driven solution automates compensation management with unprecedented ac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-compliance-platform-legal-1665f458',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Compliance Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Enterprise Compliance Platform - Legal. This AI-driven solution automates compensation management with unprecedented accuracy and efficiency.
          </p>
