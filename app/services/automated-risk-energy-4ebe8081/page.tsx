      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated risk-energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your energy business with Automated risk-energy. Our solution provides customer service automation with enterprise-grade reliability and security.
          </p>
