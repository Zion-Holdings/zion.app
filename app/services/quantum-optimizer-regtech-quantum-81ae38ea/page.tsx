...
export const metadata: Metadata = {
  title: 'Quantum Optimizer - REGTECH Quantum',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Optimizer - REGTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Quantum Optimizer - REGTECH Quantum. This autonomous system provides expense reporting with zero manual intervention needed.
          </p>
