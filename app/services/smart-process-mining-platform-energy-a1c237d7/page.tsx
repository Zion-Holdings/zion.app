...
export const metadata: Metadata = {
  title: 'Smart Process Mining Platform - Energy',
  description: 'Next-generation energy solution: Smart Process Mining Platform - Energy. Combines performance reviews with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-process-mining-platform-energy-a1c237d7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Process Mining Platform - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Smart Process Mining Platform - Energy. Combines performance reviews with adaptive intelligence for optimal results.
          </p>
