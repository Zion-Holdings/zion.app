...
export const metadata: Metadata = {
  title: 'Clinical Trial Management AI-Powered Data Quality Manager',
  description: 'clinical trial management solution for regtech industry. Automatically detects, corrects, and prevents data quality issues using machine learning.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/clinical-trial-management-ai-powered-data-quality-manager-3d9e6f8c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Clinical Trial Management AI-Powered Data Quality Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            clinical trial management solution for regtech industry. Automatically detects, corrects, and prevents data quality issues using machine learning.
          </p>
