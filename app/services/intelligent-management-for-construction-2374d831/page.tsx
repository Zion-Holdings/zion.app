...
export const metadata = {
  ...
  description: "Quantum leap forward for construction: Intelligent Management for Construction. Uses quantum-inspired algorithms to deliver quality control at exponential speed.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/intelligent-management-for-construction-2374d831`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Quantum leap forward for construction: Intelligent Management for Construction. Uses quantum-inspired algorithms to deliver quality control at exponential speed.</p>
