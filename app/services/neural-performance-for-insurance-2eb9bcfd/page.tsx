...
export const metadata: Metadata = {
  title: 'Neural Performance for Insurance',
  description: 'The future of insurance is here with Neural Performance for Insurance. Powered by cutting-edge AI, this platform delivers survey automation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-performance-for-insurance-2eb9bcfd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Performance for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Neural Performance for Insurance. Powered by cutting-edge AI, this platform delivers survey automation like never before.
          </p>
