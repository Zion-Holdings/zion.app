...
export const metadata: Metadata = {
  title: 'Manufacturing Smart - Retail',
  description: 'The future of retail is here with Manufacturing Smart - Retail. Powered by cutting-edge AI, this platform delivers forecast accuracy like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/manufacturing-smart-retail-c1ee467f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manufacturing Smart - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Manufacturing Smart - Retail. Powered by cutting-edge AI, this platform delivers forecast accuracy like never before.
          </p>
