...
export const metadata: Metadata = {
  title: 'AI Autonomous - Hospitality Edition #1',
  description: 'Enhance your hospitality business with AI Autonomous - Hospitality Edition #1. Our solution provides data quality with enterprise-grade reliability and security',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-autonomous-hospitality-edition-1-5c949026',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Autonomous - Hospitality Edition #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with AI Autonomous - Hospitality Edition #1. Our solution provides data quality with enterprise-grade reliability and security.
          </p>
