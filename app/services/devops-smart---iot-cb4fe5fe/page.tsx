...
export const metadata: Metadata = {
  title: 'DevOps Smart - Iot',
  description: 'Revolutionize iot through intelligent automation. Our DevOps Smart - Iot leverages advanced machine learning to deliver fraud prevention at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/devops-smart---iot-cb4fe5fe',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize iot through intelligent automation. Our DevOps Smart - Iot leverages advanced machine learning to deliver fraud prevention at scale.
          </p>
