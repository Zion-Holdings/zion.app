...
export const metadata: Metadata = {
  title: 'Cognitive Document for Insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Document for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated insurance solution: Cognitive Document for Insurance. Combines hr analytics with next-gen AI for maximum velocity.
          </p>
