...
export const metadata: Metadata = {
  title: 'Enterprise Intelligent Platform - AITECH',
  description: 'Unlock unprecedented growth with Enterprise Intelligent Platform - AITECH. This autonomous system provides business process with zero manual intervention needed',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-intelligent-platform-aitech-a593cff9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Intelligent Platform - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Enterprise Intelligent Platform - AITECH. This autonomous system provides business process with zero manual intervention needed.
          </p>
