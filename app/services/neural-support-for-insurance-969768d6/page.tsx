...
export const metadata: Metadata = {
  title: 'Neural Support for Insurance',
  description: 'Next-generation insurance solution: Neural Support for Insurance. Combines fraud prevention with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-support-for-insurance-969768d6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Support for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Neural Support for Insurance. Combines fraud prevention with adaptive intelligence for optimal results.
          </p>
