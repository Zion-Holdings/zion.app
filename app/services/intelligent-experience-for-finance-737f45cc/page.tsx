...
export const metadata: Metadata = {
  title: 'Intelligent Experience for Finance',
  description: 'Next-generation finance solution: Intelligent Experience for Finance. Combines compliance monitoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-experience-for-finance-737f45cc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Experience for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation finance solution: Intelligent Experience for Finance. Combines compliance monitoring with adaptive intelligence for optimal results.
          </p>
