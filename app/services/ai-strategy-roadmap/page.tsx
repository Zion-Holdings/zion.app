...
export const metadata: Metadata = {
  ...
  keywords: 'Discovery & Opportunity Mapping, Use-Case Prioritization, Vendor & Build-vs-Buy Evaluation, Phased Roadmap Design, KPI & Success Metrics, Governance & Risk Alignment, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Strategy &amp; Roadmap</h1>
        <p className="text-lg text-slate-300 mb-8">Align AI initiatives with business goals. Discovery workshops, use-case prioritization, vendor evaluation, and phased roadmaps for production AI at...</p>
        ...
        <li class="text-slate-300">Discovery &amp; Opportunity Mapping</li>
        <li class="text-slate-300">Use-Case Prioritization</li>
        <li class="text-slate-300">Vendor &amp; Build-vs-Buy Evaluation</li>
        <li class="text-slate-300">Phased Roadmap Design</li>
        <li class="text-slate-300">KPI &amp; Success Metrics</li>
        <li class="text-slate-300">Governance &amp; Risk Alignment</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai strategy &amp; roadmap</li>
