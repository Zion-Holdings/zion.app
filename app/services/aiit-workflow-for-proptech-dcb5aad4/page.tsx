...
export const metadata: Metadata = {
  title: 'AI/IT Workflow for PROPTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Workflow for PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with AI/IT Workflow for PROPTECH. Powered by cutting-edge AI, this platform delivers conversational ai like never before.
          </p>
