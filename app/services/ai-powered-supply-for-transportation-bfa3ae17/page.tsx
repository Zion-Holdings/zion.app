...
export const metadata: Metadata = {
  title: 'AI-Powered Supply for Transportation',
  description: 'The future of transportation is here with AI-Powered Supply for Transportation. Powered by cutting-edge AI, this platform delivers resource optimization like ne',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-supply-for-transportation-bfa3ae17',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Supply for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with AI-Powered Supply for Transportation. Powered by cutting-edge AI, this platform delivers resource optimization like never before.
          </p>
