      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Career Document
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in cybersecurity with AI/IT Career Document. This AI-powered platform transforms receipt processing into a competitive advantage.
          </p>
