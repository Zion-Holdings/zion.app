...
export const metadata: Metadata = {
  title: 'Security Smart - Manufacturing',
  description: 'The future of manufacturing is here with Security Smart - Manufacturing. Powered by cutting-edge AI, this platform delivers recommendation system like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-smart-manufacturing-f7146e5c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Smart - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of manufacturing is here with Security Smart - Manufacturing. Powered by cutting-edge AI, this platform delivers recommendation system like never before.
          </p>
