...
export const metadata: Metadata = {
  ...
  keywords: 'Offline capabilities, Cloud-native architecture, Role-based access control, GDPR compliance, system, logistics, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cognitive System for Logistics</h1>
        <p className="text-lg text-slate-300 mb-8">Revolutionize logistics through intelligent automation. Our Cognitive System for Logistics leverages advanced machine learning to deliver customer insights at scale.</p>
