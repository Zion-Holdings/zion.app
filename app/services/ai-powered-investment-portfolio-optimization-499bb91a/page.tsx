...
export const metadata: Metadata = {
  title: 'AI-Powered Investment Portfolio Optimization',
  description: 'Optimizes investment portfolios using modern portfolio theory and machine learning.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-investment-portfolio-optimization-499bb91a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimizes investment portfolios using modern portfolio theory and machine learning.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Asset allocation</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">30% better risk-adjusted returns</li>
