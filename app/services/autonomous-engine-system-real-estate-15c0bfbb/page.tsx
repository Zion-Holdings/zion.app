...
export const metadata: Metadata = {
  title: 'Autonomous Engine System - Real-Estate',
  description: 'Transform your real-estate operations with our Autonomous Engine System - Real-Estate. This AI-driven solution automates document processing with unprecedented ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-engine-system-real-estate-15c0bfbb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Engine System - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Autonomous Engine System - Real-Estate. This AI-driven solution automates document processing with unprecedented accuracy and efficiency.
          </p>
