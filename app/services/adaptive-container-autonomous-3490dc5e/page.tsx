...
export const metadata: Metadata = {
  title: 'Adaptive Container Autonomous',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Container Autonomous
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation manufacturing solution: Adaptive Container Autonomous. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
