...
export const metadata: Metadata = {
  title: 'Smart Generator Solution',
  description: 'Transform your agriculture operations with our Smart Generator Solution. This devops solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-generator-solution-5062c7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Generator Solution
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Smart Generator Solution. This devops solution delivers unprecedented automation and intelligence.
          </p>
