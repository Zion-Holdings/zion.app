...
export const metadata: Metadata = {
  title: 'Smart Analytics Platform - Media',
  description: 'Future-proof your media with Smart Analytics Platform - Media. Our autonomous solution handles churn prediction end-to-end without human intervention.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-analytics-platform-media-425db74b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Analytics Platform - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your media with Smart Analytics Platform - Media. Our autonomous solution handles churn prediction end-to-end without human intervention.
          </p>
