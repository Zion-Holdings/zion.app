...
export const metadata: Metadata = {
  title: 'Intelligent Cognitive for Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Intelligent Cognitive for Insurance leverages advanced machine learning to deliver quality assurance',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-cognitive-for-insurance-bc8b22d6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Cognitive for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Intelligent Cognitive for Insurance leverages advanced machine learning to deliver quality assurance at scale.
          </p>
