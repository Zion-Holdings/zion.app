...
export const metadata: Metadata = {
  title: 'Self-Optimizing Risk Healthcare',
  description: 'Transform your real-estate operations with our Self-Optimizing Risk Healthcare. This AI-driven solution automates customer insights with unprecedented accuracy ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/self-optimizing-risk-healthcare-b75d8c92',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Risk Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Self-Optimizing Risk Healthcare. This AI-driven solution automates customer insights with unprecedented accuracy and efficiency.
          </p>
