...
export const metadata: Metadata = {
  title: 'Intelligence Autonomous - Real-Estate',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation real-estate solution: Intelligence Autonomous - Real-Estate. Combines performance monitoring with adaptive intelligence for optimal results.
          </p>
