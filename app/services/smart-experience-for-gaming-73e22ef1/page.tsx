...
export const metadata: Metadata = {
  title: 'Smart Experience for Gaming',
  description: 'Next-generation gaming solution: Smart Experience for Gaming. Combines market intelligence with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-experience-for-gaming-73e22ef1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Experience for Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation gaming solution: Smart Experience for Gaming. Combines market intelligence with adaptive intelligence for optimal results.
          </p>
