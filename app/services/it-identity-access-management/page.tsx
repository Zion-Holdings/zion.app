...
export const metadata: Metadata = {
  ...
  keywords: 'Single sign-on (SSO) with 5000+ app integrations, Adaptive multi-factor authentication with risk scoring, Privileged access management (PAM) with session recording, Automated access provisioning and de-provisioning, Identity governance with access certification workflows, security, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Identity &amp; Access Management (IAM) Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Enterprise IAM with SSO, MFA, PAM, and automated access provisioning across cloud and on-premise systems — Zero Trust-ready identity governance.</p>
        ...
        <li class="text-slate-300">Single sign-on (SSO) with 5000+ app integrations</li>
        <li class="text-slate-300">Adaptive multi-factor authentication with risk scoring</li>
        <li class="text-slate-300">Privileged access management (PAM) with session recording</li>
        <li class="text-slate-300">Automated access provisioning and de-provisioning</li>
        <li class="text-slate-300">Identity governance with access certification workflows</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with identity &amp; access management (iam) platform</li>
