...
export const metadata: Metadata = {
  title: 'Cognitive Customer Service for Energy',
  description: 'Transform your energy operations with our Cognitive Customer Service for Energy. This AI-driven solution automates user experience with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-customer-service-for-energy-2bb83766',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Customer Service for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Cognitive Customer Service for Energy. This AI-driven solution automates user experience with unprecedented accuracy and efficiency.
          </p>
