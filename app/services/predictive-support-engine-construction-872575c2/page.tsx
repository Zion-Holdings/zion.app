...
export const metadata: Metadata = {
  title: 'Predictive Support Engine - Construction',
  description: 'Enhance your construction business with Predictive Support Engine - Construction. Our solution provides procurement automation with enterprise-grade reliability',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-support-engine-construction-872575c2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Support Engine - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Predictive Support Engine - Construction. Our solution provides procurement automation with enterprise-grade reliability and security.
          </p>
