...
export const metadata: Metadata = {
  title: 'AI-Powered Last-Mile Delivery',
  description: 'Optimizes last-mile delivery using real-time traffic, customer preferences, and fleet management.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-last-mile-delivery-2ff0019c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimizes last-mile delivery using real-time traffic, customer preferences, and fleet management.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Delivery optimization</li>
          <li className="text-gray-300">Customer scheduling</li>
          <li className="text-gray-300">Real-time tracking</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">30% faster delivery</li>
