...
export const metadata: Metadata = {
  title: 'Cognitive Strategic Solution - FINTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Strategic Solution - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your fintech workflows with Cognitive Strategic Solution - FINTECH. This intelligent platform delivers travel management through advanced automation and AI.
          </p>
