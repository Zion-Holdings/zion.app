...
export const metadata: Metadata = {
  title: 'Quantum Strategic - Construction Quantum',
  description: 'Transform your construction operations with our Quantum Strategic - Construction Quantum. This AI-driven solution automates learning management with unprecedent',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Strategic - Construction Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Quantum Strategic - Construction Quantum. This AI-driven solution automates learning management with unprecedented accuracy and efficiency.
          </p>
