...
export const metadata: Metadata = {
  title: 'Media Mix Modeling Multi-Cloud Cost Management Platform',
  description: 'media mix modeling solution for civictech industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/media-mix-modeling-multi-cloud-cost-management-platform-2c51d900',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Media Mix Modeling Multi-Cloud Cost Management Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            media mix modeling solution for civictech industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.
          </p>
