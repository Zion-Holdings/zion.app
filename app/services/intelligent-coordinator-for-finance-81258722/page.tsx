...
export const metadata: Metadata = {
  title: 'Intelligent Coordinator for Finance',
  description: 'Revolutionize finance through intelligent automation. Our Intelligent Coordinator for Finance leverages advanced machine learning to deliver energy management a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-coordinator-for-finance-81258722',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Coordinator for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our Intelligent Coordinator for Finance leverages advanced machine learning to deliver energy management at scale.
          </p>
