...
export const metadata: Metadata = {
  title: 'Learning Management Intelligent Document Processing AI',
  description: 'learning management solution for sports venues industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents autom',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/learning-management-intelligent-document-processing-ai-842b99a1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Learning Management Intelligent Document Processing AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            learning management solution for sports venues industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.
          </p>
