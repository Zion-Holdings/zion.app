...
export const metadata: Metadata = {
  title: 'Cognitive Security for REGTECH',
  description: 'Revolutionize regtech through intelligent automation. Our Cognitive Security for REGTECH leverages advanced machine learning to deliver process automation at sc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-security-for-regtech-cfb3f06a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Security for REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize regtech through intelligent automation. Our Cognitive Security for REGTECH leverages advanced machine learning to deliver process automation at scale.
          </p>
