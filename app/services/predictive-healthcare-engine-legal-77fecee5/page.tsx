...
export const metadata: Metadata = {
  title: 'Predictive Healthcare Engine - Legal',
  description: 'Drive innovation in legal with Predictive Healthcare Engine - Legal. This AI-powered platform transforms generative ai into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-healthcare-engine-legal-77fecee5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Healthcare Engine - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Predictive Healthcare Engine - Legal. This AI-powered platform transforms generative ai into a competitive advantage.
          </p>
