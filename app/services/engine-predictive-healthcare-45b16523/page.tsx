...
export const metadata: Metadata = {
  title: 'Engine Predictive - Healthcare',
  description: 'Enhance your healthcare business with Engine Predictive - Healthcare. Our solution provides employee engagement with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/engine-predictive-healthcare-45b16523',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Engine Predictive - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with Engine Predictive - Healthcare. Our solution provides employee engagement with enterprise-grade reliability and security.
          </p>
