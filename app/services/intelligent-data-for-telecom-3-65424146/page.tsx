...
export const metadata: Metadata = {
  title: 'Intelligent Data for Telecom #3',
  description: 'Optimize your telecom workflows with Intelligent Data for Telecom #3. This intelligent platform delivers hr analytics through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-data-for-telecom-3-65424146',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Data for Telecom #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your telecom workflows with Intelligent Data for Telecom #3. This intelligent platform delivers hr analytics through advanced automation and AI.
          </p>
