...
export const metadata: Metadata = {
  ...
  keywords: 'Defect detection, Visual inspection, Quality classification, Process monitoring, Anomaly detection, OCR/barcode reading, Safety compliance, Real-time alerts, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Computer Vision for Manufacturing</h1>
        <p className="text-lg text-slate-300 mb-8">Automated visual inspection, defect detection, quality control, and process monitoring using AI computer vision. Works with existing cameras and IoT sensors.</p>
        ...
        <li class="text-slate-300">Visual inspection</li>
        <li class="text-slate-300">Quality classification</li>
        <li class="text-slate-300">Process monitoring</li>
        <li class="text-slate-300">Anomaly detection</li>
        <li class="text-slate-300">OCR/barcode reading</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">99.5% detection accuracy</li>
        <li class="text-slate-300">100x faster than manual</li>
        <li class="text-slate-300">Zero-defect target</li>
        <li class="text-slate-300">Safety compliance</li>
      </ul>
        </div>
