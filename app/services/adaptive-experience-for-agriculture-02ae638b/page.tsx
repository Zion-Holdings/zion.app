...
export const metadata: Metadata = {
  title: 'Adaptive Experience for Agriculture',
  description: 'Next-generation agriculture solution: Adaptive Experience for Agriculture. Combines risk assessment with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-experience-for-agriculture-02ae638b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Experience for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agriculture solution: Adaptive Experience for Agriculture. Combines risk assessment with adaptive intelligence for optimal results.
          </p>
