...
export const metadata: Metadata = {
  title: 'Enterprise Engine Platform - Manufacturing',
  description: 'Hyper-accelerated manufacturing solution: Enterprise Engine Platform - Manufacturing. Combines succession planning with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-engine-platform-manufacturing-20740954',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Engine Platform - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated manufacturing solution: Enterprise Engine Platform - Manufacturing. Combines succession planning with next-gen AI for maximum velocity.
          </p>
