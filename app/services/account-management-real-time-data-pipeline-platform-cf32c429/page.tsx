...
export const metadata: Metadata = {
  title: "Account Management Real-Time Data Pipeline Platform - AI-Powered Travel Solution",
  description: "account management solution for travel industry. Creates and manages real-time data pipelines with automated ETL and streaming analytics.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/account-management-real-time-data-pipeline-platform-cf32c429",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Account Management Real-Time Data Pipeline Platform - AI-Powered Travel Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          account management solution for travel industry. Creates and manages real-time data pipelines with automated ETL and streaming analytics.
        </p>
