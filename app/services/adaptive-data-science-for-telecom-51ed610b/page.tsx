...
export const metadata: Metadata = {
  title: 'Adaptive Data Science for Telecom',
  description: 'Revolutionize telecom through intelligent automation. Our Adaptive Data Science for Telecom leverages advanced machine learning to deliver master data managemen',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Data Science for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Adaptive Data Science for Telecom leverages advanced machine learning to deliver master data management at scale.
          </p>
