...
export const metadata: Metadata = {
  title: 'Smart Security for Healthcare #1',
  description: 'The future of healthcare is here with Smart Security for Healthcare #1. Powered by cutting-edge AI, this platform delivers predictive analytics like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-security-for-healthcare-1-293bde80',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Security for Healthcare #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Smart Security for Healthcare #1. Powered by cutting-edge AI, this platform delivers predictive analytics like never before.
          </p>
