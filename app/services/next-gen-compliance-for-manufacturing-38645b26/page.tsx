...
export const metadata: Metadata = {
  title: 'Next-Gen Compliance for Manufacturing',
  description: 'Enhance your manufacturing business with Next-Gen Compliance for Manufacturing. Our solution provides financial risk management with enterprise-grade reliabilit',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Compliance for Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your manufacturing business with Next-Gen Compliance for Manufacturing. Our solution provides financial risk management with enterprise-grade reliability and security.
          </p>
