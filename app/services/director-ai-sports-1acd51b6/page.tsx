...
export const metadata: Metadata = {
  title: 'Director AI - Sports',
  description: 'Enhance your sports business with Director AI - Sports. Our solution provides quality control with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/director-ai-sports-1acd51b6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your sports business with Director AI - Sports. Our solution provides quality control with enterprise-grade reliability and security.
          </p>
