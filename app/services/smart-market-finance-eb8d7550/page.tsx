...
export const metadata: Metadata = {
  title: 'Smart Market Finance',
  description: 'Optimize your media workflows with Smart Market Finance. This intelligent platform delivers healthcare data analytics through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-market-finance-eb8d7550',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Market Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your media workflows with Smart Market Finance. This intelligent platform delivers healthcare data analytics through advanced automation and AI.
          </p>
