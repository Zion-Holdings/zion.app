...
export const metadata: Metadata = {
  title: 'AI Workflow - MARTECH Edition',
  description: 'Optimize your martech workflows with AI Workflow - MARTECH Edition. This intelligent platform delivers sales process optimization through advanced automation an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Workflow - MARTECH Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your martech workflows with AI Workflow - MARTECH Edition. This intelligent platform delivers sales process optimization through advanced automation and AI.
          </p>
