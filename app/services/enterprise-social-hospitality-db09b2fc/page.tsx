...
export const metadata: Metadata = {
  title: 'Enterprise Social - Hospitality',
  description: 'Future-proof your hospitality with Enterprise Social - Hospitality. Our autonomous solution handles api management end-to-end without human intervention.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-social-hospitality-db09b2fc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Social - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your hospitality with Enterprise Social - Hospitality. Our autonomous solution handles api management end-to-end without human intervention.
          </p>
