...
export const metadata: Metadata = {
  title: "Accounts Payable AI-Powered Chatbot Builder - AI-Powered Accounts Payable Solution",
  description: "AI-powered accounts payable solution for customer service. Creates intelligent chatbots for customer service and lead generation.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/accounts-payable-ai-powered-chatbot-builder-7a87fe77",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Accounts Payable AI-Powered Chatbot Builder - AI-Powered Accounts Payable Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          AI-powered accounts payable solution for customer service. Creates intelligent chatbots for customer service and lead generation.
        </p>
