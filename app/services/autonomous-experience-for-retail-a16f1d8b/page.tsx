...
export const metadata: Metadata = {
  title: 'Autonomous Experience for Retail',
  description: 'Next-generation retail solution: Autonomous Experience for Retail. Combines image recognition with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-experience-for-retail-a16f1d8b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Experience for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation retail solution: Autonomous Experience for Retail. Combines image recognition with adaptive intelligence for optimal results.
          </p>
