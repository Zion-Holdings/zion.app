...
export const metadata: Metadata = {
  title: 'Enterprise Scale-up Platform - PROPTECH',
  description: 'Optimize your proptech workflows with Enterprise Scale-up Platform - PROPTECH. This intelligent platform delivers performance tracking through advanced automati',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-scale-up-platform-proptech-83bb05df',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Scale-up Platform - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your proptech workflows with Enterprise Scale-up Platform - PROPTECH. This intelligent platform delivers performance tracking through advanced automation and AI.
          </p>
