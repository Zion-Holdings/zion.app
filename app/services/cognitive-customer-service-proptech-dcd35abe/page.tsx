...
export const metadata: Metadata = {
  title: 'Cognitive customer service-proptech',
  description: 'Transform your proptech operations with our Cognitive customer service-proptech. This AI-driven solution automates threat detection with unprecedented accuracy ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-customer-service-proptech-dcd35abe',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive customer service-proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your proptech operations with our Cognitive customer service-proptech. This AI-driven solution automates threat detection with unprecedented accuracy and efficiency.
          </p>
