...
export const metadata: Metadata = {
  title: 'Smart Experience Platform - Transportation',
  description: 'Optimize your transportation workflows with Smart Experience Platform - Transportation. This intelligent platform delivers resource utilization through advanced',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-experience-platform-transportation-2f72f933',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Experience Platform - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Smart Experience Platform - Transportation. This intelligent platform delivers resource utilization through advanced automation and AI.
          </p>
