...
export const metadata: Metadata = {
  ...
  keywords: '10K+ lever scoring, Experiment ROI ranking per stage, Competitor signal + gap detection, GTM strategy auto-draft per priority lever, ai, E-Commerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Growth Intelligence Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Scans 10K+ growth levers: pricing positioning channel mix funnel competitor moves. ML ranks highest-ROI experiments per your stage market unit economics.</p>
        ...
        <li class="text-slate-300">10K+ lever scoring</li>
        <li class="text-slate-300">Experiment ROI ranking per stage</li>
        <li class="text-slate-300">Competitor signal + gap detection</li>
        <li class="text-slate-300">GTM strategy auto-draft per priority lever</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai growth intelligence platform</li>
