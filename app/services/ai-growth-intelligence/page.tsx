      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Scans 10K+ growth levers: pricing positioning channel mix funnel competitor moves. ML ranks highest-ROI experiments per your stage market unit economics.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ 10K+ lever scoring</li>
            <li className="text-purple-300">✓ Experiment ROI ranking per stage</li>
            <li className="text-purple-300">✓ Competitor signal + gap detection</li>
            <li className="text-purple-300">✓ GTM strategy auto-draft per priority lever</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai growth intelligence platform</li>
