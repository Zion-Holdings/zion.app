...
export const metadata: Metadata = {
  title: 'AI Compliance - Construction Edition',
  description: 'Unlock unprecedented growth with AI Compliance - Construction Edition. This autonomous system provides intelligent automation with zero manual intervention need',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-compliance-construction-edition-03c2da76',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Compliance - Construction Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with AI Compliance - Construction Edition. This autonomous system provides intelligent automation with zero manual intervention needed.
          </p>
