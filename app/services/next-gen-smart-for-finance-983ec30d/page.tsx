...
export const metadata: Metadata = {
  title: 'Next-Gen Smart for Finance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Smart for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your finance business with Next-Gen Smart for Finance. Our solution provides margin analysis with enterprise-grade reliability and security.
          </p>
