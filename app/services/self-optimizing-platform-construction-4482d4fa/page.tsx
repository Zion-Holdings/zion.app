...
export const metadata: Metadata = {
  title: 'Self-Optimizing platform-construction',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing platform-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Self-Optimizing platform-construction. This AI-powered platform transforms disaster recovery into a competitive advantage.
          </p>
