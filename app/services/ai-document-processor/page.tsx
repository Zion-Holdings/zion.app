...
export const metadata: Metadata = {
  ...
  description: "Advanced document AI platform that extracts, classifies, and structures data from any document type \u2014 PDFs, scans, forms, contracts, invoices. Goes beyond OCR with contextual understanding, table extraction, and automate",
  openGraph: {
    title: "AI Document Understanding Engine | Zion Tech Group",
    description: "Advanced document AI platform that extracts, classifies, and structures data from any document type \u2014 PDFs, scans, forms, contracts, invoices. Goes beyond OCR with contextual understanding, table extraction, and automate",
    url: "https://ziontechgroup.com/services/ai-document-processor/",
    type: 'website',
  },
  alternates: { canonical: "/services/ai-document-processor/" },
};
...
export default function AiDocumentProcessorPage() {
  return (
    <StandardPage
      ...
      subtitle="Advanced document AI platform that extracts, classifies, and structures data from any document type \u2014 PDFs, scans, forms, contracts, invoices. Goes beyond OCR with contextual understanding, table extraction, and automate"
      breadcrumbItems={[
        { label: "Home", href: "/" },
        { label: "Services", href: "/services/" },
        { label: "AI Document Understanding Engine" }
      ]}
      actions={[
    ...
    >
        ...
        <div className="rounded-2xl border border-white/10 bg-slate-900/40 p-5"><h2 className="text-white font-semibold mb-2">AI Document Understanding Engine</h2><p className="text-slate-400 text-sm">Archived section recovered from the live site snapshot.</p></div>
      ...
      <p className="text-slate-400 leading-relaxed mb-4 max-w-5xl mx-auto">Estimated timeline for AI Document Understanding Engine — adapt to your team size and complexity.</p>
      ...
      <p className="text-slate-500 text-sm max-w-5xl mx-auto">Restored from a Wayback Machine snapshot (20260607102640) of ziontechgroup.com.</p>
    </StandardPage>
  );
}
