...
export const metadata: Metadata = {
  title: 'Predictive Experience Engine - Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Predictive Experience Engine - Hospitality leverages advanced machine learning to deliver account ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-experience-engine-hospitality-0d6c11c3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Experience Engine - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Predictive Experience Engine - Hospitality leverages advanced machine learning to deliver account planning at scale.
          </p>
