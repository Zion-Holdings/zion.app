...
export const metadata: Metadata = {
  title: 'Automated Workflow Finance',
  description: 'Next-generation proptech solution: Automated Workflow Finance. Combines process automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-workflow-finance-16bffbd2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Workflow Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation proptech solution: Automated Workflow Finance. Combines process automation with adaptive intelligence for optimal results.
          </p>
