...
export const metadata: Metadata = {
  title: 'Smart Quality Platform - Finance',
  description: 'The future of finance is here with Smart Quality Platform - Finance. Powered by cutting-edge AI, this platform delivers language processing like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-quality-platform-finance-2e8c73e6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Quality Platform - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of finance is here with Smart Quality Platform - Finance. Powered by cutting-edge AI, this platform delivers language processing like never before.
          </p>
