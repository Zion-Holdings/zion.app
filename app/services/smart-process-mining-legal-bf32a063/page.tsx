...
export const metadata: Metadata = {
  title: 'Smart process mining-legal',
  description: 'Transform your legal operations with our Smart process mining-legal. This AI-driven solution provides intelligent automation with unprecedented accuracy and eff',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-process-mining-legal-bf32a063',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart process mining-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Smart process mining-legal. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
