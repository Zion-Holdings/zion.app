...
export const metadata: Metadata = {
  title: 'Supply Predictive - Hospitality',
  description: 'Next-generation hospitality solution: Supply Predictive - Hospitality. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/supply-predictive-hospitality-8713cb03',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Supply Predictive - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Supply Predictive - Hospitality. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
