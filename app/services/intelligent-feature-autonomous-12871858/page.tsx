...
export const metadata: Metadata = {
  title: 'Intelligent Feature Autonomous',
  description: 'Revolutionize energy through intelligent automation. Our Intelligent Feature Autonomous leverages advanced machine learning to deliver vendor management at scal',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Feature Autonomous
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Intelligent Feature Autonomous leverages advanced machine learning to deliver vendor management at scale.
          </p>
