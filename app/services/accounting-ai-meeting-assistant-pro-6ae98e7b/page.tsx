...
export const metadata: Metadata = {
  title: 'Accounting AI Meeting Assistant Pro',
  description: 'AI-powered accounting solution for productivity. AI-powered meeting assistant that generates agendas, takes notes, and schedules follow-ups.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/accounting-ai-meeting-assistant-pro-6ae98e7b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Accounting AI Meeting Assistant Pro
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered accounting solution for productivity. AI-powered meeting assistant that generates agendas, takes notes, and schedules follow-ups.
          </p>
