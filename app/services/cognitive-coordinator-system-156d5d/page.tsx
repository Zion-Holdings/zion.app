...
export const metadata: Metadata = {
  title: 'Cognitive Coordinator System',
  description: 'Transform your construction operations with our Cognitive Coordinator System. This automation solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-coordinator-system-156d5d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Coordinator System
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Cognitive Coordinator System. This automation solution delivers unprecedented automation and intelligence.
          </p>
