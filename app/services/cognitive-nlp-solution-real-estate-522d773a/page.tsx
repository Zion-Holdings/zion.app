...
export const metadata: Metadata = {
  title: 'Cognitive NLP Solution - Real-Estate',
  description: 'Future-proof your real-estate with Cognitive NLP Solution - Real-Estate. Our autonomous solution handles user provisioning end-to-end without human intervention',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-nlp-solution-real-estate-522d773a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive NLP Solution - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your real-estate with Cognitive NLP Solution - Real-Estate. Our autonomous solution handles user provisioning end-to-end without human intervention.
          </p>
