...
export const metadata: Metadata = {
  title: 'Intelligent Risk for Agriculture #2',
  description: 'The future of agriculture is here with Intelligent Risk for Agriculture #2. Powered by cutting-edge AI, this platform delivers feature engineering like never be',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Risk for Agriculture #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Intelligent Risk for Agriculture #2. Powered by cutting-edge AI, this platform delivers feature engineering like never before.
          </p>
