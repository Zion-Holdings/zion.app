...
export const metadata: Metadata = {
  title: 'Autonomous Customer Service System - Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Autonomous Customer Service System - Hospitality leverages advanced machine learning to deliver co',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Customer Service System - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Autonomous Customer Service System - Hospitality leverages advanced machine learning to deliver competitive intelligence at scale.
          </p>
