...
export const metadata: Metadata = {
  title: 'Intelligent AI for Gaming',
  description: 'Next-generation gaming solution: Intelligent AI for Gaming. Combines forecast accuracy with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-ai-for-gaming-d620b21c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent AI for Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation gaming solution: Intelligent AI for Gaming. Combines forecast accuracy with adaptive intelligence for optimal results.
          </p>
