...
export const metadata: Metadata = {
  ...
  description: 'Transform your healthcare operations with our Neural Manager for Healthcare. This AI-driven solution automates customer insights with unprecedented accuracy and',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Neural Manager for Healthcare. This AI-driven solution automates customer insights with unprecedented accuracy and efficiency.
          </p>
