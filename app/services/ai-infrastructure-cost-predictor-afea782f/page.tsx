...
export const metadata: Metadata = {
  title: 'AI Infrastructure Cost Predictor',
  description: 'Predicts and optimizes cloud infrastructure costs for AI workloads before deployment.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-infrastructure-cost-predictor-afea782f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Predicts and optimizes cloud infrastructure costs for AI workloads before deployment.
          </p>
