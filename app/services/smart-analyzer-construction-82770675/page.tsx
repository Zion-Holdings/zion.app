...
export const metadata: Metadata = {
  title: 'Smart analyzer-construction',
  description: 'Transform your construction operations with our Smart analyzer-construction. This AI-driven solution provides intelligent automation with unprecedented accuracy',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-analyzer-construction-82770675',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart analyzer-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Smart analyzer-construction. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
