...
export const metadata: Metadata = {
  title: 'Predictive Market Sales',
  description: 'Transform your proptech operations with our Predictive Market Sales. This AI-driven solution automates inventory management with unprecedented accuracy and effi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Market Sales
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your proptech operations with our Predictive Market Sales. This AI-driven solution automates inventory management with unprecedented accuracy and efficiency.
          </p>
