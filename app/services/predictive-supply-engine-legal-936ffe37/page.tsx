...
export const metadata: Metadata = {
  title: 'Predictive Supply Engine - Legal',
  description: 'Optimize your legal workflows with Predictive Supply Engine - Legal. This intelligent platform delivers predictive modeling through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-supply-engine-legal-936ffe37',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Supply Engine - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with Predictive Supply Engine - Legal. This intelligent platform delivers predictive modeling through advanced automation and AI.
          </p>
