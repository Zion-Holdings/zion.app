...
export const metadata: Metadata = {
  title: 'Supply Intelligent - Finance',
  description: 'Transform your finance operations with our Supply Intelligent - Finance. This AI-driven solution provides intelligent automation with unprecedented accuracy and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/supply-intelligent-finance-f1d5cb76',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Supply Intelligent - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Supply Intelligent - Finance. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
