...
export const metadata: Metadata = {
  title: 'Smart Support Platform - Automotive',
  description: 'Optimize your automotive workflows with Smart Support Platform - Automotive. This intelligent platform delivers customer insights through advanced automation an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Support Platform - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your automotive workflows with Smart Support Platform - Automotive. This intelligent platform delivers customer insights through advanced automation and AI.
          </p>
