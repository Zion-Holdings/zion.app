...
export const metadata: Metadata = {
  ...
  keywords: 'Centralized log collection from any source, Real-time log analysis and correlation, Custom alerting and dashboards, Compliance reporting (SOC 2, HIPAA, PCI), Long-term log retention and archiving, Integration with 200+ data sources, it, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Log Management &amp; SIEM</h1>
        <p className="text-lg text-slate-300 mb-8">Centralized log management with real-time analysis, correlation, and alerting. Ingest logs from any source and detect threats, anomalies, and operational issues.</p>
        ...
        <li class="text-slate-300">Centralized log collection from any source</li>
        <li class="text-slate-300">Real-time log analysis and correlation</li>
        <li class="text-slate-300">Custom alerting and dashboards</li>
        <li class="text-slate-300">Compliance reporting (SOC 2, HIPAA, PCI)</li>
        <li class="text-slate-300">Long-term log retention and archiving</li>
        <li class="text-slate-300">Integration with 200+ data sources</li>
      </ul>
        </div>
        ...
        <li class="text-slate-300">Meet compliance log retention requirements</li>
        <li class="text-slate-300">Troubleshoot issues 10x faster</li>
        <li class="text-slate-300">Centralize all logs in one platform</li>
      </ul>
        </div>
