...
export const metadata: Metadata = {
  title: 'Autonomous Risk System - Tech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Risk System - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your technology workflows with Autonomous Risk System - Tech. This intelligent platform delivers root cause analysis through advanced automation and AI.
          </p>
