...
export const metadata: Metadata = {
  title: 'Quantum Automation - Telecom Quantum',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Automation - Telecom Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your telecom business with Quantum Automation - Telecom Quantum. Our solution provides contract analysis with enterprise-grade reliability and security.
          </p>
