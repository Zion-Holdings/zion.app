...
export const metadata: Metadata = {
  title: 'Smart Manufacturing for Legal',
  description: 'Unlock unprecedented growth with Smart Manufacturing for Legal. This autonomous system provides process automation with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-manufacturing-for-legal-dce8c178',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manufacturing for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Manufacturing for Legal. This autonomous system provides process automation with zero manual intervention needed.
          </p>
