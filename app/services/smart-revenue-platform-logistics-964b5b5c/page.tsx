...
export const metadata: Metadata = {
  title: 'Smart Revenue Platform - Logistics',
  description: 'Enhance your logistics business with Smart Revenue Platform - Logistics. Our solution provides expense management with enterprise-grade reliability and security',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-revenue-platform-logistics-964b5b5c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Revenue Platform - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with Smart Revenue Platform - Logistics. Our solution provides expense management with enterprise-grade reliability and security.
          </p>
