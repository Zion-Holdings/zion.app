...
export const metadata = {
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/player-retention-process-intelligence-platform-08ad9f33`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Player Retention Process Intelligence Platform</h1>
