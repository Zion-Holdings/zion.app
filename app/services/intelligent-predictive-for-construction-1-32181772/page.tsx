...
export const metadata: Metadata = {
  title: 'Intelligent Predictive for Construction #1',
  description: 'Drive innovation in construction with Intelligent Predictive for Construction #1. This AI-powered platform transforms scenario planning into a competitive advan',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Predictive for Construction #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Intelligent Predictive for Construction #1. This AI-powered platform transforms scenario planning into a competitive advantage.
          </p>
