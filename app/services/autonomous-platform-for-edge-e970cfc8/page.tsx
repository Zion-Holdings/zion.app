...
export const metadata: Metadata = {
  title: 'Autonomous Platform for Edge',
  description: 'Unlock unprecedented growth with Autonomous Platform for Edge. This autonomous system provides resource optimization with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-platform-for-edge-e970cfc8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Platform for Edge
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Autonomous Platform for Edge. This autonomous system provides resource optimization with zero manual intervention needed.
          </p>
