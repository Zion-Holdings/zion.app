...
export const metadata: Metadata = {
  title: 'Manager Automated - Transportation',
  description: 'Enhance your transportation business with Manager Automated - Transportation. Our solution provides code optimization with enterprise-grade reliability and secu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/manager-automated-transportation-378110a8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manager Automated - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with Manager Automated - Transportation. Our solution provides code optimization with enterprise-grade reliability and security.
          </p>
