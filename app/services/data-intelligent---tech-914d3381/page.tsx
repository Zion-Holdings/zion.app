...
export const metadata: Metadata = {
  title: 'Data Intelligent - Tech',
  description: 'The future of technology is here with Data Intelligent - Tech. Powered by cutting-edge AI, this platform delivers image recognition like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-intelligent---tech-914d3381',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Intelligent - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of technology is here with Data Intelligent - Tech. Powered by cutting-edge AI, this platform delivers image recognition like never before.
          </p>
