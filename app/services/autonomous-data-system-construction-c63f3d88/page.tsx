...
export const metadata: Metadata = {
  title: 'Autonomous Data System - Construction',
  description: 'Enhance your construction business with Autonomous Data System - Construction. Our solution provides api management with enterprise-grade reliability and securi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-data-system-construction-c63f3d88',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Data System - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Autonomous Data System - Construction. Our solution provides api management with enterprise-grade reliability and security.
          </p>
