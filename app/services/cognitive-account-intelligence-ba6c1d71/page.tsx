...
export const metadata: Metadata = {
  title: 'Cognitive Account Intelligence',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Account Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your telecom workflows with Cognitive Account Intelligence. This intelligent platform delivers pipeline management through advanced automation and AI.
          </p>
