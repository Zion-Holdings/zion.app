...
export const metadata: Metadata = {
  title: 'Intelligent Director for Legal',
  description: 'Next-generation legal solution: Intelligent Director for Legal. Combines risk assessment with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-director-for-legal-f6d91762',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Director for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Intelligent Director for Legal. Combines risk assessment with adaptive intelligence for optimal results.
          </p>
