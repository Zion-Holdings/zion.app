...
export const metadata: Metadata = {
  title: 'Predictive Business Intelligence for Logistics',
  description: 'Optimize your logistics workflows with Predictive Business Intelligence for Logistics. This intelligent platform delivers sales forecasting through advanced aut',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Business Intelligence for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your logistics workflows with Predictive Business Intelligence for Logistics. This intelligent platform delivers sales forecasting through advanced automation and AI.
          </p>
