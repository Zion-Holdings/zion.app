...
export const metadata: Metadata = {
  title: 'Intelligent suite-healthcare',
  description: 'Transform your healthcare operations with our Intelligent suite-healthcare. This AI-driven solution automates content generation with unprecedented accuracy and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-suite-healthcare-d16089d4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent suite-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Intelligent suite-healthcare. This AI-driven solution automates content generation with unprecedented accuracy and efficiency.
          </p>
