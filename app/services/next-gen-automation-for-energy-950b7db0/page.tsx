...
export const metadata: Metadata = {
  title: 'Next-Gen Automation for Energy',
  description: 'Drive innovation in energy with Next-Gen Automation for Energy. This AI-powered platform transforms data processing into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-automation-for-energy-950b7db0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Automation for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Next-Gen Automation for Energy. This AI-powered platform transforms data processing into a competitive advantage.
          </p>
