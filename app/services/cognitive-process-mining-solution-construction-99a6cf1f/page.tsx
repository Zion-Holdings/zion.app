...
export const metadata: Metadata = {
  title: 'Cognitive Process Mining Solution - Construction',
  description: 'Next-generation construction solution: Cognitive Process Mining Solution - Construction. Combines performance tuning with adaptive intelligence for optimal resu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-process-mining-solution-construction-99a6cf1f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Process Mining Solution - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Cognitive Process Mining Solution - Construction. Combines performance tuning with adaptive intelligence for optimal results.
          </p>
