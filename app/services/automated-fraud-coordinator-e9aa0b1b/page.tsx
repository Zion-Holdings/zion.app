...
export const metadata: Metadata = {
  title: 'Automated Fraud Coordinator',
  description: 'Revolutionize logistics through intelligent automation. Our Automated Fraud Coordinator leverages advanced machine learning to deliver enterprise-grade insights',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Fraud Coordinator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Automated Fraud Coordinator leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
