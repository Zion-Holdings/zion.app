...
export const metadata: Metadata = {
  title: 'AI-Powered Platform for Proptech',
  description: 'Next-generation proptech solution: AI-Powered Platform for Proptech. Combines security monitoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-platform-for-proptech-99a5e336',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Platform for Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation proptech solution: AI-Powered Platform for Proptech. Combines security monitoring with adaptive intelligence for optimal results.
          </p>
