...
export const metadata: Metadata = {
  title: 'Intelligent Intelligent for Education',
  description: 'Optimize your education workflows with Intelligent Intelligent for Education. This intelligent platform delivers sourcing optimization through advanced automati',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-intelligent-for-education-7a47dbba',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Intelligent for Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your education workflows with Intelligent Intelligent for Education. This intelligent platform delivers sourcing optimization through advanced automation and AI.
          </p>
