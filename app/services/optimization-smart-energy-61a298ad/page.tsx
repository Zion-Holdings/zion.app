...
export const metadata: Metadata = {
  title: 'Optimization Smart - Energy',
  description: 'Next-generation energy solution: Optimization Smart - Energy. Combines recruitment automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/optimization-smart-energy-61a298ad',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Optimization Smart - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Optimization Smart - Energy. Combines recruitment automation with adaptive intelligence for optimal results.
          </p>
