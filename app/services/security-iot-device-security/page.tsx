...
export const metadata: Metadata = {
  ...
  keywords: 'Device inventory and classification, Firmware vulnerability scanning, Behavioral anomaly detection, Automated patch management, Network segmentation recommendations, Compliance for IEC 62443, NIST, Integration with AWS IoT, Azure IoT Hub, Real-time threat intelligence feeds, security, IoT, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IoT Device Security Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Secure IoT device fleets with continuous monitoring, firmware vulnerability detection, and automated patch management for industrial and consumer IoT.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">security</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">IoT</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Device inventory and classification</li>
        <li class="text-slate-300">Firmware vulnerability scanning</li>
        <li class="text-slate-300">Behavioral anomaly detection</li>
        <li class="text-slate-300">Automated patch management</li>
        <li class="text-slate-300">Network segmentation recommendations</li>
        <li class="text-slate-300">Compliance for IEC 62443, NIST</li>
        <li class="text-slate-300">Integration with AWS IoT, Azure IoT Hub</li>
        <li class="text-slate-300">Real-time threat intelligence feeds</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Prevent IoT botnet recruitment</li>
        <li class="text-slate-300">Ensure firmware integrity</li>
        <li class="text-slate-300">Meet IoT security compliance</li>
        <li class="text-slate-300">Reduce breach risk across device fleets</li>
      </ul>
        </div>
