...
export const metadata: Metadata = {
  title: 'Inventory AI-Powered Data Privacy',
  description: 'AI-powered inventory solution for compliance. GDPR/CCPA compliance automation with automated data redaction.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/inventory-ai-powered-data-privacy-23438751',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Inventory AI-Powered Data Privacy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered inventory solution for compliance. GDPR/CCPA compliance automation with automated data redaction.
          </p>
