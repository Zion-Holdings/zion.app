...
export const metadata: Metadata = {
  title: 'Cognitive Platform Solution - Hospitality',
  description: 'Enhance your hospitality business with Cognitive Platform Solution - Hospitality. Our solution provides quota optimization with enterprise-grade reliability and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-platform-solution-hospitality-024731ba',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Platform Solution - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Cognitive Platform Solution - Hospitality. Our solution provides quota optimization with enterprise-grade reliability and security.
          </p>
