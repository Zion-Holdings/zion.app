...
export const metadata: Metadata = {
  title: 'AI-Powered Predictive Quality',
  description: 'Optimize your telecom workflows with AI-Powered Predictive Quality. This intelligent platform delivers manufacturing quality control through advanced automation',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your telecom workflows with AI-Powered Predictive Quality. This intelligent platform delivers manufacturing quality control through advanced automation and AI.
          </p>
