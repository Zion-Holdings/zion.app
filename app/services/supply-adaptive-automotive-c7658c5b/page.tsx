...
export const metadata: Metadata = {
  title: 'Supply Adaptive - Automotive',
  description: 'Next-generation automotive solution: Supply Adaptive - Automotive. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/supply-adaptive-automotive-c7658c5b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Supply Adaptive - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation automotive solution: Supply Adaptive - Automotive. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
