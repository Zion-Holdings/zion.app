...
export const metadata = {
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/warehouse-automation-orchestrator-28532089`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path={`/services/warehouse-automation-orchestrator-28532089`} title="Warehouse Automation Orchestrator" />
