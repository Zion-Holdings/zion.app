...
export const metadata: Metadata = {
  title: 'Cognitive Sales for Construction',
  description: 'Revolutionize construction through intelligent automation. Our Cognitive Sales for Construction leverages advanced machine learning to deliver budget optimizati',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-sales-for-construction-fd07d3fb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Sales for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Cognitive Sales for Construction leverages advanced machine learning to deliver budget optimization at scale.
          </p>
