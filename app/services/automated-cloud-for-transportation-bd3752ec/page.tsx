...
export const metadata: Metadata = {
  title: 'Automated Cloud for Transportation',
  description: 'Next-generation transportation solution: Automated Cloud for Transportation. Combines supply chain with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-cloud-for-transportation-bd3752ec',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Cloud for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation transportation solution: Automated Cloud for Transportation. Combines supply chain with adaptive intelligence for optimal results.
          </p>
