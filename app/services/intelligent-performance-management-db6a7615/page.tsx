...
export const metadata: Metadata = {
  ...
  description: 'The future of agriculture is here with Intelligent Performance Management. Powered by cutting-edge AI, this platform delivers performance monitoring like never ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-performance-management-db6a7615',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Intelligent Performance Management. Powered by cutting-edge AI, this platform delivers performance monitoring like never before.
          </p>
