...
export const metadata: Metadata = {
  title: 'Cognitive Supply for Gaming',
  description: 'The future of gaming is here with Cognitive Supply for Gaming. Powered by cutting-edge AI, this platform delivers energy management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-supply-for-gaming-e9f369c1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Supply for Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of gaming is here with Cognitive Supply for Gaming. Powered by cutting-edge AI, this platform delivers energy management like never before.
          </p>
