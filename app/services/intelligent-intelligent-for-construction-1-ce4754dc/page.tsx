...
export const metadata: Metadata = {
  title: 'Intelligent Intelligent for Construction #1',
  description: 'Optimize your construction workflows with Intelligent Intelligent for Construction #1. This intelligent platform delivers data processing through advanced autom',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-intelligent-for-construction-1-ce4754dc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Intelligent for Construction #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Intelligent Intelligent for Construction #1. This intelligent platform delivers data processing through advanced automation and AI.
          </p>
