...
export const metadata: Metadata = {
  title: 'Neural Document Analytics',
  description: 'Transform your manufacturing operations with our Neural Document Analytics. This AI-driven solution automates image recognition with unprecedented accuracy and ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your manufacturing operations with our Neural Document Analytics. This AI-driven solution automates image recognition with unprecedented accuracy and efficiency.
          </p>
