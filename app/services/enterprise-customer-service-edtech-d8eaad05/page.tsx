...
export const metadata: Metadata = {
  title: 'Enterprise customer service-edtech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise customer service-edtech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your edtech workflows with Enterprise customer service-edtech. This intelligent platform delivers data fabric through advanced automation and AI.
          </p>
