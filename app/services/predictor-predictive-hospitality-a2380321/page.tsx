...
export const metadata: Metadata = {
  ...
  description: 'Optimize your hospitality workflows with Predictor Predictive - Hospitality. This intelligent platform delivers supply chain through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictor-predictive-hospitality-a2380321',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Predictor Predictive - Hospitality. This intelligent platform delivers supply chain through advanced automation and AI.
          </p>
