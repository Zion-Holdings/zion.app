...
export const metadata: Metadata = {
  title: 'Intelligent Project Deep Learning',
  description: 'Transform your finance operations with our Intelligent Project Deep Learning. This AI-driven solution automates maintenance scheduling with unprecedented accura',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-project-deep-learning-d3a7df28',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Project Deep Learning
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Intelligent Project Deep Learning. This AI-driven solution automates maintenance scheduling with unprecedented accuracy and efficiency.
          </p>
