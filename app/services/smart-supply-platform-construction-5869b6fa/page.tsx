...
export const metadata: Metadata = {
  title: 'Smart Supply Platform - Construction',
  description: 'The future of construction is here with Smart Supply Platform - Construction. Powered by cutting-edge AI, this platform delivers performance reviews like never ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-supply-platform-construction-5869b6fa',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Supply Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Smart Supply Platform - Construction. Powered by cutting-edge AI, this platform delivers performance reviews like never before.
          </p>
