...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'ReviewPulse — Review Management', 'description': 'Monitor, respond to, and analyze reviews across Google, Yelp, Trustpilot, G2, and App Stores. AI-generated responses and sentiment trend tracking.', 'serviceType': 'micro-saas', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'Marketing'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'ReviewPulse — Review Management Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$39/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$119/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': '$399/mo', 'priceCurrency': 'USD'}]}} />
    <JsonLd data={'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'Multi-platform review monitoring', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Multi-platform review monitoring'}}, {'@type': 'Question', 'name': 'AI-generated response drafts', 'acceptedAnswer': {'@type': 'Answer', 'text': 'AI-generated response drafts'}}, {'@type': 'Question', 'name': 'Sentiment trend tracking and alerting', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Sentiment trend tracking and alerting'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Respond to every review in minutes with AI; Sentiment trends detect product issues early; Review requests increase rating volume'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} />
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>Google, Yelp, Trustpilot, G2, App Store support</li>
          </ul>
        </div>
