...
export const metadata: Metadata = {
  title: 'Cognitive Cognitive Solution - Real-Estate',
  description: 'Transform your real-estate operations with our Cognitive Cognitive Solution - Real-Estate. This AI-driven solution automates project portfolio with unprecedente',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-cognitive-solution-real-estate-983dc3f2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Cognitive Solution - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Cognitive Cognitive Solution - Real-Estate. This AI-driven solution automates project portfolio with unprecedented accuracy and efficiency.
          </p>
