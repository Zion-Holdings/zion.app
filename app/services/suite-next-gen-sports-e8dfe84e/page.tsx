...
export const metadata: Metadata = {
  title: 'Suite Next-Gen - Sports',
  description: 'Transform sports with Suite Next-Gen - Sports - the intelligent automation platform that learns, adapts, and delivers 10x results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/suite-next-gen-sports-e8dfe84e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Suite Next-Gen - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform sports with Suite Next-Gen - Sports - the intelligent automation platform that learns, adapts, and delivers 10x results.
          </p>
