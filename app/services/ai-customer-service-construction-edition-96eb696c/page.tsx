...
export const metadata: Metadata = {
  title: 'AI Customer Service - Construction Edition',
  description: 'Revolutionize construction through intelligent automation. Our AI Customer Service - Construction Edition leverages advanced machine learning to deliver feedbac',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Customer Service - Construction Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our AI Customer Service - Construction Edition leverages advanced machine learning to deliver feedback collection at scale.
          </p>
