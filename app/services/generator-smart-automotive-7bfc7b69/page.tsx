...
export const metadata: Metadata = {
  title: 'Generator Smart - Automotive',
  description: 'Enhance your automotive business with Generator Smart - Automotive. Our solution provides feedback collection with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/generator-smart-automotive-7bfc7b69',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Generator Smart - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your automotive business with Generator Smart - Automotive. Our solution provides feedback collection with enterprise-grade reliability and security.
          </p>
