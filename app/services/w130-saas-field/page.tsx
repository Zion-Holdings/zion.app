...
export const metadata: Metadata = {
  ...
  keywords: 'AI scheduling & dispatch, Route optimization, Predictive maintenance alerts, Mobile technician app, Parts inventory management, Customer portal, SLA tracking, Photo/video documentation, micro-saas, field-services, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Field Service Management</h1>
        <p className="text-lg text-slate-300 mb-8">Optimize field operations with AI scheduling, route optimization, and predictive maintenance. Mobile-first platform for technicians and dispatchers.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">micro-saas</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">field-services</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">AI scheduling &amp; dispatch</li>
        <li class="text-slate-300">Route optimization</li>
        <li class="text-slate-300">Predictive maintenance alerts</li>
        <li class="text-slate-300">Mobile technician app</li>
        <li class="text-slate-300">Parts inventory management</li>
        <li class="text-slate-300">Customer portal</li>
        <li class="text-slate-300">SLA tracking</li>
        <li class="text-slate-300">Photo/video documentation</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">35% more jobs per day</li>
        <li class="text-slate-300">25% fuel cost reduction</li>
        <li class="text-slate-300">92% SLA compliance</li>
        <li class="text-slate-300">Faster first-time fix rate</li>
        <li class="text-slate-300">Improved customer satisfaction</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">2497</p>
