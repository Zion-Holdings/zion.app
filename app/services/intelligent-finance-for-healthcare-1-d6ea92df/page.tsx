...
export const metadata: Metadata = {
  title: 'Intelligent Finance for Healthcare #1',
  description: 'Enhance your healthcare business with Intelligent Finance for Healthcare #1. Our solution provides disaster recovery with enterprise-grade reliability and secur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-finance-for-healthcare-1-d6ea92df',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Finance for Healthcare #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with Intelligent Finance for Healthcare #1. Our solution provides disaster recovery with enterprise-grade reliability and security.
          </p>
