...
export const metadata: Metadata = {
  title: 'Smart Recruitment Suite - Transportation',
  description: 'Enhance your transportation business with Smart Recruitment Suite - Transportation. Our solution provides maintenance scheduling with enterprise-grade reliabili',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Recruitment Suite - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with Smart Recruitment Suite - Transportation. Our solution provides maintenance scheduling with enterprise-grade reliability and security.
          </p>
