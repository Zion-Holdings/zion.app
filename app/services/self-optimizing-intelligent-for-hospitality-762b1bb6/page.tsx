...
export const metadata: Metadata = {
  title: 'Self-Optimizing Intelligent for Hospitality',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Intelligent for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Self-Optimizing Intelligent for Hospitality. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
