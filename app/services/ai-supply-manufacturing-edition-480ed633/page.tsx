...
export const metadata: Metadata = {
  title: 'AI Supply - Manufacturing Edition',
  description: 'Revolutionize manufacturing through intelligent automation. Our AI Supply - Manufacturing Edition leverages advanced machine learning to deliver recruitment aut',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Supply - Manufacturing Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize manufacturing through intelligent automation. Our AI Supply - Manufacturing Edition leverages advanced machine learning to deliver recruitment automation at scale.
          </p>
