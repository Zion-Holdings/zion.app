...
export const metadata: Metadata = {
  title: 'Automated insights-agriculture',
  description: 'Enhance your agriculture business with Automated insights-agriculture. Our solution provides data quality with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-insights-agriculture-da2c7f35',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated insights-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your agriculture business with Automated insights-agriculture. Our solution provides data quality with enterprise-grade reliability and security.
          </p>
