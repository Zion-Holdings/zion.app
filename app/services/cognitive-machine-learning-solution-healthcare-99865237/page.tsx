  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Drive innovation in healthcare with Cognitive Machine Learning Solution - Healthcare. This AI-powered platform transforms user experience into a competitive advantage.</p>
