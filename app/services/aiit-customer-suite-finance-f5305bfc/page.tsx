...
export const metadata: Metadata = {
  title: 'AI/IT Customer Suite - Finance',
  description: 'Revolutionize finance through intelligent automation. Our AI/IT Customer Suite - Finance leverages advanced machine learning to deliver budget optimization at s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-customer-suite-finance-f5305bfc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Customer Suite - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our AI/IT Customer Suite - Finance leverages advanced machine learning to deliver budget optimization at scale.
          </p>
