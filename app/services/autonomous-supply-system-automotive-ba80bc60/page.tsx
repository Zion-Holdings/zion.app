...
export const metadata: Metadata = {
  title: 'Autonomous Supply System - Automotive',
  description: 'Transform your automotive operations with our Autonomous Supply System - Automotive. This AI-driven solution automates compensation management with unprecedente',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Supply System - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your automotive operations with our Autonomous Supply System - Automotive. This AI-driven solution automates compensation management with unprecedented accuracy and efficiency.
          </p>
