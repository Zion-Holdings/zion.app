...
export const metadata: Metadata = {
  title: 'Smart Customer Service Platform - Insurance',
  description: 'Drive innovation in insurance with Smart Customer Service Platform - Insurance. This AI-powered platform transforms sourcing optimization into a competitive adv',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-customer-service-platform-insurance-7a9d97c2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Customer Service Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Smart Customer Service Platform - Insurance. This AI-powered platform transforms sourcing optimization into a competitive advantage.
          </p>
