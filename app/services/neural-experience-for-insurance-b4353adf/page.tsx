...
export const metadata: Metadata = {
  title: 'Neural Experience for Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Neural Experience for Insurance leverages advanced machine learning to deliver user experience at sc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-experience-for-insurance-b4353adf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Experience for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Neural Experience for Insurance leverages advanced machine learning to deliver user experience at scale.
          </p>
