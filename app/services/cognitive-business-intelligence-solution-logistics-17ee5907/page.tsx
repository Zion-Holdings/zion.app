...
export const metadata: Metadata = {
  title: 'Cognitive Business Intelligence Solution - Logistics',
  description: 'Drive innovation in logistics with Cognitive Business Intelligence Solution - Logistics. This AI-powered platform transforms data pipeline orchestration into a ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-business-intelligence-solution-logistics-17ee5907',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Business Intelligence Solution - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with Cognitive Business Intelligence Solution - Logistics. This AI-powered platform transforms data pipeline orchestration into a competitive advantage.
          </p>
