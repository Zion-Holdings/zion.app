...
export const metadata: Metadata = {
  title: 'Smart Finance Platform - Healthcare #1',
  description: 'Next-generation healthcare solution: Smart Finance Platform - Healthcare #1. Combines audit trail management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-finance-platform-healthcare-1-c53a5340',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Finance Platform - Healthcare #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Smart Finance Platform - Healthcare #1. Combines audit trail management with adaptive intelligence for optimal results.
          </p>
