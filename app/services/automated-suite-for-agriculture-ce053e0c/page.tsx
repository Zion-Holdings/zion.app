...
export const metadata: Metadata = {
  title: 'Automated Suite for Agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Automated Suite for Agriculture leverages advanced machine learning to deliver threat detection at',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-suite-for-agriculture-ce053e0c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Suite for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Automated Suite for Agriculture leverages advanced machine learning to deliver threat detection at scale.
          </p>
