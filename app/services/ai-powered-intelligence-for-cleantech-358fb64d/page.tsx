...
export const metadata: Metadata = {
  title: 'AI-Powered Intelligence for Cleantech',
  description: 'Revolutionize cleantech through intelligent automation. Our AI-Powered Intelligence for Cleantech leverages advanced machine learning to deliver healthcare data',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-intelligence-for-cleantech-358fb64d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Intelligence for Cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cleantech through intelligent automation. Our AI-Powered Intelligence for Cleantech leverages advanced machine learning to deliver healthcare data analytics at scale.
          </p>
