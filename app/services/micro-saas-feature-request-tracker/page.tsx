...
export const metadata: Metadata = {
  ...
  keywords: 'Public roadmap with voting, AI-powered feedback categorization, Intercom/Zendesk/Slack integration, Customer segmentation by plan, Changelog and release notes, Duplicate request merging, ROI scoring for features, Custom branding and domain, micro-saas, SaaS, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">FeatureVault — Feature Request Tracker</h1>
        <p className="text-lg text-slate-300 mb-8">Customer feedback and feature request management platform. Public roadmap, voting boards, and automatic categorization of feedback using AI. Integrates with Intercom, Zendesk, and Slack.</p>
        ...
        <li class="text-slate-300">Public roadmap with voting</li>
        <li class="text-slate-300">AI-powered feedback categorization</li>
        <li class="text-slate-300">Intercom/Zendesk/Slack integration</li>
        <li class="text-slate-300">Customer segmentation by plan</li>
        <li class="text-slate-300">Changelog and release notes</li>
        <li class="text-slate-300">Duplicate request merging</li>
        <li class="text-slate-300">ROI scoring for features</li>
        <li class="text-slate-300">Custom branding and domain</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Prioritize features by customer demand</li>
        <li class="text-slate-300">Reduce support ticket volume</li>
        <li class="text-slate-300">Increase customer engagement</li>
