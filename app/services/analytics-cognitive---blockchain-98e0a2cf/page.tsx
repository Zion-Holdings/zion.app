...
export const metadata: Metadata = {
  title: 'Analytics Cognitive - Blockchain',
  description: 'Transform your blockchain operations with our Analytics Cognitive - Blockchain. This AI-driven solution automates financial planning with unprecedented accuracy',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Analytics Cognitive - Blockchain
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your blockchain operations with our Analytics Cognitive - Blockchain. This AI-driven solution automates financial planning with unprecedented accuracy and efficiency.
          </p>
