...
export const metadata: Metadata = {
  ...
  description: 'Automates insurance claims processing with AI-powered document analysis and fraud detection.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-insurance-claims-automation2026-07-28t0321551840800000155-893a1ba0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automates insurance claims processing with AI-powered document analysis and fraud detection.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Claims processing</li>
          <li className="text-gray-300">Document analysis</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">80% faster claims</li>
