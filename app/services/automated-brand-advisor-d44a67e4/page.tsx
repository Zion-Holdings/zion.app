...
export const metadata: Metadata = {
  title: 'Automated Brand Advisor',
  description: 'Revolutionize transportation through intelligent automation. Our Automated Brand Advisor leverages advanced machine learning to deliver enterprise-grade insight',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Brand Advisor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize transportation through intelligent automation. Our Automated Brand Advisor leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
