...
export const metadata: Metadata = {
  title: 'Autonomous engine-agritech',
  description: 'Revolutionize agritech through intelligent automation. Our Autonomous engine-agritech leverages advanced machine learning to deliver financial risk management a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous engine-agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agritech through intelligent automation. Our Autonomous engine-agritech leverages advanced machine learning to deliver financial risk management at scale.
          </p>
