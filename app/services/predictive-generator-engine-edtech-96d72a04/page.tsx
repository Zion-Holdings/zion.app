...
export const metadata: Metadata = {
  title: 'Predictive Generator Engine - EDTECH',
  description: 'The future of edtech is here with Predictive Generator Engine - EDTECH. Powered by cutting-edge AI, this platform delivers social media automation like never be',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Generator Engine - EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of edtech is here with Predictive Generator Engine - EDTECH. Powered by cutting-edge AI, this platform delivers social media automation like never before.
          </p>
