...
export const metadata: Metadata = {
  title: 'Inventory Management Zero-Trust Identity & Access Manager',
  description: 'inventory management solution for edtech industry. Implements zero-trust security architecture with continuous authentication and adaptive access controls.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/inventory-management-zero-trust-identity--access-manager-861f82ab',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Inventory Management Zero-Trust Identity & Access Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            inventory management solution for edtech industry. Implements zero-trust security architecture with continuous authentication and adaptive access controls.
          </p>
