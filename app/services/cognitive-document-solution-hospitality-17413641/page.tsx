...
export const metadata: Metadata = {
  title: 'Cognitive Document Solution - Hospitality',
  description: 'Quantum leap forward for hospitality: Cognitive Document Solution - Hospitality. Uses quantum-inspired algorithms to deliver lakehouse architecture at exponenti',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-document-solution-hospitality-17413641',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Document Solution - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for hospitality: Cognitive Document Solution - Hospitality. Uses quantum-inspired algorithms to deliver lakehouse architecture at exponential speed.
          </p>
