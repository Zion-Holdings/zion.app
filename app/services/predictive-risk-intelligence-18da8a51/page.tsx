...
export const metadata: Metadata = {
  ...
  keywords: 'Comprehensive monitoring, Custom integrations, HIPAA ready, Real-time processing, optimization, construction, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Predictive Risk Intelligence</h1>
        <p className="text-lg text-slate-300 mb-8">Transform your construction operations with our Predictive Risk Intelligence. This AI-driven solution automates user experience with unprecedented accuracy and efficiency.</p>
