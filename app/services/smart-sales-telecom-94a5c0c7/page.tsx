...
export const metadata: Metadata = {
  title: 'Smart Sales - Telecom',
  description: 'Transform your telecom operations with Smart Sales - Telecom. This intelligent platform delivers microservices orchestration through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-sales-telecom-94a5c0c7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your telecom operations with Smart Sales - Telecom. This intelligent platform delivers microservices orchestration through advanced automation and AI.
          </p>
