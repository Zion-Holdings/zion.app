...
export const metadata: Metadata = {
  title: 'Autonomous Content Smart',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Content Smart
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in technology with Autonomous Content Smart. This AI-powered platform transforms loyalty optimization into a competitive advantage.
          </p>
