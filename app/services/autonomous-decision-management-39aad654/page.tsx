...
export const metadata: Metadata = {
  title: 'Autonomous Decision Management',
  description: 'Revolutionize edge through intelligent automation. Our Autonomous Decision Management leverages advanced machine learning to deliver customer service automation',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize edge through intelligent automation. Our Autonomous Decision Management leverages advanced machine learning to deliver customer service automation at scale.
          </p>
