...
export const metadata: Metadata = {
  title: 'Smart Network Platform',
  description: 'Revolutionize real-estate through intelligent automation. Our Smart Network Platform leverages advanced machine learning to deliver manufacturing quality contro',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our Smart Network Platform leverages advanced machine learning to deliver manufacturing quality control at scale.
          </p>
