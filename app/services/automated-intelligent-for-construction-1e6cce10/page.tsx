...
export const metadata: Metadata = {
  title: 'Automated Intelligent for Construction',
  description: 'The future of construction is here with Automated Intelligent for Construction. Powered by cutting-edge AI, this platform delivers loyalty optimization like nev',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-intelligent-for-construction-1e6cce10',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Intelligent for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Automated Intelligent for Construction. Powered by cutting-edge AI, this platform delivers loyalty optimization like never before.
          </p>
