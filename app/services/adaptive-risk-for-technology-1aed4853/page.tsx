...
export const metadata: Metadata = {
  title: 'Adaptive Risk for Technology',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Risk for Technology
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our Adaptive Risk for Technology leverages advanced machine learning to deliver supply chain at scale.
          </p>
