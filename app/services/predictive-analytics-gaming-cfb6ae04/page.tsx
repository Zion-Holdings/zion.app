...
export const metadata: Metadata = {
  title: 'Predictive analytics-gaming',
  description: 'Revolutionize gaming through intelligent automation. Our Predictive analytics-gaming leverages advanced machine learning to deliver procurement automation at sc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-analytics-gaming-cfb6ae04',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize gaming through intelligent automation. Our Predictive analytics-gaming leverages advanced machine learning to deliver procurement automation at scale.
          </p>
