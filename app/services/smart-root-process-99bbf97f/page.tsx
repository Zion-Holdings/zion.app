      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your edtech workflows with Smart Root Process. This intelligent platform delivers competitive intelligence through advanced automation and AI.
          </p>
