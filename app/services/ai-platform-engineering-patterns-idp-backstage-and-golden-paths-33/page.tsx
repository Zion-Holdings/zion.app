...
export const metadata = {
  ...
  description: 'End-to-end ai platform engineering patterns: idp, backstage, and golden paths services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/ai-platform-engineering-patterns-idp-backstage-and-golden-paths-33/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">AI Platform Engineering Patterns: IDP, Backstage, and Golden Paths</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end ai platform engineering patterns: idp, backstage, and golden paths services: assessment, deployment, and managed operations.
        </p>
