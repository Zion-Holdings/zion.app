...
export const metadata: Metadata = {
  title: 'Adaptive workflow-healthcare',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive workflow-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with Adaptive workflow-healthcare. This AI-powered platform transforms record extraction into a competitive advantage.
          </p>
