...
export const metadata: Metadata = {
  title: 'Cognitive Automation Solution - Energy',
  description: 'Transform your energy operations with our Cognitive Automation Solution - Energy. This AI-driven solution automates resource utilization with unprecedented accu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Automation Solution - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Cognitive Automation Solution - Energy. This AI-driven solution automates resource utilization with unprecedented accuracy and efficiency.
          </p>
