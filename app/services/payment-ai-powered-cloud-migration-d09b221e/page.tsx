...
export const metadata: Metadata = {
  title: 'Payment AI-Powered Cloud Migration',
  description: 'AI-powered payment solution for cloud migration. Intelligent cloud migration planning and execution.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/payment-ai-powered-cloud-migration-d09b221e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Payment AI-Powered Cloud Migration
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered payment solution for cloud migration. Intelligent cloud migration planning and execution.
          </p>
