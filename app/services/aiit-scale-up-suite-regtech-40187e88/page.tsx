...
export const metadata: Metadata = {
  title: 'AI/IT Scale-up Suite - REGTECH',
  description: 'Unlock unprecedented growth with AI/IT Scale-up Suite - REGTECH. This autonomous system provides sales process optimization with zero manual intervention needed',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-scale-up-suite-regtech-40187e88',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Scale-up Suite - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with AI/IT Scale-up Suite - REGTECH. This autonomous system provides sales process optimization with zero manual intervention needed.
          </p>
