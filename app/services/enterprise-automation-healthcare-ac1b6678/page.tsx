...
export const metadata: Metadata = {
  title: 'Enterprise Automation - Healthcare',
  description: 'Enhance your healthcare business with Enterprise Automation - Healthcare. Our solution provides brand monitoring with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-automation-healthcare-ac1b6678',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Automation - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with Enterprise Automation - Healthcare. Our solution provides brand monitoring with enterprise-grade reliability and security.
          </p>
