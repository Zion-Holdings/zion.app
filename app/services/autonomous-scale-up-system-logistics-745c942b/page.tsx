...
export const metadata: Metadata = {
  title: 'Autonomous Scale-up System - Logistics',
  description: 'The future of logistics is here with Autonomous Scale-up System - Logistics. Powered by cutting-edge AI, this platform delivers financial planning like never be',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-scale-up-system-logistics-745c942b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Scale-up System - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Autonomous Scale-up System - Logistics. Powered by cutting-edge AI, this platform delivers financial planning like never before.
          </p>
