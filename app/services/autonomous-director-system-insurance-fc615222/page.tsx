...
export const metadata: Metadata = {
  title: 'Autonomous Director System - Insurance',
  description: 'Optimize your insurance workflows with Autonomous Director System - Insurance. This intelligent platform delivers process automation through advanced automation',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Director System - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Autonomous Director System - Insurance. This intelligent platform delivers process automation through advanced automation and AI.
          </p>
