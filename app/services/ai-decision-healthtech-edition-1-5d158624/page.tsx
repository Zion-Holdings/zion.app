...
export const metadata: Metadata = {
  title: 'AI Decision - HEALTHTECH Edition #1',
  description: 'Transform your healthtech operations with our AI Decision - HEALTHTECH Edition #1. This AI-driven solution automates workflow management with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-decision-healthtech-edition-1-5d158624',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Decision - HEALTHTECH Edition #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthtech operations with our AI Decision - HEALTHTECH Edition #1. This AI-driven solution automates workflow management with unprecedented accuracy and efficiency.
          </p>
