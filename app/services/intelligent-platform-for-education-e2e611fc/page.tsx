...
export const metadata: Metadata = {
  title: 'Intelligent Platform for Education',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Platform for Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in education with Intelligent Platform for Education. This AI-powered platform transforms security monitoring into a competitive advantage.
          </p>
