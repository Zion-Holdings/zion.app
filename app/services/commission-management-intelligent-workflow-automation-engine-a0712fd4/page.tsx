...
export const metadata: Metadata = {
  title: 'Commission Management Intelligent Workflow Automation Engine',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Commission Management Intelligent Workflow Automation Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered commission management solution for workflow. AI-powered workflow automation that learns from user behavior to optimize processes.
          </p>
