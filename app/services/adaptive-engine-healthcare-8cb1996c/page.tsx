...
export const metadata: Metadata = {
  title: 'Adaptive engine-healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Adaptive engine-healthcare leverages advanced machine learning to deliver regulatory tracking at sc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-engine-healthcare-8cb1996c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive engine-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Adaptive engine-healthcare leverages advanced machine learning to deliver regulatory tracking at scale.
          </p>
