...
export const metadata: Metadata = {
  title: 'Autonomous revenue-education',
  description: 'Revolutionize education through intelligent automation. Our Autonomous revenue-education leverages advanced machine learning to deliver customer insights at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous revenue-education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize education through intelligent automation. Our Autonomous revenue-education leverages advanced machine learning to deliver customer insights at scale.
          </p>
