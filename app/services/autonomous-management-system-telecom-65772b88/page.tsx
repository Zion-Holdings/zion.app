...
export const metadata: Metadata = {
  title: 'Autonomous Management System - Telecom',
  description: 'Transform your telecom operations with our Autonomous Management System - Telecom. This AI-driven solution automates predictive analytics with unprecedented acc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-management-system-telecom-65772b88',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Management System - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your telecom operations with our Autonomous Management System - Telecom. This AI-driven solution automates predictive analytics with unprecedented accuracy and efficiency.
          </p>
