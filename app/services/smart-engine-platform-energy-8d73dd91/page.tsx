...
export const metadata: Metadata = {
  title: 'Smart Engine Platform - Energy',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Engine Platform - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Smart Engine Platform - Energy. Powered by cutting-edge AI, this platform delivers insurance automation like never before.
          </p>
