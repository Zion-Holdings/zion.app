...
export const metadata = {
  ...
  description: "Unlock unprecedented growth with Automated coordinator-manufacturing. This autonomous system provides customer service automation with zero manual intervention ",
  alternates: {
