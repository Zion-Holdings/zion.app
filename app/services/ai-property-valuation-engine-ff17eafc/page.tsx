...
export const metadata = {
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-property-valuation-engine-ff17eafc`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path={`/services/ai-property-valuation-engine-ff17eafc`} title="AI Property Valuation Engine" />
