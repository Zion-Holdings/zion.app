...
export const metadata: Metadata = {
  title: 'Smart Director Platform - Insurance #1',
  description: 'Drive innovation in insurance with Smart Director Platform - Insurance #1. This AI-powered platform transforms sales forecasting into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-director-platform-insurance-1-cb2fd242',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Director Platform - Insurance #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Smart Director Platform - Insurance #1. This AI-powered platform transforms sales forecasting into a competitive advantage.
          </p>
