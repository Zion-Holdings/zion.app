...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize real-estate through intelligent automation. Our Adaptive data-real-estate leverages advanced machine learning to deliver cost reduction at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-data-real-estate-c77c7f15',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our Adaptive data-real-estate leverages advanced machine learning to deliver cost reduction at scale.
          </p>
