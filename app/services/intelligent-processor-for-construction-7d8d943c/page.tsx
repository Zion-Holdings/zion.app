...
export const metadata: Metadata = {
  title: 'Intelligent Processor for Construction',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Processor for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Intelligent Processor for Construction. Combines employee engagement with adaptive intelligence for optimal results.
          </p>
