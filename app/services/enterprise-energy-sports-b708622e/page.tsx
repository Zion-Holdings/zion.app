...
export const metadata: Metadata = {
  title: 'Enterprise energy-sports',
  description: 'Next-generation sports solution: Enterprise energy-sports. Combines project portfolio with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-energy-sports-b708622e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise energy-sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation sports solution: Enterprise energy-sports. Combines project portfolio with adaptive intelligence for optimal results.
          </p>
