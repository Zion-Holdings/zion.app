...
export const metadata: Metadata = {
  title: 'Intelligent Security for Retail',
  description: 'Drive innovation in retail with Intelligent Security for Retail. This AI-powered platform transforms budget optimization into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-security-for-retail-0fa6a988',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Security for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in retail with Intelligent Security for Retail. This AI-powered platform transforms budget optimization into a competitive advantage.
          </p>
