...
export const metadata: Metadata = {
  title: 'Diagnostic Analytics AI-Powered Stream Processing',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Diagnostic Analytics AI-Powered Stream Processing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered diagnostic analytics solution for streaming. Real-time stream processing with automatic windowing and aggregation.
          </p>
