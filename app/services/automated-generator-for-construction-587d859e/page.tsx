...
export const metadata: Metadata = {
  title: 'Automated Generator for Construction',
  description: 'Revolutionize construction through intelligent automation. Our Automated Generator for Construction leverages advanced machine learning to deliver fraud prevent',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-generator-for-construction-587d859e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Generator for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Automated Generator for Construction leverages advanced machine learning to deliver fraud prevention at scale.
          </p>
