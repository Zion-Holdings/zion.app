...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-channel deployment (web, WhatsApp, Instagram), Personalized product recommendations, Order tracking and management, Abandoned cart recovery via chat, Multilingual support (50+ languages), Integration with major e-commerce platforms, Customer sentiment analysis, Revenue attribution tracking, ai, Retail, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">AI-powered shopping assistant that engages customers via chat, voice, and messaging apps. Product recommendations, order management, and personalized offers through natural conversation. Integrates with Shopify, WooCommerce, and custom stores.</p>
        ...
        <li class="text-slate-300">Multi-channel deployment (web, WhatsApp, Instagram)</li>
        <li class="text-slate-300">Personalized product recommendations</li>
        <li class="text-slate-300">Order tracking and management</li>
        <li class="text-slate-300">Abandoned cart recovery via chat</li>
        <li class="text-slate-300">Multilingual support (50+ languages)</li>
        <li class="text-slate-300">Integration with major e-commerce platforms</li>
        <li class="text-slate-300">Customer sentiment analysis</li>
        <li class="text-slate-300">Revenue attribution tracking</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Increase conversion rates by 35%</li>
        <li class="text-slate-300">Reduce cart abandonment by 25%</li>
        <li class="text-slate-300">24/7 automated customer engagement</li>
        <li class="text-slate-300">Personalized shopping experiences at scale</li>
      </ul>
        </div>
