...
export const metadata: Metadata = {
  title: 'Data Cognitive - Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Data Cognitive - Insurance leverages advanced machine learning to deliver loyalty optimization at sc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-cognitive-insurance-c2145780',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Cognitive - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Data Cognitive - Insurance leverages advanced machine learning to deliver loyalty optimization at scale.
          </p>
