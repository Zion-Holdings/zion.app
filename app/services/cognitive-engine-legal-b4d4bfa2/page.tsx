...
export const metadata: Metadata = {
  title: 'Cognitive engine-legal',
  description: 'Drive innovation in legal with Cognitive engine-legal. This AI-powered platform transforms data quality into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-engine-legal-b4d4bfa2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive engine-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Cognitive engine-legal. This AI-powered platform transforms data quality into a competitive advantage.
          </p>
