...
export const metadata: Metadata = {
  ...
  keywords: 'Transcript summarization & theme extraction, Sentiment analysis across user segments, Automatic persona generation with quotes, Journey map creation from session data, Priority ranking of pain points, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Generative UX Research Synthesis</h1>
        <p className="text-lg text-slate-300 mb-8">Turn raw user interviews, survey responses, and usability test recordings into structured insights, personas, and actionable recommendations using AI.</p>
        ...
        <li class="text-slate-300">Transcript summarization &amp; theme extraction</li>
        <li class="text-slate-300">Sentiment analysis across user segments</li>
        <li class="text-slate-300">Automatic persona generation with quotes</li>
        <li class="text-slate-300">Journey map creation from session data</li>
        <li class="text-slate-300">Priority ranking of pain points</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with generative ux research synthesis</li>
