...
export const metadata: Metadata = {
  title: 'Cognitive User Management',
  description: 'Optimize your education workflows with Cognitive User Management. This intelligent platform delivers account planning through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-user-management-67c81e17',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive User Management
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your education workflows with Cognitive User Management. This intelligent platform delivers account planning through advanced automation and AI.
          </p>
