...
export const metadata: Metadata = {
  title: 'Adaptive insights-education',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive insights-education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of education is here with Adaptive insights-education. Powered by cutting-edge AI, this platform delivers project portfolio like never before.
          </p>
