...
export const metadata: Metadata = {
  title: 'Cognitive Intelligence for Education',
  description: 'The future of education is here with Cognitive Intelligence for Education. Powered by cutting-edge AI, this platform delivers customer insights like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-intelligence-for-education-a744be71',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of education is here with Cognitive Intelligence for Education. Powered by cutting-edge AI, this platform delivers customer insights like never before.
          </p>
