...
export const metadata: Metadata = {
  ...
  keywords: 'Brand voice tuning, SEO content scoring, Multi-format output, Content calendar integration, Plagiarism & fact checking, ai, E-Commerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Copywriting &amp; Content Studio</h1>
        <p className="text-lg text-slate-300 mb-8">Brand-tuned AI content generation for blogs, ads, emails, and social posts with tone control, SEO scoring, and content calendar automation.</p>
        ...
        <li class="text-slate-300">Brand voice tuning</li>
        <li class="text-slate-300">SEO content scoring</li>
        <li class="text-slate-300">Multi-format output</li>
        <li class="text-slate-300">Content calendar integration</li>
        <li class="text-slate-300">Plagiarism &amp; fact checking</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai copywriting &amp; content studio</li>
