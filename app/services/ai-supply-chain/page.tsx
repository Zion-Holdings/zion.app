...
export const metadata: Metadata = {
  ...
  keywords: 'Demand forecasting (ARIMA + ML), Inventory optimization & reorder points, Supplier risk scoring & monitoring, Logistics route optimization, Real-time shipment tracking, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Supply Chain Optimization</h1>
        <p className="text-lg text-slate-300 mb-8">Predictive demand forecasting, inventory optimization, and supplier risk management powered by machine learning.</p>
        ...
        <li class="text-slate-300">Demand forecasting (ARIMA + ML)</li>
        <li class="text-slate-300">Inventory optimization &amp; reorder points</li>
        <li class="text-slate-300">Supplier risk scoring &amp; monitoring</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai supply chain optimization</li>
