...
export const metadata: Metadata = {
  title: 'Autonomous Financial System - EDTECH',
  description: 'Enhance your edtech business with Autonomous Financial System - EDTECH. Our solution provides generative ai with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-financial-system-edtech-22d52f90',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Financial System - EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your edtech business with Autonomous Financial System - EDTECH. Our solution provides generative ai with enterprise-grade reliability and security.
          </p>
