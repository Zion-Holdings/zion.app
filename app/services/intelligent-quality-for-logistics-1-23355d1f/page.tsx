...
export const metadata: Metadata = {
  title: 'Intelligent Quality for Logistics #1',
  description: 'Enhance your logistics business with Intelligent Quality for Logistics #1. Our solution provides expense management with enterprise-grade reliability and securi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-quality-for-logistics-1-23355d1f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Quality for Logistics #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with Intelligent Quality for Logistics #1. Our solution provides expense management with enterprise-grade reliability and security.
          </p>
