...
export const metadata: Metadata = {
  title: 'AI-Powered Healthcare for Telecom',
  description: 'Drive innovation in telecom with AI-Powered Healthcare for Telecom. This AI-powered platform transforms scenario planning into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-healthcare-for-telecom-f04fd604',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Healthcare for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in telecom with AI-Powered Healthcare for Telecom. This AI-powered platform transforms scenario planning into a competitive advantage.
          </p>
