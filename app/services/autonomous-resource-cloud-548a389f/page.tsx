...
export const metadata: Metadata = {
  title: 'Autonomous Resource Cloud',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your logistics workflows with Autonomous Resource Cloud. This intelligent platform delivers hr analytics through advanced automation and AI.
          </p>
