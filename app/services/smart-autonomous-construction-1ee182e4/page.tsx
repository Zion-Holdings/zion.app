...
export const metadata: Metadata = {
  title: 'Smart Autonomous - Construction',
  description: 'Next-generation construction solution: Smart Autonomous - Construction. Combines brand sentiment with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-autonomous-construction-1ee182e4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Autonomous - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Smart Autonomous - Construction. Combines brand sentiment with adaptive intelligence for optimal results.
          </p>
