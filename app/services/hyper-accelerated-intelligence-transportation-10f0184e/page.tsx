...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Intelligence - Transportation',
  description: 'Revolutionize transportation through intelligent automation. Our Hyper-Accelerated Intelligence - Transportation leverages advanced machine learning to deliver ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Intelligence - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize transportation through intelligent automation. Our Hyper-Accelerated Intelligence - Transportation leverages advanced machine learning to deliver data fabric at scale.
          </p>
