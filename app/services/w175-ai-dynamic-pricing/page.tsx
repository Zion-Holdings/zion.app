...
export const metadata: Metadata = {
  ...
  keywords: 'ML demand elasticity modeling, Competitor price tracking and matching, Margin-optimized price recommendations, A/B testing for price strategies, Time-of-day and segment pricing, Rule-based constraints (min price, MAP), Integration with Shopify, Stripe, custom carts, ai, E-Commerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Dynamic Pricing Platform</h1>
        <p className="text-lg text-slate-300 mb-8">ML-driven dynamic pricing for e-commerce, travel, and SaaS: competitor tracking, demand elasticity, margin optimization, and A/B testing of price strategies.</p>
        ...
        <li class="text-slate-300">ML demand elasticity modeling</li>
        <li class="text-slate-300">Competitor price tracking and matching</li>
        <li class="text-slate-300">Margin-optimized price recommendations</li>
        <li class="text-slate-300">A/B testing for price strategies</li>
        <li class="text-slate-300">Time-of-day and segment pricing</li>
        <li class="text-slate-300">Rule-based constraints (min price, MAP)</li>
        <li class="text-slate-300">Integration with Shopify, Stripe, custom carts</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Increase gross margin by 5-15%</li>
        <li class="text-slate-300">Competitor-aware pricing stays competitive</li>
        <li class="text-slate-300">Demand elasticity prevents leaving money on table</li>
        <li class="text-slate-300">Constraints ensure minimum prices respected</li>
      </ul>
        </div>
