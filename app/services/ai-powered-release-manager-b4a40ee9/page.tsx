...
export const metadata: Metadata = {
  title: 'AI-Powered Release Manager',
  description: 'Transform your legal operations with our AI-Powered Release Manager. This AI-driven solution provides intelligent automation with unprecedented accuracy and eff',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our AI-Powered Release Manager. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
