...
export const metadata: Metadata = {
  title: 'Security Autonomous - Transportation',
  description: 'Revolutionize transportation through intelligent automation. Our Security Autonomous - Transportation leverages advanced machine learning to deliver workflow ma',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-autonomous-transportation-3a6a7bd4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Autonomous - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize transportation through intelligent automation. Our Security Autonomous - Transportation leverages advanced machine learning to deliver workflow management at scale.
          </p>
