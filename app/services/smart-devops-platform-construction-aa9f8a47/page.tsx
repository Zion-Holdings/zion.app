...
export const metadata: Metadata = {
  title: 'Smart DevOps Platform - Construction',
  description: 'The future of construction is here with Smart DevOps Platform - Construction. Powered by cutting-edge AI, this platform delivers release management like never b',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-devops-platform-construction-aa9f8a47',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart DevOps Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Smart DevOps Platform - Construction. Powered by cutting-edge AI, this platform delivers release management like never before.
          </p>
