...
export const metadata: Metadata = {
  ...
  keywords: 'JWT/OAuth2/API-Key auth per route, Rate-limit (token-bucket) + circuit-breaker, Request/response transform + header injection, Multi-tenant API key management + analytics, cloud, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Enterprise API Gateway</h1>
        <p className="text-lg text-slate-300 mb-8">Unified API gateway: JWT/OAuth2 auth, rate-limit, circuit-breaker, request/response transform, analytics, multi-tenant API key mgmt.</p>
        ...
        <li class="text-slate-300">JWT/OAuth2/API-Key auth per route</li>
        <li class="text-slate-300">Rate-limit (token-bucket) + circuit-breaker</li>
        <li class="text-slate-300">Request/response transform + header injection</li>
        <li class="text-slate-300">Multi-tenant API key management + analytics</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with enterprise api gateway</li>
