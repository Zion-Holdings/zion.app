...
export const metadata: Metadata = {
  title: 'AI Engine - Insurance Edition',
  description: 'Enhance your insurance business with AI Engine - Insurance Edition. Our solution provides logistics route optimization with enterprise-grade reliability and sec',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-engine-insurance-edition-f8f71be0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Engine - Insurance Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with AI Engine - Insurance Edition. Our solution provides logistics route optimization with enterprise-grade reliability and security.
          </p>
