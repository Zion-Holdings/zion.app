...
export const metadata: Metadata = {
  title: 'Autonomous NLP System - Legal',
  description: 'Optimize your legal workflows with Autonomous NLP System - Legal. This intelligent platform delivers user provisioning through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-nlp-system-legal-7e470537',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous NLP System - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with Autonomous NLP System - Legal. This intelligent platform delivers user provisioning through advanced automation and AI.
          </p>
