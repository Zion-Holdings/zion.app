...
export const metadata: Metadata = {
  title: 'Autonomous optimizer-hospitality',
  description: 'Transform your hospitality operations with our Autonomous optimizer-hospitality. This AI-driven solution provides intelligent automation with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-optimizer-hospitality-c3594611',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous optimizer-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Autonomous optimizer-hospitality. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
