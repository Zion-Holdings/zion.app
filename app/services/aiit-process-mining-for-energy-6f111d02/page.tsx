...
export const metadata: Metadata = {
  title: 'AI/IT Process Mining for Energy',
  description: 'Drive innovation in energy with AI/IT Process Mining for Energy. This AI-powered platform transforms personalization engine into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-process-mining-for-energy-6f111d02',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Process Mining for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with AI/IT Process Mining for Energy. This AI-powered platform transforms personalization engine into a competitive advantage.
          </p>
