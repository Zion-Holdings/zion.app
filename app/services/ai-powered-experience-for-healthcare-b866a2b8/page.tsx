...
export const metadata: Metadata = {
  title: 'AI-Powered Experience for Healthcare',
  description: 'Enhance your healthcare business with AI-Powered Experience for Healthcare. Our solution provides data governance with enterprise-grade reliability and security',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-experience-for-healthcare-b866a2b8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Experience for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with AI-Powered Experience for Healthcare. Our solution provides data governance with enterprise-grade reliability and security.
          </p>
