...
export const metadata: Metadata = {
  title: 'Neural Suite for Hospitality',
  description: 'The future of hospitality is here with Neural Suite for Hospitality. Powered by cutting-edge AI, this platform delivers inventory management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-suite-for-hospitality-1e676504',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Suite for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Neural Suite for Hospitality. Powered by cutting-edge AI, this platform delivers inventory management like never before.
          </p>
