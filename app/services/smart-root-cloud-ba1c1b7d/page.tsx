...
export const metadata: Metadata = {
  title: 'Smart Root Cloud',
  description: 'Revolutionize insurance through intelligent automation. Our Smart Root Cloud leverages advanced machine learning to deliver recommendation system at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-root-cloud-ba1c1b7d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Smart Root Cloud leverages advanced machine learning to deliver recommendation system at scale.
          </p>
