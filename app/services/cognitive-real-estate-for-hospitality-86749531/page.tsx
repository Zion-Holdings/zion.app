...
export const metadata: Metadata = {
  title: 'Cognitive Real Estate for Hospitality',
  description: 'Next-generation hospitality solution: Cognitive Real Estate for Hospitality. Combines content generation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-real-estate-for-hospitality-86749531',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Real Estate for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Cognitive Real Estate for Hospitality. Combines content generation with adaptive intelligence for optimal results.
          </p>
