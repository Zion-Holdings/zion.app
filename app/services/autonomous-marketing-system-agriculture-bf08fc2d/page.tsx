...
export const metadata: Metadata = {
  title: 'Autonomous Marketing System - Agriculture',
  description: 'Enhance your agriculture business with Autonomous Marketing System - Agriculture. Our solution provides data quality with enterprise-grade reliability and secur',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Marketing System - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your agriculture business with Autonomous Marketing System - Agriculture. Our solution provides data quality with enterprise-grade reliability and security.
          </p>
