...
export const metadata: Metadata = {
  ...
  keywords: 'E2E test auto-generation from session replay, Auto-fix flaky selector on retry (best-match), Run full E2E suite per PR + auto-open Jira, Flake budget SLA gate per PR, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Autonomous QA Engineering Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Auto-generate comprehensive E2E tests from user session replay; auto-fix flaky selectors; run tests on every PR; auto-open bug ticket on fail.</p>
        ...
        <li class="text-slate-300">E2E test auto-generation from session replay</li>
        <li class="text-slate-300">Auto-fix flaky selector on retry (best-match)</li>
        <li class="text-slate-300">Run full E2E suite per PR + auto-open Jira</li>
        <li class="text-slate-300">Flake budget SLA gate per PR</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with autonomous qa engineering platform</li>
