...
export const metadata: Metadata = {
  title: 'AI-Powered Intelligence for Agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our AI-Powered Intelligence for Agriculture leverages advanced machine learning to deliver decision su',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-intelligence-for-agriculture-986f8280',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our AI-Powered Intelligence for Agriculture leverages advanced machine learning to deliver decision support at scale.
          </p>
