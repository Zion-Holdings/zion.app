...
export const metadata: Metadata = {
  title: 'Smart Support Suite - Sports',
  description: 'Future-proof your sports with Smart Support Suite - Sports. Our autonomous solution handles budget tracking end-to-end without human intervention.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-support-suite-sports-a42fdecb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Support Suite - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your sports with Smart Support Suite - Sports. Our autonomous solution handles budget tracking end-to-end without human intervention.
          </p>
