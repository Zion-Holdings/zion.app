...
export const metadata: Metadata = {
  title: 'Neural Logistics Management',
  description: 'Transform your edge operations with our Neural Logistics Management. This AI-driven solution automates financial risk management with unprecedented accuracy and',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Logistics Management
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your edge operations with our Neural Logistics Management. This AI-driven solution automates financial risk management with unprecedented accuracy and efficiency.
          </p>
