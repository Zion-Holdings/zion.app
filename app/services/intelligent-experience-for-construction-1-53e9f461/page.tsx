...
export const metadata: Metadata = {
  title: 'Intelligent Experience for Construction #1',
  description: 'Next-generation construction solution: Intelligent Experience for Construction #1. Combines risk assessment with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-experience-for-construction-1-53e9f461',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Experience for Construction #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Intelligent Experience for Construction #1. Combines risk assessment with adaptive intelligence for optimal results.
          </p>
