...
export const metadata: Metadata = {
  title: 'Autonomous Manufacturing for Agriculture',
  description: 'Enhance your agriculture business with Autonomous Manufacturing for Agriculture. Our solution provides procurement automation with enterprise-grade reliability ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-manufacturing-for-agriculture-50487b31',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Manufacturing for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your agriculture business with Autonomous Manufacturing for Agriculture. Our solution provides procurement automation with enterprise-grade reliability and security.
          </p>
