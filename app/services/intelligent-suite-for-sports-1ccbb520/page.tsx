...
export const metadata: Metadata = {
  title: 'Intelligent Suite for Sports',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Suite for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your sports workflows with Intelligent Suite for Sports. This intelligent platform delivers case management through advanced automation and AI.
          </p>
