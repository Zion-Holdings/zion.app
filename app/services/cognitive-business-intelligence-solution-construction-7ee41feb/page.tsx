...
export const metadata: Metadata = {
  title: 'Cognitive Business Intelligence Solution - Construction',
  description: 'Next-generation construction solution: Cognitive Business Intelligence Solution - Construction. Combines customer journey mapping with adaptive intelligence for',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-business-intelligence-solution-construction-7ee41feb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Business Intelligence Solution - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Cognitive Business Intelligence Solution - Construction. Combines customer journey mapping with adaptive intelligence for optimal results.
          </p>
