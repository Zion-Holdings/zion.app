...
export const metadata: Metadata = {
  title: 'Cognitive Analyzer Solution - Automotive',
  description: 'The future of automotive is here with Cognitive Analyzer Solution - Automotive. Powered by cutting-edge AI, this platform delivers hr analytics like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-analyzer-solution-automotive-9514f333',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Analyzer Solution - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of automotive is here with Cognitive Analyzer Solution - Automotive. Powered by cutting-edge AI, this platform delivers hr analytics like never before.
          </p>
