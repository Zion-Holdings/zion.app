...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time transcription, Action item extraction, Meeting summaries, Speaker identification, Searchable archive, Calendar integration, micro-saas, technology-and-saas, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Real-time transcription, action item extraction, and meeting summaries. Integrates with Zoom, Teams, and Google Meet.</p>
        ...
        <li class="text-slate-300">Action item extraction</li>
        <li class="text-slate-300">Meeting summaries</li>
        <li class="text-slate-300">Speaker identification</li>
        <li class="text-slate-300">Searchable archive</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Never miss action items</li>
        <li class="text-slate-300">Searchable meeting history</li>
        <li class="text-slate-300">50% less note-taking time</li>
        <li class="text-slate-300">Better follow-through</li>
      </ul>
        </div>
