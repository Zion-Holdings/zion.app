...
export const metadata: Metadata = {
  title: 'Smart Manager Platform - Sports',
  description: 'Drive innovation in sports with Smart Manager Platform - Sports. This AI-powered platform transforms customer retention into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-manager-platform-sports-a3be2c90',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manager Platform - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in sports with Smart Manager Platform - Sports. This AI-powered platform transforms customer retention into a competitive advantage.
          </p>
