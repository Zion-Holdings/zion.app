...
export const metadata: Metadata = {
  title: 'Autonomous Sales for Logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Autonomous Sales for Logistics leverages advanced machine learning to deliver image recognition at s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-sales-for-logistics-293b1273',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Sales for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Autonomous Sales for Logistics leverages advanced machine learning to deliver image recognition at scale.
          </p>
