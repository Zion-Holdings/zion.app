...
export const metadata: Metadata = {
  title: 'Smart Smart Platform - AITECH',
  description: 'Hyper-accelerated aitech solution: Smart Smart Platform - AITECH. Combines lead scoring with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-smart-platform-aitech-3848243e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Smart Platform - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated aitech solution: Smart Smart Platform - AITECH. Combines lead scoring with next-gen AI for maximum velocity.
          </p>
