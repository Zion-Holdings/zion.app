...
export const metadata: Metadata = {
  title: 'Quantum Enterprise - Insurance Quantum',
  description: 'Quantum leap forward for insurance: Quantum Enterprise - Insurance Quantum. Uses quantum-inspired algorithms to deliver master data management at exponential sp',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-enterprise-insurance-quantum-a425fdbb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Enterprise - Insurance Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for insurance: Quantum Enterprise - Insurance Quantum. Uses quantum-inspired algorithms to deliver master data management at exponential speed.
          </p>
