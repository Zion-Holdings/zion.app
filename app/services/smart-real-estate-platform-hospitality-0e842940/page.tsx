...
export const metadata: Metadata = {
  title: 'Smart Real Estate Platform - Hospitality',
  description: 'Optimize your hospitality workflows with Smart Real Estate Platform - Hospitality. This intelligent platform delivers competitive intelligence through advanced ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-real-estate-platform-hospitality-0e842940',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Real Estate Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Smart Real Estate Platform - Hospitality. This intelligent platform delivers competitive intelligence through advanced automation and AI.
          </p>
