...
export const metadata: Metadata = {
  title: 'Smart Orchestrator for Energy',
  description: 'Next-generation energy solution: Smart Orchestrator for Energy. Combines risk assessment with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-orchestrator-for-energy-4a05e110',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Orchestrator for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Smart Orchestrator for Energy. Combines risk assessment with adaptive intelligence for optimal results.
          </p>
