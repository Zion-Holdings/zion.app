...
export const metadata: Metadata = {
  title: 'Smart Director Platform - FINTECH',
  description: 'Drive innovation in fintech with Smart Director Platform - FINTECH. This AI-powered platform transforms budget optimization into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-director-platform-fintech-66732b4e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Director Platform - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in fintech with Smart Director Platform - FINTECH. This AI-powered platform transforms budget optimization into a competitive advantage.
          </p>
