...
export const metadata: Metadata = {
  title: 'Smart Real Estate Platform - Legal',
  description: 'Enhance your legal business with Smart Real Estate Platform - Legal. Our solution provides loyalty optimization with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-real-estate-platform-legal-c91d620b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Real Estate Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Smart Real Estate Platform - Legal. Our solution provides loyalty optimization with enterprise-grade reliability and security.
          </p>
