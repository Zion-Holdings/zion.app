...
export const metadata: Metadata = {
  title: 'Security Smart - Real-Estate',
  description: 'Revolutionize real-estate through intelligent automation. Our Security Smart - Real-Estate leverages advanced machine learning to deliver resource optimization ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-smart---real-estate-2e0df5fb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Smart - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our Security Smart - Real-Estate leverages advanced machine learning to deliver resource optimization at scale.
          </p>
