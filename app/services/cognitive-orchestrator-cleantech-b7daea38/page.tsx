...
export const metadata: Metadata = {
  title: 'Cognitive orchestrator-cleantech',
  description: 'Transform your cleantech operations with our Cognitive orchestrator-cleantech. This AI-driven solution automates content generation with unprecedented accuracy ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive orchestrator-cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your cleantech operations with our Cognitive orchestrator-cleantech. This AI-driven solution automates content generation with unprecedented accuracy and efficiency.
          </p>
