...
export const metadata: Metadata = {
  title: 'AI/IT Predictive Suite - Sports',
  description: 'Optimize your sports workflows with AI/IT Predictive Suite - Sports. This intelligent platform delivers project management through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-predictive-suite-sports-73482af0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Predictive Suite - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your sports workflows with AI/IT Predictive Suite - Sports. This intelligent platform delivers project management through advanced automation and AI.
          </p>
