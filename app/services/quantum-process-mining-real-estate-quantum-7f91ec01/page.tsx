...
export const metadata: Metadata = {
  title: 'Quantum Process Mining - Real-Estate Quantum',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Process Mining - Real-Estate Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for real-estate: Quantum Process Mining - Real-Estate Quantum. Uses quantum-inspired algorithms to deliver task mining at exponential speed.
          </p>
