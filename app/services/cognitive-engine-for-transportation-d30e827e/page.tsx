...
export const metadata: Metadata = {
  title: 'Cognitive Engine for Transportation',
  description: 'Unlock unprecedented growth with Cognitive Engine for Transportation. This autonomous system provides customer service automation with zero manual intervention ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-engine-for-transportation-d30e827e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Engine for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Cognitive Engine for Transportation. This autonomous system provides customer service automation with zero manual intervention needed.
          </p>
