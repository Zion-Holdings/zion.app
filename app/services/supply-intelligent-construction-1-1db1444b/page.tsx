...
export const metadata: Metadata = {
  title: 'Supply Intelligent - Construction #1',
  description: 'Enhance your construction business with Supply Intelligent - Construction #1. Our solution provides maintenance scheduling with enterprise-grade reliability and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/supply-intelligent-construction-1-1db1444b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Supply Intelligent - Construction #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Supply Intelligent - Construction #1. Our solution provides maintenance scheduling with enterprise-grade reliability and security.
          </p>
