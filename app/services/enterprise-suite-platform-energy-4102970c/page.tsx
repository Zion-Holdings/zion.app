...
export const metadata: Metadata = {
  title: 'Enterprise Suite Platform - Energy',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Suite Platform - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for energy: Enterprise Suite Platform - Energy. Uses quantum-inspired algorithms to deliver warehouse automation at exponential speed.
          </p>
