...
export const metadata: Metadata = {
  title: 'AI/IT Platform Suite - PROPTECH',
  description: 'Revolutionize proptech through intelligent automation. Our AI/IT Platform Suite - PROPTECH leverages advanced machine learning to deliver user experience at sca',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-platform-suite-proptech-72cf9a3e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Platform Suite - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our AI/IT Platform Suite - PROPTECH leverages advanced machine learning to deliver user experience at scale.
          </p>
