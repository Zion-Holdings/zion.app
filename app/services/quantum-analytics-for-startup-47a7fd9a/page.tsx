...
export const metadata: Metadata = {
  title: 'Quantum Analytics for Startup',
  description: 'Transform your startup operations with our Quantum Analytics for Startup. This AI-driven solution automates content moderation with unprecedented accuracy and e',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Analytics for Startup
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your startup operations with our Quantum Analytics for Startup. This AI-driven solution automates content moderation with unprecedented accuracy and efficiency.
          </p>
