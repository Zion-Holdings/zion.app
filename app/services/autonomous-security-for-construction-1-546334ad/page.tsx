...
export const metadata: Metadata = {
  title: 'Autonomous Security for Construction #1',
  description: 'The future of construction is here with Autonomous Security for Construction #1. Powered by cutting-edge AI, this platform delivers fraud prevention like never ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-security-for-construction-1-546334ad',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Security for Construction #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Autonomous Security for Construction #1. Powered by cutting-edge AI, this platform delivers fraud prevention like never before.
          </p>
