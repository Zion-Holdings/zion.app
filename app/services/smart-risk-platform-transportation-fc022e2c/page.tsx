...
export const metadata: Metadata = {
  title: 'Smart Risk Platform - Transportation',
  description: 'Revolutionize transportation through intelligent automation. Our Smart Risk Platform - Transportation leverages advanced machine learning to deliver fraud preve',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-risk-platform-transportation-fc022e2c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Risk Platform - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize transportation through intelligent automation. Our Smart Risk Platform - Transportation leverages advanced machine learning to deliver fraud prevention at scale.
          </p>
