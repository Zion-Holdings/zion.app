...
export const metadata: Metadata = {
  ...
  description: 'The future of healthcare is here with Smart Machine Learning Platform - Healthcare. Powered by cutting-edge AI, this platform delivers resource optimization lik',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-machine-learning-platform-healthcare-69bf234e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Smart Machine Learning Platform - Healthcare. Powered by cutting-edge AI, this platform delivers resource optimization like never before.
          </p>
