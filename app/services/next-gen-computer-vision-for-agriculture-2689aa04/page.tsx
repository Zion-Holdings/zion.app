...
export const metadata: Metadata = {
  title: 'Next-Gen Computer Vision for Agriculture',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Computer Vision for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your agriculture workflows with Next-Gen Computer Vision for Agriculture. This intelligent platform delivers esg reporting through advanced automation and AI.
          </p>
