...
export const metadata: Metadata = {
  title: 'Predictive Director Engine - Insurance',
  description: 'Drive innovation in insurance with Predictive Director Engine - Insurance. This AI-powered platform transforms forecast accuracy into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-director-engine-insurance-68ef84fd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Director Engine - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Predictive Director Engine - Insurance. This AI-powered platform transforms forecast accuracy into a competitive advantage.
          </p>
