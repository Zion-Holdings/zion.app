...
export const metadata: Metadata = {
  title: 'Smart Scheduler Solution',
  description: 'Transform your education operations with our Smart Scheduler Solution. This ai solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-scheduler-solution-5a4d64',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Scheduler Solution
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your education operations with our Smart Scheduler Solution. This ai solution delivers unprecedented automation and intelligence.
          </p>
