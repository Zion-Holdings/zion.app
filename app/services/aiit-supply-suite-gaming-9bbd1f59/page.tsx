...
export const metadata: Metadata = {
  title: 'AI/IT Supply Suite - Gaming',
  description: 'The future of gaming is here with AI/IT Supply Suite - Gaming. Powered by cutting-edge AI, this platform delivers claims processing like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-supply-suite-gaming-9bbd1f59',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Supply Suite - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of gaming is here with AI/IT Supply Suite - Gaming. Powered by cutting-edge AI, this platform delivers claims processing like never before.
          </p>
