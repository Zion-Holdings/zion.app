...
export const metadata: Metadata = {
  title: 'Enterprise Real Estate Platform - Finance',
  description: 'The future of finance is here with Enterprise Real Estate Platform - Finance. Powered by cutting-edge AI, this platform delivers recommendation system like neve',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Real Estate Platform - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of finance is here with Enterprise Real Estate Platform - Finance. Powered by cutting-edge AI, this platform delivers recommendation system like never before.
          </p>
