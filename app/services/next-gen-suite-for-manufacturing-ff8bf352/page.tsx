...
export const metadata: Metadata = {
  title: 'Next-Gen Suite for Manufacturing',
  description: 'Hyper-accelerated manufacturing solution: Next-Gen Suite for Manufacturing. Combines logistics route optimization with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-suite-for-manufacturing-ff8bf352',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Suite for Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated manufacturing solution: Next-Gen Suite for Manufacturing. Combines logistics route optimization with next-gen AI for maximum velocity.
          </p>
