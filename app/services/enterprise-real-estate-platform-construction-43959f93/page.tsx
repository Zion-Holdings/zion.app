...
export const metadata: Metadata = {
  title: 'Enterprise Real Estate Platform - Construction',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Real Estate Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Enterprise Real Estate Platform - Construction. This intelligent platform delivers vendor management through advanced automation and AI.
          </p>
