...
export const metadata: Metadata = {
  title: 'Automated Intelligence for Energy',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Intelligence for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your energy business with Automated Intelligence for Energy. Our solution provides account planning with enterprise-grade reliability and security.
          </p>
