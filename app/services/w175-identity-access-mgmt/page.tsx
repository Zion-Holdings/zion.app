...
export const metadata: Metadata = {
  ...
  keywords: 'SSO across all applications (SAML, OIDC, WS-Fed), MFA with phishing-resistant factors, Directory sync (AD, LDAP, Google, HRDS), User lifecycle management (joiner, mover, leaver), Application governance and access reviews, Privileged access management, Okta, Entra ID, Ping, Auth0 deployment, it, Identity, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Centralized IAM with SSO, MFA, directory sync, and lifecycle management. Okta, Entra ID, or Ping deployment with governance and compliance.</p>
        ...
        <li class="text-slate-300">SSO across all applications (SAML, OIDC, WS-Fed)</li>
        <li class="text-slate-300">MFA with phishing-resistant factors</li>
        <li class="text-slate-300">Directory sync (AD, LDAP, Google, HRDS)</li>
        <li class="text-slate-300">User lifecycle management (joiner, mover, leaver)</li>
        <li class="text-slate-300">Application governance and access reviews</li>
        <li class="text-slate-300">Privileged access management</li>
        <li class="text-slate-300">Okta, Entra ID, Ping, Auth0 deployment</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">One login for all applications</li>
        <li class="text-slate-300">MFA reduces credential attacks by 99%</li>
        <li class="text-slate-300">Automated lifecycle prevents orphan accounts</li>
        <li class="text-slate-300">Access reviews ensure least privilege</li>
      </ul>
        </div>
