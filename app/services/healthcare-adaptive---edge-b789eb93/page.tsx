...
export const metadata: Metadata = {
  title: 'Healthcare Adaptive - Edge',
  description: 'The future of edge is here with Healthcare Adaptive - Edge. Powered by cutting-edge AI, this platform delivers supply chain like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/healthcare-adaptive---edge-b789eb93',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Healthcare Adaptive - Edge
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of edge is here with Healthcare Adaptive - Edge. Powered by cutting-edge AI, this platform delivers supply chain like never before.
          </p>
