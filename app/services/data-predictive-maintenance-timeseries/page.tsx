...
export const metadata: Metadata = {
  ...
  keywords: 'Sensor TS ingestion + Pandas validation, Anomaly detector (IsolationForest + Prophet), Failure risk scoring XGBoost per asset, Auto-created CMMS work-order on threshold, data, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Predictive Maintenance (Time-Series)</h1>
        <p className="text-lg text-slate-300 mb-8">Sensor TS ingestion, anomaly detection (IsolationForest/Prophet), failure-prediction XGBoost, and work-order auto-creation.</p>
        ...
        <li class="text-slate-300">Sensor TS ingestion + Pandas validation</li>
        <li class="text-slate-300">Anomaly detector (IsolationForest + Prophet)</li>
        <li class="text-slate-300">Failure risk scoring XGBoost per asset</li>
        <li class="text-slate-300">Auto-created CMMS work-order on threshold</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with predictive maintenance (time-series)</li>
