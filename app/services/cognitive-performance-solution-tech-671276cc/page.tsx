...
export const metadata: Metadata = {
  title: 'Cognitive Performance Solution - Tech',
  description: 'The future of technology is here with Cognitive Performance Solution - Tech. Powered by cutting-edge AI, this platform delivers workflow management like never b',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-performance-solution-tech-671276cc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Performance Solution - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of technology is here with Cognitive Performance Solution - Tech. Powered by cutting-edge AI, this platform delivers workflow management like never before.
          </p>
