...
export const metadata: Metadata = {
  title: 'Autonomous Intelligence System - Hospitality',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Intelligence System - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for hospitality: Autonomous Intelligence System - Hospitality. Uses quantum-inspired algorithms to deliver revenue intelligence at exponential speed.
          </p>
