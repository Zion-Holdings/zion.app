...
export const metadata: Metadata = {
  title: 'Smart Data Platform - Construction',
  description: 'Enhance your construction business with Smart Data Platform - Construction. Our solution provides anomaly detection with enterprise-grade reliability and securi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Data Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Smart Data Platform - Construction. Our solution provides anomaly detection with enterprise-grade reliability and security.
          </p>
