...
export const metadata = {
  ...
  alternates: { canonical: '/services/devops-cicd-2026-6711/' },

  openGraph: {
    title: 'DevOps CI/CD | Zion Tech Group',
    description: 'End-to-end devops ci/cd services: assessment, deployment, and managed operations.',
    url: 'https://ziontechgroup.com/services/devops-cicd-2026-6711/',
...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "DevOps CI/CD | Zion Tech Group", description: "End-to-end devops ci/cd services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/devops-cicd-2026-6711/"}} />
