...
export const metadata: Metadata = {
  title: 'Cognitive Compliance Solution - Healthcare',
  description: 'Optimize your healthcare workflows with Cognitive Compliance Solution - Healthcare. This intelligent platform delivers invoice processing through advanced autom',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-compliance-solution-healthcare-2467e238',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Compliance Solution - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Cognitive Compliance Solution - Healthcare. This intelligent platform delivers invoice processing through advanced automation and AI.
          </p>
