...
export const metadata: Metadata = {
  title: 'Smart Finance Platform - Automotive',
  description: 'Transform your automotive operations with our Smart Finance Platform - Automotive. This AI-driven solution automates customer service automation with unpreceden',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-finance-platform-automotive-c594ab0e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Finance Platform - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your automotive operations with our Smart Finance Platform - Automotive. This AI-driven solution automates customer service automation with unprecedented accuracy and efficiency.
          </p>
