...
export const metadata: Metadata = {
  title: 'AI-Powered Anti-Money Laundering',
  description: 'AI-powered AML monitoring with transaction pattern analysis.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-anti-money-laundering-d20baf92',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            AI-powered AML monitoring with transaction pattern analysis.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">AML monitoring</li>
          <li className="text-gray-300">Pattern analysis</li>
          <li className="text-gray-300">Suspicious activity detection</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">99% suspicious detection</li>
