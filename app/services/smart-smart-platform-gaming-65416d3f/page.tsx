...
export const metadata: Metadata = {
  title: 'Smart Smart Platform - Gaming',
  description: 'Enhance your gaming business with Smart Smart Platform - Gaming. Our solution provides budget tracking with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-smart-platform-gaming-65416d3f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Smart Platform - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your gaming business with Smart Smart Platform - Gaming. Our solution provides budget tracking with enterprise-grade reliability and security.
          </p>
