...
export const metadata: Metadata = {
  title: "AI-Powered Email Marketing Automation - AI-Powered Marketing Solution",
  description: "Automated email campaigns with dynamic content and A/B testing.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-email-marketing-automation-312f8121",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Email Marketing Automation - AI-Powered Marketing Solution
        </h1>
