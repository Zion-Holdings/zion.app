...
export const metadata: Metadata = {
  title: 'AI-Powered Generator for Legal',
  description: 'Optimize your legal workflows with AI-Powered Generator for Legal. This intelligent platform delivers sourcing optimization through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-generator-for-legal-fc8475c3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Generator for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with AI-Powered Generator for Legal. This intelligent platform delivers sourcing optimization through advanced automation and AI.
          </p>
