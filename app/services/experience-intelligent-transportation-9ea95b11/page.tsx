...
export const metadata: Metadata = {
  title: 'Experience Intelligent - Transportation',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Experience Intelligent - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize transportation through intelligent automation. Our Experience Intelligent - Transportation leverages advanced machine learning to deliver forecast accuracy at scale.
          </p>
