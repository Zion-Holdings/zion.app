...
export const metadata: Metadata = {
  ...
  keywords: 'Semantic patent search (80M+ patents), Novelty & patentability assessment, Freedom-to-operate analysis, Patent landscape visualization, Competent IP monitoring alerts, Prior art discovery, ai, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Patent Search &amp; IP Intelligence</h1>
        <p className="text-lg text-slate-300 mb-8">Semantic patent search across USPTO, EPO, WIPO: novelty assessment, freedom-to-operate analysis, patent landscape mapping, competitor IP tracking.</p>
        ...
        <li class="text-slate-300">Semantic patent search (80M+ patents)</li>
        <li class="text-slate-300">Novelty &amp; patentability assessment</li>
        <li class="text-slate-300">Freedom-to-operate analysis</li>
        <li class="text-slate-300">Patent landscape visualization</li>
        <li class="text-slate-300">Competent IP monitoring alerts</li>
        <li class="text-slate-300">Prior art discovery</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Search 100x faster than manual</li>
        <li class="text-slate-300">Identify patent risks early</li>
        <li class="text-slate-300">Track competitor IP moves</li>
      </ul>
        </div>
