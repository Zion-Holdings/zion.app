...
export const metadata: Metadata = {
  ...
  keywords: 'Role-based access control, API-first design, Edge computing support, Open-source friendly, GDPR compliance, Container orchestration, advisor, logistics, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Smart Insights for Logistics</h1>
        <p className="text-lg text-slate-300 mb-8">Next-generation logistics solution: Smart Insights for Logistics. Combines security monitoring with adaptive intelligence for optimal results.</p>
