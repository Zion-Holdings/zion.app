...
export const metadata: Metadata = {
  title: 'Suite Predictive - Education',
  description: 'Revolutionize education through intelligent automation. Our Suite Predictive - Education leverages advanced machine learning to deliver security monitoring at s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Suite Predictive - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize education through intelligent automation. Our Suite Predictive - Education leverages advanced machine learning to deliver security monitoring at scale.
          </p>
