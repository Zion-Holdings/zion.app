...
export const metadata: Metadata = {
  title: 'AI-Powered Manufacturing Safety Management',
  description: 'Manages manufacturing safety with hazard detection and prevention.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-manufacturing-safety-management2026-07-28t040247290616000014-3ddbba1a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Manufacturing Safety Management
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Manages manufacturing safety with hazard detection and prevention.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Safety management</li>
          <li className="text-gray-300">Hazard detection</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">40% fewer incidents</li>
