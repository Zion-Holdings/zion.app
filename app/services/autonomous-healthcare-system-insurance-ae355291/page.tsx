...
export const metadata: Metadata = {
  title: 'Autonomous Healthcare System - Insurance',
  description: 'Enhance your insurance business with Autonomous Healthcare System - Insurance. Our solution provides churn prediction with enterprise-grade reliability and secu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-healthcare-system-insurance-ae355291',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Healthcare System - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Autonomous Healthcare System - Insurance. Our solution provides churn prediction with enterprise-grade reliability and security.
          </p>
