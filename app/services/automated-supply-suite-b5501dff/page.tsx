...
export const metadata: Metadata = {
  ...
  keywords: 'Audit trails, Edge computing support, Cloud-native architecture, API-first design, Plugin architecture, Container orchestration, automation, finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Automated Supply Suite</h1>
        <p className="text-lg text-slate-300 mb-8">The future of finance is here with Automated Supply Suite. Powered by cutting-edge AI, this platform delivers customer insights like never before.</p>
