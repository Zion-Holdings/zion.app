...
export const metadata: Metadata = {
  title: 'Enterprise Data Platform - HEALTHTECH',
  description: 'Revolutionize healthtech through intelligent automation. Our Enterprise Data Platform - HEALTHTECH leverages advanced machine learning to deliver investor relat',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Data Platform - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthtech through intelligent automation. Our Enterprise Data Platform - HEALTHTECH leverages advanced machine learning to deliver investor relations at scale.
          </p>
