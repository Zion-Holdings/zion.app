...
export const metadata: Metadata = {
  title: 'Intelligent Enterprise for Telecom',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Enterprise for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for telecom: Intelligent Enterprise for Telecom. Uses quantum-inspired algorithms to deliver feedback collection at exponential speed.
          </p>
