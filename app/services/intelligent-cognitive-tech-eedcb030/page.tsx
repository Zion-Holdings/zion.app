...
export const metadata: Metadata = {
  title: 'Intelligent Cognitive - Tech',
  description: 'Optimize your technology workflows with Intelligent Cognitive - Tech. This intelligent platform delivers lead scoring through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-cognitive-tech-eedcb030',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Cognitive - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your technology workflows with Intelligent Cognitive - Tech. This intelligent platform delivers lead scoring through advanced automation and AI.
          </p>
