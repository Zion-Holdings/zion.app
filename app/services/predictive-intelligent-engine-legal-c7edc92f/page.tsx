...
export const metadata: Metadata = {
  title: 'Predictive Intelligent Engine - Legal',
  description: 'Enhance your legal business with Predictive Intelligent Engine - Legal. Our solution provides procurement automation with enterprise-grade reliability and secur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-intelligent-engine-legal-c7edc92f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Intelligent Engine - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Predictive Intelligent Engine - Legal. Our solution provides procurement automation with enterprise-grade reliability and security.
          </p>
