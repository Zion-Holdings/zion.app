...
export const metadata: Metadata = {
  title: 'Intelligent Performance for Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Intelligent Performance for Insurance leverages advanced machine learning to deliver supply chain at',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-performance-for-insurance-ac293f4f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Performance for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Intelligent Performance for Insurance leverages advanced machine learning to deliver supply chain at scale.
          </p>
