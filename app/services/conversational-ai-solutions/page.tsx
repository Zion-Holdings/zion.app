...
export const metadata = {
  title: 'Conversational AI Solutions | Zion Tech Group',
  description: 'Engage customers with intelligent chatbots and virtual assistants. Discover how Zion Tech Group can help transform your business.',
  openGraph: {
    title: 'Conversational AI Solutions | Zion Tech Group',
    description: 'Engage customers with intelligent chatbots and virtual assistants',
    url: 'https://ziontechgroup.com/solutions/conversational-ai-solutions',
  },
  twitter: { card: 'summary_large_image' },
};

const features = ["Natural language understanding","Multi-channel deployment","Contextual conversations","Integration with business systems","Continuous learning"];
const benefits = ["Provide 24/7 customer support","Handle unlimited conversations","Reduce support costs by 60%","Improve customer satisfaction","Capture valuable insights"];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50">
      <section className="py-20 text-center max-w-7xl mx-auto px-4">
        ...
        <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">Conversational AI Solutions</h1>
        <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">Engage customers with intelligent chatbots and virtual assistants</p>
