...
export const metadata: Metadata = {
  title: 'Security Cognitive - Iot #1',
  description: 'Next-generation iot solution: Security Cognitive - Iot #1. Combines threat detection with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-cognitive---iot-1-5fad1b27',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Cognitive - Iot #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation iot solution: Security Cognitive - Iot #1. Combines threat detection with adaptive intelligence for optimal results.
          </p>
