...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize energy through intelligent automation. Our Smart Marketing Platform - Energy leverages advanced machine learning to deliver contract analysis at s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Smart Marketing Platform - Energy leverages advanced machine learning to deliver contract analysis at scale.
          </p>
