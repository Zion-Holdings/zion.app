...
export const metadata: Metadata = {
  title: 'Sales Intelligent - Legal',
  description: 'Enhance your legal business with Sales Intelligent - Legal. Our solution provides cost reduction with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/sales-intelligent-legal-13ab94f7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Sales Intelligent - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Sales Intelligent - Legal. Our solution provides cost reduction with enterprise-grade reliability and security.
          </p>
