...
export const metadata: Metadata = {
  title: 'AI-Powered Cloud for Proptech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Cloud for Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with AI-Powered Cloud for Proptech. Powered by cutting-edge AI, this platform delivers network optimization like never before.
          </p>
