...
export const metadata: Metadata = {
  title: 'Predictive Cognitive Engine - Logistics',
  description: 'The future of logistics is here with Predictive Cognitive Engine - Logistics. Powered by cutting-edge AI, this platform delivers forecast accuracy like never be',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Cognitive Engine - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Predictive Cognitive Engine - Logistics. Powered by cutting-edge AI, this platform delivers forecast accuracy like never before.
          </p>
