...
export const metadata: Metadata = {
  title: 'AI-Powered Healthcare Ai Platform 100',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Healthcare Ai Platform 100
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered ai platform for healthcare industry. Leverages machine learning for advanced analytics and automation.
          </p>
