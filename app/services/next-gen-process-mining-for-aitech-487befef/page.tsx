...
export const metadata: Metadata = {
  title: 'Next-Gen Process Mining for AITECH',
  description: 'Optimize your aitech workflows with Next-Gen Process Mining for AITECH. This intelligent platform delivers capacity management through advanced automation and A',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-process-mining-for-aitech-487befef',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Process Mining for AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your aitech workflows with Next-Gen Process Mining for AITECH. This intelligent platform delivers capacity management through advanced automation and AI.
          </p>
