...
export const metadata: Metadata = {
  title: 'AI/IT support-agriculture',
  description: 'Quantum leap forward for agriculture: AI/IT support-agriculture. Uses quantum-inspired algorithms to deliver supply visibility at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-support-agriculture-b9a22668',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT support-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for agriculture: AI/IT support-agriculture. Uses quantum-inspired algorithms to deliver supply visibility at exponential speed.
          </p>
