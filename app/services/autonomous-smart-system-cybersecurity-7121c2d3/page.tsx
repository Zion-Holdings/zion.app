...
export const metadata: Metadata = {
  title: 'Autonomous Smart System - Cybersecurity',
  description: 'Drive innovation in cybersecurity with Autonomous Smart System - Cybersecurity. This AI-powered platform transforms sustainability tracking into a competitive a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-smart-system-cybersecurity-7121c2d3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Smart System - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in cybersecurity with Autonomous Smart System - Cybersecurity. This AI-powered platform transforms sustainability tracking into a competitive advantage.
          </p>
