...
export const metadata: Metadata = {
  ...
  description: 'Drive innovation in real-estate with Intelligent Customer Service for Real-Estate. This AI-powered platform transforms invoice processing into a competitive adv',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in real-estate with Intelligent Customer Service for Real-Estate. This AI-powered platform transforms invoice processing into a competitive advantage.
          </p>
