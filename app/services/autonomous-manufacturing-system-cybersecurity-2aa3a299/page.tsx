...
export const metadata: Metadata = {
  title: 'Autonomous Manufacturing System - Cybersecurity',
  description: 'Drive innovation in cybersecurity with Autonomous Manufacturing System - Cybersecurity. This AI-powered platform transforms forecast accuracy into a competitive',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Manufacturing System - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in cybersecurity with Autonomous Manufacturing System - Cybersecurity. This AI-powered platform transforms forecast accuracy into a competitive advantage.
          </p>
