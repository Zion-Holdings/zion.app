...
export const metadata: Metadata = {
  title: 'AI-Powered Net Optimizer',
  description: 'Optimize your logistics workflows with AI-Powered Net Optimizer. This intelligent platform delivers time tracking through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-net-optimizer-a35604b6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Net Optimizer
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your logistics workflows with AI-Powered Net Optimizer. This intelligent platform delivers time tracking through advanced automation and AI.
          </p>
