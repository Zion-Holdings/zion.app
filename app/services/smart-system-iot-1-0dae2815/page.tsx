...
export const metadata: Metadata = {
  title: 'Smart system-iot #1',
  description: 'Unlock unprecedented growth with Smart system-iot #1. This autonomous system provides performance monitoring with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-system-iot-1-0dae2815',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart system-iot #1. This autonomous system provides performance monitoring with zero manual intervention needed.
          </p>
