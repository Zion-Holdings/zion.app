...
export const metadata: Metadata = {
  title: 'Smart Data Platform - Transportation',
  description: 'Optimize your transportation workflows with Smart Data Platform - Transportation. This intelligent platform delivers container orchestration through advanced au',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-data-platform-transportation-5a0b941b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Data Platform - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Smart Data Platform - Transportation. This intelligent platform delivers container orchestration through advanced automation and AI.
          </p>
