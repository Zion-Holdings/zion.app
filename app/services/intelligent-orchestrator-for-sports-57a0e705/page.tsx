...
export const metadata: Metadata = {
  ...
  description: 'Transform your sports operations with our Intelligent Orchestrator for Sports. This AI-driven solution automates quality control with unprecedented accuracy and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-orchestrator-for-sports-57a0e705',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our Intelligent Orchestrator for Sports. This AI-driven solution automates quality control with unprecedented accuracy and efficiency.
          </p>
