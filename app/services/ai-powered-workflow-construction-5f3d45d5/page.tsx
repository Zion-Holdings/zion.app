...
export const metadata: Metadata = {
  title: 'AI-Powered workflow-construction',
  description: 'Optimize your construction workflows with AI-Powered workflow-construction. This intelligent platform delivers cost tracking through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-workflow-construction-5f3d45d5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with AI-Powered workflow-construction. This intelligent platform delivers cost tracking through advanced automation and AI.
          </p>
