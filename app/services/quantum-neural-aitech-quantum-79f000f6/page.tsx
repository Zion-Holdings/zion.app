...
export const metadata: Metadata = {
  title: 'Quantum Neural - AITECH Quantum',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Neural - AITECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for aitech: Quantum Neural - AITECH Quantum. Uses quantum-inspired algorithms to deliver image recognition at exponential speed.
          </p>
