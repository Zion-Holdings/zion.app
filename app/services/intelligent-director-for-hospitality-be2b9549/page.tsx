export const metadata = {
  ...
  description: "Zion Tech Group delivers Intelligent Director for Hospitality with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/services/intelligent-director-for-hospitality-be2b9549/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>Intelligent Director for Hospitality</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers Intelligent Director for Hospitality with measurable outcomes.
      </p>
