...
export const metadata: Metadata = {
  title: 'Intelligent Content for Marketplace',
  description: 'Optimize your marketplace workflows with Intelligent Content for Marketplace. This intelligent platform delivers budget tracking through advanced automation and',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Content for Marketplace
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your marketplace workflows with Intelligent Content for Marketplace. This intelligent platform delivers budget tracking through advanced automation and AI.
          </p>
