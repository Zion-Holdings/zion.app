...
export const metadata: Metadata = {
  title: 'Smart Manufacturing Platform - Logistics',
  description: 'Optimize your logistics workflows with Smart Manufacturing Platform - Logistics. This intelligent platform delivers release management through advanced automati',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manufacturing Platform - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your logistics workflows with Smart Manufacturing Platform - Logistics. This intelligent platform delivers release management through advanced automation and AI.
          </p>
