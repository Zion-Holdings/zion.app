...
export const metadata: Metadata = {
  title: 'Autonomous Orchestrator for Logistics',
  description: 'Transform your logistics operations with our Autonomous Orchestrator for Logistics. This AI-driven solution automates compliance monitoring with unprecedented a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Orchestrator for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Autonomous Orchestrator for Logistics. This AI-driven solution automates compliance monitoring with unprecedented accuracy and efficiency.
          </p>
