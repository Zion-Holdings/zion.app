...
export const metadata: Metadata = {
  ...
  description: 'Drive innovation in education with Intelligent Risk for Education. This AI-powered platform transforms performance monitoring into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-risk-for-education-47c11ba7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in education with Intelligent Risk for Education. This AI-powered platform transforms performance monitoring into a competitive advantage.
          </p>
