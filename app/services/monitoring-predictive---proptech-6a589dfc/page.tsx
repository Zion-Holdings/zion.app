...
export const metadata: Metadata = {
  title: 'Monitoring Predictive - Proptech',
  description: 'The future of proptech is here with Monitoring Predictive - Proptech. Powered by cutting-edge AI, this platform delivers quality control like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/monitoring-predictive---proptech-6a589dfc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Monitoring Predictive - Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with Monitoring Predictive - Proptech. Powered by cutting-edge AI, this platform delivers quality control like never before.
          </p>
