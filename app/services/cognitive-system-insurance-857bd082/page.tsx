...
export const metadata: Metadata = {
  title: 'Cognitive system-insurance',
  description: 'The future of insurance is here with Cognitive system-insurance. Powered by cutting-edge AI, this platform delivers quota optimization like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-system-insurance-857bd082',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive system-insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Cognitive system-insurance. Powered by cutting-edge AI, this platform delivers quota optimization like never before.
          </p>
