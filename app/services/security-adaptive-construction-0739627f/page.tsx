...
export const metadata: Metadata = {
  title: 'Security Adaptive - Construction',
  description: 'Optimize your construction workflows with Security Adaptive - Construction. This intelligent platform delivers competitive intelligence through advanced automat',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-adaptive-construction-0739627f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Adaptive - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Security Adaptive - Construction. This intelligent platform delivers competitive intelligence through advanced automation and AI.
          </p>
