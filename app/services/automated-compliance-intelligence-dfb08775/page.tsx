...
export const metadata: Metadata = {
  ...
  keywords: 'Auto-scaling capabilities, Data encryption, GDPR compliance, Cloud-native architecture, Machine learning integration, Comprehensive monitoring, orchestrator, construction, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Automated Compliance Intelligence</h1>
        <p className="text-lg text-slate-300 mb-8">Next-generation construction solution: Automated Compliance Intelligence. Combines threat detection with adaptive intelligence for optimal results.</p>
