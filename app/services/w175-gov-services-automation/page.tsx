...
export const metadata: Metadata = {
  ...
  keywords: 'Permit and license processing automation, Benefits eligibility determination, Case management and workflow, Citizen portal and self-service, Inter-agency data sharing (with consent), Compliance (FedRAMP, FISMA, Section 508), Open data and transparency reporting, automation, Government, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Government Services Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Digital government services automation: permit processing, benefits eligibility, case management, and citizen communication. FedRAMP compatible.</p>
        ...
        <li class="text-slate-300">Permit and license processing automation</li>
        <li class="text-slate-300">Benefits eligibility determination</li>
        <li class="text-slate-300">Case management and workflow</li>
        <li class="text-slate-300">Citizen portal and self-service</li>
        <li class="text-slate-300">Inter-agency data sharing (with consent)</li>
        <li class="text-slate-300">Compliance (FedRAMP, FISMA, Section 508)</li>
        <li class="text-slate-300">Open data and transparency reporting</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce permit processing time by 80%</li>
        <li class="text-slate-300">Benefits eligibility in minutes, not weeks</li>
        <li class="text-slate-300">Citizen self-service reduces counter traffic</li>
        <li class="text-slate-300">FedRAMP compatible for federal deployment</li>
      </ul>
        </div>
