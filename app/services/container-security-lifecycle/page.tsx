...
export const metadata: Metadata = {
  ...
  keywords: 'Registry vuln scanning (Trivy), Runtime behavior monitoring (Falco), OPA admission policy engine, SBOM attestation per image, SLSA Level 3+ supply chain attestation, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Container &amp; Kubernetes Security</h1>
        <p className="text-lg text-slate-300 mb-8">Full container security: registry scanning (Trivy/Clair), runtime protection (Falco), OPA admission controllers, SBOM attestation per build.</p>
        ...
        <li class="text-slate-300">Registry vuln scanning (Trivy)</li>
        <li class="text-slate-300">Runtime behavior monitoring (Falco)</li>
        <li class="text-slate-300">OPA admission policy engine</li>
        <li class="text-slate-300">SBOM attestation per image</li>
        <li class="text-slate-300">SLSA Level 3+ supply chain attestation</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with container &amp; kubernetes security</li>
