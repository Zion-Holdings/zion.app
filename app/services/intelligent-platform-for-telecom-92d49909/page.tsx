...
export const metadata: Metadata = {
  title: 'Intelligent Platform for Telecom',
  description: 'Next-generation telecom solution: Intelligent Platform for Telecom. Combines network optimization with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-platform-for-telecom-92d49909',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Platform for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation telecom solution: Intelligent Platform for Telecom. Combines network optimization with adaptive intelligence for optimal results.
          </p>
