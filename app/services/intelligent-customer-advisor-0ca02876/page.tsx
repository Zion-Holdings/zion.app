...
export const metadata: Metadata = {
  title: 'Intelligent Customer Advisor',
  description: 'The future of logistics is here with Intelligent Customer Advisor. Powered by cutting-edge AI, this platform delivers network optimization like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-customer-advisor-0ca02876',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Customer Advisor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Intelligent Customer Advisor. Powered by cutting-edge AI, this platform delivers network optimization like never before.
          </p>
