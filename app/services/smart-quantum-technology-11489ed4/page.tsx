...
export const metadata: Metadata = {
  title: 'Smart Quantum - TECHNOLOGY',
  description: 'Drive innovation in technology with Smart Quantum - TECHNOLOGY. This AI-powered platform transforms demand planning into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-quantum-technology-11489ed4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in technology with Smart Quantum - TECHNOLOGY. This AI-powered platform transforms demand planning into a competitive advantage.
          </p>
