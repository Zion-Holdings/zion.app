...
export const metadata: Metadata = {
  title: 'Smart Sales Platform - Hospitality',
  description: 'Enhance your hospitality business with Smart Sales Platform - Hospitality. Our solution provides access management with enterprise-grade reliability and securit',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-sales-platform-hospitality-d2595f77',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Sales Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Smart Sales Platform - Hospitality. Our solution provides access management with enterprise-grade reliability and security.
          </p>
