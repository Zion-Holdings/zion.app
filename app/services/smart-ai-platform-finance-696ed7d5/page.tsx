...
export const metadata: Metadata = {
  title: 'Smart AI Platform - Finance',
  description: 'Transform your finance operations with our Smart AI Platform - Finance. This AI-driven solution automates disaster recovery with unprecedented accuracy and effi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-ai-platform-finance-696ed7d5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart AI Platform - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Smart AI Platform - Finance. This AI-driven solution automates disaster recovery with unprecedented accuracy and efficiency.
          </p>
