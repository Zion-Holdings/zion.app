...
export const metadata: Metadata = {
  title: 'Intelligent Platform for Hospitality',
  description: 'Hyper-accelerated hospitality solution: Intelligent Platform for Hospitality. Combines performance monitoring with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-platform-for-hospitality-8a672345',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Platform for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated hospitality solution: Intelligent Platform for Hospitality. Combines performance monitoring with next-gen AI for maximum velocity.
          </p>
