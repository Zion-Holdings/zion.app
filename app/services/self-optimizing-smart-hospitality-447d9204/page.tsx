...
export const metadata: Metadata = {
  title: 'Self-Optimizing smart-hospitality',
  description: 'Drive innovation in hospitality with Self-Optimizing smart-hospitality. This AI-powered platform transforms master data management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/self-optimizing-smart-hospitality-447d9204',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing smart-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Self-Optimizing smart-hospitality. This AI-powered platform transforms master data management into a competitive advantage.
          </p>
