...
export const metadata: Metadata = {
  title: 'Platform Cognitive - Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Platform Cognitive - Insurance leverages advanced machine learning to deliver enterprise-grade insig',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/platform-cognitive-insurance-ba6b8df1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Platform Cognitive - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Platform Cognitive - Insurance leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
