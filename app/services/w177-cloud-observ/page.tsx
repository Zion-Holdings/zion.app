...
export const metadata: Metadata = {
  ...
  keywords: 'Metrics collection and dashboards, Distributed tracing (OpenTelemetry), Log aggregation and search, Continuous profiling, AI-powered anomaly detection, SLO/SLI tracking and error budgets, Integration with Datadog, Grafana, Honeycomb, cloud, Observability, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cloud Observability Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Full-stack cloud observability: metrics, traces, logs, profiling. OpenTelemetry-native with AI-powered anomaly detection.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">cloud</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">Observability</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Metrics collection and dashboards</li>
        <li class="text-slate-300">Distributed tracing (OpenTelemetry)</li>
        <li class="text-slate-300">Log aggregation and search</li>
        <li class="text-slate-300">Continuous profiling</li>
        <li class="text-slate-300">AI-powered anomaly detection</li>
        <li class="text-slate-300">SLO/SLI tracking and error budgets</li>
        <li class="text-slate-300">Integration with Datadog</li>
        <li class="text-slate-300">Grafana</li>
        <li class="text-slate-300">Honeycomb</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Full-stack observability in one platform</li>
        <li class="text-slate-300">OpenTelemetry-native no vendor lock-in</li>
        <li class="text-slate-300">AI anomaly detection finds issues first</li>
        <li class="text-slate-300">SLO tracking aligns engineering with business</li>
      </ul>
        </div>
