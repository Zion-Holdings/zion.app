...
export const metadata: Metadata = {
  title: 'Autonomous intelligent-logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Autonomous intelligent-logistics leverages advanced machine learning to deliver energy management at',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-intelligent-logistics-ae96fac4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Autonomous intelligent-logistics leverages advanced machine learning to deliver energy management at scale.
          </p>
