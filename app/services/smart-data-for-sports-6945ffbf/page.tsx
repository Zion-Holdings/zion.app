...
export const metadata: Metadata = {
  title: 'Smart Data for Sports',
  description: 'Next-generation sports solution: Smart Data for Sports. Combines customer service automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-data-for-sports-6945ffbf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Data for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation sports solution: Smart Data for Sports. Combines customer service automation with adaptive intelligence for optimal results.
          </p>
