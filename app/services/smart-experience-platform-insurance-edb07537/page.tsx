...
export const metadata: Metadata = {
  title: 'Smart Experience Platform - Insurance',
  description: 'The future of insurance is here with Smart Experience Platform - Insurance. Powered by cutting-edge AI, this platform delivers resource allocation like never be',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-experience-platform-insurance-edb07537',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Experience Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Smart Experience Platform - Insurance. Powered by cutting-edge AI, this platform delivers resource allocation like never before.
          </p>
