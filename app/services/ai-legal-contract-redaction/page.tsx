...
export const metadata: Metadata = {
  ...
  keywords: 'Entity recognition (PII, PHI, PCI), Custom redaction rules per jurisdiction, Audit trail of redactions, Secure workspace with encryption, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Legal Contract Redaction</h1>
        <p className="text-lg text-slate-300 mb-8">Automatically redacts PII, trade secrets, and privileged information from legal documents before sharing or discovery.</p>
        ...
        <li class="text-slate-300">Entity recognition (PII, PHI, PCI)</li>
        <li class="text-slate-300">Custom redaction rules per jurisdiction</li>
        <li class="text-slate-300">Audit trail of redactions</li>
        <li class="text-slate-300">Secure workspace with encryption</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai legal contract redaction</li>
