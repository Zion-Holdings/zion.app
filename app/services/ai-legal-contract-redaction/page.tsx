      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Automatically redacts PII, trade secrets, and privileged information from legal documents before sharing or discovery.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Entity recognition (PII, PHI, PCI)</li>
            <li className="text-purple-300">✓ Custom redaction rules per jurisdiction</li>
            <li className="text-purple-300">✓ Audit trail of redactions</li>
            <li className="text-purple-300">✓ Secure workspace with encryption</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai legal contract redaction</li>
