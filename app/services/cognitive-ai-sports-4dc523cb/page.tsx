...
export const metadata: Metadata = {
  title: 'Cognitive ai-sports',
  description: 'Revolutionize sports through intelligent automation. Our Cognitive ai-sports leverages advanced machine learning to deliver enterprise-grade insights at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-ai-sports-4dc523cb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Cognitive ai-sports leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
