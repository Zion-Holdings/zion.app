...
export const metadata: Metadata = {
  title: 'Autonomous Intelligence for Real-Estate',
  description: 'Transform your real-estate operations with our Autonomous Intelligence for Real-Estate. This AI-driven solution automates image recognition with unprecedented a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Autonomous Intelligence for Real-Estate. This AI-driven solution automates image recognition with unprecedented accuracy and efficiency.
          </p>
