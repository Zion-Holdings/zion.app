...
export const metadata: Metadata = {
  title: 'Enterprise Experience Platform - Media',
  description: 'Transform your media operations with our Enterprise Experience Platform - Media. This AI-driven solution automates quality assurance with unprecedented accuracy',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-experience-platform-media-5aecd36d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Experience Platform - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your media operations with our Enterprise Experience Platform - Media. This AI-driven solution automates quality assurance with unprecedented accuracy and efficiency.
          </p>
