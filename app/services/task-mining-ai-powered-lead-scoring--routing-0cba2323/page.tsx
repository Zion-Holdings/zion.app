...
export const metadata: Metadata = {
  title: 'Task Mining AI-Powered Lead Scoring & Routing',
  description: 'AI-powered task mining solution for sales. Scores and routes sales leads in real-time based on engagement.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/task-mining-ai-powered-lead-scoring--routing-0cba2323',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Task Mining AI-Powered Lead Scoring & Routing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered task mining solution for sales. Scores and routes sales leads in real-time based on engagement.
          </p>
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-purple-900/30 text-purple-300 text-sm">
            <span className="mr-2">💡</span>
            <span>Task Mining</span>
          </div>
        </div>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Real-time scoring</li>
          <li className="text-gray-300">Automated routing</li>
          </ul>
        </section>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your task mining operations?</p>
