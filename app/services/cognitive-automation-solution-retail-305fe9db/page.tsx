...
export const metadata: Metadata = {
  title: 'Cognitive Automation Solution - Retail',
  description: 'Drive innovation in retail with Cognitive Automation Solution - Retail. This AI-powered platform transforms business continuity into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-automation-solution-retail-305fe9db',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Automation Solution - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in retail with Cognitive Automation Solution - Retail. This AI-powered platform transforms business continuity into a competitive advantage.
          </p>
