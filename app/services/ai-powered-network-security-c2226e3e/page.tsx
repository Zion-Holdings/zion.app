...
export const metadata: Metadata = {
  title: "AI-Powered Network Security - AI-Powered Network Security Solution",
  description: "AI-driven network security with threat detection and response.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-network-security-c2226e3e",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Network Security - AI-Powered Network Security Solution
        </h1>
