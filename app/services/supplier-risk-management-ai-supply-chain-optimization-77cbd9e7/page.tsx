...
export const metadata: Metadata = {
  title: 'Supplier Risk Management AI Supply Chain Optimization',
  description: 'supplier risk management solution for hedge funds industry. Optimizes supply chain operations using predictive analytics, demand forecasting, and route optimiza',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/supplier-risk-management-ai-supply-chain-optimization-77cbd9e7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Supplier Risk Management AI Supply Chain Optimization
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            supplier risk management solution for hedge funds industry. Optimizes supply chain operations using predictive analytics, demand forecasting, and route optimization.
          </p>
