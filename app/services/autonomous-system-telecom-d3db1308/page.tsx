...
export const metadata: Metadata = {
  title: 'Autonomous system-telecom',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous system-telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your telecom business with Autonomous system-telecom. Our solution provides automation opportunity with enterprise-grade reliability and security.
          </p>
