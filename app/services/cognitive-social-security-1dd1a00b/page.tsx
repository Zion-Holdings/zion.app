...
export const metadata: Metadata = {
  title: 'Cognitive Social Security',
  description: 'Enhance your healthcare business with Cognitive Social Security. Our solution provides content moderation with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-social-security-1dd1a00b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Social Security
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with Cognitive Social Security. Our solution provides content moderation with enterprise-grade reliability and security.
          </p>
