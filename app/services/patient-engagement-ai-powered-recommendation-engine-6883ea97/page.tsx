...
export const metadata: Metadata = {
  title: 'Patient Engagement AI-Powered Recommendation Engine',
  description: 'AI-powered patient engagement solution for e-commerce. Personalized product and content recommendations for e-commerce and media.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/patient-engagement-ai-powered-recommendation-engine-6883ea97',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Patient Engagement AI-Powered Recommendation Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered patient engagement solution for e-commerce. Personalized product and content recommendations for e-commerce and media.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your patient engagement operations?</p>
