    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        ...
        <p className="text-xl text-slate-300 mb-8">
          Enterprise knowledge graph platform that connects disparate data sources into a unified semantic layer. Enables intelligent search, recommendation, and decision
        </p>
