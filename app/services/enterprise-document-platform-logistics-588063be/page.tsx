...
export const metadata: Metadata = {
  title: 'Enterprise Document Platform - Logistics',
  description: 'Drive innovation in logistics with Enterprise Document Platform - Logistics. This AI-powered platform transforms loyalty optimization into a competitive advanta',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-document-platform-logistics-588063be',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Document Platform - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with Enterprise Document Platform - Logistics. This AI-powered platform transforms loyalty optimization into a competitive advantage.
          </p>
