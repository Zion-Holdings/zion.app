...
export const metadata: Metadata = {
  title: 'Supply Intelligent - Education',
  description: 'Unlock unprecedented growth with Supply Intelligent - Education. This autonomous system provides logistics route optimization with zero manual intervention need',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/supply-intelligent-education-c2e733de',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Supply Intelligent - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Supply Intelligent - Education. This autonomous system provides logistics route optimization with zero manual intervention needed.
          </p>
