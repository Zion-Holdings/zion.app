...
export const metadata: Metadata = {
  title: 'Explainable AI AI Meeting Assistant Pro',
  description: 'AI-powered explainable ai solution for productivity. AI-powered meeting assistant that generates agendas, takes notes, and schedules follow-ups.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/explainable-ai-ai-meeting-assistant-pro-163f29f9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Explainable AI AI Meeting Assistant Pro
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered explainable ai solution for productivity. AI-powered meeting assistant that generates agendas, takes notes, and schedules follow-ups.
          </p>
