...
export const metadata: Metadata = {
  title: 'Next-Gen Generator for Construction',
  description: 'Next-generation construction solution: Next-Gen Generator for Construction. Combines record extraction with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-generator-for-construction-b01905bf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Generator for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Next-Gen Generator for Construction. Combines record extraction with adaptive intelligence for optimal results.
          </p>
