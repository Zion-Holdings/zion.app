...
export const metadata: Metadata = {
  title: 'Automated Platform for Gaming',
  description: 'The future of gaming is here with Automated Platform for Gaming. Powered by cutting-edge AI, this platform delivers customer service automation like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-platform-for-gaming-2f4220cc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Platform for Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of gaming is here with Automated Platform for Gaming. Powered by cutting-edge AI, this platform delivers customer service automation like never before.
          </p>
