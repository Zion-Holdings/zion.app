...
export const metadata: Metadata = {
  ...
  description: 'Transform your manufacturing operations with our Autonomous Management for Manufacturing. This AI-driven solution automates inventory management with unpreceden',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-management-for-manufacturing-96cbcd57',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your manufacturing operations with our Autonomous Management for Manufacturing. This AI-driven solution automates inventory management with unprecedented accuracy and efficiency.
          </p>
