...
export const metadata: Metadata = {
  title: 'AI AI-Powered Log Analysis',
  description: 'AI-powered ai solution for devops. Automated log analysis for incident detection and root cause analysis.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-ai-powered-log-analysis-695cd123',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            AI-powered ai solution for devops. Automated log analysis for incident detection and root cause analysis.
          </p>
