...
export const metadata: Metadata = {
  ...
  description: 'Transform your healthcare operations with our AI-Powered Processor for Healthcare. This AI-driven solution automates quality control with unprecedented accuracy',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-processor-for-healthcare-ca7119b5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our AI-Powered Processor for Healthcare. This AI-driven solution automates quality control with unprecedented accuracy and efficiency.
          </p>
