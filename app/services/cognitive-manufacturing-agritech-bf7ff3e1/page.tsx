...
export const metadata: Metadata = {
  title: 'Cognitive manufacturing-agritech',
  description: 'Revolutionize agritech through intelligent automation. Our Cognitive manufacturing-agritech leverages advanced machine learning to deliver supply chain at scale',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-manufacturing-agritech-bf7ff3e1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive manufacturing-agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agritech through intelligent automation. Our Cognitive manufacturing-agritech leverages advanced machine learning to deliver supply chain at scale.
          </p>
