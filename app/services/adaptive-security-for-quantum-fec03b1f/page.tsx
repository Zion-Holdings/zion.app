...
export const metadata: Metadata = {
  title: 'Adaptive Security for Quantum',
  description: 'Transform your quantum operations with our Adaptive Security for Quantum. This AI-driven solution automates workflow management with unprecedented accuracy and ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Security for Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your quantum operations with our Adaptive Security for Quantum. This AI-driven solution automates workflow management with unprecedented accuracy and efficiency.
          </p>
