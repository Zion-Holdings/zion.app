...
export const metadata: Metadata = {
  title: 'Autonomous Security System - Sports',
  description: 'Revolutionize sports through intelligent automation. Our Autonomous Security System - Sports leverages advanced machine learning to deliver pipeline management ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-security-system-sports-c3943ace',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Security System - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Autonomous Security System - Sports leverages advanced machine learning to deliver pipeline management at scale.
          </p>
