...
export const metadata: Metadata = {
  title: 'Smart Business Intelligence Platform - Sports',
  description: 'Transform your sports operations with our Smart Business Intelligence Platform - Sports. This AI-driven solution automates brand sentiment with unprecedented ac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-business-intelligence-platform-sports-76a7efca',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Business Intelligence Platform - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our Smart Business Intelligence Platform - Sports. This AI-driven solution automates brand sentiment with unprecedented accuracy and efficiency.
          </p>
