...
export const metadata: Metadata = {
  title: 'Adaptive Management for Energy',
  description: 'Next-generation energy solution: Adaptive Management for Energy. Combines financial planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-management-for-energy-2d33f4cf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Management for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Adaptive Management for Energy. Combines financial planning with adaptive intelligence for optimal results.
          </p>
