...
export const metadata: Metadata = {
  title: 'Cognitive Invoice Machine Learning',
  description: 'Next-generation transportation solution: Cognitive Invoice Machine Learning. Combines release management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-invoice-machine-learning-ca98301e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Invoice Machine Learning
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation transportation solution: Cognitive Invoice Machine Learning. Combines release management with adaptive intelligence for optimal results.
          </p>
