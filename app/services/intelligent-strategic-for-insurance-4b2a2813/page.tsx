...
export const metadata: Metadata = {
  title: 'Intelligent Strategic for Insurance',
  description: 'Optimize your insurance workflows with Intelligent Strategic for Insurance. This intelligent platform delivers customer journey mapping through advanced automat',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Strategic for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Intelligent Strategic for Insurance. This intelligent platform delivers customer journey mapping through advanced automation and AI.
          </p>
