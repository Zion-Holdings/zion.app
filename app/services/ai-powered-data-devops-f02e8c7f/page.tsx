...
export const metadata: Metadata = {
  title: 'AI-Powered Data DevOps',
  description: 'Enhance your construction business with AI-Powered Data DevOps. Our solution provides user experience with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-data-devops-f02e8c7f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Data DevOps
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with AI-Powered Data DevOps. Our solution provides user experience with enterprise-grade reliability and security.
          </p>
