...
export const metadata: Metadata = {
  ...
  keywords: 'Per-user behavior baseline engine, Multi-signal anomaly scoring, Cross-account ring detection, Geo-velocity + device fingerprint trigger, Slack/PagerDuty webhook for SOC integration, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Fraud Pattern Analyzer</h1>
        <p className="text-lg text-slate-300 mb-8">Deep behavioral profiling: baseline per user then alerts on anomalous patterns — login geography, transaction velocity, amount/type deviation, withdrawn account signals. Links across accounts to detect ring fraud.</p>
        ...
        <li class="text-slate-300">Per-user behavior baseline engine</li>
        <li class="text-slate-300">Multi-signal anomaly scoring</li>
        <li class="text-slate-300">Cross-account ring detection</li>
        <li class="text-slate-300">Geo-velocity + device fingerprint trigger</li>
        <li class="text-slate-300">Slack/PagerDuty webhook for SOC integration</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai fraud pattern analyzer</li>
