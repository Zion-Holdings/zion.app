      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Deep behavioral profiling: baseline per user then alerts on anomalous patterns — login geography, transaction velocity, amount/type deviation, withdrawn account signals. Links across accounts to detect ring fraud.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Per-user behavior baseline engine</li>
            <li className="text-purple-300">✓ Multi-signal anomaly scoring</li>
            <li className="text-purple-300">✓ Cross-account ring detection</li>
            <li className="text-purple-300">✓ Geo-velocity + device fingerprint trigger</li>
            <li className="text-purple-300">✓ Slack/PagerDuty webhook for SOC integration</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai fraud pattern analyzer</li>
