...
export const metadata: Metadata = {
  title: 'Automated sales-transportation',
  description: 'Enhance your transportation business with Automated sales-transportation. Our solution provides business intelligence with enterprise-grade reliability and secu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-sales-transportation-a117a821',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated sales-transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with Automated sales-transportation. Our solution provides business intelligence with enterprise-grade reliability and security.
          </p>
