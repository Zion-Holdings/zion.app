...
export const metadata: Metadata = {
  title: 'Manager AI - Telecom',
  description: 'Transform your telecom operations with our Manager AI - Telecom. This AI-driven solution automates pipeline management with unprecedented accuracy and efficienc',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your telecom operations with our Manager AI - Telecom. This AI-driven solution automates pipeline management with unprecedented accuracy and efficiency.
          </p>
