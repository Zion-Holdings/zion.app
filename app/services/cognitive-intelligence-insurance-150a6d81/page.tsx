...
export const metadata: Metadata = {
  title: 'Cognitive intelligence-insurance',
  description: 'The future of insurance is here with Cognitive intelligence-insurance. Powered by cutting-edge AI, this platform delivers transformative results like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-intelligence-insurance-150a6d81',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive intelligence-insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Cognitive intelligence-insurance. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
