...
export const metadata: Metadata = {
  title: 'Process Mining Self-Optimizing - Energy',
  description: 'Revolutionize energy through intelligent automation. Our Process Mining Self-Optimizing - Energy leverages advanced machine learning to deliver resource utiliza',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Process Mining Self-Optimizing - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Process Mining Self-Optimizing - Energy leverages advanced machine learning to deliver resource utilization at scale.
          </p>
