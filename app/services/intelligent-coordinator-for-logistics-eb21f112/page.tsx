...
export const metadata: Metadata = {
  title: 'Intelligent Coordinator for Logistics',
  description: 'Unlock unprecedented growth with Intelligent Coordinator for Logistics. This autonomous system provides resource utilization with zero manual intervention neede',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-coordinator-for-logistics-eb21f112',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Coordinator for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Coordinator for Logistics. This autonomous system provides resource utilization with zero manual intervention needed.
          </p>
