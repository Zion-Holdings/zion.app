...
export const metadata: Metadata = {
  title: 'Intelligent Cloud for Agriculture',
  description: 'Next-generation agriculture solution: Intelligent Cloud for Agriculture. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-cloud-for-agriculture-4430b5d1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Cloud for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agriculture solution: Intelligent Cloud for Agriculture. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
