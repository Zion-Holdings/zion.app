...
export const metadata: Metadata = {
  title: 'Adaptive Lead Coordinator',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Lead Coordinator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Adaptive Lead Coordinator. Our solution provides decision support with enterprise-grade reliability and security.
          </p>
