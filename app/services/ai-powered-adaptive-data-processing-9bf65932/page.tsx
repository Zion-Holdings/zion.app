  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Powered Adaptive Data Processing</h1>
        <p className="text-lg text-slate-300 mb-8">Intelligent data processing platform that automates extraction, transformation, and loading of data at scale.</p>
