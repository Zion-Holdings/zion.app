...
export const metadata: Metadata = {
  title: 'Smart Platform Platform - Sports',
  description: 'The future of sports is here with Smart Platform Platform - Sports. Powered by cutting-edge AI, this platform delivers business intelligence like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-platform-platform-sports-e7419d1d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Platform Platform - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Smart Platform Platform - Sports. Powered by cutting-edge AI, this platform delivers business intelligence like never before.
          </p>
