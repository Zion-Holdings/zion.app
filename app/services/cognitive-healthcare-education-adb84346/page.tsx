...
export const metadata: Metadata = {
  title: 'Cognitive healthcare-education',
  description: 'Revolutionize education through intelligent automation. Our Cognitive healthcare-education leverages advanced machine learning to deliver financial planning at ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive healthcare-education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize education through intelligent automation. Our Cognitive healthcare-education leverages advanced machine learning to deliver financial planning at scale.
          </p>
