    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        ...
        <p className="text-xl text-slate-300 mb-8">
          Transform your energy operations with our Automated Automation for Energy. This AI-driven solution automates market intelligence with unprecedented accuracy and
        </p>
