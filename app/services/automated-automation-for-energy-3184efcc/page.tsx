...
export const metadata: Metadata = {
  title: 'Automated Automation for Energy',
  description: 'Transform your energy operations with our Automated Automation for Energy. This AI-driven solution automates maintenance scheduling with unprecedented accuracy ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Automation for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Automated Automation for Energy. This AI-driven solution automates maintenance scheduling with unprecedented accuracy and efficiency.
          </p>
