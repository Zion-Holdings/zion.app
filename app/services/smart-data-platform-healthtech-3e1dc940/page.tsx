...
export const metadata: Metadata = {
  title: 'Smart Data Platform - HEALTHTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Data Platform - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthtech is here with Smart Data Platform - HEALTHTECH. Powered by cutting-edge AI, this platform delivers task mining like never before.
          </p>
