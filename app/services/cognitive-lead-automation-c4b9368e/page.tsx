...
export const metadata: Metadata = {
  title: 'Cognitive Lead Automation',
  description: 'The future of telecom is here with Cognitive Lead Automation. Powered by cutting-edge AI, this platform delivers process automation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-lead-automation-c4b9368e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Lead Automation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of telecom is here with Cognitive Lead Automation. Powered by cutting-edge AI, this platform delivers process automation like never before.
          </p>
