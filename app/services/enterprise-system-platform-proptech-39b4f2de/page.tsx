...
export const metadata: Metadata = {
  title: 'Enterprise System Platform - PROPTECH',
  description: 'Quantum leap forward for proptech: Enterprise System Platform - PROPTECH. Uses quantum-inspired algorithms to deliver business intelligence at exponential speed',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-system-platform-proptech-39b4f2de',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise System Platform - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for proptech: Enterprise System Platform - PROPTECH. Uses quantum-inspired algorithms to deliver business intelligence at exponential speed.
          </p>
