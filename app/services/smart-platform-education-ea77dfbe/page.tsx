...
export const metadata: Metadata = {
  title: 'Smart platform-education',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart platform-education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your education workflows with Smart platform-education. This intelligent platform delivers account planning through advanced automation and AI.
          </p>
