...
export const metadata: Metadata = {
  title: 'Security Adaptive - Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Security Adaptive - Healthcare leverages advanced machine learning to deliver enterprise-grade insi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-adaptive-healthcare-fdf61d93',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Adaptive - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Security Adaptive - Healthcare leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
