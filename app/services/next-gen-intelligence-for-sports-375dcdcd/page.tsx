...
export const metadata: Metadata = {
  title: 'Next-Gen Intelligence for Sports',
  description: 'Unlock unprecedented growth with Next-Gen Intelligence for Sports. This autonomous system provides supply visibility with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-intelligence-for-sports-375dcdcd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Intelligence for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Next-Gen Intelligence for Sports. This autonomous system provides supply visibility with zero manual intervention needed.
          </p>
