...
export const metadata: Metadata = {
  title: 'Director Adaptive - Cleantech',
  description: 'Revolutionize cleantech through intelligent automation. Our Director Adaptive - Cleantech leverages advanced machine learning to deliver image recognition at sc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/director-adaptive---cleantech-9153b907',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Director Adaptive - Cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cleantech through intelligent automation. Our Director Adaptive - Cleantech leverages advanced machine learning to deliver image recognition at scale.
          </p>
