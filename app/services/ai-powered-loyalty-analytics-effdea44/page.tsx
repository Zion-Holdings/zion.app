...
export const metadata: Metadata = {
  title: 'AI-Powered Loyalty Analytics',
  description: 'Transform your insurance operations with our AI-Powered Loyalty Analytics. This AI-driven solution automates executive dashboards with unprecedented accuracy an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our AI-Powered Loyalty Analytics. This AI-driven solution automates executive dashboards with unprecedented accuracy and efficiency.
          </p>
