...
export const metadata: Metadata = {
  title: 'AI/IT Cloud Suite - AITECH #1',
  description: 'Drive innovation in aitech with AI/IT Cloud Suite - AITECH #1. This AI-powered platform transforms supply chain into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-cloud-suite-aitech-1-b7fa2cad',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Cloud Suite - AITECH #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in aitech with AI/IT Cloud Suite - AITECH #1. This AI-powered platform transforms supply chain into a competitive advantage.
          </p>
