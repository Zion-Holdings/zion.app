...
export const metadata: Metadata = {
  title: 'Next-Gen tactical-sports',
  description: 'Hyper-accelerated sports solution: Next-Gen tactical-sports. Combines cost tracking with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-tactical-sports-fdaa30cd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen tactical-sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated sports solution: Next-Gen tactical-sports. Combines cost tracking with next-gen AI for maximum velocity.
          </p>
