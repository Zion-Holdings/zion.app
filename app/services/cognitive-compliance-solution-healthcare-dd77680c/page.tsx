...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize healthcare through intelligent automation. Our Cognitive Compliance Solution - Healthcare leverages advanced machine learning to deliver serverles',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Cognitive Compliance Solution - Healthcare leverages advanced machine learning to deliver serverless deployment at scale.
          </p>
