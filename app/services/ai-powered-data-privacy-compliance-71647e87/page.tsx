...
export const metadata: Metadata = {
  title: 'AI-Powered Data Privacy Compliance',
  description: 'Automates GDPR/CCPA compliance with data mapping and consent management.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-data-privacy-compliance-71647e87',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automates GDPR/CCPA compliance with data mapping and consent management.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Data mapping</li>
          <li className="text-gray-300">Consent management</li>
          </ul>
        </section>
