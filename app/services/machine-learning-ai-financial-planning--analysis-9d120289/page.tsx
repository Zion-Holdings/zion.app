...
export const metadata: Metadata = {
  ...
  description: 'machine learning solution for healthcare industry. Generates financial forecasts, budget plans, and performance analyses using machine learning models.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/machine-learning-ai-financial-planning--analysis-9d120289',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Machine Learning AI Financial Planning & Analysis
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            machine learning solution for healthcare industry. Generates financial forecasts, budget plans, and performance analyses using machine learning models.
          </p>
