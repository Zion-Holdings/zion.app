...
export const metadata: Metadata = {
  title: 'Smart Supply Platform - Real-Estate',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Supply Platform - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation real-estate solution: Smart Supply Platform - Real-Estate. Combines churn prediction with adaptive intelligence for optimal results.
          </p>
