...
export const metadata: Metadata = {
  title: 'Adaptive Energy Director',
  description: 'The future of hospitality is here with Adaptive Energy Director. Powered by cutting-edge AI, this platform delivers data processing like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-energy-director-16216e67',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Energy Director
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Adaptive Energy Director. Powered by cutting-edge AI, this platform delivers data processing like never before.
          </p>
