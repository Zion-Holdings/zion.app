...
export const metadata: Metadata = {
  title: 'Cognitive Resource Management',
  description: 'The future of transportation is here with Cognitive Resource Management. Powered by cutting-edge AI, this platform delivers transformative results like never be',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-resource-management-eb495d6f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Cognitive Resource Management. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
