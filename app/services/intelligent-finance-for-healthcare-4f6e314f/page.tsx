...
export const metadata: Metadata = {
  title: 'Intelligent Finance for Healthcare',
  description: 'Next-generation healthcare solution: Intelligent Finance for Healthcare. Combines inventory management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-finance-for-healthcare-4f6e314f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Finance for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Intelligent Finance for Healthcare. Combines inventory management with adaptive intelligence for optimal results.
          </p>
