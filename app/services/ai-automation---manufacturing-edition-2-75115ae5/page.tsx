...
export const metadata = {
  ...
  description: "Transform your Manufacturing operations with our AI Automation - Manufacturing Edition #2. This AI-driven solution automates data processing with unprecedented ",
  alternates: {
