...
export const metadata: Metadata = {
  title: 'Smart Insights Platform - Insurance #2',
  description: 'Next-generation insurance solution: Smart Insights Platform - Insurance #2. Combines ml model training with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-insights-platform-insurance-2-7e34bd24',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Insights Platform - Insurance #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Smart Insights Platform - Insurance #2. Combines ml model training with adaptive intelligence for optimal results.
          </p>
