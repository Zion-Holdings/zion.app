...
export const metadata: Metadata = {
  title: 'Account Management Intelligent Document Processing AI',
  description: 'account management solution for transportation industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents autom',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/account-management-intelligent-document-processing-ai-0404a6bb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            account management solution for transportation industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.
          </p>
