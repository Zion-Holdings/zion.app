...
export const metadata: Metadata = {
  title: 'Smart autonomous-manufacturing',
  description: 'Next-generation manufacturing solution: Smart autonomous-manufacturing. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-autonomous-manufacturing-3fa44bb6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation manufacturing solution: Smart autonomous-manufacturing. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
