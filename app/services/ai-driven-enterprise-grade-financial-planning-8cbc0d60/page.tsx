...
export const metadata = {
  ...
  description: "Automated financial planning system that creates enterprise-grade personalized wealth strategies, tax optimization, and retirement planning using advanced algor",
  alternates: {
