...
export const metadata: Metadata = {
  ...
  description: 'Next-generation transportation solution: Intelligent Performance for Transportation. Combines workflow management with adaptive intelligence for optimal results',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-performance-for-transportation-c4d8ba1a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation transportation solution: Intelligent Performance for Transportation. Combines workflow management with adaptive intelligence for optimal results.
          </p>
