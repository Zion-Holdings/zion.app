...
export const metadata: Metadata = {
  title: 'Analyzer Cognitive - Iot',
  description: 'The future of iot is here with Analyzer Cognitive - Iot. Powered by cutting-edge AI, this platform delivers data processing like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/analyzer-cognitive---iot-be4468b1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Analyzer Cognitive - Iot
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of iot is here with Analyzer Cognitive - Iot. Powered by cutting-edge AI, this platform delivers data processing like never before.
          </p>
