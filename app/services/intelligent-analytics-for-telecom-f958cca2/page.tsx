...
export const metadata: Metadata = {
  title: 'Intelligent Analytics for Telecom',
  description: 'Enhance your telecom business with Intelligent Analytics for Telecom. Our solution provides influencer identification with enterprise-grade reliability and secu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-analytics-for-telecom-f958cca2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Analytics for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your telecom business with Intelligent Analytics for Telecom. Our solution provides influencer identification with enterprise-grade reliability and security.
          </p>
