...
export const metadata: Metadata = {
  title: 'Game Dev AI-Powered Data Governance',
  description: 'AI-powered game dev solution for data governance. Automated data governance with compliance checking and policy enforcement.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/game-dev-ai-powered-data-governance-edcf4234',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Game Dev AI-Powered Data Governance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered game dev solution for data governance. Automated data governance with compliance checking and policy enforcement.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your game dev operations?</p>
