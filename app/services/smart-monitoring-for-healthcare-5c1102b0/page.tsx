...
export const metadata: Metadata = {
  title: 'Smart Monitoring for Healthcare',
  description: 'Optimize your healthcare workflows with Smart Monitoring for Healthcare. This intelligent platform delivers data quality through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-monitoring-for-healthcare-5c1102b0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Smart Monitoring for Healthcare. This intelligent platform delivers data quality through advanced automation and AI.
          </p>
