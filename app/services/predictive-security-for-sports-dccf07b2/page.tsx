...
export const metadata: Metadata = {
  title: 'Predictive Security for Sports',
  description: 'Next-generation sports solution: Predictive Security for Sports. Combines decision support with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-security-for-sports-dccf07b2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Security for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation sports solution: Predictive Security for Sports. Combines decision support with adaptive intelligence for optimal results.
          </p>
