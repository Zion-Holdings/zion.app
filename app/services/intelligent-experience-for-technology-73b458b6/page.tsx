...
export const metadata: Metadata = {
  title: 'Intelligent Experience for Technology',
  description: 'Revolutionize technology through intelligent automation. Our Intelligent Experience for Technology leverages advanced machine learning to deliver network optimi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Experience for Technology
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our Intelligent Experience for Technology leverages advanced machine learning to deliver network optimization at scale.
          </p>
