...
export const metadata: Metadata = {
  ...
  keywords: 'Vulnerability detection (reentrancy, overflow, access control), Gas optimization suggestions, Compliance checking (ERC standards), Integration with Hardhat, Foundry, CI/CD pipeline integration, Detailed audit reports, Remediation suggestions, Multi-chain support (Ethereum, Solana, Aptos), automation, Web3, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Smart Contract Security Auditor</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered smart contract security analysis. Detect vulnerabilities, gas optimizations, and compliance issues across Solidity, Rust, and Move.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">automation</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">Web3</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Vulnerability detection (reentrancy, overflow, access control)</li>
        <li class="text-slate-300">Gas optimization suggestions</li>
        <li class="text-slate-300">Compliance checking (ERC standards)</li>
        <li class="text-slate-300">Integration with Hardhat, Foundry</li>
        <li class="text-slate-300">CI/CD pipeline integration</li>
        <li class="text-slate-300">Detailed audit reports</li>
        <li class="text-slate-300">Remediation suggestions</li>
        <li class="text-slate-300">Multi-chain support (Ethereum, Solana, Aptos)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Prevent costly exploits</li>
        <li class="text-slate-300">Optimize gas costs</li>
        <li class="text-slate-300">Ensure compliance</li>
        <li class="text-slate-300">Automate security reviews</li>
      </ul>
        </div>
