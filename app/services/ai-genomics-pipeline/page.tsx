      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Process genomic data at scale: variant calling, pharmacogenomics, disease risk scoring, and treatment recommendations. HIPAA-compliant, FDA guidance-aligned pipeline.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Whole genome sequencing analysis</li>
            <li className="text-purple-300">✓ Pharmacogenomics scoring</li>
            <li className="text-purple-300">✓ Polygenic disease risk scoring</li>
            <li className="text-purple-300">✓ Treatment response prediction</li>
            <li className="text-purple-300">✓ HIPAA-compliant cloud pipeline</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Process genomes in hours</li>
            <li className="text-purple-300">✓ Personalize treatment plans</li>
            <li className="text-purple-300">✓ Identify disease risk early</li>
            </ul>
          </div>
