...
export const metadata: Metadata = {
  title: 'Autonomous Supply Management',
  description: 'Transform your edge operations with our Autonomous Supply Management. This AI-driven solution automates healthcare data analytics with unprecedented accuracy an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your edge operations with our Autonomous Supply Management. This AI-driven solution automates healthcare data analytics with unprecedented accuracy and efficiency.
          </p>
