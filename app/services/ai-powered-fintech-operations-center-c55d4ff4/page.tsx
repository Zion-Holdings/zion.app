...
export const metadata: Metadata = {
  title: "AI-Powered Fintech Operations Center - AI-Powered Fintech Solution",
  description: "AI-powered fintech solution leveraging advanced machine learning for optimal performance and ROI.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-fintech-operations-center-c55d4ff4",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Fintech Operations Center - AI-Powered Fintech Solution
        </h1>
