...
export const metadata: Metadata = {
  title: 'Automated Document Cloud',
  description: 'Transform your media operations with our Automated Document Cloud. This AI-driven solution automates market intelligence with unprecedented accuracy and efficie',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-document-cloud-0c5345f3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Document Cloud
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your media operations with our Automated Document Cloud. This AI-driven solution automates market intelligence with unprecedented accuracy and efficiency.
          </p>
