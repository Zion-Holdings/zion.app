...
export const metadata: Metadata = {
  ...
  description: 'The future of education is here with Intelligent Intelligent for Education. Powered by cutting-edge AI, this platform delivers reputation management like never ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-intelligent-for-education-f9cfec68',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of education is here with Intelligent Intelligent for Education. Powered by cutting-edge AI, this platform delivers reputation management like never before.
          </p>
