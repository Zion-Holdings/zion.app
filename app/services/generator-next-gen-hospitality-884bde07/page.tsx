...
export const metadata: Metadata = {
  title: 'Generator Next-Gen - Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Generator Next-Gen - Hospitality leverages advanced machine learning to deliver compliance reporti',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/generator-next-gen-hospitality-884bde07',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Generator Next-Gen - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Generator Next-Gen - Hospitality leverages advanced machine learning to deliver compliance reporting at scale.
          </p>
