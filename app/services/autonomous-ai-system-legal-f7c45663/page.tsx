...
export const metadata: Metadata = {
  title: 'Autonomous AI System - Legal',
  description: 'Revolutionize legal through intelligent automation. Our Autonomous AI System - Legal leverages advanced machine learning to deliver project portfolio at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-ai-system-legal-f7c45663',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous AI System - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Autonomous AI System - Legal leverages advanced machine learning to deliver project portfolio at scale.
          </p>
