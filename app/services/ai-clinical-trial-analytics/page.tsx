...
export const metadata: Metadata = {
  ...
  keywords: 'AI trial design optimization, Patient recruitment and matching, Adverse event prediction, Biomarker discovery and analysis, Real-time trial analytics dashboard, Integration with EDC and CTMS systems, Regulatory compliance (FDA, EMA), Predictive modeling for trial outcomes, ai, healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Clinical Trial Design &amp; Analytics Platform</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered clinical trial design, patient matching, and analytics. Accelerate drug discovery and improve trial success rates with predictive modeling.</p>
        ...
        <li class="text-slate-300">AI trial design optimization</li>
        <li class="text-slate-300">Patient recruitment and matching</li>
        <li class="text-slate-300">Adverse event prediction</li>
        <li class="text-slate-300">Biomarker discovery and analysis</li>
        <li class="text-slate-300">Real-time trial analytics dashboard</li>
        <li class="text-slate-300">Integration with EDC and CTMS systems</li>
        <li class="text-slate-300">Regulatory compliance (FDA, EMA)</li>
        <li class="text-slate-300">Predictive modeling for trial outcomes</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Accelerate trial timelines by 30%</li>
        <li class="text-slate-300">Improve patient recruitment by 50%</li>
        <li class="text-slate-300">Predict adverse events before they occur</li>
        <li class="text-slate-300">Increase trial success rates with AI insights</li>
      </ul>
        </div>
