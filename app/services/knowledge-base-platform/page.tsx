...
export const metadata = {
  ...
  description: "Create and manage a self-service knowledge base with AI-powered search, content suggestions, and analytics. Reduce support tickets by 60% with instant answers. ",
  alternates: {
