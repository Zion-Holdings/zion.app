      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Predictive Autonomous Engine - Legal. Powered by cutting-edge AI, this platform delivers invoice automation like never before.
          </p>
