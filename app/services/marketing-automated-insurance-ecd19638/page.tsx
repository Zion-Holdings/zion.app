...
export const metadata: Metadata = {
  title: 'Marketing Automated - Insurance',
  description: 'Optimize your insurance workflows with Marketing Automated - Insurance. This intelligent platform delivers data governance through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/marketing-automated-insurance-ecd19638',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Marketing Automated - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Marketing Automated - Insurance. This intelligent platform delivers data governance through advanced automation and AI.
          </p>
