...
export const metadata: Metadata = {
  title: 'Smart finance-telecom',
  description: 'Revolutionize telecom through intelligent automation. Our Smart finance-telecom leverages advanced machine learning to deliver financial planning at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-finance-telecom-0129da03',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart finance-telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Smart finance-telecom leverages advanced machine learning to deliver financial planning at scale.
          </p>
