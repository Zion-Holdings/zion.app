...
export const metadata: Metadata = {
  title: 'Predictive Support Engine - Hospitality',
  description: 'Drive innovation in hospitality with Predictive Support Engine - Hospitality. This AI-powered platform transforms performance tuning into a competitive advantag',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Support Engine - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Predictive Support Engine - Hospitality. This AI-powered platform transforms performance tuning into a competitive advantage.
          </p>
