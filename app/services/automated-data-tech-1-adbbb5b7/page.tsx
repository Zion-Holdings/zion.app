      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated data-tech #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your technology business with Automated data-tech #1. Our solution provides executive dashboards with enterprise-grade reliability and security.
          </p>
