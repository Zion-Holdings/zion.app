...
export const metadata: Metadata = {
  title: 'Autonomous Risk Processor',
  description: 'Optimize your agriculture workflows with Autonomous Risk Processor. This intelligent platform delivers revenue intelligence through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-risk-processor-31bd5354',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Risk Processor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your agriculture workflows with Autonomous Risk Processor. This intelligent platform delivers revenue intelligence through advanced automation and AI.
          </p>
