...
export const metadata: Metadata = {
  ...
  keywords: 'Static analysis + LLM-based reasoning, Security vulnerability scoring (CWE, OWASP), Auto-suggested patches via diffs, Custom rule engine per team standards, CI/CD integration (GitHub Actions, GitLab CI), ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Autonomous Code Review Agent</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered code review bot that analyzes pull requests for security flaws, performance antipatterns, style violations, and architectural drift across JavaScript/TypeScript, Python, and Go.</p>
        ...
        <li class="text-slate-300">Static analysis + LLM-based reasoning</li>
        <li class="text-slate-300">Security vulnerability scoring (CWE, OWASP)</li>
        <li class="text-slate-300">Auto-suggested patches via diffs</li>
        <li class="text-slate-300">Custom rule engine per team standards</li>
        <li class="text-slate-300">CI/CD integration (GitHub Actions, GitLab CI)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with autonomous code review agent</li>
