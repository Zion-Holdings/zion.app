...
export const metadata: Metadata = {
  title: 'Predictive Intelligence Engine - Insurance',
  description: 'Next-generation insurance solution: Predictive Intelligence Engine - Insurance. Combines threat detection with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-intelligence-engine-insurance-951705ef',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Intelligence Engine - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Predictive Intelligence Engine - Insurance. Combines threat detection with adaptive intelligence for optimal results.
          </p>
