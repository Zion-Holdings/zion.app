...
export const metadata: Metadata = {
  ...
  keywords: 'HNSW + IVF index types, Hybrid scalar + vector filter, Multi-modal embeddings, Autoscaling replicas, REST + gRPC + SDK, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Vector Database</h1>
        <p className="text-lg text-slate-300 mb-8">Managed vector database for RAG pipelines, semantic search, and similarity queries with hybrid filtering, autoscaling, and multi-modal indexing.</p>
        ...
        <li class="text-slate-300">HNSW + IVF index types</li>
        <li class="text-slate-300">Hybrid scalar + vector filter</li>
        <li class="text-slate-300">Multi-modal embeddings</li>
        <li class="text-slate-300">Autoscaling replicas</li>
        <li class="text-slate-300">REST + gRPC + SDK</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with vector database</li>
