      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Data Suite - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in gaming with AI/IT Data Suite - Gaming. This AI-powered platform transforms career development into a competitive advantage.
          </p>
