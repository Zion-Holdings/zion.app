...
export const metadata: Metadata = {
  ...
  keywords: 'Kafka event stream feature engineering, IsolationForest + XGBoost stacked fraud score, Online feature store for low-latency inference, Feedback loop model retrain pipeline, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Streaming Fraud Detection (Real-Time)</h1>
        <p className="text-lg text-slate-300 mb-8">Real-time fraud scoring on Kafka event stream: feature engineering IsolationForest + XGBoost alert/block with feedback loop for model retrain.</p>
        ...
        <li class="text-slate-300">Kafka event stream feature engineering</li>
        <li class="text-slate-300">IsolationForest + XGBoost stacked fraud score</li>
        <li class="text-slate-300">Online feature store for low-latency inference</li>
        <li class="text-slate-300">Feedback loop model retrain pipeline</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with streaming fraud detection (real-time)</li>
