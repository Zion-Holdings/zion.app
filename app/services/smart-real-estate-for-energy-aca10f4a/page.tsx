...
export const metadata: Metadata = {
  title: 'Smart Real Estate for Energy',
  description: 'The future of energy is here with Smart Real Estate for Energy. Powered by cutting-edge AI, this platform delivers inventory management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-real-estate-for-energy-aca10f4a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Real Estate for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Smart Real Estate for Energy. Powered by cutting-edge AI, this platform delivers inventory management like never before.
          </p>
