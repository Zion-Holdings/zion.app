...
export const metadata: Metadata = {
  title: 'Intelligent Director for Transportation',
  description: 'Next-generation transportation solution: Intelligent Director for Transportation. Combines scalability planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-director-for-transportation-b91d8751',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Director for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation transportation solution: Intelligent Director for Transportation. Combines scalability planning with adaptive intelligence for optimal results.
          </p>
