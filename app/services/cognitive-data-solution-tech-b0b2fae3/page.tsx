...
export const metadata: Metadata = {
  ...
  description: 'Optimize your technology workflows with Cognitive Data Solution - Tech. This intelligent platform delivers social media monitoring through advanced automation a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your technology workflows with Cognitive Data Solution - Tech. This intelligent platform delivers social media monitoring through advanced automation and AI.
          </p>
