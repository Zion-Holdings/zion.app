...
export const metadata: Metadata = {
  ...
  description: 'Optimize your insurance workflows with Cognitive Platform Solution - Insurance. This intelligent platform delivers capacity management through advanced automati',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-platform-solution-insurance-2811d09f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Cognitive Platform Solution - Insurance. This intelligent platform delivers capacity management through advanced automation and AI.
          </p>
