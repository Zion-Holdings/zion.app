...
export const metadata: Metadata = {
  title: 'AI-Driven Insights for Hospitality',
  description: 'Next-generation hospitality solution: AI-Driven Insights for Hospitality. Combines net promoter score with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-driven-insights-for-hospitality-3aa31446',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Driven Insights for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: AI-Driven Insights for Hospitality. Combines net promoter score with adaptive intelligence for optimal results.
          </p>
