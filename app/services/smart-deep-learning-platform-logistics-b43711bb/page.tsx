...
export const metadata: Metadata = {
  title: 'Smart Deep Learning Platform - Logistics',
  description: 'The future of logistics is here with Smart Deep Learning Platform - Logistics. Powered by cutting-edge AI, this platform delivers network optimization like neve',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Deep Learning Platform - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Smart Deep Learning Platform - Logistics. Powered by cutting-edge AI, this platform delivers network optimization like never before.
          </p>
