...
export const metadata: Metadata = {
  title: 'Smart Marketing - Education',
  description: 'Accelerate your education initiatives with Smart Marketing - Education. Our solution combines risk assessment with enterprise-grade reliability.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-marketing-education-d357d1f8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Accelerate your education initiatives with Smart Marketing - Education. Our solution combines risk assessment with enterprise-grade reliability.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Self-healing infrastructure</li>
          ...
          <li className="text-gray-300">Zero-downtime deployments</li>
          </ul>
        </section>
