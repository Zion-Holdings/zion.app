...
export const metadata: Metadata = {
  ...
  keywords: 'Identity-verified per-session auth (OIDC/SAML), Device posture check before granting access, Per-app micro-segmented VPN access, Continuous risk score per session (anomaly detector), cloud, E-Commerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Zero Trust Access Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Identity-first zero trust: device posture check, per-session access policy, micro-VPN per-app access, continuous auth risk scoring.</p>
        ...
        <li class="text-slate-300">Identity-verified per-session auth (OIDC/SAML)</li>
        <li class="text-slate-300">Device posture check before granting access</li>
        <li class="text-slate-300">Per-app micro-segmented VPN access</li>
        <li class="text-slate-300">Continuous risk score per session (anomaly detector)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with zero trust access platform</li>
