...
export const metadata: Metadata = {
  title: 'Engine Intelligent - Logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Engine Intelligent - Logistics leverages advanced machine learning to deliver market analysis at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Engine Intelligent - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Engine Intelligent - Logistics leverages advanced machine learning to deliver market analysis at scale.
          </p>
