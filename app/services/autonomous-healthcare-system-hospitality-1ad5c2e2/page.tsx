export const metadata = {
  title: "Autonomous Healthcare System - Hospitality",
  description: "Zion Tech Group delivers Autonomous Healthcare System - Hospitality with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/services/autonomous-healthcare-system-hospitality-1ad5c2e2/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>Autonomous Healthcare System - Hospitality</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers Autonomous Healthcare System - Hospitality with measurable outcomes.
      </p>
