...
export const metadata: Metadata = {
  title: 'Compliance Automated - Logistics',
  description: 'Drive innovation in logistics with Compliance Automated - Logistics. This AI-powered platform transforms survey automation into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/compliance-automated-logistics-6054d1ef',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Compliance Automated - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with Compliance Automated - Logistics. This AI-powered platform transforms survey automation into a competitive advantage.
          </p>
