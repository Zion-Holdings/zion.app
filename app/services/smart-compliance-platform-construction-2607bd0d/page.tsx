...
export const metadata: Metadata = {
  title: 'Smart Compliance Platform - Construction',
  description: 'Unlock unprecedented growth with Smart Compliance Platform - Construction. This autonomous system provides supply chain with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-compliance-platform-construction-2607bd0d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Compliance Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Compliance Platform - Construction. This autonomous system provides supply chain with zero manual intervention needed.
          </p>
