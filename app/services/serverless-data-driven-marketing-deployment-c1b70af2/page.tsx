...
export const metadata = {
  title: "Serverless Data-Driven Marketing Deployment - Zion Tech Group",
  description: "Serverless deployment platform that auto-scales data-driven marketing workloads without infrastructure management.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/serverless-data-driven-marketing-deployment-c1b70af2`
  }
};
