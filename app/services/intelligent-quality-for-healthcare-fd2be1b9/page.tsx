...
export const metadata: Metadata = {
  title: 'Intelligent Quality for Healthcare',
  description: 'The future of healthcare is here with Intelligent Quality for Healthcare. Powered by cutting-edge AI, this platform delivers resource utilization like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-quality-for-healthcare-fd2be1b9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Quality for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Intelligent Quality for Healthcare. Powered by cutting-edge AI, this platform delivers resource utilization like never before.
          </p>
