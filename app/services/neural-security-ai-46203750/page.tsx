...
export const metadata: Metadata = {
  ...
  description: 'Transform your martech operations with our Neural Security AI. This AI-driven solution automates recruitment automation with unprecedented accuracy and efficien',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your martech operations with our Neural Security AI. This AI-driven solution automates recruitment automation with unprecedented accuracy and efficiency.
          </p>
