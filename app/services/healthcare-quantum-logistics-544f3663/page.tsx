...
export const metadata: Metadata = {
  title: 'Healthcare Quantum - Logistics',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Healthcare Quantum - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for logistics: Healthcare Quantum - Logistics. Uses quantum-inspired algorithms to deliver quota optimization at exponential speed.
          </p>
