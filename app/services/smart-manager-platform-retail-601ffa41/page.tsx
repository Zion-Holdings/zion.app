...
export const metadata: Metadata = {
  title: 'Smart Manager Platform - Retail',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manager Platform - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation retail solution: Smart Manager Platform - Retail. Combines churn prediction with adaptive intelligence for optimal results.
          </p>
