...
export const metadata = {
  ...
  description: "Professional scheduling solution for service businesses. Online booking, calendar sync (Google, Outlook), automated reminders, payment collection, and waitlist ",
  alternates: {
