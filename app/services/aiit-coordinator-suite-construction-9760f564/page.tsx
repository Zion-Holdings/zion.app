...
export const metadata: Metadata = {
  title: 'AI/IT Coordinator Suite - Construction',
  description: 'Next-generation construction solution: AI/IT Coordinator Suite - Construction. Combines data quality with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-coordinator-suite-construction-9760f564',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Coordinator Suite - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: AI/IT Coordinator Suite - Construction. Combines data quality with adaptive intelligence for optimal results.
          </p>
