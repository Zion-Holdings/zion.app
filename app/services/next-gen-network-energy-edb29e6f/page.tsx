...
export const metadata: Metadata = {
  title: 'Next-Gen Network - Energy',
  description: 'Revolutionize energy through intelligent automation. Our Next-Gen Network - Energy leverages advanced machine learning to deliver api management at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-network-energy-edb29e6f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Network - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Next-Gen Network - Energy leverages advanced machine learning to deliver api management at scale.
          </p>
