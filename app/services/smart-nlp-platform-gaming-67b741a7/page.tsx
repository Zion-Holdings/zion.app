...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize gaming through intelligent automation. Our Smart NLP Platform - Gaming leverages advanced machine learning to deliver procurement automation at sc',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize gaming through intelligent automation. Our Smart NLP Platform - Gaming leverages advanced machine learning to deliver procurement automation at scale.
          </p>
