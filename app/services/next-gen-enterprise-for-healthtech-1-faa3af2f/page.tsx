...
export const metadata: Metadata = {
  title: 'Next-Gen Enterprise for HEALTHTECH #1',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Enterprise for HEALTHTECH #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated healthtech solution: Next-Gen Enterprise for HEALTHTECH #1. Combines market intelligence with next-gen AI for maximum velocity.
          </p>
