...
export const metadata: Metadata = {
  ...
  description: 'Automated ITSM platform that streamlines incident, problem, and change management with AI-powered routing and resolution suggestions.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/it-service-management-automation-d271b31d',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automated ITSM platform that streamlines incident, problem, and change management with AI-powered routing and resolution suggestions.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Automated ticket routing</li>
          <li className="text-gray-300">Resolution suggestions</li>
          <li className="text-gray-300">Change impact analysis</li>
          <li className="text-gray-300">SLA monitoring</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">60% faster resolution</li>
          <li className="text-purple-300">90% SLA compliance</li>
          <li className="text-purple-300">Reduced MTTR</li>
          </ul>
        </section>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your it operations operations?</p>
