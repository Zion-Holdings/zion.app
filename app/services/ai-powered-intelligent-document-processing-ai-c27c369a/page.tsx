...
export const metadata: Metadata = {
  title: "AI-Powered Intelligent Document Processing AI - AI-Powered Proptech Solution",
  description: "ai-powered solution for proptech industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-intelligent-document-processing-ai-c27c369a",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Intelligent Document Processing AI - AI-Powered Proptech Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          ai-powered solution for proptech industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.
        </p>
