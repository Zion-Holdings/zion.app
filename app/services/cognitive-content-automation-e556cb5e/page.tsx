...
export const metadata: Metadata = {
  title: 'Cognitive Content Automation',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Cognitive Content Automation. Our solution provides quality assurance with enterprise-grade reliability and security.
          </p>
