...
export const metadata: Metadata = {
  title: 'Enterprise SMB Platform - Agriculture',
  description: 'The future of agriculture is here with Enterprise SMB Platform - Agriculture. Powered by cutting-edge AI, this platform delivers feature engineering like never ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise SMB Platform - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Enterprise SMB Platform - Agriculture. Powered by cutting-edge AI, this platform delivers feature engineering like never before.
          </p>
