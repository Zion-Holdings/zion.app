...
export const metadata: Metadata = {
  ...
  keywords: 'AI-powered incident triage, Auto-remediation runbooks, Multi-channel alerting (PagerDuty, Slack, Teams), Incident timeline reconstruction, Post-incident review automation, SLA tracking and reporting, War room collaboration, Integration with 100+ monitoring tools, it, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Incident Management Platform</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end incident management with AI-powered triage, auto-remediation, and post-incident analysis. Integrates with monitoring tools, creates runbooks, and tracks SLA compliance.</p>
        ...
        <li class="text-slate-300">AI-powered incident triage</li>
        <li class="text-slate-300">Auto-remediation runbooks</li>
        <li class="text-slate-300">Multi-channel alerting (PagerDuty, Slack, Teams)</li>
        <li class="text-slate-300">Incident timeline reconstruction</li>
        <li class="text-slate-300">Post-incident review automation</li>
        <li class="text-slate-300">SLA tracking and reporting</li>
        <li class="text-slate-300">War room collaboration</li>
        <li class="text-slate-300">Integration with 100+ monitoring tools</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce MTTR by 70%</li>
        <li class="text-slate-300">Automate repetitive incident response</li>
        <li class="text-slate-300">Improve SLA compliance</li>
        <li class="text-slate-300">Learn from every incident</li>
      </ul>
        </div>
