...
export const metadata: Metadata = {
  title: 'Autonomous Security for Construction #2',
  description: 'Next-generation construction solution: Autonomous Security for Construction #2. Combines content generation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-security-for-construction-2-889b6b0b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Security for Construction #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Autonomous Security for Construction #2. Combines content generation with adaptive intelligence for optimal results.
          </p>
