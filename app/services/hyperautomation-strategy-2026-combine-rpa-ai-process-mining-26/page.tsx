...
export const metadata = {
  ...
  description: 'End-to-end hyperautomation strategy 2026: combine rpa, ai, and process mining services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/hyperautomation-strategy-2026-combine-rpa-ai-process-mining-26/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">Hyperautomation Strategy 2026: Combine RPA, AI, and Process Mining</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end hyperautomation strategy 2026: combine rpa, ai, and process mining services: assessment, deployment, and managed operations.
        </p>
