...
export const metadata: Metadata = {
  title: 'Vehicle Telematics AI-Powered Data Visualization',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Vehicle Telematics AI-Powered Data Visualization
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered vehicle telematics solution for bi. Intelligent chart and graph recommendations based on data patterns.
          </p>
