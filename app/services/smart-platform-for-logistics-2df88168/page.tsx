...
export const metadata: Metadata = {
  ...
  keywords: 'Audit trails, HIPAA ready, Multi-language support, Cloud-native architecture, SOC 2 certified, Alerting system, generator, logistics, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Smart Platform for Logistics</h1>
        <p className="text-lg text-slate-300 mb-8">The future of logistics is here with Smart Platform for Logistics. Powered by cutting-edge AI, this platform delivers compliance monitoring like never before.</p>
