...
export const metadata: Metadata = {
  title: 'Cloud Smart - Logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Cloud Smart - Logistics leverages advanced machine learning to deliver healthcare data analytics at ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cloud-smart---logistics-bc7379e1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cloud Smart - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Cloud Smart - Logistics leverages advanced machine learning to deliver healthcare data analytics at scale.
          </p>
