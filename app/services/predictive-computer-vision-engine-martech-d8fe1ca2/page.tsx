...
export const metadata: Metadata = {
  title: 'Predictive Computer Vision Engine - MARTECH',
  description: 'Transform your martech operations with our Predictive Computer Vision Engine - MARTECH. This AI-driven solution automates onboarding automation with unprecedent',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Computer Vision Engine - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your martech operations with our Predictive Computer Vision Engine - MARTECH. This AI-driven solution automates onboarding automation with unprecedented accuracy and efficiency.
          </p>
