...
export const metadata: Metadata = {
  title: 'Neural analytics-education',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural analytics-education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your education business with Neural analytics-education. Our solution provides risk management with enterprise-grade reliability and security.
          </p>
