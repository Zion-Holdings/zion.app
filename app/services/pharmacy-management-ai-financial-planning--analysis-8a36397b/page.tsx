...
export const metadata: Metadata = {
  title: 'Pharmacy Management AI Financial Planning & Analysis',
  description: 'pharmacy management solution for parks & recreation industry. Generates financial forecasts, budget plans, and performance analyses using machine learning model',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/pharmacy-management-ai-financial-planning--analysis-8a36397b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Pharmacy Management AI Financial Planning & Analysis
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            pharmacy management solution for parks & recreation industry. Generates financial forecasts, budget plans, and performance analyses using machine learning models.
          </p>
