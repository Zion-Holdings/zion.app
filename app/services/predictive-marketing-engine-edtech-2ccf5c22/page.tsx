...
export const metadata: Metadata = {
  title: 'Predictive Marketing Engine - EDTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Marketing Engine - EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for edtech: Predictive Marketing Engine - EDTECH. Uses quantum-inspired algorithms to deliver hr analytics at exponential speed.
          </p>
