...
export const metadata: Metadata = {
  title: 'Smart Cloud for Education',
  description: 'Next-generation education solution: Smart Cloud for Education. Combines quality control with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-cloud-for-education-133d3806',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Cloud for Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation education solution: Smart Cloud for Education. Combines quality control with adaptive intelligence for optimal results.
          </p>
