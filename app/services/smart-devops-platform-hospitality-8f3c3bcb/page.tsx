...
export const metadata: Metadata = {
  title: 'Smart DevOps Platform - Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Smart DevOps Platform - Hospitality leverages advanced machine learning to deliver vendor manageme',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-devops-platform-hospitality-8f3c3bcb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart DevOps Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Smart DevOps Platform - Hospitality leverages advanced machine learning to deliver vendor management at scale.
          </p>
