...
export const metadata: Metadata = {
  title: 'Self-Optimizing Financial DevOps',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Financial DevOps
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your iot operations with our Self-Optimizing Financial DevOps. This AI-driven solution automates manufacturing quality control with unprecedented accuracy and efficiency.
          </p>
