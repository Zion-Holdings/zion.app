...
export const metadata: Metadata = {
  title: 'AI Engine - Iot Edition #2',
  description: 'Revolutionize iot through intelligent automation. Our AI Engine - Iot Edition #2 leverages advanced machine learning to deliver decision support at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-engine---iot-edition-2-8d5d66dc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Engine - Iot Edition #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize iot through intelligent automation. Our AI Engine - Iot Edition #2 leverages advanced machine learning to deliver decision support at scale.
          </p>
