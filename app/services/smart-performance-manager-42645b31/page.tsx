...
export const metadata: Metadata = {
  title: 'Smart Performance Manager',
  description: 'Next-generation logistics solution: Smart Performance Manager. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-performance-manager-42645b31',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Smart Performance Manager. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
