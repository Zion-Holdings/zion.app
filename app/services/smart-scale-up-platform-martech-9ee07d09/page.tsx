...
export const metadata: Metadata = {
  title: 'Smart Scale-up Platform - MARTECH',
  description: 'Optimize your martech workflows with Smart Scale-up Platform - MARTECH. This intelligent platform delivers recommendation system through advanced automation and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-scale-up-platform-martech-9ee07d09',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Scale-up Platform - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your martech workflows with Smart Scale-up Platform - MARTECH. This intelligent platform delivers recommendation system through advanced automation and AI.
          </p>
