...
export const metadata: Metadata = {
  title: 'Smart ai-telecom',
  description: 'Revolutionize telecom through intelligent automation. Our Smart ai-telecom leverages advanced machine learning to deliver edge computing at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-ai-telecom-aa2f5e36',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Smart ai-telecom leverages advanced machine learning to deliver edge computing at scale.
          </p>
