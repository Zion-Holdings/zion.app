...
export const metadata: Metadata = {
  title: 'Smart Sales for Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Smart Sales for Healthcare leverages advanced machine learning to deliver quality control at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-sales-for-healthcare-055934bc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Sales for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Smart Sales for Healthcare leverages advanced machine learning to deliver quality control at scale.
          </p>
