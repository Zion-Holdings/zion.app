...
export const metadata: Metadata = {
  title: 'Appointment Scheduling Intelligent Document Processing AI',
  description: 'appointment scheduling solution for hedge funds industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents auto',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/appointment-scheduling-intelligent-document-processing-ai-f94d1f6c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Appointment Scheduling Intelligent Document Processing AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            appointment scheduling solution for hedge funds industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.
          </p>
