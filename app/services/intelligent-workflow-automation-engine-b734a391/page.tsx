...
export const metadata: Metadata = {
  ...
  description: 'AI-powered workflow automation that learns from user behavior to optimize processes.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-workflow-automation-engine-b734a391',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            AI-powered workflow automation that learns from user behavior to optimize processes.
          </p>
