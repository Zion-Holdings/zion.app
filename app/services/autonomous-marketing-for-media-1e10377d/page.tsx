...
export const metadata: Metadata = {
  title: 'Autonomous Marketing for Media',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Marketing for Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your media operations with our Autonomous Marketing for Media. This AI-driven solution automates energy management with unprecedented accuracy and efficiency.
          </p>
