...
export const metadata: Metadata = {
  title: 'Cognitive Data Solution - Logistics',
  description: 'Optimize your logistics workflows with Cognitive Data Solution - Logistics. This intelligent platform delivers sentiment analysis through advanced automation an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-data-solution-logistics-2d675f7d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Data Solution - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your logistics workflows with Cognitive Data Solution - Logistics. This intelligent platform delivers sentiment analysis through advanced automation and AI.
          </p>
