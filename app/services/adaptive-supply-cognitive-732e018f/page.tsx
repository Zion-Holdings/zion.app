...
export const metadata: Metadata = {
  title: 'Adaptive Supply Cognitive',
  description: 'Next-generation insurance solution: Adaptive Supply Cognitive. Combines data governance with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-supply-cognitive-732e018f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Supply Cognitive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Adaptive Supply Cognitive. Combines data governance with adaptive intelligence for optimal results.
          </p>
