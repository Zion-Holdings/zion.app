...
export const metadata: Metadata = {
  title: 'Cognitive Revenue Solution - Insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Revenue Solution - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Cognitive Revenue Solution - Insurance. This AI-powered platform transforms expense management into a competitive advantage.
          </p>
