...
export const metadata: Metadata = {
  title: 'AI Marketing - Proptech Edition #3',
  description: 'The future of proptech is here with AI Marketing - Proptech Edition #3. Powered by cutting-edge AI, this platform delivers energy management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-marketing---proptech-edition-3-0f4ca55d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Marketing - Proptech Edition #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with AI Marketing - Proptech Edition #3. Powered by cutting-edge AI, this platform delivers energy management like never before.
          </p>
