...
export const metadata: Metadata = {
  ...
  keywords: 'OCR with 99%+ accuracy, AI field extraction, Document classification, Validation rules engine, ERP/Accounting integration, Human-in-the-loop review, Batch processing, Custom document templates, automation, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Intelligent Document Processing (IDP)</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered document processing for invoices, contracts, forms, and receipts. OCR, NLP extraction, validation, and integration with ERP and accounting systems.</p>
        ...
        <li class="text-slate-300">OCR with 99%+ accuracy</li>
        <li class="text-slate-300">AI field extraction</li>
        <li class="text-slate-300">Document classification</li>
        <li class="text-slate-300">Validation rules engine</li>
        <li class="text-slate-300">ERP/Accounting integration</li>
        <li class="text-slate-300">Human-in-the-loop review</li>
        <li class="text-slate-300">Batch processing</li>
        <li class="text-slate-300">Custom document templates</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce document processing time by 85%</li>
        <li class="text-slate-300">Eliminate manual data entry</li>
        <li class="text-slate-300">Improve accuracy and compliance</li>
        <li class="text-slate-300">Scale without hiring</li>
      </ul>
        </div>
