...
export const metadata: Metadata = {
  ...
  keywords: 'Deterministic + fuzzy + phonetic matching, Embedding model for compound record matching, Bulk-match upload + reason-code dispute UI, Reconciliation history + export report, data, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Data Reconciliation Engine</h1>
        <p className="text-lg text-slate-300 mb-8">Automated record matching across source-of-truth systems with fuzzy/phonetic/ML matching and a reconciliation dispute UI.</p>
        ...
        <li class="text-slate-300">Deterministic + fuzzy + phonetic matching</li>
        <li class="text-slate-300">Embedding model for compound record matching</li>
        <li class="text-slate-300">Bulk-match upload + reason-code dispute UI</li>
        <li class="text-slate-300">Reconciliation history + export report</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with data reconciliation engine</li>
