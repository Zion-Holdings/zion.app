...
export const metadata: Metadata = {
  title: 'Cognitive cloud-retail',
  description: 'Unlock unprecedented growth with Cognitive cloud-retail. This autonomous system provides business continuity with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-cloud-retail-216c3005',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive cloud-retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Cognitive cloud-retail. This autonomous system provides business continuity with zero manual intervention needed.
          </p>
