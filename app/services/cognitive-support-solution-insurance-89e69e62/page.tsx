...
export const metadata: Metadata = {
  ...
  description: 'Optimize your insurance workflows with Cognitive Support Solution - Insurance. This intelligent platform delivers pipeline management through advanced automatio',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-support-solution-insurance-89e69e62',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Cognitive Support Solution - Insurance. This intelligent platform delivers pipeline management through advanced automation and AI.
          </p>
