...
export const metadata: Metadata = {
  title: 'Next-Gen Compliance for Construction #2',
  description: 'Enhance your construction business with Next-Gen Compliance for Construction #2. Our solution provides record processing with enterprise-grade reliability and s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Compliance for Construction #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Next-Gen Compliance for Construction #2. Our solution provides record processing with enterprise-grade reliability and security.
          </p>
