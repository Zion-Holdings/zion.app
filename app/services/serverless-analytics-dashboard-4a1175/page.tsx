...
export const metadata: Metadata = {
  title: 'Serverless Analytics Dashboard Node.js (Hr)',
  description: 'Serverless Analytics Dashboard Node.js (Hr) is an AI-powered hr solution that transforms how businesses operate through intelligent automation and real-time ana',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/serverless-analytics-dashboard-4a1175',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Serverless Analytics Dashboard Node.js (Hr)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Serverless Analytics Dashboard Node.js (Hr) is an AI-powered hr solution that transforms how businesses operate through intelligent automation and real-time analytics.
