...
export const metadata: Metadata = {
  title: 'Autonomous Performance for Insurance',
  description: 'The future of insurance is here with Autonomous Performance for Insurance. Powered by cutting-edge AI, this platform delivers image recognition like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-performance-for-insurance-8cec8bb1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Performance for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Autonomous Performance for Insurance. Powered by cutting-edge AI, this platform delivers image recognition like never before.
          </p>
