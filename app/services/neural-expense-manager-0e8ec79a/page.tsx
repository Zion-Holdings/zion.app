...
export const metadata: Metadata = {
  title: 'Neural Expense Manager',
  description: 'The future of agriculture is here with Neural Expense Manager. Powered by cutting-edge AI, this platform delivers process discovery like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-expense-manager-0e8ec79a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Expense Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Neural Expense Manager. Powered by cutting-edge AI, this platform delivers process discovery like never before.
          </p>
