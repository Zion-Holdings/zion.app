...
export const metadata: Metadata = {
  ...
  keywords: 'Auto-generate REST and GraphQL APIs, Authentication and rate limiting, API documentation and playground, Usage analytics and monitoring, Caching and performance optimization, Integration with PostgREST, Hasura, Prisma, data, API Management, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Data API Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Turn any data source into a REST or GraphQL API: auto-generated, documented, secured, monitored. Data as a product.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">data</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">API Management</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Auto-generate REST and GraphQL APIs</li>
        <li class="text-slate-300">Authentication and rate limiting</li>
        <li class="text-slate-300">API documentation and playground</li>
        <li class="text-slate-300">Usage analytics and monitoring</li>
        <li class="text-slate-300">Caching and performance optimization</li>
        <li class="text-slate-300">Integration with PostgREST</li>
        <li class="text-slate-300">Hasura</li>
        <li class="text-slate-300">Prisma</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Turn data into APIs in minutes</li>
        <li class="text-slate-300">Authentication and rate limiting built in</li>
        <li class="text-slate-300">Documentation auto-generated</li>
        <li class="text-slate-300">Usage analytics for API products</li>
      </ul>
        </div>
