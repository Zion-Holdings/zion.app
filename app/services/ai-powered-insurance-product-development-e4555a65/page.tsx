...
export const metadata: Metadata = {
  title: 'AI-Powered Insurance Product Development',
  description: 'AI-powered insurance product development with risk modeling.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-insurance-product-development-e4555a65',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Insurance Product Development
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered insurance product development with risk modeling.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Product development</li>
          <li className="text-gray-300">Risk modeling</li>
          <li className="text-gray-300">Pricing optimization</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">40% faster product launch</li>
