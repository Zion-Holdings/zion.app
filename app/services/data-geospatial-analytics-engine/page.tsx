...
export const metadata: Metadata = {
  ...
  keywords: 'PostGIS spatial index + SRID auto-detect, Tile-based cluster heatmap (deck.gl/Mapbox), OSRM/Valhalla route optimisation per order, Geofence trigger alert per asset/customer, data, E-Commerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Geospatial Analytics Engine</h1>
        <p className="text-lg text-slate-300 mb-8">Location intelligence: PostGIS spatial queries, tile-based heatmaps, delivery-route optimisation, and geofence-triggered alerts.</p>
        ...
        <li class="text-slate-300">PostGIS spatial index + SRID auto-detect</li>
        <li class="text-slate-300">Tile-based cluster heatmap (deck.gl/Mapbox)</li>
        <li class="text-slate-300">OSRM/Valhalla route optimisation per order</li>
        <li class="text-slate-300">Geofence trigger alert per asset/customer</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with geospatial analytics engine</li>
