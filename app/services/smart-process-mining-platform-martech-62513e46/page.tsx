...
export const metadata: Metadata = {
  title: 'Smart Process Mining Platform - MARTECH',
  description: 'Enhance your martech business with Smart Process Mining Platform - MARTECH. Our solution provides resource utilization with enterprise-grade reliability and sec',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Process Mining Platform - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your martech business with Smart Process Mining Platform - MARTECH. Our solution provides resource utilization with enterprise-grade reliability and security.
          </p>
