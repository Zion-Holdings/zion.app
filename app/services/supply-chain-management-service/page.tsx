...
export const metadata: Metadata = {
  ...
  keywords: 'AI-driven demand forecasting, Multi-modal route optimization, Supplier risk intelligence & monitoring, Automated disruption response playbooks, Warehouse operations AI optimization, automation, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Supply Chain Management Platform</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end supply chain orchestration with AI demand forecasting, multi-modal route optimization, supplier risk scoring, and real-time disruption response.</p>
        ...
        <li class="text-slate-300">AI-driven demand forecasting</li>
        <li class="text-slate-300">Multi-modal route optimization</li>
        <li class="text-slate-300">Supplier risk intelligence &amp; monitoring</li>
        <li class="text-slate-300">Automated disruption response playbooks</li>
        <li class="text-slate-300">Warehouse operations AI optimization</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with supply chain management platform</li>
