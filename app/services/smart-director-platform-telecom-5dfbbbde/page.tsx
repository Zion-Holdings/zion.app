...
export const metadata: Metadata = {
  title: 'Smart Director Platform - Telecom',
  description: 'Optimize your telecom workflows with Smart Director Platform - Telecom. This intelligent platform delivers financial risk management through advanced automation',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-director-platform-telecom-5dfbbbde',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Director Platform - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your telecom workflows with Smart Director Platform - Telecom. This intelligent platform delivers financial risk management through advanced automation and AI.
          </p>
