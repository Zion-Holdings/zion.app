...
export const metadata: Metadata = {
  title: 'Manufacturing Intelligent - Sports #1',
  description: 'Next-generation sports solution: Manufacturing Intelligent - Sports #1. Combines energy management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/manufacturing-intelligent---sports-1-1f8fb49b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manufacturing Intelligent - Sports #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation sports solution: Manufacturing Intelligent - Sports #1. Combines energy management with adaptive intelligence for optimal results.
          </p>
