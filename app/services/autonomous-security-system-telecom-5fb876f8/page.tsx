...
export const metadata: Metadata = {
  title: 'Autonomous Security System - Telecom',
  description: 'Revolutionize telecom through intelligent automation. Our Autonomous Security System - Telecom leverages advanced machine learning to deliver network optimizati',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-security-system-telecom-5fb876f8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Security System - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Autonomous Security System - Telecom leverages advanced machine learning to deliver network optimization at scale.
          </p>
