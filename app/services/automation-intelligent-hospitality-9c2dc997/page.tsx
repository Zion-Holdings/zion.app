...
export const metadata: Metadata = {
  title: 'Automation Intelligent - Hospitality',
  description: 'Next-generation hospitality solution: Automation Intelligent - Hospitality. Combines feature engineering with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automation-intelligent-hospitality-9c2dc997',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automation Intelligent - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Automation Intelligent - Hospitality. Combines feature engineering with adaptive intelligence for optimal results.
          </p>
