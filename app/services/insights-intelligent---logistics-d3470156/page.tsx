...
export const metadata: Metadata = {
  ...
  keywords: 'Role-based access control, Multi-region deployment, Alerting system, Performance dashboards, platform, logistics, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Insights Intelligent - Logistics</h1>
        <p className="text-lg text-slate-300 mb-8">Next-generation logistics solution: Insights Intelligent - Logistics. Combines network optimization with adaptive intelligence for optimal results.</p>
