...
export const metadata: Metadata = {
  title: 'Intelligent API Sales',
  description: 'Transform your education operations with our Intelligent API Sales. This AI-driven solution automates user provisioning with unprecedented accuracy and efficien',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-api-sales-a7fc877d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent API Sales
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your education operations with our Intelligent API Sales. This AI-driven solution automates user provisioning with unprecedented accuracy and efficiency.
          </p>
