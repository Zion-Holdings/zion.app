...
export const metadata: Metadata = {
  title: 'Suite Cognitive - Iot',
  description: 'Transform your iot operations with our Suite Cognitive - Iot. This AI-driven solution automates healthcare data analytics with unprecedented accuracy and effici',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your iot operations with our Suite Cognitive - Iot. This AI-driven solution automates healthcare data analytics with unprecedented accuracy and efficiency.
          </p>
