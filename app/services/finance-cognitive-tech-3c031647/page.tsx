...
export const metadata: Metadata = {
  title: 'Finance Cognitive - Tech',
  description: 'Revolutionize technology through intelligent automation. Our Finance Cognitive - Tech leverages advanced machine learning to deliver enterprise-grade insights a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/finance-cognitive-tech-3c031647',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Finance Cognitive - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our Finance Cognitive - Tech leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
