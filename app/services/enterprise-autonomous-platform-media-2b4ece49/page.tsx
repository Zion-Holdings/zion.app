...
export const metadata: Metadata = {
  title: 'Enterprise Autonomous Platform - Media',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Autonomous Platform - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize media through intelligent automation. Our Enterprise Autonomous Platform - Media leverages advanced machine learning to deliver forecast accuracy at scale.
          </p>
