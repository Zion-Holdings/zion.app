...
export const metadata: Metadata = {
  title: 'Enterprise Knowledge Platform - Healthcare',
  description: 'Optimize your healthcare workflows with Enterprise Knowledge Platform - Healthcare. This intelligent platform delivers record processing through advanced automa',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-knowledge-platform-healthcare-99ee64af',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Knowledge Platform - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Enterprise Knowledge Platform - Healthcare. This intelligent platform delivers record processing through advanced automation and AI.
          </p>
