...
export const metadata: Metadata = {
  title: 'Autonomous Suite for Energy',
  description: 'Revolutionize energy through intelligent automation. Our Autonomous Suite for Energy leverages advanced machine learning to deliver resource optimization at sca',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-suite-for-energy-cff00295',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Suite for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Autonomous Suite for Energy leverages advanced machine learning to deliver resource optimization at scale.
          </p>
