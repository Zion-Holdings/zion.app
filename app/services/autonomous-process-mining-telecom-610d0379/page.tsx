...
export const metadata: Metadata = {
  title: 'Autonomous process mining-telecom',
  description: 'Drive innovation in telecom with Autonomous process mining-telecom. This AI-powered platform transforms business continuity into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-process-mining-telecom-610d0379',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous process mining-telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in telecom with Autonomous process mining-telecom. This AI-powered platform transforms business continuity into a competitive advantage.
          </p>
