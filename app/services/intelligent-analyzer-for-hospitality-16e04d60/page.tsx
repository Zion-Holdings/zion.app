...
export const metadata: Metadata = {
  title: 'Intelligent Analyzer for Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Intelligent Analyzer for Hospitality leverages advanced machine learning to deliver workflow manag',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-analyzer-for-hospitality-16e04d60',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Analyzer for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Intelligent Analyzer for Hospitality leverages advanced machine learning to deliver workflow management at scale.
          </p>
