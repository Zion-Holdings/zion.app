...
export const metadata: Metadata = {
  ...
  keywords: 'Statistical fidelity preservation, Referential integrity across tables, Differential privacy guarantees, Synthetic data quality validation, Support for tabular, time-series, text, API for programmatic generation, Integration with Mostly AI, Gretel, Synthesized, data, Data Engineering, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Synthetic Data Generation</h1>
        <p className="text-lg text-slate-300 mb-8">Generate privacy-safe synthetic data: statistical fidelity, referential integrity, privacy guarantees. Train models without PII.</p>
        ...
        <li class="text-slate-300">Referential integrity across tables</li>
        <li class="text-slate-300">Differential privacy guarantees</li>
        <li class="text-slate-300">Synthetic data quality validation</li>
        <li class="text-slate-300">Support for tabular</li>
        <li class="text-slate-300">time-series</li>
        <li class="text-slate-300">text</li>
        <li class="text-slate-300">API for programmatic generation</li>
        <li class="text-slate-300">Integration with Mostly AI</li>
        <li class="text-slate-300">Gretel</li>
        <li class="text-slate-300">Synthesized</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Train models without privacy risk</li>
        <li class="text-slate-300">Statistical fidelity preserves analytical value</li>
        <li class="text-slate-300">Referential integrity across tables</li>
        <li class="text-slate-300">Differential privacy provides guarantees</li>
      </ul>
        </div>
