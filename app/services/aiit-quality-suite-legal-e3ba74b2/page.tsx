...
export const metadata: Metadata = {
  title: 'AI/IT Quality Suite - Legal',
  description: 'Optimize your legal workflows with AI/IT Quality Suite - Legal. This intelligent platform delivers financial planning through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-quality-suite-legal-e3ba74b2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Quality Suite - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with AI/IT Quality Suite - Legal. This intelligent platform delivers financial planning through advanced automation and AI.
          </p>
