...
export const metadata: Metadata = {
  title: 'Intelligent director-agritech',
  description: 'The future of agritech is here with Intelligent director-agritech. Powered by cutting-edge AI, this platform delivers inventory management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-director-agritech-33440d4f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent director-agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agritech is here with Intelligent director-agritech. Powered by cutting-edge AI, this platform delivers inventory management like never before.
          </p>
