...
export const metadata: Metadata = {
  ...
  keywords: 'Plugin architecture, Container orchestration, Data encryption, Audit trails, Alerting system, analytics, construction, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Suite - Construction Edition</h1>
        <p className="text-lg text-slate-300 mb-8">Transform your construction operations with our AI Suite - Construction Edition. This AI-driven solution automates decision support with unprecedented accuracy and efficiency.</p>
