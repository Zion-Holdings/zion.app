...
export const metadata: Metadata = {
  title: 'AI/IT Workflow Suite - CLEANTECH',
  description: 'Next-generation cleantech solution: AI/IT Workflow Suite - CLEANTECH. Combines compliance automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-workflow-suite-cleantech-ef57827c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Workflow Suite - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation cleantech solution: AI/IT Workflow Suite - CLEANTECH. Combines compliance automation with adaptive intelligence for optimal results.
          </p>
