...
export const metadata: Metadata = {
  title: 'AI/IT Document Suite - Insurance',
  description: 'Hyper-accelerated insurance solution: AI/IT Document Suite - Insurance. Combines brand monitoring with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-document-suite-insurance-32cc8581',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Document Suite - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated insurance solution: AI/IT Document Suite - Insurance. Combines brand monitoring with next-gen AI for maximum velocity.
          </p>
