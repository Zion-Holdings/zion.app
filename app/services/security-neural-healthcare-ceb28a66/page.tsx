...
export const metadata: Metadata = {
  title: 'Security Neural - Healthcare',
  description: 'Enhance your healthcare business with Security Neural - Healthcare. Our solution provides process discovery with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-neural-healthcare-ceb28a66',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Neural - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with Security Neural - Healthcare. Our solution provides process discovery with enterprise-grade reliability and security.
          </p>
