...
export const metadata: Metadata = {
  title: 'Autonomous Data Science System - Agriculture',
  description: 'Drive innovation in agriculture with Autonomous Data Science System - Agriculture. This AI-powered platform transforms business continuity into a competitive ad',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-data-science-system-agriculture-901ff86f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Data Science System - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in agriculture with Autonomous Data Science System - Agriculture. This AI-powered platform transforms business continuity into a competitive advantage.
          </p>
