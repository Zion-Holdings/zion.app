...
export const metadata = {
  ...
  description: "Automated pull request reviews powered by deep code understanding. Scans for security vulnerabilities, enforces style guides, detects anti-patterns, and provide",
  alternates: {
