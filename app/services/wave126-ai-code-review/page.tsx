...
export const metadata: Metadata = {
  ...
  keywords: 'Automated PR review with contextual AI analysis, Security vulnerability scanning (OWASP Top 10, SAST), Style guide enforcement & linting integration, Anti-pattern & code smell detection, Architecture compliance checks, Custom rule engine for team-specific standards, GitHub / GitLab / Bitbucket native integration, Review summary & quality score dashboard, micro-saas, Software Development, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Powered Code Review Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Automated pull request reviews powered by deep code understanding. Scans for security vulnerabilities, enforces style guides, detects anti-patterns, and provides actionable suggestions — reducing review time by 80% and catching issues before they reach production.</p>
        ...
        <li class="text-slate-300">Automated PR review with contextual AI analysis</li>
        <li class="text-slate-300">Security vulnerability scanning (OWASP Top 10, SAST)</li>
        <li class="text-slate-300">Style guide enforcement &amp; linting integration</li>
        <li class="text-slate-300">Anti-pattern &amp; code smell detection</li>
        <li class="text-slate-300">Architecture compliance checks</li>
        <li class="text-slate-300">Custom rule engine for team-specific standards</li>
        <li class="text-slate-300">GitHub / GitLab / Bitbucket native integration</li>
        <li class="text-slate-300">Review summary &amp; quality score dashboard</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">80% faster code review cycles</li>
        <li class="text-slate-300">Ship with confidence — catch bugs before production</li>
        <li class="text-slate-300">Consistent code quality across every team</li>
        <li class="text-slate-300">Onboard new developers 3× faster with AI-guided reviews</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">797</p>
