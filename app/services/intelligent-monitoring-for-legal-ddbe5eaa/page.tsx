...
export const metadata: Metadata = {
  title: 'Intelligent Monitoring for Legal',
  description: 'The future of legal is here with Intelligent Monitoring for Legal. Powered by cutting-edge AI, this platform delivers performance reviews like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-monitoring-for-legal-ddbe5eaa',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Monitoring for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Intelligent Monitoring for Legal. Powered by cutting-edge AI, this platform delivers performance reviews like never before.
          </p>
