...
export const metadata: Metadata = {
  title: 'Next-Gen Healthcare - Gaming',
  description: 'Transform your gaming operations with our Next-Gen Healthcare - Gaming. This AI-driven solution automates ml model training with unprecedented accuracy and effi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Healthcare - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your gaming operations with our Next-Gen Healthcare - Gaming. This AI-driven solution automates ml model training with unprecedented accuracy and efficiency.
          </p>
