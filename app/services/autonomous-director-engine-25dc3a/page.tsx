...
export const metadata: Metadata = {
  title: 'Autonomous Director Engine',
  description: 'Transform your manufacturing operations with our Autonomous Director Engine. This security solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-director-engine-25dc3a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Director Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your manufacturing operations with our Autonomous Director Engine. This security solution delivers unprecedented automation and intelligence.
          </p>
