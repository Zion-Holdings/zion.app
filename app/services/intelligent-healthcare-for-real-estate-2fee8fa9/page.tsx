...
export const metadata: Metadata = {
  ...
  description: 'Next-generation real-estate solution: Intelligent Healthcare for Real-Estate. Combines supply chain with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-healthcare-for-real-estate-2fee8fa9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation real-estate solution: Intelligent Healthcare for Real-Estate. Combines supply chain with adaptive intelligence for optimal results.
          </p>
