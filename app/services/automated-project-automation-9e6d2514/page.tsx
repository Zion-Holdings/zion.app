...
export const metadata: Metadata = {
  title: 'Automated Project Automation',
  description: 'Revolutionize real-estate through intelligent automation. Our Automated Project Automation leverages advanced machine learning to deliver market analysis at sca',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-project-automation-9e6d2514',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Project Automation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our Automated Project Automation leverages advanced machine learning to deliver market analysis at scale.
          </p>
