...
export const metadata = {
  ...
  description: "Revolutionize Finance through intelligent automation. Our Neural Cloud for Finance leverages advanced machine learning to deliver manufacturing quality control ",
  alternates: {
