...
export const metadata: Metadata = {
  title: "Accounting AI-Powered Demand Forecasting - AI-Powered Accounting Solution",
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Accounting AI-Powered Demand Forecasting - AI-Powered Accounting Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          AI-powered accounting solution for retail. Uses time-series analysis to predict product demand with high accuracy.
        </p>
