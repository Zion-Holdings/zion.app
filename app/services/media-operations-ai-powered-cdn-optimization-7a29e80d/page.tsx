...
export const metadata: Metadata = {
  title: 'Media Operations AI-Powered CDN Optimization',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Media Operations AI-Powered CDN Optimization
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered media operations solution for infrastructure. Content delivery network optimization using predictive caching and routing.
          </p>
