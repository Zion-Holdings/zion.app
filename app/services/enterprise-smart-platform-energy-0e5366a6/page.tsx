...
export const metadata: Metadata = {
  title: 'Enterprise Smart Platform - Energy',
  description: 'Revolutionize energy through intelligent automation. Our Enterprise Smart Platform - Energy leverages advanced machine learning to deliver claims processing at ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-smart-platform-energy-0e5366a6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Smart Platform - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Enterprise Smart Platform - Energy leverages advanced machine learning to deliver claims processing at scale.
          </p>
