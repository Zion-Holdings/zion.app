...
export const metadata = {
  ...
  description: "01.AI (Chinese: 零一万物; pinyin: Língyī Wànwù) is an artificial intelligence (AI) company based in Beijing, China. It focuses on developing open source products. It is one of China's 6 \"AI Tigers\".",
  alternates: {
...
export default function ServicePage() {
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">01.AI (Chinese: 零一万物; pinyin: Língyī Wànwù) is an artificial intelligence (AI) company based in Beijing, China. It focuses on developing open source products. It is one of China's 6 \"AI Tigers\".</p>
  ...
  "name": "01.AI",
  "description": "01.AI (Chinese: 零一万物; pinyin: Língyī Wànwù) is an artificial intelligence (AI) company based in Beijing, China. It focuses on developing open source products. It is one of China's 6 \"AI Tigers\".",
  "url": "https://ziontechgroup.com/services/01-ai-18799938",
  "category": "cognitive",
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "01.AI (Chinese: 零一万物; pinyin: Língyī Wànwù) is an artificial intelligence (AI) company based in Beijing, China. It focuses on developing open source products. It is one of China's 6 \"AI Tigers\"."
      }
    },
    {
      "@type": "Question",
      "name": "What are the key features of 01.AI?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      "name": "What benefits does 01.AI provide?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "01.AI offers Basic, Pro, and Enterprise tiers. Contact us for a custom quote."
      }
    }
  ]
} }} />
