...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize real-estate through intelligent automation. Our Neural Analytics for Real-Estate leverages advanced machine learning to deliver image recognition ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-analytics-for-real-estate-1aa78510',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our Neural Analytics for Real-Estate leverages advanced machine learning to deliver image recognition at scale.
          </p>
