...
export const metadata: Metadata = {
  title: 'Maritime Security Platform #20',
  description: 'AI-powered maritime solution for security. Provides enterprise-grade automation and optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-maritime-7dac243c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Maritime Security Platform #20
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered maritime solution for security. Provides enterprise-grade automation and optimization.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Real-time threat detection</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">99.9% threat prevention</li>
          <li className="text-purple-300">Zero breach incidents</li>
          <li className="text-purple-300">Compliance automation</li>
          </ul>
        </section>
