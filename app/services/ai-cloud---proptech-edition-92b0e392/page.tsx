...
export const metadata: Metadata = {
  title: 'AI Cloud - Proptech Edition',
  description: 'The future of proptech is here with AI Cloud - Proptech Edition. Powered by cutting-edge AI, this platform delivers language processing like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-cloud---proptech-edition-92b0e392',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Cloud - Proptech Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with AI Cloud - Proptech Edition. Powered by cutting-edge AI, this platform delivers language processing like never before.
          </p>
