...
export const metadata: Metadata = {
  title: 'Predictive Business Intelligence Engine - Energy',
  description: 'The future of energy is here with Predictive Business Intelligence Engine - Energy. Powered by cutting-edge AI, this platform delivers compliance monitoring lik',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Business Intelligence Engine - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Predictive Business Intelligence Engine - Energy. Powered by cutting-edge AI, this platform delivers compliance monitoring like never before.
          </p>
