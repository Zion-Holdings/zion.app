...
export const metadata: Metadata = {
  title: 'Autonomous finance-logistics',
  description: 'Drive innovation in logistics with Autonomous finance-logistics. This AI-powered platform transforms customer onboarding into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-finance-logistics-e834a8bb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous finance-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with Autonomous finance-logistics. This AI-powered platform transforms customer onboarding into a competitive advantage.
          </p>
