...
export const metadata: Metadata = {
  title: 'Autonomous Smart System - Legal',
  description: 'Next-generation legal solution: Autonomous Smart System - Legal. Combines decision support with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-smart-system-legal-49c3d3b6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Smart System - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Autonomous Smart System - Legal. Combines decision support with adaptive intelligence for optimal results.
          </p>
