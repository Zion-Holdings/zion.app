...
export const metadata: Metadata = {
  ...
  keywords: 'X-ray, CT, MRI, and pathology image analysis, Automated anomaly detection and classification, Priority flagging for urgent findings, Structured report generation, Integration with PACS and EMR systems, Longitudinal comparison with prior studies, Quality assurance and peer review tools, HIPAA-compliant infrastructure, ai, healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Medical Imaging Analysis Assistant</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered medical imaging analysis that assists radiologists in detecting anomalies in X-rays, CT scans, MRIs, and pathology slides. FDA-cleared algorithms with 95%+ sensitivity.</p>
        ...
        <li class="text-slate-300">X-ray, CT, MRI, and pathology image analysis</li>
        <li class="text-slate-300">Automated anomaly detection and classification</li>
        <li class="text-slate-300">Priority flagging for urgent findings</li>
        <li class="text-slate-300">Structured report generation</li>
        <li class="text-slate-300">Integration with PACS and EMR systems</li>
        <li class="text-slate-300">Longitudinal comparison with prior studies</li>
        <li class="text-slate-300">Quality assurance and peer review tools</li>
        <li class="text-slate-300">HIPAA-compliant infrastructure</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Detect abnormalities with 95%+ sensitivity</li>
        <li class="text-slate-300">Reduce radiologist reading time by 40%</li>
        <li class="text-slate-300">Flag urgent cases for immediate attention</li>
        <li class="text-slate-300">Improve diagnostic consistency across providers</li>
      </ul>
        </div>
