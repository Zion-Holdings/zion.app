...
export const metadata: Metadata = {
  title: 'Self-Optimizing Resource Suite',
  description: 'Transform your healthcare operations with our Self-Optimizing Resource Suite. This AI-driven solution automates supply chain with unprecedented accuracy and eff',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Resource Suite
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Self-Optimizing Resource Suite. This AI-driven solution automates supply chain with unprecedented accuracy and efficiency.
          </p>
