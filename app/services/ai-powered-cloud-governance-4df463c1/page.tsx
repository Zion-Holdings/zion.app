...
export const metadata: Metadata = {
  title: 'AI-Powered Cloud Governance',
  description: 'Automated cloud governance with policy enforcement and resource control.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-cloud-governance-4df463c1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automated cloud governance with policy enforcement and resource control.
          </p>
