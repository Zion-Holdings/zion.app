...
export const metadata: Metadata = {
  ...
  description: 'Transform your logistics operations with our Deep Learning Processor. This automation solution delivers unprecedented automation and intelligence.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Deep Learning Processor. This automation solution delivers unprecedented automation and intelligence.
          </p>
