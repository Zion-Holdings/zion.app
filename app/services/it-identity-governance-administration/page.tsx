...
export const metadata: Metadata = {
  ...
  keywords: 'Automated access certifications, Role-based access control (RBAC), Privileged access management, Identity lifecycle automation, Segregation of duties enforcement, Compliance reporting (SOX, GDPR), Self-service access requests, Integration with 200+ enterprise apps, it, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Identity Governance &amp; Administration (IGA)</h1>
        <p className="text-lg text-slate-300 mb-8">Comprehensive identity governance with automated access reviews, role-based access control, privileged access management, and compliance reporting. Centralized identity lifecycle management across all enterprise systems.</p>
        ...
        <li class="text-slate-300">Automated access certifications</li>
        <li class="text-slate-300">Role-based access control (RBAC)</li>
        <li class="text-slate-300">Privileged access management</li>
        <li class="text-slate-300">Identity lifecycle automation</li>
        <li class="text-slate-300">Segregation of duties enforcement</li>
        <li class="text-slate-300">Compliance reporting (SOX, GDPR)</li>
        <li class="text-slate-300">Self-service access requests</li>
        <li class="text-slate-300">Integration with 200+ enterprise apps</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce access-related security risks</li>
        <li class="text-slate-300">Automate compliance reporting</li>
        <li class="text-slate-300">Streamline access requests</li>
        <li class="text-slate-300">Prevent privilege creep</li>
      </ul>
        </div>
