...
export const metadata: Metadata = {
  title: 'Director Cognitive - Media',
  description: 'Revolutionize media through intelligent automation. Our Director Cognitive - Media leverages advanced machine learning to deliver document processing at scale.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize media through intelligent automation. Our Director Cognitive - Media leverages advanced machine learning to deliver document processing at scale.
          </p>
