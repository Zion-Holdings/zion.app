...
export const metadata: Metadata = {
  title: 'Intelligent Contract for Startup',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Contract for Startup
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in startup with Intelligent Contract for Startup. This AI-powered platform transforms fraud prevention into a competitive advantage.
          </p>
