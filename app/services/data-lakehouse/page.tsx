...
export const metadata: Metadata = {
  ...
  keywords: 'Open-table format (Iceberg), ACID transactions, Time-travel queries, Schema evolution, Separation of compute/storage, data, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Unified platform combining data lake flexibility with data warehouse performance — ACID transactions, time travel, and open-table format support.</p>
        ...
        <li class="text-slate-300">Open-table format (Iceberg)</li>
        <li class="text-slate-300">ACID transactions</li>
        <li class="text-slate-300">Time-travel queries</li>
        <li class="text-slate-300">Schema evolution</li>
        <li class="text-slate-300">Separation of compute/storage</li>
      </ul>
        </div>
