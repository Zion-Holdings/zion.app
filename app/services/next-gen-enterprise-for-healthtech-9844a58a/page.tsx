...
export const metadata: Metadata = {
  title: 'Next-Gen Enterprise for HEALTHTECH',
  description: 'Revolutionize healthtech through intelligent automation. Our Next-Gen Enterprise for HEALTHTECH leverages advanced machine learning to deliver root cause analys',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-enterprise-for-healthtech-9844a58a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Enterprise for HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthtech through intelligent automation. Our Next-Gen Enterprise for HEALTHTECH leverages advanced machine learning to deliver root cause analysis at scale.
          </p>
