...
export const metadata: Metadata = {
  title: 'Neural Suite for Proptech',
  description: 'The future of proptech is here with Neural Suite for Proptech. Powered by cutting-edge AI, this platform delivers data processing like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-suite-for-proptech-01ae4cc2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Suite for Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with Neural Suite for Proptech. Powered by cutting-edge AI, this platform delivers data processing like never before.
          </p>
