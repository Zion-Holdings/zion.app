...
export const metadata: Metadata = {
  title: 'Quantum Finance - Healthcare Quantum',
  description: 'Optimize your healthcare workflows with Quantum Finance - Healthcare Quantum. This intelligent platform delivers record extraction through advanced automation a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-finance-healthcare-quantum-168a7d9f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Finance - Healthcare Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Quantum Finance - Healthcare Quantum. This intelligent platform delivers record extraction through advanced automation and AI.
          </p>
