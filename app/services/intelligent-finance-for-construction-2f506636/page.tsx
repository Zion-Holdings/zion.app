...
export const metadata: Metadata = {
  title: 'Intelligent Finance for Construction',
  description: 'Drive innovation in construction with Intelligent Finance for Construction. This AI-powered platform transforms brand monitoring into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-finance-for-construction-2f506636',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Finance for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Intelligent Finance for Construction. This AI-powered platform transforms brand monitoring into a competitive advantage.
          </p>
