...
export const metadata: Metadata = {
  title: 'Cognitive supply-energy',
  description: 'Transform your energy operations with our Cognitive supply-energy. This AI-driven solution provides intelligent automation with unprecedented accuracy and effic',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-supply-energy-b275c883',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive supply-energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Cognitive supply-energy. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
