...
export const metadata: Metadata = {
  title: 'Kinetic Energy Harvester Monitor',
  description: 'Monitors and optimizes kinetic energy harvesters for industrial IoT sites.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/kinetic-energy-harvester-monitor-8e76d7e6',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Kinetic Energy Harvester Monitor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Monitors and optimizes kinetic energy harvesters for industrial IoT sites.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your energy harvesting operations?</p>
