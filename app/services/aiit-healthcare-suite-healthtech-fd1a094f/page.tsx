...
export const metadata: Metadata = {
  title: 'AI/IT Healthcare Suite - HEALTHTECH',
  description: 'Quantum leap forward for healthtech: AI/IT Healthcare Suite - HEALTHTECH. Uses quantum-inspired algorithms to deliver performance reviews at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-healthcare-suite-healthtech-fd1a094f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Healthcare Suite - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for healthtech: AI/IT Healthcare Suite - HEALTHTECH. Uses quantum-inspired algorithms to deliver performance reviews at exponential speed.
          </p>
