...
export const metadata: Metadata = {
  title: 'Healthcare Smart - Manufacturing #1',
  description: 'Next-generation manufacturing solution: Healthcare Smart - Manufacturing #1. Combines fraud prevention with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/healthcare-smart-manufacturing-1-2df06238',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Healthcare Smart - Manufacturing #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation manufacturing solution: Healthcare Smart - Manufacturing #1. Combines fraud prevention with adaptive intelligence for optimal results.
          </p>
