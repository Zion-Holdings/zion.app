...
export const metadata: Metadata = {
  title: 'Enterprise Process Mining Platform - HEALTHTECH',
  description: 'Revolutionize healthtech through intelligent automation. Our Enterprise Process Mining Platform - HEALTHTECH leverages advanced machine learning to deliver cust',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Process Mining Platform - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthtech through intelligent automation. Our Enterprise Process Mining Platform - HEALTHTECH leverages advanced machine learning to deliver customer journey mapping at scale.
          </p>
