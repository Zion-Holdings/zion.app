...
export const metadata: Metadata = {
  title: 'Intelligent Orchestrator for HEALTHTECH',
  description: 'Quantum leap forward for healthtech: Intelligent Orchestrator for HEALTHTECH. Uses quantum-inspired algorithms to deliver contract analysis at exponential speed',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-orchestrator-for-healthtech-f18877ea',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Orchestrator for HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for healthtech: Intelligent Orchestrator for HEALTHTECH. Uses quantum-inspired algorithms to deliver contract analysis at exponential speed.
          </p>
