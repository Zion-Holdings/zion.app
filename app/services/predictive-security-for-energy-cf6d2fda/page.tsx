...
export const metadata: Metadata = {
  title: 'Predictive Security for Energy',
  description: 'Next-generation energy solution: Predictive Security for Energy. Combines security monitoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-security-for-energy-cf6d2fda',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Security for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Predictive Security for Energy. Combines security monitoring with adaptive intelligence for optimal results.
          </p>
