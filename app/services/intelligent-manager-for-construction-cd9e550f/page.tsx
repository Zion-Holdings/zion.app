...
export const metadata: Metadata = {
  title: 'Intelligent Manager for Construction',
  description: 'Transform your construction operations with our Intelligent Manager for Construction. This AI-driven solution automates territory management with unprecedented ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-manager-for-construction-cd9e550f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Manager for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Intelligent Manager for Construction. This AI-driven solution automates territory management with unprecedented accuracy and efficiency.
          </p>
