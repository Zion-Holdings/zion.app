...
export const metadata: Metadata = {
  title: 'Suite AI - Construction',
  description: 'Next-generation construction solution: Suite AI - Construction. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/suite-ai-construction-480d8bbe',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Suite AI - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Suite AI - Construction. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
