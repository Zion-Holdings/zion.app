...
export const metadata: Metadata = {
  title: 'AI Quality - Construction Edition',
  description: 'The future of construction is here with AI Quality - Construction Edition. Powered by cutting-edge AI, this platform delivers compensation management like never',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Quality - Construction Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with AI Quality - Construction Edition. Powered by cutting-edge AI, this platform delivers compensation management like never before.
          </p>
