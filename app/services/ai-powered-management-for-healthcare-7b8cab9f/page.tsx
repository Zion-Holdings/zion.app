...
export const metadata: Metadata = {
  ...
  description: 'Optimize your healthcare workflows with AI-Powered Management for Healthcare. This intelligent platform delivers risk assessment through advanced automation and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-management-for-healthcare-7b8cab9f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with AI-Powered Management for Healthcare. This intelligent platform delivers risk assessment through advanced automation and AI.
          </p>
