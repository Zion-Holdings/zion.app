...
export const metadata: Metadata = {
  title: "AI-Powered Logistics Threat Detection - AI-Powered Logistics Solution",
  description: "AI-powered logistics solution leveraging advanced machine learning for optimal performance and ROI.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-logistics-threat-detection-bcc54068",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Logistics Threat Detection - AI-Powered Logistics Solution
        </h1>
