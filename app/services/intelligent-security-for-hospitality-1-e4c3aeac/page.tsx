...
export const metadata: Metadata = {
  title: 'Intelligent Security for Hospitality #1',
  description: 'The future of hospitality is here with Intelligent Security for Hospitality #1. Powered by cutting-edge AI, this platform delivers customer insights like never ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-security-for-hospitality-1-e4c3aeac',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Security for Hospitality #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Intelligent Security for Hospitality #1. Powered by cutting-edge AI, this platform delivers customer insights like never before.
          </p>
