...
export const metadata: Metadata = {
  title: 'AI/IT tactical-hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our AI/IT tactical-hospitality leverages advanced machine learning to deliver forecast accuracy at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT tactical-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our AI/IT tactical-hospitality leverages advanced machine learning to deliver forecast accuracy at scale.
          </p>
