...
export const metadata: Metadata = {
  title: 'Next-Gen Sales for Legal',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Sales for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Next-Gen Sales for Legal leverages advanced machine learning to deliver net promoter score at scale.
          </p>
