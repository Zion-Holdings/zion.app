...
export const metadata: Metadata = {
  title: 'Intelligent processor-insurance',
  description: 'Optimize your insurance workflows with Intelligent processor-insurance. This intelligent platform delivers contract analysis through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-processor-insurance-9689ba1a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent processor-insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Intelligent processor-insurance. This intelligent platform delivers contract analysis through advanced automation and AI.
          </p>
