...
export const metadata: Metadata = {
  title: 'Intelligent Risk for Agriculture #1',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Risk for Agriculture #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Intelligent Risk for Agriculture #1 leverages advanced machine learning to deliver network optimization at scale.
          </p>
