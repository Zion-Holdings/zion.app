...
export const metadata: Metadata = {
  title: 'Cognitive Data Science Solution - HEALTHTECH',
  description: 'Optimize your healthtech workflows with Cognitive Data Science Solution - HEALTHTECH. This intelligent platform delivers margin analysis through advanced automa',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-data-science-solution-healthtech-f77e94b1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Data Science Solution - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthtech workflows with Cognitive Data Science Solution - HEALTHTECH. This intelligent platform delivers margin analysis through advanced automation and AI.
          </p>
