...
export const metadata: Metadata = {
  title: 'Optimizer Cognitive - Insurance',
  description: 'Optimize your insurance workflows with Optimizer Cognitive - Insurance. This intelligent platform delivers edge computing through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/optimizer-cognitive-insurance-a01ffa5c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Optimizer Cognitive - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Optimizer Cognitive - Insurance. This intelligent platform delivers edge computing through advanced automation and AI.
          </p>
