...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-format document ingest, Configurable summary length, Citation-backed extraction, Compliance abstract templates, Bulk processing API, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Generative AI Document Summarizer</h1>
        <p className="text-lg text-slate-300 mb-8">Enterprise document summarization engine: ingest PDFs, Word docs, and transcripts to generate executive briefs, meeting notes, and compliance abstracts.</p>
        ...
        <li class="text-slate-300">Multi-format document ingest</li>
        <li class="text-slate-300">Configurable summary length</li>
        <li class="text-slate-300">Citation-backed extraction</li>
        <li class="text-slate-300">Compliance abstract templates</li>
        <li class="text-slate-300">Bulk processing API</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with generative ai document summarizer</li>
