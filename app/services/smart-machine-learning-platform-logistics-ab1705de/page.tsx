...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize logistics through intelligent automation. Our Smart Machine Learning Platform - Logistics leverages advanced machine learning to deliver serverles',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-machine-learning-platform-logistics-ab1705de',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Smart Machine Learning Platform - Logistics leverages advanced machine learning to deliver serverless deployment at scale.
          </p>
