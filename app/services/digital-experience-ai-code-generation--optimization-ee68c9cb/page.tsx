...
export const metadata: Metadata = {
  ...
  description: 'digital experience solution for personal care industry. Generates production-ready code from natural language descriptions, optimizes existing code for performa',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/digital-experience-ai-code-generation--optimization-ee68c9cb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            digital experience solution for personal care industry. Generates production-ready code from natural language descriptions, optimizes existing code for performance.
          </p>
