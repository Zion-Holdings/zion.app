...
export const metadata: Metadata = {
  ...
  description: 'Identifies high-risk patients for chronic conditions with intervention triggers.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-patient-risk-stratification-45eacfda',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Identifies high-risk patients for chronic conditions with intervention triggers.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">40% churn reduction</li>
