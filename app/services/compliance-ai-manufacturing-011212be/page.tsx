...
export const metadata: Metadata = {
  title: 'Compliance AI - Manufacturing',
  description: 'The future of manufacturing is here with Compliance AI - Manufacturing. Powered by cutting-edge AI, this platform delivers churn prediction like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/compliance-ai-manufacturing-011212be',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of manufacturing is here with Compliance AI - Manufacturing. Powered by cutting-edge AI, this platform delivers churn prediction like never before.
          </p>
