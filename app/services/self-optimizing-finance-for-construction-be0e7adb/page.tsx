...
export const metadata: Metadata = {
  title: 'Self-Optimizing Finance for Construction',
  description: 'Optimize your construction workflows with Self-Optimizing Finance for Construction. This intelligent platform delivers reputation management through advanced au',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/self-optimizing-finance-for-construction-be0e7adb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Finance for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Self-Optimizing Finance for Construction. This intelligent platform delivers reputation management through advanced automation and AI.
          </p>
