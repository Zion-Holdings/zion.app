...
export const metadata: Metadata = {
  ...
  description: 'Optimize your healthcare workflows with Predictive Data Engine - Healthcare. This intelligent platform delivers container orchestration through advanced automat',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Predictive Data Engine - Healthcare. This intelligent platform delivers container orchestration through advanced automation and AI.
          </p>
