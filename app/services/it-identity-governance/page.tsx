...
export const metadata: Metadata = {
  ...
  keywords: 'Provisioning/deprovisioning workflows, Access certification campaigns, SoD policy engine, Role mining & optimization, SOD analytics, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Identity Governance &amp; Administration</h1>
        <p className="text-lg text-slate-300 mb-8">Centralized IGA: lifecycle management, access certifications, separation-of-duties policies. Integrates with Active Directory, Okta, Azure AD.</p>
        ...
        <li class="text-slate-300">Provisioning/deprovisioning workflows</li>
        <li class="text-slate-300">Access certification campaigns</li>
        <li class="text-slate-300">SoD policy engine</li>
        <li class="text-slate-300">Role mining &amp; optimization</li>
        <li class="text-slate-300">SOD analytics</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with identity governance &amp; administration</li>
