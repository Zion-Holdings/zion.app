...
export const metadata: Metadata = {
  title: 'Smart Enterprise Platform - Telecom',
  description: 'Unlock unprecedented growth with Smart Enterprise Platform - Telecom. This autonomous system provides campaign optimization with zero manual intervention needed',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-enterprise-platform-telecom-653729e9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Enterprise Platform - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Enterprise Platform - Telecom. This autonomous system provides campaign optimization with zero manual intervention needed.
          </p>
