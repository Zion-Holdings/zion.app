...
export const metadata: Metadata = {
  title: 'AI/IT Orchestrator Suite - Retail',
  description: 'Optimize your retail workflows with AI/IT Orchestrator Suite - Retail. This intelligent platform delivers customer service automation through advanced automatio',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-orchestrator-suite-retail-be3fbcfa',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Orchestrator Suite - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your retail workflows with AI/IT Orchestrator Suite - Retail. This intelligent platform delivers customer service automation through advanced automation and AI.
          </p>
