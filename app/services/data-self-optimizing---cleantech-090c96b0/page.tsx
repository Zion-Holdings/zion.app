...
export const metadata: Metadata = {
  title: 'Data Self-Optimizing - Cleantech',
  description: 'Transform your cleantech operations with our Data Self-Optimizing - Cleantech. This AI-driven solution automates sales forecasting with unprecedented accuracy a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Self-Optimizing - Cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your cleantech operations with our Data Self-Optimizing - Cleantech. This AI-driven solution automates sales forecasting with unprecedented accuracy and efficiency.
          </p>
