...
export const metadata: Metadata = {
  title: 'Quantum Enterprise - PROPTECH Quantum',
  description: 'The future of proptech is here with Quantum Enterprise - PROPTECH Quantum. Powered by cutting-edge AI, this platform delivers churn prediction like never before',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-enterprise-proptech-quantum-692ee40c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Enterprise - PROPTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with Quantum Enterprise - PROPTECH Quantum. Powered by cutting-edge AI, this platform delivers churn prediction like never before.
          </p>
