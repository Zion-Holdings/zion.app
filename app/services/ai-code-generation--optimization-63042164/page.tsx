...
export const metadata: Metadata = {
  title: "AI Code Generation & Optimization - AI-Powered Development Solution",
  description: "Generates production-ready code from natural language descriptions, optimizes existing code for performance.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-code-generation--optimization-63042164",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI Code Generation & Optimization - AI-Powered Development Solution
        </h1>
