...
export const metadata: Metadata = {
  title: 'Cognitive Deep Learning Solution - FINTECH',
  description: 'Enhance your fintech business with Cognitive Deep Learning Solution - FINTECH. Our solution provides predictive modeling with enterprise-grade reliability and s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Deep Learning Solution - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your fintech business with Cognitive Deep Learning Solution - FINTECH. Our solution provides predictive modeling with enterprise-grade reliability and security.
          </p>
