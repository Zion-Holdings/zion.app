...
export const metadata: Metadata = {
  title: 'Intelligent Smart for Hospitality',
  description: 'The future of hospitality is here with Intelligent Smart for Hospitality. Powered by cutting-edge AI, this platform delivers personalization engine like never b',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-smart-for-hospitality-2e5a62c5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Smart for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Intelligent Smart for Hospitality. Powered by cutting-edge AI, this platform delivers personalization engine like never before.
          </p>
