...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "Incident Response Retainer | Zion Tech Group", description: "End-to-end incident response retainer services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/incident-response-retainer-2026-8344/}} />
