...
export const metadata: Metadata = {
  ...
  description: 'Drive innovation in finance with Autonomous Customer Service System - Finance. This AI-powered platform transforms net promoter score into a competitive advanta',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-customer-service-system-finance-95f98bbb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in finance with Autonomous Customer Service System - Finance. This AI-powered platform transforms net promoter score into a competitive advantage.
          </p>
