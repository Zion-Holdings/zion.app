...
export const metadata: Metadata = {
  title: 'Autonomous HR Deep Learning',
  description: 'Transform your healthcare operations with our Autonomous HR Deep Learning. This AI-driven solution provides intelligent automation with unprecedented accuracy a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous HR Deep Learning
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Autonomous HR Deep Learning. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
