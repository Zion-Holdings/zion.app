...
export const metadata: Metadata = {
  title: 'Healthcare Intelligent - Legal',
  description: 'Transform your legal operations with our Healthcare Intelligent - Legal. This AI-driven solution automates performance tuning with unprecedented accuracy and ef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/healthcare-intelligent-legal-a898efe1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Healthcare Intelligent - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Healthcare Intelligent - Legal. This AI-driven solution automates performance tuning with unprecedented accuracy and efficiency.
          </p>
