...
export const metadata: Metadata = {
  title: 'Autonomous Supply Chain GCP (Education)',
  description: 'Autonomous Supply Chain GCP (Education) is an AI-powered education solution that transforms how businesses operate through intelligent automation and real-time ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Supply Chain GCP (Education)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Autonomous Supply Chain GCP (Education) is an AI-powered education solution that transforms how businesses operate through intelligent automation and real-time analytics.
