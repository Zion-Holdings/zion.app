...
export const metadata: Metadata = {
  title: 'Cognitive Risk Solution - Hospitality #1',
  description: 'Next-generation hospitality solution: Cognitive Risk Solution - Hospitality #1. Combines regulatory tracking with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-risk-solution-hospitality-1-e4b1f11c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Risk Solution - Hospitality #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Cognitive Risk Solution - Hospitality #1. Combines regulatory tracking with adaptive intelligence for optimal results.
          </p>
