...
export const metadata: Metadata = {
  ...
  keywords: 'Continuous identity verification (adaptive auth), Context-aware access policies, Device posture scoring + compliance gating, Micro-segmentation per user/session, Real-time threat intelligence integration, ai, E-Commerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Zero Trust Network Access (ZTNA)</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered ZTNA platform: continuous identity verification, adaptive access policies, micro-segmentation, device posture scoring, and real-time threat-based access revocation — all enforced at the edge.</p>
        ...
        <li class="text-slate-300">Continuous identity verification (adaptive auth)</li>
        <li class="text-slate-300">Context-aware access policies</li>
        <li class="text-slate-300">Device posture scoring + compliance gating</li>
        <li class="text-slate-300">Micro-segmentation per user/session</li>
        <li class="text-slate-300">Real-time threat intelligence integration</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai zero trust network access (ztna)</li>
