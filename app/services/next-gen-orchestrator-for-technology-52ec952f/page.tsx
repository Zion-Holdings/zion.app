...
export const metadata: Metadata = {
  title: 'Next-Gen Orchestrator for TECHNOLOGY',
  description: 'Revolutionize technology through intelligent automation. Our Next-Gen Orchestrator for TECHNOLOGY leverages advanced machine learning to deliver churn predictio',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Orchestrator for TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our Next-Gen Orchestrator for TECHNOLOGY leverages advanced machine learning to deliver churn prediction at scale.
          </p>
