...
export const metadata: Metadata = {
  title: 'Marketing Predictive - Energy',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Marketing Predictive - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Marketing Predictive - Energy leverages advanced machine learning to deliver risk assessment at scale.
          </p>
