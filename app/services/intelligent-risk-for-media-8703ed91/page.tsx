...
export const metadata: Metadata = {
  title: 'Intelligent Risk for Media',
  description: 'Enhance your media business with Intelligent Risk for Media. Our solution provides capacity management with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-risk-for-media-8703ed91',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Risk for Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your media business with Intelligent Risk for Media. Our solution provides capacity management with enterprise-grade reliability and security.
          </p>
