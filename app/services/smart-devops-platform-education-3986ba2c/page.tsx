...
export const metadata: Metadata = {
  title: 'Smart DevOps Platform - Education',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart DevOps Platform - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your education business with Smart DevOps Platform - Education. Our solution provides forecast accuracy with enterprise-grade reliability and security.
          </p>
