...
export const metadata: Metadata = {
  title: 'AI-Powered intelligence-agriculture',
  description: 'The future of agriculture is here with AI-Powered intelligence-agriculture. Powered by cutting-edge AI, this platform delivers procurement automation like never',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-intelligence-agriculture-a618ac4e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered intelligence-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with AI-Powered intelligence-agriculture. Powered by cutting-edge AI, this platform delivers procurement automation like never before.
          </p>
