...
export const metadata: Metadata = {
  title: 'Smart Threat Security',
  description: 'Transform your logistics operations with our Smart Threat Security. This AI-driven solution automates fraud prevention with unprecedented accuracy and efficienc',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Threat Security
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Smart Threat Security. This AI-driven solution automates fraud prevention with unprecedented accuracy and efficiency.
          </p>
