...
export const metadata: Metadata = {
  title: 'Computer Vision AI Sales Lead Scoring Engine',
  description: 'computer vision solution for sports & entertainment industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/computer-vision-ai-sales-lead-scoring-engine-38c4e55c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Computer Vision AI Sales Lead Scoring Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            computer vision solution for sports & entertainment industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.
          </p>
