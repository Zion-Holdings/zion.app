...
export const metadata: Metadata = {
  title: 'Hospitality Iot Platform #30',
  description: 'AI-powered hospitality solution for iot. Provides enterprise-grade automation and optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/iot-hospitality-0e62ef1c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hospitality Iot Platform #30
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered hospitality solution for iot. Provides enterprise-grade automation and optimization.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Edge computing</li>
          <li className="text-gray-300">Sensor data analysis</li>
        ...
        <section className="mb-12">
          ...
          <li className="text-purple-300">Energy efficiency</li>
          </ul>
        </section>
