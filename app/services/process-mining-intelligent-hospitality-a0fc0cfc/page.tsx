...
export const metadata: Metadata = {
  title: 'Process Mining Intelligent - Hospitality',
  description: 'Transform your hospitality operations with our Process Mining Intelligent - Hospitality. This AI-driven solution provides intelligent automation with unpreceden',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/process-mining-intelligent-hospitality-a0fc0cfc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Process Mining Intelligent - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Process Mining Intelligent - Hospitality. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
