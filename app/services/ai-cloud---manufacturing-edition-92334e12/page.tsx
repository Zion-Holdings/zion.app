...
export const metadata: Metadata = {
  title: 'AI Cloud - Manufacturing Edition',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Cloud - Manufacturing Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation manufacturing solution: AI Cloud - Manufacturing Edition. Combines compliance monitoring with adaptive intelligence for optimal results.
          </p>
