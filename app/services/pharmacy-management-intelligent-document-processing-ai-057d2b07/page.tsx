...
export const metadata: Metadata = {
  ...
  description: 'pharmacy management solution for agriculture industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automat',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/pharmacy-management-intelligent-document-processing-ai-057d2b07',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            pharmacy management solution for agriculture industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.
          </p>
