...
export const metadata: Metadata = {
  title: 'Autonomous automation-cleantech',
  description: 'Transform your cleantech operations with our Autonomous automation-cleantech. This AI-driven solution automates logistics route optimization with unprecedented ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous automation-cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your cleantech operations with our Autonomous automation-cleantech. This AI-driven solution automates logistics route optimization with unprecedented accuracy and efficiency.
          </p>
