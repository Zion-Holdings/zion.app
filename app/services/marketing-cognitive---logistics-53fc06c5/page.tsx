...
export const metadata: Metadata = {
  title: 'Marketing Cognitive - Logistics',
  description: 'Transform your logistics operations with our Marketing Cognitive - Logistics. This AI-driven solution automates financial planning with unprecedented accuracy a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Marketing Cognitive - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Marketing Cognitive - Logistics. This AI-driven solution automates financial planning with unprecedented accuracy and efficiency.
          </p>
