...
export const metadata: Metadata = {
  title: 'Merchandising AI-Powered Disaster Recovery',
  description: 'AI-powered merchandising solution for disaster recovery. Automated disaster recovery planning and failover testing.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/merchandising-ai-powered-disaster-recovery-47bf1739',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Merchandising AI-Powered Disaster Recovery
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered merchandising solution for disaster recovery. Automated disaster recovery planning and failover testing.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your merchandising operations?</p>
