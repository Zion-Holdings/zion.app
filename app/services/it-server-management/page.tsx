...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'IT Server Management & Infrastructure Monitoring', 'description': '24/7 server management with proactive monitoring, patching, backups, and performance optimization. For on-premises, cloud, and hybrid environments.', 'serviceType': 'it', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'technology'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'IT Server Management & Infrastructure Monitoring Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$500/server/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$800/server/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': 'Custom', 'priceCurrency': 'USD'}]}} />
    <JsonLd data={'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': '24/7 server monitoring and alerting', 'acceptedAnswer': {'@type': 'Answer', 'text': '24/7 server monitoring and alerting'}}, {'@type': 'Question', 'name': 'Automated patching and updates', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Automated patching and updates'}}, {'@type': 'Question', 'name': 'Performance optimization and tuning', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Performance optimization and tuning'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Achieve 99.9% server uptime; Proactively prevent issues before they impact; Optimize server performance and costs'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} />
