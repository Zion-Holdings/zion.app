...
export const metadata: Metadata = {
  ...
  keywords: 'HD video consultations, EHR/EMR integration (Epic, Cerner), Remote patient monitoring, Automated scheduling & reminders, HIPAA-compliant messaging, it, Healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Healthcare Telehealth Platform</h1>
        <p className="text-lg text-slate-300 mb-8">HIPAA-compliant telehealth platform with HD video consultations, EHR integration, remote patient monitoring, and automated appointment scheduling.</p>
        ...
        <li class="text-slate-300">EHR/EMR integration (Epic, Cerner)</li>
        <li class="text-slate-300">Remote patient monitoring</li>
        <li class="text-slate-300">Automated scheduling &amp; reminders</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Increase patient reach by 300%</li>
        <li class="text-slate-300">Reduce no-shows by 45%</li>
        <li class="text-slate-300">Full HIPAA compliance</li>
      </ul>
        </div>
