...
export const metadata: Metadata = {
  ...
  keywords: 'Opportunity assessment per process, AI model + stack selection, Data readiness audit, 90-day roadmap + first-win per exec approval, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Strategy &amp; Roadmap Consulting</h1>
        <p className="text-lg text-slate-300 mb-8">Executive AI strategy: opportunity assessment model selection custom vs off-the-shelf stack design data readiness audit pilot roadmap prioritization 90-day win plan.</p>
        ...
        <li class="text-slate-300">Opportunity assessment per process</li>
        <li class="text-slate-300">AI model + stack selection</li>
        <li class="text-slate-300">Data readiness audit</li>
        <li class="text-slate-300">90-day roadmap + first-win per exec approval</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai strategy &amp; roadmap consulting</li>
