...
export const metadata: Metadata = {
  title: 'Smart coordinator-construction',
  description: 'Transform your construction operations with our Smart coordinator-construction. This AI-driven solution automates compliance reporting with unprecedented accura',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-coordinator-construction-6b528a1c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart coordinator-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Smart coordinator-construction. This AI-driven solution automates compliance reporting with unprecedented accuracy and efficiency.
          </p>
