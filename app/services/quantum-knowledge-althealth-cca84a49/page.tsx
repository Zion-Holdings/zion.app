...
export const metadata: Metadata = {
  title: 'Quantum knowledge-althealth',
  description: 'The future of althealth is here with Quantum knowledge-althealth. Powered by cutting-edge AI, this platform delivers disaster recovery like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-knowledge-althealth-cca84a49',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum knowledge-althealth
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of althealth is here with Quantum knowledge-althealth. Powered by cutting-edge AI, this platform delivers disaster recovery like never before.
          </p>
