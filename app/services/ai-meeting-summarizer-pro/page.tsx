      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Record + transcribe with speaker diarization. AI summary: decisions made, action items, owners, deadlines, topic timeline. Auto-pushes to Slack/Asana/Notion/Jira + recurring meeting agenda builder.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Live transcription with speaker diarization</li>
            <li className="text-purple-300">✓ AI summary: decisions + action items + owners</li>
            <li className="text-purple-300">✓ Auto-push to Slack/Asana/Notion/Jira</li>
            <li className="text-purple-300">✓ Recurring meeting agenda from past topics</li>
            <li className="text-purple-300">✓ Sentiment + engagement score per participant</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai meeting summarizer & action tracker</li>
