...
export const metadata: Metadata = {
  ...
  keywords: 'Live transcription with speaker diarization, AI summary: decisions + action items + owners, Auto-push to Slack/Asana/Notion/Jira, Recurring meeting agenda from past topics, Sentiment + engagement score per participant, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Meeting Summarizer &amp; Action Tracker</h1>
        <p className="text-lg text-slate-300 mb-8">Record + transcribe with speaker diarization. AI summary: decisions made, action items, owners, deadlines, topic timeline. Auto-pushes to Slack/Asana/Notion/Jira + recurring meeting agenda builder.</p>
        ...
        <li class="text-slate-300">Live transcription with speaker diarization</li>
        <li class="text-slate-300">AI summary: decisions + action items + owners</li>
        <li class="text-slate-300">Auto-push to Slack/Asana/Notion/Jira</li>
        <li class="text-slate-300">Recurring meeting agenda from past topics</li>
        <li class="text-slate-300">Sentiment + engagement score per participant</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai meeting summarizer &amp; action tracker</li>
