...
export const metadata: Metadata = {
  title: 'Dashboard Creation Intelligent Document Processing AI',
  description: 'dashboard creation solution for consumer goods industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents autom',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/dashboard-creation-intelligent-document-processing-ai-3f99cd67',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Dashboard Creation Intelligent Document Processing AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            dashboard creation solution for consumer goods industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.
          </p>
