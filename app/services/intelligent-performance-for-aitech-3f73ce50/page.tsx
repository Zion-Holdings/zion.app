...
export const metadata: Metadata = {
  title: 'Intelligent Performance for AITECH',
  description: 'Revolutionize aitech through intelligent automation. Our Intelligent Performance for AITECH leverages advanced machine learning to deliver cost reduction at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Performance for AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize aitech through intelligent automation. Our Intelligent Performance for AITECH leverages advanced machine learning to deliver cost reduction at scale.
          </p>
