...
export const metadata: Metadata = {
  title: 'AI-Powered Factory Optimization AI',
  description: 'AI for factory optimization with simulation and analytics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-factory-optimization-ai-cb62f943',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Factory Optimization AI
          </h1>
