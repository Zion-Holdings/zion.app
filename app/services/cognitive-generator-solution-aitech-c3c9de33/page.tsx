...
export const metadata: Metadata = {
  title: 'Cognitive Generator Solution - AITECH',
  description: 'Optimize your aitech workflows with Cognitive Generator Solution - AITECH. This intelligent platform delivers background checks through advanced automation and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-generator-solution-aitech-c3c9de33',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Generator Solution - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your aitech workflows with Cognitive Generator Solution - AITECH. This intelligent platform delivers background checks through advanced automation and AI.
          </p>
