...
export const metadata: Metadata = {
  title: 'Next-Gen Director for Hospitality',
  description: 'Transform your hospitality operations with our Next-Gen Director for Hospitality. This AI-driven solution automates survey automation with unprecedented accurac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-director-for-hospitality-413c6d16',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Director for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Next-Gen Director for Hospitality. This AI-driven solution automates survey automation with unprecedented accuracy and efficiency.
          </p>
