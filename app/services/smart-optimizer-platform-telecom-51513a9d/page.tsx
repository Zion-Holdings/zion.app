...
export const metadata: Metadata = {
  title: 'Smart Optimizer Platform - Telecom',
  description: 'Revolutionize telecom through intelligent automation. Our Smart Optimizer Platform - Telecom leverages advanced machine learning to deliver energy management at',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-optimizer-platform-telecom-51513a9d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Optimizer Platform - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Smart Optimizer Platform - Telecom leverages advanced machine learning to deliver energy management at scale.
          </p>
