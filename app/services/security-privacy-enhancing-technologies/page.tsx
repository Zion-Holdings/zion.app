...
export const metadata: Metadata = {
  ...
  keywords: 'Differential privacy budget tracker with dataset privacy score per column, Zero-knowledge proof circuit design and deployment audit for selected use cases, TEE Trusted Execution Environment enclave architecture review and threat model, Synthetic data generator — privacy-preserving by construction with attribute correlation learned, security, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Privacy Enhancing Technologies</h1>
        <p className="text-lg text-slate-300 mb-8">Privacy Enhancing Technologies consulting and implementation: differential privacy budget tracking, homomorphic encryption proof-of-concept, zero-knowledge proof circuits, TEE enclave design, synthetic data generation, and compliance audit-readiness report.</p>
        ...
        <li class="text-slate-300">Differential privacy budget tracker with dataset privacy score per column</li>
        <li class="text-slate-300">Zero-knowledge proof circuit design and deployment audit for selected use cases</li>
        <li class="text-slate-300">TEE Trusted Execution Environment enclave architecture review and threat model</li>
        <li class="text-slate-300">Synthetic data generator — privacy-preserving by construction with attribute correlation learned</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with privacy enhancing technologies</li>
