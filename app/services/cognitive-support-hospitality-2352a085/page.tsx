...
export const metadata: Metadata = {
  title: 'Cognitive support-hospitality',
  description: 'Optimize your hospitality workflows with Cognitive support-hospitality. This intelligent platform delivers brand monitoring through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-support-hospitality-2352a085',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive support-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Cognitive support-hospitality. This intelligent platform delivers brand monitoring through advanced automation and AI.
          </p>
