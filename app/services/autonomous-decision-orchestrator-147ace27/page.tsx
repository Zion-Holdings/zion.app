...
export const metadata: Metadata = {
  title: 'Autonomous Decision Orchestrator',
  description: 'Transform your energy operations with our Autonomous Decision Orchestrator. This AI-driven solution automates performance reviews with unprecedented accuracy an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Autonomous Decision Orchestrator. This AI-driven solution automates performance reviews with unprecedented accuracy and efficiency.
          </p>
