...
export const metadata: Metadata = {
  title: 'Intelligent Smart - Telecom',
  description: 'Optimize your telecom workflows with Intelligent Smart - Telecom. This intelligent platform delivers cost reduction through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-smart-telecom-26e2853a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Smart - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your telecom workflows with Intelligent Smart - Telecom. This intelligent platform delivers cost reduction through advanced automation and AI.
          </p>
