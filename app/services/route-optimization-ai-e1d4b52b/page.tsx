...
export const metadata = {
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/route-optimization-ai-e1d4b52b`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path={`/services/route-optimization-ai-e1d4b52b`} title="Route Optimization AI — Dynamic Logistics Planning" />
