...
export const metadata: Metadata = {
  title: 'AI/IT management-transportation',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT management-transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize transportation through intelligent automation. Our AI/IT management-transportation leverages advanced machine learning to deliver scenario planning at scale.
          </p>
