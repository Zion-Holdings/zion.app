...
export const metadata: Metadata = {
  title: 'Intelligent Data for Hospitality',
  description: 'Drive innovation in hospitality with Intelligent Data for Hospitality. This AI-powered platform transforms expense management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-data-for-hospitality-86d318e3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Data for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Intelligent Data for Hospitality. This AI-powered platform transforms expense management into a competitive advantage.
          </p>
