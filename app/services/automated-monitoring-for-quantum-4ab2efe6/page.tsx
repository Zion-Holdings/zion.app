...
export const metadata: Metadata = {
  title: 'Automated Monitoring for Quantum',
  description: 'Transform your quantum operations with our Automated Monitoring for Quantum. This AI-driven solution automates compliance monitoring with unprecedented accuracy',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Monitoring for Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your quantum operations with our Automated Monitoring for Quantum. This AI-driven solution automates compliance monitoring with unprecedented accuracy and efficiency.
          </p>
