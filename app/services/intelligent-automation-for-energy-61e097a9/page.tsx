...
export const metadata: Metadata = {
  title: 'Intelligent Automation for Energy',
  description: 'The future of energy is here with Intelligent Automation for Energy. Powered by cutting-edge AI, this platform delivers quota optimization like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-automation-for-energy-61e097a9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Automation for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Intelligent Automation for Energy. Powered by cutting-edge AI, this platform delivers quota optimization like never before.
          </p>
