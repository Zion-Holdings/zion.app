...
export const metadata: Metadata = {
  title: 'Intelligent Orchestrator Platform',
  description: 'Transform your insurance operations with our Intelligent Orchestrator Platform. This ai solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-orchestrator-platf-4a5720',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Orchestrator Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Intelligent Orchestrator Platform. This ai solution delivers unprecedented automation and intelligence.
          </p>
