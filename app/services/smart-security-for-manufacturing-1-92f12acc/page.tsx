...
export const metadata: Metadata = {
  title: 'Smart Security for Manufacturing #1',
  description: 'The future of manufacturing is here with Smart Security for Manufacturing #1. Powered by cutting-edge AI, this platform delivers maintenance scheduling like nev',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-security-for-manufacturing-1-92f12acc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Security for Manufacturing #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of manufacturing is here with Smart Security for Manufacturing #1. Powered by cutting-edge AI, this platform delivers maintenance scheduling like never before.
          </p>
