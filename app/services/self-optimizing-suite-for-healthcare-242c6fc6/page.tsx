...
export const metadata: Metadata = {
  title: 'Self-Optimizing Suite for Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Self-Optimizing Suite for Healthcare leverages advanced machine learning to deliver sentiment analy',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Suite for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Self-Optimizing Suite for Healthcare leverages advanced machine learning to deliver sentiment analysis at scale.
          </p>
