...
export const metadata: Metadata = {
  ...
  description: 'Automates data governance with compliance checking, lineage tracking, and policy enforcement.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-data-governance-50444523',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automates data governance with compliance checking, lineage tracking, and policy enforcement.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Governance automation</li>
