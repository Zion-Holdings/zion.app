...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'AI Warehouse Robotics Platform', 'description': 'Orchestrate autonomous mobile robots (AMRs) for warehouse operations. Pick-and-place, inventory counting, and goods-to-person fulfillment optimization.', 'serviceType': 'logistics-tech', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'Logistics'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'AI Warehouse Robotics Platform Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$2,999/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$8,999/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': 'Custom', 'priceCurrency': 'USD'}]}} />
    <JsonLd data={'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'AMR fleet orchestration', 'acceptedAnswer': {'@type': 'Answer', 'text': 'AMR fleet orchestration'}}, {'@type': 'Question', 'name': 'Pick path optimization', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Pick path optimization'}}, {'@type': 'Question', 'name': 'Inventory counting robots', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Inventory counting robots'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Increase picking efficiency by 3x; Reduce labor costs by 40%; Improve inventory accuracy to 99.9%'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} />
