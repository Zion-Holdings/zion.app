...
export const metadata: Metadata = {
  title: 'Intelligent Performance for Construction',
  description: 'Enhance your construction business with Intelligent Performance for Construction. Our solution provides container orchestration with enterprise-grade reliabilit',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-performance-for-construction-ac63f891',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Performance for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Intelligent Performance for Construction. Our solution provides container orchestration with enterprise-grade reliability and security.
          </p>
