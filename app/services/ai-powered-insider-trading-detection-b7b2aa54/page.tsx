...
export const metadata: Metadata = {
  title: 'AI-Powered Insider Trading Detection',
  description: 'Detects insider trading patterns using communication and transaction analysis.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-insider-trading-detection-b7b2aa54',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Detects insider trading patterns using communication and transaction analysis.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Trading analysis</li>
          <li className="text-gray-300">Communication analysis</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">95% detection</li>
