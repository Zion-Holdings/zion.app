...
export const metadata: Metadata = {
  title: 'AI/IT Automation Suite - Transportation',
  description: 'Next-generation transportation solution: AI/IT Automation Suite - Transportation. Combines financial planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-automation-suite-transportation-b84598d6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Automation Suite - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation transportation solution: AI/IT Automation Suite - Transportation. Combines financial planning with adaptive intelligence for optimal results.
          </p>
