...
export const metadata: Metadata = {
  title: 'Predictive intelligent-insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive intelligent-insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Predictive intelligent-insurance. Our solution provides project portfolio with enterprise-grade reliability and security.
          </p>
