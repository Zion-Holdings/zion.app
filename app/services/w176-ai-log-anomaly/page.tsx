...
export const metadata = {
  ...
  description: "AI-powered log analysis and anomaly detection: parse any log format, detect anomalies, correlate across services, and reduce noise. Find the needle in the log h",
  alternates: {
