...
export const metadata: Metadata = {
  ...
  keywords: 'Auto-parse any log format (syslog, JSON, custom), Anomaly detection with learning baseline, Cross-service log correlation, Smart deduplication and grouping, Root cause hint generation, Log-based KPI dashboards, Integration with ELK, Splunk, Datadog, Loki, ai, DevOps, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Log Anomaly Detection</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered log analysis and anomaly detection: parse any log format, detect anomalies, correlate across services, and reduce noise. Find the needle in the log haystack.</p>
        ...
        <li class="text-slate-300">Auto-parse any log format (syslog, JSON, custom)</li>
        <li class="text-slate-300">Anomaly detection with learning baseline</li>
        <li class="text-slate-300">Cross-service log correlation</li>
        <li class="text-slate-300">Smart deduplication and grouping</li>
        <li class="text-slate-300">Root cause hint generation</li>
        <li class="text-slate-300">Log-based KPI dashboards</li>
        <li class="text-slate-300">Integration with ELK, Splunk, Datadog, Loki</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Detect anomalies invisible to threshold alerts</li>
        <li class="text-slate-300">Cross-correlation links related events</li>
        <li class="text-slate-300">Smart dedup reduces alert noise by 90%</li>
        <li class="text-slate-300">Root cause hints speed investigation</li>
      </ul>
        </div>
