...
export const metadata: Metadata = {
  title: 'Smart Insights Platform - Media',
  description: 'The future of media is here with Smart Insights Platform - Media. Powered by cutting-edge AI, this platform delivers brand sentiment like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-insights-platform-media-c94d44a1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Insights Platform - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of media is here with Smart Insights Platform - Media. Powered by cutting-edge AI, this platform delivers brand sentiment like never before.
          </p>
