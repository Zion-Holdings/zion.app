...
export const metadata: Metadata = {
  title: 'Intelligent Security for Agriculture',
  description: 'Transform your agriculture operations with our Intelligent Security for Agriculture. This AI-driven solution automates data processing with unprecedented accura',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-security-for-agriculture-1bd1fa9e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Security for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Intelligent Security for Agriculture. This AI-driven solution automates data processing with unprecedented accuracy and efficiency.
          </p>
