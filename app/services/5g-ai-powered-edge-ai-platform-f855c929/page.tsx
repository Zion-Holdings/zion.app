...
export const metadata: Metadata = {
  title: '5G AI-Powered Edge AI Platform',
  description: 'AI-powered 5g solution for iot. Deploys and manages AI models at the edge with automatic optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/5g-ai-powered-edge-ai-platform-f855c929',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            5G AI-Powered Edge AI Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered 5g solution for iot. Deploys and manages AI models at the edge with automatic optimization.
          </p>
