...
export const metadata: Metadata = {
  ...
  description: 'The future of finance is here with AI Customer Service - Finance Edition #1. Powered by cutting-edge AI, this platform delivers process automation like never be',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of finance is here with AI Customer Service - Finance Edition #1. Powered by cutting-edge AI, this platform delivers process automation like never before.
          </p>
