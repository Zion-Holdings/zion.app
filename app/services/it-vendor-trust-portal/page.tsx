...
export const metadata: Metadata = {
  ...
  keywords: 'Security and compliance scorecard, Financial health monitoring, Contract expiry alerting, Periodic self-assessment workflow, Task action feed per vendor, it, Healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Vendor Risk &amp; Trust Portal</h1>
        <p className="text-lg text-slate-300 mb-8">Continuous vendor monitoring with security scorecards, financial health tracking, contract expiry alerts, and automated periodic vendor reassessments.</p>
        ...
        <li class="text-slate-300">Security and compliance scorecard</li>
        <li class="text-slate-300">Financial health monitoring</li>
        <li class="text-slate-300">Contract expiry alerting</li>
        <li class="text-slate-300">Periodic self-assessment workflow</li>
        <li class="text-slate-300">Task action feed per vendor</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with it vendor risk &amp; trust portal</li>
