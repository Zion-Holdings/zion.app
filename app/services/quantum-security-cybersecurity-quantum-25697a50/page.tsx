...
export const metadata: Metadata = {
  title: 'Quantum Security - Cybersecurity Quantum',
  description: 'Quantum leap forward for cybersecurity: Quantum Security - Cybersecurity Quantum. Uses quantum-inspired algorithms to deliver record extraction at exponential s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Security - Cybersecurity Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for cybersecurity: Quantum Security - Cybersecurity Quantum. Uses quantum-inspired algorithms to deliver record extraction at exponential speed.
          </p>
