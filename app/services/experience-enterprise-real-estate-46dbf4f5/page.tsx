...
export const metadata: Metadata = {
  title: 'Experience Enterprise - Real-Estate',
  description: 'Enhance your real-estate business with Experience Enterprise - Real-Estate. Our solution provides time tracking with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/experience-enterprise-real-estate-46dbf4f5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Experience Enterprise - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your real-estate business with Experience Enterprise - Real-Estate. Our solution provides time tracking with enterprise-grade reliability and security.
          </p>
