...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize transportation through intelligent automation. Our Smart Sales for Transportation leverages advanced machine learning to deliver workflow manageme',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-sales-for-transportation-84cd3fee',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize transportation through intelligent automation. Our Smart Sales for Transportation leverages advanced machine learning to deliver workflow management at scale.
          </p>
