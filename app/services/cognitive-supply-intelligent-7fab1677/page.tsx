...
export const metadata: Metadata = {
  title: 'Cognitive Supply Intelligent',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Supply Intelligent
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Cognitive Supply Intelligent. Powered by cutting-edge AI, this platform delivers performance monitoring like never before.
          </p>
