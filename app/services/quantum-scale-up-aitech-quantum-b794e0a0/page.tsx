...
export const metadata: Metadata = {
  title: 'Quantum Scale-up - AITECH Quantum',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Scale-up - AITECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in aitech with Quantum Scale-up - AITECH Quantum. This AI-powered platform transforms investor relations into a competitive advantage.
          </p>
