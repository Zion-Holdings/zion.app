...
export const metadata: Metadata = {
  title: 'Smart Energy Suite - Enterprise',
  description: 'Next-generation enterprise solution: Smart Energy Suite - Enterprise. Combines brand sentiment with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-energy-suite-enterprise-1884dfae',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Energy Suite - Enterprise
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation enterprise solution: Smart Energy Suite - Enterprise. Combines brand sentiment with adaptive intelligence for optimal results.
          </p>
