...
export const metadata: Metadata = {
  title: 'Neural System for Sports',
  description: 'Drive innovation in sports with Neural System for Sports. This AI-powered platform transforms net promoter score into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-system-for-sports-02234454',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural System for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in sports with Neural System for Sports. This AI-powered platform transforms net promoter score into a competitive advantage.
          </p>
