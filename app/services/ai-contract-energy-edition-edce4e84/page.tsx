...
export const metadata: Metadata = {
  title: 'AI Contract - Energy Edition',
  description: 'Transform energy with AI Contract - Energy Edition - the intelligent automation platform that learns, adapts, and delivers 10x results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-contract-energy-edition-edce4e84',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Contract - Energy Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform energy with AI Contract - Energy Edition - the intelligent automation platform that learns, adapts, and delivers 10x results.
          </p>
