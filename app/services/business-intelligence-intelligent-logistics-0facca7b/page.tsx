...
export const metadata: Metadata = {
  title: 'Business Intelligence Intelligent - Logistics',
  description: 'Drive innovation in logistics with Business Intelligence Intelligent - Logistics. This AI-powered platform transforms training optimization into a competitive a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/business-intelligence-intelligent-logistics-0facca7b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Business Intelligence Intelligent - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with Business Intelligence Intelligent - Logistics. This AI-powered platform transforms training optimization into a competitive advantage.
          </p>
