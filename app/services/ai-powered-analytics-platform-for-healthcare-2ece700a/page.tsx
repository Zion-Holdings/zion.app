...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-analytics-platform-for-healthcare-2ece700a',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">35% reduction in operational costs</li>
          <li className="text-purple-300">Process 85% faster with automation</li>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$345</p>
          <ul className="space-y-2 mb-4">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$764</p>
          <ul className="space-y-2 mb-4">
