...
export const metadata: Metadata = {
  title: 'Autonomous System for Healthcare',
  description: 'Transform your healthcare operations with our Autonomous System for Healthcare. This AI-driven solution automates decision support with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-system-for-healthcare-e29fb7b9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous System for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Autonomous System for Healthcare. This AI-driven solution automates decision support with unprecedented accuracy and efficiency.
          </p>
