...
export const metadata: Metadata = {
  title: 'Intelligent DevOps Pipeline Edge Computing (It)',
  description: 'Intelligent DevOps Pipeline Edge Computing (It) is an AI-powered it solution that transforms how businesses operate through intelligent automation and real-time',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/e5e02480f9a6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent DevOps Pipeline Edge Computing (It)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Intelligent DevOps Pipeline Edge Computing (It) is an AI-powered it solution that transforms how businesses operate through intelligent automation and real-time analytics.
...
Ansible, Kubernetes, AWS, MongoDB, Hadoop, Azure
