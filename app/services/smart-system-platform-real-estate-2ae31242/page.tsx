...
export const metadata: Metadata = {
  title: 'Smart System Platform - Real-Estate',
  description: 'Next-generation real-estate solution: Smart System Platform - Real-Estate. Combines container orchestration with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-system-platform-real-estate-2ae31242',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart System Platform - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation real-estate solution: Smart System Platform - Real-Estate. Combines container orchestration with adaptive intelligence for optimal results.
          </p>
