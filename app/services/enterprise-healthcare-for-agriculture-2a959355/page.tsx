...
export const metadata: Metadata = {
  title: 'Enterprise Healthcare for Agriculture',
  description: 'Next-generation agriculture solution: Enterprise Healthcare for Agriculture. Combines sales process optimization with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-healthcare-for-agriculture-2a959355',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Healthcare for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agriculture solution: Enterprise Healthcare for Agriculture. Combines sales process optimization with adaptive intelligence for optimal results.
          </p>
