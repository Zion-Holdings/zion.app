...
export const metadata: Metadata = {
  title: 'Automated risk-agriculture',
  description: 'Optimize your agriculture workflows with Automated risk-agriculture. This intelligent platform delivers compliance monitoring through advanced automation and AI',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-risk-agriculture-8c198915',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated risk-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your agriculture workflows with Automated risk-agriculture. This intelligent platform delivers compliance monitoring through advanced automation and AI.
          </p>
