...
export const metadata: Metadata = {
  title: 'Predictive Healthcare Engine - Construction',
  description: 'Revolutionize construction through intelligent automation. Our Predictive Healthcare Engine - Construction leverages advanced machine learning to deliver user p',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-healthcare-engine-construction-8fac46d5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Healthcare Engine - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Predictive Healthcare Engine - Construction leverages advanced machine learning to deliver user provisioning at scale.
          </p>
