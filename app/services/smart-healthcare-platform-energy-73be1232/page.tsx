...
export const metadata: Metadata = {
  title: 'Smart Healthcare Platform - Energy',
  description: 'Drive innovation in energy with Smart Healthcare Platform - Energy. This AI-powered platform transforms payroll processing into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-healthcare-platform-energy-73be1232',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Healthcare Platform - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Smart Healthcare Platform - Energy. This AI-powered platform transforms payroll processing into a competitive advantage.
          </p>
