...
export const metadata: Metadata = {
  title: 'AI/IT Quality Suite - CLEANTECH',
  description: 'Drive innovation in cleantech with AI/IT Quality Suite - CLEANTECH. This AI-powered platform transforms onboarding automation into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-quality-suite-cleantech-12682e17',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Quality Suite - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in cleantech with AI/IT Quality Suite - CLEANTECH. This AI-powered platform transforms onboarding automation into a competitive advantage.
          </p>
