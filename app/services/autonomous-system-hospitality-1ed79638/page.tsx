...
export const metadata: Metadata = {
  title: 'Autonomous system-hospitality',
  description: 'Next-generation hospitality solution: Autonomous system-hospitality. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-system-hospitality-1ed79638',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous system-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Autonomous system-hospitality. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
