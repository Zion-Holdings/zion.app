...
export const metadata: Metadata = {
  title: 'Insights Neural - REGTECH',
  description: 'Hyper-accelerated regtech solution: Insights Neural - REGTECH. Combines hyperautomation with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/insights-neural-regtech-f48898eb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Insights Neural - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated regtech solution: Insights Neural - REGTECH. Combines hyperautomation with next-gen AI for maximum velocity.
          </p>
