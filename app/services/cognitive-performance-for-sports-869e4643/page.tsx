...
export const metadata: Metadata = {
  title: 'Cognitive Performance for Sports',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Performance for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your sports workflows with Cognitive Performance for Sports. This intelligent platform delivers churn prediction through advanced automation and AI.
          </p>
