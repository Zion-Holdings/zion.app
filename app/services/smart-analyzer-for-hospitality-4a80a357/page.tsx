...
export const metadata: Metadata = {
  title: 'Smart Analyzer for Hospitality',
  description: 'The future of hospitality is here with Smart Analyzer for Hospitality. Powered by cutting-edge AI, this platform delivers security monitoring like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-analyzer-for-hospitality-4a80a357',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Analyzer for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Smart Analyzer for Hospitality. Powered by cutting-edge AI, this platform delivers security monitoring like never before.
          </p>
