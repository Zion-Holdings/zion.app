...
export const metadata: Metadata = {
  title: 'AI Risk - Transportation Edition',
  description: 'The future of transportation is here with AI Risk - Transportation Edition. Powered by cutting-edge AI, this platform delivers audit automation like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-risk-transportation-edition-8f0f4559',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Risk - Transportation Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with AI Risk - Transportation Edition. Powered by cutting-edge AI, this platform delivers audit automation like never before.
          </p>
