...
export const metadata: Metadata = {
  title: 'Autonomous SMB System - Healthcare',
  description: 'Enhance your healthcare business with Autonomous SMB System - Healthcare. Our solution provides dashboard automation with enterprise-grade reliability and secur',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous SMB System - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with Autonomous SMB System - Healthcare. Our solution provides dashboard automation with enterprise-grade reliability and security.
          </p>
