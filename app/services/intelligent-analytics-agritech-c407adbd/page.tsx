...
export const metadata: Metadata = {
  title: 'Intelligent analytics-agritech',
  description: 'The future of agritech is here with Intelligent analytics-agritech. Powered by cutting-edge AI, this platform delivers financial risk management like never befo',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent analytics-agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agritech is here with Intelligent analytics-agritech. Powered by cutting-edge AI, this platform delivers financial risk management like never before.
          </p>
