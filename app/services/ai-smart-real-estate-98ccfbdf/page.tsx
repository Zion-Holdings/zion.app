...
export const metadata: Metadata = {
  title: 'AI Smart - Real-Estate',
  description: 'Transform your real-estate operations with our AI Smart - Real-Estate. This AI-driven solution provides intelligent automation with unprecedented accuracy and e',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-smart-real-estate-98ccfbdf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our AI Smart - Real-Estate. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
