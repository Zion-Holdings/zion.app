...
export const metadata: Metadata = {
  title: 'Cognitive Platform Solution - MARTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Platform Solution - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated martech solution: Cognitive Platform Solution - MARTECH. Combines revenue intelligence with next-gen AI for maximum velocity.
          </p>
