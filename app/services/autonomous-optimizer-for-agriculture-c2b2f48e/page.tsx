...
export const metadata: Metadata = {
  title: 'Autonomous Optimizer for Agriculture',
  description: 'The future of agriculture is here with Autonomous Optimizer for Agriculture. Powered by cutting-edge AI, this platform delivers image recognition like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-optimizer-for-agriculture-c2b2f48e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Optimizer for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Autonomous Optimizer for Agriculture. Powered by cutting-edge AI, this platform delivers image recognition like never before.
          </p>
