...
export const metadata: Metadata = {
  title: 'AI/IT Startup Suite - HEALTHTECH',
  description: 'Unlock unprecedented growth with AI/IT Startup Suite - HEALTHTECH. This autonomous system provides background checks with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-startup-suite-healthtech-9e9041e0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Startup Suite - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with AI/IT Startup Suite - HEALTHTECH. This autonomous system provides background checks with zero manual intervention needed.
          </p>
