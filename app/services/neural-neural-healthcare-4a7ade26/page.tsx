...
export const metadata: Metadata = {
  title: 'Neural neural-healthcare',
  description: 'Next-generation healthcare solution: Neural neural-healthcare. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-neural-healthcare-4a7ade26',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural neural-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Neural neural-healthcare. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
