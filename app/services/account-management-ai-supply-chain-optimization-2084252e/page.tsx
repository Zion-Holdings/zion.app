...
export const metadata: Metadata = {
  title: "Account Management AI Supply Chain Optimization - AI-Powered Insurance Solution",
  description: "account management solution for insurance industry. Optimizes supply chain operations using predictive analytics, demand forecasting, and route optimization.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/account-management-ai-supply-chain-optimization-2084252e",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Account Management AI Supply Chain Optimization - AI-Powered Insurance Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          account management solution for insurance industry. Optimizes supply chain operations using predictive analytics, demand forecasting, and route optimization.
        </p>
