...
export const metadata: Metadata = {
  title: 'AI-Powered Security for Energy',
  description: 'Next-generation energy solution: AI-Powered Security for Energy. Combines process automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-security-for-energy-5807eae3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Security for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: AI-Powered Security for Energy. Combines process automation with adaptive intelligence for optimal results.
          </p>
