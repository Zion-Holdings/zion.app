...
export const metadata: Metadata = {
  title: 'Quantum Engine - MARTECH Quantum',
  description: 'Drive innovation in martech with Quantum Engine - MARTECH Quantum. This AI-powered platform transforms customer intelligence into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-engine-martech-quantum-905cf93d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Engine - MARTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in martech with Quantum Engine - MARTECH Quantum. This AI-powered platform transforms customer intelligence into a competitive advantage.
          </p>
