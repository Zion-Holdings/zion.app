...
export const metadata = {
  ...
  description: 'End-to-end chaos engineering for kubernetes: proactively test resilience with litmus or chaos mesh services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/chaos-engineering-kubernetes-proactively-test-resilience-litmus-chaos-mesh-46/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">Chaos Engineering for Kubernetes: Proactively Test Resilience with Litmus or Chaos Mesh</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end chaos engineering for kubernetes: proactively test resilience with litmus or chaos mesh services: assessment, deployment, and managed operations.
        </p>
