...
export const metadata: Metadata = {
  ...
  keywords: 'Automated data profiling, Rule-based validation, Anomaly detection, Data quality scoring, Remediation workflows, Integration with data warehouses, Custom quality dimensions, Quality trend dashboards, data, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Data Quality Management Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Automated data quality monitoring and remediation. Rule-based validation, anomaly detection, and data profiling for trustworthy analytics and AI.</p>
        ...
        <li class="text-slate-300">Automated data profiling</li>
        <li class="text-slate-300">Rule-based validation</li>
        <li class="text-slate-300">Anomaly detection</li>
        <li class="text-slate-300">Data quality scoring</li>
        <li class="text-slate-300">Remediation workflows</li>
        <li class="text-slate-300">Integration with data warehouses</li>
        <li class="text-slate-300">Custom quality dimensions</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Ensure data trustworthiness</li>
        <li class="text-slate-300">Catch quality issues early</li>
        <li class="text-slate-300">Automate data monitoring</li>
        <li class="text-slate-300">Improve analytics accuracy</li>
      </ul>
        </div>
