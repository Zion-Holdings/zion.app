...
export const metadata: Metadata = {
  title: 'Enterprise Manager Platform - MARTECH',
  description: 'Drive innovation in martech with Enterprise Manager Platform - MARTECH. This AI-powered platform transforms network optimization into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-manager-platform-martech-0a786021',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Manager Platform - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in martech with Enterprise Manager Platform - MARTECH. This AI-powered platform transforms network optimization into a competitive advantage.
          </p>
