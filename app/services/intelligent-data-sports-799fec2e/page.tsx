...
export const metadata: Metadata = {
  title: 'Intelligent data-sports',
  description: 'Revolutionize sports through intelligent automation. Our Intelligent data-sports leverages advanced machine learning to deliver pipeline management at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-data-sports-799fec2e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent data-sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Intelligent data-sports leverages advanced machine learning to deliver pipeline management at scale.
          </p>
