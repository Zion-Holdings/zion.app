...
export const metadata: Metadata = {
  title: 'Cognitive Data Solution - Automotive',
  description: 'Drive innovation in automotive with Cognitive Data Solution - Automotive. This AI-powered platform transforms survey automation into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-data-solution-automotive-73c6d1a3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Data Solution - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in automotive with Cognitive Data Solution - Automotive. This AI-powered platform transforms survey automation into a competitive advantage.
          </p>
