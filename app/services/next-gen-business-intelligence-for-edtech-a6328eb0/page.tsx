...
export const metadata: Metadata = {
  title: 'Next-Gen Business Intelligence for EDTECH',
  description: 'Unlock unprecedented growth with Next-Gen Business Intelligence for EDTECH. This autonomous system provides manufacturing quality control with zero manual inter',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Business Intelligence for EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Next-Gen Business Intelligence for EDTECH. This autonomous system provides manufacturing quality control with zero manual intervention needed.
          </p>
