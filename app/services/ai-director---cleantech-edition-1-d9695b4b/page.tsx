...
export const metadata: Metadata = {
  title: 'AI Director - Cleantech Edition #1',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Director - Cleantech Edition #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of cleantech is here with AI Director - Cleantech Edition #1. Powered by cutting-edge AI, this platform delivers predictive analytics like never before.
          </p>
