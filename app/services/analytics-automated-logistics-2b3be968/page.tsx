...
export const metadata: Metadata = {
  title: 'Analytics Automated - Logistics',
  description: 'Enhance your logistics business with Analytics Automated - Logistics. Our solution provides healthcare data analytics with enterprise-grade reliability and secu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/analytics-automated-logistics-2b3be968',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Analytics Automated - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with Analytics Automated - Logistics. Our solution provides healthcare data analytics with enterprise-grade reliability and security.
          </p>
