...
export const metadata: Metadata = {
  title: 'AI-Powered process mining-finance',
  description: 'Drive innovation in finance with AI-Powered process mining-finance. This AI-powered platform transforms quality control into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-process-mining-finance-c491aecf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered process mining-finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in finance with AI-Powered process mining-finance. This AI-powered platform transforms quality control into a competitive advantage.
          </p>
