...
export const metadata: Metadata = {
  title: 'Intelligent Performance Support',
  description: 'Hyper-accelerated real-estate solution: Intelligent Performance Support. Combines contract analysis with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-performance-support-a668e935',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated real-estate solution: Intelligent Performance Support. Combines contract analysis with next-gen AI for maximum velocity.
          </p>
