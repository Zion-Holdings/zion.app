...
export const metadata: Metadata = {
  title: 'Quantum Process Mining - EDTECH Quantum',
  description: 'The future of edtech is here with Quantum Process Mining - EDTECH Quantum. Powered by cutting-edge AI, this platform delivers anomaly detection like never befor',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Process Mining - EDTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of edtech is here with Quantum Process Mining - EDTECH Quantum. Powered by cutting-edge AI, this platform delivers anomaly detection like never before.
          </p>
