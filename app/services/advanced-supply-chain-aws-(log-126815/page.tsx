...
export const metadata: Metadata = {
  title: 'Advanced Supply Chain AWS (Logistics)',
  description: 'Advanced Supply Chain AWS (Logistics) is an AI-powered logistics solution that transforms how businesses operate through intelligent automation and real-time an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/advanced-supply-chain-aws-(log-126815',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Advanced Supply Chain AWS (Logistics)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Advanced Supply Chain AWS (Logistics) is an AI-powered logistics solution that transforms how businesses operate through intelligent automation and real-time analytics.
...
Computer Vision, Edge Computing, Kafka, Python, Airflow, Go
