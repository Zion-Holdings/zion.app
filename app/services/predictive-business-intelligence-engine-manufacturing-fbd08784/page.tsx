...
export const metadata: Metadata = {
  title: 'Predictive Business Intelligence Engine - Manufacturing',
  description: 'Optimize your manufacturing workflows with Predictive Business Intelligence Engine - Manufacturing. This intelligent platform delivers ml model training through',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Business Intelligence Engine - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your manufacturing workflows with Predictive Business Intelligence Engine - Manufacturing. This intelligent platform delivers ml model training through advanced automation and AI.
          </p>
