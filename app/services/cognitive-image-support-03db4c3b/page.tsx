...
export const metadata: Metadata = {
  title: 'Cognitive Image Support',
  description: 'Transform your media operations with our Cognitive Image Support. This AI-driven solution automates regulatory tracking with unprecedented accuracy and efficien',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-image-support-03db4c3b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Image Support
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your media operations with our Cognitive Image Support. This AI-driven solution automates regulatory tracking with unprecedented accuracy and efficiency.
          </p>
