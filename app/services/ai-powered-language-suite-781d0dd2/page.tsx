...
export const metadata: Metadata = {
  title: 'AI-Powered Language Suite',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize edge through intelligent automation. Our AI-Powered Language Suite leverages advanced machine learning to deliver security monitoring at scale.
          </p>
