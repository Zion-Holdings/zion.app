...
export const metadata: Metadata = {
  title: 'Customer Journey Intelligent Document Processing AI',
  description: 'customer journey solution for private equity industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automat',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/customer-journey-intelligent-document-processing-ai-07f92193',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Customer Journey Intelligent Document Processing AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            customer journey solution for private equity industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.
          </p>
