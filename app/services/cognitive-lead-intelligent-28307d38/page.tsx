...
export const metadata: Metadata = {
  title: 'Cognitive Lead Intelligent',
  description: 'Transform your technology operations with our Cognitive Lead Intelligent. This AI-driven solution automates manufacturing quality control with unprecedented acc',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Lead Intelligent
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your technology operations with our Cognitive Lead Intelligent. This AI-driven solution automates manufacturing quality control with unprecedented accuracy and efficiency.
          </p>
