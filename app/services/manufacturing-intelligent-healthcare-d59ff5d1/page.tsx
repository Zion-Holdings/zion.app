...
export const metadata: Metadata = {
  title: 'Manufacturing Intelligent - Healthcare',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manufacturing Intelligent - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated healthcare solution: Manufacturing Intelligent - Healthcare. Combines email automation with next-gen AI for maximum velocity.
          </p>
