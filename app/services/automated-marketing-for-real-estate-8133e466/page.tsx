...
export const metadata: Metadata = {
  title: 'Automated Marketing for Real-Estate',
  description: 'Revolutionize real-estate through intelligent automation. Our Automated Marketing for Real-Estate leverages advanced machine learning to deliver scenario planni',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our Automated Marketing for Real-Estate leverages advanced machine learning to deliver scenario planning at scale.
          </p>
