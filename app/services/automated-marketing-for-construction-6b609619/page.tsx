...
export const metadata: Metadata = {
  title: 'Automated Marketing for Construction',
  description: 'Next-generation construction solution: Automated Marketing for Construction. Combines content generation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-marketing-for-construction-6b609619',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Marketing for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Automated Marketing for Construction. Combines content generation with adaptive intelligence for optimal results.
          </p>
