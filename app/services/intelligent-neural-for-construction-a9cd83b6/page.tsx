...
export const metadata: Metadata = {
  title: 'Intelligent Neural for Construction',
  description: 'Drive innovation in construction with Intelligent Neural for Construction. This AI-powered platform transforms quality control into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-neural-for-construction-a9cd83b6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Neural for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Intelligent Neural for Construction. This AI-powered platform transforms quality control into a competitive advantage.
          </p>
