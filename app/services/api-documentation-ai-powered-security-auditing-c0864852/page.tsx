...
export const metadata: Metadata = {
  title: 'API Documentation AI-Powered Security Auditing',
  description: 'AI-powered api documentation solution for security. Continuous security auditing with automated compliance reporting.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/api-documentation-ai-powered-security-auditing-c0864852',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            API Documentation AI-Powered Security Auditing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered api documentation solution for security. Continuous security auditing with automated compliance reporting.
          </p>
