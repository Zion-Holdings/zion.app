...
export const metadata: Metadata = {
  ...
  description: 'The future of agriculture is here with Autonomous Processor System - Agriculture. Powered by cutting-edge AI, this platform delivers content generation like nev',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Autonomous Processor System - Agriculture. Powered by cutting-edge AI, this platform delivers content generation like never before.
          </p>
