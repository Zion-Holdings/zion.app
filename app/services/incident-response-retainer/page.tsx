...
export const metadata: Metadata = {
  ...
  keywords: '24/7 on-call IR team (SANS-certified), Forensic evidence collection & chain of custody, Containment & eradication planning, Post-incident root cause analysis (RCA), Executive communication & regulatory reporting, it, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Incident Response Retainer (IR)</h1>
        <p className="text-lg text-slate-300 mb-8">24/7 on-call incident response for security breaches, ransomware, and major outages: forensic analysis, containment, eradication, and recovery.</p>
        ...
        <li class="text-slate-300">24/7 on-call IR team (SANS-certified)</li>
        <li class="text-slate-300">Forensic evidence collection &amp; chain of custody</li>
        <li class="text-slate-300">Containment &amp; eradication planning</li>
        <li class="text-slate-300">Post-incident root cause analysis (RCA)</li>
        <li class="text-slate-300">Executive communication &amp; regulatory reporting</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with incident response retainer (ir)</li>
