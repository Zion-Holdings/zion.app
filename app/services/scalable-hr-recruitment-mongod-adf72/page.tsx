...
export const metadata: Metadata = {
  title: 'Scalable HR Recruitment MongoDB (Analytics)',
  description: 'Scalable HR Recruitment MongoDB (Analytics) is an AI-powered analytics solution that transforms how businesses operate through intelligent automation and real-t',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/scalable-hr-recruitment-mongod-adf72',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Scalable HR Recruitment MongoDB (Analytics)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Scalable HR Recruitment MongoDB (Analytics) is an AI-powered analytics solution that transforms how businesses operate through intelligent automation and real-time analytics.
