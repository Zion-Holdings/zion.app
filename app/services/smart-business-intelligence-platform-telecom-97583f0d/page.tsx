...
export const metadata: Metadata = {
  title: 'Smart Business Intelligence Platform - Telecom',
  description: 'Future-proof your telecom with Smart Business Intelligence Platform - Telecom. Our autonomous solution handles business intelligence end-to-end without human in',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-business-intelligence-platform-telecom-97583f0d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Business Intelligence Platform - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your telecom with Smart Business Intelligence Platform - Telecom. Our autonomous solution handles business intelligence end-to-end without human intervention.
          </p>
