...
export const metadata: Metadata = {
  ...
  description: 'Optimize your hospitality workflows with Autonomous Processor System - Hospitality. This intelligent platform delivers document processing through advanced auto',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Autonomous Processor System - Hospitality. This intelligent platform delivers document processing through advanced automation and AI.
          </p>
