...
export const metadata: Metadata = {
  title: 'Intelligent Process for Insurance',
  description: 'Next-generation insurance solution: Intelligent Process for Insurance. Combines churn prediction with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-process-for-insurance-343b0d26',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Process for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Intelligent Process for Insurance. Combines churn prediction with adaptive intelligence for optimal results.
          </p>
