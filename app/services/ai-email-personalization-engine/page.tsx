...
export const metadata: Metadata = {
  ...
  keywords: 'Dynamic content insertion, AI subject line optimization, Send-time optimization, Automated A/B testing, Audience segmentation AI, Integration with Mailchimp, Klaviyo, HubSpot, Personalization analytics, Spam score checking, ai, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Email Personalization Engine</h1>
        <p className="text-lg text-slate-300 mb-8">Hyper-personalize marketing emails with AI. Dynamic content, subject line optimization, send-time optimization, and automated A/B testing for higher open and conversion rates.</p>
        ...
        <li class="text-slate-300">Dynamic content insertion</li>
        <li class="text-slate-300">AI subject line optimization</li>
        <li class="text-slate-300">Send-time optimization</li>
        <li class="text-slate-300">Automated A/B testing</li>
        <li class="text-slate-300">Audience segmentation AI</li>
        <li class="text-slate-300">Integration with Mailchimp, Klaviyo, HubSpot</li>
        <li class="text-slate-300">Personalization analytics</li>
        <li class="text-slate-300">Spam score checking</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Increase open rates by 35%</li>
        <li class="text-slate-300">Improve click-through rates</li>
        <li class="text-slate-300">Automate email optimization</li>
        <li class="text-slate-300">Scale personalization</li>
      </ul>
        </div>
