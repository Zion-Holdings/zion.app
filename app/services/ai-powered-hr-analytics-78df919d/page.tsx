...
export const metadata: Metadata = {
  title: "AI-Powered HR Analytics - AI-Powered HR Solution",
  description: "Predictive analytics for employee performance, retention, and recruitment.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-hr-analytics-78df919d",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered HR Analytics - AI-Powered HR Solution
        </h1>
