...
export const metadata: Metadata = {
  title: 'AI-Powered risk-finance',
  description: 'Transform your finance operations with our AI-Powered risk-finance. This AI-driven solution automates network optimization with unprecedented accuracy and effic',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-risk-finance-4d8eda61',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered risk-finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our AI-Powered risk-finance. This AI-driven solution automates network optimization with unprecedented accuracy and efficiency.
          </p>
