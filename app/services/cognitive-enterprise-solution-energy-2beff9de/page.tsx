...
export const metadata: Metadata = {
  title: 'Cognitive Enterprise Solution - Energy',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Enterprise Solution - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your energy workflows with Cognitive Enterprise Solution - Energy. This intelligent platform delivers sentiment analysis through advanced automation and AI.
          </p>
