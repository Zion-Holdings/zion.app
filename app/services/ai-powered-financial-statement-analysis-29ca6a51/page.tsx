...
export const metadata: Metadata = {
  ...
  description: 'Automated financial statement analysis with anomaly detection and insights.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-financial-statement-analysis-29ca6a51',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automated financial statement analysis with anomaly detection and insights.
          </p>
