...
export const metadata: Metadata = {
  title: 'AI-Powered Claims Manager',
  description: 'Revolutionize real-estate through intelligent automation. Our AI-Powered Claims Manager leverages advanced machine learning to deliver customer journey mapping ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-claims-manager-a63cb682',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Claims Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our AI-Powered Claims Manager leverages advanced machine learning to deliver customer journey mapping at scale.
          </p>
