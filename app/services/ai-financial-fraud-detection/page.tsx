      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Real-time transaction scoring & blocking</li>
            <li className="text-purple-300">✓ Deep learning behavioral anomaly detection</li>
            <li className="text-purple-300">✓ Customer risk profiling with dynamic baselines</li>
            <li className="text-purple-300">✓ Automated case management with evidence bundling</li>
            <li className="text-purple-300">✓ False positive reduction with adaptive learning</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai financial fraud detection & prevention</li>
