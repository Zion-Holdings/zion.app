...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time transaction scoring & blocking, Deep learning behavioral anomaly detection, Customer risk profiling with dynamic baselines, Automated case management with evidence bundling, False positive reduction with adaptive learning, Regulatory reporting (BSA, AML, SAR) automation, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Real-time transaction monitoring with deep learning anomaly detection, customer behavior profiling, and automated case management for banking and fintech.</p>
        ...
        <li class="text-slate-300">Real-time transaction scoring &amp; blocking</li>
        <li class="text-slate-300">Deep learning behavioral anomaly detection</li>
        <li class="text-slate-300">Customer risk profiling with dynamic baselines</li>
        <li class="text-slate-300">Automated case management with evidence bundling</li>
        <li class="text-slate-300">False positive reduction with adaptive learning</li>
        <li class="text-slate-300">Regulatory reporting (BSA, AML, SAR) automation</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai financial fraud detection &amp; prevention</li>
