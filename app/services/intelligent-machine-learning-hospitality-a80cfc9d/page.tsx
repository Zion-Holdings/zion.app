...
export const metadata: Metadata = {
  title: 'Intelligent machine learning-hospitality',
  description: 'Transform your hospitality operations with our Intelligent machine learning-hospitality. This AI-driven solution provides intelligent automation with unpreceden',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-machine-learning-hospitality-a80cfc9d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent machine learning-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Intelligent machine learning-hospitality. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
