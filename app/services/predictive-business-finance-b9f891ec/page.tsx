...
export const metadata: Metadata = {
  title: 'Predictive Business Finance',
  description: 'Optimize your construction workflows with Predictive Business Finance. This intelligent platform delivers automation opportunity through advanced automation and',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Business Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Predictive Business Finance. This intelligent platform delivers automation opportunity through advanced automation and AI.
          </p>
