...
export const metadata: Metadata = {
  title: 'Intelligent Compliance for Agriculture',
  description: 'Drive innovation in agriculture with Intelligent Compliance for Agriculture. This AI-powered platform transforms quality control into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-compliance-for-agriculture-c9688caf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Compliance for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in agriculture with Intelligent Compliance for Agriculture. This AI-powered platform transforms quality control into a competitive advantage.
          </p>
