...
export const metadata: Metadata = {
  ...
  keywords: 'Granular permissions, Role hierarchies, Audit trails, SSO integration, Policy engine, Multi-tenant, SDK access, Compliance reporting, micro-saas, Security, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">RBAC as a Service</h1>
        <p className="text-lg text-slate-300 mb-8">Role-based access control platform with granular permissions, audit trails, and SSO integration.</p>
        ...
        <li class="text-slate-300">Granular permissions</li>
        <li class="text-slate-300">Role hierarchies</li>
        <li class="text-slate-300">Audit trails</li>
        <li class="text-slate-300">SSO integration</li>
        <li class="text-slate-300">Policy engine</li>
        <li class="text-slate-300">Multi-tenant</li>
        <li class="text-slate-300">SDK access</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Enterprise security</li>
        <li class="text-slate-300">Drop-in integration</li>
