...
export const metadata: Metadata = {
  title: "AI-Powered Master Data Sync - AI-Powered Integration Solution",
  description: "Automated master data synchronization across systems.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-master-data-sync-065cc3fd",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Master Data Sync - AI-Powered Integration Solution
        </h1>
