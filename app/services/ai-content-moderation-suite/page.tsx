...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time text, image & video classification, Multi-language + multi-script support, Custom policy rule engine per platform, Human-in-the-loop review queue, Audit log + takedown SFTP/webhook export, ai, E-Commerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Content Moderation Suite</h1>
        <p className="text-lg text-slate-300 mb-8">Platform-agnostic content moderation: real-time text/image/video classification, multi-language support, custom policy rules, human-in-the-loop review queues, and automated takedown workflows for platforms, marketplaces, and social apps.</p>
        ...
        <li class="text-slate-300">Real-time text, image &amp; video classification</li>
        <li class="text-slate-300">Multi-language + multi-script support</li>
        <li class="text-slate-300">Custom policy rule engine per platform</li>
        <li class="text-slate-300">Human-in-the-loop review queue</li>
        <li class="text-slate-300">Audit log + takedown SFTP/webhook export</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai content moderation suite</li>
