...
export const metadata: Metadata = {
  title: 'Intelligent compliance-energy',
  description: 'The future of energy is here with Intelligent compliance-energy. Powered by cutting-edge AI, this platform delivers brand sentiment like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-compliance-energy-ef7962f0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent compliance-energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Intelligent compliance-energy. Powered by cutting-edge AI, this platform delivers brand sentiment like never before.
          </p>
