...
export const metadata: Metadata = {
  title: 'Autonomous Intelligent System - Insurance',
  description: 'Enhance your insurance business with Autonomous Intelligent System - Insurance. Our solution provides sourcing optimization with enterprise-grade reliability an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Intelligent System - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Autonomous Intelligent System - Insurance. Our solution provides sourcing optimization with enterprise-grade reliability and security.
          </p>
