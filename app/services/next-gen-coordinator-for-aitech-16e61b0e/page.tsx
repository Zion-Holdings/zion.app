...
export const metadata = {
  ...
  description: "Transform your aitech operations with our Next-Gen Coordinator for AITECH. This AI-driven solution automates time tracking with unprecedented accuracy and effic",
  alternates: {
