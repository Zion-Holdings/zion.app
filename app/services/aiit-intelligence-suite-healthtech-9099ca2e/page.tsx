...
export const metadata: Metadata = {
  title: 'AI/IT Intelligence Suite - HEALTHTECH',
  description: 'Quantum leap forward for healthtech: AI/IT Intelligence Suite - HEALTHTECH. Uses quantum-inspired algorithms to deliver click automation at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-intelligence-suite-healthtech-9099ca2e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Intelligence Suite - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for healthtech: AI/IT Intelligence Suite - HEALTHTECH. Uses quantum-inspired algorithms to deliver click automation at exponential speed.
          </p>
