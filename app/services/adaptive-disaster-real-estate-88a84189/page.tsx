...
export const metadata: Metadata = {
  title: 'Adaptive Disaster Real Estate',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Disaster Real Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your real-estate business with Adaptive Disaster Real Estate. Our solution provides revenue forecasting with enterprise-grade reliability and security.
          </p>
