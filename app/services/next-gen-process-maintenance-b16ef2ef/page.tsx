...
export const metadata: Metadata = {
  title: 'Next-Gen Process Maintenance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Process Maintenance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform technology with Next-Gen Process Maintenance - the intelligent automation platform that learns, adapts, and delivers 10x results.
          </p>
