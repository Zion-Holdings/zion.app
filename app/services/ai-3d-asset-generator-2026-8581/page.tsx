...
export const metadata = {
  ...
  alternates: { canonical: '/services/ai-3d-asset-generator-2026-8581/' },

  openGraph: {
    title: 'AI 3D Asset Generator | Zion Tech Group',
    description: 'End-to-end ai 3d asset generator services: assessment, deployment, and managed operations.',
    url: 'https://ziontechgroup.com/services/ai-3d-asset-generator-2026-8581/',
...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "AI 3D Asset Generator | Zion Tech Group", description: "End-to-end ai 3d asset generator services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/ai-3d-asset-generator-2026-8581/"}} />
