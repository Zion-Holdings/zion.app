...
export const metadata: Metadata = {
  title: 'Autonomous Generator System - Energy',
  description: 'Transform your energy operations with our Autonomous Generator System - Energy. This AI-driven solution automates brand sentiment with unprecedented accuracy an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-generator-system-energy-52769c31',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Generator System - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Autonomous Generator System - Energy. This AI-driven solution automates brand sentiment with unprecedented accuracy and efficiency.
          </p>
