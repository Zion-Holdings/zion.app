...
export const metadata: Metadata = {
  title: 'AI-Powered Engine for Sports',
  description: 'Drive innovation in sports with AI-Powered Engine for Sports. This AI-powered platform transforms customer intelligence into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-engine-for-sports-7f9f7f3e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Engine for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in sports with AI-Powered Engine for Sports. This AI-powered platform transforms customer intelligence into a competitive advantage.
          </p>
