...
export const metadata: Metadata = {
  title: 'Smart Cloud Platform - Hospitality #1',
  description: 'Transform hospitality with Smart Cloud Platform - Hospitality #1 - the intelligent automation platform that learns, adapts, and delivers 10x results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-cloud-platform-hospitality-1-a5c68603',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Cloud Platform - Hospitality #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform hospitality with Smart Cloud Platform - Hospitality #1 - the intelligent automation platform that learns, adapts, and delivers 10x results.
          </p>
