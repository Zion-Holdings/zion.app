...
export const metadata: Metadata = {
  title: 'Cognitive Real Estate Solution - Hospitality',
  description: 'Drive innovation in hospitality with Cognitive Real Estate Solution - Hospitality. This AI-powered platform transforms training optimization into a competitive ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Real Estate Solution - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Cognitive Real Estate Solution - Hospitality. This AI-powered platform transforms training optimization into a competitive advantage.
          </p>
