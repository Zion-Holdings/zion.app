...
export const metadata: Metadata = {
  title: "Brand Sentiment & Social Listening AI | Zion Tech Group",
  ...
  openGraph: {
    title: "Brand Sentiment & Social Listening AI | Zion Tech Group",
    description: "Monitor brand mentions across social media, news, forums, review sites, and podcasts in real-time. AI sentiment analysis detects crises before they escalate. Competitive intelligence dashboard included.",
    url: "https://ziontechgroup.com/services/ai-sentiment-monitor/",
    type: 'website',
  },
  alternates: { canonical: "/services/ai-sentiment-monitor/" },
};

export default function AiSentimentMonitorPage() {
  return (
    <StandardPage
      title="Brand Sentiment & Social Listening AI"
      subtitle="Monitor brand mentions across social media, news, forums, review sites, and podcasts in real-time. AI sentiment analysis detects crises before they escalate. Competitive intelligence dashboard included."
      breadcrumbItems={[
        { label: "Home", href: "/" },
        { label: "Services", href: "/services/" },
        { label: "Brand Sentiment & Social Listening AI" }
      ]}
      actions={[
    ...
    >
        ...
        <div className="rounded-2xl border border-white/10 bg-slate-900/40 p-5"><h2 className="text-white font-semibold mb-2">Brand Sentiment &amp; Social Listening AI</h2><p className="text-slate-400 text-sm">Archived section recovered from the live site snapshot.</p></div>
      ...
      <p className="text-slate-400 leading-relaxed mb-4 max-w-5xl mx-auto">Estimated timeline for Brand Sentiment &amp; Social Listening AI — adapt to your team size and complexity.</p>
      ...
      <p className="text-slate-500 text-sm max-w-5xl mx-auto">Restored from a Wayback Machine snapshot (20260607105255) of ziontechgroup.com.</p>
    </StandardPage>
  );
}
