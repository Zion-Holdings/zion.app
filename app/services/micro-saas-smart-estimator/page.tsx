...
export const metadata: Metadata = {
  ...
  keywords: 'AI cost estimation, Scope breakdown, Proposal generator, Historical analysis, CRM integration, E-signature, Approval workflows, Analytics, micro-saas, SaaS, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Estimator and Proposal Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Generate accurate project estimates using AI historical data analysis.</p>
        ...
        <li class="text-slate-300">AI cost estimation</li>
        <li class="text-slate-300">Scope breakdown</li>
        <li class="text-slate-300">Proposal generator</li>
        <li class="text-slate-300">Historical analysis</li>
        <li class="text-slate-300">CRM integration</li>
        <li class="text-slate-300">E-signature</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">3x faster estimates</li>
        <li class="text-slate-300">25% more wins</li>
        <li class="text-slate-300">Professional proposals</li>
        <li class="text-slate-300">Data-driven pricing</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$749/mo</p>
