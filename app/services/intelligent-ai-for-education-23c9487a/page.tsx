...
export const metadata: Metadata = {
  title: 'Intelligent AI for Education',
  description: 'The future of education is here with Intelligent AI for Education. Powered by cutting-edge AI, this platform delivers user experience like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-ai-for-education-23c9487a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent AI for Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of education is here with Intelligent AI for Education. Powered by cutting-edge AI, this platform delivers user experience like never before.
          </p>
