...
export const metadata: Metadata = {
  title: 'Cognitive Territory Data Science',
  description: 'The future of transportation is here with Cognitive Territory Data Science. Powered by cutting-edge AI, this platform delivers transformative results like never',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-territory-data-science-03657429',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Territory Data Science
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Cognitive Territory Data Science. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
