...
export const metadata: Metadata = {
  ...
  keywords: 'Vault as a service, Auto-rotation (certificates, keys), Just-In-Time access approvals, Audit trail & reporting, K8s operator, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Secrets Management as a Service</h1>
        <p className="text-lg text-slate-300 mb-8">Centralized secrets vault with automatic rotation, audit logs, and Just-In-Time access. Integrates with Kubernetes, VSphere, and cloud providers.</p>
        ...
        <li class="text-slate-300">Vault as a service</li>
        <li class="text-slate-300">Auto-rotation (certificates, keys)</li>
        <li class="text-slate-300">Just-In-Time access approvals</li>
        <li class="text-slate-300">Audit trail &amp; reporting</li>
        <li class="text-slate-300">K8s operator</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with secrets management as a service</li>
