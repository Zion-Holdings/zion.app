...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-cloud cluster management, Built-in service mesh (Istio), GitOps continuous delivery, Auto-scrolling policies, Cost optimization dashboards, cloud, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cloud Kubernetes Platform as a Service</h1>
        <p className="text-lg text-slate-300 mb-8">Managed Kubernetes platform with auto-scrolling, service mesh, GitOps deployments, and multi-cluster management across AWS, Azure, and GCP.</p>
        ...
        <li class="text-slate-300">Multi-cloud cluster management</li>
        <li class="text-slate-300">Built-in service mesh (Istio)</li>
        <li class="text-slate-300">GitOps continuous delivery</li>
        <li class="text-slate-300">Auto-scrolling policies</li>
        <li class="text-slate-300">Cost optimization dashboards</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce Kubernetes complexity by 80%</li>
        <li class="text-slate-300">Deploy in minutes not days</li>
        <li class="text-slate-300">Multi-cloud portability</li>
      </ul>
        </div>
