...
export const metadata: Metadata = {
  title: 'Smart Predictive Platform - Energy',
  description: 'Transform your energy operations with our Smart Predictive Platform - Energy. This AI-driven solution automates social media monitoring with unprecedented accur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-predictive-platform-energy-fcde6f4a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Predictive Platform - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Smart Predictive Platform - Energy. This AI-driven solution automates social media monitoring with unprecedented accuracy and efficiency.
          </p>
