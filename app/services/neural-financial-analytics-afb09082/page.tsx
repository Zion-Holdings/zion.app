...
export const metadata: Metadata = {
  title: 'Neural Financial Analytics',
  description: 'Revolutionize energy through intelligent automation. Our Neural Financial Analytics leverages advanced machine learning to deliver incident response at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-financial-analytics-afb09082',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Neural Financial Analytics leverages advanced machine learning to deliver incident response at scale.
          </p>
