...
export const metadata: Metadata = {
  title: 'Cognitive Automation Solution - Construction',
  description: 'Optimize your construction workflows with Cognitive Automation Solution - Construction. This intelligent platform delivers business intelligence through advance',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-automation-solution-construction-6bc6859e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Automation Solution - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Cognitive Automation Solution - Construction. This intelligent platform delivers business intelligence through advanced automation and AI.
          </p>
