...
export const metadata: Metadata = {
  title: 'Smart Smart Platform - Insurance #1',
  description: 'Enhance your insurance business with Smart Smart Platform - Insurance #1. Our solution provides campaign optimization with enterprise-grade reliability and secu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-smart-platform-insurance-1-f8f07283',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Smart Platform - Insurance #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Smart Smart Platform - Insurance #1. Our solution provides campaign optimization with enterprise-grade reliability and security.
          </p>
