...
export const metadata: Metadata = {
  title: 'Scorecards AI-Powered Stream Processing',
  description: 'AI-powered scorecards solution for streaming. Real-time stream processing with automatic windowing and aggregation.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/scorecards-ai-powered-stream-processing-62036157',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Scorecards AI-Powered Stream Processing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered scorecards solution for streaming. Real-time stream processing with automatic windowing and aggregation.
          </p>
