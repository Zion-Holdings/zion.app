...
export const metadata: Metadata = {
  title: 'Autonomous Analyzer for Real-Estate',
  description: 'Revolutionize real-estate through intelligent automation. Our Autonomous Analyzer for Real-Estate leverages advanced machine learning to deliver risk assessment',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-analyzer-for-real-estate-a46121cc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Analyzer for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our Autonomous Analyzer for Real-Estate leverages advanced machine learning to deliver risk assessment at scale.
          </p>
