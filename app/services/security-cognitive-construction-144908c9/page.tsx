...
export const metadata: Metadata = {
  title: 'Security Cognitive - Construction',
  description: 'Revolutionize construction through intelligent automation. Our Security Cognitive - Construction leverages advanced machine learning to deliver feature engineer',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-cognitive-construction-144908c9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Cognitive - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Security Cognitive - Construction leverages advanced machine learning to deliver feature engineering at scale.
          </p>
