...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time transcription, Custom language models, Speaker diarization, Multi-language (50+), Medical/legal models, Edge deployment, Punctuation and formatting, Vocabulary customization, ai, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Enterprise Speech-to-Text Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Real-time speech recognition for enterprise. Custom language models, speaker diarization, multi-language support, medical/legal domain accuracy, and edge deployment.</p>
        ...
        <li class="text-slate-300">Real-time transcription</li>
        <li class="text-slate-300">Custom language models</li>
        <li class="text-slate-300">Speaker diarization</li>
        <li class="text-slate-300">Multi-language (50+)</li>
        <li class="text-slate-300">Medical/legal models</li>
        <li class="text-slate-300">Edge deployment</li>
        <li class="text-slate-300">Punctuation and formatting</li>
        <li class="text-slate-300">Vocabulary customization</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">95%+ accuracy</li>
        <li class="text-slate-300">Real-time processing</li>
        <li class="text-slate-300">Domain-specific models</li>
        <li class="text-slate-300">Edge deployment option</li>
        <li class="text-slate-300">50+ languages</li>
      </ul>
        </div>
