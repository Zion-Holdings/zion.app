...
export const metadata: Metadata = {
  title: 'Automated Platform for Legal',
  description: 'Revolutionize legal through intelligent automation. Our Automated Platform for Legal leverages advanced machine learning to deliver content generation at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-platform-for-legal-85275d41',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Platform for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Automated Platform for Legal leverages advanced machine learning to deliver content generation at scale.
          </p>
