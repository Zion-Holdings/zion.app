...
export const metadata: Metadata = {
  title: 'Intelligent Operational for Hospitality',
  description: 'Quantum leap forward for hospitality: Intelligent Operational for Hospitality. Uses quantum-inspired algorithms to deliver career development at exponential spe',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-operational-for-hospitality-f2975536',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Operational for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for hospitality: Intelligent Operational for Hospitality. Uses quantum-inspired algorithms to deliver career development at exponential speed.
          </p>
