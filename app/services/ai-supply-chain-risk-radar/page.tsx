...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-tier supplier monitoring, Disaster & weather impact prediction, Geopolitical risk scoring, Port congestion forecasting, Supplier financial health tracking, Alternative supplier matching, ai, Logistics & Supply Chain, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Supply Chain Risk Intelligence</h1>
        <p className="text-lg text-slate-300 mb-8">Real-time supply chain disruption monitoring: natural disasters, geopolitical events, port congestion, supplier health. Predictive alerts 30 days before impact.</p>
        ...
        <li class="text-slate-300">Multi-tier supplier monitoring</li>
        <li class="text-slate-300">Disaster &amp; weather impact prediction</li>
        <li class="text-slate-300">Geopolitical risk scoring</li>
        <li class="text-slate-300">Port congestion forecasting</li>
        <li class="text-slate-300">Supplier financial health tracking</li>
        <li class="text-slate-300">Alternative supplier matching</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">30-day advance disruption alerts</li>
        <li class="text-slate-300">Reduce stockouts by 45%</li>
        <li class="text-slate-300">Maintain supply continuity</li>
      </ul>
        </div>
