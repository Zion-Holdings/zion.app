...
export const metadata: Metadata = {
  ...
  keywords: 'Clause extraction & classification, Risk scoring engine, Template comparison, Redline suggestions, Multi-language support, Version tracking, ai, Legal, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Micro-SAAS AI Contract Analyzer</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered contract review and analysis. Automatically extracts key terms, flags risky clauses, compares against templates, and generates summary reports.</p>
        ...
        <li class="text-slate-300">Clause extraction &amp; classification</li>
        <li class="text-slate-300">Risk scoring engine</li>
        <li class="text-slate-300">Template comparison</li>
        <li class="text-slate-300">Redline suggestions</li>
        <li class="text-slate-300">Multi-language support</li>
        <li class="text-slate-300">Version tracking</li>
      </ul>
        </div>
        ...
        <li class="text-slate-300">Never miss critical clauses</li>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">1299</p>
