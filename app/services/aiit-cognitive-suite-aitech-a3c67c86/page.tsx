...
export const metadata: Metadata = {
  title: 'AI/IT Cognitive Suite - AITECH',
  description: 'Unlock unprecedented growth with AI/IT Cognitive Suite - AITECH. This autonomous system provides recommendation system with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-cognitive-suite-aitech-a3c67c86',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Cognitive Suite - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with AI/IT Cognitive Suite - AITECH. This autonomous system provides recommendation system with zero manual intervention needed.
          </p>
