...
export const metadata: Metadata = {
  title: 'Self-Optimizing Insights for Insurance',
  description: 'The future of insurance is here with Self-Optimizing Insights for Insurance. Powered by cutting-edge AI, this platform delivers maintenance scheduling like neve',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/self-optimizing-insights-for-insurance-606ace77',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Insights for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Self-Optimizing Insights for Insurance. Powered by cutting-edge AI, this platform delivers maintenance scheduling like never before.
          </p>
