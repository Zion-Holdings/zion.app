...
export const metadata: Metadata = {
  title: 'Intelligent healthcare-fintech',
  description: 'Next-generation fintech solution: Intelligent healthcare-fintech. Combines content moderation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-healthcare-fintech-d5645ca7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent healthcare-fintech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation fintech solution: Intelligent healthcare-fintech. Combines content moderation with adaptive intelligence for optimal results.
          </p>
