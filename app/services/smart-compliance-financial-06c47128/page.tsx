...
export const metadata: Metadata = {
  title: 'Smart Compliance Financial',
  description: 'Next-generation logistics solution: Smart Compliance Financial. Combines business intelligence with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-compliance-financial-06c47128',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Compliance Financial
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Smart Compliance Financial. Combines business intelligence with adaptive intelligence for optimal results.
          </p>
