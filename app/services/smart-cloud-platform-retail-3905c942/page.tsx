...
export const metadata: Metadata = {
  title: 'Smart Cloud Platform - Retail',
  description: 'Unlock unprecedented growth with Smart Cloud Platform - Retail. This autonomous system provides dashboard automation with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-cloud-platform-retail-3905c942',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Cloud Platform - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Cloud Platform - Retail. This autonomous system provides dashboard automation with zero manual intervention needed.
          </p>
