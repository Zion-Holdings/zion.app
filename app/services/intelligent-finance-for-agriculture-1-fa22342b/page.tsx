...
export const metadata: Metadata = {
  title: 'Intelligent Finance for Agriculture #1',
  description: 'Optimize your agriculture workflows with Intelligent Finance for Agriculture #1. This intelligent platform delivers business continuity through advanced automat',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-finance-for-agriculture-1-fa22342b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Finance for Agriculture #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your agriculture workflows with Intelligent Finance for Agriculture #1. This intelligent platform delivers business continuity through advanced automation and AI.
          </p>
