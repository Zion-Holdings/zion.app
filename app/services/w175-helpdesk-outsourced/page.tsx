...
export const metadata: Metadata = {
  ...
  keywords: '24/7 L1 and L2 technical support, Ticket management and escalation, Knowledge base and self-service portal, Remote desktop support, Onboarding and offboarding assistance, SLA guarantees with penalties, Multi-channel (phone, chat, email, portal), it, IT Operations, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Outsourced IT Help Desk</h1>
        <p className="text-lg text-slate-300 mb-8">24/7 outsourced IT help desk with certified technicians: L1/L2 support, ticket management, knowledge base, and SLA guarantees. US-based or global.</p>
        ...
        <li class="text-slate-300">24/7 L1 and L2 technical support</li>
        <li class="text-slate-300">Ticket management and escalation</li>
        <li class="text-slate-300">Knowledge base and self-service portal</li>
        <li class="text-slate-300">Remote desktop support</li>
        <li class="text-slate-300">Onboarding and offboarding assistance</li>
        <li class="text-slate-300">SLA guarantees with penalties</li>
        <li class="text-slate-300">Multi-channel (phone, chat, email, portal)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">24/7 support without hiring</li>
        <li class="text-slate-300">SLA guarantees response and resolution times</li>
        <li class="text-slate-300">Certified technicians, not generalists</li>
        <li class="text-slate-300">Scales with your organization</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$40/user/mo</p>
