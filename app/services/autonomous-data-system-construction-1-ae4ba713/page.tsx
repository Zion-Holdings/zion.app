...
export const metadata: Metadata = {
  title: 'Autonomous Data System - Construction #1',
  description: 'Next-generation construction solution: Autonomous Data System - Construction #1. Combines inventory management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-data-system-construction-1-ae4ba713',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Data System - Construction #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Autonomous Data System - Construction #1. Combines inventory management with adaptive intelligence for optimal results.
          </p>
