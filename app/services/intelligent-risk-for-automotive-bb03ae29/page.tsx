...
export const metadata: Metadata = {
  ...
  description: 'Unlock unprecedented growth with Intelligent Risk for Automotive. This autonomous system provides content moderation with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-risk-for-automotive-bb03ae29',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Risk for Automotive. This autonomous system provides content moderation with zero manual intervention needed.
          </p>
