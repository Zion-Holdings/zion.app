...
export const metadata: Metadata = {
  title: 'Employee Experience AI-Powered DevOps Automation',
  description: 'AI-powered employee experience solution for devops. Automated CI/CD pipelines with intelligent testing and deployment.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/employee-experience-ai-powered-devops-automation-3173bee0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Employee Experience AI-Powered DevOps Automation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered employee experience solution for devops. Automated CI/CD pipelines with intelligent testing and deployment.
          </p>
