...
export const metadata: Metadata = {
  title: 'Adaptive Survey Processor',
  description: 'Transform your real-estate operations with our Adaptive Survey Processor. This AI-driven solution automates decision support with unprecedented accuracy and eff',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Survey Processor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Adaptive Survey Processor. This AI-driven solution automates decision support with unprecedented accuracy and efficiency.
          </p>
