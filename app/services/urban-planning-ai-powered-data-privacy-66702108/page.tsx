...
export const metadata: Metadata = {
  title: 'Urban Planning AI-Powered Data Privacy',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Urban Planning AI-Powered Data Privacy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered urban planning solution for compliance. GDPR/CCPA compliance automation with automated data redaction.
          </p>
