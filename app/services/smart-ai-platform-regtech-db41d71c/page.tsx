...
export const metadata: Metadata = {
  title: 'Smart AI Platform - REGTECH',
  description: 'Next-generation regtech solution: Smart AI Platform - REGTECH. Combines release management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-ai-platform-regtech-db41d71c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart AI Platform - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation regtech solution: Smart AI Platform - REGTECH. Combines release management with adaptive intelligence for optimal results.
          </p>
