...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Security for Hospitality',
  description: 'Unlock unprecedented growth with Hyper-Accelerated Security for Hospitality. This autonomous system provides employee engagement with zero manual intervention n',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/hyper-accelerated-security-for-hospitality-e44ff41a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Security for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Hyper-Accelerated Security for Hospitality. This autonomous system provides employee engagement with zero manual intervention needed.
          </p>
