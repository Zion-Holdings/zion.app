...
export const metadata: Metadata = {
  title: 'Engine Predictive - Cleantech',
  description: 'Revolutionize cleantech through intelligent automation. Our Engine Predictive - Cleantech leverages advanced machine learning to deliver compliance monitoring a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Engine Predictive - Cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cleantech through intelligent automation. Our Engine Predictive - Cleantech leverages advanced machine learning to deliver compliance monitoring at scale.
          </p>
