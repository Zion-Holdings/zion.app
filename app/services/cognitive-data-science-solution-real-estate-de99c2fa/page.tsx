...
export const metadata: Metadata = {
  title: 'Cognitive Data Science Solution - Real-Estate',
  description: 'Unlock unprecedented growth with Cognitive Data Science Solution - Real-Estate. This autonomous system provides project portfolio with zero manual intervention ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Data Science Solution - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Cognitive Data Science Solution - Real-Estate. This autonomous system provides project portfolio with zero manual intervention needed.
          </p>
