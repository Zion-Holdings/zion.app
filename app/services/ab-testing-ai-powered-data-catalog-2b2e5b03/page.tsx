...
export const metadata: Metadata = {
  title: "A/B Testing AI-Powered Data Catalog - AI-Powered A/B Testing Solution",
  description: "AI-powered a/b testing solution for data governance. Self-updating data catalog with automated metadata extraction.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ab-testing-ai-powered-data-catalog-2b2e5b03",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          A/B Testing AI-Powered Data Catalog - AI-Powered A/B Testing Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          AI-powered a/b testing solution for data governance. Self-updating data catalog with automated metadata extraction.
        </p>
