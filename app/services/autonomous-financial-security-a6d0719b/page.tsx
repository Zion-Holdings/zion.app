...
export const metadata: Metadata = {
  title: 'Autonomous Financial Security',
  description: 'Revolutionize hospitality through intelligent automation. Our Autonomous Financial Security leverages advanced machine learning to deliver decision support at s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Autonomous Financial Security leverages advanced machine learning to deliver decision support at scale.
          </p>
