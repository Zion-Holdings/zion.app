...
export const metadata: Metadata = {
  ...
  description: 'Deploys and manages AI models at the edge with automatic optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-edge-ai-platform-f13fa155',
  },

export const metadata = {
  title: "AI-Powered Edge AI Platform - Zion Tech Group",
  description: "Deploys and manages AI models at the edge with automatic optimization.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-edge-ai-platform-f13fa155`
  }
  ...
  return (
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Edge AI Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Deploys and manages AI models at the edge with automatic optimization.
          </p>
    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">AI-Powered Edge AI Platform</h1>
        <p className="text-lg text-gray-300 mb-8">Deploys and manages AI models at the edge with automatic optimization.</p>
