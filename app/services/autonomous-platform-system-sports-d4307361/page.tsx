...
export const metadata: Metadata = {
  title: 'Autonomous Platform System - Sports',
  description: 'Transform your sports operations with our Autonomous Platform System - Sports. This AI-driven solution automates event-driven architecture with unprecedented ac',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Platform System - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our Autonomous Platform System - Sports. This AI-driven solution automates event-driven architecture with unprecedented accuracy and efficiency.
          </p>
