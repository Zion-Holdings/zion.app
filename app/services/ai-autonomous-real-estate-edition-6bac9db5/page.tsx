...
export const metadata: Metadata = {
  ...
  description: 'The future of real-estate is here with AI Autonomous - Real-Estate Edition. Powered by cutting-edge AI, this platform delivers brand monitoring like never befor',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of real-estate is here with AI Autonomous - Real-Estate Edition. Powered by cutting-edge AI, this platform delivers brand monitoring like never before.
          </p>
