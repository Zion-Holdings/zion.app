...
export const metadata: Metadata = {
  title: 'Smart Data Science for Insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Data Science for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Data Science for Insurance. This autonomous system provides language processing with zero manual intervention needed.
          </p>
