      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Enterprise-grade content localization with context-aware translation, cultural nuance adaptation, brand voice preservation, and multi-market compliance.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Context-aware Neural Machine Translation (100+ languages)</li>
            <li className="text-purple-300">✓ Cultural adaptation and localization QA</li>
            <li className="text-purple-300">✓ Brand voice consistency across markets</li>
            <li className="text-purple-300">✓ Automated regulatory compliance checking</li>
            <li className="text-purple-300">✓ CMS and marketing platform integrations</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai content localization & cultural adaptation</li>
