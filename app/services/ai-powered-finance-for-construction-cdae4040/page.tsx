...
export const metadata: Metadata = {
  title: 'AI-Powered Finance for Construction',
  description: 'The future of construction is here with AI-Powered Finance for Construction. Powered by cutting-edge AI, this platform delivers workflow management like never b',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-finance-for-construction-cdae4040',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Finance for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with AI-Powered Finance for Construction. Powered by cutting-edge AI, this platform delivers workflow management like never before.
          </p>
