...
export const metadata: Metadata = {
  ...
  keywords: 'Supplier risk scoring, Geopolitical risk monitoring, Disruption prediction, Alternative sourcing recommendations, Financial health monitoring, ESG compliance tracking, Real-time alerting, Scenario modeling, ai, Supply Chain, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Supply Chain Risk Management</h1>
        <p className="text-lg text-slate-300 mb-8">Monitor and mitigate supply chain risks with AI. Supplier risk scoring, disruption prediction, alternative sourcing recommendations, and real-time monitoring.</p>
        ...
        <li class="text-slate-300">Geopolitical risk monitoring</li>
        <li class="text-slate-300">Disruption prediction</li>
        <li class="text-slate-300">Alternative sourcing recommendations</li>
        <li class="text-slate-300">Financial health monitoring</li>
        <li class="text-slate-300">ESG compliance tracking</li>
        <li class="text-slate-300">Real-time alerting</li>
        <li class="text-slate-300">Scenario modeling</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Predict disruptions weeks in advance</li>
        <li class="text-slate-300">Diversify supplier base proactively</li>
        <li class="text-slate-300">Reduce supply chain costs</li>
        <li class="text-slate-300">Improve resilience</li>
      </ul>
        </div>
