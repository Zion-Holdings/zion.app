...
export const metadata: Metadata = {
  title: 'Neural Monitoring for Proptech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Monitoring for Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation proptech solution: Neural Monitoring for Proptech. Combines energy management with adaptive intelligence for optimal results.
          </p>
