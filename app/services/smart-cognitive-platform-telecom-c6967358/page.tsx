...
export const metadata: Metadata = {
  title: 'Smart Cognitive Platform - Telecom',
  description: 'Next-generation telecom solution: Smart Cognitive Platform - Telecom. Combines customer retention with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-cognitive-platform-telecom-c6967358',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Cognitive Platform - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation telecom solution: Smart Cognitive Platform - Telecom. Combines customer retention with adaptive intelligence for optimal results.
          </p>
