...
export const metadata: Metadata = {
  title: 'Cognitive Insights for Media',
  description: 'The future of media is here with Cognitive Insights for Media. Powered by cutting-edge AI, this platform delivers quality control like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-insights-for-media-b02a8451',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Insights for Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of media is here with Cognitive Insights for Media. Powered by cutting-edge AI, this platform delivers quality control like never before.
          </p>
