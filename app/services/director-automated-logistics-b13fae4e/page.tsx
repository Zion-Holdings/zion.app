...
export const metadata: Metadata = {
  title: 'Director Automated - Logistics',
  description: 'The future of logistics is here with Director Automated - Logistics. Powered by cutting-edge AI, this platform delivers transformative results like never before',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/director-automated-logistics-b13fae4e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Director Automated - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Director Automated - Logistics. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
