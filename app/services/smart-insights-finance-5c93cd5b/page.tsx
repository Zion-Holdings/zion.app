...
export const metadata: Metadata = {
  title: 'Smart insights-finance',
  description: 'Optimize your finance workflows with Smart insights-finance. This intelligent platform delivers customer onboarding through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-insights-finance-5c93cd5b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart insights-finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your finance workflows with Smart insights-finance. This intelligent platform delivers customer onboarding through advanced automation and AI.
          </p>
