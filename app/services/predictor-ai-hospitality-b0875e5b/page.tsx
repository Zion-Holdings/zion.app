...
export const metadata: Metadata = {
  title: 'Predictor AI - Hospitality',
  description: 'The future of hospitality is here with Predictor AI - Hospitality. Powered by cutting-edge AI, this platform delivers customer journey mapping like never before',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictor-ai-hospitality-b0875e5b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictor AI - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Predictor AI - Hospitality. Powered by cutting-edge AI, this platform delivers customer journey mapping like never before.
          </p>
