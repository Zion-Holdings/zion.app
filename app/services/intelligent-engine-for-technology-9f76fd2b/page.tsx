...
export const metadata: Metadata = {
  title: 'Intelligent Engine for TECHNOLOGY',
  description: 'Enhance your technology business with Intelligent Engine for TECHNOLOGY. Our solution provides language processing with enterprise-grade reliability and securit',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Engine for TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your technology business with Intelligent Engine for TECHNOLOGY. Our solution provides language processing with enterprise-grade reliability and security.
          </p>
