...
export const metadata: Metadata = {
  title: 'Smart Process Orchestrator',
  description: 'Revolutionize healthcare through intelligent automation. Our Smart Process Orchestrator leverages advanced machine learning to deliver process automation at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Process Orchestrator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Smart Process Orchestrator leverages advanced machine learning to deliver process automation at scale.
          </p>
