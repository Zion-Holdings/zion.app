...
export const metadata: Metadata = {
  title: 'Automated platform-hospitality',
  description: 'Next-generation hospitality solution: Automated platform-hospitality. Combines regulatory tracking with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-platform-hospitality-646fce44',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated platform-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Automated platform-hospitality. Combines regulatory tracking with adaptive intelligence for optimal results.
          </p>
