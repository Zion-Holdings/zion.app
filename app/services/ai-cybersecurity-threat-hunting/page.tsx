...
export const metadata: Metadata = {
  ...
  keywords: 'Behavioral analytics (UEBA), Network traffic analysis, Endpoint detection and response, Automated threat investigation, MITRE ATT&CK mapping, Integration with Splunk, Sentinel, CrowdStrike, Threat intelligence correlation, Incident timeline reconstruction, ai, Cybersecurity, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Cybersecurity Threat Hunting Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Proactively hunt for advanced threats using AI-driven behavioral analytics, anomaly detection, and automated investigation playbooks across endpoints, network, and cloud.</p>
        ...
        <li class="text-slate-300">Behavioral analytics (UEBA)</li>
        <li class="text-slate-300">Network traffic analysis</li>
        <li class="text-slate-300">Endpoint detection and response</li>
        <li class="text-slate-300">Automated threat investigation</li>
        <li class="text-slate-300">MITRE ATT&amp;CK mapping</li>
        <li class="text-slate-300">Integration with Splunk, Sentinel, CrowdStrike</li>
        <li class="text-slate-300">Threat intelligence correlation</li>
        <li class="text-slate-300">Incident timeline reconstruction</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Detect threats 10x faster</li>
        <li class="text-slate-300">Reduce dwell time to hours</li>
        <li class="text-slate-300">Automate Tier-1 investigation</li>
        <li class="text-slate-300">Meet SOC 2 and ISO 27001 requirements</li>
      </ul>
        </div>
