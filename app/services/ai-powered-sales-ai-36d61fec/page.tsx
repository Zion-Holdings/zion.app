...
export const metadata: Metadata = {
  title: 'AI-Powered Sales AI',
  description: 'Next-generation construction solution: AI-Powered Sales AI. Combines performance reviews with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-sales-ai-36d61fec',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: AI-Powered Sales AI. Combines performance reviews with adaptive intelligence for optimal results.
          </p>
