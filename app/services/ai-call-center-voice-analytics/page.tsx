      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Real-time call transcription, sentiment analysis, agent coaching insights, and compliance monitoring for contact centers.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Real-time speech-to-text transcription</li>
            <li className="text-purple-300">✓ Sentiment & emotion detection</li>
            <li className="text-purple-300">✓ Agent compliance monitoring (PCI, GDPR)</li>
            <li className="text-purple-300">✓ Automated coaching suggestions</li>
            <li className="text-purple-300">✓ Keyword & topic trend analysis</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai call center voice analytics</li>
