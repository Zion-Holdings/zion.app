...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time speech-to-text transcription, Sentiment & emotion detection, Agent compliance monitoring (PCI, GDPR), Automated coaching suggestions, Keyword & topic trend analysis, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Call Center Voice Analytics</h1>
        <p className="text-lg text-slate-300 mb-8">Real-time call transcription, sentiment analysis, agent coaching insights, and compliance monitoring for contact centers.</p>
        ...
        <li class="text-slate-300">Real-time speech-to-text transcription</li>
        <li class="text-slate-300">Sentiment &amp; emotion detection</li>
        <li class="text-slate-300">Agent compliance monitoring (PCI, GDPR)</li>
        <li class="text-slate-300">Automated coaching suggestions</li>
        <li class="text-slate-300">Keyword &amp; topic trend analysis</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai call center voice analytics</li>
