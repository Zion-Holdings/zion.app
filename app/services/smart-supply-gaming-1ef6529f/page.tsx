...
export const metadata: Metadata = {
  title: 'Smart supply-gaming',
  description: 'Next-generation gaming solution: Smart supply-gaming. Combines campaign optimization with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-supply-gaming-1ef6529f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation gaming solution: Smart supply-gaming. Combines campaign optimization with adaptive intelligence for optimal results.
          </p>
