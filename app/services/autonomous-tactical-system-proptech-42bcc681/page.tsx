...
export const metadata: Metadata = {
  title: 'Autonomous Tactical System - PROPTECH',
  description: 'Hyper-accelerated proptech solution: Autonomous Tactical System - PROPTECH. Combines market intelligence with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-tactical-system-proptech-42bcc681',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Tactical System - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated proptech solution: Autonomous Tactical System - PROPTECH. Combines market intelligence with next-gen AI for maximum velocity.
          </p>
