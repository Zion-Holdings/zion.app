...
export const metadata: Metadata = {
  title: 'Sales Intelligent - Real-Estate #1',
  description: 'The future of real-estate is here with Sales Intelligent - Real-Estate #1. Powered by cutting-edge AI, this platform delivers content generation like never befo',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Sales Intelligent - Real-Estate #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of real-estate is here with Sales Intelligent - Real-Estate #1. Powered by cutting-edge AI, this platform delivers content generation like never before.
          </p>
