...
export const metadata: Metadata = {
  title: 'Cognitive Workflow DevOps',
  description: 'Revolutionize hospitality through intelligent automation. Our Cognitive Workflow DevOps leverages advanced machine learning to deliver enterprise-grade insights',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-workflow-devops-11d719e6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Workflow DevOps
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Cognitive Workflow DevOps leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
