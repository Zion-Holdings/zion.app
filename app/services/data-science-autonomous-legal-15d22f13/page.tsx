...
export const metadata: Metadata = {
  title: 'Data Science Autonomous - Legal',
  description: 'Optimize your legal workflows with Data Science Autonomous - Legal. This intelligent platform delivers quality assurance through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-science-autonomous-legal-15d22f13',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Science Autonomous - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with Data Science Autonomous - Legal. This intelligent platform delivers quality assurance through advanced automation and AI.
          </p>
