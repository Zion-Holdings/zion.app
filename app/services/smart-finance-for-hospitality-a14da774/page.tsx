...
export const metadata: Metadata = {
  title: 'Smart Finance for Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Smart Finance for Hospitality leverages advanced machine learning to deliver decision support at s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-finance-for-hospitality-a14da774',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Finance for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Smart Finance for Hospitality leverages advanced machine learning to deliver decision support at scale.
          </p>
