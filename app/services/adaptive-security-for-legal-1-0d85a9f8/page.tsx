...
export const metadata: Metadata = {
  title: 'Adaptive Security for Legal #1',
  description: 'Transform your legal operations with our Adaptive Security for Legal #1. This AI-driven solution automates scenario planning with unprecedented accuracy and eff',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Security for Legal #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Adaptive Security for Legal #1. This AI-driven solution automates scenario planning with unprecedented accuracy and efficiency.
          </p>
