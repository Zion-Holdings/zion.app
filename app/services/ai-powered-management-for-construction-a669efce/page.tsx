...
export const metadata: Metadata = {
  title: 'AI-Powered Management for Construction',
  description: 'The future of construction is here with AI-Powered Management for Construction. Powered by cutting-edge AI, this platform delivers compliance monitoring like ne',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-management-for-construction-a669efce',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Management for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with AI-Powered Management for Construction. Powered by cutting-edge AI, this platform delivers compliance monitoring like never before.
          </p>
