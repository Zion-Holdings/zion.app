...
export const metadata: Metadata = {
  title: 'Autonomous business intelligence-construction',
  description: 'Transform your construction operations with our Autonomous business intelligence-construction. This AI-driven solution automates employee engagement with unprec',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous business intelligence-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Autonomous business intelligence-construction. This AI-driven solution automates employee engagement with unprecedented accuracy and efficiency.
          </p>
