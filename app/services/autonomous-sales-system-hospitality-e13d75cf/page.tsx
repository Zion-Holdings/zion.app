...
export const metadata: Metadata = {
  title: 'Autonomous Sales System - Hospitality',
  description: 'Enhance your hospitality business with Autonomous Sales System - Hospitality. Our solution provides process automation with enterprise-grade reliability and sec',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-sales-system-hospitality-e13d75cf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Sales System - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Autonomous Sales System - Hospitality. Our solution provides process automation with enterprise-grade reliability and security.
          </p>
