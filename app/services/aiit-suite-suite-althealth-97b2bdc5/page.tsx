...
export const metadata: Metadata = {
  title: 'AI/IT Suite Suite - ALTHEALTH',
  description: 'Transform your althealth operations with our AI/IT Suite Suite - ALTHEALTH. This AI-driven solution automates hr analytics with unprecedented accuracy and effic',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-suite-suite-althealth-97b2bdc5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Suite Suite - ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your althealth operations with our AI/IT Suite Suite - ALTHEALTH. This AI-driven solution automates hr analytics with unprecedented accuracy and efficiency.
          </p>
