...
export const metadata: Metadata = {
  title: 'Cognitive Process Optimization',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Cognitive Process Optimization. Powered by cutting-edge AI, this platform delivers customer journey mapping like never before.
          </p>
