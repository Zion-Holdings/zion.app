...
export const metadata = {
  ...
  description: 'End-to-end ai customer onboarding automation: reduce time to value services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/ai-customer-onboarding-automation-reduce-time-to-value-1/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">AI Customer Onboarding Automation: Reduce Time to Value</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end ai customer onboarding automation: reduce time to value services: assessment, deployment, and managed operations.
        </p>
