...
export const metadata: Metadata = {
  title: 'Autonomous Cloud System - Insurance #1',
  description: 'Enhance your insurance business with Autonomous Cloud System - Insurance #1. Our solution provides container orchestration with enterprise-grade reliability and',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Cloud System - Insurance #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Autonomous Cloud System - Insurance #1. Our solution provides container orchestration with enterprise-grade reliability and security.
          </p>
