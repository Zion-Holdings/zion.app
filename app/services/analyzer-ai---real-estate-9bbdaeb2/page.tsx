...
export const metadata: Metadata = {
  title: 'Analyzer AI - Real-Estate',
  description: 'The future of real-estate is here with Analyzer AI - Real-Estate. Powered by cutting-edge AI, this platform delivers process automation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/analyzer-ai---real-estate-9bbdaeb2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Analyzer AI - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of real-estate is here with Analyzer AI - Real-Estate. Powered by cutting-edge AI, this platform delivers process automation like never before.
          </p>
