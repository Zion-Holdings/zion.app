      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with DevOps Neural - Legal. This intelligent platform delivers data governance through advanced automation and AI.
          </p>
