...
export const metadata: Metadata = {
  title: 'Generator Neural - Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Generator Neural - Healthcare leverages advanced machine learning to deliver risk assessment at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Generator Neural - Healthcare leverages advanced machine learning to deliver risk assessment at scale.
          </p>
