...
export const metadata: Metadata = {
  title: 'Smart Neural Platform - Transportation',
  description: 'Optimize your transportation workflows with Smart Neural Platform - Transportation. This intelligent platform delivers master data management through advanced a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-neural-platform-transportation-30c2336d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Neural Platform - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Smart Neural Platform - Transportation. This intelligent platform delivers master data management through advanced automation and AI.
          </p>
