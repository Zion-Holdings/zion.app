...
export const metadata: Metadata = {
  title: 'Process Mining Smart - Retail',
  description: 'The future of retail is here with Process Mining Smart - Retail. Powered by cutting-edge AI, this platform delivers recommendation system like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/process-mining-smart-retail-ce99109b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Process Mining Smart - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Process Mining Smart - Retail. Powered by cutting-edge AI, this platform delivers recommendation system like never before.
          </p>
