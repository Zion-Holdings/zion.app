...
export const metadata: Metadata = {
  title: 'AI/IT Scale-up Suite - AITECH #1',
  description: 'Revolutionize aitech through intelligent automation. Our AI/IT Scale-up Suite - AITECH #1 leverages advanced machine learning to deliver skills management at sc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-scale-up-suite-aitech-1-c74e6dc5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Scale-up Suite - AITECH #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize aitech through intelligent automation. Our AI/IT Scale-up Suite - AITECH #1 leverages advanced machine learning to deliver skills management at scale.
          </p>
