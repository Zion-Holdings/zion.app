...
export const metadata: Metadata = {
  title: 'Intelligent Business Intelligence for Logistics',
  description: 'Transform your logistics operations with our Intelligent Business Intelligence for Logistics. This AI-driven solution automates logistics route optimization wit',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-business-intelligence-for-logistics-c01270cb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Business Intelligence for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Intelligent Business Intelligence for Logistics. This AI-driven solution automates logistics route optimization with unprecedented accuracy and efficiency.
          </p>
