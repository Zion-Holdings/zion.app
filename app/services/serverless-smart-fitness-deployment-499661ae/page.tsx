...
export const metadata = {
  title: "Serverless Smart Fitness Deployment - Zion Tech Group",
  description: "Serverless deployment platform that auto-scales smart fitness workloads without infrastructure management.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/serverless-smart-fitness-deployment-499661ae`
  }
};
