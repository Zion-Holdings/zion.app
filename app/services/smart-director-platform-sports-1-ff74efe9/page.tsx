...
export const metadata: Metadata = {
  title: 'Smart Director Platform - Sports #1',
  description: 'The future of sports is here with Smart Director Platform - Sports #1. Powered by cutting-edge AI, this platform delivers market analysis like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-director-platform-sports-1-ff74efe9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Director Platform - Sports #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Smart Director Platform - Sports #1. Powered by cutting-edge AI, this platform delivers market analysis like never before.
          </p>
