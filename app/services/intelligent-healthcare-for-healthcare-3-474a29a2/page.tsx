...
export const metadata: Metadata = {
  title: 'Intelligent Healthcare for Healthcare #3',
  description: 'Revolutionize healthcare through intelligent automation. Our Intelligent Healthcare for Healthcare #3 leverages advanced machine learning to deliver access mana',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Healthcare for Healthcare #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Intelligent Healthcare for Healthcare #3 leverages advanced machine learning to deliver access management at scale.
          </p>
