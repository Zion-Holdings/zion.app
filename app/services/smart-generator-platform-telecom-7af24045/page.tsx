...
export const metadata: Metadata = {
  title: 'Smart Generator Platform - Telecom',
  description: 'Revolutionize telecom through intelligent automation. Our Smart Generator Platform - Telecom leverages advanced machine learning to deliver fraud prevention at ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-generator-platform-telecom-7af24045',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Generator Platform - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Smart Generator Platform - Telecom leverages advanced machine learning to deliver fraud prevention at scale.
          </p>
