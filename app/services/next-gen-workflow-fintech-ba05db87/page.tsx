...
export const metadata: Metadata = {
  title: 'Next-Gen workflow-fintech',
  description: 'Next-generation fintech solution: Next-Gen workflow-fintech. Combines quality control with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-workflow-fintech-ba05db87',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen workflow-fintech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation fintech solution: Next-Gen workflow-fintech. Combines quality control with adaptive intelligence for optimal results.
          </p>
