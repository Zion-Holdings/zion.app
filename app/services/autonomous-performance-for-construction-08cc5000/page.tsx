...
export const metadata: Metadata = {
  title: 'Autonomous Performance for Construction',
  description: 'Next-generation construction solution: Autonomous Performance for Construction. Combines compliance monitoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-performance-for-construction-08cc5000',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Performance for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Autonomous Performance for Construction. Combines compliance monitoring with adaptive intelligence for optimal results.
          </p>
