...
export const metadata: Metadata = {
  title: 'Autonomous Insights System - Legal #1',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Insights System - Legal #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Autonomous Insights System - Legal #1. Our solution provides lead scoring with enterprise-grade reliability and security.
          </p>
