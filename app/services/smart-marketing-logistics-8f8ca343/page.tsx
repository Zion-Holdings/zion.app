...
export const metadata: Metadata = {
  title: 'Smart marketing-logistics',
  description: 'Next-generation logistics solution: Smart marketing-logistics. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-marketing-logistics-8f8ca343',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart marketing-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Smart marketing-logistics. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
