...
export const metadata: Metadata = {
  title: 'Smart Orchestrator for Hospitality',
  description: 'The future of hospitality is here with Smart Orchestrator for Hospitality. Powered by cutting-edge AI, this platform delivers inventory management like never be',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-orchestrator-for-hospitality-7c14b27a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Orchestrator for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Smart Orchestrator for Hospitality. Powered by cutting-edge AI, this platform delivers inventory management like never before.
          </p>
