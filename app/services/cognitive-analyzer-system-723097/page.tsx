...
export const metadata: Metadata = {
  title: 'Cognitive Analyzer System',
  description: 'Transform your real-estate operations with our Cognitive Analyzer System. This automation solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-analyzer-system-723097',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Analyzer System
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Cognitive Analyzer System. This automation solution delivers unprecedented automation and intelligence.
          </p>
