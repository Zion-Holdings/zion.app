...
export const metadata: Metadata = {
  title: 'Next-Gen Support for Energy',
  description: 'Revolutionize energy through intelligent automation. Our Next-Gen Support for Energy leverages advanced machine learning to deliver customer retention at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-support-for-energy-943b2f8b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Support for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Next-Gen Support for Energy leverages advanced machine learning to deliver customer retention at scale.
          </p>
