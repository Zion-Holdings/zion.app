...
export const metadata: Metadata = {
  ...
  keywords: 'Timeline assembly from logs/metrics/alerts, Root cause inference via causal graph, Impact quantification (users, revenue, SLA), Auto-generated action items with owners, Follow-up tracking & closure verification, ai, E-Commerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Powered Incident Postmortem Generator</h1>
        <p className="text-lg text-slate-300 mb-8">Automatically generate blameless postmortem reports from incident data: timeline reconstruction, root cause hypothesis, action items, and status tracking.</p>
        ...
        <li class="text-slate-300">Timeline assembly from logs/metrics/alerts</li>
        <li class="text-slate-300">Root cause inference via causal graph</li>
        <li class="text-slate-300">Impact quantification (users, revenue, SLA)</li>
        <li class="text-slate-300">Auto-generated action items with owners</li>
        <li class="text-slate-300">Follow-up tracking &amp; closure verification</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai-powered incident postmortem generator</li>
