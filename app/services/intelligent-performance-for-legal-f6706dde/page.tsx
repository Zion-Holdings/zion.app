...
export const metadata: Metadata = {
  title: 'Intelligent Performance for Legal',
  description: 'The future of legal is here with Intelligent Performance for Legal. Powered by cutting-edge AI, this platform delivers code optimization like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-performance-for-legal-f6706dde',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Performance for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Intelligent Performance for Legal. Powered by cutting-edge AI, this platform delivers code optimization like never before.
          </p>
