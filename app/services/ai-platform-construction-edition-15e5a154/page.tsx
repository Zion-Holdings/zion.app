...
export const metadata: Metadata = {
  title: 'AI Platform - Construction Edition',
  description: 'Drive innovation in construction with AI Platform - Construction Edition. This AI-powered platform transforms customer health into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-platform-construction-edition-15e5a154',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Platform - Construction Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with AI Platform - Construction Edition. This AI-powered platform transforms customer health into a competitive advantage.
          </p>
