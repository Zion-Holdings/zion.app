...
export const metadata: Metadata = {
  title: 'Next-Gen NLP - Agriculture',
  description: 'Drive innovation in agriculture with Next-Gen NLP - Agriculture. This AI-powered platform transforms compliance monitoring into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-nlp-agriculture-c67f2534',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen NLP - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in agriculture with Next-Gen NLP - Agriculture. This AI-powered platform transforms compliance monitoring into a competitive advantage.
          </p>
