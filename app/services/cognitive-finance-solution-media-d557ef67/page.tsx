...
export const metadata: Metadata = {
  title: 'Cognitive Finance Solution - Media',
  description: 'Enhance your media business with Cognitive Finance Solution - Media. Our solution provides contract analysis with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-finance-solution-media-d557ef67',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Finance Solution - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your media business with Cognitive Finance Solution - Media. Our solution provides contract analysis with enterprise-grade reliability and security.
          </p>
