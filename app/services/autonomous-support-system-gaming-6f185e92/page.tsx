...
export const metadata: Metadata = {
  title: 'Autonomous Support System - Gaming',
  description: 'Drive innovation in gaming with Autonomous Support System - Gaming. This AI-powered platform transforms contract analysis into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-support-system-gaming-6f185e92',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Support System - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in gaming with Autonomous Support System - Gaming. This AI-powered platform transforms contract analysis into a competitive advantage.
          </p>
