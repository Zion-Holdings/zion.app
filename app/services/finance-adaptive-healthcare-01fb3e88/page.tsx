...
export const metadata: Metadata = {
  title: 'Finance Adaptive - Healthcare',
  description: 'The future of healthcare is here with Finance Adaptive - Healthcare. Powered by cutting-edge AI, this platform delivers data governance like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/finance-adaptive-healthcare-01fb3e88',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Finance Adaptive - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Finance Adaptive - Healthcare. Powered by cutting-edge AI, this platform delivers data governance like never before.
          </p>
