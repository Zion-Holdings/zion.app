...
export const metadata: Metadata = {
  title: 'Enterprise Threat - Energy',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Threat - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Enterprise Threat - Energy. This AI-powered platform transforms risk assessment into a competitive advantage.
          </p>
