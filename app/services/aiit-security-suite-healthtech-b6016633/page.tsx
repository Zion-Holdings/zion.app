...
export const metadata: Metadata = {
  title: 'AI/IT Security Suite - HEALTHTECH',
  description: 'Hyper-accelerated healthtech solution: AI/IT Security Suite - HEALTHTECH. Combines maintenance scheduling with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-security-suite-healthtech-b6016633',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Security Suite - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated healthtech solution: AI/IT Security Suite - HEALTHTECH. Combines maintenance scheduling with next-gen AI for maximum velocity.
          </p>
