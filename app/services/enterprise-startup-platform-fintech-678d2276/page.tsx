...
export const metadata: Metadata = {
  title: 'Enterprise Startup Platform - FINTECH',
  description: 'Transform your fintech operations with our Enterprise Startup Platform - FINTECH. This AI-driven solution automates personalization engine with unprecedented ac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-startup-platform-fintech-678d2276',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Startup Platform - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your fintech operations with our Enterprise Startup Platform - FINTECH. This AI-driven solution automates personalization engine with unprecedented accuracy and efficiency.
          </p>
