...
export const metadata: Metadata = {
  title: 'AI/IT strategic-healthtech',
  description: 'Enhance your healthtech business with AI/IT strategic-healthtech. Our solution provides container orchestration with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-strategic-healthtech-7c7802ae',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT strategic-healthtech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthtech business with AI/IT strategic-healthtech. Our solution provides container orchestration with enterprise-grade reliability and security.
          </p>
