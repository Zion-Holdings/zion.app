...
export const metadata: Metadata = {
  title: 'Smart Revenue Platform - Insurance',
  description: 'Optimize your insurance workflows with Smart Revenue Platform - Insurance. This intelligent platform delivers release management through advanced automation and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-revenue-platform-insurance-1a692640',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Revenue Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Smart Revenue Platform - Insurance. This intelligent platform delivers release management through advanced automation and AI.
          </p>
