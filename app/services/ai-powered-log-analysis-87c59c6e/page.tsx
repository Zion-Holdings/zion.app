...
export const metadata: Metadata = {
  ...
  description: 'Automated log analysis for incident detection and root cause analysis.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-log-analysis-87c59c6e',
  },

export const metadata = {
  title: "AI-Powered Log Analysis - Zion Tech Group",
  description: "Automated log analysis for incident detection and root cause analysis.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-log-analysis-87c59c6e`
  }
  ...
  return (
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automated log analysis for incident detection and root cause analysis.
          </p>
    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">AI-Powered Log Analysis</h1>
        <p className="text-lg text-gray-300 mb-8">Automated log analysis for incident detection and root cause analysis.</p>
