...
export const metadata: Metadata = {
  title: 'Smart Intelligence Platform - Transportation',
  description: 'Drive innovation in transportation with Smart Intelligence Platform - Transportation. This AI-powered platform transforms anomaly detection into a competitive a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Intelligence Platform - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in transportation with Smart Intelligence Platform - Transportation. This AI-powered platform transforms anomaly detection into a competitive advantage.
          </p>
