...
export const metadata: Metadata = {
  title: "AI-Powered Multi-Cloud Cost Management Platform - AI-Powered Textiles Solution",
  description: "ai-powered solution for textiles industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-multi-cloud-cost-management-platform-ec57afb6",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Multi-Cloud Cost Management Platform - AI-Powered Textiles Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          ai-powered solution for textiles industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.
        </p>
