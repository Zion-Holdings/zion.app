...
export const metadata: Metadata = {
  title: 'Management AI - Ecommerce',
  description: 'Revolutionize ecommerce through intelligent automation. Our Management AI - Ecommerce leverages advanced machine learning to deliver business intelligence at sc',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Management AI - Ecommerce
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize ecommerce through intelligent automation. Our Management AI - Ecommerce leverages advanced machine learning to deliver business intelligence at scale.
          </p>
