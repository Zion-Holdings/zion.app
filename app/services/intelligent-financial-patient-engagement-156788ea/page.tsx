...
export const metadata = {
  ...
  description: "AI-driven patient engagement platform that delivers next-generation personalized care journeys, remote monitoring, and adherence support through intelligent aut",
  alternates: {
