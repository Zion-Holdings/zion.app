  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Intelligent Financial Patient Engagement</h1>
        <p className="text-lg text-slate-300 mb-8">AI-driven patient engagement platform that delivers next-generation personalized care journeys, remote monitoring, and adherence support through intelligent automation.</p>
