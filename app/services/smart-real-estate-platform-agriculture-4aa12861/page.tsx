...
export const metadata: Metadata = {
  title: 'Smart Real Estate Platform - Agriculture',
  description: 'The future of agriculture is here with Smart Real Estate Platform - Agriculture. Powered by cutting-edge AI, this platform delivers testing automation like neve',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-real-estate-platform-agriculture-4aa12861',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Real Estate Platform - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Smart Real Estate Platform - Agriculture. Powered by cutting-edge AI, this platform delivers testing automation like never before.
          </p>
