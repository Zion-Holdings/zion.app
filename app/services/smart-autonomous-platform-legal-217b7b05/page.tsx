...
export const metadata: Metadata = {
  title: 'Smart Autonomous Platform - Legal',
  description: 'Optimize your legal workflows with Smart Autonomous Platform - Legal. This intelligent platform delivers market analysis through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-autonomous-platform-legal-217b7b05',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Autonomous Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with Smart Autonomous Platform - Legal. This intelligent platform delivers market analysis through advanced automation and AI.
          </p>
