...
export const metadata: Metadata = {
  title: 'Adaptive Document Analyzer',
  description: 'Transform your proptech operations with our Adaptive Document Analyzer. This AI-driven solution automates financial risk management with unprecedented accuracy ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Document Analyzer
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your proptech operations with our Adaptive Document Analyzer. This AI-driven solution automates financial risk management with unprecedented accuracy and efficiency.
          </p>
