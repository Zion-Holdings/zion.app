...
export const metadata: Metadata = {
  title: 'Autonomous Cloud for Healthcare',
  description: 'Transform your healthcare operations with our Autonomous Cloud for Healthcare. This AI-driven solution automates fraud prevention with unprecedented accuracy an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-cloud-for-healthcare-85e2c9e7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Cloud for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Autonomous Cloud for Healthcare. This AI-driven solution automates fraud prevention with unprecedented accuracy and efficiency.
          </p>
