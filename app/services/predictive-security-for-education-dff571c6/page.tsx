export const metadata = {
  title: "Predictive Security for Education",
  description: "Zion Tech Group delivers Predictive Security for Education with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/services/predictive-security-for-education-dff571c6/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>Predictive Security for Education</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers Predictive Security for Education with measurable outcomes.
      </p>
