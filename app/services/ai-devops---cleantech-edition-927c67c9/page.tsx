...
export const metadata: Metadata = {
  title: 'AI DevOps - Cleantech Edition',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI DevOps - Cleantech Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cleantech through intelligent automation. Our AI DevOps - Cleantech Edition leverages advanced machine learning to deliver quality control at scale.
          </p>
