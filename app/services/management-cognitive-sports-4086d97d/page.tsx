...
export const metadata: Metadata = {
  title: 'Management Cognitive - Sports',
  description: 'Drive innovation in sports with Management Cognitive - Sports. This AI-powered platform transforms compliance automation into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/management-cognitive-sports-4086d97d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Management Cognitive - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in sports with Management Cognitive - Sports. This AI-powered platform transforms compliance automation into a competitive advantage.
          </p>
