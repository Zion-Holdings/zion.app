...
export const metadata: Metadata = {
  title: 'Automation Anywhere AI-Powered Data Lineage',
  description: 'AI-powered automation anywhere solution for data governance. Automated tracking of data flow from source to consumption.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automation-anywhere-ai-powered-data-lineage-c527356e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automation Anywhere AI-Powered Data Lineage
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered automation anywhere solution for data governance. Automated tracking of data flow from source to consumption.
          </p>
