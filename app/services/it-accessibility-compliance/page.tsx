...
export const metadata: Metadata = {
  ...
  keywords: 'WCAG 2.1 AA compliance audit, Automated accessibility scanning, Manual testing with assistive technologies, Remediation guidance and implementation, VPAT and accessibility statement creation, Ongoing monitoring and alerting, Training for developers and content teams, Legal compliance documentation, it, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Accessibility Compliance &amp; Digital Inclusion</h1>
        <p className="text-lg text-slate-300 mb-8">Digital accessibility compliance for WCAG 2.1, ADA, and Section 508. Audits, remediation, and ongoing monitoring to ensure your digital properties are accessible to all.</p>
        ...
        <li class="text-slate-300">WCAG 2.1 AA compliance audit</li>
        <li class="text-slate-300">Automated accessibility scanning</li>
        <li class="text-slate-300">Manual testing with assistive technologies</li>
        <li class="text-slate-300">Remediation guidance and implementation</li>
        <li class="text-slate-300">VPAT and accessibility statement creation</li>
        <li class="text-slate-300">Ongoing monitoring and alerting</li>
        <li class="text-slate-300">Training for developers and content teams</li>
        <li class="text-slate-300">Legal compliance documentation</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Achieve WCAG 2.1 AA compliance</li>
        <li class="text-slate-300">Reduce legal risk of accessibility lawsuits</li>
        <li class="text-slate-300">Reach 15% more users with accessible design</li>
        <li class="text-slate-300">Demonstrate commitment to digital inclusion</li>
      </ul>
        </div>
