...
export const metadata = {
  ...
  description: 'End-to-end distributed tracing with jaeger and zipkin: debug microservices without log dumps services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/distributed-tracing-with-jaeger-and-zipkin-debug-microservices-without-log-dumps-44/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">Distributed Tracing with Jaeger and Zipkin: Debug Microservices Without Log Dumps</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end distributed tracing with jaeger and zipkin: debug microservices without log dumps services: assessment, deployment, and managed operations.
        </p>
