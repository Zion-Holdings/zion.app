...
export const metadata: Metadata = {
  title: 'AI-Powered Management for Telecom',
  description: 'Transform your telecom operations with our AI-Powered Management for Telecom. This AI-driven solution automates resource optimization with unprecedented accurac',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Management for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your telecom operations with our AI-Powered Management for Telecom. This AI-driven solution automates resource optimization with unprecedented accuracy and efficiency.
          </p>
