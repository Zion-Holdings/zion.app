...
export const metadata: Metadata = {
  title: 'Enterprise Tactical Platform - EDTECH',
  description: 'Revolutionize edtech through intelligent automation. Our Enterprise Tactical Platform - EDTECH leverages advanced machine learning to deliver incident response ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-tactical-platform-edtech-1f758f10',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Tactical Platform - EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize edtech through intelligent automation. Our Enterprise Tactical Platform - EDTECH leverages advanced machine learning to deliver incident response at scale.
          </p>
