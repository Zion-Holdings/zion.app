...
export const metadata: Metadata = {
  title: 'Cognitive Business Intelligence Solution - Sports',
  description: 'The future of sports is here with Cognitive Business Intelligence Solution - Sports. Powered by cutting-edge AI, this platform delivers pipeline management like',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-business-intelligence-solution-sports-6ea4e939',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Business Intelligence Solution - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Cognitive Business Intelligence Solution - Sports. Powered by cutting-edge AI, this platform delivers pipeline management like never before.
          </p>
