...
export const metadata: Metadata = {
  ...
  keywords: 'SAST/DAST scanning in CI/CD, Container image scanning, Infrastructure as Code scanning, Secret detection, Compliance gates, Developer-friendly remediation, Integration with GitHub, GitLab, Jenkins, Security metrics dashboard, it, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">DevSecOps Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Integrate security into CI/CD pipelines. Automated security scanning, compliance gates, and developer-friendly security tools for shift-left security.</p>
        ...
        <li class="text-slate-300">SAST/DAST scanning in CI/CD</li>
        <li class="text-slate-300">Container image scanning</li>
        <li class="text-slate-300">Infrastructure as Code scanning</li>
        <li class="text-slate-300">Secret detection</li>
        <li class="text-slate-300">Compliance gates</li>
        <li class="text-slate-300">Developer-friendly remediation</li>
        <li class="text-slate-300">Integration with GitHub, GitLab, Jenkins</li>
        <li class="text-slate-300">Security metrics dashboard</li>
      </ul>
        </div>
        ...
        <li class="text-slate-300">Reduce vulnerabilities in production</li>
        <li class="text-slate-300">Automate compliance checking</li>
        <li class="text-slate-300">Developer-friendly security</li>
      </ul>
        </div>
