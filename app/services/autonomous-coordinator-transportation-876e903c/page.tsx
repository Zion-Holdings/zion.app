...
export const metadata: Metadata = {
  title: 'Autonomous coordinator-transportation',
  description: 'Next-generation transportation solution: Autonomous coordinator-transportation. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-coordinator-transportation-876e903c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous coordinator-transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation transportation solution: Autonomous coordinator-transportation. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
