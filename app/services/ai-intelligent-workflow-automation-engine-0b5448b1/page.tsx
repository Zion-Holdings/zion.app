...
export const metadata: Metadata = {
  title: 'AI Intelligent Workflow Automation Engine',
  description: 'AI-powered ai solution for workflow. AI-powered workflow automation that learns from user behavior to optimize processes.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-intelligent-workflow-automation-engine-0b5448b1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Intelligent Workflow Automation Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered ai solution for workflow. AI-powered workflow automation that learns from user behavior to optimize processes.
          </p>
