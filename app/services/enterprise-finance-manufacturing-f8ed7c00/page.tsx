...
export const metadata: Metadata = {
  title: 'Enterprise finance-manufacturing',
  description: 'Next-generation manufacturing solution: Enterprise finance-manufacturing. Combines financial risk management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-finance-manufacturing-f8ed7c00',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation manufacturing solution: Enterprise finance-manufacturing. Combines financial risk management with adaptive intelligence for optimal results.
          </p>
