...
export const metadata: Metadata = {
  title: 'Generator Adaptive - Legal',
  description: 'The future of legal is here with Generator Adaptive - Legal. Powered by cutting-edge AI, this platform delivers brand sentiment like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/generator-adaptive-legal-6bcc5465',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Generator Adaptive - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Generator Adaptive - Legal. Powered by cutting-edge AI, this platform delivers brand sentiment like never before.
          </p>
