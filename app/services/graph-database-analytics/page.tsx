...
export const metadata: Metadata = {
  ...
  keywords: 'Neo4j cluster + GDS (community/pagerank), Knowledge graph from internal docs + relations, Relationship query builder UI, Shortest-path + link-prediction for recommendations, Visual graph explorer + dashboard, data, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Graph Database &amp; Analytics</h1>
        <p className="text-lg text-slate-300 mb-8">Graph database: fraud rings, social networks, knowledge graphs, recommendation engine. Neo4j + GDS — community detection, centrality, shortest-path, link prediction, visual dashboard.</p>
        ...
        <li class="text-slate-300">Neo4j cluster + GDS (community/pagerank)</li>
        <li class="text-slate-300">Knowledge graph from internal docs + relations</li>
        <li class="text-slate-300">Relationship query builder UI</li>
        <li class="text-slate-300">Shortest-path + link-prediction for recommendations</li>
        <li class="text-slate-300">Visual graph explorer + dashboard</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with graph database &amp; analytics</li>
