...
export const metadata: Metadata = {
  ...
  description: 'Transform your construction operations with our Autonomous Monitoring for Construction. This AI-driven solution automates network optimization with unprecedente',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-monitoring-for-construction-0ded79fb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Autonomous Monitoring for Construction. This AI-driven solution automates network optimization with unprecedented accuracy and efficiency.
          </p>
