...
export const metadata: Metadata = {
  ...
  keywords: 'Smart categorization, Priority scoring, Auto-draft replies, Reply-all verification, Sentiment analysis, Follow-up reminders, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Micro-SAAS AI Smart Email Responder</h1>
        <p className="text-lg text-slate-300 mb-8">Intelligent email management that categorizes, prioritizes, drafts replies, and sends responses with human-in-the-loop approval.</p>
        ...
        <li class="text-slate-300">Smart categorization</li>
        <li class="text-slate-300">Priority scoring</li>
        <li class="text-slate-300">Auto-draft replies</li>
        <li class="text-slate-300">Reply-all verification</li>
        <li class="text-slate-300">Sentiment analysis</li>
        <li class="text-slate-300">Follow-up reminders</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Inbox zero every day</li>
        <li class="text-slate-300">Never miss important emails</li>
        <li class="text-slate-300">Consistent response quality</li>
        <li class="text-slate-300">10x faster email processing</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">39</p>
