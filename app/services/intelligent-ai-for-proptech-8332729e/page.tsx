...
export const metadata: Metadata = {
  title: 'Intelligent AI for PROPTECH',
  description: 'Next-generation proptech solution: Intelligent AI for PROPTECH. Combines inventory optimization with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-ai-for-proptech-8332729e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent AI for PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation proptech solution: Intelligent AI for PROPTECH. Combines inventory optimization with adaptive intelligence for optimal results.
          </p>
