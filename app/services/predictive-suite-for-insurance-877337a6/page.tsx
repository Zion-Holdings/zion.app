...
export const metadata: Metadata = {
  title: 'Predictive Suite for Insurance',
  description: 'Next-generation insurance solution: Predictive Suite for Insurance. Combines maintenance scheduling with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-suite-for-insurance-877337a6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Suite for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Predictive Suite for Insurance. Combines maintenance scheduling with adaptive intelligence for optimal results.
          </p>
