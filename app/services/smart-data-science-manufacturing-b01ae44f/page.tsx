...
export const metadata: Metadata = {
  title: 'Smart data science-manufacturing',
  description: 'Future-proof your manufacturing with Smart data science-manufacturing. Our autonomous solution handles financial planning end-to-end without human intervention.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-data-science-manufacturing-b01ae44f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart data science-manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your manufacturing with Smart data science-manufacturing. Our autonomous solution handles financial planning end-to-end without human intervention.
          </p>
