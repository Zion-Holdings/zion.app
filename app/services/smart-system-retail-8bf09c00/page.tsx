...
export const metadata: Metadata = {
  title: 'Smart system-retail',
  description: 'Transform your retail operations with our Smart system-retail. This AI-driven solution automates roi tracking with unprecedented accuracy and efficiency.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-system-retail-8bf09c00',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our Smart system-retail. This AI-driven solution automates roi tracking with unprecedented accuracy and efficiency.
          </p>
