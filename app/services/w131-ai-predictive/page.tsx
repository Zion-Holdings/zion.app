...
export const metadata: Metadata = {
  ...
  keywords: 'AutoML, Demand forecasting, Risk assessment, Customer churn prediction, Anomaly detection, Explainable AI, Automated feature engineering, What-if analysis, ai-services, ai-and-ml, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Predictive Analytics Platform</h1>
        <p className="text-lg text-slate-300 mb-8">No-code predictive analytics for business forecasting, demand planning, and risk assessment. AutoML with explainable AI and automated feature engineering.</p>
        ...
        <li class="text-slate-300">AutoML</li>
        ...
        <li class="text-slate-300">Automated feature engineering</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">No data science team needed</li>
        <li class="text-slate-300">80% faster model deployment</li>
        <li class="text-slate-300">Explainable predictions</li>
        <li class="text-slate-300">Automated feature engineering</li>
