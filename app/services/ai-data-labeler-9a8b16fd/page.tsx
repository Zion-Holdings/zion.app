...
export const metadata: Metadata = {
  ...
  description: 'Automatically labels training data for machine learning models with human-in-the-loop validation.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-data-labeler-9a8b16fd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automatically labels training data for machine learning models with human-in-the-loop validation.
          </p>
