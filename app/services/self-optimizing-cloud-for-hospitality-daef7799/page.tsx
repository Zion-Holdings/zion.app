...
export const metadata: Metadata = {
  title: 'Self-Optimizing Cloud for Hospitality',
  description: 'Optimize your hospitality workflows with Self-Optimizing Cloud for Hospitality. This intelligent platform delivers fraud prevention through advanced automation ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/self-optimizing-cloud-for-hospitality-daef7799',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Cloud for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Self-Optimizing Cloud for Hospitality. This intelligent platform delivers fraud prevention through advanced automation and AI.
          </p>
