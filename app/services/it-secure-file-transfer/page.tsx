...
export const metadata: Metadata = {
  ...
  keywords: 'PGP/GPG encryption, AS2 protocol support, Workflow automation, Compliance reports (HIPAA, PCI), Detailed audit logs, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Secure File Transfer (MFT)</h1>
        <p className="text-lg text-slate-300 mb-8">Managed file transfer with end-to-end encryption, audit trails, and automated scheduling. Supports SFTP, FTPS, AS2, and HTTPS.</p>
        ...
        <li class="text-slate-300">PGP/GPG encryption</li>
        <li class="text-slate-300">AS2 protocol support</li>
        <li class="text-slate-300">Workflow automation</li>
        <li class="text-slate-300">Compliance reports (HIPAA, PCI)</li>
        <li class="text-slate-300">Detailed audit logs</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with secure file transfer (mft)</li>
