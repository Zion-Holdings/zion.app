...
export const metadata: Metadata = {
  ...
  keywords: 'Churn scoring, Root cause analysis, Automated retention campaigns, Win-back offers, CRM integration, Health scoring, Early warning alerts, What-if analysis, ai, SaaS, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Customer Churn Prediction &amp; Prevention</h1>
        <p className="text-lg text-slate-300 mb-8">Predict which customers are at risk of leaving, understand why, and trigger automated retention campaigns. Integrates with CRM, billing, and support systems.</p>
        ...
        <li class="text-slate-300">Churn scoring</li>
        <li class="text-slate-300">Root cause analysis</li>
        <li class="text-slate-300">Automated retention campaigns</li>
        <li class="text-slate-300">Win-back offers</li>
        <li class="text-slate-300">CRM integration</li>
        <li class="text-slate-300">Health scoring</li>
        <li class="text-slate-300">Early warning alerts</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">40% reduction in churn</li>
        <li class="text-slate-300">Predictive 6+ months ahead</li>
        <li class="text-slate-300">Automated retention</li>
