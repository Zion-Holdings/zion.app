...
export const metadata = {
  title: 'Service - AI-Powered SaaS Solution',
      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Churn scoring</li>
            <li className="text-purple-300">✓ Root cause analysis</li>
            <li className="text-purple-300">✓ Automated retention campaigns</li>
            <li className="text-purple-300">✓ Win-back offers</li>
            <li className="text-purple-300">✓ CRM integration</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ 40% reduction in churn</li>
            <li className="text-purple-300">✓ Predictive 6+ months ahead</li>
            <li className="text-purple-300">✓ Automated retention</li>
            <li className="text-purple-300">✓ Actionable insights</li>
            </ul>
          </div>
