...
export const metadata: Metadata = {
  title: 'Social Media Management Multi-Cloud Cost Management Platform',
  description: 'social media management solution for border services industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/social-media-management-multi-cloud-cost-management-platform-9f31dd0d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Social Media Management Multi-Cloud Cost Management Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            social media management solution for border services industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.
          </p>
