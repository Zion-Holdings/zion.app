...
export const metadata: Metadata = {
  title: 'AI/IT Insights Suite - AITECH #2',
  description: 'Revolutionize aitech through intelligent automation. Our AI/IT Insights Suite - AITECH #2 leverages advanced machine learning to deliver inventory management at',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-insights-suite-aitech-2-9ff2a8f2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Insights Suite - AITECH #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize aitech through intelligent automation. Our AI/IT Insights Suite - AITECH #2 leverages advanced machine learning to deliver inventory management at scale.
          </p>
