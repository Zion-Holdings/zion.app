...
export const metadata: Metadata = {
  title: 'Quantum Healthcare - AITECH Quantum',
  description: 'Transform your aitech operations with our Quantum Healthcare - AITECH Quantum. This AI-driven solution automates vendor management with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-healthcare-aitech-quantum-2262dae4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Healthcare - AITECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your aitech operations with our Quantum Healthcare - AITECH Quantum. This AI-driven solution automates vendor management with unprecedented accuracy and efficiency.
          </p>
