...
export const metadata: Metadata = {
  title: 'Next-Gen Financial for CLEANTECH',
  description: 'Next-generation cleantech solution: Next-Gen Financial for CLEANTECH. Combines claims processing with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-financial-for-cleantech-413debe0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Financial for CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation cleantech solution: Next-Gen Financial for CLEANTECH. Combines claims processing with adaptive intelligence for optimal results.
          </p>
