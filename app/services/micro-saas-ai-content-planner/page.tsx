...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'AI Content Strategy & SEO Planner', 'description': 'AI-driven content strategy platform that identifies content gaps, generates topic clusters, and optimizes for SEO. Includes AI writing assistant, content calendar, and performance tracking.', 'serviceType': 'ai', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'marketing'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'AI Content Strategy & SEO Planner Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$79/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$249/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': 'Custom', 'priceCurrency': 'USD'}]}} />
    <JsonLd data={'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'AI content gap analysis vs competitors', 'acceptedAnswer': {'@type': 'Answer', 'text': 'AI content gap analysis vs competitors'}}, {'@type': 'Question', 'name': 'Topic cluster and pillar page planning', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Topic cluster and pillar page planning'}}, {'@type': 'Question', 'name': 'AI writing assistant with brand voice', 'acceptedAnswer': {'@type': 'Answer', 'text': 'AI writing assistant with brand voice'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Rank for 3x more keywords in 6 months; Create content 5x faster with AI; Align content strategy with revenue goals'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} />
