...
export const metadata: Metadata = {
  ...
  keywords: 'AI content gap analysis vs competitors, Topic cluster and pillar page planning, AI writing assistant with brand voice, SEO optimization scoring in real-time, Content calendar with team collaboration, Performance tracking and ROI attribution, Integration with WordPress, Webflow, HubSpot, Content refresh recommendations based on rankings, ai, marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Content Strategy &amp; SEO Planner</h1>
        <p className="text-lg text-slate-300 mb-8">AI-driven content strategy platform that identifies content gaps, generates topic clusters, and optimizes for SEO. Includes AI writing assistant, content calendar, and performance tracking.</p>
        ...
        <li class="text-slate-300">AI content gap analysis vs competitors</li>
        <li class="text-slate-300">Topic cluster and pillar page planning</li>
        <li class="text-slate-300">AI writing assistant with brand voice</li>
        <li class="text-slate-300">SEO optimization scoring in real-time</li>
        <li class="text-slate-300">Content calendar with team collaboration</li>
        <li class="text-slate-300">Performance tracking and ROI attribution</li>
        <li class="text-slate-300">Integration with WordPress, Webflow, HubSpot</li>
        <li class="text-slate-300">Content refresh recommendations based on rankings</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Rank for 3x more keywords in 6 months</li>
        <li class="text-slate-300">Create content 5x faster with AI</li>
        <li class="text-slate-300">Align content strategy with revenue goals</li>
        <li class="text-slate-300">Automate content performance reporting</li>
      </ul>
        </div>
