  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Real-time transaction monitoring with graph-based anomaly detection, behavioral biometrics, and adaptive ML models. Scores every transaction in under 50ms, reduces false positives by 80%, and integrates with payment processors for instant blocking.</p>
        ...
        <li class="text-slate-300">Real-time transaction scoring (&lt;50ms latency)</li>
        <li class="text-slate-300">Graph-based fraud ring detection</li>
        <li class="text-slate-300">Behavioral biometrics (keystroke, device fingerprint)</li>
        <li class="text-slate-300">Adaptive ML with online learning from feedback</li>
        <li class="text-slate-300">Multi-channel monitoring (card, ACH, wire, crypto)</li>
        <li class="text-slate-300">Case management with SAR auto-generation</li>
        <li class="text-slate-300">Model explainability for regulatory compliance</li>
        <li class="text-slate-300">Integration with Stripe, Adyen, Fiserv, Plaid</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">80% reduction in false-positive decline rates</li>
        <li class="text-slate-300">Detect fraud rings invisible to rule-based systems</li>
        <li class="text-slate-300">Sub-50ms scoring — no customer experience impact</li>
        <li class="text-slate-300">Regulatory-ready with explainable AI &amp; SAR generation</li>
      </ul>
        </div>
