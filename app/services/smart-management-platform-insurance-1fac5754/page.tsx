...
export const metadata: Metadata = {
  title: 'Smart Management Platform - Insurance',
  description: 'Unlock unprecedented growth with Smart Management Platform - Insurance. This autonomous system provides influencer identification with zero manual intervention ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-management-platform-insurance-1fac5754',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Management Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Management Platform - Insurance. This autonomous system provides influencer identification with zero manual intervention needed.
          </p>
