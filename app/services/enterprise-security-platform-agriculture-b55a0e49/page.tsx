...
export const metadata: Metadata = {
  title: 'Enterprise Security Platform - Agriculture',
  description: 'Transform your agriculture operations with our Enterprise Security Platform - Agriculture. This AI-driven solution automates insurance automation with unprecede',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-security-platform-agriculture-b55a0e49',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Security Platform - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Enterprise Security Platform - Agriculture. This AI-driven solution automates insurance automation with unprecedented accuracy and efficiency.
          </p>
