...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'AI-Assisted Code Migration & Refactoring', 'description': 'Automate legacy codebase modernization: convert jQuery to React, Python 2 to 3, AngularJS to modern frameworks with semantic-preserving transformations.', 'serviceType': 'ai', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'commercial@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'General'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'AI-Assisted Code Migration & Refactoring Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$149/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$449/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': '$1,499/mo', 'priceCurrency': 'USD'}]}} />
    <JsonLd data={'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'Language-to-language AST-based translation', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Language-to-language AST-based translation'}}, {'@type': 'Question', 'name': 'Preserve business logic & edge cases', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Preserve business logic & edge cases'}}, {'@type': 'Question', 'name': 'Interactive migration playground (preview changes)', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Interactive migration playground (preview changes)'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Reduce costs with ai-assisted code migration & refactoring; Improve operational efficiency; Scale without complexity'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} />
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path={`/services/ai-for-code-migration`} title="AI-Assisted Code Migration & Refactoring" />
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce costs with ai-assisted code migration & refactoring</li>
