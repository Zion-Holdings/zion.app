      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Automate legacy codebase modernization: convert jQuery to React, Python 2 to 3, AngularJS to modern frameworks with semantic-preserving transformations.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Language-to-language AST-based translation</li>
            <li className="text-purple-300">✓ Preserve business logic & edge cases</li>
            <li className="text-purple-300">✓ Interactive migration playground (preview changes)</li>
            <li className="text-purple-300">✓ Test generation for migrated functions</li>
            <li className="text-purple-300">✓ Gradual cutover strategy planning</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai-assisted code migration & refactoring</li>
