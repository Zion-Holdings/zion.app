...
export const metadata: Metadata = {
  title: 'Neural Platform for Hospitality',
  description: 'Unlock unprecedented growth with Neural Platform for Hospitality. This autonomous system provides customer insights with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-platform-for-hospitality-1ba4cd47',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Platform for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Neural Platform for Hospitality. This autonomous system provides customer insights with zero manual intervention needed.
          </p>
