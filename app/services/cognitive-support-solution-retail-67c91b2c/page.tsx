...
export const metadata: Metadata = {
  title: 'Cognitive Support Solution - Retail',
  description: 'Drive innovation in retail with Cognitive Support Solution - Retail. This AI-powered platform transforms customer service automation into a competitive advantag',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-support-solution-retail-67c91b2c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Support Solution - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in retail with Cognitive Support Solution - Retail. This AI-powered platform transforms customer service automation into a competitive advantage.
          </p>
