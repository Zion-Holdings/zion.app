...
export const metadata: Metadata = {
  title: 'Smart generator-edge',
  description: 'Next-generation edge solution: Smart generator-edge. Combines document processing with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-generator-edge-7ffa9614',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart generator-edge
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation edge solution: Smart generator-edge. Combines document processing with adaptive intelligence for optimal results.
          </p>
