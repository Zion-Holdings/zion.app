...
export const metadata: Metadata = {
  title: 'Intelligent Data Compliance',
  description: 'The future of education is here with Intelligent Data Compliance. Powered by cutting-edge AI, this platform delivers transformative results like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-data-compliance-697acc56',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of education is here with Intelligent Data Compliance. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
