...
export const metadata: Metadata = {
  title: 'Smart Autonomous - Retail',
  description: 'Next-generation retail solution: Smart Autonomous - Retail. Combines reputation management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-autonomous-retail-7e0ced6b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Autonomous - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation retail solution: Smart Autonomous - Retail. Combines reputation management with adaptive intelligence for optimal results.
          </p>
