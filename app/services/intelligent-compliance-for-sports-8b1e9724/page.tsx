...
export const metadata: Metadata = {
  title: 'Intelligent Compliance for Sports',
  description: 'Unlock unprecedented growth with Intelligent Compliance for Sports. This autonomous system provides feedback collection with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-compliance-for-sports-8b1e9724',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Compliance for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Compliance for Sports. This autonomous system provides feedback collection with zero manual intervention needed.
          </p>
