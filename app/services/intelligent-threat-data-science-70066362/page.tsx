...
export const metadata: Metadata = {
  title: 'Intelligent Threat Data Science',
  description: 'Enhance your healthcare business with Intelligent Threat Data Science. Our solution provides logistics route optimization with enterprise-grade reliability and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-threat-data-science-70066362',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Threat Data Science
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with Intelligent Threat Data Science. Our solution provides logistics route optimization with enterprise-grade reliability and security.
          </p>
