...
export const metadata: Metadata = {
  title: 'AI-Powered Performance for Logistics',
  description: 'Revolutionize logistics through intelligent automation. Our AI-Powered Performance for Logistics leverages advanced machine learning to deliver data processing ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Performance for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our AI-Powered Performance for Logistics leverages advanced machine learning to deliver data processing at scale.
          </p>
