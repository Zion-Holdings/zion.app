...
export const metadata: Metadata = {
  title: 'Performance Adaptive - Logistics',
  description: 'Transform your logistics operations with our Performance Adaptive - Logistics. This AI-driven solution automates performance reviews with unprecedented accuracy',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/performance-adaptive-logistics-80750ea8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Performance Adaptive - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Performance Adaptive - Logistics. This AI-driven solution automates performance reviews with unprecedented accuracy and efficiency.
          </p>
