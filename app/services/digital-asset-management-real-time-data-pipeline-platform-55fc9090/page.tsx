...
export const metadata: Metadata = {
  title: 'Digital Asset Management Real-Time Data Pipeline Platform',
  description: 'digital asset management solution for entertainment industry. Creates and manages real-time data pipelines with automated ETL and streaming analytics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/digital-asset-management-real-time-data-pipeline-platform-55fc9090',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Digital Asset Management Real-Time Data Pipeline Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            digital asset management solution for entertainment industry. Creates and manages real-time data pipelines with automated ETL and streaming analytics.
          </p>
