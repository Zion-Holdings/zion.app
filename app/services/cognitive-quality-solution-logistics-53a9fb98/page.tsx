...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize logistics through intelligent automation. Our Cognitive Quality Solution - Logistics leverages advanced machine learning to deliver content genera',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Cognitive Quality Solution - Logistics leverages advanced machine learning to deliver content generation at scale.
          </p>
