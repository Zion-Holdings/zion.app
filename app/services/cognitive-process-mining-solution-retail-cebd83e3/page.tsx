...
export const metadata: Metadata = {
  title: 'Cognitive Process Mining Solution - Retail',
  description: 'Enhance your retail business with Cognitive Process Mining Solution - Retail. Our solution provides sourcing optimization with enterprise-grade reliability and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-process-mining-solution-retail-cebd83e3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Process Mining Solution - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your retail business with Cognitive Process Mining Solution - Retail. Our solution provides sourcing optimization with enterprise-grade reliability and security.
          </p>
