...
export const metadata: Metadata = {
  ...
  keywords: 'Automated data discovery, AI classification and tagging, Data lineage tracking, Access policy enforcement, PII detection and masking, Integration with data warehouses and lakes, Business glossary, Data stewardship workflows, data, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Data Catalog &amp; Governance Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Automated data catalog with AI-powered classification, lineage tracking, and governance policies. Discover, understand, and govern data assets across the enterprise.</p>
        ...
        <li class="text-slate-300">Automated data discovery</li>
        <li class="text-slate-300">AI classification and tagging</li>
        <li class="text-slate-300">Data lineage tracking</li>
        <li class="text-slate-300">Access policy enforcement</li>
        <li class="text-slate-300">PII detection and masking</li>
        <li class="text-slate-300">Integration with data warehouses and lakes</li>
        <li class="text-slate-300">Business glossary</li>
        <li class="text-slate-300">Data stewardship workflows</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Discover all data assets automatically</li>
        <li class="text-slate-300">Ensure data governance compliance</li>
        <li class="text-slate-300">Track data lineage end-to-end</li>
        <li class="text-slate-300">Enable self-service analytics</li>
      </ul>
        </div>
