...
export const metadata = {
  ...
  description: "Automated data catalog with AI-powered classification, lineage tracking, and governance policies. Discover, understand, and govern data assets across the enterp",
  alternates: {
