...
export const metadata: Metadata = {
  title: 'Data Smart - Telecom',
  description: 'Optimize your telecom workflows with Data Smart - Telecom. This intelligent platform delivers survey automation through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-smart-telecom-d1322c95',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your telecom workflows with Data Smart - Telecom. This intelligent platform delivers survey automation through advanced automation and AI.
          </p>
