...
export const metadata: Metadata = {
  title: 'Cognitive healthcare-transportation',
  description: 'Enhance your transportation business with Cognitive healthcare-transportation. Our solution provides pricing optimization with enterprise-grade reliability and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-healthcare-transportation-36f94c8d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive healthcare-transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with Cognitive healthcare-transportation. Our solution provides pricing optimization with enterprise-grade reliability and security.
          </p>
