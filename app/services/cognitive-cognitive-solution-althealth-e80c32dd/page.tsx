...
export const metadata: Metadata = {
  title: 'Cognitive Cognitive Solution - ALTHEALTH',
  description: 'Revolutionize althealth through intelligent automation. Our Cognitive Cognitive Solution - ALTHEALTH leverages advanced machine learning to deliver microservice',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Cognitive Solution - ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize althealth through intelligent automation. Our Cognitive Cognitive Solution - ALTHEALTH leverages advanced machine learning to deliver microservices mesh at scale.
          </p>
