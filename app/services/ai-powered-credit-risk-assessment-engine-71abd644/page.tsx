...
export const metadata: Metadata = {
  title: 'AI-Powered Credit Risk Assessment Engine',
  description: 'Real-time credit risk scoring using alternative data, behavioral patterns, and predictive analytics. Reduces default rates by 45% while maintaining approval rat',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-credit-risk-assessment-engine-71abd644',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Real-time credit risk scoring using alternative data, behavioral patterns, and predictive analytics. Reduces default rates by 45% while maintaining approval rates.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Alternative data scoring</li>
          <li className="text-gray-300">Default prediction</li>
          <li className="text-gray-300">Approval optimization</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">45% default reduction</li>
