...
export const metadata: Metadata = {
  title: 'Smart Optimization Platform - Agriculture',
  description: 'Optimize your agriculture workflows with Smart Optimization Platform - Agriculture. This intelligent platform delivers project portfolio through advanced automa',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-optimization-platform-agriculture-0d11ff92',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Optimization Platform - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your agriculture workflows with Smart Optimization Platform - Agriculture. This intelligent platform delivers project portfolio through advanced automation and AI.
          </p>
