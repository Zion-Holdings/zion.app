...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize sports through intelligent automation. Our Intelligent Platform for Sports leverages advanced machine learning to deliver workflow management at s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Intelligent Platform for Sports leverages advanced machine learning to deliver workflow management at scale.
          </p>
