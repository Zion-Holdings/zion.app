  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Process Mining &amp; Optimization Platform</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered process mining that discovers, monitors, and optimizes business processes from event logs. Identify bottlenecks, deviations, and automation opportunities.</p>
        ...
        <li class="text-slate-300">Automated process discovery from event logs</li>
        <li class="text-slate-300">Conformance checking and deviation detection</li>
        <li class="text-slate-300">Bottleneck identification and root cause analysis</li>
        <li class="text-slate-300">Process simulation and what-if analysis</li>
        <li class="text-slate-300">Integration with SAP, Salesforce, ServiceNow</li>
        <li class="text-slate-300">Real-time process monitoring dashboards</li>
        <li class="text-slate-300">Automation opportunity identification</li>
        <li class="text-slate-300">Compliance and audit trail generation</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce process cycle time by 35%</li>
        <li class="text-slate-300">Identify automation opportunities worth millions</li>
        <li class="text-slate-300">Ensure compliance with automated conformance checking</li>
        <li class="text-slate-300">Optimize processes with data-driven insights</li>
      </ul>
        </div>
