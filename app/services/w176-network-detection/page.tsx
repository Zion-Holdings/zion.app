...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{'@context': 'https://schema.org', '@type': 'Service', 'name': 'Network Detection & Response (NDR)', 'description': 'Network-level threat detection: traffic analysis, lateral movement detection, encrypted traffic inspection, and beacon detection. See what EDR misses.', 'serviceType': 'security', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'Cybersecurity'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'Network Detection & Response (NDR) Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$799/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$2,499/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': '$7,999/mo', 'priceCurrency': 'USD'}]}} }/>
    <JsonLd data={{'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'Full network traffic analysis', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Full network traffic analysis'}}, {'@type': 'Question', 'name': 'Lateral movement and C2 detection', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Lateral movement and C2 detection'}}, {'@type': 'Question', 'name': 'Encrypted traffic inspection (JA3/JA3S)', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Encrypted traffic inspection (JA3/JA3S)'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Detect threats EDR and SIEM miss; See lateral movement across the network; Encrypted traffic inspection without MITM'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} }/>
