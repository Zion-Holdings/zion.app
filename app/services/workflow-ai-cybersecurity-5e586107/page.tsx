...
export const metadata: Metadata = {
  title: 'Workflow AI - Cybersecurity',
  description: 'Quantum leap forward for cybersecurity: Workflow AI - Cybersecurity. Uses quantum-inspired algorithms to deliver cost tracking at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/workflow-ai-cybersecurity-5e586107',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Workflow AI - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for cybersecurity: Workflow AI - Cybersecurity. Uses quantum-inspired algorithms to deliver cost tracking at exponential speed.
          </p>
