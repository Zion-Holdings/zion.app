...
export const metadata: Metadata = {
  title: 'Smart Manager Platform - Logistics',
  description: 'Transform your logistics operations with our Smart Manager Platform - Logistics. This AI-driven solution automates performance tuning with unprecedented accurac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-manager-platform-logistics-56a73629',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manager Platform - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Smart Manager Platform - Logistics. This AI-driven solution automates performance tuning with unprecedented accuracy and efficiency.
          </p>
