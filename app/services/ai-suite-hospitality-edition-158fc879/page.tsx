...
export const metadata: Metadata = {
  title: 'AI Suite - Hospitality Edition',
  description: 'The future of hospitality is here with AI Suite - Hospitality Edition. Powered by cutting-edge AI, this platform delivers transformative results like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-suite-hospitality-edition-158fc879',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Suite - Hospitality Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with AI Suite - Hospitality Edition. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
