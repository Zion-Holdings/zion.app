...
export const metadata: Metadata = {
  title: 'Predictive Influencer Automation',
  description: 'The future of insurance is here with Predictive Influencer Automation. Powered by cutting-edge AI, this platform delivers procurement automation like never befo',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Influencer Automation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Predictive Influencer Automation. Powered by cutting-edge AI, this platform delivers procurement automation like never before.
          </p>
