...
export const metadata: Metadata = {
  ...
  description: 'Optimize your energy workflows with Autonomous Automation System - Energy. This intelligent platform delivers feature engineering through advanced automation an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your energy workflows with Autonomous Automation System - Energy. This intelligent platform delivers feature engineering through advanced automation and AI.
          </p>
