...
export const metadata: Metadata = {
  title: 'Smart Performance Platform - Legal',
  description: 'Enhance your legal business with Smart Performance Platform - Legal. Our solution provides budget optimization with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-performance-platform-legal-f2f4cf9a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Performance Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Smart Performance Platform - Legal. Our solution provides budget optimization with enterprise-grade reliability and security.
          </p>
