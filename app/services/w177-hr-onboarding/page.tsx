...
export const metadata: Metadata = {
  ...
  keywords: 'Offer letter and paperwork automation, Equipment and access provisioning, Training plan and tracking, Manager and buddy assignments, Offboarding and access revocation, Integration with Workday, BambooHR, Rippling, automation, Human Resources, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">HR Onboarding and Offboarding</h1>
        <p className="text-lg text-slate-300 mb-8">Automate HR onboarding: offer letters, paperwork, equipment, training, access. Day-one productivity.</p>
        ...
        <li class="text-slate-300">Offer letter and paperwork automation</li>
        <li class="text-slate-300">Equipment and access provisioning</li>
        <li class="text-slate-300">Training plan and tracking</li>
        <li class="text-slate-300">Manager and buddy assignments</li>
        <li class="text-slate-300">Offboarding and access revocation</li>
        <li class="text-slate-300">Integration with Workday</li>
        <li class="text-slate-300">BambooHR</li>
        <li class="text-slate-300">Rippling</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Day-one productivity for new hires</li>
        <li class="text-slate-300">Paperwork automation reduces HR burden</li>
        <li class="text-slate-300">Training tracking ensures completion</li>
        <li class="text-slate-300">Offboarding security</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$20/employee/mo</p>
