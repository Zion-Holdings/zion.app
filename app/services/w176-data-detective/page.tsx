...
export const metadata: Metadata = {
  ...
  keywords: 'Anomaly triage with root cause hints, Upstream change detection, Pipeline impact analysis, Data reconciliation tools, Historical comparison and diff, Automated fix suggestions, Integration with Airflow, dbt, Snowflake, data, Data Operations, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Data Detective &amp; Root Cause</h1>
        <p className="text-lg text-slate-300 mb-8">Automated data issue investigation: trace anomalies to root cause, identify upstream changes, and fix data pipeline breaks fast.</p>
        ...
        <li class="text-slate-300">Anomaly triage with root cause hints</li>
        <li class="text-slate-300">Upstream change detection</li>
        <li class="text-slate-300">Pipeline impact analysis</li>
        <li class="text-slate-300">Data reconciliation tools</li>
        <li class="text-slate-300">Historical comparison and diff</li>
        <li class="text-slate-300">Automated fix suggestions</li>
        <li class="text-slate-300">Integration with Airflow, dbt, Snowflake</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Find data issue root cause in minutes</li>
        <li class="text-slate-300">Upstream change detection links cause and effect</li>
        <li class="text-slate-300">Impact analysis shows blast radius</li>
        <li class="text-slate-300">Fix suggestions speed remediation</li>
      </ul>
        </div>
