...
export const metadata: Metadata = {
  title: 'AI/IT Risk Suite - PROPTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Risk Suite - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your proptech business with AI/IT Risk Suite - PROPTECH. Our solution provides model interpretability with enterprise-grade reliability and security.
          </p>
