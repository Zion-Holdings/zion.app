...
export const metadata: Metadata = {
  title: 'Intelligent DevOps for PROPTECH',
  description: 'Transform your proptech operations with our Intelligent DevOps for PROPTECH. This AI-driven solution automates quantum computing with unprecedented accuracy and',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent DevOps for PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your proptech operations with our Intelligent DevOps for PROPTECH. This AI-driven solution automates quantum computing with unprecedented accuracy and efficiency.
          </p>
