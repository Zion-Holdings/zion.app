      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Driven User for Saas
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your saaS with AI-Driven User for Saas. Our autonomous solution handles business intelligence end-to-end without human intervention.
          </p>
