...
export const metadata: Metadata = {
  title: 'Engine Intelligent - Media',
  description: 'Transform your media operations with our Engine Intelligent - Media. This AI-driven solution automates social media monitoring with unprecedented accuracy and e',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Engine Intelligent - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your media operations with our Engine Intelligent - Media. This AI-driven solution automates social media monitoring with unprecedented accuracy and efficiency.
          </p>
