...
export const metadata: Metadata = {
  title: 'Smart Supply Platform - PROPTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Supply Platform - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in proptech with Smart Supply Platform - PROPTECH. This AI-powered platform transforms warehouse automation into a competitive advantage.
          </p>
