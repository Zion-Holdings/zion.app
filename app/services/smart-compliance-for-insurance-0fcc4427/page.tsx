...
export const metadata: Metadata = {
  title: 'Smart Compliance for Insurance',
  description: 'Transform your insurance operations with our Smart Compliance for Insurance. This AI-driven solution automates code optimization with unprecedented accuracy and',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Compliance for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Smart Compliance for Insurance. This AI-driven solution automates code optimization with unprecedented accuracy and efficiency.
          </p>
