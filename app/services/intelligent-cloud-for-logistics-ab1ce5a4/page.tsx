...
export const metadata: Metadata = {
  title: 'Intelligent Cloud for Logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Intelligent Cloud for Logistics leverages advanced machine learning to deliver cost reduction at sca',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-cloud-for-logistics-ab1ce5a4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Cloud for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Intelligent Cloud for Logistics leverages advanced machine learning to deliver cost reduction at scale.
          </p>
