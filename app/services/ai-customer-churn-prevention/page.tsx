...
export const metadata: Metadata = {
  ...
  keywords: 'Churn risk scoring, Behavioral anomaly detection, Automated retention campaigns, Win-back workflow builder, Revenue impact forecasting, Integration with CRM and billing, Health score dashboards, Cohort analysis, ai, Customer Success, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Customer Churn Prevention Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Predict and prevent customer churn with AI. Behavioral analysis, early warning alerts, automated retention campaigns, and win-back workflows.</p>
        ...
        <li class="text-slate-300">Behavioral anomaly detection</li>
        <li class="text-slate-300">Automated retention campaigns</li>
        <li class="text-slate-300">Win-back workflow builder</li>
        <li class="text-slate-300">Revenue impact forecasting</li>
        <li class="text-slate-300">Integration with CRM and billing</li>
        <li class="text-slate-300">Health score dashboards</li>
        <li class="text-slate-300">Cohort analysis</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce churn by 25%</li>
        <li class="text-slate-300">Identify at-risk accounts early</li>
        <li class="text-slate-300">Automate retention efforts</li>
        <li class="text-slate-300">Protect revenue</li>
      </ul>
        </div>
