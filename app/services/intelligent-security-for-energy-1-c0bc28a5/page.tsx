...
export const metadata: Metadata = {
  title: 'Intelligent Security for Energy #1',
  description: 'Transform your energy operations with our Intelligent Security for Energy #1. This AI-driven solution automates language processing with unprecedented accuracy ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-security-for-energy-1-c0bc28a5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Security for Energy #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Intelligent Security for Energy #1. This AI-driven solution automates language processing with unprecedented accuracy and efficiency.
          </p>
