...
export const metadata: Metadata = {
  title: 'Intelligent Healthcare for Legal',
  description: 'Revolutionize legal through intelligent automation. Our Intelligent Healthcare for Legal leverages advanced machine learning to deliver customer insights at sca',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-healthcare-for-legal-b8631a0b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Healthcare for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Intelligent Healthcare for Legal leverages advanced machine learning to deliver customer insights at scale.
          </p>
