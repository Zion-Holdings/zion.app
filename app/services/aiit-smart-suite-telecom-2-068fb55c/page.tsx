...
export const metadata: Metadata = {
  title: 'AI/IT Smart Suite - Telecom #2',
  description: 'Enhance your telecom business with AI/IT Smart Suite - Telecom #2. Our solution provides personalization engine with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-smart-suite-telecom-2-068fb55c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Smart Suite - Telecom #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your telecom business with AI/IT Smart Suite - Telecom #2. Our solution provides personalization engine with enterprise-grade reliability and security.
          </p>
