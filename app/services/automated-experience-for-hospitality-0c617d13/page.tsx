...
export const metadata: Metadata = {
  title: 'Automated Experience for Hospitality',
  description: 'Next-generation hospitality solution: Automated Experience for Hospitality. Combines workflow management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-experience-for-hospitality-0c617d13',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Experience for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Automated Experience for Hospitality. Combines workflow management with adaptive intelligence for optimal results.
          </p>
