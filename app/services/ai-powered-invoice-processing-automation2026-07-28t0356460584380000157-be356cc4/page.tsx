...
export const metadata: Metadata = {
  ...
  description: 'Automates invoice processing with OCR, validation, and payment scheduling.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-invoice-processing-automation2026-07-28t0356460584380000157-be356cc4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automates invoice processing with OCR, validation, and payment scheduling.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">OCR processing</li>
          <li className="text-gray-300">Validation automation</li>
          <li className="text-gray-300">Payment scheduling</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">80% faster processing</li>
