      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Automatically discover, qualify, and enrich B2B leads with web scraping, firmographic scoring, and intent signal detection.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Automated lead discovery from public sources</li>
            <li className="text-purple-300">✓ Firmographic enrichment — revenue, tech stack, contacts</li>
            <li className="text-purple-300">✓ Intent signal — hiring, mentions, website visits</li>
            <li className="text-purple-300">✓ CRM auto-sync to Salesforce, HubSpot, Pipedrive</li>
            <li className="text-purple-300">✓ Personalized outreach — email, LinkedIn, sequences</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai lead generation & enrichment</li>
