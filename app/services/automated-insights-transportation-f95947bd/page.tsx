...
export const metadata: Metadata = {
  title: 'Automated insights-transportation',
  description: 'Drive innovation in transportation with Automated insights-transportation. This AI-powered platform transforms predictive analytics into a competitive advantage',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-insights-transportation-f95947bd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated insights-transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in transportation with Automated insights-transportation. This AI-powered platform transforms predictive analytics into a competitive advantage.
          </p>
