...
export const metadata: Metadata = {
  title: 'AI/IT Compliance Suite - Media',
  description: 'Optimize your media workflows with AI/IT Compliance Suite - Media. This intelligent platform delivers resource allocation through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-compliance-suite-media-06ded0ff',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Compliance Suite - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your media workflows with AI/IT Compliance Suite - Media. This intelligent platform delivers resource allocation through advanced automation and AI.
          </p>
