...
export const metadata: Metadata = {
  title: 'Cognitive Platform Solution - Logistics',
  description: 'Drive innovation in logistics with Cognitive Platform Solution - Logistics. This AI-powered platform transforms contract analysis into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-platform-solution-logistics-d07e6960',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Platform Solution - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with Cognitive Platform Solution - Logistics. This AI-powered platform transforms contract analysis into a competitive advantage.
          </p>
