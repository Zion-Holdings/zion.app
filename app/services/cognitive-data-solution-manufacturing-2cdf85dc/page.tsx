...
export const metadata: Metadata = {
  title: 'Cognitive Data Solution - Manufacturing',
  description: 'The future of manufacturing is here with Cognitive Data Solution - Manufacturing. Powered by cutting-edge AI, this platform delivers feature engineering like ne',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Data Solution - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of manufacturing is here with Cognitive Data Solution - Manufacturing. Powered by cutting-edge AI, this platform delivers feature engineering like never before.
          </p>
