...
export const metadata: Metadata = {
  title: 'Healthcare Automated - Retail',
  description: 'Transform your retail operations with our Healthcare Automated - Retail. This AI-driven solution automates customer insights with unprecedented accuracy and eff',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Healthcare Automated - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our Healthcare Automated - Retail. This AI-driven solution automates customer insights with unprecedented accuracy and efficiency.
          </p>
