...
export const metadata: Metadata = {
  ...
  keywords: 'Conversion funnel anomaly per step, Feature-adoption cohort heatmap, Retention waterfall (D1/D7/D30/D90), Session replay auto-clip per anomaly insight, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Product Analytics &amp; AI Insights</h1>
        <p className="text-lg text-slate-300 mb-8">Auto-insights engine: conversion funnel anomaly, feature-adoption cohort, retention waterfall, session replay auto-clip per insight.</p>
        ...
        <li class="text-slate-300">Conversion funnel anomaly per step</li>
        <li class="text-slate-300">Feature-adoption cohort heatmap</li>
        <li class="text-slate-300">Retention waterfall (D1/D7/D30/D90)</li>
        <li class="text-slate-300">Session replay auto-clip per anomaly insight</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with product analytics &amp; ai insights</li>
