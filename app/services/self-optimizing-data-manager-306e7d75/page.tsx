...
export const metadata: Metadata = {
  title: 'Self-Optimizing Data Manager',
  description: 'The future of agritech is here with Self-Optimizing Data Manager. Powered by cutting-edge AI, this platform delivers manufacturing quality control like never be',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Data Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agritech is here with Self-Optimizing Data Manager. Powered by cutting-edge AI, this platform delivers manufacturing quality control like never before.
          </p>
