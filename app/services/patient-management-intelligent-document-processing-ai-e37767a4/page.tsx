...
export const metadata: Metadata = {
  title: 'Patient Management Intelligent Document Processing AI',
  description: 'patient management solution for labor unions industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automat',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/patient-management-intelligent-document-processing-ai-e37767a4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Patient Management Intelligent Document Processing AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            patient management solution for labor unions industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.
          </p>
