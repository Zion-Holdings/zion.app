...
export const metadata: Metadata = {
  title: 'Smart Processor Platform - Legal',
  description: 'Revolutionize legal through intelligent automation. Our Smart Processor Platform - Legal leverages advanced machine learning to deliver network optimization at ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-processor-platform-legal-59ff64dd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Processor Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Smart Processor Platform - Legal leverages advanced machine learning to deliver network optimization at scale.
          </p>
