...
export const metadata: Metadata = {
  title: 'Smart Knowledge Platform - EDTECH #1',
  description: 'Transform your edtech operations with our Smart Knowledge Platform - EDTECH #1. This AI-driven solution automates sales forecasting with unprecedented accuracy ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-knowledge-platform-edtech-1-a6bfcf87',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Knowledge Platform - EDTECH #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your edtech operations with our Smart Knowledge Platform - EDTECH #1. This AI-driven solution automates sales forecasting with unprecedented accuracy and efficiency.
          </p>
