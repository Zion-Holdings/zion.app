...
export const metadata: Metadata = {
  title: 'Next-Gen Smart - Energy',
  description: 'Future-proof your energy with Next-Gen Smart - Energy. Our autonomous solution handles access management end-to-end without human intervention.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-smart-energy-08390e2b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Smart - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your energy with Next-Gen Smart - Energy. Our autonomous solution handles access management end-to-end without human intervention.
          </p>
