...
export const metadata: Metadata = {
  title: 'Intelligent Intelligent for Construction #2',
  description: 'Drive innovation in construction with Intelligent Intelligent for Construction #2. This AI-powered platform transforms roi tracking into a competitive advantage',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-intelligent-for-construction-2-3b6a4791',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Intelligent for Construction #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Intelligent Intelligent for Construction #2. This AI-powered platform transforms roi tracking into a competitive advantage.
          </p>
