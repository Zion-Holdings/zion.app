...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize quantum through intelligent automation. Our Predictive Security Intelligence leverages advanced machine learning to deliver maintenance scheduling',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize quantum through intelligent automation. Our Predictive Security Intelligence leverages advanced machine learning to deliver maintenance scheduling at scale.
          </p>
