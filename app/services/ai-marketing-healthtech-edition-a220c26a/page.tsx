...
export const metadata: Metadata = {
  title: 'AI Marketing - HEALTHTECH Edition',
  description: 'Enhance your healthtech business with AI Marketing - HEALTHTECH Edition. Our solution provides fleet management with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-marketing-healthtech-edition-a220c26a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Marketing - HEALTHTECH Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthtech business with AI Marketing - HEALTHTECH Edition. Our solution provides fleet management with enterprise-grade reliability and security.
          </p>
