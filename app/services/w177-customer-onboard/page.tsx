...
export const metadata: Metadata = {
  ...
  keywords: 'Welcome email and in-app sequences, Setup wizard and configuration, Training content delivery, Success milestone tracking, Health scoring and alerts, Integration with Intercom, Pendo, Gainsight, automation, Customer Success, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Customer Onboarding Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Automate customer onboarding: welcome sequences, setup wizards, training, success milestones. Reduce time-to-value 50%.</p>
        ...
        <li class="text-slate-300">Welcome email and in-app sequences</li>
        <li class="text-slate-300">Setup wizard and configuration</li>
        <li class="text-slate-300">Training content delivery</li>
        <li class="text-slate-300">Success milestone tracking</li>
        <li class="text-slate-300">Health scoring and alerts</li>
        <li class="text-slate-300">Integration with Intercom</li>
        <li class="text-slate-300">Pendo</li>
        <li class="text-slate-300">Gainsight</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce time-to-value by 50%</li>
        <li class="text-slate-300">Automated sequences keep customers engaged</li>
        <li class="text-slate-300">Milestone tracking measures progress</li>
        <li class="text-slate-300">Health scoring identifies at-risk customers</li>
      </ul>
        </div>
