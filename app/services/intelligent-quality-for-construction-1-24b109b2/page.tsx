...
export const metadata: Metadata = {
  title: 'Intelligent Quality for Construction #1',
  description: 'Next-generation construction solution: Intelligent Quality for Construction #1. Combines language processing with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-quality-for-construction-1-24b109b2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Quality for Construction #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Intelligent Quality for Construction #1. Combines language processing with adaptive intelligence for optimal results.
          </p>
