...
export const metadata: Metadata = {
  title: 'AI-Powered Mortgage Underwriting',
  description: 'Automates mortgage underwriting with risk assessment and approval recommendations.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-mortgage-underwriting2026-07-28t0356460584380000164-13f808c1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automates mortgage underwriting with risk assessment and approval recommendations.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Approval recommendations</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">70% faster underwriting</li>
