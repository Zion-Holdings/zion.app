...
export const metadata: Metadata = {
  ...
  description: 'Drive innovation in finance with Intelligent Cloud for Finance. This AI-powered platform transforms survey automation into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-cloud-for-finance-97cc9de7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in finance with Intelligent Cloud for Finance. This AI-powered platform transforms survey automation into a competitive advantage.
          </p>
