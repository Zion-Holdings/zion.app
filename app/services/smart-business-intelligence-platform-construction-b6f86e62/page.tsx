...
export const metadata: Metadata = {
  title: 'Smart Business Intelligence Platform - Construction',
  description: 'The future of construction is here with Smart Business Intelligence Platform - Construction. Powered by cutting-edge AI, this platform delivers churn prediction',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-business-intelligence-platform-construction-b6f86e62',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Business Intelligence Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Smart Business Intelligence Platform - Construction. Powered by cutting-edge AI, this platform delivers churn prediction like never before.
          </p>
