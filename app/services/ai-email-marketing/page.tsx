...
export const metadata: Metadata = {
  ...
  keywords: 'AI subject line & copy generator, Send-time optimization per subscriber, Dynamic content personalization, Advanced behavioral segmentation, A/B/n automated testing, ai, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Email Marketing</h1>
        <p className="text-lg text-slate-300 mb-8">Intelligent email campaigns with AI-powered subject lines, send-time optimization, dynamic content, and advanced segmentation.</p>
        ...
        <li class="text-slate-300">AI subject line &amp; copy generator</li>
        <li class="text-slate-300">Send-time optimization per subscriber</li>
        <li class="text-slate-300">Dynamic content personalization</li>
        <li class="text-slate-300">Advanced behavioral segmentation</li>
        <li class="text-slate-300">A/B/n automated testing</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai email marketing</li>
