      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Intelligent email campaigns with AI-powered subject lines, send-time optimization, dynamic content, and advanced segmentation.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ AI subject line & copy generator</li>
            <li className="text-purple-300">✓ Send-time optimization per subscriber</li>
            <li className="text-purple-300">✓ Dynamic content personalization</li>
            <li className="text-purple-300">✓ Advanced behavioral segmentation</li>
            <li className="text-purple-300">✓ A/B/n automated testing</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai email marketing</li>
