...
export const metadata: Metadata = {
  title: 'Autonomous Autonomous System - Insurance',
  description: 'Drive innovation in insurance with Autonomous Autonomous System - Insurance. This AI-powered platform transforms invoice processing into a competitive advantage',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-autonomous-system-insurance-6cf88b87',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Autonomous System - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Autonomous Autonomous System - Insurance. This AI-powered platform transforms invoice processing into a competitive advantage.
          </p>
