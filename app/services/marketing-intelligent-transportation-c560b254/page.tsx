...
export const metadata: Metadata = {
  title: 'Marketing Intelligent - Transportation',
  description: 'Optimize your transportation workflows with Marketing Intelligent - Transportation. This intelligent platform delivers scenario planning through advanced automa',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Marketing Intelligent - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Marketing Intelligent - Transportation. This intelligent platform delivers scenario planning through advanced automation and AI.
          </p>
