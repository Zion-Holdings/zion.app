...
export const metadata: Metadata = {
  title: 'Automated Orchestrator for Energy',
  description: 'Optimize your energy workflows with Automated Orchestrator for Energy. This intelligent platform delivers reputation management through advanced automation and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-orchestrator-for-energy-884c35c4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Orchestrator for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your energy workflows with Automated Orchestrator for Energy. This intelligent platform delivers reputation management through advanced automation and AI.
          </p>
