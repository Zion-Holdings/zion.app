      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            End-to-end intelligent document processing with 99%+ accuracy OCR, classification, field-level data extraction, and automated workflow triggers.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ 99%+ accuracy AI-powered OCR</li>
            <li className="text-purple-300">✓ Intelligent document classification</li>
            <li className="text-purple-300">✓ Field-level structured data extraction</li>
            <li className="text-purple-300">✓ ERP/CRM validation & reconciliation</li>
            <li className="text-purple-300">✓ Automated approval workflow triggers</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai document intelligence</li>
