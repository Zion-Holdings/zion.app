...
export const metadata: Metadata = {
  ...
  keywords: '99%+ accuracy AI-powered OCR, Intelligent document classification, Field-level structured data extraction, ERP/CRM validation & reconciliation, Automated approval workflow triggers, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Document Intelligence</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end intelligent document processing with 99%+ accuracy OCR, classification, field-level data extraction, and automated workflow triggers.</p>
        ...
        <li class="text-slate-300">99%+ accuracy AI-powered OCR</li>
        <li class="text-slate-300">Intelligent document classification</li>
        <li class="text-slate-300">Field-level structured data extraction</li>
        <li class="text-slate-300">ERP/CRM validation &amp; reconciliation</li>
        <li class="text-slate-300">Automated approval workflow triggers</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai document intelligence</li>
