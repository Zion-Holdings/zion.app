...
export const metadata: Metadata = {
  title: 'Cognitive Engine Solution - Construction',
  description: 'Revolutionize construction through intelligent automation. Our Cognitive Engine Solution - Construction leverages advanced machine learning to deliver release m',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-engine-solution-construction-3bedafc1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Engine Solution - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Cognitive Engine Solution - Construction leverages advanced machine learning to deliver release management at scale.
          </p>
