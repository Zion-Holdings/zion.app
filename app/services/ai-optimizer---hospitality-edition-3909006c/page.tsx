...
export const metadata: Metadata = {
  title: 'AI Optimizer - Hospitality Edition',
  description: 'Next-generation hospitality solution: AI Optimizer - Hospitality Edition. Combines workflow management with adaptive intelligence for optimal results.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Optimizer - Hospitality Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: AI Optimizer - Hospitality Edition. Combines workflow management with adaptive intelligence for optimal results.
          </p>
