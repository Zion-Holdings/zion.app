...
export const metadata: Metadata = {
  title: 'Smart System Platform - Finance #1',
  description: 'Drive innovation in finance with Smart System Platform - Finance #1. This AI-powered platform transforms feedback collection into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-system-platform-finance-1-61bbd33e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart System Platform - Finance #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in finance with Smart System Platform - Finance #1. This AI-powered platform transforms feedback collection into a competitive advantage.
          </p>
