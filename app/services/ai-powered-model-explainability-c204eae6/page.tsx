...
export const metadata = {
  ...
  description: 'Provides interpretable explanations for AI model decisions to satisfy regulations.',
}
      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Provides interpretable explanations for AI model decisions to satisfy regulations.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Model explanations</li>
            <li className="text-purple-300">✓ Feature importance</li>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Full transparency</li>
