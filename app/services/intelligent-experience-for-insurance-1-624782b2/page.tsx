...
export const metadata: Metadata = {
  title: 'Intelligent Experience for Insurance #1',
  description: 'Optimize your insurance workflows with Intelligent Experience for Insurance #1. This intelligent platform delivers user experience through advanced automation a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-experience-for-insurance-1-624782b2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Experience for Insurance #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Intelligent Experience for Insurance #1. This intelligent platform delivers user experience through advanced automation and AI.
          </p>
