...
export const metadata: Metadata = {
  title: 'Business Intelligence Automated - Retail',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Business Intelligence Automated - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your retail workflows with Business Intelligence Automated - Retail. This intelligent platform delivers data processing through advanced automation and AI.
          </p>
