...
export const metadata: Metadata = {
  title: 'Intelligent Management for Gaming',
  description: 'Optimize your gaming workflows with Intelligent Management for Gaming. This intelligent platform delivers recruitment automation through advanced automation and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-management-for-gaming-1b649a9c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Management for Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your gaming workflows with Intelligent Management for Gaming. This intelligent platform delivers recruitment automation through advanced automation and AI.
          </p>
