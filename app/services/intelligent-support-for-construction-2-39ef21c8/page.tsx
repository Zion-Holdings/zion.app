...
export const metadata: Metadata = {
  title: 'Intelligent Support for Construction #2',
  description: 'Next-generation construction solution: Intelligent Support for Construction #2. Combines performance monitoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-support-for-construction-2-39ef21c8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Support for Construction #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Intelligent Support for Construction #2. Combines performance monitoring with adaptive intelligence for optimal results.
          </p>
