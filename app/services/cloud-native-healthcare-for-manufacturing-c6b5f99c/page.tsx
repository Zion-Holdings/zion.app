...
export const metadata: Metadata = {
  title: 'Cloud-Native Healthcare for Manufacturing',
  description: 'Transform manufacturing with Cloud-Native Healthcare for Manufacturing - the intelligent automation platform that learns, adapts, and delivers 10x results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cloud-native-healthcare-for-manufacturing-c6b5f99c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cloud-Native Healthcare for Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform manufacturing with Cloud-Native Healthcare for Manufacturing - the intelligent automation platform that learns, adapts, and delivers 10x results.
          </p>
