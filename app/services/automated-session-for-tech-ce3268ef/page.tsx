...
export const metadata: Metadata = {
  title: 'Automated Session for Tech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Session for Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in technology with Automated Session for Tech. This AI-powered platform transforms data quality into a competitive advantage.
          </p>
