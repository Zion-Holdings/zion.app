...
export const metadata: Metadata = {
  title: 'Clinical AI-Powered Data Security',
  description: 'AI-powered clinical solution for security. Automated data access control and encryption management.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/clinical-ai-powered-data-security-cd67865f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Clinical AI-Powered Data Security
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered clinical solution for security. Automated data access control and encryption management.
          </p>
