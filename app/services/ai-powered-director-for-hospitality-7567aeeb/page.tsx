...
export const metadata: Metadata = {
  title: 'AI-Powered Director for Hospitality',
  description: 'Transform your hospitality operations with our AI-Powered Director for Hospitality. This AI-driven solution automates fraud prevention with unprecedented accura',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-director-for-hospitality-7567aeeb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Director for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our AI-Powered Director for Hospitality. This AI-driven solution automates fraud prevention with unprecedented accuracy and efficiency.
          </p>
