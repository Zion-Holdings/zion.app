...
export const metadata: Metadata = {
  title: 'Smart Manufacturing Platform - Sports',
  description: 'Drive innovation in sports with Smart Manufacturing Platform - Sports. This AI-powered platform transforms customer onboarding into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-manufacturing-platform-sports-2992bcbf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manufacturing Platform - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in sports with Smart Manufacturing Platform - Sports. This AI-powered platform transforms customer onboarding into a competitive advantage.
          </p>
