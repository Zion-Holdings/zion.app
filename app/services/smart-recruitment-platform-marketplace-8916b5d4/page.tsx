...
export const metadata: Metadata = {
  title: 'Smart Recruitment Platform - Marketplace',
  description: 'Drive innovation in marketplace with Smart Recruitment Platform - Marketplace. This AI-powered platform transforms inventory management into a competitive advan',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-recruitment-platform-marketplace-8916b5d4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Recruitment Platform - Marketplace
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in marketplace with Smart Recruitment Platform - Marketplace. This AI-powered platform transforms inventory management into a competitive advantage.
          </p>
