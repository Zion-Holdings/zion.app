...
export const metadata: Metadata = {
  ...
  keywords: 'Next-gen antivirus (NGAV), Behavior-based threat detection, Incident response playbooks, Quarterly threat hunting reports, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Managed Endpoint Detection &amp; Response (EDR)</h1>
        <p className="text-lg text-slate-300 mb-8">24/7 monitored EDR service with threat hunting, ransomware rollback, and 15-minute SLA for critical alerts. Includes managed SOC.</p>
        ...
        <li class="text-slate-300">Next-gen antivirus (NGAV)</li>
        <li class="text-slate-300">Behavior-based threat detection</li>
        <li class="text-slate-300">Incident response playbooks</li>
        <li class="text-slate-300">Quarterly threat hunting reports</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with managed endpoint detection &amp; response (edr)</li>
