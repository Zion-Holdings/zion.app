...
export const metadata: Metadata = {
  title: 'Next-Gen Authorization - Energy',
  description: 'Next-generation energy solution: Next-Gen Authorization - Energy. Combines manufacturing quality control with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-authorization-energy-cd14feb5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Authorization - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Next-Gen Authorization - Energy. Combines manufacturing quality control with adaptive intelligence for optimal results.
          </p>
