...
export const metadata: Metadata = {
  title: 'Autonomous suite-legal',
  description: 'The future of legal is here with Autonomous suite-legal. Powered by cutting-edge AI, this platform delivers vendor management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-suite-legal-86209f6b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous suite-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Autonomous suite-legal. Powered by cutting-edge AI, this platform delivers vendor management like never before.
          </p>
