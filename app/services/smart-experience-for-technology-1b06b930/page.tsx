...
export const metadata: Metadata = {
  title: 'Smart Experience for Technology',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Experience for Technology
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Experience for Technology. This autonomous system provides threat detection with zero manual intervention needed.
          </p>
