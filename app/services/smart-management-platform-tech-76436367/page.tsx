...
export const metadata: Metadata = {
  title: 'Smart Management Platform - Tech',
  description: 'The future of technology is here with Smart Management Platform - Tech. Powered by cutting-edge AI, this platform delivers logistics route optimization like nev',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-management-platform-tech-76436367',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Management Platform - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of technology is here with Smart Management Platform - Tech. Powered by cutting-edge AI, this platform delivers logistics route optimization like never before.
          </p>
