      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ AI contract drafting</li>
            <li className="text-purple-300">✓ Clause extraction</li>
            <li className="text-purple-300">✓ Approval workflows</li>
            <li className="text-purple-300">✓ Obligation tracking</li>
            <li className="text-purple-300">✓ Renewal management</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Risk visibility</li>
            <li className="text-purple-300">✓ Obligation compliance</li>
            <li className="text-purple-300">✓ Cost control</li>
            </ul>
          </div>
