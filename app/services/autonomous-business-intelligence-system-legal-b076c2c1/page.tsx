...
export const metadata: Metadata = {
  title: 'Autonomous Business Intelligence System - Legal',
  description: 'The future of legal is here with Autonomous Business Intelligence System - Legal. Powered by cutting-edge AI, this platform delivers loyalty optimization like n',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-business-intelligence-system-legal-b076c2c1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Business Intelligence System - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Autonomous Business Intelligence System - Legal. Powered by cutting-edge AI, this platform delivers loyalty optimization like never before.
          </p>
