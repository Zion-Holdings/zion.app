...
export const metadata: Metadata = {
  title: 'Intelligent Platform for Telecom #3',
  description: 'Transform your telecom operations with our Intelligent Platform for Telecom #3. This AI-driven solution automates threat detection with unprecedented accuracy a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Platform for Telecom #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your telecom operations with our Intelligent Platform for Telecom #3. This AI-driven solution automates threat detection with unprecedented accuracy and efficiency.
          </p>
