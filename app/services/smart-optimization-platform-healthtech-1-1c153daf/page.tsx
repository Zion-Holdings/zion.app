...
export const metadata: Metadata = {
  title: 'Smart Optimization Platform - HEALTHTECH #1',
  description: 'The future of healthtech is here with Smart Optimization Platform - HEALTHTECH #1. Powered by cutting-edge AI, this platform delivers performance monitoring lik',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-optimization-platform-healthtech-1-1c153daf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Optimization Platform - HEALTHTECH #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthtech is here with Smart Optimization Platform - HEALTHTECH #1. Powered by cutting-edge AI, this platform delivers performance monitoring like never before.
          </p>
