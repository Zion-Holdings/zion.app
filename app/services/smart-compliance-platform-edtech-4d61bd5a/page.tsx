...
export const metadata: Metadata = {
  title: 'Smart Compliance Platform - EDTECH',
  description: 'Transform your edtech operations with our Smart Compliance Platform - EDTECH. This AI-driven solution automates cost reduction with unprecedented accuracy and e',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Compliance Platform - EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your edtech operations with our Smart Compliance Platform - EDTECH. This AI-driven solution automates cost reduction with unprecedented accuracy and efficiency.
          </p>
