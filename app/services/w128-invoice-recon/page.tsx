...
export const metadata: Metadata = {
  ...
  keywords: 'AI invoice matching, Discrepancy detection, Multi-currency support, Accounting system sync (QuickBooks, Xero, SAP), Exception handling dashboard, Bulk processing, micro-saas, financial-services, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">AI-powered invoice matching and reconciliation. Auto-matches invoices to payments, flags discrepancies, and syncs with accounting systems.</p>
        ...
        <li class="text-slate-300">AI invoice matching</li>
        <li class="text-slate-300">Discrepancy detection</li>
        <li class="text-slate-300">Multi-currency support</li>
        <li class="text-slate-300">Accounting system sync (QuickBooks, Xero, SAP)</li>
        <li class="text-slate-300">Exception handling dashboard</li>
        <li class="text-slate-300">Bulk processing</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">95% reduction in manual work</li>
        <li class="text-slate-300">Eliminate payment errors</li>
        <li class="text-slate-300">Real-time reconciliation</li>
        <li class="text-slate-300">Faster month-end close</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">597</p>
