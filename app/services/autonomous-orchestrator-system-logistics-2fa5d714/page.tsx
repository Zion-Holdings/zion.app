...
export const metadata: Metadata = {
  title: 'Autonomous Orchestrator System - Logistics',
  description: 'Next-generation logistics solution: Autonomous Orchestrator System - Logistics. Combines claims processing with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-orchestrator-system-logistics-2fa5d714',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Orchestrator System - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Autonomous Orchestrator System - Logistics. Combines claims processing with adaptive intelligence for optimal results.
          </p>
