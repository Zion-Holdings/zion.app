...
export const metadata: Metadata = {
  title: 'Intelligent Risk for Education',
  description: 'Enhance your education business with Intelligent Risk for Education. Our solution provides data quality with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-risk-for-education-2358240f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Risk for Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your education business with Intelligent Risk for Education. Our solution provides data quality with enterprise-grade reliability and security.
          </p>
