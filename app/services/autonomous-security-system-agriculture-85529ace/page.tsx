...
export const metadata: Metadata = {
  title: 'Autonomous Security System - Agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Autonomous Security System - Agriculture leverages advanced machine learning to deliver api manage',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Security System - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Autonomous Security System - Agriculture leverages advanced machine learning to deliver api management at scale.
          </p>
