...
export const metadata: Metadata = {
  title: 'Intelligent Supply for ALTHEALTH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Supply for ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for althealth: Intelligent Supply for ALTHEALTH. Uses quantum-inspired algorithms to deliver generative ai at exponential speed.
          </p>
