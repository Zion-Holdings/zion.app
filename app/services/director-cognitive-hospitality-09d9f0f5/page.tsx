...
export const metadata: Metadata = {
  title: 'Director Cognitive - Hospitality',
  description: 'Drive innovation in hospitality with Director Cognitive - Hospitality. This AI-powered platform transforms data pipeline orchestration into a competitive advant',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/director-cognitive-hospitality-09d9f0f5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Director Cognitive - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Director Cognitive - Hospitality. This AI-powered platform transforms data pipeline orchestration into a competitive advantage.
          </p>
