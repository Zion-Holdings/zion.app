...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time contamination detection, Temperature monitoring alerts, Hygiene compliance verification, Pest detection in storage areas, Supply chain traceability, Automated HACCP reporting, Integration with IoT sensors, Historical compliance analytics, ai, food, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Food Safety &amp; Quality Inspection System</h1>
        <p className="text-lg text-slate-300 mb-8">Computer vision-based food safety inspection for restaurants, food processing plants, and supply chains.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">ai</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">food</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Real-time contamination detection</li>
        <li class="text-slate-300">Temperature monitoring alerts</li>
        <li class="text-slate-300">Hygiene compliance verification</li>
        <li class="text-slate-300">Pest detection in storage areas</li>
        <li class="text-slate-300">Supply chain traceability</li>
        <li class="text-slate-300">Automated HACCP reporting</li>
        <li class="text-slate-300">Integration with IoT sensors</li>
        <li class="text-slate-300">Historical compliance analytics</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Prevent foodborne illness outbreaks</li>
        <li class="text-slate-300">Automate safety inspections</li>
        <li class="text-slate-300">Ensure regulatory compliance</li>
        <li class="text-slate-300">Reduce food waste</li>
      </ul>
        </div>
