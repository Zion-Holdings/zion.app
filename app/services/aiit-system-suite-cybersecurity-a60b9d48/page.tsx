...
export const metadata: Metadata = {
  title: 'AI/IT System Suite - Cybersecurity',
  description: 'Drive innovation in cybersecurity with AI/IT System Suite - Cybersecurity. This AI-powered platform transforms predictive analytics into a competitive advantage',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-system-suite-cybersecurity-a60b9d48',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT System Suite - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in cybersecurity with AI/IT System Suite - Cybersecurity. This AI-powered platform transforms predictive analytics into a competitive advantage.
          </p>
