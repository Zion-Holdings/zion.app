...
export const metadata: Metadata = {
  title: 'Cognitive Finance Solution - Marketplace',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Finance Solution - Marketplace
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in marketplace with Cognitive Finance Solution - Marketplace. This AI-powered platform transforms user experience into a competitive advantage.
          </p>
