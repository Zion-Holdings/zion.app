...
export const metadata: Metadata = {
  title: 'AI Intelligence - Healthcare Edition',
  description: 'Revolutionize healthcare through intelligent automation. Our AI Intelligence - Healthcare Edition leverages advanced machine learning to deliver predictive anal',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Intelligence - Healthcare Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our AI Intelligence - Healthcare Edition leverages advanced machine learning to deliver predictive analytics at scale.
          </p>
