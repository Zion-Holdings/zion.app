...
export const metadata: Metadata = {
  title: 'Adaptive scale-up-regtech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive scale-up-regtech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in regtech with Adaptive scale-up-regtech. This AI-powered platform transforms serverless orchestration into a competitive advantage.
          </p>
