...
export const metadata: Metadata = {
  title: 'Intelligent Workflow for Agriculture',
  description: 'Transform your agriculture operations with our Intelligent Workflow for Agriculture. This AI-driven solution automates email automation with unprecedented accur',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Workflow for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Intelligent Workflow for Agriculture. This AI-driven solution automates email automation with unprecedented accuracy and efficiency.
          </p>
