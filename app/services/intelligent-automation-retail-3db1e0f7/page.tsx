...
export const metadata: Metadata = {
  title: 'Intelligent automation-retail',
  description: 'Revolutionize retail through intelligent automation. Our Intelligent automation-retail leverages advanced machine learning to deliver business intelligence at s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-automation-retail-3db1e0f7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent automation-retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize retail through intelligent automation. Our Intelligent automation-retail leverages advanced machine learning to deliver business intelligence at scale.
          </p>
