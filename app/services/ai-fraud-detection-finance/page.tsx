      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Rule-based plus ML hybrid model</li>
            <li className="text-purple-300">✓ Explainable decision reasons (XAI)</li>
            <li className="text-purple-300">✓ Adaptive learning from investigator feedback</li>
            <li className="text-purple-300">✓ Automatic SAR filing templates</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai fraud detection for finance</li>
