...
export const metadata: Metadata = {
  ...
  keywords: 'Rule-based plus ML hybrid model, Explainable decision reasons (XAI), Adaptive learning from investigator feedback, Automatic SAR filing templates, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Fraud Detection for Finance</h1>
        <p className="text-lg text-slate-300 mb-8">Real-time transaction monitoring for banks, fintechs, and accounting firms with explainable AI decisions and SAR report generation.</p>
        ...
        <li class="text-slate-300">Rule-based plus ML hybrid model</li>
        <li class="text-slate-300">Explainable decision reasons (XAI)</li>
        <li class="text-slate-300">Adaptive learning from investigator feedback</li>
        <li class="text-slate-300">Automatic SAR filing templates</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai fraud detection for finance</li>
