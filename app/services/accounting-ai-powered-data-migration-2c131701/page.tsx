...
export const metadata: Metadata = {
  title: 'Accounting AI-Powered Data Migration',
  description: 'AI-powered accounting solution for data engineering. Intelligent data migration planning and execution.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/accounting-ai-powered-data-migration-2c131701',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Accounting AI-Powered Data Migration
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered accounting solution for data engineering. Intelligent data migration planning and execution.
          </p>
