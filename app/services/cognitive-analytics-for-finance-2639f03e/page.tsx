...
export const metadata: Metadata = {
  title: 'Cognitive Analytics for Finance',
  description: 'Revolutionize finance through intelligent automation. Our Cognitive Analytics for Finance leverages advanced machine learning to deliver decision support at sca',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-analytics-for-finance-2639f03e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Analytics for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our Cognitive Analytics for Finance leverages advanced machine learning to deliver decision support at scale.
          </p>
