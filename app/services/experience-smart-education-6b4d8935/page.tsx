...
export const metadata: Metadata = {
  title: 'Experience Smart - Education',
  description: 'Revolutionize education through intelligent automation. Our Experience Smart - Education leverages advanced machine learning to deliver resource allocation at s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Experience Smart - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize education through intelligent automation. Our Experience Smart - Education leverages advanced machine learning to deliver resource allocation at scale.
          </p>
