...
export const metadata = {
  ...
  description: "Processes invoices, contracts, and forms with 99.5% accuracy, extracting data and routing automatically.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/intelligent-document-processing-ai-51f2e7bd`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Processes invoices, contracts, and forms with 99.5% accuracy, extracting data and routing automatically.</p>
