...
export const metadata: Metadata = {
  title: 'Smart Security Platform - Healthcare',
  description: 'Optimize your healthcare workflows with Smart Security Platform - Healthcare. This intelligent platform delivers financial planning through advanced automation ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-security-platform-healthcare-cb8952b7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Security Platform - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Smart Security Platform - Healthcare. This intelligent platform delivers financial planning through advanced automation and AI.
          </p>
