...
export const metadata: Metadata = {
  ...
  keywords: 'Per-container right-sizing via VPA and workload profiling with safe-in-place patch, Spot-compatible scheduling for bursty workloads onto sporadically preemptible instances, Cost allocation per workload to the owning team or namespace by codebase tag, Idle resource crawler — auto-suspend or delete untouched workloads after 7 idle days, cloud, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Kubernetes Cost Optimizer</h1>
        <p className="text-lg text-slate-300 mb-8">K8s cluster cost engine: per-container CPU and RAM right-sizing via VPA plus workload profiling, spot-compatible scheduling for bursty workloads, cost attribution per team or namespace, idle resource crawler, and budget alerts.</p>
        ...
        <li class="text-slate-300">Per-container right-sizing via VPA and workload profiling with safe-in-place patch</li>
        <li class="text-slate-300">Spot-compatible scheduling for bursty workloads onto sporadically preemptible instances</li>
        <li class="text-slate-300">Cost allocation per workload to the owning team or namespace by codebase tag</li>
        <li class="text-slate-300">Idle resource crawler — auto-suspend or delete untouched workloads after 7 idle days</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with kubernetes cost optimizer</li>
