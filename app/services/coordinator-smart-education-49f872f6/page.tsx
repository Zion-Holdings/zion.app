...
export const metadata: Metadata = {
  title: 'Coordinator Smart - Education',
  description: 'Enhance your education business with Coordinator Smart - Education. Our solution provides threat detection with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/coordinator-smart-education-49f872f6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Coordinator Smart - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your education business with Coordinator Smart - Education. Our solution provides threat detection with enterprise-grade reliability and security.
          </p>
