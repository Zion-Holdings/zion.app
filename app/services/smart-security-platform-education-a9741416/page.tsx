...
export const metadata: Metadata = {
  title: 'Smart Security Platform - Education',
  description: 'The future of education is here with Smart Security Platform - Education. Powered by cutting-edge AI, this platform delivers executive dashboards like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-security-platform-education-a9741416',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Security Platform - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of education is here with Smart Security Platform - Education. Powered by cutting-edge AI, this platform delivers executive dashboards like never before.
          </p>
