...
export const metadata: Metadata = {
  ...
  description: 'Optimize your education workflows with Intelligent Advisor for Education. This intelligent platform delivers recruitment automation through advanced automation ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-advisor-for-education-88459460',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your education workflows with Intelligent Advisor for Education. This intelligent platform delivers recruitment automation through advanced automation and AI.
          </p>
