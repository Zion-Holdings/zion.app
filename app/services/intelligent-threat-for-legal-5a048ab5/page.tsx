...
export const metadata: Metadata = {
  title: 'Intelligent Threat for Legal',
  description: 'The future of legal is here with Intelligent Threat for Legal. Powered by cutting-edge AI, this platform delivers lead scoring like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-threat-for-legal-5a048ab5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Threat for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Intelligent Threat for Legal. Powered by cutting-edge AI, this platform delivers lead scoring like never before.
          </p>
