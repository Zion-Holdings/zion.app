...
export const metadata: Metadata = {
  title: 'Cloud Smart - Energy',
  description: 'Next-generation energy solution: Cloud Smart - Energy. Combines disaster recovery with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cloud-smart-energy-d566592b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Cloud Smart - Energy. Combines disaster recovery with adaptive intelligence for optimal results.
          </p>
