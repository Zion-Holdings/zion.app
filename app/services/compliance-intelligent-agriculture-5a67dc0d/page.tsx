...
export const metadata: Metadata = {
  title: 'Compliance Intelligent - Agriculture',
  description: 'Optimize your agriculture workflows with Compliance Intelligent - Agriculture. This intelligent platform delivers process discovery through advanced automation ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/compliance-intelligent-agriculture-5a67dc0d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Compliance Intelligent - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your agriculture workflows with Compliance Intelligent - Agriculture. This intelligent platform delivers process discovery through advanced automation and AI.
          </p>
