...
export const metadata: Metadata = {
  title: 'Smart Compliance Insights',
  description: 'Next-generation manufacturing solution: Smart Compliance Insights. Combines security monitoring with adaptive intelligence for optimal results.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation manufacturing solution: Smart Compliance Insights. Combines security monitoring with adaptive intelligence for optimal results.
          </p>
