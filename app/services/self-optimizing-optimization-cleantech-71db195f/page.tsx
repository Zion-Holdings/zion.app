...
export const metadata: Metadata = {
  title: 'Self-Optimizing optimization-cleantech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing optimization-cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cleantech through intelligent automation. Our Self-Optimizing optimization-cleantech leverages advanced machine learning to deliver maintenance scheduling at scale.
          </p>
