...
export const metadata: Metadata = {
  title: 'AI/IT Neural for Sports',
  description: 'Drive innovation in sports with AI/IT Neural for Sports. This AI-powered platform transforms conversational ai into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-neural-for-sports-85c88526',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Neural for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in sports with AI/IT Neural for Sports. This AI-powered platform transforms conversational ai into a competitive advantage.
          </p>
