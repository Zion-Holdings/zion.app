...
export const metadata: Metadata = {
  title: 'Self-Optimizing Project System',
  description: 'Next-generation real-estate solution: Self-Optimizing Project System. Combines succession planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/self-optimizing-project-system-d90902af',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Project System
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation real-estate solution: Self-Optimizing Project System. Combines succession planning with adaptive intelligence for optimal results.
          </p>
