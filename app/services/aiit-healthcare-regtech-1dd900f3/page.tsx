...
export const metadata: Metadata = {
  title: 'AI/IT healthcare-regtech',
  description: 'Transform your regtech operations with our AI/IT healthcare-regtech. This AI-driven solution automates benefits administration with unprecedented accuracy and e',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-healthcare-regtech-1dd900f3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT healthcare-regtech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your regtech operations with our AI/IT healthcare-regtech. This AI-driven solution automates benefits administration with unprecedented accuracy and efficiency.
          </p>
