...
export const metadata: Metadata = {
  title: 'Intelligent coordinator-blockchain',
  description: 'Revolutionize blockchain through intelligent automation. Our Intelligent coordinator-blockchain leverages advanced machine learning to deliver fraud prevention ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent coordinator-blockchain
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize blockchain through intelligent automation. Our Intelligent coordinator-blockchain leverages advanced machine learning to deliver fraud prevention at scale.
          </p>
