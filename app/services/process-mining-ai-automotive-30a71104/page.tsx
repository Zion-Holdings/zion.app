...
export const metadata: Metadata = {
  title: 'Process Mining AI - Automotive',
  description: 'Transform your automotive operations with our Process Mining AI - Automotive. This AI-driven solution provides intelligent automation with unprecedented accurac',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Process Mining AI - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your automotive operations with our Process Mining AI - Automotive. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
