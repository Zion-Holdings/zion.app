...
export const metadata: Metadata = {
  title: 'Cloud Smart - Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Cloud Smart - Healthcare leverages advanced machine learning to deliver enterprise-grade insights a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cloud-smart-healthcare-a3b62917',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cloud Smart - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Cloud Smart - Healthcare leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
