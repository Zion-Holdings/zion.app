...
export const metadata: Metadata = {
  title: 'Smart Automation Platform - Sports',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Automation Platform - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in sports with Smart Automation Platform - Sports. This AI-powered platform transforms roi tracking into a competitive advantage.
          </p>
