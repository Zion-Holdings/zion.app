...
export const metadata: Metadata = {
  title: 'Automated monitoring-hospitality',
  description: 'The future of hospitality is here with Automated monitoring-hospitality. Powered by cutting-edge AI, this platform delivers maintenance scheduling like never be',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-monitoring-hospitality-6214d673',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated monitoring-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Automated monitoring-hospitality. Powered by cutting-edge AI, this platform delivers maintenance scheduling like never before.
          </p>
