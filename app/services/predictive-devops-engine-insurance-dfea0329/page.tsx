...
export const metadata: Metadata = {
  title: 'Predictive DevOps Engine - Insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive DevOps Engine - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Predictive DevOps Engine - Insurance. Combines recruitment automation with adaptive intelligence for optimal results.
          </p>
