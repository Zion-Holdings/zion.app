...
export const metadata: Metadata = {
  title: 'AI Startup - Construction Edition',
  description: 'Next-generation construction solution: AI Startup - Construction Edition. Combines social media automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-startup-construction-edition-4c4819ba',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Startup - Construction Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: AI Startup - Construction Edition. Combines social media automation with adaptive intelligence for optimal results.
          </p>
