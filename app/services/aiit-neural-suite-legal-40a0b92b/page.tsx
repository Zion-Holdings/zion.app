...
export const metadata: Metadata = {
  title: 'AI/IT Neural Suite - Legal',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Neural Suite - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with AI/IT Neural Suite - Legal. This intelligent platform delivers performance tracking through advanced automation and AI.
          </p>
