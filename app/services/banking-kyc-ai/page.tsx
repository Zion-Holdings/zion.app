...
export const metadata: Metadata = {
  ...
  keywords: 'Document verification, Biometric matching, Risk scoring, PEP screening, Sanctions check, Ongoing monitoring, Compliance, Case management, ai, Financial, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Banking KYC and Onboarding AI</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered KYC with document verification and biometric matching.</p>
        ...
        <li class="text-slate-300">Document verification</li>
        <li class="text-slate-300">Biometric matching</li>
        <li class="text-slate-300">Risk scoring</li>
        <li class="text-slate-300">PEP screening</li>
        <li class="text-slate-300">Sanctions check</li>
        <li class="text-slate-300">Ongoing monitoring</li>
        <li class="text-slate-300">Compliance</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">80% faster onboarding</li>
        <li class="text-slate-300">95% auto-approval</li>
        <li class="text-slate-300">Regulatory compliance</li>
        <li class="text-slate-300">Fraud prevention</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$2/check</p>
