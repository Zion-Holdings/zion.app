...
export const metadata: Metadata = {
  title: 'Cognitive System Solution - Media',
  description: 'Unlock unprecedented growth with Cognitive System Solution - Media. This autonomous system provides data quality with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-system-solution-media-20c9783c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive System Solution - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Cognitive System Solution - Media. This autonomous system provides data quality with zero manual intervention needed.
          </p>
