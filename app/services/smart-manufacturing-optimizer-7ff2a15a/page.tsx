...
export const metadata: Metadata = {
  ...
  description: 'The future of proptech is here with Smart Manufacturing Optimizer. Powered by cutting-edge AI, this platform delivers fraud prevention like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-manufacturing-optimizer-7ff2a15a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with Smart Manufacturing Optimizer. Powered by cutting-edge AI, this platform delivers fraud prevention like never before.
          </p>
