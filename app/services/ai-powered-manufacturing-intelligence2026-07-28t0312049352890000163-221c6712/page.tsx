...
export const metadata: Metadata = {
  ...
  description: 'Intelligence platform for manufacturing with AI insights.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-manufacturing-intelligence2026-07-28t0312049352890000163-221c6712',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Intelligence platform for manufacturing with AI insights.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Manufacturing intelligence</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">90% better decisions</li>
