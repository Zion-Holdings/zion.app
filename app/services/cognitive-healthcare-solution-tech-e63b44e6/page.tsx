...
export const metadata: Metadata = {
  title: 'Cognitive Healthcare Solution - Tech',
  description: 'Next-generation technology solution: Cognitive Healthcare Solution - Tech. Combines data quality with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-healthcare-solution-tech-e63b44e6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Healthcare Solution - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation technology solution: Cognitive Healthcare Solution - Tech. Combines data quality with adaptive intelligence for optimal results.
          </p>
