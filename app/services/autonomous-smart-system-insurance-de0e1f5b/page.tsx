...
export const metadata: Metadata = {
  title: 'Autonomous Smart System - Insurance',
  description: 'Enhance your insurance business with Autonomous Smart System - Insurance. Our solution provides executive dashboards with enterprise-grade reliability and secur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-smart-system-insurance-de0e1f5b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Smart System - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Autonomous Smart System - Insurance. Our solution provides executive dashboards with enterprise-grade reliability and security.
          </p>
