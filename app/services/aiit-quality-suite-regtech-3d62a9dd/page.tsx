...
export const metadata: Metadata = {
  title: 'AI/IT Quality Suite - REGTECH',
  description: 'Revolutionize regtech through intelligent automation. Our AI/IT Quality Suite - REGTECH leverages advanced machine learning to deliver net promoter score at sca',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-quality-suite-regtech-3d62a9dd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Quality Suite - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize regtech through intelligent automation. Our AI/IT Quality Suite - REGTECH leverages advanced machine learning to deliver net promoter score at scale.
          </p>
