...
export const metadata: Metadata = {
  title: 'Real Estate Intelligent - Proptech',
  description: 'Next-generation proptech solution: Real Estate Intelligent - Proptech. Combines healthcare data analytics with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/real-estate-intelligent---proptech-69e22595',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Real Estate Intelligent - Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation proptech solution: Real Estate Intelligent - Proptech. Combines healthcare data analytics with adaptive intelligence for optimal results.
          </p>
