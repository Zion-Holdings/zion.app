...
export const metadata: Metadata = {
  ...
  keywords: 'Clause Extraction, Risk Identification, Obligation Tracking, Multi-format Support, Citation Analysis, AI, Legal Tech, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Legal Document AI Summarizer</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered legal document analysis and summarization tool. Extracts key clauses, obligations, and risks from contracts, briefs, and compliance documents.</p>
        ...
        <li class="text-slate-300">Multi-format Support</li>
        <li class="text-slate-300">Citation Analysis</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce review time 80%</li>
        <li class="text-slate-300">Minimize legal risk</li>
        <li class="text-slate-300">Standardize analysis</li>
      </ul>
        </div>
