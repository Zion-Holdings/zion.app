...
export const metadata: Metadata = {
  title: 'Smart Platform for Telecom',
  description: 'Revolutionize telecom through intelligent automation. Our Smart Platform for Telecom leverages advanced machine learning to deliver data quality at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-platform-for-telecom-24bd9d8f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Platform for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Smart Platform for Telecom leverages advanced machine learning to deliver data quality at scale.
          </p>
