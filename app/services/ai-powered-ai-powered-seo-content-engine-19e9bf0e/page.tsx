...
export const metadata: Metadata = {
  title: "AI-Powered AI-Powered SEO Content Engine - AI-Powered Textiles Solution",
  description: "ai-powered solution for textiles industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing copy.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-ai-powered-seo-content-engine-19e9bf0e",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered AI-Powered SEO Content Engine - AI-Powered Textiles Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          ai-powered solution for textiles industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing copy.
        </p>
