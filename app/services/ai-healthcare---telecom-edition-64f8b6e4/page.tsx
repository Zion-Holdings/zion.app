...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize telecom through intelligent automation. Our AI Healthcare - Telecom Edition leverages advanced machine learning to deliver fraud prevention at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our AI Healthcare - Telecom Edition leverages advanced machine learning to deliver fraud prevention at scale.
          </p>
