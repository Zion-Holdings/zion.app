...
export const metadata: Metadata = {
  title: '5G AI Social Media Content Creator',
  description: 'AI-powered 5g solution for social media. Generates, schedules, and optimizes social media content across all platforms.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/5g-ai-social-media-content-creator-8d30db27',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            5G AI Social Media Content Creator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered 5g solution for social media. Generates, schedules, and optimizes social media content across all platforms.
          </p>
