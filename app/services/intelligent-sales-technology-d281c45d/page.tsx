...
export const metadata: Metadata = {
  title: 'Intelligent sales-technology',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent sales-technology
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of technology is here with Intelligent sales-technology. Powered by cutting-edge AI, this platform delivers anomaly detection like never before.
          </p>
