...
export const metadata: Metadata = {
  title: 'Automated Vendor Suite',
  description: 'Transform your real-estate operations with our Automated Vendor Suite. This AI-driven solution automates resource allocation with unprecedented accuracy and eff',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-vendor-suite-953e708a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Vendor Suite
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Automated Vendor Suite. This AI-driven solution automates resource allocation with unprecedented accuracy and efficiency.
          </p>
