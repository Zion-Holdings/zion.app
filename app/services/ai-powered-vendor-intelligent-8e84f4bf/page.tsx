...
export const metadata: Metadata = {
  title: 'AI-Powered Vendor Intelligent',
  description: 'Transform your agriculture operations with our AI-Powered Vendor Intelligent. This AI-driven solution provides intelligent automation with unprecedented accurac',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Vendor Intelligent
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our AI-Powered Vendor Intelligent. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
