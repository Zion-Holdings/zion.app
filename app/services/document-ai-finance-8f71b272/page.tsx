...
export const metadata: Metadata = {
  title: 'Document AI - Finance',
  description: 'Unlock unprecedented growth with Document AI - Finance. This autonomous system provides sentiment analysis with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/document-ai-finance-8f71b272',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Document AI - Finance. This autonomous system provides sentiment analysis with zero manual intervention needed.
          </p>
