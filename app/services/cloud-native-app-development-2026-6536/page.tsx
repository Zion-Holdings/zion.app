...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={@context: "https://schema.org", @type: "Service", name: "Cloud Native App Development | Zion Tech Group", description: "End-to-end cloud native app development services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/cloud-native-app-development-2026-6536/"} />
