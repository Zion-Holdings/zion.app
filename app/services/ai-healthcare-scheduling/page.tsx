...
export const metadata: Metadata = {
  title: "AI Patient Scheduling & No-Show Predictor | Zion Tech Group",
  ...
  openGraph: {
    title: "AI Patient Scheduling & No-Show Predictor | Zion Tech Group",
    description: "Intelligent appointment scheduling with AI no-show prediction, automated reminders, waitlist management, and provider utilization optimization. Integrated with major EHR systems. Reduces no-shows by 40%.",
    url: "https://ziontechgroup.com/services/ai-healthcare-scheduling/",
    type: 'website',
  },
  alternates: { canonical: "/services/ai-healthcare-scheduling/" },
};

export default function AiHealthcareSchedulingPage() {
  return (
    <StandardPage
      title="AI Patient Scheduling & No-Show Predictor"
      subtitle="Intelligent appointment scheduling with AI no-show prediction, automated reminders, waitlist management, and provider utilization optimization. Integrated with major EHR systems. Reduces no-shows by 40%."
      breadcrumbItems={[
        { label: "Home", href: "/" },
        { label: "Services", href: "/services/" },
        { label: "AI Patient Scheduling & No-Show Predictor" }
      ]}
      actions={[
    ...
    >
        ...
        <div className="rounded-2xl border border-white/10 bg-slate-900/40 p-5"><h2 className="text-white font-semibold mb-2">AI Patient Scheduling &amp; No-Show Predictor</h2><p className="text-slate-400 text-sm">Archived section recovered from the live site snapshot.</p></div>
      ...
      <p className="text-slate-400 leading-relaxed mb-4 max-w-5xl mx-auto">Estimated timeline for AI Patient Scheduling &amp; No-Show Predictor — adapt to your team size and complexity.</p>
      ...
      <p className="text-slate-500 text-sm max-w-5xl mx-auto">Restored from a Wayback Machine snapshot (20260614110351) of ziontechgroup.com.</p>
    </StandardPage>
  );
}
