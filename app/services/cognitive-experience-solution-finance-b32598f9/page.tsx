...
export const metadata: Metadata = {
  title: 'Cognitive Experience Solution - Finance',
  description: 'Next-generation finance solution: Cognitive Experience Solution - Finance. Combines territory management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-experience-solution-finance-b32598f9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Experience Solution - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation finance solution: Cognitive Experience Solution - Finance. Combines territory management with adaptive intelligence for optimal results.
          </p>
