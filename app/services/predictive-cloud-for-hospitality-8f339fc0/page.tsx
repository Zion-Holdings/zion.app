...
export const metadata: Metadata = {
  title: 'Predictive Cloud for Hospitality',
  description: 'The future of hospitality is here with Predictive Cloud for Hospitality. Powered by cutting-edge AI, this platform delivers sales process optimization like neve',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-cloud-for-hospitality-8f339fc0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Cloud for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Predictive Cloud for Hospitality. Powered by cutting-edge AI, this platform delivers sales process optimization like never before.
          </p>
