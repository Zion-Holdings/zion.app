...
export const metadata: Metadata = {
  title: 'System Neural - Hospitality #1',
  description: 'Transform your hospitality operations with our System Neural - Hospitality #1. This AI-driven solution automates root cause analysis with unprecedented accuracy',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/system-neural-hospitality-1-de2a1e94',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            System Neural - Hospitality #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our System Neural - Hospitality #1. This AI-driven solution automates root cause analysis with unprecedented accuracy and efficiency.
          </p>
