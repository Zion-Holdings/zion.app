...
export const metadata: Metadata = {
  title: 'Predictive Support Engine - AITECH',
  description: 'Next-generation aitech solution: Predictive Support Engine - AITECH. Combines task mining with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-support-engine-aitech-28242005',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Support Engine - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation aitech solution: Predictive Support Engine - AITECH. Combines task mining with adaptive intelligence for optimal results.
          </p>
