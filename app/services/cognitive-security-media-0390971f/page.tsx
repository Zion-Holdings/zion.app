...
export const metadata = {
  ...
  description: "Revolutionize media through intelligent automation. Our Cognitive security-media leverages advanced machine learning to deliver sales process optimization at sc",
  alternates: {
