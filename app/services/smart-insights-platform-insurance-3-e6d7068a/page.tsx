...
export const metadata: Metadata = {
  title: 'Smart Insights Platform - Insurance #3',
  description: 'Enhance your insurance business with Smart Insights Platform - Insurance #3. Our solution provides customer journey mapping with enterprise-grade reliability an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Insights Platform - Insurance #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Smart Insights Platform - Insurance #3. Our solution provides customer journey mapping with enterprise-grade reliability and security.
          </p>
