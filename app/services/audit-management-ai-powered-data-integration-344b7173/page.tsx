...
export const metadata: Metadata = {
  title: 'Audit Management AI-Powered Data Integration',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Audit Management AI-Powered Data Integration
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered audit management solution for integration. Automated data integration with conflict resolution.
          </p>
