...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize automotive through intelligent automation. Our Autonomous Revenue System - Automotive leverages advanced machine learning to deliver business inte',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize automotive through intelligent automation. Our Autonomous Revenue System - Automotive leverages advanced machine learning to deliver business intelligence at scale.
          </p>
