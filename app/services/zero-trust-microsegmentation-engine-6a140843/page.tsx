...
export const metadata: Metadata = {
  title: 'Zero-Trust Microsegmentation Engine',
  description: 'Dynamic microsegmentation for hybrid environments with zero-trust policy enforcement.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/zero-trust-microsegmentation-engine-6a140843',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Dynamic microsegmentation for hybrid environments with zero-trust policy enforcement.
          </p>
