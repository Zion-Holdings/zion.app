  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Employee Wellness &amp; Mental Health Platform</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered employee wellness platform with personalized mental health support, burnout prediction, meditation guidance, and anonymous counseling access. HIPAA compliant.</p>
        ...
        <li class="text-slate-300">AI burnout prediction from work patterns</li>
        <li class="text-slate-300">Personalized meditation and mindfulness</li>
        <li class="text-slate-300">Anonymous AI therapy chatbot</li>
        <li class="text-slate-300">EAP integration and referral tracking</li>
        <li class="text-slate-300">Manager dashboards (aggregated, anonymous)</li>
        <li class="text-slate-300">Crisis detection and escalation</li>
        <li class="text-slate-300">HIPAA/GDPR compliant infrastructure</li>
        <li class="text-slate-300">Integration with Slack, Teams, Workday</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce burnout by 40%</li>
        <li class="text-slate-300">Improve employee retention by 25%</li>
        <li class="text-slate-300">Decrease absenteeism by 30%</li>
        <li class="text-slate-300">Scale mental health support company-wide</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$24/employee/mo</p>
