...
export const metadata: Metadata = {
  title: 'Smart Automation Suite - Finance',
  description: 'The future of finance is here with Smart Automation Suite - Finance. Powered by cutting-edge AI, this platform delivers customer retention like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-automation-suite-finance-afe79e0c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Automation Suite - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of finance is here with Smart Automation Suite - Finance. Powered by cutting-edge AI, this platform delivers customer retention like never before.
          </p>
