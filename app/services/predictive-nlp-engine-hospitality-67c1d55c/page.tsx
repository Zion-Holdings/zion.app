...
export const metadata: Metadata = {
  title: 'Predictive NLP Engine - Hospitality',
  description: 'The future of hospitality is here with Predictive NLP Engine - Hospitality. Powered by cutting-edge AI, this platform delivers user provisioning like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-nlp-engine-hospitality-67c1d55c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive NLP Engine - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Predictive NLP Engine - Hospitality. Powered by cutting-edge AI, this platform delivers user provisioning like never before.
          </p>
