...
export const metadata: Metadata = {
  title: 'Smart DevOps Platform - Healthcare',
  description: 'Transform your healthcare operations with our Smart DevOps Platform - Healthcare. This AI-driven solution automates predictive analytics with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-devops-platform-healthcare-5b2b1d57',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart DevOps Platform - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Smart DevOps Platform - Healthcare. This AI-driven solution automates predictive analytics with unprecedented accuracy and efficiency.
          </p>
