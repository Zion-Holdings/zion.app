...
export const metadata: Metadata = {
  title: "Account Management Multi-Cloud Cost Management Platform - AI-Powered Electric Vehicles Solution",
  description: "account management solution for electric vehicles industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/account-management-multi-cloud-cost-management-platform-c7db3e40",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Account Management Multi-Cloud Cost Management Platform - AI-Powered Electric Vehicles Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          account management solution for electric vehicles industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.
        </p>
