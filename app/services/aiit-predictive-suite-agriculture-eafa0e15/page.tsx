...
export const metadata: Metadata = {
  title: 'AI/IT Predictive Suite - Agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our AI/IT Predictive Suite - Agriculture leverages advanced machine learning to deliver expense report',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-predictive-suite-agriculture-eafa0e15',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Predictive Suite - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our AI/IT Predictive Suite - Agriculture leverages advanced machine learning to deliver expense reporting at scale.
          </p>
