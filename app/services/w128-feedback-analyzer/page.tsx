...
export const metadata: Metadata = {
  ...
  keywords: 'Sentiment analysis, Trend detection, Topic clustering, Survey analysis, Support ticket classification, Executive dashboards, micro-saas, retail-and-ecommerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">NLP-powered analysis of customer reviews, surveys, and support tickets. Identifies trends, sentiment, and actionable insights.</p>
        ...
        <li class="text-slate-300">Trend detection</li>
        <li class="text-slate-300">Topic clustering</li>
        <li class="text-slate-300">Survey analysis</li>
        <li class="text-slate-300">Support ticket classification</li>
        ...
        <li class="text-slate-300">Identify product issues early</li>
