...
export const metadata: Metadata = {
  title: 'Smart Management Platform - Manufacturing',
  description: 'Enhance your manufacturing business with Smart Management Platform - Manufacturing. Our solution provides capacity management with enterprise-grade reliability ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-management-platform-manufacturing-eb749f85',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Management Platform - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your manufacturing business with Smart Management Platform - Manufacturing. Our solution provides capacity management with enterprise-grade reliability and security.
          </p>
