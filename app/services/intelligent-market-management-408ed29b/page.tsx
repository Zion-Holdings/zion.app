...
export const metadata: Metadata = {
  title: 'Intelligent Market Management',
  description: 'The future of sports is here with Intelligent Market Management. Powered by cutting-edge AI, this platform delivers maintenance scheduling like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-market-management-408ed29b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Intelligent Market Management. Powered by cutting-edge AI, this platform delivers maintenance scheduling like never before.
          </p>
