...
export const metadata: Metadata = {
  title: 'Predictive Experience for Tech',
  description: 'Revolutionize technology through intelligent automation. Our Predictive Experience for Tech leverages advanced machine learning to deliver root cause analysis a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Experience for Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our Predictive Experience for Tech leverages advanced machine learning to deliver root cause analysis at scale.
          </p>
