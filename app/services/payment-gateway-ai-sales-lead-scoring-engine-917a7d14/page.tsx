...
export const metadata: Metadata = {
  title: 'Payment Gateway AI Sales Lead Scoring Engine',
  description: 'payment gateway solution for proptech industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/payment-gateway-ai-sales-lead-scoring-engine-917a7d14',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Payment Gateway AI Sales Lead Scoring Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            payment gateway solution for proptech industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.
          </p>
