...
export const metadata: Metadata = {
  title: 'Enterprise Workflow Platform - Manufacturing',
  description: 'Unlock unprecedented growth with Enterprise Workflow Platform - Manufacturing. This autonomous system provides territory management with zero manual interventio',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-workflow-platform-manufacturing-e0500512',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Workflow Platform - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Enterprise Workflow Platform - Manufacturing. This autonomous system provides territory management with zero manual intervention needed.
          </p>
