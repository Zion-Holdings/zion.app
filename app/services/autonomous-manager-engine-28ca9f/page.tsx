...
export const metadata: Metadata = {
  title: 'Autonomous Manager Engine',
  description: 'Transform your energy operations with our Autonomous Manager Engine. This cloud solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-manager-engine-28ca9f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Manager Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Autonomous Manager Engine. This cloud solution delivers unprecedented automation and intelligence.
          </p>
