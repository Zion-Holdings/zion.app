...
export const metadata: Metadata = {
  title: 'Cognitive Optimizer for Legal',
  description: 'Revolutionize legal through intelligent automation. Our Cognitive Optimizer for Legal leverages advanced machine learning to deliver process automation at scale',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-optimizer-for-legal-a0d5f4f2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Optimizer for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Cognitive Optimizer for Legal leverages advanced machine learning to deliver process automation at scale.
          </p>
