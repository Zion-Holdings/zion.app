...
export const metadata: Metadata = {
  title: 'Intelligent User Analytics',
  description: 'Revolutionize healthcare through intelligent automation. Our Intelligent User Analytics leverages advanced machine learning to deliver energy management at scal',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Intelligent User Analytics leverages advanced machine learning to deliver energy management at scale.
          </p>
