...
export const metadata: Metadata = {
  ...
  keywords: 'PPO/SAC RL fine-tune on your KPI objective, Simulation environment without touching production, Policy deployment via feature-flag rollout, Online drift detector + retrain trigger, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Reinforcement Learning Optimiser</h1>
        <p className="text-lg text-slate-300 mb-8">RL-based continuous optimisation for resource scheduling, pricing, content delivery, manufacturing control, and inventory replenishment policies.</p>
        ...
        <li class="text-slate-300">PPO/SAC RL fine-tune on your KPI objective</li>
        <li class="text-slate-300">Simulation environment without touching production</li>
        <li class="text-slate-300">Policy deployment via feature-flag rollout</li>
        <li class="text-slate-300">Online drift detector + retrain trigger</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with reinforcement learning optimiser</li>
