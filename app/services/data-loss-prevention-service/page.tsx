...
export const metadata: Metadata = {
  ...
  keywords: 'Content inspection, Email DLP, Cloud DLP, Endpoint DLP, Policy enforcement, Incident response, User behavior analytics, Compliance reporting, security, Enterprise, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Data Loss Prevention (DLP) Service</h1>
        <p className="text-lg text-slate-300 mb-8">Comprehensive DLP solution that monitors, detects, and prevents data exfiltration across email, cloud, and endpoints. Includes content inspection, policy enforcement, and incident response.</p>
        ...
        <li class="text-slate-300">Content inspection</li>
        ...
        <li class="text-slate-300">User behavior analytics</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">99% data leak prevention</li>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">25</p>
