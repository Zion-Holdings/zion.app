...
export const metadata: Metadata = {
  title: 'Predictive Automation Engine - Hospitality',
  description: 'Next-generation hospitality solution: Predictive Automation Engine - Hospitality. Combines scalability planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-automation-engine-hospitality-a37fe4f6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Automation Engine - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Predictive Automation Engine - Hospitality. Combines scalability planning with adaptive intelligence for optimal results.
          </p>
