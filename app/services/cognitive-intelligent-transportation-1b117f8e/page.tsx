...
export const metadata: Metadata = {
  title: 'Cognitive intelligent-transportation',
  description: 'Enhance your transportation business with Cognitive intelligent-transportation. Our solution provides compliance reporting with enterprise-grade reliability and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-intelligent-transportation-1b117f8e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive intelligent-transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with Cognitive intelligent-transportation. Our solution provides compliance reporting with enterprise-grade reliability and security.
          </p>
