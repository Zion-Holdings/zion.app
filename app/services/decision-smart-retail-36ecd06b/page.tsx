...
export const metadata: Metadata = {
  title: 'Decision Smart - Retail',
  description: 'Revolutionize retail through intelligent automation. Our Decision Smart - Retail leverages advanced machine learning to deliver budget management at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/decision-smart-retail-36ecd06b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Decision Smart - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize retail through intelligent automation. Our Decision Smart - Retail leverages advanced machine learning to deliver budget management at scale.
          </p>
