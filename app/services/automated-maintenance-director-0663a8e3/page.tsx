...
export const metadata: Metadata = {
  title: 'Automated Maintenance Director',
  description: 'Revolutionize edge through intelligent automation. Our Automated Maintenance Director leverages advanced machine learning to deliver language processing at scal',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Maintenance Director
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize edge through intelligent automation. Our Automated Maintenance Director leverages advanced machine learning to deliver language processing at scale.
          </p>
