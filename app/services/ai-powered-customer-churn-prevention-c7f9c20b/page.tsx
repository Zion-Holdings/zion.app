...
export const metadata: Metadata = {
  title: 'AI-Powered Customer Churn Prevention',
  description: 'Identifies at-risk customers and triggers retention workflows automatically.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-customer-churn-prevention-c7f9c20b',
  },

export const metadata = {
  title: "AI-Powered Customer Churn Prevention - Zion Tech Group",
  description: "Identifies at-risk customers and triggers retention workflows automatically.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-customer-churn-prevention-c7f9c20b`
  }
  ...
  return (
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Identifies at-risk customers and triggers retention workflows automatically.
          </p>
    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">AI-Powered Customer Churn Prevention</h1>
        <p className="text-lg text-gray-300 mb-8">Identifies at-risk customers and triggers retention workflows automatically.</p>
