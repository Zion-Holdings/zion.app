...
export const metadata: Metadata = {
  title: 'AI-Powered Territory Optimization',
  description: 'Optimizes sales territories for maximum coverage and minimal overlap.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-territory-optimization-a3cc0ea8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimizes sales territories for maximum coverage and minimal overlap.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Territory optimization</li>
          <li className="text-gray-300">Coverage analysis</li>
          <li className="text-gray-300">Account assignment</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">25% efficiency gain</li>
