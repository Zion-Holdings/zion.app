...
export const metadata: Metadata = {
  title: 'Enterprise data-gaming',
  description: 'The future of gaming is here with Enterprise data-gaming. Powered by cutting-edge AI, this platform delivers root cause analysis like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-data-gaming-aeadbff5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise data-gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of gaming is here with Enterprise data-gaming. Powered by cutting-edge AI, this platform delivers root cause analysis like never before.
          </p>
