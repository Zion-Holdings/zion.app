...
export const metadata: Metadata = {
  title: 'Smart Data for Tech',
  description: 'Enhance your technology business with Smart Data for Tech. Our solution provides recruitment automation with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-data-for-tech-64a00697',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your technology business with Smart Data for Tech. Our solution provides recruitment automation with enterprise-grade reliability and security.
          </p>
