...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time shipment tracking & ETA prediction, Supplier risk scoring & early warning, Inventory anomaly detection, Automated disruption alerts (Slack/email), Root cause analysis & recommendation engine, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Supply Chain Visibility Platform</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end supply chain monitoring with AI-driven anomaly detection, predictive ETAs, and automated disruption alerts across suppliers, logistics, and inventory.</p>
        ...
        <li class="text-slate-300">Real-time shipment tracking &amp; ETA prediction</li>
        <li class="text-slate-300">Supplier risk scoring &amp; early warning</li>
        <li class="text-slate-300">Inventory anomaly detection</li>
        <li class="text-slate-300">Automated disruption alerts (Slack/email)</li>
        <li class="text-slate-300">Root cause analysis &amp; recommendation engine</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai supply chain visibility platform</li>
