...
export const metadata: Metadata = {
  ...
  description: 'Drive innovation in logistics with Cognitive AI Solution - Logistics. This AI-powered platform transforms security monitoring into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-ai-solution-logistics-5fcde79a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with Cognitive AI Solution - Logistics. This AI-powered platform transforms security monitoring into a competitive advantage.
          </p>
