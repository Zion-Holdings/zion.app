...
export const metadata: Metadata = {
  title: 'Intelligent Security for Finance',
  description: 'Enhance your finance business with Intelligent Security for Finance. Our solution provides sentiment analysis with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-security-for-finance-51db6046',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Security for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your finance business with Intelligent Security for Finance. Our solution provides sentiment analysis with enterprise-grade reliability and security.
          </p>
