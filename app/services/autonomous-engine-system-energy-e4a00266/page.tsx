...
export const metadata: Metadata = {
  title: 'Autonomous Engine System - Energy',
  description: 'Transform your energy operations with our Autonomous Engine System - Energy. This AI-driven solution automates loyalty optimization with unprecedented accuracy ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-engine-system-energy-e4a00266',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Engine System - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Autonomous Engine System - Energy. This AI-driven solution automates loyalty optimization with unprecedented accuracy and efficiency.
          </p>
