...
export const metadata: Metadata = {
  title: 'Autonomous cloud-real-estate',
  description: 'Enhance your real-estate business with Autonomous cloud-real-estate. Our solution provides testing automation with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-cloud-real-estate-1005120a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous cloud-real-estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your real-estate business with Autonomous cloud-real-estate. Our solution provides testing automation with enterprise-grade reliability and security.
          </p>
