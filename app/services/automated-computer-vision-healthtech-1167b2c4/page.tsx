...
export const metadata: Metadata = {
  title: 'Automated computer vision-healthtech',
  description: 'The future of healthtech is here with Automated computer vision-healthtech. Powered by cutting-edge AI, this platform delivers rpa orchestration like never befo',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated computer vision-healthtech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthtech is here with Automated computer vision-healthtech. Powered by cutting-edge AI, this platform delivers rpa orchestration like never before.
          </p>
