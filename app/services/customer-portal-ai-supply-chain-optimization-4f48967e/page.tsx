...
export const metadata: Metadata = {
  ...
  description: 'customer portal solution for petrochemicals industry. Optimizes supply chain operations using predictive analytics, demand forecasting, and route optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/customer-portal-ai-supply-chain-optimization-4f48967e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Customer Portal AI Supply Chain Optimization
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            customer portal solution for petrochemicals industry. Optimizes supply chain operations using predictive analytics, demand forecasting, and route optimization.
          </p>
