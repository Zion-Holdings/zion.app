...
export const metadata: Metadata = {
  ...
  keywords: 'OCI-compliant private container registry, Trivy CVE scan gate (fail on CRITICAL), SBOM (SPDX/CycloneDX) per image, Cosign image signing + policy gate, Registry mirror + geo-replication, cloud, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Container Registry + Trivy Scan</h1>
        <p className="text-lg text-slate-300 mb-8">Private container registry with built-in Trivy CVE scanning, SBOM generation, image signing, and promotion pipeline (dev→staging→prod).</p>
        ...
        <li class="text-slate-300">OCI-compliant private container registry</li>
        <li class="text-slate-300">Trivy CVE scan gate (fail on CRITICAL)</li>
        <li class="text-slate-300">SBOM (SPDX/CycloneDX) per image</li>
        <li class="text-slate-300">Cosign image signing + policy gate</li>
        <li class="text-slate-300">Registry mirror + geo-replication</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with container registry + trivy scan</li>
