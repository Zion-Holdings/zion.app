...
export const metadata: Metadata = {
  title: 'Real Estate Predictive - Cleantech',
  description: 'Next-generation cleantech solution: Real Estate Predictive - Cleantech. Combines user experience with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/real-estate-predictive---cleantech-68942ab0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Real Estate Predictive - Cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation cleantech solution: Real Estate Predictive - Cleantech. Combines user experience with adaptive intelligence for optimal results.
          </p>
