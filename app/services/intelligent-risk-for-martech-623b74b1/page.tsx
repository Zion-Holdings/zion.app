...
export const metadata: Metadata = {
  title: 'Intelligent Risk for MARTECH',
  description: 'Next-generation martech solution: Intelligent Risk for MARTECH. Combines business continuity with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-risk-for-martech-623b74b1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Risk for MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation martech solution: Intelligent Risk for MARTECH. Combines business continuity with adaptive intelligence for optimal results.
          </p>
