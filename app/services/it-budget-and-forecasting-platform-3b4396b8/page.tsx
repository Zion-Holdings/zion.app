...
export const metadata: Metadata = {
  title: 'IT Budget & Forecasting Platform',
  description: 'AI-powered IT financial management solution that provides budget planning, forecasting, and cost allocation with predictive analytics for future spending.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/it-budget-and-forecasting-platform-3b4396b8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            IT Budget & Forecasting Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered IT financial management solution that provides budget planning, forecasting, and cost allocation with predictive analytics for future spending.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Budget planning</li>
          <li className="text-gray-300">Forecasting</li>
          <li className="text-gray-300">Cost allocation</li>
          <li className="text-gray-300">Spend analytics</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">25% budget accuracy</li>
          <li className="text-purple-300">90% forecast precision</li>
          <li className="text-purple-300">Zero budget overruns</li>
          </ul>
        </section>
