...
export const metadata: Metadata = {
  title: 'Autonomous Content Optimization',
  description: 'Revolutionize healthcare through intelligent automation. Our Autonomous Content Optimization leverages advanced machine learning to deliver supply chain at scal',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Autonomous Content Optimization leverages advanced machine learning to deliver supply chain at scale.
          </p>
