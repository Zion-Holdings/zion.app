...
export const metadata: Metadata = {
  ...
  keywords: 'Unsupervised clustering of log events, Real-time anomaly scoring per time-series, Seamless integration with ELK/Prometheus, Alert suppression & correlation, Root-cause hinting via pattern matching, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Powered Log Anomaly Detection</h1>
        <p className="text-lg text-slate-300 mb-8">Automatically detect unusual patterns, spikes, and errors in logs using unsupervised ML; reduce alert fatigue and surface issues before they cause outages.</p>
        ...
        <li class="text-slate-300">Unsupervised clustering of log events</li>
        <li class="text-slate-300">Real-time anomaly scoring per time-series</li>
        <li class="text-slate-300">Seamless integration with ELK/Prometheus</li>
        <li class="text-slate-300">Alert suppression &amp; correlation</li>
        <li class="text-slate-300">Root-cause hinting via pattern matching</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai-powered log anomaly detection</li>
