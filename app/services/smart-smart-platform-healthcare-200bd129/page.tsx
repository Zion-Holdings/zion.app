...
export const metadata: Metadata = {
  title: 'Smart Smart Platform - Healthcare',
  description: 'Optimize your healthcare workflows with Smart Smart Platform - Healthcare. This intelligent platform delivers automation opportunity through advanced automation',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-smart-platform-healthcare-200bd129',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Smart Platform - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Smart Smart Platform - Healthcare. This intelligent platform delivers automation opportunity through advanced automation and AI.
          </p>
