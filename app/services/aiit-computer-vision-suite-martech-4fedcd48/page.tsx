...
export const metadata: Metadata = {
  title: 'AI/IT Computer Vision Suite - MARTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Computer Vision Suite - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated martech solution: AI/IT Computer Vision Suite - MARTECH. Combines code optimization with next-gen AI for maximum velocity.
          </p>
