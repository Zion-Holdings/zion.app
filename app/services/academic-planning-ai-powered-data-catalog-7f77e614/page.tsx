...
export const metadata: Metadata = {
  title: 'Academic Planning AI-Powered Data Catalog',
  description: 'AI-powered academic planning solution for data governance. Self-updating data catalog with automated metadata extraction.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/academic-planning-ai-powered-data-catalog-7f77e614',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Academic Planning AI-Powered Data Catalog
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered academic planning solution for data governance. Self-updating data catalog with automated metadata extraction.
          </p>
