...
export const metadata: Metadata = {
  title: 'Autonomous Recruitment System - Saas',
  description: 'Unlock unprecedented growth with Autonomous Recruitment System - Saas. This autonomous system provides procurement automation with zero manual intervention need',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Recruitment System - Saas
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Autonomous Recruitment System - Saas. This autonomous system provides procurement automation with zero manual intervention needed.
          </p>
