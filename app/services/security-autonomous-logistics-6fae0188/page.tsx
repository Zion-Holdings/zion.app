...
export const metadata: Metadata = {
  title: 'Security Autonomous - Logistics',
  description: 'Transform your logistics operations with our Security Autonomous - Logistics. This AI-driven solution automates performance tuning with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-autonomous-logistics-6fae0188',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Autonomous - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Security Autonomous - Logistics. This AI-driven solution automates performance tuning with unprecedented accuracy and efficiency.
          </p>
