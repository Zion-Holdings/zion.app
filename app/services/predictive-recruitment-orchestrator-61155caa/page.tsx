...
export const metadata: Metadata = {
  title: 'Predictive Recruitment Orchestrator',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Recruitment Orchestrator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for althealth: Predictive Recruitment Orchestrator. Uses quantum-inspired algorithms to deliver conversational ai at exponential speed.
          </p>
