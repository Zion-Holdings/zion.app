...
export const metadata: Metadata = {
  title: 'Intelligent Revenue for Logistics',
  description: 'Enhance your logistics business with Intelligent Revenue for Logistics. Our solution provides churn prediction with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-revenue-for-logistics-2f157824',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Revenue for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with Intelligent Revenue for Logistics. Our solution provides churn prediction with enterprise-grade reliability and security.
          </p>
