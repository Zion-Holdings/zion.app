...
export const metadata: Metadata = {
  title: 'Next-Gen Optimization for Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Next-Gen Optimization for Hospitality leverages advanced machine learning to deliver threat detect',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-optimization-for-hospitality-facbc1ff',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Optimization for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Next-Gen Optimization for Hospitality leverages advanced machine learning to deliver threat detection at scale.
          </p>
