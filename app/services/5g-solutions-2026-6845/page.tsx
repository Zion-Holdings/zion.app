...
export const metadata = {
  ...
  alternates: { canonical: '/services/5g-solutions-2026-6845/' },

  openGraph: {
    title: '5G Solutions | Zion Tech Group',
    description: 'End-to-end 5g solutions services: assessment, deployment, and managed operations.',
    url: 'https://ziontechgroup.com/services/5g-solutions-2026-6845/',
    siteName: 'Zion Tech Group',
    type: 'website',
    images: ['/og-default.png'],
  },
  twitter: { card: 'summary_large_image', title: '5G Solutions | Zion Tech Group', description: 'End-to-end 5g solutions services: assessment, deployment, and managed operations.' }};

export default function ServicePage() {
  return (
    <main className="min-h-screen bg-slate-950 py-20">

    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "5G Solutions | Zion Tech Group", description: "End-to-end 5g solutions services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/5g-solutions-2026-6845/}} />
      <div className="container-page">
        ...
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end 5g solutions services: assessment, deployment, and managed operations.
        </p>
