...
export const metadata: Metadata = {
  title: 'AI-Powered Revenue for Agriculture',
  description: 'The future of agriculture is here with AI-Powered Revenue for Agriculture. Powered by cutting-edge AI, this platform delivers energy management like never befor',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Revenue for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with AI-Powered Revenue for Agriculture. Powered by cutting-edge AI, this platform delivers energy management like never before.
          </p>
