...
export const metadata: Metadata = {
  title: 'Smart Intelligence Platform - Agriculture',
  description: 'Unlock unprecedented growth with Smart Intelligence Platform - Agriculture. This autonomous system provides user experience with zero manual intervention needed',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-intelligence-platform-agriculture-0c2e3f67',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Intelligence Platform - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Intelligence Platform - Agriculture. This autonomous system provides user experience with zero manual intervention needed.
          </p>
