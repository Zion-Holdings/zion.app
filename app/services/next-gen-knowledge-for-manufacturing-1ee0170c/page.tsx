...
export const metadata: Metadata = {
  title: 'Next-Gen Knowledge for Manufacturing',
  description: 'Drive innovation in manufacturing with Next-Gen Knowledge for Manufacturing. This AI-powered platform transforms survey automation into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-knowledge-for-manufacturing-1ee0170c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Knowledge for Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in manufacturing with Next-Gen Knowledge for Manufacturing. This AI-powered platform transforms survey automation into a competitive advantage.
          </p>
