...
export const metadata: Metadata = {
  title: 'AI/IT SMB Suite - Media',
  description: 'Drive innovation in media with AI/IT SMB Suite - Media. This AI-powered platform transforms user experience into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-smb-suite-media-f6f72439',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT SMB Suite - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in media with AI/IT SMB Suite - Media. This AI-powered platform transforms user experience into a competitive advantage.
          </p>
