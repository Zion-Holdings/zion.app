...
export const metadata: Metadata = {
  ...
  keywords: 'No-code model training, Edge deployment option, Anomaly detection mode, Conveyor integration SDK, Defect classification export, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Auto-train Custom vision models for manufacturing quality control: surface defect detection, assembly verification, and real-time conveyor-belt inspection.</p>
        ...
        <li class="text-slate-300">No-code model training</li>
        <li class="text-slate-300">Edge deployment option</li>
        <li class="text-slate-300">Anomaly detection mode</li>
        <li class="text-slate-300">Conveyor integration SDK</li>
        <li class="text-slate-300">Defect classification export</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with computer vision quality inspection</li>
