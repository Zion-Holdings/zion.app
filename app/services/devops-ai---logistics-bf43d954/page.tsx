...
export const metadata: Metadata = {
  title: 'DevOps AI - Logistics',
  description: 'Revolutionize logistics through intelligent automation. Our DevOps AI - Logistics leverages advanced machine learning to deliver maintenance scheduling at scale',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/devops-ai---logistics-bf43d954',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our DevOps AI - Logistics leverages advanced machine learning to deliver maintenance scheduling at scale.
          </p>
