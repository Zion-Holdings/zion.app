...
export const metadata: Metadata = {
  title: 'Smart Machine Learning Platform - Construction #2',
  description: 'Revolutionize construction through intelligent automation. Our Smart Machine Learning Platform - Construction #2 leverages advanced machine learning to deliver ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-machine-learning-platform-construction-2-dad4edf8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Machine Learning Platform - Construction #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Smart Machine Learning Platform - Construction #2 leverages advanced machine learning to deliver disaster recovery at scale.
          </p>
