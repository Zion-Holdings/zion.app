      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Intelligent HR automation for recruitment, onboarding, employee engagement, and policy Q&A using conversational AI.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ AI resume screening & ranking</li>
            <li className="text-purple-300">✓ Automated interview scheduling</li>
            <li className="text-purple-300">✓ Employee onboarding chatbot</li>
            <li className="text-purple-300">✓ Policy Q&A knowledge base</li>
            <li className="text-purple-300">✓ Engagement & sentiment tracking</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai hr assistant</li>
