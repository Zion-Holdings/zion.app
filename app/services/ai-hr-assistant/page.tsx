...
export const metadata: Metadata = {
  ...
  keywords: 'AI resume screening & ranking, Automated interview scheduling, Employee onboarding chatbot, Policy Q&A knowledge base, Engagement & sentiment tracking, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI HR Assistant</h1>
        <p className="text-lg text-slate-300 mb-8">Intelligent HR automation for recruitment, onboarding, employee engagement, and policy Q&amp;A using conversational AI.</p>
        ...
        <li class="text-slate-300">AI resume screening &amp; ranking</li>
        <li class="text-slate-300">Automated interview scheduling</li>
        <li class="text-slate-300">Employee onboarding chatbot</li>
        <li class="text-slate-300">Policy Q&amp;A knowledge base</li>
        <li class="text-slate-300">Engagement &amp; sentiment tracking</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai hr assistant</li>
