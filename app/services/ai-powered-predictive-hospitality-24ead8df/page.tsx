...
export const metadata: Metadata = {
  title: 'AI-Powered predictive-hospitality',
  description: 'Enhance your hospitality business with AI-Powered predictive-hospitality. Our solution provides inventory management with enterprise-grade reliability and secur',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered predictive-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with AI-Powered predictive-hospitality. Our solution provides inventory management with enterprise-grade reliability and security.
          </p>
