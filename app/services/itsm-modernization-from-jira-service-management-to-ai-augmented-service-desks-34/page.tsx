...
export const metadata = {
  ...
  description: 'End-to-end itsm modernization: from jira service management to ai-augmented service desks services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/itsm-modernization-from-jira-service-management-to-ai-augmented-service-desks-34/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">ITSM Modernization: From Jira Service Management to AI-Augmented Service Desks</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end itsm modernization: from jira service management to ai-augmented service desks services: assessment, deployment, and managed operations.
        </p>
