...
export const metadata: Metadata = {
  title: 'Self-Optimizing Security for Edge',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Security for Edge
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation edge solution: Self-Optimizing Security for Edge. Combines customer service automation with adaptive intelligence for optimal results.
          </p>
