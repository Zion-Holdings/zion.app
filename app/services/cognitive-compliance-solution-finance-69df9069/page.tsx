...
export const metadata: Metadata = {
  title: 'Cognitive Compliance Solution - Finance',
  description: 'The future of finance is here with Cognitive Compliance Solution - Finance. Powered by cutting-edge AI, this platform delivers image recognition like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-compliance-solution-finance-69df9069',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Compliance Solution - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of finance is here with Cognitive Compliance Solution - Finance. Powered by cutting-edge AI, this platform delivers image recognition like never before.
          </p>
