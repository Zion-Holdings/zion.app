...
export const metadata: Metadata = {
  title: "Account-Based Marketing AI-Powered Resume Screening - AI-Powered Account-Based Marketing Solution",
  description: "AI-powered account-based marketing solution for hr. Automates candidate screening using NLP and skills matching.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/account-based-marketing-ai-powered-resume-screening-fa3e4cba",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Account-Based Marketing AI-Powered Resume Screening - AI-Powered Account-Based Marketing Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          AI-powered account-based marketing solution for hr. Automates candidate screening using NLP and skills matching.
        </p>
