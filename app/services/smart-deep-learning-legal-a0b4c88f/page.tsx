...
export const metadata: Metadata = {
  title: 'Smart deep learning-legal',
  description: 'The future of legal is here with Smart deep learning-legal. Powered by cutting-edge AI, this platform delivers transformative results like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-deep-learning-legal-a0b4c88f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart deep learning-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Smart deep learning-legal. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
