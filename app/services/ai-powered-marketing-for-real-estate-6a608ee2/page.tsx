...
export const metadata: Metadata = {
  title: 'AI-Powered Marketing for Real-Estate',
  description: 'The future of real-estate is here with AI-Powered Marketing for Real-Estate. Powered by cutting-edge AI, this platform delivers quality control like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-marketing-for-real-estate-6a608ee2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of real-estate is here with AI-Powered Marketing for Real-Estate. Powered by cutting-edge AI, this platform delivers quality control like never before.
          </p>
