...
export const metadata: Metadata = {
  title: 'Automated real estate-edge',
  description: 'The future of edge is here with Automated real estate-edge. Powered by cutting-edge AI, this platform delivers workflow management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-real-estate-edge-cdc553ee',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated real estate-edge
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of edge is here with Automated real estate-edge. Powered by cutting-edge AI, this platform delivers workflow management like never before.
          </p>
