...
export const metadata: Metadata = {
  title: 'Cognitive Insights Solution - FINTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Insights Solution - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Cognitive Insights Solution - FINTECH. This autonomous system provides pricing optimization with zero manual intervention needed.
          </p>
