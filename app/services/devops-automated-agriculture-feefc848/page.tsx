...
export const metadata: Metadata = {
  title: 'DevOps Automated - Agriculture',
  description: 'The future of agriculture is here with DevOps Automated - Agriculture. Powered by cutting-edge AI, this platform delivers edge computing like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/devops-automated-agriculture-feefc848',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            DevOps Automated - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with DevOps Automated - Agriculture. Powered by cutting-edge AI, this platform delivers edge computing like never before.
          </p>
