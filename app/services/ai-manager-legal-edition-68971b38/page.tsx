...
export const metadata: Metadata = {
  title: 'AI Manager - Legal Edition',
  description: 'Drive innovation in legal with AI Manager - Legal Edition. This AI-powered platform transforms sentiment analysis into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-manager-legal-edition-68971b38',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Manager - Legal Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with AI Manager - Legal Edition. This AI-powered platform transforms sentiment analysis into a competitive advantage.
          </p>
