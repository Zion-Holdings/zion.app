...
export const metadata: Metadata = {
  title: 'Autonomous Predictor System - Transportation',
  description: 'Future-proof your transportation with Autonomous Predictor System - Transportation. Our autonomous solution handles decision support end-to-end without human in',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Predictor System - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your transportation with Autonomous Predictor System - Transportation. Our autonomous solution handles decision support end-to-end without human intervention.
          </p>
