...
export const metadata: Metadata = {
  title: 'Quantum Orchestrator - Construction Quantum',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Orchestrator - Construction Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Quantum Orchestrator - Construction Quantum. This AI-driven solution automates sales process optimization with unprecedented accuracy and efficiency.
          </p>
