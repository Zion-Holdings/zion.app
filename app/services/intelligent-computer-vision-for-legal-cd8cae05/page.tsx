...
export const metadata: Metadata = {
  title: 'Intelligent Computer Vision for Legal',
  description: 'The future of legal is here with Intelligent Computer Vision for Legal. Powered by cutting-edge AI, this platform delivers feature engineering like never before',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-computer-vision-for-legal-cd8cae05',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Computer Vision for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Intelligent Computer Vision for Legal. Powered by cutting-edge AI, this platform delivers feature engineering like never before.
          </p>
