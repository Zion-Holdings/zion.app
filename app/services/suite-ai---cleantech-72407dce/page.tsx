...
export const metadata: Metadata = {
  title: 'Suite AI - Cleantech',
  description: 'Revolutionize cleantech through intelligent automation. Our Suite AI - Cleantech leverages advanced machine learning to deliver network optimization at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/suite-ai---cleantech-72407dce',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cleantech through intelligent automation. Our Suite AI - Cleantech leverages advanced machine learning to deliver network optimization at scale.
          </p>
