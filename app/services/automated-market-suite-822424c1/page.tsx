...
export const metadata: Metadata = {
  title: 'Automated Market Suite',
  description: 'Transform your healthcare operations with our Automated Market Suite. This AI-driven solution provides intelligent automation with unprecedented accuracy and ef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-market-suite-822424c1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Market Suite
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Automated Market Suite. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
