...
export const metadata: Metadata = {
  ...
  keywords: 'Role-based access control, Machine learning integration, Custom integrations, Offline capabilities, intelligence, manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Automation Intelligent - Manufacturing</h1>
        <p className="text-lg text-slate-300 mb-8">Revolutionize manufacturing through intelligent automation. Our Automation Intelligent - Manufacturing leverages advanced machine learning to deliver data processing at scale.</p>
