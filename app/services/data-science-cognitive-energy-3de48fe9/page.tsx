...
export const metadata: Metadata = {
  title: 'Data Science Cognitive - Energy',
  description: 'Unlock unprecedented growth with Data Science Cognitive - Energy. This autonomous system provides financial risk management with zero manual intervention needed',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-science-cognitive-energy-3de48fe9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Science Cognitive - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Data Science Cognitive - Energy. This autonomous system provides financial risk management with zero manual intervention needed.
          </p>
