...
export const metadata: Metadata = {
  title: 'Smart Process Mining Platform - Sports',
  description: 'The future of sports is here with Smart Process Mining Platform - Sports. Powered by cutting-edge AI, this platform delivers api management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-process-mining-platform-sports-b4c9fe67',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Process Mining Platform - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Smart Process Mining Platform - Sports. Powered by cutting-edge AI, this platform delivers api management like never before.
          </p>
