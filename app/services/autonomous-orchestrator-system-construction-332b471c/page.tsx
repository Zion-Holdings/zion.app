...
export const metadata: Metadata = {
  title: 'Autonomous Orchestrator System - Construction',
  description: 'Drive innovation in construction with Autonomous Orchestrator System - Construction. This AI-powered platform transforms compliance monitoring into a competitiv',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-orchestrator-system-construction-332b471c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Orchestrator System - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Autonomous Orchestrator System - Construction. This AI-powered platform transforms compliance monitoring into a competitive advantage.
          </p>
