...
export const metadata: Metadata = {
  ...
  keywords: 'AI-powered threat detection, Automated threat response, Behavioral analysis, Ransomware protection, Forensic investigation tools, Threat intelligence integration, Integration with SIEM/SOAR, Managed detection option, security, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Endpoint Detection &amp; Response (EDR) Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Next-gen EDR with AI-powered threat detection, automated response, and forensic investigation. Protect endpoints from malware, ransomware, and advanced threats.</p>
        ...
        <li class="text-slate-300">AI-powered threat detection</li>
        ...
        <li class="text-slate-300">Forensic investigation tools</li>
        <li class="text-slate-300">Threat intelligence integration</li>
        <li class="text-slate-300">Integration with SIEM/SOAR</li>
        <li class="text-slate-300">Managed detection option</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Detect advanced threats in real-time</li>
        <li class="text-slate-300">Automated response reduces MTTR</li>
        <li class="text-slate-300">Protect against ransomware</li>
        <li class="text-slate-300">Full forensic visibility</li>
      </ul>
        </div>
