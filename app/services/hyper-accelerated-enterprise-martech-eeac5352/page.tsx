...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated enterprise-martech',
  description: 'Enhance your martech business with Hyper-Accelerated enterprise-martech. Our solution provides rpa orchestration with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/hyper-accelerated-enterprise-martech-eeac5352',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated enterprise-martech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your martech business with Hyper-Accelerated enterprise-martech. Our solution provides rpa orchestration with enterprise-grade reliability and security.
          </p>
