...
export const metadata: Metadata = {
  title: 'Enterprise Process Mining for Finance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Process Mining for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation finance solution: Enterprise Process Mining for Finance. Combines hyperautomation with adaptive intelligence for optimal results.
          </p>
