...
export const metadata: Metadata = {
  title: 'Autonomous Vendor System - Insurance',
  description: 'Next-generation insurance solution: Autonomous Vendor System - Insurance. Combines incident response with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-vendor-system-insurance-b8423921',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Vendor System - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Autonomous Vendor System - Insurance. Combines incident response with adaptive intelligence for optimal results.
          </p>
