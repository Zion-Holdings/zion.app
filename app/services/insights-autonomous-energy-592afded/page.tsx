...
export const metadata: Metadata = {
  title: 'Insights Autonomous - Energy',
  description: 'Unlock unprecedented growth with Insights Autonomous - Energy. This autonomous system provides data quality with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/insights-autonomous-energy-592afded',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Insights Autonomous - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Insights Autonomous - Energy. This autonomous system provides data quality with zero manual intervention needed.
          </p>
