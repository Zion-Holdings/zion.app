...
export const metadata: Metadata = {
  title: 'Intelligent Security for Legal',
  description: 'Enhance your legal business with Intelligent Security for Legal. Our solution provides vendor management with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-security-for-legal-901ab553',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Security for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Intelligent Security for Legal. Our solution provides vendor management with enterprise-grade reliability and security.
          </p>
