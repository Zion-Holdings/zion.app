...
export const metadata: Metadata = {
  title: 'Intelligent Finance for Agriculture',
  description: 'Transform your agriculture operations with our Intelligent Finance for Agriculture. This AI-driven solution automates supply chain with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-finance-for-agriculture-7e4f23b5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Finance for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Intelligent Finance for Agriculture. This AI-driven solution automates supply chain with unprecedented accuracy and efficiency.
          </p>
