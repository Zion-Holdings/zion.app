...
export const metadata: Metadata = {
  title: 'Smart System Platform - Retail',
  description: 'Transform your retail operations with our Smart System Platform - Retail. This AI-driven solution automates market intelligence with unprecedented accuracy and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-system-platform-retail-10d58eeb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart System Platform - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our Smart System Platform - Retail. This AI-driven solution automates market intelligence with unprecedented accuracy and efficiency.
          </p>
