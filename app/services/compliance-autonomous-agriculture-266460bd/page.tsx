...
export const metadata: Metadata = {
  title: 'Compliance Autonomous - Agriculture',
  description: 'The future of agriculture is here with Compliance Autonomous - Agriculture. Powered by cutting-edge AI, this platform delivers invoice processing like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/compliance-autonomous-agriculture-266460bd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Compliance Autonomous - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Compliance Autonomous - Agriculture. Powered by cutting-edge AI, this platform delivers invoice processing like never before.
          </p>
