...
export const metadata: Metadata = {
  title: 'Automated Computer Vision for Construction',
  description: 'Revolutionize construction through intelligent automation. Our Automated Computer Vision for Construction leverages advanced machine learning to deliver data qu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-computer-vision-for-construction-b3bd6867',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Computer Vision for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Automated Computer Vision for Construction leverages advanced machine learning to deliver data quality at scale.
          </p>
