...
export const metadata: Metadata = {
  title: 'Smart Manufacturing Finance',
  description: 'Next-generation logistics solution: Smart Manufacturing Finance. Combines inventory management with adaptive intelligence for optimal results.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manufacturing Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Smart Manufacturing Finance. Combines inventory management with adaptive intelligence for optimal results.
          </p>
