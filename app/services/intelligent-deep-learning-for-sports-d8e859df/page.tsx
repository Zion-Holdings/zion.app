...
export const metadata: Metadata = {
  title: 'Intelligent Deep Learning for Sports',
  description: 'Drive innovation in sports with Intelligent Deep Learning for Sports. This AI-powered platform transforms customer journey mapping into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-deep-learning-for-sports-d8e859df',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Deep Learning for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in sports with Intelligent Deep Learning for Sports. This AI-powered platform transforms customer journey mapping into a competitive advantage.
          </p>
