...
export const metadata: Metadata = {
  title: 'Autonomous Cloud for Sports',
  description: 'Transform your sports operations with our Autonomous Cloud for Sports. This AI-driven solution automates process automation with unprecedented accuracy and effi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-cloud-for-sports-23c81c3f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Cloud for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our Autonomous Cloud for Sports. This AI-driven solution automates process automation with unprecedented accuracy and efficiency.
          </p>
