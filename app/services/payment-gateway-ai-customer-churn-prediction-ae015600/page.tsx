...
export const metadata: Metadata = {
  title: 'Payment Gateway AI Customer Churn Prediction',
  description: 'payment gateway solution for renewable energy industry. Identifies at-risk customers before they churn using behavioral patterns and engagement metrics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/payment-gateway-ai-customer-churn-prediction-ae015600',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Payment Gateway AI Customer Churn Prediction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            payment gateway solution for renewable energy industry. Identifies at-risk customers before they churn using behavioral patterns and engagement metrics.
          </p>
