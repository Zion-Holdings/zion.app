...
export const metadata: Metadata = {
  title: 'Adaptive Director Module',
  description: 'Transform your insurance operations with our Adaptive Director Module. This devops solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-director-module-8218e8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Director Module
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Adaptive Director Module. This devops solution delivers unprecedented automation and intelligence.
          </p>
