...
export const metadata = {
  title: "Enterprise Optimized Healthcare Analytics Suite - Zion Tech Group",
  description: "Enterprise analytics suite that delivers optimized healthcare insights with unified dashboards and reporting.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/enterprise-optimized-healthcare-analytics-suite-7d9ae2df`
  }
};
