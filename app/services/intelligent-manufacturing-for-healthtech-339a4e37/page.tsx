...
export const metadata: Metadata = {
  title: 'Intelligent Manufacturing for HEALTHTECH',
  description: 'Optimize your healthtech workflows with Intelligent Manufacturing for HEALTHTECH. This intelligent platform delivers esg reporting through advanced automation a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Manufacturing for HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthtech workflows with Intelligent Manufacturing for HEALTHTECH. This intelligent platform delivers esg reporting through advanced automation and AI.
          </p>
