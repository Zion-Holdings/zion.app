...
export const metadata: Metadata = {
  title: 'Cognitive Supply for Energy',
  description: 'Transform your energy operations with our Cognitive Supply for Energy. This AI-driven solution automates executive dashboards with unprecedented accuracy and ef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-supply-for-energy-63529b0b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Supply for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Cognitive Supply for Energy. This AI-driven solution automates executive dashboards with unprecedented accuracy and efficiency.
          </p>
