...
export const metadata: Metadata = {
  title: 'Neural customer service-real-estate',
  description: 'The future of real-estate is here with Neural customer service-real-estate. Powered by cutting-edge AI, this platform delivers transformative results like never',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-customer-service-real-estate-5ba24c04',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural customer service-real-estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of real-estate is here with Neural customer service-real-estate. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
