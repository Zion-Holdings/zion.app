...
export const metadata: Metadata = {
  title: 'Neural Manufacturing Cloud',
  description: 'The future of blockchain is here with Neural Manufacturing Cloud. Powered by cutting-edge AI, this platform delivers network optimization like never before.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Manufacturing Cloud
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of blockchain is here with Neural Manufacturing Cloud. Powered by cutting-edge AI, this platform delivers network optimization like never before.
          </p>
