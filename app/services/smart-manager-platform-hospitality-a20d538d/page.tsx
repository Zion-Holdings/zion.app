...
export const metadata: Metadata = {
  title: 'Smart Manager Platform - Hospitality',
  description: 'Enhance your hospitality business with Smart Manager Platform - Hospitality. Our solution provides incident response with enterprise-grade reliability and secur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-manager-platform-hospitality-a20d538d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manager Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Smart Manager Platform - Hospitality. Our solution provides incident response with enterprise-grade reliability and security.
          </p>
