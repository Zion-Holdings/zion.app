...
export const metadata: Metadata = {
  ...
  keywords: 'IoT/OT device discovery and profiling, Protocol analysis (Modbus, DNP3, BACnet, OPC-UA), Behavioral anomaly detection, Network micro-segmentation, Vulnerability assessment for IoT firmware, Incident response playbooks for OT, Integration with Claroty, Nozomi, Armis, security, IoT Security, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IoT &amp; OT Security Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Security for IoT and operational technology: device profiling, anomaly detection, network segmentation, and protocol analysis. Protect what traditional IT security cannot.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">security</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">IoT Security</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">IoT/OT device discovery and profiling</li>
        <li class="text-slate-300">Protocol analysis (Modbus, DNP3, BACnet, OPC-UA)</li>
        <li class="text-slate-300">Behavioral anomaly detection</li>
        <li class="text-slate-300">Network micro-segmentation</li>
        <li class="text-slate-300">Vulnerability assessment for IoT firmware</li>
        <li class="text-slate-300">Incident response playbooks for OT</li>
        <li class="text-slate-300">Integration with Claroty, Nozomi, Armis</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">See and secure every IoT/OT device</li>
        <li class="text-slate-300">Protocol-aware detection for industrial systems</li>
        <li class="text-slate-300">Micro-segmentation limits IoT blast radius</li>
        <li class="text-slate-300">OT-specific incident response playbooks</li>
      </ul>
        </div>
