...
export const metadata: Metadata = {
  title: 'Predictive Marketing Engine - Insurance',
  description: 'Optimize your insurance workflows with Predictive Marketing Engine - Insurance. This intelligent platform delivers automation opportunity through advanced autom',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-marketing-engine-insurance-86509129',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Marketing Engine - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Predictive Marketing Engine - Insurance. This intelligent platform delivers automation opportunity through advanced automation and AI.
          </p>
