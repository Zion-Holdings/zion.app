...
export const metadata: Metadata = {
  title: 'AI Coordinator - Legal Edition',
  description: 'Revolutionize legal through intelligent automation. Our AI Coordinator - Legal Edition leverages advanced machine learning to deliver feedback collection at sca',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-coordinator-legal-edition-ef686c53',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Coordinator - Legal Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our AI Coordinator - Legal Edition leverages advanced machine learning to deliver feedback collection at scale.
          </p>
