...
export const metadata: Metadata = {
  title: 'Intelligent Processor Platform',
  description: 'Transform your finance operations with our Intelligent Processor Platform. This it solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-processor-platform-354043',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Processor Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Intelligent Processor Platform. This it solution delivers unprecedented automation and intelligence.
          </p>
