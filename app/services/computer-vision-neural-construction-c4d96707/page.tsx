...
export const metadata: Metadata = {
  title: 'Computer Vision Neural - Construction',
  description: 'Revolutionize construction through intelligent automation. Our Computer Vision Neural - Construction leverages advanced machine learning to deliver enterprise-g',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/computer-vision-neural-construction-c4d96707',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Computer Vision Neural - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Computer Vision Neural - Construction leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
