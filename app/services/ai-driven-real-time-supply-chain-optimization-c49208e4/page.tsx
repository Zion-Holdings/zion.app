  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Driven Real-Time Supply Chain Optimization</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end supply chain platform that uses real-time optimization algorithms for demand planning, inventory management, and logistics coordination.</p>
