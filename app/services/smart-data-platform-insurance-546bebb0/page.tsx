...
export const metadata: Metadata = {
  title: 'Smart Data Platform - Insurance',
  description: 'Enhance your insurance business with Smart Data Platform - Insurance. Our solution provides anomaly detection with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-data-platform-insurance-546bebb0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Data Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Smart Data Platform - Insurance. Our solution provides anomaly detection with enterprise-grade reliability and security.
          </p>
