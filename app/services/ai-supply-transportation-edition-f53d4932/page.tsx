...
export const metadata: Metadata = {
  title: 'AI Supply - Transportation Edition',
  description: 'Drive innovation in transportation with AI Supply - Transportation Edition. This AI-powered platform transforms social media monitoring into a competitive advan',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-supply-transportation-edition-f53d4932',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Supply - Transportation Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in transportation with AI Supply - Transportation Edition. This AI-powered platform transforms social media monitoring into a competitive advantage.
          </p>
