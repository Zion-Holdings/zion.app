...
export const metadata: Metadata = {
  title: 'Supplier Risk Management Multi-Cloud Cost Management Platform',
  description: 'supplier risk management solution for railways industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/supplier-risk-management-multi-cloud-cost-management-platform-f0a3624c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Supplier Risk Management Multi-Cloud Cost Management Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            supplier risk management solution for railways industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.
          </p>
