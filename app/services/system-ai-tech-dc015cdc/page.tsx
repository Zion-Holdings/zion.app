...
export const metadata: Metadata = {
  title: 'System AI - Tech',
  description: 'The future of technology is here with System AI - Tech. Powered by cutting-edge AI, this platform delivers net promoter score like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/system-ai-tech-dc015cdc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of technology is here with System AI - Tech. Powered by cutting-edge AI, this platform delivers net promoter score like never before.
          </p>
