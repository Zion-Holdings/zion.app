...
export const metadata: Metadata = {
  ...
  description: 'Transform your construction operations with our Intelligent Predictor for Construction. This AI-driven solution automates process automation with unprecedented ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Intelligent Predictor for Construction. This AI-driven solution automates process automation with unprecedented accuracy and efficiency.
          </p>
