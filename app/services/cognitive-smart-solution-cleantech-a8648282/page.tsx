...
export const metadata: Metadata = {
  title: 'Cognitive Smart Solution - CLEANTECH',
  description: 'Transform your cleantech operations with our Cognitive Smart Solution - CLEANTECH. This AI-driven solution automates threat detection with unprecedented accurac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-smart-solution-cleantech-a8648282',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Smart Solution - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your cleantech operations with our Cognitive Smart Solution - CLEANTECH. This AI-driven solution automates threat detection with unprecedented accuracy and efficiency.
          </p>
