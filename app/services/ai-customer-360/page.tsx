...
export const metadata: Metadata = {
  ...
  keywords: 'Data unification (10+ sources), Timeline view, Next-best-action recommendations, Segment builder, Predictive CLV, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Customer 360 Unified Profile</h1>
        <p className="text-lg text-slate-300 mb-8">Aggregate all customer data (CRM, support, usage, billing) into single timeline. AI suggests next best action per customer.</p>
        ...
        <li class="text-slate-300">Data unification (10+ sources)</li>
        <li class="text-slate-300">Timeline view</li>
        <li class="text-slate-300">Next-best-action recommendations</li>
        <li class="text-slate-300">Segment builder</li>
        <li class="text-slate-300">Predictive CLV</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with customer 360 unified profile</li>
