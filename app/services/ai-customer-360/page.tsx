      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Aggregate all customer data (CRM, support, usage, billing) into single timeline. AI suggests next best action per customer.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Data unification (10+ sources)</li>
            <li className="text-purple-300">✓ Timeline view</li>
            <li className="text-purple-300">✓ Next-best-action recommendations</li>
            <li className="text-purple-300">✓ Segment builder</li>
            <li className="text-purple-300">✓ Predictive CLV</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with customer 360 unified profile</li>
