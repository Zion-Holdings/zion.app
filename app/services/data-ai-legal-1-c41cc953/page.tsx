...
export const metadata: Metadata = {
  title: 'Data AI - Legal #1',
  description: 'Next-generation legal solution: Data AI - Legal #1. Combines anomaly detection with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-ai-legal-1-c41cc953',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Data AI - Legal #1. Combines anomaly detection with adaptive intelligence for optimal results.
          </p>
