...
export const metadata: Metadata = {
  ...
  keywords: 'Automatic transcription, Meeting summarization, Action item extraction, Decision tracking, Searchable archive, Multi-language support, Zoom/Teams/Meet integration, Custom templates, ai, Enterprise, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Meeting Assistant &amp; Summarizer</h1>
        <p className="text-lg text-slate-300 mb-8">Automatically join, transcribe, and summarize meetings from Zoom, Teams, and Google Meet. Generates action items, decisions, and follow-up tasks. Share searchable meeting notes with attendees instantly.</p>
        ...
        <li class="text-slate-300">Automatic transcription</li>
        <li class="text-slate-300">Meeting summarization</li>
        <li class="text-slate-300">Action item extraction</li>
        <li class="text-slate-300">Decision tracking</li>
        <li class="text-slate-300">Searchable archive</li>
        <li class="text-slate-300">Multi-language support</li>
        <li class="text-slate-300">Zoom/Teams/Meet integration</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">95% accurate transcripts</li>
        <li class="text-slate-300">Save 3 hours/week on meeting notes</li>
        <li class="text-slate-300">Never miss an action item</li>
      </ul>
        </div>
