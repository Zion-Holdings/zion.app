...
export const metadata: Metadata = {
  title: 'AI-Powered Performance for Construction',
  description: 'Revolutionize construction through intelligent automation. Our AI-Powered Performance for Construction leverages advanced machine learning to deliver predictive',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-performance-for-construction-802ae509',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Performance for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our AI-Powered Performance for Construction leverages advanced machine learning to deliver predictive analytics at scale.
          </p>
