...
export const metadata: Metadata = {
  ...
  description: 'social media management solution for consumer goods industry. End-to-end predictive analytics platform that forecasts market trends, customer behavior, and oper',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/social-media-management-ai-powered-predictive-analytics-suite-0c554a10',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            social media management solution for consumer goods industry. End-to-end predictive analytics platform that forecasts market trends, customer behavior, and operational metrics with 95% accuracy.
          </p>
