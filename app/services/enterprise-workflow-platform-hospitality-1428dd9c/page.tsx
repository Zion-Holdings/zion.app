...
export const metadata: Metadata = {
  title: 'Enterprise Workflow Platform - Hospitality',
  description: 'Enhance your hospitality business with Enterprise Workflow Platform - Hospitality. Our solution provides predictive modeling with enterprise-grade reliability a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Workflow Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Enterprise Workflow Platform - Hospitality. Our solution provides predictive modeling with enterprise-grade reliability and security.
          </p>
