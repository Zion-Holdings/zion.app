...
export const metadata: Metadata = {
  title: 'Cognitive Advisor for Sports',
  description: 'The future of sports is here with Cognitive Advisor for Sports. Powered by cutting-edge AI, this platform delivers energy management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-advisor-for-sports-00c64f52',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Advisor for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Cognitive Advisor for Sports. Powered by cutting-edge AI, this platform delivers energy management like never before.
          </p>
