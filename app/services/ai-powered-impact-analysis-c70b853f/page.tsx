...
export const metadata: Metadata = {
  ...
  description: 'Predictive impact analysis for data and system changes.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-impact-analysis-c70b853f',
  },

export const metadata = {
  title: "AI-Powered Impact Analysis - Zion Tech Group",
  description: "Predictive impact analysis for data and system changes.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-impact-analysis-c70b853f`
  }
  ...
  return (
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Predictive impact analysis for data and system changes.
          </p>
    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">AI-Powered Impact Analysis</h1>
        <p className="text-lg text-gray-300 mb-8">Predictive impact analysis for data and system changes.</p>
