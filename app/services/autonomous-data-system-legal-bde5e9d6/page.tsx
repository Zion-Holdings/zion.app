...
export const metadata: Metadata = {
  title: 'Autonomous Data System - Legal',
  description: 'Revolutionize legal through intelligent automation. Our Autonomous Data System - Legal leverages advanced machine learning to deliver reputation management at s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-data-system-legal-bde5e9d6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Data System - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Autonomous Data System - Legal leverages advanced machine learning to deliver reputation management at scale.
          </p>
