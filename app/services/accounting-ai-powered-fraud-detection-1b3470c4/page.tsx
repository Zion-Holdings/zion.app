...
export const metadata: Metadata = {
  title: "Accounting AI-Powered Fraud Detection - AI-Powered Accounting Solution",
  description: "AI-powered accounting solution for finance. Real-time fraud detection for financial transactions and user behavior.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/accounting-ai-powered-fraud-detection-1b3470c4",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Accounting AI-Powered Fraud Detection - AI-Powered Accounting Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          AI-powered accounting solution for finance. Real-time fraud detection for financial transactions and user behavior.
        </p>
