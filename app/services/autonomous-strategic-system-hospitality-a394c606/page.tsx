...
export const metadata: Metadata = {
  title: 'Autonomous Strategic System - Hospitality',
  description: 'The future of hospitality is here with Autonomous Strategic System - Hospitality. Powered by cutting-edge AI, this platform delivers data governance like never ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-strategic-system-hospitality-a394c606',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Strategic System - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Autonomous Strategic System - Hospitality. Powered by cutting-edge AI, this platform delivers data governance like never before.
          </p>
