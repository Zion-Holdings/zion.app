...
export const metadata: Metadata = {
  title: 'AI/IT SMB Suite - Cybersecurity',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT SMB Suite - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of cybersecurity is here with AI/IT SMB Suite - Cybersecurity. Powered by cutting-edge AI, this platform delivers territory management like never before.
          </p>
