...
export const metadata: Metadata = {
  title: 'Enterprise Intelligence for Construction',
  description: 'Enhance your construction business with Enterprise Intelligence for Construction. Our solution provides image recognition with enterprise-grade reliability and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-intelligence-for-construction-2076f7b0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Intelligence for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Enterprise Intelligence for Construction. Our solution provides image recognition with enterprise-grade reliability and security.
          </p>
