...
export const metadata: Metadata = {
  title: 'Smart Management Platform - AITECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Management Platform - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation aitech solution: Smart Management Platform - AITECH. Combines quality prediction with adaptive intelligence for optimal results.
          </p>
