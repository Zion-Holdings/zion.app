...
export const metadata: Metadata = {
  title: 'Cognitive Management Solution - FINTECH',
  description: 'The future of fintech is here with Cognitive Management Solution - FINTECH. Powered by cutting-edge AI, this platform delivers brand sentiment like never before',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-management-solution-fintech-7abed0b8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Management Solution - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of fintech is here with Cognitive Management Solution - FINTECH. Powered by cutting-edge AI, this platform delivers brand sentiment like never before.
          </p>
