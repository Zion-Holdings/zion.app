...
export const metadata: Metadata = {
  title: 'AI/IT Monitoring Suite - Hospitality #1',
  description: 'The future of hospitality is here with AI/IT Monitoring Suite - Hospitality #1. Powered by cutting-edge AI, this platform delivers process mining like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-monitoring-suite-hospitality-1-e47f7b4e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Monitoring Suite - Hospitality #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with AI/IT Monitoring Suite - Hospitality #1. Powered by cutting-edge AI, this platform delivers process mining like never before.
          </p>
