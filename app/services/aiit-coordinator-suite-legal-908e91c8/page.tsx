...
export const metadata: Metadata = {
  title: 'AI/IT Coordinator Suite - Legal',
  description: 'Unlock unprecedented growth with AI/IT Coordinator Suite - Legal. This autonomous system provides cost tracking with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-coordinator-suite-legal-908e91c8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Coordinator Suite - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with AI/IT Coordinator Suite - Legal. This autonomous system provides cost tracking with zero manual intervention needed.
          </p>
