...
export const metadata: Metadata = {
  title: 'Smart Supply for Education',
  description: 'Drive innovation in education with Smart Supply for Education. This AI-powered platform transforms edge computing into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-supply-for-education-3ad8f78d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Supply for Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in education with Smart Supply for Education. This AI-powered platform transforms edge computing into a competitive advantage.
          </p>
