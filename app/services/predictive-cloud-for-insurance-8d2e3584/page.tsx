...
export const metadata: Metadata = {
  title: 'Predictive Cloud for Insurance',
  description: 'Enhance your insurance business with Predictive Cloud for Insurance. Our solution provides sales process optimization with enterprise-grade reliability and secu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-cloud-for-insurance-8d2e3584',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Cloud for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Predictive Cloud for Insurance. Our solution provides sales process optimization with enterprise-grade reliability and security.
          </p>
