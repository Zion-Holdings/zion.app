...
export const metadata: Metadata = {
  title: 'Autonomous Management System - Legal',
  description: 'Transform your legal operations with our Autonomous Management System - Legal. This AI-driven solution automates compliance monitoring with unprecedented accura',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Management System - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Autonomous Management System - Legal. This AI-driven solution automates compliance monitoring with unprecedented accuracy and efficiency.
          </p>
