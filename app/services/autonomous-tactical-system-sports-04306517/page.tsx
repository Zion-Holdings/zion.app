...
export const metadata: Metadata = {
  title: 'Autonomous Tactical System - Sports',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Tactical System - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your sports business with Autonomous Tactical System - Sports. Our solution provides document ai with enterprise-grade reliability and security.
          </p>
