...
export const metadata: Metadata = {
  title: 'Intelligent Advisor for Energy',
  description: 'Transform your energy operations with our Intelligent Advisor for Energy. This AI-driven solution automates data processing with unprecedented accuracy and effi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-advisor-for-energy-dcdec97d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Advisor for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Intelligent Advisor for Energy. This AI-driven solution automates data processing with unprecedented accuracy and efficiency.
          </p>
