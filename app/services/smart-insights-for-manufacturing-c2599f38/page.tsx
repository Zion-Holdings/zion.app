...
export const metadata: Metadata = {
  ...
  description: 'Transform your manufacturing operations with our Smart Insights for Manufacturing. This AI-driven solution automates network optimization with unprecedented acc',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your manufacturing operations with our Smart Insights for Manufacturing. This AI-driven solution automates network optimization with unprecedented accuracy and efficiency.
          </p>
