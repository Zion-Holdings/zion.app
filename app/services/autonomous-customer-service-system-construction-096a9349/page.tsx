...
export const metadata: Metadata = {
  title: 'Autonomous Customer Service System - Construction',
  description: 'Optimize your construction workflows with Autonomous Customer Service System - Construction. This intelligent platform delivers data processing through advanced',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Customer Service System - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Autonomous Customer Service System - Construction. This intelligent platform delivers data processing through advanced automation and AI.
          </p>
