...
export const metadata: Metadata = {
  title: 'Predictive Platform for Energy',
  description: 'The future of energy is here with Predictive Platform for Energy. Powered by cutting-edge AI, this platform delivers customer insights like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-platform-for-energy-f93e7662',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Platform for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Predictive Platform for Energy. Powered by cutting-edge AI, this platform delivers customer insights like never before.
          </p>
