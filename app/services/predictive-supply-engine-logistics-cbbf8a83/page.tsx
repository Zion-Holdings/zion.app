...
export const metadata: Metadata = {
  title: 'Predictive Supply Engine - Logistics',
  description: 'Optimize your logistics workflows with Predictive Supply Engine - Logistics. This intelligent platform delivers process automation through advanced automation a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-supply-engine-logistics-cbbf8a83',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Supply Engine - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your logistics workflows with Predictive Supply Engine - Logistics. This intelligent platform delivers process automation through advanced automation and AI.
          </p>
