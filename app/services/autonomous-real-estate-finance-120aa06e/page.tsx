...
export const metadata: Metadata = {
  title: 'Autonomous real estate-finance',
  description: 'Transform your finance operations with our Autonomous real estate-finance. This AI-driven solution automates supply chain with unprecedented accuracy and effici',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-real-estate-finance-120aa06e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous real estate-finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Autonomous real estate-finance. This AI-driven solution automates supply chain with unprecedented accuracy and efficiency.
          </p>
