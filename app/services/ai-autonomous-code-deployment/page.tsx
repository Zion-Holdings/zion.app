      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Code-review finder (comment on PR per pattern)</li>
            <li className="text-purple-300">✓ Security scan (CodeQL + Snyk + Trivy)</li>
            <li className="text-purple-300">✓ Auto-retry flaky test up to 3x</li>
            <li className="text-purple-300">✓ Feature-flag gate auto-enable on green CI</li>
            <li className="text-purple-300">✓ Rollback automatic on error-rate spike</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with autonomous code deployment agent</li>
