...
export const metadata: Metadata = {
  ...
  description: 'Automates quality control with computer vision and statistical process control.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-manufacturing-quality-control2026-07-28t035143503982000063-16266ed9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automates quality control with computer vision and statistical process control.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">SPC</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">99% quality assurance</li>
