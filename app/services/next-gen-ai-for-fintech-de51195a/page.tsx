...
export const metadata: Metadata = {
  title: 'Next-Gen AI for FINTECH',
  description: 'Revolutionize fintech through intelligent automation. Our Next-Gen AI for FINTECH leverages advanced machine learning to deliver hyperautomation at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-ai-for-fintech-de51195a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen AI for FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize fintech through intelligent automation. Our Next-Gen AI for FINTECH leverages advanced machine learning to deliver hyperautomation at scale.
          </p>
