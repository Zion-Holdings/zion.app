...
export const metadata: Metadata = {
  title: 'Predictive Intelligence Engine - Legal',
  description: 'Revolutionize legal through intelligent automation. Our Predictive Intelligence Engine - Legal leverages advanced machine learning to deliver maintenance predic',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-intelligence-engine-legal-97235d44',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Intelligence Engine - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Predictive Intelligence Engine - Legal leverages advanced machine learning to deliver maintenance prediction at scale.
          </p>
