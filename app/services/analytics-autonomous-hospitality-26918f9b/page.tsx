...
export const metadata: Metadata = {
  title: 'Analytics Autonomous - Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Analytics Autonomous - Hospitality leverages advanced machine learning to deliver enterprise-grade',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/analytics-autonomous-hospitality-26918f9b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Analytics Autonomous - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Analytics Autonomous - Hospitality leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
