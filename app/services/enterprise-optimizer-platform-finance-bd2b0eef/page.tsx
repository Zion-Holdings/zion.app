...
export const metadata: Metadata = {
  title: 'Enterprise Optimizer Platform - Finance',
  description: 'Unlock unprecedented growth with Enterprise Optimizer Platform - Finance. This autonomous system provides logistics route optimization with zero manual interven',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-optimizer-platform-finance-bd2b0eef',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Optimizer Platform - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Enterprise Optimizer Platform - Finance. This autonomous system provides logistics route optimization with zero manual intervention needed.
          </p>
