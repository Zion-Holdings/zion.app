...
export const metadata: Metadata = {
  title: 'Smart Director Platform - Insurance',
  description: 'Transform your insurance operations with our Smart Director Platform - Insurance. This AI-driven solution automates master data management with unprecedented ac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-director-platform-insurance-8f9a2234',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Director Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Smart Director Platform - Insurance. This AI-driven solution automates master data management with unprecedented accuracy and efficiency.
          </p>
