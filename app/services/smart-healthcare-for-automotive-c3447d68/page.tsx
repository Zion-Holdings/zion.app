...
export const metadata: Metadata = {
  title: 'Smart Healthcare for Automotive',
  description: 'Transform your automotive operations with our Smart Healthcare for Automotive. This AI-driven solution automates predictive analytics with unprecedented accurac',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Healthcare for Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your automotive operations with our Smart Healthcare for Automotive. This AI-driven solution automates predictive analytics with unprecedented accuracy and efficiency.
          </p>
