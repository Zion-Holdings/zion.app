...
export const metadata: Metadata = {
  title: 'Next-Gen Engine for CLEANTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Engine for CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated cleantech solution: Next-Gen Engine for CLEANTECH. Combines generative ai with next-gen AI for maximum velocity.
          </p>
