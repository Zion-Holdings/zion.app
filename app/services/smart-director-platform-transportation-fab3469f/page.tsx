...
export const metadata: Metadata = {
  title: 'Smart Director Platform - Transportation',
  description: 'Transform your transportation operations with our Smart Director Platform - Transportation. This AI-driven solution automates sales process optimization with un',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-director-platform-transportation-fab3469f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Director Platform - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your transportation operations with our Smart Director Platform - Transportation. This AI-driven solution automates sales process optimization with unprecedented accuracy and efficiency.
          </p>
