...
export const metadata: Metadata = {
  title: 'Intelligent Support for Telecom',
  description: 'Revolutionize telecom through intelligent automation. Our Intelligent Support for Telecom leverages advanced machine learning to deliver audit trail management ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-support-for-telecom-fb029b04',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Support for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Intelligent Support for Telecom leverages advanced machine learning to deliver audit trail management at scale.
          </p>
