...
export const metadata: Metadata = {
  title: 'Intelligent Startup for Education',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Startup for Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of education is here with Intelligent Startup for Education. Powered by cutting-edge AI, this platform delivers expense management like never before.
          </p>
