...
export const metadata: Metadata = {
  title: 'AI Autonomous - HEALTHTECH Edition',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Autonomous - HEALTHTECH Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthtech business with AI Autonomous - HEALTHTECH Edition. Our solution provides record processing with enterprise-grade reliability and security.
          </p>
