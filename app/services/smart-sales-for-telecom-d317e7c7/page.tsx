...
export const metadata: Metadata = {
  title: 'Smart Sales for Telecom',
  description: 'The future of telecom is here with Smart Sales for Telecom. Powered by cutting-edge AI, this platform delivers data processing like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-sales-for-telecom-d317e7c7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Sales for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of telecom is here with Smart Sales for Telecom. Powered by cutting-edge AI, this platform delivers data processing like never before.
          </p>
