...
export const metadata: Metadata = {
  title: 'Autonomous Document System - Retail',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Document System - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for retail: Autonomous Document System - Retail. Uses quantum-inspired algorithms to deliver customer intelligence at exponential speed.
          </p>
