...
export const metadata: Metadata = {
  title: 'Quantum Supply Chain Blockchain (Data)',
  description: 'Quantum Supply Chain Blockchain (Data) is an AI-powered data solution that transforms how businesses operate through intelligent automation and real-time analyt',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-supply-chain-blockchai-8f23c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Supply Chain Blockchain (Data)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum Supply Chain Blockchain (Data) is an AI-powered data solution that transforms how businesses operate through intelligent automation and real-time analytics.
