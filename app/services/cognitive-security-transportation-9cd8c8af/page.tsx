...
export const metadata: Metadata = {
  title: 'Cognitive security-transportation',
  description: 'Optimize your transportation workflows with Cognitive security-transportation. This intelligent platform delivers automation opportunity through advanced automa',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-security-transportation-9cd8c8af',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive security-transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Cognitive security-transportation. This intelligent platform delivers automation opportunity through advanced automation and AI.
          </p>
