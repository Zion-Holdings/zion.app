...
export const metadata: Metadata = {
  title: 'Smart Manager Platform - Agriculture',
  description: 'Enhance your agriculture business with Smart Manager Platform - Agriculture. Our solution provides customer retention with enterprise-grade reliability and secu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-manager-platform-agriculture-9871d567',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manager Platform - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your agriculture business with Smart Manager Platform - Agriculture. Our solution provides customer retention with enterprise-grade reliability and security.
          </p>
