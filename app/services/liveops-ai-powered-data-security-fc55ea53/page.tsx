...
export const metadata: Metadata = {
  title: 'LiveOps AI-Powered Data Security',
  description: 'AI-powered liveops solution for security. Automated data access control and encryption management.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/liveops-ai-powered-data-security-fc55ea53',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            LiveOps AI-Powered Data Security
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered liveops solution for security. Automated data access control and encryption management.
          </p>
