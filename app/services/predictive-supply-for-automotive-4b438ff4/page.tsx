...
export const metadata: Metadata = {
  ...
  description: 'Transform your automotive operations with our Predictive Supply for Automotive. This AI-driven solution automates threat detection with unprecedented accuracy a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your automotive operations with our Predictive Supply for Automotive. This AI-driven solution automates threat detection with unprecedented accuracy and efficiency.
          </p>
