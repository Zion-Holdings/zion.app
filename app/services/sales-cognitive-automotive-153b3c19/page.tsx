...
export const metadata: Metadata = {
  title: 'Sales Cognitive - Automotive',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Sales Cognitive - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of automotive is here with Sales Cognitive - Automotive. Powered by cutting-edge AI, this platform delivers performance tracking like never before.
          </p>
