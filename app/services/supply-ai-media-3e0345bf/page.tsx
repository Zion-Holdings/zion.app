...
export const metadata: Metadata = {
  title: 'Supply AI - Media',
  description: 'Drive innovation in media with Supply AI - Media. This AI-powered platform transforms pipeline management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/supply-ai-media-3e0345bf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in media with Supply AI - Media. This AI-powered platform transforms pipeline management into a competitive advantage.
          </p>
