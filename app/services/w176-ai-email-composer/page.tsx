...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'AI Email Composer & Optimizer', 'description': 'AI-powered email drafting with tone matching, audience adaptation, subject line optimization, and send-time prediction. Increase open rates by 35% and response rates by 50%.', 'serviceType': 'ai', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'Communication'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'AI Email Composer & Optimizer Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$29/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$79/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': '$249/mo', 'priceCurrency': 'USD'}]}} />
    <JsonLd data={'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'Context-aware email drafting', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Context-aware email drafting'}}, {'@type': 'Question', 'name': 'Tone matching (formal, friendly, urgent, persuasive)', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Tone matching (formal, friendly, urgent, persuasive)'}}, {'@type': 'Question', 'name': 'Subject line A/B optimization', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Subject line A/B optimization'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Draft perfect emails in seconds; Subject optimization increases opens by 35%; Send-time prediction maximizes visibility'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} />
