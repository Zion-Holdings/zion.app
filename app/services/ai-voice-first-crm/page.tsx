...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time call transcription with speaker separation across phone, Zoom, Teams, Live deal coaching: sales rep hears contextual prompts mid-call via earpiece or screen pop-up, Voice command CRM update: update stage, log notes, create task — all hands-free, Auto-contact enrichment via Clearbit, ZoomInfo, LinkedIn — contact record complete in 3 seconds, Post-call: auto-summary, action items, next-step suggestions delivered to Slack/CRM within 30 seconds, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Voice-First CRM &amp; Sales Assistant</h1>
        <p className="text-lg text-slate-300 mb-8">Voice-first CRM for field sales and inside sales teams: automatic call transcription, real-time deal coaching via live prompt injection, pipeline update via voice command, contact enrichment, and post-call auto-summary + next-step action items.</p>
        ...
        <li class="text-slate-300">Real-time call transcription with speaker separation across phone, Zoom, Teams</li>
        <li class="text-slate-300">Live deal coaching: sales rep hears contextual prompts mid-call via earpiece or screen pop-up</li>
        <li class="text-slate-300">Voice command CRM update: update stage, log notes, create task — all hands-free</li>
        <li class="text-slate-300">Auto-contact enrichment via Clearbit, ZoomInfo, LinkedIn — contact record complete in 3 seconds</li>
        <li class="text-slate-300">Post-call: auto-summary, action items, next-step suggestions delivered to Slack/CRM within 30 seconds</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with voice-first crm &amp; sales assistant</li>
