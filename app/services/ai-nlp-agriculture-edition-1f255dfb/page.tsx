...
export const metadata: Metadata = {
  title: 'AI NLP - Agriculture Edition',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI NLP - Agriculture Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in agriculture with AI NLP - Agriculture Edition. This AI-powered platform transforms revenue forecasting into a competitive advantage.
          </p>
