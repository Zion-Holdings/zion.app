...
export const metadata: Metadata = {
  ...
  keywords: 'SOC 2 certified, Zero-downtime updates, Performance dashboards, Plugin architecture, generator, media, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Director Intelligent - Media</h1>
        <p className="text-lg text-slate-300 mb-8">Next-generation media solution: Director Intelligent - Media. Combines maintenance scheduling with adaptive intelligence for optimal results.</p>
