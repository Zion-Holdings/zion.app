...
export const metadata: Metadata = {
  title: 'Predictive Platform Engine - Legal',
  description: 'Next-generation legal solution: Predictive Platform Engine - Legal. Combines budget tracking with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-platform-engine-legal-48eed6de',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Platform Engine - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Predictive Platform Engine - Legal. Combines budget tracking with adaptive intelligence for optimal results.
          </p>
