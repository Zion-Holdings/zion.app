...
export const metadata: Metadata = {
  title: 'Intelligent AI for Construction',
  description: 'Revolutionize construction through intelligent automation. Our Intelligent AI for Construction leverages advanced machine learning to deliver supply chain at sc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-ai-for-construction-b315c2ad',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent AI for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Intelligent AI for Construction leverages advanced machine learning to deliver supply chain at scale.
          </p>
