...
export const metadata: Metadata = {
  title: 'Automated automation-healthcare',
  description: 'Optimize your healthcare workflows with Automated automation-healthcare. This intelligent platform delivers ml model training through advanced automation and AI',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-automation-healthcare-639dfed3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated automation-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Automated automation-healthcare. This intelligent platform delivers ml model training through advanced automation and AI.
          </p>
