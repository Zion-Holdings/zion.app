...
export const metadata: Metadata = {
  title: 'AI Healthcare - Construction Edition #1',
  description: 'Drive innovation in construction with AI Healthcare - Construction Edition #1. This AI-powered platform transforms loyalty optimization into a competitive advan',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-healthcare-construction-edition-1-d678838f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Healthcare - Construction Edition #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with AI Healthcare - Construction Edition #1. This AI-powered platform transforms loyalty optimization into a competitive advantage.
          </p>
