...
export const metadata: Metadata = {
  title: 'Cognitive Customer Service Solution - Legal',
  description: 'Optimize your legal workflows with Cognitive Customer Service Solution - Legal. This intelligent platform delivers edge computing through advanced automation an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-customer-service-solution-legal-646908d9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Customer Service Solution - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with Cognitive Customer Service Solution - Legal. This intelligent platform delivers edge computing through advanced automation and AI.
          </p>
