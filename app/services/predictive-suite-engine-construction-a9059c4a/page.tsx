...
export const metadata: Metadata = {
  title: 'Predictive Suite Engine - Construction',
  description: 'Transform your construction operations with our Predictive Suite Engine - Construction. This AI-driven solution automates resource optimization with unprecedent',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-suite-engine-construction-a9059c4a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Suite Engine - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Predictive Suite Engine - Construction. This AI-driven solution automates resource optimization with unprecedented accuracy and efficiency.
          </p>
