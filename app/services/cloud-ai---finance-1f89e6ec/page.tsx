      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our Cloud AI - Finance leverages advanced machine learning to deliver healthcare data analytics at scale.
          </p>
