...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Operational - Agriculture',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Operational - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agriculture solution: Hyper-Accelerated Operational - Agriculture. Combines leave management with adaptive intelligence for optimal results.
          </p>
