...
export const metadata: Metadata = {
  title: 'Cognitive Customer DevOps',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Customer DevOps
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Cognitive Customer DevOps leverages advanced machine learning to deliver workflow management at scale.
          </p>
