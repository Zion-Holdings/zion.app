...
export const metadata: Metadata = {
  title: 'AI-Powered Quality for Education',
  description: 'Transform your education operations with our AI-Powered Quality for Education. This AI-driven solution provides intelligent automation with unprecedented accura',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Quality for Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your education operations with our AI-Powered Quality for Education. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
