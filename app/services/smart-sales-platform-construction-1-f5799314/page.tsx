...
export const metadata: Metadata = {
  title: 'Smart Sales Platform - Construction #1',
  description: 'Enhance your construction business with Smart Sales Platform - Construction #1. Our solution provides vendor management with enterprise-grade reliability and se',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-sales-platform-construction-1-f5799314',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Sales Platform - Construction #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Smart Sales Platform - Construction #1. Our solution provides vendor management with enterprise-grade reliability and security.
          </p>
