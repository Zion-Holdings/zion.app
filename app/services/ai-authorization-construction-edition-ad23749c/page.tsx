...
export const metadata: Metadata = {
  title: 'AI Authorization - Construction Edition',
  description: 'Next-generation construction solution: AI Authorization - Construction Edition. Combines customer insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-authorization-construction-edition-ad23749c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Authorization - Construction Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: AI Authorization - Construction Edition. Combines customer insights with adaptive intelligence for optimal results.
          </p>
