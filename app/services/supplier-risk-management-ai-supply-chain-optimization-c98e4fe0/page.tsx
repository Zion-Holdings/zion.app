...
export const metadata: Metadata = {
  ...
  description: 'supplier risk management solution for cosmetics industry. Optimizes supply chain operations using predictive analytics, demand forecasting, and route optimizati',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/supplier-risk-management-ai-supply-chain-optimization-c98e4fe0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            supplier risk management solution for cosmetics industry. Optimizes supply chain operations using predictive analytics, demand forecasting, and route optimization.
          </p>
