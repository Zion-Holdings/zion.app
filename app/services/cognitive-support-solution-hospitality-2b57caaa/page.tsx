...
export const metadata: Metadata = {
  title: 'Cognitive Support Solution - Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Cognitive Support Solution - Hospitality leverages advanced machine learning to deliver predictive',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-support-solution-hospitality-2b57caaa',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Support Solution - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Cognitive Support Solution - Hospitality leverages advanced machine learning to deliver predictive analytics at scale.
          </p>
