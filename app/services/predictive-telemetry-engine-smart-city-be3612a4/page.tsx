...
export const metadata = {
  ...
  description: "Enhance your smart-city business with Predictive Telemetry Engine - Smart-City. Our solution provides telemetry collection with enterprise-grade reliability and",
  alternates: {
