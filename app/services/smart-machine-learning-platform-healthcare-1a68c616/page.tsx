...
export const metadata: Metadata = {
  title: 'Smart Machine Learning Platform - Healthcare',
  description: 'Drive innovation in healthcare with Smart Machine Learning Platform - Healthcare. This AI-powered platform transforms customer retention into a competitive adva',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-machine-learning-platform-healthcare-1a68c616',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Machine Learning Platform - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with Smart Machine Learning Platform - Healthcare. This AI-powered platform transforms customer retention into a competitive advantage.
          </p>
