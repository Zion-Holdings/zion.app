...
export const metadata: Metadata = {
  title: 'Content AI-Powered Business Intelligence',
  description: 'AI-powered content solution for bi. Automated BI report generation and insight discovery.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/content-ai-powered-business-intelligence-b71564bc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Content AI-Powered Business Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered content solution for bi. Automated BI report generation and insight discovery.
          </p>
