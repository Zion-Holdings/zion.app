...
export const metadata: Metadata = {
  title: 'Autonomous Analyzer for Cleantech',
  description: 'Transform your cleantech operations with our Autonomous Analyzer for Cleantech. This AI-driven solution automates fraud prevention with unprecedented accuracy a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Analyzer for Cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your cleantech operations with our Autonomous Analyzer for Cleantech. This AI-driven solution automates fraud prevention with unprecedented accuracy and efficiency.
          </p>
