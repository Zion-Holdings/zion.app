...
export const metadata: Metadata = {
  title: 'Director Autonomous - Agritech',
  description: 'Next-generation agritech solution: Director Autonomous - Agritech. Combines performance monitoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/director-autonomous---agritech-56229bf5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Director Autonomous - Agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agritech solution: Director Autonomous - Agritech. Combines performance monitoring with adaptive intelligence for optimal results.
          </p>
