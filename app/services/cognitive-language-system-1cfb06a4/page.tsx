...
export const metadata: Metadata = {
  title: 'Cognitive Language System',
  description: 'Drive innovation in agriculture with Cognitive Language System. This AI-powered platform transforms form processing into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-language-system-1cfb06a4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in agriculture with Cognitive Language System. This AI-powered platform transforms form processing into a competitive advantage.
          </p>
