...
export const metadata: Metadata = {
  title: 'Autonomous Manufacturing for Hospitality',
  description: 'The future of hospitality is here with Autonomous Manufacturing for Hospitality. Powered by cutting-edge AI, this platform delivers security monitoring like nev',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-manufacturing-for-hospitality-27e8ea50',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Manufacturing for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Autonomous Manufacturing for Hospitality. Powered by cutting-edge AI, this platform delivers security monitoring like never before.
          </p>
