...
export const metadata: Metadata = {
  title: 'Smart manager-insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Smart manager-insurance leverages advanced machine learning to deliver predictive modeling at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-manager-insurance-a72767e3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart manager-insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Smart manager-insurance leverages advanced machine learning to deliver predictive modeling at scale.
          </p>
