...
export const metadata: Metadata = {
  title: 'Neural Management for Agritech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Management for Agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agritech is here with Neural Management for Agritech. Powered by cutting-edge AI, this platform delivers document processing like never before.
          </p>
