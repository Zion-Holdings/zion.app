...
export const metadata = {
  ...
  description: "Machine learning-powered forecasting system that predicts logistics trends, demands, and outcomes with high accuracy. Uses advanced algorithms to analyze histor",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Machine learning-powered forecasting system that predicts logistics trends, demands, and outcomes with high accuracy. Uses advanced algorithms to analyze historical patterns and identify opportunities.</p>
