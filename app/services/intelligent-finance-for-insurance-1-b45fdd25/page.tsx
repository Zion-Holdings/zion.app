...
export const metadata: Metadata = {
  title: 'Intelligent Finance for Insurance #1',
  description: 'Quantum leap forward for insurance: Intelligent Finance for Insurance #1. Uses quantum-inspired algorithms to deliver business process at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-finance-for-insurance-1-b45fdd25',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Finance for Insurance #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for insurance: Intelligent Finance for Insurance #1. Uses quantum-inspired algorithms to deliver business process at exponential speed.
          </p>
