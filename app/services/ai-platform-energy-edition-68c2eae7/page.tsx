...
export const metadata: Metadata = {
  title: 'AI Platform - Energy Edition',
  description: 'Revolutionize energy through intelligent automation. Our AI Platform - Energy Edition leverages advanced machine learning to deliver enterprise-grade insights a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-platform-energy-edition-68c2eae7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Platform - Energy Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our AI Platform - Energy Edition leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
