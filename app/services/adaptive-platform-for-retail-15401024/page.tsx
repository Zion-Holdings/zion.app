...
export const metadata: Metadata = {
  title: 'Adaptive Platform for Retail',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Platform for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation retail solution: Adaptive Platform for Retail. Combines fraud prevention with adaptive intelligence for optimal results.
          </p>
