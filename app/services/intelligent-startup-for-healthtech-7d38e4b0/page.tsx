...
export const metadata: Metadata = {
  title: 'Intelligent Startup for HEALTHTECH',
  description: 'Transform your healthtech operations with our Intelligent Startup for HEALTHTECH. This AI-driven solution automates net promoter score with unprecedented accura',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Startup for HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthtech operations with our Intelligent Startup for HEALTHTECH. This AI-driven solution automates net promoter score with unprecedented accuracy and efficiency.
          </p>
