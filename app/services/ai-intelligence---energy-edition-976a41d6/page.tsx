...
export const metadata: Metadata = {
  title: 'AI Intelligence - Energy Edition',
  description: 'Revolutionize energy through intelligent automation. Our AI Intelligence - Energy Edition leverages advanced machine learning to deliver healthcare data analyti',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Intelligence - Energy Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our AI Intelligence - Energy Edition leverages advanced machine learning to deliver healthcare data analytics at scale.
          </p>
