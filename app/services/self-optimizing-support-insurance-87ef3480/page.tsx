...
export const metadata: Metadata = {
  title: 'Self-Optimizing support-insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing support-insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Self-Optimizing support-insurance. Powered by cutting-edge AI, this platform delivers succession planning like never before.
          </p>
