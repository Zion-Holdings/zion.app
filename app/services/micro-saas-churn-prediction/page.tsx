...
export const metadata: Metadata = {
  ...
  keywords: 'ML churn prediction, Health score automation, Retention playbook engine, Integration with Stripe, HubSpot, Intercom, Cohort analysis, Revenue impact forecasting, Automated outreach triggers, Executive churn dashboards, micro-saas, SaaS, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">ChurnGuard — Churn Prediction &amp; Prevention</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered churn prediction for SaaS. Identify at-risk accounts, automate retention playbooks, and track health scores in real-time.</p>
        ...
        <li class="text-slate-300">ML churn prediction</li>
        <li class="text-slate-300">Health score automation</li>
        <li class="text-slate-300">Retention playbook engine</li>
        <li class="text-slate-300">Integration with Stripe, HubSpot, Intercom</li>
        <li class="text-slate-300">Cohort analysis</li>
        <li class="text-slate-300">Revenue impact forecasting</li>
        <li class="text-slate-300">Automated outreach triggers</li>
        <li class="text-slate-300">Executive churn dashboards</li>
      </ul>
        </div>
        ...
        <li class="text-slate-300">Prioritize at-risk accounts</li>
        <li class="text-slate-300">Increase LTV</li>
      </ul>
        </div>
