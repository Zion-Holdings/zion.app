...
export const metadata: Metadata = {
  title: 'Autonomous intelligent-legal',
  description: 'Revolutionize legal through intelligent automation. Our Autonomous intelligent-legal leverages advanced machine learning to deliver sales forecasting at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-intelligent-legal-f3d8cdf1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous intelligent-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Autonomous intelligent-legal leverages advanced machine learning to deliver sales forecasting at scale.
          </p>
