...
export const metadata = {
  title: "Intelligent Logistics Patient Engagement - Zion Tech Group",
  description: "AI-driven patient engagement platform that delivers proactive personalized care journeys, remote monitoring, and adherence support through intelligent automation.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/intelligent-logistics-patient-engagement-9584b043`
  }
};
...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'Intelligent Logistics Patient Engagement', 'description': 'AI-driven patient engagement platform that delivers proactive personalized care journeys, remote monitoring, and adherence support through intelligent automation.', 'serviceType': 'customer experience', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'hello@ziontechgroup.com', 'telephone': '+1 (302) 464-0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'healthcare'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'Intelligent Logistics Patient Engagement Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '258', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '648', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': '1948', 'priceCurrency': 'USD'}]}} />
    <JsonLd data={'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'Personalized care plans', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Personalized care plans'}}, {'@type': 'Question', 'name': 'Remote monitoring', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Remote monitoring'}}, {'@type': 'Question', 'name': 'Medication adherence', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Medication adherence'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Better outcomes; Higher satisfaction; Reduced readmissions'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} />
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path={`/services/intelligent-logistics-patient-engagement-9584b043`} title="Intelligent Logistics Patient Engagement" />
        <h1 className="text-4xl font-bold mb-6">💡 Intelligent Logistics Patient Engagement</h1>
