...
export const metadata: Metadata = {
  ...
  description: 'Auto-generates BI reports and insights from raw data with natural language queries.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-business-intelligence-5436fbbd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Auto-generates BI reports and insights from raw data with natural language queries.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">NL querying</li>
          </ul>
        </section>
