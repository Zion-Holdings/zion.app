...
export const metadata: Metadata = {
  title: 'AI/IT Suite Suite - Real-Estate',
  description: 'Quantum leap forward for real-estate: AI/IT Suite Suite - Real-Estate. Uses quantum-inspired algorithms to deliver decision support at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-suite-suite-real-estate-b8cf6465',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Suite Suite - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for real-estate: AI/IT Suite Suite - Real-Estate. Uses quantum-inspired algorithms to deliver decision support at exponential speed.
          </p>
