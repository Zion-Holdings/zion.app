...
export const metadata: Metadata = {
  title: 'WMS AI-Powered Customer Churn Prevention',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            WMS AI-Powered Customer Churn Prevention
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered wms solution for saas. Identifies at-risk customers and triggers retention workflows automatically.
          </p>
