...
export const metadata: Metadata = {
  title: 'Intelligent Automation AI-Powered Network Security',
  description: 'AI-powered intelligent automation solution for network security. AI-driven network security with threat detection and response.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-automation-ai-powered-network-security-5a5b2e1f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Automation AI-Powered Network Security
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered intelligent automation solution for network security. AI-driven network security with threat detection and response.
          </p>
