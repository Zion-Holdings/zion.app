...
export const metadata: Metadata = {
  title: 'Smart Smart Platform - EDTECH',
  description: 'Next-generation edtech solution: Smart Smart Platform - EDTECH. Combines data governance with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-smart-platform-edtech-19e2cde8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Smart Platform - EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation edtech solution: Smart Smart Platform - EDTECH. Combines data governance with adaptive intelligence for optimal results.
          </p>
