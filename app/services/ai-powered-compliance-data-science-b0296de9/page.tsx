...
export const metadata: Metadata = {
  title: 'AI-Powered Compliance Data Science',
  description: 'Drive innovation in energy with AI-Powered Compliance Data Science. This AI-powered platform transforms quality control into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-compliance-data-science-b0296de9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Compliance Data Science
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with AI-Powered Compliance Data Science. This AI-powered platform transforms quality control into a competitive advantage.
          </p>
