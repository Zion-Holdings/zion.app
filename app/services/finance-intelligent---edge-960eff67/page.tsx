...
export const metadata: Metadata = {
  title: 'Finance Intelligent - Edge',
  description: 'Transform your edge operations with our Finance Intelligent - Edge. This AI-driven solution automates energy management with unprecedented accuracy and efficien',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/finance-intelligent---edge-960eff67',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Finance Intelligent - Edge
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your edge operations with our Finance Intelligent - Edge. This AI-driven solution automates energy management with unprecedented accuracy and efficiency.
          </p>
