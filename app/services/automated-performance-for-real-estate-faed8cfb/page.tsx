  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Automated Performance for Real-Estate</h1>
        <p className="text-lg text-gray-300 mb-8">Next-generation real-estate solution: Automated Performance for Real-Estate. Combines customer service automation with adaptive intelligence for optimal results.</p>
