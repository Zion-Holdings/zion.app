...
export const metadata: Metadata = {
  title: 'Cloud Neural - Healthcare',
  description: 'Next-generation healthcare solution: Cloud Neural - Healthcare. Combines user experience with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cloud-neural---healthcare-0b1090f0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cloud Neural - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Cloud Neural - Healthcare. Combines user experience with adaptive intelligence for optimal results.
          </p>
