...
export const metadata: Metadata = {
  title: 'Expense Predictive - Ecommerce',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Expense Predictive - Ecommerce
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your ecommerce workflows with Expense Predictive - Ecommerce. This intelligent platform delivers account planning through advanced automation and AI.
          </p>
