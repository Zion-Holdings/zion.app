...
export const metadata: Metadata = {
  title: 'Quality Intelligent - Healthcare',
  description: 'Optimize your healthcare workflows with Quality Intelligent - Healthcare. This intelligent platform delivers disaster recovery through advanced automation and A',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quality-intelligent-healthcare-5f622a0c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quality Intelligent - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Quality Intelligent - Healthcare. This intelligent platform delivers disaster recovery through advanced automation and AI.
          </p>
