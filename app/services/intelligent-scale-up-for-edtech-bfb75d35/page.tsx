...
export const metadata: Metadata = {
  title: 'Intelligent Scale-up for EDTECH',
  description: 'Enhance your edtech business with Intelligent Scale-up for EDTECH. Our solution provides root cause analysis with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-scale-up-for-edtech-bfb75d35',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Scale-up for EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your edtech business with Intelligent Scale-up for EDTECH. Our solution provides root cause analysis with enterprise-grade reliability and security.
          </p>
