...
export const metadata: Metadata = {
  title: 'Cognitive Intelligence for Hospitality',
  description: 'Optimize your hospitality workflows with Cognitive Intelligence for Hospitality. This intelligent platform delivers fraud prevention through advanced automation',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-intelligence-for-hospitality-97b0f6ad',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Intelligence for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Cognitive Intelligence for Hospitality. This intelligent platform delivers fraud prevention through advanced automation and AI.
          </p>
