...
export const metadata: Metadata = {
  title: 'Smart Support for Manufacturing',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Support for Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your manufacturing operations with our Smart Support for Manufacturing. This AI-driven solution automates performance monitoring with unprecedented accuracy and efficiency.
          </p>
