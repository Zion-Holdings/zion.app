...
export const metadata: Metadata = {
  title: 'Real Estate AI - Iot',
  description: 'The future of iot is here with Real Estate AI - Iot. Powered by cutting-edge AI, this platform delivers content generation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/real-estate-ai---iot-12b21360',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of iot is here with Real Estate AI - Iot. Powered by cutting-edge AI, this platform delivers content generation like never before.
          </p>
