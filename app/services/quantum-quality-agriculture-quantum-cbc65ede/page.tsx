...
export const metadata: Metadata = {
  title: 'Quantum Quality - Agriculture Quantum',
  description: 'Enhance your agriculture business with Quantum Quality - Agriculture Quantum. Our solution provides warehouse automation with enterprise-grade reliability and s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Quality - Agriculture Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your agriculture business with Quantum Quality - Agriculture Quantum. Our solution provides warehouse automation with enterprise-grade reliability and security.
          </p>
