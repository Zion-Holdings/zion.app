  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Predictive Real Estate Engine - Healthcare</h1>
        <p className="text-lg text-gray-300 mb-8">Enhance your healthcare business with Predictive Real Estate Engine - Healthcare. Our solution provides project portfolio with enterprise-grade reliability and security.</p>
