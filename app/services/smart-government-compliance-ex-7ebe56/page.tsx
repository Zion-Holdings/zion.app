...
export const metadata: Metadata = {
  title: 'Smart Government Compliance Express (Data)',
  description: 'Smart Government Compliance Express (Data) is an AI-powered data solution that transforms how businesses operate through intelligent automation and real-time an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Government Compliance Express (Data)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Smart Government Compliance Express (Data) is an AI-powered data solution that transforms how businesses operate through intelligent automation and real-time analytics.
