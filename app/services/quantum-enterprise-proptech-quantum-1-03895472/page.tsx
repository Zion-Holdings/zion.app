...
export const metadata: Metadata = {
  title: 'Quantum Enterprise - PROPTECH Quantum #1',
  description: 'Next-generation proptech solution: Quantum Enterprise - PROPTECH Quantum #1. Combines logistics route optimization with adaptive intelligence for optimal result',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-enterprise-proptech-quantum-1-03895472',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Enterprise - PROPTECH Quantum #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation proptech solution: Quantum Enterprise - PROPTECH Quantum #1. Combines logistics route optimization with adaptive intelligence for optimal results.
          </p>
