...
export const metadata: Metadata = {
  title: 'Vendor Intelligent - Tech',
  description: 'Enhance your technology business with Vendor Intelligent - Tech. Our solution provides content moderation with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/vendor-intelligent-tech-5dd054ba',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Vendor Intelligent - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your technology business with Vendor Intelligent - Tech. Our solution provides content moderation with enterprise-grade reliability and security.
          </p>
