...
export const metadata: Metadata = {
  title: 'Automated engine-healthcare',
  description: 'Next-generation healthcare solution: Automated engine-healthcare. Combines financial planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-engine-healthcare-59817139',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated engine-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Automated engine-healthcare. Combines financial planning with adaptive intelligence for optimal results.
          </p>
