...
export const metadata: Metadata = {
  title: 'Predictive Security Optimization',
  description: 'Revolutionize real-estate through intelligent automation. Our Predictive Security Optimization leverages advanced machine learning to deliver maintenance schedu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our Predictive Security Optimization leverages advanced machine learning to deliver maintenance scheduling at scale.
          </p>
