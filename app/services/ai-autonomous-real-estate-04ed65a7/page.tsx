...
export const metadata: Metadata = {
  title: 'AI Autonomous - Real-Estate',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Autonomous - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in real-estate with AI Autonomous - Real-Estate. This AI-powered platform transforms resource allocation into a competitive advantage.
          </p>
