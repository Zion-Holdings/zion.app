...
export const metadata: Metadata = {
  title: "AI-Powered AI-Powered Market Intelligence - AI-Powered Pharmaceuticals Solution",
  description: "ai-powered solution for pharmaceuticals industry. Monitors market trends, competitor activities, and industry news to provide actionable insights.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-ai-powered-market-intelligence-235ef66d",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered AI-Powered Market Intelligence - AI-Powered Pharmaceuticals Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          ai-powered solution for pharmaceuticals industry. Monitors market trends, competitor activities, and industry news to provide actionable insights.
        </p>
