...
export const metadata: Metadata = {
  title: 'Intelligent Computer Vision for Transportation',
  description: 'Optimize your transportation workflows with Intelligent Computer Vision for Transportation. This intelligent platform delivers serverless orchestration through ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-computer-vision-for-transportation-9b12fa57',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Computer Vision for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Intelligent Computer Vision for Transportation. This intelligent platform delivers serverless orchestration through advanced automation and AI.
          </p>
