...
export const metadata: Metadata = {
  title: 'Intelligent Sales for Transportation',
  description: 'The future of transportation is here with Intelligent Sales for Transportation. Powered by cutting-edge AI, this platform delivers manufacturing quality control',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-sales-for-transportation-45d98b43',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Sales for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Intelligent Sales for Transportation. Powered by cutting-edge AI, this platform delivers manufacturing quality control like never before.
          </p>
