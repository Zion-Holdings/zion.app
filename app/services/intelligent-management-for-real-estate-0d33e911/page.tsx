...
export const metadata: Metadata = {
  title: 'Intelligent Management for Real-Estate',
  description: 'The future of real-estate is here with Intelligent Management for Real-Estate. Powered by cutting-edge AI, this platform delivers market intelligence like never',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-management-for-real-estate-0d33e911',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Management for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of real-estate is here with Intelligent Management for Real-Estate. Powered by cutting-edge AI, this platform delivers market intelligence like never before.
          </p>
