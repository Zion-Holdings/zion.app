...
export const metadata: Metadata = {
  title: 'Security Automated - Hospitality',
  description: 'Next-generation hospitality solution: Security Automated - Hospitality. Combines financial risk management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-automated---hospitality-1f28ca99',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Automated - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Security Automated - Hospitality. Combines financial risk management with adaptive intelligence for optimal results.
          </p>
