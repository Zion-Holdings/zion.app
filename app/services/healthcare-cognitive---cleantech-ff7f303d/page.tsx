...
export const metadata: Metadata = {
  title: 'Healthcare Cognitive - Cleantech',
  description: 'The future of cleantech is here with Healthcare Cognitive - Cleantech. Powered by cutting-edge AI, this platform delivers data processing like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/healthcare-cognitive---cleantech-ff7f303d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Healthcare Cognitive - Cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of cleantech is here with Healthcare Cognitive - Cleantech. Powered by cutting-edge AI, this platform delivers data processing like never before.
          </p>
