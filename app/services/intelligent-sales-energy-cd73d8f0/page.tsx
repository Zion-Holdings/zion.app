...
export const metadata: Metadata = {
  title: 'Intelligent sales-energy',
  description: 'Enhance your energy business with Intelligent sales-energy. Our solution provides master data management with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-sales-energy-cd73d8f0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent sales-energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your energy business with Intelligent sales-energy. Our solution provides master data management with enterprise-grade reliability and security.
          </p>
