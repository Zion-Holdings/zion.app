...
export const metadata: Metadata = {
  title: 'AI/IT Analytics for Healthcare',
  description: 'Unlock unprecedented growth with AI/IT Analytics for Healthcare. This autonomous system provides performance tuning with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-analytics-for-healthcare-c6fc6141',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Analytics for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with AI/IT Analytics for Healthcare. This autonomous system provides performance tuning with zero manual intervention needed.
          </p>
