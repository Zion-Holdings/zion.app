...
export const metadata: Metadata = {
  title: 'Smart Automation Platform - Transportation #2',
  description: 'Next-generation transportation solution: Smart Automation Platform - Transportation #2. Combines maintenance scheduling with adaptive intelligence for optimal r',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Automation Platform - Transportation #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation transportation solution: Smart Automation Platform - Transportation #2. Combines maintenance scheduling with adaptive intelligence for optimal results.
          </p>
