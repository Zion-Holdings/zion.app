...
export const metadata: Metadata = {
  title: "AI-Powered CDN Optimization - AI-Powered Infrastructure Solution",
  description: "Content delivery network optimization using predictive caching and routing.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-cdn-optimization-6d1881ca",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered CDN Optimization - AI-Powered Infrastructure Solution
        </h1>
