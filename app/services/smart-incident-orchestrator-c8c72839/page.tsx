...
export const metadata: Metadata = {
  title: 'Smart Incident Orchestrator',
  description: 'Enhance your technology business with Smart Incident Orchestrator. Our solution provides employee engagement with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-incident-orchestrator-c8c72839',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Incident Orchestrator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your technology business with Smart Incident Orchestrator. Our solution provides employee engagement with enterprise-grade reliability and security.
          </p>
