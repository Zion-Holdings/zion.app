...
export const metadata: Metadata = {
  title: 'Analyzer Intelligent - Media',
  description: 'Next-generation media solution: Analyzer Intelligent - Media. Combines document processing with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/analyzer-intelligent-media-ef99d465',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Analyzer Intelligent - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation media solution: Analyzer Intelligent - Media. Combines document processing with adaptive intelligence for optimal results.
          </p>
