...
export const metadata: Metadata = {
  title: 'Smart data science-agriculture',
  description: 'Transform your agriculture operations with our Smart data science-agriculture. This AI-driven solution provides intelligent automation with unprecedented accura',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-data-science-agriculture-e2b54664',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart data science-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Smart data science-agriculture. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
