...
export const metadata: Metadata = {
  title: 'Next-Gen Operational for Insurance',
  description: 'Drive innovation in insurance with Next-Gen Operational for Insurance. This AI-powered platform transforms record processing into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-operational-for-insurance-34c090aa',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Operational for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Next-Gen Operational for Insurance. This AI-powered platform transforms record processing into a competitive advantage.
          </p>
