...
export const metadata: Metadata = {
  title: 'AI/IT Cloud Suite - ALTHEALTH',
  description: 'Quantum leap forward for althealth: AI/IT Cloud Suite - ALTHEALTH. Uses quantum-inspired algorithms to deliver influencer identification at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-cloud-suite-althealth-52e29b7e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Cloud Suite - ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for althealth: AI/IT Cloud Suite - ALTHEALTH. Uses quantum-inspired algorithms to deliver influencer identification at exponential speed.
          </p>
