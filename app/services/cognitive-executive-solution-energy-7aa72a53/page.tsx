...
export const metadata: Metadata = {
  title: 'Cognitive Executive Solution - Energy',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Executive Solution - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Cognitive Executive Solution - Energy. Combines integration platform with adaptive intelligence for optimal results.
          </p>
