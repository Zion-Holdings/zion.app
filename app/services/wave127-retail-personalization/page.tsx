...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time product recommendations (contextual bandits), Dynamic pricing & promo optimization, Demand forecasting & inventory balancing, Omnichannel session stitching (web, app, in-store), Customer segmentation & cohort analytics, A/B testing & experimentation framework, Shopify, Magento, Commerce Tools integration, Privacy-first design (no PII leaves your infra), ai, Retail Tech, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Omnichannel personalization engine powering real-time product recommendations, dynamic pricing, and demand-driven inventory optimization. Contextual bandits adapt to shopper behavior in-session, lifting conversion 15-30% and reducing overstock by 20%.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">ai</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">Retail Tech</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Real-time product recommendations (contextual bandits)</li>
        <li class="text-slate-300">Dynamic pricing &amp; promo optimization</li>
        <li class="text-slate-300">Demand forecasting &amp; inventory balancing</li>
        <li class="text-slate-300">Omnichannel session stitching (web, app, in-store)</li>
        <li class="text-slate-300">Customer segmentation &amp; cohort analytics</li>
        <li class="text-slate-300">A/B testing &amp; experimentation framework</li>
        <li class="text-slate-300">Shopify, Magento, Commerce Tools integration</li>
        <li class="text-slate-300">Privacy-first design (no PII leaves your infra)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">15-30% uplift in conversion rates</li>
        <li class="text-slate-300">20% reduction in overstock &amp; markdowns</li>
        <li class="text-slate-300">Unified experience across every channel</li>
        <li class="text-slate-300">GDPR/CCPA compliant personalization</li>
      </ul>
        </div>
