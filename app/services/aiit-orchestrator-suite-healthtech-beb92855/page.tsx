...
export const metadata: Metadata = {
  title: 'AI/IT Orchestrator Suite - HEALTHTECH',
  description: 'The future of healthtech is here with AI/IT Orchestrator Suite - HEALTHTECH. Powered by cutting-edge AI, this platform delivers form processing like never befor',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Orchestrator Suite - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthtech is here with AI/IT Orchestrator Suite - HEALTHTECH. Powered by cutting-edge AI, this platform delivers form processing like never before.
          </p>
