...
export const metadata: Metadata = {
  ...
  keywords: 'Drag-drop quote builder, E-signature and approval workflows, Template library with pricing rules, CRM sync (Salesforce, HubSpot), Analytics on quote views and conversions, Multi-currency and multi-language, Integration with PandaDoc, DocuSign, micro-saas, Sales, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">QuoteGen — Quote Builder</h1>
        <p className="text-lg text-slate-300 mb-8">Create quotes and proposals: templates, e-signature, approval workflows, CRM sync. Close deals 3x faster.</p>
        ...
        <li class="text-slate-300">Drag-drop quote builder</li>
        <li class="text-slate-300">E-signature and approval workflows</li>
        <li class="text-slate-300">Template library with pricing rules</li>
        <li class="text-slate-300">CRM sync (Salesforce</li>
        <li class="text-slate-300">HubSpot)</li>
        <li class="text-slate-300">Analytics on quote views and conversions</li>
        <li class="text-slate-300">Multi-currency and multi-language</li>
        <li class="text-slate-300">Integration with PandaDoc</li>
        <li class="text-slate-300">DocuSign</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Close deals 3x faster</li>
        <li class="text-slate-300">E-signatures eliminate printing and scanning</li>
        <li class="text-slate-300">Pricing rules prevent discount abuse</li>
        <li class="text-slate-300">Analytics reveal what content converts</li>
      </ul>
        </div>
