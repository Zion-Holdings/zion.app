...
export const metadata: Metadata = {
  title: 'Intelligent Manager for Logistics',
  description: 'Drive innovation in logistics with Intelligent Manager for Logistics. This AI-powered platform transforms net promoter score into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-manager-for-logistics-377ae965',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Manager for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with Intelligent Manager for Logistics. This AI-powered platform transforms net promoter score into a competitive advantage.
          </p>
