...
export const metadata: Metadata = {
  ...
  keywords: 'Document-to-slide conversion from any file, Smart data visualization — auto charts, graphs, AI-generated speaker notes and timing cues, Brand-consistent — apply company guidelines, Multi-format export — PowerPoint, Google Slides, PDF, Real-time collaboration with team editing, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Presentation &amp; Pitch Deck Maker</h1>
        <p className="text-lg text-slate-300 mb-8">Generate polished presentations, pitch decks, and reports from outlines with data visualization, templates, and speaker notes.</p>
        ...
        <li class="text-slate-300">Document-to-slide conversion from any file</li>
        <li class="text-slate-300">Smart data visualization — auto charts, graphs</li>
        <li class="text-slate-300">AI-generated speaker notes and timing cues</li>
        <li class="text-slate-300">Brand-consistent — apply company guidelines</li>
        <li class="text-slate-300">Multi-format export — PowerPoint, Google Slides, PDF</li>
        <li class="text-slate-300">Real-time collaboration with team editing</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai presentation &amp; pitch deck maker</li>
