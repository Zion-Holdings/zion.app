...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'Kubernetes GitOps Platform', 'description': 'GitOps-driven Kubernetes operations: declarative manifests stored in Git, automated drift detection and reconciliation, environment promotion workflows, progressive delivery (canary/blue-green), and built-in secrets management with external vault sync.', 'serviceType': 'cloud', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'commercial@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'Sustainability'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'Kubernetes GitOps Platform Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$299/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$899/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': '$2,999/mo', 'priceCurrency': 'USD'}]}} />
    <JsonLd data={'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'Declarative manifests in Git — single source of truth for every cluster', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Declarative manifests in Git — single source of truth for every cluster'}}, {'@type': 'Question', 'name': 'Drift detection + auto-reconciliation every 60 seconds', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Drift detection + auto-reconciliation every 60 seconds'}}, {'@type': 'Question', 'name': 'Environment promotion: dev → staging → prod with approval gates', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Environment promotion: dev → staging → prod with approval gates'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Reduce costs with kubernetes gitops platform; Improve operational efficiency; Scale without complexity'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} />
