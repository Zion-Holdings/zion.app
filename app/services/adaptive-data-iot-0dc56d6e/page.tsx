...
export const metadata: Metadata = {
  title: 'Adaptive data-iot',
  description: 'The future of iot is here with Adaptive data-iot. Powered by cutting-edge AI, this platform delivers healthcare data analytics like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-data-iot-0dc56d6e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of iot is here with Adaptive data-iot. Powered by cutting-edge AI, this platform delivers healthcare data analytics like never before.
          </p>
