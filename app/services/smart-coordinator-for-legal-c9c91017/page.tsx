...
export const metadata: Metadata = {
  title: 'Smart Coordinator for Legal',
  description: 'Next-generation legal solution: Smart Coordinator for Legal. Combines customer service automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-coordinator-for-legal-c9c91017',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Coordinator for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Smart Coordinator for Legal. Combines customer service automation with adaptive intelligence for optimal results.
          </p>
