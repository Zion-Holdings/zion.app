...
export const metadata: Metadata = {
  title: 'Adaptive Computer Vision for Construction',
  description: 'Drive innovation in construction with Adaptive Computer Vision for Construction. This AI-powered platform transforms release management into a competitive advan',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-computer-vision-for-construction-d331d174',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Computer Vision for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Adaptive Computer Vision for Construction. This AI-powered platform transforms release management into a competitive advantage.
          </p>
