...
export const metadata: Metadata = {
  title: 'Smart Computer Vision for Finance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Computer Vision for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for finance: Smart Computer Vision for Finance. Uses quantum-inspired algorithms to deliver ml model training at exponential speed.
          </p>
