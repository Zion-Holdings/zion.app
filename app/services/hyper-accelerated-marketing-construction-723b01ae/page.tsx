...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated marketing-construction',
  description: 'Drive innovation in construction with Hyper-Accelerated marketing-construction. This AI-powered platform transforms insurance automation into a competitive adva',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/hyper-accelerated-marketing-construction-723b01ae',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated marketing-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Hyper-Accelerated marketing-construction. This AI-powered platform transforms insurance automation into a competitive advantage.
          </p>
