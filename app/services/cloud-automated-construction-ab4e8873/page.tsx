...
export const metadata: Metadata = {
  title: 'Cloud Automated - Construction',
  description: 'Optimize your construction workflows with Cloud Automated - Construction. This intelligent platform delivers invoice automation through advanced automation and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cloud-automated-construction-ab4e8873',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cloud Automated - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Cloud Automated - Construction. This intelligent platform delivers invoice automation through advanced automation and AI.
          </p>
