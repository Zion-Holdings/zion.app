...
export const metadata: Metadata = {
  ...
  keywords: 'Offline store (Snowflake/BigQuery/Parquet), Online store (Redis low-latency <50ms), Point-in-time correctness per feature, Feature lineage + SDK (Python/Java), data, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Feature Store Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Centralised ML feature store with online (Redis) + offline (Snowflake/BigQuery) stores, point-in-time correctness, feature lineage, SDK.</p>
        ...
        <li class="text-slate-300">Offline store (Snowflake/BigQuery/Parquet)</li>
        <li class="text-slate-300">Online store (Redis low-latency &lt;50ms)</li>
        <li class="text-slate-300">Point-in-time correctness per feature</li>
        <li class="text-slate-300">Feature lineage + SDK (Python/Java)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with feature store platform</li>
