...
export const metadata: Metadata = {
  title: 'Cognitive Security for Transportation',
  description: 'Revolutionize transportation through intelligent automation. Our Cognitive Security for Transportation leverages advanced machine learning to deliver predictive',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-security-for-transportation-5acf4c2d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Security for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize transportation through intelligent automation. Our Cognitive Security for Transportation leverages advanced machine learning to deliver predictive analytics at scale.
          </p>
