...
export const metadata: Metadata = {
  title: 'Next-Gen Advisor for Agriculture',
  description: 'Drive innovation in agriculture with Next-Gen Advisor for Agriculture. This AI-powered platform transforms receipt processing into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-advisor-for-agriculture-2441c2e9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Advisor for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in agriculture with Next-Gen Advisor for Agriculture. This AI-powered platform transforms receipt processing into a competitive advantage.
          </p>
