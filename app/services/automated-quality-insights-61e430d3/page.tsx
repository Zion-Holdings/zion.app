...
export const metadata: Metadata = {
  title: 'Automated Quality Insights',
  description: 'The future of transportation is here with Automated Quality Insights. Powered by cutting-edge AI, this platform delivers transformative results like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-quality-insights-61e430d3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Automated Quality Insights. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
