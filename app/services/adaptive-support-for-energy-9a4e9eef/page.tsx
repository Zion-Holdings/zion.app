...
export const metadata: Metadata = {
  title: 'Adaptive Support for Energy',
  description: 'Drive innovation in energy with Adaptive Support for Energy. This AI-powered platform transforms security monitoring into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-support-for-energy-9a4e9eef',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Support for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Adaptive Support for Energy. This AI-powered platform transforms security monitoring into a competitive advantage.
          </p>
