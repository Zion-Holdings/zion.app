...
export const metadata: Metadata = {
  title: 'Adaptive Director for Energy',
  description: 'The future of energy is here with Adaptive Director for Energy. Powered by cutting-edge AI, this platform delivers document processing like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-director-for-energy-b7f6c4e2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Director for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Adaptive Director for Energy. Powered by cutting-edge AI, this platform delivers document processing like never before.
          </p>
