...
export const metadata: Metadata = {
  title: 'Intelligence Autonomous - Sports',
  description: 'The future of sports is here with Intelligence Autonomous - Sports. Powered by cutting-edge AI, this platform delivers release management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligence-autonomous-sports-31d7c453',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligence Autonomous - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Intelligence Autonomous - Sports. Powered by cutting-edge AI, this platform delivers release management like never before.
          </p>
