...
export const metadata: Metadata = {
  title: 'Cognitive Real Estate for Construction #1',
  description: 'Future-proof your construction with Cognitive Real Estate for Construction #1. Our autonomous solution handles manufacturing quality control end-to-end without ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Real Estate for Construction #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your construction with Cognitive Real Estate for Construction #1. Our autonomous solution handles manufacturing quality control end-to-end without human intervention.
          </p>
