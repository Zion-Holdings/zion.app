...
export const metadata: Metadata = {
  title: 'Smart security-insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart security-insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Smart security-insurance. Powered by cutting-edge AI, this platform delivers sourcing optimization like never before.
          </p>
