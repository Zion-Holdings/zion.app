...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-source EHR + wearable data fusion, Early-deterioration signal detection, Personalised care plan generation, Hospitalisation risk prediction, Care-team dashboards + alerts, ai, Healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Chronic Disease Progression Tracker</h1>
        <p className="text-lg text-slate-300 mb-8">Longitudinal patient analytics: track chronic disease progression across EHR data, lab results, and wearables. AI identifies early deterioration signals, predicts hospitalisation risk, and generates personalised care plans.</p>
        ...
        <li class="text-slate-300">Multi-source EHR + wearable data fusion</li>
        <li class="text-slate-300">Early-deterioration signal detection</li>
        <li class="text-slate-300">Personalised care plan generation</li>
        <li class="text-slate-300">Hospitalisation risk prediction</li>
        <li class="text-slate-300">Care-team dashboards + alerts</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai chronic disease progression tracker</li>
