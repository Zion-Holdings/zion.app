...
export const metadata: Metadata = {
  ...
  keywords: 'Edge computing support, Audit trails, Machine learning integration, Data encryption, Offline capabilities, analyzer, finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Smart platform-finance</h1>
        <p className="text-lg text-slate-300 mb-8">Revolutionize finance through intelligent automation. Our Smart platform-finance leverages advanced machine learning to deliver threat detection at scale.</p>
