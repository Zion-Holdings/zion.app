...
export const metadata: Metadata = {
  title: 'Cognitive DevOps Solution - HEALTHTECH',
  description: 'Optimize your healthtech workflows with Cognitive DevOps Solution - HEALTHTECH. This intelligent platform delivers document processing through advanced automati',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive DevOps Solution - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthtech workflows with Cognitive DevOps Solution - HEALTHTECH. This intelligent platform delivers document processing through advanced automation and AI.
          </p>
