...
export const metadata: Metadata = {
  title: 'Intelligent DevOps Pipeline IoT (Security)',
  description: 'Intelligent DevOps Pipeline IoT (Security) is an AI-powered security solution that transforms how businesses operate through intelligent automation and real-tim',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-devops-pipeline-io-951b9a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent DevOps Pipeline IoT (Security)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Intelligent DevOps Pipeline IoT (Security) is an AI-powered security solution that transforms how businesses operate through intelligent automation and real-time analytics.
...
Edge Computing, Natural Language Processing, Kafka, Redis, Microservices, Serverless
