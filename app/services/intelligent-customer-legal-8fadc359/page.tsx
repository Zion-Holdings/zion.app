...
export const metadata: Metadata = {
  title: 'Intelligent customer-legal',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent customer-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with Intelligent customer-legal. This intelligent platform delivers low-code automation through advanced automation and AI.
          </p>
