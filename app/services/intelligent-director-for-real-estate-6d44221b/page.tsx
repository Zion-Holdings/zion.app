...
export const metadata: Metadata = {
  title: 'Intelligent Director for Real-Estate',
  description: 'Transform your real-estate operations with our Intelligent Director for Real-Estate. This AI-driven solution automates content moderation with unprecedented acc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-director-for-real-estate-6d44221b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Director for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Intelligent Director for Real-Estate. This AI-driven solution automates content moderation with unprecedented accuracy and efficiency.
          </p>
