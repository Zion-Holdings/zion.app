...
export const metadata: Metadata = {
  title: 'Predictive Generator Engine - Insurance',
  description: 'Drive innovation in insurance with Predictive Generator Engine - Insurance. This AI-powered platform transforms decision support into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-generator-engine-insurance-7aee73d2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Generator Engine - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Predictive Generator Engine - Insurance. This AI-powered platform transforms decision support into a competitive advantage.
          </p>
