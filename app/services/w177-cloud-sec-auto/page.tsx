...
export const metadata: Metadata = {
  ...
  keywords: 'Infrastructure-as-code scanning (Checkov, tfsec), Runtime security monitoring, Compliance automation (CIS, SOC2, PCI), Incident response automation, Remediation as code, Integration with Wiz, Orca, Prisma Cloud, cloud, Cloud Security, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cloud Security Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Automate cloud security: infrastructure scanning, compliance checks, incident response, remediation. Shift-left security.</p>
        ...
        <li class="text-slate-300">Infrastructure-as-code scanning (Checkov</li>
        <li class="text-slate-300">tfsec)</li>
        <li class="text-slate-300">Runtime security monitoring</li>
        <li class="text-slate-300">Compliance automation (CIS</li>
        <li class="text-slate-300">SOC2</li>
        <li class="text-slate-300">PCI)</li>
        <li class="text-slate-300">Incident response automation</li>
        <li class="text-slate-300">Remediation as code</li>
        <li class="text-slate-300">Integration with Wiz</li>
        <li class="text-slate-300">Orca</li>
        <li class="text-slate-300">Prisma Cloud</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Shift-left security catches issues in code</li>
        <li class="text-slate-300">Runtime monitoring detects active threats</li>
        <li class="text-slate-300">Compliance automation reduces audit burden</li>
        <li class="text-slate-300">Remediation as code fixes issues fast</li>
      </ul>
        </div>
