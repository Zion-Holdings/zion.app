...
export const metadata: Metadata = {
  title: 'Smart Image Suite - Startup',
  description: 'Revolutionize startup through intelligent automation. Our Smart Image Suite - Startup leverages advanced machine learning to deliver logistics route optimizatio',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Image Suite - Startup
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize startup through intelligent automation. Our Smart Image Suite - Startup leverages advanced machine learning to deliver logistics route optimization at scale.
          </p>
