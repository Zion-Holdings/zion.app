...
export const metadata: Metadata = {
  title: 'Neural System for Logistics',
  description: 'Transform your logistics operations with our Neural System for Logistics. This AI-driven solution automates content moderation with unprecedented accuracy and e',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-system-for-logistics-f175b81b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural System for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Neural System for Logistics. This AI-driven solution automates content moderation with unprecedented accuracy and efficiency.
          </p>
