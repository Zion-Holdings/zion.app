...
export const metadata: Metadata = {
  title: 'Data Science AI - Real-Estate',
  description: 'Next-generation real-estate solution: Data Science AI - Real-Estate. Combines forecast accuracy with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-science-ai-real-estate-26640e62',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Science AI - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation real-estate solution: Data Science AI - Real-Estate. Combines forecast accuracy with adaptive intelligence for optimal results.
          </p>
