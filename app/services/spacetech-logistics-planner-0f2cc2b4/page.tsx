...
export const metadata: Metadata = {
  title: 'SpaceTech Logistics Planner',
  description: 'Plans and optimizes satellite and space logistics, launch scheduling, and ground-station handoffs.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/spacetech-logistics-planner-0f2cc2b4',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            SpaceTech Logistics Planner
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Plans and optimizes satellite and space logistics, launch scheduling, and ground-station handoffs.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$79999</p>
          <ul className="space-y-2 mb-4">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your spacetech operations?</p>
