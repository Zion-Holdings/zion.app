...
export const metadata: Metadata = {
  title: 'Supply Serverless - Construction',
  description: 'Next-generation construction solution: Supply Serverless - Construction. Combines account planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/supply-serverless-construction-63146c3d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Supply Serverless - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Supply Serverless - Construction. Combines account planning with adaptive intelligence for optimal results.
          </p>
