...
export const metadata: Metadata = {
  title: 'Security Smart - Education',
  description: 'Drive innovation in education with Security Smart - Education. This AI-powered platform transforms training optimization into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-smart-education-f9b0b05a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Smart - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in education with Security Smart - Education. This AI-powered platform transforms training optimization into a competitive advantage.
          </p>
