...
export const metadata: Metadata = {
  title: 'AI-Powered Analyzer for Transportation',
  description: 'Transform your transportation operations with our AI-Powered Analyzer for Transportation. This AI-driven solution automates security monitoring with unprecedent',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Analyzer for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your transportation operations with our AI-Powered Analyzer for Transportation. This AI-driven solution automates security monitoring with unprecedented accuracy and efficiency.
          </p>
