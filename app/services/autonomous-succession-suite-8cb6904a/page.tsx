...
export const metadata: Metadata = {
  title: 'Autonomous Succession Suite',
  description: 'Transform your manufacturing operations with our Autonomous Succession Suite. This AI-driven solution provides intelligent automation with unprecedented accurac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-succession-suite-8cb6904a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Succession Suite
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your manufacturing operations with our Autonomous Succession Suite. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
