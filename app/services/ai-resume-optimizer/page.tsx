...
export const metadata: Metadata = {
  ...
  keywords: 'ATS keyword scoring (JD vs resume), Bullet-point rewrite per role, Achievement quantification suggestions, One-click PDF + cover letter export, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Resume Optimizer</h1>
        <p className="text-lg text-slate-300 mb-8">AI reads your resume vs JD: scores ATS compatibility rewrites bullet points quantifies achievements fills keyword gaps produces one-click export + cover letter draft.</p>
        ...
        <li class="text-slate-300">ATS keyword scoring (JD vs resume)</li>
        <li class="text-slate-300">Bullet-point rewrite per role</li>
        <li class="text-slate-300">Achievement quantification suggestions</li>
        <li class="text-slate-300">One-click PDF + cover letter export</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai resume optimizer</li>
