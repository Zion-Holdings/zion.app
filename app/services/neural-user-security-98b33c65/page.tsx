...
export const metadata: Metadata = {
  title: 'Neural User Security',
  description: 'Next-generation iot solution: Neural User Security. Combines fraud prevention with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-user-security-98b33c65',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural User Security
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation iot solution: Neural User Security. Combines fraud prevention with adaptive intelligence for optimal results.
          </p>
