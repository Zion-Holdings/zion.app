...
export const metadata: Metadata = {
  title: 'Opportunity Management AI-Powered SEO Content Engine',
  description: 'opportunity management solution for pharmaceuticals industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketin',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/opportunity-management-ai-powered-seo-content-engine-1117f029',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Opportunity Management AI-Powered SEO Content Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            opportunity management solution for pharmaceuticals industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing copy.
          </p>
