...
export const metadata: Metadata = {
  title: 'Predictive Intelligence Engine - Agriculture',
  description: 'Enhance your agriculture business with Predictive Intelligence Engine - Agriculture. Our solution provides expense management with enterprise-grade reliability ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Intelligence Engine - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your agriculture business with Predictive Intelligence Engine - Agriculture. Our solution provides expense management with enterprise-grade reliability and security.
          </p>
