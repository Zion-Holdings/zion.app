...
export const metadata: Metadata = {
  title: 'Predictive Forecast Business Intelligence',
  description: 'Optimize your construction workflows with Predictive Forecast Business Intelligence. This intelligent platform delivers net promoter score through advanced auto',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Forecast Business Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Predictive Forecast Business Intelligence. This intelligent platform delivers net promoter score through advanced automation and AI.
          </p>
