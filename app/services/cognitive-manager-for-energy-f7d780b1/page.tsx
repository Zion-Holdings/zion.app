...
export const metadata: Metadata = {
  title: 'Cognitive Manager for Energy',
  description: 'The future of energy is here with Cognitive Manager for Energy. Powered by cutting-edge AI, this platform delivers process automation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-manager-for-energy-f7d780b1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Manager for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Cognitive Manager for Energy. Powered by cutting-edge AI, this platform delivers process automation like never before.
          </p>
