...
export const metadata: Metadata = {
  title: 'Intelligent Neural - Construction',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Neural - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Intelligent Neural - Construction. This AI-powered platform transforms root cause analysis into a competitive advantage.
          </p>
