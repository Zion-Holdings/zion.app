...
export const metadata: Metadata = {
  title: 'Enterprise Director Platform - PROPTECH',
  description: 'Drive innovation in proptech with Enterprise Director Platform - PROPTECH. This AI-powered platform transforms benefits administration into a competitive advant',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-director-platform-proptech-78d72aee',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Director Platform - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in proptech with Enterprise Director Platform - PROPTECH. This AI-powered platform transforms benefits administration into a competitive advantage.
          </p>
