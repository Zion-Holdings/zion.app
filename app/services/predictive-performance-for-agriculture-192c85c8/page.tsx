...
export const metadata: Metadata = {
  title: 'Predictive Performance for Agriculture',
  description: 'Enhance your agriculture business with Predictive Performance for Agriculture. Our solution provides inventory management with enterprise-grade reliability and ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Performance for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your agriculture business with Predictive Performance for Agriculture. Our solution provides inventory management with enterprise-grade reliability and security.
          </p>
