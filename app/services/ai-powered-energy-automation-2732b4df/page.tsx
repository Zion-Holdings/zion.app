...
export const metadata: Metadata = {
  ...
  keywords: 'Open-source friendly, Container orchestration, Audit trails, Data encryption, advisor, hospitality, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Powered Energy Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Next-generation hospitality solution: AI-Powered Energy Automation. Combines security monitoring with adaptive intelligence for optimal results.</p>
