...
export const metadata: Metadata = {
  title: 'Logistics Automation Platform #5',
  description: 'AI-powered logistics solution for automation. Provides enterprise-grade automation and optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automation-logistics-b61092b0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Logistics Automation Platform #5
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered logistics solution for automation. Provides enterprise-grade automation and optimization.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Workflow optimization</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">70% process efficiency</li>
          <li className="text-purple-300">Zero manual work</li>
          <li className="text-purple-300">24/7 operation</li>
          </ul>
        </section>
