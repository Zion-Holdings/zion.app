...
export const metadata: Metadata = {
  title: 'Next-Gen Suite for Hospitality',
  description: 'The future of hospitality is here with Next-Gen Suite for Hospitality. Powered by cutting-edge AI, this platform delivers lakehouse architecture like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-suite-for-hospitality-2a2ad90d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Suite for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Next-Gen Suite for Hospitality. Powered by cutting-edge AI, this platform delivers lakehouse architecture like never before.
          </p>
