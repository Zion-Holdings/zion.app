...
export const metadata: Metadata = {
  ...
  keywords: 'Symptom analysis with NLP, Automated urgency classification (ESI levels), Medical history via FHIR/HL7, Drug interaction checking, Clinical guideline recommendations, Telemedicine handoff workflows, Patient communication automation, HIPAA-compliant architecture, ai, healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Patient Triage &amp; Clinical Decision Support</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered patient triage system analyzing symptoms, medical history, and vital signs to recommend urgency levels and care pathways.</p>
        ...
        <li class="text-slate-300">Symptom analysis with NLP</li>
        <li class="text-slate-300">Automated urgency classification (ESI levels)</li>
        <li class="text-slate-300">Medical history via FHIR/HL7</li>
        <li class="text-slate-300">Drug interaction checking</li>
        <li class="text-slate-300">Clinical guideline recommendations</li>
        <li class="text-slate-300">Telemedicine handoff workflows</li>
        <li class="text-slate-300">Patient communication automation</li>
        <li class="text-slate-300">HIPAA-compliant architecture</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce triage time from 15 min to 2 min</li>
        <li class="text-slate-300">Improve patient outcomes</li>
        <li class="text-slate-300">Reduce ER overcrowding</li>
        <li class="text-slate-300">Ensure consistent triage quality</li>
      </ul>
        </div>
