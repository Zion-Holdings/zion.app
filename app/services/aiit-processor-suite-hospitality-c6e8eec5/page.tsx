...
export const metadata: Metadata = {
  title: 'AI/IT Processor Suite - Hospitality',
  description: 'Hyper-accelerated hospitality solution: AI/IT Processor Suite - Hospitality. Combines time tracking with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-processor-suite-hospitality-c6e8eec5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Processor Suite - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated hospitality solution: AI/IT Processor Suite - Hospitality. Combines time tracking with next-gen AI for maximum velocity.
          </p>
