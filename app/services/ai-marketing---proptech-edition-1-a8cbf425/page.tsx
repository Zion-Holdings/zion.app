...
export const metadata: Metadata = {
  title: 'AI Marketing - Proptech Edition #1',
  description: 'Transform your proptech operations with our AI Marketing - Proptech Edition #1. This AI-driven solution automates content generation with unprecedented accuracy',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-marketing---proptech-edition-1-a8cbf425',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Marketing - Proptech Edition #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your proptech operations with our AI Marketing - Proptech Edition #1. This AI-driven solution automates content generation with unprecedented accuracy and efficiency.
          </p>
