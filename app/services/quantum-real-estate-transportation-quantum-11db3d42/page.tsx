...
export const metadata: Metadata = {
  title: 'Quantum Real Estate - Transportation Quantum',
  description: 'The future of transportation is here with Quantum Real Estate - Transportation Quantum. Powered by cutting-edge AI, this platform delivers demand planning like ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Real Estate - Transportation Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Quantum Real Estate - Transportation Quantum. Powered by cutting-edge AI, this platform delivers demand planning like never before.
          </p>
