...
export const metadata: Metadata = {
  title: 'Smart Risk Platform - Education',
  description: 'Next-generation education solution: Smart Risk Platform - Education. Combines quality control with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-risk-platform-education-58c0f56b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Risk Platform - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation education solution: Smart Risk Platform - Education. Combines quality control with adaptive intelligence for optimal results.
          </p>
