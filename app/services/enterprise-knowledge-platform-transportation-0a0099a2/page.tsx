...
export const metadata: Metadata = {
  title: 'Enterprise Knowledge Platform - Transportation',
  description: 'Quantum leap forward for transportation: Enterprise Knowledge Platform - Transportation. Uses quantum-inspired algorithms to deliver document processing at expo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-knowledge-platform-transportation-0a0099a2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Knowledge Platform - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for transportation: Enterprise Knowledge Platform - Transportation. Uses quantum-inspired algorithms to deliver document processing at exponential speed.
          </p>
