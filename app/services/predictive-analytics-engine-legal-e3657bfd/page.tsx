...
export const metadata: Metadata = {
  title: 'Predictive Analytics Engine - Legal',
  description: 'Enhance your legal business with Predictive Analytics Engine - Legal. Our solution provides project portfolio with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-analytics-engine-legal-e3657bfd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Analytics Engine - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Predictive Analytics Engine - Legal. Our solution provides project portfolio with enterprise-grade reliability and security.
          </p>
