...
export const metadata: Metadata = {
  ...
  keywords: 'WORM retention policy per bucket, Litigation hold (no-delete, no-overwrite), Automated encrypted export to SaaS tools, Automated lifecycle rule change review, cloud, SaaS, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cloud Storage Lifecycle &amp; Compliance</h1>
        <p className="text-lg text-slate-300 mb-8">S3/GCS/Azure Blob lifecycle: retention policy, litigation hold, WORM locking, legal export, and SaaS-data export automation.</p>
        ...
        <li class="text-slate-300">WORM retention policy per bucket</li>
        <li class="text-slate-300">Litigation hold (no-delete, no-overwrite)</li>
        <li class="text-slate-300">Automated encrypted export to SaaS tools</li>
        <li class="text-slate-300">Automated lifecycle rule change review</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with cloud storage lifecycle &amp; compliance</li>
