...
export const metadata: Metadata = {
  title: 'Autonomous Maintenance Automation',
  description: 'Revolutionize hospitality through intelligent automation. Our Autonomous Maintenance Automation leverages advanced machine learning to deliver document processi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Autonomous Maintenance Automation leverages advanced machine learning to deliver document processing at scale.
          </p>
