...
export const metadata: Metadata = {
  title: 'Smart Insights for Retail',
  description: 'The future of retail is here with Smart Insights for Retail. Powered by cutting-edge AI, this platform delivers image recognition like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-insights-for-retail-51542c02',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Insights for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Smart Insights for Retail. Powered by cutting-edge AI, this platform delivers image recognition like never before.
          </p>
