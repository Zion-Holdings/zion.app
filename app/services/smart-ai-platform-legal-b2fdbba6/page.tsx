...
export const metadata: Metadata = {
  title: 'Smart AI Platform - Legal',
  description: 'Drive innovation in legal with Smart AI Platform - Legal. This AI-powered platform transforms churn prediction into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-ai-platform-legal-b2fdbba6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart AI Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Smart AI Platform - Legal. This AI-powered platform transforms churn prediction into a competitive advantage.
          </p>
