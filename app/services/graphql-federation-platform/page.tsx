...
export const metadata: Metadata = {
  ...
  keywords: 'Apollo Federation 2 gateway + subgraph composition, Schema registry + CI/CD guardrails, Distributed caching per entity, Auto-generated TS/Java/Python SDKs, Rate limiting + cost analysis per query, it, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">GraphQL Federation &amp; API Composition Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Apollo Federation 2 gateway: compose 50+ microservice schemas into a unified GraphQL API, manage subgraph schema evolution, implement distributed caching, and provide type-safe SDKs in 12 languages.</p>
        ...
        <li class="text-slate-300">Apollo Federation 2 gateway + subgraph composition</li>
        <li class="text-slate-300">Schema registry + CI/CD guardrails</li>
        <li class="text-slate-300">Distributed caching per entity</li>
        <li class="text-slate-300">Auto-generated TS/Java/Python SDKs</li>
        <li class="text-slate-300">Rate limiting + cost analysis per query</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with graphql federation &amp; api composition platform</li>
