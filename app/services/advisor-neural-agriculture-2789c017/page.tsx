...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize agriculture through intelligent automation. Our Advisor Neural - Agriculture leverages advanced machine learning to deliver performance reviews at',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Advisor Neural - Agriculture leverages advanced machine learning to deliver performance reviews at scale.
          </p>
