...
export const metadata: Metadata = {
  ...
  keywords: 'Exactly-once delivery guarantee, Windowed aggregations, Schema evolution auto-handle, Kafka / Kinesis connectors, SQL-based transformation, data, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Streaming ETL Pipeline</h1>
        <p className="text-lg text-slate-300 mb-8">Sub-second streaming data pipelines with exactly-once delivery, windowed aggregations, schema evolution, and native connectors for Kafka, Pulsar, and Kinesis.</p>
        ...
        <li class="text-slate-300">Exactly-once delivery guarantee</li>
        <li class="text-slate-300">Windowed aggregations</li>
        <li class="text-slate-300">Schema evolution auto-handle</li>
        <li class="text-slate-300">Kafka / Kinesis connectors</li>
        <li class="text-slate-300">SQL-based transformation</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with streaming etl pipeline</li>
