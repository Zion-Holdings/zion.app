...
export const metadata: Metadata = {
  title: 'Smart Support Platform - EDTECH',
  description: 'Drive innovation in edtech with Smart Support Platform - EDTECH. This AI-powered platform transforms conversational ai into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-support-platform-edtech-58e789f8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Support Platform - EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in edtech with Smart Support Platform - EDTECH. This AI-powered platform transforms conversational ai into a competitive advantage.
          </p>
