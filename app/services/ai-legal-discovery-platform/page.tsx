      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Automated document review for litigation: privilege detection, relevance scoring, entity extraction, chronology building. Cuts review costs by 70%.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ AI-powered relevance scoring</li>
            <li className="text-purple-300">✓ Privilege & confidence detection</li>
            <li className="text-purple-300">✓ Entity extraction (people, orgs, dates)</li>
            <li className="text-purple-300">✓ Chronology auto-building</li>
            <li className="text-purple-300">✓ Redaction automation</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Cut review costs by 70%</li>
            <li className="text-purple-300">✓ Improve accuracy by 40%</li>
            <li className="text-purple-300">✓ Review 10x more docs per hour</li>
            </ul>
          </div>
