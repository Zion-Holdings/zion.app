...
export const metadata: Metadata = {
  ...
  keywords: 'AI-powered relevance scoring, Privilege & confidence detection, Entity extraction (people, orgs, dates), Chronology auto-building, Redaction automation, Production-ready export, ai, Legal & Compliance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Legal eDiscovery &amp; Review Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Automated document review for litigation: privilege detection, relevance scoring, entity extraction, chronology building. Cuts review costs by 70%.</p>
        ...
        <li class="text-slate-300">AI-powered relevance scoring</li>
        <li class="text-slate-300">Privilege &amp; confidence detection</li>
        <li class="text-slate-300">Entity extraction (people, orgs, dates)</li>
        <li class="text-slate-300">Chronology auto-building</li>
        <li class="text-slate-300">Redaction automation</li>
        <li class="text-slate-300">Production-ready export</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Cut review costs by 70%</li>
        <li class="text-slate-300">Improve accuracy by 40%</li>
        <li class="text-slate-300">Review 10x more docs per hour</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">5999</p>
