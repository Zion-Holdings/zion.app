...
export const metadata: Metadata = {
  title: "Affiliate Management Intelligent Document Processing AI - AI-Powered Proptech Solution",
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Affiliate Management Intelligent Document Processing AI - AI-Powered Proptech Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          affiliate management solution for proptech industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatic
        </p>
