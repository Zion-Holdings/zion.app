...
export const metadata: Metadata = {
  title: 'Smart processor-construction',
  description: 'The future of construction is here with Smart processor-construction. Powered by cutting-edge AI, this platform delivers predictive modeling like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-processor-construction-c5c1ecd8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart processor-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Smart processor-construction. Powered by cutting-edge AI, this platform delivers predictive modeling like never before.
          </p>
