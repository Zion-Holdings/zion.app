...
export const metadata = {
  ...
  description: "Optimize your transportation workflows with Intelligent Data for Transportation. This intelligent platform delivers lead scoring through advanced automation and",
  alternates: {
