...
export const metadata: Metadata = {
  title: 'Enterprise Data Platform - PROPTECH',
  description: 'Next-generation proptech solution: Enterprise Data Platform - PROPTECH. Combines testing automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-data-platform-proptech-9473efee',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Data Platform - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation proptech solution: Enterprise Data Platform - PROPTECH. Combines testing automation with adaptive intelligence for optimal results.
          </p>
