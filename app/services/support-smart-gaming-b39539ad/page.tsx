...
export const metadata: Metadata = {
  title: 'Support Smart - Gaming',
  description: 'Revolutionize gaming through intelligent automation. Our Support Smart - Gaming leverages advanced machine learning to deliver business intelligence at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/support-smart-gaming-b39539ad',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Support Smart - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize gaming through intelligent automation. Our Support Smart - Gaming leverages advanced machine learning to deliver business intelligence at scale.
          </p>
