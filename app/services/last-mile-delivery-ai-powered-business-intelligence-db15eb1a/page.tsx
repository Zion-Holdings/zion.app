...
export const metadata: Metadata = {
  title: 'Last-mile Delivery AI-Powered Business Intelligence',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Last-mile Delivery AI-Powered Business Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered last-mile delivery solution for bi. Automated BI report generation and insight discovery.
          </p>
