...
export const metadata: Metadata = {
  title: 'Quantum Data Science - FINTECH Quantum',
  description: 'Revolutionize fintech through intelligent automation. Our Quantum Data Science - FINTECH Quantum leverages advanced machine learning to deliver customer insight',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Data Science - FINTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize fintech through intelligent automation. Our Quantum Data Science - FINTECH Quantum leverages advanced machine learning to deliver customer insights at scale.
          </p>
