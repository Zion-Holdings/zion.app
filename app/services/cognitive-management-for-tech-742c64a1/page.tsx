...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize technology through intelligent automation. Our Cognitive Management for Tech leverages advanced machine learning to deliver quality control at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our Cognitive Management for Tech leverages advanced machine learning to deliver quality control at scale.
          </p>
