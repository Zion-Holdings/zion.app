...
export const metadata: Metadata = {
  title: 'Adaptive Management for Agriculture',
  description: 'Next-generation agriculture solution: Adaptive Management for Agriculture. Combines process automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-management-for-agriculture-4365bc42',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Management for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agriculture solution: Adaptive Management for Agriculture. Combines process automation with adaptive intelligence for optimal results.
          </p>
