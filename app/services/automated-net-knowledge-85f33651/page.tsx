...
export const metadata: Metadata = {
  title: 'Automated Net Knowledge',
  description: 'Transform your logistics operations with our Automated Net Knowledge. This AI-driven solution automates compliance monitoring with unprecedented accuracy and ef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-net-knowledge-85f33651',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Net Knowledge
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Automated Net Knowledge. This AI-driven solution automates compliance monitoring with unprecedented accuracy and efficiency.
          </p>
