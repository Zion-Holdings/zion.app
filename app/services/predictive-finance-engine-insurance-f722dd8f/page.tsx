...
export const metadata: Metadata = {
  title: 'Predictive Finance Engine - Insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Finance Engine - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Predictive Finance Engine - Insurance. Combines brand monitoring with adaptive intelligence for optimal results.
          </p>
