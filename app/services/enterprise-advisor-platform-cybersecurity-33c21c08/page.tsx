...
export const metadata: Metadata = {
  title: 'Enterprise Advisor Platform - Cybersecurity',
  description: 'Unlock unprecedented growth with Enterprise Advisor Platform - Cybersecurity. This autonomous system provides lakehouse architecture with zero manual interventi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Advisor Platform - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Enterprise Advisor Platform - Cybersecurity. This autonomous system provides lakehouse architecture with zero manual intervention needed.
          </p>
