...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Optimization - AITECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Optimization - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in aitech with Hyper-Accelerated Optimization - AITECH. This AI-powered platform transforms workflow automation into a competitive advantage.
          </p>
