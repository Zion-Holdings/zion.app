...
export const metadata: Metadata = {
  title: 'AI Manufacturing - REGTECH Edition',
  description: 'Enhance your regtech business with AI Manufacturing - REGTECH Edition. Our solution provides social media monitoring with enterprise-grade reliability and secur',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Manufacturing - REGTECH Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your regtech business with AI Manufacturing - REGTECH Edition. Our solution provides social media monitoring with enterprise-grade reliability and security.
          </p>
