...
export const metadata: Metadata = {
  title: 'AI-Powered AI-Powered Market Intelligence',
  description: 'ai-powered solution for non-profit industry. Monitors market trends, competitor activities, and industry news to provide actionable insights.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-ai-powered-market-intelligence-8a208dbc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            ai-powered solution for non-profit industry. Monitors market trends, competitor activities, and industry news to provide actionable insights.
          </p>
