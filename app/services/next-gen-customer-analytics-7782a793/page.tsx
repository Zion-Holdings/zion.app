...
export const metadata: Metadata = {
  title: 'Next-Gen Customer Analytics',
  description: 'The future of agriculture is here with Next-Gen Customer Analytics. Powered by cutting-edge AI, this platform delivers expense reporting like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-customer-analytics-7782a793',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Next-Gen Customer Analytics. Powered by cutting-edge AI, this platform delivers expense reporting like never before.
          </p>
