...
export const metadata: Metadata = {
  title: 'Intelligent Manufacturing for Retail',
  description: 'Hyper-accelerated retail solution: Intelligent Manufacturing for Retail. Combines master data management with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-manufacturing-for-retail-c8b543d6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Manufacturing for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated retail solution: Intelligent Manufacturing for Retail. Combines master data management with next-gen AI for maximum velocity.
          </p>
