...
export const metadata: Metadata = {
  title: 'Autonomous Management for Logistics #1',
  description: 'The future of logistics is here with Autonomous Management for Logistics #1. Powered by cutting-edge AI, this platform delivers transformative results like neve',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-management-for-logistics-1-6c52137e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Management for Logistics #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Autonomous Management for Logistics #1. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
