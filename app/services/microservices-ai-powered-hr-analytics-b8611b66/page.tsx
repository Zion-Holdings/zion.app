...
export const metadata: Metadata = {
  title: 'Microservices AI-Powered HR Analytics',
  description: 'AI-powered microservices solution for hr. Predictive analytics for employee performance, retention, and recruitment.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/microservices-ai-powered-hr-analytics-b8611b66',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Microservices AI-Powered HR Analytics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered microservices solution for hr. Predictive analytics for employee performance, retention, and recruitment.
          </p>
