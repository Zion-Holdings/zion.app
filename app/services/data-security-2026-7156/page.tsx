...
export const metadata = {
  ...
  description: 'End-to-end data security services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/data-security-2026-7156/' },
};
    ...
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        ...
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end data security services: assessment, deployment, and managed operations.
        </p>
