...
export const metadata: Metadata = {
  title: 'Smart Automation for Tech',
  description: 'Enhance your technology business with Smart Automation for Tech. Our solution provides invoice processing with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-automation-for-tech-2a9deaae',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Automation for Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your technology business with Smart Automation for Tech. Our solution provides invoice processing with enterprise-grade reliability and security.
          </p>
