...
export const metadata: Metadata = {
  title: 'Autonomous NLP System - Finance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous NLP System - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in finance with Autonomous NLP System - Finance. This AI-powered platform transforms brand sentiment into a competitive advantage.
          </p>
