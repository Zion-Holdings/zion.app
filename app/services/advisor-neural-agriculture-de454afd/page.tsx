...
export const metadata: Metadata = {
  title: 'Advisor Neural - Agriculture',
  description: 'Next-generation agriculture solution: Advisor Neural - Agriculture. Combines customer onboarding with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/advisor-neural-agriculture-de454afd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Advisor Neural - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agriculture solution: Advisor Neural - Agriculture. Combines customer onboarding with adaptive intelligence for optimal results.
          </p>
