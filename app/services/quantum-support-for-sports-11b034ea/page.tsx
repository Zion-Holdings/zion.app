...
export const metadata: Metadata = {
  title: 'Quantum Support for Sports',
  description: 'Enhance your sports business with Quantum Support for Sports. Our solution provides inventory management with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-support-for-sports-11b034ea',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Support for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your sports business with Quantum Support for Sports. Our solution provides inventory management with enterprise-grade reliability and security.
          </p>
