...
export const metadata: Metadata = {
  title: 'Autonomous Support for Sports',
  description: 'Revolutionize sports through intelligent automation. Our Autonomous Support for Sports leverages advanced machine learning to deliver predictive analytics at sc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-support-for-sports-0c5f9c8a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Support for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Autonomous Support for Sports leverages advanced machine learning to deliver predictive analytics at scale.
          </p>
