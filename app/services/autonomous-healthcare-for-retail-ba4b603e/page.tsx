...
export const metadata: Metadata = {
  ...
  description: 'Next-generation retail solution: Autonomous Healthcare for Retail. Combines energy management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-healthcare-for-retail-ba4b603e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation retail solution: Autonomous Healthcare for Retail. Combines energy management with adaptive intelligence for optimal results.
          </p>
