...
export const metadata: Metadata = {
  title: 'Intelligent Content Moderation PyTorch (Government)',
  description: 'Intelligent Content Moderation PyTorch (Government) is an AI-powered government solution that transforms how businesses operate through intelligent automation a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Content Moderation PyTorch (Government)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Intelligent Content Moderation PyTorch (Government) is an AI-powered government solution that transforms how businesses operate through intelligent automation and real-time analytics.
