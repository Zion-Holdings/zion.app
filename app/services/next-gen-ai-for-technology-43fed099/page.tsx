...
export const metadata: Metadata = {
  title: 'Next-Gen AI for TECHNOLOGY',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen AI for TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your technology business with Next-Gen AI for TECHNOLOGY. Our solution provides predictive modeling with enterprise-grade reliability and security.
          </p>
