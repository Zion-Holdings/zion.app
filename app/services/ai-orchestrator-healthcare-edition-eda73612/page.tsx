      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with AI Orchestrator - Healthcare Edition. This AI-powered platform transforms revenue forecasting into a competitive advantage.
          </p>
