...
export const metadata: Metadata = {
  title: 'Predictive Customer Service Engine - Healthcare',
  description: 'The future of healthcare is here with Predictive Customer Service Engine - Healthcare. Powered by cutting-edge AI, this platform delivers process automation lik',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Customer Service Engine - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Predictive Customer Service Engine - Healthcare. Powered by cutting-edge AI, this platform delivers process automation like never before.
          </p>
