...
export const metadata: Metadata = {
  title: 'Intelligent optimization-energy',
  description: 'The future of energy is here with Intelligent optimization-energy. Powered by cutting-edge AI, this platform delivers sales forecasting like never before.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent optimization-energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Intelligent optimization-energy. Powered by cutting-edge AI, this platform delivers sales forecasting like never before.
          </p>
