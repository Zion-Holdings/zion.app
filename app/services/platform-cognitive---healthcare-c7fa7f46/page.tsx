...
export const metadata: Metadata = {
  title: 'Platform Cognitive - Healthcare',
  description: 'The future of healthcare is here with Platform Cognitive - Healthcare. Powered by cutting-edge AI, this platform delivers maintenance scheduling like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/platform-cognitive---healthcare-c7fa7f46',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Platform Cognitive - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Platform Cognitive - Healthcare. Powered by cutting-edge AI, this platform delivers maintenance scheduling like never before.
          </p>
