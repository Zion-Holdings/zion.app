...
export const metadata: Metadata = {
  ...
  description: '24/7 customer support chatbot that handles 80% of inquiries with human-like responses.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-customer-support-chatbot-0a3df152',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            24/7 customer support chatbot that handles 80% of inquiries with human-like responses.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">NLP understanding</li>
          <li className="text-gray-300">Escalation management</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">80% automation</li>
