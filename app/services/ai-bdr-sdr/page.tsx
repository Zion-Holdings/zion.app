      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Autonomous AI Business Development & Sales Development Representative: prospect, qualify, email, book meetings, and nurture leads 24/7 without human intervention.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Lead research & enrichment (LinkedIn, company data)</li>
            <li className="text-purple-300">✓ Personalized cold email & LinkedIn outreach</li>
            <li className="text-purple-300">✓ Intent signal detection & prioritization</li>
            <li className="text-purple-300">✓ Automated meeting booking (Calendly integration)</li>
            <li className="text-purple-300">✓ CRM sync (HubSpot, Salesforce)</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai bdr/sdr agent</li>
