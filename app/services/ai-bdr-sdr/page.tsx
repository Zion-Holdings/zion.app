...
export const metadata: Metadata = {
  ...
  keywords: 'Lead research & enrichment (LinkedIn, company data), Personalized cold email & LinkedIn outreach, Intent signal detection & prioritization, Automated meeting booking (Calendly integration), CRM sync (HubSpot, Salesforce), ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI BDR/SDR Agent</h1>
        <p className="text-lg text-slate-300 mb-8">Autonomous AI Business Development &amp; Sales Development Representative: prospect, qualify, email, book meetings, and nurture leads 24/7 without human intervention.</p>
        ...
        <li class="text-slate-300">Lead research &amp; enrichment (LinkedIn, company data)</li>
        <li class="text-slate-300">Personalized cold email &amp; LinkedIn outreach</li>
        <li class="text-slate-300">Intent signal detection &amp; prioritization</li>
        <li class="text-slate-300">Automated meeting booking (Calendly integration)</li>
        <li class="text-slate-300">CRM sync (HubSpot, Salesforce)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai bdr/sdr agent</li>
