...
export const metadata: Metadata = {
  title: 'Cognitive Manager System',
  description: 'Transform your telecommunications operations with our Cognitive Manager System. This data solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-manager-system-a1ef2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Manager System
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your telecommunications operations with our Cognitive Manager System. This data solution delivers unprecedented automation and intelligence.
          </p>
