...
export const metadata: Metadata = {
  title: 'Cognitive Automation for Real-Estate',
  description: 'Transform your real-estate operations with our Cognitive Automation for Real-Estate. This AI-driven solution automates customer insights with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-automation-for-real-estate-319ee499',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Automation for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Cognitive Automation for Real-Estate. This AI-driven solution automates customer insights with unprecedented accuracy and efficiency.
          </p>
