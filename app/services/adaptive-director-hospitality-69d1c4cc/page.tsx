...
export const metadata: Metadata = {
  title: 'Adaptive director-hospitality',
  description: 'Enhance your hospitality business with Adaptive director-hospitality. Our solution provides competitive intelligence with enterprise-grade reliability and secur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-director-hospitality-69d1c4cc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive director-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Adaptive director-hospitality. Our solution provides competitive intelligence with enterprise-grade reliability and security.
          </p>
