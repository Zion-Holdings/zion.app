...
export const metadata: Metadata = {
  title: 'AI-Driven Territory for Tech',
  description: 'Optimize your technology workflows with AI-Driven Territory for Tech. This intelligent platform delivers master data management through advanced automation and ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Driven Territory for Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your technology workflows with AI-Driven Territory for Tech. This intelligent platform delivers master data management through advanced automation and AI.
          </p>
