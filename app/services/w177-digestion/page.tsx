...
export const metadata: Metadata = {
  ...
  keywords: 'Editorial newsletter builder, Employee contribution collection, Content curation from RSS and internal, Analytics on open and engagement, Slack and email distribution, Digest scheduling and archiving, Integration with Slack, Teams, micro-saas, Internal Communications, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">DigestIt — Internal Newsletter</h1>
        <p className="text-lg text-slate-300 mb-8">Create and distribute internal newsletters: curated content, employee submissions, analytics, Slack/email distribution.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">micro-saas</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">Internal Communications</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Editorial newsletter builder</li>
        <li class="text-slate-300">Employee contribution collection</li>
        <li class="text-slate-300">Content curation from RSS and internal</li>
        <li class="text-slate-300">Analytics on open and engagement</li>
        <li class="text-slate-300">Slack and email distribution</li>
        <li class="text-slate-300">Digest scheduling and archiving</li>
        <li class="text-slate-300">Integration with Slack</li>
        <li class="text-slate-300">Teams</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Keep teams informed with curated content</li>
        <li class="text-slate-300">Employee contributions drive engagement</li>
        <li class="text-slate-300">Analytics show what resonates</li>
        <li class="text-slate-300">Archiving for institutional memory</li>
      </ul>
        </div>
