...
export const metadata: Metadata = {
  title: 'Quantum SMB - Energy Quantum',
  description: 'Enhance your energy business with Quantum SMB - Energy Quantum. Our solution provides compliance reporting with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-smb-energy-quantum-cad2353d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum SMB - Energy Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your energy business with Quantum SMB - Energy Quantum. Our solution provides compliance reporting with enterprise-grade reliability and security.
          </p>
