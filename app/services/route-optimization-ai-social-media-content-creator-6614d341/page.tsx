...
export const metadata: Metadata = {
  title: 'Route Optimization AI Social Media Content Creator',
  description: 'AI-powered route optimization solution for social media. Generates, schedules, and optimizes social media content across all platforms.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/route-optimization-ai-social-media-content-creator-6614d341',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Route Optimization AI Social Media Content Creator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered route optimization solution for social media. Generates, schedules, and optimizes social media content across all platforms.
          </p>
