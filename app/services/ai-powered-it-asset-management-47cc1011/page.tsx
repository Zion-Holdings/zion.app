...
export const metadata: Metadata = {
  ...
  description: 'Intelligent IT asset management platform that tracks hardware, software, and cloud resources with predictive lifecycle management and cost optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-it-asset-management-47cc1011',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Intelligent IT asset management platform that tracks hardware, software, and cloud resources with predictive lifecycle management and cost optimization.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Asset discovery</li>
          <li className="text-gray-300">Lifecycle prediction</li>
          <li className="text-gray-300">Cost optimization</li>
          <li className="text-gray-300">License management</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <li className="text-purple-300">95% asset visibility</li>
          <li className="text-purple-300">Automated renewals</li>
          </ul>
        </section>
