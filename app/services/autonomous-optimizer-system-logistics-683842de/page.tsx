...
export const metadata: Metadata = {
  title: 'Autonomous Optimizer System - Logistics',
  description: 'Drive innovation in logistics with Autonomous Optimizer System - Logistics. This AI-powered platform transforms api management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-optimizer-system-logistics-683842de',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Optimizer System - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with Autonomous Optimizer System - Logistics. This AI-powered platform transforms api management into a competitive advantage.
          </p>
