...
export const metadata: Metadata = {
  title: 'Smart Autonomous Platform - Logistics',
  description: 'Enhance your logistics business with Smart Autonomous Platform - Logistics. Our solution provides regulatory tracking with enterprise-grade reliability and secu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-autonomous-platform-logistics-b02e68c2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Autonomous Platform - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with Smart Autonomous Platform - Logistics. Our solution provides regulatory tracking with enterprise-grade reliability and security.
          </p>
