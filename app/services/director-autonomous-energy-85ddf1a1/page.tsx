...
export const metadata: Metadata = {
  title: 'Director Autonomous - Energy',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Director Autonomous - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Director Autonomous - Energy. This AI-powered platform transforms data governance into a competitive advantage.
          </p>
