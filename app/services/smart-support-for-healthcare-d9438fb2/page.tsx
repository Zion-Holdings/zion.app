...
export const metadata: Metadata = {
  title: 'Smart Support for Healthcare',
  description: 'The future of healthcare is here with Smart Support for Healthcare. Powered by cutting-edge AI, this platform delivers security monitoring like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-support-for-healthcare-d9438fb2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Support for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Smart Support for Healthcare. Powered by cutting-edge AI, this platform delivers security monitoring like never before.
          </p>
