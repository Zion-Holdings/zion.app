...
export const metadata: Metadata = {
  title: 'Automated computer vision-hospitality',
  description: 'Unlock unprecedented growth with Automated computer vision-hospitality. This autonomous system provides intelligent automation with zero manual intervention nee',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-computer-vision-hospitality-82b303ce',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated computer vision-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Automated computer vision-hospitality. This autonomous system provides intelligent automation with zero manual intervention needed.
          </p>
