...
export const metadata: Metadata = {
  title: 'AI/IT Computer Vision Suite - Real-Estate',
  description: 'Transform your real-estate operations with our AI/IT Computer Vision Suite - Real-Estate. This AI-driven solution automates forecast accuracy with unprecedented',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-computer-vision-suite-real-estate-7ce0de04',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Computer Vision Suite - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our AI/IT Computer Vision Suite - Real-Estate. This AI-driven solution automates forecast accuracy with unprecedented accuracy and efficiency.
          </p>
