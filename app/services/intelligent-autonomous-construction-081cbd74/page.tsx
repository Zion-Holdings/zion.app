...
export const metadata: Metadata = {
  title: 'Intelligent Autonomous - Construction',
  description: 'Revolutionize construction through intelligent automation. Our Intelligent Autonomous - Construction leverages advanced machine learning to deliver vendor manag',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-autonomous-construction-081cbd74',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Autonomous - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Intelligent Autonomous - Construction leverages advanced machine learning to deliver vendor management at scale.
          </p>
