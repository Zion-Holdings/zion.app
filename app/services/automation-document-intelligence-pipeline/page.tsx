  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Legal Document Intelligence Pipeline</h1>
        <p className="text-lg text-slate-300 mb-8">OCR + NLP document-intelligence: pipeline-abstract multi-service orchestration for contracts, invoices, and regulatory submissions; auto-classification, clause extraction, anomaly flag, e-signature ready, approval routing.</p>
        ...
        <li class="text-slate-300">OCR + NLP pipeline orchestrating multiple document types in one session</li>
        <li class="text-slate-300">Auto-classification — any document placed in input folder routed to correct intake path</li>
        <li class="text-slate-300">Clause extraction, anomaly flag, and summarisation in same pipeline step</li>
        <li class="text-slate-300">Approval routing with journalised highlight — every step durably signed and trusting</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with legal document intelligence pipeline</li>
