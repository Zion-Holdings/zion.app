...
export const metadata: Metadata = {
  title: 'Processor Cognitive - Proptech',
  description: 'Revolutionize proptech through intelligent automation. Our Processor Cognitive - Proptech leverages advanced machine learning to deliver document processing at ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/processor-cognitive---proptech-4d252e64',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Processor Cognitive - Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our Processor Cognitive - Proptech leverages advanced machine learning to deliver document processing at scale.
          </p>
