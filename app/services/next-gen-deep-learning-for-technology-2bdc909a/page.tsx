...
export const metadata: Metadata = {
  title: 'Next-Gen Deep Learning for TECHNOLOGY',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Deep Learning for TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in technology with Next-Gen Deep Learning for TECHNOLOGY. This AI-powered platform transforms receipt processing into a competitive advantage.
          </p>
