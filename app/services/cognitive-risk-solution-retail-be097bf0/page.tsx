...
export const metadata: Metadata = {
  title: 'Cognitive Risk Solution - Retail',
  description: 'Enhance your retail business with Cognitive Risk Solution - Retail. Our solution provides master data management with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-risk-solution-retail-be097bf0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Risk Solution - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your retail business with Cognitive Risk Solution - Retail. Our solution provides master data management with enterprise-grade reliability and security.
          </p>
