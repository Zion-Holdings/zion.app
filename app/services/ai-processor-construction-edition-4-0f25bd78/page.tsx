...
export const metadata: Metadata = {
  title: 'AI Processor - Construction Edition #4',
  description: 'Optimize your construction workflows with AI Processor - Construction Edition #4. This intelligent platform delivers decision support through advanced automatio',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-processor-construction-edition-4-0f25bd78',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Processor - Construction Edition #4
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with AI Processor - Construction Edition #4. This intelligent platform delivers decision support through advanced automation and AI.
          </p>
