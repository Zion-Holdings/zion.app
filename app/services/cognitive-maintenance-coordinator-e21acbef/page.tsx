...
export const metadata: Metadata = {
  title: 'Cognitive Maintenance Coordinator',
  description: 'The future of logistics is here with Cognitive Maintenance Coordinator. Powered by cutting-edge AI, this platform delivers energy management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-maintenance-coordinator-e21acbef',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Maintenance Coordinator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Cognitive Maintenance Coordinator. Powered by cutting-edge AI, this platform delivers energy management like never before.
          </p>
