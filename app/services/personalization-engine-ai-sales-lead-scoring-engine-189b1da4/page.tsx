...
export const metadata: Metadata = {
  title: 'Personalization Engine AI Sales Lead Scoring Engine',
  description: 'personalization engine solution for parks & recreation industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/personalization-engine-ai-sales-lead-scoring-engine-189b1da4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Personalization Engine AI Sales Lead Scoring Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            personalization engine solution for parks & recreation industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.
          </p>
