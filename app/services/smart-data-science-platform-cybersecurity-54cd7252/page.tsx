...
export const metadata: Metadata = {
  title: 'Smart Data Science Platform - Cybersecurity',
  description: 'The future of cybersecurity is here with Smart Data Science Platform - Cybersecurity. Powered by cutting-edge AI, this platform delivers sales forecasting like ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-data-science-platform-cybersecurity-54cd7252',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Data Science Platform - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of cybersecurity is here with Smart Data Science Platform - Cybersecurity. Powered by cutting-edge AI, this platform delivers sales forecasting like never before.
          </p>
