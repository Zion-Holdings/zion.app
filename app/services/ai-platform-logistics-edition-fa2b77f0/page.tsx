...
export const metadata: Metadata = {
  title: 'AI Platform - Logistics Edition',
  description: 'Revolutionize logistics through intelligent automation. Our AI Platform - Logistics Edition leverages advanced machine learning to deliver enterprise-grade insi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-platform-logistics-edition-fa2b77f0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Platform - Logistics Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our AI Platform - Logistics Edition leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
