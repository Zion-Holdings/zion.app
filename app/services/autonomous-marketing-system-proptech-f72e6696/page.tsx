...
export const metadata: Metadata = {
  title: 'Autonomous Marketing System - PROPTECH',
  description: 'The future of proptech is here with Autonomous Marketing System - PROPTECH. Powered by cutting-edge AI, this platform delivers predictive modeling like never be',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-marketing-system-proptech-f72e6696',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Marketing System - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with Autonomous Marketing System - PROPTECH. Powered by cutting-edge AI, this platform delivers predictive modeling like never before.
          </p>
