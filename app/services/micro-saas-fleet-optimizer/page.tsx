...
export const metadata: Metadata = {
  ...
  keywords: 'Route optimization, Fuel tracking, Maintenance scheduling, Driver safety, GPS tracking, Compliance, Analytics, Mobile app, micro-saas, Logistics, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Fleet Management Platform</h1>
        <p className="text-lg text-slate-300 mb-8">AI fleet management with route optimization and driver safety scoring.</p>
        ...
        <li class="text-slate-300">Fuel tracking</li>
        <li class="text-slate-300">Maintenance scheduling</li>
        <li class="text-slate-300">Driver safety</li>
        <li class="text-slate-300">GPS tracking</li>
        <li class="text-slate-300">Compliance</li>
        <li class="text-slate-300">Analytics</li>
        <li class="text-slate-300">Mobile app</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">20% fuel savings</li>
        <li class="text-slate-300">30% less downtime</li>
        <li class="text-slate-300">Driver safety</li>
        <li class="text-slate-300">Compliance</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$49/vehicle/mo</p>
