...
export const metadata: Metadata = {
  title: 'Analytics Cognitive - Retail',
  description: 'The future of retail is here with Analytics Cognitive - Retail. Powered by cutting-edge AI, this platform delivers maintenance scheduling like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/analytics-cognitive---retail-dc59bb2b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Analytics Cognitive - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Analytics Cognitive - Retail. Powered by cutting-edge AI, this platform delivers maintenance scheduling like never before.
          </p>
