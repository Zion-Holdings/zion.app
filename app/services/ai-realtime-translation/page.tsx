...
export const metadata: Metadata = {
  ...
  keywords: '70+ languages & dialects, Sub-200ms latency, Speaker diarization, Custom glossary per client, REST + WebSocket APIs, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Real-Time Translation Engine</h1>
        <p className="text-lg text-slate-300 mb-8">Sub-200ms speech-to-text and text-to-speech translation across 70+ languages with dialect preservation.</p>
        ...
        <li class="text-slate-300">70+ languages &amp; dialects</li>
        <li class="text-slate-300">Sub-200ms latency</li>
        <li class="text-slate-300">Speaker diarization</li>
        <li class="text-slate-300">Custom glossary per client</li>
        <li class="text-slate-300">REST + WebSocket APIs</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with real-time translation engine</li>
