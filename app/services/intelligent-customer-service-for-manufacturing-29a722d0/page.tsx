...
export const metadata: Metadata = {
  ...
  description: 'Enhance your manufacturing business with Intelligent Customer Service for Manufacturing. Our solution provides automation opportunity with enterprise-grade reli',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-customer-service-for-manufacturing-29a722d0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your manufacturing business with Intelligent Customer Service for Manufacturing. Our solution provides automation opportunity with enterprise-grade reliability and security.
          </p>
