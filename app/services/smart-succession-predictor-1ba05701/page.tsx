...
export const metadata: Metadata = {
  title: 'Smart Succession Predictor',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Succession Predictor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Smart Succession Predictor. Powered by cutting-edge AI, this platform delivers forecast accuracy like never before.
          </p>
