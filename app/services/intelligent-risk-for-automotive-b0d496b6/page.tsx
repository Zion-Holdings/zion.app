...
export const metadata: Metadata = {
  title: 'Intelligent Risk for Automotive',
  description: 'The future of automotive is here with Intelligent Risk for Automotive. Powered by cutting-edge AI, this platform delivers sentiment analysis like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-risk-for-automotive-b0d496b6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Risk for Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of automotive is here with Intelligent Risk for Automotive. Powered by cutting-edge AI, this platform delivers sentiment analysis like never before.
          </p>
