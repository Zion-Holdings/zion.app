...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'GeoAnalytics — Location Intelligence', 'description': 'Location analytics: geocoding, heatmaps, trade area analysis, drive-time rings, and demographic enrichment. Turn addresses into insights.', 'serviceType': 'micro-saas', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'Analytics'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'GeoAnalytics — Location Intelligence Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$49/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$149/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': '$499/mo', 'priceCurrency': 'USD'}]}} />
    <JsonLd data={'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'Batch geocoding and reverse geocoding', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Batch geocoding and reverse geocoding'}}, {'@type': 'Question', 'name': 'Heatmap and density visualization', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Heatmap and density visualization'}}, {'@type': 'Question', 'name': 'Trade area and drive-time analysis', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Trade area and drive-time analysis'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Turn addresses into actionable intelligence; Demographic enrichment for site selection; Drive-time analysis for coverage'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} />
