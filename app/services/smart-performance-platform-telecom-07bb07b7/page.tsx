...
export const metadata: Metadata = {
  title: 'Smart Performance Platform - Telecom',
  description: 'Optimize your telecom workflows with Smart Performance Platform - Telecom. This intelligent platform delivers customer journey mapping through advanced automati',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-performance-platform-telecom-07bb07b7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Performance Platform - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your telecom workflows with Smart Performance Platform - Telecom. This intelligent platform delivers customer journey mapping through advanced automation and AI.
          </p>
