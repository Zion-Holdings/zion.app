...
export const metadata: Metadata = {
  title: 'Next-Gen Financial for Cybersecurity',
  description: 'Enhance your cybersecurity business with Next-Gen Financial for Cybersecurity. Our solution provides quality prediction with enterprise-grade reliability and se',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Financial for Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your cybersecurity business with Next-Gen Financial for Cybersecurity. Our solution provides quality prediction with enterprise-grade reliability and security.
          </p>
