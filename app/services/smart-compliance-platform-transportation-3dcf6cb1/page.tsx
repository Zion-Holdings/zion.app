...
export const metadata: Metadata = {
  title: 'Smart Compliance Platform - Transportation',
  description: 'Enhance your transportation business with Smart Compliance Platform - Transportation. Our solution provides business intelligence with enterprise-grade reliabil',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-compliance-platform-transportation-3dcf6cb1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Compliance Platform - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with Smart Compliance Platform - Transportation. Our solution provides business intelligence with enterprise-grade reliability and security.
          </p>
