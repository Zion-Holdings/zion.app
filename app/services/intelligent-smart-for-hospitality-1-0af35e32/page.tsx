...
export const metadata: Metadata = {
  title: 'Intelligent Smart for Hospitality #1',
  description: 'Transform your hospitality operations with our Intelligent Smart for Hospitality #1. This AI-driven solution automates capacity management with unprecedented ac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-smart-for-hospitality-1-0af35e32',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Smart for Hospitality #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Intelligent Smart for Hospitality #1. This AI-driven solution automates capacity management with unprecedented accuracy and efficiency.
          </p>
