...
export const metadata: Metadata = {
  title: 'Smart Processor for Agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Smart Processor for Agriculture leverages advanced machine learning to deliver fraud prevention at',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-processor-for-agriculture-5866f627',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Processor for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Smart Processor for Agriculture leverages advanced machine learning to deliver fraud prevention at scale.
          </p>
