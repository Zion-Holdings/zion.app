...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Revenue - Transportation',
  description: 'Optimize your transportation workflows with Hyper-Accelerated Revenue - Transportation. This intelligent platform delivers api management through advanced autom',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Revenue - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Hyper-Accelerated Revenue - Transportation. This intelligent platform delivers api management through advanced automation and AI.
          </p>
