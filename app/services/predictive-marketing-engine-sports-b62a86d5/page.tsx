...
export const metadata: Metadata = {
  title: 'Predictive Marketing Engine - Sports',
  description: 'The future of sports is here with Predictive Marketing Engine - Sports. Powered by cutting-edge AI, this platform delivers customer retention like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-marketing-engine-sports-b62a86d5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Marketing Engine - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Predictive Marketing Engine - Sports. Powered by cutting-edge AI, this platform delivers customer retention like never before.
          </p>
