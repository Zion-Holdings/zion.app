...
export const metadata: Metadata = {
  ...
  keywords: 'Argument and claim extraction, Precedent matching and citation analysis, Argument strength scoring, Counter-argument suggestions, Brief comparison between cases, Timeline and fact extraction, Integration with Clio, Westlaw, LexisNexis, ai, Legal, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Legal Brief Analyzer</h1>
        <p className="text-lg text-slate-300 mb-8">Analyze legal briefs: argument extraction, precedent matching, strength scoring, counter-argument suggestions.</p>
        ...
        <li class="text-slate-300">Argument and claim extraction</li>
        <li class="text-slate-300">Precedent matching and citation analysis</li>
        <li class="text-slate-300">Argument strength scoring</li>
        <li class="text-slate-300">Counter-argument suggestions</li>
        <li class="text-slate-300">Brief comparison between cases</li>
        <li class="text-slate-300">Timeline and fact extraction</li>
        <li class="text-slate-300">Integration with Clio</li>
        <li class="text-slate-300">Westlaw</li>
        <li class="text-slate-300">LexisNexis</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Analyze briefs 10x faster</li>
        <li class="text-slate-300">Precedent matching finds relevant cases</li>
        <li class="text-slate-300">Strength scoring prioritizes arguments</li>
        <li class="text-slate-300">Counter-argument prep strengthens cases</li>
      </ul>
        </div>
