...
export const metadata: Metadata = {
  ...
  keywords: 'M365 or Google Workspace architecture design, Migration from on-prem or competitor platforms, Governance and lifecycle management, Security configuration (DLP, IRM, eDiscovery), Teams/SharePoint/Drive structure design, Adoption training and change management, Ongoing optimization and support, it, Communication, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Enterprise Collaboration Platform Setup</h1>
        <p className="text-lg text-slate-300 mb-8">Design, deploy, and manage Microsoft 365 or Google Workspace with governance, security, migration, and adoption training. Maximize ROI on your collaboration investment.</p>
        ...
        <li class="text-slate-300">M365 or Google Workspace architecture design</li>
        <li class="text-slate-300">Migration from on-prem or competitor platforms</li>
        <li class="text-slate-300">Governance and lifecycle management</li>
        <li class="text-slate-300">Security configuration (DLP, IRM, eDiscovery)</li>
        <li class="text-slate-300">Teams/SharePoint/Drive structure design</li>
        <li class="text-slate-300">Adoption training and change management</li>
        <li class="text-slate-300">Ongoing optimization and support</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Maximize ROI on collaboration investment</li>
        <li class="text-slate-300">Governance prevents sprawl and data leaks</li>
        <li class="text-slate-300">Migration with zero data loss</li>
        <li class="text-slate-300">Adoption training ensures user buy-in</li>
      </ul>
        </div>
