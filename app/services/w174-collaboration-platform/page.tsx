...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{'@context': 'https://schema.org', '@type': 'Service', 'name': 'Enterprise Collaboration Platform Setup', 'description': 'Design, deploy, and manage Microsoft 365 or Google Workspace with governance, security, migration, and adoption training. Maximize ROI on your collaboration investment.', 'serviceType': 'it', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'Communication'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'Enterprise Collaboration Platform Setup Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$2,999', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$9,999', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': 'Custom', 'priceCurrency': 'USD'}]}} }/>
    <JsonLd data={{'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'M365 or Google Workspace architecture design', 'acceptedAnswer': {'@type': 'Answer', 'text': 'M365 or Google Workspace architecture design'}}, {'@type': 'Question', 'name': 'Migration from on-prem or competitor platforms', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Migration from on-prem or competitor platforms'}}, {'@type': 'Question', 'name': 'Governance and lifecycle management', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Governance and lifecycle management'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Maximize ROI on collaboration investment; Governance prevents sprawl and data leaks; Migration with zero data loss'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} }/>
