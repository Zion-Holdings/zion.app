      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in retail with Analyzer AI - Retail. This AI-powered platform transforms root cause analysis into a competitive advantage.
          </p>
