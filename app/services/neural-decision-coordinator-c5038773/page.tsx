...
export const metadata: Metadata = {
  title: 'Neural Decision Coordinator',
  description: 'Revolutionize technology through intelligent automation. Our Neural Decision Coordinator leverages advanced machine learning to deliver threat detection at scal',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Decision Coordinator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our Neural Decision Coordinator leverages advanced machine learning to deliver threat detection at scale.
          </p>
