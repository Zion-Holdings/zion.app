...
export const metadata: Metadata = {
  title: 'Autonomous Lead System - Insurance',
  description: 'Enhance your insurance business with Autonomous Lead System - Insurance. Our solution provides sales process optimization with enterprise-grade reliability and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-lead-system-insurance-93a916e4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Lead System - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Autonomous Lead System - Insurance. Our solution provides sales process optimization with enterprise-grade reliability and security.
          </p>
