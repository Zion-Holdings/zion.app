...
export const metadata: Metadata = {
  title: 'AI-Powered automation-retail',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with AI-Powered automation-retail. Powered by cutting-edge AI, this platform delivers decision support like never before.
          </p>
