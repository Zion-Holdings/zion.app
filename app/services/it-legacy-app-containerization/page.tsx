...
export const metadata: Metadata = {
  ...
  keywords: 'Automated dependency mapping, Service extraction recommendations, StatefulSet migration, Database connection pooling, Blue-green deployment, it, General, Zion Tech Group',
  alternates: {
    canonical: `https://ziontechgroup.com/services/it-legacy-app-containerization/`,
  },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Legacy App Containerization</h1>
        <p className="text-lg text-slate-300 mb-8">Migrate monoliths and legacy apps to Docker/Kubernetes with minimal code changes. Automated dependency analysis and service extraction.</p>
        ...
        <li class="text-slate-300">Automated dependency mapping</li>
        <li class="text-slate-300">Service extraction recommendations</li>
        <li class="text-slate-300">StatefulSet migration</li>
        <li class="text-slate-300">Database connection pooling</li>
        <li class="text-slate-300">Blue-green deployment</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with legacy app containerization</li>
