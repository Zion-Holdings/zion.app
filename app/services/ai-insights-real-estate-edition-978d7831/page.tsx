...
export const metadata: Metadata = {
  title: 'AI Insights - Real-Estate Edition',
  description: 'Drive innovation in real-estate with AI Insights - Real-Estate Edition. This AI-powered platform transforms supply chain into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-insights-real-estate-edition-978d7831',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Insights - Real-Estate Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in real-estate with AI Insights - Real-Estate Edition. This AI-powered platform transforms supply chain into a competitive advantage.
          </p>
