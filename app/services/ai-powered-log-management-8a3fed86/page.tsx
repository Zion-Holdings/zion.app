...
export const metadata: Metadata = {
  title: "AI-Powered Log Management - AI-Powered DevOps Solution",
  description: "Centralized log management with AI-powered analysis and alerting.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-log-management-8a3fed86",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Log Management - AI-Powered DevOps Solution
        </h1>
