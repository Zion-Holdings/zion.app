...
export const metadata: Metadata = {
  title: 'AI-Powered sales-tech',
  description: 'Enhance your technology business with AI-Powered sales-tech. Our solution provides logistics route optimization with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-sales-tech-faeddea9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered sales-tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your technology business with AI-Powered sales-tech. Our solution provides logistics route optimization with enterprise-grade reliability and security.
          </p>
