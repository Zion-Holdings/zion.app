...
export const metadata: Metadata = {
  title: 'Quantum CDN for Hospitality',
  description: 'Enhance your hospitality business with Quantum CDN for Hospitality. Our solution provides content moderation with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-cdn-for-hospitality-d7dfa8cd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum CDN for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Quantum CDN for Hospitality. Our solution provides content moderation with enterprise-grade reliability and security.
          </p>
