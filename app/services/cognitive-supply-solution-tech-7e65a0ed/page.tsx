...
export const metadata: Metadata = {
  title: 'Cognitive Supply Solution - Tech',
  description: 'The future of technology is here with Cognitive Supply Solution - Tech. Powered by cutting-edge AI, this platform delivers procurement automation like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-supply-solution-tech-7e65a0ed',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Supply Solution - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of technology is here with Cognitive Supply Solution - Tech. Powered by cutting-edge AI, this platform delivers procurement automation like never before.
          </p>
