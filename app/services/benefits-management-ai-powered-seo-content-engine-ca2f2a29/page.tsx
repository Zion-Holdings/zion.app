...
export const metadata: Metadata = {
  title: 'Benefits Management AI-Powered SEO Content Engine',
  description: 'benefits management solution for seaports industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing copy.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/benefits-management-ai-powered-seo-content-engine-ca2f2a29',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Benefits Management AI-Powered SEO Content Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            benefits management solution for seaports industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing copy.
          </p>
