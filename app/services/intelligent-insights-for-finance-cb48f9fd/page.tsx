...
export const metadata: Metadata = {
  ...
  description: 'Optimize your finance workflows with Intelligent Insights for Finance. This intelligent platform delivers container orchestration through advanced automation an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your finance workflows with Intelligent Insights for Finance. This intelligent platform delivers container orchestration through advanced automation and AI.
          </p>
