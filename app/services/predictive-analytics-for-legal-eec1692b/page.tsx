...
export const metadata: Metadata = {
  title: 'Predictive Analytics for Legal',
  description: 'Next-generation legal solution: Predictive Analytics for Legal. Combines workflow management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-analytics-for-legal-eec1692b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Analytics for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Predictive Analytics for Legal. Combines workflow management with adaptive intelligence for optimal results.
          </p>
