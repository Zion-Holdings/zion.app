...
export const metadata: Metadata = {
  title: 'Smart Compliance Platform - Insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Compliance Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Smart Compliance Platform - Insurance. Combines inventory management with adaptive intelligence for optimal results.
          </p>
