...
export const metadata: Metadata = {
  title: 'Smart Performance Platform - CLEANTECH',
  description: 'Transform your cleantech operations with our Smart Performance Platform - CLEANTECH. This AI-driven solution automates budget management with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-performance-platform-cleantech-c71e5296',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Performance Platform - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your cleantech operations with our Smart Performance Platform - CLEANTECH. This AI-driven solution automates budget management with unprecedented accuracy and efficiency.
          </p>
