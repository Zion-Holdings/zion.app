...
export const metadata: Metadata = {
  title: 'Cognitive Invoice Real Estate',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Invoice Real Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Cognitive Invoice Real Estate. This intelligent platform delivers process discovery through advanced automation and AI.
          </p>
