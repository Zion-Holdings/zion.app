...
export const metadata: Metadata = {
  title: 'Cognitive NLP Solution - Construction',
  description: 'Optimize your construction workflows with Cognitive NLP Solution - Construction. This intelligent platform delivers expense management through advanced automati',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-nlp-solution-construction-3525a56c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive NLP Solution - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Cognitive NLP Solution - Construction. This intelligent platform delivers expense management through advanced automation and AI.
          </p>
