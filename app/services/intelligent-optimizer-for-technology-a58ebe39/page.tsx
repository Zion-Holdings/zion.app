...
export const metadata: Metadata = {
  title: 'Intelligent Optimizer for Technology',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Optimizer for Technology
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our Intelligent Optimizer for Technology leverages advanced machine learning to deliver sales process optimization at scale.
          </p>
