...
export const metadata: Metadata = {
  title: 'Smart Smart Platform - Manufacturing',
  description: 'Enhance your manufacturing business with Smart Smart Platform - Manufacturing. Our solution provides document processing with enterprise-grade reliability and s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-smart-platform-manufacturing-3b7fc969',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Smart Platform - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your manufacturing business with Smart Smart Platform - Manufacturing. Our solution provides document processing with enterprise-grade reliability and security.
          </p>
