...
export const metadata: Metadata = {
  title: 'Smart Intelligence Platform - Logistics #1',
  description: 'Transform your logistics operations with our Smart Intelligence Platform - Logistics #1. This AI-driven solution automates personalization engine with unprecede',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-intelligence-platform-logistics-1-6fd07fea',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Intelligence Platform - Logistics #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Smart Intelligence Platform - Logistics #1. This AI-driven solution automates personalization engine with unprecedented accuracy and efficiency.
          </p>
