...
export const metadata: Metadata = {
  ...
  keywords: 'PST import and export, Journal archive migration, Cross-platform migration (Exchange, Google, Zoho), Compliance retention policy enforcement, eDiscovery search and export, Deduplication and compression, Integration with Mimecast, Proofpoint, Barracuda, it, Data Management, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Email Archive and Migration</h1>
        <p className="text-lg text-slate-300 mb-8">Email archive and migration: PST import, journal archive, cross-platform migration, compliance retention.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">it</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">Data Management</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">PST import and export</li>
        <li class="text-slate-300">Journal archive migration</li>
        <li class="text-slate-300">Cross-platform migration (Exchange</li>
        <li class="text-slate-300">Google</li>
        <li class="text-slate-300">Zoho)</li>
        <li class="text-slate-300">Compliance retention policy enforcement</li>
        <li class="text-slate-300">eDiscovery search and export</li>
        <li class="text-slate-300">Deduplication and compression</li>
        <li class="text-slate-300">Integration with Mimecast</li>
        <li class="text-slate-300">Proofpoint</li>
        <li class="text-slate-300">Barracuda</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Migrate email without data loss</li>
        <li class="text-slate-300">Compliance retention enforced automatically</li>
        <li class="text-slate-300">eDiscovery search for legal holds</li>
        <li class="text-slate-300">Deduplication reduces storage costs</li>
      </ul>
        </div>
