...
export const metadata: Metadata = {
  ...
  keywords: 'Identity-verified every request, Continuous risk evaluation, Least-privilege micro-perimeters, Device posture checking, Full access audit log, security, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Zero Trust Access Gateway</h1>
        <p className="text-lg text-slate-300 mb-8">Replace traditional VPN with continuous identity-verified access — least-privilege, device-aware, audit-logged connections to every app for hybrid and remote-first enterprises.</p>
        ...
        <li class="text-slate-300">Identity-verified every request</li>
        <li class="text-slate-300">Continuous risk evaluation</li>
        <li class="text-slate-300">Least-privilege micro-perimeters</li>
        <li class="text-slate-300">Device posture checking</li>
        <li class="text-slate-300">Full access audit log</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with zero trust access gateway</li>
