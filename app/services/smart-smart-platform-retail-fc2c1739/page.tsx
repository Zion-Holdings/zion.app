...
export const metadata: Metadata = {
  title: 'Smart Smart Platform - Retail',
  description: 'Next-generation retail solution: Smart Smart Platform - Retail. Combines customer journey mapping with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-smart-platform-retail-fc2c1739',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Smart Platform - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation retail solution: Smart Smart Platform - Retail. Combines customer journey mapping with adaptive intelligence for optimal results.
          </p>
