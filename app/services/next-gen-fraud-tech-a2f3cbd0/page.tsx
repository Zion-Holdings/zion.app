...
export const metadata: Metadata = {
  title: 'Next-Gen Fraud - Tech',
  description: 'The future of technology is here with Next-Gen Fraud - Tech. Powered by cutting-edge AI, this platform delivers net promoter score like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-fraud-tech-a2f3cbd0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of technology is here with Next-Gen Fraud - Tech. Powered by cutting-edge AI, this platform delivers net promoter score like never before.
          </p>
