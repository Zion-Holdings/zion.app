...
export const metadata: Metadata = {
  ...
  description: 'Transform your legal operations with our Cognitive Director System. This security solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-director-system-11f762',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Cognitive Director System. This security solution delivers unprecedented automation and intelligence.
          </p>
