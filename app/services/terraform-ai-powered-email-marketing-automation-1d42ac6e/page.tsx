...
export const metadata: Metadata = {
  title: 'Terraform AI-Powered Email Marketing Automation',
  description: 'AI-powered terraform solution for marketing. Automated email campaigns with dynamic content and A/B testing.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/terraform-ai-powered-email-marketing-automation-1d42ac6e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Terraform AI-Powered Email Marketing Automation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered terraform solution for marketing. Automated email campaigns with dynamic content and A/B testing.
          </p>
