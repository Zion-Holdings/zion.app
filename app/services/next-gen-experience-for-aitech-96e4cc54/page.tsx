...
export const metadata: Metadata = {
  title: 'Next-Gen Experience for AITECH',
  description: 'Transform your aitech operations with our Next-Gen Experience for AITECH. This AI-driven solution automates data fabric with unprecedented accuracy and efficien',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-experience-for-aitech-96e4cc54',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Experience for AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your aitech operations with our Next-Gen Experience for AITECH. This AI-driven solution automates data fabric with unprecedented accuracy and efficiency.
          </p>
