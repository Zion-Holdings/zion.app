...
export const metadata: Metadata = {
  title: 'Intelligence Automated - Healthcare',
  description: 'Enhance your healthcare business with Intelligence Automated - Healthcare. Our solution provides automation opportunity with enterprise-grade reliability and se',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligence-automated-healthcare-83c02a67',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligence Automated - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with Intelligence Automated - Healthcare. Our solution provides automation opportunity with enterprise-grade reliability and security.
          </p>
