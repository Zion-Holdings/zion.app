  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Social Engineering Risk Estimator</h1>
        <p className="text-lg text-gray-300 mb-8">Estimates phishing and social engineering risk from email patterns, click behavior, and awareness training signals.</p>
