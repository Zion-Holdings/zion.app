...
export const metadata: Metadata = {
  title: 'Cognitive AI Solution - Insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive AI Solution - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Cognitive AI Solution - Insurance. Our solution provides disaster recovery with enterprise-grade reliability and security.
          </p>
