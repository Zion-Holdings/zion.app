...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Strategic - Hospitality',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Strategic - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for hospitality: Hyper-Accelerated Strategic - Hospitality. Uses quantum-inspired algorithms to deliver cost tracking at exponential speed.
          </p>
