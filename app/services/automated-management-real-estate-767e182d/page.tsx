...
export const metadata: Metadata = {
  title: 'Automated management-real-estate',
  description: 'Revolutionize real-estate through intelligent automation. Our Automated management-real-estate leverages advanced machine learning to deliver customer insights ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-management-real-estate-767e182d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated management-real-estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our Automated management-real-estate leverages advanced machine learning to deliver customer insights at scale.
          </p>
