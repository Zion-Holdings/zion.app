      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Automated content review for user-generated platforms — detect spam, harassment, and policy violations across text, image, and video.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Multi-modal content analysis</li>
            <li className="text-purple-300">✓ Custom policy rule engine</li>
            <li className="text-purple-300">✓ Real-time moderation workflows</li>
            <li className="text-purple-300">✓ Appeal and escalation handling</li>
            <li className="text-purple-300">✓ Compliance audit logging</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai content moderation platform</li>
