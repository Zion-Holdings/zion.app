...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-modal content analysis, Custom policy rule engine, Real-time moderation workflows, Appeal and escalation handling, Compliance audit logging, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Automated content review for user-generated platforms — detect spam, harassment, and policy violations across text, image, and video.</p>
        ...
        <li class="text-slate-300">Multi-modal content analysis</li>
        <li class="text-slate-300">Custom policy rule engine</li>
        <li class="text-slate-300">Real-time moderation workflows</li>
        <li class="text-slate-300">Appeal and escalation handling</li>
        <li class="text-slate-300">Compliance audit logging</li>
      </ul>
        </div>
