...
export const metadata: Metadata = {
  title: 'Smart Reputation Business Intelligence',
  description: 'Transform your transportation operations with our Smart Reputation Business Intelligence. This AI-driven solution automates hr analytics with unprecedented accu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Reputation Business Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your transportation operations with our Smart Reputation Business Intelligence. This AI-driven solution automates hr analytics with unprecedented accuracy and efficiency.
          </p>
