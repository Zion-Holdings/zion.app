...
export const metadata: Metadata = {
  title: 'Headless Commerce AI-Powered Cloud Governance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Headless Commerce AI-Powered Cloud Governance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered headless commerce solution for cloud governance. Automated cloud governance with policy enforcement and resource control.
          </p>
