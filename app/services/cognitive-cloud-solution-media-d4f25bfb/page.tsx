...
export const metadata: Metadata = {
  ...
  description: 'The future of media is here with Cognitive Cloud Solution - Media. Powered by cutting-edge AI, this platform delivers sales forecasting like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-cloud-solution-media-d4f25bfb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of media is here with Cognitive Cloud Solution - Media. Powered by cutting-edge AI, this platform delivers sales forecasting like never before.
          </p>
