...
export const metadata: Metadata = {
  title: 'Intelligent Intelligence for Hospitality',
  description: 'Unlock unprecedented growth with Intelligent Intelligence for Hospitality. This autonomous system provides training optimization with zero manual intervention n',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-intelligence-for-hospitality-10ac6fea',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Intelligence for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Intelligence for Hospitality. This autonomous system provides training optimization with zero manual intervention needed.
          </p>
