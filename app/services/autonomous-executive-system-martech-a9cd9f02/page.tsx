...
export const metadata: Metadata = {
  title: 'Autonomous Executive System - MARTECH',
  description: 'Next-generation martech solution: Autonomous Executive System - MARTECH. Combines data quality with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-executive-system-martech-a9cd9f02',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Executive System - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation martech solution: Autonomous Executive System - MARTECH. Combines data quality with adaptive intelligence for optimal results.
          </p>
