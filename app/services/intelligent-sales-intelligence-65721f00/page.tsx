...
export const metadata: Metadata = {
  title: 'Intelligent Sales Intelligence',
  description: 'Revolutionize energy through intelligent automation. Our Intelligent Sales Intelligence leverages advanced machine learning to deliver predictive analytics at s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Sales Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Intelligent Sales Intelligence leverages advanced machine learning to deliver predictive analytics at scale.
          </p>
