...
export const metadata: Metadata = {
  title: 'Public Sector AI-Powered HR Analytics',
  description: 'AI-powered public sector solution for hr. Predictive analytics for employee performance, retention, and recruitment.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/public-sector-ai-powered-hr-analytics-fcb2de4d',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Public Sector AI-Powered HR Analytics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered public sector solution for hr. Predictive analytics for employee performance, retention, and recruitment.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your public sector operations?</p>
