...
export const metadata: Metadata = {
  ...
  keywords: 'Natural language to UI component generation, Multi-framework support (React, Vue, Angular), Tailwind CSS output with custom themes, Figma plugin for bidirectional sync, Design system consistency enforcement, Accessibility compliance auto-check, Responsive layout generation, Component variant generation, ai, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Generative UI Design Studio</h1>
        <p className="text-lg text-slate-300 mb-8">Generate production-ready UI components and full page layouts from natural language descriptions. Supports React, Vue, and Angular output with Tailwind CSS styling. Integrates with Figma for seamless designer-developer handoff.</p>
        ...
        <li class="text-slate-300">Natural language to UI component generation</li>
        <li class="text-slate-300">Multi-framework support (React, Vue, Angular)</li>
        <li class="text-slate-300">Tailwind CSS output with custom themes</li>
        <li class="text-slate-300">Figma plugin for bidirectional sync</li>
        <li class="text-slate-300">Design system consistency enforcement</li>
        <li class="text-slate-300">Accessibility compliance auto-check</li>
        <li class="text-slate-300">Responsive layout generation</li>
        <li class="text-slate-300">Component variant generation</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">10x faster UI prototyping</li>
        <li class="text-slate-300">Consistent design system adherence</li>
        <li class="text-slate-300">Reduced designer-developer handoff time</li>
        <li class="text-slate-300">Auto-accessible components</li>
      </ul>
        </div>
