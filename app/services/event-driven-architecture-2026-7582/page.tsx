...
export const metadata = {
  ...
  alternates: { canonical: '/services/event-driven-architecture-2026-7582/' },

  openGraph: {
    title: 'Event Driven Architecture | Zion Tech Group',
    description: 'End-to-end event driven architecture services: assessment, deployment, and managed operations.',
    url: 'https://ziontechgroup.com/services/event-driven-architecture-2026-7582/',
    siteName: 'Zion Tech Group',
    type: 'website',
    images: ['/og-default.png'],
  },
  twitter: { card: 'summary_large_image', title: 'Event Driven Architecture | Zion Tech Group', description: 'End-to-end event driven architecture services: assessment, deployment, and managed operations.' }};

export default function ServicePage() {
  return (
    <main className="min-h-screen bg-slate-950 py-20">

    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "Event Driven Architecture | Zion Tech Group", description: "End-to-end event driven architecture services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/event-driven-architecture-2026-7582/"}} />
      <div className="container-page">
        ...
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end event driven architecture services: assessment, deployment, and managed operations.
        </p>
