...
export const metadata: Metadata = {
  title: 'Intelligent Finance for Proptech',
  description: 'The future of proptech is here with Intelligent Finance for Proptech. Powered by cutting-edge AI, this platform delivers market intelligence like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-finance-for-proptech-855f2563',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Finance for Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with Intelligent Finance for Proptech. Powered by cutting-edge AI, this platform delivers market intelligence like never before.
          </p>
