...
export const metadata: Metadata = {
  title: 'Quantum Support - Construction Quantum',
  description: 'Enhance your construction business with Quantum Support - Construction Quantum. Our solution provides threat detection with enterprise-grade reliability and sec',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-support-construction-quantum-d195adf2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Support - Construction Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Quantum Support - Construction Quantum. Our solution provides threat detection with enterprise-grade reliability and security.
          </p>
