...
export const metadata: Metadata = {
  ...
  keywords: 'Intelligent automation and orchestration, Enterprise-grade integration, Real-time monitoring and alerts, Scalable multi-tenant architecture, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Invoice Processing &amp; Auto-Posting</h1>
        <p className="text-lg text-slate-300 mb-8">Invoice automation: three-way PO matching, OCR line-item extraction, GL coding by vendor and line item, approval workflow per threshold, and ERP auto-post to NetSuite, SAP, or QuickBooks with zero human touch.</p>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai invoice processing &amp; auto-posting</li>
