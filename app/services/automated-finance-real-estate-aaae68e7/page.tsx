...
export const metadata: Metadata = {
  title: 'Automated finance-real-estate',
  description: 'Revolutionize real-estate through intelligent automation. Our Automated finance-real-estate leverages advanced machine learning to deliver executive dashboards ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-finance-real-estate-aaae68e7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated finance-real-estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our Automated finance-real-estate leverages advanced machine learning to deliver executive dashboards at scale.
          </p>
