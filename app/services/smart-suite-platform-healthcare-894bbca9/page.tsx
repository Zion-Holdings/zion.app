...
export const metadata: Metadata = {
  title: 'Smart Suite Platform - Healthcare',
  description: 'The future of healthcare is here with Smart Suite Platform - Healthcare. Powered by cutting-edge AI, this platform delivers churn prediction like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-suite-platform-healthcare-894bbca9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Suite Platform - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Smart Suite Platform - Healthcare. Powered by cutting-edge AI, this platform delivers churn prediction like never before.
          </p>
