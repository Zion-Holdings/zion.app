...
export const metadata: Metadata = {
  ...
  keywords: 'AI customer health scoring, Churn risk prediction and alerting, Expansion and upsell opportunity detection, Automated playbooks and outreach sequences, Renewal forecasting and management, Product usage analytics and adoption scoring, Integration with Salesforce, Gainsight, Totango, automation, Customer Success, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Customer Success Platform</h1>
        <p className="text-lg text-slate-300 mb-8">AI-driven customer success: health scoring, churn prediction, expansion opportunity detection, and playbooks. Proactive retention instead of reactive support.</p>
        ...
        <li class="text-slate-300">AI customer health scoring</li>
        <li class="text-slate-300">Churn risk prediction and alerting</li>
        <li class="text-slate-300">Expansion and upsell opportunity detection</li>
        <li class="text-slate-300">Automated playbooks and outreach sequences</li>
        <li class="text-slate-300">Renewal forecasting and management</li>
        <li class="text-slate-300">Product usage analytics and adoption scoring</li>
        <li class="text-slate-300">Integration with Salesforce, Gainsight, Totango</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Proactive retention reduces churn 25%</li>
        <li class="text-slate-300">Health scoring identifies at-risk accounts early</li>
        <li class="text-slate-300">Expansion opportunities drive revenue growth</li>
        <li class="text-slate-300">Automated playbooks scale CS team efficiency</li>
      </ul>
        </div>
