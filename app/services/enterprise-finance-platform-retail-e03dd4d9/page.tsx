...
export const metadata: Metadata = {
  title: 'Enterprise Finance Platform - Retail',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Finance Platform - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your retail business with Enterprise Finance Platform - Retail. Our solution provides audit automation with enterprise-grade reliability and security.
          </p>
