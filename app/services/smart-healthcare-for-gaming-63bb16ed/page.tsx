...
export const metadata: Metadata = {
  title: 'Smart Healthcare for Gaming',
  description: 'Revolutionize gaming through intelligent automation. Our Smart Healthcare for Gaming leverages advanced machine learning to deliver customer insights at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-healthcare-for-gaming-63bb16ed',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Healthcare for Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize gaming through intelligent automation. Our Smart Healthcare for Gaming leverages advanced machine learning to deliver customer insights at scale.
          </p>
