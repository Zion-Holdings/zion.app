...
export const metadata: Metadata = {
  title: 'Cognitive Insights Solution - Hospitality',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Insights Solution - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Cognitive Insights Solution - Hospitality. This AI-powered platform transforms task mining into a competitive advantage.
          </p>
