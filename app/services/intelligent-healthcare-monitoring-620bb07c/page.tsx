...
export const metadata: Metadata = {
  title: 'Intelligent Healthcare Monitoring',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with Intelligent Healthcare Monitoring. Powered by cutting-edge AI, this platform delivers quality control like never before.
          </p>
