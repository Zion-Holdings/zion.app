...
export const metadata: Metadata = {
  title: 'In-Vehicle Cockpit AI Safety Layer',
  description: 'AI safety monitoring for vehicle cockpits with attention and drowsiness detection.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/in-vehicle-cockpit-ai-safety-layer-e6f83564',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            In-Vehicle Cockpit AI Safety Layer
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI safety monitoring for vehicle cockpits with attention and drowsiness detection.
          </p>
