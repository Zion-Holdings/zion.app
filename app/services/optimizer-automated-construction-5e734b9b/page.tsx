...
export const metadata: Metadata = {
  title: 'Optimizer Automated - Construction',
  description: 'Revolutionize construction through intelligent automation. Our Optimizer Automated - Construction leverages advanced machine learning to deliver campaign optimi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/optimizer-automated-construction-5e734b9b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Optimizer Automated - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Optimizer Automated - Construction leverages advanced machine learning to deliver campaign optimization at scale.
          </p>
