...
export const metadata: Metadata = {
  title: 'AI-Driven Cloud for Logistics',
  description: 'Transform your logistics operations with our AI-Driven Cloud for Logistics. This AI-driven solution automates influencer identification with unprecedented accur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-driven-cloud-for-logistics-63aa0cfe',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Driven Cloud for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our AI-Driven Cloud for Logistics. This AI-driven solution automates influencer identification with unprecedented accuracy and efficiency.
          </p>
