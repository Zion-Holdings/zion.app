...
export const metadata: Metadata = {
  ...
  keywords: 'Scope 1/2/3 carbon tracking, Supplier ESG scoring, Circular economy optimization, Sustainability reporting (GRI, CDP), Integration with procurement systems, What-if scenario modeling, Benchmarking, Regulatory compliance, ai, Supply Chain, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Supply Chain Sustainability Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Measure, monitor, and improve supply chain sustainability. Carbon footprint tracking, supplier ESG scoring, and circular economy optimization.</p>
        ...
        <li class="text-slate-300">Scope 1/2/3 carbon tracking</li>
        <li class="text-slate-300">Supplier ESG scoring</li>
        <li class="text-slate-300">Circular economy optimization</li>
        <li class="text-slate-300">Sustainability reporting (GRI, CDP)</li>
        <li class="text-slate-300">Integration with procurement systems</li>
        <li class="text-slate-300">What-if scenario modeling</li>
        <li class="text-slate-300">Benchmarking</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Meet ESG requirements</li>
        <li class="text-slate-300">Reduce carbon footprint</li>
        <li class="text-slate-300">Optimize sustainable sourcing</li>
        <li class="text-slate-300">Improve brand reputation</li>
      </ul>
        </div>
