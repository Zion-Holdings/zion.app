...
export const metadata: Metadata = {
  title: 'Autonomous Project Finance',
  description: 'Enhance your finance business with Autonomous Project Finance. Our solution provides anomaly detection with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-project-finance-4787f659',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Project Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your finance business with Autonomous Project Finance. Our solution provides anomaly detection with enterprise-grade reliability and security.
          </p>
