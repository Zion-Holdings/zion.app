...
export const metadata: Metadata = {
  title: 'Intelligent Engine for Hospitality #1',
  description: 'Next-generation hospitality solution: Intelligent Engine for Hospitality #1. Combines testing automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-engine-for-hospitality-1-5cb6e329',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Engine for Hospitality #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Intelligent Engine for Hospitality #1. Combines testing automation with adaptive intelligence for optimal results.
          </p>
