...
export const metadata: Metadata = {
  title: 'Smart optimization-iot',
  description: 'Transform your iot operations with our Smart optimization-iot. This AI-driven solution automates energy management with unprecedented accuracy and efficiency.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-optimization-iot-79bd1178',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart optimization-iot
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your iot operations with our Smart optimization-iot. This AI-driven solution automates energy management with unprecedented accuracy and efficiency.
          </p>
