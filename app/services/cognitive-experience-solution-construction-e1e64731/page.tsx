...
export const metadata: Metadata = {
  title: 'Cognitive Experience Solution - Construction',
  description: 'Revolutionize construction through intelligent automation. Our Cognitive Experience Solution - Construction leverages advanced machine learning to deliver decis',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-experience-solution-construction-e1e64731',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Experience Solution - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Cognitive Experience Solution - Construction leverages advanced machine learning to deliver decision support at scale.
          </p>
