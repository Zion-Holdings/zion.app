...
export const metadata = {
  ...
  description: "Fully white-label helpdesk solution for agencies and SaaS companies. Multi-brand support, AI-powered ticket routing, canned responses, and SLA management. Custo",
  alternates: {
