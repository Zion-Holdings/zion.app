...
export const metadata: Metadata = {
  title: 'Autonomous Marketing for Telecom',
  description: 'Enhance your telecom business with Autonomous Marketing for Telecom. Our solution provides risk assessment with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-marketing-for-telecom-18f9e43c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Marketing for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your telecom business with Autonomous Marketing for Telecom. Our solution provides risk assessment with enterprise-grade reliability and security.
          </p>
