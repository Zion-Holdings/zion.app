export const metadata = {
  title: "Cognitive Monitoring Solution - Sports",
  description: "Zion Tech Group delivers Cognitive Monitoring Solution - Sports with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/services/cognitive-monitoring-solution-sports-f71ad03e/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>Cognitive Monitoring Solution - Sports</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers Cognitive Monitoring Solution - Sports with measurable outcomes.
      </p>
