...
export const metadata = {
  title: "Cognitive Serverless Retail Decision Engine - Zion Tech Group",
  description: "Cognitive decision engine that processes serverless signals to drive retail strategy with deep learning.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/cognitive-serverless-retail-decision-engine-c356aeec`
  }
};
