...
export const metadata: Metadata = {
  title: 'AI/IT Predictor Suite - HEALTHTECH',
  description: 'Drive innovation in healthtech with AI/IT Predictor Suite - HEALTHTECH. This AI-powered platform transforms feedback collection into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-predictor-suite-healthtech-da4e5cb0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Predictor Suite - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthtech with AI/IT Predictor Suite - HEALTHTECH. This AI-powered platform transforms feedback collection into a competitive advantage.
          </p>
