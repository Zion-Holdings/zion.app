...
export const metadata: Metadata = {
  title: 'Autonomous Platform for Energy',
  description: 'Enhance your energy business with Autonomous Platform for Energy. Our solution provides predictive modeling with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-platform-for-energy-83b212b7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Platform for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your energy business with Autonomous Platform for Energy. Our solution provides predictive modeling with enterprise-grade reliability and security.
          </p>
