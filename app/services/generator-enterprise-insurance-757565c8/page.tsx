...
export const metadata: Metadata = {
  title: 'Generator Enterprise - Insurance',
  description: 'Next-generation insurance solution: Generator Enterprise - Insurance. Combines time tracking with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/generator-enterprise-insurance-757565c8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Generator Enterprise - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Generator Enterprise - Insurance. Combines time tracking with adaptive intelligence for optimal results.
          </p>
