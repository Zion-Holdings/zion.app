...
export const metadata: Metadata = {
  title: 'Autonomous Real Estate System - EDTECH #1',
  description: 'Revolutionize edtech through intelligent automation. Our Autonomous Real Estate System - EDTECH #1 leverages advanced machine learning to deliver customer servi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Real Estate System - EDTECH #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize edtech through intelligent automation. Our Autonomous Real Estate System - EDTECH #1 leverages advanced machine learning to deliver customer service automation at scale.
          </p>
