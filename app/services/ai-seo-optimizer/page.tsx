...
export const metadata: Metadata = {
  ...
  keywords: 'On-page SEO audit & recommendations, Automated meta title & description generation, Readability & grammar improvement, Competitor content gap analysis, Internal linking suggestions, ai, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Real-time SEO analysis and content optimization: keyword suggestions, meta tag generation, readability scoring, and content gap analysis.</p>
        ...
        <li class="text-slate-300">On-page SEO audit &amp; recommendations</li>
        <li class="text-slate-300">Automated meta title &amp; description generation</li>
        <li class="text-slate-300">Readability &amp; grammar improvement</li>
        <li class="text-slate-300">Competitor content gap analysis</li>
        <li class="text-slate-300">Internal linking suggestions</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai seo content optimizer</li>
