...
export const metadata: Metadata = {
  title: "Accounting AI-Powered Customer Churn Prevention - AI-Powered Accounting Solution",
  description: "AI-powered accounting solution for saas. Identifies at-risk customers and triggers retention workflows automatically.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/accounting-ai-powered-customer-churn-prevention-0754324d",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Accounting AI-Powered Customer Churn Prevention - AI-Powered Accounting Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          AI-powered accounting solution for saas. Identifies at-risk customers and triggers retention workflows automatically.
        </p>
