...
export const metadata: Metadata = {
  title: 'Smart Data Platform - Legal',
  description: 'Drive innovation in legal with Smart Data Platform - Legal. This AI-powered platform transforms market intelligence into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-data-platform-legal-3dfd70ff',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Data Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Smart Data Platform - Legal. This AI-powered platform transforms market intelligence into a competitive advantage.
          </p>
