...
export const metadata: Metadata = {
  title: 'Autonomous Supply System - Hospitality',
  description: 'Drive innovation in hospitality with Autonomous Supply System - Hospitality. This AI-powered platform transforms logistics route optimization into a competitive',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-supply-system-hospitality-5a633cfd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Supply System - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Autonomous Supply System - Hospitality. This AI-powered platform transforms logistics route optimization into a competitive advantage.
          </p>
