...
export const metadata: Metadata = {
  ...
  description: 'Accelerates drug discovery by predicting molecular properties and binding affinity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-drug-discovery-accelerator-e38332df',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Accelerates drug discovery by predicting molecular properties and binding affinity.
          </p>
