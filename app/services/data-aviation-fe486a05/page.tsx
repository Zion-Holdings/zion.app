...
export const metadata: Metadata = {
  title: 'Aviation Data Platform #21',
  description: 'AI-powered aviation solution for data. Provides enterprise-grade automation and optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-aviation-fe486a05',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Aviation Data Platform #21
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered aviation solution for data. Provides enterprise-grade automation and optimization.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Data pipeline automation</li>
