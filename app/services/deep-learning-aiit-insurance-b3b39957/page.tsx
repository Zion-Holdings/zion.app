...
export const metadata: Metadata = {
  title: 'Deep Learning AI/IT - Insurance',
  description: 'Optimize your insurance workflows with Deep Learning AI/IT - Insurance. This intelligent platform delivers pipeline management through advanced automation and A',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/deep-learning-aiit-insurance-b3b39957',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Deep Learning AI/IT - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Deep Learning AI/IT - Insurance. This intelligent platform delivers pipeline management through advanced automation and AI.
          </p>
