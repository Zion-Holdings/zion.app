...
export const metadata: Metadata = {
  ...
  description: 'The future of education is here with Predictive Predictor Engine - Education. Powered by cutting-edge AI, this platform delivers predictive analytics like never',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of education is here with Predictive Predictor Engine - Education. Powered by cutting-edge AI, this platform delivers predictive analytics like never before.
          </p>
