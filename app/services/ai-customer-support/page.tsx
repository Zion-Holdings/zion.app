      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            24/7 AI-powered customer service with intelligent ticket routing, auto-resolution, and sentiment analysis.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ AI chatbot with human handoff</li>
            <li className="text-purple-300">✓ Smart ticket routing & prioritization</li>
            <li className="text-purple-300">✓ Sentiment analysis & escalation</li>
            <li className="text-purple-300">✓ Knowledge base auto-sync</li>
            <li className="text-purple-300">✓ Multi-channel support (email, chat, social)</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai customer support</li>
