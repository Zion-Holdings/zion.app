...
export const metadata: Metadata = {
  title: 'Enterprise Director Platform - HEALTHTECH',
  description: 'The future of healthtech is here with Enterprise Director Platform - HEALTHTECH. Powered by cutting-edge AI, this platform delivers risk management like never b',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Director Platform - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthtech is here with Enterprise Director Platform - HEALTHTECH. Powered by cutting-edge AI, this platform delivers risk management like never before.
          </p>
