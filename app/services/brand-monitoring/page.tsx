...
export const metadata: Metadata = {
  ...
  keywords: 'Global scan DNS+WHOIS+SSL 24/7, Typosquat + lookalike domain detection, Auto-takedown to registrars + DNS, Alert + dashboard per new domain registered, ai, E-Commerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Brand Monitoring &amp; Fake Domain Detection</h1>
        <p className="text-lg text-slate-300 mb-8">Scans global DNS+WHOIS+SSL cert feeds 24/7 for lookalike typosquatting phishing domains targeting your brand. Auto-generates registrar takedown request sent to DNS provider.</p>
        ...
        <li class="text-slate-300">Global scan DNS+WHOIS+SSL 24/7</li>
        <li class="text-slate-300">Typosquat + lookalike domain detection</li>
        <li class="text-slate-300">Auto-takedown to registrars + DNS</li>
        <li class="text-slate-300">Alert + dashboard per new domain registered</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with brand monitoring &amp; fake domain detection</li>
