...
export const metadata: Metadata = {
  title: 'AI-Powered Capital Raising Optimization',
  description: 'Optimizes capital raising with investor targeting and deal structuring.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-capital-raising-optimization-dcc78f2e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Capital Raising Optimization
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimizes capital raising with investor targeting and deal structuring.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Investor targeting</li>
          <li className="text-gray-300">Deal structuring</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">30% better terms</li>
