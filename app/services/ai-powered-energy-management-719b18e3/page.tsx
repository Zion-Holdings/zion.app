...
export const metadata: Metadata = {
  ...
  description: 'Optimizes energy consumption in manufacturing facilities using real-time data and predictive analytics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-energy-management-719b18e3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimizes energy consumption in manufacturing facilities using real-time data and predictive analytics.
          </p>
