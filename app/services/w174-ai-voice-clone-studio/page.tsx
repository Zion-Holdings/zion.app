  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Voice Clone Studio</h1>
        <p className="text-lg text-slate-300 mb-8">Professional voice cloning and text-to-speech with 30-second sample creation. 50+ languages, emotion control, and real-time streaming. Built-in consent management and watermarking.</p>
        ...
        <li class="text-slate-300">Voice cloning from 30-second audio sample</li>
        <li class="text-slate-300">50+ language support with accent control</li>
        <li class="text-slate-300">Emotion and speaking style adjustment</li>
        <li class="text-slate-300">Real-time streaming TTS (&lt; 200ms first byte)</li>
        <li class="text-slate-300">Consent and licensing management</li>
        <li class="text-slate-300">Audio watermarking for authenticity</li>
        <li class="text-slate-300">API with SSML support and pronunciation dictionaries</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Clone any voice from just 30 seconds of audio</li>
        <li class="text-slate-300">Real-time streaming for live applications</li>
        <li class="text-slate-300">Consent management ensures ethical use</li>
        <li class="text-slate-300">Watermarking prevents misuse</li>
      </ul>
        </div>
