...
export const metadata: Metadata = {
  title: 'Intelligent supply-real-estate',
  description: 'Enhance your real-estate business with Intelligent supply-real-estate. Our solution provides hr analytics with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-supply-real-estate-8fa64308',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent supply-real-estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your real-estate business with Intelligent supply-real-estate. Our solution provides hr analytics with enterprise-grade reliability and security.
          </p>
