...
export const metadata: Metadata = {
  title: 'Next-Gen Insights for Manufacturing',
  description: 'Next-generation manufacturing solution: Next-Gen Insights for Manufacturing. Combines market analysis with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-insights-for-manufacturing-64ed6aa7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Insights for Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation manufacturing solution: Next-Gen Insights for Manufacturing. Combines market analysis with adaptive intelligence for optimal results.
          </p>
