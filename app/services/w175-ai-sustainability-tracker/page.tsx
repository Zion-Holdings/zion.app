...
export const metadata: Metadata = {
  ...
  keywords: 'Scope 1/2/3 emissions calculation, Science-based target tracking (SBTi), ESG metric collection and scoring, CSRD and TCFD report generation, Supply chain carbon mapping, Carbon offset and credit management, Benchmarking vs industry peers, ai, Sustainability, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Sustainability &amp; Carbon Tracker</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered carbon accounting, ESG metrics, and sustainability reporting. Scope 1/2/3 emissions, science-based targets, and CSRD/TCFD reporting.</p>
        ...
        <li class="text-slate-300">Scope 1/2/3 emissions calculation</li>
        <li class="text-slate-300">Science-based target tracking (SBTi)</li>
        <li class="text-slate-300">ESG metric collection and scoring</li>
        <li class="text-slate-300">CSRD and TCFD report generation</li>
        <li class="text-slate-300">Supply chain carbon mapping</li>
        <li class="text-slate-300">Carbon offset and credit management</li>
        <li class="text-slate-300">Benchmarking vs industry peers</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Automated carbon accounting eliminates spreadsheets</li>
        <li class="text-slate-300">SBTi progress tracking for net-zero goals</li>
        <li class="text-slate-300">CSRD/TCFD reports generated automatically</li>
        <li class="text-slate-300">Supply chain carbon visibility</li>
      </ul>
        </div>
