...
export const metadata: Metadata = {
  ...
  description: 'Optimizes clinical trials with patient recruitment and protocol adherence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-clinical-trial-optimization-1d2f633e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimizes clinical trials with patient recruitment and protocol adherence.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Patient recruitment</li>
          <li className="text-gray-300">Protocol optimization</li>
          <li className="text-gray-300">Trial monitoring</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">50% faster trials</li>
