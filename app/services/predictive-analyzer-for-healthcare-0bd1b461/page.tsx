  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Transform your healthcare operations with our Predictive Analyzer for Healthcare. This AI-driven solution automates workflow management with unprecedented accuracy and efficiency.</p>
