...
export const metadata: Metadata = {
  title: 'Smart Deep Learning Platform - Construction #2',
  description: 'Transform your construction operations with our Smart Deep Learning Platform - Construction #2. This AI-driven solution automates root cause analysis with unpre',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Deep Learning Platform - Construction #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Smart Deep Learning Platform - Construction #2. This AI-driven solution automates root cause analysis with unprecedented accuracy and efficiency.
          </p>
