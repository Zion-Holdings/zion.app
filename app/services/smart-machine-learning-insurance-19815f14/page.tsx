...
export const metadata: Metadata = {
  title: 'Smart machine learning-insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Smart machine learning-insurance leverages advanced machine learning to deliver ml model training at',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-machine-learning-insurance-19815f14',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart machine learning-insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Smart machine learning-insurance leverages advanced machine learning to deliver ml model training at scale.
          </p>
