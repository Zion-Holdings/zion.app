...
export const metadata: Metadata = {
  title: 'AI/IT Generator Suite - Healthcare',
  description: 'Hyper-accelerated healthcare solution: AI/IT Generator Suite - Healthcare. Combines roi tracking with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-generator-suite-healthcare-a7d19ce3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Generator Suite - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated healthcare solution: AI/IT Generator Suite - Healthcare. Combines roi tracking with next-gen AI for maximum velocity.
          </p>
