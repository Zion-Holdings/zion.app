...
export const metadata: Metadata = {
  title: 'AI Insights - Education Edition',
  description: 'Enhance your education business with AI Insights - Education Edition. Our solution provides sourcing optimization with enterprise-grade reliability and security',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-insights-education-edition-25ae1d7c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Insights - Education Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your education business with AI Insights - Education Edition. Our solution provides sourcing optimization with enterprise-grade reliability and security.
          </p>
