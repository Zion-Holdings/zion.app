...
export const metadata: Metadata = {
  ...
  keywords: 'Process digital twin creation, Real-time simulation, What-if scenario analysis, Quality prediction, Energy optimization, Integration with MES/ERP, 3D visualization, Predictive analytics, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Digital Twin for Manufacturing</h1>
        <p className="text-lg text-slate-300 mb-8">Create digital twins of manufacturing processes for simulation, optimization, and predictive analytics. Reduce downtime and improve throughput.</p>
        ...
        <li class="text-slate-300">Process digital twin creation</li>
        <li class="text-slate-300">Real-time simulation</li>
        <li class="text-slate-300">What-if scenario analysis</li>
        <li class="text-slate-300">Quality prediction</li>
        ...
        <li class="text-slate-300">Predictive analytics</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Optimize production processes</li>
        <li class="text-slate-300">Reduce downtime by 30%</li>
        <li class="text-slate-300">Improve product quality</li>
        <li class="text-slate-300">Enable data-driven decisions</li>
      </ul>
        </div>
