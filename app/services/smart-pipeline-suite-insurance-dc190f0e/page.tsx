...
export const metadata: Metadata = {
  title: 'Smart Pipeline Suite - Insurance',
  description: 'Unlock unprecedented growth with Smart Pipeline Suite - Insurance. This autonomous system provides budget tracking with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-pipeline-suite-insurance-dc190f0e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Pipeline Suite - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Pipeline Suite - Insurance. This autonomous system provides budget tracking with zero manual intervention needed.
          </p>
