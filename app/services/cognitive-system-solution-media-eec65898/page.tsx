...
export const metadata: Metadata = {
  ...
  description: 'The future of media is here with Cognitive System Solution - Media. Powered by cutting-edge AI, this platform delivers logistics route optimization like never b',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-system-solution-media-eec65898',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of media is here with Cognitive System Solution - Media. Powered by cutting-edge AI, this platform delivers logistics route optimization like never before.
          </p>
