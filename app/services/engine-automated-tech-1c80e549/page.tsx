...
export const metadata: Metadata = {
  title: 'Engine Automated - Tech',
  description: 'Next-generation technology solution: Engine Automated - Tech. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/engine-automated-tech-1c80e549',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Engine Automated - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation technology solution: Engine Automated - Tech. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
