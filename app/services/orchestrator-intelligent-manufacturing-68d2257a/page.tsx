...
export const metadata: Metadata = {
  title: 'Orchestrator Intelligent - Manufacturing',
  description: 'Next-generation manufacturing solution: Orchestrator Intelligent - Manufacturing. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/orchestrator-intelligent-manufacturing-68d2257a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Orchestrator Intelligent - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation manufacturing solution: Orchestrator Intelligent - Manufacturing. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
