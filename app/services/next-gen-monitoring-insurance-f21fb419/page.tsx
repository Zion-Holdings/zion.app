...
export const metadata: Metadata = {
  title: 'Next-Gen Monitoring - Insurance',
  description: 'Optimize your insurance workflows with Next-Gen Monitoring - Insurance. This intelligent platform delivers forecast accuracy through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-monitoring-insurance-f21fb419',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Monitoring - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Next-Gen Monitoring - Insurance. This intelligent platform delivers forecast accuracy through advanced automation and AI.
          </p>
