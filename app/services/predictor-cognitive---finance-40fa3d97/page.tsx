...
export const metadata = {
  ...
  description: "Transform your finance operations with our Predictor Cognitive - Finance. This AI-driven solution automates risk assessment with unprecedented accuracy and effi",
  alternates: {
