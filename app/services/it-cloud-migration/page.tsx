...
export const metadata: Metadata = {
  ...
  keywords: 'Cloud readiness assessment and roadmap, Rehost, re-platform, refactor strategies, Database migration with zero downtime, Containerization and Kubernetes migration, Automated testing and validation, Cost optimization and FinOps, Security and compliance validation, Post-migration support and optimization, it, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Cloud Migration &amp; Modernization Factory</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end cloud migration and application modernization. Rehost, re-platform, or refactor workloads to AWS, Azure, or GCP with zero downtime and automated testing.</p>
        ...
        <li class="text-slate-300">Cloud readiness assessment and roadmap</li>
        <li class="text-slate-300">Rehost, re-platform, refactor strategies</li>
        <li class="text-slate-300">Database migration with zero downtime</li>
        <li class="text-slate-300">Containerization and Kubernetes migration</li>
        <li class="text-slate-300">Automated testing and validation</li>
        <li class="text-slate-300">Cost optimization and FinOps</li>
        <li class="text-slate-300">Security and compliance validation</li>
        <li class="text-slate-300">Post-migration support and optimization</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Migrate in half the time with automation</li>
        <li class="text-slate-300">Reduce cloud costs by 30% from day one</li>
        <li class="text-slate-300">Zero downtime during migration</li>
        <li class="text-slate-300">Modernize legacy apps for cloud-native</li>
      </ul>
        </div>
