...
export const metadata: Metadata = {
  title: 'Intelligent supply-insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent supply-insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Intelligent supply-insurance. This intelligent platform delivers loyalty optimization through advanced automation and AI.
          </p>
