...
export const metadata: Metadata = {
  title: 'Adaptive Cloud for Logistics',
  description: 'Transform your logistics operations with our Adaptive Cloud for Logistics. This AI-driven solution provides intelligent automation with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-cloud-for-logistics-aa5e15b3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Cloud for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Adaptive Cloud for Logistics. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
