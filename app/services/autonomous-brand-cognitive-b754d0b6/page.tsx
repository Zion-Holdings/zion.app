...
export const metadata: Metadata = {
  title: 'Autonomous Brand Cognitive',
  description: 'Enhance your hospitality business with Autonomous Brand Cognitive. Our solution provides personalization engine with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-brand-cognitive-b754d0b6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Brand Cognitive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Autonomous Brand Cognitive. Our solution provides personalization engine with enterprise-grade reliability and security.
          </p>
