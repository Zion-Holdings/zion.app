...
export const metadata: Metadata = {
  ...
  keywords: 'Intelligent automation and orchestration, Enterprise-grade integration, Real-time monitoring and alerts, Scalable multi-tenant architecture, security, Healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Compliance Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Compliance automation platform: maps your controls to SOC 2, ISO 27001, HIPAA, PCI-DSS, and GDPR. Auto-generates evidence, provides continuous monitoring, and produces pre-built audit reports for faster certification.</p>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with compliance automation</li>
