...
export const metadata: Metadata = {
  title: 'Cognitive Computer Vision Solution - Hospitality',
  description: 'Transform your hospitality operations with our Cognitive Computer Vision Solution - Hospitality. This AI-driven solution automates loyalty optimization with unp',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-computer-vision-solution-hospitality-db2bd391',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Computer Vision Solution - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Cognitive Computer Vision Solution - Hospitality. This AI-driven solution automates loyalty optimization with unprecedented accuracy and efficiency.
          </p>
