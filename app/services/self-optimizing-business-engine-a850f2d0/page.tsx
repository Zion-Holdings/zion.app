...
export const metadata: Metadata = {
  title: 'Self-Optimizing Business Engine',
  description: 'The future of transportation is here with Self-Optimizing Business Engine. Powered by cutting-edge AI, this platform delivers receipt processing like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/self-optimizing-business-engine-a850f2d0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Business Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Self-Optimizing Business Engine. Powered by cutting-edge AI, this platform delivers receipt processing like never before.
          </p>
