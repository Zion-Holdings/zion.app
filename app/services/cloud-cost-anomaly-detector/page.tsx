...
export const metadata: Metadata = {
  ...
  keywords: 'ML anomaly detection, Root-cause attribution, Budget forecasting, Cost-reduction recommendations, AWS/Azure/GCP unified view, cloud, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cloud Cost Anomaly Detector</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered cloud cost anomaly detection with root-cause attribution, budget forecasting, and auto-generated cost-reduction playbooks.</p>
        ...
        <li class="text-slate-300">ML anomaly detection</li>
        <li class="text-slate-300">Root-cause attribution</li>
        <li class="text-slate-300">Budget forecasting</li>
        <li class="text-slate-300">Cost-reduction recommendations</li>
        <li class="text-slate-300">AWS/Azure/GCP unified view</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with cloud cost anomaly detector</li>
