...
export const metadata: Metadata = {
  title: 'Autonomous Compliance for Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Autonomous Compliance for Insurance leverages advanced machine learning to deliver document processi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-compliance-for-insurance-e29180b2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Compliance for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Autonomous Compliance for Insurance leverages advanced machine learning to deliver document processing at scale.
          </p>
