...
export const metadata: Metadata = {
  title: 'Automated Monitoring for Proptech',
  description: 'Transform your proptech operations with our Automated Monitoring for Proptech. This AI-driven solution automates manufacturing quality control with unprecedente',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-monitoring-for-proptech-8d59a37e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Monitoring for Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your proptech operations with our Automated Monitoring for Proptech. This AI-driven solution automates manufacturing quality control with unprecedented accuracy and efficiency.
          </p>
