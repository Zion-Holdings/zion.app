...
export const metadata: Metadata = {
  title: 'Smart Sales DevOps',
  description: 'Revolutionize automotive through intelligent automation. Our Smart Sales DevOps leverages advanced machine learning to deliver financial risk management at scal',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize automotive through intelligent automation. Our Smart Sales DevOps leverages advanced machine learning to deliver financial risk management at scale.
          </p>
