...
export const metadata: Metadata = {
  title: 'Automated Performance for Hospitality',
  description: 'Unlock unprecedented growth with Automated Performance for Hospitality. This autonomous system provides intelligent automation with zero manual intervention nee',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-performance-for-hospitality-7638390e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Performance for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Automated Performance for Hospitality. This autonomous system provides intelligent automation with zero manual intervention needed.
          </p>
