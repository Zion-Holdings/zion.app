...
export const metadata = {
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-fraud-detection-engine-e175d64b`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path={`/services/ai-fraud-detection-engine-e175d64b`} title="AI Fraud Detection Engine" />
