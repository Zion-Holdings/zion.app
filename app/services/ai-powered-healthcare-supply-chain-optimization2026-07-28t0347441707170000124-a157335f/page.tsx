...
export const metadata: Metadata = {
  title: 'AI-Powered Healthcare Supply Chain Optimization',
  description: 'Optimizes healthcare supply chain with demand forecasting.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-healthcare-supply-chain-optimization2026-07-28t0347441707170000124-a157335f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Healthcare Supply Chain Optimization
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimizes healthcare supply chain with demand forecasting.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Supply chain optimization</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">30% supply chain efficiency</li>
