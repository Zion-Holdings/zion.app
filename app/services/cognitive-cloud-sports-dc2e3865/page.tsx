...
export const metadata: Metadata = {
  title: 'Cognitive cloud-sports',
  description: 'Revolutionize sports through intelligent automation. Our Cognitive cloud-sports leverages advanced machine learning to deliver survey automation at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-cloud-sports-dc2e3865',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive cloud-sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Cognitive cloud-sports leverages advanced machine learning to deliver survey automation at scale.
          </p>
