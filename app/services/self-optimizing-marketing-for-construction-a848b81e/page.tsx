...
export const metadata: Metadata = {
  title: 'Self-Optimizing Marketing for Construction',
  description: 'Next-generation construction solution: Self-Optimizing Marketing for Construction. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/self-optimizing-marketing-for-construction-a848b81e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Marketing for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Self-Optimizing Marketing for Construction. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
