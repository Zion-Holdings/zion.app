...
export const metadata: Metadata = {
  title: 'Smart Workflow Platform - MARTECH',
  description: 'Transform your martech operations with our Smart Workflow Platform - MARTECH. This AI-driven solution automates performance monitoring with unprecedented accura',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Workflow Platform - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your martech operations with our Smart Workflow Platform - MARTECH. This AI-driven solution automates performance monitoring with unprecedented accuracy and efficiency.
          </p>
