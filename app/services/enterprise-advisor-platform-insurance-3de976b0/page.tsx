...
export const metadata: Metadata = {
  title: 'Enterprise Advisor Platform - Insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Advisor Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Enterprise Advisor Platform - Insurance. Powered by cutting-edge AI, this platform delivers budget management like never before.
          </p>
