...
export const metadata: Metadata = {
  title: 'Next-Gen Tactical for Education',
  description: 'Enhance your education business with Next-Gen Tactical for Education. Our solution provides form processing with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-tactical-for-education-353777cd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Tactical for Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your education business with Next-Gen Tactical for Education. Our solution provides form processing with enterprise-grade reliability and security.
          </p>
