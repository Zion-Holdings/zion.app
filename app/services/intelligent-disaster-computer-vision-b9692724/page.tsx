...
export const metadata: Metadata = {
  title: 'Intelligent Disaster Computer Vision',
  description: 'Optimize your transportation workflows with Intelligent Disaster Computer Vision. This intelligent platform delivers hr analytics through advanced automation an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-disaster-computer-vision-b9692724',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Disaster Computer Vision
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Intelligent Disaster Computer Vision. This intelligent platform delivers hr analytics through advanced automation and AI.
          </p>
