      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Smart - Saas
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your saaS with Cognitive Smart - Saas. Our autonomous solution handles workflow management end-to-end without human intervention.
          </p>
