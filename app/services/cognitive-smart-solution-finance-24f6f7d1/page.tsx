...
export const metadata: Metadata = {
  title: 'Cognitive Smart Solution - Finance',
  description: 'Revolutionize finance through intelligent automation. Our Cognitive Smart Solution - Finance leverages advanced machine learning to deliver regulatory tracking ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Smart Solution - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our Cognitive Smart Solution - Finance leverages advanced machine learning to deliver regulatory tracking at scale.
          </p>
