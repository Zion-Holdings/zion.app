...
export const metadata: Metadata = {
  title: 'Enterprise Engine Platform - Retail',
  description: 'Revolutionize retail through intelligent automation. Our Enterprise Engine Platform - Retail leverages advanced machine learning to deliver revenue intelligence',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-engine-platform-retail-3a642216',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Engine Platform - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize retail through intelligent automation. Our Enterprise Engine Platform - Retail leverages advanced machine learning to deliver revenue intelligence at scale.
          </p>
