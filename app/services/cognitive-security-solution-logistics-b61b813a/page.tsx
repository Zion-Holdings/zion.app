...
export const metadata: Metadata = {
  title: 'Cognitive Security Solution - Logistics',
  description: 'Transform your logistics operations with our Cognitive Security Solution - Logistics. This AI-driven solution automates sourcing optimization with unprecedented',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-security-solution-logistics-b61b813a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Security Solution - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Cognitive Security Solution - Logistics. This AI-driven solution automates sourcing optimization with unprecedented accuracy and efficiency.
          </p>
