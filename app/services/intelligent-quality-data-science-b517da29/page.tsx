...
export const metadata: Metadata = {
  title: 'Intelligent Quality Data Science',
  description: 'The future of hospitality is here with Intelligent Quality Data Science. Powered by cutting-edge AI, this platform delivers competitive intelligence like never ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Quality Data Science
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Intelligent Quality Data Science. Powered by cutting-edge AI, this platform delivers competitive intelligence like never before.
          </p>
