...
export const metadata: Metadata = {
  title: 'Demand Response AI-Powered Resume Screening',
  description: 'AI-powered demand response solution for hr. Automates candidate screening using NLP and skills matching.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/demand-response-ai-powered-resume-screening-3133fd02',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Demand Response AI-Powered Resume Screening
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered demand response solution for hr. Automates candidate screening using NLP and skills matching.
          </p>
