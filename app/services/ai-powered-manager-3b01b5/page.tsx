...
export const metadata: Metadata = {
  title: 'AI-Powered Manager',
  description: 'Transform your telecommunications operations with our AI-Powered Manager. This cloud solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-manager-3b01b5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your telecommunications operations with our AI-Powered Manager. This cloud solution delivers unprecedented automation and intelligence.
          </p>
