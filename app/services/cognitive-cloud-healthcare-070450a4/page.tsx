...
export const metadata: Metadata = {
  title: 'Cognitive cloud-healthcare',
  description: 'Unlock unprecedented growth with Cognitive cloud-healthcare. This autonomous system provides hr analytics with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-cloud-healthcare-070450a4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive cloud-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Cognitive cloud-healthcare. This autonomous system provides hr analytics with zero manual intervention needed.
          </p>
