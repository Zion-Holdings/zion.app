...
export const metadata: Metadata = {
  title: 'Intelligent Financial Business Intelligence',
  description: 'Transform your energy operations with our Intelligent Financial Business Intelligence. This AI-driven solution provides intelligent automation with unprecedente',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-financial-business-intelligence-ac716739',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Financial Business Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Intelligent Financial Business Intelligence. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
