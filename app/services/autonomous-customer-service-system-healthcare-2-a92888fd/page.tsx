...
export const metadata = {
  ...
  description: "Revolutionize healthcare through intelligent automation. Our Autonomous Customer Service System - Healthcare #2 leverages advanced machine learning to deliver c",
  alternates: {
