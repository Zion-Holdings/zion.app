...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-jurisdiction template engine, Cookie banner and consent builder, Policy version history and diff, Consent audit log, Legal review export package, ai, Healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Privacy Policy &amp; Compliance Generator</h1>
        <p className="text-lg text-slate-300 mb-8">Generate compliant privacy policies, cookie banners, and consent management frameworks for GDPR, CCPA, HIPAA, and SOC 2 with one-click multi-version export.</p>
        ...
        <li class="text-slate-300">Multi-jurisdiction template engine</li>
        <li class="text-slate-300">Cookie banner and consent builder</li>
        <li class="text-slate-300">Policy version history and diff</li>
        <li class="text-slate-300">Consent audit log</li>
        <li class="text-slate-300">Legal review export package</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai privacy policy &amp; compliance generator</li>
