      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Generate compliant privacy policies, cookie banners, and consent management frameworks for GDPR, CCPA, HIPAA, and SOC 2 with one-click multi-version export.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Multi-jurisdiction template engine</li>
            <li className="text-purple-300">✓ Cookie banner and consent builder</li>
            <li className="text-purple-300">✓ Policy version history and diff</li>
            <li className="text-purple-300">✓ Consent audit log</li>
            <li className="text-purple-300">✓ Legal review export package</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai privacy policy & compliance generator</li>
