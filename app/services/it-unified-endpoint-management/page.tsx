...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-platform: Windows, macOS, iOS, Android, ChromeOS, RaspberryPi ESP32 IoT, OS patch deployment with maintenance-window scheduling and rollback protection, Remote actions: wipe, lock, locate, reboot, reset password, revoke certs, Self-service app catalog: users install approved apps without IT ticket, Compliance policies: BitLocker, FileVault, firewall rules, USB restriction, AV enforcement, it, E-Commerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Unified Endpoint &amp; Device Management</h1>
        <p className="text-lg text-slate-300 mb-8">Unified endpoint management across Windows, macOS, iOS, Android, ChromeOS, and IoT: OS patch deployment, remote wipe, app catalog + distribution, inventory management, and compliance policy enforcement from a single console.</p>
        ...
        <li class="text-slate-300">Multi-platform: Windows, macOS, iOS, Android, ChromeOS, RaspberryPi ESP32 IoT</li>
        <li class="text-slate-300">OS patch deployment with maintenance-window scheduling and rollback protection</li>
        <li class="text-slate-300">Remote actions: wipe, lock, locate, reboot, reset password, revoke certs</li>
        <li class="text-slate-300">Self-service app catalog: users install approved apps without IT ticket</li>
        <li class="text-slate-300">Compliance policies: BitLocker, FileVault, firewall rules, USB restriction, AV enforcement</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with unified endpoint &amp; device management</li>
