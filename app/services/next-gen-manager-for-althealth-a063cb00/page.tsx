...
export const metadata: Metadata = {
  title: 'Next-Gen Manager for ALTHEALTH',
  description: 'Drive innovation in althealth with Next-Gen Manager for ALTHEALTH. This AI-powered platform transforms sales forecasting into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-manager-for-althealth-a063cb00',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Manager for ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in althealth with Next-Gen Manager for ALTHEALTH. This AI-powered platform transforms sales forecasting into a competitive advantage.
          </p>
