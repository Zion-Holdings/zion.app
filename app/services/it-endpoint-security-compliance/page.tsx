  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">EDR and XDR endpoint coverage with compliance attestation: CIS benchmark checks, disk-encrypt status, OS patch-level verification, software-inventory SBOM per asset, CISA KEV auto-detection, and SCAP reporting for regulated assessments.</p>
        ...
        <li class="text-slate-300">EDR and XDR with behavioural threat detection and real-time endpoint isolation</li>
        <li class="text-slate-300">CIS benchmark and compliance attestation per device without manual spreadsheet</li>
        <li class="text-slate-300">Software inventory SBOM per asset with CISA KEV automated detection</li>
        <li class="text-slate-300">SCAP-formatted reporting for FedRAMP and regulated customer assessments</li>
      </ul>
        </div>
