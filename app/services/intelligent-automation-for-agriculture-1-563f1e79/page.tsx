...
export const metadata: Metadata = {
  title: 'Intelligent Automation for Agriculture #1',
  description: 'Transform your agriculture operations with our Intelligent Automation for Agriculture #1. This AI-driven solution automates lead scoring with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-automation-for-agriculture-1-563f1e79',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Automation for Agriculture #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Intelligent Automation for Agriculture #1. This AI-driven solution automates lead scoring with unprecedented accuracy and efficiency.
          </p>
