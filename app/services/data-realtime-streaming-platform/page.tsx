...
export const metadata = {
  ...
  description: "Managed real-time data streaming with Apache Kafka, Flink, and change data capture. Ingest, process, and serve data in milliseconds for event-driven architectur",
  alternates: {
