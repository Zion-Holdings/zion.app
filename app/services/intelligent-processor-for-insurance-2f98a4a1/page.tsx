...
export const metadata: Metadata = {
  ...
  description: 'Enhance your insurance business with Intelligent Processor for Insurance. Our solution provides revenue forecasting with enterprise-grade reliability and securi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-processor-for-insurance-2f98a4a1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Intelligent Processor for Insurance. Our solution provides revenue forecasting with enterprise-grade reliability and security.
          </p>
