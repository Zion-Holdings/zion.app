...
export const metadata: Metadata = {
  ...
  description: 'Enhance your technology business with Smart Cognitive Platform - Tech. Our solution provides compliance reporting with enterprise-grade reliability and security',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-cognitive-platform-tech-bac0d25f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your technology business with Smart Cognitive Platform - Tech. Our solution provides compliance reporting with enterprise-grade reliability and security.
          </p>
