...
export const metadata: Metadata = {
  title: 'Cognitive Risk Data Science',
  description: 'Transform your construction operations with our Cognitive Risk Data Science. This AI-driven solution provides intelligent automation with unprecedented accuracy',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-risk-data-science-8b0b033c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Risk Data Science
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Cognitive Risk Data Science. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
