...
export const metadata: Metadata = {
  title: 'Smart Intelligent Platform - Transportation',
  description: 'Drive innovation in transportation with Smart Intelligent Platform - Transportation. This AI-powered platform transforms personalization engine into a competiti',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-intelligent-platform-transportation-3cae3c33',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Intelligent Platform - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in transportation with Smart Intelligent Platform - Transportation. This AI-powered platform transforms personalization engine into a competitive advantage.
          </p>
