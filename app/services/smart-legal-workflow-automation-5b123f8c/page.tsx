export const metadata = {
  title: "Smart Legal Workflow Automation",
  description: "Zion Tech Group delivers Smart Legal Workflow Automation with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/services/smart-legal-workflow-automation-5b123f8c/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>Smart Legal Workflow Automation</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers Smart Legal Workflow Automation with measurable outcomes.
      </p>
