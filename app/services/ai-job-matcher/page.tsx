...
export const metadata: Metadata = {
  ...
  keywords: 'Two-sided job + candidate fit scoring, Gap analysis + interview prep, Salary benchmark + offer comparison, Employer short-list with fit rankings, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Job Matcher &amp; Career Path</h1>
        <p className="text-lg text-slate-300 mb-8">Two-sided AI: job seeker resume vs all open roles + candidate profile vs employer requirements. Fit scores gap analysis interview prep salary benchmark.</p>
        ...
        <li class="text-slate-300">Two-sided job + candidate fit scoring</li>
        <li class="text-slate-300">Gap analysis + interview prep</li>
        <li class="text-slate-300">Salary benchmark + offer comparison</li>
        <li class="text-slate-300">Employer short-list with fit rankings</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai job matcher &amp; career path</li>
