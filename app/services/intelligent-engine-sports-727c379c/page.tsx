...
export const metadata: Metadata = {
  title: 'Intelligent engine-sports',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent engine-sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Intelligent engine-sports leverages advanced machine learning to deliver microservices mesh at scale.
          </p>
