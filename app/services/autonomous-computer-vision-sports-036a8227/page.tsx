...
export const metadata: Metadata = {
  title: 'Autonomous computer vision-sports',
  description: 'Transform your sports operations with our Autonomous computer vision-sports. This AI-driven solution automates data processing with unprecedented accuracy and e',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-computer-vision-sports-036a8227',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous computer vision-sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our Autonomous computer vision-sports. This AI-driven solution automates data processing with unprecedented accuracy and efficiency.
          </p>
