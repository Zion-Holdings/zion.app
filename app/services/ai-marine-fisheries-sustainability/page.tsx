...
export const metadata: Metadata = {
  ...
  keywords: 'Satellite & AIS vessel tracking, Fish stock abundance estimation, Illegal fishing detection & alerting, Coral reef health monitoring, UN SDG 14 compliance reporting, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Marine &amp; Fisheries Sustainability Monitor</h1>
        <p className="text-lg text-slate-300 mb-8">Satellite + IoT ocean analytics: track fish stocks, detect illegal fishing, monitor coral reef health, and model climate impact on marine ecosystems. Supports MSC certification and UN SDG 14 reporting.</p>
        ...
        <li class="text-slate-300">Satellite &amp; AIS vessel tracking</li>
        <li class="text-slate-300">Fish stock abundance estimation</li>
        <li class="text-slate-300">Illegal fishing detection &amp; alerting</li>
        <li class="text-slate-300">Coral reef health monitoring</li>
        <li class="text-slate-300">UN SDG 14 compliance reporting</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai marine &amp; fisheries sustainability monitor</li>
