    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI Marine & Fisheries Sustainability Monitor
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          Satellite + IoT ocean analytics: track fish stocks, detect illegal fishing, monitor coral reef health, and model climate impact on marine ecosystems. Supports M
        </p>
