...
export const metadata: Metadata = {
  title: 'Suite Cognitive - Transportation',
  description: 'The future of transportation is here with Suite Cognitive - Transportation. Powered by cutting-edge AI, this platform delivers quota optimization like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/suite-cognitive-transportation-90442b64',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Suite Cognitive - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Suite Cognitive - Transportation. Powered by cutting-edge AI, this platform delivers quota optimization like never before.
          </p>
