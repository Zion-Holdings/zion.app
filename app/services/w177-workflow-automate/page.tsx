...
export const metadata: Metadata = {
  ...
  keywords: 'Visual drag-drop workflow builder, Conditional logic and branching, API orchestration and transformation, 200+ pre-built connectors, Error handling and retry logic, Scheduled and event-triggered workflows, Integration with Zapier, Make, n8n, automation, Operations, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">No-Code Workflow Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Visual workflow builder: drag-drop, conditional logic, API orchestration, 200+ connectors. Automate without code.</p>
        ...
        <li class="text-slate-300">Visual drag-drop workflow builder</li>
        <li class="text-slate-300">Conditional logic and branching</li>
        <li class="text-slate-300">API orchestration and transformation</li>
        <li class="text-slate-300">200+ pre-built connectors</li>
        <li class="text-slate-300">Error handling and retry logic</li>
        <li class="text-slate-300">Scheduled and event-triggered workflows</li>
        <li class="text-slate-300">Integration with Zapier</li>
        <li class="text-slate-300">Make</li>
        <li class="text-slate-300">n8n</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Automate complex multi-step processes</li>
        <li class="text-slate-300">Visual builder</li>
        <li class="text-slate-300">no code required</li>
        <li class="text-slate-300">200+ connectors for popular services</li>
        <li class="text-slate-300">Error handling prevents workflow failures</li>
      </ul>
        </div>
