...
export const metadata: Metadata = {
  title: 'AI Process Mining - REGTECH Edition',
  description: 'Transform your regtech operations with our AI Process Mining - REGTECH Edition. This AI-driven solution automates fleet management with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-process-mining-regtech-edition-9904a489',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Process Mining - REGTECH Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your regtech operations with our AI Process Mining - REGTECH Edition. This AI-driven solution automates fleet management with unprecedented accuracy and efficiency.
          </p>
