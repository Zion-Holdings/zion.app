...
export const metadata: Metadata = {
  ...
  keywords: 'Price monitoring across 50+ sources, Feature gap analysis vs your product, Hiring intent detection (e.g. \\, ), Sentiment on competitor brands, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Competitive Intel Engine</h1>
        <p className="text-lg text-slate-300 mb-8">Tracks competitors\</p>
        ...
        <li class="text-slate-300">Price monitoring across 50+ sources</li>
        <li class="text-slate-300">Feature gap analysis vs your product</li>
        <li class="text-slate-300">Hiring intent detection (e.g. \</li>
        <li class="text-slate-300">)</li>
        <li class="text-slate-300">Sentiment on competitor brands</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai competitive intel engine</li>
