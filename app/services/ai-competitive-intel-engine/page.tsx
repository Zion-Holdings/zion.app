      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Price monitoring across 50+ sources</li>
            <li className="text-purple-300">✓ Feature gap analysis vs your product</li>
            <li className="text-purple-300">✓ Hiring intent detection (e.g. \</li>
            <li className="text-purple-300">✓ )</li>
            <li className="text-purple-300">✓ Sentiment on competitor brands</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai competitive intel engine</li>
