...
export const metadata: Metadata = {
  title: 'Customer Service AI - Construction',
  description: 'Drive innovation in construction with Customer Service AI - Construction. This AI-powered platform transforms campaign optimization into a competitive advantage',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/customer-service-ai-construction-9840a6d7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Customer Service AI - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Customer Service AI - Construction. This AI-powered platform transforms campaign optimization into a competitive advantage.
          </p>
