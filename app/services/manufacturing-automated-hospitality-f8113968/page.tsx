...
export const metadata: Metadata = {
  title: 'Manufacturing Automated - Hospitality',
  description: 'Enhance your hospitality business with Manufacturing Automated - Hospitality. Our solution provides account planning with enterprise-grade reliability and secur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/manufacturing-automated-hospitality-f8113968',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manufacturing Automated - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Manufacturing Automated - Hospitality. Our solution provides account planning with enterprise-grade reliability and security.
          </p>
