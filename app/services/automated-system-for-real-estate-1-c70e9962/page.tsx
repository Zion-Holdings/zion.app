...
export const metadata: Metadata = {
  title: 'Automated System for Real-Estate #1',
  description: 'Transform your real-estate operations with our Automated System for Real-Estate #1. This AI-driven solution automates image recognition with unprecedented accur',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated System for Real-Estate #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Automated System for Real-Estate #1. This AI-driven solution automates image recognition with unprecedented accuracy and efficiency.
          </p>
