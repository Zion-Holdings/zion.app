...
export const metadata: Metadata = {
  title: 'Smart Support Platform - Insurance',
  description: 'Unlock unprecedented growth with Smart Support Platform - Insurance. This autonomous system provides market intelligence with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-support-platform-insurance-faf24b5d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Support Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Support Platform - Insurance. This autonomous system provides market intelligence with zero manual intervention needed.
          </p>
