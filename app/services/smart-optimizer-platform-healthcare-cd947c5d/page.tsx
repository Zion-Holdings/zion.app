...
export const metadata: Metadata = {
  ...
  description: 'Drive innovation in healthcare with Smart Optimizer Platform - Healthcare. This AI-powered platform transforms training optimization into a competitive advantag',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with Smart Optimizer Platform - Healthcare. This AI-powered platform transforms training optimization into a competitive advantage.
          </p>
