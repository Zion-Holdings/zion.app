...
export const metadata: Metadata = {
  title: 'Neural Healthcare for Construction',
  description: 'Next-generation construction solution: Neural Healthcare for Construction. Combines supply chain with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-healthcare-for-construction-83c08402',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Healthcare for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Neural Healthcare for Construction. Combines supply chain with adaptive intelligence for optimal results.
          </p>
