...
export const metadata: Metadata = {
  title: 'Goal Tracking Multi-Cloud Cost Management Platform',
  description: 'goal tracking solution for seaports industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/goal-tracking-multi-cloud-cost-management-platform-a5bdf627',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Goal Tracking Multi-Cloud Cost Management Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            goal tracking solution for seaports industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.
          </p>
