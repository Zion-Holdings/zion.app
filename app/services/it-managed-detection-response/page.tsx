...
export const metadata: Metadata = {
  ...
  keywords: '24/7/365 security monitoring by certified analysts, Advanced threat detection with behavioral analytics, Endpoint detection and response (EDR) management, Network detection and response (NDR) with full packet capture, Threat intelligence feeds and IOC correlation, Incident response with 15-minute SLA for critical alerts, Digital forensics and root cause analysis, Monthly security posture reports and recommendations, security, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">24/7 managed security operations with advanced threat detection, incident response, and digital forensics. Combines SIEM, EDR, NDR, and human analysts to protect your organization.</p>
        ...
        <li class="text-slate-300">24/7/365 security monitoring by certified analysts</li>
        <li class="text-slate-300">Advanced threat detection with behavioral analytics</li>
        <li class="text-slate-300">Endpoint detection and response (EDR) management</li>
        <li class="text-slate-300">Network detection and response (NDR) with full packet capture</li>
        <li class="text-slate-300">Threat intelligence feeds and IOC correlation</li>
        <li class="text-slate-300">Incident response with 15-minute SLA for critical alerts</li>
        <li class="text-slate-300">Digital forensics and root cause analysis</li>
        <li class="text-slate-300">Monthly security posture reports and recommendations</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Enterprise-grade SOC at 1/3 the cost of building in-house</li>
        <li class="text-slate-300">Detect and respond to threats in under 15 minutes</li>
        <li class="text-slate-300">Reduce false positives by 95% with tuned detection rules</li>
        <li class="text-slate-300">Meet cyber insurance and compliance requirements</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$3,500/mo</p>
