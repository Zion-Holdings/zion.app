...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize hospitality through intelligent automation. Our AI Cloud - Hospitality Edition leverages advanced machine learning to deliver user experience at s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-cloud---hospitality-edition-4ebe64d3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our AI Cloud - Hospitality Edition leverages advanced machine learning to deliver user experience at scale.
          </p>
