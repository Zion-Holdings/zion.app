...
export const metadata: Metadata = {
  ...
  keywords: 'Auto-build relationship graphs from any tabular data via auto-linking columns, Community detection + clustering: Louvain, label propagation, clique percolation, Shortest-path, betweenness, PageRank — 20+ standard graph algorithms, Cypher-like graph query language with visual query builder, Interactive graph visualisation with zoom, filter, highlight, force-layout options, data, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Graph Analytics &amp; Network Intelligence Engine</h1>
        <p className="text-lg text-slate-300 mb-8">Enterprise graph analytics for fraud, risk, ESG, and recommendations: ingest tabular data to build dynamic relationship graphs, community detection, shortest-path analysis, centrality scoring, and interactive visual exploration with Cypher-like query language.</p>
        ...
        <li class="text-slate-300">Auto-build relationship graphs from any tabular data via auto-linking columns</li>
        <li class="text-slate-300">Community detection + clustering: Louvain, label propagation, clique percolation</li>
        <li class="text-slate-300">Shortest-path, betweenness, PageRank — 20+ standard graph algorithms</li>
        <li class="text-slate-300">Cypher-like graph query language with visual query builder</li>
        <li class="text-slate-300">Interactive graph visualisation with zoom, filter, highlight, force-layout options</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with graph analytics &amp; network intelligence engine</li>
