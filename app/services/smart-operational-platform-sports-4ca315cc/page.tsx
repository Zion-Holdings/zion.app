...
export const metadata: Metadata = {
  title: 'Smart Operational Platform - Sports',
  description: 'Optimize your sports workflows with Smart Operational Platform - Sports. This intelligent platform delivers fraud prevention through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-operational-platform-sports-4ca315cc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Operational Platform - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your sports workflows with Smart Operational Platform - Sports. This intelligent platform delivers fraud prevention through advanced automation and AI.
          </p>
