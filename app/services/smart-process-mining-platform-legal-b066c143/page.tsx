...
export const metadata: Metadata = {
  title: 'Smart Process Mining Platform - Legal',
  description: 'Optimize your legal workflows with Smart Process Mining Platform - Legal. This intelligent platform delivers succession planning through advanced automation and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-process-mining-platform-legal-b066c143',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Process Mining Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with Smart Process Mining Platform - Legal. This intelligent platform delivers succession planning through advanced automation and AI.
          </p>
