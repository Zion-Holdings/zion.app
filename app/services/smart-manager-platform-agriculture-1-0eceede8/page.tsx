...
export const metadata: Metadata = {
  title: 'Smart Manager Platform - Agriculture #1',
  description: 'Transform your agriculture operations with our Smart Manager Platform - Agriculture #1. This AI-driven solution automates inventory optimization with unpreceden',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-manager-platform-agriculture-1-0eceede8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manager Platform - Agriculture #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Smart Manager Platform - Agriculture #1. This AI-driven solution automates inventory optimization with unprecedented accuracy and efficiency.
          </p>
