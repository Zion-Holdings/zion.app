...
export const metadata: Metadata = {
  title: 'Cognitive Cloud Solution - Finance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Cloud Solution - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your finance workflows with Cognitive Cloud Solution - Finance. This intelligent platform delivers survey automation through advanced automation and AI.
          </p>
