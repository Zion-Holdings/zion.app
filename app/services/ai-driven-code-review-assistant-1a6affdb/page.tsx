...
export const metadata: Metadata = {
  ...
  description: 'Automated code review system that analyzes pull requests for security vulnerabilities, performance issues, and code quality with human-level understanding.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-driven-code-review-assistant-1a6affdb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automated code review system that analyzes pull requests for security vulnerabilities, performance issues, and code quality with human-level understanding.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Performance analysis</li>
          <li className="text-gray-300">Code style enforcement</li>
          <li className="text-gray-300">PR comments</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">60% faster reviews</li>
          <li className="text-purple-300">90% vulnerability detection</li>
          <li className="text-purple-300">Consistent code quality</li>
          </ul>
        </section>
