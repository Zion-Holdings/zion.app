...
export const metadata: Metadata = {
  title: 'Freight Management AI-Powered Container Orchestration',
  description: 'AI-powered freight management solution for devops. Intelligent container scheduling and resource allocation.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/freight-management-ai-powered-container-orchestration-a9224b87',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Freight Management AI-Powered Container Orchestration
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered freight management solution for devops. Intelligent container scheduling and resource allocation.
          </p>
