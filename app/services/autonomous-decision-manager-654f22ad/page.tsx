...
export const metadata: Metadata = {
  title: 'Autonomous Decision Manager',
  description: 'Transform your automotive operations with our Autonomous Decision Manager. This AI-driven solution automates financial planning with unprecedented accuracy and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-decision-manager-654f22ad',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Decision Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your automotive operations with our Autonomous Decision Manager. This AI-driven solution automates financial planning with unprecedented accuracy and efficiency.
          </p>
