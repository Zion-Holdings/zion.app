...
export const metadata: Metadata = {
  ...
  keywords: 'Intelligent automation and orchestration, Enterprise-grade integration, Real-time monitoring and alerts, Scalable multi-tenant architecture, it, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">DevSecOps Pipeline Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Security-baked CI/CD pipeline: SAST, DAST, secrets scanning, container image signing, SBOM generation, and penetration-test gates. Enforces policy as code before every production deployment.</p>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with devsecops pipeline automation</li>
