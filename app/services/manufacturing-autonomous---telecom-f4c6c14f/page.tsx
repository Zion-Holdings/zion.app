...
export const metadata: Metadata = {
  title: 'Manufacturing Autonomous - Telecom',
  description: 'Unlock unprecedented growth with Manufacturing Autonomous - Telecom. This autonomous system provides performance monitoring with zero manual intervention needed',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manufacturing Autonomous - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Manufacturing Autonomous - Telecom. This autonomous system provides performance monitoring with zero manual intervention needed.
          </p>
