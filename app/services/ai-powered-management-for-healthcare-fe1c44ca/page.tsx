...
export const metadata: Metadata = {
  title: 'AI-Powered Management for Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our AI-Powered Management for Healthcare leverages advanced machine learning to deliver employee engage',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-management-for-healthcare-fe1c44ca',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Management for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our AI-Powered Management for Healthcare leverages advanced machine learning to deliver employee engagement at scale.
          </p>
