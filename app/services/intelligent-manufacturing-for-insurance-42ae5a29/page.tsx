...
export const metadata: Metadata = {
  ...
  description: 'Next-generation insurance solution: Intelligent Manufacturing for Insurance. Combines customer insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-manufacturing-for-insurance-42ae5a29',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Intelligent Manufacturing for Insurance. Combines customer insights with adaptive intelligence for optimal results.
          </p>
