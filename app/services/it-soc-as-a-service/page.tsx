...
export const metadata: Metadata = {
  ...
  keywords: '24/7/365 monitoring by certified security analysts, SIEM deployment and management (Splunk, Sentinel, Elastic), Threat detection with custom correlation rules, Incident response with 15-min critical alert SLA, Vulnerability management and patch prioritization, Compliance reporting (SOC 2, HIPAA, PCI DSS, ISO 27001), security, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Security Operations Center as a Service (SOCaaS)</h1>
        <p className="text-lg text-slate-300 mb-8">24/7 managed security operations center without the $2M+ price tag. Full SIEM, threat detection, incident response, and compliance monitoring delivered as a service.</p>
        ...
        <li class="text-slate-300">24/7/365 monitoring by certified security analysts</li>
        <li class="text-slate-300">SIEM deployment and management (Splunk, Sentinel, Elastic)</li>
        <li class="text-slate-300">Threat detection with custom correlation rules</li>
        <li class="text-slate-300">Incident response with 15-min critical alert SLA</li>
        <li class="text-slate-300">Vulnerability management and patch prioritization</li>
        <li class="text-slate-300">Compliance reporting (SOC 2, HIPAA, PCI DSS, ISO 27001)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Enterprise SOC at 1/5 the cost of building in-house</li>
        <li class="text-slate-300">Detect and respond to threats in under 15 minutes</li>
        <li class="text-slate-300">Meet compliance requirements without dedicated staff</li>
        <li class="text-slate-300">Scale security as you grow</li>
      </ul>
        </div>
