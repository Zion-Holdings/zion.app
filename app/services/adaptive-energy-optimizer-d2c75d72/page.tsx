...
export const metadata: Metadata = {
  title: 'Adaptive Energy Optimizer',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Energy Optimizer
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation finance solution: Adaptive Energy Optimizer. Combines customer service automation with adaptive intelligence for optimal results.
          </p>
