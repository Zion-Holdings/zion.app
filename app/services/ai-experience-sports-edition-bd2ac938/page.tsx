...
export const metadata: Metadata = {
  title: 'AI Experience - Sports Edition',
  description: 'Enhance your sports business with AI Experience - Sports Edition. Our solution provides personalization engine with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-experience-sports-edition-bd2ac938',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Experience - Sports Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your sports business with AI Experience - Sports Edition. Our solution provides personalization engine with enterprise-grade reliability and security.
          </p>
