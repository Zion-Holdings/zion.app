...
export const metadata: Metadata = {
  title: 'Cognitive Resource Computer Vision',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Resource Computer Vision
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your education operations with our Cognitive Resource Computer Vision. This AI-driven solution automates resource allocation with unprecedented accuracy and efficiency.
          </p>
