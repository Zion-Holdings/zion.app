...
export const metadata: Metadata = {
  title: 'Next-Gen Risk for Gaming',
  description: 'Optimize your gaming workflows with Next-Gen Risk for Gaming. This intelligent platform delivers customer journey mapping through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-risk-for-gaming-1f1bc5df',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Risk for Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your gaming workflows with Next-Gen Risk for Gaming. This intelligent platform delivers customer journey mapping through advanced automation and AI.
          </p>
