...
export const metadata: Metadata = {
  title: 'Smart Engine for Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Smart Engine for Healthcare leverages advanced machine learning to deliver fraud prevention at scal',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Engine for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Smart Engine for Healthcare leverages advanced machine learning to deliver fraud prevention at scale.
          </p>
