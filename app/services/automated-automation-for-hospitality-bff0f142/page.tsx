...
export const metadata: Metadata = {
  title: 'Automated Automation for Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Automated Automation for Hospitality leverages advanced machine learning to deliver sales forecast',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Automation for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Automated Automation for Hospitality leverages advanced machine learning to deliver sales forecasting at scale.
          </p>
