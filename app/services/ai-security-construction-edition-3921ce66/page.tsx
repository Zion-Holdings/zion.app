...
export const metadata: Metadata = {
  title: 'AI Security - Construction Edition',
  description: 'The future of construction is here with AI Security - Construction Edition. Powered by cutting-edge AI, this platform delivers supply chain like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-security-construction-edition-3921ce66',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Security - Construction Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with AI Security - Construction Edition. Powered by cutting-edge AI, this platform delivers supply chain like never before.
          </p>
