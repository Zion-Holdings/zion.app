...
export const metadata: Metadata = {
  title: 'Predictive Engine Engine - Logistics',
  description: 'Enhance your logistics business with Predictive Engine Engine - Logistics. Our solution provides master data management with enterprise-grade reliability and se',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Engine Engine - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with Predictive Engine Engine - Logistics. Our solution provides master data management with enterprise-grade reliability and security.
          </p>
