...
export const metadata: Metadata = {
  title: 'Data Science Intelligent - Sports',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Science Intelligent - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your sports business with Data Science Intelligent - Sports. Our solution provides content moderation with enterprise-grade reliability and security.
          </p>
