...
export const metadata: Metadata = {
  ...
  keywords: 'HIPAA ready, Data encryption, Custom integrations, Multi-region deployment, suite, hospitality, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Smart advisor-hospitality</h1>
        <p className="text-lg text-slate-300 mb-8">Revolutionize hospitality through intelligent automation. Our Smart advisor-hospitality leverages advanced machine learning to deliver process automation at scale.</p>
