...
export const metadata: Metadata = {
  title: 'Predictive Customer Healthcare',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Customer Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation transportation solution: Predictive Customer Healthcare. Combines resource utilization with adaptive intelligence for optimal results.
          </p>
