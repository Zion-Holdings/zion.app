...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize agriculture through intelligent automation. Our Smart Experience Platform - Agriculture leverages advanced machine learning to deliver root cause ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-experience-platform-agriculture-029f0d2c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Smart Experience Platform - Agriculture leverages advanced machine learning to deliver root cause analysis at scale.
          </p>
