...
export const metadata: Metadata = {
  ...
  keywords: '1:N matching (100M+ mugshots), Age progression modeling, Disguise & makeup detection, Forensic evidence packaging, Gait analysis from video, Court-compliant reporting, ai, Government, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Forensic Face Recognition &amp; Investigation Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Law enforcement-grade face recognition: 1:N matching across mugshot databases, age progression modeling, disguise detection, and forensic-quality evidence packaging.</p>
        ...
        <li class="text-slate-300">1:N matching (100M+ mugshots)</li>
        <li class="text-slate-300">Age progression modeling</li>
        <li class="text-slate-300">Disguise &amp; makeup detection</li>
        <li class="text-slate-300">Forensic evidence packaging</li>
        <li class="text-slate-300">Gait analysis from video</li>
        <li class="text-slate-300">Court-compliant reporting</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Search 100M mugshots in seconds</li>
        <li class="text-slate-300">Identify subjects despite disguises</li>
        <li class="text-slate-300">Court-admissible evidence</li>
      </ul>
        </div>
