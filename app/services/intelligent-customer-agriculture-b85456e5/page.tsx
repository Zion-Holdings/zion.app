...
export const metadata: Metadata = {
  title: 'Intelligent customer-agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Intelligent customer-agriculture leverages advanced machine learning to deliver invoice automation',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-customer-agriculture-b85456e5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent customer-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Intelligent customer-agriculture leverages advanced machine learning to deliver invoice automation at scale.
          </p>
