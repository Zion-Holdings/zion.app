...
export const metadata: Metadata = {
  ...
  keywords: 'AI contract drafting from templates, Clause extraction and risk analysis, Obligation tracking and alerts, Renewal and expiration management, Contract comparison (original vs amended), Integration with CRM and procurement, ai, legal-tech, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Smart Contract Lifecycle Management</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered contract management with automated drafting, clause extraction, risk analysis, and renewal tracking. Manage the entire contract lifecycle in one platform.</p>
        ...
        <li class="text-slate-300">AI contract drafting from templates</li>
        <li class="text-slate-300">Clause extraction and risk analysis</li>
        <li class="text-slate-300">Obligation tracking and alerts</li>
        <li class="text-slate-300">Renewal and expiration management</li>
        <li class="text-slate-300">Contract comparison (original vs amended)</li>
        <li class="text-slate-300">Integration with CRM and procurement</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Draft contracts 10x faster</li>
        <li class="text-slate-300">Catch risky clauses automatically</li>
        <li class="text-slate-300">Never miss a renewal deadline</li>
        <li class="text-slate-300">Reduce contract management costs by 60%</li>
      </ul>
        </div>
