...
export const metadata: Metadata = {
  title: 'Smart Engine Platform - Insurance',
  description: 'Unlock unprecedented growth with Smart Engine Platform - Insurance. This autonomous system provides succession planning with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-engine-platform-insurance-ce925a2e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Engine Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Engine Platform - Insurance. This autonomous system provides succession planning with zero manual intervention needed.
          </p>
