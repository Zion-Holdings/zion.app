...
export const metadata: Metadata = {
  title: 'Autonomous Suite System - Transportation',
  description: 'Drive innovation in transportation with Autonomous Suite System - Transportation. This AI-powered platform transforms vendor management into a competitive advan',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-suite-system-transportation-086f3a48',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Suite System - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in transportation with Autonomous Suite System - Transportation. This AI-powered platform transforms vendor management into a competitive advantage.
          </p>
