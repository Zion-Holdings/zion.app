...
export const metadata: Metadata = {
  title: 'Intelligent Optimizer for CLEANTECH #1',
  description: 'The future of cleantech is here with Intelligent Optimizer for CLEANTECH #1. Powered by cutting-edge AI, this platform delivers business continuity like never b',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-optimizer-for-cleantech-1-8ee67d42',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Optimizer for CLEANTECH #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of cleantech is here with Intelligent Optimizer for CLEANTECH #1. Powered by cutting-edge AI, this platform delivers business continuity like never before.
          </p>
