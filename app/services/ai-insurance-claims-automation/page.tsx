...
export const metadata: Metadata = {
  ...
  keywords: 'OCR document extraction, Photo-based damage assessment, Fraud scoring engine, Automated adjudication rules, Policy coverage matching, Integration with Guidewire, Duck Creek, Regulatory compliance checks, Customer self-service portal, ai, Insurance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Insurance Claims Automation</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end insurance claims processing with AI. Document extraction, fraud detection, damage assessment via photos, and automated adjudication for faster payouts.</p>
        ...
        <li class="text-slate-300">OCR document extraction</li>
        <li class="text-slate-300">Photo-based damage assessment</li>
        <li class="text-slate-300">Fraud scoring engine</li>
        <li class="text-slate-300">Automated adjudication rules</li>
        <li class="text-slate-300">Policy coverage matching</li>
        <li class="text-slate-300">Integration with Guidewire, Duck Creek</li>
        <li class="text-slate-300">Regulatory compliance checks</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce claims processing time by 70%</li>
        <li class="text-slate-300">Lower fraud losses</li>
        <li class="text-slate-300">Improve customer satisfaction</li>
        <li class="text-slate-300">Cut operational costs</li>
      </ul>
        </div>
