...
export const metadata: Metadata = {
  title: 'Computer Vision Autonomous - Telecom',
  description: 'Revolutionize telecom through intelligent automation. Our Computer Vision Autonomous - Telecom leverages advanced machine learning to deliver sourcing optimizat',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Computer Vision Autonomous - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Computer Vision Autonomous - Telecom leverages advanced machine learning to deliver sourcing optimization at scale.
          </p>
