...
export const metadata: Metadata = {
  title: 'Smart NLP Platform - Agriculture',
  description: 'Transform your agriculture operations with our Smart NLP Platform - Agriculture. This AI-driven solution automates quality control with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-nlp-platform-agriculture-4743db3e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart NLP Platform - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Smart NLP Platform - Agriculture. This AI-driven solution automates quality control with unprecedented accuracy and efficiency.
          </p>
