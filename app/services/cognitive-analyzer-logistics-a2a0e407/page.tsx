...
export const metadata: Metadata = {
  title: 'Cognitive analyzer-logistics',
  description: 'The future of logistics is here with Cognitive analyzer-logistics. Powered by cutting-edge AI, this platform delivers incident response like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-analyzer-logistics-a2a0e407',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive analyzer-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Cognitive analyzer-logistics. Powered by cutting-edge AI, this platform delivers incident response like never before.
          </p>
