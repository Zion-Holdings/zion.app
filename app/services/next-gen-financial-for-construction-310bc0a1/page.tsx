...
export const metadata: Metadata = {
  title: 'Next-Gen Financial for Construction',
  description: 'Drive innovation in construction with Next-Gen Financial for Construction. This AI-powered platform transforms succession planning into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-financial-for-construction-310bc0a1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Financial for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Next-Gen Financial for Construction. This AI-powered platform transforms succession planning into a competitive advantage.
          </p>
