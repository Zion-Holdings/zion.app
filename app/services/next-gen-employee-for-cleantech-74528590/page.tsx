...
export const metadata: Metadata = {
  title: 'Next-Gen Employee for CLEANTECH',
  description: 'Hyper-accelerated cleantech solution: Next-Gen Employee for CLEANTECH. Combines investor relations with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-employee-for-cleantech-74528590',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Employee for CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated cleantech solution: Next-Gen Employee for CLEANTECH. Combines investor relations with next-gen AI for maximum velocity.
          </p>
