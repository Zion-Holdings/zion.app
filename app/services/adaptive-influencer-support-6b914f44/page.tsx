...
export const metadata: Metadata = {
  title: 'Adaptive Influencer Support',
  description: 'Drive innovation in hospitality with Adaptive Influencer Support. This AI-powered platform transforms financial planning into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-influencer-support-6b914f44',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Influencer Support
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Adaptive Influencer Support. This AI-powered platform transforms financial planning into a competitive advantage.
          </p>
