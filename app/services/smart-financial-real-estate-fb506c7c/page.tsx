...
export const metadata: Metadata = {
  title: 'Smart Financial Real Estate',
  description: 'Transform your proptech operations with our Smart Financial Real Estate. This AI-driven solution automates financial planning with unprecedented accuracy and ef',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Financial Real Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your proptech operations with our Smart Financial Real Estate. This AI-driven solution automates financial planning with unprecedented accuracy and efficiency.
          </p>
