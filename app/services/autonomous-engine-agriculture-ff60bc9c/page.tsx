...
export const metadata: Metadata = {
  title: 'Autonomous engine-agriculture',
  description: 'Transform your agriculture operations with our Autonomous engine-agriculture. This AI-driven solution automates container orchestration with unprecedented accur',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous engine-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Autonomous engine-agriculture. This AI-driven solution automates container orchestration with unprecedented accuracy and efficiency.
          </p>
