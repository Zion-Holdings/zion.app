...
export const metadata: Metadata = {
  title: 'Smart Performance Platform - Retail',
  description: 'Optimize your retail workflows with Smart Performance Platform - Retail. This intelligent platform delivers lead scoring through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-performance-platform-retail-defa7c51',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Performance Platform - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your retail workflows with Smart Performance Platform - Retail. This intelligent platform delivers lead scoring through advanced automation and AI.
          </p>
