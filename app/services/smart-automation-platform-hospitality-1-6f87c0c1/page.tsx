...
export const metadata: Metadata = {
  title: 'Smart Automation Platform - Hospitality #1',
  description: 'Future-proof your hospitality with Smart Automation Platform - Hospitality #1. Our autonomous solution handles loyalty optimization end-to-end without human int',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-automation-platform-hospitality-1-6f87c0c1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Automation Platform - Hospitality #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your hospitality with Smart Automation Platform - Hospitality #1. Our autonomous solution handles loyalty optimization end-to-end without human intervention.
          </p>
