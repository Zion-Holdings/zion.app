...
export const metadata: Metadata = {
  title: 'Adaptive Manufacturing for Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Adaptive Manufacturing for Hospitality leverages advanced machine learning to deliver risk assessm',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Manufacturing for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Adaptive Manufacturing for Hospitality leverages advanced machine learning to deliver risk assessment at scale.
          </p>
