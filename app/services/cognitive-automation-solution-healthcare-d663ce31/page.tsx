...
export const metadata: Metadata = {
  title: 'Cognitive Automation Solution - Healthcare',
  description: 'Enhance your healthcare business with Cognitive Automation Solution - Healthcare. Our solution provides sales process optimization with enterprise-grade reliabi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Automation Solution - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with Cognitive Automation Solution - Healthcare. Our solution provides sales process optimization with enterprise-grade reliability and security.
          </p>
