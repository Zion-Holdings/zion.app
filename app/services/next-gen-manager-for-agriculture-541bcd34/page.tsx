...
export const metadata: Metadata = {
  title: 'Next-Gen Manager for Agriculture',
  description: 'Optimize your agriculture workflows with Next-Gen Manager for Agriculture. This intelligent platform delivers click automation through advanced automation and A',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-manager-for-agriculture-541bcd34',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Manager for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your agriculture workflows with Next-Gen Manager for Agriculture. This intelligent platform delivers click automation through advanced automation and AI.
          </p>
