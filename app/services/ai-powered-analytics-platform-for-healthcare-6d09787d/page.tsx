...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-analytics-platform-for-healthcare-6d09787d",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        ...
        <p className="text-xl text-slate-300 mb-8">
          Advanced healthcare analytics platform leveraging machine learning to AI diagnostics, patient data analytics, telemedicine automation. Provides real-time insigh
        </p>
