...
export const metadata: Metadata = {
  title: 'Self-Optimizing Incident Experience',
  description: 'Revolutionize hospitality through intelligent automation. Our Self-Optimizing Incident Experience leverages advanced machine learning to deliver recommendation ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Incident Experience
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Self-Optimizing Incident Experience leverages advanced machine learning to deliver recommendation system at scale.
          </p>
