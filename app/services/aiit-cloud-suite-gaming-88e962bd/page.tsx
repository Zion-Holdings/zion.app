...
export const metadata: Metadata = {
  title: 'AI/IT Cloud Suite - Gaming',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Cloud Suite - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for gaming: AI/IT Cloud Suite - Gaming. Uses quantum-inspired algorithms to deliver resource planning at exponential speed.
          </p>
