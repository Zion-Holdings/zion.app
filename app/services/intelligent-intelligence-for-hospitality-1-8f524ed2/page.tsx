...
export const metadata: Metadata = {
  title: 'Intelligent Intelligence for Hospitality #1',
  description: 'Optimize your hospitality workflows with Intelligent Intelligence for Hospitality #1. This intelligent platform delivers data pipeline orchestration through adv',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Intelligence for Hospitality #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Intelligent Intelligence for Hospitality #1. This intelligent platform delivers data pipeline orchestration through advanced automation and AI.
          </p>
