...
export const metadata: Metadata = {
  title: 'Data Autonomous - Energy',
  description: 'Drive innovation in energy with Data Autonomous - Energy. This AI-powered platform transforms sentiment analysis into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-autonomous-energy-11fba705',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Autonomous - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Data Autonomous - Energy. This AI-powered platform transforms sentiment analysis into a competitive advantage.
          </p>
