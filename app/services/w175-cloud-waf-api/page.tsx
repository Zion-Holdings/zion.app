...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{'@context': 'https://schema.org', '@type': 'Service', 'name': 'Cloud WAF & API Gateway Security', 'description': 'Combined WAF and API gateway with rate limiting, bot management, JWT validation, and mTLS. Protect web apps and APIs with a single cloud-native service.', 'serviceType': 'security', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'Cybersecurity'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'Cloud WAF & API Gateway Security Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$199/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$599/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': '$1,999/mo', 'priceCurrency': 'USD'}]}} }/>
    <JsonLd data={{'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'WAF with OWASP Core Rule Set', 'acceptedAnswer': {'@type': 'Answer', 'text': 'WAF with OWASP Core Rule Set'}}, {'@type': 'Question', 'name': 'API gateway with rate limiting', 'acceptedAnswer': {'@type': 'Answer', 'text': 'API gateway with rate limiting'}}, {'@type': 'Question', 'name': 'JWT/OAuth2 token validation', 'acceptedAnswer': {'@type': 'Answer', 'text': 'JWT/OAuth2 token validation'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'WAF + API gateway in one service; Rate limiting prevents API abuse; mTLS secures service-to-service'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} }/>
