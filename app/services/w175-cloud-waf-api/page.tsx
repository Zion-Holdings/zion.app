...
export const metadata: Metadata = {
  ...
  keywords: 'WAF with OWASP Core Rule Set, API gateway with rate limiting, JWT/OAuth2 token validation, mTLS between services, Bot detection and CAPTCHA challenge, Geo-blocking and IP allow/deny lists, Cloud-native deployment (AWS, Azure, GCP), security, Cybersecurity, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cloud WAF &amp; API Gateway Security</h1>
        <p className="text-lg text-slate-300 mb-8">Combined WAF and API gateway with rate limiting, bot management, JWT validation, and mTLS. Protect web apps and APIs with a single cloud-native service.</p>
        ...
        <li class="text-slate-300">WAF with OWASP Core Rule Set</li>
        <li class="text-slate-300">API gateway with rate limiting</li>
        <li class="text-slate-300">JWT/OAuth2 token validation</li>
        <li class="text-slate-300">mTLS between services</li>
        <li class="text-slate-300">Bot detection and CAPTCHA challenge</li>
        <li class="text-slate-300">Geo-blocking and IP allow/deny lists</li>
        <li class="text-slate-300">Cloud-native deployment (AWS, Azure, GCP)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">WAF + API gateway in one service</li>
        <li class="text-slate-300">Rate limiting prevents API abuse</li>
        <li class="text-slate-300">mTLS secures service-to-service</li>
        <li class="text-slate-300">Bot management protects critical flows</li>
      </ul>
        </div>
