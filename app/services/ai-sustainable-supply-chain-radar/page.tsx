...
export const metadata: Metadata = {
  ...
  keywords: 'Supplier-scope carbon database from tier-1 to tier-n with Scope 3 quantification, Green-alternative sourcing score with cost-impact tradeoff analysis, CSRD and CBAM compliant auto-reports per quarter per jurisdiction, Regulatory penalty simulator — cost-of-non-compliance per scenario, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Sustainable Supply Chain Radar</h1>
        <p className="text-lg text-slate-300 mb-8">Supply-chain ESG tracking: carbon-intensity per supplier tier, green-alternative sourcing score, Scope 3 quantification, regulatory dashboard for CSRD and CBAM, and regulatory penalty simulator per scenario.</p>
        ...
        <li class="text-slate-300">Supplier-scope carbon database from tier-1 to tier-n with Scope 3 quantification</li>
        <li class="text-slate-300">Green-alternative sourcing score with cost-impact tradeoff analysis</li>
        <li class="text-slate-300">CSRD and CBAM compliant auto-reports per quarter per jurisdiction</li>
        <li class="text-slate-300">Regulatory penalty simulator — cost-of-non-compliance per scenario</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with sustainable supply chain radar</li>
