...
export const metadata: Metadata = {
  title: 'Experience Intelligent - Hospitality',
  description: 'Next-generation hospitality solution: Experience Intelligent - Hospitality. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/experience-intelligent-hospitality-31b6e6ca',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Experience Intelligent - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Experience Intelligent - Hospitality. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
