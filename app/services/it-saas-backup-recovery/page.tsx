...
export const metadata: Metadata = {
  ...
  keywords: 'Automated daily backups for 50+ SaaS apps, One-click granular recovery (files, emails, records), Point-in-time recovery with unlimited retention, Cross-account and cross-region backup copies, Ransomware detection and alerting, Compliance reporting and audit logs, Self-service recovery portal for end users, 24/7 monitoring and support, it, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT SaaS Backup &amp; Disaster Recovery</h1>
        <p className="text-lg text-slate-300 mb-8">Protect your SaaS data with automated backups and one-click recovery for Microsoft 365, Google Workspace, Salesforce, and 50+ SaaS applications. RPO under 1 hour.</p>
        ...
        <li class="text-slate-300">Automated daily backups for 50+ SaaS apps</li>
        <li class="text-slate-300">One-click granular recovery (files, emails, records)</li>
        <li class="text-slate-300">Point-in-time recovery with unlimited retention</li>
        <li class="text-slate-300">Cross-account and cross-region backup copies</li>
        <li class="text-slate-300">Ransomware detection and alerting</li>
        <li class="text-slate-300">Compliance reporting and audit logs</li>
        <li class="text-slate-300">Self-service recovery portal for end users</li>
        <li class="text-slate-300">24/7 monitoring and support</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Protect against SaaS data loss and ransomware</li>
        <li class="text-slate-300">Meet compliance backup requirements</li>
        <li class="text-slate-300">Recover data in minutes, not days</li>
        <li class="text-slate-300">Eliminate manual backup processes</li>
      </ul>
        </div>
