export const metadata = {
  title: "Smart Monitoring Platform - Energy",
  description: "Zion Tech Group delivers Smart Monitoring Platform - Energy with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/services/smart-monitoring-platform-energy-dcca4964/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>Smart Monitoring Platform - Energy</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers Smart Monitoring Platform - Energy with measurable outcomes.
      </p>
