...
export const metadata: Metadata = {
  ...
  keywords: 'Identity & Access Management (IAM) modernization, Micro-segmentation of network workloads, Continuous adaptive risk & trust assessment, Device posture checking & conditional access, Privileged Access Management (PAM) integration, security, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Implement Zero Trust principles across your enterprise — identity verification, micro-segmentation, least-privilege access, and continuous authentication for every request.</p>
        ...
        <li class="text-slate-300">Identity &amp; Access Management (IAM) modernization</li>
        <li class="text-slate-300">Micro-segmentation of network workloads</li>
        <li class="text-slate-300">Continuous adaptive risk &amp; trust assessment</li>
        <li class="text-slate-300">Device posture checking &amp; conditional access</li>
        <li class="text-slate-300">Privileged Access Management (PAM) integration</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with zero trust security architecture</li>
