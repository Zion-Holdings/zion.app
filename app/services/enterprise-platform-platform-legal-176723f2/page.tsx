...
export const metadata: Metadata = {
  title: 'Enterprise Platform Platform - Legal',
  description: 'Drive innovation in legal with Enterprise Platform Platform - Legal. This AI-powered platform transforms data quality into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-platform-platform-legal-176723f2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Platform Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Enterprise Platform Platform - Legal. This AI-powered platform transforms data quality into a competitive advantage.
          </p>
