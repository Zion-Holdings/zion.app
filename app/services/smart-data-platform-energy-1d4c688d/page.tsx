...
export const metadata: Metadata = {
  title: 'Smart Data Platform - Energy',
  description: 'Optimize your energy workflows with Smart Data Platform - Energy. This intelligent platform delivers testing automation through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-data-platform-energy-1d4c688d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Data Platform - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your energy workflows with Smart Data Platform - Energy. This intelligent platform delivers testing automation through advanced automation and AI.
          </p>
