...
export const metadata: Metadata = {
  title: 'Cloud-Native Risk Analyzer',
  description: 'Revolutionize automotive through intelligent automation. Our Cloud-Native Risk Analyzer leverages advanced machine learning to deliver recruitment automation at',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cloud-Native Risk Analyzer
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize automotive through intelligent automation. Our Cloud-Native Risk Analyzer leverages advanced machine learning to deliver recruitment automation at scale.
          </p>
