...
export const metadata: Metadata = {
  ...
  keywords: 'Platform selection (Shopify/BigCommerce/Salesforce), Headless storefront (Next.js/Hydrogen), Payment integration (Stripe/Square/PayPal), Migration plan minimise downtime maximise SEO transfer, it, E-Commerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">E-Commerce Platform Advisor</h1>
        <p className="text-lg text-slate-300 mb-8">Platform selection, headless storefront implementation, payments integration, and Shopify/BigCommerce/Salesforce Commerce migration guidance.</p>
        ...
        <li class="text-slate-300">Platform selection (Shopify/BigCommerce/Salesforce)</li>
        <li class="text-slate-300">Headless storefront (Next.js/Hydrogen)</li>
        <li class="text-slate-300">Payment integration (Stripe/Square/PayPal)</li>
        <li class="text-slate-300">Migration plan minimise downtime maximise SEO transfer</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with e-commerce platform advisor</li>
