...
export const metadata: Metadata = {
  title: 'AI-Powered Experience for Energy',
  description: 'Transform your energy operations with our AI-Powered Experience for Energy. This AI-driven solution automates performance monitoring with unprecedented accuracy',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-experience-for-energy-a6b1655c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Experience for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our AI-Powered Experience for Energy. This AI-driven solution automates performance monitoring with unprecedented accuracy and efficiency.
          </p>
