...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-language ASR transcription (50+ languages), LLM translation + cultural localisation, SRT/VTT/WebVTT + lip-sync time-align, Auto-highlight key quote phrases per transcript, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Caption &amp; Subtitle Generator</h1>
        <p className="text-lg text-slate-300 mb-8">Multi-language ASR translation, caption formatting, SRT/VTT/WebVTT export with lip-sync timing alignment for video.</p>
        ...
        <li class="text-slate-300">Multi-language ASR transcription (50+ languages)</li>
        <li class="text-slate-300">LLM translation + cultural localisation</li>
        <li class="text-slate-300">SRT/VTT/WebVTT + lip-sync time-align</li>
        <li class="text-slate-300">Auto-highlight key quote phrases per transcript</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with caption &amp; subtitle generator</li>
