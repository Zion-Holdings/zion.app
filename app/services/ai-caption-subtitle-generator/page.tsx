      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Multi-language ASR transcription (50+ languages)</li>
            <li className="text-purple-300">✓ LLM translation + cultural localisation</li>
            <li className="text-purple-300">✓ SRT/VTT/WebVTT + lip-sync time-align</li>
            <li className="text-purple-300">✓ Auto-highlight key quote phrases per transcript</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with caption & subtitle generator</li>
