...
export const metadata: Metadata = {
  ...
  keywords: 'Tabular data synthesis (CTGAN, TVAE), Image synthesis with diffusion models, Privacy-preserving synthetic data (DP-SGD), Data augmentation pipelines, Quality metrics (KSTest, coverage), ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Generative Data Synthesis for Model Training</h1>
        <p className="text-lg text-slate-300 mb-8">Create synthetic tabular, image, or text datasets to augment training data, balance classes, or simulate rare scenarios while preserving statistical fidelity.</p>
        ...
        <li class="text-slate-300">Tabular data synthesis (CTGAN, TVAE)</li>
        <li class="text-slate-300">Image synthesis with diffusion models</li>
        <li class="text-slate-300">Privacy-preserving synthetic data (DP-SGD)</li>
        <li class="text-slate-300">Data augmentation pipelines</li>
        <li class="text-slate-300">Quality metrics (KSTest, coverage)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with generative data synthesis for model training</li>
