...
export const metadata: Metadata = {
  title: 'Intelligent Customer Support Docker (Logistics)',
  description: 'Intelligent Customer Support Docker (Logistics) is an AI-powered logistics solution that transforms how businesses operate through intelligent automation and re',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-customer-support-d-6271b7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Customer Support Docker (Logistics)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Intelligent Customer Support Docker (Logistics) is an AI-powered logistics solution that transforms how businesses operate through intelligent automation and real-time analytics.
