...
export const metadata: Metadata = {
  title: 'AI-Powered Feature Smart',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Feature Smart
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with AI-Powered Feature Smart. Powered by cutting-edge AI, this platform delivers automation opportunity like never before.
          </p>
