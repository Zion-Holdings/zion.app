...
export const metadata: Metadata = {
  title: 'Quantum Workflow - REGTECH Quantum',
  description: 'Quantum leap forward for regtech: Quantum Workflow - REGTECH Quantum. Uses quantum-inspired algorithms to deliver logistics route optimization at exponential sp',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-workflow-regtech-quantum-2cb693b2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Workflow - REGTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for regtech: Quantum Workflow - REGTECH Quantum. Uses quantum-inspired algorithms to deliver logistics route optimization at exponential speed.
          </p>
