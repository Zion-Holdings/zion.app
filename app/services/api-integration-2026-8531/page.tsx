...
export const metadata = {
  ...
  alternates: { canonical: '/services/api-integration-2026-8531/' },

  openGraph: {
    title: 'API Integration | Zion Tech Group',
    description: 'End-to-end api integration services: assessment, deployment, and managed operations.',
    url: 'https://ziontechgroup.com/services/api-integration-2026-8531/',
...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "API Integration | Zion Tech Group", description: "End-to-end api integration services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/api-integration-2026-8531/}} />
