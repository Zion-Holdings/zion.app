...
export const metadata: Metadata = {
  title: 'Intelligent Recruitment Business Intelligence',
  description: 'Revolutionize automotive through intelligent automation. Our Intelligent Recruitment Business Intelligence leverages advanced machine learning to deliver fraud ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Recruitment Business Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize automotive through intelligent automation. Our Intelligent Recruitment Business Intelligence leverages advanced machine learning to deliver fraud prevention at scale.
          </p>
