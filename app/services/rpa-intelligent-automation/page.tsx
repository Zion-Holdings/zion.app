...
export const metadata: Metadata = {
  ...
  keywords: 'AI document extraction (OCR + LLM), ERP/CRM auto-population (SAP, NetSuite, SF), Exception classification + routing, End-to-end audit trail per transaction, Unattended robots + attended robot copilot mode, automation, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">RPA + Intelligent Document Processing</h1>
        <p className="text-lg text-slate-300 mb-8">RPA robots augmented with AI document understanding: extract structured data from PDFs, invoices, and emails; fill ERP/CRM forms; reconcile payments; and escalate exceptions — end-to-end touchless processing.</p>
        ...
        <li class="text-slate-300">AI document extraction (OCR + LLM)</li>
        <li class="text-slate-300">ERP/CRM auto-population (SAP, NetSuite, SF)</li>
        <li class="text-slate-300">Exception classification + routing</li>
        <li class="text-slate-300">End-to-end audit trail per transaction</li>
        <li class="text-slate-300">Unattended robots + attended robot copilot mode</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with rpa + intelligent document processing</li>
