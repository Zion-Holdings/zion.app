...
export const metadata: Metadata = {
  title: 'Smart Real Estate for Proptech',
  description: 'Revolutionize proptech through intelligent automation. Our Smart Real Estate for Proptech leverages advanced machine learning to deliver inventory management at',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-real-estate-for-proptech-4b7c6bc0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Real Estate for Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our Smart Real Estate for Proptech leverages advanced machine learning to deliver inventory management at scale.
          </p>
