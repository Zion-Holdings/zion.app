...
export const metadata: Metadata = {
  title: 'Smart Analytics Platform - Construction',
  description: 'Revolutionize construction through intelligent automation. Our Smart Analytics Platform - Construction leverages advanced machine learning to deliver net promot',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-analytics-platform-construction-0fca17b8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Analytics Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Smart Analytics Platform - Construction leverages advanced machine learning to deliver net promoter score at scale.
          </p>
