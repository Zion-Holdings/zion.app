...
export const metadata: Metadata = {
  title: "Advertising AI Meeting Assistant Pro - AI-Powered Advertising Solution",
  description: "AI-powered advertising solution for productivity. AI-powered meeting assistant that generates agendas, takes notes, and schedules follow-ups.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/advertising-ai-meeting-assistant-pro-d4ff0809",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Advertising AI Meeting Assistant Pro - AI-Powered Advertising Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          AI-powered advertising solution for productivity. AI-powered meeting assistant that generates agendas, takes notes, and schedules follow-ups.
        </p>
