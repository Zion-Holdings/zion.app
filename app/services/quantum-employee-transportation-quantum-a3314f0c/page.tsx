...
export const metadata: Metadata = {
  title: 'Quantum Employee - Transportation Quantum',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Employee - Transportation Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Quantum Employee - Transportation Quantum. This intelligent platform delivers succession planning through advanced automation and AI.
          </p>
