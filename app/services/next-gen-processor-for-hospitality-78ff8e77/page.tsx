...
export const metadata: Metadata = {
  title: 'Next-Gen Processor for Hospitality',
  description: 'Transform your hospitality operations with our Next-Gen Processor for Hospitality. This AI-driven solution automates business continuity with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-processor-for-hospitality-78ff8e77',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Processor for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Next-Gen Processor for Hospitality. This AI-driven solution automates business continuity with unprecedented accuracy and efficiency.
          </p>
