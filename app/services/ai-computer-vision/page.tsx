...
export const metadata: Metadata = {
  ...
  keywords: 'Image classification & object detection, Visual quality inspection & defect detection, OCR + layout analysis, Visual search & similarity matching, Edge deployment for real-time inference, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Computer Vision</h1>
        <p className="text-lg text-slate-300 mb-8">Image recognition, object detection, quality inspection, and visual search powered by deep learning models trained on your domain data.</p>
        ...
        <li class="text-slate-300">Image classification &amp; object detection</li>
        <li class="text-slate-300">Visual quality inspection &amp; defect detection</li>
        <li class="text-slate-300">OCR + layout analysis</li>
        <li class="text-slate-300">Visual search &amp; similarity matching</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai computer vision</li>
