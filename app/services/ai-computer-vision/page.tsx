      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Image recognition, object detection, quality inspection, and visual search powered by deep learning models trained on your domain data.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Image classification & object detection</li>
            <li className="text-purple-300">✓ Visual quality inspection & defect detection</li>
            <li className="text-purple-300">✓ OCR + layout analysis</li>
            <li className="text-purple-300">✓ Visual search & similarity matching</li>
            <li className="text-purple-300">✓ Edge deployment for real-time inference</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai computer vision</li>
