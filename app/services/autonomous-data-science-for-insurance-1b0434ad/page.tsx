...
export const metadata: Metadata = {
  title: 'Autonomous Data Science for Insurance',
  description: 'The future of insurance is here with Autonomous Data Science for Insurance. Powered by cutting-edge AI, this platform delivers revenue forecasting like never be',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-data-science-for-insurance-1b0434ad',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Data Science for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Autonomous Data Science for Insurance. Powered by cutting-edge AI, this platform delivers revenue forecasting like never before.
          </p>
