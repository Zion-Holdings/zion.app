...
export const metadata: Metadata = {
  ...
  description: 'Drive innovation in construction with Intelligent Machine Learning for Construction. This AI-powered platform transforms capacity management into a competitive ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Intelligent Machine Learning for Construction. This AI-powered platform transforms capacity management into a competitive advantage.
          </p>
