...
export const metadata: Metadata = {
  title: 'Healthcare Autonomous - Logistics',
  description: 'Transform your logistics operations with our Healthcare Autonomous - Logistics. This AI-driven solution provides intelligent automation with unprecedented accur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/healthcare-autonomous-logistics-f208061f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Healthcare Autonomous - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Healthcare Autonomous - Logistics. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
