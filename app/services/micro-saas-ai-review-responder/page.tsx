...
export const metadata: Metadata = {
  ...
  keywords: 'AI review response generation with brand voice, Multi-platform monitoring (Google, Yelp, TripAdvisor, Amazon), Negative review escalation alerts, Response approval workflows, Competitor review benchmarking, Review sentiment analytics, Integration with CRM and reputation platforms, Automatic review request campaigns, ai, marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Review Response &amp; Reputation Manager</h1>
        <p className="text-lg text-slate-300 mb-8">AI that writes personalized responses to customer reviews across Google, Yelp, TripAdvisor, and 50+ platforms. Maintains brand voice and handles negative reviews with care.</p>
        ...
        <li class="text-slate-300">AI review response generation with brand voice</li>
        <li class="text-slate-300">Multi-platform monitoring (Google, Yelp, TripAdvisor, Amazon)</li>
        <li class="text-slate-300">Negative review escalation alerts</li>
        <li class="text-slate-300">Response approval workflows</li>
        <li class="text-slate-300">Competitor review benchmarking</li>
        <li class="text-slate-300">Review sentiment analytics</li>
        <li class="text-slate-300">Integration with CRM and reputation platforms</li>
        <li class="text-slate-300">Automatic review request campaigns</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Respond to reviews 10x faster</li>
        <li class="text-slate-300">Improve ratings with consistent responses</li>
        <li class="text-slate-300">Catch negative reviews before they spread</li>
        <li class="text-slate-300">Maintain brand voice across all responses</li>
      </ul>
        </div>
