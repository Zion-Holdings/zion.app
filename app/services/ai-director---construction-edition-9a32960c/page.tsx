...
export const metadata: Metadata = {
  ...
  keywords: 'Audit trails, Edge computing support, Role-based access control, Real-time processing, Serverless functions, Custom integrations, suite, construction, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Director - Construction Edition</h1>
        <p className="text-lg text-slate-300 mb-8">The future of construction is here with AI Director - Construction Edition. Powered by cutting-edge AI, this platform delivers predictive analytics like never before.</p>
