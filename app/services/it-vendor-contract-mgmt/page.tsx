...
export const metadata: Metadata = {
  ...
  keywords: 'Central contract repository, Automated renewal alerts, SLA tracking dashboard, Configurable approval workflows, Vendor spend analytics, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Vendor &amp; Contract Management</h1>
        <p className="text-lg text-slate-300 mb-8">Centralise IT vendor contracts, SLAs, and renewal dates. AI monitors terms, flags expiring agreements, and automates renewal workflows with configurable approval chains.</p>
        ...
        <li class="text-slate-300">Central contract repository</li>
        <li class="text-slate-300">Automated renewal alerts</li>
        <li class="text-slate-300">SLA tracking dashboard</li>
        <li class="text-slate-300">Configurable approval workflows</li>
        <li class="text-slate-300">Vendor spend analytics</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with it vendor &amp; contract management</li>
