...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize manufacturing through intelligent automation. Our Autonomous Insights for Manufacturing leverages advanced machine learning to deliver customer se',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-insights-for-manufacturing-187169d5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize manufacturing through intelligent automation. Our Autonomous Insights for Manufacturing leverages advanced machine learning to deliver customer service automation at scale.
          </p>
