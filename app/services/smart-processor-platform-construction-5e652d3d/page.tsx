...
export const metadata: Metadata = {
  ...
  description: 'Enhance your construction business with Smart Processor Platform - Construction. Our solution provides project portfolio with enterprise-grade reliability and s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-processor-platform-construction-5e652d3d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Smart Processor Platform - Construction. Our solution provides project portfolio with enterprise-grade reliability and security.
          </p>
