...
export const metadata: Metadata = {
  title: 'Neural Experience for Retail',
  description: 'Revolutionize retail through intelligent automation. Our Neural Experience for Retail leverages advanced machine learning to deliver user experience at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-experience-for-retail-49a2f197',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Experience for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize retail through intelligent automation. Our Neural Experience for Retail leverages advanced machine learning to deliver user experience at scale.
          </p>
