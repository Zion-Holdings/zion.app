...
export const metadata: Metadata = {
  title: 'Smart business intelligence-tech',
  description: 'Revolutionize technology through intelligent automation. Our Smart business intelligence-tech leverages advanced machine learning to deliver access management a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart business intelligence-tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our Smart business intelligence-tech leverages advanced machine learning to deliver access management at scale.
          </p>
