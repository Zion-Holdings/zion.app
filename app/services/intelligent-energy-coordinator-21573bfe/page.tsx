...
export const metadata: Metadata = {
  title: 'Intelligent Energy Coordinator',
  description: 'Transform your edge operations with our Intelligent Energy Coordinator. This AI-driven solution automates user experience with unprecedented accuracy and effici',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Energy Coordinator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your edge operations with our Intelligent Energy Coordinator. This AI-driven solution automates user experience with unprecedented accuracy and efficiency.
          </p>
