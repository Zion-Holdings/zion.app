...
export const metadata: Metadata = {
  title: 'Sales Cognitive - Cleantech',
  description: 'Transform your cleantech operations with our Sales Cognitive - Cleantech. This AI-driven solution automates document processing with unprecedented accuracy and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/sales-cognitive---cleantech-b51d7032',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Sales Cognitive - Cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your cleantech operations with our Sales Cognitive - Cleantech. This AI-driven solution automates document processing with unprecedented accuracy and efficiency.
          </p>
