...
export const metadata: Metadata = {
  title: 'AI-Powered Optimizer for Construction #1',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Optimizer for Construction #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: AI-Powered Optimizer for Construction #1. Combines document processing with adaptive intelligence for optimal results.
          </p>
