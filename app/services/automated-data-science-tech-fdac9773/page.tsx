...
export const metadata: Metadata = {
  title: 'Automated data science-tech',
  description: 'Revolutionize technology through intelligent automation. Our Automated data science-tech leverages advanced machine learning to deliver enterprise-grade insight',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated data science-tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our Automated data science-tech leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
