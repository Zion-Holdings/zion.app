...
export const metadata: Metadata = {
  title: 'Intelligent Customer for ALTHEALTH',
  description: 'Drive innovation in althealth with Intelligent Customer for ALTHEALTH. This AI-powered platform transforms lead scoring into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-customer-for-althealth-5995ea58',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Customer for ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in althealth with Intelligent Customer for ALTHEALTH. This AI-powered platform transforms lead scoring into a competitive advantage.
          </p>
