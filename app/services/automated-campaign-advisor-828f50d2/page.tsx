...
export const metadata: Metadata = {
  title: 'Automated Campaign Advisor',
  description: 'Drive innovation in agriculture with Automated Campaign Advisor. This AI-powered platform transforms invoice processing into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-campaign-advisor-828f50d2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Campaign Advisor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in agriculture with Automated Campaign Advisor. This AI-powered platform transforms invoice processing into a competitive advantage.
          </p>
