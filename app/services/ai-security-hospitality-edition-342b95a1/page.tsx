...
export const metadata: Metadata = {
  title: 'AI Security - Hospitality Edition',
  description: 'Revolutionize hospitality through intelligent automation. Our AI Security - Hospitality Edition leverages advanced machine learning to deliver enterprise-grade ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-security-hospitality-edition-342b95a1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Security - Hospitality Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our AI Security - Hospitality Edition leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
