...
export const metadata: Metadata = {
  title: 'Marketing Intelligence AI-Powered CRM Automation',
  description: 'AI-powered marketing intelligence solution for sales. Automates customer relationship management with AI-driven insights and follow-ups.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/marketing-intelligence-ai-powered-crm-automation-7b8a2170',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Marketing Intelligence AI-Powered CRM Automation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered marketing intelligence solution for sales. Automates customer relationship management with AI-driven insights and follow-ups.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">CRM automation</li>
          <li className="text-gray-300">AI insights</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">30% more deals</li>
          <li className="text-purple-300">Better follow-ups</li>
          </ul>
        </section>
