...
export const metadata: Metadata = {
  title: 'AI-Driven Manager for Construction',
  description: 'Transform your construction operations with our AI-Driven Manager for Construction. This AI-driven solution automates process automation with unprecedented accu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Driven Manager for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our AI-Driven Manager for Construction. This AI-driven solution automates process automation with unprecedented accuracy and efficiency.
          </p>
