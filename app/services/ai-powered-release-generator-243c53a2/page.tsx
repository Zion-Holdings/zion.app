...
export const metadata: Metadata = {
  title: 'AI-Powered Release Generator',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Release Generator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your technology business with AI-Powered Release Generator. Our solution provides api management with enterprise-grade reliability and security.
          </p>
