...
export const metadata: Metadata = {
  title: 'Smart Process Mining Platform - Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Smart Process Mining Platform - Insurance leverages advanced machine learning to deliver disaster re',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-process-mining-platform-insurance-f69259a7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Process Mining Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Smart Process Mining Platform - Insurance leverages advanced machine learning to deliver disaster recovery at scale.
          </p>
