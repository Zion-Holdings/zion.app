...
export const metadata: Metadata = {
  title: 'Intelligence Intelligent - Agriculture',
  description: 'The future of agriculture is here with Intelligence Intelligent - Agriculture. Powered by cutting-edge AI, this platform delivers transformative results like ne',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligence-intelligent-agriculture-d4a6e79e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligence Intelligent - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Intelligence Intelligent - Agriculture. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
