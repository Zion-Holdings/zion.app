...
export const metadata: Metadata = {
  title: 'Suite Adaptive - Retail',
  description: 'The future of retail is here with Suite Adaptive - Retail. Powered by cutting-edge AI, this platform delivers customer retention like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/suite-adaptive-retail-85b2cb78',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Suite Adaptive - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Suite Adaptive - Retail. Powered by cutting-edge AI, this platform delivers customer retention like never before.
          </p>
