...
export const metadata: Metadata = {
  title: 'Cognitive Orchestrator Solution - REGTECH',
  description: 'Revolutionize regtech through intelligent automation. Our Cognitive Orchestrator Solution - REGTECH leverages advanced machine learning to deliver customer jour',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-orchestrator-solution-regtech-e6681ca6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Orchestrator Solution - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize regtech through intelligent automation. Our Cognitive Orchestrator Solution - REGTECH leverages advanced machine learning to deliver customer journey mapping at scale.
          </p>
