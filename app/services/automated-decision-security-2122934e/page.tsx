...
export const metadata: Metadata = {
  title: 'Automated Decision Security',
  description: 'The future of iot is here with Automated Decision Security. Powered by cutting-edge AI, this platform delivers data processing like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-decision-security-2122934e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Decision Security
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of iot is here with Automated Decision Security. Powered by cutting-edge AI, this platform delivers data processing like never before.
          </p>
