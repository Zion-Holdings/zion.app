...
export const metadata: Metadata = {
  title: 'Neural Content Platform',
  description: 'Optimize your transportation workflows with Neural Content Platform. This intelligent platform delivers compliance monitoring through advanced automation and AI',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-content-platform-c41edf4e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Content Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Neural Content Platform. This intelligent platform delivers compliance monitoring through advanced automation and AI.
          </p>
