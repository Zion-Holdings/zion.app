...
export const metadata = {
  ...
  description: "Revolutionize Agriculture through intelligent automation. Our AI Insights - Agriculture Edition #2 leverages advanced machine learning to deliver inventory mana",
  alternates: {
