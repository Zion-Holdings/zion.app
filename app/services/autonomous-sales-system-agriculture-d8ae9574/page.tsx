...
export const metadata: Metadata = {
  title: 'Autonomous Sales System - Agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Autonomous Sales System - Agriculture leverages advanced machine learning to deliver quality contr',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Sales System - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Autonomous Sales System - Agriculture leverages advanced machine learning to deliver quality control at scale.
          </p>
