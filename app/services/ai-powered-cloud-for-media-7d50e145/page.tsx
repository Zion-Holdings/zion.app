...
export const metadata: Metadata = {
  title: 'AI-Powered Cloud for Media',
  description: 'Optimize your media workflows with AI-Powered Cloud for Media. This intelligent platform delivers compliance reporting through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-cloud-for-media-7d50e145',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Cloud for Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your media workflows with AI-Powered Cloud for Media. This intelligent platform delivers compliance reporting through advanced automation and AI.
          </p>
