...
export const metadata: Metadata = {
  title: 'AI-Powered Healthcare Machine Learning',
  description: 'Transform your media operations with our AI-Powered Healthcare Machine Learning. This AI-driven solution automates feature engineering with unprecedented accura',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Healthcare Machine Learning
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your media operations with our AI-Powered Healthcare Machine Learning. This AI-driven solution automates feature engineering with unprecedented accuracy and efficiency.
          </p>
