...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize construction through intelligent automation. Our Cognitive cognitive-construction leverages advanced machine learning to deliver financial plannin',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Cognitive cognitive-construction leverages advanced machine learning to deliver financial planning at scale.
          </p>
