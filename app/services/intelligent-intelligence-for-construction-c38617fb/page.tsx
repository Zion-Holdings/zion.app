...
export const metadata: Metadata = {
  title: 'Intelligent Intelligence for Construction',
  description: 'Revolutionize construction through intelligent automation. Our Intelligent Intelligence for Construction leverages advanced machine learning to deliver regulato',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-intelligence-for-construction-c38617fb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Intelligence for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Intelligent Intelligence for Construction leverages advanced machine learning to deliver regulatory tracking at scale.
          </p>
