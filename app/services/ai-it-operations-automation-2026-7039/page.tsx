...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "AI IT Operations | Zion Tech Group", description: "End-to-end ai it operations services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/ai-it-operations-automation-2026-7039/"}} />
