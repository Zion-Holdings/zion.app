...
export const metadata: Metadata = {
  title: 'Intelligent Predictor for Hospitality',
  description: 'The future of hospitality is here with Intelligent Predictor for Hospitality. Powered by cutting-edge AI, this platform delivers root cause analysis like never ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-predictor-for-hospitality-9b47a479',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Predictor for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Intelligent Predictor for Hospitality. Powered by cutting-edge AI, this platform delivers root cause analysis like never before.
          </p>
