...
export const metadata: Metadata = {
  title: 'Cognitive Processor System',
  description: 'Transform your construction operations with our Cognitive Processor System. This ai solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-processor-system-8350cf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Processor System
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Cognitive Processor System. This ai solution delivers unprecedented automation and intelligence.
          </p>
