...
export const metadata: Metadata = {
  title: 'Smart Data for Iot',
  description: 'Unlock unprecedented growth with Smart Data for Iot. This autonomous system provides financial planning with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-data-for-iot-b1f051f1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Data for Iot. This autonomous system provides financial planning with zero manual intervention needed.
          </p>
