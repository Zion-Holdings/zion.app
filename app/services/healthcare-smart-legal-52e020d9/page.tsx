...
export const metadata: Metadata = {
  title: 'Healthcare Smart - Legal',
  description: 'The future of legal is here with Healthcare Smart - Legal. Powered by cutting-edge AI, this platform delivers resource utilization like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/healthcare-smart-legal-52e020d9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Healthcare Smart - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Healthcare Smart - Legal. Powered by cutting-edge AI, this platform delivers resource utilization like never before.
          </p>
