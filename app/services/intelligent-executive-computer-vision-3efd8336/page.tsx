...
export const metadata: Metadata = {
  title: 'Intelligent Executive Computer Vision',
  description: 'Transform your transportation operations with our Intelligent Executive Computer Vision. This AI-driven solution automates sales process optimization with unpre',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-executive-computer-vision-3efd8336',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Executive Computer Vision
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your transportation operations with our Intelligent Executive Computer Vision. This AI-driven solution automates sales process optimization with unprecedented accuracy and efficiency.
          </p>
