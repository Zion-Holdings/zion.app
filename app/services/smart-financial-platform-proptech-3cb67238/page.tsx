...
export const metadata: Metadata = {
  title: 'Smart Financial Platform - PROPTECH',
  description: 'Optimize your proptech workflows with Smart Financial Platform - PROPTECH. This intelligent platform delivers resource allocation through advanced automation an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Financial Platform - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your proptech workflows with Smart Financial Platform - PROPTECH. This intelligent platform delivers resource allocation through advanced automation and AI.
          </p>
