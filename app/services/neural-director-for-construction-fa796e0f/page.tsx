...
export const metadata: Metadata = {
  title: 'Neural Director for Construction',
  description: 'Drive innovation in construction with Neural Director for Construction. This AI-powered platform transforms recruitment automation into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-director-for-construction-fa796e0f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Director for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Neural Director for Construction. This AI-powered platform transforms recruitment automation into a competitive advantage.
          </p>
