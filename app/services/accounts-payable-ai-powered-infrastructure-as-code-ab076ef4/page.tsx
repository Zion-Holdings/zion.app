...
export const metadata: Metadata = {
  title: 'Accounts Payable AI-Powered Infrastructure as Code',
  description: 'AI-powered accounts payable solution for infrastructure. AI-generated infrastructure code with best practices and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/accounts-payable-ai-powered-infrastructure-as-code-ab076ef4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Accounts Payable AI-Powered Infrastructure as Code
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered accounts payable solution for infrastructure. AI-generated infrastructure code with best practices and security.
          </p>
