...
export const metadata: Metadata = {
  title: 'Cognitive Platform Solution - EDTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Platform Solution - EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your edtech operations with our Cognitive Platform Solution - EDTECH. This AI-driven solution automates talent acquisition with unprecedented accuracy and efficiency.
          </p>
