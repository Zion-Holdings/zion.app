...
export const metadata: Metadata = {
  title: 'Autonomous Employee System - MARTECH',
  description: 'Optimize your martech workflows with Autonomous Employee System - MARTECH. This intelligent platform delivers receipt processing through advanced automation and',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Employee System - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your martech workflows with Autonomous Employee System - MARTECH. This intelligent platform delivers receipt processing through advanced automation and AI.
          </p>
