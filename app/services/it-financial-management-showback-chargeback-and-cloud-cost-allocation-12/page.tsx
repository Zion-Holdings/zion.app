...
export const metadata = {
  ...
  description: 'End-to-end it financial management: showback, chargeback, and cloud cost allocation services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/it-financial-management-showback-chargeback-and-cloud-cost-allocation-12/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">IT Financial Management: Showback, Chargeback, and Cloud Cost Allocation</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end it financial management: showback, chargeback, and cloud cost allocation services: assessment, deployment, and managed operations.
        </p>
