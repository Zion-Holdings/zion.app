...
export const metadata: Metadata = {
  title: 'Adaptive Budget Data Science',
  description: 'Revolutionize logistics through intelligent automation. Our Adaptive Budget Data Science leverages advanced machine learning to deliver enterprise-grade insight',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Budget Data Science
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Adaptive Budget Data Science leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
