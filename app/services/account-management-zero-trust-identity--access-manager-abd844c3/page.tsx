...
export const metadata: Metadata = {
  title: "Account Management Zero-Trust Identity & Access Manager - AI-Powered LegalTech Solution",
  description: "account management solution for legaltech industry. Implements zero-trust security architecture with continuous authentication and adaptive access controls.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/account-management-zero-trust-identity--access-manager-abd844c3",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Account Management Zero-Trust Identity & Access Manager - AI-Powered LegalTech Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          account management solution for legaltech industry. Implements zero-trust security architecture with continuous authentication and adaptive access controls.
        </p>
