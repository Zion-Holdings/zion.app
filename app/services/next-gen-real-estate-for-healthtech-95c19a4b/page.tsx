...
export const metadata: Metadata = {
  title: 'Next-Gen Real Estate for HEALTHTECH',
  description: 'Transform your healthtech operations with our Next-Gen Real Estate for HEALTHTECH. This AI-driven solution automates click automation with unprecedented accurac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-real-estate-for-healthtech-95c19a4b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Real Estate for HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthtech operations with our Next-Gen Real Estate for HEALTHTECH. This AI-driven solution automates click automation with unprecedented accuracy and efficiency.
          </p>
