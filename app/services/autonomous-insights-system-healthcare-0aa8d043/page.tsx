...
export const metadata: Metadata = {
  title: 'Autonomous Insights System - Healthcare',
  description: 'Unlock unprecedented growth with Autonomous Insights System - Healthcare. This autonomous system provides manufacturing quality control with zero manual interve',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-insights-system-healthcare-0aa8d043',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Insights System - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Autonomous Insights System - Healthcare. This autonomous system provides manufacturing quality control with zero manual intervention needed.
          </p>
