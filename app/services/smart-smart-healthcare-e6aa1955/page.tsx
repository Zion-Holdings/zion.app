...
export const metadata: Metadata = {
  title: 'Smart Smart - Healthcare',
  description: 'Transform your healthcare operations with our Smart Smart - Healthcare. This AI-driven solution provides intelligent automation with unprecedented accuracy and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-smart-healthcare-e6aa1955',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Smart Smart - Healthcare. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
