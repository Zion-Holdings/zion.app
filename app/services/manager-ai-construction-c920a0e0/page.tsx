...
export const metadata: Metadata = {
  title: 'Manager AI - Construction',
  description: 'Revolutionize construction through intelligent automation. Our Manager AI - Construction leverages advanced machine learning to deliver enterprise-grade insight',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/manager-ai-construction-c920a0e0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manager AI - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Manager AI - Construction leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
