...
export const metadata: Metadata = {
  title: 'Smart Engine Platform - Manufacturing',
  description: 'Enhance your manufacturing business with Smart Engine Platform - Manufacturing. Our solution provides ml model training with enterprise-grade reliability and se',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-engine-platform-manufacturing-14cc3ad9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Engine Platform - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your manufacturing business with Smart Engine Platform - Manufacturing. Our solution provides ml model training with enterprise-grade reliability and security.
          </p>
