...
export const metadata: Metadata = {
  ...
  description: 'Next-generation construction solution: Self-Optimizing Quality for Construction. Combines employee engagement with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/self-optimizing-quality-for-construction-452f5cdc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Self-Optimizing Quality for Construction. Combines employee engagement with adaptive intelligence for optimal results.
          </p>
