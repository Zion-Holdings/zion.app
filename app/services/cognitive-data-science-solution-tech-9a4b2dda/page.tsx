...
export const metadata: Metadata = {
  title: 'Cognitive Data Science Solution - Tech',
  description: 'Optimize your technology workflows with Cognitive Data Science Solution - Tech. This intelligent platform delivers brand sentiment through advanced automation a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Data Science Solution - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your technology workflows with Cognitive Data Science Solution - Tech. This intelligent platform delivers brand sentiment through advanced automation and AI.
          </p>
