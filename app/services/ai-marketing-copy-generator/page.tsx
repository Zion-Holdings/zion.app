...
export const metadata: Metadata = {
  ...
  keywords: '10+ output formats (blog/ad/landing/LinkedIn/email), Brand voice training on your tone/guidelines, SEO brief + outline + draft in one pass, Human-in-loop review + approval workflow, ai, E-Commerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Marketing Copy Generator</h1>
        <p className="text-lg text-slate-300 mb-8">Multi-format copy engine: SEO blog, ad headline, landing page, LinkedIn post, email sequence — brand-voice tuned per company.</p>
        ...
        <li class="text-slate-300">10+ output formats (blog/ad/landing/LinkedIn/email)</li>
        <li class="text-slate-300">Brand voice training on your tone/guidelines</li>
        <li class="text-slate-300">SEO brief + outline + draft in one pass</li>
        <li class="text-slate-300">Human-in-loop review + approval workflow</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai marketing copy generator</li>
