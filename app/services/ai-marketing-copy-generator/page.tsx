      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Multi-format copy engine: SEO blog, ad headline, landing page, LinkedIn post, email sequence — brand-voice tuned per company.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ 10+ output formats (blog/ad/landing/LinkedIn/email)</li>
            <li className="text-purple-300">✓ Brand voice training on your tone/guidelines</li>
            <li className="text-purple-300">✓ SEO brief + outline + draft in one pass</li>
            <li className="text-purple-300">✓ Human-in-loop review + approval workflow</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai marketing copy generator</li>
