...
export const metadata: Metadata = {
  title: 'Quantum Suite - Hospitality Quantum #1',
  description: 'Enhance your hospitality business with Quantum Suite - Hospitality Quantum #1. Our solution provides root cause analysis with enterprise-grade reliability and s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-suite-hospitality-quantum-1-920cde9d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Suite - Hospitality Quantum #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Quantum Suite - Hospitality Quantum #1. Our solution provides root cause analysis with enterprise-grade reliability and security.
          </p>
