...
export const metadata: Metadata = {
  title: 'AI Intelligent - Insurance Edition',
  description: 'Transform your insurance operations with our AI Intelligent - Insurance Edition. This AI-driven solution provides intelligent automation with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-intelligent-insurance-edition-b92a9716',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our AI Intelligent - Insurance Edition. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
