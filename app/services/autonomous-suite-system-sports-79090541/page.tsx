...
export const metadata: Metadata = {
  title: 'Autonomous Suite System - Sports',
  description: 'Transform your sports operations with our Autonomous Suite System - Sports. This AI-driven solution automates feedback collection with unprecedented accuracy an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-suite-system-sports-79090541',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Suite System - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our Autonomous Suite System - Sports. This AI-driven solution automates feedback collection with unprecedented accuracy and efficiency.
          </p>
