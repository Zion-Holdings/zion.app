...
export const metadata: Metadata = {
  title: 'Intelligent Predictive for Healthcare',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Predictive for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Intelligent Predictive for Healthcare. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
