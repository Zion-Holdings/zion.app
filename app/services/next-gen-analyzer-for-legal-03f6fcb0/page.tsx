...
export const metadata: Metadata = {
  title: 'Next-Gen Analyzer for Legal',
  description: 'Revolutionize legal through intelligent automation. Our Next-Gen Analyzer for Legal leverages advanced machine learning to deliver supply chain at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-analyzer-for-legal-03f6fcb0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Analyzer for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Next-Gen Analyzer for Legal leverages advanced machine learning to deliver supply chain at scale.
          </p>
