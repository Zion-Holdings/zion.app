...
export const metadata: Metadata = {
  title: 'Intelligence Automated - Legal',
  description: 'Transform your legal operations with our Intelligence Automated - Legal. This AI-driven solution automates logistics route optimization with unprecedented accur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligence-automated-legal-d3d410f9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligence Automated - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Intelligence Automated - Legal. This AI-driven solution automates logistics route optimization with unprecedented accuracy and efficiency.
          </p>
