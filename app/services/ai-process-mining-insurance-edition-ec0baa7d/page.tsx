...
export const metadata: Metadata = {
  title: 'AI Process Mining - Insurance Edition',
  description: 'Drive innovation in insurance with AI Process Mining - Insurance Edition. This AI-powered platform transforms brand sentiment into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-process-mining-insurance-edition-ec0baa7d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Process Mining - Insurance Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with AI Process Mining - Insurance Edition. This AI-powered platform transforms brand sentiment into a competitive advantage.
          </p>
