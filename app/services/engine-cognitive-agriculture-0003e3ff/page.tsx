...
export const metadata: Metadata = {
  title: 'Engine Cognitive - Agriculture',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Engine Cognitive - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Engine Cognitive - Agriculture. Powered by cutting-edge AI, this platform delivers succession planning like never before.
          </p>
