...
export const metadata: Metadata = {
  title: 'Autonomous Automation System - Energy',
  description: 'Optimize your energy workflows with Autonomous Automation System - Energy. This intelligent platform delivers workflow management through advanced automation an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-automation-system-energy-b31df471',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Automation System - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your energy workflows with Autonomous Automation System - Energy. This intelligent platform delivers workflow management through advanced automation and AI.
          </p>
