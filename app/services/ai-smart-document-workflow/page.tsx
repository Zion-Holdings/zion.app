...
export const metadata: Metadata = {
  ...
  keywords: 'AI document classification and routing, Multi-format data extraction (PDF, scan, photo), Automated approval workflows, Exception handling with human-in-the-loop, Integration with ERP, CRM, and ECM systems, Full audit trail and compliance logging, ai, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Smart Document Workflow Automation</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end document workflow automation with AI classification, extraction, routing, and approval. Processes invoices, contracts, forms, and custom documents at scale.</p>
        ...
        <li class="text-slate-300">AI document classification and routing</li>
        <li class="text-slate-300">Multi-format data extraction (PDF, scan, photo)</li>
        <li class="text-slate-300">Automated approval workflows</li>
        <li class="text-slate-300">Exception handling with human-in-the-loop</li>
        <li class="text-slate-300">Integration with ERP, CRM, and ECM systems</li>
        <li class="text-slate-300">Full audit trail and compliance logging</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Process documents 20x faster</li>
        <li class="text-slate-300">Reduce processing costs by 75%</li>
        <li class="text-slate-300">Eliminate manual data entry errors</li>
        <li class="text-slate-300">Scale document operations without adding staff</li>
      </ul>
        </div>
