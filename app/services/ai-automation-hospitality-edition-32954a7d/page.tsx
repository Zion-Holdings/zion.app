...
export const metadata: Metadata = {
  title: 'AI Automation - Hospitality Edition',
  description: 'Drive innovation in hospitality with AI Automation - Hospitality Edition. This AI-powered platform transforms brand sentiment into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-automation-hospitality-edition-32954a7d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Automation - Hospitality Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with AI Automation - Hospitality Edition. This AI-powered platform transforms brand sentiment into a competitive advantage.
          </p>
