...
export const metadata = {
  ...
  description: "Drive innovation in legal with Cognitive Computer Vision Solution - Legal. This AI-powered platform transforms edge computing into a competitive advantage.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/cognitive-computer-vision-solution-legal-017adeaf`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Drive innovation in legal with Cognitive Computer Vision Solution - Legal. This AI-powered platform transforms edge computing into a competitive advantage.</p>
