...
export const metadata: Metadata = {
  title: 'Smart Capacity Marketing',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Capacity Marketing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Capacity Marketing. This autonomous system provides territory management with zero manual intervention needed.
          </p>
