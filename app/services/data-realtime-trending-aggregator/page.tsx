...
export const metadata: Metadata = {
  ...
  keywords: 'Flink + Redpanda backbone with sub-second windowed aggregation, Trend-detection + anomaly-alert engine with statistical significance scoring, Opentelemetry per event — correlate any aggregate back to source event in one click, Live dashboard with drill-through per team with RBAC on views and rows, data, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Real-time Event &amp; Trending Aggregator</h1>
        <p className="text-lg text-slate-300 mb-8">Streaming data platform: Flink/Redpanda backbone, windowed aggregation at sub-second latency, trend-detection anomaly alerts, opentelemetry distributed-tracing per event, dashboarding per team with live drill-through.</p>
        ...
        <li class="text-slate-300">Flink + Redpanda backbone with sub-second windowed aggregation</li>
        <li class="text-slate-300">Trend-detection + anomaly-alert engine with statistical significance scoring</li>
        <li class="text-slate-300">Opentelemetry per event — correlate any aggregate back to source event in one click</li>
        <li class="text-slate-300">Live dashboard with drill-through per team with RBAC on views and rows</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with real-time event &amp; trending aggregator</li>
