...
export const metadata: Metadata = {
  ...
  keywords: 'Remote container browser — the full browser runs in the cloud, pixel-streamed live, Zero download risk — malware, ransomware, and drive-by exploits never touch the endpoint, URL categorisation and DLP inspection on every rendered page, SSL inspection decrypts TLS streams to detect threats encoded within encrypted sessions, security, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Browser Isolation &amp; Web Security</h1>
        <p className="text-lg text-slate-300 mb-8">Remote browser isolation for internet access: containerised browser runs in cloud, pixel-streamed to the user, no download can reach the corporate device, URL categorisation, DLP inspection on every render, and SSL inspection for encoded threats.</p>
        ...
        <li class="text-slate-300">Remote container browser — the full browser runs in the cloud, pixel-streamed live</li>
        <li class="text-slate-300">Zero download risk — malware, ransomware, and drive-by exploits never touch the endpoint</li>
        <li class="text-slate-300">URL categorisation and DLP inspection on every rendered page</li>
        <li class="text-slate-300">SSL inspection decrypts TLS streams to detect threats encoded within encrypted sessions</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with browser isolation &amp; web security</li>
