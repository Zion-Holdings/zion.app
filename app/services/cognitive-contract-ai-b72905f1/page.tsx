...
export const metadata: Metadata = {
  title: 'Cognitive Contract AI',
  description: 'Transform your energy operations with our Cognitive Contract AI. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficie',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-contract-ai-b72905f1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Contract AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Cognitive Contract AI. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
