...
export const metadata: Metadata = {
  title: 'Cognitive Experience for Insurance',
  description: 'The future of insurance is here with Cognitive Experience for Insurance. Powered by cutting-edge AI, this platform delivers sales forecasting like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-experience-for-insurance-b2a22619',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Experience for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Cognitive Experience for Insurance. Powered by cutting-edge AI, this platform delivers sales forecasting like never before.
          </p>
