...
export const metadata: Metadata = {
  title: 'Enterprise Process Mining Platform - Logistics',
  description: 'Optimize your logistics workflows with Enterprise Process Mining Platform - Logistics. This intelligent platform delivers network optimization through advanced ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-process-mining-platform-logistics-d98c8a43',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Process Mining Platform - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your logistics workflows with Enterprise Process Mining Platform - Logistics. This intelligent platform delivers network optimization through advanced automation and AI.
          </p>
