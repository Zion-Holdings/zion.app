...
export const metadata: Metadata = {
  title: 'Smart Analytics Platform - PROPTECH',
  description: 'Quantum leap forward for proptech: Smart Analytics Platform - PROPTECH. Uses quantum-inspired algorithms to deliver territory management at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-analytics-platform-proptech-d84e79ef',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Analytics Platform - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for proptech: Smart Analytics Platform - PROPTECH. Uses quantum-inspired algorithms to deliver territory management at exponential speed.
          </p>
