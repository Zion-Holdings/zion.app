...
export const metadata: Metadata = {
  title: 'Startup Intelligent - REGTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Startup Intelligent - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in regtech with Startup Intelligent - REGTECH. This AI-powered platform transforms maintenance scheduling into a competitive advantage.
          </p>
