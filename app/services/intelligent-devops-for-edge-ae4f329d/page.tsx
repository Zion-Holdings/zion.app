...
export const metadata: Metadata = {
  title: 'Intelligent DevOps for Edge',
  description: 'Revolutionize edge through intelligent automation. Our Intelligent DevOps for Edge leverages advanced machine learning to deliver financial risk management at s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-devops-for-edge-ae4f329d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent DevOps for Edge
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize edge through intelligent automation. Our Intelligent DevOps for Edge leverages advanced machine learning to deliver financial risk management at scale.
          </p>
