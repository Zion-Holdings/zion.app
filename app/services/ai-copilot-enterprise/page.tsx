      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Context-Aware Assistance</li>
            <li className="text-purple-300">✓ Role-Specific Intelligence</li>
            <li className="text-purple-300">✓ Embedded in Your Tools</li>
            <li className="text-purple-300">✓ Controlled & Governed</li>
            <li className="text-purple-300">✓ Learning & Improvement</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai copilot & enterprise assistants</li>
