...
export const metadata: Metadata = {
  ...
  keywords: 'Context-Aware Assistance, Role-Specific Intelligence, Embedded in Your Tools, Controlled & Governed, Learning & Improvement, Multi-Modal Interaction, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Copilot &amp; Enterprise Assistants</h1>
        <p className="text-lg text-slate-300 mb-8">Deploy AI copilots and enterprise assistants that augment human work. Context-aware, role-specific AI embedded in your tools and workflows.</p>
        ...
        <li class="text-slate-300">Context-Aware Assistance</li>
        <li class="text-slate-300">Role-Specific Intelligence</li>
        <li class="text-slate-300">Embedded in Your Tools</li>
        <li class="text-slate-300">Controlled &amp; Governed</li>
        <li class="text-slate-300">Learning &amp; Improvement</li>
        <li class="text-slate-300">Multi-Modal Interaction</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai copilot &amp; enterprise assistants</li>
