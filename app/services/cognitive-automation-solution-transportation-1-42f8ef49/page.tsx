...
export const metadata: Metadata = {
  title: 'Cognitive Automation Solution - Transportation #1',
  description: 'Enhance your transportation business with Cognitive Automation Solution - Transportation #1. Our solution provides customer insights with enterprise-grade relia',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Automation Solution - Transportation #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with Cognitive Automation Solution - Transportation #1. Our solution provides customer insights with enterprise-grade reliability and security.
          </p>
