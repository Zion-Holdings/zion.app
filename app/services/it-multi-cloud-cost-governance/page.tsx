...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-cloud ingestion, Budget thresholds & alerts, Rightsizing AI, Tag compliance enforcement, Department chargeback, it, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Multi-Cloud Cost Governance</h1>
        <p className="text-lg text-slate-300 mb-8">Unified cost visibility and policy enforcement across AWS, Azure, GCP. budgets, alerts, rightsizing recommendations, and chargeback/showback.</p>
        ...
        <li class="text-slate-300">Multi-cloud ingestion</li>
        <li class="text-slate-300">Budget thresholds &amp; alerts</li>
        <li class="text-slate-300">Rightsizing AI</li>
        <li class="text-slate-300">Tag compliance enforcement</li>
        <li class="text-slate-300">Department chargeback</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with multi-cloud cost governance</li>
