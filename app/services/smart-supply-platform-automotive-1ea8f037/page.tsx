...
export const metadata: Metadata = {
  title: 'Smart Supply Platform - Automotive',
  description: 'Enhance your automotive business with Smart Supply Platform - Automotive. Our solution provides business intelligence with enterprise-grade reliability and secu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-supply-platform-automotive-1ea8f037',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Supply Platform - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your automotive business with Smart Supply Platform - Automotive. Our solution provides business intelligence with enterprise-grade reliability and security.
          </p>
