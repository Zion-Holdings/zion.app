...
export const metadata: Metadata = {
  title: 'Cognitive Autonomous for Transportation',
  description: 'Next-generation transportation solution: Cognitive Autonomous for Transportation. Combines healthcare data analytics with adaptive intelligence for optimal resu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-autonomous-for-transportation-f9e761b0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Autonomous for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation transportation solution: Cognitive Autonomous for Transportation. Combines healthcare data analytics with adaptive intelligence for optimal results.
          </p>
