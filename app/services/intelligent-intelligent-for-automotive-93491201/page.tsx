...
export const metadata: Metadata = {
  ...
  description: 'Enhance your automotive business with Intelligent Intelligent for Automotive. Our solution provides access management with enterprise-grade reliability and secu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your automotive business with Intelligent Intelligent for Automotive. Our solution provides access management with enterprise-grade reliability and security.
          </p>
