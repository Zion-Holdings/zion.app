...
export const metadata: Metadata = {
  ...
  keywords: 'SD-WAN design and deployment, SASE (Secure Access Service Edge), Intent-based networking, Network automation and orchestration, Zero-trust network access (ZTNA), 24/7 network monitoring and NOC, Integration with Cisco, Palo Alto, Fortinet, Performance optimization and QoS, it, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Network Modernization &amp; SD-WAN</h1>
        <p className="text-lg text-slate-300 mb-8">Modernize your network with SD-WAN, SASE, and intent-based networking. Reduce costs by 40% while improving performance, security, and reliability.</p>
        ...
        <li class="text-slate-300">SD-WAN design and deployment</li>
        <li class="text-slate-300">SASE (Secure Access Service Edge)</li>
        <li class="text-slate-300">Intent-based networking</li>
        <li class="text-slate-300">Network automation and orchestration</li>
        <li class="text-slate-300">Zero-trust network access (ZTNA)</li>
        <li class="text-slate-300">24/7 network monitoring and NOC</li>
        <li class="text-slate-300">Integration with Cisco, Palo Alto, Fortinet</li>
        <li class="text-slate-300">Performance optimization and QoS</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce network costs by 40%</li>
        <li class="text-slate-300">Improve application performance by 60%</li>
        <li class="text-slate-300">Secure branch offices without backhauling</li>
        <li class="text-slate-300">Automate network operations with zero-touch</li>
      </ul>
        </div>
