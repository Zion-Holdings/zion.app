...
export const metadata: Metadata = {
  title: 'Cognitive Analytics Solution - Sports',
  description: 'Revolutionize sports through intelligent automation. Our Cognitive Analytics Solution - Sports leverages advanced machine learning to deliver vendor management ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Analytics Solution - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Cognitive Analytics Solution - Sports leverages advanced machine learning to deliver vendor management at scale.
          </p>
