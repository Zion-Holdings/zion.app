...
export const metadata: Metadata = {
  title: 'AI Optimization - Insurance Edition',
  description: 'Next-generation insurance solution: AI Optimization - Insurance Edition. Combines demand planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-optimization-insurance-edition-9adf93ec',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Optimization - Insurance Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: AI Optimization - Insurance Edition. Combines demand planning with adaptive intelligence for optimal results.
          </p>
