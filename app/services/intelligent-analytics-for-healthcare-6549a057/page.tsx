...
export const metadata: Metadata = {
  title: 'Intelligent Analytics for Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Intelligent Analytics for Healthcare leverages advanced machine learning to deliver survey automati',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-analytics-for-healthcare-6549a057',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Analytics for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Intelligent Analytics for Healthcare leverages advanced machine learning to deliver survey automation at scale.
          </p>
