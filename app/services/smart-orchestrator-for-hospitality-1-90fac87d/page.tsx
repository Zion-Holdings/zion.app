...
export const metadata: Metadata = {
  title: 'Smart Orchestrator for Hospitality #1',
  description: 'Next-generation hospitality solution: Smart Orchestrator for Hospitality #1. Combines network optimization with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-orchestrator-for-hospitality-1-90fac87d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Orchestrator for Hospitality #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Smart Orchestrator for Hospitality #1. Combines network optimization with adaptive intelligence for optimal results.
          </p>
