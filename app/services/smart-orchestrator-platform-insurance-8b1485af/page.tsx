...
export const metadata: Metadata = {
  title: 'Smart Orchestrator Platform - Insurance',
  description: 'Enhance your insurance business with Smart Orchestrator Platform - Insurance. Our solution provides customer insights with enterprise-grade reliability and secu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Orchestrator Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Smart Orchestrator Platform - Insurance. Our solution provides customer insights with enterprise-grade reliability and security.
          </p>
