...
export const metadata: Metadata = {
  title: 'AI Compliance - Hospitality Edition',
  description: 'The future of hospitality is here with AI Compliance - Hospitality Edition. Powered by cutting-edge AI, this platform delivers transformative results like never',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-compliance-hospitality-edition-9ed70b7f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Compliance - Hospitality Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with AI Compliance - Hospitality Edition. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
