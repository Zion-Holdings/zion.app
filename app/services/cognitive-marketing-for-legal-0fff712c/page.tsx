...
export const metadata: Metadata = {
  title: 'Cognitive Marketing for Legal',
  description: 'Revolutionize legal through intelligent automation. Our Cognitive Marketing for Legal leverages advanced machine learning to deliver account planning at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-marketing-for-legal-0fff712c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Marketing for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Cognitive Marketing for Legal leverages advanced machine learning to deliver account planning at scale.
          </p>
