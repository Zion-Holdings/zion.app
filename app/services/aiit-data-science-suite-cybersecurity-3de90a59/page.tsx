...
export const metadata: Metadata = {
  title: 'AI/IT Data Science Suite - Cybersecurity',
  description: 'Hyper-accelerated cybersecurity solution: AI/IT Data Science Suite - Cybersecurity. Combines social media monitoring with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-data-science-suite-cybersecurity-3de90a59',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Data Science Suite - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated cybersecurity solution: AI/IT Data Science Suite - Cybersecurity. Combines social media monitoring with next-gen AI for maximum velocity.
          </p>
