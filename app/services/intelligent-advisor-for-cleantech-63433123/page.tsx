...
export const metadata: Metadata = {
  title: 'Intelligent Advisor for Cleantech',
  description: 'Transform your cleantech operations with our Intelligent Advisor for Cleantech. This AI-driven solution automates document processing with unprecedented accurac',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Advisor for Cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your cleantech operations with our Intelligent Advisor for Cleantech. This AI-driven solution automates document processing with unprecedented accuracy and efficiency.
          </p>
