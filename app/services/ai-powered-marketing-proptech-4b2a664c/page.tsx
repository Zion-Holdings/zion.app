...
export const metadata: Metadata = {
  title: 'AI-Powered marketing-proptech',
  description: 'Revolutionize proptech through intelligent automation. Our AI-Powered marketing-proptech leverages advanced machine learning to deliver content generation at sc',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered marketing-proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our AI-Powered marketing-proptech leverages advanced machine learning to deliver content generation at scale.
          </p>
