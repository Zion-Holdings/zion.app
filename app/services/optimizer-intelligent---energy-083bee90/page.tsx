...
export const metadata: Metadata = {
  title: 'Optimizer Intelligent - Energy',
  description: 'Revolutionize energy through intelligent automation. Our Optimizer Intelligent - Energy leverages advanced machine learning to deliver customer insights at scal',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/optimizer-intelligent---energy-083bee90',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Optimizer Intelligent - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Optimizer Intelligent - Energy leverages advanced machine learning to deliver customer insights at scale.
          </p>
