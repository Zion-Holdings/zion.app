...
export const metadata: Metadata = {
  title: 'Neural security-sports',
  description: 'Next-generation sports solution: Neural security-sports. Combines market intelligence with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-security-sports-bed4b1ca',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural security-sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation sports solution: Neural security-sports. Combines market intelligence with adaptive intelligence for optimal results.
          </p>
