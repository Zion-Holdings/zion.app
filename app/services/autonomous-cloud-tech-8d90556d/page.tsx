...
export const metadata: Metadata = {
  title: 'Autonomous cloud-tech',
  description: 'Next-generation technology solution: Autonomous cloud-tech. Combines invoice processing with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-cloud-tech-8d90556d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous cloud-tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation technology solution: Autonomous cloud-tech. Combines invoice processing with adaptive intelligence for optimal results.
          </p>
