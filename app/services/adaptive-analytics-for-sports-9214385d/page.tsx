...
export const metadata: Metadata = {
  title: 'Adaptive Analytics for Sports',
  description: 'Next-generation sports solution: Adaptive Analytics for Sports. Combines data processing with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-analytics-for-sports-9214385d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Analytics for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation sports solution: Adaptive Analytics for Sports. Combines data processing with adaptive intelligence for optimal results.
          </p>
