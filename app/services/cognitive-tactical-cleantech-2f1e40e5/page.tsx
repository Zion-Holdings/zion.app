...
export const metadata: Metadata = {
  title: 'Cognitive tactical-cleantech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive tactical-cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in cleantech with Cognitive tactical-cleantech. This AI-powered platform transforms sustainability tracking into a competitive advantage.
          </p>
