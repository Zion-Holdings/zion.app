...
export const metadata: Metadata = {
  title: "AI-Powered Dashboard Creation - AI-Powered BI Solution",
  description: "Auto-generates dashboards from data patterns and user behavior.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-dashboard-creation-9f9cbb3b",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Dashboard Creation - AI-Powered BI Solution
        </h1>
