...
export const metadata: Metadata = {
  title: 'Smart knowledge-legal',
  description: 'Optimize your legal workflows with Smart knowledge-legal. This intelligent platform delivers training optimization through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-knowledge-legal-d677daa8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart knowledge-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with Smart knowledge-legal. This intelligent platform delivers training optimization through advanced automation and AI.
          </p>
