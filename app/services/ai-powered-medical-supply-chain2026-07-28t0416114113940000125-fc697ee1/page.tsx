...
export const metadata: Metadata = {
  title: 'AI-Powered Medical Supply Chain',
  description: 'Optimizes medical supply chain with demand forecasting and inventory.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-medical-supply-chain2026-07-28t0416114113940000125-fc697ee1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimizes medical supply chain with demand forecasting and inventory.
          </p>
