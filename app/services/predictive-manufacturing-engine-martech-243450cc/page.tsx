...
export const metadata: Metadata = {
  title: 'Predictive Manufacturing Engine - MARTECH',
  description: 'The future of martech is here with Predictive Manufacturing Engine - MARTECH. Powered by cutting-edge AI, this platform delivers image recognition like never be',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Manufacturing Engine - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of martech is here with Predictive Manufacturing Engine - MARTECH. Powered by cutting-edge AI, this platform delivers image recognition like never before.
          </p>
