...
export const metadata: Metadata = {
  title: 'Self-Optimizing Decision Suite',
  description: 'Transform your energy operations with our Self-Optimizing Decision Suite. This AI-driven solution automates healthcare data analytics with unprecedented accurac',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Decision Suite
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Self-Optimizing Decision Suite. This AI-driven solution automates healthcare data analytics with unprecedented accuracy and efficiency.
          </p>
