...
export const metadata: Metadata = {
  ...
  description: 'Drive innovation in education with Intelligent Analytics for Education. This AI-powered platform transforms brand sentiment into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-analytics-for-education-3d9e9572',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in education with Intelligent Analytics for Education. This AI-powered platform transforms brand sentiment into a competitive advantage.
          </p>
