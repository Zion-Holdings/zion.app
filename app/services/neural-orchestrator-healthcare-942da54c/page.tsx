...
export const metadata: Metadata = {
  title: 'Neural orchestrator-healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Neural orchestrator-healthcare leverages advanced machine learning to deliver enterprise-grade insi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-orchestrator-healthcare-942da54c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural orchestrator-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Neural orchestrator-healthcare leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
