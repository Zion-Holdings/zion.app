...
export const metadata: Metadata = {
  title: 'Intelligent Management for Sports',
  description: 'Next-generation sports solution: Intelligent Management for Sports. Combines disaster recovery with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-management-for-sports-adf7ea19',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Management for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation sports solution: Intelligent Management for Sports. Combines disaster recovery with adaptive intelligence for optimal results.
          </p>
