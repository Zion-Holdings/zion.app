...
export const metadata: Metadata = {
  title: 'Intelligent Suite for Automotive',
  description: 'Optimize your automotive workflows with Intelligent Suite for Automotive. This intelligent platform delivers budget optimization through advanced automation and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-suite-for-automotive-c617f31d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Suite for Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your automotive workflows with Intelligent Suite for Automotive. This intelligent platform delivers budget optimization through advanced automation and AI.
          </p>
