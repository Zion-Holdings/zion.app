...
export const metadata: Metadata = {
  title: 'AI Engine - Automotive Edition',
  description: 'Next-generation automotive solution: AI Engine - Automotive Edition. Combines sales forecasting with adaptive intelligence for optimal results.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Engine - Automotive Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation automotive solution: AI Engine - Automotive Edition. Combines sales forecasting with adaptive intelligence for optimal results.
          </p>
