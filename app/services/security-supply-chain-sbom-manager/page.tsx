...
export const metadata: Metadata = {
  ...
  keywords: 'Auto-generate SBOM per build in SPDX and Cyclone-DX formats, License compliance matrix covering GPL, Apache, MIT, and commercial licenses, CVE matching per SBOM component auto-updated daily from NVD and vendor feeds, Attestation signing and SBOM consumer portal per vendor per OS release, security, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Software Bill-of-Materials Manager</h1>
        <p className="text-lg text-slate-300 mb-8">Full SBOM lifecycle management: auto-generate SPDX and Cyclone-DX per build, license-compliance check, vulnerability and CVE matching per component, attestation signing, and SBOM consumer portal per vendor release.</p>
        ...
        <li class="text-slate-300">Auto-generate SBOM per build in SPDX and Cyclone-DX formats</li>
        <li class="text-slate-300">License compliance matrix covering GPL, Apache, MIT, and commercial licenses</li>
        <li class="text-slate-300">CVE matching per SBOM component auto-updated daily from NVD and vendor feeds</li>
        <li class="text-slate-300">Attestation signing and SBOM consumer portal per vendor per OS release</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with software bill-of-materials manager</li>
