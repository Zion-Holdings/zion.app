...
export const metadata: Metadata = {
  ...
  keywords: 'Drag-and-drop catalogue designer, CMDB auto-import and sync, Multi-language service description, Self-service portal embed, Version history and approval, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Service Catalog Builder</h1>
        <p className="text-lg text-slate-300 mb-8">Drag-and-drop service catalog designer for ITSM teams. Auto-generates from CMDB data, supports multi-language publication, and integrates with ServiceNow and Jira.</p>
        ...
        <li class="text-slate-300">Drag-and-drop catalogue designer</li>
        <li class="text-slate-300">CMDB auto-import and sync</li>
        <li class="text-slate-300">Multi-language service description</li>
        <li class="text-slate-300">Self-service portal embed</li>
        <li class="text-slate-300">Version history and approval</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with it service catalog builder</li>
