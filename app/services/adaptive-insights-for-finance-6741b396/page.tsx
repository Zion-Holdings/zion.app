...
export const metadata: Metadata = {
  title: 'Adaptive Insights for Finance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our Adaptive Insights for Finance leverages advanced machine learning to deliver manufacturing quality control at scale.
          </p>
