...
export const metadata: Metadata = {
  title: 'Intelligent Disaster Processor',
  description: 'Revolutionize legal through intelligent automation. Our Intelligent Disaster Processor leverages advanced machine learning to deliver enterprise-grade insights ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-disaster-processor-e6241923',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Disaster Processor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Intelligent Disaster Processor leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
