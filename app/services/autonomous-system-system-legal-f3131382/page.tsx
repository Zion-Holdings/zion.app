...
export const metadata: Metadata = {
  ...
  description: 'Drive innovation in legal with Autonomous System System - Legal. This AI-powered platform transforms roi tracking into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-system-system-legal-f3131382',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Autonomous System System - Legal. This AI-powered platform transforms roi tracking into a competitive advantage.
          </p>
