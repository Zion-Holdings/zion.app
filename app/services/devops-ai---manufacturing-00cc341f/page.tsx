...
export const metadata: Metadata = {
  title: 'DevOps AI - Manufacturing',
  description: 'The future of manufacturing is here with DevOps AI - Manufacturing. Powered by cutting-edge AI, this platform delivers financial risk management like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/devops-ai---manufacturing-00cc341f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            DevOps AI - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of manufacturing is here with DevOps AI - Manufacturing. Powered by cutting-edge AI, this platform delivers financial risk management like never before.
          </p>
