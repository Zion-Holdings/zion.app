...
export const metadata: Metadata = {
  title: 'AI-Powered Warehouse Automation',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Intelligent warehouse management system that optimizes picking, packing, and shipping processes.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Pick optimization</li>
          <li className="text-gray-300">Packing algorithms</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">50% faster fulfillment</li>
