...
export const metadata: Metadata = {
  title: 'Smart Predictive for Construction',
  description: 'Enhance your construction business with Smart Predictive for Construction. Our solution provides net promoter score with enterprise-grade reliability and securi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Predictive for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Smart Predictive for Construction. Our solution provides net promoter score with enterprise-grade reliability and security.
          </p>
