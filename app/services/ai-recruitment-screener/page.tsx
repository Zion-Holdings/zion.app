...
export const metadata: Metadata = {
  title: "AI Recruitment Screening Platform | Zion Tech Group",
  ...
  openGraph: {
    title: "AI Recruitment Screening Platform | Zion Tech Group",
    description: "Bias-aware AI recruitment platform that screens resumes, ranks candidates, and conducts initial video interview analysis. Ensures fair evaluation while reducing time-to-hire by 60%.",
    url: "https://ziontechgroup.com/services/ai-recruitment-screener/",
    type: 'website',
  },
  alternates: { canonical: "/services/ai-recruitment-screener/" },
};

export default function AiRecruitmentScreenerPage() {
  return (
    <StandardPage
      title="AI Recruitment Screening Platform"
      subtitle="Bias-aware AI recruitment platform that screens resumes, ranks candidates, and conducts initial video interview analysis. Ensures fair evaluation while reducing time-to-hire by 60%."
      breadcrumbItems={[
        { label: "Home", href: "/" },
        { label: "Services", href: "/services/" },
        { label: "AI Recruitment Screening Platform" }
      ]}
      actions={[
    ...
    >
        ...
        <div className="rounded-2xl border border-white/10 bg-slate-900/40 p-5"><h2 className="text-white font-semibold mb-2">AI Recruitment Screening Platform</h2><p className="text-slate-400 text-sm">Archived section recovered from the live site snapshot.</p></div>
      ...
      <p className="text-slate-400 leading-relaxed mb-4 max-w-5xl mx-auto">Estimated timeline for AI Recruitment Screening Platform — adapt to your team size and complexity.</p>
      ...
      <p className="text-slate-500 text-sm max-w-5xl mx-auto">Restored from a Wayback Machine snapshot (20260614104639) of ziontechgroup.com.</p>
    </StandardPage>
  );
}
