...
export const metadata: Metadata = {
  title: 'Next-Gen Real Estate - Ecommerce',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Real Estate - Ecommerce
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your ecommerce business with Next-Gen Real Estate - Ecommerce. Our solution provides scalability planning with enterprise-grade reliability and security.
          </p>
