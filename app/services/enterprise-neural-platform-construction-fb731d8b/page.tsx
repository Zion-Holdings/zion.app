...
export const metadata: Metadata = {
  title: 'Enterprise Neural Platform - Construction',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Neural Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Enterprise Neural Platform - Construction. Our solution provides career development with enterprise-grade reliability and security.
          </p>
