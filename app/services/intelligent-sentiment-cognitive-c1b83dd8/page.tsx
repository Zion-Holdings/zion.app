...
export const metadata: Metadata = {
  title: 'Intelligent Sentiment Cognitive',
  description: 'The future of healthcare is here with Intelligent Sentiment Cognitive. Powered by cutting-edge AI, this platform delivers transformative results like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-sentiment-cognitive-c1b83dd8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Sentiment Cognitive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Intelligent Sentiment Cognitive. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
