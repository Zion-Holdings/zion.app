...
export const metadata: Metadata = {
  title: 'Smart Management for Hospitality #2',
  description: 'Transform your hospitality operations with our Smart Management for Hospitality #2. This AI-driven solution automates threat detection with unprecedented accura',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-management-for-hospitality-2-be4da8c4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Management for Hospitality #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Smart Management for Hospitality #2. This AI-driven solution automates threat detection with unprecedented accuracy and efficiency.
          </p>
