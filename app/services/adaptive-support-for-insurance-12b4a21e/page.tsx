...
export const metadata: Metadata = {
  title: 'Adaptive Support for Insurance',
  description: 'Transform your insurance operations with our Adaptive Support for Insurance. This AI-driven solution automates data processing with unprecedented accuracy and e',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-support-for-insurance-12b4a21e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Support for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Adaptive Support for Insurance. This AI-driven solution automates data processing with unprecedented accuracy and efficiency.
          </p>
