...
export const metadata: Metadata = {
  ...
  description: 'Unlock unprecedented growth with Smart Business Intelligence Platform - Tech. This autonomous system provides access management with zero manual intervention ne',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-business-intelligence-platform-tech-0757f7ae',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Business Intelligence Platform - Tech. This autonomous system provides access management with zero manual intervention needed.
          </p>
