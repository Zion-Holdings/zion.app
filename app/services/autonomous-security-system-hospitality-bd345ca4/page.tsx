...
export const metadata: Metadata = {
  title: 'Autonomous Security System - Hospitality',
  description: 'Unlock unprecedented growth with Autonomous Security System - Hospitality. This autonomous system provides container orchestration with zero manual intervention',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-security-system-hospitality-bd345ca4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Security System - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Autonomous Security System - Hospitality. This autonomous system provides container orchestration with zero manual intervention needed.
          </p>
