...
export const metadata: Metadata = {
  ...
  keywords: 'API Gateway + Lambda per route, OpenAPI-first gateway from spec, Per-route WAF + Shield DDoS protection, X-Ray distributed tracing per request, CI/CD spec-driven deploy pipeline, cloud, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Serverless API Production Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Production serverless API: API Gateway + Lambda, OpenAPI-first gateway, per-route WAF+Shield, distributed tracing, CI/CD spec-to-gateway pipeline.</p>
        ...
        <li class="text-slate-300">API Gateway + Lambda per route</li>
        <li class="text-slate-300">OpenAPI-first gateway from spec</li>
        <li class="text-slate-300">Per-route WAF + Shield DDoS protection</li>
        <li class="text-slate-300">X-Ray distributed tracing per request</li>
        <li class="text-slate-300">CI/CD spec-driven deploy pipeline</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with serverless api production platform</li>
