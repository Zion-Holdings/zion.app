...
export const metadata: Metadata = {
  title: 'Deal Registration Real-Time Data Pipeline Platform',
  description: 'deal registration solution for gaming industry. Creates and manages real-time data pipelines with automated ETL and streaming analytics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/deal-registration-real-time-data-pipeline-platform-98d9cf9b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Deal Registration Real-Time Data Pipeline Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            deal registration solution for gaming industry. Creates and manages real-time data pipelines with automated ETL and streaming analytics.
          </p>
