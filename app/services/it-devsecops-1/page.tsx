  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">DevSecOps &amp; Security Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Embed security into CI/CD pipelines with automated SAST, DAST, SCA, container scanning, and infrastructure-as-code security checks — shifting security left without slowing delivery.</p>
        ...
        <li class="text-slate-300">Automated SAST/DAST scanning in CI/CD</li>
        <li class="text-slate-300">Software composition analysis (SCA) for dependencies</li>
        <li class="text-slate-300">Container and Kubernetes security scanning</li>
        <li class="text-slate-300">Infrastructure-as-code security validation (Terraform, CloudFormation)</li>
        <li class="text-slate-300">Secrets detection and rotation automation</li>
        <li class="text-slate-300">SBOM generation and vulnerability tracking</li>
        <li class="text-slate-300">Threat modeling automation</li>
        <li class="text-slate-300">Compliance-as-code policy enforcement</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with devsecops &amp; security automation</li>
