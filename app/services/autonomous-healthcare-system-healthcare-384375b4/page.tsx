...
export const metadata: Metadata = {
  title: 'Autonomous Healthcare System - Healthcare',
  description: 'Transform your healthcare operations with our Autonomous Healthcare System - Healthcare. This AI-driven solution automates threat detection with unprecedented a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-healthcare-system-healthcare-384375b4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Healthcare System - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Autonomous Healthcare System - Healthcare. This AI-driven solution automates threat detection with unprecedented accuracy and efficiency.
          </p>
