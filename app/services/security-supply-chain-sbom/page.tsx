  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Supply Chain SBOM &amp; Vulnerability Intelligence</h1>
        <p className="text-lg text-slate-300 mb-8">Automated SBOM generation, dependency attestation, real-time CVE/SSVC scoring, exploitability prediction, automated PR patch suggestions, and SLSA provenance verification — closing the software supply-chain attack window at build time.</p>
        ...
        <li class="text-slate-300">Automated SBOM generation per-commit, per-PR, and per-release — CycloneDX + SPDX both supported</li>
        <li class="text-slate-300">SSVC scoring maps CVE severity against exploitability + patch availability in real-time</li>
        <li class="text-slate-300">Automated security PRs: patch suggestion AI opens PR per vulnerable dependency</li>
        <li class="text-slate-300">SLSA provenance: build time + identity verification signed and traceable per artefact</li>
        <li class="text-slate-300">Bill of Materials attestation built into container image and artifact metadata</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with supply chain sbom &amp; vulnerability intelligence</li>
