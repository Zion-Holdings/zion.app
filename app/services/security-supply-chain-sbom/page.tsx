    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce supply-chain attack surface 80%+ through automated SBOM and patch PR automation</li>
            <li>Shrink mean-time-to-patch critical CVEs from weeks to hours via automated PR suggestions</li>
            <li>Achieve SLSA Level 3+ build provenance sufficient for regulated industry compliance</li>
          </ul>
        </div>
