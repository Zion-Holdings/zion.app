...
export const metadata: Metadata = {
  title: 'Intelligent Document Processing Autonomous Customer Service AI',
  description: 'intelligent document processing solution for cultural heritage industry. Fully automated customer support system that handles 80% of inquiries without human int',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-document-processing-autonomous-customer-service-ai-c8ce0d21',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Document Processing Autonomous Customer Service AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            intelligent document processing solution for cultural heritage industry. Fully automated customer support system that handles 80% of inquiries without human intervention.
          </p>
