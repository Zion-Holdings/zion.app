...
export const metadata: Metadata = {
  title: 'Knowledge Automated - Hospitality',
  description: 'Transform your hospitality operations with our Knowledge Automated - Hospitality. This AI-driven solution automates resource allocation with unprecedented accur',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Knowledge Automated - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Knowledge Automated - Hospitality. This AI-driven solution automates resource allocation with unprecedented accuracy and efficiency.
          </p>
