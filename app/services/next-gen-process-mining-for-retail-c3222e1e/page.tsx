...
export const metadata: Metadata = {
  title: 'Next-Gen Process Mining for Retail',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Process Mining for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your retail with Next-Gen Process Mining for Retail. Our autonomous solution handles energy management end-to-end without human intervention.
          </p>
