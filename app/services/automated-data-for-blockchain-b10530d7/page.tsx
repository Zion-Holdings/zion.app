...
export const metadata: Metadata = {
  title: 'Automated Data for Blockchain',
  description: 'Next-generation blockchain solution: Automated Data for Blockchain. Combines logistics route optimization with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-data-for-blockchain-b10530d7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Data for Blockchain
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation blockchain solution: Automated Data for Blockchain. Combines logistics route optimization with adaptive intelligence for optimal results.
          </p>
