...
export const metadata: Metadata = {
  title: 'Cognitive customer service-insurance',
  description: 'The future of insurance is here with Cognitive customer service-insurance. Powered by cutting-edge AI, this platform delivers user provisioning like never befor',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive customer service-insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Cognitive customer service-insurance. Powered by cutting-edge AI, this platform delivers user provisioning like never before.
          </p>
