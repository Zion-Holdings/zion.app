...
export const metadata: Metadata = {
  title: 'Automation Cognitive - Construction',
  description: 'Drive innovation in construction with Automation Cognitive - Construction. This AI-powered platform transforms customer journey mapping into a competitive advan',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automation-cognitive-construction-27ad6849',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automation Cognitive - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Automation Cognitive - Construction. This AI-powered platform transforms customer journey mapping into a competitive advantage.
          </p>
