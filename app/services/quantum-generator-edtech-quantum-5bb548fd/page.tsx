...
export const metadata: Metadata = {
  title: 'Quantum Generator - EDTECH Quantum',
  description: 'Drive innovation in edtech with Quantum Generator - EDTECH Quantum. This AI-powered platform transforms predictive analytics into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-generator-edtech-quantum-5bb548fd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Generator - EDTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in edtech with Quantum Generator - EDTECH Quantum. This AI-powered platform transforms predictive analytics into a competitive advantage.
          </p>
