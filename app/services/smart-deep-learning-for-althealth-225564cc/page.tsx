...
export const metadata: Metadata = {
  title: 'Smart Deep Learning for ALTHEALTH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Deep Learning for ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize althealth through intelligent automation. Our Smart Deep Learning for ALTHEALTH leverages advanced machine learning to deliver time tracking at scale.
          </p>
