...
export const metadata: Metadata = {
  ...
  description: "Autonomous AI security analyst that continuously monitors networks, endpoints, and cloud workloads for threats. Mimics human SOC analyst decision-making with automated triage, investigation, and response \u2014 operating 24/7",
  openGraph: {
    title: "AI Cybersecurity Analyst | Zion Tech Group",
    description: "Autonomous AI security analyst that continuously monitors networks, endpoints, and cloud workloads for threats. Mimics human SOC analyst decision-making with automated triage, investigation, and response \u2014 operating 24/7",
    url: "https://ziontechgroup.com/services/ai-cybersecurity-analyst/",
    type: 'website',
  },
  alternates: { canonical: "/services/ai-cybersecurity-analyst/" },
};

export default function AiCybersecurityAnalystPage() {
  return (
    <StandardPage
      title="AI Cybersecurity Analyst"
      subtitle="Autonomous AI security analyst that continuously monitors networks, endpoints, and cloud workloads for threats. Mimics human SOC analyst decision-making with automated triage, investigation, and response \u2014 operating 24/7"
      breadcrumbItems={[
        { label: "Home", href: "/" },
        { label: "Services", href: "/services/" },
        { label: "AI Cybersecurity Analyst" }
      ]}
      actions={[
    ...
    >
        ...
        <div className="rounded-2xl border border-white/10 bg-slate-900/40 p-5"><h2 className="text-white font-semibold mb-2">AI Cybersecurity Analyst</h2><p className="text-slate-400 text-sm">Archived section recovered from the live site snapshot.</p></div>
      ...
      <p className="text-slate-400 leading-relaxed mb-4 max-w-5xl mx-auto">Estimated timeline for AI Cybersecurity Analyst — adapt to your team size and complexity.</p>
      ...
      <p className="text-slate-500 text-sm max-w-5xl mx-auto">Restored from a Wayback Machine snapshot (20260607200317) of ziontechgroup.com.</p>
    </StandardPage>
  );
}
