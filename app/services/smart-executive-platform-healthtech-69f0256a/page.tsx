...
export const metadata: Metadata = {
  title: 'Smart Executive Platform - HEALTHTECH',
  description: 'Quantum leap forward for healthtech: Smart Executive Platform - HEALTHTECH. Uses quantum-inspired algorithms to deliver document ai at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-executive-platform-healthtech-69f0256a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Executive Platform - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for healthtech: Smart Executive Platform - HEALTHTECH. Uses quantum-inspired algorithms to deliver document ai at exponential speed.
          </p>
