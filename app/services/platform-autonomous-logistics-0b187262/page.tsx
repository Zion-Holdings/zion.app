...
export const metadata: Metadata = {
  title: 'Platform Autonomous - Logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Platform Autonomous - Logistics leverages advanced machine learning to deliver quality assurance at ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Platform Autonomous - Logistics leverages advanced machine learning to deliver quality assurance at scale.
          </p>
