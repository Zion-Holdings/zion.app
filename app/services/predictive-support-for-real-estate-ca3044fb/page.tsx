...
export const metadata: Metadata = {
  title: 'Predictive Support for Real-Estate',
  description: 'The future of real-estate is here with Predictive Support for Real-Estate. Powered by cutting-edge AI, this platform delivers release management like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-support-for-real-estate-ca3044fb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Support for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of real-estate is here with Predictive Support for Real-Estate. Powered by cutting-edge AI, this platform delivers release management like never before.
          </p>
