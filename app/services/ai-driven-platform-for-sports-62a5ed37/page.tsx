...
export const metadata: Metadata = {
  title: 'AI-Driven Platform for Sports',
  description: 'Future-proof your sports with AI-Driven Platform for Sports. Our autonomous solution handles roi tracking end-to-end without human intervention.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-driven-platform-for-sports-62a5ed37',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Driven Platform for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your sports with AI-Driven Platform for Sports. Our autonomous solution handles roi tracking end-to-end without human intervention.
          </p>
