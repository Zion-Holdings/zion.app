...
export const metadata: Metadata = {
  title: 'Intelligent Manager for Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Intelligent Manager for Hospitality leverages advanced machine learning to deliver quality control',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-manager-for-hospitality-fe67f2bd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Manager for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Intelligent Manager for Hospitality leverages advanced machine learning to deliver quality control at scale.
          </p>
