...
export const metadata: Metadata = {
  title: 'Intelligent Logistics Generator',
  description: 'Revolutionize hospitality through intelligent automation. Our Intelligent Logistics Generator leverages advanced machine learning to deliver maintenance schedul',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-logistics-generator-aace9a78',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Logistics Generator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Intelligent Logistics Generator leverages advanced machine learning to deliver maintenance scheduling at scale.
          </p>
