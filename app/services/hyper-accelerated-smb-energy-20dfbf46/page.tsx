...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated SMB - Energy',
  description: 'Transform your energy operations with our Hyper-Accelerated SMB - Energy. This AI-driven solution automates budget management with unprecedented accuracy and ef',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated SMB - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Hyper-Accelerated SMB - Energy. This AI-driven solution automates budget management with unprecedented accuracy and efficiency.
          </p>
