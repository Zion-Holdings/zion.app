...
export const metadata: Metadata = {
  title: 'Intelligent Regulatory Optimization',
  description: 'Optimize your construction workflows with Intelligent Regulatory Optimization. This intelligent platform delivers threat detection through advanced automation a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-regulatory-optimization-1d340eb0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Regulatory Optimization
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Intelligent Regulatory Optimization. This intelligent platform delivers threat detection through advanced automation and AI.
          </p>
