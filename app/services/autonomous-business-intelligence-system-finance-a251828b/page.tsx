...
export const metadata: Metadata = {
  title: 'Autonomous Business Intelligence System - Finance',
  description: 'The future of finance is here with Autonomous Business Intelligence System - Finance. Powered by cutting-edge AI, this platform delivers budget optimization lik',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Business Intelligence System - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of finance is here with Autonomous Business Intelligence System - Finance. Powered by cutting-edge AI, this platform delivers budget optimization like never before.
          </p>
