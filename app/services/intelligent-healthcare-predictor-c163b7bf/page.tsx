...
export const metadata: Metadata = {
  title: 'Intelligent Healthcare Predictor',
  description: 'Revolutionize telecom through intelligent automation. Our Intelligent Healthcare Predictor leverages advanced machine learning to deliver workflow management at',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Healthcare Predictor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Intelligent Healthcare Predictor leverages advanced machine learning to deliver workflow management at scale.
          </p>
