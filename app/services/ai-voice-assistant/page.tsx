...
export const metadata: Metadata = {
  ...
  keywords: 'Natural language voice processing, Multi-language support (50+ languages), CRM & ERP integration, Real-time transcription & analytics, Custom wake words & voice branding, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Voice Assistant</h1>
        <p className="text-lg text-slate-300 mb-8">Enterprise-grade voice AI with natural language understanding, multi-language support, and seamless CRM integration.</p>
        ...
        <li class="text-slate-300">Natural language voice processing</li>
        <li class="text-slate-300">Multi-language support (50+ languages)</li>
        <li class="text-slate-300">CRM &amp; ERP integration</li>
        <li class="text-slate-300">Real-time transcription &amp; analytics</li>
        <li class="text-slate-300">Custom wake words &amp; voice branding</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai voice assistant</li>
