...
export const metadata: Metadata = {
  title: 'Intelligent Analytics for Gaming',
  description: 'The future of gaming is here with Intelligent Analytics for Gaming. Powered by cutting-edge AI, this platform delivers supply chain like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-analytics-for-gaming-068d5b6a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Analytics for Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of gaming is here with Intelligent Analytics for Gaming. Powered by cutting-edge AI, this platform delivers supply chain like never before.
          </p>
