...
export const metadata: Metadata = {
  title: 'CockroachDB AI-Powered HR Analytics',
  description: 'AI-powered cockroachdb solution for hr. Predictive analytics for employee performance, retention, and recruitment.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cockroachdb-ai-powered-hr-analytics-26ff7e23',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            CockroachDB AI-Powered HR Analytics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered cockroachdb solution for hr. Predictive analytics for employee performance, retention, and recruitment.
          </p>
