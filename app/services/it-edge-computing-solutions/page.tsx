...
export const metadata: Metadata = {
  ...
  keywords: 'Edge server deployment & configuration, Container orchestration at the edge (K3s, KubeEdge), IoT device provisioning & lifecycle management, Low-latency AI inference on edge hardware, Offline-first data synchronization with cloud, cloud, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Edge Computing &amp; IoT Infrastructure</h1>
        <p className="text-lg text-slate-300 mb-8">Deploy compute closer to your data sources with edge computing architecture — low-latency processing, distributed AI inference, and resilient IoT device management.</p>
        ...
        <li class="text-slate-300">Edge server deployment &amp; configuration</li>
        <li class="text-slate-300">Container orchestration at the edge (K3s, KubeEdge)</li>
        <li class="text-slate-300">IoT device provisioning &amp; lifecycle management</li>
        <li class="text-slate-300">Low-latency AI inference on edge hardware</li>
        <li class="text-slate-300">Offline-first data synchronization with cloud</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with edge computing &amp; iot infrastructure</li>
