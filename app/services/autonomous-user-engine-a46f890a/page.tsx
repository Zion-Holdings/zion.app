...
export const metadata: Metadata = {
  title: 'Autonomous User Engine',
  description: 'Enhance your energy business with Autonomous User Engine. Our solution provides financial planning with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-user-engine-a46f890a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous User Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your energy business with Autonomous User Engine. Our solution provides financial planning with enterprise-grade reliability and security.
          </p>
