...
export const metadata: Metadata = {
  ...
  keywords: 'Freight booking and carrier selection, Route optimization across modes (road, rail, air, sea), Real-time shipment tracking, Customs and compliance documentation, Carrier performance scoring, Freight audit and invoice matching, Integration with SAP TM, Oracle TMS, project44, automation, Logistics, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Logistics &amp; Freight Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Automate logistics operations: freight booking, route optimization, tracking, customs documentation, and carrier management across modes.</p>
        ...
        <li class="text-slate-300">Freight booking and carrier selection</li>
        <li class="text-slate-300">Route optimization across modes (road, rail, air, sea)</li>
        <li class="text-slate-300">Real-time shipment tracking</li>
        <li class="text-slate-300">Customs and compliance documentation</li>
        <li class="text-slate-300">Carrier performance scoring</li>
        <li class="text-slate-300">Freight audit and invoice matching</li>
        <li class="text-slate-300">Integration with SAP TM, Oracle TMS, project44</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Carrier selection optimized for cost and reliability</li>
        <li class="text-slate-300">Route optimization reduces transit time</li>
        <li class="text-slate-300">Customs automation prevents delays</li>
        <li class="text-slate-300">Freight audit catches billing errors</li>
      </ul>
        </div>
