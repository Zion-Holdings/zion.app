...
export const metadata: Metadata = {
  title: 'Quantum Healthcare - Legal Quantum',
  description: 'Next-generation legal solution: Quantum Healthcare - Legal Quantum. Combines testing automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-healthcare-legal-quantum-d3e3ea60',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Healthcare - Legal Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Quantum Healthcare - Legal Quantum. Combines testing automation with adaptive intelligence for optimal results.
          </p>
