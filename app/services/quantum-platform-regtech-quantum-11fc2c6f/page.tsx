...
export const metadata: Metadata = {
  title: 'Quantum Platform - REGTECH Quantum',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Platform - REGTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of regtech is here with Quantum Platform - REGTECH Quantum. Powered by cutting-edge AI, this platform delivers supply visibility like never before.
          </p>
