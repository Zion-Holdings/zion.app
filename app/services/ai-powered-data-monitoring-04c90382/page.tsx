...
export const metadata: Metadata = {
  title: 'AI-Powered Data Monitoring',
  description: 'Revolutionize telecom through intelligent automation. Our AI-Powered Data Monitoring leverages advanced machine learning to deliver enterprise-grade insights at',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our AI-Powered Data Monitoring leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
