...
export const metadata: Metadata = {
  ...
  description: 'Enhance your agriculture business with Autonomous Revenue System - Agriculture. Our solution provides anomaly detection with enterprise-grade reliability and se',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-revenue-system-agriculture-ecdb2dc0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your agriculture business with Autonomous Revenue System - Agriculture. Our solution provides anomaly detection with enterprise-grade reliability and security.
          </p>
