...
export const metadata: Metadata = {
  title: 'AI-Powered Reputation Security',
  description: 'Transform your hospitality operations with our AI-Powered Reputation Security. This AI-driven solution provides intelligent automation with unprecedented accura',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Reputation Security
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our AI-Powered Reputation Security. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
