      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            End-to-end employee lifecycle automation from AI-powered onboarding to performance management, engagement tracking, and retention prediction.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Automated onboarding workflow orchestration</li>
            <li className="text-purple-300">✓ Personalized training & development paths</li>
            <li className="text-purple-300">✓ Sentiment & engagement tracking</li>
            <li className="text-purple-300">✓ AI-powered retention risk prediction</li>
            <li className="text-purple-300">✓ Buddy & mentor matching algorithms</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai employee experience platform</li>
