...
export const metadata: Metadata = {
  ...
  keywords: 'Automated onboarding workflow orchestration, Personalized training & development paths, Sentiment & engagement tracking, AI-powered retention risk prediction, Buddy & mentor matching algorithms, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Employee Experience Platform</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end employee lifecycle automation from AI-powered onboarding to performance management, engagement tracking, and retention prediction.</p>
        ...
        <li class="text-slate-300">Automated onboarding workflow orchestration</li>
        <li class="text-slate-300">Personalized training &amp; development paths</li>
        <li class="text-slate-300">Sentiment &amp; engagement tracking</li>
        <li class="text-slate-300">AI-powered retention risk prediction</li>
        <li class="text-slate-300">Buddy &amp; mentor matching algorithms</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai employee experience platform</li>
