...
export const metadata: Metadata = {
  ...
  keywords: 'SAP ERP BAPI/IDoc adapters, SuccessFactors sync, Ariba network integration, Error reconciliation dashboard, SAP-certified connectors, it, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">SAP Integration Hub</h1>
        <p className="text-lg text-slate-300 mb-8">Pre-built connectors for SAP ERP, S/4HANA, SuccessFactors, and Ariba. Real-time sync, IDoc/BAPI support, and error handling out of the box.</p>
        ...
        <li class="text-slate-300">SAP ERP BAPI/IDoc adapters</li>
        <li class="text-slate-300">SuccessFactors sync</li>
        <li class="text-slate-300">Ariba network integration</li>
        <li class="text-slate-300">Error reconciliation dashboard</li>
        <li class="text-slate-300">SAP-certified connectors</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with sap integration hub</li>
