...
export const metadata: Metadata = {
  title: 'AI Operational - Transportation Edition',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Operational - Transportation Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize transportation through intelligent automation. Our AI Operational - Transportation Edition leverages advanced machine learning to deliver image recognition at scale.
          </p>
