...
export const metadata: Metadata = {
  title: 'Analytics Predictive - Hospitality',
  description: 'Enhance your hospitality business with Analytics Predictive - Hospitality. Our solution provides roi tracking with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/analytics-predictive-hospitality-0b67ea0f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Analytics Predictive - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Analytics Predictive - Hospitality. Our solution provides roi tracking with enterprise-grade reliability and security.
          </p>
