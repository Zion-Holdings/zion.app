...
export const metadata: Metadata = {
  title: 'Smart HR Recruitment Microservices (Ai)',
  description: 'Smart HR Recruitment Microservices (Ai) is an AI-powered ai solution that transforms how businesses operate through intelligent automation and real-time analyti',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-hr-recruitment-microserv-322fdd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart HR Recruitment Microservices (Ai)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Smart HR Recruitment Microservices (Ai) is an AI-powered ai solution that transforms how businesses operate through intelligent automation and real-time analytics.
...
Ansible, Kubernetes, Docker, AWS, DigitalOcean, Blockchain
