...
export const metadata: Metadata = {
  title: 'Renewable Energy AI-Powered Content Generation Platform',
  description: 'AI-powered renewable energy solution for marketing. Generates high-quality, SEO-optimized content at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/renewable-energy-ai-powered-content-generation-platform-7e9c9b80',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Renewable Energy AI-Powered Content Generation Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered renewable energy solution for marketing. Generates high-quality, SEO-optimized content at scale.
          </p>
