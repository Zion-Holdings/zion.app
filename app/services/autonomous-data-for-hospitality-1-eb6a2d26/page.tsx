...
export const metadata: Metadata = {
  title: 'Autonomous Data for Hospitality #1',
  description: 'Next-generation hospitality solution: Autonomous Data for Hospitality #1. Combines financial planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-data-for-hospitality-1-eb6a2d26',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Data for Hospitality #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Autonomous Data for Hospitality #1. Combines financial planning with adaptive intelligence for optimal results.
          </p>
