...
export const metadata: Metadata = {
  title: 'Autonomous Security System - Media',
  description: 'Enhance your media business with Autonomous Security System - Media. Our solution provides reputation management with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-security-system-media-b46dbd86',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Security System - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your media business with Autonomous Security System - Media. Our solution provides reputation management with enterprise-grade reliability and security.
          </p>
