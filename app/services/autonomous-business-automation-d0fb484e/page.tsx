...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize insurance through intelligent automation. Our Autonomous Business Automation leverages advanced machine learning to deliver enterprise-grade insig',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-business-automation-d0fb484e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Autonomous Business Automation leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
