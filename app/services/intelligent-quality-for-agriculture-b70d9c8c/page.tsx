...
export const metadata: Metadata = {
  title: 'Intelligent Quality for Agriculture',
  description: 'Optimize your agriculture workflows with Intelligent Quality for Agriculture. This intelligent platform delivers process automation through advanced automation ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Quality for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your agriculture workflows with Intelligent Quality for Agriculture. This intelligent platform delivers process automation through advanced automation and AI.
          </p>
