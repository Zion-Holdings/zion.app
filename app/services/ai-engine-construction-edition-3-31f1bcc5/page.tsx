...
export const metadata: Metadata = {
  title: 'AI Engine - Construction Edition #3',
  description: 'Transform your construction operations with our AI Engine - Construction Edition #3. This AI-driven solution automates roi tracking with unprecedented accuracy ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-engine-construction-edition-3-31f1bcc5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Engine - Construction Edition #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our AI Engine - Construction Edition #3. This AI-driven solution automates roi tracking with unprecedented accuracy and efficiency.
          </p>
