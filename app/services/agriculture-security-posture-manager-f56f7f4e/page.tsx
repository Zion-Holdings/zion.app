...
export const metadata: Metadata = {
  title: "Agriculture Security Posture Manager - AI-Powered Agriculture Solution",
  description: "AI-powered agriculture solution leveraging advanced machine learning for optimal performance and ROI.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/agriculture-security-posture-manager-f56f7f4e",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Agriculture Security Posture Manager - AI-Powered Agriculture Solution
        </h1>
