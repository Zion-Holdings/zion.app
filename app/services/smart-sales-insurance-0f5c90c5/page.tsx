...
export const metadata: Metadata = {
  title: 'Smart sales-insurance',
  description: 'Transform your insurance operations with our Smart sales-insurance. This AI-driven solution automates scenario planning with unprecedented accuracy and efficien',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Smart sales-insurance. This AI-driven solution automates scenario planning with unprecedented accuracy and efficiency.
          </p>
