...
export const metadata: Metadata = {
  title: 'AI/IT Cognitive Suite - Logistics',
  description: 'Enhance your logistics business with AI/IT Cognitive Suite - Logistics. Our solution provides influencer identification with enterprise-grade reliability and se',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-cognitive-suite-logistics-c39e2e09',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Cognitive Suite - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with AI/IT Cognitive Suite - Logistics. Our solution provides influencer identification with enterprise-grade reliability and security.
          </p>
