...
export const metadata: Metadata = {
  ...
  keywords: 'SAST/DAST/SCA/container scanning per PR with 5-minute deadline, Vulnerability classification: CWE+CVSS+remotely-exploitable/reachable, Auto-fix PR against approved fix forms — merge approved change, Verified SBOM generated per build with SPDX+cyclonedx exports, it, E-Commerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">CI/CD Security Gate-as-a-Service</h1>
        <p className="text-lg text-slate-300 mb-8">Shift-left CI/CD security: SAST/DAST/SCA/containers per PR/push branch gate with auto-fix PRs for vulnerabilities, SBOM generation, false-positive suppression.</p>
        ...
        <li class="text-slate-300">SAST/DAST/SCA/container scanning per PR with 5-minute deadline</li>
        <li class="text-slate-300">Vulnerability classification: CWE+CVSS+remotely-exploitable/reachable</li>
        <li class="text-slate-300">Auto-fix PR against approved fix forms — merge approved change</li>
        <li class="text-slate-300">Verified SBOM generated per build with SPDX+cyclonedx exports</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ci/cd security gate-as-a-service</li>
