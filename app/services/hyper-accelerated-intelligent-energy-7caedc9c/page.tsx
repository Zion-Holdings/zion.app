...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated intelligent-energy',
  description: 'Revolutionize energy through intelligent automation. Our Hyper-Accelerated intelligent-energy leverages advanced machine learning to deliver ml model training a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated intelligent-energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Hyper-Accelerated intelligent-energy leverages advanced machine learning to deliver ml model training at scale.
          </p>
