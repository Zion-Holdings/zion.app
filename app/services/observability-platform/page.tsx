...
export const metadata: Metadata = {
  ...
  keywords: 'Log aggregation & full-text search (ELK-compatible), Metrics collection & dashboards (Prometheus/Grafana), Distributed tracing (OpenTelemetry), AI-driven anomaly detection & alerting, SLO/SLI tracking & error budget burn rate, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Full-Stack Observability Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Unified logs, metrics, traces, and distributed tracing with AI-powered anomaly detection and automated root-cause analysis for microservices.</p>
        ...
        <li class="text-slate-300">Log aggregation &amp; full-text search (ELK-compatible)</li>
        <li class="text-slate-300">Metrics collection &amp; dashboards (Prometheus/Grafana)</li>
        <li class="text-slate-300">Distributed tracing (OpenTelemetry)</li>
        <li class="text-slate-300">AI-driven anomaly detection &amp; alerting</li>
        <li class="text-slate-300">SLO/SLI tracking &amp; error budget burn rate</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with full-stack observability platform</li>
