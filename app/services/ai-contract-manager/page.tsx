...
export const metadata: Metadata = {
  ...
  keywords: 'Smart clause library & assembly, Obligation & deadline tracking, Risk scoring & non-standard clause flagging, Automated renewal & expiration alerts, Integration with DocuSign & Adobe Sign, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Contract Manager</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end contract lifecycle management: AI-powered drafting, review, clause library, obligation tracking, and renewal alerts.</p>
        ...
        <li class="text-slate-300">Smart clause library &amp; assembly</li>
        <li class="text-slate-300">Obligation &amp; deadline tracking</li>
        <li class="text-slate-300">Risk scoring &amp; non-standard clause flagging</li>
        <li class="text-slate-300">Automated renewal &amp; expiration alerts</li>
        <li class="text-slate-300">Integration with DocuSign &amp; Adobe Sign</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai contract manager</li>
