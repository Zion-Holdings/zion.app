      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            End-to-end contract lifecycle management: AI-powered drafting, review, clause library, obligation tracking, and renewal alerts.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Smart clause library & assembly</li>
            <li className="text-purple-300">✓ Obligation & deadline tracking</li>
            <li className="text-purple-300">✓ Risk scoring & non-standard clause flagging</li>
            <li className="text-purple-300">✓ Automated renewal & expiration alerts</li>
            <li className="text-purple-300">✓ Integration with DocuSign & Adobe Sign</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai contract manager</li>
