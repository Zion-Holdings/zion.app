...
export const metadata: Metadata = {
  title: 'Intelligent Platform for Sports',
  description: 'The future of sports is here with Intelligent Platform for Sports. Powered by cutting-edge AI, this platform delivers customer retention like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-platform-for-sports-2286600b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Platform for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Intelligent Platform for Sports. Powered by cutting-edge AI, this platform delivers customer retention like never before.
          </p>
