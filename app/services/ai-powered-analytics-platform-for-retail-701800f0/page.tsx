...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-analytics-platform-for-retail-701800f0',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <section className="mb-12">
          ...
          <li className="text-purple-300">Process 89% faster with automation</li>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$166</p>
          <ul className="space-y-2 mb-4">
