...
export const metadata: Metadata = {
  ...
  keywords: 'Contract analysis (ASC 606/IFRS 15), Performance obligation identification, Automated journal entries, ERP integration (SAP, Oracle, NetSuite), Audit trail & documentation, Multi-element arrangement handling, Variable consideration estimation, Disclosure report generation, micro-saas, financial-services, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Revenue Recognition Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Automate ASC 606 / IFRS 15 compliance with AI. Analyzes contracts, identifies performance obligations, and generates journal entries. Integrates with ERP systems.</p>
        ...
        <li class="text-slate-300">Contract analysis (ASC 606/IFRS 15)</li>
        <li class="text-slate-300">Performance obligation identification</li>
        <li class="text-slate-300">Automated journal entries</li>
        <li class="text-slate-300">ERP integration (SAP, Oracle, NetSuite)</li>
        <li class="text-slate-300">Audit trail &amp; documentation</li>
        <li class="text-slate-300">Multi-element arrangement handling</li>
        <li class="text-slate-300">Variable consideration estimation</li>
        <li class="text-slate-300">Disclosure report generation</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">90% faster close cycles</li>
        <li class="text-slate-300">Eliminate manual spreadsheet errors</li>
        <li class="text-slate-300">Audit-ready documentation</li>
