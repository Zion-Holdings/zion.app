...
export const metadata: Metadata = {
  title: 'AI/IT machine learning-finance',
  description: 'Enhance your finance business with AI/IT machine learning-finance. Our solution provides reporting automation with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-machine-learning-finance-2991ba18',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT machine learning-finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your finance business with AI/IT machine learning-finance. Our solution provides reporting automation with enterprise-grade reliability and security.
          </p>
