...
export const metadata: Metadata = {
  title: 'AI Process Mining - Ecommerce Edition',
  description: 'Future-proof your ecommerce with AI Process Mining - Ecommerce Edition. Our autonomous solution handles root cause analysis end-to-end without human interventio',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Process Mining - Ecommerce Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your ecommerce with AI Process Mining - Ecommerce Edition. Our autonomous solution handles root cause analysis end-to-end without human intervention.
          </p>
