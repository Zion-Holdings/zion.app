...
export const metadata: Metadata = {
  title: 'Intelligent Compliance for Retail',
  description: 'Optimize your retail workflows with Intelligent Compliance for Retail. This intelligent platform delivers lead scoring through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-compliance-for-retail-d0aaebec',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Compliance for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your retail workflows with Intelligent Compliance for Retail. This intelligent platform delivers lead scoring through advanced automation and AI.
          </p>
