...
export const metadata: Metadata = {
  title: 'Patient Data Management AI Financial Planning & Analysis',
  description: 'patient data management solution for wildlife management industry. Generates financial forecasts, budget plans, and performance analyses using machine learning ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/patient-data-management-ai-financial-planning--analysis-1d23a75f',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Patient Data Management AI Financial Planning & Analysis
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            patient data management solution for wildlife management industry. Generates financial forecasts, budget plans, and performance analyses using machine learning models.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your wildlife management operations?</p>
