...
export const metadata: Metadata = {
  title: 'Quantum Tactical - Automotive Quantum',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Tactical - Automotive Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in automotive with Quantum Tactical - Automotive Quantum. This AI-powered platform transforms process discovery into a competitive advantage.
          </p>
