...
export const metadata: Metadata = {
  title: 'Ad-hoc Analysis AI-Powered Data Lineage',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Ad-hoc Analysis AI-Powered Data Lineage
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered ad-hoc analysis solution for data governance. Automated tracking of data flow from source to consumption.
          </p>
