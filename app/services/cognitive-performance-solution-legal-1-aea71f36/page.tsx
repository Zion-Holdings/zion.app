...
export const metadata: Metadata = {
  title: 'Cognitive Performance Solution - Legal #1',
  description: 'Transform your legal operations with our Cognitive Performance Solution - Legal #1. This AI-driven solution automates campaign optimization with unprecedented a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Performance Solution - Legal #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Cognitive Performance Solution - Legal #1. This AI-driven solution automates campaign optimization with unprecedented accuracy and efficiency.
          </p>
