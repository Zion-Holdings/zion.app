...
export const metadata: Metadata = {
  title: 'Enterprise Knowledge Platform - HEALTHTECH',
  description: 'Unlock unprecedented growth with Enterprise Knowledge Platform - HEALTHTECH. This autonomous system provides root cause analysis with zero manual intervention n',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-knowledge-platform-healthtech-4818f516',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Knowledge Platform - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Enterprise Knowledge Platform - HEALTHTECH. This autonomous system provides root cause analysis with zero manual intervention needed.
          </p>
