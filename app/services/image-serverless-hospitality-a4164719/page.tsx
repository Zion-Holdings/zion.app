...
export const metadata: Metadata = {
  title: 'Image Serverless - Hospitality',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Image Serverless - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Image Serverless - Hospitality. This AI-powered platform transforms churn prediction into a competitive advantage.
          </p>
