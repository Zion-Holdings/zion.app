...
export const metadata: Metadata = {
  title: 'Intelligent Experience for Construction',
  description: 'Optimize your construction workflows with Intelligent Experience for Construction. This intelligent platform delivers competitive intelligence through advanced ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Experience for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Intelligent Experience for Construction. This intelligent platform delivers competitive intelligence through advanced automation and AI.
          </p>
