...
export const metadata: Metadata = {
  ...
  description: 'revenue cycle management solution for insurtech industry. Automatically detects, corrects, and prevents data quality issues using machine learning.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/revenue-cycle-management-ai-powered-data-quality-manager-3665e0c1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Revenue Cycle Management AI-Powered Data Quality Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            revenue cycle management solution for insurtech industry. Automatically detects, corrects, and prevents data quality issues using machine learning.
          </p>
