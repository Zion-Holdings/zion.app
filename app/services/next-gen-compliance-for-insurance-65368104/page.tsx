...
export const metadata: Metadata = {
  title: 'Next-Gen Compliance for Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Next-Gen Compliance for Insurance leverages advanced machine learning to deliver scalability plannin',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Compliance for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Next-Gen Compliance for Insurance leverages advanced machine learning to deliver scalability planning at scale.
          </p>
