...
export const metadata: Metadata = {
  title: 'Financial Close Intelligent Document Processing AI',
  description: 'AI-powered financial close solution for operations. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatica',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/financial-close-intelligent-document-processing-ai-2b0fab69',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Financial Close Intelligent Document Processing AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered financial close solution for operations. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Multi-format OCR</li>
          <li className="text-gray-300">Data extraction</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <li className="text-purple-300">Zero manual entry</li>
          </ul>
        </section>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your financial close operations?</p>
