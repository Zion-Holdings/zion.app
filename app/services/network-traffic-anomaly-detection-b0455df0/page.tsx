...
export const metadata = {
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/network-traffic-anomaly-detection-b0455df0`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path={`/services/network-traffic-anomaly-detection-b0455df0`} title="Network Traffic Anomaly Detection — AI Threat Prevention" />
