...
export const metadata: Metadata = {
  title: 'Compliance Intelligent - Retail',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Compliance Intelligent - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in retail with Compliance Intelligent - Retail. This AI-powered platform transforms logistics route optimization into a competitive advantage.
          </p>
