...
export const metadata: Metadata = {
  title: 'Enterprise Predictor Platform - MARTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Predictor Platform - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your martech business with Enterprise Predictor Platform - MARTECH. Our solution provides hyperautomation with enterprise-grade reliability and security.
          </p>
