...
export const metadata: Metadata = {
  ...
  description: 'Quantum leap forward for logistics: Intelligent Revenue for Logistics. Uses quantum-inspired algorithms to deliver form processing at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-revenue-for-logistics-26d0349b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for logistics: Intelligent Revenue for Logistics. Uses quantum-inspired algorithms to deliver form processing at exponential speed.
          </p>
