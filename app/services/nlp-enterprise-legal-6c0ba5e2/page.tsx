...
export const metadata: Metadata = {
  title: 'NLP Enterprise - Legal',
  description: 'Quantum leap forward for legal: NLP Enterprise - Legal. Uses quantum-inspired algorithms to deliver low-code automation at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/nlp-enterprise-legal-6c0ba5e2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            NLP Enterprise - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for legal: NLP Enterprise - Legal. Uses quantum-inspired algorithms to deliver low-code automation at exponential speed.
          </p>
