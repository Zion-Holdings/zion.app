...
export const metadata: Metadata = {
  title: 'Smart Intelligent - Media',
  description: 'The future of media is here with Smart Intelligent - Media. Powered by cutting-edge AI, this platform delivers dashboard automation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-intelligent-media-a49fe221',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Intelligent - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of media is here with Smart Intelligent - Media. Powered by cutting-edge AI, this platform delivers dashboard automation like never before.
          </p>
