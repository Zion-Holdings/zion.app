...
export const metadata: Metadata = {
  title: 'Smart Cognitive Platform - Transportation',
  description: 'Next-generation transportation solution: Smart Cognitive Platform - Transportation. Combines resource allocation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-cognitive-platform-transportation-8fb2131a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Cognitive Platform - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation transportation solution: Smart Cognitive Platform - Transportation. Combines resource allocation with adaptive intelligence for optimal results.
          </p>
