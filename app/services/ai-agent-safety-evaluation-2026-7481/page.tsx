...
export const metadata = {
  ...
  alternates: { canonical: '/services/ai-agent-safety-evaluation-2026-7481/' },

  openGraph: {
    title: 'AI Agent Safety Evaluation | Zion Tech Group',
    description: 'End-to-end ai agent safety evaluation services: assessment, deployment, and managed operations.',
    url: 'https://ziontechgroup.com/services/ai-agent-safety-evaluation-2026-7481/',
    siteName: 'Zion Tech Group',
    type: 'website',
    images: ['/og-default.png'],
  },
  twitter: { card: 'summary_large_image', title: 'AI Agent Safety Evaluation | Zion Tech Group', description: 'End-to-end ai agent safety evaluation services: assessment, deployment, and managed operations.' }};

export default function ServicePage() {
  return (
    <main className="min-h-screen bg-slate-950 py-20">

    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "AI Agent Safety Evaluation | Zion Tech Group", description: "End-to-end ai agent safety evaluation services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/ai-agent-safety-evaluation-2026-7481/"}} />
      <div className="container-page">
        ...
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end ai agent safety evaluation services: assessment, deployment, and managed operations.
        </p>
