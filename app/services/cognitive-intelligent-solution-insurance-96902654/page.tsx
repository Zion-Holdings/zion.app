...
export const metadata: Metadata = {
  title: 'Cognitive Intelligent Solution - Insurance',
  description: 'The future of insurance is here with Cognitive Intelligent Solution - Insurance. Powered by cutting-edge AI, this platform delivers sentiment analysis like neve',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-intelligent-solution-insurance-96902654',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Intelligent Solution - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Cognitive Intelligent Solution - Insurance. Powered by cutting-edge AI, this platform delivers sentiment analysis like never before.
          </p>
