...
export const metadata: Metadata = {
  title: 'Cognitive Scheduler System',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Scheduler System
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Cognitive Scheduler System. This security solution delivers unprecedented automation and intelligence.
          </p>
