...
export const metadata: Metadata = {
  title: 'Intelligent Computer Vision for Hospitality',
  description: 'Optimize your hospitality workflows with Intelligent Computer Vision for Hospitality. This intelligent platform delivers brand sentiment through advanced automa',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-computer-vision-for-hospitality-61324d36',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Computer Vision for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Intelligent Computer Vision for Hospitality. This intelligent platform delivers brand sentiment through advanced automation and AI.
          </p>
