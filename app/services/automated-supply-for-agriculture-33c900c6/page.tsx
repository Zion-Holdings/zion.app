...
export const metadata: Metadata = {
  title: 'Automated Supply for Agriculture',
  description: 'Drive innovation in agriculture with Automated Supply for Agriculture. This AI-powered platform transforms competitive intelligence into a competitive advantage',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-supply-for-agriculture-33c900c6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Supply for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in agriculture with Automated Supply for Agriculture. This AI-powered platform transforms competitive intelligence into a competitive advantage.
          </p>
