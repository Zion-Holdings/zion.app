...
export const metadata: Metadata = {
  title: 'AI Intelligence - Construction Edition #1',
  description: 'Optimize your construction workflows with AI Intelligence - Construction Edition #1. This intelligent platform delivers budget optimization through advanced aut',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-intelligence-construction-edition-1-97c728e4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Intelligence - Construction Edition #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with AI Intelligence - Construction Edition #1. This intelligent platform delivers budget optimization through advanced automation and AI.
          </p>
