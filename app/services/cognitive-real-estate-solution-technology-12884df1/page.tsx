...
export const metadata: Metadata = {
  title: 'Cognitive Real Estate Solution - TECHNOLOGY',
  description: 'Drive innovation in technology with Cognitive Real Estate Solution - TECHNOLOGY. This AI-powered platform transforms warehouse automation into a competitive adv',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Real Estate Solution - TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in technology with Cognitive Real Estate Solution - TECHNOLOGY. This AI-powered platform transforms warehouse automation into a competitive advantage.
          </p>
