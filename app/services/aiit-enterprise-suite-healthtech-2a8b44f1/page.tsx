...
export const metadata: Metadata = {
  title: 'AI/IT Enterprise Suite - HEALTHTECH',
  description: 'Transform your healthtech operations with our AI/IT Enterprise Suite - HEALTHTECH. This AI-driven solution automates document processing with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-enterprise-suite-healthtech-2a8b44f1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Enterprise Suite - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthtech operations with our AI/IT Enterprise Suite - HEALTHTECH. This AI-driven solution automates document processing with unprecedented accuracy and efficiency.
          </p>
