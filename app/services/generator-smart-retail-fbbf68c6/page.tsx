...
export const metadata: Metadata = {
  title: 'Generator Smart - Retail',
  description: 'Revolutionize retail through intelligent automation. Our Generator Smart - Retail leverages advanced machine learning to deliver enterprise-grade insights at sc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/generator-smart-retail-fbbf68c6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Generator Smart - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize retail through intelligent automation. Our Generator Smart - Retail leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
