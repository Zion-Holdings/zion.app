...
export const metadata: Metadata = {
  title: 'Communication Management Multi-Cloud Cost Management Platform',
  description: 'communication management solution for travel industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/communication-management-multi-cloud-cost-management-platform-0f6cf54d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Communication Management Multi-Cloud Cost Management Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            communication management solution for travel industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.
          </p>
