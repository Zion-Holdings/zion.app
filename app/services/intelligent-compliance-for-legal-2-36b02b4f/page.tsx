...
export const metadata: Metadata = {
  title: 'Intelligent Compliance for Legal #2',
  description: 'Drive innovation in legal with Intelligent Compliance for Legal #2. This AI-powered platform transforms budget optimization into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-compliance-for-legal-2-36b02b4f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Compliance for Legal #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Intelligent Compliance for Legal #2. This AI-powered platform transforms budget optimization into a competitive advantage.
          </p>
