...
export const metadata: Metadata = {
  title: 'Intelligent Marketing for Edge',
  description: 'The future of edge is here with Intelligent Marketing for Edge. Powered by cutting-edge AI, this platform delivers maintenance scheduling like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-marketing-for-edge-954c3baa',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Marketing for Edge
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of edge is here with Intelligent Marketing for Edge. Powered by cutting-edge AI, this platform delivers maintenance scheduling like never before.
          </p>
