...
export const metadata: Metadata = {
  title: 'A/B Testing AI Business Process Automation Suite',
  description: 'AI-powered a/b testing solution for business process. Discovers, automates, and optimizes business processes using AI-powered process mining.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ab-testing-ai-business-process-automation-suite-e9d01644',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            A/B Testing AI Business Process Automation Suite
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered a/b testing solution for business process. Discovers, automates, and optimizes business processes using AI-powered process mining.
          </p>
