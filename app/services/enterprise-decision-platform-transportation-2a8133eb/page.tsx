...
export const metadata: Metadata = {
  title: 'Enterprise Decision Platform - Transportation',
  description: 'Hyper-accelerated transportation solution: Enterprise Decision Platform - Transportation. Combines workflow automation with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-decision-platform-transportation-2a8133eb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Decision Platform - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated transportation solution: Enterprise Decision Platform - Transportation. Combines workflow automation with next-gen AI for maximum velocity.
          </p>
