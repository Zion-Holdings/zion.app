...
export const metadata: Metadata = {
  title: 'Intelligent Advisor for Legal',
  description: 'Drive innovation in legal with Intelligent Advisor for Legal. This AI-powered platform transforms root cause analysis into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-advisor-for-legal-4703a574',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Advisor for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Intelligent Advisor for Legal. This AI-powered platform transforms root cause analysis into a competitive advantage.
          </p>
