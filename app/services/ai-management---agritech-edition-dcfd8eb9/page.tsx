...
export const metadata: Metadata = {
  title: 'AI Management - Agritech Edition',
  description: 'The future of agritech is here with AI Management - Agritech Edition. Powered by cutting-edge AI, this platform delivers security monitoring like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-management---agritech-edition-dcfd8eb9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Management - Agritech Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agritech is here with AI Management - Agritech Edition. Powered by cutting-edge AI, this platform delivers security monitoring like never before.
          </p>
