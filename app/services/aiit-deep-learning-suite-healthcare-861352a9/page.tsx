...
export const metadata: Metadata = {
  title: 'AI/IT Deep Learning Suite - Healthcare',
  description: 'Optimize your healthcare workflows with AI/IT Deep Learning Suite - Healthcare. This intelligent platform delivers capacity planning through advanced automation',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-deep-learning-suite-healthcare-861352a9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Deep Learning Suite - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with AI/IT Deep Learning Suite - Healthcare. This intelligent platform delivers capacity planning through advanced automation and AI.
          </p>
