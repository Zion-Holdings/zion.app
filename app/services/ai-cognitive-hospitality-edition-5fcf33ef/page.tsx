...
export const metadata: Metadata = {
  title: 'AI Cognitive - Hospitality Edition',
  description: 'Revolutionize hospitality through intelligent automation. Our AI Cognitive - Hospitality Edition leverages advanced machine learning to deliver enterprise-grade',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-cognitive-hospitality-edition-5fcf33ef',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Cognitive - Hospitality Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our AI Cognitive - Hospitality Edition leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
