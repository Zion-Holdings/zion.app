...
export const metadata: Metadata = {
  title: 'Cognitive Real Estate Solution - HEALTHTECH',
  description: 'Enhance your healthtech business with Cognitive Real Estate Solution - HEALTHTECH. Our solution provides expense management with enterprise-grade reliability an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Real Estate Solution - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthtech business with Cognitive Real Estate Solution - HEALTHTECH. Our solution provides expense management with enterprise-grade reliability and security.
          </p>
