...
export const metadata: Metadata = {
  ...
  description: 'opportunity management solution for waste management industry. Fully automated customer support system that handles 80% of inquiries without human intervention.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/opportunity-management-autonomous-customer-service-ai-9d0d949d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            opportunity management solution for waste management industry. Fully automated customer support system that handles 80% of inquiries without human intervention.
          </p>
