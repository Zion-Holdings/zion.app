...
export const metadata: Metadata = {
  ...
  keywords: 'Predictive and on-site RF surveys, Capacity planning and density optimization, IoT and sensor network design, Seamless roaming and load balancing, Security hardening (WPA3, 802.1X, NAC), cloud, Finance, Zion Tech Group',
  alternates: {
    canonical: `https://ziontechgroup.com/services/it-wireless-network-design/`,
  },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Wireless Network Design &amp; Optimization</h1>
        <p className="text-lg text-slate-300 mb-8">Enterprise Wi-Fi and wireless infrastructure design, site surveys, RF optimization, and capacity planning for campuses, warehouses, and smart buildings.</p>
        ...
        <li class="text-slate-300">Predictive and on-site RF surveys</li>
        <li class="text-slate-300">Capacity planning and density optimization</li>
        <li class="text-slate-300">IoT and sensor network design</li>
        <li class="text-slate-300">Seamless roaming and load balancing</li>
        <li class="text-slate-300">Security hardening (WPA3, 802.1X, NAC)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with wireless network design &amp; optimization</li>
