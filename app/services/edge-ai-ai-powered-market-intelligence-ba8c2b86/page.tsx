...
export const metadata: Metadata = {
  title: 'Edge AI AI-Powered Market Intelligence',
  description: 'AI-powered edge ai solution for market research. Monitors market trends, competitor activities, and industry news to provide actionable insights.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/edge-ai-ai-powered-market-intelligence-ba8c2b86',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Edge AI AI-Powered Market Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered edge ai solution for market research. Monitors market trends, competitor activities, and industry news to provide actionable insights.
          </p>
