...
export const metadata: Metadata = {
  title: 'Real Estate Smart - Retail',
  description: 'The future of retail is here with Real Estate Smart - Retail. Powered by cutting-edge AI, this platform delivers transformative results like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/real-estate-smart-retail-146ba23c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Real Estate Smart - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Real Estate Smart - Retail. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
