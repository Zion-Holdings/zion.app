...
export const metadata: Metadata = {
  title: 'Cognitive Supply Solution - Transportation',
  description: 'Next-generation transportation solution: Cognitive Supply Solution - Transportation. Combines sales process optimization with adaptive intelligence for optimal ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-supply-solution-transportation-2d09e40d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Supply Solution - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation transportation solution: Cognitive Supply Solution - Transportation. Combines sales process optimization with adaptive intelligence for optimal results.
          </p>
