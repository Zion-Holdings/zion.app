...
export const metadata: Metadata = {
  title: 'Smart Processor Platform - Agriculture',
  description: 'Optimize your agriculture workflows with Smart Processor Platform - Agriculture. This intelligent platform delivers logistics route optimization through advance',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Processor Platform - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your agriculture workflows with Smart Processor Platform - Agriculture. This intelligent platform delivers logistics route optimization through advanced automation and AI.
          </p>
