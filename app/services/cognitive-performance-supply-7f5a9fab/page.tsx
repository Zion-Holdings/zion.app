...
export const metadata: Metadata = {
  title: 'Cognitive Performance Supply',
  description: 'Hyper-accelerated hospitality solution: Cognitive Performance Supply. Combines demand planning with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-performance-supply-7f5a9fab',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Performance Supply
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated hospitality solution: Cognitive Performance Supply. Combines demand planning with next-gen AI for maximum velocity.
          </p>
