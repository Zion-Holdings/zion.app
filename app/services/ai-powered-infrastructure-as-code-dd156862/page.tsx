...
export const metadata: Metadata = {
  ...
  description: 'AI-generated infrastructure code with best practices and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-infrastructure-as-code-dd156862',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            AI-generated infrastructure code with best practices and security.
          </p>
