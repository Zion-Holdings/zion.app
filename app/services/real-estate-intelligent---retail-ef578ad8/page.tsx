...
export const metadata: Metadata = {
  title: 'Real Estate Intelligent - Retail',
  description: 'The future of retail is here with Real Estate Intelligent - Retail. Powered by cutting-edge AI, this platform delivers language processing like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/real-estate-intelligent---retail-ef578ad8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Real Estate Intelligent - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Real Estate Intelligent - Retail. Powered by cutting-edge AI, this platform delivers language processing like never before.
          </p>
