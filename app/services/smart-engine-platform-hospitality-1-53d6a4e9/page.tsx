...
export const metadata: Metadata = {
  title: 'Smart Engine Platform - Hospitality #1',
  description: 'Optimize your hospitality workflows with Smart Engine Platform - Hospitality #1. This intelligent platform delivers sentiment analysis through advanced automati',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-engine-platform-hospitality-1-53d6a4e9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Engine Platform - Hospitality #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Smart Engine Platform - Hospitality #1. This intelligent platform delivers sentiment analysis through advanced automation and AI.
          </p>
