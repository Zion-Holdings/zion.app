...
export const metadata: Metadata = {
  title: 'Data Science Smart - Agriculture',
  description: 'Unlock unprecedented growth with Data Science Smart - Agriculture. This autonomous system provides intelligent automation with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-science-smart-agriculture-301709cf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Data Science Smart - Agriculture. This autonomous system provides intelligent automation with zero manual intervention needed.
          </p>
