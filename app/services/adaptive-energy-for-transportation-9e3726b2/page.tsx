...
export const metadata: Metadata = {
  title: 'Adaptive Energy for Transportation',
  description: 'Transform your transportation operations with our Adaptive Energy for Transportation. This AI-driven solution automates vendor management with unprecedented acc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-energy-for-transportation-9e3726b2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Energy for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your transportation operations with our Adaptive Energy for Transportation. This AI-driven solution automates vendor management with unprecedented accuracy and efficiency.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Energy Management</li>
          ...
          <li className="text-gray-300">Customer Insights</li>
          </ul>
        </section>
