...
export const metadata: Metadata = {
  title: 'Autonomous Risk System - Healthcare',
  description: 'Unlock unprecedented growth with Autonomous Risk System - Healthcare. This autonomous system provides roi tracking with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-risk-system-healthcare-df5ebaec',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Risk System - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Autonomous Risk System - Healthcare. This autonomous system provides roi tracking with zero manual intervention needed.
          </p>
