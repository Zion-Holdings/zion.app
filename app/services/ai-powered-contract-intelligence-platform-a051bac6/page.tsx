...
export const metadata: Metadata = {
  title: 'AI-Powered Contract Intelligence Platform',
  description: 'Automated contract analysis and management system that extracts clauses, identifies risks, tracks obligations, and alerts on key dates using NLP.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-contract-intelligence-platform-a051bac6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automated contract analysis and management system that extracts clauses, identifies risks, tracks obligations, and alerts on key dates using NLP.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Obligation tracking</li>
        ...
        <section className="mb-12">
          ...
          <li className="text-purple-300">Zero missed deadlines</li>
