...
export const metadata: Metadata = {
  title: 'Smart Support Platform - Real-Estate',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Support Platform - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated real-estate solution: Smart Support Platform - Real-Estate. Combines record extraction with next-gen AI for maximum velocity.
          </p>
