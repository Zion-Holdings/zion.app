...
export const metadata: Metadata = {
  title: 'AI Suite - Education Edition',
  description: 'Revolutionize education through intelligent automation. Our AI Suite - Education Edition leverages advanced machine learning to deliver enterprise-grade insight',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-suite-education-edition-90b36d06',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Suite - Education Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize education through intelligent automation. Our AI Suite - Education Edition leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
