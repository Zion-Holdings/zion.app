...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Finance for Telecom',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Finance for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in telecom with Hyper-Accelerated Finance for Telecom. This AI-powered platform transforms customer retention into a competitive advantage.
          </p>
