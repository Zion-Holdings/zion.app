...
export const metadata: Metadata = {
  title: 'Cognitive Predictor Solution - Legal',
  description: 'Optimize your legal workflows with Cognitive Predictor Solution - Legal. This intelligent platform delivers user provisioning through advanced automation and AI',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-predictor-solution-legal-305b544e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Predictor Solution - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with Cognitive Predictor Solution - Legal. This intelligent platform delivers user provisioning through advanced automation and AI.
          </p>
