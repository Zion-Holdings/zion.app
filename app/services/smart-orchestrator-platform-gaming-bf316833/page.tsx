...
export const metadata: Metadata = {
  title: 'Smart Orchestrator Platform - Gaming',
  description: 'Revolutionize gaming through intelligent automation. Our Smart Orchestrator Platform - Gaming leverages advanced machine learning to deliver recruitment automat',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-orchestrator-platform-gaming-bf316833',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Orchestrator Platform - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize gaming through intelligent automation. Our Smart Orchestrator Platform - Gaming leverages advanced machine learning to deliver recruitment automation at scale.
          </p>
