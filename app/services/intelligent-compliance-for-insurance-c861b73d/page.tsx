...
export const metadata: Metadata = {
  title: 'Intelligent Compliance for Insurance',
  description: 'Next-generation insurance solution: Intelligent Compliance for Insurance. Combines energy management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-compliance-for-insurance-c861b73d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Compliance for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Intelligent Compliance for Insurance. Combines energy management with adaptive intelligence for optimal results.
          </p>
