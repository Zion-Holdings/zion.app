...
export const metadata: Metadata = {
  title: 'AI/IT Analytics Suite - Healthcare #1',
  description: 'The future of healthcare is here with AI/IT Analytics Suite - Healthcare #1. Powered by cutting-edge AI, this platform delivers resource allocation like never b',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-analytics-suite-healthcare-1-159418e7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Analytics Suite - Healthcare #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with AI/IT Analytics Suite - Healthcare #1. Powered by cutting-edge AI, this platform delivers resource allocation like never before.
          </p>
