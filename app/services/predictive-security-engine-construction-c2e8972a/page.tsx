...
export const metadata: Metadata = {
  title: 'Predictive Security Engine - Construction',
  description: 'Next-generation construction solution: Predictive Security Engine - Construction. Combines healthcare data analytics with adaptive intelligence for optimal resu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-security-engine-construction-c2e8972a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Security Engine - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Predictive Security Engine - Construction. Combines healthcare data analytics with adaptive intelligence for optimal results.
          </p>
