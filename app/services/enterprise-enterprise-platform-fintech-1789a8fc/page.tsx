...
export const metadata: Metadata = {
  title: 'Enterprise Enterprise Platform - FINTECH',
  description: 'The future of fintech is here with Enterprise Enterprise Platform - FINTECH. Powered by cutting-edge AI, this platform delivers pricing optimization like never ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-enterprise-platform-fintech-1789a8fc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Enterprise Platform - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of fintech is here with Enterprise Enterprise Platform - FINTECH. Powered by cutting-edge AI, this platform delivers pricing optimization like never before.
          </p>
