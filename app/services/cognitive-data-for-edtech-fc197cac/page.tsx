...
export const metadata: Metadata = {
  title: 'Cognitive Data for EDTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Data for EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your edtech workflows with Cognitive Data for EDTECH. This intelligent platform delivers payroll processing through advanced automation and AI.
          </p>
