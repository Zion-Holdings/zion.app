...
export const metadata: Metadata = {
  title: 'Intelligent Customer Service for Construction',
  description: 'Revolutionize construction through intelligent automation. Our Intelligent Customer Service for Construction leverages advanced machine learning to deliver repu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-customer-service-for-construction-66529b99',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Customer Service for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Intelligent Customer Service for Construction leverages advanced machine learning to deliver reputation management at scale.
          </p>
