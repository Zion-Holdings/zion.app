...
export const metadata: Metadata = {
  title: 'Autonomous Computer Vision System - HEALTHTECH',
  description: 'Enhance your healthtech business with Autonomous Computer Vision System - HEALTHTECH. Our solution provides payroll processing with enterprise-grade reliability',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Computer Vision System - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthtech business with Autonomous Computer Vision System - HEALTHTECH. Our solution provides payroll processing with enterprise-grade reliability and security.
          </p>
