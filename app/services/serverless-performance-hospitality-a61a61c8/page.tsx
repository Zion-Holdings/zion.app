...
export const metadata: Metadata = {
  title: 'Serverless performance-hospitality',
  description: 'Transform hospitality with Serverless performance-hospitality - the intelligent automation platform that learns, adapts, and delivers 10x results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/serverless-performance-hospitality-a61a61c8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Serverless performance-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform hospitality with Serverless performance-hospitality - the intelligent automation platform that learns, adapts, and delivers 10x results.
          </p>
