...
export const metadata: Metadata = {
  title: 'Autonomous Data for Hospitality',
  description: 'Next-generation hospitality solution: Autonomous Data for Hospitality. Combines content generation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-data-for-hospitality-a624da2c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Data for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Autonomous Data for Hospitality. Combines content generation with adaptive intelligence for optimal results.
          </p>
