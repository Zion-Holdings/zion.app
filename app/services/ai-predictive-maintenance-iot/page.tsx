...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time sensor data ingestion, Failure prediction (7-30 day window), Root cause analysis, Maintenance work order auto-generation, Remaining useful life estimates, Digital twin integration, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Predictive Maintenance for Industrial IoT</h1>
        <p className="text-lg text-slate-300 mb-8">Predict equipment failures before they happen. Ingests sensor data, identifies anomalies, triggers maintenance work orders. Reduces unplanned downtime by 60%.</p>
        ...
        <li class="text-slate-300">Real-time sensor data ingestion</li>
        <li class="text-slate-300">Failure prediction (7-30 day window)</li>
        <li class="text-slate-300">Root cause analysis</li>
        <li class="text-slate-300">Maintenance work order auto-generation</li>
        <li class="text-slate-300">Remaining useful life estimates</li>
        <li class="text-slate-300">Digital twin integration</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce unplanned downtime by 60%</li>
        <li class="text-slate-300">Extend asset life by 25%</li>
        <li class="text-slate-300">Cut maintenance costs by 30%</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">2499</p>
