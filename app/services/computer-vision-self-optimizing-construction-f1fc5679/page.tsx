...
export const metadata: Metadata = {
  title: 'Computer Vision Self-Optimizing - Construction',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Computer Vision Self-Optimizing - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Computer Vision Self-Optimizing - Construction. Combines quality assurance with adaptive intelligence for optimal results.
          </p>
