...
export const metadata: Metadata = {
  title: 'Quantum Optimization - Construction Quantum',
  description: 'Quantum leap forward for construction: Quantum Optimization - Construction Quantum. Uses quantum-inspired algorithms to deliver workflow management at exponenti',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Optimization - Construction Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for construction: Quantum Optimization - Construction Quantum. Uses quantum-inspired algorithms to deliver workflow management at exponential speed.
          </p>
