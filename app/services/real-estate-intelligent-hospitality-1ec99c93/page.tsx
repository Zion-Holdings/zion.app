...
export const metadata: Metadata = {
  title: 'Real Estate Intelligent - Hospitality',
  description: 'The future of hospitality is here with Real Estate Intelligent - Hospitality. Powered by cutting-edge AI, this platform delivers api management like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/real-estate-intelligent-hospitality-1ec99c93',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Real Estate Intelligent - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Real Estate Intelligent - Hospitality. Powered by cutting-edge AI, this platform delivers api management like never before.
          </p>
