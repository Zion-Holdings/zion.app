...
export const metadata: Metadata = {
  title: 'AI Coordinator - Cleantech Edition',
  description: 'Transform your cleantech operations with our AI Coordinator - Cleantech Edition. This AI-driven solution automates energy management with unprecedented accuracy',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-coordinator---cleantech-edition-e3f285a9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Coordinator - Cleantech Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your cleantech operations with our AI Coordinator - Cleantech Edition. This AI-driven solution automates energy management with unprecedented accuracy and efficiency.
          </p>
