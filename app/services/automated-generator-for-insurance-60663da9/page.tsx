...
export const metadata: Metadata = {
  title: 'Automated Generator for Insurance',
  description: 'Transform your insurance operations with our Automated Generator for Insurance. This AI-driven solution automates forecast accuracy with unprecedented accuracy ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-generator-for-insurance-60663da9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Generator for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Automated Generator for Insurance. This AI-driven solution automates forecast accuracy with unprecedented accuracy and efficiency.
          </p>
