...
export const metadata: Metadata = {
  title: 'Automated real estate-manufacturing',
  description: 'Enhance your manufacturing business with Automated real estate-manufacturing. Our solution provides logistics route optimization with enterprise-grade reliabili',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated real estate-manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your manufacturing business with Automated real estate-manufacturing. Our solution provides logistics route optimization with enterprise-grade reliability and security.
          </p>
