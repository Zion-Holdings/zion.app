...
export const metadata: Metadata = {
  title: 'Enterprise Performance Platform - Healthcare',
  description: 'The future of healthcare is here with Enterprise Performance Platform - Healthcare. Powered by cutting-edge AI, this platform delivers record processing like ne',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-performance-platform-healthcare-f787af6c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Performance Platform - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Enterprise Performance Platform - Healthcare. Powered by cutting-edge AI, this platform delivers record processing like never before.
          </p>
