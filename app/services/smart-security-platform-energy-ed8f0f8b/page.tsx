...
export const metadata: Metadata = {
  title: 'Smart Security Platform - Energy',
  description: 'The future of energy is here with Smart Security Platform - Energy. Powered by cutting-edge AI, this platform delivers incident response like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-security-platform-energy-ed8f0f8b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Security Platform - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Smart Security Platform - Energy. Powered by cutting-edge AI, this platform delivers incident response like never before.
          </p>
