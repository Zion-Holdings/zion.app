...
export const metadata: Metadata = {
  ...
  keywords: 'OpenTelemetry auto-instrumentation, Log aggregation & search, Distributed tracing, Profiling (CPU/memory), AI RCA (root cause), it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Unified Observability Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Single pane of glass for logs, metrics, traces, and profiles. Powered by OpenTelemetry, with AI-assisted root cause analysis.</p>
        ...
        <li class="text-slate-300">OpenTelemetry auto-instrumentation</li>
        <li class="text-slate-300">Log aggregation &amp; search</li>
        <li class="text-slate-300">Distributed tracing</li>
        <li class="text-slate-300">Profiling (CPU/memory)</li>
        <li class="text-slate-300">AI RCA (root cause)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with unified observability platform</li>
