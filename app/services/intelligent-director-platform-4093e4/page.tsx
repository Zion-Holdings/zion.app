...
export const metadata: Metadata = {
  title: 'Intelligent Director Platform',
  description: 'Transform your healthcare operations with our Intelligent Director Platform. This automation solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-director-platform-4093e4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Director Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Intelligent Director Platform. This automation solution delivers unprecedented automation and intelligence.
          </p>
