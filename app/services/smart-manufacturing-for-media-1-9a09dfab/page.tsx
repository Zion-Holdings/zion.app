  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Revolutionize media through intelligent automation. Our Smart Manufacturing for Media #1 leverages advanced machine learning to deliver inventory management at scale.</p>
