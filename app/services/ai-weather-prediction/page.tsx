...
export const metadata: Metadata = {
  ...
  keywords: 'Hyperlocal weather forecasting (1km resolution), Climate risk scoring for assets and supply chains, Severe weather early warning, Integration with IoT sensors and SCADA, Historical climate trend analysis, Custom models for agriculture, energy, insurance, API for embedding weather intelligence, Climate scenario modeling (RCP 4.5, 8.5), ai, energy, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Weather Prediction &amp; Climate Risk Analytics</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered hyperlocal weather prediction and climate risk analytics. Protect assets, optimize operations, and manage climate risk with 95% accurate forecasts.</p>
        ...
        <li class="text-slate-300">Hyperlocal weather forecasting (1km resolution)</li>
        <li class="text-slate-300">Climate risk scoring for assets and supply chains</li>
        <li class="text-slate-300">Severe weather early warning</li>
        <li class="text-slate-300">Integration with IoT sensors and SCADA</li>
        <li class="text-slate-300">Historical climate trend analysis</li>
        <li class="text-slate-300">Custom models for agriculture, energy, insurance</li>
        <li class="text-slate-300">API for embedding weather intelligence</li>
        <li class="text-slate-300">Climate scenario modeling (RCP 4.5, 8.5)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">95% accurate hyperlocal forecasts</li>
        <li class="text-slate-300">Protect assets from weather disruptions</li>
        <li class="text-slate-300">Optimize operations with weather intelligence</li>
        <li class="text-slate-300">Manage long-term climate risk</li>
      </ul>
        </div>
