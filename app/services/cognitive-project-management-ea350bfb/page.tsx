...
export const metadata: Metadata = {
  title: 'Cognitive Project Management',
  description: 'Revolutionize agriculture through intelligent automation. Our Cognitive Project Management leverages advanced machine learning to deliver sales process optimiza',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-project-management-ea350bfb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Cognitive Project Management leverages advanced machine learning to deliver sales process optimization at scale.
          </p>
