...
export const metadata = {
  ...
  alternates: { canonical: '/services/it-consulting-2026-6984/' },

  openGraph: {
    title: 'IT Consulting | Zion Tech Group',
    description: 'End-to-end it consulting services: assessment, deployment, and managed operations.',
    url: 'https://ziontechgroup.com/services/it-consulting-2026-6984/',
...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "IT Consulting | Zion Tech Group", description: "End-to-end it consulting services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/it-consulting-2026-6984/"}} />
