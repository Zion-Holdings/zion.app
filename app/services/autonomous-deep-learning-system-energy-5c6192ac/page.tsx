...
export const metadata: Metadata = {
  title: 'Autonomous Deep Learning System - Energy',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Deep Learning System - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Autonomous Deep Learning System - Energy. This AI-powered platform transforms campaign optimization into a competitive advantage.
          </p>
