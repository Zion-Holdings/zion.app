...
export const metadata: Metadata = {
  ...
  keywords: 'Self-service IT catalog, Automated employee lifecycle (joiner/mover/leaver), License optimization engine, Employee sentiment surveys, it, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Digital Workplace Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Unified intranet, collaboration, and employee apps (Microsoft 365 + Google Workspace + Slack) with streamlined onboarding and automated license management.</p>
        ...
        <li class="text-slate-300">Self-service IT catalog</li>
        <li class="text-slate-300">Automated employee lifecycle (joiner/mover/leaver)</li>
        <li class="text-slate-300">License optimization engine</li>
        <li class="text-slate-300">Employee sentiment surveys</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with digital workplace platform</li>
