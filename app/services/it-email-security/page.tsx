...
export const metadata: Metadata = {
  ...
  keywords: 'AI-powered phishing and BEC detection, Email encryption and DLP, Automated email archiving with legal hold, eDiscovery and compliance reporting, Integration with Microsoft 365 and Google Workspace, Email continuity during outages, Advanced threat protection sandboxing, User security awareness training, security, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Email Security, Compliance &amp; Archiving</h1>
        <p className="text-lg text-slate-300 mb-8">Comprehensive email security, compliance, and archiving solution. Protect against phishing, BEC, and data loss while meeting legal and regulatory requirements.</p>
        ...
        <li class="text-slate-300">AI-powered phishing and BEC detection</li>
        <li class="text-slate-300">Email encryption and DLP</li>
        <li class="text-slate-300">Automated email archiving with legal hold</li>
        <li class="text-slate-300">eDiscovery and compliance reporting</li>
        <li class="text-slate-300">Integration with Microsoft 365 and Google Workspace</li>
        <li class="text-slate-300">Email continuity during outages</li>
        <li class="text-slate-300">Advanced threat protection sandboxing</li>
        <li class="text-slate-300">User security awareness training</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Block 99.9% of email threats</li>
        <li class="text-slate-300">Meet SEC, FINRA, HIPAA, GDPR requirements</li>
        <li class="text-slate-300">Recover emails instantly with granular search</li>
        <li class="text-slate-300">Maintain email continuity even during outages</li>
      </ul>
        </div>
