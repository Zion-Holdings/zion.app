...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'IT Email Security, Compliance & Archiving', 'description': 'Comprehensive email security, compliance, and archiving solution. Protect against phishing, BEC, and data loss while meeting legal and regulatory requirements.', 'serviceType': 'security', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'technology'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'IT Email Security, Compliance & Archiving Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$5/user/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$12/user/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': 'Custom', 'priceCurrency': 'USD'}]}} />
    <JsonLd data={'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'AI-powered phishing and BEC detection', 'acceptedAnswer': {'@type': 'Answer', 'text': 'AI-powered phishing and BEC detection'}}, {'@type': 'Question', 'name': 'Email encryption and DLP', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Email encryption and DLP'}}, {'@type': 'Question', 'name': 'Automated email archiving with legal hold', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Automated email archiving with legal hold'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Block 99.9% of email threats; Meet SEC, FINRA, HIPAA, GDPR requirements; Recover emails instantly with granular search'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} />
