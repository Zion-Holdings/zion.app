...
export const metadata: Metadata = {
  title: 'Adaptive Incident Coordinator',
  description: 'Transform your transportation operations with our Adaptive Incident Coordinator. This AI-driven solution automates influencer identification with unprecedented ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Incident Coordinator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your transportation operations with our Adaptive Incident Coordinator. This AI-driven solution automates influencer identification with unprecedented accuracy and efficiency.
          </p>
