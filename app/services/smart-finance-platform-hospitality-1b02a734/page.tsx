...
export const metadata: Metadata = {
  ...
  description: 'Optimize your hospitality workflows with Smart Finance Platform - Hospitality. This intelligent platform delivers automation opportunity through advanced automa',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-finance-platform-hospitality-1b02a734',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Smart Finance Platform - Hospitality. This intelligent platform delivers automation opportunity through advanced automation and AI.
          </p>
