...
export const metadata: Metadata = {
  title: 'AI-Powered analyzer-transportation #1',
  description: 'Enhance your transportation business with AI-Powered analyzer-transportation #1. Our solution provides recruitment automation with enterprise-grade reliability ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered analyzer-transportation #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with AI-Powered analyzer-transportation #1. Our solution provides recruitment automation with enterprise-grade reliability and security.
          </p>
