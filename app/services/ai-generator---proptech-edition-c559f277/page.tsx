...
export const metadata: Metadata = {
  title: 'AI Generator - Proptech Edition',
  description: 'Revolutionize proptech through intelligent automation. Our AI Generator - Proptech Edition leverages advanced machine learning to deliver maintenance scheduling',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Generator - Proptech Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our AI Generator - Proptech Edition leverages advanced machine learning to deliver maintenance scheduling at scale.
          </p>
