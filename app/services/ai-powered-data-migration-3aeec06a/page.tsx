...
export const metadata: Metadata = {
  title: "AI-Powered Data Migration - AI-Powered Data Engineering Solution",
  description: "Intelligent data migration planning and execution.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-data-migration-3aeec06a",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Data Migration - AI-Powered Data Engineering Solution
        </h1>
