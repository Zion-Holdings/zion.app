...
export const metadata: Metadata = {
  title: 'Brand Awareness AI-Powered Market Intelligence',
  description: 'brand awareness solution for railways industry. Monitors market trends, competitor activities, and industry news to provide actionable insights.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/brand-awareness-ai-powered-market-intelligence-fa54d823',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Brand Awareness AI-Powered Market Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            brand awareness solution for railways industry. Monitors market trends, competitor activities, and industry news to provide actionable insights.
          </p>
