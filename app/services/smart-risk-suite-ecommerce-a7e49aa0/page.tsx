...
export const metadata: Metadata = {
  title: 'Smart Risk Suite - Ecommerce',
  description: 'Optimize your ecommerce workflows with Smart Risk Suite - Ecommerce. This intelligent platform delivers project portfolio through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-risk-suite-ecommerce-a7e49aa0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Risk Suite - Ecommerce
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your ecommerce workflows with Smart Risk Suite - Ecommerce. This intelligent platform delivers project portfolio through advanced automation and AI.
          </p>
