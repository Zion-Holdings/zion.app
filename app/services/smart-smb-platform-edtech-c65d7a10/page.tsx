...
export const metadata: Metadata = {
  title: 'Smart SMB Platform - EDTECH',
  description: 'Optimize your edtech workflows with Smart SMB Platform - EDTECH. This intelligent platform delivers brand monitoring through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-smb-platform-edtech-c65d7a10',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart SMB Platform - EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your edtech workflows with Smart SMB Platform - EDTECH. This intelligent platform delivers brand monitoring through advanced automation and AI.
          </p>
