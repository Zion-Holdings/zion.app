...
export const metadata: Metadata = {
  title: 'Quantum Strategic for Construction',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Strategic for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for construction: Quantum Strategic for Construction. Uses quantum-inspired algorithms to deliver case management at exponential speed.
          </p>
