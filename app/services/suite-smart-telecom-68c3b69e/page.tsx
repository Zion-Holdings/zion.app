...
export const metadata: Metadata = {
  title: 'Suite Smart - Telecom',
  description: 'Optimize your telecom workflows with Suite Smart - Telecom. This intelligent platform delivers customer journey mapping through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/suite-smart-telecom-68c3b69e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your telecom workflows with Suite Smart - Telecom. This intelligent platform delivers customer journey mapping through advanced automation and AI.
          </p>
