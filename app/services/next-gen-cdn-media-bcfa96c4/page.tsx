...
export const metadata: Metadata = {
  title: 'Next-Gen CDN - Media',
  description: 'The future of media is here with Next-Gen CDN - Media. Powered by cutting-edge AI, this platform delivers succession planning like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-cdn-media-bcfa96c4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of media is here with Next-Gen CDN - Media. Powered by cutting-edge AI, this platform delivers succession planning like never before.
          </p>
