...
export const metadata: Metadata = {
  title: 'Survey AI - Real-Estate',
  description: 'Optimize your real-estate workflows with Survey AI - Real-Estate. This intelligent platform delivers renewal prediction through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/survey-ai-real-estate-9b4e525b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Survey AI - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your real-estate workflows with Survey AI - Real-Estate. This intelligent platform delivers renewal prediction through advanced automation and AI.
          </p>
