...
export const metadata: Metadata = {
  title: "AI-Powered Lead Scoring & Routing - AI-Powered Sales Solution",
  description: "Scores and routes sales leads in real-time based on engagement.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-lead-scoring--routing-bcf65bf1",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Lead Scoring & Routing - AI-Powered Sales Solution
        </h1>
