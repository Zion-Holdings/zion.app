...
export const metadata: Metadata = {
  title: 'Smart Data for Agriculture',
  description: 'Unlock unprecedented growth with Smart Data for Agriculture. This autonomous system provides fraud prevention with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-data-for-agriculture-914610d7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Data for Agriculture. This autonomous system provides fraud prevention with zero manual intervention needed.
          </p>
