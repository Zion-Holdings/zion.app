...
export const metadata: Metadata = {
  title: 'Self-Optimizing Energy Customer Service',
  description: 'Revolutionize manufacturing through intelligent automation. Our Self-Optimizing Energy Customer Service leverages advanced machine learning to deliver maintenan',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Energy Customer Service
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize manufacturing through intelligent automation. Our Self-Optimizing Energy Customer Service leverages advanced machine learning to deliver maintenance scheduling at scale.
          </p>
