...
export const metadata: Metadata = {
  title: 'Smart Anomaly Machine Learning',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Anomaly Machine Learning
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation real-estate solution: Smart Anomaly Machine Learning. Combines personalization engine with adaptive intelligence for optimal results.
          </p>
