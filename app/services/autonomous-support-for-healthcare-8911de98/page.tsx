...
export const metadata: Metadata = {
  title: 'Autonomous Support for Healthcare',
  description: 'Next-generation healthcare solution: Autonomous Support for Healthcare. Combines predictive analytics with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-support-for-healthcare-8911de98',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Support for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Autonomous Support for Healthcare. Combines predictive analytics with adaptive intelligence for optimal results.
          </p>
