...
export const metadata: Metadata = {
  title: 'AI Advisor - Insurance Edition',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Advisor - Insurance Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with AI Advisor - Insurance Edition. Powered by cutting-edge AI, this platform delivers threat detection like never before.
          </p>
