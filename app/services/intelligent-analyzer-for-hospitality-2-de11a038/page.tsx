...
export const metadata = {
  ...
  description: "Drive innovation in hospitality with Intelligent Analyzer for Hospitality #2. This AI-powered platform transforms customer retention into a competitive advantag",
  alternates: {
