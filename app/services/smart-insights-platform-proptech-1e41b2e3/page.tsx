...
export const metadata: Metadata = {
  title: 'Smart Insights Platform - PROPTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Insights Platform - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your proptech operations with our Smart Insights Platform - PROPTECH. This AI-driven solution automates talent acquisition with unprecedented accuracy and efficiency.
          </p>
