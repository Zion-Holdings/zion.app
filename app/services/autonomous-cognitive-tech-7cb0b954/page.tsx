...
export const metadata: Metadata = {
  title: 'Autonomous cognitive-tech',
  description: 'Next-generation technology solution: Autonomous cognitive-tech. Combines data processing with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-cognitive-tech-7cb0b954',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous cognitive-tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation technology solution: Autonomous cognitive-tech. Combines data processing with adaptive intelligence for optimal results.
          </p>
