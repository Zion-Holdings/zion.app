...
export const metadata: Metadata = {
  title: 'Predictive Suite Engine - Energy',
  description: 'Optimize your energy workflows with Predictive Suite Engine - Energy. This intelligent platform delivers document processing through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-suite-engine-energy-30b8c73a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Suite Engine - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your energy workflows with Predictive Suite Engine - Energy. This intelligent platform delivers document processing through advanced automation and AI.
          </p>
