...
export const metadata: Metadata = {
  title: 'Intelligent Management for Legal',
  description: 'Drive innovation in legal with Intelligent Management for Legal. This AI-powered platform transforms resource allocation into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-management-for-legal-e6f184e4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Management for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Intelligent Management for Legal. This AI-powered platform transforms resource allocation into a competitive advantage.
          </p>
