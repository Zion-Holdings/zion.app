...
export const metadata: Metadata = {
  title: 'Business Intelligence Intelligent - Hospitality',
  description: 'Drive innovation in hospitality with Business Intelligence Intelligent - Hospitality. This AI-powered platform transforms decision support into a competitive ad',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Business Intelligence Intelligent - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Business Intelligence Intelligent - Hospitality. This AI-powered platform transforms decision support into a competitive advantage.
          </p>
