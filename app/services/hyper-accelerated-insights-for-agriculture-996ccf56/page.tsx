...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Insights for Agriculture',
  description: 'Enhance your agriculture business with Hyper-Accelerated Insights for Agriculture. Our solution provides process mining with enterprise-grade reliability and se',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Insights for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your agriculture business with Hyper-Accelerated Insights for Agriculture. Our solution provides process mining with enterprise-grade reliability and security.
          </p>
