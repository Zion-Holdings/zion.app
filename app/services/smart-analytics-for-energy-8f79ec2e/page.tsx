...
export const metadata: Metadata = {
  title: 'Smart Analytics for Energy',
  description: 'Transform your energy operations with our Smart Analytics for Energy. This AI-driven solution automates sales forecasting with unprecedented accuracy and effici',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-analytics-for-energy-8f79ec2e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Analytics for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Smart Analytics for Energy. This AI-driven solution automates sales forecasting with unprecedented accuracy and efficiency.
          </p>
