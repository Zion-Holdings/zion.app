...
export const metadata: Metadata = {
  title: 'Business Intelligence AI - Transportation',
  description: 'Optimize your transportation workflows with Business Intelligence AI - Transportation. This intelligent platform delivers budget optimization through advanced a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/business-intelligence-ai-transportation-2150086a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Business Intelligence AI - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Business Intelligence AI - Transportation. This intelligent platform delivers budget optimization through advanced automation and AI.
          </p>
