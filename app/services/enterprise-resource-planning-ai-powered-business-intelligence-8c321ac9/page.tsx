...
export const metadata: Metadata = {
  title: 'Enterprise Resource Planning AI-Powered Business Intelligence',
  description: 'AI-powered enterprise resource planning solution for bi. Automated BI report generation and insight discovery.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-resource-planning-ai-powered-business-intelligence-8c321ac9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Resource Planning AI-Powered Business Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered enterprise resource planning solution for bi. Automated BI report generation and insight discovery.
          </p>
