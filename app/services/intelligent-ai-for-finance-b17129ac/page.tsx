...
export const metadata: Metadata = {
  title: 'Intelligent AI for Finance',
  description: 'Unlock unprecedented growth with Intelligent AI for Finance. This autonomous system provides testing automation with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-ai-for-finance-b17129ac',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent AI for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent AI for Finance. This autonomous system provides testing automation with zero manual intervention needed.
          </p>
