...
export const metadata: Metadata = {
  title: 'Influencer Management Multi-Cloud Cost Management Platform',
  description: 'influencer management solution for seaports industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/influencer-management-multi-cloud-cost-management-platform-47d8dd1a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Influencer Management Multi-Cloud Cost Management Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            influencer management solution for seaports industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.
          </p>
