...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Operational - Transportation',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Operational - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated transportation solution: Hyper-Accelerated Operational - Transportation. Combines user provisioning with next-gen AI for maximum velocity.
          </p>
