...
export const metadata: Metadata = {
  title: 'AI-Powered Risk Generator',
  description: 'The future of technology is here with AI-Powered Risk Generator. Powered by cutting-edge AI, this platform delivers decision support like never before.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Risk Generator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of technology is here with AI-Powered Risk Generator. Powered by cutting-edge AI, this platform delivers decision support like never before.
          </p>
