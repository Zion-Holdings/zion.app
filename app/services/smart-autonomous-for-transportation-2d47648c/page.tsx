...
export const metadata: Metadata = {
  title: 'Smart Autonomous for Transportation',
  description: 'The future of transportation is here with Smart Autonomous for Transportation. Powered by cutting-edge AI, this platform delivers language processing like never',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-autonomous-for-transportation-2d47648c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Autonomous for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Smart Autonomous for Transportation. Powered by cutting-edge AI, this platform delivers language processing like never before.
          </p>
