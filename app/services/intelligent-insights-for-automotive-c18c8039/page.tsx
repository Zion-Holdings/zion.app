...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize automotive through intelligent automation. Our Intelligent Insights for Automotive leverages advanced machine learning to deliver performance moni',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-insights-for-automotive-c18c8039',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize automotive through intelligent automation. Our Intelligent Insights for Automotive leverages advanced machine learning to deliver performance monitoring at scale.
          </p>
