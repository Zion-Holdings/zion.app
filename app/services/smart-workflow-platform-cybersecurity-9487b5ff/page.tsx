...
export const metadata: Metadata = {
  title: 'Smart Workflow Platform - Cybersecurity',
  description: 'Revolutionize cybersecurity through intelligent automation. Our Smart Workflow Platform - Cybersecurity leverages advanced machine learning to deliver sustainab',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-workflow-platform-cybersecurity-9487b5ff',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Workflow Platform - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cybersecurity through intelligent automation. Our Smart Workflow Platform - Cybersecurity leverages advanced machine learning to deliver sustainability tracking at scale.
          </p>
