...
export const metadata: Metadata = {
  title: "AI Legal Demand Forecasting Engine - AI-Powered Legal Solution",
  description: "AI-powered legal solution leveraging advanced machine learning for optimal performance and ROI.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-legal-demand-forecasting-engine-6ebec990",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI Legal Demand Forecasting Engine - AI-Powered Legal Solution
        </h1>
