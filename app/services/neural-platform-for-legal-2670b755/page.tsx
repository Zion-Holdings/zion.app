...
export const metadata: Metadata = {
  title: 'Neural Platform for Legal',
  description: 'Revolutionize legal through intelligent automation. Our Neural Platform for Legal leverages advanced machine learning to deliver data processing at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-platform-for-legal-2670b755',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Platform for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Neural Platform for Legal leverages advanced machine learning to deliver data processing at scale.
          </p>
