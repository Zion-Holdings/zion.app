...
export const metadata: Metadata = {
  title: 'Smart Autonomous Platform - Energy',
  description: 'Enhance your energy business with Smart Autonomous Platform - Energy. Our solution provides fraud prevention with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-autonomous-platform-energy-394fd7f4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Autonomous Platform - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your energy business with Smart Autonomous Platform - Energy. Our solution provides fraud prevention with enterprise-grade reliability and security.
          </p>
