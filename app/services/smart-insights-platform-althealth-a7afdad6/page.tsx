...
export const metadata: Metadata = {
  title: 'Smart Insights Platform - ALTHEALTH',
  description: 'Drive innovation in althealth with Smart Insights Platform - ALTHEALTH. This AI-powered platform transforms capacity planning into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-insights-platform-althealth-a7afdad6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Insights Platform - ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in althealth with Smart Insights Platform - ALTHEALTH. This AI-powered platform transforms capacity planning into a competitive advantage.
          </p>
