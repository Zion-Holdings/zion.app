...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize education through intelligent automation. Our Autonomous Risk for Education #1 leverages advanced machine learning to deliver maintenance scheduli',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-risk-for-education-1-786aad9c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize education through intelligent automation. Our Autonomous Risk for Education #1 leverages advanced machine learning to deliver maintenance scheduling at scale.
          </p>
