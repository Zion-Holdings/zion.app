...
export const metadata: Metadata = {
  title: 'Next-Gen Financial for PROPTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Financial for PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with Next-Gen Financial for PROPTECH. Powered by cutting-edge AI, this platform delivers process mining like never before.
          </p>
