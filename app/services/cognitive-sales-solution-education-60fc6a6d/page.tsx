...
export const metadata: Metadata = {
  title: 'Cognitive Sales Solution - Education',
  description: 'The future of education is here with Cognitive Sales Solution - Education. Powered by cutting-edge AI, this platform delivers feature engineering like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-sales-solution-education-60fc6a6d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Sales Solution - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of education is here with Cognitive Sales Solution - Education. Powered by cutting-edge AI, this platform delivers feature engineering like never before.
          </p>
