      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Self-Optimizing Optimization for Legal. Powered by cutting-edge AI, this platform delivers quality control like never before.
          </p>
