...
export const metadata: Metadata = {
  ...
  keywords: 'CLIP-compatible embedding index from any image or video frame up to 60 frames per second, Multi-modal retrieval — text-to-image, image-to-image, and image-to-video query supported, Parent-album auto-cluster — same-scene and same-people clips auto-grouped per video, Auto-detected people, location, and label tags per frame with searchable metadata, data, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Image and Video Search Engine</h1>
        <p className="text-lg text-slate-300 mb-8">Visual search engine for media libraries: CLIP-compatible index built from images and video frames up to 60 frames per second; multi-modal query with text or image; auto-cluster same-scene per video clip; people, location, and label auto-tags per frame.</p>
        ...
        <li class="text-slate-300">CLIP-compatible embedding index from any image or video frame up to 60 frames per second</li>
        <li class="text-slate-300">Multi-modal retrieval — text-to-image, image-to-image, and image-to-video query supported</li>
        <li class="text-slate-300">Parent-album auto-cluster — same-scene and same-people clips auto-grouped per video</li>
        <li class="text-slate-300">Auto-detected people, location, and label tags per frame with searchable metadata</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with image and video search engine</li>
