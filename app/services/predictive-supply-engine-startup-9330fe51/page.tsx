...
export const metadata: Metadata = {
  title: 'Predictive Supply Engine - Startup',
  description: 'Transform your startup operations with our Predictive Supply Engine - Startup. This AI-driven solution automates feedback collection with unprecedented accuracy',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Supply Engine - Startup
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your startup operations with our Predictive Supply Engine - Startup. This AI-driven solution automates feedback collection with unprecedented accuracy and efficiency.
          </p>
