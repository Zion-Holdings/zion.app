...
export const metadata: Metadata = {
  title: 'Neural Data Science for Energy',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Data Science for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Neural Data Science for Energy. Combines logistics route optimization with adaptive intelligence for optimal results.
          </p>
