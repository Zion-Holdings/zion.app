...
export const metadata: Metadata = {
  title: 'Quantum Experience - Telecom Quantum',
  description: 'The future of telecom is here with Quantum Experience - Telecom Quantum. Powered by cutting-edge AI, this platform delivers brand sentiment like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-experience-telecom-quantum-71a23ab4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Experience - Telecom Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of telecom is here with Quantum Experience - Telecom Quantum. Powered by cutting-edge AI, this platform delivers brand sentiment like never before.
          </p>
