...
export const metadata: Metadata = {
  title: 'Cognitive Process Advisor',
  description: 'Drive innovation in energy with Cognitive Process Advisor. This AI-powered platform transforms lead scoring into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-process-advisor-160735a6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Process Advisor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Cognitive Process Advisor. This AI-powered platform transforms lead scoring into a competitive advantage.
          </p>
