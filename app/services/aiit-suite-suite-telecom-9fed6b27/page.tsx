...
export const metadata: Metadata = {
  title: 'AI/IT Suite Suite - Telecom',
  description: 'The future of telecom is here with AI/IT Suite Suite - Telecom. Powered by cutting-edge AI, this platform delivers data governance like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-suite-suite-telecom-9fed6b27',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Suite Suite - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of telecom is here with AI/IT Suite Suite - Telecom. Powered by cutting-edge AI, this platform delivers data governance like never before.
          </p>
