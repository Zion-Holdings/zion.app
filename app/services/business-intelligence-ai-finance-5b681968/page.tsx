...
export const metadata: Metadata = {
  title: 'Business Intelligence AI - Finance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Business Intelligence AI - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation finance solution: Business Intelligence AI - Finance. Combines root cause analysis with adaptive intelligence for optimal results.
          </p>
