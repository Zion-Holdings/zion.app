...
export const metadata: Metadata = {
  title: 'AI Security - Blockchain Edition',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Security - Blockchain Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of blockchain is here with AI Security - Blockchain Edition. Powered by cutting-edge AI, this platform delivers language processing like never before.
          </p>
