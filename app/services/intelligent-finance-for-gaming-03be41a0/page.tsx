...
export const metadata: Metadata = {
  title: 'Intelligent Finance for Gaming',
  description: 'Revolutionize gaming through intelligent automation. Our Intelligent Finance for Gaming leverages advanced machine learning to deliver hr analytics at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-finance-for-gaming-03be41a0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Finance for Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize gaming through intelligent automation. Our Intelligent Finance for Gaming leverages advanced machine learning to deliver hr analytics at scale.
          </p>
