...
export const metadata: Metadata = {
  title: 'Smart Suite Platform - Hospitality #1',
  description: 'Next-generation hospitality solution: Smart Suite Platform - Hospitality #1. Combines ml model training with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-suite-platform-hospitality-1-dccd0375',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Suite Platform - Hospitality #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Smart Suite Platform - Hospitality #1. Combines ml model training with adaptive intelligence for optimal results.
          </p>
