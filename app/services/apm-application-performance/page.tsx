...
export const metadata: Metadata = {
  ...
  keywords: 'Distributed traces per request, Slow query / endpoint dashboard, Error tracking with stack, SLO burn-rate alerting, Service map dependency view, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">APM Application Performance</h1>
        <p className="text-lg text-slate-300 mb-8">Deep-dive application performance monitoring with distributed tracing, slow query dashboards, error tracking, and SLO/SLI burn-rate alerting.</p>
        ...
        <li class="text-slate-300">Distributed traces per request</li>
        <li class="text-slate-300">Slow query / endpoint dashboard</li>
        <li class="text-slate-300">Error tracking with stack</li>
        <li class="text-slate-300">SLO burn-rate alerting</li>
        <li class="text-slate-300">Service map dependency view</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with apm application performance</li>
