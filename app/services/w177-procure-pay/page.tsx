...
export const metadata: Metadata = {
  ...
  keywords: 'Requisition and approval workflows, Purchase order generation, Receiving and three-way matching, Invoice processing and payment, Vendor performance tracking, Integration with SAP Ariba, Coupa, Oracle, automation, Procurement, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Procure-to-Pay Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Automate procurement-to-payment: requisitions, POs, receiving, invoice matching, payment. Reduce cycle 60%.</p>
        ...
        <li class="text-slate-300">Purchase order generation</li>
        <li class="text-slate-300">Receiving and three-way matching</li>
        <li class="text-slate-300">Invoice processing and payment</li>
        <li class="text-slate-300">Vendor performance tracking</li>
        <li class="text-slate-300">Integration with SAP Ariba</li>
        <li class="text-slate-300">Coupa</li>
        <li class="text-slate-300">Oracle</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce procurement cycle by 60%</li>
        <li class="text-slate-300">Three-way matching prevents overpayment</li>
        <li class="text-slate-300">Invoice processing automated</li>
        <li class="text-slate-300">Vendor performance tracking</li>
      </ul>
        </div>
