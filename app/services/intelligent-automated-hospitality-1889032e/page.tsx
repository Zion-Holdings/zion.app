...
export const metadata: Metadata = {
  title: 'Intelligent Automated - Hospitality',
  description: 'Transform your hospitality operations with our Intelligent Automated - Hospitality. This AI-driven solution automates customer retention with unprecedented accu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Automated - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Intelligent Automated - Hospitality. This AI-driven solution automates customer retention with unprecedented accuracy and efficiency.
          </p>
