...
export const metadata: Metadata = {
  ...
  description: 'Analyzes customer sentiment across all touchpoints to identify at-risk customers.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-customer-sentiment-analysis-c7f81ebb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Analyzes customer sentiment across all touchpoints to identify at-risk customers.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Risk identification</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">30% churn reduction</li>
