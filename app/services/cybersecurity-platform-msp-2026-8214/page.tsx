...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "Cybersecurity for MSPs | Zion Tech Group", description: "End-to-end cybersecurity for msps services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/cybersecurity-platform-msp-2026-8214/"}} />
