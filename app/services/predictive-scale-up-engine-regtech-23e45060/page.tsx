...
export const metadata: Metadata = {
  title: 'Predictive Scale-up Engine - REGTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Scale-up Engine - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your regtech operations with our Predictive Scale-up Engine - REGTECH. This AI-driven solution automates form processing with unprecedented accuracy and efficiency.
          </p>
