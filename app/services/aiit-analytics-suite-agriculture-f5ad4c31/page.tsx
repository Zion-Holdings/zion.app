...
export const metadata: Metadata = {
  title: 'AI/IT Analytics Suite - Agriculture',
  description: 'Transform your agriculture operations with our AI/IT Analytics Suite - Agriculture. This AI-driven solution automates onboarding automation with unprecedented a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-analytics-suite-agriculture-f5ad4c31',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Analytics Suite - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our AI/IT Analytics Suite - Agriculture. This AI-driven solution automates onboarding automation with unprecedented accuracy and efficiency.
          </p>
