...
export const metadata: Metadata = {
  title: 'Smart Logistics Suite',
  description: 'The future of gaming is here with Smart Logistics Suite. Powered by cutting-edge AI, this platform delivers healthcare data analytics like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-logistics-suite-317b5a13',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of gaming is here with Smart Logistics Suite. Powered by cutting-edge AI, this platform delivers healthcare data analytics like never before.
          </p>
