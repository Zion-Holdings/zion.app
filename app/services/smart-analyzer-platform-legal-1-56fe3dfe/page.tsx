...
export const metadata: Metadata = {
  title: 'Smart Analyzer Platform - Legal #1',
  description: 'The future of legal is here with Smart Analyzer Platform - Legal #1. Powered by cutting-edge AI, this platform delivers market analysis like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-analyzer-platform-legal-1-56fe3dfe',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Analyzer Platform - Legal #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Smart Analyzer Platform - Legal #1. Powered by cutting-edge AI, this platform delivers market analysis like never before.
          </p>
