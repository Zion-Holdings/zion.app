...
export const metadata: Metadata = {
  title: 'Social Intelligent - Healthcare',
  description: 'Future-proof your healthcare with Social Intelligent - Healthcare. Our autonomous solution handles recommendation system end-to-end without human intervention.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/social-intelligent-healthcare-58a4d7ce',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Social Intelligent - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your healthcare with Social Intelligent - Healthcare. Our autonomous solution handles recommendation system end-to-end without human intervention.
          </p>
