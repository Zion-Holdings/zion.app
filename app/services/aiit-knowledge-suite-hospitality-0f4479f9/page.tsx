...
export const metadata: Metadata = {
  title: 'AI/IT Knowledge Suite - Hospitality',
  description: 'Optimize your hospitality workflows with AI/IT Knowledge Suite - Hospitality. This intelligent platform delivers invoice processing through advanced automation ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-knowledge-suite-hospitality-0f4479f9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Knowledge Suite - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with AI/IT Knowledge Suite - Hospitality. This intelligent platform delivers invoice processing through advanced automation and AI.
          </p>
