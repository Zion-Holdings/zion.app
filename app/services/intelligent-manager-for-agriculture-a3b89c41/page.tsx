...
export const metadata: Metadata = {
  title: 'Intelligent Manager for Agriculture',
  description: 'The future of agriculture is here with Intelligent Manager for Agriculture. Powered by cutting-edge AI, this platform delivers resource allocation like never be',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-manager-for-agriculture-a3b89c41',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Manager for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Intelligent Manager for Agriculture. Powered by cutting-edge AI, this platform delivers resource allocation like never before.
          </p>
