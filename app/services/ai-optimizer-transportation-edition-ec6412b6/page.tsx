...
export const metadata: Metadata = {
  ...
  description: 'Optimize your transportation workflows with AI Optimizer - Transportation Edition. This intelligent platform delivers budget optimization through advanced autom',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-optimizer-transportation-edition-ec6412b6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with AI Optimizer - Transportation Edition. This intelligent platform delivers budget optimization through advanced automation and AI.
          </p>
