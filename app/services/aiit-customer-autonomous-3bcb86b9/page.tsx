...
export const metadata: Metadata = {
  title: 'AI/IT Customer Autonomous',
  description: 'Next-generation finance solution: AI/IT Customer Autonomous. Combines social media monitoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-customer-autonomous-3bcb86b9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Customer Autonomous
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation finance solution: AI/IT Customer Autonomous. Combines social media monitoring with adaptive intelligence for optimal results.
          </p>
