...
export const metadata: Metadata = {
  title: 'SMB Hyper-Accelerated - TECHNOLOGY',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            SMB Hyper-Accelerated - TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for technology: SMB Hyper-Accelerated - TECHNOLOGY. Uses quantum-inspired algorithms to deliver record extraction at exponential speed.
          </p>
