...
export const metadata: Metadata = {
  title: 'Next-Gen Platform - Transportation',
  description: 'Transform your transportation operations with our Next-Gen Platform - Transportation. This AI-driven solution automates data governance with unprecedented accur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-platform-transportation-ca5995e6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Platform - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your transportation operations with our Next-Gen Platform - Transportation. This AI-driven solution automates data governance with unprecedented accuracy and efficiency.
          </p>
