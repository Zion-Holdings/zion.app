...
export const metadata: Metadata = {
  ...
  keywords: 'Auto-agenda from calendar invite, Context assembly from Slack/CRM, Decision log and action tracker, Stakeholder routing by role, Brand template for pre-reads, ai, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Meeting Pre-read Generator</h1>
        <p className="text-lg text-slate-300 mb-8">AI analyses your calendar, gathers Slack threads and CRM context, then auto-generates a structured meeting pre-read with agenda, talking points, and decision log.</p>
        ...
        <li class="text-slate-300">Auto-agenda from calendar invite</li>
        <li class="text-slate-300">Context assembly from Slack/CRM</li>
        <li class="text-slate-300">Decision log and action tracker</li>
        <li class="text-slate-300">Stakeholder routing by role</li>
        <li class="text-slate-300">Brand template for pre-reads</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai meeting pre-read generator</li>
