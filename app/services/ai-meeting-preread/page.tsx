      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            AI analyses your calendar, gathers Slack threads and CRM context, then auto-generates a structured meeting pre-read with agenda, talking points, and decision log.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Auto-agenda from calendar invite</li>
            <li className="text-purple-300">✓ Context assembly from Slack/CRM</li>
            <li className="text-purple-300">✓ Decision log and action tracker</li>
            <li className="text-purple-300">✓ Stakeholder routing by role</li>
            <li className="text-purple-300">✓ Brand template for pre-reads</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai meeting pre-read generator</li>
