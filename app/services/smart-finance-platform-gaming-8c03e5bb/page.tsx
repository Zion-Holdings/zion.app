...
export const metadata: Metadata = {
  title: 'Smart Finance Platform - Gaming',
  description: 'Next-generation gaming solution: Smart Finance Platform - Gaming. Combines sales forecasting with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-finance-platform-gaming-8c03e5bb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Finance Platform - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation gaming solution: Smart Finance Platform - Gaming. Combines sales forecasting with adaptive intelligence for optimal results.
          </p>
