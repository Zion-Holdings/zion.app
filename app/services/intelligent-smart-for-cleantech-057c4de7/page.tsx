...
export const metadata: Metadata = {
  title: 'Intelligent Smart for CLEANTECH',
  description: 'Optimize your cleantech workflows with Intelligent Smart for CLEANTECH. This intelligent platform delivers workflow management through advanced automation and A',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Smart for CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your cleantech workflows with Intelligent Smart for CLEANTECH. This intelligent platform delivers workflow management through advanced automation and AI.
          </p>
