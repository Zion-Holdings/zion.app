...
export const metadata: Metadata = {
  title: 'Intelligent Computer Vision for Energy',
  description: 'Revolutionize energy through intelligent automation. Our Intelligent Computer Vision for Energy leverages advanced machine learning to deliver document processi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-computer-vision-for-energy-d8711fc9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Computer Vision for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Intelligent Computer Vision for Energy leverages advanced machine learning to deliver document processing at scale.
          </p>
