...
export const metadata: Metadata = {
  ...
  keywords: 'AI-powered energy load forecasting and optimization, HVAC, lighting, and power system automated control, Carbon emissions tracking with ESG reporting, Peer benchmarking and efficiency gap analysis, Renewable energy integration recommendations, Real-time cost savings dashboard, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Energy Optimization &amp; Sustainability</h1>
        <p className="text-lg text-slate-300 mb-8">AI-driven energy consumption optimization for buildings, data centers, and manufacturing — reduce costs, meet ESG targets, and automate sustainability reporting.</p>
        ...
        <li class="text-slate-300">AI-powered energy load forecasting and optimization</li>
        <li class="text-slate-300">HVAC, lighting, and power system automated control</li>
        <li class="text-slate-300">Carbon emissions tracking with ESG reporting</li>
        <li class="text-slate-300">Peer benchmarking and efficiency gap analysis</li>
        <li class="text-slate-300">Renewable energy integration recommendations</li>
        <li class="text-slate-300">Real-time cost savings dashboard</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai energy optimization &amp; sustainability</li>
