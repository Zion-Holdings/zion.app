      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            AI-driven energy consumption optimization for buildings, data centers, and manufacturing — reduce costs, meet ESG targets, and automate sustainability reporting.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ AI-powered energy load forecasting and optimization</li>
            <li className="text-purple-300">✓ HVAC, lighting, and power system automated control</li>
            <li className="text-purple-300">✓ Carbon emissions tracking with ESG reporting</li>
            <li className="text-purple-300">✓ Peer benchmarking and efficiency gap analysis</li>
            <li className="text-purple-300">✓ Renewable energy integration recommendations</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai energy optimization & sustainability</li>
