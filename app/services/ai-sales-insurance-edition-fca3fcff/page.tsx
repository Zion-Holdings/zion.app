...
export const metadata: Metadata = {
  title: 'AI Sales - Insurance Edition',
  description: 'The future of insurance is here with AI Sales - Insurance Edition. Powered by cutting-edge AI, this platform delivers api management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-sales-insurance-edition-fca3fcff',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Sales - Insurance Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with AI Sales - Insurance Edition. Powered by cutting-edge AI, this platform delivers api management like never before.
          </p>
