...
export const metadata: Metadata = {
  title: 'AI Monitoring - Legal Edition',
  description: 'Transform your legal operations with our AI Monitoring - Legal Edition. This AI-driven solution automates process discovery with unprecedented accuracy and effi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-monitoring-legal-edition-51f5838a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Monitoring - Legal Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our AI Monitoring - Legal Edition. This AI-driven solution automates process discovery with unprecedented accuracy and efficiency.
          </p>
