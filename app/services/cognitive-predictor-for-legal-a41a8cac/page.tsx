...
export const metadata: Metadata = {
  title: 'Cognitive Predictor for Legal',
  description: 'Revolutionize legal through intelligent automation. Our Cognitive Predictor for Legal leverages advanced machine learning to deliver security monitoring at scal',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Predictor for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Cognitive Predictor for Legal leverages advanced machine learning to deliver security monitoring at scale.
          </p>
