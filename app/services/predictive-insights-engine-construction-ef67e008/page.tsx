...
export const metadata: Metadata = {
  title: 'Predictive Insights Engine - Construction',
  description: 'Next-generation construction solution: Predictive Insights Engine - Construction. Combines expense management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-insights-engine-construction-ef67e008',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Insights Engine - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Predictive Insights Engine - Construction. Combines expense management with adaptive intelligence for optimal results.
          </p>
