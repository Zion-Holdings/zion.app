...
export const metadata: Metadata = {
  title: 'Intelligent Survey Experience',
  description: 'The future of manufacturing is here with Intelligent Survey Experience. Powered by cutting-edge AI, this platform delivers project portfolio like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-survey-experience-fd0bdfdb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Survey Experience
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of manufacturing is here with Intelligent Survey Experience. Powered by cutting-edge AI, this platform delivers project portfolio like never before.
          </p>
