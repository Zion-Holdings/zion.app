...
export const metadata: Metadata = {
  title: 'Quantum Sales - HEALTHTECH Quantum',
  description: 'Enhance your healthtech business with Quantum Sales - HEALTHTECH Quantum. Our solution provides personalization engine with enterprise-grade reliability and sec',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-sales-healthtech-quantum-4da009aa',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Sales - HEALTHTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthtech business with Quantum Sales - HEALTHTECH Quantum. Our solution provides personalization engine with enterprise-grade reliability and security.
          </p>
