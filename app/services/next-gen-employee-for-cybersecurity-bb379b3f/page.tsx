...
export const metadata: Metadata = {
  title: 'Next-Gen Employee for Cybersecurity',
  description: 'The future of cybersecurity is here with Next-Gen Employee for Cybersecurity. Powered by cutting-edge AI, this platform delivers content generation like never b',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-employee-for-cybersecurity-bb379b3f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Employee for Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of cybersecurity is here with Next-Gen Employee for Cybersecurity. Powered by cutting-edge AI, this platform delivers content generation like never before.
          </p>
