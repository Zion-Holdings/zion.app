...
export const metadata: Metadata = {
  title: 'Intelligent Autonomous for Agriculture',
  description: 'Optimize your agriculture workflows with Intelligent Autonomous for Agriculture. This intelligent platform delivers document processing through advanced automat',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-autonomous-for-agriculture-89a32022',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Autonomous for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your agriculture workflows with Intelligent Autonomous for Agriculture. This intelligent platform delivers document processing through advanced automation and AI.
          </p>
