...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Processor - Hospitality',
  description: 'Enhance your hospitality business with Hyper-Accelerated Processor - Hospitality. Our solution provides warehouse automation with enterprise-grade reliability a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Processor - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Hyper-Accelerated Processor - Hospitality. Our solution provides warehouse automation with enterprise-grade reliability and security.
          </p>
