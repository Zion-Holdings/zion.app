...
export const metadata: Metadata = {
  title: 'Automated Engine for Finance',
  description: 'The future of finance is here with Automated Engine for Finance. Powered by cutting-edge AI, this platform delivers image recognition like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-engine-for-finance-982afdf0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Engine for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of finance is here with Automated Engine for Finance. Powered by cutting-edge AI, this platform delivers image recognition like never before.
          </p>
