...
export const metadata: Metadata = {
  title: 'Intelligent coordinator-iot',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent coordinator-iot
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize iot through intelligent automation. Our Intelligent coordinator-iot leverages advanced machine learning to deliver workflow management at scale.
          </p>
