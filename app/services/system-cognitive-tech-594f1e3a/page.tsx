...
export const metadata: Metadata = {
  title: 'System Cognitive - Tech',
  description: 'Enhance your technology business with System Cognitive - Tech. Our solution provides data quality with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/system-cognitive-tech-594f1e3a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            System Cognitive - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your technology business with System Cognitive - Tech. Our solution provides data quality with enterprise-grade reliability and security.
          </p>
