...
export const metadata: Metadata = {
  title: 'Autonomous Strategic System - Sports',
  description: 'Transform your sports operations with our Autonomous Strategic System - Sports. This AI-driven solution automates record processing with unprecedented accuracy ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-strategic-system-sports-1ba602b9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Strategic System - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our Autonomous Strategic System - Sports. This AI-driven solution automates record processing with unprecedented accuracy and efficiency.
          </p>
