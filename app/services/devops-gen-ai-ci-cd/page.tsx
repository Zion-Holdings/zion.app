...
export const metadata: Metadata = {
  ...
  keywords: 'Natural language to pipeline generation, IaC template creation (Terraform, CloudFormation), Automated incident runbook drafting, Self-healing deployment rollbacks, Performance anomaly detection & tuning, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Generative AI for DevOps &amp; CI/CD</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered DevOps: auto-generate CI/CD pipelines, infrastructure-as-code, deployment scripts, and incident runbooks from natural language specifications.</p>
        ...
        <li class="text-slate-300">Natural language to pipeline generation</li>
        <li class="text-slate-300">IaC template creation (Terraform, CloudFormation)</li>
        <li class="text-slate-300">Automated incident runbook drafting</li>
        <li class="text-slate-300">Self-healing deployment rollbacks</li>
        <li class="text-slate-300">Performance anomaly detection &amp; tuning</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with generative ai for devops &amp; ci/cd</li>
