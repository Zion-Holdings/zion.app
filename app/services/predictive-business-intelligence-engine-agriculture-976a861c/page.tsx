...
export const metadata: Metadata = {
  ...
  description: 'The future of agriculture is here with Predictive Business Intelligence Engine - Agriculture. Powered by cutting-edge AI, this platform delivers scalability pla',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Predictive Business Intelligence Engine - Agriculture. Powered by cutting-edge AI, this platform delivers scalability planning like never before.
          </p>
