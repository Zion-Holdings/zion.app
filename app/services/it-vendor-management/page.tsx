...
export const metadata: Metadata = {
  ...
  keywords: 'Vendor assessment and scorecarding, Contract negotiation support, SLA monitoring and enforcement, Spend analysis and optimization, Renewal management and benchmarking, Risk assessment for critical vendors, it, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Vendor Management &amp; Procurement Service</h1>
        <p className="text-lg text-slate-300 mb-8">Streamline IT vendor management with vendor assessment, contract negotiation, SLA monitoring, and renewal management. Reduce vendor costs by 15-25% while improving service quality.</p>
        ...
        <li class="text-slate-300">Vendor assessment and scorecarding</li>
        <li class="text-slate-300">Contract negotiation support</li>
        <li class="text-slate-300">SLA monitoring and enforcement</li>
        <li class="text-slate-300">Spend analysis and optimization</li>
        <li class="text-slate-300">Renewal management and benchmarking</li>
        <li class="text-slate-300">Risk assessment for critical vendors</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce IT vendor costs by 15-25%</li>
        <li class="text-slate-300">Ensure SLA compliance with automated monitoring</li>
        <li class="text-slate-300">Avoid auto-renewal traps</li>
        <li class="text-slate-300">Data-driven vendor decisions</li>
      </ul>
        </div>
