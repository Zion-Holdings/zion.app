...
export const metadata: Metadata = {
  title: 'AI-Powered knowledge-insurance',
  description: 'The future of insurance is here with AI-Powered knowledge-insurance. Powered by cutting-edge AI, this platform delivers reputation management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-knowledge-insurance-0099f78f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered knowledge-insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with AI-Powered knowledge-insurance. Powered by cutting-edge AI, this platform delivers reputation management like never before.
          </p>
