...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize automotive through intelligent automation. Our Cognitive Customer Service Solution - Automotive leverages advanced machine learning to deliver cus',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize automotive through intelligent automation. Our Cognitive Customer Service Solution - Automotive leverages advanced machine learning to deliver customer insights at scale.
          </p>
