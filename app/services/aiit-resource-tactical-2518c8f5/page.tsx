...
export const metadata: Metadata = {
  title: 'AI/IT Resource Tactical',
  description: 'Transform your edtech operations with our AI/IT Resource Tactical. This AI-driven solution automates testing automation with unprecedented accuracy and efficien',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Resource Tactical
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your edtech operations with our AI/IT Resource Tactical. This AI-driven solution automates testing automation with unprecedented accuracy and efficiency.
          </p>
