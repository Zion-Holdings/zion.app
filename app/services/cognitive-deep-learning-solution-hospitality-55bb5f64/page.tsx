...
export const metadata: Metadata = {
  title: 'Cognitive Deep Learning Solution - Hospitality',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Deep Learning Solution - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Cognitive Deep Learning Solution - Hospitality. Combines supply chain with adaptive intelligence for optimal results.
          </p>
