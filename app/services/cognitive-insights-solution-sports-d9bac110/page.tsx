...
export const metadata: Metadata = {
  title: 'Cognitive Insights Solution - Sports',
  description: 'Revolutionize sports through intelligent automation. Our Cognitive Insights Solution - Sports leverages advanced machine learning to deliver inventory managemen',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Insights Solution - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Cognitive Insights Solution - Sports leverages advanced machine learning to deliver inventory management at scale.
          </p>
