...
export const metadata: Metadata = {
  title: 'Intelligent orchestrator-automotive',
  description: 'Revolutionize automotive through intelligent automation. Our Intelligent orchestrator-automotive leverages advanced machine learning to deliver threat detection',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent orchestrator-automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize automotive through intelligent automation. Our Intelligent orchestrator-automotive leverages advanced machine learning to deliver threat detection at scale.
          </p>
