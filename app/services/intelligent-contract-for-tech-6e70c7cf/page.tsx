...
export const metadata: Metadata = {
  title: 'Intelligent Contract for Tech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Contract for Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your technology with Intelligent Contract for Tech. Our autonomous solution handles resource allocation end-to-end without human intervention.
          </p>
