...
export const metadata: Metadata = {
  title: 'Sales Engagement AI-Powered Content Generation Platform',
  description: 'AI-powered sales engagement solution for marketing. Generates high-quality, SEO-optimized content at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/sales-engagement-ai-powered-content-generation-platform-19abba18',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Sales Engagement AI-Powered Content Generation Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered sales engagement solution for marketing. Generates high-quality, SEO-optimized content at scale.
          </p>
