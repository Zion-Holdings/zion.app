...
export const metadata: Metadata = {
  title: 'Autonomous Analytics System - Healthcare',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Analytics System - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Autonomous Analytics System - Healthcare leverages advanced machine learning to deliver incident response at scale.
          </p>
