...
export const metadata: Metadata = {
  title: 'Intelligent Automated - Automotive',
  description: 'The future of automotive is here with Intelligent Automated - Automotive. Powered by cutting-edge AI, this platform delivers master data management like never b',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Automated - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of automotive is here with Intelligent Automated - Automotive. Powered by cutting-edge AI, this platform delivers master data management like never before.
          </p>
