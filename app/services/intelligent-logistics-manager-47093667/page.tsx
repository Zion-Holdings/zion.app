...
export const metadata: Metadata = {
  title: 'Intelligent Logistics Manager',
  description: 'Next-generation healthcare solution: Intelligent Logistics Manager. Combines resource optimization with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-logistics-manager-47093667',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Logistics Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Intelligent Logistics Manager. Combines resource optimization with adaptive intelligence for optimal results.
          </p>
