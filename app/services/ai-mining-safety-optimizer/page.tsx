...
export const metadata: Metadata = {
  ...
  keywords: 'Equipment health prediction, Ventilation air quality optimization, Worker PPE compliance detection, Ore grade prediction from images, Slope stability analysis, Autonomous vehicle coordination, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Mining Safety &amp; Operations Optimizer</h1>
        <p className="text-lg text-slate-300 mb-8">Computer vision + IoT for mining: equipment health monitoring, ventilation optimization, worker safety enforcement, and ore grade prediction. Reduces accidents by 50%.</p>
        ...
        <li class="text-slate-300">Equipment health prediction</li>
        <li class="text-slate-300">Ventilation air quality optimization</li>
        <li class="text-slate-300">Worker PPE compliance detection</li>
        <li class="text-slate-300">Ore grade prediction from images</li>
        <li class="text-slate-300">Slope stability analysis</li>
        <li class="text-slate-300">Autonomous vehicle coordination</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce accidents by 50%</li>
        <li class="text-slate-300">Optimize ore extraction</li>
        <li class="text-slate-300">Ensure safety compliance</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">4999</p>
