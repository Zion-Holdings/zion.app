...
export const metadata: Metadata = {
  title: 'Quantum Process Mining - Finance Quantum',
  description: 'The future of finance is here with Quantum Process Mining - Finance Quantum. Powered by cutting-edge AI, this platform delivers expense management like never be',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Process Mining - Finance Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of finance is here with Quantum Process Mining - Finance Quantum. Powered by cutting-edge AI, this platform delivers expense management like never before.
          </p>
