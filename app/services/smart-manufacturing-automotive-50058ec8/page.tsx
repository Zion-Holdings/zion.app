...
export const metadata: Metadata = {
  title: 'Smart manufacturing-automotive',
  description: 'Transform your automotive operations with our Smart manufacturing-automotive. This AI-driven solution automates content moderation with unprecedented accuracy a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your automotive operations with our Smart manufacturing-automotive. This AI-driven solution automates content moderation with unprecedented accuracy and efficiency.
          </p>
