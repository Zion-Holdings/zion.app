export const metadata = {
  title: "AI-Powered Intelligent IoT Intelligence",
  description: "Zion Tech Group delivers AI-Powered Intelligent IoT Intelligence with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/services/ai-powered-intelligent-iot-intelligence-b8f2fbb6/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>AI-Powered Intelligent IoT Intelligence</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers AI-Powered Intelligent IoT Intelligence with measurable outcomes.
      </p>
