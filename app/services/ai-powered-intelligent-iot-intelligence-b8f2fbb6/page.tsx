...
export const metadata: Metadata = {
  ...
  keywords: 'Edge processing, Real-time analytics, Automated control, Device management, iot, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Powered Intelligent IoT Intelligence</h1>
        <p className="text-lg text-slate-300 mb-8">Edge AI platform that processes IoT sensor data in real-time, providing intelligent insights and automated control for smart devices and industrial systems.</p>
        ...
        <li class="text-slate-300">Automated control</li>
        <li class="text-slate-300">Device management</li>
      </ul>
        </div>
