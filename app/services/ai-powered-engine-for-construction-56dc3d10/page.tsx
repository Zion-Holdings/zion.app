...
export const metadata: Metadata = {
  title: 'AI-Powered Engine for Construction',
  description: 'Revolutionize construction through intelligent automation. Our AI-Powered Engine for Construction leverages advanced machine learning to deliver process automat',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-engine-for-construction-56dc3d10',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Engine for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our AI-Powered Engine for Construction leverages advanced machine learning to deliver process automation at scale.
          </p>
