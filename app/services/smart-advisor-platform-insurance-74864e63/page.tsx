...
export const metadata: Metadata = {
  title: 'Smart Advisor Platform - Insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Advisor Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Smart Advisor Platform - Insurance. This AI-powered platform transforms hr analytics into a competitive advantage.
          </p>
