...
export const metadata: Metadata = {
  title: 'AI/IT Engine Suite - MARTECH',
  description: 'The future of martech is here with AI/IT Engine Suite - MARTECH. Powered by cutting-edge AI, this platform delivers threat detection like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-engine-suite-martech-880d39ee',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Engine Suite - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of martech is here with AI/IT Engine Suite - MARTECH. Powered by cutting-edge AI, this platform delivers threat detection like never before.
          </p>
