...
export const metadata: Metadata = {
  title: 'Next-Gen Experience for Cybersecurity',
  description: 'The future of cybersecurity is here with Next-Gen Experience for Cybersecurity. Powered by cutting-edge AI, this platform delivers lakehouse architecture like n',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-experience-for-cybersecurity-a19a4b92',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Experience for Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of cybersecurity is here with Next-Gen Experience for Cybersecurity. Powered by cutting-edge AI, this platform delivers lakehouse architecture like never before.
          </p>
