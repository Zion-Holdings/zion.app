...
export const metadata: Metadata = {
  title: 'Next-Gen AI for Healthcare',
  description: 'The future of healthcare is here with Next-Gen AI for Healthcare. Powered by cutting-edge AI, this platform delivers healthcare data analytics like never before',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-ai-for-healthcare-f1e2cd02',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen AI for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Next-Gen AI for Healthcare. Powered by cutting-edge AI, this platform delivers healthcare data analytics like never before.
          </p>
