...
export const metadata: Metadata = {
  title: 'Cognitive Manager Solution - Telecom',
  description: 'Transform your telecom operations with our Cognitive Manager Solution - Telecom. This AI-driven solution automates document processing with unprecedented accura',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-manager-solution-telecom-64432881',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Manager Solution - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your telecom operations with our Cognitive Manager Solution - Telecom. This AI-driven solution automates document processing with unprecedented accuracy and efficiency.
          </p>
