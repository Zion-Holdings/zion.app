...
export const metadata: Metadata = {
  ...
  keywords: 'Intelligent scheduling and dispatch, Mobile work orders and checklists, Parts and inventory management, Customer communication and ETA, Technician tracking and route optimization, Integration with ServiceMax, Salesforce Field Service, automation, Field Service, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Field Service Management</h1>
        <p className="text-lg text-slate-300 mb-8">Manage field service: scheduling, dispatch, mobile work orders, customer communication. Optimize technician utilization.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">automation</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">Field Service</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Intelligent scheduling and dispatch</li>
        <li class="text-slate-300">Mobile work orders and checklists</li>
        <li class="text-slate-300">Parts and inventory management</li>
        <li class="text-slate-300">Customer communication and ETA</li>
        <li class="text-slate-300">Technician tracking and route optimization</li>
        <li class="text-slate-300">Integration with ServiceMax</li>
        <li class="text-slate-300">Salesforce Field Service</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Optimize technician utilization</li>
        <li class="text-slate-300">Mobile work orders eliminate paper</li>
        <li class="text-slate-300">Customer ETA improves satisfaction</li>
        <li class="text-slate-300">Route optimization reduces drive time</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$49/tech/mo</p>
              <p class="text-sm text-slate-400">Getting started plan</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              <h3 class="font-semibold text-white mb-2">Pro</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">$99/tech/mo</p>
              <p class="text-sm text-slate-400">Most popular</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              <h3 class="font-semibold text-white mb-2">Enterprise</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">$199/tech/mo</p>
