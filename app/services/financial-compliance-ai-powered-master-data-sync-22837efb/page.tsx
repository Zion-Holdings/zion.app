...
export const metadata: Metadata = {
  title: 'Financial Compliance AI-Powered Master Data Sync',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Financial Compliance AI-Powered Master Data Sync
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered financial compliance solution for integration. Automated master data synchronization across systems.
          </p>
