...
export const metadata: Metadata = {
  title: "Accounting AI-Powered Metaverse Experience Engine - AI-Powered Accounting Solution",
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Accounting AI-Powered Metaverse Experience Engine - AI-Powered Accounting Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          AI-powered accounting solution for gaming. Creates immersive metaverse experiences with AI-generated content and virtual avatars.
        </p>
