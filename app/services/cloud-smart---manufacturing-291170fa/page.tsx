...
export const metadata: Metadata = {
  title: 'Cloud Smart - Manufacturing',
  description: 'Transform your manufacturing operations with our Cloud Smart - Manufacturing. This AI-driven solution automates workflow management with unprecedented accuracy ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your manufacturing operations with our Cloud Smart - Manufacturing. This AI-driven solution automates workflow management with unprecedented accuracy and efficiency.
          </p>
