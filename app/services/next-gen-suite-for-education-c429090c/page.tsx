...
export const metadata: Metadata = {
  title: 'Next-Gen Suite for Education',
  description: 'Hyper-accelerated education solution: Next-Gen Suite for Education. Combines succession planning with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-suite-for-education-c429090c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Suite for Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated education solution: Next-Gen Suite for Education. Combines succession planning with next-gen AI for maximum velocity.
          </p>
