...
export const metadata: Metadata = {
  title: 'Risk Neural - Manufacturing',
  description: 'Revolutionize manufacturing through intelligent automation. Our Risk Neural - Manufacturing leverages advanced machine learning to deliver access management at ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Risk Neural - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize manufacturing through intelligent automation. Our Risk Neural - Manufacturing leverages advanced machine learning to deliver access management at scale.
          </p>
