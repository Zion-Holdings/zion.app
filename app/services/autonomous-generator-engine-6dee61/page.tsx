...
export const metadata: Metadata = {
  title: 'Autonomous Generator Engine',
  description: 'Transform your healthcare operations with our Autonomous Generator Engine. This cloud solution delivers unprecedented automation and intelligence.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Autonomous Generator Engine. This cloud solution delivers unprecedented automation and intelligence.
          </p>
