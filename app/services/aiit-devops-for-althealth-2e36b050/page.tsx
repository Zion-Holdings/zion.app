...
export const metadata: Metadata = {
  title: 'AI/IT DevOps for ALTHEALTH',
  description: 'Drive innovation in althealth with AI/IT DevOps for ALTHEALTH. This AI-powered platform transforms payroll processing into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-devops-for-althealth-2e36b050',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT DevOps for ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in althealth with AI/IT DevOps for ALTHEALTH. This AI-powered platform transforms payroll processing into a competitive advantage.
          </p>
