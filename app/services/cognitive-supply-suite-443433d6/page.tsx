...
export const metadata: Metadata = {
  title: 'Cognitive Supply Suite',
  description: 'Revolutionize education through intelligent automation. Our Cognitive Supply Suite leverages advanced machine learning to deliver document processing at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-supply-suite-443433d6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Supply Suite
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize education through intelligent automation. Our Cognitive Supply Suite leverages advanced machine learning to deliver document processing at scale.
          </p>
