...
export const metadata: Metadata = {
  title: 'Intelligent Process Finance',
  description: 'Transform your quantum operations with our Intelligent Process Finance. This AI-driven solution automates financial planning with unprecedented accuracy and eff',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Process Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your quantum operations with our Intelligent Process Finance. This AI-driven solution automates financial planning with unprecedented accuracy and efficiency.
          </p>
