...
export const metadata: Metadata = {
  title: 'Intelligent Cloud for Automotive',
  description: 'The future of automotive is here with Intelligent Cloud for Automotive. Powered by cutting-edge AI, this platform delivers network optimization like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-cloud-for-automotive-a4408164',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Cloud for Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of automotive is here with Intelligent Cloud for Automotive. Powered by cutting-edge AI, this platform delivers network optimization like never before.
          </p>
