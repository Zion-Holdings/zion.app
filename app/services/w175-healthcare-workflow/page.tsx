...
export const metadata: Metadata = {
  ...
  keywords: 'Prior authorization automation, Claims submission and status tracking, Clinical documentation improvement (CDI), Patient communication (appointment, reminder, portal), Care coordination and referral management, Regulatory compliance (HIPAA, HITECH), Integration with Epic, Cerner, Meditech, Athena, automation, Healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Healthcare Workflow Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Healthcare process automation: prior authorization, claims, clinical documentation, patient communication, and care coordination. HIPAA-compliant.</p>
        ...
        <li class="text-slate-300">Prior authorization automation</li>
        <li class="text-slate-300">Claims submission and status tracking</li>
        <li class="text-slate-300">Clinical documentation improvement (CDI)</li>
        <li class="text-slate-300">Patient communication (appointment, reminder, portal)</li>
        <li class="text-slate-300">Care coordination and referral management</li>
        <li class="text-slate-300">Regulatory compliance (HIPAA, HITECH)</li>
        <li class="text-slate-300">Integration with Epic, Cerner, Meditech, Athena</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce prior auth turnaround by 80%</li>
        <li class="text-slate-300">CDI improves documentation accuracy and revenue</li>
        <li class="text-slate-300">Patient communication reduces no-shows</li>
        <li class="text-slate-300">Care coordination improves outcomes</li>
      </ul>
        </div>
