...
export const metadata: Metadata = {
  title: 'Intelligent Quality for HEALTHTECH',
  description: 'Revolutionize healthtech through intelligent automation. Our Intelligent Quality for HEALTHTECH leverages advanced machine learning to deliver financial plannin',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-quality-for-healthtech-1359c226',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Quality for HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthtech through intelligent automation. Our Intelligent Quality for HEALTHTECH leverages advanced machine learning to deliver financial planning at scale.
          </p>
