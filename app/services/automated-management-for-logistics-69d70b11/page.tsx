...
export const metadata: Metadata = {
  title: 'Automated Management for Logistics',
  description: 'Transform your logistics operations with our Automated Management for Logistics. This AI-driven solution automates manufacturing quality control with unpreceden',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-management-for-logistics-69d70b11',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Management for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Automated Management for Logistics. This AI-driven solution automates manufacturing quality control with unprecedented accuracy and efficiency.
          </p>
