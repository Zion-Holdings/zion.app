...
export const metadata: Metadata = {
  title: 'Intelligent Predictive for ALTHEALTH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Predictive for ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation althealth solution: Intelligent Predictive for ALTHEALTH. Combines incident response with adaptive intelligence for optimal results.
          </p>
