...
export const metadata = {
  ...
  description: "AI-powered workforce analytics: attrition prediction, performance forecasting, diversity analysis, and workforce planning. Make HR decisions with data, not intu",
  alternates: {
