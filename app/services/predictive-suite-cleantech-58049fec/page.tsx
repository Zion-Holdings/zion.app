...
export const metadata: Metadata = {
  title: 'Predictive suite-cleantech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive suite-cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Predictive suite-cleantech. This autonomous system provides predictive analytics with zero manual intervention needed.
          </p>
