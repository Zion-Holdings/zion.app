...
export const metadata: Metadata = {
  title: 'AI-Powered Support for Telecom',
  description: 'Revolutionize telecom through intelligent automation. Our AI-Powered Support for Telecom leverages advanced machine learning to deliver risk assessment at scale',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-support-for-telecom-f6c184b8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Support for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our AI-Powered Support for Telecom leverages advanced machine learning to deliver risk assessment at scale.
          </p>
