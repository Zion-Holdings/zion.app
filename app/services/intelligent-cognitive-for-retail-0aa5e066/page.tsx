export const metadata = {
  title: "Intelligent Cognitive for Retail",
  description: "Zion Tech Group delivers Intelligent Cognitive for Retail with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/services/intelligent-cognitive-for-retail-0aa5e066/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>Intelligent Cognitive for Retail</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers Intelligent Cognitive for Retail with measurable outcomes.
      </p>
