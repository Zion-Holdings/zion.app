...
export const metadata: Metadata = {
  title: 'Intelligent Performance Platform',
  description: 'Revolutionize insurance through intelligent automation. Our Intelligent Performance Platform leverages advanced machine learning to deliver scenario planning at',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-performance-platform-f9d321e0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Performance Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Intelligent Performance Platform leverages advanced machine learning to deliver scenario planning at scale.
          </p>
