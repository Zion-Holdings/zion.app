...
export const metadata: Metadata = {
  title: 'Intelligent Director for ALTHEALTH',
  description: 'Revolutionize althealth through intelligent automation. Our Intelligent Director for ALTHEALTH leverages advanced machine learning to deliver recruitment automa',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-director-for-althealth-d2f31196',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Director for ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize althealth through intelligent automation. Our Intelligent Director for ALTHEALTH leverages advanced machine learning to deliver recruitment automation at scale.
          </p>
