...
export const metadata: Metadata = {
  title: 'AI Smart - Construction Edition #1',
  description: 'Revolutionize construction through intelligent automation. Our AI Smart - Construction Edition #1 leverages advanced machine learning to deliver access manageme',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-smart-construction-edition-1-68a03bb1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Smart - Construction Edition #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our AI Smart - Construction Edition #1 leverages advanced machine learning to deliver access management at scale.
          </p>
