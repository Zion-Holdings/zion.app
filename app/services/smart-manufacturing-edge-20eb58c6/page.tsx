...
export const metadata: Metadata = {
  title: 'Smart manufacturing-edge',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation edge solution: Smart manufacturing-edge. Combines performance monitoring with adaptive intelligence for optimal results.
          </p>
