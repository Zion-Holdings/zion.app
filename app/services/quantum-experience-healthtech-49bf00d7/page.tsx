...
export const metadata: Metadata = {
  title: 'Quantum experience-healthtech',
  description: 'Enhance your healthtech business with Quantum experience-healthtech. Our solution provides customer journey mapping with enterprise-grade reliability and securi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-experience-healthtech-49bf00d7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum experience-healthtech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthtech business with Quantum experience-healthtech. Our solution provides customer journey mapping with enterprise-grade reliability and security.
          </p>
