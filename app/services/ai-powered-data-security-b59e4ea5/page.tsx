...
export const metadata: Metadata = {
  title: "AI-Powered Data Security - AI-Powered Security Solution",
  description: "Automated data access control and encryption management.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-data-security-b59e4ea5",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Data Security - AI-Powered Security Solution
        </h1>
