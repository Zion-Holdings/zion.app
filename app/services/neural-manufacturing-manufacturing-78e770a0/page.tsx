...
export const metadata: Metadata = {
  ...
  description: 'The future of manufacturing is here with Neural manufacturing-manufacturing. Powered by cutting-edge AI, this platform delivers performance monitoring like neve',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-manufacturing-manufacturing-78e770a0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of manufacturing is here with Neural manufacturing-manufacturing. Powered by cutting-edge AI, this platform delivers performance monitoring like never before.
          </p>
