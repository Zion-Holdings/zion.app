...
export const metadata: Metadata = {
  title: 'AI/IT Monitoring Suite - Retail',
  description: 'Enhance your retail business with AI/IT Monitoring Suite - Retail. Our solution provides onboarding automation with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-monitoring-suite-retail-c2fc32b9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Monitoring Suite - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your retail business with AI/IT Monitoring Suite - Retail. Our solution provides onboarding automation with enterprise-grade reliability and security.
          </p>
