...
export const metadata: Metadata = {
  title: "Academic Planning AI-Powered Content Generation Platform - AI-Powered Academic Planning Solution",
  description: "AI-powered academic planning solution for marketing. Generates high-quality, SEO-optimized content at scale.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/academic-planning-ai-powered-content-generation-platform-1eaf6215",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Academic Planning AI-Powered Content Generation Platform - AI-Powered Academic Planning Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          AI-powered academic planning solution for marketing. Generates high-quality, SEO-optimized content at scale.
        </p>
