...
export const metadata: Metadata = {
  ...
  keywords: 'Secure data destruction (NIST 800-88), Environmental compliance (R2, e-Stewards), Asset recovery and resale, Chain of custody documentation, Certificate of destruction, On-site and off-site destruction options, Integration with asset management systems, it, IT Operations, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Asset Disposal and Recycling</h1>
        <p className="text-lg text-slate-300 mb-8">Secure IT asset disposal: data destruction, environmental compliance, asset recovery. Certified and auditable.</p>
        ...
        <li class="text-slate-300">Secure data destruction (NIST 800-88)</li>
        <li class="text-slate-300">Environmental compliance (R2</li>
        <li class="text-slate-300">e-Stewards)</li>
        <li class="text-slate-300">Asset recovery and resale</li>
        <li class="text-slate-300">Chain of custody documentation</li>
        <li class="text-slate-300">Certificate of destruction</li>
        <li class="text-slate-300">On-site and off-site destruction options</li>
        <li class="text-slate-300">Integration with asset management systems</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Certified data destruction for compliance</li>
        <li class="text-slate-300">Environmental compliance prevents fines</li>
        <li class="text-slate-300">Asset recovery returns value</li>
        <li class="text-slate-300">Chain of custody for audit</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$99/asset</p>
              <p class="text-sm text-slate-400">Getting started plan</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              <h3 class="font-semibold text-white mb-2">Pro</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">$199/asset</p>
