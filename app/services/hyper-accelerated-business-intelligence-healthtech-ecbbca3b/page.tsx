...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Business Intelligence - HEALTHTECH',
  description: 'Drive innovation in healthtech with Hyper-Accelerated Business Intelligence - HEALTHTECH. This AI-powered platform transforms fleet management into a competitiv',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/hyper-accelerated-business-intelligence-healthtech-ecbbca3b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Business Intelligence - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthtech with Hyper-Accelerated Business Intelligence - HEALTHTECH. This AI-powered platform transforms fleet management into a competitive advantage.
          </p>
