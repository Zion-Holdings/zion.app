...
export const metadata: Metadata = {
  ...
  keywords: 'Strangler fig incremental migration plan, Gradual bounded-context extraction per sprint, Dual-run production validation + canary, Feature-flag cutover per module, Anti-corruption layer per legacy interface, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Legacy App Refactoring &amp; Strangler Fig</h1>
        <p className="text-lg text-slate-300 mb-8">Strangler fig: reverse-engineer monolith deps, incrementally migrate bounded contexts to modern services with feature-flags, dual-run validation, rollback at every step.</p>
        ...
        <li class="text-slate-300">Strangler fig incremental migration plan</li>
        <li class="text-slate-300">Gradual bounded-context extraction per sprint</li>
        <li class="text-slate-300">Dual-run production validation + canary</li>
        <li class="text-slate-300">Feature-flag cutover per module</li>
        <li class="text-slate-300">Anti-corruption layer per legacy interface</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with legacy app refactoring &amp; strangler fig</li>
