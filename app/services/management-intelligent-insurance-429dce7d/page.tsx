...
export const metadata: Metadata = {
  title: 'Management Intelligent - Insurance',
  description: 'Enhance your insurance business with Management Intelligent - Insurance. Our solution provides document processing with enterprise-grade reliability and securit',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/management-intelligent-insurance-429dce7d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Management Intelligent - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Management Intelligent - Insurance. Our solution provides document processing with enterprise-grade reliability and security.
          </p>
