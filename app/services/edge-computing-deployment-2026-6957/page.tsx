...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={@context: "https://schema.org", @type: "Service", name: "Edge Computing Deployment | Zion Tech Group", description: "End-to-end edge computing deployment services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/edge-computing-deployment-2026-6957/"} />
