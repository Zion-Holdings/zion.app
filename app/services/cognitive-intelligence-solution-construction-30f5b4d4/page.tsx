...
export const metadata: Metadata = {
  title: 'Cognitive Intelligence Solution - Construction',
  description: 'Optimize your construction workflows with Cognitive Intelligence Solution - Construction. This intelligent platform delivers manufacturing quality control throu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-intelligence-solution-construction-30f5b4d4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Intelligence Solution - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Cognitive Intelligence Solution - Construction. This intelligent platform delivers manufacturing quality control through advanced automation and AI.
          </p>
