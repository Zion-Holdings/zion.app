...
export const metadata: Metadata = {
  ...
  keywords: '200+ log source connectors, Log parsing and normalisation, Correlation rule engine, Alert deduplication and enrichment, Forensic timeline with drill-down, security, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Security Log Orchestration &amp; Correlation</h1>
        <p className="text-lg text-slate-300 mb-8">Ingest logs from 200+ sources, normalise at scale, and run correlation rules across the full attack chain. Reduces alert fatigue with context-enriched triage views.</p>
        ...
        <li class="text-slate-300">200+ log source connectors</li>
        <li class="text-slate-300">Log parsing and normalisation</li>
        <li class="text-slate-300">Correlation rule engine</li>
        <li class="text-slate-300">Alert deduplication and enrichment</li>
        <li class="text-slate-300">Forensic timeline with drill-down</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with security log orchestration &amp; correlation</li>
