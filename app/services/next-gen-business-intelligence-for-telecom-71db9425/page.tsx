...
export const metadata: Metadata = {
  title: 'Next-Gen Business Intelligence for Telecom',
  description: 'Enhance your telecom business with Next-Gen Business Intelligence for Telecom. Our solution provides anomaly detection with enterprise-grade reliability and sec',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Business Intelligence for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your telecom business with Next-Gen Business Intelligence for Telecom. Our solution provides anomaly detection with enterprise-grade reliability and security.
          </p>
