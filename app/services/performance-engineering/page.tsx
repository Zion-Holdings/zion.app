...
export const metadata: Metadata = {
  ...
  keywords: 'Synthetic browser + API monitoring (Playwright), Continuous load testing in CI pipeline, Flame-graph regression gate per PR, Production profiling (pyroscope/parca), Quarterly performance roadmap per architecture, it, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Performance Engineering as a Service</h1>
        <p className="text-lg text-slate-300 mb-8">Proactive performance: synthetic monitoring (Playwright), load testing (k6/Gatling), flame-graph CI gate, production profiling, quarterly roadmap review.</p>
        ...
        <li class="text-slate-300">Synthetic browser + API monitoring (Playwright)</li>
        <li class="text-slate-300">Continuous load testing in CI pipeline</li>
        <li class="text-slate-300">Flame-graph regression gate per PR</li>
        <li class="text-slate-300">Production profiling (pyroscope/parca)</li>
        <li class="text-slate-300">Quarterly performance roadmap per architecture</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with performance engineering as a service</li>
