...
export const metadata: Metadata = {
  title: 'Cognitive Security Solution - Education',
  description: 'Drive innovation in education with Cognitive Security Solution - Education. This AI-powered platform transforms customer service automation into a competitive a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-security-solution-education-a3bb12a3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Security Solution - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in education with Cognitive Security Solution - Education. This AI-powered platform transforms customer service automation into a competitive advantage.
          </p>
