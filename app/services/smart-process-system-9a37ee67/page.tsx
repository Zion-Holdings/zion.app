...
export const metadata: Metadata = {
  title: 'Smart Process System',
  description: 'Transform your education operations with our Smart Process System. This AI-driven solution automates market intelligence with unprecedented accuracy and efficie',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-process-system-9a37ee67',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your education operations with our Smart Process System. This AI-driven solution automates market intelligence with unprecedented accuracy and efficiency.
          </p>
