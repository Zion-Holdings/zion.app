...
export const metadata: Metadata = {
  title: 'Cognitive Advisor Solution - Automotive',
  description: 'Future-proof your automotive with Cognitive Advisor Solution - Automotive. Our autonomous solution handles language processing end-to-end without human interven',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Advisor Solution - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your automotive with Cognitive Advisor Solution - Automotive. Our autonomous solution handles language processing end-to-end without human intervention.
          </p>
