...
export const metadata: Metadata = {
  title: 'AI Analyzer - Cleantech Edition',
  description: 'Transform your cleantech operations with our AI Analyzer - Cleantech Edition. This AI-driven solution automates document processing with unprecedented accuracy ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-analyzer---cleantech-edition-94402a19',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Analyzer - Cleantech Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your cleantech operations with our AI Analyzer - Cleantech Edition. This AI-driven solution automates document processing with unprecedented accuracy and efficiency.
          </p>
