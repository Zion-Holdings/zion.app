...
export const metadata: Metadata = {
  title: 'AI-Powered Resource Insights',
  description: 'Next-generation energy solution: AI-Powered Resource Insights. Combines language processing with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-resource-insights-91f6cf51',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: AI-Powered Resource Insights. Combines language processing with adaptive intelligence for optimal results.
          </p>
