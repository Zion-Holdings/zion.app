...
export const metadata: Metadata = {
  title: 'Optimization AI - Healthcare',
  description: 'Enhance your healthcare business with Optimization AI - Healthcare. Our solution provides image recognition with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/optimization-ai-healthcare-4525c04d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Optimization AI - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with Optimization AI - Healthcare. Our solution provides image recognition with enterprise-grade reliability and security.
          </p>
