...
export const metadata: Metadata = {
  title: 'Quantum Neural - MARTECH Quantum',
  description: 'Revolutionize martech through intelligent automation. Our Quantum Neural - MARTECH Quantum leverages advanced machine learning to deliver performance tracking a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Neural - MARTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize martech through intelligent automation. Our Quantum Neural - MARTECH Quantum leverages advanced machine learning to deliver performance tracking at scale.
          </p>
