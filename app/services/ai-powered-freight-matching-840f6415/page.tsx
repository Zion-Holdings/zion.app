...
export const metadata: Metadata = {
  ...
  description: 'Matches shippers with carriers in real-time based on price, capacity, and delivery requirements.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-freight-matching-840f6415',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Matches shippers with carriers in real-time based on price, capacity, and delivery requirements.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Freight matching</li>
          <li className="text-gray-300">Price optimization</li>
          <li className="text-gray-300">Capacity utilization</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">40% cost savings</li>
