...
export const metadata: Metadata = {
  ...
  keywords: 'Semantic search across all documents, Auto-tagging & intelligent categorization, Knowledge gap detection, AI Q&A over internal documents, Content lifecycle & freshness monitoring, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Knowledge Management</h1>
        <p className="text-lg text-slate-300 mb-8">Centralize organizational knowledge with AI-powered semantic search, auto-tagging, content gap detection, and intelligent Q&amp;A across your document corpus.</p>
        ...
        <li class="text-slate-300">Semantic search across all documents</li>
        <li class="text-slate-300">Auto-tagging &amp; intelligent categorization</li>
        <li class="text-slate-300">Knowledge gap detection</li>
        <li class="text-slate-300">AI Q&amp;A over internal documents</li>
        <li class="text-slate-300">Content lifecycle &amp; freshness monitoring</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai knowledge management</li>
