      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Centralize organizational knowledge with AI-powered semantic search, auto-tagging, content gap detection, and intelligent Q&A across your document corpus.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Semantic search across all documents</li>
            <li className="text-purple-300">✓ Auto-tagging & intelligent categorization</li>
            <li className="text-purple-300">✓ Knowledge gap detection</li>
            <li className="text-purple-300">✓ AI Q&A over internal documents</li>
            <li className="text-purple-300">✓ Content lifecycle & freshness monitoring</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai knowledge management</li>
