...
export const metadata: Metadata = {
  title: 'AI Intelligence - HEALTHTECH Edition',
  description: 'Transform your healthtech operations with our AI Intelligence - HEALTHTECH Edition. This AI-driven solution automates recommendation system with unprecedented a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Intelligence - HEALTHTECH Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthtech operations with our AI Intelligence - HEALTHTECH Edition. This AI-driven solution automates recommendation system with unprecedented accuracy and efficiency.
          </p>
