...
export const metadata: Metadata = {
  title: 'AI-Powered management-transportation',
  description: 'Optimize your transportation workflows with AI-Powered management-transportation. This intelligent platform delivers net promoter score through advanced automat',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-management-transportation-6a527e79',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered management-transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with AI-Powered management-transportation. This intelligent platform delivers net promoter score through advanced automation and AI.
          </p>
