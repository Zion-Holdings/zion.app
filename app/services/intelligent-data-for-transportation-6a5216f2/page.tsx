...
export const metadata: Metadata = {
  title: 'Intelligent Data for Transportation',
  description: 'Unlock unprecedented growth with Intelligent Data for Transportation. This autonomous system provides user provisioning with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-data-for-transportation-6a5216f2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Data for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Data for Transportation. This autonomous system provides user provisioning with zero manual intervention needed.
          </p>
