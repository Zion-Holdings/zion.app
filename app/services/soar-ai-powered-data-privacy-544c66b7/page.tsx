...
export const metadata: Metadata = {
  title: 'SOAR AI-Powered Data Privacy',
  description: 'AI-powered soar solution for compliance. GDPR/CCPA compliance automation with automated data redaction.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/soar-ai-powered-data-privacy-544c66b7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            SOAR AI-Powered Data Privacy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered soar solution for compliance. GDPR/CCPA compliance automation with automated data redaction.
          </p>
