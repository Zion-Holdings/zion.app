...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "AI Agentic Workflows | Zion Tech Group", description: "End-to-end ai agentic workflows services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/ai-agentic-workflows-2026-6517/}} />
