...
export const metadata: Metadata = {
  title: 'Neural sales-hospitality',
  description: 'Enhance your hospitality business with Neural sales-hospitality. Our solution provides employee engagement with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-sales-hospitality-5ea3c2ce',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural sales-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Neural sales-hospitality. Our solution provides employee engagement with enterprise-grade reliability and security.
          </p>
