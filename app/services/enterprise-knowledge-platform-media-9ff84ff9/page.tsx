...
export const metadata: Metadata = {
  title: 'Enterprise Knowledge Platform - Media',
  description: 'Drive innovation in media with Enterprise Knowledge Platform - Media. This AI-powered platform transforms process discovery into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-knowledge-platform-media-9ff84ff9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Knowledge Platform - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in media with Enterprise Knowledge Platform - Media. This AI-powered platform transforms process discovery into a competitive advantage.
          </p>
