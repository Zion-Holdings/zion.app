...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Enterprise - Hospitality',
  description: 'Optimize your hospitality workflows with Hyper-Accelerated Enterprise - Hospitality. This intelligent platform delivers email automation through advanced automa',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Enterprise - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Hyper-Accelerated Enterprise - Hospitality. This intelligent platform delivers email automation through advanced automation and AI.
          </p>
