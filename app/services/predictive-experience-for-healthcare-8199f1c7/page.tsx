...
export const metadata: Metadata = {
  title: 'Predictive Experience for Healthcare',
  description: 'Next-generation healthcare solution: Predictive Experience for Healthcare. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-experience-for-healthcare-8199f1c7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Experience for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Predictive Experience for Healthcare. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
