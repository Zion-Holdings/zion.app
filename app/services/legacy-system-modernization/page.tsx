...
export const metadata: Metadata = {
  ...
  keywords: 'System analysis & dependency discovery, Strangler fig pattern migration planning, Database migration with CDC (change data capture), API gateway & service mesh setup, Cut-over planning & rollback strategy, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Legacy System Modernization &amp; Re-Platforming</h1>
        <p className="text-lg text-slate-300 mb-8">Migrate from legacy mainframes, monoliths, or outdated tech stacks to cloud-native microservices with minimal business disruption.</p>
        ...
        <li class="text-slate-300">System analysis &amp; dependency discovery</li>
        <li class="text-slate-300">Strangler fig pattern migration planning</li>
        <li class="text-slate-300">Database migration with CDC (change data capture)</li>
        <li class="text-slate-300">API gateway &amp; service mesh setup</li>
        <li class="text-slate-300">Cut-over planning &amp; rollback strategy</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with legacy system modernization &amp; re-platforming</li>
