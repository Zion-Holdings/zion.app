...
export const metadata: Metadata = {
  title: 'Next-Gen Insights for Transportation',
  description: 'Revolutionize transportation through intelligent automation. Our Next-Gen Insights for Transportation leverages advanced machine learning to deliver data pipeli',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-insights-for-transportation-d4abeca7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Insights for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize transportation through intelligent automation. Our Next-Gen Insights for Transportation leverages advanced machine learning to deliver data pipeline orchestration at scale.
          </p>
