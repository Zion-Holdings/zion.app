...
export const metadata: Metadata = {
  title: 'Generator Smart - Healthcare',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Generator Smart - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Generator Smart - Healthcare. Powered by cutting-edge AI, this platform delivers process automation like never before.
          </p>
