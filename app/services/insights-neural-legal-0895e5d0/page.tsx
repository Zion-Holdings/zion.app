...
export const metadata: Metadata = {
  title: 'Insights Neural - Legal',
  description: 'The future of legal is here with Insights Neural - Legal. Powered by cutting-edge AI, this platform delivers transformative results like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/insights-neural-legal-0895e5d0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Insights Neural - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Insights Neural - Legal. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
