...
export const metadata: Metadata = {
  title: 'Cognitive System Solution - Retail',
  description: 'Revolutionize retail through intelligent automation. Our Cognitive System Solution - Retail leverages advanced machine learning to deliver territory management ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-system-solution-retail-dfdd5811',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive System Solution - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize retail through intelligent automation. Our Cognitive System Solution - Retail leverages advanced machine learning to deliver territory management at scale.
          </p>
