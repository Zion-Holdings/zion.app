...
export const metadata: Metadata = {
  title: 'Smart Succession System',
  description: 'Next-generation education solution: Smart Succession System. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-succession-system-fa368759',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Succession System
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation education solution: Smart Succession System. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
