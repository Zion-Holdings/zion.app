...
export const metadata: Metadata = {
  ...
  keywords: 'Automated data discovery and cataloging, Schema inference and documentation, End-to-end data lineage, Business glossary management, Data quality scoring, Access request workflows, Integration with Alation, Collibra, DataHub, data, Data Governance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Automated Data Catalog</h1>
        <p className="text-lg text-slate-300 mb-8">Auto-discover and catalog data assets: schema inference, lineage tracking, business glossary. Find any data in seconds.</p>
        ...
        <li class="text-slate-300">Automated data discovery and cataloging</li>
        <li class="text-slate-300">Schema inference and documentation</li>
        <li class="text-slate-300">End-to-end data lineage</li>
        <li class="text-slate-300">Business glossary management</li>
        <li class="text-slate-300">Data quality scoring</li>
        <li class="text-slate-300">Access request workflows</li>
        <li class="text-slate-300">Integration with Alation</li>
        <li class="text-slate-300">Collibra</li>
        <li class="text-slate-300">DataHub</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Find any data asset in seconds</li>
        <li class="text-slate-300">Lineage tracks data from source to dashboard</li>
        <li class="text-slate-300">Business glossary for common language</li>
        <li class="text-slate-300">Data quality scoring for trust</li>
      </ul>
        </div>
