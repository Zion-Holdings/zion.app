...
export const metadata: Metadata = {
  title: 'Cognitive Director Solution - Agriculture',
  description: 'Transform your agriculture operations with our Cognitive Director Solution - Agriculture. This AI-driven solution automates compliance reporting with unpreceden',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-director-solution-agriculture-73e0cd10',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Director Solution - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Cognitive Director Solution - Agriculture. This AI-driven solution automates compliance reporting with unprecedented accuracy and efficiency.
          </p>
