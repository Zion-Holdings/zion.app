...
export const metadata: Metadata = {
  title: 'Cognitive Suite Solution - Tech',
  description: 'Next-generation technology solution: Cognitive Suite Solution - Tech. Combines container orchestration with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-suite-solution-tech-51c03228',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Suite Solution - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation technology solution: Cognitive Suite Solution - Tech. Combines container orchestration with adaptive intelligence for optimal results.
          </p>
