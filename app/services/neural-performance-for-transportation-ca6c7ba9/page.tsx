...
export const metadata: Metadata = {
  title: 'Neural Performance for Transportation',
  description: 'The future of transportation is here with Neural Performance for Transportation. Powered by cutting-edge AI, this platform delivers supply chain like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-performance-for-transportation-ca6c7ba9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Performance for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Neural Performance for Transportation. Powered by cutting-edge AI, this platform delivers supply chain like never before.
          </p>
