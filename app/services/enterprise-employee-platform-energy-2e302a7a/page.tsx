...
export const metadata: Metadata = {
  title: 'Enterprise Employee Platform - Energy',
  description: 'Optimize your energy workflows with Enterprise Employee Platform - Energy. This intelligent platform delivers sales forecasting through advanced automation and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-employee-platform-energy-2e302a7a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Employee Platform - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your energy workflows with Enterprise Employee Platform - Energy. This intelligent platform delivers sales forecasting through advanced automation and AI.
          </p>
