...
export const metadata: Metadata = {
  title: 'Predictive Monitoring for Insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Monitoring for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Predictive Monitoring for Insurance. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
