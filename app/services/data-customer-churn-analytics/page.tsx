...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Customer Churn Analytics | Zion Tech Group",
    description: "Predictive analytics platform to identify at-risk customers and recommend retention strategies.",
    url: "https://ziontechgroup.com/services/data-customer-churn-analytics/",
    type: 'website',
  },
  alternates: { canonical: "/services/data-customer-churn-analytics/" },
};

export default function DataCustomerChurnAnalyticsPage() {
  return (
    <StandardPage
      title="Customer Churn Analytics"
      subtitle="Predictive analytics platform to identify at-risk customers and recommend retention strategies."
      breadcrumbItems={[
        { label: "Home", href: "/" },
        { label: "Services", href: "/services/" },
        { label: "Customer Churn Analytics" }
      ]}
      actions={[
    ...
    >
        ...
        <div className="rounded-2xl border border-white/10 bg-slate-900/40 p-5"><h2 className="text-white font-semibold mb-2">Customer Churn Analytics</h2><p className="text-slate-400 text-sm">Archived section recovered from the live site snapshot.</p></div>
      ...
      <p className="text-slate-400 leading-relaxed mb-4 max-w-5xl mx-auto">Estimated timeline for Customer Churn Analytics — adapt to your team size and complexity.</p>
      ...
      <p className="text-slate-500 text-sm max-w-5xl mx-auto">Restored from a Wayback Machine snapshot (20260607112030) of ziontechgroup.com.</p>
    </StandardPage>
  );
}
