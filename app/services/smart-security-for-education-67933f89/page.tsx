...
export const metadata: Metadata = {
  title: 'Smart Security for Education',
  description: 'Next-generation education solution: Smart Security for Education. Combines compliance monitoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-security-for-education-67933f89',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation education solution: Smart Security for Education. Combines compliance monitoring with adaptive intelligence for optimal results.
          </p>
