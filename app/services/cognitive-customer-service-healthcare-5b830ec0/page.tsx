...
export const metadata: Metadata = {
  title: 'Cognitive customer service-healthcare',
  description: 'The future of healthcare is here with Cognitive customer service-healthcare. Powered by cutting-edge AI, this platform delivers customer insights like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-customer-service-healthcare-5b830ec0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive customer service-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Cognitive customer service-healthcare. Powered by cutting-edge AI, this platform delivers customer insights like never before.
          </p>
