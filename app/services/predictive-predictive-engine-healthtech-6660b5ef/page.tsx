...
export const metadata: Metadata = {
  title: 'Predictive Predictive Engine - HEALTHTECH',
  description: 'The future of healthtech is here with Predictive Predictive Engine - HEALTHTECH. Powered by cutting-edge AI, this platform delivers low-code automation like nev',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-predictive-engine-healthtech-6660b5ef',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Predictive Engine - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthtech is here with Predictive Predictive Engine - HEALTHTECH. Powered by cutting-edge AI, this platform delivers low-code automation like never before.
          </p>
