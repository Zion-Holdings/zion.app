...
export const metadata: Metadata = {
  title: 'Smart Intelligent Platform - Education',
  description: 'Optimize your education workflows with Smart Intelligent Platform - Education. This intelligent platform delivers risk assessment through advanced automation an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-intelligent-platform-education-8638968c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Intelligent Platform - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your education workflows with Smart Intelligent Platform - Education. This intelligent platform delivers risk assessment through advanced automation and AI.
          </p>
