...
export const metadata: Metadata = {
  title: 'Cognitive Intelligent Solution - Real-Estate',
  description: 'Enhance your real-estate business with Cognitive Intelligent Solution - Real-Estate. Our solution provides recruitment automation with enterprise-grade reliabil',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-intelligent-solution-real-estate-fce8c0e4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Intelligent Solution - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your real-estate business with Cognitive Intelligent Solution - Real-Estate. Our solution provides recruitment automation with enterprise-grade reliability and security.
          </p>
