...
export const metadata: Metadata = {
  title: 'Adaptive intelligence-retail',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive intelligence-retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Adaptive intelligence-retail. Powered by cutting-edge AI, this platform delivers user experience like never before.
          </p>
