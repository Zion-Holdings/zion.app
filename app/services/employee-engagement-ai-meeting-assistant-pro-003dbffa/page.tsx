...
export const metadata: Metadata = {
  title: 'Employee Engagement AI Meeting Assistant Pro',
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Employee Engagement AI Meeting Assistant Pro
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered employee engagement solution for productivity. AI-powered meeting assistant that generates agendas, takes notes, and schedules follow-ups.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your employee engagement operations?</p>
