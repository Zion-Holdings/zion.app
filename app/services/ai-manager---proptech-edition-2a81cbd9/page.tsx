...
export const metadata: Metadata = {
  title: 'AI Manager - Proptech Edition',
  description: 'Next-generation proptech solution: AI Manager - Proptech Edition. Combines process automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-manager---proptech-edition-2a81cbd9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Manager - Proptech Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation proptech solution: AI Manager - Proptech Edition. Combines process automation with adaptive intelligence for optimal results.
          </p>
