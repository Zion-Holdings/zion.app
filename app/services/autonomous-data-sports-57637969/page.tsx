...
export const metadata: Metadata = {
  title: 'Autonomous data-sports',
  description: 'Drive innovation in sports with Autonomous data-sports. This AI-powered platform transforms fraud prevention into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-data-sports-57637969',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous data-sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in sports with Autonomous data-sports. This AI-powered platform transforms fraud prevention into a competitive advantage.
          </p>
