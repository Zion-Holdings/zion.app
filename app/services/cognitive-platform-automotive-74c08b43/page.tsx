...
export const metadata: Metadata = {
  title: 'Cognitive platform-automotive',
  description: 'Next-generation automotive solution: Cognitive platform-automotive. Combines threat detection with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-platform-automotive-74c08b43',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive platform-automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation automotive solution: Cognitive platform-automotive. Combines threat detection with adaptive intelligence for optimal results.
          </p>
