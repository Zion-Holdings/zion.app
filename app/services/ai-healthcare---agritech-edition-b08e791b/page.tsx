...
export const metadata: Metadata = {
  title: 'AI Healthcare - Agritech Edition',
  description: 'Revolutionize agritech through intelligent automation. Our AI Healthcare - Agritech Edition leverages advanced machine learning to deliver resource optimization',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-healthcare---agritech-edition-b08e791b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Healthcare - Agritech Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agritech through intelligent automation. Our AI Healthcare - Agritech Edition leverages advanced machine learning to deliver resource optimization at scale.
          </p>
