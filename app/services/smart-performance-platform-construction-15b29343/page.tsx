...
export const metadata: Metadata = {
  ...
  description: 'Optimize your construction workflows with Smart Performance Platform - Construction. This intelligent platform delivers ml model training through advanced autom',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Smart Performance Platform - Construction. This intelligent platform delivers ml model training through advanced automation and AI.
          </p>
