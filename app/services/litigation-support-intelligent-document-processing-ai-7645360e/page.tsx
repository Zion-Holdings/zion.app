...
export const metadata: Metadata = {
  title: 'Litigation Support Intelligent Document Processing AI',
  description: 'litigation support solution for asset management industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents aut',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/litigation-support-intelligent-document-processing-ai-7645360e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Litigation Support Intelligent Document Processing AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            litigation support solution for asset management industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.
          </p>
