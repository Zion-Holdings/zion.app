...
export const metadata: Metadata = {
  ...
  description: 'Enhance your construction business with Intelligent Intelligence for Construction. Our solution provides performance tuning with enterprise-grade reliability an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Intelligent Intelligence for Construction. Our solution provides performance tuning with enterprise-grade reliability and security.
          </p>
