...
export const metadata: Metadata = {
  title: 'Smart Machine Learning Platform - Agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Smart Machine Learning Platform - Agriculture leverages advanced machine learning to deliver proce',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-machine-learning-platform-agriculture-5c6d0e8e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Machine Learning Platform - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Smart Machine Learning Platform - Agriculture leverages advanced machine learning to deliver process discovery at scale.
          </p>
