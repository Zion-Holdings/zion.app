...
export const metadata: Metadata = {
  ...
  description: 'Optimizes energy consumption in manufacturing facilities using predictive analytics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-manufacturing-energy-management2026-07-28t0402472906160000114-5df9795b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimizes energy consumption in manufacturing facilities using predictive analytics.
          </p>
