...
export const metadata: Metadata = {
  ...
  keywords: 'Dynamic pricing, Demand forecasting, Guest segmentation, Competitive intelligence, Channel optimization, Length-of-stay optimization, Group pricing, Reporting, ai, Hospitality, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Hospitality Revenue Management AI</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered revenue optimization for hotels with dynamic pricing and demand forecasting.</p>
        ...
        <li class="text-slate-300">Guest segmentation</li>
        <li class="text-slate-300">Competitive intelligence</li>
        <li class="text-slate-300">Channel optimization</li>
        <li class="text-slate-300">Length-of-stay optimization</li>
        <li class="text-slate-300">Group pricing</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">15-25% RevPAR increase</li>
        <li class="text-slate-300">Competitive pricing</li>
        <li class="text-slate-300">Forecasting accuracy</li>
        <li class="text-slate-300">Channel optimization</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$3/room/mo</p>
