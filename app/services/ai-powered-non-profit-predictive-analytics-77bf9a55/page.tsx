...
export const metadata: Metadata = {
  title: 'AI-Powered Non-profit Predictive Analytics',
  description: 'AI-powered non-profit solution leveraging advanced machine learning for optimal performance and ROI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-non-profit-predictive-analytics-77bf9a55',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Non-profit Predictive Analytics
          </h1>
