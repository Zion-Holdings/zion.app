...
export const metadata: Metadata = {
  title: 'AI/IT Real Estate Suite - Hospitality',
  description: 'Hyper-accelerated hospitality solution: AI/IT Real Estate Suite - Hospitality. Combines user experience with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-real-estate-suite-hospitality-1f5f20ee',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Real Estate Suite - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated hospitality solution: AI/IT Real Estate Suite - Hospitality. Combines user experience with next-gen AI for maximum velocity.
          </p>
