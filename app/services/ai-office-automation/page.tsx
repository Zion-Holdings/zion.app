      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            AI copilot for office workflows: document classification, contract parsing, email triage, invoice data extraction, and workflow routing — all with no-code builder.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Document classification AI</li>
            <li className="text-purple-300">✓ Contract key clause extraction</li>
            <li className="text-purple-300">✓ Email triage + auto-response</li>
            <li className="text-purple-300">✓ Invoice data extraction</li>
            <li className="text-purple-300">✓ No-code workflow builder</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai-powered office automation</li>
