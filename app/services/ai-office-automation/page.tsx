...
export const metadata: Metadata = {
  ...
  keywords: 'Document classification AI, Contract key clause extraction, Email triage + auto-response, Invoice data extraction, No-code workflow builder, automation, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Powered Office Automation</h1>
        <p className="text-lg text-slate-300 mb-8">AI copilot for office workflows: document classification, contract parsing, email triage, invoice data extraction, and workflow routing — all with no-code builder.</p>
        ...
        <li class="text-slate-300">Document classification AI</li>
        <li class="text-slate-300">Contract key clause extraction</li>
        <li class="text-slate-300">Email triage + auto-response</li>
        <li class="text-slate-300">Invoice data extraction</li>
        <li class="text-slate-300">No-code workflow builder</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai-powered office automation</li>
