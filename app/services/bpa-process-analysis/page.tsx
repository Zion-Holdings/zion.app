...
export const metadata: Metadata = {
  ...
  keywords: 'Process event log mining + variant discovery, Bottleneck + wait-time per activity, Automation opportunity ROAS scoring, Target BPMN process design, Automation ROI per identified opportunity, automation, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Business Process Analysis (BPA)</h1>
        <p className="text-lg text-slate-300 mb-8">Process discovery + event log mining, variant discovery, bottleneck detection, automation opportunity scoring. Output: BPMN design + automation ROI per task.</p>
        ...
        <li class="text-slate-300">Process event log mining + variant discovery</li>
        <li class="text-slate-300">Bottleneck + wait-time per activity</li>
        <li class="text-slate-300">Automation opportunity ROAS scoring</li>
        <li class="text-slate-300">Target BPMN process design</li>
        <li class="text-slate-300">Automation ROI per identified opportunity</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with business process analysis (bpa)</li>
