...
export const metadata: Metadata = {
  title: 'Intelligent Process Mining for Hospitality',
  description: 'Transform your hospitality operations with our Intelligent Process Mining for Hospitality. This AI-driven solution automates financial planning with unprecedent',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-process-mining-for-hospitality-ec21f831',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Process Mining for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Intelligent Process Mining for Hospitality. This AI-driven solution automates financial planning with unprecedented accuracy and efficiency.
          </p>
