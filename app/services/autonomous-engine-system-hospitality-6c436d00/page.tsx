...
export const metadata: Metadata = {
  title: 'Autonomous Engine System - Hospitality',
  description: 'Next-generation hospitality solution: Autonomous Engine System - Hospitality. Combines pipeline management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-engine-system-hospitality-6c436d00',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Engine System - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Autonomous Engine System - Hospitality. Combines pipeline management with adaptive intelligence for optimal results.
          </p>
