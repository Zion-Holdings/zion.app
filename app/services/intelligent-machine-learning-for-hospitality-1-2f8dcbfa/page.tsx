...
export const metadata: Metadata = {
  ...
  description: 'Next-generation hospitality solution: Intelligent Machine Learning for Hospitality #1. Combines invoice processing with adaptive intelligence for optimal result',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Intelligent Machine Learning for Hospitality #1. Combines invoice processing with adaptive intelligence for optimal results.
          </p>
