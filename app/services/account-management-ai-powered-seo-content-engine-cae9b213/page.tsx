...
export const metadata: Metadata = {
  title: "Account Management AI-Powered SEO Content Engine - AI-Powered LegalTech Solution",
  description: "account management solution for legaltech industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing copy.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/account-management-ai-powered-seo-content-engine-cae9b213",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Account Management AI-Powered SEO Content Engine - AI-Powered LegalTech Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          account management solution for legaltech industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing copy.
        </p>
