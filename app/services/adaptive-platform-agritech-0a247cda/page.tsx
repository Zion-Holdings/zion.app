...
export const metadata: Metadata = {
  title: 'Adaptive platform-agritech',
  description: 'Revolutionize agritech through intelligent automation. Our Adaptive platform-agritech leverages advanced machine learning to deliver financial risk management a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-platform-agritech-0a247cda',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive platform-agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agritech through intelligent automation. Our Adaptive platform-agritech leverages advanced machine learning to deliver financial risk management at scale.
          </p>
