...
export const metadata: Metadata = {
  title: 'Autonomous Finance System - MARTECH',
  description: 'The future of martech is here with Autonomous Finance System - MARTECH. Powered by cutting-edge AI, this platform delivers career development like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-finance-system-martech-34aa2e75',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Finance System - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of martech is here with Autonomous Finance System - MARTECH. Powered by cutting-edge AI, this platform delivers career development like never before.
          </p>
