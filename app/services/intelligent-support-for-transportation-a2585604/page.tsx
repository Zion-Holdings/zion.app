...
export const metadata: Metadata = {
  title: 'Intelligent Support for Transportation',
  description: 'Enhance your transportation business with Intelligent Support for Transportation. Our solution provides user provisioning with enterprise-grade reliability and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-support-for-transportation-a2585604',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Support for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with Intelligent Support for Transportation. Our solution provides user provisioning with enterprise-grade reliability and security.
          </p>
