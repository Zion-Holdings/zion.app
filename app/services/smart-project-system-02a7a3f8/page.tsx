...
export const metadata: Metadata = {
  title: 'Smart Project System',
  description: 'Revolutionize hospitality through intelligent automation. Our Smart Project System leverages advanced machine learning to deliver enterprise-grade insights at s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-project-system-02a7a3f8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Smart Project System leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
