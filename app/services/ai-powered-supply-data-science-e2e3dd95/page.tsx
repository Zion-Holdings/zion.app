...
export const metadata: Metadata = {
  title: 'AI-Powered Supply Data Science',
  description: 'Transform your hospitality operations with our AI-Powered Supply Data Science. This AI-driven solution automates resource optimization with unprecedented accura',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Supply Data Science
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our AI-Powered Supply Data Science. This AI-driven solution automates resource optimization with unprecedented accuracy and efficiency.
          </p>
