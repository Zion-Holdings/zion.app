...
export const metadata: Metadata = {
  title: 'Supply Neural - Energy',
  description: 'Next-generation energy solution: Supply Neural - Energy. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/supply-neural-energy-26b9db0f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Supply Neural - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Supply Neural - Energy. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
