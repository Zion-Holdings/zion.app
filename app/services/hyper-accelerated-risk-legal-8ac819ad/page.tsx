...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Risk - Legal',
  description: 'Revolutionize legal through intelligent automation. Our Hyper-Accelerated Risk - Legal leverages advanced machine learning to deliver revenue intelligence at sc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/hyper-accelerated-risk-legal-8ac819ad',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Risk - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Hyper-Accelerated Risk - Legal leverages advanced machine learning to deliver revenue intelligence at scale.
          </p>
