...
export const metadata: Metadata = {
  title: 'Cognitive Manufacturing Solution - Healthcare',
  description: 'Optimize your healthcare workflows with Cognitive Manufacturing Solution - Healthcare. This intelligent platform delivers customer journey mapping through advan',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-manufacturing-solution-healthcare-f4497cdb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Manufacturing Solution - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Cognitive Manufacturing Solution - Healthcare. This intelligent platform delivers customer journey mapping through advanced automation and AI.
          </p>
