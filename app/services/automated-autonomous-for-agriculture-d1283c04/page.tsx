...
export const metadata: Metadata = {
  title: 'Automated Autonomous for Agriculture',
  description: 'Next-generation agriculture solution: Automated Autonomous for Agriculture. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-autonomous-for-agriculture-d1283c04',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Autonomous for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agriculture solution: Automated Autonomous for Agriculture. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
