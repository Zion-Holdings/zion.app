...
export const metadata: Metadata = {
  ...
  keywords: '500+ app pre-built connectors, Conditional branching + retry logic, Webhook + scheduling + approval steps, Audit log + execution history per workflow, automation, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Workflow Automation &amp; Integration Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Low-code workflow builder: connect 500+ apps Zaps custom logic conditional branching retry error handling webhook triggers scheduling and approvals — replaces manual copy-paste.</p>
        ...
        <li class="text-slate-300">500+ app pre-built connectors</li>
        <li class="text-slate-300">Conditional branching + retry logic</li>
        <li class="text-slate-300">Webhook + scheduling + approval steps</li>
        <li class="text-slate-300">Audit log + execution history per workflow</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with workflow automation &amp; integration platform</li>
