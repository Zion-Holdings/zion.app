...
export const metadata = {
  ...
  description: "Transform your media operations with our Healthcare Self-Optimizing - Media. This AI-driven solution automates compliance reporting with unprecedented accuracy ",
  alternates: {
