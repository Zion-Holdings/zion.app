...
export const metadata: Metadata = {
  title: 'Intelligent Insights for Transportation',
  description: 'Revolutionize transportation through intelligent automation. Our Intelligent Insights for Transportation leverages advanced machine learning to deliver data pro',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-insights-for-transportation-8ad56c9c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Insights for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize transportation through intelligent automation. Our Intelligent Insights for Transportation leverages advanced machine learning to deliver data processing at scale.
          </p>
