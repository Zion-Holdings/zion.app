...
export const metadata: Metadata = {
  title: 'Smart Enterprise Platform - CLEANTECH #1',
  description: 'Next-generation cleantech solution: Smart Enterprise Platform - CLEANTECH #1. Combines microservices mesh with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-enterprise-platform-cleantech-1-2c7d5d18',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Enterprise Platform - CLEANTECH #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation cleantech solution: Smart Enterprise Platform - CLEANTECH #1. Combines microservices mesh with adaptive intelligence for optimal results.
          </p>
