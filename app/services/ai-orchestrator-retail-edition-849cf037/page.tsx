...
export const metadata: Metadata = {
  title: 'AI Orchestrator - Retail Edition',
  description: 'Revolutionize retail through intelligent automation. Our AI Orchestrator - Retail Edition leverages advanced machine learning to deliver disaster recovery at sc',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Orchestrator - Retail Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize retail through intelligent automation. Our AI Orchestrator - Retail Edition leverages advanced machine learning to deliver disaster recovery at scale.
          </p>
