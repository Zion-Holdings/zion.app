...
export const metadata: Metadata = {
  title: 'Autonomous Customer Service System - Insurance #1',
  description: 'Drive innovation in insurance with Autonomous Customer Service System - Insurance #1. This AI-powered platform transforms recruitment automation into a competit',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Customer Service System - Insurance #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Autonomous Customer Service System - Insurance #1. This AI-powered platform transforms recruitment automation into a competitive advantage.
          </p>
