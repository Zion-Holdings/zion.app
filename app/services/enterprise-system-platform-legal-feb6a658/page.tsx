...
export const metadata: Metadata = {
  title: 'Enterprise System Platform - Legal',
  description: 'The future of legal is here with Enterprise System Platform - Legal. Powered by cutting-edge AI, this platform delivers market intelligence like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-system-platform-legal-feb6a658',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise System Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Enterprise System Platform - Legal. Powered by cutting-edge AI, this platform delivers market intelligence like never before.
          </p>
