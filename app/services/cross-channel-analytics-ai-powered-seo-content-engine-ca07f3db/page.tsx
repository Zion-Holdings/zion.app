...
export const metadata: Metadata = {
  title: 'Cross-Channel Analytics AI-Powered SEO Content Engine',
  description: 'cross-channel analytics solution for cleaning services industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marke',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cross-channel-analytics-ai-powered-seo-content-engine-ca07f3db',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cross-Channel Analytics AI-Powered SEO Content Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            cross-channel analytics solution for cleaning services industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing copy.
          </p>
