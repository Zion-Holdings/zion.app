...
export const metadata: Metadata = {
  title: 'Intelligent DevOps Pipeline Node.js (Iot)',
  description: 'Intelligent DevOps Pipeline Node.js (Iot) is an AI-powered iot solution that transforms how businesses operate through intelligent automation and real-time anal',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent DevOps Pipeline Node.js (Iot)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Intelligent DevOps Pipeline Node.js (Iot) is an AI-powered iot solution that transforms how businesses operate through intelligent automation and real-time analytics.
