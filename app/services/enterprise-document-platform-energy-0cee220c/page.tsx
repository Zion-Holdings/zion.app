...
export const metadata: Metadata = {
  title: 'Enterprise Document Platform - Energy',
  description: 'Enhance your energy business with Enterprise Document Platform - Energy. Our solution provides logistics route optimization with enterprise-grade reliability an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Document Platform - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your energy business with Enterprise Document Platform - Energy. Our solution provides logistics route optimization with enterprise-grade reliability and security.
          </p>
