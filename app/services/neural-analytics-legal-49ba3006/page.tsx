...
export const metadata: Metadata = {
  title: 'Neural analytics-legal',
  description: 'The future of legal is here with Neural analytics-legal. Powered by cutting-edge AI, this platform delivers quality assurance like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-analytics-legal-49ba3006',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural analytics-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Neural analytics-legal. Powered by cutting-edge AI, this platform delivers quality assurance like never before.
          </p>
