...
export const metadata: Metadata = {
  title: 'Quantum Real Estate - Energy Quantum',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Real Estate - Energy Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your energy workflows with Quantum Real Estate - Energy Quantum. This intelligent platform delivers decision support through advanced automation and AI.
          </p>
