...
export const metadata: Metadata = {
  title: 'Autonomous Customer Service System - Logistics',
  description: 'Optimize your logistics workflows with Autonomous Customer Service System - Logistics. This intelligent platform delivers user provisioning through advanced aut',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Customer Service System - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your logistics workflows with Autonomous Customer Service System - Logistics. This intelligent platform delivers user provisioning through advanced automation and AI.
          </p>
