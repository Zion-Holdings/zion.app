...
export const metadata: Metadata = {
  title: 'Cognitive Risk for Retail',
  description: 'Next-generation retail solution: Cognitive Risk for Retail. Combines network optimization with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-risk-for-retail-5deed27d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Risk for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation retail solution: Cognitive Risk for Retail. Combines network optimization with adaptive intelligence for optimal results.
          </p>
