...
export const metadata: Metadata = {
  title: 'Customer Journey AI-Powered API Gateway',
  description: 'AI-powered customer journey solution for api management. Intelligent API management with rate limiting, security, and analytics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/customer-journey-ai-powered-api-gateway-d9027b27',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Customer Journey AI-Powered API Gateway
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered customer journey solution for api management. Intelligent API management with rate limiting, security, and analytics.
          </p>
