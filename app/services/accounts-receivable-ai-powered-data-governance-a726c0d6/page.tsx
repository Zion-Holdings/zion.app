...
export const metadata: Metadata = {
  title: 'Accounts Receivable AI-Powered Data Governance',
  description: 'AI-powered accounts receivable solution for data governance. Automated data governance with compliance checking and policy enforcement.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/accounts-receivable-ai-powered-data-governance-a726c0d6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Accounts Receivable AI-Powered Data Governance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered accounts receivable solution for data governance. Automated data governance with compliance checking and policy enforcement.
          </p>
