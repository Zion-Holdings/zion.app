      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for transportation: Hyper-Accelerated Customer Service - Transportation. Uses quantum-inspired algorithms to deliver supply visibility at exponential speed.
          </p>
