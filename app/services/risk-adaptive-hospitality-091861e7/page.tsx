...
export const metadata: Metadata = {
  title: 'Risk Adaptive - Hospitality',
  description: 'The future of hospitality is here with Risk Adaptive - Hospitality. Powered by cutting-edge AI, this platform delivers loyalty optimization like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/risk-adaptive-hospitality-091861e7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Risk Adaptive - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Risk Adaptive - Hospitality. Powered by cutting-edge AI, this platform delivers loyalty optimization like never before.
          </p>
