...
export const metadata: Metadata = {
  ...
  description: 'Unlock unprecedented growth with Intelligent Process Mining for Insurance. This autonomous system provides employee engagement with zero manual intervention nee',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-process-mining-for-insurance-4cf87200',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Process Mining for Insurance. This autonomous system provides employee engagement with zero manual intervention needed.
          </p>
