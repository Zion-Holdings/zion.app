...
export const metadata: Metadata = {
  title: 'Enterprise Startup Platform - Media',
  description: 'The future of media is here with Enterprise Startup Platform - Media. Powered by cutting-edge AI, this platform delivers receipt processing like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-startup-platform-media-4d1a6cb2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Startup Platform - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of media is here with Enterprise Startup Platform - Media. Powered by cutting-edge AI, this platform delivers receipt processing like never before.
          </p>
