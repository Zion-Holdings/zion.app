...
export const metadata: Metadata = {
  title: 'Autonomous Analyzer System - PROPTECH',
  description: 'Optimize your proptech workflows with Autonomous Analyzer System - PROPTECH. This intelligent platform delivers serverless deployment through advanced automatio',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-analyzer-system-proptech-c5822567',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Analyzer System - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your proptech workflows with Autonomous Analyzer System - PROPTECH. This intelligent platform delivers serverless deployment through advanced automation and AI.
          </p>
