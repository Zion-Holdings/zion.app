...
export const metadata: Metadata = {
  title: 'Smart Adaptive - HEALTHTECH',
  description: 'Drive innovation in healthtech with Smart Adaptive - HEALTHTECH. This AI-powered platform transforms onboarding automation into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-adaptive-healthtech-db3a81cf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Adaptive - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthtech with Smart Adaptive - HEALTHTECH. This AI-powered platform transforms onboarding automation into a competitive advantage.
          </p>
