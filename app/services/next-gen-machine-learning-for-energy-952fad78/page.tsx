...
export const metadata: Metadata = {
  title: 'Next-Gen Machine Learning for Energy',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Machine Learning for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated energy solution: Next-Gen Machine Learning for Energy. Combines hr analytics with next-gen AI for maximum velocity.
          </p>
