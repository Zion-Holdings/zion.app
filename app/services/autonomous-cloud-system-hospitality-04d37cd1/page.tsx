...
export const metadata: Metadata = {
  title: 'Autonomous Cloud System - Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Autonomous Cloud System - Hospitality leverages advanced machine learning to deliver energy manage',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-cloud-system-hospitality-04d37cd1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Cloud System - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Autonomous Cloud System - Hospitality leverages advanced machine learning to deliver energy management at scale.
          </p>
