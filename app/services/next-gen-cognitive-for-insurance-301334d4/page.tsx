...
export const metadata: Metadata = {
  title: 'Next-Gen Cognitive for Insurance',
  description: 'Optimize your insurance workflows with Next-Gen Cognitive for Insurance. This intelligent platform delivers release management through advanced automation and A',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-cognitive-for-insurance-301334d4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Cognitive for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Next-Gen Cognitive for Insurance. This intelligent platform delivers release management through advanced automation and AI.
          </p>
