...
export const metadata: Metadata = {
  title: 'Marketing Intelligent - Retail',
  description: 'Unlock unprecedented growth with Marketing Intelligent - Retail. This autonomous system provides business process with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/marketing-intelligent-retail-c5cd2d81',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Marketing Intelligent - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Marketing Intelligent - Retail. This autonomous system provides business process with zero manual intervention needed.
          </p>
