...
export const metadata: Metadata = {
  ...
  keywords: 'OpenAPI 3.1 spec lifecycle — versioning, deprecation, staging, Rate-limit + quota per consumer key with brotten alerting, Managed threat-protection WAF rule set for API endpoints, Schema registry + mocking + developer portal with embedded sandbox, it, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">API Gateway + OpenAPI Management</h1>
        <p className="text-lg text-slate-300 mb-8">Enterprise API gateway: OpenAPI 3.1 lifecycle, rate-limit/quota per key, threat-protection WAF rules, schema registry, live API analytics, developer portal with interactive docs and sandbox.</p>
        ...
        <li class="text-slate-300">OpenAPI 3.1 spec lifecycle — versioning, deprecation, staging</li>
        <li class="text-slate-300">Rate-limit + quota per consumer key with brotten alerting</li>
        <li class="text-slate-300">Managed threat-protection WAF rule set for API endpoints</li>
        <li class="text-slate-300">Schema registry + mocking + developer portal with embedded sandbox</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with api gateway + openapi management</li>
