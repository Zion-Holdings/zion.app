...
export const metadata: Metadata = {
  ...
  keywords: 'Technographics + intent signal + web engagement, ML model per ICP scoring dimension, ABM target list auto-generated per score tier, CRM sync Salesforce HubSpot Pipedrive, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Predictive Lead Scoring Model</h1>
        <p className="text-lg text-slate-300 mb-8">ML lead scoring: technographics intent signals website pages email engagement ABM data produces rank-ordered lead score with explanation per scoring dimension per lead toward target ICP.</p>
        ...
        <li class="text-slate-300">Technographics + intent signal + web engagement</li>
        <li class="text-slate-300">ML model per ICP scoring dimension</li>
        <li class="text-slate-300">ABM target list auto-generated per score tier</li>
        <li class="text-slate-300">CRM sync Salesforce HubSpot Pipedrive</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with predictive lead scoring model</li>
