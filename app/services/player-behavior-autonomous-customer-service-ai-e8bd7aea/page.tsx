...
export const metadata: Metadata = {
  title: 'Player Behavior Autonomous Customer Service AI',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Player Behavior Autonomous Customer Service AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered player behavior solution for customer service. Fully automated customer support system that handles 80% of inquiries without human intervention.
          </p>
