...
export const metadata: Metadata = {
  title: 'AI Analyzer - EDTECH Edition',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Analyzer - EDTECH Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your edtech workflows with AI Analyzer - EDTECH Edition. This intelligent platform delivers demand planning through advanced automation and AI.
          </p>
