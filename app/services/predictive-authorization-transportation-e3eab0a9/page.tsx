...
export const metadata: Metadata = {
  title: 'Predictive authorization-transportation',
  description: 'Future-proof your transportation with Predictive authorization-transportation. Our autonomous solution handles disaster recovery end-to-end without human interv',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive authorization-transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your transportation with Predictive authorization-transportation. Our autonomous solution handles disaster recovery end-to-end without human intervention.
          </p>
