...
export const metadata: Metadata = {
  title: 'Intelligent Healthcare for Hospitality',
  description: 'Unlock unprecedented growth with Intelligent Healthcare for Hospitality. This autonomous system provides quality control with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-healthcare-for-hospitality-f365e59e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Healthcare for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Healthcare for Hospitality. This autonomous system provides quality control with zero manual intervention needed.
          </p>
