...
export const metadata: Metadata = {
  title: 'Cognitive customer service-energy',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive customer service-energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Cognitive customer service-energy. Combines compliance monitoring with adaptive intelligence for optimal results.
          </p>
