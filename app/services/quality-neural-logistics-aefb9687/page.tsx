...
export const metadata: Metadata = {
  title: 'Quality Neural - Logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Quality Neural - Logistics leverages advanced machine learning to deliver healthcare data analytics ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quality Neural - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Quality Neural - Logistics leverages advanced machine learning to deliver healthcare data analytics at scale.
          </p>
