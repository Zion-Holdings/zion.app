...
export const metadata: Metadata = {
  title: 'Advisor Predictive - Legal',
  description: 'The future of legal is here with Advisor Predictive - Legal. Powered by cutting-edge AI, this platform delivers project portfolio like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/advisor-predictive-legal-09aa716c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Advisor Predictive - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Advisor Predictive - Legal. Powered by cutting-edge AI, this platform delivers project portfolio like never before.
          </p>
