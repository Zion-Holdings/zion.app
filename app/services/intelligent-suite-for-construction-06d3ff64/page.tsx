...
export const metadata: Metadata = {
  title: 'Intelligent Suite for Construction',
  description: 'Transform your construction operations with our Intelligent Suite for Construction. This AI-driven solution provides intelligent automation with unprecedented a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Suite for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Intelligent Suite for Construction. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
