...
export const metadata: Metadata = {
  title: 'Smart intelligent-construction #1',
  description: 'Revolutionize construction through intelligent automation. Our Smart intelligent-construction #1 leverages advanced machine learning to deliver enterprise-grade',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-intelligent-construction-1-479cda15',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart intelligent-construction #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Smart intelligent-construction #1 leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
