...
export const metadata: Metadata = {
  title: 'Next-Gen Quality for Telecom',
  description: 'Transform your telecom operations with our Next-Gen Quality for Telecom. This AI-driven solution automates workflow automation with unprecedented accuracy and e',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-quality-for-telecom-3e067c88',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Quality for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your telecom operations with our Next-Gen Quality for Telecom. This AI-driven solution automates workflow automation with unprecedented accuracy and efficiency.
          </p>
