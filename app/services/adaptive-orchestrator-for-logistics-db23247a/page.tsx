...
export const metadata: Metadata = {
  title: 'Adaptive Orchestrator for Logistics',
  description: 'Optimize your logistics workflows with Adaptive Orchestrator for Logistics. This intelligent platform delivers sourcing optimization through advanced automation',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-orchestrator-for-logistics-db23247a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Orchestrator for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your logistics workflows with Adaptive Orchestrator for Logistics. This intelligent platform delivers sourcing optimization through advanced automation and AI.
          </p>
