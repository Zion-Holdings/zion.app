...
export const metadata: Metadata = {
  title: 'Smart Healthcare for Edge',
  description: 'The future of edge is here with Smart Healthcare for Edge. Powered by cutting-edge AI, this platform delivers sales forecasting like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-healthcare-for-edge-715f6ec3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Healthcare for Edge
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of edge is here with Smart Healthcare for Edge. Powered by cutting-edge AI, this platform delivers sales forecasting like never before.
          </p>
