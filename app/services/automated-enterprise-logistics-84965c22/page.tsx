...
export const metadata: Metadata = {
  title: 'Automated enterprise-logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Automated enterprise-logistics leverages advanced machine learning to deliver leave management at sc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-enterprise-logistics-84965c22',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated enterprise-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Automated enterprise-logistics leverages advanced machine learning to deliver leave management at scale.
          </p>
