...
export const metadata: Metadata = {
  title: 'Adaptive performance-finance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive performance-finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your finance workflows with Adaptive performance-finance. This intelligent platform delivers reputation management through advanced automation and AI.
          </p>
