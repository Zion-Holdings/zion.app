...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Data Lineage & Impact Analysis Platform | Zion Tech Group",
    description: "Automated data lineage discovery and visualization platform that maps data flow from source to consumption. Column-level lineage, impact analysis for schema changes, and compliance documentation for data governance.",
    url: "https://ziontechgroup.com/services/data-lineage-tracker/",
    type: 'website',
  },
  alternates: { canonical: "/services/data-lineage-tracker/" },
};
...
export default function DataLineageTrackerPage() {
  return (
    <StandardPage
      ...
      subtitle="Automated data lineage discovery and visualization platform that maps data flow from source to consumption. Column-level lineage, impact analysis for schema changes, and compliance documentation for data governance."
      breadcrumbItems={[
        { label: "Home", href: "/" },
        { label: "Services", href: "/services/" },
        { label: "Data Lineage & Impact Analysis Platform" }
      ]}
      actions={[
    ...
    >
        ...
        <div className="rounded-2xl border border-white/10 bg-slate-900/40 p-5"><h2 className="text-white font-semibold mb-2">Data Lineage &amp; Impact Analysis Platform</h2><p className="text-slate-400 text-sm">Archived section recovered from the live site snapshot.</p></div>
      ...
      <p className="text-slate-400 leading-relaxed mb-4 max-w-5xl mx-auto">Estimated timeline for Data Lineage &amp; Impact Analysis Platform — adapt to your team size and complexity.</p>
      ...
      <p className="text-slate-500 text-sm max-w-5xl mx-auto">Restored from a Wayback Machine snapshot (20260614134414) of ziontechgroup.com.</p>
    </StandardPage>
  );
}
