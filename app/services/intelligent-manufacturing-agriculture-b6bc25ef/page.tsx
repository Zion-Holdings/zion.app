...
export const metadata: Metadata = {
  title: 'Intelligent manufacturing-agriculture',
  description: 'Transform your agriculture operations with our Intelligent manufacturing-agriculture. This AI-driven solution automates sales process optimization with unpreced',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-manufacturing-agriculture-b6bc25ef',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent manufacturing-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Intelligent manufacturing-agriculture. This AI-driven solution automates sales process optimization with unprecedented accuracy and efficiency.
          </p>
