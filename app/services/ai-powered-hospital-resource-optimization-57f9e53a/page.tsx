...
export const metadata: Metadata = {
  ...
  description: 'Optimizes hospital bed allocation, staff scheduling, and equipment utilization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-hospital-resource-optimization-57f9e53a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimizes hospital bed allocation, staff scheduling, and equipment utilization.
          </p>
