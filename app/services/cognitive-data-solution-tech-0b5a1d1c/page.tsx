...
export const metadata: Metadata = {
  title: 'Cognitive Data Solution - Tech',
  description: 'The future of technology is here with Cognitive Data Solution - Tech. Powered by cutting-edge AI, this platform delivers logistics route optimization like never',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-data-solution-tech-0b5a1d1c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Data Solution - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of technology is here with Cognitive Data Solution - Tech. Powered by cutting-edge AI, this platform delivers logistics route optimization like never before.
          </p>
