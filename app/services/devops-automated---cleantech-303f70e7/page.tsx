...
export const metadata: Metadata = {
  title: 'DevOps Automated - Cleantech',
  description: 'Next-generation cleantech solution: DevOps Automated - Cleantech. Combines network optimization with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/devops-automated---cleantech-303f70e7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            DevOps Automated - Cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation cleantech solution: DevOps Automated - Cleantech. Combines network optimization with adaptive intelligence for optimal results.
          </p>
