...
export const metadata: Metadata = {
  ...
  description: 'Robo-advisor that creates and manages investment portfolios using modern portfolio theory and ML optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-wealth-management-advisor-71b83c4c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Wealth Management Advisor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Robo-advisor that creates and manages investment portfolios using modern portfolio theory and ML optimization.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Portfolio optimization</li>
          <li className="text-gray-300">Rebalancing</li>
          <li className="text-gray-300">Tax-loss harvesting</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">25% better returns</li>
