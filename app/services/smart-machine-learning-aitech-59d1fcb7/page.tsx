...
export const metadata: Metadata = {
  title: 'Smart machine learning-aitech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart machine learning-aitech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your aitech workflows with Smart machine learning-aitech. This intelligent platform delivers language processing through advanced automation and AI.
          </p>
