...
export const metadata: Metadata = {
  title: 'Enterprise Computer Vision Platform - Gaming',
  description: 'Transform your gaming operations with our Enterprise Computer Vision Platform - Gaming. This AI-driven solution automates invoice automation with unprecedented ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-computer-vision-platform-gaming-c4e80d0b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Computer Vision Platform - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your gaming operations with our Enterprise Computer Vision Platform - Gaming. This AI-driven solution automates invoice automation with unprecedented accuracy and efficiency.
          </p>
