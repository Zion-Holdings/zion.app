...
export const metadata: Metadata = {
  title: 'Quantum Marketing - HEALTHTECH Quantum',
  description: 'Drive innovation in healthtech with Quantum Marketing - HEALTHTECH Quantum. This AI-powered platform transforms serverless orchestration into a competitive adva',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Marketing - HEALTHTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthtech with Quantum Marketing - HEALTHTECH Quantum. This AI-powered platform transforms serverless orchestration into a competitive advantage.
          </p>
