...
export const metadata: Metadata = {
  title: 'Autonomous Revenue System - Hospitality #1',
  description: 'Enhance your hospitality business with Autonomous Revenue System - Hospitality #1. Our solution provides logistics route optimization with enterprise-grade reli',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-revenue-system-hospitality-1-6c2c41fc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Revenue System - Hospitality #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Autonomous Revenue System - Hospitality #1. Our solution provides logistics route optimization with enterprise-grade reliability and security.
          </p>
