      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Live transcription, action-item extraction, decision-log compiler, sentiment tracker, and auto-sync to Asana/Slack/Done with calendar.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Live transcription (OpenAI Whisper Real-time)</li>
            <li className="text-purple-300">✓ Action-item extraction + assignment</li>
            <li className="text-purple-300">✓ Decision-log compiler per meeting</li>
            <li className="text-purple-300">✓ Sentiment tracker per participant + aggregate</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai meeting assistant pro</li>
