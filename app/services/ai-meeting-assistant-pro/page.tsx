...
export const metadata: Metadata = {
  ...
  keywords: 'Live transcription (OpenAI Whisper Real-time), Action-item extraction + assignment, Decision-log compiler per meeting, Sentiment tracker per participant + aggregate, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Meeting Assistant Pro</h1>
        <p className="text-lg text-slate-300 mb-8">Live transcription, action-item extraction, decision-log compiler, sentiment tracker, and auto-sync to Asana/Slack/Done with calendar.</p>
        ...
        <li class="text-slate-300">Live transcription (OpenAI Whisper Real-time)</li>
        <li class="text-slate-300">Action-item extraction + assignment</li>
        <li class="text-slate-300">Decision-log compiler per meeting</li>
        <li class="text-slate-300">Sentiment tracker per participant + aggregate</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai meeting assistant pro</li>
