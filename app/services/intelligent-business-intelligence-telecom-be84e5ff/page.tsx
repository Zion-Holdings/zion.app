...
export const metadata: Metadata = {
  title: 'Intelligent business intelligence-telecom',
  description: 'Drive innovation in telecom with Intelligent business intelligence-telecom. This AI-powered platform transforms language processing into a competitive advantage',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-business-intelligence-telecom-be84e5ff',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent business intelligence-telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in telecom with Intelligent business intelligence-telecom. This AI-powered platform transforms language processing into a competitive advantage.
          </p>
