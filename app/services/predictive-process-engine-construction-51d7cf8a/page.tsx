...
export const metadata: Metadata = {
  title: 'Predictive Process Engine - Construction',
  description: 'Optimize your construction workflows with Predictive Process Engine - Construction. This intelligent platform delivers budget optimization through advanced auto',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-process-engine-construction-51d7cf8a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Process Engine - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Predictive Process Engine - Construction. This intelligent platform delivers budget optimization through advanced automation and AI.
          </p>
