...
export const metadata: Metadata = {
  title: 'Enterprise NLP Platform - AITECH',
  description: 'Next-generation aitech solution: Enterprise NLP Platform - AITECH. Combines project management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-nlp-platform-aitech-44586aea',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise NLP Platform - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation aitech solution: Enterprise NLP Platform - AITECH. Combines project management with adaptive intelligence for optimal results.
          </p>
