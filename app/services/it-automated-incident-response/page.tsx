...
export const metadata: Metadata = {
  ...
  keywords: 'Pre-built playbooks (phishing, malware, IAM), Integration with 200+ security tools, Case management & audit trail, AI-assisted triage suggestions, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Automated Incident Response (SOAR)</h1>
        <p className="text-lg text-slate-300 mb-8">Security Orchestration, Automation &amp; Response platform that auto-remediates 40% of Tier-1 incidents using playbooks and AI decisioning.</p>
        ...
        <li class="text-slate-300">Pre-built playbooks (phishing, malware, IAM)</li>
        <li class="text-slate-300">Integration with 200+ security tools</li>
        <li class="text-slate-300">Case management &amp; audit trail</li>
        <li class="text-slate-300">AI-assisted triage suggestions</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with automated incident response (soar)</li>
