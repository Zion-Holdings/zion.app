...
export const metadata: Metadata = {
  title: 'Intelligent Sourcing NLP',
  description: 'Next-generation education solution: Intelligent Sourcing NLP. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-sourcing-nlp-7986116f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Sourcing NLP
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation education solution: Intelligent Sourcing NLP. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
