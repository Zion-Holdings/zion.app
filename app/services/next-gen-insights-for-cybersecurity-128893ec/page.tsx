...
export const metadata: Metadata = {
  title: 'Next-Gen Insights for Cybersecurity',
  description: 'Hyper-accelerated cybersecurity solution: Next-Gen Insights for Cybersecurity. Combines project management with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-insights-for-cybersecurity-128893ec',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Insights for Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated cybersecurity solution: Next-Gen Insights for Cybersecurity. Combines project management with next-gen AI for maximum velocity.
          </p>
