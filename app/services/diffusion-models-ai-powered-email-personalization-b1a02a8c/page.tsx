...
export const metadata: Metadata = {
  title: 'Diffusion Models AI-Powered Email Personalization',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Diffusion Models AI-Powered Email Personalization
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered diffusion models solution for email marketing. Creates hyper-personalized email campaigns by analyzing recipient data.
          </p>
