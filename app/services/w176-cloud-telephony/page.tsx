...
export const metadata: Metadata = {
  ...
  keywords: 'Cloud PBX with auto-attendant, Advanced call routing and IVR, HD audio conferencing, Call recording and analytics, Number porting and management, SMS and MMS messaging, Integration with CRM (Salesforce, HubSpot), it, Communication, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cloud Telephony &amp; VoIP Service</h1>
        <p className="text-lg text-slate-300 mb-8">Business cloud telephony: PBX, call routing, IVR, conferencing, and call analytics. Replace PBX hardware with cloud VoIP.</p>
        ...
        <li class="text-slate-300">Cloud PBX with auto-attendant</li>
        <li class="text-slate-300">Advanced call routing and IVR</li>
        <li class="text-slate-300">HD audio conferencing</li>
        <li class="text-slate-300">Call recording and analytics</li>
        <li class="text-slate-300">Number porting and management</li>
        <li class="text-slate-300">SMS and MMS messaging</li>
        <li class="text-slate-300">Integration with CRM (Salesforce, HubSpot)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Replace expensive PBX hardware</li>
        <li class="text-slate-300">Analytics reveal call patterns and quality</li>
        <li class="text-slate-300">IVR routes callers efficiently</li>
        <li class="text-slate-300">CRM integration for screen pops</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$55/user/mo</p>
