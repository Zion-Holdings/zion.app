...
export const metadata: Metadata = {
  title: 'Next-Gen Autonomous for Transportation',
  description: 'Next-generation transportation solution: Next-Gen Autonomous for Transportation. Combines financial planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-autonomous-for-transportation-92f4e537',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Autonomous for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation transportation solution: Next-Gen Autonomous for Transportation. Combines financial planning with adaptive intelligence for optimal results.
          </p>
