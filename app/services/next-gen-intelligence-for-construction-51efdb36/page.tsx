...
export const metadata: Metadata = {
  title: 'Next-Gen Intelligence for Construction',
  description: 'Optimize your construction workflows with Next-Gen Intelligence for Construction. This intelligent platform delivers dashboard automation through advanced autom',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-intelligence-for-construction-51efdb36',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Intelligence for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Next-Gen Intelligence for Construction. This intelligent platform delivers dashboard automation through advanced automation and AI.
          </p>
