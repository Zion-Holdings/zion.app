...
export const metadata: Metadata = {
  title: 'System Adaptive - Logistics',
  description: 'Next-generation logistics solution: System Adaptive - Logistics. Combines security monitoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/system-adaptive-logistics-11ee8157',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            System Adaptive - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: System Adaptive - Logistics. Combines security monitoring with adaptive intelligence for optimal results.
          </p>
