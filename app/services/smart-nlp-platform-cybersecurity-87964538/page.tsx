...
export const metadata: Metadata = {
  title: 'Smart NLP Platform - Cybersecurity',
  description: 'Optimize your cybersecurity workflows with Smart NLP Platform - Cybersecurity. This intelligent platform delivers fleet management through advanced automation a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-nlp-platform-cybersecurity-87964538',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart NLP Platform - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your cybersecurity workflows with Smart NLP Platform - Cybersecurity. This intelligent platform delivers fleet management through advanced automation and AI.
          </p>
