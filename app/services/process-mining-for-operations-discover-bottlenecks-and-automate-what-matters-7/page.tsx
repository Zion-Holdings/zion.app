...
export const metadata = {
  ...
  description: 'End-to-end process mining for operations: discover bottlenecks and automate what matters services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/process-mining-for-operations-discover-bottlenecks-and-automate-what-matters-7/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">Process Mining for Operations: Discover Bottlenecks and Automate What Matters</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end process mining for operations: discover bottlenecks and automate what matters services: assessment, deployment, and managed operations.
        </p>
