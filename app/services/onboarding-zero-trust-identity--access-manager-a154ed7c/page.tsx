...
export const metadata: Metadata = {
  title: 'Onboarding Zero-Trust Identity & Access Manager',
  description: 'onboarding solution for sports venues industry. Implements zero-trust security architecture with continuous authentication and adaptive access controls.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/onboarding-zero-trust-identity--access-manager-a154ed7c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Onboarding Zero-Trust Identity & Access Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            onboarding solution for sports venues industry. Implements zero-trust security architecture with continuous authentication and adaptive access controls.
          </p>
