...
export const metadata: Metadata = {
  ...
  description: 'Discovers, automates, and optimizes business processes using AI-powered process mining.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-business-process-automation-suite-a80ed8bb',
  },

export const metadata = {
  title: "AI Business Process Automation Suite - Zion Tech Group",
  description: "Discovers, automates, and optimizes business processes using AI-powered process mining.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-business-process-automation-suite-a80ed8bb`
  }
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Business Process Automation Suite
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Discovers, automates, and optimizes business processes using AI-powered process mining.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Automation recommendations</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">70% faster automation</li>
          <li className="text-purple-300">Optimized ROI</li>
          </ul>
        </section>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your business process operations?</p>
    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">AI Business Process Automation Suite</h1>
        <p className="text-lg text-gray-300 mb-8">Discovers, automates, and optimizes business processes using AI-powered process mining.</p>
