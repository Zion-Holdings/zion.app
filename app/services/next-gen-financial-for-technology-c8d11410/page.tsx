...
export const metadata: Metadata = {
  title: 'Next-Gen Financial for TECHNOLOGY',
  description: 'Optimize your technology workflows with Next-Gen Financial for TECHNOLOGY. This intelligent platform delivers project management through advanced automation and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-financial-for-technology-c8d11410',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Financial for TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your technology workflows with Next-Gen Financial for TECHNOLOGY. This intelligent platform delivers project management through advanced automation and AI.
          </p>
