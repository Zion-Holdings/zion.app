...
export const metadata: Metadata = {
  title: 'Intelligent Vendor Support',
  description: 'Unlock unprecedented growth with Intelligent Vendor Support. This autonomous system provides incident response with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-vendor-support-fd27540e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Vendor Support. This autonomous system provides incident response with zero manual intervention needed.
          </p>
