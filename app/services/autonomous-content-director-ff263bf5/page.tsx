...
export const metadata: Metadata = {
  title: 'Autonomous Content Director',
  description: 'Transform your healthcare operations with our Autonomous Content Director. This AI-driven solution provides intelligent automation with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-content-director-ff263bf5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Autonomous Content Director. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
