...
export const metadata: Metadata = {
  title: 'AI/IT Process Mining Suite - Automotive',
  description: 'Enhance your automotive business with AI/IT Process Mining Suite - Automotive. Our solution provides recruitment automation with enterprise-grade reliability an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-process-mining-suite-automotive-edf690b2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Process Mining Suite - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your automotive business with AI/IT Process Mining Suite - Automotive. Our solution provides recruitment automation with enterprise-grade reliability and security.
          </p>
