...
export const metadata: Metadata = {
  title: 'Predictive System for Telecom',
  description: 'Revolutionize telecom through intelligent automation. Our Predictive System for Telecom leverages advanced machine learning to deliver logistics route optimizat',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive System for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Predictive System for Telecom leverages advanced machine learning to deliver logistics route optimization at scale.
          </p>
