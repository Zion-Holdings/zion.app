...
export const metadata: Metadata = {
  title: 'Optimizer Cognitive - Healthcare',
  description: 'Enhance your healthcare business with Optimizer Cognitive - Healthcare. Our solution provides employee engagement with enterprise-grade reliability and security',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/optimizer-cognitive-healthcare-713022ae',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Optimizer Cognitive - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with Optimizer Cognitive - Healthcare. Our solution provides employee engagement with enterprise-grade reliability and security.
          </p>
