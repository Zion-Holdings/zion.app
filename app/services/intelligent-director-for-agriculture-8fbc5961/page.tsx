...
export const metadata: Metadata = {
  title: 'Intelligent Director for Agriculture',
  description: 'The future of agriculture is here with Intelligent Director for Agriculture. Powered by cutting-edge AI, this platform delivers fraud prevention like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-director-for-agriculture-8fbc5961',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Director for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Intelligent Director for Agriculture. Powered by cutting-edge AI, this platform delivers fraud prevention like never before.
          </p>
