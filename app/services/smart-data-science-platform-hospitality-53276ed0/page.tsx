...
export const metadata: Metadata = {
  title: 'Smart Data Science Platform - Hospitality',
  description: 'Transform your hospitality operations with our Smart Data Science Platform - Hospitality. This AI-driven solution automates manufacturing quality control with u',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-data-science-platform-hospitality-53276ed0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Data Science Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Smart Data Science Platform - Hospitality. This AI-driven solution automates manufacturing quality control with unprecedented accuracy and efficiency.
          </p>
