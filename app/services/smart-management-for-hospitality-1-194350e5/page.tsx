...
export const metadata: Metadata = {
  title: 'Smart Management for Hospitality #1',
  description: 'Optimize your hospitality workflows with Smart Management for Hospitality #1. This intelligent platform delivers audit trail management through advanced automat',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-management-for-hospitality-1-194350e5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Management for Hospitality #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Smart Management for Hospitality #1. This intelligent platform delivers audit trail management through advanced automation and AI.
          </p>
