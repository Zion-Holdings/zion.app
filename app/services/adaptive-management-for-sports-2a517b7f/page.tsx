...
export const metadata: Metadata = {
  title: 'Adaptive Management for Sports',
  description: 'The future of sports is here with Adaptive Management for Sports. Powered by cutting-edge AI, this platform delivers process automation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-management-for-sports-2a517b7f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Management for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Adaptive Management for Sports. Powered by cutting-edge AI, this platform delivers process automation like never before.
          </p>
