...
export const metadata: Metadata = {
  title: 'Cognitive Quality Solution - Sports',
  description: 'Enhance your sports business with Cognitive Quality Solution - Sports. Our solution provides data governance with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-quality-solution-sports-638a37ef',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Quality Solution - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your sports business with Cognitive Quality Solution - Sports. Our solution provides data governance with enterprise-grade reliability and security.
          </p>
