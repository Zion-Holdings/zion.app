...
export const metadata: Metadata = {
  title: 'Cognitive Data Science Solution - Hospitality',
  description: 'Future-proof your hospitality with Cognitive Data Science Solution - Hospitality. Our autonomous solution handles user provisioning end-to-end without human int',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-data-science-solution-hospitality-35a46f9d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Data Science Solution - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your hospitality with Cognitive Data Science Solution - Hospitality. Our autonomous solution handles user provisioning end-to-end without human intervention.
          </p>
