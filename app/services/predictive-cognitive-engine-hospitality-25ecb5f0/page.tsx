...
export const metadata: Metadata = {
  ...
  description: 'Enhance your hospitality business with Predictive Cognitive Engine - Hospitality. Our solution provides user provisioning with enterprise-grade reliability and ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Predictive Cognitive Engine - Hospitality. Our solution provides user provisioning with enterprise-grade reliability and security.
          </p>
