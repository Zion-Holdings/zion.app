...
export const metadata: Metadata = {
  title: 'Ride-hailing AI-Powered Demand Forecasting',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Ride-hailing AI-Powered Demand Forecasting
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered ride-hailing solution for retail. Uses time-series analysis to predict product demand with high accuracy.
          </p>
