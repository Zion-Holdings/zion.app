  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Revolutionize transportation through intelligent automation. Our Neural Cloud for Transportation leverages advanced machine learning to deliver risk assessment at scale.</p>
