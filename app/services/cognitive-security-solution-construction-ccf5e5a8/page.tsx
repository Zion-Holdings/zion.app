...
export const metadata: Metadata = {
  title: 'Cognitive Security Solution - Construction',
  description: 'Revolutionize construction through intelligent automation. Our Cognitive Security Solution - Construction leverages advanced machine learning to deliver data go',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-security-solution-construction-ccf5e5a8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Security Solution - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Cognitive Security Solution - Construction leverages advanced machine learning to deliver data governance at scale.
          </p>
