...
export const metadata: Metadata = {
  title: 'Insights Smart - Agriculture',
  description: 'Next-generation agriculture solution: Insights Smart - Agriculture. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/insights-smart-agriculture-a5f5cb9c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agriculture solution: Insights Smart - Agriculture. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
