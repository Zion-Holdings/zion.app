...
export const metadata: Metadata = {
  title: 'Cognitive Capacity Sales',
  description: 'Optimize your insurance workflows with Cognitive Capacity Sales. This intelligent platform delivers reputation management through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-capacity-sales-7c13e2e8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Capacity Sales
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Cognitive Capacity Sales. This intelligent platform delivers reputation management through advanced automation and AI.
          </p>
