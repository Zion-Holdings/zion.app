...
export const metadata: Metadata = {
  title: 'Cognitive Sales Advisor',
  description: 'Revolutionize manufacturing through intelligent automation. Our Cognitive Sales Advisor leverages advanced machine learning to deliver financial risk management',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Sales Advisor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize manufacturing through intelligent automation. Our Cognitive Sales Advisor leverages advanced machine learning to deliver financial risk management at scale.
          </p>
