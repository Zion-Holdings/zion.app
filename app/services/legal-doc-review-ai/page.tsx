...
export const metadata: Metadata = {
  ...
  keywords: 'Clause extraction & classification (liability, IP, termination), Risk scoring per clause (high/medium/low), Deviation detection from standard templates, Redline suggestions with rationale, Multi-jurisdiction compliance checks, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Legal Document Review &amp; Risk Analysis</h1>
        <p className="text-lg text-slate-300 mb-8">Accelerate legal contract review by 80%: extract obligations, flag risks, suggest clauses, and compare against playbooks using LLMs fine-tuned on legal corpora.</p>
        ...
        <li class="text-slate-300">Clause extraction &amp; classification (liability, IP, termination)</li>
        <li class="text-slate-300">Risk scoring per clause (high/medium/low)</li>
        <li class="text-slate-300">Deviation detection from standard templates</li>
        <li class="text-slate-300">Redline suggestions with rationale</li>
        <li class="text-slate-300">Multi-jurisdiction compliance checks</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai legal document review &amp; risk analysis</li>
