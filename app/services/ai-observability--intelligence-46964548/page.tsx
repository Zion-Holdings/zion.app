...
export const metadata: Metadata = {
  title: 'AI Observability & Intelligence',
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-observability--intelligence-46964548',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Cross-signal anomaly detection</li>
          <li className="text-gray-300">Root-cause ranking and timeline</li>
          <li className="text-gray-300">SLO burn-rate prediction</li>
          <li className="text-gray-300">Incident summarization for Slack/Teams</li>
          </ul>
        </section>
