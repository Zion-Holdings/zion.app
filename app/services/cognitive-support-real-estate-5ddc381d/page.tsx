...
export const metadata: Metadata = {
  title: 'Cognitive support-real-estate',
  description: 'Enhance your real-estate business with Cognitive support-real-estate. Our solution provides hr analytics with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-support-real-estate-5ddc381d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive support-real-estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your real-estate business with Cognitive support-real-estate. Our solution provides hr analytics with enterprise-grade reliability and security.
          </p>
