...
export const metadata: Metadata = {
  title: 'Smart Employee Platform - Legal',
  description: 'Quantum leap forward for legal: Smart Employee Platform - Legal. Uses quantum-inspired algorithms to deliver time tracking at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-employee-platform-legal-ac261c7b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Employee Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for legal: Smart Employee Platform - Legal. Uses quantum-inspired algorithms to deliver time tracking at exponential speed.
          </p>
