...
export const metadata: Metadata = {
  title: "AI-Powered Master Data Management - AI-Powered Data Governance Solution",
  description: "Automated master data consolidation and deduplication.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-master-data-management-36f569a9",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Master Data Management - AI-Powered Data Governance Solution
        </h1>
