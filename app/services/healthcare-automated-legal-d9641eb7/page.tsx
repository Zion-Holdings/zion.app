...
export const metadata: Metadata = {
  title: 'Healthcare Automated - Legal',
  description: 'Transform your legal operations with our Healthcare Automated - Legal. This AI-driven solution provides intelligent automation with unprecedented accuracy and e',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Healthcare Automated - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Healthcare Automated - Legal. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
