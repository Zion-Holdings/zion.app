...
export const metadata: Metadata = {
  title: 'Intelligent System for Transportation',
  description: 'Optimize your transportation workflows with Intelligent System for Transportation. This intelligent platform delivers succession planning through advanced autom',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-system-for-transportation-30d0d7ed',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent System for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Intelligent System for Transportation. This intelligent platform delivers succession planning through advanced automation and AI.
          </p>
