...
export const metadata: Metadata = {
  title: 'Influencer AI-Powered Chatbot Builder',
  description: 'AI-powered influencer solution for customer service. Creates intelligent chatbots for customer service and lead generation.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/influencer-ai-powered-chatbot-builder-f04984d9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Influencer AI-Powered Chatbot Builder
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered influencer solution for customer service. Creates intelligent chatbots for customer service and lead generation.
          </p>
