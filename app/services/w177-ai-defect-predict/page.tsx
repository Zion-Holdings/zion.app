...
export const metadata: Metadata = {
  ...
  keywords: 'Process parameter anomaly detection, Quality outcome prediction, Root cause analysis with explainability, Real-time production monitoring, Yield optimization recommendations, Maintenance trigger prediction, Integration with Siemens, Rockwell, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Manufacturing Defect Predictor</h1>
        <p className="text-lg text-slate-300 mb-8">Predict manufacturing defects: process parameter analysis, quality correlation, root cause identification. Reduce scrap 35%.</p>
        ...
        <li class="text-slate-300">Process parameter anomaly detection</li>
        <li class="text-slate-300">Quality outcome prediction</li>
        <li class="text-slate-300">Root cause analysis with explainability</li>
        <li class="text-slate-300">Real-time production monitoring</li>
        <li class="text-slate-300">Yield optimization recommendations</li>
        <li class="text-slate-300">Maintenance trigger prediction</li>
        <li class="text-slate-300">Integration with Siemens</li>
        <li class="text-slate-300">Rockwell</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Predict defects before they occur</li>
        <li class="text-slate-300">Reduce scrap rate by 35%</li>
        <li class="text-slate-300">Root cause analysis speeds fixes</li>
        <li class="text-slate-300">Yield optimization increases output</li>
      </ul>
        </div>
