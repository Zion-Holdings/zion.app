...
export const metadata: Metadata = {
  title: 'AI Business Intelligence - Retail Edition',
  description: 'Transform your retail operations with our AI Business Intelligence - Retail Edition. This AI-driven solution automates procurement automation with unprecedented',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-business-intelligence-retail-edition-8563ccdc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Business Intelligence - Retail Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our AI Business Intelligence - Retail Edition. This AI-driven solution automates procurement automation with unprecedented accuracy and efficiency.
          </p>
