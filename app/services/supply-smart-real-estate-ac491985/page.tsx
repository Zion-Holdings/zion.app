...
export const metadata: Metadata = {
  title: 'Supply Smart - Real-Estate',
  description: 'Revolutionize real-estate through intelligent automation. Our Supply Smart - Real-Estate leverages advanced machine learning to deliver scalability planning at ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/supply-smart-real-estate-ac491985',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Supply Smart - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our Supply Smart - Real-Estate leverages advanced machine learning to deliver scalability planning at scale.
          </p>
