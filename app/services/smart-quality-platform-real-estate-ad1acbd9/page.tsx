...
export const metadata: Metadata = {
  title: 'Smart Quality Platform - Real-Estate',
  description: 'The future of real-estate is here with Smart Quality Platform - Real-Estate. Powered by cutting-edge AI, this platform delivers automation opportunity like neve',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-quality-platform-real-estate-ad1acbd9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Quality Platform - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of real-estate is here with Smart Quality Platform - Real-Estate. Powered by cutting-edge AI, this platform delivers automation opportunity like never before.
          </p>
