...
export const metadata: Metadata = {
  title: 'Quantum Manager - Real-Estate Quantum',
  description: 'Transform your real-estate operations with our Quantum Manager - Real-Estate Quantum. This AI-driven solution automates financial planning with unprecedented ac',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Manager - Real-Estate Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Quantum Manager - Real-Estate Quantum. This AI-driven solution automates financial planning with unprecedented accuracy and efficiency.
          </p>
