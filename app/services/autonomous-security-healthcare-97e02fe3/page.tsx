...
export const metadata: Metadata = {
  title: 'Autonomous security-healthcare',
  description: 'Next-generation healthcare solution: Autonomous security-healthcare. Combines compliance monitoring with adaptive intelligence for optimal results.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous security-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Autonomous security-healthcare. Combines compliance monitoring with adaptive intelligence for optimal results.
          </p>
