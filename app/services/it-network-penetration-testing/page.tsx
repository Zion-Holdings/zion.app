...
export const metadata: Metadata = {
  ...
  keywords: 'Network penetration testing, Web application security testing, Social engineering campaigns, Physical security assessment, Detailed remediation roadmap, Retesting after fixes, security, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Network Penetration Testing &amp; Red Team</h1>
        <p className="text-lg text-slate-300 mb-8">Comprehensive penetration testing and red team exercises to identify vulnerabilities before attackers do. Includes network, web app, social engineering, and physical security testing.</p>
        ...
        <li class="text-slate-300">Network penetration testing</li>
        <li class="text-slate-300">Web application security testing</li>
        <li class="text-slate-300">Social engineering campaigns</li>
        <li class="text-slate-300">Physical security assessment</li>
        <li class="text-slate-300">Detailed remediation roadmap</li>
        <li class="text-slate-300">Retesting after fixes</li>
      </ul>
        </div>
        ...
        <li class="text-slate-300">Meet compliance requirements (PCI, SOC 2)</li>
        <li class="text-slate-300">Prioritize remediation by risk</li>
        <li class="text-slate-300">Reduce breach likelihood by 80%</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$5,000/test</p>
              <p class="text-sm text-slate-400">Getting started plan</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              <h3 class="font-semibold text-white mb-2">Pro</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">$15,000/test</p>
