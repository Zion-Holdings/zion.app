export const metadata = {
  title: "Smart Smart Platform - Energy",
  description: "Zion Tech Group delivers Smart Smart Platform - Energy with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/services/smart-smart-platform-energy-e7c35dfe/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>Smart Smart Platform - Energy</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers Smart Smart Platform - Energy with measurable outcomes.
      </p>
