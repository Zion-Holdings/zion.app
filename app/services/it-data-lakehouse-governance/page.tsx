...
export const metadata: Metadata = {
  ...
  keywords: 'Automated data catalog, Column-level lineage, Policy-based access control (RBAC/ABAC), Quality scorecard per dataset, it, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Data Lakehouse Governance</h1>
        <p className="text-lg text-slate-300 mb-8">Metadata management, lineage tracking, and access controls for Delta Lake, Apache Iceberg, or Snowflake environments.</p>
        ...
        <li class="text-slate-300">Automated data catalog</li>
        <li class="text-slate-300">Column-level lineage</li>
        <li class="text-slate-300">Policy-based access control (RBAC/ABAC)</li>
        <li class="text-slate-300">Quality scorecard per dataset</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with data lakehouse governance</li>
