...
export const metadata: Metadata = {
  ...
  keywords: 'Demand forecasting with 94% accuracy, Alternative routing suggestions, Supplier risk scoring, Real-time anomaly alerts, ai, Healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Supply Chain Predictor</h1>
        <p className="text-lg text-slate-300 mb-8">Predicts supply chain disruptions 14–30 days in advance using multi-source data: weather, geopolitical events, shipping delays, and supplier health scores.</p>
        ...
        <li class="text-slate-300">Demand forecasting with 94% accuracy</li>
        <li class="text-slate-300">Alternative routing suggestions</li>
        <li class="text-slate-300">Supplier risk scoring</li>
        <li class="text-slate-300">Real-time anomaly alerts</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai supply chain predictor</li>
