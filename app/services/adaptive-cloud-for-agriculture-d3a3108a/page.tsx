...
export const metadata: Metadata = {
  title: 'Adaptive Cloud for Agriculture',
  description: 'Transform your agriculture operations with our Adaptive Cloud for Agriculture. This AI-driven solution automates resource optimization with unprecedented accura',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Cloud for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Adaptive Cloud for Agriculture. This AI-driven solution automates resource optimization with unprecedented accuracy and efficiency.
          </p>
