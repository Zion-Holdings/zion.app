...
export const metadata: Metadata = {
  title: 'Smart Engine for Proptech',
  description: 'Revolutionize proptech through intelligent automation. Our Smart Engine for Proptech leverages advanced machine learning to deliver sales process optimization a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Engine for Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our Smart Engine for Proptech leverages advanced machine learning to deliver sales process optimization at scale.
          </p>
