...
export const metadata: Metadata = {
  title: 'Intelligent Platform for Legal',
  description: 'Revolutionize legal through intelligent automation. Our Intelligent Platform for Legal leverages advanced machine learning to deliver manufacturing quality cont',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-platform-for-legal-0613d84f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Platform for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Intelligent Platform for Legal leverages advanced machine learning to deliver manufacturing quality control at scale.
          </p>
