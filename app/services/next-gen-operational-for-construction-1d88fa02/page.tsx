...
export const metadata: Metadata = {
  title: 'Next-Gen Operational for Construction',
  description: 'Revolutionize construction through intelligent automation. Our Next-Gen Operational for Construction leverages advanced machine learning to deliver content gene',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-operational-for-construction-1d88fa02',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Operational for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Next-Gen Operational for Construction leverages advanced machine learning to deliver content generation at scale.
          </p>
