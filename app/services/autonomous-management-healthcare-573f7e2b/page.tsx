...
export const metadata: Metadata = {
  title: 'Autonomous management-healthcare',
  description: 'Transform your healthcare operations with our Autonomous management-healthcare. This AI-driven solution automates loyalty optimization with unprecedented accura',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-management-healthcare-573f7e2b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous management-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Autonomous management-healthcare. This AI-driven solution automates loyalty optimization with unprecedented accuracy and efficiency.
          </p>
