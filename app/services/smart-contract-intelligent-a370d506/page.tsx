...
export const metadata: Metadata = {
  title: 'Smart Contract Intelligent',
  description: 'Revolutionize energy through intelligent automation. Our Smart Contract Intelligent leverages advanced machine learning to deliver root cause analysis at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-contract-intelligent-a370d506',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Contract Intelligent
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Smart Contract Intelligent leverages advanced machine learning to deliver root cause analysis at scale.
          </p>
