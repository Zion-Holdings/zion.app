...
export const metadata: Metadata = {
  ...
  keywords: 'Auto-discovery of network assets, Compliance and licence tracking, Depreciation schedule engine, End-of-life automation, Audit-ready reporting, it, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Asset Lifecycle Manager</h1>
        <p className="text-lg text-slate-300 mb-8">Track hardware and software assets from procurement to disposal. Auto-discovery, compliance tracking, depreciation schedules, and end-of-life automation in one dashboard.</p>
        ...
        <li class="text-slate-300">Compliance and licence tracking</li>
        <li class="text-slate-300">Depreciation schedule engine</li>
        <li class="text-slate-300">End-of-life automation</li>
        <li class="text-slate-300">Audit-ready reporting</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with it asset lifecycle manager</li>
