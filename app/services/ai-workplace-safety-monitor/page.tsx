...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time PPE compliance detection, Fall & accident detection, Forklift/proximity zone alerts, OSHA compliance dashboard, Incident auto-reporting, Safety training gap analysis, security, Construction, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Workplace Safety &amp; Compliance Monitor</h1>
        <p className="text-lg text-slate-300 mb-8">Computer vision safety system: PPE compliance detection, fall detection, forklift proximity alerts, incident reporting. OSHA compliance built-in.</p>
        ...
        <li class="text-slate-300">Real-time PPE compliance detection</li>
        <li class="text-slate-300">Fall &amp; accident detection</li>
        <li class="text-slate-300">Forklift/proximity zone alerts</li>
        <li class="text-slate-300">OSHA compliance dashboard</li>
        <li class="text-slate-300">Incident auto-reporting</li>
        <li class="text-slate-300">Safety training gap analysis</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce injuries by 45%</li>
        <li class="text-slate-300">Ensure OSHA compliance 24/7</li>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">149/location</p>
              <p class="text-sm text-slate-400">Getting started plan</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              <h3 class="font-semibold text-white mb-2">Pro</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">349/location</p>
              <p class="text-sm text-slate-400">Most popular</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              <h3 class="font-semibold text-white mb-2">Enterprise</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">999/location</p>
