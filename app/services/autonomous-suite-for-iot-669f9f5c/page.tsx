...
export const metadata: Metadata = {
  title: 'Autonomous Suite for Iot',
  description: 'The future of iot is here with Autonomous Suite for Iot. Powered by cutting-edge AI, this platform delivers language processing like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-suite-for-iot-669f9f5c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Suite for Iot
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of iot is here with Autonomous Suite for Iot. Powered by cutting-edge AI, this platform delivers language processing like never before.
          </p>
