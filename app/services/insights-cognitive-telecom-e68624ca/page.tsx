...
export const metadata: Metadata = {
  title: 'Insights Cognitive - Telecom',
  description: 'Enhance your telecom business with Insights Cognitive - Telecom. Our solution provides campaign optimization with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/insights-cognitive-telecom-e68624ca',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Insights Cognitive - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your telecom business with Insights Cognitive - Telecom. Our solution provides campaign optimization with enterprise-grade reliability and security.
          </p>
