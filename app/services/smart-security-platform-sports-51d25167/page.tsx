...
export const metadata: Metadata = {
  title: 'Smart Security Platform - Sports',
  description: 'Optimize your sports workflows with Smart Security Platform - Sports. This intelligent platform delivers release management through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-security-platform-sports-51d25167',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Security Platform - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your sports workflows with Smart Security Platform - Sports. This intelligent platform delivers release management through advanced automation and AI.
          </p>
