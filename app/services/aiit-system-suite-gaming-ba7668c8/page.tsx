...
export const metadata: Metadata = {
  title: 'AI/IT System Suite - Gaming',
  description: 'Revolutionize gaming through intelligent automation. Our AI/IT System Suite - Gaming leverages advanced machine learning to deliver customer intelligence at sca',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-system-suite-gaming-ba7668c8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT System Suite - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize gaming through intelligent automation. Our AI/IT System Suite - Gaming leverages advanced machine learning to deliver customer intelligence at scale.
          </p>
