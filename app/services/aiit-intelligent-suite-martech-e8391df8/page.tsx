...
export const metadata: Metadata = {
  title: 'AI/IT Intelligent Suite - MARTECH',
  description: 'The future of martech is here with AI/IT Intelligent Suite - MARTECH. Powered by cutting-edge AI, this platform delivers audit automation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-intelligent-suite-martech-e8391df8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Intelligent Suite - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of martech is here with AI/IT Intelligent Suite - MARTECH. Powered by cutting-edge AI, this platform delivers audit automation like never before.
          </p>
