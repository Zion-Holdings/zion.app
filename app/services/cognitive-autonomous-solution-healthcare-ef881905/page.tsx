...
export const metadata: Metadata = {
  title: 'Cognitive Autonomous Solution - Healthcare',
  description: 'The future of healthcare is here with Cognitive Autonomous Solution - Healthcare. Powered by cutting-edge AI, this platform delivers lead scoring like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-autonomous-solution-healthcare-ef881905',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Autonomous Solution - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Cognitive Autonomous Solution - Healthcare. Powered by cutting-edge AI, this platform delivers lead scoring like never before.
          </p>
