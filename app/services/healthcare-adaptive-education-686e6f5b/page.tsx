...
export const metadata: Metadata = {
  title: 'Healthcare Adaptive - Education',
  description: 'Transform your education operations with our Healthcare Adaptive - Education. This AI-driven solution automates feedback collection with unprecedented accuracy ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/healthcare-adaptive-education-686e6f5b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Healthcare Adaptive - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your education operations with our Healthcare Adaptive - Education. This AI-driven solution automates feedback collection with unprecedented accuracy and efficiency.
          </p>
