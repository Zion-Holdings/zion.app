...
export const metadata: Metadata = {
  ...
  keywords: '30+ data sources, Sentiment scoring (-100 to +100), Crisis detection, Influencer identification, Competitor benchmark, ai, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Social Sentiment Tracker</h1>
        <p className="text-lg text-slate-300 mb-8">Monitor brand sentiment across Twitter, Reddit, news, forums in real-time. Crisis detection alerts before issues go viral.</p>
        ...
        <li class="text-slate-300">30+ data sources</li>
        <li class="text-slate-300">Sentiment scoring (-100 to +100)</li>
        <li class="text-slate-300">Crisis detection</li>
        <li class="text-slate-300">Influencer identification</li>
        <li class="text-slate-300">Competitor benchmark</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with social sentiment tracker</li>
