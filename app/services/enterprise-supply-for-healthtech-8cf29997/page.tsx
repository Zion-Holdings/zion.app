...
export const metadata: Metadata = {
  title: 'Enterprise Supply for HEALTHTECH',
  description: 'Quantum leap forward for healthtech: Enterprise Supply for HEALTHTECH. Uses quantum-inspired algorithms to deliver performance reviews at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-supply-for-healthtech-8cf29997',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Supply for HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for healthtech: Enterprise Supply for HEALTHTECH. Uses quantum-inspired algorithms to deliver performance reviews at exponential speed.
          </p>
