...
export const metadata: Metadata = {
  title: 'Enterprise Manager Platform - REGTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Manager Platform - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of regtech is here with Enterprise Manager Platform - REGTECH. Powered by cutting-edge AI, this platform delivers churn prediction like never before.
          </p>
