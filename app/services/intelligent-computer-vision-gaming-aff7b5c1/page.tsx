...
export const metadata: Metadata = {
  title: 'Intelligent computer vision-gaming',
  description: 'Enhance your gaming business with Intelligent computer vision-gaming. Our solution provides customer journey mapping with enterprise-grade reliability and secur',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent computer vision-gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your gaming business with Intelligent computer vision-gaming. Our solution provides customer journey mapping with enterprise-grade reliability and security.
          </p>
