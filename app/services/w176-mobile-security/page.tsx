...
export const metadata: Metadata = {
  ...
  keywords: 'Mobile SAST (iOS Swift, Android Kotlin/Java), Mobile DAST with device farm testing, Code obfuscation and anti-tampering, Runtime protection (RASP), API security testing for mobile backends, App store compliance review, Integration with Nowsecure, Appdome, Guardsquare, security, Mobile Security, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Mobile Application Security</h1>
        <p className="text-lg text-slate-300 mb-8">Mobile app security testing and protection: SAST, DAST, code obfuscation, runtime protection, and app store compliance for iOS and Android.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">security</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">Mobile Security</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Mobile SAST (iOS Swift, Android Kotlin/Java)</li>
        <li class="text-slate-300">Mobile DAST with device farm testing</li>
        <li class="text-slate-300">Code obfuscation and anti-tampering</li>
        <li class="text-slate-300">Runtime protection (RASP)</li>
        <li class="text-slate-300">API security testing for mobile backends</li>
        <li class="text-slate-300">App store compliance review</li>
        <li class="text-slate-300">Integration with Nowsecure, Appdome, Guardsquare</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Find mobile vulnerabilities before release</li>
        <li class="text-slate-300">Runtime protection defends in production</li>
        <li class="text-slate-300">Anti-tampering prevents reverse engineering</li>
        <li class="text-slate-300">App store compliance prevents rejection</li>
      </ul>
        </div>
