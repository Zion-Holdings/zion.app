...
export const metadata: Metadata = {
  title: 'Smart NLP Platform - Insurance',
  description: 'Next-generation insurance solution: Smart NLP Platform - Insurance. Combines vendor management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-nlp-platform-insurance-6661fedb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart NLP Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Smart NLP Platform - Insurance. Combines vendor management with adaptive intelligence for optimal results.
          </p>
