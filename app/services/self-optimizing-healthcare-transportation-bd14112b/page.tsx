...
export const metadata: Metadata = {
  title: 'Self-Optimizing healthcare-transportation',
  description: 'The future of transportation is here with Self-Optimizing healthcare-transportation. Powered by cutting-edge AI, this platform delivers campaign optimization li',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing healthcare-transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Self-Optimizing healthcare-transportation. Powered by cutting-edge AI, this platform delivers campaign optimization like never before.
          </p>
