...
export const metadata: Metadata = {
  title: 'Enterprise Performance Platform - TECHNOLOGY',
  description: 'Quantum leap forward for technology: Enterprise Performance Platform - TECHNOLOGY. Uses quantum-inspired algorithms to deliver social media monitoring at expone',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Performance Platform - TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for technology: Enterprise Performance Platform - TECHNOLOGY. Uses quantum-inspired algorithms to deliver social media monitoring at exponential speed.
          </p>
