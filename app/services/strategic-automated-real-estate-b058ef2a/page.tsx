...
export const metadata: Metadata = {
  title: 'Strategic Automated - Real-Estate',
  description: 'Enhance your real-estate business with Strategic Automated - Real-Estate. Our solution provides benefits administration with enterprise-grade reliability and se',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/strategic-automated-real-estate-b058ef2a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Strategic Automated - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your real-estate business with Strategic Automated - Real-Estate. Our solution provides benefits administration with enterprise-grade reliability and security.
          </p>
