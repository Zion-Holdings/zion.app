...
export const metadata: Metadata = {
  ...
  keywords: 'Plugin architecture, Serverless functions, Custom integrations, SOC 2 certified, management, construction, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Powered platform-construction</h1>
        <p className="text-lg text-slate-300 mb-8">Revolutionize construction through intelligent automation. Our AI-Powered platform-construction leverages advanced machine learning to deliver workflow management at scale.</p>
