...
export const metadata: Metadata = {
  title: 'AI/IT Employee Suite - Telecom',
  description: 'Unlock unprecedented growth with AI/IT Employee Suite - Telecom. This autonomous system provides predictive modeling with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-employee-suite-telecom-f38ab4af',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Employee Suite - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with AI/IT Employee Suite - Telecom. This autonomous system provides predictive modeling with zero manual intervention needed.
          </p>
