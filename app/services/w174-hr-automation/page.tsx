...
export const metadata: Metadata = {
  ...
  keywords: 'Employee onboarding workflows, Offboarding and knowledge transfer automation, Time tracking and schedule management, Benefits enrollment and change automation, Performance review cycles and 360 feedback, Compliance reporting (EEO-1, ACA, VETS-4212), Integration with Workday, BambooHR, Rippling, ADP, automation, Human Resources, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">HR Process Automation Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Automate HR processes: onboarding, offboarding, time tracking, benefits enrollment, performance reviews, and compliance reporting.</p>
        ...
        <li class="text-slate-300">Employee onboarding workflows</li>
        <li class="text-slate-300">Offboarding and knowledge transfer automation</li>
        <li class="text-slate-300">Time tracking and schedule management</li>
        <li class="text-slate-300">Benefits enrollment and change automation</li>
        <li class="text-slate-300">Performance review cycles and 360 feedback</li>
        <li class="text-slate-300">Compliance reporting (EEO-1, ACA, VETS-4212)</li>
        <li class="text-slate-300">Integration with Workday, BambooHR, Rippling, ADP</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Onboarding in hours, not days</li>
        <li class="text-slate-300">Offboarding ensures complete deprovisioning</li>
        <li class="text-slate-300">Compliance reporting automated</li>
        <li class="text-slate-300">Performance reviews on schedule, every cycle</li>
      </ul>
        </div>
