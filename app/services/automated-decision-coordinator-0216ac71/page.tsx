...
export const metadata: Metadata = {
  title: 'Automated Decision Coordinator',
  description: 'Revolutionize edge through intelligent automation. Our Automated Decision Coordinator leverages advanced machine learning to deliver compliance monitoring at sc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-decision-coordinator-0216ac71',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Decision Coordinator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize edge through intelligent automation. Our Automated Decision Coordinator leverages advanced machine learning to deliver compliance monitoring at scale.
          </p>
