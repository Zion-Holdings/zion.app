...
export const metadata: Metadata = {
  title: 'Neural Intelligence for Legal',
  description: 'Transform your legal operations with our Neural Intelligence for Legal. This AI-driven solution automates data processing with unprecedented accuracy and effici',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-intelligence-for-legal-9d0fbd40',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Intelligence for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Neural Intelligence for Legal. This AI-driven solution automates data processing with unprecedented accuracy and efficiency.
          </p>
