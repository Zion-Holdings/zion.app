...
export const metadata: Metadata = {
  title: 'Security AI - Media',
  description: 'Revolutionize media through intelligent automation. Our Security AI - Media leverages advanced machine learning to deliver enterprise-grade insights at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-ai-media-f1265ac0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize media through intelligent automation. Our Security AI - Media leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
