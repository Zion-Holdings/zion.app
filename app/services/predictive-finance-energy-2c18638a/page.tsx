...
export const metadata: Metadata = {
  title: 'Predictive finance-energy',
  description: 'The future of energy is here with Predictive finance-energy. Powered by cutting-edge AI, this platform delivers transformative results like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-finance-energy-2c18638a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive finance-energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Predictive finance-energy. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
