...
export const metadata: Metadata = {
  title: 'Adaptive compliance-proptech',
  description: 'Revolutionize proptech through intelligent automation. Our Adaptive compliance-proptech leverages advanced machine learning to deliver customer retention at sca',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-compliance-proptech-3a81e286',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive compliance-proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our Adaptive compliance-proptech leverages advanced machine learning to deliver customer retention at scale.
          </p>
