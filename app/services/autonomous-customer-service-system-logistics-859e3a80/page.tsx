...
export const metadata: Metadata = {
  ...
  description: 'Enhance your logistics business with Autonomous Customer Service System - Logistics. Our solution provides workflow management with enterprise-grade reliability',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with Autonomous Customer Service System - Logistics. Our solution provides workflow management with enterprise-grade reliability and security.
          </p>
