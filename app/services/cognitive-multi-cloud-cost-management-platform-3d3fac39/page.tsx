...
export const metadata: Metadata = {
  title: 'Cognitive Multi-Cloud Cost Management Platform',
  description: 'cognitive solution for manufacturing industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-multi-cloud-cost-management-platform-3d3fac39',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Multi-Cloud Cost Management Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            cognitive solution for manufacturing industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.
          </p>
