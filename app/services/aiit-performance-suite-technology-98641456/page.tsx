...
export const metadata: Metadata = {
  title: 'AI/IT Performance Suite - TECHNOLOGY',
  description: 'The future of technology is here with AI/IT Performance Suite - TECHNOLOGY. Powered by cutting-edge AI, this platform delivers predictive analytics like never b',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-performance-suite-technology-98641456',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Performance Suite - TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of technology is here with AI/IT Performance Suite - TECHNOLOGY. Powered by cutting-edge AI, this platform delivers predictive analytics like never before.
          </p>
