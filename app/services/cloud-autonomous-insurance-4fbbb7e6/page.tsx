...
export const metadata: Metadata = {
  title: 'Cloud Autonomous - Insurance',
  description: 'The future of insurance is here with Cloud Autonomous - Insurance. Powered by cutting-edge AI, this platform delivers root cause analysis like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cloud-autonomous-insurance-4fbbb7e6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cloud Autonomous - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Cloud Autonomous - Insurance. Powered by cutting-edge AI, this platform delivers root cause analysis like never before.
          </p>
