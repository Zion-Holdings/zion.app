...
export const metadata: Metadata = {
  title: 'Adaptive orchestrator-hospitality',
  description: 'The future of hospitality is here with Adaptive orchestrator-hospitality. Powered by cutting-edge AI, this platform delivers decision support like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-orchestrator-hospitality-afa6c22a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive orchestrator-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Adaptive orchestrator-hospitality. Powered by cutting-edge AI, this platform delivers decision support like never before.
          </p>
