...
export const metadata: Metadata = {
  title: 'Engine Autonomous - Iot',
  description: 'Revolutionize iot through intelligent automation. Our Engine Autonomous - Iot leverages advanced machine learning to deliver decision support at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/engine-autonomous---iot-37ddce8a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Engine Autonomous - Iot
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize iot through intelligent automation. Our Engine Autonomous - Iot leverages advanced machine learning to deliver decision support at scale.
          </p>
