...
export const metadata: Metadata = {
  title: 'Cognitive Coordinator Solution - PROPTECH',
  description: 'Unlock unprecedented growth with Cognitive Coordinator Solution - PROPTECH. This autonomous system provides vendor management with zero manual intervention need',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-coordinator-solution-proptech-82c7cb73',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Coordinator Solution - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Cognitive Coordinator Solution - PROPTECH. This autonomous system provides vendor management with zero manual intervention needed.
          </p>
