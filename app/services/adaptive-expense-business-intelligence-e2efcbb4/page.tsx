...
export const metadata: Metadata = {
  title: 'Adaptive Expense Business Intelligence',
  description: 'Revolutionize real-estate through intelligent automation. Our Adaptive Expense Business Intelligence leverages advanced machine learning to deliver cost reducti',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Expense Business Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our Adaptive Expense Business Intelligence leverages advanced machine learning to deliver cost reduction at scale.
          </p>
