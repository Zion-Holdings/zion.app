...
export const metadata = {
  ...
  description: "Automated disaster recovery for cloud and hybrid environments. Continuous replication, automated failover, and regular DR testing. RPO under 15 minutes, RTO und",
  alternates: {
