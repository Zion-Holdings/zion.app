...
export const metadata: Metadata = {
  title: 'Automated real estate-agritech',
  description: 'The future of agritech is here with Automated real estate-agritech. Powered by cutting-edge AI, this platform delivers threat detection like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-real-estate-agritech-236ebab8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated real estate-agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agritech is here with Automated real estate-agritech. Powered by cutting-edge AI, this platform delivers threat detection like never before.
          </p>
