...
export const metadata: Metadata = {
  title: 'Intelligent Cloud for Real-Estate',
  description: 'Unlock unprecedented growth with Intelligent Cloud for Real-Estate. This autonomous system provides testing automation with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-cloud-for-real-estate-4adc9641',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Cloud for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Cloud for Real-Estate. This autonomous system provides testing automation with zero manual intervention needed.
          </p>
