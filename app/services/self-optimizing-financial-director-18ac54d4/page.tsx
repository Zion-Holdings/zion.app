...
export const metadata: Metadata = {
  title: 'Self-Optimizing Financial Director',
  description: 'Next-generation proptech solution: Self-Optimizing Financial Director. Combines market intelligence with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/self-optimizing-financial-director-18ac54d4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Financial Director
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation proptech solution: Self-Optimizing Financial Director. Combines market intelligence with adaptive intelligence for optimal results.
          </p>
