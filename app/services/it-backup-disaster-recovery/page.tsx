...
export const metadata: Metadata = {
  ...
  keywords: 'Image-level block/snapshot incremental backup, Continuous replication RPO sub-15 min, One-click bare-metal restore = confirmed drill, Test-restore sandbox per schedule, no production impact, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Backup &amp; Disaster Recovery Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Image-level backup (filesystem/DB/bare-metal), continuous replication with RPO sub-15 min, one-click full restore drill per server.</p>
        ...
        <li class="text-slate-300">Image-level block/snapshot incremental backup</li>
        <li class="text-slate-300">Continuous replication RPO sub-15 min</li>
        <li class="text-slate-300">One-click bare-metal restore = confirmed drill</li>
        <li class="text-slate-300">Test-restore sandbox per schedule, no production impact</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with backup &amp; disaster recovery platform</li>
