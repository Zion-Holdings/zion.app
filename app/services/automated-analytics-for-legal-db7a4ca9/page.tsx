...
export const metadata: Metadata = {
  title: 'Automated Analytics for Legal',
  description: 'Optimize your legal workflows with Automated Analytics for Legal. This intelligent platform delivers container orchestration through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-analytics-for-legal-db7a4ca9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Analytics for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with Automated Analytics for Legal. This intelligent platform delivers container orchestration through advanced automation and AI.
          </p>
