...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-email sequence generation, Personalization tokens, Subject line A/B testing, Send-time optimization, Deliverability monitoring, ai, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Email Campaign Generator</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end email marketing: Generate sequences, personalize per recipient, A/B test subject lines, optimize send times.</p>
        ...
        <li class="text-slate-300">Multi-email sequence generation</li>
        <li class="text-slate-300">Personalization tokens</li>
        <li class="text-slate-300">Subject line A/B testing</li>
        <li class="text-slate-300">Send-time optimization</li>
        <li class="text-slate-300">Deliverability monitoring</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with email campaign generator</li>
