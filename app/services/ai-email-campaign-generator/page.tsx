      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            End-to-end email marketing: Generate sequences, personalize per recipient, A/B test subject lines, optimize send times.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Multi-email sequence generation</li>
            <li className="text-purple-300">✓ Personalization tokens</li>
            <li className="text-purple-300">✓ Subject line A/B testing</li>
            <li className="text-purple-300">✓ Send-time optimization</li>
            <li className="text-purple-300">✓ Deliverability monitoring</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with email campaign generator</li>
