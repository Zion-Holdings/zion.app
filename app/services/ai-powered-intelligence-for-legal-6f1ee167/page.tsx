...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-language support, Open-source friendly, Alerting system, Machine learning integration, Offline capabilities, Custom integrations, predictor, legal, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Powered Intelligence for Legal</h1>
        <p className="text-lg text-slate-300 mb-8">Transform your legal operations with our AI-Powered Intelligence for Legal. This AI-driven solution automates security monitoring with unprecedented accuracy and efficiency.</p>
