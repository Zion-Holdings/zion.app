...
export const metadata: Metadata = {
  title: 'AI Employee - CLEANTECH Edition',
  description: 'The future of cleantech is here with AI Employee - CLEANTECH Edition. Powered by cutting-edge AI, this platform delivers model interpretability like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-employee-cleantech-edition-bc5e7e00',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Employee - CLEANTECH Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of cleantech is here with AI Employee - CLEANTECH Edition. Powered by cutting-edge AI, this platform delivers model interpretability like never before.
          </p>
