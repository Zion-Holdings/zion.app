...
export const metadata: Metadata = {
  title: 'Enterprise Social - Retail',
  description: 'Transform retail with Enterprise Social - Retail - the intelligent automation platform that learns, adapts, and delivers 10x results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-social-retail-b05d3983',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Social - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform retail with Enterprise Social - Retail - the intelligent automation platform that learns, adapts, and delivers 10x results.
          </p>
