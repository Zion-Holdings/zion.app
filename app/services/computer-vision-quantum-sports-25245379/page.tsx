...
export const metadata: Metadata = {
  title: 'Computer Vision Quantum - Sports',
  description: 'Drive innovation in sports with Computer Vision Quantum - Sports. This AI-powered platform transforms data processing into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/computer-vision-quantum-sports-25245379',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Computer Vision Quantum - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in sports with Computer Vision Quantum - Sports. This AI-powered platform transforms data processing into a competitive advantage.
          </p>
