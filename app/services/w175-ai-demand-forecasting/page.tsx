...
export const metadata: Metadata = {
  ...
  keywords: 'SKU-level demand forecasting, Promotion and event lift modeling, Weather and external factor integration, New product forecasting (cold start), Forecast accuracy tracking and bias correction, Scenario planning and what-if analysis, Integration with SAP IBP, Kinaxis, Anaplan, ai, Retail, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Demand Forecasting Platform</h1>
        <p className="text-lg text-slate-300 mb-8">ML demand forecasting for retail, CPG, and food: SKU-level predictions, promotion lift, weather impact, and new product forecasting. Reduce forecast error by 40%.</p>
        ...
        <li class="text-slate-300">Promotion and event lift modeling</li>
        <li class="text-slate-300">Weather and external factor integration</li>
        <li class="text-slate-300">New product forecasting (cold start)</li>
        <li class="text-slate-300">Forecast accuracy tracking and bias correction</li>
        <li class="text-slate-300">Scenario planning and what-if analysis</li>
        <li class="text-slate-300">Integration with SAP IBP, Kinaxis, Anaplan</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce forecast error by 40%</li>
        <li class="text-slate-300">SKU-level predictions prevent stockouts</li>
        <li class="text-slate-300">Promotion lift modeling improves ROI</li>
        <li class="text-slate-300">New product forecasting for launches</li>
      </ul>
        </div>
