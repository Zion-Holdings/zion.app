...
export const metadata: Metadata = {
  title: 'Healthcare Predictive - Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Healthcare Predictive - Hospitality leverages advanced machine learning to deliver enterprise-grad',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/healthcare-predictive-hospitality-114ac253',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Healthcare Predictive - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Healthcare Predictive - Hospitality leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
