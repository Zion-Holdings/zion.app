...
export const metadata: Metadata = {
  title: 'Quantum orchestrator-healthcare',
  description: 'Drive innovation in healthcare with Quantum orchestrator-healthcare. This AI-powered platform transforms user experience into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-orchestrator-healthcare-0be38cfa',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum orchestrator-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with Quantum orchestrator-healthcare. This AI-powered platform transforms user experience into a competitive advantage.
          </p>
