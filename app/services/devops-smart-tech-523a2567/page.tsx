...
export const metadata: Metadata = {
  title: 'DevOps Smart - Tech',
  description: 'Revolutionize technology through intelligent automation. Our DevOps Smart - Tech leverages advanced machine learning to deliver enterprise-grade insights at sca',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/devops-smart-tech-523a2567',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our DevOps Smart - Tech leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
