...
export const metadata: Metadata = {
  title: 'Intelligence Adaptive - Logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Intelligence Adaptive - Logistics leverages advanced machine learning to deliver enterprise-grade in',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligence-adaptive-logistics-d4c7273b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligence Adaptive - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Intelligence Adaptive - Logistics leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
