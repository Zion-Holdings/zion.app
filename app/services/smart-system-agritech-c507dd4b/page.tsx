...
export const metadata: Metadata = {
  title: 'Smart system-agritech',
  description: 'Revolutionize agritech through intelligent automation. Our Smart system-agritech leverages advanced machine learning to deliver inventory management at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-system-agritech-c507dd4b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart system-agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agritech through intelligent automation. Our Smart system-agritech leverages advanced machine learning to deliver inventory management at scale.
          </p>
