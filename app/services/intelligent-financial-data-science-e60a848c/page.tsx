...
export const metadata: Metadata = {
  title: 'Intelligent Financial Data Science',
  description: 'Next-generation logistics solution: Intelligent Financial Data Science. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-financial-data-science-e60a848c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Financial Data Science
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Intelligent Financial Data Science. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
