...
export const metadata: Metadata = {
  ...
  keywords: 'OKR creation and cascading, Progress tracking with confidence ratings, Weekly check-in prompts and updates, Retrospective and scoring, Visibility across organization, Integration with Slack, Jira, Asana, Historical trend and benchmarking, micro-saas, Productivity, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">ProgressBoard — OKR Tracking</h1>
        <p className="text-lg text-slate-300 mb-8">OKR tracking: cascading goals, progress visibility, retrospective insights. Keep teams aligned.</p>
        ...
        <li class="text-slate-300">OKR creation and cascading</li>
        <li class="text-slate-300">Progress tracking with confidence ratings</li>
        <li class="text-slate-300">Weekly check-in prompts and updates</li>
        <li class="text-slate-300">Retrospective and scoring</li>
        <li class="text-slate-300">Visibility across organization</li>
        <li class="text-slate-300">Integration with Slack</li>
        <li class="text-slate-300">Jira</li>
        <li class="text-slate-300">Asana</li>
        <li class="text-slate-300">Historical trend and benchmarking</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Cascading OKRs align teams to strategy</li>
        <li class="text-slate-300">Visibility across organization</li>
        <li class="text-slate-300">Weekly check-ins prevent drift</li>
        <li class="text-slate-300">Retrospectives drive continuous improvement</li>
      </ul>
        </div>
