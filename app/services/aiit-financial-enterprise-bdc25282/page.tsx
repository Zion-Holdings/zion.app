...
export const metadata: Metadata = {
  title: 'AI/IT Financial Enterprise',
  description: 'Revolutionize transportation through intelligent automation. Our AI/IT Financial Enterprise leverages advanced machine learning to deliver personalization engin',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Financial Enterprise
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize transportation through intelligent automation. Our AI/IT Financial Enterprise leverages advanced machine learning to deliver personalization engine at scale.
          </p>
