...
export const metadata: Metadata = {
  title: 'Intelligent insights-agritech',
  description: 'Unlock unprecedented growth with Intelligent insights-agritech. This autonomous system provides financial planning with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-insights-agritech-6faa84c6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent insights-agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent insights-agritech. This autonomous system provides financial planning with zero manual intervention needed.
          </p>
