...
export const metadata: Metadata = {
  title: 'Intelligent Data for Energy #2',
  description: 'Revolutionize energy through intelligent automation. Our Intelligent Data for Energy #2 leverages advanced machine learning to deliver customer onboarding at sc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-data-for-energy-2-f682ad2e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Data for Energy #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Intelligent Data for Energy #2 leverages advanced machine learning to deliver customer onboarding at scale.
          </p>
