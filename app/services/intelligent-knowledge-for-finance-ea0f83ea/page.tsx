...
export const metadata: Metadata = {
  title: 'Intelligent Knowledge for Finance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Knowledge for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated finance solution: Intelligent Knowledge for Finance. Combines invoice automation with next-gen AI for maximum velocity.
          </p>
