...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Data Science - Legal',
  description: 'Drive innovation in legal with Hyper-Accelerated Data Science - Legal. This AI-powered platform transforms time tracking into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/hyper-accelerated-data-science-legal-fc6cebd5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Data Science - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Hyper-Accelerated Data Science - Legal. This AI-powered platform transforms time tracking into a competitive advantage.
          </p>
