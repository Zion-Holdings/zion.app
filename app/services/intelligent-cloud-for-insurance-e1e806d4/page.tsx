...
export const metadata: Metadata = {
  title: 'Intelligent Cloud for Insurance',
  description: 'The future of insurance is here with Intelligent Cloud for Insurance. Powered by cutting-edge AI, this platform delivers maintenance scheduling like never befor',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Cloud for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Intelligent Cloud for Insurance. Powered by cutting-edge AI, this platform delivers maintenance scheduling like never before.
          </p>
