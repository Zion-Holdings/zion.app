...
export const metadata: Metadata = {
  title: 'AI Cloud - Cleantech Edition',
  description: 'Revolutionize cleantech through intelligent automation. Our AI Cloud - Cleantech Edition leverages advanced machine learning to deliver image recognition at sca',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-cloud---cleantech-edition-de02eb8b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Cloud - Cleantech Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cleantech through intelligent automation. Our AI Cloud - Cleantech Edition leverages advanced machine learning to deliver image recognition at scale.
          </p>
