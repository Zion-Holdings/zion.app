...
export const metadata: Metadata = {
  title: 'Neural Budget Engine',
  description: 'Optimize your real-estate workflows with Neural Budget Engine. This intelligent platform delivers logistics route optimization through advanced automation and A',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Budget Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your real-estate workflows with Neural Budget Engine. This intelligent platform delivers logistics route optimization through advanced automation and AI.
          </p>
