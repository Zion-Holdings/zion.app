...
export const metadata: Metadata = {
  title: 'Adaptive Healthcare for Blockchain',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Healthcare for Blockchain
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation blockchain solution: Adaptive Healthcare for Blockchain. Combines customer service automation with adaptive intelligence for optimal results.
          </p>
