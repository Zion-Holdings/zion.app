...
export const metadata: Metadata = {
  title: 'Autonomous Experience System - Construction',
  description: 'Hyper-accelerated construction solution: Autonomous Experience System - Construction. Combines customer intelligence with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-experience-system-construction-05082b35',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Experience System - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated construction solution: Autonomous Experience System - Construction. Combines customer intelligence with next-gen AI for maximum velocity.
          </p>
