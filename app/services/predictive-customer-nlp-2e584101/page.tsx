...
export const metadata: Metadata = {
  title: 'Predictive Customer NLP',
  description: 'Revolutionize legal through intelligent automation. Our Predictive Customer NLP leverages advanced machine learning to deliver enterprise-grade insights at scal',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Customer NLP
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Predictive Customer NLP leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
