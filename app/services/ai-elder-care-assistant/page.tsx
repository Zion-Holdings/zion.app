...
export const metadata: Metadata = {
  ...
  keywords: 'Fall detection with 99% accuracy, Medication adherence tracking, Vitals monitoring (HR, BP, SpO2), Emergency response auto-dispatch, Family caregiver dashboard, HIPAA-compliant data handling, ai, Healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Elder Care Monitoring &amp; Alert Platform</h1>
        <p className="text-lg text-slate-300 mb-8">IoT + AI for independent seniors: fall detection, medication reminders, vitals monitoring, emergency response, and family alerts. HIPAA-compliant with 24/7 monitoring.</p>
        ...
        <li class="text-slate-300">Fall detection with 99% accuracy</li>
        <li class="text-slate-300">Medication adherence tracking</li>
        <li class="text-slate-300">Vitals monitoring (HR, BP, SpO2)</li>
        <li class="text-slate-300">Emergency response auto-dispatch</li>
        <li class="text-slate-300">Family caregiver dashboard</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Detect falls in seconds</li>
        <li class="text-slate-300">Reduce hospitalizations by 35%</li>
        <li class="text-slate-300">Family peace of mind</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">49/resident</p>
              <p class="text-sm text-slate-400">Getting started plan</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              <h3 class="font-semibold text-white mb-2">Pro</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">99/resident</p>
              <p class="text-sm text-slate-400">Most popular</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              <h3 class="font-semibold text-white mb-2">Enterprise</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">199/resident</p>
