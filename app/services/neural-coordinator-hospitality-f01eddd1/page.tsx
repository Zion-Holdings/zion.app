    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        ...
        <p className="text-xl text-slate-300 mb-8">
          Revolutionize hospitality through intelligent automation. Our Neural coordinator-hospitality leverages advanced machine learning to deliver customer insights at
        </p>
