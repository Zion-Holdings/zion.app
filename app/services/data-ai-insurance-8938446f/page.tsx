      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Data AI - Insurance. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
