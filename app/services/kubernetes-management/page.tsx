...
export const metadata: Metadata = {
  ...
  keywords: 'Cluster design and deployment, Auto-scaling configuration, Service mesh implementation, CI/CD pipeline integration, Cost optimization and rightsizing, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Expert Kubernetes deployment, scaling, monitoring, and optimization for containerized applications with GitOps-driven workflows.</p>
        ...
        <li class="text-slate-300">Cluster design and deployment</li>
        <li class="text-slate-300">Auto-scaling configuration</li>
        <li class="text-slate-300">Service mesh implementation</li>
        <li class="text-slate-300">CI/CD pipeline integration</li>
        <li class="text-slate-300">Cost optimization and rightsizing</li>
      </ul>
        </div>
