...
export const metadata: Metadata = {
  title: 'Cognitive Feature Analytics',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Cognitive Feature Analytics. Combines net promoter score with adaptive intelligence for optimal results.
          </p>
