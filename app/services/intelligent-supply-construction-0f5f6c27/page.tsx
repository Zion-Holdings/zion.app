...
export const metadata: Metadata = {
  title: 'Intelligent supply-construction',
  description: 'Transform your construction operations with our Intelligent supply-construction. This AI-driven solution provides intelligent automation with unprecedented accu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent supply-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Intelligent supply-construction. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
