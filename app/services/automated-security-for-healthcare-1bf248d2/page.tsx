...
export const metadata: Metadata = {
  title: 'Automated Security for Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Automated Security for Healthcare leverages advanced machine learning to deliver network optimizati',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-security-for-healthcare-1bf248d2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Security for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Automated Security for Healthcare leverages advanced machine learning to deliver network optimization at scale.
          </p>
