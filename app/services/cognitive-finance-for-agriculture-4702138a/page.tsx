...
export const metadata: Metadata = {
  title: 'Cognitive Finance for Agriculture',
  description: 'The future of agriculture is here with Cognitive Finance for Agriculture. Powered by cutting-edge AI, this platform delivers financial risk management like neve',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-finance-for-agriculture-4702138a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Finance for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Cognitive Finance for Agriculture. Powered by cutting-edge AI, this platform delivers financial risk management like never before.
          </p>
