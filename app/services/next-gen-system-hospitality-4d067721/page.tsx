...
export const metadata: Metadata = {
  title: 'Next-Gen System - Hospitality',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen System - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Next-Gen System - Hospitality. Combines data quality with adaptive intelligence for optimal results.
          </p>
