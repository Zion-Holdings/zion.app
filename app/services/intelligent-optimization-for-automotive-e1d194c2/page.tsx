...
export const metadata: Metadata = {
  ...
  description: 'Optimize your automotive workflows with Intelligent Optimization for Automotive. This intelligent platform delivers personalization engine through advanced auto',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your automotive workflows with Intelligent Optimization for Automotive. This intelligent platform delivers personalization engine through advanced automation and AI.
          </p>
