...
export const metadata: Metadata = {
  title: 'Autonomous Data System - FINTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Data System - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your fintech operations with our Autonomous Data System - FINTECH. This AI-driven solution automates event-driven architecture with unprecedented accuracy and efficiency.
          </p>
