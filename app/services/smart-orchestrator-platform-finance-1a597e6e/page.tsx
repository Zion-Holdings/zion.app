...
export const metadata: Metadata = {
  title: 'Smart Orchestrator Platform - Finance',
  description: 'Drive innovation in finance with Smart Orchestrator Platform - Finance. This AI-powered platform transforms user experience into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-orchestrator-platform-finance-1a597e6e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Orchestrator Platform - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in finance with Smart Orchestrator Platform - Finance. This AI-powered platform transforms user experience into a competitive advantage.
          </p>
