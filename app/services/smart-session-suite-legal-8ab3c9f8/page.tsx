...
export const metadata: Metadata = {
  title: 'Smart Session Suite - Legal',
  description: 'Revolutionize legal through intelligent automation. Our Smart Session Suite - Legal leverages advanced machine learning to deliver usage analytics at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-session-suite-legal-8ab3c9f8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Session Suite - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Smart Session Suite - Legal leverages advanced machine learning to deliver usage analytics at scale.
          </p>
