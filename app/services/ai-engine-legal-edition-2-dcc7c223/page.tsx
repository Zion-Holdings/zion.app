...
export const metadata: Metadata = {
  title: 'AI Engine - Legal Edition #2',
  description: 'Transform your legal operations with our AI Engine - Legal Edition #2. This AI-driven solution automates fraud prevention with unprecedented accuracy and effici',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Engine - Legal Edition #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our AI Engine - Legal Edition #2. This AI-driven solution automates fraud prevention with unprecedented accuracy and efficiency.
          </p>
