...
export const metadata: Metadata = {
  title: 'Predictive Manager Engine - Energy',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Manager Engine - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Predictive Manager Engine - Energy. This AI-driven solution automates pricing optimization with unprecedented accuracy and efficiency.
          </p>
