...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-language support, SOC 2 certified, Audit trails, Container orchestration, engine, hospitality, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cognitive Financial Analytics</h1>
        <p className="text-lg text-slate-300 mb-8">The future of hospitality is here with Cognitive Financial Analytics. Powered by cutting-edge AI, this platform delivers process automation like never before.</p>
