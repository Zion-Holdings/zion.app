...
export const metadata: Metadata = {
  title: 'Predictive Insights for Construction',
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-insights-for-construction-c60897da',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Predictive Insights for Construction. Combines code optimization with adaptive intelligence for optimal results.
          </p>
