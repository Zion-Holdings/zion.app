...
export const metadata: Metadata = {
  title: 'Forecasting AI Customer Churn Prediction',
  description: 'forecasting solution for petrochemicals industry. Identifies at-risk customers before they churn using behavioral patterns and engagement metrics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/forecasting-ai-customer-churn-prediction-1d1ac34f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Forecasting AI Customer Churn Prediction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            forecasting solution for petrochemicals industry. Identifies at-risk customers before they churn using behavioral patterns and engagement metrics.
          </p>
