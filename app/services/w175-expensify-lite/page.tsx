...
export const metadata: Metadata = {
  ...
  keywords: 'Receipt OCR scanning and data extraction, AI auto-categorization of expenses, Mileage tracking with GPS, Multi-level approval workflows, Corporate card reconciliation, Reimbursement to bank account, QuickBooks, Xero, NetSuite integration, micro-saas, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">ExpenseLite — Expense Management</h1>
        <p className="text-lg text-slate-300 mb-8">Simple expense management: receipt scanning, auto-categorization, approval flows, and reimbursement. Built for small and mid-size teams.</p>
        ...
        <li class="text-slate-300">Receipt OCR scanning and data extraction</li>
        <li class="text-slate-300">AI auto-categorization of expenses</li>
        <li class="text-slate-300">Mileage tracking with GPS</li>
        <li class="text-slate-300">Multi-level approval workflows</li>
        <li class="text-slate-300">Corporate card reconciliation</li>
        <li class="text-slate-300">Reimbursement to bank account</li>
        <li class="text-slate-300">QuickBooks, Xero, NetSuite integration</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Receipt scanning eliminates manual entry</li>
        <li class="text-slate-300">AI categorization saves 80% of time</li>
        <li class="text-slate-300">Approval flows enforce policy</li>
        <li class="text-slate-300">Reimbursement automated, not manual</li>
      </ul>
        </div>
