export const metadata = {
  title: "Smart Sales Platform - Transportation",
  description: "Zion Tech Group delivers Smart Sales Platform - Transportation with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/services/smart-sales-platform-transportation-399b3761/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>Smart Sales Platform - Transportation</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers Smart Sales Platform - Transportation with measurable outcomes.
      </p>
