...
export const metadata: Metadata = {
  title: 'Process Mining Cognitive - Legal',
  description: 'Transform your legal operations with our Process Mining Cognitive - Legal. This AI-driven solution automates data quality with unprecedented accuracy and effici',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/process-mining-cognitive-legal-a5bed653',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Process Mining Cognitive - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Process Mining Cognitive - Legal. This AI-driven solution automates data quality with unprecedented accuracy and efficiency.
          </p>
