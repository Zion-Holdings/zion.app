...
export const metadata: Metadata = {
  title: 'AI Supply - ALTHEALTH Edition',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Supply - ALTHEALTH Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your althealth workflows with AI Supply - ALTHEALTH Edition. This intelligent platform delivers incident response through advanced automation and AI.
          </p>
