...
export const metadata: Metadata = {
  title: 'Edge Process Automation Hadoop (Iot)',
  description: 'Edge Process Automation Hadoop (Iot) is an AI-powered iot solution that transforms how businesses operate through intelligent automation and real-time analytics',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/edge-process-automation-hadoop-2b4a85',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Edge Process Automation Hadoop (Iot)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Edge Process Automation Hadoop (Iot) is an AI-powered iot solution that transforms how businesses operate through intelligent automation and real-time analytics.
...
Docker, Hadoop, Redis, Python, Natural Language Processing, Kafka
