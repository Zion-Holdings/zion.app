...
export const metadata: Metadata = {
  title: 'Smart Advisor Suite - Legal',
  description: 'Transform legal with Smart Advisor Suite - Legal - the intelligent automation platform that learns, adapts, and delivers 10x results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-advisor-suite-legal-6aab3aa7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Advisor Suite - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform legal with Smart Advisor Suite - Legal - the intelligent automation platform that learns, adapts, and delivers 10x results.
          </p>
