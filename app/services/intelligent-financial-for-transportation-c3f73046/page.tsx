...
export const metadata: Metadata = {
  title: 'Intelligent Financial for Transportation',
  description: 'Enhance your transportation business with Intelligent Financial for Transportation. Our solution provides integration platform with enterprise-grade reliability',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-financial-for-transportation-c3f73046',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Financial for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with Intelligent Financial for Transportation. Our solution provides integration platform with enterprise-grade reliability and security.
          </p>
