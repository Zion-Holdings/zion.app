      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Predict campaign outcomes before launch. Forecast CTR, conversion rate, and ROAS using historical targeting data and creative asset features.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ ROAS and CTR forecasting</li>
            <li className="text-purple-300">✓ A/B test simulation engine</li>
            <li className="text-purple-300">✓ Audience segment scoring</li>
            <li className="text-purple-300">✓ Creative asset feature extractor</li>
            <li className="text-purple-300">✓ Multi-touch attribution model</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai campaign performance predictor</li>
