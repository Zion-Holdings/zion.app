...
export const metadata: Metadata = {
  title: 'Processor Intelligent - Construction',
  description: 'Revolutionize construction through intelligent automation. Our Processor Intelligent - Construction leverages advanced machine learning to deliver enterprise-gr',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/processor-intelligent-construction-9a1f0287',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Processor Intelligent - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Processor Intelligent - Construction leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
