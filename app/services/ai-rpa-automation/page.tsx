...
export const metadata: Metadata = {
  ...
  keywords: 'Desktop + web + mobile RPA, ERP / tax portal connector, Screen-scrape + form fill + readback, Scheduler + audit log per bot, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Robotic Process Automation (RPA)</h1>
        <p className="text-lg text-slate-300 mb-8">Web desktop mobile RPA: automates mouse keyboard form data entry ERP tax portal batch processing screen-scrape scheduler audit log per bot.</p>
        ...
        <li class="text-slate-300">Desktop + web + mobile RPA</li>
        <li class="text-slate-300">ERP / tax portal connector</li>
        <li class="text-slate-300">Screen-scrape + form fill + readback</li>
        <li class="text-slate-300">Scheduler + audit log per bot</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai robotic process automation (rpa)</li>
