...
export const metadata: Metadata = {
  ...
  keywords: 'Custom invoice templates, Recurring invoice automation, Payment tracking dashboard, Automatic late payment reminders, Multi-currency support, Tax calculation (VAT, GST, Sales Tax), Stripe/PayPal payment integration, Expense and time tracking, micro-saas, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">InvoiceFlow — Invoice Generator Micro-SaaS</h1>
        <p className="text-lg text-slate-300 mb-8">Professional invoice and payment collection for freelancers and small businesses. Custom templates, recurring invoices, payment tracking, and automatic late payment reminders. Multi-currency and tax support.</p>
        ...
        <li class="text-slate-300">Custom invoice templates</li>
        <li class="text-slate-300">Recurring invoice automation</li>
        <li class="text-slate-300">Payment tracking dashboard</li>
        <li class="text-slate-300">Automatic late payment reminders</li>
        <li class="text-slate-300">Multi-currency support</li>
        <li class="text-slate-300">Tax calculation (VAT, GST, Sales Tax)</li>
        <li class="text-slate-300">Stripe/PayPal payment integration</li>
        <li class="text-slate-300">Expense and time tracking</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Get paid 2x faster</li>
        <li class="text-slate-300">Automate invoicing workflows</li>
        <li class="text-slate-300">Professional brand image</li>
        <li class="text-slate-300">Accurate tax compliance</li>
      </ul>
        </div>
