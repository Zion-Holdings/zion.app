...
export const metadata: Metadata = {
  title: 'Enterprise Risk - Marketplace',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Risk - Marketplace
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in marketplace with Enterprise Risk - Marketplace. This AI-powered platform transforms expense management into a competitive advantage.
          </p>
