...
export const metadata: Metadata = {
  title: 'AI Process Mining - Construction Edition',
  description: 'The future of construction is here with AI Process Mining - Construction Edition. Powered by cutting-edge AI, this platform delivers transformative results like',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-process-mining-construction-edition-03df1a0b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Process Mining - Construction Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with AI Process Mining - Construction Edition. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
