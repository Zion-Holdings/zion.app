...
export const metadata: Metadata = {
  title: 'Cognitive Customer Service for Proptech',
  description: 'Transform your proptech operations with our Cognitive Customer Service for Proptech. This AI-driven solution automates process automation with unprecedented acc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-customer-service-for-proptech-9fe1e7dd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Customer Service for Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your proptech operations with our Cognitive Customer Service for Proptech. This AI-driven solution automates process automation with unprecedented accuracy and efficiency.
          </p>
