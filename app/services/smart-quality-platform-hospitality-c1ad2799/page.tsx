...
export const metadata: Metadata = {
  title: 'Smart Quality Platform - Hospitality',
  description: 'Drive innovation in hospitality with Smart Quality Platform - Hospitality. This AI-powered platform transforms maintenance scheduling into a competitive advanta',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-quality-platform-hospitality-c1ad2799',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Quality Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Smart Quality Platform - Hospitality. This AI-powered platform transforms maintenance scheduling into a competitive advantage.
          </p>
