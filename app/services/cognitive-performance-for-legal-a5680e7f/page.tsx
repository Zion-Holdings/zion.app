...
export const metadata: Metadata = {
  title: 'Cognitive Performance for Legal',
  description: 'Next-generation legal solution: Cognitive Performance for Legal. Combines energy management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-performance-for-legal-a5680e7f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Performance for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Cognitive Performance for Legal. Combines energy management with adaptive intelligence for optimal results.
          </p>
