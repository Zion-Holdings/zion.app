...
export const metadata: Metadata = {
  title: 'Platform Automated - Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Platform Automated - Hospitality leverages advanced machine learning to deliver data processing at',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/platform-automated-hospitality-25da3fb0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Platform Automated - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Platform Automated - Hospitality leverages advanced machine learning to deliver data processing at scale.
          </p>
