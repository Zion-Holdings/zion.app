...
export const metadata: Metadata = {
  ...
  keywords: 'SSO (SAML 2.0 + OIDC) for all SaaS apps, Adaptive MFA (TOTP/WebAuthn/risk-based), SCIM auto-provision + de-provision per hire/fire, JIT privileged-access, session recorded, it, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Identity &amp; Access Management (SSO/MFA)</h1>
        <p className="text-lg text-slate-300 mb-8">SSO (SAML 2.0/OIDC), adaptive MFA (TOTP/WebAuthn/risk-based), SCIM auto-provision/revoke, JIT privileged-access.</p>
        ...
        <li class="text-slate-300">SSO (SAML 2.0 + OIDC) for all SaaS apps</li>
        <li class="text-slate-300">Adaptive MFA (TOTP/WebAuthn/risk-based)</li>
        <li class="text-slate-300">SCIM auto-provision + de-provision per hire/fire</li>
        <li class="text-slate-300">JIT privileged-access, session recorded</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with identity &amp; access management (sso/mfa)</li>
