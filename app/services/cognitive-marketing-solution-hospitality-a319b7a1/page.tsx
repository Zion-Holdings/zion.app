...
export const metadata: Metadata = {
  title: 'Cognitive Marketing Solution - Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Cognitive Marketing Solution - Hospitality leverages advanced machine learning to deliver financia',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-marketing-solution-hospitality-a319b7a1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Marketing Solution - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Cognitive Marketing Solution - Hospitality leverages advanced machine learning to deliver financial risk management at scale.
          </p>
