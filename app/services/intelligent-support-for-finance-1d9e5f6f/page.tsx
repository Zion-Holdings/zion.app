...
export const metadata: Metadata = {
  title: 'Intelligent Support for Finance',
  description: 'Unlock unprecedented growth with Intelligent Support for Finance. This autonomous system provides claims processing with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-support-for-finance-1d9e5f6f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Support for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Support for Finance. This autonomous system provides claims processing with zero manual intervention needed.
          </p>
