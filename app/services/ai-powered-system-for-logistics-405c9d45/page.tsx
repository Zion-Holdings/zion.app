...
export const metadata: Metadata = {
  title: 'AI-Powered System for Logistics',
  description: 'Revolutionize logistics through intelligent automation. Our AI-Powered System for Logistics leverages advanced machine learning to deliver performance monitorin',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-system-for-logistics-405c9d45',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered System for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our AI-Powered System for Logistics leverages advanced machine learning to deliver performance monitoring at scale.
          </p>
