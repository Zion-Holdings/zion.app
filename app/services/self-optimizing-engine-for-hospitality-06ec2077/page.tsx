...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize hospitality through intelligent automation. Our Self-Optimizing Engine for Hospitality leverages advanced machine learning to deliver market intel',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/self-optimizing-engine-for-hospitality-06ec2077',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Self-Optimizing Engine for Hospitality leverages advanced machine learning to deliver market intelligence at scale.
          </p>
