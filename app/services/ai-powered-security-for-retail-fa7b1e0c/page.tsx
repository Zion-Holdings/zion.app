...
export const metadata: Metadata = {
  title: 'AI-Powered Security for Retail',
  description: 'Transform your retail operations with our AI-Powered Security for Retail. This AI-driven solution automates decision support with unprecedented accuracy and eff',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-security-for-retail-fa7b1e0c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Security for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our AI-Powered Security for Retail. This AI-driven solution automates decision support with unprecedented accuracy and efficiency.
          </p>
