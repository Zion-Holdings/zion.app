...
export const metadata: Metadata = {
  title: 'Intelligent Support for Energy',
  description: 'Optimize your energy workflows with Intelligent Support for Energy. This intelligent platform delivers invoice processing through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-support-for-energy-27635844',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Support for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your energy workflows with Intelligent Support for Energy. This intelligent platform delivers invoice processing through advanced automation and AI.
          </p>
