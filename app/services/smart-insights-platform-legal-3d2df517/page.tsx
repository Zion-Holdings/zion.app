...
export const metadata: Metadata = {
  title: 'Smart Insights Platform - Legal',
  description: 'Revolutionize legal through intelligent automation. Our Smart Insights Platform - Legal leverages advanced machine learning to deliver roi tracking at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-insights-platform-legal-3d2df517',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Insights Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Smart Insights Platform - Legal leverages advanced machine learning to deliver roi tracking at scale.
          </p>
