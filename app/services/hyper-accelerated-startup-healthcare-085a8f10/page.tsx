...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Startup - Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Hyper-Accelerated Startup - Healthcare leverages advanced machine learning to deliver reporting aut',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Startup - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Hyper-Accelerated Startup - Healthcare leverages advanced machine learning to deliver reporting automation at scale.
          </p>
