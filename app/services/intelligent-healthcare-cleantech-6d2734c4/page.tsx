...
export const metadata: Metadata = {
  title: 'Intelligent healthcare-cleantech',
  description: 'Unlock unprecedented growth with Intelligent healthcare-cleantech. This autonomous system provides decision support with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-healthcare-cleantech-6d2734c4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent healthcare-cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent healthcare-cleantech. This autonomous system provides decision support with zero manual intervention needed.
          </p>
