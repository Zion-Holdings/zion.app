...
export const metadata: Metadata = {
  ...
  keywords: 'White-box test generation from source code, Black-box tests from BDD/Gherkin specs, E2E test generation via Puppeteer/Playwright, Coverage gap analysis & prioritizing, Test flake detection & stabilization, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Powered Test Suite Generator</h1>
        <p className="text-lg text-slate-300 mb-8">Automatically generate comprehensive unit, integration, and E2E tests from code, requirements, or user stories with high coverage and maintainability.</p>
        ...
        <li class="text-slate-300">White-box test generation from source code</li>
        <li class="text-slate-300">Black-box tests from BDD/Gherkin specs</li>
        <li class="text-slate-300">E2E test generation via Puppeteer/Playwright</li>
        <li class="text-slate-300">Coverage gap analysis &amp; prioritizing</li>
        <li class="text-slate-300">Test flake detection &amp; stabilization</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai-powered test suite generator</li>
