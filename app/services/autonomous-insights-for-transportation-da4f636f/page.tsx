...
export const metadata: Metadata = {
  ...
  keywords: 'Role-based access control, Alerting system, Audit trails, Multi-region deployment, GDPR compliance, processor, transportation, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Autonomous Insights for Transportation</h1>
        <p className="text-lg text-slate-300 mb-8">Transform your transportation operations with our Autonomous Insights for Transportation. This AI-driven solution automates threat detection with unprecedented accuracy and efficiency.</p>
