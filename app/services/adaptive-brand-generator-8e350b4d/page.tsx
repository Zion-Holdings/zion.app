...
export const metadata: Metadata = {
  title: 'Adaptive Brand Generator',
  description: 'Revolutionize automotive through intelligent automation. Our Adaptive Brand Generator leverages advanced machine learning to deliver recruitment automation at s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-brand-generator-8e350b4d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Brand Generator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize automotive through intelligent automation. Our Adaptive Brand Generator leverages advanced machine learning to deliver recruitment automation at scale.
          </p>
