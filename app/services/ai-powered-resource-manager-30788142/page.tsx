...
export const metadata: Metadata = {
  title: 'AI-Powered Resource Manager',
  description: 'Revolutionize energy through intelligent automation. Our AI-Powered Resource Manager leverages advanced machine learning to deliver compliance monitoring at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Resource Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our AI-Powered Resource Manager leverages advanced machine learning to deliver compliance monitoring at scale.
          </p>
