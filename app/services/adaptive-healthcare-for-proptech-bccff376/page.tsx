...
export const metadata: Metadata = {
  title: 'Adaptive Healthcare for Proptech',
  description: 'Revolutionize proptech through intelligent automation. Our Adaptive Healthcare for Proptech leverages advanced machine learning to deliver customer service auto',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-healthcare-for-proptech-bccff376',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Healthcare for Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our Adaptive Healthcare for Proptech leverages advanced machine learning to deliver customer service automation at scale.
          </p>
