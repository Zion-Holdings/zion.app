...
export const metadata: Metadata = {
  title: 'Smart Optimizer Platform - CLEANTECH',
  description: 'Transform your cleantech operations with our Smart Optimizer Platform - CLEANTECH. This AI-driven solution automates disaster recovery with unprecedented accura',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-optimizer-platform-cleantech-d5e4b96f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Optimizer Platform - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your cleantech operations with our Smart Optimizer Platform - CLEANTECH. This AI-driven solution automates disaster recovery with unprecedented accuracy and efficiency.
          </p>
