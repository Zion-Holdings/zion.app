...
export const metadata: Metadata = {
  title: 'Enterprise Computer Vision Platform - Sports',
  description: 'Transform your sports operations with our Enterprise Computer Vision Platform - Sports. This AI-driven solution automates form processing with unprecedented acc',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Computer Vision Platform - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our Enterprise Computer Vision Platform - Sports. This AI-driven solution automates form processing with unprecedented accuracy and efficiency.
          </p>
