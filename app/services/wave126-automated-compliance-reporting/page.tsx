...
export const metadata: Metadata = {
  ...
  keywords: 'Automated evidence collection from 100+ integrations, SOC 2, HIPAA, GDPR, PCI-DSS, ISO 27001 frameworks, Control mapping & gap analysis, Audit-ready report generation, Remediation tracking with SLA enforcement, Real-time compliance score dashboard, Vendor risk assessment workflows, Change management & policy versioning, micro-saas, Compliance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Automated Compliance Reporting</h1>
        <p className="text-lg text-slate-300 mb-8">Continuous compliance automation for SOC 2, HIPAA, GDPR, PCI-DSS, and ISO 27001. Auto-collects evidence, maps controls, generates audit-ready reports, and tracks remediation — compressing audit prep from months to days.</p>
        ...
        <li class="text-slate-300">Automated evidence collection from 100+ integrations</li>
        <li class="text-slate-300">SOC 2, HIPAA, GDPR, PCI-DSS, ISO 27001 frameworks</li>
        <li class="text-slate-300">Control mapping &amp; gap analysis</li>
        <li class="text-slate-300">Audit-ready report generation</li>
        <li class="text-slate-300">Remediation tracking with SLA enforcement</li>
        <li class="text-slate-300">Real-time compliance score dashboard</li>
        <li class="text-slate-300">Vendor risk assessment workflows</li>
        <li class="text-slate-300">Change management &amp; policy versioning</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce audit prep from months to days</li>
        <li class="text-slate-300">Continuous compliance — not point-in-time</li>
        <li class="text-slate-300">Eliminate spreadsheet-driven compliance chaos</li>
        <li class="text-slate-300">Pass audits on the first attempt</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">3997</p>
