  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Integrated Commerce Flow Orchestrator</h1>
        <p className="text-lg text-slate-300 mb-8">Commerce workflow automation: cart-to-delivery orchestrator connecting Shopify/BigCommerce/WooCommerce with payment and shipping providers, automated RMA/return-handling, subscription-billing orchestrator, revenue reconciliation engine.</p>
        ...
        <li class="text-slate-300">Omnichannel cart-to-delivery orchestration across Shopify, BigCommerce, and WooCommerce</li>
        <li class="text-slate-300">Automated RMA and return handling end-to-end — refund, restock, denomination dispatch</li>
        <li class="text-slate-300">Subscription billing orchestrator — proration, cohort billing, proration</li>
        <li class="text-slate-300">Revenue reconciliation engine against payment providers with always-reconciled ledger</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with integrated commerce flow orchestrator</li>
