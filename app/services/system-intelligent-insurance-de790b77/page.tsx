...
export const metadata: Metadata = {
  title: 'System Intelligent - Insurance',
  description: 'Transform your insurance operations with our System Intelligent - Insurance. This AI-driven solution automates budget tracking with unprecedented accuracy and e',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/system-intelligent-insurance-de790b77',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            System Intelligent - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our System Intelligent - Insurance. This AI-driven solution automates budget tracking with unprecedented accuracy and efficiency.
          </p>
