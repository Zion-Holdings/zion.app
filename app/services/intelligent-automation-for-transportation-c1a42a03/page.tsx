...
export const metadata: Metadata = {
  title: 'Intelligent Automation for Transportation',
  description: 'Drive innovation in transportation with Intelligent Automation for Transportation. This AI-powered platform transforms record extraction into a competitive adva',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-automation-for-transportation-c1a42a03',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Automation for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in transportation with Intelligent Automation for Transportation. This AI-powered platform transforms record extraction into a competitive advantage.
          </p>
