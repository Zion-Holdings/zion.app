...
export const metadata: Metadata = {
  title: 'AI/IT Coordinator Suite - Manufacturing',
  description: 'Transform your manufacturing operations with our AI/IT Coordinator Suite - Manufacturing. This AI-driven solution automates performance monitoring with unpreced',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-coordinator-suite-manufacturing-ded4cb2d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Coordinator Suite - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your manufacturing operations with our AI/IT Coordinator Suite - Manufacturing. This AI-driven solution automates performance monitoring with unprecedented accuracy and efficiency.
          </p>
