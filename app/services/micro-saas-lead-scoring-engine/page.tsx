...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-signal lead scoring, Website visit tracking, Email engagement analytics, Firmographic enrichment, CRM integration (HubSpot, Salesforce, Pipedrive), Custom scoring models, Real-time score updates, Sales alerts for hot leads, micro-saas, Sales, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">LeadForge — Lead Scoring Micro-SaaS</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered lead scoring for sales teams. Analyze website activity, email engagement, firmographics, and social signals to rank leads by conversion probability. Integrates with HubSpot, Salesforce, and Pipedrive.</p>
        ...
        <li class="text-slate-300">Multi-signal lead scoring</li>
        <li class="text-slate-300">Website visit tracking</li>
        <li class="text-slate-300">Email engagement analytics</li>
        <li class="text-slate-300">Firmographic enrichment</li>
        <li class="text-slate-300">CRM integration (HubSpot, Salesforce, Pipedrive)</li>
        <li class="text-slate-300">Custom scoring models</li>
        <li class="text-slate-300">Real-time score updates</li>
        <li class="text-slate-300">Sales alerts for hot leads</li>
      </ul>
        </div>
        ...
        <li class="text-slate-300">Prioritize high-value leads</li>
        <li class="text-slate-300">Reduce sales cycle time</li>
        <li class="text-slate-300">Data-driven lead qualification</li>
      </ul>
        </div>
