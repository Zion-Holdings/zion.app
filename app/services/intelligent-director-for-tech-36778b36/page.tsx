...
export const metadata: Metadata = {
  title: 'Intelligent Director for Tech',
  description: 'Optimize your technology workflows with Intelligent Director for Tech. This intelligent platform delivers quality assurance through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-director-for-tech-36778b36',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Director for Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your technology workflows with Intelligent Director for Tech. This intelligent platform delivers quality assurance through advanced automation and AI.
          </p>
