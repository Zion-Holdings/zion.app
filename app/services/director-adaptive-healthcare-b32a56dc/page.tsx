...
export const metadata: Metadata = {
  title: 'Director Adaptive - Healthcare',
  description: 'Next-generation healthcare solution: Director Adaptive - Healthcare. Combines lead scoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/director-adaptive-healthcare-b32a56dc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Director Adaptive - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Director Adaptive - Healthcare. Combines lead scoring with adaptive intelligence for optimal results.
          </p>
