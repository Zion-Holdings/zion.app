...
export const metadata: Metadata = {
  title: 'Smart Management Platform - Sports',
  description: 'Unlock unprecedented growth with Smart Management Platform - Sports. This autonomous system provides employee engagement with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-management-platform-sports-e41d58d0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Management Platform - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Management Platform - Sports. This autonomous system provides employee engagement with zero manual intervention needed.
          </p>
