...
export const metadata: Metadata = {
  title: 'Smart Finance for Agriculture #1',
  description: 'Revolutionize agriculture through intelligent automation. Our Smart Finance for Agriculture #1 leverages advanced machine learning to deliver supply chain at sc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-finance-for-agriculture-1-6b37b563',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Finance for Agriculture #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Smart Finance for Agriculture #1 leverages advanced machine learning to deliver supply chain at scale.
          </p>
