...
export const metadata: Metadata = {
  title: 'Intelligent Data for Iot',
  description: 'Transform your iot operations with our Intelligent Data for Iot. This AI-driven solution automates quality control with unprecedented accuracy and efficiency.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-data-for-iot-c2dfcaa5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Data for Iot
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your iot operations with our Intelligent Data for Iot. This AI-driven solution automates quality control with unprecedented accuracy and efficiency.
          </p>
