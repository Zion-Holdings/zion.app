...
export const metadata: Metadata = {
  title: 'Automated Cloud for Construction',
  description: 'Revolutionize construction through intelligent automation. Our Automated Cloud for Construction leverages advanced machine learning to deliver maintenance sched',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-cloud-for-construction-a98feae7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Cloud for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Automated Cloud for Construction leverages advanced machine learning to deliver maintenance scheduling at scale.
          </p>
