...
export const metadata: Metadata = {
  title: 'Financial Analytics AI-Powered Lead Scoring & Routing',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Financial Analytics AI-Powered Lead Scoring & Routing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered financial analytics solution for sales. Scores and routes sales leads in real-time based on engagement.
          </p>
