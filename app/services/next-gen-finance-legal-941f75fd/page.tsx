...
export const metadata: Metadata = {
  title: 'Next-Gen Finance - Legal',
  description: 'Next-generation legal solution: Next-Gen Finance - Legal. Combines revenue forecasting with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-finance-legal-941f75fd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Finance - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Next-Gen Finance - Legal. Combines revenue forecasting with adaptive intelligence for optimal results.
          </p>
