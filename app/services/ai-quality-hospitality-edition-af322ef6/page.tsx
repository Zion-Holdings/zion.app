...
export const metadata: Metadata = {
  title: 'AI Quality - Hospitality Edition',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Quality - Hospitality Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with AI Quality - Hospitality Edition. Our solution provides market analysis with enterprise-grade reliability and security.
          </p>
