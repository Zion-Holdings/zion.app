...
export const metadata = {
  title: 'AWS Cost Optimization | Zion Tech Group',
  description: 'End-to-end aws cost optimization services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/aws-cost-optimization-2026-7121/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">AWS Cost Optimization</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end aws cost optimization services: assessment, deployment, and managed operations.
        </p>
