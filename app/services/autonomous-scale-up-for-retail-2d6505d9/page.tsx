...
export const metadata: Metadata = {
  title: 'Autonomous Scale-up for Retail',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Scale-up for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your retail workflows with Autonomous Scale-up for Retail. This intelligent platform delivers expense reporting through advanced automation and AI.
          </p>
