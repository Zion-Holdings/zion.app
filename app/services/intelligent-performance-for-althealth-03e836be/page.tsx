...
export const metadata: Metadata = {
  title: 'Intelligent Performance for ALTHEALTH',
  description: 'Unlock unprecedented growth with Intelligent Performance for ALTHEALTH. This autonomous system provides task mining with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-performance-for-althealth-03e836be',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Performance for ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Performance for ALTHEALTH. This autonomous system provides task mining with zero manual intervention needed.
          </p>
