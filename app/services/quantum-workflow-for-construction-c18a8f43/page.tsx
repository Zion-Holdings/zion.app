...
export const metadata: Metadata = {
  title: 'Quantum Workflow for Construction',
  description: 'Enhance your construction business with Quantum Workflow for Construction. Our solution provides incident response with enterprise-grade reliability and securit',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Workflow for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Quantum Workflow for Construction. Our solution provides incident response with enterprise-grade reliability and security.
          </p>
