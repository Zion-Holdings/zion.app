...
export const metadata: Metadata = {
  title: 'Autonomous neural-insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Autonomous neural-insurance leverages advanced machine learning to deliver project portfolio at scal',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-neural-insurance-a6aedad8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous neural-insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Autonomous neural-insurance leverages advanced machine learning to deliver project portfolio at scale.
          </p>
