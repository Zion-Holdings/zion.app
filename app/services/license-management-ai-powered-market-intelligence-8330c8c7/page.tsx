...
export const metadata: Metadata = {
  title: 'License Management AI-Powered Market Intelligence',
  description: 'license management solution for infrastructure industry. Monitors market trends, competitor activities, and industry news to provide actionable insights.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/license-management-ai-powered-market-intelligence-8330c8c7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            License Management AI-Powered Market Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            license management solution for infrastructure industry. Monitors market trends, competitor activities, and industry news to provide actionable insights.
          </p>
