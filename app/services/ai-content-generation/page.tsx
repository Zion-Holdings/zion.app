...
export const metadata: Metadata = {
  ...
  keywords: 'Blog post & article generation, Social media content creation, SEO-optimized copywriting, Ad copy & landing page text, Brand voice customization, ai, E-Commerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Content Generation</h1>
        <p className="text-lg text-slate-300 mb-8">Generate high-quality blog posts, social media content, ad copy, product descriptions, and email campaigns powered by advanced LLMs.</p>
        ...
        <li class="text-slate-300">Blog post &amp; article generation</li>
        <li class="text-slate-300">Social media content creation</li>
        <li class="text-slate-300">SEO-optimized copywriting</li>
        <li class="text-slate-300">Ad copy &amp; landing page text</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai content generation</li>
