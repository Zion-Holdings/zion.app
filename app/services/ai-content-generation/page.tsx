      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Generate high-quality blog posts, social media content, ad copy, product descriptions, and email campaigns powered by advanced LLMs.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Blog post & article generation</li>
            <li className="text-purple-300">✓ Social media content creation</li>
            <li className="text-purple-300">✓ SEO-optimized copywriting</li>
            <li className="text-purple-300">✓ Ad copy & landing page text</li>
            <li className="text-purple-300">✓ Brand voice customization</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai content generation</li>
