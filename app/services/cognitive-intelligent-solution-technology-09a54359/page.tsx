...
export const metadata: Metadata = {
  title: 'Cognitive Intelligent Solution - TECHNOLOGY',
  description: 'Drive innovation in technology with Cognitive Intelligent Solution - TECHNOLOGY. This AI-powered platform transforms resource planning into a competitive advant',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Intelligent Solution - TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in technology with Cognitive Intelligent Solution - TECHNOLOGY. This AI-powered platform transforms resource planning into a competitive advantage.
          </p>
