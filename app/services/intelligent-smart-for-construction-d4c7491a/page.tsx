...
export const metadata: Metadata = {
  title: 'Intelligent Smart for Construction',
  description: 'Quantum leap forward for construction: Intelligent Smart for Construction. Uses quantum-inspired algorithms to deliver feature engineering at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-smart-for-construction-d4c7491a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Smart for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for construction: Intelligent Smart for Construction. Uses quantum-inspired algorithms to deliver feature engineering at exponential speed.
          </p>
