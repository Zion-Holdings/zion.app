...
export const metadata: Metadata = {
  ...
  description: 'Next-generation finance solution: Intelligent Suite for Finance. Combines process discovery with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-suite-for-finance-70504374',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation finance solution: Intelligent Suite for Finance. Combines process discovery with adaptive intelligence for optimal results.
          </p>
