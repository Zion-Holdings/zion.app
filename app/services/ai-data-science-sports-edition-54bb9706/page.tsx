...
export const metadata: Metadata = {
  title: 'AI Data Science - Sports Edition',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Data Science - Sports Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your sports business with AI Data Science - Sports Edition. Our solution provides procurement automation with enterprise-grade reliability and security.
          </p>
