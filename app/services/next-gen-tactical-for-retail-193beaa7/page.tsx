...
export const metadata: Metadata = {
  title: 'Next-Gen Tactical for Retail',
  description: 'Hyper-accelerated retail solution: Next-Gen Tactical for Retail. Combines master data management with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-tactical-for-retail-193beaa7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Tactical for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated retail solution: Next-Gen Tactical for Retail. Combines master data management with next-gen AI for maximum velocity.
          </p>
