...
export const metadata: Metadata = {
  title: 'Machine Learning Autonomous - Agriculture',
  description: 'Transform your agriculture operations with our Machine Learning Autonomous - Agriculture. This AI-driven solution provides intelligent automation with unprecede',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Machine Learning Autonomous - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Machine Learning Autonomous - Agriculture. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
