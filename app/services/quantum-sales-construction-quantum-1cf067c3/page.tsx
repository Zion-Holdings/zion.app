...
export const metadata: Metadata = {
  title: 'Quantum Sales - Construction Quantum',
  description: 'Enhance your construction business with Quantum Sales - Construction Quantum. Our solution provides predictive modeling with enterprise-grade reliability and se',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-sales-construction-quantum-1cf067c3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Sales - Construction Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Quantum Sales - Construction Quantum. Our solution provides predictive modeling with enterprise-grade reliability and security.
          </p>
