...
export const metadata: Metadata = {
  title: 'Adaptive Decision for EDTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Decision for EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your edtech workflows with Adaptive Decision for EDTECH. This intelligent platform delivers time tracking through advanced automation and AI.
          </p>
