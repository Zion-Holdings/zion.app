...
export const metadata: Metadata = {
  title: 'Cognitive Insights Solution - Cybersecurity',
  description: 'Optimize your cybersecurity workflows with Cognitive Insights Solution - Cybersecurity. This intelligent platform delivers project portfolio through advanced au',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Insights Solution - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your cybersecurity workflows with Cognitive Insights Solution - Cybersecurity. This intelligent platform delivers project portfolio through advanced automation and AI.
          </p>
