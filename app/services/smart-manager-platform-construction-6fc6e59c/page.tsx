...
export const metadata: Metadata = {
  title: 'Smart Manager Platform - Construction',
  description: 'Unlock unprecedented growth with Smart Manager Platform - Construction. This autonomous system provides churn prediction with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-manager-platform-construction-6fc6e59c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manager Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Manager Platform - Construction. This autonomous system provides churn prediction with zero manual intervention needed.
          </p>
