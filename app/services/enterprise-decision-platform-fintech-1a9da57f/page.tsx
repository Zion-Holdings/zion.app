...
export const metadata: Metadata = {
  title: 'Enterprise Decision Platform - FINTECH',
  description: 'Revolutionize fintech through intelligent automation. Our Enterprise Decision Platform - FINTECH leverages advanced machine learning to deliver network optimiza',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-decision-platform-fintech-1a9da57f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Decision Platform - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize fintech through intelligent automation. Our Enterprise Decision Platform - FINTECH leverages advanced machine learning to deliver network optimization at scale.
          </p>
