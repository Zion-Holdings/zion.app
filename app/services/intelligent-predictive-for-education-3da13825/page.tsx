...
export const metadata: Metadata = {
  title: 'Intelligent Predictive for Education',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Predictive for Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your education business with Intelligent Predictive for Education. Our solution provides churn prediction with enterprise-grade reliability and security.
          </p>
