...
export const metadata: Metadata = {
  title: 'Quantum Predictor - Legal Quantum',
  description: 'Revolutionize legal through intelligent automation. Our Quantum Predictor - Legal Quantum leverages advanced machine learning to deliver content moderation at s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Predictor - Legal Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Quantum Predictor - Legal Quantum leverages advanced machine learning to deliver content moderation at scale.
          </p>
