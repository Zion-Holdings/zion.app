...
export const metadata: Metadata = {
  title: 'Quantum Workflow - Legal Quantum',
  description: 'Drive innovation in legal with Quantum Workflow - Legal Quantum. This AI-powered platform transforms warehouse automation into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-workflow-legal-quantum-f87677f5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Workflow - Legal Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Quantum Workflow - Legal Quantum. This AI-powered platform transforms warehouse automation into a competitive advantage.
          </p>
