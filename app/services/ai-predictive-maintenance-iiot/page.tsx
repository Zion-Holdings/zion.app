...
export const metadata: Metadata = {
  ...
  keywords: 'Vibration analysis and anomaly detection, Thermal imaging analysis, Remaining useful life prediction, Automated work order generation, CMMS/EPA integration, Digital twin visualization, Mobile technician app, Historical failure analysis, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Predictive Maintenance IIoT Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Industrial IoT predictive maintenance for manufacturing and energy. Sensor data analysis, anomaly detection, remaining useful life prediction, and automated work order generation.</p>
        ...
        <li class="text-slate-300">Vibration analysis and anomaly detection</li>
        <li class="text-slate-300">Thermal imaging analysis</li>
        <li class="text-slate-300">Remaining useful life prediction</li>
        <li class="text-slate-300">Automated work order generation</li>
        <li class="text-slate-300">CMMS/EPA integration</li>
        <li class="text-slate-300">Digital twin visualization</li>
        ...
        <li class="text-slate-300">Extend asset lifespan by 25%</li>
        <li class="text-slate-300">Optimize spare parts inventory</li>
        <li class="text-slate-300">Increase production efficiency</li>
      </ul>
        </div>
