...
export const metadata: Metadata = {
  title: 'Conversion Rate Optimization AI-Powered Email Marketing Automation',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Conversion Rate Optimization AI-Powered Email Marketing Automation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered conversion rate optimization solution for marketing. Automated email campaigns with dynamic content and A/B testing.
          </p>
