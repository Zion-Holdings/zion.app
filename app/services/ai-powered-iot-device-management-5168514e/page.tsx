...
export const metadata: Metadata = {
  title: 'AI-Powered IoT Device Management',
  description: 'Manages and optimizes IoT devices with predictive maintenance and edge AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-iot-device-management-5168514e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Manages and optimizes IoT devices with predictive maintenance and edge AI.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Edge AI</li>
