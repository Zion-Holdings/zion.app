...
export const metadata: Metadata = {
  title: 'System Automated - Transportation',
  description: 'Transform your transportation operations with our System Automated - Transportation. This AI-driven solution automates project portfolio with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/system-automated-transportation-7393ff57',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            System Automated - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your transportation operations with our System Automated - Transportation. This AI-driven solution automates project portfolio with unprecedented accuracy and efficiency.
          </p>
