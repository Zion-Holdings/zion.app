...
export const metadata: Metadata = {
  ...
  keywords: 'Demand forecast XGBoost/LightGBM per SKU, Safety-stock SDE (service-level, lead-time), Route optimisation OR-Tools per order-batch, Supplier risk score per vendor/region/country, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Predictive Supply Chain Optimizer</h1>
        <p className="text-lg text-slate-300 mb-8">Demand forecasting XGBoost/LightGBM, inventory reorder point SDE, route optimisation OR-Tools, and supplier risk scoring per vendor.</p>
        ...
        <li class="text-slate-300">Demand forecast XGBoost/LightGBM per SKU</li>
        <li class="text-slate-300">Safety-stock SDE (service-level, lead-time)</li>
        <li class="text-slate-300">Route optimisation OR-Tools per order-batch</li>
        <li class="text-slate-300">Supplier risk score per vendor/region/country</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with predictive supply chain optimizer</li>
