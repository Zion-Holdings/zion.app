...
export const metadata: Metadata = {
  title: 'Autonomous Generator System - MARTECH',
  description: 'Optimize your martech workflows with Autonomous Generator System - MARTECH. This intelligent platform delivers network optimization through advanced automation ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Generator System - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your martech workflows with Autonomous Generator System - MARTECH. This intelligent platform delivers network optimization through advanced automation and AI.
          </p>
