...
export const metadata: Metadata = {
  title: 'Intelligent Data Science for Transportation',
  description: 'Enhance your transportation business with Intelligent Data Science for Transportation. Our solution provides data quality with enterprise-grade reliability and ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Data Science for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with Intelligent Data Science for Transportation. Our solution provides data quality with enterprise-grade reliability and security.
          </p>
