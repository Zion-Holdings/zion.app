      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Future manufacturing</li>
            <li className="text-purple-300">✓ AI</li>
            <li className="text-purple-300">✓ Quantum</li>
            <li className="text-purple-300">✓ Advanced tech</li>
            </ul>
          </div>
          ...
          <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl p-8 text-center mb-8">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-white/10 rounded-lg p-4">
                <div className="text-3xl font-bold mb-2">$8999;34999;89999</div>
                <div>Basic</div>
              </div>
