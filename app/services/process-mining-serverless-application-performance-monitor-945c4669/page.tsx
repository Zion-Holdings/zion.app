...
export const metadata: Metadata = {
  title: 'Process Mining Serverless Application Performance Monitor',
  description: 'AI-powered process mining solution for development. Comprehensive monitoring for serverless applications.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/process-mining-serverless-application-performance-monitor-945c4669',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Process Mining Serverless Application Performance Monitor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered process mining solution for development. Comprehensive monitoring for serverless applications.
          </p>
