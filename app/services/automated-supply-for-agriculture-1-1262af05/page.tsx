...
export const metadata: Metadata = {
  title: 'Automated Supply for Agriculture #1',
  description: 'Revolutionize agriculture through intelligent automation. Our Automated Supply for Agriculture #1 leverages advanced machine learning to deliver image recogniti',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-supply-for-agriculture-1-1262af05',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Supply for Agriculture #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Automated Supply for Agriculture #1 leverages advanced machine learning to deliver image recognition at scale.
          </p>
