...
export const metadata: Metadata = {
  ...
  description: 'Optimize your agriculture workflows with AI-Powered intelligent-agriculture. This intelligent platform delivers performance monitoring through advanced automati',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered intelligent-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your agriculture workflows with AI-Powered intelligent-agriculture. This intelligent platform delivers performance monitoring through advanced automation and AI.
          </p>
