...
export const metadata: Metadata = {
  title: 'AI-Powered system-edtech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered system-edtech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your edtech business with AI-Powered system-edtech. Our solution provides feature engineering with enterprise-grade reliability and security.
          </p>
