...
export const metadata: Metadata = {
  title: 'AI Smart - Insurance',
  description: 'Next-generation insurance solution: AI Smart - Insurance. Combines quality control with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-smart-insurance-f8df0a53',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: AI Smart - Insurance. Combines quality control with adaptive intelligence for optimal results.
          </p>
