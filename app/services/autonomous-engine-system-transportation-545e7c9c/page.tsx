...
export const metadata: Metadata = {
  title: 'Autonomous Engine System - Transportation',
  description: 'The future of transportation is here with Autonomous Engine System - Transportation. Powered by cutting-edge AI, this platform delivers audit trail management l',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-engine-system-transportation-545e7c9c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Engine System - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Autonomous Engine System - Transportation. Powered by cutting-edge AI, this platform delivers audit trail management like never before.
          </p>
