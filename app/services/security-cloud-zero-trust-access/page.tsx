...
export const metadata: Metadata = {
  ...
  keywords: 'Per-application least-privilege access policy from identity to cookie, Device posture context — certificate validity, OS, browser assessment before granting, 1-click kill/revoke per user identity across all resources, Full session recording with playable video replay per access session, security, E-Commerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cloud Zero Trust Access (ZTNA)</h1>
        <p className="text-lg text-slate-300 mb-8">Zero trust network access for cloud and on-prem resources: per-application least-privilege policy, device posture context, 1-click revoke per identity, 75% faster access time for legitimate users, full session recording.</p>
        ...
        <li class="text-slate-300">Per-application least-privilege access policy from identity to cookie</li>
        <li class="text-slate-300">Device posture context — certificate validity, OS, browser assessment before granting</li>
        <li class="text-slate-300">1-click kill/revoke per user identity across all resources</li>
        <li class="text-slate-300">Full session recording with playable video replay per access session</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with cloud zero trust access (ztna)</li>
