...
export const metadata: Metadata = {
  title: 'Engine AI - Blockchain',
  description: 'Revolutionize blockchain through intelligent automation. Our Engine AI - Blockchain leverages advanced machine learning to deliver language processing at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/engine-ai---blockchain-831e3612',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize blockchain through intelligent automation. Our Engine AI - Blockchain leverages advanced machine learning to deliver language processing at scale.
          </p>
