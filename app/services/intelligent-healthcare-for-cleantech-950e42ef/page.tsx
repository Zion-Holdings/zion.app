...
export const metadata: Metadata = {
  title: 'Intelligent Healthcare for CLEANTECH',
  description: 'Optimize your cleantech workflows with Intelligent Healthcare for CLEANTECH. This intelligent platform delivers resource allocation through advanced automation ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-healthcare-for-cleantech-950e42ef',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Healthcare for CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your cleantech workflows with Intelligent Healthcare for CLEANTECH. This intelligent platform delivers resource allocation through advanced automation and AI.
          </p>
