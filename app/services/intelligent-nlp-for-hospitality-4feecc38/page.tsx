...
export const metadata: Metadata = {
  title: 'Intelligent NLP for Hospitality',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent NLP for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated hospitality solution: Intelligent NLP for Hospitality. Combines lakehouse architecture with next-gen AI for maximum velocity.
          </p>
