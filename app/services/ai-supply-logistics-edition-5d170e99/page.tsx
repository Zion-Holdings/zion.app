...
export const metadata: Metadata = {
  title: 'AI Supply - Logistics Edition',
  description: 'Enhance your logistics business with AI Supply - Logistics Edition. Our solution provides healthcare data analytics with enterprise-grade reliability and securi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-supply-logistics-edition-5d170e99',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Supply - Logistics Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with AI Supply - Logistics Edition. Our solution provides healthcare data analytics with enterprise-grade reliability and security.
          </p>
