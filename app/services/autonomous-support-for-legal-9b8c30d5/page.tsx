...
export const metadata: Metadata = {
  title: 'Autonomous Support for Legal',
  description: 'The future of legal is here with Autonomous Support for Legal. Powered by cutting-edge AI, this platform delivers performance tuning like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-support-for-legal-9b8c30d5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Support for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Autonomous Support for Legal. Powered by cutting-edge AI, this platform delivers performance tuning like never before.
          </p>
