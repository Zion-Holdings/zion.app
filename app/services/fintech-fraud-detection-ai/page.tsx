...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time transaction scoring, Behavioral biometrics, Account takeover detection, AML/BSA compliance monitoring, Integration with payment processors, Case management workflow, Explainable AI for regulators, Custom rule engine, fintech, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Powered Fraud Detection for Fintech</h1>
        <p className="text-lg text-slate-300 mb-8">Real-time fraud detection for financial transactions. ML models trained on billions of transactions to detect anomalies, account takeover, and money laundering.</p>
        ...
        <li class="text-slate-300">Behavioral biometrics</li>
        <li class="text-slate-300">Account takeover detection</li>
        <li class="text-slate-300">AML/BSA compliance monitoring</li>
        <li class="text-slate-300">Integration with payment processors</li>
        <li class="text-slate-300">Case management workflow</li>
        <li class="text-slate-300">Explainable AI for regulators</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce fraud losses by 80%</li>
        <li class="text-slate-300">Meet regulatory requirements</li>
        <li class="text-slate-300">Minimize false positives</li>
        <li class="text-slate-300">Scale without adding analysts</li>
      </ul>
        </div>
