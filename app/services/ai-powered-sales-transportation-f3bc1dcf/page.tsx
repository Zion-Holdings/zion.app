...
export const metadata: Metadata = {
  title: 'AI-Powered sales-transportation',
  description: 'The future of transportation is here with AI-Powered sales-transportation. Powered by cutting-edge AI, this platform delivers brand sentiment like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-sales-transportation-f3bc1dcf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered sales-transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with AI-Powered sales-transportation. Powered by cutting-edge AI, this platform delivers brand sentiment like never before.
          </p>
