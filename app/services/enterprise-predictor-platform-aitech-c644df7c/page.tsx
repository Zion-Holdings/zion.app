...
export const metadata: Metadata = {
  title: 'Enterprise Predictor Platform - AITECH',
  description: 'Optimize your aitech workflows with Enterprise Predictor Platform - AITECH. This intelligent platform delivers ml model training through advanced automation and',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Predictor Platform - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your aitech workflows with Enterprise Predictor Platform - AITECH. This intelligent platform delivers ml model training through advanced automation and AI.
          </p>
