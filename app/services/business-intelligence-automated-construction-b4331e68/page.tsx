...
export const metadata: Metadata = {
  title: 'Business Intelligence Automated - Construction',
  description: 'Transform your construction operations with our Business Intelligence Automated - Construction. This AI-driven solution automates customer service automation wi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Business Intelligence Automated - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Business Intelligence Automated - Construction. This AI-driven solution automates customer service automation with unprecedented accuracy and efficiency.
          </p>
