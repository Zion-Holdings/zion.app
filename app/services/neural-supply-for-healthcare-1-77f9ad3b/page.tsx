...
export const metadata: Metadata = {
  title: 'Neural Supply for Healthcare #1',
  description: 'The future of healthcare is here with Neural Supply for Healthcare #1. Powered by cutting-edge AI, this platform delivers process automation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-supply-for-healthcare-1-77f9ad3b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Supply for Healthcare #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Neural Supply for Healthcare #1. Powered by cutting-edge AI, this platform delivers process automation like never before.
          </p>
