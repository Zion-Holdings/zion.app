...
export const metadata: Metadata = {
  title: 'Smart Finance Platform - PROPTECH',
  description: 'Revolutionize proptech through intelligent automation. Our Smart Finance Platform - PROPTECH leverages advanced machine learning to deliver training optimizatio',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Finance Platform - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our Smart Finance Platform - PROPTECH leverages advanced machine learning to deliver training optimization at scale.
          </p>
