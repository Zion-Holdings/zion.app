...
export const metadata: Metadata = {
  title: 'Automated Quality for Finance',
  description: 'Transform your finance operations with our Automated Quality for Finance. This AI-driven solution automates supply chain with unprecedented accuracy and efficie',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-quality-for-finance-28cedbe4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Quality for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Automated Quality for Finance. This AI-driven solution automates supply chain with unprecedented accuracy and efficiency.
          </p>
