...
export const metadata: Metadata = {
  title: 'Supply Intelligent - Retail',
  description: 'Revolutionize retail through intelligent automation. Our Supply Intelligent - Retail leverages advanced machine learning to deliver enterprise-grade insights at',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/supply-intelligent-retail-f8bec189',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Supply Intelligent - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize retail through intelligent automation. Our Supply Intelligent - Retail leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
