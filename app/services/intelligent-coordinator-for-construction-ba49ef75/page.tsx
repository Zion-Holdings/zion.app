export const metadata = {
  title: "Intelligent Coordinator for Construction",
  description: "Zion Tech Group delivers Intelligent Coordinator for Construction with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/services/intelligent-coordinator-for-construction-ba49ef75/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>Intelligent Coordinator for Construction</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers Intelligent Coordinator for Construction with measurable outcomes.
      </p>
