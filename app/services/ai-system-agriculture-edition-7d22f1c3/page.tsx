...
export const metadata: Metadata = {
  title: 'AI System - Agriculture Edition',
  description: 'Enhance your agriculture business with AI System - Agriculture Edition. Our solution provides disaster recovery with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-system-agriculture-edition-7d22f1c3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI System - Agriculture Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your agriculture business with AI System - Agriculture Edition. Our solution provides disaster recovery with enterprise-grade reliability and security.
          </p>
