...
export const metadata: Metadata = {
  title: 'Sales Smart - Healthcare',
  description: 'Drive innovation in healthcare with Sales Smart - Healthcare. This AI-powered platform transforms budget tracking into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/sales-smart-healthcare-3741cc5a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Sales Smart - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with Sales Smart - Healthcare. This AI-powered platform transforms budget tracking into a competitive advantage.
          </p>
