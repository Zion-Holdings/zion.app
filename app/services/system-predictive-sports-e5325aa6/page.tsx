...
export const metadata: Metadata = {
  title: 'System Predictive - Sports',
  description: 'Revolutionize sports through intelligent automation. Our System Predictive - Sports leverages advanced machine learning to deliver predictive modeling at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/system-predictive-sports-e5325aa6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            System Predictive - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our System Predictive - Sports leverages advanced machine learning to deliver predictive modeling at scale.
          </p>
