...
export const metadata: Metadata = {
  title: 'Cognitive Analytics Solution - Transportation',
  description: 'The future of transportation is here with Cognitive Analytics Solution - Transportation. Powered by cutting-edge AI, this platform delivers scenario planning li',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-analytics-solution-transportation-a11e38f5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Analytics Solution - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Cognitive Analytics Solution - Transportation. Powered by cutting-edge AI, this platform delivers scenario planning like never before.
          </p>
