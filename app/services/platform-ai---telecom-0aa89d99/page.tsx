...
export const metadata: Metadata = {
  title: 'Platform AI - Telecom',
  description: 'Transform your telecom operations with our Platform AI - Telecom. This AI-driven solution automates decision support with unprecedented accuracy and efficiency.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/platform-ai---telecom-0aa89d99',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your telecom operations with our Platform AI - Telecom. This AI-driven solution automates decision support with unprecedented accuracy and efficiency.
          </p>
