...
export const metadata: Metadata = {
  ...
  keywords: 'Application portfolio assessment, Migration strategy (6 Rs), Automated migration tools, Data migration, Testing and validation, Cost optimization, Training and knowledge transfer, Post-migration support, cloud, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cloud Migration Assessment &amp; Execution</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end cloud migration services. Assessment, planning, execution, and optimization for migrating workloads to AWS, Azure, or GCP.</p>
        ...
        <li class="text-slate-300">Migration strategy (6 Rs)</li>
        <li class="text-slate-300">Automated migration tools</li>
        <li class="text-slate-300">Data migration</li>
        <li class="text-slate-300">Testing and validation</li>
        <li class="text-slate-300">Cost optimization</li>
        <li class="text-slate-300">Training and knowledge transfer</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce migration risk</li>
        <li class="text-slate-300">Optimize cloud costs</li>
        <li class="text-slate-300">Minimize downtime</li>
        <li class="text-slate-300">Accelerate time to cloud</li>
      </ul>
        </div>
