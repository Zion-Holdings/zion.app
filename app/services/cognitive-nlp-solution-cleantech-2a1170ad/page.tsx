...
export const metadata: Metadata = {
  title: 'Cognitive NLP Solution - CLEANTECH',
  description: 'Unlock unprecedented growth with Cognitive NLP Solution - CLEANTECH. This autonomous system provides rpa orchestration with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-nlp-solution-cleantech-2a1170ad',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive NLP Solution - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Cognitive NLP Solution - CLEANTECH. This autonomous system provides rpa orchestration with zero manual intervention needed.
          </p>
