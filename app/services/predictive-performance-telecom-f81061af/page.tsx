...
export const metadata: Metadata = {
  title: 'Predictive performance-telecom',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive performance-telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in telecom with Predictive performance-telecom. This AI-powered platform transforms project portfolio into a competitive advantage.
          </p>
