...
export const metadata = {
  title: "Conversational AI for Fintech - Zion Tech Group",
  description: "Natural language processing system that handles fintech inquiries through intelligent chatbots.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/conversational-ai-for-fintech-31eea30d`
  }
};
