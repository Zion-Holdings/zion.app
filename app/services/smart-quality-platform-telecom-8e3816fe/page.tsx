...
export const metadata: Metadata = {
  title: 'Smart Quality Platform - Telecom',
  description: 'Next-generation telecom solution: Smart Quality Platform - Telecom. Combines energy management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-quality-platform-telecom-8e3816fe',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Quality Platform - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation telecom solution: Smart Quality Platform - Telecom. Combines energy management with adaptive intelligence for optimal results.
          </p>
