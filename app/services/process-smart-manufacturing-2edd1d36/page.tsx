...
export const metadata: Metadata = {
  title: 'Process Smart - Manufacturing',
  description: 'Next-generation manufacturing solution: Process Smart - Manufacturing. Combines competitive intelligence with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/process-smart-manufacturing-2edd1d36',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation manufacturing solution: Process Smart - Manufacturing. Combines competitive intelligence with adaptive intelligence for optimal results.
          </p>
