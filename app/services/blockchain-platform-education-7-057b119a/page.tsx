...
export const metadata: Metadata = {
  title: 'Blockchain Platform for Education - Batch 7',
  description: 'Advanced blockchain platform for Education industry. Leverages machine learning for advanced analytics and automation. Provides real-time insights and predictiv',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/blockchain-platform-education-7-057b119a',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Blockchain Platform for Education - Batch 7
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Advanced blockchain platform for Education industry. Leverages machine learning for advanced analytics and automation. Provides real-time insights and predictive capabilities for strategic decision-making.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Machine learning algorithms</li>
          <li className="text-gray-300">Automated workflows</li>
          <li className="text-gray-300">Data visualization</li>
          <li className="text-gray-300">Scalable architecture</li>
          </ul>
        </section>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-500/20">
          ...
          <p className="text-3xl font-bold text-purple-400 mb-4">$259</p>
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$719</p>
          <ul className="space-y-2 mb-4">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$2299</p>
          <ul className="space-y-2 mb-4">
