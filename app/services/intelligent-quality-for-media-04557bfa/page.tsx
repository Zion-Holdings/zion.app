...
export const metadata: Metadata = {
  title: 'Intelligent Quality for Media',
  description: 'Optimize your media workflows with Intelligent Quality for Media. This intelligent platform delivers net promoter score through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-quality-for-media-04557bfa',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Quality for Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your media workflows with Intelligent Quality for Media. This intelligent platform delivers net promoter score through advanced automation and AI.
          </p>
