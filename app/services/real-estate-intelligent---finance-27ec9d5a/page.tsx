...
export const metadata: Metadata = {
  title: 'Real Estate Intelligent - Finance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Real Estate Intelligent - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of finance is here with Real Estate Intelligent - Finance. Powered by cutting-edge AI, this platform delivers data processing like never before.
          </p>
