...
export const metadata: Metadata = {
  title: 'Microservices AI Meeting Assistant Pro',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Microservices AI Meeting Assistant Pro
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered microservices solution for productivity. AI-powered meeting assistant that generates agendas, takes notes, and schedules follow-ups.
          </p>
