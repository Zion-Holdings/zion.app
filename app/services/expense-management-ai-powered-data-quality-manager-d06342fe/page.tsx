...
export const metadata: Metadata = {
  title: 'Expense Management AI-Powered Data Quality Manager',
  description: 'expense management solution for sports & entertainment industry. Automatically detects, corrects, and prevents data quality issues using machine learning.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/expense-management-ai-powered-data-quality-manager-d06342fe',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Expense Management AI-Powered Data Quality Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            expense management solution for sports & entertainment industry. Automatically detects, corrects, and prevents data quality issues using machine learning.
          </p>
