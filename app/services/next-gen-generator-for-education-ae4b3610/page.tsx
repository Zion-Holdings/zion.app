...
export const metadata: Metadata = {
  title: 'Next-Gen Generator for Education',
  description: 'Next-generation education solution: Next-Gen Generator for Education. Combines resource planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-generator-for-education-ae4b3610',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Generator for Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation education solution: Next-Gen Generator for Education. Combines resource planning with adaptive intelligence for optimal results.
          </p>
