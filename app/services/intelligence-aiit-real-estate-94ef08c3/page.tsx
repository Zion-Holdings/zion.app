...
export const metadata: Metadata = {
  title: 'Intelligence AI/IT - Real-Estate',
  description: 'Revolutionize real-estate through intelligent automation. Our Intelligence AI/IT - Real-Estate leverages advanced machine learning to deliver resource utilizati',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligence-aiit-real-estate-94ef08c3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligence AI/IT - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our Intelligence AI/IT - Real-Estate leverages advanced machine learning to deliver resource utilization at scale.
          </p>
