...
export const metadata: Metadata = {
  ...
  keywords: 'Intelligent ticket classification, Auto-resolution engine, Self-service knowledge base, SLA monitoring and escalation, Performance analytics, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Service Desk Automation</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered IT service management with intelligent ticket routing, auto-resolution, self-service portals, and SLA monitoring.</p>
        ...
        <li class="text-slate-300">Intelligent ticket classification</li>
        <li class="text-slate-300">Auto-resolution engine</li>
        <li class="text-slate-300">Self-service knowledge base</li>
        <li class="text-slate-300">SLA monitoring and escalation</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with it service desk automation</li>
