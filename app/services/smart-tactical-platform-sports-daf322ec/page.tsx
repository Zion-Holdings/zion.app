...
export const metadata: Metadata = {
  title: 'Smart Tactical Platform - Sports',
  description: 'Hyper-accelerated sports solution: Smart Tactical Platform - Sports. Combines ml model training with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-tactical-platform-sports-daf322ec',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Tactical Platform - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated sports solution: Smart Tactical Platform - Sports. Combines ml model training with next-gen AI for maximum velocity.
          </p>
