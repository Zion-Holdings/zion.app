    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Never miss a regulatory deadline again</li>
            <li>Reduce compliance research time by 90%</li>
            <li>Automated reporting for SOC 2, HIPAA, GDPR</li>
            <li>Proactive risk mitigation before violations occur</li>
          </ul>
        </div>
