...
export const metadata: Metadata = {
  ...
  keywords: '150+ jurisdiction regulatory change tracking, AI-powered impact analysis on existing operations, Automated compliance gap detection, Real-time deadline and filing alerts, Audit-ready evidence collection, Integration with GRC platforms, ai, Healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Continuous regulatory change monitoring across 150+ jurisdictions with automated impact analysis, gap detection, and compliance report generation for financial services and healthcare.</p>
        ...
        <li class="text-slate-300">150+ jurisdiction regulatory change tracking</li>
        <li class="text-slate-300">AI-powered impact analysis on existing operations</li>
        <li class="text-slate-300">Automated compliance gap detection</li>
        <li class="text-slate-300">Real-time deadline and filing alerts</li>
        <li class="text-slate-300">Audit-ready evidence collection</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai regulatory compliance monitor</li>
