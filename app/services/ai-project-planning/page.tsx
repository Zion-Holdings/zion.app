...
export const metadata: Metadata = {
  ...
  keywords: 'Scope to WBS auto-generation, Resource allocation + critical path analysis, Risk register + contingency recommendation, Sync Jira Asana Monday, ai, Sustainability, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Project Planning &amp; Scheduling</h1>
        <p className="text-lg text-slate-300 mb-8">PM-grade AI: scope→WBS→resource allocation→critical path→risk register→milestone tracking. Syncs to Jira Asana Monday auto-updates when scope changes.</p>
        ...
        <li class="text-slate-300">Scope to WBS auto-generation</li>
        <li class="text-slate-300">Resource allocation + critical path analysis</li>
        <li class="text-slate-300">Risk register + contingency recommendation</li>
        <li class="text-slate-300">Sync Jira Asana Monday</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai project planning &amp; scheduling</li>
