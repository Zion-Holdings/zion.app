...
export const metadata: Metadata = {
  ...
  keywords: 'Usage analytics churn signal (feature adoption), Support ticket sentiment per account, Auto-created retention playbook per at-risk account, CSM engagement score card per tier cohort, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Customer Success Predictor</h1>
        <p className="text-lg text-slate-300 mb-8">Early churn signal detection via usage analytics + support ticket sentiment; auto-create retention playbook per at-risk account.</p>
        ...
        <li class="text-slate-300">Usage analytics churn signal (feature adoption)</li>
        <li class="text-slate-300">Support ticket sentiment per account</li>
        <li class="text-slate-300">Auto-created retention playbook per at-risk account</li>
        <li class="text-slate-300">CSM engagement score card per tier cohort</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with customer success predictor</li>
