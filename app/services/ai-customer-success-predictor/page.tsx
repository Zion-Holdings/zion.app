    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Proactively retain customers before they churn</li>
            <li>Shared context across CSM + engineering + product</li>
            <li>Retention playbook = no more fire-drill</li>
            <li>Churn signal visible in real-time</li>
          </ul>
        </div>
