      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Usage analytics churn signal (feature adoption)</li>
            <li className="text-purple-300">✓ Support ticket sentiment per account</li>
            <li className="text-purple-300">✓ Auto-created retention playbook per at-risk account</li>
            <li className="text-purple-300">✓ CSM engagement score card per tier cohort</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with customer success predictor</li>
