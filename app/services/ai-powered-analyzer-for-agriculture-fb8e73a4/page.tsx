...
export const metadata: Metadata = {
  title: 'AI-Powered Analyzer for Agriculture',
  description: 'Next-generation agriculture solution: AI-Powered Analyzer for Agriculture. Combines image recognition with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-analyzer-for-agriculture-fb8e73a4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Analyzer for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agriculture solution: AI-Powered Analyzer for Agriculture. Combines image recognition with adaptive intelligence for optimal results.
          </p>
