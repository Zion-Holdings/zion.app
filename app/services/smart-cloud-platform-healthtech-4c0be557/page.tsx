...
export const metadata: Metadata = {
  title: 'Smart Cloud Platform - HEALTHTECH',
  description: 'The future of healthtech is here with Smart Cloud Platform - HEALTHTECH. Powered by cutting-edge AI, this platform delivers career development like never before',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-cloud-platform-healthtech-4c0be557',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Cloud Platform - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthtech is here with Smart Cloud Platform - HEALTHTECH. Powered by cutting-edge AI, this platform delivers career development like never before.
          </p>
