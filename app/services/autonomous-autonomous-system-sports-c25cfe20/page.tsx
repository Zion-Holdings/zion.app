...
export const metadata: Metadata = {
  ...
  description: 'Drive innovation in sports with Autonomous Autonomous System - Sports. This AI-powered platform transforms access management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-autonomous-system-sports-c25cfe20',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in sports with Autonomous Autonomous System - Sports. This AI-powered platform transforms access management into a competitive advantage.
          </p>
