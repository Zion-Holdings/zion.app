...
export const metadata: Metadata = {
  ...
  description: 'Drive innovation in energy with Intelligent Manufacturing for Energy. This AI-powered platform transforms security monitoring into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-manufacturing-for-energy-22372e81',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Intelligent Manufacturing for Energy. This AI-powered platform transforms security monitoring into a competitive advantage.
          </p>
