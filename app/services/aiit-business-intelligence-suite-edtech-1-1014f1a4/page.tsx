...
export const metadata: Metadata = {
  title: 'AI/IT Business Intelligence Suite - EDTECH #1',
  description: 'Unlock unprecedented growth with AI/IT Business Intelligence Suite - EDTECH #1. This autonomous system provides hr analytics with zero manual intervention neede',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-business-intelligence-suite-edtech-1-1014f1a4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Business Intelligence Suite - EDTECH #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with AI/IT Business Intelligence Suite - EDTECH #1. This autonomous system provides hr analytics with zero manual intervention needed.
          </p>
