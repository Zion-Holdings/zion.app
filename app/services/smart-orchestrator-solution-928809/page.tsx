...
export const metadata: Metadata = {
  title: 'Smart Orchestrator Solution',
  description: 'Transform your retail operations with our Smart Orchestrator Solution. This cloud solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-orchestrator-solution-928809',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Orchestrator Solution
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our Smart Orchestrator Solution. This cloud solution delivers unprecedented automation and intelligence.
          </p>
