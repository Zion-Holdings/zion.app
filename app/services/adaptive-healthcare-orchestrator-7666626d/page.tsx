...
export const metadata: Metadata = {
  title: 'Adaptive Healthcare Orchestrator',
  description: 'Transform your real-estate operations with our Adaptive Healthcare Orchestrator. This AI-driven solution automates security monitoring with unprecedented accura',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-healthcare-orchestrator-7666626d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Healthcare Orchestrator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Adaptive Healthcare Orchestrator. This AI-driven solution automates security monitoring with unprecedented accuracy and efficiency.
          </p>
