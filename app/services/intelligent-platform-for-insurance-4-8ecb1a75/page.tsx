...
export const metadata: Metadata = {
  title: 'Intelligent Platform for Insurance #4',
  description: 'Drive innovation in insurance with Intelligent Platform for Insurance #4. This AI-powered platform transforms decision support into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-platform-for-insurance-4-8ecb1a75',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Platform for Insurance #4
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Intelligent Platform for Insurance #4. This AI-powered platform transforms decision support into a competitive advantage.
          </p>
