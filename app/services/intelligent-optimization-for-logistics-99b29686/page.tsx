...
export const metadata: Metadata = {
  title: 'Intelligent Optimization for Logistics',
  description: 'Transform your logistics operations with our Intelligent Optimization for Logistics. This AI-driven solution automates churn prediction with unprecedented accur',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Intelligent Optimization for Logistics. This AI-driven solution automates churn prediction with unprecedented accuracy and efficiency.
          </p>
