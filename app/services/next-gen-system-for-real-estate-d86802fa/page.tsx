...
export const metadata: Metadata = {
  title: 'Next-Gen System for Real-Estate',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen System for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated real-estate solution: Next-Gen System for Real-Estate. Combines training optimization with next-gen AI for maximum velocity.
          </p>
