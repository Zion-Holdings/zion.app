...
export const metadata: Metadata = {
  title: 'Smart Sourcing Smart',
  description: 'Optimize your gaming workflows with Smart Sourcing Smart. This intelligent platform delivers customer onboarding through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-sourcing-smart-34686459',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Sourcing Smart
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your gaming workflows with Smart Sourcing Smart. This intelligent platform delivers customer onboarding through advanced automation and AI.
          </p>
