...
export const metadata: Metadata = {
  title: 'Cognitive Data Manufacturing',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Data Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our Cognitive Data Manufacturing. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
