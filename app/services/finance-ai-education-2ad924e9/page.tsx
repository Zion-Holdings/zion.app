...
export const metadata: Metadata = {
  title: 'Finance AI - Education',
  description: 'Transform your education operations with our Finance AI - Education. This AI-driven solution automates social media monitoring with unprecedented accuracy and e',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your education operations with our Finance AI - Education. This AI-driven solution automates social media monitoring with unprecedented accuracy and efficiency.
          </p>
