...
export const metadata: Metadata = {
  title: 'Patient Data Management AI-Powered SEO Content Engine',
  description: 'patient data management solution for insurtech industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing cop',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/patient-data-management-ai-powered-seo-content-engine-69882444',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Patient Data Management AI-Powered SEO Content Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            patient data management solution for insurtech industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing copy.
          </p>
