...
export const metadata: Metadata = {
  title: 'AI Manufacturing - Construction Edition',
  description: 'Next-generation construction solution: AI Manufacturing - Construction Edition. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-manufacturing-construction-edition-51a54693',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Manufacturing - Construction Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: AI Manufacturing - Construction Edition. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
