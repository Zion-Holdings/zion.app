...
export const metadata = {
  ...
  description: 'End-to-end aiops for incident detection: reduce mttr with anomaly detection and root cause analysis services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/aiops-incident-detection-reduce-mttr-anomaly-detection-root-cause-analysis-9/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">AIOps for Incident Detection: Reduce MTTR with Anomaly Detection and Root Cause Analysis</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end aiops for incident detection: reduce mttr with anomaly detection and root cause analysis services: assessment, deployment, and managed operations.
        </p>
