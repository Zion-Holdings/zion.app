...
export const metadata: Metadata = {
  title: 'Automated manager-transportation',
  description: 'The future of transportation is here with Automated manager-transportation. Powered by cutting-edge AI, this platform delivers transformative results like never',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-manager-transportation-528c475e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated manager-transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Automated manager-transportation. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
