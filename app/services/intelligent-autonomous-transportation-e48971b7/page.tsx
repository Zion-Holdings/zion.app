...
export const metadata: Metadata = {
  title: 'Intelligent autonomous-transportation',
  description: 'Next-generation transportation solution: Intelligent autonomous-transportation. Combines vendor management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-autonomous-transportation-e48971b7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation transportation solution: Intelligent autonomous-transportation. Combines vendor management with adaptive intelligence for optimal results.
          </p>
