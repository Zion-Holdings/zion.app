...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Healthcare - HEALTHTECH',
  description: 'Optimize your healthtech workflows with Hyper-Accelerated Healthcare - HEALTHTECH. This intelligent platform delivers data quality through advanced automation a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/hyper-accelerated-healthcare-healthtech-49261256',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Healthcare - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthtech workflows with Hyper-Accelerated Healthcare - HEALTHTECH. This intelligent platform delivers data quality through advanced automation and AI.
          </p>
