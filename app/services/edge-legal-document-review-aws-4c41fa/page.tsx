...
export const metadata: Metadata = {
  title: 'Edge Legal Document Review AWS (Energy)',
  description: 'Edge Legal Document Review AWS (Energy) is an AI-powered energy solution that transforms how businesses operate through intelligent automation and real-time ana',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Edge Legal Document Review AWS (Energy)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Edge Legal Document Review AWS (Energy) is an AI-powered energy solution that transforms how businesses operate through intelligent automation and real-time analytics.
