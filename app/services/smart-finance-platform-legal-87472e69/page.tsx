...
export const metadata: Metadata = {
  title: 'Smart Finance Platform - Legal',
  description: 'Unlock unprecedented growth with Smart Finance Platform - Legal. This autonomous system provides supply chain with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-finance-platform-legal-87472e69',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Finance Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Finance Platform - Legal. This autonomous system provides supply chain with zero manual intervention needed.
          </p>
