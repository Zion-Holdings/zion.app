...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "AI Code Security Reviewer | Zion Tech Group",
    description: "Static application security testing (SAST) platform powered by large language models. Detects vulnerabilities, insecure patterns, and compliance issues in source code across 30+ languages with fix suggestions.",
    url: "https://ziontechgroup.com/services/ai-code-security-reviewer/",
    type: 'website',
  },
  alternates: { canonical: "/services/ai-code-security-reviewer/" },
};

export default function AiCodeSecurityReviewerPage() {
  return (
    <StandardPage
      title="AI Code Security Reviewer"
      subtitle="Static application security testing (SAST) platform powered by large language models. Detects vulnerabilities, insecure patterns, and compliance issues in source code across 30+ languages with fix suggestions."
      breadcrumbItems={[
        { label: "Home", href: "/" },
        { label: "Services", href: "/services/" },
        { label: "AI Code Security Reviewer" }
      ]}
      actions={[
    ...
    >
        ...
        <div className="rounded-2xl border border-white/10 bg-slate-900/40 p-5"><h2 className="text-white font-semibold mb-2">AI Code Security Reviewer</h2><p className="text-slate-400 text-sm">Archived section recovered from the live site snapshot.</p></div>
      ...
      <p className="text-slate-400 leading-relaxed mb-4 max-w-5xl mx-auto">Estimated timeline for AI Code Security Reviewer — adapt to your team size and complexity.</p>
      ...
      <p className="text-slate-500 text-sm max-w-5xl mx-auto">Restored from a Wayback Machine snapshot (20260614093258) of ziontechgroup.com.</p>
    </StandardPage>
  );
}
