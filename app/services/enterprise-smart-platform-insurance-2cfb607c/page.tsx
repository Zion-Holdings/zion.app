...
export const metadata: Metadata = {
  title: 'Enterprise Smart Platform - Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Enterprise Smart Platform - Insurance leverages advanced machine learning to deliver loyalty optimiz',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-smart-platform-insurance-2cfb607c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Smart Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Enterprise Smart Platform - Insurance leverages advanced machine learning to deliver loyalty optimization at scale.
          </p>
