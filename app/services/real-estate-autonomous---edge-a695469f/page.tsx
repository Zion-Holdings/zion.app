...
export const metadata: Metadata = {
  title: 'Real Estate Autonomous - Edge',
  description: 'Transform your edge operations with our Real Estate Autonomous - Edge. This AI-driven solution automates process automation with unprecedented accuracy and effi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/real-estate-autonomous---edge-a695469f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Real Estate Autonomous - Edge
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your edge operations with our Real Estate Autonomous - Edge. This AI-driven solution automates process automation with unprecedented accuracy and efficiency.
          </p>
