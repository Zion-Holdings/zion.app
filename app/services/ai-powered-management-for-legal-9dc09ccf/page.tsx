...
export const metadata: Metadata = {
  title: 'AI-Powered Management for Legal',
  description: 'Enhance your legal business with AI-Powered Management for Legal. Our solution provides user provisioning with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-management-for-legal-9dc09ccf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Management for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with AI-Powered Management for Legal. Our solution provides user provisioning with enterprise-grade reliability and security.
          </p>
