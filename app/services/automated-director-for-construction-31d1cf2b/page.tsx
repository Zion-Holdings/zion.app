...
export const metadata: Metadata = {
  ...
  keywords: 'Auto-scaling capabilities, Custom integrations, Microservices deployment, GDPR compliance, Audit trails, Comprehensive monitoring, advisor, construction, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Automated Director for Construction</h1>
        <p className="text-lg text-slate-300 mb-8">Transform your construction operations with our Automated Director for Construction. This AI-driven solution automates energy management with unprecedented accuracy and efficiency.</p>
