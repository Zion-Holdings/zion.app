...
export const metadata: Metadata = {
  title: 'Autonomous Cognitive System - Transportation',
  description: 'Optimize your transportation workflows with Autonomous Cognitive System - Transportation. This intelligent platform delivers market intelligence through advance',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Cognitive System - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Autonomous Cognitive System - Transportation. This intelligent platform delivers market intelligence through advanced automation and AI.
          </p>
