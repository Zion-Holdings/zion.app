...
export const metadata: Metadata = {
  title: 'Intelligent Operational for Education',
  description: 'Drive innovation in education with Intelligent Operational for Education. This AI-powered platform transforms event-driven architecture into a competitive advan',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Operational for Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in education with Intelligent Operational for Education. This AI-powered platform transforms event-driven architecture into a competitive advantage.
          </p>
