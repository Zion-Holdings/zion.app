...
export const metadata: Metadata = {
  title: 'Cloud Smart - Finance',
  description: 'Next-generation finance solution: Cloud Smart - Finance. Combines decision support with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cloud-smart---finance-53f59202',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation finance solution: Cloud Smart - Finance. Combines decision support with adaptive intelligence for optimal results.
          </p>
