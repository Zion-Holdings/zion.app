...
export const metadata: Metadata = {
  title: 'Intelligent Marketing for Construction',
  description: 'Next-generation construction solution: Intelligent Marketing for Construction. Combines performance tuning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-marketing-for-construction-0d9963d4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Marketing for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Intelligent Marketing for Construction. Combines performance tuning with adaptive intelligence for optimal results.
          </p>
