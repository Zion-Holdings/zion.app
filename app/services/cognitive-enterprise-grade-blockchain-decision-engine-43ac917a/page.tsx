...
export const metadata = {
  title: "Cognitive Enterprise-Grade Blockchain Decision Engine - Zion Tech Group",
  description: "Cognitive decision engine that processes enterprise-grade signals to drive blockchain strategy with deep learning.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/cognitive-enterprise-grade-blockchain-decision-engine-43ac917a`
  }
};
