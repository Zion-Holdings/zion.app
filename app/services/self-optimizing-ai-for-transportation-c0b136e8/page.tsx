...
export const metadata: Metadata = {
  title: 'Self-Optimizing AI for Transportation',
  description: 'Enhance your transportation business with Self-Optimizing AI for Transportation. Our solution provides churn prediction with enterprise-grade reliability and se',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing AI for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with Self-Optimizing AI for Transportation. Our solution provides churn prediction with enterprise-grade reliability and security.
          </p>
