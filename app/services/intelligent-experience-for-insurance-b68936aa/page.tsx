...
export const metadata: Metadata = {
  title: 'Intelligent Experience for Insurance',
  description: 'Optimize your insurance workflows with Intelligent Experience for Insurance. This intelligent platform delivers capacity management through advanced automation ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-experience-for-insurance-b68936aa',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Experience for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Intelligent Experience for Insurance. This intelligent platform delivers capacity management through advanced automation and AI.
          </p>
