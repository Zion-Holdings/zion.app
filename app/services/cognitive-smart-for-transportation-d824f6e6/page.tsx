...
export const metadata: Metadata = {
  title: 'Cognitive Smart for Transportation',
  description: 'Drive innovation in transportation with Cognitive Smart for Transportation. This AI-powered platform transforms data quality into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-smart-for-transportation-d824f6e6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Smart for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in transportation with Cognitive Smart for Transportation. This AI-powered platform transforms data quality into a competitive advantage.
          </p>
