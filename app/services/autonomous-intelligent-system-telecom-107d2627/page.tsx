...
export const metadata: Metadata = {
  title: 'Autonomous Intelligent System - Telecom',
  description: 'The future of telecom is here with Autonomous Intelligent System - Telecom. Powered by cutting-edge AI, this platform delivers capacity management like never be',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-intelligent-system-telecom-107d2627',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Intelligent System - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of telecom is here with Autonomous Intelligent System - Telecom. Powered by cutting-edge AI, this platform delivers capacity management like never before.
          </p>
