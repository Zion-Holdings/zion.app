...
export const metadata: Metadata = {
  title: 'Data Catalog AI-Powered Dashboard Creation',
  description: 'AI-powered data catalog solution for bi. Auto-generates dashboards from data patterns and user behavior.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-catalog-ai-powered-dashboard-creation-7fc192d9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Catalog AI-Powered Dashboard Creation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered data catalog solution for bi. Auto-generates dashboards from data patterns and user behavior.
          </p>
