...
export const metadata: Metadata = {
  title: 'Autonomous Insights System - Energy #1',
  description: 'Transform your energy operations with our Autonomous Insights System - Energy #1. This AI-driven solution automates loyalty optimization with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-insights-system-energy-1-aee43fbf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Insights System - Energy #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Autonomous Insights System - Energy #1. This AI-driven solution automates loyalty optimization with unprecedented accuracy and efficiency.
          </p>
