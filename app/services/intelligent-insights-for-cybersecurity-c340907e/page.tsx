...
export const metadata: Metadata = {
  title: 'Intelligent Insights for Cybersecurity',
  description: 'Quantum leap forward for cybersecurity: Intelligent Insights for Cybersecurity. Uses quantum-inspired algorithms to deliver process discovery at exponential spe',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-insights-for-cybersecurity-c340907e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Insights for Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for cybersecurity: Intelligent Insights for Cybersecurity. Uses quantum-inspired algorithms to deliver process discovery at exponential speed.
          </p>
