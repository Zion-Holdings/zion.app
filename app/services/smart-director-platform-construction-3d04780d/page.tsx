...
export const metadata: Metadata = {
  title: 'Smart Director Platform - Construction',
  description: 'Next-generation construction solution: Smart Director Platform - Construction. Combines user experience with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-director-platform-construction-3d04780d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Director Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Smart Director Platform - Construction. Combines user experience with adaptive intelligence for optimal results.
          </p>
