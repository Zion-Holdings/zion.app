...
export const metadata: Metadata = {
  title: 'AI Intelligent - MARTECH Edition',
  description: 'Transform your martech operations with our AI Intelligent - MARTECH Edition. This AI-driven solution automates network optimization with unprecedented accuracy ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Intelligent - MARTECH Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your martech operations with our AI Intelligent - MARTECH Edition. This AI-driven solution automates network optimization with unprecedented accuracy and efficiency.
          </p>
