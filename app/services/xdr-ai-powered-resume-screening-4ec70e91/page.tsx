...
export const metadata: Metadata = {
  title: 'XDR AI-Powered Resume Screening',
  description: 'AI-powered xdr solution for hr. Automates candidate screening using NLP and skills matching.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/xdr-ai-powered-resume-screening-4ec70e91',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            XDR AI-Powered Resume Screening
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered xdr solution for hr. Automates candidate screening using NLP and skills matching.
          </p>
