...
export const metadata: Metadata = {
  title: 'Enterprise Feature Security',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in regtech with Enterprise Feature Security. This AI-powered platform transforms data quality into a competitive advantage.
          </p>
