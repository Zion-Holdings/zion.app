...
export const metadata: Metadata = {
  title: 'AI/IT Automation Suite - Telecom',
  description: 'Transform your telecom operations with our AI/IT Automation Suite - Telecom. This AI-driven solution automates sales forecasting with unprecedented accuracy and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-automation-suite-telecom-7e8e4c5d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Automation Suite - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your telecom operations with our AI/IT Automation Suite - Telecom. This AI-driven solution automates sales forecasting with unprecedented accuracy and efficiency.
          </p>
