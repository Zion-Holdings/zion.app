...
export const metadata: Metadata = {
  title: 'Marketing Adaptive - Automotive',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Marketing Adaptive - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of automotive is here with Marketing Adaptive - Automotive. Powered by cutting-edge AI, this platform delivers risk assessment like never before.
          </p>
