...
export const metadata: Metadata = {
  title: 'Adaptive User Automation',
  description: 'Next-generation technology solution: Adaptive User Automation. Combines decision support with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-user-automation-5acf7e16',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive User Automation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation technology solution: Adaptive User Automation. Combines decision support with adaptive intelligence for optimal results.
          </p>
