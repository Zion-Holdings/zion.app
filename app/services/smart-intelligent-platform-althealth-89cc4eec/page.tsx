...
export const metadata: Metadata = {
  title: 'Smart Intelligent Platform - ALTHEALTH',
  description: 'Optimize your althealth workflows with Smart Intelligent Platform - ALTHEALTH. This intelligent platform delivers audit trail management through advanced automa',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Intelligent Platform - ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your althealth workflows with Smart Intelligent Platform - ALTHEALTH. This intelligent platform delivers audit trail management through advanced automation and AI.
          </p>
