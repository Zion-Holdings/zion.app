...
export const metadata: Metadata = {
  title: 'Autonomous healthcare-transportation',
  description: 'Enhance your transportation business with Autonomous healthcare-transportation. Our solution provides budget tracking with enterprise-grade reliability and secu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous healthcare-transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with Autonomous healthcare-transportation. Our solution provides budget tracking with enterprise-grade reliability and security.
          </p>
