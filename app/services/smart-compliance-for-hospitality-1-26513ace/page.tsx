...
export const metadata: Metadata = {
  title: 'Smart Compliance for Hospitality #1',
  description: 'The future of hospitality is here with Smart Compliance for Hospitality #1. Powered by cutting-edge AI, this platform delivers financial planning like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-compliance-for-hospitality-1-26513ace',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Compliance for Hospitality #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Smart Compliance for Hospitality #1. Powered by cutting-edge AI, this platform delivers financial planning like never before.
          </p>
