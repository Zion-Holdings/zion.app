...
export const metadata: Metadata = {
  title: 'AI/IT Cognitive Suite - Education',
  description: 'The future of education is here with AI/IT Cognitive Suite - Education. Powered by cutting-edge AI, this platform delivers dashboard automation like never befor',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Cognitive Suite - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of education is here with AI/IT Cognitive Suite - Education. Powered by cutting-edge AI, this platform delivers dashboard automation like never before.
          </p>
