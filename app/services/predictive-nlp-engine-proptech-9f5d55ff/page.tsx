...
export const metadata: Metadata = {
  title: 'Predictive NLP Engine - PROPTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive NLP Engine - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your proptech business with Predictive NLP Engine - PROPTECH. Our solution provides background checks with enterprise-grade reliability and security.
          </p>
