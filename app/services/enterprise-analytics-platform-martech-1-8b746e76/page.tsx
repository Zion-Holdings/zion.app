...
export const metadata: Metadata = {
  title: 'Enterprise Analytics Platform - MARTECH #1',
  description: 'Transform your martech operations with our Enterprise Analytics Platform - MARTECH #1. This AI-driven solution automates feedback collection with unprecedented ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-analytics-platform-martech-1-8b746e76',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Analytics Platform - MARTECH #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your martech operations with our Enterprise Analytics Platform - MARTECH #1. This AI-driven solution automates feedback collection with unprecedented accuracy and efficiency.
          </p>
