...
export const metadata: Metadata = {
  title: 'AI-Driven Autonomous for Sports',
  description: 'Drive innovation in sports with AI-Driven Autonomous for Sports. This AI-powered platform transforms customer health into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-driven-autonomous-for-sports-9b9cfc30',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Driven Autonomous for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in sports with AI-Driven Autonomous for Sports. This AI-powered platform transforms customer health into a competitive advantage.
          </p>
