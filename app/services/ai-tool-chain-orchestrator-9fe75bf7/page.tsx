...
export const metadata: Metadata = {
  title: 'AI Tool Chain Orchestrator',
  description: 'Automatically discovers, chains, and optimizes AI tools for complex multi-step workflows.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-tool-chain-orchestrator-9fe75bf7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automatically discovers, chains, and optimizes AI tools for complex multi-step workflows.
          </p>
