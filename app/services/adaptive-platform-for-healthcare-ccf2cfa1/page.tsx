...
export const metadata: Metadata = {
  title: 'Adaptive Platform for Healthcare',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Platform for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with Adaptive Platform for Healthcare. This AI-powered platform transforms cost reduction into a competitive advantage.
          </p>
