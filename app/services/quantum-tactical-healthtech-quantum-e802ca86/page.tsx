...
export const metadata: Metadata = {
  title: 'Quantum Tactical - HEALTHTECH Quantum',
  description: 'Next-generation healthtech solution: Quantum Tactical - HEALTHTECH Quantum. Combines margin analysis with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-tactical-healthtech-quantum-e802ca86',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Tactical - HEALTHTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthtech solution: Quantum Tactical - HEALTHTECH Quantum. Combines margin analysis with adaptive intelligence for optimal results.
          </p>
