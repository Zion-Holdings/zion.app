...
export const metadata: Metadata = {
  title: 'Autonomous analytics-construction',
  description: 'Optimize your construction workflows with Autonomous analytics-construction. This intelligent platform delivers lead scoring through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-analytics-construction-6cacf0dd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous analytics-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Autonomous analytics-construction. This intelligent platform delivers lead scoring through advanced automation and AI.
          </p>
