...
export const metadata: Metadata = {
  title: 'Smart Marketing Platform - Logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Smart Marketing Platform - Logistics leverages advanced machine learning to deliver predictive analy',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Marketing Platform - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Smart Marketing Platform - Logistics leverages advanced machine learning to deliver predictive analytics at scale.
          </p>
