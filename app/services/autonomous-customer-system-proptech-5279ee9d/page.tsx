...
export const metadata: Metadata = {
  title: 'Autonomous Customer System - PROPTECH',
  description: 'Revolutionize proptech through intelligent automation. Our Autonomous Customer System - PROPTECH leverages advanced machine learning to deliver business continu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Customer System - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our Autonomous Customer System - PROPTECH leverages advanced machine learning to deliver business continuity at scale.
          </p>
