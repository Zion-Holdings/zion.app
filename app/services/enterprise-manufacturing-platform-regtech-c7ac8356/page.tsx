...
export const metadata: Metadata = {
  title: 'Enterprise Manufacturing Platform - REGTECH',
  description: 'The future of regtech is here with Enterprise Manufacturing Platform - REGTECH. Powered by cutting-edge AI, this platform delivers financial risk management lik',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-manufacturing-platform-regtech-c7ac8356',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Manufacturing Platform - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of regtech is here with Enterprise Manufacturing Platform - REGTECH. Powered by cutting-edge AI, this platform delivers financial risk management like never before.
          </p>
