...
export const metadata = {
  ...
  description: "Unlock unprecedented growth with Autonomous Computer Vision System - Tech #3. This autonomous system provides performance monitoring with zero manual interventi",
  alternates: {
