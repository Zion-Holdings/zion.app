...
export const metadata: Metadata = {
  title: 'Autonomous Business Intelligence for Transportation',
  description: 'Revolutionize transportation through intelligent automation. Our Autonomous Business Intelligence for Transportation leverages advanced machine learning to deli',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Business Intelligence for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize transportation through intelligent automation. Our Autonomous Business Intelligence for Transportation leverages advanced machine learning to deliver compliance reporting at scale.
          </p>
