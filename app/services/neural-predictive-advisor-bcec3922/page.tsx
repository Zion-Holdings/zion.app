...
export const metadata: Metadata = {
  title: 'Neural Predictive Advisor',
  description: 'The future of quantum is here with Neural Predictive Advisor. Powered by cutting-edge AI, this platform delivers customer insights like never before.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Predictive Advisor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of quantum is here with Neural Predictive Advisor. Powered by cutting-edge AI, this platform delivers customer insights like never before.
          </p>
