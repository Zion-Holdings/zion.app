  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path={`/services/{service_id}`} title="Cognitive Platform for Manufacturing" />
        <h1 className="text-4xl font-bold mb-6">Cognitive Platform for Manufacturing</h1>
        <p className="text-lg text-gray-300 mb-8">Transform your manufacturing operations with our Cognitive Platform for Manufacturing. This AI-driven solution automates risk assessment with unprecedented accu</p>
