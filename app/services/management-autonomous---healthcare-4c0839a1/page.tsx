...
export const metadata: Metadata = {
  title: 'Management Autonomous - Healthcare',
  description: 'The future of healthcare is here with Management Autonomous - Healthcare. Powered by cutting-edge AI, this platform delivers risk assessment like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/management-autonomous---healthcare-4c0839a1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Management Autonomous - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Management Autonomous - Healthcare. Powered by cutting-edge AI, this platform delivers risk assessment like never before.
          </p>
