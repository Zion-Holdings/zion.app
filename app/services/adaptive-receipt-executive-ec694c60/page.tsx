...
export const metadata: Metadata = {
  title: 'Adaptive Receipt Executive',
  description: 'Optimize your energy workflows with Adaptive Receipt Executive. This intelligent platform delivers low-code automation through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-receipt-executive-ec694c60',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Receipt Executive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your energy workflows with Adaptive Receipt Executive. This intelligent platform delivers low-code automation through advanced automation and AI.
          </p>
