...
export const metadata: Metadata = {
  title: 'Intelligent Coordinator for Transportation',
  description: 'Drive innovation in transportation with Intelligent Coordinator for Transportation. This AI-powered platform transforms expense management into a competitive ad',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-coordinator-for-transportation-b3fb4d23',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Coordinator for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in transportation with Intelligent Coordinator for Transportation. This AI-powered platform transforms expense management into a competitive advantage.
          </p>
