...
export const metadata: Metadata = {
  title: 'Computer Vision Automated - Insurance',
  description: 'Transform your insurance operations with our Computer Vision Automated - Insurance. This AI-driven solution provides intelligent automation with unprecedented a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/computer-vision-automated-insurance-868113e0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Computer Vision Automated - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Computer Vision Automated - Insurance. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
