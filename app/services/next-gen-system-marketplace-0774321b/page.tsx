...
export const metadata: Metadata = {
  title: 'Next-Gen System - Marketplace',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen System - Marketplace
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform marketplace with Next-Gen System - Marketplace - the intelligent automation platform that learns, adapts, and delivers 10x results.
          </p>
