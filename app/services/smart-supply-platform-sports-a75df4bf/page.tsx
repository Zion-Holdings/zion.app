...
export const metadata: Metadata = {
  ...
  description: 'Unlock unprecedented growth with Smart Supply Platform - Sports. This autonomous system provides edge computing with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-supply-platform-sports-a75df4bf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Supply Platform - Sports. This autonomous system provides edge computing with zero manual intervention needed.
          </p>
