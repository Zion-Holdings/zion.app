...
export const metadata: Metadata = {
  title: 'Experience Automated - Logistics #1',
  description: 'Revolutionize logistics through intelligent automation. Our Experience Automated - Logistics #1 leverages advanced machine learning to deliver invoice processin',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Experience Automated - Logistics #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Experience Automated - Logistics #1 leverages advanced machine learning to deliver invoice processing at scale.
          </p>
