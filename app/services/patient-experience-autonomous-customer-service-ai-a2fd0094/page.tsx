...
export const metadata: Metadata = {
  title: 'Patient Experience Autonomous Customer Service AI',
  description: 'patient experience solution for space technology industry. Fully automated customer support system that handles 80% of inquiries without human intervention.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/patient-experience-autonomous-customer-service-ai-a2fd0094',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Patient Experience Autonomous Customer Service AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            patient experience solution for space technology industry. Fully automated customer support system that handles 80% of inquiries without human intervention.
          </p>
