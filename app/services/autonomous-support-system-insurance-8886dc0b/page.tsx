...
export const metadata: Metadata = {
  title: 'Autonomous Support System - Insurance',
  description: 'Drive innovation in insurance with Autonomous Support System - Insurance. This AI-powered platform transforms maintenance scheduling into a competitive advantag',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-support-system-insurance-8886dc0b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Support System - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Autonomous Support System - Insurance. This AI-powered platform transforms maintenance scheduling into a competitive advantage.
          </p>
