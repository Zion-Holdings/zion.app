...
export const metadata: Metadata = {
  ...
  keywords: 'Dependency vulnerability scanning, SBOM generation and management, Build provenance (SLSA level 1-4), Artifact signing (Sigstore, Cosign), Pipeline security hardening, Private package registry security, Integration with Snyk, Socket, Dependabot, security, DevSecOps, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Software Supply Chain Security</h1>
        <p className="text-lg text-slate-300 mb-8">Secure your software supply chain: dependency scanning, SBOM management, build provenance (SLSA), artifact signing, and pipeline hardening.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">security</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">DevSecOps</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Dependency vulnerability scanning</li>
        <li class="text-slate-300">SBOM generation and management</li>
        <li class="text-slate-300">Build provenance (SLSA level 1-4)</li>
        <li class="text-slate-300">Artifact signing (Sigstore, Cosign)</li>
        <li class="text-slate-300">Pipeline security hardening</li>
        <li class="text-slate-300">Private package registry security</li>
        <li class="text-slate-300">Integration with Snyk, Socket, Dependabot</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Prevent supply chain attacks (SolarWinds-style)</li>
        <li class="text-slate-300">SBOM for transparency and compliance</li>
        <li class="text-slate-300">SLSA provenance proves build integrity</li>
        <li class="text-slate-300">Artifact signing prevents tampering</li>
      </ul>
        </div>
