...
export const metadata: Metadata = {
  title: 'Smart Director Platform - HEALTHTECH',
  description: 'Transform your healthtech operations with our Smart Director Platform - HEALTHTECH. This AI-driven solution automates vendor management with unprecedented accur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-director-platform-healthtech-71ce4d83',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Director Platform - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthtech operations with our Smart Director Platform - HEALTHTECH. This AI-driven solution automates vendor management with unprecedented accuracy and efficiency.
          </p>
