...
export const metadata: Metadata = {
  title: 'Predictive System Engine - Manufacturing',
  description: 'Transform your manufacturing operations with our Predictive System Engine - Manufacturing. This AI-driven solution automates recommendation system with unpreced',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive System Engine - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your manufacturing operations with our Predictive System Engine - Manufacturing. This AI-driven solution automates recommendation system with unprecedented accuracy and efficiency.
          </p>
