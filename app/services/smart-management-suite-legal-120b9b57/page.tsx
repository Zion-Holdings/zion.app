...
export const metadata: Metadata = {
  title: 'Smart Management Suite - Legal',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Management Suite - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Smart Management Suite - Legal. Combines renewal prediction with adaptive intelligence for optimal results.
          </p>
