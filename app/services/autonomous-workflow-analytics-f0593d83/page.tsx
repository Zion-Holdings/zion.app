...
export const metadata: Metadata = {
  title: 'Autonomous Workflow Analytics',
  description: 'Revolutionize agritech through intelligent automation. Our Autonomous Workflow Analytics leverages advanced machine learning to deliver resource optimization at',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agritech through intelligent automation. Our Autonomous Workflow Analytics leverages advanced machine learning to deliver resource optimization at scale.
          </p>
