...
export const metadata: Metadata = {
  title: 'Intelligent Risk for Real-Estate',
  description: 'Revolutionize real-estate through intelligent automation. Our Intelligent Risk for Real-Estate leverages advanced machine learning to deliver procurement automa',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-risk-for-real-estate-df695d79',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Risk for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our Intelligent Risk for Real-Estate leverages advanced machine learning to deliver procurement automation at scale.
          </p>
