...
export const metadata: Metadata = {
  title: 'Quantum Insights - FINTECH Quantum',
  description: 'Drive innovation in fintech with Quantum Insights - FINTECH Quantum. This AI-powered platform transforms quality assurance into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-insights-fintech-quantum-9f044e2e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Insights - FINTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in fintech with Quantum Insights - FINTECH Quantum. This AI-powered platform transforms quality assurance into a competitive advantage.
          </p>
