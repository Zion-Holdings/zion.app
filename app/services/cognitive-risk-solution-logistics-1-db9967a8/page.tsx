...
export const metadata: Metadata = {
  title: 'Cognitive Risk Solution - Logistics #1',
  description: 'Drive innovation in logistics with Cognitive Risk Solution - Logistics #1. This AI-powered platform transforms vendor management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-risk-solution-logistics-1-db9967a8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Risk Solution - Logistics #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with Cognitive Risk Solution - Logistics #1. This AI-powered platform transforms vendor management into a competitive advantage.
          </p>
