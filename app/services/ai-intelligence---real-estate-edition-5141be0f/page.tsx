...
export const metadata: Metadata = {
  title: 'AI Intelligence - Real-Estate Edition',
  description: 'Revolutionize real-estate through intelligent automation. Our AI Intelligence - Real-Estate Edition leverages advanced machine learning to deliver process autom',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Intelligence - Real-Estate Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our AI Intelligence - Real-Estate Edition leverages advanced machine learning to deliver process automation at scale.
          </p>
