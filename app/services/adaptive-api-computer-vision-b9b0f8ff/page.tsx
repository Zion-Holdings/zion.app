...
export const metadata: Metadata = {
  title: 'Adaptive API Computer Vision',
  description: 'Transform your sports operations with our Adaptive API Computer Vision. This AI-driven solution automates user provisioning with unprecedented accuracy and effi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-api-computer-vision-b9b0f8ff',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive API Computer Vision
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our Adaptive API Computer Vision. This AI-driven solution automates user provisioning with unprecedented accuracy and efficiency.
          </p>
