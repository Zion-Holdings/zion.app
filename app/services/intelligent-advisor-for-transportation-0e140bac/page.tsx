...
export const metadata: Metadata = {
  title: 'Intelligent Advisor for Transportation',
  description: 'Transform your transportation operations with our Intelligent Advisor for Transportation. This AI-driven solution automates risk assessment with unprecedented a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-advisor-for-transportation-0e140bac',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Advisor for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your transportation operations with our Intelligent Advisor for Transportation. This AI-driven solution automates risk assessment with unprecedented accuracy and efficiency.
          </p>
