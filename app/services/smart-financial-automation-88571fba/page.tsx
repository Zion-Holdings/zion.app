...
export const metadata: Metadata = {
  title: 'Smart Financial Automation',
  description: 'Transform your manufacturing operations with our Smart Financial Automation. This AI-driven solution provides intelligent automation with unprecedented accuracy',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-financial-automation-88571fba',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your manufacturing operations with our Smart Financial Automation. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
