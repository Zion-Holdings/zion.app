...
export const metadata: Metadata = {
  title: 'Analytics Intelligent - Manufacturing',
  description: 'Revolutionize manufacturing through intelligent automation. Our Analytics Intelligent - Manufacturing leverages advanced machine learning to deliver image recog',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Analytics Intelligent - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize manufacturing through intelligent automation. Our Analytics Intelligent - Manufacturing leverages advanced machine learning to deliver image recognition at scale.
          </p>
