...
export const metadata: Metadata = {
  title: 'AI Intelligence - Healthcare Edition #1',
  description: 'Transform your healthcare operations with our AI Intelligence - Healthcare Edition #1. This AI-driven solution automates customer onboarding with unprecedented ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-intelligence-healthcare-edition-1-b65c5ec6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Intelligence - Healthcare Edition #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our AI Intelligence - Healthcare Edition #1. This AI-driven solution automates customer onboarding with unprecedented accuracy and efficiency.
          </p>
