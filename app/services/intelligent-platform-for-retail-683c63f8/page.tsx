...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize retail through intelligent automation. Our Intelligent Platform for Retail leverages advanced machine learning to deliver energy management at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize retail through intelligent automation. Our Intelligent Platform for Retail leverages advanced machine learning to deliver energy management at scale.
          </p>
