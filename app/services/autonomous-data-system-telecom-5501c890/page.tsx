...
export const metadata: Metadata = {
  title: 'Autonomous Data System - Telecom',
  description: 'Revolutionize telecom through intelligent automation. Our Autonomous Data System - Telecom leverages advanced machine learning to deliver project portfolio at s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-data-system-telecom-5501c890',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Data System - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Autonomous Data System - Telecom leverages advanced machine learning to deliver project portfolio at scale.
          </p>
