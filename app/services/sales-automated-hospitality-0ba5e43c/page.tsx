...
export const metadata: Metadata = {
  title: 'Sales Automated - Hospitality',
  description: 'Next-generation hospitality solution: Sales Automated - Hospitality. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/sales-automated-hospitality-0ba5e43c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Sales Automated - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Sales Automated - Hospitality. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
