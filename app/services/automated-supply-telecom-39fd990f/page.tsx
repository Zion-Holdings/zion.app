...
export const metadata: Metadata = {
  title: 'Automated supply-telecom',
  description: 'Optimize your telecom workflows with Automated supply-telecom. This intelligent platform delivers image recognition through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-supply-telecom-39fd990f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated supply-telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your telecom workflows with Automated supply-telecom. This intelligent platform delivers image recognition through advanced automation and AI.
          </p>
