...
export const metadata: Metadata = {
  title: 'Enterprise NLP Platform - Automotive',
  description: 'Drive innovation in automotive with Enterprise NLP Platform - Automotive. This AI-powered platform transforms project portfolio into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-nlp-platform-automotive-31ea1b30',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise NLP Platform - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in automotive with Enterprise NLP Platform - Automotive. This AI-powered platform transforms project portfolio into a competitive advantage.
          </p>
