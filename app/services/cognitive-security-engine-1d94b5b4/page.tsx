...
export const metadata: Metadata = {
  title: 'Cognitive Security Engine',
  description: 'Revolutionize sports through intelligent automation. Our Cognitive Security Engine leverages advanced machine learning to deliver maintenance scheduling at scal',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Cognitive Security Engine leverages advanced machine learning to deliver maintenance scheduling at scale.
          </p>
