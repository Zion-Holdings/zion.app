...
export const metadata: Metadata = {
  ...
  description: 'The future of energy is here with Intelligent Predictive Analytics. Powered by cutting-edge AI, this platform delivers financial risk management like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-predictive-analytics-90c4b07c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Intelligent Predictive Analytics. Powered by cutting-edge AI, this platform delivers financial risk management like never before.
          </p>
