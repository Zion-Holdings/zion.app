...
export const metadata: Metadata = {
  title: 'Intelligent Optimizer for Healthcare',
  description: 'Optimize your healthcare workflows with Intelligent Optimizer for Healthcare. This intelligent platform delivers api management through advanced automation and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-optimizer-for-healthcare-0da89305',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Optimizer for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Intelligent Optimizer for Healthcare. This intelligent platform delivers api management through advanced automation and AI.
          </p>
