...
export const metadata: Metadata = {
  title: 'Autonomous Performance System - Construction',
  description: 'Unlock unprecedented growth with Autonomous Performance System - Construction. This autonomous system provides process automation with zero manual intervention ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-performance-system-construction-6695a42b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Performance System - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Autonomous Performance System - Construction. This autonomous system provides process automation with zero manual intervention needed.
          </p>
