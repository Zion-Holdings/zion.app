...
export const metadata: Metadata = {
  title: 'Supplier Risk Management AI-Powered Data Quality Manager',
  description: 'supplier risk management solution for animal care industry. Automatically detects, corrects, and prevents data quality issues using machine learning.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/supplier-risk-management-ai-powered-data-quality-manager-74c4c231',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Supplier Risk Management AI-Powered Data Quality Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            supplier risk management solution for animal care industry. Automatically detects, corrects, and prevents data quality issues using machine learning.
          </p>
