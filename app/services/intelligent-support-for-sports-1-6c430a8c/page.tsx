...
export const metadata: Metadata = {
  title: 'Intelligent Support for Sports #1',
  description: 'Transform your sports operations with our Intelligent Support for Sports #1. This AI-driven solution automates risk assessment with unprecedented accuracy and e',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-support-for-sports-1-6c430a8c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Support for Sports #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our Intelligent Support for Sports #1. This AI-driven solution automates risk assessment with unprecedented accuracy and efficiency.
          </p>
