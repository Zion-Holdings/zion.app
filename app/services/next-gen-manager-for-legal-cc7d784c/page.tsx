...
export const metadata: Metadata = {
  title: 'Next-Gen Manager for Legal',
  description: 'Drive innovation in legal with Next-Gen Manager for Legal. This AI-powered platform transforms sales process optimization into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-manager-for-legal-cc7d784c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Manager for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Next-Gen Manager for Legal. This AI-powered platform transforms sales process optimization into a competitive advantage.
          </p>
