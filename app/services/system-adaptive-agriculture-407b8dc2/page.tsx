...
export const metadata: Metadata = {
  title: 'System Adaptive - Agriculture',
  description: 'The future of agriculture is here with System Adaptive - Agriculture. Powered by cutting-edge AI, this platform delivers transformative results like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/system-adaptive-agriculture-407b8dc2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            System Adaptive - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with System Adaptive - Agriculture. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
