...
export const metadata: Metadata = {
  title: 'Adaptive Customer Service Blockchain (Healthcare)',
  description: 'Adaptive Customer Service Blockchain (Healthcare) is an AI-powered healthcare solution that transforms how businesses operate through intelligent automation and',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Customer Service Blockchain (Healthcare)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Adaptive Customer Service Blockchain (Healthcare) is an AI-powered healthcare solution that transforms how businesses operate through intelligent automation and real-time analytics.
