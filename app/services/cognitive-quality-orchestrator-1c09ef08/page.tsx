...
export const metadata: Metadata = {
  title: 'Cognitive Quality Orchestrator',
  description: 'Transform your healthcare operations with our Cognitive Quality Orchestrator. This AI-driven solution automates financial planning with unprecedented accuracy a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Cognitive Quality Orchestrator. This AI-driven solution automates financial planning with unprecedented accuracy and efficiency.
          </p>
