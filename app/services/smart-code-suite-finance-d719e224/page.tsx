...
export const metadata: Metadata = {
  title: 'Smart Code Suite - Finance',
  description: 'Transform your finance operations with our Smart Code Suite - Finance. This AI-driven solution automates sourcing optimization with unprecedented accuracy and e',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Code Suite - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Smart Code Suite - Finance. This AI-driven solution automates sourcing optimization with unprecedented accuracy and efficiency.
          </p>
