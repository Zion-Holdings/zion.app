...
export const metadata: Metadata = {
  title: 'Intelligent Tactical for REGTECH',
  description: 'Optimize your regtech workflows with Intelligent Tactical for REGTECH. This intelligent platform delivers cost reduction through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-tactical-for-regtech-bb0a5a25',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Tactical for REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your regtech workflows with Intelligent Tactical for REGTECH. This intelligent platform delivers cost reduction through advanced automation and AI.
          </p>
