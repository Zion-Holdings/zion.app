...
export const metadata: Metadata = {
  title: 'Scalable IoT Device Management Ansible (Security)',
  description: 'Scalable IoT Device Management Ansible (Security) is an AI-powered security solution that transforms how businesses operate through intelligent automation and r',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/scalable-iot-device-management-248ba4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Scalable IoT Device Management Ansible (Security)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Scalable IoT Device Management Ansible (Security) is an AI-powered security solution that transforms how businesses operate through intelligent automation and real-time analytics.
