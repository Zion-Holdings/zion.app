...
export const metadata: Metadata = {
  title: 'Space Management AI-Powered Log Analysis',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Space Management AI-Powered Log Analysis
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered space management solution for devops. Automated log analysis for incident detection and root cause analysis.
          </p>
