...
export const metadata: Metadata = {
  title: 'AI-Powered scheduling-education',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered scheduling-education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your education workflows with AI-Powered scheduling-education. This intelligent platform delivers energy management through advanced automation and AI.
          </p>
