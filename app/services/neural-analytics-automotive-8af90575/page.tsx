...
export const metadata: Metadata = {
  title: 'Neural analytics-automotive',
  description: 'Revolutionize automotive through intelligent automation. Our Neural analytics-automotive leverages advanced machine learning to deliver document processing at s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural analytics-automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize automotive through intelligent automation. Our Neural analytics-automotive leverages advanced machine learning to deliver document processing at scale.
          </p>
