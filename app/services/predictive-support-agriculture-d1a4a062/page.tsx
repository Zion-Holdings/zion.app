...
export const metadata: Metadata = {
  title: 'Predictive support-agriculture',
  description: 'The future of agriculture is here with Predictive support-agriculture. Powered by cutting-edge AI, this platform delivers serverless deployment like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-support-agriculture-d1a4a062',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive support-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Predictive support-agriculture. Powered by cutting-edge AI, this platform delivers serverless deployment like never before.
          </p>
