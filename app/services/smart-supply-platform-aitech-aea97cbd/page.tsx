...
export const metadata: Metadata = {
  title: 'Smart Supply Platform - AITECH',
  description: 'Drive innovation in aitech with Smart Supply Platform - AITECH. This AI-powered platform transforms inventory management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-supply-platform-aitech-aea97cbd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Supply Platform - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in aitech with Smart Supply Platform - AITECH. This AI-powered platform transforms inventory management into a competitive advantage.
          </p>
