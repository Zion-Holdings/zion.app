...
export const metadata: Metadata = {
  title: 'Autonomous Sales System - Telecom',
  description: 'Optimize your telecom workflows with Autonomous Sales System - Telecom. This intelligent platform delivers data quality through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-sales-system-telecom-26b77201',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Sales System - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your telecom workflows with Autonomous Sales System - Telecom. This intelligent platform delivers data quality through advanced automation and AI.
          </p>
