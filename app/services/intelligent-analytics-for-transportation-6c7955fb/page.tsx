...
export const metadata: Metadata = {
  title: 'Intelligent Analytics for Transportation',
  description: 'Next-generation transportation solution: Intelligent Analytics for Transportation. Combines container orchestration with adaptive intelligence for optimal resul',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-analytics-for-transportation-6c7955fb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Analytics for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation transportation solution: Intelligent Analytics for Transportation. Combines container orchestration with adaptive intelligence for optimal results.
          </p>
