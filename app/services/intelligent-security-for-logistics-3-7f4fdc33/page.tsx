...
export const metadata: Metadata = {
  title: 'Intelligent Security for Logistics #3',
  description: 'Unlock unprecedented growth with Intelligent Security for Logistics #3. This autonomous system provides decision support with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-security-for-logistics-3-7f4fdc33',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Security for Logistics #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Security for Logistics #3. This autonomous system provides decision support with zero manual intervention needed.
          </p>
