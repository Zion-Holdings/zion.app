...
export const metadata: Metadata = {
  title: 'AI Scale-up - REGTECH Edition',
  description: 'Next-generation regtech solution: AI Scale-up - REGTECH Edition. Combines record processing with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-scale-up-regtech-edition-b02d0ef1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Scale-up - REGTECH Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation regtech solution: AI Scale-up - REGTECH Edition. Combines record processing with adaptive intelligence for optimal results.
          </p>
