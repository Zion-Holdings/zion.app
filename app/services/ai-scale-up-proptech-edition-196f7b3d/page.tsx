...
export const metadata: Metadata = {
  title: 'AI Scale-up - PROPTECH Edition',
  description: 'Revolutionize proptech through intelligent automation. Our AI Scale-up - PROPTECH Edition leverages advanced machine learning to deliver testing automation at s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-scale-up-proptech-edition-196f7b3d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Scale-up - PROPTECH Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our AI Scale-up - PROPTECH Edition leverages advanced machine learning to deliver testing automation at scale.
          </p>
