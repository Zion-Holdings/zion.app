...
export const metadata: Metadata = {
  title: 'Smart Orchestrator Platform - Transportation',
  description: 'Enhance your transportation business with Smart Orchestrator Platform - Transportation. Our solution provides user experience with enterprise-grade reliability ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-orchestrator-platform-transportation-472f9139',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Orchestrator Platform - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with Smart Orchestrator Platform - Transportation. Our solution provides user experience with enterprise-grade reliability and security.
          </p>
