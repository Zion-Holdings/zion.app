...
export const metadata: Metadata = {
  title: 'Network Management AI-Powered Threat Detection System',
  description: 'network management solution for oil & gas industry. Real-time threat detection using behavioral analysis, anomaly detection, and machine learning.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/network-management-ai-powered-threat-detection-system-dc10247e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Network Management AI-Powered Threat Detection System
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            network management solution for oil & gas industry. Real-time threat detection using behavioral analysis, anomaly detection, and machine learning.
          </p>
