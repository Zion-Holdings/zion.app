...
export const metadata: Metadata = {
  title: 'AI-Powered suite-legal',
  description: 'Revolutionize legal through intelligent automation. Our AI-Powered suite-legal leverages advanced machine learning to deliver data pipeline orchestration at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered suite-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our AI-Powered suite-legal leverages advanced machine learning to deliver data pipeline orchestration at scale.
          </p>
