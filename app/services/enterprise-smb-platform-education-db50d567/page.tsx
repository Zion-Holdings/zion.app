...
export const metadata: Metadata = {
  title: 'Enterprise SMB Platform - Education',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise SMB Platform - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation education solution: Enterprise SMB Platform - Education. Combines customer onboarding with adaptive intelligence for optimal results.
          </p>
