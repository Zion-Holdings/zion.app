...
export const metadata: Metadata = {
  title: 'Security Cognitive - Retail',
  description: 'The future of retail is here with Security Cognitive - Retail. Powered by cutting-edge AI, this platform delivers language processing like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-cognitive---retail-f0e73a74',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Cognitive - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Security Cognitive - Retail. Powered by cutting-edge AI, this platform delivers language processing like never before.
          </p>
