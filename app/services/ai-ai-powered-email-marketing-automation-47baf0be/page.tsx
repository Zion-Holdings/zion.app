...
export const metadata: Metadata = {
  title: "AI AI-Powered Email Marketing Automation - AI-Powered AI Solution",
  description: "AI-powered ai solution for marketing. Automated email campaigns with dynamic content and A/B testing.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-ai-powered-email-marketing-automation-47baf0be",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI AI-Powered Email Marketing Automation - AI-Powered AI Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          AI-powered ai solution for marketing. Automated email campaigns with dynamic content and A/B testing.
        </p>
