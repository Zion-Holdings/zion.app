...
export const metadata: Metadata = {
  title: 'Generator Adaptive - Insurance',
  description: 'The future of insurance is here with Generator Adaptive - Insurance. Powered by cutting-edge AI, this platform delivers transformative results like never before',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/generator-adaptive-insurance-e4c2b5e6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Generator Adaptive - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Generator Adaptive - Insurance. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
