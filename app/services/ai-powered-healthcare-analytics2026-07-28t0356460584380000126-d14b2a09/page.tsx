...
export const metadata: Metadata = {
  ...
  description: 'Healthcare analytics with population health management and insights.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-healthcare-analytics2026-07-28t0356460584380000126-d14b2a09',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Healthcare analytics with population health management and insights.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Population health</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">30% better outcomes</li>
