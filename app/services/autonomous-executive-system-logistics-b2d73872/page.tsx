...
export const metadata: Metadata = {
  title: 'Autonomous Executive System - Logistics',
  description: 'Drive innovation in logistics with Autonomous Executive System - Logistics. This AI-powered platform transforms financial risk management into a competitive adv',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Executive System - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with Autonomous Executive System - Logistics. This AI-powered platform transforms financial risk management into a competitive advantage.
          </p>
