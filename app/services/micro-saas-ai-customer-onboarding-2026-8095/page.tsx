...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={@context: "https://schema.org", @type: "Service", name: "MicroSaaS Customer Onboarding | Zion Tech Group", description: "End-to-end microsaas customer onboarding services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/micro-saas-ai-customer-onboarding-2026-8095/"} />
