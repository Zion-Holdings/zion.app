...
export const metadata: Metadata = {
  title: 'Autonomous System System - Transportation',
  description: 'Enhance your transportation business with Autonomous System System - Transportation. Our solution provides ml model training with enterprise-grade reliability a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous System System - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with Autonomous System System - Transportation. Our solution provides ml model training with enterprise-grade reliability and security.
          </p>
