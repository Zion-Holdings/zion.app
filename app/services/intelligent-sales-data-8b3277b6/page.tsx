...
export const metadata: Metadata = {
  title: 'Intelligent Sales Data',
  description: 'The future of manufacturing is here with Intelligent Sales Data. Powered by cutting-edge AI, this platform delivers inventory management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-sales-data-8b3277b6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of manufacturing is here with Intelligent Sales Data. Powered by cutting-edge AI, this platform delivers inventory management like never before.
          </p>
