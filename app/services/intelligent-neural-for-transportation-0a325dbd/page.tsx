...
export const metadata: Metadata = {
  title: 'Intelligent Neural for Transportation',
  description: 'Optimize your transportation workflows with Intelligent Neural for Transportation. This intelligent platform delivers sales process optimization through advance',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-neural-for-transportation-0a325dbd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Neural for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Intelligent Neural for Transportation. This intelligent platform delivers sales process optimization through advanced automation and AI.
          </p>
