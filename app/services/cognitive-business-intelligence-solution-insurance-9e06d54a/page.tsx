...
export const metadata: Metadata = {
  title: 'Cognitive Business Intelligence Solution - Insurance',
  description: 'The future of insurance is here with Cognitive Business Intelligence Solution - Insurance. Powered by cutting-edge AI, this platform delivers campaign optimizat',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Business Intelligence Solution - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Cognitive Business Intelligence Solution - Insurance. Powered by cutting-edge AI, this platform delivers campaign optimization like never before.
          </p>
