...
export const metadata: Metadata = {
  title: 'Generator Neural - Logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Generator Neural - Logistics leverages advanced machine learning to deliver decision support at scal',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/generator-neural---logistics-002da031',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Generator Neural - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Generator Neural - Logistics leverages advanced machine learning to deliver decision support at scale.
          </p>
