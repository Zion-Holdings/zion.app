...
export const metadata: Metadata = {
  title: 'Autonomous Process Mining System - Insurance',
  description: 'Transform your insurance operations with our Autonomous Process Mining System - Insurance. This AI-driven solution automates workflow management with unpreceden',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-process-mining-system-insurance-3afea5fb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Process Mining System - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Autonomous Process Mining System - Insurance. This AI-driven solution automates workflow management with unprecedented accuracy and efficiency.
          </p>
