...
export const metadata: Metadata = {
  ...
  keywords: 'Contract clause extraction, Risk identification, Compliance checking, Redline suggestions, Version comparison, Obligation extraction, Deadline tracking, Template library, ai, Enterprise, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Legal Document Review Assistant</h1>
        <p className="text-lg text-slate-300 mb-8">Accelerate legal document review with AI-powered contract analysis, clause extraction, risk identification, and compliance checking. Reduces review time by 80% while improving accuracy. Supports NDAs, MSAs, and complex commercial agreements.</p>
        ...
        <li class="text-slate-300">Contract clause extraction</li>
        ...
        <li class="text-slate-300">Version comparison</li>
        <li class="text-slate-300">Obligation extraction</li>
        <li class="text-slate-300">Deadline tracking</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">80% faster document review</li>
        <li class="text-slate-300">99% clause detection accuracy</li>
        <li class="text-slate-300">Reduced legal costs</li>
      </ul>
        </div>
