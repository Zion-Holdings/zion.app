...
export const metadata: Metadata = {
  title: 'Smart Finance Platform - Logistics',
  description: 'Next-generation logistics solution: Smart Finance Platform - Logistics. Combines data pipeline orchestration with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-finance-platform-logistics-50cd2dce',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Finance Platform - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Smart Finance Platform - Logistics. Combines data pipeline orchestration with adaptive intelligence for optimal results.
          </p>
