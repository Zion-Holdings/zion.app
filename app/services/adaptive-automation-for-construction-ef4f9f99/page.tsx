...
export const metadata: Metadata = {
  title: 'Adaptive Automation for Construction',
  description: 'The future of construction is here with Adaptive Automation for Construction. Powered by cutting-edge AI, this platform delivers decision support like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-automation-for-construction-ef4f9f99',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Automation for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Adaptive Automation for Construction. Powered by cutting-edge AI, this platform delivers decision support like never before.
          </p>
