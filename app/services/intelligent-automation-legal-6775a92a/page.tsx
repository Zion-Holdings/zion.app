...
export const metadata: Metadata = {
  title: 'Intelligent automation-legal',
  description: 'Next-generation legal solution: Intelligent automation-legal. Combines training optimization with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-automation-legal-6775a92a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent automation-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Intelligent automation-legal. Combines training optimization with adaptive intelligence for optimal results.
          </p>
