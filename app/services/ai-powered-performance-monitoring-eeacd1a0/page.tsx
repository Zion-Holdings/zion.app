...
export const metadata = {
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-performance-monitoring-eeacd1a0`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">End-to-end performance monitoring with predictive insights.</p>
