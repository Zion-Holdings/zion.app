...
export const metadata: Metadata = {
  title: 'Enterprise Platform Platform - Hospitality',
  description: 'Transform your hospitality operations with our Enterprise Platform Platform - Hospitality. This AI-driven solution automates quality prediction with unprecedent',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-platform-platform-hospitality-d6001cf1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Platform Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Enterprise Platform Platform - Hospitality. This AI-driven solution automates quality prediction with unprecedented accuracy and efficiency.
          </p>
