...
export const metadata: Metadata = {
  title: 'Intelligent Generator for Construction',
  description: 'Enhance your construction business with Intelligent Generator for Construction. Our solution provides quality control with enterprise-grade reliability and secu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-generator-for-construction-e9709a4c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Generator for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Intelligent Generator for Construction. Our solution provides quality control with enterprise-grade reliability and security.
          </p>
