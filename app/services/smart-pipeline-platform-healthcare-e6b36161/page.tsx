  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path={`/services/{service_id}`} title="Smart Pipeline Platform - Healthcare" />
        <h1 className="text-4xl font-bold mb-6">Smart Pipeline Platform - Healthcare</h1>
        <p className="text-lg text-gray-300 mb-8">Revolutionize healthcare through intelligent automation. Our Smart Pipeline Platform - Healthcare leverages advanced machine learning to deliver monitoring syst</p>
