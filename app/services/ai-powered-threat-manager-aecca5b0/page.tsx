...
export const metadata: Metadata = {
  ...
  keywords: 'Offline capabilities, Cloud-native architecture, Machine learning integration, Rollback mechanisms, Serverless functions, analyzer, construction, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Powered Threat Manager</h1>
        <p className="text-lg text-slate-300 mb-8">Transform your construction operations with our AI-Powered Threat Manager. This AI-driven solution automates threat detection with unprecedented accuracy and efficiency.</p>
