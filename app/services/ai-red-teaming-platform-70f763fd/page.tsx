...
export const metadata: Metadata = {
  ...
  description: 'AI-powered adversarial testing to identify vulnerabilities and biases in AI systems before deployment.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-red-teaming-platform-70f763fd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            AI-powered adversarial testing to identify vulnerabilities and biases in AI systems before deployment.
          </p>
