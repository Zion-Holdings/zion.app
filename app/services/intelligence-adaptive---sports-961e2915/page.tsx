...
export const metadata: Metadata = {
  title: 'Intelligence Adaptive - Sports',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligence Adaptive - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Intelligence Adaptive - Sports. Powered by cutting-edge AI, this platform delivers content generation like never before.
          </p>
