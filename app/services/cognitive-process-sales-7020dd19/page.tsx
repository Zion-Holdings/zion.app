...
export const metadata: Metadata = {
  title: 'Cognitive Process Sales',
  description: 'The future of construction is here with Cognitive Process Sales. Powered by cutting-edge AI, this platform delivers scenario planning like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-process-sales-7020dd19',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Process Sales
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Cognitive Process Sales. Powered by cutting-edge AI, this platform delivers scenario planning like never before.
          </p>
