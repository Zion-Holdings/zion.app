...
export const metadata: Metadata = {
  ...
  keywords: 'AI triage auto-categorise ticket, KB article suggestion per ticket similarity, Auto-routing to correct team/queue, Agent copilot with runbook snippet per ticket, it, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Help Desk (AI-Powered)</h1>
        <p className="text-lg text-slate-300 mb-8">AI triage + KB auto-resolution, ticket routing, asset CMDB auto-link, and agent copilot with runbook-snippet suggestion per ticket.</p>
        ...
        <li class="text-slate-300">AI triage auto-categorise ticket</li>
        <li class="text-slate-300">KB article suggestion per ticket similarity</li>
        <li class="text-slate-300">Auto-routing to correct team/queue</li>
        <li class="text-slate-300">Agent copilot with runbook snippet per ticket</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with it help desk (ai-powered)</li>
