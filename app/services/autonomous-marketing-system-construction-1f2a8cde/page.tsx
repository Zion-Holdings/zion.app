...
export const metadata: Metadata = {
  title: 'Autonomous Marketing System - Construction',
  description: 'Next-generation construction solution: Autonomous Marketing System - Construction. Combines user provisioning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-marketing-system-construction-1f2a8cde',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Marketing System - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Autonomous Marketing System - Construction. Combines user provisioning with adaptive intelligence for optimal results.
          </p>
