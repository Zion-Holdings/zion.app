...
export const metadata: Metadata = {
  title: 'Autonomous AI System - CLEANTECH',
  description: 'The future of cleantech is here with Autonomous AI System - CLEANTECH. Powered by cutting-edge AI, this platform delivers logistics optimization like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-ai-system-cleantech-51cc1541',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous AI System - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of cleantech is here with Autonomous AI System - CLEANTECH. Powered by cutting-edge AI, this platform delivers logistics optimization like never before.
          </p>
