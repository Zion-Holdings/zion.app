...
export const metadata: Metadata = {
  title: 'Automated Experience for Retail',
  description: 'The future of retail is here with Automated Experience for Retail. Powered by cutting-edge AI, this platform delivers quality control like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-experience-for-retail-e1f8498b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Experience for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Automated Experience for Retail. Powered by cutting-edge AI, this platform delivers quality control like never before.
          </p>
