...
export const metadata: Metadata = {
  ...
  keywords: 'Code complexity and duplication analysis, Dependency health and vulnerability audit, Architecture drift detection, Test coverage and quality assessment, Prioritized remediation roadmap, ROI estimation for each debt item, Integration with SonarQube, CodeClimate, Dependabot, it, Software Development, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Technical Debt Assessment &amp; Remediation</h1>
        <p className="text-lg text-slate-300 mb-8">Comprehensive technical debt audit: code complexity, dependency health, architecture drift, and test coverage. Prioritized remediation roadmap with ROI estimates.</p>
        ...
        <li class="text-slate-300">Code complexity and duplication analysis</li>
        <li class="text-slate-300">Dependency health and vulnerability audit</li>
        <li class="text-slate-300">Architecture drift detection</li>
        <li class="text-slate-300">Test coverage and quality assessment</li>
        <li class="text-slate-300">Prioritized remediation roadmap</li>
        <li class="text-slate-300">ROI estimation for each debt item</li>
        <li class="text-slate-300">Integration with SonarQube, CodeClimate, Dependabot</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Quantify tech debt with hard metrics</li>
        <li class="text-slate-300">Prioritized roadmap focuses effort</li>
        <li class="text-slate-300">ROI estimates justify remediation investment</li>
        <li class="text-slate-300">Track debt reduction over time</li>
      </ul>
        </div>
