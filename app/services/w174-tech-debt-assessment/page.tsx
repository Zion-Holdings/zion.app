...
export const metadata = {
  ...
  description: "Comprehensive technical debt audit: code complexity, dependency health, architecture drift, and test coverage. Prioritized remediation roadmap with ROI estimate",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Technical Debt Assessment &amp; Remediation</h1>
