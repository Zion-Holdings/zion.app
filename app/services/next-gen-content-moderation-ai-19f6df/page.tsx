...
export const metadata: Metadata = {
  title: 'Next-Gen Content Moderation Airflow (Security)',
  description: 'Next-Gen Content Moderation Airflow (Security) is an AI-powered security solution that transforms how businesses operate through intelligent automation and real',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Content Moderation Airflow (Security)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-Gen Content Moderation Airflow (Security) is an AI-powered security solution that transforms how businesses operate through intelligent automation and real-time analytics.
