...
export const metadata: Metadata = {
  title: 'Smart Healthcare Platform - Gaming',
  description: 'Optimize your gaming workflows with Smart Healthcare Platform - Gaming. This intelligent platform delivers anomaly detection through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-healthcare-platform-gaming-df6051b4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Healthcare Platform - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your gaming workflows with Smart Healthcare Platform - Gaming. This intelligent platform delivers anomaly detection through advanced automation and AI.
          </p>
