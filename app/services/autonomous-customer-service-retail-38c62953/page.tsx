...
export const metadata: Metadata = {
  title: 'Autonomous customer service-retail',
  description: 'Revolutionize retail through intelligent automation. Our Autonomous customer service-retail leverages advanced machine learning to deliver security monitoring a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous customer service-retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize retail through intelligent automation. Our Autonomous customer service-retail leverages advanced machine learning to deliver security monitoring at scale.
          </p>
