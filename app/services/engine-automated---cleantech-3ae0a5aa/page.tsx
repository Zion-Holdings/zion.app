...
export const metadata: Metadata = {
  title: 'Engine Automated - Cleantech',
  description: 'Transform your cleantech operations with our Engine Automated - Cleantech. This AI-driven solution automates market intelligence with unprecedented accuracy and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/engine-automated---cleantech-3ae0a5aa',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Engine Automated - Cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your cleantech operations with our Engine Automated - Cleantech. This AI-driven solution automates market intelligence with unprecedented accuracy and efficiency.
          </p>
