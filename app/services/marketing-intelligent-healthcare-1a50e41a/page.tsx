...
export const metadata: Metadata = {
  title: 'Marketing Intelligent - Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Marketing Intelligent - Healthcare leverages advanced machine learning to deliver financial plannin',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/marketing-intelligent-healthcare-1a50e41a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Marketing Intelligent - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Marketing Intelligent - Healthcare leverages advanced machine learning to deliver financial planning at scale.
          </p>
