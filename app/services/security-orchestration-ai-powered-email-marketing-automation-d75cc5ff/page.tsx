...
export const metadata: Metadata = {
  title: 'Security Orchestration AI-Powered Email Marketing Automation',
  description: 'AI-powered security orchestration solution for marketing. Automated email campaigns with dynamic content and A/B testing.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-orchestration-ai-powered-email-marketing-automation-d75cc5ff',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Orchestration AI-Powered Email Marketing Automation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered security orchestration solution for marketing. Automated email campaigns with dynamic content and A/B testing.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">3x engagement</li>
          <li className="text-purple-300">Better conversions</li>
          </ul>
        </section>
