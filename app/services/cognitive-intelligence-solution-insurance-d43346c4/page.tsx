...
export const metadata: Metadata = {
  title: 'Cognitive Intelligence Solution - Insurance',
  description: 'Optimize your insurance workflows with Cognitive Intelligence Solution - Insurance. This intelligent platform delivers campaign optimization through advanced au',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-intelligence-solution-insurance-d43346c4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Intelligence Solution - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Cognitive Intelligence Solution - Insurance. This intelligent platform delivers campaign optimization through advanced automation and AI.
          </p>
