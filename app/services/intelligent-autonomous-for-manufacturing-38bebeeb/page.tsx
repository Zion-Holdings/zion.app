...
export const metadata: Metadata = {
  title: 'Intelligent Autonomous for Manufacturing',
  description: 'Next-generation manufacturing solution: Intelligent Autonomous for Manufacturing. Combines hr analytics with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-autonomous-for-manufacturing-38bebeeb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Autonomous for Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation manufacturing solution: Intelligent Autonomous for Manufacturing. Combines hr analytics with adaptive intelligence for optimal results.
          </p>
