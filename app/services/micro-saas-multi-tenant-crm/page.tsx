...
export const metadata: Metadata = {
  ...
  keywords: 'Contact management, Pipeline tracking, Email automation, Analytics, Tenant isolation, White-label branding, API access, Workflow automation, micro-saas, SaaS, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Multi-Tenant CRM Platform</h1>
        <p className="text-lg text-slate-300 mb-8">White-label CRM with contact management, pipeline tracking, email automation, and tenant isolation.</p>
        ...
        <li class="text-slate-300">Contact management</li>
        <li class="text-slate-300">Pipeline tracking</li>
        <li class="text-slate-300">Email automation</li>
        ...
        <li class="text-slate-300">Per-tenant isolation</li>
        <li class="text-slate-300">Revenue opportunity</li>
        <li class="text-slate-300">Complete customization</li>
      </ul>
        </div>
