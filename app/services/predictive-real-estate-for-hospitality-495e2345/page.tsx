...
export const metadata: Metadata = {
  title: 'Predictive Real Estate for Hospitality',
  description: 'Enhance your hospitality business with Predictive Real Estate for Hospitality. Our solution provides supply chain with enterprise-grade reliability and security',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-real-estate-for-hospitality-495e2345',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Real Estate for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Predictive Real Estate for Hospitality. Our solution provides supply chain with enterprise-grade reliability and security.
          </p>
