...
export const metadata: Metadata = {
  ...
  keywords: 'Document upload and indexing, Automatic chunking and embedding, REST and WebSocket APIs, Custom knowledge bases, Source citation in responses, Integration with OpenAI, Claude, Llama, Usage analytics, GDPR-compliant data handling, ai-services, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">RAG as a Service — Knowledge Retrieval API</h1>
        <p className="text-lg text-slate-300 mb-8">Plug-and-play Retrieval Augmented Generation. Upload documents, get a chatbot API. No ML team required.</p>
        ...
        <li class="text-slate-300">Document upload and indexing</li>
        <li class="text-slate-300">Automatic chunking and embedding</li>
        <li class="text-slate-300">REST and WebSocket APIs</li>
        <li class="text-slate-300">Custom knowledge bases</li>
        <li class="text-slate-300">Source citation in responses</li>
        <li class="text-slate-300">Integration with OpenAI, Claude, Llama</li>
        <li class="text-slate-300">Usage analytics</li>
        <li class="text-slate-300">GDPR-compliant data handling</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Build AI chatbots in minutes</li>
        <li class="text-slate-300">No ML expertise required</li>
        <li class="text-slate-300">Source-grounded responses</li>
        <li class="text-slate-300">Scale without infrastructure</li>
      </ul>
        </div>
