...
export const metadata: Metadata = {
  title: 'Cognitive Risk Finance',
  description: 'Revolutionize insurance through intelligent automation. Our Cognitive Risk Finance leverages advanced machine learning to deliver enterprise-grade insights at s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-risk-finance-94809793',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Risk Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Cognitive Risk Finance leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
