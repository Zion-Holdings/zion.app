...
export const metadata: Metadata = {
  title: 'Predictive Manager Engine - Construction',
  description: 'Transform your construction operations with our Predictive Manager Engine - Construction. This AI-driven solution automates threat detection with unprecedented ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-manager-engine-construction-60117c81',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Manager Engine - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Predictive Manager Engine - Construction. This AI-driven solution automates threat detection with unprecedented accuracy and efficiency.
          </p>
