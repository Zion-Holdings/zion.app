...
export const metadata: Metadata = {
  title: 'Cognitive Procurement Real Estate',
  description: 'Transform your education operations with our Cognitive Procurement Real Estate. This AI-driven solution automates social media monitoring with unprecedented acc',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Procurement Real Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your education operations with our Cognitive Procurement Real Estate. This AI-driven solution automates social media monitoring with unprecedented accuracy and efficiency.
          </p>
