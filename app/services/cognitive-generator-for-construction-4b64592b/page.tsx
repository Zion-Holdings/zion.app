...
export const metadata: Metadata = {
  title: 'Cognitive Generator for Construction',
  description: 'Optimize your construction workflows with Cognitive Generator for Construction. This intelligent platform delivers supply chain through advanced automation and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-generator-for-construction-4b64592b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Generator for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Cognitive Generator for Construction. This intelligent platform delivers supply chain through advanced automation and AI.
          </p>
