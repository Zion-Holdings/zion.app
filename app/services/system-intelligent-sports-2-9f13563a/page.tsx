...
export const metadata: Metadata = {
  title: 'System Intelligent - Sports #2',
  description: 'The future of sports is here with System Intelligent - Sports #2. Powered by cutting-edge AI, this platform delivers transformative results like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/system-intelligent-sports-2-9f13563a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            System Intelligent - Sports #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with System Intelligent - Sports #2. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
