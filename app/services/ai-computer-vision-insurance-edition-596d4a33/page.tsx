...
export const metadata: Metadata = {
  title: 'AI Computer Vision - Insurance Edition',
  description: 'Next-generation insurance solution: AI Computer Vision - Insurance Edition. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-computer-vision-insurance-edition-596d4a33',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Computer Vision - Insurance Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: AI Computer Vision - Insurance Edition. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
