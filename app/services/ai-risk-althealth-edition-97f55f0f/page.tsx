...
export const metadata: Metadata = {
  title: 'AI Risk - ALTHEALTH Edition',
  description: 'Optimize your althealth workflows with AI Risk - ALTHEALTH Edition. This intelligent platform delivers customer onboarding through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-risk-althealth-edition-97f55f0f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Risk - ALTHEALTH Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your althealth workflows with AI Risk - ALTHEALTH Edition. This intelligent platform delivers customer onboarding through advanced automation and AI.
          </p>
