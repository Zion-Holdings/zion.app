export const metadata = {
  ...
  description: "Zion Tech Group delivers Intelligent Customer Service for Healthcare with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/services/intelligent-customer-service-for-healthcare-d0f9c7ca/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>Intelligent Customer Service for Healthcare</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers Intelligent Customer Service for Healthcare with measurable outcomes.
      </p>
