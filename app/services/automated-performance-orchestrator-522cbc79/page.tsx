...
export const metadata: Metadata = {
  title: 'Automated Performance Orchestrator',
  description: 'The future of proptech is here with Automated Performance Orchestrator. Powered by cutting-edge AI, this platform delivers content generation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-performance-orchestrator-522cbc79',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Performance Orchestrator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with Automated Performance Orchestrator. Powered by cutting-edge AI, this platform delivers content generation like never before.
          </p>
