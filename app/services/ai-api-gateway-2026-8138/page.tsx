...
export const metadata = {
  ...
  alternates: { canonical: '/services/ai-api-gateway-2026-8138/' },

  openGraph: {
    title: 'AI API Gateway | Zion Tech Group',
    description: 'End-to-end ai api gateway services: assessment, deployment, and managed operations.',
    url: 'https://ziontechgroup.com/services/ai-api-gateway-2026-8138/',
...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={@context: "https://schema.org", @type: "Service", name: "AI API Gateway | Zion Tech Group", description: "End-to-end ai api gateway services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/ai-api-gateway-2026-8138/"} />
