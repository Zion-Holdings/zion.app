...
export const metadata: Metadata = {
  title: 'AI-Powered Generator for Iot',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Generator for Iot
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize iot through intelligent automation. Our AI-Powered Generator for Iot leverages advanced machine learning to deliver sales forecasting at scale.
          </p>
