...
export const metadata: Metadata = {
  title: 'Automated Processor for Hospitality',
  description: 'Next-generation hospitality solution: Automated Processor for Hospitality. Combines resource optimization with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-processor-for-hospitality-a9ae46f7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Processor for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Automated Processor for Hospitality. Combines resource optimization with adaptive intelligence for optimal results.
          </p>
