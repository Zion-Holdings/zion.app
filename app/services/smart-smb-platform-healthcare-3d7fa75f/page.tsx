...
export const metadata: Metadata = {
  title: 'Smart SMB Platform - Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Smart SMB Platform - Healthcare leverages advanced machine learning to deliver api composition at s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-smb-platform-healthcare-3d7fa75f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart SMB Platform - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Smart SMB Platform - Healthcare leverages advanced machine learning to deliver api composition at scale.
          </p>
