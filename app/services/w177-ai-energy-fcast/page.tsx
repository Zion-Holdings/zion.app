...
export const metadata: Metadata = {
  ...
  keywords: 'Short and long-term load forecasting, Renewable generation prediction (solar, wind), Demand response optimization, Weather-driven demand modeling, Energy price forecasting, Peak demand prediction and alerting, Integration with GE, Siemens SCADA, ai, Energy, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Energy Demand Forecaster</h1>
        <p className="text-lg text-slate-300 mb-8">ML energy demand forecasting: load prediction, renewable generation forecasting, demand response optimization.</p>
        ...
        <li class="text-slate-300">Short and long-term load forecasting</li>
        <li class="text-slate-300">Renewable generation prediction (solar</li>
        <li class="text-slate-300">wind)</li>
        <li class="text-slate-300">Demand response optimization</li>
        <li class="text-slate-300">Weather-driven demand modeling</li>
        <li class="text-slate-300">Energy price forecasting</li>
        <li class="text-slate-300">Peak demand prediction and alerting</li>
        <li class="text-slate-300">Integration with GE</li>
        <li class="text-slate-300">Siemens SCADA</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Accurate load forecasting reduces reserve costs</li>
        <li class="text-slate-300">Renewable prediction optimizes grid integration</li>
        <li class="text-slate-300">Demand response reduces peak pricing</li>
        <li class="text-slate-300">Price forecasting enables procurement savings</li>
      </ul>
        </div>
