...
export const metadata: Metadata = {
  ...
  keywords: 'Network & web application penetration testing, Vulnerability scanning & remediation, Security awareness training, Incident response & forensics, Compliance audits (SOC 2, ISO 27001), security, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cybersecurity &amp; Penetration Testing</h1>
        <p className="text-lg text-slate-300 mb-8">Comprehensive security assessments, vulnerability management, and incident response to protect your digital assets.</p>
        ...
        <li class="text-slate-300">Network &amp; web application penetration testing</li>
        <li class="text-slate-300">Vulnerability scanning &amp; remediation</li>
        <li class="text-slate-300">Security awareness training</li>
        <li class="text-slate-300">Incident response &amp; forensics</li>
        <li class="text-slate-300">Compliance audits (SOC 2, ISO 27001)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with cybersecurity &amp; penetration testing</li>
