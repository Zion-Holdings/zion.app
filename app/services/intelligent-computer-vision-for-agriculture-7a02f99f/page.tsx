...
export const metadata: Metadata = {
  title: 'Intelligent Computer Vision for Agriculture',
  description: 'Drive innovation in agriculture with Intelligent Computer Vision for Agriculture. This AI-powered platform transforms performance tuning into a competitive adva',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-computer-vision-for-agriculture-7a02f99f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Computer Vision for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in agriculture with Intelligent Computer Vision for Agriculture. This AI-powered platform transforms performance tuning into a competitive advantage.
          </p>
