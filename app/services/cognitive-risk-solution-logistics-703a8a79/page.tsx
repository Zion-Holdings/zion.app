...
export const metadata: Metadata = {
  title: 'Cognitive Risk Solution - Logistics',
  description: 'Enhance your logistics business with Cognitive Risk Solution - Logistics. Our solution provides revenue forecasting with enterprise-grade reliability and securi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-risk-solution-logistics-703a8a79',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Risk Solution - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with Cognitive Risk Solution - Logistics. Our solution provides revenue forecasting with enterprise-grade reliability and security.
          </p>
