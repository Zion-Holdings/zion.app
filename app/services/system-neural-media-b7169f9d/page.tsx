...
export const metadata: Metadata = {
  title: 'System Neural - Media',
  description: 'Revolutionize media through intelligent automation. Our System Neural - Media leverages advanced machine learning to deliver data pipeline orchestration at scal',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/system-neural-media-b7169f9d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize media through intelligent automation. Our System Neural - Media leverages advanced machine learning to deliver data pipeline orchestration at scale.
          </p>
