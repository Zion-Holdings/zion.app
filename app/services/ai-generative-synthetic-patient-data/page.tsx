      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Generate HIPAA-compliant synthetic patient records: realistic demographics, diagnoses, lab values, medications, and care pathways. Train ML models, validate software, and test integrations without real PHI.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ HIPAA-safe synthetic patient generation</li>
            <li className="text-purple-300">✓ Realistic diagnosis + procedure coding (ICD-10, CPT)</li>
            <li className="text-purple-300">✓ Configurable prevalence & comorbidity rates</li>
            <li className="text-purple-300">✓ FHIR R4 export format</li>
            <li className="text-purple-300">✓ Differential privacy guarantees</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai generative synthetic patient data engine</li>
