...
export const metadata: Metadata = {
  ...
  keywords: 'HIPAA-safe synthetic patient generation, Realistic diagnosis + procedure coding (ICD-10, CPT), Configurable prevalence & comorbidity rates, FHIR R4 export format, Differential privacy guarantees, ai, Healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Generative Synthetic Patient Data Engine</h1>
        <p className="text-lg text-slate-300 mb-8">Generate HIPAA-compliant synthetic patient records: realistic demographics, diagnoses, lab values, medications, and care pathways. Train ML models, validate software, and test integrations without real PHI.</p>
        ...
        <li class="text-slate-300">HIPAA-safe synthetic patient generation</li>
        <li class="text-slate-300">Realistic diagnosis + procedure coding (ICD-10, CPT)</li>
        <li class="text-slate-300">Configurable prevalence &amp; comorbidity rates</li>
        <li class="text-slate-300">FHIR R4 export format</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai generative synthetic patient data engine</li>
