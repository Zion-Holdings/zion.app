...
export const metadata: Metadata = {
  title: 'Next-Gen Director for CLEANTECH',
  description: 'Transform your cleantech operations with our Next-Gen Director for CLEANTECH. This AI-driven solution automates financial planning with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-director-for-cleantech-3ef3a381',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Director for CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your cleantech operations with our Next-Gen Director for CLEANTECH. This AI-driven solution automates financial planning with unprecedented accuracy and efficiency.
          </p>
