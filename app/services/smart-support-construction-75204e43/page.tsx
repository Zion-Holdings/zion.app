...
export const metadata: Metadata = {
  title: 'Smart support-construction',
  description: 'The future of construction is here with Smart support-construction. Powered by cutting-edge AI, this platform delivers security monitoring like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-support-construction-75204e43',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart support-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Smart support-construction. Powered by cutting-edge AI, this platform delivers security monitoring like never before.
          </p>
