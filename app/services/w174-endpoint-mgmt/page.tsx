...
export const metadata: Metadata = {
  ...
  keywords: 'Device enrollment (BYOD and corporate), Policy enforcement and configuration, Remote lock, wipe, and troubleshooting, Compliance monitoring and reporting, Integrated threat detection (EDR), OS and app deployment, Integration with Intune, Jamf, Workspace ONE, it, End User Computing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Endpoint Management &amp; Security (UEM)</h1>
        <p className="text-lg text-slate-300 mb-8">Unified endpoint management: device enrollment, policy enforcement, remote wipe, compliance, and threat detection across Windows, Mac, iOS, Android.</p>
        ...
        <li class="text-slate-300">Device enrollment (BYOD and corporate)</li>
        <li class="text-slate-300">Policy enforcement and configuration</li>
        <li class="text-slate-300">Remote lock, wipe, and troubleshooting</li>
        <li class="text-slate-300">Compliance monitoring and reporting</li>
        <li class="text-slate-300">Integrated threat detection (EDR)</li>
        <li class="text-slate-300">OS and app deployment</li>
        <li class="text-slate-300">Integration with Intune, Jamf, Workspace ONE</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Manage all platforms from one console</li>
        <li class="text-slate-300">Compliance enforcement automated</li>
        <li class="text-slate-300">Remote wipe protects lost/stolen devices</li>
        <li class="text-slate-300">Integrated EDR for endpoint security</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$6/device/mo</p>
              <p class="text-sm text-slate-400">Getting started plan</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              <h3 class="font-semibold text-white mb-2">Pro</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">$12/device/mo</p>
              <p class="text-sm text-slate-400">Most popular</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              <h3 class="font-semibold text-white mb-2">Enterprise</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">$25/device/mo</p>
