...
export const metadata: Metadata = {
  title: 'AI/IT Intelligence Suite - EDTECH',
  description: 'Next-generation edtech solution: AI/IT Intelligence Suite - EDTECH. Combines skills management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-intelligence-suite-edtech-ca073ed7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Intelligence Suite - EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation edtech solution: AI/IT Intelligence Suite - EDTECH. Combines skills management with adaptive intelligence for optimal results.
          </p>
