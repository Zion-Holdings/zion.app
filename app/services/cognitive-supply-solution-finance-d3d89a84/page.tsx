...
export const metadata: Metadata = {
  title: 'Cognitive Supply Solution - Finance',
  description: 'Drive innovation in finance with Cognitive Supply Solution - Finance. This AI-powered platform transforms feedback collection into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-supply-solution-finance-d3d89a84',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Supply Solution - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in finance with Cognitive Supply Solution - Finance. This AI-powered platform transforms feedback collection into a competitive advantage.
          </p>
