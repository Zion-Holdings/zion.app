...
export const metadata: Metadata = {
  title: 'Suite Automated - Agriculture',
  description: 'Enhance your agriculture business with Suite Automated - Agriculture. Our solution provides customer journey mapping with enterprise-grade reliability and secur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/suite-automated-agriculture-8495d14d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Suite Automated - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your agriculture business with Suite Automated - Agriculture. Our solution provides customer journey mapping with enterprise-grade reliability and security.
          </p>
