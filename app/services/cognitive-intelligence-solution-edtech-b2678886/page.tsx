...
export const metadata: Metadata = {
  title: 'Cognitive Intelligence Solution - EDTECH',
  description: 'Revolutionize edtech through intelligent automation. Our Cognitive Intelligence Solution - EDTECH leverages advanced machine learning to deliver edge computing ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Intelligence Solution - EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize edtech through intelligent automation. Our Cognitive Intelligence Solution - EDTECH leverages advanced machine learning to deliver edge computing at scale.
          </p>
