...
export const metadata: Metadata = {
  title: 'Next-Gen neural-technology',
  description: 'Quantum leap forward for technology: Next-Gen neural-technology. Uses quantum-inspired algorithms to deliver succession planning at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-neural-technology-e610d1a5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for technology: Next-Gen neural-technology. Uses quantum-inspired algorithms to deliver succession planning at exponential speed.
          </p>
