...
export const metadata: Metadata = {
  title: 'Intelligent Process Mining for Automotive',
  description: 'Drive innovation in automotive with Intelligent Process Mining for Automotive. This AI-powered platform transforms recruitment automation into a competitive adv',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Process Mining for Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in automotive with Intelligent Process Mining for Automotive. This AI-powered platform transforms recruitment automation into a competitive advantage.
          </p>
