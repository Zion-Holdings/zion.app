...
export const metadata: Metadata = {
  title: 'Quantum Optimization for Insurance',
  description: 'The future of insurance is here with Quantum Optimization for Insurance. Powered by cutting-edge AI, this platform delivers image recognition like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-optimization-for-insurance-06accb76',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Optimization for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Quantum Optimization for Insurance. Powered by cutting-edge AI, this platform delivers image recognition like never before.
          </p>
