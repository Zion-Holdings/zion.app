...
export const metadata: Metadata = {
  title: 'Automated devops-tech',
  description: 'Transform your technology operations with our Automated devops-tech. This AI-driven solution automates financial risk management with unprecedented accuracy and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-devops-tech-1ea85343',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated devops-tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your technology operations with our Automated devops-tech. This AI-driven solution automates financial risk management with unprecedented accuracy and efficiency.
          </p>
