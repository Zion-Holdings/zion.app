...
export const metadata: Metadata = {
  title: 'Intelligence Smart - Media',
  description: 'The future of media is here with Intelligence Smart - Media. Powered by cutting-edge AI, this platform delivers regulatory tracking like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligence-smart-media-41bda710',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligence Smart - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of media is here with Intelligence Smart - Media. Powered by cutting-edge AI, this platform delivers regulatory tracking like never before.
          </p>
