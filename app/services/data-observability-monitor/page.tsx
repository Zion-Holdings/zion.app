...
export const metadata: Metadata = {
  ...
  keywords: 'Column freshness and volume checks, Distribution drift detection, Schema-change alerting, End-to-end lineage viewer, Quality SLA dashboards, data, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Data Observability &amp; Quality Monitor</h1>
        <p className="text-lg text-slate-300 mb-8">Column-level freshness, volume, distribution drift, and schema-change detection across every pipeline and warehouse table with auto-generated lineage.</p>
        ...
        <li class="text-slate-300">Column freshness and volume checks</li>
        <li class="text-slate-300">Distribution drift detection</li>
        <li class="text-slate-300">Schema-change alerting</li>
        <li class="text-slate-300">End-to-end lineage viewer</li>
        <li class="text-slate-300">Quality SLA dashboards</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with data observability &amp; quality monitor</li>
