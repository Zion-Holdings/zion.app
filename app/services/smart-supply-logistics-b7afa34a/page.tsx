...
export const metadata: Metadata = {
  title: 'Smart supply-logistics',
  description: 'Enhance your logistics business with Smart supply-logistics. Our solution provides competitive intelligence with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-supply-logistics-b7afa34a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart supply-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with Smart supply-logistics. Our solution provides competitive intelligence with enterprise-grade reliability and security.
          </p>
