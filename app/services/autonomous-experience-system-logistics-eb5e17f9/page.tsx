...
export const metadata: Metadata = {
  title: 'Autonomous Experience System - Logistics',
  description: 'Enhance your logistics business with Autonomous Experience System - Logistics. Our solution provides compliance reporting with enterprise-grade reliability and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-experience-system-logistics-eb5e17f9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Experience System - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with Autonomous Experience System - Logistics. Our solution provides compliance reporting with enterprise-grade reliability and security.
          </p>
