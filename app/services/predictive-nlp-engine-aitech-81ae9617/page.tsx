...
export const metadata: Metadata = {
  title: 'Predictive NLP Engine - AITECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive NLP Engine - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in aitech with Predictive NLP Engine - AITECH. This AI-powered platform transforms feature engineering into a competitive advantage.
          </p>
