...
export const metadata: Metadata = {
  title: 'Smart AI Platform - AITECH',
  description: 'Optimize your aitech workflows with Smart AI Platform - AITECH. This intelligent platform delivers data fabric through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-ai-platform-aitech-783a0463',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart AI Platform - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your aitech workflows with Smart AI Platform - AITECH. This intelligent platform delivers data fabric through advanced automation and AI.
          </p>
