...
export const metadata: Metadata = {
  title: 'Smart Real Estate for Education',
  description: 'Drive innovation in education with Smart Real Estate for Education. This AI-powered platform transforms disaster recovery into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-real-estate-for-education-662cced0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Real Estate for Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in education with Smart Real Estate for Education. This AI-powered platform transforms disaster recovery into a competitive advantage.
          </p>
