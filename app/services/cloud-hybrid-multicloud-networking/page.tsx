...
export const metadata: Metadata = {
  ...
  keywords: 'Cloud-router fabric — single control-plane connects up to 40 VPCs/accounts, Site-to-cloud connectivity via WireGuard tunnel or IPSec with automated failover, Global anycast front-door with WAF + geo-ip routing per user, Zero-trust per-connection IAM authorization beyond the network boundary, cloud, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Zero-trust networking across on-prem/edge/cloud: cloud-router fabric connects VPCs across AWS/GCP/Azure, on-prem data-centre via WireGuard or IPSec, global anycast front-door with WAF.</p>
        ...
        <li class="text-slate-300">Cloud-router fabric — single control-plane connects up to 40 VPCs/accounts</li>
        <li class="text-slate-300">Site-to-cloud connectivity via WireGuard tunnel or IPSec with automated failover</li>
        <li class="text-slate-300">Global anycast front-door with WAF + geo-ip routing per user</li>
        <li class="text-slate-300">Zero-trust per-connection IAM authorization beyond the network boundary</li>
      </ul>
        </div>
