...
export const metadata: Metadata = {
  title: 'Smart manufacturing-proptech',
  description: 'Transform your proptech operations with our Smart manufacturing-proptech. This AI-driven solution automates manufacturing quality control with unprecedented acc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-manufacturing-proptech-afb4fccf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart manufacturing-proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your proptech operations with our Smart manufacturing-proptech. This AI-driven solution automates manufacturing quality control with unprecedented accuracy and efficiency.
          </p>
