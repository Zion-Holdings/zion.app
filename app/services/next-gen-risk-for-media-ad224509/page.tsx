...
export const metadata: Metadata = {
  title: 'Next-Gen Risk for Media',
  description: 'Optimize your media workflows with Next-Gen Risk for Media. This intelligent platform delivers survey automation through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-risk-for-media-ad224509',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Risk for Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your media workflows with Next-Gen Risk for Media. This intelligent platform delivers survey automation through advanced automation and AI.
          </p>
