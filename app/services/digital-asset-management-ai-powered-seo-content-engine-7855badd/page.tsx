...
export const metadata: Metadata = {
  title: 'Digital Asset Management AI-Powered SEO Content Engine',
  description: 'digital asset management solution for parks & recreation industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and mar',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/digital-asset-management-ai-powered-seo-content-engine-7855badd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Digital Asset Management AI-Powered SEO Content Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            digital asset management solution for parks & recreation industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing copy.
          </p>
