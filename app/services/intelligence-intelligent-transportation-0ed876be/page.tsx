...
export const metadata: Metadata = {
  title: 'Intelligence Intelligent - Transportation',
  description: 'The future of transportation is here with Intelligence Intelligent - Transportation. Powered by cutting-edge AI, this platform delivers resource optimization li',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligence-intelligent-transportation-0ed876be',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Intelligence Intelligent - Transportation. Powered by cutting-edge AI, this platform delivers resource optimization like never before.
          </p>
