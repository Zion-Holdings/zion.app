...
export const metadata: Metadata = {
  title: 'Cognitive Suite Solution - Media',
  description: 'Unlock unprecedented growth with Cognitive Suite Solution - Media. This autonomous system provides scenario planning with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-suite-solution-media-706c3c09',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Suite Solution - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Cognitive Suite Solution - Media. This autonomous system provides scenario planning with zero manual intervention needed.
          </p>
