...
export const metadata: Metadata = {
  title: 'Marketing Next-Gen - Insurance',
  description: 'Next-generation insurance solution: Marketing Next-Gen - Insurance. Combines master data management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/marketing-next-gen-insurance-51fad0c7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Marketing Next-Gen - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Marketing Next-Gen - Insurance. Combines master data management with adaptive intelligence for optimal results.
          </p>
