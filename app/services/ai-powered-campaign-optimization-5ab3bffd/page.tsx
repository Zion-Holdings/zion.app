...
export const metadata: Metadata = {
  ...
  description: 'Optimizes marketing campaigns across channels with real-time bidding and creative optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-campaign-optimization-5ab3bffd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimizes marketing campaigns across channels with real-time bidding and creative optimization.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Bidding</li>
          <li className="text-gray-300">Creative optimization</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">50% lower CAC</li>
