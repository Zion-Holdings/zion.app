...
export const metadata: Metadata = {
  title: 'Intelligent Brand Cognitive',
  description: 'Revolutionize healthcare through intelligent automation. Our Intelligent Brand Cognitive leverages advanced machine learning to deliver enterprise-grade insight',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-brand-cognitive-883c93a1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Brand Cognitive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Intelligent Brand Cognitive leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
