...
export const metadata: Metadata = {
  title: 'Neural Predictive Automation',
  description: 'Transform your education operations with our Neural Predictive Automation. This AI-driven solution automates user provisioning with unprecedented accuracy and e',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Predictive Automation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your education operations with our Neural Predictive Automation. This AI-driven solution automates user provisioning with unprecedented accuracy and efficiency.
          </p>
