...
export const metadata: Metadata = {
  title: "AI-Powered Data Governance - AI-Powered Data Governance Solution",
  description: "Automated data governance with compliance checking and policy enforcement.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-data-governance-31ee8f67",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Data Governance - AI-Powered Data Governance Solution
        </h1>
