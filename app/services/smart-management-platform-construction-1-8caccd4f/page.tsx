...
export const metadata: Metadata = {
  title: 'Smart Management Platform - Construction #1',
  description: 'Next-generation construction solution: Smart Management Platform - Construction #1. Combines logistics route optimization with adaptive intelligence for optimal',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-management-platform-construction-1-8caccd4f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Management Platform - Construction #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Smart Management Platform - Construction #1. Combines logistics route optimization with adaptive intelligence for optimal results.
          </p>
