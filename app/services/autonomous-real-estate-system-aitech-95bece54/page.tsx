...
export const metadata: Metadata = {
  title: 'Autonomous Real Estate System - AITECH',
  description: 'Transform your aitech operations with our Autonomous Real Estate System - AITECH. This AI-driven solution automates scalability planning with unprecedented accu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Real Estate System - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your aitech operations with our Autonomous Real Estate System - AITECH. This AI-driven solution automates scalability planning with unprecedented accuracy and efficiency.
          </p>
