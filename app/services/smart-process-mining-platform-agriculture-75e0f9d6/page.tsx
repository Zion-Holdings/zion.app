...
export const metadata: Metadata = {
  title: 'Smart Process Mining Platform - Agriculture',
  description: 'Transform your agriculture operations with our Smart Process Mining Platform - Agriculture. This AI-driven solution automates contract analysis with unprecedent',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-process-mining-platform-agriculture-75e0f9d6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Process Mining Platform - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Smart Process Mining Platform - Agriculture. This AI-driven solution automates contract analysis with unprecedented accuracy and efficiency.
          </p>
