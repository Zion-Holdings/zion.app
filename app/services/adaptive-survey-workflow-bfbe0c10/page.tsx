...
export const metadata: Metadata = {
  title: 'Adaptive Survey Workflow',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Survey Workflow
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Adaptive Survey Workflow. Our solution provides cost reduction with enterprise-grade reliability and security.
          </p>
