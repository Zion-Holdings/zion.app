...
export const metadata: Metadata = {
  title: 'Cloud Smart - Finance #1',
  description: 'Revolutionize finance through intelligent automation. Our Cloud Smart - Finance #1 leverages advanced machine learning to deliver supply chain at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cloud-smart---finance-1-5f07570a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cloud Smart - Finance #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our Cloud Smart - Finance #1 leverages advanced machine learning to deliver supply chain at scale.
          </p>
