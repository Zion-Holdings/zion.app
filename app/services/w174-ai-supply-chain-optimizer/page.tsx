...
export const metadata: Metadata = {
  ...
  keywords: 'AI demand forecasting (30/60/90 day), Multi-echelon inventory optimization, Supplier risk scoring and diversification, Logistics route and carrier optimization, What-if scenario modeling, Real-time disruption alerts, Integration with SAP, Oracle SCM, Kinaxis, ai, Supply Chain, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Supply Chain Optimizer</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered supply chain optimization: demand forecasting, inventory optimization, supplier risk scoring, and logistics route planning. Reduce costs and prevent stockouts.</p>
        ...
        <li class="text-slate-300">AI demand forecasting (30/60/90 day)</li>
        <li class="text-slate-300">Multi-echelon inventory optimization</li>
        <li class="text-slate-300">Supplier risk scoring and diversification</li>
        <li class="text-slate-300">Logistics route and carrier optimization</li>
        <li class="text-slate-300">What-if scenario modeling</li>
        <li class="text-slate-300">Real-time disruption alerts</li>
        <li class="text-slate-300">Integration with SAP, Oracle SCM, Kinaxis</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce inventory costs by 20-30%</li>
        <li class="text-slate-300">Prevent stockouts with accurate forecasting</li>
        <li class="text-slate-300">Supplier diversification reduces risk</li>
        <li class="text-slate-300">Scenario modeling for decision support</li>
      </ul>
        </div>
