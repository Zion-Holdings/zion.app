...
export const metadata: Metadata = {
  title: 'AI/IT Analyzer Suite - Transportation',
  description: 'Optimize your transportation workflows with AI/IT Analyzer Suite - Transportation. This intelligent platform delivers margin analysis through advanced automatio',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-analyzer-suite-transportation-917dc74c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Analyzer Suite - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with AI/IT Analyzer Suite - Transportation. This intelligent platform delivers margin analysis through advanced automation and AI.
          </p>
