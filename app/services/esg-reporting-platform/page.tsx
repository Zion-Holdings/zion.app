...
export const metadata: Metadata = {
  ...
  keywords: 'Data collection, Carbon accounting, Compliance reporting, Stakeholder dashboards, Benchmarking, Audit trail, Scenario analysis, Integration, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">ESG Reporting &amp; Compliance Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Environmental, Social, and Governance reporting with AI data collection and carbon accounting.</p>
        ...
        <li class="text-slate-300">Data collection</li>
        <li class="text-slate-300">Carbon accounting</li>
        <li class="text-slate-300">Compliance reporting</li>
        <li class="text-slate-300">Stakeholder dashboards</li>
        <li class="text-slate-300">Benchmarking</li>
        <li class="text-slate-300">Audit trail</li>
        <li class="text-slate-300">Scenario analysis</li>
        <li class="text-slate-300">Integration</li>
      </ul>
        </div>
        ...
        <li class="text-slate-300">Stakeholder transparency</li>
        <li class="text-slate-300">Benchmarking</li>
        <li class="text-slate-300">Audit readiness</li>
      </ul>
        </div>
