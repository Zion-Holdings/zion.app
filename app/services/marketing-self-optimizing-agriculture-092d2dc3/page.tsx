...
export const metadata: Metadata = {
  title: 'Marketing Self-Optimizing - Agriculture',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Marketing Self-Optimizing - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in agriculture with Marketing Self-Optimizing - Agriculture. This AI-powered platform transforms lead scoring into a competitive advantage.
          </p>
