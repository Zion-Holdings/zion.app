...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'IT Unified Communications Platform', 'description': 'All-in-one communications platform combining video conferencing, team messaging, phone system, and contact center. AI-powered features including real-time translation, meeting summaries, and sentiment analysis.', 'serviceType': 'it', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'Technology'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'IT Unified Communications Platform Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$199/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$599/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': 'Custom', 'priceCurrency': 'USD'}]}} />
    <JsonLd data={'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'HD video conferencing (1000+ participants)', 'acceptedAnswer': {'@type': 'Answer', 'text': 'HD video conferencing (1000+ participants)'}}, {'@type': 'Question', 'name': 'Team messaging with channels', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Team messaging with channels'}}, {'@type': 'Question', 'name': 'Cloud PBX phone system', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Cloud PBX phone system'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Consolidate communication tools; Reduce telecom costs by 50%; Improve team collaboration'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} />
