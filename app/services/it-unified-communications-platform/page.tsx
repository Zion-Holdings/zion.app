...
export const metadata: Metadata = {
  ...
  keywords: 'HD video conferencing (1000+ participants), Team messaging with channels, Cloud PBX phone system, Contact center with AI routing, Real-time translation (30+ languages), AI meeting summaries and action items, Sentiment analysis for calls, CRM and helpdesk integrations, it, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Unified Communications Platform</h1>
        <p className="text-lg text-slate-300 mb-8">All-in-one communications platform combining video conferencing, team messaging, phone system, and contact center. AI-powered features including real-time translation, meeting summaries, and sentiment analysis.</p>
        ...
        <li class="text-slate-300">HD video conferencing (1000+ participants)</li>
        <li class="text-slate-300">Team messaging with channels</li>
        <li class="text-slate-300">Cloud PBX phone system</li>
        <li class="text-slate-300">Contact center with AI routing</li>
        <li class="text-slate-300">Real-time translation (30+ languages)</li>
        <li class="text-slate-300">AI meeting summaries and action items</li>
        <li class="text-slate-300">Sentiment analysis for calls</li>
        <li class="text-slate-300">CRM and helpdesk integrations</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Consolidate communication tools</li>
        <li class="text-slate-300">Reduce telecom costs by 50%</li>
        <li class="text-slate-300">Improve team collaboration</li>
        <li class="text-slate-300">Enhance customer experience</li>
      </ul>
        </div>
