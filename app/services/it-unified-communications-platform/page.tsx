...
export const metadata = {
  ...
  description: "All-in-one communications platform combining video conferencing, team messaging, phone system, and contact center. AI-powered features including real-time trans",
  alternates: {
