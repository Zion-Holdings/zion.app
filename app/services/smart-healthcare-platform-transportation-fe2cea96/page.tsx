...
export const metadata: Metadata = {
  ...
  description: 'Drive innovation in transportation with Smart Healthcare Platform - Transportation. This AI-powered platform transforms scalability planning into a competitive ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-healthcare-platform-transportation-fe2cea96',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in transportation with Smart Healthcare Platform - Transportation. This AI-powered platform transforms scalability planning into a competitive advantage.
          </p>
