...
export const metadata: Metadata = {
  title: 'AI-Powered Private Equity Analysis',
  description: 'Automates private equity due diligence and portfolio management.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-private-equity-analysis-c90b2d2b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Private Equity Analysis
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Automates private equity due diligence and portfolio management.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">40% faster due diligence</li>
