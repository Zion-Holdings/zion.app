...
export const metadata: Metadata = {
  title: 'Security Cognitive - Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Security Cognitive - Hospitality leverages advanced machine learning to deliver data processing at',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-cognitive---hospitality-dbc03c89',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Cognitive - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Security Cognitive - Hospitality leverages advanced machine learning to deliver data processing at scale.
          </p>
