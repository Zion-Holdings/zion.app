...
export const metadata: Metadata = {
  ...
  description: 'Enhance your media business with Cognitive Cloud Solution - Media. Our solution provides network optimization with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-cloud-solution-media-2f0377f4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your media business with Cognitive Cloud Solution - Media. Our solution provides network optimization with enterprise-grade reliability and security.
          </p>
