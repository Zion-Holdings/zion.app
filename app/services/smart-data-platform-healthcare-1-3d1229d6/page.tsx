...
export const metadata: Metadata = {
  title: 'Smart Data Platform - Healthcare #1',
  description: 'Revolutionize healthcare through intelligent automation. Our Smart Data Platform - Healthcare #1 leverages advanced machine learning to deliver user provisionin',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Data Platform - Healthcare #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Smart Data Platform - Healthcare #1 leverages advanced machine learning to deliver user provisioning at scale.
          </p>
