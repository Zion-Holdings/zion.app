...
export const metadata: Metadata = {
  title: 'Cognitive Quality Solution - Energy',
  description: 'Enhance your energy business with Cognitive Quality Solution - Energy. Our solution provides business continuity with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-quality-solution-energy-0f7c2513',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Quality Solution - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your energy business with Cognitive Quality Solution - Energy. Our solution provides business continuity with enterprise-grade reliability and security.
          </p>
