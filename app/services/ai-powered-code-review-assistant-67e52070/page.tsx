...
export const metadata: Metadata = {
  title: "AI-Powered Code Review Assistant - AI-Powered Development Solution",
  description: "Automatically reviews code changes for quality, security, and best practices.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-code-review-assistant-67e52070",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Code Review Assistant - AI-Powered Development Solution
        </h1>
