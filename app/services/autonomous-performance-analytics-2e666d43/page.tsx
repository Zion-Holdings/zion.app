...
export const metadata: Metadata = {
  title: 'Autonomous Performance Analytics',
  description: 'Drive innovation in logistics with Autonomous Performance Analytics. This AI-powered platform transforms financial planning into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-performance-analytics-2e666d43',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with Autonomous Performance Analytics. This AI-powered platform transforms financial planning into a competitive advantage.
          </p>
