...
export const metadata: Metadata = {
  title: 'Self-Optimizing Security for Sports',
  description: 'The future of sports is here with Self-Optimizing Security for Sports. Powered by cutting-edge AI, this platform delivers threat detection like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/self-optimizing-security-for-sports-44948a4d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Security for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Self-Optimizing Security for Sports. Powered by cutting-edge AI, this platform delivers threat detection like never before.
          </p>
