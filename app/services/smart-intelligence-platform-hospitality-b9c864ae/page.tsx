...
export const metadata: Metadata = {
  title: 'Smart Intelligence Platform - Hospitality',
  description: 'Optimize your hospitality workflows with Smart Intelligence Platform - Hospitality. This intelligent platform delivers code optimization through advanced automa',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Intelligence Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Smart Intelligence Platform - Hospitality. This intelligent platform delivers code optimization through advanced automation and AI.
          </p>
