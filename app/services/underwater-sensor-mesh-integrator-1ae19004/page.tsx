...
export const metadata: Metadata = {
  title: 'Underwater Sensor Mesh Integrator',
  description: 'Manages underwater acoustic sensor mesh for maritime, energy, and climate telemetry.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/underwater-sensor-mesh-integrator-1ae19004',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Underwater Sensor Mesh Integrator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Manages underwater acoustic sensor mesh for maritime, energy, and climate telemetry.
          </p>
