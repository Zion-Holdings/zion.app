...
export const metadata: Metadata = {
  title: 'Cognitive Experience Solution - REGTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Experience Solution - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize regtech through intelligent automation. Our Cognitive Experience Solution - REGTECH leverages advanced machine learning to deliver root cause analysis at scale.
          </p>
