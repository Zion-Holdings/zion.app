...
export const metadata: Metadata = {
  title: 'AI Coordinator - Iot Edition',
  description: 'Transform your iot operations with our AI Coordinator - Iot Edition. This AI-driven solution automates risk assessment with unprecedented accuracy and efficienc',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Coordinator - Iot Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your iot operations with our AI Coordinator - Iot Edition. This AI-driven solution automates risk assessment with unprecedented accuracy and efficiency.
          </p>
