...
export const metadata: Metadata = {
  ...
  keywords: 'Auto-organize and tag documents, Natural language Q&A over knowledge base, Relevant info surfacing in Slack, Teams, Confluence, Knowledge gap identification, Content lifecycle and freshness management, Access control and permissions, Integration with Confluence, SharePoint, Notion, GDrive, data, Knowledge Management, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Enterprise Knowledge Management</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered enterprise knowledge management: auto-organize documents, answer questions over your knowledge base, and surface relevant info in workflow tools.</p>
        ...
        <li class="text-slate-300">Auto-organize and tag documents</li>
        <li class="text-slate-300">Natural language Q&amp;A over knowledge base</li>
        <li class="text-slate-300">Relevant info surfacing in Slack, Teams, Confluence</li>
        <li class="text-slate-300">Knowledge gap identification</li>
        <li class="text-slate-300">Content lifecycle and freshness management</li>
        <li class="text-slate-300">Access control and permissions</li>
        <li class="text-slate-300">Integration with Confluence, SharePoint, Notion, GDrive</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Find any information in seconds with NL search</li>
        <li class="text-slate-300">AI surfaces relevant knowledge in your workflow</li>
        <li class="text-slate-300">Knowledge gaps identified and addressed</li>
        <li class="text-slate-300">Content lifecycle keeps knowledge fresh</li>
      </ul>
        </div>
