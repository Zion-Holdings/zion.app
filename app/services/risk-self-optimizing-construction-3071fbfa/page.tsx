...
export const metadata: Metadata = {
  title: 'Risk Self-Optimizing - Construction',
  description: 'Unlock unprecedented growth with Risk Self-Optimizing - Construction. This autonomous system provides user provisioning with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/risk-self-optimizing-construction-3071fbfa',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Risk Self-Optimizing - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Risk Self-Optimizing - Construction. This autonomous system provides user provisioning with zero manual intervention needed.
          </p>
