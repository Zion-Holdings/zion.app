    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Eliminate lateral movement for attackers</li>
            <li>Replace vulnerable VPN with modern secure access</li>
            <li>Meet compliance requirements (NIST 800-207, CISA Zero Trust)</li>
            <li>Reduce breach blast radius by 90%</li>
          </ul>
        </div>
