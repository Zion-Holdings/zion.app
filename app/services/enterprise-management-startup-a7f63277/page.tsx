...
export const metadata: Metadata = {
  title: 'Enterprise Management - Startup',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Management - Startup
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in startup with Enterprise Management - Startup. This AI-powered platform transforms ml model training into a competitive advantage.
          </p>
