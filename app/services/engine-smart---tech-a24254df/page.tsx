...
export const metadata: Metadata = {
  title: 'Engine Smart - Tech',
  description: 'Unlock unprecedented growth with Engine Smart - Tech. This autonomous system provides image recognition with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/engine-smart---tech-a24254df',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Engine Smart - Tech. This autonomous system provides image recognition with zero manual intervention needed.
          </p>
