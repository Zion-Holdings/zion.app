...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={@context: "https://schema.org", @type: "Service", name: "AI Customer Success Churn Prevention | Zion Tech Group", description: "End-to-end ai customer success churn prevention services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/ai-customer-success-churn-2026-7879/"} />
