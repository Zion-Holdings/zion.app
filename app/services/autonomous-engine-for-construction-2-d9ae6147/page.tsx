...
export const metadata: Metadata = {
  title: 'Autonomous Engine for Construction #2',
  description: 'Next-generation construction solution: Autonomous Engine for Construction #2. Combines user experience with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-engine-for-construction-2-d9ae6147',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Engine for Construction #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Autonomous Engine for Construction #2. Combines user experience with adaptive intelligence for optimal results.
          </p>
