...
export const metadata: Metadata = {
  title: 'AI Management - Construction Edition #3',
  description: 'Next-generation construction solution: AI Management - Construction Edition #3. Combines access management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-management-construction-edition-3-695693fc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Management - Construction Edition #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: AI Management - Construction Edition #3. Combines access management with adaptive intelligence for optimal results.
          </p>
