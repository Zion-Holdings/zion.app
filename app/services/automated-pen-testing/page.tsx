...
export const metadata: Metadata = {
  ...
  keywords: 'Automated OWASP Top 10 scans, API security testing, Infrastructure CVE scan, Exploitable-path chain reports, Remediation ticket integration, security, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Automated Penetration Testing</h1>
        <p className="text-lg text-slate-300 mb-8">Continuous, automated penetration testing of web apps, APIs, and infrastructure with CVE scanning, exploitable-path reporting, and fix verification.</p>
        ...
        <li class="text-slate-300">Automated OWASP Top 10 scans</li>
        <li class="text-slate-300">API security testing</li>
        <li class="text-slate-300">Infrastructure CVE scan</li>
        <li class="text-slate-300">Exploitable-path chain reports</li>
        <li class="text-slate-300">Remediation ticket integration</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with automated penetration testing</li>
