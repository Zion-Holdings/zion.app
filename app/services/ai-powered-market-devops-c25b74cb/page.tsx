...
export const metadata: Metadata = {
  title: 'AI-Powered Market DevOps',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Market DevOps
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in retail with AI-Powered Market DevOps. This AI-powered platform transforms influencer identification into a competitive advantage.
          </p>
