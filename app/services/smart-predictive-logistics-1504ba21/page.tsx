...
export const metadata: Metadata = {
  title: 'Smart predictive-logistics',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart predictive-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with Smart predictive-logistics. Our solution provides security monitoring with enterprise-grade reliability and security.
          </p>
