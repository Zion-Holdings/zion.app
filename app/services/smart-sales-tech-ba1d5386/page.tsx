...
export const metadata: Metadata = {
  title: 'Smart sales-tech',
  description: 'Next-generation technology solution: Smart sales-tech. Combines image recognition with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-sales-tech-ba1d5386',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation technology solution: Smart sales-tech. Combines image recognition with adaptive intelligence for optimal results.
          </p>
