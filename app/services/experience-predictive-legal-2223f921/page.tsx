...
export const metadata: Metadata = {
  title: 'Experience Predictive - Legal',
  description: 'Optimize your legal workflows with Experience Predictive - Legal. This intelligent platform delivers quality control through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/experience-predictive-legal-2223f921',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Experience Predictive - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with Experience Predictive - Legal. This intelligent platform delivers quality control through advanced automation and AI.
          </p>
