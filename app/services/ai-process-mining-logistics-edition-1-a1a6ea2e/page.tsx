...
export const metadata: Metadata = {
  ...
  description: 'Future-proof your logistics with AI Process Mining - Logistics Edition #1. Our autonomous solution handles market intelligence end-to-end without human interven',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your logistics with AI Process Mining - Logistics Edition #1. Our autonomous solution handles market intelligence end-to-end without human intervention.
          </p>
