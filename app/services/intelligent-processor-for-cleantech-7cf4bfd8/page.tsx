...
export const metadata: Metadata = {
  title: 'Intelligent Processor for CLEANTECH',
  description: 'Quantum leap forward for cleantech: Intelligent Processor for CLEANTECH. Uses quantum-inspired algorithms to deliver financial risk management at exponential sp',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Processor for CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for cleantech: Intelligent Processor for CLEANTECH. Uses quantum-inspired algorithms to deliver financial risk management at exponential speed.
          </p>
