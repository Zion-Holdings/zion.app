...
export const metadata: Metadata = {
  title: 'AI SMB - Finance Edition',
  description: 'The future of finance is here with AI SMB - Finance Edition. Powered by cutting-edge AI, this platform delivers fleet management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-smb-finance-edition-dfa8c58c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI SMB - Finance Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of finance is here with AI SMB - Finance Edition. Powered by cutting-edge AI, this platform delivers fleet management like never before.
          </p>
