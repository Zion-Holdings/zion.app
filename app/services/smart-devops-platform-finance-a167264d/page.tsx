export const metadata = {
  ...
  description: "Zion Tech Group delivers Smart DevOps Platform - Finance with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/services/smart-devops-platform-finance-a167264d/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>Smart DevOps Platform - Finance</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers Smart DevOps Platform - Finance with measurable outcomes.
      </p>
