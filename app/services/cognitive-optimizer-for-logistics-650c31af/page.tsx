...
export const metadata: Metadata = {
  ...
  description: 'Next-generation logistics solution: Cognitive Optimizer for Logistics. Combines threat detection with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-optimizer-for-logistics-650c31af',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Cognitive Optimizer for Logistics. Combines threat detection with adaptive intelligence for optimal results.
          </p>
