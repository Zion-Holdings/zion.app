...
export const metadata: Metadata = {
  title: 'Finance Cognitive - Agriculture',
  description: 'Optimize your agriculture workflows with Finance Cognitive - Agriculture. This intelligent platform delivers incident response through advanced automation and A',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/finance-cognitive-agriculture-d4687bdc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Finance Cognitive - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your agriculture workflows with Finance Cognitive - Agriculture. This intelligent platform delivers incident response through advanced automation and AI.
          </p>
