...
export const metadata = {
  ...
  description: "Revolutionize gaming through intelligent automation. Our AI-Powered Platform for Gaming leverages advanced machine learning to deliver content generation at sca",
  alternates: {
