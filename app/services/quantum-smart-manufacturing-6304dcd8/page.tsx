...
export const metadata: Metadata = {
  title: 'Quantum smart-manufacturing',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum smart-manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for manufacturing: Quantum smart-manufacturing. Uses quantum-inspired algorithms to deliver budget tracking at exponential speed.
          </p>
