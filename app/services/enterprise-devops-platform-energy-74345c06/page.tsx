...
export const metadata: Metadata = {
  title: 'Enterprise DevOps Platform - Energy',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise DevOps Platform - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Enterprise DevOps Platform - Energy leverages advanced machine learning to deliver ai ethics at scale.
          </p>
