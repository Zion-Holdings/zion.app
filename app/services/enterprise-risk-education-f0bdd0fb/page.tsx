...
export const metadata: Metadata = {
  title: 'Enterprise Risk - Education',
  description: 'Next-generation education solution: Enterprise Risk - Education. Combines release management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-risk-education-f0bdd0fb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation education solution: Enterprise Risk - Education. Combines release management with adaptive intelligence for optimal results.
          </p>
