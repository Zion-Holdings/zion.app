...
export const metadata: Metadata = {
  title: 'Enterprise Processor Platform - CLEANTECH',
  description: 'Quantum leap forward for cleantech: Enterprise Processor Platform - CLEANTECH. Uses quantum-inspired algorithms to deliver security monitoring at exponential sp',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Processor Platform - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for cleantech: Enterprise Processor Platform - CLEANTECH. Uses quantum-inspired algorithms to deliver security monitoring at exponential speed.
          </p>
