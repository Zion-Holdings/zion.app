...
export const metadata: Metadata = {
  title: 'Cold-Chain IoT Tracker',
  description: 'IoT tracking and compliance for healthcare cold-chain logistics and vaccines.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cold-chain-iot-tracker-31119df2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cold-Chain IoT Tracker
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            IoT tracking and compliance for healthcare cold-chain logistics and vaccines.
          </p>
