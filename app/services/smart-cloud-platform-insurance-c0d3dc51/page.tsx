...
export const metadata: Metadata = {
  title: 'Smart Cloud Platform - Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Smart Cloud Platform - Insurance leverages advanced machine learning to deliver hr analytics at scal',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-cloud-platform-insurance-c0d3dc51',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Cloud Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Smart Cloud Platform - Insurance leverages advanced machine learning to deliver hr analytics at scale.
          </p>
