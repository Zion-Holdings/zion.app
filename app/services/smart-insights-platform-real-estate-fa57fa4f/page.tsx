...
export const metadata: Metadata = {
  title: 'Smart Insights Platform - Real-Estate',
  description: 'Transform your real-estate operations with our Smart Insights Platform - Real-Estate. This AI-driven solution automates contract analysis with unprecedented acc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-insights-platform-real-estate-fa57fa4f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Insights Platform - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Smart Insights Platform - Real-Estate. This AI-driven solution automates contract analysis with unprecedented accuracy and efficiency.
          </p>
