...
export const metadata: Metadata = {
  title: 'Cognitive Risk for Legal #3',
  description: 'Revolutionize legal through intelligent automation. Our Cognitive Risk for Legal #3 leverages advanced machine learning to deliver lead scoring at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-risk-for-legal-3-5ba33137',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Risk for Legal #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Cognitive Risk for Legal #3 leverages advanced machine learning to deliver lead scoring at scale.
          </p>
