...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Analytics - HEALTHTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Analytics - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for healthtech: Hyper-Accelerated Analytics - HEALTHTECH. Uses quantum-inspired algorithms to deliver scenario planning at exponential speed.
          </p>
