...
export const metadata: Metadata = {
  title: 'Suite Intelligent - Insurance',
  description: 'Enhance your insurance business with Suite Intelligent - Insurance. Our solution provides data quality with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/suite-intelligent-insurance-fa0da16b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Suite Intelligent - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Suite Intelligent - Insurance. Our solution provides data quality with enterprise-grade reliability and security.
          </p>
