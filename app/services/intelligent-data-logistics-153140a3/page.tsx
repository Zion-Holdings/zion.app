...
export const metadata: Metadata = {
  title: 'Intelligent data-logistics',
  description: 'Drive innovation in logistics with Intelligent data-logistics. This AI-powered platform transforms maintenance scheduling into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-data-logistics-153140a3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with Intelligent data-logistics. This AI-powered platform transforms maintenance scheduling into a competitive advantage.
          </p>
