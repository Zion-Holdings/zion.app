    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Draft and file a motion in 1 hour instead of 1 day — returned to billable hours</li>
            <li>Deadline tracking means no lost case from missed filing statute</li>
            <li>E-sign per jurisdiction eliminates the paper scan cycle per document</li>
            <li>Binder compile reduces paralegal manual effort from 8 hours to 1 hour</li>
          </ul>
        </div>
