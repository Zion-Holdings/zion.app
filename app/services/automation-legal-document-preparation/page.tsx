...
export const metadata: Metadata = {
  ...
  keywords: 'Template library per case type with clause auto-match per case facts entered, E-sign integrates per jurisdiction via DocuSign or HelloSign embedded signing, Deadline auto-calculation per court rules per state, Evidence binder auto-compile with exhibit auto-order by relevance per document, Regulatory filing per authority per batch or per individual case per filing limit, Prior precedent search per case law by citation auto-detected per case type, automation, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Legal Document Preparation and Filing</h1>
        <p className="text-lg text-slate-300 mb-8">Legal document preparation: template-per-case-type, clause auto-match per case facts, e-sign per jurisdiction, deadline tracking, regulatory filing per state and federal authority, and evidence binder auto-compile with exhibit order per relevance score.</p>
        ...
        <li class="text-slate-300">Template library per case type with clause auto-match per case facts entered</li>
        <li class="text-slate-300">E-sign integrates per jurisdiction via DocuSign or HelloSign embedded signing</li>
        <li class="text-slate-300">Deadline auto-calculation per court rules per state</li>
        <li class="text-slate-300">Evidence binder auto-compile with exhibit auto-order by relevance per document</li>
        <li class="text-slate-300">Regulatory filing per authority per batch or per individual case per filing limit</li>
        <li class="text-slate-300">Prior precedent search per case law by citation auto-detected per case type</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with legal document preparation and filing</li>
