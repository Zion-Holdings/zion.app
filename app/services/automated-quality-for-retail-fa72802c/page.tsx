...
export const metadata: Metadata = {
  title: 'Automated Quality for Retail',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Quality for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Automated Quality for Retail. This autonomous system provides sales process optimization with zero manual intervention needed.
          </p>
