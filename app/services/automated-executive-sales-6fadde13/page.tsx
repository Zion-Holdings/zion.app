...
export const metadata: Metadata = {
  title: 'Automated Executive Sales',
  description: 'Enhance your construction business with Automated Executive Sales. Our solution provides manufacturing quality control with enterprise-grade reliability and sec',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Executive Sales
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Automated Executive Sales. Our solution provides manufacturing quality control with enterprise-grade reliability and security.
          </p>
