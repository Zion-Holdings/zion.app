...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'AI Proposal & RFP Generator', 'description': 'Auto-generate winning proposals and RFP responses from your knowledge base. AI matches requirements, drafts content, and optimizes pricing sections.', 'serviceType': 'ai', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'Sales'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'AI Proposal & RFP Generator Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$199/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$599/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': '$1,999/mo', 'priceCurrency': 'USD'}]}} />
    <JsonLd data={'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'RFP requirement extraction and matching', 'acceptedAnswer': {'@type': 'Answer', 'text': 'RFP requirement extraction and matching'}}, {'@type': 'Question', 'name': 'Content auto-generation from knowledge base', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Content auto-generation from knowledge base'}}, {'@type': 'Question', 'name': 'Pricing section optimization', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Pricing section optimization'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Write proposals 10x faster with AI; Win rate analysis improves content; Compliance matrices auto-generated'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} />
