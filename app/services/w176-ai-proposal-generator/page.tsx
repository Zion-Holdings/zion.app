...
export const metadata: Metadata = {
  ...
  keywords: 'RFP requirement extraction and matching, Content auto-generation from knowledge base, Pricing section optimization, Compliance matrix auto-generation, Past win/loss analysis incorporation, Collaborative review workflow, Export to Word, PDF, and portal, ai, Sales, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Proposal &amp; RFP Generator</h1>
        <p className="text-lg text-slate-300 mb-8">Auto-generate winning proposals and RFP responses from your knowledge base. AI matches requirements, drafts content, and optimizes pricing sections.</p>
        ...
        <li class="text-slate-300">RFP requirement extraction and matching</li>
        <li class="text-slate-300">Content auto-generation from knowledge base</li>
        <li class="text-slate-300">Pricing section optimization</li>
        <li class="text-slate-300">Compliance matrix auto-generation</li>
        <li class="text-slate-300">Past win/loss analysis incorporation</li>
        <li class="text-slate-300">Collaborative review workflow</li>
        <li class="text-slate-300">Export to Word, PDF, and portal</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Write proposals 10x faster with AI</li>
        <li class="text-slate-300">Win rate analysis improves content</li>
        <li class="text-slate-300">Compliance matrices auto-generated</li>
        <li class="text-slate-300">Collaborative review maintains quality</li>
      </ul>
        </div>
