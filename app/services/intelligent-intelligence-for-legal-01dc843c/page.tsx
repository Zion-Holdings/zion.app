...
export const metadata: Metadata = {
  title: 'Intelligent Intelligence for Legal',
  description: 'Optimize legal workflows using Intelligent Intelligence for Legal. This platform delivers intelligent credit scoring with real-time insights.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-intelligence-for-legal-01dc843c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Intelligence for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize legal workflows using Intelligent Intelligence for Legal. This platform delivers intelligent credit scoring with real-time insights.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Customizable workflows and rules engine</li>
