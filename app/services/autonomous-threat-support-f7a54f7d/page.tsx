...
export const metadata: Metadata = {
  title: 'Autonomous Threat Support',
  description: 'Optimize your healthtech workflows with Autonomous Threat Support. This intelligent platform delivers network optimization through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-threat-support-f7a54f7d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Threat Support
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthtech workflows with Autonomous Threat Support. This intelligent platform delivers network optimization through advanced automation and AI.
          </p>
