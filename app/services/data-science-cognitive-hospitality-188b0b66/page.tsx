...
export const metadata: Metadata = {
  title: 'Data Science Cognitive - Hospitality',
  description: 'Unlock unprecedented growth with Data Science Cognitive - Hospitality. This autonomous system provides competitive intelligence with zero manual intervention ne',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Science Cognitive - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Data Science Cognitive - Hospitality. This autonomous system provides competitive intelligence with zero manual intervention needed.
          </p>
