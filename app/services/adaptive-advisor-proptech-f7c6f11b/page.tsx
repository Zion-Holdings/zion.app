...
export const metadata: Metadata = {
  title: 'Adaptive advisor-proptech',
  description: 'Drive innovation in proptech with Adaptive advisor-proptech. This AI-powered platform transforms travel management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-advisor-proptech-f7c6f11b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive advisor-proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in proptech with Adaptive advisor-proptech. This AI-powered platform transforms travel management into a competitive advantage.
          </p>
