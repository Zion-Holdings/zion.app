...
export const metadata: Metadata = {
  title: 'Engine AI - Hospitality',
  description: 'Next-generation hospitality solution: Engine AI - Hospitality. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/engine-ai-hospitality-019ea9ed',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Engine AI - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Engine AI - Hospitality. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
