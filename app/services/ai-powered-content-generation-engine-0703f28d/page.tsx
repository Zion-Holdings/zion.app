...
export const metadata: Metadata = {
  ...
  description: 'Generates SEO-optimized content at scale including blog posts, product descriptions, and ad copy.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-content-generation-engine-0703f28d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Generates SEO-optimized content at scale including blog posts, product descriptions, and ad copy.
          </p>
