...
export const metadata: Metadata = {
  title: 'Intelligent Support for Tech',
  description: 'Optimize your technology workflows with Intelligent Support for Tech. This intelligent platform delivers sales forecasting through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-support-for-tech-3d7d270a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Support for Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your technology workflows with Intelligent Support for Tech. This intelligent platform delivers sales forecasting through advanced automation and AI.
          </p>
