...
export const metadata: Metadata = {
  title: 'Predictive Code Manager',
  description: 'Transform your manufacturing operations with our Predictive Code Manager. This AI-driven solution automates feedback collection with unprecedented accuracy and ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Code Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your manufacturing operations with our Predictive Code Manager. This AI-driven solution automates feedback collection with unprecedented accuracy and efficiency.
          </p>
