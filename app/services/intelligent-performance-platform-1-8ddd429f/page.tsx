...
export const metadata: Metadata = {
  title: 'Intelligent Performance Platform #1',
  description: 'Next-generation transportation solution: Intelligent Performance Platform #1. Combines sales forecasting with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-performance-platform-1-8ddd429f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Performance Platform #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation transportation solution: Intelligent Performance Platform #1. Combines sales forecasting with adaptive intelligence for optimal results.
          </p>
