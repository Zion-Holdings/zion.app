...
export const metadata: Metadata = {
  title: 'Autonomous Insights System - Agriculture',
  description: 'Transform your agriculture operations with our Autonomous Insights System - Agriculture. This AI-driven solution automates security monitoring with unprecedente',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-insights-system-agriculture-ed4862c6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Insights System - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Autonomous Insights System - Agriculture. This AI-driven solution automates security monitoring with unprecedented accuracy and efficiency.
          </p>
