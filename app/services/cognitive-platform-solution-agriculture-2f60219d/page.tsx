...
export const metadata: Metadata = {
  title: 'Cognitive Platform Solution - Agriculture',
  description: 'The future of agriculture is here with Cognitive Platform Solution - Agriculture. Powered by cutting-edge AI, this platform delivers project portfolio like neve',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Platform Solution - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Cognitive Platform Solution - Agriculture. Powered by cutting-edge AI, this platform delivers project portfolio like never before.
          </p>
