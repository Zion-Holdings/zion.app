...
export const metadata: Metadata = {
  title: 'Smart Supply Suite - Manufacturing',
  description: 'The future of manufacturing is here with Smart Supply Suite - Manufacturing. Powered by cutting-edge AI, this platform delivers content moderation like never be',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-supply-suite-manufacturing-24c643e8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Supply Suite - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of manufacturing is here with Smart Supply Suite - Manufacturing. Powered by cutting-edge AI, this platform delivers content moderation like never before.
          </p>
