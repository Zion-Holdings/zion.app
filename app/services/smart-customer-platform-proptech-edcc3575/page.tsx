...
export const metadata: Metadata = {
  title: 'Smart Customer Platform - PROPTECH',
  description: 'Revolutionize proptech through intelligent automation. Our Smart Customer Platform - PROPTECH leverages advanced machine learning to deliver goal setting at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Customer Platform - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our Smart Customer Platform - PROPTECH leverages advanced machine learning to deliver goal setting at scale.
          </p>
