...
export const metadata: Metadata = {
  title: 'AI-Powered Financial Monitoring',
  description: 'The future of legal is here with AI-Powered Financial Monitoring. Powered by cutting-edge AI, this platform delivers transformative results like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-financial-monitoring-ac94ddb9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with AI-Powered Financial Monitoring. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
