...
export const metadata: Metadata = {
  ...
  description: 'cart abandonment solution for non-profit industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatical',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cart-abandonment-intelligent-document-processing-ai-61193378',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            cart abandonment solution for non-profit industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.
          </p>
