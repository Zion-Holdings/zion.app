...
export const metadata: Metadata = {
  title: 'Automated Monitoring for Legal',
  description: 'Next-generation legal solution: Automated Monitoring for Legal. Combines customer service automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-monitoring-for-legal-caa2da50',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Monitoring for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Automated Monitoring for Legal. Combines customer service automation with adaptive intelligence for optimal results.
          </p>
