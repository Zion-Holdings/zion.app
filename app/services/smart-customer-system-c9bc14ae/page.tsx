...
export const metadata: Metadata = {
  title: 'Smart Customer System',
  description: 'Transform your retail operations with our Smart Customer System. This AI-driven solution automates content moderation with unprecedented accuracy and efficiency',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-customer-system-c9bc14ae',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our Smart Customer System. This AI-driven solution automates content moderation with unprecedented accuracy and efficiency.
          </p>
