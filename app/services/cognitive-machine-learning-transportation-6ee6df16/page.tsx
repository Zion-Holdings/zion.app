...
export const metadata: Metadata = {
  title: 'Cognitive machine learning-transportation',
  description: 'The future of transportation is here with Cognitive machine learning-transportation. Powered by cutting-edge AI, this platform delivers predictive modeling like',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-machine-learning-transportation-6ee6df16',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive machine learning-transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Cognitive machine learning-transportation. Powered by cutting-edge AI, this platform delivers predictive modeling like never before.
          </p>
