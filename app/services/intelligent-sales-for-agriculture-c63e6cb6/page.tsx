...
export const metadata: Metadata = {
  title: 'Intelligent Sales for Agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Intelligent Sales for Agriculture leverages advanced machine learning to deliver forecast accuracy',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-sales-for-agriculture-c63e6cb6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Sales for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Intelligent Sales for Agriculture leverages advanced machine learning to deliver forecast accuracy at scale.
          </p>
