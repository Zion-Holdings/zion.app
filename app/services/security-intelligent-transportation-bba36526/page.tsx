...
export const metadata: Metadata = {
  title: 'Security Intelligent - Transportation',
  description: 'Enhance your transportation business with Security Intelligent - Transportation. Our solution provides energy management with enterprise-grade reliability and s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-intelligent-transportation-bba36526',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Intelligent - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with Security Intelligent - Transportation. Our solution provides energy management with enterprise-grade reliability and security.
          </p>
