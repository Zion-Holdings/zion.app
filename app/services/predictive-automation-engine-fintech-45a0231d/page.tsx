...
export const metadata: Metadata = {
  title: 'Predictive Automation Engine - FINTECH',
  description: 'Optimize your fintech workflows with Predictive Automation Engine - FINTECH. This intelligent platform delivers form processing through advanced automation and ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Automation Engine - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your fintech workflows with Predictive Automation Engine - FINTECH. This intelligent platform delivers form processing through advanced automation and AI.
          </p>
