...
export const metadata: Metadata = {
  ...
  keywords: 'AI pre-labeling, Image annotation, Text classification, Video labeling, Audio transcription, Quality control, Workforce management, API access, ai, Enterprise, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Data Labeling &amp; Annotation Platform</h1>
        <p className="text-lg text-slate-300 mb-8">High-quality data labeling for ML training with AI-assisted pre-labeling, quality control, and workforce management. Supports image, text, video, and audio annotation with 99%+ accuracy.</p>
        ...
        <li class="text-slate-300">AI pre-labeling</li>
        <li class="text-slate-300">Image annotation</li>
        <li class="text-slate-300">Text classification</li>
        <li class="text-slate-300">Video labeling</li>
        <li class="text-slate-300">Audio transcription</li>
        <li class="text-slate-300">Quality control</li>
        <li class="text-slate-300">Workforce management</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">70% faster labeling</li>
        <li class="text-slate-300">99%+ accuracy</li>
        <li class="text-slate-300">50% cost reduction vs manual</li>
      </ul>
        </div>
