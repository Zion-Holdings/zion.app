  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Adaptive Management for Hospitality</h1>
        <p className="text-lg text-gray-300 mb-8">The future of hospitality is here with Adaptive Management for Hospitality. Powered by cutting-edge AI, this platform delivers fraud prevention like never before.</p>
