...
export const metadata: Metadata = {
  title: 'Cognitive System for Legal',
  description: 'Transform your legal operations with our Cognitive System for Legal. This AI-driven solution provides intelligent automation with unprecedented accuracy and eff',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-system-for-legal-54cfeeee',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive System for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Cognitive System for Legal. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
