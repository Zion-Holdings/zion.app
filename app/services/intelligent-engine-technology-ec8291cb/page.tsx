...
export const metadata: Metadata = {
  title: 'Intelligent engine-technology',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for technology: Intelligent engine-technology. Uses quantum-inspired algorithms to deliver margin analysis at exponential speed.
          </p>
