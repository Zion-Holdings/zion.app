...
export const metadata: Metadata = {
  title: 'Next-Gen insights-agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Next-Gen insights-agriculture leverages advanced machine learning to deliver revenue intelligence ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen insights-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Next-Gen insights-agriculture leverages advanced machine learning to deliver revenue intelligence at scale.
          </p>
