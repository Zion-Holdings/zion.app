...
export const metadata: Metadata = {
  title: 'Smart Marketing Platform - Hospitality',
  description: 'Enhance your hospitality business with Smart Marketing Platform - Hospitality. Our solution provides fraud prevention with enterprise-grade reliability and secu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-marketing-platform-hospitality-7685ea45',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Marketing Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Smart Marketing Platform - Hospitality. Our solution provides fraud prevention with enterprise-grade reliability and security.
          </p>
