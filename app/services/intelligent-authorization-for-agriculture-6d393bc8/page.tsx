...
export const metadata: Metadata = {
  title: 'Intelligent Authorization for Agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Intelligent Authorization for Agriculture leverages advanced machine learning to deliver customer ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-authorization-for-agriculture-6d393bc8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Authorization for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Intelligent Authorization for Agriculture leverages advanced machine learning to deliver customer onboarding at scale.
          </p>
