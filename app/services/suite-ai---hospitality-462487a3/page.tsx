...
export const metadata: Metadata = {
  title: 'Suite AI - Hospitality',
  description: 'Transform your hospitality operations with our Suite AI - Hospitality. This AI-driven solution automates manufacturing quality control with unprecedented accura',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Suite AI - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Suite AI - Hospitality. This AI-driven solution automates manufacturing quality control with unprecedented accuracy and efficiency.
          </p>
