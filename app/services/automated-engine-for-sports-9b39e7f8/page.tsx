...
export const metadata: Metadata = {
  title: 'Automated Engine for Sports',
  description: 'The future of sports is here with Automated Engine for Sports. Powered by cutting-edge AI, this platform delivers data processing like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-engine-for-sports-9b39e7f8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Engine for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Automated Engine for Sports. Powered by cutting-edge AI, this platform delivers data processing like never before.
          </p>
