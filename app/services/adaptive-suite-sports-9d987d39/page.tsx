...
export const metadata: Metadata = {
  title: 'Adaptive suite-sports',
  description: 'The future of sports is here with Adaptive suite-sports. Powered by cutting-edge AI, this platform delivers roi tracking like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-suite-sports-9d987d39',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive suite-sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Adaptive suite-sports. Powered by cutting-edge AI, this platform delivers roi tracking like never before.
          </p>
