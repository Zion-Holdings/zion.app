...
export const metadata: Metadata = {
  title: 'Manufacturing Cognitive - Hospitality',
  description: 'Enhance your hospitality business with Manufacturing Cognitive - Hospitality. Our solution provides predictive analytics with enterprise-grade reliability and s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/manufacturing-cognitive-hospitality-80019b90',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manufacturing Cognitive - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Manufacturing Cognitive - Hospitality. Our solution provides predictive analytics with enterprise-grade reliability and security.
          </p>
