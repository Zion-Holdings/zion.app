...
export const metadata: Metadata = {
  title: 'Smart Analytics Platform - Insurance',
  description: 'Enhance your insurance business with Smart Analytics Platform - Insurance. Our solution provides disaster recovery with enterprise-grade reliability and securit',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Analytics Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Smart Analytics Platform - Insurance. Our solution provides disaster recovery with enterprise-grade reliability and security.
          </p>
