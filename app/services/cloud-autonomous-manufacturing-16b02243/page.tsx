...
export const metadata: Metadata = {
  title: 'Cloud Autonomous - Manufacturing',
  description: 'Next-generation manufacturing solution: Cloud Autonomous - Manufacturing. Combines access management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cloud-autonomous-manufacturing-16b02243',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cloud Autonomous - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation manufacturing solution: Cloud Autonomous - Manufacturing. Combines access management with adaptive intelligence for optimal results.
          </p>
