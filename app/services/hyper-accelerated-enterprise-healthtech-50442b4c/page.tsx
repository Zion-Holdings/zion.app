...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Enterprise - HEALTHTECH',
  description: 'Transform your healthtech operations with our Hyper-Accelerated Enterprise - HEALTHTECH. This AI-driven solution automates decision support with unprecedented a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Enterprise - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthtech operations with our Hyper-Accelerated Enterprise - HEALTHTECH. This AI-driven solution automates decision support with unprecedented accuracy and efficiency.
          </p>
