...
export const metadata: Metadata = {
  title: 'Smart Security Sales',
  description: 'Revolutionize retail through intelligent automation. Our Smart Security Sales leverages advanced machine learning to deliver maintenance scheduling at scale.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Security Sales
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize retail through intelligent automation. Our Smart Security Sales leverages advanced machine learning to deliver maintenance scheduling at scale.
          </p>
