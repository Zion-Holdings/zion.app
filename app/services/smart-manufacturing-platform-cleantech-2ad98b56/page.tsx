...
export const metadata: Metadata = {
  title: 'Smart Manufacturing Platform - CLEANTECH',
  description: 'Next-generation cleantech solution: Smart Manufacturing Platform - CLEANTECH. Combines model interpretability with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-manufacturing-platform-cleantech-2ad98b56',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manufacturing Platform - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation cleantech solution: Smart Manufacturing Platform - CLEANTECH. Combines model interpretability with adaptive intelligence for optimal results.
          </p>
