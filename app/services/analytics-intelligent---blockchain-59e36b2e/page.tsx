...
export const metadata: Metadata = {
  title: 'Analytics Intelligent - Blockchain',
  description: 'Revolutionize blockchain through intelligent automation. Our Analytics Intelligent - Blockchain leverages advanced machine learning to deliver logistics route o',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Analytics Intelligent - Blockchain
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize blockchain through intelligent automation. Our Analytics Intelligent - Blockchain leverages advanced machine learning to deliver logistics route optimization at scale.
          </p>
