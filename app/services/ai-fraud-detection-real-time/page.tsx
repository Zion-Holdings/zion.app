      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            ML models trained on transaction data to detect anomalies in milliseconds. Adaptive learning reduces false positives over time.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Real-time scoring (<50ms)</li>
            <li className="text-purple-300">✓ Adaptive thresholds</li>
            <li className="text-purple-300">✓ Case management dashboard</li>
            <li className="text-purple-300">✓ Investigation tools</li>
            <li className="text-purple-300">✓ PCI DSS compliant</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with real-time fraud detection</li>
