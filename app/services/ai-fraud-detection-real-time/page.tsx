...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time scoring (<50ms), Adaptive thresholds, Case management dashboard, Investigation tools, PCI DSS compliant, ai, E-Commerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Real-Time Fraud Detection</h1>
        <p className="text-lg text-slate-300 mb-8">ML models trained on transaction data to detect anomalies in milliseconds. Adaptive learning reduces false positives over time.</p>
        ...
        <li class="text-slate-300">Real-time scoring (&lt;50ms)</li>
        <li class="text-slate-300">Adaptive thresholds</li>
        <li class="text-slate-300">Case management dashboard</li>
        <li class="text-slate-300">Investigation tools</li>
        <li class="text-slate-300">PCI DSS compliant</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with real-time fraud detection</li>
