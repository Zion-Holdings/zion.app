...
export const metadata: Metadata = {
  title: 'Smart support-healthcare #1',
  description: 'Transform your healthcare operations with our Smart support-healthcare #1. This AI-driven solution provides intelligent automation with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-support-healthcare-1-10a74808',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart support-healthcare #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Smart support-healthcare #1. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
