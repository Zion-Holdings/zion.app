...
export const metadata: Metadata = {
  title: 'Sales Automated - Telecom',
  description: 'Enhance your telecom business with Sales Automated - Telecom. Our solution provides executive dashboards with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/sales-automated-telecom-5cf47a57',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Sales Automated - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your telecom business with Sales Automated - Telecom. Our solution provides executive dashboards with enterprise-grade reliability and security.
          </p>
