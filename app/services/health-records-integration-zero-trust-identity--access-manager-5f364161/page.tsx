...
export const metadata: Metadata = {
  title: 'Health Records Integration Zero-Trust Identity & Access Manager',
  description: 'health records integration solution for edtech industry. Implements zero-trust security architecture with continuous authentication and adaptive access controls',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/health-records-integration-zero-trust-identity--access-manager-5f364161',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Health Records Integration Zero-Trust Identity & Access Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            health records integration solution for edtech industry. Implements zero-trust security architecture with continuous authentication and adaptive access controls.
          </p>
