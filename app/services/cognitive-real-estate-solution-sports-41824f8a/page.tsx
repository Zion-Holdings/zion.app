...
export const metadata: Metadata = {
  title: 'Cognitive Real Estate Solution - Sports',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Real Estate Solution - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in sports with Cognitive Real Estate Solution - Sports. This AI-powered platform transforms customer insights into a competitive advantage.
          </p>
