      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Private, fine-tuned AI coding copilot trained on your internal repositories with role-based access and SOC 2 compliance.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Private fine-tuned model</li>
            <li className="text-purple-300">✓ Repo-aware completions</li>
            <li className="text-purple-300">✓ Security scanning integrations</li>
            <li className="text-purple-300">✓ Role-based access</li>
            <li className="text-purple-300">✓ On-prem or VPC deployment</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai code assistant (enterprise)</li>
