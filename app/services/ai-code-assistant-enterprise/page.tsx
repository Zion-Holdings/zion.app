...
export const metadata: Metadata = {
  ...
  keywords: 'Private fine-tuned model, Repo-aware completions, Security scanning integrations, Role-based access, On-prem or VPC deployment, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Code Assistant (Enterprise)</h1>
        <p className="text-lg text-slate-300 mb-8">Private, fine-tuned AI coding copilot trained on your internal repositories with role-based access and SOC 2 compliance.</p>
        ...
        <li class="text-slate-300">Private fine-tuned model</li>
        <li class="text-slate-300">Repo-aware completions</li>
        <li class="text-slate-300">Security scanning integrations</li>
        <li class="text-slate-300">Role-based access</li>
        <li class="text-slate-300">On-prem or VPC deployment</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai code assistant (enterprise)</li>
