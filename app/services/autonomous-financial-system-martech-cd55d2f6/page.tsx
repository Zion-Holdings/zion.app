...
export const metadata: Metadata = {
  title: 'Autonomous Financial System - MARTECH',
  description: 'Next-generation martech solution: Autonomous Financial System - MARTECH. Combines testing automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-financial-system-martech-cd55d2f6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Financial System - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation martech solution: Autonomous Financial System - MARTECH. Combines testing automation with adaptive intelligence for optimal results.
          </p>
