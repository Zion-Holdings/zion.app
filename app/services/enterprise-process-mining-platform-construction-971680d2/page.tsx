...
export const metadata: Metadata = {
  title: 'Enterprise Process Mining Platform - Construction',
  description: 'Drive innovation in construction with Enterprise Process Mining Platform - Construction. This AI-powered platform transforms record processing into a competitiv',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Process Mining Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Enterprise Process Mining Platform - Construction. This AI-powered platform transforms record processing into a competitive advantage.
          </p>
