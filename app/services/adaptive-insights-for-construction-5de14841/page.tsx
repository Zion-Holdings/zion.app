...
export const metadata: Metadata = {
  ...
  keywords: 'Zero-downtime updates, Container orchestration, Offline capabilities, GDPR compliance, Performance dashboards, Microservices deployment, orchestrator, construction, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Adaptive Insights for Construction</h1>
        <p className="text-lg text-slate-300 mb-8">The future of construction is here with Adaptive Insights for Construction. Powered by cutting-edge AI, this platform delivers data processing like never before.</p>
