...
export const metadata: Metadata = {
  title: 'Cognitive Advisor for Energy',
  description: 'Revolutionize energy through intelligent automation. Our Cognitive Advisor for Energy leverages advanced machine learning to deliver customer insights at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-advisor-for-energy-c9bb3313',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Advisor for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Cognitive Advisor for Energy leverages advanced machine learning to deliver customer insights at scale.
          </p>
