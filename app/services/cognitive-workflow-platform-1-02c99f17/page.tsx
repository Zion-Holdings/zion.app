...
export const metadata: Metadata = {
  title: 'Cognitive Workflow Platform #1',
  description: 'Quantum leap forward for retail: Cognitive Workflow Platform #1. Uses quantum-inspired algorithms to deliver low-code automation at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-workflow-platform-1-02c99f17',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Workflow Platform #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for retail: Cognitive Workflow Platform #1. Uses quantum-inspired algorithms to deliver low-code automation at exponential speed.
          </p>
