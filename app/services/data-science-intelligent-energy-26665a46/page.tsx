...
export const metadata: Metadata = {
  title: 'Data Science Intelligent - Energy',
  description: 'Transform your energy operations with our Data Science Intelligent - Energy. This AI-driven solution provides intelligent automation with unprecedented accuracy',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-science-intelligent-energy-26665a46',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Science Intelligent - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Data Science Intelligent - Energy. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
