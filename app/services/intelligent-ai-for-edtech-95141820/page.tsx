...
export const metadata: Metadata = {
  title: 'Intelligent AI for EDTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent AI for EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your edtech business with Intelligent AI for EDTECH. Our solution provides record extraction with enterprise-grade reliability and security.
          </p>
