...
export const metadata: Metadata = {
  title: 'Infrastructure Monitoring Multi-Cloud Cost Management Platform',
  description: 'AI-powered infrastructure monitoring solution for cloud operations. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/infrastructure-monitoring-multi-cloud-cost-management-platform-f380677c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Infrastructure Monitoring Multi-Cloud Cost Management Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered infrastructure monitoring solution for cloud operations. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Cross-cloud monitoring</li>
        ...
        <section className="mb-12">
          ...
          <li className="text-purple-300">Unified view</li>
          </ul>
        </section>
