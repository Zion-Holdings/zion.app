...
export const metadata: Metadata = {
  title: 'Neural analytics-energy',
  description: 'Drive innovation in energy with Neural analytics-energy. This AI-powered platform transforms succession planning into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-analytics-energy-76509aab',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural analytics-energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Neural analytics-energy. This AI-powered platform transforms succession planning into a competitive advantage.
          </p>
