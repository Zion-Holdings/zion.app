...
export const metadata: Metadata = {
  title: 'Cognitive Intelligent Solution - PROPTECH',
  description: 'Drive innovation in proptech with Cognitive Intelligent Solution - PROPTECH. This AI-powered platform transforms sustainability tracking into a competitive adva',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-intelligent-solution-proptech-ca3809ca',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Intelligent Solution - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in proptech with Cognitive Intelligent Solution - PROPTECH. This AI-powered platform transforms sustainability tracking into a competitive advantage.
          </p>
