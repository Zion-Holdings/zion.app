...
export const metadata: Metadata = {
  title: 'AI-Powered intelligent-transportation',
  description: 'Optimize your transportation workflows with AI-Powered intelligent-transportation. This intelligent platform delivers leave management through advanced automati',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-intelligent-transportation-3311af2f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with AI-Powered intelligent-transportation. This intelligent platform delivers leave management through advanced automation and AI.
          </p>
