...
export const metadata: Metadata = {
  title: 'Cognitive Cognitive - Healthcare',
  description: 'Next-generation healthcare solution: Cognitive Cognitive - Healthcare. Combines recruitment automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-cognitive-healthcare-e80cccad',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Cognitive - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Cognitive Cognitive - Healthcare. Combines recruitment automation with adaptive intelligence for optimal results.
          </p>
