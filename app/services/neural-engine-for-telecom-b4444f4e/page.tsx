...
export const metadata: Metadata = {
  title: 'Neural Engine for Telecom',
  description: 'Revolutionize telecom through intelligent automation. Our Neural Engine for Telecom leverages advanced machine learning to deliver customer service automation a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Engine for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Neural Engine for Telecom leverages advanced machine learning to deliver customer service automation at scale.
          </p>
