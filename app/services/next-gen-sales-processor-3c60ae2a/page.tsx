...
export const metadata: Metadata = {
  title: 'Next-Gen Sales Processor',
  description: 'Drive innovation in cleantech with Next-Gen Sales Processor. This AI-powered platform transforms fraud prevention into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-sales-processor-3c60ae2a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Sales Processor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in cleantech with Next-Gen Sales Processor. This AI-powered platform transforms fraud prevention into a competitive advantage.
          </p>
