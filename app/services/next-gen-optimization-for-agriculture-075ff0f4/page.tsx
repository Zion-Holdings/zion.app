...
export const metadata: Metadata = {
  title: 'Next-Gen Optimization for Agriculture',
  description: 'Next-generation agriculture solution: Next-Gen Optimization for Agriculture. Combines model interpretability with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-optimization-for-agriculture-075ff0f4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Optimization for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agriculture solution: Next-Gen Optimization for Agriculture. Combines model interpretability with adaptive intelligence for optimal results.
          </p>
