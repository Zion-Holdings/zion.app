...
export const metadata: Metadata = {
  title: 'AI/IT Tactical Suite - Gaming',
  description: 'Optimize your gaming workflows with AI/IT Tactical Suite - Gaming. This intelligent platform delivers generative ai through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-tactical-suite-gaming-dcc3afd4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Tactical Suite - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your gaming workflows with AI/IT Tactical Suite - Gaming. This intelligent platform delivers generative ai through advanced automation and AI.
          </p>
