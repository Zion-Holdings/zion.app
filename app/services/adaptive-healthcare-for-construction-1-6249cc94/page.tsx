...
export const metadata: Metadata = {
  title: 'Adaptive Healthcare for Construction #1',
  description: 'Transform your construction operations with our Adaptive Healthcare for Construction #1. This AI-driven solution automates fraud prevention with unprecedented a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Healthcare for Construction #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Adaptive Healthcare for Construction #1. This AI-driven solution automates fraud prevention with unprecedented accuracy and efficiency.
          </p>
