...
export const metadata: Metadata = {
  title: 'Intelligent Compliance Predictor',
  description: 'Revolutionize gaming through intelligent automation. Our Intelligent Compliance Predictor leverages advanced machine learning to deliver market intelligence at ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Compliance Predictor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize gaming through intelligent automation. Our Intelligent Compliance Predictor leverages advanced machine learning to deliver market intelligence at scale.
          </p>
