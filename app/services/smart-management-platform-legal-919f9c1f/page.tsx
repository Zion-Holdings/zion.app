...
export const metadata: Metadata = {
  title: 'Smart Management Platform - Legal',
  description: 'Transform your legal operations with our Smart Management Platform - Legal. This AI-driven solution automates social media monitoring with unprecedented accurac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-management-platform-legal-919f9c1f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Management Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Smart Management Platform - Legal. This AI-driven solution automates social media monitoring with unprecedented accuracy and efficiency.
          </p>
