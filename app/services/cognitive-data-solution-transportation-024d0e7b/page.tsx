...
export const metadata: Metadata = {
  title: 'Cognitive Data Solution - Transportation',
  description: 'Optimize your transportation workflows with Cognitive Data Solution - Transportation. This intelligent platform delivers capacity management through advanced au',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-data-solution-transportation-024d0e7b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Data Solution - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Cognitive Data Solution - Transportation. This intelligent platform delivers capacity management through advanced automation and AI.
          </p>
