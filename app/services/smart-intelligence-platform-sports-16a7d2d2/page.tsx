...
export const metadata: Metadata = {
  title: 'Smart Intelligence Platform - Sports',
  description: 'Unlock unprecedented growth with Smart Intelligence Platform - Sports. This autonomous system provides access management with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-intelligence-platform-sports-16a7d2d2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Intelligence Platform - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Intelligence Platform - Sports. This autonomous system provides access management with zero manual intervention needed.
          </p>
