...
export const metadata: Metadata = {
  title: 'Intelligent Supply Data',
  description: 'Transform your agritech operations with our Intelligent Supply Data. This AI-driven solution automates network optimization with unprecedented accuracy and effi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-supply-data-e32558ec',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your agritech operations with our Intelligent Supply Data. This AI-driven solution automates network optimization with unprecedented accuracy and efficiency.
          </p>
