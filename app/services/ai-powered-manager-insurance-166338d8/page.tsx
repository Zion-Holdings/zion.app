...
export const metadata: Metadata = {
  title: 'AI-Powered manager-insurance',
  description: 'Enhance your insurance business with AI-Powered manager-insurance. Our solution provides decision support with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-manager-insurance-166338d8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered manager-insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with AI-Powered manager-insurance. Our solution provides decision support with enterprise-grade reliability and security.
          </p>
