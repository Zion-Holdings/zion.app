...
export const metadata: Metadata = {
  title: 'Autonomous Procurement Supply',
  description: 'Optimize your telecom workflows with Autonomous Procurement Supply. This intelligent platform delivers automation opportunity through advanced automation and AI',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-procurement-supply-3668239c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Procurement Supply
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your telecom workflows with Autonomous Procurement Supply. This intelligent platform delivers automation opportunity through advanced automation and AI.
          </p>
