...
export const metadata: Metadata = {
  title: 'Smart SMB Platform - HEALTHTECH',
  description: 'Drive innovation in healthtech with Smart SMB Platform - HEALTHTECH. This AI-powered platform transforms manufacturing quality control into a competitive advant',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-smb-platform-healthtech-48079827',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart SMB Platform - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthtech with Smart SMB Platform - HEALTHTECH. This AI-powered platform transforms manufacturing quality control into a competitive advantage.
          </p>
