...
export const metadata: Metadata = {
  ...
  keywords: 'Feature definition registry per team, Offline feature compute (dbt/SQL transforms), Online feature serving sub-10ms (Feast/Redis), Point-in-time correctness validation, Model drift detect + alert on distribution shift, data, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Feature Engineering Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Feature store as-a-service: feature definition registry, feature pipeline orchestration, online + offline serving, point-in-time correctness, model drift detection.</p>
        ...
        <li class="text-slate-300">Feature definition registry per team</li>
        <li class="text-slate-300">Offline feature compute (dbt/SQL transforms)</li>
        <li class="text-slate-300">Online feature serving sub-10ms (Feast/Redis)</li>
        <li class="text-slate-300">Point-in-time correctness validation</li>
        <li class="text-slate-300">Model drift detect + alert on distribution shift</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with feature engineering platform</li>
