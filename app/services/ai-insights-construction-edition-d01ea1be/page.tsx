...
export const metadata: Metadata = {
  title: 'AI Insights - Construction Edition',
  description: 'Next-generation construction solution: AI Insights - Construction Edition. Combines data pipeline orchestration with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-insights-construction-edition-d01ea1be',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Insights - Construction Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: AI Insights - Construction Edition. Combines data pipeline orchestration with adaptive intelligence for optimal results.
          </p>
