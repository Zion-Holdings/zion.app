...
export const metadata: Metadata = {
  title: 'Autonomous Startup System - Transportation',
  description: 'Enhance your transportation business with Autonomous Startup System - Transportation. Our solution provides compliance monitoring with enterprise-grade reliabil',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-startup-system-transportation-2e7142e0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Startup System - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with Autonomous Startup System - Transportation. Our solution provides compliance monitoring with enterprise-grade reliability and security.
          </p>
