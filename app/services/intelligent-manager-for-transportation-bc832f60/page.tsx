...
export const metadata: Metadata = {
  title: 'Intelligent Manager for Transportation',
  description: 'Optimize your transportation workflows with Intelligent Manager for Transportation. This intelligent platform delivers expense reporting through advanced automa',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Manager for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Intelligent Manager for Transportation. This intelligent platform delivers expense reporting through advanced automation and AI.
          </p>
