...
export const metadata: Metadata = {
  ...
  keywords: 'Legacy system assessment and planning, Automated schema conversion, Zero-downtime migration execution, Data validation and reconciliation, Rollback capabilities, Performance testing post-migration, Documentation and knowledge transfer, Post-migration support, it, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Data Migration &amp; Modernization Service</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end data migration from legacy systems to modern cloud platforms. Zero-downtime migration with automated validation.</p>
        ...
        <li class="text-slate-300">Legacy system assessment and planning</li>
        <li class="text-slate-300">Automated schema conversion</li>
        <li class="text-slate-300">Zero-downtime migration execution</li>
        <li class="text-slate-300">Data validation and reconciliation</li>
        <li class="text-slate-300">Rollback capabilities</li>
        <li class="text-slate-300">Performance testing post-migration</li>
        <li class="text-slate-300">Documentation and knowledge transfer</li>
        <li class="text-slate-300">Post-migration support</li>
      </ul>
        </div>
        ...
        <li class="text-slate-300">Modernize legacy infrastructure</li>
        <li class="text-slate-300">Reduce technical debt</li>
        <li class="text-slate-300">Ensure data integrity</li>
      </ul>
        </div>
