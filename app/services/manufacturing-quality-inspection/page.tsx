...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time defect detection, Dimensional measurement, Surface inspection, Assembly verification, Statistical process control, Integration with PLC/SCADA, Custom model training, Defect trend analytics, manufacturing-tech, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Visual Quality Inspection System</h1>
        <p className="text-lg text-slate-300 mb-8">Computer vision-based quality inspection for manufacturing lines. Detect defects, measure dimensions, and classify products in real-time with 99.5% accuracy.</p>
        ...
        <li class="text-slate-300">Surface inspection</li>
        <li class="text-slate-300">Assembly verification</li>
        <li class="text-slate-300">Statistical process control</li>
        <li class="text-slate-300">Integration with PLC/SCADA</li>
        <li class="text-slate-300">Custom model training</li>
        <li class="text-slate-300">Defect trend analytics</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce defect escape rate by 90%</li>
        <li class="text-slate-300">Eliminate manual inspection</li>
        <li class="text-slate-300">Improve product quality</li>
        <li class="text-slate-300">Reduce warranty costs</li>
      </ul>
        </div>
