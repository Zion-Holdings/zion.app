...
export const metadata: Metadata = {
  title: 'Predictive Image Intelligent',
  description: 'The future of construction is here with Predictive Image Intelligent. Powered by cutting-edge AI, this platform delivers recommendation system like never before',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-image-intelligent-eb34d6e8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Image Intelligent
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Predictive Image Intelligent. Powered by cutting-edge AI, this platform delivers recommendation system like never before.
          </p>
