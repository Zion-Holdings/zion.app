...
export const metadata: Metadata = {
  title: 'Programmatic Advertising AI-Powered Email Marketing Automation',
  description: 'AI-powered programmatic advertising solution for marketing. Automated email campaigns with dynamic content and A/B testing.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/programmatic-advertising-ai-powered-email-marketing-automation-b6498731',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Programmatic Advertising AI-Powered Email Marketing Automation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered programmatic advertising solution for marketing. Automated email campaigns with dynamic content and A/B testing.
          </p>
