...
export const metadata = {
  ...
  description: "Revolutionize Real Estate through intelligent automation. Our Optimizer Self-Optimizing - Real Estate leverages advanced machine learning to deliver competitive",
  alternates: {
