...
export const metadata: Metadata = {
  title: 'Self-Optimizing Case Smart',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Case Smart
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthtech workflows with Self-Optimizing Case Smart. This intelligent platform delivers claims processing through advanced automation and AI.
          </p>
