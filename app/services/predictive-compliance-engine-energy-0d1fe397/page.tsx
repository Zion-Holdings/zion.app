  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Enhance your energy business with Predictive Compliance Engine - Energy. Our solution provides feature engineering with enterprise-grade reliability and security.</p>
