      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart performance-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with Smart performance-legal. This intelligent platform delivers sales process optimization through advanced automation and AI.
          </p>
