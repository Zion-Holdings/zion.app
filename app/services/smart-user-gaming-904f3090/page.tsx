...
export const metadata: Metadata = {
  title: 'Smart user-gaming',
  description: 'Transform your gaming operations with our Smart user-gaming. This AI-driven solution automates financial risk management with unprecedented accuracy and efficie',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-user-gaming-904f3090',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your gaming operations with our Smart user-gaming. This AI-driven solution automates financial risk management with unprecedented accuracy and efficiency.
          </p>
