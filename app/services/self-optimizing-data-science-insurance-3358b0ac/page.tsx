...
export const metadata: Metadata = {
  title: 'Self-Optimizing data science-insurance',
  description: 'Enhance your insurance business with Self-Optimizing data science-insurance. Our solution provides procurement automation with enterprise-grade reliability and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/self-optimizing-data-science-insurance-3358b0ac',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing data science-insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Self-Optimizing data science-insurance. Our solution provides procurement automation with enterprise-grade reliability and security.
          </p>
