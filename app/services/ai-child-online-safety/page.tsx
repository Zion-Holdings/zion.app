    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI Child Online Safety & Parental Control Platform
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          Protect children online: content filtering, cyberbullying detection, screen time management, location tracking, and app monitoring. Age-adaptive AI that grows w
        </p>
