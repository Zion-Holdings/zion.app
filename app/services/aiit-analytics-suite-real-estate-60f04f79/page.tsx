...
export const metadata: Metadata = {
  title: 'AI/IT Analytics Suite - Real-Estate',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Analytics Suite - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with AI/IT Analytics Suite - Real-Estate. This autonomous system provides vendor management with zero manual intervention needed.
          </p>
