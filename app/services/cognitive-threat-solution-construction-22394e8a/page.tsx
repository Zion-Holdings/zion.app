...
export const metadata: Metadata = {
  title: 'Cognitive Threat Solution - Construction',
  description: 'Optimize your construction workflows with Cognitive Threat Solution - Construction. This intelligent platform delivers budget tracking through advanced automati',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-threat-solution-construction-22394e8a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Threat Solution - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Cognitive Threat Solution - Construction. This intelligent platform delivers budget tracking through advanced automation and AI.
          </p>
