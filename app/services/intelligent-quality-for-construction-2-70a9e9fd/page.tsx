...
export const metadata: Metadata = {
  title: 'Intelligent Quality for Construction #2',
  description: 'Revolutionize construction through intelligent automation. Our Intelligent Quality for Construction #2 leverages advanced machine learning to deliver vendor man',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-quality-for-construction-2-70a9e9fd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Quality for Construction #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Intelligent Quality for Construction #2 leverages advanced machine learning to deliver vendor management at scale.
          </p>
