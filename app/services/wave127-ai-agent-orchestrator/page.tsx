...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-agent workflow definition & orchestration, Guardrail enforcement & output validation, Real-time agent monitoring & observability, Human-in-the-loop escalation paths, Agent performance analytics & benchmarking, Tool & API permission management, Agent versioning & rollback, Horizontal auto-scaling for peak workloads, ai, AI Automation, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Agent Orchestrator</h1>
        <p className="text-lg text-slate-300 mb-8">Production-grade platform for managing, monitoring, and scaling fleets of autonomous AI agents. Define workflows, enforce guardrails, track performance, and coordinate multi-agent systems — turning experimental agents into reliable business automation.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">ai</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">AI Automation</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Multi-agent workflow definition &amp; orchestration</li>
        <li class="text-slate-300">Guardrail enforcement &amp; output validation</li>
        <li class="text-slate-300">Real-time agent monitoring &amp; observability</li>
        <li class="text-slate-300">Human-in-the-loop escalation paths</li>
        <li class="text-slate-300">Agent performance analytics &amp; benchmarking</li>
        <li class="text-slate-300">Tool &amp; API permission management</li>
        <li class="text-slate-300">Agent versioning &amp; rollback</li>
        <li class="text-slate-300">Horizontal auto-scaling for peak workloads</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Deploy AI agents to production with confidence</li>
        <li class="text-slate-300">Coordinate complex multi-step tasks across agents</li>
        <li class="text-slate-300">Full auditability and compliance for autonomous systems</li>
        <li class="text-slate-300">Scale agent fleets from 10 to 10,000 seamlessly</li>
      </ul>
        </div>
