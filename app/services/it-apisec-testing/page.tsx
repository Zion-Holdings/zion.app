...
export const metadata: Metadata = {
  ...
  keywords: 'DAST + SCA for APIs, Authentication flaw detection, Rate-limiting & throttling tests, CI/CD pipeline integration, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">API Security Testing</h1>
        <p className="text-lg text-slate-300 mb-8">Automated security scans for REST, GraphQL, and gRPC APIs. Detects OWASP API Top 10 vulnerabilities and provides remediation code snippets.</p>
        ...
        <li class="text-slate-300">DAST + SCA for APIs</li>
        <li class="text-slate-300">Authentication flaw detection</li>
        <li class="text-slate-300">Rate-limiting &amp; throttling tests</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with api security testing</li>
