...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-channel sentiment tracking, Emotion intensity scoring, Trend detection and alerting, Competitor sentiment benchmarking, Actionable insight generation, ai, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Customer Sentiment Analytics</h1>
        <p className="text-lg text-slate-300 mb-8">Real-time sentiment analysis across reviews, surveys, social media, and support interactions to drive proactive customer experience improvements.</p>
        ...
        <li class="text-slate-300">Multi-channel sentiment tracking</li>
        <li class="text-slate-300">Emotion intensity scoring</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai customer sentiment analytics</li>
