      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Real-time sentiment analysis across reviews, surveys, social media, and support interactions to drive proactive customer experience improvements.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Multi-channel sentiment tracking</li>
            <li className="text-purple-300">✓ Emotion intensity scoring</li>
            <li className="text-purple-300">✓ Trend detection and alerting</li>
            <li className="text-purple-300">✓ Competitor sentiment benchmarking</li>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai customer sentiment analytics</li>
