...
export const metadata: Metadata = {
  title: 'Smart orchestrator-cleantech',
  description: 'The future of cleantech is here with Smart orchestrator-cleantech. Powered by cutting-edge AI, this platform delivers sales process optimization like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-orchestrator-cleantech-ed83a5db',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart orchestrator-cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of cleantech is here with Smart orchestrator-cleantech. Powered by cutting-edge AI, this platform delivers sales process optimization like never before.
          </p>
