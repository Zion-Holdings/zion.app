...
export const metadata: Metadata = {
  title: 'Intelligent Finance for Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Intelligent Finance for Hospitality leverages advanced machine learning to deliver content generat',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-finance-for-hospitality-c6d8d16a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Finance for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Intelligent Finance for Hospitality leverages advanced machine learning to deliver content generation at scale.
          </p>
