...
export const metadata: Metadata = {
  title: 'Automated Finance for Technology',
  description: 'Transform your technology operations with our Automated Finance for Technology. This AI-driven solution automates customer service automation with unprecedented',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Finance for Technology
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your technology operations with our Automated Finance for Technology. This AI-driven solution automates customer service automation with unprecedented accuracy and efficiency.
          </p>
