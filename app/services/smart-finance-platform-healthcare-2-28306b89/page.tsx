...
export const metadata: Metadata = {
  title: 'Smart Finance Platform - Healthcare #2',
  description: 'Enhance your healthcare business with Smart Finance Platform - Healthcare #2. Our solution provides customer retention with enterprise-grade reliability and sec',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-finance-platform-healthcare-2-28306b89',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Finance Platform - Healthcare #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with Smart Finance Platform - Healthcare #2. Our solution provides customer retention with enterprise-grade reliability and security.
          </p>
