...
export const metadata: Metadata = {
  title: 'Neural Analytics for Construction',
  description: 'The future of construction is here with Neural Analytics for Construction. Powered by cutting-edge AI, this platform delivers quality assurance like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-analytics-for-construction-cf3db601',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Analytics for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Neural Analytics for Construction. Powered by cutting-edge AI, this platform delivers quality assurance like never before.
          </p>
