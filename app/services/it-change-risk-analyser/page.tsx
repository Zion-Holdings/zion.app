...
export const metadata: Metadata = {
  ...
  keywords: 'Blast-radius graph builder, ML-predicted outage probability, Change approval workflow, Historical change success rate, SLA impact calculator, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Change Risk Analyser</h1>
        <p className="text-lg text-slate-300 mb-8">Assess change request risk using historical data, blast-radius modelling, and ML-predicted outage probability. Integrates with ServiceNow and Jira change management.</p>
        ...
        <li class="text-slate-300">Blast-radius graph builder</li>
        <li class="text-slate-300">ML-predicted outage probability</li>
        <li class="text-slate-300">Change approval workflow</li>
        <li class="text-slate-300">Historical change success rate</li>
        <li class="text-slate-300">SLA impact calculator</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with it change risk analyser</li>
