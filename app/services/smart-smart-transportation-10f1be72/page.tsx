...
export const metadata: Metadata = {
  title: 'Smart smart-transportation',
  description: 'Transform your transportation operations with our Smart smart-transportation. This AI-driven solution automates data governance with unprecedented accuracy and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-smart-transportation-10f1be72',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your transportation operations with our Smart smart-transportation. This AI-driven solution automates data governance with unprecedented accuracy and efficiency.
          </p>
