...
export const metadata: Metadata = {
  title: `Real-Time Personalisation Engine | Zion Tech Group`,
  ...
  keywords: 'Session-based collaborative-filtering per user, LLM cold-start description for new/no-history users, Auto A/B variant per homepage/checkout/product, JSON recommendation API (endpoint per user/context), ai, General, Zion Tech Group',
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-personalisation-engine-realtime/`,
  },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Real-Time Personalisation Engine</h1>
        <p className="text-lg text-slate-300 mb-8">Session-based recommendation: collaborative-filtering + LLM cold-start description; auto A/B homepage variant; JSON recommendation API.</p>
        ...
        <li class="text-slate-300">Session-based collaborative-filtering per user</li>
        <li class="text-slate-300">LLM cold-start description for new/no-history users</li>
        <li class="text-slate-300">Auto A/B variant per homepage/checkout/product</li>
        <li class="text-slate-300">JSON recommendation API (endpoint per user/context)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with real-time personalisation engine</li>
