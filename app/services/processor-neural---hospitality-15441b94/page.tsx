...
export const metadata: Metadata = {
  title: 'Processor Neural - Hospitality',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Processor Neural - Hospitality. Combines language processing with adaptive intelligence for optimal results.
          </p>
