...
export const metadata: Metadata = {
  ...
  description: 'partnership management solution for veterinary services industry. Automatically detects, corrects, and prevents data quality issues using machine learning.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/partnership-management-ai-powered-data-quality-manager-b5c3f531',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            partnership management solution for veterinary services industry. Automatically detects, corrects, and prevents data quality issues using machine learning.
          </p>
