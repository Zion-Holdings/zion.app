...
export const metadata: Metadata = {
  title: 'Smart Automation Platform - AITECH',
  description: 'The future of aitech is here with Smart Automation Platform - AITECH. Powered by cutting-edge AI, this platform delivers scenario planning like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-automation-platform-aitech-bc35f8a6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Automation Platform - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of aitech is here with Smart Automation Platform - AITECH. Powered by cutting-edge AI, this platform delivers scenario planning like never before.
          </p>
