...
export const metadata: Metadata = {
  title: 'Cognitive Contract Solution - Legal',
  description: 'Drive innovation in legal with Cognitive Contract Solution - Legal. This AI-powered platform transforms capacity management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-contract-solution-legal-86358bde',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Contract Solution - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Cognitive Contract Solution - Legal. This AI-powered platform transforms capacity management into a competitive advantage.
          </p>
