...
export const metadata: Metadata = {
  ...
  keywords: 'Clause extraction and classification, Risk scoring per clause and overall, Playbook comparison and deviation flagging, Red-line and alternative clause suggestions, Obligation extraction and tracking, Template generation from approved clauses, Integration with DocuSign, Ironclad, Contractbook, ai, Legal, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Contract Analyzer &amp; Negotiator</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered contract analysis: clause extraction, risk scoring, comparison against playbooks, and red-line suggestions. Reduce legal review time by 80%.</p>
        ...
        <li class="text-slate-300">Clause extraction and classification</li>
        <li class="text-slate-300">Risk scoring per clause and overall</li>
        <li class="text-slate-300">Playbook comparison and deviation flagging</li>
        <li class="text-slate-300">Red-line and alternative clause suggestions</li>
        <li class="text-slate-300">Obligation extraction and tracking</li>
        <li class="text-slate-300">Template generation from approved clauses</li>
        <li class="text-slate-300">Integration with DocuSign, Ironclad, Contractbook</li>
      </ul>
        </div>
        ...
        <li class="text-slate-300">Consistent playbook enforcement</li>
        <li class="text-slate-300">Risk scoring prioritizes negotiation items</li>
        <li class="text-slate-300">Obligation tracking prevents missed commitments</li>
      </ul>
        </div>
