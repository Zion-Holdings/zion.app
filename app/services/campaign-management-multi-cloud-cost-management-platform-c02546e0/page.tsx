...
export const metadata: Metadata = {
  title: 'Campaign Management Multi-Cloud Cost Management Platform',
  description: 'campaign management solution for water parks industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/campaign-management-multi-cloud-cost-management-platform-c02546e0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Campaign Management Multi-Cloud Cost Management Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            campaign management solution for water parks industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.
          </p>
