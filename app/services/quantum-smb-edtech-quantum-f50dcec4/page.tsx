...
export const metadata: Metadata = {
  title: 'Quantum SMB - EDTECH Quantum',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum SMB - EDTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation edtech solution: Quantum SMB - EDTECH Quantum. Combines background checks with adaptive intelligence for optimal results.
          </p>
