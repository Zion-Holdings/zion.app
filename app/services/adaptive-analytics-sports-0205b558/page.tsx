...
export const metadata: Metadata = {
  title: 'Adaptive analytics-sports',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive analytics-sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Adaptive analytics-sports. Powered by cutting-edge AI, this platform delivers sales process optimization like never before.
          </p>
