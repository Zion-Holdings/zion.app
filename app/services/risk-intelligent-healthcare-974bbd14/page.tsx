...
export const metadata: Metadata = {
  title: 'Risk Intelligent - Healthcare',
  description: 'Next-generation healthcare solution: Risk Intelligent - Healthcare. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/risk-intelligent-healthcare-974bbd14',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Risk Intelligent - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Risk Intelligent - Healthcare. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
