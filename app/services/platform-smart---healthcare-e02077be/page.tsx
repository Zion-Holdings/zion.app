...
export const metadata: Metadata = {
  title: 'Platform Smart - Healthcare',
  description: 'Next-generation healthcare solution: Platform Smart - Healthcare. Combines financial risk management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/platform-smart---healthcare-e02077be',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Platform Smart - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Platform Smart - Healthcare. Combines financial risk management with adaptive intelligence for optimal results.
          </p>
