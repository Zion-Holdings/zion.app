...
export const metadata: Metadata = {
  ...
  description: 'Drive innovation in energy with Intelligent System for Energy. This AI-powered platform transforms capacity management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-system-for-energy-78fde2d1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Intelligent System for Energy. This AI-powered platform transforms capacity management into a competitive advantage.
          </p>
