...
export const metadata: Metadata = {
  title: 'Intelligent Resource System',
  description: 'The future of transportation is here with Intelligent Resource System. Powered by cutting-edge AI, this platform delivers market analysis like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-resource-system-8f458d0c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Intelligent Resource System. Powered by cutting-edge AI, this platform delivers market analysis like never before.
          </p>
