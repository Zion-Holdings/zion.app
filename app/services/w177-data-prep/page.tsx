...
export const metadata: Metadata = {
  ...
  keywords: 'No-code data cleaning and transformation, Deduplication and matching, Data enrichment (firmographic, demographic), Formula and calculated fields, Scheduling and automation, API for programmatic pipelines, Integration with Trifacta, Alteryx, pandas, data, Data Engineering, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Data Preparation and Wrangling</h1>
        <p className="text-lg text-slate-300 mb-8">Self-service data preparation: cleaning, transformation, deduplication, enrichment. No-code for analysts.</p>
        ...
        <li class="text-slate-300">No-code data cleaning and transformation</li>
        <li class="text-slate-300">Deduplication and matching</li>
        <li class="text-slate-300">Data enrichment (firmographic</li>
        <li class="text-slate-300">demographic)</li>
        <li class="text-slate-300">Formula and calculated fields</li>
        <li class="text-slate-300">Scheduling and automation</li>
        <li class="text-slate-300">API for programmatic pipelines</li>
        <li class="text-slate-300">Integration with Trifacta</li>
        <li class="text-slate-300">Alteryx</li>
        <li class="text-slate-300">pandas</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Self-service prep reduces analyst wait time</li>
        <li class="text-slate-300">Deduplication improves data quality</li>
        <li class="text-slate-300">Enrichment adds context to raw data</li>
        <li class="text-slate-300">Scheduling automates recurring prep</li>
      </ul>
        </div>
