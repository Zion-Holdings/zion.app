...
export const metadata: Metadata = {
  title: 'Intelligent Code Data Science',
  description: 'Transform your althealth operations with our Intelligent Code Data Science. This AI-driven solution automates survey automation with unprecedented accuracy and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-code-data-science-40b866f7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Code Data Science
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your althealth operations with our Intelligent Code Data Science. This AI-driven solution automates survey automation with unprecedented accuracy and efficiency.
          </p>
