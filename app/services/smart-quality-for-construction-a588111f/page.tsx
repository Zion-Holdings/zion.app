...
export const metadata: Metadata = {
  title: 'Smart Quality for Construction',
  description: 'Enhance your construction business with Smart Quality for Construction. Our solution provides ai ethics with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-quality-for-construction-a588111f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Quality for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Smart Quality for Construction. Our solution provides ai ethics with enterprise-grade reliability and security.
          </p>
