...
export const metadata: Metadata = {
  title: 'AI/IT Executive Suite - HEALTHTECH',
  description: 'Quantum leap forward for healthtech: AI/IT Executive Suite - HEALTHTECH. Uses quantum-inspired algorithms to deliver record extraction at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-executive-suite-healthtech-0ec3cbbb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Executive Suite - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for healthtech: AI/IT Executive Suite - HEALTHTECH. Uses quantum-inspired algorithms to deliver record extraction at exponential speed.
          </p>
