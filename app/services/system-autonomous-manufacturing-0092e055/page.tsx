...
export const metadata: Metadata = {
  title: 'System Autonomous - Manufacturing',
  description: 'Enhance your manufacturing business with System Autonomous - Manufacturing. Our solution provides cost reduction with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/system-autonomous-manufacturing-0092e055',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            System Autonomous - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your manufacturing business with System Autonomous - Manufacturing. Our solution provides cost reduction with enterprise-grade reliability and security.
          </p>
