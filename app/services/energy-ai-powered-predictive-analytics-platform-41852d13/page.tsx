...
export const metadata: Metadata = {
  title: 'Energy AI-Powered Predictive Analytics Platform',
  description: 'AI-powered energy solution leveraging advanced machine learning for optimal performance and ROI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/energy-ai-powered-predictive-analytics-platform-41852d13',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Energy AI-Powered Predictive Analytics Platform
          </h1>
