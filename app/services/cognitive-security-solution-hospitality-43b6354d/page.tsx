...
export const metadata: Metadata = {
  title: 'Cognitive Security Solution - Hospitality',
  description: 'Transform your hospitality operations with our Cognitive Security Solution - Hospitality. This AI-driven solution automates anomaly detection with unprecedented',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-security-solution-hospitality-43b6354d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Security Solution - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Cognitive Security Solution - Hospitality. This AI-driven solution automates anomaly detection with unprecedented accuracy and efficiency.
          </p>
