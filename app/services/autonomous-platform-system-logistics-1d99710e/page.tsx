...
export const metadata: Metadata = {
  title: 'Autonomous Platform System - Logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Autonomous Platform System - Logistics leverages advanced machine learning to deliver data quality a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-platform-system-logistics-1d99710e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Platform System - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Autonomous Platform System - Logistics leverages advanced machine learning to deliver data quality at scale.
          </p>
