...
export const metadata: Metadata = {
  title: 'Engine Neural - Tech',
  description: 'Transform your technology operations with our Engine Neural - Tech. This AI-driven solution automates customer journey mapping with unprecedented accuracy and e',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/engine-neural-tech-9e7c5dfd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your technology operations with our Engine Neural - Tech. This AI-driven solution automates customer journey mapping with unprecedented accuracy and efficiency.
          </p>
