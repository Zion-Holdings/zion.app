...
export const metadata: Metadata = {
  title: 'Autonomous Risk for Legal',
  description: 'The future of legal is here with Autonomous Risk for Legal. Powered by cutting-edge AI, this platform delivers inventory management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-risk-for-legal-a4fe47f9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Risk for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Autonomous Risk for Legal. Powered by cutting-edge AI, this platform delivers inventory management like never before.
          </p>
