...
export const metadata: Metadata = {
  title: 'AI-Powered Analyzer for Healthcare',
  description: 'The future of healthcare is here with AI-Powered Analyzer for Healthcare. Powered by cutting-edge AI, this platform delivers energy management like never before',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-analyzer-for-healthcare-cbd9dd02',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Analyzer for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with AI-Powered Analyzer for Healthcare. Powered by cutting-edge AI, this platform delivers energy management like never before.
          </p>
