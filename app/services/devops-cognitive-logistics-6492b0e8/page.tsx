...
export const metadata: Metadata = {
  title: 'DevOps Cognitive - Logistics',
  description: 'Drive innovation in logistics with DevOps Cognitive - Logistics. This AI-powered platform transforms invoice automation into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/devops-cognitive-logistics-6492b0e8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            DevOps Cognitive - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with DevOps Cognitive - Logistics. This AI-powered platform transforms invoice automation into a competitive advantage.
          </p>
