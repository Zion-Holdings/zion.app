...
export const metadata: Metadata = {
  title: 'Cognitive Quality Suite',
  description: 'Revolutionize blockchain through intelligent automation. Our Cognitive Quality Suite leverages advanced machine learning to deliver data processing at scale.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Quality Suite
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize blockchain through intelligent automation. Our Cognitive Quality Suite leverages advanced machine learning to deliver data processing at scale.
          </p>
