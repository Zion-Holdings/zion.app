...
export const metadata: Metadata = {
  title: 'Smart Suite Platform - Tech',
  description: 'Future-proof your technology with Smart Suite Platform - Tech. Our autonomous solution handles quality control end-to-end without human intervention.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-suite-platform-tech-2b6b98a6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Suite Platform - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your technology with Smart Suite Platform - Tech. Our autonomous solution handles quality control end-to-end without human intervention.
          </p>
