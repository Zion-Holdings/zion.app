...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize real-estate through intelligent automation. Our Intelligent Business Intelligence for Real-Estate leverages advanced machine learning to deliver p',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our Intelligent Business Intelligence for Real-Estate leverages advanced machine learning to deliver project portfolio at scale.
          </p>
