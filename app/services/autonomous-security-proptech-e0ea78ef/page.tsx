...
export const metadata: Metadata = {
  title: 'Autonomous security-proptech',
  description: 'Next-generation proptech solution: Autonomous security-proptech. Combines code optimization with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-security-proptech-e0ea78ef',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous security-proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation proptech solution: Autonomous security-proptech. Combines code optimization with adaptive intelligence for optimal results.
          </p>
