...
export const metadata: Metadata = {
  title: 'Smart customer service-edtech',
  description: 'Next-generation edtech solution: Smart customer service-edtech. Combines claims processing with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-customer-service-edtech-5d605ba4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart customer service-edtech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation edtech solution: Smart customer service-edtech. Combines claims processing with adaptive intelligence for optimal results.
          </p>
