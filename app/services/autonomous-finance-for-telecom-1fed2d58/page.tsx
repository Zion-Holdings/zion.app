...
export const metadata: Metadata = {
  title: 'Autonomous Finance for Telecom',
  description: 'Next-generation telecom solution: Autonomous Finance for Telecom. Combines resource utilization with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-finance-for-telecom-1fed2d58',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Finance for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation telecom solution: Autonomous Finance for Telecom. Combines resource utilization with adaptive intelligence for optimal results.
          </p>
