...
export const metadata: Metadata = {
  title: 'Synthetic Biology Workflow Engine',
  description: 'Workflow engine for DNA assembly, simulation, and lab automation.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/synthetic-biology-workflow-engine-c0aa1905',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Synthetic Biology Workflow Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Workflow engine for DNA assembly, simulation, and lab automation.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your biotech operations?</p>
