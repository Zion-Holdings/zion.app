...
export const metadata: Metadata = {
  title: 'AI/IT Enterprise Suite - CLEANTECH',
  description: 'The future of cleantech is here with AI/IT Enterprise Suite - CLEANTECH. Powered by cutting-edge AI, this platform delivers sentiment analysis like never before',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-enterprise-suite-cleantech-1f814961',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Enterprise Suite - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of cleantech is here with AI/IT Enterprise Suite - CLEANTECH. Powered by cutting-edge AI, this platform delivers sentiment analysis like never before.
          </p>
