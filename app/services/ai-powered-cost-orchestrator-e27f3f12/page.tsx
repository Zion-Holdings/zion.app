...
export const metadata: Metadata = {
  title: 'AI-Powered Cost Orchestrator',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Cost Orchestrator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with AI-Powered Cost Orchestrator. This intelligent platform delivers sentiment analysis through advanced automation and AI.
          </p>
