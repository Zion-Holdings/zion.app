...
export const metadata: Metadata = {
  title: 'AI Process Automator',
  description: 'Automates business processes using AI to understand context and make decisions.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-process-automator-66d258ea',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automates business processes using AI to understand context and make decisions.
          </p>
