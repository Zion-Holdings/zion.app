...
export const metadata: Metadata = {
  ...
  keywords: 'Route optimization (real-time), Fuel consumption analysis, Driver safety scoring, Predictive vehicle maintenance, ELD compliance tracking, Integration with telematics devices, Cargo tracking and condition monitoring, Fleet utilization analytics, logistics-tech, Logistics, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Fleet Management Platform</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered fleet management with route optimization, fuel management, driver safety monitoring, and predictive maintenance for commercial fleets.</p>
        ...
        <li class="text-slate-300">Route optimization (real-time)</li>
        <li class="text-slate-300">Fuel consumption analysis</li>
        <li class="text-slate-300">Driver safety scoring</li>
        <li class="text-slate-300">Predictive vehicle maintenance</li>
        <li class="text-slate-300">ELD compliance tracking</li>
        <li class="text-slate-300">Integration with telematics devices</li>
        <li class="text-slate-300">Cargo tracking and condition monitoring</li>
        <li class="text-slate-300">Fleet utilization analytics</li>
      </ul>
        </div>
        ...
        <li class="text-slate-300">Improve driver safety</li>
        <li class="text-slate-300">Optimize fleet utilization</li>
        <li class="text-slate-300">Reduce maintenance costs</li>
      </ul>
        </div>
