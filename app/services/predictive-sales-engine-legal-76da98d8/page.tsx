...
export const metadata: Metadata = {
  title: 'Predictive Sales Engine - Legal',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Sales Engine - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with Predictive Sales Engine - Legal. This intelligent platform delivers survey automation through advanced automation and AI.
          </p>
