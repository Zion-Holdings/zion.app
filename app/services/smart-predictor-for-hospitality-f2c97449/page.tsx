...
export const metadata: Metadata = {
  title: 'Smart Predictor for Hospitality',
  description: 'Next-generation hospitality solution: Smart Predictor for Hospitality. Combines process automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-predictor-for-hospitality-f2c97449',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Predictor for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Smart Predictor for Hospitality. Combines process automation with adaptive intelligence for optimal results.
          </p>
