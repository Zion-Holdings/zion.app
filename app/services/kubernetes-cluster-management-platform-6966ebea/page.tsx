...
export const metadata: Metadata = {
  ...
  description: 'Automated Kubernetes cluster provisioning, scaling, and management.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/kubernetes-cluster-management-platform-6966ebea',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automated Kubernetes cluster provisioning, scaling, and management.
          </p>
