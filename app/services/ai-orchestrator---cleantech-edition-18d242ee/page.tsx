...
export const metadata: Metadata = {
  title: 'AI Orchestrator - Cleantech Edition',
  description: 'Revolutionize cleantech through intelligent automation. Our AI Orchestrator - Cleantech Edition leverages advanced machine learning to deliver energy management',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-orchestrator---cleantech-edition-18d242ee',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Orchestrator - Cleantech Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cleantech through intelligent automation. Our AI Orchestrator - Cleantech Edition leverages advanced machine learning to deliver energy management at scale.
          </p>
