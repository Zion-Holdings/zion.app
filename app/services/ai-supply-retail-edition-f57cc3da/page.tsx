...
export const metadata: Metadata = {
  title: 'AI Supply - Retail Edition',
  description: 'Transform your retail operations with our AI Supply - Retail Edition. This AI-driven solution automates budget optimization with unprecedented accuracy and effi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our AI Supply - Retail Edition. This AI-driven solution automates budget optimization with unprecedented accuracy and efficiency.
          </p>
