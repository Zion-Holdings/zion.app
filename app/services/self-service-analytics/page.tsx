...
export const metadata: Metadata = {
  ...
  keywords: 'Semantic layer — named metrics single source of truth, NL to SQL per business question, Dashboard builder (no SQL required), Semantic model governance + approval workflow, Row/column-level security per user/group, data, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Self-Service Analytics Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Self-service analytics for business analysts: semantic layer + named metric layer, NL to SQL, dashboard builder, governance + lineage. No SQL required by end user.</p>
        ...
        <li class="text-slate-300">Semantic layer — named metrics single source of truth</li>
        <li class="text-slate-300">NL to SQL per business question</li>
        <li class="text-slate-300">Dashboard builder (no SQL required)</li>
        <li class="text-slate-300">Semantic model governance + approval workflow</li>
        <li class="text-slate-300">Row/column-level security per user/group</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with self-service analytics platform</li>
