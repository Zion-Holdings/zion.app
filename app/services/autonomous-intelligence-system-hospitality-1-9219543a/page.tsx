...
export const metadata: Metadata = {
  title: 'Autonomous Intelligence System - Hospitality #1',
  description: 'The future of hospitality is here with Autonomous Intelligence System - Hospitality #1. Powered by cutting-edge AI, this platform delivers contract analysis lik',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-intelligence-system-hospitality-1-9219543a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Intelligence System - Hospitality #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Autonomous Intelligence System - Hospitality #1. Powered by cutting-edge AI, this platform delivers contract analysis like never before.
          </p>
