...
export const metadata: Metadata = {
  ...
  description: 'Enhance your education business with Autonomous Financial Management. Our solution provides master data management with enterprise-grade reliability and securit',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your education business with Autonomous Financial Management. Our solution provides master data management with enterprise-grade reliability and security.
          </p>
