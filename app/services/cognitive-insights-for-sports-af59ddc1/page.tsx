...
export const metadata: Metadata = {
  title: 'Cognitive Insights for Sports',
  description: 'Transform your sports operations with our Cognitive Insights for Sports. This AI-driven solution automates quality control with unprecedented accuracy and effic',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-insights-for-sports-af59ddc1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Insights for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our Cognitive Insights for Sports. This AI-driven solution automates quality control with unprecedented accuracy and efficiency.
          </p>
