...
export const metadata: Metadata = {
  title: 'Enterprise Risk Platform - Cybersecurity',
  description: 'Enhance your cybersecurity business with Enterprise Risk Platform - Cybersecurity. Our solution provides anomaly detection with enterprise-grade reliability and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-risk-platform-cybersecurity-968bd122',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Risk Platform - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your cybersecurity business with Enterprise Risk Platform - Cybersecurity. Our solution provides anomaly detection with enterprise-grade reliability and security.
          </p>
