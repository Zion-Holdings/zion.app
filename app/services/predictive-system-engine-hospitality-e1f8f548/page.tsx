...
export const metadata: Metadata = {
  title: 'Predictive System Engine - Hospitality',
  description: 'Drive innovation in hospitality with Predictive System Engine - Hospitality. This AI-powered platform transforms capacity management into a competitive advantag',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-system-engine-hospitality-e1f8f548',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive System Engine - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Predictive System Engine - Hospitality. This AI-powered platform transforms capacity management into a competitive advantage.
          </p>
