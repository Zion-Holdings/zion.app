...
export const metadata: Metadata = {
  title: 'Suite Neural - Transportation',
  description: 'Revolutionize transportation through intelligent automation. Our Suite Neural - Transportation leverages advanced machine learning to deliver enterprise-grade i',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Suite Neural - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize transportation through intelligent automation. Our Suite Neural - Transportation leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
