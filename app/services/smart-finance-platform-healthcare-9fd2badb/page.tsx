...
export const metadata: Metadata = {
  title: 'Smart Finance Platform - Healthcare',
  description: 'Transform your healthcare operations with our Smart Finance Platform - Healthcare. This AI-driven solution automates regulatory tracking with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-finance-platform-healthcare-9fd2badb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Finance Platform - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Smart Finance Platform - Healthcare. This AI-driven solution automates regulatory tracking with unprecedented accuracy and efficiency.
          </p>
