...
export const metadata: Metadata = {
  ...
  keywords: 'Stripe/Braintree integration, Per-customer churn risk scoring, Automated retention campaigns, Win-back workflows, Revenue impact forecasting, Cohort analysis, Slack/Teams alerts, API access, micro-saas, SaaS, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Churnlytics — Churn Analytics Micro-SaaS</h1>
        <p className="text-lg text-slate-300 mb-8">Predict and prevent SaaS churn with AI. Connect Stripe/Braintree, get churn risk scores, automated retention campaigns, and revenue impact forecasting.</p>
        ...
        <li class="text-slate-300">Forecast revenue impact</li>
      </ul>
        </div>
