      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our AI Machine Learning - Construction Edition leverages advanced machine learning to deliver feedback collection at scale.
          </p>
