...
export const metadata = {
  ...
  alternates: { canonical: '/services/data-analytics-platform-modern-enterprise-2026-7871/' },

  openGraph: {
    title: 'Data Analytics Platform | Zion Tech Group',
    description: 'End-to-end data analytics platform services: assessment, deployment, and managed operations.',
    url: 'https://ziontechgroup.com/services/data-analytics-platform-modern-enterprise-2026-7871/',
...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "Data Analytics Platform | Zion Tech Group", description: "End-to-end data analytics platform services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/data-analytics-platform-modern-enterprise-2026-7871/}} />
