...
export const metadata: Metadata = {
  title: 'AI Optimizer - Transportation Edition #1',
  description: 'Enhance your transportation business with AI Optimizer - Transportation Edition #1. Our solution provides expense management with enterprise-grade reliability a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Optimizer - Transportation Edition #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with AI Optimizer - Transportation Edition #1. Our solution provides expense management with enterprise-grade reliability and security.
          </p>
