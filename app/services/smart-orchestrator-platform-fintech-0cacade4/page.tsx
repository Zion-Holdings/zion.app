...
export const metadata: Metadata = {
  title: 'Smart Orchestrator Platform - FINTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Orchestrator Platform - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation fintech solution: Smart Orchestrator Platform - FINTECH. Combines performance tracking with adaptive intelligence for optimal results.
          </p>
