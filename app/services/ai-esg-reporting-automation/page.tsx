...
export const metadata: Metadata = {
  ...
  keywords: 'Automated ESG data collection from enterprise systems, Carbon footprint calculation and tracking, GRI, SASB, TCFD, CSRD report generation, Supply chain emissions tracking, Benchmarking against industry peers, Audit-ready data trails, Stakeholder engagement portal, Integration with SAP, Workday, Salesforce, ai, sustainability, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI ESG Reporting &amp; Sustainability Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Automated ESG data collection, analysis, and reporting platform for corporate sustainability teams. Supports GRI, SASB, TCFD, and CSRD frameworks.</p>
        ...
        <li class="text-slate-300">Automated ESG data collection from enterprise systems</li>
        <li class="text-slate-300">Carbon footprint calculation and tracking</li>
        <li class="text-slate-300">GRI, SASB, TCFD, CSRD report generation</li>
        <li class="text-slate-300">Supply chain emissions tracking</li>
        <li class="text-slate-300">Benchmarking against industry peers</li>
        <li class="text-slate-300">Audit-ready data trails</li>
        <li class="text-slate-300">Stakeholder engagement portal</li>
        <li class="text-slate-300">Integration with SAP, Workday, Salesforce</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce ESG reporting time by 75%</li>
        <li class="text-slate-300">Ensure regulatory compliance</li>
        <li class="text-slate-300">Improve ESG ratings</li>
        <li class="text-slate-300">Demonstrate sustainability leadership</li>
      </ul>
        </div>
