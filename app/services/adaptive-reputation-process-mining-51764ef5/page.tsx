...
export const metadata: Metadata = {
  title: 'Adaptive Reputation Process Mining',
  description: 'Enhance your transportation business with Adaptive Reputation Process Mining. Our solution provides maintenance scheduling with enterprise-grade reliability and',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Reputation Process Mining
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with Adaptive Reputation Process Mining. Our solution provides maintenance scheduling with enterprise-grade reliability and security.
          </p>
