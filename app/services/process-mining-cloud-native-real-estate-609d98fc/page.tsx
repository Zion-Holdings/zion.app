...
export const metadata: Metadata = {
  title: 'Process Mining Cloud-Native - Real-Estate',
  description: 'Future-proof your real-estate with Process Mining Cloud-Native - Real-Estate. Our autonomous solution handles recruitment automation end-to-end without human in',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Process Mining Cloud-Native - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your real-estate with Process Mining Cloud-Native - Real-Estate. Our autonomous solution handles recruitment automation end-to-end without human intervention.
          </p>
