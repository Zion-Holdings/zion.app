...
export const metadata: Metadata = {
  title: 'Neural Supply for Transportation',
  description: 'Revolutionize transportation through intelligent automation. Our Neural Supply for Transportation leverages advanced machine learning to deliver executive dashb',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Supply for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize transportation through intelligent automation. Our Neural Supply for Transportation leverages advanced machine learning to deliver executive dashboards at scale.
          </p>
