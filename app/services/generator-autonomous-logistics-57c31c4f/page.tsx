...
export const metadata: Metadata = {
  title: 'Generator Autonomous - Logistics',
  description: 'Next-generation logistics solution: Generator Autonomous - Logistics. Combines master data management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/generator-autonomous-logistics-57c31c4f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Generator Autonomous - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Generator Autonomous - Logistics. Combines master data management with adaptive intelligence for optimal results.
          </p>
