...
export const metadata: Metadata = {
  title: 'Cognitive optimization-construction',
  description: 'Revolutionize construction through intelligent automation. Our Cognitive optimization-construction leverages advanced machine learning to deliver campaign optim',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-optimization-construction-b005ce0d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive optimization-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Cognitive optimization-construction leverages advanced machine learning to deliver campaign optimization at scale.
          </p>
