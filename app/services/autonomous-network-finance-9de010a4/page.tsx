...
export const metadata: Metadata = {
  title: 'Autonomous Network Finance',
  description: 'The future of manufacturing is here with Autonomous Network Finance. Powered by cutting-edge AI, this platform delivers transformative results like never before',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-network-finance-9de010a4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Network Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of manufacturing is here with Autonomous Network Finance. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
