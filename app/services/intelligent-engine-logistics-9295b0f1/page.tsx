...
export const metadata: Metadata = {
  title: 'Intelligent engine-logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Intelligent engine-logistics leverages advanced machine learning to deliver enterprise-grade insight',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-engine-logistics-9295b0f1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent engine-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Intelligent engine-logistics leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
