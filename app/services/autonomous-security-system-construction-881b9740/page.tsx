...
export const metadata: Metadata = {
  title: 'Autonomous Security System - Construction',
  description: 'Enhance your construction business with Autonomous Security System - Construction. Our solution provides disaster recovery with enterprise-grade reliability and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-security-system-construction-881b9740',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Security System - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Autonomous Security System - Construction. Our solution provides disaster recovery with enterprise-grade reliability and security.
          </p>
