...
export const metadata: Metadata = {
  title: 'Autonomous Generator System - Enterprise',
  description: 'Transform enterprise with Autonomous Generator System - Enterprise - the intelligent automation platform that learns, adapts, and delivers 10x results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-generator-system-enterprise-3748b104',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Generator System - Enterprise
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform enterprise with Autonomous Generator System - Enterprise - the intelligent automation platform that learns, adapts, and delivers 10x results.
          </p>
