...
export const metadata: Metadata = {
  title: 'Recruiting AI-Powered Cloud Migration',
  description: 'AI-powered recruiting solution for cloud migration. Intelligent cloud migration planning and execution.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/recruiting-ai-powered-cloud-migration-bdd2a1c1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Recruiting AI-Powered Cloud Migration
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered recruiting solution for cloud migration. Intelligent cloud migration planning and execution.
          </p>
