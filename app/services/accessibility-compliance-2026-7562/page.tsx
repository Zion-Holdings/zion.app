...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={@context: "https://schema.org", @type: "Service", name: "Accessibility Compliance | Zion Tech Group", description: "End-to-end accessibility compliance services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/accessibility-compliance-2026-7562/"} />
