...
export const metadata: Metadata = {
  title: 'Cognitive Marketing Solution - Agriculture',
  description: 'Drive innovation in agriculture with Cognitive Marketing Solution - Agriculture. This AI-powered platform transforms customer retention into a competitive advan',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Marketing Solution - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in agriculture with Cognitive Marketing Solution - Agriculture. This AI-powered platform transforms customer retention into a competitive advantage.
          </p>
