...
export const metadata: Metadata = {
  title: 'Next-Gen Data Science - Agriculture',
  description: 'Future-proof your agriculture with Next-Gen Data Science - Agriculture. Our autonomous solution handles customer insights end-to-end without human intervention.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-data-science-agriculture-b81a2a5c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Data Science - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your agriculture with Next-Gen Data Science - Agriculture. Our autonomous solution handles customer insights end-to-end without human intervention.
          </p>
