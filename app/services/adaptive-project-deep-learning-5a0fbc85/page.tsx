...
export const metadata: Metadata = {
  title: 'Adaptive Project Deep Learning',
  description: 'The future of manufacturing is here with Adaptive Project Deep Learning. Powered by cutting-edge AI, this platform delivers container orchestration like never b',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Project Deep Learning
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of manufacturing is here with Adaptive Project Deep Learning. Powered by cutting-edge AI, this platform delivers container orchestration like never before.
          </p>
