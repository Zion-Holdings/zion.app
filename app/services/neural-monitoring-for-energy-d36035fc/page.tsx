...
export const metadata: Metadata = {
  title: 'Neural Monitoring for Energy',
  description: 'Drive innovation in energy with Neural Monitoring for Energy. This AI-powered platform transforms healthcare data analytics into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-monitoring-for-energy-d36035fc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Monitoring for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Neural Monitoring for Energy. This AI-powered platform transforms healthcare data analytics into a competitive advantage.
          </p>
