...
export const metadata: Metadata = {
  ...
  description: 'Enhance your healthcare business with Adaptive smart-healthcare. Our solution provides cost reduction with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-smart-healthcare-cbf3754b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with Adaptive smart-healthcare. Our solution provides cost reduction with enterprise-grade reliability and security.
          </p>
