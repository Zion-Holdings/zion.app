...
export const metadata: Metadata = {
  ...
  description: 'Next-generation construction solution: AI Process Mining - Construction Edition #1. Combines resource optimization with adaptive intelligence for optimal result',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: AI Process Mining - Construction Edition #1. Combines resource optimization with adaptive intelligence for optimal results.
          </p>
