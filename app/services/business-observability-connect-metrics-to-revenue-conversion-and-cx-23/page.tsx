...
export const metadata = {
  ...
  description: 'End-to-end business observability: connect metrics to revenue, conversion, and cx services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/business-observability-connect-metrics-to-revenue-conversion-and-cx-23/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">Business Observability: Connect Metrics to Revenue, Conversion, and CX</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end business observability: connect metrics to revenue, conversion, and cx services: assessment, deployment, and managed operations.
        </p>
