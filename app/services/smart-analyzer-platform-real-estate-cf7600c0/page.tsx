...
export const metadata: Metadata = {
  title: 'Smart Analyzer Platform - Real-Estate',
  description: 'The future of real-estate is here with Smart Analyzer Platform - Real-Estate. Powered by cutting-edge AI, this platform delivers campaign optimization like neve',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-analyzer-platform-real-estate-cf7600c0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Analyzer Platform - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of real-estate is here with Smart Analyzer Platform - Real-Estate. Powered by cutting-edge AI, this platform delivers campaign optimization like never before.
          </p>
