...
export const metadata: Metadata = {
  title: 'Next-Gen Operational for Logistics',
  description: 'Optimize your logistics workflows with Next-Gen Operational for Logistics. This intelligent platform delivers project management through advanced automation and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-operational-for-logistics-754099de',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Operational for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your logistics workflows with Next-Gen Operational for Logistics. This intelligent platform delivers project management through advanced automation and AI.
          </p>
