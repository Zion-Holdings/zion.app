...
export const metadata: Metadata = {
  title: 'Smart Automated - Hospitality',
  description: 'Optimize your hospitality workflows with Smart Automated - Hospitality. This intelligent platform delivers disaster recovery through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-automated-hospitality-80e14981',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Automated - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Smart Automated - Hospitality. This intelligent platform delivers disaster recovery through advanced automation and AI.
          </p>
