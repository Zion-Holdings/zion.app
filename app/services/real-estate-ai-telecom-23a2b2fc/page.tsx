...
export const metadata: Metadata = {
  title: 'Real Estate AI - Telecom',
  description: 'The future of telecom is here with Real Estate AI - Telecom. Powered by cutting-edge AI, this platform delivers transformative results like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/real-estate-ai-telecom-23a2b2fc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Real Estate AI - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of telecom is here with Real Estate AI - Telecom. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
