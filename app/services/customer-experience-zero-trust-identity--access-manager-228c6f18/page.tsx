...
export const metadata: Metadata = {
  title: 'Customer Experience Zero-Trust Identity & Access Manager',
  description: 'customer experience solution for cosmetics industry. Implements zero-trust security architecture with continuous authentication and adaptive access controls.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/customer-experience-zero-trust-identity--access-manager-228c6f18',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Customer Experience Zero-Trust Identity & Access Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            customer experience solution for cosmetics industry. Implements zero-trust security architecture with continuous authentication and adaptive access controls.
          </p>
