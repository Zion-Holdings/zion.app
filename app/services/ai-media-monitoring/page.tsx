...
export const metadata: Metadata = {
  ...
  keywords: '100K+ sources monitored, Multilingual sentiment, Trending topic detection, Custom keyword & competitor alerts, ai, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Media &amp; News Monitoring</h1>
        <p className="text-lg text-slate-300 mb-8">Tracks global news, podcasts, and video transcripts for brand mentions, sentiment shifts, and crisis signals in real time.</p>
        ...
        <li class="text-slate-300">100K+ sources monitored</li>
        <li class="text-slate-300">Multilingual sentiment</li>
        <li class="text-slate-300">Trending topic detection</li>
        <li class="text-slate-300">Custom keyword &amp; competitor alerts</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai media &amp; news monitoring</li>
