      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Tracks global news, podcasts, and video transcripts for brand mentions, sentiment shifts, and crisis signals in real time.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ 100K+ sources monitored</li>
            <li className="text-purple-300">✓ Multilingual sentiment</li>
            <li className="text-purple-300">✓ Trending topic detection</li>
            <li className="text-purple-300">✓ Custom keyword & competitor alerts</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai media & news monitoring</li>
