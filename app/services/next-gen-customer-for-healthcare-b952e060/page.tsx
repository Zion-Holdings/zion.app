...
export const metadata: Metadata = {
  title: 'Next-Gen Customer for Healthcare',
  description: 'Next-generation healthcare solution: Next-Gen Customer for Healthcare. Combines image recognition with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-customer-for-healthcare-b952e060',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Customer for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Next-Gen Customer for Healthcare. Combines image recognition with adaptive intelligence for optimal results.
          </p>
