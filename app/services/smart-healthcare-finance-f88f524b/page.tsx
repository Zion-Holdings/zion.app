...
export const metadata: Metadata = {
  title: 'Smart healthcare-finance',
  description: 'Next-generation finance solution: Smart healthcare-finance. Combines workflow management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-healthcare-finance-f88f524b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart healthcare-finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation finance solution: Smart healthcare-finance. Combines workflow management with adaptive intelligence for optimal results.
          </p>
