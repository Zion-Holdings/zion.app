...
export const metadata: Metadata = {
  title: 'Employee Autonomous - REGTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Employee Autonomous - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your regtech workflows with Employee Autonomous - REGTECH. This intelligent platform delivers demand planning through advanced automation and AI.
          </p>
