...
export const metadata: Metadata = {
  title: 'Automated Threat DevOps',
  description: 'Transform your logistics operations with our Automated Threat DevOps. This AI-driven solution automates customer insights with unprecedented accuracy and effici',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-threat-devops-8c13614f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Threat DevOps
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Automated Threat DevOps. This AI-driven solution automates customer insights with unprecedented accuracy and efficiency.
          </p>
