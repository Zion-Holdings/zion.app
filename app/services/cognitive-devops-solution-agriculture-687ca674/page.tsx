...
export const metadata: Metadata = {
  title: 'Cognitive DevOps Solution - Agriculture',
  description: 'Drive innovation in agriculture with Cognitive DevOps Solution - Agriculture. This AI-powered platform transforms manufacturing quality control into a competiti',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive DevOps Solution - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in agriculture with Cognitive DevOps Solution - Agriculture. This AI-powered platform transforms manufacturing quality control into a competitive advantage.
          </p>
