...
export const metadata: Metadata = {
  title: 'Cognitive Marketing Solution - Construction',
  description: 'The future of construction is here with Cognitive Marketing Solution - Construction. Powered by cutting-edge AI, this platform delivers net promoter score like ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-marketing-solution-construction-109fe59e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Marketing Solution - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Cognitive Marketing Solution - Construction. Powered by cutting-edge AI, this platform delivers net promoter score like never before.
          </p>
