...
export const metadata: Metadata = {
  ...
  keywords: 'Ingestion: 1 million+ events/second per cluster with exactly-once guarantees, Down-sampling + retention policy: raw for 7 d, 1-minute roll-ups for 90 d, hourly for 3 y, SQL query engine + Python SDK for time-series queries in one familiar language, Alert rules: threshold, rate-of-change, compound condition — Slack, PagerDuty, Email, Webhook, Grafana + PostgreSQL wire-protocol: connect existing dashboards in 2 minutes, data, E-Commerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Real-Time Time-Series Analytics Platform</h1>
        <p className="text-lg text-slate-300 mb-8">High-throughput real-time analytics for IoT, monitoring, and business metrics: stores, aggregates, and queries billions of events per day at &lt;200ms p99 latency. Includes alert rules, anomaly detection, SQL + Python query engine, dashboards, and Grafana/PostgreSQL-compatible endpoints.</p>
        ...
        <li class="text-slate-300">Ingestion: 1 million+ events/second per cluster with exactly-once guarantees</li>
        <li class="text-slate-300">Down-sampling + retention policy: raw for 7 d, 1-minute roll-ups for 90 d, hourly for 3 y</li>
        <li class="text-slate-300">SQL query engine + Python SDK for time-series queries in one familiar language</li>
        <li class="text-slate-300">Alert rules: threshold, rate-of-change, compound condition — Slack, PagerDuty, Email, Webhook</li>
        <li class="text-slate-300">Grafana + PostgreSQL wire-protocol: connect existing dashboards in 2 minutes</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with real-time time-series analytics platform</li>
