...
export const metadata: Metadata = {
  title: 'DevOps Cognitive - Tech',
  description: 'Transform your technology operations with our DevOps Cognitive - Tech. This AI-driven solution automates financial risk management with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/devops-cognitive---tech-3d5d5967',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            DevOps Cognitive - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your technology operations with our DevOps Cognitive - Tech. This AI-driven solution automates financial risk management with unprecedented accuracy and efficiency.
          </p>
