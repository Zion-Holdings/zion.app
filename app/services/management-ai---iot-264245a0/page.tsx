...
export const metadata: Metadata = {
  title: 'Management AI - Iot',
  description: 'Transform your iot operations with our Management AI - Iot. This AI-driven solution automates customer insights with unprecedented accuracy and efficiency.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/management-ai---iot-264245a0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your iot operations with our Management AI - Iot. This AI-driven solution automates customer insights with unprecedented accuracy and efficiency.
          </p>
