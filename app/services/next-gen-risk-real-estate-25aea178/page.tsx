...
export const metadata: Metadata = {
  title: 'Next-Gen Risk - Real-Estate',
  description: 'Transform your real-estate operations with our Next-Gen Risk - Real-Estate. This AI-driven solution automates data processing with unprecedented accuracy and ef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-risk-real-estate-25aea178',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Risk - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Next-Gen Risk - Real-Estate. This AI-driven solution automates data processing with unprecedented accuracy and efficiency.
          </p>
