...
export const metadata: Metadata = {
  title: 'Digital Experience AI-Powered SEO Content Engine',
  description: 'digital experience solution for zoological parks industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing c',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/digital-experience-ai-powered-seo-content-engine-217cda65',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Digital Experience AI-Powered SEO Content Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            digital experience solution for zoological parks industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing copy.
          </p>
