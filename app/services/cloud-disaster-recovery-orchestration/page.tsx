...
export const metadata: Metadata = {
  ...
  keywords: 'Asynchronous cross-region replication — zero-downtime writes at primary region, Warm-standby spin-up from snapshot in 30 seconds with no manual scripts, Failover runbook executor: 47-step runbook with per-step human halt available, DR test runner schedules quarterly drills and auto-reports pass or fail to management, cloud, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Disaster Recovery Orchestration</h1>
        <p className="text-lg text-slate-300 mb-8">Zero-downtime DR orchestration across regions: continuous async replication, warm-standby spin-up automation in 30 seconds, failover runbook executor with per-step human-halt, DR test runner, and RPO and RTO dashboard with graded SLA.</p>
        ...
        <li class="text-slate-300">Asynchronous cross-region replication — zero-downtime writes at primary region</li>
        <li class="text-slate-300">Warm-standby spin-up from snapshot in 30 seconds with no manual scripts</li>
        <li class="text-slate-300">Failover runbook executor: 47-step runbook with per-step human halt available</li>
        <li class="text-slate-300">DR test runner schedules quarterly drills and auto-reports pass or fail to management</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with disaster recovery orchestration</li>
