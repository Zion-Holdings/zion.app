...
export const metadata: Metadata = {
  title: 'Legal AI-Powered Predictive Analytics Platform',
  description: 'AI-powered legal solution leveraging advanced machine learning for optimal performance and ROI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/legal-ai-powered-predictive-analytics-platform-cbf579cc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Legal AI-Powered Predictive Analytics Platform
          </h1>
