...
export const metadata: Metadata = {
  title: 'Enterprise Manager Platform - Sports',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Manager Platform - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for sports: Enterprise Manager Platform - Sports. Uses quantum-inspired algorithms to deliver payroll processing at exponential speed.
          </p>
