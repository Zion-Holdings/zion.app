...
export const metadata: Metadata = {
  title: 'Smart Maintenance Suite - Logistics',
  description: 'Future-proof your logistics with Smart Maintenance Suite - Logistics. Our autonomous solution handles net promoter score end-to-end without human intervention.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-maintenance-suite-logistics-469ca07c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Maintenance Suite - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your logistics with Smart Maintenance Suite - Logistics. Our autonomous solution handles net promoter score end-to-end without human intervention.
          </p>
