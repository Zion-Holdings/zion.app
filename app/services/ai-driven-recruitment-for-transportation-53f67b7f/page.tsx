...
export const metadata: Metadata = {
  title: 'AI-Driven Recruitment for Transportation',
  description: 'Future-proof your transportation with AI-Driven Recruitment for Transportation. Our autonomous solution handles data pipeline orchestration end-to-end without h',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Driven Recruitment for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your transportation with AI-Driven Recruitment for Transportation. Our autonomous solution handles data pipeline orchestration end-to-end without human intervention.
          </p>
