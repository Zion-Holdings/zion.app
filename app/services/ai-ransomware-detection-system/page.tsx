...
export const metadata: Metadata = {
  ...
  keywords: 'Behavioral encryption detection, Auto-isolation of infected endpoints, Ransom note analysis & decryption keys, Forensic timeline reconstruction, Integration with SIEM/SOAR, 24/7 SOC monitoring included, security, Financial Services, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Ransomware Detection &amp; Response Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Real-time ransomware detection across endpoints, network, and cloud. AI identifies encryption behavior patterns, auto-isolates infected systems, and triggers incident response playbooks. Stops ransomware in under 30 seconds.</p>
        ...
        <li class="text-slate-300">Behavioral encryption detection</li>
        <li class="text-slate-300">Auto-isolation of infected endpoints</li>
        <li class="text-slate-300">Ransom note analysis &amp; decryption keys</li>
        <li class="text-slate-300">Forensic timeline reconstruction</li>
        <li class="text-slate-300">Integration with SIEM/SOAR</li>
        <li class="text-slate-300">24/7 SOC monitoring included</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Detect ransomware in 30 seconds</li>
        <li class="text-slate-300">Auto-isolate before spread</li>
        <li class="text-slate-300">Reduce breach cost by 80%</li>
      </ul>
        </div>
