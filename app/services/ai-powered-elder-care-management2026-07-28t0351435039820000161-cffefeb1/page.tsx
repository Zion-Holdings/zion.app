...
export const metadata: Metadata = {
  title: 'AI-Powered Elder Care Management',
  description: 'AI-powered elder care with monitoring and health tracking.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-elder-care-management2026-07-28t0351435039820000161-cffefeb1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Elder Care Management
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered elder care with monitoring and health tracking.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Alert systems</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">50% better care</li>
