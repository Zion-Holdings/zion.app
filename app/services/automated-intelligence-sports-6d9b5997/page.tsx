...
export const metadata: Metadata = {
  title: 'Automated intelligence-sports',
  description: 'Revolutionize sports through intelligent automation. Our Automated intelligence-sports leverages advanced machine learning to deliver cost reduction at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-intelligence-sports-6d9b5997',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated intelligence-sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Automated intelligence-sports leverages advanced machine learning to deliver cost reduction at scale.
          </p>
