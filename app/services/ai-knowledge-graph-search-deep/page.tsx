...
export const metadata: Metadata = {
  ...
  keywords: 'Auto-ingest: Confluence, Slack, Drive, Jira, Notion, SharePoint, Auto-built navigable knowledge graph with entity recognition, Faceted navigation + path finder (A→B shortest path through relations), Answer synthesis with inline citations + source confidence scores, On-prem AIR-gapped deployment option for public-sector / PHI, ai, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Knowledge Graph Search Engine</h1>
        <p className="text-lg text-slate-300 mb-8">Deep semantic search across structured + unstructured corporate knowledge: auto-builds a navigable knowledge graph from Confluence, Slack, Drive, Jira, and CRM; facet navigation, path-finding between related entities, and answer synthesis with cited sources.</p>
        ...
        <li class="text-slate-300">Auto-ingest: Confluence, Slack, Drive, Jira, Notion, SharePoint</li>
        <li class="text-slate-300">Auto-built navigable knowledge graph with entity recognition</li>
        <li class="text-slate-300">Faceted navigation + path finder (A→B shortest path through relations)</li>
        <li class="text-slate-300">Answer synthesis with inline citations + source confidence scores</li>
        <li class="text-slate-300">On-prem AIR-gapped deployment option for public-sector / PHI</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai knowledge graph search engine</li>
