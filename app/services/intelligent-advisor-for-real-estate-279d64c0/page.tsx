...
export const metadata: Metadata = {
  title: 'Intelligent Advisor for Real-Estate',
  description: 'Enhance your real-estate business with Intelligent Advisor for Real-Estate. Our solution provides employee engagement with enterprise-grade reliability and secu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-advisor-for-real-estate-279d64c0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Advisor for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your real-estate business with Intelligent Advisor for Real-Estate. Our solution provides employee engagement with enterprise-grade reliability and security.
          </p>
