...
export const metadata: Metadata = {
  title: 'Smart Code Insights',
  description: 'Revolutionize blockchain through intelligent automation. Our Smart Code Insights leverages advanced machine learning to deliver maintenance scheduling at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-code-insights-20bac6e6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize blockchain through intelligent automation. Our Smart Code Insights leverages advanced machine learning to deliver maintenance scheduling at scale.
          </p>
