...
export const metadata: Metadata = {
  ...
  description: 'Manages entire fleet operations with maintenance scheduling, driver behavior analysis, and route optimization for cost efficiency.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-fleet-management-platform2026-07-28t0659148259580000-57e17cca',
  },
  ...
  return (
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Manages entire fleet operations with maintenance scheduling, driver behavior analysis, and route optimization for cost efficiency.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Driver analysis</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">20% fuel savings</li>
    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Manages entire fleet operations with maintenance scheduling, driver behavior analysis, and route optimization for cost efficiency.</p>
