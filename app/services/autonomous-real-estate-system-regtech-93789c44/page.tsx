...
export const metadata: Metadata = {
  title: 'Autonomous Real Estate System - REGTECH',
  description: 'Optimize your regtech workflows with Autonomous Real Estate System - REGTECH. This intelligent platform delivers financial risk management through advanced auto',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Real Estate System - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your regtech workflows with Autonomous Real Estate System - REGTECH. This intelligent platform delivers financial risk management through advanced automation and AI.
          </p>
