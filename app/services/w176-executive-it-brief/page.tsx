...
export const metadata: Metadata = {
  ...
  keywords: 'Monthly IT health scorecard, Security posture summary (non-technical), Cloud cost trends and forecasting, Strategic recommendation roadmap, Risk register and mitigation status, Board-ready presentation format, Quarterly deep-dive workshops, it, Executive, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Executive IT Briefing Service</h1>
        <p className="text-lg text-slate-300 mb-8">Monthly executive briefings on IT health, security posture, cost trends, and strategic recommendations. Board-ready reports without the technical jargon.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">it</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">Executive</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Monthly IT health scorecard</li>
        <li class="text-slate-300">Security posture summary (non-technical)</li>
        <li class="text-slate-300">Cloud cost trends and forecasting</li>
        <li class="text-slate-300">Strategic recommendation roadmap</li>
        <li class="text-slate-300">Risk register and mitigation status</li>
        <li class="text-slate-300">Board-ready presentation format</li>
        <li class="text-slate-300">Quarterly deep-dive workshops</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">IT insights in business language</li>
        <li class="text-slate-300">Board-ready without technical translation</li>
        <li class="text-slate-300">Proactive recommendations, not just status</li>
        <li class="text-slate-300">Trends reveal direction, not just snapshots</li>
      </ul>
        </div>
