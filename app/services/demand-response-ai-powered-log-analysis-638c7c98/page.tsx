...
export const metadata: Metadata = {
  title: 'Demand Response AI-Powered Log Analysis',
  description: 'AI-powered demand response solution for devops. Automated log analysis for incident detection and root cause analysis.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/demand-response-ai-powered-log-analysis-638c7c98',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Demand Response AI-Powered Log Analysis
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered demand response solution for devops. Automated log analysis for incident detection and root cause analysis.
          </p>
