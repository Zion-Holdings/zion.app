...
export const metadata: Metadata = {
  title: 'Intelligent Analytics for Agriculture',
  description: 'Transform your agriculture operations with our Intelligent Analytics for Agriculture. This AI-driven solution automates employee engagement with unprecedented a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Analytics for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Intelligent Analytics for Agriculture. This AI-driven solution automates employee engagement with unprecedented accuracy and efficiency.
          </p>
