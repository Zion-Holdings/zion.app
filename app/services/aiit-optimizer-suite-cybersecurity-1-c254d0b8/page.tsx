...
export const metadata: Metadata = {
  title: 'AI/IT Optimizer Suite - Cybersecurity #1',
  description: 'Transform your cybersecurity operations with our AI/IT Optimizer Suite - Cybersecurity #1. This AI-driven solution automates learning management with unpreceden',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Optimizer Suite - Cybersecurity #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your cybersecurity operations with our AI/IT Optimizer Suite - Cybersecurity #1. This AI-driven solution automates learning management with unprecedented accuracy and efficiency.
          </p>
