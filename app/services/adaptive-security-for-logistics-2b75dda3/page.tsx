...
export const metadata: Metadata = {
  title: 'Adaptive Security for Logistics',
  description: 'Next-generation logistics solution: Adaptive Security for Logistics. Combines workflow management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-security-for-logistics-2b75dda3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Security for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Adaptive Security for Logistics. Combines workflow management with adaptive intelligence for optimal results.
          </p>
