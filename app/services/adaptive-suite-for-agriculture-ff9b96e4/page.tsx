...
export const metadata: Metadata = {
  title: 'Adaptive Suite for Agriculture',
  description: 'The future of agriculture is here with Adaptive Suite for Agriculture. Powered by cutting-edge AI, this platform delivers risk assessment like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-suite-for-agriculture-ff9b96e4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Suite for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Adaptive Suite for Agriculture. Powered by cutting-edge AI, this platform delivers risk assessment like never before.
          </p>
