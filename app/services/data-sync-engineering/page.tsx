...
export const metadata: Metadata = {
  ...
  keywords: 'CDC from 10+ databases, Schema evolution handled, Exactly-once delivery, Conflict resolution config, Backfill historical data, data, E-Commerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Data Sync &amp; Change Capture</h1>
        <p className="text-lg text-slate-300 mb-8">Change data capture (CDC) sync engine that replicates real-time changes from Postgres, MySQL, MongoDB, and Snowflake to any destination with schema evolution.</p>
        ...
        <li class="text-slate-300">CDC from 10+ databases</li>
        <li class="text-slate-300">Schema evolution handled</li>
        <li class="text-slate-300">Exactly-once delivery</li>
        <li class="text-slate-300">Conflict resolution config</li>
        <li class="text-slate-300">Backfill historical data</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with data sync &amp; change capture</li>
