...
export const metadata: Metadata = {
  title: 'Cognitive Quality Solution - Transportation #1',
  description: 'Optimize your transportation workflows with Cognitive Quality Solution - Transportation #1. This intelligent platform delivers resource allocation through advan',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Quality Solution - Transportation #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Cognitive Quality Solution - Transportation #1. This intelligent platform delivers resource allocation through advanced automation and AI.
          </p>
