...
export const metadata: Metadata = {
  title: 'Cognitive Campaign Finance',
  description: 'Drive innovation in gaming with Cognitive Campaign Finance. This AI-powered platform transforms feedback collection into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-campaign-finance-29eaabde',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Campaign Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in gaming with Cognitive Campaign Finance. This AI-powered platform transforms feedback collection into a competitive advantage.
          </p>
