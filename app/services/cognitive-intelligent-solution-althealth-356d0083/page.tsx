...
export const metadata: Metadata = {
  title: 'Cognitive Intelligent Solution - ALTHEALTH',
  description: 'Transform your althealth operations with our Cognitive Intelligent Solution - ALTHEALTH. This AI-driven solution automates esg reporting with unprecedented accu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Intelligent Solution - ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your althealth operations with our Cognitive Intelligent Solution - ALTHEALTH. This AI-driven solution automates esg reporting with unprecedented accuracy and efficiency.
          </p>
