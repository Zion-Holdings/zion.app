...
export const metadata: Metadata = {
  title: 'AI/IT Strategic Suite - FINTECH',
  description: 'Quantum leap forward for fintech: AI/IT Strategic Suite - FINTECH. Uses quantum-inspired algorithms to deliver lead scoring at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-strategic-suite-fintech-d8c6b9f7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Strategic Suite - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for fintech: AI/IT Strategic Suite - FINTECH. Uses quantum-inspired algorithms to deliver lead scoring at exponential speed.
          </p>
