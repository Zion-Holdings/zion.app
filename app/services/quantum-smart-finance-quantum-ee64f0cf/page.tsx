...
export const metadata: Metadata = {
  title: 'Quantum Smart - Finance Quantum',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Smart - Finance Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation finance solution: Quantum Smart - Finance Quantum. Combines time tracking with adaptive intelligence for optimal results.
          </p>
