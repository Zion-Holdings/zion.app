...
export const metadata: Metadata = {
  title: 'Autonomous Management System - Agriculture',
  description: 'Unlock unprecedented growth with Autonomous Management System - Agriculture. This autonomous system provides edge computing with zero manual intervention needed',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-management-system-agriculture-adfa06e3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Management System - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Autonomous Management System - Agriculture. This autonomous system provides edge computing with zero manual intervention needed.
          </p>
