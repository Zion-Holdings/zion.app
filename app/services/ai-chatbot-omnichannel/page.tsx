...
export const metadata: Metadata = {
  ...
  keywords: 'Multichannel conversation orchestration, Context memory across channels, Fallback to live agents with full context, Built-in analytics & conversation flows, CRM & helpdesk integration, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Omnichannel Chatbot</h1>
        <p className="text-lg text-slate-300 mb-8">Unified AI assistant across website chat, Messenger, WhatsApp, SMS, and voice. Context-aware conversations with seamless human handoff.</p>
        ...
        <li class="text-slate-300">Multichannel conversation orchestration</li>
        <li class="text-slate-300">Context memory across channels</li>
        <li class="text-slate-300">Fallback to live agents with full context</li>
        <li class="text-slate-300">Built-in analytics &amp; conversation flows</li>
        <li class="text-slate-300">CRM &amp; helpdesk integration</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai omnichannel chatbot</li>
