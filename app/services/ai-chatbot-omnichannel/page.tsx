      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Unified AI assistant across website chat, Messenger, WhatsApp, SMS, and voice. Context-aware conversations with seamless human handoff.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Multichannel conversation orchestration</li>
            <li className="text-purple-300">✓ Context memory across channels</li>
            <li className="text-purple-300">✓ Fallback to live agents with full context</li>
            <li className="text-purple-300">✓ Built-in analytics & conversation flows</li>
            <li className="text-purple-300">✓ CRM & helpdesk integration</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai omnichannel chatbot</li>
