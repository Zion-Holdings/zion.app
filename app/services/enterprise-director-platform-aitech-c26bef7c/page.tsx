...
export const metadata: Metadata = {
  title: 'Enterprise Director Platform - AITECH',
  description: 'Quantum leap forward for aitech: Enterprise Director Platform - AITECH. Uses quantum-inspired algorithms to deliver conversational ai at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-director-platform-aitech-c26bef7c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Director Platform - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for aitech: Enterprise Director Platform - AITECH. Uses quantum-inspired algorithms to deliver conversational ai at exponential speed.
          </p>
