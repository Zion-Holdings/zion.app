...
export const metadata: Metadata = {
  title: 'Intelligent NLP for Sports',
  description: 'The future of sports is here with Intelligent NLP for Sports. Powered by cutting-edge AI, this platform delivers master data management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-nlp-for-sports-e1873a6a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent NLP for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Intelligent NLP for Sports. Powered by cutting-edge AI, this platform delivers master data management like never before.
          </p>
