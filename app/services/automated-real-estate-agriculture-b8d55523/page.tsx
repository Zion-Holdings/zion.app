...
export const metadata: Metadata = {
  title: 'Automated real estate-agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Automated real estate-agriculture leverages advanced machine learning to deliver resource optimiza',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-real-estate-agriculture-b8d55523',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated real estate-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Automated real estate-agriculture leverages advanced machine learning to deliver resource optimization at scale.
          </p>
