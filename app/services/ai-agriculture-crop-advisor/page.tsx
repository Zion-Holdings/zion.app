...
export const metadata: Metadata = {
  ...
  keywords: 'Crop health imaging (drone + satellite), Pest & disease early detection, Irrigation optimization, Yield prediction models, Soil nutrient mapping, Weather impact forecasting, ai, Agriculture, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Crop Diagnostic &amp; Yield Optimizer</h1>
        <p className="text-lg text-slate-300 mb-8">Precision agriculture: drone/satellite crop health imaging, pest detection, irrigation optimization, yield prediction. Field-level recommendations in real-time.</p>
        ...
        <li class="text-slate-300">Crop health imaging (drone + satellite)</li>
        <li class="text-slate-300">Pest &amp; disease early detection</li>
        <li class="text-slate-300">Irrigation optimization</li>
        <li class="text-slate-300">Yield prediction models</li>
        <li class="text-slate-300">Soil nutrient mapping</li>
        <li class="text-slate-300">Weather impact forecasting</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Increase yields by 20%</li>
        <li class="text-slate-300">Reduce water use by 30%</li>
        <li class="text-slate-300">Cut pesticide costs by 40%</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">49/acre</p>
              <p class="text-sm text-slate-400">Getting started plan</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              <h3 class="font-semibold text-white mb-2">Pro</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">99/acre</p>
              <p class="text-sm text-slate-400">Most popular</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              <h3 class="font-semibold text-white mb-2">Enterprise</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">249/acre</p>
