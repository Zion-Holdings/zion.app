...
export const metadata: Metadata = {
  title: 'AI Adaptive - Legal',
  description: 'Next-generation legal solution: AI Adaptive - Legal. Combines forecast accuracy with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-adaptive-legal-ab92b709',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: AI Adaptive - Legal. Combines forecast accuracy with adaptive intelligence for optimal results.
          </p>
