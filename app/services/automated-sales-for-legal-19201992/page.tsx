...
export const metadata: Metadata = {
  title: 'Automated Sales for Legal',
  description: 'Drive innovation in legal with Automated Sales for Legal. This AI-powered platform transforms feedback collection into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-sales-for-legal-19201992',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Sales for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Automated Sales for Legal. This AI-powered platform transforms feedback collection into a competitive advantage.
          </p>
