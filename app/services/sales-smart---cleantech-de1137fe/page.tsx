...
export const metadata: Metadata = {
  title: 'Sales Smart - Cleantech',
  description: 'The future of cleantech is here with Sales Smart - Cleantech. Powered by cutting-edge AI, this platform delivers content generation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/sales-smart---cleantech-de1137fe',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Sales Smart - Cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of cleantech is here with Sales Smart - Cleantech. Powered by cutting-edge AI, this platform delivers content generation like never before.
          </p>
