...
export const metadata: Metadata = {
  title: 'Adaptive customer service-hospitality',
  description: 'Transform your hospitality operations with our Adaptive customer service-hospitality. This AI-driven solution automates compliance monitoring with unprecedented',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive customer service-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Adaptive customer service-hospitality. This AI-driven solution automates compliance monitoring with unprecedented accuracy and efficiency.
          </p>
