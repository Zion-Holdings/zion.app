...
export const metadata: Metadata = {
  title: 'Support Automated - Manufacturing',
  description: 'Drive innovation in manufacturing with Support Automated - Manufacturing. This AI-powered platform transforms customer retention into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/support-automated-manufacturing-3923cdf3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in manufacturing with Support Automated - Manufacturing. This AI-powered platform transforms customer retention into a competitive advantage.
          </p>
