...
export const metadata: Metadata = {
  title: 'Autonomous healthcare-education',
  description: 'Transform your education operations with our Autonomous healthcare-education. This AI-driven solution automates code optimization with unprecedented accuracy an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous healthcare-education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your education operations with our Autonomous healthcare-education. This AI-driven solution automates code optimization with unprecedented accuracy and efficiency.
          </p>
