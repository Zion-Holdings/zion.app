...
export const metadata: Metadata = {
  title: 'Intelligent System for Education',
  description: 'Drive innovation in education with Intelligent System for Education. This AI-powered platform transforms quality assurance into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-system-for-education-5f2fde23',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent System for Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in education with Intelligent System for Education. This AI-powered platform transforms quality assurance into a competitive advantage.
          </p>
