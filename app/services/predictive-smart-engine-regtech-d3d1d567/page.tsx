...
export const metadata: Metadata = {
  title: 'Predictive Smart Engine - REGTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Smart Engine - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in regtech with Predictive Smart Engine - REGTECH. This AI-powered platform transforms sourcing optimization into a competitive advantage.
          </p>
