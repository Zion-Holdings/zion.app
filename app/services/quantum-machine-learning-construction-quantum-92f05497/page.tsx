...
export const metadata: Metadata = {
  title: 'Quantum Machine Learning - Construction Quantum',
  description: 'Revolutionize construction through intelligent automation. Our Quantum Machine Learning - Construction Quantum leverages advanced machine learning to deliver bu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Machine Learning - Construction Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Quantum Machine Learning - Construction Quantum leverages advanced machine learning to deliver business continuity at scale.
          </p>
