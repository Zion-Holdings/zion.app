...
export const metadata: Metadata = {
  title: 'Smart Predictive for Sports',
  description: 'Drive innovation in sports with Smart Predictive for Sports. This AI-powered platform transforms inventory management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-predictive-for-sports-aafd9070',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Predictive for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in sports with Smart Predictive for Sports. This AI-powered platform transforms inventory management into a competitive advantage.
          </p>
