...
export const metadata: Metadata = {
  ...
  keywords: 'Demand forecasting, Renewable integration, Load balancing, Predictive maintenance, Outage prediction, Energy trading, Compliance, SCADA integration, ai, Energy, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Energy Grid Optimization</h1>
        <p className="text-lg text-slate-300 mb-8">Smart grid optimization with demand forecasting and renewable integration.</p>
        ...
        <li class="text-slate-300">Load balancing</li>
        <li class="text-slate-300">Predictive maintenance</li>
        <li class="text-slate-300">Outage prediction</li>
        <li class="text-slate-300">Energy trading</li>
        <li class="text-slate-300">Compliance</li>
        <li class="text-slate-300">SCADA integration</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">20% efficiency gain</li>
        <li class="text-slate-300">Renewable optimization</li>
        <li class="text-slate-300">Outage reduction</li>
        <li class="text-slate-300">Cost savings</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$20,000</p>
              <p class="text-sm text-slate-400">Getting started plan</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              <h3 class="font-semibold text-white mb-2">Pro</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">$6,000/mo</p>
