...
export const metadata: Metadata = {
  title: 'Cognitive Machine Learning Solution - CLEANTECH',
  description: 'Optimize your cleantech workflows with Cognitive Machine Learning Solution - CLEANTECH. This intelligent platform delivers conversational ai through advanced au',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Machine Learning Solution - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your cleantech workflows with Cognitive Machine Learning Solution - CLEANTECH. This intelligent platform delivers conversational ai through advanced automation and AI.
          </p>
