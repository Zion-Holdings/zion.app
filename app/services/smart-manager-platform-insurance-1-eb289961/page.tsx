...
export const metadata: Metadata = {
  title: 'Smart Manager Platform - Insurance #1',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manager Platform - Insurance #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Smart Manager Platform - Insurance #1. This AI-powered platform transforms security monitoring into a competitive advantage.
          </p>
