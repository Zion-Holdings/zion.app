...
export const metadata: Metadata = {
  title: 'Candidate Experience Multi-Cloud Cost Management Platform',
  description: 'candidate experience solution for professional associations industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GC',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/candidate-experience-multi-cloud-cost-management-platform-3dca8a87',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Candidate Experience Multi-Cloud Cost Management Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            candidate experience solution for professional associations industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.
          </p>
