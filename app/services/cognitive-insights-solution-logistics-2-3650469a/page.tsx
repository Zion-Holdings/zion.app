...
export const metadata: Metadata = {
  title: 'Cognitive Insights Solution - Logistics #2',
  description: 'Drive innovation in logistics with Cognitive Insights Solution - Logistics #2. This AI-powered platform transforms sourcing optimization into a competitive adva',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-insights-solution-logistics-2-3650469a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Insights Solution - Logistics #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with Cognitive Insights Solution - Logistics #2. This AI-powered platform transforms sourcing optimization into a competitive advantage.
          </p>
