  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">AI Project Risk Radar</h1>
        <p className="text-lg text-gray-300 mb-8">Predicts project delivery risk from schedule, dependency, staffing, and change signals with early mitigation routing.</p>
