...
export const metadata: Metadata = {
  title: 'Predictive Support for Healthcare',
  description: 'The future of healthcare is here with Predictive Support for Healthcare. Powered by cutting-edge AI, this platform delivers workflow management like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-support-for-healthcare-28980b47',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Support for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Predictive Support for Healthcare. Powered by cutting-edge AI, this platform delivers workflow management like never before.
          </p>
