...
export const metadata: Metadata = {
  title: 'Neural Healthcare for FINTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Healthcare for FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for fintech: Neural Healthcare for FINTECH. Uses quantum-inspired algorithms to deliver master data management at exponential speed.
          </p>
