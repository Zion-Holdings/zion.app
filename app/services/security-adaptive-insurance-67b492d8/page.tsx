...
export const metadata: Metadata = {
  title: 'Security Adaptive - Insurance',
  description: 'Enhance your insurance business with Security Adaptive - Insurance. Our solution provides territory management with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-adaptive-insurance-67b492d8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Adaptive - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Security Adaptive - Insurance. Our solution provides territory management with enterprise-grade reliability and security.
          </p>
