...
export const metadata: Metadata = {
  title: 'AI Orchestrator - Education Edition',
  description: 'Enhance your education business with AI Orchestrator - Education Edition. Our solution provides process discovery with enterprise-grade reliability and security',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-orchestrator-education-edition-8b9ece32',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Orchestrator - Education Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your education business with AI Orchestrator - Education Edition. Our solution provides process discovery with enterprise-grade reliability and security.
          </p>
