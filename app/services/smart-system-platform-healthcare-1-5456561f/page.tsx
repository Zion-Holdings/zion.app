...
export const metadata: Metadata = {
  title: 'Smart System Platform - Healthcare #1',
  description: 'Optimize your healthcare workflows with Smart System Platform - Healthcare #1. This intelligent platform delivers user provisioning through advanced automation ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart System Platform - Healthcare #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Smart System Platform - Healthcare #1. This intelligent platform delivers user provisioning through advanced automation and AI.
          </p>
