...
export const metadata: Metadata = {
  ...
  keywords: 'Automated discovery of servers, cloud resources, IoT devices, Configuration item (CI) relationship mapping, Change impact analysis, License compliance & inventory tracking, Integration with ITSM tools (ServiceNow, Jira), it, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Service Asset &amp; Configuration Management</h1>
        <p className="text-lg text-slate-300 mb-8">Complete IT asset discovery, configuration mapping, and dependency visualization for cloud and on-prem environments.</p>
        ...
        <li class="text-slate-300">Automated discovery of servers, cloud resources, IoT devices</li>
        <li class="text-slate-300">Configuration item (CI) relationship mapping</li>
        <li class="text-slate-300">Change impact analysis</li>
        <li class="text-slate-300">License compliance &amp; inventory tracking</li>
        <li class="text-slate-300">Integration with ITSM tools (ServiceNow, Jira)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with it service asset &amp; configuration management</li>
