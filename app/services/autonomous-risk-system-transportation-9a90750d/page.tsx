...
export const metadata: Metadata = {
  title: 'Autonomous Risk System - Transportation',
  description: 'Unlock unprecedented growth with Autonomous Risk System - Transportation. This autonomous system provides decision support with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-risk-system-transportation-9a90750d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Risk System - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Autonomous Risk System - Transportation. This autonomous system provides decision support with zero manual intervention needed.
          </p>
