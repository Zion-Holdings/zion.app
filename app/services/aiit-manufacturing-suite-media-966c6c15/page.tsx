...
export const metadata: Metadata = {
  title: 'AI/IT Manufacturing Suite - Media',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Manufacturing Suite - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for media: AI/IT Manufacturing Suite - Media. Uses quantum-inspired algorithms to deliver integration platform at exponential speed.
          </p>
