...
export const metadata: Metadata = {
  title: 'Enterprise Coordinator Platform - Construction',
  description: 'Drive innovation in construction with Enterprise Coordinator Platform - Construction. This AI-powered platform transforms reputation management into a competiti',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-coordinator-platform-construction-55ebebcd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Coordinator Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Enterprise Coordinator Platform - Construction. This AI-powered platform transforms reputation management into a competitive advantage.
          </p>
