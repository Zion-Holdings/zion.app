...
export const metadata: Metadata = {
  title: 'Smart Content Suite - Healthcare',
  description: 'Unlock unprecedented growth with Smart Content Suite - Healthcare. This autonomous system provides performance reviews with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-content-suite-healthcare-3e86bc61',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Content Suite - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Content Suite - Healthcare. This autonomous system provides performance reviews with zero manual intervention needed.
          </p>
