...
export const metadata: Metadata = {
  ...
  keywords: 'Cryptographic inventory and assessment, Quantum vulnerability scoring, NIST PQC algorithm migration, TLS and certificate modernization, Crypto-agility framework, Compliance reporting (CNSA 2.0), Hybrid certificate deployment, Zero-downtime migration, it, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Quantum-Safe Cryptography Migration</h1>
        <p className="text-lg text-slate-300 mb-8">Prepare your infrastructure for the post-quantum era. Cryptographic inventory, vulnerability assessment, and migration to NIST-approved quantum-resistant algorithms. Compliance with CNSA 2.0 timeline.</p>
        ...
        <li class="text-slate-300">Cryptographic inventory and assessment</li>
        <li class="text-slate-300">Quantum vulnerability scoring</li>
        <li class="text-slate-300">NIST PQC algorithm migration</li>
        <li class="text-slate-300">TLS and certificate modernization</li>
        <li class="text-slate-300">Crypto-agility framework</li>
        <li class="text-slate-300">Compliance reporting (CNSA 2.0)</li>
        <li class="text-slate-300">Hybrid certificate deployment</li>
        <li class="text-slate-300">Zero-downtime migration</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Future-proof against quantum attacks</li>
        <li class="text-slate-300">Meet CNSA 2.0 compliance deadlines</li>
        <li class="text-slate-300">Identify crypto vulnerabilities</li>
        <li class="text-slate-300">Seamless migration with no downtime</li>
      </ul>
        </div>
