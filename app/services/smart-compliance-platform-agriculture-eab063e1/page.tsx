...
export const metadata: Metadata = {
  title: 'Smart Compliance Platform - Agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Smart Compliance Platform - Agriculture leverages advanced machine learning to deliver data qualit',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Compliance Platform - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Smart Compliance Platform - Agriculture leverages advanced machine learning to deliver data quality at scale.
          </p>
