...
export const metadata: Metadata = {
  title: 'Speech Analytics AI-Powered Data Quality Manager',
  description: 'speech analytics solution for museums industry. Automatically detects, corrects, and prevents data quality issues using machine learning.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/speech-analytics-ai-powered-data-quality-manager-8a8909d2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Speech Analytics AI-Powered Data Quality Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            speech analytics solution for museums industry. Automatically detects, corrects, and prevents data quality issues using machine learning.
          </p>
