...
export const metadata: Metadata = {
  title: 'Quality Intelligent - Construction',
  description: 'Optimize your construction workflows with Quality Intelligent - Construction. This intelligent platform delivers influencer identification through advanced auto',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Quality Intelligent - Construction. This intelligent platform delivers influencer identification through advanced automation and AI.
          </p>
