...
export const metadata: Metadata = {
  title: 'Manufacturing Automated - HEALTHTECH',
  description: 'Drive innovation in healthtech with Manufacturing Automated - HEALTHTECH. This AI-powered platform transforms language processing into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/manufacturing-automated-healthtech-cef7ae50',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manufacturing Automated - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthtech with Manufacturing Automated - HEALTHTECH. This AI-powered platform transforms language processing into a competitive advantage.
          </p>
