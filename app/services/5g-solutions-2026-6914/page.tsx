...
export const metadata = {
  ...
  alternates: { canonical: '/services/5g-solutions-2026-6914/' },

  openGraph: {
    title: '5G Solutions | Zion Tech Group',
    description: 'End-to-end 5g solutions services: assessment, deployment, and managed operations.',
    url: 'https://ziontechgroup.com/services/5g-solutions-2026-6914/',
...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={@context: "https://schema.org", @type: "Service", name: "5G Solutions | Zion Tech Group", description: "End-to-end 5g solutions services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/5g-solutions-2026-6914/"} />
