...
export const metadata: Metadata = {
  title: 'Serverless expense-healthcare',
  description: 'Optimize your healthcare workflows with Serverless expense-healthcare. This intelligent platform delivers data quality through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/serverless-expense-healthcare-ca32949c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Serverless expense-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Serverless expense-healthcare. This intelligent platform delivers data quality through advanced automation and AI.
          </p>
