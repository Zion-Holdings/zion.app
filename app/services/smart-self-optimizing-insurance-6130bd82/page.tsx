...
export const metadata: Metadata = {
  title: 'Smart Self-Optimizing - Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Smart Self-Optimizing - Insurance leverages advanced machine learning to deliver process automation ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-self-optimizing-insurance-6130bd82',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Self-Optimizing - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Smart Self-Optimizing - Insurance leverages advanced machine learning to deliver process automation at scale.
          </p>
