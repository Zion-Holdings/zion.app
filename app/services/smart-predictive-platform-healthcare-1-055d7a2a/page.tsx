...
export const metadata: Metadata = {
  title: 'Smart Predictive Platform - Healthcare #1',
  description: 'Drive innovation in healthcare with Smart Predictive Platform - Healthcare #1. This AI-powered platform transforms quality assurance into a competitive advantag',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Predictive Platform - Healthcare #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with Smart Predictive Platform - Healthcare #1. This AI-powered platform transforms quality assurance into a competitive advantage.
          </p>
