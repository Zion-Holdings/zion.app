...
export const metadata: Metadata = {
  title: 'Predictive Document Engine - PROPTECH',
  description: 'Drive innovation in proptech with Predictive Document Engine - PROPTECH. This AI-powered platform transforms customer onboarding into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-document-engine-proptech-a17bea09',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Document Engine - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in proptech with Predictive Document Engine - PROPTECH. This AI-powered platform transforms customer onboarding into a competitive advantage.
          </p>
