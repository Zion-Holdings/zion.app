...
export const metadata: Metadata = {
  title: 'Engine Intelligent - Education',
  description: 'Drive innovation in education with Engine Intelligent - Education. This AI-powered platform transforms influencer identification into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/engine-intelligent-education-494d6443',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Engine Intelligent - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in education with Engine Intelligent - Education. This AI-powered platform transforms influencer identification into a competitive advantage.
          </p>
