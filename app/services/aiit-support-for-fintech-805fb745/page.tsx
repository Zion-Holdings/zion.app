...
export const metadata: Metadata = {
  title: 'AI/IT Support for FINTECH',
  description: 'Optimize your fintech workflows with AI/IT Support for FINTECH. This intelligent platform delivers predictive modeling through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-support-for-fintech-805fb745',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Support for FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your fintech workflows with AI/IT Support for FINTECH. This intelligent platform delivers predictive modeling through advanced automation and AI.
          </p>
