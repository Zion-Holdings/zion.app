...
export const metadata: Metadata = {
  title: 'Autonomous Experience System - Agriculture',
  description: 'The future of agriculture is here with Autonomous Experience System - Agriculture. Powered by cutting-edge AI, this platform delivers financial risk management ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-experience-system-agriculture-19984316',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Experience System - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Autonomous Experience System - Agriculture. Powered by cutting-edge AI, this platform delivers financial risk management like never before.
          </p>
