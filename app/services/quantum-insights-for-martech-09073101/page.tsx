...
export const metadata: Metadata = {
  title: 'Quantum Insights for MARTECH',
  description: 'Drive innovation in martech with Quantum Insights for MARTECH. This AI-powered platform transforms low-code automation into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-insights-for-martech-09073101',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Insights for MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in martech with Quantum Insights for MARTECH. This AI-powered platform transforms low-code automation into a competitive advantage.
          </p>
