...
export const metadata: Metadata = {
  title: 'AI-Powered Incident Engine',
  description: 'Drive innovation in retail with AI-Powered Incident Engine. This AI-powered platform transforms territory management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-incident-engine-c1ca4c04',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Incident Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in retail with AI-Powered Incident Engine. This AI-powered platform transforms territory management into a competitive advantage.
          </p>
