...
export const metadata: Metadata = {
  title: 'Quantum System - MARTECH Quantum',
  description: 'Next-generation martech solution: Quantum System - MARTECH Quantum. Combines dashboard automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-system-martech-quantum-d596bd90',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum System - MARTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation martech solution: Quantum System - MARTECH Quantum. Combines dashboard automation with adaptive intelligence for optimal results.
          </p>
