...
export const metadata: Metadata = {
  title: 'Autonomous Financial Processor',
  description: 'Next-generation proptech solution: Autonomous Financial Processor. Combines energy management with adaptive intelligence for optimal results.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation proptech solution: Autonomous Financial Processor. Combines energy management with adaptive intelligence for optimal results.
          </p>
