...
export const metadata: Metadata = {
  title: 'Cognitive Autonomous for Manufacturing',
  description: 'The future of manufacturing is here with Cognitive Autonomous for Manufacturing. Powered by cutting-edge AI, this platform delivers transformative results like ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-autonomous-for-manufacturing-29051583',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Autonomous for Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of manufacturing is here with Cognitive Autonomous for Manufacturing. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
