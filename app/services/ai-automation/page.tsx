...
export const metadata: Metadata = {
  ...
  keywords: 'Workflow automation, Document processing, Email automation, Task scheduling, Process optimization, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Streamline your business processes with intelligent automation solutions.</p>
        ...
        <li class="text-slate-300">Task scheduling</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai automation</li>
