...
export const metadata: Metadata = {
  title: 'Cognitive Risk Solution - Legal',
  description: 'Drive innovation in legal with Cognitive Risk Solution - Legal. This AI-powered platform transforms invoice processing into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-risk-solution-legal-c06c9116',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Risk Solution - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Cognitive Risk Solution - Legal. This AI-powered platform transforms invoice processing into a competitive advantage.
          </p>
