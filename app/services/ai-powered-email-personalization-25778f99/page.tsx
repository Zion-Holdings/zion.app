...
export const metadata: Metadata = {
  ...
  description: 'Creates hyper-personalized email campaigns with dynamic content and behavioral triggers.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-email-personalization-25778f99',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Creates hyper-personalized email campaigns with dynamic content and behavioral triggers.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">300% engagement</li>
