...
export const metadata: Metadata = {
  title: 'Smart Customer Service Platform - HEALTHTECH',
  description: 'Revolutionize healthtech through intelligent automation. Our Smart Customer Service Platform - HEALTHTECH leverages advanced machine learning to deliver process',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-customer-service-platform-healthtech-497885c8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Customer Service Platform - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthtech through intelligent automation. Our Smart Customer Service Platform - HEALTHTECH leverages advanced machine learning to deliver process discovery at scale.
          </p>
