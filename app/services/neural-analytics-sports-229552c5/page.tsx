...
export const metadata: Metadata = {
  title: 'Neural analytics-sports',
  description: 'Optimize your sports workflows with Neural analytics-sports. This intelligent platform delivers recruitment automation through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-analytics-sports-229552c5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural analytics-sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your sports workflows with Neural analytics-sports. This intelligent platform delivers recruitment automation through advanced automation and AI.
          </p>
