...
export const metadata: Metadata = {
  title: 'Predictive Machine Learning Engine - Sports',
  description: 'The future of sports is here with Predictive Machine Learning Engine - Sports. Powered by cutting-edge AI, this platform delivers brand sentiment like never bef',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Machine Learning Engine - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Predictive Machine Learning Engine - Sports. Powered by cutting-edge AI, this platform delivers brand sentiment like never before.
          </p>
