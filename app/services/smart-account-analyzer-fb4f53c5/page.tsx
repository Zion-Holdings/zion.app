...
export const metadata: Metadata = {
  title: 'Smart Account Analyzer',
  description: 'Drive innovation in energy with Smart Account Analyzer. This AI-powered platform transforms api management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-account-analyzer-fb4f53c5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Account Analyzer
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Smart Account Analyzer. This AI-powered platform transforms api management into a competitive advantage.
          </p>
