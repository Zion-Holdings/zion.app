...
export const metadata: Metadata = {
  title: 'Self-Optimizing Healthcare Intelligence',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Healthcare Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Self-Optimizing Healthcare Intelligence. This autonomous system provides task mining with zero manual intervention needed.
          </p>
