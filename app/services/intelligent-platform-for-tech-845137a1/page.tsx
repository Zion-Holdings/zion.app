...
export const metadata: Metadata = {
  title: 'Intelligent Platform for Tech',
  description: 'Revolutionize technology through intelligent automation. Our Intelligent Platform for Tech leverages advanced machine learning to deliver supply chain at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-platform-for-tech-845137a1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Platform for Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our Intelligent Platform for Tech leverages advanced machine learning to deliver supply chain at scale.
          </p>
