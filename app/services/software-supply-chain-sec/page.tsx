...
export const metadata: Metadata = {
  ...
  keywords: 'SBOM + provenance per build (SPDX/CycloneDX), SLSA Level 3+ attestation per release, Dependency verification + vuln patch automation, Code-signing pipeline integrity verification, Supply chain dashboard per upstream risk, security, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">End-to-end supply chain: SBOM generation+attestation, dependency verification, code-signing (SLSA L3+), vulnerability patch management, artifact provenance tracking.</p>
        ...
        <li class="text-slate-300">SBOM + provenance per build (SPDX/CycloneDX)</li>
        <li class="text-slate-300">SLSA Level 3+ attestation per release</li>
        <li class="text-slate-300">Dependency verification + vuln patch automation</li>
        <li class="text-slate-300">Code-signing pipeline integrity verification</li>
        <li class="text-slate-300">Supply chain dashboard per upstream risk</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with software supply chain security</li>
