...
export const metadata: Metadata = {
  title: 'Enterprise Executive Platform - Logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Enterprise Executive Platform - Logistics leverages advanced machine learning to deliver compliance ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-executive-platform-logistics-abce62a6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Executive Platform - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Enterprise Executive Platform - Logistics leverages advanced machine learning to deliver compliance monitoring at scale.
          </p>
