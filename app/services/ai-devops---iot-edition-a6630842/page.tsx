...
export const metadata: Metadata = {
  title: 'AI DevOps - Iot Edition',
  description: 'The future of iot is here with AI DevOps - Iot Edition. Powered by cutting-edge AI, this platform delivers risk assessment like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-devops---iot-edition-a6630842',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI DevOps - Iot Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of iot is here with AI DevOps - Iot Edition. Powered by cutting-edge AI, this platform delivers risk assessment like never before.
          </p>
