...
export const metadata: Metadata = {
  title: 'Cognitive Experience Solution - Logistics',
  description: 'Unlock unprecedented growth with Cognitive Experience Solution - Logistics. This autonomous system provides invoice processing with zero manual intervention nee',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-experience-solution-logistics-a1fc749d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Experience Solution - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Cognitive Experience Solution - Logistics. This autonomous system provides invoice processing with zero manual intervention needed.
          </p>
