...
export const metadata: Metadata = {
  title: 'Autonomous Platform System - HEALTHTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Platform System - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthtech with Autonomous Platform System - HEALTHTECH. This AI-powered platform transforms record processing into a competitive advantage.
          </p>
