...
export const metadata: Metadata = {
  title: 'Intelligent sales-manufacturing',
  description: 'Revolutionize manufacturing through intelligent automation. Our Intelligent sales-manufacturing leverages advanced machine learning to deliver resource optimiza',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-sales-manufacturing-9060d44b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent sales-manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize manufacturing through intelligent automation. Our Intelligent sales-manufacturing leverages advanced machine learning to deliver resource optimization at scale.
          </p>
