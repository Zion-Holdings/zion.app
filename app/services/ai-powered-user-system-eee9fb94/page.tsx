...
export const metadata: Metadata = {
  title: 'AI-Powered User System',
  description: 'Revolutionize real-estate through intelligent automation. Our AI-Powered User System leverages advanced machine learning to deliver logistics route optimization',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered User System
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our AI-Powered User System leverages advanced machine learning to deliver logistics route optimization at scale.
          </p>
