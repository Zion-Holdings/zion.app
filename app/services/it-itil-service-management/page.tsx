...
export const metadata: Metadata = {
  ...
  keywords: 'AI-powered incident classification & routing, Automated change approval workflows, Service catalog & self-service portal, CMDB auto-discovery & dependency mapping, SLA monitoring & escalation engine, Knowledge base integration with AI search, it, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">ITIL Service Management (ITSM) Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Full ITIL-aligned service management with AI-powered ticketing, change management automation, CMDB discovery, and self-service portal for enterprise IT operations.</p>
        ...
        <li class="text-slate-300">AI-powered incident classification &amp; routing</li>
        <li class="text-slate-300">Automated change approval workflows</li>
        <li class="text-slate-300">Service catalog &amp; self-service portal</li>
        <li class="text-slate-300">CMDB auto-discovery &amp; dependency mapping</li>
        <li class="text-slate-300">SLA monitoring &amp; escalation engine</li>
        <li class="text-slate-300">Knowledge base integration with AI search</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with itil service management (itsm) platform</li>
