...
export const metadata: Metadata = {
  title: 'Intelligent data-cleantech',
  description: 'Next-generation cleantech solution: Intelligent data-cleantech. Combines logistics route optimization with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-data-cleantech-4a762164',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent data-cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation cleantech solution: Intelligent data-cleantech. Combines logistics route optimization with adaptive intelligence for optimal results.
          </p>
