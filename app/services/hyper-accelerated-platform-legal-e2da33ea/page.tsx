...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Platform - Legal',
  description: 'Enhance your legal business with Hyper-Accelerated Platform - Legal. Our solution provides model interpretability with enterprise-grade reliability and security',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/hyper-accelerated-platform-legal-e2da33ea',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Hyper-Accelerated Platform - Legal. Our solution provides model interpretability with enterprise-grade reliability and security.
          </p>
