...
export const metadata: Metadata = {
  title: 'AI-Powered Platform for Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our AI-Powered Platform for Insurance leverages advanced machine learning to deliver document processing',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Platform for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our AI-Powered Platform for Insurance leverages advanced machine learning to deliver document processing at scale.
          </p>
