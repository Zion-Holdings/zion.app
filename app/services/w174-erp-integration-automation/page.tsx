...
export const metadata: Metadata = {
  ...
  keywords: 'SAP, Oracle, NetSuite, Dynamics integration, Bidirectional data synchronization, Business workflow automation (AP, AR, PO), Custom module and extension development, Legacy ERP modernization and API enablement, Error handling and reconciliation, iPaaS connectivity (MuleSoft, Boomi, Workato), automation, Operations, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">ERP Integration &amp; Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Automate ERP workflows and integrations: SAP, Oracle, NetSuite, and Dynamics. Data sync, workflow automation, and custom module development.</p>
        ...
        <li class="text-slate-300">SAP, Oracle, NetSuite, Dynamics integration</li>
        <li class="text-slate-300">Bidirectional data synchronization</li>
        <li class="text-slate-300">Business workflow automation (AP, AR, PO)</li>
        <li class="text-slate-300">Custom module and extension development</li>
        <li class="text-slate-300">Legacy ERP modernization and API enablement</li>
        <li class="text-slate-300">Error handling and reconciliation</li>
        <li class="text-slate-300">iPaaS connectivity (MuleSoft, Boomi, Workato)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Integrate ERP with modern cloud apps</li>
        <li class="text-slate-300">Automate manual ERP workflows</li>
        <li class="text-slate-300">Real-time sync eliminates batch delays</li>
        <li class="text-slate-300">Legacy ERP API enablement for digital transformation</li>
      </ul>
        </div>
