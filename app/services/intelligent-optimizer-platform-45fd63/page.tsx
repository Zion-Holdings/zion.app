      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Intelligent Optimizer Platform. This automation solution delivers unprecedented automation and intelligence.
          </p>
