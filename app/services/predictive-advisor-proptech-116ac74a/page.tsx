...
export const metadata: Metadata = {
  title: 'Predictive advisor-proptech',
  description: 'Revolutionize proptech through intelligent automation. Our Predictive advisor-proptech leverages advanced machine learning to deliver image recognition at scale',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-advisor-proptech-116ac74a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive advisor-proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our Predictive advisor-proptech leverages advanced machine learning to deliver image recognition at scale.
          </p>
