      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize fintech through intelligent automation. Our Smart cloud-fintech leverages advanced machine learning to deliver resource allocation at scale.
          </p>
