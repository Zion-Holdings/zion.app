...
export const metadata: Metadata = {
  title: 'Generator Cognitive - Legal',
  description: 'Enhance your legal business with Generator Cognitive - Legal. Our solution provides customer retention with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/generator-cognitive-legal-e8952f01',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Generator Cognitive - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Generator Cognitive - Legal. Our solution provides customer retention with enterprise-grade reliability and security.
          </p>
