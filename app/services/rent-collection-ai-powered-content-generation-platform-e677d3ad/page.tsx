...
export const metadata: Metadata = {
  title: 'Rent Collection AI-Powered Content Generation Platform',
  description: 'AI-powered rent collection solution for marketing. Generates high-quality, SEO-optimized content at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/rent-collection-ai-powered-content-generation-platform-e677d3ad',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Rent Collection AI-Powered Content Generation Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered rent collection solution for marketing. Generates high-quality, SEO-optimized content at scale.
          </p>
