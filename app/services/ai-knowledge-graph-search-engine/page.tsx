...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-source entity and relation extractor from PDF, Notion, Slack, databases, and API specs, Entity disambiguation with canonical identity store, NL query rewriter — \\,  becomes a graph query automatically, Every answer carries a primary-source footnote plus timestamp, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Knowledge Graph Search Engine</h1>
        <p className="text-lg text-slate-300 mb-8">Semantic graph search engine: turn siloed docs, databases, and APIs into a unified knowledge graph with entity disambiguation, NL query rewriting, and cited ranked answers across 50+ connected tools.</p>
        ...
        <li class="text-slate-300">Multi-source entity and relation extractor from PDF, Notion, Slack, databases, and API specs</li>
        <li class="text-slate-300">Entity disambiguation with canonical identity store</li>
        <li class="text-slate-300">NL query rewriter — \</li>
        <li class="text-slate-300"> becomes a graph query automatically</li>
        <li class="text-slate-300">Every answer carries a primary-source footnote plus timestamp</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with knowledge graph search engine</li>
