...
export const metadata: Metadata = {
  ...
  description: 'budgeting solution for security services industry. End-to-end predictive analytics platform that forecasts market trends, customer behavior, and operational met',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/budgeting-ai-powered-predictive-analytics-suite-7eaecb45',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            budgeting solution for security services industry. End-to-end predictive analytics platform that forecasts market trends, customer behavior, and operational metrics with 95% accuracy.
          </p>
