...
export const metadata: Metadata = {
  title: 'AI Suite - Legal Edition #5',
  description: 'The future of legal is here with AI Suite - Legal Edition #5. Powered by cutting-edge AI, this platform delivers executive dashboards like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-suite-legal-edition-5-2b70f845',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Suite - Legal Edition #5
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with AI Suite - Legal Edition #5. Powered by cutting-edge AI, this platform delivers executive dashboards like never before.
          </p>
