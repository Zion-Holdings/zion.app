...
export const metadata: Metadata = {
  ...
  keywords: 'Application-consistent backups, Cross-region replication, Automated failover testing, DR runbook automation, Compliance (ISO 27001, SOC 2), it, E-Commerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Business Continuity &amp; Disaster Recovery</h1>
        <p className="text-lg text-slate-300 mb-8">Automated backup, replication, and failover orchestration across cloud and on-premise. RPOs as low as 15 seconds, RTOs under 5 minutes.</p>
        ...
        <li class="text-slate-300">Application-consistent backups</li>
        <li class="text-slate-300">Cross-region replication</li>
        <li class="text-slate-300">Automated failover testing</li>
        <li class="text-slate-300">DR runbook automation</li>
        <li class="text-slate-300">Compliance (ISO 27001, SOC 2)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with business continuity &amp; disaster recovery</li>
