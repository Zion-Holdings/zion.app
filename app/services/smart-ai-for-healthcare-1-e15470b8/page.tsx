...
export const metadata: Metadata = {
  title: 'Smart AI for Healthcare #1',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart AI for Healthcare #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with Smart AI for Healthcare #1. This AI-powered platform transforms social media monitoring into a competitive advantage.
          </p>
