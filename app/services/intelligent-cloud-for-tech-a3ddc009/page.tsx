...
export const metadata: Metadata = {
  title: 'Intelligent Cloud for Tech',
  description: 'Drive innovation in technology with Intelligent Cloud for Tech. This AI-powered platform transforms user experience into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-cloud-for-tech-a3ddc009',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Cloud for Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in technology with Intelligent Cloud for Tech. This AI-powered platform transforms user experience into a competitive advantage.
          </p>
