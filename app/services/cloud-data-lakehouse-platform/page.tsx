    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>One lake and one engine replaces data warehouse and data lake silos with a single system</li>
            <li>SQL on raw data means no schema needed upfront before every case is known</li>
            <li>Schema enforcement prevents schema-drift from breaking live dashboards in production</li>
            <li>Join optimizer means 200-table joins run in seconds rather than hours</li>
          </ul>
        </div>
