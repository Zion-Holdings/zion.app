...
export const metadata: Metadata = {
  ...
  keywords: 'Open-table format ACID engine with Delta Lake or Apache Iceberg, SQL front-end with mesh cardinality optimizer — large multi-table joins run fast, Schema enforcement at write path — no orphan columns enter production tables, BI connectors for Looker, Grafana, Metabase, and Tableau ODBC — no ETL layer needed, cloud, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Data Lakehouse Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Unified data lakehouse: ingest CSV, JSON, Parquet, and streams; implement ACID semantics with open-table format Delta Lake or Iceberg engine; SQL query with cardinality optimizer; built-in BI tool connectors; schema enforcement at write time.</p>
        ...
        <li class="text-slate-300">Open-table format ACID engine with Delta Lake or Apache Iceberg</li>
        <li class="text-slate-300">SQL front-end with mesh cardinality optimizer — large multi-table joins run fast</li>
        <li class="text-slate-300">Schema enforcement at write path — no orphan columns enter production tables</li>
        <li class="text-slate-300">BI connectors for Looker, Grafana, Metabase, and Tableau ODBC — no ETL layer needed</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with data lakehouse platform</li>
