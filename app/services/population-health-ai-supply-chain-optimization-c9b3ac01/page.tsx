...
export const metadata: Metadata = {
  title: 'Population Health AI Supply Chain Optimization',
  description: 'population health solution for sports & entertainment industry. Optimizes supply chain operations using predictive analytics, demand forecasting, and route opti',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/population-health-ai-supply-chain-optimization-c9b3ac01',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Population Health AI Supply Chain Optimization
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            population health solution for sports & entertainment industry. Optimizes supply chain operations using predictive analytics, demand forecasting, and route optimization.
          </p>
