...
export const metadata: Metadata = {
  title: 'Cognitive AI Solution - Legal',
  description: 'Drive innovation in legal with Cognitive AI Solution - Legal. This AI-powered platform transforms energy management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-ai-solution-legal-581f29cc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive AI Solution - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Cognitive AI Solution - Legal. This AI-powered platform transforms energy management into a competitive advantage.
          </p>
