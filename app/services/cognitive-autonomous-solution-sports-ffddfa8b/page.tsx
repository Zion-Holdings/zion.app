...
export const metadata: Metadata = {
  title: 'Cognitive Autonomous Solution - Sports',
  description: 'Next-generation sports solution: Cognitive Autonomous Solution - Sports. Combines image recognition with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-autonomous-solution-sports-ffddfa8b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Autonomous Solution - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation sports solution: Cognitive Autonomous Solution - Sports. Combines image recognition with adaptive intelligence for optimal results.
          </p>
