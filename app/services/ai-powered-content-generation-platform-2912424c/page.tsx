...
export const metadata: Metadata = {
  ...
  description: 'Generates high-quality, SEO-optimized content at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-content-generation-platform-2912424c',
  },

export const metadata = {
  title: "AI-Powered Content Generation Platform - Zion Tech Group",
  description: "Generates high-quality, SEO-optimized content at scale.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-content-generation-platform-2912424c`
  }
  ...
  return (
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Generates high-quality, SEO-optimized content at scale.
          </p>
    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">AI-Powered Content Generation Platform</h1>
        <p className="text-lg text-gray-300 mb-8">Generates high-quality, SEO-optimized content at scale.</p>
