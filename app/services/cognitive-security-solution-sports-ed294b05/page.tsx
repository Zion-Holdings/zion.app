export const metadata = {
  title: "Cognitive Security Solution - Sports",
  description: "Zion Tech Group delivers Cognitive Security Solution - Sports with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/services/cognitive-security-solution-sports-ed294b05/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>Cognitive Security Solution - Sports</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers Cognitive Security Solution - Sports with measurable outcomes.
      </p>
