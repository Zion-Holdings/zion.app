...
export const metadata: Metadata = {
  title: 'Enterprise Risk Platform - Construction',
  description: 'Drive innovation in construction with Enterprise Risk Platform - Construction. This AI-powered platform transforms maintenance scheduling into a competitive adv',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Risk Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Enterprise Risk Platform - Construction. This AI-powered platform transforms maintenance scheduling into a competitive advantage.
          </p>
