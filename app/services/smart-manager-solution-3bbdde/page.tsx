...
export const metadata: Metadata = {
  title: 'Smart Manager Solution',
  description: 'Transform your transportation operations with our Smart Manager Solution. This analytics solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-manager-solution-3bbdde',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manager Solution
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your transportation operations with our Smart Manager Solution. This analytics solution delivers unprecedented automation and intelligence.
          </p>
