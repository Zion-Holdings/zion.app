...
export const metadata: Metadata = {
  title: 'AI-Powered Industrial Automation Platform',
  description: 'Platform for industrial automation with AI and IoT integration.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-industrial-automation-platform-08f069bf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Industrial Automation Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Platform for industrial automation with AI and IoT integration.
          </p>
