...
export const metadata: Metadata = {
  title: 'Predictive Process Mining Engine - Energy',
  description: 'Next-generation energy solution: Predictive Process Mining Engine - Energy. Combines process discovery with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-process-mining-engine-energy-815b2bac',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Process Mining Engine - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Predictive Process Mining Engine - Energy. Combines process discovery with adaptive intelligence for optimal results.
          </p>
