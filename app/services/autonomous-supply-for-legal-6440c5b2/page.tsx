...
export const metadata: Metadata = {
  title: 'Autonomous Supply for Legal',
  description: 'Transform your legal operations with our Autonomous Supply for Legal. This AI-driven solution automates customer service automation with unprecedented accuracy ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-supply-for-legal-6440c5b2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Supply for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Autonomous Supply for Legal. This AI-driven solution automates customer service automation with unprecedented accuracy and efficiency.
          </p>
