...
export const metadata: Metadata = {
  title: 'Automated system-legal',
  description: 'Transform your legal operations with our Automated system-legal. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficie',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-system-legal-5b0208a2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated system-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Automated system-legal. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
