...
export const metadata: Metadata = {
  title: 'Autonomous Analyzer System - Logistics',
  description: 'Optimize your logistics workflows with Autonomous Analyzer System - Logistics. This intelligent platform delivers invoice processing through advanced automation',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Analyzer System - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your logistics workflows with Autonomous Analyzer System - Logistics. This intelligent platform delivers invoice processing through advanced automation and AI.
          </p>
