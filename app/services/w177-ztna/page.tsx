...
export const metadata: Metadata = {
  ...
  keywords: 'Identity-based access control, Device posture verification, Per-application access (no network trust), Continuous session verification, Split tunneling for performance, Integration with Okta, Entra ID, CrowdStrike, security, Cybersecurity, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Zero Trust Network Access (ZTNA)</h1>
        <p className="text-lg text-slate-300 mb-8">ZTNA replaces VPN: identity-based access, device posture verification, per-application access, no network trust.</p>
        ...
        <li class="text-slate-300">Identity-based access control</li>
        <li class="text-slate-300">Device posture verification</li>
        <li class="text-slate-300">Per-application access (no network trust)</li>
        <li class="text-slate-300">Continuous session verification</li>
        <li class="text-slate-300">Split tunneling for performance</li>
        <li class="text-slate-300">Integration with Okta</li>
        <li class="text-slate-300">Entra ID</li>
        <li class="text-slate-300">CrowdStrike</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Replace VPN with zero trust</li>
        <li class="text-slate-300">Device posture blocks non-compliant devices</li>
        <li class="text-slate-300">Per-application access limits blast radius</li>
        <li class="text-slate-300">Continuous verification prevents session hijacking</li>
      </ul>
        </div>
