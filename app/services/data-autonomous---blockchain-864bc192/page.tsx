...
export const metadata: Metadata = {
  title: 'Data Autonomous - Blockchain',
  description: 'Next-generation blockchain solution: Data Autonomous - Blockchain. Combines quality control with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-autonomous---blockchain-864bc192',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Autonomous - Blockchain
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation blockchain solution: Data Autonomous - Blockchain. Combines quality control with adaptive intelligence for optimal results.
          </p>
