...
export const metadata: Metadata = {
  title: 'Predictive Experience for Transportation',
  description: 'Transform your transportation operations with our Predictive Experience for Transportation. This AI-driven solution automates customer insights with unprecedent',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Experience for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your transportation operations with our Predictive Experience for Transportation. This AI-driven solution automates customer insights with unprecedented accuracy and efficiency.
          </p>
