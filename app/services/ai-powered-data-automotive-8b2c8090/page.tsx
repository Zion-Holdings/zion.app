...
export const metadata: Metadata = {
  title: 'AI-Powered data-automotive',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered data-automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with AI-Powered data-automotive. This autonomous system provides supply chain with zero manual intervention needed.
          </p>
