...
export const metadata: Metadata = {
  title: "Ad-hoc Analysis AI-Powered HR Analytics - AI-Powered Ad-hoc Analysis Solution",
  description: "AI-powered ad-hoc analysis solution for hr. Predictive analytics for employee performance, retention, and recruitment.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ad-hoc-analysis-ai-powered-hr-analytics-632a68d5",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Ad-hoc Analysis AI-Powered HR Analytics - AI-Powered Ad-hoc Analysis Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          AI-powered ad-hoc analysis solution for hr. Predictive analytics for employee performance, retention, and recruitment.
        </p>
