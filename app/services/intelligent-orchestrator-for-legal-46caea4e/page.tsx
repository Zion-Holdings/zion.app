...
export const metadata: Metadata = {
  title: 'Intelligent Orchestrator for Legal',
  description: 'The future of legal is here with Intelligent Orchestrator for Legal. Powered by cutting-edge AI, this platform delivers survey automation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-orchestrator-for-legal-46caea4e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Orchestrator for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Intelligent Orchestrator for Legal. Powered by cutting-edge AI, this platform delivers survey automation like never before.
          </p>
