...
export const metadata: Metadata = {
  title: 'Risk Neural - Logistics',
  description: 'Drive innovation in logistics with Risk Neural - Logistics. This AI-powered platform transforms sales forecasting into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/risk-neural-logistics-023d933f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Risk Neural - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with Risk Neural - Logistics. This AI-powered platform transforms sales forecasting into a competitive advantage.
          </p>
