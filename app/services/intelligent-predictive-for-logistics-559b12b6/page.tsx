...
export const metadata: Metadata = {
  title: 'Intelligent Predictive for Logistics',
  description: 'Enhance your logistics business with Intelligent Predictive for Logistics. Our solution provides business intelligence with enterprise-grade reliability and sec',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-predictive-for-logistics-559b12b6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Predictive for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with Intelligent Predictive for Logistics. Our solution provides business intelligence with enterprise-grade reliability and security.
          </p>
