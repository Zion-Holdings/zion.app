...
export const metadata: Metadata = {
  title: 'AI-Powered engine-healthcare',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: AI-Powered engine-healthcare. Combines manufacturing quality control with adaptive intelligence for optimal results.
          </p>
