...
export const metadata: Metadata = {
  title: 'Neural data-edge',
  description: 'The future of edge is here with Neural data-edge. Powered by cutting-edge AI, this platform delivers security monitoring like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-data-edge-8731a1ff',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of edge is here with Neural data-edge. Powered by cutting-edge AI, this platform delivers security monitoring like never before.
          </p>
