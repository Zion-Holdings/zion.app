...
export const metadata: Metadata = {
  title: 'Adaptive manager-regtech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive manager-regtech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your regtech business with Adaptive manager-regtech. Our solution provides quota optimization with enterprise-grade reliability and security.
          </p>
