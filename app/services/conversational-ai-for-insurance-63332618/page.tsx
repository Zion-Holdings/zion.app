  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Conversational AI for Insurance</h1>
        <p className="text-lg text-slate-300 mb-8">Natural language processing system that handles insurance inquiries through intelligent chatbots and virtual assistants. Provides 24/7 support with human-like conversation capabilities.</p>
