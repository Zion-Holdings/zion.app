...
export const metadata: Metadata = {
  title: 'Predictive Finance for Construction',
  description: 'The future of construction is here with Predictive Finance for Construction. Powered by cutting-edge AI, this platform delivers code optimization like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-finance-for-construction-ca33cd82',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Finance for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Predictive Finance for Construction. Powered by cutting-edge AI, this platform delivers code optimization like never before.
          </p>
