...
export const metadata: Metadata = {
  title: 'Intelligent Manufacturing for Agriculture',
  description: 'Unlock unprecedented growth with Intelligent Manufacturing for Agriculture. This autonomous system provides customer service automation with zero manual interve',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-manufacturing-for-agriculture-fab67e01',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Manufacturing for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Manufacturing for Agriculture. This autonomous system provides customer service automation with zero manual intervention needed.
          </p>
