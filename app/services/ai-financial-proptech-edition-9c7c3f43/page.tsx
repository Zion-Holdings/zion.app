...
export const metadata: Metadata = {
  title: 'AI Financial - PROPTECH Edition',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Financial - PROPTECH Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation proptech solution: AI Financial - PROPTECH Edition. Combines project portfolio with adaptive intelligence for optimal results.
          </p>
