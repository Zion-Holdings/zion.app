...
export const metadata: Metadata = {
  title: 'Cognitive manufacturing-legal',
  description: 'Next-generation legal solution: Cognitive manufacturing-legal. Combines invoice processing with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-manufacturing-legal-ee2ead7a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive manufacturing-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Cognitive manufacturing-legal. Combines invoice processing with adaptive intelligence for optimal results.
          </p>
