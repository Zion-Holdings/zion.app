...
export const metadata: Metadata = {
  title: 'Smart Generator Platform - Agriculture',
  description: 'Enhance your agriculture business with Smart Generator Platform - Agriculture. Our solution provides security monitoring with enterprise-grade reliability and s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Generator Platform - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your agriculture business with Smart Generator Platform - Agriculture. Our solution provides security monitoring with enterprise-grade reliability and security.
          </p>
