  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Autonomous Experience for Healthcare #1</h1>
        <p className="text-lg text-gray-300 mb-8">Next-generation healthcare solution: Autonomous Experience for Healthcare #1. Combines customer service automation with adaptive intelligence for optimal results.</p>
