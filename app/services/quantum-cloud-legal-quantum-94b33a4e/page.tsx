...
export const metadata: Metadata = {
  title: 'Quantum Cloud - Legal Quantum',
  description: 'Quantum leap forward for legal: Quantum Cloud - Legal Quantum. Uses quantum-inspired algorithms to deliver demand planning at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-cloud-legal-quantum-94b33a4e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Cloud - Legal Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for legal: Quantum Cloud - Legal Quantum. Uses quantum-inspired algorithms to deliver demand planning at exponential speed.
          </p>
