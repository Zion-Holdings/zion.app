...
export const metadata: Metadata = {
  ...
  description: 'Automates customer relationship management with AI-driven insights and follow-ups.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-crm-automation-7a13491f',
  },
  ...
  return (
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automates customer relationship management with AI-driven insights and follow-ups.
          </p>
    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">AI-Powered CRM Automation</h1>
        <p className="text-lg text-gray-300 mb-8">Automates customer relationship management with AI-driven insights and follow-ups.</p>
