...
export const metadata: Metadata = {
  title: 'Predictive Workflow Engine - Cybersecurity',
  description: 'Drive innovation in cybersecurity with Predictive Workflow Engine - Cybersecurity. This AI-powered platform transforms goal setting into a competitive advantage',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-workflow-engine-cybersecurity-8e8307c5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Workflow Engine - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in cybersecurity with Predictive Workflow Engine - Cybersecurity. This AI-powered platform transforms goal setting into a competitive advantage.
          </p>
