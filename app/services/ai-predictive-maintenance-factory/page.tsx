...
export const metadata: Metadata = {
  ...
  keywords: 'Vibration & thermal analysis, Failure mode classification, Maintenance scheduling, Parts inventory forecasting, OEE dashboards, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Predictive Maintenance for Manufacturing</h1>
        <p className="text-lg text-slate-300 mb-8">IoT sensor fusion + ML to predict equipment failures 7–30 days in advance. Reduces downtime by 50%, extends asset life.</p>
        ...
        <li class="text-slate-300">Vibration &amp; thermal analysis</li>
        <li class="text-slate-300">Failure mode classification</li>
        <li class="text-slate-300">Maintenance scheduling</li>
        <li class="text-slate-300">Parts inventory forecasting</li>
        <li class="text-slate-300">OEE dashboards</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with predictive maintenance for manufacturing</li>
