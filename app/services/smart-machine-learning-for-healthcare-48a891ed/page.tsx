...
export const metadata: Metadata = {
  title: 'Smart Machine Learning for Healthcare',
  description: 'Next-generation healthcare solution: Smart Machine Learning for Healthcare. Combines resource allocation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-machine-learning-for-healthcare-48a891ed',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Machine Learning for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Smart Machine Learning for Healthcare. Combines resource allocation with adaptive intelligence for optimal results.
          </p>
