...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Supply - TECHNOLOGY',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Supply - TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your technology business with Hyper-Accelerated Supply - TECHNOLOGY. Our solution provides expense reporting with enterprise-grade reliability and security.
          </p>
