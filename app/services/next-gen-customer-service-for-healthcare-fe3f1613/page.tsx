...
export const metadata: Metadata = {
  title: 'Next-Gen Customer Service for Healthcare',
  description: 'Enhance your healthcare business with Next-Gen Customer Service for Healthcare. Our solution provides expense management with enterprise-grade reliability and s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Customer Service for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with Next-Gen Customer Service for Healthcare. Our solution provides expense management with enterprise-grade reliability and security.
          </p>
