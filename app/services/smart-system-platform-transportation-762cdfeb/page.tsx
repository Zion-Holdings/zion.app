...
export const metadata: Metadata = {
  title: 'Smart System Platform - Transportation',
  description: 'Optimize your transportation workflows with Smart System Platform - Transportation. This intelligent platform delivers budget optimization through advanced auto',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-system-platform-transportation-762cdfeb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart System Platform - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Smart System Platform - Transportation. This intelligent platform delivers budget optimization through advanced automation and AI.
          </p>
