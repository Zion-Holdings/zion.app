...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated DevOps - PROPTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated DevOps - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your proptech workflows with Hyper-Accelerated DevOps - PROPTECH. This intelligent platform delivers case management through advanced automation and AI.
          </p>
