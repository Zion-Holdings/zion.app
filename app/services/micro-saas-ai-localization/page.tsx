  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">AI-powered translation and localization for websites, apps, docs, and marketing. Go beyond translation with cultural adaptation, SEO optimization, and quality scoring.</p>
        ...
        <li class="text-slate-300">AI translation with domain-specific models</li>
        <li class="text-slate-300">Cultural adaptation and localization review</li>
        <li class="text-slate-300">SEO-optimized translation for each locale</li>
        <li class="text-slate-300">Quality scoring with human-in-the-loop</li>
        <li class="text-slate-300">Integration with CMS, GitHub, Figma</li>
        <li class="text-slate-300">Glossary and style guide enforcement</li>
        <li class="text-slate-300">Real-time collaboration for translators</li>
        <li class="text-slate-300">Support for 100+ languages</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Launch in 100+ languages in weeks</li>
        <li class="text-slate-300">Reduce translation costs by 70%</li>
        <li class="text-slate-300">Maintain brand voice across all locales</li>
        <li class="text-slate-300">SEO-optimized for each target market</li>
      </ul>
        </div>
