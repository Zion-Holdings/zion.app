...
export const metadata: Metadata = {
  title: 'Lease Administration AI-Powered Cloud Migration',
  description: 'AI-powered lease administration solution for cloud migration. Intelligent cloud migration planning and execution.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/lease-administration-ai-powered-cloud-migration-f0153e1b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Lease Administration AI-Powered Cloud Migration
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered lease administration solution for cloud migration. Intelligent cloud migration planning and execution.
          </p>
