...
export const metadata: Metadata = {
  title: 'Smart Platform for Retail',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Platform for Retail. This autonomous system provides predictive analytics with zero manual intervention needed.
          </p>
