...
export const metadata: Metadata = {
  ...
  keywords: 'AI-guided will and trust creation wizard, State-specific legal compliance, Asset inventory and beneficiary management, Tax optimization recommendations, Attorney review network, Digital vault for document storage, Automated updates on life events, Multi-generational legacy planning, ai, legal, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Will, Estate &amp; Legacy Planning Assistant</h1>
        <p className="text-lg text-slate-300 mb-8">Guided AI assistant for creating legally sound wills, trusts, and estate plans. Analyzes assets, family structure, and state laws.</p>
        ...
        <li class="text-slate-300">AI-guided will and trust creation wizard</li>
        <li class="text-slate-300">State-specific legal compliance</li>
        <li class="text-slate-300">Asset inventory and beneficiary management</li>
        <li class="text-slate-300">Tax optimization recommendations</li>
        <li class="text-slate-300">Attorney review network</li>
        <li class="text-slate-300">Digital vault for document storage</li>
        <li class="text-slate-300">Automated updates on life events</li>
        <li class="text-slate-300">Multi-generational legacy planning</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Create a legal will in under 30 minutes</li>
        <li class="text-slate-300">Save $1,000+ on attorney fees</li>
        <li class="text-slate-300">Keep estate plans current</li>
        <li class="text-slate-300">Ensure family financial security</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">Custom family plans</p>
