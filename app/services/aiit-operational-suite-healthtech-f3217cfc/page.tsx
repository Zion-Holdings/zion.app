...
export const metadata: Metadata = {
  title: 'AI/IT Operational Suite - HEALTHTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Operational Suite - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for healthtech: AI/IT Operational Suite - HEALTHTECH. Uses quantum-inspired algorithms to deliver generative ai at exponential speed.
          </p>
