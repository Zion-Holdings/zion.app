...
export const metadata: Metadata = {
  title: 'Autonomous Platform for Insurance',
  description: 'Transform your insurance operations with our Autonomous Platform for Insurance. This AI-driven solution automates security monitoring with unprecedented accurac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-platform-for-insurance-eca14725',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Platform for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Autonomous Platform for Insurance. This AI-driven solution automates security monitoring with unprecedented accuracy and efficiency.
          </p>
