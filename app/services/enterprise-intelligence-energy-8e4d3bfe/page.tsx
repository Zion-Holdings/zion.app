...
export const metadata: Metadata = {
  title: 'Enterprise Intelligence - Energy',
  description: 'Optimize your energy workflows with Enterprise Intelligence - Energy. This intelligent platform delivers sentiment analysis through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-intelligence-energy-8e4d3bfe',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Intelligence - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your energy workflows with Enterprise Intelligence - Energy. This intelligent platform delivers sentiment analysis through advanced automation and AI.
          </p>
