...
export const metadata: Metadata = {
  title: 'Smart Manufacturing Platform - Real-Estate',
  description: 'Optimize your real-estate workflows with Smart Manufacturing Platform - Real-Estate. This intelligent platform delivers data governance through advanced automat',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-manufacturing-platform-real-estate-80f1baf2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manufacturing Platform - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your real-estate workflows with Smart Manufacturing Platform - Real-Estate. This intelligent platform delivers data governance through advanced automation and AI.
          </p>
