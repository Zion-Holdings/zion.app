...
export const metadata: Metadata = {
  title: 'Predictive Healthcare Engine - Gaming',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Healthcare Engine - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation gaming solution: Predictive Healthcare Engine - Gaming. Combines maintenance scheduling with adaptive intelligence for optimal results.
          </p>
