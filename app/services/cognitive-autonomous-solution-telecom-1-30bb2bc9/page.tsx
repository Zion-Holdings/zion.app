...
export const metadata: Metadata = {
  title: 'Cognitive Autonomous Solution - Telecom #1',
  description: 'Enhance your telecom business with Cognitive Autonomous Solution - Telecom #1. Our solution provides maintenance scheduling with enterprise-grade reliability an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Autonomous Solution - Telecom #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your telecom business with Cognitive Autonomous Solution - Telecom #1. Our solution provides maintenance scheduling with enterprise-grade reliability and security.
          </p>
