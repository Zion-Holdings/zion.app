...
export const metadata: Metadata = {
  title: 'AI/IT Computer Vision Suite - Retail',
  description: 'Next-generation retail solution: AI/IT Computer Vision Suite - Retail. Combines esg reporting with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-computer-vision-suite-retail-4473c083',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Computer Vision Suite - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation retail solution: AI/IT Computer Vision Suite - Retail. Combines esg reporting with adaptive intelligence for optimal results.
          </p>
