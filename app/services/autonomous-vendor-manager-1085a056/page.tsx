...
export const metadata: Metadata = {
  title: 'Autonomous Vendor Manager',
  description: 'Drive innovation in construction with Autonomous Vendor Manager. This AI-powered platform transforms cost reduction into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-vendor-manager-1085a056',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Autonomous Vendor Manager. This AI-powered platform transforms cost reduction into a competitive advantage.
          </p>
