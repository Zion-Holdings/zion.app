...
export const metadata: Metadata = {
  title: 'Accounts Payable AI Social Media Content Creator',
  description: 'AI-powered accounts payable solution for social media. Generates, schedules, and optimizes social media content across all platforms.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/accounts-payable-ai-social-media-content-creator-cf559610',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Accounts Payable AI Social Media Content Creator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered accounts payable solution for social media. Generates, schedules, and optimizes social media content across all platforms.
          </p>
