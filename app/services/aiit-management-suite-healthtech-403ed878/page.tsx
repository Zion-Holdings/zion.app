...
export const metadata: Metadata = {
  title: 'AI/IT Management Suite - HEALTHTECH',
  description: 'Transform your healthtech operations with our AI/IT Management Suite - HEALTHTECH. This AI-driven solution automates sourcing optimization with unprecedented ac',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Management Suite - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthtech operations with our AI/IT Management Suite - HEALTHTECH. This AI-driven solution automates sourcing optimization with unprecedented accuracy and efficiency.
          </p>
