...
export const metadata: Metadata = {
  ...
  keywords: 'Resume parsing and skill extraction, Job-candidate matching with explainability, Culture fit assessment from profiles, Diversity-optimized shortlisting, Skill gap analysis for candidates, Pipeline analytics and bias auditing, Integration with Greenhouse, Lever, Workday, ai, Human Resources, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Talent Matching Platform</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered talent matching: resume parsing, skill extraction, culture fit scoring, and diversity-optimized shortlisting. Reduce time-to-hire by 50%.</p>
        ...
        <li class="text-slate-300">Resume parsing and skill extraction</li>
        <li class="text-slate-300">Job-candidate matching with explainability</li>
        <li class="text-slate-300">Culture fit assessment from profiles</li>
        <li class="text-slate-300">Diversity-optimized shortlisting</li>
        <li class="text-slate-300">Skill gap analysis for candidates</li>
        <li class="text-slate-300">Pipeline analytics and bias auditing</li>
        <li class="text-slate-300">Integration with Greenhouse, Lever, Workday</li>
      </ul>
        </div>
        ...
        <li class="text-slate-300">Diversity optimization built into matching</li>
        <li class="text-slate-300">Explainable matching for fairness compliance</li>
        <li class="text-slate-300">Bias auditing ensures equitable screening</li>
      </ul>
        </div>
