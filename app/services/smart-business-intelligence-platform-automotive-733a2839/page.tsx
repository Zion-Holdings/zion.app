...
export const metadata: Metadata = {
  title: 'Smart Business Intelligence Platform - Automotive',
  description: 'Next-generation automotive solution: Smart Business Intelligence Platform - Automotive. Combines expense management with adaptive intelligence for optimal resul',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-business-intelligence-platform-automotive-733a2839',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Business Intelligence Platform - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation automotive solution: Smart Business Intelligence Platform - Automotive. Combines expense management with adaptive intelligence for optimal results.
          </p>
