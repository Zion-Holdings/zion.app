...
export const metadata: Metadata = {
  ...
  keywords: 'Microservices deployment, Role-based access control, Audit trails, GDPR compliance, Cloud-native architecture, system, construction, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Adaptive System for Construction</h1>
        <p className="text-lg text-slate-300 mb-8">The future of construction is here with Adaptive System for Construction. Powered by cutting-edge AI, this platform delivers market intelligence like never before.</p>
