...
export const metadata: Metadata = {
  title: 'AI/IT Data Suite - Manufacturing',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Data Suite - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated manufacturing solution: AI/IT Data Suite - Manufacturing. Combines scenario planning with next-gen AI for maximum velocity.
          </p>
