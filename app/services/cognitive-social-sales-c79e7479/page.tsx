...
export const metadata: Metadata = {
  title: 'Cognitive Social Sales',
  description: 'Optimize your finance workflows with Cognitive Social Sales. This intelligent platform delivers lead scoring through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-social-sales-c79e7479',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Social Sales
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your finance workflows with Cognitive Social Sales. This intelligent platform delivers lead scoring through advanced automation and AI.
          </p>
