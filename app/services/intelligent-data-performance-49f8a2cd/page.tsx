...
export const metadata: Metadata = {
  title: 'Intelligent Data Performance',
  description: 'The future of automotive is here with Intelligent Data Performance. Powered by cutting-edge AI, this platform delivers net promoter score like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-data-performance-49f8a2cd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Data Performance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of automotive is here with Intelligent Data Performance. Powered by cutting-edge AI, this platform delivers net promoter score like never before.
          </p>
