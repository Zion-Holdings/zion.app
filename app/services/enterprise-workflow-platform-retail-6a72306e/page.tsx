...
export const metadata: Metadata = {
  title: 'Enterprise Workflow Platform - Retail',
  description: 'Quantum leap forward for retail: Enterprise Workflow Platform - Retail. Uses quantum-inspired algorithms to deliver onboarding automation at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-workflow-platform-retail-6a72306e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Workflow Platform - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for retail: Enterprise Workflow Platform - Retail. Uses quantum-inspired algorithms to deliver onboarding automation at exponential speed.
          </p>
