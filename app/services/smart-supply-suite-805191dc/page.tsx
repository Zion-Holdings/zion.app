...
export const metadata: Metadata = {
  title: 'Smart Supply Suite',
  description: 'Unlock unprecedented growth with Smart Supply Suite. This autonomous system provides resource optimization with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-supply-suite-805191dc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Supply Suite. This autonomous system provides resource optimization with zero manual intervention needed.
          </p>
