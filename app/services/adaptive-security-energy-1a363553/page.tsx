...
export const metadata: Metadata = {
  title: 'Adaptive security-energy',
  description: 'Transform your energy operations with our Adaptive security-energy. This AI-driven solution automates image recognition with unprecedented accuracy and efficien',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-security-energy-1a363553',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive security-energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Adaptive security-energy. This AI-driven solution automates image recognition with unprecedented accuracy and efficiency.
          </p>
