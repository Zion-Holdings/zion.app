...
export const metadata: Metadata = {
  title: 'Smart Performance for Agriculture',
  description: 'Enhance your agriculture business with Smart Performance for Agriculture. Our solution provides language processing with enterprise-grade reliability and securi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-performance-for-agriculture-becf4659',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Performance for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your agriculture business with Smart Performance for Agriculture. Our solution provides language processing with enterprise-grade reliability and security.
          </p>
