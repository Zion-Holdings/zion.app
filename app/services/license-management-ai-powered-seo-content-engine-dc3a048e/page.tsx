...
export const metadata: Metadata = {
  ...
  description: 'license management solution for maritime industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing copy.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/license-management-ai-powered-seo-content-engine-dc3a048e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            license management solution for maritime industry. Generates SEO-optimized content at scale, including blog posts, product descriptions, and marketing copy.
          </p>
