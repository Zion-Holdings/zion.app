...
export const metadata: Metadata = {
  title: 'AI-Powered Healthcare for Quantum',
  description: 'Revolutionize quantum through intelligent automation. Our AI-Powered Healthcare for Quantum leverages advanced machine learning to deliver threat detection at s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Healthcare for Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize quantum through intelligent automation. Our AI-Powered Healthcare for Quantum leverages advanced machine learning to deliver threat detection at scale.
          </p>
