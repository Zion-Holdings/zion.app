...
export const metadata: Metadata = {
  title: 'AI Analyzer - Healthcare Edition',
  description: 'The future of healthcare is here with AI Analyzer - Healthcare Edition. Powered by cutting-edge AI, this platform delivers risk assessment like never before.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Analyzer - Healthcare Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with AI Analyzer - Healthcare Edition. Powered by cutting-edge AI, this platform delivers risk assessment like never before.
          </p>
