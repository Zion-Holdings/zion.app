...
export const metadata: Metadata = {
  title: 'Autonomous engine-manufacturing',
  description: 'Drive innovation in manufacturing with Autonomous engine-manufacturing. This AI-powered platform transforms network optimization into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-engine-manufacturing-5f5355a9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous engine-manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in manufacturing with Autonomous engine-manufacturing. This AI-powered platform transforms network optimization into a competitive advantage.
          </p>
