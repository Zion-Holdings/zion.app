...
export const metadata: Metadata = {
  title: 'Cognitive real estate-automotive',
  description: 'The future of automotive is here with Cognitive real estate-automotive. Powered by cutting-edge AI, this platform delivers loyalty optimization like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-real-estate-automotive-b64dc10e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive real estate-automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of automotive is here with Cognitive real estate-automotive. Powered by cutting-edge AI, this platform delivers loyalty optimization like never before.
          </p>
