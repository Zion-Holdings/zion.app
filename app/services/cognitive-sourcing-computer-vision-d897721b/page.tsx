...
export const metadata: Metadata = {
  title: 'Cognitive Sourcing Computer Vision',
  description: 'The future of construction is here with Cognitive Sourcing Computer Vision. Powered by cutting-edge AI, this platform delivers feature engineering like never be',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-sourcing-computer-vision-d897721b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Sourcing Computer Vision
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Cognitive Sourcing Computer Vision. Powered by cutting-edge AI, this platform delivers feature engineering like never before.
          </p>
