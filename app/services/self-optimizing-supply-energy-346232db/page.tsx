...
export const metadata: Metadata = {
  title: 'Self-Optimizing supply-energy',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing supply-energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your energy business with Self-Optimizing supply-energy. Our solution provides energy management with enterprise-grade reliability and security.
          </p>
