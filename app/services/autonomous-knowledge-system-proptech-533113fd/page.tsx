...
export const metadata: Metadata = {
  title: 'Autonomous Knowledge System - PROPTECH',
  description: 'Quantum leap forward for proptech: Autonomous Knowledge System - PROPTECH. Uses quantum-inspired algorithms to deliver access management at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-knowledge-system-proptech-533113fd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Knowledge System - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for proptech: Autonomous Knowledge System - PROPTECH. Uses quantum-inspired algorithms to deliver access management at exponential speed.
          </p>
