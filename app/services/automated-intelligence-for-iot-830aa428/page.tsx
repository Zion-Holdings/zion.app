...
export const metadata: Metadata = {
  title: 'Automated Intelligence for Iot',
  description: 'Revolutionize iot through intelligent automation. Our Automated Intelligence for Iot leverages advanced machine learning to deliver data processing at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-intelligence-for-iot-830aa428',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Intelligence for Iot
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize iot through intelligent automation. Our Automated Intelligence for Iot leverages advanced machine learning to deliver data processing at scale.
          </p>
