...
export const metadata: Metadata = {
  ...
  keywords: '24/7 monitoring, Auto detection and classification, Response playbook automation, Digital forensics, Executive reporting, security, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Incident Response &amp; Security Operations Center</h1>
        <p className="text-lg text-slate-300 mb-8">24/7 SOC and incident response - threat detection, investigation, containment, recovery with automated playbooks and forensics.</p>
        ...
        <li class="text-slate-300">Auto detection and classification</li>
        <li class="text-slate-300">Response playbook automation</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with incident response &amp; security operations center</li>
