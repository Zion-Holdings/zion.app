...
export const metadata: Metadata = {
  title: 'Smart Cognitive Platform - Finance',
  description: 'The future of finance is here with Smart Cognitive Platform - Finance. Powered by cutting-edge AI, this platform delivers account planning like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-cognitive-platform-finance-170cb64b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Cognitive Platform - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of finance is here with Smart Cognitive Platform - Finance. Powered by cutting-edge AI, this platform delivers account planning like never before.
          </p>
