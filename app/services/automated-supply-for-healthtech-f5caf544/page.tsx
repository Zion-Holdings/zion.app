...
export const metadata: Metadata = {
  title: 'Automated Supply for HEALTHTECH',
  description: 'Quantum leap forward for healthtech: Automated Supply for HEALTHTECH. Uses quantum-inspired algorithms to deliver risk management at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-supply-for-healthtech-f5caf544',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Supply for HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for healthtech: Automated Supply for HEALTHTECH. Uses quantum-inspired algorithms to deliver risk management at exponential speed.
          </p>
