...
export const metadata: Metadata = {
  title: 'Automated Cloud for Proptech',
  description: 'The future of proptech is here with Automated Cloud for Proptech. Powered by cutting-edge AI, this platform delivers customer insights like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-cloud-for-proptech-2762c83a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Cloud for Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with Automated Cloud for Proptech. Powered by cutting-edge AI, this platform delivers customer insights like never before.
          </p>
