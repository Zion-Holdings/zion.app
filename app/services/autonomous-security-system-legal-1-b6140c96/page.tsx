...
export const metadata: Metadata = {
  title: 'Autonomous Security System - Legal #1',
  description: 'Enhance your legal business with Autonomous Security System - Legal #1. Our solution provides quality control with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-security-system-legal-1-b6140c96',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Security System - Legal #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Autonomous Security System - Legal #1. Our solution provides quality control with enterprise-grade reliability and security.
          </p>
