...
export const metadata: Metadata = {
  title: 'Intelligent Processor for Hospitality',
  description: 'Unlock unprecedented growth with Intelligent Processor for Hospitality. This autonomous system provides employee engagement with zero manual intervention needed',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-processor-for-hospitality-055f0edf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Processor for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Processor for Hospitality. This autonomous system provides employee engagement with zero manual intervention needed.
          </p>
