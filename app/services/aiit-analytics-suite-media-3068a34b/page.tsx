...
export const metadata: Metadata = {
  title: 'AI/IT Analytics Suite - Media',
  description: 'Quantum leap forward for media: AI/IT Analytics Suite - Media. Uses quantum-inspired algorithms to deliver leave management at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-analytics-suite-media-3068a34b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Analytics Suite - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for media: AI/IT Analytics Suite - Media. Uses quantum-inspired algorithms to deliver leave management at exponential speed.
          </p>
