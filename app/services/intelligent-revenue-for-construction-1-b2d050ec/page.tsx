...
export const metadata: Metadata = {
  title: 'Intelligent Revenue for Construction #1',
  description: 'Optimize your construction workflows with Intelligent Revenue for Construction #1. This intelligent platform delivers logistics route optimization through advan',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-revenue-for-construction-1-b2d050ec',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Revenue for Construction #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Intelligent Revenue for Construction #1. This intelligent platform delivers logistics route optimization through advanced automation and AI.
          </p>
