...
export const metadata: Metadata = {
  title: 'Intelligent Decision for HEALTHTECH',
  description: 'Drive innovation in healthtech with Intelligent Decision for HEALTHTECH. This AI-powered platform transforms learning management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-decision-for-healthtech-f4976c05',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Decision for HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthtech with Intelligent Decision for HEALTHTECH. This AI-powered platform transforms learning management into a competitive advantage.
          </p>
