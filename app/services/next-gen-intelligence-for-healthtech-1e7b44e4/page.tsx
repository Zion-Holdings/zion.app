...
export const metadata: Metadata = {
  title: 'Next-Gen Intelligence for HEALTHTECH',
  description: 'Next-generation healthtech solution: Next-Gen Intelligence for HEALTHTECH. Combines security monitoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-intelligence-for-healthtech-1e7b44e4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Intelligence for HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthtech solution: Next-Gen Intelligence for HEALTHTECH. Combines security monitoring with adaptive intelligence for optimal results.
          </p>
