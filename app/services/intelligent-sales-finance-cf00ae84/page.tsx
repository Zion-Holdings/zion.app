...
export const metadata: Metadata = {
  title: 'Intelligent sales-finance',
  description: 'Next-generation finance solution: Intelligent sales-finance. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-sales-finance-cf00ae84',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent sales-finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation finance solution: Intelligent sales-finance. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
