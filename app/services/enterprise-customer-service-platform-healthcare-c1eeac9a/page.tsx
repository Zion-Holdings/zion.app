...
export const metadata: Metadata = {
  title: 'Enterprise Customer Service Platform - Healthcare',
  description: 'Transform your healthcare operations with our Enterprise Customer Service Platform - Healthcare. This AI-driven solution automates social media monitoring with ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-customer-service-platform-healthcare-c1eeac9a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Customer Service Platform - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Enterprise Customer Service Platform - Healthcare. This AI-driven solution automates social media monitoring with unprecedented accuracy and efficiency.
          </p>
