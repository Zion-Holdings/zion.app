...
export const metadata: Metadata = {
  title: 'Autonomous data-construction',
  description: 'Revolutionize construction through intelligent automation. Our Autonomous data-construction leverages advanced machine learning to deliver logistics route optim',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-data-construction-e5af124c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous data-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Autonomous data-construction leverages advanced machine learning to deliver logistics route optimization at scale.
          </p>
