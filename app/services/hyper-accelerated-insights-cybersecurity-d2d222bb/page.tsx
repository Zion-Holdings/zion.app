...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Insights - Cybersecurity',
  description: 'Next-generation cybersecurity solution: Hyper-Accelerated Insights - Cybersecurity. Combines competitive intelligence with adaptive intelligence for optimal res',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/hyper-accelerated-insights-cybersecurity-d2d222bb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Insights - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation cybersecurity solution: Hyper-Accelerated Insights - Cybersecurity. Combines competitive intelligence with adaptive intelligence for optimal results.
          </p>
