...
export const metadata: Metadata = {
  title: 'Cognitive System for Education',
  description: 'Next-generation education solution: Cognitive System for Education. Combines user experience with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-system-for-education-ae0d3110',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive System for Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation education solution: Cognitive System for Education. Combines user experience with adaptive intelligence for optimal results.
          </p>
