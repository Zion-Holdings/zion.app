...
export const metadata: Metadata = {
  title: 'Autonomous Computer Vision System - Insurance',
  description: 'Enhance your insurance business with Autonomous Computer Vision System - Insurance. Our solution provides disaster recovery with enterprise-grade reliability an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-computer-vision-system-insurance-166dfefd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Computer Vision System - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Autonomous Computer Vision System - Insurance. Our solution provides disaster recovery with enterprise-grade reliability and security.
          </p>
