...
export const metadata: Metadata = {
  title: 'AI Manager - Hospitality Edition #3',
  description: 'Transform your hospitality operations with our AI Manager - Hospitality Edition #3. This AI-driven solution automates generative ai with unprecedented accuracy ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-manager-hospitality-edition-3-5ee9e781',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Manager - Hospitality Edition #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our AI Manager - Hospitality Edition #3. This AI-driven solution automates generative ai with unprecedented accuracy and efficiency.
          </p>
