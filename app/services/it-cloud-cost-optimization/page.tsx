...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'IT Cloud Cost Optimization Service', 'description': 'Comprehensive cloud cost analysis and optimization for AWS, Azure, and GCP. Identifies waste, recommends right-sizing, manages reserved instances, and implements FinOps best practices to reduce cloud spend by 30-50%.', 'serviceType': 'it', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'technology'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'IT Cloud Cost Optimization Service Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$2,500/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$5,000/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': 'Custom', 'priceCurrency': 'USD'}]}} />
    <JsonLd data={'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'Multi-cloud cost analysis (AWS, Azure, GCP)', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Multi-cloud cost analysis (AWS, Azure, GCP)'}}, {'@type': 'Question', 'name': 'Idle resource detection and auto-remediation', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Idle resource detection and auto-remediation'}}, {'@type': 'Question', 'name': 'Reserved instance and savings plan management', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Reserved instance and savings plan management'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Reduce cloud spend by 30-50% within 90 days; Eliminate waste from idle and over-provisioned resources; Implement FinOps culture with team accountability'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} />
