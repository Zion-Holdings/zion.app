...
export const metadata: Metadata = {
  title: 'Security Autonomous - Insurance',
  description: 'Next-generation insurance solution: Security Autonomous - Insurance. Combines quality control with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-autonomous-insurance-7df20af9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Autonomous - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Security Autonomous - Insurance. Combines quality control with adaptive intelligence for optimal results.
          </p>
