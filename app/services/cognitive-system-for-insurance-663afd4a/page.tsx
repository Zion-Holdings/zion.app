...
export const metadata: Metadata = {
  title: 'Cognitive System for Insurance',
  description: 'Next-generation insurance solution: Cognitive System for Insurance. Combines supply chain with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-system-for-insurance-663afd4a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive System for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Cognitive System for Insurance. Combines supply chain with adaptive intelligence for optimal results.
          </p>
