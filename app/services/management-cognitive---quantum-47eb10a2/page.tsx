...
export const metadata: Metadata = {
  title: 'Management Cognitive - Quantum',
  description: 'The future of quantum is here with Management Cognitive - Quantum. Powered by cutting-edge AI, this platform delivers document processing like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/management-cognitive---quantum-47eb10a2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Management Cognitive - Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of quantum is here with Management Cognitive - Quantum. Powered by cutting-edge AI, this platform delivers document processing like never before.
          </p>
