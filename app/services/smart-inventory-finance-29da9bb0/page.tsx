...
export const metadata: Metadata = {
  title: 'Smart Inventory Finance',
  description: 'Unlock unprecedented growth with Smart Inventory Finance. This autonomous system provides logistics route optimization with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-inventory-finance-29da9bb0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Inventory Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Inventory Finance. This autonomous system provides logistics route optimization with zero manual intervention needed.
          </p>
