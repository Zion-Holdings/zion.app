...
export const metadata: Metadata = {
  title: 'Intelligent Intelligent for Logistics',
  description: 'Enhance your logistics business with Intelligent Intelligent for Logistics. Our solution provides language processing with enterprise-grade reliability and secu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-intelligent-for-logistics-9816417d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Intelligent for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with Intelligent Intelligent for Logistics. Our solution provides language processing with enterprise-grade reliability and security.
          </p>
