...
export const metadata: Metadata = {
  ...
  keywords: 'Natural language to JSX/TSX component generation, Tailwind CSS class application, Responsive breakpoint handling, A11y attributes (aria-* roles & labels), Export to Figma/Storybook format, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Powered UI Generator (Text-to-UI)</h1>
        <p className="text-lg text-slate-300 mb-8">Turn natural language descriptions into production-ready React/Next.js components with Tailwind styling; customize variants, states, and accessibility attributes via chat.</p>
        ...
        <li class="text-slate-300">Natural language to JSX/TSX component generation</li>
        <li class="text-slate-300">Tailwind CSS class application</li>
        <li class="text-slate-300">Responsive breakpoint handling</li>
        <li class="text-slate-300">A11y attributes (aria-* roles &amp; labels)</li>
        <li class="text-slate-300">Export to Figma/Storybook format</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai-powered ui generator (text-to-ui)</li>
