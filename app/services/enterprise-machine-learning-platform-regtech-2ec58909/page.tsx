...
export const metadata: Metadata = {
  title: 'Enterprise Machine Learning Platform - REGTECH',
  description: 'Next-generation regtech solution: Enterprise Machine Learning Platform - REGTECH. Combines lead scoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-machine-learning-platform-regtech-2ec58909',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Machine Learning Platform - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation regtech solution: Enterprise Machine Learning Platform - REGTECH. Combines lead scoring with adaptive intelligence for optimal results.
          </p>
