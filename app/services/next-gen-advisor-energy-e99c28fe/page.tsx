...
export const metadata: Metadata = {
  title: 'Next-Gen Advisor - Energy',
  description: 'The future of energy is here with Next-Gen Advisor - Energy. Powered by cutting-edge AI, this platform delivers quality assurance like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-advisor-energy-e99c28fe',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Advisor - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Next-Gen Advisor - Energy. Powered by cutting-edge AI, this platform delivers quality assurance like never before.
          </p>
