...
export const metadata: Metadata = {
  title: 'AI-Powered Campaign Support',
  description: 'Transform your gaming operations with our AI-Powered Campaign Support. This AI-driven solution automates sentiment analysis with unprecedented accuracy and effi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-campaign-support-d61ae6fa',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your gaming operations with our AI-Powered Campaign Support. This AI-driven solution automates sentiment analysis with unprecedented accuracy and efficiency.
          </p>
