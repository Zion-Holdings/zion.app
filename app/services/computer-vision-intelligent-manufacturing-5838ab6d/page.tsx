...
export const metadata: Metadata = {
  title: 'Computer Vision Intelligent - Manufacturing',
  description: 'Drive innovation in manufacturing with Computer Vision Intelligent - Manufacturing. This AI-powered platform transforms resource utilization into a competitive ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in manufacturing with Computer Vision Intelligent - Manufacturing. This AI-powered platform transforms resource utilization into a competitive advantage.
          </p>
