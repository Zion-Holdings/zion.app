...
export const metadata: Metadata = {
  title: 'Enterprise Sales Platform - Finance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Sales Platform - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your finance business with Enterprise Sales Platform - Finance. Our solution provides supply visibility with enterprise-grade reliability and security.
          </p>
