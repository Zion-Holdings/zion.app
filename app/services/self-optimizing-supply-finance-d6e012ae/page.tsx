...
export const metadata: Metadata = {
  title: 'Self-Optimizing supply-finance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing supply-finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in finance with Self-Optimizing supply-finance. This AI-powered platform transforms testing automation into a competitive advantage.
          </p>
