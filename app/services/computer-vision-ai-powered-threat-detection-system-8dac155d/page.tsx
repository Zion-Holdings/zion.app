...
export const metadata: Metadata = {
  title: 'Computer Vision AI-Powered Threat Detection System',
  description: 'computer vision solution for infrastructure industry. Real-time threat detection using behavioral analysis, anomaly detection, and machine learning.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/computer-vision-ai-powered-threat-detection-system-8dac155d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Computer Vision AI-Powered Threat Detection System
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            computer vision solution for infrastructure industry. Real-time threat detection using behavioral analysis, anomaly detection, and machine learning.
          </p>
