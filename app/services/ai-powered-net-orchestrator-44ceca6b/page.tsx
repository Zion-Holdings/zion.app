...
export const metadata: Metadata = {
  title: 'AI-Powered Net Orchestrator',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Net Orchestrator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with AI-Powered Net Orchestrator. This autonomous system provides procurement automation with zero manual intervention needed.
          </p>
