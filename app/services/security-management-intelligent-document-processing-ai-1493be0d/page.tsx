...
export const metadata: Metadata = {
  title: 'Security Management Intelligent Document Processing AI',
  description: 'security management solution for water & wastewater industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-management-intelligent-document-processing-ai-1493be0d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Management Intelligent Document Processing AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            security management solution for water & wastewater industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.
          </p>
