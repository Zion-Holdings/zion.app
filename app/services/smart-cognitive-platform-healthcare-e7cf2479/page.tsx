...
export const metadata: Metadata = {
  title: 'Smart Cognitive Platform - Healthcare',
  description: 'The future of healthcare is here with Smart Cognitive Platform - Healthcare. Powered by cutting-edge AI, this platform delivers testing automation like never be',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-cognitive-platform-healthcare-e7cf2479',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Cognitive Platform - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Smart Cognitive Platform - Healthcare. Powered by cutting-edge AI, this platform delivers testing automation like never before.
          </p>
