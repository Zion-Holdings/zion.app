...
export const metadata: Metadata = {
  title: 'Smart Risk Marketing',
  description: 'Next-generation insurance solution: Smart Risk Marketing. Combines healthcare data analytics with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-risk-marketing-da3c0205',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Risk Marketing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Smart Risk Marketing. Combines healthcare data analytics with adaptive intelligence for optimal results.
          </p>
