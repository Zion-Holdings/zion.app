export const metadata = {
  title: "Autonomous Risk System - Legal",
  description: "Zion Tech Group delivers Autonomous Risk System - Legal with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/services/autonomous-risk-system-legal-e0985ae4/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>Autonomous Risk System - Legal</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers Autonomous Risk System - Legal with measurable outcomes.
      </p>
