...
export const metadata: Metadata = {
  title: 'Smart Deep Learning Platform - Healthcare #1',
  description: 'Drive innovation in healthcare with Smart Deep Learning Platform - Healthcare #1. This AI-powered platform transforms recruitment automation into a competitive ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-deep-learning-platform-healthcare-1-8a67a6af',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Deep Learning Platform - Healthcare #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with Smart Deep Learning Platform - Healthcare #1. This AI-powered platform transforms recruitment automation into a competitive advantage.
          </p>
