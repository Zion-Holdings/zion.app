...
export const metadata: Metadata = {
  ...
  keywords: 'Multimodal sensor fusion across vibration, thermal, acoustic, and current sensors, Remaining-Useful-Life distribution with three-severity flag per asset, Plain-English root-cause description with part and vendor recommendation, HSE safety-risk layer assessed before scheduling any maintenance work, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Predictive Maintenance Advisor</h1>
        <p className="text-lg text-slate-300 mb-8">Asset remaining useful life prediction via multimodal sensor fusion — vibration, thermal, acoustic, and electrical. Plain-English root-cause narration, part recommendation, and HSE safety-risk layer for maintenance managers.</p>
        ...
        <li class="text-slate-300">Multimodal sensor fusion across vibration, thermal, acoustic, and current sensors</li>
        <li class="text-slate-300">Remaining-Useful-Life distribution with three-severity flag per asset</li>
        <li class="text-slate-300">Plain-English root-cause description with part and vendor recommendation</li>
        <li class="text-slate-300">HSE safety-risk layer assessed before scheduling any maintenance work</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with predictive maintenance advisor</li>
