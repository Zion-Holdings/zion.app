...
export const metadata: Metadata = {
  title: 'Smart Risk Platform - Media',
  description: 'Drive innovation in media with Smart Risk Platform - Media. This AI-powered platform transforms influencer identification into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-risk-platform-media-1d9d481e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Risk Platform - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in media with Smart Risk Platform - Media. This AI-powered platform transforms influencer identification into a competitive advantage.
          </p>
