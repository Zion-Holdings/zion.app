...
export const metadata: Metadata = {
  title: 'Machine Learning Intelligent - Construction',
  description: 'Next-generation construction solution: Machine Learning Intelligent - Construction. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/machine-learning-intelligent-construction-cf0b4e0a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Machine Learning Intelligent - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Machine Learning Intelligent - Construction. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
