...
export const metadata: Metadata = {
  title: 'AI Startup - Cybersecurity Edition',
  description: 'Optimize your cybersecurity workflows with AI Startup - Cybersecurity Edition. This intelligent platform delivers project management through advanced automation',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Startup - Cybersecurity Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your cybersecurity workflows with AI Startup - Cybersecurity Edition. This intelligent platform delivers project management through advanced automation and AI.
          </p>
