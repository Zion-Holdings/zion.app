...
export const metadata: Metadata = {
  title: 'Engagement AI-Powered Data Privacy',
  description: 'AI-powered engagement solution for compliance. GDPR/CCPA compliance automation with automated data redaction.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/engagement-ai-powered-data-privacy-d0f4e5bc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Engagement AI-Powered Data Privacy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered engagement solution for compliance. GDPR/CCPA compliance automation with automated data redaction.
          </p>
