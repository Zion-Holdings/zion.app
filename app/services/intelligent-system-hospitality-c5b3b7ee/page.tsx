...
export const metadata: Metadata = {
  title: 'Intelligent system-hospitality',
  description: 'The future of hospitality is here with Intelligent system-hospitality. Powered by cutting-edge AI, this platform delivers logistics route optimization like neve',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-system-hospitality-c5b3b7ee',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent system-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Intelligent system-hospitality. Powered by cutting-edge AI, this platform delivers logistics route optimization like never before.
          </p>
