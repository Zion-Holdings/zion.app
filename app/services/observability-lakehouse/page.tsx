...
export const metadata: Metadata = {
  ...
  keywords: 'Metrics + traces + logs + events in single Iceberg format, OpenMetadata catalog + lineage per signal type, Standard SQL query across all observability data, Per-signal retention (hours to years), Built-in aggregations + rollups for dashboarding, data, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Observability Data Lakehouse</h1>
        <p className="text-lg text-slate-300 mb-8">Unified observability: metrics, traces, logs, events in one Iceberg-format lakehouse. OpenMetadata catalog, standard SQL across all signals. Retention hours to years per data class.</p>
        ...
        <li class="text-slate-300">Metrics + traces + logs + events in single Iceberg format</li>
        <li class="text-slate-300">OpenMetadata catalog + lineage per signal type</li>
        <li class="text-slate-300">Standard SQL query across all observability data</li>
        <li class="text-slate-300">Per-signal retention (hours to years)</li>
        <li class="text-slate-300">Built-in aggregations + rollups for dashboarding</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with observability data lakehouse</li>
