      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Automatically migrate legacy codebases to modern frameworks (COBOL → Java, jQuery → React, Python 2 → Python 3) with AI-assisted refactoring.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Automated code translation</li>
            <li className="text-purple-300">✓ Dependency analysis and mapping</li>
            <li className="text-purple-300">✓ Test generation and validation</li>
            <li className="text-purple-300">✓ Incremental migration planning</li>
            <li className="text-purple-300">✓ Code quality scoring post-migration</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai code migration & modernization</li>
