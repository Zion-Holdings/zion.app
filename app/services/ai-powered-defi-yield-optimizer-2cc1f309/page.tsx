...
export const metadata: Metadata = {
  title: "Service - AI-Powered Web3 Solution",
  description: "Optimizes DeFi portfolio yields using AI-driven strategy selection and risk management.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-defi-yield-optimizer-2cc1f309",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Service - AI-Powered Web3 Solution
        </h1>
