...
export const metadata: Metadata = {
  title: 'Smart Support Suite - Startup',
  description: 'Transform your startup operations with our Smart Support Suite - Startup. This AI-driven solution automates predictive modeling with unprecedented accuracy and ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Support Suite - Startup
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your startup operations with our Smart Support Suite - Startup. This AI-driven solution automates predictive modeling with unprecedented accuracy and efficiency.
          </p>
