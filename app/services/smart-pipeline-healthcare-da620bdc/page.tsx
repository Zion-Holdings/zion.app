...
export const metadata: Metadata = {
  title: 'Smart Pipeline Healthcare',
  description: 'The future of construction is here with Smart Pipeline Healthcare. Powered by cutting-edge AI, this platform delivers capacity management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-pipeline-healthcare-da620bdc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Pipeline Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Smart Pipeline Healthcare. Powered by cutting-edge AI, this platform delivers capacity management like never before.
          </p>
