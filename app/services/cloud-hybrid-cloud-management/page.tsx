...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Hybrid Cloud Management Platform | Zion Tech Group",
    description: "Unified management across on-premises, private, and public cloud infrastructure.",
    url: "https://ziontechgroup.com/services/cloud-hybrid-cloud-management/",
    type: 'website',
  },
  alternates: { canonical: "/services/cloud-hybrid-cloud-management/" },
};

export default function CloudHybridCloudManagementPage() {
  return (
    <StandardPage
      title="Hybrid Cloud Management Platform"
      subtitle="Unified management across on-premises, private, and public cloud infrastructure."
      breadcrumbItems={[
        { label: "Home", href: "/" },
    ...
    >
      ...
      <p className="text-slate-500 text-sm max-w-5xl mx-auto">Restored from a Wayback Machine snapshot (20260614140348) of ziontechgroup.com.</p>
    </StandardPage>
  );
}
