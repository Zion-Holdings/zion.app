...
export const metadata: Metadata = {
  title: 'Adaptive Supply for Sports',
  description: 'Next-generation sports solution: Adaptive Supply for Sports. Combines financial planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-supply-for-sports-8deef510',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Supply for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation sports solution: Adaptive Supply for Sports. Combines financial planning with adaptive intelligence for optimal results.
          </p>
