...
export const metadata: Metadata = {
  title: 'AI/IT Suite Suite - Automotive',
  description: 'Drive innovation in automotive with AI/IT Suite Suite - Automotive. This AI-powered platform transforms risk management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-suite-suite-automotive-c924caf3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Suite Suite - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in automotive with AI/IT Suite Suite - Automotive. This AI-powered platform transforms risk management into a competitive advantage.
          </p>
