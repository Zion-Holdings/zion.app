...
export const metadata: Metadata = {
  title: 'Smart HR Recruitment Python (Education)',
  description: 'Smart HR Recruitment Python (Education) is an AI-powered education solution that transforms how businesses operate through intelligent automation and real-time ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-hr-recruitment-python-(e-6aaa07',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart HR Recruitment Python (Education)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Smart HR Recruitment Python (Education) is an AI-powered education solution that transforms how businesses operate through intelligent automation and real-time analytics.
