...
export const metadata: Metadata = {
  title: 'Cognitive Healthcare Process Mining',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Healthcare Process Mining
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your telecom workflows with Cognitive Healthcare Process Mining. This intelligent platform delivers supply chain through advanced automation and AI.
          </p>
