...
export const metadata: Metadata = {
  title: 'Automated intelligence-finance',
  description: 'The future of finance is here with Automated intelligence-finance. Powered by cutting-edge AI, this platform delivers risk assessment like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-intelligence-finance-7abc3c37',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated intelligence-finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of finance is here with Automated intelligence-finance. Powered by cutting-edge AI, this platform delivers risk assessment like never before.
          </p>
