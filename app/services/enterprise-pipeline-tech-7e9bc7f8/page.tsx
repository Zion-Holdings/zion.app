...
export const metadata: Metadata = {
  title: 'Enterprise Pipeline - Tech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Pipeline - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation technology solution: Enterprise Pipeline - Tech. Combines forecast accuracy with adaptive intelligence for optimal results.
          </p>
