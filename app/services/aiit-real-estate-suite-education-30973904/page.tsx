...
export const metadata: Metadata = {
  title: 'AI/IT Real Estate Suite - Education',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Real Estate Suite - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for education: AI/IT Real Estate Suite - Education. Uses quantum-inspired algorithms to deliver market analysis at exponential speed.
          </p>
