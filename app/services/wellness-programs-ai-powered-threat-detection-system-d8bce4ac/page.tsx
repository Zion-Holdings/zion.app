...
export const metadata: Metadata = {
  title: 'Wellness Programs AI-Powered Threat Detection System',
  description: 'wellness programs solution for public safety industry. Real-time threat detection using behavioral analysis, anomaly detection, and machine learning.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/wellness-programs-ai-powered-threat-detection-system-d8bce4ac',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Wellness Programs AI-Powered Threat Detection System
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            wellness programs solution for public safety industry. Real-time threat detection using behavioral analysis, anomaly detection, and machine learning.
          </p>
