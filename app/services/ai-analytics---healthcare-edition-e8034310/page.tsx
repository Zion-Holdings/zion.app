...
export const metadata: Metadata = {
  title: 'AI Analytics - Healthcare Edition',
  description: 'Transform your healthcare operations with our AI Analytics - Healthcare Edition. This AI-driven solution automates risk assessment with unprecedented accuracy a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Analytics - Healthcare Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our AI Analytics - Healthcare Edition. This AI-driven solution automates risk assessment with unprecedented accuracy and efficiency.
          </p>
