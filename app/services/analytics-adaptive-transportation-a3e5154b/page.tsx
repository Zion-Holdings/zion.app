...
export const metadata: Metadata = {
  title: 'Analytics Adaptive - Transportation',
  description: 'Optimize your transportation workflows with Analytics Adaptive - Transportation. This intelligent platform delivers document processing through advanced automat',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/analytics-adaptive-transportation-a3e5154b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Analytics Adaptive - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Analytics Adaptive - Transportation. This intelligent platform delivers document processing through advanced automation and AI.
          </p>
