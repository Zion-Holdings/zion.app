...
export const metadata: Metadata = {
  title: 'AI-Driven Finance for Hospitality',
  description: 'Drive innovation in hospitality with AI-Driven Finance for Hospitality. This AI-powered platform transforms influencer identification into a competitive advanta',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-driven-finance-for-hospitality-59c1ab1d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Driven Finance for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with AI-Driven Finance for Hospitality. This AI-powered platform transforms influencer identification into a competitive advantage.
          </p>
