...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={@context: "https://schema.org", @type: "Service", name: "Container Security Lifecycle | Zion Tech Group", description: "End-to-end container security lifecycle services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/container-security-lifecycle-2026-7434/"} />
