...
export const metadata: Metadata = {
  ...
  description: 'crisis management solution for logistics industry. Optimizes supply chain operations using predictive analytics, demand forecasting, and route optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/crisis-management-ai-supply-chain-optimization-17e42cf2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            crisis management solution for logistics industry. Optimizes supply chain operations using predictive analytics, demand forecasting, and route optimization.
          </p>
