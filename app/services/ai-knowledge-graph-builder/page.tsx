      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Auto-build entity/relation graph from unstructured docs + structured DBs; SPARQL/GraphQL query; graph-visualisation frontend.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ NER (Named Entity Recognition) + relation extraction</li>
            <li className="text-purple-300">✓ Graph schema auto-generated from data</li>
            <li className="text-purple-300">✓ SPARQL + GraphQL dual query layer</li>
            <li className="text-purple-300">✓ Neo4j/TypeDB graph store + schema management</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with knowledge graph builder</li>
