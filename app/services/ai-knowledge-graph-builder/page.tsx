...
export const metadata: Metadata = {
  ...
  keywords: 'NER (Named Entity Recognition) + relation extraction, Graph schema auto-generated from data, SPARQL + GraphQL dual query layer, Neo4j/TypeDB graph store + schema management, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Knowledge Graph Builder</h1>
        <p className="text-lg text-slate-300 mb-8">Auto-build entity/relation graph from unstructured docs + structured DBs; SPARQL/GraphQL query; graph-visualisation frontend.</p>
        ...
        <li class="text-slate-300">NER (Named Entity Recognition) + relation extraction</li>
        <li class="text-slate-300">Graph schema auto-generated from data</li>
        <li class="text-slate-300">SPARQL + GraphQL dual query layer</li>
        <li class="text-slate-300">Neo4j/TypeDB graph store + schema management</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with knowledge graph builder</li>
