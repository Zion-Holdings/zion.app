...
export const metadata: Metadata = {
  title: 'Autonomous Strategic System - Telecom',
  description: 'Optimize your telecom workflows with Autonomous Strategic System - Telecom. This intelligent platform delivers customer intelligence through advanced automation',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Strategic System - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your telecom workflows with Autonomous Strategic System - Telecom. This intelligent platform delivers customer intelligence through advanced automation and AI.
          </p>
