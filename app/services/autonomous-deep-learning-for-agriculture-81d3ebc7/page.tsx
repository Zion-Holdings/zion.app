...
export const metadata: Metadata = {
  title: 'Autonomous Deep Learning for Agriculture',
  description: 'Drive innovation in agriculture with Autonomous Deep Learning for Agriculture. This AI-powered platform transforms manufacturing quality control into a competit',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-deep-learning-for-agriculture-81d3ebc7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Deep Learning for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in agriculture with Autonomous Deep Learning for Agriculture. This AI-powered platform transforms manufacturing quality control into a competitive advantage.
          </p>
