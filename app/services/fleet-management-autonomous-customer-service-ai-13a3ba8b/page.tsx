...
export const metadata: Metadata = {
  ...
  description: 'fleet management solution for  venture capital industry. Fully automated customer support system that handles 80% of inquiries without human intervention.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/fleet-management-autonomous-customer-service-ai-13a3ba8b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Fleet Management Autonomous Customer Service AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            fleet management solution for  venture capital industry. Fully automated customer support system that handles 80% of inquiries without human intervention.
          </p>
