...
export const metadata: Metadata = {
  title: 'AI-Powered Real Estate Predictive Analytics',
  description: 'AI-powered real estate solution leveraging advanced machine learning for optimal performance and ROI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-real-estate-predictive-analytics-169d956e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Real Estate Predictive Analytics
          </h1>
