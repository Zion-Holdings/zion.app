...
export const metadata: Metadata = {
  ...
  keywords: 'Curriculum-aligned (Common Core, IB, AP), Progress dashboards for parents/teachers, Multilingual support (25 languages), Plagiarism-resistant homework assistance, ai, Education, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI 1:1 Tutor for K–12 &amp; Higher Ed</h1>
        <p className="text-lg text-slate-300 mb-8">Personalized learning companion that adapts to student\</p>
        ...
        <li class="text-slate-300">Curriculum-aligned (Common Core, IB, AP)</li>
        <li class="text-slate-300">Progress dashboards for parents/teachers</li>
        <li class="text-slate-300">Multilingual support (25 languages)</li>
        <li class="text-slate-300">Plagiarism-resistant homework assistance</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai 1:1 tutor for k–12 &amp; higher ed</li>
