      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Personalized learning companion that adapts to student\
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Curriculum-aligned (Common Core, IB, AP)</li>
            <li className="text-purple-300">✓ Progress dashboards for parents/teachers</li>
            <li className="text-purple-300">✓ Multilingual support (25 languages)</li>
            <li className="text-purple-300">✓ Plagiarism-resistant homework assistance</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai 1:1 tutor for k–12 & higher ed</li>
