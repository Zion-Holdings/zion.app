...
export const metadata: Metadata = {
  title: 'Next-Gen Compliance for Saas',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Compliance for Saas
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of saaS is here with Next-Gen Compliance for Saas. Powered by cutting-edge AI, this platform delivers workflow management like never before.
          </p>
