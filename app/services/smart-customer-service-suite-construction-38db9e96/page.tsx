...
export const metadata: Metadata = {
  title: 'Smart Customer Service Suite - Construction',
  description: 'Revolutionize construction through intelligent automation. Our Smart Customer Service Suite - Construction leverages advanced machine learning to deliver invoic',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-customer-service-suite-construction-38db9e96',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Customer Service Suite - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Smart Customer Service Suite - Construction leverages advanced machine learning to deliver invoice processing at scale.
          </p>
