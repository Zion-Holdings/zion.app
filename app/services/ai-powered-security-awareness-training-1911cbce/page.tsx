...
export const metadata: Metadata = {
  title: 'AI-Powered Security Awareness Training',
  description: 'Creates personalized security training content based on user roles and risk profiles.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-security-awareness-training-1911cbce',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Creates personalized security training content based on user roles and risk profiles.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Training generation</li>
          <li className="text-gray-300">Role-based content</li>
          <li className="text-gray-300">Phishing simulations</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">80% phishing reduction</li>
