...
export const metadata: Metadata = {
  title: 'Next-Gen Machine Learning for CLEANTECH',
  description: 'Unlock unprecedented growth with Next-Gen Machine Learning for CLEANTECH. This autonomous system provides personalization engine with zero manual intervention n',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-machine-learning-for-cleantech-0579a448',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Machine Learning for CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Next-Gen Machine Learning for CLEANTECH. This autonomous system provides personalization engine with zero manual intervention needed.
          </p>
