...
export const metadata: Metadata = {
  title: 'Automated Director for Sports',
  description: 'Transform your sports operations with our Automated Director for Sports. This AI-driven solution automates compliance monitoring with unprecedented accuracy and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-director-for-sports-1bfc4cb7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Director for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our Automated Director for Sports. This AI-driven solution automates compliance monitoring with unprecedented accuracy and efficiency.
          </p>
