...
export const metadata: Metadata = {
  ...
  keywords: 'Offline capabilities, Role-based access control, SOC 2 certified, Multi-region deployment, API-first design, GDPR compliance, insights, finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Suite - Finance Edition</h1>
        <p className="text-lg text-slate-300 mb-8">The future of finance is here with AI Suite - Finance Edition. Powered by cutting-edge AI, this platform delivers decision support like never before.</p>
