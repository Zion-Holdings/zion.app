...
export const metadata: Metadata = {
  title: 'Stream Processing Multi-Cloud Cost Management Platform',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Stream Processing Multi-Cloud Cost Management Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered stream processing solution for cloud operations. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.
          </p>
