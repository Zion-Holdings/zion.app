...
export const metadata: Metadata = {
  ...
  keywords: 'Personalized paths, Adaptive content, Progress tracking, Auto-assessment, Content recommendation, Learning analytics, Parent/teacher dashboards, Multi-language, ai, Education, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Adaptive Learning Platform</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered personalized learning that adapts to each student&#x27;s pace, style, and level. Content recommendations, progress tracking, and automated assessment.</p>
        ...
        <li class="text-slate-300">Personalized paths</li>
        <li class="text-slate-300">Adaptive content</li>
        <li class="text-slate-300">Progress tracking</li>
        <li class="text-slate-300">Auto-assessment</li>
        <li class="text-slate-300">Content recommendation</li>
        <li class="text-slate-300">Learning analytics</li>
        <li class="text-slate-300">Parent/teacher dashboards</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">3x faster learning</li>
        <li class="text-slate-300">90%+ completion</li>
        <li class="text-slate-300">Personalized engagement</li>
