...
export const metadata: Metadata = {
  title: 'Autonomous Revenue System - Insurance',
  description: 'The future of insurance is here with Autonomous Revenue System - Insurance. Powered by cutting-edge AI, this platform delivers succession planning like never be',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-revenue-system-insurance-4150cd80',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Revenue System - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Autonomous Revenue System - Insurance. Powered by cutting-edge AI, this platform delivers succession planning like never before.
          </p>
