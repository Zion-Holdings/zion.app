...
export const metadata: Metadata = {
  title: 'Intelligent Smart for Sports',
  description: 'Transform your sports operations with our Intelligent Smart for Sports. This AI-driven solution automates data governance with unprecedented accuracy and effici',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-smart-for-sports-6eb17389',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Smart for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our Intelligent Smart for Sports. This AI-driven solution automates data governance with unprecedented accuracy and efficiency.
          </p>
