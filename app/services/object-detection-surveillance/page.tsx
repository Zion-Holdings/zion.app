...
export const metadata: Metadata = {
  ...
  keywords: 'Person/vehicle/package detect, Loitering & perimeter alerts, License plate recognition, Behavior anomaly flagging, Privacy blur option, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Object Detection Surveillance</h1>
        <p className="text-lg text-slate-300 mb-8">Real-time AI video analytics for security cameras: person/vehicle detection, loitering alerts, license plate recognition, and behavior anomaly flagging.</p>
        ...
        <li class="text-slate-300">Person/vehicle/package detect</li>
        <li class="text-slate-300">Loitering &amp; perimeter alerts</li>
        <li class="text-slate-300">License plate recognition</li>
        <li class="text-slate-300">Behavior anomaly flagging</li>
        <li class="text-slate-300">Privacy blur option</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with object detection surveillance</li>
