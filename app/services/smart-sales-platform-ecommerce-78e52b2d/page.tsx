...
export const metadata: Metadata = {
  title: 'Smart Sales Platform - Ecommerce',
  description: 'Optimize your ecommerce workflows with Smart Sales Platform - Ecommerce. This intelligent platform delivers supply chain through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-sales-platform-ecommerce-78e52b2d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Sales Platform - Ecommerce
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your ecommerce workflows with Smart Sales Platform - Ecommerce. This intelligent platform delivers supply chain through advanced automation and AI.
          </p>
