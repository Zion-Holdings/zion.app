...
export const metadata: Metadata = {
  title: 'Automated API Gateway GCP (Automation)',
  description: 'Automated API Gateway GCP (Automation) is an AI-powered automation solution that transforms how businesses operate through intelligent automation and real-time ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated API Gateway GCP (Automation)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Automated API Gateway GCP (Automation) is an AI-powered automation solution that transforms how businesses operate through intelligent automation and real-time analytics.
