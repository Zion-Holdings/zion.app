...
export const metadata: Metadata = {
  title: 'Neural Insights for Construction',
  description: 'Next-generation construction solution: Neural Insights for Construction. Combines financial planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-insights-for-construction-1e09362a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Insights for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Neural Insights for Construction. Combines financial planning with adaptive intelligence for optimal results.
          </p>
