...
export const metadata: Metadata = {
  title: 'Enterprise Territory - Logistics',
  description: 'The future of logistics is here with Enterprise Territory - Logistics. Powered by cutting-edge AI, this platform delivers financial planning like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-territory-logistics-08a8824a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Territory - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Enterprise Territory - Logistics. Powered by cutting-edge AI, this platform delivers financial planning like never before.
          </p>
