...
export const metadata: Metadata = {
  title: 'Smart Inventory Platform - Hospitality',
  description: 'Future-proof your hospitality with Smart Inventory Platform - Hospitality. Our autonomous solution handles financial risk management end-to-end without human in',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-inventory-platform-hospitality-21c52a58',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Inventory Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your hospitality with Smart Inventory Platform - Hospitality. Our autonomous solution handles financial risk management end-to-end without human intervention.
          </p>
