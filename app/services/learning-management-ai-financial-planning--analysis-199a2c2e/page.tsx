...
export const metadata: Metadata = {
  title: 'Learning Management AI Financial Planning & Analysis',
  description: 'learning management solution for healthtech industry. Generates financial forecasts, budget plans, and performance analyses using machine learning models.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/learning-management-ai-financial-planning--analysis-199a2c2e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Learning Management AI Financial Planning & Analysis
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            learning management solution for healthtech industry. Generates financial forecasts, budget plans, and performance analyses using machine learning models.
          </p>
