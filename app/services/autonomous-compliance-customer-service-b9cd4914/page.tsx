...
export const metadata: Metadata = {
  title: 'Autonomous Compliance Customer Service',
  description: 'The future of sports is here with Autonomous Compliance Customer Service. Powered by cutting-edge AI, this platform delivers customer service automation like ne',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Compliance Customer Service
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Autonomous Compliance Customer Service. Powered by cutting-edge AI, this platform delivers customer service automation like never before.
          </p>
