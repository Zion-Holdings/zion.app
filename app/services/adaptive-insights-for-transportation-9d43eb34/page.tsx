...
export const metadata: Metadata = {
  title: 'Adaptive Insights for Transportation',
  description: 'Optimize your transportation workflows with Adaptive Insights for Transportation. This intelligent platform delivers financial planning through advanced automat',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-insights-for-transportation-9d43eb34',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Insights for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Adaptive Insights for Transportation. This intelligent platform delivers financial planning through advanced automation and AI.
          </p>
