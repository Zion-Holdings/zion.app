...
export const metadata: Metadata = {
  title: 'Adaptive Intelligence for Sports',
  description: 'The future of sports is here with Adaptive Intelligence for Sports. Powered by cutting-edge AI, this platform delivers logistics route optimization like never b',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-intelligence-for-sports-571b1150',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Intelligence for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Adaptive Intelligence for Sports. Powered by cutting-edge AI, this platform delivers logistics route optimization like never before.
          </p>
