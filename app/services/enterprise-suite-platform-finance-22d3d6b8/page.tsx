...
export const metadata: Metadata = {
  title: 'Enterprise Suite Platform - Finance',
  description: 'Revolutionize finance through intelligent automation. Our Enterprise Suite Platform - Finance leverages advanced machine learning to deliver brand monitoring at',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Suite Platform - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our Enterprise Suite Platform - Finance leverages advanced machine learning to deliver brand monitoring at scale.
          </p>
