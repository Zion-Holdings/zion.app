...
export const metadata: Metadata = {
  title: 'Smart devops-tech',
  description: 'Revolutionize technology through intelligent automation. Our Smart devops-tech leverages advanced machine learning to deliver financial risk management at scale',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-devops-tech-9a9f54b5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our Smart devops-tech leverages advanced machine learning to deliver financial risk management at scale.
          </p>
