...
export const metadata: Metadata = {
  title: 'Cognitive Management for Tech',
  description: 'The future of technology is here with Cognitive Management for Tech. Powered by cutting-edge AI, this platform delivers risk assessment like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-management-for-tech-b9c38c6d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Management for Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of technology is here with Cognitive Management for Tech. Powered by cutting-edge AI, this platform delivers risk assessment like never before.
          </p>
