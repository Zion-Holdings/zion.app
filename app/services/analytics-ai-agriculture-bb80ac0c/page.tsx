...
export const metadata: Metadata = {
  title: 'Analytics AI - Agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Analytics AI - Agriculture leverages advanced machine learning to deliver enterprise-grade insight',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/analytics-ai-agriculture-bb80ac0c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Analytics AI - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Analytics AI - Agriculture leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
