...
export const metadata: Metadata = {
  title: 'AI Scale-up - Agriculture Edition',
  description: 'Transform your agriculture operations with our AI Scale-up - Agriculture Edition. This AI-driven solution automates quality prediction with unprecedented accura',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-scale-up-agriculture-edition-567fddd0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Scale-up - Agriculture Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our AI Scale-up - Agriculture Edition. This AI-driven solution automates quality prediction with unprecedented accuracy and efficiency.
          </p>
