...
export const metadata: Metadata = {
  ...
  keywords: 'Adversarial Robustness & Red-Teaming, Prompt & Input Guardrails, Data Privacy & Confidentiality, Model Supply Chain Security, Fairness & Bias Mitigation, Incident Response & Recovery, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Security &amp; Responsible AI</h1>
        <p className="text-lg text-slate-300 mb-8">Secure AI systems and responsible deployment. Adversarial robustness, prompt injection defense, data privacy, and AI safety controls for enterprise...</p>
        ...
        <li class="text-slate-300">Adversarial Robustness &amp; Red-Teaming</li>
        <li class="text-slate-300">Prompt &amp; Input Guardrails</li>
        <li class="text-slate-300">Data Privacy &amp; Confidentiality</li>
        <li class="text-slate-300">Model Supply Chain Security</li>
        <li class="text-slate-300">Fairness &amp; Bias Mitigation</li>
        <li class="text-slate-300">Incident Response &amp; Recovery</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai security &amp; responsible ai</li>
