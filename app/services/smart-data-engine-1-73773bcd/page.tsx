...
export const metadata: Metadata = {
  title: 'Smart Data Engine #1',
  description: 'Drive innovation in hospitality with Smart Data Engine #1. This AI-powered platform transforms resource utilization into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-data-engine-1-73773bcd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Smart Data Engine #1. This AI-powered platform transforms resource utilization into a competitive advantage.
          </p>
