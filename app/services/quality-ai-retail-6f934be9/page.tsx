...
export const metadata: Metadata = {
  title: 'Quality AI - Retail',
  description: 'The future of retail is here with Quality AI - Retail. Powered by cutting-edge AI, this platform delivers image recognition like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quality-ai-retail-6f934be9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Quality AI - Retail. Powered by cutting-edge AI, this platform delivers image recognition like never before.
          </p>
