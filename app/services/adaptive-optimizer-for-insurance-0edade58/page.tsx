...
export const metadata: Metadata = {
  title: 'Adaptive Optimizer for Insurance',
  description: 'Enhance your insurance business with Adaptive Optimizer for Insurance. Our solution provides scenario planning with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-optimizer-for-insurance-0edade58',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Optimizer for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Adaptive Optimizer for Insurance. Our solution provides scenario planning with enterprise-grade reliability and security.
          </p>
