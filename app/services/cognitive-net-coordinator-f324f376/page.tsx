...
export const metadata: Metadata = {
  title: 'Cognitive Net Coordinator',
  description: 'Next-generation insurance solution: Cognitive Net Coordinator. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-net-coordinator-f324f376',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Net Coordinator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation insurance solution: Cognitive Net Coordinator. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
