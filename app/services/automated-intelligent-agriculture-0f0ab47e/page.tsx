...
export const metadata: Metadata = {
  title: 'Automated intelligent-agriculture',
  description: 'The future of agriculture is here with Automated intelligent-agriculture. Powered by cutting-edge AI, this platform delivers transformative results like never b',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-intelligent-agriculture-0f0ab47e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated intelligent-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Automated intelligent-agriculture. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
