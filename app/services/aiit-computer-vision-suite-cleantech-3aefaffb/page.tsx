...
export const metadata: Metadata = {
  title: 'AI/IT Computer Vision Suite - CLEANTECH',
  description: 'The future of cleantech is here with AI/IT Computer Vision Suite - CLEANTECH. Powered by cutting-edge AI, this platform delivers audit automation like never bef',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Computer Vision Suite - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of cleantech is here with AI/IT Computer Vision Suite - CLEANTECH. Powered by cutting-edge AI, this platform delivers audit automation like never before.
          </p>
