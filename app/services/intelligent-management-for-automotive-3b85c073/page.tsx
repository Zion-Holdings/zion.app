...
export const metadata: Metadata = {
  title: 'Intelligent Management for Automotive',
  description: 'Optimize your automotive workflows with Intelligent Management for Automotive. This intelligent platform delivers hr analytics through advanced automation and A',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Management for Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your automotive workflows with Intelligent Management for Automotive. This intelligent platform delivers hr analytics through advanced automation and AI.
          </p>
