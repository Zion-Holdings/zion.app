...
export const metadata: Metadata = {
  title: 'Smart Sales for Energy',
  description: 'Accelerate your energy initiatives with Smart Sales for Energy. Our solution combines lead scoring with enterprise-grade reliability.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-sales-for-energy-6c82753f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Sales for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Accelerate your energy initiatives with Smart Sales for Energy. Our solution combines lead scoring with enterprise-grade reliability.
          </p>
