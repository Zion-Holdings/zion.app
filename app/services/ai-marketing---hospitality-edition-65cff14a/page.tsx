...
export const metadata: Metadata = {
  title: 'AI Marketing - Hospitality Edition',
  description: 'Revolutionize hospitality through intelligent automation. Our AI Marketing - Hospitality Edition leverages advanced machine learning to deliver logistics route ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-marketing---hospitality-edition-65cff14a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Marketing - Hospitality Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our AI Marketing - Hospitality Edition leverages advanced machine learning to deliver logistics route optimization at scale.
          </p>
