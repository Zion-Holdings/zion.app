...
export const metadata: Metadata = {
  title: 'Cognitive Management Solution - Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Cognitive Management Solution - Healthcare leverages advanced machine learning to deliver expense m',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-management-solution-healthcare-3a8785c6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Management Solution - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Cognitive Management Solution - Healthcare leverages advanced machine learning to deliver expense management at scale.
          </p>
