...
export const metadata: Metadata = {
  title: 'Intelligent Optimizer for Hospitality',
  description: 'Transform your hospitality operations with our Intelligent Optimizer for Hospitality. This AI-driven solution automates energy management with unprecedented acc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-optimizer-for-hospitality-31ddecf8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Optimizer for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Intelligent Optimizer for Hospitality. This AI-driven solution automates energy management with unprecedented accuracy and efficiency.
          </p>
