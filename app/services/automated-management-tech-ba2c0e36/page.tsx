...
export const metadata: Metadata = {
  title: 'Automated management-tech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated management-tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation technology solution: Automated management-tech. Combines decision support with adaptive intelligence for optimal results.
          </p>
