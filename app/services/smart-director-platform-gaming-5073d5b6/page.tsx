...
export const metadata: Metadata = {
  title: 'Smart Director Platform - Gaming',
  description: 'Revolutionize gaming through intelligent automation. Our Smart Director Platform - Gaming leverages advanced machine learning to deliver supply visibility at sc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-director-platform-gaming-5073d5b6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Director Platform - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize gaming through intelligent automation. Our Smart Director Platform - Gaming leverages advanced machine learning to deliver supply visibility at scale.
          </p>
