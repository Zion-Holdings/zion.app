...
export const metadata: Metadata = {
  title: 'Cybersecurity Customer Data Platform AI',
  description: 'AI-powered cybersecurity solution for customer data. Unified customer data platform with AI-powered segmentation.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cybersecurity-customer-data-platform-ai-8d703d45',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cybersecurity Customer Data Platform AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered cybersecurity solution for customer data. Unified customer data platform with AI-powered segmentation.
          </p>
