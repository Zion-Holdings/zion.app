...
export const metadata: Metadata = {
  title: 'Cognitive Analytics Solution - Construction',
  description: 'Transform your construction operations with our Cognitive Analytics Solution - Construction. This AI-driven solution automates performance tuning with unprecede',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-analytics-solution-construction-d4ac67fd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Analytics Solution - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Cognitive Analytics Solution - Construction. This AI-driven solution automates performance tuning with unprecedented accuracy and efficiency.
          </p>
