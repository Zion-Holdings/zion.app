...
export const metadata: Metadata = {
  title: "AI-Powered AI Financial Planning & Analysis - AI-Powered Asset Management Solution",
  description: "ai-powered solution for asset management industry. Generates financial forecasts, budget plans, and performance analyses using machine learning models.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-ai-financial-planning--analysis-a4f08de4",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered AI Financial Planning & Analysis - AI-Powered Asset Management Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          ai-powered solution for asset management industry. Generates financial forecasts, budget plans, and performance analyses using machine learning models.
        </p>
