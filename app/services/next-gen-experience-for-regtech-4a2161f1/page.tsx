...
export const metadata: Metadata = {
  title: 'Next-Gen Experience for REGTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Experience for REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for regtech: Next-Gen Experience for REGTECH. Uses quantum-inspired algorithms to deliver serverless orchestration at exponential speed.
          </p>
