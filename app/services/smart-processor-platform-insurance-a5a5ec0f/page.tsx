...
export const metadata: Metadata = {
  title: 'Smart Processor Platform - Insurance',
  description: 'The future of insurance is here with Smart Processor Platform - Insurance. Powered by cutting-edge AI, this platform delivers supply chain like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-processor-platform-insurance-a5a5ec0f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Processor Platform - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Smart Processor Platform - Insurance. Powered by cutting-edge AI, this platform delivers supply chain like never before.
          </p>
