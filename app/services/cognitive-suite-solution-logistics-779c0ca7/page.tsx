...
export const metadata: Metadata = {
  title: 'Cognitive Suite Solution - Logistics',
  description: 'Transform your logistics operations with our Cognitive Suite Solution - Logistics. This AI-driven solution automates lead scoring with unprecedented accuracy an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-suite-solution-logistics-779c0ca7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Suite Solution - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Cognitive Suite Solution - Logistics. This AI-driven solution automates lead scoring with unprecedented accuracy and efficiency.
          </p>
