...
export const metadata: Metadata = {
  title: 'Next-Gen Decision for Healthcare',
  description: 'Drive innovation in healthcare with Next-Gen Decision for Healthcare. This AI-powered platform transforms quality control into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-decision-for-healthcare-a0bf3577',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Decision for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with Next-Gen Decision for Healthcare. This AI-powered platform transforms quality control into a competitive advantage.
          </p>
