...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Insights - Construction',
  description: 'Drive innovation in construction with Hyper-Accelerated Insights - Construction. This AI-powered platform transforms dashboard automation into a competitive adv',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/hyper-accelerated-insights-construction-ec30998f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Insights - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Hyper-Accelerated Insights - Construction. This AI-powered platform transforms dashboard automation into a competitive advantage.
          </p>
