...
export const metadata: Metadata = {
  ...
  description: 'Transform your real-estate operations with our Automated Quality for Real-Estate. This AI-driven solution provides intelligent automation with unprecedented acc',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Automated Quality for Real-Estate. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
