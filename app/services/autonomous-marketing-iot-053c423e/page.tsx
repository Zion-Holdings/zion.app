...
export const metadata: Metadata = {
  title: 'Autonomous marketing-iot',
  description: 'Transform your iot operations with our Autonomous marketing-iot. This AI-driven solution automates language processing with unprecedented accuracy and efficienc',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous marketing-iot
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your iot operations with our Autonomous marketing-iot. This AI-driven solution automates language processing with unprecedented accuracy and efficiency.
          </p>
