...
export const metadata: Metadata = {
  title: 'Next-Gen Manager for Telecom',
  description: 'Transform your telecom operations with our Next-Gen Manager for Telecom. This AI-driven solution automates api management with unprecedented accuracy and effici',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-manager-for-telecom-1d59663e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Manager for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your telecom operations with our Next-Gen Manager for Telecom. This AI-driven solution automates api management with unprecedented accuracy and efficiency.
          </p>
