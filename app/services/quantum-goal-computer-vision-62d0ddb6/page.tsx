...
export const metadata: Metadata = {
  title: 'Quantum Goal Computer Vision',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Goal Computer Vision
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation regtech solution: Quantum Goal Computer Vision. Combines document ai with adaptive intelligence for optimal results.
          </p>
