...
export const metadata: Metadata = {
  title: 'AI-Powered Advisor for Sports',
  description: 'The future of sports is here with AI-Powered Advisor for Sports. Powered by cutting-edge AI, this platform delivers performance monitoring like never before.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Advisor for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with AI-Powered Advisor for Sports. Powered by cutting-edge AI, this platform delivers performance monitoring like never before.
          </p>
