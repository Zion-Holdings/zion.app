...
export const metadata: Metadata = {
  title: 'Predictive Data Science Engine - Finance',
  description: 'The future of finance is here with Predictive Data Science Engine - Finance. Powered by cutting-edge AI, this platform delivers content moderation like never be',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Data Science Engine - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of finance is here with Predictive Data Science Engine - Finance. Powered by cutting-edge AI, this platform delivers content moderation like never before.
          </p>
