...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize finance through intelligent automation. Our AI NLP - Finance Edition leverages advanced machine learning to deliver audit trail management at scal',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our AI NLP - Finance Edition leverages advanced machine learning to deliver audit trail management at scale.
          </p>
