...
export const metadata: Metadata = {
  title: 'AI-Powered Brand Experience',
  description: 'Revolutionize cleantech through intelligent automation. Our AI-Powered Brand Experience leverages advanced machine learning to deliver customer intelligence at ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Brand Experience
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cleantech through intelligent automation. Our AI-Powered Brand Experience leverages advanced machine learning to deliver customer intelligence at scale.
          </p>
