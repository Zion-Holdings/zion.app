...
export const metadata: Metadata = {
  title: 'Autonomous Quality System - REGTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Quality System - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your regtech business with Autonomous Quality System - REGTECH. Our solution provides performance tracking with enterprise-grade reliability and security.
          </p>
