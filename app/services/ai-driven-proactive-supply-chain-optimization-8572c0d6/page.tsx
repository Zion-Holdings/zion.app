...
export const metadata: Metadata = {
  ...
  keywords: 'Demand forecasting, Inventory optimization, Supplier risk, Logistics planning, analytics, manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Driven Proactive Supply Chain Optimization</h1>
        <p className="text-lg text-slate-300 mb-8">End-to-end supply chain platform that uses proactive optimization algorithms for demand planning, inventory management, and logistics coordination.</p>
        ...
        <li class="text-slate-300">Supplier risk</li>
        <li class="text-slate-300">Logistics planning</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduced inventory costs</li>
        <li class="text-slate-300">Improved service levels</li>
        <li class="text-slate-300">Resilient supply chain</li>
        <li class="text-slate-300">Faster response</li>
      </ul>
        </div>
