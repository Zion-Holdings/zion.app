...
export const metadata: Metadata = {
  ...
  description: 'Unlock unprecedented growth with AI-Powered Logistics Platform. This autonomous system provides network optimization with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-logistics-platform-60f3dd94',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with AI-Powered Logistics Platform. This autonomous system provides network optimization with zero manual intervention needed.
          </p>
