...
export const metadata: Metadata = {
  title: 'Enterprise Customer for ALTHEALTH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Customer for ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for althealth: Enterprise Customer for ALTHEALTH. Uses quantum-inspired algorithms to deliver incident response at exponential speed.
          </p>
