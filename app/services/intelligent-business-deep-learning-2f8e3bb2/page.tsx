...
export const metadata: Metadata = {
  title: 'Intelligent Business Deep Learning',
  description: 'Transform your agriculture operations with our Intelligent Business Deep Learning. This AI-driven solution provides intelligent automation with unprecedented ac',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Business Deep Learning
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Intelligent Business Deep Learning. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
