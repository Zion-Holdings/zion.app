...
export const metadata: Metadata = {
  title: 'Smart suite-sports',
  description: 'Next-generation sports solution: Smart suite-sports. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-suite-sports-4eafcea8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation sports solution: Smart suite-sports. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
