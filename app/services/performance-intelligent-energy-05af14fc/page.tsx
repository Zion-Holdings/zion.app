...
export const metadata: Metadata = {
  title: 'Performance Intelligent - Energy',
  description: 'Next-generation energy solution: Performance Intelligent - Energy. Combines sales forecasting with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/performance-intelligent-energy-05af14fc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Performance Intelligent - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Performance Intelligent - Energy. Combines sales forecasting with adaptive intelligence for optimal results.
          </p>
