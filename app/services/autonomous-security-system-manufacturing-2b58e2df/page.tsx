...
export const metadata: Metadata = {
  title: 'Autonomous Security System - Manufacturing',
  description: 'Optimize your manufacturing workflows with Autonomous Security System - Manufacturing. This intelligent platform delivers anomaly detection through advanced aut',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-security-system-manufacturing-2b58e2df',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Security System - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your manufacturing workflows with Autonomous Security System - Manufacturing. This intelligent platform delivers anomaly detection through advanced automation and AI.
          </p>
