...
export const metadata: Metadata = {
  title: 'Cognitive Advisor Solution - Insurance',
  description: 'Enhance your insurance business with Cognitive Advisor Solution - Insurance. Our solution provides inventory management with enterprise-grade reliability and se',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-advisor-solution-insurance-b1a70cef',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Advisor Solution - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Cognitive Advisor Solution - Insurance. Our solution provides inventory management with enterprise-grade reliability and security.
          </p>
