...
export const metadata: Metadata = {
  title: `AI Climate Risk Analytics | Zion Tech Group`,
  ...
  keywords: 'Physical risk modeling (flood, fire, storm), Transition risk analysis, Carbon footprint forecasting, TCFD and ISSB compliance reporting, Integration with geospatial data, Scenario analysis (1.5°C, 2°C, 3°C), Portfolio risk scoring, Executive dashboards, ai, Finance, Zion Tech Group',
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-climate-risk-analytics/`,
  },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Climate Risk Analytics</h1>
        <p className="text-lg text-slate-300 mb-8">Assess climate-related financial and operational risks using AI. Physical risk modeling, transition risk analysis, and TCFD-compliant reporting.</p>
        ...
        <li class="text-slate-300">Physical risk modeling (flood, fire, storm)</li>
        <li class="text-slate-300">Transition risk analysis</li>
        <li class="text-slate-300">Carbon footprint forecasting</li>
        <li class="text-slate-300">TCFD and ISSB compliance reporting</li>
        <li class="text-slate-300">Integration with geospatial data</li>
        <li class="text-slate-300">Scenario analysis (1.5°C, 2°C, 3°C)</li>
        <li class="text-slate-300">Portfolio risk scoring</li>
        <li class="text-slate-300">Executive dashboards</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Meet climate disclosure requirements</li>
        <li class="text-slate-300">Protect assets from physical risks</li>
        <li class="text-slate-300">Identify transition opportunities</li>
        <li class="text-slate-300">Investor-grade climate data</li>
      </ul>
        </div>
