...
export const metadata: Metadata = {
  title: 'Neural Cognitive for Healthcare',
  description: 'Transform your healthcare operations with our Neural Cognitive for Healthcare. This AI-driven solution automates resource utilization with unprecedented accurac',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Cognitive for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Neural Cognitive for Healthcare. This AI-driven solution automates resource utilization with unprecedented accuracy and efficiency.
          </p>
