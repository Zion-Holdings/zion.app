...
export const metadata: Metadata = {
  title: 'AI-Powered support-real-estate',
  description: 'Transform your real-estate operations with our AI-Powered support-real-estate. This AI-driven solution automates sourcing optimization with unprecedented accura',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-support-real-estate-1533eaf8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered support-real-estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our AI-Powered support-real-estate. This AI-driven solution automates sourcing optimization with unprecedented accuracy and efficiency.
          </p>
