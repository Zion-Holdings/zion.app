...
export const metadata: Metadata = {
  title: 'Intelligent Autonomous for Legal',
  description: 'Revolutionize legal through intelligent automation. Our Intelligent Autonomous for Legal leverages advanced machine learning to deliver pipeline management at s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-autonomous-for-legal-94c628e0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Autonomous for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Intelligent Autonomous for Legal leverages advanced machine learning to deliver pipeline management at scale.
          </p>
