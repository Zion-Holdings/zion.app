...
export const metadata: Metadata = {
  title: 'Smart Image Platform - Energy',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Image Platform - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your energy workflows with Smart Image Platform - Energy. This intelligent platform delivers workflow management through advanced automation and AI.
          </p>
