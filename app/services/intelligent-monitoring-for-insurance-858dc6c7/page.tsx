...
export const metadata: Metadata = {
  title: 'Intelligent Monitoring for Insurance',
  description: 'Drive innovation in insurance with Intelligent Monitoring for Insurance. This AI-powered platform transforms budget optimization into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-monitoring-for-insurance-858dc6c7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Monitoring for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Intelligent Monitoring for Insurance. This AI-powered platform transforms budget optimization into a competitive advantage.
          </p>
