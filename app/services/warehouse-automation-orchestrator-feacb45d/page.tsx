...
export const metadata = {
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/warehouse-automation-orchestrator-feacb45d`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path={`/services/warehouse-automation-orchestrator-feacb45d`} title="Warehouse Automation Orchestrator" />
