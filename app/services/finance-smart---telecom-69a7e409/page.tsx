...
export const metadata: Metadata = {
  title: 'Finance Smart - Telecom',
  description: 'Revolutionize telecom through intelligent automation. Our Finance Smart - Telecom leverages advanced machine learning to deliver language processing at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/finance-smart---telecom-69a7e409',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Finance Smart - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Finance Smart - Telecom leverages advanced machine learning to deliver language processing at scale.
          </p>
