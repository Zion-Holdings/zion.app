...
export const metadata: Metadata = {
  title: 'AI/IT Logistics Workflow',
  description: 'Unlock unprecedented growth with AI/IT Logistics Workflow. This autonomous system provides onboarding automation with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-logistics-workflow-58b3cec3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Logistics Workflow
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with AI/IT Logistics Workflow. This autonomous system provides onboarding automation with zero manual intervention needed.
          </p>
