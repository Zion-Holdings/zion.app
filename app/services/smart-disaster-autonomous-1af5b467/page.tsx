...
export const metadata: Metadata = {
  title: 'Smart Disaster Autonomous',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Disaster Autonomous
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for gaming: Smart Disaster Autonomous. Uses quantum-inspired algorithms to deliver quality control at exponential speed.
          </p>
