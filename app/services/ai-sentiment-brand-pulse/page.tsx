...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-source brand mention ingestion, Sentiment scoring per region + product, Issue spike alert + anomaly detect, Weekly brand health executive summary, Competitor sentiment comparison view, ai, Healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Sentiment &amp; Brand Pulse Monitor</h1>
        <p className="text-lg text-slate-300 mb-8">Monitor brand mentions across social, reviews, news, forums. Sentiment trend analysis per region, product, issue. Alert on sentiment spike. Generate weekly brand health executive summary.</p>
        ...
        <li class="text-slate-300">Multi-source brand mention ingestion</li>
        <li class="text-slate-300">Sentiment scoring per region + product</li>
        <li class="text-slate-300">Issue spike alert + anomaly detect</li>
        <li class="text-slate-300">Weekly brand health executive summary</li>
        <li class="text-slate-300">Competitor sentiment comparison view</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai sentiment &amp; brand pulse monitor</li>
