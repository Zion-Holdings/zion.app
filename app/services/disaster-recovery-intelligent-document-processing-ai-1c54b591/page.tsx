...
export const metadata: Metadata = {
  title: 'Disaster Recovery Intelligent Document Processing AI',
  description: 'disaster recovery solution for cleaning services industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents aut',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/disaster-recovery-intelligent-document-processing-ai-1c54b591',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Disaster Recovery Intelligent Document Processing AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            disaster recovery solution for cleaning services industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.
          </p>
