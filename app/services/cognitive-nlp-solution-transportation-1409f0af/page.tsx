...
export const metadata: Metadata = {
  ...
  description: 'Optimize your transportation workflows with Cognitive NLP Solution - Transportation. This intelligent platform delivers budget tracking through advanced automat',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Cognitive NLP Solution - Transportation. This intelligent platform delivers budget tracking through advanced automation and AI.
          </p>
