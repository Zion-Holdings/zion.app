...
export const metadata: Metadata = {
  title: 'Quantum Enterprise - TECHNOLOGY Quantum',
  description: 'Enhance your technology business with Quantum Enterprise - TECHNOLOGY Quantum. Our solution provides training optimization with enterprise-grade reliability and',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Enterprise - TECHNOLOGY Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your technology business with Quantum Enterprise - TECHNOLOGY Quantum. Our solution provides training optimization with enterprise-grade reliability and security.
          </p>
