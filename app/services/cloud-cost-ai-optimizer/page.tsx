...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-cloud cost aggregation & normalization, AI-driven rightsizing recommendations, Automated RI/SP purchase optimization, Idle resource detection & auto-cleanup, Anomaly detection & budget alerts, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Cloud Cost Optimizer</h1>
        <p className="text-lg text-slate-300 mb-8">Continuously analyze cloud spend (AWS, Azure, GCP) and automatically implement cost-saving actions: rightsizing, reserved instances, spot instance switching, and idle resource cleanup.</p>
        ...
        <li class="text-slate-300">Multi-cloud cost aggregation &amp; normalization</li>
        <li class="text-slate-300">AI-driven rightsizing recommendations</li>
        <li class="text-slate-300">Automated RI/SP purchase optimization</li>
        <li class="text-slate-300">Idle resource detection &amp; auto-cleanup</li>
        <li class="text-slate-300">Anomaly detection &amp; budget alerts</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai cloud cost optimizer</li>
