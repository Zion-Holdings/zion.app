...
export const metadata: Metadata = {
  title: 'Quantum Performance - Real-Estate Quantum',
  description: 'The future of real-estate is here with Quantum Performance - Real-Estate Quantum. Powered by cutting-edge AI, this platform delivers quality assurance like neve',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Performance - Real-Estate Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of real-estate is here with Quantum Performance - Real-Estate Quantum. Powered by cutting-edge AI, this platform delivers quality assurance like never before.
          </p>
