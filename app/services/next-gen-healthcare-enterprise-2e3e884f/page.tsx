...
export const metadata: Metadata = {
  title: 'Next-Gen Healthcare - Enterprise',
  description: 'Transform your enterprise operations with our Next-Gen Healthcare - Enterprise. This AI-driven solution automates financial risk management with unprecedented a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-healthcare-enterprise-2e3e884f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Healthcare - Enterprise
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your enterprise operations with our Next-Gen Healthcare - Enterprise. This AI-driven solution automates financial risk management with unprecedented accuracy and efficiency.
          </p>
