...
export const metadata: Metadata = {
  ...
  keywords: 'Product recommendations, Personalized search, Dynamic pricing, Customer segmentation, Abandoned cart recovery, Visual search, -size recommendations, Inventory-aware suggestions, ai, Retail, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Retail AI Personalization Engine</h1>
        <p className="text-lg text-slate-300 mb-8">Real-time product recommendations, personalized search, dynamic pricing, and customer segmentation for e-commerce and retail. Increase conversion and AOV with AI.</p>
        ...
        <li class="text-slate-300">Personalized search</li>
        <li class="text-slate-300">Dynamic pricing</li>
        <li class="text-slate-300">Customer segmentation</li>
        <li class="text-slate-300">Abandoned cart recovery</li>
        <li class="text-slate-300">Visual search</li>
        <li class="text-slate-300">-size recommendations</li>
        <li class="text-slate-300">Inventory-aware suggestions</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">20-35% conversion lift</li>
        <li class="text-slate-300">15% higher AOV</li>
        <li class="text-slate-300">Reduced cart abandonment</li>
        <li class="text-slate-300">Better customer experience</li>
