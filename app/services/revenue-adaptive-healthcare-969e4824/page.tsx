...
export const metadata: Metadata = {
  title: 'Revenue Adaptive - Healthcare',
  description: 'Transform your healthcare operations with our Revenue Adaptive - Healthcare. This AI-driven solution automates account planning with unprecedented accuracy and ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Revenue Adaptive - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Revenue Adaptive - Healthcare. This AI-driven solution automates account planning with unprecedented accuracy and efficiency.
          </p>
