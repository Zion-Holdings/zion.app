...
export const metadata: Metadata = {
  title: 'Automated advisor-healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Automated advisor-healthcare leverages advanced machine learning to deliver quality control at scal',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated advisor-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Automated advisor-healthcare leverages advanced machine learning to deliver quality control at scale.
          </p>
