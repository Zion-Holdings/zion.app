...
export const metadata: Metadata = {
  title: 'Intelligent Quality for Real-Estate',
  description: 'Quantum leap forward for real-estate: Intelligent Quality for Real-Estate. Uses quantum-inspired algorithms to deliver low-code automation at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-quality-for-real-estate-6ff112d7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Quality for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for real-estate: Intelligent Quality for Real-Estate. Uses quantum-inspired algorithms to deliver low-code automation at exponential speed.
          </p>
