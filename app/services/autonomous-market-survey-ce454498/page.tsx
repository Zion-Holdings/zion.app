...
export const metadata: Metadata = {
  title: 'Autonomous Market Survey',
  description: 'Optimize your transportation workflows with Autonomous Market Survey. This intelligent platform delivers cross-sell recommendations through advanced automation ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Market Survey
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Autonomous Market Survey. This intelligent platform delivers cross-sell recommendations through advanced automation and AI.
          </p>
