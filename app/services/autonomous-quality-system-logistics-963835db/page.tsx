...
export const metadata: Metadata = {
  title: 'Autonomous Quality System - Logistics',
  description: 'Transform your logistics operations with our Autonomous Quality System - Logistics. This AI-driven solution automates supply chain with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-quality-system-logistics-963835db',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Quality System - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Autonomous Quality System - Logistics. This AI-driven solution automates supply chain with unprecedented accuracy and efficiency.
          </p>
