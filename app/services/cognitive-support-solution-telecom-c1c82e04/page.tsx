...
export const metadata: Metadata = {
  title: 'Cognitive Support Solution - Telecom',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Support Solution - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in telecom with Cognitive Support Solution - Telecom. This AI-powered platform transforms language processing into a competitive advantage.
          </p>
