...
export const metadata: Metadata = {
  ...
  description: 'Enhance your automotive business with Autonomous Finance System - Automotive. Our solution provides click automation with enterprise-grade reliability and secur',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your automotive business with Autonomous Finance System - Automotive. Our solution provides click automation with enterprise-grade reliability and security.
          </p>
