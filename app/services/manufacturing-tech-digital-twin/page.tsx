...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time asset digital twins, Predictive maintenance simulation, Process optimization, What-if scenario modeling, Integration with IoT sensors, 3D visualization integration, OEE tracking and improvement, Integration with Siemens, GE Digital, manufacturing-tech, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Digital Twin for Manufacturing</h1>
        <p className="text-lg text-slate-300 mb-8">Create digital twins of manufacturing assets. Real-time simulation, predictive maintenance, process optimization, and what-if scenario modeling.</p>
        ...
        <li class="text-slate-300">Real-time asset digital twins</li>
        <li class="text-slate-300">Predictive maintenance simulation</li>
        <li class="text-slate-300">Process optimization</li>
        <li class="text-slate-300">What-if scenario modeling</li>
        <li class="text-slate-300">Integration with IoT sensors</li>
        <li class="text-slate-300">3D visualization integration</li>
        <li class="text-slate-300">OEE tracking and improvement</li>
        <li class="text-slate-300">Integration with Siemens, GE Digital</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce unplanned downtime 45%</li>
        <li class="text-slate-300">Optimize processes digitally</li>
        <li class="text-slate-300">Predict failures before they occur</li>
        <li class="text-slate-300">Improve OEE by 20%</li>
      </ul>
        </div>
