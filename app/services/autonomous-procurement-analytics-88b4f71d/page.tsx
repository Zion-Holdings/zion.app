...
export const metadata: Metadata = {
  title: 'Autonomous Procurement Analytics',
  description: 'Revolutionize sports through intelligent automation. Our Autonomous Procurement Analytics leverages advanced machine learning to deliver enterprise-grade insigh',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-procurement-analytics-88b4f71d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Autonomous Procurement Analytics leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
