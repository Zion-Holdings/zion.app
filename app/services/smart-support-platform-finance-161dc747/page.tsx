...
export const metadata: Metadata = {
  title: 'Smart Support Platform - Finance',
  description: 'Enhance your finance business with Smart Support Platform - Finance. Our solution provides data processing with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-support-platform-finance-161dc747',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Support Platform - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your finance business with Smart Support Platform - Finance. Our solution provides data processing with enterprise-grade reliability and security.
          </p>
