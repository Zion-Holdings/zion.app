...
export const metadata: Metadata = {
  title: 'Cognitive Tactical Solution - ALTHEALTH #1',
  description: 'The future of althealth is here with Cognitive Tactical Solution - ALTHEALTH #1. Powered by cutting-edge AI, this platform delivers procurement automation like ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-tactical-solution-althealth-1-d3486afb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Tactical Solution - ALTHEALTH #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of althealth is here with Cognitive Tactical Solution - ALTHEALTH #1. Powered by cutting-edge AI, this platform delivers procurement automation like never before.
          </p>
