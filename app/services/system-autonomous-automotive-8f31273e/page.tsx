...
export const metadata: Metadata = {
  title: 'System Autonomous - Automotive',
  description: 'Next-generation automotive solution: System Autonomous - Automotive. Combines training optimization with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/system-autonomous-automotive-8f31273e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            System Autonomous - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation automotive solution: System Autonomous - Automotive. Combines training optimization with adaptive intelligence for optimal results.
          </p>
