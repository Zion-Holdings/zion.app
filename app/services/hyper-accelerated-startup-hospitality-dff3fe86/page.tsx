...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Startup - Hospitality',
  description: 'Hyper-accelerated hospitality solution: Hyper-Accelerated Startup - Hospitality. Combines lead scoring with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/hyper-accelerated-startup-hospitality-dff3fe86',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Startup - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated hospitality solution: Hyper-Accelerated Startup - Hospitality. Combines lead scoring with next-gen AI for maximum velocity.
          </p>
