...
export const metadata: Metadata = {
  title: 'Supply Chain Optimization AI Sales Lead Scoring Engine',
  description: 'supply chain optimization solution for franchises industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/supply-chain-optimization-ai-sales-lead-scoring-engine-67d5ee2e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Supply Chain Optimization AI Sales Lead Scoring Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            supply chain optimization solution for franchises industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.
          </p>
