...
export const metadata: Metadata = {
  title: 'Smart Manufacturing for Transportation',
  description: 'Optimize your transportation workflows with Smart Manufacturing for Transportation. This intelligent platform delivers manufacturing quality control through adv',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manufacturing for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Smart Manufacturing for Transportation. This intelligent platform delivers manufacturing quality control through advanced automation and AI.
          </p>
