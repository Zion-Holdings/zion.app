...
export const metadata: Metadata = {
  title: 'Smart Experience for Legal',
  description: 'Optimize your legal workflows with Smart Experience for Legal. This intelligent platform delivers manufacturing quality control through advanced automation and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-experience-for-legal-a9dc91fd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Experience for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with Smart Experience for Legal. This intelligent platform delivers manufacturing quality control through advanced automation and AI.
          </p>
