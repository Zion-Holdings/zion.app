...
export const metadata: Metadata = {
  title: 'Self-Optimizing Marketing for Transportation',
  description: 'The future of transportation is here with Self-Optimizing Marketing for Transportation. Powered by cutting-edge AI, this platform delivers predictive analytics ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Marketing for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Self-Optimizing Marketing for Transportation. Powered by cutting-edge AI, this platform delivers predictive analytics like never before.
          </p>
