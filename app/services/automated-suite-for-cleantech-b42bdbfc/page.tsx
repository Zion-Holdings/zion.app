...
export const metadata: Metadata = {
  title: 'Automated Suite for Cleantech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Suite for Cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of cleantech is here with Automated Suite for Cleantech. Powered by cutting-edge AI, this platform delivers document processing like never before.
          </p>
