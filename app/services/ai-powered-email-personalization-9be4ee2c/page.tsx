...
export const metadata: Metadata = {
  ...
  description: 'Creates hyper-personalized email campaigns by analyzing recipient data.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-email-personalization-9be4ee2c',
  },

export const metadata = {
  title: "AI-Powered Email Personalization - Zion Tech Group",
  description: "Creates hyper-personalized email campaigns by analyzing recipient data.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-email-personalization-9be4ee2c`
  }
  ...
  return (
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Creates hyper-personalized email campaigns by analyzing recipient data.
          </p>
    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">AI-Powered Email Personalization</h1>
        <p className="text-lg text-gray-300 mb-8">Creates hyper-personalized email campaigns by analyzing recipient data.</p>
