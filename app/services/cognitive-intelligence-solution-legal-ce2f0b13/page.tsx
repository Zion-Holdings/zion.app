...
export const metadata: Metadata = {
  title: 'Cognitive Intelligence Solution - Legal',
  description: 'Revolutionize legal through intelligent automation. Our Cognitive Intelligence Solution - Legal leverages advanced machine learning to deliver influencer identi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-intelligence-solution-legal-ce2f0b13',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Intelligence Solution - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Cognitive Intelligence Solution - Legal leverages advanced machine learning to deliver influencer identification at scale.
          </p>
