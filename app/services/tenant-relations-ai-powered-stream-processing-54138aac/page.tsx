...
export const metadata: Metadata = {
  title: 'Tenant Relations AI-Powered Stream Processing',
  description: 'AI-powered tenant relations solution for streaming. Real-time stream processing with automatic windowing and aggregation.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/tenant-relations-ai-powered-stream-processing-54138aac',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Tenant Relations AI-Powered Stream Processing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered tenant relations solution for streaming. Real-time stream processing with automatic windowing and aggregation.
          </p>
