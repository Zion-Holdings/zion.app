  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Cognitive Platform for Energy #1</h1>
        <p className="text-lg text-gray-300 mb-8">Transform your energy operations with our Cognitive Platform for Energy #1. This AI-driven solution automates network optimization with unprecedented accuracy and efficiency.</p>
