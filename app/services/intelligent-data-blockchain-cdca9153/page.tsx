...
export const metadata: Metadata = {
  title: 'Intelligent data-blockchain',
  description: 'Revolutionize blockchain through intelligent automation. Our Intelligent data-blockchain leverages advanced machine learning to deliver customer service automat',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-data-blockchain-cdca9153',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent data-blockchain
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize blockchain through intelligent automation. Our Intelligent data-blockchain leverages advanced machine learning to deliver customer service automation at scale.
          </p>
