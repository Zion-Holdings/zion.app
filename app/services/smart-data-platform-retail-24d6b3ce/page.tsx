...
export const metadata: Metadata = {
  title: 'Smart Data Platform - Retail',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Data Platform - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Smart Data Platform - Retail. Powered by cutting-edge AI, this platform delivers cost reduction like never before.
          </p>
