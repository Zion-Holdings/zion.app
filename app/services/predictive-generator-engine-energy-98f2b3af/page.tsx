...
export const metadata: Metadata = {
  title: 'Predictive Generator Engine - Energy',
  description: 'The future of energy is here with Predictive Generator Engine - Energy. Powered by cutting-edge AI, this platform delivers market intelligence like never before',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-generator-engine-energy-98f2b3af',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Generator Engine - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Predictive Generator Engine - Energy. Powered by cutting-edge AI, this platform delivers market intelligence like never before.
          </p>
