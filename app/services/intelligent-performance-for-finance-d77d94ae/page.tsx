...
export const metadata: Metadata = {
  title: 'Intelligent Performance for Finance',
  description: 'Next-generation finance solution: Intelligent Performance for Finance. Combines threat detection with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-performance-for-finance-d77d94ae',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Performance for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation finance solution: Intelligent Performance for Finance. Combines threat detection with adaptive intelligence for optimal results.
          </p>
