...
export const metadata: Metadata = {
  title: 'Risk AI - Gaming',
  description: 'Drive innovation in gaming with Risk AI - Gaming. This AI-powered platform transforms customer journey mapping into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/risk-ai-gaming-d24ae6c7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in gaming with Risk AI - Gaming. This AI-powered platform transforms customer journey mapping into a competitive advantage.
          </p>
