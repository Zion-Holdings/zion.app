...
export const metadata: Metadata = {
  title: 'Intelligent Director for Gaming',
  description: 'Next-generation gaming solution: Intelligent Director for Gaming. Combines decision support with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-director-for-gaming-75c99207',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Director for Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation gaming solution: Intelligent Director for Gaming. Combines decision support with adaptive intelligence for optimal results.
          </p>
