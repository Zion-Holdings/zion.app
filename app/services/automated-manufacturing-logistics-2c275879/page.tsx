...
export const metadata: Metadata = {
  title: 'Automated manufacturing-logistics',
  description: 'Optimize your logistics workflows with Automated manufacturing-logistics. This intelligent platform delivers logistics route optimization through advanced autom',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your logistics workflows with Automated manufacturing-logistics. This intelligent platform delivers logistics route optimization through advanced automation and AI.
          </p>
