...
export const metadata: Metadata = {
  title: 'Cognitive Optimizer Solution - HEALTHTECH',
  description: 'Enhance your healthtech business with Cognitive Optimizer Solution - HEALTHTECH. Our solution provides supply chain with enterprise-grade reliability and securi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-optimizer-solution-healthtech-a48439a2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Optimizer Solution - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthtech business with Cognitive Optimizer Solution - HEALTHTECH. Our solution provides supply chain with enterprise-grade reliability and security.
          </p>
