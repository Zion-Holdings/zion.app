...
export const metadata: Metadata = {
  title: 'AI Compliance - Insurance Edition',
  description: 'Transform your insurance operations with our AI Compliance - Insurance Edition. This AI-driven solution provides intelligent automation with unprecedented accur',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Compliance - Insurance Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our AI Compliance - Insurance Edition. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
