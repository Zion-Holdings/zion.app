...
export const metadata: Metadata = {
  title: 'AI Strategic - CLEANTECH Edition',
  description: 'Transform your cleantech operations with our AI Strategic - CLEANTECH Edition. This AI-driven solution automates access management with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-strategic-cleantech-edition-b906e360',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Strategic - CLEANTECH Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your cleantech operations with our AI Strategic - CLEANTECH Edition. This AI-driven solution automates access management with unprecedented accuracy and efficiency.
          </p>
