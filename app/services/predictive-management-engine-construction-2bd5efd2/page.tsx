...
export const metadata: Metadata = {
  title: 'Predictive Management Engine - Construction',
  description: 'Next-generation construction solution: Predictive Management Engine - Construction. Combines logistics route optimization with adaptive intelligence for optimal',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-management-engine-construction-2bd5efd2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Management Engine - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Predictive Management Engine - Construction. Combines logistics route optimization with adaptive intelligence for optimal results.
          </p>
