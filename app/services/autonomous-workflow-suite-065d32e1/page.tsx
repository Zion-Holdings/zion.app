...
export const metadata: Metadata = {
  title: 'Autonomous Workflow Suite',
  description: 'Revolutionize healthcare through intelligent automation. Our Autonomous Workflow Suite leverages advanced machine learning to deliver language processing at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Autonomous Workflow Suite leverages advanced machine learning to deliver language processing at scale.
          </p>
