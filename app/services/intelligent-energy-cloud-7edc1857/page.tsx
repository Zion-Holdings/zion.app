...
export const metadata: Metadata = {
  title: 'Intelligent Energy Cloud',
  description: 'The future of agritech is here with Intelligent Energy Cloud. Powered by cutting-edge AI, this platform delivers quality control like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-energy-cloud-7edc1857',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Energy Cloud
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agritech is here with Intelligent Energy Cloud. Powered by cutting-edge AI, this platform delivers quality control like never before.
          </p>
