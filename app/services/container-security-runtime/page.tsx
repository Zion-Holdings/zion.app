...
export const metadata: Metadata = {
  ...
  keywords: 'Image vulnerability scan, K8s admission control, Runtime threat detection, Secret scanning (registry + env), SBOM generation on push, security, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Container Security Runtime</h1>
        <p className="text-lg text-slate-300 mb-8">Kubernetes-aware container security with image scanning, admission control, runtime threat detection, secret scanning, and CVSS scoring in CI/CD pipelines.</p>
        ...
        <li class="text-slate-300">Image vulnerability scan</li>
        <li class="text-slate-300">K8s admission control</li>
        <li class="text-slate-300">Runtime threat detection</li>
        <li class="text-slate-300">Secret scanning (registry + env)</li>
        <li class="text-slate-300">SBOM generation on push</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with container security runtime</li>
