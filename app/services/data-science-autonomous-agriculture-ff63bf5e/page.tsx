...
export const metadata: Metadata = {
  title: 'Data Science Autonomous - Agriculture',
  description: 'Optimize your agriculture workflows with Data Science Autonomous - Agriculture. This intelligent platform delivers user provisioning through advanced automation',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-science-autonomous-agriculture-ff63bf5e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Science Autonomous - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your agriculture workflows with Data Science Autonomous - Agriculture. This intelligent platform delivers user provisioning through advanced automation and AI.
          </p>
