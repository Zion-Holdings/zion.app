...
export const metadata: Metadata = {
  title: 'Smart Process for Transportation',
  description: 'Drive innovation in transportation with Smart Process for Transportation. This AI-powered platform transforms procurement automation into a competitive advantag',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Process for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in transportation with Smart Process for Transportation. This AI-powered platform transforms procurement automation into a competitive advantage.
          </p>
