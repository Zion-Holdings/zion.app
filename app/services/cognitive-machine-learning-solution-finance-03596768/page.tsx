...
export const metadata: Metadata = {
  title: 'Cognitive Machine Learning Solution - Finance',
  description: 'The future of finance is here with Cognitive Machine Learning Solution - Finance. Powered by cutting-edge AI, this platform delivers account planning like never',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Machine Learning Solution - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of finance is here with Cognitive Machine Learning Solution - Finance. Powered by cutting-edge AI, this platform delivers account planning like never before.
          </p>
