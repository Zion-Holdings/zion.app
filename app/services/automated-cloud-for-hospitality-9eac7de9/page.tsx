...
export const metadata: Metadata = {
  title: 'Automated Cloud for Hospitality',
  description: 'The future of hospitality is here with Automated Cloud for Hospitality. Powered by cutting-edge AI, this platform delivers transformative results like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-cloud-for-hospitality-9eac7de9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Cloud for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Automated Cloud for Hospitality. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
