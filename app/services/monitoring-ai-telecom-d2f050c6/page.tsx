...
export const metadata: Metadata = {
  title: 'Monitoring AI - Telecom',
  description: 'Drive innovation in telecom with Monitoring AI - Telecom. This AI-powered platform transforms quality control into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/monitoring-ai-telecom-d2f050c6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Monitoring AI - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in telecom with Monitoring AI - Telecom. This AI-powered platform transforms quality control into a competitive advantage.
          </p>
