...
export const metadata: Metadata = {
  ...
  keywords: 'Unsupervised learning, Adaptive thresholds, Root cause analysis, Automated alerting, Multi-source ingestion, Seasonality detection, Correlation analysis, Noise reduction, ai, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Real-Time Anomaly Detection Platform</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered anomaly detection for metrics, logs, and events. Unsupervised learning, adaptive thresholds, root cause analysis, and automated alerting across your entire stack.</p>
        ...
        <li class="text-slate-300">Unsupervised learning</li>
        <li class="text-slate-300">Adaptive thresholds</li>
        <li class="text-slate-300">Root cause analysis</li>
        <li class="text-slate-300">Automated alerting</li>
        <li class="text-slate-300">Multi-source ingestion</li>
        <li class="text-slate-300">Seasonality detection</li>
        <li class="text-slate-300">Correlation analysis</li>
        <li class="text-slate-300">Noise reduction</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">90% fewer false positives</li>
        <li class="text-slate-300">Detect unknown unknowns</li>
        <li class="text-slate-300">Root cause in seconds</li>
        <li class="text-slate-300">Adaptive learning</li>
        <li class="text-slate-300">Multi-source correlation</li>
      </ul>
        </div>
