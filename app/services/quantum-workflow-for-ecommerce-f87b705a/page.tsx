...
export const metadata: Metadata = {
  title: 'Quantum Workflow for Ecommerce',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Workflow for Ecommerce
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in ecommerce with Quantum Workflow for Ecommerce. This AI-powered platform transforms succession planning into a competitive advantage.
          </p>
