...
export const metadata: Metadata = {
  title: 'Insights Adaptive - Media #1',
  description: 'Quantum leap forward for media: Insights Adaptive - Media #1. Uses quantum-inspired algorithms to deliver case management at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/insights-adaptive-media-1-79050c05',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Insights Adaptive - Media #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for media: Insights Adaptive - Media #1. Uses quantum-inspired algorithms to deliver case management at exponential speed.
          </p>
