...
export const metadata: Metadata = {
  title: 'Smart machine learning-energy',
  description: 'Revolutionize energy through intelligent automation. Our Smart machine learning-energy leverages advanced machine learning to deliver user experience at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-machine-learning-energy-975f9370',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart machine learning-energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Smart machine learning-energy leverages advanced machine learning to deliver user experience at scale.
          </p>
