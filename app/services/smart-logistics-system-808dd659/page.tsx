...
export const metadata: Metadata = {
  ...
  description: 'Next-generation automotive solution: Smart Logistics System. Combines feedback collection with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-logistics-system-808dd659',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation automotive solution: Smart Logistics System. Combines feedback collection with adaptive intelligence for optimal results.
          </p>
