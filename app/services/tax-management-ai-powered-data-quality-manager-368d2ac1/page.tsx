...
export const metadata: Metadata = {
  title: 'Tax Management AI-Powered Data Quality Manager',
  description: 'tax management solution for construction industry. Automatically detects, corrects, and prevents data quality issues using machine learning.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/tax-management-ai-powered-data-quality-manager-368d2ac1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Tax Management AI-Powered Data Quality Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            tax management solution for construction industry. Automatically detects, corrects, and prevents data quality issues using machine learning.
          </p>
