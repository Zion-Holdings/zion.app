...
export const metadata: Metadata = {
  title: 'Quantum Analytics - TECHNOLOGY Quantum',
  description: 'Quantum leap forward for technology: Quantum Analytics - TECHNOLOGY Quantum. Uses quantum-inspired algorithms to deliver succession planning at exponential spee',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Analytics - TECHNOLOGY Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for technology: Quantum Analytics - TECHNOLOGY Quantum. Uses quantum-inspired algorithms to deliver succession planning at exponential speed.
          </p>
