...
export const metadata: Metadata = {
  title: 'Public Safety AI-Powered Data Catalog',
  description: 'AI-powered public safety solution for data governance. Self-updating data catalog with automated metadata extraction.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/public-safety-ai-powered-data-catalog-079de9da',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Public Safety AI-Powered Data Catalog
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered public safety solution for data governance. Self-updating data catalog with automated metadata extraction.
          </p>
