...
export const metadata: Metadata = {
  title: 'Security Automated - Telecom',
  description: 'Optimize your telecom workflows with Security Automated - Telecom. This intelligent platform delivers performance monitoring through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-automated-telecom-74120562',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Automated - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your telecom workflows with Security Automated - Telecom. This intelligent platform delivers performance monitoring through advanced automation and AI.
          </p>
