...
export const metadata: Metadata = {
  title: 'Risk Automated - Media',
  description: 'Enhance your media business with Risk Automated - Media. Our solution provides compliance reporting with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/risk-automated-media-96085db1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Risk Automated - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your media business with Risk Automated - Media. Our solution provides compliance reporting with enterprise-grade reliability and security.
          </p>
