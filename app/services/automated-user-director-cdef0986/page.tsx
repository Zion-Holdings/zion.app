...
export const metadata: Metadata = {
  title: 'Automated User Director',
  description: 'Enhance your insurance business with Automated User Director. Our solution provides contract analysis with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-user-director-cdef0986',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated User Director
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Automated User Director. Our solution provides contract analysis with enterprise-grade reliability and security.
          </p>
