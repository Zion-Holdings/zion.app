...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated process mining-logistics',
  description: 'Drive innovation in logistics with Hyper-Accelerated process mining-logistics. This AI-powered platform transforms business intelligence into a competitive adva',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/hyper-accelerated-process-mining-logistics-85902e8d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated process mining-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with Hyper-Accelerated process mining-logistics. This AI-powered platform transforms business intelligence into a competitive advantage.
          </p>
