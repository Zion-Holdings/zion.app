...
export const metadata: Metadata = {
  title: 'Cognitive Engine Solution - Healthcare',
  description: 'The future of healthcare is here with Cognitive Engine Solution - Healthcare. Powered by cutting-edge AI, this platform delivers edge computing like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-engine-solution-healthcare-6a7c2911',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Engine Solution - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Cognitive Engine Solution - Healthcare. Powered by cutting-edge AI, this platform delivers edge computing like never before.
          </p>
