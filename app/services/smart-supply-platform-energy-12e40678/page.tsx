...
export const metadata: Metadata = {
  title: 'Smart Supply Platform - Energy',
  description: 'Next-generation energy solution: Smart Supply Platform - Energy. Combines quality assurance with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-supply-platform-energy-12e40678',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Supply Platform - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Smart Supply Platform - Energy. Combines quality assurance with adaptive intelligence for optimal results.
          </p>
