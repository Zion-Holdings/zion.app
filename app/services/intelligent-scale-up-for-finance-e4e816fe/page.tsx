...
export const metadata: Metadata = {
  title: 'Intelligent Scale-up for Finance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Scale-up for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Scale-up for Finance. This autonomous system provides roi tracking with zero manual intervention needed.
          </p>
