...
export const metadata: Metadata = {
  title: 'Intelligent Supply for Sports #1',
  description: 'The future of sports is here with Intelligent Supply for Sports #1. Powered by cutting-edge AI, this platform delivers customer onboarding like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-supply-for-sports-1-4e023c72',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Supply for Sports #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Intelligent Supply for Sports #1. Powered by cutting-edge AI, this platform delivers customer onboarding like never before.
          </p>
