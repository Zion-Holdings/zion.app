...
export const metadata: Metadata = {
  title: 'Neural marketing-retail',
  description: 'The future of retail is here with Neural marketing-retail. Powered by cutting-edge AI, this platform delivers access management like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-marketing-retail-6abf34ac',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural marketing-retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Neural marketing-retail. Powered by cutting-edge AI, this platform delivers access management like never before.
          </p>
