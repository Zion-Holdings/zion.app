...
export const metadata: Metadata = {
  title: 'Autonomous Experience for Healthcare',
  description: 'Drive innovation in healthcare with Autonomous Experience for Healthcare. This AI-powered platform transforms anomaly detection into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-experience-for-healthcare-242db259',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Experience for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with Autonomous Experience for Healthcare. This AI-powered platform transforms anomaly detection into a competitive advantage.
          </p>
