...
export const metadata: Metadata = {
  title: 'Director Smart - Construction',
  description: 'Enhance your construction business with Director Smart - Construction. Our solution provides brand sentiment with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/director-smart-construction-fb7ec335',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Director Smart - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Director Smart - Construction. Our solution provides brand sentiment with enterprise-grade reliability and security.
          </p>
