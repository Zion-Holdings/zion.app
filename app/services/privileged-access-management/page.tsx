...
export const metadata: Metadata = {
  ...
  keywords: 'Just-in-time access grants, Session recording & auditing, Credential vaulting, Break-glass account emergency access, Cross-cloud vault sync, security, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Just-in-time elevated access, session recording, and credential vaulting for admin, SSH, and database accounts across cloud and on-premise.</p>
        ...
        <li class="text-slate-300">Just-in-time access grants</li>
        <li class="text-slate-300">Session recording &amp; auditing</li>
        <li class="text-slate-300">Credential vaulting</li>
        <li class="text-slate-300">Break-glass account emergency access</li>
        <li class="text-slate-300">Cross-cloud vault sync</li>
      </ul>
        </div>
