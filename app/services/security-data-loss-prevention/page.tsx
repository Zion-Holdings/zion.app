...
export const metadata = {
  ...
  description: "Prevent sensitive data from leaving your organization. Content inspection, endpoint, cloud, and email DLP.",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Prevent sensitive data from leaving your organization. Content inspection, endpoint, cloud, and email DLP.</p>
        
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          <h2 className="text-2xl font-semibold mb-4">Key Features</h2>
          <ul className="list-disc list-inside space-y-2">
            <li>Content inspection and classification</li>
            <li>Endpoint DLP agents</li>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Prevent data breaches from insiders</li>
            <li>Compliance-ready DLP policies</li>
            <li>Monitor data at rest and in use</li>
