...
export const metadata: Metadata = {
  title: 'Intelligent Supply for Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Intelligent Supply for Insurance leverages advanced machine learning to deliver performance monitori',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-supply-for-insurance-cddd9833',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Supply for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Intelligent Supply for Insurance leverages advanced machine learning to deliver performance monitoring at scale.
          </p>
