...
export const metadata: Metadata = {
  title: 'AI/IT Supply Suite - Agriculture',
  description: 'Unlock unprecedented growth with AI/IT Supply Suite - Agriculture. This autonomous system provides document ai with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-supply-suite-agriculture-cdea79e4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Supply Suite - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with AI/IT Supply Suite - Agriculture. This autonomous system provides document ai with zero manual intervention needed.
          </p>
