export const metadata = {
  title: "Cognitive Data Science for Energy",
  description: "Zion Tech Group delivers Cognitive Data Science for Energy with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/services/cognitive-data-science-for-energy-8a9f5a38/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>Cognitive Data Science for Energy</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers Cognitive Data Science for Energy with measurable outcomes.
      </p>
