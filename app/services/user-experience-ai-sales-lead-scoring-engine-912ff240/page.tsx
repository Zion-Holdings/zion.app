...
export const metadata: Metadata = {
  ...
  description: 'user experience solution for mining & metals industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/user-experience-ai-sales-lead-scoring-engine-912ff240',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            user experience solution for mining & metals industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.
          </p>
