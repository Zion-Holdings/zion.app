      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            FDA-ready AI diagnostic support for radiology, pathology, and dermatology — detect anomalies, prioritize cases, and assist radiologists with second-opinion AI.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Deep learning anomaly detection in X-rays, CT, MRI</li>
            <li className="text-purple-300">✓ Pathology slide analysis and classification</li>
            <li className="text-purple-300">✓ Dermatological lesion assessment</li>
            <li className="text-purple-300">✓ Triage and workload prioritization</li>
            <li className="text-purple-300">✓ HIPAA-compliant deployment with audit trails</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai medical imaging & diagnostics</li>
