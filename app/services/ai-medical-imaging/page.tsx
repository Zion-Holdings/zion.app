...
export const metadata: Metadata = {
  ...
  keywords: 'Deep learning anomaly detection in X-rays, CT, MRI, Pathology slide analysis and classification, Dermatological lesion assessment, Triage and workload prioritization, HIPAA-compliant deployment with audit trails, ai, Healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Medical Imaging &amp; Diagnostics</h1>
        <p className="text-lg text-slate-300 mb-8">FDA-ready AI diagnostic support for radiology, pathology, and dermatology — detect anomalies, prioritize cases, and assist radiologists with second-opinion AI.</p>
        ...
        <li class="text-slate-300">Deep learning anomaly detection in X-rays, CT, MRI</li>
        <li class="text-slate-300">Pathology slide analysis and classification</li>
        <li class="text-slate-300">Dermatological lesion assessment</li>
        <li class="text-slate-300">Triage and workload prioritization</li>
        <li class="text-slate-300">HIPAA-compliant deployment with audit trails</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai medical imaging &amp; diagnostics</li>
