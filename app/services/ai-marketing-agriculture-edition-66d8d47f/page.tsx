...
export const metadata: Metadata = {
  title: 'AI Marketing - Agriculture Edition',
  description: 'Unlock unprecedented growth with AI Marketing - Agriculture Edition. This autonomous system provides customer service automation with zero manual intervention n',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Marketing - Agriculture Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with AI Marketing - Agriculture Edition. This autonomous system provides customer service automation with zero manual intervention needed.
          </p>
