...
export const metadata: Metadata = {
  title: 'Cognitive Healthcare Solution - Finance',
  description: 'Next-generation finance solution: Cognitive Healthcare Solution - Finance. Combines security monitoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-healthcare-solution-finance-2d47b5f8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Healthcare Solution - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation finance solution: Cognitive Healthcare Solution - Finance. Combines security monitoring with adaptive intelligence for optimal results.
          </p>
