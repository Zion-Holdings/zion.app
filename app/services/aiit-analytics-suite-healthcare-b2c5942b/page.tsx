...
export const metadata: Metadata = {
  title: 'AI/IT Analytics Suite - Healthcare',
  description: 'Drive innovation in healthcare with AI/IT Analytics Suite - Healthcare. This AI-powered platform transforms feature engineering into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-analytics-suite-healthcare-b2c5942b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Analytics Suite - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with AI/IT Analytics Suite - Healthcare. This AI-powered platform transforms feature engineering into a competitive advantage.
          </p>
