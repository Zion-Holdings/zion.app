...
export const metadata: Metadata = {
  title: 'Testing Automation AI-Powered Data Visualization',
  description: 'AI-powered testing automation solution for bi. Intelligent chart and graph recommendations based on data patterns.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/testing-automation-ai-powered-data-visualization-878197e3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Testing Automation AI-Powered Data Visualization
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered testing automation solution for bi. Intelligent chart and graph recommendations based on data patterns.
          </p>
