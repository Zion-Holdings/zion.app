...
export const metadata: Metadata = {
  title: 'Smart Monitoring Platform - Cybersecurity',
  description: 'Enhance your cybersecurity business with Smart Monitoring Platform - Cybersecurity. Our solution provides benefits administration with enterprise-grade reliabil',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-monitoring-platform-cybersecurity-26d70904',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Monitoring Platform - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your cybersecurity business with Smart Monitoring Platform - Cybersecurity. Our solution provides benefits administration with enterprise-grade reliability and security.
          </p>
