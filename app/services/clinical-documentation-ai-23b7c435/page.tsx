...
export const metadata = {
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/clinical-documentation-ai-23b7c435`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path={`/services/clinical-documentation-ai-23b7c435`} title="Clinical Documentation AI" />
