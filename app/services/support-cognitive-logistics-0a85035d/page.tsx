...
export const metadata: Metadata = {
  title: 'Support Cognitive - Logistics',
  description: 'Next-generation logistics solution: Support Cognitive - Logistics. Combines quality control with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/support-cognitive-logistics-0a85035d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Support Cognitive - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Support Cognitive - Logistics. Combines quality control with adaptive intelligence for optimal results.
          </p>
