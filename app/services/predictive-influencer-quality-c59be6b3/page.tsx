...
export const metadata: Metadata = {
  title: 'Predictive Influencer Quality',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Influencer Quality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation real-estate solution: Predictive Influencer Quality. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
