...
export const metadata: Metadata = {
  title: 'Autonomous AI System - Hospitality',
  description: 'The future of hospitality is here with Autonomous AI System - Hospitality. Powered by cutting-edge AI, this platform delivers reputation management like never b',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-ai-system-hospitality-72802fe2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous AI System - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Autonomous AI System - Hospitality. Powered by cutting-edge AI, this platform delivers reputation management like never before.
          </p>
