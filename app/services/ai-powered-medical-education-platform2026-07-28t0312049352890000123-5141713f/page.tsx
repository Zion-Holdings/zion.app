...
export const metadata: Metadata = {
  ...
  description: 'AI-powered medical education with personalized learning paths.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-medical-education-platform2026-07-28t0312049352890000123-5141713f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            AI-powered medical education with personalized learning paths.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Medical education</li>
          <li className="text-gray-300">Personalized learning</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">50% faster learning</li>
