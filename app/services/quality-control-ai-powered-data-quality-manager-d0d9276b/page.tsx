...
export const metadata: Metadata = {
  ...
  description: 'quality control solution for construction industry. Automatically detects, corrects, and prevents data quality issues using machine learning.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quality-control-ai-powered-data-quality-manager-d0d9276b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            quality control solution for construction industry. Automatically detects, corrects, and prevents data quality issues using machine learning.
          </p>
