...
export const metadata: Metadata = {
  ...
  keywords: 'Unified multi-cloud K8s management, Policy enforcement, Observability across clusters, Auto-scaling, Service mesh integration, Backup and disaster recovery, Cost allocation, Developer self-service, cloud, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Multi-Cloud Kubernetes Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Managed Kubernetes across AWS EKS, Azure AKS, and GCP GKE. Unified control plane, security policies, and observability.</p>
        ...
        <li class="text-slate-300">Unified multi-cloud K8s management</li>
        <li class="text-slate-300">Policy enforcement</li>
        <li class="text-slate-300">Observability across clusters</li>
        <li class="text-slate-300">Auto-scaling</li>
        <li class="text-slate-300">Service mesh integration</li>
        <li class="text-slate-300">Backup and disaster recovery</li>
        <li class="text-slate-300">Cost allocation</li>
        <li class="text-slate-300">Developer self-service</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Consistent K8s across clouds</li>
        <li class="text-slate-300">Centralized security policies</li>
        <li class="text-slate-300">Reduce operational overhead</li>
        <li class="text-slate-300">Enable developer productivity</li>
      </ul>
        </div>
