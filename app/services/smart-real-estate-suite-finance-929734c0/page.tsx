...
export const metadata: Metadata = {
  title: 'Smart Real Estate Suite - Finance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Real Estate Suite - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation finance solution: Smart Real Estate Suite - Finance. Combines workflow management with adaptive intelligence for optimal results.
          </p>
