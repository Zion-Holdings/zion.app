...
export const metadata: Metadata = {
  title: 'AI-Powered Brand Automation',
  description: 'Transform your energy operations with our AI-Powered Brand Automation. This AI-driven solution automates brand monitoring with unprecedented accuracy and effici',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-brand-automation-4eb00f1f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our AI-Powered Brand Automation. This AI-driven solution automates brand monitoring with unprecedented accuracy and efficiency.
          </p>
