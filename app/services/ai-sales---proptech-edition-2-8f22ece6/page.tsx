...
export const metadata: Metadata = {
  title: 'AI Sales - Proptech Edition #2',
  description: 'The future of proptech is here with AI Sales - Proptech Edition #2. Powered by cutting-edge AI, this platform delivers predictive analytics like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-sales---proptech-edition-2-8f22ece6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Sales - Proptech Edition #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with AI Sales - Proptech Edition #2. Powered by cutting-edge AI, this platform delivers predictive analytics like never before.
          </p>
