...
export const metadata: Metadata = {
  title: 'Smart Lead Experience',
  description: 'Next-generation finance solution: Smart Lead Experience. Combines master data management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-lead-experience-72ae440d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Lead Experience
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation finance solution: Smart Lead Experience. Combines master data management with adaptive intelligence for optimal results.
          </p>
