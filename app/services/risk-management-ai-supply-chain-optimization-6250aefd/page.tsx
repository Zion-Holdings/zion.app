...
export const metadata: Metadata = {
  title: 'Risk Management AI Supply Chain Optimization',
  description: 'risk management solution for hospitality industry. Optimizes supply chain operations using predictive analytics, demand forecasting, and route optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/risk-management-ai-supply-chain-optimization-6250aefd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Risk Management AI Supply Chain Optimization
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            risk management solution for hospitality industry. Optimizes supply chain operations using predictive analytics, demand forecasting, and route optimization.
          </p>
