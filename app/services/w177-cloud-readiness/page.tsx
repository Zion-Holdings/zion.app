  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cloud Readiness Assessment</h1>
        <p className="text-lg text-slate-300 mb-8">Assess organizational cloud readiness: people, process, technology, governance. Roadmap with quick wins and cost modeling.</p>
