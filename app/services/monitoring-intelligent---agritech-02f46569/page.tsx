...
export const metadata: Metadata = {
  title: 'Monitoring Intelligent - Agritech',
  description: 'Next-generation agritech solution: Monitoring Intelligent - Agritech. Combines inventory management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/monitoring-intelligent---agritech-02f46569',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Monitoring Intelligent - Agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agritech solution: Monitoring Intelligent - Agritech. Combines inventory management with adaptive intelligence for optimal results.
          </p>
