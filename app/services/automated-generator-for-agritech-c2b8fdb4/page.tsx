...
export const metadata: Metadata = {
  title: 'Automated Generator for Agritech',
  description: 'Revolutionize agritech through intelligent automation. Our Automated Generator for Agritech leverages advanced machine learning to deliver supply chain at scale',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-generator-for-agritech-c2b8fdb4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Generator for Agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agritech through intelligent automation. Our Automated Generator for Agritech leverages advanced machine learning to deliver supply chain at scale.
          </p>
