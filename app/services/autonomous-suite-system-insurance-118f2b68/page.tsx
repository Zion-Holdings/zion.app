...
export const metadata: Metadata = {
  title: 'Autonomous Suite System - Insurance',
  description: 'Optimize your insurance workflows with Autonomous Suite System - Insurance. This intelligent platform delivers feedback collection through advanced automation a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-suite-system-insurance-118f2b68',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Suite System - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with Autonomous Suite System - Insurance. This intelligent platform delivers feedback collection through advanced automation and AI.
          </p>
