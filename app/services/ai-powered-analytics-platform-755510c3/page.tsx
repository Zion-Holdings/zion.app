...
export const metadata: Metadata = {
  ...
  description: 'Self-service analytics platform with predictive analytics and automated insights.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-analytics-platform-755510c3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Self-service analytics platform with predictive analytics and automated insights.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Self-service analytics</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">Instant insights</li>
