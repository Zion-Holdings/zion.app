...
export const metadata: Metadata = {
  title: 'Intelligent Cognitive for Automotive',
  description: 'Drive innovation in automotive with Intelligent Cognitive for Automotive. This AI-powered platform transforms sourcing optimization into a competitive advantage',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-cognitive-for-automotive-73ec93d4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Cognitive for Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in automotive with Intelligent Cognitive for Automotive. This AI-powered platform transforms sourcing optimization into a competitive advantage.
          </p>
