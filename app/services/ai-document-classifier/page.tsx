...
export const metadata: Metadata = {
  ...
  keywords: '99-doc ocr nlp classification, Key field extraction per doc type, Workflow queue routing + SLA tagging, Metadata + search tags auto-attached, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Document Classifier</h1>
        <p className="text-lg text-slate-300 mb-8">Auto-classifies invoices contracts NDAs receipts resumes medical records: routes to correct workflow extracts key fields attaches metadata search tags.</p>
        ...
        <li class="text-slate-300">99-doc ocr nlp classification</li>
        <li class="text-slate-300">Key field extraction per doc type</li>
        <li class="text-slate-300">Workflow queue routing + SLA tagging</li>
        <li class="text-slate-300">Metadata + search tags auto-attached</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai document classifier</li>
