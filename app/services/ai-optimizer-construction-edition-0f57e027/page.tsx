...
export const metadata: Metadata = {
  title: 'AI Optimizer - Construction Edition',
  description: 'Revolutionize construction through intelligent automation. Our AI Optimizer - Construction Edition leverages advanced machine learning to deliver resource alloc',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Optimizer - Construction Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our AI Optimizer - Construction Edition leverages advanced machine learning to deliver resource allocation at scale.
          </p>
