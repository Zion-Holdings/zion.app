...
export const metadata: Metadata = {
  title: 'Intelligent automation-agriculture',
  description: 'Optimize your agriculture workflows with Intelligent automation-agriculture. This intelligent platform delivers user experience through advanced automation and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-automation-agriculture-6a2ed4ae',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent automation-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your agriculture workflows with Intelligent automation-agriculture. This intelligent platform delivers user experience through advanced automation and AI.
          </p>
