...
export const metadata: Metadata = {
  title: 'Smart NLP Platform - Transportation',
  description: 'Drive innovation in transportation with Smart NLP Platform - Transportation. This AI-powered platform transforms process automation into a competitive advantage',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-nlp-platform-transportation-86542842',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart NLP Platform - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in transportation with Smart NLP Platform - Transportation. This AI-powered platform transforms process automation into a competitive advantage.
          </p>
