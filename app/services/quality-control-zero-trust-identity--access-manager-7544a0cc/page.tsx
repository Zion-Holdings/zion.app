...
export const metadata: Metadata = {
  title: 'Quality Control Zero-Trust Identity & Access Manager',
  description: 'quality control solution for finance industry. Implements zero-trust security architecture with continuous authentication and adaptive access controls.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quality-control-zero-trust-identity--access-manager-7544a0cc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quality Control Zero-Trust Identity & Access Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            quality control solution for finance industry. Implements zero-trust security architecture with continuous authentication and adaptive access controls.
          </p>
