...
export const metadata: Metadata = {
  title: 'Neural Monitoring for Legal',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Monitoring for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Neural Monitoring for Legal leverages advanced machine learning to deliver supply chain at scale.
          </p>
