...
export const metadata: Metadata = {
  title: 'Drug Discovery AI Customer Churn Prediction',
  description: 'drug discovery solution for museums industry. Identifies at-risk customers before they churn using behavioral patterns and engagement metrics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/drug-discovery-ai-customer-churn-prediction-32910cbc',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Drug Discovery AI Customer Churn Prediction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            drug discovery solution for museums industry. Identifies at-risk customers before they churn using behavioral patterns and engagement metrics.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your museums operations?</p>
