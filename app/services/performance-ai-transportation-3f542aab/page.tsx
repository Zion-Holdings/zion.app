...
export const metadata: Metadata = {
  title: 'Performance AI - Transportation',
  description: 'Transform your transportation operations with our Performance AI - Transportation. This AI-driven solution provides intelligent automation with unprecedented ac',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Performance AI - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your transportation operations with our Performance AI - Transportation. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
