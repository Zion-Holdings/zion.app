...
export const metadata: Metadata = {
  ...
  keywords: 'Regulatory-First Architecture, Human-in-the-Loop & Oversight, Bias & Fairness Monitoring, Documentation & Transparency, Sector-Specific Workflows, Vendor & Model Governance, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI for Regulated Industries</h1>
        <p className="text-lg text-slate-300 mb-8">AI solutions built for healthcare, finance, legal, and government. HIPAA, SOC 2, GDPR, and EU AI Act–ready with audit trails and human oversight.</p>
        ...
        <li class="text-slate-300">Regulatory-First Architecture</li>
        <li class="text-slate-300">Human-in-the-Loop &amp; Oversight</li>
        <li class="text-slate-300">Bias &amp; Fairness Monitoring</li>
        <li class="text-slate-300">Documentation &amp; Transparency</li>
        <li class="text-slate-300">Sector-Specific Workflows</li>
        <li class="text-slate-300">Vendor &amp; Model Governance</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai for regulated industries</li>
