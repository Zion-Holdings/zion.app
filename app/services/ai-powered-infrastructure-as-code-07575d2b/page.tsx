...
export const metadata: Metadata = {
  title: "Service - AI-Powered DevOps Solution",
  description: "Generates and optimizes Terraform/CloudFormation templates from architecture diagrams.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-infrastructure-as-code-07575d2b",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Service - AI-Powered DevOps Solution
        </h1>
