...
export const metadata: Metadata = {
  title: 'Next-Gen Data Science for PROPTECH #1',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Data Science for PROPTECH #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in proptech with Next-Gen Data Science for PROPTECH #1. This AI-powered platform transforms low-code automation into a competitive advantage.
          </p>
