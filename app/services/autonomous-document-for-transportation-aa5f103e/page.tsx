...
export const metadata: Metadata = {
  title: 'Autonomous Document for Transportation',
  description: 'Transform your transportation operations with our Autonomous Document for Transportation. This AI-driven solution automates logistics route optimization with un',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-document-for-transportation-aa5f103e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Document for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your transportation operations with our Autonomous Document for Transportation. This AI-driven solution automates logistics route optimization with unprecedented accuracy and efficiency.
          </p>
