...
export const metadata: Metadata = {
  ...
  description: 'shipping integration solution for personal care industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/shipping-integration-ai-sales-lead-scoring-engine-5e89190d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            shipping integration solution for personal care industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.
          </p>
