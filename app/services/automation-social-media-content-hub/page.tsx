  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Social Media Content Hub &amp; Publisher</h1>
        <p className="text-lg text-slate-300 mb-8">All-in-one social media content hub: AI-assisted content ideation and drafting per platform, content calendar, multi-platform publishing (LinkedIn, X/Twitter, Instagram, Facebook, TikTok, YouTube), real-time engagement monitoring, and weekly performance reporting.</p>
        ...
        <li class="text-slate-300">AI content drafting: platform-optimised posts per network with tone + brand voice pre-trained</li>
        <li class="text-slate-300">Content calendar kanban: quarterly calendar with drag-drop scheduling per platform</li>
        <li class="text-slate-300">Bulk publishing: schedule 50+ posts across 6 platforms in one session with platform-native format</li>
        <li class="text-slate-300">Real-time engagement: mentions, DMs, comments all in one inbox with AI-suggested replies</li>
        <li class="text-slate-300">Weekly performance report: top-performing content type, audience growth trend, best posting time slot</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with social media content hub &amp; publisher</li>
