...
export const metadata: Metadata = {
  ...
  description: 'Real-time credit risk scoring using alternative data, behavioral patterns, and predictive analytics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-credit-risk-assessment-engine2026-07-28t0402472906160000165-ed0b6e38',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Real-time credit risk scoring using alternative data, behavioral patterns, and predictive analytics.
          </p>
