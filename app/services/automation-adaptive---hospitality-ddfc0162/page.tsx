...
export const metadata: Metadata = {
  title: 'Automation Adaptive - Hospitality',
  description: 'Transform your hospitality operations with our Automation Adaptive - Hospitality. This AI-driven solution automates fraud prevention with unprecedented accuracy',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automation-adaptive---hospitality-ddfc0162',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automation Adaptive - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Automation Adaptive - Hospitality. This AI-driven solution automates fraud prevention with unprecedented accuracy and efficiency.
          </p>
