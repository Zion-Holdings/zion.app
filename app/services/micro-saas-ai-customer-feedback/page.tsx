...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'AI Customer Feedback Analyzer & NPS Platform', 'description': 'Collect, analyze, and act on customer feedback from surveys, reviews, support tickets, and social media. AI identifies themes, sentiment, and priority actions.', 'serviceType': 'ai', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'customer-success'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'AI Customer Feedback Analyzer & NPS Platform Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$99/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$299/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': 'Custom', 'priceCurrency': 'USD'}]}} />
    <JsonLd data={'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'Multi-channel feedback collection', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Multi-channel feedback collection'}}, {'@type': 'Question', 'name': 'AI theme extraction and clustering', 'acceptedAnswer': {'@type': 'Answer', 'text': 'AI theme extraction and clustering'}}, {'@type': 'Question', 'name': 'Sentiment analysis with emotion detection', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Sentiment analysis with emotion detection'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Understand customer sentiment in real-time; Identify product issues before they escalate; Increase NPS by 15+ points with closed-loop follow-up'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} />
