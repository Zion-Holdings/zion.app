...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-channel feedback collection, AI theme extraction and clustering, Sentiment analysis with emotion detection, NPS, CSAT, and CES scoring with trend analysis, Automated follow-up for detractors, Integration with CRM, helpdesk, and product tools, Executive dashboard with actionable insights, Custom alert rules for negative feedback spikes, ai, customer-success, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Customer Feedback Analyzer &amp; NPS Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Collect, analyze, and act on customer feedback from surveys, reviews, support tickets, and social media. AI identifies themes, sentiment, and priority actions.</p>
        ...
        <li class="text-slate-300">Multi-channel feedback collection</li>
        <li class="text-slate-300">AI theme extraction and clustering</li>
        <li class="text-slate-300">Sentiment analysis with emotion detection</li>
        <li class="text-slate-300">NPS, CSAT, and CES scoring with trend analysis</li>
        <li class="text-slate-300">Automated follow-up for detractors</li>
        <li class="text-slate-300">Integration with CRM, helpdesk, and product tools</li>
        <li class="text-slate-300">Executive dashboard with actionable insights</li>
        <li class="text-slate-300">Custom alert rules for negative feedback spikes</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Understand customer sentiment in real-time</li>
        <li class="text-slate-300">Identify product issues before they escalate</li>
        <li class="text-slate-300">Increase NPS by 15+ points with closed-loop follow-up</li>
        <li class="text-slate-300">Unify feedback from all channels in one place</li>
      </ul>
        </div>
