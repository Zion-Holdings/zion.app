...
export const metadata: Metadata = {
  title: 'Predictive insights-proptech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive insights-proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation proptech solution: Predictive insights-proptech. Combines data processing with adaptive intelligence for optimal results.
          </p>
