...
export const metadata: Metadata = {
  title: 'Generator Cognitive - Cleantech',
  description: 'Next-generation cleantech solution: Generator Cognitive - Cleantech. Combines user experience with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/generator-cognitive---cleantech-e4fb4f80',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Generator Cognitive - Cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation cleantech solution: Generator Cognitive - Cleantech. Combines user experience with adaptive intelligence for optimal results.
          </p>
