...
export const metadata: Metadata = {
  title: 'Smart Security for Tech',
  description: 'Drive innovation in technology with Smart Security for Tech. This AI-powered platform transforms succession planning into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-security-for-tech-582ffafc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Security for Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in technology with Smart Security for Tech. This AI-powered platform transforms succession planning into a competitive advantage.
          </p>
