...
export const metadata: Metadata = {
  title: 'Manager Smart - Proptech',
  description: 'Revolutionize proptech through intelligent automation. Our Manager Smart - Proptech leverages advanced machine learning to deliver user experience at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/manager-smart---proptech-be3c9177',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manager Smart - Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our Manager Smart - Proptech leverages advanced machine learning to deliver user experience at scale.
          </p>
