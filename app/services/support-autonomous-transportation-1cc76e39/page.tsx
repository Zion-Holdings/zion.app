...
export const metadata: Metadata = {
  title: 'Support Autonomous - Transportation',
  description: 'The future of transportation is here with Support Autonomous - Transportation. Powered by cutting-edge AI, this platform delivers document processing like never',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/support-autonomous-transportation-1cc76e39',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Support Autonomous - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Support Autonomous - Transportation. Powered by cutting-edge AI, this platform delivers document processing like never before.
          </p>
