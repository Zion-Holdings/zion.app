...
export const metadata: Metadata = {
  title: 'Deep Learning Neural - Hospitality',
  description: 'Transform your hospitality operations with our Deep Learning Neural - Hospitality. This AI-driven solution automates leave management with unprecedented accurac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/deep-learning-neural-hospitality-8da6a70f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Deep Learning Neural - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Deep Learning Neural - Hospitality. This AI-driven solution automates leave management with unprecedented accuracy and efficiency.
          </p>
