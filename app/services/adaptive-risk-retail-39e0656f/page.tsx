...
export const metadata: Metadata = {
  title: 'Adaptive risk-retail',
  description: 'Revolutionize retail through intelligent automation. Our Adaptive risk-retail leverages advanced machine learning to deliver root cause analysis at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-risk-retail-39e0656f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive risk-retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize retail through intelligent automation. Our Adaptive risk-retail leverages advanced machine learning to deliver root cause analysis at scale.
          </p>
