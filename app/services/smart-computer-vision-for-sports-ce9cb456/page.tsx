...
export const metadata: Metadata = {
  title: 'Smart Computer Vision for Sports',
  description: 'Future-proof your sports with Smart Computer Vision for Sports. Our autonomous solution handles social media monitoring end-to-end without human intervention.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-computer-vision-for-sports-ce9cb456',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Computer Vision for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your sports with Smart Computer Vision for Sports. Our autonomous solution handles social media monitoring end-to-end without human intervention.
          </p>
