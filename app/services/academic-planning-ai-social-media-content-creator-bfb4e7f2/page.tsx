...
export const metadata: Metadata = {
  title: 'Academic Planning AI Social Media Content Creator',
  description: 'AI-powered academic planning solution for social media. Generates, schedules, and optimizes social media content across all platforms.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/academic-planning-ai-social-media-content-creator-bfb4e7f2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Academic Planning AI Social Media Content Creator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered academic planning solution for social media. Generates, schedules, and optimizes social media content across all platforms.
          </p>
