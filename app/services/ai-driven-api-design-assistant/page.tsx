...
export const metadata: Metadata = {
  ...
  keywords: 'Natural language to OpenAPI 3.0 spec, Schema validation & best practice linting, Auto-generated client SDKs (10+ languages), Mock server with configurable responses, Breaking change detection across versions, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Driven API Design Assistant</h1>
        <p className="text-lg text-slate-300 mb-8">Design, document, and validate APIs using natural language specs; auto-generate OpenAPI/Swagger definitions, SDKs, and mock servers.</p>
        ...
        <li class="text-slate-300">Natural language to OpenAPI 3.0 spec</li>
        <li class="text-slate-300">Schema validation &amp; best practice linting</li>
        <li class="text-slate-300">Auto-generated client SDKs (10+ languages)</li>
        <li class="text-slate-300">Mock server with configurable responses</li>
        <li class="text-slate-300">Breaking change detection across versions</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai-driven api design assistant</li>
