      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Design, document, and validate APIs using natural language specs; auto-generate OpenAPI/Swagger definitions, SDKs, and mock servers.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Natural language to OpenAPI 3.0 spec</li>
            <li className="text-purple-300">✓ Schema validation & best practice linting</li>
            <li className="text-purple-300">✓ Auto-generated client SDKs (10+ languages)</li>
            <li className="text-purple-300">✓ Mock server with configurable responses</li>
            <li className="text-purple-300">✓ Breaking change detection across versions</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai-driven api design assistant</li>
