...
export const metadata: Metadata = {
  title: 'Cognitive Optimizer System',
  description: 'Transform your transportation operations with our Cognitive Optimizer System. This it solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-optimizer-system-670923',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Optimizer System
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your transportation operations with our Cognitive Optimizer System. This it solution delivers unprecedented automation and intelligence.
          </p>
