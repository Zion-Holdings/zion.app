...
export const metadata: Metadata = {
  title: 'Neural Advisor for Startup',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Advisor for Startup
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your startup with Neural Advisor for Startup. Our autonomous solution handles scenario planning end-to-end without human intervention.
          </p>
