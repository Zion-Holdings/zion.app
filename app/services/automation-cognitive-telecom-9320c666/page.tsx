...
export const metadata: Metadata = {
  title: 'Automation Cognitive - Telecom',
  description: 'Unlock unprecedented growth with Automation Cognitive - Telecom. This autonomous system provides project portfolio with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automation-cognitive-telecom-9320c666',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automation Cognitive - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Automation Cognitive - Telecom. This autonomous system provides project portfolio with zero manual intervention needed.
          </p>
