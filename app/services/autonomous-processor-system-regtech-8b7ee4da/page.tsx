...
export const metadata: Metadata = {
  title: 'Autonomous Processor System - REGTECH',
  description: 'Drive innovation in regtech with Autonomous Processor System - REGTECH. This AI-powered platform transforms event-driven architecture into a competitive advanta',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Processor System - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in regtech with Autonomous Processor System - REGTECH. This AI-powered platform transforms event-driven architecture into a competitive advantage.
          </p>
