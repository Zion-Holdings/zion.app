...
export const metadata: Metadata = {
  title: 'AI-Driven Analytics for Media',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Driven Analytics for Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your media business with AI-Driven Analytics for Media. Our solution provides net promoter score with enterprise-grade reliability and security.
          </p>
