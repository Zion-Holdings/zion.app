...
export const metadata: Metadata = {
  title: 'Supply Autonomous - Agriculture',
  description: 'Optimize your agriculture workflows with Supply Autonomous - Agriculture. This intelligent platform delivers model interpretability through advanced automation ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/supply-autonomous-agriculture-f908aee4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Supply Autonomous - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your agriculture workflows with Supply Autonomous - Agriculture. This intelligent platform delivers model interpretability through advanced automation and AI.
          </p>
