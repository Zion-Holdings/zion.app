...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{'@context': 'https://schema.org', '@type': 'Service', 'name': 'Customer Feedback Analyzer', 'description': 'Unified NLP-powered analysis across reviews, surveys, support tickets, and social mentions. Surfaces sentiment trends, emerging issues, and feature requests — turning unstructured feedback into strategic product intelligence.', 'serviceType': 'micro-saas', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'Customer Experience'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'Customer Feedback Analyzer Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '0', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '997', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': '2497', 'priceCurrency': 'USD'}]}} }/>
    <JsonLd data={{'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'Multi-source ingestion (reviews, NPS, Zendesk, social)', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Multi-source ingestion (reviews, NPS, Zendesk, social)'}}, {'@type': 'Question', 'name': 'Sentiment analysis with emotion detection', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Sentiment analysis with emotion detection'}}, {'@type': 'Question', 'name': 'Topic modeling & theme clustering', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Topic modeling & theme clustering'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Understand customers at scale without reading every ticket; Spot churn risks early from sentiment shifts; Prioritize product roadmap with real data, not guesses'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} }/>
