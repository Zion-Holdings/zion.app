...
export const metadata: Metadata = {
  title: 'AI/IT Optimizer Suite - Cybersecurity',
  description: 'Quantum leap forward for cybersecurity: AI/IT Optimizer Suite - Cybersecurity. Uses quantum-inspired algorithms to deliver business intelligence at exponential ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Optimizer Suite - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for cybersecurity: AI/IT Optimizer Suite - Cybersecurity. Uses quantum-inspired algorithms to deliver business intelligence at exponential speed.
          </p>
