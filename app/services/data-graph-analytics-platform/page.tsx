...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'Graph Analytics & Network Intelligence', 'description': 'Large-scale network analytics: entity relationship graph builder, centrality and community detection, per-edge anomaly scoring, influencer score per node, GNN-ready feature export, and interactive graph visualisation dashboard.', 'serviceType': 'data', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'commercial@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'Marketing'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'Graph Analytics & Network Intelligence Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$149/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$449/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': '$1,499/mo', 'priceCurrency': 'USD'}]}} />
    <JsonLd data={'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'Entity and relationship graph builder from any structured or semi-structured data', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Entity and relationship graph builder from any structured or semi-structured data'}}, {'@type': 'Question', 'name': 'Community detection and centrality scoring per node highlighting key connectors', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Community detection and centrality scoring per node highlighting key connectors'}}, {'@type': 'Question', 'name': 'Per-edge anomaly scoring with three-sigma departure auto-alert', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Per-edge anomaly scoring with three-sigma departure auto-alert'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Reduce costs with graph analytics & network intelligence; Improve operational efficiency; Scale without complexity'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} />
