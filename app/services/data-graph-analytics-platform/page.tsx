...
export const metadata: Metadata = {
  ...
  keywords: 'Entity and relationship graph builder from any structured or semi-structured data, Community detection and centrality scoring per node highlighting key connectors, Per-edge anomaly scoring with three-sigma departure auto-alert, GNN-ready feature export for training ML fraud and influence detection models, data, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Large-scale network analytics: entity relationship graph builder, centrality and community detection, per-edge anomaly scoring, influencer score per node, GNN-ready feature export, and interactive graph visualisation dashboard.</p>
        ...
        <li class="text-slate-300">Entity and relationship graph builder from any structured or semi-structured data</li>
        <li class="text-slate-300">Community detection and centrality scoring per node highlighting key connectors</li>
        <li class="text-slate-300">Per-edge anomaly scoring with three-sigma departure auto-alert</li>
        <li class="text-slate-300">GNN-ready feature export for training ML fraud and influence detection models</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with graph analytics &amp; network intelligence</li>
