...
export const metadata: Metadata = {
  title: 'Adaptive User Monitoring',
  description: 'Drive innovation in hospitality with Adaptive User Monitoring. This AI-powered platform transforms data governance into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-user-monitoring-c83d83d3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive User Monitoring
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Adaptive User Monitoring. This AI-powered platform transforms data governance into a competitive advantage.
          </p>
