...
export const metadata: Metadata = {
  title: 'Smart Business Intelligence Platform - Finance',
  description: 'Revolutionize finance through intelligent automation. Our Smart Business Intelligence Platform - Finance leverages advanced machine learning to deliver lead sco',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Business Intelligence Platform - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our Smart Business Intelligence Platform - Finance leverages advanced machine learning to deliver lead scoring at scale.
          </p>
