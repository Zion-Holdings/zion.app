...
export const metadata: Metadata = {
  title: 'System Serverless - Transportation',
  description: 'Drive innovation in transportation with System Serverless - Transportation. This AI-powered platform transforms business intelligence into a competitive advanta',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/system-serverless-transportation-670a5b89',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            System Serverless - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in transportation with System Serverless - Transportation. This AI-powered platform transforms business intelligence into a competitive advantage.
          </p>
