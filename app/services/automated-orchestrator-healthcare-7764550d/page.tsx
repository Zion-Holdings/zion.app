...
export const metadata: Metadata = {
  title: 'Automated orchestrator-healthcare',
  description: 'Optimize your healthcare workflows with Automated orchestrator-healthcare. This intelligent platform delivers brand sentiment through advanced automation and AI',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-orchestrator-healthcare-7764550d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated orchestrator-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Automated orchestrator-healthcare. This intelligent platform delivers brand sentiment through advanced automation and AI.
          </p>
