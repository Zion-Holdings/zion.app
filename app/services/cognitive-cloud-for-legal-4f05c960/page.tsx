...
export const metadata: Metadata = {
  title: 'Cognitive Cloud for Legal',
  description: 'Unlock unprecedented growth with Cognitive Cloud for Legal. This autonomous system provides customer insights with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-cloud-for-legal-4f05c960',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Cloud for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Cognitive Cloud for Legal. This autonomous system provides customer insights with zero manual intervention needed.
          </p>
