...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time log correlation, MITRE ATT&CK grid view, UEBA - user behavior analytics, Automated incident tickets, Compliance dashboards, security, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">SIEM Security Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Cloud-native SIEM with real-time event correlation, MITRE ATT&amp;CK tracking, UEBA behavioral baselines, and automated incident ticketing for SOC teams.</p>
        ...
        <li class="text-slate-300">Real-time log correlation</li>
        <li class="text-slate-300">MITRE ATT&amp;CK grid view</li>
        <li class="text-slate-300">UEBA - user behavior analytics</li>
        <li class="text-slate-300">Automated incident tickets</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with siem security platform</li>
