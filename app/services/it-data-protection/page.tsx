...
export const metadata: Metadata = {
  ...
  keywords: 'Immutable and air-gapped backups, Instant VM and file-level recovery, Ransomware detection and automated isolation, Cross-site and cloud replication, Automated backup testing and verification, Integration with Veeam, Commvault, Rubrik, Compliance reporting for data retention, 24/7 monitoring and alerting, it, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Data Protection, Backup &amp; Ransomware Recovery</h1>
        <p className="text-lg text-slate-300 mb-8">Comprehensive data protection with immutable backups, air-gapped copies, and instant ransomware recovery. Achieve RPO under 1 hour and RTO under 15 minutes.</p>
        ...
        <li class="text-slate-300">Immutable and air-gapped backups</li>
        <li class="text-slate-300">Instant VM and file-level recovery</li>
        <li class="text-slate-300">Ransomware detection and automated isolation</li>
        <li class="text-slate-300">Cross-site and cloud replication</li>
        <li class="text-slate-300">Automated backup testing and verification</li>
        <li class="text-slate-300">Integration with Veeam, Commvault, Rubrik</li>
        <li class="text-slate-300">Compliance reporting for data retention</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Recover from ransomware in under 15 minutes</li>
        <li class="text-slate-300">Achieve RPO under 1 hour</li>
        <li class="text-slate-300">Automate backup testing and compliance</li>
        <li class="text-slate-300">Protect against data loss from any threat</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$1,000/mo</p>
