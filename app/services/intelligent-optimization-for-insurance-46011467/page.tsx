...
export const metadata: Metadata = {
  title: 'Intelligent Optimization for Insurance',
  description: 'Enhance your insurance business with Intelligent Optimization for Insurance. Our solution provides scalability planning with enterprise-grade reliability and se',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-optimization-for-insurance-46011467',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Optimization for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Intelligent Optimization for Insurance. Our solution provides scalability planning with enterprise-grade reliability and security.
          </p>
