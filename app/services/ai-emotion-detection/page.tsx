  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Emotion Detection &amp; Customer Experience Analytics</h1>
        <p className="text-lg text-slate-300 mb-8">AI that detects customer emotions in real-time across voice, chat, and video. Improve customer experience by understanding how customers feel at every interaction.</p>
        ...
        <li class="text-slate-300">Real-time emotion detection from voice (calls)</li>
        <li class="text-slate-300">Text emotion analysis (chat, email, social)</li>
        <li class="text-slate-300">Video emotion analysis (facial expressions)</li>
        <li class="text-slate-300">Agent guidance based on detected emotions</li>
        <li class="text-slate-300">Integration with contact center platforms</li>
        <li class="text-slate-300">Customer journey emotion mapping</li>
        <li class="text-slate-300">Training recommendations for agents</li>
        <li class="text-slate-300">GDPR/privacy-compliant processing</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Understand customer emotions at every touchpoint</li>
        <li class="text-slate-300">Improve CSAT by 20% with emotion-aware service</li>
        <li class="text-slate-300">Train agents with real emotion data</li>
        <li class="text-slate-300">Deliver empathetic customer experiences at scale</li>
      </ul>
        </div>
