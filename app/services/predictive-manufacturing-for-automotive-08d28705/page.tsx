...
export const metadata: Metadata = {
  title: 'Predictive Manufacturing for Automotive',
  description: 'Revolutionize automotive through intelligent automation. Our Predictive Manufacturing for Automotive leverages advanced machine learning to deliver compliance m',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize automotive through intelligent automation. Our Predictive Manufacturing for Automotive leverages advanced machine learning to deliver compliance monitoring at scale.
          </p>
