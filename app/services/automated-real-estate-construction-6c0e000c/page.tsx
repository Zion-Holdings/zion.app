...
export const metadata: Metadata = {
  title: 'Automated real estate-construction',
  description: 'The future of construction is here with Automated real estate-construction. Powered by cutting-edge AI, this platform delivers user experience like never before',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-real-estate-construction-6c0e000c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated real estate-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Automated real estate-construction. Powered by cutting-edge AI, this platform delivers user experience like never before.
          </p>
