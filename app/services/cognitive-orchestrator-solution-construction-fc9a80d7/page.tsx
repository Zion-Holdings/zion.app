...
export const metadata: Metadata = {
  ...
  description: 'Transform your construction operations with our Cognitive Orchestrator Solution - Construction. This AI-driven solution automates revenue forecasting with unpre',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Cognitive Orchestrator Solution - Construction. This AI-driven solution automates revenue forecasting with unprecedented accuracy and efficiency.
          </p>
