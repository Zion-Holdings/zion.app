...
export const metadata: Metadata = {
  title: "AI-Powered Edge AI Platform - AI-Powered IoT Solution",
  description: "Deploys and manages AI models at the edge with automatic optimization.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-edge-ai-platform-6ed5a898",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered Edge AI Platform - AI-Powered IoT Solution
        </h1>
