...
export const metadata: Metadata = {
  title: 'AI Analytics - Legal Edition',
  description: 'Optimize your legal workflows with AI Analytics - Legal Edition. This intelligent platform delivers incident response through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-analytics-legal-edition-b02d71f9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Analytics - Legal Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your legal workflows with AI Analytics - Legal Edition. This intelligent platform delivers incident response through advanced automation and AI.
          </p>
