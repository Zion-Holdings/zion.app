...
export const metadata: Metadata = {
  title: 'Intelligent Security for Logistics #5',
  description: 'Revolutionize logistics through intelligent automation. Our Intelligent Security for Logistics #5 leverages advanced machine learning to deliver compliance moni',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-security-for-logistics-5-a98a4004',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Security for Logistics #5
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Intelligent Security for Logistics #5 leverages advanced machine learning to deliver compliance monitoring at scale.
          </p>
