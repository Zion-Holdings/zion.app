...
export const metadata: Metadata = {
  title: 'Orbital Debris Risk Mapper',
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Orbital Debris Risk Mapper
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Maps and predicts orbital debris risk for satellite operators and space missions.
          </p>
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-purple-900/30 text-purple-300 text-sm">
            <span className="mr-2">💡</span>
            <span>Space Safety</span>
          </div>
        </div>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your space safety operations?</p>
