...
export const metadata: Metadata = {
  title: 'Cognitive Autonomous for Energy #1',
  description: 'Drive innovation in energy with Cognitive Autonomous for Energy #1. This AI-powered platform transforms employee engagement into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-autonomous-for-energy-1-e15cbdd8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Autonomous for Energy #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Cognitive Autonomous for Energy #1. This AI-powered platform transforms employee engagement into a competitive advantage.
          </p>
