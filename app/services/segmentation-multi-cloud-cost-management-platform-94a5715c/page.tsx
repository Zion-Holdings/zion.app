...
export const metadata: Metadata = {
  title: 'Segmentation Multi-Cloud Cost Management Platform',
  description: 'segmentation solution for entertainment industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/segmentation-multi-cloud-cost-management-platform-94a5715c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Segmentation Multi-Cloud Cost Management Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            segmentation solution for entertainment industry. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.
          </p>
