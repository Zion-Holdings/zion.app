...
export const metadata: Metadata = {
  ...
  keywords: 'Identity-centric security architecture, Micro-segmentation of network resources, Continuous authentication and authorization, Device trust scoring, Least-privilege access enforcement, SIEM and SOAR integration, Compliance mapping (NIST, ISO 27001), 24/7 security monitoring, it, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Zero Trust Security Architecture Implementation</h1>
        <p className="text-lg text-slate-300 mb-8">Complete zero trust security framework including identity verification, micro-segmentation, and continuous authentication.</p>
        ...
        <li class="text-slate-300">Identity-centric security architecture</li>
        <li class="text-slate-300">Micro-segmentation of network resources</li>
        <li class="text-slate-300">Continuous authentication and authorization</li>
        <li class="text-slate-300">Device trust scoring</li>
        <li class="text-slate-300">Least-privilege access enforcement</li>
        <li class="text-slate-300">SIEM and SOAR integration</li>
        <li class="text-slate-300">Compliance mapping (NIST, ISO 27001)</li>
        <li class="text-slate-300">24/7 security monitoring</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Eliminate implicit trust in networks</li>
        <li class="text-slate-300">Reduce breach impact by 90%</li>
        <li class="text-slate-300">Meet compliance requirements</li>
        <li class="text-slate-300">Secure remote workforce</li>
      </ul>
        </div>
