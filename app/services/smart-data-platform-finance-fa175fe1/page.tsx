...
export const metadata: Metadata = {
  title: 'Smart Data Platform - Finance',
  description: 'Revolutionize finance through intelligent automation. Our Smart Data Platform - Finance leverages advanced machine learning to deliver customer retention at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Data Platform - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our Smart Data Platform - Finance leverages advanced machine learning to deliver customer retention at scale.
          </p>
