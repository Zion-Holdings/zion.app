...
export const metadata: Metadata = {
  ...
  keywords: 'Custom voice cloning, Emotional control, Multi-language (40+), Real-time streaming, SSML support, Voice design studio, API access, Usage analytics, ai, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Enterprise Text-to-Speech Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Natural-sounding voice synthesis with custom voice cloning, emotional control, multi-language support, and real-time streaming. Perfect for IVR, media, and accessibility.</p>
        ...
        <li class="text-slate-300">Emotional control</li>
        <li class="text-slate-300">Multi-language (40+)</li>
        <li class="text-slate-300">Real-time streaming</li>
        <li class="text-slate-300">SSML support</li>
        <li class="text-slate-300">Voice design studio</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Natural-sounding voices</li>
        <li class="text-slate-300">Custom brand voices</li>
        <li class="text-slate-300">Low-latency streaming</li>
        <li class="text-slate-300">40+ languages</li>
        <li class="text-slate-300">Scalable infrastructure</li>
      </ul>
        </div>
