...
export const metadata: Metadata = {
  title: 'Performance AI-Powered Lead Scoring & Routing',
  description: 'AI-powered performance solution for sales. Scores and routes sales leads in real-time based on engagement.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/performance-ai-powered-lead-scoring--routing-1c6060da',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Performance AI-Powered Lead Scoring & Routing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered performance solution for sales. Scores and routes sales leads in real-time based on engagement.
          </p>
