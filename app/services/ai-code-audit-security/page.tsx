      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Comprehensive static analysis powered by AI: detect vulnerabilities, code smells, license compliance issues, and security anti-patterns before they reach production.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Static Application Security Testing (SAST)</li>
            <li className="text-purple-300">✓ Secrets & credential leakage detection</li>
            <li className="text-purple-300">✓ Dependency vulnerability scanning</li>
            <li className="text-purple-300">✓ License compliance & risk assessment</li>
            <li className="text-purple-300">✓ Remediation guidance with code suggestions</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai code audit & security scanner</li>
