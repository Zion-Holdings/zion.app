...
export const metadata: Metadata = {
  ...
  keywords: 'Static Application Security Testing (SAST), Secrets & credential leakage detection, Dependency vulnerability scanning, License compliance & risk assessment, Remediation guidance with code suggestions, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Code Audit &amp; Security Scanner</h1>
        <p className="text-lg text-slate-300 mb-8">Comprehensive static analysis powered by AI: detect vulnerabilities, code smells, license compliance issues, and security anti-patterns before they reach production.</p>
        ...
        <li class="text-slate-300">Secrets &amp; credential leakage detection</li>
        <li class="text-slate-300">Dependency vulnerability scanning</li>
        <li class="text-slate-300">License compliance &amp; risk assessment</li>
        <li class="text-slate-300">Remediation guidance with code suggestions</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai code audit &amp; security scanner</li>
