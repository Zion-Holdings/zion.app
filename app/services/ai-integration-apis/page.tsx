      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Integrate AI into existing systems with unified APIs, event-driven pipelines, and enterprise connectors. One integration layer across LLMs, agents,...
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Unified AI API Layer</li>
            <li className="text-purple-300">✓ Enterprise Connectors</li>
            <li className="text-purple-300">✓ Event-Driven Pipelines</li>
            <li className="text-purple-300">✓ Structured Outputs & Orchestration</li>
            <li className="text-purple-300">✓ Security & Access Control</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai integration & apis</li>
