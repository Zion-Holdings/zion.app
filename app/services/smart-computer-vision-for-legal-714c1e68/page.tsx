...
export const metadata: Metadata = {
  title: 'Smart Computer Vision for Legal',
  description: 'Transform your legal operations with our Smart Computer Vision for Legal. This AI-driven solution provides intelligent automation with unprecedented accuracy an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-computer-vision-for-legal-714c1e68',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Computer Vision for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Smart Computer Vision for Legal. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
