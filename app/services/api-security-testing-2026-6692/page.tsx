...
export const metadata = {
  ...
  alternates: { canonical: '/services/api-security-testing-2026-6692/' },

  openGraph: {
    title: 'API Security Testing | Zion Tech Group',
    description: 'End-to-end api security testing services: assessment, deployment, and managed operations.',
    url: 'https://ziontechgroup.com/services/api-security-testing-2026-6692/',
...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={@context: "https://schema.org", @type: "Service", name: "API Security Testing | Zion Tech Group", description: "End-to-end api security testing services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/api-security-testing-2026-6692/"} />
