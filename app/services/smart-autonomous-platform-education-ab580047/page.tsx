...
export const metadata: Metadata = {
  title: 'Smart Autonomous Platform - Education',
  description: 'The future of education is here with Smart Autonomous Platform - Education. Powered by cutting-edge AI, this platform delivers project portfolio like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-autonomous-platform-education-ab580047',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Autonomous Platform - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of education is here with Smart Autonomous Platform - Education. Powered by cutting-edge AI, this platform delivers project portfolio like never before.
          </p>
