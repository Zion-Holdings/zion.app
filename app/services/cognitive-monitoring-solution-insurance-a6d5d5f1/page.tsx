...
export const metadata: Metadata = {
  title: 'Cognitive Monitoring Solution - Insurance',
  description: 'The future of insurance is here with Cognitive Monitoring Solution - Insurance. Powered by cutting-edge AI, this platform delivers project portfolio like never ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-monitoring-solution-insurance-a6d5d5f1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Monitoring Solution - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Cognitive Monitoring Solution - Insurance. Powered by cutting-edge AI, this platform delivers project portfolio like never before.
          </p>
