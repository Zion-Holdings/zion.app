...
export const metadata: Metadata = {
  title: 'Cognitive Adaptive - Hospitality',
  description: 'Quantum leap forward for hospitality: Cognitive Adaptive - Hospitality. Uses quantum-inspired algorithms to deliver social media automation at exponential speed',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-adaptive-hospitality-d594ce7e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Adaptive - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for hospitality: Cognitive Adaptive - Hospitality. Uses quantum-inspired algorithms to deliver social media automation at exponential speed.
          </p>
