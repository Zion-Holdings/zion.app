...
export const metadata: Metadata = {
  title: 'Autonomous Sales for PROPTECH',
  description: 'The future of proptech is here with Autonomous Sales for PROPTECH. Powered by cutting-edge AI, this platform delivers predictive modeling like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-sales-for-proptech-6313e329',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Sales for PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of proptech is here with Autonomous Sales for PROPTECH. Powered by cutting-edge AI, this platform delivers predictive modeling like never before.
          </p>
