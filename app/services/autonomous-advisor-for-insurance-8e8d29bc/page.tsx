...
export const metadata: Metadata = {
  title: 'Autonomous Advisor for Insurance',
  description: 'Transform your insurance operations with our Autonomous Advisor for Insurance. This AI-driven solution automates inventory management with unprecedented accurac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-advisor-for-insurance-8e8d29bc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Advisor for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Autonomous Advisor for Insurance. This AI-driven solution automates inventory management with unprecedented accuracy and efficiency.
          </p>
