...
export const metadata: Metadata = {
  title: 'Cognitive platform-healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Cognitive platform-healthcare leverages advanced machine learning to deliver quality control at sca',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-platform-healthcare-c43d98cc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive platform-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Cognitive platform-healthcare leverages advanced machine learning to deliver quality control at scale.
          </p>
