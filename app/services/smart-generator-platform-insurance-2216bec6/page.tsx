  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Smart Generator Platform - Insurance</h1>
        <p className="text-lg text-gray-300 mb-8">The future of insurance is here with Smart Generator Platform - Insurance. Powered by cutting-edge AI, this platform delivers contract analysis like never before.</p>
