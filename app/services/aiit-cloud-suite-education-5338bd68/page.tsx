...
export const metadata: Metadata = {
  title: 'AI/IT Cloud Suite - Education',
  description: 'Quantum leap forward for education: AI/IT Cloud Suite - Education. Uses quantum-inspired algorithms to deliver business process at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-cloud-suite-education-5338bd68',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Cloud Suite - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for education: AI/IT Cloud Suite - Education. Uses quantum-inspired algorithms to deliver business process at exponential speed.
          </p>
