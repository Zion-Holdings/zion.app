...
export const metadata: Metadata = {
  title: 'Smart NLP for Hospitality',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart NLP for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Smart NLP for Hospitality. Our solution provides financial risk management with enterprise-grade reliability and security.
          </p>
