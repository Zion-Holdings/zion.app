...
export const metadata: Metadata = {
  title: 'Intelligent Process Mining for Logistics',
  description: 'Next-generation logistics solution: Intelligent Process Mining for Logistics. Combines executive dashboards with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-process-mining-for-logistics-1ea5d06b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Process Mining for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Intelligent Process Mining for Logistics. Combines executive dashboards with adaptive intelligence for optimal results.
          </p>
