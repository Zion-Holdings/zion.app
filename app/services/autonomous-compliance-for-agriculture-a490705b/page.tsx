...
export const metadata: Metadata = {
  title: 'Autonomous Compliance for Agriculture',
  description: 'Transform your agriculture operations with our Autonomous Compliance for Agriculture. This AI-driven solution automates customer insights with unprecedented acc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-compliance-for-agriculture-a490705b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Compliance for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Autonomous Compliance for Agriculture. This AI-driven solution automates customer insights with unprecedented accuracy and efficiency.
          </p>
