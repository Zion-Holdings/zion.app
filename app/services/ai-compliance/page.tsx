      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Automated compliance monitoring, risk assessment, and audit trail management for GDPR, HIPAA, SOC 2, and more.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Automated policy generation</li>
            <li className="text-purple-300">✓ Real-time compliance monitoring</li>
            <li className="text-purple-300">✓ Risk assessment scoring</li>
            <li className="text-purple-300">✓ Audit trail & reporting</li>
            <li className="text-purple-300">✓ Regulatory change alerts</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai compliance & regulatory</li>
