  ...
  <div className="min-h-screen bg-slate-950 text-white">
   ...
   <main className="min-h-screen bg-slate-950 py-20 px-4">
    <div className="container-page max-w-4xl mx-auto">
     <h1 className="text-4xl font-bold text-white mb-4">AI Compliance & Regulatory</h1>
     <p className="text-slate-300 text-lg mb-8">Automated compliance monitoring, risk assessment, and audit trail management for GDPR, HIPAA, SOC 2, and more.</p>
