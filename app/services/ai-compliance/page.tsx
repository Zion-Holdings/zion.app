...
export const metadata: Metadata = {
  ...
  keywords: 'Automated policy generation, Real-time compliance monitoring, Risk assessment scoring, Audit trail & reporting, Regulatory change alerts, ai, Healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Compliance &amp; Regulatory</h1>
        <p className="text-lg text-slate-300 mb-8">Automated compliance monitoring, risk assessment, and audit trail management for GDPR, HIPAA, SOC 2, and more.</p>
        ...
        <li class="text-slate-300">Automated policy generation</li>
        <li class="text-slate-300">Real-time compliance monitoring</li>
        <li class="text-slate-300">Risk assessment scoring</li>
        <li class="text-slate-300">Audit trail &amp; reporting</li>
        <li class="text-slate-300">Regulatory change alerts</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai compliance &amp; regulatory</li>
