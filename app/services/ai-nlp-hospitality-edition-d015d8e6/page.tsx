...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize hospitality through intelligent automation. Our AI NLP - Hospitality Edition leverages advanced machine learning to deliver enterprise-grade insig',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-nlp-hospitality-edition-d015d8e6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our AI NLP - Hospitality Edition leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
