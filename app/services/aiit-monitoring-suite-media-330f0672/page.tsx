...
export const metadata: Metadata = {
  title: 'AI/IT Monitoring Suite - Media',
  description: 'Hyper-accelerated media solution: AI/IT Monitoring Suite - Media. Combines generative ai with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-monitoring-suite-media-330f0672',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Monitoring Suite - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated media solution: AI/IT Monitoring Suite - Media. Combines generative ai with next-gen AI for maximum velocity.
          </p>
