...
export const metadata: Metadata = {
  ...
  keywords: 'Automated backup scheduling (hourly to daily), Point-in-time recovery for databases, Immutable backups for ransomware protection, Automated DR testing without production impact, Cross-region replication, Compliance retention policies, it, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Data Backup &amp; Recovery Service</h1>
        <p className="text-lg text-slate-300 mb-8">Comprehensive backup and recovery solution with automated backups, point-in-time recovery, and disaster recovery testing. Protect against ransomware, human error, and hardware failure.</p>
        ...
        <li class="text-slate-300">Automated backup scheduling (hourly to daily)</li>
        <li class="text-slate-300">Point-in-time recovery for databases</li>
        <li class="text-slate-300">Immutable backups for ransomware protection</li>
        <li class="text-slate-300">Automated DR testing without production impact</li>
        <li class="text-slate-300">Cross-region replication</li>
        <li class="text-slate-300">Compliance retention policies</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Recover from ransomware in hours not days</li>
        <li class="text-slate-300">Meet RPO/RTO requirements</li>
        <li class="text-slate-300">Automated DR testing ensures readiness</li>
        <li class="text-slate-300">Protect against accidental deletion</li>
      </ul>
        </div>
