...
export const metadata: Metadata = {
  title: 'AI-Powered Recruitment Process Mining',
  description: 'Enhance your technology business with AI-Powered Recruitment Process Mining. Our solution provides competitive intelligence with enterprise-grade reliability an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Recruitment Process Mining
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your technology business with AI-Powered Recruitment Process Mining. Our solution provides competitive intelligence with enterprise-grade reliability and security.
          </p>
