    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        ...
        <p className="text-xl text-slate-300 mb-8">
          Search across text, images, video, and audio with a single query. CLIP-based embeddings, natural language understanding, and real-time indexing for enterprise c
        </p>
