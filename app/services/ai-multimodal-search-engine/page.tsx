...
export const metadata: Metadata = {
  ...
  keywords: 'Cross-modal search (text, image, video, audio), CLIP and custom embeddings, Real-time indexing, Natural language queries, Integration with Elasticsearch, Pinecone, Weaviate, Access control and filtering, Search analytics dashboard, API and embeddable widget, ai, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Multimodal Search Engine</h1>
        <p className="text-lg text-slate-300 mb-8">Search across text, images, video, and audio with a single query. CLIP-based embeddings, natural language understanding, and real-time indexing for enterprise content.</p>
        ...
        <li class="text-slate-300">Cross-modal search (text, image, video, audio)</li>
        <li class="text-slate-300">CLIP and custom embeddings</li>
        <li class="text-slate-300">Real-time indexing</li>
        <li class="text-slate-300">Natural language queries</li>
        <li class="text-slate-300">Integration with Elasticsearch, Pinecone, Weaviate</li>
        <li class="text-slate-300">Access control and filtering</li>
        <li class="text-slate-300">Search analytics dashboard</li>
        <li class="text-slate-300">API and embeddable widget</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Find content across all media types</li>
        <li class="text-slate-300">Reduce search time by 70%</li>
        <li class="text-slate-300">Unified search experience</li>
