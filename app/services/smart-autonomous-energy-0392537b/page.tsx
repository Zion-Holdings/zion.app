...
export const metadata: Metadata = {
  title: 'Smart Autonomous - Energy',
  description: 'The future of energy is here with Smart Autonomous - Energy. Powered by cutting-edge AI, this platform delivers image recognition like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-autonomous-energy-0392537b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Autonomous - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Smart Autonomous - Energy. Powered by cutting-edge AI, this platform delivers image recognition like never before.
          </p>
