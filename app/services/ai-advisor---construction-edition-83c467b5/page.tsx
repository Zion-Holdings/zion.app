...
export const metadata: Metadata = {
  ...
  keywords: 'GDPR compliance, Offline capabilities, Zero-downtime updates, SOC 2 certified, optimization, construction, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Advisor - Construction Edition</h1>
        <p className="text-lg text-slate-300 mb-8">Next-generation construction solution: AI Advisor - Construction Edition. Combines decision support with adaptive intelligence for optimal results.</p>
