...
export const metadata: Metadata = {
  title: 'Smart Engine Platform - Tech',
  description: 'Transform your technology operations with our Smart Engine Platform - Tech. This AI-driven solution automates compliance reporting with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-engine-platform-tech-8b49bef4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Engine Platform - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your technology operations with our Smart Engine Platform - Tech. This AI-driven solution automates compliance reporting with unprecedented accuracy and efficiency.
          </p>
