...
export const metadata: Metadata = {
  title: 'Public Administration AI-Powered Log Management',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Public Administration AI-Powered Log Management
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered public administration solution for devops. Centralized log management with AI-powered analysis and alerting.
          </p>
