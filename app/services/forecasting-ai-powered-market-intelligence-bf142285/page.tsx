...
export const metadata: Metadata = {
  title: 'Forecasting AI-Powered Market Intelligence',
  description: 'forecasting solution for proptech industry. Monitors market trends, competitor activities, and industry news to provide actionable insights.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/forecasting-ai-powered-market-intelligence-bf142285',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Forecasting AI-Powered Market Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            forecasting solution for proptech industry. Monitors market trends, competitor activities, and industry news to provide actionable insights.
          </p>
