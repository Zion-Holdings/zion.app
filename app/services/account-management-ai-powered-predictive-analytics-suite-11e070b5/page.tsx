      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
            Account Management AI-Powered Predictive Analytics Suite
          </h1>
          
          <p className="text-xl text-slate-300 mb-8">
            account management solution for community organizations industry. End-to-end predictive analytics platform that forecasts market trends, customer behavior, and operational metrics with 95% accuracy.
          </p>
