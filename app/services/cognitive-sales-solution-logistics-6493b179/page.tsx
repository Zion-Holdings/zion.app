...
export const metadata: Metadata = {
  title: 'Cognitive Sales Solution - Logistics',
  description: 'The future of logistics is here with Cognitive Sales Solution - Logistics. Powered by cutting-edge AI, this platform delivers revenue forecasting like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-sales-solution-logistics-6493b179',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Sales Solution - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Cognitive Sales Solution - Logistics. Powered by cutting-edge AI, this platform delivers revenue forecasting like never before.
          </p>
