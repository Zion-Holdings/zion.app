...
export const metadata: Metadata = {
  ...
  description: 'Evidence-based clinical decision support system that provides real-time recommendations at point of care with integrated medical knowledge.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-clinical-decision-support2026-07-28t0659148259580000-369a2f64',
  },
  ...
  return (
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Evidence-based clinical decision support system that provides real-time recommendations at point of care with integrated medical knowledge.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Evidence integration</li>
          <li className="text-gray-300">Real-time alerts</li>
          <li className="text-gray-300">Care coordination</li>
          </ul>
        </section>
    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Evidence-based clinical decision support system that provides real-time recommendations at point of care with integrated medical knowledge.</p>
