...
export const metadata: Metadata = {
  title: 'Analyzer Smart - Agriculture',
  description: 'The future of agriculture is here with Analyzer Smart - Agriculture. Powered by cutting-edge AI, this platform delivers logistics route optimization like never ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/analyzer-smart-agriculture-bb72443e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Analyzer Smart - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Analyzer Smart - Agriculture. Powered by cutting-edge AI, this platform delivers logistics route optimization like never before.
          </p>
