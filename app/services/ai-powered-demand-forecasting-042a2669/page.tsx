...
export const metadata: Metadata = {
  ...
  description: 'Accurate demand forecasting using time-series analysis, seasonality detection, and external factors.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-demand-forecasting-042a2669',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Accurate demand forecasting using time-series analysis, seasonality detection, and external factors.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Time-series forecasting</li>
