...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize gaming through intelligent automation. Our Intelligent Quality Platform leverages advanced machine learning to deliver anomaly detection at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-quality-platform-94cf53a4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize gaming through intelligent automation. Our Intelligent Quality Platform leverages advanced machine learning to deliver anomaly detection at scale.
          </p>
