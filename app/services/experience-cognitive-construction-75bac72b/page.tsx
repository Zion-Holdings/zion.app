...
export const metadata: Metadata = {
  title: 'Experience Cognitive - Construction',
  description: 'Transform your construction operations with our Experience Cognitive - Construction. This AI-driven solution automates predictive modeling with unprecedented ac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/experience-cognitive-construction-75bac72b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Experience Cognitive - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Experience Cognitive - Construction. This AI-driven solution automates predictive modeling with unprecedented accuracy and efficiency.
          </p>
