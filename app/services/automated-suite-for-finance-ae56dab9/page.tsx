...
export const metadata: Metadata = {
  title: 'Automated Suite for Finance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Suite for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in finance with Automated Suite for Finance. This AI-powered platform transforms anomaly detection into a competitive advantage.
          </p>
