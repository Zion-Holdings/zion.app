...
export const metadata: Metadata = {
  title: 'AI/IT Quality Suite - ALTHEALTH',
  description: 'Drive innovation in althealth with AI/IT Quality Suite - ALTHEALTH. This AI-powered platform transforms record extraction into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-quality-suite-althealth-f8adafbf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Quality Suite - ALTHEALTH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in althealth with AI/IT Quality Suite - ALTHEALTH. This AI-powered platform transforms record extraction into a competitive advantage.
          </p>
