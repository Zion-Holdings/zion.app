...
export const metadata: Metadata = {
  title: 'Next-Gen Data Science - Ecommerce',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Data Science - Ecommerce
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform ecommerce with Next-Gen Data Science - Ecommerce - the intelligent automation platform that learns, adapts, and delivers 10x results.
          </p>
