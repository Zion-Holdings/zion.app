...
export const metadata: Metadata = {
  title: 'AI-Powered Pharmacy Optimization',
  description: 'Optimizes pharmacy operations with inventory and prescription management.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-pharmacy-optimization-a832ad14',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Pharmacy Optimization
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimizes pharmacy operations with inventory and prescription management.
          </p>
