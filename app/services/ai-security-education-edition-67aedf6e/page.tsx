...
export const metadata: Metadata = {
  ...
  description: 'The future of education is here with AI Security - Education Edition. Powered by cutting-edge AI, this platform delivers transformative results like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-security-education-edition-67aedf6e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of education is here with AI Security - Education Edition. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
