...
export const metadata: Metadata = {
  ...
  description: 'Enhance your logistics business with AI Automation - Logistics Edition. Our solution provides data processing with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-automation-logistics-edition-9359d77c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with AI Automation - Logistics Edition. Our solution provides data processing with enterprise-grade reliability and security.
          </p>
