...
export const metadata: Metadata = {
  title: 'AI Suite - Real-Estate Edition',
  description: 'The future of real-estate is here with AI Suite - Real-Estate Edition. Powered by cutting-edge AI, this platform delivers regulatory tracking like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-suite-real-estate-edition-fc0a6bbb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Suite - Real-Estate Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of real-estate is here with AI Suite - Real-Estate Edition. Powered by cutting-edge AI, this platform delivers regulatory tracking like never before.
          </p>
