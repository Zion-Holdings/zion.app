...
export const metadata: Metadata = {
  title: 'Enterprise Data Science - Hospitality',
  description: 'Transform your hospitality operations with our Enterprise Data Science - Hospitality. This AI-driven solution automates inventory management with unprecedented ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-data-science-hospitality-7d68f6d6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Data Science - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Enterprise Data Science - Hospitality. This AI-driven solution automates inventory management with unprecedented accuracy and efficiency.
          </p>
