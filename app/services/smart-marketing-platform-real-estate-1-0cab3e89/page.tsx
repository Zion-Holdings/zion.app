...
export const metadata: Metadata = {
  title: 'Smart Marketing Platform - Real-Estate #1',
  description: 'Drive innovation in real-estate with Smart Marketing Platform - Real-Estate #1. This AI-powered platform transforms sales process optimization into a competitiv',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Marketing Platform - Real-Estate #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in real-estate with Smart Marketing Platform - Real-Estate #1. This AI-powered platform transforms sales process optimization into a competitive advantage.
          </p>
