...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-platform scheduling (6 platforms), AI content suggestions, Optimal posting time detection, Hashtag recommendations, Analytics and engagement tracking, Team collaboration, Content calendar view, Bulk upload and scheduling, micro-saas, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">PostPilot — Social Media Scheduler Micro-SaaS</h1>
        <p className="text-lg text-slate-300 mb-8">Multi-platform social media scheduling with AI content suggestions, optimal posting times, and analytics. Supports Instagram, Twitter/X, LinkedIn, Facebook, and TikTok.</p>
        ...
        <li class="text-slate-300">Multi-platform scheduling (6 platforms)</li>
        <li class="text-slate-300">AI content suggestions</li>
        <li class="text-slate-300">Optimal posting time detection</li>
        <li class="text-slate-300">Hashtag recommendations</li>
        <li class="text-slate-300">Analytics and engagement tracking</li>
        <li class="text-slate-300">Team collaboration</li>
        <li class="text-slate-300">Content calendar view</li>
        <li class="text-slate-300">Bulk upload and scheduling</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Save 10+ hours/week on social media</li>
        <li class="text-slate-300">Increase engagement with optimal timing</li>
        <li class="text-slate-300">AI-powered content ideas</li>
        <li class="text-slate-300">Unified social media management</li>
      </ul>
        </div>
