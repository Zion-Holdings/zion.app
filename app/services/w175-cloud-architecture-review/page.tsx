...
export const metadata: Metadata = {
  ...
  keywords: 'Well-Architected Framework assessment (AWS/Azure/GCP), Cost optimization recommendations, Security hardening and gap remediation, Reliability and resiliency improvements, Architecture diagrams and documentation, Prioritized remediation roadmap, Reference architecture alignment, cloud, Cloud Computing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Cloud Architecture Review</h1>
        <p className="text-lg text-slate-300 mb-8">Expert review of your cloud architecture: Well-Architected Framework assessment, cost optimization, security hardening, and reliability improvements.</p>
        ...
        <li class="text-slate-300">Well-Architected Framework assessment (AWS/Azure/GCP)</li>
        <li class="text-slate-300">Cost optimization recommendations</li>
        <li class="text-slate-300">Security hardening and gap remediation</li>
        <li class="text-slate-300">Reliability and resiliency improvements</li>
        <li class="text-slate-300">Architecture diagrams and documentation</li>
        <li class="text-slate-300">Prioritized remediation roadmap</li>
        <li class="text-slate-300">Reference architecture alignment</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Identify risks before they become incidents</li>
        <li class="text-slate-300">Cost optimization saves 20-40%</li>
        <li class="text-slate-300">Well-Architected alignment for production readiness</li>
        <li class="text-slate-300">Prioritized roadmap focuses effort</li>
      </ul>
        </div>
