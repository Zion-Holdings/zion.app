...
export const metadata: Metadata = {
  ...
  keywords: 'RESTful & GraphQL API design, Third-party API integrations, Webhook architecture & event systems, API gateway & rate limiting, API documentation & versioning (OpenAPI/Swagger), it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Custom API design, development, and integration — REST, GraphQL, Webhooks, and third-party service connectors.</p>
        ...
        <li class="text-slate-300">RESTful &amp; GraphQL API design</li>
        <li class="text-slate-300">Third-party API integrations</li>
        <li class="text-slate-300">Webhook architecture &amp; event systems</li>
        <li class="text-slate-300">API gateway &amp; rate limiting</li>
        <li class="text-slate-300">API documentation &amp; versioning (OpenAPI/Swagger)</li>
      </ul>
        </div>
