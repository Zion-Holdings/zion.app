...
export const metadata: Metadata = {
  title: "AI-Powered CRM Automation - AI-Powered Sales Solution",
  description: "Automates customer relationship management with AI-driven insights and follow-ups.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-powered-crm-automation-c2818c47",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI-Powered CRM Automation - AI-Powered Sales Solution
        </h1>
