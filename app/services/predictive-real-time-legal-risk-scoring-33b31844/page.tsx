...
export const metadata = {
  title: "Predictive Real-Time Legal Risk Scoring - Zion Tech Group",
  description: "Predictive risk scoring engine that assesses real-time legal vulnerabilities with machine learning.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/predictive-real-time-legal-risk-scoring-33b31844`
  }
};
