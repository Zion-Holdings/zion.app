...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time transcription with speaker IDs, Action item extraction and assignment, Decision and key takeaway logging, Automated follow-up email drafting, Searchable meeting knowledge base, Meeting effectiveness scoring, CRM integration for customer meetings, ai, Productivity, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Meeting Intelligence Platform</h1>
        <p className="text-lg text-slate-300 mb-8">AI that joins every meeting: real-time transcription, action item extraction, decision logging, and follow-up automation. Works with Zoom, Teams, Google Meet, and Webex.</p>
        ...
        <li class="text-slate-300">Real-time transcription with speaker IDs</li>
        <li class="text-slate-300">Action item extraction and assignment</li>
        <li class="text-slate-300">Decision and key takeaway logging</li>
        <li class="text-slate-300">Automated follow-up email drafting</li>
        <li class="text-slate-300">Searchable meeting knowledge base</li>
        <li class="text-slate-300">Meeting effectiveness scoring</li>
        <li class="text-slate-300">CRM integration for customer meetings</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Never lose a meeting decision again</li>
        <li class="text-slate-300">Action items captured and assigned automatically</li>
        <li class="text-slate-300">Searchable archive of all organizational knowledge</li>
        <li class="text-slate-300">Meeting effectiveness data drives improvement</li>
      </ul>
        </div>
