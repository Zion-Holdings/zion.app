...
export const metadata: Metadata = {
  title: 'Smart Platform Platform - Finance',
  description: 'Revolutionize finance through intelligent automation. Our Smart Platform Platform - Finance leverages advanced machine learning to deliver customer retention at',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-platform-platform-finance-2abe8c7b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Platform Platform - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our Smart Platform Platform - Finance leverages advanced machine learning to deliver customer retention at scale.
          </p>
