...
export const metadata: Metadata = {
  title: 'Predictive orchestrator-proptech',
  description: 'Revolutionize proptech through intelligent automation. Our Predictive orchestrator-proptech leverages advanced machine learning to deliver benefits administrati',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-orchestrator-proptech-1310d04c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive orchestrator-proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our Predictive orchestrator-proptech leverages advanced machine learning to deliver benefits administration at scale.
          </p>
