...
export const metadata: Metadata = {
  title: 'AI/IT Scale-up Suite - Gaming',
  description: 'Revolutionize gaming through intelligent automation. Our AI/IT Scale-up Suite - Gaming leverages advanced machine learning to deliver claims processing at scale',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-scale-up-suite-gaming-421f9a36',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Scale-up Suite - Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize gaming through intelligent automation. Our AI/IT Scale-up Suite - Gaming leverages advanced machine learning to deliver claims processing at scale.
          </p>
