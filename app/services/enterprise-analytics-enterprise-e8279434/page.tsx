...
export const metadata: Metadata = {
  title: 'Enterprise analytics-enterprise',
  description: 'Revolutionize enterprise through intelligent automation. Our Enterprise analytics-enterprise leverages advanced machine learning to deliver vendor management at',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-analytics-enterprise-e8279434',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize enterprise through intelligent automation. Our Enterprise analytics-enterprise leverages advanced machine learning to deliver vendor management at scale.
          </p>
