...
export const metadata: Metadata = {
  title: 'AI Service Directory',
  description: 'Discover and evaluate AI services with ratings, reviews, and integration guides.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-service-directory-7996dd8e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Discover and evaluate AI services with ratings, reviews, and integration guides.
          </p>
