...
export const metadata: Metadata = {
  title: 'Smart Intelligent Platform - Hospitality',
  description: 'Quantum leap forward for hospitality: Smart Intelligent Platform - Hospitality. Uses quantum-inspired algorithms to deliver inventory optimization at exponentia',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-intelligent-platform-hospitality-1163b0aa',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Intelligent Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for hospitality: Smart Intelligent Platform - Hospitality. Uses quantum-inspired algorithms to deliver inventory optimization at exponential speed.
          </p>
