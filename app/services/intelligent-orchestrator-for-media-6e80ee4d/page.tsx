...
export const metadata: Metadata = {
  title: 'Intelligent Orchestrator for Media',
  description: 'Next-generation media solution: Intelligent Orchestrator for Media. Combines image recognition with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-orchestrator-for-media-6e80ee4d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Orchestrator for Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation media solution: Intelligent Orchestrator for Media. Combines image recognition with adaptive intelligence for optimal results.
          </p>
