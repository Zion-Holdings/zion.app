...
export const metadata: Metadata = {
  title: 'Enterprise Experience - Logistics',
  description: 'Optimize your logistics workflows with Enterprise Experience - Logistics. This intelligent platform delivers personalization engine through advanced automation ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-experience-logistics-d474f667',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Experience - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your logistics workflows with Enterprise Experience - Logistics. This intelligent platform delivers personalization engine through advanced automation and AI.
          </p>
