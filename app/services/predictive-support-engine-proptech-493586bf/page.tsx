...
export const metadata: Metadata = {
  title: 'Predictive Support Engine - PROPTECH',
  description: 'Next-generation proptech solution: Predictive Support Engine - PROPTECH. Combines hyperautomation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-support-engine-proptech-493586bf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Support Engine - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation proptech solution: Predictive Support Engine - PROPTECH. Combines hyperautomation with adaptive intelligence for optimal results.
          </p>
