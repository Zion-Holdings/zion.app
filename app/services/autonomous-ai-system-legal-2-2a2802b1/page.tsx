...
export const metadata: Metadata = {
  title: 'Autonomous AI System - Legal #2',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous AI System - Legal #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Autonomous AI System - Legal #2. Powered by cutting-edge AI, this platform delivers vendor management like never before.
          </p>
