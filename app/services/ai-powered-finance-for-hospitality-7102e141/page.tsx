...
export const metadata: Metadata = {
  title: 'AI-Powered Finance for Hospitality',
  description: 'Next-generation hospitality solution: AI-Powered Finance for Hospitality. Combines data processing with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-finance-for-hospitality-7102e141',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Finance for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: AI-Powered Finance for Hospitality. Combines data processing with adaptive intelligence for optimal results.
          </p>
