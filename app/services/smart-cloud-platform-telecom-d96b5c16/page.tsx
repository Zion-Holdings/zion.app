...
export const metadata: Metadata = {
  title: 'Smart Cloud Platform - Telecom',
  description: 'Transform your telecom operations with our Smart Cloud Platform - Telecom. This AI-driven solution automates recruitment automation with unprecedented accuracy ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-cloud-platform-telecom-d96b5c16',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Cloud Platform - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your telecom operations with our Smart Cloud Platform - Telecom. This AI-driven solution automates recruitment automation with unprecedented accuracy and efficiency.
          </p>
