...
export const metadata: Metadata = {
  title: 'AI Engine - Edge Edition',
  description: 'Revolutionize edge through intelligent automation. Our AI Engine - Edge Edition leverages advanced machine learning to deliver sales forecasting at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-engine---edge-edition-8ef5d73c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Engine - Edge Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize edge through intelligent automation. Our AI Engine - Edge Edition leverages advanced machine learning to deliver sales forecasting at scale.
          </p>
