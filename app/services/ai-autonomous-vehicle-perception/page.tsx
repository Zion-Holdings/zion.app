...
export const metadata: Metadata = {
  ...
  keywords: '3D object detection, Lane and road boundary tracking, Pedestrian and cyclist prediction, Traffic sign and signal recognition, Sensor fusion (camera, LiDAR, radar), Real-time processing (< 50ms), Simulation environment, HD map integration, ai, Automotive, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Autonomous Vehicle Perception System</h1>
        <p className="text-lg text-slate-300 mb-8">Computer vision and sensor fusion for autonomous vehicles. Object detection, lane tracking, pedestrian prediction, and real-time decision making.</p>
        ...
        <li class="text-slate-300">3D object detection</li>
        <li class="text-slate-300">Lane and road boundary tracking</li>
        <li class="text-slate-300">Pedestrian and cyclist prediction</li>
        <li class="text-slate-300">Traffic sign and signal recognition</li>
        <li class="text-slate-300">Sensor fusion (camera, LiDAR, radar)</li>
        <li class="text-slate-300">Real-time processing (&lt; 50ms)</li>
        <li class="text-slate-300">Simulation environment</li>
        <li class="text-slate-300">HD map integration</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Improve autonomous driving safety</li>
        <li class="text-slate-300">Reduce perception latency</li>
        <li class="text-slate-300">Handle edge cases with AI</li>
        <li class="text-slate-300">Accelerate AV development</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$29,999/mo</p>
