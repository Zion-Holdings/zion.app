...
export const metadata: Metadata = {
  title: 'Autonomous Director for Energy',
  description: 'Transform your energy operations with our Autonomous Director for Energy. This AI-driven solution automates security monitoring with unprecedented accuracy and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-director-for-energy-b5100b3e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Director for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Autonomous Director for Energy. This AI-driven solution automates security monitoring with unprecedented accuracy and efficiency.
          </p>
