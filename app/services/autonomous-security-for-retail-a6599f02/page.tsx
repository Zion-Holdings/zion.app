...
export const metadata: Metadata = {
  title: 'Autonomous Security for Retail',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Security for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize retail through intelligent automation. Our Autonomous Security for Retail leverages advanced machine learning to deliver document processing at scale.
          </p>
