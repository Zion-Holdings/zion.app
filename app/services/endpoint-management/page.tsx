...
export const metadata: Metadata = {
  ...
  keywords: 'Cross-platform device enrollment (Windows, macOS, iOS, Android, Linux), Automated patch & update deployment, Endpoint detection & response (EDR), Application whitelisting & app catalog, Remote lock, wipe, and geofencing, it, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Unified Endpoint Management (UEM)</h1>
        <p className="text-lg text-slate-300 mb-8">Manage and secure all devices (laptops, mobile, IoT) from a single dashboard: enrollment, policy enforcement, patch management, and remote wipe.</p>
        ...
        <li class="text-slate-300">Cross-platform device enrollment (Windows, macOS, iOS, Android, Linux)</li>
        <li class="text-slate-300">Automated patch &amp; update deployment</li>
        <li class="text-slate-300">Endpoint detection &amp; response (EDR)</li>
        <li class="text-slate-300">Application whitelisting &amp; app catalog</li>
        <li class="text-slate-300">Remote lock, wipe, and geofencing</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with unified endpoint management (uem)</li>
