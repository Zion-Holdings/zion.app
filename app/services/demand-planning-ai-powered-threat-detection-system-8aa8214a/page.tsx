...
export const metadata: Metadata = {
  ...
  description: 'demand planning solution for proptech industry. Real-time threat detection using behavioral analysis, anomaly detection, and machine learning.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/demand-planning-ai-powered-threat-detection-system-8aa8214a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            demand planning solution for proptech industry. Real-time threat detection using behavioral analysis, anomaly detection, and machine learning.
          </p>
