...
export const metadata: Metadata = {
  title: 'Enterprise Manufacturing Platform - Real-Estate',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Manufacturing Platform - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Enterprise Manufacturing Platform - Real-Estate. This AI-driven solution automates invoice automation with unprecedented accuracy and efficiency.
          </p>
