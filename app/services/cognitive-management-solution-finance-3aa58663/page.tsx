...
export const metadata: Metadata = {
  title: 'Cognitive Management Solution - Finance',
  description: 'Optimize your finance workflows with Cognitive Management Solution - Finance. This intelligent platform delivers reputation management through advanced automati',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Management Solution - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your finance workflows with Cognitive Management Solution - Finance. This intelligent platform delivers reputation management through advanced automation and AI.
          </p>
