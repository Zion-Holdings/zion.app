...
export const metadata: Metadata = {
  title: 'Enterprise Form Decision',
  description: 'Drive innovation in legal with Enterprise Form Decision. This AI-powered platform transforms performance tracking into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-form-decision-7f7bb459',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Form Decision
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Enterprise Form Decision. This AI-powered platform transforms performance tracking into a competitive advantage.
          </p>
