...
export const metadata: Metadata = {
  title: 'FP&A Automation Zero-Trust Identity & Access Manager',
  description: 'fp&a automation solution for theme parks industry. Implements zero-trust security architecture with continuous authentication and adaptive access controls.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/fpa-automation-zero-trust-identity--access-manager-b53ead0a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            FP&A Automation Zero-Trust Identity & Access Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            fp&a automation solution for theme parks industry. Implements zero-trust security architecture with continuous authentication and adaptive access controls.
          </p>
