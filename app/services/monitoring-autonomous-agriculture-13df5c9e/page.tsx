...
export const metadata: Metadata = {
  title: 'Monitoring Autonomous - Agriculture',
  description: 'Transform your agriculture operations with our Monitoring Autonomous - Agriculture. This AI-driven solution automates customer retention with unprecedented accu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Monitoring Autonomous - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Monitoring Autonomous - Agriculture. This AI-driven solution automates customer retention with unprecedented accuracy and efficiency.
          </p>
