...
export const metadata: Metadata = {
  title: 'Quantum Suite for Logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Quantum Suite for Logistics leverages advanced machine learning to deliver anomaly detection at scal',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-suite-for-logistics-ce72cef8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Suite for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Quantum Suite for Logistics leverages advanced machine learning to deliver anomaly detection at scale.
          </p>
