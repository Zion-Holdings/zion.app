...
export const metadata = {
  ...
  description: "End-to-end data center transformation including assessment, migration planning, hybrid cloud architecture, and decommissioning. Modernize legacy infrastructure ",
  alternates: {
