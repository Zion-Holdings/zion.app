...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'IT Data Center Modernization Service', 'description': 'End-to-end data center transformation including assessment, migration planning, hybrid cloud architecture, and decommissioning. Modernize legacy infrastructure with minimal downtime.', 'serviceType': 'it', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'technology'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'IT Data Center Modernization Service Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$25,000 project', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$75,000 project', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': 'Custom', 'priceCurrency': 'USD'}]}} />
    <JsonLd data={'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'Comprehensive infrastructure assessment and TCO analysis', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Comprehensive infrastructure assessment and TCO analysis'}}, {'@type': 'Question', 'name': 'Hybrid cloud architecture design (on-prem + cloud)', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Hybrid cloud architecture design (on-prem + cloud)'}}, {'@type': 'Question', 'name': 'Workload migration planning with dependency mapping', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Workload migration planning with dependency mapping'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Reduce infrastructure costs by 40-60%; Improve application performance and availability; Enable cloud-native development on modern platform'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} />
