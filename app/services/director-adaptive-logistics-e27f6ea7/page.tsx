...
export const metadata: Metadata = {
  title: 'Director Adaptive - Logistics',
  description: 'Next-generation logistics solution: Director Adaptive - Logistics. Combines maintenance scheduling with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/director-adaptive-logistics-e27f6ea7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Director Adaptive - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Director Adaptive - Logistics. Combines maintenance scheduling with adaptive intelligence for optimal results.
          </p>
