...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Manufacturing - HEALTHTECH',
  description: 'The future of healthtech is here with Hyper-Accelerated Manufacturing - HEALTHTECH. Powered by cutting-edge AI, this platform delivers financial planning like n',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/hyper-accelerated-manufacturing-healthtech-74f223d1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Manufacturing - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthtech is here with Hyper-Accelerated Manufacturing - HEALTHTECH. Powered by cutting-edge AI, this platform delivers financial planning like never before.
          </p>
