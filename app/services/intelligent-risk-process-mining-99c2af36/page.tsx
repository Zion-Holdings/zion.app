...
export const metadata: Metadata = {
  title: 'Intelligent Risk Process Mining',
  description: 'Transform your agriculture operations with our Intelligent Risk Process Mining. This AI-driven solution provides intelligent automation with unprecedented accur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-risk-process-mining-99c2af36',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Risk Process Mining
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Intelligent Risk Process Mining. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
