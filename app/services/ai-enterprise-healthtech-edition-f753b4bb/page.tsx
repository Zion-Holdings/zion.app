...
export const metadata: Metadata = {
  title: 'AI Enterprise - HEALTHTECH Edition',
  description: 'Enhance your healthtech business with AI Enterprise - HEALTHTECH Edition. Our solution provides learning management with enterprise-grade reliability and securi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-enterprise-healthtech-edition-f753b4bb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Enterprise - HEALTHTECH Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthtech business with AI Enterprise - HEALTHTECH Edition. Our solution provides learning management with enterprise-grade reliability and security.
          </p>
