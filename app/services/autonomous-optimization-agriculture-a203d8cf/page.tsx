...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'Autonomous optimization-agriculture', 'description': 'Optimize your agriculture workflows with Autonomous optimization-agriculture. This intelligent platform delivers sourcing optimization through advanced automation and AI.', 'serviceType': 'optimizer', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'hello@ziontechgroup.com', 'telephone': '+1 (302) 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'agriculture'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'Autonomous optimization-agriculture Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '199', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '499', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': '1499', 'priceCurrency': 'USD'}]}} />
    <JsonLd data={'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'Behavioral analytics for anomaly detection', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Behavioral analytics for anomaly detection'}}, {'@type': 'Question', 'name': 'Multi-language support with localization', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Multi-language support with localization'}}, {'@type': 'Question', 'name': 'Master data management with golden records', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Master data management with golden records'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Improved sales performance with lead scoring; Improved employee productivity with automation; 3x faster decision making with real-time insights'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} />
