...
export const metadata: Metadata = {
  title: 'Smart cloud-education',
  description: 'Next-generation education solution: Smart cloud-education. Combines data processing with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-cloud-education-eb00e62d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation education solution: Smart cloud-education. Combines data processing with adaptive intelligence for optimal results.
          </p>
