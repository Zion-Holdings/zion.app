...
export const metadata = {
  ...
  description: "Enhance your telecom business with Predictive Revenue Engine - Telecom #1. Our solution provides resource utilization with enterprise-grade reliability and secu",
  alternates: {
