...
export const metadata: Metadata = {
  title: 'Adaptive Sentiment Cloud',
  description: 'Revolutionize legal through intelligent automation. Our Adaptive Sentiment Cloud leverages advanced machine learning to deliver enterprise-grade insights at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Sentiment Cloud
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Adaptive Sentiment Cloud leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
