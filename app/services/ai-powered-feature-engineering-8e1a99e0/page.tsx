...
export const metadata: Metadata = {
  title: 'AI-Powered Feature Engineering',
  description: 'Automatically generates and selects features for machine learning models.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-feature-engineering-8e1a99e0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automatically generates and selects features for machine learning models.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Feature generation</li>
          <li className="text-gray-300">Feature selection</li>
          <li className="text-gray-300">Data transformation</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">50% better features</li>
