...
export const metadata = {
  title: "Cloud-Native Industry-Specific Financial Orchestration - Zion Tech Group",
  description: "Cloud-native orchestration platform that manages industry-specific financial resources with auto-scaling and cost control.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/cloud-native-industry-specific-financial-orchestration-1924a9cc`
  }
};
