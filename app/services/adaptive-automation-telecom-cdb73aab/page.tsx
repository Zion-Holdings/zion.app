...
export const metadata: Metadata = {
  title: 'Adaptive automation-telecom',
  description: 'Enhance your telecom business with Adaptive automation-telecom. Our solution provides lead scoring with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-automation-telecom-cdb73aab',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive automation-telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your telecom business with Adaptive automation-telecom. Our solution provides lead scoring with enterprise-grade reliability and security.
          </p>
