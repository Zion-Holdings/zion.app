...
export const metadata: Metadata = {
  title: 'Autonomous Intelligent - Hospitality',
  description: 'Drive innovation in hospitality with Autonomous Intelligent - Hospitality. This AI-powered platform transforms document ai into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-intelligent-hospitality-7b16dfbe',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Intelligent - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Autonomous Intelligent - Hospitality. This AI-powered platform transforms document ai into a competitive advantage.
          </p>
