...
export const metadata: Metadata = {
  title: 'Intelligent Energy Security',
  description: 'Transform your automotive operations with our Intelligent Energy Security. This AI-driven solution automates content generation with unprecedented accuracy and ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your automotive operations with our Intelligent Energy Security. This AI-driven solution automates content generation with unprecedented accuracy and efficiency.
          </p>
