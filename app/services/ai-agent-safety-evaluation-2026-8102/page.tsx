...
export const metadata = {
  ...
  alternates: { canonical: '/services/ai-agent-safety-evaluation-2026-8102/' },

  openGraph: {
    title: 'AI Agent Safety Evaluation | Zion Tech Group',
    description: 'End-to-end ai agent safety evaluation services: assessment, deployment, and managed operations.',
    url: 'https://ziontechgroup.com/services/ai-agent-safety-evaluation-2026-8102/',
...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "AI Agent Safety Evaluation | Zion Tech Group", description: "End-to-end ai agent safety evaluation services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/ai-agent-safety-evaluation-2026-8102/"}} />
