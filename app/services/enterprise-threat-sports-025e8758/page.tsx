...
export const metadata: Metadata = {
  title: 'Enterprise Threat - Sports',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Threat - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your sports business with Enterprise Threat - Sports. Our solution provides customer service automation with enterprise-grade reliability and security.
          </p>
