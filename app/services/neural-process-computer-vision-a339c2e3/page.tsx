...
export const metadata: Metadata = {
  title: 'Neural Process Computer Vision',
  description: 'Hyper-accelerated hospitality solution: Neural Process Computer Vision. Combines time tracking with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-process-computer-vision-a339c2e3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Process Computer Vision
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated hospitality solution: Neural Process Computer Vision. Combines time tracking with next-gen AI for maximum velocity.
          </p>
