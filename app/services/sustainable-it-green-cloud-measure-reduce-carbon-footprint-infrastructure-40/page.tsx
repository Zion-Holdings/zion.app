...
export const metadata = {
  ...
  description: 'End-to-end sustainable it and green cloud: measure and reduce carbon footprint of infrastructure services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/sustainable-it-green-cloud-measure-reduce-carbon-footprint-infrastructure-40/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">Sustainable IT and Green Cloud: Measure and Reduce Carbon Footprint of Infrastructure</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end sustainable it and green cloud: measure and reduce carbon footprint of infrastructure services: assessment, deployment, and managed operations.
        </p>
