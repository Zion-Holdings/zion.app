...
export const metadata: Metadata = {
  title: 'Next-Gen Autonomous for Real-Estate',
  description: 'Optimize your real-estate workflows with Next-Gen Autonomous for Real-Estate. This intelligent platform delivers energy management through advanced automation a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-autonomous-for-real-estate-fda7cfcc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Autonomous for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your real-estate workflows with Next-Gen Autonomous for Real-Estate. This intelligent platform delivers energy management through advanced automation and AI.
          </p>
