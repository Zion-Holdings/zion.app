...
export const metadata: Metadata = {
  title: 'AI/IT Engine Suite - EDTECH',
  description: 'The future of edtech is here with AI/IT Engine Suite - EDTECH. Powered by cutting-edge AI, this platform delivers automation opportunity like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-engine-suite-edtech-62a38043',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Engine Suite - EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of edtech is here with AI/IT Engine Suite - EDTECH. Powered by cutting-edge AI, this platform delivers automation opportunity like never before.
          </p>
