...
export const metadata: Metadata = {
  title: 'Smart Machine Learning Platform - Hospitality',
  description: 'Next-generation hospitality solution: Smart Machine Learning Platform - Hospitality. Combines invoice processing with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-machine-learning-platform-hospitality-988c161f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Machine Learning Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Smart Machine Learning Platform - Hospitality. Combines invoice processing with adaptive intelligence for optimal results.
          </p>
