...
export const metadata: Metadata = {
  title: 'Autonomous Automation for Real-Estate',
  description: 'The future of real-estate is here with Autonomous Automation for Real-Estate. Powered by cutting-edge AI, this platform delivers threat detection like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-automation-for-real-estate-7f0fa9fc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Automation for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of real-estate is here with Autonomous Automation for Real-Estate. Powered by cutting-edge AI, this platform delivers threat detection like never before.
          </p>
