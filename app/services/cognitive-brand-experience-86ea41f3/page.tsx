...
export const metadata: Metadata = {
  title: 'Cognitive Brand Experience',
  description: 'Revolutionize technology through intelligent automation. Our Cognitive Brand Experience leverages advanced machine learning to deliver sentiment analysis at sca',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-brand-experience-86ea41f3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our Cognitive Brand Experience leverages advanced machine learning to deliver sentiment analysis at scale.
          </p>
