...
export const metadata: Metadata = {
  title: 'Adaptive Healthcare for Construction',
  description: 'The future of construction is here with Adaptive Healthcare for Construction. Powered by cutting-edge AI, this platform delivers customer service automation lik',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-healthcare-for-construction-ec811a3e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Healthcare for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Adaptive Healthcare for Construction. Powered by cutting-edge AI, this platform delivers customer service automation like never before.
          </p>
