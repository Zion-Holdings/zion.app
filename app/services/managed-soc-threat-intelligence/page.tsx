...
export const metadata: Metadata = {
  ...
  keywords: '24/7 security monitoring, AI-powered threat detection, Incident response automation, Proactive threat hunting, Compliance reporting, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Managed SOC &amp; Threat Intelligence</h1>
        <p className="text-lg text-slate-300 mb-8">24/7 Security Operations Center with AI-enhanced threat detection, incident response, and proactive threat hunting.</p>
        ...
        <li class="text-slate-300">Proactive threat hunting</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with managed soc &amp; threat intelligence</li>
