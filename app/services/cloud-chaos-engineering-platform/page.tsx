...
export const metadata: Metadata = {
  ...
  keywords: '50-plus experiment recipes — latency injection, packet loss, CPU, OOM, and DB failover, Blast-radius boundary per namespace and region, CI integration — run the chaos suite post-deploy per pull request, Auto-generated results report per scenario per run with evidence screenshots, cloud, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Chaos Engineering as a Service</h1>
        <p className="text-lg text-slate-300 mb-8">Hosted chaos experiment platform: inject latency, packet loss, CPU or memory spikes, or database failover per Kubernetes namespace or instance, blast-radius boundary, auto-generated results report per scenario, and CI integration.</p>
        ...
        <li class="text-slate-300">50-plus experiment recipes — latency injection, packet loss, CPU, OOM, and DB failover</li>
        <li class="text-slate-300">Blast-radius boundary per namespace and region</li>
        <li class="text-slate-300">CI integration — run the chaos suite post-deploy per pull request</li>
        <li class="text-slate-300">Auto-generated results report per scenario per run with evidence screenshots</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with chaos engineering as a service</li>
