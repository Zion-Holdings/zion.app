...
export const metadata: Metadata = {
  title: 'Autonomous Manufacturing for Finance',
  description: 'Transform your finance operations with our Autonomous Manufacturing for Finance. This AI-driven solution automates inventory management with unprecedented accur',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Manufacturing for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Autonomous Manufacturing for Finance. This AI-driven solution automates inventory management with unprecedented accuracy and efficiency.
          </p>
