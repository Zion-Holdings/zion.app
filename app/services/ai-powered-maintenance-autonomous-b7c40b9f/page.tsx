...
export const metadata: Metadata = {
  title: 'AI-Powered Maintenance Autonomous',
  description: 'Optimize your construction workflows with AI-Powered Maintenance Autonomous. This intelligent platform delivers pipeline management through advanced automation ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Maintenance Autonomous
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with AI-Powered Maintenance Autonomous. This intelligent platform delivers pipeline management through advanced automation and AI.
          </p>
