...
export const metadata: Metadata = {
  title: 'Predictive Supply Engine - Hospitality',
  description: 'Transform your hospitality operations with our Predictive Supply Engine - Hospitality. This AI-driven solution automates hr analytics with unprecedented accurac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-supply-engine-hospitality-be2446a8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Supply Engine - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Predictive Supply Engine - Hospitality. This AI-driven solution automates hr analytics with unprecedented accuracy and efficiency.
          </p>
