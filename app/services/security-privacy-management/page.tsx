...
export const metadata: Metadata = {
  ...
  keywords: 'Data mapping and inventory, Consent management, Data subject request (DSR) automation, Privacy impact assessments, Cookie consent management, Integration with marketing and analytics tools, Breach notification automation, Global regulation coverage, security, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Privacy Management Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Comprehensive privacy management for GDPR, CCPA, LGPD, and global privacy regulations. Data mapping, consent management, and DSR automation.</p>
        ...
        <li class="text-slate-300">Data mapping and inventory</li>
        <li class="text-slate-300">Consent management</li>
        <li class="text-slate-300">Data subject request (DSR) automation</li>
        <li class="text-slate-300">Privacy impact assessments</li>
        <li class="text-slate-300">Cookie consent management</li>
        <li class="text-slate-300">Integration with marketing and analytics tools</li>
        <li class="text-slate-300">Breach notification automation</li>
        <li class="text-slate-300">Global regulation coverage</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Automate privacy compliance</li>
        <li class="text-slate-300">Reduce DSR processing time by 80%</li>
        <li class="text-slate-300">Manage consent across channels</li>
        <li class="text-slate-300">Prevent privacy violations</li>
      </ul>
        </div>
