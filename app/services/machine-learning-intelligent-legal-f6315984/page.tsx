...
export const metadata: Metadata = {
  title: 'Machine Learning Intelligent - Legal',
  description: 'Next-generation legal solution: Machine Learning Intelligent - Legal. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/machine-learning-intelligent-legal-f6315984',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Machine Learning Intelligent - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Machine Learning Intelligent - Legal. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
