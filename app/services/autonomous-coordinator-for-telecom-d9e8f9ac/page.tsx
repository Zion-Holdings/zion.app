  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Autonomous Coordinator for Telecom</h1>
        <p className="text-lg text-gray-300 mb-8">Unlock unprecedented growth with Autonomous Coordinator for Telecom. This autonomous system provides customer service automation with zero manual intervention needed.</p>
