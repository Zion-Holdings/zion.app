...
export const metadata: Metadata = {
  title: 'AI Orchestrator - Construction Edition',
  description: 'Revolutionize construction through intelligent automation. Our AI Orchestrator - Construction Edition leverages advanced machine learning to deliver enterprise-',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-orchestrator-construction-edition-0ee9982f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Orchestrator - Construction Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our AI Orchestrator - Construction Edition leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
