...
export const metadata: Metadata = {
  title: 'Smart Analyzer for Legal',
  description: 'Next-generation legal solution: Smart Analyzer for Legal. Combines risk assessment with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-analyzer-for-legal-a3848e0e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Analyzer for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Smart Analyzer for Legal. Combines risk assessment with adaptive intelligence for optimal results.
          </p>
