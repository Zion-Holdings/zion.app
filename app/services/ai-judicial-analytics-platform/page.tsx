      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Analyze case law, predict litigation outcomes, and optimize legal strategy. NLP across 50M+ cases, judge behavior analysis, and settlement range prediction. Used by 100+ law firms.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Case outcome prediction (85% accuracy)</li>
            <li className="text-purple-300">✓ Judge behavior analysis</li>
            <li className="text-purple-300">✓ Settlement range estimation</li>
            <li className="text-purple-300">✓ Precedent citation mining</li>
            <li className="text-purple-300">✓ Brief quality scoring</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ 85% litigation outcome accuracy</li>
            <li className="text-purple-300">✓ Negotiate better settlements</li>
            <li className="text-purple-300">✓ Win more cases</li>
            </ul>
          </div>
