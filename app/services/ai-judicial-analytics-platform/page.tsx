...
export const metadata: Metadata = {
  ...
  keywords: 'Case outcome prediction (85% accuracy), Judge behavior analysis, Settlement range estimation, Precedent citation mining, Brief quality scoring, Opposition weakness identification, ai, Legal & Compliance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Judicial Analytics &amp; Case Prediction</h1>
        <p className="text-lg text-slate-300 mb-8">Analyze case law, predict litigation outcomes, and optimize legal strategy. NLP across 50M+ cases, judge behavior analysis, and settlement range prediction. Used by 100+ law firms.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">ai</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">Legal &amp; Compliance</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Case outcome prediction (85% accuracy)</li>
        <li class="text-slate-300">Judge behavior analysis</li>
        <li class="text-slate-300">Settlement range estimation</li>
        <li class="text-slate-300">Precedent citation mining</li>
        <li class="text-slate-300">Brief quality scoring</li>
        <li class="text-slate-300">Opposition weakness identification</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">85% litigation outcome accuracy</li>
        <li class="text-slate-300">Negotiate better settlements</li>
        <li class="text-slate-300">Win more cases</li>
      </ul>
        </div>
