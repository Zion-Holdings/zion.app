...
export const metadata: Metadata = {
  ...
  description: 'Optimize your agriculture workflows with Smart Analyzer Platform - Agriculture. This intelligent platform delivers incident response through advanced automation',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your agriculture workflows with Smart Analyzer Platform - Agriculture. This intelligent platform delivers incident response through advanced automation and AI.
          </p>
