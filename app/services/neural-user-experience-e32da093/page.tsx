...
export const metadata: Metadata = {
  title: 'Neural User Experience',
  description: 'Revolutionize media through intelligent automation. Our Neural User Experience leverages advanced machine learning to deliver rpa orchestration at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-user-experience-e32da093',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural User Experience
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize media through intelligent automation. Our Neural User Experience leverages advanced machine learning to deliver rpa orchestration at scale.
          </p>
