...
export const metadata: Metadata = {
  title: 'Cognitive finance-automotive',
  description: 'Next-generation automotive solution: Cognitive finance-automotive. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-finance-automotive-1a566e02',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive finance-automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation automotive solution: Cognitive finance-automotive. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
