...
export const metadata: Metadata = {
  title: 'Quantum Quality - CLEANTECH Quantum',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Quality - CLEANTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in cleantech with Quantum Quality - CLEANTECH Quantum. This AI-powered platform transforms performance tracking into a competitive advantage.
          </p>
