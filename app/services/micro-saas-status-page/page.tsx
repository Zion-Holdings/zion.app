...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time status updates, Incident communication, Email/SMS subscriber notifications, Uptime tracking and SLA reporting, Custom domain and branding, Integration with monitoring tools, Historical incident archive, Team management, micro-saas, SaaS, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">StatusPulse — Status Page Micro-SaaS</h1>
        <p className="text-lg text-slate-300 mb-8">Beautiful status pages for SaaS companies. Real-time incident communication, subscriber notifications, and uptime tracking. Custom domain and branding.</p>
        ...
        <li class="text-slate-300">Real-time status updates</li>
        <li class="text-slate-300">Incident communication</li>
        <li class="text-slate-300">Email/SMS subscriber notifications</li>
        <li class="text-slate-300">Uptime tracking and SLA reporting</li>
        <li class="text-slate-300">Custom domain and branding</li>
        <li class="text-slate-300">Integration with monitoring tools</li>
        <li class="text-slate-300">Historical incident archive</li>
        <li class="text-slate-300">Team management</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Build customer trust with transparency</li>
        <li class="text-slate-300">Reduce support tickets during incidents</li>
        <li class="text-slate-300">Professional incident communication</li>
        <li class="text-slate-300">Custom branded status page</li>
      </ul>
        </div>
