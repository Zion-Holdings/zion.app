...
export const metadata: Metadata = {
  ...
  keywords: 'Blog post generation with SEO optimization, Social media post creation (LinkedIn, X, Instagram), Email sequence drafting and personalization, Ad copy for Google, Meta, LinkedIn, Whitepaper and eBook chapter generation, Brand voice enforcement and style control, Content calendar integration, automation, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Content Generation Engine</h1>
        <p className="text-lg text-slate-300 mb-8">AI content engine for marketing: blog posts, social media, email sequences, ad copy, and whitepapers. Brand-consistent, SEO-optimized, at scale.</p>
        ...
        <li class="text-slate-300">Blog post generation with SEO optimization</li>
        <li class="text-slate-300">Social media post creation (LinkedIn, X, Instagram)</li>
        <li class="text-slate-300">Email sequence drafting and personalization</li>
        <li class="text-slate-300">Ad copy for Google, Meta, LinkedIn</li>
        <li class="text-slate-300">Whitepaper and eBook chapter generation</li>
        <li class="text-slate-300">Brand voice enforcement and style control</li>
        <li class="text-slate-300">Content calendar integration</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Generate months of content in days</li>
        <li class="text-slate-300">SEO-optimized content ranks faster</li>
        <li class="text-slate-300">Brand voice consistent across all content</li>
        <li class="text-slate-300">Multi-format from single brief</li>
      </ul>
        </div>
