...
export const metadata: Metadata = {
  title: 'Intelligent Generator for Tech',
  description: 'The future of technology is here with Intelligent Generator for Tech. Powered by cutting-edge AI, this platform delivers manufacturing quality control like neve',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-generator-for-tech-38bbf84e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Generator for Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of technology is here with Intelligent Generator for Tech. Powered by cutting-edge AI, this platform delivers manufacturing quality control like never before.
          </p>
