      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Dynamic route optimization for delivery fleets considering traffic, weather, and delivery windows.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Traffic prediction</li>
          <li className="text-gray-300">Fleet utilization</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">25% cost reduction</li>
