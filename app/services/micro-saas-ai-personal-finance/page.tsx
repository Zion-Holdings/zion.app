...
export const metadata = {
  ...
  description: "AI-powered personal finance manager that categorizes spending, predicts cash flow, and provides personalized financial advice. Like having a financial advisor i",
  alternates: {
