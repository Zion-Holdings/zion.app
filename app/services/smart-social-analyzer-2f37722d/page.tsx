...
export const metadata: Metadata = {
  title: 'Smart Social Analyzer',
  description: 'Next-generation construction solution: Smart Social Analyzer. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-social-analyzer-2f37722d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Social Analyzer
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Smart Social Analyzer. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
