...
export const metadata: Metadata = {
  title: 'Intelligent data-finance',
  description: 'Transform your finance operations with our Intelligent data-finance. This AI-driven solution automates customer insights with unprecedented accuracy and efficie',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-data-finance-5ffd2ac3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent data-finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Intelligent data-finance. This AI-driven solution automates customer insights with unprecedented accuracy and efficiency.
          </p>
