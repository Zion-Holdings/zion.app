...
export const metadata: Metadata = {
  ...
  keywords: 'Event-driven refactoring (SNS/SQS/Lambda), DynamoDB single-table pattern design, Lambda cold-start + provisioned concurrency, Dual-write validation during migration window, RTO/RPO dashboard per migrated workload, cloud, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AWS Serverless Migration</h1>
        <p className="text-lg text-slate-300 mb-8">Migrate EC2/S3 apps to serverless: Lambda + API Gateway + DynamoDB event-driven. Schema migration dual-write zero-downtime cutover — saves compute costs 60-80%.</p>
        ...
        <li class="text-slate-300">Event-driven refactoring (SNS/SQS/Lambda)</li>
        <li class="text-slate-300">DynamoDB single-table pattern design</li>
        <li class="text-slate-300">Lambda cold-start + provisioned concurrency</li>
        <li class="text-slate-300">Dual-write validation during migration window</li>
        <li class="text-slate-300">RTO/RPO dashboard per migrated workload</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with aws serverless migration</li>
