...
export const metadata: Metadata = {
  title: 'Adaptive Security Analyzer',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of telecom is here with Adaptive Security Analyzer. Powered by cutting-edge AI, this platform delivers maintenance scheduling like never before.
          </p>
