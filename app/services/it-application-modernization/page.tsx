...
export const metadata: Metadata = {
  ...
  keywords: 'Assessment, Architecture design, Refactoring, Re-platforming, API layer, Data migration, Testing, Optimization, it, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Legacy App Modernization</h1>
        <p className="text-lg text-slate-300 mb-8">Transform legacy applications to cloud-native architectures.</p>
        ...
        <li class="text-slate-300">Assessment</li>
        <li class="text-slate-300">Architecture design</li>
        <li class="text-slate-300">Refactoring</li>
        <li class="text-slate-300">Re-platforming</li>
        <li class="text-slate-300">API layer</li>
        <li class="text-slate-300">Data migration</li>
        <li class="text-slate-300">Testing</li>
        <li class="text-slate-300">Optimization</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Modern architecture</li>
        <li class="text-slate-300">Cloud-native</li>
        <li class="text-slate-300">Cost reduction</li>
        <li class="text-slate-300">Faster delivery</li>
      </ul>
        </div>
