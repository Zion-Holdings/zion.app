...
export const metadata: Metadata = {
  ...
  keywords: 'Enrollment and registration automation, AI-assisted grading and rubrics, Content delivery and adaptive paths, Plagiarism detection and originality, Student communication and reminders, Learning analytics and at-risk detection, Integration with Canvas, Moodle, Blackboard, Google Classroom, automation, Education, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Education &amp; LMS Automation</h1>
        <p className="text-lg text-slate-300 mb-8">Automate education operations: enrollment, grading, content delivery, plagiarism checking, and student communication. Canvas, Moodle, Blackboard.</p>
        ...
        <li class="text-slate-300">Enrollment and registration automation</li>
        <li class="text-slate-300">AI-assisted grading and rubrics</li>
        <li class="text-slate-300">Content delivery and adaptive paths</li>
        <li class="text-slate-300">Plagiarism detection and originality</li>
        <li class="text-slate-300">Student communication and reminders</li>
        <li class="text-slate-300">Learning analytics and at-risk detection</li>
        <li class="text-slate-300">Integration with Canvas, Moodle, Blackboard, Google Classroom</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">AI grading saves faculty hours</li>
        <li class="text-slate-300">Plagiarism detection ensures integrity</li>
        <li class="text-slate-300">At-risk detection enables early intervention</li>
        <li class="text-slate-300">Learning analytics improve outcomes</li>
      </ul>
        </div>
