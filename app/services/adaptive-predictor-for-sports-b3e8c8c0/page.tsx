...
export const metadata: Metadata = {
  title: 'Adaptive Predictor for Sports',
  description: 'Transform your sports operations with our Adaptive Predictor for Sports. This AI-driven solution automates risk assessment with unprecedented accuracy and effic',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Predictor for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your sports operations with our Adaptive Predictor for Sports. This AI-driven solution automates risk assessment with unprecedented accuracy and efficiency.
          </p>
