...
export const metadata: Metadata = {
  title: 'AI/IT Smart Suite - Transportation',
  description: 'Quantum leap forward for transportation: AI/IT Smart Suite - Transportation. Uses quantum-inspired algorithms to deliver compliance monitoring at exponential sp',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Smart Suite - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for transportation: AI/IT Smart Suite - Transportation. Uses quantum-inspired algorithms to deliver compliance monitoring at exponential speed.
          </p>
