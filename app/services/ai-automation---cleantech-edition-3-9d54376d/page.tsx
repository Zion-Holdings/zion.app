...
export const metadata: Metadata = {
  title: 'AI Automation - Cleantech Edition #3',
  description: 'Transform your cleantech operations with our AI Automation - Cleantech Edition #3. This AI-driven solution automates maintenance scheduling with unprecedented a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Automation - Cleantech Edition #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your cleantech operations with our AI Automation - Cleantech Edition #3. This AI-driven solution automates maintenance scheduling with unprecedented accuracy and efficiency.
          </p>
