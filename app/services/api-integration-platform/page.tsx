...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "API Integration & Orchestration Platform | Zion Tech Group",
    description: "No-code API integration platform that connects SaaS applications, databases, and services with pre-built connectors and custom API orchestration. Event-driven workflows, data transformation, and error handling.",
    url: "https://ziontechgroup.com/services/api-integration-platform/",
    type: 'website',
  },
  alternates: { canonical: "/services/api-integration-platform/" },
};
...
export default function ApiIntegrationPlatformPage() {
  return (
    <StandardPage
      ...
      subtitle="No-code API integration platform that connects SaaS applications, databases, and services with pre-built connectors and custom API orchestration. Event-driven workflows, data transformation, and error handling."
      breadcrumbItems={[
        { label: "Home", href: "/" },
        { label: "Services", href: "/services/" },
        { label: "API Integration & Orchestration Platform" }
      ]}
      actions={[
    ...
    >
        ...
        <div className="rounded-2xl border border-white/10 bg-slate-900/40 p-5"><h2 className="text-white font-semibold mb-2">API Integration &amp; Orchestration Platform</h2><p className="text-slate-400 text-sm">Archived section recovered from the live site snapshot.</p></div>
      ...
      <p className="text-slate-400 leading-relaxed mb-4 max-w-5xl mx-auto">Estimated timeline for API Integration &amp; Orchestration Platform — adapt to your team size and complexity.</p>
      ...
      <p className="text-slate-500 text-sm max-w-5xl mx-auto">Restored from a Wayback Machine snapshot (20260607112214) of ziontechgroup.com.</p>
    </StandardPage>
  );
}
