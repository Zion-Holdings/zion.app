...
export const metadata: Metadata = {
  title: 'Adaptive Coordinator for Cleantech',
  description: 'Next-generation cleantech solution: Adaptive Coordinator for Cleantech. Combines image recognition with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-coordinator-for-cleantech-35fadab4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Coordinator for Cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation cleantech solution: Adaptive Coordinator for Cleantech. Combines image recognition with adaptive intelligence for optimal results.
          </p>
