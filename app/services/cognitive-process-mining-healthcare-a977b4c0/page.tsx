...
export const metadata: Metadata = {
  title: 'Cognitive process mining-healthcare',
  description: 'Next-generation healthcare solution: Cognitive process mining-healthcare. Combines customer service automation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-process-mining-healthcare-a977b4c0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive process mining-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Cognitive process mining-healthcare. Combines customer service automation with adaptive intelligence for optimal results.
          </p>
