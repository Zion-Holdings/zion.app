...
export const metadata: Metadata = {
  title: 'AI/IT Process Suite - Manufacturing',
  description: 'Hyper-accelerated manufacturing solution: AI/IT Process Suite - Manufacturing. Combines decision support with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-process-suite-manufacturing-3957884c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Process Suite - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated manufacturing solution: AI/IT Process Suite - Manufacturing. Combines decision support with next-gen AI for maximum velocity.
          </p>
