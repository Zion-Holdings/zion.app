...
export const metadata: Metadata = {
  ...
  keywords: 'ArgoCD GitOps synced per environment, Argo Rollouts progressive delivery (canary/blue-green), Terraform EKS/GKE/AKS provisioning, Kyverno admission policies + OPA-Gatekeeper, Drift auto-remediation reconciler, cloud, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">GitOps Enterprise Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Full GitOps on Kubernetes: ArgoCD + Argo Rollouts (canary/blue-green), Terraform provisioning, Kyverno admission policy, automated drift remediation.</p>
        ...
        <li class="text-slate-300">ArgoCD GitOps synced per environment</li>
        <li class="text-slate-300">Argo Rollouts progressive delivery (canary/blue-green)</li>
        <li class="text-slate-300">Terraform EKS/GKE/AKS provisioning</li>
        <li class="text-slate-300">Kyverno admission policies + OPA-Gatekeeper</li>
        <li class="text-slate-300">Drift auto-remediation reconciler</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with gitops enterprise platform</li>
