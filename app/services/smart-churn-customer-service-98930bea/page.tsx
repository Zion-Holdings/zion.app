...
export const metadata: Metadata = {
  title: 'Smart Churn Customer Service',
  description: 'Drive innovation in transportation with Smart Churn Customer Service. This AI-powered platform transforms healthcare data analytics into a competitive advantage',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-churn-customer-service-98930bea',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Churn Customer Service
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in transportation with Smart Churn Customer Service. This AI-powered platform transforms healthcare data analytics into a competitive advantage.
          </p>
