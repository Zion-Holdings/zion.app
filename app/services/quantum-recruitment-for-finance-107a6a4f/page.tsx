...
export const metadata: Metadata = {
  title: 'Quantum Recruitment for Finance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Recruitment for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your finance with Quantum Recruitment for Finance. Our autonomous solution handles contract analysis end-to-end without human intervention.
          </p>
