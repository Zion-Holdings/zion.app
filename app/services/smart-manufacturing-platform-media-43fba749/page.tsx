...
export const metadata: Metadata = {
  title: 'Smart Manufacturing Platform - Media',
  description: 'Drive innovation in media with Smart Manufacturing Platform - Media. This AI-powered platform transforms incident response into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-manufacturing-platform-media-43fba749',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manufacturing Platform - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in media with Smart Manufacturing Platform - Media. This AI-powered platform transforms incident response into a competitive advantage.
          </p>
