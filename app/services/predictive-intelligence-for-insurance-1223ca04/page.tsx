...
export const metadata: Metadata = {
  title: 'Predictive Intelligence for Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Predictive Intelligence for Insurance leverages advanced machine learning to deliver financial plann',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-intelligence-for-insurance-1223ca04',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Intelligence for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Predictive Intelligence for Insurance leverages advanced machine learning to deliver financial planning at scale.
          </p>
