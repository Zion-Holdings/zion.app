...
export const metadata: Metadata = {
  ...
  keywords: 'Alerting system, Open-source friendly, Edge computing support, GDPR compliance, Machine learning integration, Mobile-responsive interface, manager, logistics, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Powered Risk Suite</h1>
        <p className="text-lg text-slate-300 mb-8">Transform your logistics operations with our AI-Powered Risk Suite. This AI-driven solution automates workflow management with unprecedented accuracy and efficiency.</p>
