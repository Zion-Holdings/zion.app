...
export const metadata: Metadata = {
  title: 'Intelligent Customer Service for Hospitality',
  description: 'Drive innovation in hospitality with Intelligent Customer Service for Hospitality. This AI-powered platform transforms security monitoring into a competitive ad',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Customer Service for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Intelligent Customer Service for Hospitality. This AI-powered platform transforms security monitoring into a competitive advantage.
          </p>
