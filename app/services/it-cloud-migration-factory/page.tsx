...
export const metadata: Metadata = {
  ...
  keywords: 'Application portfolio assessment, Migration strategy (rehost, refactor, rearchitect), Automated migration tooling, Data migration with zero downtime, Post-migration optimization, Knowledge transfer and training, it, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Cloud Migration Factory</h1>
        <p className="text-lg text-slate-300 mb-8">Systematic cloud migration service with assessment, planning, migration, and optimization. Proven methodology for lifting and shifting or re-architecting to cloud-native.</p>
        ...
        <li class="text-slate-300">Application portfolio assessment</li>
        <li class="text-slate-300">Migration strategy (rehost, refactor, rearchitect)</li>
        <li class="text-slate-300">Automated migration tooling</li>
        <li class="text-slate-300">Data migration with zero downtime</li>
        <li class="text-slate-300">Post-migration optimization</li>
        <li class="text-slate-300">Knowledge transfer and training</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Migrate 10x faster with automation</li>
        <li class="text-slate-300">Reduce cloud costs by 40% post-migration</li>
        <li class="text-slate-300">Zero-downtime migrations for critical apps</li>
        <li class="text-slate-300">De-risk migration with proven methodology</li>
      </ul>
        </div>
