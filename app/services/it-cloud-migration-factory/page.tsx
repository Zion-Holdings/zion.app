...
export const metadata = {
  ...
  description: "Systematic cloud migration service with assessment, planning, migration, and optimization. Proven methodology for lifting and shifting or re-architecting to clo",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">IT Cloud Migration Factory</h1>
        ...
        <div className="border border-purple-500 rounded-xl p-6 mb-8">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="bg-slate-800 p-4 rounded-lg">
              ...
              <p className="text-2xl font-bold mb-2">$25,000 project</p>
            </div>
            <div className="bg-slate-800 p-4 rounded-lg border-2 border-purple-500">
              <h3 className="font-semibold mb-2">Pro</h3>
              <p className="text-2xl font-bold mb-2">$75,000 project</p>
            </div>
            <div className="bg-slate-800 p-4 rounded-lg">
