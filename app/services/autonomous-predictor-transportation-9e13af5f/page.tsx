...
export const metadata = {
  ...
  description: "Unlock unprecedented growth with Autonomous predictor-transportation. This autonomous system provides maintenance scheduling with zero manual intervention neede",
  alternates: {
