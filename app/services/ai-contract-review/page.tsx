      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Automatically reviews legal contracts, flags risky clauses, suggests amendments, and benchmarks against industry standards.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Clause risk scoring (1-10)</li>
            <li className="text-purple-300">✓ Comparison with 200K+ public contracts</li>
            <li className="text-purple-300">✓ AI-suggested redlines</li>
            <li className="text-purple-300">✓ Compliance checklist generation</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai contract review assistant</li>
