...
export const metadata: Metadata = {
  ...
  keywords: 'Clause risk scoring (1-10), Comparison with 200K+ public contracts, AI-suggested redlines, Compliance checklist generation, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Contract Review Assistant</h1>
        <p className="text-lg text-slate-300 mb-8">Automatically reviews legal contracts, flags risky clauses, suggests amendments, and benchmarks against industry standards.</p>
        ...
        <li class="text-slate-300">Clause risk scoring (1-10)</li>
        <li class="text-slate-300">Comparison with 200K+ public contracts</li>
        <li class="text-slate-300">AI-suggested redlines</li>
        <li class="text-slate-300">Compliance checklist generation</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai contract review assistant</li>
