...
export const metadata: Metadata = {
  title: 'AI DevOps - Transportation Edition',
  description: 'Next-generation transportation solution: AI DevOps - Transportation Edition. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-devops-transportation-edition-d565001c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI DevOps - Transportation Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation transportation solution: AI DevOps - Transportation Edition. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
