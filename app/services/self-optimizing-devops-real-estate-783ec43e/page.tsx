...
export const metadata = {
  ...
  description: "Transform your Real Estate operations with our Self-Optimizing devops-real estate. This AI-driven solution automates healthcare data analytics with unprecedente",
  alternates: {
