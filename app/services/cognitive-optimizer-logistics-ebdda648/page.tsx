...
export const metadata: Metadata = {
  title: 'Cognitive optimizer-logistics',
  description: 'Next-generation logistics solution: Cognitive optimizer-logistics. Combines content moderation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-optimizer-logistics-ebdda648',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive optimizer-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Cognitive optimizer-logistics. Combines content moderation with adaptive intelligence for optimal results.
          </p>
