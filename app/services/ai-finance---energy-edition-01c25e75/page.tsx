...
export const metadata: Metadata = {
  title: 'AI Finance - Energy Edition',
  description: 'Transform your energy operations with our AI Finance - Energy Edition. This AI-driven solution automates fraud prevention with unprecedented accuracy and effici',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-finance---energy-edition-01c25e75',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Finance - Energy Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our AI Finance - Energy Edition. This AI-driven solution automates fraud prevention with unprecedented accuracy and efficiency.
          </p>
