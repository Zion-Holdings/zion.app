...
export const metadata: Metadata = {
  title: 'LLM AI Sales Lead Scoring Engine',
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/llm-ai-sales-lead-scoring-engine-7c42ebcc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            LLM AI Sales Lead Scoring Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered llm solution for sales. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.
          </p>
