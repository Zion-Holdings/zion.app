...
export const metadata: Metadata = {
  title: 'Predictive Strategic for PROPTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Strategic for PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your proptech business with Predictive Strategic for PROPTECH. Our solution provides market analysis with enterprise-grade reliability and security.
          </p>
