...
export const metadata: Metadata = {
  title: 'AI Intelligent - Construction Edition',
  description: 'Next-generation construction solution: AI Intelligent - Construction Edition. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-intelligent-construction-edition-ee3f93ec',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Intelligent - Construction Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: AI Intelligent - Construction Edition. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
