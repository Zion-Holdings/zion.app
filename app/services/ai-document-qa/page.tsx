      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Upload PDFs, Word docs, and spreadsheets; ask natural language questions and get instant cited answers with multi-document cross-referencing and role-based access control.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Multi-format PDF/Word/Sheets ingest</li>
            <li className="text-purple-300">✓ Natural language query with citations</li>
            <li className="text-purple-300">✓ Cross-document comparison view</li>
            <li className="text-purple-300">✓ Role-based access and audit log</li>
            <li className="text-purple-300">✓ Snippet-level answer provenance</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai document q&a engine</li>
