...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-format PDF/Word/Sheets ingest, Natural language query with citations, Cross-document comparison view, Role-based access and audit log, Snippet-level answer provenance, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Document Q&amp;A Engine</h1>
        <p className="text-lg text-slate-300 mb-8">Upload PDFs, Word docs, and spreadsheets; ask natural language questions and get instant cited answers with multi-document cross-referencing and role-based access control.</p>
        ...
        <li class="text-slate-300">Multi-format PDF/Word/Sheets ingest</li>
        <li class="text-slate-300">Natural language query with citations</li>
        <li class="text-slate-300">Cross-document comparison view</li>
        <li class="text-slate-300">Role-based access and audit log</li>
        <li class="text-slate-300">Snippet-level answer provenance</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai document q&amp;a engine</li>
