...
export const metadata: Metadata = {
  title: 'AI-Powered Intelligent for Energy',
  description: 'Drive innovation in energy with AI-Powered Intelligent for Energy. This AI-powered platform transforms document processing into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-intelligent-for-energy-e345ad58',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Intelligent for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with AI-Powered Intelligent for Energy. This AI-powered platform transforms document processing into a competitive advantage.
          </p>
