...
export const metadata: Metadata = {
  title: 'Cognitive Orchestrator for Finance',
  description: 'Next-generation finance solution: Cognitive Orchestrator for Finance. Combines document processing with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-orchestrator-for-finance-c6d3d3ca',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Orchestrator for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation finance solution: Cognitive Orchestrator for Finance. Combines document processing with adaptive intelligence for optimal results.
          </p>
