...
export const metadata: Metadata = {
  title: 'AI-Powered advisor-logistics',
  description: 'Drive innovation in logistics with AI-Powered advisor-logistics. This AI-powered platform transforms data processing into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-advisor-logistics-df420452',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered advisor-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with AI-Powered advisor-logistics. This AI-powered platform transforms data processing into a competitive advantage.
          </p>
