...
export const metadata: Metadata = {
  title: 'Intelligent predictive-agriculture',
  description: 'Enhance your agriculture business with Intelligent predictive-agriculture. Our solution provides influencer identification with enterprise-grade reliability and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-predictive-agriculture-60f109b5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent predictive-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your agriculture business with Intelligent predictive-agriculture. Our solution provides influencer identification with enterprise-grade reliability and security.
          </p>
