...
export const metadata: Metadata = {
  title: 'Pipeline Visibility AI-Powered Market Intelligence',
  description: 'pipeline visibility solution for smart city industry. Monitors market trends, competitor activities, and industry news to provide actionable insights.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/pipeline-visibility-ai-powered-market-intelligence-6ba94f4e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Pipeline Visibility AI-Powered Market Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            pipeline visibility solution for smart city industry. Monitors market trends, competitor activities, and industry news to provide actionable insights.
          </p>
