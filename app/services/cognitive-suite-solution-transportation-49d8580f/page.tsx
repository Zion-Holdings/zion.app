...
export const metadata: Metadata = {
  title: 'Cognitive Suite Solution - Transportation',
  description: 'Transform your transportation operations with our Cognitive Suite Solution - Transportation. This AI-driven solution automates data quality with unprecedented a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Suite Solution - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your transportation operations with our Cognitive Suite Solution - Transportation. This AI-driven solution automates data quality with unprecedented accuracy and efficiency.
          </p>
