...
export const metadata: Metadata = {
  title: 'Smart NLP Platform - Finance',
  description: 'Optimize your finance workflows with Smart NLP Platform - Finance. This intelligent platform delivers account planning through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-nlp-platform-finance-7de332b0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart NLP Platform - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your finance workflows with Smart NLP Platform - Finance. This intelligent platform delivers account planning through advanced automation and AI.
          </p>
