...
export const metadata: Metadata = {
  title: 'Next-Gen Document for FINTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Document for FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your fintech business with Next-Gen Document for FINTECH. Our solution provides financial planning with enterprise-grade reliability and security.
          </p>
