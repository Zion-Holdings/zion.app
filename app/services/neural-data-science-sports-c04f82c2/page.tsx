...
export const metadata: Metadata = {
  title: 'Neural data science-sports',
  description: 'Unlock unprecedented growth with Neural data science-sports. This autonomous system provides leave management with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/neural-data-science-sports-c04f82c2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural data science-sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Neural data science-sports. This autonomous system provides leave management with zero manual intervention needed.
          </p>
