...
export const metadata: Metadata = {
  title: 'AI Network - Insurance Edition',
  description: 'Optimize your insurance workflows with AI Network - Insurance Edition. This intelligent platform delivers sales forecasting through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-network-insurance-edition-58acf93f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Network - Insurance Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your insurance workflows with AI Network - Insurance Edition. This intelligent platform delivers sales forecasting through advanced automation and AI.
          </p>
