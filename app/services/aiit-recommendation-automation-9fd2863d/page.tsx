...
export const metadata: Metadata = {
  title: 'AI/IT Recommendation Automation',
  description: 'Enhance your hospitality business with AI/IT Recommendation Automation. Our solution provides recommendation system with enterprise-grade reliability and securi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Recommendation Automation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with AI/IT Recommendation Automation. Our solution provides recommendation system with enterprise-grade reliability and security.
          </p>
