...
export const metadata: Metadata = {
  title: 'AI-Powered Support for Sports',
  description: 'Revolutionize sports through intelligent automation. Our AI-Powered Support for Sports leverages advanced machine learning to deliver sales process optimization',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-support-for-sports-9356e9c6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Support for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our AI-Powered Support for Sports leverages advanced machine learning to deliver sales process optimization at scale.
          </p>
