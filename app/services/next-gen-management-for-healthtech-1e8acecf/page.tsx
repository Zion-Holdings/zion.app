...
export const metadata: Metadata = {
  title: 'Next-Gen Management for HEALTHTECH',
  description: 'Transform your healthtech operations with our Next-Gen Management for HEALTHTECH. This AI-driven solution automates receipt processing with unprecedented accura',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-management-for-healthtech-1e8acecf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Management for HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthtech operations with our Next-Gen Management for HEALTHTECH. This AI-driven solution automates receipt processing with unprecedented accuracy and efficiency.
          </p>
