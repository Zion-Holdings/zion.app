...
export const metadata: Metadata = {
  title: 'Engine Intelligent - Logistics #2',
  description: 'Optimize your logistics workflows with Engine Intelligent - Logistics #2. This intelligent platform delivers resource utilization through advanced automation an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/engine-intelligent-logistics-2-1c6e0dc9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Engine Intelligent - Logistics #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your logistics workflows with Engine Intelligent - Logistics #2. This intelligent platform delivers resource utilization through advanced automation and AI.
          </p>
