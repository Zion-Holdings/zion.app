...
export const metadata: Metadata = {
  title: 'Predictive Cognitive Engine - Enterprise',
  description: 'Future-proof your enterprise with Predictive Cognitive Engine - Enterprise. Our autonomous solution handles document processing end-to-end without human interve',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Cognitive Engine - Enterprise
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your enterprise with Predictive Cognitive Engine - Enterprise. Our autonomous solution handles document processing end-to-end without human intervention.
          </p>
