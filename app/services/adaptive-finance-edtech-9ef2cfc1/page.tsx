...
export const metadata: Metadata = {
  title: 'Adaptive finance-edtech',
  description: 'Hyper-accelerated edtech solution: Adaptive finance-edtech. Combines workflow automation with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-finance-edtech-9ef2cfc1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive finance-edtech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated edtech solution: Adaptive finance-edtech. Combines workflow automation with next-gen AI for maximum velocity.
          </p>
