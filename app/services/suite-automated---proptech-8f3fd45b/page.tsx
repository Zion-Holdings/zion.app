...
export const metadata: Metadata = {
  title: 'Suite Automated - Proptech',
  description: 'Unlock unprecedented growth with Suite Automated - Proptech. This autonomous system provides manufacturing quality control with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/suite-automated---proptech-8f3fd45b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Suite Automated - Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Suite Automated - Proptech. This autonomous system provides manufacturing quality control with zero manual intervention needed.
          </p>
