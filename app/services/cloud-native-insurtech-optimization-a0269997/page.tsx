...
export const metadata = {
  title: "Cloud-Native Insurtech Optimization - Zion Tech Group",
  description: "AI-driven cloud optimization platform that automatically manages resource allocation and cost optimization.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/cloud-native-insurtech-optimization-a0269997`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Cloud-Native Insurtech Optimization</h1>
