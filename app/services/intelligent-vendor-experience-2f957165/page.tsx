...
export const metadata: Metadata = {
  title: 'Intelligent Vendor Experience',
  description: 'Drive innovation in technology with Intelligent Vendor Experience. This AI-powered platform transforms market intelligence into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-vendor-experience-2f957165',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Vendor Experience
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in technology with Intelligent Vendor Experience. This AI-powered platform transforms market intelligence into a competitive advantage.
          </p>
