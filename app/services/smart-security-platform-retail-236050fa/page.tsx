...
export const metadata: Metadata = {
  title: 'Smart Security Platform - Retail',
  description: 'Next-generation retail solution: Smart Security Platform - Retail. Combines scalability planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-security-platform-retail-236050fa',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Security Platform - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation retail solution: Smart Security Platform - Retail. Combines scalability planning with adaptive intelligence for optimal results.
          </p>
