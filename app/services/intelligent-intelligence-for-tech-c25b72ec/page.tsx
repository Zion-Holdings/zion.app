...
export const metadata: Metadata = {
  title: 'Intelligent Intelligence for Tech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Intelligence for Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize technology through intelligent automation. Our Intelligent Intelligence for Tech leverages advanced machine learning to deliver social media monitoring at scale.
          </p>
