...
export const metadata: Metadata = {
  title: 'Intelligent Experience for Telecom',
  description: 'Transform your telecom operations with our Intelligent Experience for Telecom. This AI-driven solution automates risk assessment with unprecedented accuracy and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-experience-for-telecom-77249d03',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Experience for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your telecom operations with our Intelligent Experience for Telecom. This AI-driven solution automates risk assessment with unprecedented accuracy and efficiency.
          </p>
