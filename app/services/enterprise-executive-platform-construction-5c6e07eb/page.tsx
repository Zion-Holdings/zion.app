...
export const metadata: Metadata = {
  title: 'Enterprise Executive Platform - Construction',
  description: 'Unlock unprecedented growth with Enterprise Executive Platform - Construction. This autonomous system provides pipeline management with zero manual intervention',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Executive Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Enterprise Executive Platform - Construction. This autonomous system provides pipeline management with zero manual intervention needed.
          </p>
