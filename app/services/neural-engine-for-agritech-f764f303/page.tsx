...
export const metadata: Metadata = {
  title: 'Neural Engine for Agritech',
  description: 'Transform your agritech operations with our Neural Engine for Agritech. This AI-driven solution automates financial risk management with unprecedented accuracy ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Engine for Agritech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agritech operations with our Neural Engine for Agritech. This AI-driven solution automates financial risk management with unprecedented accuracy and efficiency.
          </p>
