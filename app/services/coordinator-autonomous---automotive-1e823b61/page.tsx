...
export const metadata: Metadata = {
  title: 'Coordinator Autonomous - Automotive',
  description: 'Next-generation automotive solution: Coordinator Autonomous - Automotive. Combines risk assessment with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/coordinator-autonomous---automotive-1e823b61',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Coordinator Autonomous - Automotive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation automotive solution: Coordinator Autonomous - Automotive. Combines risk assessment with adaptive intelligence for optimal results.
          </p>
