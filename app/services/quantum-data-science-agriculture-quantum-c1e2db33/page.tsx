...
export const metadata: Metadata = {
  title: 'Quantum Data Science - Agriculture Quantum',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Data Science - Agriculture Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in agriculture with Quantum Data Science - Agriculture Quantum. This AI-powered platform transforms api management into a competitive advantage.
          </p>
