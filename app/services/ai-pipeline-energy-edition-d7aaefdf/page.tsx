...
export const metadata: Metadata = {
  title: 'AI Pipeline - Energy Edition',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Pipeline - Energy Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your energy workflows with AI Pipeline - Energy Edition. This intelligent platform delivers release management through advanced automation and AI.
          </p>
