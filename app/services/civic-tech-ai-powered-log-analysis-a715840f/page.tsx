...
export const metadata: Metadata = {
  title: 'Civic Tech AI-Powered Log Analysis',
  description: 'AI-powered civic tech solution for devops. Automated log analysis for incident detection and root cause analysis.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/civic-tech-ai-powered-log-analysis-a715840f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Civic Tech AI-Powered Log Analysis
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered civic tech solution for devops. Automated log analysis for incident detection and root cause analysis.
          </p>
