...
export const metadata: Metadata = {
  title: 'Autonomous System System - Agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Autonomous System System - Agriculture leverages advanced machine learning to deliver feedback col',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-system-system-agriculture-c437b3c1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous System System - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Autonomous System System - Agriculture leverages advanced machine learning to deliver feedback collection at scale.
          </p>
