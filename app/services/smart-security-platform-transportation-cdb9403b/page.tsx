...
export const metadata: Metadata = {
  title: 'Smart Security Platform - Transportation',
  description: 'Revolutionize transportation through intelligent automation. Our Smart Security Platform - Transportation leverages advanced machine learning to deliver risk as',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-security-platform-transportation-cdb9403b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Security Platform - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize transportation through intelligent automation. Our Smart Security Platform - Transportation leverages advanced machine learning to deliver risk assessment at scale.
          </p>
