...
export const metadata: Metadata = {
  ...
  keywords: 'SOC 2 Type II evidence auto-collection, Control-test automation (30+ pre-built tests), GRC Evidence Vault (versioned, immutable), Continuous monitoring dashboard per control, security, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Compliance &amp; Audit Automation</h1>
        <p className="text-lg text-slate-300 mb-8">SOC 2 Type II evidence collection, control-test automation, GRC Evidence Vault, continuous monitoring dashboard, and auditor-ready report.</p>
        ...
        <li class="text-slate-300">SOC 2 Type II evidence auto-collection</li>
        <li class="text-slate-300">Control-test automation (30+ pre-built tests)</li>
        <li class="text-slate-300">GRC Evidence Vault (versioned, immutable)</li>
        <li class="text-slate-300">Continuous monitoring dashboard per control</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with compliance &amp; audit automation</li>
