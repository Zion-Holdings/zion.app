...
export const metadata: Metadata = {
  title: 'Enterprise Manager - Construction',
  description: 'The future of construction is here with Enterprise Manager - Construction. Powered by cutting-edge AI, this platform delivers customer insights like never befor',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Manager - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Enterprise Manager - Construction. Powered by cutting-edge AI, this platform delivers customer insights like never before.
          </p>
