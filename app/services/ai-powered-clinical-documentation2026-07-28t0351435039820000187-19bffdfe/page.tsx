...
export const metadata: Metadata = {
  ...
  description: 'AI-powered clinical documentation with voice-to-text and auto-charting.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-clinical-documentation2026-07-28t0351435039820000187-19bffdfe',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            AI-powered clinical documentation with voice-to-text and auto-charting.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Documentation automation</li>
          <li className="text-gray-300">Voice-to-text</li>
          <li className="text-gray-300">Auto-charting</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">50% documentation time saved</li>
