...
export const metadata: Metadata = {
  title: 'Cognitive Insights Solution - Logistics',
  description: 'Transform your logistics operations with our Cognitive Insights Solution - Logistics. This AI-driven solution automates container orchestration with unprecedent',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-insights-solution-logistics-8b64fac8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Insights Solution - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Cognitive Insights Solution - Logistics. This AI-driven solution automates container orchestration with unprecedented accuracy and efficiency.
          </p>
