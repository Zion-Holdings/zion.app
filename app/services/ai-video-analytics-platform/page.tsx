...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time content moderation (violence, nudity, hate), Object and scene detection in video streams, Facial recognition with privacy controls, Behavioral anomaly detection, Automated video tagging and transcription, Live stream monitoring with sub-second latency, ai, media, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Video Analytics &amp; Content Moderation</h1>
        <p className="text-lg text-slate-300 mb-8">Real-time video analytics platform for content moderation, object detection, and behavioral analysis. Powers safe user-generated content and intelligent surveillance.</p>
        ...
        <li class="text-slate-300">Real-time content moderation (violence, nudity, hate)</li>
        <li class="text-slate-300">Object and scene detection in video streams</li>
        <li class="text-slate-300">Facial recognition with privacy controls</li>
        <li class="text-slate-300">Behavioral anomaly detection</li>
        <li class="text-slate-300">Automated video tagging and transcription</li>
        <li class="text-slate-300">Live stream monitoring with sub-second latency</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Moderate 100% of video content automatically</li>
        <li class="text-slate-300">Reduce content moderation costs by 90%</li>
        <li class="text-slate-300">Detect threats in real-time</li>
        <li class="text-slate-300">Scale video operations without adding reviewers</li>
      </ul>
        </div>
