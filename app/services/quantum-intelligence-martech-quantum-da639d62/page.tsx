...
export const metadata: Metadata = {
  title: 'Quantum Intelligence - MARTECH Quantum',
  description: 'Transform your martech operations with our Quantum Intelligence - MARTECH Quantum. This AI-driven solution automates business process with unprecedented accurac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-intelligence-martech-quantum-da639d62',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Intelligence - MARTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your martech operations with our Quantum Intelligence - MARTECH Quantum. This AI-driven solution automates business process with unprecedented accuracy and efficiency.
          </p>
