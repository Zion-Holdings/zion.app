...
export const metadata: Metadata = {
  title: 'Neural process mining-healthcare',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural process mining-healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with Neural process mining-healthcare. This AI-powered platform transforms territory management into a competitive advantage.
          </p>
