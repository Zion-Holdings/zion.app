...
export const metadata: Metadata = {
  ...
  keywords: 'Automated certificate issuance and renewal, Multi-CA support (LetsEncrypt, DigiCert, Sectigo), Expiry monitoring and alerting, Certificate inventory and audit, Private CA management, Compliance reporting, Integration with ACME, HashiCorp Vault, micro-saas, Security, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">CertManager — SSL/TLS Certificate Mgmt</h1>
        <p className="text-lg text-slate-300 mb-8">Automated SSL/TLS certificate lifecycle: issuance, renewal, revocation, monitoring. Never let a cert expire.</p>
        ...
        <li class="text-slate-300">Automated certificate issuance and renewal</li>
        <li class="text-slate-300">Multi-CA support (LetsEncrypt</li>
        <li class="text-slate-300">DigiCert</li>
        <li class="text-slate-300">Sectigo)</li>
        <li class="text-slate-300">Expiry monitoring and alerting</li>
        <li class="text-slate-300">Certificate inventory and audit</li>
        <li class="text-slate-300">Private CA management</li>
        <li class="text-slate-300">Compliance reporting</li>
        <li class="text-slate-300">Integration with ACME</li>
        <li class="text-slate-300">HashiCorp Vault</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Never let a certificate expire</li>
        <li class="text-slate-300">Automated renewal eliminates manual work</li>
        <li class="text-slate-300">Centralized inventory for audit</li>
        <li class="text-slate-300">Private CA for internal services</li>
      </ul>
        </div>
