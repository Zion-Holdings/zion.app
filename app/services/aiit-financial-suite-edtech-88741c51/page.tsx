...
export const metadata: Metadata = {
  title: 'AI/IT Financial Suite - EDTECH',
  description: 'Drive innovation in edtech with AI/IT Financial Suite - EDTECH. This AI-powered platform transforms serverless orchestration into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-financial-suite-edtech-88741c51',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Financial Suite - EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in edtech with AI/IT Financial Suite - EDTECH. This AI-powered platform transforms serverless orchestration into a competitive advantage.
          </p>
