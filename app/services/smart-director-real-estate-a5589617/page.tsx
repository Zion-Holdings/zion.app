...
export const metadata: Metadata = {
  title: 'Smart director-real-estate',
  description: 'Drive innovation in real-estate with Smart director-real-estate. This AI-powered platform transforms campaign optimization into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-director-real-estate-a5589617',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart director-real-estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in real-estate with Smart director-real-estate. This AI-powered platform transforms campaign optimization into a competitive advantage.
          </p>
