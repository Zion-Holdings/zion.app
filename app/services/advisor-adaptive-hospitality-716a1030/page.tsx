...
export const metadata: Metadata = {
  title: 'Advisor Adaptive - Hospitality',
  description: 'Optimize your hospitality workflows with Advisor Adaptive - Hospitality. This intelligent platform delivers master data management through advanced automation a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/advisor-adaptive-hospitality-716a1030',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Advisor Adaptive - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Advisor Adaptive - Hospitality. This intelligent platform delivers master data management through advanced automation and AI.
          </p>
