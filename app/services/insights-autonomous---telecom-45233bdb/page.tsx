...
export const metadata: Metadata = {
  title: 'Insights Autonomous - Telecom',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Insights Autonomous - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of telecom is here with Insights Autonomous - Telecom. Powered by cutting-edge AI, this platform delivers decision support like never before.
          </p>
