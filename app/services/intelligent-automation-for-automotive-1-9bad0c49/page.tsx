...
export const metadata: Metadata = {
  title: 'Intelligent Automation for Automotive #1',
  description: 'Optimize your automotive workflows with Intelligent Automation for Automotive #1. This intelligent platform delivers brand monitoring through advanced automatio',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Automation for Automotive #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your automotive workflows with Intelligent Automation for Automotive #1. This intelligent platform delivers brand monitoring through advanced automation and AI.
          </p>
