...
export const metadata: Metadata = {
  title: 'Automated Intelligence for Construction',
  description: 'The future of construction is here with Automated Intelligence for Construction. Powered by cutting-edge AI, this platform delivers image recognition like never',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-intelligence-for-construction-0cea0132',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Intelligence for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Automated Intelligence for Construction. Powered by cutting-edge AI, this platform delivers image recognition like never before.
          </p>
