...
export const metadata: Metadata = {
  title: 'Intelligent Automation for Sports',
  description: 'Next-generation sports solution: Intelligent Automation for Sports. Combines content moderation with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-automation-for-sports-7f93bd40',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Automation for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation sports solution: Intelligent Automation for Sports. Combines content moderation with adaptive intelligence for optimal results.
          </p>
