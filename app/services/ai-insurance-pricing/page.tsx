...
export const metadata: Metadata = {
  ...
  keywords: 'Per-risk ML pricing model, Confidence interval + exposure summary, Market rate benchmarking vs competitors, Underwriter explainability per recommendation, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Insurance Pricing Advisor</h1>
        <p className="text-lg text-slate-300 mb-8">ML pricing model for underwriters: ingests claim history risk factors market data produces per-risk pricing with confidence interval exposure summary benchmark vs competitors.</p>
        ...
        <li class="text-slate-300">Per-risk ML pricing model</li>
        <li class="text-slate-300">Confidence interval + exposure summary</li>
        <li class="text-slate-300">Market rate benchmarking vs competitors</li>
        <li class="text-slate-300">Underwriter explainability per recommendation</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai insurance pricing advisor</li>
