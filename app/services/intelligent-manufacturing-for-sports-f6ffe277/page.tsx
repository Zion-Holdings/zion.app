...
export const metadata: Metadata = {
  title: 'Intelligent Manufacturing for Sports',
  description: 'Drive innovation in sports with Intelligent Manufacturing for Sports. This AI-powered platform transforms master data management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-manufacturing-for-sports-f6ffe277',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Manufacturing for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in sports with Intelligent Manufacturing for Sports. This AI-powered platform transforms master data management into a competitive advantage.
          </p>
