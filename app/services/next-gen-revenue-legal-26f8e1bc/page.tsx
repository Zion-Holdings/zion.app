...
export const metadata: Metadata = {
  title: 'Next-Gen revenue-legal',
  description: 'Next-generation legal solution: Next-Gen revenue-legal. Combines quality control with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-revenue-legal-26f8e1bc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen revenue-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Next-Gen revenue-legal. Combines quality control with adaptive intelligence for optimal results.
          </p>
