...
export const metadata: Metadata = {
  ...
  keywords: 'Automated data discovery, AI classification and tagging, Data lineage tracking, Quality scoring, Integration with Snowflake, Databricks, BigQuery, Collaboration and glossary, Access control, Usage analytics, data, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Powered Data Catalog</h1>
        <p className="text-lg text-slate-300 mb-8">Automated data catalog with AI-powered discovery, classification, and lineage. Find, understand, and trust your data assets.</p>
        ...
        <li class="text-slate-300">Collaboration and glossary</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Find data assets instantly</li>
        <li class="text-slate-300">Understand data lineage</li>
        <li class="text-slate-300">Ensure data quality</li>
