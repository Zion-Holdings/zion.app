...
export const metadata: Metadata = {
  ...
  keywords: 'EDR engine with behavioural analytics, endpoint firewall, exploit prevention, Patch catalog covering CVE/third-party blobs — auto-deploy fix per deployment group, Compliance posture dashboard for HIPAA/PCI/SOX/ISO27001/GDPR, Automated audit evidence export package per framework on demand, it, Healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Endpoint Security &amp; Compliance Monitor</h1>
        <p className="text-lg text-slate-300 mb-8">Endpoint security continuous monitoring: EDR detection + endpoint firewall + exploit prevention, CVE auto-fix via patch catalog, compliance posture for HIPAA/PCI/SOX/ISO27001 with automated audit evidence export.</p>
        ...
        <li class="text-slate-300">EDR engine with behavioural analytics, endpoint firewall, exploit prevention</li>
        <li class="text-slate-300">Patch catalog covering CVE/third-party blobs — auto-deploy fix per deployment group</li>
        <li class="text-slate-300">Compliance posture dashboard for HIPAA/PCI/SOX/ISO27001/GDPR</li>
        <li class="text-slate-300">Automated audit evidence export package per framework on demand</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with endpoint security &amp; compliance monitor</li>
