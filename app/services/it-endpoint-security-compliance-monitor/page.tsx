...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'Endpoint Security & Compliance Monitor', 'description': 'Endpoint security continuous monitoring: EDR detection + endpoint firewall + exploit prevention, CVE auto-fix via patch catalog, compliance posture for HIPAA/PCI/SOX/ISO27001 with automated audit evidence export.', 'serviceType': 'it', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'commercial@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'Healthcare'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'Endpoint Security & Compliance Monitor Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$399/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$999/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': '$2,999/mo', 'priceCurrency': 'USD'}]}} />
    <JsonLd data={'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'EDR engine with behavioural analytics, endpoint firewall, exploit prevention', 'acceptedAnswer': {'@type': 'Answer', 'text': 'EDR engine with behavioural analytics, endpoint firewall, exploit prevention'}}, {'@type': 'Question', 'name': 'Patch catalog covering CVE/third-party blobs — auto-deploy fix per deployment group', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Patch catalog covering CVE/third-party blobs — auto-deploy fix per deployment group'}}, {'@type': 'Question', 'name': 'Compliance posture dashboard for HIPAA/PCI/SOX/ISO27001/GDPR', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Compliance posture dashboard for HIPAA/PCI/SOX/ISO27001/GDPR'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Reduce costs with endpoint security & compliance monitor; Improve operational efficiency; Scale without complexity'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} />
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path={`/services/it-endpoint-security-compliance-monitor`} title="Endpoint Security & Compliance Monitor" />
