...
export const metadata: Metadata = {
  ...
  description: 'Generates and reviews legal contracts with clause-level risk scoring and jurisdiction rules.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-legal-contract-generator-53f5c068',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Generates and reviews legal contracts with clause-level risk scoring and jurisdiction rules.
          </p>
