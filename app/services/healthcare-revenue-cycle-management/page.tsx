...
export const metadata: Metadata = {
  ...
  keywords: 'Automated medical coding (ICD-10, CPT), Electronic claims submission, Denial prediction and prevention, Payment reconciliation, Patient cost estimation, Prior authorization automation, Compliance reporting, Integration with billing systems, healthcare-it, Healthcare, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Revenue Cycle Management Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Automate healthcare revenue cycle from patient registration to final payment. AI-powered coding, claims submission, denial management, and payment reconciliation.</p>
        ...
        <li class="text-slate-300">Automated medical coding (ICD-10, CPT)</li>
        <li class="text-slate-300">Electronic claims submission</li>
        <li class="text-slate-300">Denial prediction and prevention</li>
        <li class="text-slate-300">Payment reconciliation</li>
        <li class="text-slate-300">Patient cost estimation</li>
        <li class="text-slate-300">Prior authorization automation</li>
        <li class="text-slate-300">Compliance reporting</li>
        <li class="text-slate-300">Integration with billing systems</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce claim denials by 50%</li>
        <li class="text-slate-300">Accelerate payment cycles</li>
        <li class="text-slate-300">Improve coding accuracy</li>
        <li class="text-slate-300">Increase revenue capture</li>
      </ul>
        </div>
