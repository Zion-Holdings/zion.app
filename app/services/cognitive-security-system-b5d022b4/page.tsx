...
export const metadata: Metadata = {
  title: 'Cognitive Security System',
  description: 'The future of althealth is here with Cognitive Security System. Powered by cutting-edge AI, this platform delivers quality prediction like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-security-system-b5d022b4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of althealth is here with Cognitive Security System. Powered by cutting-edge AI, this platform delivers quality prediction like never before.
          </p>
