...
export const metadata: Metadata = {
  title: 'Cognitive Supply Solution - Insurance #1',
  description: 'The future of insurance is here with Cognitive Supply Solution - Insurance #1. Powered by cutting-edge AI, this platform delivers workflow management like never',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-supply-solution-insurance-1-19377ee4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Supply Solution - Insurance #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Cognitive Supply Solution - Insurance #1. Powered by cutting-edge AI, this platform delivers workflow management like never before.
          </p>
