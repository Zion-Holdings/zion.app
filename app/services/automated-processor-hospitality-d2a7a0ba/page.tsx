...
export const metadata: Metadata = {
  title: 'Automated processor-hospitality',
  description: 'Transform your hospitality operations with our Automated processor-hospitality. This AI-driven solution automates data pipeline orchestration with unprecedented',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-processor-hospitality-d2a7a0ba',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated processor-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Automated processor-hospitality. This AI-driven solution automates data pipeline orchestration with unprecedented accuracy and efficiency.
          </p>
