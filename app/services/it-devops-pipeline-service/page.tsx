...
export const metadata: Metadata = {
  ...
  keywords: 'Visual pipeline builder, Automated testing integration, Security scanning (SAST, DAST, SCA), Multi-environment deployment, Rollback and canary releases, Integration with GitHub, GitLab, Bitbucket, Infrastructure provisioning, Compliance-as-code, it, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT DevOps Pipeline as a Service</h1>
        <p className="text-lg text-slate-300 mb-8">Fully managed CI/CD pipeline with automated testing, security scanning, and deployment orchestration for any language or framework.</p>
        ...
        <li class="text-slate-300">Visual pipeline builder</li>
        <li class="text-slate-300">Automated testing integration</li>
        <li class="text-slate-300">Security scanning (SAST, DAST, SCA)</li>
        <li class="text-slate-300">Multi-environment deployment</li>
        <li class="text-slate-300">Rollback and canary releases</li>
        <li class="text-slate-300">Integration with GitHub, GitLab, Bitbucket</li>
        <li class="text-slate-300">Infrastructure provisioning</li>
        <li class="text-slate-300">Compliance-as-code</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Deploy 10x faster</li>
        <li class="text-slate-300">Catch vulnerabilities early</li>
        <li class="text-slate-300">Reduce deployment failures</li>
        <li class="text-slate-300">Meet compliance automatically</li>
      </ul>
        </div>
