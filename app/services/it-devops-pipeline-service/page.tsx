...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'IT DevOps Pipeline as a Service', 'description': 'Fully managed CI/CD pipeline with automated testing, security scanning, and deployment orchestration for any language or framework.', 'serviceType': 'it', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'technology'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'IT DevOps Pipeline as a Service Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$199/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$599/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': 'Custom', 'priceCurrency': 'USD'}]}} />
    <JsonLd data={'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'Visual pipeline builder', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Visual pipeline builder'}}, {'@type': 'Question', 'name': 'Automated testing integration', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Automated testing integration'}}, {'@type': 'Question', 'name': 'Security scanning (SAST, DAST, SCA)', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Security scanning (SAST, DAST, SCA)'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Deploy 10x faster; Catch vulnerabilities early; Reduce deployment failures'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} />
