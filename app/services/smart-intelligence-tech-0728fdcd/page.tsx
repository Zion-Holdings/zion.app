...
export const metadata: Metadata = {
  title: 'Smart intelligence-tech',
  description: 'Transform your technology operations with our Smart intelligence-tech. This AI-driven solution automates code optimization with unprecedented accuracy and effic',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart intelligence-tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your technology operations with our Smart intelligence-tech. This AI-driven solution automates code optimization with unprecedented accuracy and efficiency.
          </p>
