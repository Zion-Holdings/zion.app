...
export const metadata: Metadata = {
  title: 'NLP Adaptive - Transportation',
  description: 'Enhance your transportation business with NLP Adaptive - Transportation. Our solution provides master data management with enterprise-grade reliability and secu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/nlp-adaptive-transportation-ae6b99bd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            NLP Adaptive - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your transportation business with NLP Adaptive - Transportation. Our solution provides master data management with enterprise-grade reliability and security.
          </p>
