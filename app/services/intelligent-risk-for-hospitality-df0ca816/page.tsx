...
export const metadata: Metadata = {
  title: 'Intelligent Risk for Hospitality',
  description: 'Transform your hospitality operations with our Intelligent Risk for Hospitality. This AI-driven solution automates document processing with unprecedented accura',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Risk for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your hospitality operations with our Intelligent Risk for Hospitality. This AI-driven solution automates document processing with unprecedented accuracy and efficiency.
          </p>
