...
export const metadata: Metadata = {
  title: 'Smart Suite for Manufacturing',
  description: 'Next-generation manufacturing solution: Smart Suite for Manufacturing. Combines financial planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-suite-for-manufacturing-7aac6168',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Suite for Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation manufacturing solution: Smart Suite for Manufacturing. Combines financial planning with adaptive intelligence for optimal results.
          </p>
