...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "Managed IT Services | Zion Tech Group", description: "End-to-end managed it services services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/managed-it-services-small-business-2026-8146/}} />
