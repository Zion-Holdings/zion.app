...
export const metadata: Metadata = {
  title: 'Autonomous Generator for Sports',
  description: 'Revolutionize sports through intelligent automation. Our Autonomous Generator for Sports leverages advanced machine learning to deliver energy management at sca',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-generator-for-sports-d7411675',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Generator for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Autonomous Generator for Sports leverages advanced machine learning to deliver energy management at scale.
          </p>
