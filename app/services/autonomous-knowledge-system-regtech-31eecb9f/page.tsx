...
export const metadata: Metadata = {
  title: 'Autonomous Knowledge System - REGTECH',
  description: 'Revolutionize regtech through intelligent automation. Our Autonomous Knowledge System - REGTECH leverages advanced machine learning to deliver scalability plann',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Knowledge System - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize regtech through intelligent automation. Our Autonomous Knowledge System - REGTECH leverages advanced machine learning to deliver scalability planning at scale.
          </p>
