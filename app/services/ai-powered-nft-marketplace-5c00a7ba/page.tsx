...
export const metadata: Metadata = {
  ...
  description: 'Creates and manages NFT marketplaces with AI-powered pricing and curation.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-nft-marketplace-5c00a7ba',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Creates and manages NFT marketplaces with AI-powered pricing and curation.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">NFT pricing</li>
          <li className="text-gray-300">Curation</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">30% higher sales</li>
