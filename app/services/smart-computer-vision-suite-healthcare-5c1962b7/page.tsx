...
export const metadata: Metadata = {
  title: 'Smart Computer Vision Suite - Healthcare',
  description: 'Future-proof your healthcare with Smart Computer Vision Suite - Healthcare. Our autonomous solution handles social media monitoring end-to-end without human int',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-computer-vision-suite-healthcare-5c1962b7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Computer Vision Suite - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your healthcare with Smart Computer Vision Suite - Healthcare. Our autonomous solution handles social media monitoring end-to-end without human intervention.
          </p>
