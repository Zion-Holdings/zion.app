...
export const metadata: Metadata = {
  title: 'Intelligent Automation for Agriculture',
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-automation-for-agriculture-43f20c62',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Automation for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Intelligent Automation for Agriculture. Powered by cutting-edge AI, this platform delivers maintenance scheduling like never before.
          </p>
