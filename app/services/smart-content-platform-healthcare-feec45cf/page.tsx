...
export const metadata: Metadata = {
  title: 'Smart Content Platform - Healthcare',
  description: 'Optimize your healthcare workflows with Smart Content Platform - Healthcare. This intelligent platform delivers sales process optimization through advanced auto',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-content-platform-healthcare-feec45cf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Content Platform - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Smart Content Platform - Healthcare. This intelligent platform delivers sales process optimization through advanced automation and AI.
          </p>
