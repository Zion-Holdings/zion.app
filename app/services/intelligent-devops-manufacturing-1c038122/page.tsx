...
export const metadata: Metadata = {
  title: 'Intelligent devops-manufacturing',
  description: 'Revolutionize manufacturing through intelligent automation. Our Intelligent devops-manufacturing leverages advanced machine learning to deliver manufacturing qu',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent devops-manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize manufacturing through intelligent automation. Our Intelligent devops-manufacturing leverages advanced machine learning to deliver manufacturing quality control at scale.
          </p>
