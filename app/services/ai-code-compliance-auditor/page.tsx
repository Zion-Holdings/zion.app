...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-language code analysis (50+), License compliance scanning (200+ licenses), Security vulnerability detection, Code quality scoring, CI/CD pipeline integration, SBOM generation, security, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Code Compliance &amp; License Auditor</h1>
        <p className="text-lg text-slate-300 mb-8">Scan codebases for license compliance, security vulnerabilities, and quality issues. Supports 50+ languages, 200+ license types. Integrates with GitHub, GitLab, Bitbucket.</p>
        ...
        <li class="text-slate-300">Multi-language code analysis (50+)</li>
        <li class="text-slate-300">License compliance scanning (200+ licenses)</li>
        <li class="text-slate-300">Security vulnerability detection</li>
        <li class="text-slate-300">Code quality scoring</li>
        <li class="text-slate-300">CI/CD pipeline integration</li>
        <li class="text-slate-300">SBOM generation</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Avoid license lawsuits</li>
        <li class="text-slate-300">Find vulnerabilities early</li>
        <li class="text-slate-300">Automate compliance</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">49/repo</p>
              <p class="text-sm text-slate-400">Getting started plan</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              <h3 class="font-semibold text-white mb-2">Pro</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">149/repo</p>
              <p class="text-sm text-slate-400">Most popular</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              <h3 class="font-semibold text-white mb-2">Enterprise</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">499/repo</p>
