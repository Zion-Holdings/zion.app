...
export const metadata: Metadata = {
  title: 'System Smart - Legal',
  description: 'Revolutionize legal through intelligent automation. Our System Smart - Legal leverages advanced machine learning to deliver enterprise-grade insights at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/system-smart-legal-b9b1ecc5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our System Smart - Legal leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
