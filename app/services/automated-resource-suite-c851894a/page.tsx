...
export const metadata: Metadata = {
  title: 'Automated Resource Suite',
  description: 'Optimize your transportation workflows with Automated Resource Suite. This intelligent platform delivers campaign optimization through advanced automation and A',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-resource-suite-c851894a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Resource Suite
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your transportation workflows with Automated Resource Suite. This intelligent platform delivers campaign optimization through advanced automation and AI.
          </p>
