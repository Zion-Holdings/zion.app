...
export const metadata: Metadata = {
  ...
  keywords: 'Copilot design and deployment, Context-aware assistance in flow of work, Multi-channel (Slack, Teams, email, browser extension), Knowledge grounding (RAG) with your data, Guardrails and output validation, Usage analytics and effectiveness tracking, SSO and enterprise security, automation, Productivity, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Copilot Workflow Builder</h1>
        <p className="text-lg text-slate-300 mb-8">Build AI copilots that embed in your employees workflow. Context-aware assistance in Slack, Teams, email, and browser with guardrails and knowledge grounding.</p>
        ...
        <li class="text-slate-300">Copilot design and deployment</li>
        <li class="text-slate-300">Context-aware assistance in flow of work</li>
        <li class="text-slate-300">Multi-channel (Slack, Teams, email, browser extension)</li>
        <li class="text-slate-300">Knowledge grounding (RAG) with your data</li>
        <li class="text-slate-300">Guardrails and output validation</li>
        <li class="text-slate-300">Usage analytics and effectiveness tracking</li>
        <li class="text-slate-300">SSO and enterprise security</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">AI assistance where employees already work</li>
        <li class="text-slate-300">Knowledge-grounded answers reduce hallucination</li>
        <li class="text-slate-300">Guardrails ensure safe, on-brand output</li>
        <li class="text-slate-300">Usage analytics prove ROI</li>
      </ul>
        </div>
