...
export const metadata: Metadata = {
  title: 'Edge DevOps Pipeline IoT (Analytics)',
  description: 'Edge DevOps Pipeline IoT (Analytics) is an AI-powered analytics solution that transforms how businesses operate through intelligent automation and real-time ana',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/edge-devops-pipeline-iot-(anal-3b52f5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Edge DevOps Pipeline IoT (Analytics)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Edge DevOps Pipeline IoT (Analytics) is an AI-powered analytics solution that transforms how businesses operate through intelligent automation and real-time analytics.
...
Docker, Node.js, IoT, Kubernetes, Hadoop, MongoDB
