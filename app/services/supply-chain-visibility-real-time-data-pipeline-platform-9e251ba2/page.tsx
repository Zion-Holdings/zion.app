...
export const metadata: Metadata = {
  title: 'Supply Chain Visibility Real-Time Data Pipeline Platform',
  description: 'AI-powered supply chain visibility solution for data engineering. Creates and manages real-time data pipelines with automated ETL and streaming analytics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/supply-chain-visibility-real-time-data-pipeline-platform-9e251ba2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Supply Chain Visibility Real-Time Data Pipeline Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered supply chain visibility solution for data engineering. Creates and manages real-time data pipelines with automated ETL and streaming analytics.
          </p>
