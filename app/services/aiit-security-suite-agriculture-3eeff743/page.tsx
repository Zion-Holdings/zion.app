...
export const metadata: Metadata = {
  title: 'AI/IT Security Suite - Agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our AI/IT Security Suite - Agriculture leverages advanced machine learning to deliver skills managemen',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-security-suite-agriculture-3eeff743',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Security Suite - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our AI/IT Security Suite - Agriculture leverages advanced machine learning to deliver skills management at scale.
          </p>
