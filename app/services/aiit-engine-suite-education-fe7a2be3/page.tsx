...
export const metadata: Metadata = {
  title: 'AI/IT Engine Suite - Education',
  description: 'Revolutionize education through intelligent automation. Our AI/IT Engine Suite - Education leverages advanced machine learning to deliver warehouse automation a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-engine-suite-education-fe7a2be3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Engine Suite - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize education through intelligent automation. Our AI/IT Engine Suite - Education leverages advanced machine learning to deliver warehouse automation at scale.
          </p>
