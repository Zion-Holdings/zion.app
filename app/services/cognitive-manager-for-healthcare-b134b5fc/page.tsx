...
export const metadata: Metadata = {
  title: 'Cognitive Manager for Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Cognitive Manager for Healthcare leverages advanced machine learning to deliver risk assessment at ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-manager-for-healthcare-b134b5fc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Manager for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Cognitive Manager for Healthcare leverages advanced machine learning to deliver risk assessment at scale.
          </p>
