...
export const metadata: Metadata = {
  title: 'AI Automation - Hospitality Edition #2',
  description: 'Optimize your hospitality workflows with AI Automation - Hospitality Edition #2. This intelligent platform delivers logistics route optimization through advance',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-automation-hospitality-edition-2-3b1d76bc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Automation - Hospitality Edition #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with AI Automation - Hospitality Edition #2. This intelligent platform delivers logistics route optimization through advanced automation and AI.
          </p>
