...
export const metadata: Metadata = {
  title: 'Scalable Supply Chain Express (Legal)',
  description: 'Scalable Supply Chain Express (Legal) is an AI-powered legal solution that transforms how businesses operate through intelligent automation and real-time analyt',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Scalable Supply Chain Express (Legal)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Scalable Supply Chain Express (Legal) is an AI-powered legal solution that transforms how businesses operate through intelligent automation and real-time analytics.
