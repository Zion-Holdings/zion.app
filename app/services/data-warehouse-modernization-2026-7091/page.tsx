...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "Data Warehouse Modernization | Zion Tech Group", description: "End-to-end data warehouse modernization services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/data-warehouse-modernization-2026-7091/"}} />
