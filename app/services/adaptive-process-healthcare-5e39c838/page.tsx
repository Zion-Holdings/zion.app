...
export const metadata: Metadata = {
  title: 'Adaptive Process Healthcare',
  description: 'Revolutionize hospitality through intelligent automation. Our Adaptive Process Healthcare leverages advanced machine learning to deliver process automation at s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Process Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Adaptive Process Healthcare leverages advanced machine learning to deliver process automation at scale.
          </p>
