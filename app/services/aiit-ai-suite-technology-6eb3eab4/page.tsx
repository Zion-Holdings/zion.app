...
export const metadata: Metadata = {
  title: 'AI/IT AI Suite - TECHNOLOGY',
  description: 'Quantum leap forward for technology: AI/IT AI Suite - TECHNOLOGY. Uses quantum-inspired algorithms to deliver expense reporting at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-ai-suite-technology-6eb3eab4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT AI Suite - TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for technology: AI/IT AI Suite - TECHNOLOGY. Uses quantum-inspired algorithms to deliver expense reporting at exponential speed.
          </p>
