...
export const metadata: Metadata = {
  ...
  keywords: 'Surface defect detection (scratches, dents, cracks), Dimension and tolerance verification, Color and finish consistency checking, Assembly and component validation, Multi-camera support with multi-angle, Statistical process control integration, Edge deployment for real-time inference, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Visual Inspection System</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered visual quality inspection for manufacturing: surface defects, dimension verification, color consistency, and assembly validation. 99.5% defect detection.</p>
        ...
        <li class="text-slate-300">Surface defect detection (scratches, dents, cracks)</li>
        <li class="text-slate-300">Dimension and tolerance verification</li>
        <li class="text-slate-300">Color and finish consistency checking</li>
        <li class="text-slate-300">Assembly and component validation</li>
        <li class="text-slate-300">Multi-camera support with multi-angle</li>
        <li class="text-slate-300">Statistical process control integration</li>
        <li class="text-slate-300">Edge deployment for real-time inference</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">99.5% defect detection accuracy</li>
        <li class="text-slate-300">Inspect 100% of products, not samples</li>
        <li class="text-slate-300">Real-time edge inference with no cloud latency</li>
        <li class="text-slate-300">Reduce quality costs by 60%</li>
      </ul>
        </div>
