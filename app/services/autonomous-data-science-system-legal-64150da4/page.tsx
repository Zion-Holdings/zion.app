...
export const metadata: Metadata = {
  title: 'Autonomous Data Science System - Legal',
  description: 'Enhance your legal business with Autonomous Data Science System - Legal. Our solution provides territory management with enterprise-grade reliability and securi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Data Science System - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Autonomous Data Science System - Legal. Our solution provides territory management with enterprise-grade reliability and security.
          </p>
