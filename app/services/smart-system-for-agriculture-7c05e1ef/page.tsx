...
export const metadata: Metadata = {
  title: 'Smart System for Agriculture',
  description: 'Transform your agriculture operations with our Smart System for Agriculture. This AI-driven solution automates financial planning with unprecedented accuracy an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-system-for-agriculture-7c05e1ef',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart System for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your agriculture operations with our Smart System for Agriculture. This AI-driven solution automates financial planning with unprecedented accuracy and efficiency.
          </p>
