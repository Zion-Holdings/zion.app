...
export const metadata: Metadata = {
  title: 'Autonomous User Intelligence',
  description: 'Transform your automotive operations with our Autonomous User Intelligence. This AI-driven solution automates workflow management with unprecedented accuracy an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your automotive operations with our Autonomous User Intelligence. This AI-driven solution automates workflow management with unprecedented accuracy and efficiency.
          </p>
