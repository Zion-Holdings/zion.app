...
export const metadata: Metadata = {
  title: 'Accounting AI-Powered Contract Analysis',
  description: 'AI-powered accounting solution for legal. Analyzes legal contracts and agreements using NLP to extract key terms and risks.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/accounting-ai-powered-contract-analysis-bd37de36',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Accounting AI-Powered Contract Analysis
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered accounting solution for legal. Analyzes legal contracts and agreements using NLP to extract key terms and risks.
          </p>
