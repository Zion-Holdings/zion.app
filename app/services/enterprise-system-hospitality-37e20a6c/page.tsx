...
export const metadata: Metadata = {
  title: 'Enterprise system-hospitality',
  description: 'Enhance your hospitality business with Enterprise system-hospitality. Our solution provides influencer identification with enterprise-grade reliability and secu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-system-hospitality-37e20a6c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise system-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Enterprise system-hospitality. Our solution provides influencer identification with enterprise-grade reliability and security.
          </p>
