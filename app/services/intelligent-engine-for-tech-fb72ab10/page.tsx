...
export const metadata: Metadata = {
  title: 'Intelligent Engine for Tech',
  description: 'Transform your technology operations with our Intelligent Engine for Tech. This AI-driven solution automates sales forecasting with unprecedented accuracy and e',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-engine-for-tech-fb72ab10',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Engine for Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your technology operations with our Intelligent Engine for Tech. This AI-driven solution automates sales forecasting with unprecedented accuracy and efficiency.
          </p>
