...
export const metadata: Metadata = {
  title: 'Smart Strategic Platform - Telecom',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Strategic Platform - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Strategic Platform - Telecom. This autonomous system provides insurance automation with zero manual intervention needed.
          </p>
