...
export const metadata: Metadata = {
  title: 'Intelligent Platform for Construction #1',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Platform for Construction #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Intelligent Platform for Construction #1. Combines maintenance scheduling with adaptive intelligence for optimal results.
          </p>
