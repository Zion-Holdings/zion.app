...
export const metadata: Metadata = {
  ...
  keywords: 'AI-powered search, Auto-categorization, Intelligent recommendations, Multi-source integration, Knowledge gap analysis, Expert identification, Content freshness scoring, Access control & governance, micro-saas, knowledge-management, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Enterprise knowledge base with AI-powered search, auto-categorization, and intelligent recommendations. Connects to Slack, Teams, Confluence, and SharePoint.</p>
        ...
        <li class="text-slate-300">Intelligent recommendations</li>
        ...
        <li class="text-slate-300">Content freshness scoring</li>
        <li class="text-slate-300">Access control &amp; governance</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Find answers 10x faster</li>
        <li class="text-slate-300">Reduce duplicate work by 40%</li>
        <li class="text-slate-300">Preserve institutional knowledge</li>
        <li class="text-slate-300">Improve onboarding speed</li>
        <li class="text-slate-300">Data-driven knowledge gaps</li>
      </ul>
        </div>
