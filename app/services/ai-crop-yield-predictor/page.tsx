  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Crop Yield Prediction &amp; Precision Agriculture</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered precision agriculture with crop yield prediction, soil analysis, and irrigation optimization. Increase yields by 20% while reducing water and fertilizer use.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">ai</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">agritech</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Satellite and drone imagery analysis</li>
        <li class="text-slate-300">Crop yield prediction with weather integration</li>
        <li class="text-slate-300">Soil health monitoring and recommendations</li>
        <li class="text-slate-300">Irrigation optimization and scheduling</li>
        <li class="text-slate-300">Pest and disease early detection</li>
        <li class="text-slate-300">Integration with farm management software</li>
        <li class="text-slate-300">Field-level analytics and reporting</li>
        <li class="text-slate-300">Sustainability and carbon credit tracking</li>
      </ul>
        </div>
        ...
        <li class="text-slate-300">Detect pests and disease 2 weeks early</li>
        <li class="text-slate-300">Optimize fertilizer application with AI</li>
      </ul>
        </div>
