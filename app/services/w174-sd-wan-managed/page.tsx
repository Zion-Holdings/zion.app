...
export const metadata: Metadata = {
  ...
  keywords: 'Application-aware routing and QoS, Multi-link (broadband, 5G, MPLS) aggregation, Built-in firewall and IDS/IPS, Centralized policy management, Auto-failover and self-healing, Cloud on-ramp optimization, Cisco Meraki, Fortinet, VMware Velocloud support, it, Networking, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">SD-WAN Managed Service</h1>
        <p className="text-lg text-slate-300 mb-8">Fully managed SD-WAN with intelligent path selection, application-aware routing, and built-in security. Replace MPLS with cost-effective broadband + 5G.</p>
        ...
        <li class="text-slate-300">Application-aware routing and QoS</li>
        <li class="text-slate-300">Multi-link (broadband, 5G, MPLS) aggregation</li>
        <li class="text-slate-300">Built-in firewall and IDS/IPS</li>
        <li class="text-slate-300">Centralized policy management</li>
        <li class="text-slate-300">Auto-failover and self-healing</li>
        <li class="text-slate-300">Cloud on-ramp optimization</li>
        <li class="text-slate-300">Cisco Meraki, Fortinet, VMware Velocloud support</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Replace expensive MPLS with broadband + 5G</li>
        <li class="text-slate-300">Application QoS ensures critical app performance</li>
        <li class="text-slate-300">Self-healing reduces support tickets</li>
        <li class="text-slate-300">Centralized management for all sites</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$199/site/mo</p>
              <p class="text-sm text-slate-400">Getting started plan</p>
            </div>
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              <h3 class="font-semibold text-white mb-2">Pro</h3>
              <p class="text-2xl font-bold text-purple-400 mb-2">$399/site/mo</p>
