...
export const metadata: Metadata = {
  title: 'Autonomous Risk System - Construction',
  description: 'Optimize your construction workflows with Autonomous Risk System - Construction. This intelligent platform delivers reputation management through advanced autom',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-risk-system-construction-e20da196',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Risk System - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Autonomous Risk System - Construction. This intelligent platform delivers reputation management through advanced automation and AI.
          </p>
