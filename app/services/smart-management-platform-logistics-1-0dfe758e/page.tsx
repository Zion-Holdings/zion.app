...
export const metadata: Metadata = {
  title: 'Smart Management Platform - Logistics #1',
  description: 'Enhance your logistics business with Smart Management Platform - Logistics #1. Our solution provides sales process optimization with enterprise-grade reliabilit',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-management-platform-logistics-1-0dfe758e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Management Platform - Logistics #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your logistics business with Smart Management Platform - Logistics #1. Our solution provides sales process optimization with enterprise-grade reliability and security.
          </p>
