...
export const metadata: Metadata = {
  title: 'Next-Gen Platform for Insurance',
  description: 'Unlock unprecedented growth with Next-Gen Platform for Insurance. This autonomous system provides loyalty optimization with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-platform-for-insurance-82473856',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Platform for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Next-Gen Platform for Insurance. This autonomous system provides loyalty optimization with zero manual intervention needed.
          </p>
