...
export const metadata: Metadata = {
  title: 'Intelligent AI - Insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent AI - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Intelligent AI - Insurance. Powered by cutting-edge AI, this platform delivers territory management like never before.
          </p>
