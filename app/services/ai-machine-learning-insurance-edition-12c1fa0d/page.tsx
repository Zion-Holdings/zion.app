...
export const metadata: Metadata = {
  title: 'AI Machine Learning - Insurance Edition',
  description: 'Transform insurance with AI Machine Learning - Insurance Edition - the intelligent automation platform that learns, adapts, and delivers 10x results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-machine-learning-insurance-edition-12c1fa0d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Machine Learning - Insurance Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform insurance with AI Machine Learning - Insurance Edition - the intelligent automation platform that learns, adapts, and delivers 10x results.
          </p>
