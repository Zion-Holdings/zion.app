...
export const metadata: Metadata = {
  title: 'Smart NLP Platform - Construction',
  description: 'Optimize your construction workflows with Smart NLP Platform - Construction. This intelligent platform delivers predictive analytics through advanced automation',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-nlp-platform-construction-de754377',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart NLP Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Smart NLP Platform - Construction. This intelligent platform delivers predictive analytics through advanced automation and AI.
          </p>
