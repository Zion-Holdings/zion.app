...
export const metadata: Metadata = {
  ...
  keywords: 'Custom wake-word training, Task execution, Multi-turn context, On-premise deployment, Twilio/Asterisk integration, ai, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Voice Assistant Pro</h1>
        <p className="text-lg text-slate-300 mb-8">Custom voice assistants for brands: wake-word detection, natural-language task execution, multi-turn dialog. Deploy on-premise or cloud.</p>
        ...
        <li class="text-slate-300">Custom wake-word training</li>
        <li class="text-slate-300">Task execution</li>
        <li class="text-slate-300">Multi-turn context</li>
        <li class="text-slate-300">On-premise deployment</li>
        <li class="text-slate-300">Twilio/Asterisk integration</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with voice assistant pro</li>
