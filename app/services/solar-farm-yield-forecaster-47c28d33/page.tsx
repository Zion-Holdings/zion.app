...
export const metadata: Metadata = {
  title: 'Solar Farm Yield Forecaster',
  description: 'Forecasts solar farm yield with weather models and panel-level telemetry.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/solar-farm-yield-forecaster-47c28d33',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Solar Farm Yield Forecaster
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Forecasts solar farm yield with weather models and panel-level telemetry.
          </p>
