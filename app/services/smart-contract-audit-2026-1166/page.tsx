...
export const metadata = {
  ...
  alternates: { canonical: '/services/smart-contract-audit-2026-1166/' },

  openGraph: {
    title: 'Smart Contract Audit | Zion Tech Group',
    description: 'End-to-end smart contract audit services: assessment, deployment, and managed operations.',
    url: 'https://ziontechgroup.com/services/smart-contract-audit-2026-1166/',
...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "Smart Contract Audit | Zion Tech Group", description: "End-to-end smart contract audit services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/smart-contract-audit-2026-1166/}} />
