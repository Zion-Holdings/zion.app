...
export const metadata: Metadata = {
  title: 'AI AI - Legal',
  description: 'Enhance your legal business with AI AI - Legal. Our solution provides root cause analysis with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-ai-legal-8975562d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with AI AI - Legal. Our solution provides root cause analysis with enterprise-grade reliability and security.
          </p>
