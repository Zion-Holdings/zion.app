...
export const metadata: Metadata = {
  title: 'AI Management - Cleantech Edition',
  description: 'Transform your cleantech operations with our AI Management - Cleantech Edition. This AI-driven solution automates maintenance scheduling with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-management---cleantech-edition-c12f2249',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Management - Cleantech Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your cleantech operations with our AI Management - Cleantech Edition. This AI-driven solution automates maintenance scheduling with unprecedented accuracy and efficiency.
          </p>
