      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Maps your control implementations to FedRAMP Rev 5 generates POA&M tracks continuous monitoring artifacts auto-generates audit evidence bundles readiness gap report.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ FedRAMP Rev 5 control mapping</li>
            <li className="text-purple-300">✓ POA&M auto-generation + monthly tracking</li>
            <li className="text-purple-300">✓ Continuous monitoring artifact creation</li>
            <li className="text-purple-300">✓ Audit evidence bundle per annual assessment</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai fedramp compliance assistant</li>
