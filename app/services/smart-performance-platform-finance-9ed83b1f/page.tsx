...
export const metadata: Metadata = {
  title: 'Smart Performance Platform - Finance',
  description: 'Transform your finance operations with our Smart Performance Platform - Finance. This AI-driven solution automates user provisioning with unprecedented accuracy',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-performance-platform-finance-9ed83b1f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Performance Platform - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Smart Performance Platform - Finance. This AI-driven solution automates user provisioning with unprecedented accuracy and efficiency.
          </p>
