...
export const metadata = {
  title: "AI-Powered Composable Travel Optimization Engine - Zion Tech Group",
  description: "AI-powered optimization engine that continuously improves composable travel performance through self-tuning algorithms.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-composable-travel-optimization-engine-74da7f9d`
  }
};
