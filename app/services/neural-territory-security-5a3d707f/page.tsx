...
export const metadata: Metadata = {
  title: 'Neural Territory Security',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Territory Security
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Neural Territory Security. Our solution provides sales process optimization with enterprise-grade reliability and security.
          </p>
