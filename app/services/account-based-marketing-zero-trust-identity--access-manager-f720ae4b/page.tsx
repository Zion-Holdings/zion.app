...
export const metadata: Metadata = {
  title: "Account-Based Marketing Zero-Trust Identity & Access Manager - AI-Powered Account-Based Marketing Solution",
  description: "AI-powered account-based marketing solution for enterprise security. Implements zero-trust security architecture with continuous authentication and adaptive acc",
  alternates: {
    canonical: "https://ziontechgroup.com/services/account-based-marketing-zero-trust-identity--access-manager-f720ae4b",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Account-Based Marketing Zero-Trust Identity & Access Manager - AI-Powered Account-Based Marketing Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          AI-powered account-based marketing solution for enterprise security. Implements zero-trust security architecture with continuous authentication and adaptive acc
        </p>
