...
export const metadata: Metadata = {
  title: 'Smart Optimization Platform - HEALTHTECH',
  description: 'Revolutionize healthtech through intelligent automation. Our Smart Optimization Platform - HEALTHTECH leverages advanced machine learning to deliver talent acqu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-optimization-platform-healthtech-c33805a8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Optimization Platform - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthtech through intelligent automation. Our Smart Optimization Platform - HEALTHTECH leverages advanced machine learning to deliver talent acquisition at scale.
          </p>
