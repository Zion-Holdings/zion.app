...
export const metadata: Metadata = {
  title: 'Enterprise Optimization - Construction',
  description: 'Next-generation construction solution: Enterprise Optimization - Construction. Combines customer journey mapping with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-optimization-construction-663ad61b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Optimization - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Enterprise Optimization - Construction. Combines customer journey mapping with adaptive intelligence for optimal results.
          </p>
