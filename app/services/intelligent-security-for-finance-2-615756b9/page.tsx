  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Revolutionize finance through intelligent automation. Our Intelligent Security for Finance #2 leverages advanced machine learning to deliver image recognition at scale.</p>
