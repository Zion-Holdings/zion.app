...
export const metadata: Metadata = {
  title: 'Automated Engine for Legal',
  description: 'Revolutionize legal through intelligent automation. Our Automated Engine for Legal leverages advanced machine learning to deliver workflow management at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-engine-for-legal-f5a76f79',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Engine for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Automated Engine for Legal leverages advanced machine learning to deliver workflow management at scale.
          </p>
