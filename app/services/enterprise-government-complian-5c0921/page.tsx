...
export const metadata: Metadata = {
  title: 'Enterprise Government Compliance Terraform (Finance)',
  description: 'Enterprise Government Compliance Terraform (Finance) is an AI-powered finance solution that transforms how businesses operate through intelligent automation and',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Government Compliance Terraform (Finance)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enterprise Government Compliance Terraform (Finance) is an AI-powered finance solution that transforms how businesses operate through intelligent automation and real-time analytics.
