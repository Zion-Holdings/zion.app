      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize blockchain through intelligent automation. Our AI-Powered Financial Analyzer leverages advanced machine learning to deliver performance monitoring at scale.
          </p>
