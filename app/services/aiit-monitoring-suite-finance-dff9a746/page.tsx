...
export const metadata: Metadata = {
  title: 'AI/IT Monitoring Suite - Finance',
  description: 'Next-generation finance solution: AI/IT Monitoring Suite - Finance. Combines manufacturing quality control with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-monitoring-suite-finance-dff9a746',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Monitoring Suite - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation finance solution: AI/IT Monitoring Suite - Finance. Combines manufacturing quality control with adaptive intelligence for optimal results.
          </p>
