...
export const metadata: Metadata = {
  title: 'Autonomous Engine System - Tech',
  description: 'Drive innovation in technology with Autonomous Engine System - Tech. This AI-powered platform transforms data governance into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-engine-system-tech-5180a38d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Engine System - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in technology with Autonomous Engine System - Tech. This AI-powered platform transforms data governance into a competitive advantage.
          </p>
