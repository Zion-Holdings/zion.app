...
export const metadata: Metadata = {
  title: 'Autonomous Risk for Manufacturing',
  description: 'Revolutionize manufacturing through intelligent automation. Our Autonomous Risk for Manufacturing leverages advanced machine learning to deliver code optimizati',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Risk for Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize manufacturing through intelligent automation. Our Autonomous Risk for Manufacturing leverages advanced machine learning to deliver code optimization at scale.
          </p>
