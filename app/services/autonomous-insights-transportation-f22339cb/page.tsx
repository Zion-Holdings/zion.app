...
export const metadata: Metadata = {
  title: 'Autonomous insights-transportation',
  description: 'Next-generation transportation solution: Autonomous insights-transportation. Combines supply chain with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-insights-transportation-f22339cb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous insights-transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation transportation solution: Autonomous insights-transportation. Combines supply chain with adaptive intelligence for optimal results.
          </p>
