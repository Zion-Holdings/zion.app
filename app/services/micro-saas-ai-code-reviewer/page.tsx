...
export const metadata: Metadata = {
  ...
  keywords: 'Automated code review, Security vulnerability detection, Performance suggestions, Style enforcement, Custom rules engine, CI/CD integration, ai, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Micro-SAAS AI Code Reviewer</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered code review that catches bugs, security vulnerabilities, and performance issues before merge. Supports 40+ languages.</p>
        ...
        <li class="text-slate-300">Automated code review</li>
        <li class="text-slate-300">Security vulnerability detection</li>
        <li class="text-slate-300">Performance suggestions</li>
        ...
        <li class="text-slate-300">Reduce review time by 80%</li>
        <li class="text-slate-300">Security-first approach</li>
      </ul>
        </div>
