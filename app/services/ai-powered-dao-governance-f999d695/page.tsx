      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Proposal analysis</li>
            <li className="text-purple-300">✓ Voting optimization</li>
            <li className="text-purple-300">✓ Governance insights</li>
            </ul>
          </div>
