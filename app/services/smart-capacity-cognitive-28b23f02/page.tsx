...
export const metadata: Metadata = {
  title: 'Smart Capacity Cognitive',
  description: 'Enhance your gaming business with Smart Capacity Cognitive. Our solution provides anomaly detection with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-capacity-cognitive-28b23f02',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Capacity Cognitive
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your gaming business with Smart Capacity Cognitive. Our solution provides anomaly detection with enterprise-grade reliability and security.
          </p>
