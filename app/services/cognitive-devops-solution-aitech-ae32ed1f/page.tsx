...
export const metadata: Metadata = {
  title: 'Cognitive DevOps Solution - AITECH',
  description: 'Transform your aitech operations with our Cognitive DevOps Solution - AITECH. This AI-driven solution automates process automation with unprecedented accuracy a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive DevOps Solution - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your aitech operations with our Cognitive DevOps Solution - AITECH. This AI-driven solution automates process automation with unprecedented accuracy and efficiency.
          </p>
