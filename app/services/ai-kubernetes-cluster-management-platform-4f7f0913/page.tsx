...
export const metadata: Metadata = {
  title: "AI Kubernetes Cluster Management Platform - AI-Powered AI Solution",
  description: "AI-powered ai solution for devops. Automated Kubernetes cluster provisioning, scaling, and management.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/ai-kubernetes-cluster-management-platform-4f7f0913",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI Kubernetes Cluster Management Platform - AI-Powered AI Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          AI-powered ai solution for devops. Automated Kubernetes cluster provisioning, scaling, and management.
        </p>
