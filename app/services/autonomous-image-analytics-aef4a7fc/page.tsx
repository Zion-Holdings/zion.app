...
export const metadata: Metadata = {
  ...
  keywords: 'Open-source friendly, GDPR compliance, Audit trails, Mobile-responsive interface, Cloud-native architecture, Data encryption, coordinator, transportation, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Autonomous Image Analytics</h1>
        <p className="text-lg text-slate-300 mb-8">The future of transportation is here with Autonomous Image Analytics. Powered by cutting-edge AI, this platform delivers compliance monitoring like never before.</p>
