...
export const metadata: Metadata = {
  title: 'Enterprise Enterprise Platform - Real-Estate',
  description: 'Revolutionize real-estate through intelligent automation. Our Enterprise Enterprise Platform - Real-Estate leverages advanced machine learning to deliver featur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-enterprise-platform-real-estate-a254fcc6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Enterprise Platform - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our Enterprise Enterprise Platform - Real-Estate leverages advanced machine learning to deliver feature engineering at scale.
          </p>
