...
export const metadata: Metadata = {
  title: 'Intelligence Smart - Edge',
  description: 'Revolutionize edge through intelligent automation. Our Intelligence Smart - Edge leverages advanced machine learning to deliver logistics route optimization at ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligence-smart---edge-023110a6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligence Smart - Edge
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize edge through intelligent automation. Our Intelligence Smart - Edge leverages advanced machine learning to deliver logistics route optimization at scale.
          </p>
