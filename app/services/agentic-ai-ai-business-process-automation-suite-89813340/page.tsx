...
export const metadata: Metadata = {
  title: "Agentic AI AI Business Process Automation Suite - AI-Powered Agentic AI Solution",
  description: "AI-powered agentic ai solution for business process. Discovers, automates, and optimizes business processes using AI-powered process mining.",
  alternates: {
    canonical: "https://ziontechgroup.com/services/agentic-ai-ai-business-process-automation-suite-89813340",
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Agentic AI AI Business Process Automation Suite - AI-Powered Agentic AI Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          AI-powered agentic ai solution for business process. Discovers, automates, and optimizes business processes using AI-powered process mining.
        </p>
