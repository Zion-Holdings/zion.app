...
export const metadata: Metadata = {
  title: 'Autonomous Process System - AITECH',
  description: 'Optimize your aitech workflows with Autonomous Process System - AITECH. This intelligent platform delivers quota optimization through advanced automation and AI',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-process-system-aitech-36cd9cc3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Process System - AITECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your aitech workflows with Autonomous Process System - AITECH. This intelligent platform delivers quota optimization through advanced automation and AI.
          </p>
