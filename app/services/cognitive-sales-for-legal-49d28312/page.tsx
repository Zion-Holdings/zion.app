...
export const metadata: Metadata = {
  title: 'Cognitive Sales for Legal',
  description: 'The future of legal is here with Cognitive Sales for Legal. Powered by cutting-edge AI, this platform delivers process automation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-sales-for-legal-49d28312',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Sales for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Cognitive Sales for Legal. Powered by cutting-edge AI, this platform delivers process automation like never before.
          </p>
