...
export const metadata: Metadata = {
  title: 'Autonomous Director for Insurance',
  description: 'The future of insurance is here with Autonomous Director for Insurance. Powered by cutting-edge AI, this platform delivers threat detection like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-director-for-insurance-83253e9d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Director for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Autonomous Director for Insurance. Powered by cutting-edge AI, this platform delivers threat detection like never before.
          </p>
