...
export const metadata: Metadata = {
  ...
  keywords: 'APT29 and MITRE ATT&CK emulation, Ransomware attack simulation, Purple team collaborative workspace, Executive risk scoring report, Detection and response metrics, security, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Security Breach &amp; Attack Simulation Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Automated adversary emulation: APT29, ransomware, insider-threat vectors. Subject your defences to realistic attack chains and measure D&amp;R effectiveness against MITRE ATT&amp;CK.</p>
        ...
        <li class="text-slate-300">APT29 and MITRE ATT&amp;CK emulation</li>
        <li class="text-slate-300">Ransomware attack simulation</li>
        <li class="text-slate-300">Purple team collaborative workspace</li>
        <li class="text-slate-300">Executive risk scoring report</li>
        <li class="text-slate-300">Detection and response metrics</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with security breach &amp; attack simulation platform</li>
