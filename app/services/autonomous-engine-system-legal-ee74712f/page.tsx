export const metadata = {
  ...
  description: "Zion Tech Group delivers Autonomous Engine System - Legal with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/services/autonomous-engine-system-legal-ee74712f/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>Autonomous Engine System - Legal</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers Autonomous Engine System - Legal with measurable outcomes.
      </p>
