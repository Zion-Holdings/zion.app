...
export const metadata: Metadata = {
  title: 'Intelligent Workflow for Startup',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Workflow for Startup
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform startup with Intelligent Workflow for Startup - the intelligent automation platform that learns, adapts, and delivers 10x results.
          </p>
