...
export const metadata: Metadata = {
  title: 'Smart Quality Platform - Energy',
  description: 'Next-generation energy solution: Smart Quality Platform - Energy. Combines recommendation system with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-quality-platform-energy-4f09a2b2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Quality Platform - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation energy solution: Smart Quality Platform - Energy. Combines recommendation system with adaptive intelligence for optimal results.
          </p>
