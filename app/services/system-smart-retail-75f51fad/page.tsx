...
export const metadata: Metadata = {
  title: 'System Smart - Retail',
  description: 'Revolutionize retail through intelligent automation. Our System Smart - Retail leverages advanced machine learning to deliver enterprise-grade insights at scale',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/system-smart-retail-75f51fad',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize retail through intelligent automation. Our System Smart - Retail leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
