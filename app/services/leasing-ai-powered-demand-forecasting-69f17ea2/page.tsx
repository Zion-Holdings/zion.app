...
export const metadata: Metadata = {
  title: 'Leasing AI-Powered Demand Forecasting',
  description: 'AI-powered leasing solution for retail. Uses time-series analysis to predict product demand with high accuracy.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/leasing-ai-powered-demand-forecasting-69f17ea2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Leasing AI-Powered Demand Forecasting
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered leasing solution for retail. Uses time-series analysis to predict product demand with high accuracy.
          </p>
