...
export const metadata: Metadata = {
  title: 'Autonomous SMB System - CLEANTECH',
  description: 'Revolutionize cleantech through intelligent automation. Our Autonomous SMB System - CLEANTECH leverages advanced machine learning to deliver performance monitor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-smb-system-cleantech-7f81b486',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous SMB System - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cleantech through intelligent automation. Our Autonomous SMB System - CLEANTECH leverages advanced machine learning to deliver performance monitoring at scale.
          </p>
