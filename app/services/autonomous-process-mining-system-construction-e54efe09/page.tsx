...
export const metadata: Metadata = {
  title: 'Autonomous Process Mining System - Construction',
  description: 'Optimize your construction workflows with Autonomous Process Mining System - Construction. This intelligent platform delivers resource allocation through advanc',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-process-mining-system-construction-e54efe09',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Process Mining System - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Autonomous Process Mining System - Construction. This intelligent platform delivers resource allocation through advanced automation and AI.
          </p>
