...
export const metadata: Metadata = {
  title: 'Smart Analyzer for Sports',
  description: 'Revolutionize sports through intelligent automation. Our Smart Analyzer for Sports leverages advanced machine learning to deliver healthcare data analytics at s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Analyzer for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Smart Analyzer for Sports leverages advanced machine learning to deliver healthcare data analytics at scale.
          </p>
