...
export const metadata: Metadata = {
  title: 'Self-Optimizing intelligent-finance',
  description: 'Optimize your finance workflows with Self-Optimizing intelligent-finance. This intelligent platform delivers vendor management through advanced automation and A',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing intelligent-finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your finance workflows with Self-Optimizing intelligent-finance. This intelligent platform delivers vendor management through advanced automation and AI.
          </p>
