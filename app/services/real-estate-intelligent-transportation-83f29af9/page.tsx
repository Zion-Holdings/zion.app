...
export const metadata: Metadata = {
  title: 'Real Estate Intelligent - Transportation',
  description: 'Drive innovation in transportation with Real Estate Intelligent - Transportation. This AI-powered platform transforms financial planning into a competitive adva',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/real-estate-intelligent-transportation-83f29af9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Real Estate Intelligent - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in transportation with Real Estate Intelligent - Transportation. This AI-powered platform transforms financial planning into a competitive advantage.
          </p>
