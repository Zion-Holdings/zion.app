...
export const metadata: Metadata = {
  title: 'Intelligent Experience for Logistics #1',
  description: 'Unlock unprecedented growth with Intelligent Experience for Logistics #1. This autonomous system provides sales process optimization with zero manual interventi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Experience for Logistics #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Experience for Logistics #1. This autonomous system provides sales process optimization with zero manual intervention needed.
          </p>
