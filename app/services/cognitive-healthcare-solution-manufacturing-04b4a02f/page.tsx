...
export const metadata: Metadata = {
  title: 'Cognitive Healthcare Solution - Manufacturing',
  description: 'Drive innovation in manufacturing with Cognitive Healthcare Solution - Manufacturing. This AI-powered platform transforms document processing into a competitive',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-healthcare-solution-manufacturing-04b4a02f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Healthcare Solution - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in manufacturing with Cognitive Healthcare Solution - Manufacturing. This AI-powered platform transforms document processing into a competitive advantage.
          </p>
