...
export const metadata: Metadata = {
  title: 'Intelligent Suite for Telecom',
  description: 'Drive innovation in telecom with Intelligent Suite for Telecom. This AI-powered platform transforms fraud prevention into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-suite-for-telecom-28d1cf19',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Suite for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in telecom with Intelligent Suite for Telecom. This AI-powered platform transforms fraud prevention into a competitive advantage.
          </p>
