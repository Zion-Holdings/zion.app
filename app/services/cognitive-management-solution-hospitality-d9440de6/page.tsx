...
export const metadata: Metadata = {
  title: 'Cognitive Management Solution - Hospitality',
  description: 'Enhance your hospitality business with Cognitive Management Solution - Hospitality. Our solution provides anomaly detection with enterprise-grade reliability an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-management-solution-hospitality-d9440de6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Management Solution - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Cognitive Management Solution - Hospitality. Our solution provides anomaly detection with enterprise-grade reliability and security.
          </p>
