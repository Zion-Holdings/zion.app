...
export const metadata: Metadata = {
  title: 'Autonomous Business Intelligence for Retail',
  description: 'Transform your retail operations with our Autonomous Business Intelligence for Retail. This AI-driven solution automates data quality with unprecedented accurac',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Business Intelligence for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our Autonomous Business Intelligence for Retail. This AI-driven solution automates data quality with unprecedented accuracy and efficiency.
          </p>
