...
export const metadata: Metadata = {
  ...
  keywords: 'CDN architecture and provider selection, Caching strategy and TTL optimization, Origin shielding and failover, Image optimization (WebP, AVIF, resize), Real-time purge and invalidation, Video streaming optimization (HLS/DASH), Cloudflare, Fastly, Akamai, AWS CloudFront support, cloud, Infrastructure, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">CDN &amp; Edge Optimization Service</h1>
        <p className="text-lg text-slate-300 mb-8">CDN architecture, caching strategy, origin shielding, image optimization, and real-time purge. Sub-100ms global TTFN with 300+ PoPs.</p>
        ...
        <li class="text-slate-300">CDN architecture and provider selection</li>
        <li class="text-slate-300">Caching strategy and TTL optimization</li>
        <li class="text-slate-300">Origin shielding and failover</li>
        <li class="text-slate-300">Image optimization (WebP, AVIF, resize)</li>
        <li class="text-slate-300">Real-time purge and invalidation</li>
        <li class="text-slate-300">Video streaming optimization (HLS/DASH)</li>
        <li class="text-slate-300">Cloudflare, Fastly, Akamai, AWS CloudFront support</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Sub-100ms global load times</li>
        <li class="text-slate-300">Image optimization reduces bandwidth 50%</li>
        <li class="text-slate-300">Origin shielding reduces origin load</li>
        <li class="text-slate-300">CDN expertise without hiring</li>
      </ul>
        </div>
