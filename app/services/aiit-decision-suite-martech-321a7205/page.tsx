...
export const metadata: Metadata = {
  title: 'AI/IT Decision Suite - MARTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Decision Suite - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of martech is here with AI/IT Decision Suite - MARTECH. Powered by cutting-edge AI, this platform delivers compliance automation like never before.
          </p>
