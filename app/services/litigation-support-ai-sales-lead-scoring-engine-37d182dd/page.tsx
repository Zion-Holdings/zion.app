...
export const metadata: Metadata = {
  title: 'Litigation Support AI Sales Lead Scoring Engine',
  description: 'litigation support solution for public safety industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/litigation-support-ai-sales-lead-scoring-engine-37d182dd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Litigation Support AI Sales Lead Scoring Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            litigation support solution for public safety industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.
          </p>
