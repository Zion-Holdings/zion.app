...
export const metadata: Metadata = {
  ...
  keywords: 'Architecture and design pattern review, Security vulnerability detection, Performance anti-pattern identification, Code style and convention enforcement, Test coverage analysis and suggestions, Context-aware comments on specific lines, GitHub, GitLab, Bitbucket integration, ai, Software Development, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Code Review Agent</h1>
        <p className="text-lg text-slate-300 mb-8">Autonomous code review agent that reviews every PR: correctness, security, performance, style, and architecture. Provides actionable comments with fix suggestions.</p>
        ...
        <li class="text-slate-300">Architecture and design pattern review</li>
        ...
        <li class="text-slate-300">Code style and convention enforcement</li>
        <li class="text-slate-300">Test coverage analysis and suggestions</li>
        <li class="text-slate-300">Context-aware comments on specific lines</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Every PR reviewed by AI, no PR unreviewed</li>
        <li class="text-slate-300">Security issues caught before merge</li>
        <li class="text-slate-300">Architecture feedback improves codebase quality</li>
        <li class="text-slate-300">Context-aware comments, not generic lint</li>
      </ul>
        </div>
