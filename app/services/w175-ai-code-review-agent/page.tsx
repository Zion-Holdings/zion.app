...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={'@context': 'https://schema.org', '@type': 'Service', 'name': 'AI Code Review Agent', 'description': 'Autonomous code review agent that reviews every PR: correctness, security, performance, style, and architecture. Provides actionable comments with fix suggestions.', 'serviceType': 'ai', 'provider': {'@type': 'Organization', 'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'contactPoint': {'@type': 'ContactPoint', 'email': 'kleber@ziontechgroup.com', 'telephone': '+1 302 464 0950', 'contactType': 'sales'}}, 'serviceArea': {'@type': 'Place', 'name': 'Software Development'}, 'hasOfferCatalog': {'@type': 'OfferCatalog', 'name': 'AI Code Review Agent Pricing Plans', 'itemListElement': [{'@type': 'Offer', 'name': 'Basic', 'price': '$49/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Pro', 'price': '$149/mo', 'priceCurrency': 'USD'}, {'@type': 'Offer', 'name': 'Enterprise', 'price': '$499/mo', 'priceCurrency': 'USD'}]}} />
    <JsonLd data={'@context': 'https://schema.org', '@type': 'FAQPage', 'mainEntity': [{'@type': 'Question', 'name': 'Architecture and design pattern review', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Architecture and design pattern review'}}, {'@type': 'Question', 'name': 'Security vulnerability detection', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Security vulnerability detection'}}, {'@type': 'Question', 'name': 'Performance anti-pattern identification', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Performance anti-pattern identification'}}, {'@type': 'Question', 'name': 'What business impact can I expect?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Every PR reviewed by AI, no PR unreviewed; Security issues caught before merge; Architecture feedback improves codebase quality'}}, {'@type': 'Question', 'name': 'How do I get started with this service?', 'acceptedAnswer': {'@type': 'Answer', 'text': 'Contact our team at hello@ziontechgroup.com or book a free consultation at https://calendly.com/kleber-ziontechgroup/consultation to get started.'}}]} />
