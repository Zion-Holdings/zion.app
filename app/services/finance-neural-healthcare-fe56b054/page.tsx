...
export const metadata: Metadata = {
  title: 'Finance Neural - Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our Finance Neural - Healthcare leverages advanced machine learning to deliver hr analytics at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/finance-neural-healthcare-fe56b054',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Finance Neural - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Finance Neural - Healthcare leverages advanced machine learning to deliver hr analytics at scale.
          </p>
