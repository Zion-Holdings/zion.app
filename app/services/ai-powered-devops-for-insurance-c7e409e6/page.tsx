...
export const metadata: Metadata = {
  title: 'AI-Powered DevOps for Insurance',
  description: 'Transform your insurance operations with our AI-Powered DevOps for Insurance. This AI-driven solution automates quality control with unprecedented accuracy and ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-devops-for-insurance-c7e409e6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered DevOps for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our AI-Powered DevOps for Insurance. This AI-driven solution automates quality control with unprecedented accuracy and efficiency.
          </p>
