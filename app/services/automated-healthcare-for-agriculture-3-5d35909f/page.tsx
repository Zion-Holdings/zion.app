...
export const metadata: Metadata = {
  title: 'Automated Healthcare for Agriculture #3',
  description: 'The future of agriculture is here with Automated Healthcare for Agriculture #3. Powered by cutting-edge AI, this platform delivers document processing like neve',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-healthcare-for-agriculture-3-5d35909f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Healthcare for Agriculture #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Automated Healthcare for Agriculture #3. Powered by cutting-edge AI, this platform delivers document processing like never before.
          </p>
