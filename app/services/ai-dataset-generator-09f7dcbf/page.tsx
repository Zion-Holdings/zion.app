...
export const metadata: Metadata = {
  ...
  description: 'Generate synthetic training datasets for ML models with realistic distributions.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-dataset-generator-09f7dcbf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Generate synthetic training datasets for ML models with realistic distributions.
          </p>
