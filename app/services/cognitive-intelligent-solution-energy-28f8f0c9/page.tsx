...
export const metadata: Metadata = {
  title: 'Cognitive Intelligent Solution - Energy',
  description: 'Transform your energy operations with our Cognitive Intelligent Solution - Energy. This AI-driven solution automates invoice processing with unprecedented accur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-intelligent-solution-energy-28f8f0c9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Intelligent Solution - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Cognitive Intelligent Solution - Energy. This AI-driven solution automates invoice processing with unprecedented accuracy and efficiency.
          </p>
