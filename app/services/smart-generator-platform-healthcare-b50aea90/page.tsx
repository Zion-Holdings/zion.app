...
export const metadata: Metadata = {
  title: 'Smart Generator Platform - Healthcare',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Generator Platform - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Smart Generator Platform - Healthcare. Combines training optimization with adaptive intelligence for optimal results.
          </p>
