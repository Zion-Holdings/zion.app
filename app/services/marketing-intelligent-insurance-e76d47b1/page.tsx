...
export const metadata: Metadata = {
  title: 'Marketing Intelligent - Insurance',
  description: 'Unlock unprecedented growth with Marketing Intelligent - Insurance. This autonomous system provides invoice processing with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/marketing-intelligent-insurance-e76d47b1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Marketing Intelligent - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Marketing Intelligent - Insurance. This autonomous system provides invoice processing with zero manual intervention needed.
          </p>
