...
export const metadata: Metadata = {
  title: 'Cognitive Intelligent Solution - Education',
  description: 'The future of education is here with Cognitive Intelligent Solution - Education. Powered by cutting-edge AI, this platform delivers project portfolio like never',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-intelligent-solution-education-803e1aab',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Intelligent Solution - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of education is here with Cognitive Intelligent Solution - Education. Powered by cutting-edge AI, this platform delivers project portfolio like never before.
          </p>
