...
export const metadata: Metadata = {
  title: 'Smart Feature Cloud',
  description: 'The future of logistics is here with Smart Feature Cloud. Powered by cutting-edge AI, this platform delivers transformative results like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-feature-cloud-4cd43b4a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Smart Feature Cloud. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
