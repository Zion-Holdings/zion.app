...
export const metadata = {
  ...
  description: 'End-to-end data mesh implementation: domain-owned data products with self-serve infrastructure services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/data-mesh-implementation-domain-owned-data-products-self-serve-infrastructure-39/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">Data Mesh Implementation: Domain-Owned Data Products with Self-Serve Infrastructure</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end data mesh implementation: domain-owned data products with self-serve infrastructure services: assessment, deployment, and managed operations.
        </p>
