...
export const metadata: Metadata = {
  ...
  description: 'Quantum leap forward for media: Cognitive Manager Solution - Media. Uses quantum-inspired algorithms to deliver revenue intelligence at exponential speed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-manager-solution-media-31f951ac',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for media: Cognitive Manager Solution - Media. Uses quantum-inspired algorithms to deliver revenue intelligence at exponential speed.
          </p>
