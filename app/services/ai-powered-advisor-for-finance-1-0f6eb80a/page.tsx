...
export const metadata = {
  ...
  description: "Transform your Finance operations with our AI-Powered Advisor for Finance #1. This AI-driven solution automates compliance monitoring with unprecedented accurac",
  alternates: {
