...
export const metadata: Metadata = {
  title: 'Planetary Data Lake Formatter',
  description: 'Normalizes planetary science datasets into searchable data lakes with metadata genealogy.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/planetary-data-lake-formatter-ec0a1ca4',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Planetary Data Lake Formatter
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Normalizes planetary science datasets into searchable data lakes with metadata genealogy.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your space science operations?</p>
