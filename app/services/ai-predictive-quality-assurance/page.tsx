...
export const metadata: Metadata = {
  ...
  keywords: 'Sensor data anomaly detection, Defect prediction models, Root cause analysis, Integration with Siemens MindSphere, AWS IoT, Real-time quality dashboards, Custom ML model training, Batch quality forecasting, Alerting and escalation workflows, ai, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Predictive Quality Assurance</h1>
        <p className="text-lg text-slate-300 mb-8">Predict manufacturing defects before they happen using sensor data and ML models. Integrate with IoT platforms and MES for real-time quality control.</p>
        ...
        <li class="text-slate-300">Sensor data anomaly detection</li>
        <li class="text-slate-300">Defect prediction models</li>
        <li class="text-slate-300">Root cause analysis</li>
        <li class="text-slate-300">Integration with Siemens MindSphere, AWS IoT</li>
        <li class="text-slate-300">Real-time quality dashboards</li>
        <li class="text-slate-300">Custom ML model training</li>
        <li class="text-slate-300">Batch quality forecasting</li>
        <li class="text-slate-300">Alerting and escalation workflows</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce defect rates by 40%</li>
        <li class="text-slate-300">Minimize scrap and rework</li>
        <li class="text-slate-300">Ensure consistent product quality</li>
