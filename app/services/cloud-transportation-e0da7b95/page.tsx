...
export const metadata: Metadata = {
  title: 'Transportation Cloud Platform #36',
  description: 'AI-powered transportation solution for cloud. Provides enterprise-grade automation and optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cloud-transportation-e0da7b95',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Transportation Cloud Platform #36
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered transportation solution for cloud. Provides enterprise-grade automation and optimization.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Multi-cloud deployment</li>
          <li className="text-gray-300">Auto-scaling infrastructure</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">50% infrastructure savings</li>
          <li className="text-purple-300">99.9% uptime</li>
          <li className="text-purple-300">Global scalability</li>
          </ul>
        </section>
