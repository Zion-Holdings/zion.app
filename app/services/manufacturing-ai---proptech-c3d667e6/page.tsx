...
export const metadata: Metadata = {
  title: 'Manufacturing AI - Proptech',
  description: 'Unlock unprecedented growth with Manufacturing AI - Proptech. This autonomous system provides financial planning with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/manufacturing-ai---proptech-c3d667e6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manufacturing AI - Proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Manufacturing AI - Proptech. This autonomous system provides financial planning with zero manual intervention needed.
          </p>
