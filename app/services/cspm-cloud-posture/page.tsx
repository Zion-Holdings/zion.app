...
export const metadata: Metadata = {
  ...
  keywords: 'Multi-cloud IAM + resource posture scanner, Misconfiguration auto-remediation (Terraform), Drift detection from desired baseline, Compliance report (SOC 2/ISO 27001/PCI DSS), Risk scoring per resource + alert on threshold, cloud, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Continuous cloud posture: IAM overprivilege, misconfigured S3, exposed RDS, public subnets. Drift detection + auto-remediation via Terraform per AWS/GCP/Azure.</p>
        ...
        <li class="text-slate-300">Multi-cloud IAM + resource posture scanner</li>
        <li class="text-slate-300">Misconfiguration auto-remediation (Terraform)</li>
        <li class="text-slate-300">Drift detection from desired baseline</li>
        <li class="text-slate-300">Compliance report (SOC 2/ISO 27001/PCI DSS)</li>
        <li class="text-slate-300">Risk scoring per resource + alert on threshold</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with cloud security posture management (cspm)</li>
