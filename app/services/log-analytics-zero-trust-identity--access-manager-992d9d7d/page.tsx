...
export const metadata: Metadata = {
  title: 'Log Analytics Zero-Trust Identity & Access Manager',
  description: 'AI-powered log analytics solution for enterprise security. Implements zero-trust security architecture with continuous authentication and adaptive access contro',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/log-analytics-zero-trust-identity--access-manager-992d9d7d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Log Analytics Zero-Trust Identity & Access Manager
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered log analytics solution for enterprise security. Implements zero-trust security architecture with continuous authentication and adaptive access controls.
          </p>
