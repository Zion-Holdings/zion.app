...
export const metadata: Metadata = {
  title: 'Autonomous Engine System - Agriculture',
  description: 'Unlock unprecedented growth with Autonomous Engine System - Agriculture. This autonomous system provides api management with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-engine-system-agriculture-cc6ebc54',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Engine System - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Autonomous Engine System - Agriculture. This autonomous system provides api management with zero manual intervention needed.
          </p>
