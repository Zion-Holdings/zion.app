...
export const metadata: Metadata = {
  title: 'Cognitive Procurement Analytics',
  description: 'Drive innovation in logistics with Cognitive Procurement Analytics. This AI-powered platform transforms expense management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-procurement-analytics-0f30711d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Procurement Analytics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with Cognitive Procurement Analytics. This AI-powered platform transforms expense management into a competitive advantage.
          </p>
