...
export const metadata: Metadata = {
  title: 'Autonomous devops-agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Autonomous devops-agriculture leverages advanced machine learning to deliver disaster recovery at ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-devops-agriculture-5987f840',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous devops-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Autonomous devops-agriculture leverages advanced machine learning to deliver disaster recovery at scale.
          </p>
