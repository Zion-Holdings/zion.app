...
export const metadata: Metadata = {
  title: 'Smart Sourcing Business Intelligence',
  description: 'Revolutionize insurance through intelligent automation. Our Smart Sourcing Business Intelligence leverages advanced machine learning to deliver capacity managem',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Sourcing Business Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Smart Sourcing Business Intelligence leverages advanced machine learning to deliver capacity management at scale.
          </p>
