...
export const metadata: Metadata = {
  title: 'AI-Powered Manufacturing Risk Management',
  description: 'Manages manufacturing risks with predictive analytics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-manufacturing-risk-management2026-07-28t0347441707170000168-6bfcbb8b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Manufacturing Risk Management
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Manages manufacturing risks with predictive analytics.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Mitigation</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">50% risk reduction</li>
