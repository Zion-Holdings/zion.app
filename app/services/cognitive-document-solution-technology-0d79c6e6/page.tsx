...
export const metadata: Metadata = {
  title: 'Cognitive Document Solution - TECHNOLOGY',
  description: 'Drive innovation in technology with Cognitive Document Solution - TECHNOLOGY. This AI-powered platform transforms sustainability tracking into a competitive adv',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-document-solution-technology-0d79c6e6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Document Solution - TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in technology with Cognitive Document Solution - TECHNOLOGY. This AI-powered platform transforms sustainability tracking into a competitive advantage.
          </p>
