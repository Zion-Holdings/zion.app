...
export const metadata: Metadata = {
  title: 'Data Cognitive - Healthcare',
  description: 'Transform your healthcare operations with our Data Cognitive - Healthcare. This AI-driven solution automates customer journey mapping with unprecedented accurac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-cognitive-healthcare-3a0ba44e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Data Cognitive - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthcare operations with our Data Cognitive - Healthcare. This AI-driven solution automates customer journey mapping with unprecedented accuracy and efficiency.
          </p>
