...
export const metadata: Metadata = {
  title: 'Intelligent Marketing for Energy',
  description: 'Revolutionize energy through intelligent automation. Our Intelligent Marketing for Energy leverages advanced machine learning to deliver security monitoring at ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-marketing-for-energy-85b61bca',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Marketing for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Intelligent Marketing for Energy leverages advanced machine learning to deliver security monitoring at scale.
          </p>
