...
export const metadata: Metadata = {
  title: 'Smart Performance Platform - Energy #1',
  description: 'Enhance your energy business with Smart Performance Platform - Energy #1. Our solution provides customer onboarding with enterprise-grade reliability and securi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-performance-platform-energy-1-86a4c0d5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Performance Platform - Energy #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your energy business with Smart Performance Platform - Energy #1. Our solution provides customer onboarding with enterprise-grade reliability and security.
          </p>
