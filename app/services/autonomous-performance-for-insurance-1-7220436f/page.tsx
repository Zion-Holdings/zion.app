...
export const metadata: Metadata = {
  title: 'Autonomous Performance for Insurance #1',
  description: 'The future of insurance is here with Autonomous Performance for Insurance #1. Powered by cutting-edge AI, this platform delivers decision support like never bef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-performance-for-insurance-1-7220436f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Performance for Insurance #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Autonomous Performance for Insurance #1. Powered by cutting-edge AI, this platform delivers decision support like never before.
          </p>
