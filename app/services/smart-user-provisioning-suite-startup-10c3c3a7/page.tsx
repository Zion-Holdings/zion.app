...
export const metadata: Metadata = {
  title: 'Smart User Provisioning Suite - Startup',
  description: 'Transform your startup operations with our Smart User Provisioning Suite - Startup. This AI-driven solution automates healthcare data analytics with unprecedent',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-user-provisioning-suite-startup-10c3c3a7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart User Provisioning Suite - Startup
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your startup operations with our Smart User Provisioning Suite - Startup. This AI-driven solution automates healthcare data analytics with unprecedented accuracy and efficiency.
          </p>
