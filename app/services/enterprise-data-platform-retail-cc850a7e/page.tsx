...
export const metadata: Metadata = {
  title: 'Enterprise Data Platform - Retail',
  description: 'Enhance your retail business with Enterprise Data Platform - Retail. Our solution provides user provisioning with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-data-platform-retail-cc850a7e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Data Platform - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your retail business with Enterprise Data Platform - Retail. Our solution provides user provisioning with enterprise-grade reliability and security.
          </p>
