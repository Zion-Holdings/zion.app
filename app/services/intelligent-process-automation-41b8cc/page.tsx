...
export const metadata: Metadata = {
  title: 'Intelligent Process Automation Kafka (Education)',
  description: 'Intelligent Process Automation Kafka (Education) is an AI-powered education solution that transforms how businesses operate through intelligent automation and r',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-process-automation-41b8cc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Process Automation Kafka (Education)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Intelligent Process Automation Kafka (Education) is an AI-powered education solution that transforms how businesses operate through intelligent automation and real-time analytics.
...
Docker, Python, Kafka, Machine Learning, React, Kubernetes
