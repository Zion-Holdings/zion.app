...
export const metadata: Metadata = {
  title: 'AI-Powered Sales for Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our AI-Powered Sales for Healthcare leverages advanced machine learning to deliver sales process optimi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-sales-for-healthcare-34820b72',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Sales for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our AI-Powered Sales for Healthcare leverages advanced machine learning to deliver sales process optimization at scale.
          </p>
