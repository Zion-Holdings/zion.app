...
export const metadata: Metadata = {
  title: 'Azure AI-Powered Network Monitoring',
  description: 'AI-powered azure solution for it operations. Real-time network monitoring with anomaly detection and automated alerts.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/azure-ai-powered-network-monitoring-4b9a04b4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Azure AI-Powered Network Monitoring
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered azure solution for it operations. Real-time network monitoring with anomaly detection and automated alerts.
          </p>
