...
export const metadata: Metadata = {
  title: 'Smart Employee Platform - CLEANTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Employee Platform - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of cleantech is here with Smart Employee Platform - CLEANTECH. Powered by cutting-edge AI, this platform delivers performance tuning like never before.
          </p>
