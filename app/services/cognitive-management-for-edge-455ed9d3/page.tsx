...
export const metadata: Metadata = {
  title: 'Cognitive Management for Edge',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Management for Edge
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation edge solution: Cognitive Management for Edge. Combines customer service automation with adaptive intelligence for optimal results.
          </p>
