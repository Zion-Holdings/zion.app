...
export const metadata: Metadata = {
  title: 'Cognitive Support for Construction',
  description: 'Unlock unprecedented growth with Cognitive Support for Construction. This autonomous system provides market intelligence with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-support-for-construction-6f0c1647',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Support for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Cognitive Support for Construction. This autonomous system provides market intelligence with zero manual intervention needed.
          </p>
