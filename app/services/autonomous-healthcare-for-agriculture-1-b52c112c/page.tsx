...
export const metadata: Metadata = {
  title: 'Autonomous Healthcare for Agriculture #1',
  description: 'Next-generation agriculture solution: Autonomous Healthcare for Agriculture #1. Combines resource optimization with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-healthcare-for-agriculture-1-b52c112c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Healthcare for Agriculture #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation agriculture solution: Autonomous Healthcare for Agriculture #1. Combines resource optimization with adaptive intelligence for optimal results.
          </p>
