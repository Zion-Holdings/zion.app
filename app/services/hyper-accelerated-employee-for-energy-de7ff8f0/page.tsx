...
export const metadata: Metadata = {
  title: 'Hyper-Accelerated Employee for Energy',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Hyper-Accelerated Employee for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Hyper-Accelerated Employee for Energy. This AI-driven solution automates access management with unprecedented accuracy and efficiency.
          </p>
