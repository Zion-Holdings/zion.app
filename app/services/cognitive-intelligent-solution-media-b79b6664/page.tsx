...
export const metadata: Metadata = {
  title: 'Cognitive Intelligent Solution - Media',
  description: 'Next-generation media solution: Cognitive Intelligent Solution - Media. Combines business intelligence with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-intelligent-solution-media-b79b6664',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Intelligent Solution - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation media solution: Cognitive Intelligent Solution - Media. Combines business intelligence with adaptive intelligence for optimal results.
          </p>
