...
export const metadata: Metadata = {
  title: 'Brain-Computer Interface Logger',
  description: 'Secure logging and analytics platform for BCI research and clinical data.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/brain-computer-interface-logger-24cb8ee2',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Brain-Computer Interface Logger
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Secure logging and analytics platform for BCI research and clinical data.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$13999</p>
          <ul className="space-y-2 mb-4">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$44999</p>
          <ul className="space-y-2 mb-4">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your neurotech operations?</p>
