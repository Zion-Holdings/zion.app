...
export const metadata: Metadata = {
  title: 'Automated Cloud for Sports',
  description: 'The future of sports is here with Automated Cloud for Sports. Powered by cutting-edge AI, this platform delivers quality control like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-cloud-for-sports-3e66d0bf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Cloud for Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of sports is here with Automated Cloud for Sports. Powered by cutting-edge AI, this platform delivers quality control like never before.
          </p>
