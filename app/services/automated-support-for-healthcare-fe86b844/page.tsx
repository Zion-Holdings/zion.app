...
export const metadata: Metadata = {
  title: 'Automated Support for Healthcare',
  description: 'The future of healthcare is here with Automated Support for Healthcare. Powered by cutting-edge AI, this platform delivers transformative results like never bef',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Support for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of healthcare is here with Automated Support for Healthcare. Powered by cutting-edge AI, this platform delivers transformative results like never before.
          </p>
