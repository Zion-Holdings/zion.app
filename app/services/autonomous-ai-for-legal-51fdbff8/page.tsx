...
export const metadata: Metadata = {
  title: 'Autonomous AI for Legal',
  description: 'Unlock unprecedented growth with Autonomous AI for Legal. This autonomous system provides data processing with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-ai-for-legal-51fdbff8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous AI for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Autonomous AI for Legal. This autonomous system provides data processing with zero manual intervention needed.
          </p>
