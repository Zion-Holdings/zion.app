...
export const metadata: Metadata = {
  title: 'Predictive Healthcare for Logistics',
  description: 'The future of logistics is here with Predictive Healthcare for Logistics. Powered by cutting-edge AI, this platform delivers fraud prevention like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-healthcare-for-logistics-1028a05d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Healthcare for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Predictive Healthcare for Logistics. Powered by cutting-edge AI, this platform delivers fraud prevention like never before.
          </p>
