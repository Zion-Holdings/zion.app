...
export const metadata: Metadata = {
  title: 'Smart Platform for Transportation',
  description: 'Revolutionize transportation through intelligent automation. Our Smart Platform for Transportation leverages advanced machine learning to deliver content genera',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Platform for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize transportation through intelligent automation. Our Smart Platform for Transportation leverages advanced machine learning to deliver content generation at scale.
          </p>
