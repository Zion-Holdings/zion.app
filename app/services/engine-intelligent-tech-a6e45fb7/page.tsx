export const metadata = {
  ...
  description: "Zion Tech Group delivers Engine Intelligent - Tech with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/services/engine-intelligent-tech-a6e45fb7/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>Engine Intelligent - Tech</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers Engine Intelligent - Tech with measurable outcomes.
      </p>
