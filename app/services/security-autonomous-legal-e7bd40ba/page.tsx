...
export const metadata: Metadata = {
  title: 'Security Autonomous - Legal',
  description: 'Next-generation legal solution: Security Autonomous - Legal. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-autonomous-legal-e7bd40ba',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Autonomous - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Security Autonomous - Legal. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
