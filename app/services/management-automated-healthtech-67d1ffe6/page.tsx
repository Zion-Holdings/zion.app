...
export const metadata: Metadata = {
  title: 'Management Automated - HEALTHTECH',
  description: 'Revolutionize healthtech through intelligent automation. Our Management Automated - HEALTHTECH leverages advanced machine learning to deliver compliance automat',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Management Automated - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthtech through intelligent automation. Our Management Automated - HEALTHTECH leverages advanced machine learning to deliver compliance automation at scale.
          </p>
