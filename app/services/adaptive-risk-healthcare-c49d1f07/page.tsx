...
export const metadata: Metadata = {
  title: 'Adaptive Risk Healthcare',
  description: 'Revolutionize blockchain through intelligent automation. Our Adaptive Risk Healthcare leverages advanced machine learning to deliver risk assessment at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-risk-healthcare-c49d1f07',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Risk Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize blockchain through intelligent automation. Our Adaptive Risk Healthcare leverages advanced machine learning to deliver risk assessment at scale.
          </p>
