...
export const metadata: Metadata = {
  title: 'Self-Optimizing Customer Compliance',
  description: 'Transform your construction operations with our Self-Optimizing Customer Compliance. This AI-driven solution automates expense management with unprecedented acc',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Customer Compliance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Self-Optimizing Customer Compliance. This AI-driven solution automates expense management with unprecedented accuracy and efficiency.
          </p>
