...
export const metadata: Metadata = {
  title: "Agentic AI AI-Powered Data Governance - AI-Powered Agentic AI Solution",
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Agentic AI AI-Powered Data Governance - AI-Powered Agentic AI Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          AI-powered agentic ai solution for data governance. Automated data governance with compliance checking and policy enforcement.
        </p>
