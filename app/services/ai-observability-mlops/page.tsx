      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Monitor, debug, and optimize AI systems at scale. End-to-end observability for LLMs, agents, and ML pipelines with tracing, evaluation, and cost an...
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ End-to-End Tracing</li>
            <li className="text-purple-300">✓ Quality & Safety Evaluation</li>
            <li className="text-purple-300">✓ Cost & Usage Analytics</li>
            <li className="text-purple-300">✓ MLOps Pipeline Management</li>
            <li className="text-purple-300">✓ Debugging & Root Cause</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai observability & mlops</li>
