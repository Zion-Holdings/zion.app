...
export const metadata: Metadata = {
  ...
  description: 'Drive innovation in healthcare with Predictive Intelligence Engine - Healthcare. This AI-powered platform transforms workflow automation into a competitive adva',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with Predictive Intelligence Engine - Healthcare. This AI-powered platform transforms workflow automation into a competitive advantage.
          </p>
