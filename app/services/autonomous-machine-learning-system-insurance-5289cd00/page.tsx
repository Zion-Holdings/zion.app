...
export const metadata: Metadata = {
  title: 'Autonomous Machine Learning System - Insurance',
  description: 'Drive innovation in insurance with Autonomous Machine Learning System - Insurance. This AI-powered platform transforms feature engineering into a competitive ad',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-machine-learning-system-insurance-5289cd00',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Machine Learning System - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Autonomous Machine Learning System - Insurance. This AI-powered platform transforms feature engineering into a competitive advantage.
          </p>
