...
export const metadata = {
  ...
  description: 'End-to-end document processing automation: extract data from invoices, contracts, and forms services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/document-processing-automation-extract-data-invoices-contracts-forms-18/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">Document Processing Automation: Extract Data from Invoices, Contracts, and Forms</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end document processing automation: extract data from invoices, contracts, and forms services: assessment, deployment, and managed operations.
        </p>
