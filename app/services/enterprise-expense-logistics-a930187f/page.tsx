...
export const metadata: Metadata = {
  title: 'Enterprise Expense - Logistics',
  description: 'Transform logistics with Enterprise Expense - Logistics - the intelligent automation platform that learns, adapts, and delivers 10x results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-expense-logistics-a930187f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Expense - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform logistics with Enterprise Expense - Logistics - the intelligent automation platform that learns, adapts, and delivers 10x results.
          </p>
