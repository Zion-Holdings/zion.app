...
export const metadata: Metadata = {
  ...
  description: 'AI-powered audit automation for energy and utilities with 15% energy savings, Renewable integration, and Grid optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-energy-audit-automation-c665a0f8',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            AI-powered audit automation for energy and utilities with 15% energy savings, Renewable integration, and Grid optimization.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$3526</p>
          <ul className="space-y-2 mb-4">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$20931</p>
          <ul className="space-y-2 mb-4">
