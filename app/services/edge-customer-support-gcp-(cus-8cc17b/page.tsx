...
export const metadata: Metadata = {
  title: 'Edge Customer Support GCP (Customer)',
  description: 'Edge Customer Support GCP (Customer) is an AI-powered customer solution that transforms how businesses operate through intelligent automation and real-time anal',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Edge Customer Support GCP (Customer)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Edge Customer Support GCP (Customer) is an AI-powered customer solution that transforms how businesses operate through intelligent automation and real-time analytics.
