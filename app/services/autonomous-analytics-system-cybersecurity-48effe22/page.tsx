...
export const metadata: Metadata = {
  title: 'Autonomous Analytics System - Cybersecurity',
  description: 'Drive innovation in cybersecurity with Autonomous Analytics System - Cybersecurity. This AI-powered platform transforms cost reduction into a competitive advant',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Analytics System - Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in cybersecurity with Autonomous Analytics System - Cybersecurity. This AI-powered platform transforms cost reduction into a competitive advantage.
          </p>
