...
export const metadata: Metadata = {
  title: 'AI-Driven User Provisioning for Construction',
  description: 'Next-generation construction solution: AI-Driven User Provisioning for Construction. Combines vendor management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-driven-user-provisioning-for-construction-fc695a64',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Driven User Provisioning for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: AI-Driven User Provisioning for Construction. Combines vendor management with adaptive intelligence for optimal results.
          </p>
