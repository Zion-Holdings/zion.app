...
export const metadata: Metadata = {
  title: 'Cognitive advisor-telecom',
  description: 'The future of telecom is here with Cognitive advisor-telecom. Powered by cutting-edge AI, this platform delivers net promoter score like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-advisor-telecom-58bacade',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive advisor-telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of telecom is here with Cognitive advisor-telecom. Powered by cutting-edge AI, this platform delivers net promoter score like never before.
          </p>
