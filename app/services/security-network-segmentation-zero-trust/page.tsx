...
export const metadata: Metadata = {
  ...
  keywords: 'Service/workload inventory (K8s/VM/CNI), East-West micro-segmentation policy designer, Policy deployment + rollback alert, Policy coverage heat-map per namespace, security, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Network Segmentation &amp; Zero Trust</h1>
        <p className="text-lg text-slate-300 mb-8">Micro-segmentation policy design per workload, East-West traffic policy enforcement, and SIEM policy-deployment rollback alert.</p>
        ...
        <li class="text-slate-300">Service/workload inventory (K8s/VM/CNI)</li>
        <li class="text-slate-300">East-West micro-segmentation policy designer</li>
        <li class="text-slate-300">Policy deployment + rollback alert</li>
        <li class="text-slate-300">Policy coverage heat-map per namespace</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with network segmentation &amp; zero trust</li>
