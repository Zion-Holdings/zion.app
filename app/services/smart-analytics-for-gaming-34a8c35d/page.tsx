...
export const metadata: Metadata = {
  title: 'Smart Analytics for Gaming',
  description: 'Drive innovation in gaming with Smart Analytics for Gaming. This AI-powered platform transforms threat detection into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-analytics-for-gaming-34a8c35d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Analytics for Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in gaming with Smart Analytics for Gaming. This AI-powered platform transforms threat detection into a competitive advantage.
          </p>
