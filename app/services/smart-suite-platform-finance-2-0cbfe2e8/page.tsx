...
export const metadata: Metadata = {
  title: 'Smart Suite Platform - Finance #2',
  description: 'Transform your finance operations with our Smart Suite Platform - Finance #2. This AI-driven solution automates influencer identification with unprecedented acc',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Suite Platform - Finance #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Smart Suite Platform - Finance #2. This AI-driven solution automates influencer identification with unprecedented accuracy and efficiency.
          </p>
