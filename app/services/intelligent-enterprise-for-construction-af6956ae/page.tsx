...
export const metadata: Metadata = {
  title: 'Intelligent Enterprise for Construction',
  description: 'Unlock unprecedented growth with Intelligent Enterprise for Construction. This autonomous system provides learning management with zero manual intervention need',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-enterprise-for-construction-af6956ae',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Enterprise for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Enterprise for Construction. This autonomous system provides learning management with zero manual intervention needed.
          </p>
