...
export const metadata: Metadata = {
  ...
  keywords: 'M365 licensing optimization and procurement, Email migration from legacy systems, SharePoint and OneDrive deployment, Teams configuration and governance, M365 security and compliance setup, Intune device management, User training and adoption programs, Ongoing management and support, it, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Microsoft 365 Deployment &amp; Management</h1>
        <p className="text-lg text-slate-300 mb-8">Complete Microsoft 365 deployment, migration, and management. Exchange, SharePoint, Teams, OneDrive, and security configuration.</p>
        ...
        <li class="text-slate-300">M365 licensing optimization and procurement</li>
        <li class="text-slate-300">Email migration from legacy systems</li>
        <li class="text-slate-300">SharePoint and OneDrive deployment</li>
        <li class="text-slate-300">Teams configuration and governance</li>
        <li class="text-slate-300">M365 security and compliance setup</li>
        <li class="text-slate-300">Intune device management</li>
        <li class="text-slate-300">User training and adoption programs</li>
        <li class="text-slate-300">Ongoing management and support</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Optimize M365 licensing costs by 30%</li>
        <li class="text-slate-300">Migrate without business disruption</li>
        <li class="text-slate-300">Secure M365 with best-practice configuration</li>
        <li class="text-slate-300">Drive user adoption with training</li>
      </ul>
        </div>
