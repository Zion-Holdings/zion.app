...
export const metadata: Metadata = {
  title: 'AI/IT Enterprise Suite - Agriculture',
  description: 'The future of agriculture is here with AI/IT Enterprise Suite - Agriculture. Powered by cutting-edge AI, this platform delivers resource utilization like never ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-enterprise-suite-agriculture-0bbeea92',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Enterprise Suite - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with AI/IT Enterprise Suite - Agriculture. Powered by cutting-edge AI, this platform delivers resource utilization like never before.
          </p>
