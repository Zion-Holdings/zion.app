...
export const metadata: Metadata = {
  title: 'Enterprise Intelligent for CLEANTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Intelligent for CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your cleantech business with Enterprise Intelligent for CLEANTECH. Our solution provides data governance with enterprise-grade reliability and security.
          </p>
