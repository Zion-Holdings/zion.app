...
export const metadata: Metadata = {
  title: 'Cloud-Native Lead for Media',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cloud-Native Lead for Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your media workflows with Cloud-Native Lead for Media. This intelligent platform delivers net promoter score through advanced automation and AI.
          </p>
