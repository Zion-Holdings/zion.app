...
export const metadata: Metadata = {
  title: 'Smart Analytics Platform - Retail',
  description: 'Drive innovation in retail with Smart Analytics Platform - Retail. This AI-powered platform transforms resource allocation into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-analytics-platform-retail-6375af05',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Analytics Platform - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in retail with Smart Analytics Platform - Retail. This AI-powered platform transforms resource allocation into a competitive advantage.
          </p>
