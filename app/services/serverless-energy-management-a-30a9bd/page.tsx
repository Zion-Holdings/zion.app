...
export const metadata: Metadata = {
  title: 'Serverless Energy Management Azure (Manufacturing)',
  description: 'Serverless Energy Management Azure (Manufacturing) is an AI-powered manufacturing solution that transforms how businesses operate through intelligent automation',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Serverless Energy Management Azure (Manufacturing)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Serverless Energy Management Azure (Manufacturing) is an AI-powered manufacturing solution that transforms how businesses operate through intelligent automation and real-time analytics.
