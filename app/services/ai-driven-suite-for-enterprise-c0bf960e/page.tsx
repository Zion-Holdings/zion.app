...
export const metadata: Metadata = {
  title: 'AI-Driven Suite for Enterprise',
  description: 'Revolutionize enterprise through intelligent automation. Our AI-Driven Suite for Enterprise leverages advanced machine learning to deliver access management at ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-driven-suite-for-enterprise-c0bf960e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Driven Suite for Enterprise
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize enterprise through intelligent automation. Our AI-Driven Suite for Enterprise leverages advanced machine learning to deliver access management at scale.
          </p>
