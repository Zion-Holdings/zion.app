...
export const metadata: Metadata = {
  title: 'Cognitive Marketing Solution - EDTECH',
  description: 'Transform your edtech operations with our Cognitive Marketing Solution - EDTECH. This AI-driven solution automates record extraction with unprecedented accuracy',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-marketing-solution-edtech-6100de05',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Marketing Solution - EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your edtech operations with our Cognitive Marketing Solution - EDTECH. This AI-driven solution automates record extraction with unprecedented accuracy and efficiency.
          </p>
