...
export const metadata: Metadata = {
  title: 'Intelligent Decision Finance',
  description: 'Transform your retail operations with our Intelligent Decision Finance. This AI-driven solution automates logistics route optimization with unprecedented accura',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-decision-finance-c87900ae',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Decision Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our Intelligent Decision Finance. This AI-driven solution automates logistics route optimization with unprecedented accuracy and efficiency.
          </p>
