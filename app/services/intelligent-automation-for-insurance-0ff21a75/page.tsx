...
export const metadata: Metadata = {
  title: 'Intelligent Automation for Insurance',
  description: 'Transform your insurance operations with our Intelligent Automation for Insurance. This AI-driven solution automates employee engagement with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-automation-for-insurance-0ff21a75',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Intelligent Automation for Insurance. This AI-driven solution automates employee engagement with unprecedented accuracy and efficiency.
          </p>
