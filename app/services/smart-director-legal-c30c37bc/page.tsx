...
export const metadata: Metadata = {
  title: 'Smart director-legal',
  description: 'Next-generation legal solution: Smart director-legal. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-director-legal-c30c37bc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart director-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Smart director-legal. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
