...
export const metadata: Metadata = {
  title: 'Cognitive system-proptech',
  description: 'Unlock unprecedented growth with Cognitive system-proptech. This autonomous system provides quality control with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-system-proptech-311e9484',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive system-proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Cognitive system-proptech. This autonomous system provides quality control with zero manual intervention needed.
          </p>
