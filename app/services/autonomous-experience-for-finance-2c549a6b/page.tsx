...
export const metadata: Metadata = {
  title: 'Autonomous Experience for Finance',
  description: 'Transform your finance operations with our Autonomous Experience for Finance. This AI-driven solution automates process automation with unprecedented accuracy a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-experience-for-finance-2c549a6b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Experience for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Autonomous Experience for Finance. This AI-driven solution automates process automation with unprecedented accuracy and efficiency.
          </p>
