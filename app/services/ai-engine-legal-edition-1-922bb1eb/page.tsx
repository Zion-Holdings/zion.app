...
export const metadata: Metadata = {
  title: 'AI Engine - Legal Edition #1',
  description: 'Enhance your legal business with AI Engine - Legal Edition #1. Our solution provides recruitment automation with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-engine-legal-edition-1-922bb1eb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Engine - Legal Edition #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with AI Engine - Legal Edition #1. Our solution provides recruitment automation with enterprise-grade reliability and security.
          </p>
