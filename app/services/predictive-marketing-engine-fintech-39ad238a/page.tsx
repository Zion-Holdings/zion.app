...
export const metadata: Metadata = {
  title: 'Predictive Marketing Engine - FINTECH',
  description: 'Transform your fintech operations with our Predictive Marketing Engine - FINTECH. This AI-driven solution automates testing automation with unprecedented accura',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Marketing Engine - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your fintech operations with our Predictive Marketing Engine - FINTECH. This AI-driven solution automates testing automation with unprecedented accuracy and efficiency.
          </p>
