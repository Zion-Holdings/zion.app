...
export const metadata: Metadata = {
  title: 'Adaptive manufacturing-hospitality',
  description: 'The future of hospitality is here with Adaptive manufacturing-hospitality. Powered by cutting-edge AI, this platform delivers sales forecasting like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-manufacturing-hospitality-fe3e28c6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive manufacturing-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Adaptive manufacturing-hospitality. Powered by cutting-edge AI, this platform delivers sales forecasting like never before.
          </p>
