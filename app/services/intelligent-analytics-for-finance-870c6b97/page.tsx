...
export const metadata: Metadata = {
  title: 'Intelligent Analytics for Finance',
  description: 'Future-proof your finance with Intelligent Analytics for Finance. Our autonomous solution handles customer service automation end-to-end without human intervent',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Analytics for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your finance with Intelligent Analytics for Finance. Our autonomous solution handles customer service automation end-to-end without human intervention.
          </p>
