...
export const metadata: Metadata = {
  ...
  keywords: 'One-click failover, Continuous replication, Compliance testing, RPO < 1 min, RTO < 15 min, Multi-region support, Automated runbooks, Recovery testing, cloud, Enterprise, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Disaster Recovery Orchestration Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Automated disaster recovery with one-click failover, continuous replication, and compliance testing. Achieves RPO &lt; 1 minute and RTO &lt; 15 minutes for critical applications.</p>
        ...
        <li class="text-slate-300">One-click failover</li>
        <li class="text-slate-300">Continuous replication</li>
        <li class="text-slate-300">Compliance testing</li>
        <li class="text-slate-300">RPO &lt; 1 min</li>
        <li class="text-slate-300">RTO &lt; 15 min</li>
        <li class="text-slate-300">Multi-region support</li>
        <li class="text-slate-300">Automated runbooks</li>
        <li class="text-slate-300">Recovery testing</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">99.99% data durability</li>
        <li class="text-slate-300">15-minute RTO</li>
        <li class="text-slate-300">Automated compliance testing</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">3999</p>
