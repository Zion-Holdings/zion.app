...
export const metadata = {
  ...
  description: "Automated disaster recovery with one-click failover, continuous replication, and compliance testing. Achieves RPO < 1 minute and RTO < 15 minutes for critical a",
  alternates: {
