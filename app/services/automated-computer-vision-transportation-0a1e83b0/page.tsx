...
export const metadata: Metadata = {
  title: 'Automated computer vision-transportation',
  description: 'Transform your transportation operations with our Automated computer vision-transportation. This AI-driven solution automates audit automation with unprecedente',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-computer-vision-transportation-0a1e83b0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated computer vision-transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your transportation operations with our Automated computer vision-transportation. This AI-driven solution automates audit automation with unprecedented accuracy and efficiency.
          </p>
