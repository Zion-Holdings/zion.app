...
export const metadata: Metadata = {
  title: 'Adaptive Supply for Logistics',
  description: 'Next-generation logistics solution: Adaptive Supply for Logistics. Combines financial planning with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-supply-for-logistics-189a6af4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Supply for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation logistics solution: Adaptive Supply for Logistics. Combines financial planning with adaptive intelligence for optimal results.
          </p>
