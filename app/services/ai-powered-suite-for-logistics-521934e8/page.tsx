...
export const metadata: Metadata = {
  title: 'AI-Powered Suite for Logistics',
  description: 'Revolutionize logistics through intelligent automation. Our AI-Powered Suite for Logistics leverages advanced machine learning to deliver market intelligence at',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-suite-for-logistics-521934e8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Suite for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our AI-Powered Suite for Logistics leverages advanced machine learning to deliver market intelligence at scale.
          </p>
