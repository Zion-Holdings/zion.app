...
export const metadata: Metadata = {
  title: 'Cognitive Intelligent - Logistics',
  description: 'Transform your logistics operations with our Cognitive Intelligent - Logistics. This AI-driven solution automates resource utilization with unprecedented accura',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-intelligent-logistics-8a7cd7b4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Intelligent - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Cognitive Intelligent - Logistics. This AI-driven solution automates resource utilization with unprecedented accuracy and efficiency.
          </p>
