...
export const metadata: Metadata = {
  ...
  keywords: 'Global backbone (100+ PoPs), Direct cloud connects, Zero-trust network access, WAN optimization, Central policy management, it, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Multi-Cloud Networking</h1>
        <p className="text-lg text-slate-300 mb-8">Global SD-WAN with direct cloud interconnect (AWS Direct Connect, Azure ExpressRoute). Secure, performant, and centrally managed.</p>
        ...
        <li class="text-slate-300">Global backbone (100+ PoPs)</li>
        <li class="text-slate-300">Direct cloud connects</li>
        <li class="text-slate-300">Zero-trust network access</li>
        <li class="text-slate-300">WAN optimization</li>
        <li class="text-slate-300">Central policy management</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with multi-cloud networking</li>
