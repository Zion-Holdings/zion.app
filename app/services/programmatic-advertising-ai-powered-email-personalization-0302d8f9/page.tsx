...
export const metadata: Metadata = {
  title: 'Programmatic Advertising AI-Powered Email Personalization',
  description: 'AI-powered programmatic advertising solution for email marketing. Creates hyper-personalized email campaigns by analyzing recipient data.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/programmatic-advertising-ai-powered-email-personalization-0302d8f9',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Programmatic Advertising AI-Powered Email Personalization
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered programmatic advertising solution for email marketing. Creates hyper-personalized email campaigns by analyzing recipient data.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Dynamic content</li>
          <li className="text-gray-300">Behavioral triggers</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">3x engagement rates</li>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-500/20">
          ...
          <p className="text-3xl font-bold text-purple-400 mb-4">$99</p>
