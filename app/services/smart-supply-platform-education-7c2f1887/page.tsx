...
export const metadata: Metadata = {
  ...
  description: 'The future of education is here with Smart Supply Platform - Education. Powered by cutting-edge AI, this platform delivers testing automation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-supply-platform-education-7c2f1887',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of education is here with Smart Supply Platform - Education. Powered by cutting-edge AI, this platform delivers testing automation like never before.
          </p>
