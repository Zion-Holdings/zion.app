...
export const metadata: Metadata = {
  title: 'Smart Real Estate Platform - Energy',
  description: 'The future of energy is here with Smart Real Estate Platform - Energy. Powered by cutting-edge AI, this platform delivers account planning like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-real-estate-platform-energy-4e7ebdfe',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Real Estate Platform - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Smart Real Estate Platform - Energy. Powered by cutting-edge AI, this platform delivers account planning like never before.
          </p>
