...
export const metadata: Metadata = {
  title: 'AI-Powered Supply Process Mining',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Supply Process Mining
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of cleantech is here with AI-Powered Supply Process Mining. Powered by cutting-edge AI, this platform delivers margin analysis like never before.
          </p>
