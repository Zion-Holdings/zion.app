...
export const metadata: Metadata = {
  title: 'Cognitive Risk for Gaming',
  description: 'Revolutionize gaming through intelligent automation. Our Cognitive Risk for Gaming leverages advanced machine learning to deliver compliance monitoring at scale',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-risk-for-gaming-26287b5d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Risk for Gaming
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize gaming through intelligent automation. Our Cognitive Risk for Gaming leverages advanced machine learning to deliver compliance monitoring at scale.
          </p>
