...
export const metadata: Metadata = {
  title: 'Smart Analytics Platform - Transportation',
  description: 'Unlock unprecedented growth with Smart Analytics Platform - Transportation. This autonomous system provides financial risk management with zero manual intervent',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-analytics-platform-transportation-31e81852',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Analytics Platform - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Analytics Platform - Transportation. This autonomous system provides financial risk management with zero manual intervention needed.
          </p>
