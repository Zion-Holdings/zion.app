...
export const metadata: Metadata = {
  title: 'Enterprise Automation Platform - PROPTECH',
  description: 'Hyper-accelerated proptech solution: Enterprise Automation Platform - PROPTECH. Combines resource utilization with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-automation-platform-proptech-d0f658f1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Automation Platform - PROPTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated proptech solution: Enterprise Automation Platform - PROPTECH. Combines resource utilization with next-gen AI for maximum velocity.
          </p>
