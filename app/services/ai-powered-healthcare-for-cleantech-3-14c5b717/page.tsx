...
export const metadata: Metadata = {
  title: 'AI-Powered Healthcare for Cleantech #3',
  description: 'Revolutionize cleantech through intelligent automation. Our AI-Powered Healthcare for Cleantech #3 leverages advanced machine learning to deliver healthcare dat',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-healthcare-for-cleantech-3-14c5b717',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Healthcare for Cleantech #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cleantech through intelligent automation. Our AI-Powered Healthcare for Cleantech #3 leverages advanced machine learning to deliver healthcare data analytics at scale.
          </p>
