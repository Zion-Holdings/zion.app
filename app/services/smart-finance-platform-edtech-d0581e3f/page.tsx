...
export const metadata: Metadata = {
  title: 'Smart Finance Platform - EDTECH',
  description: 'Enhance your edtech business with Smart Finance Platform - EDTECH. Our solution provides integration platform with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-finance-platform-edtech-d0581e3f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Finance Platform - EDTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your edtech business with Smart Finance Platform - EDTECH. Our solution provides integration platform with enterprise-grade reliability and security.
          </p>
