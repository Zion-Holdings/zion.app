...
export const metadata: Metadata = {
  ...
  keywords: 'Course creation and management, SCORM and xAPI compliance, Learning paths and certifications, Compliance training tracking, Skills gap analysis, Integration with Cornerstone, Docebo, TalentLMS, automation, Education, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Learning Management System (LMS)</h1>
        <p className="text-lg text-slate-300 mb-8">Manage training: course creation, delivery, tracking, compliance reporting. SCORM and xAPI compliant.</p>
        ...
        <li class="text-slate-300">Course creation and management</li>
        <li class="text-slate-300">SCORM and xAPI compliance</li>
        <li class="text-slate-300">Learning paths and certifications</li>
        <li class="text-slate-300">Compliance training tracking</li>
        <li class="text-slate-300">Skills gap analysis</li>
        <li class="text-slate-300">Integration with Cornerstone</li>
        <li class="text-slate-300">Docebo</li>
        <li class="text-slate-300">TalentLMS</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Course creation and delivery in one platform</li>
        <li class="text-slate-300">SCORM/xAPI for content compatibility</li>
        <li class="text-slate-300">Compliance tracking for regulated industries</li>
        <li class="text-slate-300">Skills gap analysis for development</li>
      </ul>
        </div>
