...
export const metadata: Metadata = {
  ...
  description: 'Computer vision system that detects defects with 99.9% accuracy and automates quality control processes across production lines.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-quality-inspection-system2026-07-28t0659148259580000-1ffa8cd4',
  },
=======
=======
...
export const metadata = {
  title: "AI-Powered Quality Inspection System - Zion Tech Group",
  description: "Computer vision system that detects defects with 99.9% accuracy and automates quality control processes across production lines.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-quality-inspection-system2026-07-28t0659148259580000-1ffa8cd4`
  }
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Computer vision system that detects defects with 99.9% accuracy and automates quality control processes across production lines.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Visual inspection</li>
          <li className="text-gray-300">Defect detection</li>
          <li className="text-gray-300">Quality scoring</li>
          <li className="text-gray-300">Automated QC</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">Zero defects</li>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$24999</p>
          <ul className="space-y-2 mb-4">
...
>>>>>>> 39bf07ce6891d15dc926f13878391bb6137ef7f2
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">AI-Powered Quality Inspection System</h1>
        <p className="text-lg text-gray-300 mb-8">Computer vision system that detects defects with 99.9% accuracy and automates quality control processes across production lines.</p>
