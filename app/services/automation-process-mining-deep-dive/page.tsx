...
export const metadata: Metadata = {
  ...
  keywords: 'Auto-discover process maps from ERP, CRM, and BPM event logs including SAP, Oracle, Salesforce, Jira, and ServiceNow, Conformance checking — compare actual behaviour against the ideal process path with deviation scoring per transaction, Bottleneck, rework, and hotspot analysis — queue time, cycle time, and handover waste per step, RPA opportunity score per step — suggests which steps to auto-route with effort estimate, Executive dashboard with process KPIs, SLA drift, and cost-per-transaction trend, automation, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Process Mining Deep Dive</h1>
        <p className="text-lg text-slate-300 mb-8">Deep-dive process analytics: auto-discover process maps from ERP, CRM, and BPM event logs; conformance checking per transaction; bottleneck and rework hotspot analysis with cycle-time and handover waste; RPA opportunity scoring per step; executive KPI dashboard.</p>
        ...
        <li class="text-slate-300">Auto-discover process maps from ERP, CRM, and BPM event logs including SAP, Oracle, Salesforce, Jira, and ServiceNow</li>
        <li class="text-slate-300">Conformance checking — compare actual behaviour against the ideal process path with deviation scoring per transaction</li>
        <li class="text-slate-300">Bottleneck, rework, and hotspot analysis — queue time, cycle time, and handover waste per step</li>
        <li class="text-slate-300">RPA opportunity score per step — suggests which steps to auto-route with effort estimate</li>
        <li class="text-slate-300">Executive dashboard with process KPIs, SLA drift, and cost-per-transaction trend</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with process mining deep dive</li>
