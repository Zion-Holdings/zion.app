    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Identify hidden bottlenecks invisible in manual process reviews</li>
            <li>Quantify RPA and automation ROI before writing a single script</li>
            <li>Reduce end-to-end cycle time by 20 to 40 percent on average</li>
            <li>Continuous monitoring catches process drift after go-live rather than at the next quarter review</li>
          </ul>
        </div>
