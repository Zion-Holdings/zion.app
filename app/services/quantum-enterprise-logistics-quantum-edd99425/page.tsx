...
export const metadata: Metadata = {
  title: 'Quantum Enterprise - Logistics Quantum',
  description: 'Hyper-accelerated logistics solution: Quantum Enterprise - Logistics Quantum. Combines esg reporting with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-enterprise-logistics-quantum-edd99425',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Enterprise - Logistics Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated logistics solution: Quantum Enterprise - Logistics Quantum. Combines esg reporting with next-gen AI for maximum velocity.
          </p>
