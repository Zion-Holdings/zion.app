...
export const metadata: Metadata = {
  title: 'Anomaly Detection Real-Time Data Pipeline Platform',
  description: 'anomaly detection solution for finance industry. Creates and manages real-time data pipelines with automated ETL and streaming analytics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/anomaly-detection-real-time-data-pipeline-platform-e20f1645',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Anomaly Detection Real-Time Data Pipeline Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            anomaly detection solution for finance industry. Creates and manages real-time data pipelines with automated ETL and streaming analytics.
          </p>
