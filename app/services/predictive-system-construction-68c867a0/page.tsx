...
export const metadata: Metadata = {
  title: 'Predictive system-construction',
  description: 'Optimize your construction workflows with Predictive system-construction. This intelligent platform delivers customer journey mapping through advanced automatio',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-system-construction-68c867a0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Predictive system-construction. This intelligent platform delivers customer journey mapping through advanced automation and AI.
          </p>
