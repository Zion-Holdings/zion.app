...
export const metadata: Metadata = {
  title: 'Autonomous Healthcare System - Retail',
  description: 'Transform your retail operations with our Autonomous Healthcare System - Retail. This AI-driven solution automates scenario planning with unprecedented accuracy',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-healthcare-system-retail-b11178ed',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Healthcare System - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our Autonomous Healthcare System - Retail. This AI-driven solution automates scenario planning with unprecedented accuracy and efficiency.
          </p>
