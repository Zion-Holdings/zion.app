...
export const metadata: Metadata = {
  title: 'AI/IT Optimization Suite - Real-Estate',
  description: 'Transform your real-estate operations with our AI/IT Optimization Suite - Real-Estate. This AI-driven solution automates compensation management with unpreceden',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-optimization-suite-real-estate-35a60fba',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Optimization Suite - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our AI/IT Optimization Suite - Real-Estate. This AI-driven solution automates compensation management with unprecedented accuracy and efficiency.
          </p>
