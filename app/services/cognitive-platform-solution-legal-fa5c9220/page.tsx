...
export const metadata: Metadata = {
  title: 'Cognitive Platform Solution - Legal',
  description: 'Revolutionize legal through intelligent automation. Our Cognitive Platform Solution - Legal leverages advanced machine learning to deliver sales process optimiz',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-platform-solution-legal-fa5c9220',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Platform Solution - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Cognitive Platform Solution - Legal leverages advanced machine learning to deliver sales process optimization at scale.
          </p>
