...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize logistics through intelligent automation. Our Predictive Monitoring Engine - Logistics leverages advanced machine learning to deliver brand monito',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Predictive Monitoring Engine - Logistics leverages advanced machine learning to deliver brand monitoring at scale.
          </p>
