...
export const metadata = {
  ...
  description: "Transform your manufacturing operations with our Intelligent Edge for Manufacturing. This AI-driven solution automates edge computing with unprecedented accurac",
  alternates: {
