...
export const metadata: Metadata = {
  title: 'Smart DevOps Platform - Manufacturing',
  description: 'Drive innovation in manufacturing with Smart DevOps Platform - Manufacturing. This AI-powered platform transforms lead scoring into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-devops-platform-manufacturing-867e93e6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart DevOps Platform - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in manufacturing with Smart DevOps Platform - Manufacturing. This AI-powered platform transforms lead scoring into a competitive advantage.
          </p>
