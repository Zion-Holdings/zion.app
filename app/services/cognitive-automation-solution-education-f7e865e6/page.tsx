...
export const metadata: Metadata = {
  title: 'Cognitive Automation Solution - Education',
  description: 'Drive innovation in education with Cognitive Automation Solution - Education. This AI-powered platform transforms recommendation system into a competitive advan',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Automation Solution - Education
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in education with Cognitive Automation Solution - Education. This AI-powered platform transforms recommendation system into a competitive advantage.
          </p>
