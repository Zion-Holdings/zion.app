...
export const metadata: Metadata = {
  title: 'AI/IT Cognitive Suite - Insurance #1',
  description: 'Enhance your insurance business with AI/IT Cognitive Suite - Insurance #1. Our solution provides audit trail management with enterprise-grade reliability and se',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Cognitive Suite - Insurance #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with AI/IT Cognitive Suite - Insurance #1. Our solution provides audit trail management with enterprise-grade reliability and security.
          </p>
