...
export const metadata: Metadata = {
  title: 'Predictive Security Engine - FINTECH',
  description: 'Revolutionize fintech through intelligent automation. Our Predictive Security Engine - FINTECH leverages advanced machine learning to deliver leave management a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-security-engine-fintech-e41d06e2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Security Engine - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize fintech through intelligent automation. Our Predictive Security Engine - FINTECH leverages advanced machine learning to deliver leave management at scale.
          </p>
