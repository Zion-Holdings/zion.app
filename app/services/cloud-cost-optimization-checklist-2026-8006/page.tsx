...
export const metadata = {
  ...
  alternates: { canonical: '/services/cloud-cost-optimization-checklist-2026-8006/' },

  openGraph: {
    title: 'Cloud Cost Optimization | Zion Tech Group',
    description: 'End-to-end cloud cost optimization services: assessment, deployment, and managed operations.',
    url: 'https://ziontechgroup.com/services/cloud-cost-optimization-checklist-2026-8006/',
    siteName: 'Zion Tech Group',
    type: 'website',
    images: ['/og-default.png'],
  },
  twitter: { card: 'summary_large_image', title: 'Cloud Cost Optimization | Zion Tech Group', description: 'End-to-end cloud cost optimization services: assessment, deployment, and managed operations.' }};

export default function ServicePage() {
  return (
    <main className="min-h-screen bg-slate-950 py-20">

    <JsonLd data={{@context: "https://schema.org", @type: "Service", name: "Cloud Cost Optimization | Zion Tech Group", description: "End-to-end cloud cost optimization services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/cloud-cost-optimization-checklist-2026-8006/}} />
      <div className="container-page">
        ...
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end cloud cost optimization services: assessment, deployment, and managed operations.
        </p>
