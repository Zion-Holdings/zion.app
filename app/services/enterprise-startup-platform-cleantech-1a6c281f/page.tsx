...
export const metadata: Metadata = {
  title: 'Enterprise Startup Platform - CLEANTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Startup Platform - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your cleantech workflows with Enterprise Startup Platform - CLEANTECH. This intelligent platform delivers market intelligence through advanced automation and AI.
          </p>
