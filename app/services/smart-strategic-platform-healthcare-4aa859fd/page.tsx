...
export const metadata: Metadata = {
  title: 'Smart Strategic Platform - Healthcare',
  description: 'Drive innovation in healthcare with Smart Strategic Platform - Healthcare. This AI-powered platform transforms serverless orchestration into a competitive advan',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Strategic Platform - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with Smart Strategic Platform - Healthcare. This AI-powered platform transforms serverless orchestration into a competitive advantage.
          </p>
