...
export const metadata: Metadata = {
  title: 'DevOps Automated - Finance',
  description: 'Revolutionize finance through intelligent automation. Our DevOps Automated - Finance leverages advanced machine learning to deliver sales forecasting at scale.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            DevOps Automated - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize finance through intelligent automation. Our DevOps Automated - Finance leverages advanced machine learning to deliver sales forecasting at scale.
          </p>
