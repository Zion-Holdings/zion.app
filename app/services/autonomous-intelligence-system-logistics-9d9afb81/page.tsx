...
export const metadata: Metadata = {
  title: 'Autonomous Intelligence System - Logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Autonomous Intelligence System - Logistics leverages advanced machine learning to deliver employee e',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-intelligence-system-logistics-9d9afb81',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Intelligence System - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Autonomous Intelligence System - Logistics leverages advanced machine learning to deliver employee engagement at scale.
          </p>
