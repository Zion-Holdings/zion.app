...
export const metadata: Metadata = {
  title: 'Predictive Experience Engine - Legal',
  description: 'Unlock unprecedented growth with Predictive Experience Engine - Legal. This autonomous system provides quality control with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-experience-engine-legal-3ef02afa',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Experience Engine - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Predictive Experience Engine - Legal. This autonomous system provides quality control with zero manual intervention needed.
          </p>
