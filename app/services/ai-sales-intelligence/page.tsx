...
export const metadata: Metadata = {
  ...
  keywords: 'Predictive lead scoring (0-100), Sales pipeline forecasting, Deal risk detection & alerts, Automated email sequences, Competitive intelligence briefs, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Sales Intelligence</h1>
        <p className="text-lg text-slate-300 mb-8">Boost revenue with AI-driven lead scoring, pipeline prediction, deal insights, and automated outreach sequencing.</p>
        ...
        <li class="text-slate-300">Predictive lead scoring (0-100)</li>
        <li class="text-slate-300">Sales pipeline forecasting</li>
        <li class="text-slate-300">Deal risk detection &amp; alerts</li>
        <li class="text-slate-300">Automated email sequences</li>
        <li class="text-slate-300">Competitive intelligence briefs</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai sales intelligence</li>
