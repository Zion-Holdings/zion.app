...
export const metadata: Metadata = {
  title: 'Autonomous Engine System - Telecom',
  description: 'The future of telecom is here with Autonomous Engine System - Telecom. Powered by cutting-edge AI, this platform delivers code optimization like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-engine-system-telecom-e8c478d8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Engine System - Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of telecom is here with Autonomous Engine System - Telecom. Powered by cutting-edge AI, this platform delivers code optimization like never before.
          </p>
