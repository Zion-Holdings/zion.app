...
export const metadata: Metadata = {
  title: 'Smart Supply Platform - Healthcare',
  description: 'Optimize your healthcare workflows with Smart Supply Platform - Healthcare. This intelligent platform delivers background checks through advanced automation and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-supply-platform-healthcare-c0faae45',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Supply Platform - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Smart Supply Platform - Healthcare. This intelligent platform delivers background checks through advanced automation and AI.
          </p>
