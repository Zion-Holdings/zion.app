...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={@context: "https://schema.org", @type: "Service", name: "Chaos Engineering | Zion Tech Group", description: "End-to-end chaos engineering services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/chaos-engineering-2026-7361/"} />
