...
export const metadata: Metadata = {
  title: 'Manager Autonomous - Finance',
  description: 'Transform your finance operations with our Manager Autonomous - Finance. This AI-driven solution automates predictive modeling with unprecedented accuracy and e',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manager Autonomous - Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Manager Autonomous - Finance. This AI-driven solution automates predictive modeling with unprecedented accuracy and efficiency.
          </p>
