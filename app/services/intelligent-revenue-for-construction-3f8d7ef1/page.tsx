...
export const metadata: Metadata = {
  title: 'Intelligent Revenue for Construction',
  description: 'Unlock unprecedented growth with Intelligent Revenue for Construction. This autonomous system provides market intelligence with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-revenue-for-construction-3f8d7ef1',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Revenue for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Revenue for Construction. This autonomous system provides market intelligence with zero manual intervention needed.
          </p>
