...
export const metadata: Metadata = {
  title: 'Coordinator Neural - MARTECH',
  description: 'Revolutionize martech through intelligent automation. Our Coordinator Neural - MARTECH leverages advanced machine learning to deliver compensation management at',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Coordinator Neural - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize martech through intelligent automation. Our Coordinator Neural - MARTECH leverages advanced machine learning to deliver compensation management at scale.
          </p>
