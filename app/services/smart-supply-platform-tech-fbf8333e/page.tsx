...
export const metadata: Metadata = {
  ...
  description: 'Optimize your technology workflows with Smart Supply Platform - Tech. This intelligent platform delivers decision support through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-supply-platform-tech-fbf8333e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Optimize your technology workflows with Smart Supply Platform - Tech. This intelligent platform delivers decision support through advanced automation and AI.
          </p>
