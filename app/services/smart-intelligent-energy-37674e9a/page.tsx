...
export const metadata: Metadata = {
  title: 'Smart Intelligent - Energy',
  description: 'Enhance your energy business with Smart Intelligent - Energy. Our solution provides budget tracking with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-intelligent-energy-37674e9a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Intelligent - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your energy business with Smart Intelligent - Energy. Our solution provides budget tracking with enterprise-grade reliability and security.
          </p>
