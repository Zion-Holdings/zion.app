...
export const metadata: Metadata = {
  title: 'Intelligent revenue-logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Intelligent revenue-logistics leverages advanced machine learning to deliver enterprise-grade insigh',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-revenue-logistics-468fa60d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent revenue-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Intelligent revenue-logistics leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
