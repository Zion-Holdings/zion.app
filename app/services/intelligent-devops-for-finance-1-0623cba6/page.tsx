...
export const metadata: Metadata = {
  title: 'Intelligent DevOps for Finance #1',
  description: 'Optimize your finance workflows with Intelligent DevOps for Finance #1. This intelligent platform delivers document processing through advanced automation and A',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-devops-for-finance-1-0623cba6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent DevOps for Finance #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your finance workflows with Intelligent DevOps for Finance #1. This intelligent platform delivers document processing through advanced automation and AI.
          </p>
