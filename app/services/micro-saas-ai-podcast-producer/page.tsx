...
export const metadata: Metadata = {
  ...
  keywords: 'AI audio editing (remove ums, ahs, long pauses), Automatic transcription with speaker detection, AI show notes and summary generation, Social media clip extraction and captioning, Blog post and newsletter generation from episodes, Integration with Spotify, Apple Podcasts, YouTube, Multi-language translation and dubbing, Analytics on listener engagement and drop-off, ai, media, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Podcast Producer &amp; Content Repurposing</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered podcast production that edits audio, removes filler words, generates show notes, creates clips for social media, and repurposes episodes into blog posts and newsletters.</p>
        ...
        <li class="text-slate-300">AI audio editing (remove ums, ahs, long pauses)</li>
        <li class="text-slate-300">Automatic transcription with speaker detection</li>
        <li class="text-slate-300">AI show notes and summary generation</li>
        <li class="text-slate-300">Social media clip extraction and captioning</li>
        <li class="text-slate-300">Blog post and newsletter generation from episodes</li>
        <li class="text-slate-300">Integration with Spotify, Apple Podcasts, YouTube</li>
        <li class="text-slate-300">Multi-language translation and dubbing</li>
        <li class="text-slate-300">Analytics on listener engagement and drop-off</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Produce podcasts 5x faster</li>
        <li class="text-slate-300">Repurpose every episode into 10+ content pieces</li>
        <li class="text-slate-300">Reach global audiences with AI translation</li>
        <li class="text-slate-300">Grow audience with optimized social clips</li>
      </ul>
        </div>
