...
export const metadata = {
  ...
  alternates: { canonical: '/services/ai-bdr-sdr-2026-6662/' },

  openGraph: {
    title: 'AI BDR SDR | Zion Tech Group',
    description: 'End-to-end ai bdr sdr services: assessment, deployment, and managed operations.',
    url: 'https://ziontechgroup.com/services/ai-bdr-sdr-2026-6662/',
...
export default function ServicePage() {
  return (
    ...
    <JsonLd data={@context: "https://schema.org", @type: "Service", name: "AI BDR SDR | Zion Tech Group", description: "End-to-end ai bdr sdr services: assessment, deployment, and managed operations.", url: "https://ziontechgroup.com/services/ai-bdr-sdr-2026-6662/"} />
