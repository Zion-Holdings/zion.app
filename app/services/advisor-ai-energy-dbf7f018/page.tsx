...
export const metadata: Metadata = {
  title: 'Advisor AI - Energy',
  description: 'The future of energy is here with Advisor AI - Energy. Powered by cutting-edge AI, this platform delivers contract analysis like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/advisor-ai-energy-dbf7f018',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of energy is here with Advisor AI - Energy. Powered by cutting-edge AI, this platform delivers contract analysis like never before.
          </p>
