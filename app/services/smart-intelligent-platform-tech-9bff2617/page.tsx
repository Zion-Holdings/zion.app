...
export const metadata: Metadata = {
  title: 'Smart Intelligent Platform - Tech',
  description: 'Enhance your technology business with Smart Intelligent Platform - Tech. Our solution provides user provisioning with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-intelligent-platform-tech-9bff2617',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Intelligent Platform - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your technology business with Smart Intelligent Platform - Tech. Our solution provides user provisioning with enterprise-grade reliability and security.
          </p>
