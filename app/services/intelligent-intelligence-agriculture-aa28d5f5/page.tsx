...
export const metadata: Metadata = {
  title: 'Intelligent intelligence-agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Intelligent intelligence-agriculture leverages advanced machine learning to deliver testing automa',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-intelligence-agriculture-aa28d5f5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent intelligence-agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Intelligent intelligence-agriculture leverages advanced machine learning to deliver testing automation at scale.
          </p>
