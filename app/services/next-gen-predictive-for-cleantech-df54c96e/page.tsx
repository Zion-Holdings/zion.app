...
export const metadata: Metadata = {
  title: 'Next-Gen Predictive for CLEANTECH',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Predictive for CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for cleantech: Next-Gen Predictive for CLEANTECH. Uses quantum-inspired algorithms to deliver personalization engine at exponential speed.
          </p>
