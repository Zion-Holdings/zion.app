...
export const metadata: Metadata = {
  title: 'Autonomous Manufacturing System - Tech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Manufacturing System - Tech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in technology with Autonomous Manufacturing System - Tech. This AI-powered platform transforms energy management into a competitive advantage.
          </p>
