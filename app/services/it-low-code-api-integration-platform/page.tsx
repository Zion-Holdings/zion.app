...
export const metadata: Metadata = {
  ...
  keywords: '500+ pre-built SaaS connectors, Visual drag-and-drop integration builder, Real-time and batch synchronization, API gateway with rate limiting, Data transformation engine, Error handling with auto retry, Audit logging and compliance, On-premise and cloud deployment, it, technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Low-Code Integration &amp; API Management Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Visual integration platform connecting any application, data source, or API without code. 500+ pre-built SaaS connectors.</p>
        ...
        <li class="text-slate-300">500+ pre-built SaaS connectors</li>
        <li class="text-slate-300">Visual drag-and-drop integration builder</li>
        <li class="text-slate-300">Real-time and batch synchronization</li>
        <li class="text-slate-300">API gateway with rate limiting</li>
        <li class="text-slate-300">Data transformation engine</li>
        <li class="text-slate-300">Error handling with auto retry</li>
        <li class="text-slate-300">Audit logging and compliance</li>
        <li class="text-slate-300">On-premise and cloud deployment</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce integration time by 90%</li>
        <li class="text-slate-300">Connect any system without coding</li>
        <li class="text-slate-300">Eliminate data silos</li>
        <li class="text-slate-300">Scale integrations without engineering</li>
      </ul>
        </div>
