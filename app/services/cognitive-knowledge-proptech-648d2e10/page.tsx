...
export const metadata: Metadata = {
  title: 'Cognitive knowledge-proptech',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive knowledge-proptech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in proptech with Cognitive knowledge-proptech. This AI-powered platform transforms quality prediction into a competitive advantage.
          </p>
