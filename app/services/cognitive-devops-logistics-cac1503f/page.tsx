...
export const metadata: Metadata = {
  title: 'Cognitive devops-logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Cognitive devops-logistics leverages advanced machine learning to deliver user experience at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-devops-logistics-cac1503f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive devops-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Cognitive devops-logistics leverages advanced machine learning to deliver user experience at scale.
          </p>
