...
export const metadata: Metadata = {
  title: 'Orchestrator Next-Gen - Enterprise',
  description: 'Revolutionize enterprise through intelligent automation. Our Orchestrator Next-Gen - Enterprise leverages advanced machine learning to deliver user provisioning',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/orchestrator-next-gen-enterprise-7e88d751',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Orchestrator Next-Gen - Enterprise
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize enterprise through intelligent automation. Our Orchestrator Next-Gen - Enterprise leverages advanced machine learning to deliver user provisioning at scale.
          </p>
