...
export const metadata: Metadata = {
  title: 'Intelligent IoT Device Management Terraform (Cloud)',
  description: 'Intelligent IoT Device Management Terraform (Cloud) is an AI-powered cloud solution that transforms how businesses operate through intelligent automation and re',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent IoT Device Management Terraform (Cloud)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Intelligent IoT Device Management Terraform (Cloud) is an AI-powered cloud solution that transforms how businesses operate through intelligent automation and real-time analytics.
