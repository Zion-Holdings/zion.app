...
export const metadata: Metadata = {
  title: 'AI-Powered Security Information & Event Management',
  description: 'SIEM solution with AI-driven log analysis and threat detection.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-security-information--event-management-dfa0a3b9',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            SIEM solution with AI-driven log analysis and threat detection.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your security operations operations?</p>
