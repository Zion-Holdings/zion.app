...
export const metadata: Metadata = {
  title: 'Intelligent Document for Manufacturing',
  description: 'Enhance your manufacturing business with Intelligent Document for Manufacturing. Our solution provides quantum computing with enterprise-grade reliability and s',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-document-for-manufacturing-33e45d23',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Document for Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your manufacturing business with Intelligent Document for Manufacturing. Our solution provides quantum computing with enterprise-grade reliability and security.
          </p>
