...
export const metadata: Metadata = {
  title: 'Smart Supply for Agriculture',
  description: 'The future of agriculture is here with Smart Supply for Agriculture. Powered by cutting-edge AI, this platform delivers customer service automation like never b',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-supply-for-agriculture-372ff82a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Supply for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of agriculture is here with Smart Supply for Agriculture. Powered by cutting-edge AI, this platform delivers customer service automation like never before.
          </p>
