...
export const metadata: Metadata = {
  title: 'Next-Gen Document for Finance',
  description: 'Transform your finance operations with our Next-Gen Document for Finance. This AI-driven solution automates capacity planning with unprecedented accuracy and ef',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-document-for-finance-52173c94',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Document for Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your finance operations with our Next-Gen Document for Finance. This AI-driven solution automates capacity planning with unprecedented accuracy and efficiency.
          </p>
