...
export const metadata: Metadata = {
  title: 'Security Next-Gen - Telecom',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for telecom: Security Next-Gen - Telecom. Uses quantum-inspired algorithms to deliver project management at exponential speed.
          </p>
