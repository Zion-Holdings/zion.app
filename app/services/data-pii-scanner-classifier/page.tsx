...
export const metadata: Metadata = {
  ...
  keywords: 'Column-level regex + ML pattern detection, Auto-generate dynamic data masking policies, Compliance report (GDPR/CCPA/HIPAA), Alert on PII touching new table/column, data, Manufacturing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">PII Scanner &amp; Classifier</h1>
        <p className="text-lg text-slate-300 mb-8">Column-level PII detection (name/SSN/email/phone/address) across data warehouses, with automatic masking policies and compliance report.</p>
        ...
        <li class="text-slate-300">Column-level regex + ML pattern detection</li>
        <li class="text-slate-300">Auto-generate dynamic data masking policies</li>
        <li class="text-slate-300">Compliance report (GDPR/CCPA/HIPAA)</li>
        <li class="text-slate-300">Alert on PII touching new table/column</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with pii scanner &amp; classifier</li>
