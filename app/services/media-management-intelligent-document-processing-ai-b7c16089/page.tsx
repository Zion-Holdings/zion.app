...
export const metadata: Metadata = {
  ...
  description: 'media management solution for sports & entertainment industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/media-management-intelligent-document-processing-ai-b7c16089',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Media Management Intelligent Document Processing AI
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            media management solution for sports & entertainment industry. Processes invoices, contracts, and forms with 99% accuracy, extracting data and routing documents automatically.
          </p>
