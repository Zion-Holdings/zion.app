...
export const metadata: Metadata = {
  title: 'AI-Powered Capacity Process Mining',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Capacity Process Mining
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated regtech solution: AI-Powered Capacity Process Mining. Combines process discovery with next-gen AI for maximum velocity.
          </p>
