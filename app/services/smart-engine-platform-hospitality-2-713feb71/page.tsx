...
export const metadata: Metadata = {
  title: 'Smart Engine Platform - Hospitality #2',
  description: 'Enhance your hospitality business with Smart Engine Platform - Hospitality #2. Our solution provides risk assessment with enterprise-grade reliability and secur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-engine-platform-hospitality-2-713feb71',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Engine Platform - Hospitality #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your hospitality business with Smart Engine Platform - Hospitality #2. Our solution provides risk assessment with enterprise-grade reliability and security.
          </p>
