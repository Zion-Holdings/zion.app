...
export const metadata: Metadata = {
  title: 'Enterprise Manager Platform - Real-Estate',
  description: 'Enhance your real-estate business with Enterprise Manager Platform - Real-Estate. Our solution provides integration platform with enterprise-grade reliability a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-manager-platform-real-estate-43e7c865',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Manager Platform - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your real-estate business with Enterprise Manager Platform - Real-Estate. Our solution provides integration platform with enterprise-grade reliability and security.
          </p>
