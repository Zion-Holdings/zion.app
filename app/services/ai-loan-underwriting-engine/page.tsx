...
export const metadata: Metadata = {
  ...
  keywords: 'Alternative data credit scoring, Automated income verification, Fraud detection (identity, income), FICO/NMFS compliant decisioning, Adverse action letter generation, Fair lending bias monitoring, ai, Financial Services, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Loan Underwriting &amp; Risk Scoring Engine</h1>
        <p className="text-lg text-slate-300 mb-8">Automate consumer and commercial loan underwriting: alternative data scoring, income verification, fraud detection, and FICO/NMFS-compliant decisioning. Processes applications in 30 seconds.</p>
        ...
        <li class="text-slate-300">Alternative data credit scoring</li>
        <li class="text-slate-300">Automated income verification</li>
        <li class="text-slate-300">Fraud detection (identity, income)</li>
        <li class="text-slate-300">FICO/NMFS compliant decisioning</li>
        <li class="text-slate-300">Adverse action letter generation</li>
        <li class="text-slate-300">Fair lending bias monitoring</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Process loans in 30 seconds</li>
        <li class="text-slate-300">Reduce defaults by 25%</li>
        <li class="text-slate-300">Ensure fair lending compliance</li>
      </ul>
        </div>
