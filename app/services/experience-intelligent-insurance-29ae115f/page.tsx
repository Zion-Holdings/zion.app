...
export const metadata: Metadata = {
  title: 'Experience Intelligent - Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Experience Intelligent - Insurance leverages advanced machine learning to deliver code optimization ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Experience Intelligent - Insurance leverages advanced machine learning to deliver code optimization at scale.
          </p>
