...
export const metadata: Metadata = {
  title: 'Quantum Risk - HEALTHTECH Quantum',
  description: 'Drive innovation in healthtech with Quantum Risk - HEALTHTECH Quantum. This AI-powered platform transforms executive dashboards into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-risk-healthtech-quantum-6feb24e6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Risk - HEALTHTECH Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthtech with Quantum Risk - HEALTHTECH Quantum. This AI-powered platform transforms executive dashboards into a competitive advantage.
          </p>
