...
export const metadata: Metadata = {
  title: 'Cognitive Insights for Transportation',
  description: 'Revolutionize transportation through intelligent automation. Our Cognitive Insights for Transportation leverages advanced machine learning to deliver regulatory',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-insights-for-transportation-f2eb8b64',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Insights for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize transportation through intelligent automation. Our Cognitive Insights for Transportation leverages advanced machine learning to deliver regulatory tracking at scale.
          </p>
