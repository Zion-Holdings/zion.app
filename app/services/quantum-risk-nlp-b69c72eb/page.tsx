...
export const metadata: Metadata = {
  title: 'Quantum Risk NLP',
  description: 'Drive innovation in construction with Quantum Risk NLP. This AI-powered platform transforms budget management into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-risk-nlp-b69c72eb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Quantum Risk NLP. This AI-powered platform transforms budget management into a competitive advantage.
          </p>
