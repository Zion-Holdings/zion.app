...
export const metadata: Metadata = {
  title: 'Autonomous Deep Learning for Transportation',
  description: 'The future of transportation is here with Autonomous Deep Learning for Transportation. Powered by cutting-edge AI, this platform delivers incident response like',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Deep Learning for Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of transportation is here with Autonomous Deep Learning for Transportation. Powered by cutting-edge AI, this platform delivers incident response like never before.
          </p>
