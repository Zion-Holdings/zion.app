...
export const metadata: Metadata = {
  title: 'AI Tactical - Finance Edition',
  description: 'Drive innovation in finance with AI Tactical - Finance Edition. This AI-powered platform transforms process mining into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-tactical-finance-edition-4ccd357b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Tactical - Finance Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in finance with AI Tactical - Finance Edition. This AI-powered platform transforms process mining into a competitive advantage.
          </p>
