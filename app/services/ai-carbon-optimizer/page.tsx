...
export const metadata: Metadata = {
  ...
  keywords: 'Scope 1-3 automatic accounting from bills, APIs, and invoices, Machine learning intensity factors per city, data-centre, and carrier, Priority-ranked action plan generated weekly, ESG/CSRD-ready report PDF and CSV exports, Alerts: budget exceeded, deviation from reduction trajectory, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Carbon Footprint Optimizer</h1>
        <p className="text-lg text-slate-300 mb-8">Automated Scope 1-3 carbon accounting: ingests utility bills, cloud usage, travel itineraries, supplier invoices, and calculates real-time carbon intensity scores with prioritised reduction actions and ESG report-ready outputs.</p>
        ...
        <li class="text-slate-300">Scope 1-3 automatic accounting from bills, APIs, and invoices</li>
        <li class="text-slate-300">Machine learning intensity factors per city, data-centre, and carrier</li>
        <li class="text-slate-300">Priority-ranked action plan generated weekly</li>
        <li class="text-slate-300">ESG/CSRD-ready report PDF and CSV exports</li>
        <li class="text-slate-300">Alerts: budget exceeded, deviation from reduction trajectory</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai carbon footprint optimizer</li>
