...
export const metadata: Metadata = {
  title: 'Automated compliance-energy',
  description: 'Drive innovation in energy with Automated compliance-energy. This AI-powered platform transforms image recognition into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-compliance-energy-a2bbc1ea',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated compliance-energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in energy with Automated compliance-energy. This AI-powered platform transforms image recognition into a competitive advantage.
          </p>
