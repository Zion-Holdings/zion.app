...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time engagement monitoring, AI flight risk prediction, Automated pulse surveys with sentiment analysis, Manager coaching recommendations, Benchmarking against industry standards, Integration with HRIS and communication tools, ai, hr-tech, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Employee Engagement &amp; Retention Platform</h1>
        <p className="text-lg text-slate-300 mb-8">AI platform that measures employee engagement in real-time, predicts flight risk, and recommends retention actions. Pulse surveys, sentiment analysis, and manager coaching.</p>
        ...
        <li class="text-slate-300">Real-time engagement monitoring</li>
        <li class="text-slate-300">AI flight risk prediction</li>
        <li class="text-slate-300">Automated pulse surveys with sentiment analysis</li>
        <li class="text-slate-300">Manager coaching recommendations</li>
        <li class="text-slate-300">Benchmarking against industry standards</li>
        <li class="text-slate-300">Integration with HRIS and communication tools</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce turnover by 25%</li>
        <li class="text-slate-300">Identify at-risk employees 6 months early</li>
        <li class="text-slate-300">Data-driven retention strategies</li>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">$10/employee/mo</p>
