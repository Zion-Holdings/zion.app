...
export const metadata: Metadata = {
  ...
  keywords: 'No-code conversation builder, Multi-language support (50+), Omnichannel deployment (web, WhatsApp, SMS), Human handoff with context, Intent classification, Sentiment analysis, Conversation analytics, Integration with CRM and helpdesk, ai, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Conversational AI Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Build and deploy AI-powered conversational agents for customer service, sales, and internal support. Multi-language, multi-channel, with human handoff and analytics.</p>
        ...
        <li class="text-slate-300">No-code conversation builder</li>
        <li class="text-slate-300">Multi-language support (50+)</li>
        <li class="text-slate-300">Omnichannel deployment (web, WhatsApp, SMS)</li>
        <li class="text-slate-300">Human handoff with context</li>
        <li class="text-slate-300">Intent classification</li>
        <li class="text-slate-300">Sentiment analysis</li>
        <li class="text-slate-300">Conversation analytics</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce support costs by 60%</li>
        <li class="text-slate-300">24/7 automated customer service</li>
        <li class="text-slate-300">Consistent customer experience</li>
        <li class="text-slate-300">Scalable without hiring</li>
      </ul>
        </div>
