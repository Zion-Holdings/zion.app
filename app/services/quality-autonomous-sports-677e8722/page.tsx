...
export const metadata: Metadata = {
  title: 'Quality Autonomous - Sports',
  description: 'Next-generation sports solution: Quality Autonomous - Sports. Combines predictive analytics with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quality-autonomous-sports-677e8722',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quality Autonomous - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation sports solution: Quality Autonomous - Sports. Combines predictive analytics with adaptive intelligence for optimal results.
          </p>
