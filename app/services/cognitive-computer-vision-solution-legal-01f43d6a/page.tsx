...
export const metadata: Metadata = {
  title: 'Cognitive Computer Vision Solution - Legal',
  description: 'Enhance your legal business with Cognitive Computer Vision Solution - Legal. Our solution provides compliance reporting with enterprise-grade reliability and se',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-computer-vision-solution-legal-01f43d6a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Computer Vision Solution - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with Cognitive Computer Vision Solution - Legal. Our solution provides compliance reporting with enterprise-grade reliability and security.
          </p>
