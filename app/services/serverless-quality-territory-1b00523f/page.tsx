...
export const metadata: Metadata = {
  title: 'Serverless Quality Territory',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Serverless Quality Territory
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of technology is here with Serverless Quality Territory. Powered by cutting-edge AI, this platform delivers workflow management like never before.
          </p>
