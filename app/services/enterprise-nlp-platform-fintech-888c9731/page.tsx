...
export const metadata: Metadata = {
  title: 'Enterprise NLP Platform - FINTECH',
  description: 'Revolutionize fintech through intelligent automation. Our Enterprise NLP Platform - FINTECH leverages advanced machine learning to deliver compliance automation',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise NLP Platform - FINTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize fintech through intelligent automation. Our Enterprise NLP Platform - FINTECH leverages advanced machine learning to deliver compliance automation at scale.
          </p>
