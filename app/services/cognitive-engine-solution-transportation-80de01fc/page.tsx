...
export const metadata: Metadata = {
  title: 'Cognitive Engine Solution - Transportation',
  description: 'Next-generation transportation solution: Cognitive Engine Solution - Transportation. Combines personalization engine with adaptive intelligence for optimal resu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-engine-solution-transportation-80de01fc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Engine Solution - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation transportation solution: Cognitive Engine Solution - Transportation. Combines personalization engine with adaptive intelligence for optimal results.
          </p>
