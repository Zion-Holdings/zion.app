...
export const metadata: Metadata = {
  title: 'Intelligent Fraud DevOps',
  description: 'Transform your media operations with our Intelligent Fraud DevOps. This AI-driven solution automates logistics route optimization with unprecedented accuracy an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Fraud DevOps
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your media operations with our Intelligent Fraud DevOps. This AI-driven solution automates logistics route optimization with unprecedented accuracy and efficiency.
          </p>
