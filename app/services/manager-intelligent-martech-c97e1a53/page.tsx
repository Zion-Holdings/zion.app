...
export const metadata: Metadata = {
  title: 'Manager Intelligent - MARTECH',
  description: 'Next-generation martech solution: Manager Intelligent - MARTECH. Combines leave management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/manager-intelligent-martech-c97e1a53',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manager Intelligent - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation martech solution: Manager Intelligent - MARTECH. Combines leave management with adaptive intelligence for optimal results.
          </p>
