...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize legal through intelligent automation. Our Intelligent intelligent-legal leverages advanced machine learning to deliver quality control at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-intelligent-legal-c3583e35',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Intelligent intelligent-legal leverages advanced machine learning to deliver quality control at scale.
          </p>
