      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automated compliance platform that monitors transactions, generates regulatory reports, and flags suspicious activities using advanced ML algorithms.
          </p>
        ...
        <section className="mb-12">
          ...
          <li className="text-gray-300">Regulatory tracking</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">90% faster reporting</li>
          <li className="text-purple-300">Zero compliance misses</li>
          <li className="text-purple-300">Reduced audit time</li>
          </ul>
        </section>
