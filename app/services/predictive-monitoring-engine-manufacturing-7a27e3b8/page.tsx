...
export const metadata: Metadata = {
  ...
  description: 'Quantum leap forward for manufacturing: Predictive Monitoring Engine - Manufacturing. Uses quantum-inspired algorithms to deliver generative ai at exponential s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for manufacturing: Predictive Monitoring Engine - Manufacturing. Uses quantum-inspired algorithms to deliver generative ai at exponential speed.
          </p>
