...
export const metadata: Metadata = {
  title: 'Cognitive Real Estate for Construction',
  description: 'Enhance your construction business with Cognitive Real Estate for Construction. Our solution provides regulatory tracking with enterprise-grade reliability and ',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Real Estate for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Cognitive Real Estate for Construction. Our solution provides regulatory tracking with enterprise-grade reliability and security.
          </p>
