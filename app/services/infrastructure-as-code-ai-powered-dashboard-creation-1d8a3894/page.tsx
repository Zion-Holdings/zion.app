...
export const metadata: Metadata = {
  title: 'Infrastructure as Code AI-Powered Dashboard Creation',
  description: 'AI-powered infrastructure as code solution for bi. Auto-generates dashboards from data patterns and user behavior.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/infrastructure-as-code-ai-powered-dashboard-creation-1d8a3894',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Infrastructure as Code AI-Powered Dashboard Creation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered infrastructure as code solution for bi. Auto-generates dashboards from data patterns and user behavior.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your infrastructure as code operations?</p>
