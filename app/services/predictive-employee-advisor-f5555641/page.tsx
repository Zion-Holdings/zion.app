...
export const metadata: Metadata = {
  title: 'Predictive Employee Advisor',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Employee Advisor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in retail with Predictive Employee Advisor. This AI-powered platform transforms scalability planning into a competitive advantage.
          </p>
