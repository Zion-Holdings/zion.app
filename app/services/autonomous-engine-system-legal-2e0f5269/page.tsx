...
export const metadata: Metadata = {
  title: 'Autonomous Engine System - Legal',
  description: 'Hyper-accelerated legal solution: Autonomous Engine System - Legal. Combines image recognition with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-engine-system-legal-2e0f5269',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Engine System - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated legal solution: Autonomous Engine System - Legal. Combines image recognition with next-gen AI for maximum velocity.
          </p>
