...
export const metadata: Metadata = {
  title: 'Quantum Predictor - Energy Quantum',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Predictor - Energy Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your energy business with Quantum Predictor - Energy Quantum. Our solution provides sentiment analysis with enterprise-grade reliability and security.
          </p>
