...
export const metadata: Metadata = {
  title: 'AI Code - Legal Edition',
  description: 'Enhance your legal business with AI Code - Legal Edition. Our solution provides budget tracking with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-code-legal-edition-b5bb8cb5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Code - Legal Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your legal business with AI Code - Legal Edition. Our solution provides budget tracking with enterprise-grade reliability and security.
          </p>
