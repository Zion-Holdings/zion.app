...
export const metadata: Metadata = {
  title: 'Intelligent Engine for Construction',
  description: 'Unlock unprecedented growth with Intelligent Engine for Construction. This autonomous system provides root cause analysis with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-engine-for-construction-7ea73bf4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Engine for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Intelligent Engine for Construction. This autonomous system provides root cause analysis with zero manual intervention needed.
          </p>
