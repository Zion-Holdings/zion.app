...
export const metadata: Metadata = {
  title: 'AI-Powered Procurement Support',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Procurement Support
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your gaming business with AI-Powered Procurement Support. Our solution provides survey automation with enterprise-grade reliability and security.
          </p>
