...
export const metadata: Metadata = {
  title: 'Enterprise Intelligent Platform - Transportation',
  description: 'Quantum leap forward for transportation: Enterprise Intelligent Platform - Transportation. Uses quantum-inspired algorithms to deliver case management at expone',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Intelligent Platform - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Quantum leap forward for transportation: Enterprise Intelligent Platform - Transportation. Uses quantum-inspired algorithms to deliver case management at exponential speed.
          </p>
