...
export const metadata: Metadata = {
  title: 'Intelligent data-manufacturing',
  description: 'The future of manufacturing is here with Intelligent data-manufacturing. Powered by cutting-edge AI, this platform delivers manufacturing quality control like n',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent data-manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of manufacturing is here with Intelligent data-manufacturing. Powered by cutting-edge AI, this platform delivers manufacturing quality control like never before.
          </p>
