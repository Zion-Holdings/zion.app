...
export const metadata: Metadata = {
  title: 'Quantum Management - Hospitality Quantum',
  description: 'Drive innovation in hospitality with Quantum Management - Hospitality Quantum. This AI-powered platform transforms automation opportunity into a competitive adv',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/quantum-management-hospitality-quantum-00fafbf6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Management - Hospitality Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Quantum Management - Hospitality Quantum. This AI-powered platform transforms automation opportunity into a competitive advantage.
          </p>
