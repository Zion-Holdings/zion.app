...
export const metadata: Metadata = {
  ...
  description: 'process mining solution for faith-based industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/process-mining-ai-sales-lead-scoring-engine-4b4c733c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Process Mining AI Sales Lead Scoring Engine
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            process mining solution for faith-based industry. Scores and prioritizes sales leads in real-time using behavioral data and engagement patterns.
          </p>
