...
export const metadata: Metadata = {
  title: 'Intelligent Data for Telecom',
  description: 'Next-generation telecom solution: Intelligent Data for Telecom. Combines customer insights with adaptive intelligence for optimal results.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Data for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation telecom solution: Intelligent Data for Telecom. Combines customer insights with adaptive intelligence for optimal results.
          </p>
