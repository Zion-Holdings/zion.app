...
export const metadata: Metadata = {
  title: 'Smart Experience Platform - Agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Smart Experience Platform - Agriculture leverages advanced machine learning to deliver healthcare ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-experience-platform-agriculture-e5368666',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Experience Platform - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Smart Experience Platform - Agriculture leverages advanced machine learning to deliver healthcare data analytics at scale.
          </p>
