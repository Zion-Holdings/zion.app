...
export const metadata: Metadata = {
  title: 'Smart Deep Learning Platform - Hospitality',
  description: 'Drive innovation in hospitality with Smart Deep Learning Platform - Hospitality. This AI-powered platform transforms logistics route optimization into a competi',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Deep Learning Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in hospitality with Smart Deep Learning Platform - Hospitality. This AI-powered platform transforms logistics route optimization into a competitive advantage.
          </p>
