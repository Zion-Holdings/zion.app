...
export const metadata: Metadata = {
  title: 'Smart Compliance Platform - Manufacturing',
  description: 'Enhance your manufacturing business with Smart Compliance Platform - Manufacturing. Our solution provides business intelligence with enterprise-grade reliabilit',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Compliance Platform - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your manufacturing business with Smart Compliance Platform - Manufacturing. Our solution provides business intelligence with enterprise-grade reliability and security.
          </p>
