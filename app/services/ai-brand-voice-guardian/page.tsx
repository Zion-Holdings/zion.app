      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Maintain consistent brand voice. AI audits existing content, generates tone guidelines, and rewrites copy in real time to match your brand persona across every channel.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Tone profiling from existing content</li>
            <li className="text-purple-300">✓ Multi-channel voice adapter</li>
            <li className="text-purple-300">✓ Brand guideline document generator</li>
            <li className="text-purple-300">✓ Competitor tone comparison</li>
            <li className="text-purple-300">✓ Real-time style enforcement</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai brand voice guardian</li>
