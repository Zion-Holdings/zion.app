...
export const metadata: Metadata = {
  ...
  keywords: 'Tone profiling from existing content, Multi-channel voice adapter, Brand guideline document generator, Competitor tone comparison, Real-time style enforcement, ai, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Brand Voice Guardian</h1>
        <p className="text-lg text-slate-300 mb-8">Maintain consistent brand voice. AI audits existing content, generates tone guidelines, and rewrites copy in real time to match your brand persona across every channel.</p>
        ...
        <li class="text-slate-300">Tone profiling from existing content</li>
        <li class="text-slate-300">Multi-channel voice adapter</li>
        <li class="text-slate-300">Brand guideline document generator</li>
        <li class="text-slate-300">Competitor tone comparison</li>
        <li class="text-slate-300">Real-time style enforcement</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai brand voice guardian</li>
