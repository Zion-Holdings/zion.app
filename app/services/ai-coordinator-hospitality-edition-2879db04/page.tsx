...
export const metadata: Metadata = {
  title: 'AI Coordinator - Hospitality Edition',
  description: 'Next-generation hospitality solution: AI Coordinator - Hospitality Edition. Combines pipeline management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-coordinator-hospitality-edition-2879db04',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Coordinator - Hospitality Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: AI Coordinator - Hospitality Edition. Combines pipeline management with adaptive intelligence for optimal results.
          </p>
