...
export const metadata: Metadata = {
  title: 'AI/IT Deep Learning Suite - MARTECH',
  description: 'Hyper-accelerated martech solution: AI/IT Deep Learning Suite - MARTECH. Combines serverless orchestration with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-deep-learning-suite-martech-ac267e4b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Deep Learning Suite - MARTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated martech solution: AI/IT Deep Learning Suite - MARTECH. Combines serverless orchestration with next-gen AI for maximum velocity.
          </p>
