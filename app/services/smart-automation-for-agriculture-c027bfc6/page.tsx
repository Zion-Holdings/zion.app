...
export const metadata: Metadata = {
  title: 'Smart Automation for Agriculture',
  description: 'Revolutionize agriculture through intelligent automation. Our Smart Automation for Agriculture leverages advanced machine learning to deliver resource optimizat',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-automation-for-agriculture-c027bfc6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Smart Automation for Agriculture leverages advanced machine learning to deliver resource optimization at scale.
          </p>
