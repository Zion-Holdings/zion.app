...
export const metadata: Metadata = {
  title: 'Smart Supply for Technology',
  description: 'Transform your technology operations with our Smart Supply for Technology. This AI-driven solution automates risk assessment with unprecedented accuracy and eff',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-supply-for-technology-ec534775',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Supply for Technology
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your technology operations with our Smart Supply for Technology. This AI-driven solution automates risk assessment with unprecedented accuracy and efficiency.
          </p>
