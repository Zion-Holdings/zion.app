export const metadata = {
  ...
  description: "Zion Tech Group delivers AI Engine - Insurance Edition with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/services/ai-engine-insurance-edition-c3bdb541/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>AI Engine - Insurance Edition</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers AI Engine - Insurance Edition with measurable outcomes.
      </p>
