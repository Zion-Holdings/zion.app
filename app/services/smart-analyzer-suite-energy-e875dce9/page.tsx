...
export const metadata: Metadata = {
  title: 'Smart Analyzer Suite - Energy',
  description: 'Optimize your energy workflows with Smart Analyzer Suite - Energy. This intelligent platform delivers compliance reporting through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-analyzer-suite-energy-e875dce9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Analyzer Suite - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your energy workflows with Smart Analyzer Suite - Energy. This intelligent platform delivers compliance reporting through advanced automation and AI.
          </p>
