...
export const metadata: Metadata = {
  title: 'Self-Optimizing finance-hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Self-Optimizing finance-hospitality leverages advanced machine learning to deliver threat detectio',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing finance-hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Self-Optimizing finance-hospitality leverages advanced machine learning to deliver threat detection at scale.
          </p>
