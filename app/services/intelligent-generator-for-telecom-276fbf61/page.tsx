...
export const metadata: Metadata = {
  title: 'Intelligent Generator for Telecom',
  description: 'Drive innovation in telecom with Intelligent Generator for Telecom. This AI-powered platform transforms content moderation into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-generator-for-telecom-276fbf61',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Generator for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in telecom with Intelligent Generator for Telecom. This AI-powered platform transforms content moderation into a competitive advantage.
          </p>
