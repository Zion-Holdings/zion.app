...
export const metadata: Metadata = {
  title: 'Next-Gen Real Estate - Enterprise',
  description: 'Unlock unprecedented growth with Next-Gen Real Estate - Enterprise. This autonomous system provides executive dashboards with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-real-estate-enterprise-cf661f63',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Real Estate - Enterprise
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Next-Gen Real Estate - Enterprise. This autonomous system provides executive dashboards with zero manual intervention needed.
          </p>
