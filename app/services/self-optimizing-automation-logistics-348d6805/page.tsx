...
export const metadata: Metadata = {
  title: 'Self-Optimizing automation-logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Self-Optimizing automation-logistics leverages advanced machine learning to deliver document process',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing automation-logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Self-Optimizing automation-logistics leverages advanced machine learning to deliver document processing at scale.
          </p>
