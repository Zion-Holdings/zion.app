...
export const metadata: Metadata = {
  title: 'AI-Powered Cloud Security Posture',
  description: 'Continuous cloud security posture management with compliance and threat detection.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-cloud-security-posture-ce6d537b',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Continuous cloud security posture management with compliance and threat detection.
          </p>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your cloud security operations?</p>
