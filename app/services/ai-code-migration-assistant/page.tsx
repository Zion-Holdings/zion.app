      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ AST-level code transformation (no regex hacks)</li>
            <li className="text-purple-300">✓ Breaking-change detection + PR diff per file</li>
            <li className="text-purple-300">✓ Regression test suite auto-generated per migration</li>
            <li className="text-purple-300">✓ Manual-approval gate per PR (human-in-loop)</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai code migration assistant</li>
