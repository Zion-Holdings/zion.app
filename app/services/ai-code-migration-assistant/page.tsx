    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Migrate framework major-version in days not weeks</li>
            <li>AST transform = safe, not search-replace</li>
            <li>Regression test = confidence before merging</li>
            <li>PR per file = audit trail of every change</li>
          </ul>
        </div>
