...
export const metadata: Metadata = {
  ...
  keywords: 'AST-level code transformation (no regex hacks), Breaking-change detection + PR diff per file, Regression test suite auto-generated per migration, Manual-approval gate per PR (human-in-loop), ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Code Migration Assistant</h1>
        <p className="text-lg text-slate-300 mb-8">Automated major-version migration: React 18→19, Python 3.9→3.12, Rails 6→7, with AST-wrapped diff PR and regression test suit.</p>
        ...
        <li class="text-slate-300">AST-level code transformation (no regex hacks)</li>
        <li class="text-slate-300">Breaking-change detection + PR diff per file</li>
        <li class="text-slate-300">Regression test suite auto-generated per migration</li>
        <li class="text-slate-300">Manual-approval gate per PR (human-in-loop)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai code migration assistant</li>
