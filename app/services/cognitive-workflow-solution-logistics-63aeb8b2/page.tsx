...
export const metadata: Metadata = {
  title: 'Cognitive Workflow Solution - Logistics',
  description: 'Drive innovation in logistics with Cognitive Workflow Solution - Logistics. This AI-powered platform transforms anomaly detection into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-workflow-solution-logistics-63aeb8b2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Workflow Solution - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with Cognitive Workflow Solution - Logistics. This AI-powered platform transforms anomaly detection into a competitive advantage.
          </p>
