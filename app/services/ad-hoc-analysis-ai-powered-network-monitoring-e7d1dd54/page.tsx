...
export const metadata: Metadata = {
  title: 'Ad-hoc Analysis AI-Powered Network Monitoring',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Ad-hoc Analysis AI-Powered Network Monitoring
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered ad-hoc analysis solution for it operations. Real-time network monitoring with anomaly detection and automated alerts.
          </p>
