...
export const metadata: Metadata = {
  title: 'Autonomous Energy Finance',
  description: 'Transform your proptech operations with our Autonomous Energy Finance. This AI-driven solution automates image recognition with unprecedented accuracy and effic',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-energy-finance-9b07c916',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Energy Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your proptech operations with our Autonomous Energy Finance. This AI-driven solution automates image recognition with unprecedented accuracy and efficiency.
          </p>
