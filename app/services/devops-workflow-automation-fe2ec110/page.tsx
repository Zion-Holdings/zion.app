...
export const metadata: Metadata = {
  ...
  description: 'End-to-end DevOps automation platform that streamlines CI/CD pipelines, infrastructure as code, and deployment orchestration with AI-assisted optimization.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/devops-workflow-automation-fe2ec110',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            End-to-end DevOps automation platform that streamlines CI/CD pipelines, infrastructure as code, and deployment orchestration with AI-assisted optimization.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Pipeline automation</li>
          <li className="text-gray-300">IaC management</li>
          <li className="text-gray-300">Deployment orchestration</li>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">70% faster deployments</li>
          <li className="text-purple-300">95% pipeline reliability</li>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <section className="mt-16 bg-slate-900 rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-6">Ready to transform your devops operations?</p>
