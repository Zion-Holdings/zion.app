...
export const metadata: Metadata = {
  title: 'Suite Smart - Tech',
  description: 'The future of technology is here with Suite Smart - Tech. Powered by cutting-edge AI, this platform delivers quality control like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/suite-smart-tech-ea3c7705',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of technology is here with Suite Smart - Tech. Powered by cutting-edge AI, this platform delivers quality control like never before.
          </p>
