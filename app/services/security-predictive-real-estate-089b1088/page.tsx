...
export const metadata: Metadata = {
  title: 'Security Predictive - Real-Estate',
  description: 'Revolutionize real-estate through intelligent automation. Our Security Predictive - Real-Estate leverages advanced machine learning to deliver financial risk ma',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/security-predictive-real-estate-089b1088',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Security Predictive - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our Security Predictive - Real-Estate leverages advanced machine learning to deliver financial risk management at scale.
          </p>
