...
export const metadata: Metadata = {
  title: 'Intelligent Document Security',
  description: 'The future of real-estate is here with Intelligent Document Security. Powered by cutting-edge AI, this platform delivers compliance reporting like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-document-security-7f5881db',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of real-estate is here with Intelligent Document Security. Powered by cutting-edge AI, this platform delivers compliance reporting like never before.
          </p>
