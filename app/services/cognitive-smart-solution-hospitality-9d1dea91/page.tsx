...
export const metadata: Metadata = {
  title: 'Cognitive Smart Solution - Hospitality',
  description: 'Optimize your hospitality workflows with Cognitive Smart Solution - Hospitality. This intelligent platform delivers territory management through advanced automa',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-smart-solution-hospitality-9d1dea91',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Smart Solution - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your hospitality workflows with Cognitive Smart Solution - Hospitality. This intelligent platform delivers territory management through advanced automation and AI.
          </p>
