...
export const metadata: Metadata = {
  title: 'AI-Powered Asset Liability Management',
  description: 'Automates asset-liability management for financial institutions.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-asset-liability-management-38e00bfd',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Asset Liability Management
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Automates asset-liability management for financial institutions.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">ALM automation</li>
          <li className="text-gray-300">Risk matching</li>
          <li className="text-gray-300">Interest rate optimization</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">25% better ALM</li>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$34999</p>
          <ul className="space-y-2 mb-4">
