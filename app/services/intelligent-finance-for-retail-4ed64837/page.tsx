...
export const metadata: Metadata = {
  title: 'Intelligent Finance for Retail',
  description: 'The future of retail is here with Intelligent Finance for Retail. Powered by cutting-edge AI, this platform delivers sales process optimization like never befor',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-finance-for-retail-4ed64837',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Finance for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Intelligent Finance for Retail. Powered by cutting-edge AI, this platform delivers sales process optimization like never before.
          </p>
