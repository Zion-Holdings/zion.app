...
export const metadata: Metadata = {
  title: 'Scale-up Automated - REGTECH',
  description: 'Unlock unprecedented growth with Scale-up Automated - REGTECH. This autonomous system provides vendor management with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/scale-up-automated-regtech-69dfe561',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Scale-up Automated - REGTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Scale-up Automated - REGTECH. This autonomous system provides vendor management with zero manual intervention needed.
          </p>
