...
export const metadata: Metadata = {
  ...
  description: 'data visualization solution for retail industry. Identifies at-risk customers before they churn using behavioral patterns and engagement metrics.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-visualization-ai-customer-churn-prediction-8e710f81',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            data visualization solution for retail industry. Identifies at-risk customers before they churn using behavioral patterns and engagement metrics.
          </p>
