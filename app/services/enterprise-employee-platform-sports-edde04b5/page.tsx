...
export const metadata: Metadata = {
  title: 'Enterprise Employee Platform - Sports',
  description: 'Enhance your sports business with Enterprise Employee Platform - Sports. Our solution provides resource optimization with enterprise-grade reliability and secur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-employee-platform-sports-edde04b5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Employee Platform - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your sports business with Enterprise Employee Platform - Sports. Our solution provides resource optimization with enterprise-grade reliability and security.
          </p>
