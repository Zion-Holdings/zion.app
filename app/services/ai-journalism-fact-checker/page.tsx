    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          AI Real-Time Fact-Checking for Journalism
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          Verify claims in real-time against 100M+ sources: statement verification, source credibility scoring, bias detection, citation suggestions. Used by 50+ newsroom
        </p>
