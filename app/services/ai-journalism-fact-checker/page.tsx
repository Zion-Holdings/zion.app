...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time claim verification, Source credibility scoring, Bias & framing detection, Citation suggestion engine, Deepfake detection, Multi-language verification, ai, Media & Entertainment, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Real-Time Fact-Checking for Journalism</h1>
        <p className="text-lg text-slate-300 mb-8">Verify claims in real-time against 100M+ sources: statement verification, source credibility scoring, bias detection, and citation suggestions. Used by 50+ newsrooms.</p>
        
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          <div class="flex flex-wrap gap-2 mb-4">
            <span class="text-xs px-3 py-1 bg-purple-900/30 rounded-full text-purple-300">ai</span>
            <span class="text-xs px-3 py-1 bg-blue-900/30 rounded-full text-blue-300">Media &amp; Entertainment</span>
          </div>
          <h2 class="text-2xl font-semibold mb-4 text-white">Key Features</h2>
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Real-time claim verification</li>
        <li class="text-slate-300">Source credibility scoring</li>
        <li class="text-slate-300">Bias &amp; framing detection</li>
        <li class="text-slate-300">Citation suggestion engine</li>
        <li class="text-slate-300">Deepfake detection</li>
        <li class="text-slate-300">Multi-language verification</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Verify in seconds not hours</li>
        <li class="text-slate-300">Never miss a false claim</li>
        <li class="text-slate-300">Maintain editorial integrity</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center border-2 border-purple-500">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">249</p>
