...
export const metadata: Metadata = {
  ...
  keywords: 'Semantic search case law+statutes+regs, Source attribution + citation per answer, Law change alerts per jurisdiction, Memo export per research session, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Legal Research Engine</h1>
        <p className="text-lg text-slate-300 mb-8">LLM legal research: semantic search across case law statutes regulations SEC filings patents. Produces cited answers source attribution alerts law changes per jurisdiction.</p>
        ...
        <li class="text-slate-300">Semantic search case law+statutes+regs</li>
        <li class="text-slate-300">Source attribution + citation per answer</li>
        <li class="text-slate-300">Law change alerts per jurisdiction</li>
        <li class="text-slate-300">Memo export per research session</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai legal research engine</li>
