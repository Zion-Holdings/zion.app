...
export const metadata: Metadata = {
  title: 'Cognitive Intelligence Solution - Energy',
  description: 'Optimize your energy workflows with Cognitive Intelligence Solution - Energy. This intelligent platform delivers audit trail management through advanced automat',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-intelligence-solution-energy-1ce5ec1b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Intelligence Solution - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your energy workflows with Cognitive Intelligence Solution - Energy. This intelligent platform delivers audit trail management through advanced automation and AI.
          </p>
