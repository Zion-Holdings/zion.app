...
export const metadata: Metadata = {
  title: 'Suite Smart - Logistics',
  description: 'Revolutionize logistics through intelligent automation. Our Suite Smart - Logistics leverages advanced machine learning to deliver inventory management at scale',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/suite-smart-logistics-b338d449',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Suite Smart - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize logistics through intelligent automation. Our Suite Smart - Logistics leverages advanced machine learning to deliver inventory management at scale.
          </p>
