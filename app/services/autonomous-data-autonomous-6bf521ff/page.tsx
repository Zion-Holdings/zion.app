...
export const metadata: Metadata = {
  title: 'Autonomous Data Autonomous',
  description: 'Transform your insurance operations with our Autonomous Data Autonomous. This AI-driven solution provides intelligent automation with unprecedented accuracy and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-data-autonomous-6bf521ff',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our Autonomous Data Autonomous. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
