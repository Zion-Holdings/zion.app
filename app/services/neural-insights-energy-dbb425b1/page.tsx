export const metadata = {
  title: "Neural insights-energy",
  description: "Zion Tech Group delivers Neural insights-energy with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/services/neural-insights-energy-dbb425b1/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>Neural insights-energy</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers Neural insights-energy with measurable outcomes.
      </p>
