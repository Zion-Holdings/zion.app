...
export const metadata: Metadata = {
  title: 'Process Mining AI Financial Planning & Analysis',
  description: 'process mining solution for healthcare industry. Generates financial forecasts, budget plans, and performance analyses using machine learning models.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/process-mining-ai-financial-planning--analysis-7afde313',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Process Mining AI Financial Planning & Analysis
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            process mining solution for healthcare industry. Generates financial forecasts, budget plans, and performance analyses using machine learning models.
          </p>
