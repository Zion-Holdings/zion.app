...
export const metadata: Metadata = {
  ...
  keywords: 'Behavioral biometrics (keystroke dynamics, mouse movements), Device & location risk scoring, Step-up authentication for anomalies, FIDO2/WebAuthn integration, Compliance: NIST 800-63B, PSD2 SCA, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Powered Passwordless Authentication</h1>
        <p className="text-lg text-slate-300 mb-8">Behavioral biometrics &amp; risk-based authentication: continuous fraud detection using device fingerprinting, typing patterns, and anomaly detection without passwords.</p>
        ...
        <li class="text-slate-300">Behavioral biometrics (keystroke dynamics, mouse movements)</li>
        <li class="text-slate-300">Device &amp; location risk scoring</li>
        <li class="text-slate-300">Step-up authentication for anomalies</li>
        <li class="text-slate-300">FIDO2/WebAuthn integration</li>
        <li class="text-slate-300">Compliance: NIST 800-63B, PSD2 SCA</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai-powered passwordless authentication</li>
