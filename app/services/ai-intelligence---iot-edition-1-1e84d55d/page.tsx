...
export const metadata: Metadata = {
  title: 'AI Intelligence - Iot Edition #1',
  description: 'Transform your iot operations with our AI Intelligence - Iot Edition #1. This AI-driven solution automates logistics route optimization with unprecedented accur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-intelligence---iot-edition-1-1e84d55d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Intelligence - Iot Edition #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your iot operations with our AI Intelligence - Iot Edition #1. This AI-driven solution automates logistics route optimization with unprecedented accuracy and efficiency.
          </p>
