...
export const metadata: Metadata = {
  ...
  description: 'Computer vision for X-rays, MRIs, CT scans with radiologist-level accuracy.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-medical-imaging-analysis-d18bd36c',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Computer vision for X-rays, MRIs, CT scans with radiologist-level accuracy.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Image analysis</li>
          <li className="text-gray-300">Abnormality detection</li>
          <li className="text-gray-300">Tumor detection</li>
          </ul>
        </section>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$11999</p>
          <ul className="space-y-2 mb-4">
