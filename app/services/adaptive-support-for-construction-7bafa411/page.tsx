...
export const metadata: Metadata = {
  title: 'Adaptive Support for Construction',
  description: 'Transform your construction operations with our Adaptive Support for Construction. This AI-driven solution automates maintenance scheduling with unprecedented a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Support for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Adaptive Support for Construction. This AI-driven solution automates maintenance scheduling with unprecedented accuracy and efficiency.
          </p>
