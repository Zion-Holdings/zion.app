...
export const metadata: Metadata = {
  title: 'Enterprise Revenue Platform - Energy',
  description: 'Unlock unprecedented growth with Enterprise Revenue Platform - Energy. This autonomous system provides leave management with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-revenue-platform-energy-b2be5518',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Revenue Platform - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Enterprise Revenue Platform - Energy. This autonomous system provides leave management with zero manual intervention needed.
          </p>
