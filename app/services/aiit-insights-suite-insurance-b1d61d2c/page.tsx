...
export const metadata: Metadata = {
  title: 'AI/IT Insights Suite - Insurance',
  description: 'The future of insurance is here with AI/IT Insights Suite - Insurance. Powered by cutting-edge AI, this platform delivers cost reduction like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-insights-suite-insurance-b1d61d2c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Insights Suite - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with AI/IT Insights Suite - Insurance. Powered by cutting-edge AI, this platform delivers cost reduction like never before.
          </p>
