...
export const metadata: Metadata = {
  ...
  keywords: 'Real-time 3D scene reconstruction and understanding, AI-driven gesture and gaze tracking, Spatial audio processing and acoustic mapping, Immersive analytics dashboard creation, Cross-platform AR/VR deployment (Vision Pro, Quest, HoloLens), ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Spatial Computing &amp; AR/VR Analytics</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered spatial computing platform for augmented and virtual reality experiences — 3D scene understanding, gesture recognition, and immersive analytics.</p>
        ...
        <li class="text-slate-300">Real-time 3D scene reconstruction and understanding</li>
        <li class="text-slate-300">AI-driven gesture and gaze tracking</li>
        <li class="text-slate-300">Spatial audio processing and acoustic mapping</li>
        <li class="text-slate-300">Immersive analytics dashboard creation</li>
        <li class="text-slate-300">Cross-platform AR/VR deployment (Vision Pro, Quest, HoloLens)</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai spatial computing &amp; ar/vr analytics</li>
