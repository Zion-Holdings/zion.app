...
export const metadata: Metadata = {
  title: 'Smart Supply Platform - Legal #1',
  description: 'Revolutionize legal through intelligent automation. Our Smart Supply Platform - Legal #1 leverages advanced machine learning to deliver case management at scale',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-supply-platform-legal-1-34cf03bd',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Supply Platform - Legal #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Smart Supply Platform - Legal #1 leverages advanced machine learning to deliver case management at scale.
          </p>
