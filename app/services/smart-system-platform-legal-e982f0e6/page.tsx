...
export const metadata: Metadata = {
  title: 'Smart System Platform - Legal',
  description: 'Unlock unprecedented growth with Smart System Platform - Legal. This autonomous system provides content moderation with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-system-platform-legal-e982f0e6',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart System Platform - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart System Platform - Legal. This autonomous system provides content moderation with zero manual intervention needed.
          </p>
