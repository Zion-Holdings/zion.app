...
export const metadata: Metadata = {
  title: 'Manufacturing Intelligent - Manufacturing',
  description: 'Next-generation manufacturing solution: Manufacturing Intelligent - Manufacturing. Combines AI-powered insights with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/manufacturing-intelligent-manufacturing-a4f4a047',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Next-generation manufacturing solution: Manufacturing Intelligent - Manufacturing. Combines AI-powered insights with adaptive intelligence for optimal results.
          </p>
