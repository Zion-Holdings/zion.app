...
export const metadata: Metadata = {
  title: 'Autonomous generator-cybersecurity',
  description: 'Revolutionize cybersecurity through intelligent automation. Our Autonomous generator-cybersecurity leverages advanced machine learning to deliver quality assura',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-generator-cybersecurity-9212c53e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous generator-cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cybersecurity through intelligent automation. Our Autonomous generator-cybersecurity leverages advanced machine learning to deliver quality assurance at scale.
          </p>
