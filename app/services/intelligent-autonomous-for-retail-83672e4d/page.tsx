...
export const metadata: Metadata = {
  title: 'Intelligent Autonomous for Retail',
  description: 'Enhance your retail business with Intelligent Autonomous for Retail. Our solution provides net promoter score with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-autonomous-for-retail-83672e4d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Autonomous for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your retail business with Intelligent Autonomous for Retail. Our solution provides net promoter score with enterprise-grade reliability and security.
          </p>
