...
export const metadata: Metadata = {
  title: 'Data AI - Legal',
  description: 'Transform your legal operations with our Data AI - Legal. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-ai-legal-64bc32ad',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Data AI - Legal. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
