...
export const metadata: Metadata = {
  title: 'Loyalty Program Management AI Financial Planning & Analysis',
  description: 'loyalty program management solution for media industry. Generates financial forecasts, budget plans, and performance analyses using machine learning models.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/loyalty-program-management-ai-financial-planning--analysis-180b0efb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Loyalty Program Management AI Financial Planning & Analysis
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            loyalty program management solution for media industry. Generates financial forecasts, budget plans, and performance analyses using machine learning models.
          </p>
