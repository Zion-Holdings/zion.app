...
export const metadata: Metadata = {
  title: 'Smart Orchestrator Platform - Construction',
  description: 'Drive innovation in construction with Smart Orchestrator Platform - Construction. This AI-powered platform transforms quality assurance into a competitive advan',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-orchestrator-platform-construction-fd0de6a8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Orchestrator Platform - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Smart Orchestrator Platform - Construction. This AI-powered platform transforms quality assurance into a competitive advantage.
          </p>
