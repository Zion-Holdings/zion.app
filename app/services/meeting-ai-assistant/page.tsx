...
export const metadata: Metadata = {
  ...
  keywords: 'Cloud recording & real-time transcription, Speaker identification & diarization, Action item extraction with assignees, Decision log & key quote highlights, Sync to Notion/Confluence/ClickUp, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Meeting AI Assistant (Record, Transcribe, Summarize)</h1>
        <p className="text-lg text-slate-300 mb-8">Automatic meeting assistant that records, transcribes with speaker ID, generates action items, decisions, and summaries; integrates with Zoom, Teams, Google Meet.</p>
        ...
        <li class="text-slate-300">Cloud recording &amp; real-time transcription</li>
        <li class="text-slate-300">Speaker identification &amp; diarization</li>
        <li class="text-slate-300">Action item extraction with assignees</li>
        <li class="text-slate-300">Decision log &amp; key quote highlights</li>
        <li class="text-slate-300">Sync to Notion/Confluence/ClickUp</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with meeting ai assistant (record, transcribe, summarize)</li>
