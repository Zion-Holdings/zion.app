...
export const metadata: Metadata = {
  title: 'Next-Gen Process for Retail',
  description: 'Revolutionize retail through intelligent automation. Our Next-Gen Process for Retail leverages advanced machine learning to deliver logistics route optimization',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-process-for-retail-1ad7e9a5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Process for Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize retail through intelligent automation. Our Next-Gen Process for Retail leverages advanced machine learning to deliver logistics route optimization at scale.
          </p>
