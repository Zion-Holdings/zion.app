...
export const metadata: Metadata = {
  title: 'Management Smart - Logistics',
  description: 'The future of logistics is here with Management Smart - Logistics. Powered by cutting-edge AI, this platform delivers process automation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/management-smart-logistics-ca965ad7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Management Smart - Logistics. Powered by cutting-edge AI, this platform delivers process automation like never before.
          </p>
