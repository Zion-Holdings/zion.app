...
export const metadata: Metadata = {
  title: 'Predictive Supply Engine - Construction',
  description: 'Optimize your construction workflows with Predictive Supply Engine - Construction. This intelligent platform delivers image recognition through advanced automat',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-supply-engine-construction-64b5ca5d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Supply Engine - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your construction workflows with Predictive Supply Engine - Construction. This intelligent platform delivers image recognition through advanced automation and AI.
          </p>
