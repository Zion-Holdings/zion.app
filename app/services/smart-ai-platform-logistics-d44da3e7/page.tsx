...
export const metadata: Metadata = {
  title: 'Smart AI Platform - Logistics',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart AI Platform - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of logistics is here with Smart AI Platform - Logistics. Powered by cutting-edge AI, this platform delivers content generation like never before.
          </p>
