...
export const metadata: Metadata = {
  title: 'Smart DevOps Platform - Agriculture',
  description: 'Drive innovation in agriculture with Smart DevOps Platform - Agriculture. This AI-powered platform transforms invoice processing into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-devops-platform-agriculture-4a9c585b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart DevOps Platform - Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in agriculture with Smart DevOps Platform - Agriculture. This AI-powered platform transforms invoice processing into a competitive advantage.
          </p>
