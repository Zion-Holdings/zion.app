...
export const metadata: Metadata = {
  title: 'Intelligent Compliance for Healthcare',
  description: 'Drive innovation in healthcare with Intelligent Compliance for Healthcare. This AI-powered platform transforms training optimization into a competitive advantag',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-compliance-for-healthcare-37ca73f3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Compliance for Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with Intelligent Compliance for Healthcare. This AI-powered platform transforms training optimization into a competitive advantage.
          </p>
