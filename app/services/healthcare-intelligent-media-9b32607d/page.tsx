...
export const metadata: Metadata = {
  title: 'Healthcare Intelligent - Media',
  description: 'Enhance your media business with Healthcare Intelligent - Media. Our solution provides customer insights with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/healthcare-intelligent-media-9b32607d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Healthcare Intelligent - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your media business with Healthcare Intelligent - Media. Our solution provides customer insights with enterprise-grade reliability and security.
          </p>
