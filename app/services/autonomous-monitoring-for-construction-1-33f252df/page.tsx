...
export const metadata: Metadata = {
  title: 'Autonomous Monitoring for Construction #1',
  description: 'Next-generation construction solution: Autonomous Monitoring for Construction #1. Combines threat detection with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-monitoring-for-construction-1-33f252df',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Monitoring for Construction #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation construction solution: Autonomous Monitoring for Construction #1. Combines threat detection with adaptive intelligence for optimal results.
          </p>
