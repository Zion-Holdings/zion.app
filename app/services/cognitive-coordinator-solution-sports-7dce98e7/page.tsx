...
export const metadata: Metadata = {
  title: 'Cognitive Coordinator Solution - Sports',
  description: 'Revolutionize sports through intelligent automation. Our Cognitive Coordinator Solution - Sports leverages advanced machine learning to deliver healthcare data ',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-coordinator-solution-sports-7dce98e7',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Coordinator Solution - Sports
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize sports through intelligent automation. Our Cognitive Coordinator Solution - Sports leverages advanced machine learning to deliver healthcare data analytics at scale.
          </p>
