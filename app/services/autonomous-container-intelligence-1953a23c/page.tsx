...
export const metadata: Metadata = {
  ...
  description: 'Enhance your insurance business with Autonomous Container Intelligence. Our solution provides automation opportunity with enterprise-grade reliability and secur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-container-intelligence-1953a23c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Container Intelligence
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Autonomous Container Intelligence. Our solution provides automation opportunity with enterprise-grade reliability and security.
          </p>
