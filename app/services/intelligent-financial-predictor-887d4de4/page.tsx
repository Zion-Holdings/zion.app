...
export const metadata: Metadata = {
  title: 'Intelligent Financial Predictor',
  description: 'Revolutionize proptech through intelligent automation. Our Intelligent Financial Predictor leverages advanced machine learning to deliver security monitoring at',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Financial Predictor
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our Intelligent Financial Predictor leverages advanced machine learning to deliver security monitoring at scale.
          </p>
