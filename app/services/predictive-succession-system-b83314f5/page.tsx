...
export const metadata: Metadata = {
  title: 'Predictive Succession System',
  description: 'Drive innovation in insurance with Predictive Succession System. This AI-powered platform transforms recommendation system into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-succession-system-b83314f5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Succession System
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in insurance with Predictive Succession System. This AI-powered platform transforms recommendation system into a competitive advantage.
          </p>
