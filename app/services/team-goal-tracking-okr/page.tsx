...
export const metadata: Metadata = {
  ...
  keywords: 'OKR management, Progress dashboards, 1:1 meeting agendas, Weekly check-ins, Performance analytics, Slack/Teams/Jira integration, Custom OKR templates, Executive reporting, micro-saas, Enterprise, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Team Goal &amp; OKR Tracking Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Align your team with transparent goal tracking, OKR management, and progress dashboards. Includes 1:1 meeting agendas, weekly check-ins, and performance analytics. Integrates with Slack, Teams, and Jira.</p>
        ...
        <li class="text-slate-300">OKR management</li>
        <li class="text-slate-300">Progress dashboards</li>
        <li class="text-slate-300">1:1 meeting agendas</li>
        <li class="text-slate-300">Weekly check-ins</li>
        <li class="text-slate-300">Performance analytics</li>
        <li class="text-slate-300">Slack/Teams/Jira integration</li>
        <li class="text-slate-300">Custom OKR templates</li>
        <li class="text-slate-300">Executive reporting</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">35% improvement in goal achievement</li>
        <li class="text-slate-300">Increased team alignment</li>
        <li class="text-slate-300">Data-driven performance reviews</li>
      </ul>
        </div>
        ...
        <div class="border border-purple-500/30 rounded-xl p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-slate-800 rounded-lg p-4 text-center">
              ...
              <p class="text-2xl font-bold text-purple-400 mb-2">79</p>
