...
export const metadata = {
  ...
  description: "Align your team with transparent goal tracking, OKR management, and progress dashboards. Includes 1:1 meeting agendas, weekly check-ins, and performance analyti",
  alternates: {
