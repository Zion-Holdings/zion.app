...
export const metadata: Metadata = {
  title: 'Cognitive engine-construction',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive engine-construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in construction with Cognitive engine-construction. This AI-powered platform transforms budget tracking into a competitive advantage.
          </p>
