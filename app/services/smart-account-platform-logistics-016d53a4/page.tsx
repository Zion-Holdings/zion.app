...
export const metadata: Metadata = {
  title: 'Smart Account Platform - Logistics',
  description: 'Transform your logistics operations with our Smart Account Platform - Logistics. This AI-driven solution automates network optimization with unprecedented accur',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-account-platform-logistics-016d53a4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Account Platform - Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your logistics operations with our Smart Account Platform - Logistics. This AI-driven solution automates network optimization with unprecedented accuracy and efficiency.
          </p>
