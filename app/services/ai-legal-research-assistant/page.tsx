...
export const metadata: Metadata = {
  ...
  keywords: 'Natural language legal research across jurisdictions, Case law analysis with relevance scoring, Automated legal memo generation, Contract clause risk analysis, Regulatory change monitoring, Case outcome prediction based on historical data, Integration with Westlaw, LexisNexis, Clio, Citation checking and brief analysis, ai, legal-tech, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Legal Research &amp; Case Analysis</h1>
        <p className="text-lg text-slate-300 mb-8">AI legal research assistant that analyzes case law, statutes, and regulations in seconds. Generate legal memos, find relevant precedents, and predict case outcomes.</p>
        ...
        <li class="text-slate-300">Natural language legal research across jurisdictions</li>
        <li class="text-slate-300">Case law analysis with relevance scoring</li>
        <li class="text-slate-300">Automated legal memo generation</li>
        <li class="text-slate-300">Contract clause risk analysis</li>
        <li class="text-slate-300">Regulatory change monitoring</li>
        <li class="text-slate-300">Case outcome prediction based on historical data</li>
        <li class="text-slate-300">Integration with Westlaw, LexisNexis, Clio</li>
        <li class="text-slate-300">Citation checking and brief analysis</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Research 10x faster than manual methods</li>
        <li class="text-slate-300">Find relevant precedents others miss</li>
        <li class="text-slate-300">Reduce legal research costs by 70%</li>
        <li class="text-slate-300">Predict case outcomes with 85% accuracy</li>
      </ul>
        </div>
