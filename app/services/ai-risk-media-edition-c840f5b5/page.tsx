...
export const metadata: Metadata = {
  title: 'AI Risk - Media Edition',
  description: 'Drive innovation in media with AI Risk - Media Edition. This AI-powered platform transforms content generation into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-risk-media-edition-c840f5b5',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Risk - Media Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in media with AI Risk - Media Edition. This AI-powered platform transforms content generation into a competitive advantage.
          </p>
