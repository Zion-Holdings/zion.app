      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of technology is here with Coordinator AI - Tech. Powered by cutting-edge AI, this platform delivers performance monitoring like never before.
          </p>
