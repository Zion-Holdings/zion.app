...
export const metadata: Metadata = {
  ...
  keywords: 'Autonomous web search and source gathering, Multi-source synthesis with citations, Literature review generation, Competitive and market research reports, Fact verification and source quality scoring, Custom research templates and formatting, Export to PDF, DOCX, and LaTeX, ai, Research, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Autonomous Research Agent</h1>
        <p className="text-lg text-slate-300 mb-8">Autonomous AI research agent that searches, reads, synthesizes, and cites sources on any topic. Generates literature reviews, competitive analyses, and market research reports.</p>
        ...
        <li class="text-slate-300">Autonomous web search and source gathering</li>
        <li class="text-slate-300">Multi-source synthesis with citations</li>
        <li class="text-slate-300">Literature review generation</li>
        <li class="text-slate-300">Competitive and market research reports</li>
        <li class="text-slate-300">Fact verification and source quality scoring</li>
        <li class="text-slate-300">Custom research templates and formatting</li>
        <li class="text-slate-300">Export to PDF, DOCX, and LaTeX</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Produce research reports in hours, not weeks</li>
        <li class="text-slate-300">Every claim backed by cited sources</li>
        <li class="text-slate-300">Fact verification prevents errors</li>
        <li class="text-slate-300">Custom templates match your brand</li>
      </ul>
        </div>
