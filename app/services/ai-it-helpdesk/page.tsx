...
export const metadata: Metadata = {
  ...
  keywords: 'Automated ticket creation & routing, Knowledge base search with semantic understanding, Password reset & MFA enrollment automation, Software request fulfillment workflows, Hardware troubleshooting decision trees, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI IT Helpdesk &amp; Support</h1>
        <p className="text-lg text-slate-300 mb-8">Automated Tier-1 IT support for employees: password resets, software installs, device troubleshooting, and knowledge base search.</p>
        ...
        <li class="text-slate-300">Automated ticket creation &amp; routing</li>
        <li class="text-slate-300">Knowledge base search with semantic understanding</li>
        <li class="text-slate-300">Password reset &amp; MFA enrollment automation</li>
        <li class="text-slate-300">Software request fulfillment workflows</li>
        <li class="text-slate-300">Hardware troubleshooting decision trees</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai it helpdesk &amp; support</li>
