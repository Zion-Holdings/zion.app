      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Automated Tier-1 IT support for employees: password resets, software installs, device troubleshooting, and knowledge base search.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Automated ticket creation & routing</li>
            <li className="text-purple-300">✓ Knowledge base search with semantic understanding</li>
            <li className="text-purple-300">✓ Password reset & MFA enrollment automation</li>
            <li className="text-purple-300">✓ Software request fulfillment workflows</li>
            <li className="text-purple-300">✓ Hardware troubleshooting decision trees</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai it helpdesk & support</li>
