...
export const metadata: Metadata = {
  title: 'Automated Image Coordinator',
  description: 'Revolutionize proptech through intelligent automation. Our Automated Image Coordinator leverages advanced machine learning to deliver threat detection at scale.',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated Image Coordinator
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize proptech through intelligent automation. Our Automated Image Coordinator leverages advanced machine learning to deliver threat detection at scale.
          </p>
