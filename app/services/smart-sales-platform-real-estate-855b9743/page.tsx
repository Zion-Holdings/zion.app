...
export const metadata: Metadata = {
  title: 'Smart Sales Platform - Real-Estate',
  description: 'Revolutionize real-estate through intelligent automation. Our Smart Sales Platform - Real-Estate leverages advanced machine learning to deliver business continu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-sales-platform-real-estate-855b9743',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Sales Platform - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our Smart Sales Platform - Real-Estate leverages advanced machine learning to deliver business continuity at scale.
          </p>
