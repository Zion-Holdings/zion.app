...
export const metadata: Metadata = {
  title: 'Cognitive Marketing Solution - Legal',
  description: 'Revolutionize legal through intelligent automation. Our Cognitive Marketing Solution - Legal leverages advanced machine learning to deliver healthcare data anal',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-marketing-solution-legal-faf9e6e2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Marketing Solution - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Cognitive Marketing Solution - Legal leverages advanced machine learning to deliver healthcare data analytics at scale.
          </p>
