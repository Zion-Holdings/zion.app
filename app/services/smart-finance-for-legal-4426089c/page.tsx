...
export const metadata: Metadata = {
  title: 'Smart Finance for Legal',
  description: 'Revolutionize legal through intelligent automation. Our Smart Finance for Legal leverages advanced machine learning to deliver user experience at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-finance-for-legal-4426089c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Finance for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Smart Finance for Legal leverages advanced machine learning to deliver user experience at scale.
          </p>
