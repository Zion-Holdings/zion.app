...
export const metadata: Metadata = {
  title: 'Supply Chain Visibility AI-Powered Code Review Assistant',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Supply Chain Visibility AI-Powered Code Review Assistant
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered supply chain visibility solution for development. Automatically reviews code changes for quality, security, and best practices.
          </p>
