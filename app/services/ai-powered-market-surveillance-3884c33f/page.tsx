...
export const metadata: Metadata = {
  title: 'AI-Powered Market Surveillance',
  description: 'Real-time market surveillance for trading anomalies and manipulation.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-market-surveillance-3884c33f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Real-time market surveillance for trading anomalies and manipulation.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">Market surveillance</li>
          <li className="text-gray-300">Anomaly detection</li>
          <li className="text-gray-300">Manipulation detection</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">90% faster detection</li>
