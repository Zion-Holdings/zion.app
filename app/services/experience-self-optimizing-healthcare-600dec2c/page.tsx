...
export const metadata: Metadata = {
  title: 'Experience Self-Optimizing - Healthcare',
  description: 'Next-generation healthcare solution: Experience Self-Optimizing - Healthcare. Combines healthcare data analytics with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/experience-self-optimizing-healthcare-600dec2c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Experience Self-Optimizing - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation healthcare solution: Experience Self-Optimizing - Healthcare. Combines healthcare data analytics with adaptive intelligence for optimal results.
          </p>
