...
export const metadata: Metadata = {
  title: 'Deep Learning Director',
  description: 'Transform your energy operations with our Deep Learning Director. This analytics solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/deep-learning-director-7af98b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Deep Learning Director
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Deep Learning Director. This analytics solution delivers unprecedented automation and intelligence.
          </p>
