...
export const metadata: Metadata = {
  ...
  keywords: 'Clause extraction matching against 200+ contract type templates, Auto renewal calendar plus amendment tracker with approval chain, Benchmark pricing and T&Cs against anonymised peer market medians, Obligation tracker with reminders at 90, 30, and 7 days pre-renewal, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Contract Lifecycle Intelligence</h1>
        <p className="text-lg text-slate-300 mb-8">AI contract lifecycle management: extract clauses and dates, auto-flag risk, renewal calendar, benchmark against market terms, amendment tracker across 200+ contract types.</p>
        ...
        <li class="text-slate-300">Clause extraction matching against 200+ contract type templates</li>
        <li class="text-slate-300">Auto renewal calendar plus amendment tracker with approval chain</li>
        <li class="text-slate-300">Benchmark pricing and T&amp;Cs against anonymised peer market medians</li>
        <li class="text-slate-300">Obligation tracker with reminders at 90, 30, and 7 days pre-renewal</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with contract lifecycle intelligence</li>
