...
export const metadata: Metadata = {
  ...
  description: 'Drive innovation in logistics with Autonomous Advisor System - Logistics. This AI-powered platform transforms process automation into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-advisor-system-logistics-8a435dbb',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in logistics with Autonomous Advisor System - Logistics. This AI-powered platform transforms process automation into a competitive advantage.
          </p>
