...
export const metadata: Metadata = {
  title: 'Next-Gen Data for Logistics',
  description: 'Hyper-accelerated logistics solution: Next-Gen Data for Logistics. Combines model interpretability with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-data-for-logistics-1ce98b4e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Data for Logistics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated logistics solution: Next-Gen Data for Logistics. Combines model interpretability with next-gen AI for maximum velocity.
          </p>
