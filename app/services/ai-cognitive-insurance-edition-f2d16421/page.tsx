...
export const metadata: Metadata = {
  title: 'AI Cognitive - Insurance Edition',
  description: 'Transform your insurance operations with our AI Cognitive - Insurance Edition. This AI-driven solution automates network optimization with unprecedented accurac',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-cognitive-insurance-edition-f2d16421',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Cognitive - Insurance Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your insurance operations with our AI Cognitive - Insurance Edition. This AI-driven solution automates network optimization with unprecedented accuracy and efficiency.
          </p>
