...
export const metadata: Metadata = {
  title: 'Smart Platform Platform - Construction #1',
  description: 'Revolutionize construction through intelligent automation. Our Smart Platform Platform - Construction #1 leverages advanced machine learning to deliver scenario',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-platform-platform-construction-1-9c8d5a04',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Platform Platform - Construction #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Smart Platform Platform - Construction #1 leverages advanced machine learning to deliver scenario planning at scale.
          </p>
