...
export const metadata: Metadata = {
  title: 'Engine Autonomous - Retail',
  description: 'The future of retail is here with Engine Autonomous - Retail. Powered by cutting-edge AI, this platform delivers fraud prevention like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/engine-autonomous-retail-9d172de3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Engine Autonomous - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of retail is here with Engine Autonomous - Retail. Powered by cutting-edge AI, this platform delivers fraud prevention like never before.
          </p>
