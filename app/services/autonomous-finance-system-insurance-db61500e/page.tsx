...
export const metadata: Metadata = {
  title: 'Autonomous Finance System - Insurance',
  description: 'Enhance your insurance business with Autonomous Finance System - Insurance. Our solution provides succession planning with enterprise-grade reliability and secu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-finance-system-insurance-db61500e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Finance System - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Autonomous Finance System - Insurance. Our solution provides succession planning with enterprise-grade reliability and security.
          </p>
