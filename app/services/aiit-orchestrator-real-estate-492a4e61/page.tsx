...
export const metadata: Metadata = {
  title: 'AI/IT orchestrator-real-estate',
  description: 'Transform your real-estate operations with our AI/IT orchestrator-real-estate. This AI-driven solution automates feedback collection with unprecedented accuracy',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-orchestrator-real-estate-492a4e61',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT orchestrator-real-estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our AI/IT orchestrator-real-estate. This AI-driven solution automates feedback collection with unprecedented accuracy and efficiency.
          </p>
