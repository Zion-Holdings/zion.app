...
export const metadata: Metadata = {
  title: 'Smart Process Mining Platform - Legal #1',
  description: 'Transform your legal operations with our Smart Process Mining Platform - Legal #1. This AI-driven solution automates business continuity with unprecedented accu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-process-mining-platform-legal-1-fe85e833',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Process Mining Platform - Legal #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Smart Process Mining Platform - Legal #1. This AI-driven solution automates business continuity with unprecedented accuracy and efficiency.
          </p>
