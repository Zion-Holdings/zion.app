...
export const metadata: Metadata = {
  title: 'Cognitive finance-media',
  description: 'The future of media is here with Cognitive finance-media. Powered by cutting-edge AI, this platform delivers container orchestration like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-finance-media-7509fbb3',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive finance-media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of media is here with Cognitive finance-media. Powered by cutting-edge AI, this platform delivers container orchestration like never before.
          </p>
