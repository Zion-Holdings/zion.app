...
export const metadata = {
  ...
  description: "Lightweight AI-powered applicant tracking system for SMBs. Smart resume parsing, candidate scoring, interview scheduling, and offer management — all in one affo",
  alternates: {
