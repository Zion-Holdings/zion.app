...
export const metadata: Metadata = {
  ...
  description: 'Real-time fraud detection for financial transactions and user behavior.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-fraud-detection-ddd20ca1',
  },

export const metadata = {
  title: "AI-Powered Fraud Detection - Zion Tech Group",
  description: "Real-time fraud detection for financial transactions and user behavior.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-fraud-detection-ddd20ca1`
  }
  ...
  return (
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Real-time fraud detection for financial transactions and user behavior.
          </p>
    ...
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">AI-Powered Fraud Detection</h1>
        <p className="text-lg text-gray-300 mb-8">Real-time fraud detection for financial transactions and user behavior.</p>
