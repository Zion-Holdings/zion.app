  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Invoice &amp; Purchase Order Processing</h1>
        <p className="text-lg text-slate-300 mb-8">AI-powered invoice + PO processing pipeline: scans, OCR, vendor matching via payment history, line-item validation vs. PO, three-way match against GRN, GL-code auto-suggestion, ERP posting stub, and exception-routing for unmatched documents.</p>
        ...
        <li class="text-slate-300">Multi-format OCR: scanned PDF, email attachment, vendor portal, API, paper mail with routing</li>
        <li class="text-slate-300">Three-way match: invoice vs. PO vs. goods-received note auto-compared per line item</li>
        <li class="text-slate-300">GL-code suggestion: vendor + line-item category ML classification with override audit trail</li>
        <li class="text-slate-300">Exception routing: unmatched → human worker queue with one-click approve/reject/edit</li>
        <li class="text-slate-300">ERP posting API stub: NetSuite, QuickBooks, Sage, Xero, Workday all pre-wired</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with invoice &amp; purchase order processing</li>
