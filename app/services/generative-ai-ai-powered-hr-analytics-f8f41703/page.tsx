...
export const metadata: Metadata = {
  title: 'Generative AI AI-Powered HR Analytics',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Generative AI AI-Powered HR Analytics
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered generative ai solution for hr. Predictive analytics for employee performance, retention, and recruitment.
          </p>
