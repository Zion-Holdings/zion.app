...
export const metadata: Metadata = {
  title: 'Intelligent Revenue for Real-Estate',
  description: 'Next-generation real-estate solution: Intelligent Revenue for Real-Estate. Combines supply chain with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-revenue-for-real-estate-f3083908',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Revenue for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation real-estate solution: Intelligent Revenue for Real-Estate. Combines supply chain with adaptive intelligence for optimal results.
          </p>
