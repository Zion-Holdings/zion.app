...
export const metadata: Metadata = {
  ...
  description: 'Revolutionize agriculture through intelligent automation. Our Autonomous Cognitive System - Agriculture leverages advanced machine learning to deliver regulator',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-cognitive-system-agriculture-d74c6c89',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize agriculture through intelligent automation. Our Autonomous Cognitive System - Agriculture leverages advanced machine learning to deliver regulatory tracking at scale.
          </p>
