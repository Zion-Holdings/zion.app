...
export const metadata: Metadata = {
  title: 'Enterprise Document Platform - CLEANTECH',
  description: 'Enhance your cleantech business with Enterprise Document Platform - CLEANTECH. Our solution provides social media monitoring with enterprise-grade reliability a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-document-platform-cleantech-2f61b65d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Document Platform - CLEANTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your cleantech business with Enterprise Document Platform - CLEANTECH. Our solution provides social media monitoring with enterprise-grade reliability and security.
          </p>
