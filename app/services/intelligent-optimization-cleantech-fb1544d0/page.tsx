...
export const metadata: Metadata = {
  title: 'Intelligent optimization-cleantech',
  description: 'Optimize your cleantech workflows with Intelligent optimization-cleantech. This intelligent platform delivers procurement automation through advanced automation',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-optimization-cleantech-fb1544d0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent optimization-cleantech
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your cleantech workflows with Intelligent optimization-cleantech. This intelligent platform delivers procurement automation through advanced automation and AI.
          </p>
