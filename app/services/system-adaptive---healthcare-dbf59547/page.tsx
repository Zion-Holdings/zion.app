...
export const metadata: Metadata = {
  title: 'System Adaptive - Healthcare',
  description: 'Revolutionize healthcare through intelligent automation. Our System Adaptive - Healthcare leverages advanced machine learning to deliver process automation at s',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            System Adaptive - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our System Adaptive - Healthcare leverages advanced machine learning to deliver process automation at scale.
          </p>
