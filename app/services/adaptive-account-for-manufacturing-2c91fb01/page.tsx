...
export const metadata: Metadata = {
  title: 'Adaptive Account for Manufacturing',
  description: 'Future-proof your manufacturing with Adaptive Account for Manufacturing. Our autonomous solution handles sales process optimization end-to-end without human int',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Account for Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your manufacturing with Adaptive Account for Manufacturing. Our autonomous solution handles sales process optimization end-to-end without human intervention.
          </p>
