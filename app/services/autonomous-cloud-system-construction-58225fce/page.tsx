...
export const metadata: Metadata = {
  title: 'Autonomous Cloud System - Construction',
  description: 'Revolutionize construction through intelligent automation. Our Autonomous Cloud System - Construction leverages advanced machine learning to deliver risk assess',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Cloud System - Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Autonomous Cloud System - Construction leverages advanced machine learning to deliver risk assessment at scale.
          </p>
