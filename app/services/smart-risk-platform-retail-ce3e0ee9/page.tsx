...
export const metadata: Metadata = {
  title: 'Smart Risk Platform - Retail',
  description: 'Unlock unprecedented growth with Smart Risk Platform - Retail. This autonomous system provides market intelligence with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-risk-platform-retail-ce3e0ee9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Risk Platform - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Smart Risk Platform - Retail. This autonomous system provides market intelligence with zero manual intervention needed.
          </p>
