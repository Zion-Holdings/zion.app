...
export const metadata: Metadata = {
  title: 'Autonomous Healthcare Insights',
  description: 'Next-generation manufacturing solution: Autonomous Healthcare Insights. Combines risk assessment with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-healthcare-insights-77c21e42',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Healthcare Insights
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation manufacturing solution: Autonomous Healthcare Insights. Combines risk assessment with adaptive intelligence for optimal results.
          </p>
