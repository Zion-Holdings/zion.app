...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-analytics-platform-for-retail-bb614ea1',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Advanced retail analytics platform leveraging machine learning to Demand forecasting, pricing optimization, customer segmentation. Provides real-time insights and predictive capabilities for strategic decision-making.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">48% reduction in operational costs</li>
          <li className="text-purple-300">Process 37% faster with automation</li>
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$273</p>
          <ul className="space-y-2 mb-4">
        ...
        <div className="bg-slate-800 rounded-xl p-6 border border-purple-400">
          ...
          <p className="text-3xl font-bold text-purple-300 mb-4">$478</p>
          <ul className="space-y-2 mb-4">
