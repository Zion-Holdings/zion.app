...
export const metadata: Metadata = {
  ...
  description: 'Computer vision system that detects defects on production lines with 99.9% accuracy.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-quality-inspection-system-45c1e87c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Computer vision system that detects defects on production lines with 99.9% accuracy.
          </p>
