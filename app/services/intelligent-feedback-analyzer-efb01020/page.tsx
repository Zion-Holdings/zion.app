...
export const metadata: Metadata = {
  title: 'Intelligent Feedback Analyzer',
  description: 'Enhance your construction business with Intelligent Feedback Analyzer. Our solution provides access management with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-feedback-analyzer-efb01020',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Intelligent Feedback Analyzer. Our solution provides access management with enterprise-grade reliability and security.
          </p>
