...
export const metadata: Metadata = {
  title: 'AI/IT Customer Suite - Hospitality',
  description: 'The future of hospitality is here with AI/IT Customer Suite - Hospitality. Powered by cutting-edge AI, this platform delivers project management like never befo',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-customer-suite-hospitality-757a7503',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Customer Suite - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with AI/IT Customer Suite - Hospitality. Powered by cutting-edge AI, this platform delivers project management like never before.
          </p>
