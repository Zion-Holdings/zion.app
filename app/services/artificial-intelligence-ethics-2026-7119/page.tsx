...
export const metadata = {
  title: 'Artificial Intelligence Ethics | Zion Tech Group',
  description: 'End-to-end artificial intelligence ethics services: assessment, deployment, and managed operations.',
  alternates: { canonical: '/services/artificial-intelligence-ethics-2026-7119/' },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <h1 className="text-4xl font-bold text-white mb-4">Artificial Intelligence Ethics</h1>
        <p className="text-slate-300 text-lg leading-relaxed max-w-3xl mb-10">
          End-to-end artificial intelligence ethics services: assessment, deployment, and managed operations.
        </p>
