...
export const metadata: Metadata = {
  title: 'Advisor Intelligent - Iot',
  description: 'Next-generation iot solution: Advisor Intelligent - Iot. Combines supply chain with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/advisor-intelligent---iot-b97639a8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Advisor Intelligent - Iot
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation iot solution: Advisor Intelligent - Iot. Combines supply chain with adaptive intelligence for optimal results.
          </p>
