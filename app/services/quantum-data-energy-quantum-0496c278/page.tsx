...
export const metadata: Metadata = {
  title: 'Quantum Data - Energy Quantum',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Quantum Data - Energy Quantum
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated energy solution: Quantum Data - Energy Quantum. Combines compliance automation with next-gen AI for maximum velocity.
          </p>
