...
export const metadata: Metadata = {
  title: 'Autonomous Smart System - Insurance #1',
  description: 'Enhance your insurance business with Autonomous Smart System - Insurance #1. Our solution provides customer journey mapping with enterprise-grade reliability an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-smart-system-insurance-1-de9a23d8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Smart System - Insurance #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Autonomous Smart System - Insurance #1. Our solution provides customer journey mapping with enterprise-grade reliability and security.
          </p>
