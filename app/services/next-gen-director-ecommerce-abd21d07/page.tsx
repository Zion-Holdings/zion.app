...
export const metadata: Metadata = {
  title: 'Next-Gen Director - Ecommerce',
  description: 'Transform your ecommerce operations with our Next-Gen Director - Ecommerce. This AI-driven solution automates net promoter score with unprecedented accuracy and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-director-ecommerce-abd21d07',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Director - Ecommerce
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your ecommerce operations with our Next-Gen Director - Ecommerce. This AI-driven solution automates net promoter score with unprecedented accuracy and efficiency.
          </p>
