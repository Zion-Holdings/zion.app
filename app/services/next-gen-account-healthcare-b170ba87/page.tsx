...
export const metadata: Metadata = {
  title: 'Next-Gen Account - Healthcare',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Account - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with Next-Gen Account - Healthcare. Our solution provides renewal prediction with enterprise-grade reliability and security.
          </p>
