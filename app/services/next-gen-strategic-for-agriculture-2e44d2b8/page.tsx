...
export const metadata: Metadata = {
  title: 'Next-Gen Strategic for Agriculture',
  description: 'Enhance your agriculture business with Next-Gen Strategic for Agriculture. Our solution provides fraud prevention with enterprise-grade reliability and security',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-strategic-for-agriculture-2e44d2b8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Strategic for Agriculture
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your agriculture business with Next-Gen Strategic for Agriculture. Our solution provides fraud prevention with enterprise-grade reliability and security.
          </p>
