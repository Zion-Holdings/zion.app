...
export const metadata: Metadata = {
  title: 'Neural Cognitive - Media',
  description: 'Revolutionize media through intelligent automation. Our Neural Cognitive - Media leverages advanced machine learning to deliver enterprise-grade insights at sca',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Neural Cognitive - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize media through intelligent automation. Our Neural Cognitive - Media leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
