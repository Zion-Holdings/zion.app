...
export const metadata: Metadata = {
  ...
  keywords: 'Zero-shot voice clone (30 sec sample), 80+ language prosody matching, Emotion + pacing per brand voice, Batch production for script libraries, ai, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Voice Clone + Text-to-Speech Engine</h1>
        <p className="text-lg text-slate-300 mb-8">Zero-shot voice clone (30 sec sample) prosody matching across 80+ languages: reads any script with brand tone for narration audiobooks courses voice at scale.</p>
        ...
        <li class="text-slate-300">Zero-shot voice clone (30 sec sample)</li>
        <li class="text-slate-300">80+ language prosody matching</li>
        <li class="text-slate-300">Emotion + pacing per brand voice</li>
        <li class="text-slate-300">Batch production for script libraries</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai voice clone + text-to-speech engine</li>
