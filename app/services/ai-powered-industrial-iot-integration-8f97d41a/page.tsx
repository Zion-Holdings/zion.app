...
export const metadata: Metadata = {
  title: 'AI-Powered Industrial IoT Integration',
  description: 'Integrates industrial IoT with AI analytics and automation.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-industrial-iot-integration-8f97d41a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Industrial IoT Integration
          </h1>
