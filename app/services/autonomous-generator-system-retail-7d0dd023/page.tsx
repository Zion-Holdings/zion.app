...
export const metadata: Metadata = {
  title: 'Autonomous Generator System - Retail',
  description: 'Next-generation retail solution: Autonomous Generator System - Retail. Combines security monitoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-generator-system-retail-7d0dd023',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Generator System - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation retail solution: Autonomous Generator System - Retail. Combines security monitoring with adaptive intelligence for optimal results.
          </p>
