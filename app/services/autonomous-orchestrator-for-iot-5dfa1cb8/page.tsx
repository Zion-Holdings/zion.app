...
export const metadata: Metadata = {
  title: 'Autonomous Orchestrator for Iot',
  description: 'Transform your iot operations with our Autonomous Orchestrator for Iot. This AI-driven solution automates energy management with unprecedented accuracy and effi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-orchestrator-for-iot-5dfa1cb8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Orchestrator for Iot
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your iot operations with our Autonomous Orchestrator for Iot. This AI-driven solution automates energy management with unprecedented accuracy and efficiency.
          </p>
