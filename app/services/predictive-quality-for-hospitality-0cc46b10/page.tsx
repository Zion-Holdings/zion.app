...
export const metadata: Metadata = {
  title: 'Predictive Quality for Hospitality',
  description: 'Unlock unprecedented growth with Predictive Quality for Hospitality. This autonomous system provides supply chain with zero manual intervention needed.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/predictive-quality-for-hospitality-0cc46b10',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Predictive Quality for Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Unlock unprecedented growth with Predictive Quality for Hospitality. This autonomous system provides supply chain with zero manual intervention needed.
          </p>
