...
export const metadata: Metadata = {
  title: 'Intelligent Tactical for Cybersecurity',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Tactical for Cybersecurity
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your cybersecurity operations with our Intelligent Tactical for Cybersecurity. This AI-driven solution automates budget management with unprecedented accuracy and efficiency.
          </p>
