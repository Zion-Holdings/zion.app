...
export const metadata: Metadata = {
  title: 'Cognitive Cloud for Real-Estate',
  description: 'Revolutionize real-estate through intelligent automation. Our Cognitive Cloud for Real-Estate leverages advanced machine learning to deliver user provisioning a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-cloud-for-real-estate-c5a2f510',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Cloud for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our Cognitive Cloud for Real-Estate leverages advanced machine learning to deliver user provisioning at scale.
          </p>
