...
export const metadata: Metadata = {
  title: 'AI/IT Workflow Suite - TECHNOLOGY',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Workflow Suite - TECHNOLOGY
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of technology is here with AI/IT Workflow Suite - TECHNOLOGY. Powered by cutting-edge AI, this platform delivers case management like never before.
          </p>
