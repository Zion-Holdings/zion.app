...
export const metadata: Metadata = {
  title: 'Smart Analytics for Telecom',
  description: 'Revolutionize telecom through intelligent automation. Our Smart Analytics for Telecom leverages advanced machine learning to deliver data processing at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-analytics-for-telecom-a2d18ecf',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Analytics for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize telecom through intelligent automation. Our Smart Analytics for Telecom leverages advanced machine learning to deliver data processing at scale.
          </p>
