...
export const metadata: Metadata = {
  title: 'Smart Fraud Platform - Media',
  description: 'Transform media with Smart Fraud Platform - Media - the intelligent automation platform that learns, adapts, and delivers 10x results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-fraud-platform-media-9acd9380',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Fraud Platform - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform media with Smart Fraud Platform - Media - the intelligent automation platform that learns, adapts, and delivers 10x results.
          </p>
