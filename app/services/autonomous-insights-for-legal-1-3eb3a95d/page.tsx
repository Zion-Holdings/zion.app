...
export const metadata: Metadata = {
  title: 'Autonomous Insights for Legal #1',
  description: 'The future of legal is here with Autonomous Insights for Legal #1. Powered by cutting-edge AI, this platform delivers process automation like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-insights-for-legal-1-3eb3a95d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Insights for Legal #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of legal is here with Autonomous Insights for Legal #1. Powered by cutting-edge AI, this platform delivers process automation like never before.
          </p>
