...
export const metadata: Metadata = {
  ...
  keywords: 'K-means + hierarchical clustering models, Dynamic segment recalculation (daily/weekly), Persona profiles with predictive scores, Export to CRM/CDP (Segment, HubSpot), Campaign performance tracking per segment, ai, Marketing, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI-Driven Customer Segmentation &amp; Persona Engine</h1>
        <p className="text-lg text-slate-300 mb-8">Cluster your customer base into meaningful personas using behavioral data, purchase history, and engagement patterns; deliver personalized marketing automatically.</p>
        ...
        <li class="text-slate-300">K-means + hierarchical clustering models</li>
        <li class="text-slate-300">Dynamic segment recalculation (daily/weekly)</li>
        <li class="text-slate-300">Persona profiles with predictive scores</li>
        <li class="text-slate-300">Export to CRM/CDP (Segment, HubSpot)</li>
        <li class="text-slate-300">Campaign performance tracking per segment</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai-driven customer segmentation &amp; persona engine</li>
