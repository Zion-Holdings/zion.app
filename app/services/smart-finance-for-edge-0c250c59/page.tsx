...
export const metadata: Metadata = {
  title: 'Smart Finance for Edge',
  description: 'Next-generation edge solution: Smart Finance for Edge. Combines maintenance scheduling with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-finance-for-edge-0c250c59',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Finance for Edge
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation edge solution: Smart Finance for Edge. Combines maintenance scheduling with adaptive intelligence for optimal results.
          </p>
