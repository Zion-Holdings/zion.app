...
export const metadata: Metadata = {
  title: 'Smart Financial Marketing',
  description: 'Transform your transportation operations with our Smart Financial Marketing. This AI-driven solution provides intelligent automation with unprecedented accuracy',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-financial-marketing-a50da270',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Financial Marketing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your transportation operations with our Smart Financial Marketing. This AI-driven solution provides intelligent automation with unprecedented accuracy and efficiency.
          </p>
