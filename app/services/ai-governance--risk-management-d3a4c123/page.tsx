...
export const metadata: Metadata = {
  ...
  description: 'AI risk governance, bias review, model inventory, and approval workflows for regulated AI deployments.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-governance--risk-management-d3a4c123',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            AI risk governance, bias review, model inventory, and approval workflows for regulated AI deployments.
          </p>
        ...
        <section className="mb-12">
          ...
          <ul className="grid md:grid-cols-2 gap-4">
                      <li className="text-gray-300">AI model inventory and risk classification</li>
          <li className="text-gray-300">Bias review and fairness testing</li>
          <li className="text-gray-300">Governance approval workflows</li>
          <li className="text-gray-300">Regulatory documentation and evidence</li>
          </ul>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3">
                      <li className="text-purple-300">Ship AI with accountable guardrails</li>
          <li className="text-purple-300">Reduce regulatory objection risk</li>
          <li className="text-purple-300">Create audit-ready AI evidence quickly</li>
          </ul>
        </section>
