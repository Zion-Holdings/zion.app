...
export const metadata: Metadata = {
  title: 'AI-Powered insights-energy',
  description: 'Revolutionize energy through intelligent automation. Our AI-Powered insights-energy leverages advanced machine learning to deliver sales process optimization at',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered insights-energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our AI-Powered insights-energy leverages advanced machine learning to deliver sales process optimization at scale.
          </p>
