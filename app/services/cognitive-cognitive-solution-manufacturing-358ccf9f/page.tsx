...
export const metadata: Metadata = {
  title: 'Cognitive Cognitive Solution - Manufacturing',
  description: 'Transform your manufacturing operations with our Cognitive Cognitive Solution - Manufacturing. This AI-driven solution automates survey automation with unpreced',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Cognitive Solution - Manufacturing
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your manufacturing operations with our Cognitive Cognitive Solution - Manufacturing. This AI-driven solution automates survey automation with unprecedented accuracy and efficiency.
          </p>
