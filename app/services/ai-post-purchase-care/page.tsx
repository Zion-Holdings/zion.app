...
export const metadata: Metadata = {
  ...
  keywords: 'Order and shipment tracking, Proactive outreach on delays, RMA and return automation, Self-service resolution portal, SLA monitoring and alerting, ai, E-Commerce, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Post-Purchase Customer Care Agent</h1>
        <p className="text-lg text-slate-300 mb-8">Proactive post-purchase support agent that monitors order status, delivery delays, and product issues — resolving 80% of cases before human escalation.</p>
        ...
        <li class="text-slate-300">Order and shipment tracking</li>
        <li class="text-slate-300">Proactive outreach on delays</li>
        <li class="text-slate-300">RMA and return automation</li>
        <li class="text-slate-300">Self-service resolution portal</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai post-purchase customer care agent</li>
