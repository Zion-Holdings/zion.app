...
export const metadata: Metadata = {
  title: 'Next-Gen DevOps for Real-Estate',
  description: 'Transform your real-estate operations with our Next-Gen DevOps for Real-Estate. This AI-driven solution automates workflow automation with unprecedented accurac',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen DevOps for Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your real-estate operations with our Next-Gen DevOps for Real-Estate. This AI-driven solution automates workflow automation with unprecedented accuracy and efficiency.
          </p>
