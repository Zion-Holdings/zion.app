...
export const metadata: Metadata = {
  title: 'Autonomous Cognitive System - Healthcare',
  description: 'Optimize your healthcare workflows with Autonomous Cognitive System - Healthcare. This intelligent platform delivers lead scoring through advanced automation an',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-cognitive-system-healthcare-4d220f24',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Cognitive System - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your healthcare workflows with Autonomous Cognitive System - Healthcare. This intelligent platform delivers lead scoring through advanced automation and AI.
          </p>
