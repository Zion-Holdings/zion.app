      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Ingest internal docs, wikis, tickets, and code — extract entity relations, build searchable knowledge graph. Surfaces hidden connections: which team owns what, what service is blocked by which team.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Entity extraction + relation graph build</li>
            <li className="text-purple-300">✓ Semantic search across full graph</li>
            <li className="text-purple-300">✓ Impact analysis: what breaks if team X leaves</li>
            <li className="text-purple-300">✓ Auto-updating from new documents + PRs</li>
            <li className="text-purple-300">✓ GraphQL API for custom integrations</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai knowledge graph builder</li>
