...
export const metadata: Metadata = {
  ...
  keywords: 'Entity extraction + relation graph build, Semantic search across full graph, Impact analysis: what breaks if team X leaves, Auto-updating from new documents + PRs, GraphQL API for custom integrations, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Knowledge Graph Builder</h1>
        <p className="text-lg text-slate-300 mb-8">Ingest internal docs, wikis, tickets, and code — extract entity relations, build searchable knowledge graph. Surfaces hidden connections: which team owns what, what service is blocked by which team.</p>
        ...
        <li class="text-slate-300">Entity extraction + relation graph build</li>
        <li class="text-slate-300">Semantic search across full graph</li>
        <li class="text-slate-300">Impact analysis: what breaks if team X leaves</li>
        <li class="text-slate-300">Auto-updating from new documents + PRs</li>
        <li class="text-slate-300">GraphQL API for custom integrations</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai knowledge graph builder</li>
