...
export const metadata: Metadata = {
  title: 'Smart Engine for Energy',
  description: 'Revolutionize energy through intelligent automation. Our Smart Engine for Energy leverages advanced machine learning to deliver data processing at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-engine-for-energy-b0c47ab9',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Engine for Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize energy through intelligent automation. Our Smart Engine for Energy leverages advanced machine learning to deliver data processing at scale.
          </p>
