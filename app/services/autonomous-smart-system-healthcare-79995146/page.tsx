...
export const metadata: Metadata = {
  title: 'Autonomous Smart System - Healthcare',
  description: 'Enhance your healthcare business with Autonomous Smart System - Healthcare. Our solution provides energy management with enterprise-grade reliability and securi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-smart-system-healthcare-79995146',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Smart System - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your healthcare business with Autonomous Smart System - Healthcare. Our solution provides energy management with enterprise-grade reliability and security.
          </p>
