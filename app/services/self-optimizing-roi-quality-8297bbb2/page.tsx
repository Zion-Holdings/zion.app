...
export const metadata: Metadata = {
  title: 'Self-Optimizing ROI Quality',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing ROI Quality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your construction business with Self-Optimizing ROI Quality. Our solution provides network optimization with enterprise-grade reliability and security.
          </p>
