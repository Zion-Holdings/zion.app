...
export const metadata: Metadata = {
  title: 'Smart Director Solution',
  description: 'Transform your retail operations with our Smart Director Solution. This security solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-director-solution-104854',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Director Solution
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your retail operations with our Smart Director Solution. This security solution delivers unprecedented automation and intelligence.
          </p>
