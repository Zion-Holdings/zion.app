...
export const metadata: Metadata = {
  title: 'Cognitive Workflow Security',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Workflow Security
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your gaming operations with our Cognitive Workflow Security. This AI-driven solution automates threat detection with unprecedented accuracy and efficiency.
          </p>
