...
export const metadata: Metadata = {
  title: 'Intelligent Revenue for Telecom',
  description: 'Optimize your telecom workflows with Intelligent Revenue for Telecom. This intelligent platform delivers training optimization through advanced automation and A',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Revenue for Telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your telecom workflows with Intelligent Revenue for Telecom. This intelligent platform delivers training optimization through advanced automation and AI.
          </p>
