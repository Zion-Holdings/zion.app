...
export const metadata: Metadata = {
  title: 'AI/IT Cognitive Suite - Transportation',
  description: 'Revolutionize transportation through intelligent automation. Our AI/IT Cognitive Suite - Transportation leverages advanced machine learning to deliver cost redu',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/aiit-cognitive-suite-transportation-8f4ae944',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI/IT Cognitive Suite - Transportation
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize transportation through intelligent automation. Our AI/IT Cognitive Suite - Transportation leverages advanced machine learning to deliver cost reduction at scale.
          </p>
