...
export const metadata: Metadata = {
  ...
  keywords: 'Automatic mTLS encryption, Traffic routing and canary deployments, Circuit breaking and retry policies, Distributed tracing (OpenTelemetry), Multi-cluster federation, Zero-trust network policies, Performance dashboards, Istio/Linkerd compatibility, it, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">IT Service Mesh Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Enterprise service mesh for microservices communication, security, and observability. mTLS encryption, traffic management, circuit breaking, and distributed tracing across Kubernetes clusters.</p>
        ...
        <li class="text-slate-300">Automatic mTLS encryption</li>
        <li class="text-slate-300">Traffic routing and canary deployments</li>
        ...
        <li class="text-slate-300">Multi-cluster federation</li>
        <li class="text-slate-300">Zero-trust network policies</li>
        <li class="text-slate-300">Performance dashboards</li>
        <li class="text-slate-300">Istio/Linkerd compatibility</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Secure microservices communication</li>
        <li class="text-slate-300">Zero-downtime deployments</li>
        <li class="text-slate-300">Full observability across services</li>
        <li class="text-slate-300">Simplify multi-cluster management</li>
      </ul>
        </div>
