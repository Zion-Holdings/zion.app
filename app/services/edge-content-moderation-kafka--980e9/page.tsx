...
export const metadata: Metadata = {
  title: 'Edge Content Moderation Kafka (Telecom)',
  description: 'Edge Content Moderation Kafka (Telecom) is an AI-powered telecom solution that transforms how businesses operate through intelligent automation and real-time an',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Edge Content Moderation Kafka (Telecom)
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Edge Content Moderation Kafka (Telecom) is an AI-powered telecom solution that transforms how businesses operate through intelligent automation and real-time analytics.
