...
export const metadata: Metadata = {
  title: 'Self-Optimizing Record Director',
  description: 'Revolutionize cleantech through intelligent automation. Our Self-Optimizing Record Director leverages advanced machine learning to deliver budget tracking at sc',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Self-Optimizing Record Director
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize cleantech through intelligent automation. Our Self-Optimizing Record Director leverages advanced machine learning to deliver budget tracking at scale.
          </p>
