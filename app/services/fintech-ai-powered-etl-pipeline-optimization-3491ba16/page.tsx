...
export const metadata: Metadata = {
  title: 'Fintech AI-Powered ETL Pipeline Optimization',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Fintech AI-Powered ETL Pipeline Optimization
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            AI-powered fintech solution for data engineering. Automated ETL pipeline optimization and error recovery.
          </p>
