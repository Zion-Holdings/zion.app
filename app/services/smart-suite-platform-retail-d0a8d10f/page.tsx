...
export const metadata: Metadata = {
  title: 'Smart Suite Platform - Retail',
  description: 'Enhance your retail business with Smart Suite Platform - Retail. Our solution provides language processing with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-suite-platform-retail-d0a8d10f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Suite Platform - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your retail business with Smart Suite Platform - Retail. Our solution provides language processing with enterprise-grade reliability and security.
          </p>
