...
export const metadata: Metadata = {
  title: 'Autonomous Real Estate for Construction',
  description: 'Revolutionize construction through intelligent automation. Our Autonomous Real Estate for Construction leverages advanced machine learning to deliver document p',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-real-estate-for-construction-9a094a09',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Real Estate for Construction
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize construction through intelligent automation. Our Autonomous Real Estate for Construction leverages advanced machine learning to deliver document processing at scale.
          </p>
