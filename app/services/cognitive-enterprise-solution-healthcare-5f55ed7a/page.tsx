...
export const metadata: Metadata = {
  title: 'Cognitive Enterprise Solution - Healthcare',
  description: 'Drive innovation in healthcare with Cognitive Enterprise Solution - Healthcare. This AI-powered platform transforms document ai into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-enterprise-solution-healthcare-5f55ed7a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Enterprise Solution - Healthcare
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in healthcare with Cognitive Enterprise Solution - Healthcare. This AI-powered platform transforms document ai into a competitive advantage.
          </p>
