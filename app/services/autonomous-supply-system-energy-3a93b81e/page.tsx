...
export const metadata: Metadata = {
  ...
  description: 'Transform your energy operations with our Autonomous Supply System - Energy. This AI-driven solution automates forecast accuracy with unprecedented accuracy and',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-supply-system-energy-3a93b81e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Transform your energy operations with our Autonomous Supply System - Energy. This AI-driven solution automates forecast accuracy with unprecedented accuracy and efficiency.
          </p>
