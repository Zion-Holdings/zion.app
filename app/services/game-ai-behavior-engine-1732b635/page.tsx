...
export const metadata = {
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/game-ai-behavior-engine-1732b635`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path={`/services/game-ai-behavior-engine-1732b635`} title="Game AI Behavior Engine" />
