...
export const metadata: Metadata = {
  title: 'Cognitive Generator System',
  description: 'Transform your legal operations with our Cognitive Generator System. This cloud solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-generator-system-84ffd8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Generator System
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your legal operations with our Cognitive Generator System. This cloud solution delivers unprecedented automation and intelligence.
          </p>
