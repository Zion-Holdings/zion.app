...
export const metadata: Metadata = {
  title: 'Autonomous Training System - Energy',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Training System - Energy
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Future-proof your energy with Autonomous Training System - Energy. Our autonomous solution handles audit trail management end-to-end without human intervention.
          </p>
