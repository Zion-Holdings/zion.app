...
export const metadata: Metadata = {
  title: 'AI Attack Surface Analyzer',
  description: 'Automatically discovers and analyzes AI system attack surfaces with remediation recommendations.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-attack-surface-analyzer-447f8c5f',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Automatically discovers and analyzes AI system attack surfaces with remediation recommendations.
          </p>
