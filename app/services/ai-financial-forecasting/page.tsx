...
export const metadata: Metadata = {
  ...
  keywords: 'Revenue and expense forecasting, Cash flow prediction models, Scenario planning and simulation, Budget variance analysis, Automated financial reporting, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Financial Forecasting &amp; Planning</h1>
        <p className="text-lg text-slate-300 mb-8">Revenue forecasting, cash flow prediction, and budget optimization using AI models trained on your historical and market data.</p>
        ...
        <li class="text-slate-300">Revenue and expense forecasting</li>
        <li class="text-slate-300">Cash flow prediction models</li>
        <li class="text-slate-300">Scenario planning and simulation</li>
        <li class="text-slate-300">Budget variance analysis</li>
        <li class="text-slate-300">Automated financial reporting</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai financial forecasting &amp; planning</li>
