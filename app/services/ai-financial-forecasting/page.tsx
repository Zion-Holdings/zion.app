      ...
      <div className="min-h-screen bg-slate-950 text-white">
        <div className="max-w-4xl mx-auto py-16 px-4">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Revenue forecasting, cash flow prediction, and budget optimization using AI models trained on your historical and market data.
          </p>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <li className="text-purple-300">✓ Revenue and expense forecasting</li>
            <li className="text-purple-300">✓ Cash flow prediction models</li>
            <li className="text-purple-300">✓ Scenario planning and simulation</li>
            <li className="text-purple-300">✓ Budget variance analysis</li>
            <li className="text-purple-300">✓ Automated financial reporting</li>
            </ul>
          </div>
          ...
          <div className="bg-slate-900 rounded-xl p-8 mb-8">
            ...
            <ul className="list-disc list-inside space-y-2">
            <li className="text-purple-300">✓ Reduce costs with ai financial forecasting & planning</li>
