...
export const metadata: Metadata = {
  ...
  keywords: 'Eligibility + formulary real-time check, Payer portal auto-submit clinical note attach, Denial tracking + rework automation, Analytics per payer approval time + rate, ai, Finance, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-slate-300 mb-8">Automated prior authorization: eligibility check formulary check code auto-populate payer portal submission clinical note attach outcome tracking denial tracking remittance per payer analytics.</p>
        ...
        <li class="text-slate-300">Payer portal auto-submit clinical note attach</li>
