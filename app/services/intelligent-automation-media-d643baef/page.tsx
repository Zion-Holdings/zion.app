...
export const metadata: Metadata = {
  title: 'Intelligent automation-media',
  description: 'Enhance your media business with Intelligent automation-media. Our solution provides process discovery with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-automation-media-d643baef',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent automation-media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your media business with Intelligent automation-media. Our solution provides process discovery with enterprise-grade reliability and security.
          </p>
