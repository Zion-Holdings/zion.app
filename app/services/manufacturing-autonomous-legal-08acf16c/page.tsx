...
export const metadata: Metadata = {
  title: 'Manufacturing Autonomous - Legal',
  description: 'Next-generation legal solution: Manufacturing Autonomous - Legal. Combines vendor management with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/manufacturing-autonomous-legal-08acf16c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Manufacturing Autonomous - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation legal solution: Manufacturing Autonomous - Legal. Combines vendor management with adaptive intelligence for optimal results.
          </p>
