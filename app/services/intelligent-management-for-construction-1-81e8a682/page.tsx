...
export const metadata: Metadata = {
  title: 'Intelligent Management for Construction #1',
  description: 'The future of construction is here with Intelligent Management for Construction #1. Powered by cutting-edge AI, this platform delivers project portfolio like ne',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-management-for-construction-1-81e8a682',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Management for Construction #1
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of construction is here with Intelligent Management for Construction #1. Powered by cutting-edge AI, this platform delivers project portfolio like never before.
          </p>
