...
export const metadata: Metadata = {
  title: 'Intelligent Analyzer Platform',
  description: 'Transform your construction operations with our Intelligent Analyzer Platform. This security solution delivers unprecedented automation and intelligence.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-analyzer-platform-320bef',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Analyzer Platform
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your construction operations with our Intelligent Analyzer Platform. This security solution delivers unprecedented automation and intelligence.
          </p>
