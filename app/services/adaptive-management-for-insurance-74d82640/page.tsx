...
export const metadata: Metadata = {
  title: 'Adaptive Management for Insurance',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive Management for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of insurance is here with Adaptive Management for Insurance. Powered by cutting-edge AI, this platform delivers ml model training like never before.
          </p>
