...
export const metadata: Metadata = {
  title: 'AI-Powered Sourcing Finance',
  description: 'Revolutionize real-estate through intelligent automation. Our AI-Powered Sourcing Finance leverages advanced machine learning to deliver logistics route optimiz',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-powered-sourcing-finance-a4c08a96',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI-Powered Sourcing Finance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize real-estate through intelligent automation. Our AI-Powered Sourcing Finance leverages advanced machine learning to deliver logistics route optimization at scale.
          </p>
