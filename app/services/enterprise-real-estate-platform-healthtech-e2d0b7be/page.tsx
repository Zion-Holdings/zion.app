...
export const metadata: Metadata = {
  title: 'Enterprise Real Estate Platform - HEALTHTECH',
  description: 'Transform your healthtech operations with our Enterprise Real Estate Platform - HEALTHTECH. This AI-driven solution automates performance tuning with unpreceden',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/enterprise-real-estate-platform-healthtech-e2d0b7be',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Enterprise Real Estate Platform - HEALTHTECH
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Transform your healthtech operations with our Enterprise Real Estate Platform - HEALTHTECH. This AI-driven solution automates performance tuning with unprecedented accuracy and efficiency.
          </p>
