...
export const metadata: Metadata = {
  title: 'Experience Predictive - Real-Estate',
  description: 'Enhance your real-estate business with Experience Predictive - Real-Estate. Our solution provides expense reporting with enterprise-grade reliability and securi',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/experience-predictive-real-estate-4df3af70',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Experience Predictive - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your real-estate business with Experience Predictive - Real-Estate. Our solution provides expense reporting with enterprise-grade reliability and security.
          </p>
