...
export const metadata = {
  ...
  description: "White-label analytics infrastructure for SaaS products. Pre-built dashboards, custom reports, data visualization, and self-service analytics your customers will",
  alternates: {
