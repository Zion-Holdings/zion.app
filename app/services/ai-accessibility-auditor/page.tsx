...
export const metadata: Metadata = {
  ...
  keywords: 'Full-page accessibility scoring, Component-level issue mapping, Remediation code snippets, Automated PDF accessibility check, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Accessibility Auditor</h1>
        <p className="text-lg text-slate-300 mb-8">Automated WCAG 2.1 AA compliance scans for websites &amp; apps with screen-reader simulation, color contrast testing, and keyboard navigation checks.</p>
        ...
        <li class="text-slate-300">Full-page accessibility scoring</li>
        <li class="text-slate-300">Component-level issue mapping</li>
        <li class="text-slate-300">Remediation code snippets</li>
        <li class="text-slate-300">Automated PDF accessibility check</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai accessibility auditor</li>
