...
export const metadata: Metadata = {
  ...
  keywords: 'Single pane of glass for AWS, Azure, GCP, Infrastructure as Code (Terraform/Pulumi), Drift detection and auto-remediation, Cost optimization across clouds, Compliance policy enforcement, Multi-cloud Kubernetes management, Disaster recovery orchestration, Role-based access control, cloud, Technology, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">Multi-Cloud Orchestration Platform</h1>
        <p className="text-lg text-slate-300 mb-8">Unified orchestration across AWS, Azure, and GCP. Deploy, manage, and monitor workloads from a single control plane. Infrastructure as Code with drift detection and auto-remediation.</p>
        ...
        <li class="text-slate-300">Single pane of glass for AWS, Azure, GCP</li>
        <li class="text-slate-300">Infrastructure as Code (Terraform/Pulumi)</li>
        <li class="text-slate-300">Drift detection and auto-remediation</li>
        <li class="text-slate-300">Cost optimization across clouds</li>
        <li class="text-slate-300">Compliance policy enforcement</li>
        <li class="text-slate-300">Multi-cloud Kubernetes management</li>
        <li class="text-slate-300">Disaster recovery orchestration</li>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce multi-cloud complexity</li>
        <li class="text-slate-300">Optimize cloud spend across providers</li>
        <li class="text-slate-300">Ensure compliance everywhere</li>
        <li class="text-slate-300">Faster disaster recovery</li>
      </ul>
        </div>
