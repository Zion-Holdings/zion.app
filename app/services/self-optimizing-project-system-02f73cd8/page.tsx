...
export const metadata: Metadata = {
  ...
  description: 'Enhance your media business with Self-Optimizing Project System. Our solution provides procurement automation with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/self-optimizing-project-system-02f73cd8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            Enhance your media business with Self-Optimizing Project System. Our solution provides procurement automation with enterprise-grade reliability and security.
          </p>
