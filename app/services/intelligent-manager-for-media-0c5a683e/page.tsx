...
export const metadata: Metadata = {
  title: 'Intelligent Manager for Media',
  description: 'Optimize your media workflows with Intelligent Manager for Media. This intelligent platform delivers business intelligence through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/intelligent-manager-for-media-0c5a683e',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Intelligent Manager for Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your media workflows with Intelligent Manager for Media. This intelligent platform delivers business intelligence through advanced automation and AI.
          </p>
