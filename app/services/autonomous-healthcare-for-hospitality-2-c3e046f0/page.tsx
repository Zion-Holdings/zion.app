...
export const metadata: Metadata = {
  title: 'Autonomous Healthcare for Hospitality #2',
  description: 'Next-generation hospitality solution: Autonomous Healthcare for Hospitality #2. Combines security monitoring with adaptive intelligence for optimal results.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-healthcare-for-hospitality-2-c3e046f0',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Healthcare for Hospitality #2
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation hospitality solution: Autonomous Healthcare for Hospitality #2. Combines security monitoring with adaptive intelligence for optimal results.
          </p>
