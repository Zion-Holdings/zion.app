...
export const metadata: Metadata = {
  title: 'Cognitive Analytics Solution - Healthcare #3',
  description: 'Revolutionize healthcare through intelligent automation. Our Cognitive Analytics Solution - Healthcare #3 leverages advanced machine learning to deliver custome',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Analytics Solution - Healthcare #3
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize healthcare through intelligent automation. Our Cognitive Analytics Solution - Healthcare #3 leverages advanced machine learning to deliver customer journey mapping at scale.
          </p>
