...
export const metadata: Metadata = {
  ...
  keywords: 'Shopper behavior scoring per SKU, Real-time offer personalization, Inventory allocation + OOS prevention, Basket size + store labor optimization, ai, General, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI Retail Personalization Engine</h1>
        <p className="text-lg text-slate-300 mb-8">Offline + online retail: shopper behavior scoring real-time offer personalization inventory allocation basket optimization store labor scheduling per SKU.</p>
        ...
        <li class="text-slate-300">Shopper behavior scoring per SKU</li>
        <li class="text-slate-300">Real-time offer personalization</li>
        <li class="text-slate-300">Inventory allocation + OOS prevention</li>
        <li class="text-slate-300">Basket size + store labor optimization</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">Reduce costs with ai retail personalization engine</li>
