...
export const metadata: Metadata = {
  title: 'Cognitive Suite Solution - Hospitality',
  description: 'The future of hospitality is here with Cognitive Suite Solution - Hospitality. Powered by cutting-edge AI, this platform delivers scalability planning like neve',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-suite-solution-hospitality-8b6b724c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Suite Solution - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of hospitality is here with Cognitive Suite Solution - Hospitality. Powered by cutting-edge AI, this platform delivers scalability planning like never before.
          </p>
