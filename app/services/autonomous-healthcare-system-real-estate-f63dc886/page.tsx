...
export const metadata: Metadata = {
  title: 'Autonomous Healthcare System - Real-Estate',
  description: 'Drive innovation in real-estate with Autonomous Healthcare System - Real-Estate. This AI-powered platform transforms user experience into a competitive advantag',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Healthcare System - Real-Estate
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in real-estate with Autonomous Healthcare System - Real-Estate. This AI-powered platform transforms user experience into a competitive advantage.
          </p>
