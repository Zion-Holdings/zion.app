...
export const metadata: Metadata = {
  title: 'Smart Supply Supply',
  description: 'The future of automotive is here with Smart Supply Supply. Powered by cutting-edge AI, this platform delivers churn prediction like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-supply-supply-27b78d3a',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 mb-8">
            The future of automotive is here with Smart Supply Supply. Powered by cutting-edge AI, this platform delivers churn prediction like never before.
          </p>
