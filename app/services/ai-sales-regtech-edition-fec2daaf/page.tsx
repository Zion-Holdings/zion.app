...
export const metadata: Metadata = {
  title: 'AI Sales - REGTECH Edition',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            AI Sales - REGTECH Edition
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of regtech is here with AI Sales - REGTECH Edition. Powered by cutting-edge AI, this platform delivers capacity planning like never before.
          </p>
