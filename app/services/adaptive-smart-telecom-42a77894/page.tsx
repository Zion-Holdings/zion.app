...
export const metadata: Metadata = {
  title: 'Adaptive smart-telecom',
  description: 'Optimize your telecom workflows with Adaptive smart-telecom. This intelligent platform delivers customer onboarding through advanced automation and AI.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/adaptive-smart-telecom-42a77894',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Adaptive smart-telecom
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Optimize your telecom workflows with Adaptive smart-telecom. This intelligent platform delivers customer onboarding through advanced automation and AI.
          </p>
