...
export const metadata: Metadata = {
  title: 'Next-Gen Smart for Legal',
  description: 'Hyper-accelerated legal solution: Next-Gen Smart for Legal. Combines threat detection with next-gen AI for maximum velocity.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/next-gen-smart-for-legal-599c3fb8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Next-Gen Smart for Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Hyper-accelerated legal solution: Next-Gen Smart for Legal. Combines threat detection with next-gen AI for maximum velocity.
          </p>
