...
export const metadata: Metadata = {
  title: 'Cognitive AI Solution - Media',
  description: 'Enhance your media business with Cognitive AI Solution - Media. Our solution provides customer journey mapping with enterprise-grade reliability and security.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-ai-solution-media-85500970',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive AI Solution - Media
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your media business with Cognitive AI Solution - Media. Our solution provides customer journey mapping with enterprise-grade reliability and security.
          </p>
