...
export const metadata: Metadata = {
  title: 'Smart Manufacturing for Insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Smart Manufacturing for Insurance leverages advanced machine learning to deliver image recognition a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-manufacturing-for-insurance-e1a087c8',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Manufacturing for Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Smart Manufacturing for Insurance leverages advanced machine learning to deliver image recognition at scale.
          </p>
