...
export const metadata: Metadata = {
  title: 'Cognitive Vendor Smart',
  description: 'The future of gaming is here with Cognitive Vendor Smart. Powered by cutting-edge AI, this platform delivers user provisioning like never before.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/cognitive-vendor-smart-f0aab1f2',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Vendor Smart
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            The future of gaming is here with Cognitive Vendor Smart. Powered by cutting-edge AI, this platform delivers user provisioning like never before.
          </p>
