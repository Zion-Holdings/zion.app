...
export const metadata: Metadata = {
  title: "Accounts Payable Multi-Cloud Cost Management Platform - AI-Powered Accounts Payable Solution",
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-purple-400 mb-6">
          Accounts Payable Multi-Cloud Cost Management Platform - AI-Powered Accounts Payable Solution
        </h1>
        <p className="text-xl text-slate-300 mb-8">
          AI-powered accounts payable solution for cloud operations. Unified platform for monitoring, optimizing, and governing costs across AWS, Azure, and GCP.
        </p>
