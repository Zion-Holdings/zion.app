...
export const metadata: Metadata = {
  title: 'Risk Autonomous - Retail',
  description: 'Drive innovation in retail with Risk Autonomous - Retail. This AI-powered platform transforms revenue forecasting into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/risk-autonomous-retail-6575c46b',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Risk Autonomous - Retail
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in retail with Risk Autonomous - Retail. This AI-powered platform transforms revenue forecasting into a competitive advantage.
          </p>
