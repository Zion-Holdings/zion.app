...
export const metadata: Metadata = {
  title: 'Autonomous Cloud System - Legal',
  description: 'Drive innovation in legal with Autonomous Cloud System - Legal. This AI-powered platform transforms maintenance prediction into a competitive advantage.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/autonomous-cloud-system-legal-e0479cf4',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous Cloud System - Legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Drive innovation in legal with Autonomous Cloud System - Legal. This AI-powered platform transforms maintenance prediction into a competitive advantage.
          </p>
