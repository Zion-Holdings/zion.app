...
export const metadata: Metadata = {
  title: 'Smart Automation Platform - Hospitality',
  description: 'Revolutionize hospitality through intelligent automation. Our Smart Automation Platform - Hospitality leverages advanced machine learning to deliver financial r',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/smart-automation-platform-hospitality-ec74d4fc',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Smart Automation Platform - Hospitality
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize hospitality through intelligent automation. Our Smart Automation Platform - Hospitality leverages advanced machine learning to deliver financial risk management at scale.
          </p>
