...
export const metadata: Metadata = {
  title: 'Serverless threat-legal',
  description: 'Revolutionize legal through intelligent automation. Our Serverless threat-legal leverages advanced machine learning to deliver feature engineering at scale.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/serverless-threat-legal-a588aa6c',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Serverless threat-legal
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize legal through intelligent automation. Our Serverless threat-legal leverages advanced machine learning to deliver feature engineering at scale.
          </p>
