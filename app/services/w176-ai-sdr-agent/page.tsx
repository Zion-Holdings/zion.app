...
export const metadata: Metadata = {
  ...
  keywords: 'AI prospect research and qualification, Personalized email and LinkedIn outreach, Multi-step sequence management, Meeting booking with calendar integration, Response classification and routing, Lead scoring and priority ranking, Integration with Salesforce, HubSpot, Outreach, Salesloft, automation, Sales, Zion Tech Group',
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6 text-white">AI SDR &amp; Prospecting Agent</h1>
        <p className="text-lg text-slate-300 mb-8">AI sales development rep: research prospects, write personalized outreach, manage sequences, and book meetings. Replaces 3 SDRs for a fraction of the cost.</p>
        ...
        <li class="text-slate-300">AI prospect research and qualification</li>
        <li class="text-slate-300">Personalized email and LinkedIn outreach</li>
        <li class="text-slate-300">Multi-step sequence management</li>
        <li class="text-slate-300">Meeting booking with calendar integration</li>
        <li class="text-slate-300">Response classification and routing</li>
        <li class="text-slate-300">Lead scoring and priority ranking</li>
        <li class="text-slate-300">Integration with Salesforce, HubSpot, Outreach, Salesloft</li>
      </ul>
        </div>
        ...
        <div class="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul class="list-disc list-inside space-y-2">
        <li class="text-slate-300">AI SDR operates 24/7 without burnout</li>
        <li class="text-slate-300">Personalized at scale, not template spam</li>
        <li class="text-slate-300">Response routing to right rep instantly</li>
        <li class="text-slate-300">Fraction of an SDR cost with more output</li>
      </ul>
        </div>
