...
export const metadata: Metadata = {
  title: 'Automated cloud-insurance',
  description: 'Revolutionize insurance through intelligent automation. Our Automated cloud-insurance leverages advanced machine learning to deliver enterprise-grade insights a',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/automated-cloud-insurance-b0bfc54d',
  },
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Automated cloud-insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Revolutionize insurance through intelligent automation. Our Automated cloud-insurance leverages advanced machine learning to deliver enterprise-grade insights at scale.
          </p>
