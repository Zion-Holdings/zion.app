...
export const metadata: Metadata = {
  title: 'Autonomous DevOps System - Insurance',
  description: 'Enhance your insurance business with Autonomous DevOps System - Insurance. Our solution provides customer service automation with enterprise-grade reliability a',
  alternates: {
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Autonomous DevOps System - Insurance
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Enhance your insurance business with Autonomous DevOps System - Insurance. Our solution provides customer service automation with enterprise-grade reliability and security.
          </p>
