...
export const metadata: Metadata = {
  title: 'Cognitive Net Data Science',
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Cognitive Net Data Science
          </h1>
          <p className="text-xl text-gray-400 mb-8">
            Next-generation retail solution: Cognitive Net Data Science. Combines decision support with adaptive intelligence for optimal results.
          </p>
