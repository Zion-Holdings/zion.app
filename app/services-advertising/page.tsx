...
export const metadata = {
  ...
  description:
    'Services Advertising empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Tu',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Services Advertising empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Services Advertising',
      }}
    />
  );
}
