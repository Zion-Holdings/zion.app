...
export const metadata = {
  ...
  description:
    'AI Task Manager eliminates manual bottlenecks with intelligent process automation, event-driven orchestration, and cross-system integration. Reclaim operat',
  alternates: { canonical: '/ai-task-manager' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Task Manager eliminates manual bottlenecks with intelligent process automation, event-driven orchestration, and cross-system integration. Reclaim operational capacity and reduce human error.',
        iconEmoji: '🔄',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Task Manager',
      }}
    />
  );
}
