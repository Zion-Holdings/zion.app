...
export const metadata = {
  ...
  description:
    'AI Translation Services enhances team communication and content workflows with AI-powered language processing, automated transcription, and intelligent tra',
  alternates: { canonical: '/ai-translation-services' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Translation Services enhances team communication and content workflows with AI-powered language processing, automated transcription, and intelligent translation across channels and languages.',
        iconEmoji: '🗣️',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy AI Translation Services to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use AI Translation Services to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage AI Translation Services analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with AI Translation Services',
      }}
    />
  );
}
