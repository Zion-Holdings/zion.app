...
export const metadata = {
  title: 'Database | Zion Tech Group',
  description:
    'Database transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more confiden',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Database transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more confident decisions backed by production-grade analytics.',
        iconEmoji: '📊',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Database',
      }}
    />
  );
}
