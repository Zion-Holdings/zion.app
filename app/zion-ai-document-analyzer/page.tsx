...
export const metadata = {
  title: 'Zion AI Document Analyzer | Zion Tech Group',
  description:
    'Zion AI Document Analyzer streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your te',
  alternates: { canonical: '/zion-ai-document-analyzer' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion AI Document Analyzer streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focus on strategic work.',
        iconEmoji: '📋',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion AI Document Analyzer',
      }}
    />
  );
}
