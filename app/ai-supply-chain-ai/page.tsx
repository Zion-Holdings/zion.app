...
export const metadata = {
  title: 'AI Supply Chain AI | Zion Tech Group',
  description:
    'AI Supply Chain AI delivers purpose-built AI solutions tailored to specific industry requirements. Accelerate digital transformation with domain-specific w',
  alternates: { canonical: '/ai-supply-chain-ai' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Supply Chain AI delivers purpose-built AI solutions tailored to specific industry requirements. Accelerate digital transformation with domain-specific workflows, compliance controls, and operational intelligence.',
        iconEmoji: '🏢',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy AI Supply Chain AI to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use AI Supply Chain AI to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage AI Supply Chain AI analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with AI Supply Chain AI',
      }}
    />
  );
}
