...
export const metadata = {
  ...
  description:
    'Security Monitoring provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audi',
  alternates: { canonical: '/security-monitoring' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Security Monitoring provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit readiness with AI-driven threat detection and policy enforcement.',
        iconEmoji: '🛡️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Security Monitoring',
      }}
    />
  );
}
