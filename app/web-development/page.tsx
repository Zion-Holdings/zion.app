...
export const metadata = {
  ...
  description:
    'Web Development accelerates software delivery with intelligent tooling, automated code analysis, and streamlined development workflows. Ship higher-quality',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Web Development accelerates software delivery with intelligent tooling, automated code analysis, and streamlined development workflows. Ship higher-quality code faster while reducing technical debt.',
        iconEmoji: '⚙️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Web Development',
      }}
    />
  );
}
