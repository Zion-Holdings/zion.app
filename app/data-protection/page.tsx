...
export const metadata = {
  ...
  description:
    'Data Protection transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more c',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Data Protection transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more confident decisions backed by production-grade analytics.',
        iconEmoji: '📊',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Data Protection',
      }}
    />
  );
}
