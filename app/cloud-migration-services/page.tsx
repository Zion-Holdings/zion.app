...
export const metadata = {
  ...
  alternates: { canonical: '/cloud-migration-services' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Cloud Migration Services delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster with battle-tested deployment patterns and cost optimization.',
        iconEmoji: '☁️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Cloud Migration Services',
      }}
    />
  );
}
