...
export const metadata = {
  title: 'IoT Edge | Zion Tech Group',
  description:
    'IoT Edge connects physical operations with intelligent digital systems. Process sensor data at the edge, automate responses in real time, and gain visibili',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'IoT Edge connects physical operations with intelligent digital systems. Process sensor data at the edge, automate responses in real time, and gain visibility across distributed environments.',
        iconEmoji: '📡',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy IoT Edge to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use IoT Edge to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage IoT Edge analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with IoT Edge',
      }}
    />
  );
}
