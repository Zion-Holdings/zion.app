...
export const metadata = {
  ...
  description:
    'AI Meeting Assistant enhances team communication and content workflows with AI-powered language processing, automated transcription, and intelligent transl',
  alternates: { canonical: '/ai-meeting-assistant' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Meeting Assistant enhances team communication and content workflows with AI-powered language processing, automated transcription, and intelligent translation across channels and languages.',
        iconEmoji: '🗣️',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy AI Meeting Assistant to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use AI Meeting Assistant to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage AI Meeting Assistant analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with AI Meeting Assistant',
      }}
    />
  );
}
