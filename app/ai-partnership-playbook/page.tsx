export const metadata = {
  ...
  description: "Zion Tech Group delivers ai partnership playbook with measurable outcomes.",
  alternates: { canonical: "https://ziontechgroup.com/ai-partnership-playbook/" },
};

export default function Page() {
  return (
    <main style={{ maxWidth: 900, margin: '0 auto', padding: '2rem 1rem' }}>
      <h1>ai partnership playbook</h1>
      <p style={{ color: '#cbd5e1', lineHeight: 1.7, fontSize: 18 }}>
        Zion Tech Group delivers ai partnership playbook with measurable outcomes.
      </p>
