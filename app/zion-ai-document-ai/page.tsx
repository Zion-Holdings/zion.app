...
export const metadata = {
  title: 'Zion AI Document AI | Zion Tech Group',
  description:
    'Zion AI Document AI streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to ',
  alternates: { canonical: '/zion-ai-document-ai' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion AI Document AI streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focus on strategic work.',
        iconEmoji: '📋',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion AI Document AI',
      }}
    />
  );
}
