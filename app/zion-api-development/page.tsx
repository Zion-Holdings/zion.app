...
export const metadata = {
  title: 'Zion API Development | Zion Tech Group',
  description:
    'Zion API Development accelerates software delivery with intelligent tooling, automated code analysis, and streamlined development workflows. Ship higher-qu',
  alternates: { canonical: '/zion-api-development' },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'Zion API Development',
        category: 'Engineering & Development',
        description:
          'Zion API Development accelerates software delivery with intelligent tooling, automated code analysis, and streamlined development workflows. Ship higher-quality code faster while reducing technical debt.',
        iconEmoji: '⚙️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion API Development',
      }}
    />
  );
}
