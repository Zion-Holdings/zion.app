...
export const metadata = {
  ...
  description:
    'IT Support elevates customer interactions with AI-driven support, intelligent routing, and personalized engagement across every touchpoint. Increase satisf',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'IT Support elevates customer interactions with AI-driven support, intelligent routing, and personalized engagement across every touchpoint. Increase satisfaction while reducing response times.',
        iconEmoji: '💬',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy IT Support to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use IT Support to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage IT Support analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with IT Support',
      }}
    />
  );
}
