...
export const metadata = {
  ...
  description:
    'AI Ops combines AI intelligence with practical engineering to solve real business challenges. Deploy production-ready capabilities that integrate with your',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Ops combines AI intelligence with practical engineering to solve real business challenges. Deploy production-ready capabilities that integrate with your existing systems and deliver measurable results.',
        iconEmoji: '✨',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy AI Ops to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use AI Ops to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage AI Ops analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with AI Ops',
      }}
    />
  );
}
