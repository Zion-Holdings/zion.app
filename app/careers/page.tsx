...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Careers | Zion Tech Group', description: 'Open roles and culture at Zion Tech Group.', url: 'https://ziontechgroup.com/careers/', type: 'website' },  twitter: {
