export default function Page() {
  ...
  const summary = "AI-assisted alert triage, incident summarization, and playbook recommendation for security teams.";
  const keywords = ["security AI", "SOAR assistant", "incident response", "alert triage", "AI SOC"];
  return (
    <>
      <main className="min-h-screen">
        <section className="relative overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 pt-20 pb-16">
          ...
          <div className="container-page relative">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 max-w-3xl">AI Security Operations Assistant</h1>
            <p className="text-lg text-slate-400 max-w-2xl mb-8">AI-assisted alert triage, incident summarization, and playbook recommendation for security teams.</p>
