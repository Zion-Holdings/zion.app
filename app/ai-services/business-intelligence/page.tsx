...
export const metadata = {
  ...
  alternates: { canonical: '/ai-services/business-intelligence' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Business Intelligence transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more confident decisions backed by production-grade analytics.',
        iconEmoji: '📊',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Business Intelligence',
      }}
    />
  );
}
