      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 pt-20 pb-16">
        ...
        <div className="container-page relative">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-cyan-400/20 bg-cyan-400/5 mb-6">
            <span className="text-cyan-400 text-xs font-semibold uppercase tracking-wider">RAG</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 max-w-3xl">AI RAG & Knowledge Systems</h1>
          <p className="text-lg text-slate-400 max-w-2xl mb-8">AI RAG & Knowledge Systems solutions for enterprise.</p>
