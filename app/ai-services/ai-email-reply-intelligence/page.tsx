export default function Page() {
  ...
  const summary = "Automated email response drafting, triage, and intent detection for revenue and support teams.";
  const keywords = ["email AI", "reply intelligence", "support triage", "automated responses", "enterprise email automation"];
  return (
    <>
      <main className="min-h-screen">
        <section className="relative overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 pt-20 pb-16">
          ...
          <div className="container-page relative">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 max-w-3xl">AI Email Reply Intelligence</h1>
            <p className="text-lg text-slate-400 max-w-2xl mb-8">Automated email response drafting, triage, and intent detection for revenue and support teams.</p>
