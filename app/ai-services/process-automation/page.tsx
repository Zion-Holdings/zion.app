...
export const metadata = {
  ...
  description:
    'Process Automation eliminates manual bottlenecks with intelligent process automation, event-driven orchestration, and cross-system integration. Reclaim ope',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Process Automation eliminates manual bottlenecks with intelligent process automation, event-driven orchestration, and cross-system integration. Reclaim operational capacity and reduce human error.',
        iconEmoji: '🔄',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Process Automation',
      }}
    />
  );
}
