export default function Page() {
  ...
  const summary = "Extract insights from contracts, invoices, and operational documents with AI parsing and validation.";
  const keywords = ["document AI", "contract extraction", "invoice parsing", "OCR automation", "enterprise document processing"];
  return (
    <>
      <main className="min-h-screen">
        <section className="relative overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 pt-20 pb-16">
          ...
          <div className="container-page relative">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 max-w-3xl">AI Document Intelligence</h1>
            <p className="text-lg text-slate-400 max-w-2xl mb-8">Extract insights from contracts, invoices, and operational documents with AI parsing and validation.</p>
