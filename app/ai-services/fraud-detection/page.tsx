...
export const metadata = {
  ...
  description:
    'Fraud Detection provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit re',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Fraud Detection provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit readiness with AI-driven threat detection and policy enforcement.',
        iconEmoji: '🛡️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Fraud Detection',
      }}
    />
  );
}
