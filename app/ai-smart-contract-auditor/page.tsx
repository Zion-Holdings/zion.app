...
export const metadata = {
  ...
  description:
    'AI Smart Contract Auditor provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerat',
  alternates: { canonical: '/ai-smart-contract-auditor' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Smart Contract Auditor provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit readiness with AI-driven threat detection and policy enforcement.',
        iconEmoji: '🛡️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Smart Contract Auditor',
      }}
    />
  );
}
