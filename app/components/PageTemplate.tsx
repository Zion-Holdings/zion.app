      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        ...
        {layout === 'hero' && (
          <div className="text-center max-w-4xl mx-auto mb-12 md:mb-16 lg:mb-20">
            ...
            {resolvedSubtitle && (
              <p className="text-xl text-slate-300 leading-relaxed mb-6 md:mb-8 max-w-2xl mx-auto">
                {resolvedSubtitle}
              </p>
            )}
            {actions.length > 0 && (
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center pt-3 md:pt-4">
                {actions.map((action, idx) => (
                  <ActionComponent
                    key={idx}
                    href={action.href}
                    className={`${action.style === 'secondary' ? 'btn-secondary' : 'btn-primary'} text-base md:text-lg px-6 md:px-10 py-3 md:py-4 inline-flex items-center justify-center`}
                  >
                    {action.label}
                  </ActionComponent>
                ))}
        ...
        {layout !== 'hero' && (
          <div className="max-w-4xl mx-auto mb-12 md:mb-16">
            ...
            {resolvedSubtitle && (
              <p className="text-xl text-slate-300 leading-relaxed mb-6 md:mb-8">
                {resolvedSubtitle}
              </p>
            )}
            {actions.length > 0 && (
