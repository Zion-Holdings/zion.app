...
const TOP_CATEGORIES = [
  ...
  { key:'it', label:'IT', href:'/services/?category=it', emoji:'' },
  { key:'cloud', label:'Cloud', href:'/services/?category=cloud', emoji:'' },
        ...
        <div className="container-page">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              ...
              { title:'Custom build', desc:'Tailored AI/Cloud/Security stack built to your stack and governance.', cta:'/proposal', label:'Request Proposal' },
            ].map(card => (
