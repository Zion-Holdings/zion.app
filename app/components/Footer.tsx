...
const FOOTER_LINKS: { title: string; links: FooterLink[] }[] = [
  {
    ...
    links: [
      ...
      { name: 'IT Services', href: '/it-consulting-services' },
      { name: 'AI Consulting', href: '/ai-consulting-services' },
      { name: 'Micro-SaaS Products', href: '/micro-saas' },
  ...
  },
  {
    ...
    links: [
      ...
      { name: 'Telecom', href: '/industries/telecommunications' },
      { name: 'Energy', href: '/industries/energy-utilities' },
      { name: 'Logistics', href: '/industries/logistics' },
      { name: 'Gaming', href: '/industries/gaming-interactive' },
      { name: 'Real Estate', href: '/industries/real-estate' },
      { name: 'Legal Tech', href: '/industries/legal-compliance' },
    ],
  },
  {
    title: 'Company',
  ...
  },
  {
    ...
    links: [
      ...
      { name: 'System Status', href: '/status/service-health' },
    ],
  },
  {
    title: 'Legal',
