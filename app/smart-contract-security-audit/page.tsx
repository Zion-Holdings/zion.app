...
export const metadata = {
  ...
  alternates: { canonical: '/smart-contract-security-audit' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Smart Contract Security Audit provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit readiness with AI-driven threat detection and policy enforcement.',
        iconEmoji: '🛡️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Smart Contract Security Audit',
      }}
    />
  );
}
