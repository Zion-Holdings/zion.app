...
export const metadata = {
  ...
  description:
    'Cybersecurity provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit read',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Cybersecurity provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit readiness with AI-driven threat detection and policy enforcement.',
        iconEmoji: '🛡️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Cybersecurity',
      }}
    />
  );
}
