...
export const metadata = {
  ...
  description:
    'Security Monitoring Suite provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerat',
  alternates: { canonical: '/security-monitoring-suite' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Security Monitoring Suite provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit readiness with AI-driven threat detection and policy enforcement.',
        iconEmoji: '🛡️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Security Monitoring Suite',
      }}
    />
  );
}
