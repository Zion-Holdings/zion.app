...
export const metadata = {
  title: 'Health | Zion Tech Group',
  description:
    'Health brings AI-powered intelligence to healthcare workflows, enabling faster diagnostics, better patient outcomes, and streamlined administrative process',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Health brings AI-powered intelligence to healthcare workflows, enabling faster diagnostics, better patient outcomes, and streamlined administrative processes while maintaining strict compliance.',
        iconEmoji: '🏥',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy Health to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use Health to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage Health analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with Health',
      }}
    />
  );
}
