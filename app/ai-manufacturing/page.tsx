...
export const metadata = {
  title: 'AI Manufacturing | Zion Tech Group',
  description:
    'AI Manufacturing delivers purpose-built AI solutions tailored to specific industry requirements. Accelerate digital transformation with domain-specific wor',
  alternates: { canonical: '/ai-manufacturing' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Manufacturing delivers purpose-built AI solutions tailored to specific industry requirements. Accelerate digital transformation with domain-specific workflows, compliance controls, and operational intelligence.',
        iconEmoji: '🏢',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy AI Manufacturing to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use AI Manufacturing to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage AI Manufacturing analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with AI Manufacturing',
      }}
    />
  );
}
