  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Custom Software accelerates software delivery with intelligent tooling, automated code analysis, and streamlined development workflows. Ship higher-quality code faster while reducing technical debt.',
        iconEmoji: '⚙️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Custom Software',
      }}
    />
  );
}
