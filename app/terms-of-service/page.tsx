  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Information about our policies, terms, and legal commitments. We are transparent about how we operate, protect your data, and ensure fair business practices.',
        iconEmoji: '📜',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy Terms Of Service to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use Terms Of Service to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage Terms Of Service analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with Terms Of Service',
      }}
    />
  );
}
