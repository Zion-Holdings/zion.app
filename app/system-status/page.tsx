...
export const metadata = {
  ...
  description:
    'System Status provides resources, documentation, and information to help you get the most from Zion Tech Group services and products.',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy System Status to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use System Status to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage System Status analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with System Status',
      }}
    />
  );
}
