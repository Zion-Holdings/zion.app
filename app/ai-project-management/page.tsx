...
export const metadata = {
  ...
  description:
    'AI Project Management streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team t',
  alternates: { canonical: '/ai-project-management' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Project Management streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focus on strategic work.',
        iconEmoji: '📋',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Project Management',
      }}
    />
  );
}
