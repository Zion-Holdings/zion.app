...
export const metadata = {
  title: 'Email Optimizer | Zion Tech Group',
  description:
    'Email Optimizer empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn da',
  alternates: { canonical: '/email-optimizer' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Email Optimizer empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Email Optimizer',
      }}
    />
  );
}
