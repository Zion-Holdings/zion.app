...
export const metadata = {
  title: 'Data Visualization | Zion Tech Group',
  description:
    'Data Visualization transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, mor',
  alternates: { canonical: '/data-visualization' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Data Visualization transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more confident decisions backed by production-grade analytics.',
        iconEmoji: '📊',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Data Visualization',
      }}
    />
  );
}
