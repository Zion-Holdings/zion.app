...
export const metadata = {
  ...
  description:
    'Mobile App Development accelerates software delivery with intelligent tooling, automated code analysis, and streamlined development workflows. Ship higher-',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Mobile App Development accelerates software delivery with intelligent tooling, automated code analysis, and streamlined development workflows. Ship higher-quality code faster while reducing technical debt.',
        iconEmoji: '⚙️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Mobile App Development',
      }}
    />
  );
}
