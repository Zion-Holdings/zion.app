...
export const metadata = {
  ...
  description:
    'AI Mobile App Development accelerates software delivery with intelligent tooling, automated code analysis, and streamlined development workflows. Ship high',
  alternates: { canonical: '/ai-mobile-app-development' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Mobile App Development accelerates software delivery with intelligent tooling, automated code analysis, and streamlined development workflows. Ship higher-quality code faster while reducing technical debt.',
        iconEmoji: '⚙️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Mobile App Development',
      }}
    />
  );
}
