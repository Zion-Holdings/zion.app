...
export const metadata = {
  ...
  description:
    'AI Project Manager Pro streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team ',
  alternates: { canonical: '/ai-project-manager-pro' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Project Manager Pro streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focus on strategic work.',
        iconEmoji: '📋',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Project Manager Pro',
      }}
    />
  );
}
