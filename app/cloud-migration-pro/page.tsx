...
export const metadata = {
  ...
  description:
    'Cloud Migration Pro delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production fas',
  alternates: { canonical: '/cloud-migration-pro' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Cloud Migration Pro delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster with battle-tested deployment patterns and cost optimization.',
        iconEmoji: '☁️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Cloud Migration Pro',
      }}
    />
  );
}
