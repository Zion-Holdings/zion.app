...
export const metadata = {
  title: "Providers | Zion Tech Group Partnerships & Solutions",
  description: "Managed service, co-delivery, and white-label partners. Explore service providers recommendations from our catalog.",
    ...
    <main className="min-h-screen bg-slate-950">
      <div className="container-page py-20">
        <div className="max-w-5xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-3">🤝 Providers</h1>
          <p className="text-slate-300 mb-8 max-w-2xl">Managed service, co-delivery, and white-label partners.</p>
