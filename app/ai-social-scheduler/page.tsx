...
export const metadata = {
  ...
  alternates: { canonical: '/ai-social-scheduler' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Social Scheduler empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Social Scheduler',
      }}
    />
  );
}
