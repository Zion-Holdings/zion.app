...
export const metadata: Metadata = {
  ...
  description: 'Process Automation — Zion Tech Group enterprise solutions.',
  alternates: { canonical: '/process-automation/' },
};
    ...
    <main className="min-h-screen">
      <section className="relative overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 pt-20 pb-16">
        ...
        <div className="container-page relative">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 max-w-3xl">Process Automation</h1>
          <p className="text-lg text-slate-400 max-w-2xl mb-8">Process Automation — Zion Tech Group enterprise solutions.</p>
