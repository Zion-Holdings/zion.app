...
export const metadata = {
  title: "Business Customers | Zion Tech Group Partnerships & Solutions",
  description: "Enterprises and mid-market buyers with procurement and compliance. Explore business customers recommendations from our catalog.",
  alternates: { canonical: '/business-customers/' }
};

export default function Page() {
  const rows = [{"title":"Micro-SAAS AI Invoice Processor","category":"ai","price":"$79/mo"},{"title":"Micro-SAAS AI Contract Analyzer","category":"ai","price":"$149/mo"},{"title":"Micro-SAAS AI Meeting Minutes Generator","category":"ai","price":"$29/mo"},{"title":"Micro-SAAS AI Website Builder","category":"ai","price":"$19/mo"},{"title":"Micro-SAAS AI Smart Email Responder","category":"ai","price":"$39/mo"}];
  return (
    <main className="min-h-screen bg-slate-950">
      <div className="container-page py-20">
        <div className="max-w-5xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-3">🏢 Business Customers</h1>
          <p className="text-slate-300 mb-8 max-w-2xl">Enterprises and mid-market buyers with procurement and compliance.</p>
          ...
          <section className="mb-16">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              <Link key="ai" href="/services/?category=ai" className="glass-card p-5 hover:border-purple-500/40"><div className="text-white font-semibold capitalize">ai</div><div className="text-slate-400 text-xs mt-1">2148 services</div></Link>
