...
export const metadata = {
  title: 'AI Scheduler | Zion Tech Group',
  description:
    'AI Scheduler eliminates manual bottlenecks with intelligent process automation, event-driven orchestration, and cross-system integration. Reclaim operation',
  alternates: { canonical: '/ai-scheduler' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Scheduler eliminates manual bottlenecks with intelligent process automation, event-driven orchestration, and cross-system integration. Reclaim operational capacity and reduce human error.',
        iconEmoji: '🔄',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Scheduler',
      }}
    />
  );
}
