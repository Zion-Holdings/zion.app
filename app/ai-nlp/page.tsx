...
export const metadata = {
  ...
  description:
    'AI NLP enhances team communication and content workflows with AI-powered language processing, automated transcription, and intelligent translation across c',
  alternates: { canonical: '/ai-nlp' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI NLP enhances team communication and content workflows with AI-powered language processing, automated transcription, and intelligent translation across channels and languages.',
        iconEmoji: '🗣️',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy AI NLP to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use AI NLP to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage AI NLP analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with AI NLP',
      }}
    />
  );
}
