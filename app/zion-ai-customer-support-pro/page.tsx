    ...
    <main className="min-h-screen">
      <section className="relative overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 pt-20 pb-16">
        ...
        <div className="container-page relative">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-pink-400/20 bg-pink-400/5 mb-6">
            <span className="text-pink-400 text-xs font-semibold uppercase tracking-wider">Support</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 max-w-3xl">Zion AI Customer Support Pro</h1>
          <p className="text-lg text-slate-400 max-w-2xl mb-8">Zion AI Customer Support Pro — Zion Tech Group enterprise solutions.</p>
