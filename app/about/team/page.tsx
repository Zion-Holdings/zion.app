...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://ziontechgroup.com/about/team/' },
};
...
export default function TeamPage() {
  return (
    <PageTemplate
      ...
      description="Meet the US-based experts behind Zion Tech Group. Our team combines deep technical expertise with real-world enterprise experience."
      canonical="https://ziontechgroup.com/about/team/"
      hero={{ variant: 'none' }}
      breadcrumbItems={[
        { label: 'Home', href: '/' },
    ...
    >
      ...
      <div className="space-y-8 mt-8">
        {teamMembers.map((member) => (
          <div key={member.name} className="glass-card-strong flex items-start gap-6">
