...
export const metadata: Metadata = {
  ...
  description: 'The world\'s most advanced email processing system. 1,000 AI engines analyze every email case-by-case, enforce reply-all, and take the most appropriate action automatically.',
