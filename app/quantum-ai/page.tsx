...
export const metadata = {
  title: 'Quantum AI | Zion Tech Group',
  description:
    'Quantum AI explores the frontier of computing with advanced AI, simulation, and next-generation platforms. Position your team at the cutting edge while mai',
  alternates: { canonical: '/quantum-ai' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Quantum AI explores the frontier of computing with advanced AI, simulation, and next-generation platforms. Position your team at the cutting edge while maintaining practical delivery standards.',
        iconEmoji: '🚀',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy Quantum AI to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use Quantum AI to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage Quantum AI analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with Quantum AI',
      }}
    />
  );
}
