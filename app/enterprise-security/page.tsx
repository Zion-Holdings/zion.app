...
export const metadata = {
  ...
  description:
    'Enterprise Security provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audi',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Enterprise Security provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit readiness with AI-driven threat detection and policy enforcement.',
        iconEmoji: '🛡️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Enterprise Security',
      }}
    />
  );
}
