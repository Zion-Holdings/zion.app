...
e  alternates: { canonical: 'https://ziontechgroup.com/enterprise-security' },
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      <div className="max-w-4xl mx-auto px-4 py-16">
        <h1 className="text-4xl font-bold text-white mb-4">Enterprise Security</h1>
        <p className="text-slate-400 text-lg mb-8">Enterprise-grade security solutions for large organizations.</p>
        <div className="flex flex-wrap gap-4">
        <Link href="/services" className="text-emerald-400 hover:text-emerald-300 underline">Security Services</Link>
        <Link href="/contact" className="text-emerald-400 hover:text-emerald-300 underline">Get Protected</Link>
        </div>
