    ...
    <div className="relative min-h-screen overflow-hidden bg-slate-950">
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-slate-700/70 bg-gradient-to-br from-slate-900/80 to-slate-950/70 p-6 sm:p-10">
          ...
          <h2 className="mt-2 text-2xl font-bold text-white">Common Real Estate & Property Workflows</h2>
          <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="rounded-2xl border border-slate-700/70 bg-slate-950/65 p-5">
              <h3 className="font-semibold text-white">Listing & Tenant Management</h3>
              <p className="mt-2 text-sm text-slate-300">
                Automate listing updates, tenant intake, and lease renewals. Improve occupancy and reduce admin time.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700/70 bg-slate-950/65 p-5">
              <h3 className="font-semibold text-white">Document & Contract Processing</h3>
              <p className="mt-2 text-sm text-slate-300">
                Automate lease review, document extraction, and compliance. Speed up due diligence and onboarding.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700/70 bg-slate-950/65 p-5">
              <h3 className="font-semibold text-white">Tenant Communications</h3>
              <p className="mt-2 text-sm text-slate-300">
                Deploy chatbots for inquiries, maintenance requests, and payments. Scale support without headcount.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700/70 bg-slate-950/65 p-5">
              <h3 className="font-semibold text-white">Performance & Reporting</h3>
              <p className="mt-2 text-sm text-slate-300">
                Generate property performance reports and analytics. Improve decision-making and investor reporting.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-purple-500/20 bg-slate-900/65 p-6 sm:p-8">
          ...
          <h2 className="mt-2 text-xl font-bold text-white">Real Estate Firm Automates Lease Review 55%</h2>
          <p className="mt-2 text-slate-300">
            A property management firm deployed Zion AI Contract Analyzer and Document Processor to automate lease review and tenant onboarding. Document turnaround dropped 55% while improving compliance.
          </p>
          <a
            href="/case-studies"
      ...
      <SolutionPageFAQ
        ...
        items={SOLUTION_FAQS['real-estate-property'] ?? []}
      />
