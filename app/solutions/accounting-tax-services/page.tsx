...
export const metadata = {
  title: 'Accounting & Tax Services AI Solutions | Zion Tech Group',
  description:
    'Automate bookkeeping, reconciliation, and tax workflows for accounting firms and tax preparers with AI-powered document and compliance tools.',
  alternates: { canonical: '/solutions/accounting-tax-services' },
};
...
export default function AccountingTaxServicesSolutionsPage() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-950">
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 pb-12 pt-16 sm:px-6 sm:pt-20 lg:px-8">
        ...
        <div className="max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
            Streamline document intake, automate reconciliation, generate financial reports, and
            manage compliance workflows for accounting firms and tax preparers.
          </p>
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-slate-700/70 bg-slate-900/65 p-6 shadow-lg shadow-black/20 sm:p-8">
          <h2 className="text-xl font-bold text-white">
            Featured AI Apps for Accounting & Tax Services
          </h2>
          <p className="mt-2 text-slate-300">
            Production-ready tools for bookkeeping, reconciliation, and compliance.
          </p>
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-slate-700/70 bg-gradient-to-br from-slate-900/80 to-slate-950/70 p-6 sm:p-10">
          ...
          <h2 className="mt-2 text-2xl font-bold text-white">Common Accounting & Tax Services Workflows</h2>
          <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="rounded-2xl border border-slate-700/70 bg-slate-950/65 p-5">
              <h3 className="font-semibold text-white">Document Processing</h3>
              <p className="mt-2 text-sm text-slate-300">
                Automate data extraction from invoices, receipts, and tax documents. Reduce manual data entry and errors.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700/70 bg-slate-950/65 p-5">
              <h3 className="font-semibold text-white">Tax Prep & Compliance</h3>
              <p className="mt-2 text-sm text-slate-300">
                Automate tax preparation workflows and compliance checks. Speed up filing and reduce audit risk.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700/70 bg-slate-950/65 p-5">
              <h3 className="font-semibold text-white">Client Onboarding</h3>
              <p className="mt-2 text-sm text-slate-300">
                Automate intake, document collection, and engagement letters. Speed up onboarding and improve experience.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700/70 bg-slate-950/65 p-5">
              <h3 className="font-semibold text-white">Reporting & Analytics</h3>
              <p className="mt-2 text-sm text-slate-300">
                Automate financial reporting and client dashboards. Improve insights and reduce manual report generation.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-purple-500/20 bg-slate-900/65 p-6 sm:p-8">
          ...
          <h2 className="mt-2 text-xl font-bold text-white">Accounting Firm Cuts Tax Prep Time 45%</h2>
          <p className="mt-2 text-slate-300">
            An accounting firm deployed Zion AI Document Processor and Report Generator to automate document extraction and tax preparation. Prep time dropped 45% while accuracy improved.
          </p>
          <a
            href="/case-studies"
      ...
      <SolutionPageFAQ
        ...
        items={SOLUTION_FAQS['accounting-tax-services'] ?? []}
      />
