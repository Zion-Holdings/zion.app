...
export const metadata = {
  ...
  alternates: { canonical: '/solutions/non-profit-social-impact' },
};
...
export default function NonProfitSocialImpactSolutionsPage() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-950">
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 pb-12 pt-16 sm:px-6 sm:pt-20 lg:px-8">
        ...
        <div className="max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
            Automate donor communications, manage volunteer coordination, and generate impact
            reports with limited resources using AI-powered workflows.
          </p>
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-slate-700/70 bg-slate-900/65 p-6 shadow-lg shadow-black/20 sm:p-8">
          <h2 className="text-xl font-bold text-white">
            Featured AI Apps for Non-Profit & Social Impact
          </h2>
          <p className="mt-2 text-slate-300">
            Production-ready tools for outreach, engagement, and impact reporting.
          </p>
          <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
            {nonProfitApps.map((app) => (
              <a
                key={app.href}
                href={app.href}
      ...
      <SolutionPageFAQ
        industryName="Non-Profit & Social Impact"
        items={SOLUTION_FAQS['non-profit-social-impact'] ?? []}
      />
