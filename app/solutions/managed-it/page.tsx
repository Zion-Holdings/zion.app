...
export const metadata: Metadata = {
  title: 'Managed IT Solutions | Zion Tech Group',
    description: 'Managed IT, support operations, and enterprise service-delivery solutions.',
    openGraph: {
    title: 'Managed IT Solutions | Zion Tech Group',
...
export default function ManagedItSolutionsPage() {
  return (
    <StandardPage
      title="Managed IT"
      subtitle="Support operations, service desks, and reliable enterprise delivery."
      breadcrumbItems={[
        { label: 'Home', href: '/' },
