...
export const metadata = {
  title: 'Electronics & Semiconductors AI Solutions | Zion Tech Group',
  description:
    'Streamline yield optimization and supply chain visibility for electronics and semiconductor operations with AI-powered workflows.',
  alternates: { canonical: '/solutions/electronics-semiconductors' },
};

const electronicsApps = [
...
export default function ElectronicsSemiconductorsSolutionsPage() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-950">
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 pb-12 pt-16 sm:px-6 sm:pt-20 lg:px-8">
        ...
        <div className="max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
            Improve demand forecasting, predictive maintenance for equipment, quality assurance, and
            compliance workflows for electronics and semiconductor operations.
          </p>
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-slate-700/70 bg-slate-900/65 p-6 shadow-lg shadow-black/20 sm:p-8">
          <h2 className="text-xl font-bold text-white">
            Featured AI Apps for Electronics & Semiconductors
          </h2>
          <p className="mt-2 text-slate-300">
            Production-ready tools for yield optimization, quality assurance, and supply chain visibility.
          </p>
          <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
            {electronicsApps.map((app) => (
              <a
                key={app.href}
                href={app.href}
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-slate-700/70 bg-gradient-to-br from-slate-900/80 to-slate-950/70 p-6 sm:p-10">
          ...
          <h2 className="mt-2 text-2xl font-bold text-white">Common Electronics & Semiconductors Workflows</h2>
          <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="rounded-2xl border border-slate-700/70 bg-slate-950/65 p-5">
              <h3 className="font-semibold text-white">Yield & Quality Optimization</h3>
              <p className="mt-2 text-sm text-slate-300">
                Analyze defect patterns and process data. Improve yield and reduce scrap.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700/70 bg-slate-950/65 p-5">
              <h3 className="font-semibold text-white">Supply Chain & Procurement</h3>
              <p className="mt-2 text-sm text-slate-300">
                Optimize component sourcing, inventory, and supplier management. Reduce supply chain risk.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700/70 bg-slate-950/65 p-5">
              <h3 className="font-semibold text-white">Predictive Maintenance</h3>
              <p className="mt-2 text-sm text-slate-300">
                Monitor fab equipment and predict failures. Reduce unplanned downtime and extend tool life.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700/70 bg-slate-950/65 p-5">
              <h3 className="font-semibold text-white">Compliance & Documentation</h3>
              <p className="mt-2 text-sm text-slate-300">
                Automate traceability, compliance reporting, and documentation. Maintain audit trails.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-purple-500/20 bg-slate-900/65 p-6 sm:p-8">
          ...
          <h2 className="mt-2 text-xl font-bold text-white">Semiconductor Fab Improves Yield 18%</h2>
          <p className="mt-2 text-slate-300">
            A semiconductor fab deployed Zion AI Quality Assurance and Predictive Maintenance to improve defect detection and equipment reliability. Yield improved 18% while downtime decreased.
          </p>
          <a
            href="/case-studies"
      ...
      <SolutionPageFAQ
        industryName="Electronics & Semiconductors"
        items={SOLUTION_FAQS['electronics-semiconductors'] ?? []}
      />
