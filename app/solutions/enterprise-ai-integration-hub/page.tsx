...
export const metadata: Metadata = {
  title: "Enterprise AI Integration Hub | Zion Tech Group",
  description: "Discover how our Enterprise AI Integration Hub solution delivers measurable outcomes with faster deployment and lower operational risk.",
  alternates: {
    canonical: `https://ziontechgroup.com/solutions/enterprise-ai-integration-hub`,
  },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-4xl font-bold mb-4">Enterprise AI Integration Hub</h1>
