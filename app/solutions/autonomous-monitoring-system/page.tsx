...
export const metadata: Metadata = {
  title: "Autonomous Monitoring System | Zion Tech Group",
  description: "Discover how our Autonomous Monitoring System solution delivers measurable outcomes with faster deployment and lower operational risk.",
  alternates: {
    canonical: `https://ziontechgroup.com/solutions/autonomous-monitoring-system`,
  },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-4xl font-bold mb-4">Autonomous Monitoring System</h1>
