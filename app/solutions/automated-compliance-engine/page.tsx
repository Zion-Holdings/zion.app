...
export const metadata: Metadata = {
  ...
  description: "Discover how our Automated Compliance Engine solution delivers measurable outcomes with faster deployment and lower operational risk.",
  alternates: {
    canonical: `https://ziontechgroup.com/solutions/automated-compliance-engine`,
  },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-4xl font-bold mb-4">Automated Compliance Engine</h1>
