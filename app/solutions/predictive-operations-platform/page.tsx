...
export const metadata: Metadata = {
  title: "Predictive Operations Platform | Zion Tech Group",
  description: "Discover how our Predictive Operations Platform solution delivers measurable outcomes with faster deployment and lower operational risk.",
  alternates: {
    canonical: `https://ziontechgroup.com/solutions/predictive-operations-platform`,
  },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-4xl font-bold mb-4">Predictive Operations Platform</h1>
