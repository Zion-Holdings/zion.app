...
export const metadata = {
  title: 'Asset Management & Investment AI Solutions | Zion Tech Group',
  description:
    'Portfolio analytics, risk assessment, and compliance reporting for asset managers and wealth advisors. Deploy AI-powered workflows for investment firms.',
  alternates: { canonical: '/solutions/asset-management' },
};
    ...
    <div className="relative min-h-screen overflow-hidden bg-slate-950">
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 pb-12 pt-16 sm:px-6 sm:pt-20 lg:px-8">
        <Breadcrumb
          items={[
            ...
            { label: 'Asset Management & Investment' },
          ]}
          className="mb-6"
        />
        <div className="max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
            Portfolio analytics, risk assessment, and compliance reporting for asset managers and wealth advisors.
            Deploy AI-powered workflows for fraud detection, regulatory reporting, and client communications.
          </p>
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-slate-700/70 bg-slate-900/65 p-6 shadow-lg shadow-black/20 sm:p-8">
          <h2 className="text-xl font-bold text-white">Featured AI Apps for Asset Management</h2>
          <p className="mt-2 text-slate-300">
            Production-ready tools for portfolio analytics, compliance, risk assessment, and client reporting.
          </p>
          <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
            {assetManagementApps.map((app) => (
              <a
                key={app.href}
                href={app.href}
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-slate-700/70 bg-gradient-to-br from-slate-900/80 to-slate-950/70 p-6 sm:p-10">
          ...
          <h2 className="mt-2 text-2xl font-bold text-white">Common Asset Management Workflows</h2>
          <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="rounded-2xl border border-slate-700/70 bg-slate-950/65 p-5">
              <h3 className="font-semibold text-white">Portfolio Analytics</h3>
              <p className="mt-2 text-sm text-slate-300">
                Analyze performance, attribution, and risk across portfolios. Automate reporting and client communications.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700/70 bg-slate-950/65 p-5">
              <h3 className="font-semibold text-white">Fraud & Risk Detection</h3>
              <p className="mt-2 text-sm text-slate-300">
                Detect anomalies, fraud patterns, and compliance gaps. Protect assets and meet regulatory requirements.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700/70 bg-slate-950/65 p-5">
              <h3 className="font-semibold text-white">Compliance & Reporting</h3>
              <p className="mt-2 text-sm text-slate-300">
                Automate regulatory filings, audit trails, and client reporting. Reduce manual effort and errors.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700/70 bg-slate-950/65 p-5">
              <h3 className="font-semibold text-white">Contract & Document Analysis</h3>
              <p className="mt-2 text-sm text-slate-300">
                Extract terms, compare agreements, and surface risks. Speed up due diligence and onboarding.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-purple-500/20 bg-slate-900/65 p-6 sm:p-8">
          ...
          <h2 className="mt-2 text-xl font-bold text-white">Asset Manager Automates Client Reporting 45%</h2>
          <p className="mt-2 text-slate-300">
            An asset management firm deployed Zion AI Report Generator and Compliance Manager to automate client reporting and regulatory filings. Reporting time dropped 45% while improving accuracy.
          </p>
          <a
            href="/case-studies"
      ...
      <SolutionPageFAQ
        ...
        items={SOLUTION_FAQS['asset-management'] ?? []}
      />
