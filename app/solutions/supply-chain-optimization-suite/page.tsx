...
export const metadata: Metadata = {
  title: "Supply Chain Optimization Suite | Zion Tech Group",
  description: "Discover how our Supply Chain Optimization Suite solution delivers measurable outcomes with faster deployment and lower operational risk.",
  alternates: {
    canonical: `https://ziontechgroup.com/solutions/supply-chain-optimization-suite`,
  },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-4xl font-bold mb-4">Supply Chain Optimization Suite</h1>
