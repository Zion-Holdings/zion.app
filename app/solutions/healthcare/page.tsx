...
eexport const metadata = { title: 'Healthcare Solutions', description: 'AI and IT solutions for healthcare. Medical imaging, clinical decision support, EHR integration, telemedicine, HIPAA compliance.' };
