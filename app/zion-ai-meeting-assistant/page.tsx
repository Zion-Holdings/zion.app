...
export const metadata: Metadata = {
  ...
  description: 'AI meeting assistant that transcribes conversations, extracts action items, and syncs with calendar and project tools.',
  alternates: { canonical: '/zion-ai-meeting-assistan/' },
};
