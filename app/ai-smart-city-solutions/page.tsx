...
export const metadata = {
  ...
  description:
    'AI Smart City Solutions connects physical operations with intelligent digital systems. Process sensor data at the edge, automate responses in real time, an',
  alternates: { canonical: '/ai-smart-city-solutions' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Smart City Solutions connects physical operations with intelligent digital systems. Process sensor data at the edge, automate responses in real time, and gain visibility across distributed environments.',
        iconEmoji: '📡',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy AI Smart City Solutions to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use AI Smart City Solutions to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage AI Smart City Solutions analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with AI Smart City Solutions',
      }}
    />
  );
}
