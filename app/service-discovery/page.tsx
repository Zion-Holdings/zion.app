    ...
    <main className="min-h-screen bg-slate-950">
      ...
      <section className="relative overflow-hidden pt-32 pb-24">
        ...
        <div className="relative container-page text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-900/30 border border-purple-500/30 text-purple-300 text-sm mb-6">
            <span className="text-green-400">●</span> Industry-Specific Solutions
          </div>
          <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
            <span className="gradient-text">AI Solutions for Your Industry</span>
          </h1>
          <p className="text-xl text-slate-300 mb-10 max-w-3xl mx-auto leading-relaxed">
            Discover AI, IT, and automation services tailored to your industry's unique challenges.
            Get personalized recommendations with ROI projections.
          </p>
        </div>
      </section>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {INDUSTRIES.map((industry) => (
              <button
                ...
                className="text-left glass-card group hover:border-purple-500/40 transition-all duration-300"
              >
      ...
      {industryData && (
        <section className="py-20">
          <div className="container-page">
            <h2 className="text-2xl font-bold text-white mb-6">{industryData.label} Solutions</h2>
            <p className="text-slate-400 mb-8">{INDUSTRY_RECOMMENDATIONS[selectedIndustry]?.title || 'Recommended Services'}</p>
            ...
            <div className="text-center mt-12">
              ...
              >
                View All {industryData.label} Services →
              </Link>
            </div>
          </div>
        </section>
