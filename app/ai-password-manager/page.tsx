...
export const metadata = {
  ...
  description:
    'AI Password Manager provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audi',
  alternates: { canonical: '/ai-password-manager' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Password Manager provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit readiness with AI-driven threat detection and policy enforcement.',
        iconEmoji: '🔑',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Password Manager',
      }}
    />
  );
}
