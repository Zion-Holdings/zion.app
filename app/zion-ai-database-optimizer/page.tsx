...
export const metadata: Metadata = {
  ...
  description: 'AI-powered database optimization platform that improves query performance, reduces storage costs, and automates maintenance.',
  alternates: { canonical: '/zion-ai-database-optimizer/' },
};
