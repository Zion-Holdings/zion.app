...
export const metadata = {
  title: "Governments | Zion Tech Group Partnerships & Solutions",
  description: "Public-sector missions: identity, compliance, and infrastructure. Explore government agencies recommendations from our catalog.",
  alternates: { canonical: '/governments/' }
};

export default function Page() {
  const rows = [{"title":"Micro-SAAS AI Cybersecurity Monitor","category":"security","price":"$149/mo"},{"title":"Micro-SAAS AI Project Manager","category":"automation","price":"$49/mo"},{"title":"Micro-SAAS AI Vulnerability Scanner","category":"security","price":"$199/mo"},{"title":"Micro-SAAS AI Smart Data Backup","category":"cloud","price":"$29/mo"},{"title":"AI Workplace Safety & Compliance Monitor","category":"security","price":"$149/location/mo"}];
  return (
    <main className="min-h-screen bg-slate-950">
      <div className="container-page py-20">
        <div className="max-w-5xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-3">🏛️ Governments</h1>
          <p className="text-slate-300 mb-8 max-w-2xl">Public-sector missions: identity, compliance, and infrastructure.</p>
