...
export const metadata = {
  ...
  description:
    'Zion Project Master streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to ',
  alternates: { canonical: '/zion-project-master' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion Project Master streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focus on strategic work.',
        iconEmoji: '📋',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion Project Master',
      }}
    />
  );
}
