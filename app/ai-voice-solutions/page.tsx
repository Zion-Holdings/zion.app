...
export const metadata = {
  title: 'AI Voice Solutions | Zion Tech Group',
  description:
    'AI Voice Solutions enhances team communication and content workflows with AI-powered language processing, automated transcription, and intelligent translat',
  alternates: { canonical: '/ai-voice-solutions' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Voice Solutions enhances team communication and content workflows with AI-powered language processing, automated transcription, and intelligent translation across channels and languages.',
        iconEmoji: '🗣️',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy AI Voice Solutions to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use AI Voice Solutions to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage AI Voice Solutions analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with AI Voice Solutions',
      }}
    />
  );
}
