...
export const metadata = {
  ...
  alternates: { canonical: '/zion-ai-meeting-transcriber' },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'Zion AI Meeting Transcriber',
        category: 'Language & Communication',
        description:
          'Zion AI Meeting Transcriber enhances team communication and content workflows with AI-powered language processing, automated transcription, and intelligent translation across channels and languages.',
        iconEmoji: '🗣️',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy Zion AI Meeting Transcriber to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use Zion AI Meeting Transcriber to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage Zion AI Meeting Transcriber analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with Zion AI Meeting Transcriber',
      }}
    />
  );
}
