...
export const metadata = {
  ...
  description:
    'Database Management transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, mo',
  alternates: { canonical: '/database-management' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Database Management transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more confident decisions backed by production-grade analytics.',
        iconEmoji: '📊',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Database Management',
      }}
    />
  );
}
