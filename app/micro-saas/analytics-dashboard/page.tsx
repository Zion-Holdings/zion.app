...
export const metadata = {
  ...
  description:
    'Analytics Dashboard transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, mo',
  alternates: { canonical: '/micro-saas/analytics-dashboard' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Analytics Dashboard transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more confident decisions backed by production-grade analytics.',
        iconEmoji: '📊',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Analytics Dashboard',
      }}
    />
  );
}
