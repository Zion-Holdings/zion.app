...
export const metadata = {
  ...
  description:
    'AI Inventory Manager streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to',
  alternates: { canonical: '/micro-saas/ai-inventory-manager' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Inventory Manager streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focus on strategic work.',
        iconEmoji: '📋',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Inventory Manager',
      }}
    />
  );
}
