...
export const metadata = {
  ...
  description:
    'Lead Scoring empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data ',
  alternates: { canonical: '/micro-saas/lead-scoring' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Lead Scoring empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Lead Scoring',
      }}
    />
  );
}
