...
export const metadata = {
  ...
  description:
    'AI Expense Tracker streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to f',
  alternates: { canonical: '/micro-saas/ai-expense-tracker' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Expense Tracker streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focus on strategic work.',
        iconEmoji: '📋',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Expense Tracker',
      }}
    />
  );
}
