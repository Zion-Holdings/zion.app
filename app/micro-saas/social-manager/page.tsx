...
export const metadata = {
  ...
  description:
    'Social Manager empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn dat',
  alternates: { canonical: '/micro-saas/social-manager' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Social Manager empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Social Manager',
      }}
    />
  );
}
