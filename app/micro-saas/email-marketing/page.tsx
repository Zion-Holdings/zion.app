...
export const metadata = {
  ...
  description:
    'Email Marketing empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn da',
  alternates: { canonical: '/micro-saas/email-marketing' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Email Marketing empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
