...
export const metadata = {
  ...
  description:
    'Chat Analytics transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more co',
  alternates: { canonical: '/micro-saas/chat-analytics' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Chat Analytics transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more confident decisions backed by production-grade analytics.',
        iconEmoji: '📊',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Chat Analytics',
      }}
    />
  );
}
