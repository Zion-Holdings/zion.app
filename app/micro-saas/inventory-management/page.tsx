...
export const metadata = {
  title: 'Inventory Management | Zion Tech Group',
  description:
    'Inventory Management streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to',
  alternates: { canonical: '/micro-saas/inventory-management' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Inventory Management streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focus on strategic work.',
        iconEmoji: '📋',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Inventory Management',
      }}
    />
  );
}
