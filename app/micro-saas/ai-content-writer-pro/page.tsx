...
export const metadata = {
  ...
  description:
    'AI Content Writer Pro empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. T',
  alternates: { canonical: '/micro-saas/ai-content-writer-pro' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Content Writer Pro empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Content Writer Pro',
      }}
    />
  );
}
