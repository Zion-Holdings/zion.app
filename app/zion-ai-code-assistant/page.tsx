...
export const metadata: Metadata = {
  ...
  description: 'AI code assistant that helps developers write, debug, and refactor code across 30+ programming languages.',
  alternates: { canonical: '/zion-ai-code-assistan/' },
};
