...
export const metadata = {
  ...
  openGraph: {
    title: 'Time Series Analytics for IoT: Ingest, Store, and Query Sensor Data at Scale: 2026 Playbook checklist for IT and security leaders',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/time-series-analytics-for-iot-ingest-store-and-query-sensor-data-at-scale-2026-playbook-checklist-for-it-and-security-leaders/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/time-series-analytics-for-iot-ingest-store-and-query-sensor-data-at-scale-2026-playbook-checklist-for-it-and-security-leaders/' },
};

const jsonLd = {"@context": "https://schema.org/", "@type": "TechArticle", "headline": "{title}", "description": "{description}", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "{NOW_ISO}", "dateModified": "{NOW_ISO}", "mainEntityOfPage": "{canonical}", "wordCount": 1865};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Time Series Analytics for IoT: Ingest, Store, and Query Sensor Data at Scale: 2026 Playbook checklist for IT and security leaders' }]} className="mb-8" />
