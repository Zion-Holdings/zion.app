...
export const metadata = {
  ...
  description: 'Data Privacy Engineering: Anonymization, Tokenization, and Differential Privacy: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/blog/data-privacy-engineering-anonymization-tokenization-differential-privacy',
  },
};
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'Data Privacy Engineering: Anonymization, Tokenization, and Differential Privacy' }
          ]}
          className="mb-8"
        />
        ...
        <header className="mb-12">
          ...
          <p className="mt-4 text-lg text-slate-300">Data Privacy Engineering: Anonymization, Tokenization, and Differential Privacy requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
