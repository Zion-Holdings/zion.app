...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Cloud Migration Services: case study | Zion Tech Group" description="Cloud Migration Services: case study" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/cloud-migration-services-case-study/" />
