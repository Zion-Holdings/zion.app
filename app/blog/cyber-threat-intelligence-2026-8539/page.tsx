...
export default function Page() {
  return (
    <PageShell title="Cyber Threat Intelligence" description="Practical guide to cyber threat intelligence: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/cyber-threat-intelligence-2026-8539/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/cyber-threat-intelligence-2026-8539/'
    }}>
