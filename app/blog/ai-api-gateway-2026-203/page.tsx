...
export const metadata = {
  ...
  alternates: { canonical: '/blog/ai-api-gateway-2026-203/' },
  openGraph: { title: 'AI API Gateway', description: 'Practical guide to ai api gateway.', url: 'https://ziontechgroup.com/blog/ai-api-gateway-2026-203/', type: 'article' },
  twitter: { card: 'summary_large_image', title: 'AI API Gateway', description: 'Practical guide to ai api gateway.' }
};

export default function Page() {
  return (
    <PageShell title="AI API Gateway" description="Practical guide to ai api gateway: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/ai-api-gateway-2026-203/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/ai-api-gateway-2026-203/'
    }}>
