...
export const metadata = {
  ...
  openGraph: {
    title: 'Attack Surface Management: Continuous Discovery and Exposure Validation: 2026 Playbook: policy, compliance, and vendor management',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/attack-surface-management-continuous-discovery-and-exposure-validation-2026-playbook-policy-compliance-and-vendor-management/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/attack-surface-management-continuous-discovery-and-exposure-validation-2026-playbook-policy-compliance-and-vendor-management/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Attack Surface Management: Continuous Discovery and Exposure Validation: 2026 Playbook: policy, compliance, and vendor management' }]} className="mb-8" />
