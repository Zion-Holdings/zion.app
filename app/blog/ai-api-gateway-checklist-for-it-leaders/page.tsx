...
export const metadata = {
  ...
  openGraph: {
    title: 'AI API Gateway: checklist for IT leaders | Zion Tech Group',
    description: 'AI API Gateway: checklist for IT leaders.',
    url: 'https://ziontechgroup.comapp/blog/ai-api-gateway-checklist-for-it-leaders/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/ai-api-gateway-checklist-for-it-leaders/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'AI API Gateway: checklist for IT leaders',
  description: 'AI API Gateway: checklist for IT leaders.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/ai-api-gateway-checklist-for-it-leaders/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'AI API Gateway: checklist for IT leaders' },
      ]}
    >
