...
export const metadata = {
  ...
  openGraph: {
    title: 'Comparing Endpoint Detection and Response for Remote Workers: Beyond VPN Protection: vendors and build vs buy: 2026 Playbook',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/comparing-endpoint-detection-and-response-for-remote-workers-beyond-vpn-protection-vendors-and-build-vs-buy-2026-playbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/comparing-endpoint-detection-and-response-for-remote-workers-beyond-vpn-protection-vendors-and-build-vs-buy-2026-playbook/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Comparing Endpoint Detection and Response for Remote Workers: Beyond VPN Protection: vendors and build vs buy: 2026 Playbook' }]} className="mb-8" />
