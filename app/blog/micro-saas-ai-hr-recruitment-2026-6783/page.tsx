...
export default function Page() {
  return (
    <PageShell title="MicroSaaS HR Recruitment" description="Practical guide to microsaas hr recruitment: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/micro-saas-ai-hr-recruitment-2026-6783/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/micro-saas-ai-hr-recruitment-2026-6783/'
    }}>
