...
export const metadata = {
  title: 'AI construction automation: costs, ROI, and hidden risks | Zion Tech Group',
  description: 'AI construction automation: costs, ROI, and hidden risks',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'AI construction automation: costs, ROI, and hidden risks',
    description: 'AI construction automation: costs, ROI, and hidden risks',
    url: 'https://ziontechgroup.com/blog/ai-construction-automation-3/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-construction-automation-3/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AI construction automation: costs, ROI, and hidden risks", "description": "AI construction automation: costs, ROI, and hidden risks", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T12:58:57Z", "dateModified": "2026-08-04T12:58:57Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ai-construction-automation-3/", "wordCount": 2067};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI construction automation: costs, ROI, and hidden risks' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AI construction automation: costs, ROI, and hidden risks</h1>
          <p className="mt-4 text-lg text-slate-300">AI construction automation: costs, ROI, and hidden risks</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/ai-education-technology-2">Ai Education Technology 2</Link></li>
