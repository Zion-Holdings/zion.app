...
export const metadata = {
  ...
  openGraph: {
    title: 'Automation and scaling patterns for Comparing AI Network Detection and Response for Hybrid Infrastructures: vendors and build vs buy',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/automation-and-scaling-patterns-for-comparing-ai-network-detection-and-response-for-hybrid-infrastructures-vendors-and-build-vs-buy/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/automation-and-scaling-patterns-for-comparing-ai-network-detection-and-response-for-hybrid-infrastructures-vendors-and-build-vs-buy/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Automation and scaling patterns for Comparing AI Network Detection and Response for Hybrid Infrastructures: vendors and build vs buy' }]} className="mb-8" />
