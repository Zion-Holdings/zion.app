...
export const metadata = {
  title: 'Data Architecture: evaluation framework | Zion Tech Group',
  description: 'Data Architecture: evaluation framework',
  keywords: ['data', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Data Architecture: evaluation framework',
    description: 'Data Architecture: evaluation framework',
    url: 'https://ziontechgroup.com/blog/data-architecture-evaluation-framework/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/data-architecture-evaluation-framework/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Data Architecture: evaluation framework", "description": "Data Architecture: evaluation framework", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:12:15Z", "dateModified": "2026-08-06T18:12:15Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/data-architecture-evaluation-framework/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Data Architecture: evaluation framework' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Data Architecture: evaluation framework</h1>
          <p className="mt-4 text-lg text-slate-300">Data Architecture: evaluation framework</p>
