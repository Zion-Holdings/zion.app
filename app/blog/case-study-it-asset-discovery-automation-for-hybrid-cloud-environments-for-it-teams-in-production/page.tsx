...
export const metadata = {
  ...
  openGraph: {
    title: 'Case study: IT Asset Discovery Automation for Hybrid Cloud Environments for it teams in production',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/case-study-it-asset-discovery-automation-for-hybrid-cloud-environments-for-it-teams-in-production/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/case-study-it-asset-discovery-automation-for-hybrid-cloud-environments-for-it-teams-in-production/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Case study: IT Asset Discovery Automation for Hybrid Cloud Environments for it teams in production' }]} className="mb-8" />
