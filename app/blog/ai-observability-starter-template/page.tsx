...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI Observability: starter template | Zion Tech Group" description="AI Observability: starter template" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-observability-starter-template/" />
