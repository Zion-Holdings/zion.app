...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="API Security Testing: checklist for IT leaders | Zion Tech Group" description="API Security Testing: checklist for IT leaders" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/api-security-testing-checklist-for-it-leaders/" />
