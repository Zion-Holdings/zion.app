...
export const metadata = {
  ...
  description: 'AI Accessibility Auditor: operations handbook',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AI Accessibility Auditor: operations handbook", "description": "AI Accessibility Auditor: operations handbook", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-17T17:20:18Z", "dateModified": "2026-08-17T17:20:18Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ai-accessibility-auditor-operations-handbook/"};
  ...
  return (
    ...
    >
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Accessibility Auditor: operations handbook' }]} className="mb-8" />
        <header className="mb-10">
          ...
          <p className="mt-4 text-lg text-slate-300">AI Accessibility Auditor: operations handbook</p>
