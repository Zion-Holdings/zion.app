...
export const metadata = {
  title: 'Vector Database: automation roadmap | Zion Tech Group',
  description: 'Vector Database: automation roadmap',
  keywords: ['data', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Vector Database: automation roadmap',
    description: 'Vector Database: automation roadmap',
    url: 'https://ziontechgroup.com/blog/vector-database-automation-roadmap/',
    type: 'article',
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Vector Database: automation roadmap' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Vector Database: automation roadmap</h1>
          <p className="mt-4 text-lg text-slate-300">Vector Database: automation roadmap</p>
