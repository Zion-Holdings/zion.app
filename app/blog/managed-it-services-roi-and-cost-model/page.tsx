...
<li><Link href="/blog/graphql-federation-platform-2026-132">Graphql Federation Platform 2026 132</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
