...
<li><Link href="/blog/ai-agent-tool-builder-2026-651">Ai Agent Tool Builder 2026 651</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
