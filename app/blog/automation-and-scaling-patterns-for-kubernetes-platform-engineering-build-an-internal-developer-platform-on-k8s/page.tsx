...
export const metadata = {
  ...
  openGraph: {
    ...
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/automation-and-scaling-patterns-for-kubernetes-platform-engineering-build-an-internal-developer-platform-on-k8s/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/automation-and-scaling-patterns-for-kubernetes-platform-engineering-build-an-internal-developer-platform-on-k8s/' },
};
