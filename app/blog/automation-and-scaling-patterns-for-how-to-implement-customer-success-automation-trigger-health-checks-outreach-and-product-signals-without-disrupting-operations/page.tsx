...
export const metadata = {
  ...
  openGraph: {
    title: 'Automation and scaling patterns for How to implement Customer Success Automation: Trigger Health Checks, Outreach, and Product Signals without disrupting operations',
    description: 'Health-based playbooks and intervention timing',
    url: 'https://ziontechgroup.com/blog/automation-and-scaling-patterns-for-how-to-implement-customer-success-automation-trigger-health-checks-outreach-and-product-signals-without-disrupting-operations/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/automation-and-scaling-patterns-for-how-to-implement-customer-success-automation-trigger-health-checks-outreach-and-product-signals-without-disrupting-operations/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Automation and scaling patterns for How to implement Customer Success Automation: Trigger Health Checks, Outreach, and Product Signals without disrupting operations' }]} className="mb-8" />
