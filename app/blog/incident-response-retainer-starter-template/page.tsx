        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/ai-agent-safety-evaluation-2026-4238">Ai Agent Safety Evaluation 2026 4238</Link></li>
<li><Link href="/blog/ai-autonomous-agents-2026-1688">Ai Autonomous Agents 2026 1688</Link></li>
<li><Link href="/blog/api-management-gateway-security-and-governance">Api Management Gateway Security And Governance</Link></li>
<li><Link href="/blog/5g-solutions-2026-3464">5G Solutions 2026 3464</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
