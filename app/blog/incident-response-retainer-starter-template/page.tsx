...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Incident Response Retainer: starter template | Zion Tech Group" description="Incident Response Retainer: starter template" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/incident-response-retainer-starter-template/" />
