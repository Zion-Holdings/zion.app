...
export const metadata = {
  title: 'Digital Twin: starter template | Zion Tech Group',
  description: 'Digital Twin: starter template',
  keywords: ['ai', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Digital Twin: starter template',
    description: 'Digital Twin: starter template',
    url: 'https://ziontechgroup.com/blog/digital-twin-starter-template/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/digital-twin-starter-template/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Digital Twin: starter template", "description": "Digital Twin: starter template", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:43:30Z", "dateModified": "2026-08-06T18:43:30Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/digital-twin-starter-template/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Digital Twin: starter template' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Digital Twin: starter template</h1>
          <p className="mt-4 text-lg text-slate-300">Digital Twin: starter template</p>
...
<li><Link /blog/infrastructure-monitoring-vendor-evaluation/>Infrastructure Monitoring Vendor Evaluation</Link></li>
