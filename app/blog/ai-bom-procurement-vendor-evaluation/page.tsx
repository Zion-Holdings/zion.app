...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI BOM Procurement: vendor evaluation | Zion Tech Group" description="AI BOM Procurement: vendor evaluation" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-bom-procurement-vendor-evaluation/" />
