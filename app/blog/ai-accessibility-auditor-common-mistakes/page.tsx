...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI Accessibility Auditor: common mistakes | Zion Tech Group" description="AI Accessibility Auditor: common mistakes" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-accessibility-auditor-common-mistakes/" />
