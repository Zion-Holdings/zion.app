...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI BOM Procurement: ROI and cost model | Zion Tech Group" description="AI BOM Procurement: ROI and cost model" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-bom-procurement-roi-and-cost-model/" />
