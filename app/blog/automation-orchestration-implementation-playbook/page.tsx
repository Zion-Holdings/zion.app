        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/ai-api-gateway-2026-3170">Ai Api Gateway 2026 3170</Link></li>
<li><Link href="/blog/ai-bom-procurement-2026-3213">Ai Bom Procurement 2026 3213</Link></li>
<li><Link href="/blog/5g-solutions-2026-2084">5G Solutions 2026 2084</Link></li>
<li><Link href="/blog/api-gateway-management-2026-664">Api Gateway Management 2026 664</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
