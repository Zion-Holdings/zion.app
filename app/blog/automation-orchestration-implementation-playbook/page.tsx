...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Automation Orchestration: implementation playbook | Zion Tech Group" description="Automation Orchestration: implementation playbook" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/automation-orchestration-implementation-playbook/" />
