...
export const metadata = {
  ...
  openGraph: {
    title: 'Automation and scaling patterns for Data Contracts for Analytics Engineering: Enforce Schema and Quality Between Teams for data teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/automation-and-scaling-patterns-for-data-contracts-for-analytics-engineering-enforce-schema-and-quality-between-teams-for-data-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/automation-and-scaling-patterns-for-data-contracts-for-analytics-engineering-enforce-schema-and-quality-between-teams-for-data-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Automation and scaling patterns for Data Contracts for Analytics Engineering: Enforce Schema and Quality Between Teams for data teams' }]} className="mb-8" />
