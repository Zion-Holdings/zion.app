...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI Customer Support: case study | Zion Tech Group" description="AI Customer Support: case study" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-customer-support-case-study/" />
