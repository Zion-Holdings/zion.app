...
<li><Link /blog/ai-data-lakehouse-pipelines-evaluation-framework/>Ai Data Lakehouse Pipelines Evaluation Framework</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
