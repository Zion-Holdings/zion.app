...
export const metadata: Metadata = {
  ...
  description: 'Implementation patterns, risks, and next steps for incident response automation 2026.',
  openGraph: {
    title: 'Incident Response Automation 2026 | Zion Tech Group',
...
<>
    <StandardPage
      title="Incident Response Automation 2026"
      subtitle="Practical guidance for implementation, governance, and delivery."
      breadcrumbItems={[
        { label: 'Home', href: '/' },
        { label: 'Blog', href: '/blog/' },
        { label: 'Incident Response Automation 2026' },
      ]}
      actions={[
