...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Cybersecurity for MSPs: ROI and cost model | Zion Tech Group" description="Cybersecurity for MSPs: ROI and cost model" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/cybersecurity-for-msps-roi-and-cost-model/" />
