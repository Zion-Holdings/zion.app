...
export const metadata = {
  ...
  openGraph: {
    title: 'Case study: AI Security Operations Center Modernization for MSSPs in production for security teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/case-study-ai-security-operations-center-modernization-for-mssps-in-production-for-security-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/case-study-ai-security-operations-center-modernization-for-mssps-in-production-for-security-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Case study: AI Security Operations Center Modernization for MSSPs in production for security teams' }]} className="mb-8" />
