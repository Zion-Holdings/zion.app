...
export const metadata = {
  ...
  openGraph: {
    title: 'Automation and scaling patterns for Email and Calendar Automation with AI Agents: Schedule, Follow Up, and Summarize: 2026 Playbook',
    description: 'Practical workflow integration instead of generic assistant demos',
    url: 'https://ziontechgroup.com/blog/automation-and-scaling-patterns-for-email-and-calendar-automation-with-ai-agents-schedule-follow-up-and-summarize-2026-playbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/automation-and-scaling-patterns-for-email-and-calendar-automation-with-ai-agents-schedule-follow-up-and-summarize-2026-playbook/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Automation and scaling patterns for Email and Calendar Automation with AI Agents: Schedule, Follow Up, and Summarize: 2026 Playbook' }]} className="mb-8" />
