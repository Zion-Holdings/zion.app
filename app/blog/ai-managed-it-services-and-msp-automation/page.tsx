...
export const metadata = {
  title: 'Ai Managed It Services And Msp Automation | Zion Tech Group',
  description: 'Ai Managed It Services And Msp Automation: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
    title: 'Ai Managed It Services And Msp Automation',
    description: 'Ai Managed It Services And Msp Automation: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
    url: 'https://ziontechgroup.com/blog/ai-managed-it-services-and-msp-automation',
    type: 'article',
  },
  alternates: {
    canonical: 'https://ziontechgroup.com/blog/ai-managed-it-services-and-msp-automation',
  },
};
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'Ai Managed It Services And Msp Automation' }
          ]}
          className="mb-8"
        />
        ...
        <header className="mb-12">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Ai Managed It Services And Msp Automation</h1>
          <p className="mt-4 text-lg text-slate-300">Ai Managed It Services And Msp Automation requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
