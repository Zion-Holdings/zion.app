...
export const metadata = {
  title: 'Automation and scaling patterns for AI audit compliance | Zion Tech Group',
  description: 'Automation and scaling patterns for AI audit compliance',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Automation and scaling patterns for AI audit compliance',
    description: 'Automation and scaling patterns for AI audit compliance',
    url: 'https://ziontechgroup.com/blog/ai-audit-compliance-9/',
    type: 'article',
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Automation and scaling patterns for AI audit compliance' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Automation and scaling patterns for AI audit compliance</h1>
          <p className="mt-4 text-lg text-slate-300">Automation and scaling patterns for AI audit compliance</p>
