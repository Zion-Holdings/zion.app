...
export const metadata = {
  title: 'Continuous Integration: architecture overview | Zion Tech Group',
  description: 'Continuous Integration: architecture overview',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Continuous Integration: architecture overview',
    description: 'Continuous Integration: architecture overview',
    url: 'https://ziontechgroup.com/blog/continuous-integration-architecture-overview/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/continuous-integration-architecture-overview/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Continuous Integration: architecture overview", "description": "Continuous Integration: architecture overview", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T19:54:37Z", "dateModified": "2026-08-06T19:54:37Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/continuous-integration-architecture-overview/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Continuous Integration: architecture overview' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Continuous Integration: architecture overview</h1>
          <p className="mt-4 text-lg text-slate-300">Continuous Integration: architecture overview</p>
...
<li><Link /blog/identity-access-management-policy-and-compliance/>Identity Access Management Policy And Compliance</Link></li>
<li><Link /blog/api-monetization-security-and-governance/>Api Monetization Security And Governance</Link></li>
<li><Link /blog/continuous-deployment-common-mistakes/>Continuous Deployment Common Mistakes</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
