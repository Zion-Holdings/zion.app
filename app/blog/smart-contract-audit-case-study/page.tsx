...
export const metadata = {
  ...
  openGraph: {
    title: 'Smart Contract Audit: case study | Zion Tech Group',
    description: 'Smart Contract Audit: case study.',
    url: 'https://ziontechgroup.comapp/blog/smart-contract-audit-case-study/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/smart-contract-audit-case-study/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'Smart Contract Audit: case study',
  description: 'Smart Contract Audit: case study.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/smart-contract-audit-case-study/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'Smart Contract Audit: case study' },
      ]}
    >
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <section className="prose prose-invert max-w-none">
          ...
          <p className="text-slate-300 mb-6">Smart Contract Audit: case study. Organizations benefit from clearer requirements, tighter governance, and repeatable delivery models.</p>
