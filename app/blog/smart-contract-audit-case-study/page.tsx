...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Smart Contract Audit: case study | Zion Tech Group" description="Smart Contract Audit: case study" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/smart-contract-audit-case-study/" />
