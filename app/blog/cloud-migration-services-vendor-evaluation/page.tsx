...
export const metadata = {
  ...
  openGraph: {
    title: 'Cloud Migration Services: vendor evaluation',
    description: 'Cloud Migration Services: vendor evaluation - AI and IT insights from Zion Tech Group.',
    url: 'https://ziontechgroup.com/blog/cloud-migration-services-2026/2026/2026/vendor-evaluation/',
    type: 'article',
  },
  alternates: { canonical: '/blog/cloud-migration-services-2026/2026/2026/vendor-evaluation/' },
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'Cloud Migration Services: vendor evaluation' },
      ]}
    >
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <header className="mb-10">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Cloud Migration Services: vendor evaluation | Zion Tech Group</h1>
