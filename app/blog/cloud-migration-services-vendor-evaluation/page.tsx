...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Cloud Migration Services: vendor evaluation | Zion Tech Group" description="Cloud Migration Services: vendor evaluation" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/cloud-migration-services-vendor-evaluation/" />
