...
export const metadata = {
  ...
  openGraph: {
    ...
    description: 'Event Driven Architecture: vendor evaluation',
    url: 'https://ziontechgroup.com/blog/event-driven-architecture-vendor-evaluation/',
    type: 'article',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Event Driven Architecture: vendor evaluation", "description": "Event Driven Architecture: vendor evaluation", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:15:34Z", "dateModified": "2026-08-04T16:15:34Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/event-driven-architecture-vendor-evaluation/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Event Driven Architecture: vendor evaluation' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Event Driven Architecture: vendor evaluation</h1>
          <p className="mt-4 text-lg text-slate-300">Event Driven Architecture: vendor evaluation</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/etl-pipeline-optimization-2026-1440">Etl Pipeline Optimization 2026 1440</Link></li>
<li><Link href="/blog/ai-observability-2026-4081">Ai Observability 2026 4081</Link></li>
