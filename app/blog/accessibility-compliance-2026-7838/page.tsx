...
export const metadata = {
  ...
  alternates: { canonical: '/blog/accessibility-compliance-2026-7838/' },
  openGraph: { title: 'Accessibility Compliance', description: 'Practical guide to accessibility compliance.', url: 'https://ziontechgroup.com/blog/accessibility-compliance-2026-7838/', type: 'article' },
...
export default function Page() {
  return (
    <PageShell title="Accessibility Compliance" description="Practical guide to accessibility compliance: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/accessibility-compliance-2026-7838/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/accessibility-compliance-2026-7838/'
    }}>
