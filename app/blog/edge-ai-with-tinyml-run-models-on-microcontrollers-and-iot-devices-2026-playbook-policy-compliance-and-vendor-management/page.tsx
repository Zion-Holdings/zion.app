...
export const metadata = {
  ...
  openGraph: {
    title: 'Edge AI with TinyML: Run Models on Microcontrollers and IoT Devices: 2026 Playbook: policy, compliance, and vendor management',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/edge-ai-with-tinyml-run-models-on-microcontrollers-and-iot-devices-2026-playbook-policy-compliance-and-vendor-management/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/edge-ai-with-tinyml-run-models-on-microcontrollers-and-iot-devices-2026-playbook-policy-compliance-and-vendor-management/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Edge AI with TinyML: Run Models on Microcontrollers and IoT Devices: 2026 Playbook: policy, compliance, and vendor management' }]} className="mb-8" />
