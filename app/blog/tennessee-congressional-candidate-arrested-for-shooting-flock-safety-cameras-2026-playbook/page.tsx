...
export const metadata = {
  ...
  openGraph: {
    title: 'Tennessee Congressional Candidate Arrested for Shooting Flock Safety Cameras: 2026 Playbook',
    description: 'Live web-researched high-intent buyer topic',
    url: 'https://ziontechgroup.com/blog/tennessee-congressional-candidate-arrested-for-shooting-flock-safety-cameras-2026-playbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/tennessee-congressional-candidate-arrested-for-shooting-flock-safety-cameras-2026-playbook/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Tennessee Congressional Candidate Arrested for Shooting Flock Safety Cameras: 2026 Playbook' }]} className="mb-8" />
