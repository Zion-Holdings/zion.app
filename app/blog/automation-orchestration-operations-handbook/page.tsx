...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Automation Orchestration: operations handbook | Zion Tech Group" description="Automation Orchestration: operations handbook" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/automation-orchestration-operations-handbook/" />
