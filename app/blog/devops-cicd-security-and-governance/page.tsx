...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="DevOps CI/CD: security and governance | Zion Tech Group" description="DevOps CI/CD: security and governance" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/devops-cicd-security-and-governance/" />
