...
export const metadata = {
  ...
  openGraph: {
    title: 'DevOps CI/CD: security and governance | Zion Tech Group',
    description: 'DevOps CI/CD: security and governance.',
    url: 'https://ziontechgroup.comapp/blog/devops-cicd-security-and-governance/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/devops-cicd-security-and-governance/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'DevOps CI/CD: security and governance',
  description: 'DevOps CI/CD: security and governance.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/devops-cicd-security-and-governance/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'DevOps CI/CD: security and governance' },
      ]}
    >
