...
export const metadata = {
  ...
  openGraph: {
    title: 'IT Asset Discovery Automation for Hybrid Cloud Environments checklist for IT and security leaders: policy, compliance, and vendor management',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/it-asset-discovery-automation-for-hybrid-cloud-environments-checklist-for-it-and-security-leaders-policy-compliance-and-vendor-management/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/it-asset-discovery-automation-for-hybrid-cloud-environments-checklist-for-it-and-security-leaders-policy-compliance-and-vendor-management/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'IT Asset Discovery Automation for Hybrid Cloud Environments checklist for IT and security leaders: policy, compliance, and vendor management' }]} className="mb-8" />
