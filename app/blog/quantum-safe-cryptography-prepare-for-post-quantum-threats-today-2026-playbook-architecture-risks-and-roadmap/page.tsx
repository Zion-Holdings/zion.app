...
export const metadata = {
  ...
  openGraph: {
    title: 'Quantum-Safe Cryptography: Prepare for Post-Quantum Threats Today: 2026 Playbook: architecture, risks, and roadmap',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/quantum-safe-cryptography-prepare-for-post-quantum-threats-today-2026-playbook-architecture-risks-and-roadmap/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/quantum-safe-cryptography-prepare-for-post-quantum-threats-today-2026-playbook-architecture-risks-and-roadmap/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Quantum-Safe Cryptography: Prepare for Post-Quantum Threats Today: 2026 Playbook: architecture, risks, and roadmap' }]} className="mb-8" />
