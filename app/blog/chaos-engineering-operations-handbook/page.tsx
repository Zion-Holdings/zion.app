...
export const metadata = {
  ...
  openGraph: {
    title: 'Chaos Engineering: operations handbook',
    description: 'Chaos Engineering: operations handbook',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Chaos Engineering: operations handbook", "description": "Chaos Engineering: operations handbook", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-30T04:40:57Z", "dateModified": "2026-08-30T04:40:57Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/chaos-engineering-operations-handbook/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: "Home", href: "/" }, { label: "Blog", href: "/blog/" }, { label: "Chaos Engineering: operations handbook" }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Chaos Engineering: operations handbook</h1>
          <p className="mt-4 text-lg text-slate-300">Chaos Engineering: operations handbook</p>
