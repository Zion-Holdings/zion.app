...
export const metadata = {
  ...
  openGraph: {
    title: 'Comparing Attack Surface Management: Continuous Discovery and Exposure Validation: vendors and build vs buy for security teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/comparing-attack-surface-management-continuous-discovery-and-exposure-validation-vendors-and-build-vs-buy-for-security-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/comparing-attack-surface-management-continuous-discovery-and-exposure-validation-vendors-and-build-vs-buy-for-security-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Comparing Attack Surface Management: Continuous Discovery and Exposure Validation: vendors and build vs buy for security teams' }]} className="mb-8" />
