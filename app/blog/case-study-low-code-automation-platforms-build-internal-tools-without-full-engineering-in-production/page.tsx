...
export const metadata = {
  ...
  openGraph: {
    ...
    description: 'Case study: Low-Code Automation Platforms: Build Internal Tools Without Full Engineering in production',
    url: 'https://ziontechgroup.com/blog/case-study-low-code-automation-platforms-build-internal-tools-without-full-engineering-in-production/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'https://ziontechgroup.com/blog/case-study-low-code-automation-platforms-build-internal-tools-without-full-engineering-in-production/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Case study: Low-Code Automation Platforms: Build Internal Tools Without Full Engineering in production", "description": "Case study: Low-Code Automation Platforms: Build Internal Tools Without Full Engineering in production", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-03T22:37:21Z", "dateModified": "2026-08-03T22:37:21Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/case-study-low-code-automation-platforms-build-internal-tools-without-full-engineering-in-production/", "wordCount": 2180};
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/edge-ai-tinyml-run-models-microcontrollers-iot-devices">Edge Ai Tinyml Run Models Microcontrollers Iot Devices</Link></li><li><Link href="/blog/vulnerability-management-prioritization-cvss-not-enough-exploitability-scoring">Vulnerability Management Prioritization Cvss Not Enough Exploitability Scoring</Link></li><li><Link href="/blog/invoice-processing-automation-from-receipt-to-payment-ai-extraction">Invoice Processing Automation From Receipt To Payment Ai Extraction</Link></li><li><Link href="/blog/distributed-tracing-with-jaeger-and-zipkin-debug-microservices-without-log-dumps">Distributed Tracing With Jaeger And Zipkin Debug Microservices Without Log Dumps</Link></li>
              ...
              <li><Link href="/blog/how-to-implement-ai-security-operations-center-modernization-for-mssps-without-disrupting-operations">How To Implement Ai Security Operations Center Modernization For Mssps Without Disrupting Operations</Link></li>
