...
export const metadata = {
  ...
  alternates: { canonical: '/blog/event-driven-architecture-2026-6754/' },
  openGraph: { title: 'Event Driven Architecture', description: 'Practical guide to event driven architecture.', url: 'https://ziontechgroup.com/blog/event-driven-architecture-2026-6754/', type: 'article' },
...
export default function Page() {
  return (
    <PageShell title="Event Driven Architecture" description="Practical guide to event driven architecture: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/event-driven-architecture-2026-6754/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/event-driven-architecture-2026-6754/'
    }}>
