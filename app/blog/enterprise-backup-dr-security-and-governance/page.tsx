...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Enterprise Backup DR: security and governance", "description": "Enterprise Backup DR: security and governance", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:24:55Z", "dateModified": "2026-08-04T16:24:55Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/enterprise-backup-dr-security-and-governance/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Enterprise Backup DR: security and governance' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Enterprise Backup DR: security and governance</h1>
          <p className="mt-4 text-lg text-slate-300">Enterprise Backup DR: security and governance</p>
...
<li><Link href="/blog/network-infrastructure-2026-1810">Network Infrastructure 2026 1810</Link></li>
<li><Link href="/blog/micro-saas-ai-translation-engine-2026-2848">Micro Saas Ai Translation Engine 2026 2848</Link></li>
<li><Link href="/blog/micro-saas-ai-expense-tracker-2026-1193">Micro Saas Ai Expense Tracker 2026 1193</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
