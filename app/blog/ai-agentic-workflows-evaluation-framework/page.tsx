...
export const metadata = {
  ...
  description: 'AI Agentic Workflows: evaluation framework',
  keywords: ['data', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'AI Agentic Workflows: evaluation framework',
    description: 'AI Agentic Workflows: evaluation framework',
    url: 'https://ziontechgroup.com/blog/ai-agentic-workflows-evaluation-framework/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-agentic-workflows-evaluation-framework/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AI Agentic Workflows: evaluation framework", "description": "AI Agentic Workflows: evaluation framework", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:12:43Z", "dateModified": "2026-08-04T16:12:43Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ai-agentic-workflows-evaluation-framework/"};
    ...
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AI Agentic Workflows: evaluation framework</h1>
          <p className="mt-4 text-lg text-slate-300">AI Agentic Workflows: evaluation framework</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/database-migration-service-2026-1227">Database Migration Service 2026 1227</Link></li>
<li><Link href="/blog/cybersecurity-platform-msp-2026-693">Cybersecurity Platform Msp 2026 693</Link></li>
<li><Link href="/blog/5g-solutions-2026-4292">5G Solutions 2026 4292</Link></li>
<li><Link href="/blog/it-consulting-2026-2223">It Consulting 2026 2223</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
