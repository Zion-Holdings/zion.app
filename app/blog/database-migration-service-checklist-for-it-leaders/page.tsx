...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Database Migration Service: checklist for IT leaders | Zion Tech Group" description="Database Migration Service: checklist for IT leaders" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/database-migration-service-checklist-for-it-leaders/" />
