...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="DevSecOps Pipeline: common mistakes | Zion Tech Group" description="DevSecOps Pipeline: common mistakes" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/devsecops-pipeline-common-mistakes/" />
