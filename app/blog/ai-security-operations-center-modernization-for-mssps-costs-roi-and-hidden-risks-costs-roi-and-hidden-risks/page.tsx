...
export const metadata = {
  ...
  openGraph: {
    title: 'AI Security Operations Center Modernization for MSSPs: costs, ROI, and hidden risks: costs, ROI, and hidden risks',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/ai-security-operations-center-modernization-for-mssps-costs-roi-and-hidden-risks-costs-roi-and-hidden-risks/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-security-operations-center-modernization-for-mssps-costs-roi-and-hidden-risks-costs-roi-and-hidden-risks/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Security Operations Center Modernization for MSSPs: costs, ROI, and hidden risks: costs, ROI, and hidden risks' }]} className="mb-8" />
