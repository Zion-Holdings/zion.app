...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Brand Voice Guardian: checklist for IT leaders | Zion Tech Group" description="Brand Voice Guardian: checklist for IT leaders" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/brand-voice-guardian-checklist-for-it-leaders/" />
