...
export const metadata = {
  ...
  openGraph: {
    title: 'DevOps CI/CD: vendor evaluation',
    description: 'DevOps CI/CD: vendor evaluation',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "DevOps CI/CD: vendor evaluation", "description": "DevOps CI/CD: vendor evaluation", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-07T14:32:52Z", "dateModified": "2026-08-07T14:32:52Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/devops-cicd-vendor-evaluation/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'DevOps CI/CD: vendor evaluation' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">DevOps CI/CD: vendor evaluation</h1>
          <p className="mt-4 text-lg text-slate-300">DevOps CI/CD: vendor evaluation</p>
