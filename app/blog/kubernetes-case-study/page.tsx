...
export const metadata = {
  title: 'Kubernetes: case study | Zion Tech Group',
  description: 'Kubernetes: case study',
  keywords: ['cloud', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Kubernetes: case study',
    description: 'Kubernetes: case study',
    url: 'https://ziontechgroup.com/blog/kubernetes-case-study/',
    type: 'article',
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Kubernetes: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Kubernetes: case study</h1>
          <p className="mt-4 text-lg text-slate-300">Kubernetes: case study</p>
...
<li><Link /blog/release-management-case-study/>Release Management Case Study</Link></li>
<li><Link /blog/digital-twin-architecture-overview/>Digital Twin Architecture Overview</Link></li>
<li><Link /blog/aws-cost-optimization-security-and-governance/>Aws Cost Optimization Security And Governance</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
