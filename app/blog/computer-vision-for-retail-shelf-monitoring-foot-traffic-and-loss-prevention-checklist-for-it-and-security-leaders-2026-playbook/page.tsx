...
export const metadata = {
  ...
  openGraph: {
    title: 'Computer Vision for Retail: Shelf Monitoring, Foot Traffic, and Loss Prevention checklist for IT and security leaders: 2026 Playbook',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/computer-vision-for-retail-shelf-monitoring-foot-traffic-and-loss-prevention-checklist-for-it-and-security-leaders-2026-playbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/computer-vision-for-retail-shelf-monitoring-foot-traffic-and-loss-prevention-checklist-for-it-and-security-leaders-2026-playbook/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Computer Vision for Retail: Shelf Monitoring, Foot Traffic, and Loss Prevention checklist for IT and security leaders: 2026 Playbook' }]} className="mb-8" />
