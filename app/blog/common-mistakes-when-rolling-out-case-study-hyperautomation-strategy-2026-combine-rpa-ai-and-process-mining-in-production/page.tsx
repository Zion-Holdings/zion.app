...
export const metadata = {
  ...
  openGraph: {
    title: 'Common mistakes when rolling out Case study: Hyperautomation Strategy 2026: Combine RPA, AI, and Process Mining in production',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/common-mistakes-when-rolling-out-case-study-hyperautomation-strategy-2026-combine-rpa-ai-and-process-mining-in-production/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/common-mistakes-when-rolling-out-case-study-hyperautomation-strategy-2026-combine-rpa-ai-and-process-mining-in-production/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Common mistakes when rolling out Case study: Hyperautomation Strategy 2026: Combine RPA, AI, and Process Mining in production' }]} className="mb-8" />
