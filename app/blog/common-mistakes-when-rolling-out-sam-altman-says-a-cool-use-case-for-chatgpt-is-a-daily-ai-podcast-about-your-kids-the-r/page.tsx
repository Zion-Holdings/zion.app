...
export const metadata = {
  ...
  openGraph: {
    title: 'Common mistakes when rolling out Sam Altman says a 'cool use case' for ChatGPT is a daily AI podcast about your kids. The r',
    description: 'Live web-researched high-intent buyer topic',
    url: 'https://ziontechgroup.com/blog/common-mistakes-when-rolling-out-sam-altman-says-a-cool-use-case-for-chatgpt-is-a-daily-ai-podcast-about-your-kids-the-r/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/common-mistakes-when-rolling-out-sam-altman-says-a-cool-use-case-for-chatgpt-is-a-daily-ai-podcast-about-your-kids-the-r/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Common mistakes when rolling out Sam Altman says a 'cool use case' for ChatGPT is a daily AI podcast about your kids. The r' }]} className="mb-8" />
