...
export const metadata = {
  ...
  openGraph: {
    title: 'Case study: Software Supply Chain Security: SBOM, Signing, and Provenance in 2026 for security teams in production',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/case-study-software-supply-chain-security-sbom-signing-and-provenance-in-2026-for-security-teams-in-production/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/case-study-software-supply-chain-security-sbom-signing-and-provenance-in-2026-for-security-teams-in-production/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Case study: Software Supply Chain Security: SBOM, Signing, and Provenance in 2026 for security teams in production' }]} className="mb-8" />
