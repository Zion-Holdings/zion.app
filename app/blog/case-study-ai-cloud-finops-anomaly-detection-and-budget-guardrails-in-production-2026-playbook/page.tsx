...
export const metadata = {
  ...
  openGraph: {
    title: 'Case study: AI Cloud FinOps: Anomaly Detection and Budget Guardrails in production: 2026 Playbook',
    description: 'Finance and engineering collaboration with automated alerts',
    url: 'https://ziontechgroup.com/blog/case-study-ai-cloud-finops-anomaly-detection-and-budget-guardrails-in-production-2026-playbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/case-study-ai-cloud-finops-anomaly-detection-and-budget-guardrails-in-production-2026-playbook/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Case study: AI Cloud FinOps: Anomaly Detection and Budget Guardrails in production: 2026 Playbook' }]} className="mb-8" />
