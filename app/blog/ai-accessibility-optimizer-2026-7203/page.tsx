...
export const metadata = {
  ...
  alternates: { canonical: '/blog/ai-accessibility-optimizer-2026-7203/' },
  openGraph: { title: 'AI Accessibility Optimizer', description: 'Practical guide to ai accessibility optimizer.', url: 'https://ziontechgroup.com/blog/ai-accessibility-optimizer-2026-7203/', type: 'article' },
...
export default function Page() {
  return (
    <PageShell title="AI Accessibility Optimizer" description="Practical guide to ai accessibility optimizer: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/ai-accessibility-optimizer-2026-7203/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/ai-accessibility-optimizer-2026-7203/'
    }}>
