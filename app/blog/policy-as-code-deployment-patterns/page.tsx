...
export const metadata = {
  title: 'Policy as Code: deployment patterns | Zion Tech Group',
  description: 'Policy as Code: deployment patterns',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Policy as Code: deployment patterns',
    description: 'Policy as Code: deployment patterns',
    url: 'https://ziontechgroup.com/blog/policy-as-code-deployment-patterns/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/policy-as-code-deployment-patterns/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Policy as Code: deployment patterns' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Policy as Code: deployment patterns</h1>
          <p className="mt-4 text-lg text-slate-300">Policy as Code: deployment patterns</p>
