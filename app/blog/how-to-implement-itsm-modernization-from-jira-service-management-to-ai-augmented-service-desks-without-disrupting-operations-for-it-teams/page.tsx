...
export const metadata = {
  ...
  openGraph: {
    title: 'How to implement ITSM Modernization: From Jira Service Management to AI-Augmented Service Desks without disrupting operations for it teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/how-to-implement-itsm-modernization-from-jira-service-management-to-ai-augmented-service-desks-without-disrupting-operations-for-it-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/how-to-implement-itsm-modernization-from-jira-service-management-to-ai-augmented-service-desks-without-disrupting-operations-for-it-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'How to implement ITSM Modernization: From Jira Service Management to AI-Augmented Service Desks without disrupting operations for it teams' }]} className="mb-8" />
