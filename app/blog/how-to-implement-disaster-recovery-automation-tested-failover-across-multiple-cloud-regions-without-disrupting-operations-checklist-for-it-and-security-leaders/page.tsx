...
export const metadata = {
  ...
  openGraph: {
    title: 'How to implement Disaster Recovery Automation: Tested Failover Across Multiple Cloud Regions without disrupting operations checklist for IT and security leaders',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/how-to-implement-disaster-recovery-automation-tested-failover-across-multiple-cloud-regions-without-disrupting-operations-checklist-for-it-and-security-leaders/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/how-to-implement-disaster-recovery-automation-tested-failover-across-multiple-cloud-regions-without-disrupting-operations-checklist-for-it-and-security-leaders/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'How to implement Disaster Recovery Automation: Tested Failover Across Multiple Cloud Regions without disrupting operations checklist for IT and security leaders' }]} className="mb-8" />
