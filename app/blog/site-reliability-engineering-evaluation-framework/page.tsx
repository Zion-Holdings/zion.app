...
export const metadata = {
  title: 'Site Reliability Engineering: evaluation framework | Zion Tech Group',
  description: 'Site Reliability Engineering: evaluation framework',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Site Reliability Engineering: evaluation framework',
    description: 'Site Reliability Engineering: evaluation framework',
    url: 'https://ziontechgroup.com/blog/site-reliability-engineering-evaluation-framework/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/site-reliability-engineering-evaluation-framework/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Site Reliability Engineering: evaluation framework", "description": "Site Reliability Engineering: evaluation framework", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:12:35Z", "dateModified": "2026-08-06T18:12:35Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/site-reliability-engineering-evaluation-framework/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Site Reliability Engineering: evaluation framework' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Site Reliability Engineering: evaluation framework</h1>
          <p className="mt-4 text-lg text-slate-300">Site Reliability Engineering: evaluation framework</p>
