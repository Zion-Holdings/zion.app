...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="API Management Gateway: policy and compliance | Zion Tech Group" description="API Management Gateway: policy and compliance" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/api-management-gateway-policy-and-compliance/" />
