...
export const metadata = {
  ...
  openGraph: {
    title: 'Cloud Migration Services: architecture overview | Zion Tech Group',
    description: 'Cloud Migration Services: architecture overview.',
    url: 'https://ziontechgroup.com/blog/cloud-migration-services-2026/architecture-overview/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/cloud-migration-services-2026/architecture-overview/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'Cloud Migration Services: architecture overview',
  description: 'Cloud Migration Services: architecture overview.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.com/blog/cloud-migration-services-2026/architecture-overview/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'Cloud Migration Services: architecture overview' },
      ]}
    >
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <section className="prose prose-invert max-w-none">
          ...
          <p className="text-slate-300 mb-6">Cloud Migration Services: architecture overview. Organizations benefit from clearer requirements, tighter governance, and repeatable delivery models.</p>
