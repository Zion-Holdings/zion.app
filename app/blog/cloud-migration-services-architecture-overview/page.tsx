...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Cloud Migration Services: architecture overview | Zion Tech Group" description="Cloud Migration Services: architecture overview" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/cloud-migration-services-architecture-overview/" />
