...
export const metadata = {
  ...
  openGraph: {
    title: 'AI Data Lakehouse Pipelines: evaluation framework | Zion Tech Group',
    description: 'AI Data Lakehouse Pipelines: evaluation framework.',
    url: 'https://ziontechgroup.comapp/blog/ai-data-lakehouse-pipelines-evaluation-framework/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/ai-data-lakehouse-pipelines-evaluation-framework/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'AI Data Lakehouse Pipelines: evaluation framework',
  description: 'AI Data Lakehouse Pipelines: evaluation framework.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/ai-data-lakehouse-pipelines-evaluation-framework/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'AI Data Lakehouse Pipelines: evaluation framework' },
      ]}
    >
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <section className="prose prose-invert max-w-none">
          ...
          <p className="text-slate-300 mb-6">AI Data Lakehouse Pipelines: evaluation framework. Organizations benefit from clearer requirements, tighter governance, and repeatable delivery models.</p>
