...
export const metadata = {
  ...
  alternates: { canonical: '/blog/database-migration-service-2026-7782/' },
  openGraph: { title: 'Database Migration Service', description: 'Practical guide to database migration service.', url: 'https://ziontechgroup.com/blog/database-migration-service-2026-7782/', type: 'article' },
...
export default function Page() {
  return (
    <PageShell title="Database Migration Service" description="Practical guide to database migration service: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/database-migration-service-2026-7782/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/database-migration-service-2026-7782/'
    }}>
