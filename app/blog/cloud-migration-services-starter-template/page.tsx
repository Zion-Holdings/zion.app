...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Cloud Migration Services: starter template", "description": "Cloud Migration Services: starter template", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:24:20Z", "dateModified": "2026-08-04T16:24:20Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/cloud-migration-services-starter-template/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Cloud Migration Services: starter template' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Cloud Migration Services: starter template</h1>
          <p className="mt-4 text-lg text-slate-300">Cloud Migration Services: starter template</p>
...
<li><Link href="/blog/cloud-cost-optimization-checklist-2026-3728">Cloud Cost Optimization Checklist 2026 3728</Link></li>
<li><Link href="/blog/ai-accessibility-optimizer-2026-2097">Ai Accessibility Optimizer 2026 2097</Link></li>
<li><Link href="/blog/ai-performance-monitoring-2026-1836">Ai Performance Monitoring 2026 1836</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
