...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="DevSecOps Pipeline: starter template | Zion Tech Group" description="DevSecOps Pipeline: starter template" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/devsecops-pipeline-starter-template/" />
