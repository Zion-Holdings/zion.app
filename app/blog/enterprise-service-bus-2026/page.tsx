...
export const metadata = {
  title: 'Enterprise Service Bus | Zion Tech Group',
  ...
  openGraph: {
    ...
    description: 'Enterprise Service Bus',
    url: 'https://ziontechgroup.com/blog/enterprise-service-bus-2026/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/enterprise-service-bus-2026/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Enterprise Service Bus' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Enterprise Service Bus</h1>
          <p className="mt-4 text-lg text-slate-300">Enterprise Service Bus</p>
