...
export const metadata: Metadata = {
  title: 'scaling ai across healthcarelifesciences operations | Zion Tech Group',
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <main className="mx-auto max-w-4xl px-6 py-16">
        <h1 className="text-4xl font-bold">scaling ai across healthcarelifesciences operations</h1>
