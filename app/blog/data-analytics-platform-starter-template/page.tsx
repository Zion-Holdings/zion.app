...
export const metadata = {
  ...
  openGraph: {
    title: 'Data Analytics Platform: starter template | Zion Tech Group',
    description: 'Data Analytics Platform: starter template.',
    url: 'https://ziontechgroup.comapp/blog/data-analytics-platform-starter-template/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/data-analytics-platform-starter-template/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'Data Analytics Platform: starter template',
  description: 'Data Analytics Platform: starter template.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/data-analytics-platform-starter-template/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'Data Analytics Platform: starter template' },
      ]}
    >
