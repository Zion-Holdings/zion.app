...
export const metadata = {
  title: 'Bot Detection: ROI and cost model | Zion Tech Group',
  description: 'Bot Detection: ROI and cost model',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Bot Detection: ROI and cost model',
    description: 'Bot Detection: ROI and cost model',
    url: 'https://ziontechgroup.com/blog/bot-detection-roi-and-cost-model/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/bot-detection-roi-and-cost-model/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Bot Detection: ROI and cost model", "description": "Bot Detection: ROI and cost model", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:10:09Z", "dateModified": "2026-08-06T18:10:09Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/bot-detection-roi-and-cost-model/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Bot Detection: ROI and cost model' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Bot Detection: ROI and cost model</h1>
          <p className="mt-4 text-lg text-slate-300">Bot Detection: ROI and cost model</p>
...
<li><Link href="/blog/performance-testing-executive-guide">Performance Testing Executive Guide</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
