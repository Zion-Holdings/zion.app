...
export const metadata = {
  ...
  openGraph: {
    title: 'Software Supply Chain Security: SBOM, Signing, and Provenance in 2026: costs, ROI, and hidden risks: 2026 Playbook',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/software-supply-chain-security-sbom-signing-and-provenance-in-2026-costs-roi-and-hidden-risks-2026-playbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/software-supply-chain-security-sbom-signing-and-provenance-in-2026-costs-roi-and-hidden-risks-2026-playbook/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Software Supply Chain Security: SBOM, Signing, and Provenance in 2026: costs, ROI, and hidden risks: 2026 Playbook' }]} className="mb-8" />
