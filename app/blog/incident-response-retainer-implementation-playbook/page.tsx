...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Incident Response Retainer: implementation playbook | Zion Tech Group" description="Incident Response Retainer: implementation playbook" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/incident-response-retainer-implementation-playbook/" />
