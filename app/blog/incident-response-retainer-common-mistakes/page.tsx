...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Incident Response Retainer: common mistakes | Zion Tech Group" description="Incident Response Retainer: common mistakes" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/incident-response-retainer-common-mistakes/" />
