...
export const metadata = {
  title: 'How to implement AI hospitality automation without disrupting operations | Zion Tech Group',
  description: 'How to implement AI hospitality automation without disrupting operations',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'How to implement AI hospitality automation without disrupting operations',
    description: 'How to implement AI hospitality automation without disrupting operations',
    url: 'https://ziontechgroup.com/blog/ai-hospitality-automation-2/',
    type: 'article',
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'How to implement AI hospitality automation without disrupting operations' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">How to implement AI hospitality automation without disrupting operations</h1>
          <p className="mt-4 text-lg text-slate-300">How to implement AI hospitality automation without disrupting operations</p>
