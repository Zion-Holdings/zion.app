...
export const metadata = {
  title: 'Observability Platform: evaluation framework | Zion Tech Group',
  description: 'Observability Platform: evaluation framework',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Observability Platform: evaluation framework',
    description: 'Observability Platform: evaluation framework',
    url: 'https://ziontechgroup.com/blog/observability-platform-evaluation-framework/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/observability-platform-evaluation-framework/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Observability Platform: evaluation framework", "description": "Observability Platform: evaluation framework", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:24:54Z", "dateModified": "2026-08-06T18:24:54Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/observability-platform-evaluation-framework/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Observability Platform: evaluation framework' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Observability Platform: evaluation framework</h1>
          <p className="mt-4 text-lg text-slate-300">Observability Platform: evaluation framework</p>
...
<li><Link href="/blog/cost-optimization-starter-template">Cost Optimization Starter Template</Link></li>
<li><Link href="/blog/observability-platform-policy-and-compliance">Observability Platform Policy And Compliance</Link></li>
