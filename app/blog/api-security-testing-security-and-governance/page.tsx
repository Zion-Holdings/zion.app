...
const jsonLd = {
  ...
  '@type': 'TechArticle',
  headline: 'API Security Testing: security and governance',
  description: 'API Security Testing: security and governance.',
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'API Security Testing: security and governance' },
      ]}
    >
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <section className="prose prose-invert max-w-none">
          ...
          <p className="text-slate-300 mb-6">API Security Testing: security and governance. Organizations benefit from clearer requirements, tighter governance, and repeatable delivery models.</p>
