...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Managed IT Services | Zion Tech Group" description="Managed IT Services" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/managed-it-services-small-business-2026/" />
