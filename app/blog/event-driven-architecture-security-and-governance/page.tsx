...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Event Driven Architecture: security and governance | Zion Tech Group" description="Event Driven Architecture: security and governance" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/event-driven-architecture-security-and-governance/" />
