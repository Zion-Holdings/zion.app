...
export const metadata = {
  ...
  openGraph: {
    title: 'Event Driven Architecture: security and governance',
    description: 'Event Driven Architecture: security and governance',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Event Driven Architecture: security and governance", "description": "Event Driven Architecture: security and governance", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:39:52Z", "dateModified": "2026-08-04T16:39:52Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/event-driven-architecture-security-and-governance/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Event Driven Architecture: security and governance' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Event Driven Architecture: security and governance</h1>
          <p className="mt-4 text-lg text-slate-300">Event Driven Architecture: security and governance</p>
...
<li><Link href="/blog/database-migration-service-2026-1917">Database Migration Service 2026 1917</Link></li>
