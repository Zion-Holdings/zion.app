        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link /blog/cloud-governance-policy-and-compliance/>Cloud Governance Policy And Compliance</Link></li>
<li><Link /blog/multi-cloud-strategy-operations-handbook/>Multi Cloud Strategy Operations Handbook</Link></li>
<li><Link /blog/product-analytics-architecture-overview/>Product Analytics Architecture Overview</Link></li>
