...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="MicroSaaS HR Recruitment: architecture overview | Zion Tech Group" description="MicroSaaS HR Recruitment: architecture overview" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/microsaas-hr-recruitment-architecture-overview/" />
