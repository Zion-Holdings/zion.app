...
export default function Page() {
  return (
    <PageShell title="API Security Testing" description="Practical guide to api security testing: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/api-security-testing-2026-8486/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/api-security-testing-2026-8486/'
    }}>
