...
export const metadata = {
  title: 'AI government services checklist for IT and security leaders | Zion Tech Group',
  description: 'AI government services checklist for IT and security leaders',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'AI government services checklist for IT and security leaders',
    description: 'AI government services checklist for IT and security leaders',
    url: 'https://ziontechgroup.com/blog/ai-government-services-8/',
    type: 'article',
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI government services checklist for IT and security leaders' }]} className="mb-8" />
        <header className="mb-10">
          ...
          <p className="mt-4 text-lg text-slate-300">AI government services checklist for IT and security leaders</p>
