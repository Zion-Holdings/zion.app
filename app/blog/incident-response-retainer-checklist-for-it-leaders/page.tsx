...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Incident Response Retainer: checklist for IT leaders | Zion Tech Group" description="Incident Response Retainer: checklist for IT leaders" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/incident-response-retainer-checklist-for-it-leaders/" />
