...
export const metadata = {
  ...
  openGraph: {
    title: 'Common mistakes when rolling out ICE Collected Nearly 1 Million People’s DNA Last Year—Including Young Children',
    description: 'Live web-researched high-intent buyer topic',
    url: 'https://ziontechgroup.com/blog/common-mistakes-when-rolling-out-ice-collected-nearly-1-million-people-s-dna-last-year-including-young-children/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/common-mistakes-when-rolling-out-ice-collected-nearly-1-million-people-s-dna-last-year-including-young-children/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Common mistakes when rolling out ICE Collected Nearly 1 Million People’s DNA Last Year—Including Young Children' }]} className="mb-8" />
