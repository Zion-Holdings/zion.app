...
export const metadata = {
  title: 'AI Risk Assessment: operations handbook | Zion Tech Group',
  description: 'AI Risk Assessment: operations handbook',
  keywords: ['ai', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'AI Risk Assessment: operations handbook',
    description: 'AI Risk Assessment: operations handbook',
    url: 'https://ziontechgroup.com/blog/ai-risk-assessment-operations-handbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-risk-assessment-operations-handbook/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AI Risk Assessment: operations handbook", "description": "AI Risk Assessment: operations handbook", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:03:55Z", "dateModified": "2026-08-06T18:03:55Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ai-risk-assessment-operations-handbook/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Risk Assessment: operations handbook' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AI Risk Assessment: operations handbook</h1>
          <p className="mt-4 text-lg text-slate-300">AI Risk Assessment: operations handbook</p>
