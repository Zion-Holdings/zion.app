...
export const metadata = {
  title: 'Process Automation: starter template | Zion Tech Group',
  description: 'Process Automation: starter template',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Process Automation: starter template',
    description: 'Process Automation: starter template',
    url: 'https://ziontechgroup.com/blog/process-automation-starter-template/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/process-automation-starter-template/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Process Automation: starter template", "description": "Process Automation: starter template", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T19:54:27Z", "dateModified": "2026-08-06T19:54:27Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/process-automation-starter-template/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Process Automation: starter template' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Process Automation: starter template</h1>
          <p className="mt-4 text-lg text-slate-300">Process Automation: starter template</p>
...
<li><Link /blog/data-compliance-operations-handbook/>Data Compliance Operations Handbook</Link></li>
<li><Link /blog/ai-bom-procurement-common-mistakes/>Ai Bom Procurement Common Mistakes</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
