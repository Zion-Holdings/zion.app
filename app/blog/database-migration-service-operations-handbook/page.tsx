...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Database Migration Service: operations handbook | Zion Tech Group" description="Database Migration Service: operations handbook" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/database-migration-service-operations-handbook/" />
