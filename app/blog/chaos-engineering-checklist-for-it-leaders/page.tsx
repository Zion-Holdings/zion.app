...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Chaos Engineering: checklist for IT leaders | Zion Tech Group" description="Chaos Engineering: checklist for IT leaders" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/chaos-engineering-checklist-for-it-leaders/" />
