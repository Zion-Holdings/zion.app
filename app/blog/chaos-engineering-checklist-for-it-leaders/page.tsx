        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/event-driven-architecture-2026-1855">Event Driven Architecture 2026 1855</Link></li>
<li><Link href="/blog/ai-agent-tool-builder-2026-4239">Ai Agent Tool Builder 2026 4239</Link></li>
<li><Link href="/blog/network-infrastructure-2026-4294">Network Infrastructure 2026 4294</Link></li>
