...
export const metadata = {
  ...
  openGraph: {
    title: 'AI Agent Tool Builder: evaluation framework | Zion Tech Group',
    description: 'AI Agent Tool Builder: evaluation framework.',
    url: 'https://ziontechgroup.comapp/blog/ai-agent-tool-builder-evaluation-framework/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/ai-agent-tool-builder-evaluation-framework/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'AI Agent Tool Builder: evaluation framework',
  description: 'AI Agent Tool Builder: evaluation framework.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/ai-agent-tool-builder-evaluation-framework/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'AI Agent Tool Builder: evaluation framework' },
      ]}
    >
