...
export const metadata = {
  title: 'Case study: AI hospitality automation in production | Zion Tech Group',
  description: 'Case study: AI hospitality automation in production',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Case study: AI hospitality automation in production',
    description: 'Case study: AI hospitality automation in production',
    url: 'https://ziontechgroup.com/blog/ai-hospitality-automation-6/',
    type: 'article',
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Case study: AI hospitality automation in production' }]} className="mb-8" />
        <header className="mb-10">
          ...
          <p className="mt-4 text-lg text-slate-300">Case study: AI hospitality automation in production</p>
