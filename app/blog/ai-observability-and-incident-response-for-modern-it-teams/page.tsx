...
export const metadata = {
  ...
  description: 'Ai Observability And Incident Response For Modern It Teams: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
    title: 'Ai Observability And Incident Response For Modern It Teams',
    description: 'Ai Observability And Incident Response For Modern It Teams: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
    url: 'https://ziontechgroup.com/blog/ai-observability-and-incident-response-for-modern-it-teams',
    type: 'article',
  },
  alternates: {
    canonical: 'https://ziontechgroup.com/blog/ai-observability-and-incident-response-for-modern-it-teams',
  },
};
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'Ai Observability And Incident Response For Modern It Teams' }
          ]}
          className="mb-8"
        />
        ...
        <header className="mb-12">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Ai Observability And Incident Response For Modern It Teams</h1>
          <p className="mt-4 text-lg text-slate-300">Ai Observability And Incident Response For Modern It Teams requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
