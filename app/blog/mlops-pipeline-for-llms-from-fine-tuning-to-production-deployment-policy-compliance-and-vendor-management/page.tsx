...
export const metadata = {
  ...
  openGraph: {
    ...
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/mlops-pipeline-for-llms-from-fine-tuning-to-production-deployment-policy-compliance-and-vendor-management/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/mlops-pipeline-for-llms-from-fine-tuning-to-production-deployment-policy-compliance-and-vendor-management/' },
};
