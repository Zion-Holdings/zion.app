...
export const metadata = {
  title: 'GenAI DevOps CI/CD: executive guide | Zion Tech Group',
  description: 'GenAI DevOps CI/CD: executive guide',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'GenAI DevOps CI/CD: executive guide',
    description: 'GenAI DevOps CI/CD: executive guide',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "GenAI DevOps CI/CD: executive guide", "description": "GenAI DevOps CI/CD: executive guide", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:15:18Z", "dateModified": "2026-08-04T16:15:18Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/genai-devops-cicd-executive-guide/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'GenAI DevOps CI/CD: executive guide' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">GenAI DevOps CI/CD: executive guide</h1>
          <p className="mt-4 text-lg text-slate-300">GenAI DevOps CI/CD: executive guide</p>
...
<li><Link href="/blog/network-infrastructure-2026-4018">Network Infrastructure 2026 4018</Link></li>
<li><Link href="/blog/ai-3d-asset-generator-2026-1405">Ai 3D Asset Generator 2026 1405</Link></li>
