...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AI Email Intelligence: operations handbook", "description": "AI Email Intelligence: operations handbook", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:28:45Z", "dateModified": "2026-08-04T16:28:45Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ai-email-intelligence-operations-handbook/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Email Intelligence: operations handbook' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AI Email Intelligence: operations handbook</h1>
          <p className="mt-4 text-lg text-slate-300">AI Email Intelligence: operations handbook</p>
...
<li><Link href="/blog/enterprise-ai-intelligence-hub-2026-3819">Enterprise Ai Intelligence Hub 2026 3819</Link></li>
<li><Link href="/blog/etl-pipeline-optimization-2026-4269">Etl Pipeline Optimization 2026 4269</Link></li>
<li><Link href="/blog/it-consulting-2026-774">It Consulting 2026 774</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
