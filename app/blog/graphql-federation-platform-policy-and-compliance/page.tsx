...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="GraphQL Federation Platform: policy and compliance | Zion Tech Group" description="GraphQL Federation Platform: policy and compliance" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/graphql-federation-platform-policy-and-compliance/" />
