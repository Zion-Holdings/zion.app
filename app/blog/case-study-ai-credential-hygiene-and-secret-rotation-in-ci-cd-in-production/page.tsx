...
export const metadata = {
  ...
  openGraph: {
    ...
    description: 'Case study: AI Credential Hygiene and Secret Rotation in CI/CD in production',
    url: 'https://ziontechgroup.com/blog/case-study-ai-credential-hygiene-and-secret-rotation-in-ci-cd-in-production/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'https://ziontechgroup.com/blog/case-study-ai-credential-hygiene-and-secret-rotation-in-ci-cd-in-production/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Case study: AI Credential Hygiene and Secret Rotation in CI/CD in production", "description": "Case study: AI Credential Hygiene and Secret Rotation in CI/CD in production", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-03T22:37:16Z", "dateModified": "2026-08-03T22:37:16Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/case-study-ai-credential-hygiene-and-secret-rotation-in-ci-cd-in-production/", "wordCount": 1659};
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/channel-partner-reseller-program-ai-services">Channel Partner Reseller Program Ai Services</Link></li><li><Link href="/blog/nebius-partnership-latam-expansion-guide">Nebius Partnership Latam Expansion Guide</Link></li><li><Link href="/blog/ai-first-sase-and-secure-access-for-distributed-it-teams-in-2026">Ai First Sase And Secure Access For Distributed It Teams In 2026</Link></li><li><Link href="/blog/ai-credential-hygiene-and-secret-rotation-for-ci-cd-for-security-teams">Ai Credential Hygiene And Secret Rotation For Ci Cd For Security Teams</Link></li>
