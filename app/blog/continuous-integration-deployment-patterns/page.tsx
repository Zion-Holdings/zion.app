...
export const metadata = {
  title: 'Continuous Integration: deployment patterns | Zion Tech Group',
  description: 'Continuous Integration: deployment patterns',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Continuous Integration: deployment patterns',
    description: 'Continuous Integration: deployment patterns',
    url: 'https://ziontechgroup.com/blog/continuous-integration-deployment-patterns/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/continuous-integration-deployment-patterns/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Continuous Integration: deployment patterns", "description": "Continuous Integration: deployment patterns", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:11:18Z", "dateModified": "2026-08-06T18:11:18Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/continuous-integration-deployment-patterns/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Continuous Integration: deployment patterns' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Continuous Integration: deployment patterns</h1>
          <p className="mt-4 text-lg text-slate-300">Continuous Integration: deployment patterns</p>
...
<li><Link href="/blog/api-governance-policy-and-compliance">Api Governance Policy And Compliance</Link></li>
<li><Link href="/blog/ai-network-optimization-2026">Ai Network Optimization 2026</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
