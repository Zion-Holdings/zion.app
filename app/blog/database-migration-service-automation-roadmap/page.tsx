...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Database Migration Service: automation roadmap | Zion Tech Group" description="Database Migration Service: automation roadmap" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/database-migration-service-automation-roadmap/" />
