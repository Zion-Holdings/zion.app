...
export const metadata = {
  ...
  openGraph: {
    title: 'Cloud Exit Strategy: Avoid Vendor Lock-In with Portable Architecture Patterns for cloud teams: architecture, risks, and roadmap',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/cloud-exit-strategy-avoid-vendor-lock-in-with-portable-architecture-patterns-for-cloud-teams-architecture-risks-and-roadmap/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/cloud-exit-strategy-avoid-vendor-lock-in-with-portable-architecture-patterns-for-cloud-teams-architecture-risks-and-roadmap/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Cloud Exit Strategy: Avoid Vendor Lock-In with Portable Architecture Patterns for cloud teams: architecture, risks, and roadmap' }]} className="mb-8" />
