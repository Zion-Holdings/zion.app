        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/micro-saas-ai-hr-recruitment-2026-918">Micro Saas Ai Hr Recruitment 2026 918</Link></li>
<li><Link href="/blog/micro-saas-ai-social-media-manager-2026-644">Micro Saas Ai Social Media Manager 2026 644</Link></li>
<li><Link href="/blog/it-consulting-2026-705">It Consulting 2026 705</Link></li>
<li><Link href="/blog/api-management-gateway-2026-3909">Api Management Gateway 2026 3909</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
