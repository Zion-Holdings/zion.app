...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI API Gateway: policy and compliance | Zion Tech Group" description="AI API Gateway: policy and compliance" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-api-gateway-policy-and-compliance/" />
