...
export const metadata = {
  ...
  alternates: { canonical: '/blog/incident-response-retainer-2026-8068/' },
  openGraph: { title: 'Incident Response Retainer', description: 'Practical guide to incident response retainer.', url: 'https://ziontechgroup.com/blog/incident-response-retainer-2026-8068/', type: 'article' },
...
export default function Page() {
  return (
    <PageShell title="Incident Response Retainer" description="Practical guide to incident response retainer: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/incident-response-retainer-2026-8068/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/incident-response-retainer-2026-8068/'
    }}>
