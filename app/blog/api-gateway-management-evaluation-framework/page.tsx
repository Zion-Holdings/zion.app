...
<li><Link href="/blog/ai-agentic-workflows-2026-514">Ai Agentic Workflows 2026 514</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
