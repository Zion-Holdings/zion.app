...
export default function Page() {
  return (
    <PageShell title="API Orchestration Layer" description="Practical guide to api orchestration layer: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/api-orchestration-layer-2026-6589/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/api-orchestration-layer-2026-6589/'
    }}>
