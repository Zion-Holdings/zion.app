...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="MicroSaaS HR Recruitment: policy and compliance | Zion Tech Group" description="MicroSaaS HR Recruitment: policy and compliance" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/microsaas-hr-recruitment-policy-and-compliance/" />
