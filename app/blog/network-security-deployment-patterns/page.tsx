...
export const metadata = {
  title: 'Network Security: deployment patterns | Zion Tech Group',
  description: 'Network Security: deployment patterns',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Network Security: deployment patterns',
    description: 'Network Security: deployment patterns',
    url: 'https://ziontechgroup.com/blog/network-security-deployment-patterns/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/network-security-deployment-patterns/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Network Security: deployment patterns' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Network Security: deployment patterns</h1>
          <p className="mt-4 text-lg text-slate-300">Network Security: deployment patterns</p>
