...
export const metadata = {
  ...
  openGraph: {
    title: 'AI Credential Hygiene and Secret Rotation for CI/CD: 2026 Playbook checklist for IT and security leaders',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/ai-credential-hygiene-and-secret-rotation-for-ci-cd-2026-playbook-checklist-for-it-and-security-leaders/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-credential-hygiene-and-secret-rotation-for-ci-cd-2026-playbook-checklist-for-it-and-security-leaders/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Credential Hygiene and Secret Rotation for CI/CD: 2026 Playbook checklist for IT and security leaders' }]} className="mb-8" />
