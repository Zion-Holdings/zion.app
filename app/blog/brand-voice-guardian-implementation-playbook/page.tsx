...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Brand Voice Guardian: implementation playbook | Zion Tech Group" description="Brand Voice Guardian: implementation playbook" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/brand-voice-guardian-implementation-playbook/" />
