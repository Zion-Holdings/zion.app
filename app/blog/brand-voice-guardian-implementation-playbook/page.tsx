        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/devops-gen-ai-cicd-2026-1366">Devops Gen Ai Cicd 2026 1366</Link></li>
<li><Link href="/blog/cloud-cost-optimization-checklist-2026-3245">Cloud Cost Optimization Checklist 2026 3245</Link></li>
<li><Link href="/blog/edge-computing-deployment-2026-1230">Edge Computing Deployment 2026 1230</Link></li>
<li><Link href="/blog/ai-ad-copy-generator-2026-1753">Ai Ad Copy Generator 2026 1753</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
