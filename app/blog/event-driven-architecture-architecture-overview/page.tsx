...
<li><Link href="/blog/api-gateway-management-2026-2044">Api Gateway Management 2026 2044</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
