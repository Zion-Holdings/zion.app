...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Event Driven Architecture: architecture overview | Zion Tech Group" description="Event Driven Architecture: architecture overview" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/event-driven-architecture-architecture-overview/" />
