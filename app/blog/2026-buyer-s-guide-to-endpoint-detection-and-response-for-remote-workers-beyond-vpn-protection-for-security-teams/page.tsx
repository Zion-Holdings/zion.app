...
export const metadata = {
  ...
  openGraph: {
    title: '2026 buyer's guide to Endpoint Detection and Response for Remote Workers: Beyond VPN Protection for security teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/2026-buyer-s-guide-to-endpoint-detection-and-response-for-remote-workers-beyond-vpn-protection-for-security-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/2026-buyer-s-guide-to-endpoint-detection-and-response-for-remote-workers-beyond-vpn-protection-for-security-teams/' },
};

const jsonLd = {"@context": "https://schema.org/", "@type": "TechArticle", "headline": "{title}", "description": "{description}", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "{NOW_ISO}", "dateModified": "{NOW_ISO}", "mainEntityOfPage": "{canonical}", "wordCount": 1255};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: '2026 buyer's guide to Endpoint Detection and Response for Remote Workers: Beyond VPN Protection for security teams' }]} className="mb-8" />
