...
export const metadata = {
  title: 'Kubernetes Security: case study | Zion Tech Group',
  description: 'Kubernetes Security: case study',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Kubernetes Security: case study',
    description: 'Kubernetes Security: case study',
    url: 'https://ziontechgroup.com/blog/kubernetes-security-case-study/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/kubernetes-security-case-study/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Kubernetes Security: case study", "description": "Kubernetes Security: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:28:37Z", "dateModified": "2026-08-06T18:28:37Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/kubernetes-security-case-study/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Kubernetes Security: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Kubernetes Security: case study</h1>
          <p className="mt-4 text-lg text-slate-300">Kubernetes Security: case study</p>
...
<li><Link /blog/application-modernization-automation-roadmap/>Application Modernization Automation Roadmap</Link></li>
