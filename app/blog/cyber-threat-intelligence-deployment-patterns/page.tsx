        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/api-orchestration-layer-2026-379">Api Orchestration Layer 2026 379</Link></li>
<li><Link href="/blog/micro-saas-ai-customer-onboarding-2026-505">Micro Saas Ai Customer Onboarding 2026 505</Link></li>
