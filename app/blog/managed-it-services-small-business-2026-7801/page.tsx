...
export const metadata = {
  ...
  alternates: { canonical: '/blog/managed-it-services-small-business-2026-7801/' },
  openGraph: { title: 'Managed IT Services', description: 'Practical guide to managed it services.', url: 'https://ziontechgroup.com/blog/managed-it-services-small-business-2026-7801/', type: 'article' },
  twitter: { card: 'summary_large_image', title: 'Managed IT Services', description: 'Practical guide to managed it services.' }
};

export default function Page() {
  return (
    <PageShell title="Managed IT Services" description="Practical guide to managed it services: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/managed-it-services-small-business-2026-7801/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/managed-it-services-small-business-2026-7801/'
    }}>
