...
export const metadata = {
  title: 'AI Customer Onboarding: operations handbook | Zion Tech Group',
  description: 'AI Customer Onboarding: operations handbook',
  keywords: ['ai', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'AI Customer Onboarding: operations handbook',
    description: 'AI Customer Onboarding: operations handbook',
    url: 'https://ziontechgroup.com/blog/ai-customer-onboarding-operations-handbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-customer-onboarding-operations-handbook/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AI Customer Onboarding: operations handbook", "description": "AI Customer Onboarding: operations handbook", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:08:30Z", "dateModified": "2026-08-06T18:08:30Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ai-customer-onboarding-operations-handbook/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Customer Onboarding: operations handbook' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AI Customer Onboarding: operations handbook</h1>
          <p className="mt-4 text-lg text-slate-300">AI Customer Onboarding: operations handbook</p>
