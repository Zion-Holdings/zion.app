...
export const metadata = {
  title: 'Infrastructure Monitoring: case study | Zion Tech Group',
  description: 'Infrastructure Monitoring: case study',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Infrastructure Monitoring: case study',
    description: 'Infrastructure Monitoring: case study',
    url: 'https://ziontechgroup.com/blog/infrastructure-monitoring-case-study/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/infrastructure-monitoring-case-study/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Infrastructure Monitoring: case study", "description": "Infrastructure Monitoring: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:12:53Z", "dateModified": "2026-08-06T18:12:53Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/infrastructure-monitoring-case-study/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Infrastructure Monitoring: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Infrastructure Monitoring: case study</h1>
          <p className="mt-4 text-lg text-slate-300">Infrastructure Monitoring: case study</p>
