...
export const metadata = {
  title: 'Cyber Threat Intelligence: evaluation framework | Zion Tech Group',
  description: 'Cyber Threat Intelligence: evaluation framework',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Cyber Threat Intelligence: evaluation framework',
    description: 'Cyber Threat Intelligence: evaluation framework',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Cyber Threat Intelligence: evaluation framework", "description": "Cyber Threat Intelligence: evaluation framework", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-07T07:57:02Z", "dateModified": "2026-08-07T07:57:02Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/cyber-threat-intelligence-evaluation-framework/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">

    <BlogPostStructuredData title="Cyber Threat Intelligence: evaluation framework | Zion Tech Group" description="Cyber Threat Intelligence: evaluation framework" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/cyber-threat-intelligence-evaluation-framework/" />
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Cyber Threat Intelligence: evaluation framework' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Cyber Threat Intelligence: evaluation framework</h1>
          <p className="mt-4 text-lg text-slate-300">Cyber Threat Intelligence: evaluation framework</p>
