...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Managed IT Services: checklist for IT leaders", "description": "Managed IT Services: checklist for IT leaders", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:13:29Z", "dateModified": "2026-08-04T16:13:29Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/managed-it-services-checklist-for-it-leaders/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Managed IT Services: checklist for IT leaders' }]} className="mb-8" />
        <header className="mb-10">
          ...
          <p className="mt-4 text-lg text-slate-300">Managed IT Services: checklist for IT leaders</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/api-management-gateway-2026-2598">Api Management Gateway 2026 2598</Link></li>
<li><Link href="/blog/ai-it-operations-automation-2026">Ai It Operations Automation 2026</Link></li>
<li><Link href="/blog/ai-3d-asset-generator-2026-1336">Ai 3D Asset Generator 2026 1336</Link></li>
<li><Link href="/blog/managed-it-services-small-business-2026-1384">Managed It Services Small Business 2026 1384</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
