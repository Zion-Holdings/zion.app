...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Managed IT Services: checklist for IT leaders | Zion Tech Group" description="Managed IT Services: checklist for IT leaders" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/managed-it-services-checklist-for-it-leaders/" />
