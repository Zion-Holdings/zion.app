...
export const metadata = {
  title: 'AI email intelligence for It teams | Zion Tech Group',
  description: 'AI email intelligence for It teams',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'AI email intelligence for It teams',
    description: 'AI email intelligence for It teams',
    url: 'https://ziontechgroup.com/blog/ai-email-intelligence-5/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-email-intelligence-5/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AI email intelligence for It teams", "description": "AI email intelligence for It teams", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T12:58:15Z", "dateModified": "2026-08-04T12:58:15Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ai-email-intelligence-5/", "wordCount": 1668};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI email intelligence for It teams' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AI email intelligence for It teams</h1>
          <p className="mt-4 text-lg text-slate-300">AI email intelligence for It teams</p>
...
<li><Link href="/blog/ai-document-processing-4">Ai Document Processing 4</Link></li>
              ...
              <li><Link href="/blog/ai-government-services-2">Ai Government Services 2</Link></li>
              <li><Link href="/blog/ai-configuration-management-6">Ai Configuration Management 6</Link></li>
