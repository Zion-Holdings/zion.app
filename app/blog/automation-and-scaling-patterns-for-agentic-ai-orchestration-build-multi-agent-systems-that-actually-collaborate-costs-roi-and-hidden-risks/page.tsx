...
export const metadata = {
  ...
  openGraph: {
    title: 'Automation and scaling patterns for Agentic AI Orchestration: Build Multi-Agent Systems That Actually Collaborate: costs, ROI, and hidden risks',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/automation-and-scaling-patterns-for-agentic-ai-orchestration-build-multi-agent-systems-that-actually-collaborate-costs-roi-and-hidden-risks/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/automation-and-scaling-patterns-for-agentic-ai-orchestration-build-multi-agent-systems-that-actually-collaborate-costs-roi-and-hidden-risks/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Automation and scaling patterns for Agentic AI Orchestration: Build Multi-Agent Systems That Actually Collaborate: costs, ROI, and hidden risks' }]} className="mb-8" />
