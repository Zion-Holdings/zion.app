...
export const metadata = {
  ...
  openGraph: {
    title: 'Common mistakes when rolling out Real-Time Data Streaming with Kafka and Flink: Event-Driven Architecture: costs, ROI, and hidden risks',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/common-mistakes-when-rolling-out-real-time-data-streaming-with-kafka-and-flink-event-driven-architecture-costs-roi-and-hidden-risks/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/common-mistakes-when-rolling-out-real-time-data-streaming-with-kafka-and-flink-event-driven-architecture-costs-roi-and-hidden-risks/' },
};

const jsonLd = {"@context": "https://schema.org/", "@type": "TechArticle", "headline": "{title}", "description": "{description}", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "{NOW_ISO}", "dateModified": "{NOW_ISO}", "mainEntityOfPage": "{canonical}", "wordCount": 1154};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Common mistakes when rolling out Real-Time Data Streaming with Kafka and Flink: Event-Driven Architecture: costs, ROI, and hidden risks' }]} className="mb-8" />
