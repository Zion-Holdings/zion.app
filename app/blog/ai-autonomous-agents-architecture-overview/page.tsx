...
export const metadata = {
  ...
  openGraph: {
    title: 'AI Autonomous Agents: architecture overview',
    description: 'AI Autonomous Agents: architecture overview',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AI Autonomous Agents: architecture overview", "description": "AI Autonomous Agents: architecture overview", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-07T04:51:53Z", "dateModified": "2026-08-07T04:51:53Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ai-autonomous-agents-architecture-overview/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Autonomous Agents: architecture overview' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AI Autonomous Agents: architecture overview</h1>
          <p className="mt-4 text-lg text-slate-300">AI Autonomous Agents: architecture overview</p>
