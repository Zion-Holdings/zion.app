...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Cloud Migration Services: executive guide | Zion Tech Group" description="Cloud Migration Services: executive guide" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/cloud-migration-services-executive-guide/" />
