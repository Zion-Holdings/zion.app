...
export const metadata = {
  title: 'Database Security: checklist for IT leaders | Zion Tech Group',
  description: 'Database Security: checklist for IT leaders',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Database Security: checklist for IT leaders',
    description: 'Database Security: checklist for IT leaders',
    url: 'https://ziontechgroup.com/blog/database-security-checklist-for-it-leaders/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/database-security-checklist-for-it-leaders/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Database Security: checklist for IT leaders", "description": "Database Security: checklist for IT leaders", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:09:58Z", "dateModified": "2026-08-06T18:09:58Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/database-security-checklist-for-it-leaders/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Database Security: checklist for IT leaders' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Database Security: checklist for IT leaders</h1>
          <p className="mt-4 text-lg text-slate-300">Database Security: checklist for IT leaders</p>
