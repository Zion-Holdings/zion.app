...
export const metadata = {
  ...
  description: 'Smart Contract Audit: implementation playbook - AI and IT insights from Zion Tech Group.',
  openGraph: {
    title: 'Smart Contract Audit: implementation playbook',
    description: 'Smart Contract Audit: implementation playbook - AI and IT insights from Zion Tech Group.',
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'Smart Contract Audit: implementation playbook' },
      ]}
    >
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <header className="mb-10">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Smart Contract Audit: implementation playbook | Zion Tech Group</h1>
