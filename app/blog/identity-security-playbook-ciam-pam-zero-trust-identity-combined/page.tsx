...
export const metadata = {
  ...
  description: 'Identity Security Playbook: CIAM, PAM, and Zero Trust Identity Combined: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/blog/identity-security-playbook-ciam-pam-zero-trust-identity-combined',
  },
};
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'Identity Security Playbook: CIAM, PAM, and Zero Trust Identity Combined' }
          ]}
          className="mb-8"
        />
        ...
        <header className="mb-12">
          ...
          <p className="mt-4 text-lg text-slate-300">Identity Security Playbook: CIAM, PAM, and Zero Trust Identity Combined requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
