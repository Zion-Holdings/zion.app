...
export const metadata = {
  ...
  openGraph: {
    title: 'Data Loss Prevention for AI: Prevent Confidential Data Leaks to LLM APIs for security teams: costs, ROI, and hidden risks',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/data-loss-prevention-for-ai-prevent-confidential-data-leaks-to-llm-apis-for-security-teams-costs-roi-and-hidden-risks/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/data-loss-prevention-for-ai-prevent-confidential-data-leaks-to-llm-apis-for-security-teams-costs-roi-and-hidden-risks/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Data Loss Prevention for AI: Prevent Confidential Data Leaks to LLM APIs for security teams: costs, ROI, and hidden risks' }]} className="mb-8" />
