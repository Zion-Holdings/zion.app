...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Enterprise Backup DR: checklist for IT leaders | Zion Tech Group" description="Enterprise Backup DR: checklist for IT leaders" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/enterprise-backup-dr-checklist-for-it-leaders/" />
