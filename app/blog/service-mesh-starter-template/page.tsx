...
export const metadata = {
  title: 'Service Mesh: starter template | Zion Tech Group',
  description: 'Service Mesh: starter template',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Service Mesh: starter template',
    description: 'Service Mesh: starter template',
    url: 'https://ziontechgroup.com/blog/service-mesh-starter-template/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/service-mesh-starter-template/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Service Mesh: starter template", "description": "Service Mesh: starter template", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:12:17Z", "dateModified": "2026-08-06T18:12:17Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/service-mesh-starter-template/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Service Mesh: starter template' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Service Mesh: starter template</h1>
          <p className="mt-4 text-lg text-slate-300">Service Mesh: starter template</p>
...
<li><Link href="/blog/cloud-cost-management-roi-and-cost-model">Cloud Cost Management Roi And Cost Model</Link></li>
