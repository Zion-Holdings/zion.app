...
export const metadata = {
  title: 'Ai It Support Automation And Managed Help Desk | Zion Tech Group',
  description: 'Ai It Support Automation And Managed Help Desk: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
    title: 'Ai It Support Automation And Managed Help Desk',
    description: 'Ai It Support Automation And Managed Help Desk: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
    url: 'https://ziontechgroup.com/blog/ai-it-support-automation-and-managed-help-desk',
    type: 'article',
  },
  alternates: {
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'Ai It Support Automation And Managed Help Desk' }
          ]}
          className="mb-8"
        />
        ...
        <header className="mb-12">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Ai It Support Automation And Managed Help Desk</h1>
          <p className="mt-4 text-lg text-slate-300">Ai It Support Automation And Managed Help Desk requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
