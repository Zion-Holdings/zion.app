...
export const metadata = {
  title: 'Cloud Migration Services: implementation playbook | Zion Tech Group',
  ...
  openGraph: {
    ...
    description: 'Cloud Migration Services: implementation playbook',
    url: 'https://ziontechgroup.com/blog/cloud-migration-services-implementation-playbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  
    images: ['/og-default.png'],},
  alternates: { canonical: '/blog/cloud-migration-services-implementation-playbook/' },
};
...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Cloud Migration Services: implementation playbook | Zion Tech Group" description="Cloud Migration Services: implementation playbook" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/cloud-migration-services-implementation-playbook/" />
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Cloud Migration Services: implementation playbook' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Cloud Migration Services: implementation playbook</h1>
          <p className="mt-4 text-lg text-slate-300">Cloud Migration Services: implementation playbook</p>
