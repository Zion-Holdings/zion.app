...
export const metadata = {
  ...
  openGraph: {
    title: 'Case study: Sustainable IT and Green Cloud: Measure and Reduce Carbon Footprint of Infrastructure in production: 2026 Playbook',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/case-study-sustainable-it-and-green-cloud-measure-and-reduce-carbon-footprint-of-infrastructure-in-production-2026-playbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/case-study-sustainable-it-and-green-cloud-measure-and-reduce-carbon-footprint-of-infrastructure-in-production-2026-playbook/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Case study: Sustainable IT and Green Cloud: Measure and Reduce Carbon Footprint of Infrastructure in production: 2026 Playbook' }]} className="mb-8" />
