...
export const metadata = {
  title: 'Monitoring Observability: operations handbook | Zion Tech Group',
  description: 'Monitoring Observability: operations handbook',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Monitoring Observability: operations handbook',
    description: 'Monitoring Observability: operations handbook',
    url: 'https://ziontechgroup.com/blog/monitoring-observability-operations-handbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/monitoring-observability-operations-handbook/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Monitoring Observability: operations handbook", "description": "Monitoring Observability: operations handbook", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:24:46Z", "dateModified": "2026-08-06T18:24:46Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/monitoring-observability-operations-handbook/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Monitoring Observability: operations handbook' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Monitoring Observability: operations handbook</h1>
          <p className="mt-4 text-lg text-slate-300">Monitoring Observability: operations handbook</p>
