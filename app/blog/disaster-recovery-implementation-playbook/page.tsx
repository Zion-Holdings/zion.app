...
export const metadata = {
  title: 'Disaster Recovery: implementation playbook | Zion Tech Group',
  description: 'Disaster Recovery: implementation playbook',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Disaster Recovery: implementation playbook',
    description: 'Disaster Recovery: implementation playbook',
    url: 'https://ziontechgroup.com/blog/disaster-recovery-implementation-playbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/disaster-recovery-implementation-playbook/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Disaster Recovery: implementation playbook", "description": "Disaster Recovery: implementation playbook", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:09:59Z", "dateModified": "2026-08-06T18:09:59Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/disaster-recovery-implementation-playbook/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Disaster Recovery: implementation playbook' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Disaster Recovery: implementation playbook</h1>
          <p className="mt-4 text-lg text-slate-300">Disaster Recovery: implementation playbook</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/database-security-implementation-playbook">Database Security Implementation Playbook</Link></li>
