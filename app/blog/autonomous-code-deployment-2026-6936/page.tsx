...
export const metadata = {
  ...
  alternates: { canonical: '/blog/autonomous-code-deployment-2026-6936/' },
  openGraph: { title: 'Autonomous Code Deployment', description: 'Practical guide to autonomous code deployment.', url: 'https://ziontechgroup.com/blog/autonomous-code-deployment-2026-6936/', type: 'article' },
...
export default function Page() {
  return (
    <PageShell title="Autonomous Code Deployment" description="Practical guide to autonomous code deployment: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/autonomous-code-deployment-2026-6936/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/autonomous-code-deployment-2026-6936/'
    }}>
