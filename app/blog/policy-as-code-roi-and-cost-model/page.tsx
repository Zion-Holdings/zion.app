...
export const metadata = {
  title: 'Policy as Code: ROI and cost model | Zion Tech Group',
  description: 'Policy as Code: ROI and cost model',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Policy as Code: ROI and cost model',
    description: 'Policy as Code: ROI and cost model',
    url: 'https://ziontechgroup.com/blog/policy-as-code-roi-and-cost-model/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/policy-as-code-roi-and-cost-model/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Policy as Code: ROI and cost model", "description": "Policy as Code: ROI and cost model", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:00:50Z", "dateModified": "2026-08-06T18:00:50Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/policy-as-code-roi-and-cost-model/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Policy as Code: ROI and cost model' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Policy as Code: ROI and cost model</h1>
          <p className="mt-4 text-lg text-slate-300">Policy as Code: ROI and cost model</p>
