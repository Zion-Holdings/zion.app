...
export const metadata = {
  title: 'Smart Contract Audit: starter template | Zion Tech Group',
  description: 'Smart Contract Audit: starter template',
  keywords: ['data', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Smart Contract Audit: starter template',
    description: 'Smart Contract Audit: starter template',
    url: 'https://ziontechgroup.com/blog/smart-contract-audit-starter-template/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/smart-contract-audit-starter-template/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Smart Contract Audit: starter template", "description": "Smart Contract Audit: starter template", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:40:00Z", "dateModified": "2026-08-04T16:40:00Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/smart-contract-audit-starter-template/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Smart Contract Audit: starter template' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Smart Contract Audit: starter template</h1>
          <p className="mt-4 text-lg text-slate-300">Smart Contract Audit: starter template</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/it-consulting-2026-3327">It Consulting 2026 3327</Link></li>
<li><Link href="/blog/data-warehouse-modernization-2026-2123">Data Warehouse Modernization 2026 2123</Link></li>
<li><Link href="/blog/ai-customer-support-pro-2026-3252">Ai Customer Support Pro 2026 3252</Link></li>
<li><Link href="/blog/api-gateway-management-2026-2757">Api Gateway Management 2026 2757</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
