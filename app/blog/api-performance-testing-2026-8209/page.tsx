...
export const metadata = {
  ...
  alternates: { canonical: '/blog/api-performance-testing-2026-8209/' },
  openGraph: { title: 'API Performance Testing', description: 'Practical guide to api performance testing.', url: 'https://ziontechgroup.com/blog/api-performance-testing-2026-8209/', type: 'article' },
...
export default function Page() {
  return (
    <PageShell title="API Performance Testing" description="Practical guide to api performance testing: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/api-performance-testing-2026-8209/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/api-performance-testing-2026-8209/'
    }}>
