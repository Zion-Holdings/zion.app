...
export const metadata = {
  ...
  description: '5G Solutions: case study - AI and IT insights from Zion Tech Group.',
  openGraph: {
    title: '5G Solutions: case study',
    description: '5G Solutions: case study - AI and IT insights from Zion Tech Group.',
    ...
    >
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <header className="mb-10">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">5G Solutions: case study | Zion Tech Group</h1>
