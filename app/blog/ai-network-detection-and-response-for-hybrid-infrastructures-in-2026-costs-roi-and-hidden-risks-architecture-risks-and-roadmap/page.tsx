...
export const metadata = {
  ...
  openGraph: {
    title: 'AI Network Detection and Response for Hybrid Infrastructures in 2026: costs, ROI, and hidden risks: architecture, risks, and roadmap',
    description: 'Network telemetry plus endpoint and identity signals',
    url: 'https://ziontechgroup.com/blog/ai-network-detection-and-response-for-hybrid-infrastructures-in-2026-costs-roi-and-hidden-risks-architecture-risks-and-roadmap/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-network-detection-and-response-for-hybrid-infrastructures-in-2026-costs-roi-and-hidden-risks-architecture-risks-and-roadmap/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Network Detection and Response for Hybrid Infrastructures in 2026: costs, ROI, and hidden risks: architecture, risks, and roadmap' }]} className="mb-8" />
