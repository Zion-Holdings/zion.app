        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link /blog/policy-as-code-vendor-evaluation/>Policy As Code Vendor Evaluation</Link></li>
<li><Link /blog/siem-common-mistakes/>Siem Common Mistakes</Link></li>
<li><Link /blog/api-orchestration-layer-2026-6934/>Api Orchestration Layer 2026 6934</Link></li>
<li><Link /blog/product-led-growth-deployment-patterns/>Product Led Growth Deployment Patterns</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
