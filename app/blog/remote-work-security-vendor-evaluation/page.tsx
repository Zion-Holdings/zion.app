...
export const metadata = {
  title: 'Remote Work Security: vendor evaluation | Zion Tech Group',
  description: 'Remote Work Security: vendor evaluation',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Remote Work Security: vendor evaluation',
    description: 'Remote Work Security: vendor evaluation',
    url: 'https://ziontechgroup.com/blog/remote-work-security-vendor-evaluation/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/remote-work-security-vendor-evaluation/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Remote Work Security: vendor evaluation", "description": "Remote Work Security: vendor evaluation", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:11:49Z", "dateModified": "2026-08-06T18:11:49Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/remote-work-security-vendor-evaluation/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Remote Work Security: vendor evaluation' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Remote Work Security: vendor evaluation</h1>
          <p className="mt-4 text-lg text-slate-300">Remote Work Security: vendor evaluation</p>
...
<li><Link href="/blog/hybrid-cloud-checklist-for-it-leaders">Hybrid Cloud Checklist For It Leaders</Link></li>
