...
export const metadata = {
  ...
  openGraph: {
    title: 'AI Desktop Support Automation for Enterprise IT: 2026 Playbook for support teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/ai-desktop-support-automation-for-enterprise-it-2026-playbook-for-support-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-desktop-support-automation-for-enterprise-it-2026-playbook-for-support-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Desktop Support Automation for Enterprise IT: 2026 Playbook for support teams' }]} className="mb-8" />
