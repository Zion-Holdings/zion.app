        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link /blog/structured-data-extraction-common-mistakes/>Structured Data Extraction Common Mistakes</Link></li>
<li><Link /blog/automation-orchestration-enterprise-2026/>Automation Orchestration Enterprise 2026</Link></li>
<li><Link /blog/token-optimization-vendor-evaluation/>Token Optimization Vendor Evaluation</Link></li>
