...
export const metadata = {
  ...
  openGraph: {
    title: 'Time Series Analytics for IoT: Ingest, Store, and Query Sensor Data at Scale: 2026 Playbook: costs, ROI, and hidden risks',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/time-series-analytics-for-iot-ingest-store-and-query-sensor-data-at-scale-2026-playbook-costs-roi-and-hidden-risks/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/time-series-analytics-for-iot-ingest-store-and-query-sensor-data-at-scale-2026-playbook-costs-roi-and-hidden-risks/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Time Series Analytics for IoT: Ingest, Store, and Query Sensor Data at Scale: 2026 Playbook: costs, ROI, and hidden risks' }]} className="mb-8" />
