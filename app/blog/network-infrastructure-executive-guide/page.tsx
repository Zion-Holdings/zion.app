...
<li><Link href="/blog/api-integration-2026-7634">Api Integration 2026 7634</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
