        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/5g-solutions-2026-3257">5G Solutions 2026 3257</Link></li>
<li><Link href="/blog/ai-performance-monitoring-2026-4044">Ai Performance Monitoring 2026 4044</Link></li>
<li><Link href="/blog/ai-msp-security-compliance-2026-1253">Ai Msp Security Compliance 2026 1253</Link></li>
