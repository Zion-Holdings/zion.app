...
export const metadata = {
  title: 'Platform Engineering: case study | Zion Tech Group',
  description: 'Platform Engineering: case study',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Platform Engineering: case study',
    description: 'Platform Engineering: case study',
    url: 'https://ziontechgroup.com/blog/platform-engineering-case-study/',
    type: 'article',
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Platform Engineering: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Platform Engineering: case study</h1>
          <p className="mt-4 text-lg text-slate-300">Platform Engineering: case study</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link /blog/vulnerability-assessment-vendor-evaluation/>Vulnerability Assessment Vendor Evaluation</Link></li>
