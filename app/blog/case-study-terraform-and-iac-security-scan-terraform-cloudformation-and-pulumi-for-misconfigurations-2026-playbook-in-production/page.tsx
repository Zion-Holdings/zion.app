...
export const metadata = {
  ...
  openGraph: {
    title: 'Case study: Terraform and IaC Security: Scan Terraform, CloudFormation, and Pulumi for Misconfigurations: 2026 Playbook in production',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/case-study-terraform-and-iac-security-scan-terraform-cloudformation-and-pulumi-for-misconfigurations-2026-playbook-in-production/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/case-study-terraform-and-iac-security-scan-terraform-cloudformation-and-pulumi-for-misconfigurations-2026-playbook-in-production/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Case study: Terraform and IaC Security: Scan Terraform, CloudFormation, and Pulumi for Misconfigurations: 2026 Playbook in production' }]} className="mb-8" />
