...
export const metadata = {
  title: 'Distributed Tracing: common mistakes | Zion Tech Group',
  description: 'Distributed Tracing: common mistakes',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Distributed Tracing: common mistakes',
    description: 'Distributed Tracing: common mistakes',
    url: 'https://ziontechgroup.com/blog/distributed-tracing-common-mistakes/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/distributed-tracing-common-mistakes/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Distributed Tracing: common mistakes", "description": "Distributed Tracing: common mistakes", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:25:23Z", "dateModified": "2026-08-06T18:25:23Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/distributed-tracing-common-mistakes/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Distributed Tracing: common mistakes' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Distributed Tracing: common mistakes</h1>
          <p className="mt-4 text-lg text-slate-300">Distributed Tracing: common mistakes</p>
...
<li><Link href="/blog/site-reliability-engineering-common-mistakes">Site Reliability Engineering Common Mistakes</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
