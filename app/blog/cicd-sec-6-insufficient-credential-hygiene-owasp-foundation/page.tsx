...
export const metadata = {
  title: 'CICD-SEC-6: Insufficient Credential Hygiene - OWASP Foundation | Zion Tech Group',
  description: 'CICD-SEC-6: Insufficient Credential Hygiene - OWASP Foundation',
  keywords: ['it', 'solution', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'CICD-SEC-6: Insufficient Credential Hygiene - OWASP Foundation',
    description: 'CICD-SEC-6: Insufficient Credential Hygiene - OWASP Foundation',
    url: 'https://ziontechgroup.com/blog/cicd-sec-6-insufficient-credential-hygiene-owasp-foundation/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'https://ziontechgroup.com/blog/cicd-sec-6-insufficient-credential-hygiene-owasp-foundation/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "CICD-SEC-6: Insufficient Credential Hygiene - OWASP Foundation", "description": "CICD-SEC-6: Insufficient Credential Hygiene - OWASP Foundation", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-03T20:48:23Z", "dateModified": "2026-08-03T20:48:23Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/cicd-sec-6-insufficient-credential-hygiene-owasp-foundation/", "wordCount": 2037};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'CICD-SEC-6: Insufficient Credential Hygiene - OWASP Foundation' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">CICD-SEC-6: Insufficient Credential Hygiene - OWASP Foundation</h1>
          <p className="mt-4 text-lg text-slate-300">CICD-SEC-6: Insufficient Credential Hygiene - OWASP Foundation</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/ai-credential-hygiene-and-secret-rotation-in-ci-cd-7">Ai Credential Hygiene And Secret Rotation In Ci Cd 7</Link></li><li><Link href="/blog/ai-cloud-finops-anomaly-detection-and-budget-guardrails-4">Ai Cloud Finops Anomaly Detection And Budget Guardrails 4</Link></li><li><Link href="/blog/show-hn-deepreel-ai-video-agent-that-turns-blogs-docs-into-polished-videos">Show Hn Deepreel Ai Video Agent That Turns Blogs Docs Into Polished Videos</Link></li><li><Link href="/blog/distributed-tracing-with-jaeger-and-zipkin-debug-microservices-without-log-dumps-4">Distributed Tracing With Jaeger And Zipkin Debug Microservices Without Log Dumps 4</Link></li>
