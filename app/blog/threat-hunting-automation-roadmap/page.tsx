...
export const metadata = {
  title: 'Threat Hunting: automation roadmap | Zion Tech Group',
  description: 'Threat Hunting: automation roadmap',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Threat Hunting: automation roadmap',
    description: 'Threat Hunting: automation roadmap',
    url: 'https://ziontechgroup.com/blog/threat-hunting-automation-roadmap/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/threat-hunting-automation-roadmap/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Threat Hunting: automation roadmap", "description": "Threat Hunting: automation roadmap", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:01:28Z", "dateModified": "2026-08-06T18:01:28Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/threat-hunting-automation-roadmap/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Threat Hunting: automation roadmap' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Threat Hunting: automation roadmap</h1>
          <p className="mt-4 text-lg text-slate-300">Threat Hunting: automation roadmap</p>
