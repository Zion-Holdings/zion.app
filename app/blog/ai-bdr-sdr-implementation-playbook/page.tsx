...
export const metadata = {
  title: 'AI BDR SDR: implementation playbook | Zion Tech Group',
  description: 'AI BDR SDR: implementation playbook',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'AI BDR SDR: implementation playbook',
    description: 'AI BDR SDR: implementation playbook',
    url: 'https://ziontechgroup.com/blog/ai-bdr-sdr-implementation-playbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-bdr-sdr-implementation-playbook/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AI BDR SDR: implementation playbook", "description": "AI BDR SDR: implementation playbook", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:39:36Z", "dateModified": "2026-08-04T16:39:36Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ai-bdr-sdr-implementation-playbook/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI BDR SDR: implementation playbook' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AI BDR SDR: implementation playbook</h1>
          <p className="mt-4 text-lg text-slate-300">AI BDR SDR: implementation playbook</p>
...
<li><Link href="/blog/api-security-testing-2026-1310">Api Security Testing 2026 1310</Link></li>
<li><Link href="/blog/ai-api-gateway-2026-3860">Ai Api Gateway 2026 3860</Link></li>
<li><Link href="/blog/automation-orchestration-enterprise-2026-3870">Automation Orchestration Enterprise 2026 3870</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
