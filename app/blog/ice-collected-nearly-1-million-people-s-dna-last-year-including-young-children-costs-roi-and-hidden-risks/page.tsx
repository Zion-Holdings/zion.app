...
export const metadata = {
  ...
  openGraph: {
    title: 'ICE Collected Nearly 1 Million People’s DNA Last Year—Including Young Children: costs, ROI, and hidden risks',
    description: 'Live web-researched high-intent buyer topic',
    url: 'https://ziontechgroup.com/blog/ice-collected-nearly-1-million-people-s-dna-last-year-including-young-children-costs-roi-and-hidden-risks/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ice-collected-nearly-1-million-people-s-dna-last-year-including-young-children-costs-roi-and-hidden-risks/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'ICE Collected Nearly 1 Million People’s DNA Last Year—Including Young Children: costs, ROI, and hidden risks' }]} className="mb-8" />
