...
export const metadata = {
  ...
  openGraph: {
    title: 'Automation and scaling patterns for Comparing AI Support Quality Assurance: Score Tickets, Detect Escalations, and Coach Agents: vendors and build vs buy',
    description: 'Quality scoring and coaching without full QA staffing',
    url: 'https://ziontechgroup.com/blog/automation-and-scaling-patterns-for-comparing-ai-support-quality-assurance-score-tickets-detect-escalations-and-coach-agents-vendors-and-build-vs-buy/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/automation-and-scaling-patterns-for-comparing-ai-support-quality-assurance-score-tickets-detect-escalations-and-coach-agents-vendors-and-build-vs-buy/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Automation and scaling patterns for Comparing AI Support Quality Assurance: Score Tickets, Detect Escalations, and Coach Agents: vendors and build vs buy' }]} className="mb-8" />
