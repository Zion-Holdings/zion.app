...
export const metadata = {
  ...
  alternates: { canonical: '/blog/api-orchestration-layer-2026-7624/' },
  openGraph: { title: 'API Orchestration Layer', description: 'Practical guide to api orchestration layer.', url: 'https://ziontechgroup.com/blog/api-orchestration-layer-2026-7624/', type: 'article' },
...
export default function Page() {
  return (
    <PageShell title="API Orchestration Layer" description="Practical guide to api orchestration layer: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/api-orchestration-layer-2026-7624/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/api-orchestration-layer-2026-7624/'
    }}>
