...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI BDR SDR | Zion Tech Group" description="AI BDR SDR" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-bdr-sdr-2026/" />
