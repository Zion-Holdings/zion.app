...
export const metadata = {
  title: 'Deep Learning: evaluation framework | Zion Tech Group',
  description: 'Deep Learning: evaluation framework',
  keywords: ['ai', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Deep Learning: evaluation framework',
    description: 'Deep Learning: evaluation framework',
    url: 'https://ziontechgroup.com/blog/deep-learning-evaluation-framework/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/deep-learning-evaluation-framework/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Deep Learning: evaluation framework", "description": "Deep Learning: evaluation framework", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:44:45Z", "dateModified": "2026-08-06T18:44:45Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/deep-learning-evaluation-framework/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Deep Learning: evaluation framework' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Deep Learning: evaluation framework</h1>
          <p className="mt-4 text-lg text-slate-300">Deep Learning: evaluation framework</p>
...
<li><Link href="/blog/database-performance-executive-guide">Database Performance Executive Guide</Link></li>
