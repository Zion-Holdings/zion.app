  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <ArticleStructuredData
        headline="AI for Healthcare Analytics and Clinical Decision Support"
        description="Clinical documentation, diagnosis assistance, population health, and operational analytics. Responsible AI in healthcare delivery."
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'AI for Healthcare Analytics and Clinical Decision Support' },
          ]}
          className="mb-8"
        />
