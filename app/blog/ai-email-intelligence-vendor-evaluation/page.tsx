...
export const metadata = {
  title: 'AI Email Intelligence: vendor evaluation | Zion Tech Group',
  description: 'AI Email Intelligence: vendor evaluation',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'AI Email Intelligence: vendor evaluation',
    description: 'AI Email Intelligence: vendor evaluation',
    url: 'https://ziontechgroup.com/blog/ai-email-intelligence-vendor-evaluation/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-email-intelligence-vendor-evaluation/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AI Email Intelligence: vendor evaluation", "description": "AI Email Intelligence: vendor evaluation", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:28:49Z", "dateModified": "2026-08-04T16:28:49Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ai-email-intelligence-vendor-evaluation/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Email Intelligence: vendor evaluation' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AI Email Intelligence: vendor evaluation</h1>
          <p className="mt-4 text-lg text-slate-300">AI Email Intelligence: vendor evaluation</p>
...
<li><Link href="/blog/api-integration-2026-4046">Api Integration 2026 4046</Link></li>
<li><Link href="/blog/enterprise-ai-intelligence-hub-2026-3543">Enterprise Ai Intelligence Hub 2026 3543</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
