...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="DevSecOps Pipeline: deployment patterns | Zion Tech Group" description="DevSecOps Pipeline: deployment patterns" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/devsecops-pipeline-deployment-patterns/" />
