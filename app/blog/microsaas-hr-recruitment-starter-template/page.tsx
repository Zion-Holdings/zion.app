...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="MicroSaaS HR Recruitment: starter template | Zion Tech Group" description="MicroSaaS HR Recruitment: starter template" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/microsaas-hr-recruitment-starter-template/" />
