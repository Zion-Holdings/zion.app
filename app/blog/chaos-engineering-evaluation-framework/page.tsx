...
export const metadata = {
  ...
  openGraph: {
    title: 'Chaos engineering evaluation framework',
    description: 'Chaos engineering evaluation framework',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Chaos engineering evaluation framework", "description": "Chaos engineering evaluation framework", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T15:07:16Z", "dateModified": "2026-08-04T15:07:16Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/chaos-engineering-evaluation-framework/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Chaos engineering evaluation framework' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Chaos engineering evaluation framework</h1>
          <p className="mt-4 text-lg text-slate-300">Chaos engineering evaluation framework</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/microsaas-social-media-manager-deployment-patterns">Microsaas Social Media Manager Deployment Patterns</Link></li>
<li><Link href="/blog/ai-data-lakehouse-pipelines-2026">Ai Data Lakehouse Pipelines 2026</Link></li>
<li><Link href="/blog/ai-observability-2026-424">Ai Observability 2026 424</Link></li>
<li><Link href="/blog/automated-ai-reporting-2026-104">Automated Ai Reporting 2026 104</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
