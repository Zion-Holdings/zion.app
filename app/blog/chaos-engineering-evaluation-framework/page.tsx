...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Chaos Engineering: evaluation framework | Zion Tech Group" description="Chaos Engineering: evaluation framework" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/chaos-engineering-evaluation-framework/" />
