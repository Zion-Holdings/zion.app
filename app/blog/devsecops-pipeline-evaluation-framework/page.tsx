...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="DevSecOps Pipeline: evaluation framework | Zion Tech Group" description="DevSecOps Pipeline: evaluation framework" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/devsecops-pipeline-evaluation-framework/" />
