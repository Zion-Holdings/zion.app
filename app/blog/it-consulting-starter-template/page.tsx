...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="IT Consulting: starter template | Zion Tech Group" description="IT Consulting: starter template" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/it-consulting-starter-template/" />
