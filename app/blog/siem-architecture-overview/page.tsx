        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link /blog/business-intelligence-roi-and-cost-model/>Business Intelligence Roi And Cost Model</Link></li>
<li><Link /blog/database-performance-operations-handbook/>Database Performance Operations Handbook</Link></li>
<li><Link /blog/ai-security-analytics-checklist-for-it-leaders/>Ai Security Analytics Checklist For It Leaders</Link></li>
