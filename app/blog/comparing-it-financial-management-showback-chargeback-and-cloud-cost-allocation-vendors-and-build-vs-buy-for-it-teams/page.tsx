...
export const metadata = {
  ...
  openGraph: {
    title: 'Comparing IT Financial Management: Showback, Chargeback, and Cloud Cost Allocation: vendors and build vs buy for it teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/comparing-it-financial-management-showback-chargeback-and-cloud-cost-allocation-vendors-and-build-vs-buy-for-it-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/comparing-it-financial-management-showback-chargeback-and-cloud-cost-allocation-vendors-and-build-vs-buy-for-it-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Comparing IT Financial Management: Showback, Chargeback, and Cloud Cost Allocation: vendors and build vs buy for it teams' }]} className="mb-8" />
