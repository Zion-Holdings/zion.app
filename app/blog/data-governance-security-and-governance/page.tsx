...
export const metadata = {
  title: 'Data Governance: security and governance | Zion Tech Group',
  description: 'Data Governance: security and governance',
  keywords: ['data', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Data Governance: security and governance',
    description: 'Data Governance: security and governance',
    url: 'https://ziontechgroup.com/blog/data-governance-security-and-governance/',
    type: 'article',
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Data Governance: security and governance' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Data Governance: security and governance</h1>
          <p className="mt-4 text-lg text-slate-300">Data Governance: security and governance</p>
