...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Event Driven Architecture: case study", "description": "Event Driven Architecture: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:13:10Z", "dateModified": "2026-08-04T16:13:10Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/event-driven-architecture-case-study/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Event Driven Architecture: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Event Driven Architecture: case study</h1>
          <p className="mt-4 text-lg text-slate-300">Event Driven Architecture: case study</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/automated-ai-reporting-2026-1622">Automated Ai Reporting 2026 1622</Link></li>
<li><Link href="/blog/event-driven-architecture-2026-3028">Event Driven Architecture 2026 3028</Link></li>
<li><Link href="/blog/ai-performance-monitoring-2026-3906">Ai Performance Monitoring 2026 3906</Link></li>
<li><Link href="/blog/event-driven-architecture-2026-1510">Event Driven Architecture 2026 1510</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
