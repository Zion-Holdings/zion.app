...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Event Driven Architecture: case study | Zion Tech Group" description="Event Driven Architecture: case study" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/event-driven-architecture-case-study/" />
