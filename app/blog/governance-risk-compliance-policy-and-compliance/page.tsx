...
export const metadata = {
  title: 'Governance Risk Compliance: policy and compliance | Zion Tech Group',
  description: 'Governance Risk Compliance: policy and compliance',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Governance Risk Compliance: policy and compliance',
    description: 'Governance Risk Compliance: policy and compliance',
    url: 'https://ziontechgroup.com/blog/governance-risk-compliance-policy-and-compliance/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/governance-risk-compliance-policy-and-compliance/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Governance Risk Compliance: policy and compliance", "description": "Governance Risk Compliance: policy and compliance", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:02:06Z", "dateModified": "2026-08-06T18:02:06Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/governance-risk-compliance-policy-and-compliance/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Governance Risk Compliance: policy and compliance' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Governance Risk Compliance: policy and compliance</h1>
          <p className="mt-4 text-lg text-slate-300">Governance Risk Compliance: policy and compliance</p>
