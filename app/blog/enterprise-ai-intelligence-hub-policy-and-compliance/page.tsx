...
export const metadata = {
  ...
  openGraph: {
    title: 'Enterprise AI Intelligence Hub: policy and compliance | Zion Tech Group',
    description: 'Enterprise AI Intelligence Hub: policy and compliance.',
    url: 'https://ziontechgroup.comapp/blog/enterprise-ai-intelligence-hub-policy-and-compliance/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/enterprise-ai-intelligence-hub-policy-and-compliance/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'Enterprise AI Intelligence Hub: policy and compliance',
  description: 'Enterprise AI Intelligence Hub: policy and compliance.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/enterprise-ai-intelligence-hub-policy-and-compliance/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'Enterprise AI Intelligence Hub: policy and compliance' },
      ]}
    >
