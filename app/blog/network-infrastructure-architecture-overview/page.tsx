...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Network Infrastructure: architecture overview | Zion Tech Group" description="Network Infrastructure: architecture overview" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/network-infrastructure-architecture-overview/" />
