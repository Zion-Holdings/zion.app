...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Network Infrastructure: architecture overview", "description": "Network Infrastructure: architecture overview", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:27:16Z", "dateModified": "2026-08-04T16:27:16Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/network-infrastructure-architecture-overview/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Network Infrastructure: architecture overview' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Network Infrastructure: architecture overview</h1>
          <p className="mt-4 text-lg text-slate-300">Network Infrastructure: architecture overview</p>
...
<li><Link href="/blog/ai-msp-security-compliance-2026-3185">Ai Msp Security Compliance 2026 3185</Link></li>
<li><Link href="/blog/5g-solutions-2026-635">5G Solutions 2026 635</Link></li>
<li><Link href="/blog/automation-orchestration-enterprise-2026-2490">Automation Orchestration Enterprise 2026 2490</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
