...
export const metadata = {
  ...
  description: 'It Cost Optimization Report For Managed Cloud Spend: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
    title: 'It Cost Optimization Report For Managed Cloud Spend',
    description: 'It Cost Optimization Report For Managed Cloud Spend: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
    url: 'https://ziontechgroup.com/blog/it-cost-optimization-report-for-managed-cloud-spend',
    type: 'article',
  },
  alternates: {
    canonical: 'https://ziontechgroup.com/blog/it-cost-optimization-report-for-managed-cloud-spend',
  },
};
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'It Cost Optimization Report For Managed Cloud Spend' }
          ]}
          className="mb-8"
        />
        ...
        <header className="mb-12">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">It Cost Optimization Report For Managed Cloud Spend</h1>
          <p className="mt-4 text-lg text-slate-300">It Cost Optimization Report For Managed Cloud Spend requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
