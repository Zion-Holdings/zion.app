...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Event Driven Architecture: starter template | Zion Tech Group" description="Event Driven Architecture: starter template" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/event-driven-architecture-starter-template/" />
