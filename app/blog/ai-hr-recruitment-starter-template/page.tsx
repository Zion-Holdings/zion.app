        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link /blog/enterprise-backup-dr-common-mistakes/>Enterprise Backup Dr Common Mistakes</Link></li>
<li><Link /blog/network-automation-evaluation-framework/>Network Automation Evaluation Framework</Link></li>
<li><Link /blog/error-budget-starter-template/>Error Budget Starter Template</Link></li>
