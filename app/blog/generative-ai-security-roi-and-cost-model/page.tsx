...
export const metadata = {
  title: 'Generative AI Security: ROI and cost model | Zion Tech Group',
  description: 'Generative AI Security: ROI and cost model',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Generative AI Security: ROI and cost model',
    description: 'Generative AI Security: ROI and cost model',
    url: 'https://ziontechgroup.com/blog/generative-ai-security-roi-and-cost-model/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/generative-ai-security-roi-and-cost-model/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Generative AI Security: ROI and cost model", "description": "Generative AI Security: ROI and cost model", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:08:37Z", "dateModified": "2026-08-06T18:08:37Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/generative-ai-security-roi-and-cost-model/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Generative AI Security: ROI and cost model' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Generative AI Security: ROI and cost model</h1>
          <p className="mt-4 text-lg text-slate-300">Generative AI Security: ROI and cost model</p>
...
<li><Link href="/blog/aiops-vendor-evaluation">Aiops Vendor Evaluation</Link></li>
