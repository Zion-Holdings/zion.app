...
export const metadata = {
  title: 'Managed Ai Ops Platform For It Service Providers | Zion Tech Group',
  description: 'Managed Ai Ops Platform For It Service Providers: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
    title: 'Managed Ai Ops Platform For It Service Providers',
    description: 'Managed Ai Ops Platform For It Service Providers: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
    url: 'https://ziontechgroup.com/blog/managed-ai-ops-platform-for-it-service-providers',
    type: 'article',
  },
  alternates: {
    canonical: 'https://ziontechgroup.com/blog/managed-ai-ops-platform-for-it-service-providers',
  },
};
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'Managed Ai Ops Platform For It Service Providers' }
          ]}
          className="mb-8"
        />
        ...
        <header className="mb-12">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Managed Ai Ops Platform For It Service Providers</h1>
          <p className="mt-4 text-lg text-slate-300">Managed Ai Ops Platform For It Service Providers requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
