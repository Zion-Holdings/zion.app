...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AI BDR SDR: starter template", "description": "AI BDR SDR: starter template", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:26:59Z", "dateModified": "2026-08-04T16:26:59Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ai-bdr-sdr-starter-template/"};
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/ai-bdr-sdr-2026-4040">Ai Bdr Sdr 2026 4040</Link></li>
...
<li><Link href="/blog/incident-response-retainer-2026-2824">Incident Response Retainer 2026 2824</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
