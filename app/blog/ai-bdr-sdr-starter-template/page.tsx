...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI BDR SDR: starter template | Zion Tech Group" description="AI BDR SDR: starter template" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-bdr-sdr-starter-template/" />
