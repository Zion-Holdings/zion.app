...
export const metadata = {
  ...
  openGraph: {
    title: 'Cybersecurity Modernization 2026: policy, compliance, and vendor management',
    description: 'Web-researched high-intent buyer topic',
    url: 'https://ziontechgroup.com/blog/cybersecurity-modernization-2026-policy-compliance-and-vendor-management/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/cybersecurity-modernization-2026-policy-compliance-and-vendor-management/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Cybersecurity Modernization 2026: policy, compliance, and vendor management' }]} className="mb-8" />
