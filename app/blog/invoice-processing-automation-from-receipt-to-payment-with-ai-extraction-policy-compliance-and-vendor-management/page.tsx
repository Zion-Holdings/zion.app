...
export const metadata = {
  ...
  openGraph: {
    ...
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/invoice-processing-automation-from-receipt-to-payment-with-ai-extraction-policy-compliance-and-vendor-management/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/invoice-processing-automation-from-receipt-to-payment-with-ai-extraction-policy-compliance-and-vendor-management/' },
};
