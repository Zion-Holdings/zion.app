...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="MicroSaaS HR Recruitment: case study | Zion Tech Group" description="MicroSaaS HR Recruitment: case study" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/microsaas-hr-recruitment-case-study/" />
