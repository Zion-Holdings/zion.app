...
export const metadata = {
  ...
  openGraph: {
    title: 'Data Analytics Platform: operations handbook | Zion Tech Group',
    description: 'Data Analytics Platform: operations handbook.',
    url: 'https://ziontechgroup.comapp/blog/data-analytics-platform-operations-handbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/data-analytics-platform-operations-handbook/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'Data Analytics Platform: operations handbook',
  description: 'Data Analytics Platform: operations handbook.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/data-analytics-platform-operations-handbook/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'Data Analytics Platform: operations handbook' },
      ]}
    >
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <section className="prose prose-invert max-w-none">
          ...
          <p className="text-slate-300 mb-6">Data Analytics Platform: operations handbook. Organizations benefit from clearer requirements, tighter governance, and repeatable delivery models.</p>
