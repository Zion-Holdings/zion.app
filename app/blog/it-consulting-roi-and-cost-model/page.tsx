...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="IT Consulting: ROI and cost model | Zion Tech Group" description="IT Consulting: ROI and cost model" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/it-consulting-roi-and-cost-model/" />
