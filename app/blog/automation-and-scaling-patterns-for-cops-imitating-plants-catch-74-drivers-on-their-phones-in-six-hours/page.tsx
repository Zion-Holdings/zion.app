...
export const metadata = {
  ...
  openGraph: {
    title: 'Automation and scaling patterns for Cops Imitating Plants Catch 74 Drivers on Their Phones in Six Hours',
    description: 'Live web-researched high-intent buyer topic',
    url: 'https://ziontechgroup.com/blog/automation-and-scaling-patterns-for-cops-imitating-plants-catch-74-drivers-on-their-phones-in-six-hours/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/automation-and-scaling-patterns-for-cops-imitating-plants-catch-74-drivers-on-their-phones-in-six-hours/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Automation and scaling patterns for Cops Imitating Plants Catch 74 Drivers on Their Phones in Six Hours' }]} className="mb-8" />
