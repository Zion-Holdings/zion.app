...
export const metadata = {
  ...
  openGraph: {
    title: 'How to implement AI-Powered Incident Remediation: From Alert to Fix in Minutes without disrupting operations: costs, ROI, and hidden risks',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/how-to-implement-ai-powered-incident-remediation-from-alert-to-fix-in-minutes-without-disrupting-operations-costs-roi-and-hidden-risks/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/how-to-implement-ai-powered-incident-remediation-from-alert-to-fix-in-minutes-without-disrupting-operations-costs-roi-and-hidden-risks/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'How to implement AI-Powered Incident Remediation: From Alert to Fix in Minutes without disrupting operations: costs, ROI, and hidden risks' }]} className="mb-8" />
