...
export const metadata = {
  title: 'Cloud Optimization: case study | Zion Tech Group',
  description: 'Cloud Optimization: case study',
  keywords: ['cloud', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Cloud Optimization: case study',
    description: 'Cloud Optimization: case study',
    url: 'https://ziontechgroup.com/blog/cloud-optimization-case-study/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/cloud-optimization-case-study/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Cloud Optimization: case study", "description": "Cloud Optimization: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:09:00Z", "dateModified": "2026-08-06T18:09:00Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/cloud-optimization-case-study/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Cloud Optimization: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Cloud Optimization: case study</h1>
          <p className="mt-4 text-lg text-slate-300">Cloud Optimization: case study</p>
