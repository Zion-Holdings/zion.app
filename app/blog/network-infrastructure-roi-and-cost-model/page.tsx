...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Network Infrastructure: ROI and cost model | Zion Tech Group" description="Network Infrastructure: ROI and cost model" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/network-infrastructure-roi-and-cost-model/" />
