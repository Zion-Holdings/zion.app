...
export const metadata = {
  ...
  openGraph: {
    title: 'Enterprise AI Intelligence Hub: case study | Zion Tech Group',
    description: 'Enterprise AI Intelligence Hub: case study.',
    url: 'https://ziontechgroup.comapp/blog/enterprise-ai-intelligence-hub-case-study/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/enterprise-ai-intelligence-hub-case-study/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'Enterprise AI Intelligence Hub: case study',
  description: 'Enterprise AI Intelligence Hub: case study.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/enterprise-ai-intelligence-hub-case-study/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'Enterprise AI Intelligence Hub: case study' },
      ]}
    >
