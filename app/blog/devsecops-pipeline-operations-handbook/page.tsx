...
<li><Link href="/blog/ai-email-intelligence-2026-76">Ai Email Intelligence 2026 76</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
