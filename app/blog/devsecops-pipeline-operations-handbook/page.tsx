...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="DevSecOps Pipeline: operations handbook | Zion Tech Group" description="DevSecOps Pipeline: operations handbook" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/devsecops-pipeline-operations-handbook/" />
