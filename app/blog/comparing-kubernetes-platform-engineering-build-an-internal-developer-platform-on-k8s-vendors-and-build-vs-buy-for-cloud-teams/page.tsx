...
export const metadata = {
  ...
  openGraph: {
    title: 'Comparing Kubernetes Platform Engineering: Build an Internal Developer Platform on K8s: vendors and build vs buy for cloud teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/comparing-kubernetes-platform-engineering-build-an-internal-developer-platform-on-k8s-vendors-and-build-vs-buy-for-cloud-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/comparing-kubernetes-platform-engineering-build-an-internal-developer-platform-on-k8s-vendors-and-build-vs-buy-for-cloud-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Comparing Kubernetes Platform Engineering: Build an Internal Developer Platform on K8s: vendors and build vs buy for cloud teams' }]} className="mb-8" />
