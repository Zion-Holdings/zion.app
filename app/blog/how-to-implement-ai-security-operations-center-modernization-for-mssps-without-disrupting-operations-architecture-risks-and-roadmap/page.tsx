...
export const metadata = {
  ...
  openGraph: {
    title: 'How to implement AI Security Operations Center Modernization for MSSPs without disrupting operations: architecture, risks, and roadmap',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/how-to-implement-ai-security-operations-center-modernization-for-mssps-without-disrupting-operations-architecture-risks-and-roadmap/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/how-to-implement-ai-security-operations-center-modernization-for-mssps-without-disrupting-operations-architecture-risks-and-roadmap/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'How to implement AI Security Operations Center Modernization for MSSPs without disrupting operations: architecture, risks, and roadmap' }]} className="mb-8" />
