...
export const metadata = {
  title: 'AI Meeting Assistant: case study | Zion Tech Group',
  description: 'AI Meeting Assistant: case study',
  keywords: ['ai', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'AI Meeting Assistant: case study',
    description: 'AI Meeting Assistant: case study',
    url: 'https://ziontechgroup.com/blog/ai-meeting-assistant-case-study/',
    type: 'article',
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Meeting Assistant: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AI Meeting Assistant: case study</h1>
          <p className="mt-4 text-lg text-slate-300">AI Meeting Assistant: case study</p>
