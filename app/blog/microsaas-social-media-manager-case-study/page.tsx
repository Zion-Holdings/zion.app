...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "MicroSaaS Social Media Manager: case study", "description": "MicroSaaS Social Media Manager: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:12:19Z", "dateModified": "2026-08-04T16:12:19Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/microsaas-social-media-manager-case-study/"};
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/container-security-lifecycle-2026-3156">Container Security Lifecycle 2026 3156</Link></li>
...
<li><Link href="/blog/etl-pipeline-optimization-2026-2268">Etl Pipeline Optimization 2026 2268</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
