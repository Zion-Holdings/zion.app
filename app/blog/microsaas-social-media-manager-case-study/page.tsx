...
export const metadata = {
  title: 'MicroSaaS Social Media Manager: case study | Zion Tech Group',
  description: 'MicroSaaS Social Media Manager: case study',
  keywords: ['ai', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'MicroSaaS Social Media Manager: case study',
    description: 'MicroSaaS Social Media Manager: case study',
    url: 'https://ziontechgroup.com/blog/microsaas-social-media-manager-case-study/',
    type: 'article',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "MicroSaaS Social Media Manager: case study", "description": "MicroSaaS Social Media Manager: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-07T04:51:50Z", "dateModified": "2026-08-07T04:51:50Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/microsaas-social-media-manager-case-study/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">

    <BlogPostStructuredData title="MicroSaaS Social Media Manager: case study | Zion Tech Group" description="MicroSaaS Social Media Manager: case study" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/microsaas-social-media-manager-case-study/" />
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'MicroSaaS Social Media Manager: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">MicroSaaS Social Media Manager: case study</h1>
          <p className="mt-4 text-lg text-slate-300">MicroSaaS Social Media Manager: case study</p>
