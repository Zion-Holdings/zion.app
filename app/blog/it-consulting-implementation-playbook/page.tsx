...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="IT Consulting: implementation playbook | Zion Tech Group" description="IT Consulting: implementation playbook" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/it-consulting-implementation-playbook/" />
