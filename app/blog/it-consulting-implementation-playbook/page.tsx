...
const jsonLd = {
  ...
  '@type': 'TechArticle',
  headline: 'IT Consulting: implementation playbook',
  description: 'IT Consulting: implementation playbook.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.com/blog/it-consulting-2026/implementation-playbook/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'IT Consulting: implementation playbook' },
      ]}
    >
