...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "IT Consulting: implementation playbook", "description": "IT Consulting: implementation playbook", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T12:47:40Z", "dateModified": "2026-08-06T12:47:40Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/it-consulting-implementation-playbook/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'IT Consulting: implementation playbook' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">IT Consulting: implementation playbook</h1>
          <p className="mt-4 text-lg text-slate-300">IT Consulting: implementation playbook</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link /blog/ai-it-operations-automation-2026-6832/>Ai It Operations Automation 2026 6832</Link></li>
<li><Link /blog/apm-application-performance-roi-and-cost-model/>Apm Application Performance Roi And Cost Model</Link></li>
<li><Link /blog/ai-agent-safety-evaluation-evaluation-framework/>Ai Agent Safety Evaluation Evaluation Framework</Link></li>
