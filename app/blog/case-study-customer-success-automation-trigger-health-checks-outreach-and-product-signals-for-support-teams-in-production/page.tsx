...
export const metadata = {
  ...
  openGraph: {
    title: 'Case study: Customer Success Automation: Trigger Health Checks, Outreach, and Product Signals for support teams in production',
    description: 'Health-based playbooks and intervention timing',
    url: 'https://ziontechgroup.com/blog/case-study-customer-success-automation-trigger-health-checks-outreach-and-product-signals-for-support-teams-in-production/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/case-study-customer-success-automation-trigger-health-checks-outreach-and-product-signals-for-support-teams-in-production/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Case study: Customer Success Automation: Trigger Health Checks, Outreach, and Product Signals for support teams in production' }]} className="mb-8" />
