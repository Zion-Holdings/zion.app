...
export default function Page() {
  return (
    <PageShell title="AI Customer Support" description="Practical guide to ai customer support: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/ai-customer-support-pro-2026-6978/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/ai-customer-support-pro-2026-6978/'
    }}>
