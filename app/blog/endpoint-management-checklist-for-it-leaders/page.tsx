...
<li><Link href="/blog/devops-platform-roi-model/">Devops Platform Roi Model</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
