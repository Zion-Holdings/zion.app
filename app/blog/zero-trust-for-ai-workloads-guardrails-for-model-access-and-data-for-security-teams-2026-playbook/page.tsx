...
export const metadata = {
  ...
  openGraph: {
    title: 'Zero Trust for AI Workloads: Guardrails for Model Access and Data for security teams: 2026 Playbook',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/zero-trust-for-ai-workloads-guardrails-for-model-access-and-data-for-security-teams-2026-playbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/zero-trust-for-ai-workloads-guardrails-for-model-access-and-data-for-security-teams-2026-playbook/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Zero Trust for AI Workloads: Guardrails for Model Access and Data for security teams: 2026 Playbook' }]} className="mb-8" />
