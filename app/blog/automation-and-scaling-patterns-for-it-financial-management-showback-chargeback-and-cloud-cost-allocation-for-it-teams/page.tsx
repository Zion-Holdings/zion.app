...
export const metadata = {
  ...
  openGraph: {
    title: 'Automation and scaling patterns for IT Financial Management: Showback, Chargeback, and Cloud Cost Allocation for it teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/automation-and-scaling-patterns-for-it-financial-management-showback-chargeback-and-cloud-cost-allocation-for-it-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/automation-and-scaling-patterns-for-it-financial-management-showback-chargeback-and-cloud-cost-allocation-for-it-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Automation and scaling patterns for IT Financial Management: Showback, Chargeback, and Cloud Cost Allocation for it teams' }]} className="mb-8" />
