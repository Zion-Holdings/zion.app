...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Enterprise AI Intelligence Hub: evaluation framework", "description": "Enterprise AI Intelligence Hub: evaluation framework", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-17T17:20:16Z", "dateModified": "2026-08-17T17:20:16Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/enterprise-ai-intelligence-hub-evaluation-framework/"};
  ...
  return (
    ...
    >
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Enterprise AI Intelligence Hub: evaluation framework' }]} className="mb-8" />
        <header className="mb-10">
          ...
          <p className="mt-4 text-lg text-slate-300">Enterprise AI Intelligence Hub: evaluation framework</p>
