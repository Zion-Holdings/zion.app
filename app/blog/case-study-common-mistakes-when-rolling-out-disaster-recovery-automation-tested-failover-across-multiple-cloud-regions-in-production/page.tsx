...
export const metadata = {
  ...
  openGraph: {
    title: 'Case study: Common mistakes when rolling out Disaster Recovery Automation: Tested Failover Across Multiple Cloud Regions in production',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/case-study-common-mistakes-when-rolling-out-disaster-recovery-automation-tested-failover-across-multiple-cloud-regions-in-production/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/case-study-common-mistakes-when-rolling-out-disaster-recovery-automation-tested-failover-across-multiple-cloud-regions-in-production/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Case study: Common mistakes when rolling out Disaster Recovery Automation: Tested Failover Across Multiple Cloud Regions in production' }]} className="mb-8" />
