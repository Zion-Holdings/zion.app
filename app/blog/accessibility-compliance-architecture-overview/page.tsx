...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Accessibility Compliance: architecture overview | Zion Tech Group" description="Accessibility Compliance: architecture overview" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/accessibility-compliance-architecture-overview/" />
