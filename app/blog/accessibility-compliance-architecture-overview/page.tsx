...
export const metadata = {
  ...
  openGraph: {
    ...
    description: 'Accessibility Compliance: architecture overview',
    url: 'https://ziontechgroup.com/blog/accessibility-compliance-architecture-overview/',
    type: 'article',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Accessibility Compliance: architecture overview", "description": "Accessibility Compliance: architecture overview", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:28:39Z", "dateModified": "2026-08-04T16:28:39Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/accessibility-compliance-architecture-overview/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Accessibility Compliance: architecture overview' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Accessibility Compliance: architecture overview</h1>
          <p className="mt-4 text-lg text-slate-300">Accessibility Compliance: architecture overview</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/ai-data-lakehouse-pipelines-2026-4290">Ai Data Lakehouse Pipelines 2026 4290</Link></li>
<li><Link href="/blog/edge-computing-deployment-2026-3714">Edge Computing Deployment 2026 3714</Link></li>
<li><Link href="/blog/devops-gen-ai-cicd-2026-3919">Devops Gen Ai Cicd 2026 3919</Link></li>
<li><Link href="/blog/api-security-testing-2026-827">Api Security Testing 2026 827</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
