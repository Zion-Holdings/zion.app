...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Smart Contract Audit: architecture overview | Zion Tech Group" description="Smart Contract Audit: architecture overview" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/smart-contract-audit-architecture-overview/" />
