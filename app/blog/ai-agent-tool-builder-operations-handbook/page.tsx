...
export const metadata = {
  ...
  openGraph: {
    title: 'AI Agent Tool Builder: operations handbook | Zion Tech Group',
    description: 'AI Agent Tool Builder: operations handbook.',
    url: 'https://ziontechgroup.comapp/blog/ai-agent-tool-builder-operations-handbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/ai-agent-tool-builder-operations-handbook/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'AI Agent Tool Builder: operations handbook',
  description: 'AI Agent Tool Builder: operations handbook.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/ai-agent-tool-builder-operations-handbook/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'AI Agent Tool Builder: operations handbook' },
      ]}
    >
