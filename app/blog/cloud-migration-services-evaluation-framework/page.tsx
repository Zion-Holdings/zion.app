...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Cloud Migration Services: evaluation framework | Zion Tech Group" description="Cloud Migration Services: evaluation framework" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/cloud-migration-services-evaluation-framework/" />
