...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Cloud Migration Services: evaluation framework", "description": "Cloud Migration Services: evaluation framework", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:12:57Z", "dateModified": "2026-08-04T16:12:57Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/cloud-migration-services-evaluation-framework/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Cloud Migration Services: evaluation framework' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Cloud Migration Services: evaluation framework</h1>
          <p className="mt-4 text-lg text-slate-300">Cloud Migration Services: evaluation framework</p>
...
<li><Link href="/blog/smart-contract-audit-2026-1166">Smart Contract Audit 2026 1166</Link></li>
<li><Link href="/blog/apm-application-performance-2026-1012">Apm Application Performance 2026 1012</Link></li>
<li><Link href="/blog/accessibility-compliance-2026-2525">Accessibility Compliance 2026 2525</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
