...
export const metadata = {
  title: 'AWS Cost Optimization: policy and compliance | Zion Tech Group',
  description: 'AWS Cost Optimization: policy and compliance',
  keywords: ['cloud', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'AWS Cost Optimization: policy and compliance',
    description: 'AWS Cost Optimization: policy and compliance',
    url: 'https://ziontechgroup.com/blog/aws-cost-optimization-policy-and-compliance/',
    type: 'article',
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AWS Cost Optimization: policy and compliance' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AWS Cost Optimization: policy and compliance</h1>
          <p className="mt-4 text-lg text-slate-300">AWS Cost Optimization: policy and compliance</p>
