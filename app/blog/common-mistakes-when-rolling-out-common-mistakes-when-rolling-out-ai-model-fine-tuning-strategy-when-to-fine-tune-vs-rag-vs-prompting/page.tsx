...
export const metadata = {
  ...
  openGraph: {
    title: 'Common mistakes when rolling out Common mistakes when rolling out AI Model Fine-Tuning Strategy: When to Fine-Tune vs. RAG vs. Prompting',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/common-mistakes-when-rolling-out-common-mistakes-when-rolling-out-ai-model-fine-tuning-strategy-when-to-fine-tune-vs-rag-vs-prompting/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/common-mistakes-when-rolling-out-common-mistakes-when-rolling-out-ai-model-fine-tuning-strategy-when-to-fine-tune-vs-rag-vs-prompting/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Common mistakes when rolling out Common mistakes when rolling out AI Model Fine-Tuning Strategy: When to Fine-Tune vs. RAG vs. Prompting' }]} className="mb-8" />
