...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "GraphQL Federation Platform: evaluation framework", "description": "GraphQL Federation Platform: evaluation framework", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-17T17:20:26Z", "dateModified": "2026-08-17T17:20:26Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/graphql-federation-platform-evaluation-framework/"};
  ...
  return (
    ...
    >
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'GraphQL Federation Platform: evaluation framework' }]} className="mb-8" />
        <header className="mb-10">
          ...
          <p className="mt-4 text-lg text-slate-300">GraphQL Federation Platform: evaluation framework</p>
