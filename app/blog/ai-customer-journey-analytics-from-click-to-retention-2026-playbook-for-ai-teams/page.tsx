...
export const metadata = {
  ...
  openGraph: {
    title: 'AI Customer Journey Analytics: From Click to Retention: 2026 Playbook for ai teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/ai-customer-journey-analytics-from-click-to-retention-2026-playbook-for-ai-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-customer-journey-analytics-from-click-to-retention-2026-playbook-for-ai-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Customer Journey Analytics: From Click to Retention: 2026 Playbook for ai teams' }]} className="mb-8" />
