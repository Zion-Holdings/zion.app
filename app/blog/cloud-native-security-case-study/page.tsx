...
export const metadata = {
  title: 'Cloud Native Security: case study | Zion Tech Group',
  description: 'Cloud Native Security: case study',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Cloud Native Security: case study',
    description: 'Cloud Native Security: case study',
    url: 'https://ziontechgroup.com/blog/cloud-native-security-case-study/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/cloud-native-security-case-study/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Cloud Native Security: case study", "description": "Cloud Native Security: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:08:00Z", "dateModified": "2026-08-06T18:08:00Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/cloud-native-security-case-study/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Cloud Native Security: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Cloud Native Security: case study</h1>
          <p className="mt-4 text-lg text-slate-300">Cloud Native Security: case study</p>
