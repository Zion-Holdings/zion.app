...
export const metadata = {
  title: 'Microservices Security: evaluation framework | Zion Tech Group',
  description: 'Microservices Security: evaluation framework',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Microservices Security: evaluation framework',
    description: 'Microservices Security: evaluation framework',
    url: 'https://ziontechgroup.com/blog/microservices-security-evaluation-framework/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/microservices-security-evaluation-framework/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Microservices Security: evaluation framework", "description": "Microservices Security: evaluation framework", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T19:15:17Z", "dateModified": "2026-08-06T19:15:17Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/microservices-security-evaluation-framework/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Microservices Security: evaluation framework' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Microservices Security: evaluation framework</h1>
          <p className="mt-4 text-lg text-slate-300">Microservices Security: evaluation framework</p>
...
<li><Link href="/blog/data-quality-security-and-governance">Data Quality Security And Governance</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
