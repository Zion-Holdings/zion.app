...
export const metadata = {
  title: 'SIEM: vendor evaluation | Zion Tech Group',
  description: 'SIEM: vendor evaluation',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'SIEM: vendor evaluation',
    description: 'SIEM: vendor evaluation',
    url: 'https://ziontechgroup.com/blog/siem-vendor-evaluation/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/siem-vendor-evaluation/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "SIEM: vendor evaluation", "description": "SIEM: vendor evaluation", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:01:30Z", "dateModified": "2026-08-06T18:01:30Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/siem-vendor-evaluation/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'SIEM: vendor evaluation' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">SIEM: vendor evaluation</h1>
          <p className="mt-4 text-lg text-slate-300">SIEM: vendor evaluation</p>
