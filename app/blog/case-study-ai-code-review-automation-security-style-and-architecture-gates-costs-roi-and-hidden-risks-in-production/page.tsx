...
export const metadata = {
  ...
  openGraph: {
    title: 'Case study: AI Code Review Automation: Security, Style, and Architecture Gates: costs, ROI, and hidden risks in production',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/case-study-ai-code-review-automation-security-style-and-architecture-gates-costs-roi-and-hidden-risks-in-production/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/case-study-ai-code-review-automation-security-style-and-architecture-gates-costs-roi-and-hidden-risks-in-production/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Case study: AI Code Review Automation: Security, Style, and Architecture Gates: costs, ROI, and hidden risks in production' }]} className="mb-8" />
