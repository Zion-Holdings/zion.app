...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI BDR SDR: common mistakes | Zion Tech Group" description="AI BDR SDR: common mistakes" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-bdr-sdr-common-mistakes/" />
