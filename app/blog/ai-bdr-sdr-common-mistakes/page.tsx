...
export const metadata = {
  ...
  openGraph: {
    ...
    description: 'AI BDR SDR: common mistakes',
    url: 'https://ziontechgroup.com/blog/ai-bdr-sdr-common-mistakes/',
    type: 'article',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AI BDR SDR: common mistakes", "description": "AI BDR SDR: common mistakes", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T15:07:58Z", "dateModified": "2026-08-04T15:07:58Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ai-bdr-sdr-common-mistakes/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI BDR SDR: common mistakes' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AI BDR SDR: common mistakes</h1>
          <p className="mt-4 text-lg text-slate-300">AI BDR SDR: common mistakes</p>
