...
export const metadata = {
  title: 'Threat Hunting: evaluation framework | Zion Tech Group',
  description: 'Threat Hunting: evaluation framework',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Threat Hunting: evaluation framework',
    description: 'Threat Hunting: evaluation framework',
    url: 'https://ziontechgroup.com/blog/threat-hunting-evaluation-framework/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/threat-hunting-evaluation-framework/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Threat Hunting: evaluation framework", "description": "Threat Hunting: evaluation framework", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:11:49Z", "dateModified": "2026-08-06T18:11:49Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/threat-hunting-evaluation-framework/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Threat Hunting: evaluation framework' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Threat Hunting: evaluation framework</h1>
          <p className="mt-4 text-lg text-slate-300">Threat Hunting: evaluation framework</p>
...
<li><Link href="/blog/business-intelligence-executive-guide">Business Intelligence Executive Guide</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
