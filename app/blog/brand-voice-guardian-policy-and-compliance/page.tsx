...
export const metadata = {
  ...
  openGraph: {
    title: 'Brand Voice Guardian: policy and compliance',
    description: 'Brand Voice Guardian: policy and compliance',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Brand Voice Guardian: policy and compliance", "description": "Brand Voice Guardian: policy and compliance", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-24T13:22:02Z", "dateModified": "2026-08-24T13:22:02Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/brand-voice-guardian-policy-and-compliance/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Brand Voice Guardian: policy and compliance' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Brand Voice Guardian: policy and compliance</h1>
          <p className="mt-4 text-lg text-slate-300">Brand Voice Guardian: policy and compliance</p>
