...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Chaos Engineering: common mistakes | Zion Tech Group" description="Chaos Engineering: common mistakes" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/chaos-engineering-common-mistakes/" />
