...
export const metadata = {
  ...
  openGraph: {
    title: 'Common mistakes when rolling out Terraform and IaC Security: Scan Terraform, CloudFormation, and Pulumi for Misconfigurations for cloud teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/common-mistakes-when-rolling-out-terraform-and-iac-security-scan-terraform-cloudformation-and-pulumi-for-misconfigurations-for-cloud-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/common-mistakes-when-rolling-out-terraform-and-iac-security-scan-terraform-cloudformation-and-pulumi-for-misconfigurations-for-cloud-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Common mistakes when rolling out Terraform and IaC Security: Scan Terraform, CloudFormation, and Pulumi for Misconfigurations for cloud teams' }]} className="mb-8" />
