...
export const metadata = {
  ...
  openGraph: {
    title: 'How to implement OpenTelemetry Implementation Guide: Instrument Any Language and Export Anywhere: 2026 Playbook without disrupting operations',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/how-to-implement-opentelemetry-implementation-guide-instrument-any-language-and-export-anywhere-2026-playbook-without-disrupting-operations/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/how-to-implement-opentelemetry-implementation-guide-instrument-any-language-and-export-anywhere-2026-playbook-without-disrupting-operations/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'How to implement OpenTelemetry Implementation Guide: Instrument Any Language and Export Anywhere: 2026 Playbook without disrupting operations' }]} className="mb-8" />
