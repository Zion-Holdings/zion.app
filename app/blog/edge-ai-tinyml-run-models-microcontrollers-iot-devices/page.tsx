...
export const metadata = {
  ...
  description: 'Edge AI with TinyML: Run Models on Microcontrollers and IoT Devices: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/blog/edge-ai-tinyml-run-models-microcontrollers-iot-devices',
  },
};
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'Edge AI with TinyML: Run Models on Microcontrollers and IoT Devices' }
          ]}
          className="mb-8"
        />
        ...
        <header className="mb-12">
          ...
          <p className="mt-4 text-lg text-slate-300">Edge AI with TinyML: Run Models on Microcontrollers and IoT Devices requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
