...
export const metadata = {
  title: 'Blockchain Enterprise: case study | Zion Tech Group',
  description: 'Blockchain Enterprise: case study',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Blockchain Enterprise: case study',
    description: 'Blockchain Enterprise: case study',
    url: 'https://ziontechgroup.com/blog/blockchain-enterprise-case-study/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/blockchain-enterprise-case-study/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Blockchain Enterprise: case study", "description": "Blockchain Enterprise: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:08:12Z", "dateModified": "2026-08-06T18:08:12Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/blockchain-enterprise-case-study/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Blockchain Enterprise: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Blockchain Enterprise: case study</h1>
          <p className="mt-4 text-lg text-slate-300">Blockchain Enterprise: case study</p>
