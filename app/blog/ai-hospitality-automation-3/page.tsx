...
export const metadata = {
  title: 'AI hospitality automation: costs, ROI, and hidden risks | Zion Tech Group',
  description: 'AI hospitality automation: costs, ROI, and hidden risks',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'AI hospitality automation: costs, ROI, and hidden risks',
    description: 'AI hospitality automation: costs, ROI, and hidden risks',
    url: 'https://ziontechgroup.com/blog/ai-hospitality-automation-3/',
    type: 'article',
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI hospitality automation: costs, ROI, and hidden risks' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AI hospitality automation: costs, ROI, and hidden risks</h1>
          <p className="mt-4 text-lg text-slate-300">AI hospitality automation: costs, ROI, and hidden risks</p>
