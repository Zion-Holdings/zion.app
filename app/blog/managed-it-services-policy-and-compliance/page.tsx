...
export const metadata = {
  ...
  openGraph: {
    title: 'Managed IT Services: policy and compliance | Zion Tech Group',
    description: 'Managed IT Services: policy and compliance.',
    url: 'https://ziontechgroup.comapp/blog/managed-it-services-policy-and-compliance/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/managed-it-services-policy-and-compliance/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'Managed IT Services: policy and compliance',
  description: 'Managed IT Services: policy and compliance.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/managed-it-services-policy-and-compliance/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'Managed IT Services: policy and compliance' },
      ]}
    >
