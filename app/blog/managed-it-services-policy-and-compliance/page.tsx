...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Managed IT Services: policy and compliance | Zion Tech Group" description="Managed IT Services: policy and compliance" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/managed-it-services-policy-and-compliance/" />
