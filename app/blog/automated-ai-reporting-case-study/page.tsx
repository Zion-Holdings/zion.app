...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Automated AI Reporting: case study | Zion Tech Group" description="Automated AI Reporting: case study" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/automated-ai-reporting-case-study/" />
