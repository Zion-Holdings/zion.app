...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Automated AI Reporting: case study", "description": "Automated AI Reporting: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:23:41Z", "dateModified": "2026-08-04T16:23:41Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/automated-ai-reporting-case-study/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Automated AI Reporting: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Automated AI Reporting: case study</h1>
          <p className="mt-4 text-lg text-slate-300">Automated AI Reporting: case study</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/ai-accessibility-optimizer-2026-3891">Ai Accessibility Optimizer 2026 3891</Link></li>
<li><Link href="/blog/ai-agentic-workflows-2026-1480">Ai Agentic Workflows 2026 1480</Link></li>
<li><Link href="/blog/api-management-gateway-2026-1287">Api Management Gateway 2026 1287</Link></li>
<li><Link href="/blog/ai-accessibility-optimizer-2026-1338">Ai Accessibility Optimizer 2026 1338</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
