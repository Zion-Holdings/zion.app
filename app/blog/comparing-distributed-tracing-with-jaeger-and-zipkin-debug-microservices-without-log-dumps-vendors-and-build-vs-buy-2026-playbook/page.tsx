...
export const metadata = {
  ...
  openGraph: {
    title: 'Comparing Distributed Tracing with Jaeger and Zipkin: Debug Microservices Without Log Dumps: vendors and build vs buy: 2026 Playbook',
    description: 'Practical instrumentation and sampling strategy',
    url: 'https://ziontechgroup.com/blog/comparing-distributed-tracing-with-jaeger-and-zipkin-debug-microservices-without-log-dumps-vendors-and-build-vs-buy-2026-playbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/comparing-distributed-tracing-with-jaeger-and-zipkin-debug-microservices-without-log-dumps-vendors-and-build-vs-buy-2026-playbook/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Comparing Distributed Tracing with Jaeger and Zipkin: Debug Microservices Without Log Dumps: vendors and build vs buy: 2026 Playbook' }]} className="mb-8" />
