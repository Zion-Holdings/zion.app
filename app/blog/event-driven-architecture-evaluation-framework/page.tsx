...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Event Driven Architecture: evaluation framework", "description": "Event Driven Architecture: evaluation framework", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:28:36Z", "dateModified": "2026-08-04T16:28:36Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/event-driven-architecture-evaluation-framework/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Event Driven Architecture: evaluation framework' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Event Driven Architecture: evaluation framework</h1>
          <p className="mt-4 text-lg text-slate-300">Event Driven Architecture: evaluation framework</p>
...
<li><Link href="/blog/edge-computing-deployment-2026-2679">Edge Computing Deployment 2026 2679</Link></li>
<li><Link href="/blog/ai-it-operations-automation-2026">Ai It Operations Automation 2026</Link></li>
<li><Link href="/blog/it-consulting-2026-1326">It Consulting 2026 1326</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
