...
export const metadata = {
  ...
  openGraph: {
    title: 'Hyperautomation Strategy 2026: Combine RPA, AI, and Process Mining for automation teams: costs, ROI, and hidden risks',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/hyperautomation-strategy-2026-combine-rpa-ai-and-process-mining-for-automation-teams-costs-roi-and-hidden-risks/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/hyperautomation-strategy-2026-combine-rpa-ai-and-process-mining-for-automation-teams-costs-roi-and-hidden-risks/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Hyperautomation Strategy 2026: Combine RPA, AI, and Process Mining for automation teams: costs, ROI, and hidden risks' }]} className="mb-8" />
