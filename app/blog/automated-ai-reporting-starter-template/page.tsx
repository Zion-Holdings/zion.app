...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Automated AI Reporting: starter template | Zion Tech Group" description="Automated AI Reporting: starter template" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/automated-ai-reporting-starter-template/" />
