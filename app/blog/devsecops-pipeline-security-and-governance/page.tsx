...
export const metadata = {
  title: 'DevSecOps Pipeline: security and governance | Zion Tech Group',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "DevSecOps Pipeline: security and governance", "description": "DevSecOps Pipeline: security and governance", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:24:29Z", "dateModified": "2026-08-04T16:24:29Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/devsecops-pipeline-security-and-governance/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'DevSecOps Pipeline: security and governance' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">DevSecOps Pipeline: security and governance</h1>
          <p className="mt-4 text-lg text-slate-300">DevSecOps Pipeline: security and governance</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/database-migration-service-2026-3642">Database Migration Service 2026 3642</Link></li>
<li><Link href="/blog/ai-development-acceleration-2026-1388">Ai Development Acceleration 2026 1388</Link></li>
<li><Link href="/blog/ai-msp-security-compliance-2026-3875">Ai Msp Security Compliance 2026 3875</Link></li>
<li><Link href="/blog/ai-it-operations-automation-2026-760">Ai It Operations Automation 2026 760</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
