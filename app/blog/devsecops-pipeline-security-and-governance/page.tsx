...
export const metadata = {
  ...
  openGraph: {
    title: 'DevSecOps Pipeline: security and governance | Zion Tech Group',
    description: 'DevSecOps Pipeline: security and governance.',
    url: 'https://ziontechgroup.comapp/blog/devsecops-pipeline-security-and-governance/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/devsecops-pipeline-security-and-governance/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'DevSecOps Pipeline: security and governance',
  description: 'DevSecOps Pipeline: security and governance.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/devsecops-pipeline-security-and-governance/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'DevSecOps Pipeline: security and governance' },
      ]}
    >
