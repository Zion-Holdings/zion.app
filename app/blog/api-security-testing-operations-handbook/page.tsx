        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/ai-autonomous-agents-2026-860">Ai Autonomous Agents 2026 860</Link></li>
<li><Link href="/blog/event-driven-architecture-2026-3097">Event Driven Architecture 2026 3097</Link></li>
<li><Link href="/blog/cybersecurity-platform-msp-2026-2832">Cybersecurity Platform Msp 2026 2832</Link></li>
<li><Link href="/blog/it-consulting-2026-2982">It Consulting 2026 2982</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
