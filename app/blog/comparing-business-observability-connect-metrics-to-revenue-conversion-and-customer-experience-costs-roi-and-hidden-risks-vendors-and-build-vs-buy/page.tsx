...
export const metadata = {
  ...
  openGraph: {
    title: 'Comparing Business Observability: Connect Metrics to Revenue, Conversion, and Customer Experience: costs, ROI, and hidden risks: vendors and build vs buy',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/comparing-business-observability-connect-metrics-to-revenue-conversion-and-customer-experience-costs-roi-and-hidden-risks-vendors-and-build-vs-buy/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/comparing-business-observability-connect-metrics-to-revenue-conversion-and-customer-experience-costs-roi-and-hidden-risks-vendors-and-build-vs-buy/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Comparing Business Observability: Connect Metrics to Revenue, Conversion, and Customer Experience: costs, ROI, and hidden risks: vendors and build vs buy' }]} className="mb-8" />
