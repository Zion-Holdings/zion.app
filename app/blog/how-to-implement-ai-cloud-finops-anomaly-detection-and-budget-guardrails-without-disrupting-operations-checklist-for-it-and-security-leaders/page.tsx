...
export const metadata = {
  ...
  openGraph: {
    title: 'How to implement AI Cloud FinOps: Anomaly Detection and Budget Guardrails without disrupting operations checklist for IT and security leaders',
    description: 'Finance and engineering collaboration with automated alerts',
    url: 'https://ziontechgroup.com/blog/how-to-implement-ai-cloud-finops-anomaly-detection-and-budget-guardrails-without-disrupting-operations-checklist-for-it-and-security-leaders/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/how-to-implement-ai-cloud-finops-anomaly-detection-and-budget-guardrails-without-disrupting-operations-checklist-for-it-and-security-leaders/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'How to implement AI Cloud FinOps: Anomaly Detection and Budget Guardrails without disrupting operations checklist for IT and security leaders' }]} className="mb-8" />
