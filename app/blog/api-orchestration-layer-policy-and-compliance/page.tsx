...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="API Orchestration Layer: policy and compliance | Zion Tech Group" description="API Orchestration Layer: policy and compliance" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/api-orchestration-layer-policy-and-compliance/" />
