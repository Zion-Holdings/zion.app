...
export const metadata = {
  ...
  openGraph: {
    title: 'AI-Powered Incident Remediation: From Alert to Fix in Minutes checklist for IT and security leaders: architecture, risks, and roadmap',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/ai-powered-incident-remediation-from-alert-to-fix-in-minutes-checklist-for-it-and-security-leaders-architecture-risks-and-roadmap/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-powered-incident-remediation-from-alert-to-fix-in-minutes-checklist-for-it-and-security-leaders-architecture-risks-and-roadmap/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI-Powered Incident Remediation: From Alert to Fix in Minutes checklist for IT and security leaders: architecture, risks, and roadmap' }]} className="mb-8" />
