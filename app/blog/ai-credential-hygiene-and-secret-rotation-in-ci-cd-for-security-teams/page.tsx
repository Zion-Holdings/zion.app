        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/ai-it-partnership-growth-playbook-2026">Ai It Partnership Growth Playbook 2026</Link></li><li><Link href="/blog/ai-first-digital-twins-and-asset-simulation-in-2026">Ai First Digital Twins And Asset Simulation In 2026</Link></li><li><Link href="/blog/how-to-implement-mlops-pipeline-for-llms-from-fine-tuning-to-production-deployment-without-disrupting-operations">How To Implement Mlops Pipeline For Llms From Fine Tuning To Production Deployment Without Disrupting Operations</Link></li><li><Link href="/blog/ai-telecom-automation-guide-for-enterprise-teams-in-2026">Ai Telecom Automation Guide For Enterprise Teams In 2026</Link></li>
              ...
              <li><Link href="/blog/real-time-data-streaming-with-kafka-and-flink-event-driven-architecture-for-data-teams">Real Time Data Streaming With Kafka And Flink Event Driven Architecture For Data Teams</Link></li>
              ...
              <li><Link href="/blog/common-mistakes-when-rolling-out-terraform-and-iac-security-scan-terraform-cloudformation-and-pulumi-for-misconfigurations">Common Mistakes When Rolling Out Terraform And Iac Security Scan Terraform Cloudformation And Pulumi For Misconfigurations</Link></li>
