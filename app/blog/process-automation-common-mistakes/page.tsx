...
export const metadata = {
  title: 'Process Automation: common mistakes | Zion Tech Group',
  description: 'Process Automation: common mistakes',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Process Automation: common mistakes',
    description: 'Process Automation: common mistakes',
    url: 'https://ziontechgroup.com/blog/process-automation-common-mistakes/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/process-automation-common-mistakes/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Process Automation: common mistakes", "description": "Process Automation: common mistakes", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:07:47Z", "dateModified": "2026-08-06T18:07:47Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/process-automation-common-mistakes/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Process Automation: common mistakes' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Process Automation: common mistakes</h1>
          <p className="mt-4 text-lg text-slate-300">Process Automation: common mistakes</p>
