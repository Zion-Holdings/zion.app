...
<li><Link href="/blog/autonomous-code-deployment-2026-243">Autonomous Code Deployment 2026 243</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
