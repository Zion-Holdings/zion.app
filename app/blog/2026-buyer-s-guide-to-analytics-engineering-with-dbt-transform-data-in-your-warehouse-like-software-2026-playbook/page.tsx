...
export const metadata = {
  ...
  openGraph: {
    title: '2026 buyer's guide to Analytics Engineering with dbt: Transform Data in Your Warehouse Like Software: 2026 Playbook',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/2026-buyer-s-guide-to-analytics-engineering-with-dbt-transform-data-in-your-warehouse-like-software-2026-playbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/2026-buyer-s-guide-to-analytics-engineering-with-dbt-transform-data-in-your-warehouse-like-software-2026-playbook/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: '2026 buyer's guide to Analytics Engineering with dbt: Transform Data in Your Warehouse Like Software: 2026 Playbook' }]} className="mb-8" />
