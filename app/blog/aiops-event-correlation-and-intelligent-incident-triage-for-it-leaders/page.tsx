...
export const metadata = {
  ...
  description: 'Aiops Event Correlation And Intelligent Incident Triage For It Leaders: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
    title: 'Aiops Event Correlation And Intelligent Incident Triage For It Leaders',
    description: 'Aiops Event Correlation And Intelligent Incident Triage For It Leaders: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
    url: 'https://ziontechgroup.com/blog/aiops-event-correlation-and-intelligent-incident-triage-for-it-leaders',
    type: 'article',
  },
  alternates: {
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'Aiops Event Correlation And Intelligent Incident Triage For It Leaders' }
          ]}
          className="mb-8"
        />
        ...
        <header className="mb-12">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Aiops Event Correlation And Intelligent Incident Triage For It Leaders</h1>
          <p className="mt-4 text-lg text-slate-300">Aiops Event Correlation And Intelligent Incident Triage For It Leaders requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
