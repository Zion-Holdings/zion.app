...
export const metadata = {
  ...
  openGraph: {
    title: 'How to implement Synthetic Data Generation for Compliance and Model Training without disrupting operations for data teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/how-to-implement-synthetic-data-generation-for-compliance-and-model-training-without-disrupting-operations-for-data-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/how-to-implement-synthetic-data-generation-for-compliance-and-model-training-without-disrupting-operations-for-data-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'How to implement Synthetic Data Generation for Compliance and Model Training without disrupting operations for data teams' }]} className="mb-8" />
