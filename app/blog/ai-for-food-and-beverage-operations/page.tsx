  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <ArticleStructuredData
        headline="AI for Food and Beverage Operations"
        description="Demand forecasting, quality control, supply chain traceability, and waste reduction. AI across the food value chain."
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'AI for Food and Beverage Operations' },
          ]}
          className="mb-8"
        />
