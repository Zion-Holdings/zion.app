        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/event-driven-architecture-2026-1165">Event Driven Architecture 2026 1165</Link></li>
...
<li><Link href="/blog/enterprise-ai-intelligence-hub-2026-3474">Enterprise Ai Intelligence Hub 2026 3474</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
