...
export default function Page() {
  return (
    <PageShell title="AI Observability" description="Practical guide to ai observability: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/ai-observability-2026-6910/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/ai-observability-2026-6910/'
    }}>
