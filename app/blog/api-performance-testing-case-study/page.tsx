...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="API Performance Testing: case study | Zion Tech Group" description="API Performance Testing: case study" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/api-performance-testing-case-study/" />
