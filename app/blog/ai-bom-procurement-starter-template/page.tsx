...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI BOM Procurement: starter template | Zion Tech Group" description="AI BOM Procurement: starter template" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-bom-procurement-starter-template/" />
