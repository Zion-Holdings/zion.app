...
export const metadata = {
  ...
  description: 'Ai For Document Intelligence And Intelligent Automation: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
    ...
    <div className="relative min-h-screen bg-slate-950">
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <header className="mb-12">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Ai For Document Intelligence And Intelligent Automation</h1>
          <p className="mt-4 text-lg text-slate-300">Ai For Document Intelligence And Intelligent Automation requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
