...
export const metadata = {
  title: 'Generative Ai Automation Playbook For Enterprise | Zion Tech Group',
  description: 'Generative Ai Automation Playbook For Enterprise: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
    title: 'Generative Ai Automation Playbook For Enterprise',
    description: 'Generative Ai Automation Playbook For Enterprise: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
    url: 'https://ziontechgroup.com/blog/generative-ai-automation-playbook-for-enterprise',
    type: 'article',
  },
  alternates: {
    canonical: 'https://ziontechgroup.com/blog/generative-ai-automation-playbook-for-enterprise',
  },
};
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'Generative Ai Automation Playbook For Enterprise' }
          ]}
          className="mb-8"
        />
        ...
        <header className="mb-12">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Generative Ai Automation Playbook For Enterprise</h1>
          <p className="mt-4 text-lg text-slate-300">Generative Ai Automation Playbook For Enterprise requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
