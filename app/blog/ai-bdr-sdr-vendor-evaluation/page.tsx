...
export const metadata = {
  ...
  openGraph: {
    title: 'AI BDR SDR: vendor evaluation | Zion Tech Group',
    description: 'AI BDR SDR: vendor evaluation.',
    url: 'https://ziontechgroup.comapp/blog/ai-bdr-sdr-vendor-evaluation/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/ai-bdr-sdr-vendor-evaluation/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'AI BDR SDR: vendor evaluation',
  description: 'AI BDR SDR: vendor evaluation.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/ai-bdr-sdr-vendor-evaluation/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'AI BDR SDR: vendor evaluation' },
      ]}
    >
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <section className="prose prose-invert max-w-none">
          ...
          <p className="text-slate-300 mb-6">AI BDR SDR: vendor evaluation. Organizations benefit from clearer requirements, tighter governance, and repeatable delivery models.</p>
