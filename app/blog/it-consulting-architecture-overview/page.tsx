...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="IT Consulting: architecture overview | Zion Tech Group" description="IT Consulting: architecture overview" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/it-consulting-architecture-overview/" />
