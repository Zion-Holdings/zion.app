...
export const metadata = {
  ...
  description: 'IT Consulting: architecture overview - AI and IT insights from Zion Tech Group.',
  openGraph: {
    title: 'IT Consulting: architecture overview',
    description: 'IT Consulting: architecture overview - AI and IT insights from Zion Tech Group.',
    url: 'https://ziontechgroup.com/blog/it-consulting-2026/2026/2026/architecture-overview/',
    type: 'article',
  },
  alternates: { canonical: '/blog/it-consulting-2026/2026/2026/architecture-overview/' },
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'IT Consulting: architecture overview' },
      ]}
    >
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <header className="mb-10">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">IT Consulting: architecture overview | Zion Tech Group</h1>
