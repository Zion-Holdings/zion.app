        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/micro-saas-ai-customer-onboarding-2026-2575">Micro Saas Ai Customer Onboarding 2026 2575</Link></li>
<li><Link href="/blog/ai-accessibility-auditor-2026-923">Ai Accessibility Auditor 2026 923</Link></li>
