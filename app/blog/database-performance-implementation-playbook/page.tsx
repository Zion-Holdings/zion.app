...
export const metadata = {
  title: 'Database Performance: implementation playbook | Zion Tech Group',
  description: 'Database Performance: implementation playbook',
  keywords: ['data', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Database Performance: implementation playbook',
    description: 'Database Performance: implementation playbook',
    url: 'https://ziontechgroup.com/blog/database-performance-implementation-playbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/database-performance-implementation-playbook/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Database Performance: implementation playbook", "description": "Database Performance: implementation playbook", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:07:23Z", "dateModified": "2026-08-06T18:07:23Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/database-performance-implementation-playbook/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Database Performance: implementation playbook' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Database Performance: implementation playbook</h1>
          <p className="mt-4 text-lg text-slate-300">Database Performance: implementation playbook</p>
