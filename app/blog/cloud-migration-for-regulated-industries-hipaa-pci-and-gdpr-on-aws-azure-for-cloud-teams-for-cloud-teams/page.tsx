...
export const metadata = {
  ...
  openGraph: {
    title: 'Cloud Migration for Regulated Industries: HIPAA, PCI, and GDPR on AWS/Azure for cloud teams for cloud teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/cloud-migration-for-regulated-industries-hipaa-pci-and-gdpr-on-aws-azure-for-cloud-teams-for-cloud-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/cloud-migration-for-regulated-industries-hipaa-pci-and-gdpr-on-aws-azure-for-cloud-teams-for-cloud-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Cloud Migration for Regulated Industries: HIPAA, PCI, and GDPR on AWS/Azure for cloud teams for cloud teams' }]} className="mb-8" />
