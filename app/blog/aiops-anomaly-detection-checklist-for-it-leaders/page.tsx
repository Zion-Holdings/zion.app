...
export const metadata = {
  ...
  openGraph: {
    title: 'AIOps Anomaly Detection: checklist for IT leaders | Zion Tech Group',
    description: 'AIOps Anomaly Detection: checklist for IT leaders.',
    url: 'https://ziontechgroup.comapp/blog/aiops-anomaly-detection-checklist-for-it-leaders/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/aiops-anomaly-detection-checklist-for-it-leaders/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'AIOps Anomaly Detection: checklist for IT leaders',
  description: 'AIOps Anomaly Detection: checklist for IT leaders.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/aiops-anomaly-detection-checklist-for-it-leaders/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'AIOps Anomaly Detection: checklist for IT leaders' },
      ]}
    >
