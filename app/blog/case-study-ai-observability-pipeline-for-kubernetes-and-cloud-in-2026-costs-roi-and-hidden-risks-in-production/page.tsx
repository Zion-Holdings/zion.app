...
export const metadata = {
  ...
  openGraph: {
    title: 'Case study: AI Observability Pipeline for Kubernetes and Cloud in 2026: costs, ROI, and hidden risks in production',
    description: 'Unified metrics, logs, traces, and events pipeline',
    url: 'https://ziontechgroup.com/blog/case-study-ai-observability-pipeline-for-kubernetes-and-cloud-in-2026-costs-roi-and-hidden-risks-in-production/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/case-study-ai-observability-pipeline-for-kubernetes-and-cloud-in-2026-costs-roi-and-hidden-risks-in-production/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Case study: AI Observability Pipeline for Kubernetes and Cloud in 2026: costs, ROI, and hidden risks in production' }]} className="mb-8" />
