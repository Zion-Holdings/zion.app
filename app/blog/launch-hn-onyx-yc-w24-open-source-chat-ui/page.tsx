...
export const metadata = {
  title: 'Launch HN: Onyx (YC W24) – Open-source chat UI | Zion Tech Group',
  description: 'Launch HN: Onyx (YC W24) – Open-source chat UI',
  keywords: ['it', 'solution', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Launch HN: Onyx (YC W24) – Open-source chat UI',
    description: 'Launch HN: Onyx (YC W24) – Open-source chat UI',
    url: 'https://ziontechgroup.com/blog/launch-hn-onyx-yc-w24-open-source-chat-ui/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'https://ziontechgroup.com/blog/launch-hn-onyx-yc-w24-open-source-chat-ui/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Launch HN: Onyx (YC W24) – Open-source chat UI", "description": "Launch HN: Onyx (YC W24) – Open-source chat UI", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-03T20:47:04Z", "dateModified": "2026-08-03T20:47:04Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/launch-hn-onyx-yc-w24-open-source-chat-ui/", "wordCount": 2251};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Launch HN: Onyx (YC W24) – Open-source chat UI' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Launch HN: Onyx (YC W24) – Open-source chat UI</h1>
          <p className="mt-4 text-lg text-slate-300">Launch HN: Onyx (YC W24) – Open-source chat UI</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/ai-observability-pipeline-for-kubernetes-and-cloud-in-2026-6">Ai Observability Pipeline For Kubernetes And Cloud In 2026 6</Link></li><li><Link href="/blog/ai-customer-journey-analytics-from-click-to-retention-9">Ai Customer Journey Analytics From Click To Retention 9</Link></li><li><Link href="/blog/data-mesh-implementation-domain-owned-data-products-self-serve-infrastructure-5">Data Mesh Implementation Domain Owned Data Products Self Serve Infrastructure 5</Link></li><li><Link href="/blog/data-mesh-implementation-domain-owned-data-products-self-serve-infrastructure-3">Data Mesh Implementation Domain Owned Data Products Self Serve Infrastructure 3</Link></li>
