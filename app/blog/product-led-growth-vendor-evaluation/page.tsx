...
export const metadata = {
  title: 'Product Led Growth: vendor evaluation | Zion Tech Group',
  description: 'Product Led Growth: vendor evaluation',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Product Led Growth: vendor evaluation',
    description: 'Product Led Growth: vendor evaluation',
    url: 'https://ziontechgroup.com/blog/product-led-growth-vendor-evaluation/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/product-led-growth-vendor-evaluation/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Product Led Growth: vendor evaluation", "description": "Product Led Growth: vendor evaluation", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:11:47Z", "dateModified": "2026-08-06T18:11:47Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/product-led-growth-vendor-evaluation/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Product Led Growth: vendor evaluation' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Product Led Growth: vendor evaluation</h1>
          <p className="mt-4 text-lg text-slate-300">Product Led Growth: vendor evaluation</p>
