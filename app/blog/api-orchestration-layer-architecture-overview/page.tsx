...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="API Orchestration Layer: architecture overview | Zion Tech Group" description="API Orchestration Layer: architecture overview" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/api-orchestration-layer-architecture-overview/" />
