        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/data-contracts-for-analytics-engineering-enforce-schema-and-quality-between-teams-checklist-for-it-and-security-leaders">Data Contracts For Analytics Engineering Enforce Schema And Quality Between Teams Checklist For It And Security Leaders</Link></li><li><Link href="/blog/soc-2-automation-continuous-compliance-monitoring-and-audit-evidence-collection-checklist-for-it-and-security-leaders">Soc 2 Automation Continuous Compliance Monitoring And Audit Evidence Collection Checklist For It And Security Leaders</Link></li><li><Link href="/blog/feature-store-for-machine-learning-centralize-features-for-training-and-inference-checklist-for-it-and-security-leaders">Feature Store For Machine Learning Centralize Features For Training And Inference Checklist For It And Security Leaders</Link></li><li><Link href="/blog/nebius-latam-ai-cloud-partnership-guide">Nebius Latam Ai Cloud Partnership Guide</Link></li>
