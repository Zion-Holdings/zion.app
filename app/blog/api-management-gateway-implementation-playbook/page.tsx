...
export const metadata = {
  ...
  openGraph: {
    title: 'API Management Gateway: implementation playbook | Zion Tech Group',
    description: 'API Management Gateway: implementation playbook.',
    url: 'https://ziontechgroup.comapp/blog/api-management-gateway-implementation-playbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/api-management-gateway-implementation-playbook/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'API Management Gateway: implementation playbook',
  description: 'API Management Gateway: implementation playbook.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/api-management-gateway-implementation-playbook/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'API Management Gateway: implementation playbook' },
      ]}
    >
