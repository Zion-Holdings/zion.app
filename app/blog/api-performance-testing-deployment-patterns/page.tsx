...
<li><Link href="/blog/edge-computing-deployment-2026-2265">Edge Computing Deployment 2026 2265</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
