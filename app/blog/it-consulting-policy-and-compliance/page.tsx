...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="IT Consulting: policy and compliance | Zion Tech Group" description="IT Consulting: policy and compliance" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/it-consulting-policy-and-compliance/" />
