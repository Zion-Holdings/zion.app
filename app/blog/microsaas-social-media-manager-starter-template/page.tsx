...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="MicroSaaS Social Media Manager: starter template | Zion Tech Group" description="MicroSaaS Social Media Manager: starter template" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/microsaas-social-media-manager-starter-template/" />
