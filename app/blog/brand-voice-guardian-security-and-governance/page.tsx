...
export const metadata = {
  ...
  openGraph: {
    title: 'Brand Voice Guardian: security and governance | Zion Tech Group',
    description: 'Brand Voice Guardian: security and governance.',
    url: 'https://ziontechgroup.comapp/blog/brand-voice-guardian-security-and-governance/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/brand-voice-guardian-security-and-governance/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'Brand Voice Guardian: security and governance',
  description: 'Brand Voice Guardian: security and governance.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/brand-voice-guardian-security-and-governance/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'Brand Voice Guardian: security and governance' },
      ]}
    >
