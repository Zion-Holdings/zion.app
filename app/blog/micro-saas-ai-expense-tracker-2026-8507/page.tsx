...
export const metadata = {
  ...
  alternates: { canonical: '/blog/micro-saas-ai-expense-tracker-2026-8507/' },
  openGraph: { title: 'MicroSaaS Expense Tracker', description: 'Practical guide to microsaas expense tracker.', url: 'https://ziontechgroup.com/blog/micro-saas-ai-expense-tracker-2026-8507/', type: 'article' },
...
export default function Page() {
  return (
    <PageShell title="MicroSaaS Expense Tracker" description="Practical guide to microsaas expense tracker: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/micro-saas-ai-expense-tracker-2026-8507/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/micro-saas-ai-expense-tracker-2026-8507/'
    }}>
