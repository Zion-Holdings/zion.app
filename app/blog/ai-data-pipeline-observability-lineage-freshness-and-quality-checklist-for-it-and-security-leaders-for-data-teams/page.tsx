...
export const metadata = {
  ...
  openGraph: {
    title: 'AI Data Pipeline Observability: Lineage, Freshness, and Quality checklist for IT and security leaders for data teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/ai-data-pipeline-observability-lineage-freshness-and-quality-checklist-for-it-and-security-leaders-for-data-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-data-pipeline-observability-lineage-freshness-and-quality-checklist-for-it-and-security-leaders-for-data-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Data Pipeline Observability: Lineage, Freshness, and Quality checklist for IT and security leaders for data teams' }]} className="mb-8" />
