...
export const metadata = {
  title: 'Managed Socaas Pricing Model Small Business | Zion Tech Group',
  description: 'Managed Socaas Pricing Model Small Business: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
    title: 'Managed Socaas Pricing Model Small Business',
    description: 'Managed Socaas Pricing Model Small Business: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
    url: 'https://ziontechgroup.com/blog/managed-socaas-pricing-model-small-business',
    type: 'article',
  },
  alternates: {
    canonical: 'https://ziontechgroup.com/blog/managed-socaas-pricing-model-small-business',
  },
};
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'Managed Socaas Pricing Model Small Business' }
          ]}
          className="mb-8"
        />
        ...
        <header className="mb-12">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Managed Socaas Pricing Model Small Business</h1>
          <p className="mt-4 text-lg text-slate-300">Managed Socaas Pricing Model Small Business requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
