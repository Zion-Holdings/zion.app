...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Cloud Migration Services: checklist for IT leaders | Zion Tech Group" description="Cloud Migration Services: checklist for IT leaders" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/cloud-migration-services-checklist-for-it-leaders/" />
