...
export const metadata = {
  title: 'API Economy: starter template | Zion Tech Group',
  description: 'API Economy: starter template',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'API Economy: starter template',
    description: 'API Economy: starter template',
    url: 'https://ziontechgroup.com/blog/api-economy-starter-template/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/api-economy-starter-template/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "API Economy: starter template", "description": "API Economy: starter template", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:11:57Z", "dateModified": "2026-08-06T18:11:57Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/api-economy-starter-template/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'API Economy: starter template' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">API Economy: starter template</h1>
          <p className="mt-4 text-lg text-slate-300">API Economy: starter template</p>
