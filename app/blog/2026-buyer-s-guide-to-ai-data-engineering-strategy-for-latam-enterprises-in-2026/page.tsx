...
export const metadata = {
  ...
  openGraph: {
    title: '2026 buyer's guide to AI Data Engineering Strategy for LATAM Enterprises in 2026',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/2026-buyer-s-guide-to-ai-data-engineering-strategy-for-latam-enterprises-in-2026/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/2026-buyer-s-guide-to-ai-data-engineering-strategy-for-latam-enterprises-in-2026/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: '2026 buyer's guide to AI Data Engineering Strategy for LATAM Enterprises in 2026' }]} className="mb-8" />
