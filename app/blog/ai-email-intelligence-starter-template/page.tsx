...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI Email Intelligence: starter template | Zion Tech Group" description="AI Email Intelligence: starter template" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-email-intelligence-starter-template/" />
