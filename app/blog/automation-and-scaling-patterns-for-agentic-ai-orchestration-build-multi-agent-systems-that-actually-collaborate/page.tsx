...
export const metadata = {
  ...
  openGraph: {
    ...
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/automation-and-scaling-patterns-for-agentic-ai-orchestration-build-multi-agent-systems-that-actually-collaborate/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/automation-and-scaling-patterns-for-agentic-ai-orchestration-build-multi-agent-systems-that-actually-collaborate/' },
};
