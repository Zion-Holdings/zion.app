...
export const metadata = {
  ...
  openGraph: {
    title: 'APM Application Performance: architecture overview | Zion Tech Group',
    description: 'APM Application Performance: architecture overview.',
    url: 'https://ziontechgroup.comapp/blog/apm-application-performance-architecture-overview/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/apm-application-performance-architecture-overview/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'APM Application Performance: architecture overview',
  description: 'APM Application Performance: architecture overview.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/apm-application-performance-architecture-overview/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'APM Application Performance: architecture overview' },
      ]}
    >
