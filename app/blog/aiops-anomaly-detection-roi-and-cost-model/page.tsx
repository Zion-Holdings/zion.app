        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/data-warehouse-modernization-2026-3365">Data Warehouse Modernization 2026 3365</Link></li>
<li><Link href="/blog/ai-customer-success-churn-2026-2911">Ai Customer Success Churn 2026 2911</Link></li>
<li><Link href="/blog/ai-agent-tool-builder-checklist-for-it-leaders">Ai Agent Tool Builder Checklist For It Leaders</Link></li>
<li><Link href="/blog/autonomous-qa-engineering-2026-4246">Autonomous Qa Engineering 2026 4246</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
