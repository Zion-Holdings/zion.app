...
export const metadata = {
  ...
  openGraph: {
    title: 'AIOps Anomaly Detection: operations handbook | Zion Tech Group',
    description: 'AIOps Anomaly Detection: operations handbook.',
    url: 'https://ziontechgroup.comapp/blog/aiops-anomaly-detection-operations-handbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/aiops-anomaly-detection-operations-handbook/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'AIOps Anomaly Detection: operations handbook',
  description: 'AIOps Anomaly Detection: operations handbook.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/aiops-anomaly-detection-operations-handbook/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'AIOps Anomaly Detection: operations handbook' },
      ]}
    >
