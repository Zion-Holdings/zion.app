...
export const metadata = {
  title: 'Aiops Reduce Incident Resolution Time For Ceos | Zion Tech Group',
  description: 'Aiops Reduce Incident Resolution Time For Ceos: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
    title: 'Aiops Reduce Incident Resolution Time For Ceos',
    description: 'Aiops Reduce Incident Resolution Time For Ceos: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
    url: 'https://ziontechgroup.com/blog/aiops-reduce-incident-resolution-time-for-ceos',
    type: 'article',
  },
  alternates: {
    canonical: 'https://ziontechgroup.com/blog/aiops-reduce-incident-resolution-time-for-ceos',
  },
};
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'Aiops Reduce Incident Resolution Time For Ceos' }
          ]}
          className="mb-8"
        />
        ...
        <header className="mb-12">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Aiops Reduce Incident Resolution Time For Ceos</h1>
          <p className="mt-4 text-lg text-slate-300">Aiops Reduce Incident Resolution Time For Ceos requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
