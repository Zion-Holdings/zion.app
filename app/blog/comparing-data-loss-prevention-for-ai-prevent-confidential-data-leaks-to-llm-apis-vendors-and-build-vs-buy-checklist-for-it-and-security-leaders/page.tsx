...
export const metadata = {
  ...
  openGraph: {
    title: 'Comparing Data Loss Prevention for AI: Prevent Confidential Data Leaks to LLM APIs: vendors and build vs buy checklist for IT and security leaders',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/comparing-data-loss-prevention-for-ai-prevent-confidential-data-leaks-to-llm-apis-vendors-and-build-vs-buy-checklist-for-it-and-security-leaders/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/comparing-data-loss-prevention-for-ai-prevent-confidential-data-leaks-to-llm-apis-vendors-and-build-vs-buy-checklist-for-it-and-security-leaders/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Comparing Data Loss Prevention for AI: Prevent Confidential Data Leaks to LLM APIs: vendors and build vs buy checklist for IT and security leaders' }]} className="mb-8" />
