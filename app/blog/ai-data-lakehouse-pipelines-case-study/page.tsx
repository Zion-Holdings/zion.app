        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/it-consulting-2026-84">It Consulting 2026 84</Link></li>
<li><Link href="/blog/ai-agent-tool-builder-2026-3549">Ai Agent Tool Builder 2026 3549</Link></li>
<li><Link href="/blog/ai-ad-copy-generator-2026-2926">Ai Ad Copy Generator 2026 2926</Link></li>
