...
export const metadata = {
  title: 'Product Analytics: architecture overview | Zion Tech Group',
  description: 'Product Analytics: architecture overview',
  keywords: ['data', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Product Analytics: architecture overview',
    description: 'Product Analytics: architecture overview',
    url: 'https://ziontechgroup.com/blog/product-analytics-architecture-overview/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/product-analytics-architecture-overview/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Product Analytics: architecture overview", "description": "Product Analytics: architecture overview", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:09:59Z", "dateModified": "2026-08-06T18:09:59Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/product-analytics-architecture-overview/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Product Analytics: architecture overview' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Product Analytics: architecture overview</h1>
          <p className="mt-4 text-lg text-slate-300">Product Analytics: architecture overview</p>
