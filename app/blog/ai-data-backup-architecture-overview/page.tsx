        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/cloud-migration-services-2026-1328">Cloud Migration Services 2026 1328</Link></li>
...
<li><Link href="/blog/brand-voice-guardian-2026-1834">Brand Voice Guardian 2026 1834</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
