...
export const metadata = {
  title: 'AI Code Review Automation: operations handbook | Zion Tech Group',
  description: 'AI Code Review Automation: operations handbook',
  keywords: ['ai', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'AI Code Review Automation: operations handbook',
    description: 'AI Code Review Automation: operations handbook',
    url: 'https://ziontechgroup.com/blog/ai-code-review-automation-operations-handbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-code-review-automation-operations-handbook/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AI Code Review Automation: operations handbook", "description": "AI Code Review Automation: operations handbook", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:02:46Z", "dateModified": "2026-08-06T18:02:46Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ai-code-review-automation-operations-handbook/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Code Review Automation: operations handbook' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AI Code Review Automation: operations handbook</h1>
          <p className="mt-4 text-lg text-slate-300">AI Code Review Automation: operations handbook</p>
