...
export const metadata = {
  title: 'AI 3D Asset Generator: case study | Zion Tech Group',
  description: 'AI 3D Asset Generator: case study',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'AI 3D Asset Generator: case study',
    description: 'AI 3D Asset Generator: case study',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AI 3D Asset Generator: case study", "description": "AI 3D Asset Generator: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T15:08:46Z", "dateModified": "2026-08-04T15:08:46Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ai-3d-asset-generator-case-study/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI 3D Asset Generator: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AI 3D Asset Generator: case study</h1>
          <p className="mt-4 text-lg text-slate-300">AI 3D Asset Generator: case study</p>
