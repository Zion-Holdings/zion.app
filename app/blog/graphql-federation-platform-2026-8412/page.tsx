...
export const metadata = {
  ...
  alternates: { canonical: '/blog/graphql-federation-platform-2026-8412/' },
  openGraph: { title: 'GraphQL Federation Platform', description: 'Practical guide to graphql federation platform.', url: 'https://ziontechgroup.com/blog/graphql-federation-platform-2026-8412/', type: 'article' },
...
export default function Page() {
  return (
    <PageShell title="GraphQL Federation Platform" description="Practical guide to graphql federation platform: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/graphql-federation-platform-2026-8412/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/graphql-federation-platform-2026-8412/'
    }}>
