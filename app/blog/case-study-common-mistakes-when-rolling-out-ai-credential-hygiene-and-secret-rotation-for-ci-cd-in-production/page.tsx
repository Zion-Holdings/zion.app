...
export const metadata = {
  ...
  openGraph: {
    title: 'Case study: Common mistakes when rolling out AI Credential Hygiene and Secret Rotation for CI/CD in production',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/case-study-common-mistakes-when-rolling-out-ai-credential-hygiene-and-secret-rotation-for-ci-cd-in-production/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/case-study-common-mistakes-when-rolling-out-ai-credential-hygiene-and-secret-rotation-for-ci-cd-in-production/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Case study: Common mistakes when rolling out AI Credential Hygiene and Secret Rotation for CI/CD in production' }]} className="mb-8" />
