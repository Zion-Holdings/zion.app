...
export default function Page() {
  return (
    <PageShell title="AI API Gateway" description="Practical guide to ai api gateway: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/ai-api-gateway-2026-6620/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/ai-api-gateway-2026-6620/'
    }}>
