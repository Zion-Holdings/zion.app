...
export const metadata = {
  ...
  openGraph: {
    title: 'Passwordless Authentication Strategy: FIDO2, Passkeys, and SSO Integration: costs, ROI, and hidden risks checklist for IT and security leaders',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/passwordless-authentication-strategy-fido2-passkeys-and-sso-integration-costs-roi-and-hidden-risks-checklist-for-it-and-security-leaders/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/passwordless-authentication-strategy-fido2-passkeys-and-sso-integration-costs-roi-and-hidden-risks-checklist-for-it-and-security-leaders/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Passwordless Authentication Strategy: FIDO2, Passkeys, and SSO Integration: costs, ROI, and hidden risks checklist for IT and security leaders' }]} className="mb-8" />
