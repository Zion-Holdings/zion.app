...
export const metadata = {
  title: 'Low Code Platform: case study | Zion Tech Group',
  description: 'Low Code Platform: case study',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Low Code Platform: case study',
    description: 'Low Code Platform: case study',
    url: 'https://ziontechgroup.com/blog/low-code-platform-case-study/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/low-code-platform-case-study/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Low Code Platform: case study", "description": "Low Code Platform: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:03:12Z", "dateModified": "2026-08-06T18:03:12Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/low-code-platform-case-study/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Low Code Platform: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Low Code Platform: case study</h1>
          <p className="mt-4 text-lg text-slate-300">Low Code Platform: case study</p>
...
<li><Link /blog/autonomous-code-deployment-evaluation-framework/>Autonomous Code Deployment Evaluation Framework</Link></li>
