...
export const metadata = {
  ...
  openGraph: {
    title: 'Cloud Migration Services: common mistakes',
    description: 'Cloud Migration Services: common mistakes - AI and IT insights from Zion Tech Group.',
    url: 'https://ziontechgroup.com/blog/cloud-migration-services-2026/2026/2026/common-mistakes/',
    type: 'article',
  },
  alternates: { canonical: '/blog/cloud-migration-services-2026/2026/2026/common-mistakes/' },
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'Cloud Migration Services: common mistakes' },
      ]}
    >
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <header className="mb-10">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Cloud Migration Services: common mistakes | Zion Tech Group</h1>
