...
export const metadata = {
  title: 'Genai devops cicd checklist for it leaders | Zion Tech Group',
  description: 'Genai devops cicd checklist for it leaders',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Genai devops cicd checklist for it leaders',
    description: 'Genai devops cicd checklist for it leaders',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Genai devops cicd checklist for it leaders", "description": "Genai devops cicd checklist for it leaders", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T15:07:21Z", "dateModified": "2026-08-04T15:07:21Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/genai-devops-cicd-checklist-for-it-leaders/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Genai devops cicd checklist for it leaders' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Genai devops cicd checklist for it leaders</h1>
          <p className="mt-4 text-lg text-slate-300">Genai devops cicd checklist for it leaders</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/accessibility-compliance-2026-179">Accessibility Compliance 2026 179</Link></li>
<li><Link href="/blog/api-integration-roi-and-cost-model">Api Integration Roi And Cost Model</Link></li>
<li><Link href="/blog/managed-it-services-small-business-2026-142">Managed It Services Small Business 2026 142</Link></li>
