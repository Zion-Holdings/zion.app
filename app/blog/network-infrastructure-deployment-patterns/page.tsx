...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Network infrastructure deployment patterns", "description": "Network infrastructure deployment patterns", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T15:07:25Z", "dateModified": "2026-08-04T15:07:25Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/network-infrastructure-deployment-patterns/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Network infrastructure deployment patterns' }]} className="mb-8" />
        <header className="mb-10">
          ...
          <p className="mt-4 text-lg text-slate-300">Network infrastructure deployment patterns</p>
...
<li><Link href="/blog/it-consulting-2026-291">It Consulting 2026 291</Link></li>
