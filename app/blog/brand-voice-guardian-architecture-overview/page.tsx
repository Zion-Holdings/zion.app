...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Brand Voice Guardian: architecture overview | Zion Tech Group" description="Brand Voice Guardian: architecture overview" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/brand-voice-guardian-architecture-overview/" />
