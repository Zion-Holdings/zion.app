...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Brand Voice Guardian: architecture overview", "description": "Brand Voice Guardian: architecture overview", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:12:09Z", "dateModified": "2026-08-04T16:12:09Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/brand-voice-guardian-architecture-overview/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Brand Voice Guardian: architecture overview' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Brand Voice Guardian: architecture overview</h1>
          <p className="mt-4 text-lg text-slate-300">Brand Voice Guardian: architecture overview</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/ai-agent-safety-evaluation-2026-1961">Ai Agent Safety Evaluation 2026 1961</Link></li>
...
<li><Link href="/blog/ai-it-operations-automation-2026-1864">Ai It Operations Automation 2026 1864</Link></li>
<li><Link href="/blog/ai-accessibility-auditor-2026-3476">Ai Accessibility Auditor 2026 3476</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
