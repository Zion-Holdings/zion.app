...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="GenAI DevOps CI/CD: starter template | Zion Tech Group" description="GenAI DevOps CI/CD: starter template" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/genai-devops-cicd-starter-template/" />
