...
export const metadata = {
  ...
  openGraph: {
    title: 'Comparing RAG Optimization Playbook: Reduce Hallucination and Improve Retrieval Accuracy: vendors and build vs buy for ai teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/comparing-rag-optimization-playbook-reduce-hallucination-and-improve-retrieval-accuracy-vendors-and-build-vs-buy-for-ai-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/comparing-rag-optimization-playbook-reduce-hallucination-and-improve-retrieval-accuracy-vendors-and-build-vs-buy-for-ai-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Comparing RAG Optimization Playbook: Reduce Hallucination and Improve Retrieval Accuracy: vendors and build vs buy for ai teams' }]} className="mb-8" />
