        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/ai-performance-monitoring-2026-525">Ai Performance Monitoring 2026 525</Link></li>
<li><Link href="/blog/autonomous-qa-engineering-case-study">Autonomous Qa Engineering Case Study</Link></li>
<li><Link href="/blog/automated-ai-reporting-2026-380">Automated Ai Reporting 2026 380</Link></li>
