...
export const metadata = {
  ...
  openGraph: {
    title: 'API Security Testing: architecture overview | Zion Tech Group',
    description: 'API Security Testing: architecture overview.',
    url: 'https://ziontechgroup.comapp/blog/api-security-testing-architecture-overview/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/api-security-testing-architecture-overview/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'API Security Testing: architecture overview',
  description: 'API Security Testing: architecture overview.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/api-security-testing-architecture-overview/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'API Security Testing: architecture overview' },
      ]}
    >
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <section className="prose prose-invert max-w-none">
          ...
          <p className="text-slate-300 mb-6">API Security Testing: architecture overview. Organizations benefit from clearer requirements, tighter governance, and repeatable delivery models.</p>
