...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "API Security Testing: architecture overview", "description": "API Security Testing: architecture overview", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:12:21Z", "dateModified": "2026-08-04T16:12:21Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/api-security-testing-architecture-overview/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'API Security Testing: architecture overview' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">API Security Testing: architecture overview</h1>
          <p className="mt-4 text-lg text-slate-300">API Security Testing: architecture overview</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/micro-saas-ai-expense-tracker-2026-1952">Micro Saas Ai Expense Tracker 2026 1952</Link></li>
<li><Link href="/blog/ai-data-lakehouse-pipelines-2026-2841">Ai Data Lakehouse Pipelines 2026 2841</Link></li>
<li><Link href="/blog/accessibility-compliance-2026-2456">Accessibility Compliance 2026 2456</Link></li>
