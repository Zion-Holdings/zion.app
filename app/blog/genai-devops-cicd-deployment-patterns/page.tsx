...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="GenAI DevOps CI/CD: deployment patterns | Zion Tech Group" description="GenAI DevOps CI/CD: deployment patterns" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/genai-devops-cicd-deployment-patterns/" />
