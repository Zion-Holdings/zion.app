...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI BDR SDR: operations handbook | Zion Tech Group" description="AI BDR SDR: operations handbook" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-bdr-sdr-operations-handbook/" />
