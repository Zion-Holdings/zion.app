...
export default function Page() {
  return (
    <PageShell title="GraphQL Federation Platform" description="Practical guide to graphql federation platform: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/graphql-federation-platform-2026-7032/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/graphql-federation-platform-2026-7032/'
    }}>
