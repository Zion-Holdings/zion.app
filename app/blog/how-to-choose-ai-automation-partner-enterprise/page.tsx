...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "How to Choose the Right AI Automation Partner for Enterprise | Zion Tech Group",
    description: "Enterprise guide to choosing an AI automation partner: selection criteria, pricing benchmarks, red flags, and a practical evaluation framework for IT leaders in 2026.",
    url: "https://ziontechgroup.com/blog/how-to-choose-ai-automation-partner-enterprise/",
    type: 'website',
  },
  alternates: { canonical: "/blog/how-to-choose-ai-automation-partner-enterprise/" },
};

export default function BlogHowToChooseAiAutomationPartnerEnterprisePage() {
  return (
    <StandardPage
    ...
    >
      <p className="text-slate-300 text-lg leading-relaxed mb-8 max-w-5xl mx-auto">Enterprise guide to choosing an AI automation partner: selection criteria, pricing benchmarks, red flags, and a practical evaluation framework for IT leaders in 2026.</p>
