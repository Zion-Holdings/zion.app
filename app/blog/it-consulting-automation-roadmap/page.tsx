...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="IT Consulting: automation roadmap | Zion Tech Group" description="IT Consulting: automation roadmap" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/it-consulting-automation-roadmap/" />
