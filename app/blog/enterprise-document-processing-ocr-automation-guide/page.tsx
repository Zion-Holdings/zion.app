...
export const metadata = {
  ...
  description: 'Enterprise Document Processing Ocr Automation Guide: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
    title: 'Enterprise Document Processing Ocr Automation Guide',
    description: 'Enterprise Document Processing Ocr Automation Guide: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
    url: 'https://ziontechgroup.com/blog/enterprise-document-processing-ocr-automation-guide',
    type: 'article',
  },
  alternates: {
    canonical: 'https://ziontechgroup.com/blog/enterprise-document-processing-ocr-automation-guide',
  },
};
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'Enterprise Document Processing Ocr Automation Guide' }
          ]}
          className="mb-8"
        />
        ...
        <header className="mb-12">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Enterprise Document Processing Ocr Automation Guide</h1>
          <p className="mt-4 text-lg text-slate-300">Enterprise Document Processing Ocr Automation Guide requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
