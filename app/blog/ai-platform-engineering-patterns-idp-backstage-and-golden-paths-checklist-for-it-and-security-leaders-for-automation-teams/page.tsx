...
export const metadata = {
  ...
  openGraph: {
    title: 'AI Platform Engineering Patterns: IDP, Backstage, and Golden Paths checklist for IT and security leaders for automation teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/ai-platform-engineering-patterns-idp-backstage-and-golden-paths-checklist-for-it-and-security-leaders-for-automation-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-platform-engineering-patterns-idp-backstage-and-golden-paths-checklist-for-it-and-security-leaders-for-automation-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Platform Engineering Patterns: IDP, Backstage, and Golden Paths checklist for IT and security leaders for automation teams' }]} className="mb-8" />
