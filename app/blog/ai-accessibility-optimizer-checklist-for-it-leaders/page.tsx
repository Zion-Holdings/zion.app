...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AI Accessibility Optimizer: checklist for IT leaders", "description": "AI Accessibility Optimizer: checklist for IT leaders", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:27:21Z", "dateModified": "2026-08-04T16:27:21Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ai-accessibility-optimizer-checklist-for-it-leaders/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Accessibility Optimizer: checklist for IT leaders' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AI Accessibility Optimizer: checklist for IT leaders</h1>
          <p className="mt-4 text-lg text-slate-300">AI Accessibility Optimizer: checklist for IT leaders</p>
...
<li><Link href="/blog/cloud-cost-ai-optimizer-2026-1911">Cloud Cost Ai Optimizer 2026 1911</Link></li>
