...
export const metadata = {
  ...
  description: 'AI IT Operations: operations handbook - AI and IT insights from Zion Tech Group.',
  openGraph: {
    title: 'AI IT Operations: operations handbook',
    description: 'AI IT Operations: operations handbook - AI and IT insights from Zion Tech Group.',
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'AI IT Operations: operations handbook' },
      ]}
    >
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <header className="mb-10">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AI IT Operations: operations handbook | Zion Tech Group</h1>
