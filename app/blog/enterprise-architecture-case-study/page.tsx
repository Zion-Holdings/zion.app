...
export const metadata = {
  title: 'Enterprise Architecture: case study | Zion Tech Group',
  description: 'Enterprise Architecture: case study',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Enterprise Architecture: case study',
    description: 'Enterprise Architecture: case study',
    url: 'https://ziontechgroup.com/blog/enterprise-architecture-case-study/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/enterprise-architecture-case-study/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Enterprise Architecture: case study", "description": "Enterprise Architecture: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:43:00Z", "dateModified": "2026-08-06T18:43:00Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/enterprise-architecture-case-study/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Enterprise Architecture: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Enterprise Architecture: case study</h1>
          <p className="mt-4 text-lg text-slate-300">Enterprise Architecture: case study</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link /blog/penetration-testing-security-and-governance/>Penetration Testing Security And Governance</Link></li>
