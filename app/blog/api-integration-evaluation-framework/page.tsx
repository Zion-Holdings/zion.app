    ...
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <section className="prose prose-invert max-w-none">
            ...
            <h2 className="text-xl font-bold text-violet-400 mb-3">Recommended approach</h2>
            ...
            <h2 className="text-xl font-bold text-violet-400 mb-3">Common pitfalls</h2>
            ...
            <h2 className="text-xl font-bold text-violet-400 mb-3">Next actions</h2>
