...
<h2 className="mt-6 text-2xl font-bold text-white">Why this matters now</h2>
...
<h2 className="mt-6 text-2xl font-bold text-white">Executive summary</h2>
...
<h2 className="mt-6 text-2xl font-bold text-white">Recommended approach</h2>
...
<h2 className="mt-6 text-2xl font-bold text-white">Common pitfalls</h2>
...
<h2 className="mt-6 text-2xl font-bold text-white">Next actions</h2>
