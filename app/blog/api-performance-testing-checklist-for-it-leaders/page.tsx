...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="API Performance Testing: checklist for IT leaders | Zion Tech Group" description="API Performance Testing: checklist for IT leaders" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/api-performance-testing-checklist-for-it-leaders/" />
