...
export const metadata = {
  title: 'Data Catalog: automation roadmap | Zion Tech Group',
  description: 'Data Catalog: automation roadmap',
  keywords: ['data', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Data Catalog: automation roadmap',
    description: 'Data Catalog: automation roadmap',
    url: 'https://ziontechgroup.com/blog/data-catalog-automation-roadmap/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/data-catalog-automation-roadmap/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Data Catalog: automation roadmap", "description": "Data Catalog: automation roadmap", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:03:48Z", "dateModified": "2026-08-06T18:03:48Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/data-catalog-automation-roadmap/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Data Catalog: automation roadmap' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Data Catalog: automation roadmap</h1>
          <p className="mt-4 text-lg text-slate-300">Data Catalog: automation roadmap</p>
...
<li><Link href="/blog/network-security-evaluation-framework">Network Security Evaluation Framework</Link></li>
