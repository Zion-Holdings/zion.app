...
export const metadata = {
  title: 'AI Process Mining: operations handbook | Zion Tech Group',
  description: 'AI Process Mining: operations handbook',
  keywords: ['ai', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'AI Process Mining: operations handbook',
    description: 'AI Process Mining: operations handbook',
    url: 'https://ziontechgroup.com/blog/ai-process-mining-operations-handbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-process-mining-operations-handbook/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AI Process Mining: operations handbook", "description": "AI Process Mining: operations handbook", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T19:00:03Z", "dateModified": "2026-08-06T19:00:03Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ai-process-mining-operations-handbook/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Process Mining: operations handbook' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AI Process Mining: operations handbook</h1>
          <p className="mt-4 text-lg text-slate-300">AI Process Mining: operations handbook</p>
