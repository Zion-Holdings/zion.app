...
export const metadata = {
  ...
  openGraph: {
    title: 'Automation and scaling patterns for Container Security at Scale: Image Scanning, Runtime Protection, and Policy Enforcement for cloud teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/automation-and-scaling-patterns-for-container-security-at-scale-image-scanning-runtime-protection-and-policy-enforcement-for-cloud-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/automation-and-scaling-patterns-for-container-security-at-scale-image-scanning-runtime-protection-and-policy-enforcement-for-cloud-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Automation and scaling patterns for Container Security at Scale: Image Scanning, Runtime Protection, and Policy Enforcement for cloud teams' }]} className="mb-8" />
