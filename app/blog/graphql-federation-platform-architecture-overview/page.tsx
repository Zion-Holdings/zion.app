...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="GraphQL Federation Platform: architecture overview | Zion Tech Group" description="GraphQL Federation Platform: architecture overview" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/graphql-federation-platform-architecture-overview/" />
