        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/ai-customer-support-pro-2026-2355">Ai Customer Support Pro 2026 2355</Link></li>
<li><Link href="/blog/devsecops-pipeline-implementation-playbook">Devsecops Pipeline Implementation Playbook</Link></li>
<li><Link href="/blog/devsecops-pipeline-2026-470">Devsecops Pipeline 2026 470</Link></li>
<li><Link href="/blog/accessibility-compliance-2026-3077">Accessibility Compliance 2026 3077</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
