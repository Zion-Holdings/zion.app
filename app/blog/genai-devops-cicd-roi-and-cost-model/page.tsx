...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="GenAI DevOps CI/CD: ROI and cost model | Zion Tech Group" description="GenAI DevOps CI/CD: ROI and cost model" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/genai-devops-cicd-roi-and-cost-model/" />
