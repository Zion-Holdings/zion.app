...
export const metadata = {
  title: 'Threat Hunting: operations handbook | Zion Tech Group',
  description: 'Threat Hunting: operations handbook',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Threat Hunting: operations handbook',
    description: 'Threat Hunting: operations handbook',
    url: 'https://ziontechgroup.com/blog/threat-hunting-operations-handbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/threat-hunting-operations-handbook/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Threat Hunting: operations handbook", "description": "Threat Hunting: operations handbook", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:12:02Z", "dateModified": "2026-08-06T18:12:02Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/threat-hunting-operations-handbook/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Threat Hunting: operations handbook' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Threat Hunting: operations handbook</h1>
          <p className="mt-4 text-lg text-slate-300">Threat Hunting: operations handbook</p>
