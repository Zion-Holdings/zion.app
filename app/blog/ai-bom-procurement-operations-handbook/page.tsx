...
export const metadata = {
  ...
  openGraph: {
    title: 'AI BOM Procurement: operations handbook | Zion Tech Group',
    description: 'AI BOM Procurement: operations handbook.',
    url: 'https://ziontechgroup.comapp/blog/ai-bom-procurement-operations-handbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/ai-bom-procurement-operations-handbook/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'AI BOM Procurement: operations handbook',
  description: 'AI BOM Procurement: operations handbook.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/ai-bom-procurement-operations-handbook/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'AI BOM Procurement: operations handbook' },
      ]}
    >
