...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="DevSecOps Pipeline: ROI and cost model | Zion Tech Group" description="DevSecOps Pipeline: ROI and cost model" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/devsecops-pipeline-roi-and-cost-model/" />
