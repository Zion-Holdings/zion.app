...
export const metadata = {
  ...
  alternates: { canonical: '/blog/micro-saas-ai-customer-onboarding-2026-6784/' },
  openGraph: { title: 'MicroSaaS Customer Onboarding', description: 'Practical guide to microsaas customer onboarding.', url: 'https://ziontechgroup.com/blog/micro-saas-ai-customer-onboarding-2026-6784/', type: 'article' },
...
export default function Page() {
  return (
    <PageShell title="MicroSaaS Customer Onboarding" description="Practical guide to microsaas customer onboarding: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/micro-saas-ai-customer-onboarding-2026-6784/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/micro-saas-ai-customer-onboarding-2026-6784/'
    }}>
