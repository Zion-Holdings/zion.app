...
export const metadata = {
  ...
  openGraph: {
    title: 'Case study: Comparing Customer Service Chatbot Beyond FAQs: Integrate RAG for Context-Aware Support: vendors and build vs buy in production',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/case-study-comparing-customer-service-chatbot-beyond-faqs-integrate-rag-for-context-aware-support-vendors-and-build-vs-buy-in-production/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/case-study-comparing-customer-service-chatbot-beyond-faqs-integrate-rag-for-context-aware-support-vendors-and-build-vs-buy-in-production/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Case study: Comparing Customer Service Chatbot Beyond FAQs: Integrate RAG for Context-Aware Support: vendors and build vs buy in production' }]} className="mb-8" />
