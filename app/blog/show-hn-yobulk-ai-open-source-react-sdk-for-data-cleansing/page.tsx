...
export const metadata = {
  title: 'Show HN: YoBulk AI – Open Source React SDK for data cleansing | Zion Tech Group',
  description: 'Show HN: YoBulk AI – Open Source React SDK for data cleansing',
  keywords: ['ai', 'solution', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Show HN: YoBulk AI – Open Source React SDK for data cleansing',
    description: 'Show HN: YoBulk AI – Open Source React SDK for data cleansing',
    url: 'https://ziontechgroup.com/blog/show-hn-yobulk-ai-open-source-react-sdk-for-data-cleansing/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'https://ziontechgroup.com/blog/show-hn-yobulk-ai-open-source-react-sdk-for-data-cleansing/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Show HN: YoBulk AI – Open Source React SDK for data cleansing", "description": "Show HN: YoBulk AI – Open Source React SDK for data cleansing", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-03T20:48:28Z", "dateModified": "2026-08-03T20:48:28Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/show-hn-yobulk-ai-open-source-react-sdk-for-data-cleansing/", "wordCount": 2193};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Show HN: YoBulk AI – Open Source React SDK for data cleansing' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Show HN: YoBulk AI – Open Source React SDK for data cleansing</h1>
          <p className="mt-4 text-lg text-slate-300">Show HN: YoBulk AI – Open Source React SDK for data cleansing</p>
