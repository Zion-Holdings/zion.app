...
export const metadata = {
  ...
  description: 'GraphQL Federation Platform: implementation playbook - AI and IT insights from Zion Tech Group.',
  openGraph: {
    title: 'GraphQL Federation Platform: implementation playbook',
    description: 'GraphQL Federation Platform: implementation playbook - AI and IT insights from Zion Tech Group.',
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'GraphQL Federation Platform: implementation playbook' },
      ]}
    >
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <header className="mb-10">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">GraphQL Federation Platform: implementation playbook | Zion Tech Group</h1>
