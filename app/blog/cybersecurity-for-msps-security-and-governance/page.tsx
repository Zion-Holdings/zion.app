...
<li><Link href="/blog/hermes-agent-platform">Hermes Agent Platform</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
