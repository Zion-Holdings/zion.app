...
export const metadata = {
  ...
  openGraph: {
    ...
    description: 'Cybersecurity for MSPs: security and governance',
    url: 'https://ziontechgroup.com/blog/cybersecurity-for-msps-security-and-governance/',
    type: 'article',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Cybersecurity for MSPs: security and governance", "description": "Cybersecurity for MSPs: security and governance", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:11:41Z", "dateModified": "2026-08-04T16:11:41Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/cybersecurity-for-msps-security-and-governance/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Cybersecurity for MSPs: security and governance' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Cybersecurity for MSPs: security and governance</h1>
          <p className="mt-4 text-lg text-slate-300">Cybersecurity for MSPs: security and governance</p>
