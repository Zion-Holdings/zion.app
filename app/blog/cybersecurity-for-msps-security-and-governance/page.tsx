...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Cybersecurity for MSPs: security and governance | Zion Tech Group" description="Cybersecurity for MSPs: security and governance" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/cybersecurity-for-msps-security-and-governance/" />
