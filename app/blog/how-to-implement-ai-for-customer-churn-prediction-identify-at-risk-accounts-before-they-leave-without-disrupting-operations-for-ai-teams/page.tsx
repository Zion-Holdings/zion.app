...
export const metadata = {
  ...
  openGraph: {
    title: 'How to implement AI for Customer Churn Prediction: Identify At-Risk Accounts Before They Leave without disrupting operations for ai teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/how-to-implement-ai-for-customer-churn-prediction-identify-at-risk-accounts-before-they-leave-without-disrupting-operations-for-ai-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/how-to-implement-ai-for-customer-churn-prediction-identify-at-risk-accounts-before-they-leave-without-disrupting-operations-for-ai-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'How to implement AI for Customer Churn Prediction: Identify At-Risk Accounts Before They Leave without disrupting operations for ai teams' }]} className="mb-8" />
