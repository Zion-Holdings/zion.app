...
export const metadata = {
  ...
  openGraph: {
    title: 'MicroSaaS Social Media Manager: policy and compliance | Zion Tech Group',
    description: 'MicroSaaS Social Media Manager: policy and compliance.',
    url: 'https://ziontechgroup.comapp/blog/microsaas-social-media-manager-policy-and-compliance/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/microsaas-social-media-manager-policy-and-compliance/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'MicroSaaS Social Media Manager: policy and compliance',
  description: 'MicroSaaS Social Media Manager: policy and compliance.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/microsaas-social-media-manager-policy-and-compliance/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'MicroSaaS Social Media Manager: policy and compliance' },
      ]}
    >
