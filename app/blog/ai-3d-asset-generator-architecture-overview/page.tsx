    ...
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <header className="mb-10">
          ...
          <p className="mt-4 text-lg text-slate-300">AI 3D Asset Generator: architecture overview</p>
...
<li><Link href="/blog/ai-email-intelligence-2026-2422">Ai Email Intelligence 2026 2422</Link></li>
<li><Link href="/blog/api-performance-testing-2026-1999">Api Performance Testing 2026 1999</Link></li>
