...
export const metadata = {
  ...
  openGraph: {
    title: '2026 buyer's guide to Sustainable IT and Green Cloud: Measure and Reduce Carbon Footprint of Infrastructure checklist for IT and security leaders',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/2026-buyer-s-guide-to-sustainable-it-and-green-cloud-measure-and-reduce-carbon-footprint-of-infrastructure-checklist-for-it-and-security-leaders/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/2026-buyer-s-guide-to-sustainable-it-and-green-cloud-measure-and-reduce-carbon-footprint-of-infrastructure-checklist-for-it-and-security-leaders/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: '2026 buyer's guide to Sustainable IT and Green Cloud: Measure and Reduce Carbon Footprint of Infrastructure checklist for IT and security leaders' }]} className="mb-8" />
