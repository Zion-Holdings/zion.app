...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Automation Orchestration: architecture overview", "description": "Automation Orchestration: architecture overview", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:27:19Z", "dateModified": "2026-08-04T16:27:19Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/automation-orchestration-architecture-overview/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Automation Orchestration: architecture overview' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Automation Orchestration: architecture overview</h1>
          <p className="mt-4 text-lg text-slate-300">Automation Orchestration: architecture overview</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/micro-saas-ai-social-media-manager-2026-1748">Micro Saas Ai Social Media Manager 2026 1748</Link></li>
<li><Link href="/blog/ai-agent-tool-builder-2026-4032">Ai Agent Tool Builder 2026 4032</Link></li>
<li><Link href="/blog/ai-agent-tool-builder-implementation-playbook">Ai Agent Tool Builder Implementation Playbook</Link></li>
<li><Link href="/blog/ai-bom-procurement-2026-3489">Ai Bom Procurement 2026 3489</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
