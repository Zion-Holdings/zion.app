...
export const metadata = {
  ...
  openGraph: {
    title: 'Automated Provisioning and Deprovisioning: Identity and Access Lifecycle Automation: 2026 Playbook: costs, ROI, and hidden risks',
    description: 'Joiner/mover/leaver playbooks with audit trails',
    url: 'https://ziontechgroup.com/blog/automated-provisioning-and-deprovisioning-identity-and-access-lifecycle-automation-2026-playbook-costs-roi-and-hidden-risks/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/automated-provisioning-and-deprovisioning-identity-and-access-lifecycle-automation-2026-playbook-costs-roi-and-hidden-risks/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Automated Provisioning and Deprovisioning: Identity and Access Lifecycle Automation: 2026 Playbook: costs, ROI, and hidden risks' }]} className="mb-8" />
