        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/cloud-finops-2026-4120">Cloud Finops 2026 4120</Link></li>
<li><Link href="/blog/ai-bdr-sdr-2026-4109">Ai Bdr Sdr 2026 4109</Link></li>
<li><Link href="/blog/ai-autonomous-agents-2026-3344">Ai Autonomous Agents 2026 3344</Link></li>
<li><Link href="/blog/chaos-engineering-2026-1772">Chaos Engineering 2026 1772</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
