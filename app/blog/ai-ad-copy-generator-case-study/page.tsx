...
export const metadata = {
  ...
  openGraph: {
    ...
    description: 'AI Ad Copy Generator: case study',
    url: 'https://ziontechgroup.com/blog/ai-ad-copy-generator-case-study/',
    type: 'article',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AI Ad Copy Generator: case study", "description": "AI Ad Copy Generator: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:24:39Z", "dateModified": "2026-08-04T16:24:39Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ai-ad-copy-generator-case-study/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Ad Copy Generator: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AI Ad Copy Generator: case study</h1>
          <p className="mt-4 text-lg text-slate-300">AI Ad Copy Generator: case study</p>
...
<li><Link href="/blog/api-security-testing-2026-2207">Api Security Testing 2026 2207</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
