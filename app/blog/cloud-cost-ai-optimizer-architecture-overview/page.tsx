        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/container-security-lifecycle-2026-1914">Container Security Lifecycle 2026 1914</Link></li>
<li><Link href="/blog/ai-agent-safety-evaluation-2026-581">Ai Agent Safety Evaluation 2026 581</Link></li>
<li><Link href="/blog/ai-bdr-sdr-2026-3833">Ai Bdr Sdr 2026 3833</Link></li>
<li><Link href="/blog/enterprise-backup-dr-2026-3923">Enterprise Backup Dr 2026 3923</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
