...
export const metadata = {
  ...
  openGraph: {
    title: 'Cloud Cost AI Optimizer: architecture overview | Zion Tech Group',
    description: 'Cloud Cost AI Optimizer: architecture overview.',
    url: 'https://ziontechgroup.comapp/blog/cloud-cost-ai-optimizer-architecture-overview/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/cloud-cost-ai-optimizer-architecture-overview/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'Cloud Cost AI Optimizer: architecture overview',
  description: 'Cloud Cost AI Optimizer: architecture overview.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/cloud-cost-ai-optimizer-architecture-overview/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'Cloud Cost AI Optimizer: architecture overview' },
      ]}
    >
