...
export const metadata = {
  ...
  description: 'AI Code Review Automation: Enforce Standards and Find Vulnerabilities Before Merge: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/blog/ai-code-review-automation-enforce-standards-find-vulnerabilities-before-merge',
  },
};
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'AI Code Review Automation: Enforce Standards and Find Vulnerabilities Before Merge' }
          ]}
          className="mb-8"
        />
        ...
        <header className="mb-12">
          ...
          <p className="mt-4 text-lg text-slate-300">AI Code Review Automation: Enforce Standards and Find Vulnerabilities Before Merge requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
