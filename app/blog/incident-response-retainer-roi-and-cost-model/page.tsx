...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Incident Response Retainer: ROI and cost model | Zion Tech Group" description="Incident Response Retainer: ROI and cost model" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/incident-response-retainer-roi-and-cost-model/" />
