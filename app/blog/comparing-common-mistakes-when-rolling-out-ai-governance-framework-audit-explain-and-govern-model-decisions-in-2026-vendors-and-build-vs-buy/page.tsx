...
export const metadata = {
  ...
  openGraph: {
    title: 'Comparing Common mistakes when rolling out AI Governance Framework: Audit, Explain, and Govern Model Decisions in 2026: vendors and build vs buy',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/comparing-common-mistakes-when-rolling-out-ai-governance-framework-audit-explain-and-govern-model-decisions-in-2026-vendors-and-build-vs-buy/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/comparing-common-mistakes-when-rolling-out-ai-governance-framework-audit-explain-and-govern-model-decisions-in-2026-vendors-and-build-vs-buy/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Comparing Common mistakes when rolling out AI Governance Framework: Audit, Explain, and Govern Model Decisions in 2026: vendors and build vs buy' }]} className="mb-8" />
