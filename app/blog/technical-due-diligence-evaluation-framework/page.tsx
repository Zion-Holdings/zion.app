...
export const metadata = {
  title: 'Technical Due Diligence: evaluation framework | Zion Tech Group',
  description: 'Technical Due Diligence: evaluation framework',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Technical Due Diligence: evaluation framework',
    description: 'Technical Due Diligence: evaluation framework',
    url: 'https://ziontechgroup.com/blog/technical-due-diligence-evaluation-framework/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/technical-due-diligence-evaluation-framework/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Technical Due Diligence: evaluation framework", "description": "Technical Due Diligence: evaluation framework", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:43:16Z", "dateModified": "2026-08-06T18:43:16Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/technical-due-diligence-evaluation-framework/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Technical Due Diligence: evaluation framework' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Technical Due Diligence: evaluation framework</h1>
          <p className="mt-4 text-lg text-slate-300">Technical Due Diligence: evaluation framework</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link /blog/information-security-vendor-evaluation/>Information Security Vendor Evaluation</Link></li>
...
<li><Link /blog/remote-work-security-vendor-evaluation/>Remote Work Security Vendor Evaluation</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
