...
export const metadata = {
  title: 'No Code Platform: starter template | Zion Tech Group',
  description: 'No Code Platform: starter template',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'No Code Platform: starter template',
    description: 'No Code Platform: starter template',
    url: 'https://ziontechgroup.com/blog/no-code-platform-starter-template/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/no-code-platform-starter-template/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "No Code Platform: starter template", "description": "No Code Platform: starter template", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:28:06Z", "dateModified": "2026-08-06T18:28:06Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/no-code-platform-starter-template/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'No Code Platform: starter template' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">No Code Platform: starter template</h1>
          <p className="mt-4 text-lg text-slate-300">No Code Platform: starter template</p>
