...
export const metadata = {
  title: 'Microservices Architecture: security and governance | Zion Tech Group',
  description: 'Microservices Architecture: security and governance',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Microservices Architecture: security and governance',
    description: 'Microservices Architecture: security and governance',
    url: 'https://ziontechgroup.com/blog/microservices-architecture-security-and-governance/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/microservices-architecture-security-and-governance/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Microservices Architecture: security and governance", "description": "Microservices Architecture: security and governance", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:10:43Z", "dateModified": "2026-08-06T18:10:43Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/microservices-architecture-security-and-governance/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Microservices Architecture: security and governance' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Microservices Architecture: security and governance</h1>
          <p className="mt-4 text-lg text-slate-300">Microservices Architecture: security and governance</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/service-mesh-2026">Service Mesh 2026</Link></li>
