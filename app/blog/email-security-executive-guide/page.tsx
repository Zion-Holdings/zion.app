...
export const metadata = {
  title: 'Email Security: executive guide | Zion Tech Group',
  description: 'Email Security: executive guide',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Email Security: executive guide',
    description: 'Email Security: executive guide',
    url: 'https://ziontechgroup.com/blog/email-security-executive-guide/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/email-security-executive-guide/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Email Security: executive guide", "description": "Email Security: executive guide", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:11:53Z", "dateModified": "2026-08-06T18:11:53Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/email-security-executive-guide/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Email Security: executive guide' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Email Security: executive guide</h1>
          <p className="mt-4 text-lg text-slate-300">Email Security: executive guide</p>
