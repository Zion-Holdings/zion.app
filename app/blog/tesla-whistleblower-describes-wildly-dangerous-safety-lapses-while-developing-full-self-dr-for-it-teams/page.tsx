...
export const metadata = {
  ...
  openGraph: {
    title: 'Tesla Whistleblower Describes Wildly Dangerous Safety Lapses While Developing Full Self-Dr for it teams',
    description: 'Live web-researched high-intent buyer topic',
    url: 'https://ziontechgroup.com/blog/tesla-whistleblower-describes-wildly-dangerous-safety-lapses-while-developing-full-self-dr-for-it-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/tesla-whistleblower-describes-wildly-dangerous-safety-lapses-while-developing-full-self-dr-for-it-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Tesla Whistleblower Describes Wildly Dangerous Safety Lapses While Developing Full Self-Dr for it teams' }]} className="mb-8" />
