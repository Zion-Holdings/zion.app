...
export const metadata = {
  ...
  openGraph: {
    title: 'Cybersecurity for MSPs: evaluation framework',
    description: 'Cybersecurity for MSPs: evaluation framework',
    url: 'https://ziontechgroup.com/blog/cybersecurity-for-msps-evaluation-framework/',
    type: 'article',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Cybersecurity for MSPs: evaluation framework", "description": "Cybersecurity for MSPs: evaluation framework", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:28:58Z", "dateModified": "2026-08-04T16:28:58Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/cybersecurity-for-msps-evaluation-framework/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Cybersecurity for MSPs: evaluation framework' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Cybersecurity for MSPs: evaluation framework</h1>
          <p className="mt-4 text-lg text-slate-300">Cybersecurity for MSPs: evaluation framework</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/smart-contract-audit-2026-3857">Smart Contract Audit 2026 3857</Link></li>
<li><Link href="/blog/devsecops-pipeline-2026-2333">Devsecops Pipeline 2026 2333</Link></li>
<li><Link href="/blog/api-management-gateway-2026-1494">Api Management Gateway 2026 1494</Link></li>
<li><Link href="/blog/devsecops-pipeline-2026-3506">Devsecops Pipeline 2026 3506</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
