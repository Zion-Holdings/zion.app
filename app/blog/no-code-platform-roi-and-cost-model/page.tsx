...
export const metadata = {
  title: 'No Code Platform: ROI and cost model | Zion Tech Group',
  description: 'No Code Platform: ROI and cost model',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'No Code Platform: ROI and cost model',
    description: 'No Code Platform: ROI and cost model',
    url: 'https://ziontechgroup.com/blog/no-code-platform-roi-and-cost-model/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/no-code-platform-roi-and-cost-model/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "No Code Platform: ROI and cost model", "description": "No Code Platform: ROI and cost model", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:11:07Z", "dateModified": "2026-08-06T18:11:07Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/no-code-platform-roi-and-cost-model/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'No Code Platform: ROI and cost model' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">No Code Platform: ROI and cost model</h1>
          <p className="mt-4 text-lg text-slate-300">No Code Platform: ROI and cost model</p>
...
<li><Link href="/blog/compliance-automation-common-mistakes">Compliance Automation Common Mistakes</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
