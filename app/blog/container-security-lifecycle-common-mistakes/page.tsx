...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Container Security Lifecycle: common mistakes", "description": "Container Security Lifecycle: common mistakes", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:26:04Z", "dateModified": "2026-08-04T16:26:04Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/container-security-lifecycle-common-mistakes/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Container Security Lifecycle: common mistakes' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Container Security Lifecycle: common mistakes</h1>
          <p className="mt-4 text-lg text-slate-300">Container Security Lifecycle: common mistakes</p>
...
<li><Link href="/blog/ai-observability-2026-3391">Ai Observability 2026 3391</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
