...
export const metadata = {
  ...
  openGraph: {
    title: 'Container Security Lifecycle: common mistakes | Zion Tech Group',
    description: 'Container Security Lifecycle: common mistakes.',
    url: 'https://ziontechgroup.comapp/blog/container-security-lifecycle-common-mistakes/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/container-security-lifecycle-common-mistakes/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'Container Security Lifecycle: common mistakes',
  description: 'Container Security Lifecycle: common mistakes.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/container-security-lifecycle-common-mistakes/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'Container Security Lifecycle: common mistakes' },
      ]}
    >
