...
export const metadata = {
  ...
  alternates: { canonical: '/blog/autonomous-code-deployment-2026-7833/' },
  openGraph: { title: 'Autonomous Code Deployment', description: 'Practical guide to autonomous code deployment.', url: 'https://ziontechgroup.com/blog/autonomous-code-deployment-2026-7833/', type: 'article' },
...
export default function Page() {
  return (
    <PageShell title="Autonomous Code Deployment" description="Practical guide to autonomous code deployment: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/autonomous-code-deployment-2026-7833/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/autonomous-code-deployment-2026-7833/'
    }}>
