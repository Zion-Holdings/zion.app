...
export const metadata = {
  ...
  openGraph: {
    title: 'Network Infrastructure: common mistakes | Zion Tech Group',
    description: 'Network Infrastructure: common mistakes.',
    url: 'https://ziontechgroup.comapp/blog/network-infrastructure-common-mistakes/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/network-infrastructure-common-mistakes/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'Network Infrastructure: common mistakes',
  description: 'Network Infrastructure: common mistakes.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/network-infrastructure-common-mistakes/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'Network Infrastructure: common mistakes' },
      ]}
    >
