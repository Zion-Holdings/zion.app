...
export const metadata = {
  title: 'Case study: AI IoT platform in production | Zion Tech Group',
  description: 'Case study: AI IoT platform in production',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Case study: AI IoT platform in production',
    description: 'Case study: AI IoT platform in production',
    url: 'https://ziontechgroup.com/blog/ai-iot-platform-6/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-iot-platform-6/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Case study: AI IoT platform in production", "description": "Case study: AI IoT platform in production", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T12:59:17Z", "dateModified": "2026-08-04T12:59:17Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ai-iot-platform-6/", "wordCount": 2036};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Case study: AI IoT platform in production' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Case study: AI IoT platform in production</h1>
          <p className="mt-4 text-lg text-slate-300">Case study: AI IoT platform in production</p>
