...
export const metadata = {
  ...
  openGraph: {
    title: 'How to implement FinOps Maturity Model: From Cloud Cost Visibility to Automated Optimization without disrupting operations: costs, ROI, and hidden risks',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/how-to-implement-finops-maturity-model-from-cloud-cost-visibility-to-automated-optimization-without-disrupting-operations-costs-roi-and-hidden-risks/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/how-to-implement-finops-maturity-model-from-cloud-cost-visibility-to-automated-optimization-without-disrupting-operations-costs-roi-and-hidden-risks/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'How to implement FinOps Maturity Model: From Cloud Cost Visibility to Automated Optimization without disrupting operations: costs, ROI, and hidden risks' }]} className="mb-8" />
