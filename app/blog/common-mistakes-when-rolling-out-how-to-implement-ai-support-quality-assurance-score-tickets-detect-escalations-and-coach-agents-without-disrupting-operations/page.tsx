...
export const metadata = {
  ...
  openGraph: {
    title: 'Common mistakes when rolling out How to implement AI Support Quality Assurance: Score Tickets, Detect Escalations, and Coach Agents without disrupting operations',
    description: 'Quality scoring and coaching without full QA staffing',
    url: 'https://ziontechgroup.com/blog/common-mistakes-when-rolling-out-how-to-implement-ai-support-quality-assurance-score-tickets-detect-escalations-and-coach-agents-without-disrupting-operations/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/common-mistakes-when-rolling-out-how-to-implement-ai-support-quality-assurance-score-tickets-detect-escalations-and-coach-agents-without-disrupting-operations/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Common mistakes when rolling out How to implement AI Support Quality Assurance: Score Tickets, Detect Escalations, and Coach Agents without disrupting operations' }]} className="mb-8" />
