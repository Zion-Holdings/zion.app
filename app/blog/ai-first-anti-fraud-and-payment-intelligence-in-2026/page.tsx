    ...
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        ...
        <div className="glass-card prose prose-invert max-w-none">
          <p>Anti-fraud patterns that reduce loss while preserving conversion.</p><ul><li>Behavior analysis and anomaly scoring</li><li>Adaptive controls and rule reduction</li><li>Free readiness tools at <a href="https://ziontechgroup.com">ziontechgroup.com</a></li></ul><p>See <a href="/services/ai-observability-aiops">platform services</a>, then <a href="/contact">contact us</a> or <a href="https://calendly.com/kleber-ziontechgroup">schedule a meeting</a>.</p>
        </div>
