...
export const metadata = {
  ...
  openGraph: {
    title: 'Comparing Low-Code Automation Platforms: Build Internal Tools Without Full Engineering: vendors and build vs buy: 2026 Playbook',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/comparing-low-code-automation-platforms-build-internal-tools-without-full-engineering-vendors-and-build-vs-buy-2026-playbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/comparing-low-code-automation-platforms-build-internal-tools-without-full-engineering-vendors-and-build-vs-buy-2026-playbook/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Comparing Low-Code Automation Platforms: Build Internal Tools Without Full Engineering: vendors and build vs buy: 2026 Playbook' }]} className="mb-8" />
