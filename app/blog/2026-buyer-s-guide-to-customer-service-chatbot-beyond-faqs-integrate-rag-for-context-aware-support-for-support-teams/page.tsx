...
export const metadata = {
  ...
  openGraph: {
    title: '2026 buyer's guide to Customer Service Chatbot Beyond FAQs: Integrate RAG for Context-Aware Support for support teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/2026-buyer-s-guide-to-customer-service-chatbot-beyond-faqs-integrate-rag-for-context-aware-support-for-support-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/2026-buyer-s-guide-to-customer-service-chatbot-beyond-faqs-integrate-rag-for-context-aware-support-for-support-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: '2026 buyer's guide to Customer Service Chatbot Beyond FAQs: Integrate RAG for Context-Aware Support for support teams' }]} className="mb-8" />
