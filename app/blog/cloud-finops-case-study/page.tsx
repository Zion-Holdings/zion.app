...
export const metadata = {
  ...
  openGraph: {
    ...
    description: 'Cloud FinOps: case study',
    url: 'https://ziontechgroup.com/blog/cloud-finops-case-study/',
    type: 'article',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Cloud FinOps: case study", "description": "Cloud FinOps: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:26:29Z", "dateModified": "2026-08-04T16:26:29Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/cloud-finops-case-study/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Cloud FinOps: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Cloud FinOps: case study</h1>
          <p className="mt-4 text-lg text-slate-300">Cloud FinOps: case study</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/accessibility-compliance-2026-2387">Accessibility Compliance 2026 2387</Link></li>
<li><Link href="/blog/smart-contract-audit-2026-3029">Smart Contract Audit 2026 3029</Link></li>
<li><Link href="/blog/devops-gen-ai-cicd-2026-952">Devops Gen Ai Cicd 2026 952</Link></li>
