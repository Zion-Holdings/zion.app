...
export const metadata = {
  ...
  openGraph: {
    title: 'How to implement Automated Provisioning and De-provisioning: Identity and Access Lifecycle Automation without disrupting operations: 2026 Playbook',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/how-to-implement-automated-provisioning-and-de-provisioning-identity-and-access-lifecycle-automation-without-disrupting-operations-2026-playbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/how-to-implement-automated-provisioning-and-de-provisioning-identity-and-access-lifecycle-automation-without-disrupting-operations-2026-playbook/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'How to implement Automated Provisioning and De-provisioning: Identity and Access Lifecycle Automation without disrupting operations: 2026 Playbook' }]} className="mb-8" />
