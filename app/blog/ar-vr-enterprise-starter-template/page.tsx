...
export const metadata = {
  title: 'AR VR Enterprise: starter template | Zion Tech Group',
  description: 'AR VR Enterprise: starter template',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'AR VR Enterprise: starter template',
    description: 'AR VR Enterprise: starter template',
    url: 'https://ziontechgroup.com/blog/ar-vr-enterprise-starter-template/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ar-vr-enterprise-starter-template/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AR VR Enterprise: starter template", "description": "AR VR Enterprise: starter template", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T19:00:06Z", "dateModified": "2026-08-06T19:00:06Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ar-vr-enterprise-starter-template/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AR VR Enterprise: starter template' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AR VR Enterprise: starter template</h1>
          <p className="mt-4 text-lg text-slate-300">AR VR Enterprise: starter template</p>
...
<li><Link href="/blog/integration-testing-automation-roadmap">Integration Testing Automation Roadmap</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
