...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI MSP Security Compliance: policy and compliance | Zion Tech Group" description="AI MSP Security Compliance: policy and compliance" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-msp-security-compliance-policy-and-compliance/" />
