...
export const metadata = {
  title: 'Low Code Platform: policy and compliance | Zion Tech Group',
  description: 'Low Code Platform: policy and compliance',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Low Code Platform: policy and compliance',
    description: 'Low Code Platform: policy and compliance',
    url: 'https://ziontechgroup.com/blog/low-code-platform-policy-and-compliance/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/low-code-platform-policy-and-compliance/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Low Code Platform: policy and compliance", "description": "Low Code Platform: policy and compliance", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:09:22Z", "dateModified": "2026-08-06T18:09:22Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/low-code-platform-policy-and-compliance/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Low Code Platform: policy and compliance' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Low Code Platform: policy and compliance</h1>
          <p className="mt-4 text-lg text-slate-300">Low Code Platform: policy and compliance</p>
