...
export const metadata = {
  title: 'Blue Green Deployment: common mistakes | Zion Tech Group',
  description: 'Blue Green Deployment: common mistakes',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Blue Green Deployment: common mistakes',
    description: 'Blue Green Deployment: common mistakes',
    url: 'https://ziontechgroup.com/blog/blue-green-deployment-common-mistakes/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/blue-green-deployment-common-mistakes/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Blue Green Deployment: common mistakes", "description": "Blue Green Deployment: common mistakes", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:39:04Z", "dateModified": "2026-08-06T18:39:04Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/blue-green-deployment-common-mistakes/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Blue Green Deployment: common mistakes' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Blue Green Deployment: common mistakes</h1>
          <p className="mt-4 text-lg text-slate-300">Blue Green Deployment: common mistakes</p>
...
<li><Link href="/blog/enterprise-integration-executive-guide">Enterprise Integration Executive Guide</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
