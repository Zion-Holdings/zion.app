...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Automated AI Reporting: policy and compliance | Zion Tech Group" description="Automated AI Reporting: policy and compliance" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/automated-ai-reporting-policy-and-compliance/" />
