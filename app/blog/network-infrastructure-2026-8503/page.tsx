...
export const metadata = {
  ...
  alternates: { canonical: '/blog/network-infrastructure-2026-8503/' },
  openGraph: { title: 'Network Infrastructure', description: 'Practical guide to network infrastructure.', url: 'https://ziontechgroup.com/blog/network-infrastructure-2026-8503/', type: 'article' },
  twitter: { card: 'summary_large_image', title: 'Network Infrastructure', description: 'Practical guide to network infrastructure.' }
};

export default function Page() {
  return (
    <PageShell title="Network Infrastructure" description="Practical guide to network infrastructure: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/network-infrastructure-2026-8503/" jsonLd={{
