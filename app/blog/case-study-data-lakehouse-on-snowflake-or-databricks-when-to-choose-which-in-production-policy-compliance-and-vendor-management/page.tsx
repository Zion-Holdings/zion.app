...
export const metadata = {
  ...
  openGraph: {
    title: 'Case study: Data Lakehouse on Snowflake or Databricks: When to Choose Which in production: policy, compliance, and vendor management',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/case-study-data-lakehouse-on-snowflake-or-databricks-when-to-choose-which-in-production-policy-compliance-and-vendor-management/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/case-study-data-lakehouse-on-snowflake-or-databricks-when-to-choose-which-in-production-policy-compliance-and-vendor-management/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Case study: Data Lakehouse on Snowflake or Databricks: When to Choose Which in production: policy, compliance, and vendor management' }]} className="mb-8" />
