...
export const metadata = {
  ...
  openGraph: {
    title: 'AI Code Review Automation: Security, Style, and Architecture Gates: costs, ROI, and hidden risks for automation teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/ai-code-review-automation-security-style-and-architecture-gates-costs-roi-and-hidden-risks-for-automation-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-code-review-automation-security-style-and-architecture-gates-costs-roi-and-hidden-risks-for-automation-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Code Review Automation: Security, Style, and Architecture Gates: costs, ROI, and hidden risks for automation teams' }]} className="mb-8" />
