        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/it-consulting-2026-2361">It Consulting 2026 2361</Link></li>
<li><Link href="/blog/managed-it-services-small-business-2026-28">Managed It Services Small Business 2026 28</Link></li>
<li><Link href="/blog/autonomous-qa-engineering-2026-1348">Autonomous Qa Engineering 2026 1348</Link></li>
<li><Link href="/blog/database-migration-service-2026-1434">Database Migration Service 2026 1434</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
