...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="API Gateway Management: policy and compliance | Zion Tech Group" description="API Gateway Management: policy and compliance" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/api-gateway-management-policy-and-compliance/" />
