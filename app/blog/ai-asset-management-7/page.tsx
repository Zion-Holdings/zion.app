...
export const metadata = {
  title: 'Common mistakes when rolling out AI asset management | Zion Tech Group',
  description: 'Common mistakes when rolling out AI asset management',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Common mistakes when rolling out AI asset management',
    description: 'Common mistakes when rolling out AI asset management',
    url: 'https://ziontechgroup.com/blog/ai-asset-management-7/',
    type: 'article',
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Common mistakes when rolling out AI asset management' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Common mistakes when rolling out AI asset management</h1>
          <p className="mt-4 text-lg text-slate-300">Common mistakes when rolling out AI asset management</p>
