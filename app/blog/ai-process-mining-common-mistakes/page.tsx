...
export const metadata = {
  title: 'AI Process Mining: common mistakes | Zion Tech Group',
  description: 'AI Process Mining: common mistakes',
  keywords: ['ai', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'AI Process Mining: common mistakes',
    description: 'AI Process Mining: common mistakes',
    url: 'https://ziontechgroup.com/blog/ai-process-mining-common-mistakes/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-process-mining-common-mistakes/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AI Process Mining: common mistakes", "description": "AI Process Mining: common mistakes", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:24:30Z", "dateModified": "2026-08-06T18:24:30Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ai-process-mining-common-mistakes/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Process Mining: common mistakes' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AI Process Mining: common mistakes</h1>
          <p className="mt-4 text-lg text-slate-300">AI Process Mining: common mistakes</p>
...
<li><Link href="/blog/generative-ai-security-common-mistakes">Generative Ai Security Common Mistakes</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
