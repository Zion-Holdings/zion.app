...
export const metadata = {
  ...
  openGraph: {
    title: 'Student Teacher Sent a Private Snapchat Complaining About Her Workday. An Hour Later, Poli: policy, compliance, and vendor management',
    description: 'Live web-researched high-intent buyer topic',
    url: 'https://ziontechgroup.com/blog/student-teacher-sent-a-private-snapchat-complaining-about-her-workday-an-hour-later-poli-policy-compliance-and-vendor-management/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/student-teacher-sent-a-private-snapchat-complaining-about-her-workday-an-hour-later-poli-policy-compliance-and-vendor-management/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Student Teacher Sent a Private Snapchat Complaining About Her Workday. An Hour Later, Poli: policy, compliance, and vendor management' }]} className="mb-8" />
