...
export const metadata = {
  ...
  openGraph: {
    title: 'Ex-60 Minutes boss wants to create rival broadcast with fired staffers: report | A new cur: costs, ROI, and hidden risks',
    description: 'Live web-researched high-intent buyer topic',
    url: 'https://ziontechgroup.com/blog/ex-60-minutes-boss-wants-to-create-rival-broadcast-with-fired-staffers-report-a-new-cur-costs-roi-and-hidden-risks/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ex-60-minutes-boss-wants-to-create-rival-broadcast-with-fired-staffers-report-a-new-cur-costs-roi-and-hidden-risks/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Ex-60 Minutes boss wants to create rival broadcast with fired staffers: report | A new cur: costs, ROI, and hidden risks' }]} className="mb-8" />
