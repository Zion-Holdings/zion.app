...
export const metadata = {
  ...
  openGraph: {
    title: 'How to implement Comparing Customer Success Automation: Trigger Health Checks, Outreach, and Product Signals: vendors and build vs buy without disrupting operations',
    description: 'Health-based playbooks and intervention timing',
    url: 'https://ziontechgroup.com/blog/how-to-implement-comparing-customer-success-automation-trigger-health-checks-outreach-and-product-signals-vendors-and-build-vs-buy-without-disrupting-operations/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/how-to-implement-comparing-customer-success-automation-trigger-health-checks-outreach-and-product-signals-vendors-and-build-vs-buy-without-disrupting-operations/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'How to implement Comparing Customer Success Automation: Trigger Health Checks, Outreach, and Product Signals: vendors and build vs buy without disrupting operations' }]} className="mb-8" />
