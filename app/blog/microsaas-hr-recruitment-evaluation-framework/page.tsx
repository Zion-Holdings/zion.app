...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="MicroSaaS HR Recruitment: evaluation framework | Zion Tech Group" description="MicroSaaS HR Recruitment: evaluation framework" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/microsaas-hr-recruitment-evaluation-framework/" />
