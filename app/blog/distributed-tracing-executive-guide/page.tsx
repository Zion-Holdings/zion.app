...
export const metadata = {
  title: 'Distributed Tracing: executive guide | Zion Tech Group',
  description: 'Distributed Tracing: executive guide',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Distributed Tracing: executive guide',
    description: 'Distributed Tracing: executive guide',
    url: 'https://ziontechgroup.com/blog/distributed-tracing-executive-guide/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/distributed-tracing-executive-guide/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Distributed Tracing: executive guide", "description": "Distributed Tracing: executive guide", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:24:59Z", "dateModified": "2026-08-06T18:24:59Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/distributed-tracing-executive-guide/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Distributed Tracing: executive guide' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Distributed Tracing: executive guide</h1>
          <p className="mt-4 text-lg text-slate-300">Distributed Tracing: executive guide</p>
...
<li><Link href="/blog/generative-ai-vendor-evaluation">Generative Ai Vendor Evaluation</Link></li>
