...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Brand Voice Guardian: evaluation framework | Zion Tech Group" description="Brand Voice Guardian: evaluation framework" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/brand-voice-guardian-evaluation-framework/" />
