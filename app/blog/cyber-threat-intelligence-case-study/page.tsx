...
export const metadata = {
  ...
  openGraph: {
    title: 'Cyber Threat Intelligence: case study | Zion Tech Group',
    description: 'Cyber Threat Intelligence: case study.',
    url: 'https://ziontechgroup.comapp/blog/cyber-threat-intelligence-case-study/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/cyber-threat-intelligence-case-study/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'Cyber Threat Intelligence: case study',
  description: 'Cyber Threat Intelligence: case study.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/cyber-threat-intelligence-case-study/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'Cyber Threat Intelligence: case study' },
      ]}
    >
