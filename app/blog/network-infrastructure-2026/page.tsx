...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Network Infrastructure | Zion Tech Group" description="Network Infrastructure" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/network-infrastructure-2026/" />
