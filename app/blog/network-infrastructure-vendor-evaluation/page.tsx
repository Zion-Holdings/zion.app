...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Network Infrastructure: vendor evaluation", "description": "Network Infrastructure: vendor evaluation", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T15:08:45Z", "dateModified": "2026-08-04T15:08:45Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/network-infrastructure-vendor-evaluation/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Network Infrastructure: vendor evaluation' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Network Infrastructure: vendor evaluation</h1>
          <p className="mt-4 text-lg text-slate-300">Network Infrastructure: vendor evaluation</p>
