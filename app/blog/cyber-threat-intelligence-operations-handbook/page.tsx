...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Cyber Threat Intelligence: operations handbook | Zion Tech Group" description="Cyber Threat Intelligence: operations handbook" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/cyber-threat-intelligence-operations-handbook/" />
