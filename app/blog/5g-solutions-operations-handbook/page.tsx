...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "5G Solutions: operations handbook", "description": "5G Solutions: operations handbook", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:28:32Z", "dateModified": "2026-08-04T16:28:32Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/5g-solutions-operations-handbook/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: '5G Solutions: operations handbook' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">5G Solutions: operations handbook</h1>
          <p className="mt-4 text-lg text-slate-300">5G Solutions: operations handbook</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/devops-gen-ai-cicd-2026-2677">Devops Gen Ai Cicd 2026 2677</Link></li>
<li><Link href="/blog/automated-ai-reporting-2026-2450">Automated Ai Reporting 2026 2450</Link></li>
<li><Link href="/blog/devops-cicd-2026-708">Devops Cicd 2026 708</Link></li>
<li><Link href="/blog/event-driven-architecture-2026-3511">Event Driven Architecture 2026 3511</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
