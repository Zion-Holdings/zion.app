...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI Customer Support: common mistakes | Zion Tech Group" description="AI Customer Support: common mistakes" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-customer-support-common-mistakes/" />
