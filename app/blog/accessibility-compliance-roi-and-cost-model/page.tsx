...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Accessibility Compliance: ROI and cost model | Zion Tech Group" description="Accessibility Compliance: ROI and cost model" datePublished="2026-08-11" url="https://ziontechgroup.com/blog/accessibility-compliance-roi-and-cost-model/" />
