        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/micro-saas-ai-social-media-manager-2026-575">Micro Saas Ai Social Media Manager 2026 575</Link></li>
<li><Link href="/blog/ai-ad-copy-generator-2026-1339">Ai Ad Copy Generator 2026 1339</Link></li>
