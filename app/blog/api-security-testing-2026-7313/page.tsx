...
export const metadata = {
  ...
  openGraph: { title: 'API Security Testing', description: 'Practical guide to api security testing.', url: 'https://ziontechgroup.com/blog/api-security-testing-2026/', type: 'article' },
  twitter: { card: 'summary_large_image', title: 'API Security Testing', description: 'Practical guide to api security testing.' }
};

export default function Page() {
  return (
    <PageShell title="API Security Testing" description="Practical guide to api security testing: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/api-security-testing-2026/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/api-security-testing-2026/'
    }}>
