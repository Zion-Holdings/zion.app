...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI Email Intelligence: case study | Zion Tech Group" description="AI Email Intelligence: case study" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-email-intelligence-case-study/" />
