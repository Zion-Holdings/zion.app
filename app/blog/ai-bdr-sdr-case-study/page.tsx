...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI BDR SDR: case study | Zion Tech Group" description="AI BDR SDR: case study" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-bdr-sdr-case-study/" />
