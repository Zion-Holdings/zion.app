...
export const metadata = {
  ...
  description: 'Aiops Automated Root Cause Analysis For It Operations: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
    title: 'Aiops Automated Root Cause Analysis For It Operations',
    description: 'Aiops Automated Root Cause Analysis For It Operations: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
    url: 'https://ziontechgroup.com/blog/aiops-automated-root-cause-analysis-for-it-operations',
    type: 'article',
  },
  alternates: {
    canonical: 'https://ziontechgroup.com/blog/aiops-automated-root-cause-analysis-for-it-operations',
  },
};
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'Aiops Automated Root Cause Analysis For It Operations' }
          ]}
          className="mb-8"
        />
        ...
        <header className="mb-12">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Aiops Automated Root Cause Analysis For It Operations</h1>
          <p className="mt-4 text-lg text-slate-300">Aiops Automated Root Cause Analysis For It Operations requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
