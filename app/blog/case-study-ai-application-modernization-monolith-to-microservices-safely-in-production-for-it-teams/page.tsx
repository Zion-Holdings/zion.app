...
export const metadata = {
  ...
  openGraph: {
    title: 'Case study: AI Application Modernization: Monolith to Microservices Safely in production for it teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/case-study-ai-application-modernization-monolith-to-microservices-safely-in-production-for-it-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/case-study-ai-application-modernization-monolith-to-microservices-safely-in-production-for-it-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Case study: AI Application Modernization: Monolith to Microservices Safely in production for it teams' }]} className="mb-8" />
