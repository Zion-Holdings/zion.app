...
export const metadata = {
  title: 'Kubernetes: architecture overview | Zion Tech Group',
  ...
  openGraph: {
    ...
    description: 'Kubernetes: architecture overview',
    url: 'https://ziontechgroup.com/blog/kubernetes-architecture-overview/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/kubernetes-architecture-overview/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Kubernetes: architecture overview", "description": "Kubernetes: architecture overview", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:11:41Z", "dateModified": "2026-08-06T18:11:41Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/kubernetes-architecture-overview/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Kubernetes: architecture overview' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Kubernetes: architecture overview</h1>
          <p className="mt-4 text-lg text-slate-300">Kubernetes: architecture overview</p>
...
<li><Link href="/blog/data-architecture-vendor-evaluation">Data Architecture Vendor Evaluation</Link></li>
