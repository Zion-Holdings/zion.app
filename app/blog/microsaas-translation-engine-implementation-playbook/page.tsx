        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/autonomous-qa-engineering-2026-2038">Autonomous Qa Engineering 2026 2038</Link></li>
<li><Link href="/blog/devsecops-pipeline-2026-3092">Devsecops Pipeline 2026 3092</Link></li>
<li><Link href="/blog/ai-bdr-sdr-vendor-evaluation">Ai Bdr Sdr Vendor Evaluation</Link></li>
<li><Link href="/blog/api-gateway-management-2026-3654">Api Gateway Management 2026 3654</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
