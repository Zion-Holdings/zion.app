...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI BDR SDR: evaluation framework | Zion Tech Group" description="AI BDR SDR: evaluation framework" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-bdr-sdr-evaluation-framework/" />
