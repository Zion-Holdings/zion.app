...
export const metadata = {
  ...
  description: 'Ai For It Service Analytics And Reporting: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
    title: 'Ai For It Service Analytics And Reporting',
    description: 'Ai For It Service Analytics And Reporting: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
    url: 'https://ziontechgroup.com/blog/ai-for-it-service-analytics-and-reporting',
    type: 'article',
  },
  alternates: {
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'Ai For It Service Analytics And Reporting' }
          ]}
          className="mb-8"
        />
        ...
        <header className="mb-12">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Ai For It Service Analytics And Reporting</h1>
          <p className="mt-4 text-lg text-slate-300">Ai For It Service Analytics And Reporting requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
