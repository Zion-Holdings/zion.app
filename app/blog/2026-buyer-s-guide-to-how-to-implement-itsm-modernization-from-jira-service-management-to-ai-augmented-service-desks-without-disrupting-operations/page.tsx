...
export const metadata = {
  ...
  openGraph: {
    title: '2026 buyer's guide to How to implement ITSM Modernization: From Jira Service Management to AI-Augmented Service Desks without disrupting operations',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/2026-buyer-s-guide-to-how-to-implement-itsm-modernization-from-jira-service-management-to-ai-augmented-service-desks-without-disrupting-operations/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/2026-buyer-s-guide-to-how-to-implement-itsm-modernization-from-jira-service-management-to-ai-augmented-service-desks-without-disrupting-operations/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: '2026 buyer's guide to How to implement ITSM Modernization: From Jira Service Management to AI-Augmented Service Desks without disrupting operations' }]} className="mb-8" />
