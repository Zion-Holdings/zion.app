...
export const metadata = {
  ...
  openGraph: {
    title: 'How to implement Data Lakehouse on Snowflake or Databricks: When to Choose Which without disrupting operations checklist for IT and security leaders',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/how-to-implement-data-lakehouse-on-snowflake-or-databricks-when-to-choose-which-without-disrupting-operations-checklist-for-it-and-security-leaders/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/how-to-implement-data-lakehouse-on-snowflake-or-databricks-when-to-choose-which-without-disrupting-operations-checklist-for-it-and-security-leaders/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'How to implement Data Lakehouse on Snowflake or Databricks: When to Choose Which without disrupting operations checklist for IT and security leaders' }]} className="mb-8" />
