...
export const metadata = {
  ...
  openGraph: {
    title: 'Case study: Comparing Proactive Customer Support with AI: Predict Issues Before Tickets Open: vendors and build vs buy in production',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/case-study-comparing-proactive-customer-support-with-ai-predict-issues-before-tickets-open-vendors-and-build-vs-buy-in-production/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/case-study-comparing-proactive-customer-support-with-ai-predict-issues-before-tickets-open-vendors-and-build-vs-buy-in-production/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Case study: Comparing Proactive Customer Support with AI: Predict Issues Before Tickets Open: vendors and build vs buy in production' }]} className="mb-8" />
