...
export const metadata = {
  ...
  openGraph: {
    title: 'Incident Response Retainer: architecture overview | Zion Tech Group',
    description: 'Incident Response Retainer: architecture overview.',
    url: 'https://ziontechgroup.comapp/blog/incident-response-retainer-architecture-overview/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/incident-response-retainer-architecture-overview/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'Incident Response Retainer: architecture overview',
  description: 'Incident Response Retainer: architecture overview.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/incident-response-retainer-architecture-overview/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'Incident Response Retainer: architecture overview' },
      ]}
    >
