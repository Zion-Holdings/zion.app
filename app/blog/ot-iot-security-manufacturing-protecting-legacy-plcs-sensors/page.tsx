...
export const metadata = {
  ...
  description: 'OT/IoT Security for Manufacturing: Protecting Legacy PLCs and Sensors: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/blog/ot-iot-security-manufacturing-protecting-legacy-plcs-sensors',
  },
};
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'OT/IoT Security for Manufacturing: Protecting Legacy PLCs and Sensors' }
          ]}
          className="mb-8"
        />
        ...
        <header className="mb-12">
          ...
          <p className="mt-4 text-lg text-slate-300">OT/IoT Security Manufacturing: Protecting Legacy PLCs and Sensors requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
