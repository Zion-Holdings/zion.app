...
export const metadata = {
  ...
  openGraph: {
    title: 'Automation Orchestration: security and governance',
    description: 'Automation Orchestration: security and governance',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Automation Orchestration: security and governance", "description": "Automation Orchestration: security and governance", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:13:48Z", "dateModified": "2026-08-04T16:13:48Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/automation-orchestration-security-and-governance/"};
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/ai-data-lakehouse-pipelines-2026-1806">Ai Data Lakehouse Pipelines 2026 1806</Link></li>
<li><Link href="/blog/it-consulting-2026-3879">It Consulting 2026 3879</Link></li>
