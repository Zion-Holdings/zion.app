...
export const metadata = {
  title: 'Comparing AI government services vendors and build vs buy | Zion Tech Group',
  description: 'Comparing AI government services vendors and build vs buy',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Comparing AI government services vendors and build vs buy',
    description: 'Comparing AI government services vendors and build vs buy',
    url: 'https://ziontechgroup.com/blog/ai-government-services-4/',
    type: 'article',
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Comparing AI government services vendors and build vs buy' }]} className="mb-8" />
        <header className="mb-10">
          ...
          <p className="mt-4 text-lg text-slate-300">Comparing AI government services vendors and build vs buy</p>
