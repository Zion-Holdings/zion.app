...
<h2 className="text-2xl font-bold text-white mb-3">Overview</h2>
          <p className="text-slate-300 mb-6">Automated AI Reporting: evaluation framework. Organizations benefit from clearer requirements, tighter governance, and repeatable delivery models.</p>
