...
export const metadata = {
  ...
  openGraph: {
    title: 'Automated AI Reporting: evaluation framework | Zion Tech Group',
    description: 'Automated AI Reporting: evaluation framework.',
    url: 'https://ziontechgroup.comapp/blog/automated-ai-reporting-evaluation-framework/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/automated-ai-reporting-evaluation-framework/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'Automated AI Reporting: evaluation framework',
  description: 'Automated AI Reporting: evaluation framework.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/automated-ai-reporting-evaluation-framework/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'Automated AI Reporting: evaluation framework' },
      ]}
    >
