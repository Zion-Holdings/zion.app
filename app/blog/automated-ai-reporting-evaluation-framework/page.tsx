...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Automated AI Reporting: evaluation framework | Zion Tech Group" description="Automated AI Reporting: evaluation framework" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/automated-ai-reporting-evaluation-framework/" />
