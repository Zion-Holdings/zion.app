...
export const metadata = {
  ...
  openGraph: {
    ...
    description: 'Automated AI Reporting: evaluation framework',
    url: 'https://ziontechgroup.com/blog/automated-ai-reporting-evaluation-framework/',
    type: 'article',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Automated AI Reporting: evaluation framework", "description": "Automated AI Reporting: evaluation framework", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-18T21:49:46Z", "dateModified": "2026-08-18T21:49:46Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/automated-ai-reporting-evaluation-framework/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: "Home", href: "/" }, { label: "Blog", href: "/blog/" }, { label: "Automated AI Reporting: evaluation framework" }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Automated AI Reporting: evaluation framework</h1>
          <p className="mt-4 text-lg text-slate-300">Automated AI Reporting: evaluation framework</p>
