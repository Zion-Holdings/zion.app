...
export const metadata = {
  title: 'Edge Ai Video Analytics Retail Operations | Zion Tech Group',
  description: 'Edge Ai Video Analytics Retail Operations: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
    title: 'Edge Ai Video Analytics Retail Operations',
    description: 'Edge Ai Video Analytics Retail Operations: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
    url: 'https://ziontechgroup.com/blog/edge-ai-video-analytics-retail-operations',
    type: 'article',
  },
  alternates: {
    canonical: 'https://ziontechgroup.com/blog/edge-ai-video-analytics-retail-operations',
  },
};
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'Edge Ai Video Analytics Retail Operations' }
          ]}
          className="mb-8"
        />
        ...
        <header className="mb-12">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Edge Ai Video Analytics Retail Operations</h1>
          <p className="mt-4 text-lg text-slate-300">Edge Ai Video Analytics Retail Operations requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
