...
export const metadata = {
  title: 'AR VR Enterprise: executive guide | Zion Tech Group',
  description: 'AR VR Enterprise: executive guide',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'AR VR Enterprise: executive guide',
    description: 'AR VR Enterprise: executive guide',
    url: 'https://ziontechgroup.com/blog/ar-vr-enterprise-executive-guide/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ar-vr-enterprise-executive-guide/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AR VR Enterprise: executive guide", "description": "AR VR Enterprise: executive guide", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T19:00:03Z", "dateModified": "2026-08-06T19:00:03Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ar-vr-enterprise-executive-guide/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AR VR Enterprise: executive guide' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AR VR Enterprise: executive guide</h1>
          <p className="mt-4 text-lg text-slate-300">AR VR Enterprise: executive guide</p>
...
<li><Link href="/blog/data-modeling-security-and-governance">Data Modeling Security And Governance</Link></li>
<li><Link href="/blog/compliance-automation-vendor-evaluation">Compliance Automation Vendor Evaluation</Link></li>
<li><Link href="/blog/data-catalog-deployment-patterns">Data Catalog Deployment Patterns</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
