...
export const metadata = {
  ...
  description: 'Ai Insurance Claims Automation Guide For Operations Leaders: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
    title: 'Ai Insurance Claims Automation Guide For Operations Leaders',
    description: 'Ai Insurance Claims Automation Guide For Operations Leaders: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
    url: 'https://ziontechgroup.com/blog/ai-insurance-claims-automation-guide-for-operations-leaders',
    type: 'article',
  },
  alternates: {
    canonical: 'https://ziontechgroup.com/blog/ai-insurance-claims-automation-guide-for-operations-leaders',
  },
};
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'Ai Insurance Claims Automation Guide For Operations Leaders' }
          ]}
          className="mb-8"
        />
        ...
        <header className="mb-12">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Ai Insurance Claims Automation Guide For Operations Leaders</h1>
          <p className="mt-4 text-lg text-slate-300">Ai Insurance Claims Automation Guide For Operations Leaders requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
