...
<li><Link href="/blog/container-security-lifecycle-2026-258">Container Security Lifecycle 2026 258</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
