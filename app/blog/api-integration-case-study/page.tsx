...
export const metadata = {
  ...
  description: 'API Integration: case study',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "API Integration: case study", "description": "API Integration: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-17T17:20:22Z", "dateModified": "2026-08-17T17:20:22Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/api-integration-case-study/"};
  ...
  return (
    ...
    >
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'API Integration: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">API Integration: case study</h1>
          <p className="mt-4 text-lg text-slate-300">API Integration: case study</p>
