...
export const metadata = {
  ...
  openGraph: {
    title: 'AI Capacity Planning for SaaS and Cloud Platforms checklist for IT and security leaders: 2026 Playbook',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/ai-capacity-planning-for-saas-and-cloud-platforms-checklist-for-it-and-security-leaders-2026-playbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-capacity-planning-for-saas-and-cloud-platforms-checklist-for-it-and-security-leaders-2026-playbook/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Capacity Planning for SaaS and Cloud Platforms checklist for IT and security leaders: 2026 Playbook' }]} className="mb-8" />
