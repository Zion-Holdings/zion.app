...
export const metadata = {
  title: 'Privacy Engineering: architecture overview | Zion Tech Group',
  description: 'Privacy Engineering: architecture overview',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Privacy Engineering: architecture overview',
    description: 'Privacy Engineering: architecture overview',
    url: 'https://ziontechgroup.com/blog/privacy-engineering-architecture-overview/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/privacy-engineering-architecture-overview/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Privacy Engineering: architecture overview", "description": "Privacy Engineering: architecture overview", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:24:05Z", "dateModified": "2026-08-06T18:24:05Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/privacy-engineering-architecture-overview/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Privacy Engineering: architecture overview' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Privacy Engineering: architecture overview</h1>
          <p className="mt-4 text-lg text-slate-300">Privacy Engineering: architecture overview</p>
...
<li><Link href="/blog/ai-hr-recruitment-implementation-playbook">Ai Hr Recruitment Implementation Playbook</Link></li>
