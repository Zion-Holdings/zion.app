...
export default function Page() {
  return (
    <PageShell title="AI Accessibility Optimizer" description="Practical guide to ai accessibility optimizer: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/ai-accessibility-optimizer-2026-8031/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/ai-accessibility-optimizer-2026-8031/'
    }}>
