...
export const metadata = {
  title: 'AR VR Enterprise: deployment patterns | Zion Tech Group',
  description: 'AR VR Enterprise: deployment patterns',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'AR VR Enterprise: deployment patterns',
    description: 'AR VR Enterprise: deployment patterns',
    url: 'https://ziontechgroup.com/blog/ar-vr-enterprise-deployment-patterns/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ar-vr-enterprise-deployment-patterns/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AR VR Enterprise: deployment patterns", "description": "AR VR Enterprise: deployment patterns", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:12:50Z", "dateModified": "2026-08-06T18:12:50Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ar-vr-enterprise-deployment-patterns/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AR VR Enterprise: deployment patterns' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AR VR Enterprise: deployment patterns</h1>
          <p className="mt-4 text-lg text-slate-300">AR VR Enterprise: deployment patterns</p>
...
<li><Link href="/blog/privacy-engineering-case-study">Privacy Engineering Case Study</Link></li>
