...
export const metadata = {
  ...
  openGraph: {
    title: 'Comparing AI Customer Journey Analytics: From Click to Retention: vendors and build vs buy checklist for IT and security leaders',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/comparing-ai-customer-journey-analytics-from-click-to-retention-vendors-and-build-vs-buy-checklist-for-it-and-security-leaders/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/comparing-ai-customer-journey-analytics-from-click-to-retention-vendors-and-build-vs-buy-checklist-for-it-and-security-leaders/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Comparing AI Customer Journey Analytics: From Click to Retention: vendors and build vs buy checklist for IT and security leaders' }]} className="mb-8" />
