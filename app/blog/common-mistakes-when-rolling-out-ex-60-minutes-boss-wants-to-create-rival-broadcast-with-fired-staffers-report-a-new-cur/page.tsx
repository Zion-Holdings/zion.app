...
export const metadata = {
  ...
  openGraph: {
    title: 'Common mistakes when rolling out Ex-60 Minutes boss wants to create rival broadcast with fired staffers: report | A new cur',
    description: 'Live web-researched high-intent buyer topic',
    url: 'https://ziontechgroup.com/blog/common-mistakes-when-rolling-out-ex-60-minutes-boss-wants-to-create-rival-broadcast-with-fired-staffers-report-a-new-cur/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/common-mistakes-when-rolling-out-ex-60-minutes-boss-wants-to-create-rival-broadcast-with-fired-staffers-report-a-new-cur/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Common mistakes when rolling out Ex-60 Minutes boss wants to create rival broadcast with fired staffers: report | A new cur' }]} className="mb-8" />
