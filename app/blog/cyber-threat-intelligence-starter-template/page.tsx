...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Cyber Threat Intelligence: starter template | Zion Tech Group" description="Cyber Threat Intelligence: starter template" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/cyber-threat-intelligence-starter-template/" />
