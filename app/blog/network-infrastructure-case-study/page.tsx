...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Network Infrastructure: case study | Zion Tech Group" description="Network Infrastructure: case study" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/network-infrastructure-case-study/" />
