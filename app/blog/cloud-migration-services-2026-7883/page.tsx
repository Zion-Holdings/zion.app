...
export const metadata = {
  ...
  alternates: { canonical: '/blog/cloud-migration-services-2026-7883/' },
  openGraph: { title: 'Cloud Migration Services', description: 'Practical guide to cloud migration services.', url: 'https://ziontechgroup.com/blog/cloud-migration-services-2026-7883/', type: 'article' },
...
export default function Page() {
  return (
    <PageShell title="Cloud Migration Services" description="Practical guide to cloud migration services: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/cloud-migration-services-2026-7883/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/cloud-migration-services-2026-7883/'
    }}>
