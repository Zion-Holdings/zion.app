...
export const metadata = {
  title: 'Penetration Testing: executive guide | Zion Tech Group',
  description: 'Penetration Testing: executive guide',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Penetration Testing: executive guide',
    description: 'Penetration Testing: executive guide',
    url: 'https://ziontechgroup.com/blog/penetration-testing-executive-guide/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/penetration-testing-executive-guide/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Penetration Testing: executive guide", "description": "Penetration Testing: executive guide", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:25:00Z", "dateModified": "2026-08-06T18:25:00Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/penetration-testing-executive-guide/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Penetration Testing: executive guide' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Penetration Testing: executive guide</h1>
          <p className="mt-4 text-lg text-slate-300">Penetration Testing: executive guide</p>
...
<li><Link href="/blog/infrastructure-as-code-deployment-patterns">Infrastructure As Code Deployment Patterns</Link></li>
