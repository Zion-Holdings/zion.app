...
export const metadata = {
  ...
  alternates: { canonical: '/blog/devops-cicd-2026-3537/' },
  openGraph: { title: 'DevOps CI/CD', description: 'Practical guide to devops ci/cd.', url: 'https://ziontechgroup.com/blog/devops-cicd-2026-3537/', type: 'article' },
  twitter: { card: 'summary_large_image', title: 'DevOps CI/CD', description: 'Practical guide to devops ci/cd.' }
};

export default function Page() {
  return (
    <PageShell title="DevOps CI/CD" description="Practical guide to devops ci/cd: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/devops-cicd-2026-3537/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/devops-cicd-2026-3537/'
    }}>
