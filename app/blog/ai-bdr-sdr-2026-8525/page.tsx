...
export default function Page() {
  return (
    <PageShell title="AI BDR SDR" description="Practical guide to ai bdr sdr: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/ai-bdr-sdr-2026-8525/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/ai-bdr-sdr-2026-8525/'
    }}>
