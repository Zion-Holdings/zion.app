...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI BOM Procurement: executive guide | Zion Tech Group" description="AI BOM Procurement: executive guide" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-bom-procurement-executive-guide/" />
