...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Cloud Cost Optimization: implementation playbook | Zion Tech Group" description="Cloud Cost Optimization: implementation playbook" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/cloud-cost-optimization-implementation-playbook/" />
