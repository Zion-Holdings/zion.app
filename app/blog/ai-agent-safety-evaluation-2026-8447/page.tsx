...
export default function Page() {
  return (
    <PageShell title="AI Agent Safety Evaluation" description="Practical guide to ai agent safety evaluation: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/ai-agent-safety-evaluation-2026-8447/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/ai-agent-safety-evaluation-2026-8447/'
    }}>
