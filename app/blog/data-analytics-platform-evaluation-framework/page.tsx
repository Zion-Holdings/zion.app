...
<li><Link href="/blog/api-management-gateway-2026-321">Api Management Gateway 2026 321</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
