...
export default function Page() {
  return (
    <PageShell title="AI MSP Security Compliance" description="Practical guide to ai msp security compliance: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/ai-msp-security-compliance-2026-8084/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/ai-msp-security-compliance-2026-8084/'
    }}>
