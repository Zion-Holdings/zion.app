...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Smart Contract Audit: evaluation framework | Zion Tech Group" description="Smart Contract Audit: evaluation framework" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/smart-contract-audit-evaluation-framework/" />
