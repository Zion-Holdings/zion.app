...
export const metadata = {
  ...
  openGraph: {
    title: 'Common mistakes when rolling out AI Governance Framework: Audit, Explain, and Govern Model Decisions in 2026 for ai teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/common-mistakes-when-rolling-out-ai-governance-framework-audit-explain-and-govern-model-decisions-in-2026-for-ai-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/common-mistakes-when-rolling-out-ai-governance-framework-audit-explain-and-govern-model-decisions-in-2026-for-ai-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Common mistakes when rolling out AI Governance Framework: Audit, Explain, and Govern Model Decisions in 2026 for ai teams' }]} className="mb-8" />
