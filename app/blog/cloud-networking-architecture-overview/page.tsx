...
export const metadata = {
  title: 'Cloud Networking: architecture overview | Zion Tech Group',
  description: 'Cloud Networking: architecture overview',
  keywords: ['cloud', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Cloud Networking: architecture overview',
    description: 'Cloud Networking: architecture overview',
    url: 'https://ziontechgroup.com/blog/cloud-networking-architecture-overview/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/cloud-networking-architecture-overview/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Cloud Networking: architecture overview", "description": "Cloud Networking: architecture overview", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:08:17Z", "dateModified": "2026-08-06T18:08:17Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/cloud-networking-architecture-overview/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Cloud Networking: architecture overview' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Cloud Networking: architecture overview</h1>
          <p className="mt-4 text-lg text-slate-300">Cloud Networking: architecture overview</p>
