...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Database Migration Service: vendor evaluation | Zion Tech Group" description="Database Migration Service: vendor evaluation" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/database-migration-service-vendor-evaluation/" />
