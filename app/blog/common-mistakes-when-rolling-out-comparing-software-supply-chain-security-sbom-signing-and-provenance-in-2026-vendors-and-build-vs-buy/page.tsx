...
export const metadata = {
  ...
  openGraph: {
    title: 'Common mistakes when rolling out Comparing Software Supply Chain Security: SBOM, Signing, and Provenance in 2026: vendors and build vs buy',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/common-mistakes-when-rolling-out-comparing-software-supply-chain-security-sbom-signing-and-provenance-in-2026-vendors-and-build-vs-buy/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/common-mistakes-when-rolling-out-comparing-software-supply-chain-security-sbom-signing-and-provenance-in-2026-vendors-and-build-vs-buy/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Common mistakes when rolling out Comparing Software Supply Chain Security: SBOM, Signing, and Provenance in 2026: vendors and build vs buy' }]} className="mb-8" />
