...
export const metadata = {
  ...
  openGraph: {
    title: 'Comparing OT/IoT Security for Manufacturing: Protecting Legacy PLCs and Sensors: vendors and build vs buy: policy, compliance, and vendor management',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/comparing-ot-iot-security-for-manufacturing-protecting-legacy-plcs-and-sensors-vendors-and-build-vs-buy-policy-compliance-and-vendor-management/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/comparing-ot-iot-security-for-manufacturing-protecting-legacy-plcs-and-sensors-vendors-and-build-vs-buy-policy-compliance-and-vendor-management/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Comparing OT/IoT Security for Manufacturing: Protecting Legacy PLCs and Sensors: vendors and build vs buy: policy, compliance, and vendor management' }]} className="mb-8" />
