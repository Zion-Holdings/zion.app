...
export const metadata = {
  ...
  alternates: { canonical: '/blog/ai-customer-success-churn-2026-11536/' },
  openGraph: { title: 'AI Customer Success Churn Prevention', description: 'Practical guide to ai customer success churn prevention.', url: 'https://ziontechgroup.com/blog/ai-customer-success-churn-2026-11536/', type: 'article' },
...
export default function Page() {
  return (
    <PageShell title="AI Customer Success Churn Prevention" description="Practical guide to ai customer success churn prevention: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/ai-customer-success-churn-2026-11536/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/ai-customer-success-churn-2026-11536/'
    }}>
