...
export const metadata = {
  ...
  openGraph: {
    title: 'Comparing Comparing Automated Provisioning and De-provisioning: Identity and Access Lifecycle Automation: vendors and build vs buy: vendors and build vs buy',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/comparing-comparing-automated-provisioning-and-de-provisioning-identity-and-access-lifecycle-automation-vendors-and-build-vs-buy-vendors-and-build-vs-buy/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/comparing-comparing-automated-provisioning-and-de-provisioning-identity-and-access-lifecycle-automation-vendors-and-build-vs-buy-vendors-and-build-vs-buy/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Comparing Comparing Automated Provisioning and De-provisioning: Identity and Access Lifecycle Automation: vendors and build vs buy: vendors and build vs buy' }]} className="mb-8" />
