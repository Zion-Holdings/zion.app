...
export const metadata = {
  ...
  openGraph: {
    title: 'Comparing AI Network Detection and Response for Hybrid Infrastructures in 2026: 2026 Playbook: vendors and build vs buy',
    description: 'Network telemetry plus endpoint and identity signals',
    url: 'https://ziontechgroup.com/blog/comparing-ai-network-detection-and-response-for-hybrid-infrastructures-in-2026-2026-playbook-vendors-and-build-vs-buy/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/comparing-ai-network-detection-and-response-for-hybrid-infrastructures-in-2026-2026-playbook-vendors-and-build-vs-buy/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Comparing AI Network Detection and Response for Hybrid Infrastructures in 2026: 2026 Playbook: vendors and build vs buy' }]} className="mb-8" />
