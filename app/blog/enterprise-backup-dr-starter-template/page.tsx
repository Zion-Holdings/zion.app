...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Enterprise Backup DR: starter template | Zion Tech Group" description="Enterprise Backup DR: starter template" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/enterprise-backup-dr-starter-template/" />
