...
export const metadata = {
  ...
  openGraph: {
    title: 'How to implement Process Mining for Operations: Discover Bottlenecks and Automate What Matters for automation teams without disrupting operations',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/how-to-implement-process-mining-for-operations-discover-bottlenecks-and-automate-what-matters-for-automation-teams-without-disrupting-operations/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/how-to-implement-process-mining-for-operations-discover-bottlenecks-and-automate-what-matters-for-automation-teams-without-disrupting-operations/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'How to implement Process Mining for Operations: Discover Bottlenecks and Automate What Matters for automation teams without disrupting operations' }]} className="mb-8" />
