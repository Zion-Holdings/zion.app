...
<li><Link href="/blog/smart-contract-audit-2026-7859/">Smart Contract Audit 2026 7859</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
