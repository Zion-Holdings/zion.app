...
export const metadata = {
  ...
  description: 'Ai Driven Supply Chain Risk Management For Operations Leaders: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
    title: 'Ai Driven Supply Chain Risk Management For Operations Leaders',
    description: 'Ai Driven Supply Chain Risk Management For Operations Leaders: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
    url: 'https://ziontechgroup.com/blog/ai-driven-supply-chain-risk-management-for-operations-leaders',
    type: 'article',
  },
  alternates: {
    canonical: 'https://ziontechgroup.com/blog/ai-driven-supply-chain-risk-management-for-operations-leaders',
  },
};
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'Ai Driven Supply Chain Risk Management For Operations Leaders' }
          ]}
          className="mb-8"
        />
        ...
        <header className="mb-12">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Ai Driven Supply Chain Risk Management For Operations Leaders</h1>
          <p className="mt-4 text-lg text-slate-300">Ai Driven Supply Chain Risk Management For Operations Leaders requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
