...
export const metadata = {
  ...
  openGraph: {
    title: 'AI Network Detection and Response for Hybrid Infrastructures in 2026 checklist for IT and security leaders: 2026 Playbook',
    description: 'Network telemetry plus endpoint and identity signals',
    url: 'https://ziontechgroup.com/blog/ai-network-detection-and-response-for-hybrid-infrastructures-in-2026-checklist-for-it-and-security-leaders-2026-playbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-network-detection-and-response-for-hybrid-infrastructures-in-2026-checklist-for-it-and-security-leaders-2026-playbook/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Network Detection and Response for Hybrid Infrastructures in 2026 checklist for IT and security leaders: 2026 Playbook' }]} className="mb-8" />
