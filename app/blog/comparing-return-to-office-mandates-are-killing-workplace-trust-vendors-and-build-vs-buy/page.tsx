...
export const metadata = {
  ...
  openGraph: {
    title: 'Comparing Return-to-office mandates are killing workplace trust: vendors and build vs buy',
    description: 'Live web-researched high-intent buyer topic',
    url: 'https://ziontechgroup.com/blog/comparing-return-to-office-mandates-are-killing-workplace-trust-vendors-and-build-vs-buy/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/comparing-return-to-office-mandates-are-killing-workplace-trust-vendors-and-build-vs-buy/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Comparing Return-to-office mandates are killing workplace trust: vendors and build vs buy' }]} className="mb-8" />
