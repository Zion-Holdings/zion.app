...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Accessibility Compliance: implementation playbook | Zion Tech Group" description="Accessibility Compliance: implementation playbook" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/accessibility-compliance-implementation-playbook/" />
