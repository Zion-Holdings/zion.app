        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/data-warehouse-modernization-2026-329">Data Warehouse Modernization 2026 329</Link></li>
<li><Link href="/blog/event-driven-architecture-vendor-evaluation">Event Driven Architecture Vendor Evaluation</Link></li>
<li><Link href="/blog/data-analytics-platform-modern-enterprise-2026-74">Data Analytics Platform Modern Enterprise 2026 74</Link></li>
