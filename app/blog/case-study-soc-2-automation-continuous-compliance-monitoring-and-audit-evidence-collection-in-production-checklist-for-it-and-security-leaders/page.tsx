...
export const metadata = {
  ...
  openGraph: {
    title: 'Case study: SOC 2 Automation: Continuous Compliance Monitoring and Audit Evidence Collection in production checklist for IT and security leaders',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/case-study-soc-2-automation-continuous-compliance-monitoring-and-audit-evidence-collection-in-production-checklist-for-it-and-security-leaders/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/case-study-soc-2-automation-continuous-compliance-monitoring-and-audit-evidence-collection-in-production-checklist-for-it-and-security-leaders/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Case study: SOC 2 Automation: Continuous Compliance Monitoring and Audit Evidence Collection in production checklist for IT and security leaders' }]} className="mb-8" />
