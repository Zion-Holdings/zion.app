...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Database Migration Service: executive guide | Zion Tech Group" description="Database Migration Service: executive guide" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/database-migration-service-executive-guide/" />
