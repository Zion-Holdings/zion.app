...
export const metadata = {
  ...
  openGraph: {
    title: 'How to implement AI Customer Journey Analytics: From Click to Retention without disrupting operations: architecture, risks, and roadmap',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/how-to-implement-ai-customer-journey-analytics-from-click-to-retention-without-disrupting-operations-architecture-risks-and-roadmap/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/how-to-implement-ai-customer-journey-analytics-from-click-to-retention-without-disrupting-operations-architecture-risks-and-roadmap/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'How to implement AI Customer Journey Analytics: From Click to Retention without disrupting operations: architecture, risks, and roadmap' }]} className="mb-8" />
