        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/devops-gen-ai-cicd-2026-2746">Devops Gen Ai Cicd 2026 2746</Link></li>
<li><Link href="/blog/ai-performance-monitoring-2026-180">Ai Performance Monitoring 2026 180</Link></li>
<li><Link href="/blog/cloud-cost-optimization-checklist-2026-1106">Cloud Cost Optimization Checklist 2026 1106</Link></li>
