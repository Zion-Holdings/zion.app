...
export const metadata = {
  title: 'AI data analytics platform: policy, compliance, and vendor management | Zion Tech Group',
  description: 'AI data analytics platform: policy, compliance, and vendor management',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'AI data analytics platform: policy, compliance, and vendor management',
    description: 'AI data analytics platform: policy, compliance, and vendor management',
    url: 'https://ziontechgroup.com/blog/ai-data-analytics-platform-10/',
    type: 'article',
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI data analytics platform: policy, compliance, and vendor management' }]} className="mb-8" />
        <header className="mb-10">
          ...
          <p className="mt-4 text-lg text-slate-300">AI data analytics platform: policy, compliance, and vendor management</p>
