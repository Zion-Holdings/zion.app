...
export const metadata = {
  title: 'Policy as Code: starter template | Zion Tech Group',
  description: 'Policy as Code: starter template',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Policy as Code: starter template',
    description: 'Policy as Code: starter template',
    url: 'https://ziontechgroup.com/blog/policy-as-code-starter-template/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/policy-as-code-starter-template/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Policy as Code: starter template", "description": "Policy as Code: starter template", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:03:57Z", "dateModified": "2026-08-06T18:03:57Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/policy-as-code-starter-template/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Policy as Code: starter template' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Policy as Code: starter template</h1>
          <p className="mt-4 text-lg text-slate-300">Policy as Code: starter template</p>
