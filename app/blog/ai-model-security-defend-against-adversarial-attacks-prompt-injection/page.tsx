...
export const metadata = {
  ...
  description: 'AI Model Security: Defend Against Adversarial Attacks and Prompt Injection: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/blog/ai-model-security-defend-against-adversarial-attacks-prompt-injection',
  },
};
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'AI Model Security: Defend Against Adversarial Attacks and Prompt Injection' }
          ]}
          className="mb-8"
        />
        ...
        <header className="mb-12">
          ...
          <p className="mt-4 text-lg text-slate-300">AI Model Security: Defend Against Adversarial Attacks and Prompt Injection requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
