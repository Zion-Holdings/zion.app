...
export const metadata = {
  ...
  openGraph: {
    title: 'Case study: Disaster Recovery Automation: Tested Failover Across Multiple Cloud Regions for cloud teams in production',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/case-study-disaster-recovery-automation-tested-failover-across-multiple-cloud-regions-for-cloud-teams-in-production/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/case-study-disaster-recovery-automation-tested-failover-across-multiple-cloud-regions-for-cloud-teams-in-production/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Case study: Disaster Recovery Automation: Tested Failover Across Multiple Cloud Regions for cloud teams in production' }]} className="mb-8" />
