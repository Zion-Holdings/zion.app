...
export const metadata = {
  title: 'Multi Cloud Strategy: starter template | Zion Tech Group',
  description: 'Multi Cloud Strategy: starter template',
  keywords: ['cloud', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Multi Cloud Strategy: starter template',
    description: 'Multi Cloud Strategy: starter template',
    url: 'https://ziontechgroup.com/blog/multi-cloud-strategy-starter-template/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/multi-cloud-strategy-starter-template/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Multi Cloud Strategy: starter template", "description": "Multi Cloud Strategy: starter template", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:41:14Z", "dateModified": "2026-08-06T18:41:14Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/multi-cloud-strategy-starter-template/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Multi Cloud Strategy: starter template' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Multi Cloud Strategy: starter template</h1>
          <p className="mt-4 text-lg text-slate-300">Multi Cloud Strategy: starter template</p>
...
<li><Link href="/blog/platform-engineering-deployment-patterns">Platform Engineering Deployment Patterns</Link></li>
<li><Link href="/blog/devops-gen-ai-cicd-2026-6817">Devops Gen Ai Cicd 2026 6817</Link></li>
<li><Link href="/blog/policy-as-code-case-study">Policy As Code Case Study</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
