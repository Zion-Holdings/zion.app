...
export const metadata = {
  ...
  openGraph: {
    title: 'Cloud Cost Optimization: starter template | Zion Tech Group',
    description: 'Cloud Cost Optimization: starter template.',
    url: 'https://ziontechgroup.comapp/blog/cloud-cost-optimization-starter-template/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/cloud-cost-optimization-starter-template/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'Cloud Cost Optimization: starter template',
  description: 'Cloud Cost Optimization: starter template.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/cloud-cost-optimization-starter-template/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'Cloud Cost Optimization: starter template' },
      ]}
    >
