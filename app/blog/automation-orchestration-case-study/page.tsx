...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Automation Orchestration: case study", "description": "Automation Orchestration: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:12:53Z", "dateModified": "2026-08-04T16:12:53Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/automation-orchestration-case-study/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Automation Orchestration: case study' }]} className="mb-8" />
        <header className="mb-10">
          ...
          <p className="mt-4 text-lg text-slate-300">Automation Orchestration: case study</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/network-infrastructure-2026-844">Network Infrastructure 2026 844</Link></li>
<li><Link href="/blog/automated-ai-reporting-2026-2312">Automated Ai Reporting 2026 2312</Link></li>
<li><Link href="/blog/cloud-native-app-development-2026-1085">Cloud Native App Development 2026 1085</Link></li>
