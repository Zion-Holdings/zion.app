...
export const metadata = {
  ...
  openGraph: {
    title: 'Automation Orchestration: case study | Zion Tech Group',
    description: 'Automation Orchestration: case study.',
    url: 'https://ziontechgroup.comapp/blog/automation-orchestration-case-study/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/automation-orchestration-case-study/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'Automation Orchestration: case study',
  description: 'Automation Orchestration: case study.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/automation-orchestration-case-study/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'Automation Orchestration: case study' },
      ]}
    >
