...
export const metadata = {
  ...
  openGraph: {
    title: 'Common mistakes when rolling out Comparing Edge AI Deployment Patterns for Retail and Manufacturing: vendors and build vs buy',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/common-mistakes-when-rolling-out-comparing-edge-ai-deployment-patterns-for-retail-and-manufacturing-vendors-and-build-vs-buy/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/common-mistakes-when-rolling-out-comparing-edge-ai-deployment-patterns-for-retail-and-manufacturing-vendors-and-build-vs-buy/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Common mistakes when rolling out Comparing Edge AI Deployment Patterns for Retail and Manufacturing: vendors and build vs buy' }]} className="mb-8" />
