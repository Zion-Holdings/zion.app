...
export const metadata = {
  title: 'Process Automation: security and governance | Zion Tech Group',
  description: 'Process Automation: security and governance',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Process Automation: security and governance',
    description: 'Process Automation: security and governance',
    url: 'https://ziontechgroup.com/blog/process-automation-security-and-governance/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/process-automation-security-and-governance/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Process Automation: security and governance", "description": "Process Automation: security and governance", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T20:47:05Z", "dateModified": "2026-08-06T20:47:05Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/process-automation-security-and-governance/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Process Automation: security and governance' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Process Automation: security and governance</h1>
          <p className="mt-4 text-lg text-slate-300">Process Automation: security and governance</p>
...
<li><Link href="/blog/infrastructure-monitoring-vendor-evaluation">Infrastructure Monitoring Vendor Evaluation</Link></li>
