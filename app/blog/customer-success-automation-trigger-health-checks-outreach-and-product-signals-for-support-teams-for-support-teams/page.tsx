...
export const metadata = {
  ...
  openGraph: {
    title: 'Customer Success Automation: Trigger Health Checks, Outreach, and Product Signals for support teams for support teams',
    description: 'Health-based playbooks and intervention timing',
    url: 'https://ziontechgroup.com/blog/customer-success-automation-trigger-health-checks-outreach-and-product-signals-for-support-teams-for-support-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/customer-success-automation-trigger-health-checks-outreach-and-product-signals-for-support-teams-for-support-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Customer Success Automation: Trigger Health Checks, Outreach, and Product Signals for support teams for support teams' }]} className="mb-8" />
