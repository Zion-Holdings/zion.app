...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Brand Voice Guardian: case study", "description": "Brand Voice Guardian: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:11:36Z", "dateModified": "2026-08-04T16:11:36Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/brand-voice-guardian-case-study/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Brand Voice Guardian: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Brand Voice Guardian: case study</h1>
          <p className="mt-4 text-lg text-slate-300">Brand Voice Guardian: case study</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/ai-agent-tool-builder-2026-1617">Ai Agent Tool Builder 2026 1617</Link></li>
<li><Link href="/blog/api-gateway-management-2026-2136">Api Gateway Management 2026 2136</Link></li>
<li><Link href="/blog/ai-msp-security-compliance-2026-1184">Ai Msp Security Compliance 2026 1184</Link></li>
<li><Link href="/blog/cyber-threat-intelligence-2026-604">Cyber Threat Intelligence 2026 604</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
