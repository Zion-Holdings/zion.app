...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Brand Voice Guardian: case study | Zion Tech Group" description="Brand Voice Guardian: case study" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/brand-voice-guardian-case-study/" />
