...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Cyber Threat Intelligence: implementation playbook | Zion Tech Group" description="Cyber Threat Intelligence: implementation playbook" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/cyber-threat-intelligence-implementation-playbook/" />
