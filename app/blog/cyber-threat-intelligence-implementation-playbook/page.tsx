...
const jsonLd = {
  ...
  '@type': 'TechArticle',
  headline: 'Cyber Threat Intelligence: implementation playbook',
  description: 'Cyber Threat Intelligence: implementation playbook.',
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'Cyber Threat Intelligence: implementation playbook' },
      ]}
    >
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <section className="prose prose-invert max-w-none">
          ...
          <p className="text-slate-300 mb-6">Cyber Threat Intelligence: implementation playbook. Organizations benefit from clearer requirements, tighter governance, and repeatable delivery models.</p>
