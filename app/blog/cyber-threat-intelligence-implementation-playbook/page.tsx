        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/ai-bdr-sdr-2026-935">Ai Bdr Sdr 2026 935</Link></li>
<li><Link href="/blog/ai-ad-copy-generator-2026-4237">Ai Ad Copy Generator 2026 4237</Link></li>
<li><Link href="/blog/smart-contract-audit-2026-4271">Smart Contract Audit 2026 4271</Link></li>
<li><Link href="/blog/automation-orchestration-enterprise-2026-2835">Automation Orchestration Enterprise 2026 2835</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
