...
export const metadata = {
  ...
  openGraph: {
    title: 'Automation and scaling patterns for Comparing AI SOC Modernization for MSSPs in 2026: vendors and build vs buy',
    description: 'MSSP-specific playbook with tooling comparisons',
    url: 'https://ziontechgroup.com/blog/automation-and-scaling-patterns-for-comparing-ai-soc-modernization-for-mssps-in-2026-vendors-and-build-vs-buy/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/automation-and-scaling-patterns-for-comparing-ai-soc-modernization-for-mssps-in-2026-vendors-and-build-vs-buy/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Automation and scaling patterns for Comparing AI SOC Modernization for MSSPs in 2026: vendors and build vs buy' }]} className="mb-8" />
