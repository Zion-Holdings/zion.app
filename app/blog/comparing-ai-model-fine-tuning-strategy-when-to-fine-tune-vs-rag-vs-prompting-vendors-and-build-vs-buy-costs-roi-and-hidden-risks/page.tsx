...
export const metadata = {
  ...
  openGraph: {
    title: 'Comparing AI Model Fine-Tuning Strategy: When to Fine-Tune vs. RAG vs. Prompting: vendors and build vs buy: costs, ROI, and hidden risks',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/comparing-ai-model-fine-tuning-strategy-when-to-fine-tune-vs-rag-vs-prompting-vendors-and-build-vs-buy-costs-roi-and-hidden-risks/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/comparing-ai-model-fine-tuning-strategy-when-to-fine-tune-vs-rag-vs-prompting-vendors-and-build-vs-buy-costs-roi-and-hidden-risks/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Comparing AI Model Fine-Tuning Strategy: When to Fine-Tune vs. RAG vs. Prompting: vendors and build vs buy: costs, ROI, and hidden risks' }]} className="mb-8" />
