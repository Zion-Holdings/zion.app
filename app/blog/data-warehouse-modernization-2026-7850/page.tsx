...
export const metadata = {
  ...
  alternates: { canonical: '/blog/data-warehouse-modernization-2026-7850/' },
  openGraph: { title: 'Data Warehouse Modernization', description: 'Practical guide to data warehouse modernization.', url: 'https://ziontechgroup.com/blog/data-warehouse-modernization-2026-7850/', type: 'article' },
...
export default function Page() {
  return (
    <PageShell title="Data Warehouse Modernization" description="Practical guide to data warehouse modernization: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/data-warehouse-modernization-2026-7850/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/data-warehouse-modernization-2026-7850/'
    }}>
