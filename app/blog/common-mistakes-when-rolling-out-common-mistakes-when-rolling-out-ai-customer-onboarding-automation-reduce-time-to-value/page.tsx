...
export const metadata = {
  ...
  openGraph: {
    title: 'Common mistakes when rolling out Common mistakes when rolling out AI Customer Onboarding Automation: Reduce Time-to-Value',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/common-mistakes-when-rolling-out-common-mistakes-when-rolling-out-ai-customer-onboarding-automation-reduce-time-to-value/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/common-mistakes-when-rolling-out-common-mistakes-when-rolling-out-ai-customer-onboarding-automation-reduce-time-to-value/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Common mistakes when rolling out Common mistakes when rolling out AI Customer Onboarding Automation: Reduce Time-to-Value' }]} className="mb-8" />
