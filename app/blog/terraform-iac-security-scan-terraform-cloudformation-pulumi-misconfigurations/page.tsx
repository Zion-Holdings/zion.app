...
export const metadata = {
  ...
  description: 'Terraform and IaC Security: Scan Terraform, CloudFormation, and Pulumi for Misconfigurations: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/blog/terraform-iac-security-scan-terraform-cloudformation-pulumi-misconfigurations',
  },
};
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'Terraform and IaC Security: Scan Terraform, CloudFormation, and Pulumi for Misconfigurations' }
          ]}
          className="mb-8"
        />
        ...
        <header className="mb-12">
          ...
          <p className="mt-4 text-lg text-slate-300">Terraform and IaC Security: Scan Terraform, CloudFormation, and Pulumi Misconfigurations requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
