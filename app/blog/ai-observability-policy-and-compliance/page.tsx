...
export const metadata = {
  title: 'AI Observability: policy and compliance | Zion Tech Group',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AI Observability: policy and compliance", "description": "AI Observability: policy and compliance", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T14:13:05Z", "dateModified": "2026-08-04T14:13:05Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ai-observability-policy-and-compliance/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Observability: policy and compliance' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AI Observability: policy and compliance</h1>
          <p className="mt-4 text-lg text-slate-300">AI Observability: policy and compliance</p>
...
<li><Link href="/blog/smart-contract-audit-2026-269">Smart Contract Audit 2026 269</Link></li>
