        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/computer-vision-for-retail-shelf-monitoring-foot-traffic-and-loss-prevention-checklist-for-it-and-security-leaders">Computer Vision For Retail Shelf Monitoring Foot Traffic And Loss Prevention Checklist For It And Security Leaders</Link></li><li><Link href="/blog/time-series-analytics-for-iot-ingest-store-and-query-sensor-data-at-scale-checklist-for-it-and-security-leaders">Time Series Analytics For Iot Ingest Store And Query Sensor Data At Scale Checklist For It And Security Leaders</Link></li><li><Link href="/blog/ai-support-outsourcing-roi-enterprise">Ai Support Outsourcing Roi Enterprise</Link></li><li><Link href="/blog/customer-success-automation-trigger-health-checks-outreach-and-product-signals-for-support-teams">Customer Success Automation Trigger Health Checks Outreach And Product Signals For Support Teams</Link></li>
              ...
              <li><Link href="/blog/comparing-slo-driven-development-set-error-budgets-and-build-features-without-breaking-reliability-vendors-and-build-vs-buy">Comparing Slo Driven Development Set Error Budgets And Build Features Without Breaking Reliability Vendors And Build Vs Buy</Link></li>
