...
export const metadata = {
  title: 'Threat Hunting: executive guide | Zion Tech Group',
  description: 'Threat Hunting: executive guide',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Threat Hunting: executive guide',
    description: 'Threat Hunting: executive guide',
    url: 'https://ziontechgroup.com/blog/threat-hunting-executive-guide/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/threat-hunting-executive-guide/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Threat Hunting: executive guide", "description": "Threat Hunting: executive guide", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T19:54:36Z", "dateModified": "2026-08-06T19:54:36Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/threat-hunting-executive-guide/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Threat Hunting: executive guide' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Threat Hunting: executive guide</h1>
          <p className="mt-4 text-lg text-slate-300">Threat Hunting: executive guide</p>
...
<li><Link /blog/cloud-optimization-automation-roadmap/>Cloud Optimization Automation Roadmap</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
