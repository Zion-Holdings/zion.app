...
export const metadata = {
  title: 'API Security Testing: case study | Zion Tech Group',
  description: 'API Security Testing: case study',
  keywords: ['ai', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'API Security Testing: case study',
    description: 'API Security Testing: case study',
    url: 'https://ziontechgroup.com/blog/api-security-testing-case-study/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/api-security-testing-case-study/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "API Security Testing: case study", "description": "API Security Testing: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:26:40Z", "dateModified": "2026-08-04T16:26:40Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/api-security-testing-case-study/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'API Security Testing: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">API Security Testing: case study</h1>
          <p className="mt-4 text-lg text-slate-300">API Security Testing: case study</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/endpoint-management-2026-748">Endpoint Management 2026 748</Link></li>
<li><Link href="/blog/api-integration-2026-2735">Api Integration 2026 2735</Link></li>
<li><Link href="/blog/ai-development-acceleration-2026-3596">Ai Development Acceleration 2026 3596</Link></li>
<li><Link href="/blog/ai-email-intelligence-2026-3526">Ai Email Intelligence 2026 3526</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
