...
export const metadata = {
  ...
  openGraph: {
    title: 'IT Consulting: vendor evaluation',
    description: 'IT Consulting: vendor evaluation - AI and IT insights from Zion Tech Group.',
    url: 'https://ziontechgroup.com/blog/it-consulting-2026/2026/2026/vendor-evaluation/',
    type: 'article',
  },
  alternates: { canonical: '/blog/it-consulting-2026/2026/2026/vendor-evaluation/' },
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'IT Consulting: vendor evaluation' },
      ]}
    >
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <header className="mb-10">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">IT Consulting: vendor evaluation | Zion Tech Group</h1>
