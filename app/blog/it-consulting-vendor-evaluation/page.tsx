...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="IT Consulting: vendor evaluation | Zion Tech Group" description="IT Consulting: vendor evaluation" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/it-consulting-vendor-evaluation/" />
