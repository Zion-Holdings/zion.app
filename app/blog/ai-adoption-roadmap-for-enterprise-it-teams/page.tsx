...
export const metadata = {
  ...
  openGraph: { title: 'AI adoption roadmap for enterprise IT teams', description: 'From pilot to production with governance, training, and KPI tracking.', url: 'https://ziontechgroup.com/blog/ai-adoption-roadmap-for-enterprise-it-teams/', type: 'website' },
  ...
  return (
    <main className="min-h-screen bg-slate-950">
      <div className="container-page py-20">
        <h1 className="text-4xl font-bold text-white mb-4 text-center">AI adoption roadmap for enterprise IT teams</h1>
        <p className="text-xl text-slate-300 mb-10 max-w-3xl mx-auto text-center">From pilot to production with governance, training, and KPI tracking.</p>
        
        <article className="max-w-3xl mx-auto space-y-6 text-slate-300">
          <p>From pilot to production with governance, training, and KPI tracking.</p>
      ...
      <JsonLd data={{
        ...
        keywords: 'AI adoption, enterprise AI, IT transformation',
