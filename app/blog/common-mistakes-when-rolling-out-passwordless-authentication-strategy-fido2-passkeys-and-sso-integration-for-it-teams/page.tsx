...
export const metadata = {
  ...
  openGraph: {
    title: 'Common mistakes when rolling out Passwordless Authentication Strategy: FIDO2, Passkeys, and SSO Integration for it teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/common-mistakes-when-rolling-out-passwordless-authentication-strategy-fido2-passkeys-and-sso-integration-for-it-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/common-mistakes-when-rolling-out-passwordless-authentication-strategy-fido2-passkeys-and-sso-integration-for-it-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Common mistakes when rolling out Passwordless Authentication Strategy: FIDO2, Passkeys, and SSO Integration for it teams' }]} className="mb-8" />
