...
export const metadata = {
  ...
  openGraph: {
    title: '2026 buyer's guide to Comparing Passwordless Authentication Strategy: FIDO2, Passkeys, and SSO Integration: vendors and build vs buy',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/2026-buyer-s-guide-to-comparing-passwordless-authentication-strategy-fido2-passkeys-and-sso-integration-vendors-and-build-vs-buy/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/2026-buyer-s-guide-to-comparing-passwordless-authentication-strategy-fido2-passkeys-and-sso-integration-vendors-and-build-vs-buy/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: '2026 buyer's guide to Comparing Passwordless Authentication Strategy: FIDO2, Passkeys, and SSO Integration: vendors and build vs buy' }]} className="mb-8" />
