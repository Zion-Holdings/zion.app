...
export const metadata = {
  title: 'Azure Migration: starter template | Zion Tech Group',
  description: 'Azure Migration: starter template',
  keywords: ['cloud', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Azure Migration: starter template',
    description: 'Azure Migration: starter template',
    url: 'https://ziontechgroup.com/blog/azure-migration-starter-template/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/azure-migration-starter-template/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Azure Migration: starter template", "description": "Azure Migration: starter template", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:11:44Z", "dateModified": "2026-08-06T18:11:44Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/azure-migration-starter-template/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Azure Migration: starter template' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Azure Migration: starter template</h1>
          <p className="mt-4 text-lg text-slate-300">Azure Migration: starter template</p>
