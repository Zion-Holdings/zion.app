...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI BOM Procurement: policy and compliance | Zion Tech Group" description="AI BOM Procurement: policy and compliance" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-bom-procurement-policy-and-compliance/" />
