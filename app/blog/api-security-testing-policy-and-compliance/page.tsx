...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "API Security Testing: policy and compliance", "description": "API Security Testing: policy and compliance", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:14:04Z", "dateModified": "2026-08-04T16:14:04Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/api-security-testing-policy-and-compliance/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'API Security Testing: policy and compliance' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">API Security Testing: policy and compliance</h1>
          <p className="mt-4 text-lg text-slate-300">API Security Testing: policy and compliance</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/ai-api-gateway-2026-4274">Ai Api Gateway 2026 4274</Link></li>
<li><Link href="/blog/event-driven-architecture-2026-2476">Event Driven Architecture 2026 2476</Link></li>
<li><Link href="/blog/cloud-cost-ai-optimizer-2026-3084">Cloud Cost Ai Optimizer 2026 3084</Link></li>
<li><Link href="/blog/etl-pipeline-optimization-2026-1992">Etl Pipeline Optimization 2026 1992</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
