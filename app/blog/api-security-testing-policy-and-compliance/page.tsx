...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="API Security Testing: policy and compliance | Zion Tech Group" description="API Security Testing: policy and compliance" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/api-security-testing-policy-and-compliance/" />
