...
export const metadata = {
  ...
  openGraph: {
    title: 'Data Warehouse Modernization: deployment patterns | Zion Tech Group',
    description: 'Data Warehouse Modernization: deployment patterns.',
    url: 'https://ziontechgroup.comapp/blog/data-warehouse-modernization-deployment-patterns/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/data-warehouse-modernization-deployment-patterns/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'Data Warehouse Modernization: deployment patterns',
  description: 'Data Warehouse Modernization: deployment patterns.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/data-warehouse-modernization-deployment-patterns/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'Data Warehouse Modernization: deployment patterns' },
      ]}
    >
