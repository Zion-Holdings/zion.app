...
export const metadata = {
  title: 'Policy as Code: automation roadmap | Zion Tech Group',
  description: 'Policy as Code: automation roadmap',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Policy as Code: automation roadmap',
    description: 'Policy as Code: automation roadmap',
    url: 'https://ziontechgroup.com/blog/policy-as-code-automation-roadmap/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/policy-as-code-automation-roadmap/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Policy as Code: automation roadmap", "description": "Policy as Code: automation roadmap", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:11:19Z", "dateModified": "2026-08-06T18:11:19Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/policy-as-code-automation-roadmap/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Policy as Code: automation roadmap' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Policy as Code: automation roadmap</h1>
          <p className="mt-4 text-lg text-slate-300">Policy as Code: automation roadmap</p>
...
<li><Link href="/blog/api-economy-security-and-governance">Api Economy Security And Governance</Link></li>
<li><Link href="/blog/saas-security-vendor-evaluation">Saas Security Vendor Evaluation</Link></li>
<li><Link href="/blog/error-budget-common-mistakes">Error Budget Common Mistakes</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
