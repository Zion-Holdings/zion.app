...
export const metadata = {
  title: 'Database Performance: operations handbook | Zion Tech Group',
  description: 'Database Performance: operations handbook',
  keywords: ['data', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Database Performance: operations handbook',
    description: 'Database Performance: operations handbook',
    url: 'https://ziontechgroup.com/blog/database-performance-operations-handbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/database-performance-operations-handbook/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Database Performance: operations handbook", "description": "Database Performance: operations handbook", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:12:42Z", "dateModified": "2026-08-06T18:12:42Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/database-performance-operations-handbook/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Database Performance: operations handbook' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Database Performance: operations handbook</h1>
          <p className="mt-4 text-lg text-slate-300">Database Performance: operations handbook</p>
