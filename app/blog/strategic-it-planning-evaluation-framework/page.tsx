...
export const metadata = {
  title: 'Strategic IT Planning: evaluation framework | Zion Tech Group',
  description: 'Strategic IT Planning: evaluation framework',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Strategic IT Planning: evaluation framework',
    description: 'Strategic IT Planning: evaluation framework',
    url: 'https://ziontechgroup.com/blog/strategic-it-planning-evaluation-framework/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/strategic-it-planning-evaluation-framework/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Strategic IT Planning: evaluation framework", "description": "Strategic IT Planning: evaluation framework", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:06:50Z", "dateModified": "2026-08-06T18:06:50Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/strategic-it-planning-evaluation-framework/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Strategic IT Planning: evaluation framework' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Strategic IT Planning: evaluation framework</h1>
          <p className="mt-4 text-lg text-slate-300">Strategic IT Planning: evaluation framework</p>
