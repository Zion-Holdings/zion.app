...
export const metadata = {
  ...
  openGraph: {
    title: 'Cloud Security Compliance 2026: costs, ROI, and hidden risks',
    description: 'Web-researched high-intent buyer topic',
    url: 'https://ziontechgroup.com/blog/cloud-security-compliance-2026-costs-roi-and-hidden-risks/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/cloud-security-compliance-2026-costs-roi-and-hidden-risks/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Cloud Security Compliance 2026: costs, ROI, and hidden risks' }]} className="mb-8" />
