...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="APM Application Performance: starter template | Zion Tech Group" description="APM Application Performance: starter template" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/apm-application-performance-starter-template/" />
