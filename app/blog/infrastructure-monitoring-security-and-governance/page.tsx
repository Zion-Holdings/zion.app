...
export const metadata = {
  title: 'Infrastructure Monitoring: security and governance | Zion Tech Group',
  description: 'Infrastructure Monitoring: security and governance',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Infrastructure Monitoring: security and governance',
    description: 'Infrastructure Monitoring: security and governance',
    url: 'https://ziontechgroup.com/blog/infrastructure-monitoring-security-and-governance/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/infrastructure-monitoring-security-and-governance/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Infrastructure Monitoring: security and governance", "description": "Infrastructure Monitoring: security and governance", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:53:57Z", "dateModified": "2026-08-06T18:53:57Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/infrastructure-monitoring-security-and-governance/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Infrastructure Monitoring: security and governance' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Infrastructure Monitoring: security and governance</h1>
          <p className="mt-4 text-lg text-slate-300">Infrastructure Monitoring: security and governance</p>
...
<li><Link href="/blog/ai-process-mining-vendor-evaluation">Ai Process Mining Vendor Evaluation</Link></li>
<li><Link href="/blog/api-versioning-case-study">Api Versioning Case Study</Link></li>
