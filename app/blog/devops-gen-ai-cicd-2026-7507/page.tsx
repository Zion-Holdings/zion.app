...
export default function Page() {
  return (
    <PageShell title="GenAI DevOps CI/CD" description="Practical guide to genai devops ci/cd: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/devops-gen-ai-cicd-2026-7507/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/devops-gen-ai-cicd-2026-7507/'
    }}>
