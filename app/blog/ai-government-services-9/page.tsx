...
export const metadata = {
  title: 'Automation and scaling patterns for AI government services | Zion Tech Group',
  description: 'Automation and scaling patterns for AI government services',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Automation and scaling patterns for AI government services',
    description: 'Automation and scaling patterns for AI government services',
    url: 'https://ziontechgroup.com/blog/ai-government-services-9/',
    type: 'article',
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Automation and scaling patterns for AI government services' }]} className="mb-8" />
        <header className="mb-10">
          ...
          <p className="mt-4 text-lg text-slate-300">Automation and scaling patterns for AI government services</p>
