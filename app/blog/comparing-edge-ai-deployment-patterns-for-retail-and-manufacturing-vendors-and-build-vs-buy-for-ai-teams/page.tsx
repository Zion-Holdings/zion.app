...
export const metadata = {
  ...
  openGraph: {
    title: 'Comparing Edge AI Deployment Patterns for Retail and Manufacturing: vendors and build vs buy for ai teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/comparing-edge-ai-deployment-patterns-for-retail-and-manufacturing-vendors-and-build-vs-buy-for-ai-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/comparing-edge-ai-deployment-patterns-for-retail-and-manufacturing-vendors-and-build-vs-buy-for-ai-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Comparing Edge AI Deployment Patterns for Retail and Manufacturing: vendors and build vs buy for ai teams' }]} className="mb-8" />
