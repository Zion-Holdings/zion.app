...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Chaos Engineering: architecture overview | Zion Tech Group" description="Chaos Engineering: architecture overview" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/chaos-engineering-architecture-overview/" />
