...
export const metadata = {
  title: 'AI Voice Assistant: starter template | Zion Tech Group',
  description: 'AI Voice Assistant: starter template',
  keywords: ['ai', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'AI Voice Assistant: starter template',
    description: 'AI Voice Assistant: starter template',
    url: 'https://ziontechgroup.com/blog/ai-voice-assistant-starter-template/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-voice-assistant-starter-template/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AI Voice Assistant: starter template", "description": "AI Voice Assistant: starter template", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:03:38Z", "dateModified": "2026-08-06T18:03:38Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ai-voice-assistant-starter-template/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Voice Assistant: starter template' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AI Voice Assistant: starter template</h1>
          <p className="mt-4 text-lg text-slate-300">AI Voice Assistant: starter template</p>
