...
export const metadata = {
  title: 'Test Automation: architecture overview | Zion Tech Group',
  description: 'Test Automation: architecture overview',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Test Automation: architecture overview',
    description: 'Test Automation: architecture overview',
    url: 'https://ziontechgroup.com/blog/test-automation-architecture-overview/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/test-automation-architecture-overview/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Test Automation: architecture overview", "description": "Test Automation: architecture overview", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:07:15Z", "dateModified": "2026-08-06T18:07:15Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/test-automation-architecture-overview/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Test Automation: architecture overview' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Test Automation: architecture overview</h1>
          <p className="mt-4 text-lg text-slate-300">Test Automation: architecture overview</p>
