...
export default function Page() {
  return (
    <PageShell title="API Performance Testing" description="Practical guide to api performance testing: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/api-performance-testing-2026-8002/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/api-performance-testing-2026-8002/'
    }}>
