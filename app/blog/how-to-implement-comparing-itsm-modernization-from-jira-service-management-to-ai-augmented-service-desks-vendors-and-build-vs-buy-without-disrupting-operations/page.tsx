...
export const metadata = {
  ...
  openGraph: {
    title: 'How to implement Comparing ITSM Modernization: From Jira Service Management to AI-Augmented Service Desks: vendors and build vs buy without disrupting operations',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/how-to-implement-comparing-itsm-modernization-from-jira-service-management-to-ai-augmented-service-desks-vendors-and-build-vs-buy-without-disrupting-operations/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/how-to-implement-comparing-itsm-modernization-from-jira-service-management-to-ai-augmented-service-desks-vendors-and-build-vs-buy-without-disrupting-operations/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'How to implement Comparing ITSM Modernization: From Jira Service Management to AI-Augmented Service Desks: vendors and build vs buy without disrupting operations' }]} className="mb-8" />
