...
export const metadata = {
  title: 'API Design: deployment patterns | Zion Tech Group',
  description: 'API Design: deployment patterns',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'API Design: deployment patterns',
    description: 'API Design: deployment patterns',
    url: 'https://ziontechgroup.com/blog/api-design-deployment-patterns/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/api-design-deployment-patterns/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "API Design: deployment patterns", "description": "API Design: deployment patterns", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:01:51Z", "dateModified": "2026-08-06T18:01:51Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/api-design-deployment-patterns/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'API Design: deployment patterns' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">API Design: deployment patterns</h1>
          <p className="mt-4 text-lg text-slate-300">API Design: deployment patterns</p>
...
<li><Link href="/blog/voice-biometrics-2026">Voice Biometrics 2026</Link></li>
