...
export const metadata = {
  ...
  openGraph: {
    title: 'ITSM Modernization: From Jira Service Management to AI-Augmented Service Desks: 2026 Playbook: architecture, risks, and roadmap',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/itsm-modernization-from-jira-service-management-to-ai-augmented-service-desks-2026-playbook-architecture-risks-and-roadmap/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/itsm-modernization-from-jira-service-management-to-ai-augmented-service-desks-2026-playbook-architecture-risks-and-roadmap/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'ITSM Modernization: From Jira Service Management to AI-Augmented Service Desks: 2026 Playbook: architecture, risks, and roadmap' }]} className="mb-8" />
