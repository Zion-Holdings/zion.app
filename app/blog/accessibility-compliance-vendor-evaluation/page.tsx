...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Accessibility Compliance: vendor evaluation | Zion Tech Group" description="Accessibility Compliance: vendor evaluation" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/accessibility-compliance-vendor-evaluation/" />
