...
export const metadata = {
  title: 'Accessibility compliance vendor evaluation | Zion Tech Group',
  description: 'Accessibility compliance vendor evaluation',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Accessibility compliance vendor evaluation',
    description: 'Accessibility compliance vendor evaluation',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Accessibility compliance vendor evaluation", "description": "Accessibility compliance vendor evaluation", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T14:12:12Z", "dateModified": "2026-08-04T14:12:12Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/accessibility-compliance-vendor-evaluation/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Accessibility compliance vendor evaluation' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Accessibility compliance vendor evaluation</h1>
          <p className="mt-4 text-lg text-slate-300">Accessibility compliance vendor evaluation</p>
