...
export const metadata = {
  title: 'Cloud Optimization: architecture overview | Zion Tech Group',
  description: 'Cloud Optimization: architecture overview',
  keywords: ['cloud', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Cloud Optimization: architecture overview',
    description: 'Cloud Optimization: architecture overview',
    url: 'https://ziontechgroup.com/blog/cloud-optimization-architecture-overview/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/cloud-optimization-architecture-overview/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Cloud Optimization: architecture overview", "description": "Cloud Optimization: architecture overview", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:08:41Z", "dateModified": "2026-08-06T18:08:41Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/cloud-optimization-architecture-overview/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Cloud Optimization: architecture overview' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Cloud Optimization: architecture overview</h1>
          <p className="mt-4 text-lg text-slate-300">Cloud Optimization: architecture overview</p>
