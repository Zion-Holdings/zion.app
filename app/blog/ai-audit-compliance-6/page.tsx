...
export const metadata = {
  title: 'Case study: AI audit compliance in production | Zion Tech Group',
  description: 'Case study: AI audit compliance in production',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Case study: AI audit compliance in production',
    description: 'Case study: AI audit compliance in production',
    url: 'https://ziontechgroup.com/blog/ai-audit-compliance-6/',
    type: 'article',
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Case study: AI audit compliance in production' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Case study: AI audit compliance in production</h1>
          <p className="mt-4 text-lg text-slate-300">Case study: AI audit compliance in production</p>
