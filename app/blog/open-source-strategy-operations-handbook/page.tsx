...
export const metadata = {
  title: 'Open Source Strategy: operations handbook | Zion Tech Group',
  description: 'Open Source Strategy: operations handbook',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Open Source Strategy: operations handbook',
    description: 'Open Source Strategy: operations handbook',
    url: 'https://ziontechgroup.com/blog/open-source-strategy-operations-handbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/open-source-strategy-operations-handbook/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Open Source Strategy: operations handbook", "description": "Open Source Strategy: operations handbook", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:41:20Z", "dateModified": "2026-08-06T18:41:20Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/open-source-strategy-operations-handbook/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Open Source Strategy: operations handbook' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Open Source Strategy: operations handbook</h1>
          <p className="mt-4 text-lg text-slate-300">Open Source Strategy: operations handbook</p>
...
<li><Link href="/blog/cloud-cost-management-checklist-for-it-leaders">Cloud Cost Management Checklist For It Leaders</Link></li>
