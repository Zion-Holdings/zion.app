...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI MSP Security Compliance: starter template | Zion Tech Group" description="AI MSP Security Compliance: starter template" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-msp-security-compliance-starter-template/" />
