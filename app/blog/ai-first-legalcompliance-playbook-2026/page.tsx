    ...
    <div className="relative min-h-screen bg-slate-950">
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <div className="prose-invert max-w-none space-y-10">
          <section>
            <h2 className="mb-4 text-2xl font-bold text-white">Why Legal & Compliance is moving first</h2>
            <p className="mb-4 leading-relaxed text-slate-300">
              In 2026, legal & compliance organizations face pressure to do more with fewer resources.
            ...
            <ul className="mb-4 list-disc space-y-2 pl-6 text-slate-300">
              <li>80% contract review time reduction</li>
              <li>60% legal research savings</li>
          ...
          <section>
            ...
            <p className="mb-4 leading-relaxed text-slate-300">
              Start with workflows that are rule-heavy, data-rich, and time-sensitive. In legal & compliance,
          ...
          <section>
            ...
            <p className="mb-4 leading-relaxed text-slate-300">
              AI adoption without guardrails creates new risk. Legal & Compliance teams should set
        ...
        <div className="mt-16 rounded-3xl border border-purple-500/30 bg-gradient-to-r from-purple-900/40 via-fuchsia-900/30 to-pink-900/40 p-8 text-center shadow-2xl sm:p-12">
          <h2 className="text-2xl font-bold text-white sm:text-3xl">
            Ready to accelerate your Legal & Compliance AI roadmap?
          </h2>
