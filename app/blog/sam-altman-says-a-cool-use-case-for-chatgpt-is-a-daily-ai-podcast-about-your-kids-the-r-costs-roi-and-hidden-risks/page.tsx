...
export const metadata = {
  ...
  openGraph: {
    title: 'Sam Altman says a 'cool use case' for ChatGPT is a daily AI podcast about your kids. The r: costs, ROI, and hidden risks',
    description: 'Live web-researched high-intent buyer topic',
    url: 'https://ziontechgroup.com/blog/sam-altman-says-a-cool-use-case-for-chatgpt-is-a-daily-ai-podcast-about-your-kids-the-r-costs-roi-and-hidden-risks/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/sam-altman-says-a-cool-use-case-for-chatgpt-is-a-daily-ai-podcast-about-your-kids-the-r-costs-roi-and-hidden-risks/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Sam Altman says a 'cool use case' for ChatGPT is a daily AI podcast about your kids. The r: costs, ROI, and hidden risks' }]} className="mb-8" />
