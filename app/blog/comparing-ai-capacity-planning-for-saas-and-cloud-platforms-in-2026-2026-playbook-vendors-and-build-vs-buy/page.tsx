...
export const metadata = {
  ...
  openGraph: {
    title: 'Comparing AI Capacity Planning for SaaS and Cloud Platforms in 2026: 2026 Playbook: vendors and build vs buy',
    description: 'Demand forecasting and reservation optimization',
    url: 'https://ziontechgroup.com/blog/comparing-ai-capacity-planning-for-saas-and-cloud-platforms-in-2026-2026-playbook-vendors-and-build-vs-buy/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/comparing-ai-capacity-planning-for-saas-and-cloud-platforms-in-2026-2026-playbook-vendors-and-build-vs-buy/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Comparing AI Capacity Planning for SaaS and Cloud Platforms in 2026: 2026 Playbook: vendors and build vs buy' }]} className="mb-8" />
