...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Autonomous QA Engineering: case study", "description": "Autonomous QA Engineering: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:13:56Z", "dateModified": "2026-08-04T16:13:56Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/autonomous-qa-engineering-case-study/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Autonomous QA Engineering: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Autonomous QA Engineering: case study</h1>
          <p className="mt-4 text-lg text-slate-300">Autonomous QA Engineering: case study</p>
...
<li><Link href="/blog/cyber-threat-intelligence-2026-2122">Cyber Threat Intelligence 2026 2122</Link></li>
<li><Link href="/blog/ai-observability-2026-562">Ai Observability 2026 562</Link></li>
<li><Link href="/blog/devops-gen-ai-cicd-2026-3712">Devops Gen Ai Cicd 2026 3712</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
