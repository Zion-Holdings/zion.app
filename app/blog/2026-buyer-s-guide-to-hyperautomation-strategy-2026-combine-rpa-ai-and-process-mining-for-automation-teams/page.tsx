...
export const metadata = {
  ...
  openGraph: {
    title: '2026 buyer's guide to Hyperautomation Strategy 2026: Combine RPA, AI, and Process Mining for automation teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/2026-buyer-s-guide-to-hyperautomation-strategy-2026-combine-rpa-ai-and-process-mining-for-automation-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/2026-buyer-s-guide-to-hyperautomation-strategy-2026-combine-rpa-ai-and-process-mining-for-automation-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: '2026 buyer's guide to Hyperautomation Strategy 2026: Combine RPA, AI, and Process Mining for automation teams' }]} className="mb-8" />
