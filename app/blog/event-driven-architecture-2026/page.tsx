...
export const metadata = {
  ...
  openGraph: {
    ...
    description: 'Event Driven Architecture',
    url: 'https://ziontechgroup.com/blog/event-driven-architecture-2026/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/event-driven-architecture-2026/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Event Driven Architecture", "description": "Event Driven Architecture", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:11:43Z", "dateModified": "2026-08-04T16:11:43Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/event-driven-architecture-2026/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Event Driven Architecture' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Event Driven Architecture</h1>
          <p className="mt-4 text-lg text-slate-300">Event Driven Architecture</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/ai-bdr-sdr-2026-1211">Ai Bdr Sdr 2026 1211</Link></li>
<li><Link href="/blog/ai-ad-copy-generator-2026-3823">Ai Ad Copy Generator 2026 3823</Link></li>
<li><Link href="/blog/enterprise-backup-dr-2026-3716">Enterprise Backup Dr 2026 3716</Link></li>
