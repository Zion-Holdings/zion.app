...
export const metadata = {
  title: 'Technical Due Diligence: case study | Zion Tech Group',
  description: 'Technical Due Diligence: case study',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Technical Due Diligence: case study',
    description: 'Technical Due Diligence: case study',
    url: 'https://ziontechgroup.com/blog/technical-due-diligence-case-study/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/technical-due-diligence-case-study/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Technical Due Diligence: case study", "description": "Technical Due Diligence: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:02:14Z", "dateModified": "2026-08-06T18:02:14Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/technical-due-diligence-case-study/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Technical Due Diligence: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Technical Due Diligence: case study</h1>
          <p className="mt-4 text-lg text-slate-300">Technical Due Diligence: case study</p>
...
<li><Link /blog/event-driven-architecture-evaluation-framework/>Event Driven Architecture Evaluation Framework</Link></li>
<li><Link /blog/patch-management-starter-template/>Patch Management Starter Template</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
