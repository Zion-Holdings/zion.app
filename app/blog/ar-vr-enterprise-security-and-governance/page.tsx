...
export const metadata = {
  title: 'AR VR Enterprise: security and governance | Zion Tech Group',
  description: 'AR VR Enterprise: security and governance',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'AR VR Enterprise: security and governance',
    description: 'AR VR Enterprise: security and governance',
    url: 'https://ziontechgroup.com/blog/ar-vr-enterprise-security-and-governance/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ar-vr-enterprise-security-and-governance/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AR VR Enterprise: security and governance", "description": "AR VR Enterprise: security and governance", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:39:20Z", "dateModified": "2026-08-06T18:39:20Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ar-vr-enterprise-security-and-governance/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AR VR Enterprise: security and governance' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AR VR Enterprise: security and governance</h1>
          <p className="mt-4 text-lg text-slate-300">AR VR Enterprise: security and governance</p>
