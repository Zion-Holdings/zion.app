...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="API Security Testing: starter template | Zion Tech Group" description="API Security Testing: starter template" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/api-security-testing-starter-template/" />
