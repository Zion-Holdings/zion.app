...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Database Migration Service: case study | Zion Tech Group" description="Database Migration Service: case study" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/database-migration-service-case-study/" />
