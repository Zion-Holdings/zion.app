...
export const metadata = {
  ...
  openGraph: {
    title: 'Network Infrastructure: starter template | Zion Tech Group',
    description: 'Network Infrastructure: starter template.',
    url: 'https://ziontechgroup.comapp/blog/network-infrastructure-starter-template/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/network-infrastructure-starter-template/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'Network Infrastructure: starter template',
  description: 'Network Infrastructure: starter template.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/network-infrastructure-starter-template/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'Network Infrastructure: starter template' },
      ]}
    >
