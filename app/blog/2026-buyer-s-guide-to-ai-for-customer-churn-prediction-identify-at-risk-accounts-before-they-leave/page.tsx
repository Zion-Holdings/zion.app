...
export const metadata = {
  ...
  openGraph: {
    title: '2026 buyer's guide to AI for Customer Churn Prediction: Identify At-Risk Accounts Before They Leave',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/2026-buyer-s-guide-to-ai-for-customer-churn-prediction-identify-at-risk-accounts-before-they-leave/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/2026-buyer-s-guide-to-ai-for-customer-churn-prediction-identify-at-risk-accounts-before-they-leave/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: '2026 buyer's guide to AI for Customer Churn Prediction: Identify At-Risk Accounts Before They Leave' }]} className="mb-8" />
