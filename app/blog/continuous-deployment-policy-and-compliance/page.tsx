...
<li><Link /blog/resilience-engineering-architecture-overview/>Resilience Engineering Architecture Overview</Link></li>
<li><Link /blog/api-gateway-management-roi-and-cost-model/>Api Gateway Management Roi And Cost Model</Link></li>
<li><Link /blog/application-modernization-2026/>Application Modernization 2026</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
