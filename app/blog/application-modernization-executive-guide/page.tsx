...
export const metadata = {
  title: 'Application Modernization: executive guide | Zion Tech Group',
  description: 'Application Modernization: executive guide',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Application Modernization: executive guide',
    description: 'Application Modernization: executive guide',
    url: 'https://ziontechgroup.com/blog/application-modernization-executive-guide/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/application-modernization-executive-guide/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Application Modernization: executive guide", "description": "Application Modernization: executive guide", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:12:19Z", "dateModified": "2026-08-06T18:12:19Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/application-modernization-executive-guide/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Application Modernization: executive guide' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Application Modernization: executive guide</h1>
          <p className="mt-4 text-lg text-slate-300">Application Modernization: executive guide</p>
...
<li><Link href="/blog/finops-case-study">Finops Case Study</Link></li>
...
<li><Link href="/blog/technology-roadmap-implementation-playbook">Technology Roadmap Implementation Playbook</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
