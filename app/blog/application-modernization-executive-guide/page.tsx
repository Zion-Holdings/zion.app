...
<li><Link /blog/finops-case-study/>Finops Case Study</Link></li>
<li><Link /blog/ai-performance-monitoring-implementation-playbook/>Ai Performance Monitoring Implementation Playbook</Link></li>
<li><Link /blog/technology-roadmap-implementation-playbook/>Technology Roadmap Implementation Playbook</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
