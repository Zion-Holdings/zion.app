...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Accessibility Compliance: evaluation framework | Zion Tech Group" description="Accessibility Compliance: evaluation framework" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/accessibility-compliance-evaluation-framework/" />
