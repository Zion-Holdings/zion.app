...
export const metadata = {
  ...
  openGraph: {
    title: 'AI Incident Response Orchestration: Triage, Runbooks, and Chatops: costs, ROI, and hidden risks for observability teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/ai-incident-response-orchestration-triage-runbooks-and-chatops-costs-roi-and-hidden-risks-for-observability-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-incident-response-orchestration-triage-runbooks-and-chatops-costs-roi-and-hidden-risks-for-observability-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Incident Response Orchestration: Triage, Runbooks, and Chatops: costs, ROI, and hidden risks for observability teams' }]} className="mb-8" />
