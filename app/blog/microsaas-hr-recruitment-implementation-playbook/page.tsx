        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/micro-saas-ai-hr-recruitment-2026-2436">Micro Saas Ai Hr Recruitment 2026 2436</Link></li>
<li><Link href="/blog/ai-3d-asset-generator-2026-3889">Ai 3D Asset Generator 2026 3889</Link></li>
<li><Link href="/blog/ai-accessibility-optimizer-2026-372">Ai Accessibility Optimizer 2026 372</Link></li>
<li><Link href="/blog/apm-application-performance-2026-460">Apm Application Performance 2026 460</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
