...
return (
    <StandardPage
      ...
      hero={{ variant: 'none' }}
      breadcrumbItems={[{ label: 'Home', href: '/' }, { label: "Enterprise AI Intelligence Hub: vendor evaluation | Zion Tech Group" }]}
    >
...
<li><Link href="/blog/data-warehouse-modernization-2026-7919">Data Warehouse Modernization 2026 7919</Link></li>
