...
export const metadata = {
  title: 'Prompt Engineering: case study | Zion Tech Group',
  description: 'Prompt Engineering: case study',
  keywords: ['ai', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Prompt Engineering: case study',
    description: 'Prompt Engineering: case study',
    url: 'https://ziontechgroup.com/blog/prompt-engineering-case-study/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/prompt-engineering-case-study/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Prompt Engineering: case study", "description": "Prompt Engineering: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:27:59Z", "dateModified": "2026-08-06T18:27:59Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/prompt-engineering-case-study/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Prompt Engineering: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Prompt Engineering: case study</h1>
          <p className="mt-4 text-lg text-slate-300">Prompt Engineering: case study</p>
