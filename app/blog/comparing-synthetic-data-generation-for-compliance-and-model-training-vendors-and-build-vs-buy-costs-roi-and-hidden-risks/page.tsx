...
export const metadata = {
  ...
  openGraph: {
    title: 'Comparing Synthetic Data Generation for Compliance and Model Training: vendors and build vs buy: costs, ROI, and hidden risks',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/comparing-synthetic-data-generation-for-compliance-and-model-training-vendors-and-build-vs-buy-costs-roi-and-hidden-risks/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/comparing-synthetic-data-generation-for-compliance-and-model-training-vendors-and-build-vs-buy-costs-roi-and-hidden-risks/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Comparing Synthetic Data Generation for Compliance and Model Training: vendors and build vs buy: costs, ROI, and hidden risks' }]} className="mb-8" />
