...
export const metadata = {
  title: 'DevSecOps Pipeline: architecture overview | Zion Tech Group',
  description: 'DevSecOps Pipeline: architecture overview',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'DevSecOps Pipeline: architecture overview',
    description: 'DevSecOps Pipeline: architecture overview',
    url: 'https://ziontechgroup.com/blog/devsecops-pipeline-architecture-overview/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/devsecops-pipeline-architecture-overview/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "DevSecOps Pipeline: architecture overview", "description": "DevSecOps Pipeline: architecture overview", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T21:17:12Z", "dateModified": "2026-08-06T21:17:12Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/devsecops-pipeline-architecture-overview/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'DevSecOps Pipeline: architecture overview' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">DevSecOps Pipeline: architecture overview</h1>
          <p className="mt-4 text-lg text-slate-300">DevSecOps Pipeline: architecture overview</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/it-asset-management-evaluation-framework">It Asset Management Evaluation Framework</Link></li>
