        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/ai-customer-success-churn-2026-3670">Ai Customer Success Churn 2026 3670</Link></li>
<li><Link href="/blog/ai-autonomous-agents-2026-101">Ai Autonomous Agents 2026 101</Link></li>
<li><Link href="/blog/cybersecurity-platform-msp-2026-1797">Cybersecurity Platform Msp 2026 1797</Link></li>
<li><Link href="/blog/ai-development-acceleration-2026-2354">Ai Development Acceleration 2026 2354</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
