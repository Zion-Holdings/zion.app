...
export const metadata = {
  ...
  openGraph: {
    title: 'ETL Pipeline Optimization: starter template | Zion Tech Group',
    description: 'ETL Pipeline Optimization: starter template.',
    url: 'https://ziontechgroup.comapp/blog/etl-pipeline-optimization-starter-template/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/etl-pipeline-optimization-starter-template/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'ETL Pipeline Optimization: starter template',
  description: 'ETL Pipeline Optimization: starter template.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/etl-pipeline-optimization-starter-template/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'ETL Pipeline Optimization: starter template' },
      ]}
    >
