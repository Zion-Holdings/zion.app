...
export const metadata = {
  title: 'AI Meeting Assistant: common mistakes | Zion Tech Group',
  description: 'AI Meeting Assistant: common mistakes',
  keywords: ['ai', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'AI Meeting Assistant: common mistakes',
    description: 'AI Meeting Assistant: common mistakes',
    url: 'https://ziontechgroup.com/blog/ai-meeting-assistant-common-mistakes/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-meeting-assistant-common-mistakes/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AI Meeting Assistant: common mistakes", "description": "AI Meeting Assistant: common mistakes", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:23:52Z", "dateModified": "2026-08-06T18:23:52Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ai-meeting-assistant-common-mistakes/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Meeting Assistant: common mistakes' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AI Meeting Assistant: common mistakes</h1>
          <p className="mt-4 text-lg text-slate-300">AI Meeting Assistant: common mistakes</p>
