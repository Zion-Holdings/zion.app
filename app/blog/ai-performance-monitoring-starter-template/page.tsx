...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI Performance Monitoring: starter template | Zion Tech Group" description="AI Performance Monitoring: starter template" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-performance-monitoring-starter-template/" />
