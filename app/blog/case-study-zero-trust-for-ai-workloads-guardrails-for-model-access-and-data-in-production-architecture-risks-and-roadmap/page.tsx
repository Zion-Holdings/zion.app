...
export const metadata = {
  ...
  openGraph: {
    title: 'Case study: Zero Trust for AI Workloads: Guardrails for Model Access and Data in production: architecture, risks, and roadmap',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/case-study-zero-trust-for-ai-workloads-guardrails-for-model-access-and-data-in-production-architecture-risks-and-roadmap/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/case-study-zero-trust-for-ai-workloads-guardrails-for-model-access-and-data-in-production-architecture-risks-and-roadmap/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Case study: Zero Trust for AI Workloads: Guardrails for Model Access and Data in production: architecture, risks, and roadmap' }]} className="mb-8" />
