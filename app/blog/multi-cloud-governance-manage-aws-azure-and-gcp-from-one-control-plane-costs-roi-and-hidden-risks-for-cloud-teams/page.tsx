...
export const metadata = {
  ...
  openGraph: {
    title: 'Multi-Cloud Governance: Manage AWS, Azure, and GCP from One Control Plane: costs, ROI, and hidden risks for cloud teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/multi-cloud-governance-manage-aws-azure-and-gcp-from-one-control-plane-costs-roi-and-hidden-risks-for-cloud-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/multi-cloud-governance-manage-aws-azure-and-gcp-from-one-control-plane-costs-roi-and-hidden-risks-for-cloud-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Multi-Cloud Governance: Manage AWS, Azure, and GCP from One Control Plane: costs, ROI, and hidden risks for cloud teams' }]} className="mb-8" />
