...
export const metadata = {
  title: 'Service Mesh: executive guide | Zion Tech Group',
  description: 'Service Mesh: executive guide',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Service Mesh: executive guide',
    description: 'Service Mesh: executive guide',
    url: 'https://ziontechgroup.com/blog/service-mesh-executive-guide/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/service-mesh-executive-guide/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Service Mesh: executive guide", "description": "Service Mesh: executive guide", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:11:10Z", "dateModified": "2026-08-06T18:11:10Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/service-mesh-executive-guide/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Service Mesh: executive guide' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Service Mesh: executive guide</h1>
          <p className="mt-4 text-lg text-slate-300">Service Mesh: executive guide</p>
...
<li><Link href="/blog/incident-management-case-study">Incident Management Case Study</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
