...
export const metadata = {
  ...
  openGraph: {
    title: 'MicroSaaS HR Recruitment: deployment patterns | Zion Tech Group',
    description: 'MicroSaaS HR Recruitment: deployment patterns.',
    url: 'https://ziontechgroup.comapp/blog/microsaas-hr-recruitment-deployment-patterns/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/microsaas-hr-recruitment-deployment-patterns/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'MicroSaaS HR Recruitment: deployment patterns',
  description: 'MicroSaaS HR Recruitment: deployment patterns.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/microsaas-hr-recruitment-deployment-patterns/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'MicroSaaS HR Recruitment: deployment patterns' },
      ]}
    >
