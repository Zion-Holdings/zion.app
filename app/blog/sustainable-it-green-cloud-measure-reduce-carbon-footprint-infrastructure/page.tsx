...
export const metadata = {
  ...
  description: 'Sustainable IT and Green Cloud: Measure and Reduce Carbon Footprint of Infrastructure: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/blog/sustainable-it-green-cloud-measure-reduce-carbon-footprint-infrastructure',
  },
};
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'Sustainable IT and Green Cloud: Measure and Reduce Carbon Footprint of Infrastructure' }
          ]}
          className="mb-8"
        />
        ...
        <header className="mb-12">
          ...
          <p className="mt-4 text-lg text-slate-300">Sustainable IT and Green Cloud: Measure and Reduce Carbon Footprint of Infrastructure requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>

        <div className="prose-invert max-w-none space-y-10">
          <section>
            <h2 className="mb-4 text-2xl font-bold text-white">Where this adds value</h2>
            <p className="mb-4 leading-relaxed text-slate-300">Focus on execution clarity, outcome measurement, and operational discipline. Start with a small owned workflow, measure weekly, and expand only after the first workflow shows consistent improvement.</p>
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li>Reduce manual work tied to execution clarity without removing review checkpoints</li>
              <li>Create a repeatable baseline for outcome measurement before expanding automation</li>
              <li>Connect improvements to measurable operational discipline stakeholders can track</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mb-4 leading-relaxed text-slate-300">
              ...
              {' '}
              <Link href="/services" className="text-violet-300 underline">
                AI services
              </Link>
        ...
        <div className="mt-16 rounded-3xl border border-violet-500/30 bg-gradient-to-r from-violet-900/40 via-indigo-900/30 to-blue-900/40 p-8 text-center shadow-2xl sm:p-12">
          ...
          <div className="mt-8 flex flex-col justify-center gap-4 sm:flex-row">
            ...
            <Link href="/services" className="rounded-xl border border-white/30 px-6 py-3 text-sm font-semibold text-white transition hover:bg-white/10">
              AI services
            </Link>
          </div>
        </div>
