...
export const metadata = {
  ...
  openGraph: {
    title: 'Common mistakes when rolling out Case study: AI Desktop Support Automation for Enterprise IT in production',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/common-mistakes-when-rolling-out-case-study-ai-desktop-support-automation-for-enterprise-it-in-production/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/common-mistakes-when-rolling-out-case-study-ai-desktop-support-automation-for-enterprise-it-in-production/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Common mistakes when rolling out Case study: AI Desktop Support Automation for Enterprise IT in production' }]} className="mb-8" />
