...
export const metadata = {
  title: 'Cost Optimization: vendor evaluation | Zion Tech Group',
  description: 'Cost Optimization: vendor evaluation',
  keywords: ['cloud', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Cost Optimization: vendor evaluation',
    description: 'Cost Optimization: vendor evaluation',
    url: 'https://ziontechgroup.com/blog/cost-optimization-vendor-evaluation/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/cost-optimization-vendor-evaluation/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Cost Optimization: vendor evaluation", "description": "Cost Optimization: vendor evaluation", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:32:30Z", "dateModified": "2026-08-06T18:32:30Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/cost-optimization-vendor-evaluation/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Cost Optimization: vendor evaluation' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Cost Optimization: vendor evaluation</h1>
          <p className="mt-4 text-lg text-slate-300">Cost Optimization: vendor evaluation</p>
