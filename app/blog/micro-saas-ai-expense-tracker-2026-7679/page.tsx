...
export default function Page() {
  return (
    <PageShell title="MicroSaaS Expense Tracker" description="Practical guide to microsaas expense tracker: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/micro-saas-ai-expense-tracker-2026-7679/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/micro-saas-ai-expense-tracker-2026-7679/'
    }}>
