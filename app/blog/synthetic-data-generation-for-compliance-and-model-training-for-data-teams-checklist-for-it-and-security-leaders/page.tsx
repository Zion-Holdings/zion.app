...
export const metadata = {
  ...
  openGraph: {
    title: 'Synthetic Data Generation for Compliance and Model Training for data teams checklist for IT and security leaders',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/synthetic-data-generation-for-compliance-and-model-training-for-data-teams-checklist-for-it-and-security-leaders/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/synthetic-data-generation-for-compliance-and-model-training-for-data-teams-checklist-for-it-and-security-leaders/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Synthetic Data Generation for Compliance and Model Training for data teams checklist for IT and security leaders' }]} className="mb-8" />
