...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Chaos Engineering: implementation playbook | Zion Tech Group" description="Chaos Engineering: implementation playbook" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/chaos-engineering-implementation-playbook/" />
