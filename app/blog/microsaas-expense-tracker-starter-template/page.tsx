...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="MicroSaaS Expense Tracker: starter template | Zion Tech Group" description="MicroSaaS Expense Tracker: starter template" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/microsaas-expense-tracker-starter-template/" />
