...
export const metadata = {
  ...
  openGraph: {
    title: '2026 buyer's guide to Field Service AI Optimization: Predict Service Times and Optimize Technician Routes',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/2026-buyer-s-guide-to-field-service-ai-optimization-predict-service-times-and-optimize-technician-routes/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/2026-buyer-s-guide-to-field-service-ai-optimization-predict-service-times-and-optimize-technician-routes/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: '2026 buyer's guide to Field Service AI Optimization: Predict Service Times and Optimize Technician Routes' }]} className="mb-8" />
