...
<li><Link /blog/terraform-evaluation-framework/>Terraform Evaluation Framework</Link></li>
<li><Link /blog/cloud-migration-services-vendor-evaluation/>Cloud Migration Services Vendor Evaluation</Link></li>
<li><Link /blog/google-cloud-migration-starter-template/>Google Cloud Migration Starter Template</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
