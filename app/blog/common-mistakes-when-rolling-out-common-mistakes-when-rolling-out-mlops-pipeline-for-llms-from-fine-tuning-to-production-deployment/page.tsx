...
export const metadata = {
  ...
  openGraph: {
    title: 'Common mistakes when rolling out Common mistakes when rolling out MLOps Pipeline for LLMs: From Fine-Tuning to Production Deployment',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/common-mistakes-when-rolling-out-common-mistakes-when-rolling-out-mlops-pipeline-for-llms-from-fine-tuning-to-production-deployment/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/common-mistakes-when-rolling-out-common-mistakes-when-rolling-out-mlops-pipeline-for-llms-from-fine-tuning-to-production-deployment/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Common mistakes when rolling out Common mistakes when rolling out MLOps Pipeline for LLMs: From Fine-Tuning to Production Deployment' }]} className="mb-8" />
