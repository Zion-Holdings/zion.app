...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Cybersecurity for MSPs: case study | Zion Tech Group" description="Cybersecurity for MSPs: case study" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/cybersecurity-for-msps-case-study/" />
