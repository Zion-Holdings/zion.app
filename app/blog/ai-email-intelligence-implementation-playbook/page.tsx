...
export const metadata = {
  title: 'AI Email Intelligence: implementation playbook | Zion Tech Group',
  description: 'AI Email Intelligence: implementation playbook',
  keywords: ['data', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'AI Email Intelligence: implementation playbook',
    description: 'AI Email Intelligence: implementation playbook',
    url: 'https://ziontechgroup.com/blog/ai-email-intelligence-implementation-playbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-email-intelligence-implementation-playbook/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AI Email Intelligence: implementation playbook", "description": "AI Email Intelligence: implementation playbook", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T14:13:19Z", "dateModified": "2026-08-04T14:13:19Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ai-email-intelligence-implementation-playbook/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Email Intelligence: implementation playbook' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AI Email Intelligence: implementation playbook</h1>
          <p className="mt-4 text-lg text-slate-300">AI Email Intelligence: implementation playbook</p>
...
<li><Link href="/blog/brand-voice-guardian-2026-178">Brand Voice Guardian 2026 178</Link></li>
<li><Link href="/blog/cybersecurity-platform-msp-2026-15">Cybersecurity Platform Msp 2026 15</Link></li>
<li><Link href="/blog/cyber-threat-intelligence-2026-466">Cyber Threat Intelligence 2026 466</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
