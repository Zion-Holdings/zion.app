...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Smart Contract Audit: vendor evaluation | Zion Tech Group" description="Smart Contract Audit: vendor evaluation" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/smart-contract-audit-vendor-evaluation/" />
