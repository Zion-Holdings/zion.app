...
export const metadata = {
  ...
  openGraph: {
    title: 'Remote Work Enablement: Secure VPN Alternatives and Zero Trust Access checklist for IT and security leaders: costs, ROI, and hidden risks',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/remote-work-enablement-secure-vpn-alternatives-and-zero-trust-access-checklist-for-it-and-security-leaders-costs-roi-and-hidden-risks/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/remote-work-enablement-secure-vpn-alternatives-and-zero-trust-access-checklist-for-it-and-security-leaders-costs-roi-and-hidden-risks/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Remote Work Enablement: Secure VPN Alternatives and Zero Trust Access checklist for IT and security leaders: costs, ROI, and hidden risks' }]} className="mb-8" />
