...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Automation Orchestration: starter template | Zion Tech Group" description="Automation Orchestration: starter template" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/automation-orchestration-starter-template/" />
