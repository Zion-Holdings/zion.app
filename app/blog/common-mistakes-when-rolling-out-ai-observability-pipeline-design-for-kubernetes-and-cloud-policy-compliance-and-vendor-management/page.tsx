...
export const metadata = {
  ...
  openGraph: {
    title: 'Common mistakes when rolling out AI Observability Pipeline Design for Kubernetes and Cloud: policy, compliance, and vendor management',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/common-mistakes-when-rolling-out-ai-observability-pipeline-design-for-kubernetes-and-cloud-policy-compliance-and-vendor-management/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/common-mistakes-when-rolling-out-ai-observability-pipeline-design-for-kubernetes-and-cloud-policy-compliance-and-vendor-management/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Common mistakes when rolling out AI Observability Pipeline Design for Kubernetes and Cloud: policy, compliance, and vendor management' }]} className="mb-8" />
