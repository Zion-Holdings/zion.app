...
export const metadata = {
  ...
  openGraph: {
    title: 'Case study: Email and Calendar Automation: AI Agents That Schedule, Follow Up, and Summarize: 2026 Playbook in production',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/case-study-email-and-calendar-automation-ai-agents-that-schedule-follow-up-and-summarize-2026-playbook-in-production/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/case-study-email-and-calendar-automation-ai-agents-that-schedule-follow-up-and-summarize-2026-playbook-in-production/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Case study: Email and Calendar Automation: AI Agents That Schedule, Follow Up, and Summarize: 2026 Playbook in production' }]} className="mb-8" />
