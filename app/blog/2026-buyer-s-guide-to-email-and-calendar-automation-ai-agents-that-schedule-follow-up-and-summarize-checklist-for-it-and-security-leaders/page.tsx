...
export const metadata = {
  ...
  openGraph: {
    title: '2026 buyer's guide to Email and Calendar Automation: AI Agents That Schedule, Follow Up, and Summarize checklist for IT and security leaders',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/2026-buyer-s-guide-to-email-and-calendar-automation-ai-agents-that-schedule-follow-up-and-summarize-checklist-for-it-and-security-leaders/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/2026-buyer-s-guide-to-email-and-calendar-automation-ai-agents-that-schedule-follow-up-and-summarize-checklist-for-it-and-security-leaders/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: '2026 buyer's guide to Email and Calendar Automation: AI Agents That Schedule, Follow Up, and Summarize checklist for IT and security leaders' }]} className="mb-8" />
