...
<li><Link href="/blog/cloud-native-app-development-2026-257">Cloud Native App Development 2026 257</Link></li>
<li><Link href="/blog/graphql-federation-platform-2026-201">Graphql Federation Platform 2026 201</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
