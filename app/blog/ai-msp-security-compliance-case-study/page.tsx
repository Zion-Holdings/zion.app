        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/api-gateway-management-2026-1975">Api Gateway Management 2026 1975</Link></li>
<li><Link href="/blog/ai-bom-procurement-2026-2385">Ai Bom Procurement 2026 2385</Link></li>
<li><Link href="/blog/data-warehouse-modernization-2026-2261">Data Warehouse Modernization 2026 2261</Link></li>
<li><Link href="/blog/ai-msp-security-compliance-2026-1598">Ai Msp Security Compliance 2026 1598</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
