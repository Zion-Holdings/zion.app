...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI MSP Security Compliance: case study | Zion Tech Group" description="AI MSP Security Compliance: case study" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-msp-security-compliance-case-study/" />
