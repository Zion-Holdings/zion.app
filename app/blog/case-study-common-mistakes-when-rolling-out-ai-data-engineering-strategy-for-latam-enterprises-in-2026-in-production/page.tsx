...
export const metadata = {
  ...
  openGraph: {
    title: 'Case study: Common mistakes when rolling out AI Data Engineering Strategy for LATAM Enterprises in 2026 in production',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/case-study-common-mistakes-when-rolling-out-ai-data-engineering-strategy-for-latam-enterprises-in-2026-in-production/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/case-study-common-mistakes-when-rolling-out-ai-data-engineering-strategy-for-latam-enterprises-in-2026-in-production/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Case study: Common mistakes when rolling out AI Data Engineering Strategy for LATAM Enterprises in 2026 in production' }]} className="mb-8" />
