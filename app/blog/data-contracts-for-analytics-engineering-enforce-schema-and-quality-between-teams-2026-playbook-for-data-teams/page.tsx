...
export const metadata = {
  ...
  openGraph: {
    title: 'Data Contracts for Analytics Engineering: Enforce Schema and Quality Between Teams: 2026 Playbook for data teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/data-contracts-for-analytics-engineering-enforce-schema-and-quality-between-teams-2026-playbook-for-data-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/data-contracts-for-analytics-engineering-enforce-schema-and-quality-between-teams-2026-playbook-for-data-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Data Contracts for Analytics Engineering: Enforce Schema and Quality Between Teams: 2026 Playbook for data teams' }]} className="mb-8" />
