...
export const metadata = {
  ...
  openGraph: {
    title: 'Sustainable IT and Green Cloud: Measure and Reduce Carbon Footprint of Infrastructure: costs, ROI, and hidden risks: architecture, risks, and roadmap',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/sustainable-it-and-green-cloud-measure-and-reduce-carbon-footprint-of-infrastructure-costs-roi-and-hidden-risks-architecture-risks-and-roadmap/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/sustainable-it-and-green-cloud-measure-and-reduce-carbon-footprint-of-infrastructure-costs-roi-and-hidden-risks-architecture-risks-and-roadmap/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Sustainable IT and Green Cloud: Measure and Reduce Carbon Footprint of Infrastructure: costs, ROI, and hidden risks: architecture, risks, and roadmap' }]} className="mb-8" />
