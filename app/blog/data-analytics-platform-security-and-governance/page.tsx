...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Data Analytics Platform: security and governance", "description": "Data Analytics Platform: security and governance", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:13:22Z", "dateModified": "2026-08-04T16:13:22Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/data-analytics-platform-security-and-governance/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Data Analytics Platform: security and governance' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Data Analytics Platform: security and governance</h1>
          <p className="mt-4 text-lg text-slate-300">Data Analytics Platform: security and governance</p>
...
<li><Link href="/blog/devops-gen-ai-cicd-2026-2332">Devops Gen Ai Cicd 2026 2332</Link></li>
<li><Link href="/blog/ai-observability-2026-2218">Ai Observability 2026 2218</Link></li>
<li><Link href="/blog/graphql-federation-platform-2026-891">Graphql Federation Platform 2026 891</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
