...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Data Analytics Platform: security and governance | Zion Tech Group" description="Data Analytics Platform: security and governance" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/data-analytics-platform-security-and-governance/" />
