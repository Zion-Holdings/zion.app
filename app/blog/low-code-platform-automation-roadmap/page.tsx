...
export const metadata = {
  title: 'Low Code Platform: automation roadmap | Zion Tech Group',
  description: 'Low Code Platform: automation roadmap',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Low Code Platform: automation roadmap',
    description: 'Low Code Platform: automation roadmap',
    url: 'https://ziontechgroup.com/blog/low-code-platform-automation-roadmap/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/low-code-platform-automation-roadmap/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Low Code Platform: automation roadmap", "description": "Low Code Platform: automation roadmap", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:02:35Z", "dateModified": "2026-08-06T18:02:35Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/low-code-platform-automation-roadmap/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Low Code Platform: automation roadmap' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Low Code Platform: automation roadmap</h1>
          <p className="mt-4 text-lg text-slate-300">Low Code Platform: automation roadmap</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link /blog/api-gateway-management-security-and-governance/>Api Gateway Management Security And Governance</Link></li>
