...
export const metadata = {
  ...
  openGraph: {
    title: 'Automation and scaling patterns for Common mistakes when rolling out IT Financial Management: Showback, Chargeback, and Cloud Cost Allocation',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/automation-and-scaling-patterns-for-common-mistakes-when-rolling-out-it-financial-management-showback-chargeback-and-cloud-cost-allocation/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/automation-and-scaling-patterns-for-common-mistakes-when-rolling-out-it-financial-management-showback-chargeback-and-cloud-cost-allocation/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Automation and scaling patterns for Common mistakes when rolling out IT Financial Management: Showback, Chargeback, and Cloud Cost Allocation' }]} className="mb-8" />
