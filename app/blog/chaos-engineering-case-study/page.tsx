...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Chaos Engineering: case study | Zion Tech Group" description="Chaos Engineering: case study" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/chaos-engineering-case-study/" />
