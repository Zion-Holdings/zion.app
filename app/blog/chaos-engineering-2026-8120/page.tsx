...
export const metadata = {
  ...
  alternates: { canonical: '/blog/chaos-engineering-2026-8120/' },
  openGraph: { title: 'Chaos Engineering', description: 'Practical guide to chaos engineering.', url: 'https://ziontechgroup.com/blog/chaos-engineering-2026-8120/', type: 'article' },
  twitter: { card: 'summary_large_image', title: 'Chaos Engineering', description: 'Practical guide to chaos engineering.' }
};

export default function Page() {
  return (
    <PageShell title="Chaos Engineering" description="Practical guide to chaos engineering: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/chaos-engineering-2026-8120/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/chaos-engineering-2026-8120/'
    }}>
