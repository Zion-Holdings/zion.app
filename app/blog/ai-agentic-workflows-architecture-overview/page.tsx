...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI Agentic Workflows: architecture overview | Zion Tech Group" description="AI Agentic Workflows: architecture overview" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-agentic-workflows-architecture-overview/" />
