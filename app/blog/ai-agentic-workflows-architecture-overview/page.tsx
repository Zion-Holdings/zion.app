        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/ai-data-lakehouse-pipelines-2026-2220">Ai Data Lakehouse Pipelines 2026 2220</Link></li>
...
<li><Link href="/blog/micro-saas-ai-social-media-manager-2026-2231">Micro Saas Ai Social Media Manager 2026 2231</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
