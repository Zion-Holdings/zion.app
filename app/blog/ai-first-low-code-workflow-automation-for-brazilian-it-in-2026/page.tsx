    ...
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        ...
        <div className="glass-card prose prose-invert max-w-none">
          <p>Low-code workflow patterns that expand IT throughput safely.</p><ul><li>Approval, integration, and event-driven automation</li><li>Governance, auditability, and reuse</li><li>Free readiness tools at <a href="https://ziontechgroup.com">ziontechgroup.com</a></li></ul><p>See <a href="/services/ai-observability-aiops">observability services</a>, then <a href="/contact">contact us</a> or <a href="https://calendly.com/kleber-ziontechgroup">schedule a meeting</a>.</p>
        </div>
