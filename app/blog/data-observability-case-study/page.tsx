...
export const metadata = {
  title: 'Data Observability: case study | Zion Tech Group',
  description: 'Data Observability: case study',
  keywords: ['data', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Data Observability: case study',
    description: 'Data Observability: case study',
    url: 'https://ziontechgroup.com/blog/data-observability-case-study/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/data-observability-case-study/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Data Observability: case study", "description": "Data Observability: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:03:02Z", "dateModified": "2026-08-06T18:03:02Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/data-observability-case-study/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Data Observability: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Data Observability: case study</h1>
          <p className="mt-4 text-lg text-slate-300">Data Observability: case study</p>
...
<li><Link /blog/ai-agent-tool-builder-evaluation-framework/>Ai Agent Tool Builder Evaluation Framework</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
