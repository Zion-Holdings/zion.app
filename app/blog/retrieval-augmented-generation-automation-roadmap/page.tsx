...
export const metadata = {
  title: 'Retrieval Augmented Generation: automation roadmap | Zion Tech Group',
  description: 'Retrieval Augmented Generation: automation roadmap',
  keywords: ['ai', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Retrieval Augmented Generation: automation roadmap',
    description: 'Retrieval Augmented Generation: automation roadmap',
    url: 'https://ziontechgroup.com/blog/retrieval-augmented-generation-automation-roadmap/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/retrieval-augmented-generation-automation-roadmap/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Retrieval Augmented Generation: automation roadmap", "description": "Retrieval Augmented Generation: automation roadmap", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:08:21Z", "dateModified": "2026-08-06T18:08:21Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/retrieval-augmented-generation-automation-roadmap/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Retrieval Augmented Generation: automation roadmap' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Retrieval Augmented Generation: automation roadmap</h1>
          <p className="mt-4 text-lg text-slate-300">Retrieval Augmented Generation: automation roadmap</p>
...
<li><Link href="/blog/software-supply-chain-security-evaluation-framework">Software Supply Chain Security Evaluation Framework</Link></li>
