...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI Email Intelligence: architecture overview | Zion Tech Group" description="AI Email Intelligence: architecture overview" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-email-intelligence-architecture-overview/" />
