...
export default function Page() {
  return (
    <PageShell title="IT Consulting" description="Practical guide to it consulting: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/it-consulting-2026-6984/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/it-consulting-2026-6984/'
    }}>
