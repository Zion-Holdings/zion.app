...
export const metadata = {
  title: 'SIEM: deployment patterns | Zion Tech Group',
  description: 'SIEM: deployment patterns',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'SIEM: deployment patterns',
    description: 'SIEM: deployment patterns',
    url: 'https://ziontechgroup.com/blog/siem-deployment-patterns/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/siem-deployment-patterns/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "SIEM: deployment patterns", "description": "SIEM: deployment patterns", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:03:28Z", "dateModified": "2026-08-06T18:03:28Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/siem-deployment-patterns/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'SIEM: deployment patterns' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">SIEM: deployment patterns</h1>
          <p className="mt-4 text-lg text-slate-300">SIEM: deployment patterns</p>
