...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI IT Operations: case study | Zion Tech Group" description="AI IT Operations: case study" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-it-operations-case-study/" />
