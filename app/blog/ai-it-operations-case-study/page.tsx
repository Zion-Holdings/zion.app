...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AI IT Operations: case study", "description": "AI IT Operations: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:13:53Z", "dateModified": "2026-08-04T16:13:53Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ai-it-operations-case-study/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI IT Operations: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AI IT Operations: case study</h1>
          <p className="mt-4 text-lg text-slate-300">AI IT Operations: case study</p>
...
<li><Link href="/blog/cloud-cost-optimization-checklist-2026-2831">Cloud Cost Optimization Checklist 2026 2831</Link></li>
<li><Link href="/blog/ai-agent-tool-builder-2026-2376">Ai Agent Tool Builder 2026 2376</Link></li>
<li><Link href="/blog/ai-it-operations-automation-2026-4210">Ai It Operations Automation 2026 4210</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
