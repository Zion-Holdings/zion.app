        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/case-study-cloud-exit-strategy-avoid-vendor-lock-in-with-portable-architecture-patterns-in-production">Case Study Cloud Exit Strategy Avoid Vendor Lock In With Portable Architecture Patterns In Production</Link></li><li><Link href="/blog/comparing-ai-credential-hygiene-and-secret-rotation-in-ci-cd-vendors-and-build-vs-buy">Comparing Ai Credential Hygiene And Secret Rotation In Ci Cd Vendors And Build Vs Buy</Link></li><li><Link href="/blog/comparing-ai-data-pipeline-observability-lineage-freshness-and-quality-in-2026-vendors-and-build-vs-buy">Comparing Ai Data Pipeline Observability Lineage Freshness And Quality In 2026 Vendors And Build Vs Buy</Link></li><li><Link href="/blog/common-mistakes-when-rolling-out-ai-platform-engineering-patterns-idp-backstage-and-golden-paths">Common Mistakes When Rolling Out Ai Platform Engineering Patterns Idp Backstage And Golden Paths</Link></li>
              ...
              <li><Link href="/blog/comparing-ai-customer-onboarding-automation-reduce-time-to-value-vendors-and-build-vs-buy">Comparing Ai Customer Onboarding Automation Reduce Time To Value Vendors And Build Vs Buy</Link></li>
              <li><Link href="/blog/feature-store-for-machine-learning-centralize-features-for-training-and-inference-for-data-teams">Feature Store For Machine Learning Centralize Features For Training And Inference For Data Teams</Link></li>
