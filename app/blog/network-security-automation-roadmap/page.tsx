...
export const metadata = {
  title: 'Network Security: automation roadmap | Zion Tech Group',
  description: 'Network Security: automation roadmap',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Network Security: automation roadmap',
    description: 'Network Security: automation roadmap',
    url: 'https://ziontechgroup.com/blog/network-security-automation-roadmap/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/network-security-automation-roadmap/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Network Security: automation roadmap", "description": "Network Security: automation roadmap", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:51:19Z", "dateModified": "2026-08-06T18:51:19Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/network-security-automation-roadmap/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Network Security: automation roadmap' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Network Security: automation roadmap</h1>
          <p className="mt-4 text-lg text-slate-300">Network Security: automation roadmap</p>
