...
export const metadata = {
  title: 'Open Source Strategy: deployment patterns | Zion Tech Group',
  description: 'Open Source Strategy: deployment patterns',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Open Source Strategy: deployment patterns',
    description: 'Open Source Strategy: deployment patterns',
    url: 'https://ziontechgroup.com/blog/open-source-strategy-deployment-patterns/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/open-source-strategy-deployment-patterns/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Open Source Strategy: deployment patterns", "description": "Open Source Strategy: deployment patterns", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:07:49Z", "dateModified": "2026-08-06T18:07:49Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/open-source-strategy-deployment-patterns/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Open Source Strategy: deployment patterns' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Open Source Strategy: deployment patterns</h1>
          <p className="mt-4 text-lg text-slate-300">Open Source Strategy: deployment patterns</p>
