...
export const metadata = {
  ...
  openGraph: {
    title: 'Common mistakes when rolling out Services Trends 2026',
    description: 'Web-researched high-intent buyer topic',
    url: 'https://ziontechgroup.com/blog/common-mistakes-when-rolling-out-services-trends-2026/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/common-mistakes-when-rolling-out-services-trends-2026/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Common mistakes when rolling out Services Trends 2026' }]} className="mb-8" />
