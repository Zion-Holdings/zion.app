...
export const metadata = {
  title: 'Infrastructure as Code: security and governance | Zion Tech Group',
  description: 'Infrastructure as Code: security and governance',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Infrastructure as Code: security and governance',
    description: 'Infrastructure as Code: security and governance',
    url: 'https://ziontechgroup.com/blog/infrastructure-as-code-security-and-governance/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/infrastructure-as-code-security-and-governance/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Infrastructure as Code: security and governance", "description": "Infrastructure as Code: security and governance", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T19:54:40Z", "dateModified": "2026-08-06T19:54:40Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/infrastructure-as-code-security-and-governance/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Infrastructure as Code: security and governance' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Infrastructure as Code: security and governance</h1>
          <p className="mt-4 text-lg text-slate-300">Infrastructure as Code: security and governance</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link /blog/ai-code-review-automation-roi-and-cost-model/>Ai Code Review Automation Roi And Cost Model</Link></li>
<li><Link /blog/threat-intelligence-platform-automation-roadmap/>Threat Intelligence Platform Automation Roadmap</Link></li>
<li><Link /blog/ai-predictive-maintenance-roi-and-cost-model/>Ai Predictive Maintenance Roi And Cost Model</Link></li>
