...
export const metadata = {
  ...
  openGraph: {
    title: 'Common mistakes when rolling out AI Cloud FinOps with Anomaly Detection and Budget Guardrails: 2026 Playbook',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/common-mistakes-when-rolling-out-ai-cloud-finops-with-anomaly-detection-and-budget-guardrails-2026-playbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/common-mistakes-when-rolling-out-ai-cloud-finops-with-anomaly-detection-and-budget-guardrails-2026-playbook/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Common mistakes when rolling out AI Cloud FinOps with Anomaly Detection and Budget Guardrails: 2026 Playbook' }]} className="mb-8" />
