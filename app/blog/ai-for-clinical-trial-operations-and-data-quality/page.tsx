...
export const metadata = {
  ...
  description: 'Ai For Clinical Trial Operations And Data Quality: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
    title: 'Ai For Clinical Trial Operations And Data Quality',
    description: 'Ai For Clinical Trial Operations And Data Quality: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
    url: 'https://ziontechgroup.com/blog/ai-for-clinical-trial-operations-and-data-quality',
    type: 'article',
  },
  alternates: {
    canonical: 'https://ziontechgroup.com/blog/ai-for-clinical-trial-operations-and-data-quality',
  },
};
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'Ai For Clinical Trial Operations And Data Quality' }
          ]}
          className="mb-8"
        />
        ...
        <header className="mb-12">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Ai For Clinical Trial Operations And Data Quality</h1>
          <p className="mt-4 text-lg text-slate-300">Ai For Clinical Trial Operations And Data Quality requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
