...
export const metadata = {
  ...
  openGraph: {
    title: 'DevOps CI/CD: architecture overview',
    description: 'DevOps CI/CD: architecture overview',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "DevOps CI/CD: architecture overview", "description": "DevOps CI/CD: architecture overview", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:12:55Z", "dateModified": "2026-08-04T16:12:55Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/devops-cicd-architecture-overview/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'DevOps CI/CD: architecture overview' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">DevOps CI/CD: architecture overview</h1>
          <p className="mt-4 text-lg text-slate-300">DevOps CI/CD: architecture overview</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/database-migration-service-2026-3366">Database Migration Service 2026 3366</Link></li>
<li><Link href="/blog/ai-agentic-workflows-2026-3964">Ai Agentic Workflows 2026 3964</Link></li>
