...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="DevOps CI/CD: architecture overview | Zion Tech Group" description="DevOps CI/CD: architecture overview" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/devops-cicd-architecture-overview/" />
