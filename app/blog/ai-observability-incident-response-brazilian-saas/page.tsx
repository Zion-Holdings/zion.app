...
export const metadata = {
  title: 'AI Observability and Incident Response for Brazilian SaaS',
  description: 'AI-assisted monitoring, alert prioritization, and incident remediation patterns for Brazilian SaaS teams.',
};
    ...
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        <nav className="mb-6 text-sm text-slate-400">
          ...
          <span className="mx-2">/</span>
          <span className="text-slate-300">AI Observability and Incident Response for Brazilian SaaS</span>
        </nav>
