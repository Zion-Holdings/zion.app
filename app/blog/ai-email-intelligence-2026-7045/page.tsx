...
export const metadata = {
  ...
  alternates: { canonical: '/blog/ai-email-intelligence-2026-7045/' },
  openGraph: { title: 'AI Email Intelligence', description: 'Practical guide to ai email intelligence.', url: 'https://ziontechgroup.com/blog/ai-email-intelligence-2026-7045/', type: 'article' },
  twitter: { card: 'summary_large_image', title: 'AI Email Intelligence', description: 'Practical guide to ai email intelligence.' }
};

export default function Page() {
  return (
    <PageShell title="AI Email Intelligence" description="Practical guide to ai email intelligence: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/ai-email-intelligence-2026-7045/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/ai-email-intelligence-2026-7045/'
    }}>
