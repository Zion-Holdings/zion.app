        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/api-integration-2026-8117">Api Integration 2026 8117</Link></li>
<li><Link href="/blog/container-security-lifecycle-2026-7986">Container Security Lifecycle 2026 7986</Link></li>
