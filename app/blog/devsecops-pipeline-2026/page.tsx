...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "DevSecOps Pipeline", "description": "DevSecOps Pipeline", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:14:01Z", "dateModified": "2026-08-04T16:14:01Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/devsecops-pipeline-2026/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'DevSecOps Pipeline' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">DevSecOps Pipeline</h1>
          <p className="mt-4 text-lg text-slate-300">DevSecOps Pipeline</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/ai-agentic-workflows-2026-2308">Ai Agentic Workflows 2026 2308</Link></li>
<li><Link href="/blog/it-consulting-2026-4086">It Consulting 2026 4086</Link></li>
<li><Link href="/blog/data-warehouse-modernization-2026-1019">Data Warehouse Modernization 2026 1019</Link></li>
<li><Link href="/blog/ai-accessibility-optimizer-2026-3132">Ai Accessibility Optimizer 2026 3132</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
