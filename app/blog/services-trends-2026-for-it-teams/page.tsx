...
export const metadata = {
  ...
  openGraph: {
    title: 'Services Trends 2026 for it teams',
    description: 'Web-researched high-intent buyer topic',
    url: 'https://ziontechgroup.com/blog/services-trends-2026-for-it-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/services-trends-2026-for-it-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Services Trends 2026 for it teams' }]} className="mb-8" />
