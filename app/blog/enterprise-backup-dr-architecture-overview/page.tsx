...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Enterprise Backup DR: architecture overview | Zion Tech Group" description="Enterprise Backup DR: architecture overview" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/enterprise-backup-dr-architecture-overview/" />
