...
export const metadata = {
  ...
  openGraph: {
    title: 'Case study: AI Platform Engineering Patterns: IDP, Backstage, and Golden Paths in production: architecture, risks, and roadmap',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/case-study-ai-platform-engineering-patterns-idp-backstage-and-golden-paths-in-production-architecture-risks-and-roadmap/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/case-study-ai-platform-engineering-patterns-idp-backstage-and-golden-paths-in-production-architecture-risks-and-roadmap/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Case study: AI Platform Engineering Patterns: IDP, Backstage, and Golden Paths in production: architecture, risks, and roadmap' }]} className="mb-8" />
