...
export const metadata = {
  title: 'Email Security: operations handbook | Zion Tech Group',
  description: 'Email Security: operations handbook',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Email Security: operations handbook',
    description: 'Email Security: operations handbook',
    url: 'https://ziontechgroup.com/blog/email-security-operations-handbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/email-security-operations-handbook/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Email Security: operations handbook", "description": "Email Security: operations handbook", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:24:05Z", "dateModified": "2026-08-06T18:24:05Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/email-security-operations-handbook/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Email Security: operations handbook' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Email Security: operations handbook</h1>
          <p className="mt-4 text-lg text-slate-300">Email Security: operations handbook</p>
