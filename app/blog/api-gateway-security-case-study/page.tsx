...
export const metadata = {
  title: 'API Gateway Security: case study | Zion Tech Group',
  description: 'API Gateway Security: case study',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'API Gateway Security: case study',
    description: 'API Gateway Security: case study',
    url: 'https://ziontechgroup.com/blog/api-gateway-security-case-study/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/api-gateway-security-case-study/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "API Gateway Security: case study", "description": "API Gateway Security: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T19:54:42Z", "dateModified": "2026-08-06T19:54:42Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/api-gateway-security-case-study/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'API Gateway Security: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">API Gateway Security: case study</h1>
          <p className="mt-4 text-lg text-slate-300">API Gateway Security: case study</p>
...
<li><Link /blog/ar-vr-enterprise-deployment-patterns/>Ar Vr Enterprise Deployment Patterns</Link></li>
