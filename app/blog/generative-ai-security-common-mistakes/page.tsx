...
export const metadata = {
  title: 'Generative AI Security: common mistakes | Zion Tech Group',
  description: 'Generative AI Security: common mistakes',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Generative AI Security: common mistakes',
    description: 'Generative AI Security: common mistakes',
    url: 'https://ziontechgroup.com/blog/generative-ai-security-common-mistakes/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/generative-ai-security-common-mistakes/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Generative AI Security: common mistakes", "description": "Generative AI Security: common mistakes", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:11:25Z", "dateModified": "2026-08-06T18:11:25Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/generative-ai-security-common-mistakes/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Generative AI Security: common mistakes' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Generative AI Security: common mistakes</h1>
          <p className="mt-4 text-lg text-slate-300">Generative AI Security: common mistakes</p>
