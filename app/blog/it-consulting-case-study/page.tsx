...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "IT Consulting: case study", "description": "IT Consulting: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T15:08:13Z", "dateModified": "2026-08-04T15:08:13Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/it-consulting-case-study/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'IT Consulting: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">IT Consulting: case study</h1>
          <p className="mt-4 text-lg text-slate-300">IT Consulting: case study</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/data-analytics-platform-modern-enterprise-2026-212">Data Analytics Platform Modern Enterprise 2026 212</Link></li>
<li><Link href="/blog/api-management-gateway-2026-114">Api Management Gateway 2026 114</Link></li>
<li><Link href="/blog/devops-gen-ai-cicd-2026-193">Devops Gen Ai Cicd 2026 193</Link></li>
