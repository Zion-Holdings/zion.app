...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="IT Consulting: case study | Zion Tech Group" description="IT Consulting: case study" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/it-consulting-case-study/" />
