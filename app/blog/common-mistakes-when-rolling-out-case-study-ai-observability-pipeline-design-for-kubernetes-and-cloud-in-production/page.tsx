...
export const metadata = {
  ...
  openGraph: {
    title: 'Common mistakes when rolling out Case study: AI Observability Pipeline Design for Kubernetes and Cloud in production',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/common-mistakes-when-rolling-out-case-study-ai-observability-pipeline-design-for-kubernetes-and-cloud-in-production/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/common-mistakes-when-rolling-out-case-study-ai-observability-pipeline-design-for-kubernetes-and-cloud-in-production/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Common mistakes when rolling out Case study: AI Observability Pipeline Design for Kubernetes and Cloud in production' }]} className="mb-8" />
