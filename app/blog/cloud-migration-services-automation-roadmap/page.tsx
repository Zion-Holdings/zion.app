...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Cloud Migration Services: automation roadmap", "description": "Cloud Migration Services: automation roadmap", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:25:14Z", "dateModified": "2026-08-04T16:25:14Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/cloud-migration-services-automation-roadmap/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Cloud Migration Services: automation roadmap' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Cloud Migration Services: automation roadmap</h1>
          <p className="mt-4 text-lg text-slate-300">Cloud Migration Services: automation roadmap</p>
...
<li><Link href="/blog/devops-gen-ai-cicd-2026-2470">Devops Gen Ai Cicd 2026 2470</Link></li>
