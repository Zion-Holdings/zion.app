...
export const metadata = {
  ...
  openGraph: {
    title: 'Feature Store for Machine Learning: Centralize Features for Training and Inference: costs, ROI, and hidden risks: 2026 Playbook',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/feature-store-for-machine-learning-centralize-features-for-training-and-inference-costs-roi-and-hidden-risks-2026-playbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/feature-store-for-machine-learning-centralize-features-for-training-and-inference-costs-roi-and-hidden-risks-2026-playbook/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Feature Store for Machine Learning: Centralize Features for Training and Inference: costs, ROI, and hidden risks: 2026 Playbook' }]} className="mb-8" />
