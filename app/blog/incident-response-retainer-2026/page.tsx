...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Incident Response Retainer | Zion Tech Group" description="Incident Response Retainer" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/incident-response-retainer-2026/" />
