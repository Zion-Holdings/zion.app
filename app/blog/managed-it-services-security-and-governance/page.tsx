...
export const metadata = {
  ...
  openGraph: {
    title: 'Managed IT Services: security and governance | Zion Tech Group',
    description: 'Managed IT Services: security and governance.',
    url: 'https://ziontechgroup.comapp/blog/managed-it-services-security-and-governance/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/managed-it-services-security-and-governance/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'Managed IT Services: security and governance',
  description: 'Managed IT Services: security and governance.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/managed-it-services-security-and-governance/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'Managed IT Services: security and governance' },
      ]}
    >
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <section className="prose prose-invert max-w-none">
          ...
          <p className="text-slate-300 mb-6">Managed IT Services: security and governance. Organizations benefit from clearer requirements, tighter governance, and repeatable delivery models.</p>
