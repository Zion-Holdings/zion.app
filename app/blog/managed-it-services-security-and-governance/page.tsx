...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Managed IT Services: security and governance | Zion Tech Group" description="Managed IT Services: security and governance" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/managed-it-services-security-and-governance/" />
