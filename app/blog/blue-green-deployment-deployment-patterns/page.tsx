...
export const metadata = {
  title: 'Blue Green Deployment: deployment patterns | Zion Tech Group',
  description: 'Blue Green Deployment: deployment patterns',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Blue Green Deployment: deployment patterns',
    description: 'Blue Green Deployment: deployment patterns',
    url: 'https://ziontechgroup.com/blog/blue-green-deployment-deployment-patterns/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/blue-green-deployment-deployment-patterns/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Blue Green Deployment: deployment patterns", "description": "Blue Green Deployment: deployment patterns", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:11:31Z", "dateModified": "2026-08-06T18:11:31Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/blue-green-deployment-deployment-patterns/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Blue Green Deployment: deployment patterns' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Blue Green Deployment: deployment patterns</h1>
          <p className="mt-4 text-lg text-slate-300">Blue Green Deployment: deployment patterns</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link /blog/open-source-strategy-vendor-evaluation/>Open Source Strategy Vendor Evaluation</Link></li>
