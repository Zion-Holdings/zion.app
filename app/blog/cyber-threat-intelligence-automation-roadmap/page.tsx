...
export const metadata = {
  title: 'Cyber Threat Intelligence: automation roadmap | Zion Tech Group',
  description: 'Cyber Threat Intelligence: automation roadmap.',
  openGraph: {
    title: 'Cyber Threat Intelligence: automation roadmap | Zion Tech Group',
    description: 'Cyber Threat Intelligence: automation roadmap.',
    url: 'https://ziontechgroup.comapp/blog/cyber-threat-intelligence-automation-roadmap/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/cyber-threat-intelligence-automation-roadmap/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'Cyber Threat Intelligence: automation roadmap',
  description: 'Cyber Threat Intelligence: automation roadmap.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/cyber-threat-intelligence-automation-roadmap/'
};

export default function Page() {
  return (
    <StandardPage
      title="Cyber Threat Intelligence: automation roadmap"
      breadcrumbItems={[
        { label: 'Home', href: '/' },
        { label: 'Blog', href: '/blog/' },
        { label: 'Cyber Threat Intelligence: automation roadmap' },
      ]}
    >
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Cyber Threat Intelligence: automation roadmap</h1>
          <p className="mt-4 text-lg text-slate-300">Cyber Threat Intelligence: automation roadmap.</p>
        ...
        <section className="prose prose-invert max-w-none">
          ...
          <p className="text-slate-300 mb-6">Cyber Threat Intelligence: automation roadmap. Organizations benefit from clearer requirements, tighter governance, and repeatable delivery models.</p>
