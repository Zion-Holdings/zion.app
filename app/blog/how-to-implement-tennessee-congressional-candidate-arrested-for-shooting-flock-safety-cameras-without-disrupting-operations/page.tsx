...
export const metadata = {
  ...
  openGraph: {
    title: 'How to implement Tennessee Congressional Candidate Arrested for Shooting Flock Safety Cameras without disrupting operations',
    description: 'Live web-researched high-intent buyer topic',
    url: 'https://ziontechgroup.com/blog/how-to-implement-tennessee-congressional-candidate-arrested-for-shooting-flock-safety-cameras-without-disrupting-operations/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/how-to-implement-tennessee-congressional-candidate-arrested-for-shooting-flock-safety-cameras-without-disrupting-operations/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'How to implement Tennessee Congressional Candidate Arrested for Shooting Flock Safety Cameras without disrupting operations' }]} className="mb-8" />
