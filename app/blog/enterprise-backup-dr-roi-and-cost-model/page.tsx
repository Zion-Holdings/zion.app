...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Enterprise Backup DR: ROI and cost model | Zion Tech Group" description="Enterprise Backup DR: ROI and cost model" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/enterprise-backup-dr-roi-and-cost-model/" />
