...
export const metadata = {
  ...
  openGraph: {
    title: 'Comparing Business Observability: Connect Metrics to Revenue, Conversion, and CX: vendors and build vs buy: architecture, risks, and roadmap',
    description: 'Business outcome mapping for technical telemetry',
    url: 'https://ziontechgroup.com/blog/comparing-business-observability-connect-metrics-to-revenue-conversion-and-cx-vendors-and-build-vs-buy-architecture-risks-and-roadmap/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/comparing-business-observability-connect-metrics-to-revenue-conversion-and-cx-vendors-and-build-vs-buy-architecture-risks-and-roadmap/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Comparing Business Observability: Connect Metrics to Revenue, Conversion, and CX: vendors and build vs buy: architecture, risks, and roadmap' }]} className="mb-8" />
