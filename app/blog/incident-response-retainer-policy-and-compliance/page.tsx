        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/ai-it-operations-automation-2026-3934">Ai It Operations Automation 2026 3934</Link></li>
<li><Link href="/blog/data-analytics-platform-modern-enterprise-2026-3524">Data Analytics Platform Modern Enterprise 2026 3524</Link></li>
<li><Link href="/blog/ai-msp-security-compliance-2026-2357">Ai Msp Security Compliance 2026 2357</Link></li>
<li><Link href="/blog/api-gateway-management-2026-3723">Api Gateway Management 2026 3723</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
