...
<li><Link href="/blog/ai-ad-copy-generator-evaluation-framework">Ai Ad Copy Generator Evaluation Framework</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
