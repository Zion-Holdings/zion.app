...
export const metadata = {
  ...
  openGraph: {
    title: 'Case study: Case study: RAG Optimization Playbook: Reduce Hallucination and Improve Retrieval Accuracy in production in production',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/case-study-case-study-rag-optimization-playbook-reduce-hallucination-and-improve-retrieval-accuracy-in-production-in-production/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/case-study-case-study-rag-optimization-playbook-reduce-hallucination-and-improve-retrieval-accuracy-in-production-in-production/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Case study: Case study: RAG Optimization Playbook: Reduce Hallucination and Improve Retrieval Accuracy in production in production' }]} className="mb-8" />
