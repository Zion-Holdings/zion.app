...
export const metadata = {
  title: 'Generative AI Security: automation roadmap | Zion Tech Group',
  description: 'Generative AI Security: automation roadmap',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Generative AI Security: automation roadmap',
    description: 'Generative AI Security: automation roadmap',
    url: 'https://ziontechgroup.com/blog/generative-ai-security-automation-roadmap/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/generative-ai-security-automation-roadmap/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Generative AI Security: automation roadmap", "description": "Generative AI Security: automation roadmap", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:10:44Z", "dateModified": "2026-08-06T18:10:44Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/generative-ai-security-automation-roadmap/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Generative AI Security: automation roadmap' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Generative AI Security: automation roadmap</h1>
          <p className="mt-4 text-lg text-slate-300">Generative AI Security: automation roadmap</p>
...
<li><Link /blog/automated-ai-reporting-implementation-playbook/>Automated Ai Reporting Implementation Playbook</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
