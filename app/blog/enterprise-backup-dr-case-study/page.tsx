...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Enterprise Backup DR: case study | Zion Tech Group" description="Enterprise Backup DR: case study" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/enterprise-backup-dr-case-study/" />
