...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Enterprise Backup DR: case study", "description": "Enterprise Backup DR: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:13:14Z", "dateModified": "2026-08-04T16:13:14Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/enterprise-backup-dr-case-study/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Enterprise Backup DR: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Enterprise Backup DR: case study</h1>
          <p className="mt-4 text-lg text-slate-300">Enterprise Backup DR: case study</p>
...
<li><Link href="/blog/container-security-lifecycle-2026-3639">Container Security Lifecycle 2026 3639</Link></li>
<li><Link href="/blog/ai-bom-procurement-2026-2592">Ai Bom Procurement 2026 2592</Link></li>
<li><Link href="/blog/enterprise-ai-intelligence-hub-2026-3957">Enterprise Ai Intelligence Hub 2026 3957</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
