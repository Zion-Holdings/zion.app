...
export const metadata = {
  ...
  openGraph: {
    ...
    description: 'API Rate Limiting',
    url: 'https://ziontechgroup.com/blog/api-rate-limiting-2026/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/api-rate-limiting-2026/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "API Rate Limiting", "description": "API Rate Limiting", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:01:36Z", "dateModified": "2026-08-06T18:01:36Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/api-rate-limiting-2026/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'API Rate Limiting' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">API Rate Limiting</h1>
          <p className="mt-4 text-lg text-slate-300">API Rate Limiting</p>
...
<li><Link /blog/ai-bom-procurement-roi-and-cost-model/>Ai Bom Procurement Roi And Cost Model</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
