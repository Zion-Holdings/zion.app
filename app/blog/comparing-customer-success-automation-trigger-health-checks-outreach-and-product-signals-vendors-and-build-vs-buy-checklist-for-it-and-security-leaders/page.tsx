...
export const metadata = {
  ...
  openGraph: {
    title: 'Comparing Customer Success Automation: Trigger Health Checks, Outreach, and Product Signals: vendors and build vs buy checklist for IT and security leaders',
    description: 'Health-based playbooks and intervention timing',
    url: 'https://ziontechgroup.com/blog/comparing-customer-success-automation-trigger-health-checks-outreach-and-product-signals-vendors-and-build-vs-buy-checklist-for-it-and-security-leaders/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/comparing-customer-success-automation-trigger-health-checks-outreach-and-product-signals-vendors-and-build-vs-buy-checklist-for-it-and-security-leaders/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Comparing Customer Success Automation: Trigger Health Checks, Outreach, and Product Signals: vendors and build vs buy checklist for IT and security leaders' }]} className="mb-8" />
