...
export const metadata = {
  ...
  openGraph: {
    title: 'API Security Testing: ROI and cost model | Zion Tech Group',
    description: 'API Security Testing: ROI and cost model.',
    url: 'https://ziontechgroup.comapp/blog/api-security-testing-roi-and-cost-model/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/api-security-testing-roi-and-cost-model/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'API Security Testing: ROI and cost model',
  description: 'API Security Testing: ROI and cost model.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/api-security-testing-roi-and-cost-model/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'API Security Testing: ROI and cost model' },
      ]}
    >
