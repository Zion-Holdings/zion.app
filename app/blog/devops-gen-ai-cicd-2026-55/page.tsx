...
export const metadata = {
  ...
  alternates: { canonical: '/blog/devops-gen-ai-cicd-2026-55/' },
  openGraph: { title: 'GenAI DevOps CI/CD', description: 'Practical guide to genai devops ci/cd.', url: 'https://ziontechgroup.com/blog/devops-gen-ai-cicd-2026-55/', type: 'article' },
  twitter: { card: 'summary_large_image', title: 'GenAI DevOps CI/CD', description: 'Practical guide to genai devops ci/cd.' }
};

export default function Page() {
  return (
    <PageShell title="GenAI DevOps CI/CD" description="Practical guide to genai devops ci/cd: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/devops-gen-ai-cicd-2026-55/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/devops-gen-ai-cicd-2026-55/'
    }}>
