...
export const metadata = {
  title: 'AI Workflow Automation: operations handbook | Zion Tech Group',
  description: 'AI Workflow Automation: operations handbook',
  keywords: ['ai', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'AI Workflow Automation: operations handbook',
    description: 'AI Workflow Automation: operations handbook',
    url: 'https://ziontechgroup.com/blog/ai-workflow-automation-operations-handbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-workflow-automation-operations-handbook/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AI Workflow Automation: operations handbook", "description": "AI Workflow Automation: operations handbook", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:29:04Z", "dateModified": "2026-08-06T18:29:04Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ai-workflow-automation-operations-handbook/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Workflow Automation: operations handbook' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AI Workflow Automation: operations handbook</h1>
          <p className="mt-4 text-lg text-slate-300">AI Workflow Automation: operations handbook</p>
