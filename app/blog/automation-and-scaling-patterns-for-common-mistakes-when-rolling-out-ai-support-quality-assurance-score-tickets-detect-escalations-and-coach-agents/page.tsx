...
export const metadata = {
  ...
  openGraph: {
    title: 'Automation and scaling patterns for Common mistakes when rolling out AI Support Quality Assurance: Score Tickets, Detect Escalations, and Coach Agents',
    description: 'Quality scoring and coaching without full QA staffing',
    url: 'https://ziontechgroup.com/blog/automation-and-scaling-patterns-for-common-mistakes-when-rolling-out-ai-support-quality-assurance-score-tickets-detect-escalations-and-coach-agents/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/automation-and-scaling-patterns-for-common-mistakes-when-rolling-out-ai-support-quality-assurance-score-tickets-detect-escalations-and-coach-agents/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Automation and scaling patterns for Common mistakes when rolling out AI Support Quality Assurance: Score Tickets, Detect Escalations, and Coach Agents' }]} className="mb-8" />
