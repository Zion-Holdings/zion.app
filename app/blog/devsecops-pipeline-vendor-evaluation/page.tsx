...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="DevSecOps Pipeline: vendor evaluation | Zion Tech Group" description="DevSecOps Pipeline: vendor evaluation" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/devsecops-pipeline-vendor-evaluation/" />
