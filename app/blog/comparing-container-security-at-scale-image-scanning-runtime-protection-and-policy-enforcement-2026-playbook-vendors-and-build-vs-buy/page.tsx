...
export const metadata = {
  ...
  openGraph: {
    title: 'Comparing Container Security at Scale: Image Scanning, Runtime Protection, and Policy Enforcement: 2026 Playbook: vendors and build vs buy',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/comparing-container-security-at-scale-image-scanning-runtime-protection-and-policy-enforcement-2026-playbook-vendors-and-build-vs-buy/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/comparing-container-security-at-scale-image-scanning-runtime-protection-and-policy-enforcement-2026-playbook-vendors-and-build-vs-buy/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Comparing Container Security at Scale: Image Scanning, Runtime Protection, and Policy Enforcement: 2026 Playbook: vendors and build vs buy' }]} className="mb-8" />
