...
export const metadata = {
  ...
  openGraph: {
    title: 'Case study: Customer Success Automation: Trigger Health Checks and Outreach from Product Signals in production: policy, compliance, and vendor management',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/case-study-customer-success-automation-trigger-health-checks-and-outreach-from-product-signals-in-production-policy-compliance-and-vendor-management/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/case-study-customer-success-automation-trigger-health-checks-and-outreach-from-product-signals-in-production-policy-compliance-and-vendor-management/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Case study: Customer Success Automation: Trigger Health Checks and Outreach from Product Signals in production: policy, compliance, and vendor management' }]} className="mb-8" />
