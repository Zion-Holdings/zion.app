...
export const metadata = {
  ...
  openGraph: {
    title: 'Comparing AI Security Operations Center Modernization for MSSPs: vendors and build vs buy: policy, compliance, and vendor management',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/comparing-ai-security-operations-center-modernization-for-mssps-vendors-and-build-vs-buy-policy-compliance-and-vendor-management/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/comparing-ai-security-operations-center-modernization-for-mssps-vendors-and-build-vs-buy-policy-compliance-and-vendor-management/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Comparing AI Security Operations Center Modernization for MSSPs: vendors and build vs buy: policy, compliance, and vendor management' }]} className="mb-8" />
