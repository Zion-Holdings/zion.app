...
export const metadata = {
  title: 'Data Architecture: policy and compliance | Zion Tech Group',
  description: 'Data Architecture: policy and compliance',
  keywords: ['data', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Data Architecture: policy and compliance',
    description: 'Data Architecture: policy and compliance',
    url: 'https://ziontechgroup.com/blog/data-architecture-policy-and-compliance/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/data-architecture-policy-and-compliance/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Data Architecture: policy and compliance", "description": "Data Architecture: policy and compliance", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:11:57Z", "dateModified": "2026-08-06T18:11:57Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/data-architecture-policy-and-compliance/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Data Architecture: policy and compliance' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Data Architecture: policy and compliance</h1>
          <p className="mt-4 text-lg text-slate-300">Data Architecture: policy and compliance</p>
...
<li><Link href="/blog/low-code-platform-starter-template">Low Code Platform Starter Template</Link></li>
