...
export const metadata = {
  ...
  openGraph: {
    title: '2026 buyer's guide to Business Observability: Connect Metrics to Revenue, Conversion, and CX',
    description: 'Business outcome mapping for technical telemetry',
    url: 'https://ziontechgroup.com/blog/2026-buyer-s-guide-to-business-observability-connect-metrics-to-revenue-conversion-and-cx/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/2026-buyer-s-guide-to-business-observability-connect-metrics-to-revenue-conversion-and-cx/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: '2026 buyer's guide to Business Observability: Connect Metrics to Revenue, Conversion, and CX' }]} className="mb-8" />
