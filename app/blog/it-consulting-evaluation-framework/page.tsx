...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="IT Consulting: evaluation framework | Zion Tech Group" description="IT Consulting: evaluation framework" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/it-consulting-evaluation-framework/" />
