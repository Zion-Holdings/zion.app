...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "IT Consulting: evaluation framework", "description": "IT Consulting: evaluation framework", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:29:12Z", "dateModified": "2026-08-04T16:29:12Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/it-consulting-evaluation-framework/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'IT Consulting: evaluation framework' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">IT Consulting: evaluation framework</h1>
          <p className="mt-4 text-lg text-slate-300">IT Consulting: evaluation framework</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/cloud-cost-optimization-checklist-2026-2072">Cloud Cost Optimization Checklist 2026 2072</Link></li>
<li><Link href="/blog/devsecops-pipeline-2026-815">Devsecops Pipeline 2026 815</Link></li>
<li><Link href="/blog/apm-application-performance-2026-3427">Apm Application Performance 2026 3427</Link></li>
<li><Link href="/blog/chaos-engineering-2026-2117">Chaos Engineering 2026 2117</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
