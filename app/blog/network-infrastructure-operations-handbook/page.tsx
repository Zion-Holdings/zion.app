...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Network Infrastructure: operations handbook | Zion Tech Group" description="Network Infrastructure: operations handbook" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/network-infrastructure-operations-handbook/" />
