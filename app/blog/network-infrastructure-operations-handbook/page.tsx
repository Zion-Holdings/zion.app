...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Network Infrastructure: operations handbook", "description": "Network Infrastructure: operations handbook", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:26:15Z", "dateModified": "2026-08-04T16:26:15Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/network-infrastructure-operations-handbook/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Network Infrastructure: operations handbook' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Network Infrastructure: operations handbook</h1>
          <p className="mt-4 text-lg text-slate-300">Network Infrastructure: operations handbook</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/cloud-native-app-development-2026-3362">Cloud Native App Development 2026 3362</Link></li>
<li><Link href="/blog/ai-agent-tool-builder-2026-3411">Ai Agent Tool Builder 2026 3411</Link></li>
<li><Link href="/blog/5g-solutions-2026-1532">5G Solutions 2026 1532</Link></li>
<li><Link href="/blog/api-management-gateway-2026-4116">Api Management Gateway 2026 4116</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
