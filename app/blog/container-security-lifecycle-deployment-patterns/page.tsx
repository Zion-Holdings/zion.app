...
<li><Link href="/blog/ai-data-lakehouse-pipelines-common-mistakes">Ai Data Lakehouse Pipelines Common Mistakes</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
