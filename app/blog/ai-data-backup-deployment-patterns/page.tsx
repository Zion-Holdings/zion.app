...
<li><Link href="/blog/cloud-cost-optimization-checklist-2026-485">Cloud Cost Optimization Checklist 2026 485</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
