...
export const metadata = {
  ...
  alternates: { canonical: '/blog/ai-accessibility-auditor-2026-6995/' },
  openGraph: { title: 'AI Accessibility Auditor', description: 'Practical guide to ai accessibility auditor.', url: 'https://ziontechgroup.com/blog/ai-accessibility-auditor-2026-6995/', type: 'article' },
...
export default function Page() {
  return (
    <PageShell title="AI Accessibility Auditor" description="Practical guide to ai accessibility auditor: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/ai-accessibility-auditor-2026-6995/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/ai-accessibility-auditor-2026-6995/'
    }}>
