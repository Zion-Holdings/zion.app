...
export const metadata = {
  title: 'Ai Cybersecurity Platform For Msp And Managed Security | Zion Tech Group',
  description: 'Ai Cybersecurity Platform For Msp And Managed Security: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
    title: 'Ai Cybersecurity Platform For Msp And Managed Security',
    description: 'Ai Cybersecurity Platform For Msp And Managed Security: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
    url: 'https://ziontechgroup.com/blog/ai-cybersecurity-platform-for-msp-and-managed-security',
    type: 'article',
  },
  alternates: {
    canonical: 'https://ziontechgroup.com/blog/ai-cybersecurity-platform-for-msp-and-managed-security',
  },
};
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'Ai Cybersecurity Platform For Msp And Managed Security' }
          ]}
          className="mb-8"
        />
        ...
        <header className="mb-12">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Ai Cybersecurity Platform For Msp And Managed Security</h1>
          <p className="mt-4 text-lg text-slate-300">Ai Cybersecurity Platform For Msp And Managed Security requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
