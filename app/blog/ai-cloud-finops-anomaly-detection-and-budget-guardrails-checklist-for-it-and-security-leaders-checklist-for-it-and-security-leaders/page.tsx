...
export const metadata = {
  ...
  openGraph: {
    title: 'AI Cloud FinOps: Anomaly Detection and Budget Guardrails checklist for IT and security leaders checklist for IT and security leaders',
    description: 'Finance and engineering collaboration with automated alerts',
    url: 'https://ziontechgroup.com/blog/ai-cloud-finops-anomaly-detection-and-budget-guardrails-checklist-for-it-and-security-leaders-checklist-for-it-and-security-leaders/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-cloud-finops-anomaly-detection-and-budget-guardrails-checklist-for-it-and-security-leaders-checklist-for-it-and-security-leaders/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Cloud FinOps: Anomaly Detection and Budget Guardrails checklist for IT and security leaders checklist for IT and security leaders' }]} className="mb-8" />
