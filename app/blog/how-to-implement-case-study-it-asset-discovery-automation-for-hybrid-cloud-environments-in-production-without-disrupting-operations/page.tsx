...
export const metadata = {
  ...
  openGraph: {
    title: 'How to implement Case study: IT Asset Discovery Automation for Hybrid Cloud Environments in production without disrupting operations',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/how-to-implement-case-study-it-asset-discovery-automation-for-hybrid-cloud-environments-in-production-without-disrupting-operations/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/how-to-implement-case-study-it-asset-discovery-automation-for-hybrid-cloud-environments-in-production-without-disrupting-operations/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'How to implement Case study: IT Asset Discovery Automation for Hybrid Cloud Environments in production without disrupting operations' }]} className="mb-8" />
