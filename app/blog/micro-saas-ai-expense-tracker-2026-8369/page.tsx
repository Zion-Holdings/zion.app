...
export const metadata = {
  ...
  alternates: { canonical: '/blog/micro-saas-ai-expense-tracker-2026-8369/' },
  openGraph: { title: 'MicroSaaS Expense Tracker', description: 'Practical guide to microsaas expense tracker.', url: 'https://ziontechgroup.com/blog/micro-saas-ai-expense-tracker-2026-8369/', type: 'article' },
...
export default function Page() {
  return (
    <PageShell title="MicroSaaS Expense Tracker" description="Practical guide to microsaas expense tracker: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/micro-saas-ai-expense-tracker-2026-8369/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/micro-saas-ai-expense-tracker-2026-8369/'
    }}>
