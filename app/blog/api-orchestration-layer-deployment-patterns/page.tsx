        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/micro-saas-ai-social-media-manager-2026-989">Micro Saas Ai Social Media Manager 2026 989</Link></li>
<li><Link href="/blog/ai-agentic-workflows-2026-1963">Ai Agentic Workflows 2026 1963</Link></li>
<li><Link href="/blog/ai-bom-procurement-2026-936">Ai Bom Procurement 2026 936</Link></li>
