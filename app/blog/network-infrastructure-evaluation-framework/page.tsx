...
export const metadata = {
  ...
  description: 'Network Infrastructure: evaluation framework - AI and IT insights from Zion Tech Group.',
  openGraph: {
    title: 'Network Infrastructure: evaluation framework',
    description: 'Network Infrastructure: evaluation framework - AI and IT insights from Zion Tech Group.',
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'Network Infrastructure: evaluation framework' },
      ]}
    >
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <header className="mb-10">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Network Infrastructure: evaluation framework | Zion Tech Group</h1>
