...
export const metadata = {
  ...
  openGraph: {
    title: 'Cloud FinOps: policy and compliance | Zion Tech Group',
    description: 'Cloud FinOps: policy and compliance.',
    url: 'https://ziontechgroup.comapp/blog/cloud-finops-policy-and-compliance/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/cloud-finops-policy-and-compliance/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'Cloud FinOps: policy and compliance',
  description: 'Cloud FinOps: policy and compliance.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/cloud-finops-policy-and-compliance/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'Cloud FinOps: policy and compliance' },
      ]}
    >
