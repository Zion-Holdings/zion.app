...
export const metadata = {
  ...
  openGraph: {
    title: 'Return-to-office mandates are killing workplace trust: policy, compliance, and vendor management',
    description: 'Live web-researched high-intent buyer topic',
    url: 'https://ziontechgroup.com/blog/return-to-office-mandates-are-killing-workplace-trust-policy-compliance-and-vendor-management/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/return-to-office-mandates-are-killing-workplace-trust-policy-compliance-and-vendor-management/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Return-to-office mandates are killing workplace trust: policy, compliance, and vendor management' }]} className="mb-8" />
