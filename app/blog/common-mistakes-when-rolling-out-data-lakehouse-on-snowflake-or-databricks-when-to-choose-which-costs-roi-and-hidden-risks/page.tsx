...
export const metadata = {
  ...
  openGraph: {
    title: 'Common mistakes when rolling out Data Lakehouse on Snowflake or Databricks: When to Choose Which: costs, ROI, and hidden risks',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/common-mistakes-when-rolling-out-data-lakehouse-on-snowflake-or-databricks-when-to-choose-which-costs-roi-and-hidden-risks/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/common-mistakes-when-rolling-out-data-lakehouse-on-snowflake-or-databricks-when-to-choose-which-costs-roi-and-hidden-risks/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Common mistakes when rolling out Data Lakehouse on Snowflake or Databricks: When to Choose Which: costs, ROI, and hidden risks' }]} className="mb-8" />
