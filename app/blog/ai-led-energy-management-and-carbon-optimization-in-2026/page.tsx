    ...
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page">
        ...
        <div className="glass-card prose prose-invert max-w-none">
          <p>Energy and carbon AI patterns for enterprise operations.</p><ul><li>Load forecasting and consumption optimization</li><li>Carbon tracking and procurement support</li><li>Request a review at <a href="https://ziontechgroup.com">ziontechgroup.com</a></li></ul><p>See <a href="/services/ai-data-lakehouse-pipelines">data services</a>, then <a href="/contact">contact us</a> or <a href="https://calendly.com/kleber-ziontechgroup">schedule a meeting</a>.</p>
        </div>
