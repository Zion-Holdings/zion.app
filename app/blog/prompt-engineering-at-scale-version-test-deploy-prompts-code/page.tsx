...
export const metadata = {
  ...
  description: 'Prompt Engineering at Scale: Version, Test, and Deploy Prompts Like Code: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/blog/prompt-engineering-at-scale-version-test-deploy-prompts-code',
  },
};
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'Prompt Engineering at Scale: Version, Test, and Deploy Prompts Like Code' }
          ]}
          className="mb-8"
        />
        ...
        <header className="mb-12">
          ...
          <p className="mt-4 text-lg text-slate-300">Prompt Engineering at Scale: Version, Test, and Deploy Prompts Like Code requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
