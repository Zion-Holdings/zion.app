...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Cloud Migration Services: operations handbook | Zion Tech Group" description="Cloud Migration Services: operations handbook" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/cloud-migration-services-operations-handbook/" />
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Cloud Migration Services: operations handbook' }]} className="mb-8" />
