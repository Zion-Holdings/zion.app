...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="MicroSaaS Social Media Manager: operations handbook | Zion Tech Group" description="MicroSaaS Social Media Manager: operations handbook" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/microsaas-social-media-manager-operations-handbook/" />
