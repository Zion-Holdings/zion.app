...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI BOM Procurement: case study | Zion Tech Group" description="AI BOM Procurement: case study" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-bom-procurement-case-study/" />
