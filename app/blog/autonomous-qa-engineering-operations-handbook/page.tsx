        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/ai-observability-2026-3598">Ai Observability 2026 3598</Link></li>
<li><Link href="/blog/ai-autonomous-agents-2026-3620">Ai Autonomous Agents 2026 3620</Link></li>
<li><Link href="/blog/data-warehouse-modernization-2026-3917">Data Warehouse Modernization 2026 3917</Link></li>
<li><Link href="/blog/cloud-native-app-development-2026-1016">Cloud Native App Development 2026 1016</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
