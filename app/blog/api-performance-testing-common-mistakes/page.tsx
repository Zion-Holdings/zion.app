...
export const metadata = {
  ...
  openGraph: {
    title: 'API Performance Testing: common mistakes | Zion Tech Group',
    description: 'API Performance Testing: common mistakes.',
    url: 'https://ziontechgroup.comapp/blog/api-performance-testing-common-mistakes/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/api-performance-testing-common-mistakes/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'API Performance Testing: common mistakes',
  description: 'API Performance Testing: common mistakes.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/api-performance-testing-common-mistakes/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'API Performance Testing: common mistakes' },
      ]}
    >
