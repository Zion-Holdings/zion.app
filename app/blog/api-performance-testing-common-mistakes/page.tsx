...
export const metadata = {
  title: 'Api performance testing common mistakes | Zion Tech Group',
  description: 'Api performance testing common mistakes',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Api performance testing common mistakes',
    description: 'Api performance testing common mistakes',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Api performance testing common mistakes", "description": "Api performance testing common mistakes", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T14:12:25Z", "dateModified": "2026-08-04T14:12:25Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/api-performance-testing-common-mistakes/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Api performance testing common mistakes' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Api performance testing common mistakes</h1>
          <p className="mt-4 text-lg text-slate-300">Api performance testing common mistakes</p>
