        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/cloud-migration-services-2026-3329">Cloud Migration Services 2026 3329</Link></li>
<li><Link href="/blog/apm-application-performance-2026-3289">Apm Application Performance 2026 3289</Link></li>
<li><Link href="/blog/smart-contract-audit-2026-1994">Smart Contract Audit 2026 1994</Link></li>
<li><Link href="/blog/ai-msp-security-compliance-2026-3737">Ai Msp Security Compliance 2026 3737</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
