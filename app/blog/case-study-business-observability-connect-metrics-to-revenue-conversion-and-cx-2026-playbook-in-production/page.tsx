...
export const metadata = {
  ...
  openGraph: {
    title: 'Case study: Business Observability: Connect Metrics to Revenue, Conversion, and CX: 2026 Playbook in production',
    description: 'Business outcome mapping for technical telemetry',
    url: 'https://ziontechgroup.com/blog/case-study-business-observability-connect-metrics-to-revenue-conversion-and-cx-2026-playbook-in-production/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/case-study-business-observability-connect-metrics-to-revenue-conversion-and-cx-2026-playbook-in-production/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Case study: Business Observability: Connect Metrics to Revenue, Conversion, and CX: 2026 Playbook in production' }]} className="mb-8" />
