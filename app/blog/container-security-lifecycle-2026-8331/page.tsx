...
export const metadata = {
  ...
  alternates: { canonical: '/blog/container-security-lifecycle-2026-8331/' },
  openGraph: { title: 'Container Security Lifecycle', description: 'Practical guide to container security lifecycle.', url: 'https://ziontechgroup.com/blog/container-security-lifecycle-2026-8331/', type: 'article' },
...
export default function Page() {
  return (
    <PageShell title="Container Security Lifecycle" description="Practical guide to container security lifecycle: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/container-security-lifecycle-2026-8331/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/container-security-lifecycle-2026-8331/'
    }}>
