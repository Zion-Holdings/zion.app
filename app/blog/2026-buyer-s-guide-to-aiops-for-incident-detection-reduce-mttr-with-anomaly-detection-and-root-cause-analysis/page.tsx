...
export const metadata = {
  ...
  openGraph: {
    title: '2026 buyer's guide to AIOps for Incident Detection: Reduce MTTR with Anomaly Detection and Root Cause Analysis',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/2026-buyer-s-guide-to-aiops-for-incident-detection-reduce-mttr-with-anomaly-detection-and-root-cause-analysis/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/2026-buyer-s-guide-to-aiops-for-incident-detection-reduce-mttr-with-anomaly-detection-and-root-cause-analysis/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: '2026 buyer's guide to AIOps for Incident Detection: Reduce MTTR with Anomaly Detection and Root Cause Analysis' }]} className="mb-8" />
