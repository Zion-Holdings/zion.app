...
export const metadata = {
  title: 'Continuous Delivery: starter template | Zion Tech Group',
  description: 'Continuous Delivery: starter template',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Continuous Delivery: starter template',
    description: 'Continuous Delivery: starter template',
    url: 'https://ziontechgroup.com/blog/continuous-delivery-starter-template/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/continuous-delivery-starter-template/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Continuous Delivery: starter template", "description": "Continuous Delivery: starter template", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:44:26Z", "dateModified": "2026-08-06T18:44:26Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/continuous-delivery-starter-template/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Continuous Delivery: starter template' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Continuous Delivery: starter template</h1>
          <p className="mt-4 text-lg text-slate-300">Continuous Delivery: starter template</p>
...
<li><Link href="/blog/cloud-backup-deployment-patterns">Cloud Backup Deployment Patterns</Link></li>
