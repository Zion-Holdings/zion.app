...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Container Security Lifecycle: starter template | Zion Tech Group" description="Container Security Lifecycle: starter template" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/container-security-lifecycle-starter-template/" />
