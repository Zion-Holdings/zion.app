...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Database Migration Service: ROI and cost model | Zion Tech Group" description="Database Migration Service: ROI and cost model" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/database-migration-service-roi-and-cost-model/" />
