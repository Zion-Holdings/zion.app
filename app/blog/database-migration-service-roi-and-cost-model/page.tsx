...
export const metadata = {
  ...
  openGraph: {
    title: 'Database Migration Service: ROI and cost model | Zion Tech Group',
    description: 'Database Migration Service: ROI and cost model.',
    url: 'https://ziontechgroup.comapp/blog/database-migration-service-roi-and-cost-model/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/database-migration-service-roi-and-cost-model/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'Database Migration Service: ROI and cost model',
  description: 'Database Migration Service: ROI and cost model.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/database-migration-service-roi-and-cost-model/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'Database Migration Service: ROI and cost model' },
      ]}
    >
