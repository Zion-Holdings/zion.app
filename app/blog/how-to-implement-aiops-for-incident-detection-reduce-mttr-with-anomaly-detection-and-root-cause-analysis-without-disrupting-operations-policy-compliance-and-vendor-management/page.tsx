...
export const metadata = {
  ...
  openGraph: {
    title: 'How to implement AIOps for Incident Detection: Reduce MTTR with Anomaly Detection and Root Cause Analysis without disrupting operations: policy, compliance, and vendor management',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/how-to-implement-aiops-for-incident-detection-reduce-mttr-with-anomaly-detection-and-root-cause-analysis-without-disrupting-operations-policy-compliance-and-vendor-management/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/how-to-implement-aiops-for-incident-detection-reduce-mttr-with-anomaly-detection-and-root-cause-analysis-without-disrupting-operations-policy-compliance-and-vendor-management/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'How to implement AIOps for Incident Detection: Reduce MTTR with Anomaly Detection and Root Cause Analysis without disrupting operations: policy, compliance, and vendor management' }]} className="mb-8" />
