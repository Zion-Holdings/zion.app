...
export const metadata = {
  ...
  openGraph: {
    title: 'Container Security at Scale: Image Scanning, Runtime Protection, and Policy Enforcement: costs, ROI, and hidden risks: costs, ROI, and hidden risks',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/container-security-at-scale-image-scanning-runtime-protection-and-policy-enforcement-costs-roi-and-hidden-risks-costs-roi-and-hidden-risks/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/container-security-at-scale-image-scanning-runtime-protection-and-policy-enforcement-costs-roi-and-hidden-risks-costs-roi-and-hidden-risks/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Container Security at Scale: Image Scanning, Runtime Protection, and Policy Enforcement: costs, ROI, and hidden risks: costs, ROI, and hidden risks' }]} className="mb-8" />
