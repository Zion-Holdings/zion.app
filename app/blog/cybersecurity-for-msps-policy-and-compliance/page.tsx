...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Cybersecurity for MSPs: policy and compliance | Zion Tech Group" description="Cybersecurity for MSPs: policy and compliance" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/cybersecurity-for-msps-policy-and-compliance/" />
