...
export const metadata = {
  ...
  openGraph: {
    ...
    description: 'Cloud Cost AI Optimizer: implementation playbook',
    url: 'https://ziontechgroup.com/blog/cloud-cost-ai-optimizer-implementation-playbook/',
    type: 'article',
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/ai-3d-asset-generator-2026-3337">Ai 3D Asset Generator 2026 3337</Link></li>
<li><Link href="/blog/data-warehouse-modernization-2026-2951">Data Warehouse Modernization 2026 2951</Link></li>
<li><Link href="/blog/autonomous-code-deployment-2026-3417">Autonomous Code Deployment 2026 3417</Link></li>
<li><Link href="/blog/ai-accessibility-auditor-2026-3131">Ai Accessibility Auditor 2026 3131</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
