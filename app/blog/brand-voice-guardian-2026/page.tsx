...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Brand Voice Guardian | Zion Tech Group" description="Brand Voice Guardian" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/brand-voice-guardian-2026/" />
