...
export const metadata = {
  ...
  openGraph: {
    title: 'Data Lakehouse on Snowflake or Databricks: When to Choose Which for data teams: 2026 Playbook',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/data-lakehouse-on-snowflake-or-databricks-when-to-choose-which-for-data-teams-2026-playbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/data-lakehouse-on-snowflake-or-databricks-when-to-choose-which-for-data-teams-2026-playbook/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Data Lakehouse on Snowflake or Databricks: When to Choose Which for data teams: 2026 Playbook' }]} className="mb-8" />
