...
export const metadata = {
  ...
  openGraph: {
    title: 'How to implement Real-Time Data Streaming with Kafka and Flink: Event-Driven Architecture without disrupting operations for data teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/how-to-implement-real-time-data-streaming-with-kafka-and-flink-event-driven-architecture-without-disrupting-operations-for-data-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/how-to-implement-real-time-data-streaming-with-kafka-and-flink-event-driven-architecture-without-disrupting-operations-for-data-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'How to implement Real-Time Data Streaming with Kafka and Flink: Event-Driven Architecture without disrupting operations for data teams' }]} className="mb-8" />
