...
export const metadata = {
  ...
  description: 'Container Security at Scale: Image Scanning, Runtime Protection, and Policy Enforcement: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/blog/container-security-at-scale-image-scanning-runtime-protection-policy-enforcement',
  },
};
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'Container Security at Scale: Image Scanning, Runtime Protection, and Policy Enforcement' }
          ]}
          className="mb-8"
        />
        ...
        <header className="mb-12">
          ...
          <p className="mt-4 text-lg text-slate-300">Container Security at Scale: Image Scanning, Runtime Protection, and Policy Enforcement requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
