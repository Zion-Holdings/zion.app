...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Brand Voice Guardian: common mistakes | Zion Tech Group" description="Brand Voice Guardian: common mistakes" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/brand-voice-guardian-common-mistakes/" />
