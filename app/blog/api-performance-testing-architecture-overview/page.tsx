...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="API Performance Testing: architecture overview | Zion Tech Group" description="API Performance Testing: architecture overview" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/api-performance-testing-architecture-overview/" />
