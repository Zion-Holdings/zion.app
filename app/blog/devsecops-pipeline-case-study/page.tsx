...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="DevSecOps Pipeline: case study | Zion Tech Group" description="DevSecOps Pipeline: case study" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/devsecops-pipeline-case-study/" />
