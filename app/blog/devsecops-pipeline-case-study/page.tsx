...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "DevSecOps Pipeline: case study", "description": "DevSecOps Pipeline: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:24:24Z", "dateModified": "2026-08-04T16:24:24Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/devsecops-pipeline-case-study/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'DevSecOps Pipeline: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">DevSecOps Pipeline: case study</h1>
          <p className="mt-4 text-lg text-slate-300">DevSecOps Pipeline: case study</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/micro-saas-ai-translation-engine-2026-1468">Micro Saas Ai Translation Engine 2026 1468</Link></li>
<li><Link href="/blog/ai-agent-tool-builder-2026-927">Ai Agent Tool Builder 2026 927</Link></li>
<li><Link href="/blog/autonomous-code-deployment-2026-3900">Autonomous Code Deployment 2026 3900</Link></li>
<li><Link href="/blog/ai-agent-safety-evaluation-2026-4169">Ai Agent Safety Evaluation 2026 4169</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
