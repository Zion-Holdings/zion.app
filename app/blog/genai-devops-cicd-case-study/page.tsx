...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="GenAI DevOps CI/CD: case study | Zion Tech Group" description="GenAI DevOps CI/CD: case study" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/genai-devops-cicd-case-study/" />
