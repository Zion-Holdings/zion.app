...
export const metadata = {
  title: 'Database Migration Service 2026 | Zion Tech Group',
...
export default function Page() {
  return (
    <StandardPage
      title="Database Migration Service 2026"
      subtitle="Read this article to understand key requirements, patterns, and next steps."
      breadcrumbItems={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog/' }, { label: 'Database Migration Service 2026' }]}
    >
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Database Migration Service 2026</h1>
