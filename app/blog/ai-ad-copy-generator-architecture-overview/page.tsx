...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI Ad Copy Generator: architecture overview | Zion Tech Group" description="AI Ad Copy Generator: architecture overview" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-ad-copy-generator-architecture-overview/" />
