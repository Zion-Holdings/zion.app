...
export const metadata = {
  ...
  openGraph: {
    title: 'AI Ad Copy Generator: architecture overview | Zion Tech Group',
    description: 'AI Ad Copy Generator: architecture overview.',
    url: 'https://ziontechgroup.comapp/blog/ai-ad-copy-generator-architecture-overview/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/ai-ad-copy-generator-architecture-overview/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'AI Ad Copy Generator: architecture overview',
  description: 'AI Ad Copy Generator: architecture overview.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/ai-ad-copy-generator-architecture-overview/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'AI Ad Copy Generator: architecture overview' },
      ]}
    >
