...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Data Analytics Platform: architecture overview | Zion Tech Group" description="Data Analytics Platform: architecture overview" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/data-analytics-platform-architecture-overview/" />
