...
export const metadata = {
  title: 'AI Risk Assessment: common mistakes | Zion Tech Group',
  description: 'AI Risk Assessment: common mistakes',
  keywords: ['ai', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'AI Risk Assessment: common mistakes',
    description: 'AI Risk Assessment: common mistakes',
    url: 'https://ziontechgroup.com/blog/ai-risk-assessment-common-mistakes/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-risk-assessment-common-mistakes/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AI Risk Assessment: common mistakes", "description": "AI Risk Assessment: common mistakes", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:02:18Z", "dateModified": "2026-08-06T18:02:18Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ai-risk-assessment-common-mistakes/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Risk Assessment: common mistakes' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AI Risk Assessment: common mistakes</h1>
          <p className="mt-4 text-lg text-slate-300">AI Risk Assessment: common mistakes</p>
