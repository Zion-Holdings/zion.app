...
export const metadata = {
  title: 'DevOps CI/CD: case study | Zion Tech Group',
  description: 'DevOps CI/CD: case study',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'DevOps CI/CD: case study',
    description: 'DevOps CI/CD: case study',
    url: 'https://ziontechgroup.com/blog/devops-cicd-case-study/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/devops-cicd-case-study/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "DevOps CI/CD: case study", "description": "DevOps CI/CD: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:24:04Z", "dateModified": "2026-08-04T16:24:04Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/devops-cicd-case-study/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'DevOps CI/CD: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">DevOps CI/CD: case study</h1>
          <p className="mt-4 text-lg text-slate-300">DevOps CI/CD: case study</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/ai-msp-security-compliance-2026-1736">Ai Msp Security Compliance 2026 1736</Link></li>
...
<li><Link href="/blog/enterprise-backup-dr-2026-1232">Enterprise Backup Dr 2026 1232</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
