...
export const metadata = {
  title: 'Data Pipeline Orchestration: security and governance | Zion Tech Group',
  description: 'Data Pipeline Orchestration: security and governance',
  keywords: ['data', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Data Pipeline Orchestration: security and governance',
    description: 'Data Pipeline Orchestration: security and governance',
    url: 'https://ziontechgroup.com/blog/data-pipeline-orchestration-security-and-governance/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/data-pipeline-orchestration-security-and-governance/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Data Pipeline Orchestration: security and governance' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Data Pipeline Orchestration: security and governance</h1>
          <p className="mt-4 text-lg text-slate-300">Data Pipeline Orchestration: security and governance</p>
