...
export const metadata = {
  ...
  openGraph: {
    title: 'Automation and scaling patterns for Case study: Computer Vision for Retail: Shelf Monitoring, Foot Traffic, and Loss Prevention in production',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/automation-and-scaling-patterns-for-case-study-computer-vision-for-retail-shelf-monitoring-foot-traffic-and-loss-prevention-in-production/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/automation-and-scaling-patterns-for-case-study-computer-vision-for-retail-shelf-monitoring-foot-traffic-and-loss-prevention-in-production/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Automation and scaling patterns for Case study: Computer Vision for Retail: Shelf Monitoring, Foot Traffic, and Loss Prevention in production' }]} className="mb-8" />
