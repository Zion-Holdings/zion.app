...
export default function Page() {
  return (
    <PageShell title="Network Infrastructure" description="Practical guide to network infrastructure: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/network-infrastructure-2026-8158/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/network-infrastructure-2026-8158/'
    }}>
