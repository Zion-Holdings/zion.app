...
export const metadata = {
  title: 'Error Budget: deployment patterns | Zion Tech Group',
  description: 'Error Budget: deployment patterns',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Error Budget: deployment patterns',
    description: 'Error Budget: deployment patterns',
    url: 'https://ziontechgroup.com/blog/error-budget-deployment-patterns/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/error-budget-deployment-patterns/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Error Budget: deployment patterns", "description": "Error Budget: deployment patterns", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:02:59Z", "dateModified": "2026-08-06T18:02:59Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/error-budget-deployment-patterns/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Error Budget: deployment patterns' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Error Budget: deployment patterns</h1>
          <p className="mt-4 text-lg text-slate-300">Error Budget: deployment patterns</p>
