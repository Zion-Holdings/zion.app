        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/container-security-lifecycle-2026-3708">Container Security Lifecycle 2026 3708</Link></li>
<li><Link href="/blog/ai-bdr-sdr-2026-3074">Ai Bdr Sdr 2026 3074</Link></li>
<li><Link href="/blog/automated-ai-reporting-2026-4037">Automated Ai Reporting 2026 4037</Link></li>
<li><Link href="/blog/brand-voice-guardian-2026-1972">Brand Voice Guardian 2026 1972</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
