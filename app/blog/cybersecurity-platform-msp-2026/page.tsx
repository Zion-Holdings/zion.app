...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Cybersecurity for MSPs | Zion Tech Group" description="Cybersecurity for MSPs" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/cybersecurity-platform-msp-2026/" />
