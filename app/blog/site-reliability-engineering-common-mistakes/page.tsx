...
export const metadata = {
  title: 'Site Reliability Engineering: common mistakes | Zion Tech Group',
  description: 'Site Reliability Engineering: common mistakes',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Site Reliability Engineering: common mistakes',
    description: 'Site Reliability Engineering: common mistakes',
    url: 'https://ziontechgroup.com/blog/site-reliability-engineering-common-mistakes/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/site-reliability-engineering-common-mistakes/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Site Reliability Engineering: common mistakes", "description": "Site Reliability Engineering: common mistakes", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:04:05Z", "dateModified": "2026-08-06T18:04:05Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/site-reliability-engineering-common-mistakes/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Site Reliability Engineering: common mistakes' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Site Reliability Engineering: common mistakes</h1>
          <p className="mt-4 text-lg text-slate-300">Site Reliability Engineering: common mistakes</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link /blog/ai-observability-2026-7048/>Ai Observability 2026 7048</Link></li>
