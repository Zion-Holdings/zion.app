        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/container-security-lifecycle-2026-4191">Container Security Lifecycle 2026 4191</Link></li>
<li><Link href="/blog/ai-it-operations-automation-2026-3175">Ai It Operations Automation 2026 3175</Link></li>
<li><Link href="/blog/devsecops-pipeline-2026-3023">Devsecops Pipeline 2026 3023</Link></li>
<li><Link href="/blog/ai-agentic-workflows-2026-3412">Ai Agentic Workflows 2026 3412</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
