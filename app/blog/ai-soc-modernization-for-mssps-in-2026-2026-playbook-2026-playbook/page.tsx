...
export const metadata = {
  ...
  openGraph: {
    title: 'AI SOC Modernization for MSSPs in 2026: 2026 Playbook: 2026 Playbook',
    description: 'MSSP-specific playbook with tooling comparisons',
    url: 'https://ziontechgroup.com/blog/ai-soc-modernization-for-mssps-in-2026-2026-playbook-2026-playbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-soc-modernization-for-mssps-in-2026-2026-playbook-2026-playbook/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI SOC Modernization for MSSPs in 2026: 2026 Playbook: 2026 Playbook' }]} className="mb-8" />
