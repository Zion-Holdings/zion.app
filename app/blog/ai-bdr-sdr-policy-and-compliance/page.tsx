...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI BDR SDR: policy and compliance | Zion Tech Group" description="AI BDR SDR: policy and compliance" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-bdr-sdr-policy-and-compliance/" />
