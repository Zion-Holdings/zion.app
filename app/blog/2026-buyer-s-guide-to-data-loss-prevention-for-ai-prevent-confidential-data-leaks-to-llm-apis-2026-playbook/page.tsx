...
export const metadata = {
  ...
  openGraph: {
    title: '2026 buyer's guide to Data Loss Prevention for AI: Prevent Confidential Data Leaks to LLM APIs: 2026 Playbook',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/2026-buyer-s-guide-to-data-loss-prevention-for-ai-prevent-confidential-data-leaks-to-llm-apis-2026-playbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/2026-buyer-s-guide-to-data-loss-prevention-for-ai-prevent-confidential-data-leaks-to-llm-apis-2026-playbook/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: '2026 buyer's guide to Data Loss Prevention for AI: Prevent Confidential Data Leaks to LLM APIs: 2026 Playbook' }]} className="mb-8" />
