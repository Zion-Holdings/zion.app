...
export const metadata = {
  ...
  openGraph: {
    title: 'FinOps Maturity Model: From Cloud Cost Visibility to Automated Optimization checklist for IT and security leaders for cloud teams',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/finops-maturity-model-from-cloud-cost-visibility-to-automated-optimization-checklist-for-it-and-security-leaders-for-cloud-teams/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/finops-maturity-model-from-cloud-cost-visibility-to-automated-optimization-checklist-for-it-and-security-leaders-for-cloud-teams/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'FinOps Maturity Model: From Cloud Cost Visibility to Automated Optimization checklist for IT and security leaders for cloud teams' }]} className="mb-8" />
