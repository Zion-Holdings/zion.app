...
export const metadata = {
  ...
  description: 'Nebius Ai Cloud Partnership Model For Latam: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
    title: 'Nebius Ai Cloud Partnership Model For Latam',
    description: 'Nebius Ai Cloud Partnership Model For Latam: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
    url: 'https://ziontechgroup.com/blog/nebius-ai-cloud-partnership-model-for-latam',
    type: 'article',
  },
  alternates: {
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'Nebius Ai Cloud Partnership Model For Latam' }
          ]}
          className="mb-8"
        />
        ...
        <header className="mb-12">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Nebius Ai Cloud Partnership Model For Latam</h1>
          <p className="mt-4 text-lg text-slate-300">Nebius Ai Cloud Partnership Model For Latam requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
