export const metadata = {
  ...
  description: "A practical partnership model for Nebius AI cloud expansion in LATAM through local delivery, managed services, and support.",
...
<p>Nebius AI cloud expansion in LATAM benefits from a local partner model that combines delivery capability, managed services, and regional support.</p>
