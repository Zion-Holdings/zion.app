...
export const metadata = {
  title: 'Microservices Architecture: architecture overview | Zion Tech Group',
  description: 'Microservices Architecture: architecture overview',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Microservices Architecture: architecture overview',
    description: 'Microservices Architecture: architecture overview',
    url: 'https://ziontechgroup.com/blog/microservices-architecture-architecture-overview/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/microservices-architecture-architecture-overview/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Microservices Architecture: architecture overview", "description": "Microservices Architecture: architecture overview", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:11:14Z", "dateModified": "2026-08-06T18:11:14Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/microservices-architecture-architecture-overview/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Microservices Architecture: architecture overview' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Microservices Architecture: architecture overview</h1>
          <p className="mt-4 text-lg text-slate-300">Microservices Architecture: architecture overview</p>
...
<li><Link href="/blog/business-intelligence-common-mistakes">Business Intelligence Common Mistakes</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
