...
export const metadata = {
  title: 'Application Modernization: checklist for IT leaders | Zion Tech Group',
  description: 'Application Modernization: checklist for IT leaders',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Application Modernization: checklist for IT leaders',
    description: 'Application Modernization: checklist for IT leaders',
    url: 'https://ziontechgroup.com/blog/application-modernization-checklist-for-it-leaders/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/application-modernization-checklist-for-it-leaders/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Application Modernization: checklist for IT leaders", "description": "Application Modernization: checklist for IT leaders", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:12:25Z", "dateModified": "2026-08-06T18:12:25Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/application-modernization-checklist-for-it-leaders/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Application Modernization: checklist for IT leaders' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Application Modernization: checklist for IT leaders</h1>
          <p className="mt-4 text-lg text-slate-300">Application Modernization: checklist for IT leaders</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/business-intelligence-implementation-playbook">Business Intelligence Implementation Playbook</Link></li>
