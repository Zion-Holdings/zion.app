...
export const metadata = {
  ...
  openGraph: {
    title: 'Time Series Analytics for IoT: Ingest, Store, and Query Sensor Data at Scale: policy, compliance, and vendor management',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/time-series-analytics-for-iot-ingest-store-and-query-sensor-data-at-scale-policy-compliance-and-vendor-management/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/time-series-analytics-for-iot-ingest-store-and-query-sensor-data-at-scale-policy-compliance-and-vendor-management/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Time Series Analytics for IoT: Ingest, Store, and Query Sensor Data at Scale: policy, compliance, and vendor management' }]} className="mb-8" />
