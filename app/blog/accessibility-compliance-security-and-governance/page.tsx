...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Accessibility Compliance: security and governance | Zion Tech Group" description="Accessibility Compliance: security and governance" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/accessibility-compliance-security-and-governance/" />
