...
export const metadata = {
  title: 'Data Compliance: case study | Zion Tech Group',
  description: 'Data Compliance: case study',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Data Compliance: case study',
    description: 'Data Compliance: case study',
    url: 'https://ziontechgroup.com/blog/data-compliance-case-study/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/data-compliance-case-study/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Data Compliance: case study", "description": "Data Compliance: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:07:06Z", "dateModified": "2026-08-06T18:07:06Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/data-compliance-case-study/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Data Compliance: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Data Compliance: case study</h1>
          <p className="mt-4 text-lg text-slate-300">Data Compliance: case study</p>
