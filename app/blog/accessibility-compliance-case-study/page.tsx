...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Accessibility Compliance: case study | Zion Tech Group" description="Accessibility Compliance: case study" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/accessibility-compliance-case-study/" />
