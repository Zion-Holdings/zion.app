...
export const metadata = {
  title: 'Accessibility Compliance: case study | Zion Tech Group',
  description: 'Accessibility Compliance: case study',
  keywords: ['cloud', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Accessibility Compliance: case study',
    description: 'Accessibility Compliance: case study',
    url: 'https://ziontechgroup.com/blog/accessibility-compliance-case-study/',
    type: 'article',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Accessibility Compliance: case study", "description": "Accessibility Compliance: case study", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:13:37Z", "dateModified": "2026-08-04T16:13:37Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/accessibility-compliance-case-study/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Accessibility Compliance: case study' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Accessibility Compliance: case study</h1>
          <p className="mt-4 text-lg text-slate-300">Accessibility Compliance: case study</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/cloud-cost-ai-optimizer-2026-2118">Cloud Cost Ai Optimizer 2026 2118</Link></li>
<li><Link href="/blog/chaos-engineering-2026-3773">Chaos Engineering 2026 3773</Link></li>
<li><Link href="/blog/apm-application-performance-2026-3565">Apm Application Performance 2026 3565</Link></li>
<li><Link href="/blog/ai-api-gateway-2026-4067">Ai Api Gateway 2026 4067</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
