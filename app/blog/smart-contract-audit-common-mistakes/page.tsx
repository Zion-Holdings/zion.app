...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Smart Contract Audit: common mistakes | Zion Tech Group" description="Smart Contract Audit: common mistakes" datePublished="2026-08-11" url="https://ziontechgroup.com/blog/smart-contract-audit-common-mistakes/" />
