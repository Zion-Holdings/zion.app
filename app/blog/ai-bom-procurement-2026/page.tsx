...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="AI BOM Procurement | Zion Tech Group" description="AI BOM Procurement" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/ai-bom-procurement-2026/" />
