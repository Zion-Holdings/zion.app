...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Event Driven Architecture: implementation playbook | Zion Tech Group" description="Event Driven Architecture: implementation playbook" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/event-driven-architecture-implementation-playbook/" />
