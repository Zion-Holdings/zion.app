...
export const metadata = {
  ...
  openGraph: {
    title: 'Comparing Feature Store for Machine Learning: Centralize Features for Training and Inference for data teams: vendors and build vs buy',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/comparing-feature-store-for-machine-learning-centralize-features-for-training-and-inference-for-data-teams-vendors-and-build-vs-buy/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/comparing-feature-store-for-machine-learning-centralize-features-for-training-and-inference-for-data-teams-vendors-and-build-vs-buy/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Comparing Feature Store for Machine Learning: Centralize Features for Training and Inference for data teams: vendors and build vs buy' }]} className="mb-8" />
