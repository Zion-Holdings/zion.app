...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Automation Orchestration: evaluation framework", "description": "Automation Orchestration: evaluation framework", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:39:50Z", "dateModified": "2026-08-04T16:39:50Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/automation-orchestration-evaluation-framework/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Automation Orchestration: evaluation framework' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Automation Orchestration: evaluation framework</h1>
          <p className="mt-4 text-lg text-slate-300">Automation Orchestration: evaluation framework</p>
...
<li><Link href="/blog/endpoint-management-2026-2611">Endpoint Management 2026 2611</Link></li>
<li><Link href="/blog/endpoint-management-2026-1576">Endpoint Management 2026 1576</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
