...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Automation Orchestration: evaluation framework | Zion Tech Group" description="Automation Orchestration: evaluation framework" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/automation-orchestration-evaluation-framework/" />
