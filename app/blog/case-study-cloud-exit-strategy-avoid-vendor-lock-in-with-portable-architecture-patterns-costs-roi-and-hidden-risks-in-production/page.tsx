...
export const metadata = {
  ...
  openGraph: {
    title: 'Case study: Cloud Exit Strategy: Avoid Vendor Lock-In with Portable Architecture Patterns: costs, ROI, and hidden risks in production',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/case-study-cloud-exit-strategy-avoid-vendor-lock-in-with-portable-architecture-patterns-costs-roi-and-hidden-risks-in-production/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/case-study-cloud-exit-strategy-avoid-vendor-lock-in-with-portable-architecture-patterns-costs-roi-and-hidden-risks-in-production/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Case study: Cloud Exit Strategy: Avoid Vendor Lock-In with Portable Architecture Patterns: costs, ROI, and hidden risks in production' }]} className="mb-8" />
