...
export const metadata = {
  ...
  description: 'Ai Itsm Modernization Playbook 2026: practical execution model, measurable guardrails, and next actions for IT and AI leaders.',
  openGraph: {
    ...
    <div className="relative min-h-screen bg-slate-950">
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <header className="mb-12">
          ...
          <p className="mt-4 text-lg text-slate-300">Ai Itsm Modernization Playbook 2026 requires measurable guardrails, repeatable workflows, and clear ownership.</p>
        </header>
