        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link /blog/itil-checklist-for-it-leaders/>Itil Checklist For It Leaders</Link></li>
<li><Link /blog/network-security-checklist-for-it-leaders/>Network Security Checklist For It Leaders</Link></li>
