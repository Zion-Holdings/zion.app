...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Chaos Engineering: executive guide", "description": "Chaos Engineering: executive guide", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:15:35Z", "dateModified": "2026-08-04T16:15:35Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/chaos-engineering-executive-guide/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Chaos Engineering: executive guide' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Chaos Engineering: executive guide</h1>
          <p className="mt-4 text-lg text-slate-300">Chaos Engineering: executive guide</p>
...
<li><Link href="/blog/brand-voice-guardian-2026-799">Brand Voice Guardian 2026 799</Link></li>
<li><Link href="/blog/devops-cicd-2026-3744">Devops Cicd 2026 3744</Link></li>
<li><Link href="/blog/database-migration-service-2026-2952">Database Migration Service 2026 2952</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
