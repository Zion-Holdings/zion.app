...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Chaos Engineering: executive guide | Zion Tech Group" description="Chaos Engineering: executive guide" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/chaos-engineering-executive-guide/" />
