...
export const metadata = {
  title: 'Google Cloud Migration | Zion Tech Group',
  description: 'Google Cloud Migration',
  keywords: ['cloud', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Google Cloud Migration',
    description: 'Google Cloud Migration',
    url: 'https://ziontechgroup.com/blog/google-cloud-migration-2026/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/google-cloud-migration-2026/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Google Cloud Migration", "description": "Google Cloud Migration", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:01:11Z", "dateModified": "2026-08-06T18:01:11Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/google-cloud-migration-2026/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Google Cloud Migration' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Google Cloud Migration</h1>
          <p className="mt-4 text-lg text-slate-300">Google Cloud Migration</p>
...
<li><Link /blog/ai-customer-success-churn-2026-6982/>Ai Customer Success Churn 2026 6982</Link></li>
