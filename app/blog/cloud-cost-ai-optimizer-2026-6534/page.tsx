...
export const metadata = {
  ...
  alternates: { canonical: '/blog/cloud-cost-ai-optimizer-2026-6534/' },
  openGraph: { title: 'Cloud Cost AI Optimizer', description: 'Practical guide to cloud cost ai optimizer.', url: 'https://ziontechgroup.com/blog/cloud-cost-ai-optimizer-2026-6534/', type: 'article' },
...
export default function Page() {
  return (
    <PageShell title="Cloud Cost AI Optimizer" description="Practical guide to cloud cost ai optimizer: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/cloud-cost-ai-optimizer-2026-6534/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/cloud-cost-ai-optimizer-2026-6534/'
    }}>
