...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="GraphQL Federation Platform: security and governance | Zion Tech Group" description="GraphQL Federation Platform: security and governance" datePublished="2026-08-11" url="https://ziontechgroup.com/blog/graphql-federation-platform-security-and-governance/" />
