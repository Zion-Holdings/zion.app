...
<li><Link href="/blog/accessibility-compliance-2026-9011">Accessibility Compliance 2026 9011</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
