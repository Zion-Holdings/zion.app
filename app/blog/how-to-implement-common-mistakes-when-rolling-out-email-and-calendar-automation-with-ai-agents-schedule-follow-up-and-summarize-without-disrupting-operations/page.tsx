...
export const metadata = {
  ...
  openGraph: {
    title: 'How to implement Common mistakes when rolling out Email and Calendar Automation with AI Agents: Schedule, Follow Up, and Summarize without disrupting operations',
    description: 'Practical workflow integration instead of generic assistant demos',
    url: 'https://ziontechgroup.com/blog/how-to-implement-common-mistakes-when-rolling-out-email-and-calendar-automation-with-ai-agents-schedule-follow-up-and-summarize-without-disrupting-operations/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/how-to-implement-common-mistakes-when-rolling-out-email-and-calendar-automation-with-ai-agents-schedule-follow-up-and-summarize-without-disrupting-operations/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'How to implement Common mistakes when rolling out Email and Calendar Automation with AI Agents: Schedule, Follow Up, and Summarize without disrupting operations' }]} className="mb-8" />
