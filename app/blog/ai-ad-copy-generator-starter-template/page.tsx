...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "AI Ad Copy Generator: starter template", "description": "AI Ad Copy Generator: starter template", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-04T16:14:17Z", "dateModified": "2026-08-04T16:14:17Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/ai-ad-copy-generator-starter-template/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Ad Copy Generator: starter template' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">AI Ad Copy Generator: starter template</h1>
          <p className="mt-4 text-lg text-slate-300">AI Ad Copy Generator: starter template</p>
...
<li><Link href="/blog/container-security-lifecycle-2026-603">Container Security Lifecycle 2026 603</Link></li>
<li><Link href="/blog/devsecops-pipeline-2026-746">Devsecops Pipeline 2026 746</Link></li>
<li><Link href="/blog/api-orchestration-layer-2026-2587">Api Orchestration Layer 2026 2587</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
