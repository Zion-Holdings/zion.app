        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/apm-application-performance-2026-1357">Apm Application Performance 2026 1357</Link></li>
...
<li><Link href="/blog/ai-bom-procurement-2026-1626">Ai Bom Procurement 2026 1626</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
