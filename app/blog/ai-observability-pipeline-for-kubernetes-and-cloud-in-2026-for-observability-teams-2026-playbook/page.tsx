...
export const metadata = {
  ...
  openGraph: {
    title: 'AI Observability Pipeline for Kubernetes and Cloud in 2026 for observability teams: 2026 Playbook',
    description: 'Unified metrics, logs, traces, and events pipeline',
    url: 'https://ziontechgroup.com/blog/ai-observability-pipeline-for-kubernetes-and-cloud-in-2026-for-observability-teams-2026-playbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/ai-observability-pipeline-for-kubernetes-and-cloud-in-2026-for-observability-teams-2026-playbook/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'AI Observability Pipeline for Kubernetes and Cloud in 2026 for observability teams: 2026 Playbook' }]} className="mb-8" />
