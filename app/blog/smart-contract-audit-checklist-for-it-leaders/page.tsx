...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Smart Contract Audit: checklist for IT leaders | Zion Tech Group" description="Smart Contract Audit: checklist for IT leaders" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/smart-contract-audit-checklist-for-it-leaders/" />
