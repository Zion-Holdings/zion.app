...
export const metadata = {
  title: 'Technical Due Diligence: executive guide | Zion Tech Group',
  description: 'Technical Due Diligence: executive guide',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Technical Due Diligence: executive guide',
    description: 'Technical Due Diligence: executive guide',
    url: 'https://ziontechgroup.com/blog/technical-due-diligence-executive-guide/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/technical-due-diligence-executive-guide/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Technical Due Diligence: executive guide", "description": "Technical Due Diligence: executive guide", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:03:22Z", "dateModified": "2026-08-06T18:03:22Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/technical-due-diligence-executive-guide/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Technical Due Diligence: executive guide' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Technical Due Diligence: executive guide</h1>
          <p className="mt-4 text-lg text-slate-300">Technical Due Diligence: executive guide</p>
