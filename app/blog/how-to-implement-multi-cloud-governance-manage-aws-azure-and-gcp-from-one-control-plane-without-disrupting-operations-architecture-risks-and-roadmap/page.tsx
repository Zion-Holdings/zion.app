...
export const metadata = {
  ...
  openGraph: {
    title: 'How to implement Multi-Cloud Governance: Manage AWS, Azure, and GCP from One Control Plane without disrupting operations: architecture, risks, and roadmap',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/how-to-implement-multi-cloud-governance-manage-aws-azure-and-gcp-from-one-control-plane-without-disrupting-operations-architecture-risks-and-roadmap/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/how-to-implement-multi-cloud-governance-manage-aws-azure-and-gcp-from-one-control-plane-without-disrupting-operations-architecture-risks-and-roadmap/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'How to implement Multi-Cloud Governance: Manage AWS, Azure, and GCP from One Control Plane without disrupting operations: architecture, risks, and roadmap' }]} className="mb-8" />
