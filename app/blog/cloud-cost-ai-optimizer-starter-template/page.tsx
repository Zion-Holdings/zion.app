...
export const metadata = {
  ...
  openGraph: {
    title: 'Cloud Cost AI Optimizer: starter template | Zion Tech Group',
    description: 'Cloud Cost AI Optimizer: starter template.',
    url: 'https://ziontechgroup.comapp/blog/cloud-cost-ai-optimizer-starter-template/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/cloud-cost-ai-optimizer-starter-template/' },
};
...
const jsonLd = {
  ...
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/cloud-cost-ai-optimizer-starter-template/'
};
