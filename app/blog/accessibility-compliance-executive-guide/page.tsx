...
export const metadata = {
  ...
  description: 'Accessibility Compliance: executive guide',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Accessibility Compliance: executive guide", "description": "Accessibility Compliance: executive guide", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-17T17:20:21Z", "dateModified": "2026-08-17T17:20:21Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/accessibility-compliance-executive-guide/"};
  ...
  return (
    ...
    >
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Accessibility Compliance: executive guide' }]} className="mb-8" />
        <header className="mb-10">
          ...
          <p className="mt-4 text-lg text-slate-300">Accessibility Compliance: executive guide</p>
