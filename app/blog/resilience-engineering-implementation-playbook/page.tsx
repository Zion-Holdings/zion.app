...
export const metadata = {
  title: 'Resilience Engineering: implementation playbook | Zion Tech Group',
  description: 'Resilience Engineering: implementation playbook',
  keywords: ['it', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Resilience Engineering: implementation playbook',
    description: 'Resilience Engineering: implementation playbook',
    url: 'https://ziontechgroup.com/blog/resilience-engineering-implementation-playbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/resilience-engineering-implementation-playbook/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Resilience Engineering: implementation playbook", "description": "Resilience Engineering: implementation playbook", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:03:17Z", "dateModified": "2026-08-06T18:03:17Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/resilience-engineering-implementation-playbook/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Resilience Engineering: implementation playbook' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Resilience Engineering: implementation playbook</h1>
          <p className="mt-4 text-lg text-slate-300">Resilience Engineering: implementation playbook</p>
