...
export const metadata = {
  ...
  openGraph: {
    title: 'Event Driven Architecture: checklist for IT leaders | Zion Tech Group',
    description: 'Event Driven Architecture: checklist for IT leaders.',
    url: 'https://ziontechgroup.comapp/blog/event-driven-architecture-checklist-for-it-leaders/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/event-driven-architecture-checklist-for-it-leaders/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'Event Driven Architecture: checklist for IT leaders',
  description: 'Event Driven Architecture: checklist for IT leaders.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/event-driven-architecture-checklist-for-it-leaders/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'Event Driven Architecture: checklist for IT leaders' },
      ]}
    >
