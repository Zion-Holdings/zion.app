...
export const metadata = {
  ...
  openGraph: {
    title: 'GenAI DevOps CI/CD: policy and compliance | Zion Tech Group',
    description: 'GenAI DevOps CI/CD: policy and compliance.',
    url: 'https://ziontechgroup.comapp/blog/genai-devops-cicd-policy-and-compliance/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: 'app/blog/genai-devops-cicd-policy-and-compliance/' },
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'TechArticle',
  headline: 'GenAI DevOps CI/CD: policy and compliance',
  description: 'GenAI DevOps CI/CD: policy and compliance.',
  author: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  publisher: { '@type': 'Organization', name: 'Zion Tech Group', url: 'https://ziontechgroup.com' },
  datePublished: '2026-08-17T11:00:00Z',
  dateModified: '2026-08-17T11:00:00Z',
  mainEntityOfPage: 'https://ziontechgroup.comapp/blog/genai-devops-cicd-policy-and-compliance/'
};
  ...
  return (
    <StandardPage
      ...
      breadcrumbItems={[
        ...
        { label: 'GenAI DevOps CI/CD: policy and compliance' },
      ]}
    >
