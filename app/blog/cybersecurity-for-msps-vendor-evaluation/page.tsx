        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/managed-it-services-small-business-2026-3661">Managed It Services Small Business 2026 3661</Link></li>
<li><Link href="/blog/cybersecurity-platform-msp-2026-4281">Cybersecurity Platform Msp 2026 4281</Link></li>
<li><Link href="/blog/event-driven-architecture-2026-2752">Event Driven Architecture 2026 2752</Link></li>
