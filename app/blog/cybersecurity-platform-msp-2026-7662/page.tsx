...
export const metadata = {
  ...
  alternates: { canonical: '/blog/cybersecurity-platform-msp-2026-7662/' },
  openGraph: { title: 'Cybersecurity for MSPs', description: 'Practical guide to cybersecurity for msps.', url: 'https://ziontechgroup.com/blog/cybersecurity-platform-msp-2026-7662/', type: 'article' },
  twitter: { card: 'summary_large_image', title: 'Cybersecurity for MSPs', description: 'Practical guide to cybersecurity for msps.' }
};

export default function Page() {
  return (
    <PageShell title="Cybersecurity for MSPs" description="Practical guide to cybersecurity for msps: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/cybersecurity-platform-msp-2026-7662/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/cybersecurity-platform-msp-2026-7662/'
    }}>
