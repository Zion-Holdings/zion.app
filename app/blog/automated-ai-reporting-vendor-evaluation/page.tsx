...
export default function Page() {
  return (
    ...
    <BlogPostStructuredData title="Automated AI Reporting: vendor evaluation | Zion Tech Group" description="Automated AI Reporting: vendor evaluation" datePublished="2026-08-07" url="https://ziontechgroup.com/blog/automated-ai-reporting-vendor-evaluation/" />
