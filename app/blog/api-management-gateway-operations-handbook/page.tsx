        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/api-performance-testing-2026-2482">Api Performance Testing 2026 2482</Link></li>
<li><Link href="/blog/micro-saas-ai-expense-tracker-2026-3884">Micro Saas Ai Expense Tracker 2026 3884</Link></li>
<li><Link href="/blog/event-driven-architecture-2026-1717">Event Driven Architecture 2026 1717</Link></li>
