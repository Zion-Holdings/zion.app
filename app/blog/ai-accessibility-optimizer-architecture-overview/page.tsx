        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/aiops-anomaly-detection-2026-2793">Aiops Anomaly Detection 2026 2793</Link></li>
<li><Link href="/blog/cloud-cost-optimization-checklist-2026-1382">Cloud Cost Optimization Checklist 2026 1382</Link></li>
<li><Link href="/blog/database-migration-service-2026-399">Database Migration Service 2026 399</Link></li>
<li><Link href="/blog/container-security-lifecycle-2026-3225">Container Security Lifecycle 2026 3225</Link></li>
            </ul>
          </div>
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
