...
export const metadata = {
  title: 'Terraform: operations handbook | Zion Tech Group',
  description: 'Terraform: operations handbook',
  keywords: ['automation', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Terraform: operations handbook',
    description: 'Terraform: operations handbook',
    url: 'https://ziontechgroup.com/blog/terraform-operations-handbook/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/terraform-operations-handbook/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Terraform: operations handbook", "description": "Terraform: operations handbook", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:12:57Z", "dateModified": "2026-08-06T18:12:57Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/terraform-operations-handbook/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Terraform: operations handbook' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Terraform: operations handbook</h1>
          <p className="mt-4 text-lg text-slate-300">Terraform: operations handbook</p>
...
<li><Link href="/blog/virtual-cto-policy-and-compliance">Virtual Cto Policy And Compliance</Link></li>
<li><Link href="/blog/managed-detection-response-security-and-governance">Managed Detection Response Security And Governance</Link></li>
