    ...
    >
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <header className="mb-10">
          ...
          <p className="mt-4 text-lg text-slate-300">API Orchestration Layer: implementation playbook</p>
