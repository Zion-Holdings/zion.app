...
export const metadata = {
  ...
  openGraph: {
    title: 'Common mistakes when rolling out Common mistakes when rolling out Business Observability: Connect Metrics to Revenue, Conversion, and Customer Experience',
    description: 'Execution-focused AI/IT playbook',
    url: 'https://ziontechgroup.com/blog/common-mistakes-when-rolling-out-common-mistakes-when-rolling-out-business-observability-connect-metrics-to-revenue-conversion-and-customer-experience/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/common-mistakes-when-rolling-out-common-mistakes-when-rolling-out-business-observability-connect-metrics-to-revenue-conversion-and-customer-experience/' },
};
  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Common mistakes when rolling out Common mistakes when rolling out Business Observability: Connect Metrics to Revenue, Conversion, and Customer Experience' }]} className="mb-8" />
