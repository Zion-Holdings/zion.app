...
export const metadata = {
  title: 'Blockchain Enterprise: starter template | Zion Tech Group',
  description: 'Blockchain Enterprise: starter template',
  keywords: ['security', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Blockchain Enterprise: starter template',
    description: 'Blockchain Enterprise: starter template',
    url: 'https://ziontechgroup.com/blog/blockchain-enterprise-starter-template/',
    type: 'article',
    siteName: 'Zion Tech Group',
  },
  alternates: { canonical: '/blog/blockchain-enterprise-starter-template/' },
};

const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Blockchain Enterprise: starter template", "description": "Blockchain Enterprise: starter template", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-06T18:11:13Z", "dateModified": "2026-08-06T18:11:13Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/blockchain-enterprise-starter-template/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: 'Home', href: '/' }, { label: 'Blog', href: '/blog' }, { label: 'Blockchain Enterprise: starter template' }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Blockchain Enterprise: starter template</h1>
          <p className="mt-4 text-lg text-slate-300">Blockchain Enterprise: starter template</p>
        ...
        <section className="mt-12 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-violet-500/30 bg-slate-900/60 p-6">
            ...
            <ul className="list-disc pl-6 text-slate-300 space-y-2">
              <li><Link href="/blog/customer-data-platform-implementation-playbook">Customer Data Platform Implementation Playbook</Link></li>
