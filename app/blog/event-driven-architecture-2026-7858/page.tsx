...
export const metadata = {
  ...
  alternates: { canonical: '/blog/event-driven-architecture-2026-7858/' },
  openGraph: { title: 'Event Driven Architecture', description: 'Practical guide to event driven architecture.', url: 'https://ziontechgroup.com/blog/event-driven-architecture-2026-7858/', type: 'article' },
...
export default function Page() {
  return (
    <PageShell title="Event Driven Architecture" description="Practical guide to event driven architecture: frameworks, metrics, and rollout playbook." canonical="https://ziontechgroup.com/blog/event-driven-architecture-2026-7858/" jsonLd={{
      ...
      mainEntityOfPage: 'https://ziontechgroup.com/blog/event-driven-architecture-2026-7858/'
    }}>
