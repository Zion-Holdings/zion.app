...
export const metadata = {
  title: 'Chaos Engineering: deployment patterns | Zion Tech Group',
  description: 'Chaos Engineering: deployment patterns',
  keywords: ['cloud', 'guide', 'AI services', 'IT services', 'Zion Tech Group'],
  authors: { name: 'Zion Tech Group' },
  openGraph: {
    title: 'Chaos Engineering: deployment patterns',
    description: 'Chaos Engineering: deployment patterns',
    url: 'https://ziontechgroup.com/blog/chaos-engineering-deployment-patterns/',
    type: 'article',
...
const jsonLd = {"@context": "https://schema.org", "@type": "TechArticle", "headline": "Chaos Engineering: deployment patterns", "description": "Chaos Engineering: deployment patterns", "author": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "publisher": {"@type": "Organization", "name": "Zion Tech Group", "url": "https://ziontechgroup.com"}, "datePublished": "2026-08-18T09:14:16Z", "dateModified": "2026-08-18T09:14:16Z", "mainEntityOfPage": "https://ziontechgroup.com/blog/chaos-engineering-deployment-patterns/"};

export default function Page() {
  return (
    <div className="relative min-h-screen bg-slate-950">
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs items={[{ label: "Home", href: "/" }, { label: "Blog", href: "/blog/" }, { label: "Chaos Engineering: deployment patterns" }]} className="mb-8" />
        <header className="mb-10">
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">Chaos Engineering: deployment patterns</h1>
          <p className="mt-4 text-lg text-slate-300">Chaos Engineering: deployment patterns</p>
