...
export const metadata: Metadata = {
  ...
  description: 'Automated API testing platform for validating endpoints, monitoring uptime, and detecting integration issues.',
  alternates: { canonical: '/zion-ai-api-tester/' },
};
