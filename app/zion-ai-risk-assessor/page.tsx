...
export const metadata: Metadata = {
  ...
  description: 'Automated risk assessment platform for evaluating AI, security, and operational risks across enterprise systems.',
  alternates: { canonical: '/zion-ai-risk-assessor/' },
};

export default function Page() {
  return (
    <PageTemplate
      title="Zion AI Risk Assessor"
      description="Automated risk assessment platform for evaluating AI, security, and operational risks across enterprise systems."
      actions={[
