...
export const metadata = {
  title: 'AI Lead Scoring Pro | Zion Tech Group',
  description:
    'AI Lead Scoring Pro empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Tur',
  alternates: { canonical: '/ai-lead-scoring-pro' },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'AI Lead Scoring Pro',
        category: 'Growth & Marketing',
        description:
          'AI Lead Scoring Pro empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Lead Scoring Pro',
      }}
    />
  );
}
