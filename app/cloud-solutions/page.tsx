...
export const metadata = {
  ...
  description:
    'Cloud Solutions delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster ',
  alternates: { canonical: '/cloud-solutions' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Cloud Solutions delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster with battle-tested deployment patterns and cost optimization.',
        iconEmoji: '☁️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Cloud Solutions',
      }}
    />
  );
}
