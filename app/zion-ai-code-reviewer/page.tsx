...
export const metadata = {
  title: 'Zion AI Code Reviewer | Zion Tech Group',
  description:
    'Zion AI Code Reviewer accelerates software delivery with intelligent tooling, automated code analysis, and streamlined development workflows. Ship higher-q',
  alternates: { canonical: '/zion-ai-code-reviewer' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion AI Code Reviewer accelerates software delivery with intelligent tooling, automated code analysis, and streamlined development workflows. Ship higher-quality code faster while reducing technical debt.',
        iconEmoji: '⚙️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion AI Code Reviewer',
      }}
    />
  );
}
