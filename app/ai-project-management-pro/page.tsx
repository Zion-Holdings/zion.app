...
export const metadata = {
  ...
  description:
    'AI Project Management Pro streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your te',
  alternates: { canonical: '/ai-project-management-pro' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Project Management Pro streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focus on strategic work.',
        iconEmoji: '📋',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Project Management Pro',
      }}
    />
  );
}
