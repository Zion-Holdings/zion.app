...
export const metadata = {
  title: 'Zion AI Video Editor | Zion Tech Group',
  description:
    'Zion AI Video Editor accelerates creative production with AI-assisted design, video generation, and content creation tools. Produce high-quality visual ass',
  alternates: { canonical: '/zion-ai-video-editor' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion AI Video Editor accelerates creative production with AI-assisted design, video generation, and content creation tools. Produce high-quality visual assets faster without sacrificing brand consistency.',
        iconEmoji: '🎨',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy Zion AI Video Editor to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use Zion AI Video Editor to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage Zion AI Video Editor analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with Zion AI Video Editor',
      }}
    />
  );
}
