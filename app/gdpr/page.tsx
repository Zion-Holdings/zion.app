...
export const metadata = {
  title: 'GDPR | Zion Tech Group',
  description:
    'GDPR provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit readiness wit',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'GDPR provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit readiness with AI-driven threat detection and policy enforcement.',
        iconEmoji: '🛡️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with GDPR',
      }}
    />
  );
}
