...
export const metadata = {
  ...
  description:
    'Marketing Tools empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn da',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Marketing Tools empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Marketing Tools',
      }}
    />
  );
}
