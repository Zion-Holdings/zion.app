...
export const metadata = {
  ...
  description:
    'Security provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit readiness',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Security provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit readiness with AI-driven threat detection and policy enforcement.',
        iconEmoji: '🛡️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Security',
      }}
    />
  );
}
