...
export const metadata = {
  ...
  description:
    'AI Legal streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focus on st',
  alternates: { canonical: '/ai-legal' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Legal streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focus on strategic work.',
        iconEmoji: '📋',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Legal',
      }}
    />
  );
}
