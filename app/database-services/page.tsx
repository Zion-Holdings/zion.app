...
export const metadata = {
  ...
  description:
    'Database Services transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more',
  alternates: { canonical: '/database-services' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Database Services transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more confident decisions backed by production-grade analytics.',
        iconEmoji: '📊',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Database Services',
      }}
    />
  );
}
