...
export const metadata = {
  title: 'IT Training | Zion Tech Group',
  description:
    'IT Training delivers purpose-built AI solutions tailored to specific industry requirements. Accelerate digital transformation with domain-specific workflow',
  alternates: { canonical: '/it-training' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'IT Training delivers purpose-built AI solutions tailored to specific industry requirements. Accelerate digital transformation with domain-specific workflows, compliance controls, and operational intelligence.',
        iconEmoji: '🏢',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy IT Training to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use IT Training to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage IT Training analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with IT Training',
      }}
    />
  );
}
