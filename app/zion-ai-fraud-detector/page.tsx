...
export const metadata = {
  ...
  description:
    'Zion AI Fraud Detector provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate a',
  alternates: { canonical: '/zion-ai-fraud-detector' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion AI Fraud Detector provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit readiness with AI-driven threat detection and policy enforcement.',
        iconEmoji: '🛡️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion AI Fraud Detector',
      }}
    />
  );
}
