...
export const metadata = {
  ...
  description:
    'Network Security provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit r',
  alternates: { canonical: '/network-security' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Network Security provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit readiness with AI-driven threat detection and policy enforcement.',
        iconEmoji: '🛡️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Network Security',
      }}
    />
  );
}
