...
export const metadata = {
  title: 'Zion Smart Inventory Manager | Zion Tech Group',
  description:
    'Zion Smart Inventory Manager streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your',
  alternates: { canonical: '/zion-smart-inventory-manager' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion Smart Inventory Manager streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focus on strategic work.',
        iconEmoji: '📋',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion Smart Inventory Manager',
      }}
    />
  );
}
