...
export const metadata = {
  ...
  description:
    'DevOps Solutions delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster',
  alternates: { canonical: '/devops-solutions' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'DevOps Solutions delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster with battle-tested deployment patterns and cost optimization.',
        iconEmoji: '☁️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with DevOps Solutions',
      }}
    />
  );
}
