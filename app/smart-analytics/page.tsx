...
export const metadata = {
  ...
  description:
    'Smart Analytics transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more c',
  alternates: { canonical: '/smart-analytics' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Smart Analytics transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more confident decisions backed by production-grade analytics.',
        iconEmoji: '📊',
        features: [
                  {
