...
export const metadata = {
  title: 'CRM Lite | Zion Tech Group',
  description:
    'CRM Lite empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into',
  alternates: { canonical: '/crm-lite' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'CRM Lite empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with CRM Lite',
      }}
    />
  );
}
