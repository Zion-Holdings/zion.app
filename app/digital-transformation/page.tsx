...
e  alternates: { canonical: 'https://ziontechgroup.com/digital-transformation' },
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <p className="text-slate-400 text-lg mb-8">End-to-end digital transformation consulting and implementation.</p>
        <div className="flex flex-wrap gap-4">
        <Link href="/services" className="text-emerald-400 hover:text-emerald-300 underline">All Services</Link>
        <Link href="/contact" className="text-emerald-400 hover:text-emerald-300 underline">Start Your Journey</Link>
        </div>
