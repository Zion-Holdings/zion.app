...
export const metadata = {
  ...
  description:
    'Zion Cybersecurity Audit provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate',
  alternates: { canonical: '/zion-cybersecurity-audit' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion Cybersecurity Audit provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit readiness with AI-driven threat detection and policy enforcement.',
        iconEmoji: '🛡️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion Cybersecurity Audit',
      }}
    />
  );
}
