...
export const metadata = {
  ...
  alternates: { canonical: '/zion-workflow-automation' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion Workflow Automation eliminates manual bottlenecks with intelligent process automation, event-driven orchestration, and cross-system integration. Reclaim operational capacity and reduce human error.',
        iconEmoji: '🔄',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion Workflow Automation',
      }}
    />
  );
}
