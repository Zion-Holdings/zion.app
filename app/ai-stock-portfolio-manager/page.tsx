...
export const metadata = {
  ...
  alternates: { canonical: '/ai-stock-portfolio-manager' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Stock Portfolio Manager applies AI to financial workflows for smarter forecasting, risk assessment, and operational efficiency. Automate routine analysis and surface insights that drive better financial decisions.',
        iconEmoji: '💰',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy AI Stock Portfolio Manager to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use AI Stock Portfolio Manager to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage AI Stock Portfolio Manager analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with AI Stock Portfolio Manager',
      }}
    />
  );
}
