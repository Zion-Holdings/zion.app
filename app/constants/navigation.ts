...
export const PRIMARY_NAV_LINKS: readonly NavigationLink[] = [{ name: 'Home', href: '/' },
...
export const SOLUTION_LINKS: readonly NavigationLink[] = [{ name: 'All Solutions', href: '/services/' },
...
// Resource Links
export const RESOURCE_LINKS: readonly NavigationLink[] = [{ name: 'Partners', href: '/partners/' },
{ name: 'Blog', href: '/blog/' },
...
export const AI_SERVICE_LINKS: readonly NavigationLink[] = [{ name: 'Advanced AI & Enterprise Intelligence Hub', href: '/services/advanced-ai-enterprise-intelligence-hub/' },
...
export const FEATURED_PRODUCT_LINKS: readonly NavigationLink[] = [{ name: 'Zion Analytics Pro', href: '/services/ai-analytics/' },
...
export const AUTOMATION_LINKS: readonly NavigationLink[] = [{ name: 'Automation', href: '/services/workflow-automation/' },
{
...
export const PRODUCT_LINKS: readonly NavigationLink[] = [{ name: 'Zion Analytics Pro', href: '/services/ai-analytics/' },
{ name: 'Zion CRM Intelligence', href: '/services/ai-crm-automation-suite/' },
{ name: 'Zion Content Studio', href: '/services/ai-content-generation/' },
{ name: 'Zion Project Master', href: '/services/ai-project-planning/' },
{ name: 'Zion Performance Monitor', href: '/services/performance-engineering/' },
...
export const IT_SERVICE_LINKS: readonly NavigationLink[] = [{ name: 'Accessibility & WCAG Compliance', href: '/services/accessibility-compliance/' },
...
export const CLOUD_SERVICE_LINKS: readonly NavigationLink[] = [{ name: 'API Development & Integration', href: '/services/api-integration/' },
...
{ name: 'Cloud Cost Optimization (FinOps)', href: '/services/cloud-cost-ai-optimizer/' },
...
export const SECURITY_SERVICE_LINKS: readonly NavigationLink[] = [{ name: 'Attack Surface Management (ASM)', href: '/services/attack-surface-management/' },
...
export const DATA_SERVICE_LINKS: readonly NavigationLink[] = [{ name: 'AI Data Quality & Enforcement Engine', href: '/services/ai-data-quality-engine/' },
...
export const AUTOMATION_SERVICE_LINKS: readonly NavigationLink[] = [{ name: 'Agentic Workflow Orchestrator', href: '/services/agentic-workflow-orchestrator/' },
