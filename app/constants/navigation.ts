...
export const AI_LAB_LINKS = [
  ...
  { name: 'Bot Mode', href: '/services/hermes-agent-bot-mode/' },
  { name: 'Plugin Development', href: '/services/hermes-agent-plugin-development/' },
  { name: 'A2A Protocol', href: '/services/hermes-agent-a2a-protocol/' },
