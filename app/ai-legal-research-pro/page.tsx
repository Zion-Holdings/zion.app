...
export const metadata = {
  ...
  description:
    'AI Legal Research Pro streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team t',
  alternates: { canonical: '/ai-legal-research-pro' },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'AI Legal Research Pro',
        category: 'Operations & Productivity',
        description:
          'AI Legal Research Pro streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focus on strategic work.',
        iconEmoji: '📋',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Legal Research Pro',
      }}
    />
  );
}
