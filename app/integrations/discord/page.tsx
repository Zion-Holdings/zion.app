...
export const metadata: Metadata = {
  title: 'Discord Integration | Zion Tech Group',
  description: 'Connect Zion AI tools with discord',
}
    ...
    <main className="min-h-screen bg-slate-950 py-20">
      <div className="container-page max-w-4xl">
        ...
        <div className="glass-card p-8">
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">Discord Integration</h1>
          <p className="text-slate-400 text-sm mb-6">Integration • API • Free</p>
          <p className="text-slate-300 mb-6">Connect Zion AI tools with discord for seamless workflow automation.</p>
