...
export const metadata = {
  ...
  description:
    'AI Lead Scoring empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn da',
  alternates: { canonical: '/ai-lead-scoring' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Lead Scoring empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Lead Scoring',
      }}
    />
  );
}
