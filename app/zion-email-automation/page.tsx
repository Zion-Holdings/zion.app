...
export const metadata = {
  ...
  description:
    'Zion Email Automation empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. T',
  alternates: { canonical: '/zion-email-automation' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion Email Automation empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion Email Automation',
      }}
    />
  );
}
