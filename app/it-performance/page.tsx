...
export const metadata = {
  title: 'IT Performance | Zion Tech Group',
  description:
    'IT Performance transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more co',
  alternates: { canonical: '/it-performance' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'IT Performance transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more confident decisions backed by production-grade analytics.',
        iconEmoji: '📊',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with IT Performance',
      }}
    />
  );
}
