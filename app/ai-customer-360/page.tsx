...
e  alternates: { canonical: 'https://ziontechgroup.com/ai-customer-360' },
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      <div className="max-w-4xl mx-auto px-4 py-16">
        <h1 className="text-4xl font-bold text-white mb-4">AI Customer 360</h1>
        <p className="text-slate-400 text-lg mb-8">Unified customer view powered by AI for personalized experiences.</p>
        <div className="flex flex-wrap gap-4">
        <Link href="/services" className="text-emerald-400 hover:text-emerald-300 underline">View CDP Services</Link>
