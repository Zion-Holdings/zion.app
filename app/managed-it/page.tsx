...
export const metadata = {
  title: 'Managed IT | Zion Tech Group',
  description:
    'Managed IT provides expert IT management, strategic consulting, and technical support services. Keep your technology infrastructure running smoothly while ',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Managed IT provides expert IT management, strategic consulting, and technical support services. Keep your technology infrastructure running smoothly while focusing on business growth.',
        iconEmoji: '🖥️',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy Managed IT to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use Managed IT to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage Managed IT analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with Managed IT',
      }}
    />
  );
}
