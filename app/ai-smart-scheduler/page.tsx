...
export const metadata = {
  ...
  description:
    'AI Smart Scheduler eliminates manual bottlenecks with intelligent process automation, event-driven orchestration, and cross-system integration. Reclaim ope',
  alternates: { canonical: '/ai-smart-scheduler' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Smart Scheduler eliminates manual bottlenecks with intelligent process automation, event-driven orchestration, and cross-system integration. Reclaim operational capacity and reduce human error.',
        iconEmoji: '🔄',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Smart Scheduler',
      }}
    />
  );
}
