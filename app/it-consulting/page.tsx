...
export const metadata = {
  ...
  description:
    'IT Consulting provides expert IT management, strategic consulting, and technical support services. Keep your technology infrastructure running smoothly whi',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'IT Consulting provides expert IT management, strategic consulting, and technical support services. Keep your technology infrastructure running smoothly while focusing on business growth.',
        iconEmoji: '🖥️',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy IT Consulting to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use IT Consulting to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage IT Consulting analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with IT Consulting',
      }}
    />
  );
}
