...
export const metadata = {
  title: 'Cloud Infrastructure Manager | Zion Tech Group',
  description:
    'Cloud Infrastructure Manager delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to produ',
  alternates: { canonical: '/cloud-infrastructure-manager' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Cloud Infrastructure Manager delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster with battle-tested deployment patterns and cost optimization.',
        iconEmoji: '☁️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Cloud Infrastructure Manager',
      }}
    />
  );
}
