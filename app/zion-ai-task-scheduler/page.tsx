...
export const metadata = {
  title: 'Zion AI Task Scheduler | Zion Tech Group',
  description:
    'Zion AI Task Scheduler eliminates manual bottlenecks with intelligent process automation, event-driven orchestration, and cross-system integration. Reclaim',
  alternates: { canonical: '/zion-ai-task-scheduler' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion AI Task Scheduler eliminates manual bottlenecks with intelligent process automation, event-driven orchestration, and cross-system integration. Reclaim operational capacity and reduce human error.',
        iconEmoji: '🔄',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion AI Task Scheduler',
      }}
    />
  );
}
