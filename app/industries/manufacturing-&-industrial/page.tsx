...
export const metadata = {
  title: "Manufacturing & Industrial AI & IT Services | Zion Tech Group",
  description: "Vision inspection, predictive maintenance, and quality control for Manufacturing & Industrial. Explore matched services, use cases, and implementation options.",
      ...
      <div className="container-page py-20">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-white">Manufacturing & Industrial</h1>
          </div>
          <p className="text-slate-300 mb-8 max-w-2xl">
            Vision inspection, predictive maintenance, and quality control — curated from our full catalog for Manufacturing & Industrial teams.
          </p>
          ...
          <section className="mb-16">
            ...
            <p className="text-slate-400 text-sm mb-6">Core domains for Manufacturing & Industrial</p>
          ...
          <section className="cta-section text-center">
            ...
            <p className="text-slate-500 text-xs mt-4">
              Categories: ai (2148) · iot (0) · data (108) · automation (99)
            </p>
          </section>
        </div>
      </div>
