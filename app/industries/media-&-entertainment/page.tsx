...
export const metadata = {
  title: "Media & Entertainment AI & IT Services | Zion Tech Group",
  description: "Content search, recommendation engines, and knowledge management for Media & Entertainment. Explore matched services, use cases, and implementation options.",
      ...
      <div className="container-page py-20">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-white">Media & Entertainment</h1>
          </div>
          <p className="text-slate-300 mb-8 max-w-2xl">
            Content search, recommendation engines, and knowledge management — curated from our full catalog for Media & Entertainment teams.
          </p>
          ...
          <section className="mb-16">
            ...
            <p className="text-slate-400 text-sm mb-6">Core domains for Media & Entertainment</p>
