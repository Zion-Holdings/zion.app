...
export const metadata: Metadata = {
  title: "AI Solutions for Telecom | Zion Tech Group",
  description: "Explore telecom-focused AI solutions with measurable ROI, faster workflows, and enterprise-grade implementation support.",
  alternates: {
    canonical: `https://ziontechgroup.com/industries/telecom`,
  },
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-bold mb-4">AI Solutions for Telecom</h1>
        <p className="text-lg text-gray-300 mb-8">
          Purpose-built AI capabilities for telecom teams.
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-300">
            <li key="1">Network optimization</li>
            <li key="2">Churn prediction</li>
            <li key="3">5G deployment planning</li>
            <li key="4">Ticket triage</li>
            <li key="5">Capacity forecasting</li>
          </ul>
        </div>
