...
export const metadata = {
  title: "Logistics & Supply Chain AI & IT Services | Zion Tech Group",
  description: "Routing, visibility, and warehouse automation for Logistics & Supply Chain. Explore matched services, use cases, and implementation options.",
      ...
      <div className="container-page py-20">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-white">Logistics & Supply Chain</h1>
          </div>
          <p className="text-slate-300 mb-8 max-w-2xl">
            Routing, visibility, and warehouse automation — curated from our full catalog for Logistics & Supply Chain teams.
          </p>
          ...
          <section className="mb-16">
            ...
            <p className="text-slate-400 text-sm mb-6">Core domains for Logistics & Supply Chain</p>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <Link key="iot" href="/services/?category=iot" className="glass-card group hover:border-purple-500/40 p-5 transition-all"><div className="text-sm font-semibold text-white group-hover:text-purple-300 capitalize">iot</div><div className="text-xs text-slate-400 mt-1">View services →</div></Link>
          ...
          <section className="cta-section text-center">
            ...
            <p className="text-slate-500 text-xs mt-4">
              Categories: ai (2148) · iot (0) · data (108)
            </p>
          </section>
        </div>
      </div>
