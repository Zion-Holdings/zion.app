...
export const metadata = {
  title: "Healthcare & Life Sciences AI & IT Services | Zion Tech Group",
  description: "Claims automation, clinical workflow, and molecular analytics for Healthcare & Life Sciences. Explore matched services, use cases, and implementation options.",
      ...
      <div className="container-page py-20">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-white">Healthcare & Life Sciences</h1>
          </div>
          <p className="text-slate-300 mb-8 max-w-2xl">
            Claims automation, clinical workflow, and molecular analytics — curated from our full catalog for Healthcare & Life Sciences teams.
          </p>
          ...
          <section className="mb-16">
            ...
            <p className="text-slate-400 text-sm mb-6">Core domains for Healthcare & Life Sciences</p>
