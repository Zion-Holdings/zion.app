...
export const metadata = {
  title: "Financial Services & FinTech AI & IT Services | Zion Tech Group",
  description: "Credit intelligence, fraud detection, and payments automation for Financial Services & FinTech. Explore matched services, use cases, and implementation options.",
      ...
      <div className="container-page py-20">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-white">Financial Services & FinTech</h1>
          </div>
          <p className="text-slate-300 mb-8 max-w-2xl">
            Credit intelligence, fraud detection, and payments automation — curated from our full catalog for Financial Services & FinTech teams.
          </p>
          ...
          <section className="mb-16">
            ...
            <p className="text-slate-400 text-sm mb-6">Core domains for Financial Services & FinTech</p>
          ...
          <section className="cta-section text-center">
            ...
            <p className="text-slate-500 text-xs mt-4">
              Categories: ai (2148) · security (139) · data (108)
            </p>
          </section>
        </div>
      </div>
