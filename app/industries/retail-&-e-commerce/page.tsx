...
export const metadata = {
  title: "Retail & E-Commerce AI & IT Services | Zion Tech Group",
  description: "Personalization, forecasting, and checkout optimization for Retail & E-Commerce. Explore matched services, use cases, and implementation options.",
  alternates: { canonical: '/industries/retail-&-e-commerce' }
};
      ...
      <div className="container-page py-20">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-white">Retail & E-Commerce</h1>
          </div>
          <p className="text-slate-300 mb-8 max-w-2xl">
            Personalization, forecasting, and checkout optimization — curated from our full catalog for Retail & E-Commerce teams.
          </p>
          ...
          <section className="mb-16">
            ...
            <p className="text-slate-400 text-sm mb-6">Core domains for Retail & E-Commerce</p>
          ...
          <section className="cta-section text-center">
            ...
            <p className="text-slate-500 text-xs mt-4">
              Categories: ai (2148) · data (108) · automation (99)
            </p>
          </section>
        </div>
      </div>
