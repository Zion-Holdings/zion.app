...
const tiles = [
  ...
  { key: 'financial', label: 'Financial Services & FinTech', emoji: '💳', href: '/industries/financial/' },
  ...
  { key: 'ai-agents', label: 'AI Agents & Automation', emoji: '🤖', href: '/industries/ai-agents/' },
];
