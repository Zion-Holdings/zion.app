...
export const metadata = {
  title: "Legal & Compliance AI & IT Services | Zion Tech Group",
  description: "Document intelligence, contract analysis, and compliance automation for Legal & Compliance. Explore matched services, use cases, and implementation options.",
  alternates: { canonical: '/industries/legal-&-compliance' }
};

export default function Page() {
  const rows = [{"title":"Micro-SAAS AI Invoice Processor","category":"ai","price":"$79/mo"},{"title":"Micro-SAAS AI Contract Analyzer","category":"ai","price":"$149/mo"},{"title":"Micro-SAAS AI Meeting Minutes Generator","category":"ai","price":"$29/mo"},{"title":"Micro-SAAS AI Website Builder","category":"ai","price":"$19/mo"},{"title":"Micro-SAAS AI Smart Email Responder","category":"ai","price":"$39/mo"},{"title":"Micro-SAAS AI Cybersecurity Monitor","category":"security","price":"$149/mo"}];
  return (
      ...
      <div className="container-page py-20">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-white">Legal & Compliance</h1>
          </div>
          <p className="text-slate-300 mb-8 max-w-2xl">
            Document intelligence, contract analysis, and compliance automation — curated from our full catalog for Legal & Compliance teams.
          </p>
          ...
          <section className="mb-16">
            ...
            <p className="text-slate-400 text-sm mb-6">Core domains for Legal & Compliance</p>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <Link key="security" href="/services/?category=security" className="glass-card group hover:border-purple-500/40 p-5 transition-all"><div className="text-sm font-semibold text-white group-hover:text-purple-300 capitalize">security</div><div className="text-xs text-slate-400 mt-1">View services →</div></Link>
          ...
          <section className="cta-section text-center">
            ...
            <p className="text-slate-500 text-xs mt-4">
              Categories: ai (2148) · security (139) · automation (99)
            </p>
          </section>
        </div>
      </div>
