...
;'
function useSafePathname(): unknown {): unknown {): unknown {): unknown {): unknown {) {;
...
;'
    try {;;
      const response: unknown = await fetch('/api/auth/resend-verification-email', {;;
        method: 'POST',;'
        headers: {;;
