...
const mockedUseIsMobile: unknown = useIsMobile as jest.MockedFunction<;
  typeof useIsMobile;
>;'
;;
jest.mock('@/context/MessagingContext');
const mockedUseMessaging: unknown = useMessaging as jest.MockedFunction<;'
  typeof useMessaging;
>;
;'
...
;";";";";"
describe('PrimaryNav', () => {;
  const mockT: unknown = jest.fn((key: string) => key) as jest.MockedFunction<;
    (key: string) => string;
...
;;
    it('renders the Login link', () => {;
      ...
      const loginLink: unknown = screen.getByTestId('login-link');'
...
;;
    it('Login and language selector allow pointer events', () => {;
      ...
      const loginLink: unknown = screen.getByTestId('login-link');;
      const langSelector: unknown = screen.getByTestId('language-selector');;
