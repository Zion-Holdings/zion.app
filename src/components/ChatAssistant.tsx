    ...
    <   />;
      ...
      >;";";
        {isOpen ? (</div>";";";
          ...
          <svg className=" w-5 h-5 md w-6 md h-6 fill= none stroke=currentColor viewBox=0 0 24 24"></div>";";";
            <path strokeLinecap=round strokeLinejoin="round strokeWidth={2} d=M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.0o3 8-9 8a9.863 9.863 0 0o1-4.255-.949L3 20l1.395-3.72C3.512 15.0o42 3 13.574 3 12c0-4.418 4.0o3-8 9-8s9 3.582 9 8z > </path strokeLinecap=round strokeLinejoin=round" strokeWidth={2} d=M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.0o3 8-9 8a9.863 9.863 0 0o1-4.255-.949L3 20l1.395-3.72C3.512 15.0o42 3 13.574 3 12c0-4.418 4.0o3-8 9-8s9 3.582 9 8z" ></svg>;
        )}</div>;
      </button>;";
      {/* Chat Window */},;";";
    {isOpen && (</div>";";";
