...
;
export function HelpArticleView(): unknown {{ articleId }: HelpArticleViewProps) {;
...
;
  ...
  for (const category of HELP_CATEGORIES) {;
    const found: unknown unknown = category.articles.find((a) => a.id === articleId);
    if (found) {;
      article = found;
      break;
    };
...
;'
  const handleFeedback: unknown unknown = (_type: 'helpful' | 'not-helpful') => {;
...
;
function formatDate(): unknown {date: string): string {;"
