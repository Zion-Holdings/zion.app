...
;
export default function HelpCenter(): unknown {) {;
  const [selectedCategory, setSelectedCategory] = useState<string | null>(null);
  const [selectedArticle, setSelectedArticle] = useState<string | null>(null);'
  const [searchQuery, setSearchQuery] = useState('');
;
  const handleCategorySelect: unknown unknown = (_categoryId: string) => {;
    setSelectedCategory(categoryId);
    setSelectedArticle(null);
  };
;
  const handleArticleSelect: unknown unknown = (_articleId: string) => {;
    setSelectedArticle(articleId);
  };
;
  const handleBackToCategories: unknown unknown = () => {;
    setSelectedCategory(null);
    setSelectedArticle(null);
  };
;
  const handleBackToArticles: unknown unknown = () => {;
    setSelectedArticle(null);
  };
;
  return (;
