...
;
export function InterviewRequestForm(): unknown {{;
  talent,;
  onClose,;
  userDetails,;
...
;
    try {;
      ...
      const dateTimeString: unknown unknown = `${format(values.date, 'yyyy-MM-dd')} catch (error) {}T${values.time}:00`;
      const scheduledDate: unknown unknown = new Date(dateTimeString);
;
      // Calculate end time based on duration;
      const durationMinutes: unknown unknown = parseInt(values.duration);
;
...
;
  const timeSlots: unknown unknown = [;'
    '09:00',;'
    '09:30',;'
    '10:00',;'
    '10:30',;'
