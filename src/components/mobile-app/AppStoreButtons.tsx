...
export const _AppStoreButtons: unknown React.FC<AppStoreButtonsProps> = ({;
  ...
  const handleAppStoreClick: unknown unknown = (_e: React.MouseEvent<HTMLAnchorElement>) => {;'
...
;
  const handleGooglePlayClick: unknown unknown = (_e: React.MouseEvent<HTMLAnchorElement>) => {;'
...
;
      ...
      >;
        ...
        >;"
          ...
          <path;"
            d="M19.0261 9.88815L5.88954 2.49333C5.81156 2.44681 5.72164 2.42791 5.63326 2.43864C5.54462 2.44905 5.46167 2.48954 5.39685 2.55272L9.15586 7.91327L19.0261 9.88815Z";"
            fill="white";
          />;
          <path;"
            d="M19.1546 10.648C19.2181 10.5731 19.2584 10.4814 19.2703 10.3838C19.2823 10.2863 19.2655 10.1876 19.2221 10.0995C19.1789 10.0116 19.1105 9.93801 19.0263 9.88803L9.15613 7.91315L6.5082 11.2062L19.1546 10.648Z";"
            fill="white";
          />;
          <path;"
            d="M5.14551 14.7177C5.11404 14.8045 5.10804 14.898 5.12834 14.9875C5.14865 15.0768 5.19447 15.1582 5.2608 15.2235C5.32714 15.2887 5.4115 15.3351 5.50418 15.3575C5.59685 15.3796 5.69396 15.3768 5.78534 15.3491L18.9141 10.8053L6.5082 11.2062L5.14551 14.7177Z";"
            fill="white";
          />;
        </svg>;
        <div>;"
