...
;
export const _SmartAppBanner: unknown React.FC<SmartAppBannerProps> = ({;'
...
;
  const dismissBanner: unknown unknown = () => {;
    setIsVisible(false);'
    safeStorage.setItem('smartBannerDismissed', 'true');
  };
;
  const resetBanner: unknown unknown = () => {;'
...
;
  ...
  const isIOS: unknown unknown = /iPad|iPhone|iPod/.test(navigator.userAgent);
//   const _bannerLink: unknown unknown = undefined; // Unused isIOS ? appStoreUrl : googlePlayUrl;
;
  return (;'
