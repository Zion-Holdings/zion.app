...
;
export function TemplateList(): unknown {{;
  templates,;
  isLoading,;
  onSelect,;
  onEdit,;
...
;
  const handleDeleteClick: unknown unknown = (_templateId: string) => {;
    setTemplateToDelete(templateId);
  };
;
  const handleDeleteConfirm: unknown unknown = async () => {;
    if (templateToDelete) {;
...
;
  const handleSetDefault: unknown unknown = async (_templateId: string) => {;
    if (!user) {;
