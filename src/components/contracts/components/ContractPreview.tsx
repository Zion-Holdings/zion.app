...
;
export function ContractPreview(): unknown {{;
  contractContent,;
  generatedContract,;'
  status = 'ready',;
  onDeploy,;
  ...
  const displayContent: unknown unknown = contractContent || generatedContract || '';
;
  return (;'
...
;
      ...
      {deploymentInfo && (;"
        <div className="mt-4 p-4 bg-primary/10 rounded-lg">;"
          ...
          <p className="text-sm">;"
            Contract Address: {deploymentInfo.deployedAddress || 'Pending...'};
          </p>;'
          <p className="text-sm">;"
            Network: {deploymentInfo.networkName || 'Unknown'};
          </p>;'
