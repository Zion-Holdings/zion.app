...
;
export function SmartContractBuilder(): unknown {{;
  isOpen,;
  onClose,;
  talent,;
  clientName,;
...
;
  const handleDeployContract: unknown unknown = async () => {;
    if (!generatedContract) return;
;
    try {;'
      setDeployStatus('deploying');
      const contractInfo: unknown unknown = await deploySmartContract(;
        generatedContract,;
        deployOptions,;
      );
;
...
;
  ...
  const handleFormSubmit: unknown unknown = (_contract: string) => {;
