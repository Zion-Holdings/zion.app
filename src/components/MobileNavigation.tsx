...
import { Home, Search, User, Menu, X, HelpCircle } from 'lucide-react';
...
export function BottomNavigation() {
  ...
  const navigationItems = [
    ...
    { icon: <Search className="w-5 h-5" />, label: 'Services', href: '/services' },
          ...
          >
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <a href="/help" className="flex items-center gap-3 p-3 rounded-lg bg-zion-blue/20 hover:bg-zion-blue/30 transition-colors duration-200">
              ...
              <div className="pt-4 border-t border-zion-blue-light/30">
                <a href="/quote" className="block w-full bg-gradient-to-r from-zion-cyan to-zion-blue text-white py-3 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 text-center">
                  Get Quote
                </a>
              </div>
            </div>
