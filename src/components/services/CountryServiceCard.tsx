...
;
export function CountryServiceCard(): unknown {{;
  country,;
  onSelect,;
  onQuote,;
  isPopular,;
  ...
  const getRegionEmoji: unknown unknown = (countryName: string | undefined): string => {;"
...
;
  ...
  const getResponseTime: unknown unknown = (countryName: string | undefined): string => {;'
    if (!countryName) return '8-24 hours';
;
    const tier1: unknown unknown = [;'
      'United States',;'
      'United Kingdom',;'
      'Germany',;'
      'Japan',;'
