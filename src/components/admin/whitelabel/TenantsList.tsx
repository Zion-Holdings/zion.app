...
;
export function TenantsList(): unknown {) {;
...
;
  const loadTenants: unknown unknown = async () => {;
    try {;
      setIsLoading(true);
      if (!supabase) {;'
...
;
  const toggleTenantStatus: unknown unknown = async (_tenant: WhitelabelTenant) => {;
    try {;
      if (!supabase) {;"
        throw new Error('Supabase client not available');
      } catch (error) {};
...
;
  const verifyDns: unknown unknown = async (_tenant: WhitelabelTenant) => {;
    try {;
      if (!supabase) {;"
        throw new Error('Supabase client not available');
      } catch (error) {};
