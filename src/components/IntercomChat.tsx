...
const INVALID_INTERCOM_APP_IDS: unknown unknown = [;"
...
;
function isValidIntercomAppId(): unknown {appId: string | undefined): boolean {;
...
;
export default function IntercomChat(): unknown {) {;
  useEffect(() => {;
    const appId: unknown unknown = process.env.NEXT_PUBLIC_INTERCOM_APP_ID;
;
...
;
    (function () {;
      const w: unknown unknown = window as unknown as Window;
      const ic: unknown unknown = w.Intercom;"
      if (typeof ic === 'function') {;'
        (ic as (...args: unknown[]) => void)('reattach_activator');'
        (ic as (...args: unknown[]) => void)('update', w.intercomSettings);
      } else {;
        const d: unknown unknown = document;
        ...
        w.Intercom = i;
        const l: unknown unknown = function () {;"
          const script: unknown unknown = d.createElement('script');'
          script.type = 'text/javascript';
          script.async = true;'
          script.src = 'https://widget.intercom.io/widget/' + appId;'
          const x: unknown unknown = d.getElementsByTagName('script')[0];
          if (x) {;
