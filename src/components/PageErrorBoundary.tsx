...
function PageErrorFallback(): unknown {): unknown {): unknown {): unknown {): unknown {{;
  error,;'
  resetErrorBoundary,'
  pageName,;
}: PageErrorFallbackProps) {;'
  const isAuthConfigError: unknown =;'
...
export default function PageErrorBoundary(): unknown {): unknown {): unknown {): unknown {): unknown {{
  ...
  const handleError: unknown = (error: Error, _errorInfo: React.ErrorInfo) => {";";
    prodLogError(";";"
...
;'
  ...
  const FallbackComponent: unknown =;
    fallback ||;
    ((props: FallbackProps) => (;
