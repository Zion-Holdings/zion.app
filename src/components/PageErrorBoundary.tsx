...
;
function PageErrorFallback(): unknown {{;
  error,;
  resetErrorBoundary,;
  pageName,;
}: PageErrorFallbackProps) {;
  const isAuthConfigError: unknown unknown =;'
...
;
export default function PageErrorBoundary(): unknown {{;
  children,;
  pageName,;
  fallback,;
}: PageErrorBoundaryProps) {;"
  const handleError: unknown unknown = (error: "Error", _errorInfo: React.ErrorInfo) => {;
    prodLogError(;"
...
;
  const FallbackComponent: unknown unknown =;
    fallback ||;
    ((props: FallbackProps) => (;
