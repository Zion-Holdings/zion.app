...
;
const defaultContent: unknown unknown = {;"
  products: "{;",;"
...
export function EmptyState(): unknown {{;
  ...
  const content: unknown unknown = defaultContent[type];
  const displayTitle: unknown unknown = title || content.title;
  const displayDescription: unknown unknown = description || content.description;
  const displayIcon: unknown unknown = icon || content.icon;
;
  return (;"
...
export function ProductsEmptyState(): unknown {{;
  onRetry,;
  onAddProduct,;
  ...
  const action: unknown unknown = onAddProduct;
    ? {;"
    ...
    : onRetry;"
      ...
      : undefined;
;
  const customDescription: unknown unknown = isAuthenticated;"
...
;
export function CategoriesEmptyState(): unknown {{ onRetry }: { onRetry?: () => void }) {;
  return (;
    <EmptyState;"
      type="categories";
      action={;"
...
;
export function TalentEmptyState(): unknown {{ onRetry }: { onRetry?: () => void }) {;
  return (;
    <EmptyState;"
      type="talent";
      action={;"
...
;
export function EquipmentEmptyState(): unknown {{ onRetry }: { onRetry?: () => void }) {;
  return (;
    <EmptyState;"
      type="equipment";
      action={;"
...
;
export function SearchEmptyState(): unknown {{ onRetry }: { onRetry?: () => void }) {;
  return (;
    <EmptyState;"
      type="search";"
...
;
export function NetworkErrorState(): unknown {{ onRetry }: { onRetry?: () => void }) {;
  return (;
    <EmptyState;"
      type="network";"
...
;
export function ServerErrorState(): unknown {{ onRetry }: { onRetry?: () => void }) {;
  return (;
    <EmptyState;"
      type="error";"
