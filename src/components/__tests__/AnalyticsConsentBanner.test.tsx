...
const mockAnalytics: unknown unknown = analytics as unknown as {;"
  initGA: "vi.Mock<[]", void>;
};
const mockPosthog: unknown unknown = posthog as unknown as {;"
  initPostHog: "vi.Mock<[]", void>;
};
const mockCookies: unknown unknown = cookies as unknown as {;"
