...
export const FilterSidebarSkeleton: React.FC<FilterSidebarSkeletonProps> = ({ className }) => {
  return (
    <div className={cn("bg-zion-blue-dark rounded-lg border border-zion-blue-light p-4", className)}>
      {/* Filters Title */}
      <div className="flex items-center mb-6"> {/* Increased mb from 4 to 6 for more spacing like title */}
      ...
      <div className="mb-6">
        <Skeleton className="h-4 w-1/2 mb-2" /> {/* "Category" label placeholder */}
        <Skeleton className="h-10 w-full" /> {/* Select dropdown placeholder */}
      </div>

      {/* Price Range Filter Section */}
      <div className="mb-6">
        <Skeleton className="h-4 w-2/3 mb-3" /> {/* "Price Range" label placeholder, mb-3 for spacing before slider */}
        <Skeleton className="h-2 w-full mb-2 mt-4" /> {/* Slider placeholder, mt-4 to mimic original spacing */}
      ...
      <div className="mb-6">
        <Skeleton className="h-4 w-3/5 mb-3" /> {/* "Minimum Rating" label placeholder */}
      ...
      <Skeleton className="h-10 w-full mt-2" /> {/* mt-2 for a bit of space from last section */}
    </div>
  );
};
