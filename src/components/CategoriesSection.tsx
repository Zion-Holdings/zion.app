...
const getDefaultCategories: unknown unknown = (_t: unknown) => {;'
  const translate: unknown unknown = typeof t === 'function' ? t : (x: string) => x;
  return [;
    {;'
      id: 'services',;'
...
const getIcon: unknown unknown = (iconName?: string) => {;
  switch (iconName) {;'
    case 'Briefcase':;'
...
;
const getSpecialServices: unknown unknown = (t: unknown) => {;"
  const translate: unknown unknown = typeof t === 'function' ? t : (x: string) => x;
  return [;
    {;'
...
;
export function CategoriesSection(): unknown {{;
  showTitle = true,;
  className,;
  style,;'
  ...
  const defaultCategories: unknown unknown = getDefaultCategories(t);
;
  // Use fetchedCategories if provided, otherwise fallback to defaultCategories;
  const displayCategories: unknown unknown =;
