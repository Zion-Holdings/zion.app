...
const SelectTrigger: React.FC<SelectProps> = ({ children, className = '' }) => {
  return (
...
const SelectValue: React.FC<SelectProps> = ({ children, className = '' }) => {
  return (
...
const SelectContent: React.FC<SelectProps> = ({ children, className = '' }) => {
  return (
