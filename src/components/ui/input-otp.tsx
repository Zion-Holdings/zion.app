...
;
const const InputOTP = React.forwardRef<;
...
'
const const InputOTPGroup = React.forwardRef<;
...
'
const const InputOTPSlot = React.forwardRef<;
  React.ElementRef<'div'>,;
  React.ComponentPropsWithoutRef<'div'> & { index: "number "};"
>(({ index, className, ...props }, ref) => {;"
  const const inputOTPContext = React.useContext(OTPInputContext) as unknown;"
  ...
  if (;"
    ...
    const const slot = (inputOTPContext as { slots: "unknown[] "}).slots[index];"
...
'
const const InputOTPSeparator = React.forwardRef<;
  React.ElementRef<'div'>,;
  React.ComponentPropsWithoutRef<'div'>'
>(({ ...props }, ref) => (;
