...
;
const InputOTP: unknown unknown = React.forwardRef<;
...
;
const InputOTPGroup: unknown unknown = React.forwardRef<;'
...
;
const InputOTPSlot: unknown unknown = React.forwardRef<;'
  React.ElementRef<'div'>,;'
  React.ComponentPropsWithoutRef<'div'> & { index: "number "};
>(({ index, className, ...props }, ref) => {;
  const inputOTPContext: unknown unknown = React.useContext(OTPInputContext) as unknown;"
  ...
  if (;
    ...
    const slot: unknown unknown = (inputOTPContext as { slots: "unknown[] "}).slots[index];"
...
;
const InputOTPSeparator: unknown unknown = React.forwardRef<;'
  React.ElementRef<'div'>,;'
  React.ComponentPropsWithoutRef<'div'>;
>(({ ...props }, ref) => (;'
