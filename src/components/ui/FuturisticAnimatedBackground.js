...
const FuturisticAnimatedBackground = ({ intensity = 'medium', colorScheme = 'zion' }) => {
    ...
    return (_jsx("canvas", { ref: canvasRef, className: "fixed inset-0 pointer-events-none z-0", style: { background: 'transparent' } }));
};
