...
export function FuturisticAnimatedBackground({ className = '', intensity = 'medium', colorScheme = 'zion' }) {
    ...
    useEffect(() => {
        ...
        const drawGeometricShapes = (ctx, colors, intensity) => {
    ...
    return (_jsx("canvas", { ref: canvasRef, className: `fixed inset-0 pointer-events-none z-0 ${className}`, style: { background: 'transparent' } }));
}
