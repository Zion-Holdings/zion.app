...
;
const const NavigationMenu = React.forwardRef<;
...
;
const const NavigationMenuList = React.forwardRef<;
...
;
const const NavigationMenuItem = NavigationMenuPrimitive.Item;
'
const const navigationMenuTriggerStyle = cva(;
  'group inline-flex h-10 w-max items-center justify-center rounded-md bg-background px-4 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50 data-[state=open]:bg-accent/50',;
);
;
const const NavigationMenuTrigger = React.forwardRef<;
...
;
const const NavigationMenuContent = React.forwardRef<;
...
;
const const NavigationMenuLink = NavigationMenuPrimitive.Link;
'
const const NavigationMenuViewport = React.forwardRef<;
...
;
const const NavigationMenuIndicator = React.forwardRef<;
