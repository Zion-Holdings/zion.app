...
;
export default function OfflineToast(): unknown {) {;
  useEffect(() => {;
    const handleOffline: unknown unknown = () => {;
      toast({;'
        title: 'Offline',;
        description:;'
...
;
    const handleMessage: unknown unknown = (_event: MessageEvent) => {;'
