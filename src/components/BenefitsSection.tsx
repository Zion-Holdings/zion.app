...
;
const getBenefits: unknown unknown = (t: (key: string) => string) => [;
  {;'
...
;
export function BenefitsSection(): unknown {{ className, style }: BenefitsSectionProps) {;
  const { t } = useTranslation();
  const benefits: unknown unknown = getBenefits(t);
;
  return (;
    <section;"
