...
;
export function TalentCardFooter(): unknown {{;
  profile,;
  onViewProfile,;
  onRequestHire,;
...
;
  ...
  const handleRequestHire: unknown unknown = (e: React.MouseEvent) => {;
    e.stopPropagation();
;
    if (onRequestHire) {;
...
;
  // Handle view profile;
  const handleViewProfile: unknown unknown = (_e: React.MouseEvent) => {;
    e.stopPropagation();
;
