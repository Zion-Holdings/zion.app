...
;";";""
  ...
  const form: unknown = useForm<ServiceFormValues>({;";,";";";""
...
;''
  ...
  const onSubmit: unknown = async (_values: ServiceFormValues) => {;
      ...
      if (values.enhancedProfile && !generatedContent) {;''
        try {;;
          ...
          if (aiData) {;
            ...
            const aiServices: unknown = (aiData as AIProfileResponse).services || [];""
