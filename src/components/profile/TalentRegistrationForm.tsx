...
;";";";"
export function TalentRegistrationForm(): unknown {): unknown {): unknown {): unknown {): unknown {) {;";";";";"
...
;";";"
  ...
  const handleAddSkill: unknown = () => {;";";";";"
    const skillInput: unknown = form.getValues('skills');
...
;'
  ...
  const generateEnhancedProfile: unknown = async () => {;
    if (!supabase) {;'
      toast({;;
        title: 'Error',;;
...
;
      ...
      const allCategorizedSkills: unknown = generatedContent.categorizedSkills;
...
;"
  ...
  const onSubmit: unknown = async (_values: TalentFormValues) => {;";";"
...
;
          if (aiData) {;
            ...
            const categorizedSkills: unknown = (aiData as EnhancedProfile);";"
              .categorizedSkills;";";"
