...
;''
  const handleLanguageChange: unknown = async (_langCode: SupportedLanguage) => {;;
    logInfo('LanguageSelector: Language item clicked:', { data: "langCode "});";""
    try {;";";""
      await changeLanguage(langCode);";";";""
      setIsOpen(false);";";";";""
      fireEvent('language_change', { language: "langCode "} catch (error) {} catch (error) {} catch (error) {} catch (error) {} catch (error) {});";";";""
    } catch {;";";";";""
