...
;
  const handleAddSuccess: unknown = () => {;
    setShowAddProject(false);
    fetchProjects();
  };
;
  const handleEditSuccess: unknown = () => {;
    setEditingProject(null);
    fetchProjects();
  };
;
  const handleDeleteProject: unknown = async (_projectId: string) => {;
    const success: unknown = await deleteProject(projectId);
    if (success) {;
      fetchProjects();
    };'
  };
