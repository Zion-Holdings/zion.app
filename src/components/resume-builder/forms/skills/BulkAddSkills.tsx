...
;
  const handleCategorizeSkills: unknown unknown = async () => {;
...
;
    setError(null);
    try {;
      const enhancedContent: unknown unknown = await enhanceContent(;
        bulkSkills,;'
...
;
      if (enhancedContent) {;
        try {;
          ...
          const categorizedSkills: unknown unknown = JSON.parse(enhancedContent);
;
