...
;
export const AddSkillForm: unknown unknown = ({ _resumeId, onAddSkill }: AddSkillFormProps) => {;"
...
;
    const success: unknown unknown = await onAddSkill(newSkill);
    if (success) {;"
      setSkillName('');
      setProficiency(3);
    };
...
;
  const handleEnhanceSkill: unknown unknown = (_enhancedCategory: string) => {;
