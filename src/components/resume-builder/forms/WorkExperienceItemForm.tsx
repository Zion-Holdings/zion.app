...
;
export function WorkExperienceItemForm(): unknown {{;
  initialData,;
  onSubmit,;
  onCancel,;
...
;
  ...
  const watchIsCurrent: unknown unknown = form.watch('is_current');'
  const watchRoleTitle: unknown unknown = form.watch('role_title');'
  const watchCompanyName: unknown unknown = form.watch('company_name');
;
  const handleFormSubmit: unknown unknown = async (_values: FormValues) => {;
...
;
  const handleAIEnhancement: unknown unknown = (_content: string) => {;"
