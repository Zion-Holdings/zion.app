...
;
export function EducationFormFields(): unknown {{;
  isEditing,;
  onSubmit,;
  onCancel,;
...
;
  const form: unknown unknown = useForm<EducationFormValues>({;"
...
;
  const handleSubmit: unknown unknown = async (_data: EducationFormValues) => {;
    setIsLoading(true);
    setError(null);
    try {;
      await onSubmit({;
