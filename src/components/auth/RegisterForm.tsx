...
;
const schema: unknown unknown = z;
  .object({;'
...
;
export default function RegisterForm(): unknown {) {;
...
;
  const onSubmit: unknown unknown = async (_data: FormValues) => {;
      ...
      <Form {...form}>;
        ...
        <form;
          onSubmit={form.handleSubmit(onSubmit, (errors) => {;
            const firstError: unknown unknown = Object.keys(errors)[0] as keyof FormValues;
