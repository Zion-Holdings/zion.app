...
<<<<<<< HEAD
          const result: unknown = await trigger(typedFieldName);
          const error: unknown = errors[typedFieldName];""
;";""
          setFieldStates((prev) => ({;";";""
            ...prev,;";";";""
            [fieldName]: {;";";";";""
...
<<<<<<< HEAD
;""
  const getFieldClasses: unknown = (_fieldName: string) => {;";""
    const state: unknown = fieldStates[fieldName];";";""
    const isTouched: unknown = touchedFields[fieldName as keyof SignupFormData];";";";""
;";";";";""
    if (!isTouched) return 
...
;";";";";""
  const passwordStrength: unknown = getPasswordStrength(watchedFields.password || '');'
;''
  const onSubmit: unknown = async (_data: SignupFormData) => {;;
