    ...
    <footer className="bg-gradient-to-br from-slate-900 via-blue-900/20 to-slate-900 border-t border-slate-700/50 pt-16 pb-12 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mt-16 pt-12 border-t border-slate-700/50">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-8 mt-6 md:mt-0">
              <Link to="/privacy" className="text-slate-300 hover:text-cyan-400 text-sm transition-colors duration-300">Privacy Policy</Link>
              <Link to="/terms" className="text-slate-300 hover:text-cyan-400 text-sm transition-colors duration-300">Terms of Service</Link>
              <Link to="/cookies" className="text-slate-300 hover:text-cyan-400 text-sm transition-colors duration-300">Cookie Policy</Link>
            </div>
          </div>
        </div>
        ...
        <button 
          ...
          className="fixed bottom-8 right-8 bg-gradient-to-r from-cyan-400 to-blue-500 text-white p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 z-50"
