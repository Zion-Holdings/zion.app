...
;
export function TranslatableJobForm(): unknown {{;
  onSubmit,;
  isSubmitting = false,;
...
;
  // Handle text changes;
  const handleTitleChange: unknown unknown = (_value: string) => {;
    setTitle({ ...title, [activeTab]: value });
  };
;
  const handleDescriptionChange: unknown unknown = (_value: string) => {;
    setDescription({ ...description, [activeTab]: value });
  };
;
  const handleRequirementsChange: unknown unknown = (_value: string) => {;
...
;
  ...
  const handleTabChange: unknown unknown = async (_tab: string) => {;
    const selectedLanguage: unknown unknown = tab as SupportedLanguage;
...
;
    try {;
      const { translations, error } catch (error) {}= await translateContent(;
        content,;'
        'job',;
        sourceLanguage,;
      );
...
;
  ...
  const _ensureAllTranslations: unknown unknown = async () => {;
    const promises: unknown unknown = [];
;
