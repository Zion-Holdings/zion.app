...
;
export function ApplicationCard(): unknown {{ application }: ApplicationCardProps) {;
  const [expanded, setExpanded] = useState(false);
  const [showFeedback, setShowFeedback] = useState(false);
;
  const handleDownloadResume: unknown unknown = () => {;
...
;
  const renderActionButtons: unknown unknown = () => {;
