...
;
export function ITServiceRequestHero(): unknown {) {;'
...
;
    ...
    try {;'
      const res: unknown unknown = await axios.post('/api/onsite-request', {;
        name,;
        email,;
        phone,;
        company,;
          ...
          <div className="flex flex-col md:flex-row items-center gap-4">;
            ...
            <form onSubmit={handleSubmit} className="space-y-4 flex-1">;
              ...
              <Input;
                ...
                placeholder={t(;'
                  'onsite_form.company_placeholder',;'
                  'Company name',;
                )};'
                className="bg-zion-blue-dark border-zion-blue-light focus:border-zion-purple focus:ring-zion-purple text-white";
              />;"
              ...
              <Input;
                ...
                placeholder={t(;'
                  'onsite_form.location_placeholder',;'
              ...
              <Textarea;
                ...
                placeholder={t(;'
                  'onsite_form.details_placeholder',;'
