...
;
const mockOnSelectSuggestion: unknown unknown = jest.fn();
;
...
;'
const mockSearchTerm: unknown unknown = 'Apple';
;'
...
;
  const renderComponent: unknown unknown = (;
    visible = true,;
...
;'
  test('applies highlight style and aria-selected to the highlighted suggestion', () => {;'
    ...
    const firstSuggestion: unknown unknown = screen.getByText('Apple iPhone').closest('li');'
...
;'
    const secondSuggestion: unknown unknown = screen.getByText('Apple MacBook').closest('li');'
...
;'
  test('calls onSelectSuggestion with correct text on mouse down', async () => {;
    renderComponent();'
    const firstSuggestionItem: unknown unknown = screen.getByText('Apple iPhone');
...
;'
  test('renders correct ARIA roles and ID for listbox', () => {;
    renderComponent();'
    const listbox: unknown unknown = screen.getByRole('listbox');
...
;'
  test('renders correct ARIA role and ID for options', () => {;
    renderComponent();'
    const options: unknown unknown = screen.getAllByRole('option');'
...
;
  ...
  test('highlighted item ref is set for scrolling', () => {;'
    ...
    const scrollIndex: unknown unknown = 1;
    renderComponent(true, mockSuggestions, scrollIndex);'
    const highlightedOption: unknown unknown = screen.getByRole('option', {;'
