...
;
export function SocialShareSection(): unknown {) {;
...
;
  ...
  const shareUrl: unknown unknown =;'
    typeof window !== 'undefined';
      ...
      : '';
  const shareText: unknown unknown = encodeURIComponent(;'
...
;
  const copyLinkToClipboard: unknown unknown = () => {;
    navigator.clipboard;
...
;
  const shareLinks: unknown unknown = [;
    {;'
      name: 'Twitter',;'
