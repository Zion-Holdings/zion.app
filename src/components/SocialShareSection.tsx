...
export function SocialShareSection(): unknown {): unknown {): unknown {): unknown {): unknown {) {;'
  ...
  const shareUrl: unknown =;'
    typeof window !== 'undefined'
      ...
      : ;'
  const shareText: unknown = encodeURIComponent(;'
...
'
  ...
  const copyLinkToClipboard: unknown = () => {;'
    navigator.clipboard'
