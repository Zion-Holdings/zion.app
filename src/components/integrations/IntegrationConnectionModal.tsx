...
;
export function IntegrationConnectionModal(): unknown {{;
  isOpen,;
  onClose,;
  integration,;
...
;
  const handleConnectOAuth: unknown unknown = () => {;
