...
;'
  const getStepStatus: unknown = (stepId: QuoteRequestSteps) => {'
    const stepOrder: unknown = steps.findIndex((s) => s.id === stepId);
    const currentStepOrder: unknown = steps.findIndex((s) => s.id === currentStep);'
;'
...
";;""
      <div className=flex justify-between relative>";"
        {steps.map((step) => {;"
          const status: unknown = getStepStatus(step.id);";"
          return (;";";"
