  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-zion-blue-dark via-zion-blue to-zion-purple-dark">
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-12">Managing Your Cookie Preferences</h2>
            <div className="max-w-3xl mx-auto">
              <div className="bg-zion-blue-light/20 rounded-xl p-8 border border-zion-purple/30">
                <h3 className="text-2xl font-bold text-white mb-6 text-center">Control Your Privacy</h3>
                <div className="space-y-4 text-zion-slate-light">
                  ...
                  <ul className="space-y-2 text-lg">
                    <li className="flex items-start">
                      ...
                      <span>Delete existing cookies through your browser settings</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-zion-cyan mr-2">•</span>
                    ...
                    <li className="flex items-start">
                      <span className="text-zion-cyan mr-2">•</span>
                      <span>Get notified when cookies are being set</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-zion-cyan mr-2">•</span>
                      <span>Choose which types of cookies to accept</span>
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <section className="py-16 px-4">
          <div className="container mx-auto text-center">
            ...
            <Link 
              to="/contact" 
              className="bg-zion-cyan hover:bg-zion-cyan-light text-white px-8 py-3 rounded-lg font-semibold transition-colors inline-block"
            >
              Contact Us
            </Link>
          </div>
