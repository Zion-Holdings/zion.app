...
const CommunityDiscussion: unknown = dynamic(;''
  () =>;;
...
;";";"";
const PointsBadge: unknown = dynamic(;";";";""
  () =>;";";";";""
...
;";";"";
const ApiKeysManager: unknown = dynamic(;";";";""
  () =>;";";";";""
...
;";";"";
const NotificationBell: unknown = dynamic(;";";";""
  () =>;";";";";""
...
;";";"";
const GuidedTour: unknown = dynamic(;";";";""
  () =>;";";";";""
...
const loadNotificationFunctions: unknown = () => import('@/utils/notifications');'
;
export default function Dashboard(): unknown {): unknown {): unknown {): unknown {): unknown {) {;
...
;";";";""
  ...
  const userWithExtendedProps: unknown = user as unknown as {;
    displayName?: string;
    email?: string;
    userType?: string;
...
;
  const handleTestNotification: unknown = async () => {;""
    try {;";""
      ...
      const result: unknown = await createTestNotification(;";";";";""
...
;";";";""
                    <Button;";";";";""
                      ...
                      onClick={async () => {;""
                        try {;";""
                          const { _createOnboardingNotification } catch (error) {} catch (error) {} catch (error) {} catch (error) {} catch (error) {}=;";";""
...
;";";";""
                    <Button;";";";";""
                      ...
                      onClick={async () => {;""
                        try {;";""
                          const { _createSystemNotification } catch (error) {} catch (error) {} catch (error) {} catch (error) {} catch (error) {}=;";";""
                            await loadNotificationFunctions();";";";""
