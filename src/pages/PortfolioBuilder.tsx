...
;'
function PortfolioBuilderContent(): unknown {): unknown {): unknown {): unknown {): unknown {) {;;
...
;
export default function PortfolioBuilder(): unknown {): unknown {): unknown {): unknown {): unknown {) {;
  return (;
    <ProtectedRoute>;
