...
;'
export default function PodcastHost(): unknown {): unknown {): unknown {): unknown {): unknown {) {;;
...
;
  const generateScript: unknown = async () => {;'
    setLoading(true);;
    setScript('');'
    try {;;
      const res: unknown = await fetch('/api/podcast/generate', {;;
        method: 'POST',;;
