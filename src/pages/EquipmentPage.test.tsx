...
const EQUIPMENT_API_URL: unknown = '/api/v1/services/equipment;
;;
...
//     const _errorMessage: unknown = undefined; // Unused 'Network Error;'
    const errorResponseData: unknown = { detail: 'Something went wrong on the server' };'
;
    server.use(;
...
;";";"
    ...
    const consoleErrorSpy: unknown = vi;";";";";"
      .spyOn(console, 'error');
      .mockImplementation(() => {});'
;;
...
;";";";";"
  it('should handle errors where error.response is undefined (e.g., network failure)', async () => {;;
    const networkErrorMessage: unknown = 'Failed to fetch // Standard message for network errors;
;
    server.use(;
      http.get(EQUIPMENT_API_URL, () => {;
...
//     const _customErrorObject: unknown = undefined; // Unused { message: 'Custom error' };
;
    server.use(;
      http.get(EQUIPMENT_API_URL, () => {;
