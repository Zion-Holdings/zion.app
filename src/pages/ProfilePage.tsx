    ...
    <div style={pageStyle}>
      ...
      <form>
        <div style={formGroupStyle}>
          ...
          <input type="text" id="name" name="name" style={inputStyle} placeholder="Enter your name" />
        </div>

        <div style={formGroupStyle}>
          <label htmlFor="email" style={labelStyle}>Email</label>
          <input type="email" id="email" name="email" style={inputStyle} placeholder="Enter your email" />
        </div>
