...
const GenesisDeployPage = () => {
  const [solidity, setSolidity] = useState('// Enter your Solidity contract here\npragma solidity ^0.8.0;\n\ncontract Genesis {\n    string public message = "Hello, Genesis!";\n}');
  ...
  return (
    <div className="container max-w-2xl py-10">
      ...
      <p className="mb-4 text-muted-foreground">Deploy your Genesis smart contract below.</p>
      <textarea
