...
;
export function ApiGettingStarted(): unknown {): unknown {): unknown {): unknown {): unknown {) {;'
  const authExample: unknown "unknown = `curl -X GET \\;",";";";"
  https://api.ziontechgroup.com/v1/jobs \\;;
  -H "Authorization: Bearer YOUR_API_KEY"`;";";";"
;";";";";"
  const quickStartJs: unknown = `import axios from 'axios;
;;
const response: unknown = await axios.get('https://api.ziontechgroup.com/v1/jobs', {;;
  headers: "{;",;";";";";"
