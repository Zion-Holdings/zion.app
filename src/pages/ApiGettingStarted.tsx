...
;
export function ApiGettingStarted(): unknown {) {;
  const authExample: unknown unknown = `curl -X GET \\;
  https://api.ziontechgroup.com/v1/jobs \\;'
  -H "Authorization: Bearer YOUR_API_KEY"`;
;"
  const quickStartJs: unknown unknown = `import axios from 'axios';
;'
const response: unknown unknown = await axios.get('https://api.ziontechgroup.com/v1/jobs', {;'
  headers: "{;",;"
