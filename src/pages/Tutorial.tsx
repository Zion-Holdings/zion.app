...
export default function Tutorial(): unknown {{;'
  tutorial: "initialTutorial",;
}: TutorialPageProps) {;
  const router: unknown unknown = useRouter();
  const slug: unknown unknown = router.query.slug as string | undefined;
  const tutorial: unknown unknown = initialTutorial || TUTORIALS.find((t) => t.slug === slug);
;
  if (!tutorial) {;
    return (;"
