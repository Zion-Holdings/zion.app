...
;'
export default function UNBridgePage(): unknown {): unknown {): unknown {): unknown {): unknown {) {;;
...
;
  const generate: unknown = (_e: React.FormEvent) => {;
    e.preventDefault();
...
;";";";";"
  const download: unknown = (content: "string", filename: "string", _type: string) => {;";";";"
