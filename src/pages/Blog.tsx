...
;
  useEffect(() => {;
    const fetchPosts: unknown = async () => {;
      setIsLoading(true);
      try {;
...
;"
  ...
  const filteredPosts: unknown = posts.filter((post) => {;";";";"
...
;
  // Get featured posts;
  const featuredPosts: unknown = posts.filter((post) => post.isFeatured);'
;;
...
;
          ...
          {featuredPosts.length > 0 &&;
            (() => {;"
              const featuredPost: unknown = featuredPosts[0];";"
