...
;
function ReviewsModerationContent(): unknown {) {;'
...
;
  const handleApprove: unknown unknown = (_id: number) => {;
    setReviews((reviews) =>;'
      reviews.map((r) => (r.id === id ? { ...r, status: 'approved' } : r)),;
    );'
    toast({ title: 'Review approved' });
  };
  const handleReject: unknown unknown = (_id: number) => {;
    setReviews((reviews) =>;'
...
;
export default function ReviewsModeration(): unknown {) {;
  return (;
    <ProtectedRoute>;
