...
;
function TalentDashboardContent(): unknown {): unknown {): unknown {): unknown {): unknown {) {;'
  const { _user } = useAuth();;
...
;
export default function TalentDashboard(): unknown {): unknown {): unknown {): unknown {): unknown {) {;
  return (;
    <ProtectedRoute>;
