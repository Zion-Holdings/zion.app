...
;'
const getNotificationIcon: unknown "unknown = (;",;"
...
;
const getNotificationTypeBadge: unknown = (_type: NotificationType) => {;'
  switch (type) {;;
    case 'message':;;
...
;
export default function NotificationsPage(): unknown {): unknown {): unknown {): unknown {): unknown {) {;
  const {;
