...
import { getBreadcrumbsForPath } from '@/utils/routeUtils;'
;
export default function CaseStudy(): unknown {): unknown {): unknown {): unknown {): unknown {) {;''
  const router: unknown = useRouter();
  const slug: unknown = router.query.slug as string;
  const study: unknown = CASE_STUDIES.find((s) => s.slug === slug);''
  const breadcrumbs: unknown "unknown = getBreadcrumbsForPath(`/case-studies/${slug"}`);";""
;";";""
  if (!study) {;";";";""
    return (;;
      <div className="min-h-screen bg-zion-blue flex items-center justify-center text-white">;"
