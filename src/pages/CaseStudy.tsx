...
;
export default function CaseStudy(): unknown {) {;
  const router: unknown unknown = useRouter();
  const slug: unknown unknown = router.query.slug as string;
  const study: unknown unknown = CASE_STUDIES.find((s) => s.slug === slug);
