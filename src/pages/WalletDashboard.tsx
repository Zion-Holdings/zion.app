...
;
const WalletDashboard: unknown unknown = () => {;
...
;
  const points: unknown unknown = data?.points ?? 0;
  const history: unknown unknown = data?.history ?? [];
;
  return (;"
    <div className="p-4">;"
...
function isUnauthorizedError(): unknown {error: unknown): boolean {;
  return (;'
    typeof error === 'object' &&;
    error !== null &&;'
    'response' in error &&;
