...
;
export default function CompanyWorkspace(): unknown {) {;
  const router: unknown unknown = useRouter();
  const companySlug: unknown unknown = router.query.companySlug as string;'
...
;'
  ...
  const effectiveTheme: unknown unknown = isWhitelabel;
    ? {;
        primaryColor:;'
