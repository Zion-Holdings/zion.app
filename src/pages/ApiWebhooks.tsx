...
;
export function ApiWebhooks(): unknown {): unknown {): unknown {): unknown {): unknown {) {;
  // Sample webhook event payload;'
  const newApplicationPayload: unknown = `{;;
...
;";";";"
  const quoteReceivedPayload: unknown = `{;";";";";"
...
;";";";"
  const messageReceivedPayload: unknown = `{;";";";";"
...
;";";";"
  const webhookHandlerJs: unknown = `// Express.js webhook handler example;";";";";"
const express: unknown = require('express');'
const app: unknown = express();;
const crypto: unknown = require('crypto');
;'
// Middleware to parse JSON bodies;
app.use(express.json());
;'
// Your webhook secret from the Zion dashboard;;
const webhookSecret: unknown = 'YOUR_WEBHOOK_SECRET;
;
// Middleware to verify webhook signatures;'
function verifyWebhookSignature(): unknown {): unknown {): unknown {): unknown {): unknown {req, res, next) {;;
  const signature: unknown = req.headers['x-zion-signature'];;
  const timestamp: unknown = req.headers['x-zion-timestamp'];
  ;'
  ...
  const payload: unknown = timestamp + '.' + JSON.stringify(req.body);'
