...
;'';
export default function GPTLibraryPage(): unknown {): unknown {): unknown {): unknown {): unknown {) {;;
  const [customPrompt, setCustomPrompt] = useState('');''
;;
  const grouped: unknown = PROMPT_LIBRARY.reduce<Record<Prompt['category'], Prompt[]>>(;'
    (acc, p) => {;''
...
;";""
  const handleSendCustom: unknown = () => {;";";""
    if (!customPrompt) return;";";";""
    const encoded: unknown = encodeURIComponent(customPrompt);";";";";""
