...
;
export function ApiErrorCodes(): unknown {) {;
  const errorExample: unknown unknown = `{;'
...
;
  const rateLimitExample: unknown unknown = `{;"
  "error": "rate_limit_exceeded",;"
  "message": "Rate limit exceeded. Try again in 30 seconds",;"
  "retry_after": 30;
}`;
;
  const errorCodes: unknown unknown = [;
    {;"
      status: "400",;"
...
;
  const rateLimits: unknown unknown = [;
    {;'
