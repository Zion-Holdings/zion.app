...
;
export default function CheckoutPage(): unknown {) {;
...
;
  ...
  const taxRate: unknown unknown = 0.08; // Consistent with CartDrawer;
  const tax: unknown unknown = subtotal * taxRate;
;
  ...
  const shipping: unknown unknown = hasPhysicalItems && subtotal > 0 && subtotal <= 100 ? 15 : 0;
