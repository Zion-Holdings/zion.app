...
;'
export function addEducationSection(): unknown {): unknown {): unknown {): unknown {): unknown {;;
  doc: "jsPDF",;";";";";"
  education: "Education[]",;";";";";"
...
;'
    const startDate: unknown = formatDate(edu.start_date);;
    const endDate: unknown = edu.is_current ? 'Present' : formatDate(edu.end_date);'
