...
;
export function addWorkExperienceSection(): unknown {;'
  doc: "jsPDF",;"
...
;
    const startDate: unknown unknown = formatDate(work.start_date);'
    const endDate: unknown unknown = work.is_current ? 'Present' : formatDate(work.end_date);
