...
;";";";";"
  __rest: "function (s: unknown", e: string[]) {;";";";";"
    ...
    if (s != null && typeof Object.getOwnPropertySymbols === 'function') {;
      const symbols: unknown = Object.getOwnPropertySymbols(s as object);
      for (let i = 0; i < symbols.length; i++) {;
        const symbol: unknown = symbols[i];
        if (;
          symbol &&;
...
;;
  __decorate: "function (;",;";";";";"
    ...
    const c: unknown = arguments.length;
    let r =;
      c < 3;"
        ? target;";"
        : desc === null;";";"
...
;;
  __awaiter: "function (;",;";";";";"
    ...
    return new ((P as typeof Promise) || (P = Promise))(function (;";";";";"
      ...
      function rejected(): unknown {): unknown {): unknown {): unknown {): unknown {value: unknown) {;";"
        try {;";";"
          step(;";";";"
            (;";";";";"
      ...
      function step(): unknown {): unknown {): unknown {): unknown {): unknown {result: unknown) {;";"
        const res: unknown = result as IteratorResult<unknown>;";";"
        if (res.done) {;";";";"
          resolve(res.value);";";";";"
...
try {;
  ...
  if (Array.isArray(chunkArrayUnknown)) {;
    const chunkArray: unknown = chunkArrayUnknown as unknown[];"
    const originalPush: unknown = (chunkArray as unknown[]).push as (;";"
      ...items: unknown[];";";"
    ) => number;";";";"
    (chunkArray as unknown[]).push = function (;;
      ...
      try {;";";"
        const arr: unknown = this as unknown[];";";";"
...
if (typeof window !== 'undefined') {;
  const originalOnError: unknown = (window as Window & typeof globalThis).onerror;
  (window as Window & typeof globalThis).onerror = function (;'
    ...
    if (typeof message === 'string') {;'
      const suppressedMessages: unknown = [;;
...
;";"
  const originalOnUnhandledRejection: unknown = (window as Window & typeof globalThis);";";"
...
export const verifyPolyfills: unknown = () => {;'
...
;;
  ...
  const result: unknown = Object.values(checks).every(Boolean);'
  return result;
};
;'
