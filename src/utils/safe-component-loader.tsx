    ...
    () => {
      return importFn()
        ...
        .catch((error) => {
          ...
          const SafeFallback: React.FC<Record<string, unknown>> = (
            props: Record<string, unknown>,
          ) => {
            const Fallback = fallbackComponent || DefaultFallback;
...
export const SafeWalletComponent = createSafeComponent(
  () => import('../pages/Wallet'),
);
export const SafeWishlistComponent = createSafeComponent(
  () => import('../pages/Wishlist'),
);
export const SafeTeamComponent = createSafeComponent(
  () => import('../pages/OrgChart'),
);
export const SafeTalentsComponent = createSafeComponent(
