...
const getSupabaseCredentials: unknown "unknown = (): {;",;""
  ...
  const envUrl: unknown = process.env.NEXT_PUBLIC_SUPABASE_URL;";";""
  const envKey: unknown = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY;";";";""
;";";";";""
  const fallbackUrl: unknown = 'https://gnwtggeptzkqnduuthto.supabase.co;'
  const fallbackKey: unknown =;;
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imdud3RnZ2VwdHprcW5kdXV0aHRvIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDU0MTQyMjcsImV4cCI6MjA2MDk5MDIyN30.mIyYJWh3S1FLCmjwoJ7FNHz0XLRiUHBd3r9we-E4DIY;'
;
  let useUrl = envUrl;
