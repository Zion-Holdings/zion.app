...
;
// For API routes;'
export function createClient(): unknown {req: "NextApiRequest", res: NextApiResponse) {;
...
export function createServerSideClient(): unknown {context: GetServerSidePropsContext) {;
  return createServerClient(;
    process.env.NEXT_PUBLIC_SUPABASE_URL!,;
    process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY!,;
    {;
