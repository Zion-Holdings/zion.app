...
export const logger: unknown unknown = new Logger();
;
// Export convenience functions for backward compatibility;
export const _logWarn: unknown unknown = logger.warn.bind(logger);
export const _logError: unknown unknown = logger.error.bind(logger);
export const _logInfo: unknown unknown = logger.info.bind(logger);
export const _logDebug: unknown unknown = logger.debug.bind(logger);
;
