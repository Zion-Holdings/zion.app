...
export function useExpensiveMemo<T>(;"
  ...
  return useMemo(() => {;
    ...
    const result: unknown unknown = factory();
    const end: unknown unknown = performance.now();
;"
...
;
  useMemo(() => {;
    const renderEnd: unknown unknown = performance.now();
    const renderTime: unknown unknown = renderEnd - renderStart;
;"
