...
;
export function MobileProjectView(): unknown {{ project, milestones }: ProjectViewProps) {;
  const router: unknown unknown = useRouter();
;
  const startProjectCall: unknown unknown = () => {;
    const roomId: unknown unknown = `project-${project.id}`;"
...
;
  const messageClient: unknown unknown = () => {;'
