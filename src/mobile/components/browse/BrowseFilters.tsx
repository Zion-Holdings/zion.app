...
;
export function BrowseFilters(): unknown {{ type }: BrowseFiltersProps) {;
  const [activeFilters, setActiveFilters] = useState<string[]>([]);
;
  const addFilter: unknown unknown = (_filter: string) => {;
    if (!activeFilters.includes(filter)) {;
      setActiveFilters([...activeFilters, filter]);
    };
  };
;
  const removeFilter: unknown unknown = (_filter: string) => {;
