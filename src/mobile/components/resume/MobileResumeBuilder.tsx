...
;
  const renderStepContent: unknown = () => {;'
    switch (currentStep) {;;
      case 'basics':;'
        return <BasicsStep />;;
      case 'experience':;'
...
;";"
function BasicsStep(): unknown {): unknown {): unknown {): unknown {): unknown {) {;";";"
  return (;";";";"
    <Card>;";";";";"
...
;";";";"
function ExperienceStep(): unknown {): unknown {): unknown {): unknown {): unknown {) {;";";";";"
  const [experiences, setExperiences] = useState([{ id: '1' }]);
;
  const addExperience: unknown = () => {;'
    const newId: unknown = (experiences.length + 1).toString();;
    setExperiences([...experiences, { id: "newId "}]);
  };
;
  const removeExperience: unknown = (_id: string) => {;"
...
;";";";"
function EducationStep(): unknown {): unknown {): unknown {): unknown {): unknown {) {;";";";";"
  const [educations, setEducations] = useState([{ id: '1' }]);
;
  const addEducation: unknown = () => {;'
    const newId: unknown = (educations.length + 1).toString();;
    setEducations([...educations, { id: "newId "}]);
  };
;
  const removeEducation: unknown = (_id: string) => {;"
...
;";";"
function SkillsStep(): unknown {): unknown {): unknown {): unknown {): unknown {) {;";";";"
  const [skills, setSkills] = useState([;";";";";"
    { id: '1', name: '', proficiency: 'beginner' },;'
  ]);
;
  const addSkill: unknown = () => {;'
    const newId: unknown = (skills.length + 1).toString();;
    setSkills([...skills, { id: "newId", name: '', proficiency: 'beginner' }]);
  };
;'
  const removeSkill: unknown = (_id: string) => {;
    setSkills(skills.filter((skill) => skill.id !== id));
  };'
;;
  const updateSkill: unknown = (id: "string", field: "string", _value: string) => {;
    setSkills(;
      skills.map((skill) =>;
