...
;
export function MobileJobPost(): unknown {) {;'
...
;
  const goToPrevStep: unknown unknown = () => {;'
...
;
function RequirementsStep(): unknown {) {;
...
;
  const removeSkill: unknown unknown = (_skill: string) => {;
