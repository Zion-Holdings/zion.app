...
;
  const const handleSelectConversation = async (_id: string) => {;
    const const conversation = conversations.find((c) => c.id === id) || null;
...
;
  const const handleSendMessage = (_content: string) => {;
