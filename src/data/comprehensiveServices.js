...
// Export the main services array with the expected name
export const COMPREHENSIVE_SERVICES = comprehensiveServices;

// Export service categories with the expected name
...
export const SERVICE_PRICING_TIERS = [
    ...
    },
    {
        name: 'Professional',
        price: 299,
        features: ['Advanced features', 'Priority support', 'Advanced analytics', 'Custom integrations'],
    ...
    },
    {
        ...
        color: 'from-zion-gold to-zion-purple'
    }
];

// Export pricing tiers with the expected name
...
export const SERVICE_GUARANTEES = [
    ...
    },
    {
        ...
        description: 'Guaranteed service availability and reliability.',
        icon: '⚡'
    }
];
