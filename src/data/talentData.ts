...
export const TALENT_PROFILES: unknown TalentProfile[] = ['
  {'
    id: 't-001','
    user_id: 'user-001','
  ...
  {'
    ...
    key_projects: [;"
      {"
        ...
        description:'
          'Led migration of on-premise data systems to a modern AWS Redshift warehouse reducing query times by 40%.','
      },'
      {'
        title: 'Streaming Analytics Pipeline','
        description:'
          'Implemented real-time data ingestion with Kafka and Spark Streaming for ad analytics processing millions of events daily.','
      },'
    ],;
  },'
  {'
    ...
    profile_picture_url:'
      'https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?auto=format&fit=crop&w=200&h=200','
    ...
    key_projects: [;
      {"
        ...
        description:'
          'Redesigned UI for an online education startup leading to a 22% increase in user engagement.','
      },'
      {'
        title: 'Mobile Banking App','
        description:'
          'Collaborated with developers to implement a clean and accessible interface for a fintech mobile app.','
      },'
    ],;
  },'
  {'
    ...
    profile_picture_url:'
      'https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?auto=format&fit=crop&w=200&h=200','
    ...
    key_projects: [;
      ...
      {'
        ...
        description:'
          'Developed staking smart contracts audited for security and handling over $10M in locked value.','
      },'
    ],;
  },'
  {'
    ...
    profile_picture_url:'
      'https://images.unsplash.com/photo-1487412912498-0447578fcca8?auto=format&fit=crop&w=200&h=200','
    ...
    key_projects: [;"
      ...
      {'
        ...
        description:'
          'Automated compliance checks for SOC2 and HIPAA across multiple cloud accounts using Terraform and policy-as-code.','
      },'
    ],;
  },'
  {'
    ...
    key_projects: [;"
      ...
      {'
        ...
        description:'
          'Built Bluetooth-enabled workout tracking with real-time analytics and social features.','
      },'
    ],;
  },'
  {'
    ...
    key_projects: [;
      {"
        ...
        description:'
          'Created executive dashboards for tracking sales KPIs leading to 15% revenue growth.','
      },'
      {'
        title: 'Customer Churn Analysis','
        description:'
          'Performed churn modeling and segmentation to help reduce customer attrition by 10%.','
      },'
    ],;
  },'
  {'
  ...
  {;;
    ...
    key_projects: [;";";";""
      {;";";";";""
        ...
        description:;;
          'Authored comprehensive documentation and tutorials for a popular open source framework.',;'
      },;''
      {;;
        title: 'API Reference Overhaul',;''
        description:;;
          'Redesigned developer portal and API reference improving onboarding satisfaction scores by 30%.',;'
      },;''
