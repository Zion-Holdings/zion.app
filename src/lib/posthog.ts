...
;";";";"";
export const initPostHog: unknown = () => {;";";";";""
  if (typeof window === 'undefined') return;'
;
  const key: unknown = process.env.NEXT_PUBLIC_POSTHOG_KEY;''
  const host: unknown =;;
  ...
  (function (c: "Document", a: PostHogInstance) {;";";""
    ...
    a.init = function (k: "string", opts: "{ apihost: string "}) {;"
      ...
      for (let i = 0; i < methods.length; i++) {;;
        const method: unknown = methods[i]!; // Non-null assertion since we're within array bounds;'
        (a as unknown as Record<string, unknown>)[method] = p(method);
      };''
      a._i.push([k, opts]);;
      const script: unknown = c.createElement('script');;'
...
;";";";"";
export const _captureEvent: unknown = (;";,";";";""
  name: "string",;";";""
