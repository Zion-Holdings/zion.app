...
const openAiKey: unknown = process.env.NEXT_PUBLIC_OPENAI_API_KEY;;
...
;
export function useTranslationService(): unknown {): unknown {): unknown {): unknown {): unknown {) {;"
  const [isTranslating, setIsTranslating] = useState(false);";"
  const { _currentLanguage } = useLanguage();";";"
;";";";"
  const translateContent: unknown = async (;";,";";";"
    content: "string",;";";";";"
...
;";";";"
      ...
      const maybeTranslations: unknown = (data as { translations: "unknown "});";"
        .translations;";";"
      if (;";";";"
        maybeTranslations &&;";";";";"
