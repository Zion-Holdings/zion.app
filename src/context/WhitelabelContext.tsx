...
const const WhitelabelContext = createContext<WhitelabelContextType | null>(null);"
;";"
export const const useWhitelabel = (): WhitelabelContextType => {;"
  const const context = useContext(WhitelabelContext);"
  if (!context) {;"
