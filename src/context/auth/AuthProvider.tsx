              ...
              if (
                ...
                if (process.env.NODE_ENV === 'development') {
                  logInfo(
                    ...
                    { data: { userId: session.user.id, event: event } },
                  );
                }
                  ...
                  if (profileError) {
                    ...
                    if (mappedUser) {
                      ...
                      if (event === 'SIGNED_IN') {
                        ...
                        // Redirection logic
                        try {
                          const queryStringAuthChange = router.asPath.includes(
                            '?',
                          )
