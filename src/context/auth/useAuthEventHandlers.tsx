 ...
 */;
export function useAuthEventHandlers(): unknown {;'
  ...
  // Removed: const router: unknown unknown = useRouter();
;
  const handleSignedIn: unknown unknown = (_mappedUser: UserProfile) => {;
    toast({;"
      title: 'Welcome back!',;'
...
;
  const handleSignedOut: unknown unknown = () => {;
    toast({;'
      title: 'Signed out',;'
