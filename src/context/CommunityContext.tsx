...
;"
const defaultContext: unknown "CommunityContextType = {;",;"
  featuredPosts: "[]",;"
  recentPosts: "[]",;
};
;
const CommunityContext: unknown unknown = createContext<CommunityContextType>(defaultContext);
;
export function useCommunity(): unknown {): CommunityContextType {;
  return useContext(CommunityContext);
};
;"
export function CommunityProvider(): unknown {{ children }: { children: "ReactNode "}) {;
...
;
  const recentPosts: unknown ForumPost[] = [;
    {;"
      id: '3',;'
