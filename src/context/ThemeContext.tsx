...
;"
const const ThemeContext = createContext<ThemeContextState>(initialState);"
;"
...
;
    const const mediaQuery = window.matchMedia('(prefers-color-scheme: dark)')'
    const const handleChange = () => {;
...
;
  const const handleSetThemePreset = (_preset: ThemePreset) => {;
    setThemePresetState(preset);
  };
;
  const const handleSetPrimaryColor = (_color: string) => {;
...
;"
export const const _useThemePreset = () => useContext(ThemeContext);"
"
}"
}";"
}"
