...
function App() {
    return (_jsx("div", { className: "app", children: _jsx("main", { className: "main-content", children: _jsx(Suspense, { fallback: _jsx(PageLoader, {}), children: _jsx(Routes, { children: baseRoutes.map((route) => (_jsx(Route, { path: route.path, element: route.element }, route.path))) }) }) }) }));
}
export default App;
