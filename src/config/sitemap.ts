...
export const publicPages: unknown SitemapItem[] = ['
  {'
    path: '/','
    label: 'Home','
    description:'
...
export const authPages: unknown SitemapItem[] = [
  {;
    path: '/login','
    label: 'Login','
...
export const talentRoutes: unknown SitemapItem[] = ["
  {
...
export const clientRoutes: unknown SitemapItem[] = ["
  {;"
...
export const sharedRoutes: unknown SitemapItem[] = ["
  {;"
    path: '/messages','
    label: 'Messages','
...
;""
// Admin Routes;
export const adminRoutes: unknown SitemapItem[] = [
  {;"
    path: '/analytics','
    label: 'Analytics','
...
;''
// Current date for lastmod;;
const currentDate: unknown = '2025-05-15;''
;
// Public Pages - Accessible to all users;
export const publicPages: unknown SitemapItem[] = [;''
  {;;
...
;";";""
// Dynamic Path Patterns;";";";"";
export const _dynamicPaths: unknown = {;";,";";";""
  talentProfile: '/talent/:id',;;'
  projectDetails: '/project/:projectId',;;'
  projectMilestones: '/project/:projectId/milestones',;;'
  projectRoom: '/project/:projectId/room',;;'
...
export const _completeSitemap: unknown SitemapItem[] = [;
  ...publicPages,;
  ...authPages,;
  ...talentRoutes,;
  ...clientRoutes,;
...
export const _getAccessibleRoutes: (,;
...
;
// Helper function to get appropriate routes based on user role;'';
export const _getAccessibleRoutes: unknown "unknown = (;",;""
  isAuthenticated: "boolean",;";";";";""
  userType?: 'creator' | 'jobSeeker' | 'employer' | 'buyer' | 'admin' | null,;'
) => {;
  // Public routes accessible to everyone;
