export const metadata = {
  title: 'Scaling AI Across Healthcare & Life Sciences Operations | Zion Tech Group',
  ...
  openGraph: {
    title: 'Scaling AI Across Healthcare & Life Sciences Operations',
    description: 'Explore how Healthcare & Life Sciences teams use AI to cut costs, improve outcomes, and scale operations in 2026.',
    type: 'article',
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <header className="mb-12">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">
            Scaling AI Across Healthcare & Life Sciences Operations
          </h1>
        </header>
