# JSON Schema Validator - Case Study
...
We deployed **JSON Schema Validator**, an AI-powered data microservice that:
...
1. Visit: https://ziontechgroup.com/services/json-schema-validator
