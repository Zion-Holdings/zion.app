# LLM Intent Classifier - Case Study
...
We deployed **LLM Intent Classifier**, an AI-powered ai microservice that:
...
1. Visit: https://ziontechgroup.com/services/llm-intent-classifier
