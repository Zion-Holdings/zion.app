# Chatbot Intent Engine - Case Study
...
We deployed **Chatbot Intent Engine**, an AI-powered ai microservice that:
...
1. Visit: https://ziontechgroup.com/services/chatbot-intent-engine
