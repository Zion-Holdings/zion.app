#!/usr/bin/env python3
"""Small-wave single-message cron send for lead growth.

Reads outreach_ready_canonical.json by default, applies exclusions and
72h dedupe, sends at most one message, writes send_verification_result.json,
and runs the fallback probe automatically.
"""
import sys, json, os, time, datetime, base64, urllib.request, urllib.error
