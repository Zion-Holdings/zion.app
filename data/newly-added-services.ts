  ...
  },
  {
    ...
    launchDate: '2025-08-22',
    		customers: 10,
					...
					{
						id: 'ai-seo-content-optimizer-pro',
						name: 'AI SEO Content Optimizer Pro',
						tagline: 'Real-time on-page SEO optimization with competitive SERP insights',
						price: '$59',
						period: '/month',
						description: 'On-page grader with NLP entity coverage, internal link suggestions, schema hints, and competitor gap analysis. Export briefs and track scores over time.',
						features: [
							'Real-time content score and entity coverage',
							'Competitor SERP analysis and gap insights',
							'Automatic schema and FAQ suggestions',
							'Internal link and anchor suggestions',
							'Brief exports and change history'
						],
						popular: true,
						icon: '🔎',
						color: 'from-cyan-600 to-blue-700',
						textColor: 'text-cyan-300',
						link: 'https://ziontechgroup.com/services/ai-seo-content-optimizer-pro',
						marketPosition: 'Comparable to SurferSEO and Clearscope with stronger internal linking and schema guidance.',
						targetAudience: 'Content, SEO, growth teams',
						trialDays: 7,
						setupTime: '15 minutes',
						category: 'AI & Data',
						realService: true,
						technology: ['Next.js', 'Node.js', 'OpenAI/Embeddings'],
						integrations: ['WordPress', 'Shopify', 'Webflow'],
						useCases: ['Content briefs', 'On-page optimization'],
						roi: 'Faster time-to-rank and higher topical coverage.',
						competitors: ['SurferSEO', 'Clearscope', 'MarketMuse'],
						marketSize: '$1B SEO tooling',
						growthRate: '20% CAGR',
						variant: 'ai-futuristic',
						contactInfo: contact,
						realImplementation: true,
						implementationDetails: 'Content scoring engine, SERP crawler, embeddings-based entity coverage.',
						launchDate: '2025-08-22',
						customers: 8,
						rating: 4.7,
						reviews: 3
					},
					{
						...
						tagline: 'AI-suggested internal links with change proposals and diffs',
						price: '$19',
						period: '/month',
						description: 'Continuously proposes internal links per page with anchors, calculates PageRank-like flow, and exports PRs for CMS/Git.',
						features: [
							'Anchor recommendations with context',
							'Change proposal previews and diffs',
							'Priority queues and suggested batches',
							'PR/commit export for Git CMS',
							'Impact scoring and rollback'
						],
						popular: false,
						icon: '🔗',
						...
						marketPosition: 'Lightweight alternative to Link Whisper with team workflows.',
						...
						integrations: ['GitHub', 'GitLab', 'Bitbucket'],
						useCases: ['SEO internal links', 'Content updates'],
						roi: 'Higher crawl efficiency and topical signals.',
						competitors: ['Link Whisper'],
						marketSize: '$0.4B SEO plugins',
						growthRate: '12% CAGR',
						variant: 'holographic-matrix',
						contactInfo: contact,
						realImplementation: true,
						implementationDetails: 'Static analysis + embeddings + CMS git export.',
						launchDate: '2025-08-22',
						customers: 6,
						rating: 4.6,
						reviews: 4
					},
					{
						...
						tagline: 'Discover underserved topics with intent and SERP difficulty',
						price: '$29',
						period: '/month',
						description: 'Imports Search Console and competitor pages to recommend low‑competition keywords with intent labels and content outlines.',
						features: [
							'Search Console mining',
							'Competitor SERP clustering',
						...
						marketPosition: 'Focused on practical, niche discovery for SMBs.',
						targetAudience: 'SEO freelancers and SMBs',
						trialDays: 7,
						setupTime: '10 minutes',
						category: 'Developer Tools',
						realService: true,
						...
						useCases: ['Content planning', 'Topic discovery'],
						roi: 'Faster wins and better topical maps.',
						competitors: ['Keyword Chef'],
						marketSize: '$1B SEO tools',
						growthRate: '10% CAGR',
						variant: 'network-futuristic',
						contactInfo: contact,
						realImplementation: true,
						implementationDetails: 'SERP scraping + GSC import + clustering.',
						launchDate: '2025-08-22',
						customers: 4,
						rating: 4.5,
						reviews: 2
					...
					{
						id: 'returns-management-portal',
						name: 'Returns Management Portal',
						tagline: 'Automate labels, tracking, and refunds for ecommerce',
						price: '$49',
						period: '/month',
						description: 'Self‑service returns center with label generation, status tracking, and refund workflows. Embeddable widgets and portals.',
						features: [
						...
						color: 'from-amber-600 to-orange-700',
						textColor: 'text-amber-300',
						link: 'https://ziontechgroup.com/services/returns-management-portal',
						marketPosition: 'Lean alternative to AfterShip/Loop for SMBs.',
						targetAudience: 'Ecommerce SMBs and agencies',
						trialDays: 14,
						setupTime: '1 hour',
						category: 'Developer Tools',
						realService: true,
						...
						useCases: ['Returns', 'Exchanges'],
						roi: 'Fewer tickets and faster refunds.',
						competitors: ['Loop', 'Returnly'],
						marketSize: '$0.6B returns software',
						growthRate: '14% CAGR',
						variant: 'holographic-futuristic',
						contactInfo: contact,
						realImplementation: true,
						implementationDetails: 'Carrier APIs + portal + webhooks.',
						launchDate: '2025-08-22',
						customers: 9,
						rating: 4.6,
						reviews: 4
					},
					{
						...
						tagline: 'Drafts and routes replies for common inquiries',
						price: '$29',
						period: '/month',
						description: 'Gmail/Office 365 plugin that drafts replies, routes tickets, and prioritizes urgent threads with approvals.',
						features: [
							'Reply drafts with variables',
						...
						marketPosition: 'Focused on SMB support workflows with approval gates.',
						targetAudience: 'Support and sales ops',
						trialDays: 7,
						setupTime: '20 minutes',
						category: 'AI & Data',
						realService: true,
						technology: ['Next.js'],
						integrations: ['Gmail', 'Office 365', 'Zendesk', 'Freshdesk'],
						useCases: ['Tier‑1 replies', 'Prioritization'],
						roi: 'Lower response time and resolution cost.',
						competitors: ['Superhuman AI (partial)'],
						marketSize: '$2B email productivity',
						growthRate: '18% CAGR',
						variant: 'ai-futuristic',
						contactInfo: contact,
						realImplementation: true,
						implementationDetails: 'Gmail/Graph APIs + templates + approvals.',
						launchDate: '2025-08-22',
						customers: 11,
						rating: 4.6,
						reviews: 6
					...
					{
						id: 'helpdesk-itsm-starter',
						name: 'Helpdesk & ITSM Starter',
						tagline: 'Ticketing, SLAs, and knowledge base without complexity',
						price: '$39',
						period: '/month',
						description: 'Lean helpdesk with email capture, SLAs, macros, and a searchable knowledge base. Fits startups and MSPs.',
						features: [
						...
						color: 'from-emerald-600 to-green-700',
						textColor: 'text-emerald-300',
						link: 'https://ziontechgroup.com/services/helpdesk-itsm-starter',
						marketPosition: 'SMB-focused alternative to Zendesk/JSM.',
						targetAudience: 'Startups and MSPs',
						trialDays: 14,
						setupTime: '1 hour',
						category: 'Developer Tools',
						realService: true,
						...
						useCases: ['IT tickets', 'Customer support'],
						roi: 'Faster responses; fewer escalations.',
						competitors: ['Zendesk', 'Freshdesk', 'JSM'],
						marketSize: '$10B helpdesk',
						growthRate: '13% CAGR',
						variant: 'neural-quantum',
						contactInfo: contact,
						realImplementation: true,
						implementationDetails: 'Ticketing + KB + SLAs.',
						launchDate: '2025-08-22',
						customers: 7,
						rating: 4.5,
						reviews: 3
					},
					{
						...
						tagline: 'Adaptive surveys optimized for mobile conversions',
						price: '$29',
						period: '/month',
						description: 'Beautiful, fast surveys with logic, scoring, and analytics. Embeddable and link‑based.',
						features: [
						...
						marketPosition: 'Lean alternative to Typeform for SMB feedback.',
						targetAudience: 'Marketing and CX',
						trialDays: 7,
						setupTime: '15 minutes',
						category: 'Developer Tools',
						realService: true,
						technology: ['Next.js'],
						integrations: ['Slack', 'HubSpot', 'Sheets'],
						useCases: ['NPS', 'Lead capture'],
						roi: 'Higher completion rates on mobile.',
						competitors: ['Typeform', 'Tally'],
						marketSize: '$1.5B survey tools',
						growthRate: '11% CAGR',
						variant: 'holographic-matrix',
						contactInfo: contact,
						realImplementation: true,
						implementationDetails: 'Form builder + logic + analytics.',
						launchDate: '2025-08-22',
						customers: 5,
						rating: 4.5,
						reviews: 2
					...
					{
						id: 'internal-docs-generator',
						name: 'Internal Docs Generator',
						tagline: 'Convert API/code comments to living docs with CI',
						price: '$25',
						period: '/month',
						description: 'Parses OpenAPI and code comments to generate and publish internal docs with diffs and review workflows.',
						features: [
							'OpenAPI + code parser',
							'Preview diffs and approvals',
						...
						color: 'from-indigo-600 to-purple-700',
						textColor: 'text-indigo-300',
						link: 'https://ziontechgroup.com/services/internal-docs-generator',
						marketPosition: 'Docs from source with review gates for safety.',
						targetAudience: 'Platform and DX teams',
						trialDays: 14,
						setupTime: '30 minutes',
						category: 'Developer Tools',
						realService: true,
						...
						useCases: ['API docs', 'Internal runbooks'],
						roi: 'Less drift, better onboarding.',
						competitors: ['SwaggerHub', 'Stoplight'],
						marketSize: '$0.8B dev docs',
						growthRate: '9% CAGR',
						variant: 'holographic-futuristic',
						contactInfo: contact,
						realImplementation: true,
						implementationDetails: 'Parsers + renderer + auth.',
						launchDate: '2025-08-22',
						customers: 3,
						rating: 4.5,
						reviews: 1
