...
export const realMarketServices: RealMarketService[] = [
  ...
  {
    id: 'sbom-dependency-risk-monitor',
    name: 'SBOM & Dependency Risk Monitor',
    tagline: 'Continuously generate SBOMs, detect vulnerabilities, and enforce SCA policies',
    price: '$59',
    period: '/month',
    description: 'Automated Software Bill of Materials (SBOM) generation with vulnerability intelligence and supply-chain policy enforcement across repositories and builds.',
    features: [
      'SBOM generation (CycloneDX/SPDX)',
      'Known CVE detection with severity scoring',
      'License policy enforcement (allow/deny lists)',
      'Reachability and exploitability heuristics',
      'CI/CD gates and PR annotations',
      'Automatic fix PRs and upgrade guidance'
    ],
    popular: true,
    icon: '🧰',
    color: 'from-emerald-600 to-teal-700',
    textColor: 'text-emerald-300',
    link: 'https://ziontechgroup.com/services/sbom-dependency-risk-monitor',
    marketPosition: 'Practical alternative to Snyk and Mend for SBOM-first programs; integrates with native scanners.',
    targetAudience: 'Platform engineering, AppSec, CTOs',
    trialDays: 14,
    setupTime: '1 day',
    category: 'Security & Compliance',
    realService: true,
    technology: ['Node.js, CycloneDX, SPDX, OSV, GitHub/GitLab CI'],
    integrations: ['GitHub, GitLab, Bitbucket, Jenkins, Azure DevOps'],
    useCases: ['SBOM compliance, SCA enforcement, Vulnerability management'],
    roi: 'Reduce critical vulns time-to-remediate by 40–70%.',
    competitors: ['Snyk, Mend, Dependabot'],
    marketSize: '$3B+ software supply chain security',
    growthRate: '28% YoY',
    variant: 'security-futuristic',
    contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'SBOM generators, OSV aggregator, policy engine, CI annotations, and remediation workflows.',
    launchDate: '2025-08-22',
    customers: 19,
    rating: 4.7,
    reviews: 11
  },
  {
    ...
    price: '$39',
    period: '/month',
    description: 'Centralize OpenAPI/JSON Schema specs with semantic diffing in CI, documentation previews, SDK hooks, and compatibility scorecards.',
    features: [
      'Semantic OpenAPI/JSON Schema diffing',
      'Breaking change detection gates',
      'Changelog and docs previews',
    ...
    marketPosition: 'Lightweight alternative to SwaggerHub; purpose-built for CI-first API teams.',
    targetAudience: 'API platform teams, backend engineers, QA',
    trialDays: 14,
    setupTime: '2 hours',
    category: 'Developer Tools',
    realService: true,
    technology: ['OpenAPI, JSON Schema, Node.js, Next.js'],
    integrations: ['GitHub Actions, GitLab CI, Jenkins, CircleCI'],
    useCases: ['Prevent breaking changes, Improve API velocity, Align contracts'],
    roi: 'Cut API regressions by 50% and speed releases.',
    competitors: ['SwaggerHub, Stoplight, Speakeasy'],
    marketSize: '$2B+ API lifecycle tooling',
    growthRate: '22% YoY',
    variant: 'api-futuristic',
    contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Spec store, diff engine, docs previewer, CI annotators, and web UI.',
    launchDate: '2025-08-22',
    customers: 27,
    rating: 4.6,
    reviews: 15
  ...
  {
    id: 'dns-failover-traffic-steering',
    name: 'DNS Failover & Traffic Steering',
    tagline: 'Health-checked multi-region routing with automatic failover and geo steering',
    price: '$49',
    period: '/month',
    description: 'Policy-based DNS steering and failover across providers and regions with health checks, SLA tracking, and runbooks.',
    features: [
      'Multi-target health checks',
      'Latency- and geo-based routing',
      'Automatic failover with notifications',
      'Synthetic probe network',
      'Incident webhooks and runbooks'
    ],
    popular: false,
    icon: '🌐',
    color: 'from-purple-600 to-indigo-700',
    textColor: 'text-purple-300',
    link: 'https://ziontechgroup.com/services/dns-failover-traffic-steering',
    marketPosition: 'Complements Cloudflare/AWS Route 53 with cross-vendor orchestration and SRE playbooks.',
    targetAudience: 'SRE, platform engineering, network ops',
    trialDays: 7,
    setupTime: '2 hours',
    category: 'Cloud & FinOps',
    realService: true,
    technology: ['DNS, Health checks, Workers/Functions'],
    integrations: ['Cloudflare, AWS Route 53, NS1, Fastly'],
    useCases: ['Improve uptime, Geo-routing, Disaster recovery'],
    roi: 'Reduce downtime minutes and latency variance.',
    competitors: ['Cloudflare Load Balancing, Route 53 ARC'],
    marketSize: '$1B traffic management',
    growthRate: '14% YoY',
    variant: 'network-futuristic',
    contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Health prober fleet, routing policy engine, and notification integrations.',
    launchDate: '2025-08-22',
    customers: 12,
    rating: 4.5,
    reviews: 7
  ...
  {
    id: 'web-performance-budget-enforcer',
    name: 'Web Performance Budget Enforcer',
    tagline: 'Automate Lighthouse budgets and block regressions in CI/CD',
    price: '$29',
    period: '/month',
    description: 'Define and enforce performance budgets (LCP, CLS, TBT, size) across pages and releases with PR annotations and trend dashboards.',
    features: [
      'Lighthouse and Web Vitals budgets',
      'PR annotations and CI gates',
      'Historical trends and alerts',
      'Third-party script watchlist',
      'Synthetic checks on schedules'
    ],
    popular: true,
    icon: '⚡',
    color: 'from-amber-600 to-orange-700',
    textColor: 'text-amber-300',
    link: 'https://ziontechgroup.com/services/web-performance-budget-enforcer',
    marketPosition: 'Faster setup than DIY scripts; complements SpeedCurve/Calibre.',
    targetAudience: 'Frontend teams, growth, platform',
    trialDays: 7,
    setupTime: '1 hour',
    category: 'Quality & Monitoring',
    realService: true,
    technology: ['Lighthouse CI, Puppeteer/Playwright, Vercel/Netlify'],
    integrations: ['GitHub, Slack, Datadog'],
    useCases: ['Prevent regressions, Optimize funnels, Enforce budgets'],
    roi: 'Improve conversion by 2–10% with faster pages.',
    competitors: ['SpeedCurve, Calibre, Treo'],
    marketSize: '$800M web performance',
    growthRate: '12% YoY',
    variant: 'monitoring-futuristic',
    contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Budget config, runners, PR annotations, and dashboard templates.',
    launchDate: '2025-08-22',
    customers: 41,
    rating: 4.7,
    reviews: 28
  ...
  {
    id: 'ai-prompt-injection-firewall',
    name: 'AI Prompt Injection Firewall',
    tagline: 'Guardrail proxy to detect prompt injection and data exfiltration attempts',
    price: '$79',
    period: '/month',
    description: 'Model-agnostic proxy with attack pattern detection, tool-use constraints, output filtering, and policy actions to secure LLM apps.',
    features: [
      'Attack pattern and jailbreak detection',
      'PII/PHI redaction and output filters',
      'Tool permission policies and sandboxes',
      'Audit logs and safety scoring',
    ...
    link: 'https://ziontechgroup.com/services/ai-prompt-injection-firewall',
    marketPosition: 'Complements red-teaming with runtime protection for production traffic.',
    targetAudience: 'AI platform teams, security engineering',
    trialDays: 14,
    setupTime: '2 hours',
    category: 'AI & Data',
    realService: true,
    technology: ['LLM gateways, policy engines, content filters'],
    integrations: ['OpenAI, Anthropic, Vertex AI, Bedrock'],
    useCases: ['Mitigate prompt injection, Prevent data leaks, Enforce policies'],
    roi: 'Reduce security incidents and model misuse risk.',
    competitors: ['Protect AI, LLM Guard, Lakera'],
    marketSize: '$1.5B AI security (growing)',
    growthRate: '60% YoY',
    variant: 'ai-futuristic',
    contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Proxy adapters, rule packs, detection models, and policy actions.',
    launchDate: '2025-08-22',
    customers: 22,
    rating: 4.6,
    reviews: 14
  ...
  {
    id: 'third-party-api-sla-monitor',
    name: 'Third-Party API SLA Monitor',
    tagline: 'Synthetic checks, uptime SLAs, and contract verification for partner APIs',
    price: '$35',
    period: '/month',
    description: 'Track the reliability, latency, and contract compliance of external APIs with global probes, canary flows, and automatic incident alerts.',
    features: [
      'Global synthetic probes',
      'Contract tests and schema checks',
      'Latency SLOs and error budgets',
      'Incident detection and alerts',
      'Reports for vendors and audits'
    ],
    popular: false,
    icon: '📡',
    color: 'from-sky-600 to-indigo-700',
    textColor: 'text-sky-200',
    link: 'https://ziontechgroup.com/services/third-party-api-sla-monitor',
    marketPosition: 'Complements Postman/APImetrics with turnkey SLO/error budget views and alerts.',
    targetAudience: 'Platform, partner engineering, FinTechs',
    trialDays: 7,
    setupTime: '2 hours',
    category: 'Observability',
    realService: true,
    technology: ['OpenAPI, Playwright, OTel, Timeseries DB'],
    integrations: ['Postman, Datadog, Grafana, PagerDuty'],
    useCases: ['Vendor management, SLA tracking, Risk reduction'],
    roi: 'Avoid partner API outages and chargebacks.',
    competitors: ['APImetrics, Checkly, Postman monitors'],
    marketSize: '$1B API monitoring',
    growthRate: '18% YoY',
    variant: 'monitoring-futuristic',
    contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Probes, contract runners, SLO calculator, and incident notifier.',
    launchDate: '2025-08-22',
    customers: 16,
    rating: 4.5,
    reviews: 9
  ...
  {
    id: 'product-feedback-insights',
    name: 'AI Product Feedback Insights',
    tagline: 'Unify NPS, surveys, and reviews with AI clustering and themes',
    price: '$49',
    period: '/month',
    description: 'Aggregate feedback from surveys, app stores, tickets, and social; use AI to cluster themes, route issues, and inform product roadmap.',
    features: [
      'Multi-source feedback ingestion',
      'AI theme clustering and summarization',
      'NPS/CSAT dashboards with trends',
      'Auto-tagging and routing',
      'Export to BI and roadmaps'
    ],
    popular: true,
    icon: '💬',
    color: 'from-fuchsia-600 to-purple-700',
    textColor: 'text-fuchsia-200',
    link: 'https://ziontechgroup.com/ai-product-feedback-insights',
    marketPosition: 'More flexible than point tools; integrates with existing survey platforms.',
    targetAudience: 'Product, CX, growth teams',
    trialDays: 14,
    setupTime: '1 day',
    category: 'AI & Data',
    realService: true,
    technology: ['NLP, Embeddings, Vector DB, Next.js'],
    integrations: ['Qualtrics, Typeform, Delighted, Zendesk'],
    useCases: ['Prioritize roadmap, Improve retention, Monitor satisfaction'],
    roi: 'Reduce churn by identifying top friction themes fast.',
    competitors: ['UnitQ, Thematic, Chattermill'],
    marketSize: '$2B+ VoC analytics',
    growthRate: '20% YoY',
    variant: 'analytics-futuristic',
    contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Connectors, embedding pipelines, clustering, and dashboards.',
    launchDate: '2025-08-22',
    customers: 29,
    rating: 4.6,
    reviews: 17
  ...
  {
    id: 'data-contracts-governance',
    name: 'Data Contracts & Governance',
    tagline: 'Define, test, and enforce data contracts with lineage and alerts',
    price: '$79',
    period: '/month',
    description: 'Contract-first data governance with schema testing, lineage awareness, and quality gates at every pipeline stage.',
    features: [
      'Schema and semantic testing in CI',
      'Lineage and impact analysis',
      'SLAs/SLOs for datasets',
    ...
    link: 'https://ziontechgroup.com/data-contracts-governance',
    marketPosition: 'Complements dbt and OpenLineage; productizes quality gates for teams.',
    targetAudience: 'Data engineering, analytics, platform',
    trialDays: 14,
    setupTime: '1-3 days',
    category: 'AI & Data',
    realService: true,
    technology: ['dbt, OpenLineage, Great Expectations'],
    integrations: ['Snowflake, BigQuery, Databricks, Airflow'],
    useCases: ['Prevent data breaks, Improve trust, Speed analytics'],
    roi: 'Reduce data downtime by 50–80%.',
    competitors: ['Monte Carlo, Metaplane, Soda'],
    marketSize: '$4B data observability',
    growthRate: '26% YoY',
    variant: 'data-futuristic',
    contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Contract repo, test runners, lineage, and alerting integrations.',
    launchDate: '2025-08-22',
    customers: 18,
    rating: 4.5,
    reviews: 10
