...
PROSPECT_POOLS = {
    'ai': [
        ...
        {'name': 'Liam Chen', 'company': 'SynthAI Systems', 'email': 'lchen@synthai.com'},
        {'name': 'Isabella Rossi', 'company': 'NeuroNet Technologies', 'email': 'irossi@neuronet.com'},
        {'name': 'Noah Kim', 'company': 'BrainBoost AI', 'email': 'nkim@brainboost.ai'},
        {'name': 'Ava Thompson', 'company': 'LogicGate AI', 'email': 'athompson@logicgate.ai'},
        {'name': 'Ethan Park', 'company': 'MindTech AI', 'email': 'epark@mindtech.ai'},
        {'name': 'Mia Johnson', 'company': 'CortexAI Solutions', 'email': 'mjohnson@cortexai.com'},
        {'name': 'Oliver Smith', 'company': 'AlgoLogic AI', 'email': 'osmith@algologic.ai'},
        {'name': 'Grace Lee', 'company': 'SmartCore AI', 'email': 'glee@smartcore.ai'},
        {'name': 'Lucas Brown', 'company': 'DataCraft AI', 'email': 'lbrown@datacraft.ai'},
        {'name': 'Emma Davis', 'company': 'VisionAI Corp', 'email': 'edavis@visionai.com'},
        {'name': 'Daniel Wilson', 'company': 'PatternMind AI', 'email': 'dwilson@patternmind.ai'},
        {'name': 'Sophia Garcia', 'company': 'Neuronet AI', 'email': 'sgarcia@neuronet.ai'},
        {'name': 'Michael Chen', 'company': 'TensorFlow AI', 'email': 'mchen2@tensorflow.ai'},
    ],
    'it-services': [
        ...
        {'name': 'Alex Morgan', 'company': 'CloudSecure Solutions', 'email': 'amorgan@cloudsecure.com'},
        {'name': 'Priya Sharma', 'company': 'NetDefend AI', 'email': 'psharma@netdefend.ai'},
        {'name': 'Chris Taylor', 'company': 'FireWall Pro', 'email': 'ctaylor@firewallpro.com'},
        {'name': 'Sarah Johnson', 'company': 'SecureCloud IT', 'email': 'sarah.johnson@securecloud.com'},
        {'name': 'Dr. Michael Chen', 'company': 'DataShield Security', 'email': 'mchen@datalshield.com'},
        {'name': 'Rachel Martinez', 'company': 'GuardNet Systems', 'email': 'rmartinez@guardnet.com'},
        {'name': 'David Park', 'company': 'CyberSentinel', 'email': 'dpark@cybersentinel.ai'},
        {'name': 'Emma Wilson', 'company': 'ThreatIntel Pro', 'email': 'ewilson@threatintelpro.com'},
        {'name': 'James Liu', 'company': 'NetShield AI', 'email': 'jliu@netshield.ai'},
        {'name': 'Olivia Kim', 'company': 'SecureOps Solutions', 'email': 'okim@secureops.com'},
    ],
    'cloud': [
        ...
        {'name': 'Jessica Williams', 'company': 'AzureEdge Solutions', 'email': 'jwilliams@azureedge.com'},
        {'name': 'Daniel Kim', 'company': 'NebulaCloud AI', 'email': 'dkim@nebulacloud.ai'},
        {'name': 'Sophia Martinez', 'company': 'StratoServe', 'email': 'smartinez@stratserve.com'},
        {'name': 'Kevin Johnson', 'company': 'CloudNova Systems', 'email': 'kjohnston@cloudnova.com'},
        {'name': 'Emma Thompson', 'company': 'SkyScale AI', 'email': 'ethompson@skyscale.ai'},
        {'name': 'Ryan Park', 'company': 'HyperCloud Solutions', 'email': 'rpark@hypercloud.com'},
        {'name': 'Olivia Davis', 'company': 'EdgeCloud Pro', 'email': 'odavis@edgecloudpro.com'},
        {'name': 'James Wilson', 'company': 'CloudBridge Technologies', 'email': 'jwilson@cloudbridge.tech'},
        {'name': 'Ava Chen', 'company': 'DigitalOcean Pro', 'email': 'achen@digitaloceanpro.com'},
        {'name': 'Noah Anderson', 'company': 'AWS Optimizer AI', 'email': 'nanderson@awsoptimizer.ai'},
    ],
    'data': [
        ...
        {'name': 'Elena Vasquez', 'company': 'BigData Pro', 'email': 'evasquez@bigdatapro.com'},
        {'name': 'Carlos Ruiz', 'company': 'DataFlow AI', 'email': 'cruiz@dataflow.ai'},
        {'name': 'Julia Martinez', 'company': 'Analytics360', 'email': 'jmartinez@analytics360.com'},
        {'name': 'Thomas Wright', 'company': 'InsightData AI', 'email': 'twright@insightdata.ai'},
        {'name': 'Lily Chen', 'company': 'StatStream Analytics', 'email': 'lchen@statstream.com'},
        {'name': 'Noah Kim', 'company': 'DataForge AI', 'email': 'nkim@dataforge.ai'},
        {'name': 'Isabella Torres', 'company': 'MetricsPro', 'email': 'itorres@metricspro.com'},
        {'name': 'Lucas Anderson', 'company': 'DataLogic AI', 'email': 'landerson@datalogic.ai'},
        {'name': 'Emma Richardson', 'company': 'TrendData AI', 'email': 'erichardson@trenddata.ai'},
        {'name': 'Miguel Garcia', 'company': 'DataPulse Analytics', 'email': 'mgarcia@datapulse.ai'},
    ],
    'security': [
        ...
        {'name': 'David Lee', 'company': 'CyberShield Pro', 'email': 'dlee@cybershieldpro.com'},
        {'name': 'Sarah Miller', 'company': 'NetSecure AI', 'email': 'smiller@netsecure.ai'},
        {'name': 'Michael Chen', 'company': 'ThreatWatch AI', 'email': 'mchen3@threatwatch.ai'},
        {'name': 'Emily Davis', 'company': 'SecurityFirst AI', 'email': 'edavis@securityfirst.ai'},
        {'name': 'James Wilson', 'company': 'CyberSentinel Pro', 'email': 'jwilson2@cybersentinelpro.com'},
        {'name': 'Olivia Martinez', 'company': 'DataProtect Security', 'email': 'omartinez@dataprotect.com'},
        {'name': 'Daniel Kim', 'company': 'GuardNet Security', 'email': 'dkim2@guardnet.com'},
        {'name': 'Sophia Johnson', 'company': 'ShieldAI Solutions', 'email': 'sjohnson@shieldai.com'},
        {'name': 'Ryan Thompson', 'company': 'SecureFlow AI', 'email': 'rthompson@secureflow.ai'},
        {'name': 'Ava Anderson', 'company': 'NetGuard AI', 'email': 'aanderson@netguard.ai'},
    ],
    'automation': [
        ...
        {'name': 'Liam Chen', 'company': 'AutoPilot AI', 'email': 'lchen@autopilot.ai'},
        {'name': 'Isabella Rossi', 'company': 'ProcessFlow AI', 'email': 'irossi@processflow.ai'},
        {'name': 'Noah Kim', 'company': 'TaskMaster AI', 'email': 'nkim@taskmaster.ai'},
        {'name': 'Ava Thompson', 'company': 'WorkflowAI Solutions', 'email': 'athompson@workflowai.com'},
        {'name': 'Ethan Park', 'company': 'AutoGenius', 'email': 'epark@autogenius.com'},
        {'name': 'Mia Johnson', 'company': 'RoboProcess AI', 'email': 'mjohnson@roboprocess.ai'},
        {'name': 'Oliver Smith', 'company': 'SmartWorkflow AI', 'email': 'osmith@smartworkflow.ai'},
        {'name': 'Grace Lee', 'company': 'TaskFlow AI', 'email': 'glee@taskflow.ai'},
        {'name': 'Lucas Brown', 'company': 'AutoPilot Pro', 'email': 'lbrown@autopilotpro.com'},
    ],
    'logistics': [
        ...
        {'name': 'Jessica Williams', 'company': 'LogiCore AI', 'email': 'jwilliams@logicore.ai'},
        {'name': 'Daniel Kim', 'company': 'ShipTrack AI', 'email': 'dkim3@shiptrack.ai'},
        {'name': 'Sophia Martinez', 'company': 'FreightFlow AI', 'email': 'smartinez@freightflow.ai'},
        {'name': 'Kevin Johnson', 'company': 'RouteAI Solutions', 'email': 'kjohnston2@routeai.com'},
        {'name': 'Emma Thompson', 'company': 'CargoMind AI', 'email': 'ethompson2@cargomind.ai'},
        {'name': 'Ryan Park', 'company': 'LogiSmart AI', 'email': 'rpark2@logismart.ai'},
        {'name': 'Olivia Davis', 'company': 'TransitAI Pro', 'email': 'odavis2@transitaipro.com'},
        {'name': 'James Wilson', 'company': 'FleetFlow AI', 'email': 'jwilson3@fleetflow.ai'},
        {'name': 'Ava Chen', 'company': 'SupplyAI Solutions', 'email': 'achen2@supplyai.com'},
        {'name': 'Noah Anderson', 'company': 'DeliveryAI Pro', 'email': 'nanderson2@deliveryaipro.com'},
    ],
    'healthcare': [
        ...
        {'name': 'Dr. Emily Davis', 'company': 'HealthAI Solutions', 'email': 'edavis@healthai.com'},
        {'name': 'James Wilson', 'company': 'MediTech AI', 'email': 'jwilson4@meditech.ai'},
        {'name': 'Olivia Kim', 'company': 'CareAI Pro', 'email': 'okim2@careaipro.com'},
        {'name': 'Daniel Kim', 'company': 'HealFlow AI', 'email': 'dkim4@healfow.ai'},
        {'name': 'Sophia Martinez', 'company': 'MediCore AI', 'email': 'smartinez2@medicore.ai'},
        {'name': 'Kevin Johnson', 'company': 'HealthSync AI', 'email': 'kjohnston3@healthsync.ai'},
        {'name': 'Emma Thompson', 'company': 'PatientAI Pro', 'email': 'ethompson3@patientaipro.com'},
        {'name': 'Ryan Park', 'company': 'HealNet AI', 'email': 'rpark3@healnet.ai'},
        {'name': 'Ava Chen', 'company': 'MediFlow AI', 'email': 'achen3@mediflow.ai'},
        {'name': 'Noah Anderson', 'company': 'HealthBridge AI', 'email': 'nanderson3@healthbridge.ai'},
    ],
    'financial-services': [
        {'name': 'William Turner', 'company': 'FinLedger Systems', 'email': 'wturner@finledger.com'},
        ...
        {'name': 'Michael Lee', 'company': 'FinFlow AI', 'email': 'mlee2@finflow.ai'},
        {'name': 'Emily Davis', 'company': 'BankAI Solutions', 'email': 'edavis2@bankai.com'},
        {'name': 'James Wilson', 'company': 'CapitalAI Pro', 'email': 'jwilson5@capitalaipro.com'},
        {'name': 'Olivia Kim', 'company': 'LedgerAI Pro', 'email': 'okim3@ledgeraipro.com'},
        {'name': 'Daniel Anderson', 'company': 'TradeAI Solutions', 'email': 'danderson@tradeai.com'},
        {'name': 'Sophia Martinez', 'company': 'InvestAI Pro', 'email': 'smartinez3@investaipro.com'},
        {'name': 'Ryan Thompson', 'company': 'PayAI Solutions', 'email': 'rthompson2@payai.com'},
        {'name': 'Ava Chen', 'company': 'RiskAI Pro', 'email': 'achen4@riskaipro.com'},
        {'name': 'Noah Wilson', 'company': 'InsurAI Pro', 'email': 'nwilson@insuraipro.com'},
    ],
    'telecom': [
        {'name': 'Victoria Scott', 'company': '5GWave Technologies', 'email': 'vscott@5gwave.com'},
        {'name': 'Mark Anderson', 'company': 'TeleNet Systems', 'email': 'manderson@telenet.com'},
        ...
        {'name': 'Jessica Williams', 'company': '5GTech AI', 'email': 'jwilliams2@5gtech.ai'},
        {'name': 'Daniel Kim', 'company': 'NetMobile AI', 'email': 'dkim5@netmobile.ai'},
        {'name': 'Sophia Martinez', 'company': 'SignalAI Solutions', 'email': 'smartinez4@signalai.com'},
        {'name': 'Kevin Johnson', 'company': 'VoiceAI Pro', 'email': 'kjohnston4@voiceaipro.com'},
        {'name': 'Emma Thompson', 'company': 'DataTel AI', 'email': 'ethompson4@datatel.ai'},
        {'name': 'Ryan Park', 'company': '5GWave AI', 'email': 'rpark4@5gwave.ai'},
        {'name': 'Olivia Davis', 'company': 'CellAI Pro', 'email': 'odavis3@cellaipro.com'},
        {'name': 'James Wilson', 'company': 'BroadbandAI', 'email': 'jwilson6@broadbandai.com'},
        {'name': 'Ava Chen', 'company': 'IoT Telecom AI', 'email': 'achen5@iottelecom.ai'},
    ],
}
