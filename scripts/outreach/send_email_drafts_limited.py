#!/usr/bin/env python3
"""Send drafted emails from draft_*.json files - limited batch version"""
import json
import sys
import time
import base64
...
BATCH_SIZE = 10  # Process only 10 emails per run
...
def main():
    print("=" * 60)
    print("📤 Sending Drafted Emails (Limited Batch)")
    print("=" * 60)
    ...
    for draft_file in all_draft_files:
        ...
        processed += 1
        time.sleep(0.2)  # Short delay to avoid 429 errors
