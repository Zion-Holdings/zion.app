#!/usr/bin/env python3
"""
Live Send Script with Throttled Batch Dispatch
Enforces 12-18 second random delay between individual email sends.
"""
import sys
import json
import random
...
def main():
    ...
    print("=" * 60)
    print("📤 LIVE SEND - Throttled Batch Dispatch")
    print("=" * 60)
