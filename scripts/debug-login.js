...
async function testLoginApi() {
  try {
    ...
    console.warn('\n4. Testing environment variables...');'    const supabaseUrl = process.env.NEXT_PUBLIC_SUPABASE_URL;
    ...
    console.warn('\n🔐 Development User Configuration...');'    const devUser1Email = process.env.DEV_USER_1_EMAIL;
    ...
    console.warn('\n5. Testing login logic simulation...');'    const testEmail = devUser1Email || 'test@example.com';'    const testPassword = devUser1Password || 'test123';'    
    ...
    console.warn('\n6. Testing fallback authentication...');'    const fallbackUsers = [
