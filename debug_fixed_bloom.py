...
# Bloom filter with deterministic hash
class BloomFilter:
...
# Check if existing IDs are in bloom filter
...
# Generate a new service ID using the FIXED hash function
...
# Generate 10 new service IDs and check
