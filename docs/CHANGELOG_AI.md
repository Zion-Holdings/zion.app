...
### Features
- merge GitHub Actions fixes and comprehensive test workflows into main (fbb40ec)

### Fixes
- Fix workflow permission and concurrency configuration across multiple files (db21104)
- Fix GitHub workflow permissions and action version updates (d86f658)
- disable workflows-auto-healer to prevent automatic workflow modifications (d92fb4b)
- resolve workflow runtime issues - timeout commands, jq dependencies, and serve installation (9a276cc)
- resolve final YAML syntax issues in workflow-validator.yml (8f6b9fc)
- restore and standardize all GitHub Actions workflows (b79a888)
- update Playwright config for Next.js export mode (5ff767d)
- resolve TypeScript errors and unused state variables (e4e7340)

### Refactors
- Refactor GitHub workflow run commands to improve readability and consistency (3e49ca5)

### Style
- restore Tailwind setup (postcss/tailwind config) and globals.css with Tailwind directives (1fca61b)

### Chores
- standardize workflow configurations and naming conventions (e0c0fee)

### Other
- Merge pull request #3945 from Zion-Holdings/cursor/fix-failing-github-actions-workflows-caa2 (18d6963)
- Add package.json check to workflow jobs for conditional execution (757be1a)
- Checkpoint before follow-up message (2ebd3fd)
- Merge pull request #3943 from Zion-Holdings/cursor/check-and-fix-github-actions-workflows-81bb (8dd9723)
- Merge pull request #3938 from Zion-Holdings/cursor/check-and-fix-github-actions-workflows-cf6c (3303a24)
- Merge pull request #3941 from Zion-Holdings/cursor/netlify-build-with-plugin-error-03f5 (8d7fbd9)
- Merge pull request #3939 from Zion-Holdings/cursor/check-and-fix-github-actions-workflows-2da3 (16240e8)
- Replace logs.info with console.log in run-functions-and-rerun plugin (485d214)
- Merge pull request #3940 from Zion-Holdings/cursor/check-and-fix-github-actions-workflows-569f (8ac3c4d)
- Update GitHub Actions workflows and release process (1f4690c)
- Merge pull request #3936 from Zion-Holdings/cursor/fix-plugin-event-name-error-967b (7608362)
- Remove unused inputs from run-functions-and-rerun plugin (17c8d46)
- Merge pull request #3935 from Zion-Holdings/cursor/netlify-build-with-plugin-error-0c69 (3aa4a3a)
- Add manifest for run-functions-and-rerun Netlify plugin (88673e7)
- Resolve ESM module issues, optimize build, and sync git repository (a3a80ff)
- Merge pull request #3934 from Zion-Holdings/cursor/migrate-github-actions-to-pm2-automations-2220 (2b27dd1)
- Create empty ecosystem configuration file (6428f49)
- Merge workflow fixes: resolve conflicts and integrate all fixed workflows (ac038d7)
- Checkpoint before follow-up message (8acbb1f)
- 🔧 Final workflow fixes: Ensure all 223 workflows are valid YAML (53a5492)
- 🔧 Merge workflow fixes: Resolve all 196 merge conflicts and integrate fixed workflows (bbd4509)
- 🚀 Add comprehensive test suite and auto-fix workflows for GitHub Actions (ce60147)
- 🔧 Fix GitHub Actions workflows: resolve permission issues and improve security (a7c6954)
- Merge pull request #3930 from Zion-Holdings/cursor/check-and-fix-github-actions-f16b (a7d4372)
- Update workflow configurations with standardized runs-on and timeout settings (9085e09)
- Merge pull request #3929 from Zion-Holdings/cursor/investigate-background-agent-merge-failures-6540 (85716ed)
...
### Chores
- enhance front index [skip ci] (7f734ce)
- advertise features, capabilities and benefits [skip ci] (d3e6a1d)
- advertise features, capabilities and benefits [skip ci] (1c3f04d)
