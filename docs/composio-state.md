...
Atualizado 2026-09-03. `origin/main` was force-rewritten to a root-exported static site (no `public/`, no workflows). Unique maximize pages now live at `/book/`, `/heritage/`, `/plans/`, `/composio/`. Pages still serve `gh-pages` **without CNAME** — apex 404 until the Pages workflow merges.
