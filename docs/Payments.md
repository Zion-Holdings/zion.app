...
- **`NEXT_PUBLIC_STRIPE_TEST_PUBLISHABLE_KEY`**: Your Stripe test _publishable_ key (e.g., `pk_test_...`).
...
- **`STRIPE_TEST_SECRET_KEY`**: Your Stripe test _secret_ key (e.g., `sk_test_...`).
