...
*   **Used In**: `pages/api/auth/register.ts`
*   **Example Format**:
...
*   **Configuration**: This variable **must be set** in the Netlify UI build environment settings for production and preview deployments. Refer to the placeholder in `netlify.toml` for an example entry. Failure to configure this variable will result in non-functional user signup.
