import React from 'react';'import { render, screen, fireEvent, waitFor } from '@testing-library/react';'import '@testing-library/jest-dom';'import WhitepaperSectionEditor from '@/components/WhitepaperSectionEditor';'import { supabase } from '@/integrations/supabase/client'; // To mock its functions''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
describe('WhitepaperSectionEditor', () => {'  const mockOnContentChange = jest.fn();'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
  ...
  test('handles error when fetching AI suggestions', async () => {'    const errorMessage = 'Failed to fetch suggestions from Supabase.';'    (supabase.functions.invoke as jest.Mock).mockResolvedValueOnce({'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
   ...
   test('handles error when suggestions data is invalid', async () => {'    (supabase.functions.invoke as jest.Mock).mockResolvedValueOnce({'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
  ...
  test('hides suggestions when "Hide Suggestions" button is clicked', async () => {'    const mockSuggestions = "Some suggestions.";"    (supabase.functions.invoke as jest.Mock).mockResolvedValueOnce({"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    ...
    fireEvent.click(screen.getByRole('button', { name: /Hide Suggestions/i }));'    expect(screen.queryByText(mockSuggestions)).not.toBeVisible();'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
  });
});
