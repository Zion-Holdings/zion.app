...
// Mock recharts
jest.mock('recharts', () => {'  const MockResponsiveContainer = ({ children }: { children: React.ReactNode }) => <div data-testid="mock-responsive-container">{children}</div>;"  const MockPieChart = ({ children }: { children: React.ReactNode }) => <div data-testid="mock-pie-chart">{children}</div>;"  const MockPie = (props: any) => <div data-testid="mock-pie" data-data={JSON.stringify(props.data)}>{props.children}</div>; // Capture data prop"  const MockCell = () => <div data-testid="mock-cell" />;"  const MockTooltip = () => <div data-testid="mock-tooltip" />;"  const MockLegend = () => <div data-testid="mock-legend" />;"  
  // Add display names
