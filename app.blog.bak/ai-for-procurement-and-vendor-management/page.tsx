  ...
  return (
    <div className="relative min-h-screen bg-slate-950">
      <ArticleStructuredData
        headline="AI for Procurement and Vendor Management"
        description="Spend analysis, contract extraction, supplier risk scoring, and automated sourcing. Optimizing procurement with intelligent automation."
      ...
      <article className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <SiteBreadcrumbs
          items={[
            ...
            { label: 'AI for Procurement and Vendor Management' },
          ]}
          className="mb-8"
        />
        ...
        <section className="mb-10">
            <h2 className="mb-4 text-2xl font-bold text-white">
              Spend Analysis and Contract Intelligence
            </h2>
