...
with open('/data/data/com.termux/files/home/zion-support.github.io/commands/google_workspace.py', 'r') as f:
    code = f.read()
mod_globals = {'__name__': 'google_workspace', '__file__': '/data/data/com.termux/files/home/zion-support.github.io/commands/google_workspace.py'}
