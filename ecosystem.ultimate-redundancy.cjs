module.exports = {
  apps: [
    // Ultimate Redundancy Automation System - Main Controller
    {
      ...
      error_file: "automation/logs/ultimate-redundancy-system-error.log",
      out_file: "automation/logs/ultimate-redundancy-system-out.log",
      time: true,
      instances: 1,
      exec_mode: "fork"
    },
    ...
    // Enhanced Git Sync Orchestrator
    {
      ...
      env: {
        ...
        GIT_SYNC_CHECK_INTERVAL: "300000", // 5 minutes
        GIT_SYNC_MAX_ATTEMPTS: "3",
    ...
    // Pre-build Health Check
    {
      ...
      env: {
        ...
        HEALTH_CHECK_TIMEOUT: "60000" // 1 minute
      },
      log_date_format: "YYYY-MM-DD HH:mm:ss Z",
    ...
    // Next.js Page Validator
    {
      ...
      env: {
        ...
        VALIDATION_CHECK_INTERVAL: "900000", // 15 minutes
