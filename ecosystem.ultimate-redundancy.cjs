module.exports = {
  apps: [
    // Ultimate Redundancy Orchestrator - Master Controller
    {
      ...
      env: {
        ...
        ULTIMATE_REDUNDANCY_MASTER_CHECK_INTERVAL: "60000",
      ...
      error_file: "automation/logs/ultimate-orchestrator-error.log",
      out_file: "automation/logs/ultimate-orchestrator-out.log",
      time: true,
      instances: 1,
      exec_mode: "fork"
    },
    ...
    // Enhanced PM2 Redundancy System
    {
      ...
      env: {
        ...
        PM2_MEMORY_THRESHOLD: "80",
        PM2_CPU_THRESHOLD: "90"
      },
      log_date_format: "YYYY-MM-DD HH:mm:ss Z",
    ...
    // Master Redundancy Orchestrator (Legacy Support)
    {
    ...
    {
      name: "redundancy-git-sync-enhanced",
      ...
      env: {
        ...
        GIT_SYNC_INTERVAL: "900000", // 15 minutes
        GIT_SYNC_AUTO_RESOLVE: "true",
        GIT_SYNC_HEALTH_CHECK: "true"
      },
      log_date_format: "YYYY-MM-DD HH:mm:ss Z",
      error_file: "automation/logs/redundancy-git-sync-enhanced-error.log",
      out_file: "automation/logs/redundancy-git-sync-enhanced-out.log",
      time: true,
      instances: 1,
      exec_mode: "fork"
    },
    ...
    {
      name: "redundancy-build-monitor-enhanced",
      script: "automation/redundancy-build-monitor.cjs",
      interpreter: "node",
      cwd: __dirname,
      watch: false,
      ...
      log_date_format: "YYYY-MM-DD HH:mm:ss Z",
      error_file: "automation/logs/redundancy-build-monitor-enhanced-error.log",
      out_file: "automation/logs/redundancy-build-monitor-enhanced-out.log",
      time: true,
      instances: 1,
      exec_mode: "fork"
    }
