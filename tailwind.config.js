  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'inner-glow': 'inset 0 0 20px rgba(0, 122, 204, 0.1)',
      },
      animation: {
      ...
      backgroundImage: {
        ...
        'gradient-cursor': 'linear-gradient(135deg, #007acc 0%, #00d4aa 100%)',
        'gradient-cursor-dark': 'linear-gradient(135deg, #005a9e 0%, #00b894 100%)',
      },
      transitionProperty: {
        'height': 'height',
