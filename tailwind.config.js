  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'quantum': '0 0 30px rgba(168, 85, 247, 0.4)',
        'hologram': '0 0 40px rgba(236, 72, 153, 0.3)',
        'plasma': '0 0 25px rgba(34, 197, 94, 0.4)',
        'energy': '0 0 35px rgba(245, 158, 11, 0.4)',
        'matrix': '0 0 30px rgba(34, 197, 94, 0.3)',
        'cyber-grid': '0 0 50px rgba(59, 130, 246, 0.2)',
        'neural-dots': '0 0 40px rgba(6, 182, 212, 0.25)',
        'quantum-waves': '0 0 45px rgba(168, 85, 247, 0.3)',
        'hologram-pattern': '0 0 60px rgba(236, 72, 153, 0.25)',
        'plasma-flow': '0 0 35px rgba(34, 197, 94, 0.35)',
        'energy-field': '0 0 55px rgba(245, 158, 11, 0.3)',
        'matrix-rain': '0 0 40px rgba(34, 197, 94, 0.25)',
        'cyber-circuit': '0 0 50px rgba(59, 130, 246, 0.2)',
      },
      animation: {
