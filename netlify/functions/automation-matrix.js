...
exports.handler = async () => {
  ...
  // External links scan
  try { logStep('links:external-check', () => runNode('automation/external-link-check.cjs')); } catch (e) { logs.push(`links:external-check skipped: ${String(e)}`); }

  // Artifacts
  try { logStep('sitemap:runner', () => runNode('automation/sitemap-runner.cjs')); } catch (e) { logs.push(`sitemap:runner skipped: ${String(e)}`); }
