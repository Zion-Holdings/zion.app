            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  ...
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.665 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 4.986 4.986 0 01-6.102 4.53 4.968 4.968 0 01-1.487-.212 9.86 9.86 0 005.216 1.525c6.14 0 9.498-5.084 9.498-9.498 0-.144-.003-.285-.01-.427a6.973 6.973 0 001.284.99z"/>
                    </svg>
                  </a>
                  <a 
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-400">
                  <li><a href="/ai-autonomous-business-manager" className="hover:text-white transition-colors">AI Business Manager</a></li>
                  <li><a href="/ai-autonomous-business-operations" className="hover:text-white transition-colors">Business Operations</a></li>
                  ...
                  <li><a href="/enterprise-it" className="hover:text-white transition-colors">Enterprise IT</a></li>
              ...
              {/* Platform & Support */}
              <div>
                <h4 className="font-semibold mb-4 text-white">Platform & Support</h4>
                <ul className="space-y-2 text-sm text-gray-400">
            ...
            <div className="border-t border-white/10 mt-8 pt-8">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm text-gray-400">
                ...
                <div>
                  ...
                  <span className="ml-2">Global Operations</span>
                </div>
              </div>
            </div>

            {/* Copyright */}
            <div className="border-t border-white/10 mt-6 pt-6 text-center text-sm text-gray-400">
