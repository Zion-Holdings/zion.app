            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="https://github.com/Zion-Holdings" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="https://youtube.com/@ziontechgroup" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* AI Solutions */}
              <div>
                <h4 className="font-semibold mb-4 text-white">AI Solutions</h4>
                <ul className="space-y-2 text-sm text-gray-400">
              ...
              {/* Company & Support */}
              <div>
                <h4 className="font-semibold mb-4 text-white">Company & Support</h4>
                <ul className="space-y-2 text-sm text-gray-400">
