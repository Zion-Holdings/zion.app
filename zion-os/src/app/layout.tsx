        ...
        <footer className="border-t border-white/10 bg-black/20 backdrop-blur-sm mt-20">
          <div className="max-w-7xl mx-auto px-4 py-8">
            ...
            <div className="border-t border-white/10 mt-8 pt-8 text-center text-sm text-gray-400">
              <p>&copy; 2024 Zion Tech Group. All rights reserved. | <a href="/privacy" className="hover:text-white transition-colors">Privacy Policy</a> | <a href="/terms" className="hover:text-white transition-colors">Terms of Service</a></p>
            </div>
          </div>
        </footer>
      </body>
