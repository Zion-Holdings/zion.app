  ...
  return (
    <html lang="en" className="scroll-smooth">
      ...
      <body className="min-h-screen bg-[var(--bg)] text-[var(--fg)] antialiased">
        ...
        <footer className="border-t border-white/10 bg-gradient-to-r from-black/40 to-gray-900/40 backdrop-blur-sm mt-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
              <div className="space-y-4">
                ...
                <p className="text-sm text-gray-400 leading-relaxed">
                  ...
                  Build the future of decentralized business.
                </p>
                <div className="flex space-x-4">
                  <a href="https://twitter.com/ziontechgroup" className="text-gray-400 hover:text-blue-400 transition-colors duration-200">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/>
                    </svg>
                  </a>
                  <a href="https://github.com/ziontechgroup" className="text-gray-400 hover:text-gray-300 transition-colors duration-200">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="https://linkedin.com/company/ziontechgroup" className="text-gray-400 hover:text-blue-600 transition-colors duration-200">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                ...
                <ul className="space-y-3 text-sm text-gray-400">
                  <li><a href="/multiverse/launch" className="hover:text-white transition-colors duration-200 flex items-center space-x-2 group">
                    <span className="w-1 h-1 bg-blue-500 rounded-full group-hover:bg-blue-400 transition-colors"></span>
                    <span>Launch Wizard</span>
                  </a></li>
                  <li><a href="/admin/instances" className="hover:text-white transition-colors duration-200 flex items-center space-x-2 group">
                    <span className="w-1 h-1 bg-purple-500 rounded-full group-hover:bg-purple-400 transition-colors"></span>
                    <span>Instances</span>
                  </a></li>
                  <li><a href="/admin/os-deploy" className="hover:text-white transition-colors duration-200 flex items-center space-x-2 group">
                    <span className="w-1 h-1 bg-green-500 rounded-full group-hover:bg-green-400 transition-colors"></span>
                    <span>Admin Deploy</span>
                  </a></li>
                  <li><a href="/docs" className="hover:text-white transition-colors duration-200 flex items-center space-x-2 group">
                    <span className="w-1 h-1 bg-yellow-500 rounded-full group-hover:bg-yellow-400 transition-colors"></span>
              ...
              <div>
                ...
                <ul className="space-y-3 text-sm text-gray-400">
                  ...
                  <li><a href="mailto:kleber@ziontechgroup.com" className="hover:text-white transition-colors duration-200">Contact</a></li>
                </ul>
              </div>
            </div>
