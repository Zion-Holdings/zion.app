    ...
    <>
      ...
      {isVisible && (
        ...
        >
              ...
              return (
                <div key={key} className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
                  ...
                  <div className={`text-right ${status.color}`}>
                    ...
                    <div className="text-xs capitalize">{status.status.replace('-', ' ')}</div>
                  </div>
                </div>
              );
            })}
          ...
          {/* Footer */}
          <div className="bg-gradient-to-r from-green-500/10 to-blue-500/10 p-3 border-t border-green-400/30">
