...
const FuturisticDataTable: React.FC<FuturisticDataTableProps> = ({
  ...
  const renderSortIcon = (columnKey: string) => {
    ...
    return (
      <svg className={`w-4 h-4 ${sortDirection === 'asc' ? 'text-neon-blue' : 'text-neon-purple'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {searchable && (
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-glass border border-neon-blue/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-neon-blue/40 focus:ring-1 focus:ring-neon-blue/20 transition-all duration-300"
              />
            </div>
          )}
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className="px-3 py-2 text-sm bg-glass border border-neon-blue/20 rounded-lg text-white hover:border-neon-blue/40 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
              >
                Previous
              </button>
