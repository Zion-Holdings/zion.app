    ...
    <div className="{`enhanced-contrast-demo ${className}`}">
      ...
      <div className="accessibility-controls bg-high-contrast-card border-high-contrast-primary rounded-lg p-4 mb-6"""></div>
        ...
        <div className=" grid grid-cols-1 md grid-cols-3 gap-4"""></div>
          ...
          >
            {highContrastMode ? Disabl'e' : Enabl'e'} High Contrast</div>
          </button>
          </div>
          <button"`
            onClick={() => setLargeTextMode(!largeTextMode)}``
            className="{`btn ${largeTextMode ? 'btn-prima'ry : 'btn-seconda'ry} focus-high-contrast`} 
          ...
          <button'`
            ...
            className={`btn ${reducedMotionMode ? btn-prima'r'y : btn-seconda'r'y} focus-high-contrast`} 
            aria-label=Toggle reduced motion mode
          >
            {reducedMotionMode ? 'Disab'le : 'Enab'le} Reduced Motion</div>
          </button></div>
        </div></div>
      </div>
''`"
      {/* Demo Container with Dynamic Classes */}``"</div>
      <div className="{`demo-container ${highContrastMode ? high-contrast-mod'e' : } ${largeTextMode ? 'large-te'xt : ''} ${reducedMotionMode ? reduced-motio'n' : }`}>
        "
...
''`;}
export default EnhancedContrastDemo;`</div>