...
'
  return (
    <div className="{`contrast-demo ${highContrastMode ? high-contrast-mod'e' : }`}">
      ...
      <div className="accessibility-controls bg-high-contrast-card border-high-contrast-primary rounded-lg p-4 mb-6"></div>
        ...
        <button'`"
          ...
          className={`btn ${highContrastMode ? btn-prima'r'y : btn-seconda'r'y} focus-high-contrast`} 
          aria-label=Toggle high contrast mode
        >
          {highContrastMode ? 'Disab'le : 'Enab'le} High Contrast</div>
        </button></div>
      </div>
...
''`;}
export default ContrastDemo;`</div>