...
const EnhancedNavigation: "React.FC<EnhancedNavigationProps> = ({"
  ...
  const variable1 = variant === light' ? 'text-gray-700 : text-white'
  const variable1 = variant === 'lig'ht ? hover: "text-blue-600 : hover:text-blue-300"
;
  const variable1 = () => setMobileMenuOpen(!mobileMenuOpen);
  const variable1 = (label: string) => {
