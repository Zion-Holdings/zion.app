...
const sidebarSections = [
  {
    ...
    items: [
      ...
      { name: 'AI Consciousness Evolution 2029', href: '/ai-consciousness-evolution-2029', badge: 'New' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Quantum Internet Security', href: '/quantum-internet-security', badge: 'New' },
      { name: 'Quantum Internet Security Platform', href: '/quantum-internet-security-platform', badge: 'New' },
      { name: 'Brain-Computer Interface', href: '/brain-computer-interface', badge: 'New' },
      { name: 'Brain-Computer Interface Platform', href: '/brain-computer-interface-platform', badge: 'New' },
      { name: 'Quantum Materials Discovery', href: '/quantum-materials-discovery', badge: 'New' },
      { name: 'Quantum Materials Discovery Platform', href: '/quantum-materials-discovery-platform', badge: 'New' },
