  ...
  const sidebarSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Leadership', href: '/leadership', badge: 'Team' },
        { label: 'Careers', href: '/careers', badge: 'Opportunities' },
        { label: 'Contact', href: '/contact', badge: 'Get in Touch' },
        { label: 'News & Press', href: '/news', badge: 'Updates' },
        { label: 'Case Studies', href: '/case-studies', badge: 'Success Stories' },
        { label: 'Partners', href: '/partners', badge: 'Collaborations' },
        { label: 'Support', href: '/support', badge: 'Help' },
        { label: 'Documentation', href: '/docs', badge: 'Guides' },
        { label: 'API Reference', href: '/api', badge: 'Developer' },
        { label: 'Training', href: '/training', badge: 'Learn' },
        { label: 'Blog', href: '/blog', badge: 'Insights' },
        { label: 'Webinars', href: '/webinars', badge: 'Learn' },
        { label: 'White Papers', href: '/white-papers', badge: 'Research' },
        { label: 'Pricing', href: '/pricing', badge: 'Plans' }
      ]
    }
  ];
