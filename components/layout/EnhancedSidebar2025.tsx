...
const sidebarSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Supply Chain Optimization', href: '/services/intelligent-supply-chain-optimization', badge: 'New' },
      { name: 'Financial Planning AI', href: '/services/ai-financial-planning-platform', badge: 'New' },
      { name: 'HR Analytics Platform', href: '/services/ai-hr-analytics-platform', badge: 'New' },
      ...
      { name: 'AI Code Review Copilot', href: '/services/ai-code-review' },
      { name: 'LLM Gateway & Observability', href: '/services/llm-gateway' },
      { name: 'MLOps Starter Kit', href: '/services/mlops-starter' },
      { name: 'Feature Flags at the Edge', href: '/services/feature-flags-edge' },
      { name: 'PDF Render API', href: '/services/pdf-render-api' },
      { name: 'Webhook Relay & Replay', href: '/services/webhook-relay-replay' },
      { name: 'Serverless Cron Manager', href: '/services/serverless-cron-manager' },
      { name: 'Status Pages & SLO', href: '/services/status-pages-slo' }
    ]
  },
  {
    title: 'Solutions',
