  ...
  const sidebarSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Quantum Cybersecurity', href: '/quantum-cybersecurity-platform', badge: 'Critical' },
        ...
        { label: 'Quantum Financial Trading', href: '/quantum-financial-trading-platform' },
    ...
    },
    {
      ...
      items: [
        { label: 'Space Resource Intelligence', href: '/space-resource-intelligence-platform', badge: 'Future', featured: true },
