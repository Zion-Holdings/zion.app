...
const sidebarSections = [
  {
    ...
    items: [
      ...
      { name: 'AI Autonomous Robotics Platform', href: '/ai-autonomous-robotics-platform', badge: 'New' },
      { name: 'AI Content Factory Pro', href: '/ai-content-factory-pro', badge: 'New' },
      { name: 'AI Autonomous Business Process Automation', href: '/ai-autonomous-business-process-automation', badge: 'New' },
