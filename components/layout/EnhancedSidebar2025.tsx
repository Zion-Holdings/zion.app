...
const sidebarSections = [
  {
    ...
    items: [
      { name: 'AI Consciousness Evolution', href: '/ai-consciousness-evolution-2040', badge: 'New' },
      { name: 'AI Quantum Neural Network', href: '/ai-quantum-neural-network', badge: 'Hot' },
      { name: 'AI Autonomous Research', href: '/ai-autonomous-research-2041', badge: 'New' },
      { name: 'AI Emotional Intelligence', href: '/ai-emotional-intelligence-training', badge: 'Popular' },
      { name: 'AI Predictive Maintenance', href: '/ai-predictive-maintenance-2041', badge: 'New' },
      { name: 'AI Content Personalization', href: '/ai-content-personalization-2041', badge: 'New' },
      { name: 'AI Autonomous Ecosystem', href: '/ai-autonomous-ecosystem-2041' },
      { name: 'AI Ethics & Governance', href: '/ai-ethics-governance-2041' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Quantum Internet Security', href: '/quantum-internet-security-2041', badge: 'New' },
      { name: 'Brain-Computer Interface', href: '/brain-computer-interface-2040', badge: 'New' },
      { name: 'Quantum Materials Discovery', href: '/quantum-materials-discovery-2040', badge: 'New' },
      { name: 'Autonomous Vehicle AI', href: '/autonomous-vehicle-ai-2040', badge: 'New' },
      { name: 'Quantum Bio-Computing', href: '/quantum-bio-computing-2041' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Quantum Cloud Infrastructure', href: '/quantum-cloud-infrastructure-2041' },
  ...
  },
  {
    ...
    items: [
      { name: 'AI Customer Success', href: '/ai-customer-success-2041', badge: 'New' },
            ...
            <div className="p-6 border-b border-cyan-500/30">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 bg-gray-800/50 border border-gray-700/50 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500"
                />
              </div>
            </div>
