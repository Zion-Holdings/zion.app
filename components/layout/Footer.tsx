        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/services" className="text-white/60 hover:text-white transition-colors duration-200 text-sm">
                  AI Services
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/blog" className="text-white/60 hover:text-white transition-colors duration-200 text-sm">
                  Blog
                </Link>
              </li>
              <li>
                <Link href="/resources" className="text-white/60 hover:text-white transition-colors duration-200 text-sm">
                  Resources
                </Link>
              </li>
              <li>
