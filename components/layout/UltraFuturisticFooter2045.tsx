...
const UltraFuturisticFooter2045: React.FC = () => {
  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Autonomous DevOps Platform 2045', href: '/autonomous-devops-platform-2045', icon: <Server className="w-4 h-4" /> },
        { name: 'Quantum Data Center Management 2045', href: '/quantum-data-center-management-2045', icon: <Database className="w-4 h-4" /> },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Autonomous AI Research 2045', href: '/autonomous-ai-research-2045', icon: <Code className="w-4 h-4" /> },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Careers', href: '/careers', icon: <Star className="w-4 h-4" /> },
        { name: 'News & Updates', href: '/news', icon: <Zap className="w-4 h-4" /> },
  ...
  const socialLinks = [
    { name: 'Facebook', icon: <Facebook className="w-4 h-4" />, href: 'https://facebook.com/ziontechgroup', color: 'from-blue-500 to-blue-600' },
    { name: 'Twitter', icon: <Twitter className="w-4 h-4" />, href: 'https://twitter.com/ziontechgroup', color: 'from-cyan-400 to-blue-500' },
    { name: 'LinkedIn', icon: <Linkedin className="w-4 h-4" />, href: 'https://linkedin.com/company/ziontechgroup', color: 'from-blue-600 to-blue-700' },
    { name: 'Instagram', icon: <Instagram className="w-4 h-4" />, href: 'https://instagram.com/ziontechgroup', color: 'from-purple-500 to-pink-500' },
    { name: 'YouTube', icon: <Youtube className="w-4 h-4" />, href: 'https://youtube.com/@ziontechgroup', color: 'from-red-500 to-red-600' },
    { name: 'GitHub', icon: <Github className="w-4 h-4" />, href: 'https://github.com/ziontechgroup', color: 'from-gray-600 to-gray-700' }
  ];
