  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: 'Autonomous Customer Success 2045', href: '/autonomous-customer-success-2045', icon: <Heart className="w-5 h-5" /> }
      ]
    },
    {
      ...
      links: [
        ...
        { name: 'Quantum Data Center Management 2045', href: '/quantum-data-center-management-2045', icon: <Database className="w-5 h-5" /> },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Press Kit', href: '/press', icon: <Star className="w-5 h-5" /> }
      ]
    }
  ];
