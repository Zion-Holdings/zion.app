...
const Header = () => {
  ...
  const productDropdown = [
    ...
    { name: 'Micro SaaS Services', href: '/micro-saas', description: 'AI-powered micro SaaS solutions' },
  ];

  const solutionsDropdown = [
    { name: 'All Services', href: '/services', description: 'Complete service portfolio' },
    { name: 'Micro SaaS', href: '/micro-saas', description: 'AI-powered micro SaaS solutions' },
    { name: 'AI & Automation', href: '/automation', description: 'Intelligent automation systems' },
