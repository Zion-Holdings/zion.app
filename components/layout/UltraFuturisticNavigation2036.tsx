...
import { 
  ...
  Target as TargetIcon, Atom as AtomIcon, Brain as BrainIcon, Home
} from 'lucide-react';
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        description: 'Government technology',
        icon: <Building className="w-4 h-4" />
      },
      {
