        ...
        <nav className="mx-auto max-w-7xl px-6">
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="hidden items-center gap-6 md:flex">
              ...
              <Link href="/main/front#capabilities" className="rounded-lg bg-gradient-to-r from-fuchsia-500 to-cyan-500 px-3 py-1.5 text-sm font-semibold shadow-[0_0_20px_rgba(34,211,238,0.35)] hover:shadow-[0_0_28px_rgba(34,211,238,0.6)] transition-shadow">
                Get Started
              </Link>
            </div>
        ...
        {mobileOpen && (
          <div className="md:hidden border-t border-white/10">
            <div className="mx-auto max-w-7xl px-6 py-3 grid gap-3">
              ...
              <Link href="/main/front#capabilities" className="rounded-md bg-white/90 px-3 py-2 text-center font-semibold text-slate-900 hover:bg-white">
                Get Started
              </Link>
            </div>
          </div>
