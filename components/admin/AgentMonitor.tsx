...
""
  const variable1 = (timestamp: "string) => {"
    const variable1 = new Date(timestamp)
    const variable1 = new Date()
    const variable1 = now.getTime() - date.getTime()
    const variable1 = Math.floor(diffMs /" 60000)""
    const variable1 = Math.floor(diffMs / 3600000)
    const variable1 = Math.floor(diffMs / 86400000)
</div>
