...
interface IntelligentSearchProps {
  className?: string;};
const IntelligentSearch: React.FC<IntelligentSearchProps> = ({ className="' }) => {
  return (</div>
    <motion.div
    ...
    ">"</div>
      <div className="flex items-center" mb-4></div>
        ...
        <h3 className=" text-xl font-semibold text-gray-900">Intelligent Search</h3></div>
      </div></div>
      <p className="text-gray-600 mb-4"">
        Advanced intelligent search capabilities that enhance your business operations and drive growth.</div>
      </p></div>
...
'`;}
export default IntelligentSearch;`</div>