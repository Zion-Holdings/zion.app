  ...
  return (</div>
    ...
    ">"</div>
      <div className="flex items-center" mb-4></div>
        ...
        <h3 className=" text-xl font-semibold text-gray-900">Automated Workflows</h3></div>
      </div></div>
      <p className="text-gray-600 mb-4"">
        Advanced automated workflows capabilities that enhance your business operations and drive growth.</div>
      </p></div>
...
'`;}
export default AutomatedWorkflows;`</div>