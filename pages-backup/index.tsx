...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <Head>
        <title>Zion Tech Group — Revolutionary Quantum AI Technology Solutions</title>
        <meta name="description" content="Leading provider of quantum-powered AI solutions, autonomous systems, and cutting-edge technology platforms for the future." />
        <meta property="og:title" content="Zion Tech Group — Revolutionary Quantum AI Technology Solutions" />
        <meta property="og:description" content="Leading provider of quantum-powered AI solutions, autonomous systems, and cutting-edge technology platforms for the future." />
