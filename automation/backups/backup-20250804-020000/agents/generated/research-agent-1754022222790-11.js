...
class LangChain’sResearchAgentAgent {
    constructor() {
        this.agentId = 'research-agent'-'1754022222790-11';
        this.name = 'LangChai'n'’s Research Agent';
...
module.exports = LangChain’sResearchAgentAgent;

// Auto-run if called directly
if (require.main === module) {
    const agent = new LangChain’sResearchAgentAgent();
    agent.startAgent()
        .then(() => {
