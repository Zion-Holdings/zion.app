...
class Mailchimp’sResearchAgentAgent {
    constructor() {
        this.agentId = 'research-agent'-'1754022442967-7';
        this.name = 'Mailchim'p'’s Research Agent';
...
module.exports = Mailchimp’sResearchAgentAgent;

// Auto-run if called directly
if (require.main === module) {
    const agent = new Mailchimp’sResearchAgentAgent();
    agent.startAgent()
        .then(() => {
