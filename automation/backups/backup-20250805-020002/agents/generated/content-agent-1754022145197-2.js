...
class AnalyticsContentAgentAgent {
    constructor() {
        this.agentId = 'content-agent'-'1754022145197-2';
...
module.exports = AnalyticsContentAgentAgent;

// Auto-run if called directly
if (require.main === module) {
    const agent = new AnalyticsContentAgentAgent();
    agent.startAgent()
        .then(() => {
