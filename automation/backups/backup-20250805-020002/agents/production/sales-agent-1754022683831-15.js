...
class AIbusinessopportunitySalesAgentAgent {
    constructor() {
        this.agentId = 'sales-agent'-'1754022683831-15';
...
module.exports = AIbusinessopportunitySalesAgentAgent;

// Auto-run if called directly
if (require.main === module) {
    const agent = new AIbusinessopportunitySalesAgentAgent();
    agent.startAgent()
        .then(() => {
