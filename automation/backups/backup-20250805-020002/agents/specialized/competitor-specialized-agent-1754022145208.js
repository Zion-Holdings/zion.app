...
class CompetitorAnalysisAgentAgent {
    constructor() {
        this.agentId = 'competitor-specialized-agent'-'1754022145208';
...
module.exports = CompetitorAnalysisAgentAgent;

// Auto-run if called directly
if (require.main === module) {
    const agent = new CompetitorAnalysisAgentAgent();
    agent.startAgent()
        .then(() => {
