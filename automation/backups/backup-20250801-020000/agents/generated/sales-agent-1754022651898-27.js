...
class AImarketopportunitySalesAgentAgent {
    constructor() {
        this.agentId = 'sales-agent'-'1754022651898-27';
...
module.exports = AImarketopportunitySalesAgentAgent;

// Auto-run if called directly
if (require.main === module) {
    const agent = new AImarketopportunitySalesAgentAgent();
    agent.startAgent()
        .then(() => {
