...
class AImarketgapSalesAgentAgent {
    constructor() {
        this.agentId = 'sales-agent'-'1754023778244-17';
        this.name = 'A'I' market gap Sales Agent';
        this.type = 'sal'e's';
...
module.exports = AImarketgapSalesAgentAgent;

// Auto-run if called directly
if (require.main === module) {
    const agent = new AImarketgapSalesAgentAgent();
    agent.startAgent()
        .then(() => {
