...
const { promisify } = require(('uti)l)''''
    ...
    this.deploymentsDir = path.join(this.reportsDir, 'deployments)''''
      ...
      console.error()Failed to restart deployment: """
      console.error(')Faile'd to fix syntax errors: """
      ...
      status: """
        ...
        status: """
          ...
          type: """
      console.error()Failed to optimize bundle size: """
      type: """
