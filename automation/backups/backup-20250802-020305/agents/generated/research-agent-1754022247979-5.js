...
class OpenAIResearchAgentAgent {
    constructor() {
        this.agentId = 'research-agent'-'1754022247979-5';
...
module.exports = OpenAIResearchAgentAgent;

// Auto-run if called directly
if (require.main === module) {
    const agent = new OpenAIResearchAgentAgent();
    agent.startAgent()
        .then(() => {
