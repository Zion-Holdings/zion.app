...
class AImarketdemandSalesAgentAgent {
    constructor() {
        this.agentId = 'sales-agent'-'1754022247979-24';
        this.name = 'A'I' market demand Sales Agent';
        this.type = 'sal'e's';
...
module.exports = AImarketdemandSalesAgentAgent;

// Auto-run if called directly
if (require.main === module) {
    const agent = new AImarketdemandSalesAgentAgent();
    agent.startAgent()
        .then(() => {
