...
class GeneralResearchAgentAgent {
    constructor() {
        this.agentId = 'research-agent'-'1754022247979-14';
...
module.exports = GeneralResearchAgentAgent;

// Auto-run if called directly
if (require.main === module) {
    const agent = new GeneralResearchAgentAgent();
    agent.startAgent()
        .then(() => {
