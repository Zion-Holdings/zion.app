...
class ProductDevelopmentAgentAgent {
    constructor() {
        this.agentId = 'product-specialized-agent'-'1754022683866';
...
module.exports = ProductDevelopmentAgentAgent;

// Auto-run if called directly
if (require.main === module) {
    const agent = new ProductDevelopmentAgentAgent();
    agent.startAgent()
        .then(() => {
