...
class AIbusinesssolutionSalesAgentAgent {
    constructor() {
        this.agentId = 'sales-agent'-'1754022553943-30';
...
module.exports = AIbusinesssolutionSalesAgentAgent;

// Auto-run if called directly
if (require.main === module) {
    const agent = new AIbusinesssolutionSalesAgentAgent();
    agent.startAgent()
        .then(() => {
