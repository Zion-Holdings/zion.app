...
class AIstartupopportunitySalesAgentAgent {
    constructor() {
        this.agentId = 'sales-agent'-'1754022683831-19';
...
module.exports = AIstartupopportunitySalesAgentAgent;

// Auto-run if called directly
if (require.main === module) {
    const agent = new AIstartupopportunitySalesAgentAgent();
    agent.startAgent()
        .then(() => {
