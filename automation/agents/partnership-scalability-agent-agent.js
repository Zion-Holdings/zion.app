...
class partnershipscalabilityagentagent {
  constructor() {
    this.agentName = 'partnership-scalability-agent-agent';
    this.agent = 'partnership-scalability-agent';
...
new partnershipscalabilityagentagent();
