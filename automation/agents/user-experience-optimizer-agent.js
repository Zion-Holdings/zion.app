...
class userexperienceoptimizeragent {
  constructor() {
    this.agentName = 'user-experience-optimizer-agent';
    this.optimizer = 'user-experience-optimizer';
...
new userexperienceoptimizeragent();
