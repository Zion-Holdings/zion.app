...
class geographicdiversificationagent {
  constructor() {
    this.agentName = 'geographic-diversification-agent';
    this.type = 'geographic-diversification';
...
new geographicdiversificationagent()
