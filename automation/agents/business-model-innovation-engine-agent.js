...
class businessmodelinnovationengineagent {
  constructor() {
    this.agentName = 'business-model-innovation-engine-agent';
    this.engine = 'business-model-innovation-engine';
...
new businessmodelinnovationengineagent();
