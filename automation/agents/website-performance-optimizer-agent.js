...
class websiteperformanceoptimizeragent {
  constructor() {
    this.agentName = 'website-performance-optimizer-agent';
    this.optimizer = 'website-performance-optimizer';
...
new websiteperformanceoptimizeragent();
