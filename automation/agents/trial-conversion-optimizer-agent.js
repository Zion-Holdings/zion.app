...
class trialconversionoptimizeragent {
  constructor() {
    this.agentName = 'trial-conversion-optimizer-agent';
    this.optimizer = 'trial-conversion-optimizer';
...
new trialconversionoptimizeragent();
