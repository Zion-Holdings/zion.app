...
class useracquisitionagent1754468601615 {
  constructor() {
    this.agentName = 'user-acquisition-agent-1754468601615';
    this.agentType = 'user-acquisition-agent';
...
new useracquisitionagent1754468601615();
