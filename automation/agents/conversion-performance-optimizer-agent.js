...
class conversionperformanceoptimizeragent {
  constructor() {
    this.agentName = 'conversion-performance-optimizer-agent';
    this.optimizer = 'conversion-performance-optimizer';
...
new conversionperformanceoptimizeragent();
