...
class marketinginnovationengineagent {
  constructor() {
    this.agentName = 'marketing-innovation-engine-agent';
    this.engine = 'marketing-innovation-engine';
...
new marketinginnovationengineagent()
