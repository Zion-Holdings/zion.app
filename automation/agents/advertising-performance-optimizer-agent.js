...
class advertisingperformanceoptimizeragent {
  constructor() {
    this.agentName = 'advertising-performance-optimizer-agent';
    this.optimizer = 'advertising-performance-optimizer';
...
new advertisingperformanceoptimizeragent();
