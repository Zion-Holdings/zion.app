...
class socialgrowthagent1754468601646 {
  constructor() {
    this.agentName = 'social-growth-agent-1754468601646';
    this.agentType = 'social-growth-agent';
...
new socialgrowthagent1754468601646();
