...
class partnershipgrowthagent1754468601643 {
  constructor() {
    this.agentName = 'partnership-growth-agent-1754468601643';
    this.agentType = 'partnership-growth-agent';
...
new partnershipgrowthagent1754468601643();
