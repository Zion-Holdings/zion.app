...
class emailperformanceoptimizeragent {
  constructor() {
    this.agentName = 'email-performance-optimizer-agent';
    this.optimizer = 'email-performance-optimizer';
...
new emailperformanceoptimizeragent();
