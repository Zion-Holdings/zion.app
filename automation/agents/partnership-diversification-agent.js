...
class partnershipdiversificationagent {
  constructor() {
    this.agentName = 'partnership-diversification-agent';
    this.type = 'partnership-diversification';
...
new partnershipdiversificationagent();
