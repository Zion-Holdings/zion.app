...
class infrastructurescalabilityagentagent {
  constructor() {
    this.agentName = 'infrastructure-scalability-agent-agent';
    this.agent = 'infrastructure-scalability-agent';
...
new infrastructurescalabilityagentagent();
