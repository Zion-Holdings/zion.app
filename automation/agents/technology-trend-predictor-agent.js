...
class technologytrendpredictoragent {
  constructor() {
    this.agentName = 'technology-trend-predictor-agent';
    this.predictor = 'technology-trend-predictor';
...
new technologytrendpredictoragent();
