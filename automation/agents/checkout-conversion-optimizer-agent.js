...
class checkoutconversionoptimizeragent {
  constructor() {
    this.agentName = 'checkout-conversion-optimizer-agent';
    this.optimizer = 'checkout-conversion-optimizer';
...
new checkoutconversionoptimizeragent()
