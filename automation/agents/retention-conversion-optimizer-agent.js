...
class retentionconversionoptimizeragent {
  constructor() {
    this.agentName = 'retention-conversion-optimizer-agent';
    this.optimizer = 'retention-conversion-optimizer';
...
new retentionconversionoptimizeragent();
