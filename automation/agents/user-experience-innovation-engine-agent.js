...
class userexperienceinnovationengineagent {
  constructor() {
    this.agentName = 'user-experience-innovation-engine-agent';
    this.engine = 'user-experience-innovation-engine';
...
new userexperienceinnovationengineagent();
