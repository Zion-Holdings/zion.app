...
class seoperformanceoptimizeragent {
  constructor() {
    this.agentName = 'seo-performance-optimizer-agent';
    this.optimizer = 'seo-performance-optimizer';
...
new seoperformanceoptimizeragent();
