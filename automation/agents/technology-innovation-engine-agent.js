...
class technologyinnovationengineagent {
  constructor() {
    this.agentName = 'technology-innovation-engine-agent';
    this.engine = 'technology-innovation-engine';
...
new technologyinnovationengineagent();
