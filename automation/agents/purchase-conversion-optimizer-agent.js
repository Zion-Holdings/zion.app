...
class purchaseconversionoptimizeragent {
  constructor() {
    this.agentName = 'purchase-conversion-optimizer-agent';
    this.optimizer = 'purchase-conversion-optimizer';
...
new purchaseconversionoptimizeragent();
