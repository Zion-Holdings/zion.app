...
class productdescriptiongeneratoragent {
  constructor() {
    this.agentName = 'product-description-generator-agent';
    this.generator = 'product-description-generator';
...
new productdescriptiongeneratoragent();
