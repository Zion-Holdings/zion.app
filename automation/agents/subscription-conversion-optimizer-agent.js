...
class subscriptionconversionoptimizeragent {
  constructor() {
    this.agentName = 'subscription-conversion-optimizer-agent';
    this.optimizer = 'subscription-conversion-optimizer';
...
new subscriptionconversionoptimizeragent();
