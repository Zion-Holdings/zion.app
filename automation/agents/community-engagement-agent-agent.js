...
class communityengagementagentagent {
  constructor() {
    this.agentName = 'community-engagement-agent-agent';
    this.agent = 'community-engagement-agent';
...
new communityengagementagentagent();
