...
class socialmediaperformanceoptimizeragent {
  constructor() {
    this.agentName = 'social-media-performance-optimizer-agent';
    this.optimizer = 'social-media-performance-optimizer';
...
new socialmediaperformanceoptimizeragent();
