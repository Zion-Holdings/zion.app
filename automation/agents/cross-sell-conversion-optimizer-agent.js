...
class crosssellconversionoptimizeragent {
  constructor() {
    this.agentName = 'cross-sell-conversion-optimizer-agent';
    this.optimizer = 'cross-sell-conversion-optimizer';
...
new crosssellconversionoptimizeragent();
