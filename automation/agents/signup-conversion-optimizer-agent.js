...
class signupconversionoptimizeragent {
  constructor() {
    this.agentName = 'signup-conversion-optimizer-agent';
    this.optimizer = 'signup-conversion-optimizer';
...
new signupconversionoptimizeragent();
