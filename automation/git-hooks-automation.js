...
`;
    ...
    getStatus() {
        ...
        return {
            ...
            lintStagedConfigured: fs.existsSync(this.packageJsonPath) && 
                JSON.parse(fs.readFileSync(this.packageJsonPath, 'utf8')).hasOwnProperty('lint-staged')
        };
    }
}
...
if (require.main === module) {
    ...
    switch (command) {
        ...
        case 'status':
            ...
            break;
        default:
            console.log('Usage: node git-hooks-automation.js [setup|remove|pre-commit|pre-push|status]');
