...
async generateNewStrategies() {
  ...
  /**
 * generateSubscriptionStrategies
 * @returns {Promise<void>}
 */
...
async generateEnterpriseStrategies() {
  ...
  /**
 * generateDataMonetizationStrategies
 * @returns {Promise<void>}
 */
