...
class Innovation-automationTrend-predictionAutomation {
  constructor() {
    this.factoryType = 'innovation-automation';
    this.capability = 'trend-prediction';
...
const automation = new Innovation-automationTrend-predictionAutomation()
