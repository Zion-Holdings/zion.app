...
class Growth-automationCompetitor-analysisAutomation {
  constructor() {
    this.factoryType = 'growth-automation';
    this.capability = 'competitor-analysis';
...
const automation = new Growth-automationCompetitor-analysisAutomation();
