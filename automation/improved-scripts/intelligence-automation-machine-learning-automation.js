...
class Intelligence-automationMachine-learningAutomation {
  constructor() {
    this.factoryType = 'intelligence-automation';
    this.capability = 'machine-learning';
...
const automation = new Intelligence-automationMachine-learningAutomation()
