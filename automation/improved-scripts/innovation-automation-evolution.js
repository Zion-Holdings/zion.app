...
class Innovation-automationEvolution {
  constructor() {
    this.factoryType = 'innovation-automation';
    this.capabilities = ["idea-generation","trend-prediction","creative-content","innovation-tracking"]
...
const evolution = new Innovation-automationEvolution()
