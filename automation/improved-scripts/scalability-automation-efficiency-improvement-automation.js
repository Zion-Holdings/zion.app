...
class Scalability-automationEfficiency-improvementAutomation {
  constructor() {
    this.factoryType = 'scalability-automation';
    this.capability = 'efficiency-improvement';
...
const automation = new Scalability-automationEfficiency-improvementAutomation()
