...
class Innovation-automationIdea-generationAutomation {
  constructor() {
    this.factoryType = 'innovation-automation';
    this.capability = 'idea-generation';
...
const automation = new Innovation-automationIdea-generationAutomation()
