...
class Technical-automationDeployment-automationAutomation {
  constructor() {
    this.factoryType = 'technical-automation';
    this.capability = 'deployment-automation';
...
const automation = new Technical-automationDeployment-automationAutomation();
