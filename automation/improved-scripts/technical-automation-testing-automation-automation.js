...
class Technical-automationTesting-automationAutomation {
  constructor() {
    this.factoryType = 'technical-automation';
    this.capability = 'testing-automation';
...
const automation = new Technical-automationTesting-automationAutomation();
