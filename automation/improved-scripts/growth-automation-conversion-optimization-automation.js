...
class Growth-automationConversion-optimizationAutomation {
  constructor() {
    this.factoryType = 'growth-automation';
    this.capability = 'conversion-optimization';
...
const automation = new Growth-automationConversion-optimizationAutomation();
