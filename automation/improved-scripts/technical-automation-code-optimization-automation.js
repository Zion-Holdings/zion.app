...
class Technical-automationCode-optimizationAutomation {
  constructor() {
    this.factoryType = 'technical-automation';
    this.capability = 'code-optimization';
...
const automation = new Technical-automationCode-optimizationAutomation();
