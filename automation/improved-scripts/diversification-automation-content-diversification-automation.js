...
class Diversification-automationContent-diversificationAutomation {
  constructor() {
    this.factoryType = 'diversification-automation';
    this.capability = 'content-diversification';
...
const automation = new Diversification-automationContent-diversificationAutomation()
