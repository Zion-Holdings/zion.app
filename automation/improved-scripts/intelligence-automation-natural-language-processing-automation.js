...
class Intelligence-automationNatural-language-processingAutomation {
  constructor() {
    this.factoryType = 'intelligence-automation';
    this.capability = 'natural-language-processing';
...
const automation = new Intelligence-automationNatural-language-processingAutomation()
