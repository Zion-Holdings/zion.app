...
class Innovation-automationCreative-contentAutomation {
  constructor() {
    this.factoryType = 'innovation-automation';
    this.capability = 'creative-content';
...
const automation = new Innovation-automationCreative-contentAutomation();
