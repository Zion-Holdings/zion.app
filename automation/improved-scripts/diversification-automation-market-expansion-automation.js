...
class Diversification-automationMarket-expansionAutomation {
  constructor() {
    this.factoryType = 'diversification-automation';
    this.capability = 'market-expansion';
...
const automation = new Diversification-automationMarket-expansionAutomation();
