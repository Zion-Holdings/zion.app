...
class Intelligence-automationPredictive-analyticsAutomation {
  constructor() {
    this.factoryType = 'intelligence-automation';
    this.capability = 'predictive-analytics';
...
const automation = new Intelligence-automationPredictive-analyticsAutomation();
