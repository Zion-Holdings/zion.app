...
class Diversification-automationRevenue-diversificationAutomation {
  constructor() {
    this.factoryType = 'diversification-automation';
    this.capability = 'revenue-diversification';
...
const automation = new Diversification-automationRevenue-diversificationAutomation();
