...
class Business-automationProcess-optimizationAutomation {
  constructor() {
    this.factoryType = 'business-automation';
    this.capability = 'process-optimization';
...
const automation = new Business-automationProcess-optimizationAutomation()
