...
class Innovation-automationInnovation-trackingAutomation {
  constructor() {
    this.factoryType = 'innovation-automation';
    this.capability = 'innovation-tracking';
...
const automation = new Innovation-automationInnovation-trackingAutomation();
