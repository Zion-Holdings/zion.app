...
class Scalability-automationResource-managementAutomation {
  constructor() {
    this.factoryType = 'scalability-automation';
    this.capability = 'resource-management';
...
const automation = new Scalability-automationResource-managementAutomation()
