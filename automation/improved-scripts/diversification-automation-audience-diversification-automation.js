...
class Diversification-automationAudience-diversificationAutomation {
  constructor() {
    this.factoryType = 'diversification-automation';
    this.capability = 'audience-diversification';
...
const automation = new Diversification-automationAudience-diversificationAutomation();
