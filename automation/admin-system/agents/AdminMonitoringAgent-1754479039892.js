...
class AdminMonitoringAgent {
    constructor() {
        this.agentId = 'AdminMonitoringAgent-1754479039892';
        this.type = 'AdminMonitoringAgent';
        this.adminConfig = {
    ...
    async initialize() {
        console.log('🤖 Initializing AdminMonitoringAgent agent...')
        await this.start()
    }
