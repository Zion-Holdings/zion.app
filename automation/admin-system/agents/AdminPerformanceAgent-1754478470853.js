...
class AdminPerformanceAgent {
    constructor() {
        this.agentId = 'AdminPerformanceAgent-1754478470853';
        this.type = 'AdminPerformanceAgent';
        this.adminConfig = {
    ...
    async initialize() {
        console.log('🤖 Initializing AdminPerformanceAgent agent...')
        await this.start()
    }
