...
class AdminRecoveryAgent {
    constructor() {
        this.agentId = 'AdminRecoveryAgent-1754483946968';
        this.type = 'AdminRecoveryAgent';
        this.adminConfig = {
    ...
    async initialize() {
        console.log('🤖 Initializing AdminRecoveryAgent agent...');
        await this.start();
    }
