...
class AdminMemoryOptimizer {
    constructor() {
        this.agentId = 'AdminMemoryOptimizer-1754483946966';
        this.type = 'AdminMemoryOptimizer';
        this.adminConfig = {
    ...
    async initialize() {
        console.log('🤖 Initializing AdminMemoryOptimizer agent...');
        await this.start();
    }
