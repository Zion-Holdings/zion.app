...
class PredictiveModelingSystem {
  constructor() {
    this.capability = 'predictive-modeling-system';
...
const automation = new PredictiveModelingSystem();

process.on('SIGINT', async () => {
  console.log('🛑 Shutting down predictive-modeling-system gracefully...');
