...
function buildAds() {
  const items = [
    ...
    { title: 'Docs & Guides', desc: 'Technical notes and architecture', href: 'https://github.com/Zion-Holdings/zion.app/tree/main/docs', external: true },
    { title: 'AI Changelog', desc: 'Summarized autonomous changes', href: 'https://github.com/Zion-Holdings/zion.app/blob/main/docs/CHANGELOG_AI.md', external: true },
