    ...
    try {
      ...
      const result = {
        machineLearning: "{""
          ...
          investment: "Math.random() * 100 + 50 // variable50-150B""
        "},""
        deepLearning: "{""
    ...
    try {
      const result = {
        development: "{""
          ...
          investment: "Math.random() * 50 + 20 // variable20-70B""
        "},""
        applications: "{""
    ...
    try {
      const result = {
        development: "{""
          ...
          investment: "Math.random() * 30 + 15 // variable15-45B""
        "},""
        applications: "{""
    ...
    try {
      const result = {
        development: "{""
          ...
          investment: "Math.random() * 200 + 100 // variable100-300B""
        "},""
        applications: "{""
