...
Generated on: 2025-08-18T18:03:45.542Z
...
**Priority**: MEDIUM
**Type**: workflow
**Description**: Found 604 workflow improvements
...
- **agent-1755540226157-0-full-stack-intermediate** (full-stack): intermediate complexity
- **agent-1755540226158-1-monitoring-basic** (monitoring): basic complexity
- **agent-1755540226159-2-backend-basic** (backend): basic complexity
...
- **Analysis Duration**: 618ms
- **Files Processed**: 48213
