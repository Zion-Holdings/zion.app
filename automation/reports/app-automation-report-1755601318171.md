...
Generated on: 2025-08-19T11:01:55.536Z
...
**Priority**: MEDIUM
**Type**: workflow
**Description**: Found 731 workflow improvements
...
- **agent-1755601318159-0-frontend-expert** (frontend): expert complexity
- **agent-1755601318162-1-monitoring-intermediate** (monitoring): intermediate complexity
- **agent-1755601318163-2-frontend-basic** (frontend): basic complexity
...
- **Analysis Duration**: 2635ms
- **Files Processed**: 54497
