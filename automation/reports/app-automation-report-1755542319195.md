...
Generated on: 2025-08-18T18:38:32.725Z
...
**Priority**: MEDIUM
**Type**: workflow
**Description**: Found 693 workflow improvements
...
- **agent-1755542319177-0-optimization-advanced** (optimization): advanced complexity
- **agent-1755542319179-1-backend-intermediate** (backend): intermediate complexity
- **agent-1755542319181-2-testing-advanced** (testing): advanced complexity
...
- **Analysis Duration**: 6470ms
- **Files Processed**: 52692
