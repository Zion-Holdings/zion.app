...
class 5gAutomationAnalyzer {
  constructor() {
    this.factoryType = '5g-automation';
    this.capability = '5g-automation-analyzer';
    this.intelligenceLevel = 0.8681528912478539;
    this.evolutionRate = 0.24346009866223334;
...
const automation = new 5gAutomationAnalyzer();
