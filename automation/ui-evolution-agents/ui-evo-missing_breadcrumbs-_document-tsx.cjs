...
console.log('UI Evolution agent addressing missing_breadcrumbs in /workspace/pages/_document.tsx');
...
const target = path.resolve('/workspace/pages/_document.tsx');
...
if (changed) {
  ...
  console.log('Applied minimal safe change for missing_breadcrumbs in /workspace/pages/_document.tsx');
} else {
  console.log('No automatic change applied for missing_breadcrumbs in /workspace/pages/_document.tsx');
}
