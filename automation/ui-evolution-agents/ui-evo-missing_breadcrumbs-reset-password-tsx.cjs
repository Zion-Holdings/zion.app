...
console.log('UI Evolution agent addressing missing_breadcrumbs in /workspace/pages/auth/reset-password.tsx');
...
const target = path.resolve('/workspace/pages/auth/reset-password.tsx');
...
if (changed) {
  ...
  console.log('Applied minimal safe change for missing_breadcrumbs in /workspace/pages/auth/reset-password.tsx');
} else {
  console.log('No automatic change applied for missing_breadcrumbs in /workspace/pages/auth/reset-password.tsx');
}
