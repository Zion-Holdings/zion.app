...
**a) hermes-agent-bot-mode**
- Added to `app/data/blogPosts.json` (date: 2026-08-24)
...
- `blogPosts.json` — 2 new blog posts added (total: 4,074)

## Próximos Passos
- [x] Git add + commit dos arquivos
- [x] Git pull + push origin main
- [x] Gerar sitemap com `npm run generate-sitemap`
- [x] Atualizar feed.xml com novos posts
- [x] Adicionar links ao navigation.ts (AI_LAB_LINKS, RESOURCE_LINKS)
- [x] Adicionar redirects para novas páginas
- [x] Adicionar Bot Mode ao HermesAdvertBanner
- [x] Verificar no site (ziontechgroup.com) com curl
