...
serve(async (req) => {
  try {
    ...
    if (req.method === "POST") {"      const body = await req.json();"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
      const cronSecret = body.secret;
      
      if (cronSecret !== Deno.env.get("CRON_SECRET")) {"        return new Response(JSON.stringify({ error: "Unauthorized" }), {"          status: 401,"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    ...
    console.("Error in cron-daily-retention:", );""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    return new Response(JSON.stringify({
      success: false,
      : .message,
    }), {
