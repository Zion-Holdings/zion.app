...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = "You are an AI assistant that creates personalized email content for a marketplace platform called Zion AI that connects AI professionals with clients. Create content that is friendly, professional, and encouraging.";"    let userPrompt = "";"    """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    ...
    try {
      ...
      console.error("Failed to parse GPT response as JSON:", e);"      // Try to extract JSON using regex as fallback"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    ...
    console.("Error in personalize-email function:", );"    return new Response(JSON.stringify({ : .message }), {"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
      status: 500,
      headers: { ...corsHeaders, "Content-Type": "application/json" },"    });"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
  }
});
