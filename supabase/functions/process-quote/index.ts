...
const openAIApiKey = Deno.env.get('OPENAI_API_KEY');'const supabaseUrl = Deno.env.get('SUPABASE_URL') || '';'const supabaseServiceKey = Deno.env.get('SUPABASE_SERVICE_ROLE_KEY') || '';';'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
serve(async (req) => {
  ...
  try {
        ...
        const openAIResponse = await fetch('https://api.openai.com/v1/chat/completions', {'          method: 'POST','          headers: {'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
          ...
          body: JSON.stringify({
            model: 'gpt-4o','            messages: ['''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
              ...
              {
                role: 'user','                content: `Analyze this service request and provide:'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
                1. A concise summary (max 100 words)
                2. 3-5 relevant tags for categorization
                3. An estimated complexity level (Low, Medium, High)
                
                Service: ${service?.title || 'Custom Service'}'                Category: ${service?.category || 'N/A'}'                Description: ${quoteDetails.description}'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
                Budget Range: ${quoteDetails.budget}
                Timeframe: ${quoteDetails.timeframe}
                Start Date: ${quoteDetails.startDate || 'Not specified'}'                End Date: ${quoteDetails.endDate || 'Not specified'}`'              }'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            ],
            temperature: 0.5
          })
        });
    ...
    console.('Error in process-quote function:', );'    return new Response(JSON.stringify({ success: false, : .message }), {'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
      status: 500,
      headers: { ...corsHeaders, 'Content-Type': 'application/json' },'    });'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
  }
});
