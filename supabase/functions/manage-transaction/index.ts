...
import { serve } from "https://deno.land/std@0.190.0/http/server.ts";"import Stripe from "https://esm.sh/stripe@14.21.0";"import { createClient } from "https://esm.sh/@supabase/supabase-js@2.45.0";";"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
const corsHeaders = {
...
serve(async (req) => {
  ...
  try {
    ...
    switch (action) {
      case 'release':'        // Only providers or admins can release escrow funds'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
        if (!isProvider) {
        ...
        await supabaseAdmin
          ...
          .eq("id", transactionId);"        """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
        result = { message: "Funds released from escrow" };"        break;"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
        
      case 'refund':'        // Check if transaction can be refunded'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
        if (transaction.status !== "completed" && transaction.status !== "pending") {"          throw new Error("This transaction cannot be refunded");"        }"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
        ...
        result = { message: "Refund processed successfully" };"        break;"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
        
      case 'cancel':'        // Only allow cancellation for pending transactions'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
        ...
        await supabaseAdmin
          ...
          .eq("id", transactionId);"        """""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
        result = { message: "Transaction cancelled successfully" };"        break;"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    ...
    console.("Transaction management :", .message);"    return new Response(JSON.stringify({ : .message }), {"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
